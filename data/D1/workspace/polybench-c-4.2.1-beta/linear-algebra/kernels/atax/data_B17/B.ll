...
.lr.ph4:                                          ; preds = %.lr.ph4..lr.ph4_crit_edge, %.lr.ph4.preheader
  %indvars.iv7 = phi i64 [ 0, %.lr.ph4.preheader ], [ %indvars.iv.next8.2, %.lr.ph4..lr.ph4_crit_edge ]
  ...
  br i1 %exitcond9.2, label %.preheader.preheader, label %.lr.ph4..lr.ph4_crit_edge
...
.preheader:                                       ; preds = %._crit_edge..preheader_crit_edge, %.preheader.preheader
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %._crit_edge..preheader_crit_edge ], [ 0, %.preheader.preheader ]
  br label %._crit_edge1

._crit_edge1:                                     ; preds = %._crit_edge1.._crit_edge1_crit_edge, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %._crit_edge1.._crit_edge1_crit_edge ]
  ...
  br i1 %exitcond.1, label %._crit_edge, label %._crit_edge1.._crit_edge1_crit_edge
...
._crit_edge:                                      ; preds = %._crit_edge1
  ...
  br i1 %exitcond, label %._crit_edge2, label %._crit_edge..preheader_crit_edge
...
.lr.ph:                                           ; preds = %._crit_edge..lr.ph_crit_edge, %.lr.ph3
  %indvars.iv10 = phi i64 [ 0, %.lr.ph3 ], [ %indvars.iv.next11, %._crit_edge..lr.ph_crit_edge ]
...
._crit_edge1:                                     ; preds = %._crit_edge1.._crit_edge1_crit_edge, %.lr.ph
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next.2, %._crit_edge1.._crit_edge1_crit_edge ]
  ...
  br i1 %exitcond.2, label %.lr.ph2.preheader, label %._crit_edge1.._crit_edge1_crit_edge
...
.lr.ph2:                                          ; preds = %.lr.ph2..lr.ph2_crit_edge, %.lr.ph2.preheader
  %indvars.iv7 = phi i64 [ %indvars.iv.next8.2, %.lr.ph2..lr.ph2_crit_edge ], [ 0, %.lr.ph2.preheader ]
  ...
  br i1 %exitcond.29, label %._crit_edge, label %.lr.ph2..lr.ph2_crit_edge
