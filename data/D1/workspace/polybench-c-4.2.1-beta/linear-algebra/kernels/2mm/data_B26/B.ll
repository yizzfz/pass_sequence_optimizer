...
.preheader5:                                      ; preds = %.preheader5.loopexit, %.preheader8.lr.ph, %.preheader6.lr.ph, %.preheader7
  %55 = icmp sgt i32 %0, 0
  br i1 %55, label %.preheader.lr.ph, label %._crit_edge14

.preheader.lr.ph:                                 ; preds = %.preheader5
  %56 = icmp sgt i32 %3, 0
  %57 = sitofp i32 %2 to double
  br i1 %56, label %.preheader.us.preheader, label %._crit_edge14
...
.preheader5:                                      ; preds = %._crit_edge25.us
  %45 = icmp sgt i32 %0, 0
  br i1 %45, label %.preheader.lr.ph, label %._crit_edge12

.preheader.lr.ph:                                 ; preds = %.preheader6.lr.ph, %.preheader5
  %46 = icmp sgt i32 %3, 0
  %47 = icmp sgt i32 %1, 0
  br i1 %46, label %.preheader.us.preheader, label %._crit_edge12
...
.lr.ph9..lr.ph9.split_crit_edge.us.prol.loopexit: ; preds = %.lr.ph9..lr.ph9.split_crit_edge.us.prol.loopexit.loopexit, %.lr.ph9..lr.ph9.split_crit_edge.us.preheader
  ...
  br i1 %49, label %._crit_edge10.us, label %.lr.ph9..lr.ph9.split_crit_edge.us.preheader78
...
._crit_edge12:                                    ; preds = %._crit_edge12.loopexit, %11, %.preheader.lr.ph, %.preheader5
  ret void
}
