...
for.cond1.preheader.us:                           ; preds = %for.inc32.us.for.cond1.preheader.us_crit_edge, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge
  %indvars.iv1122.us = phi i64 [ 1, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge ], [ %indvars.iv.next12.us, %for.inc32.us.for.cond1.preheader.us_crit_edge ]
  %indvars.iv1320.us = phi i64 [ 0, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge ], [ %3, %for.inc32.us.for.cond1.preheader.us_crit_edge ]
...
for.inc.us.preheader:                             ; preds = %middle.block17, %min.iters.checked20, %for.cond1.preheader.us
  %indvars.iv15.us.ph = phi i64 [ %n.vec22, %middle.block17 ], [ 0, %min.iters.checked20 ], [ 0, %for.cond1.preheader.us ]
  br label %for.inc.us
...
for.inc26.us.preheader:                           ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.cond9.preheader.us
  %indvars.iv316.us.ph = phi i64 [ %n.vec, %middle.block ], [ 0, %vector.memcheck ], [ 0, %min.iters.checked ], [ 0, %for.cond9.preheader.us ]
