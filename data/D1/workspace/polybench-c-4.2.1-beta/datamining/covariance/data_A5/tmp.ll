...
define internal void @init_array(i32, double* nocapture, [1200 x double]* nocapture) #2 {
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph30.split.us
  ...
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv57, i64 %indvars.iv60
  %8 = load double, double* %7, align 8
  %9 = load double, double* %sunkaddr70, align 8
  %10 = fadd double %8, %9
  store double %10, double* %sunkaddr70, align 8
  ...
  store double %13, double* %sunkaddr70, align 8
  ...
  store double %16, double* %sunkaddr70, align 8
  ...
  store double %19, double* %sunkaddr70, align 8
...
._crit_edge27.us..preheader6.us_crit_edge:        ; preds = %._crit_edge27.us
  %scevgep78 = getelementptr double, double* %5, i64 1200
...
.preheader6.us:                                   ; preds = %._crit_edge22.us, %._crit_edge27.us..preheader6.us_crit_edge
  ...
  %scevgep76 = getelementptr [1200 x double], [1200 x double]* %3, i64 %21, i64 0
  %bound0 = icmp ult double* %scevgep, %scevgep78
  %bound1 = icmp ugt double* %scevgep76, %5
  %memcheck.conflict = and i1 %bound0, %bound1
  br i1 %memcheck.conflict, label %._crit_edge66.preheader, label %vector.body.preheader

vector.body.preheader:                            ; preds = %.preheader6.us
  br label %vector.body

._crit_edge66.preheader:                          ; preds = %.preheader6.us
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.vec83 = load <8 x double>, <8 x double>* %25, align 8, !alias.scope !4, !noalias !1
  %26 = fsub <8 x double> %wide.vec83, %wide.vec
  ...
  br i1 %37, label %._crit_edge22.us.loopexit88, label %vector.body, !llvm.loop !6

._crit_edge66:                                    ; preds = %._crit_edge66.preheader, %._crit_edge66
  %indvars.iv50 = phi i64 [ %indvars.iv.next51.3, %._crit_edge66 ], [ 0, %._crit_edge66.preheader ]
  ...
  br i1 %exitcond52.3, label %._crit_edge22.us.loopexit, label %._crit_edge66, !llvm.loop !9

._crit_edge22.us.loopexit:                        ; preds = %._crit_edge66
  br label %._crit_edge22.us

._crit_edge22.us.loopexit88:                      ; preds = %vector.body
  br label %._crit_edge22.us

._crit_edge22.us:                                 ; preds = %._crit_edge22.us.loopexit88, %._crit_edge22.us.loopexit
...
._crit_edge.us.us:                                ; preds = %._crit_edge67
...
._crit_edge67:                                    ; preds = %._crit_edge67, %.lr.ph.us.us
  %62 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %74, %._crit_edge67 ]
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %._crit_edge67 ]
  ...
  br i1 %exitcond.1, label %._crit_edge.us.us, label %._crit_edge67
