...
for.body8.lr.ph:                                  ; preds = %entry, %for.end44
  %indvars.iv17 = phi i2 [ 1, %entry ], [ %indvars.iv.next18, %for.end44 ]
  %indvars.iv60 = phi i64 [ 1, %entry ], [ %indvars.iv.next61, %for.end44 ]
  %indvar = phi i64 [ 0, %entry ], [ %indvar.next, %for.end44 ]
  %beta.040 = phi double [ 1.000000e+00, %entry ], [ %mul5, %for.end44 ]
  %alpha.039 = phi double [ %sub3, %entry ], [ %div, %for.end44 ]
  %6 = zext i2 %indvars.iv17 to i64
...
for.body8.prol.loopexit:                          ; preds = %for.body8.prol.loopexit.loopexit, %for.body8.lr.ph
  %indvars.iv.unr = phi i64 [ 0, %for.body8.lr.ph ], [ %6, %for.body8.prol.loopexit.loopexit ]
  %sum.033.unr = phi double [ 0.000000e+00, %for.body8.lr.ph ], [ %add.prol, %for.body8.prol.loopexit.loopexit ]
...
for.body8:                                        ; preds = %for.body8.preheader, %for.body8
  ...
  %sum.033 = phi double [ %add.3, %for.body8 ], [ %sum.033.unr, %for.body8.preheader ]
  ...
  %add = fadd double %sum.033, %mul14.v.r1
...
for.body21.lr.ph:                                 ; preds = %for.body21.lr.ph.loopexit, %for.body8.prol.loopexit
  ...
  %arrayidx16 = getelementptr inbounds double, double* %r, i64 %indvars.iv60
  ...
  %27 = add nsw i64 %indvars.iv60, -1
  %28 = and i64 %indvar, 1
  %lcmp.mod2 = icmp eq i64 %28, 0
  br i1 %lcmp.mod2, label %for.body21.prol, label %for.body21.prol.loopexit

for.body21.prol:                                  ; preds = %for.body21.lr.ph
  %29 = load double, double* %y, align 8
  %sunkaddr3 = shl i64 %indvars.iv60, 3
  %sunkaddr4 = add i64 %3, %sunkaddr3
  %sunkaddr5 = add i64 %sunkaddr4, -8
  %sunkaddr6 = inttoptr i64 %sunkaddr5 to double*
  %30 = load double, double* %sunkaddr6, align 8
...
for.body21.prol.loopexit:                         ; preds = %for.body21.prol, %for.body21.lr.ph
  %indvars.iv45.unr.ph = phi i64 [ 1, %for.body21.prol ], [ 0, %for.body21.lr.ph ]
...
for.body21.preheader:                             ; preds = %for.body21.prol.loopexit
  %32 = sub i64 %7, %indvars.iv45.unr.ph
  %33 = lshr i64 %32, 1
  %34 = add nuw i64 %33, 1
  %min.iters.check = icmp ult i64 %34, 2
  br i1 %min.iters.check, label %for.body21.preheader16, label %min.iters.checked

min.iters.checked:                                ; preds = %for.body21.preheader
  %n.mod.vf = and i64 %34, 1
  %n.vec = sub i64 %34, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  %35 = or i64 %indvars.iv45.unr.ph, 2
  %36 = shl nuw i64 %33, 1
  %37 = add i64 %35, %36
  %38 = shl nuw nsw i64 %n.mod.vf, 1
  %ind.end = sub i64 %37, %38
  br i1 %cmp.zero, label %for.body21.preheader16, label %vector.ph

vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert13 = insertelement <2 x double> undef, double %div, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %39 = shl i64 %index, 1
  %offset.idx = or i64 %indvars.iv45.unr.ph, %39
  ...
  %strided.vec8 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  ...
  %wide.vec9 = load <4 x double>, <4 x double>* %45, align 8
  %strided.vec10 = shufflevector <4 x double> %wide.vec9, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %reverse = shufflevector <2 x double> %strided.vec10, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %strided.vec11 = shufflevector <4 x double> %wide.vec9, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %reverse12 = shufflevector <2 x double> %strided.vec11, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %46 = fmul <2 x double> %broadcast.splat14, %reverse12
  %47 = fadd <2 x double> %strided.vec, %46
  %48 = add nuw nsw i64 %offset.idx, 1
  %49 = fmul <2 x double> %broadcast.splat14, %reverse
  %50 = fadd <2 x double> %strided.vec8, %49
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.end44, label %for.body21.preheader16

for.body21.preheader16:                           ; preds = %middle.block, %min.iters.checked, %for.body21.preheader
  %indvars.iv45.ph = phi i64 [ %indvars.iv45.unr.ph, %min.iters.checked ], [ %indvars.iv45.unr.ph, %for.body21.preheader ], [ %ind.end, %middle.block ]
...
for.body21:                                       ; preds = %for.body21.preheader16, %for.body21
  %indvars.iv45 = phi i64 [ %indvars.iv.next46.1, %for.body21 ], [ %indvars.iv45.ph, %for.body21.preheader16 ]
  ...
  %58 = sub nsw i64 %27, %indvars.iv.next46
  ...
  %exitcond51.1 = icmp eq i64 %indvars.iv.next46.1, %indvars.iv60
  br i1 %exitcond51.1, label %for.end44.loopexit, label %for.body21, !llvm.loop !6
...
for.end44:                                        ; preds = %for.end44.loopexit, %middle.block, %for.body21.prol.loopexit
  ...
  %arrayidx46 = getelementptr inbounds double, double* %y, i64 %indvars.iv60
  store double %div, double* %arrayidx46, align 8
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  %indvar.next = add nuw nsw i64 %indvar, 1
  %exitcond64 = icmp eq i64 %indvar.next, 1999
  %indvars.iv.next18 = add i2 %indvars.iv17, 1
  br i1 %exitcond64, label %for.end49, label %for.body8.lr.ph
