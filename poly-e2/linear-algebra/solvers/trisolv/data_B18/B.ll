...
for.body:                                         ; preds = %for.inc14, %for.body.lr.ph
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc14 ], [ 0, %for.body.lr.ph ]
  ...
  br i1 false, label %for.inc14, label %for.body6.lr.ph

for.body6.lr.ph:                                  ; preds = %for.body
  %2 = add nsw i64 %indvars.iv7, %0
  %3 = trunc i64 %2 to i32
  %4 = zext i32 %3 to i64
  %5 = and i64 %indvars.iv7, 1
...
for.body6.prol:                                   ; preds = %for.body6.prol.preheader
  ...
  %7 = add i32 %6, 1
  %conv8.prol = sitofp i32 %7 to double
...
for.body6.prol.loopexit:                          ; preds = %for.body6.prol.loopexit.unr-lcssa
  %8 = icmp eq i64 %indvars.iv7, 0
  br i1 %8, label %for.inc14.loopexit, label %for.body6.lr.ph.new
...
for.body6:                                        ; preds = %for.body6, %for.body6.lr.ph.new
  ...
  %12 = sub i64 %4, %indvars.iv.next
  %13 = add i64 %12, 1
  %14 = trunc i64 %13 to i32
  %conv8.1 = sitofp i32 %14 to double
  ...
  store <2 x double> %div, <2 x double>* %15, align 8
...
for.inc14:                                        ; preds = %for.inc14.loopexit, %for.body
  ...
  %exitcond = icmp ne i64 %indvars.iv.next8, %wide.trip.count10
  br i1 %exitcond, label %for.body, label %for.end16.loopexit
...
for.body:                                         ; preds = %for.end, %for.body.preheader
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.end ], [ 0, %for.body.preheader ]
  %indvars.iv12 = phi i32 [ %indvars.iv.next13, %for.end ], [ -1, %for.body.preheader ]
  %0 = add nsw i64 %indvars.iv14, -1
  %arrayidx = getelementptr inbounds double, double* %b, i64 %indvars.iv14
  %1 = bitcast double* %arrayidx to i64*
  %2 = load i64, i64* %1, align 8
  %arrayidx2 = getelementptr inbounds double, double* %x, i64 %indvars.iv14
  %3 = bitcast double* %arrayidx2 to i64*
  store i64 %2, i64* %3, align 8
  %4 = bitcast i64 %2 to double
  %cmp42 = icmp sgt i64 %indvars.iv14, 0
  br i1 %cmp42, label %for.body5.preheader, label %for.end

for.body5.preheader:                              ; preds = %for.body
  %sunkaddr5 = shl nsw i64 %indvars.iv14, 3
...
for.body5.prol:                                   ; preds = %for.body5.prol.preheader
  %arrayidx9.prol = getelementptr inbounds [2000 x double], [2000 x double]* %L, i64 %indvars.iv14, i64 0
  ...
  store double %sub.prol, double* %sunkaddr7, align 8
...
for.body5:                                        ; preds = %for.body5, %for.body5.preheader.new
  ...
  %arrayidx9 = getelementptr inbounds [2000 x double], [2000 x double]* %L, i64 %indvars.iv14, i64 %indvars.iv
  ...
  store double %sub, double* %sunkaddr7, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx9.1 = getelementptr inbounds [2000 x double], [2000 x double]* %L, i64 %indvars.iv14, i64 %indvars.iv.next
  ...
  store double %sub.1, double* %sunkaddr7, align 8
...
for.body:                                         ; preds = %for.inc, %for.body.preheader
  ...
  %call2 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %5, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i64 0, i64 0), double %6) #5
