...
for.inc.us:                                       ; preds = %for.body.us, %for.inc.us
  ...
  %5 = mul nuw nsw i64 %indvars.iv10, %indvars.iv
  ...
  %7 = mul nuw nsw i64 %indvars.iv10, %indvars.iv.next
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc20_crit_edge.us, %entry
  %indvars.iv59 = phi i64 [ 0, %entry ], [ %0, %for.cond1.for.inc20_crit_edge.us ]
...
for.inc.us:                                       ; preds = %for.inc.us.preheader, %for.inc.us
  %indvars.iv55 = phi i64 [ %indvars.iv.next56.1, %for.inc.us ], [ 0, %for.inc.us.preheader ]
  ...
  br i1 %exitcond58.1, label %for.cond1.for.inc20_crit_edge.us.loopexit, label %for.inc.us, !llvm.loop !16
...
for.inc42.us:                                     ; preds = %for.cond26.preheader.us, %for.inc42.us
  %indvars.iv46 = phi i64 [ %indvars.iv.next47.1, %for.inc42.us ], [ 0, %for.cond26.preheader.us ]
...
for.cond26.for.inc45_crit_edge.us:                ; preds = %for.inc42.us
  ...
  br i1 %exitcond72, label %vector.memcheck46, label %for.cond26.preheader.us
...
for.inc80.us:                                     ; preds = %for.cond64.preheader.us, %for.inc80.us
  ...
  %55 = phi double [ %add77.us.1, %for.inc80.us ], [ %.pre36, %for.cond64.preheader.us ]
...
for.inc58:                                        ; preds = %for.inc58.preheader, %for.inc58
  %indvars.iv42 = phi i64 [ %indvars.iv.next43.3, %for.inc58 ], [ 0, %for.inc58.preheader ]
  ...
  br i1 %exitcond45.3, label %for.cond64.preheader.us.preheader.loopexit, label %for.inc58, !llvm.loop !23
