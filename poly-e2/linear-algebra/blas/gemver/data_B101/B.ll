...
for.body.us:                                      ; preds = %for.cond35.for.end_crit_edge.us, %entry
  %indvars.iv5 = phi i64 [ 0, %entry ], [ %indvars.iv.next6, %for.cond35.for.end_crit_edge.us ]
...
for.body38.us:                                    ; preds = %for.body.us, %for.body38.us
  ...
  %7 = mul nuw nsw i64 %indvars.iv5, %indvars.iv.next
...
for.body.us:                                      ; preds = %for.cond1.for.end_crit_edge.us, %entry
  %indvars.iv32 = phi i64 [ 0, %entry ], [ %0, %for.cond1.for.end_crit_edge.us ]
...
for.body3.us:                                     ; preds = %for.body3.us.preheader, %for.body3.us
  %indvars.iv28 = phi i64 [ %indvars.iv.next29.1, %for.body3.us ], [ 0, %for.body3.us.preheader ]
  ...
  br i1 %exitcond31.1, label %for.cond1.for.end_crit_edge.us.loopexit, label %for.body3.us, !llvm.loop !16
...
for.body25.us:                                    ; preds = %for.body25.us.preheader, %for.cond26.for.end44_crit_edge.us
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.cond26.for.end44_crit_edge.us ], [ 0, %for.body25.us.preheader ]
...
for.body28.us:                                    ; preds = %for.body25.us, %for.body28.us
  %indvars.iv20 = phi i64 [ %indvars.iv.next21.1, %for.body28.us ], [ 0, %for.body25.us ]
  ...
  br i1 %exitcond23.1, label %for.cond26.for.end44_crit_edge.us, label %for.body28.us
...
for.body50:                                       ; preds = %for.body50.preheader, %for.body50
  %indvars.iv16 = phi i64 [ %indvars.iv.next17.3, %for.body50 ], [ 0, %for.body50.preheader ]
  ...
  br i1 %exitcond19.3, label %for.body63.us.preheader.loopexit, label %for.body50, !llvm.loop !23
...
for.body63.us:                                    ; preds = %for.body63.us.preheader, %for.cond64.for.end82_crit_edge.us
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.cond64.for.end82_crit_edge.us ], [ 0, %for.body63.us.preheader ]
...
for.body66.us:                                    ; preds = %for.body63.us, %for.body66.us
  ...
  %63 = phi double [ %add77.us.1, %for.body66.us ], [ %.pre11, %for.body63.us ]
