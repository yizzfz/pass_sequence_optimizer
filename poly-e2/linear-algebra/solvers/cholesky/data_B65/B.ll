...
for.inc75.us:                                     ; preds = %for.cond52.for.inc72_crit_edge.us.us
  ...
  br i1 %cmp45.us, label %for.body51.lr.ph.us, label %vector.memcheck30.preheader

vector.memcheck30.preheader:                      ; preds = %for.inc75.us
...
for.body51.lr.ph.us:                              ; preds = %for.inc75.us, %for.cond48.preheader.lr.ph.for.cond48.preheader.us_crit_edge
  ...
  %scevgep3 = getelementptr [2000 x double], [2000 x double]* %13, i64 0, i64 %indvars.iv81
  %14 = add i64 %indvars.iv81, 1
  %scevgep5 = getelementptr [2000 x double], [2000 x double]* %13, i64 1999, i64 %14
...
vector.memcheck:                                  ; preds = %for.cond52.for.inc72_crit_edge.us.us, %for.body51.lr.ph.us
  ...
  %15 = bitcast double* %scevgep3 to i8*
  ...
  %bound1 = icmp ult i8* %15, %scevgep2
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %wide.load12 = load <2 x double>, <2 x double>* %43, align 8, !alias.scope !8, !noalias !10
  %44 = fadd <2 x double> %38, %wide.load
  %45 = fadd <2 x double> %39, %wide.load12
  ...
  br i1 %46, label %for.cond52.for.inc72_crit_edge.us.us.loopexit46, label %vector.body, !llvm.loop !11

for.cond52.for.inc72_crit_edge.us.us.loopexit:    ; preds = %for.body55.us.us
  br label %for.cond52.for.inc72_crit_edge.us.us

for.cond52.for.inc72_crit_edge.us.us.loopexit46:  ; preds = %vector.body
  br label %for.cond52.for.inc72_crit_edge.us.us

for.cond52.for.inc72_crit_edge.us.us:             ; preds = %for.cond52.for.inc72_crit_edge.us.us.loopexit46, %for.cond52.for.inc72_crit_edge.us.us.loopexit
...
vector.memcheck30:                                ; preds = %for.cond82.for.inc97_crit_edge.us, %vector.memcheck30.preheader
  %indvars.iv73 = phi i64 [ 0, %vector.memcheck30.preheader ], [ %55, %for.cond82.for.inc97_crit_edge.us ]
  %54 = bitcast i8* %call to [2000 x [2000 x double]]*
  %scevgep18 = getelementptr [2000 x double], [2000 x double]* %13, i64 %indvars.iv73, i64 0
  %55 = add i64 %indvars.iv73, 1
  %scevgep20 = getelementptr [2000 x double], [2000 x double]* %13, i64 %55, i64 0
  %scevgep22 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %54, i64 0, i64 %indvars.iv73, i64 0
  %scevgep24 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %54, i64 0, i64 %55, i64 0
...
vector.body13:                                    ; preds = %vector.body13, %vector.body13.preheader
  ...
  %57 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %56, i64 0, i64 %indvars.iv73, i64 %index32
  %58 = bitcast double* %57 to <2 x i64>*
  %wide.load40 = load <2 x i64>, <2 x i64>* %58, align 8, !alias.scope !15
  %59 = getelementptr double, double* %57, i64 2
  %60 = bitcast double* %59 to <2 x i64>*
  %wide.load41 = load <2 x i64>, <2 x i64>* %60, align 8, !alias.scope !15
  %61 = getelementptr inbounds [2000 x double], [2000 x double]* %13, i64 %indvars.iv73, i64 %index32
  %62 = bitcast double* %61 to <2 x i64>*
  store <2 x i64> %wide.load40, <2 x i64>* %62, align 8, !alias.scope !18, !noalias !15
  %63 = getelementptr double, double* %61, i64 2
  %64 = bitcast double* %63 to <2 x i64>*
  store <2 x i64> %wide.load41, <2 x i64>* %64, align 8, !alias.scope !18, !noalias !15
  %index.next33 = or i64 %index32, 4
  %65 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %56, i64 0, i64 %indvars.iv73, i64 %index.next33
  %66 = bitcast double* %65 to <2 x i64>*
  %wide.load40.1 = load <2 x i64>, <2 x i64>* %66, align 8, !alias.scope !15
  %67 = getelementptr double, double* %65, i64 2
  %68 = bitcast double* %67 to <2 x i64>*
  %wide.load41.1 = load <2 x i64>, <2 x i64>* %68, align 8, !alias.scope !15
  %69 = getelementptr inbounds [2000 x double], [2000 x double]* %13, i64 %indvars.iv73, i64 %index.next33
  %70 = bitcast double* %69 to <2 x i64>*
  store <2 x i64> %wide.load40.1, <2 x i64>* %70, align 8, !alias.scope !18, !noalias !15
  %71 = getelementptr double, double* %69, i64 2
  %72 = bitcast double* %71 to <2 x i64>*
  store <2 x i64> %wide.load41.1, <2 x i64>* %72, align 8, !alias.scope !18, !noalias !15
  %index.next33.1 = add nuw nsw i64 %index32, 8
  %73 = icmp eq i64 %index.next33.1, 2000
  br i1 %73, label %for.cond82.for.inc97_crit_edge.us.loopexit45, label %vector.body13, !llvm.loop !20
...
for.cond82.for.inc97_crit_edge.us.loopexit45:     ; preds = %vector.body13
  br label %for.cond82.for.inc97_crit_edge.us

for.cond82.for.inc97_crit_edge.us:                ; preds = %for.cond82.for.inc97_crit_edge.us.loopexit45, %for.cond82.for.inc97_crit_edge.us.loopexit
