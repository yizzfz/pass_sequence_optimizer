...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %middle.block
  ...
  %exitcond = icmp eq i64 %indvars.iv.next11, 4096
...
.lr.ph28.split.us:                                ; preds = %._crit_edge26.us, %.lr.ph28.split.us.preheader
  %indvars.iv136 = phi i64 [ 0, %.lr.ph28.split.us.preheader ], [ %indvars.iv.next137, %._crit_edge26.us ]
  br label %39

; <label>:39:                                     ; preds = %39, %.lr.ph28.split.us
  %indvars.iv132 = phi i64 [ 0, %.lr.ph28.split.us ], [ %indvars.iv.next133.1, %39 ]
  ...
  %43 = getelementptr inbounds [2160 x float], [2160 x float]* %3, i64 %indvars.iv136, i64 %indvars.iv132
  ...
  %50 = fmul float %40, %38
  %51 = fadd float %49, %50
  %52 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv136, i64 %indvars.iv132
  store float %51, float* %52, align 4
  %53 = load float, float* %43, align 4
  %indvars.iv.next133 = or i64 %indvars.iv132, 1
  %54 = getelementptr inbounds [2160 x float], [2160 x float]* %3, i64 %indvars.iv136, i64 %indvars.iv.next133
  ...
  %61 = fmul float %41, %38
  %62 = fadd float %60, %61
  %63 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv136, i64 %indvars.iv.next133
  store float %62, float* %63, align 4
  %64 = load float, float* %54, align 4
  %indvars.iv.next133.1 = add nsw i64 %indvars.iv132, 2
  %exitcond146.1 = icmp eq i64 %indvars.iv.next133.1, 2160
  br i1 %exitcond146.1, label %._crit_edge26.us, label %39

._crit_edge26.us:                                 ; preds = %39
  %indvars.iv.next137 = add nuw nsw i64 %indvars.iv136, 1
  %exitcond147 = icmp eq i64 %indvars.iv.next137, 4096
  br i1 %exitcond147, label %._crit_edge29, label %.lr.ph28.split.us
...
; <label>:65:                                     ; preds = %65, %.lr.ph22.split.us
  %indvars.iv125 = phi i64 [ 2160, %.lr.ph22.split.us ], [ %indvars.iv.next126.1, %65 ]
  ...
  %75 = fmul float %66, %38
  %76 = fadd float %74, %75
  %77 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv127, i64 %indvars.iv.next126
  store float %76, float* %77, align 4
  %78 = getelementptr inbounds [2160 x float], [2160 x float]* %3, i64 %indvars.iv127, i64 %indvars.iv.next126
  ...
  %85 = fmul float %67, %38
  %86 = fadd float %84, %85
  %87 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv127, i64 %indvars.iv.next126.1
  store float %86, float* %87, align 4
  %88 = getelementptr inbounds [2160 x float], [2160 x float]* %3, i64 %indvars.iv127, i64 %indvars.iv.next126.1
  %89 = load float, float* %88, align 4
  %90 = icmp sgt i64 %indvars.iv.next126, 1
  br i1 %90, label %65, label %._crit_edge20.us

._crit_edge20.us:                                 ; preds = %65
  %indvars.iv.next128 = add nuw nsw i64 %indvars.iv127, 1
  %exitcond145 = icmp eq i64 %indvars.iv.next128, 4096
  br i1 %exitcond145, label %._crit_edge23, label %.lr.ph22.split.us
...
.preheader1.us:                                   ; preds = %._crit_edge17.us, %.preheader1.us.preheader
  %indvars.iv120 = phi i64 [ 0, %.preheader1.us.preheader ], [ %indvars.iv.next121, %._crit_edge17.us ]
  %scevgep153 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv120, i64 2
  %scevgep159 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv120, i64 2
  %scevgep165 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv120, i64 2
  br i1 true, label %.prol.loopexit117, label %.prol.preheader116

.prol.preheader116:                               ; preds = %.preheader1.us
  br label %.prol.loopexit117

.prol.loopexit117:                                ; preds = %.prol.preheader116, %.preheader1.us
...
.preheader1.us.new.preheader:                     ; preds = %.prol.loopexit117
  %91 = sub nsw i64 2158, %indvars.iv112.unr.ph
  %92 = lshr i64 %91, 1
  %93 = add nuw nsw i64 %92, 1
  br i1 false, label %.preheader1.us.new.preheader229, label %min.iters.checked

min.iters.checked:                                ; preds = %.preheader1.us.new.preheader
  %n.mod.vf = and i64 %93, 3
  %n.vec = sub nsw i64 %93, %n.mod.vf
  br i1 false, label %.preheader1.us.new.preheader229, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %scevgep151 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv120, i64 %indvars.iv112.unr.ph
  %94 = sub nsw i64 2158, %indvars.iv112.unr.ph
  %95 = and i64 %94, 2158
  %96 = or i64 %indvars.iv112.unr.ph, %95
  %scevgep154 = getelementptr float, float* %scevgep153, i64 %96
  %scevgep157 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv120, i64 %indvars.iv112.unr.ph
  %scevgep160 = getelementptr float, float* %scevgep159, i64 %96
  %scevgep163 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv120, i64 %indvars.iv112.unr.ph
  %scevgep166 = getelementptr float, float* %scevgep165, i64 %96
  %bound0 = icmp ult float* %scevgep151, %scevgep160
  %bound1 = icmp ult float* %scevgep157, %scevgep154
  %found.conflict = and i1 %bound0, %bound1
  %bound0168 = icmp ult float* %scevgep151, %scevgep166
  %bound1169 = icmp ult float* %scevgep163, %scevgep154
  %found.conflict170 = and i1 %bound0168, %bound1169
  %conflict.rdx = or i1 %found.conflict, %found.conflict170
  %97 = or i64 %indvars.iv112.unr.ph, 2
  %98 = shl nuw nsw i64 %92, 1
  %99 = add nuw nsw i64 %97, %98
  %100 = shl nuw nsw i64 %n.mod.vf, 1
  %ind.end = sub nsw i64 %99, %100
  br i1 %conflict.rdx, label %.preheader1.us.new.preheader229, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %101 = shl i64 %index, 1
  %offset.idx = or i64 %indvars.iv112.unr.ph, %101
  %102 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv120, i64 %offset.idx
  %103 = bitcast float* %102 to <8 x float>*
  %wide.vec = load <8 x float>, <8 x float>* %103, align 4, !alias.scope !6
  %104 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv120, i64 %offset.idx
  %105 = bitcast float* %104 to <8 x float>*
  %wide.vec172 = load <8 x float>, <8 x float>* %105, align 4, !alias.scope !9
  %106 = fadd <8 x float> %wide.vec, %wide.vec172
  %107 = shufflevector <8 x float> %106, <8 x float> undef, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %108 = add nuw nsw i64 %offset.idx, 1
  %109 = fadd <8 x float> %wide.vec, %wide.vec172
  %110 = shufflevector <8 x float> %109, <8 x float> undef, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %111 = getelementptr inbounds [2160 x float], [2160 x float]* %4, i64 %indvars.iv120, i64 %108
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %._crit_edge17.us, label %.preheader1.us.new.preheader229

.preheader1.us.new.preheader229:                  ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.preheader1.us.new.preheader
  %indvars.iv112.ph = phi i64 [ %indvars.iv112.unr.ph, %vector.memcheck ], [ %indvars.iv112.unr.ph, %min.iters.checked ], [ %indvars.iv112.unr.ph, %.preheader1.us.new.preheader ], [ %ind.end, %middle.block ]
  br label %.preheader1.us.new

.preheader1.us.new:                               ; preds = %.preheader1.us.new.preheader229, %.preheader1.us.new
  %indvars.iv112 = phi i64 [ %indvars.iv.next113.1, %.preheader1.us.new ], [ %indvars.iv112.ph, %.preheader1.us.new.preheader229 ]
  %115 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv120, i64 %indvars.iv112
  %116 = load float, float* %115, align 4
  %117 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv120, i64 %indvars.iv112
  %118 = load float, float* %117, align 4
  %119 = fadd float %116, %118
  %120 = getelementptr inbounds [2160 x float], [2160 x float]* %4, i64 %indvars.iv120, i64 %indvars.iv112
  store float %119, float* %120, align 4
  %indvars.iv.next113 = add nuw nsw i64 %indvars.iv112, 1
  %121 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv120, i64 %indvars.iv.next113
  %122 = load float, float* %121, align 4
  %123 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv120, i64 %indvars.iv.next113
  %124 = load float, float* %123, align 4
  %125 = fadd float %122, %124
  %126 = getelementptr inbounds [2160 x float], [2160 x float]* %4, i64 %indvars.iv120, i64 %indvars.iv.next113
...
._crit_edge17.us:                                 ; preds = %._crit_edge17.us.loopexit, %middle.block, %.prol.loopexit117
  ...
  %exitcond144 = icmp eq i64 %indvars.iv.next121, 4096
  br i1 %exitcond144, label %.preheader.loopexit, label %.preheader1.us

.preheader.loopexit:                              ; preds = %._crit_edge17.us
  br label %.preheader

.preheader:                                       ; preds = %.preheader.loopexit, %7, %._crit_edge29, %._crit_edge23
...
.lr.ph14.split.us:                                ; preds = %._crit_edge13.us, %.lr.ph14.split.us.preheader
  %indvars.iv107 = phi i64 [ 0, %.lr.ph14.split.us.preheader ], [ %indvars.iv.next108, %._crit_edge13.us ]
  br label %127

; <label>:127:                                    ; preds = %127, %.lr.ph14.split.us
  %indvars.iv103 = phi i64 [ 0, %.lr.ph14.split.us ], [ %indvars.iv.next104.1, %127 ]
  ...
  %131 = getelementptr inbounds [2160 x float], [2160 x float]* %4, i64 %indvars.iv103, i64 %indvars.iv107
  ...
  %140 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv103, i64 %indvars.iv107
  store float %139, float* %140, align 4
  %141 = load float, float* %131, align 4
  %indvars.iv.next104 = or i64 %indvars.iv103, 1
  %142 = getelementptr inbounds [2160 x float], [2160 x float]* %4, i64 %indvars.iv.next104, i64 %indvars.iv107
  ...
  %151 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv.next104, i64 %indvars.iv107
  store float %150, float* %151, align 4
  %152 = load float, float* %142, align 4
  %indvars.iv.next104.1 = add nsw i64 %indvars.iv103, 2
  %exitcond142.1 = icmp eq i64 %indvars.iv.next104.1, 4096
  br i1 %exitcond142.1, label %._crit_edge13.us, label %127

._crit_edge13.us:                                 ; preds = %127
  %indvars.iv.next108 = add nuw nsw i64 %indvars.iv107, 1
  %exitcond143 = icmp eq i64 %indvars.iv.next108, 2160
  br i1 %exitcond143, label %._crit_edge15, label %.lr.ph14.split.us
...
; <label>:153:                                    ; preds = %153, %.lr.ph9.split.us
  %indvars.iv96 = phi i64 [ 4096, %.lr.ph9.split.us ], [ %indvars.iv.next97.1, %153 ]
  %154 = phi float [ 0.000000e+00, %.lr.ph9.split.us ], [ %164, %153 ]
  %155 = phi float [ 0.000000e+00, %.lr.ph9.split.us ], [ %174, %153 ]
  %156 = phi float [ 0.000000e+00, %.lr.ph9.split.us ], [ %167, %153 ]
  %157 = phi float [ 0.000000e+00, %.lr.ph9.split.us ], [ %177, %153 ]
  ...
  %165 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv.next97, i64 %indvars.iv98
  store float %164, float* %165, align 4
  %166 = getelementptr inbounds [2160 x float], [2160 x float]* %4, i64 %indvars.iv.next97, i64 %indvars.iv98
  ...
  %175 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv.next97.1, i64 %indvars.iv98
  store float %174, float* %175, align 4
  %176 = getelementptr inbounds [2160 x float], [2160 x float]* %4, i64 %indvars.iv.next97.1, i64 %indvars.iv98
  %177 = load float, float* %176, align 4
  %178 = icmp sgt i64 %indvars.iv.next97, 1
  br i1 %178, label %153, label %._crit_edge7.us

._crit_edge7.us:                                  ; preds = %153
  %indvars.iv.next99 = add nuw nsw i64 %indvars.iv98, 1
  %exitcond = icmp eq i64 %indvars.iv.next99, 2160
  br i1 %exitcond, label %._crit_edge10.loopexit, label %.lr.ph9.split.us

._crit_edge10.loopexit:                           ; preds = %._crit_edge7.us
  br label %._crit_edge10

._crit_edge10:                                    ; preds = %._crit_edge10.loopexit, %.preheader, %.lr.ph9, %._crit_edge15
  %179 = phi i1 [ true, %._crit_edge15 ], [ false, %.lr.ph9 ], [ true, %.preheader ], [ false, %._crit_edge10.loopexit ]
  br i1 %179, label %._crit_edge4, label %.lr.ph3.split.us.preheader
...
.lr.ph3.split.us:                                 ; preds = %._crit_edge.us, %.lr.ph3.split.us.preheader
  %indvars.iv92 = phi i64 [ 0, %.lr.ph3.split.us.preheader ], [ %indvars.iv.next93, %._crit_edge.us ]
  %scevgep187 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv92, i64 2
  %scevgep193 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv92, i64 2
  %scevgep199 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv92, i64 2
...
.lr.ph3.split.us.new.preheader:                   ; preds = %.prol.loopexit
  ...
  br i1 false, label %.lr.ph3.split.us.new.preheader228, label %min.iters.checked179

min.iters.checked179:                             ; preds = %.lr.ph3.split.us.new.preheader
  %n.mod.vf180 = and i64 %182, 3
  %n.vec181 = sub nsw i64 %182, %n.mod.vf180
  br i1 false, label %.lr.ph3.split.us.new.preheader228, label %vector.memcheck210

vector.memcheck210:                               ; preds = %min.iters.checked179
  %scevgep185 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv92, i64 %indvars.iv.unr.ph
  %183 = sub nsw i64 2158, %indvars.iv.unr.ph
  %184 = and i64 %183, 2158
  %185 = or i64 %indvars.iv.unr.ph, %184
  %scevgep188 = getelementptr float, float* %scevgep187, i64 %185
  %scevgep191 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv92, i64 %indvars.iv.unr.ph
  %scevgep194 = getelementptr float, float* %scevgep193, i64 %185
  %scevgep197 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv92, i64 %indvars.iv.unr.ph
  %scevgep200 = getelementptr float, float* %scevgep199, i64 %185
  %bound0202 = icmp ult float* %scevgep185, %scevgep194
  %bound1203 = icmp ult float* %scevgep191, %scevgep188
  %found.conflict204 = and i1 %bound0202, %bound1203
  %bound0205 = icmp ult float* %scevgep185, %scevgep200
  %bound1206 = icmp ult float* %scevgep197, %scevgep188
  ...
  %189 = shl nuw nsw i64 %n.mod.vf180, 1
  %ind.end215 = sub nsw i64 %188, %189
  br i1 %conflict.rdx208, label %.lr.ph3.split.us.new.preheader228, label %vector.body175.preheader

vector.body175.preheader:                         ; preds = %vector.memcheck210
  br label %vector.body175

vector.body175:                                   ; preds = %vector.body175.preheader, %vector.body175
  %index212 = phi i64 [ %index.next213, %vector.body175 ], [ 0, %vector.body175.preheader ]
  %190 = shl i64 %index212, 1
  %offset.idx217 = or i64 %indvars.iv.unr.ph, %190
  %191 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv92, i64 %offset.idx217
  %192 = bitcast float* %191 to <8 x float>*
  %wide.vec221 = load <8 x float>, <8 x float>* %192, align 4, !alias.scope !16
  %193 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv92, i64 %offset.idx217
  %194 = bitcast float* %193 to <8 x float>*
  %wide.vec224 = load <8 x float>, <8 x float>* %194, align 4, !alias.scope !19
  %195 = fadd <8 x float> %wide.vec221, %wide.vec224
  %196 = shufflevector <8 x float> %195, <8 x float> undef, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %197 = add nuw nsw i64 %offset.idx217, 1
  %198 = fadd <8 x float> %wide.vec221, %wide.vec224
  %199 = shufflevector <8 x float> %198, <8 x float> undef, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %200 = getelementptr inbounds [2160 x float], [2160 x float]* %4, i64 %indvars.iv92, i64 %197
  %201 = getelementptr float, float* %200, i64 -1
  %202 = bitcast float* %201 to <8 x float>*
  %interleaved.vec227 = shufflevector <4 x float> %196, <4 x float> %199, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x float> %interleaved.vec227, <8 x float>* %202, align 4, !alias.scope !21, !noalias !23
  %index.next213 = add i64 %index212, 4
  %203 = icmp eq i64 %index.next213, %n.vec181
  br i1 %203, label %middle.block176, label %vector.body175, !llvm.loop !24

middle.block176:                                  ; preds = %vector.body175
  %cmp.n216 = icmp eq i64 %n.mod.vf180, 0
  br i1 %cmp.n216, label %._crit_edge.us, label %.lr.ph3.split.us.new.preheader228

.lr.ph3.split.us.new.preheader228:                ; preds = %middle.block176, %vector.memcheck210, %min.iters.checked179, %.lr.ph3.split.us.new.preheader
  %indvars.iv.ph = phi i64 [ %indvars.iv.unr.ph, %vector.memcheck210 ], [ %indvars.iv.unr.ph, %min.iters.checked179 ], [ %indvars.iv.unr.ph, %.lr.ph3.split.us.new.preheader ], [ %ind.end215, %middle.block176 ]
  br label %.lr.ph3.split.us.new

.lr.ph3.split.us.new:                             ; preds = %.lr.ph3.split.us.new.preheader228, %.lr.ph3.split.us.new
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.lr.ph3.split.us.new ], [ %indvars.iv.ph, %.lr.ph3.split.us.new.preheader228 ]
  %204 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv92, i64 %indvars.iv
  %205 = load float, float* %204, align 4
  %206 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv92, i64 %indvars.iv
  %207 = load float, float* %206, align 4
  %208 = fadd float %205, %207
  %209 = getelementptr inbounds [2160 x float], [2160 x float]* %4, i64 %indvars.iv92, i64 %indvars.iv
  store float %208, float* %209, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %210 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv92, i64 %indvars.iv.next
  %211 = load float, float* %210, align 4
  %212 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv92, i64 %indvars.iv.next
  %213 = load float, float* %212, align 4
  %214 = fadd float %211, %213
  %215 = getelementptr inbounds [2160 x float], [2160 x float]* %4, i64 %indvars.iv92, i64 %indvars.iv.next
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %middle.block176, %.prol.loopexit
  %indvars.iv.next93 = add nuw nsw i64 %indvars.iv92, 1
  %exitcond141 = icmp eq i64 %indvars.iv.next93, 4096
  br i1 %exitcond141, label %._crit_edge4.loopexit, label %.lr.ph3.split.us

._crit_edge4.loopexit:                            ; preds = %._crit_edge.us
  br label %._crit_edge4

._crit_edge4:                                     ; preds = %._crit_edge4.loopexit, %._crit_edge10, %.lr.ph14, %.preheader1.lr.ph, %.lr.ph28, %.lr.ph22
  ret void
}
...
; <label>:16:                                     ; preds = %14, %9
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond16 = icmp eq i64 %indvars.iv.next, 2160
  br i1 %exitcond16, label %._crit_edge.us, label %9

._crit_edge.us:                                   ; preds = %16
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond = icmp eq i64 %indvars.iv.next12, 4096
  br i1 %exitcond, label %._crit_edge3.loopexit, label %.lr.ph2.split.us
