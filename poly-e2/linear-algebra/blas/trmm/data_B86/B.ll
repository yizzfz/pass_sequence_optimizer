...
for.body.us:                                      ; preds = %entry, %for.cond11.for.inc27_crit_edge.us
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.cond11.for.inc27_crit_edge.us ], [ 0, %entry ]
...
for.body.us:                                      ; preds = %for.cond1.for.inc30_crit_edge.us, %entry
  %indvars.iv = phi i64 [ 1, %entry ], [ %2, %for.cond1.for.inc30_crit_edge.us ]
  %indvars.iv24 = phi i64 [ 0, %entry ], [ %indvars.iv.next25, %for.cond1.for.inc30_crit_edge.us ]
