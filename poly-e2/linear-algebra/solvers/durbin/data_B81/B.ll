...
for.inc.lr.ph:                                    ; preds = %for.inc47.for.inc.lr.ph_crit_edge, %entry
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc47.for.inc.lr.ph_crit_edge ], [ 1, %entry ]
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc47.for.inc.lr.ph_crit_edge ], [ 0, %entry ]
...
for.inc:                                          ; preds = %for.inc.for.inc_crit_edge, %for.inc.lr.ph
  ...
  %sum.07 = phi double [ 0.000000e+00, %for.inc.lr.ph ], [ %add, %for.inc.for.inc_crit_edge ]
...
for.inc32:                                        ; preds = %for.inc32.for.inc32_crit_edge, %for.inc32.lr.ph
  %indvars.iv19 = phi i64 [ 0, %for.inc32.lr.ph ], [ %indvars.iv.next20, %for.inc32.for.inc32_crit_edge ]
  %arrayidx23 = getelementptr inbounds double, double* %y, i64 %indvars.iv19
  %10 = load double, double* %arrayidx23, align 8
  %11 = sub nsw i64 %5, %indvars.iv19
  ...
  br i1 %exitcond25, label %for.inc47, label %for.inc32.for.inc32_crit_edge
...
for.inc47:                                        ; preds = %for.inc32
  ...
  %cmp = icmp slt i64 %indvars.iv.next37, 2000
