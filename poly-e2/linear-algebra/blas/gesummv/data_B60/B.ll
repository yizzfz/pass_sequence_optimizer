...
entry:
  ...
  call fastcc void @kernel_gesummv(i32 1300, double %0, double %1, [1300 x double]* %arraydecay1, [1300 x double]* %arraydecay72, double* %arraydecay116, double* %arraydecay83, double* %arraydecay138)
...
for.body.us:                                      ; preds = %for.cond2.for.inc24_crit_edge.us, %entry
  %indvars.iv10 = phi i64 [ 0, %entry ], [ %indvars.iv.next11, %for.cond2.for.inc24_crit_edge.us ]
...
for.inc.us:                                       ; preds = %for.inc.us, %for.body.us
  ...
  %1 = mul nuw nsw i64 %indvars.iv10, %indvars.iv
...
for.cond2.for.inc24_crit_edge.us:                 ; preds = %for.inc.us
  ...
  br i1 %exitcond13, label %for.end26, label %for.body.us
...
for.body.us:                                      ; preds = %for.cond5.for.inc39_crit_edge.us, %entry
  %indvars.iv14 = phi i64 [ 0, %entry ], [ %indvars.iv.next15, %for.cond5.for.inc39_crit_edge.us ]
  %arrayidx.us = getelementptr inbounds double, double* %tmp, i64 %indvars.iv14
  store double 0.000000e+00, double* %arrayidx.us, align 8
  %arrayidx4.us = getelementptr inbounds double, double* %y, i64 %indvars.iv14
  ...
  %sunkaddr28 = shl i64 %indvars.iv14, 3
...
for.inc.us:                                       ; preds = %for.inc.us, %for.body.us
  %indvars.iv = phi i64 [ 0, %for.body.us ], [ %indvars.iv.next, %for.inc.us ]
  %arrayidx11.us = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv14, i64 %indvars.iv
  ...
  %arrayidx21.us = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv14, i64 %indvars.iv
  %4 = load double, double* %arrayidx21.us, align 8
  %5 = load double, double* %arrayidx13.us, align 8
  %mul24.us = fmul double %4, %5
  %6 = load double, double* %sunkaddr30, align 8
  %add27.us = fadd double %mul24.us, %6
  store double %add27.us, double* %sunkaddr30, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
  br i1 %exitcond, label %for.cond5.for.inc39_crit_edge.us, label %for.inc.us

for.cond5.for.inc39_crit_edge.us:                 ; preds = %for.inc.us
  %arrayidx31.us = getelementptr inbounds double, double* %tmp, i64 %indvars.iv14
  %7 = load double, double* %arrayidx31.us, align 8
  %mul32.us = fmul double %7, %alpha
  %sunkaddr21 = shl i64 %indvars.iv14, 3
  %sunkaddr22 = add i64 %0, %sunkaddr21
  %sunkaddr23 = inttoptr i64 %sunkaddr22 to double*
  %8 = load double, double* %sunkaddr23, align 8
  %mul35.us = fmul double %8, %beta
  %add36.us = fadd double %mul32.us, %mul35.us
  store double %add36.us, double* %sunkaddr23, align 8
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  %exitcond17 = icmp eq i64 %indvars.iv.next15, 1300
  br i1 %exitcond17, label %for.end41, label %for.body.us
