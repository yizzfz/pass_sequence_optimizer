...
define internal fastcc void @init_array(i32, [120 x [120 x double]]*, [120 x [120 x double]]*) unnamed_addr #2 {
  ...
  %9 = icmp sgt i32 %0, 0
  br i1 %9, label %.preheader3.lr.ph, label %35
...
.preheader3.us:                                   ; preds = %.preheader3.us.preheader, %._crit_edge5.us
  %indvars.iv38 = phi i64 [ %16, %.preheader3.us.preheader ], [ %indvars.iv.next39, %._crit_edge5.us ]
  br i1 %18, label %.preheader.us.us.preheader, label %._crit_edge5.us
...
._crit_edge5.us:                                  ; preds = %._crit_edge5.us.loopexit, %.preheader3.us
  ...
  %20 = icmp slt i64 %indvars.iv.next39, %17
...
; <label>:22:                                     ; preds = %22, %.preheader.us.us
  ...
  %29 = fdiv double %28, %15
  %30 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %13, i64 %indvars.iv38, i64 %indvars.iv36, i64 %indvars.iv
  store double %29, double* %30, align 8
  %31 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %14, i64 %indvars.iv38, i64 %indvars.iv36, i64 %indvars.iv
  store double %29, double* %31, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond33 = icmp eq i64 %indvars.iv.next, %11
  br i1 %exitcond33, label %._crit_edge.us.us, label %22
...
._crit_edge6.loopexit:                            ; preds = %._crit_edge5.us
  %34 = trunc i64 %indvars.iv.next39 to i32
  br label %._crit_edge6
...
._crit_edge6:                                     ; preds = %._crit_edge6.loopexit, %._crit_edge6.loopexit29
  ...
  %.lcssa11 = phi i32 [ %smax, %._crit_edge6.loopexit29 ], [ %34, %._crit_edge6.loopexit ]
  store i32 %.lcssa11, i32* %7, align 4
  store i32 %.lcssa10.lcssa16.lcssa, i32* %8, align 4
  br label %35

; <label>:35:                                     ; preds = %._crit_edge6, %3
  ret void
}
...
.preheader7.us:                                   ; preds = %._crit_edge.us, %.preheader7.us.preheader
  %indvars.iv5 = phi i64 [ 1, %.preheader7.us.preheader ], [ %indvars.iv.next6, %._crit_edge.us ]
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1
  %37 = add nsw i64 %indvars.iv5, -1
  br label %38

; <label>:38:                                     ; preds = %38, %.preheader7.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %38 ], [ 1, %.preheader7.us ]
  %39 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %35, i64 %indvars.iv5, i64 %indvars.iv
  %40 = load double, double* %39, align 8
  %41 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv61, i64 %indvars.iv5, i64 %indvars.iv
  %42 = load double, double* %41, align 8
  %43 = fmul double %42, 2.000000e+00
  %44 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %36, i64 %indvars.iv5, i64 %indvars.iv
  %45 = load double, double* %44, align 8
  %46 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv61, i64 %indvars.iv.next6, i64 %indvars.iv
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %65 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv61, i64 %indvars.iv5, i64 %indvars.iv.next
  %66 = load double, double* %65, align 8
  %67 = fsub double %66, %43
  %68 = add nsw i64 %indvars.iv, -1
  %69 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv61, i64 %indvars.iv5, i64 %68
  %70 = load double, double* %69, align 8
  %71 = fadd double %67, %70
  %72 = fmul double %71, 1.250000e-01
  %73 = fadd double %64, %72
  %74 = fadd double %42, %73
  %75 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvars.iv61, i64 %indvars.iv5, i64 %indvars.iv
  store double %74, double* %75, align 8
  %exitcond1 = icmp eq i64 %indvars.iv.next, %26
  br i1 %exitcond1, label %._crit_edge.us, label %38
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge16.us
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %._crit_edge16.us ], [ 1, %.preheader.us.preheader ]
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %79 = add nsw i64 %indvars.iv7, -1
  br label %80

; <label>:80:                                     ; preds = %80, %.preheader.us
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %80 ], [ 1, %.preheader.us ]
  %81 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %18, i64 %77, i64 %indvars.iv7, i64 %indvars.iv64
  %82 = load double, double* %81, align 8
  %83 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %18, i64 %indvars.iv68, i64 %indvars.iv7, i64 %indvars.iv64
  %84 = load double, double* %83, align 8
  %85 = fmul double %84, 2.000000e+00
  %86 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %18, i64 %78, i64 %indvars.iv7, i64 %indvars.iv64
  %87 = load double, double* %86, align 8
  %88 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %18, i64 %indvars.iv68, i64 %indvars.iv.next8, i64 %indvars.iv64
  ...
  %107 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %18, i64 %indvars.iv68, i64 %indvars.iv7, i64 %indvars.iv.next65
  %108 = load double, double* %107, align 8
  %109 = fsub double %108, %85
  %110 = add nsw i64 %indvars.iv64, -1
  %111 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %18, i64 %indvars.iv68, i64 %indvars.iv7, i64 %110
  %112 = load double, double* %111, align 8
  %113 = fadd double %109, %112
  %114 = fmul double %113, 1.250000e-01
  %115 = fadd double %106, %114
  %116 = fadd double %84, %115
  %117 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %19, i64 %indvars.iv68, i64 %indvars.iv7, i64 %indvars.iv64
  store double %116, double* %117, align 8
  %118 = icmp slt i64 %indvars.iv.next65, %23
  br i1 %118, label %80, label %._crit_edge16.us

._crit_edge16.us:                                 ; preds = %80
  %119 = icmp slt i64 %indvars.iv.next8, %27
...
._crit_edge17:                                    ; preds = %._crit_edge17.loopexit, %.preheader.lr.ph, %.preheader8
  ...
  %120 = icmp slt i64 %indvars.iv.next69, %25
...
.preheader3.us:                                   ; preds = %.preheader3.us.preheader, %._crit_edge5.us
  %indvars.iv38 = phi i64 [ %17, %.preheader3.us.preheader ], [ %indvars.iv.next39, %._crit_edge5.us ]
  br i1 %20, label %.preheader.us.us.preheader, label %._crit_edge5.us

.preheader.us.us.preheader:                       ; preds = %.preheader3.us
  %21 = mul nsw i64 %indvars.iv38, %19
...
._crit_edge5.us:                                  ; preds = %._crit_edge5.us.loopexit, %.preheader3.us
  ...
  %indvars.iv.next39 = add nsw i64 %indvars.iv38, 1
  %23 = icmp slt i64 %indvars.iv.next39, %18
  br i1 %23, label %.preheader3.us, label %._crit_edge6.loopexit

.preheader.us.us:                                 ; preds = %._crit_edge.us.us, %.preheader.us.us.preheader
  %indvars.iv36 = phi i64 [ 0, %.preheader.us.us.preheader ], [ %indvars.iv.next37, %._crit_edge.us.us ]
  %24 = trunc i64 %indvars.iv36 to i32
  %25 = add i32 %22, %24
  %26 = mul i32 %25, %13
...
; <label>:28:                                     ; preds = %35, %.preheader.us.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %35 ], [ 0, %.preheader.us.us ]
  %29 = add i64 %27, %indvars.iv
...
; <label>:33:                                     ; preds = %28
  ...
  %fputc.us.us = tail call i32 @fputc(i32 10, %struct._IO_FILE* %34) #5
  br label %35

; <label>:35:                                     ; preds = %33, %28
  %36 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %37 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %16, i64 %indvars.iv38, i64 %indvars.iv36, i64 %indvars.iv
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond33 = icmp eq i64 %indvars.iv.next, %14
  br i1 %exitcond33, label %._crit_edge.us.us, label %28
...
._crit_edge6:                                     ; preds = %._crit_edge6.loopexit, %._crit_edge6.loopexit29
  %.lcssa10.lcssa16.lcssa = phi i32 [ %.promoted14, %._crit_edge6.loopexit29 ], [ %.lcssa10.lcssa.us, %._crit_edge6.loopexit ]
  %.lcssa11 = phi i32 [ %smax, %._crit_edge6.loopexit29 ], [ %42, %._crit_edge6.loopexit ]
