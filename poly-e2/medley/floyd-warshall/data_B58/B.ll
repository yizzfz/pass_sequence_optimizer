...
for.cond1.preheader:                              ; preds = %for.inc38, %entry
  %indvars.iv29 = phi i64 [ 0, %entry ], [ %0, %for.inc38 ]
...
for.cond4.preheader:                              ; preds = %for.inc35, %for.cond1.preheader
  %indvars.iv27 = phi i64 [ 0, %for.cond1.preheader ], [ %1, %for.inc35 ]
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %9 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv29, i64 %index
  ...
  br i1 %19, label %for.inc35.loopexit18, label %vector.body, !llvm.loop !9
