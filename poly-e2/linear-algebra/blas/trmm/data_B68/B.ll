...
for.body.us:                                      ; preds = %for.cond11.for.end26_crit_edge.us, %for.body.us.preheader
  %indvars.iv24 = phi i64 [ 0, %for.body.us.preheader ], [ %indvars.iv.next25, %for.cond11.for.end26_crit_edge.us ]
...
for.body3.us13.prol.preheader78:                  ; preds = %for.body3.us13.preheader75
  br label %for.body3.us13.prol81

for.body3.us13.prol81:                            ; preds = %for.body3.us13.prol.preheader78
  %arrayidx21.us18.prol83 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv66, i64 %indvars.iv.unr
  %8 = bitcast double* %arrayidx21.us18.prol83 to <2 x double>*
  %9 = load <2 x double>, <2 x double>* %8, align 8
  %mul22.us19.prol84 = fmul <2 x double> %mul22.us19.v.i0.2, %9
  store <2 x double> %mul22.us19.prol84, <2 x double>* %8, align 8
...
for.body3.us13.prol.loopexit79.unr-lcssa:         ; preds = %for.body3.us13.preheader75, %for.body3.us13.prol81
  %indvars.iv.unr85.ph = phi i64 [ %indvars.iv.next.3.prol, %for.body3.us13.prol81 ], [ %indvars.iv.unr, %for.body3.us13.preheader75 ]
  br label %for.body3.us13.prol.loopexit79

for.body3.us13.prol.loopexit79:                   ; preds = %for.body3.us13.prol.loopexit79.unr-lcssa
  br i1 false, label %for.cond1.for.end29_crit_edge.us.loopexit77, label %for.body3.us13.preheader75.new

for.body3.us13.preheader75.new:                   ; preds = %for.body3.us13.prol.loopexit79
  br label %for.body3.us13

for.body3.us13:                                   ; preds = %for.body3.us13, %for.body3.us13.preheader75.new
  %indvars.iv = phi i64 [ %indvars.iv.unr85.ph, %for.body3.us13.preheader75.new ], [ %indvars.iv.next.3.1, %for.body3.us13 ]
...
for.body3.us.us:                                  ; preds = %for.cond4.for.end_crit_edge.us.us, %for.body3.us.us.preheader
  %indvars.iv63 = phi i64 [ 0, %for.body3.us.us.preheader ], [ %indvars.iv.next64, %for.cond4.for.end_crit_edge.us.us ]
