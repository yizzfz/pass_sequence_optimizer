...
entry:
  ...
  call fastcc void @init_array(double* %arraydecay1, double* %arraydecay52, double* %arraydecay63, double* %arraydecay74, [2000 x double]* %arraydecay85)
  call void (...) @polybench_timer_start() #4
  call fastcc void @kernel_mvt(double* %arraydecay1, double* %arraydecay52, double* %arraydecay63, double* %arraydecay74, [2000 x double]* %arraydecay85)
...
for.body:                                         ; preds = %for.end, %entry
  ...
  %arrayidx = getelementptr inbounds double, double* %x1, i64 %indvars.iv5
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1
  %1 = icmp eq i64 %indvars.iv.next6, 2000
  ...
  %arrayidx7 = getelementptr inbounds double, double* %x2, i64 %indvars.iv5
  ...
  %arrayidx14 = getelementptr inbounds double, double* %y_1, i64 %indvars.iv5
  %6 = add nuw nsw i64 %indvars.iv5, 4
  ...
  %arrayidx21 = getelementptr inbounds double, double* %y_2, i64 %indvars.iv5
...
for.body25:                                       ; preds = %for.body25, %for.body
  ...
  %arrayidx33 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv5, i64 %indvars.iv
  %indvars.iv.next = or i64 %indvars.iv, 1
  %10 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv5
  ...
  br i1 %exitcond.1, label %for.end, label %for.body25

for.end:                                          ; preds = %for.body25
  %13 = icmp eq i64 %indvars.iv.next6, 2000
...
for.body:                                         ; preds = %for.end, %entry
  %indvars.iv18 = phi i64 [ 0, %entry ], [ %indvars.iv.next19, %for.end ]
  %arrayidx = getelementptr inbounds double, double* %x1, i64 %indvars.iv18
...
for.body3:                                        ; preds = %for.body3, %for.body
  %indvars.iv11 = phi i64 [ %indvars.iv.next12.1, %for.body3 ], [ 0, %for.body ]
  %0 = phi double [ %add.1, %for.body3 ], [ %.pre, %for.body ]
  %arrayidx7 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv18, i64 %indvars.iv11
  %1 = load double, double* %arrayidx7, align 8
  %arrayidx9 = getelementptr inbounds double, double* %y_1, i64 %indvars.iv11
  ...
  %arrayidx7.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv18, i64 %indvars.iv.next12
  %3 = load double, double* %arrayidx7.1, align 8
  %arrayidx9.1 = getelementptr inbounds double, double* %y_1, i64 %indvars.iv.next12
  ...
  br i1 %exitcond14.1, label %for.end, label %for.body3
...
for.body17:                                       ; preds = %for.body17.preheader, %for.end35
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.end35 ], [ 0, %for.body17.preheader ]
  %arrayidx22 = getelementptr inbounds double, double* %x2, i64 %indvars.iv8
  %.pre7 = load double, double* %arrayidx22, align 8
  %sunkaddr5 = mul i64 %indvars.iv8, 8
...
for.body20:                                       ; preds = %for.body20, %for.body17
  ...
  %5 = phi double [ %add30.1, %for.body20 ], [ %.pre7, %for.body17 ]
  %arrayidx26 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv, i64 %indvars.iv8
  ...
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx26.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv.next, i64 %indvars.iv8
...
for.end35:                                        ; preds = %for.body20
  ...
  %exitcond22 = icmp eq i64 %indvars.iv.next9, 2000
...
for.body:                                         ; preds = %if.end, %entry
  %indvars.iv7 = phi i64 [ 0, %entry ], [ %indvars.iv.next8, %if.end ]
...
if.then:                                          ; preds = %for.body
  ...
  %fputc6 = call i32 @fputc(i32 10, %struct._IO_FILE* %4) #5
  br label %if.end
...
if.end14:                                         ; preds = %for.body9, %if.then12
  ...
  br i1 %exitcond11, label %for.end20, label %for.body9
