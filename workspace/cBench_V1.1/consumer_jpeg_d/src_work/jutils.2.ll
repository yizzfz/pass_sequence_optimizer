...
@__llvm_prf_nm = private constant [60 x i8] c"C:x\DA\CBJ\C9,\8B/\CA/\CDK\89/-`\CCB\B0\92\F3\0B*\E3\8B\13s\0BrR\81\F2\E5\C5P\91\A4\9C\FC\E4l\90\00cVUjQ~|Zb\11\00\88\F8\1A\8B", section "__llvm_prf_names"
@llvm.used = appending global [6 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jdiv_round_up to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jround_up to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jcopy_sample_rows to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jcopy_block_row to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jzero_far to i8*), i8* getelementptr inbounds ([60 x i8], [60 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
