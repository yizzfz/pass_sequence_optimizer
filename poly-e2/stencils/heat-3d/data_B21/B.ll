...
for.cond8.preheader.lr.ph:                        ; preds = %for.cond4.preheader.preheader, %for.inc98
  %indvar58 = phi i64 [ 0, %for.cond4.preheader.preheader ], [ %indvar.next59, %for.inc98 ]
  %indvars.iv19 = phi i64 [ 1, %for.cond4.preheader.preheader ], [ %indvars.iv.next20, %for.inc98 ]
  %0 = add i64 %indvar58, 1
  %1 = add i64 %indvar58, 2
...
for.cond8.preheader.us:                           ; preds = %for.cond8.for.inc95_crit_edge.us, %for.cond8.preheader.lr.ph
  %indvar60 = phi i64 [ %indvar.next61, %for.cond8.for.inc95_crit_edge.us ], [ 0, %for.cond8.preheader.lr.ph ]
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.cond8.for.inc95_crit_edge.us ], [ 1, %for.cond8.preheader.lr.ph ]
  %4 = add i64 %indvar60, 1
  ...
  br i1 %memcheck.conflict73, label %for.body11.us.preheader, label %vector.body53.preheader
...
vector.body53:                                    ; preds = %vector.body53.preheader, %vector.body53
  ...
  %28 = add nsw i64 %offset.idx80, -1
  %29 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv19, i64 %indvars.iv15, i64 %28
  %30 = bitcast double* %29 to <2 x double>*
  %wide.load90 = load <2 x double>, <2 x double>* %30, align 8, !alias.scope !1
  %31 = fadd <2 x double> %27, %wide.load90
  %32 = fmul <2 x double> %31, <double 1.250000e-01, double 1.250000e-01>
  %33 = fadd <2 x double> %23, %32
  %34 = fadd <2 x double> %wide.load85, %33
  %35 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv19, i64 %indvars.iv15, i64 %offset.idx80
  %36 = bitcast double* %35 to <2 x double>*
  store <2 x double> %34, <2 x double>* %36, align 8, !alias.scope !4, !noalias !1
  %index.next77 = add i64 %index76, 2
  %37 = icmp eq i64 %index.next77, 118
  br i1 %37, label %for.cond8.for.inc95_crit_edge.us.loopexit92, label %vector.body53, !llvm.loop !6
...
for.cond109.preheader.lr.ph:                      ; preds = %for.cond109.preheader.lr.ph.preheader, %for.inc206
  ...
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc206 ], [ 1, %for.cond109.preheader.lr.ph.preheader ]
  %46 = add i64 %indvar, 1
  %47 = add i64 %indvar, 2
...
for.cond109.preheader.us:                         ; preds = %for.cond109.for.inc203_crit_edge.us, %for.cond109.preheader.lr.ph
  %indvar38 = phi i64 [ %indvar.next39, %for.cond109.for.inc203_crit_edge.us ], [ 0, %for.cond109.preheader.lr.ph ]
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.cond109.for.inc203_crit_edge.us ], [ 1, %for.cond109.preheader.lr.ph ]
  %50 = add i64 %indvar38, 1
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %75 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv32, i64 %indvars.iv28, i64 %74
  %76 = bitcast double* %75 to <2 x double>*
  %wide.load52 = load <2 x double>, <2 x double>* %76, align 8, !alias.scope !10
  %77 = fadd <2 x double> %73, %wide.load52
  %78 = fmul <2 x double> %77, <double 1.250000e-01, double 1.250000e-01>
  %79 = fadd <2 x double> %69, %78
  %80 = fadd <2 x double> %wide.load47, %79
  %81 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv32, i64 %indvars.iv28, i64 %offset.idx
  %82 = bitcast double* %81 to <2 x double>*
  store <2 x double> %80, <2 x double>* %82, align 8, !alias.scope !13, !noalias !10
  %index.next = add i64 %index, 2
  %83 = icmp eq i64 %index.next, 118
  br i1 %83, label %for.cond109.for.inc203_crit_edge.us.loopexit91, label %vector.body, !llvm.loop !15
...
for.inc206:                                       ; preds = %for.cond109.for.inc203_crit_edge.us
  ...
  %exitcond36 = icmp eq i64 %indvars.iv.next33, 119
