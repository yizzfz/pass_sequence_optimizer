...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge20
  ...
  %sunkaddr42 = ptrtoint double* %5 to i64
  %sunkaddr43 = mul i64 %indvars.iv16, 8
  %sunkaddr44 = add i64 %sunkaddr42, %sunkaddr43
  %sunkaddr45 = inttoptr i64 %sunkaddr44 to double*
  %19 = load double, double* %sunkaddr45, align 8
...
; <label>:36:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond18, label %.preheader2.preheader, label %._crit_edge20

.preheader2.preheader:                            ; preds = %36
  br label %.preheader2

.preheader2:                                      ; preds = %53, %.preheader2.preheader
  %indvars.iv10 = phi i64 [ 0, %.preheader2.preheader ], [ %indvars.iv.next11, %53 ]
  %37 = getelementptr inbounds double, double* %8, i64 %indvars.iv10
  %.pre = load double, double* %37, align 8
  br label %._crit_edge21

._crit_edge21:                                    ; preds = %._crit_edge21, %.preheader2
  %38 = phi double [ %.pre, %.preheader2 ], [ %52, %._crit_edge21 ]
  %indvars.iv7 = phi i64 [ 0, %.preheader2 ], [ %indvars.iv.next8.1, %._crit_edge21 ]
  ...
  %sunkaddr46 = ptrtoint double* %8 to i64
  %sunkaddr47 = mul i64 %indvars.iv10, 8
  %sunkaddr48 = add i64 %sunkaddr46, %sunkaddr47
  %sunkaddr49 = inttoptr i64 %sunkaddr48 to double*
  store double %45, double* %sunkaddr49, align 8
...
._crit_edge23:                                    ; preds = %._crit_edge23, %.preheader
  %80 = phi double [ %.pre19, %.preheader ], [ %94, %._crit_edge23 ]
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %._crit_edge23 ]
  ...
  %sunkaddr50 = ptrtoint double* %7 to i64
  %sunkaddr51 = mul i64 %indvars.iv1, 8
  %sunkaddr52 = add i64 %sunkaddr50, %sunkaddr51
  %sunkaddr53 = inttoptr i64 %sunkaddr52 to double*
  store double %87, double* %sunkaddr53, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %94, double* %sunkaddr53, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %95, label %._crit_edge23

; <label>:95:                                     ; preds = %._crit_edge23
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 2000
