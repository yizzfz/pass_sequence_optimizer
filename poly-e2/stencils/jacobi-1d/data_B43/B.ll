...
for.cond1.preheader:                              ; preds = %for.inc33, %for.cond1.preheader.lr.ph
  ...
  br i1 %cmp26, label %for.body3.lr.ph, label %for.inc33

for.body3.lr.ph:                                  ; preds = %for.cond1.preheader
  br i1 %min.iters.check29, label %for.body3.preheader, label %min.iters.checked30

for.body3.preheader:                              ; preds = %middle.block27, %vector.memcheck46, %min.iters.checked30, %for.body3.lr.ph
  %indvars.iv7.ph = phi i64 [ 1, %vector.memcheck46 ], [ 1, %min.iters.checked30 ], [ 1, %for.body3.lr.ph ], [ %ind.end, %middle.block27 ]
  %3 = sub nsw i64 %0, %indvars.iv7.ph
...
for.body3.prol.preheader:                         ; preds = %for.body3.preheader
  ...
  %4 = load double, double* %arrayidx.prol, align 8
  %arrayidx6.prol = getelementptr inbounds double, double* %A, i64 %indvars.iv7.ph
  %5 = load double, double* %arrayidx6.prol, align 8
...
for.body3.prol.loopexit.unr-lcssa:                ; preds = %for.body3.preheader, %for.body3.prol.preheader
  ...
  %7 = icmp eq i64 %1, %indvars.iv7.ph
  br i1 %7, label %for.cond13.preheader.loopexit, label %for.body3.preheader.new

for.body3.preheader.new:                          ; preds = %for.body3.prol.loopexit.unr-lcssa
  br label %for.body3

min.iters.checked30:                              ; preds = %for.body3.lr.ph
  br i1 %cmp.zero, label %for.body3.preheader, label %vector.memcheck46

vector.memcheck46:                                ; preds = %min.iters.checked30
  br i1 %memcheck.conflict45, label %for.body3.preheader, label %vector.body26.preheader
...
vector.body26:                                    ; preds = %vector.body26.preheader, %vector.body26
  ...
  %8 = add nsw i64 %offset.idx53, -1
  %9 = getelementptr inbounds double, double* %A, i64 %8
  %10 = bitcast double* %9 to <2 x double>*
  %wide.load58 = load <2 x double>, <2 x double>* %10, align 8, !alias.scope !1
  %11 = getelementptr double, double* %9, i64 2
  %12 = bitcast double* %11 to <2 x double>*
  %wide.load59 = load <2 x double>, <2 x double>* %12, align 8, !alias.scope !1
  %13 = getelementptr inbounds double, double* %A, i64 %offset.idx53
  %14 = bitcast double* %13 to <2 x double>*
  %wide.load60 = load <2 x double>, <2 x double>* %14, align 8, !alias.scope !1
  %15 = getelementptr double, double* %13, i64 2
  %16 = bitcast double* %15 to <2 x double>*
  %wide.load61 = load <2 x double>, <2 x double>* %16, align 8, !alias.scope !1
  %17 = fadd <2 x double> %wide.load58, %wide.load60
  %18 = fadd <2 x double> %wide.load59, %wide.load61
  %19 = add nuw nsw i64 %offset.idx53, 1
  %20 = getelementptr inbounds double, double* %A, i64 %19
  %21 = getelementptr double, double* %20, i64 2
  %22 = bitcast double* %21 to <2 x double>*
  %wide.load63 = load <2 x double>, <2 x double>* %22, align 8, !alias.scope !1
  %23 = fadd <2 x double> %17, %wide.load59
  %24 = fadd <2 x double> %18, %wide.load63
  ...
  %27 = getelementptr inbounds double, double* %B, i64 %offset.idx53
  ...
  %31 = icmp eq i64 %index.next49, %n.vec
  br i1 %31, label %middle.block27, label %vector.body26, !llvm.loop !6
...
for.body16.lr.ph:                                 ; preds = %for.cond13.preheader
  br i1 %min.iters.check29, label %for.body16.preheader, label %min.iters.checked

for.body16.preheader:                             ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.body16.lr.ph
  %indvars.iv49.ph = phi i64 [ 1, %vector.memcheck ], [ 1, %min.iters.checked ], [ 1, %for.body16.lr.ph ], [ %ind.end, %middle.block ]
  %32 = sub nsw i64 %0, %indvars.iv49.ph
  %xtraiter64 = and i64 %32, 1
  %lcmp.mod65 = icmp eq i64 %xtraiter64, 0
  br i1 %lcmp.mod65, label %for.body16.prol.loopexit.unr-lcssa, label %for.body16.prol.preheader
...
for.body16.prol.loopexit.unr-lcssa:               ; preds = %for.body16.preheader, %for.body16.prol.preheader
  ...
  %36 = icmp eq i64 %1, %indvars.iv49.ph
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load21 = load <2 x double>, <2 x double>* %41, align 8, !alias.scope !9
  %42 = getelementptr inbounds double, double* %B, i64 %offset.idx
  %43 = bitcast double* %42 to <2 x double>*
  %wide.load22 = load <2 x double>, <2 x double>* %43, align 8, !alias.scope !9
  %44 = getelementptr double, double* %42, i64 2
  %45 = bitcast double* %44 to <2 x double>*
  %wide.load23 = load <2 x double>, <2 x double>* %45, align 8, !alias.scope !9
  %46 = fadd <2 x double> %wide.load, %wide.load22
  %47 = fadd <2 x double> %wide.load21, %wide.load23
  ...
  %wide.load25 = load <2 x double>, <2 x double>* %51, align 8, !alias.scope !9
  %52 = fadd <2 x double> %46, %wide.load21
  %53 = fadd <2 x double> %47, %wide.load25
...
for.body16:                                       ; preds = %for.body16, %for.body16.preheader.new
  ...
  %add22.1 = fadd double %70, %71
  %add23.1 = add nsw i64 %indvars.iv49, 2
  %arrayidx25.1 = getelementptr inbounds double, double* %B, i64 %add23.1
  %72 = load double, double* %arrayidx25.1, align 8
  %add26.1 = fadd double %add22.1, %72
  ...
  %exitcond12.1 = icmp eq i64 %add23.1, %0
  br i1 %exitcond12.1, label %for.inc33.loopexit.unr-lcssa, label %for.body16, !llvm.loop !16
...
for.inc33:                                        ; preds = %for.cond13.preheader.for.inc33_crit_edge, %for.inc33.loopexit, %for.cond1.preheader, %middle.block
  ...
  %exitcond13 = icmp eq i32 %inc34, %tsteps
  br i1 %exitcond13, label %for.end35.loopexit, label %for.cond1.preheader
