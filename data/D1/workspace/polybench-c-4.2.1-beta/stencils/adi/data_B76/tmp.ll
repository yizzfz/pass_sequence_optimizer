...
; <label>:52:                                     ; preds = %52, %.ph
  ...
  br i1 %exitcond38, label %._crit_edge.us.loopexit37, label %52

._crit_edge.us.loopexit:                          ; preds = %.ph.lver.orig
  br label %._crit_edge.us

._crit_edge.us.loopexit37:                        ; preds = %52
  br label %._crit_edge.us
...
.ph29.lver.orig:                                  ; preds = %.ph29.lver.orig.preheader, %.ph29.lver.orig
  ...
  br i1 %exitcond.lver.orig, label %._crit_edge15.us.loopexit, label %.ph29.lver.orig
...
; <label>:125:                                    ; preds = %125, %.ph29
  %store_forwarded35 = phi double [ %load_initial34, %.ph29 ], [ %147, %125 ]
  %store_forwarded32 = phi double [ %load_initial31, %.ph29 ], [ %136, %125 ]
  %indvars.iv30 = phi i64 [ 1, %.ph29 ], [ %indvars.iv.next31, %125 ]
  ...
  %145 = fmul double %store_forwarded35, 0xC08F400000000001
  ...
  br i1 %exitcond, label %._crit_edge15.us.loopexit36, label %125

._crit_edge15.us.loopexit:                        ; preds = %.ph29.lver.orig
  br label %._crit_edge15.us

._crit_edge15.us.loopexit36:                      ; preds = %125
  br label %._crit_edge15.us
