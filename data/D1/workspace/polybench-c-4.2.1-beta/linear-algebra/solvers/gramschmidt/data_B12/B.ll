...
; <label>:13:                                     ; preds = %10
  ...
  tail call void @print_array(i32 1000, i32 1200, [1200 x double]* %15, [1200 x double]* %14)
  br label %16
...
define internal void @print_array(i32, i32, [1200 x double]* nocapture readonly, [1200 x double]* nocapture readonly) #0 {
  ...
  %9 = icmp sgt i32 %1, 0
  br i1 %9, label %.preheader26.us.preheader, label %._crit_edge36

.preheader26.us.preheader:                        ; preds = %4
...
.preheader26.us:                                  ; preds = %._crit_edge33.us, %.preheader26.us.preheader
  %indvars.iv47 = phi i64 [ 0, %.preheader26.us.preheader ], [ %indvars.iv.next48, %._crit_edge33.us ]
  %13 = mul nsw i64 %indvars.iv47, %10
  br label %14

; <label>:14:                                     ; preds = %21, %.preheader26.us
  %indvars.iv43 = phi i64 [ 0, %.preheader26.us ], [ %indvars.iv.next44, %21 ]
  %15 = add nsw i64 %indvars.iv43, %13
...
; <label>:19:                                     ; preds = %14
  ...
  %fputc25.us = tail call i32 @fputc(i32 10, %struct._IO_FILE* %20) #6
  br label %21

; <label>:21:                                     ; preds = %19, %14
  %22 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %23 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv47, i64 %indvars.iv43
  ...
  %exitcond52 = icmp eq i64 %indvars.iv.next44, %11
  br i1 %exitcond52, label %._crit_edge33.us, label %14

._crit_edge33.us:                                 ; preds = %21
  %indvars.iv.next48 = add nuw nsw i64 %indvars.iv47, 1
  %exitcond53 = icmp eq i64 %indvars.iv.next48, %12
  br i1 %exitcond53, label %._crit_edge36.loopexit, label %.preheader26.us
...
.preheader.us:                                    ; preds = %._crit_edge.us, %.preheader.us.preheader
  ...
  %35 = mul nsw i64 %indvars.iv38, %32
  br label %36
...
; <label>:43:                                     ; preds = %41, %36
  ...
  %45 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv38, i64 %indvars.iv
