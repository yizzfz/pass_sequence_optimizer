...
for.body.us:                                      ; preds = %for.cond11.for.inc27_crit_edge.us.for.body.us_crit_edge, %for.body.us.preheader
  %indvars.iv19 = phi i64 [ 0, %for.body.us.preheader ], [ %indvars.iv.next20, %for.cond11.for.inc27_crit_edge.us.for.body.us_crit_edge ]
...
for.body14.us.prol.loopexit.unr-lcssa:            ; preds = %for.end.us.for.body14.us.prol.loopexit.unr-lcssa_crit_edge, %for.body14.us.prol.preheader
  ...
  br i1 false, label %for.body14.us.prol.loopexit.unr-lcssa.for.cond11.for.inc27_crit_edge.us_crit_edge, label %for.body14.us.preheader

for.body14.us.prol.loopexit.unr-lcssa.for.cond11.for.inc27_crit_edge.us_crit_edge: ; preds = %for.body14.us.prol.loopexit.unr-lcssa
...
for.body14.us:                                    ; preds = %for.body14.us.for.body14.us_crit_edge, %for.body14.us.preheader
  ...
  br i1 %exitcond18.1, label %for.cond11.for.inc27_crit_edge.us.loopexit, label %for.body14.us.for.body14.us_crit_edge
...
for.cond11.for.inc27_crit_edge.us:                ; preds = %for.body14.us.prol.loopexit.unr-lcssa.for.cond11.for.inc27_crit_edge.us_crit_edge, %for.cond11.for.inc27_crit_edge.us.loopexit
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  %exitcond = icmp eq i64 %indvars.iv.next20, 1000
  br i1 %exitcond, label %for.end29.loopexit, label %for.cond11.for.inc27_crit_edge.us.for.body.us_crit_edge
...
for.body3.lr.ph:                                  ; preds = %for.body
  %xtraiter35 = and i64 %indvars.iv29, 1
  %lcmp.mod36 = icmp eq i64 %xtraiter35, 0
  br i1 %lcmp.mod36, label %for.body3.lr.ph.for.body3.prol.loopexit.unr-lcssa_crit_edge, label %for.body3.prol.preheader
...
for.end:                                          ; preds = %for.body3.prol.loopexit.unr-lcssa.for.end_crit_edge, %for.body.for.end_crit_edge, %for.end.loopexit
  ...
  %exitcond37 = icmp eq i64 %indvars.iv.next30, 1000
  br i1 %exitcond37, label %for.end29.loopexit40, label %for.end.for.body_crit_edge
...
for.end29.loopexit40:                             ; preds = %for.end
  br label %for.end29

for.end29:                                        ; preds = %entry.for.end29_crit_edge, %for.end29.loopexit40, %for.end29.loopexit
  ret void
}
...
for.body.us:                                      ; preds = %for.cond1.for.inc30_crit_edge.us.for.body.us_crit_edge, %for.body.us.preheader
  %indvars.iv = phi i64 [ 1, %for.body.us.preheader ], [ %3, %for.cond1.for.inc30_crit_edge.us.for.body.us_crit_edge ]
  %indvars.iv25 = phi i64 [ 0, %for.body.us.preheader ], [ %indvars.iv.next26, %for.cond1.for.inc30_crit_edge.us.for.body.us_crit_edge ]
  %0 = sub nsw i64 1001, %indvars.iv25
...
for.end.us:                                       ; preds = %for.body6.us.prol.loopexit.unr-lcssa.for.end.us_crit_edge, %for.body3.us.for.end.us_crit_edge, %for.end.us.loopexit
  ...
  br i1 %exitcond, label %for.cond1.for.inc30_crit_edge.us, label %for.end.us.for.body3.us_crit_edge
...
for.cond1.for.inc30_crit_edge.us:                 ; preds = %for.end.us
  ...
  br i1 %exitcond29, label %for.end32.loopexit, label %for.cond1.for.inc30_crit_edge.us.for.body.us_crit_edge
...
for.body.us:                                      ; preds = %for.cond2.for.inc10_crit_edge.us.for.body.us_crit_edge, %for.body.us.preheader
  %indvars.iv10 = phi i64 [ 0, %for.body.us.preheader ], [ %indvars.iv.next11, %for.cond2.for.inc10_crit_edge.us.for.body.us_crit_edge ]
...
if.end.us:                                        ; preds = %for.body4.us.if.end.us_crit_edge, %if.then.us
  ...
  br i1 %exitcond16, label %for.cond2.for.inc10_crit_edge.us, label %if.end.us.for.body4.us_crit_edge
...
for.cond2.for.inc10_crit_edge.us:                 ; preds = %if.end.us
  ...
  br i1 %exitcond, label %for.end12.loopexit, label %for.cond2.for.inc10_crit_edge.us.for.body.us_crit_edge
