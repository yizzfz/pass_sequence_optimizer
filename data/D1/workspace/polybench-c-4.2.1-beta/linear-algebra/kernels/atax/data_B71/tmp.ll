...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc void @kernel_atax([2100 x double]*, double*, double*, double* nocapture) unnamed_addr #2 {
...
._crit_edge1:                                     ; preds = %._crit_edge1, %.preheader1._crit_edge
  ...
  %sunkaddr2 = mul i64 %indvars.iv520, 8
  ...
  store double %37, double* %sunkaddr8, align 8
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader
  ...
  %sunkaddr9 = ptrtoint double* %3 to i64
  %sunkaddr10 = mul i64 %indvars.iv520, 8
  %sunkaddr11 = add i64 %sunkaddr9, %sunkaddr10
  %sunkaddr12 = inttoptr i64 %sunkaddr11 to double*
  %42 = load double, double* %sunkaddr12, align 8
  ...
  %sunkaddr13 = ptrtoint double* %3 to i64
  %sunkaddr14 = mul i64 %indvars.iv520, 8
  %sunkaddr15 = add i64 %sunkaddr13, %sunkaddr14
  %sunkaddr16 = inttoptr i64 %sunkaddr15 to double*
  %49 = load double, double* %sunkaddr16, align 8
