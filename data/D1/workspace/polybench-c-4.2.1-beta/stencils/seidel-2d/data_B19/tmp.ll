...
; <label>:11:                                     ; preds = %._crit_edge1, %._crit_edge, %9
...
.prol.preheader:                                  ; preds = %.preheader.us
  ...
  %13 = fdiv double %12, %4
  %14 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv5, i64 0
...
.preheader.us.new:                                ; preds = %.preheader.us.new..preheader.us.new_crit_edge, %.preheader.us.new.preheader
  ...
  %27 = fadd <2 x double> %26, <double 2.000000e+00, double 2.000000e+00>
  %28 = fdiv <2 x double> %27, %8
...
.preheader3:                                      ; preds = %._crit_edge6..preheader3_crit_edge, %.preheader3.lr.ph
  %.027 = phi i32 [ 0, %.preheader3.lr.ph ], [ %37, %._crit_edge6..preheader3_crit_edge ]
  br i1 %7, label %.preheader3.._crit_edge6_crit_edge, label %.preheader.preheader
...
.preheader:                                       ; preds = %._crit_edge..preheader_crit_edge, %.preheader.preheader
  ...
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %._crit_edge..preheader_crit_edge ], [ 1, %.preheader.preheader ]
  %8 = add i64 %indvar, 1
...
; <label>:10:                                     ; preds = %._crit_edge14, %.preheader
  %store_forwarded = phi double [ %load_initial, %.preheader ], [ %36, %._crit_edge14 ]
...
._crit_edge:                                      ; preds = %10
  ...
  br i1 %exitcond12, label %._crit_edge6.loopexit, label %._crit_edge..preheader_crit_edge
...
._crit_edge6:                                     ; preds = %.preheader3.._crit_edge6_crit_edge, %._crit_edge6.loopexit
  ...
  br i1 %exitcond13, label %._crit_edge8.loopexit, label %._crit_edge6..preheader3_crit_edge

._crit_edge6..preheader3_crit_edge:               ; preds = %._crit_edge6
  br label %.preheader3
