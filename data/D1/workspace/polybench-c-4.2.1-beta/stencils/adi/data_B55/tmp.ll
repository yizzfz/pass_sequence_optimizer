...
.preheader152:                                    ; preds = %._crit_edge170, %.preheader152.lr.ph
  %.0171 = phi i32 [ 1, %.preheader152.lr.ph ], [ %154, %._crit_edge170 ]
  br label %.lver.check
...
.lver.check213:                                   ; preds = %.lver.check213.preheader, %._crit_edge167.us
  ...
  %76 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv184
  %77 = getelementptr inbounds [1000 x double], [1000 x double]* %76, i64 0, i64 0
  store double 1.000000e+00, double* %77, align 8
  %78 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv184, i64 0
  store double 0.000000e+00, double* %78, align 8
  %79 = bitcast [1000 x double]* %76 to i64*
  %80 = load i64, i64* %79, align 8
  %81 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv184
  %82 = bitcast [1000 x double]* %81 to i64*
  store i64 %80, i64* %82, align 8
  %83 = add nsw i64 %indvars.iv184, -1
...
.ph214.lver.orig:                                 ; preds = %.ph214.lver.orig.preheader, %.ph214.lver.orig
  ...
  %84 = add nsw i64 %indvars.iv178.lver.orig, -1
  %85 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv184, i64 %84
  %86 = load double, double* %85, align 8
  %87 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv184, i64 %indvars.iv178.lver.orig
  %88 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %83, i64 %indvars.iv178.lver.orig
  %89 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv184, i64 %indvars.iv178.lver.orig
  %90 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv.next185, i64 %indvars.iv178.lver.orig
  %91 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv184, i64 %84
  ...
  %111 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv184, i64 %indvars.iv178.lver.orig
...
.lr.ph166.us:                                     ; preds = %.lr.ph166.us, %._crit_edge163.us
  ...
  %112 = phi double [ 1.000000e+00, %._crit_edge163.us ], [ %125, %.lr.ph166.us ]
  %113 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv184, i64 %indvars.iv182
  %114 = load double, double* %113, align 8
  %115 = fmul double %114, %112
  %116 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv184, i64 %indvars.iv182
  %117 = load double, double* %116, align 8
  %118 = fadd double %115, %117
  %119 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv184, i64 %indvars.iv182
  store double %118, double* %119, align 8
  %indvars.iv.next183 = add nsw i64 %indvars.iv182, -1
  %120 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv184, i64 %indvars.iv.next183
  %121 = load double, double* %120, align 8
  %122 = fmul double %121, %118
  %123 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv184, i64 %indvars.iv.next183
  %124 = load double, double* %123, align 8
  %125 = fadd double %122, %124
  %126 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv184, i64 %indvars.iv.next183
  store double %125, double* %126, align 8
  %127 = icmp sgt i64 %indvars.iv.next183, 1
  %indvars.iv.next183.1 = add nsw i64 %indvars.iv182, -2
  br i1 %127, label %.lr.ph166.us, label %._crit_edge167.us

; <label>:128:                                    ; preds = %128, %.ph214
  %store_forwarded220 = phi double [ %load_initial219, %.ph214 ], [ %150, %128 ]
  %store_forwarded217 = phi double [ %load_initial216, %.ph214 ], [ %139, %128 ]
  %indvars.iv178 = phi i64 [ 1, %.ph214 ], [ %indvars.iv.next179, %128 ]
  %129 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv184, i64 %indvars.iv178
  %130 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %83, i64 %indvars.iv178
  %131 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv184, i64 %indvars.iv178
  %132 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv.next185, i64 %indvars.iv178
  %133 = insertelement <2 x double> undef, double %store_forwarded217, i32 0
  ...
  %148 = fmul double %store_forwarded220, 0xC08F400000000001
  %149 = fsub double %147, %148
  %150 = fdiv double %149, %138
  %151 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv184, i64 %indvars.iv178
  store double %150, double* %151, align 8
  %exitcond181 = icmp eq i64 %indvars.iv178, 998
  %indvars.iv.next179 = add nuw nsw i64 %indvars.iv178, 1
  br i1 %exitcond181, label %._crit_edge163.us.loopexit221, label %128

._crit_edge163.us.loopexit:                       ; preds = %.ph214.lver.orig
  br label %._crit_edge163.us

._crit_edge163.us.loopexit221:                    ; preds = %128
  br label %._crit_edge163.us

._crit_edge163.us:                                ; preds = %._crit_edge163.us.loopexit221, %._crit_edge163.us.loopexit
  %152 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv184, i64 999
  store double 1.000000e+00, double* %152, align 8
  br label %.lr.ph166.us

._crit_edge170:                                   ; preds = %._crit_edge167.us
  %153 = icmp slt i32 %.0171, 500
  %154 = add nuw nsw i32 %.0171, 1
  br i1 %153, label %.preheader152, label %._crit_edge172
