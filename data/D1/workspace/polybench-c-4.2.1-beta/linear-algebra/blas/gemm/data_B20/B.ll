...
; <label>:18:                                     ; preds = %15
  call void @print_array(i32 1000, i32 1100, [1100 x double]* %8)
  br label %._crit_edge
...
vector.body77:                                    ; preds = %vector.body77, %vector.ph109
  ...
  %61 = fmul <2 x double> %broadcast.splatinsert118, %60
  %62 = shufflevector <2 x double> %61, <2 x double> undef, <2 x i32> zeroinitializer
  %63 = getelementptr inbounds [1100 x double], [1100 x double]* %7, i64 %indvars.iv39, i64 %index110
  %64 = bitcast double* %63 to <2 x double>*
  %wide.load120 = load <2 x double>, <2 x double>* %64, align 8, !alias.scope !11
  %65 = getelementptr double, double* %63, i64 2
  %66 = bitcast double* %65 to <2 x double>*
  %wide.load121 = load <2 x double>, <2 x double>* %66, align 8, !alias.scope !11
  %67 = fmul <2 x double> %62, %wide.load120
  %68 = fmul <2 x double> %62, %wide.load121
  %69 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv42, i64 %index110
  %70 = bitcast double* %69 to <2 x double>*
  %wide.load122 = load <2 x double>, <2 x double>* %70, align 8, !alias.scope !13, !noalias !15
  %71 = getelementptr double, double* %69, i64 2
  %72 = bitcast double* %71 to <2 x double>*
  %wide.load123 = load <2 x double>, <2 x double>* %72, align 8, !alias.scope !13, !noalias !15
  %73 = fadd <2 x double> %67, %wide.load122
  %74 = fadd <2 x double> %68, %wide.load123
  ...
  %75 = icmp eq i64 %index.next111, %n.vec84
  br i1 %75, label %middle.block78, label %vector.body77, !llvm.loop !16
...
scalar.ph79:                                      ; preds = %scalar.ph79.preheader, %scalar.ph79
  ...
  %77 = fmul double %76, %3
  %78 = getelementptr inbounds [1100 x double], [1100 x double]* %7, i64 %indvars.iv39, i64 %indvars.iv37
  %79 = load double, double* %78, align 8
  %80 = fmul double %77, %79
  %81 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv42, i64 %indvars.iv37
  %82 = load double, double* %81, align 8
  %83 = fadd double %80, %82
  store double %83, double* %81, align 8
  %indvars.iv.next38 = add nuw nsw i64 %indvars.iv37, 1
  %84 = icmp slt i64 %indvars.iv.next38, %15
  br i1 %84, label %scalar.ph79, label %._crit_edge.us.us.loopexit, !llvm.loop !17
...
._crit_edge11.1:                                  ; preds = %._crit_edge.us.1, %._crit_edge11
  ...
  %86 = icmp slt i64 %indvars.iv.next52.1, %12
  br i1 %86, label %.preheader5, label %._crit_edge16.loopexit146.unr-lcssa
}
