...
for.cond1.preheader:                              ; preds = %for.inc7, %entry
  %indvars.iv32 = phi i64 [ 0, %entry ], [ %indvars.iv.next4, %for.inc7 ]
  %0 = mul nuw nsw i64 %indvars.iv32, 313
...
vector.body:                                      ; preds = %vector.body, %for.cond1.preheader
  ...
  %7 = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv32, i64 %index
...
for.inc7:                                         ; preds = %vector.body
  ...
  %cmp = icmp slt i64 %indvars.iv.next4, 4096
...
for.cond31.preheader:                             ; preds = %for.inc55, %entry
  %indvars.iv2148 = phi i64 [ 0, %entry ], [ %indvars.iv.next22, %for.inc55 ]
  %arrayidx3538 = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv2148, i64 0
  %1 = load float, float* %arrayidx3538, align 4
  %mul3639 = fmul float %div, %1
  %add3841 = fadd float %mul3740, %mul3639
  %add4043 = fadd float %mul3942, %add3841
  %add4245 = fadd float %mul4144, %add4043
  %arrayidx4646 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv2148, i64 0
...
for.cond58.preheader:                             ; preds = %for.inc55
  ...
  %2 = fmul float %div, %call24
  %mul25 = fsub float -0.000000e+00, %2
  %mul6526 = fmul float %mul16.v.r2, 0.000000e+00
  %mul6627 = fmul float %2, -0.000000e+00
...
for.body33.for.body33_crit_edge:                  ; preds = %for.body33.for.body33_crit_edge.1, %for.cond31.preheader
  ...
  %indvars.iv194448 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next20.1, %for.body33.for.body33_crit_edge.1 ]
  %ym1.04547 = phi float [ 0.000000e+00, %for.cond31.preheader ], [ %add42, %for.body33.for.body33_crit_edge.1 ]
  %indvars.iv.next20 = or i64 %indvars.iv194448, 1
  %3 = load float, float* %arrayidx3549, align 4
  %arrayidx35 = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv2148, i64 %indvars.iv.next20
  ...
  %mul41 = fmul float %ym1.04547, %sub30
  %add42 = fadd float %mul41, %add40
  %arrayidx46 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv2148, i64 %indvars.iv.next20
  store float %add42, float* %arrayidx46, align 4
  %exitcond51 = icmp eq i64 %indvars.iv.next20, 2159
  br i1 %exitcond51, label %for.inc55, label %for.body33.for.body33_crit_edge.1

for.inc55:                                        ; preds = %for.body33.for.body33_crit_edge
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv2148, 1
  %cmp = icmp slt i64 %indvars.iv.next22, 4096
  br i1 %cmp, label %for.cond31.preheader, label %for.cond58.preheader

for.cond62.preheader:                             ; preds = %for.inc86, %for.cond58.preheader
  %indvars.iv1743 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next18, %for.inc86 ]
  %arrayidx7533 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv1743, i64 2159
...
for.body64.for.body64_crit_edge:                  ; preds = %for.body64.for.body64_crit_edge.1, %for.cond62.preheader
  ...
  %indvars.iv153836 = phi i64 [ 2159, %for.cond62.preheader ], [ %indvars.iv.next16.1, %for.body64.for.body64_crit_edge.1 ]
  %xp1.03935 = phi float [ 0.000000e+00, %for.cond62.preheader ], [ %85, %for.body64.for.body64_crit_edge.1 ]
  %yp1.04134 = phi float [ 0.000000e+00, %for.cond62.preheader ], [ %add71, %for.body64.for.body64_crit_edge.1 ]
  %indvars.iv.next16 = add nsw i64 %indvars.iv153836, -1
  %arrayidx79 = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv1743, i64 %indvars.iv153836
  %5 = load float, float* %arrayidx79, align 4
  %mul65 = fmul float %mul16.v.r2, %5
  %mul66 = fmul float %xp1.03935, %mul25
  %add67 = fadd float %mul65, %mul66
  %mul68 = fmul float %exp2, %add7137
  %add69 = fadd float %add67, %mul68
  %mul70 = fmul float %yp1.04134, %sub30
  %add71 = fadd float %add69, %mul70
  %arrayidx75 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv1743, i64 %indvars.iv.next16
  store float %add71, float* %arrayidx75, align 4
  %cmp63 = icmp sgt i64 %indvars.iv153836, 1
  br i1 %cmp63, label %for.body64.for.body64_crit_edge.1, label %for.inc86

for.inc86:                                        ; preds = %for.body64.for.body64_crit_edge
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv1743, 1
  %cmp59 = icmp slt i64 %indvars.iv.next18, 4096
...
for.cond92.preheader:                             ; preds = %for.cond92.preheader.preheader, %for.inc112
  %indvars.iv1337 = phi i64 [ %indvars.iv.next14, %for.inc112 ], [ 0, %for.cond92.preheader.preheader ]
  %scevgep = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv1337, i64 0
  %6 = add i64 %indvars.iv1337, 1
  %scevgep52 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %6, i64 0
  %scevgep54 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv1337, i64 0
  %scevgep56 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %6, i64 0
  %scevgep58 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv1337, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %7 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv1337, i64 %index
  %8 = bitcast float* %7 to <4 x float>*
  ...
  %11 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv1337, i64 %index
  ...
  %17 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv1337, i64 %index
  ...
  %21 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv1337, i64 %index.next
  ...
  %25 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv1337, i64 %index.next
  ...
  %31 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv1337, i64 %index.next
  ...
  br i1 %35, label %for.inc112.loopexit111, label %vector.body, !llvm.loop !12

for.body94:                                       ; preds = %for.body94, %for.body94.preheader
  %indvars.iv1136 = phi i64 [ 0, %for.body94.preheader ], [ %indvars.iv.next12.2, %for.body94 ]
  %arrayidx98 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv1337, i64 %indvars.iv1136
  %36 = load float, float* %arrayidx98, align 4
  %arrayidx102 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv1337, i64 %indvars.iv1136
  %37 = load float, float* %arrayidx102, align 4
  %add103 = fadd float %36, %37
  %arrayidx108 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv1337, i64 %indvars.iv1136
  store float %add103, float* %arrayidx108, align 4
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv1136, 1
  %arrayidx98.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv1337, i64 %indvars.iv.next12
  %38 = load float, float* %arrayidx98.1, align 4
  %arrayidx102.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv1337, i64 %indvars.iv.next12
  %39 = load float, float* %arrayidx102.1, align 4
  %add103.1 = fadd float %38, %39
  %arrayidx108.1 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv1337, i64 %indvars.iv.next12
  store float %add103.1, float* %arrayidx108.1, align 4
  %indvars.iv.next12.1 = add nsw i64 %indvars.iv1136, 2
  %arrayidx98.2 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv1337, i64 %indvars.iv.next12.1
  %40 = load float, float* %arrayidx98.2, align 4
  %arrayidx102.2 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv1337, i64 %indvars.iv.next12.1
  %41 = load float, float* %arrayidx102.2, align 4
  %add103.2 = fadd float %40, %41
  %arrayidx108.2 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv1337, i64 %indvars.iv.next12.1
  store float %add103.2, float* %arrayidx108.2, align 4
  %exitcond50.2 = icmp eq i64 %indvars.iv.next12.1, 2159
  %indvars.iv.next12.2 = add nsw i64 %indvars.iv1136, 3
  br i1 %exitcond50.2, label %for.inc112.loopexit, label %for.body94, !llvm.loop !13
...
for.inc112:                                       ; preds = %for.inc112.loopexit111, %for.inc112.loopexit
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv1337, 1
  %cmp90 = icmp slt i64 %indvars.iv.next14, 4096
...
for.cond118.preheader:                            ; preds = %for.cond118.preheader.preheader, %for.inc147
  %indvars.iv935 = phi i64 [ %indvars.iv.next10, %for.inc147 ], [ 0, %for.cond118.preheader.preheader ]
  %arrayidx12413 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 0, i64 %indvars.iv935
  ...
  %arrayidx13521 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 0, i64 %indvars.iv935
...
for.body120.for.body120_crit_edge:                ; preds = %for.body120.for.body120_crit_edge.1, %for.cond118.preheader
  ...
  %indvars.iv73123 = phi i64 [ 0, %for.cond118.preheader ], [ %indvars.iv.next8.1, %for.body120.for.body120_crit_edge.1 ]
  %ym1.13222 = phi float [ 0.000000e+00, %for.cond118.preheader ], [ %add131, %for.body120.for.body120_crit_edge.1 ]
  %indvars.iv.next8 = or i64 %indvars.iv73123, 1
  %43 = load float, float* %arrayidx12424, align 4
  %arrayidx124 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv.next8, i64 %indvars.iv935
  ...
  %mul130 = fmul float %ym1.13222, %sub30
  %add131 = fadd float %mul130, %add129
  %arrayidx135 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv.next8, i64 %indvars.iv935
  store float %add131, float* %arrayidx135, align 4
  %exitcond49 = icmp eq i64 %indvars.iv.next8, 4095
  br i1 %exitcond49, label %for.inc147, label %for.body120.for.body120_crit_edge.1

for.inc147:                                       ; preds = %for.body120.for.body120_crit_edge
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv935, 1
  %cmp116 = icmp slt i64 %indvars.iv.next10, 2160
...
for.cond154.preheader.preheader:                  ; preds = %for.inc147
  ...
  %mul1582 = fmul float %2, -0.000000e+00
...
for.cond154.preheader:                            ; preds = %for.cond154.preheader.preheader, %for.inc179
  %indvars.iv530 = phi i64 [ %indvars.iv.next6, %for.inc179 ], [ 0, %for.cond154.preheader.preheader ]
  %arrayidx1678 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 4095, i64 %indvars.iv530
...
for.body156.for.body156_crit_edge:                ; preds = %for.body156.for.body156_crit_edge.1, %for.cond154.preheader
  ...
  %indvars.iv32511 = phi i64 [ 4095, %for.cond154.preheader ], [ %indvars.iv.next4.1, %for.body156.for.body156_crit_edge.1 ]
  %tp1.02610 = phi float [ 0.000000e+00, %for.cond154.preheader ], [ %82, %for.body156.for.body156_crit_edge.1 ]
  %yp1.1289 = phi float [ 0.000000e+00, %for.cond154.preheader ], [ %add163, %for.body156.for.body156_crit_edge.1 ]
  %indvars.iv.next4 = add nsw i64 %indvars.iv32511, -1
  %arrayidx171 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv32511, i64 %indvars.iv530
  %45 = load float, float* %arrayidx171, align 4
  %mul157 = fmul float %mul16.v.r2, %45
  %mul158 = fmul float %tp1.02610, %mul25
  %add159 = fadd float %mul157, %mul158
  %mul160 = fmul float %exp2, %add16312
  %add161 = fadd float %add159, %mul160
  %mul162 = fmul float %yp1.1289, %sub30
  %add163 = fadd float %add161, %mul162
  %arrayidx167 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv.next4, i64 %indvars.iv530
  store float %add163, float* %arrayidx167, align 4
  %cmp155 = icmp sgt i64 %indvars.iv32511, 1
...
for.inc179:                                       ; preds = %for.body156.for.body156_crit_edge
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv530, 1
  %cmp151 = icmp slt i64 %indvars.iv.next6, 2160
...
for.cond185.preheader:                            ; preds = %for.cond185.preheader.preheader, %for.inc205
  %indvars.iv124 = phi i64 [ %indvars.iv.next2, %for.inc205 ], [ 0, %for.cond185.preheader.preheader ]
  %scevgep74 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv124, i64 0
  %46 = add i64 %indvars.iv124, 1
  %scevgep76 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %46, i64 0
  %scevgep78 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv124, i64 0
  %scevgep80 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %46, i64 0
  %scevgep82 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv124, i64 0
...
vector.body69:                                    ; preds = %vector.body69, %vector.body69.preheader
  ...
  %47 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv124, i64 %index96
  ...
  %51 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv124, i64 %index96
  ...
  %57 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv124, i64 %index96
  ...
  %61 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv124, i64 %index.next97
  ...
  %65 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv124, i64 %index.next97
  ...
  %71 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv124, i64 %index.next97
  ...
  br i1 %75, label %for.inc205.loopexit110, label %vector.body69, !llvm.loop !22

for.body187:                                      ; preds = %for.body187, %for.body187.preheader
  %indvars.iv23 = phi i64 [ 0, %for.body187.preheader ], [ %indvars.iv.next.2, %for.body187 ]
  %arrayidx191 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv124, i64 %indvars.iv23
  %76 = load float, float* %arrayidx191, align 4
  %arrayidx195 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv124, i64 %indvars.iv23
  %77 = load float, float* %arrayidx195, align 4
  %add196 = fadd float %76, %77
  %arrayidx201 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv124, i64 %indvars.iv23
  store float %add196, float* %arrayidx201, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv23, 1
  %arrayidx191.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv124, i64 %indvars.iv.next
  %78 = load float, float* %arrayidx191.1, align 4
  %arrayidx195.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv124, i64 %indvars.iv.next
  %79 = load float, float* %arrayidx195.1, align 4
  %add196.1 = fadd float %78, %79
  %arrayidx201.1 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv124, i64 %indvars.iv.next
  store float %add196.1, float* %arrayidx201.1, align 4
  %indvars.iv.next.1 = add nsw i64 %indvars.iv23, 2
  %arrayidx191.2 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv124, i64 %indvars.iv.next.1
  %80 = load float, float* %arrayidx191.2, align 4
  %arrayidx195.2 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv124, i64 %indvars.iv.next.1
  %81 = load float, float* %arrayidx195.2, align 4
  %add196.2 = fadd float %80, %81
  %arrayidx201.2 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv124, i64 %indvars.iv.next.1
...
for.inc205:                                       ; preds = %for.inc205.loopexit110, %for.inc205.loopexit
  ...
  %cmp183 = icmp slt i64 %indvars.iv.next2, 4096
...
for.body156.for.body156_crit_edge.1:              ; preds = %for.body156.for.body156_crit_edge
  %indvars.iv.next4.1 = add nsw i64 %indvars.iv32511, -2
  %arrayidx171.1 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv.next4, i64 %indvars.iv530
  ...
  %arrayidx167.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv.next4.1, i64 %indvars.iv530
...
for.body120.for.body120_crit_edge.1:              ; preds = %for.body120.for.body120_crit_edge
  %indvars.iv.next8.1 = add nsw i64 %indvars.iv73123, 2
  %83 = load float, float* %arrayidx124, align 4
  %arrayidx124.1 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv.next8.1, i64 %indvars.iv935
  ...
  %arrayidx135.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv.next8.1, i64 %indvars.iv935
  store float %add131.1, float* %arrayidx135.1, align 4
  br label %for.body120.for.body120_crit_edge

for.body64.for.body64_crit_edge.1:                ; preds = %for.body64.for.body64_crit_edge
  %indvars.iv.next16.1 = add nsw i64 %indvars.iv153836, -2
  %arrayidx79.1 = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv1743, i64 %indvars.iv.next16
  ...
  %arrayidx75.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv1743, i64 %indvars.iv.next16.1
  store float %add71.1, float* %arrayidx75.1, align 4
  br label %for.body64.for.body64_crit_edge

for.body33.for.body33_crit_edge.1:                ; preds = %for.body33.for.body33_crit_edge
  %indvars.iv.next20.1 = add nsw i64 %indvars.iv194448, 2
  %86 = load float, float* %arrayidx35, align 4
  %arrayidx35.1 = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv2148, i64 %indvars.iv.next20.1
  ...
  %arrayidx46.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv2148, i64 %indvars.iv.next20.1
...
if.end:                                           ; preds = %for.body4, %if.then
  ...
  %arrayidx8 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv26, i64 %indvars.iv5
...
for.inc10:                                        ; preds = %if.end
  ...
  %cmp = icmp slt i64 %indvars.iv.next3, 4096
