...
.preheader39.us:                                  ; preds = %._crit_edge50.us, %.preheader39.us.preheader
  %indvars.iv76 = phi i64 [ 0, %.preheader39.us.preheader ], [ %indvars.iv.next77, %._crit_edge50.us ]
  %7 = mul nuw nsw i64 %indvars.iv76, 1000
  br label %._crit_edge62

._crit_edge62:                                    ; preds = %._crit_edge, %.preheader39.us
  %indvars.iv74 = phi i64 [ 0, %.preheader39.us ], [ %indvars.iv.next75, %._crit_edge ]
...
; <label>:12:                                     ; preds = %._crit_edge62
  ...
  %fputc58 = call i32 @fputc(i32 10, %struct._IO_FILE* %13) #4
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %._crit_edge62, %12
  ...
  br i1 %exitcond4, label %._crit_edge50.us, label %._crit_edge62

._crit_edge50.us:                                 ; preds = %._crit_edge
  %indvars.iv.next77 = add nuw nsw i64 %indvars.iv76, 1
  %exitcond5 = icmp eq i64 %indvars.iv.next77, 1000
  br i1 %exitcond5, label %._crit_edge52, label %.preheader39.us
...
.preheader38.us:                                  ; preds = %._crit_edge45.us, %._crit_edge52
  %indvars.iv71 = phi i64 [ 0, %._crit_edge52 ], [ %indvars.iv.next72, %._crit_edge45.us ]
  %24 = mul nuw nsw i64 %indvars.iv71, 1000
  br label %._crit_edge64

._crit_edge64:                                    ; preds = %._crit_edge63, %.preheader38.us
  %indvars.iv69 = phi i64 [ 0, %.preheader38.us ], [ %indvars.iv.next70, %._crit_edge63 ]
...
; <label>:29:                                     ; preds = %._crit_edge64
  ...
  %fputc55 = call i32 @fputc(i32 10, %struct._IO_FILE* %30) #4
...
._crit_edge63:                                    ; preds = %._crit_edge64, %29
  ...
  br i1 %exitcond2, label %._crit_edge45.us, label %._crit_edge64

._crit_edge45.us:                                 ; preds = %._crit_edge63
  %indvars.iv.next72 = add nuw nsw i64 %indvars.iv71, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next72, 1000
  br i1 %exitcond3, label %._crit_edge47, label %.preheader38.us
...
.preheader.us:                                    ; preds = %._crit_edge.us, %._crit_edge47
  %indvars.iv67 = phi i64 [ 0, %._crit_edge47 ], [ %indvars.iv.next68, %._crit_edge.us ]
...
._crit_edge.us:                                   ; preds = %._crit_edge65
  ...
  br i1 %exitcond1, label %._crit_edge42, label %.preheader.us
