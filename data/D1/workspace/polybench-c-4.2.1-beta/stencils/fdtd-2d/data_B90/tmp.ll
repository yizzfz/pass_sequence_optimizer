...
.lr.ph4:                                          ; preds = %.lr.ph4, %.lr.ph4.preheader
  ...
  %35 = trunc i64 %indvars.iv.next10.1 to i32
  %36 = sitofp i32 %35 to double
  %37 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next10.1
  %38 = bitcast double* %37 to <2 x double>*
  %indvars.iv.next10.2 = add nsw i64 %indvars.iv9, 3
  %39 = trunc i64 %indvars.iv.next10.2 to i32
  ...
  %43 = trunc i64 %indvars.iv.next10.3 to i32
  %44 = sitofp i32 %43 to double
  %45 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next10.3
...
.preheader6.lr.ph:
  %scevgep138 = getelementptr [1200 x double], [1200 x double]* %1, i64 1, i64 0
  br label %.lr.ph
...
.lr.ph:                                           ; preds = %._crit_edge12, %.preheader6.lr.ph
  ...
  %bound0141 = icmp ugt [1200 x double]* %5, %1
  %bound1142 = icmp ult double* %4, %scevgep138
  %memcheck.conflict144 = and i1 %bound0141, %bound1142
  br i1 %memcheck.conflict144, label %scalar.ph135.preheader, label %vector.body133.preheader

vector.body133.preheader:                         ; preds = %.lr.ph
  %6 = bitcast double* %4 to i64*
  %7 = bitcast double* %4 to i64*
  %8 = bitcast double* %4 to i64*
  br label %vector.body133

scalar.ph135.preheader:                           ; preds = %.lr.ph
...
vector.body133:                                   ; preds = %vector.body133, %vector.body133.preheader
  %index147 = phi i64 [ 0, %vector.body133.preheader ], [ %index.next148.2, %vector.body133 ]
  ...
  %22 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 0, i64 %index147
  ...
  %index.next148 = add nuw nsw i64 %index147, 4
  ...
  %31 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 0, i64 %index.next148
  ...
  %index.next148.1 = add nsw i64 %index147, 8
  ...
  %40 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 0, i64 %index.next148.1
  ...
  %index.next148.2 = add nsw i64 %index147, 12
  %44 = icmp eq i64 %index.next148.2, 1200
  br i1 %44, label %.preheader2.us.preheader.loopexit2, label %vector.body133, !llvm.loop !6

.preheader2.us.preheader.loopexit:                ; preds = %scalar.ph135
  br label %.preheader2.us.preheader

.preheader2.us.preheader.loopexit2:               ; preds = %vector.body133
  br label %.preheader2.us.preheader
...
.preheader2.us:                                   ; preds = %._crit_edge.us, %.preheader2.us.preheader
  ...
  %scevgep105 = getelementptr [1200 x double], [1200 x double]* %1, i64 %45, i64 0
  %46 = add nuw nsw i64 %indvar, 2
  %scevgep107 = getelementptr [1200 x double], [1200 x double]* %1, i64 %46, i64 0
  %scevgep109 = getelementptr [1200 x double], [1200 x double]* %2, i64 %indvar, i64 0
  %scevgep111 = getelementptr [1200 x double], [1200 x double]* %2, i64 %46, i64 0
  %47 = add nsw i64 %indvars.iv25, -1
  %bound0113 = icmp ult double* %scevgep105, %scevgep111
  %bound1114 = icmp ult double* %scevgep109, %scevgep107
  %memcheck.conflict116 = and i1 %bound0113, %bound1114
  br i1 %memcheck.conflict116, label %scalar.ph102.preheader, label %vector.body100.preheader

vector.body100.preheader:                         ; preds = %.preheader2.us
  br label %vector.body100

scalar.ph102.preheader:                           ; preds = %.preheader2.us
  br label %scalar.ph102

vector.body100:                                   ; preds = %vector.body100.preheader, %vector.body100
  %index119 = phi i64 [ %index.next120, %vector.body100 ], [ 0, %vector.body100.preheader ]
  %48 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv25, i64 %index119
  %49 = bitcast double* %48 to <2 x double>*
  %wide.load127 = load <2 x double>, <2 x double>* %49, align 8, !alias.scope !9, !noalias !12
  %50 = getelementptr double, double* %48, i64 2
  %51 = bitcast double* %50 to <2 x double>*
  %wide.load128 = load <2 x double>, <2 x double>* %51, align 8, !alias.scope !9, !noalias !12
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv25, i64 %index119
  %53 = bitcast double* %52 to <2 x double>*
  %wide.load129 = load <2 x double>, <2 x double>* %53, align 8, !alias.scope !12
  %54 = getelementptr double, double* %52, i64 2
  %55 = bitcast double* %54 to <2 x double>*
  %wide.load130 = load <2 x double>, <2 x double>* %55, align 8, !alias.scope !12
  %56 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %47, i64 %index119
  %57 = bitcast double* %56 to <2 x double>*
  %wide.load131 = load <2 x double>, <2 x double>* %57, align 8, !alias.scope !12
  %58 = getelementptr double, double* %56, i64 2
  %59 = bitcast double* %58 to <2 x double>*
  %wide.load132 = load <2 x double>, <2 x double>* %59, align 8, !alias.scope !12
  %60 = fsub <2 x double> %wide.load129, %wide.load131
  %61 = fsub <2 x double> %wide.load130, %wide.load132
  ...
  %64 = fsub <2 x double> %wide.load127, %62
  %65 = fsub <2 x double> %wide.load128, %63
  ...
  %index.next120 = add nuw nsw i64 %index119, 4
  %68 = icmp eq i64 %index.next120, 1200
  br i1 %68, label %._crit_edge.us.loopexit1, label %vector.body100, !llvm.loop !14

scalar.ph102:                                     ; preds = %scalar.ph102, %scalar.ph102.preheader
  %indvars.iv21 = phi i64 [ 0, %scalar.ph102.preheader ], [ %indvars.iv.next22.1, %scalar.ph102 ]
  %69 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv25, i64 %indvars.iv21
  %70 = load double, double* %69, align 8
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv25, i64 %indvars.iv21
  ...
  %78 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv25, i64 %indvars.iv.next22
  %79 = load double, double* %78, align 8
  %80 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv25, i64 %indvars.iv.next22
  ...
  br i1 %exitcond24.1, label %._crit_edge.us.loopexit, label %scalar.ph102, !llvm.loop !15

._crit_edge.us.loopexit:                          ; preds = %scalar.ph102
  br label %._crit_edge.us

._crit_edge.us.loopexit1:                         ; preds = %vector.body100
  br label %._crit_edge.us
...
scalar.ph135:                                     ; preds = %scalar.ph135, %scalar.ph135.preheader
  %indvars.iv = phi i64 [ 0, %scalar.ph135.preheader ], [ %indvars.iv.next.7, %scalar.ph135 ]
  ...
  br i1 %exitcond.7, label %.preheader2.us.preheader.loopexit, label %scalar.ph135, !llvm.loop !16
...
.preheader1.us:                                   ; preds = %._crit_edge9.us, %.preheader1.us.preheader
  ...
  %scevgep72 = getelementptr [1200 x double], [1200 x double]* %0, i64 %indvars.iv32, i64 1
  %111 = add nuw nsw i64 %indvars.iv32, 1
  %scevgep74 = getelementptr [1200 x double], [1200 x double]* %0, i64 %111, i64 0
  %scevgep76 = getelementptr [1200 x double], [1200 x double]* %2, i64 %indvars.iv32, i64 0
  %scevgep78 = getelementptr [1200 x double], [1200 x double]* %2, i64 %111, i64 0
  ...
  br i1 %memcheck.conflict83, label %scalar.ph69.preheader, label %vector.body67.preheader

vector.body67.preheader:                          ; preds = %.preheader1.us
  br label %vector.body67

vector.body67:                                    ; preds = %vector.body67.preheader, %vector.body67
  %index86 = phi i64 [ %index.next87, %vector.body67 ], [ 0, %vector.body67.preheader ]
  %offset.idx = or i64 %index86, 1
  %112 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv32, i64 %offset.idx
  %113 = bitcast double* %112 to <2 x double>*
  %wide.load94 = load <2 x double>, <2 x double>* %113, align 8, !alias.scope !17, !noalias !20
  %114 = getelementptr double, double* %112, i64 2
  %115 = bitcast double* %114 to <2 x double>*
  %wide.load95 = load <2 x double>, <2 x double>* %115, align 8, !alias.scope !17, !noalias !20
  %116 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv32, i64 %offset.idx
  %117 = bitcast double* %116 to <2 x double>*
  %wide.load96 = load <2 x double>, <2 x double>* %117, align 8, !alias.scope !20
  %118 = getelementptr double, double* %116, i64 2
  %119 = bitcast double* %118 to <2 x double>*
  %wide.load97 = load <2 x double>, <2 x double>* %119, align 8, !alias.scope !20
  %120 = add nsw i64 %offset.idx, -1
  %121 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv32, i64 %120
  %122 = bitcast double* %121 to <2 x double>*
  %wide.load98 = load <2 x double>, <2 x double>* %122, align 8, !alias.scope !20
  %123 = getelementptr double, double* %121, i64 2
  %124 = bitcast double* %123 to <2 x double>*
  %wide.load99 = load <2 x double>, <2 x double>* %124, align 8, !alias.scope !20
  %125 = fsub <2 x double> %wide.load96, %wide.load98
  %126 = fsub <2 x double> %wide.load97, %wide.load99
  ...
  %129 = fsub <2 x double> %wide.load94, %127
  %130 = fsub <2 x double> %wide.load95, %128
  ...
  %133 = icmp eq i64 %index.next87, 1196
  br i1 %133, label %scalar.ph69.preheader.loopexit, label %vector.body67, !llvm.loop !22

scalar.ph69.preheader.loopexit:                   ; preds = %vector.body67
  br label %scalar.ph69.preheader

scalar.ph69.preheader:                            ; preds = %scalar.ph69.preheader.loopexit, %.preheader1.us
  %indvars.iv28.ph = phi i64 [ 1, %.preheader1.us ], [ 1197, %scalar.ph69.preheader.loopexit ]
  br i1 true, label %scalar.ph69.prol.preheader, label %scalar.ph69.prol.loopexit.unr-lcssa

scalar.ph69.prol.preheader:                       ; preds = %scalar.ph69.preheader
  br label %scalar.ph69.prol

scalar.ph69.prol:                                 ; preds = %scalar.ph69.prol.preheader
  %134 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv32, i64 %indvars.iv28.ph
  %135 = load double, double* %134, align 8
  %136 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv32, i64 %indvars.iv28.ph
  %137 = load double, double* %136, align 8
  %138 = add nsw i64 %indvars.iv28.ph, -1
  ...
  br label %scalar.ph69.prol.loopexit.unr-lcssa

scalar.ph69.prol.loopexit.unr-lcssa:              ; preds = %scalar.ph69.preheader, %scalar.ph69.prol
  %indvars.iv28.unr.ph = phi i64 [ %indvars.iv.next29.prol, %scalar.ph69.prol ], [ %indvars.iv28.ph, %scalar.ph69.preheader ]
  br label %scalar.ph69.prol.loopexit

scalar.ph69.prol.loopexit:                        ; preds = %scalar.ph69.prol.loopexit.unr-lcssa
  br i1 false, label %._crit_edge9.us, label %scalar.ph69.preheader.new

scalar.ph69.preheader.new:                        ; preds = %scalar.ph69.prol.loopexit
  br label %scalar.ph69

scalar.ph69:                                      ; preds = %scalar.ph69, %scalar.ph69.preheader.new
  %indvars.iv28 = phi i64 [ %indvars.iv28.unr.ph, %scalar.ph69.preheader.new ], [ %indvars.iv.next29.1, %scalar.ph69 ]
  %144 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv32, i64 %indvars.iv28
  %145 = load double, double* %144, align 8
  %146 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv32, i64 %indvars.iv28
  %147 = load double, double* %146, align 8
  %148 = add nsw i64 %indvars.iv28, -1
  %149 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv32, i64 %148
  ...
  %154 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv32, i64 %indvars.iv.next29
  %155 = load double, double* %154, align 8
  %156 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv32, i64 %indvars.iv.next29
  %157 = load double, double* %156, align 8
  %158 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv32, i64 %indvars.iv28
  ...
  br i1 %exitcond31.1, label %._crit_edge9.us.unr-lcssa, label %scalar.ph69, !llvm.loop !23

._crit_edge9.us.unr-lcssa:                        ; preds = %scalar.ph69
  br label %._crit_edge9.us

._crit_edge9.us:                                  ; preds = %scalar.ph69.prol.loopexit, %._crit_edge9.us.unr-lcssa
...
.preheader.us:                                    ; preds = %._crit_edge11.us, %.preheader.us.preheader
  ...
  %scevgep44 = getelementptr [1200 x double], [1200 x double]* %2, i64 %indvars.iv39, i64 1199
  %scevgep46 = getelementptr [1200 x double], [1200 x double]* %0, i64 %indvars.iv39, i64 0
  %163 = add nuw nsw i64 %indvars.iv39, 1
  %scevgep48 = getelementptr [1200 x double], [1200 x double]* %0, i64 %163, i64 0
  %scevgep50 = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv39, i64 0
  %scevgep52 = getelementptr [1200 x double], [1200 x double]* %1, i64 %163, i64 1199
  %indvars.iv.next40 = add nuw nsw i64 %indvars.iv39, 1
  %bound0 = icmp ult double* %scevgep, %scevgep48
  %bound1 = icmp ult double* %scevgep46, %scevgep44
  %found.conflict = and i1 %bound0, %bound1
  %bound054 = icmp ult double* %scevgep, %scevgep52
  %bound155 = icmp ult double* %scevgep50, %scevgep44
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %164 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv39, i64 %index
  ...
  %wide.load58 = load <2 x double>, <2 x double>* %167, align 8, !alias.scope !24, !noalias !27
  %168 = or i64 %index, 1
  %169 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv39, i64 %168
  %170 = bitcast double* %169 to <2 x double>*
  %wide.load59 = load <2 x double>, <2 x double>* %170, align 8, !alias.scope !30
  %171 = getelementptr double, double* %169, i64 2
  %172 = bitcast double* %171 to <2 x double>*
  %wide.load60 = load <2 x double>, <2 x double>* %172, align 8, !alias.scope !30
  %173 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv39, i64 %index
  %174 = bitcast double* %173 to <2 x double>*
  %wide.load61 = load <2 x double>, <2 x double>* %174, align 8, !alias.scope !30
  %175 = getelementptr double, double* %173, i64 2
  %176 = bitcast double* %175 to <2 x double>*
  %wide.load62 = load <2 x double>, <2 x double>* %176, align 8, !alias.scope !30
  %177 = fsub <2 x double> %wide.load59, %wide.load61
  %178 = fsub <2 x double> %wide.load60, %wide.load62
  %179 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next40, i64 %index
  %180 = bitcast double* %179 to <2 x double>*
  %wide.load63 = load <2 x double>, <2 x double>* %180, align 8, !alias.scope !31
  %181 = getelementptr double, double* %179, i64 2
  %182 = bitcast double* %181 to <2 x double>*
  %wide.load64 = load <2 x double>, <2 x double>* %182, align 8, !alias.scope !31
  %183 = fadd <2 x double> %177, %wide.load63
  %184 = fadd <2 x double> %178, %wide.load64
  %185 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv39, i64 %index
  %186 = bitcast double* %185 to <2 x double>*
  %wide.load65 = load <2 x double>, <2 x double>* %186, align 8, !alias.scope !31
  %187 = getelementptr double, double* %185, i64 2
  %188 = bitcast double* %187 to <2 x double>*
  %wide.load66 = load <2 x double>, <2 x double>* %188, align 8, !alias.scope !31
  %189 = fsub <2 x double> %183, %wide.load65
  %190 = fsub <2 x double> %184, %wide.load66
  ...
  %194 = fsub <2 x double> %wide.load58, %192
...
._crit_edge19:                                    ; preds = %._crit_edge19.preheader, %._crit_edge19
  ...
  %198 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv39, i64 %indvars.iv35
  %199 = load double, double* %198, align 8
  %indvars.iv.next36 = add nuw nsw i64 %indvars.iv35, 1
  %200 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv39, i64 %indvars.iv.next36
  %201 = load double, double* %200, align 8
  %202 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv39, i64 %indvars.iv35
  %203 = load double, double* %202, align 8
  %204 = fsub double %201, %203
  %205 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next40, i64 %indvars.iv35
  %206 = load double, double* %205, align 8
  %207 = fadd double %204, %206
  %208 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv39, i64 %indvars.iv35
