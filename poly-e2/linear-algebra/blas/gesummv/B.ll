...
for.body:                                         ; preds = %for.inc24, %entry
  %indvars.iv24 = phi i64 [ 0, %entry ], [ %indvars.iv.next25, %for.inc24 ]
...
for.body5:                                        ; preds = %for.body5, %for.body
  ...
  %arrayidx13 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv24, i64 %indvars.iv
  ...
  %arrayidx23 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv24, i64 %indvars.iv
...
for.inc24:                                        ; preds = %for.body5
  ...
  %exitcond1 = icmp eq i64 %indvars.iv.next25, 1300
  br i1 %exitcond1, label %for.end26, label %for.body
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc void @kernel_gesummv(double %alpha, double %beta, [1300 x double]* nocapture readonly %A, [1300 x double]* nocapture readonly %B, double* nocapture %tmp, double* nocapture readonly %x, double* nocapture %y) unnamed_addr #2 {
entry:
  br label %for.body

for.body:                                         ; preds = %for.end, %entry
  %indvars.iv29 = phi i64 [ 0, %entry ], [ %indvars.iv.next30, %for.end ]
  %arrayidx = getelementptr inbounds double, double* %tmp, i64 %indvars.iv29
  store double 0.000000e+00, double* %arrayidx, align 8
  %arrayidx4 = getelementptr inbounds double, double* %y, i64 %indvars.iv29
...
for.body7:                                        ; preds = %for.body7, %for.body
  ...
  %arrayidx11 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv29, i64 %indvars.iv
  ...
  %arrayidx21 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv29, i64 %indvars.iv
  ...
  store double %add27, double* %arrayidx4, align 8
  %exitcond = icmp eq i64 %indvars.iv, 1299
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.end:                                          ; preds = %for.body7
  ...
  store double %add36, double* %arrayidx4, align 8
  %indvars.iv.next30 = add nuw nsw i64 %indvars.iv29, 1
  %exitcond1 = icmp eq i64 %indvars.iv.next30, 1300
  br i1 %exitcond1, label %for.end41, label %for.body
