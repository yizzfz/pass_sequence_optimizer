...
for.body.prol:                                    ; preds = %entry, %for.body.prol
  %indvars.iv16.prol = phi i64 [ %indvars.iv.next17.prol, %for.body.prol ], [ 0, %entry ]
  %prol.iter = phi i32 [ %prol.iter.sub, %for.body.prol ], [ 4, %entry ]
  %0 = trunc i64 %indvars.iv16.prol to i32
  %conv.prol = sitofp i32 %0 to double
  %arrayidx.prol = getelementptr inbounds double, double* %_fict_, i64 %indvars.iv16.prol
  store double %conv.prol, double* %arrayidx.prol, align 8
  %indvars.iv.next17.prol = add nuw nsw i64 %indvars.iv16.prol, 1
...
for.body8.us:                                     ; preds = %for.body8.us, %for.cond5.preheader.us
  ...
  br i1 %exitcond11, label %for.cond5.for.inc39_crit_edge.us, label %for.body8.us
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  %indvars.iv16 = phi i64 [ %indvars.iv.next17.7, %for.body ], [ %indvars.iv.next17.prol, %for.body.preheader ]
  ...
  %13 = trunc i64 %indvars.iv.next17.1 to i32
  ...
  %15 = trunc i64 %indvars.iv.next17.2 to i32
  ...
  %18 = trunc i64 %indvars.iv.next17.3 to i32
  ...
  %20 = trunc i64 %indvars.iv.next17.4 to i32
  ...
  %indvars.iv.next17.5 = add nsw i64 %indvars.iv16, 6
  %23 = trunc i64 %indvars.iv.next17.5 to i32
  %conv.6 = sitofp i32 %23 to double
  %arrayidx.6 = getelementptr inbounds double, double* %_fict_, i64 %indvars.iv.next17.5
  %24 = bitcast double* %arrayidx.6 to <2 x double>*
  %indvars.iv.next17.6 = add nsw i64 %indvars.iv16, 7
  %25 = trunc i64 %indvars.iv.next17.6 to i32
  ...
  %indvars.iv.next17.7 = add nsw i64 %indvars.iv16, 8
  %exitcond19.7 = icmp eq i64 %indvars.iv.next17.7, 500
  br i1 %exitcond19.7, label %for.cond5.preheader.us.preheader, label %for.body
...
for.cond10.preheader.us:                          ; preds = %for.cond10.preheader.us.preheader, %for.cond10.for.inc34_crit_edge.us
  ...
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.cond10.for.inc34_crit_edge.us ], [ 1, %for.cond10.preheader.us.preheader ]
  %0 = add i64 %indvar, 1
  %1 = add nsw i64 %indvars.iv28, -1
  %scevgep129 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %0, i64 0
  %scevgep132 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %0, i64 1200
  %scevgep135 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvar, i64 0
  %scevgep138 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %0, i64 1200
  %bound0140 = icmp ult double* %scevgep129, %scevgep138
  %bound1141 = icmp ult double* %scevgep135, %scevgep132
  %memcheck.conflict143 = and i1 %bound0140, %bound1141
  br i1 %memcheck.conflict143, label %for.body12.us.preheader, label %vector.body119.preheader

vector.body119.preheader:                         ; preds = %for.cond10.preheader.us
  br label %vector.body119

vector.body119:                                   ; preds = %vector.body119.preheader, %vector.body119
  %index146 = phi i64 [ %index.next147, %vector.body119 ], [ 0, %vector.body119.preheader ]
  %2 = shl i64 %index146, 1
  %3 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv28, i64 %2
  %4 = bitcast double* %3 to <4 x double>*
  %wide.vec155 = load <4 x double>, <4 x double>* %4, align 8, !alias.scope !3, !noalias !6
  ...
  %5 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv28, i64 %2
  %6 = bitcast double* %5 to <4 x double>*
  %wide.vec158 = load <4 x double>, <4 x double>* %6, align 8, !alias.scope !6
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %1, i64 %2
  %8 = bitcast double* %7 to <4 x double>*
  %wide.vec161 = load <4 x double>, <4 x double>* %8, align 8, !alias.scope !6
  %9 = fsub <4 x double> %wide.vec158, %wide.vec161
  ...
  %12 = fsub <2 x double> %strided.vec156, %11
  %13 = or i64 %2, 1
  %14 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv28, i64 %13
  ...
  %18 = fsub <2 x double> %strided.vec157, %17
  %19 = getelementptr double, double* %14, i64 -1
  %20 = bitcast double* %19 to <4 x double>*
  %interleaved.vec164 = shufflevector <2 x double> %12, <2 x double> %18, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec164, <4 x double>* %20, align 8, !alias.scope !3, !noalias !6
  %index.next147 = add i64 %index146, 2
  %21 = icmp eq i64 %index.next147, 600
  br i1 %21, label %middle.block120, label %vector.body119, !llvm.loop !8
...
for.body12.us:                                    ; preds = %for.body12.us.preheader, %for.body12.us
  %indvars.iv22 = phi i64 [ %indvars.iv.next23.1, %for.body12.us ], [ 0, %for.body12.us.preheader ]
  %arrayidx16.us = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv28, i64 %indvars.iv22
  %22 = load double, double* %arrayidx16.us, align 8
  %arrayidx20.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv28, i64 %indvars.iv22
  %23 = load double, double* %arrayidx20.us, align 8
  %arrayidx24.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %1, i64 %indvars.iv22
  ...
  %arrayidx16.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv28, i64 %indvars.iv.next23
  %25 = load double, double* %arrayidx16.us.1, align 8
  %arrayidx20.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv28, i64 %indvars.iv.next23
  %26 = load double, double* %arrayidx20.us.1, align 8
  %arrayidx24.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %1, i64 %indvars.iv.next23
  ...
  %exitcond25.1 = icmp eq i64 %indvars.iv.next23.1, 1200
  br i1 %exitcond25.1, label %for.cond10.for.inc34_crit_edge.us.loopexit, label %for.body12.us, !llvm.loop !11

for.cond10.for.inc34_crit_edge.us.loopexit:       ; preds = %for.body12.us
  br label %for.cond10.for.inc34_crit_edge.us

for.cond10.for.inc34_crit_edge.us:                ; preds = %for.cond10.for.inc34_crit_edge.us.loopexit, %middle.block120
  %indvars.iv.next29 = add nuw nsw i64 %indvars.iv28, 1
  %exitcond32 = icmp eq i64 %indvars.iv.next29, 1000
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond32, label %for.cond40.preheader.us.preheader, label %for.cond10.preheader.us
...
for.body3:                                        ; preds = %for.cond1.preheader, %for.body3
  ...
  %sunkaddr195 = mul i64 %indvars.iv52, 8
  %sunkaddr196 = add i64 %sunkaddr, %sunkaddr195
  %sunkaddr197 = inttoptr i64 %sunkaddr196 to i64*
  %28 = load i64, i64* %sunkaddr197, align 8
  ...
  %30 = load i64, i64* %sunkaddr197, align 8
  ...
  %32 = load i64, i64* %sunkaddr197, align 8
  ...
  %34 = load i64, i64* %sunkaddr197, align 8
  ...
  %36 = load i64, i64* %sunkaddr197, align 8
  ...
  %38 = load i64, i64* %sunkaddr197, align 8
  ...
  %40 = load i64, i64* %sunkaddr197, align 8
  ...
  %42 = load i64, i64* %sunkaddr197, align 8
  ...
  %exitcond21.7 = icmp eq i64 %indvars.iv.next.7, 1200
  br i1 %exitcond21.7, label %for.cond10.preheader.us.preheader, label %for.body3
...
for.cond40.preheader.us:                          ; preds = %for.cond40.preheader.us.preheader, %for.cond40.for.inc66_crit_edge.us
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.cond40.for.inc66_crit_edge.us ], [ 0, %for.cond40.preheader.us.preheader ]
  %arrayidx46.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv40, i64 1
  %44 = load double, double* %arrayidx46.us.prol, align 8
  %arrayidx50.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv40, i64 1
  %45 = load double, double* %arrayidx50.us.prol, align 8
  %arrayidx55.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv40, i64 0
  ...
  %scevgep88 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv40, i64 2
  %scevgep91 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv40, i64 1200
  %scevgep94 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv40, i64 1
  %scevgep97 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv40, i64 1200
  %bound099 = icmp ult double* %scevgep88, %scevgep97
  %bound1100 = icmp ult double* %scevgep94, %scevgep91
  %memcheck.conflict102 = and i1 %bound099, %bound1100
  br i1 %memcheck.conflict102, label %for.body42.us.preheader, label %vector.body82.preheader

vector.body82.preheader:                          ; preds = %for.cond40.preheader.us
  br label %vector.body82

vector.body82:                                    ; preds = %vector.body82.preheader, %vector.body82
  %index105 = phi i64 [ %index.next106, %vector.body82 ], [ 0, %vector.body82.preheader ]
  %47 = shl i64 %index105, 1
  %offset.idx = or i64 %47, 2
  %48 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv40, i64 %offset.idx
  ...
  %strided.vec112 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %50 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv40, i64 %offset.idx
  %51 = getelementptr double, double* %50, i64 -1
  %52 = bitcast double* %51 to <4 x double>*
  %wide.vec113 = load <4 x double>, <4 x double>* %52, align 8, !alias.scope !15
  ...
  %53 = fsub <2 x double> %strided.vec115, %strided.vec114
  %54 = fmul <2 x double> %53, <double 5.000000e-01, double 5.000000e-01>
  %55 = fsub <2 x double> %strided.vec, %54
  %56 = or i64 %47, 3
  %57 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv40, i64 %56
  %58 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv40, i64 %56
  %59 = getelementptr double, double* %58, i64 -1
  %60 = bitcast double* %59 to <4 x double>*
  %wide.vec116 = load <4 x double>, <4 x double>* %60, align 8, !alias.scope !15
  ...
  %61 = fsub <2 x double> %strided.vec118, %strided.vec117
  %62 = fmul <2 x double> %61, <double 5.000000e-01, double 5.000000e-01>
  %63 = fsub <2 x double> %strided.vec112, %62
  ...
  %66 = icmp eq i64 %index.next106, 598
  br i1 %66, label %middle.block83, label %vector.body82, !llvm.loop !17

middle.block83:                                   ; preds = %vector.body82
  br label %for.body42.us.preheader

for.body42.us.preheader:                          ; preds = %middle.block83, %for.cond40.preheader.us
  %indvars.iv33.ph = phi i64 [ 2, %for.cond40.preheader.us ], [ 1198, %middle.block83 ]
  br label %for.body42.us

for.body42.us:                                    ; preds = %for.body42.us.preheader, %for.body42.us
  %indvars.iv33 = phi i64 [ %indvars.iv.next34.1, %for.body42.us ], [ %indvars.iv33.ph, %for.body42.us.preheader ]
  %arrayidx46.us = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv40, i64 %indvars.iv33
  %67 = load double, double* %arrayidx46.us, align 8
  %arrayidx50.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv40, i64 %indvars.iv33
  %68 = load double, double* %arrayidx50.us, align 8
  %69 = add nsw i64 %indvars.iv33, -1
  %arrayidx55.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv40, i64 %69
  ...
  %arrayidx46.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv40, i64 %indvars.iv.next34
  %71 = load double, double* %arrayidx46.us.1, align 8
  %arrayidx50.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv40, i64 %indvars.iv.next34
  %72 = load double, double* %arrayidx50.us.1, align 8
  %arrayidx55.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv40, i64 %indvars.iv33
  ...
  %exitcond37.1 = icmp eq i64 %indvars.iv.next34.1, 1200
  br i1 %exitcond37.1, label %for.cond40.for.inc66_crit_edge.us, label %for.body42.us, !llvm.loop !18
...
for.cond73.preheader.us:                          ; preds = %for.cond73.preheader.us.preheader, %for.cond73.for.inc110_crit_edge.us
  ...
  %scevgep = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv48, i64 0
  %scevgep59 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv48, i64 1199
  %scevgep61 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv48, i64 0
  %74 = add i64 %indvars.iv48, 1
  %scevgep63 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %74, i64 0
  %scevgep65 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %indvars.iv48, i64 0
  %scevgep67 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %74, i64 1199
  %indvars.iv.next49 = add nuw nsw i64 %indvars.iv48, 1
  %bound0 = icmp ult double* %scevgep, %scevgep63
  %bound1 = icmp ult double* %scevgep61, %scevgep59
  %found.conflict = and i1 %bound0, %bound1
  %bound069 = icmp ult double* %scevgep, %scevgep67
  %bound170 = icmp ult double* %scevgep65, %scevgep59
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %75 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv48, i64 %index
  ...
  %wide.load73 = load <2 x double>, <2 x double>* %78, align 8, !alias.scope !19, !noalias !22
  %79 = or i64 %index, 1
  %80 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv48, i64 %79
  %81 = bitcast double* %80 to <2 x double>*
  %wide.load74 = load <2 x double>, <2 x double>* %81, align 8, !alias.scope !25
  %82 = getelementptr double, double* %80, i64 2
  %83 = bitcast double* %82 to <2 x double>*
  %wide.load75 = load <2 x double>, <2 x double>* %83, align 8, !alias.scope !25
  %84 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv48, i64 %index
  %85 = bitcast double* %84 to <2 x double>*
  %wide.load76 = load <2 x double>, <2 x double>* %85, align 8, !alias.scope !25
  %86 = getelementptr double, double* %84, i64 2
  %87 = bitcast double* %86 to <2 x double>*
  %wide.load77 = load <2 x double>, <2 x double>* %87, align 8, !alias.scope !25
  %88 = fsub <2 x double> %wide.load74, %wide.load76
  %89 = fsub <2 x double> %wide.load75, %wide.load77
  %90 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv.next49, i64 %index
  %91 = bitcast double* %90 to <2 x double>*
  %wide.load78 = load <2 x double>, <2 x double>* %91, align 8, !alias.scope !26
  %92 = getelementptr double, double* %90, i64 2
  %93 = bitcast double* %92 to <2 x double>*
  %wide.load79 = load <2 x double>, <2 x double>* %93, align 8, !alias.scope !26
  %94 = fadd <2 x double> %88, %wide.load78
  %95 = fadd <2 x double> %89, %wide.load79
  %96 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv48, i64 %index
  %97 = bitcast double* %96 to <2 x double>*
  %wide.load80 = load <2 x double>, <2 x double>* %97, align 8, !alias.scope !26
  %98 = getelementptr double, double* %96, i64 2
  %99 = bitcast double* %98 to <2 x double>*
  %wide.load81 = load <2 x double>, <2 x double>* %99, align 8, !alias.scope !26
  %100 = fsub <2 x double> %94, %wide.load80
  %101 = fsub <2 x double> %95, %wide.load81
  ...
  %105 = fsub <2 x double> %wide.load73, %103
...
for.body76.us.preheader:                          ; preds = %for.body76.us.preheader.loopexit, %for.cond73.preheader.us
  %indvars.iv44.ph = phi i64 [ 0, %for.cond73.preheader.us ], [ 1196, %for.body76.us.preheader.loopexit ]
  br label %for.body76.us

for.body76.us:                                    ; preds = %for.body76.us.preheader, %for.body76.us
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.body76.us ], [ %indvars.iv44.ph, %for.body76.us.preheader ]
  ...
  br i1 %exitcond47, label %for.cond73.for.inc110_crit_edge.us, label %for.body76.us, !llvm.loop !28
...
for.cond19.preheader.us:                          ; preds = %for.cond19.for.inc37_crit_edge.us, %for.end12
  %indvars.iv36 = phi i64 [ 0, %for.end12 ], [ %indvars.iv.next37, %for.cond19.for.inc37_crit_edge.us ]
  %13 = mul nsw i64 %indvars.iv36, 1000
  br label %for.body21.us

for.body21.us:                                    ; preds = %if.end28.us, %for.cond19.preheader.us
  %indvars.iv31 = phi i64 [ 0, %for.cond19.preheader.us ], [ %indvars.iv.next32, %if.end28.us ]
  %14 = add nsw i64 %indvars.iv31, %13
...
if.end28.us:                                      ; preds = %for.body21.us, %if.then26.us
  ...
  %arrayidx32.us = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv36, i64 %indvars.iv31
  ...
  br i1 %exitcond35, label %for.cond19.for.inc37_crit_edge.us, label %for.body21.us

for.cond19.for.inc37_crit_edge.us:                ; preds = %if.end28.us
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  %exitcond40 = icmp eq i64 %indvars.iv.next37, 1000
  br i1 %exitcond40, label %for.end39, label %for.cond19.preheader.us
...
if.end54.us:                                      ; preds = %for.body47.us, %if.then52.us
  ...
  br i1 %exitcond25, label %for.cond45.for.inc63_crit_edge.us, label %for.body47.us
