...
.preheader4:                                      ; preds = %._crit_edge16, %4
  %.0317 = phi i32 [ 1, %4 ], [ %153, %._crit_edge16 ]
  br label %.lver.check
...
.lver.check:                                      ; preds = %36, %.preheader4
  ...
  %scevgep16 = getelementptr [1000 x double], [1000 x double]* %2, i64 %5, i64 999
  %scevgep18 = getelementptr [1000 x double], [1000 x double]* %3, i64 %5, i64 0
  %scevgep20 = getelementptr [1000 x double], [1000 x double]* %3, i64 %5, i64 999
...
; <label>:36:                                     ; preds = %37
  ...
  br i1 %exitcond12, label %.lver.check40.preheader, label %.lver.check

.lver.check40.preheader:                          ; preds = %36
  br label %.lver.check40
...
; <label>:54:                                     ; preds = %54, %.ph
  %store_forwarded25 = phi double [ %load_initial24, %.ph ], [ %71, %54 ]
  ...
  %69 = fmul double %store_forwarded25, 0xC09F400000000001
  ...
  br i1 %exitcond, label %._crit_edge.us.loopexit49, label %54

._crit_edge.us.loopexit:                          ; preds = %.ph.lver.orig
  br label %._crit_edge.us

._crit_edge.us.loopexit49:                        ; preds = %54
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit49, %._crit_edge.us.loopexit
...
.lver.check40:                                    ; preds = %.lver.check40.preheader, %110
  %indvar26 = phi i64 [ %74, %110 ], [ 0, %.lver.check40.preheader ]
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %110 ], [ 1, %.lver.check40.preheader ]
  %74 = add i64 %indvar26, 1
  %scevgep28 = getelementptr [1000 x double], [1000 x double]* %2, i64 %74, i64 0
  %scevgep30 = getelementptr [1000 x double], [1000 x double]* %2, i64 %74, i64 999
  %scevgep32 = getelementptr [1000 x double], [1000 x double]* %3, i64 %74, i64 0
  %scevgep34 = getelementptr [1000 x double], [1000 x double]* %3, i64 %74, i64 999
  ...
  br i1 %memcheck.conflict39, label %.ph41.lver.orig.preheader, label %.ph41

.ph41.lver.orig.preheader:                        ; preds = %.lver.check40
  br label %.ph41.lver.orig

.ph41.lver.orig:                                  ; preds = %.ph41.lver.orig.preheader, %.ph41.lver.orig
  %indvars.iv5.lver.orig = phi i64 [ %indvars.iv.next6.lver.orig, %.ph41.lver.orig ], [ 1, %.ph41.lver.orig.preheader ]
  ...
  br i1 %exitcond7.lver.orig, label %._crit_edge12.us.loopexit, label %.ph41.lver.orig

.ph41:                                            ; preds = %.lver.check40
  %load_initial43 = load double, double* %scevgep28, align 8
  %load_initial46 = load double, double* %scevgep32, align 8
  br label %128

; <label>:110:                                    ; preds = %111
  %exitcond13 = icmp eq i64 %indvars.iv.next11, 999
  br i1 %exitcond13, label %._crit_edge16, label %.lver.check40

; <label>:111:                                    ; preds = %111, %._crit_edge12.us
  %indvars.iv8 = phi i64 [ 998, %._crit_edge12.us ], [ %indvars.iv.next9.1, %111 ]
...
; <label>:128:                                    ; preds = %128, %.ph41
  %store_forwarded47 = phi double [ %load_initial46, %.ph41 ], [ %150, %128 ]
  %store_forwarded44 = phi double [ %load_initial43, %.ph41 ], [ %139, %128 ]
  %indvars.iv5 = phi i64 [ 1, %.ph41 ], [ %indvars.iv.next6, %128 ]
  ...
  %133 = insertelement <2 x double> undef, double %store_forwarded44, i32 0
  ...
  %148 = fmul double %store_forwarded47, 0xC08F400000000001
  ...
  br i1 %exitcond7, label %._crit_edge12.us.loopexit48, label %128

._crit_edge12.us.loopexit:                        ; preds = %.ph41.lver.orig
  br label %._crit_edge12.us

._crit_edge12.us.loopexit48:                      ; preds = %128
  br label %._crit_edge12.us

._crit_edge12.us:                                 ; preds = %._crit_edge12.us.loopexit48, %._crit_edge12.us.loopexit
...
._crit_edge16:                                    ; preds = %110
  %153 = add nuw nsw i32 %.0317, 1
  %exitcond14 = icmp eq i32 %153, 501
  br i1 %exitcond14, label %154, label %.preheader4

; <label>:154:                                    ; preds = %._crit_edge16
  ret void
}
