...
entry:
  ...
  call fastcc void @kernel_2mm(double %0, double %1, [900 x double]* %arraydecay1221, [1100 x double]* %arraydecay17, [900 x double]* %arraydecay918, [1200 x double]* %arraydecay1019, [1200 x double]* %arraydecay1120)
...
if.then:                                          ; preds = %land.lhs.true
  call fastcc void @print_array([1200 x double]* %arraydecay1120)
  br label %if.end
...
for.body6.us.us.preheader:                        ; preds = %for.inc28.us, %for.cond4.preheader.us.preheader
  %indvars.iv4662.us = phi i64 [ 0, %for.cond4.preheader.us.preheader ], [ %indvars.iv.next47.us, %for.inc28.us ]
  %arrayidx.us = getelementptr inbounds [900 x double], [900 x double]* %tmp, i64 %indvars.iv4662.us
  %0 = ptrtoint [900 x double]* %arrayidx.us to i64
  br label %for.body6.us.us

for.inc28.us:                                     ; preds = %for.inc25.us.us
  %indvars.iv.next47.us = add nuw nsw i64 %indvars.iv4662.us, 1
  %exitcond11 = icmp eq i64 %indvars.iv.next47.us, 800
...
for.body6.us.us:                                  ; preds = %for.inc25.us.us, %for.body6.us.us.preheader
  %indvars.iv4459.us.us = phi i64 [ 0, %for.body6.us.us.preheader ], [ %indvars.iv.next45.us.us, %for.inc25.us.us ]
  %arrayidx8.us.us = getelementptr inbounds [900 x double], [900 x double]* %tmp, i64 %indvars.iv4662.us, i64 %indvars.iv4459.us.us
  store double 0.000000e+00, double* %arrayidx8.us.us, align 8
  %sunkaddr31.us.us = shl i64 %indvars.iv4459.us.us, 3
  %sunkaddr32.us.us = add i64 %sunkaddr31.us.us, %0
  %sunkaddr33.us.us = inttoptr i64 %sunkaddr32.us.us to double*
  %.pre = load double, double* %sunkaddr33.us.us, align 8
  br label %for.inc.us.us

for.inc25.us.us:                                  ; preds = %for.inc.us.us
  %indvars.iv.next45.us.us = add nuw nsw i64 %indvars.iv4459.us.us, 1
  %exitcond9 = icmp eq i64 %indvars.iv.next45.us.us, 900
...
for.inc.us.us:                                    ; preds = %for.inc.us.us, %for.body6.us.us
  ...
  %indvars.iv4257.us.us = phi i64 [ 0, %for.body6.us.us ], [ %indvars.iv.next43.us.us.1, %for.inc.us.us ]
  %arrayidx15.us.us = getelementptr inbounds [1100 x double], [1100 x double]* %A, i64 %indvars.iv4662.us, i64 %indvars.iv4257.us.us
  %2 = load double, double* %arrayidx15.us.us, align 8
  %mul.us.us = fmul double %2, %alpha
  %arrayidx19.us.us = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv4257.us.us, i64 %indvars.iv4459.us.us
  %3 = load double, double* %arrayidx19.us.us, align 8
  %mul20.us.us = fmul double %mul.us.us, %3
  %add.us.us = fadd double %1, %mul20.us.us
  store double %add.us.us, double* %sunkaddr33.us.us, align 8
  %indvars.iv.next43.us.us = or i64 %indvars.iv4257.us.us, 1
  %arrayidx15.us.us.1 = getelementptr inbounds [1100 x double], [1100 x double]* %A, i64 %indvars.iv4662.us, i64 %indvars.iv.next43.us.us
  %4 = load double, double* %arrayidx15.us.us.1, align 8
  %mul.us.us.1 = fmul double %4, %alpha
  %arrayidx19.us.us.1 = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv.next43.us.us, i64 %indvars.iv4459.us.us
  ...
  store double %add.us.us.1, double* %sunkaddr33.us.us, align 8
  %indvars.iv.next43.us.us.1 = add nsw i64 %indvars.iv4257.us.us, 2
  %exitcond8.1 = icmp eq i64 %indvars.iv.next43.us.us.1, 1100
...
for.body36.us.us.preheader:                       ; preds = %for.body36.us.us.preheader.preheader, %for.inc65.us
  %indvars.iv4054.us = phi i64 [ %indvars.iv.next41.us, %for.inc65.us ], [ 0, %for.body36.us.us.preheader.preheader ]
  %arrayidx38.us = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv4054.us
  %6 = ptrtoint [1200 x double]* %arrayidx38.us to i64
  br label %for.body36.us.us

for.inc65.us:                                     ; preds = %for.inc62.us.us
  %indvars.iv.next41.us = add nuw nsw i64 %indvars.iv4054.us, 1
  %exitcond7 = icmp eq i64 %indvars.iv.next41.us, 800
...
for.body36.us.us:                                 ; preds = %for.inc62.us.us, %for.body36.us.us.preheader
  %indvars.iv3851.us.us = phi i64 [ 0, %for.body36.us.us.preheader ], [ %indvars.iv.next39.us.us, %for.inc62.us.us ]
  %arrayidx40.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv4054.us, i64 %indvars.iv3851.us.us
  ...
  %sunkaddr35.us.us = shl i64 %indvars.iv3851.us.us, 3
  %sunkaddr36.us.us = add i64 %sunkaddr35.us.us, %6
  %sunkaddr37.us.us = inttoptr i64 %sunkaddr36.us.us to double*
  %.pre5 = load double, double* %sunkaddr37.us.us, align 8
  br label %for.inc59.us.us

for.inc62.us.us:                                  ; preds = %for.inc59.us.us
  %indvars.iv.next39.us.us = add nuw nsw i64 %indvars.iv3851.us.us, 1
  %exitcond6 = icmp eq i64 %indvars.iv.next39.us.us, 1200
...
for.inc59.us.us:                                  ; preds = %for.inc59.us.us, %for.body36.us.us
  ...
  %arrayidx48.us.us = getelementptr inbounds [900 x double], [900 x double]* %tmp, i64 %indvars.iv4054.us, i64 %indvars.iv49.us.us
  %9 = load double, double* %arrayidx48.us.us, align 8
  %arrayidx52.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv49.us.us, i64 %indvars.iv3851.us.us
  %10 = load double, double* %arrayidx52.us.us, align 8
  %mul53.us.us = fmul double %9, %10
  %add58.us.us = fadd double %8, %mul53.us.us
  store double %add58.us.us, double* %sunkaddr37.us.us, align 8
  %indvars.iv.next.us.us = add nuw nsw i64 %indvars.iv49.us.us, 1
  %arrayidx48.us.us.1 = getelementptr inbounds [900 x double], [900 x double]* %tmp, i64 %indvars.iv4054.us, i64 %indvars.iv.next.us.us
  %11 = load double, double* %arrayidx48.us.us.1, align 8
  %arrayidx52.us.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv.next.us.us, i64 %indvars.iv3851.us.us
  ...
  store double %add58.us.us.1, double* %sunkaddr37.us.us, align 8
  %indvars.iv.next.us.us.1 = add nsw i64 %indvars.iv49.us.us, 2
  %arrayidx48.us.us.2 = getelementptr inbounds [900 x double], [900 x double]* %tmp, i64 %indvars.iv4054.us, i64 %indvars.iv.next.us.us.1
  %13 = load double, double* %arrayidx48.us.us.2, align 8
  %arrayidx52.us.us.2 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv.next.us.us.1, i64 %indvars.iv3851.us.us
  ...
  store double %add58.us.us.2, double* %sunkaddr37.us.us, align 8
