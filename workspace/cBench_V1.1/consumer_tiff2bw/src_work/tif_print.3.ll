...
@__llvm_prf_nm = private constant [45 x i8] c"5+x\DA\0B\F1ts\0B(\CA\CC+q\C9,JM.\C9/\AAd\8C\0F\01\8A\15\80\C4\1C\8B\9333C\12\D3\D1\85\00\04l\13F", section "__llvm_prf_names"
@llvm.used = appending global [5 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_TIFFPrintDirectory to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd__TIFFprintAsciiTag to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd__TIFFprintAscii to i8*), i8* bitcast ([10 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
