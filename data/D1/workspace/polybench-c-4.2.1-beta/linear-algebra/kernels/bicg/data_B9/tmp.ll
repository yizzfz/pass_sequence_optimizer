...
define internal void @init_array(i32, i32, [1900 x double]* nocapture, double* nocapture, double* nocapture) #2 {
  %6 = icmp sgt i32 %0, 0
  br i1 %6, label %.lr.ph9, label %..preheader_crit_edge
...
.lr.ph9:                                          ; preds = %5
  ...
  br i1 %lcmp.mod27, label %.lr.ph9..prol.loopexit25_crit_edge, label %.prol.preheader24

.lr.ph9..prol.loopexit25_crit_edge:               ; preds = %.lr.ph9
...
.prol.loopexit25:                                 ; preds = %.lr.ph9..prol.loopexit25_crit_edge, %.prol.preheader24
  %indvars.iv20.unr = phi i64 [ 0, %.lr.ph9..prol.loopexit25_crit_edge ], [ 1, %.prol.preheader24 ]
  %9 = icmp eq i32 %0, 1
  br i1 %9, label %.prol.loopexit25..preheader_crit_edge, label %.lr.ph9.new.preheader

.prol.loopexit25..preheader_crit_edge:            ; preds = %.prol.loopexit25
  br label %.preheader
...
.preheader:                                       ; preds = %.prol.loopexit25..preheader_crit_edge, %..preheader_crit_edge, %.preheader.loopexit
  %10 = icmp sgt i32 %1, 0
  br i1 %10, label %.lr.ph5, label %.preheader.._crit_edge6_crit_edge
...
.lr.ph5.split.preheader:                          ; preds = %.lr.ph5
  ...
  br i1 %lcmp.mod19, label %.lr.ph5.split.preheader..lr.ph5.split.prol.loopexit_crit_edge, label %.lr.ph5.split.prol

.lr.ph5.split.preheader..lr.ph5.split.prol.loopexit_crit_edge: ; preds = %.lr.ph5.split.preheader
...
.lr.ph5.split.prol.loopexit:                      ; preds = %.lr.ph5.split.preheader..lr.ph5.split.prol.loopexit_crit_edge, %.lr.ph5.split.prol
  %indvars.iv14.unr = phi i64 [ 0, %.lr.ph5.split.preheader..lr.ph5.split.prol.loopexit_crit_edge ], [ 1, %.lr.ph5.split.prol ]
  %15 = icmp eq i32 %1, 1
  br i1 %15, label %.lr.ph5.split.prol.loopexit.._crit_edge6_crit_edge, label %.lr.ph5.split.preheader28

.lr.ph5.split.prol.loopexit.._crit_edge6_crit_edge: ; preds = %.lr.ph5.split.prol.loopexit
  br label %._crit_edge6
...
.lr.ph5.split.us:                                 ; preds = %._crit_edge.us..lr.ph5.split.us_crit_edge, %.lr.ph5.split.us.preheader
  ...
  br i1 %lcmp.mod, label %.lr.ph5.split.us..prol.loopexit_crit_edge, label %.prol.preheader
...
.prol.loopexit:                                   ; preds = %.lr.ph5.split.us..prol.loopexit_crit_edge, %.prol.preheader
  ...
  br i1 %13, label %.prol.loopexit.._crit_edge.us_crit_edge, label %.lr.ph5.split.us.new.preheader
...
._crit_edge.us:                                   ; preds = %.prol.loopexit.._crit_edge.us_crit_edge, %._crit_edge.us.loopexit
  ...
  br i1 %exitcond, label %._crit_edge6.loopexit, label %._crit_edge.us..lr.ph5.split.us_crit_edge
...
._crit_edge6:                                     ; preds = %.lr.ph5.split.prol.loopexit.._crit_edge6_crit_edge, %.preheader.._crit_edge6_crit_edge, %._crit_edge6.loopexit31, %._crit_edge6.loopexit
  ret void
}
...
define internal void @kernel_bicg(i32, i32, [1900 x double]* nocapture readonly, double* nocapture, double* nocapture, double* nocapture readonly, double* nocapture readonly) #2 {
  ...
  %9 = icmp sgt i32 %0, 0
  br i1 %9, label %.preheader.loopexit, label %..preheader_crit_edge
...
.preheader:                                       ; preds = %..preheader_crit_edge, %.preheader.loopexit
  %15 = icmp sgt i32 %1, 0
  br i1 %15, label %.lr.ph4, label %.preheader.._crit_edge5_crit_edge

.preheader.._crit_edge5_crit_edge:                ; preds = %.preheader
  br label %._crit_edge5

.lr.ph4:                                          ; preds = %.preheader
  %16 = icmp sgt i32 %0, 0
  br i1 %16, label %.lr.ph4.split.us.preheader, label %._crit_edge5.loopexit9
...
.lr.ph4.split.us:                                 ; preds = %._crit_edge.us..lr.ph4.split.us_crit_edge, %.lr.ph4.split.us.preheader
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %._crit_edge.us..lr.ph4.split.us_crit_edge ], [ 0, %.lr.ph4.split.us.preheader ]
  %17 = getelementptr inbounds double, double* %4, i64 %indvars.iv10
  store double 0.000000e+00, double* %17, align 8
  %18 = getelementptr inbounds double, double* %6, i64 %indvars.iv10
  br label %19

; <label>:19:                                     ; preds = %._crit_edge, %.lr.ph4.split.us
  ...
  %23 = getelementptr inbounds [1900 x double], [1900 x double]* %2, i64 %indvars.iv10, i64 %indvars.iv
...
._crit_edge.us:                                   ; preds = %19
  ...
  br i1 %exitcond13, label %._crit_edge5.loopexit, label %._crit_edge.us..lr.ph4.split.us_crit_edge
...
._crit_edge5:                                     ; preds = %.preheader.._crit_edge5_crit_edge, %._crit_edge5.loopexit, %._crit_edge5.loopexit9
  ret void
}
...
define internal void @print_array(i32, i32, double* nocapture readonly, double* nocapture readonly) #0 {
  ...
  %9 = icmp sgt i32 %0, 0
  br i1 %9, label %.lr.ph7.preheader, label %.._crit_edge8_crit_edge
...
; <label>:15:                                     ; preds = %.lr.ph7._crit_edge, %13
  ...
  br i1 %exitcond12, label %._crit_edge8.loopexit, label %..lr.ph7_crit_edge

..lr.ph7_crit_edge:                               ; preds = %15
  br label %.lr.ph7
...
._crit_edge8:                                     ; preds = %.._crit_edge8_crit_edge, %._crit_edge8.loopexit
  ...
  %24 = icmp sgt i32 %1, 0
  br i1 %24, label %.lr.ph.preheader, label %._crit_edge8.._crit_edge_crit_edge
...
.lr.ph:                                           ; preds = %..lr.ph_crit_edge, %.lr.ph.preheader
  ...
  %26 = srem i32 %25, 20
  %27 = icmp eq i32 %26, 0
  br i1 %27, label %28, label %.lr.ph._crit_edge
...
; <label>:30:                                     ; preds = %.lr.ph._crit_edge, %28
...
..lr.ph_crit_edge:                                ; preds = %30
  br label %.lr.ph

._crit_edge.loopexit:                             ; preds = %30
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge8.._crit_edge_crit_edge, %._crit_edge.loopexit
