...
define internal fastcc void @kernel_trisolv(i32, [2000 x double]*, double*, double*) unnamed_addr #0 {
  ...
  store i32 0, i32* %9, align 4
  %10 = icmp sgt i32 %0, 0
  br i1 %10, label %.lr.ph3, label %56
...
.lr.ph3:                                          ; preds = %4
  ...
  %sunkaddr17 = ptrtoint double* %12 to i64
  %sunkaddr = ptrtoint double* %12 to i64
  br label %18
...
.prol.preheader:                                  ; preds = %.lr.ph
  %26 = getelementptr inbounds [2000 x double], [2000 x double]* %13, i64 %indvars.iv11, i64 0
  %27 = load double, double* %26, align 8
  ...
  %30 = load double, double* %sunkaddr16, align 8
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.lr.ph.new ], [ %indvars.iv.unr.ph, %.lr.ph.new.preheader ]
  %34 = getelementptr inbounds [2000 x double], [2000 x double]* %13, i64 %indvars.iv11, i64 %indvars.iv
  %35 = load double, double* %34, align 8
  %36 = getelementptr inbounds double, double* %12, i64 %indvars.iv
  %37 = load double, double* %36, align 8
  %38 = fmul double %35, %37
  %39 = load double, double* %sunkaddr20, align 8
  %40 = fsub double %39, %38
  store double %40, double* %sunkaddr20, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %41 = getelementptr inbounds [2000 x double], [2000 x double]* %13, i64 %indvars.iv11, i64 %indvars.iv.next
  %42 = load double, double* %41, align 8
  %43 = getelementptr inbounds double, double* %12, i64 %indvars.iv.next
  %44 = load double, double* %43, align 8
  %45 = fmul double %42, %44
  %46 = load double, double* %sunkaddr20, align 8
  %47 = fsub double %46, %45
  store double %47, double* %sunkaddr20, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, %wide.trip.count.1
  br i1 %exitcond.1, label %._crit_edge.loopexit, label %.lr.ph.new
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %18
  %48 = getelementptr inbounds double, double* %12, i64 %indvars.iv11
  %49 = load double, double* %48, align 8
  %50 = getelementptr inbounds [2000 x double], [2000 x double]* %13, i64 %indvars.iv11, i64 %indvars.iv11
  %51 = load double, double* %50, align 8
  %52 = fdiv double %49, %51
  %53 = getelementptr inbounds double, double* %12, i64 %indvars.iv11
  store double %52, double* %53, align 8
  %indvars.iv.next12 = add nsw i64 %indvars.iv11, 1
  %indvars.iv.next10 = add i32 %indvars.iv9, 1
  %54 = icmp slt i64 %indvars.iv.next12, %17
  %indvar.next = add i32 %indvar, 1
  br i1 %54, label %18, label %._crit_edge4
...
; <label>:17:                                     ; preds = %.lr.ph, %27
  ...
  %21 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %18, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i64 0, i64 0), double %20) #5
...
; <label>:25:                                     ; preds = %17
  ...
  %fputc = tail call i32 @fputc(i32 10, %struct._IO_FILE* %26) #4
  br label %27
...
; <label>:31:                                     ; preds = %._crit_edge, %2
  ...
  %32 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %.lcssa, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #5
