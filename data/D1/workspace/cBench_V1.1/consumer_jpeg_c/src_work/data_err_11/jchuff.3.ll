...
@__llvm_prf_nm = private constant [321 x i8] c"\BE\02\00jpeg_make_c_derived_tbl\01jpeg_gen_optimal_table\01jinit_huff_encoder\01tmp1.ll:start_pass_huff\01tmp1.ll:encode_mcu_gather\01tmp1.ll:finish_pass_gather\01tmp1.ll:encode_mcu_huff\01tmp1.ll:finish_pass_huff\01tmp1.ll:htest_one_block\01tmp1.ll:emit_restart\01tmp1.ll:encode_one_block\01tmp1.ll:flush_bits\01tmp1.ll:dump_buffer\01tmp1.ll:emit_bits", section "__llvm_prf_names"
@llvm.used = appending global [16 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_make_c_derived_tbl to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_gen_optimal_table to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jinit_huff_encoder to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_start_pass_huff to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_encode_mcu_gather to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_finish_pass_gather to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_encode_mcu_huff to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_finish_pass_huff to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_htest_one_block to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_emit_restart to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_encode_one_block to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_flush_bits to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_dump_buffer to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_emit_bits to i8*), i8* bitcast ([10 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([321 x i8], [321 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
