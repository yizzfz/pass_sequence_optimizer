...
.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge
  ...
  %.phi.trans.insert14 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %9, i64 1
  %.pre15 = load double, double* %.phi.trans.insert14, align 8
  %.phi.trans.insert16 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv9, i64 1
  %.pre17 = load double, double* %.phi.trans.insert16, align 8
  %.phi.trans.insert18 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next10, i64 0
  %.pre19 = load double, double* %.phi.trans.insert18, align 8
  %.phi.trans.insert20 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next10, i64 1
  %.pre21 = load double, double* %.phi.trans.insert20, align 8
  br label %10

; <label>:10:                                     ; preds = %10, %.preheader
  %11 = phi double [ %.pre21, %.preheader ], [ %29, %10 ]
  %12 = phi double [ %.pre19, %.preheader ], [ %11, %10 ]
  %13 = phi double [ %.pre17, %.preheader ], [ %24, %10 ]
  %14 = phi double [ %.pre15, %.preheader ], [ %18, %10 ]
  %15 = phi double [ %.pre, %.preheader ], [ %14, %10 ]
  %store_forwarded = phi double [ %load_initial, %.preheader ], [ %31, %10 ]
