...
; <label>:7:                                      ; preds = %7, %.lr.ph5.split.us
  ...
  br i1 %exitcond.1, label %._crit_edge.us, label %7
...
; <label>:22:                                     ; preds = %22, %.lr.ph9
  %indvars.iv11 = phi i64 [ 0, %.lr.ph9 ], [ %indvars.iv.next12.1.1, %22 ]
  ...
  br i1 %exitcond13.1.1, label %.lr.ph5.split.us.preheader, label %22

.lr.ph5.split.us.preheader:                       ; preds = %22
