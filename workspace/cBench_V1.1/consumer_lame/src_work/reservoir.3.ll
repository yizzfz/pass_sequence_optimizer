...
@__llvm_prf_nm = private constant [49 x i8] c"2/x\DA\0BJ-.s+J\CCMuJM\CF\CCc\0C\02r}\13+\9C2K\8A\C1l\C7\94\AC\D2\E2\120\13\AC\CA5/\05\00\D6\C1\12y", section "__llvm_prf_names"
@llvm.used = appending global [5 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_ResvFrameBegin to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_ResvMaxBits to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_ResvAdjust to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_ResvFrameEnd to i8*), i8* getelementptr inbounds ([49 x i8], [49 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
