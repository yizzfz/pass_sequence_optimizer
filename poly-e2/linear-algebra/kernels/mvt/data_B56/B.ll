...
for.body.new:                                     ; preds = %for.inc12, %for.body.preheader
...
for.body3:                                        ; preds = %for.body3, %for.body.new
  %indvars.iv18 = phi i64 [ 0, %for.body.new ], [ %indvars.iv.next19.1, %for.body3 ]
  %0 = phi double [ %.pre, %for.body.new ], [ %add.1, %for.body3 ]
...
for.inc12:                                        ; preds = %for.body3
  ...
  br i1 %exitcond, label %for.body17.new.preheader, label %for.body.new

for.body17.new.preheader:                         ; preds = %for.inc12
  %sunkaddr4 = ptrtoint double* %x2 to i64
  br label %for.body17.new

for.body17.new:                                   ; preds = %for.body17.new.preheader, %for.inc36
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc36 ], [ 0, %for.body17.new.preheader ]
...
for.body20:                                       ; preds = %for.body20, %for.body17.new
  %indvars.iv = phi i64 [ 0, %for.body17.new ], [ %indvars.iv.next.1, %for.body20 ]
  %5 = phi double [ %.pre14, %for.body17.new ], [ %add30.1, %for.body20 ]
...
for.inc36:                                        ; preds = %for.body20
  ...
  br i1 %exitcond29, label %for.end38, label %for.body17.new
