...
for.cond7.preheader.us:                           ; preds = %for.cond7.preheader.us.preheader, %for.inc22.us
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc22.us ], [ 0, %for.cond7.preheader.us.preheader ]
...
for.body:                                         ; preds = %for.body, %for.body.preheader
  %inc12 = phi i32 [ 0, %for.body.preheader ], [ %inc.1, %for.body ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i32 [ 0, %vector.ph ], [ %index.next.4, %vector.body ]
...
for.body10.us:                                    ; preds = %for.body10.us, %for.body5.us
  %27 = phi double [ %.pre, %for.body5.us ], [ %add.us.2, %for.body10.us ]
  ...
  %28 = load double, double* %arrayidx16.us, align 8
  %arrayidx18.us = getelementptr inbounds double, double* %x, i64 %indvars.iv
  %29 = load double, double* %arrayidx18.us, align 8
  %mul.us = fmul double %28, %29
  %add.us = fadd double %27, %mul.us
  ...
  %30 = load double, double* %arrayidx16.us.1, align 8
  %arrayidx18.us.1 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next
  %31 = load double, double* %arrayidx18.us.1, align 8
  ...
  %32 = load double, double* %arrayidx16.us.2, align 8
  %arrayidx18.us.2 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next.1
  %33 = load double, double* %arrayidx18.us.2, align 8
  %mul.us.2 = fmul double %32, %33
  ...
  br i1 %cmp9.us.2, label %for.body10.us, label %vector.memcheck

vector.memcheck:                                  ; preds = %for.body10.us
  ...
  %35 = load double, double* %arrayidx32.us73, align 8
  %mul35.us74 = fmul double %35, %add.us.2
  %add36.us75 = fadd double %34, %mul35.us74
...
vector.body78.preheader:                          ; preds = %vector.memcheck
...
vector.body78:                                    ; preds = %vector.body78.preheader, %vector.body78
  ...
  %36 = load double, double* %arrayidx12.us, align 8, !alias.scope !4
  ...
  %wide.load = load <2 x double>, <2 x double>* %40, align 8, !alias.scope !7, !noalias !9
  %41 = getelementptr double, double* %39, i64 2
  %42 = bitcast double* %41 to <2 x double>*
  %wide.load103 = load <2 x double>, <2 x double>* %42, align 8, !alias.scope !7, !noalias !9
  %43 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 %offset.idx
  %44 = bitcast double* %43 to <2 x double>*
  %wide.load104 = load <2 x double>, <2 x double>* %44, align 8, !alias.scope !11
  %45 = getelementptr double, double* %43, i64 2
  %46 = bitcast double* %45 to <2 x double>*
  %wide.load105 = load <2 x double>, <2 x double>* %46, align 8, !alias.scope !11
  %47 = fmul <2 x double> %wide.load104, %38
  %48 = fmul <2 x double> %wide.load105, %38
  %49 = fadd <2 x double> %wide.load, %47
  %50 = fadd <2 x double> %wide.load103, %48
  store <2 x double> %49, <2 x double>* %40, align 8, !alias.scope !7, !noalias !9
  store <2 x double> %50, <2 x double>* %42, align 8, !alias.scope !7, !noalias !9
  %index.next96 = add i64 %index95, 4
  %51 = icmp eq i64 %index.next96, 2096
  br i1 %51, label %for.body26.us.for.body26.us_crit_edge.preheader.loopexit, label %vector.body78, !llvm.loop !12
...
for.body26.us.for.body26.us_crit_edge.preheader:  ; preds = %for.body26.us.for.body26.us_crit_edge.preheader.loopexit, %vector.memcheck
  %indvars.iv.next6476.ph = phi i64 [ 1, %vector.memcheck ], [ 2097, %for.body26.us.for.body26.us_crit_edge.preheader.loopexit ]
...
for.body26.us.for.body26.us_crit_edge:            ; preds = %for.body26.us.for.body26.us_crit_edge.preheader, %for.body26.us.for.body26.us_crit_edge
  ...
  %52 = load double, double* %arrayidx28.us, align 8
  %arrayidx32.us = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 %indvars.iv.next6476
  %53 = load double, double* %arrayidx32.us, align 8
  %mul35.us = fmul double %53, %.pre71
  %add36.us = fadd double %52, %mul35.us
  ...
  br i1 %cmp25.us, label %for.body26.us.for.body26.us_crit_edge, label %for.inc42.us, !llvm.loop !13
