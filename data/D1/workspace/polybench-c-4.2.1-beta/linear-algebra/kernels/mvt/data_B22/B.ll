...
define internal fastcc void @init_array(i32, double* nocapture, double* nocapture, double* nocapture, double* nocapture, [2000 x double]* nocapture) unnamed_addr #2 {
  br i1 true, label %.lr.ph25, label %._crit_edge

.lr.ph25:                                         ; preds = %6
  %7 = fdiv double 0.000000e+00, 2.000000e+03
  br label %.lr.ph.us

.lr.ph.us:                                        ; preds = %..loopexit_crit_edge.us, %.lr.ph25
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %..loopexit_crit_edge.us ], [ 0, %.lr.ph25 ]
...
.preheader27.us.preheader:                        ; preds = %6
  %sunkaddr54 = ptrtoint double* %1 to i64
...
.prol.preheader42:                                ; preds = %.preheader27.us
  %sunkaddr51 = shl i64 %indvars.iv46, 3
  %sunkaddr52 = add i64 %sunkaddr, %sunkaddr51
  %sunkaddr53 = inttoptr i64 %sunkaddr52 to double*
  %7 = load double, double* %sunkaddr53, align 8
  %8 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv46, i64 0
  %9 = load double, double* %8, align 8
  %10 = load double, double* %3, align 8
  %11 = fmul double %9, %10
  %12 = fadd double %7, %11
  store double %12, double* %sunkaddr53, align 8
...
.prol.loopexit43:                                 ; preds = %.prol.preheader42, %.preheader27.us
  ...
  br i1 false, label %._crit_edge33.us, label %.preheader27.us.new.preheader

.preheader27.us.new.preheader:                    ; preds = %.prol.loopexit43
  %sunkaddr55 = shl i64 %indvars.iv46, 3
  %sunkaddr56 = add i64 %sunkaddr54, %sunkaddr55
  %sunkaddr57 = inttoptr i64 %sunkaddr56 to double*
  %.pre = load double, double* %sunkaddr57, align 8
  br label %.preheader27.us.new

.preheader27.us.new:                              ; preds = %.preheader27.us.new.preheader, %.preheader27.us.new
  %13 = phi double [ %25, %.preheader27.us.new ], [ %.pre, %.preheader27.us.new.preheader ]
  %indvars.iv38 = phi i64 [ %indvars.iv.next39.1, %.preheader27.us.new ], [ %indvars.iv38.unr.ph, %.preheader27.us.new.preheader ]
  %14 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv46, i64 %indvars.iv38
  %15 = load double, double* %14, align 8
  %16 = getelementptr inbounds double, double* %3, i64 %indvars.iv38
  %17 = load double, double* %16, align 8
  %18 = fmul double %15, %17
  %19 = fadd double %13, %18
  store double %19, double* %sunkaddr57, align 8
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  %20 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv46, i64 %indvars.iv.next39
  %21 = load double, double* %20, align 8
  %22 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next39
  %23 = load double, double* %22, align 8
  %24 = fmul double %21, %23
  %25 = fadd double %19, %24
  store double %25, double* %sunkaddr57, align 8
...
.preheader.us.preheader:                          ; preds = %._crit_edge33.us
  %sunkaddr66 = ptrtoint double* %2 to i64
...
.prol.preheader:                                  ; preds = %.preheader.us
  %sunkaddr63 = shl i64 %indvars.iv35, 3
  %sunkaddr64 = add i64 %sunkaddr62, %sunkaddr63
  %sunkaddr65 = inttoptr i64 %sunkaddr64 to double*
  %26 = load double, double* %sunkaddr65, align 8
  %27 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 0, i64 %indvars.iv35
...
.preheader.us.new.preheader:                      ; preds = %.prol.loopexit
  %sunkaddr67 = shl i64 %indvars.iv35, 3
  %sunkaddr68 = add i64 %sunkaddr66, %sunkaddr67
  %sunkaddr69 = inttoptr i64 %sunkaddr68 to double*
  %.pre50 = load double, double* %sunkaddr69, align 8
  br label %.preheader.us.new

.preheader.us.new:                                ; preds = %.preheader.us.new.preheader, %.preheader.us.new
  %32 = phi double [ %44, %.preheader.us.new ], [ %.pre50, %.preheader.us.new.preheader ]
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.preheader.us.new ], [ %indvars.iv.unr.ph, %.preheader.us.new.preheader ]
  %33 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv, i64 %indvars.iv35
  %34 = load double, double* %33, align 8
  %35 = getelementptr inbounds double, double* %4, i64 %indvars.iv
  %36 = load double, double* %35, align 8
  %37 = fmul double %34, %36
  %38 = fadd double %32, %37
  store double %38, double* %sunkaddr69, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %39 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv.next, i64 %indvars.iv35
  %40 = load double, double* %39, align 8
  %41 = getelementptr inbounds double, double* %4, i64 %indvars.iv.next
  %42 = load double, double* %41, align 8
  %43 = fmul double %40, %42
  %44 = fadd double %38, %43
  store double %44, double* %sunkaddr69, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
...
define internal fastcc void @print_array(i32, double* nocapture readonly, double* nocapture readonly) unnamed_addr #0 {
  ...
  br i1 true, label %.lr.ph16.preheader, label %._crit_edge17

.lr.ph16.preheader:                               ; preds = %3
  br label %.lr.ph16

.lr.ph16:                                         ; preds = %.lr.ph16.preheader, %13
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %13 ], [ 0, %.lr.ph16.preheader ]
...
._crit_edge17.loopexit:                           ; preds = %13
