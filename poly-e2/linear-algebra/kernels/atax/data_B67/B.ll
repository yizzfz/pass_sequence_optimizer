...
for.body10.us:                                    ; preds = %for.body10.us, %for.body6.us
  ...
  %1 = add nsw i64 %indvars.iv16, %indvars.iv
  ...
  %3 = add nsw i64 %indvars.iv16, %indvars.iv.next
...
for.body5.us.preheader:                           ; preds = %vector.body
  %sunkaddr82 = ptrtoint double* %tmp to i64
  %sunkaddr = ptrtoint double* %tmp to i64
  %sunkaddr9 = ptrtoint double* %tmp to i64
  %sunkaddr13 = ptrtoint double* %y to i64
...
for.body5.us:                                     ; preds = %for.body5.us.preheader, %for.inc42.us
  ...
  %sunkaddr83 = shl i64 %indvars.iv65, 3
...
for.body26.us.for.body26.us_crit_edge:            ; preds = %for.body26.us.for.body26.us_crit_edge.1, %for.body10.us.for.body26.us_crit_edge
  %indvars.iv.next644 = phi i64 [ 1, %for.body10.us.for.body26.us_crit_edge ], [ %indvars.iv.next64.1, %for.body26.us.for.body26.us_crit_edge.1 ]
  %.pre71 = load double, double* %sunkaddr8, align 8
  %arrayidx28.us = getelementptr inbounds double, double* %y, i64 %indvars.iv.next644
  %26 = load double, double* %arrayidx28.us, align 8
  %arrayidx32.us = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 %indvars.iv.next644
  ...
  %indvars.iv.next64 = add nuw nsw i64 %indvars.iv.next644, 1
...
for.body10.us:                                    ; preds = %for.body10.us, %for.body5.us
  ...
  store double %add.us, double* %sunkaddr85, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %add.us.1, double* %sunkaddr85, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %cmp9.us.1 = icmp slt i64 %indvars.iv.next.1, 2100
  br i1 %cmp9.us.1, label %for.body10.us, label %for.body10.us.for.body26.us_crit_edge

for.body10.us.for.body26.us_crit_edge:            ; preds = %for.body10.us
  %33 = load double, double* %y, align 8
  %arrayidx32.us1 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 0
  %34 = load double, double* %arrayidx32.us1, align 8
  %mul35.us2 = fmul double %34, %add.us.1
  %add36.us3 = fadd double %33, %mul35.us2
  store double %add36.us3, double* %y, align 8
  %sunkaddr6 = mul i64 %indvars.iv65, 8
  %sunkaddr7 = add i64 %sunkaddr, %sunkaddr6
  %sunkaddr8 = inttoptr i64 %sunkaddr7 to double*
  %sunkaddr10 = mul i64 %indvars.iv65, 8
...
for.body26.us.for.body26.us_crit_edge.1:          ; preds = %for.body26.us.for.body26.us_crit_edge
  %.pre71.1 = load double, double* %sunkaddr12, align 8
  %sunkaddr14 = mul i64 %indvars.iv.next644, 8
  ...
  %mul35.us.1 = fmul double %36, %.pre71.1
  %add36.us.1 = fadd double %35, %mul35.us.1
  store double %add36.us.1, double* %sunkaddr17, align 8
  %indvars.iv.next64.1 = add nsw i64 %indvars.iv.next644, 2
  br label %for.body26.us.for.body26.us_crit_edge
}
