...
.lr.ph51.split.us:                                ; preds = %._crit_edge47.us, %.lr.ph51.split.us.preheader
  %indvars.iv1749.us = phi i64 [ 0, %.lr.ph51.split.us.preheader ], [ %indvars.iv.next18.us, %._crit_edge47.us ]
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv1749.us
  store double 0.000000e+00, double* %5, align 8
  %sunkaddr6 = shl i64 %indvars.iv1749.us, 3
  %sunkaddr7 = add i64 %4, %sunkaddr6
  %sunkaddr8 = inttoptr i64 %sunkaddr7 to double*
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph51.split.us
  %indvars.iv1544.us = phi i64 [ 0, %.lr.ph51.split.us ], [ %indvars.iv.next16.us.4, %._crit_edge ]
  %6 = phi double [ 0.000000e+00, %.lr.ph51.split.us ], [ %21, %._crit_edge ]
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1544.us, i64 %indvars.iv1749.us
  %8 = load double, double* %7, align 8
  %9 = fadd double %6, %8
  store double %9, double* %sunkaddr8, align 8
  %indvars.iv.next16.us = add nuw nsw i64 %indvars.iv1544.us, 1
  %10 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next16.us, i64 %indvars.iv1749.us
  %11 = load double, double* %10, align 8
  %12 = fadd double %9, %11
  store double %12, double* %sunkaddr8, align 8
  %indvars.iv.next16.us.1 = add nuw nsw i64 %indvars.iv1544.us, 2
  %13 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next16.us.1, i64 %indvars.iv1749.us
  %14 = load double, double* %13, align 8
  %15 = fadd double %12, %14
  store double %15, double* %sunkaddr8, align 8
  %indvars.iv.next16.us.2 = add nuw nsw i64 %indvars.iv1544.us, 3
  %16 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next16.us.2, i64 %indvars.iv1749.us
  %17 = load double, double* %16, align 8
  %18 = fadd double %15, %17
  store double %18, double* %sunkaddr8, align 8
  %indvars.iv.next16.us.3 = add nuw nsw i64 %indvars.iv1544.us, 4
  %19 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next16.us.3, i64 %indvars.iv1749.us
  %20 = load double, double* %19, align 8
  %21 = fadd double %18, %20
  store double %21, double* %sunkaddr8, align 8
  %indvars.iv.next16.us.4 = add nuw nsw i64 %indvars.iv1544.us, 5
  %exitcond70.4 = icmp eq i64 %indvars.iv.next16.us.4, 1400
  br i1 %exitcond70.4, label %._crit_edge47.us, label %._crit_edge

._crit_edge47.us:                                 ; preds = %._crit_edge
  %22 = fdiv double %21, %0
  %sunkaddr38 = shl nuw nsw i64 %indvars.iv1749.us, 3
  %sunkaddr39 = add i64 %sunkaddr, %sunkaddr38
  %sunkaddr40 = inttoptr i64 %sunkaddr39 to double*
  store double %22, double* %sunkaddr40, align 8
  %indvars.iv.next18.us = add nuw nsw i64 %indvars.iv1749.us, 1
  %exitcond71 = icmp eq i64 %indvars.iv.next18.us, 1200
  br i1 %exitcond71, label %._crit_edge47.us..preheader20.us_crit_edge, label %.lr.ph51.split.us

._crit_edge47.us..preheader20.us_crit_edge:       ; preds = %._crit_edge47.us
  %scevgep23 = getelementptr double, double* %3, i64 1200
  br label %vector.memcheck

vector.memcheck:                                  ; preds = %._crit_edge41.us, %._crit_edge47.us..preheader20.us_crit_edge
  %indvars.iv1342.us = phi i64 [ 0, %._crit_edge47.us..preheader20.us_crit_edge ], [ %23, %._crit_edge41.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv1342.us, i64 0
  %23 = add nuw nsw i64 %indvars.iv1342.us, 1
  %scevgep21 = getelementptr [1200 x double], [1200 x double]* %1, i64 %23, i64 0
  %bound0 = icmp ult double* %scevgep, %scevgep23
  %bound1 = icmp ugt double* %scevgep21, %3
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1342.us, i64 %offset.idx
  %27 = bitcast double* %26 to <8 x double>*
  %wide.vec28 = load <8 x double>, <8 x double>* %27, align 8, !alias.scope !4, !noalias !1
  %28 = fsub <8 x double> %wide.vec28, %wide.vec
  ...
  %33 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1342.us, i64 %32
  ...
  br i1 %39, label %._crit_edge41.us.loopexit41, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv1139.us = phi i64 [ %indvars.iv.next12.us.3, %scalar.ph ], [ 0, %scalar.ph.preheader ]
  %40 = getelementptr inbounds double, double* %3, i64 %indvars.iv1139.us
  %41 = load double, double* %40, align 8
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1342.us, i64 %indvars.iv1139.us
  %43 = load double, double* %42, align 8
  %44 = fsub double %43, %41
  store double %44, double* %42, align 8
  %indvars.iv.next12.us = or i64 %indvars.iv1139.us, 1
  %45 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next12.us
  %46 = load double, double* %45, align 8
  %47 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1342.us, i64 %indvars.iv.next12.us
  %48 = load double, double* %47, align 8
  %49 = fsub double %48, %46
  store double %49, double* %47, align 8
  %indvars.iv.next12.us.1 = or i64 %indvars.iv1139.us, 2
  %50 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next12.us.1
  %51 = load double, double* %50, align 8
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1342.us, i64 %indvars.iv.next12.us.1
  %53 = load double, double* %52, align 8
  %54 = fsub double %53, %51
  store double %54, double* %52, align 8
  %indvars.iv.next12.us.2 = or i64 %indvars.iv1139.us, 3
  %55 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next12.us.2
  %56 = load double, double* %55, align 8
  %57 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1342.us, i64 %indvars.iv.next12.us.2
  %58 = load double, double* %57, align 8
  %59 = fsub double %58, %56
  store double %59, double* %57, align 8
  %indvars.iv.next12.us.3 = add nuw nsw i64 %indvars.iv1139.us, 4
  %exitcond67.3 = icmp eq i64 %indvars.iv.next12.us.3, 1200
...
._crit_edge41.us.loopexit41:                      ; preds = %vector.body
  br label %._crit_edge41.us

._crit_edge41.us:                                 ; preds = %._crit_edge41.us.loopexit41, %._crit_edge41.us.loopexit
  %exitcond68 = icmp eq i64 %23, 1400
...
.lr.ph.us.us.preheader:                           ; preds = %._crit_edge35.us-lcssa.us.us, %.preheader.us.preheader
  %indvars.iv936.us = phi i64 [ 0, %.preheader.us.preheader ], [ %indvars.iv.next10.us, %._crit_edge35.us-lcssa.us.us ]
  br label %.lr.ph.us.us

._crit_edge35.us-lcssa.us.us:                     ; preds = %._crit_edge.us.us
  %indvars.iv.next10.us = add nuw nsw i64 %indvars.iv936.us, 1
  %exitcond74 = icmp eq i64 %indvars.iv.next10.us, 1200
  br i1 %exitcond74, label %._crit_edge38, label %.lr.ph.us.us.preheader

.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph.us.us.preheader
  %indvars.iv733.us.us = phi i64 [ %indvars.iv936.us, %.lr.ph.us.us.preheader ], [ %indvars.iv.next8.us.us, %._crit_edge.us.us ]
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv936.us, i64 %indvars.iv733.us.us
  store double 0.000000e+00, double* %61, align 8
  br label %._crit_edge34

._crit_edge.us.us:                                ; preds = %._crit_edge34
  %62 = fdiv double %76, %60
  store double %62, double* %61, align 8
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv733.us.us, i64 %indvars.iv936.us
  store double %62, double* %63, align 8
  %indvars.iv.next8.us.us = add nuw nsw i64 %indvars.iv733.us.us, 1
...
._crit_edge34:                                    ; preds = %._crit_edge34, %.lr.ph.us.us
  %indvars.iv31.us.us = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.us.us.1, %._crit_edge34 ]
  %64 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %76, %._crit_edge34 ]
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv31.us.us, i64 %indvars.iv936.us
  %66 = load double, double* %65, align 8
  %67 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv31.us.us, i64 %indvars.iv733.us.us
  %68 = load double, double* %67, align 8
  %69 = fmul double %66, %68
  %70 = fadd double %64, %69
  store double %70, double* %61, align 8
  %indvars.iv.next.us.us = or i64 %indvars.iv31.us.us, 1
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next.us.us, i64 %indvars.iv936.us
  %72 = load double, double* %71, align 8
  %73 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next.us.us, i64 %indvars.iv733.us.us
  ...
  br i1 %exitcond66.1, label %._crit_edge.us.us, label %._crit_edge34
...
._crit_edge6:                                     ; preds = %._crit_edge5, %.preheader
  %indvars.iv5 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %._crit_edge5 ]
  %6 = add nuw nsw i64 %indvars.iv5, %5
...
._crit_edge5:                                     ; preds = %._crit_edge6, %10
  ...
  %13 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv26, i64 %indvars.iv5
  %14 = load double, double* %13, align 8
