...
.lr.ph95:                                         ; preds = %._crit_edge100..lr.ph95_crit_edge, %.preheader73.lr.ph
  %indvars.iv149 = phi i64 [ 0, %.preheader73.lr.ph ], [ %indvars.iv.next150, %._crit_edge100..lr.ph95_crit_edge ]
  %indvars.iv147 = phi i64 [ 1, %.preheader73.lr.ph ], [ %indvars.iv.next148, %._crit_edge100..lr.ph95_crit_edge ]
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph95
  ...
  %8 = sub nsw i64 0, %indvars.iv131
  %9 = trunc i64 %8 to i32
  %10 = srem i32 %9, 2000
  %11 = sitofp i32 %10 to double
  %12 = fdiv double %11, 2.000000e+03
  %13 = fadd double %12, 1.000000e+00
  %14 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv149, i64 %indvars.iv131
...
._crit_edge96:                                    ; preds = %._crit_edge
  ...
  br i1 %16, label %._crit_edge100.loopexit, label %._crit_edge100
...
._crit_edge100:                                   ; preds = %._crit_edge96, %._crit_edge100.loopexit
  ...
  br i1 %exitcond152, label %._crit_edge102, label %._crit_edge100..lr.ph95_crit_edge
...
._crit_edge92.us.prol:                            ; preds = %._crit_edge92.us.prol, %._crit_edge92.us.prol.preheader
  ...
  %prol.iter162 = phi i64 [ 0, %._crit_edge92.us.prol.preheader ], [ %prol.iter162.sub, %._crit_edge92.us.prol ]
  ...
  %prol.iter162.sub = add nsw i64 %prol.iter162, -1
  %prol.iter162.cmp = icmp eq i64 %prol.iter162.sub, 0
  br i1 %prol.iter162.cmp, label %._crit_edge92.us.prol.loopexit.unr-lcssa, label %._crit_edge92.us.prol, !llvm.loop !1
...
.preheader69.us.us.preheader:                     ; preds = %.preheader69.us.us.preheader.preheader, %._crit_edge81.us
  ...
  %37 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 0, i64 %indvars.iv119
...
.preheader69.us.us:                               ; preds = %._crit_edge79.us.us, %.preheader69.us.us.preheader
  ...
  %38 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv115, i64 %indvars.iv119
  br i1 true, label %._crit_edge153.prol.loopexit.unr-lcssa, label %._crit_edge153.prol.preheader

._crit_edge153.prol.preheader:                    ; preds = %.preheader69.us.us
...
._crit_edge153.prol:                              ; preds = %._crit_edge153.prol.preheader
  ...
  %42 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv115, i64 0
  %43 = load double, double* %42, align 8
  %44 = fadd double %43, %41
  store double %44, double* %42, align 8
  br label %._crit_edge153.prol.loopexit.unr-lcssa

._crit_edge153.prol.loopexit.unr-lcssa:           ; preds = %.preheader69.us.us, %._crit_edge153.prol
...
._crit_edge79.us.us.unr-lcssa:                    ; preds = %._crit_edge153
  br label %._crit_edge79.us.us

._crit_edge79.us.us:                              ; preds = %._crit_edge153.prol.loopexit, %._crit_edge79.us.us.unr-lcssa
...
._crit_edge153:                                   ; preds = %._crit_edge153, %.preheader69.us.us.new
  ...
  %46 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv111, i64 %indvars.iv119
  %47 = load double, double* %46, align 8
  %48 = fmul double %45, %47
  %49 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv115, i64 %indvars.iv111
  %50 = load double, double* %49, align 8
  %51 = fadd double %50, %48
  store double %51, double* %49, align 8
  %indvars.iv.next112 = add nuw nsw i64 %indvars.iv111, 1
  %52 = load double, double* %38, align 8
  %53 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv.next112, i64 %indvars.iv119
  %54 = load double, double* %53, align 8
  %55 = fmul double %52, %54
  %56 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv115, i64 %indvars.iv.next112
  ...
  br i1 %exitcond114.1, label %._crit_edge79.us.us.unr-lcssa, label %._crit_edge153
...
._crit_edge154.prol.preheader:                    ; preds = %.preheader.us
  br label %._crit_edge154.prol

._crit_edge154.prol:                              ; preds = %._crit_edge154.prol, %._crit_edge154.prol.preheader
  %indvars.iv.prol = phi i64 [ 0, %._crit_edge154.prol.preheader ], [ %indvars.iv.next.prol, %._crit_edge154.prol ]
  %prol.iter = phi i64 [ 0, %._crit_edge154.prol.preheader ], [ %prol.iter.sub, %._crit_edge154.prol ]
  %59 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv107, i64 %indvars.iv.prol
  %60 = bitcast double* %59 to i64*
  %61 = load i64, i64* %60, align 8
  %62 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv107, i64 %indvars.iv.prol
  %63 = bitcast double* %62 to i64*
  store i64 %61, i64* %63, align 8
  %indvars.iv.next.prol = add nuw nsw i64 %indvars.iv.prol, 1
  %prol.iter.sub = add nsw i64 %prol.iter, -1
  %prol.iter.cmp = icmp eq i64 %prol.iter.sub, 0
  br i1 %prol.iter.cmp, label %._crit_edge154.prol.loopexit.unr-lcssa, label %._crit_edge154.prol, !llvm.loop !3

._crit_edge154.prol.loopexit.unr-lcssa:           ; preds = %._crit_edge154.prol
  br label %._crit_edge154.prol.loopexit

._crit_edge154.prol.loopexit:                     ; preds = %.preheader.us, %._crit_edge154.prol.loopexit.unr-lcssa
  br i1 false, label %._crit_edge.us, label %.preheader.us.new

.preheader.us.new:                                ; preds = %._crit_edge154.prol.loopexit
  br label %._crit_edge154

._crit_edge154:                                   ; preds = %._crit_edge154, %.preheader.us.new
  %indvars.iv = phi i64 [ 0, %.preheader.us.new ], [ %indvars.iv.next.3, %._crit_edge154 ]
  %64 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv107, i64 %indvars.iv
  %65 = bitcast double* %64 to i64*
  %66 = load i64, i64* %65, align 8
  %67 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv107, i64 %indvars.iv
  %68 = bitcast double* %67 to i64*
  store i64 %66, i64* %68, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %69 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv107, i64 %indvars.iv.next
  %70 = bitcast double* %69 to i64*
  %71 = load i64, i64* %70, align 8
  %72 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv107, i64 %indvars.iv.next
  %73 = bitcast double* %72 to i64*
  store i64 %71, i64* %73, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %74 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv107, i64 %indvars.iv.next.1
  %75 = bitcast double* %74 to i64*
  %76 = load i64, i64* %75, align 8
  %77 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv107, i64 %indvars.iv.next.1
  %78 = bitcast double* %77 to i64*
  store i64 %76, i64* %78, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %79 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv107, i64 %indvars.iv.next.2
  %80 = bitcast double* %79 to i64*
  %81 = load i64, i64* %80, align 8
  %82 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv107, i64 %indvars.iv.next.2
  %83 = bitcast double* %82 to i64*
  store i64 %81, i64* %83, align 8
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %exitcond106.3 = icmp eq i64 %indvars.iv.next.3, 2000
  br i1 %exitcond106.3, label %._crit_edge.us.unr-lcssa, label %._crit_edge154

._crit_edge.us.unr-lcssa:                         ; preds = %._crit_edge154
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge154.prol.loopexit, %._crit_edge.us.unr-lcssa
...
._crit_edge76:                                    ; preds = %._crit_edge76.loopexit, %._crit_edge102.thread
  %84 = phi i8* [ %3, %._crit_edge102.thread ], [ %19, %._crit_edge76.loopexit ]
...
.preheader44:                                     ; preds = %._crit_edge49, %.preheader44.preheader
  %indvars.iv87 = phi i2 [ %indvars.iv.next88, %._crit_edge49 ], [ 0, %.preheader44.preheader ]
  %indvars.iv74 = phi i64 [ 0, %.preheader44.preheader ], [ %indvars.iv.next75, %._crit_edge49 ]
...
._crit_edge79.prol:                               ; preds = %._crit_edge79.prol, %._crit_edge79.prol.preheader
  ...
  %prol.iter.sub = add nsw i64 %prol.iter, -1
  %prol.iter.cmp = icmp eq i64 %prol.iter.sub, 0
  br i1 %prol.iter.cmp, label %._crit_edge79.prol.loopexit.unr-lcssa, label %._crit_edge79.prol, !llvm.loop !4
...
.lr.ph:                                           ; preds = %._crit_edge..lr.ph_crit_edge, %.preheader.preheader
  %indvars.iv23 = phi i64 [ 0, %.preheader.preheader ], [ %indvars.iv.next24, %._crit_edge..lr.ph_crit_edge ]
  %indvars.iv21 = phi i64 [ 1, %.preheader.preheader ], [ %indvars.iv.next22, %._crit_edge..lr.ph_crit_edge ]
...
._crit_edge:                                      ; preds = %._crit_edge27
  ...
  br i1 %exitcond26, label %._crit_edge14.loopexit, label %._crit_edge..lr.ph_crit_edge
