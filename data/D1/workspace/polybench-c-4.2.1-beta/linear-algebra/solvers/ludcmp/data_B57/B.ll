...
._crit_edge:                                      ; preds = %._crit_edge38, %4
  ...
  br i1 %11, label %.lr.ph28.preheader, label %.lr.ph37.split.preheader
...
.lr.ph37.split.preheader:                         ; preds = %.lr.ph37..lr.ph37.split.preheader_crit_edge, %._crit_edge
  ...
  br i1 %min.iters.check, label %.lr.ph37.split.preheader106, label %min.iters.checked

.lr.ph37.split.preheader106:                      ; preds = %middle.block, %min.iters.checked, %.lr.ph37.split.preheader
  %indvars.iv75.ph = phi i64 [ %indvars.iv92, %min.iters.checked ], [ %indvars.iv92, %.lr.ph37.split.preheader ], [ %ind.end, %middle.block ]
...
min.iters.checked:                                ; preds = %.lr.ph37.split.preheader
  ...
  br i1 %cmp.zero, label %.lr.ph37.split.preheader106, label %vector.body.preheader

vector.body.preheader:                            ; preds = %min.iters.checked
  %13 = and i64 %9, 1
  %lcmp.mod120 = icmp eq i64 %13, 0
...
vector.body.prol:                                 ; preds = %vector.body.prol.preheader
  ...
  %wide.load105.prol = load <2 x i64>, <2 x i64>* %17, align 8
  store <2 x i64> %wide.load.prol, <2 x i64>* %15, align 8
  store <2 x i64> %wide.load105.prol, <2 x i64>* %17, align 8
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader.new
  ...
  %wide.load105 = load <2 x i64>, <2 x i64>* %23, align 8
  store <2 x i64> %wide.load, <2 x i64>* %21, align 8
  store <2 x i64> %wide.load105, <2 x i64>* %23, align 8
  %index.next = add i64 %index, 4
  ...
  %wide.load105.1 = load <2 x i64>, <2 x i64>* %28, align 8
  store <2 x i64> %wide.load.1, <2 x i64>* %26, align 8
  store <2 x i64> %wide.load105.1, <2 x i64>* %28, align 8
...
middle.block:                                     ; preds = %vector.body.prol.loopexit, %middle.block.unr-lcssa
  ...
  br i1 %cmp.n, label %._crit_edge38, label %.lr.ph37.split.preheader106
...
.prol.loopexit.unr-lcssa:                         ; preds = %.lr.ph37.split.us, %35
  %.lcssa113.unr.ph = phi double [ %40, %35 ], [ undef, %.lr.ph37.split.us ]
  %indvars.iv79.unr.ph = phi i64 [ 1, %35 ], [ 0, %.lr.ph37.split.us ]
  %.130.us.unr.ph = phi double [ %40, %35 ], [ %34, %.lr.ph37.split.us ]
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.prol.loopexit.unr-lcssa
  br i1 %32, label %._crit_edge33.us, label %.lr.ph37.split.us.new

.lr.ph37.split.us.new:                            ; preds = %.prol.loopexit
  br label %41

; <label>:41:                                     ; preds = %41, %.lr.ph37.split.us.new
  %indvars.iv79 = phi i64 [ %indvars.iv79.unr.ph, %.lr.ph37.split.us.new ], [ %indvars.iv.next80.1, %41 ]
  %.130.us = phi double [ %.130.us.unr.ph, %.lr.ph37.split.us.new ], [ %55, %41 ]
  ...
  br i1 %exitcond87.1, label %._crit_edge33.us.unr-lcssa, label %41

._crit_edge33.us.unr-lcssa:                       ; preds = %41
  br label %._crit_edge33.us

._crit_edge33.us:                                 ; preds = %.prol.loopexit, %._crit_edge33.us.unr-lcssa
  %.lcssa113 = phi double [ %.lcssa113.unr.ph, %.prol.loopexit ], [ %55, %._crit_edge33.us.unr-lcssa ]
  store double %.lcssa113, double* %33, align 8
  %indvars.iv.next91 = add nuw i64 %indvars.iv90, 1
  %56 = icmp slt i64 %indvars.iv.next91, 2000
  br i1 %56, label %.lr.ph37.split.us, label %._crit_edge38.loopexit
...
.lr.ph28:                                         ; preds = %.lr.ph28.preheader, %._crit_edge25
  ...
  br i1 %61, label %.lr.ph24.preheader, label %._crit_edge25

.lr.ph24.preheader:                               ; preds = %.lr.ph28
  %wide.trip.count69 = zext i32 %indvars.iv67 to i64
  %62 = and i64 %57, 1
  %lcmp.mod118 = icmp eq i64 %62, 0
  br i1 %lcmp.mod118, label %.lr.ph24.prol.preheader, label %.lr.ph24.prol.loopexit.unr-lcssa
...
.lr.ph24.prol.loopexit.unr-lcssa:                 ; preds = %.lr.ph24.preheader, %.lr.ph24.prol
  %.lcssa112.unr.ph = phi double [ %67, %.lr.ph24.prol ], [ undef, %.lr.ph24.preheader ]
  %indvars.iv62.unr.ph = phi i64 [ 1, %.lr.ph24.prol ], [ 0, %.lr.ph24.preheader ]
  %.022.unr.ph = phi double [ %67, %.lr.ph24.prol ], [ %60, %.lr.ph24.preheader ]
  br label %.lr.ph24.prol.loopexit

.lr.ph24.prol.loopexit:                           ; preds = %.lr.ph24.prol.loopexit.unr-lcssa
  %68 = icmp eq i64 %58, 0
  br i1 %68, label %._crit_edge25.loopexit, label %.lr.ph24.preheader.new
...
.lr.ph24:                                         ; preds = %.lr.ph24, %.lr.ph24.preheader.new
  ...
  %.022 = phi double [ %.022.unr.ph, %.lr.ph24.preheader.new ], [ %82, %.lr.ph24 ]
...
._crit_edge25.loopexit:                           ; preds = %.lr.ph24.prol.loopexit, %._crit_edge25.loopexit.unr-lcssa
  %.lcssa112 = phi double [ %.lcssa112.unr.ph, %.lr.ph24.prol.loopexit ], [ %82, %._crit_edge25.loopexit.unr-lcssa ]
  br label %._crit_edge25

._crit_edge25:                                    ; preds = %._crit_edge25.loopexit, %.lr.ph28
  %.0.lcssa = phi double [ %60, %.lr.ph28 ], [ %.lcssa112, %._crit_edge25.loopexit ]
  ...
  br i1 %86, label %.lr.ph28, label %.lr.ph37

.lr.ph37.split:                                   ; preds = %.lr.ph37.split.preheader106, %.lr.ph37.split
  %indvars.iv75 = phi i64 [ %indvars.iv.next76, %.lr.ph37.split ], [ %indvars.iv75.ph, %.lr.ph37.split.preheader106 ]
  %exitcond77 = icmp eq i64 %indvars.iv75, 1999
  %indvars.iv.next76 = add nuw i64 %indvars.iv75, 1
  br i1 %exitcond77, label %._crit_edge38.loopexit107, label %.lr.ph37.split, !llvm.loop !21

._crit_edge38.loopexit:                           ; preds = %._crit_edge33.us
  br label %._crit_edge38

._crit_edge38.loopexit107:                        ; preds = %.lr.ph37.split
  br label %._crit_edge38

._crit_edge38:                                    ; preds = %._crit_edge38.loopexit107, %._crit_edge38.loopexit, %middle.block
...
._crit_edge1:                                     ; preds = %._crit_edge1.preheader, %._crit_edge17
  ...
  br i1 %92, label %.lr.ph16.preheader, label %._crit_edge17

.lr.ph16.preheader:                               ; preds = %._crit_edge1
  %wide.trip.count58 = zext i32 %indvars.iv56 to i64
  %xtraiter114 = and i64 %indvars.iv60, 3
  %lcmp.mod115 = icmp eq i64 %xtraiter114, 0
  br i1 %lcmp.mod115, label %.lr.ph16.prol.loopexit, label %.lr.ph16.prol.preheader
...
.lr.ph16.prol:                                    ; preds = %.lr.ph16.prol, %.lr.ph16.prol.preheader
  ...
  %.214.prol = phi double [ %98, %.lr.ph16.prol ], [ %91, %.lr.ph16.prol.preheader ]
  %prol.iter116 = phi i64 [ %prol.iter116.sub, %.lr.ph16.prol ], [ %xtraiter114, %.lr.ph16.prol.preheader ]
  ...
  br i1 %prol.iter116.cmp, label %.lr.ph16.prol.loopexit.unr-lcssa, label %.lr.ph16.prol, !llvm.loop !23
...
.lr.ph16.prol.loopexit:                           ; preds = %.lr.ph16.preheader, %.lr.ph16.prol.loopexit.unr-lcssa
  %.lcssa111.unr = phi double [ undef, %.lr.ph16.preheader ], [ %98, %.lr.ph16.prol.loopexit.unr-lcssa ]
  %indvars.iv51.unr = phi i64 [ 0, %.lr.ph16.preheader ], [ %indvars.iv.next52.prol, %.lr.ph16.prol.loopexit.unr-lcssa ]
  %.214.unr = phi double [ %91, %.lr.ph16.preheader ], [ %98, %.lr.ph16.prol.loopexit.unr-lcssa ]
  %99 = icmp ult i64 %89, 3
  br i1 %99, label %._crit_edge17.loopexit, label %.lr.ph16.preheader.new
...
.lr.ph16:                                         ; preds = %.lr.ph16, %.lr.ph16.preheader.new
  ...
  %.214 = phi double [ %.214.unr, %.lr.ph16.preheader.new ], [ %121, %.lr.ph16 ]
...
._crit_edge17.loopexit:                           ; preds = %.lr.ph16.prol.loopexit, %._crit_edge17.loopexit.unr-lcssa
  %.lcssa111 = phi double [ %.lcssa111.unr, %.lr.ph16.prol.loopexit ], [ %121, %._crit_edge17.loopexit.unr-lcssa ]
  br label %._crit_edge17

._crit_edge17:                                    ; preds = %._crit_edge17.loopexit, %._crit_edge1
  %.2.lcssa = phi double [ %91, %._crit_edge1 ], [ %.lcssa111, %._crit_edge17.loopexit ]
  ...
  br i1 %123, label %._crit_edge1, label %._crit_edge3.preheader
...
._crit_edge3:                                     ; preds = %._crit_edge3.preheader, %._crit_edge10.._crit_edge3_crit_edge
  ...
  %127 = getelementptr inbounds double, double* %3, i64 %indvars.iv48
  %128 = load double, double* %127, align 8
  %129 = add nsw i64 %indvars.iv48, 1
  %130 = icmp slt i64 %129, 2000
  br i1 %130, label %._crit_edge3..lr.ph_crit_edge, label %._crit_edge10.thread
...
.lr.ph.prol:                                      ; preds = %.lr.ph.prol, %.lr.ph.prol.preheader
  %indvars.iv46.prol = phi i64 [ %indvars.iv.next47.prol, %.lr.ph.prol ], [ %135, %.lr.ph.prol.preheader ]
  %.37.prol = phi double [ %142, %.lr.ph.prol ], [ %128, %.lr.ph.prol.preheader ]
  %prol.iter = phi i64 [ %prol.iter.sub, %.lr.ph.prol ], [ %xtraiter, %.lr.ph.prol.preheader ]
  %137 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv48, i64 %indvars.iv46.prol
  %138 = load double, double* %137, align 8
  %139 = getelementptr inbounds double, double* %2, i64 %indvars.iv46.prol
  %140 = load double, double* %139, align 8
  %141 = fmul double %138, %140
  %142 = fsub double %.37.prol, %141
...
.lr.ph.prol.loopexit:                             ; preds = %._crit_edge3..lr.ph_crit_edge, %.lr.ph.prol.loopexit.unr-lcssa
  %.lcssa.unr = phi double [ undef, %._crit_edge3..lr.ph_crit_edge ], [ %142, %.lr.ph.prol.loopexit.unr-lcssa ]
  %indvars.iv46.unr = phi i64 [ %135, %._crit_edge3..lr.ph_crit_edge ], [ %indvars.iv.next47.prol, %.lr.ph.prol.loopexit.unr-lcssa ]
  %.37.unr = phi double [ %128, %._crit_edge3..lr.ph_crit_edge ], [ %142, %.lr.ph.prol.loopexit.unr-lcssa ]
  %143 = icmp ult i64 %126, 3
  br i1 %143, label %._crit_edge10, label %._crit_edge3..lr.ph_crit_edge.new
...
.lr.ph:                                           ; preds = %.lr.ph, %._crit_edge3..lr.ph_crit_edge.new
  ...
  %.37 = phi double [ %.37.unr, %._crit_edge3..lr.ph_crit_edge.new ], [ %165, %.lr.ph ]
  %144 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv48, i64 %indvars.iv46
  %145 = bitcast double* %144 to <2 x double>*
  %146 = getelementptr inbounds double, double* %2, i64 %indvars.iv46
  ...
  %153 = fsub double %.37, %151
  %154 = fsub double %153, %152
  %indvars.iv.next47.1 = add nsw i64 %indvars.iv46, 2
  %155 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv48, i64 %indvars.iv.next47.1
  %156 = bitcast double* %155 to <2 x double>*
  %157 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next47.1
...
._crit_edge10:                                    ; preds = %.lr.ph.prol.loopexit, %._crit_edge10.unr-lcssa
  %.lcssa = phi double [ %.lcssa.unr, %.lr.ph.prol.loopexit ], [ %165, %._crit_edge10.unr-lcssa ]
  %166 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv48, i64 %indvars.iv48
  %167 = load double, double* %166, align 8
  %168 = fdiv double %.lcssa, %167
  %169 = getelementptr inbounds double, double* %2, i64 %indvars.iv48
  store double %168, double* %169, align 8
  %170 = icmp sgt i64 %indvars.iv48, 0
  br i1 %170, label %._crit_edge10.._crit_edge3_crit_edge, label %171
