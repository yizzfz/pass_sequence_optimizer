...
for.inc.lr.ph:                                    ; preds = %entry, %for.inc47
  %indvars.iv74 = phi i64 [ 1, %entry ], [ %indvars.iv.next75, %for.inc47 ]
  %indvars.iv62 = phi i64 [ 1, %entry ], [ %indvars.iv.next63, %for.inc47 ]
  %indvar = phi i64 [ 0, %entry ], [ %indvar.next, %for.inc47 ]
  %beta.042 = phi double [ 1.000000e+00, %entry ], [ %mul5, %for.inc47 ]
  %alpha.041 = phi double [ %sub3, %entry ], [ %div, %for.inc47 ]
  %6 = add i64 %indvar, -1
  %7 = and i64 %indvars.iv74, 3
  %8 = shl i64 %indvar, 3
...
for.inc32.lr.ph:                                  ; preds = %for.inc32.lr.ph.loopexit, %for.inc.prol.loopexit
  ...
  %27 = add nsw i64 %indvars.iv62, -1
  %28 = and i64 %indvar, 1
  %lcmp.mod68 = icmp eq i64 %28, 0
...
for.inc32.preheader:                              ; preds = %for.inc32.prol.loopexit
  %32 = sub i64 %6, %indvars.iv47.unr.ph
  %33 = lshr i64 %32, 1
  %34 = add nuw i64 %33, 1
  %min.iters.check = icmp ult i64 %34, 2
  br i1 %min.iters.check, label %for.inc32.preheader8, label %min.iters.checked

min.iters.checked:                                ; preds = %for.inc32.preheader
  %n.mod.vf = and i64 %34, 1
  %n.vec = sub i64 %34, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  %35 = or i64 %indvars.iv47.unr.ph, 2
  %36 = shl nuw i64 %33, 1
  %37 = add i64 %35, %36
  %38 = shl nuw nsw i64 %n.mod.vf, 1
  %ind.end = sub i64 %37, %38
  br i1 %cmp.zero, label %for.inc32.preheader8, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %39 = shl i64 %index, 1
  %offset.idx = or i64 %indvars.iv47.unr.ph, %39
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.inc47, label %for.inc32.preheader8

for.inc32.preheader8:                             ; preds = %middle.block, %min.iters.checked, %for.inc32.preheader
  %indvars.iv47.ph = phi i64 [ %indvars.iv47.unr.ph, %min.iters.checked ], [ %indvars.iv47.unr.ph, %for.inc32.preheader ], [ %ind.end, %middle.block ]
...
for.inc32:                                        ; preds = %for.inc32.preheader8, %for.inc32
  %indvars.iv47 = phi i64 [ %indvars.iv.next48.1, %for.inc32 ], [ %indvars.iv47.ph, %for.inc32.preheader8 ]
  ...
  %58 = sub nsw i64 %27, %indvars.iv.next48
  ...
  %exitcond53.1 = icmp eq i64 %indvars.iv.next48.1, %indvars.iv62
  br i1 %exitcond53.1, label %for.inc47.loopexit, label %for.inc32, !llvm.loop !6
...
for.inc47:                                        ; preds = %for.inc47.loopexit, %middle.block, %for.inc32.prol.loopexit
  ...
  %indvars.iv.next75 = add nuw nsw i64 %7, 1
  br i1 %exitcond66, label %for.end49, label %for.inc.lr.ph
