...
.preheader.us:                                    ; preds = %.loopexit.us..preheader.us_crit_edge, %.preheader.lr.ph..preheader.us_crit_edge
  %indvars.iv16 = phi i64 [ 0, %.preheader.lr.ph..preheader.us_crit_edge ], [ %indvars.iv.next17, %.loopexit.us..preheader.us_crit_edge ]
  br label %._crit_edge.us._crit_edge

._crit_edge.us._crit_edge:                        ; preds = %._crit_edge.us._crit_edge.._crit_edge.us._crit_edge_crit_edge, %.preheader.us
  %indvars.iv = phi i64 [ 0, %.preheader.us ], [ %indvars.iv.next, %._crit_edge.us._crit_edge.._crit_edge.us._crit_edge_crit_edge ]
  %2 = mul nuw nsw i64 %indvars.iv16, %indvars.iv
  %3 = trunc i64 %2 to i32
  %4 = srem i32 %3, 7
  %5 = add nsw i32 %4, 1
  %6 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv16, i64 %indvars.iv
  %7 = add nuw nsw i64 %indvars.iv, %indvars.iv16
  ...
  br i1 %exitcond, label %.loopexit.us, label %._crit_edge.us._crit_edge.._crit_edge.us._crit_edge_crit_edge

._crit_edge.us._crit_edge.._crit_edge.us._crit_edge_crit_edge: ; preds = %._crit_edge.us._crit_edge
  br label %._crit_edge.us._crit_edge

.loopexit.us:                                     ; preds = %._crit_edge.us._crit_edge
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  %exitcond18 = icmp eq i64 %indvars.iv.next17, 2800
  br i1 %exitcond18, label %._crit_edge, label %.loopexit.us..preheader.us_crit_edge
...
.preheader3.us..preheader.us.us_crit_edge:        ; preds = %.loopexit7.us..preheader3.us..preheader.us.us_crit_edge_crit_edge, %.preheader3.lr.ph..preheader3.us_crit_edge
  %indvars.iv35 = phi i64 [ 0, %.preheader3.lr.ph..preheader3.us_crit_edge ], [ %indvars.iv.next36, %.loopexit7.us..preheader3.us..preheader.us.us_crit_edge_crit_edge ]
...
.loopexit7.us:                                    ; preds = %.loopexit.us.us
  ...
  br i1 %exitcond37, label %._crit_edge, label %.loopexit7.us..preheader3.us..preheader.us.us_crit_edge_crit_edge

.loopexit7.us..preheader3.us..preheader.us.us_crit_edge_crit_edge: ; preds = %.loopexit7.us
  br label %.preheader3.us..preheader.us.us_crit_edge

.preheader.us.us:                                 ; preds = %.loopexit.us.us..preheader.us.us_crit_edge, %.preheader3.us..preheader.us.us_crit_edge
  %indvars.iv33 = phi i64 [ 0, %.preheader3.us..preheader.us.us_crit_edge ], [ %indvars.iv.next34, %.loopexit.us.us..preheader.us.us_crit_edge ]
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.body.preheader
  ...
  br i1 %26, label %.loopexit.us.us.loopexit53, label %vector.body.vector.body_crit_edge, !llvm.loop !9
...
.loopexit.us.us:                                  ; preds = %.loopexit.us.us.loopexit53, %.loopexit.us.us.loopexit
  ...
  br i1 %exitcond, label %.loopexit7.us, label %.loopexit.us.us..preheader.us.us_crit_edge
...
scalar.ph:                                        ; preds = %scalar.ph.scalar.ph_crit_edge, %scalar.ph.preheader
  ...
  br i1 %exitcond32.1, label %.loopexit.us.us.loopexit, label %scalar.ph.scalar.ph_crit_edge, !llvm.loop !12
...
.preheader.us:                                    ; preds = %.loopexit.us..preheader.us_crit_edge, %.preheader.lr.ph..preheader.us_crit_edge
  %indvars.iv13 = phi i64 [ 0, %.preheader.lr.ph..preheader.us_crit_edge ], [ %indvars.iv.next14, %.loopexit.us..preheader.us_crit_edge ]
...
._crit_edge.us._crit_edge:                        ; preds = %._crit_edge.us.._crit_edge.us._crit_edge_crit_edge, %.preheader.us
  ...
  %9 = srem i32 %8, 20
  %10 = icmp eq i32 %9, 0
  br i1 %10, label %11, label %._crit_edge.us._crit_edge.._crit_edge.us_crit_edge
...
._crit_edge.us:                                   ; preds = %._crit_edge.us._crit_edge.._crit_edge.us_crit_edge, %11
  %13 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %14 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv13, i64 %indvars.iv
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 2800
  br i1 %exitcond, label %.loopexit.us, label %._crit_edge.us.._crit_edge.us._crit_edge_crit_edge
...
.loopexit.us:                                     ; preds = %._crit_edge.us
  ...
  br i1 %exitcond15, label %._crit_edge, label %.loopexit.us..preheader.us_crit_edge
