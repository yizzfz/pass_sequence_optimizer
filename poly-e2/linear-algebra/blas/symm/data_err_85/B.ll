...
define internal void @init_array(i32 %m, i32 %n, double* nocapture %alpha, double* nocapture %beta, [1200 x double]* %C, [1000 x double]* %A, [1200 x double]* %B) #2 {
entry:
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc16_crit_edge.us, %entry
  %indvars.iv38 = phi i64 [ 0, %entry ], [ %indvars.iv.next39, %for.cond1.for.inc16_crit_edge.us ]
  %0 = add nuw nsw i64 %indvars.iv38, 1200
  %1 = trunc i64 %0 to i32
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us, %for.cond1.preheader.us
  %indvars.iv35 = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next36, %for.body3.us ]
  %2 = add nuw nsw i64 %indvars.iv35, %indvars.iv38
  %3 = trunc i64 %2 to i32
  %rem.us = srem i32 %3, 100
  %conv.us = sitofp i32 %rem.us to double
  %div.us = fdiv double %conv.us, 1.000000e+03
  %arrayidx6.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv38, i64 %indvars.iv35
  ...
  %arrayidx15.us = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv38, i64 %indvars.iv35
...
for.cond1.for.inc16_crit_edge.us:                 ; preds = %for.body3.us
  ...
  %exitcond52 = icmp eq i64 %indvars.iv.next39, 1000
...
for.body26.lr.ph:                                 ; preds = %for.body26.lr.ph.preheader, %for.inc51
  ...
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc51 ], [ 0, %for.body26.lr.ph.preheader ]
...
for.cond40.preheader:                             ; preds = %for.cond40.preheader.loopexit, %for.body26.prol.loopexit.unr-lcssa
  ...
  %cmp419 = icmp slt i64 %indvars.iv.next34, 1000
  br i1 %cmp419, label %for.body43.lr.ph, label %for.end53

for.body43.lr.ph:                                 ; preds = %for.cond40.preheader
  %xtraiter41 = and i32 %9, 7
  %lcmp.mod42 = icmp eq i32 %xtraiter41, 0
  br i1 %lcmp.mod42, label %for.body43.prol.loopexit, label %for.body43.prol.preheader
...
for.body43.prol:                                  ; preds = %for.body43.prol.preheader, %for.body43.prol
  ...
  %prol.iter = phi i32 [ %prol.iter.sub, %for.body43.prol ], [ %xtraiter41, %for.body43.prol.preheader ]
...
for.body26:                                       ; preds = %for.body26.preheader, %for.body26
  ...
  %16 = add nsw i64 %indvars.iv, %indvars.iv33
  %17 = trunc i64 %16 to i32
  %rem28 = srem i32 %17, 100
  ...
  %18 = add nsw i64 %indvars.iv.next, %indvars.iv33
  %19 = trunc i64 %18 to i32
  %rem28.1 = srem i32 %19, 100
...
for.body43:                                       ; preds = %for.body43.preheader, %for.body43
  ...
  %exitcond32.7 = icmp eq i32 %lftr.wideiv.7, 1000
  br i1 %exitcond32.7, label %for.inc51.loopexit, label %for.body43

for.inc51.loopexit:                               ; preds = %for.body43
  br label %for.inc51

for.inc51:                                        ; preds = %for.inc51.loopexit, %for.body43.prol.loopexit
  %20 = icmp slt i64 %indvars.iv.next34, 1000
...
for.body3:                                        ; preds = %for.body3, %for.body3.preheader
  ...
  br i1 %exitcond34.1, label %for.inc53.loopexit65, label %for.body3, !llvm.loop !14
...
for.inc53:                                        ; preds = %for.inc53.loopexit66, %for.inc53.loopexit65, %for.inc53.loopexit
  ...
  br i1 %exitcond38, label %for.end55, label %for.cond1.preheader
