...
._crit_edge15:                                    ; preds = %._crit_edge15, %.preheader.us
  ...
  %1 = mul nuw nsw i64 %indvars.iv16, %indvars.iv
...
.loopexit.us:                                     ; preds = %._crit_edge15
  ...
  br i1 %exitcond18, label %.loopexit8, label %.preheader.us

.loopexit8:                                       ; preds = %.loopexit.us
  ret void
}
...
._crit_edge12:                                    ; preds = %._crit_edge13, %11
  %13 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %14 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv15, i64 %indvars.iv
