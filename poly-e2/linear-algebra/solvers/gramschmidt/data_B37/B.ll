...
for.inc12.loopexit.us:                            ; preds = %for.inc.us
  ...
  br i1 %exitcond30, label %for.cond15.preheader.loopexit, label %for.cond1.preheader.us
...
for.cond.loopexit:                                ; preds = %for.cond.loopexit.loopexit, %for.end31, %for.body35.preheader
  %exitcond86 = icmp eq i64 %indvars.iv.next73, %5
  br i1 %exitcond86, label %for.end88.loopexit, label %for.cond.loopexit.for.cond1.preheader_crit_edge
...
for.end.thread:                                   ; preds = %for.cond1.preheader
  %arrayidx1383 = getelementptr inbounds [1200 x double], [1200 x double]* %R, i64 %indvars.iv72, i64 %indvars.iv72
