...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc12_crit_edge.us, %entry
  ...
  %sunkaddr1 = shl i64 %indvars.iv30, 3
...
for.body3.us:                                     ; preds = %for.cond1.preheader.us, %for.body3.us
  %0 = phi double [ %.pre, %for.cond1.preheader.us ], [ %add.us.1, %for.body3.us ]
  %indvars.iv23 = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next24.1, %for.body3.us ]
...
for.cond18.preheader.us:                          ; preds = %for.cond18.preheader.us.preheader, %for.cond18.for.inc36_crit_edge.us
  ...
  %sunkaddr5 = shl i64 %indvars.iv21, 3
...
for.body20.us:                                    ; preds = %for.cond18.preheader.us, %for.body20.us
  %5 = phi double [ %.pre37, %for.cond18.preheader.us ], [ %add30.us.1, %for.body20.us ]
  %indvars.iv = phi i64 [ 0, %for.cond18.preheader.us ], [ %indvars.iv.next.1, %for.body20.us ]
