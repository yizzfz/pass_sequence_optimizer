...
@__llvm_prf_nm = private constant [129 x i8] c"\C5\01~x\DAm\8D\B1\0A\C2P\0CE\E9\0F\09\AE\AE\CE\8E\CE!\C4TR\F2^B\92R\FC{_\1D:\14\97;\5C\CE\B9wq~\C3\16R\0Cd<\CFB\C2\BDr\AA\E6\D7\8B\EA\AD\02{r'{14\CC\E2\80de*\B1>-\BBL\E6\1F\A0\B1 \84\0A\8E\81\8D\07\F6\7Fb\FF\18\D1+L\95\E3`\B20j\C8\99?\E4\E8\C9\9A\07\8F\D6\D6\F2\B5N\BC<\EEO\08\DB\BE\DB\DELx", section "__llvm_prf_names"
@llvm.used = appending global [9 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_write_coefficients to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_transencode_master_selection to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_copy_critical_parameters to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_transencode_coef_controller to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_start_pass_coef to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_compress_output to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_start_iMCU_row to i8*), i8* bitcast ([15 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([129 x i8], [129 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
