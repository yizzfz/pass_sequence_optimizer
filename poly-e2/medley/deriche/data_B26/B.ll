...
vector.ph:                                        ; preds = %for.cond1.for.inc7_crit_edge.us, %entry
  %indvars.iv9 = phi i64 [ 0, %entry ], [ %indvars.iv.next10, %for.cond1.for.inc7_crit_edge.us ]
  %0 = mul nsw i64 %indvars.iv9, 313
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %7 = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv9, i64 %index
...
for.cond1.for.inc7_crit_edge.us:                  ; preds = %vector.body
  ...
  %cmp.us = icmp slt i64 %indvars.iv.next10, 4096
...
for.body33.us.for.body33.us_crit_edge:            ; preds = %for.body33.us.for.body33.us_crit_edge.1, %for.cond31.preheader.us
  %add42.us153 = phi float [ %add42.us147, %for.cond31.preheader.us ], [ %add42.us.1, %for.body33.us.for.body33.us_crit_edge.1 ]
  %arrayidx35.us152 = phi float* [ %arrayidx35.us140, %for.cond31.preheader.us ], [ %arrayidx35.us.1, %for.body33.us.for.body33.us_crit_edge.1 ]
  %ym1.035.us151 = phi float [ 0.000000e+00, %for.cond31.preheader.us ], [ %add42.us, %for.body33.us.for.body33.us_crit_edge.1 ]
  %indvars.iv74150 = phi i64 [ 0, %for.cond31.preheader.us ], [ %indvars.iv.next75.1, %for.body33.us.for.body33.us_crit_edge.1 ]
  %indvars.iv.next75 = or i64 %indvars.iv74150, 1
  %3 = load float, float* %arrayidx35.us152, align 4
...
for.body64.us.for.body64.us_crit_edge:            ; preds = %for.body64.us.for.body64.us_crit_edge.1, %for.cond62.preheader.us
  %add71.us139 = phi float [ %add71.us133, %for.cond62.preheader.us ], [ %add71.us.1, %for.body64.us.for.body64.us_crit_edge.1 ]
  %indvars.iv.next70138 = phi i64 [ 2159, %for.cond62.preheader.us ], [ %indvars.iv.next70.1, %for.body64.us.for.body64.us_crit_edge.1 ]
  %xp1.027.us137 = phi float [ 0.000000e+00, %for.cond62.preheader.us ], [ %85, %for.body64.us.for.body64.us_crit_edge.1 ]
  %yp1.029.us136 = phi float [ 0.000000e+00, %for.cond62.preheader.us ], [ %add71.us, %for.body64.us.for.body64.us_crit_edge.1 ]
  ...
  %cmp63.us = icmp sgt i64 %indvars.iv.next70138, 1
...
for.cond62.for.inc86_crit_edge.us:                ; preds = %for.body64.us.for.body64.us_crit_edge
  ...
  br i1 %cmp59.us, label %for.cond62.preheader.us, label %vector.memcheck.preheader
...
vector.memcheck:                                  ; preds = %vector.memcheck.preheader, %for.cond92.for.inc112_crit_edge.us
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.cond92.for.inc112_crit_edge.us ], [ 0, %vector.memcheck.preheader ]
  %scevgep = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv66, i64 0
  %6 = add i64 %indvars.iv66, 1
  %scevgep155 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %6, i64 0
  %scevgep157 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv66, i64 0
  %scevgep159 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %6, i64 0
  %scevgep161 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv66, i64 0
  %scevgep163 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %6, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %wide.load169 = load <4 x float>, <4 x float>* %10, align 4, !alias.scope !4
  %11 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv66, i64 %index
  %12 = bitcast float* %11 to <4 x float>*
  %wide.load170 = load <4 x float>, <4 x float>* %12, align 4, !alias.scope !7
  %13 = getelementptr float, float* %11, i64 4
  %14 = bitcast float* %13 to <4 x float>*
  %wide.load171 = load <4 x float>, <4 x float>* %14, align 4, !alias.scope !7
  %15 = fadd <4 x float> %wide.load, %wide.load170
  %16 = fadd <4 x float> %wide.load169, %wide.load171
  ...
  %wide.load169.1 = load <4 x float>, <4 x float>* %24, align 4, !alias.scope !4
  %25 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv66, i64 %index.next
  %26 = bitcast float* %25 to <4 x float>*
  %wide.load170.1 = load <4 x float>, <4 x float>* %26, align 4, !alias.scope !7
  %27 = getelementptr float, float* %25, i64 4
  %28 = bitcast float* %27 to <4 x float>*
  %wide.load171.1 = load <4 x float>, <4 x float>* %28, align 4, !alias.scope !7
  %29 = fadd <4 x float> %wide.load.1, %wide.load170.1
  %30 = fadd <4 x float> %wide.load169.1, %wide.load171.1
  ...
  br i1 %35, label %for.cond92.for.inc112_crit_edge.us.loopexit212, label %vector.body, !llvm.loop !12

for.body94.us:                                    ; preds = %for.body94.us, %for.body94.us.preheader
  %indvars.iv62 = phi i64 [ 0, %for.body94.us.preheader ], [ %indvars.iv.next63.2, %for.body94.us ]
  ...
  br i1 %exitcond65.2, label %for.cond92.for.inc112_crit_edge.us.loopexit, label %for.body94.us, !llvm.loop !13

for.cond92.for.inc112_crit_edge.us.loopexit:      ; preds = %for.body94.us
  br label %for.cond92.for.inc112_crit_edge.us

for.cond92.for.inc112_crit_edge.us.loopexit212:   ; preds = %vector.body
  br label %for.cond92.for.inc112_crit_edge.us

for.cond92.for.inc112_crit_edge.us:               ; preds = %for.cond92.for.inc112_crit_edge.us.loopexit212, %for.cond92.for.inc112_crit_edge.us.loopexit
...
for.cond118.preheader.us:                         ; preds = %for.cond118.preheader.us.preheader, %for.cond118.for.inc147_crit_edge.us
  ...
  %42 = load float, float* %arrayidx124.us112, align 4
  %mul125.us113 = fmul float %div, %42
...
for.body120.us.for.body120.us_crit_edge:          ; preds = %for.body120.us.for.body120.us_crit_edge.1, %for.cond118.preheader.us
  %add131.us125 = phi float [ %add131.us119, %for.cond118.preheader.us ], [ %add131.us.1, %for.body120.us.for.body120.us_crit_edge.1 ]
  %arrayidx124.us124 = phi float* [ %arrayidx124.us112, %for.cond118.preheader.us ], [ %arrayidx124.us.1, %for.body120.us.for.body120.us_crit_edge.1 ]
  %ym1.115.us123 = phi float [ 0.000000e+00, %for.cond118.preheader.us ], [ %add131.us, %for.body120.us.for.body120.us_crit_edge.1 ]
  %indvars.iv55122 = phi i64 [ 0, %for.cond118.preheader.us ], [ %indvars.iv.next56.1, %for.body120.us.for.body120.us_crit_edge.1 ]
  %indvars.iv.next56 = or i64 %indvars.iv55122, 1
  %43 = load float, float* %arrayidx124.us124, align 4
...
for.body156.us.for.body156.us_crit_edge:          ; preds = %for.body156.us.for.body156.us_crit_edge.1, %for.cond154.preheader.us
  %add163.us111 = phi float [ %add163.us105, %for.cond154.preheader.us ], [ %add163.us.1, %for.body156.us.for.body156.us_crit_edge.1 ]
  %indvars.iv.next51110 = phi i64 [ 4095, %for.cond154.preheader.us ], [ %indvars.iv.next51.1, %for.body156.us.for.body156.us_crit_edge.1 ]
  %tp1.07.us109 = phi float [ 0.000000e+00, %for.cond154.preheader.us ], [ %82, %for.body156.us.for.body156.us_crit_edge.1 ]
  %yp1.19.us108 = phi float [ 0.000000e+00, %for.cond154.preheader.us ], [ %add163.us, %for.body156.us.for.body156.us_crit_edge.1 ]
  ...
  %cmp155.us = icmp sgt i64 %indvars.iv.next51110, 1
...
for.cond154.for.inc179_crit_edge.us:              ; preds = %for.body156.us.for.body156.us_crit_edge
  ...
  br i1 %cmp151.us, label %for.cond154.preheader.us, label %vector.memcheck197.preheader

vector.memcheck197.preheader:                     ; preds = %for.cond154.for.inc179_crit_edge.us
  br label %vector.memcheck197

vector.memcheck197:                               ; preds = %vector.memcheck197.preheader, %for.cond185.for.inc205_crit_edge.us
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.cond185.for.inc205_crit_edge.us ], [ 0, %vector.memcheck197.preheader ]
  %scevgep177 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv47, i64 0
  %46 = add i64 %indvars.iv47, 1
  %scevgep179 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %46, i64 0
  %scevgep181 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv47, i64 0
  %scevgep183 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %46, i64 0
  %scevgep185 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 0
  %scevgep187 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %46, i64 0
  ...
  br i1 %conflict.rdx195, label %for.body187.us.preheader, label %vector.body172.preheader

vector.body172.preheader:                         ; preds = %vector.memcheck197
  br label %vector.body172

for.body187.us.preheader:                         ; preds = %vector.memcheck197
  br label %for.body187.us

vector.body172:                                   ; preds = %vector.body172, %vector.body172.preheader
  %index199 = phi i64 [ 0, %vector.body172.preheader ], [ %index.next200.1, %vector.body172 ]
  %47 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv47, i64 %index199
  %48 = bitcast float* %47 to <4 x float>*
  %wide.load207 = load <4 x float>, <4 x float>* %48, align 4, !alias.scope !14
  %49 = getelementptr float, float* %47, i64 4
  %50 = bitcast float* %49 to <4 x float>*
  %wide.load208 = load <4 x float>, <4 x float>* %50, align 4, !alias.scope !14
  %51 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 %index199
  %52 = bitcast float* %51 to <4 x float>*
  %wide.load209 = load <4 x float>, <4 x float>* %52, align 4, !alias.scope !17
  %53 = getelementptr float, float* %51, i64 4
  %54 = bitcast float* %53 to <4 x float>*
  %wide.load210 = load <4 x float>, <4 x float>* %54, align 4, !alias.scope !17
  %55 = fadd <4 x float> %wide.load207, %wide.load209
  %56 = fadd <4 x float> %wide.load208, %wide.load210
  %57 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv47, i64 %index199
  ...
  %61 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv47, i64 %index.next200
  %62 = bitcast float* %61 to <4 x float>*
  %wide.load207.1 = load <4 x float>, <4 x float>* %62, align 4, !alias.scope !14
  %63 = getelementptr float, float* %61, i64 4
  %64 = bitcast float* %63 to <4 x float>*
  %wide.load208.1 = load <4 x float>, <4 x float>* %64, align 4, !alias.scope !14
  %65 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 %index.next200
  %66 = bitcast float* %65 to <4 x float>*
  %wide.load209.1 = load <4 x float>, <4 x float>* %66, align 4, !alias.scope !17
  %67 = getelementptr float, float* %65, i64 4
  %68 = bitcast float* %67 to <4 x float>*
  %wide.load210.1 = load <4 x float>, <4 x float>* %68, align 4, !alias.scope !17
  %69 = fadd <4 x float> %wide.load207.1, %wide.load209.1
  %70 = fadd <4 x float> %wide.load208.1, %wide.load210.1
  %71 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv47, i64 %index.next200
  ...
  %index.next200.1 = add nsw i64 %index199, 16
  %75 = icmp eq i64 %index.next200.1, 2160
  br i1 %75, label %for.cond185.for.inc205_crit_edge.us.loopexit211, label %vector.body172, !llvm.loop !22
...
for.cond185.for.inc205_crit_edge.us.loopexit211:  ; preds = %vector.body172
  br label %for.cond185.for.inc205_crit_edge.us

for.cond185.for.inc205_crit_edge.us:              ; preds = %for.cond185.for.inc205_crit_edge.us.loopexit211, %for.cond185.for.inc205_crit_edge.us.loopexit
  %indvars.iv.next48 = add nuw i64 %indvars.iv47, 1
  %cmp183.us = icmp slt i64 %indvars.iv.next48, 4096
  br i1 %cmp183.us, label %vector.memcheck197, label %for.end207
...
for.cond2.preheader.us:                           ; preds = %for.cond2.for.inc10_crit_edge.us, %entry
  ...
  %3 = mul nsw i64 %indvars.iv9, 2160
