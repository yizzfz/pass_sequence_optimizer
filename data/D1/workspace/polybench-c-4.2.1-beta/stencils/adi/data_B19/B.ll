...
define internal fastcc void @kernel_adi(i32, i32, [1000 x double]* nocapture, [1000 x double]* nocapture, [1000 x double]* nocapture, [1000 x double]* nocapture) unnamed_addr #2 {
  ...
  %19 = icmp slt i32 %0, 1
  br i1 %19, label %.._crit_edge24_crit_edge, label %.preheader4.lr.ph
...
.preheader4:                                      ; preds = %._crit_edge22..preheader4_crit_edge, %.preheader4.lr.ph
  %.0323 = phi i32 [ 1, %.preheader4.lr.ph ], [ %212, %._crit_edge22..preheader4_crit_edge ]
...
.lr.ph8.us:                                       ; preds = %.lr.ph8.us..lr.ph8.us_crit_edge, %.lr.ph8.us.preheader87
  ...
  br i1 %93, label %.lr.ph8.us..lr.ph8.us_crit_edge, label %._crit_edge9.us.loopexit

.lr.ph8.us..lr.ph8.us_crit_edge:                  ; preds = %.lr.ph8.us
  br label %.lr.ph8.us

; <label>:94:                                     ; preds = %._crit_edge, %.ph
  %store_forwarded60 = phi double [ %load_initial59, %.ph ], [ %114, %._crit_edge ]
  %store_forwarded57 = phi double [ %load_initial, %.ph ], [ %97, %._crit_edge ]
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit88, %._crit_edge.us.loopexit
  ...
  br i1 %24, label %.lr.ph8.us.preheader, label %._crit_edge.us.._crit_edge9.us_crit_edge

._crit_edge.us.._crit_edge9.us_crit_edge:         ; preds = %._crit_edge.us
  br label %._crit_edge9.us

.lr.ph8.us.preheader:                             ; preds = %._crit_edge.us
  br i1 %lcmp.mod, label %.lr.ph8.us.preheader..lr.ph8.us.prol.loopexit_crit_edge, label %.lr.ph8.us.prol
...
.lr.ph8.us.prol.loopexit:                         ; preds = %.lr.ph8.us.preheader..lr.ph8.us.prol.loopexit_crit_edge, %.lr.ph8.us.prol
  %indvars.iv25.unr.ph = phi i64 [ %indvars.iv.next26.prol, %.lr.ph8.us.prol ], [ %32, %.lr.ph8.us.preheader..lr.ph8.us.prol.loopexit_crit_edge ]
  br i1 %34, label %.lr.ph8.us.prol.loopexit.._crit_edge9.us_crit_edge, label %.lr.ph8.us.preheader87
...
.preheader:                                       ; preds = %._crit_edge9.us
  br i1 %36, label %.lver.check75.preheader, label %.preheader.._crit_edge22_crit_edge
...
.lr.ph18.us:                                      ; preds = %.lr.ph18.us..lr.ph18.us_crit_edge, %.lr.ph18.us.preheader85
  ...
  br i1 %179, label %.lr.ph18.us..lr.ph18.us_crit_edge, label %._crit_edge19.us.loopexit

.lr.ph18.us..lr.ph18.us_crit_edge:                ; preds = %.lr.ph18.us
  br label %.lr.ph18.us

; <label>:180:                                    ; preds = %._crit_edge89, %.ph76
  %store_forwarded84 = phi double [ %load_initial83, %.ph76 ], [ %200, %._crit_edge89 ]
  %store_forwarded81 = phi double [ %load_initial78, %.ph76 ], [ %183, %._crit_edge89 ]
  %indvars.iv31 = phi i64 [ 1, %.ph76 ], [ %indvars.iv.next32, %._crit_edge89 ]
  ...
  br i1 %exitcond34, label %._crit_edge15.us.loopexit86, label %._crit_edge89

._crit_edge89:                                    ; preds = %180
  br label %180
...
._crit_edge15.us:                                 ; preds = %._crit_edge15.us.loopexit86, %._crit_edge15.us.loopexit
  ...
  br i1 %28, label %.lr.ph18.us.preheader, label %._crit_edge15.us.._crit_edge19.us_crit_edge

._crit_edge15.us.._crit_edge19.us_crit_edge:      ; preds = %._crit_edge15.us
  br label %._crit_edge19.us

.lr.ph18.us.preheader:                            ; preds = %._crit_edge15.us
  br i1 %lcmp.mod38, label %.lr.ph18.us.preheader..lr.ph18.us.prol.loopexit_crit_edge, label %.lr.ph18.us.prol
...
.lr.ph18.us.prol.loopexit:                        ; preds = %.lr.ph18.us.preheader..lr.ph18.us.prol.loopexit_crit_edge, %.lr.ph18.us.prol
  %indvars.iv35.unr.ph = phi i64 [ %indvars.iv.next36.prol, %.lr.ph18.us.prol ], [ %32, %.lr.ph18.us.preheader..lr.ph18.us.prol.loopexit_crit_edge ]
  br i1 %38, label %.lr.ph18.us.prol.loopexit.._crit_edge19.us_crit_edge, label %.lr.ph18.us.preheader85
