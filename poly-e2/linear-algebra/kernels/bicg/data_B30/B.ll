...
for.body5.us:                                     ; preds = %for.body5.us.preheader, %for.cond12.for.inc27_crit_edge.us
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.cond12.for.inc27_crit_edge.us ], [ %8, %for.body5.us.preheader ]
  %9 = phi i32 [ %5, %for.cond12.for.inc27_crit_edge.us ], [ %2, %for.body5.us.preheader ]
  %storemerge17.us = phi i32 [ %18, %for.cond12.for.inc27_crit_edge.us ], [ 0, %for.body5.us.preheader ]
...
for.cond2.for.end29_crit_edge.loopexit:           ; preds = %for.cond12.for.inc27_crit_edge.us
  %22 = trunc i64 %indvars.iv.next18 to i32
...
for.cond2.for.end29_crit_edge:                    ; preds = %for.cond2.for.end29_crit_edge.loopexit26, %for.cond2.for.end29_crit_edge.loopexit
  %inc28.lcssa = phi i32 [ %22, %for.cond2.for.end29_crit_edge.loopexit ], [ %inc28, %for.cond2.for.end29_crit_edge.loopexit26 ]
...
for.inc31.us:                                     ; preds = %for.body3.us, %for.inc31.us
  ...
  %sunkaddr39 = add i64 %15, %sunkaddr38
  %sunkaddr40 = inttoptr i64 %sunkaddr39 to double*
  %19 = load double, double* %sunkaddr40, align 8
  ...
  %sunkaddr41 = add i64 %13, %sunkaddr
  ...
  store double %add28.us, double* %sunkaddr42, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.body3:                                        ; preds = %for.body3.preheader, %for.body3
  ...
  br i1 %cmp2, label %for.body3, label %for.cond1.for.end36_crit_edge.loopexit43
...
for.cond1.for.end36_crit_edge.loopexit43:         ; preds = %for.body3
  br label %for.cond1.for.end36_crit_edge

for.cond1.for.end36_crit_edge:                    ; preds = %for.cond1.for.end36_crit_edge.loopexit43, %for.cond1.for.end36_crit_edge.loopexit
  %inc35.lcssa = phi i32 [ %24, %for.cond1.for.end36_crit_edge.loopexit ], [ %inc35, %for.cond1.for.end36_crit_edge.loopexit43 ]
...
for.end:                                          ; preds = %for.cond.for.end_crit_edge, %entry
  ...
  %call6 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %14, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i64 0, i64 0)) #6
  store i32 0, i32* %i, align 4
...
for.body9:                                        ; preds = %for.body9.lr.ph, %for.inc18
  ...
  %storemerge16 = phi i32 [ 0, %for.body9.lr.ph ], [ %23, %for.inc18 ]
...
for.inc18:                                        ; preds = %for.body9, %if.then12
  ...
  %call17 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %21, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i64 0, i64 0), double %22) #6
...
for.end20:                                        ; preds = %for.cond7.for.end20_crit_edge, %for.end
  ...
  %call21 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %25, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i64 0, i64 0)) #6
  %26 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %27 = tail call i64 @fwrite(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.8, i64 0, i64 0), i64 22, i64 1, %struct._IO_FILE* %26) #5
  ret void
}
