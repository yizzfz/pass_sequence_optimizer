...
; <label>:4:                                      ; preds = %4, %3
  %indvars.iv43 = phi i64 [ 0, %3 ], [ %indvars.iv.next5.1, %4 ]
  %5 = trunc i64 %indvars.iv43 to i32
  %6 = srem i32 %5, 1900
  %7 = sitofp i32 %6 to double
  %8 = getelementptr inbounds double, double* %2, i64 %indvars.iv43
  %9 = trunc i64 %indvars.iv43 to i32
  %10 = or i32 %9, 1
  %11 = srem i32 %10, 1900
  ...
  br i1 %exitcond5.1, label %.preheader.preheader, label %4

.preheader.preheader:                             ; preds = %4
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %36
  %indvars.iv22 = phi i64 [ %indvars.iv.next3, %36 ], [ 0, %.preheader.preheader ]
  %17 = trunc i64 %indvars.iv22 to i32
  %18 = srem i32 %17, 2100
  %19 = sitofp i32 %18 to double
  %20 = fdiv double %19, 2.100000e+03
  %21 = getelementptr inbounds double, double* %1, i64 %indvars.iv22
  store double %20, double* %21, align 8
  br label %22

; <label>:22:                                     ; preds = %22, %.preheader
  %indvars.iv1 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %22 ]
  %indvars.iv.next = or i64 %indvars.iv1, 1
  %23 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv22
  %24 = trunc i64 %23 to i32
  %25 = srem i32 %24, 2100
  %26 = sitofp i32 %25 to double
  %27 = getelementptr inbounds [1900 x double], [1900 x double]* %0, i64 %indvars.iv22, i64 %indvars.iv1
  %indvars.iv.next.1 = add nsw i64 %indvars.iv1, 2
  %28 = mul nuw nsw i64 %indvars.iv.next.1, %indvars.iv22
...
; <label>:36:                                     ; preds = %22
  ...
  br i1 %exitcond4, label %37, label %.preheader
...
.preheader.preheader:
  ...
  %sunkaddr7 = ptrtoint double* %2 to i64
  br label %.preheader

.preheader:                                       ; preds = %21, %.preheader.preheader
  %indvars.iv22 = phi i64 [ %indvars.iv.next3, %21 ], [ 0, %.preheader.preheader ]
  %6 = getelementptr inbounds double, double* %2, i64 %indvars.iv22
  store double 0.000000e+00, double* %6, align 8
  %sunkaddr4 = shl nuw nsw i64 %indvars.iv22, 3
  %sunkaddr5 = add i64 %sunkaddr, %sunkaddr4
  %sunkaddr6 = inttoptr i64 %sunkaddr5 to double*
  %sunkaddr9 = add i64 %sunkaddr7, %sunkaddr4
  %sunkaddr10 = inttoptr i64 %sunkaddr9 to double*
  br label %7

; <label>:7:                                      ; preds = %7, %.preheader
  %indvars.iv1 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %7 ]
  %8 = getelementptr inbounds double, double* %1, i64 %indvars.iv1
  %9 = load double, double* %8, align 8
  %10 = load double, double* %sunkaddr6, align 8
  %11 = getelementptr inbounds [1900 x double], [1900 x double]* %0, i64 %indvars.iv22, i64 %indvars.iv1
  %12 = load double, double* %11, align 8
  %13 = fmul double %10, %12
  %14 = fadd double %9, %13
  store double %14, double* %8, align 8
  %15 = load double, double* %sunkaddr10, align 8
  %16 = load double, double* %11, align 8
  %17 = getelementptr inbounds double, double* %3, i64 %indvars.iv1
...
; <label>:21:                                     ; preds = %7
  %indvars.iv.next3 = add nuw nsw i64 %indvars.iv22, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next3, 2100
  br i1 %exitcond15, label %22, label %.preheader
...
; <label>:7:                                      ; preds = %13, %2
  %indvars.iv15 = phi i64 [ 0, %2 ], [ %indvars.iv.next2, %13 ]
...
; <label>:13:                                     ; preds = %7, %11
  ...
  %15 = getelementptr inbounds double, double* %0, i64 %indvars.iv15
  ...
  %exitcond6 = icmp eq i64 %indvars.iv.next2, 1900
  br i1 %exitcond6, label %18, label %7
...
; <label>:23:                                     ; preds = %29, %18
  %indvars.iv4 = phi i64 [ 0, %18 ], [ %indvars.iv.next, %29 ]
...
; <label>:29:                                     ; preds = %23, %27
  ...
  %31 = getelementptr inbounds double, double* %1, i64 %indvars.iv4
