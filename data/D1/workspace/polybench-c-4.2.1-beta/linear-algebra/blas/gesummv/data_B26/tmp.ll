...
; <label>:10:                                     ; preds = %10, %.lr.ph.us
  ...
  %11 = mul nuw nsw i64 %indvars.iv, %indvars.iv32
  %12 = add nuw nsw i64 %11, 1
  %13 = trunc i64 %12 to i32
  %14 = srem i32 %13, 1300
  %15 = sitofp i32 %14 to double
  %16 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv32, i64 %indvars.iv
  %17 = mul nuw nsw i64 %indvars.iv, %indvars.iv32
  ...
  %27 = getelementptr inbounds [1300 x double], [1300 x double]* %4, i64 %indvars.iv32, i64 %indvars.iv
...
.lr.ph39.split.us.preheader:
  ...
  %sunkaddr56 = ptrtoint double* %7 to i64
...
.lr.ph39.split.us:                                ; preds = %.lr.ph39.split.us.preheader, %._crit_edge.us
  ...
  %8 = getelementptr inbounds double, double* %5, i64 %indvars.iv41
  store double 0.000000e+00, double* %8, align 8
  %9 = getelementptr inbounds double, double* %7, i64 %indvars.iv41
  store double 0.000000e+00, double* %9, align 8
  %sunkaddr45 = shl i64 %indvars.iv41, 3
  %sunkaddr46 = add i64 %sunkaddr, %sunkaddr45
  %sunkaddr47 = inttoptr i64 %sunkaddr46 to double*
  %sunkaddr49 = shl i64 %indvars.iv41, 3
  %sunkaddr50 = add i64 %sunkaddr48, %sunkaddr49
  %sunkaddr51 = inttoptr i64 %sunkaddr50 to double*
  %sunkaddr53 = shl i64 %indvars.iv41, 3
  %sunkaddr54 = add i64 %sunkaddr52, %sunkaddr53
  %sunkaddr55 = inttoptr i64 %sunkaddr54 to double*
  %sunkaddr57 = shl i64 %indvars.iv41, 3
  %sunkaddr58 = add i64 %sunkaddr56, %sunkaddr57
  %sunkaddr59 = inttoptr i64 %sunkaddr58 to double*
  br label %10

; <label>:10:                                     ; preds = %10, %.lr.ph39.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph39.split.us ], [ %indvars.iv.next, %10 ]
  %11 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv41, i64 %indvars.iv
  %12 = load double, double* %11, align 8
  %13 = getelementptr inbounds double, double* %6, i64 %indvars.iv
  %14 = load double, double* %13, align 8
  %15 = fmul double %12, %14
  %16 = load double, double* %sunkaddr47, align 8
  %17 = fadd double %15, %16
  store double %17, double* %sunkaddr51, align 8
  %18 = getelementptr inbounds [1300 x double], [1300 x double]* %4, i64 %indvars.iv41, i64 %indvars.iv
  ...
  store double %24, double* %sunkaddr59, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
  br i1 %exitcond, label %._crit_edge.us, label %10

._crit_edge.us:                                   ; preds = %10
  %25 = getelementptr inbounds double, double* %5, i64 %indvars.iv41
  %26 = load double, double* %25, align 8
  %27 = fmul double %26, %1
  %28 = getelementptr inbounds double, double* %7, i64 %indvars.iv41
  %29 = load double, double* %28, align 8
  %30 = fmul double %29, %2
  %31 = fadd double %27, %30
  %32 = getelementptr inbounds double, double* %7, i64 %indvars.iv41
