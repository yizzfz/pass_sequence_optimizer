...
define internal fastcc void @init_array(i32, i32, double*, [1000 x double]*, [1200 x double]*) unnamed_addr #2 {
  ...
  %6 = icmp sgt i32 %0, 0
  br i1 %6, label %.lr.ph7, label %._crit_edge45
...
.lr.ph7.split.us:                                 ; preds = %._crit_edge3.us..lr.ph7.split.us_crit_edge, %.lr.ph7.split.us.preheader
  %indvars.iv26 = phi i64 [ 0, %.lr.ph7.split.us.preheader ], [ %indvars.iv.next27, %._crit_edge3.us..lr.ph7.split.us_crit_edge ]
  %indvar = phi i32 [ 0, %.lr.ph7.split.us.preheader ], [ %indvar.next, %._crit_edge3.us..lr.ph7.split.us_crit_edge ]
  %indvars.iv15 = phi i32 [ 0, %.lr.ph7.split.us.preheader ], [ %indvars.iv.next16, %._crit_edge3.us..lr.ph7.split.us_crit_edge ]
...
._crit_edge3.us:                                  ; preds = %._crit_edge3.us.loopexit, %.prol.loopexit21
  ...
  br i1 %50, label %._crit_edge3.us..lr.ph7.split.us_crit_edge, label %._crit_edge45.loopexit
...
.lr.ph7.split:                                    ; preds = %.lr.ph7.split.preheader, %._crit_edge..lr.ph7.split_crit_edge
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %._crit_edge..lr.ph7.split_crit_edge ], [ 0, %.lr.ph7.split.preheader ]
  %indvar35 = phi i32 [ %indvar.next36, %._crit_edge..lr.ph7.split_crit_edge ], [ 0, %.lr.ph7.split.preheader ]
  %indvars.iv30 = phi i32 [ %indvars.iv.next31, %._crit_edge..lr.ph7.split_crit_edge ], [ 0, %.lr.ph7.split.preheader ]
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit34, %.lr.ph7.split
  ...
  br i1 %71, label %._crit_edge..lr.ph7.split_crit_edge, label %._crit_edge45.loopexit46
...
._crit_edge45.loopexit:                           ; preds = %._crit_edge3.us
  br label %._crit_edge45

._crit_edge45.loopexit46:                         ; preds = %._crit_edge
  br label %._crit_edge45

._crit_edge45:                                    ; preds = %._crit_edge45.loopexit46, %._crit_edge45.loopexit, %5
  ret void
}
...
._crit_edge4.us:                                  ; preds = %._crit_edge.us
  ...
  br i1 %41, label %.lr.ph9.split.us, label %._crit_edge.loopexit
