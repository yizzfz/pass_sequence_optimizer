...
.lr.ph36:                                         ; preds = %._crit_edge38, %.preheader14.lr.ph
  %indvars.iv83 = phi i64 [ 0, %.preheader14.lr.ph ], [ %indvars.iv.next84, %._crit_edge38 ]
  %indvars.iv81 = phi i64 [ 1, %.preheader14.lr.ph ], [ %indvars.iv.next82, %._crit_edge38 ]
  %4 = mul nuw nsw i64 %indvars.iv83, 2001
  %5 = add nuw nsw i64 %4, 1
  %scevgep79 = getelementptr [2000 x double], [2000 x double]* %1, i64 0, i64 %5
  %6 = sub i64 1998, %indvars.iv83
  %7 = shl i64 %6, 3
...
.preheader13:                                     ; preds = %._crit_edge
  ...
  %10 = icmp slt i64 %indvars.iv.next84, 2000
  br i1 %10, label %._crit_edge38.loopexit, label %._crit_edge38

._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph36
  %indvars.iv67 = phi i64 [ 0, %.lr.ph36 ], [ %indvars.iv.next68, %._crit_edge ]
  ...
  %17 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv83, i64 %indvars.iv67
  store double %16, double* %17, align 8
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  %exitcond72 = icmp eq i64 %indvars.iv.next68, %indvars.iv81
  br i1 %exitcond72, label %.preheader13, label %._crit_edge
...
._crit_edge38:                                    ; preds = %.preheader13, %._crit_edge38.loopexit
  %18 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv83, i64 %indvars.iv83
  store double 1.000000e+00, double* %18, align 8
  %exitcond94 = icmp eq i64 %indvars.iv.next84, 2000
  %indvars.iv.next82 = add nuw nsw i64 %indvars.iv81, 1
  br i1 %exitcond94, label %._crit_edge40, label %.lr.ph36
...
._crit_edge33.us.prol:                            ; preds = %._crit_edge33.us.prol, %._crit_edge33.us.prol.preheader
  %indvars.iv63.prol = phi i64 [ 0, %._crit_edge33.us.prol.preheader ], [ %indvars.iv.next64.prol, %._crit_edge33.us.prol ]
  %prol.iter147 = phi i64 [ 0, %._crit_edge33.us.prol.preheader ], [ %prol.iter147.sub, %._crit_edge33.us.prol ]
  ...
  br i1 %prol.iter147.cmp, label %._crit_edge33.us.prol.loopexit.unr-lcssa, label %._crit_edge33.us.prol, !llvm.loop !1

._crit_edge33.us.prol.loopexit.unr-lcssa:         ; preds = %._crit_edge33.us.prol
  br label %._crit_edge33.us.prol.loopexit

._crit_edge33.us.prol.loopexit:                   ; preds = %._crit_edge40, %._crit_edge33.us.prol.loopexit.unr-lcssa
  br i1 false, label %.preheader10.lr.ph, label %._crit_edge40.new

._crit_edge40.new:                                ; preds = %._crit_edge33.us.prol.loopexit
  br label %._crit_edge33.us

._crit_edge33.us:                                 ; preds = %._crit_edge33.us, %._crit_edge40.new
  %indvars.iv63 = phi i64 [ 0, %._crit_edge40.new ], [ %indvars.iv.next64.7, %._crit_edge33.us ]
  ...
  %exitcond92.7 = icmp eq i64 %indvars.iv.next64.7, 2000
  br i1 %exitcond92.7, label %.preheader10.lr.ph.unr-lcssa, label %._crit_edge33.us
...
.preheader9.us.us.preheader:                      ; preds = %._crit_edge22.us, %.preheader10.lr.ph
  %indvars.iv55 = phi i64 [ 0, %.preheader10.lr.ph ], [ %indvars.iv.next56, %._crit_edge22.us ]
  %scevgep102 = getelementptr [2000 x double], [2000 x double]* %1, i64 0, i64 %indvars.iv55
  %scevgep102103 = bitcast double* %scevgep102 to i8*
  %37 = add nsw i64 %indvars.iv55, -1999
  %scevgep104 = getelementptr [2000 x double], [2000 x double]* %1, i64 2000, i64 %37
  %scevgep104105 = bitcast double* %scevgep104 to i8*
  br label %.preheader9.us.us

._crit_edge22.us:                                 ; preds = %._crit_edge20.us.us
  %indvars.iv.next56 = add nuw nsw i64 %indvars.iv55, 1
  %exitcond90 = icmp eq i64 %indvars.iv.next56, 2000
  br i1 %exitcond90, label %.preheader.us.preheader, label %.preheader9.us.us.preheader

.preheader9.us.us:                                ; preds = %._crit_edge20.us.us, %.preheader9.us.us.preheader
  %indvars.iv51 = phi i64 [ 0, %.preheader9.us.us.preheader ], [ %indvars.iv.next52, %._crit_edge20.us.us ]
  %38 = mul nuw nsw i64 %indvars.iv51, 16000
  %scevgep100 = getelementptr i8, i8* %19, i64 %38
  %39 = add i64 16000, %38
  %scevgep101 = getelementptr i8, i8* %19, i64 %39
  %40 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv51, i64 %indvars.iv55
  br i1 false, label %._crit_edge95.preheader, label %min.iters.checked

._crit_edge95.preheader:                          ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.preheader9.us.us
  %indvars.iv47.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %min.iters.checked ], [ 0, %.preheader9.us.us ], [ 2000, %middle.block ]
  br i1 true, label %._crit_edge95.prol.loopexit.unr-lcssa, label %._crit_edge95.prol.preheader
...
._crit_edge95.prol.loopexit.unr-lcssa:            ; preds = %._crit_edge95.preheader, %._crit_edge95.prol
  %indvars.iv47.unr.ph = phi i64 [ %indvars.iv.next48.prol, %._crit_edge95.prol ], [ %indvars.iv47.ph, %._crit_edge95.preheader ]
  br label %._crit_edge95.prol.loopexit

._crit_edge95.prol.loopexit:                      ; preds = %._crit_edge95.prol.loopexit.unr-lcssa
  br i1 false, label %._crit_edge20.us.us.loopexit, label %._crit_edge95.preheader.new

._crit_edge95.preheader.new:                      ; preds = %._crit_edge95.prol.loopexit
  br label %._crit_edge95

min.iters.checked:                                ; preds = %.preheader9.us.us
  br i1 false, label %._crit_edge95.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %bound0 = icmp ult i8* %scevgep100, %scevgep104105
  %bound1 = icmp ult i8* %scevgep102103, %scevgep101
  %found.conflict = and i1 %bound0, %bound1
  %bc = bitcast double* %40 to i8*
  %bc106 = bitcast double* %40 to i8*
  %bound0107 = icmp ult i8* %scevgep100, %bc106
  %bound1108 = icmp ult i8* %bc, %scevgep101
  %found.conflict109 = and i1 %bound0107, %bound1108
  %conflict.rdx = or i1 %found.conflict, %found.conflict109
  br i1 %conflict.rdx, label %._crit_edge95.preheader, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %57 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %48, i64 %indvars.iv55
  %58 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %49, i64 %indvars.iv55
  %59 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %50, i64 %indvars.iv55
  ...
  %wide.load111 = load <2 x double>, <2 x double>* %73, align 8, !alias.scope !8, !noalias !10
  %74 = fadd <2 x double> %wide.load, %68
  %75 = fadd <2 x double> %wide.load111, %69
...
middle.block:                                     ; preds = %vector.body
  br i1 true, label %._crit_edge20.us.us, label %._crit_edge95.preheader

._crit_edge20.us.us.loopexit.unr-lcssa:           ; preds = %._crit_edge95
  br label %._crit_edge20.us.us.loopexit

._crit_edge20.us.us.loopexit:                     ; preds = %._crit_edge95.prol.loopexit, %._crit_edge20.us.us.loopexit.unr-lcssa
  br label %._crit_edge20.us.us

._crit_edge20.us.us:                              ; preds = %._crit_edge20.us.us.loopexit, %middle.block
  %indvars.iv.next52 = add nuw nsw i64 %indvars.iv51, 1
  %exitcond89 = icmp eq i64 %indvars.iv.next52, 2000
  br i1 %exitcond89, label %._crit_edge22.us, label %.preheader9.us.us

._crit_edge95:                                    ; preds = %._crit_edge95, %._crit_edge95.preheader.new
  %indvars.iv47 = phi i64 [ %indvars.iv47.unr.ph, %._crit_edge95.preheader.new ], [ %indvars.iv.next48.1, %._crit_edge95 ]
  ...
  %exitcond88.1 = icmp eq i64 %indvars.iv.next48.1, 2000
  br i1 %exitcond88.1, label %._crit_edge20.us.us.loopexit.unr-lcssa, label %._crit_edge95, !llvm.loop !14
...
.preheader.us:                                    ; preds = %._crit_edge.us, %.preheader.us.preheader
  ...
  %scevgep121 = getelementptr [2000 x double], [2000 x double]* %1, i64 %indvars.iv43, i64 0
  %scevgep121122 = bitcast double* %scevgep121 to i8*
  %scevgep123 = getelementptr [2000 x double], [2000 x double]* %1, i64 %indvars.iv43, i64 2000
  %scevgep123124 = bitcast double* %scevgep123 to i8*
  %93 = mul nuw nsw i64 %indvars.iv43, 16000
  %scevgep125 = getelementptr i8, i8* %19, i64 %93
  %94 = add i64 16000, %93
  %scevgep126 = getelementptr i8, i8* %19, i64 %94
  br i1 false, label %._crit_edge96.preheader, label %min.iters.checked116

min.iters.checked116:                             ; preds = %.preheader.us
  br i1 false, label %._crit_edge96.preheader, label %vector.memcheck131

vector.memcheck131:                               ; preds = %min.iters.checked116
  ...
  br i1 %memcheck.conflict130, label %._crit_edge96.preheader, label %vector.body112.preheader

vector.body112.preheader:                         ; preds = %vector.memcheck131
  br label %vector.body112

vector.body112:                                   ; preds = %vector.body112.preheader, %vector.body112
  %index133 = phi i64 [ %index.next134, %vector.body112 ], [ 0, %vector.body112.preheader ]
  %95 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv43, i64 %index133
  %96 = bitcast double* %95 to <2 x i64>*
  %wide.load141 = load <2 x i64>, <2 x i64>* %96, align 8, !alias.scope !15
  %97 = getelementptr double, double* %95, i64 2
  %98 = bitcast double* %97 to <2 x i64>*
  %wide.load142 = load <2 x i64>, <2 x i64>* %98, align 8, !alias.scope !15
  %99 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv43, i64 %index133
  %100 = bitcast double* %99 to <2 x i64>*
  store <2 x i64> %wide.load141, <2 x i64>* %100, align 8, !alias.scope !18, !noalias !15
  %101 = getelementptr double, double* %99, i64 2
  %102 = bitcast double* %101 to <2 x i64>*
  store <2 x i64> %wide.load142, <2 x i64>* %102, align 8, !alias.scope !18, !noalias !15
  %index.next134 = add i64 %index133, 4
  %103 = icmp eq i64 %index.next134, 2000
  br i1 %103, label %middle.block113, label %vector.body112, !llvm.loop !20

middle.block113:                                  ; preds = %vector.body112
  br i1 true, label %._crit_edge.us, label %._crit_edge96.preheader

._crit_edge96.preheader:                          ; preds = %middle.block113, %vector.memcheck131, %min.iters.checked116, %.preheader.us
  %indvars.iv.ph = phi i64 [ 0, %vector.memcheck131 ], [ 0, %min.iters.checked116 ], [ 0, %.preheader.us ], [ 2000, %middle.block113 ]
  %104 = sub nsw i64 1999, %indvars.iv.ph
  br i1 true, label %._crit_edge96.prol.loopexit, label %._crit_edge96.prol.preheader

._crit_edge96.prol.preheader:                     ; preds = %._crit_edge96.preheader
  br label %._crit_edge96.prol

._crit_edge96.prol:                               ; preds = %._crit_edge96.prol, %._crit_edge96.prol.preheader
  %indvars.iv.prol = phi i64 [ %indvars.iv.next.prol, %._crit_edge96.prol ], [ %indvars.iv.ph, %._crit_edge96.prol.preheader ]
  %prol.iter = phi i64 [ %prol.iter.sub, %._crit_edge96.prol ], [ 0, %._crit_edge96.prol.preheader ]
  ...
  br i1 %prol.iter.cmp, label %._crit_edge96.prol.loopexit.unr-lcssa, label %._crit_edge96.prol, !llvm.loop !21

._crit_edge96.prol.loopexit.unr-lcssa:            ; preds = %._crit_edge96.prol
  br label %._crit_edge96.prol.loopexit

._crit_edge96.prol.loopexit:                      ; preds = %._crit_edge96.preheader, %._crit_edge96.prol.loopexit.unr-lcssa
  %110 = icmp ult i64 %104, 3
  br i1 %110, label %._crit_edge.us.loopexit, label %._crit_edge96.preheader.new
...
._crit_edge96:                                    ; preds = %._crit_edge96, %._crit_edge96.preheader.new
  %indvars.iv = phi i64 [ %indvars.iv.ph, %._crit_edge96.preheader.new ], [ %indvars.iv.next.3, %._crit_edge96 ]
  ...
  %exitcond87.3 = icmp eq i64 %indvars.iv.next.3, 2000
  br i1 %exitcond87.3, label %._crit_edge.us.loopexit.unr-lcssa, label %._crit_edge96, !llvm.loop !22

._crit_edge.us.loopexit.unr-lcssa:                ; preds = %._crit_edge96
  br label %._crit_edge.us.loopexit

._crit_edge.us.loopexit:                          ; preds = %._crit_edge96.prol.loopexit, %._crit_edge.us.loopexit.unr-lcssa
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %middle.block113
...
._crit_edge17:                                    ; preds = %._crit_edge17.loopexit, %._crit_edge40.thread
  %131 = phi i8* [ %3, %._crit_edge40.thread ], [ %19, %._crit_edge17.loopexit ]
...
.preheader4:                                      ; preds = %._crit_edge9, %.preheader4.preheader
  %indvars.iv39 = phi i2 [ %indvars.iv.next40, %._crit_edge9 ], [ 0, %.preheader4.preheader ]
  %indvars.iv25 = phi i64 [ 0, %.preheader4.preheader ], [ %indvars.iv.next26, %._crit_edge9 ]
  %3 = zext i2 %indvars.iv39 to i64
...
.lr.ph8:                                          ; preds = %._crit_edge
  ...
  %xtraiter34 = and i64 %indvars.iv25, 3
  %lcmp.mod35 = icmp eq i64 %xtraiter34, 0
  br i1 %lcmp.mod35, label %._crit_edge31.prol.loopexit, label %._crit_edge31.prol.preheader
...
._crit_edge31.prol:                               ; preds = %._crit_edge31.prol, %._crit_edge31.prol.preheader
  ...
  %prol.iter = phi i64 [ %xtraiter34, %._crit_edge31.prol.preheader ], [ %prol.iter.sub, %._crit_edge31.prol ]
...
._crit_edge31.prol.loopexit:                      ; preds = %.lr.ph8, %._crit_edge31.prol.loopexit.unr-lcssa
  %.unr36 = phi double [ %.pre33, %.lr.ph8 ], [ %12, %._crit_edge31.prol.loopexit.unr-lcssa ]
...
._crit_edge31:                                    ; preds = %._crit_edge31, %.lr.ph8.new
  %39 = phi double [ %.unr36, %.lr.ph8.new ], [ %55, %._crit_edge31 ]
