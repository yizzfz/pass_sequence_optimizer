...
.preheader29:                                     ; preds = %20, %2
  %indvars.iv35 = phi i64 [ 0, %2 ], [ %indvars.iv.next36, %20 ]
  br label %.preheader

.preheader:                                       ; preds = %19, %.preheader29
  %indvars.iv33 = phi i64 [ 0, %.preheader29 ], [ %indvars.iv.next34, %19 ]
  %3 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv33, i64 %indvars.iv35
  br label %4
...
; <label>:4:                                      ; preds = %4, %.preheader
  ...
  %8 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv35, i64 %indvars.iv
  ...
  %15 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv35, i64 %indvars.iv.next
...
; <label>:20:                                     ; preds = %19
  ...
  br i1 %exitcond37, label %21, label %.preheader29
