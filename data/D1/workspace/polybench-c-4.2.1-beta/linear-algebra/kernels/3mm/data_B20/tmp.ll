...
._crit_edge25:                                    ; preds = %._crit_edge25, %.preheader58
  %indvars.iv10 = phi i64 [ 0, %.preheader58 ], [ %indvars.iv.next11, %._crit_edge25 ]
  ...
  br i1 %exitcond12, label %20, label %._crit_edge25

; <label>:20:                                     ; preds = %._crit_edge25
...
._crit_edge26:                                    ; preds = %._crit_edge26, %.preheader56
  %indvars.iv4 = phi i64 [ 0, %.preheader56 ], [ %indvars.iv.next5, %._crit_edge26 ]
  ...
  br i1 %exitcond6, label %28, label %._crit_edge26

; <label>:28:                                     ; preds = %._crit_edge26
...
._crit_edge27:                                    ; preds = %._crit_edge27, %.preheader
  ...
  br i1 %exitcond, label %37, label %._crit_edge27

; <label>:37:                                     ; preds = %._crit_edge27
...
._crit_edge32:                                    ; preds = %22, %.preheader71
  %indvars.iv20 = phi i64 [ 0, %.preheader71 ], [ %indvars.iv.next21, %22 ]
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge32
  %indvars.iv17 = phi i64 [ 0, %._crit_edge32 ], [ %indvars.iv.next18.1, %._crit_edge ]
  %9 = phi double [ 0.000000e+00, %._crit_edge32 ], [ %21, %._crit_edge ]
...
; <label>:22:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond22, label %23, label %._crit_edge32
...
.preheader69:                                     ; preds = %.preheader69.preheader, %45
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %45 ], [ 0, %.preheader69.preheader ]
  br label %._crit_edge34

._crit_edge34:                                    ; preds = %44, %.preheader69
...
._crit_edge33:                                    ; preds = %._crit_edge33, %._crit_edge34
  %indvars.iv7 = phi i64 [ 0, %._crit_edge34 ], [ %indvars.iv.next8.2, %._crit_edge33 ]
  %25 = phi double [ 0.000000e+00, %._crit_edge34 ], [ %43, %._crit_edge33 ]
  ...
  br i1 %exitcond9.2, label %44, label %._crit_edge33

; <label>:44:                                     ; preds = %._crit_edge33
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %exitcond12 = icmp eq i64 %indvars.iv.next11, 1100
  br i1 %exitcond12, label %45, label %._crit_edge34
...
._crit_edge36:                                    ; preds = %66, %.preheader
...
._crit_edge35:                                    ; preds = %._crit_edge35, %._crit_edge36
  %indvars.iv = phi i64 [ 0, %._crit_edge36 ], [ %indvars.iv.next.2, %._crit_edge35 ]
  %47 = phi double [ 0.000000e+00, %._crit_edge36 ], [ %65, %._crit_edge35 ]
  ...
  br i1 %exitcond.2, label %66, label %._crit_edge35

; <label>:66:                                     ; preds = %._crit_edge35
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond = icmp eq i64 %indvars.iv.next2, 1100
  br i1 %exitcond, label %67, label %._crit_edge36
