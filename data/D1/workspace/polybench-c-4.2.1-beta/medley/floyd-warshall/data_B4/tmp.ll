...
define internal fastcc void @init_array(i32, [2800 x i32]*) unnamed_addr #2 {
  %3 = icmp sgt i32 %0, 0
  br i1 %3, label %.preheader.us.preheader, label %._crit_edge25
...
; <label>:4:                                      ; preds = %4, %.preheader.us
  ...
  %7 = srem i32 %6, 7
  %8 = add nsw i32 %7, 1
  %9 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv26, i64 %indvars.iv
  %10 = add nuw nsw i64 %indvars.iv, %indvars.iv26
  ...
  %18 = srem i32 %17, 11
  %19 = icmp eq i32 %18, 0
  %or.cond21.us = or i1 %19, %or.cond.us
  %..us = select i1 %or.cond21.us, i32 999, i32 %8
...
._crit_edge.us:                                   ; preds = %4
  ...
  br i1 %exitcond29, label %._crit_edge25.loopexit, label %.preheader.us
...
define internal fastcc void @kernel_floyd_warshall(i32, [2800 x i32]*) unnamed_addr #2 {
  %3 = icmp sgt i32 %0, 0
  br i1 %3, label %.preheader.us.us.preheader.preheader, label %._crit_edge34
...
.preheader.us.us.preheader:                       ; preds = %.preheader.us.us.preheader.preheader, %._crit_edge32.us
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %._crit_edge32.us ], [ 0, %.preheader.us.us.preheader.preheader ]
  %6 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv48, i64 0
  br label %.preheader.us.us

._crit_edge32.us:                                 ; preds = %._crit_edge.us.us
  %indvars.iv.next49 = add nuw nsw i64 %indvars.iv48, 1
  %exitcond51 = icmp eq i64 %indvars.iv.next49, %wide.trip.count50
  br i1 %exitcond51, label %._crit_edge34.loopexit, label %.preheader.us.us.preheader

.preheader.us.us:                                 ; preds = %._crit_edge.us.us, %.preheader.us.us.preheader
  %indvars.iv44 = phi i64 [ 0, %.preheader.us.us.preheader ], [ %indvars.iv.next45, %._crit_edge.us.us ]
  %7 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv44, i64 %indvars.iv48
  br i1 %lcmp.mod, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.preheader.us.us
  %8 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv44, i64 0
  %9 = load i32, i32* %8, align 4
  %10 = load i32, i32* %7, align 4
  %11 = load i32, i32* %6, align 4
  %12 = add nsw i32 %11, %10
  %13 = icmp slt i32 %9, %12
  %..us.us.prol = select i1 %13, i32 %9, i32 %12
...
.prol.loopexit:                                   ; preds = %.prol.preheader, %.preheader.us.us
  ...
  br i1 %5, label %._crit_edge.us.us, label %.preheader.us.us.new.preheader
...
._crit_edge.us.us:                                ; preds = %._crit_edge.us.us.loopexit, %.prol.loopexit
  ...
  br i1 %exitcond47, label %._crit_edge32.us, label %.preheader.us.us
...
.preheader.us.us.new:                             ; preds = %.preheader.us.us.new.preheader, %.preheader.us.us.new
  ...
  %14 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv44, i64 %indvars.iv
  %15 = load i32, i32* %14, align 4
  %16 = load i32, i32* %7, align 4
  %17 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv48, i64 %indvars.iv
  %18 = load i32, i32* %17, align 4
  %19 = add nsw i32 %18, %16
  %20 = icmp slt i32 %15, %19
  %..us.us = select i1 %20, i32 %15, i32 %19
  store i32 %..us.us, i32* %14, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %21 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv44, i64 %indvars.iv.next
  %22 = load i32, i32* %21, align 4
  %23 = load i32, i32* %7, align 4
  %24 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv48, i64 %indvars.iv.next
  %25 = load i32, i32* %24, align 4
  %26 = add nsw i32 %25, %23
  %27 = icmp slt i32 %22, %26
  %..us.us.1 = select i1 %27, i32 %22, i32 %26
  store i32 %..us.us.1, i32* %21, align 4
