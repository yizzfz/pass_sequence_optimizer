...
entry:
  ...
  call void @init_array(i32 1000, i32 1200, double* nonnull %alpha, double* nonnull %beta, [1200 x double]* %0, [1000 x double]* %1, [1200 x double]* %2)
  call void (...) @polybench_timer_start() #3
  %3 = load double, double* %alpha, align 8
  %4 = load double, double* %beta, align 8
  call void @kernel_symm(i32 1000, i32 1200, double %3, double %4, [1200 x double]* %0, [1000 x double]* %1, [1200 x double]* %2)
...
if.then:                                          ; preds = %land.lhs.true
  ...
  call void @print_array(i32 1000, i32 1200, [1200 x double]* %6)
  br label %if.end
...
for.body:                                         ; preds = %entry, %for.inc53
  %indvars.iv32 = phi i64 [ 0, %entry ], [ %0, %for.inc53 ]
