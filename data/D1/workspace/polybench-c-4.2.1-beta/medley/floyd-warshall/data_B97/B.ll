...
define i32 @main(i32, i8** nocapture readonly) local_unnamed_addr #0 {
  ...
  tail call fastcc void @init_array([2800 x i32]* %.cast)
  tail call void (...) @polybench_timer_start() #4
  tail call fastcc void @kernel_floyd_warshall([2800 x i32]* %.cast)
...
; <label>:8:                                      ; preds = %5
  ...
  tail call fastcc void @print_array([2800 x i32]* %9)
  br label %._crit_edge
...
._crit_edge12:                                    ; preds = %._crit_edge12, %.preheader.us
  ...
  %12 = srem i32 %7, 11
  %13 = icmp eq i32 %12, 0
  %or.cond17 = or i1 %or.cond, %13
  %. = select i1 %or.cond17, i32 999, i32 %4
...
.loopexit.us:                                     ; preds = %._crit_edge12
...
vector.memcheck:                                  ; preds = %.loopexit.us.us, %.preheader3.us..preheader.us.us_crit_edge
...
._crit_edge26.preheader:                          ; preds = %vector.memcheck
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  br i1 %25, label %.loopexit.us.us.loopexit1, label %vector.body, !llvm.loop !9

.loopexit.us.us.loopexit:                         ; preds = %._crit_edge26
  br label %.loopexit.us.us

.loopexit.us.us.loopexit1:                        ; preds = %vector.body
  br label %.loopexit.us.us

.loopexit.us.us:                                  ; preds = %.loopexit.us.us.loopexit1, %.loopexit.us.us.loopexit
  %indvars.iv.next30 = add nuw nsw i64 %indvars.iv29, 1
  %exitcond33 = icmp eq i64 %indvars.iv.next30, 2800
  br i1 %exitcond33, label %.loopexit6.us, label %vector.memcheck
