...
.lr.ph34.split.us:                                ; preds = %._crit_edge30.us, %.lr.ph34.split.us.preheader
  %indvars.iv81 = phi i64 [ 0, %.lr.ph34.split.us.preheader ], [ %indvars.iv.next82, %._crit_edge30.us ]
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv81
  store double 0.000000e+00, double* %5, align 8
  %sunkaddr9 = shl i64 %indvars.iv81, 3
  %sunkaddr10 = add i64 %4, %sunkaddr9
  %sunkaddr11 = inttoptr i64 %sunkaddr10 to double*
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph34.split.us
  %indvars.iv76 = phi i64 [ 0, %.lr.ph34.split.us ], [ %indvars.iv.next77.4, %._crit_edge ]
  %6 = phi double [ 0.000000e+00, %.lr.ph34.split.us ], [ %21, %._crit_edge ]
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv76, i64 %indvars.iv81
  %8 = load double, double* %7, align 8
  %9 = fadd double %6, %8
  store double %9, double* %sunkaddr11, align 8
  %indvars.iv.next77 = add nuw nsw i64 %indvars.iv76, 1
  %10 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next77, i64 %indvars.iv81
  %11 = load double, double* %10, align 8
  %12 = fadd double %9, %11
  store double %12, double* %sunkaddr11, align 8
  %indvars.iv.next77.1 = add nuw nsw i64 %indvars.iv76, 2
  %13 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next77.1, i64 %indvars.iv81
  %14 = load double, double* %13, align 8
  %15 = fadd double %12, %14
  store double %15, double* %sunkaddr11, align 8
  %indvars.iv.next77.2 = add nuw nsw i64 %indvars.iv76, 3
  %16 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next77.2, i64 %indvars.iv81
  %17 = load double, double* %16, align 8
  %18 = fadd double %15, %17
  store double %18, double* %sunkaddr11, align 8
  %indvars.iv.next77.3 = add nuw nsw i64 %indvars.iv76, 4
  %19 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next77.3, i64 %indvars.iv81
  %20 = load double, double* %19, align 8
  %21 = fadd double %18, %20
  store double %21, double* %sunkaddr11, align 8
  %indvars.iv.next77.4 = add nuw nsw i64 %indvars.iv76, 5
  %exitcond98.4 = icmp eq i64 %indvars.iv.next77.4, 1400
  br i1 %exitcond98.4, label %._crit_edge30.us, label %._crit_edge

._crit_edge30.us:                                 ; preds = %._crit_edge
  %22 = fdiv double %21, %0
  %sunkaddr44 = shl i64 %indvars.iv81, 3
  %sunkaddr45 = add i64 %sunkaddr, %sunkaddr44
  %sunkaddr46 = inttoptr i64 %sunkaddr45 to double*
  store double %22, double* %sunkaddr46, align 8
  %indvars.iv.next82 = add nuw nsw i64 %indvars.iv81, 1
  %exitcond99 = icmp eq i64 %indvars.iv.next82, 1200
  br i1 %exitcond99, label %._crit_edge30.us..preheader14.us_crit_edge, label %.lr.ph34.split.us
...
vector.memcheck:                                  ; preds = %._crit_edge25.us, %._crit_edge30.us..preheader14.us_crit_edge
  %indvars.iv72 = phi i64 [ 0, %._crit_edge30.us..preheader14.us_crit_edge ], [ %23, %._crit_edge25.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv72, i64 0
  %23 = add nuw nsw i64 %indvars.iv72, 1
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv72, i64 %offset.idx
  ...
  %33 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv72, i64 %32
  ...
  br i1 %39, label %._crit_edge25.us.loopexit47, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv68 = phi i64 [ %indvars.iv.next69.3, %scalar.ph ], [ 0, %scalar.ph.preheader ]
  %40 = getelementptr inbounds double, double* %3, i64 %indvars.iv68
  %41 = load double, double* %40, align 8
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv72, i64 %indvars.iv68
  %43 = load double, double* %42, align 8
  %44 = fsub double %43, %41
  store double %44, double* %42, align 8
  %indvars.iv.next69 = or i64 %indvars.iv68, 1
  %45 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next69
  %46 = load double, double* %45, align 8
  %47 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv72, i64 %indvars.iv.next69
  %48 = load double, double* %47, align 8
  %49 = fsub double %48, %46
  store double %49, double* %47, align 8
  %indvars.iv.next69.1 = or i64 %indvars.iv68, 2
  %50 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next69.1
  %51 = load double, double* %50, align 8
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv72, i64 %indvars.iv.next69.1
  %53 = load double, double* %52, align 8
  %54 = fsub double %53, %51
  store double %54, double* %52, align 8
  %indvars.iv.next69.2 = or i64 %indvars.iv68, 3
  %55 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next69.2
  %56 = load double, double* %55, align 8
  %57 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv72, i64 %indvars.iv.next69.2
  %58 = load double, double* %57, align 8
  %59 = fsub double %58, %56
  store double %59, double* %57, align 8
  %indvars.iv.next69.3 = add nuw nsw i64 %indvars.iv68, 4
  %exitcond96.3 = icmp eq i64 %indvars.iv.next69.3, 1200
  br i1 %exitcond96.3, label %._crit_edge25.us.loopexit, label %scalar.ph, !llvm.loop !9

._crit_edge25.us.loopexit:                        ; preds = %scalar.ph
  br label %._crit_edge25.us

._crit_edge25.us.loopexit47:                      ; preds = %vector.body
  br label %._crit_edge25.us

._crit_edge25.us:                                 ; preds = %._crit_edge25.us.loopexit47, %._crit_edge25.us.loopexit
  %exitcond97 = icmp eq i64 %23, 1400
  br i1 %exitcond97, label %.preheader.us.preheader, label %vector.memcheck
...
.lr.ph19.us:                                      ; preds = %._crit_edge20.us-lcssa.us.us, %.preheader.us.preheader
  %indvars.iv54 = phi i64 [ 0, %.preheader.us.preheader ], [ %indvars.iv.next55, %._crit_edge20.us-lcssa.us.us ]
  br label %.lr.ph.us.us

._crit_edge20.us-lcssa.us.us:                     ; preds = %._crit_edge.us.us
  %indvars.iv.next55 = add nuw nsw i64 %indvars.iv54, 1
  %exitcond57 = icmp eq i64 %indvars.iv.next55, 1200
  br i1 %exitcond57, label %._crit_edge22, label %.lr.ph19.us

.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph19.us
  %indvars.iv50 = phi i64 [ %indvars.iv54, %.lr.ph19.us ], [ %indvars.iv.next51, %._crit_edge.us.us ]
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv54, i64 %indvars.iv50
...
._crit_edge.us.us:                                ; preds = %._crit_edge37
  ...
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv50, i64 %indvars.iv54
  store double %62, double* %63, align 8
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1
  %exitcond94 = icmp eq i64 %indvars.iv.next51, 1200
  br i1 %exitcond94, label %._crit_edge20.us-lcssa.us.us, label %.lr.ph.us.us
...
._crit_edge37:                                    ; preds = %._crit_edge37, %.lr.ph.us.us
  ...
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv54
  %66 = load double, double* %65, align 8
  %67 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv50
  %68 = load double, double* %67, align 8
  %69 = fmul double %66, %68
  %70 = fadd double %64, %69
  store double %70, double* %61, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv54
  %72 = load double, double* %71, align 8
  %73 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv50
  %74 = load double, double* %73, align 8
  %75 = fmul double %72, %74
  %76 = fadd double %70, %75
  store double %76, double* %61, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond93.1 = icmp eq i64 %indvars.iv.next.1, 1400
  br i1 %exitcond93.1, label %._crit_edge.us.us, label %._crit_edge37
...
._crit_edge.us:                                   ; preds = %._crit_edge
  ...
  br i1 %exitcond11, label %._crit_edge5, label %.preheader.us
