...
.lr.ph:                                           ; preds = %._crit_edge8, %2
  ...
  %.0310 = phi double [ %9, %2 ], [ %58, %._crit_edge8 ]
...
._crit_edge29.prol:                               ; preds = %._crit_edge29.prol, %._crit_edge29.prol.preheader
  ...
  %.021.prol = phi double [ 0.000000e+00, %._crit_edge29.prol.preheader ], [ %21, %._crit_edge29.prol ]
...
._crit_edge29.prol.loopexit:                      ; preds = %.lr.ph, %._crit_edge29.prol.loopexit.unr-lcssa
  %.lcssa.unr = phi double [ undef, %.lr.ph ], [ %21, %._crit_edge29.prol.loopexit.unr-lcssa ]
  %indvars.iv.unr = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next.prol, %._crit_edge29.prol.loopexit.unr-lcssa ]
  %.021.unr = phi double [ 0.000000e+00, %.lr.ph ], [ %21, %._crit_edge29.prol.loopexit.unr-lcssa ]
  %22 = icmp ult i64 %indvar, 3
  br i1 %22, label %.lr.ph5, label %.lr.ph.new
...
._crit_edge29:                                    ; preds = %._crit_edge29, %.lr.ph.new
  ...
  %.021 = phi double [ %.021.unr, %.lr.ph.new ], [ %50, %._crit_edge29 ]
...
.lr.ph5:                                          ; preds = %._crit_edge29.prol.loopexit, %.lr.ph5.unr-lcssa
  %.lcssa = phi double [ %.lcssa.unr, %._crit_edge29.prol.loopexit ], [ %50, %.lr.ph5.unr-lcssa ]
  %51 = add nuw nsw i64 %indvar, 1
  %52 = add nuw nsw i64 %11, 8
  %53 = fmul double %.049, %13
...
._crit_edge30:                                    ; preds = %._crit_edge30.preheader, %._crit_edge30
  ...
  %81 = sub nsw i64 %14, %indvars.iv14
  %82 = getelementptr inbounds double, double* %1, i64 %81
  %83 = load double, double* %82, align 8
  %84 = fmul double %58, %83
  %85 = fadd double %80, %84
  %86 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 0, i64 %indvars.iv14
...
._crit_edge8:                                     ; preds = %._crit_edge8.loopexit, %middle.block
  ...
  %exitcond28 = icmp eq i64 %indvars.iv.next27, 2000
