...
for.body9:                                        ; preds = %for.cond7
  %10 = load [140 x [160 x double]]*, [140 x [160 x double]]** %A.addr, align 8
  %11 = load i32, i32* %r, align 4
  %idxprom10 = sext i32 %11 to i64
  %arrayidx11 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %10, i64 %idxprom10
  ...
  %15 = load [160 x double]*, [160 x double]** %C4.addr, align 8
  %16 = load i32, i32* %s, align 4
  %idxprom16 = sext i32 %16 to i64
  %arrayidx17 = getelementptr inbounds [160 x double], [160 x double]* %15, i64 %idxprom16
...
for.body27:                                       ; preds = %for.cond25
  ...
  %29 = load [140 x [160 x double]]*, [140 x [160 x double]]** %A.addr, align 8
  %30 = load i32, i32* %r, align 4
  %idxprom30 = sext i32 %30 to i64
  %arrayidx31 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %29, i64 %idxprom30
...
entry:
  ...
  %0 = bitcast i8* %call to [150 x [140 x [160 x double]]]*
  store [150 x [140 x [160 x double]]]* %0, [150 x [140 x [160 x double]]]** %A, align 8
  %call1 = call i8* @polybench_alloc_data(i64 160, i32 8)
  %1 = bitcast i8* %call1 to [160 x double]*
  store [160 x double]* %1, [160 x double]** %sum, align 8
  %call2 = call i8* @polybench_alloc_data(i64 25600, i32 8)
  %2 = bitcast i8* %call2 to [160 x [160 x double]]*
  store [160 x [160 x double]]* %2, [160 x [160 x double]]** %C4, align 8
  %3 = load i32, i32* %nr, align 4
  %4 = load i32, i32* %nq, align 4
  %5 = load i32, i32* %np, align 4
  %6 = load [150 x [140 x [160 x double]]]*, [150 x [140 x [160 x double]]]** %A, align 8
  %arraydecay = getelementptr inbounds [150 x [140 x [160 x double]]], [150 x [140 x [160 x double]]]* %6, i32 0, i32 0
  %7 = load [160 x [160 x double]]*, [160 x [160 x double]]** %C4, align 8
  %arraydecay3 = getelementptr inbounds [160 x [160 x double]], [160 x [160 x double]]* %7, i32 0, i32 0
  call void @init_array(i32 %3, i32 %4, i32 %5, [140 x [160 x double]]* %arraydecay, [160 x double]* %arraydecay3)
  call void (...) @polybench_timer_start()
  %8 = load i32, i32* %nr, align 4
  %9 = load i32, i32* %nq, align 4
  %10 = load i32, i32* %np, align 4
  %11 = load [150 x [140 x [160 x double]]]*, [150 x [140 x [160 x double]]]** %A, align 8
  %arraydecay4 = getelementptr inbounds [150 x [140 x [160 x double]]], [150 x [140 x [160 x double]]]* %11, i32 0, i32 0
  %12 = load [160 x [160 x double]]*, [160 x [160 x double]]** %C4, align 8
  %arraydecay5 = getelementptr inbounds [160 x [160 x double]], [160 x [160 x double]]* %12, i32 0, i32 0
  %13 = load [160 x double]*, [160 x double]** %sum, align 8
  %arraydecay6 = getelementptr inbounds [160 x double], [160 x double]* %13, i32 0, i32 0
  call void @kernel_doitgen(i32 %8, i32 %9, i32 %10, [140 x [160 x double]]* %arraydecay4, [160 x double]* %arraydecay5, double* %arraydecay6)
...
land.lhs.true:                                    ; preds = %entry
  ...
  %call7 = call i32 @strcmp(i8* %16, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i32 0, i32 0)) #4
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %20 = load [150 x [140 x [160 x double]]]*, [150 x [140 x [160 x double]]]** %A, align 8
  %arraydecay8 = getelementptr inbounds [150 x [140 x [160 x double]]], [150 x [140 x [160 x double]]]* %20, i32 0, i32 0
  call void @print_array(i32 %17, i32 %18, i32 %19, [140 x [160 x double]]* %arraydecay8)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  %21 = load [150 x [140 x [160 x double]]]*, [150 x [140 x [160 x double]]]** %A, align 8
  %22 = bitcast [150 x [140 x [160 x double]]]* %21 to i8*
  call void @free(i8* %22) #5
  %23 = load [160 x double]*, [160 x double]** %sum, align 8
  %24 = bitcast [160 x double]* %23 to i8*
  call void @free(i8* %24) #5
  %25 = load [160 x [160 x double]]*, [160 x [160 x double]]** %C4, align 8
  %26 = bitcast [160 x [160 x double]]* %25 to i8*
...
for.body6:                                        ; preds = %for.cond4
  ...
  %11 = load [140 x [160 x double]]*, [140 x [160 x double]]** %A.addr, align 8
  %12 = load i32, i32* %i, align 4
  %idxprom = sext i32 %12 to i64
  %arrayidx = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %11, i64 %idxprom
...
for.body25:                                       ; preds = %for.cond22
  ...
  %26 = load [160 x double]*, [160 x double]** %C4.addr, align 8
  %27 = load i32, i32* %i, align 4
  %idxprom31 = sext i32 %27 to i64
  %arrayidx32 = getelementptr inbounds [160 x double], [160 x double]* %26, i64 %idxprom31
...
if.end:                                           ; preds = %if.then, %for.body7
  ...
  %16 = load [140 x [160 x double]]*, [140 x [160 x double]]** %A.addr, align 8
  %17 = load i32, i32* %i, align 4
  %idxprom = sext i32 %17 to i64
  %arrayidx = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %16, i64 %idxprom
