...
.lr.ph4.split.us:                                 ; preds = %._crit_edge.us..lr.ph4.split.us_crit_edge, %.lr.ph4.split.us.preheader
  %indvars.iv1 = phi i64 [ 0, %.lr.ph4.split.us.preheader ], [ %indvars.iv.next2, %._crit_edge.us..lr.ph4.split.us_crit_edge ]
...
; <label>:7:                                      ; preds = %._crit_edge, %.lr.ph4.split.us
  ...
  %8 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv1
  %9 = trunc i64 %8 to i32
  %10 = srem i32 %9, 2100
  %11 = sitofp i32 %10 to double
  %12 = fdiv double %11, 2.100000e+03
  %13 = getelementptr inbounds [1900 x double], [1900 x double]* %0, i64 %indvars.iv1, i64 %indvars.iv
  store double %12, double* %13, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %14 = mul nuw nsw i64 %indvars.iv.next.1, %indvars.iv1
  %15 = trunc i64 %14 to i32
  %16 = srem i32 %15, 2100
  %17 = sitofp i32 %16 to double
  %18 = fdiv double %17, 2.100000e+03
  %19 = getelementptr inbounds [1900 x double], [1900 x double]* %0, i64 %indvars.iv1, i64 %indvars.iv.next
...
._crit_edge.us:                                   ; preds = %7
  ...
  %exitcond = icmp eq i64 %indvars.iv.next2, 2100
...
; <label>:20:                                     ; preds = %._crit_edge4, %.lr.ph10
  %indvars.iv18 = phi i64 [ 0, %.lr.ph10 ], [ %indvars.iv.next19.1, %._crit_edge4 ]
  ...
  %exitcond3.1 = icmp eq i64 %indvars.iv.next19.1, 1900
  br i1 %exitcond3.1, label %.lr.ph4.split.us.preheader, label %._crit_edge4
...
.lr.ph3.split.us:                                 ; preds = %._crit_edge.us..lr.ph3.split.us_crit_edge, %.lr.ph3.split.us.preheader
  %indvars.iv1 = phi i64 [ 0, %.lr.ph3.split.us.preheader ], [ %indvars.iv.next2, %._crit_edge.us..lr.ph3.split.us_crit_edge ]
  %5 = getelementptr inbounds double, double* %2, i64 %indvars.iv1
  store double 0.000000e+00, double* %5, align 8
  %sunkaddr13 = shl nsw i64 %indvars.iv1, 3
...
; <label>:6:                                      ; preds = %._crit_edge, %.lr.ph3.split.us
  ...
  %10 = getelementptr inbounds [1900 x double], [1900 x double]* %0, i64 %indvars.iv1, i64 %indvars.iv
...
._crit_edge.us:                                   ; preds = %6
  ...
  br i1 %exitcond3, label %._crit_edge4, label %._crit_edge.us..lr.ph3.split.us_crit_edge

._crit_edge.us..lr.ph3.split.us_crit_edge:        ; preds = %._crit_edge.us
  br label %.lr.ph3.split.us

; <label>:20:                                     ; preds = %._crit_edge5, %.lr.ph9
  %indvars.iv28 = phi i64 [ 0, %.lr.ph9 ], [ %indvars.iv.next29.24, %._crit_edge5 ]
  %indvars.iv.next29.24 = add nsw i64 %indvars.iv28, 25
  %exitcond4.24 = icmp eq i64 %indvars.iv.next29.24, 1900
  br i1 %exitcond4.24, label %.lr.ph3.split.us.preheader, label %._crit_edge5
...
; <label>:6:                                      ; preds = %._crit_edge3, %.lr.ph6
  %indvars.iv11 = phi i64 [ 0, %.lr.ph6 ], [ %indvars.iv.next12, %._crit_edge3 ]
...
; <label>:12:                                     ; preds = %._crit_edge2, %10
  ...
  %exitcond1 = icmp eq i64 %indvars.iv.next12, 1900
  br i1 %exitcond1, label %._crit_edge7, label %._crit_edge3
...
; <label>:21:                                     ; preds = %._crit_edge5, %._crit_edge7
  %indvars.iv = phi i64 [ 0, %._crit_edge7 ], [ %indvars.iv.next, %._crit_edge5 ]
  %22 = trunc i64 %indvars.iv to i32
  %23 = srem i32 %22, 20
  %24 = icmp eq i32 %23, 0
  br i1 %24, label %25, label %._crit_edge4
