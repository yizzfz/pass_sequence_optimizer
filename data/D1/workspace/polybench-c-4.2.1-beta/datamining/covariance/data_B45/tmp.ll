...
vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert160 = insertelement <2 x double> undef, double %2, i32 0
...
vector.body.prol:                                 ; preds = %vector.body.prol.preheader
  ...
  %8 = fdiv <2 x double> zeroinitializer, %broadcast.splat161
...
vector.body:                                      ; preds = %vector.body, %vector.ph.new
  ...
  %15 = fdiv <2 x double> %wide.load, %broadcast.splat161
  ...
  %22 = fdiv <2 x double> %wide.load.1, %broadcast.splat161
...
.lr.ph53.split.us.preheader:                      ; preds = %.lr.ph53
  %sunkaddr212 = ptrtoint double* %5 to i64
  %sunkaddr220 = ptrtoint double* %5 to i64
  %sunkaddr216 = ptrtoint double* %5 to i64
  %sunkaddr = ptrtoint double* %5 to i64
  %sunkaddr208 = ptrtoint double* %5 to i64
...
.lr.ph53.split.us:                                ; preds = %._crit_edge48.us, %.lr.ph53.split.us.preheader
  ...
  %sext125 = shl i64 %indvars.iv95, 32
  %24 = ashr exact i64 %sext125, 32
  %25 = getelementptr inbounds double, double* %5, i64 %24
  store double 0.000000e+00, double* %25, align 8
  br i1 true, label %.prol.loopexit121, label %.lr.ph53.split.us..prol.preheader120_crit_edge

.lr.ph53.split.us..prol.preheader120_crit_edge:   ; preds = %.lr.ph53.split.us
  %sunkaddr205 = shl i64 %indvars.iv95, 3
  %sunkaddr206 = add i64 %sunkaddr, %sunkaddr205
  %sunkaddr207 = inttoptr i64 %sunkaddr206 to double*
  %.pre = load double, double* %sunkaddr207, align 8
  %sunkaddr209 = shl i64 %indvars.iv95, 3
  %sunkaddr210 = add i64 %sunkaddr208, %sunkaddr209
  %sunkaddr211 = inttoptr i64 %sunkaddr210 to double*
  br label %.prol.preheader120

.prol.preheader120:                               ; preds = %.prol.preheader120, %.lr.ph53.split.us..prol.preheader120_crit_edge
  %26 = phi double [ %.pre, %.lr.ph53.split.us..prol.preheader120_crit_edge ], [ %29, %.prol.preheader120 ]
  %indvars.iv91.prol = phi i64 [ 0, %.lr.ph53.split.us..prol.preheader120_crit_edge ], [ %indvars.iv.next92.prol, %.prol.preheader120 ]
  %prol.iter124 = phi i64 [ 0, %.lr.ph53.split.us..prol.preheader120_crit_edge ], [ %prol.iter124.sub, %.prol.preheader120 ]
  %27 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv91.prol, i64 %indvars.iv95
  %28 = load double, double* %27, align 8
  %29 = fadd double %28, %26
  store double %29, double* %sunkaddr211, align 8
  ...
  br i1 %prol.iter124.cmp, label %.prol.loopexit121.loopexit, label %.prol.preheader120, !llvm.loop !4

.prol.loopexit121.loopexit:                       ; preds = %.prol.preheader120
  br label %.prol.loopexit121

.prol.loopexit121:                                ; preds = %.prol.loopexit121.loopexit, %.lr.ph53.split.us
  %indvars.iv91.unr = phi i64 [ 0, %.lr.ph53.split.us ], [ %indvars.iv.next92.prol, %.prol.loopexit121.loopexit ]
  %sunkaddr213 = shl i64 %indvars.iv95, 3
  %sunkaddr214 = add i64 %sunkaddr212, %sunkaddr213
  %sunkaddr215 = inttoptr i64 %sunkaddr214 to double*
  %.pre127 = load double, double* %sunkaddr215, align 8
  br i1 false, label %._crit_edge48.us, label %.lr.ph53.split.us.new.preheader

.lr.ph53.split.us.new.preheader:                  ; preds = %.prol.loopexit121
  %sunkaddr217 = shl i64 %indvars.iv95, 3
  %sunkaddr218 = add i64 %sunkaddr216, %sunkaddr217
...
.lr.ph53.split.us.new:                            ; preds = %.lr.ph53.split.us.new.preheader, %.lr.ph53.split.us.new
  %30 = phi double [ %42, %.lr.ph53.split.us.new ], [ %.pre127, %.lr.ph53.split.us.new.preheader ]
  ...
  store double %33, double* %sunkaddr219, align 8
  ...
  store double %36, double* %sunkaddr219, align 8
  ...
  store double %39, double* %sunkaddr219, align 8
  ...
  store double %42, double* %sunkaddr219, align 8
  %indvars.iv.next92.3 = add nsw i64 %indvars.iv91, 4
  %exitcond107.3 = icmp eq i64 %indvars.iv.next92.3, 1400
  br i1 %exitcond107.3, label %._crit_edge48.us.loopexit, label %.lr.ph53.split.us.new

._crit_edge48.us.loopexit:                        ; preds = %.lr.ph53.split.us.new
  br label %._crit_edge48.us

._crit_edge48.us:                                 ; preds = %._crit_edge48.us.loopexit, %.prol.loopexit121
  %43 = phi double [ %.pre127, %.prol.loopexit121 ], [ %42, %._crit_edge48.us.loopexit ]
  %44 = fdiv double %43, %2
  %sunkaddr221 = shl i64 %indvars.iv95, 3
  %sunkaddr222 = add i64 %sunkaddr220, %sunkaddr221
  %sunkaddr223 = inttoptr i64 %sunkaddr222 to double*
  store double %44, double* %sunkaddr223, align 8
...
.preheader9.loopexit225:                          ; preds = %.lr.ph53.split
  br label %.preheader9

.preheader9:                                      ; preds = %.preheader9.loopexit225, %.preheader9.loopexit, %middle.block, %6
  br i1 true, label %.preheader8.us.preheader, label %.preheader7

.preheader8.us.preheader:                         ; preds = %.preheader9
  %scevgep178 = getelementptr double, double* %5, i64 4
...
.preheader8.us:                                   ; preds = %._crit_edge38.us, %.preheader8.us.preheader
  ...
  %scevgep173 = getelementptr [1200 x double], [1200 x double]* %3, i64 %indvars.iv89, i64 4
  br i1 true, label %.prol.loopexit117, label %.prol.preheader116.preheader

.prol.preheader116.preheader:                     ; preds = %.preheader8.us
  br label %.prol.preheader116

.prol.preheader116:                               ; preds = %.prol.preheader116.preheader, %.prol.preheader116
  %indvars.iv85.prol = phi i64 [ %indvars.iv.next86.prol, %.prol.preheader116 ], [ 0, %.prol.preheader116.preheader ]
  %prol.iter = phi i64 [ %prol.iter.sub, %.prol.preheader116 ], [ 0, %.prol.preheader116.preheader ]
  ...
  br i1 %prol.iter.cmp, label %.prol.loopexit117.loopexit, label %.prol.preheader116, !llvm.loop !6

.prol.loopexit117.loopexit:                       ; preds = %.prol.preheader116
  br label %.prol.loopexit117

.prol.loopexit117:                                ; preds = %.prol.loopexit117.loopexit, %.preheader8.us
  %indvars.iv85.unr = phi i64 [ 0, %.preheader8.us ], [ %indvars.iv.next86.prol, %.prol.loopexit117.loopexit ]
  br i1 false, label %._crit_edge38.us, label %.prol.loopexit117..preheader8.us.new_crit_edge

.prol.loopexit117..preheader8.us.new_crit_edge:   ; preds = %.prol.loopexit117
  %51 = sub i64 1196, %indvars.iv85.unr
  %52 = lshr i64 %51, 2
  %53 = add nuw nsw i64 %52, 1
  %min.iters.check165 = icmp ult i64 %53, 2
  br i1 %min.iters.check165, label %.preheader8.us.new.preheader, label %min.iters.checked166

min.iters.checked166:                             ; preds = %.prol.loopexit117..preheader8.us.new_crit_edge
  %n.mod.vf167 = and i64 %53, 1
  %n.vec168 = sub nsw i64 %53, %n.mod.vf167
  %cmp.zero169 = icmp eq i64 %n.vec168, 0
  br i1 %cmp.zero169, label %.preheader8.us.new.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked166
  %scevgep171 = getelementptr [1200 x double], [1200 x double]* %3, i64 %indvars.iv89, i64 %indvars.iv85.unr
  %54 = and i64 %51, -4
  %55 = add i64 %indvars.iv85.unr, %54
  %scevgep174 = getelementptr double, double* %scevgep173, i64 %55
  %scevgep176 = getelementptr double, double* %5, i64 %indvars.iv85.unr
  %scevgep179 = getelementptr double, double* %scevgep178, i64 %55
  %bound0 = icmp ult double* %scevgep171, %scevgep179
  %bound1 = icmp ult double* %scevgep176, %scevgep174
  %memcheck.conflict = and i1 %bound0, %bound1
  %56 = add i64 %indvars.iv85.unr, 4
  %57 = shl nuw i64 %52, 2
  %58 = add i64 %56, %57
  %59 = shl nuw nsw i64 %n.mod.vf167, 2
  %ind.end = sub i64 %58, %59
  br i1 %memcheck.conflict, label %.preheader8.us.new.preheader, label %vector.body162.preheader

vector.body162.preheader:                         ; preds = %vector.memcheck
  br label %vector.body162

vector.body162:                                   ; preds = %vector.body162.preheader, %vector.body162
  %index182 = phi i64 [ %index.next183, %vector.body162 ], [ 0, %vector.body162.preheader ]
  %60 = shl i64 %index182, 2
  ...
  %wide.vec192 = load <8 x double>, <8 x double>* %65, align 8, !alias.scope !10, !noalias !7
  %66 = fsub <8 x double> %wide.vec192, %wide.vec
  ...
  %77 = icmp eq i64 %index.next183, %n.vec168
  br i1 %77, label %middle.block163, label %vector.body162, !llvm.loop !12

middle.block163:                                  ; preds = %vector.body162
  %cmp.n185 = icmp eq i64 %n.mod.vf167, 0
  br i1 %cmp.n185, label %._crit_edge38.us, label %.preheader8.us.new.preheader

.preheader8.us.new.preheader:                     ; preds = %middle.block163, %vector.memcheck, %min.iters.checked166, %.prol.loopexit117..preheader8.us.new_crit_edge
  %indvars.iv85.ph = phi i64 [ %indvars.iv85.unr, %vector.memcheck ], [ %indvars.iv85.unr, %min.iters.checked166 ], [ %indvars.iv85.unr, %.prol.loopexit117..preheader8.us.new_crit_edge ], [ %ind.end, %middle.block163 ]
...
.preheader8.us.new:                               ; preds = %.preheader8.us.new.preheader, %.preheader8.us.new
  ...
  %exitcond105.3 = icmp eq i64 %indvars.iv.next86.3, 1200
  br i1 %exitcond105.3, label %._crit_edge38.us.loopexit, label %.preheader8.us.new, !llvm.loop !13

._crit_edge38.us.loopexit:                        ; preds = %.preheader8.us.new
  br label %._crit_edge38.us

._crit_edge38.us:                                 ; preds = %._crit_edge38.us.loopexit, %middle.block163, %.prol.loopexit117
...
.lr.ph53.split:                                   ; preds = %.lr.ph53.split.preheader, %.lr.ph53.split
  ...
  br i1 %104, label %.lr.ph53.split, label %.preheader9.loopexit225, !llvm.loop !14
...
.preheader.us.preheader:                          ; preds = %.preheader.lr.ph
  %sunkaddr153 = ptrtoint [1200 x double]* %3 to i64
...
.lr.ph12.us:                                      ; preds = %.preheader.us
  ...
  %sunkaddr154 = shl i64 %indvars.iv77, 3
  %sunkaddr155 = add i64 %sunkaddr153, %sunkaddr154
...
.prol.preheader:                                  ; preds = %.lr.ph.us.us
  %112 = load double, double* %sunkaddr156, align 8
...
._crit_edge.us.us:                                ; preds = %._crit_edge.us.us.loopexit, %.prol.loopexit
  ...
  %exitcond = icmp eq i64 %indvars.iv.next74, 1200
...
.lr.ph.us.us.new:                                 ; preds = %.lr.ph.us.us.new.preheader, %.lr.ph.us.us.new
  ...
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %exitcond101.1 = icmp eq i64 %indvars.iv.next.1, 1400
  br i1 %exitcond101.1, label %._crit_edge.us.us.loopexit, label %.lr.ph.us.us.new
...
.lr.ph12:                                         ; preds = %.preheader
  ...
  %xtraiter227 = and i64 %136, 3
  %lcmp.mod = icmp eq i64 %xtraiter227, 0
...
._crit_edge.prol:                                 ; preds = %._crit_edge.prol, %._crit_edge.prol.preheader
  ...
  %prol.iter228 = phi i64 [ %xtraiter227, %._crit_edge.prol.preheader ], [ %prol.iter228.sub, %._crit_edge.prol ]
  ...
  br i1 %prol.iter228.cmp, label %._crit_edge.prol.loopexit.unr-lcssa, label %._crit_edge.prol, !llvm.loop !16
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph12.new
  ...
  %exitcond103.3 = icmp eq i64 %indvars.iv.next80.3, 1200
  br i1 %exitcond103.3, label %._crit_edge13.loopexit.unr-lcssa, label %._crit_edge
...
._crit_edge13:                                    ; preds = %._crit_edge13.loopexit, %.preheader
  ...
  br i1 %149, label %.preheader, label %.preheader7._crit_edge.loopexit224

.preheader7._crit_edge.loopexit:                  ; preds = %._crit_edge13.us-lcssa.us.us
  br label %.preheader7._crit_edge

.preheader7._crit_edge.loopexit224:               ; preds = %._crit_edge13
  br label %.preheader7._crit_edge

.preheader7._crit_edge:                           ; preds = %.preheader7._crit_edge.loopexit224, %.preheader7._crit_edge.loopexit, %.preheader7
  ret void
}
...
._crit_edge15:                                    ; preds = %._crit_edge16, %12
  ...
  br i1 %exitcond13, label %._crit_edge.us, label %._crit_edge16
