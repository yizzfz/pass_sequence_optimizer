...
@__llvm_prf_nm = private constant [93 x i8] c"[\00AddVbrFrame\01CreateI4\01CheckVbrTag\01GetVbrTag\01tmp1.ll:ExtractI4\01InitVbrTag\01PutVbrTag\01SeekPoint", section "__llvm_prf_names"
@llvm.used = appending global [9 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_AddVbrFrame to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_CreateI4 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_CheckVbrTag to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_GetVbrTag to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_ExtractI4 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_InitVbrTag to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_PutVbrTag to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_SeekPoint to i8*), i8* getelementptr inbounds ([93 x i8], [93 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
