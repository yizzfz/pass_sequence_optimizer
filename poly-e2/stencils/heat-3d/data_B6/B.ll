...
for.cond4.preheader.us.us:                        ; preds = %for.cond4.for.inc19_crit_edge.us.us, %for.cond4.preheader.us.us.preheader
  ...
  br i1 %0, label %for.inc.us.us.prol.loopexit, label %for.inc.us.us.prol
...
for.inc.us.us.prol.loopexit:                      ; preds = %for.inc.us.us.prol, %for.cond4.preheader.us.us
  ...
  br i1 %1, label %for.cond4.for.inc19_crit_edge.us.us, label %for.inc.us.us.preheader
...
for.cond1.preheader:                              ; preds = %for.inc209, %entry
  ...
  br i1 %1, label %for.cond4.preheader.preheader, label %for.inc209

for.cond4.preheader.preheader:                    ; preds = %for.cond1.preheader
  br label %for.cond4.preheader

for.cond101.preheader:                            ; preds = %for.inc98
  br i1 %3, label %for.cond109.preheader.lr.ph.preheader, label %for.inc209
...
for.cond4.preheader:                              ; preds = %for.cond4.preheader.preheader, %for.inc98
  ...
  %4 = add nuw nsw i64 %indvar168, 1
  %5 = add nuw nsw i64 %indvar168, 2
  br i1 %2, label %for.cond8.preheader.lr.ph, label %for.inc98

for.cond8.preheader.lr.ph:                        ; preds = %for.cond4.preheader
  %6 = add nuw nsw i64 %indvars.iv120, 1
  %7 = add nsw i64 %indvars.iv120, -1
...
for.cond8.preheader.us:                           ; preds = %for.cond8.for.inc95_crit_edge.us, %for.cond8.preheader.lr.ph
  ...
  %8 = add nuw nsw i64 %indvar170, 1
  %scevgep172 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %4, i64 %8, i64 1
  %scevgep174 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %4, i64 %8, i64 %wide.trip.count
  %scevgep176 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvar168, i64 %8, i64 1
  %scevgep178 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %5, i64 %8, i64 %wide.trip.count
  %indvars.iv.next116 = add nuw nsw i64 %indvars.iv115, 1
  %9 = add nsw i64 %indvars.iv115, -1
...
vector.body159:                                   ; preds = %vector.body159.preheader, %vector.body159
  ...
  %10 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %6, i64 %indvars.iv115, i64 %offset.idx191
  %11 = bitcast double* %10 to <2 x double>*
  %wide.load195 = load <2 x double>, <2 x double>* %11, align 8, !alias.scope !1
  %12 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv120, i64 %indvars.iv115, i64 %offset.idx191
  %13 = bitcast double* %12 to <2 x double>*
  %wide.load196 = load <2 x double>, <2 x double>* %13, align 8, !alias.scope !1
  %14 = fmul <2 x double> %wide.load196, <double 2.000000e+00, double 2.000000e+00>
  %15 = fsub <2 x double> %wide.load195, %14
  %16 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %7, i64 %indvars.iv115, i64 %offset.idx191
  %17 = bitcast double* %16 to <2 x double>*
  %wide.load197 = load <2 x double>, <2 x double>* %17, align 8, !alias.scope !1
  %18 = fadd <2 x double> %wide.load197, %15
  %19 = fmul <2 x double> %18, <double 1.250000e-01, double 1.250000e-01>
  %20 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv120, i64 %indvars.iv.next116, i64 %offset.idx191
  %21 = bitcast double* %20 to <2 x double>*
  %wide.load198 = load <2 x double>, <2 x double>* %21, align 8, !alias.scope !1
  %22 = fsub <2 x double> %wide.load198, %14
  %23 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv120, i64 %9, i64 %offset.idx191
  %24 = bitcast double* %23 to <2 x double>*
  %wide.load199 = load <2 x double>, <2 x double>* %24, align 8, !alias.scope !1
  %25 = fadd <2 x double> %22, %wide.load199
  %26 = fmul <2 x double> %25, <double 1.250000e-01, double 1.250000e-01>
  %27 = fadd <2 x double> %19, %26
  %28 = add nuw nsw i64 %offset.idx191, 1
  ...
  %31 = fsub <2 x double> %wide.load200, %14
  %32 = add nsw i64 %offset.idx191, -1
  %33 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv120, i64 %indvars.iv115, i64 %32
  %34 = bitcast double* %33 to <2 x double>*
  %wide.load201 = load <2 x double>, <2 x double>* %34, align 8, !alias.scope !1
  %35 = fadd <2 x double> %31, %wide.load201
  %36 = fmul <2 x double> %35, <double 1.250000e-01, double 1.250000e-01>
  %37 = fadd <2 x double> %27, %36
  %38 = fadd <2 x double> %wide.load196, %37
  %39 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv120, i64 %indvars.iv115, i64 %offset.idx191
  %40 = bitcast double* %39 to <2 x double>*
  store <2 x double> %38, <2 x double>* %40, align 8, !alias.scope !4, !noalias !1
  %index.next187 = add i64 %index186, 2
  %41 = icmp eq i64 %index.next187, %n.vec165
  br i1 %41, label %middle.block160, label %vector.body159, !llvm.loop !6
...
for.inc.us:                                       ; preds = %for.inc.us.preheader, %for.inc.us
  ...
  %arrayidx15.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %6, i64 %indvars.iv115, i64 %indvars.iv
  ...
  %arrayidx29.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %7, i64 %indvars.iv115, i64 %indvars.iv
  ...
  %arrayidx53.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv120, i64 %9, i64 %indvars.iv
  ...
  %arrayidx78.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv120, i64 %indvars.iv115, i64 %48
...
for.cond8.for.inc95_crit_edge.us:                 ; preds = %for.cond8.for.inc95_crit_edge.us.loopexit, %middle.block160
  ...
  %indvar.next171 = add nuw nsw i64 %indvar170, 1
...
for.cond109.preheader.lr.ph:                      ; preds = %for.cond109.preheader.lr.ph.preheader, %for.inc206
  ...
  %52 = add nuw nsw i64 %indvars.iv136, 1
  %53 = add nsw i64 %indvars.iv136, -1
...
for.cond109.preheader.us:                         ; preds = %for.cond109.for.inc203_crit_edge.us, %for.cond109.preheader.lr.ph
  ...
  %54 = add nuw nsw i64 %indvar144, 1
  %scevgep = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %50, i64 %54, i64 1
  %scevgep147 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %50, i64 %54, i64 %wide.trip.count
  %scevgep149 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvar, i64 %54, i64 1
  %scevgep151 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %51, i64 %54, i64 %wide.trip.count
  %indvars.iv.next132 = add nuw nsw i64 %indvars.iv131, 1
  %55 = add nsw i64 %indvars.iv131, -1
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %56 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %52, i64 %indvars.iv131, i64 %offset.idx
  %57 = bitcast double* %56 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %57, align 8, !alias.scope !10
  %58 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv136, i64 %indvars.iv131, i64 %offset.idx
  %59 = bitcast double* %58 to <2 x double>*
  %wide.load153 = load <2 x double>, <2 x double>* %59, align 8, !alias.scope !10
  %60 = fmul <2 x double> %wide.load153, <double 2.000000e+00, double 2.000000e+00>
  %61 = fsub <2 x double> %wide.load, %60
  %62 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %53, i64 %indvars.iv131, i64 %offset.idx
  %63 = bitcast double* %62 to <2 x double>*
  %wide.load154 = load <2 x double>, <2 x double>* %63, align 8, !alias.scope !10
  %64 = fadd <2 x double> %wide.load154, %61
  %65 = fmul <2 x double> %64, <double 1.250000e-01, double 1.250000e-01>
  %66 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv136, i64 %indvars.iv.next132, i64 %offset.idx
  %67 = bitcast double* %66 to <2 x double>*
  %wide.load155 = load <2 x double>, <2 x double>* %67, align 8, !alias.scope !10
  %68 = fsub <2 x double> %wide.load155, %60
  %69 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv136, i64 %55, i64 %offset.idx
  %70 = bitcast double* %69 to <2 x double>*
  %wide.load156 = load <2 x double>, <2 x double>* %70, align 8, !alias.scope !10
  %71 = fadd <2 x double> %68, %wide.load156
  ...
  %wide.load157 = load <2 x double>, <2 x double>* %76, align 8, !alias.scope !10
  %77 = fsub <2 x double> %wide.load157, %60
  %78 = add nsw i64 %offset.idx, -1
  %79 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv136, i64 %indvars.iv131, i64 %78
  %80 = bitcast double* %79 to <2 x double>*
  %wide.load158 = load <2 x double>, <2 x double>* %80, align 8, !alias.scope !10
  %81 = fadd <2 x double> %77, %wide.load158
  %82 = fmul <2 x double> %81, <double 1.250000e-01, double 1.250000e-01>
  %83 = fadd <2 x double> %73, %82
  %84 = fadd <2 x double> %wide.load153, %83
  %85 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv136, i64 %indvars.iv131, i64 %offset.idx
...
for.inc200.us:                                    ; preds = %for.inc200.us.preheader, %for.inc200.us
  ...
  %arrayidx119.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %52, i64 %indvars.iv131, i64 %indvars.iv126
  ...
  %arrayidx134.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %53, i64 %indvars.iv131, i64 %indvars.iv126
  ...
  %arrayidx158.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv136, i64 %55, i64 %indvars.iv126
  ...
  %94 = add nsw i64 %indvars.iv126, -1
  %arrayidx183.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv136, i64 %indvars.iv131, i64 %94
