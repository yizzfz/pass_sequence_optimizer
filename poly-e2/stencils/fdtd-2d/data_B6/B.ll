...
for.cond1.preheader.lr.ph:                        ; preds = %entry
  ...
  %0 = add nuw nsw i64 %wide.trip.count45, 1
  %1 = add nsw i64 %wide.trip.count34.1, -2
  %2 = add nsw i64 %wide.trip.count34.1, -2
  %3 = add nsw i64 %wide.trip.count34.1, -2
...
for.cond1.preheader:                              ; preds = %for.inc113, %for.cond1.preheader.lr.ph
  ...
  %6 = icmp sgt i32 %ny, 0
  br i1 %6, label %for.body3.lr.ph, label %for.cond7.preheader
...
for.body3.prol.loopexit:                          ; preds = %for.body3.prol.loopexit.loopexit, %for.body3.lr.ph
  ...
  %10 = icmp ult i32 %sub74, 7
  br i1 %10, label %for.cond7.preheader, label %for.body3.preheader
...
for.cond10.preheader.us:                          ; preds = %for.cond10.preheader.us.preheader, %for.cond10.for.inc34_crit_edge.us
  ...
  br i1 %11, label %for.body12.us.prol.loopexit, label %for.body12.us.prol
...
for.body12.us.prol.loopexit:                      ; preds = %for.body12.us.prol, %for.cond10.preheader.us
  ...
  %17 = icmp eq i32 %sub74, 0
  br i1 %17, label %for.cond10.for.inc34_crit_edge.us, label %for.body12.us.preheader

for.body12.us.preheader:                          ; preds = %for.body12.us.prol.loopexit
  %18 = sub nsw i64 %3, %indvars.iv20.unr.ph
  %19 = lshr i64 %18, 1
  %20 = add nuw i64 %19, 1
  %min.iters.check125 = icmp ult i64 %20, 2
...
min.iters.checked126:                             ; preds = %for.body12.us.preheader
  %n.mod.vf127 = and i64 %20, 1
  %n.vec128 = sub i64 %20, %n.mod.vf127
...
vector.memcheck147:                               ; preds = %min.iters.checked126
  ...
  %21 = sub nsw i64 %4, %indvars.iv20.unr.ph
  %22 = and i64 %21, -2
  %23 = or i64 %indvars.iv20.unr.ph, %22
  %scevgep135 = getelementptr double, double* %scevgep134, i64 %23
  %scevgep138 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvar, i64 %indvars.iv20.unr.ph
  %scevgep141 = getelementptr double, double* %scevgep140, i64 %23
  ...
  %24 = or i64 %indvars.iv20.unr.ph, 2
  %25 = shl nuw i64 %19, 1
  %26 = add i64 %24, %25
  %27 = shl nuw nsw i64 %n.mod.vf127, 1
  %ind.end152 = sub i64 %26, %27
...
vector.body122:                                   ; preds = %vector.body122.preheader, %vector.body122
  ...
  %28 = shl i64 %index149, 1
  %offset.idx154 = or i64 %indvars.iv20.unr.ph, %28
  %29 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv26, i64 %offset.idx154
  %30 = bitcast double* %29 to <4 x double>*
  %wide.vec158 = load <4 x double>, <4 x double>* %30, align 8, !alias.scope !4, !noalias !7
  ...
  %31 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv26, i64 %offset.idx154
  %32 = bitcast double* %31 to <4 x double>*
  %wide.vec161 = load <4 x double>, <4 x double>* %32, align 8, !alias.scope !7
  %33 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %13, i64 %offset.idx154
  %34 = bitcast double* %33 to <4 x double>*
  %wide.vec164 = load <4 x double>, <4 x double>* %34, align 8, !alias.scope !7
  %35 = fsub <4 x double> %wide.vec161, %wide.vec164
  ...
  %38 = fsub <2 x double> %strided.vec159, %37
  %39 = add nuw nsw i64 %offset.idx154, 1
  %40 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv26, i64 %39
  %41 = fsub <4 x double> %wide.vec161, %wide.vec164
  %42 = shufflevector <4 x double> %41, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %43 = fmul <2 x double> %42, <double 5.000000e-01, double 5.000000e-01>
  %44 = fsub <2 x double> %strided.vec160, %43
  %45 = getelementptr double, double* %40, i64 -1
  %46 = bitcast double* %45 to <4 x double>*
  %interleaved.vec167 = shufflevector <2 x double> %38, <2 x double> %44, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec167, <4 x double>* %46, align 8, !alias.scope !4, !noalias !7
  %index.next150 = add i64 %index149, 2
  %47 = icmp eq i64 %index.next150, %n.vec128
  br i1 %47, label %middle.block123, label %vector.body122, !llvm.loop !9
...
for.cond40.preheader.us:                          ; preds = %for.cond40.preheader.us.preheader, %for.cond40.for.inc66_crit_edge.us
  ...
  br i1 %70, label %for.body42.us.prol.loopexit, label %for.body42.us.prol
...
for.body42.us.prol.loopexit:                      ; preds = %for.body42.us.prol, %for.cond40.preheader.us
  ...
  %74 = icmp eq i32 %ny, 2
  br i1 %74, label %for.cond40.for.inc66_crit_edge.us, label %for.body42.us.preheader

for.body42.us.preheader:                          ; preds = %for.body42.us.prol.loopexit
  %75 = sub nsw i64 %1, %indvars.iv31.unr.ph
  %76 = lshr i64 %75, 1
  %77 = add nuw i64 %76, 1
  %min.iters.check84 = icmp ult i64 %77, 2
...
min.iters.checked85:                              ; preds = %for.body42.us.preheader
  %n.mod.vf86 = and i64 %77, 1
  %n.vec87 = sub i64 %77, %n.mod.vf86
...
vector.memcheck106:                               ; preds = %min.iters.checked85
  ...
  %78 = sub nsw i64 %2, %indvars.iv31.unr.ph
  %79 = and i64 %78, -2
  %80 = add nsw i64 %indvars.iv31.unr.ph, %79
  %scevgep94 = getelementptr double, double* %scevgep93, i64 %80
  %scevgep97 = getelementptr double, double* %scevgep96, i64 %indvars.iv31.unr.ph
  %scevgep100 = getelementptr double, double* %scevgep99, i64 %80
  ...
  %81 = add nuw nsw i64 %indvars.iv31.unr.ph, 2
  %82 = shl nuw i64 %76, 1
  %83 = add i64 %81, %82
  %84 = shl nuw nsw i64 %n.mod.vf86, 1
...
vector.body81:                                    ; preds = %vector.body81.preheader, %vector.body81
  ...
  %85 = shl i64 %index108, 1
  %offset.idx = or i64 %indvars.iv31.unr.ph, %85
  %86 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv38, i64 %offset.idx
  %87 = bitcast double* %86 to <4 x double>*
  %wide.vec = load <4 x double>, <4 x double>* %87, align 8, !alias.scope !13, !noalias !16
  %strided.vec = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %strided.vec115 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %88 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv38, i64 %offset.idx
  %89 = getelementptr double, double* %88, i64 -1
  %90 = bitcast double* %89 to <4 x double>*
  %wide.vec116 = load <4 x double>, <4 x double>* %90, align 8, !alias.scope !16
  ...
  %91 = fsub <2 x double> %strided.vec118, %strided.vec117
  %92 = fmul <2 x double> %91, <double 5.000000e-01, double 5.000000e-01>
  %93 = fsub <2 x double> %strided.vec, %92
  %94 = add nuw nsw i64 %offset.idx, 1
  %95 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv38, i64 %94
  %96 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv38, i64 %94
  %97 = getelementptr double, double* %96, i64 -1
  %98 = bitcast double* %97 to <4 x double>*
  %wide.vec119 = load <4 x double>, <4 x double>* %98, align 8, !alias.scope !16
  ...
  %99 = fsub <2 x double> %strided.vec121, %strided.vec120
  %100 = fmul <2 x double> %99, <double 5.000000e-01, double 5.000000e-01>
  %101 = fsub <2 x double> %strided.vec115, %100
  %102 = getelementptr double, double* %95, i64 -1
  %103 = bitcast double* %102 to <4 x double>*
  %interleaved.vec = shufflevector <2 x double> %93, <2 x double> %101, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec, <4 x double>* %103, align 8, !alias.scope !13, !noalias !16
  %index.next109 = add i64 %index108, 2
  %104 = icmp eq i64 %index.next109, %n.vec87
  br i1 %104, label %middle.block82, label %vector.body81, !llvm.loop !18
...
for.body42.us:                                    ; preds = %for.body42.us.preheader168, %for.body42.us
  ...
  %105 = load double, double* %arrayidx46.us, align 8
  %arrayidx50.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv38, i64 %indvars.iv31
  %106 = load double, double* %arrayidx50.us, align 8
  %107 = add nsw i64 %indvars.iv31, -1
  %arrayidx55.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv38, i64 %107
  %108 = load double, double* %arrayidx55.us, align 8
  %sub56.us = fsub double %106, %108
  %mul57.us = fmul double %sub56.us, 5.000000e-01
  %sub58.us = fsub double %105, %mul57.us
...
for.cond73.preheader.us:                          ; preds = %for.cond73.preheader.us.preheader, %for.cond73.for.inc110_crit_edge.us
  ...
  %113 = add i64 %indvars.iv47, 1
  %scevgep66 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %113, i64 %wide.trip.count45
  %indvars.iv.next48 = add nuw nsw i64 %indvars.iv47, 1
  br i1 %112, label %for.body76.us.preheader, label %min.iters.checked

min.iters.checked:                                ; preds = %for.cond73.preheader.us
  %114 = icmp eq i64 %n.vec, 0
  br i1 %114, label %for.body76.us.preheader, label %vector.memcheck
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %115 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv47, i64 %index
  %116 = bitcast double* %115 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %116, align 8, !alias.scope !20, !noalias !23
  %117 = getelementptr double, double* %115, i64 2
  %118 = bitcast double* %117 to <2 x double>*
  %wide.load72 = load <2 x double>, <2 x double>* %118, align 8, !alias.scope !20, !noalias !23
  %119 = or i64 %index, 1
  %120 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv47, i64 %119
  %121 = bitcast double* %120 to <2 x double>*
  %wide.load73 = load <2 x double>, <2 x double>* %121, align 8, !alias.scope !26
  %122 = getelementptr double, double* %120, i64 2
  %123 = bitcast double* %122 to <2 x double>*
  %wide.load74 = load <2 x double>, <2 x double>* %123, align 8, !alias.scope !26
  %124 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv47, i64 %index
  %125 = bitcast double* %124 to <2 x double>*
  %wide.load75 = load <2 x double>, <2 x double>* %125, align 8, !alias.scope !26
  %126 = getelementptr double, double* %124, i64 2
  %127 = bitcast double* %126 to <2 x double>*
  %wide.load76 = load <2 x double>, <2 x double>* %127, align 8, !alias.scope !26
  %128 = fsub <2 x double> %wide.load73, %wide.load75
  %129 = fsub <2 x double> %wide.load74, %wide.load76
  %130 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv.next48, i64 %index
  %131 = bitcast double* %130 to <2 x double>*
  %wide.load77 = load <2 x double>, <2 x double>* %131, align 8, !alias.scope !27
  %132 = getelementptr double, double* %130, i64 2
  %133 = bitcast double* %132 to <2 x double>*
  %wide.load78 = load <2 x double>, <2 x double>* %133, align 8, !alias.scope !27
  %134 = fadd <2 x double> %128, %wide.load77
  %135 = fadd <2 x double> %129, %wide.load78
  %136 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv47, i64 %index
  %137 = bitcast double* %136 to <2 x double>*
  %wide.load79 = load <2 x double>, <2 x double>* %137, align 8, !alias.scope !27
  %138 = getelementptr double, double* %136, i64 2
  %139 = bitcast double* %138 to <2 x double>*
  %wide.load80 = load <2 x double>, <2 x double>* %139, align 8, !alias.scope !27
  %140 = fsub <2 x double> %134, %wide.load79
  %141 = fsub <2 x double> %135, %wide.load80
  ...
  %145 = fsub <2 x double> %wide.load72, %143
  %146 = bitcast double* %115 to <2 x double>*
  store <2 x double> %144, <2 x double>* %146, align 8, !alias.scope !20, !noalias !23
  %147 = bitcast double* %117 to <2 x double>*
  store <2 x double> %145, <2 x double>* %147, align 8, !alias.scope !20, !noalias !23
  %index.next = add i64 %index, 4
  %148 = icmp eq i64 %index.next, %n.vec
  br i1 %148, label %middle.block, label %vector.body, !llvm.loop !28

middle.block:                                     ; preds = %vector.body
  %149 = icmp eq i32 %5, 0
  br i1 %149, label %for.cond73.for.inc110_crit_edge.us, label %for.body76.us.preheader
