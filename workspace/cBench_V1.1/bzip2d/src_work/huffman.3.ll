...
@__llvm_prf_nm = private constant [61 x i8] c"@;x\DAs\8A2\8A\CFH\F2M\CCNu\CEOI\F5I\CDK/\C9(ft\02\8B:\16\17g\A6\E7\81\C4a\22\CEE\A9\89%\A9.\A9\C9@\B1\90\C4\A4\9C\D4b\00\DC\92\16\FC", section "__llvm_prf_names"
@llvm.used = appending global [4 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_BZ2_hbMakeCodeLengths to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_BZ2_hbAssignCodes to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_BZ2_hbCreateDecodeTables to i8*), i8* getelementptr inbounds ([61 x i8], [61 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
