...
._crit_edge:                                      ; preds = %._crit_edge, %.preheader
  %indvars.iv5 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %._crit_edge ]
...
; <label>:14:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond4, label %15, label %.preheader
...
.preheader4:                                      ; preds = %155, %4
  %.0325 = phi i32 [ 1, %4 ], [ %156, %155 ]
  br label %._crit_edge.lver.check

._crit_edge.lver.check:                           ; preds = %74, %.preheader4
  %indvar = phi i64 [ %5, %74 ], [ 0, %.preheader4 ]
  %indvars.iv721 = phi i64 [ %13, %74 ], [ 1, %.preheader4 ]
  %5 = add i64 %indvar, 1
  ...
  %6 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 0, i64 %indvars.iv721
  store double 1.000000e+00, double* %6, align 8
  %7 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv721, i64 0
  store double 0.000000e+00, double* %7, align 8
  %8 = bitcast double* %6 to i64*
  %9 = load i64, i64* %8, align 8
  %10 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv721
  %11 = bitcast [1000 x double]* %10 to i64*
  store i64 %9, i64* %11, align 8
  %12 = add nsw i64 %indvars.iv721, -1
  %13 = add nuw nsw i64 %indvars.iv721, 1
...
._crit_edge.lver.orig:                            ; preds = %._crit_edge.lver.orig.preheader, %._crit_edge.lver.orig
  %indvars.iv19.lver.orig = phi i64 [ %indvars.iv.next.lver.orig, %._crit_edge.lver.orig ], [ 1, %._crit_edge.lver.orig.preheader ]
  %14 = add nsw i64 %indvars.iv19.lver.orig, -1
  %15 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv721, i64 %14
  %16 = load double, double* %15, align 8
  %17 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv721, i64 %indvars.iv19.lver.orig
  %18 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv19.lver.orig, i64 %12
  %19 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv19.lver.orig, i64 %13
  %20 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv721, i64 %14
  ...
  %36 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv721, i64 %indvars.iv19.lver.orig
  store double %35, double* %36, align 8
  %indvars.iv.next.lver.orig = add nuw nsw i64 %indvars.iv19.lver.orig, 1
  %exitcond.lver.orig = icmp eq i64 %indvars.iv.next.lver.orig, 999
  br i1 %exitcond.lver.orig, label %.loopexit33, label %._crit_edge.lver.orig
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge.ph
  %store_forwarded11 = phi double [ %load_initial10, %._crit_edge.ph ], [ %53, %._crit_edge ]
  %store_forwarded = phi double [ %load_initial, %._crit_edge.ph ], [ %41, %._crit_edge ]
  %indvars.iv19 = phi i64 [ 1, %._crit_edge.ph ], [ %indvars.iv.next, %._crit_edge ]
  %37 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv721, i64 %indvars.iv19
  %38 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv19, i64 %12
  %39 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv19, i64 %13
  ...
  %51 = fmul double %store_forwarded11, 0xC09F400000000001
  %52 = fsub double %50, %51
  %53 = fdiv double %52, %40
  %54 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv721, i64 %indvars.iv19
  store double %53, double* %54, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv19, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 999
  br i1 %exitcond, label %.loopexit34, label %._crit_edge

.loopexit33:                                      ; preds = %._crit_edge.lver.orig
  br label %55

.loopexit34:                                      ; preds = %._crit_edge
  br label %55

; <label>:55:                                     ; preds = %.loopexit34, %.loopexit33
  %56 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 999, i64 %indvars.iv721
  store double 1.000000e+00, double* %56, align 8
  br label %57

; <label>:57:                                     ; preds = %57, %55
  %58 = phi double [ 1.000000e+00, %55 ], [ %71, %57 ]
  %indvars.iv520 = phi i64 [ 998, %55 ], [ %indvars.iv.next6.1, %57 ]
  %59 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv721, i64 %indvars.iv520
  %60 = load double, double* %59, align 8
  %61 = fmul double %60, %58
  %62 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv721, i64 %indvars.iv520
  %63 = load double, double* %62, align 8
  %64 = fadd double %61, %63
  %65 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv520, i64 %indvars.iv721
  store double %64, double* %65, align 8
  %indvars.iv.next6 = add nsw i64 %indvars.iv520, -1
  %66 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv721, i64 %indvars.iv.next6
  %67 = load double, double* %66, align 8
  %68 = fmul double %67, %64
  %69 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv721, i64 %indvars.iv.next6
  %70 = load double, double* %69, align 8
  %71 = fadd double %68, %70
  %72 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv.next6, i64 %indvars.iv721
  store double %71, double* %72, align 8
  %73 = icmp sgt i64 %indvars.iv.next6, 1
  %indvars.iv.next6.1 = add nsw i64 %indvars.iv520, -2
  br i1 %73, label %57, label %74

; <label>:74:                                     ; preds = %57
  %exitcond9 = icmp eq i64 %13, 999
  br i1 %exitcond9, label %._crit_edge28.lver.check.preheader, label %._crit_edge.lver.check

._crit_edge28.lver.check.preheader:               ; preds = %74
  br label %._crit_edge28.lver.check

._crit_edge28.lver.check:                         ; preds = %._crit_edge28.lver.check.preheader, %154
  %indvar12 = phi i64 [ %75, %154 ], [ 0, %._crit_edge28.lver.check.preheader ]
  %indvars.iv1524 = phi i64 [ %83, %154 ], [ 1, %._crit_edge28.lver.check.preheader ]
  ...
  %76 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv1524, i64 0
  store double 1.000000e+00, double* %76, align 8
  %77 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv1524, i64 0
  store double 0.000000e+00, double* %77, align 8
  %78 = bitcast double* %76 to i64*
  %79 = load i64, i64* %78, align 8
  %80 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv1524
  %81 = bitcast [1000 x double]* %80 to i64*
  store i64 %79, i64* %81, align 8
  %82 = add nsw i64 %indvars.iv1524, -1
  %83 = add nuw nsw i64 %indvars.iv1524, 1
  ...
  br i1 %memcheck.conflict25, label %._crit_edge28.lver.orig.preheader, label %._crit_edge28.ph
...
._crit_edge28.lver.orig:                          ; preds = %._crit_edge28.lver.orig.preheader, %._crit_edge28.lver.orig
  %indvars.iv1022.lver.orig = phi i64 [ %indvars.iv.next11.lver.orig, %._crit_edge28.lver.orig ], [ 1, %._crit_edge28.lver.orig.preheader ]
  %84 = add nsw i64 %indvars.iv1022.lver.orig, -1
  %85 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv1524, i64 %84
  %86 = load double, double* %85, align 8
  %87 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv1524, i64 %indvars.iv1022.lver.orig
  %88 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %82, i64 %indvars.iv1022.lver.orig
  %89 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv1524, i64 %indvars.iv1022.lver.orig
  %90 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %83, i64 %indvars.iv1022.lver.orig
  %91 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv1524, i64 %84
  ...
  %111 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv1524, i64 %indvars.iv1022.lver.orig
  store double %110, double* %111, align 8
  %indvars.iv.next11.lver.orig = add nuw nsw i64 %indvars.iv1022.lver.orig, 1
  %exitcond12.lver.orig = icmp eq i64 %indvars.iv.next11.lver.orig, 999
  br i1 %exitcond12.lver.orig, label %.loopexit, label %._crit_edge28.lver.orig
...
._crit_edge28:                                    ; preds = %._crit_edge28, %._crit_edge28.ph
  %store_forwarded31 = phi double [ %load_initial30, %._crit_edge28.ph ], [ %133, %._crit_edge28 ]
  %store_forwarded28 = phi double [ %load_initial27, %._crit_edge28.ph ], [ %122, %._crit_edge28 ]
  %indvars.iv1022 = phi i64 [ 1, %._crit_edge28.ph ], [ %indvars.iv.next11, %._crit_edge28 ]
  %112 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv1524, i64 %indvars.iv1022
  %113 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %82, i64 %indvars.iv1022
  %114 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv1524, i64 %indvars.iv1022
  %115 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %83, i64 %indvars.iv1022
  %116 = insertelement <2 x double> undef, double %store_forwarded28, i32 0
  ...
  %131 = fmul double %store_forwarded31, 0xC08F400000000001
  %132 = fsub double %130, %131
  %133 = fdiv double %132, %121
  %134 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv1524, i64 %indvars.iv1022
  ...
  br i1 %exitcond12, label %.loopexit32, label %._crit_edge28

.loopexit:                                        ; preds = %._crit_edge28.lver.orig
  br label %135

.loopexit32:                                      ; preds = %._crit_edge28
  br label %135

; <label>:135:                                    ; preds = %.loopexit32, %.loopexit
  %136 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv1524, i64 999
  store double 1.000000e+00, double* %136, align 8
  br label %137

; <label>:137:                                    ; preds = %137, %135
  %138 = phi double [ 1.000000e+00, %135 ], [ %151, %137 ]
  %indvars.iv1323 = phi i64 [ 998, %135 ], [ %indvars.iv.next14.1, %137 ]
  %139 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv1524, i64 %indvars.iv1323
  %140 = load double, double* %139, align 8
  %141 = fmul double %140, %138
  %142 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv1524, i64 %indvars.iv1323
  %143 = load double, double* %142, align 8
  %144 = fadd double %141, %143
  %145 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv1524, i64 %indvars.iv1323
  store double %144, double* %145, align 8
  %indvars.iv.next14 = add nsw i64 %indvars.iv1323, -1
  %146 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv1524, i64 %indvars.iv.next14
  %147 = load double, double* %146, align 8
  %148 = fmul double %147, %144
  %149 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv1524, i64 %indvars.iv.next14
  %150 = load double, double* %149, align 8
  %151 = fadd double %148, %150
  %152 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv1524, i64 %indvars.iv.next14
  store double %151, double* %152, align 8
  %153 = icmp sgt i64 %indvars.iv.next14, 1
  %indvars.iv.next14.1 = add nsw i64 %indvars.iv1323, -2
  br i1 %153, label %137, label %154

; <label>:154:                                    ; preds = %137
  %exitcond17 = icmp eq i64 %83, 999
  br i1 %exitcond17, label %155, label %._crit_edge28.lver.check

; <label>:155:                                    ; preds = %154
  %156 = add nuw nsw i32 %.0325, 1
  %exitcond18 = icmp eq i32 %156, 501
  br i1 %exitcond18, label %157, label %.preheader4
...
._crit_edge7:                                     ; preds = %._crit_edge, %.preheader
  %indvars.iv5 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %._crit_edge ]
