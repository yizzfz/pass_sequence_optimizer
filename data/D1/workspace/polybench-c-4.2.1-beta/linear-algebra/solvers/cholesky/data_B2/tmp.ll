...
define internal void @kernel_cholesky(i32, [2000 x double]*) #0 {
  %3 = icmp sgt i32 %0, 0
  br i1 %3, label %.preheader36.preheader, label %._crit_edge45
...
.preheader36:                                     ; preds = %.preheader36.preheader, %._crit_edge42
  ...
  %4 = add i64 %indvars.iv66, -2
  %5 = add i64 %indvars.iv66, 4294967295
  %6 = icmp sgt i64 %indvars.iv66, 0
  br i1 %6, label %.preheader.preheader, label %._crit_edge42

.preheader.preheader:                             ; preds = %.preheader36
  %7 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv66, i64 0
  br label %.preheader

.preheader35:                                     ; preds = %._crit_edge
  %8 = icmp sgt i64 %indvars.iv66, 0
  br i1 %8, label %.lr.ph41, label %._crit_edge42

.lr.ph41:                                         ; preds = %.preheader35
  %9 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv66, i64 %indvars.iv66
...
.prol.preheader60:                                ; preds = %.lr.ph41
  %10 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv66, i64 0
...
.prol.loopexit61:                                 ; preds = %.prol.preheader60, %.lr.ph41
  ...
  %16 = icmp eq i32 %15, 0
  br i1 %16, label %._crit_edge42, label %.lr.ph41.new.preheader

.lr.ph41.new.preheader:                           ; preds = %.prol.loopexit61
  %17 = sub i64 %4, %indvars.iv55.unr.ph
  %18 = lshr i64 %17, 1
  %19 = and i64 %18, 1
  %lcmp.mod72 = icmp eq i64 %19, 0
...
.lr.ph41.new.prol:                                ; preds = %.lr.ph41.new.prol.preheader
  %20 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv66, i64 %indvars.iv55.unr.ph
  ...
  %25 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv66, i64 %indvars.iv.next56.prol
...
.lr.ph41.new.prol.loopexit:                       ; preds = %.lr.ph41.new.prol.loopexit.unr-lcssa
  %29 = icmp eq i64 %18, 0
  br i1 %29, label %._crit_edge42.loopexit, label %.lr.ph41.new.preheader.new
...
.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge
  ...
  %30 = add i64 %indvars.iv50, 4294967295
  %31 = icmp sgt i64 %indvars.iv50, 0
  br i1 %31, label %.lr.ph, label %._crit_edge

.lr.ph:                                           ; preds = %.preheader
  %32 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv66, i64 %indvars.iv50
...
.prol.preheader:                                  ; preds = %.lr.ph
  ...
  %34 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv50, i64 0
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %41 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv66, i64 %indvars.iv
  %42 = load double, double* %41, align 8
  %43 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv50, i64 %indvars.iv
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %48 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv66, i64 %indvars.iv.next
  %49 = load double, double* %48, align 8
  %50 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv50, i64 %indvars.iv.next
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %.preheader
  %55 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv50, i64 %indvars.iv50
  %56 = load double, double* %55, align 8
  %57 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv66, i64 %indvars.iv50
  %58 = load double, double* %57, align 8
...
.lr.ph41.new:                                     ; preds = %.lr.ph41.new, %.lr.ph41.new.preheader.new
  ...
  %60 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv66, i64 %indvars.iv55
  %61 = load double, double* %60, align 8
  ...
  %65 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv66, i64 %indvars.iv.next56
  %66 = load double, double* %65, align 8
  %67 = fmul double %66, %66
  %68 = fsub double %64, %67
  store double %68, double* %9, align 8
  %indvars.iv.next56.1 = add nsw i64 %indvars.iv55, 2
  %69 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv66, i64 %indvars.iv.next56.1
  %70 = load double, double* %69, align 8
  %71 = fmul double %70, %70
  %72 = fsub double %68, %71
  store double %72, double* %9, align 8
  %indvars.iv.next56.174 = add nsw i64 %indvars.iv55, 3
  %73 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv66, i64 %indvars.iv.next56.174
...
._crit_edge42:                                    ; preds = %._crit_edge42.loopexit, %.preheader36, %.prol.loopexit61, %.preheader35
  %77 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv66, i64 %indvars.iv66
  ...
  br i1 %exitcond69, label %._crit_edge45.loopexit, label %.preheader36
