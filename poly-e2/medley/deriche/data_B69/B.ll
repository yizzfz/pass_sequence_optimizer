...
for.cond31.preheader.us:                          ; preds = %for.cond31.for.inc55_crit_edge.us, %for.cond31.preheader.us.preheader
  %indvars.iv2165.us = phi i64 [ 0, %for.cond31.preheader.us.preheader ], [ %indvars.iv.next22.us, %for.cond31.for.inc55_crit_edge.us ]
  %arrayidx35.us38 = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv2165.us, i64 0
  %1 = load float, float* %arrayidx35.us38, align 4
  %mul36.us39 = fmul float %div, %1
  ...
  %arrayidx46.us46 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv2165.us, i64 0
...
for.body33.us.for.body33.us_crit_edge:            ; preds = %for.body33.us.for.body33.us_crit_edge.1, %for.cond31.preheader.us
  ...
  %indvars.iv1960.us48 = phi i64 [ 0, %for.cond31.preheader.us ], [ %indvars.iv.next20.us.1, %for.body33.us.for.body33.us_crit_edge.1 ]
  %ym1.061.us47 = phi float [ 0.000000e+00, %for.cond31.preheader.us ], [ %add42.us, %for.body33.us.for.body33.us_crit_edge.1 ]
  %indvars.iv.next20.us = or i64 %indvars.iv1960.us48, 1
  %2 = load float, float* %arrayidx35.us49, align 4
  %arrayidx35.us = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv2165.us, i64 %indvars.iv.next20.us
  %3 = load float, float* %arrayidx35.us, align 4
  %mul36.us = fmul float %div, %3
  %mul37.us = fmul float %mul16.v.r1, %2
  %add38.us = fadd float %mul37.us, %mul36.us
  %mul39.us = fmul float %exp2, %add42.us50
  %add40.us = fadd float %mul39.us, %add38.us
  %mul41.us = fmul float %ym1.061.us47, %sub30
  %add42.us = fadd float %mul41.us, %add40.us
  %arrayidx46.us = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv2165.us, i64 %indvars.iv.next20.us
  store float %add42.us, float* %arrayidx46.us, align 4
  %exitcond80 = icmp eq i64 %indvars.iv.next20.us, 2159
  br i1 %exitcond80, label %for.cond31.for.inc55_crit_edge.us, label %for.body33.us.for.body33.us_crit_edge.1
...
for.cond62.preheader.us.preheader:                ; preds = %for.cond31.for.inc55_crit_edge.us
  %4 = fmul float %div, %call24
  %mul25 = fsub float -0.000000e+00, %4
  %mul65.us26 = fmul float %mul16.v.r2, 0.000000e+00
  %mul66.us27 = fmul float %4, -0.000000e+00
...
for.cond62.preheader.us:                          ; preds = %for.cond62.for.inc86_crit_edge.us, %for.cond62.preheader.us.preheader
  %indvars.iv1757.us = phi i64 [ 0, %for.cond62.preheader.us.preheader ], [ %indvars.iv.next18.us, %for.cond62.for.inc86_crit_edge.us ]
  %arrayidx75.us33 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv1757.us, i64 2159
...
for.body64.us.for.body64.us_crit_edge:            ; preds = %for.body64.us.for.body64.us_crit_edge.1, %for.cond62.preheader.us
  ...
  %indvars.iv1551.us36 = phi i64 [ 2159, %for.cond62.preheader.us ], [ %indvars.iv.next16.us.1, %for.body64.us.for.body64.us_crit_edge.1 ]
  %xp1.052.us35 = phi float [ 0.000000e+00, %for.cond62.preheader.us ], [ %85, %for.body64.us.for.body64.us_crit_edge.1 ]
  %yp1.054.us34 = phi float [ 0.000000e+00, %for.cond62.preheader.us ], [ %add71.us, %for.body64.us.for.body64.us_crit_edge.1 ]
  %indvars.iv.next16.us = add nsw i64 %indvars.iv1551.us36, -1
  %arrayidx79.us = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv1757.us, i64 %indvars.iv1551.us36
  %5 = load float, float* %arrayidx79.us, align 4
  %mul65.us = fmul float %mul16.v.r2, %5
  %mul66.us = fmul float %xp1.052.us35, %mul25
  %add67.us = fadd float %mul65.us, %mul66.us
  %mul68.us = fmul float %exp2, %add71.us37
  %add69.us = fadd float %add67.us, %mul68.us
  %mul70.us = fmul float %yp1.054.us34, %sub30
  %add71.us = fadd float %add69.us, %mul70.us
  %arrayidx75.us = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv1757.us, i64 %indvars.iv.next16.us
  store float %add71.us, float* %arrayidx75.us, align 4
  %cmp63.us = icmp sgt i64 %indvars.iv1551.us36, 1
...
for.cond92.preheader.us:                          ; preds = %for.cond92.preheader.us.preheader, %for.cond92.for.inc112_crit_edge.us
  %indvars.iv1348.us = phi i64 [ %indvars.iv.next14.us, %for.cond92.for.inc112_crit_edge.us ], [ 0, %for.cond92.preheader.us.preheader ]
  %scevgep = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv1348.us, i64 0
  %6 = add i64 %indvars.iv1348.us, 1
  %scevgep52 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %6, i64 0
  %scevgep54 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv1348.us, i64 0
  %scevgep56 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %6, i64 0
  %scevgep58 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv1348.us, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %7 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv1348.us, i64 %index
  %8 = bitcast float* %7 to <4 x float>*
  ...
  %11 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv1348.us, i64 %index
  ...
  %17 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv1348.us, i64 %index
  ...
  %21 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv1348.us, i64 %index.next
  ...
  %25 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv1348.us, i64 %index.next
  ...
  %31 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv1348.us, i64 %index.next
...
for.body94.us:                                    ; preds = %for.body94.us, %for.body94.us.preheader
  %indvars.iv1146.us = phi i64 [ 0, %for.body94.us.preheader ], [ %indvars.iv.next12.us.2, %for.body94.us ]
  ...
  %arrayidx98.us.2 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv1348.us, i64 %indvars.iv.next12.us.1
  %40 = load float, float* %arrayidx98.us.2, align 4
  %arrayidx102.us.2 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv1348.us, i64 %indvars.iv.next12.us.1
  %41 = load float, float* %arrayidx102.us.2, align 4
  %add103.us.2 = fadd float %40, %41
  %arrayidx108.us.2 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv1348.us, i64 %indvars.iv.next12.us.1
  store float %add103.us.2, float* %arrayidx108.us.2, align 4
  %exitcond77.2 = icmp eq i64 %indvars.iv.next12.us.1, 2159
  %indvars.iv.next12.us.2 = add nsw i64 %indvars.iv1146.us, 3
  br i1 %exitcond77.2, label %for.cond92.for.inc112_crit_edge.us.loopexit, label %for.body94.us, !llvm.loop !13
...
for.cond118.preheader.us:                         ; preds = %for.cond118.preheader.us.preheader, %for.cond118.for.inc147_crit_edge.us
  %indvars.iv943.us = phi i64 [ %indvars.iv.next10.us, %for.cond118.for.inc147_crit_edge.us ], [ 0, %for.cond118.preheader.us.preheader ]
  %arrayidx124.us13 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 0, i64 %indvars.iv943.us
  ...
  %arrayidx135.us21 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 0, i64 %indvars.iv943.us
...
for.body120.us.for.body120.us_crit_edge:          ; preds = %for.body120.us.for.body120.us_crit_edge.1, %for.cond118.preheader.us
  ...
  %indvars.iv738.us23 = phi i64 [ 0, %for.cond118.preheader.us ], [ %indvars.iv.next8.us.1, %for.body120.us.for.body120.us_crit_edge.1 ]
  %ym1.139.us22 = phi float [ 0.000000e+00, %for.cond118.preheader.us ], [ %add131.us, %for.body120.us.for.body120.us_crit_edge.1 ]
  %indvars.iv.next8.us = or i64 %indvars.iv738.us23, 1
  %43 = load float, float* %arrayidx124.us24, align 4
  %arrayidx124.us = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv.next8.us, i64 %indvars.iv943.us
  ...
  %mul130.us = fmul float %ym1.139.us22, %sub30
  %add131.us = fadd float %mul130.us, %add129.us
  %arrayidx135.us = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv.next8.us, i64 %indvars.iv943.us
  store float %add131.us, float* %arrayidx135.us, align 4
  %exitcond75 = icmp eq i64 %indvars.iv.next8.us, 4095
  br i1 %exitcond75, label %for.cond118.for.inc147_crit_edge.us, label %for.body120.us.for.body120.us_crit_edge.1
...
for.cond154.preheader.us.preheader:               ; preds = %for.cond118.for.inc147_crit_edge.us
  ...
  %mul158.us2 = fmul float %4, -0.000000e+00
...
for.cond154.preheader.us:                         ; preds = %for.cond154.preheader.us.preheader, %for.cond154.for.inc179_crit_edge.us
  %indvars.iv535.us = phi i64 [ %indvars.iv.next6.us, %for.cond154.for.inc179_crit_edge.us ], [ 0, %for.cond154.preheader.us.preheader ]
  %arrayidx167.us8 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 4095, i64 %indvars.iv535.us
...
for.body156.us.for.body156.us_crit_edge:          ; preds = %for.body156.us.for.body156.us_crit_edge.1, %for.cond154.preheader.us
  ...
  %indvars.iv329.us11 = phi i64 [ 4095, %for.cond154.preheader.us ], [ %indvars.iv.next4.us.1, %for.body156.us.for.body156.us_crit_edge.1 ]
  %tp1.030.us10 = phi float [ 0.000000e+00, %for.cond154.preheader.us ], [ %82, %for.body156.us.for.body156.us_crit_edge.1 ]
  %yp1.132.us9 = phi float [ 0.000000e+00, %for.cond154.preheader.us ], [ %add163.us, %for.body156.us.for.body156.us_crit_edge.1 ]
  %indvars.iv.next4.us = add nsw i64 %indvars.iv329.us11, -1
  %arrayidx171.us = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv329.us11, i64 %indvars.iv535.us
  ...
  %arrayidx167.us = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv.next4.us, i64 %indvars.iv535.us
  store float %add163.us, float* %arrayidx167.us, align 4
  %cmp155.us = icmp sgt i64 %indvars.iv329.us11, 1
...
for.cond185.preheader.us:                         ; preds = %for.cond185.preheader.us.preheader, %for.cond185.for.inc205_crit_edge.us
  %indvars.iv126.us = phi i64 [ %indvars.iv.next2.us, %for.cond185.for.inc205_crit_edge.us ], [ 0, %for.cond185.preheader.us.preheader ]
  %scevgep74 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv126.us, i64 0
  %46 = add i64 %indvars.iv126.us, 1
...
vector.body69:                                    ; preds = %vector.body69, %vector.body69.preheader
  ...
  %47 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv126.us, i64 %index96
  ...
  %51 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv126.us, i64 %index96
  ...
  %57 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv126.us, i64 %index96
  ...
  %61 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv126.us, i64 %index.next97
  ...
  %65 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv126.us, i64 %index.next97
  ...
  %71 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv126.us, i64 %index.next97
...
for.body156.us.for.body156.us_crit_edge.1:        ; preds = %for.body156.us.for.body156.us_crit_edge
  %indvars.iv.next4.us.1 = add nsw i64 %indvars.iv329.us11, -2
  %arrayidx171.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv.next4.us, i64 %indvars.iv535.us
  ...
  %arrayidx167.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv.next4.us.1, i64 %indvars.iv535.us
...
for.body120.us.for.body120.us_crit_edge.1:        ; preds = %for.body120.us.for.body120.us_crit_edge
  %indvars.iv.next8.us.1 = add nsw i64 %indvars.iv738.us23, 2
  %83 = load float, float* %arrayidx124.us, align 4
  %arrayidx124.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv.next8.us.1, i64 %indvars.iv943.us
  ...
  %arrayidx135.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv.next8.us.1, i64 %indvars.iv943.us
...
for.body64.us.for.body64.us_crit_edge.1:          ; preds = %for.body64.us.for.body64.us_crit_edge
  %indvars.iv.next16.us.1 = add nsw i64 %indvars.iv1551.us36, -2
  %arrayidx79.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv1757.us, i64 %indvars.iv.next16.us
  ...
  %arrayidx75.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv1757.us, i64 %indvars.iv.next16.us.1
...
for.body33.us.for.body33.us_crit_edge.1:          ; preds = %for.body33.us.for.body33.us_crit_edge
  %indvars.iv.next20.us.1 = add nsw i64 %indvars.iv1960.us48, 2
  %86 = load float, float* %arrayidx35.us, align 4
  %arrayidx35.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv2165.us, i64 %indvars.iv.next20.us.1
  ...
  %arrayidx46.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv2165.us, i64 %indvars.iv.next20.us.1
