...
.preheader9:                                      ; preds = %.preheader9.loopexit, %12
  %43 = icmp sgt i32 %1, 0
  br i1 %43, label %.preheader8.lr.ph, label %.preheader7

.preheader8.lr.ph:                                ; preds = %.preheader9
  %44 = icmp sgt i32 %3, 0
  %45 = icmp sgt i32 %4, 0
  br i1 %44, label %.preheader8.us.preheader, label %.preheader7
...
.prol.loopexit79:                                 ; preds = %.prol.preheader78, %.lr.ph25.us.us
  ...
  br i1 %50, label %._crit_edge26.us.us, label %.lr.ph25.us.us.new.preheader
...
.preheader7:                                      ; preds = %.preheader7.loopexit, %.preheader8.lr.ph, %.preheader9
  %73 = icmp sgt i32 %0, 0
  br i1 %73, label %.preheader.lr.ph, label %._crit_edge16

.preheader.lr.ph:                                 ; preds = %.preheader10.lr.ph, %.preheader7
  %74 = icmp sgt i32 %3, 0
  %75 = icmp sgt i32 %1, 0
  br i1 %74, label %.preheader.us.preheader, label %._crit_edge16
