...
for.cond1.preheader.lr.ph:                        ; preds = %entry
  ...
  %13 = icmp eq i64 %xtraiter77, 0
  %14 = icmp ult i64 %4, 3
  %15 = icmp eq i64 %xtraiter75, 0
  %16 = icmp eq i32 %np, 1
  %sunkaddr = ptrtoint double* %sum to i64
  %17 = icmp eq i32 %nq, 1
  %xtraiter96 = and i64 %8, 7
  %lcmp.mod = icmp eq i64 %xtraiter96, 0
  %18 = icmp ult i64 %6, 14
...
for.cond4.preheader.preheader:                    ; preds = %for.cond4.preheader.lr.ph
  br i1 %17, label %for.inc42, label %for.inc39.1.preheader

for.inc39.1.preheader:                            ; preds = %for.cond4.preheader.preheader
  br i1 %lcmp.mod, label %for.inc39.1.prol.loopexit, label %for.inc39.1.prol.preheader

for.inc39.1.prol.preheader:                       ; preds = %for.inc39.1.preheader
  br label %for.inc39.1.prol

for.inc39.1.prol:                                 ; preds = %for.inc39.1.prol, %for.inc39.1.prol.preheader
  %indvars.iv2436.prol = phi i64 [ %indvars.iv.next25.1.prol, %for.inc39.1.prol ], [ %xtraiter, %for.inc39.1.prol.preheader ]
  %prol.iter97 = phi i64 [ %prol.iter97.sub, %for.inc39.1.prol ], [ %xtraiter96, %for.inc39.1.prol.preheader ]
  %indvars.iv.next25.1.prol = add nsw i64 %indvars.iv2436.prol, 2
  %prol.iter97.sub = add i64 %prol.iter97, -1
  %prol.iter97.cmp = icmp eq i64 %prol.iter97.sub, 0
  br i1 %prol.iter97.cmp, label %for.inc39.1.prol.loopexit.unr-lcssa, label %for.inc39.1.prol, !llvm.loop !1

for.inc39.1.prol.loopexit.unr-lcssa:              ; preds = %for.inc39.1.prol
  br label %for.inc39.1.prol.loopexit

for.inc39.1.prol.loopexit:                        ; preds = %for.inc39.1.preheader, %for.inc39.1.prol.loopexit.unr-lcssa
  %indvars.iv2436.unr = phi i64 [ %xtraiter, %for.inc39.1.preheader ], [ %indvars.iv.next25.1.prol, %for.inc39.1.prol.loopexit.unr-lcssa ]
  br i1 %18, label %for.inc42.loopexit95, label %for.inc39.1.preheader.new

for.inc39.1.preheader.new:                        ; preds = %for.inc39.1.prol.loopexit
...
for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.inc39.us
  ...
  br i1 %11, label %for.cond4.for.cond25.preheader_crit_edge.us.loopexit, label %for.body6.us40.preheader
...
for.inc36.us:                                     ; preds = %for.inc36.us.preheader94, %for.inc36.us
  %indvars.iv2234.us = phi i64 [ %indvars.iv.next23.us.3, %for.inc36.us ], [ %indvars.iv2234.us.unr, %for.inc36.us.preheader94 ]
...
for.body6.us40:                                   ; preds = %for.body6.us40.preheader, %for.cond7.for.inc22_crit_edge.us57
  ...
  br i1 %15, label %for.inc.us43.prol.loopexit, label %for.inc.us43.prol

for.inc.us43.prol:                                ; preds = %for.body6.us40
  %31 = load double, double* %arrayidx15.us45.prol, align 8
  %arrayidx19.us46.prol = getelementptr inbounds [160 x double], [160 x double]* %C4, i64 0, i64 %indvars.iv2031.us41
  %32 = load double, double* %arrayidx19.us46.prol, align 8
  %mul.us47.prol = fmul double %31, %32
  %add.us48.prol = fadd double %mul.us47.prol, 0.000000e+00
  %sunkaddr79 = shl i64 %indvars.iv2031.us41, 3
  %sunkaddr80 = add i64 %sunkaddr, %sunkaddr79
  %sunkaddr81 = inttoptr i64 %sunkaddr80 to double*
  store double %add.us48.prol, double* %sunkaddr81, align 8
  br label %for.inc.us43.prol.loopexit

for.inc.us43.prol.loopexit:                       ; preds = %for.inc.us43.prol, %for.body6.us40
  %.unr.ph = phi double [ %add.us48.prol, %for.inc.us43.prol ], [ 0.000000e+00, %for.body6.us40 ]
  %indvars.iv29.us44.unr.ph = phi i64 [ 1, %for.inc.us43.prol ], [ 0, %for.body6.us40 ]
  br i1 %16, label %for.cond7.for.inc22_crit_edge.us57, label %for.inc.us43.preheader

for.inc.us43.preheader:                           ; preds = %for.inc.us43.prol.loopexit
  %sunkaddr90 = shl i64 %indvars.iv2031.us41, 3
...
for.inc.us43:                                     ; preds = %for.inc.us43.preheader, %for.inc.us43
  %33 = phi double [ %add.us48.1, %for.inc.us43 ], [ %.unr.ph, %for.inc.us43.preheader ]
  ...
  %34 = load double, double* %arrayidx15.us45, align 8
  %arrayidx19.us46 = getelementptr inbounds [160 x double], [160 x double]* %C4, i64 %indvars.iv29.us44, i64 %indvars.iv2031.us41
  %35 = load double, double* %arrayidx19.us46, align 8
  %mul.us47 = fmul double %34, %35
  %add.us48 = fadd double %33, %mul.us47
  store double %add.us48, double* %sunkaddr92, align 8
  ...
  %36 = load double, double* %arrayidx15.us45.1, align 8
  %arrayidx19.us46.1 = getelementptr inbounds [160 x double], [160 x double]* %C4, i64 %indvars.iv.next.us49, i64 %indvars.iv2031.us41
  %37 = load double, double* %arrayidx19.us46.1, align 8
  %mul.us47.1 = fmul double %36, %37
  %add.us48.1 = fadd double %add.us48, %mul.us47.1
  store double %add.us48.1, double* %sunkaddr92, align 8
...
for.cond7.for.inc22_crit_edge.us57:               ; preds = %for.cond7.for.inc22_crit_edge.us57.loopexit, %for.inc.us43.prol.loopexit
  ...
  br i1 %exitcond67, label %for.inc36.us.preheader.loopexit, label %for.body6.us40
...
for.cond4.for.cond25.preheader_crit_edge.us.loopexit: ; preds = %for.cond4.preheader.us
  ...
  br label %for.inc36.us.preheader

for.inc36.us.preheader.loopexit:                  ; preds = %for.cond7.for.inc22_crit_edge.us57
  br label %for.inc36.us.preheader

for.inc36.us.preheader:                           ; preds = %for.inc36.us.preheader.loopexit, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit
...
for.inc36.us.prol:                                ; preds = %for.inc36.us.prol.preheader, %for.inc36.us.prol
  ...
  %prol.iter = phi i64 [ %prol.iter.sub, %for.inc36.us.prol ], [ %xtraiter77, %for.inc36.us.prol.preheader ]
  ...
  br i1 %prol.iter.cmp, label %for.inc36.us.prol.loopexit.loopexit, label %for.inc36.us.prol, !llvm.loop !3
...
for.inc36.us.prol.loopexit:                       ; preds = %for.inc36.us.prol.loopexit.loopexit, %for.inc36.us.preheader
  ...
  br i1 %14, label %for.inc39.us, label %for.inc36.us.preheader94

for.inc36.us.preheader94:                         ; preds = %for.inc36.us.prol.loopexit
  br label %for.inc36.us

for.inc42.loopexit:                               ; preds = %for.inc39.us
  br label %for.inc42

for.inc42.loopexit95.unr-lcssa:                   ; preds = %for.inc39.1
  br label %for.inc42.loopexit95

for.inc42.loopexit95:                             ; preds = %for.inc39.1.prol.loopexit, %for.inc42.loopexit95.unr-lcssa
  br label %for.inc42

for.inc42:                                        ; preds = %for.inc42.loopexit95, %for.inc42.loopexit, %for.cond4.preheader.preheader, %for.cond1.preheader
...
for.inc39.1:                                      ; preds = %for.inc39.1, %for.inc39.1.preheader.new
  %indvars.iv2436 = phi i64 [ %indvars.iv2436.unr, %for.inc39.1.preheader.new ], [ %indvars.iv.next25.1.7, %for.inc39.1 ]
  %indvars.iv.next25.1.7 = add nsw i64 %indvars.iv2436, 16
  %exitcond.1.7 = icmp eq i64 %indvars.iv.next25.1.7, %1
  br i1 %exitcond.1.7, label %for.inc42.loopexit95.unr-lcssa, label %for.inc39.1
}
