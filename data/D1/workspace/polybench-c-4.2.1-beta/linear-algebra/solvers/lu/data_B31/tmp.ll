...
.preheader13.lr.ph:                               ; preds = %2
  ...
  %12 = add nsw i64 %wide.trip.count130.7, -8
  %13 = trunc i32 %9 to i3
  %.pre = load [2000 x double]*, [2000 x double]** %3, align 8
  br label %.lr.ph52

.lr.ph52:                                         ; preds = %._crit_edge59, %.preheader13.lr.ph
  %indvars.iv153 = phi i3 [ %indvars.iv.next154, %._crit_edge59 ], [ %13, %.preheader13.lr.ph ]
  %indvars.iv151 = phi i64 [ %indvars.iv.next152, %._crit_edge59 ], [ 2, %.preheader13.lr.ph ]
  ...
  %14 = phi [2000 x double]* [ %.pre, %._crit_edge59 ], [ %1, %.preheader13.lr.ph ]
  %15 = zext i3 %indvars.iv153 to i64
  %16 = add nuw nsw i64 %15, 4294967295
  %17 = and i64 %16, 4294967295
  %18 = add i64 %indvars.iv151, %17
  %19 = sub nsw i64 0, %indvars.iv139
  %20 = trunc i64 %19 to i32
  %21 = add i32 %9, %20
  br label %22

; <label>:22:                                     ; preds = %22, %.lr.ph52
  %indvars.iv120 = phi i64 [ %indvars.iv.next121, %22 ], [ 0, %.lr.ph52 ]
  %23 = sub nsw i64 0, %indvars.iv120
  %24 = trunc i64 %23 to i32
  %25 = srem i32 %24, %0
  %26 = sitofp i32 %25 to double
  %27 = fdiv double %26, %8
  %28 = fadd double %27, 1.000000e+00
  %29 = getelementptr inbounds [2000 x double], [2000 x double]* %14, i64 %indvars.iv139, i64 %indvars.iv120
  store double %28, double* %29, align 8
  %indvars.iv.next121 = add nuw nsw i64 %indvars.iv120, 1
  %exitcond125 = icmp eq i64 %indvars.iv.next121, %indvars.iv137
  br i1 %exitcond125, label %._crit_edge53, label %22

._crit_edge53:                                    ; preds = %22
  %30 = add i32 %10, %20
  %indvars.iv.next140 = add nuw nsw i64 %indvars.iv139, 1
  %31 = icmp slt i64 %indvars.iv.next140, %11
  br i1 %31, label %.lr.ph58, label %._crit_edge59

.lr.ph58:                                         ; preds = %._crit_edge53
  %xtraiter134 = and i32 %21, 7
...
.prol.preheader132:                               ; preds = %.prol.preheader132.preheader, %.prol.preheader132
  ...
  %32 = getelementptr inbounds [2000 x double], [2000 x double]* %.pre, i64 %indvars.iv139, i64 %indvars.iv128.prol
...
.prol.loopexit133:                                ; preds = %.prol.loopexit133.loopexit, %.lr.ph58
  %indvars.iv128.unr = phi i64 [ %indvars.iv137, %.lr.ph58 ], [ %18, %.prol.loopexit133.loopexit ]
  %33 = icmp ult i32 %30, 7
  br i1 %33, label %._crit_edge59, label %.lr.ph58.new.preheader

.lr.ph58.new.preheader:                           ; preds = %.prol.loopexit133
  %34 = sub i64 %12, %indvars.iv128.unr
  %35 = lshr i64 %34, 3
  %36 = add nuw nsw i64 %35, 1
  %min.iters.check = icmp ult i64 %36, 2
  br i1 %min.iters.check, label %.lr.ph58.new.preheader150, label %min.iters.checked

min.iters.checked:                                ; preds = %.lr.ph58.new.preheader
  %n.mod.vf = and i64 %36, 1
  %n.vec = sub nsw i64 %36, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  %37 = add i64 %indvars.iv128.unr, 8
  %38 = shl nuw i64 %35, 3
  %39 = add i64 %37, %38
  %40 = shl nuw nsw i64 %n.mod.vf, 3
  %ind.end = sub i64 %39, %40
  br i1 %cmp.zero, label %.lr.ph58.new.preheader150, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %41 = shl i64 %index, 3
  %42 = add i64 %indvars.iv128.unr, %41
  %43 = add nsw i64 %42, 7
  %44 = getelementptr inbounds [2000 x double], [2000 x double]* %.pre, i64 %indvars.iv139, i64 %43
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %._crit_edge59, label %.lr.ph58.new.preheader150

.lr.ph58.new.preheader150:                        ; preds = %middle.block, %min.iters.checked, %.lr.ph58.new.preheader
...
.lr.ph58.new:                                     ; preds = %.lr.ph58.new.preheader150, %.lr.ph58.new
  %indvars.iv128 = phi i64 [ %indvars.iv.next129.7, %.lr.ph58.new ], [ %indvars.iv128.ph, %.lr.ph58.new.preheader150 ]
  %48 = getelementptr inbounds [2000 x double], [2000 x double]* %.pre, i64 %indvars.iv139, i64 %indvars.iv128
  store double 0.000000e+00, double* %48, align 8
  %indvars.iv.next129 = add nuw nsw i64 %indvars.iv128, 1
  %49 = getelementptr inbounds [2000 x double], [2000 x double]* %.pre, i64 %indvars.iv139, i64 %indvars.iv.next129
  store double 0.000000e+00, double* %49, align 8
  %indvars.iv.next129.1 = add nsw i64 %indvars.iv128, 2
  %50 = getelementptr inbounds [2000 x double], [2000 x double]* %.pre, i64 %indvars.iv139, i64 %indvars.iv.next129.1
  store double 0.000000e+00, double* %50, align 8
  %indvars.iv.next129.2 = add nsw i64 %indvars.iv128, 3
  %51 = getelementptr inbounds [2000 x double], [2000 x double]* %.pre, i64 %indvars.iv139, i64 %indvars.iv.next129.2
  store double 0.000000e+00, double* %51, align 8
  %indvars.iv.next129.3 = add nsw i64 %indvars.iv128, 4
  %52 = getelementptr inbounds [2000 x double], [2000 x double]* %.pre, i64 %indvars.iv139, i64 %indvars.iv.next129.3
  store double 0.000000e+00, double* %52, align 8
  %indvars.iv.next129.4 = add nsw i64 %indvars.iv128, 5
  %53 = getelementptr inbounds [2000 x double], [2000 x double]* %.pre, i64 %indvars.iv139, i64 %indvars.iv.next129.4
  store double 0.000000e+00, double* %53, align 8
  %indvars.iv.next129.5 = add nsw i64 %indvars.iv128, 6
  %54 = getelementptr inbounds [2000 x double], [2000 x double]* %.pre, i64 %indvars.iv139, i64 %indvars.iv.next129.5
  store double 0.000000e+00, double* %54, align 8
  %indvars.iv.next129.6 = add nsw i64 %indvars.iv128, 7
  %55 = getelementptr inbounds [2000 x double], [2000 x double]* %.pre, i64 %indvars.iv139, i64 %indvars.iv.next129.6
...
._crit_edge59:                                    ; preds = %._crit_edge59.loopexit, %middle.block, %.prol.loopexit133, %._crit_edge53
  %56 = getelementptr inbounds [2000 x double], [2000 x double]* %.pre, i64 %indvars.iv139, i64 %indvars.iv139
  ...
  %indvars.iv.next154 = add i3 %indvars.iv153, -1
  br i1 %exitcond142, label %.preheader12.us.preheader, label %.lr.ph52

.preheader12.us.preheader:                        ; preds = %._crit_edge59
...
._crit_edge45.us.prol:                            ; preds = %._crit_edge45.us.prol.preheader, %._crit_edge45.us.prol
  ...
  %scevgep.prol = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %65, i64 0, i64 %indvars.iv112.prol, i64 0
  %scevgep111.prol = bitcast double* %scevgep.prol to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep111.prol, i8 0, i64 %62, i32 8, i1 false)
...
.preheader12.us.prol.loopexit:                    ; preds = %.preheader12.us.prol.loopexit.loopexit, %.preheader12.us.preheader
  %indvars.iv112.unr = phi i64 [ 0, %.preheader12.us.preheader ], [ %66, %.preheader12.us.prol.loopexit.loopexit ]
  %67 = icmp ult i32 %59, 3
  br i1 %67, label %.preheader10.us.preheader, label %._crit_edge45.us.3.preheader

._crit_edge45.us.3.preheader:                     ; preds = %.preheader12.us.prol.loopexit
  %68 = add nsw i64 %wide.trip.count130.7, -4
  %69 = sub nsw i64 %68, %indvars.iv112.unr
  %70 = lshr i64 %69, 2
  %71 = and i64 %70, 1
...
._crit_edge45.us.3.prol:                          ; preds = %._crit_edge45.us.3.prol.preheader
  ...
  %scevgep.prol156 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %72, i64 0, i64 %indvars.iv112.unr, i64 0
  %scevgep111.prol157 = bitcast double* %scevgep.prol156 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep111.prol157, i8 0, i64 %62, i32 8, i1 false)
  %indvars.iv.next113.prol158 = add nuw nsw i64 %indvars.iv112.unr, 1
  %scevgep.1.prol = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %72, i64 0, i64 %indvars.iv.next113.prol158, i64 0
  %scevgep111.1.prol = bitcast double* %scevgep.1.prol to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep111.1.prol, i8 0, i64 %62, i32 8, i1 false)
  %indvars.iv.next113.1.prol = add nsw i64 %indvars.iv112.unr, 2
  %scevgep.2.prol = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %72, i64 0, i64 %indvars.iv.next113.1.prol, i64 0
  %scevgep111.2.prol = bitcast double* %scevgep.2.prol to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep111.2.prol, i8 0, i64 %62, i32 8, i1 false)
  %indvars.iv.next113.2.prol = add nsw i64 %indvars.iv112.unr, 3
  %scevgep.3.prol = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %72, i64 0, i64 %indvars.iv.next113.2.prol, i64 0
  %scevgep111.3.prol = bitcast double* %scevgep.3.prol to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep111.3.prol, i8 0, i64 %62, i32 8, i1 false)
...
._crit_edge45.us.3.prol.loopexit:                 ; preds = %._crit_edge45.us.3.prol, %._crit_edge45.us.3.preheader
  %indvars.iv112.unr159 = phi i64 [ %indvars.iv112.unr, %._crit_edge45.us.3.preheader ], [ %indvars.iv.next113.3.prol, %._crit_edge45.us.3.prol ]
  %73 = icmp eq i64 %70, 0
  br i1 %73, label %.preheader10.us.preheader.loopexit, label %._crit_edge45.us.3.preheader.new
...
.preheader9.us.us:                                ; preds = %._crit_edge22.us.us, %.preheader9.lr.ph.us
  ...
  %80 = getelementptr inbounds [2000 x double], [2000 x double]* %.pre, i64 %indvars.iv97, i64 %indvars.iv101
  br i1 %76, label %.prol.loopexit94, label %81

; <label>:81:                                     ; preds = %.preheader9.us.us
  %82 = load double, double* %80, align 8
  %83 = load double, double* %sunkaddr147, align 8
  %84 = fmul double %82, %83
  %85 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %79, i64 0, i64 %indvars.iv97, i64 0
  %86 = load double, double* %85, align 8
  %87 = fadd double %84, %86
  store double %87, double* %85, align 8
  br label %.prol.loopexit94

.prol.loopexit94:                                 ; preds = %.preheader9.us.us, %81
  %indvars.iv89.unr.ph = phi i64 [ 1, %81 ], [ 0, %.preheader9.us.us ]
  br i1 %77, label %._crit_edge22.us.us, label %.preheader9.us.us.new.preheader
...
.preheader9.us.us.new:                            ; preds = %.preheader9.us.us.new.preheader, %.preheader9.us.us.new
  ...
  %89 = getelementptr inbounds [2000 x double], [2000 x double]* %.pre, i64 %indvars.iv89, i64 %indvars.iv101
  %90 = load double, double* %89, align 8
  %91 = fmul double %88, %90
  %92 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %78, i64 0, i64 %indvars.iv97, i64 %indvars.iv89
  %93 = load double, double* %92, align 8
  %94 = fadd double %91, %93
  store double %94, double* %92, align 8
  %indvars.iv.next90 = add nuw nsw i64 %indvars.iv89, 1
  %95 = load double, double* %80, align 8
  %96 = getelementptr inbounds [2000 x double], [2000 x double]* %.pre, i64 %indvars.iv.next90, i64 %indvars.iv101
  %97 = load double, double* %96, align 8
  %98 = fmul double %95, %97
  %99 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %78, i64 0, i64 %indvars.iv97, i64 %indvars.iv.next90
...
.preheader.us.preheader:                          ; preds = %._crit_edge24.us-lcssa.us.us
  ...
  %104 = add nsw i32 %xtraiter116, -1
  %105 = zext i32 %104 to i64
  %106 = add nuw nsw i64 %105, 1
  %107 = icmp eq i32 %xtraiter116, 0
  %108 = icmp ult i32 %59, 3
  br label %.preheader.us

.preheader.us:                                    ; preds = %._crit_edge.us, %.preheader.us.preheader
  %indvars.iv85 = phi i64 [ 0, %.preheader.us.preheader ], [ %indvars.iv.next86, %._crit_edge.us ]
...
.prol.preheader:                                  ; preds = %.prol.preheader.preheader, %.prol.preheader
  ...
  %109 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %102, i64 0, i64 %indvars.iv85, i64 %indvars.iv.prol
  %110 = bitcast double* %109 to i64*
  %111 = load i64, i64* %110, align 8
  %112 = getelementptr inbounds [2000 x double], [2000 x double]* %103, i64 %indvars.iv85, i64 %indvars.iv.prol
...
.preheader.us.new:                                ; preds = %.preheader.us.new.preheader, %.preheader.us.new
  ...
  %114 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %102, i64 0, i64 %indvars.iv85, i64 %indvars.iv
  %115 = bitcast double* %114 to i64*
  %116 = load i64, i64* %115, align 8
  %117 = getelementptr inbounds [2000 x double], [2000 x double]* %103, i64 %indvars.iv85, i64 %indvars.iv
  %118 = bitcast double* %117 to i64*
  store i64 %116, i64* %118, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %119 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %102, i64 0, i64 %indvars.iv85, i64 %indvars.iv.next
  %120 = bitcast double* %119 to i64*
  %121 = load i64, i64* %120, align 8
  %122 = getelementptr inbounds [2000 x double], [2000 x double]* %103, i64 %indvars.iv85, i64 %indvars.iv.next
  %123 = bitcast double* %122 to i64*
  store i64 %121, i64* %123, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %124 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %102, i64 0, i64 %indvars.iv85, i64 %indvars.iv.next.1
  %125 = bitcast double* %124 to i64*
  %126 = load i64, i64* %125, align 8
  %127 = getelementptr inbounds [2000 x double], [2000 x double]* %103, i64 %indvars.iv85, i64 %indvars.iv.next.1
  %128 = bitcast double* %127 to i64*
  store i64 %126, i64* %128, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %129 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %102, i64 0, i64 %indvars.iv85, i64 %indvars.iv.next.2
  %130 = bitcast double* %129 to i64*
  %131 = load i64, i64* %130, align 8
  %132 = getelementptr inbounds [2000 x double], [2000 x double]* %103, i64 %indvars.iv85, i64 %indvars.iv.next.2
...
; <label>:135:                                    ; preds = %._crit_edge63.thread, %._crit_edge16
  %136 = phi i8* [ %134, %._crit_edge16 ], [ %6, %._crit_edge63.thread ]
  tail call void @free(i8* %136) #4
  ret void

._crit_edge45.us.3:                               ; preds = %._crit_edge45.us.3, %._crit_edge45.us.3.preheader.new
  %indvars.iv112 = phi i64 [ %indvars.iv112.unr159, %._crit_edge45.us.3.preheader.new ], [ %indvars.iv.next113.3.1, %._crit_edge45.us.3 ]
  %scevgep = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %74, i64 0, i64 %indvars.iv112, i64 0
  %scevgep111 = bitcast double* %scevgep to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep111, i8 0, i64 %62, i32 8, i1 false)
  %indvars.iv.next113 = add nuw nsw i64 %indvars.iv112, 1
  %scevgep.1 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %74, i64 0, i64 %indvars.iv.next113, i64 0
  %scevgep111.1 = bitcast double* %scevgep.1 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep111.1, i8 0, i64 %62, i32 8, i1 false)
  %indvars.iv.next113.1 = add nsw i64 %indvars.iv112, 2
  %scevgep.2 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %74, i64 0, i64 %indvars.iv.next113.1, i64 0
  %scevgep111.2 = bitcast double* %scevgep.2 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep111.2, i8 0, i64 %62, i32 8, i1 false)
  %indvars.iv.next113.2 = add nsw i64 %indvars.iv112, 3
  %scevgep.3 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %74, i64 0, i64 %indvars.iv.next113.2, i64 0
  %scevgep111.3 = bitcast double* %scevgep.3 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep111.3, i8 0, i64 %62, i32 8, i1 false)
  %indvars.iv.next113.3 = add nsw i64 %indvars.iv112, 4
  %scevgep.1160 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %75, i64 0, i64 %indvars.iv.next113.3, i64 0
  %scevgep111.1161 = bitcast double* %scevgep.1160 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep111.1161, i8 0, i64 %62, i32 8, i1 false)
  %indvars.iv.next113.1162 = add nsw i64 %indvars.iv112, 5
  %scevgep.1.1 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %75, i64 0, i64 %indvars.iv.next113.1162, i64 0
  %scevgep111.1.1 = bitcast double* %scevgep.1.1 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep111.1.1, i8 0, i64 %62, i32 8, i1 false)
  %indvars.iv.next113.1.1 = add nsw i64 %indvars.iv112, 6
  %scevgep.2.1 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %75, i64 0, i64 %indvars.iv.next113.1.1, i64 0
  %scevgep111.2.1 = bitcast double* %scevgep.2.1 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep111.2.1, i8 0, i64 %62, i32 8, i1 false)
  %indvars.iv.next113.2.1 = add nsw i64 %indvars.iv112, 7
  %scevgep.3.1 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %75, i64 0, i64 %indvars.iv.next113.2.1, i64 0
  %scevgep111.3.1 = bitcast double* %scevgep.3.1 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep111.3.1, i8 0, i64 %62, i32 8, i1 false)
