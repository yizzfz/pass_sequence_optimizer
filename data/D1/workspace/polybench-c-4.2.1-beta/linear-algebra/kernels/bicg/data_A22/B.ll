...
.lr.ph15.new:                                     ; preds = %.lr.ph15, %.lr.ph15.new
  %indvars.iv513 = phi i64 [ %indvars.iv.next6.1, %.lr.ph15.new ], [ 0, %.lr.ph15 ]
  %3 = trunc i64 %indvars.iv513 to i32
  %4 = srem i32 %3, 1900
  %5 = sitofp i32 %4 to double
  %6 = getelementptr inbounds double, double* %2, i64 %indvars.iv513
  ...
  %exitcond20.1 = icmp eq i64 %indvars.iv.next6.1, 1900
...
.lr.ph11.split.us:                                ; preds = %.lr.ph11.split.us.preheader, %._crit_edge.us
  ...
  %15 = trunc i64 %indvars.iv38.us to i32
  %16 = srem i32 %15, 2100
  %17 = sitofp i32 %16 to double
  %18 = fdiv double %17, 2.100000e+03
  %19 = getelementptr inbounds double, double* %1, i64 %indvars.iv38.us
  store double %18, double* %19, align 8
  br label %.lr.ph11.split.us.new

.lr.ph11.split.us.new:                            ; preds = %.lr.ph11.split.us, %.lr.ph11.split.us.new
  %indvars.iv7.us = phi i64 [ %indvars.iv.next.us.1, %.lr.ph11.split.us.new ], [ 0, %.lr.ph11.split.us ]
  %indvars.iv.next.us = or i64 %indvars.iv7.us, 1
  %20 = mul nuw nsw i64 %indvars.iv.next.us, %indvars.iv38.us
  ...
  br i1 %exitcond.1, label %._crit_edge.us, label %.lr.ph11.split.us.new

._crit_edge.us:                                   ; preds = %.lr.ph11.split.us.new
  %indvars.iv.next4.us = add nuw nsw i64 %indvars.iv38.us, 1
  %exitcond18 = icmp eq i64 %indvars.iv.next4.us, 2100
...
.lr.ph11.split.us:                                ; preds = %.lr.ph15.preheader, %._crit_edge.us
  %indvars.iv38.us = phi i64 [ %indvars.iv.next4.us, %._crit_edge.us ], [ 0, %.lr.ph15.preheader ]
...
.lr.ph10:                                         ; preds = %.lr.ph10.preheader, %11
  %indvars.iv58 = phi i64 [ %indvars.iv.next6, %11 ], [ 0, %.lr.ph10.preheader ]
...
; <label>:11:                                     ; preds = %.lr.ph10, %9
  %12 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %13 = getelementptr inbounds double, double* %0, i64 %indvars.iv58
  ...
  %exitcond12 = icmp eq i64 %indvars.iv.next6, 1900
