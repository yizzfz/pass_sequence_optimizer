...
._crit_edge27:                                    ; preds = %._crit_edge27, %.preheader22
  %indvars.iv4 = phi i64 [ 0, %.preheader22 ], [ %indvars.iv.next5, %._crit_edge27 ]
  ...
  br i1 %exitcond6, label %36, label %._crit_edge27
...
._crit_edge29:                                    ; preds = %._crit_edge29, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %._crit_edge29 ]
  ...
  br i1 %exitcond, label %44, label %._crit_edge29
...
define internal fastcc void @kernel_2mm(double, double, [900 x double]*, [1100 x double]*, [900 x double]*, [1200 x double]*, [1200 x double]*) unnamed_addr #2 {
  ...
  %9 = alloca [900 x double]*, align 8
  %10 = alloca [1100 x double]*, align 8
  %11 = alloca [900 x double]*, align 8
  %12 = alloca [1200 x double]*, align 8
  store double %0, double* %8, align 8
  store [900 x double]* %2, [900 x double]** %9, align 8
  store [1100 x double]* %3, [1100 x double]** %10, align 8
  store [900 x double]* %4, [900 x double]** %11, align 8
  store [1200 x double]* %5, [1200 x double]** %12, align 8
  br label %._crit_edge18

._crit_edge18:                                    ; preds = %37, %7
  %indvars.iv13 = phi i64 [ 0, %7 ], [ %indvars.iv.next14, %37 ]
  %13 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv13
  %sunkaddr = ptrtoint [900 x double]* %13 to i64
  br label %._crit_edge17

._crit_edge17:                                    ; preds = %36, %._crit_edge18
  %indvars.iv10 = phi i64 [ 0, %._crit_edge18 ], [ %indvars.iv.next11, %36 ]
  %14 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv13, i64 %indvars.iv10
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge17
  ...
  %15 = phi double [ 0.000000e+00, %._crit_edge17 ], [ %35, %._crit_edge ]
  %16 = load double, double* %8, align 8
  %17 = load [1100 x double]*, [1100 x double]** %10, align 8
  %18 = getelementptr inbounds [1100 x double], [1100 x double]* %17, i64 %indvars.iv13, i64 %indvars.iv7
  %19 = load double, double* %18, align 8
  %20 = fmul double %16, %19
  %21 = load [900 x double]*, [900 x double]** %11, align 8
  %22 = getelementptr inbounds [900 x double], [900 x double]* %21, i64 %indvars.iv7, i64 %indvars.iv10
  %23 = load double, double* %22, align 8
  %24 = fmul double %20, %23
  %25 = fadd double %24, %15
  store double %25, double* %sunkaddr24, align 8
  %indvars.iv.next8 = or i64 %indvars.iv7, 1
  %26 = load double, double* %8, align 8
  %27 = load [1100 x double]*, [1100 x double]** %10, align 8
  %28 = getelementptr inbounds [1100 x double], [1100 x double]* %27, i64 %indvars.iv13, i64 %indvars.iv.next8
  %29 = load double, double* %28, align 8
  %30 = fmul double %26, %29
  %31 = load [900 x double]*, [900 x double]** %11, align 8
  %32 = getelementptr inbounds [900 x double], [900 x double]* %31, i64 %indvars.iv.next8, i64 %indvars.iv10
  %33 = load double, double* %32, align 8
  %34 = fmul double %30, %33
  %35 = fadd double %34, %25
  store double %35, double* %sunkaddr24, align 8
  %indvars.iv.next8.1 = add nuw nsw i64 %indvars.iv7, 2
  %exitcond9.1 = icmp eq i64 %indvars.iv.next8.1, 1100
  br i1 %exitcond9.1, label %36, label %._crit_edge

; <label>:36:                                     ; preds = %._crit_edge
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %exitcond12 = icmp eq i64 %indvars.iv.next11, 900
  br i1 %exitcond12, label %37, label %._crit_edge17

; <label>:37:                                     ; preds = %36
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 800
  br i1 %exitcond15, label %.preheader.preheader, label %._crit_edge18

.preheader.preheader:                             ; preds = %37
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %60
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %60 ], [ 0, %.preheader.preheader ]
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv4
  %sunkaddr25 = ptrtoint [1200 x double]* %38 to i64
  br label %._crit_edge20

._crit_edge20:                                    ; preds = %59, %.preheader
  %indvars.iv1 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next2, %59 ]
  %39 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv4, i64 %indvars.iv1
  %40 = load double, double* %39, align 8
  %41 = fmul double %40, %1
  store double %41, double* %39, align 8
  %sunkaddr26 = shl i64 %indvars.iv1, 3
...
._crit_edge19:                                    ; preds = %._crit_edge19, %._crit_edge20
  %indvars.iv = phi i64 [ 0, %._crit_edge20 ], [ %indvars.iv.next.1, %._crit_edge19 ]
  %42 = phi double [ %41, %._crit_edge20 ], [ %58, %._crit_edge19 ]
  %43 = load [900 x double]*, [900 x double]** %9, align 8
  %44 = getelementptr inbounds [900 x double], [900 x double]* %43, i64 %indvars.iv4, i64 %indvars.iv
  %45 = load double, double* %44, align 8
  %46 = load [1200 x double]*, [1200 x double]** %12, align 8
  %47 = getelementptr inbounds [1200 x double], [1200 x double]* %46, i64 %indvars.iv, i64 %indvars.iv1
  %48 = load double, double* %47, align 8
  %49 = fmul double %45, %48
  %50 = fadd double %49, %42
  store double %50, double* %sunkaddr28, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %51 = load [900 x double]*, [900 x double]** %9, align 8
  %52 = getelementptr inbounds [900 x double], [900 x double]* %51, i64 %indvars.iv4, i64 %indvars.iv.next
  %53 = load double, double* %52, align 8
  %54 = load [1200 x double]*, [1200 x double]** %12, align 8
  %55 = getelementptr inbounds [1200 x double], [1200 x double]* %54, i64 %indvars.iv.next, i64 %indvars.iv1
  %56 = load double, double* %55, align 8
  %57 = fmul double %53, %56
  %58 = fadd double %57, %50
  store double %58, double* %sunkaddr28, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 900
  br i1 %exitcond.1, label %59, label %._crit_edge19

; <label>:59:                                     ; preds = %._crit_edge19
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 1200
  br i1 %exitcond3, label %60, label %._crit_edge20

; <label>:60:                                     ; preds = %59
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1
  %exitcond6 = icmp eq i64 %indvars.iv.next5, 800
  br i1 %exitcond6, label %61, label %.preheader
