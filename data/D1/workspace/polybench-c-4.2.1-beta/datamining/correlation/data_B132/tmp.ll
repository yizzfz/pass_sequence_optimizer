...
.lr.ph55.split.us:                                ; preds = %._crit_edge52.us, %.lr.ph55.split.us.preheader
  ...
  %sunkaddr127 = shl nsw i64 %indvars.iv18, 3
...
; <label>:11:                                     ; preds = %11, %.lr.ph55.split.us
  ...
  %indvars.iv.next110.133 = or i64 %indvars.iv109, 3
  %22 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next110.133, i64 %indvars.iv18
...
.lr.ph49.split.us:                                ; preds = %._crit_edge47.us, %.lr.ph49.split.us.preheader
  ...
  %sunkaddr135 = shl nsw i64 %indvars.iv15, 3
...
; <label>:30:                                     ; preds = %30, %.lr.ph49.split.us
  ...
  %34 = load double, double* %sunkaddr137, align 8
  ...
  %40 = load double, double* %sunkaddr137, align 8
