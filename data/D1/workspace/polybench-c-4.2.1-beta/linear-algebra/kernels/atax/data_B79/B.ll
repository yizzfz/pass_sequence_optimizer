...
define internal fastcc void @init_array(i32, i32, [2100 x double]*, double*) unnamed_addr #2 {
  ...
  %12 = icmp sgt i32 %1, 0
  br i1 %12, label %.lr.ph7, label %._crit_edge20
...
._crit_edge21:                                    ; preds = %._crit_edge21, %.lr.ph7
  %indvars.iv18 = phi i64 [ %16, %.lr.ph7 ], [ %indvars.iv.next19, %._crit_edge21 ]
  %18 = trunc i64 %indvars.iv18 to i32
  %19 = sitofp i32 %18 to double
  %20 = fdiv double %19, %13
  %21 = fadd double %20, 1.000000e+00
  %22 = getelementptr inbounds double, double* %14, i64 %indvars.iv18
  store double %21, double* %22, align 8
  %indvars.iv.next19 = add nsw i64 %indvars.iv18, 1
  %23 = icmp slt i64 %indvars.iv.next19, %17
  br i1 %23, label %._crit_edge21, label %._crit_edge8

._crit_edge8:                                     ; preds = %._crit_edge21
  %24 = trunc i64 %indvars.iv.next19 to i32
  store i32 %24, i32* %9, align 4
  br label %._crit_edge20

._crit_edge20:                                    ; preds = %4, %._crit_edge8
  store i32 0, i32* %9, align 4
  %25 = load i32, i32* %5, align 4
  %26 = icmp sgt i32 %25, 0
  br i1 %26, label %.lr.ph4, label %._crit_edge22

.lr.ph4:                                          ; preds = %._crit_edge20
  ...
  %.promoted9 = load i32, i32* %9, align 4
  %32 = sext i32 %.promoted9 to i64
...
._crit_edge._crit_edge:                           ; preds = %._crit_edge, %.lr.ph4
  %indvars.iv16 = phi i64 [ %32, %.lr.ph4 ], [ %indvars.iv.next17, %._crit_edge ]
...
; <label>:39:                                     ; preds = %.lr.ph
  %40 = trunc i64 %indvars.iv16 to i32
  %41 = srem i32 %40, %27
  %42 = sitofp i32 %41 to double
  %43 = fdiv double %42, %30
  %44 = getelementptr inbounds [2100 x double], [2100 x double]* %31, i64 %indvars.iv16, i64 0
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %45 = add nsw i64 %indvars.iv16, %indvars.iv
  %46 = trunc i64 %45 to i32
  %47 = srem i32 %46, %27
  %48 = sitofp i32 %47 to double
  %49 = getelementptr inbounds [2100 x double], [2100 x double]* %31, i64 %indvars.iv16, i64 %indvars.iv
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %50 = add nsw i64 %indvars.iv16, %indvars.iv.next
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %._crit_edge._crit_edge
  ...
  %58 = icmp slt i64 %indvars.iv.next17, %33
...
._crit_edge22:                                    ; preds = %._crit_edge20, %._crit_edge5
  ret void
}
...
define internal fastcc void @kernel_atax(i32, i32, [2100 x double]*, double*, double*, double*) unnamed_addr #0 {
  ...
  %14 = icmp sgt i32 %1, 0
  br i1 %14, label %.lr.ph11, label %._crit_edge65
...
.lr.ph11:                                         ; preds = %6
  ...
  call void @llvm.memset.p0i8.i64(i8* %scevgep40, i8 0, i64 %25, i32 8, i1 false)
  br label %._crit_edge66

._crit_edge66:                                    ; preds = %._crit_edge66, %.lr.ph11
  %indvars.iv38 = phi i64 [ %17, %.lr.ph11 ], [ %indvars.iv.next39, %._crit_edge66 ]
  %indvars.iv.next39 = add nsw i64 %indvars.iv38, 1
  %26 = icmp slt i64 %indvars.iv.next39, %18
  br i1 %26, label %._crit_edge66, label %._crit_edge12

._crit_edge12:                                    ; preds = %._crit_edge66
  %27 = add nsw i64 %17, 1
  %28 = icmp sgt i64 %27, %18
  %smax43 = select i1 %28, i64 %27, i64 %18
  %29 = trunc i64 %smax43 to i32
  store i32 %29, i32* %13, align 4
  br label %._crit_edge65

._crit_edge65:                                    ; preds = %6, %._crit_edge12
  store i32 0, i32* %13, align 4
  %30 = load i32, i32* %7, align 4
  %31 = icmp sgt i32 %30, 0
  br i1 %31, label %.lr.ph8, label %._crit_edge67

.lr.ph8:                                          ; preds = %._crit_edge65
  ...
  %39 = sext i32 %.promoted15 to i64
  %40 = sext i32 %37 to i64
  %xtraiter = and i32 %33, 1
  %41 = icmp sgt i32 %33, 0
  %42 = icmp eq i32 %xtraiter, 0
  %43 = icmp eq i32 %33, 1
  %sunkaddr59 = ptrtoint double* %32 to i64
  %sunkaddr = ptrtoint double* %32 to i64
  %sunkaddr47 = ptrtoint double* %32 to i64
  %sunkaddr51 = ptrtoint double* %32 to i64
  %sunkaddr55 = ptrtoint double* %32 to i64
  %44 = icmp sgt i32 %33, 0
  %45 = ptrtoint double* %32 to i64
  %46 = ptrtoint double* %32 to i64
  br label %._crit_edge6._crit_edge

._crit_edge6._crit_edge:                          ; preds = %._crit_edge6, %.lr.ph8
  %indvars.iv35 = phi i64 [ %39, %.lr.ph8 ], [ %indvars.iv.next36, %._crit_edge6 ]
  %47 = getelementptr inbounds double, double* %32, i64 %indvars.iv35
  store double 0.000000e+00, double* %47, align 8
  br i1 %41, label %.lr.ph, label %._crit_edge6

.lr.ph:                                           ; preds = %._crit_edge6._crit_edge
  br i1 %42, label %.prol.loopexit, label %48

; <label>:48:                                     ; preds = %.lr.ph
  %sunkaddr21.prol = shl i64 %indvars.iv35, 3
  %sunkaddr22.prol = add i64 %46, %sunkaddr21.prol
  %sunkaddr23.prol = inttoptr i64 %sunkaddr22.prol to double*
  %49 = load double, double* %sunkaddr23.prol, align 8
  %50 = getelementptr inbounds [2100 x double], [2100 x double]* %34, i64 %indvars.iv35, i64 0
  %51 = load double, double* %50, align 8
  %52 = load double, double* %35, align 8
  %53 = fmul double %51, %52
  %54 = fadd double %49, %53
  %sunkaddr25.prol = shl i64 %indvars.iv35, 3
  %sunkaddr26.prol = add i64 %45, %sunkaddr25.prol
  %sunkaddr27.prol = inttoptr i64 %sunkaddr26.prol to double*
  store double %54, double* %sunkaddr27.prol, align 8
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.lr.ph, %48
  %indvars.iv.unr.ph = phi i64 [ 1, %48 ], [ 0, %.lr.ph ]
  br i1 %43, label %.lr.ph5.preheader, label %.lr.ph.new.preheader

.lr.ph.new.preheader:                             ; preds = %.prol.loopexit
  %sunkaddr44 = shl i64 %indvars.iv35, 3
  %sunkaddr45 = add i64 %sunkaddr, %sunkaddr44
  %sunkaddr46 = inttoptr i64 %sunkaddr45 to double*
  %sunkaddr48 = shl i64 %indvars.iv35, 3
  %sunkaddr49 = add i64 %sunkaddr47, %sunkaddr48
  %sunkaddr50 = inttoptr i64 %sunkaddr49 to double*
  %sunkaddr52 = shl i64 %indvars.iv35, 3
  %sunkaddr53 = add i64 %sunkaddr51, %sunkaddr52
  %sunkaddr54 = inttoptr i64 %sunkaddr53 to double*
  %sunkaddr56 = shl i64 %indvars.iv35, 3
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.lr.ph.new ], [ %indvars.iv.unr.ph, %.lr.ph.new.preheader ]
  %55 = load double, double* %sunkaddr46, align 8
  %56 = getelementptr inbounds [2100 x double], [2100 x double]* %34, i64 %indvars.iv35, i64 %indvars.iv
  %57 = load double, double* %56, align 8
  %58 = getelementptr inbounds double, double* %35, i64 %indvars.iv
  %59 = load double, double* %58, align 8
  %60 = fmul double %57, %59
  %61 = fadd double %55, %60
  store double %61, double* %sunkaddr50, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %62 = load double, double* %sunkaddr54, align 8
  %63 = getelementptr inbounds [2100 x double], [2100 x double]* %34, i64 %indvars.iv35, i64 %indvars.iv.next
  %64 = load double, double* %63, align 8
  %65 = getelementptr inbounds double, double* %35, i64 %indvars.iv.next
  %66 = load double, double* %65, align 8
  %67 = fmul double %64, %66
  %68 = fadd double %62, %67
  store double %68, double* %sunkaddr58, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, %wide.trip.count.1
...
.lr.ph5.preheader:                                ; preds = %._crit_edge, %.prol.loopexit
  %sunkaddr60 = shl i64 %indvars.iv35, 3
  %sunkaddr61 = add i64 %sunkaddr59, %sunkaddr60
  %sunkaddr62 = inttoptr i64 %sunkaddr61 to double*
  br label %.lr.ph5

.lr.ph5:                                          ; preds = %.lr.ph5.preheader, %.lr.ph5
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %.lr.ph5 ], [ 0, %.lr.ph5.preheader ]
  %69 = getelementptr inbounds double, double* %36, i64 %indvars.iv33
  %70 = load double, double* %69, align 8
  %71 = getelementptr inbounds [2100 x double], [2100 x double]* %34, i64 %indvars.iv35, i64 %indvars.iv33
  %72 = load double, double* %71, align 8
  %73 = load double, double* %sunkaddr62, align 8
  %74 = fmul double %72, %73
  %75 = fadd double %70, %74
  %76 = getelementptr inbounds double, double* %36, i64 %indvars.iv33
  store double %75, double* %76, align 8
  %indvars.iv.next34 = add nuw nsw i64 %indvars.iv33, 1
  %77 = icmp slt i64 %indvars.iv.next34, %38
  br i1 %77, label %.lr.ph5, label %._crit_edge6.loopexit

._crit_edge6.loopexit:                            ; preds = %.lr.ph5
  br label %._crit_edge6

._crit_edge6:                                     ; preds = %._crit_edge6.loopexit, %._crit_edge, %._crit_edge6._crit_edge
  %indvars.iv.next36 = add nsw i64 %indvars.iv35, 1
  %78 = icmp slt i64 %indvars.iv.next36, %40
  br i1 %78, label %._crit_edge6._crit_edge, label %._crit_edge9

._crit_edge9:                                     ; preds = %._crit_edge6
  %79 = trunc i64 %indvars.iv.next36 to i32
  store i32 %79, i32* %13, align 4
  br label %._crit_edge67

._crit_edge67:                                    ; preds = %._crit_edge65, %._crit_edge9
  ret void
}
