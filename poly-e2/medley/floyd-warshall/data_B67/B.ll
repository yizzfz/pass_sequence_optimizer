...
for.cond1.preheader:                              ; preds = %for.inc20, %entry
  %indvars.iv22 = phi i64 [ 0, %entry ], [ %indvars.iv.next23, %for.inc20 ]
  br label %for.body3
...
for.body3:                                        ; preds = %for.inc, %for.cond1.preheader
  ...
  br i1 %or.cond17, label %for.inc, label %for.body3.for.inc_crit_edge

for.body3.for.inc_crit_edge:                      ; preds = %for.body3
  %2 = mul nuw nsw i64 %indvars.iv, %indvars.iv22
  %3 = trunc i64 %2 to i32
  %rem = srem i32 %3, 7
  %add = add nsw i32 %rem, 1
  br label %for.inc

for.inc:                                          ; preds = %for.body3, %for.body3.for.inc_crit_edge
  %storemerge = phi i32 [ %add, %for.body3.for.inc_crit_edge ], [ 999, %for.body3 ]
...
for.inc20:                                        ; preds = %for.inc
  ...
  %exitcond1 = icmp eq i64 %indvars.iv.next23, 2800
