...
define internal void @print_array(i32, i32, [1200 x double]* nocapture readonly, [1200 x double]* nocapture readonly, [1200 x double]* nocapture readonly) #0 {
  ...
  br i1 %or.cond, label %.preheader13.us.preheader, label %._crit_edge23
...
.preheader13.us:                                  ; preds = %._crit_edge21.us, %.preheader13.us.preheader
  ...
  %13 = mul nsw i64 %indvars.iv45, %12
  br label %14

; <label>:14:                                     ; preds = %21, %.preheader13.us
  %indvars.iv41 = phi i64 [ 0, %.preheader13.us ], [ %indvars.iv.next42, %21 ]
  %15 = add nsw i64 %indvars.iv41, %13
...
; <label>:21:                                     ; preds = %19, %14
  ...
  %23 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv45, i64 %indvars.iv41
  ...
  br i1 %exitcond44, label %._crit_edge21.us, label %14

._crit_edge21.us:                                 ; preds = %21
  %indvars.iv.next46 = add nuw nsw i64 %indvars.iv45, 1
  %exitcond48 = icmp eq i64 %indvars.iv.next46, %wide.trip.count47
  br i1 %exitcond48, label %._crit_edge23.loopexit, label %.preheader13.us
...
._crit_edge23:                                    ; preds = %._crit_edge23.loopexit, %5
  ...
  %32 = icmp sgt i32 %0, 0
  %33 = icmp sgt i32 %1, 0
  %or.cond50 = and i1 %32, %33
  br i1 %or.cond50, label %.preheader12.us.preheader, label %._crit_edge19

.preheader12.us.preheader:                        ; preds = %._crit_edge23
  %34 = sext i32 %0 to i64
  %wide.trip.count34 = zext i32 %1 to i64
  %wide.trip.count38 = zext i32 %0 to i64
  br label %.preheader12.us

.preheader12.us:                                  ; preds = %._crit_edge17.us, %.preheader12.us.preheader
  %indvars.iv36 = phi i64 [ 0, %.preheader12.us.preheader ], [ %indvars.iv.next37, %._crit_edge17.us ]
  %35 = mul nsw i64 %indvars.iv36, %34
  br label %36

; <label>:36:                                     ; preds = %43, %.preheader12.us
  %indvars.iv32 = phi i64 [ 0, %.preheader12.us ], [ %indvars.iv.next33, %43 ]
  %37 = add nsw i64 %indvars.iv32, %35
...
; <label>:43:                                     ; preds = %41, %36
  ...
  %45 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv36, i64 %indvars.iv32
  ...
  br i1 %exitcond35, label %._crit_edge17.us, label %36

._crit_edge17.us:                                 ; preds = %43
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  %exitcond39 = icmp eq i64 %indvars.iv.next37, %wide.trip.count38
  br i1 %exitcond39, label %._crit_edge19.loopexit, label %.preheader12.us

._crit_edge19.loopexit:                           ; preds = %._crit_edge17.us
  br label %._crit_edge19

._crit_edge19:                                    ; preds = %._crit_edge19.loopexit, %._crit_edge23
  ...
  %52 = icmp sgt i32 %0, 0
  %53 = icmp sgt i32 %1, 0
  %or.cond51 = and i1 %52, %53
  br i1 %or.cond51, label %.preheader.us.preheader, label %._crit_edge15
...
.preheader.us:                                    ; preds = %._crit_edge.us, %.preheader.us.preheader
  ...
  %55 = mul nsw i64 %indvars.iv27, %54
  br label %56
...
; <label>:63:                                     ; preds = %61, %56
  ...
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv27, i64 %indvars.iv
...
._crit_edge.us:                                   ; preds = %63
  ...
  br i1 %exitcond30, label %._crit_edge15.loopexit, label %.preheader.us

._crit_edge15.loopexit:                           ; preds = %._crit_edge.us
  br label %._crit_edge15

._crit_edge15:                                    ; preds = %._crit_edge15.loopexit, %._crit_edge19
