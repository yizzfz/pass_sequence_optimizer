...
define i32 @alaw_input(i16* nocapture) local_unnamed_addr #0 {
  br label %2
...
; <label>:6:                                      ; preds = %2
  %7 = and i32 %4, 255
  %8 = zext i32 %7 to i64
  %9 = getelementptr inbounds [256 x i16], [256 x i16]* @a2s, i64 0, i64 %8
  %10 = load i16, i16* %9, align 2
  %11 = getelementptr inbounds i16, i16* %0, i64 %indvars.iv
  store i16 %10, i16* %11, align 2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %12 = icmp slt i64 %indvars.iv.next, 160
  br i1 %12, label %2, label %.loopexit.loopexit

; <label>:13:                                     ; preds = %2
  %14 = load %struct._IO_FILE*, %struct._IO_FILE** @in, align 8
  %15 = tail call i32 @ferror(%struct._IO_FILE* %14) #3
  %16 = icmp eq i32 %15, 0
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %13
  %.026.in = phi i64 [ %indvars.iv, %13 ], [ %indvars.iv.next, %.loopexit.loopexit ]
  %.026 = trunc i64 %.026.in to i32
  br label %17

; <label>:17:                                     ; preds = %13, %.loopexit
  %.0 = phi i32 [ %.026, %.loopexit ], [ -1, %13 ]
  ret i32 %.0
}
...
; Function Attrs: noinline nounwind uwtable
define i32 @alaw_output(i16* nocapture readonly) local_unnamed_addr #0 {
  br label %2

; <label>:2:                                      ; preds = %1, %12
  %.014 = phi i16* [ %0, %1 ], [ %14, %12 ]
  %.023 = phi i32 [ 0, %1 ], [ %13, %12 ]
  %3 = load i16, i16* %.014, align 2
  %4 = zext i16 %3 to i64
  %5 = lshr i64 %4, 4
  %6 = getelementptr inbounds [4096 x i8], [4096 x i8]* @s2a, i64 0, i64 %5
  %7 = load i8, i8* %6, align 1
  %8 = zext i8 %7 to i32
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** @out, align 8
  %10 = tail call i32 @fputc(i32 %8, %struct._IO_FILE* %9)
  %11 = icmp eq i32 %10, -1
  br i1 %11, label %16, label %12

; <label>:12:                                     ; preds = %2
  %13 = add nuw nsw i32 %.023, 1
  %14 = getelementptr inbounds i16, i16* %.014, i64 1
  %15 = icmp slt i32 %13, 160
