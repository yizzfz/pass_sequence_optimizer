...
.prol.preheader:                                  ; preds = %.lr.ph
  ...
  %11 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv10, i64 0
  store double %10, double* %11, align 8
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph
  %indvars.iv.unr.ph = phi i64 [ 1, %.prol.preheader ], [ 0, %.lr.ph ]
  %12 = icmp eq i64 %indvars.iv10, 0
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %16 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv10, i64 %indvars.iv
...
; <label>:3:                                      ; preds = %._crit_edge, %.lr.ph13
  ...
  %5 = getelementptr inbounds double, double* %2, i64 %indvars.iv21
  %6 = load double, double* %5, align 8
  %7 = getelementptr inbounds double, double* %1, i64 %indvars.iv21
...
.prol.preheader:                                  ; preds = %.lr.ph
  %9 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv21, i64 0
...
.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph
  ...
  %.lcssa.unr.ph = phi double [ %13, %.prol.preheader ], [ undef, %.lr.ph ]
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %17 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv21, i64 %indvars.iv
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %23 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv21, i64 %indvars.iv.next
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %3, %.prol.loopexit
  %.lcssa9 = phi double [ %.lcssa.unr.ph, %.prol.loopexit ], [ %6, %3 ], [ %28, %._crit_edge.loopexit ]
  %29 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv21, i64 %indvars.iv21
  ...
  br i1 %exitcond26, label %._crit_edge14, label %3
