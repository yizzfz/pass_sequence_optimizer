...
._crit_edge.us:                                   ; preds = %._crit_edge.us.preheader, %._crit_edge7.us
  ...
  br i1 false, label %scalar.ph53.preheader, label %min.iters.checked56

scalar.ph53.preheader:                            ; preds = %middle.block52, %vector.memcheck72, %min.iters.checked56, %._crit_edge.us
  %indvars.iv.ph = phi i64 [ 1, %vector.memcheck72 ], [ 1, %min.iters.checked56 ], [ 1, %._crit_edge.us ], [ 1997, %middle.block52 ]
  br label %scalar.ph53

min.iters.checked56:                              ; preds = %._crit_edge.us
  br i1 false, label %scalar.ph53.preheader, label %vector.memcheck72
...
vector.body51:                                    ; preds = %vector.body51.preheader, %vector.body51
  ...
  %wide.load85 = load <2 x double>, <2 x double>* %8, align 8, !alias.scope !1
  %9 = getelementptr inbounds double, double* %0, i64 %offset.idx79
  %10 = bitcast double* %9 to <2 x double>*
  %wide.load86 = load <2 x double>, <2 x double>* %10, align 8, !alias.scope !1
  %11 = getelementptr double, double* %9, i64 2
  %12 = bitcast double* %11 to <2 x double>*
  %wide.load87 = load <2 x double>, <2 x double>* %12, align 8, !alias.scope !1
  %13 = fadd <2 x double> %wide.load84, %wide.load86
  %14 = fadd <2 x double> %wide.load85, %wide.load87
  %15 = add nuw nsw i64 %offset.idx79, 1
  ...
  %wide.load89 = load <2 x double>, <2 x double>* %19, align 8, !alias.scope !1
  %20 = fadd <2 x double> %13, %wide.load88
  %21 = fadd <2 x double> %14, %wide.load89
  ...
  %24 = getelementptr inbounds double, double* %1, i64 %offset.idx79
  ...
  %28 = icmp eq i64 %index.next75, 1996
  br i1 %28, label %middle.block52, label %vector.body51, !llvm.loop !6

middle.block52:                                   ; preds = %vector.body51
  br i1 false, label %.lr.ph6.us.preheader, label %scalar.ph53.preheader
...
.lr.ph6.us:                                       ; preds = %.lr.ph6.us.preheader90, %.lr.ph6.us
  %indvars.iv29 = phi i64 [ %37, %.lr.ph6.us ], [ %indvars.iv29.ph, %.lr.ph6.us.preheader90 ]
...
scalar.ph53:                                      ; preds = %scalar.ph53.preheader, %scalar.ph53
  %indvars.iv = phi i64 [ %50, %scalar.ph53 ], [ %indvars.iv.ph, %scalar.ph53.preheader ]
  ...
  br i1 %56, label %scalar.ph53, label %.lr.ph6.us.preheader.loopexit, !llvm.loop !10

.lr.ph6.us.preheader.loopexit:                    ; preds = %scalar.ph53
  br label %.lr.ph6.us.preheader

.lr.ph6.us.preheader:                             ; preds = %.lr.ph6.us.preheader.loopexit, %middle.block52
  br i1 false, label %.lr.ph6.us.preheader90, label %min.iters.checked

.lr.ph6.us.preheader90:                           ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.lr.ph6.us.preheader
...
min.iters.checked:                                ; preds = %.lr.ph6.us.preheader
  br i1 false, label %.lr.ph6.us.preheader90, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  br i1 %memcheck.conflict, label %.lr.ph6.us.preheader90, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load46 = load <2 x double>, <2 x double>* %61, align 8, !alias.scope !11
  %62 = getelementptr inbounds double, double* %1, i64 %offset.idx
  %63 = bitcast double* %62 to <2 x double>*
  %wide.load47 = load <2 x double>, <2 x double>* %63, align 8, !alias.scope !11
  %64 = getelementptr double, double* %62, i64 2
  %65 = bitcast double* %64 to <2 x double>*
  %wide.load48 = load <2 x double>, <2 x double>* %65, align 8, !alias.scope !11
  %66 = fadd <2 x double> %wide.load, %wide.load47
  %67 = fadd <2 x double> %wide.load46, %wide.load48
  %68 = add nuw nsw i64 %offset.idx, 1
  %69 = getelementptr inbounds double, double* %1, i64 %68
  %70 = bitcast double* %69 to <2 x double>*
  %wide.load49 = load <2 x double>, <2 x double>* %70, align 8, !alias.scope !11
  %71 = getelementptr double, double* %69, i64 2
  %72 = bitcast double* %71 to <2 x double>*
  %wide.load50 = load <2 x double>, <2 x double>* %72, align 8, !alias.scope !11
  %73 = fadd <2 x double> %66, %wide.load49
  %74 = fadd <2 x double> %67, %wide.load50
...
middle.block:                                     ; preds = %vector.body
  br i1 false, label %._crit_edge7.us, label %.lr.ph6.us.preheader90
