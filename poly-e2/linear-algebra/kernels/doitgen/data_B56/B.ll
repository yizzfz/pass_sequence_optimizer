...
define internal fastcc void @init_array(i32 %nr, i32 %nq, i32 %np, [140 x [160 x double]]* %A, [160 x double]* %C4) unnamed_addr #2 {
entry:
  %nr.addr = alloca i32, align 4
  %nq.addr = alloca i32, align 4
  %np.addr = alloca i32, align 4
...
for.cond1.preheader.lr.ph:                        ; preds = %entry
  ...
  br i1 %cmp216, label %for.cond1.preheader.us.preheader, label %for.cond.for.cond18.preheader_crit_edge.loopexit56
...
for.cond1.for.inc15_crit_edge.us:                 ; preds = %for.cond1.for.inc15_crit_edge.us.loopexit, %for.cond1.preheader.us
  %inc.lcssa19.lcssa.us = phi i32 [ 0, %for.cond1.preheader.us ], [ %1, %for.cond1.for.inc15_crit_edge.us.loopexit ]
...
for.cond.for.cond18.preheader_crit_edge:          ; preds = %for.cond.for.cond18.preheader_crit_edge.loopexit56, %for.cond.for.cond18.preheader_crit_edge.loopexit
  %inc.lcssa19.lcssa26.lcssa = phi i32 [ %inc.lcssa19.lcssa.us, %for.cond.for.cond18.preheader_crit_edge.loopexit ], [ %k.promoted, %for.cond.for.cond18.preheader_crit_edge.loopexit56 ]
  ...
  store i32 %inc.lcssa19.lcssa26.lcssa, i32* %k, align 4
