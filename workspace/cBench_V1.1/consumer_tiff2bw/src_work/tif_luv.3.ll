...
; <label>:146:                                    ; preds = %141, %._crit_edge
...
; <label>:151:                                    ; preds = %146, %._crit_edge
...
; <label>:21:                                     ; preds = %._crit_edge, %._crit_edge1, %1
...
; <label>:23:                                     ; preds = %._crit_edge2, %._crit_edge3, %1
...
; <label>:25:                                     ; preds = %._crit_edge, %._crit_edge1, %1
...
; <label>:288:                                    ; preds = %276, %._crit_edge
...
; <label>:297:                                    ; preds = %285, %._crit_edge
