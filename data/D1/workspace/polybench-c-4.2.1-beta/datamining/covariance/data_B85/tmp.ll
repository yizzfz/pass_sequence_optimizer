...
.lr.ph34.split.us.preheader:
  %sunkaddr111 = ptrtoint double* %3 to i64
...
.lr.ph34.split.us:                                ; preds = %._crit_edge30.us, %.lr.ph34.split.us.preheader
  ...
  %4 = getelementptr inbounds double, double* %3, i64 %indvars.iv79
  store double 0.000000e+00, double* %4, align 8
  %sunkaddr112 = shl i64 %indvars.iv79, 3
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph34.split.us
  ...
  %6 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv75, i64 %indvars.iv79
  %7 = load double, double* %6, align 8
  %8 = fadd double %5, %7
  store double %8, double* %sunkaddr114, align 8
  %indvars.iv.next76 = add nuw nsw i64 %indvars.iv75, 1
  %9 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next76, i64 %indvars.iv79
  %10 = load double, double* %9, align 8
  %11 = fadd double %8, %10
  store double %11, double* %sunkaddr114, align 8
  %indvars.iv.next76.1 = add nuw nsw i64 %indvars.iv75, 2
  %12 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next76.1, i64 %indvars.iv79
  %13 = load double, double* %12, align 8
  %14 = fadd double %11, %13
  store double %14, double* %sunkaddr114, align 8
  %indvars.iv.next76.2 = add nuw nsw i64 %indvars.iv75, 3
  %15 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next76.2, i64 %indvars.iv79
  %16 = load double, double* %15, align 8
  %17 = fadd double %14, %16
  store double %17, double* %sunkaddr114, align 8
  %indvars.iv.next76.3 = add nuw nsw i64 %indvars.iv75, 4
  %18 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next76.3, i64 %indvars.iv79
  %19 = load double, double* %18, align 8
  %20 = fadd double %17, %19
  store double %20, double* %sunkaddr114, align 8
...
._crit_edge30.us:                                 ; preds = %._crit_edge
  %21 = fdiv double %20, %0
  %sunkaddr27 = shl i64 %indvars.iv79, 3
  ...
  br i1 %exitcond94, label %._crit_edge30.us..preheader6.us_crit_edge, label %.lr.ph34.split.us

._crit_edge30.us..preheader6.us_crit_edge:        ; preds = %._crit_edge30.us
  %scevgep8 = getelementptr double, double* %3, i64 1200
  br label %vector.memcheck

vector.memcheck:                                  ; preds = %._crit_edge25.us, %._crit_edge30.us..preheader6.us_crit_edge
  %indvars.iv70 = phi i64 [ 0, %._crit_edge30.us..preheader6.us_crit_edge ], [ %22, %._crit_edge25.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv70, i64 0
  %22 = add nuw nsw i64 %indvars.iv70, 1
  %scevgep6 = getelementptr [1200 x double], [1200 x double]* %1, i64 %22, i64 0
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %25 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv70, i64 %offset.idx
  %26 = bitcast double* %25 to <8 x double>*
  %wide.vec13 = load <8 x double>, <8 x double>* %26, align 8, !alias.scope !4, !noalias !1
  %27 = fsub <8 x double> %wide.vec13, %wide.vec
  ...
  %32 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv70, i64 %31
  ...
  br i1 %38, label %._crit_edge25.us.loopexit30, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv66 = phi i64 [ %indvars.iv.next67.3, %scalar.ph ], [ 0, %scalar.ph.preheader ]
  %39 = getelementptr inbounds double, double* %3, i64 %indvars.iv66
  %40 = load double, double* %39, align 8
  %41 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv70, i64 %indvars.iv66
  %42 = load double, double* %41, align 8
  %43 = fsub double %42, %40
  store double %43, double* %41, align 8
  %indvars.iv.next67 = or i64 %indvars.iv66, 1
  %44 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next67
  %45 = load double, double* %44, align 8
  %46 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv70, i64 %indvars.iv.next67
  %47 = load double, double* %46, align 8
  %48 = fsub double %47, %45
  store double %48, double* %46, align 8
  %indvars.iv.next67.1 = or i64 %indvars.iv66, 2
  %49 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next67.1
  %50 = load double, double* %49, align 8
  %51 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv70, i64 %indvars.iv.next67.1
  %52 = load double, double* %51, align 8
  %53 = fsub double %52, %50
  store double %53, double* %51, align 8
  %indvars.iv.next67.2 = or i64 %indvars.iv66, 3
  %54 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next67.2
  %55 = load double, double* %54, align 8
  %56 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv70, i64 %indvars.iv.next67.2
...
._crit_edge25.us.loopexit30:                      ; preds = %vector.body
  br label %._crit_edge25.us

._crit_edge25.us:                                 ; preds = %._crit_edge25.us.loopexit30, %._crit_edge25.us.loopexit
  %exitcond92 = icmp eq i64 %22, 1400
...
._crit_edge20.us-lcssa.us.us:                     ; preds = %._crit_edge.us.us
  ...
  br i1 %exitcond55, label %._crit_edge22, label %.lr.ph19.us
...
.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph19.us
  ...
  %60 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv52, i64 %indvars.iv48
...
._crit_edge.us.us:                                ; preds = %._crit_edge24
  ...
  %62 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv48, i64 %indvars.iv52
...
._crit_edge24:                                    ; preds = %._crit_edge24, %.lr.ph.us.us
  ...
  %66 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv48
  ...
  %72 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv48
  ...
  br i1 %exitcond89.1, label %._crit_edge.us.us, label %._crit_edge24
...
._crit_edge:                                      ; preds = %._crit_edge1, %10
  ...
  br i1 %exitcond9, label %._crit_edge.us, label %._crit_edge1
