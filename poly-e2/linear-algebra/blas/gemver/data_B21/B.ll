...
for.body3.us.preheader:                           ; preds = %vector.memcheck
  br label %for.body3.us

vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  %index = phi i64 [ %index.next, %vector.body ], [ 0, %vector.body.preheader ]
  %offset.idx = shl i64 %index, 1
  %13 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv35, i64 %offset.idx
  ...
  %24 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv35, i64 %23
  ...
  br i1 %31, label %for.cond1.for.inc20_crit_edge.us.loopexit77, label %vector.body, !llvm.loop !13

for.body3.us:                                     ; preds = %for.body3.us.preheader, %for.body3.us
  %indvars.iv31 = phi i64 [ %indvars.iv.next32.1, %for.body3.us ], [ 0, %for.body3.us.preheader ]
  ...
  br i1 %exitcond34.1, label %for.cond1.for.inc20_crit_edge.us.loopexit, label %for.body3.us, !llvm.loop !16

for.cond1.for.inc20_crit_edge.us.loopexit:        ; preds = %for.body3.us
  br label %for.cond1.for.inc20_crit_edge.us

for.cond1.for.inc20_crit_edge.us.loopexit77:      ; preds = %vector.body
  br label %for.cond1.for.inc20_crit_edge.us

for.cond1.for.inc20_crit_edge.us:                 ; preds = %for.cond1.for.inc20_crit_edge.us.loopexit77, %for.cond1.for.inc20_crit_edge.us.loopexit
  %indvars.iv.next36 = add nuw nsw i64 %indvars.iv35, 1
  %exitcond38 = icmp eq i64 %indvars.iv.next36, 2000
  br i1 %exitcond38, label %for.cond26.preheader.us.preheader, label %vector.memcheck
...
for.cond26.preheader.us:                          ; preds = %for.cond26.preheader.us.preheader, %for.cond26.for.inc45_crit_edge.us
  ...
  %sunkaddr69 = shl i64 %indvars.iv27, 3
...
for.body28.us:                                    ; preds = %for.body28.us, %for.cond26.preheader.us
  ...
  %indvars.iv23 = phi i64 [ 0, %for.cond26.preheader.us ], [ %indvars.iv.next24.1, %for.body28.us ]
  ...
  store double %add39.us, double* %sunkaddr71, align 8
...
vector.body33:                                    ; preds = %vector.body33.preheader, %vector.body33
  ...
  br i1 %65, label %for.cond64.preheader.us.preheader.loopexit76, label %vector.body33, !llvm.loop !22

for.cond64.preheader.us.preheader.loopexit:       ; preds = %for.body50
  br label %for.cond64.preheader.us.preheader

for.cond64.preheader.us.preheader.loopexit76:     ; preds = %vector.body33
  br label %for.cond64.preheader.us.preheader

for.cond64.preheader.us.preheader:                ; preds = %for.cond64.preheader.us.preheader.loopexit76, %for.cond64.preheader.us.preheader.loopexit
  %sunkaddr72 = ptrtoint double* %w to i64
...
for.cond64.preheader.us:                          ; preds = %for.cond64.preheader.us.preheader, %for.cond64.for.inc83_crit_edge.us
  ...
  %sunkaddr73 = shl i64 %indvars.iv15, 3
...
for.body66.us:                                    ; preds = %for.body66.us, %for.cond64.preheader.us
  %66 = phi double [ %.pre2, %for.cond64.preheader.us ], [ %add77.us.1, %for.body66.us ]
  ...
  store double %add77.us, double* %sunkaddr75, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %add77.us.1, double* %sunkaddr75, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
...
for.body50:                                       ; preds = %for.body50.preheader, %for.body50
  %indvars.iv19 = phi i64 [ %indvars.iv.next20.3, %for.body50 ], [ 0, %for.body50.preheader ]
  ...
  br i1 %exitcond22.3, label %for.cond64.preheader.us.preheader.loopexit, label %for.body50, !llvm.loop !23
