...
for.body:                                         ; preds = %for.body.preheader48, %for.body
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.body ], [ %indvars.iv13.ph, %for.body.preheader48 ]
...
for.cond.for.end41_crit_edge:                     ; preds = %for.cond.for.end41_crit_edge.loopexit65, %for.cond.for.end41_crit_edge.loopexit, %middle.block
  %inc40.lcssa.in = phi i64 [ %ind.end, %middle.block ], [ %indvars.iv.next10, %for.cond.for.end41_crit_edge.loopexit ], [ %indvars.iv.next14, %for.cond.for.end41_crit_edge.loopexit65 ]
