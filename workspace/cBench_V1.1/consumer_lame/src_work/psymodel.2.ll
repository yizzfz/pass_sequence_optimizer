...
@__llvm_prf_nm = private constant [35 x i8] c"\19!x\DA\F31.(\AEL\CE\C8\8FO\CCK\CCa\F41.H,J\8C/JML\01\00v\AB\090", section "__llvm_prf_names"
@llvm.used = appending global [3 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_L3psycho_anal to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_L3para_read to i8*), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
...
; <label>:1154:                                   ; preds = %._crit_edge3, %1127
...
; <label>:1334:                                   ; preds = %._crit_edge4, %1294
...
; <label>:1554:                                   ; preds = %._crit_edge5, %1553
...
; <label>:1729:                                   ; preds = %._crit_edge, %1707
  br label %1730
...
; <label>:2690:                                   ; preds = %._crit_edge2, %2666, %2423
  br label %2691
