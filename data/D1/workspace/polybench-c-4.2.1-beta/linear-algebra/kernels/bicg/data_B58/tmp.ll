...
.lr.ph12:                                         ; preds = %.lr.ph12.preheader, %._crit_edge
  %indvars.iv110 = phi i64 [ %indvars.iv.next2, %._crit_edge ], [ 0, %.lr.ph12.preheader ]
  %6 = trunc i64 %indvars.iv110 to i32
  %7 = srem i32 %6, 20
  %8 = icmp eq i32 %7, 0
...
._crit_edge:                                      ; preds = %.lr.ph12, %9
  ...
  %12 = getelementptr inbounds double, double* %0, i64 %indvars.iv110
  %13 = load double, double* %12, align 8
  ...
  %exitcond14 = icmp eq i64 %indvars.iv.next2, 1900
...
.lr.ph:                                           ; preds = %._crit_edge13, %._crit_edge3
  %indvars.iv7 = phi i64 [ %indvars.iv.next, %._crit_edge3 ], [ 0, %._crit_edge13 ]
  %19 = trunc i64 %indvars.iv7 to i32
  %20 = srem i32 %19, 20
  %21 = icmp eq i32 %20, 0
  br i1 %21, label %22, label %._crit_edge3
