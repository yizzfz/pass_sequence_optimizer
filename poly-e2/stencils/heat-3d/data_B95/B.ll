...
for.cond8.preheader.us:                           ; preds = %for.inc95.us, %for.cond4.preheader
  %indvar157 = phi i64 [ %indvar.next158, %for.inc95.us ], [ 0, %for.cond4.preheader ]
  %indvars.iv114 = phi i64 [ %indvars.iv.next115, %for.inc95.us ], [ 1, %for.cond4.preheader ]
  ...
  br i1 %memcheck.conflict170, label %for.inc.us.preheader, label %vector.body150.preheader

vector.body150.preheader:                         ; preds = %for.cond8.preheader.us
...
vector.body150:                                   ; preds = %vector.body150.preheader, %vector.body150
  ...
  %13 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv118, i64 %add34.us, i64 %offset.idx177
  %14 = bitcast double* %13 to <2 x double>*
  %wide.load184 = load <2 x double>, <2 x double>* %14, align 8, !alias.scope !1
  %15 = fsub <2 x double> %wide.load184, %7
  %16 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv118, i64 %sub49.us, i64 %offset.idx177
  ...
  br i1 %34, label %for.inc95.us.loopexit189, label %vector.body150, !llvm.loop !6
...
for.inc95.us.loopexit189:                         ; preds = %vector.body150
  br label %for.inc95.us

for.inc95.us:                                     ; preds = %for.inc95.us.loopexit189, %for.inc95.us.loopexit
