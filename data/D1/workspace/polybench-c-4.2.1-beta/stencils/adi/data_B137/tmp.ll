...
.preheader4:                                      ; preds = %._crit_edge16, %4
  %.0317 = phi i32 [ 1, %4 ], [ %164, %._crit_edge16 ]
  br label %.lver.check
...
._crit_edge16:                                    ; preds = %121
  %164 = add nuw nsw i32 %.0317, 1
  %exitcond49 = icmp eq i32 %164, 501
  br i1 %exitcond49, label %165, label %.preheader4

; <label>:165:                                    ; preds = %._crit_edge16
  ret void
}
