...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc16_crit_edge.us, %for.cond1.preheader.us.preheader
  %indvars.iv64 = phi i64 [ 0, %for.cond1.preheader.us.preheader ], [ %indvars.iv.next65, %for.cond1.for.inc16_crit_edge.us ]
...
for.cond1.for.inc16_crit_edge.us:                 ; preds = %for.body3.us
  ...
  %exitcond77 = icmp eq i64 %indvars.iv.next65, 1000
  br i1 %exitcond77, label %for.body26.lr.ph.preheader, label %for.cond1.preheader.us
...
for.body26.lr.ph:                                 ; preds = %for.body26.lr.ph.preheader, %for.inc51
  %indvars.iv74 = phi i3 [ %indvars.iv.next75, %for.inc51 ], [ -1, %for.body26.lr.ph.preheader ]
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.inc51 ], [ 2, %for.body26.lr.ph.preheader ]
...
for.body26.prol.loopexit.unr-lcssa:               ; preds = %for.body26.lr.ph, %for.body26.prol.preheader
  ...
  br i1 %14, label %for.cond40.preheader, label %for.body26.preheader
...
for.body43.prol.loopexit:                         ; preds = %for.body43.prol.loopexit.loopexit, %for.body43.lr.ph
  ...
  br i1 %15, label %for.inc51, label %for.body43.preheader
...
for.body26:                                       ; preds = %for.body26.preheader, %for.body26
  ...
  %30 = add nuw nsw i64 %indvars.iv, %indvars.iv57
  ...
  %32 = add nuw nsw i64 %indvars.iv.next, %indvars.iv57
...
for.body43:                                       ; preds = %for.body43.preheader1, %for.body43
  %indvars.iv48 = phi i64 [ %indvars.iv.next49.7, %for.body43 ], [ %indvars.iv48.ph, %for.body43.preheader1 ]
...
for.inc51:                                        ; preds = %for.inc51.loopexit, %middle.block, %for.body43.prol.loopexit, %for.cond40.preheader
  ...
  %exitcond76 = icmp eq i64 %indvars.iv.next58, 1000
  br i1 %exitcond76, label %for.end53, label %for.body26.lr.ph
...
for.cond1.preheader.lr.ph:
  ...
  %broadcast.splatinsert79 = insertelement <2 x double> undef, double %alpha, i32 0
  %broadcast.splat80 = shufflevector <2 x double> %broadcast.splatinsert79, <2 x double> undef, <2 x i32> zeroinitializer
  %broadcast.splatinsert81 = insertelement <2 x double> undef, double %mul44, i32 0
...
for.cond4.preheader.lr.ph:                        ; preds = %for.cond1.preheader.lr.ph, %for.inc53
  ...
  %scevgep63 = getelementptr [1200 x double], [1200 x double]* %C, i64 %0, i64 0
...
vector.memcheck:                                  ; preds = %for.cond4.preheader.lr.ph
  %scevgep67 = getelementptr [1200 x double], [1200 x double]* %B, i64 %0, i64 0
  %scevgep65 = getelementptr [1200 x double], [1200 x double]* %B, i64 %indvars.iv53, i64 0
  %bound0 = icmp ult double* %scevgep, %scevgep67
  %bound1 = icmp ult double* %scevgep65, %scevgep63
  %found.conflict = and i1 %bound0, %bound1
  %bound070 = icmp ult double* %scevgep, %arrayidx41
  %bound171 = icmp ult double* %arrayidx41, %scevgep63
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load74 = load <2 x double>, <2 x double>* %4, align 8, !alias.scope !8, !noalias !11
  %5 = fmul <2 x double> %wide.load, %broadcast.splat76
  %6 = fmul <2 x double> %wide.load74, %broadcast.splat76
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv53, i64 %index
  %8 = bitcast double* %7 to <2 x double>*
  %wide.load77 = load <2 x double>, <2 x double>* %8, align 8, !alias.scope !14
  %9 = getelementptr double, double* %7, i64 2
  %10 = bitcast double* %9 to <2 x double>*
  %wide.load78 = load <2 x double>, <2 x double>* %10, align 8, !alias.scope !14
  %11 = fmul <2 x double> %wide.load77, %broadcast.splat80
  %12 = fmul <2 x double> %wide.load78, %broadcast.splat80
  ...
  %22 = fadd <2 x double> %broadcast.splat82, %20
  %23 = fadd <2 x double> %broadcast.splat82, %21
  ...
  br i1 %26, label %for.inc53.loopexit4, label %vector.body, !llvm.loop !16
...
for.cond4.preheader:                              ; preds = %for.cond4.preheader, %for.cond4.preheader.preheader
  ...
  %exitcond58.1 = icmp eq i64 %indvars.iv.next.1, 1200
  br i1 %exitcond58.1, label %for.inc53.loopexit3, label %for.cond4.preheader, !llvm.loop !17

for.inc53.loopexit:                               ; preds = %for.cond4.for.end_crit_edge.us
  br label %for.inc53

for.inc53.loopexit3:                              ; preds = %for.cond4.preheader
  br label %for.inc53

for.inc53.loopexit4:                              ; preds = %vector.body
  br label %for.inc53

for.inc53:                                        ; preds = %for.inc53.loopexit4, %for.inc53.loopexit3, %for.inc53.loopexit
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %exitcond59 = icmp eq i64 %indvars.iv.next54, 1000
  br i1 %exitcond59, label %for.end55, label %for.cond4.preheader.lr.ph
