...
.preheader.preheader:
  ...
  %sunkaddr6 = ptrtoint double* %2 to i64
  br label %.preheader
...
; <label>:7:                                      ; preds = %7, %.preheader
  ...
  %10 = load double, double* %sunkaddr5, align 8
