...
@__llvm_prf_nm = private constant [93 x i8] c"\BE\01Zx\DA}\8EK\0A\800\0C\05\F1B\82[w\A2\F7\08\A5M0\D2\1FIz\7F\8B\EED]>\E6\0D\CC\C1\99\0D\EA\DE\88 \A0/\01e\B0T\A71\C6Y\CDIgN\F5\E3poH\BE\C1\B6\02\B1\A8\BD\B1\E5\87uO\908\E3\87\F8\80U\8A\C7\DE#x\C5\9D\AD\08G\22", section "__llvm_prf_names"
@llvm.used = appending global [9 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jinit_phuff_decoder to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_start_pass_phuff_decoder to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_decode_mcu_DC_first to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_decode_mcu_AC_first to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_decode_mcu_DC_refine to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_decode_mcu_AC_refine to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_process_restart to i8*), i8* bitcast ([18 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([93 x i8], [93 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
