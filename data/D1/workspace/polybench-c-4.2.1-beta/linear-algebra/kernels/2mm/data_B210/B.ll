...
._crit_edge88:                                    ; preds = %._crit_edge88, %.lr.ph8.split.us
  %indvars.iv54 = phi i64 [ 0, %.lr.ph8.split.us ], [ %indvars.iv.next55, %._crit_edge88 ]
  ...
  br i1 %exitcond57, label %._crit_edge6.us, label %._crit_edge88

._crit_edge6.us:                                  ; preds = %._crit_edge88
...
._crit_edge89:                                    ; preds = %._crit_edge89, %.lr.ph2.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph2.split.us ], [ %indvars.iv.next, %._crit_edge89 ]
...
._crit_edge12.us:                                 ; preds = %._crit_edge9.us.us
  ...
  %exitcond95 = icmp eq i64 %indvar.next, 800
  br i1 %exitcond95, label %.lr.ph.us.us.preheader.preheader, label %.lr.ph8.us.us.preheader
...
._crit_edge.us.us:                                ; preds = %._crit_edge101
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1
  %exitcond67 = icmp eq i64 %indvars.iv.next65, 1200
  br i1 %exitcond67, label %._crit_edge3.us, label %.lr.ph.us.us

._crit_edge101:                                   ; preds = %._crit_edge101, %.lr.ph.us.us
  %30 = phi double [ %29, %.lr.ph.us.us ], [ %48, %._crit_edge101 ]
  %indvars.iv62 = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next63.2, %._crit_edge101 ]
  ...
  br i1 %exitcond.2, label %._crit_edge.us.us, label %._crit_edge101
