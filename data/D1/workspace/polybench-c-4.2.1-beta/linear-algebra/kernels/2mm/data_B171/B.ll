...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge7
  %indvars.iv23 = phi i64 [ 0, %._crit_edge7 ], [ %indvars.iv.next24, %._crit_edge ]
  %7 = mul nuw nsw i64 %indvars.iv23, %indvars.iv26
  %8 = add nuw nsw i64 %7, 1
  %9 = trunc i64 %8 to i32
  %10 = srem i32 %9, 800
  %11 = sitofp i32 %10 to double
  %12 = fdiv double %11, 8.000000e+02
  %13 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv26, i64 %indvars.iv23
  store double %12, double* %13, align 8
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  %exitcond25 = icmp eq i64 %indvars.iv.next24, 1100
  br i1 %exitcond25, label %14, label %._crit_edge

; <label>:14:                                     ; preds = %._crit_edge
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv26, 1
  %exitcond28 = icmp eq i64 %indvars.iv.next27, 800
  br i1 %exitcond28, label %.preheader2.preheader, label %._crit_edge7

.preheader2.preheader:                            ; preds = %14
  br label %.preheader2

.preheader2:                                      ; preds = %.preheader2.preheader, %28
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %28 ], [ 0, %.preheader2.preheader ]
  br label %._crit_edge8

._crit_edge8:                                     ; preds = %._crit_edge8, %.preheader2
  %indvars.iv17 = phi i64 [ 0, %.preheader2 ], [ %indvars.iv.next18.1, %._crit_edge8 ]
  %indvars.iv.next18 = or i64 %indvars.iv17, 1
  %15 = mul nuw nsw i64 %indvars.iv.next18, %indvars.iv20
  %16 = trunc i64 %15 to i32
  %17 = srem i32 %16, 900
  %18 = sitofp i32 %17 to double
  %19 = getelementptr inbounds [900 x double], [900 x double]* %3, i64 %indvars.iv20, i64 %indvars.iv17
  ...
  %exitcond19.1 = icmp eq i64 %indvars.iv.next18.1, 900
  br i1 %exitcond19.1, label %28, label %._crit_edge8

; <label>:28:                                     ; preds = %._crit_edge8
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  %exitcond22 = icmp eq i64 %indvars.iv.next21, 1100
  br i1 %exitcond22, label %.preheader1.preheader, label %.preheader2

.preheader1.preheader:                            ; preds = %28
  br label %.preheader1

.preheader1:                                      ; preds = %.preheader1.preheader, %37
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %37 ], [ 0, %.preheader1.preheader ]
  br label %._crit_edge9

._crit_edge9:                                     ; preds = %._crit_edge9, %.preheader1
  %indvars.iv11 = phi i64 [ 0, %.preheader1 ], [ %indvars.iv.next12, %._crit_edge9 ]
  %29 = add nuw nsw i64 %indvars.iv11, 3
  ...
  %36 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv14, i64 %indvars.iv11
  store double %35, double* %36, align 8
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond13 = icmp eq i64 %indvars.iv.next12, 1200
  br i1 %exitcond13, label %37, label %._crit_edge9

; <label>:37:                                     ; preds = %._crit_edge9
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  %exitcond16 = icmp eq i64 %indvars.iv.next15, 900
  br i1 %exitcond16, label %.preheader.preheader, label %.preheader1

.preheader.preheader:                             ; preds = %37
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %45
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %45 ], [ 0, %.preheader.preheader ]
...
._crit_edge10:                                    ; preds = %._crit_edge10, %.preheader
  ...
  %39 = mul nuw nsw i64 %38, %indvars.iv8
  %40 = trunc i64 %39 to i32
  %41 = srem i32 %40, 1100
  %42 = sitofp i32 %41 to double
  %43 = fdiv double %42, 1.100000e+03
  %44 = getelementptr inbounds [1200 x double], [1200 x double]* %5, i64 %indvars.iv8, i64 %indvars.iv
...
; <label>:45:                                     ; preds = %._crit_edge10
  ...
  %exitcond10 = icmp eq i64 %indvars.iv.next9, 800
...
._crit_edge6:                                     ; preds = %24, %._crit_edge7
  %indvars.iv15 = phi i64 [ 0, %._crit_edge7 ], [ %indvars.iv.next16, %24 ]
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge6
  %indvars.iv12 = phi i64 [ 0, %._crit_edge6 ], [ %indvars.iv.next13.1, %._crit_edge ]
  %9 = phi double [ 0.000000e+00, %._crit_edge6 ], [ %23, %._crit_edge ]
  %10 = getelementptr inbounds [1100 x double], [1100 x double]* %3, i64 %indvars.iv18, i64 %indvars.iv12
  %11 = load double, double* %10, align 8
  %12 = fmul double %11, %0
  %13 = getelementptr inbounds [900 x double], [900 x double]* %4, i64 %indvars.iv12, i64 %indvars.iv15
  %14 = load double, double* %13, align 8
  %15 = fmul double %12, %14
  %16 = fadd double %15, %9
  store double %16, double* %8, align 8
  %indvars.iv.next13 = or i64 %indvars.iv12, 1
  %17 = getelementptr inbounds [1100 x double], [1100 x double]* %3, i64 %indvars.iv18, i64 %indvars.iv.next13
  %18 = load double, double* %17, align 8
  %19 = fmul double %18, %0
  %20 = getelementptr inbounds [900 x double], [900 x double]* %4, i64 %indvars.iv.next13, i64 %indvars.iv15
  ...
  br i1 %exitcond14.1, label %24, label %._crit_edge

; <label>:24:                                     ; preds = %._crit_edge
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  %exitcond17 = icmp eq i64 %indvars.iv.next16, 900
  br i1 %exitcond17, label %25, label %._crit_edge6

; <label>:25:                                     ; preds = %24
  %indvars.iv.next19 = add nuw nsw i64 %indvars.iv18, 1
  %exitcond20 = icmp eq i64 %indvars.iv.next19, 800
  br i1 %exitcond20, label %.preheader.preheader, label %._crit_edge7
...
._crit_edge9:                                     ; preds = %48, %.preheader
  %indvars.iv6 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next7, %48 ]
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv9, i64 %indvars.iv6
...
._crit_edge8:                                     ; preds = %._crit_edge8, %._crit_edge9
  %indvars.iv = phi i64 [ 0, %._crit_edge9 ], [ %indvars.iv.next.2, %._crit_edge8 ]
  %29 = phi double [ %28, %._crit_edge9 ], [ %47, %._crit_edge8 ]
  %30 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv9, i64 %indvars.iv
  %31 = load double, double* %30, align 8
  %32 = getelementptr inbounds [1200 x double], [1200 x double]* %5, i64 %indvars.iv, i64 %indvars.iv6
  %33 = load double, double* %32, align 8
  %34 = fmul double %31, %33
  %35 = fadd double %34, %29
  store double %35, double* %26, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %36 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv9, i64 %indvars.iv.next
  %37 = load double, double* %36, align 8
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %5, i64 %indvars.iv.next, i64 %indvars.iv6
  %39 = load double, double* %38, align 8
  %40 = fmul double %37, %39
  %41 = fadd double %40, %35
  store double %41, double* %26, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %42 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv9, i64 %indvars.iv.next.1
  %43 = load double, double* %42, align 8
  %44 = getelementptr inbounds [1200 x double], [1200 x double]* %5, i64 %indvars.iv.next.1, i64 %indvars.iv6
...
; <label>:48:                                     ; preds = %._crit_edge8
  ...
  br i1 %exitcond8, label %49, label %._crit_edge9
...
._crit_edge._crit_edge:                           ; preds = %._crit_edge, %._crit_edge2
  %indvars.iv = phi i64 [ 0, %._crit_edge2 ], [ %indvars.iv.next, %._crit_edge ]
...
; <label>:17:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond4, label %18, label %._crit_edge2
