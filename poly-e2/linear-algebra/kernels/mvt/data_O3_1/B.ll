...
for.body3.us.prol.loopexit:                       ; preds = %for.body3.us.prol, %for.cond1.preheader.us
  ...
  br i1 %0, label %for.cond1.for.inc12_crit_edge.us, label %for.body3.us.preheader

for.body3.us.preheader:                           ; preds = %for.body3.us.prol.loopexit
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us.preheader, %for.body3.us
  %indvars.iv12 = phi i64 [ %indvars.iv.next13.1, %for.body3.us ], [ %indvars.iv12.unr.ph, %for.body3.us.preheader ]
  ...
  br i1 %exitcond15.1, label %for.cond1.for.inc12_crit_edge.us.loopexit, label %for.body3.us
...
for.body20.us.prol.loopexit:                      ; preds = %for.body20.us.prol, %for.cond18.preheader.us
  ...
  br i1 %9, label %for.cond18.for.inc36_crit_edge.us, label %for.body20.us.preheader
