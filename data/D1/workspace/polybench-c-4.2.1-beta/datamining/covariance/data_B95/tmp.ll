...
._crit_edge:                                      ; preds = %._crit_edge.._crit_edge_crit_edge, %.preheader
  ...
  br i1 %exitcond.1, label %17, label %._crit_edge.._crit_edge_crit_edge
...
.lr.ph34.split.us:                                ; preds = %._crit_edge30.us..lr.ph34.split.us_crit_edge, %.lr.ph34.split.us.preheader
  %indvars.iv79 = phi i64 [ 0, %.lr.ph34.split.us.preheader ], [ %indvars.iv.next80, %._crit_edge30.us..lr.ph34.split.us_crit_edge ]
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv79
  store double 0.000000e+00, double* %5, align 8
  %sunkaddr112 = shl i64 %indvars.iv79, 3
  %sunkaddr113 = add i64 %4, %sunkaddr112
  %sunkaddr114 = inttoptr i64 %sunkaddr113 to double*
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.._crit_edge_crit_edge, %.lr.ph34.split.us
  %indvars.iv75 = phi i64 [ 0, %.lr.ph34.split.us ], [ %indvars.iv.next76.4, %._crit_edge.._crit_edge_crit_edge ]
  %6 = phi double [ 0.000000e+00, %.lr.ph34.split.us ], [ %21, %._crit_edge.._crit_edge_crit_edge ]
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv75, i64 %indvars.iv79
  %8 = load double, double* %7, align 8
  %9 = fadd double %6, %8
  store double %9, double* %sunkaddr114, align 8
  %indvars.iv.next76 = add nuw nsw i64 %indvars.iv75, 1
  %10 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next76, i64 %indvars.iv79
  %11 = load double, double* %10, align 8
  %12 = fadd double %9, %11
  store double %12, double* %sunkaddr114, align 8
  ...
  store double %15, double* %sunkaddr114, align 8
  ...
  store double %18, double* %sunkaddr114, align 8
  ...
  store double %21, double* %sunkaddr114, align 8
  %indvars.iv.next76.4 = add nuw nsw i64 %indvars.iv75, 5
  %exitcond93.4 = icmp eq i64 %indvars.iv.next76.4, 1400
  br i1 %exitcond93.4, label %._crit_edge30.us, label %._crit_edge.._crit_edge_crit_edge
...
._crit_edge30.us:                                 ; preds = %._crit_edge
  %22 = fdiv double %21, %0
  store double %22, double* %sunkaddr114, align 8
  %indvars.iv.next80 = add nuw nsw i64 %indvars.iv79, 1
  %exitcond94 = icmp eq i64 %indvars.iv.next80, 1200
  br i1 %exitcond94, label %._crit_edge30.us..preheader6.us_crit_edge, label %._crit_edge30.us..lr.ph34.split.us_crit_edge

._crit_edge30.us..lr.ph34.split.us_crit_edge:     ; preds = %._crit_edge30.us
  br label %.lr.ph34.split.us
...
vector.memcheck:                                  ; preds = %._crit_edge25.us.vector.memcheck_crit_edge, %._crit_edge30.us..preheader6.us_crit_edge
  %indvars.iv70 = phi i64 [ 0, %._crit_edge30.us..preheader6.us_crit_edge ], [ %23, %._crit_edge25.us.vector.memcheck_crit_edge ]
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.body.preheader
  ...
  br i1 %39, label %._crit_edge25.us.loopexit27, label %vector.body.vector.body_crit_edge, !llvm.loop !6

vector.body.vector.body_crit_edge:                ; preds = %vector.body
  br label %vector.body

scalar.ph:                                        ; preds = %scalar.ph.scalar.ph_crit_edge, %scalar.ph.preheader
  %indvars.iv66 = phi i64 [ %indvars.iv.next67.3, %scalar.ph.scalar.ph_crit_edge ], [ 0, %scalar.ph.preheader ]
  ...
  br i1 %exitcond91.3, label %._crit_edge25.us.loopexit, label %scalar.ph.scalar.ph_crit_edge, !llvm.loop !9
...
._crit_edge25.us:                                 ; preds = %._crit_edge25.us.loopexit27, %._crit_edge25.us.loopexit
  ...
  br i1 %exitcond92, label %.preheader.us.preheader, label %._crit_edge25.us.vector.memcheck_crit_edge

._crit_edge25.us.vector.memcheck_crit_edge:       ; preds = %._crit_edge25.us
  br label %vector.memcheck
...
.lr.ph19.us:                                      ; preds = %._crit_edge20.us-lcssa.us.us..lr.ph19.us_crit_edge, %.preheader.us.preheader
  %indvars.iv52 = phi i64 [ 0, %.preheader.us.preheader ], [ %indvars.iv.next53, %._crit_edge20.us-lcssa.us.us..lr.ph19.us_crit_edge ]
  br label %.lr.ph.us.us

._crit_edge20.us-lcssa.us.us:                     ; preds = %._crit_edge.us.us
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1
  %exitcond55 = icmp eq i64 %indvars.iv.next53, 1200
  br i1 %exitcond55, label %._crit_edge22, label %._crit_edge20.us-lcssa.us.us..lr.ph19.us_crit_edge

._crit_edge20.us-lcssa.us.us..lr.ph19.us_crit_edge: ; preds = %._crit_edge20.us-lcssa.us.us
  br label %.lr.ph19.us

.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us..lr.ph.us.us_crit_edge, %.lr.ph19.us
  %indvars.iv48 = phi i64 [ %indvars.iv52, %.lr.ph19.us ], [ %indvars.iv.next49, %._crit_edge.us.us..lr.ph.us.us_crit_edge ]
...
._crit_edge.us.us:                                ; preds = %._crit_edge21
  ...
  br i1 %exitcond, label %._crit_edge20.us-lcssa.us.us, label %._crit_edge.us.us..lr.ph.us.us_crit_edge

._crit_edge.us.us..lr.ph.us.us_crit_edge:         ; preds = %._crit_edge.us.us
  br label %.lr.ph.us.us

._crit_edge21:                                    ; preds = %._crit_edge21.._crit_edge21_crit_edge, %.lr.ph.us.us
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %._crit_edge21.._crit_edge21_crit_edge ]
  %64 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %76, %._crit_edge21.._crit_edge21_crit_edge ]
  ...
  br i1 %exitcond89.1, label %._crit_edge.us.us, label %._crit_edge21.._crit_edge21_crit_edge
...
._crit_edge:                                      ; preds = %._crit_edge2.._crit_edge_crit_edge, %10
  ...
  br i1 %exitcond9, label %._crit_edge.us, label %._crit_edge.._crit_edge2_crit_edge
