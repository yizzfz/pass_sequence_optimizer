...
entry:
  ...
  call void @kernel_deriche(i32 4096, i32 2160, float %0, [2160 x float]* %arraydecay, [2160 x float]* %arraydecay4, [2160 x float]* %arraydecay7, [2160 x float]* %arraydecay8)
...
if.then:                                          ; preds = %land.lhs.true
  call void @print_array(i32 4096, i32 2160, [2160 x float]* %arraydecay4)
  br label %if.end
...
define internal void @init_array(i32 %w, i32 %h, float* %alpha, [2160 x float]* %imgIn) #2 {
entry:
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc7_crit_edge.us, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge
  %indvars.iv14 = phi i64 [ 0, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge ], [ %indvars.iv.next15, %for.cond1.for.inc7_crit_edge.us ]
...
for.cond31.preheader.lr.ph:                       ; preds = %entry
  ...
  br i1 %cmp32152, label %for.cond31.preheader.lr.ph.for.cond31.preheader.us_crit_edge, label %for.end207
...
for.cond31.preheader.us:                          ; preds = %for.cond31.for.inc55_crit_edge.us, %for.cond31.preheader.lr.ph.for.cond31.preheader.us_crit_edge
  %indvars.iv211 = phi i64 [ 0, %for.cond31.preheader.lr.ph.for.cond31.preheader.us_crit_edge ], [ %indvars.iv.next212, %for.cond31.for.inc55_crit_edge.us ]
...
for.inc.us.prol.loopexit:                         ; preds = %for.cond31.preheader.us, %for.inc.us.prol
  %indvars.iv205.unr.ph = phi i64 [ 1, %for.inc.us.prol ], [ 0, %for.cond31.preheader.us ]
  %xm1.0155.us.unr.ph = phi float [ %3, %for.inc.us.prol ], [ 0.000000e+00, %for.cond31.preheader.us ]
  %ym1.0154.us.unr.ph = phi float [ %add42.us.prol, %for.inc.us.prol ], [ 0.000000e+00, %for.cond31.preheader.us ]
  br i1 %1, label %for.cond31.for.inc55_crit_edge.us, label %for.inc.us.preheader
...
for.inc.us:                                       ; preds = %for.inc.us.preheader, %for.inc.us
  ...
  %xm1.0155.us = phi float [ %7, %for.inc.us ], [ %xm1.0155.us.unr.ph, %for.inc.us.preheader ]
...
for.inc84.us:                                     ; preds = %for.inc84.us, %for.cond62.preheader.us
  %indvars.iv198 = phi i64 [ %8, %for.cond62.preheader.us ], [ %indvars.iv.next199, %for.inc84.us ]
  %xp1.0148.us = phi float [ 0.000000e+00, %for.cond62.preheader.us ], [ %9, %for.inc84.us ]
...
for.cond92.preheader.lr.ph:                       ; preds = %for.cond89.preheader
  ...
  br i1 %cmp93139, label %for.cond92.preheader.lr.ph.for.cond92.preheader.us_crit_edge, label %for.end207

for.cond92.preheader.lr.ph.for.cond92.preheader.us_crit_edge: ; preds = %for.cond92.preheader.lr.ph
...
for.cond92.preheader.us:                          ; preds = %for.cond92.for.inc112_crit_edge.us, %for.cond92.preheader.lr.ph.for.cond92.preheader.us_crit_edge
  %indvars.iv193 = phi i64 [ 0, %for.cond92.preheader.lr.ph.for.cond92.preheader.us_crit_edge ], [ %indvars.iv.next194, %for.cond92.for.inc112_crit_edge.us ]
...
for.inc109.us.prol.loopexit:                      ; preds = %for.cond92.preheader.us, %for.inc109.us.prol
  %indvars.iv187.unr.ph = phi i64 [ 1, %for.inc109.us.prol ], [ 0, %for.cond92.preheader.us ]
  br i1 %10, label %for.cond92.for.inc112_crit_edge.us, label %for.inc109.us.preheader
...
for.cond118.preheader.lr.ph:                      ; preds = %for.cond115.preheader
  ...
  br i1 %cmp119132, label %for.cond118.preheader.lr.ph.for.cond118.preheader.us_crit_edge, label %for.end207
...
for.cond118.preheader.us:                         ; preds = %for.cond118.for.inc147_crit_edge.us, %for.cond118.preheader.lr.ph.for.cond118.preheader.us_crit_edge
  %indvars.iv182 = phi i64 [ 0, %for.cond118.preheader.lr.ph.for.cond118.preheader.us_crit_edge ], [ %indvars.iv.next183, %for.cond118.for.inc147_crit_edge.us ]
...
for.inc144.us.prol.loopexit:                      ; preds = %for.cond118.preheader.us, %for.inc144.us.prol
  %indvars.iv176.unr.ph = phi i64 [ 1, %for.inc144.us.prol ], [ 0, %for.cond118.preheader.us ]
  %tm1.0135.us.unr.ph = phi float [ %45, %for.inc144.us.prol ], [ 0.000000e+00, %for.cond118.preheader.us ]
  %ym1.1134.us.unr.ph = phi float [ %add131.us.prol, %for.inc144.us.prol ], [ 0.000000e+00, %for.cond118.preheader.us ]
  br i1 %43, label %for.cond118.for.inc147_crit_edge.us, label %for.inc144.us.preheader
...
for.inc144.us:                                    ; preds = %for.inc144.us.preheader, %for.inc144.us
  ...
  %tm1.0135.us = phi float [ %49, %for.inc144.us ], [ %tm1.0135.us.unr.ph, %for.inc144.us.preheader ]
...
for.inc176.us:                                    ; preds = %for.inc176.us, %for.cond154.preheader.us
  %indvars.iv169 = phi i64 [ %50, %for.cond154.preheader.us ], [ %indvars.iv.next170, %for.inc176.us ]
  %tp1.0128.us = phi float [ 0.000000e+00, %for.cond154.preheader.us ], [ %51, %for.inc176.us ]
...
for.cond185.preheader.us:                         ; preds = %for.cond185.for.inc205_crit_edge.us, %for.cond185.preheader.lr.ph.for.cond185.preheader.us_crit_edge
  %indvars.iv165 = phi i64 [ 0, %for.cond185.preheader.lr.ph.for.cond185.preheader.us_crit_edge ], [ %indvars.iv.next166, %for.cond185.for.inc205_crit_edge.us ]
...
for.inc202.us.prol.loopexit:                      ; preds = %for.cond185.preheader.us, %for.inc202.us.prol
  %indvars.iv.unr.ph = phi i64 [ 1, %for.inc202.us.prol ], [ 0, %for.cond185.preheader.us ]
  br i1 %52, label %for.cond185.for.inc205_crit_edge.us, label %for.inc202.us.preheader
