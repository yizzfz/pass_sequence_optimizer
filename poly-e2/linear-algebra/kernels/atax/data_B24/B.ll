...
for.cond7.preheader.us:                           ; preds = %for.cond7.for.inc22_crit_edge.us, %for.cond7.preheader.us.preheader
  %indvars.iv15 = phi i64 [ 0, %for.cond7.preheader.us.preheader ], [ %indvars.iv.next16, %for.cond7.for.inc22_crit_edge.us ]
...
for.body:                                         ; preds = %for.body, %entry
  %indvars.iv17 = phi i64 [ 0, %entry ], [ %indvars.iv.next18, %for.body ]
  ...
  %cmp = icmp slt i64 %indvars.iv.next18, 2100
  br i1 %cmp, label %for.body, label %for.cond7.preheader.us.preheader
...
for.body5.us.preheader:                           ; preds = %for.body
  ...
  %scevgep7 = getelementptr double, double* %y, i64 2100
  br label %for.body5.us

for.body5.us:                                     ; preds = %for.inc42.us, %for.body5.us.preheader
  %indvars.iv66 = phi i64 [ 0, %for.body5.us.preheader ], [ %0, %for.inc42.us ]
  %scevgep9 = getelementptr [2100 x double], [2100 x double]* %A, i64 %indvars.iv66, i64 1
  %0 = add i64 %indvars.iv66, 1
  %scevgep11 = getelementptr [2100 x double], [2100 x double]* %A, i64 %0, i64 0
...
for.body26.us.for.body26.us_crit_edge:            ; preds = %for.body26.us.for.body26.us_crit_edge, %for.body26.us.for.body26.us_crit_edge.preheader
  %indvars.iv.next655 = phi i64 [ %indvars.iv.next655.ph, %for.body26.us.for.body26.us_crit_edge.preheader ], [ %indvars.iv.next65, %for.body26.us.for.body26.us_crit_edge ]
  %.pre = load double, double* %arrayidx7.us, align 8
  %arrayidx28.us = getelementptr inbounds double, double* %y, i64 %indvars.iv.next655
  %1 = load double, double* %arrayidx28.us, align 8
  %arrayidx32.us = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv66, i64 %indvars.iv.next655
  ...
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv.next655, 1
...
for.body10.us:                                    ; preds = %for.body10.us, %for.body5.us
  %3 = phi double [ 0.000000e+00, %for.body5.us ], [ %add.us, %for.body10.us ]
...
for.body26.us.preheader:                          ; preds = %for.body10.us
  ...
  %arrayidx32.us2 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv66, i64 0
  %7 = load double, double* %arrayidx32.us2, align 8
  %mul35.us3 = fmul double %7, %add.us
  %add36.us4 = fadd double %6, %mul35.us3
  store double %add36.us4, double* %y, align 8
  %bound0 = icmp ult double* %scevgep, %arrayidx7.us
  %bound1 = icmp ult double* %arrayidx7.us, %scevgep7
  %found.conflict = and i1 %bound0, %bound1
  %bound014 = icmp ult double* %scevgep, %scevgep11
  %bound115 = icmp ult double* %scevgep9, %scevgep7
...
for.body26.us.for.body26.us_crit_edge.preheader:  ; preds = %for.body26.us.for.body26.us_crit_edge.preheader.loopexit, %for.body26.us.preheader
  %indvars.iv.next655.ph = phi i64 [ 1, %for.body26.us.preheader ], [ 2097, %for.body26.us.for.body26.us_crit_edge.preheader.loopexit ]
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %8 = load double, double* %arrayidx7.us, align 8, !alias.scope !4
  %9 = insertelement <2 x double> undef, double %8, i32 0
  %10 = shufflevector <2 x double> %9, <2 x double> undef, <2 x i32> zeroinitializer
  %11 = getelementptr inbounds double, double* %y, i64 %offset.idx
  %12 = bitcast double* %11 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %12, align 8, !alias.scope !7, !noalias !9
  %13 = getelementptr double, double* %11, i64 2
  %14 = bitcast double* %13 to <2 x double>*
  %wide.load18 = load <2 x double>, <2 x double>* %14, align 8, !alias.scope !7, !noalias !9
  %15 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv66, i64 %offset.idx
  %16 = bitcast double* %15 to <2 x double>*
  %wide.load19 = load <2 x double>, <2 x double>* %16, align 8, !alias.scope !11
  %17 = getelementptr double, double* %15, i64 2
  %18 = bitcast double* %17 to <2 x double>*
  %wide.load20 = load <2 x double>, <2 x double>* %18, align 8, !alias.scope !11
  %19 = fmul <2 x double> %wide.load19, %10
  %20 = fmul <2 x double> %wide.load20, %10
  %21 = fadd <2 x double> %wide.load, %19
  %22 = fadd <2 x double> %wide.load18, %20
  store <2 x double> %21, <2 x double>* %12, align 8, !alias.scope !7, !noalias !9
  store <2 x double> %22, <2 x double>* %14, align 8, !alias.scope !7, !noalias !9
  %index.next = add i64 %index, 4
  %23 = icmp eq i64 %index.next, 2096
  br i1 %23, label %for.body26.us.for.body26.us_crit_edge.preheader.loopexit, label %vector.body, !llvm.loop !12

for.body:                                         ; preds = %for.body, %entry
  %indvars.iv77 = phi i64 [ 0, %entry ], [ %indvars.iv.next78, %for.body ]
  %indvars.iv.next78 = add nsw i64 %indvars.iv77, 1
  %cmp = icmp slt i64 %indvars.iv.next78, 2100
  br i1 %cmp, label %for.body, label %for.body5.us.preheader
