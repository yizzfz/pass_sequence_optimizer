...
for.cond1.preheader.us:                           ; preds = %for.cond1.preheader.us.preheader, %for.cond6.for.inc32_crit_edge.us
  ...
  %1 = add nuw nsw i64 %indvars.iv1320.us, 1
...
for.body3.us.prol.loopexit:                       ; preds = %for.body3.us.prol.loopexit.loopexit, %for.cond1.preheader.us
  ...
  %3 = icmp ult i64 %indvars.iv1320.us, 3
  br i1 %3, label %for.cond9.preheader.us.preheader, label %for.body3.us.preheader

for.body3.us.preheader:                           ; preds = %for.body3.us.prol.loopexit
  %4 = sub i64 %0, %indvars.iv15.us.unr
  %5 = lshr i64 %4, 2
  %6 = add nuw nsw i64 %5, 1
  %min.iters.check = icmp ult i64 %6, 2
  br i1 %min.iters.check, label %for.body3.us.preheader39, label %min.iters.checked

min.iters.checked:                                ; preds = %for.body3.us.preheader
  %n.mod.vf = and i64 %6, 1
  %n.vec = sub nsw i64 %6, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  %7 = add i64 %indvars.iv15.us.unr, 4
  %8 = shl nuw i64 %5, 2
  %9 = add i64 %7, %8
  %10 = shl nuw nsw i64 %n.mod.vf, 2
  %ind.end = sub i64 %9, %10
  br i1 %cmp.zero, label %for.body3.us.preheader39, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %11 = shl i64 %index, 2
  %12 = add i64 %indvars.iv15.us.unr, %11
  %13 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv1320.us, i64 %12
  %14 = bitcast double* %13 to <8 x double>*
  %wide.vec = load <8 x double>, <8 x double>* %14, align 8
  %strided.vec = shufflevector <8 x double> %wide.vec, <8 x double> undef, <2 x i32> <i32 0, i32 4>
  %strided.vec34 = shufflevector <8 x double> %wide.vec, <8 x double> undef, <2 x i32> <i32 1, i32 5>
  %strided.vec35 = shufflevector <8 x double> %wide.vec, <8 x double> undef, <2 x i32> <i32 2, i32 6>
  %strided.vec36 = shufflevector <8 x double> %wide.vec, <8 x double> undef, <2 x i32> <i32 3, i32 7>
  %15 = fmul <2 x double> %strided.vec, %broadcast.splat38
  %16 = fmul <2 x double> %strided.vec34, %broadcast.splat38
  %17 = fmul <2 x double> %strided.vec35, %broadcast.splat38
  %18 = add nsw i64 %12, 3
  %19 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv1320.us, i64 %18
  %20 = fmul <2 x double> %strided.vec36, %broadcast.splat38
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.cond9.preheader.us.preheader, label %for.body3.us.preheader39

for.body3.us.preheader39:                         ; preds = %middle.block, %min.iters.checked, %for.body3.us.preheader
...
for.body3.us:                                     ; preds = %for.body3.us.preheader39, %for.body3.us
  %indvars.iv15.us = phi i64 [ %indvars.iv.next.us.3, %for.body3.us ], [ %indvars.iv15.us.ph, %for.body3.us.preheader39 ]
...
for.inc29.us:                                     ; preds = %for.inc29.us.loopexit, %for.body11.us.prol.loopexit
  ...
  %exitcond27 = icmp eq i64 %indvars.iv.next10.us, 1000
  br i1 %exitcond27, label %for.cond6.for.inc32_crit_edge.us, label %for.cond9.preheader.us
...
for.cond6.for.inc32_crit_edge.us:                 ; preds = %for.inc29.us
  ...
  %exitcond28 = icmp eq i64 %indvars.iv.next14.us, 1200
  br i1 %exitcond28, label %for.end34, label %for.cond1.preheader.us
