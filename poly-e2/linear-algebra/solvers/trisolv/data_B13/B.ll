...
for.body6.lr.ph:                                  ; preds = %for.end, %for.body.lr.ph
  %indvars.iv5 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next6, %for.end ]
...
entry:
  ...
  br i1 %cmp9, label %for.body.lr.ph, label %for.end24

for.body.lr.ph:                                   ; preds = %entry
  %sunkaddr4 = ptrtoint double* %x to i64
  %sunkaddr = ptrtoint double* %x to i64
  %0 = sext i32 %n to i64
  br label %for.body

for.body:                                         ; preds = %for.end, %for.body.lr.ph
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.end ], [ 0, %for.body.lr.ph ]
  %indvars.iv10 = phi i32 [ %indvars.iv.next11, %for.end ], [ -1, %for.body.lr.ph ]
  %1 = add nuw nsw i64 %indvars.iv12, 4294967295
  %2 = and i64 %1, 4294967295
  %arrayidx = getelementptr inbounds double, double* %b, i64 %indvars.iv12
  %3 = load double, double* %arrayidx, align 8
  %arrayidx2 = getelementptr inbounds double, double* %x, i64 %indvars.iv12
  store double %3, double* %arrayidx2, align 8
  %cmp48 = icmp sgt i64 %indvars.iv12, 0
  br i1 %cmp48, label %for.body5.lr.ph, label %for.end

for.body5.lr.ph:                                  ; preds = %for.body
  %sunkaddr1 = shl nsw i64 %indvars.iv12, 3
...
for.body5.prol:                                   ; preds = %for.body5.prol.preheader
  %arrayidx9.prol = getelementptr inbounds [2000 x double], [2000 x double]* %L, i64 %indvars.iv12, i64 0
  %5 = load double, double* %arrayidx9.prol, align 8
  %6 = load double, double* %x, align 8
  %mul.prol = fmul double %5, %6
  %sub.prol = fsub double %3, %mul.prol
  store double %sub.prol, double* %sunkaddr3, align 8
...
for.body5.prol.loopexit.unr-lcssa:                ; preds = %for.body5.lr.ph, %for.body5.prol
  ...
  %.unr.ph = phi double [ %sub.prol, %for.body5.prol ], [ %3, %for.body5.lr.ph ]
  br label %for.body5.prol.loopexit

for.body5.prol.loopexit:                          ; preds = %for.body5.prol.loopexit.unr-lcssa
  %7 = icmp eq i64 %2, 0
  br i1 %7, label %for.end.loopexit, label %for.body5.lr.ph.new
...
for.body5:                                        ; preds = %for.body5, %for.body5.lr.ph.new
  ...
  %8 = phi double [ %.unr.ph, %for.body5.lr.ph.new ], [ %sub.1, %for.body5 ]
  %arrayidx9 = getelementptr inbounds [2000 x double], [2000 x double]* %L, i64 %indvars.iv12, i64 %indvars.iv
  ...
  store double %sub, double* %sunkaddr3, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx9.1 = getelementptr inbounds [2000 x double], [2000 x double]* %L, i64 %indvars.iv12, i64 %indvars.iv.next
  ...
  store double %sub.1, double* %sunkaddr3, align 8
...
for.end:                                          ; preds = %for.end.loopexit, %for.body
  ...
  %arrayidx19 = getelementptr inbounds [2000 x double], [2000 x double]* %L, i64 %indvars.iv12, i64 %indvars.iv12
  ...
  %exitcond = icmp ne i64 %indvars.iv.next13, %0
...
for.body:                                         ; preds = %if.end, %for.body.preheader
  ...
  %5 = phi %struct._IO_FILE* [ %3, %for.body.preheader ], [ %9, %if.end ]
