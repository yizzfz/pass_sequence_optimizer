...
entry:
  ...
  br i1 %cmp2, label %for.inc.preheader, label %for.end
...
for.inc.prol.loopexit:                            ; preds = %for.inc.preheader, %for.inc.prol.preheader
  %indvars.iv3.unr = phi i64 [ 0, %for.inc.preheader ], [ 1, %for.inc.prol.preheader ]
  %2 = icmp eq i32 %n, 1
...
for.inc:                                          ; preds = %for.inc, %for.inc.preheader.new
  %indvars.iv3 = phi i64 [ %indvars.iv3.unr, %for.inc.preheader.new ], [ %indvars.iv.next.1, %for.inc ]
...
for.cond1.preheader:                              ; preds = %for.inc33, %for.cond1.preheader.lr.ph
  ...
  br i1 %cmp211, label %for.inc.lr.ph, label %for.inc33

for.inc.lr.ph:                                    ; preds = %for.cond1.preheader
  br i1 %min.iters.check35, label %for.inc.preheader, label %min.iters.checked36

for.inc.preheader:                                ; preds = %middle.block33, %vector.memcheck52, %min.iters.checked36, %for.inc.lr.ph
  %indvars.iv12.ph = phi i64 [ 1, %vector.memcheck52 ], [ 1, %min.iters.checked36 ], [ 1, %for.inc.lr.ph ], [ %ind.end, %middle.block33 ]
...
for.inc.prol.loopexit.unr-lcssa:                  ; preds = %for.inc.preheader, %for.inc.prol.preheader
  %indvars.iv12.unr.ph = phi i64 [ %indvars.iv.next.prol, %for.inc.prol.preheader ], [ %indvars.iv12.ph, %for.inc.preheader ]
...
min.iters.checked36:                              ; preds = %for.inc.lr.ph
  br i1 %cmp.zero, label %for.inc.preheader, label %vector.memcheck52
...
for.inc30.lr.ph:                                  ; preds = %for.cond13.preheader
  br i1 %min.iters.check35, label %for.inc30.preheader, label %min.iters.checked

for.inc30.preheader:                              ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.inc30.lr.ph
  %indvars.iv814.ph = phi i64 [ 1, %vector.memcheck ], [ 1, %min.iters.checked ], [ 1, %for.inc30.lr.ph ], [ %ind.end, %middle.block ]
  %32 = sub nsw i64 %0, %indvars.iv814.ph
  %xtraiter70 = and i64 %32, 1
  %lcmp.mod71 = icmp eq i64 %xtraiter70, 0
  br i1 %lcmp.mod71, label %for.inc30.prol.loopexit.unr-lcssa, label %for.inc30.prol.preheader
...
for.inc30.prol.loopexit.unr-lcssa:                ; preds = %for.inc30.preheader, %for.inc30.prol.preheader
  %indvars.iv814.unr.ph = phi i64 [ %indvars.iv.next9.prol, %for.inc30.prol.preheader ], [ %indvars.iv814.ph, %for.inc30.preheader ]
...
for.inc:                                          ; preds = %for.inc, %for.inc.preheader.new
  %indvars.iv12 = phi i64 [ %indvars.iv12.unr.ph, %for.inc.preheader.new ], [ %indvars.iv.next.1, %for.inc ]
...
for.inc30:                                        ; preds = %for.inc30, %for.inc30.preheader.new
  %indvars.iv814 = phi i64 [ %indvars.iv814.unr.ph, %for.inc30.preheader.new ], [ %indvars.iv.next9.1, %for.inc30 ]
  ...
  br i1 %exitcond18.1, label %for.inc33.loopexit.unr-lcssa, label %for.inc30, !llvm.loop !16
