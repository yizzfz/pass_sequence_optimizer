...
.preheader6:                                      ; preds = %._crit_edge16, %.preheader6.lr.ph
  ...
  br i1 %16, label %.preheader5.lr.ph, label %._crit_edge16
...
.preheader5.prol.loopexit:                        ; preds = %.preheader5.preheader, %.preheader5.prol.loopexit.unr-lcssa
  ...
  br i1 %21, label %._crit_edge16.loopexit118, label %.preheader5.preheader.new
...
.preheader5.us:                                   ; preds = %._crit_edge14.us, %.preheader5.us.preheader
  ...
  %22 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv64, i64 %indvars.iv62, i64 0
...
._crit_edge14.us:                                 ; preds = %._crit_edge14.us.loopexit, %middle.block
  ...
  %exitcond120 = icmp eq i64 %indvars.iv.next63, %9
  br i1 %exitcond120, label %._crit_edge16.loopexit, label %.preheader5.us

.lr.ph13.us:                                      ; preds = %.lr.ph13.us.preheader117, %.lr.ph13.us
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %.lr.ph13.us ], [ %indvars.iv60.ph, %.lr.ph13.us.preheader117 ]
  %23 = getelementptr inbounds double, double* %5, i64 %indvars.iv60
  %24 = bitcast double* %23 to i64*
  %25 = load i64, i64* %24, align 8
  %26 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv64, i64 %indvars.iv62, i64 %indvars.iv60
  %27 = bitcast double* %26 to i64*
  store i64 %25, i64* %27, align 8
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  %28 = icmp slt i64 %indvars.iv.next61, %8
  br i1 %28, label %.lr.ph13.us, label %._crit_edge14.us.loopexit, !llvm.loop !3

.lr.ph13.us.preheader:                            ; preds = %._crit_edge.us.us
  %scevgep79 = getelementptr [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv64, i64 %indvars.iv62, i64 %8
  br i1 %min.iters.check, label %.lr.ph13.us.preheader117, label %min.iters.checked

.lr.ph13.us.preheader117:                         ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.lr.ph13.us.preheader
...
min.iters.checked:                                ; preds = %.lr.ph13.us.preheader
  br i1 %cmp.zero, label %.lr.ph13.us.preheader117, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %bound0 = icmp ult double* %scevgep, %scevgep81
  %bound1 = icmp ugt double* %scevgep79, %5
  %memcheck.conflict = and i1 %bound0, %bound1
  br i1 %memcheck.conflict, label %.lr.ph13.us.preheader117, label %vector.body.preheader
...
vector.body.prol:                                 ; preds = %vector.body.prol, %vector.body.prol.preheader
  ...
  %33 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv64, i64 %indvars.iv62, i64 %index.prol
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader.new
  ...
  %41 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv64, i64 %indvars.iv62, i64 %index
  ...
  %49 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv64, i64 %indvars.iv62, i64 %index.next
  ...
  %57 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv64, i64 %indvars.iv62, i64 %index.next.1
  ...
  %65 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv64, i64 %indvars.iv62, i64 %index.next.2
...
middle.block:                                     ; preds = %vector.body.prol.loopexit, %middle.block.unr-lcssa
  br i1 %cmp.n, label %._crit_edge14.us, label %.lr.ph13.us.preheader117

.lr.ph.us.us:                                     ; preds = %.preheader5.us, %._crit_edge.us.us
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %._crit_edge.us.us ], [ 0, %.preheader5.us ]
  %70 = getelementptr inbounds double, double* %5, i64 %indvars.iv56
...
.prol.preheader:                                  ; preds = %.lr.ph.us.us
  ...
  %sunkaddr70 = shl i64 %indvars.iv56, 3
  %sunkaddr71 = add i64 %sunkaddr, %sunkaddr70
  %sunkaddr72 = inttoptr i64 %sunkaddr71 to double*
  %75 = load double, double* %sunkaddr72, align 8
  %76 = fadd double %74, %75
  store double %76, double* %sunkaddr72, align 8
...
.lr.ph.us.us.new.preheader:                       ; preds = %.prol.loopexit
  %sunkaddr74 = shl i64 %indvars.iv56, 3
...
._crit_edge.us.us:                                ; preds = %._crit_edge.us.us.loopexit, %.prol.loopexit
  ...
  %exitcond = icmp eq i64 %indvars.iv.next57, %11
...
.lr.ph.us.us.new:                                 ; preds = %.lr.ph.us.us.new.preheader, %.lr.ph.us.us.new
  ...
  %77 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv64, i64 %indvars.iv62, i64 %indvars.iv52
  %78 = load double, double* %77, align 8
  %79 = getelementptr inbounds [160 x double], [160 x double]* %4, i64 %indvars.iv52, i64 %indvars.iv56
  %80 = load double, double* %79, align 8
  %81 = fmul double %78, %80
  %82 = load double, double* %sunkaddr76, align 8
  %83 = fadd double %81, %82
  store double %83, double* %sunkaddr76, align 8
  ...
  store double %89, double* %sunkaddr76, align 8
  %indvars.iv.next53.1 = add nuw nsw i64 %indvars.iv52, 2
  %exitcond55.1 = icmp eq i64 %indvars.iv.next53.1, %11
...
.preheader5:                                      ; preds = %.preheader5, %.preheader5.preheader.new
  ...
  %exitcond119.7 = icmp eq i64 %indvars.iv.next49.7, %9
  br i1 %exitcond119.7, label %._crit_edge16.loopexit118.unr-lcssa, label %.preheader5

._crit_edge16.loopexit:                           ; preds = %._crit_edge14.us
  br label %._crit_edge16

._crit_edge16.loopexit118.unr-lcssa:              ; preds = %.preheader5
  br label %._crit_edge16.loopexit118

._crit_edge16.loopexit118:                        ; preds = %.preheader5.prol.loopexit, %._crit_edge16.loopexit118.unr-lcssa
  br label %._crit_edge16

._crit_edge16:                                    ; preds = %._crit_edge16.loopexit118, %._crit_edge16.loopexit, %.preheader6
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1
  %exitcond121 = icmp eq i64 %indvars.iv.next65, %10
  br i1 %exitcond121, label %._crit_edge32.loopexit, label %.preheader6
...
._crit_edge18.us:                                 ; preds = %._crit_edge16.us.us
  ...
  %exitcond68 = icmp eq i64 %indvars.iv.next58, 150
...
; <label>:6:                                      ; preds = %6, %.preheader6.us.us
  ...
  br i1 %exitcond.1, label %._crit_edge16.us.us, label %6
...
; <label>:20:                                     ; preds = %20, %.preheader.us
  ...
  br i1 %exitcond62.1, label %._crit_edge.us, label %20

._crit_edge.us:                                   ; preds = %20
  %indvars.iv.next47 = add nuw nsw i64 %indvars.iv46, 1
  %exitcond67 = icmp eq i64 %indvars.iv.next47, 160
