...
for.body64.us.for.body64.us_crit_edge.prol.loopexit.unr-lcssa: ; preds = %for.body64.us.for.body64.us_crit_edge.preheader, %for.body64.us.for.body64.us_crit_edge.prol
  ...
  %xp1.027.us137.unr.ph = phi float [ %16, %for.body64.us.for.body64.us_crit_edge.prol ], [ 0.000000e+00, %for.body64.us.for.body64.us_crit_edge.preheader ]
...
for.body64.us.for.body64.us_crit_edge.prol.loopexit: ; preds = %for.body64.us.for.body64.us_crit_edge.prol.loopexit.unr-lcssa
  br i1 %15, label %for.cond62.for.inc86_crit_edge.us.loopexit, label %for.body64.us.for.body64.us_crit_edge.preheader.new
...
for.body64.us.for.body64.us_crit_edge:            ; preds = %for.body64.us.for.body64.us_crit_edge, %for.body64.us.for.body64.us_crit_edge.preheader.new
  ...
  %xp1.027.us137 = phi float [ %xp1.027.us137.unr.ph, %for.body64.us.for.body64.us_crit_edge.preheader.new ], [ %18, %for.body64.us.for.body64.us_crit_edge ]
...
for.cond62.for.inc86_crit_edge.us:                ; preds = %for.cond62.for.inc86_crit_edge.us.loopexit, %for.cond62.preheader.us
  ...
  %cmp59.us = icmp slt i64 %indvars.iv.next72, %13
...
for.cond92.preheader.us.preheader:                ; preds = %for.cond92.preheader.lr.ph
  %19 = add i32 %h, -1
  %20 = sext i32 %w to i64
  %wide.trip.count64 = zext i32 %19 to i64
  %21 = add nuw nsw i64 %wide.trip.count76, 1
  %22 = and i64 %21, 8589934584
  %23 = add nsw i64 %22, -8
  %24 = lshr exact i64 %23, 3
  %25 = add nuw nsw i64 %wide.trip.count76, 1
  %min.iters.check = icmp ult i64 %21, 8
  %n.vec = and i64 %21, 8589934584
  %cmp.zero = icmp eq i64 %n.vec, 0
  %26 = and i64 %24, 1
  %lcmp.mod222 = icmp eq i64 %26, 0
  %27 = icmp eq i64 %24, 0
...
for.cond92.preheader.us:                          ; preds = %for.cond92.for.inc112_crit_edge.us, %for.cond92.preheader.us.preheader
  ...
  %scevgep155 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv66, i64 %21
  %scevgep157 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv66, i64 0
  %scevgep159 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv66, i64 %21
  %scevgep161 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv66, i64 0
  %scevgep163 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv66, i64 %21
...
vector.body.prol:                                 ; preds = %vector.body.prol.preheader
  %28 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv66, i64 0
  %29 = bitcast float* %28 to <4 x float>*
  %wide.load.prol = load <4 x float>, <4 x float>* %29, align 4, !alias.scope !6
  %30 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv66, i64 4
  %31 = bitcast float* %30 to <4 x float>*
  %wide.load169.prol = load <4 x float>, <4 x float>* %31, align 4, !alias.scope !6
  %32 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv66, i64 0
  %33 = bitcast float* %32 to <4 x float>*
  %wide.load170.prol = load <4 x float>, <4 x float>* %33, align 4, !alias.scope !9
  %34 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv66, i64 4
  %35 = bitcast float* %34 to <4 x float>*
  %wide.load171.prol = load <4 x float>, <4 x float>* %35, align 4, !alias.scope !9
  %36 = fadd <4 x float> %wide.load.prol, %wide.load170.prol
  %37 = fadd <4 x float> %wide.load169.prol, %wide.load171.prol
  %38 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv66, i64 0
  %39 = bitcast float* %38 to <4 x float>*
  store <4 x float> %36, <4 x float>* %39, align 4, !alias.scope !11, !noalias !13
  %40 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv66, i64 4
  %41 = bitcast float* %40 to <4 x float>*
  store <4 x float> %37, <4 x float>* %41, align 4, !alias.scope !11, !noalias !13
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader.new
  ...
  %42 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv66, i64 %index
  %43 = bitcast float* %42 to <4 x float>*
  %wide.load = load <4 x float>, <4 x float>* %43, align 4, !alias.scope !6
  %44 = getelementptr float, float* %42, i64 4
  %45 = bitcast float* %44 to <4 x float>*
  %wide.load169 = load <4 x float>, <4 x float>* %45, align 4, !alias.scope !6
  %46 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv66, i64 %index
  %47 = bitcast float* %46 to <4 x float>*
  %wide.load170 = load <4 x float>, <4 x float>* %47, align 4, !alias.scope !9
  %48 = getelementptr float, float* %46, i64 4
  %49 = bitcast float* %48 to <4 x float>*
  %wide.load171 = load <4 x float>, <4 x float>* %49, align 4, !alias.scope !9
  %50 = fadd <4 x float> %wide.load, %wide.load170
  %51 = fadd <4 x float> %wide.load169, %wide.load171
  %52 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv66, i64 %index
  ...
  %56 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv66, i64 %index.next
  ...
  %wide.load169.1 = load <4 x float>, <4 x float>* %59, align 4, !alias.scope !6
  %60 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv66, i64 %index.next
  %61 = bitcast float* %60 to <4 x float>*
  %wide.load170.1 = load <4 x float>, <4 x float>* %61, align 4, !alias.scope !9
  %62 = getelementptr float, float* %60, i64 4
  %63 = bitcast float* %62 to <4 x float>*
  %wide.load171.1 = load <4 x float>, <4 x float>* %63, align 4, !alias.scope !9
  %64 = fadd <4 x float> %wide.load.1, %wide.load170.1
  %65 = fadd <4 x float> %wide.load169.1, %wide.load171.1
  %66 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv66, i64 %index.next
  ...
  br i1 %70, label %middle.block.unr-lcssa, label %vector.body, !llvm.loop !14
...
for.body94.us.preheader:                          ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.cond92.preheader.us
  ...
  %71 = sub nsw i64 %25, %indvars.iv62.ph
  %xtraiter223 = and i64 %71, 1
...
for.body94.us.prol:                               ; preds = %for.body94.us.prol.preheader
  ...
  %72 = load float, float* %arrayidx98.us.prol, align 4
  %arrayidx102.us.prol = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv66, i64 %indvars.iv62.ph
  %73 = load float, float* %arrayidx102.us.prol, align 4
  %add103.us.prol = fadd float %72, %73
...
for.body94.us.prol.loopexit:                      ; preds = %for.body94.us.prol.loopexit.unr-lcssa
  %74 = icmp eq i64 %wide.trip.count76, %indvars.iv62.ph
  br i1 %74, label %for.cond92.for.inc112_crit_edge.us.loopexit, label %for.body94.us.preheader.new
...
for.body94.us:                                    ; preds = %for.body94.us, %for.body94.us.preheader.new
  ...
  %75 = load float, float* %arrayidx98.us, align 4
  %arrayidx102.us = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv66, i64 %indvars.iv62
  %76 = load float, float* %arrayidx102.us, align 4
  %add103.us = fadd float %75, %76
  ...
  %77 = load float, float* %arrayidx98.us.1, align 4
  %arrayidx102.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv66, i64 %indvars.iv.next63
  %78 = load float, float* %arrayidx102.us.1, align 4
  %add103.us.1 = fadd float %77, %78
...
for.cond92.for.inc112_crit_edge.us:               ; preds = %for.cond92.for.inc112_crit_edge.us.loopexit, %middle.block
  ...
  %cmp90.us = icmp slt i64 %indvars.iv.next67, %20
...
for.cond118.preheader.us.preheader:               ; preds = %for.cond118.preheader.lr.ph
  %79 = add i32 %w, -1
  %80 = sext i32 %h to i64
  %wide.trip.count57 = zext i32 %79 to i64
  ...
  %exitcond58121 = icmp eq i32 %79, 0
...
for.cond118.preheader.us:                         ; preds = %for.cond118.for.inc147_crit_edge.us, %for.cond118.preheader.us.preheader
  ...
  %82 = load float, float* %arrayidx124.us112, align 4
  %mul125.us113 = fmul float %div, %82
...
for.body120.us.for.body120.us_crit_edge.prol:     ; preds = %for.body120.us.for.body120.us_crit_edge.prol.preheader
  %83 = load float, float* %arrayidx124.us112, align 4
...
for.body120.us.for.body120.us_crit_edge.prol.loopexit: ; preds = %for.body120.us.for.body120.us_crit_edge.prol.loopexit.unr-lcssa
  br i1 %81, label %for.cond118.for.inc147_crit_edge.us.loopexit, label %for.body120.us.for.body120.us_crit_edge.preheader.new
...
for.body120.us.for.body120.us_crit_edge:          ; preds = %for.body120.us.for.body120.us_crit_edge, %for.body120.us.for.body120.us_crit_edge.preheader.new
  ...
  %85 = load float, float* %arrayidx124.us124, align 4
...
for.cond118.for.inc147_crit_edge.us:              ; preds = %for.cond118.for.inc147_crit_edge.us.loopexit, %for.cond118.preheader.us
  ...
  %cmp116.us = icmp slt i64 %indvars.iv.next60, %80
...
for.cond154.preheader.us.preheader:               ; preds = %for.cond154.preheader.lr.ph
  ...
  %90 = sext i32 %h to i64
  %indvars.iv.next5198 = add nsw i64 %89, -1
...
for.body156.us.for.body156.us_crit_edge.prol:     ; preds = %for.body156.us.for.body156.us_crit_edge.prol.preheader
  ...
  %93 = load float, float* %arrayidx171.us.prol, align 4
  %mul157.us.prol = fmul float %mul16.v.r2, %93
...
for.body156.us.for.body156.us_crit_edge.prol.loopexit.unr-lcssa: ; preds = %for.body156.us.for.body156.us_crit_edge.preheader, %for.body156.us.for.body156.us_crit_edge.prol
  ...
  %tp1.07.us109.unr.ph = phi float [ %93, %for.body156.us.for.body156.us_crit_edge.prol ], [ 0.000000e+00, %for.body156.us.for.body156.us_crit_edge.preheader ]
...
for.body156.us.for.body156.us_crit_edge.prol.loopexit: ; preds = %for.body156.us.for.body156.us_crit_edge.prol.loopexit.unr-lcssa
  br i1 %92, label %for.cond154.for.inc179_crit_edge.us.loopexit, label %for.body156.us.for.body156.us_crit_edge.preheader.new
...
for.body156.us.for.body156.us_crit_edge:          ; preds = %for.body156.us.for.body156.us_crit_edge, %for.body156.us.for.body156.us_crit_edge.preheader.new
  ...
  %tp1.07.us109 = phi float [ %tp1.07.us109.unr.ph, %for.body156.us.for.body156.us_crit_edge.preheader.new ], [ %95, %for.body156.us.for.body156.us_crit_edge ]
  ...
  %94 = load float, float* %arrayidx171.us, align 4
  %indvars.iv.next51 = add nsw i64 %indvars.iv.next51110, -1
  %mul157.us = fmul float %mul16.v.r2, %94
  ...
  %95 = load float, float* %arrayidx171.us.1, align 4
  %indvars.iv.next51.1 = add nsw i64 %indvars.iv.next51110, -2
  %mul157.us.1 = fmul float %mul16.v.r2, %95
  %mul158.us.1 = fmul float %94, %mul25
...
for.cond154.for.inc179_crit_edge.us:              ; preds = %for.cond154.for.inc179_crit_edge.us.loopexit, %for.cond154.preheader.us
  ...
  %cmp151.us = icmp slt i64 %indvars.iv.next53, %90
...
for.cond185.preheader.us.preheader:               ; preds = %for.cond182.preheader
  ...
  %102 = add nuw nsw i64 %wide.trip.count, 1
  %min.iters.check175 = icmp ult i64 %98, 8
  %n.vec178 = and i64 %98, 8589934584
  %cmp.zero179 = icmp eq i64 %n.vec178, 0
  %103 = and i64 %101, 1
  %lcmp.mod = icmp eq i64 %103, 0
  %104 = icmp eq i64 %101, 0
  %cmp.n206 = icmp eq i64 %98, %n.vec178
...
for.cond185.preheader.us:                         ; preds = %for.cond185.for.inc205_crit_edge.us, %for.cond185.preheader.us.preheader
  ...
  %scevgep183 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv47, i64 %98
  %scevgep185 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv47, i64 0
  %scevgep187 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv47, i64 %98
  %scevgep189 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 0
  %scevgep191 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 %98
...
vector.body172.prol:                              ; preds = %vector.body172.prol.preheader
  ...
  %wide.load211.prol = load <4 x float>, <4 x float>* %106, align 4, !alias.scope !16
  %107 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv47, i64 4
  %108 = bitcast float* %107 to <4 x float>*
  %wide.load212.prol = load <4 x float>, <4 x float>* %108, align 4, !alias.scope !16
  %109 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 0
  %110 = bitcast float* %109 to <4 x float>*
  %wide.load213.prol = load <4 x float>, <4 x float>* %110, align 4, !alias.scope !19
  %111 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 4
  %112 = bitcast float* %111 to <4 x float>*
  %wide.load214.prol = load <4 x float>, <4 x float>* %112, align 4, !alias.scope !19
  %113 = fadd <4 x float> %wide.load211.prol, %wide.load213.prol
  %114 = fadd <4 x float> %wide.load212.prol, %wide.load214.prol
...
vector.body172.prol.loopexit:                     ; preds = %vector.body172.prol.loopexit.unr-lcssa
  br i1 %104, label %middle.block173, label %vector.body172.preheader.new
...
vector.body172:                                   ; preds = %vector.body172, %vector.body172.preheader.new
  ...
  %119 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv47, i64 %index203
  %120 = bitcast float* %119 to <4 x float>*
  %wide.load211 = load <4 x float>, <4 x float>* %120, align 4, !alias.scope !16
  %121 = getelementptr float, float* %119, i64 4
  %122 = bitcast float* %121 to <4 x float>*
  %wide.load212 = load <4 x float>, <4 x float>* %122, align 4, !alias.scope !16
  %123 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 %index203
  %124 = bitcast float* %123 to <4 x float>*
  %wide.load213 = load <4 x float>, <4 x float>* %124, align 4, !alias.scope !19
  %125 = getelementptr float, float* %123, i64 4
  %126 = bitcast float* %125 to <4 x float>*
  %wide.load214 = load <4 x float>, <4 x float>* %126, align 4, !alias.scope !19
  %127 = fadd <4 x float> %wide.load211, %wide.load213
  %128 = fadd <4 x float> %wide.load212, %wide.load214
  %129 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv47, i64 %index203
  ...
  %133 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv47, i64 %index.next204
  %134 = bitcast float* %133 to <4 x float>*
  %wide.load211.1 = load <4 x float>, <4 x float>* %134, align 4, !alias.scope !16
  %135 = getelementptr float, float* %133, i64 4
  %136 = bitcast float* %135 to <4 x float>*
  %wide.load212.1 = load <4 x float>, <4 x float>* %136, align 4, !alias.scope !16
  %137 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 %index.next204
  %138 = bitcast float* %137 to <4 x float>*
  %wide.load213.1 = load <4 x float>, <4 x float>* %138, align 4, !alias.scope !19
  %139 = getelementptr float, float* %137, i64 4
  %140 = bitcast float* %139 to <4 x float>*
  %wide.load214.1 = load <4 x float>, <4 x float>* %140, align 4, !alias.scope !19
  %141 = fadd <4 x float> %wide.load211.1, %wide.load213.1
  %142 = fadd <4 x float> %wide.load212.1, %wide.load214.1
  %143 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv47, i64 %index.next204
  ...
  %147 = icmp eq i64 %index.next204.1, %n.vec178
  br i1 %147, label %middle.block173.unr-lcssa, label %vector.body172, !llvm.loop !24
...
middle.block173:                                  ; preds = %vector.body172.prol.loopexit, %middle.block173.unr-lcssa
  br i1 %cmp.n206, label %for.cond185.for.inc205_crit_edge.us, label %for.body187.us.preheader
...
for.body187.us.prol.loopexit:                     ; preds = %for.body187.us.prol.loopexit.unr-lcssa
  %151 = icmp eq i64 %wide.trip.count, %indvars.iv.ph
  br i1 %151, label %for.cond185.for.inc205_crit_edge.us.loopexit, label %for.body187.us.preheader.new
...
for.cond185.for.inc205_crit_edge.us:              ; preds = %for.cond185.for.inc205_crit_edge.us.loopexit, %middle.block173
  ...
  %cmp183.us = icmp slt i64 %indvars.iv.next48, %97
