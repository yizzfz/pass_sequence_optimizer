...
for.cond4.preheader:                              ; preds = %for.cond1.preheader, %for.inc98
  %indvar156 = phi i64 [ 0, %for.cond1.preheader ], [ %0, %for.inc98 ]
  %indvars.iv119 = phi i64 [ 1, %for.cond1.preheader ], [ %add, %for.inc98 ]
  %0 = add nuw nsw i64 %indvar156, 1
  %1 = add nuw nsw i64 %indvar156, 2
...
for.cond8.preheader.us:                           ; preds = %for.inc95.us, %for.cond4.preheader
  %indvar158 = phi i64 [ %2, %for.inc95.us ], [ 0, %for.cond4.preheader ]
  %indvars.iv115 = phi i64 [ %add34.us, %for.inc95.us ], [ 1, %for.cond4.preheader ]
  %2 = add nuw nsw i64 %indvar158, 1
  %scevgep160 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %0, i64 %2, i64 1
  %scevgep162 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %0, i64 %2, i64 119
  %scevgep164 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvar156, i64 %2, i64 1
  %scevgep166 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %1, i64 %2, i64 119
  ...
  br i1 %memcheck.conflict171, label %for.inc.us.preheader, label %vector.body151.preheader

vector.body151.preheader:                         ; preds = %for.cond8.preheader.us
...
vector.body151:                                   ; preds = %vector.body151.preheader, %vector.body151
  %index174 = phi i64 [ %index.next175, %vector.body151 ], [ 0, %vector.body151.preheader ]
  %offset.idx178 = or i64 %index174, 1
  %3 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %add, i64 %indvars.iv115, i64 %offset.idx178
  %4 = bitcast double* %3 to <2 x double>*
  %wide.load182 = load <2 x double>, <2 x double>* %4, align 8, !alias.scope !1
  %5 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv119, i64 %indvars.iv115, i64 %offset.idx178
  %6 = bitcast double* %5 to <2 x double>*
  %wide.load183 = load <2 x double>, <2 x double>* %6, align 8, !alias.scope !1
  %7 = fmul <2 x double> %wide.load183, <double 2.000000e+00, double 2.000000e+00>
  %8 = fsub <2 x double> %wide.load182, %7
  %9 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %sub23, i64 %indvars.iv115, i64 %offset.idx178
  %10 = bitcast double* %9 to <2 x double>*
  %wide.load184 = load <2 x double>, <2 x double>* %10, align 8, !alias.scope !1
  %11 = fadd <2 x double> %wide.load184, %8
  %12 = fmul <2 x double> %11, <double 1.250000e-01, double 1.250000e-01>
  %13 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv119, i64 %add34.us, i64 %offset.idx178
  %14 = bitcast double* %13 to <2 x double>*
  %wide.load185 = load <2 x double>, <2 x double>* %14, align 8, !alias.scope !1
  %15 = fsub <2 x double> %wide.load185, %7
  %16 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv119, i64 %sub49.us, i64 %offset.idx178
  %17 = bitcast double* %16 to <2 x double>*
  %wide.load186 = load <2 x double>, <2 x double>* %17, align 8, !alias.scope !1
  %18 = fadd <2 x double> %15, %wide.load186
  %19 = fmul <2 x double> %18, <double 1.250000e-01, double 1.250000e-01>
  %20 = fadd <2 x double> %12, %19
  %21 = add nuw nsw i64 %offset.idx178, 1
  %22 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv119, i64 %indvars.iv115, i64 %21
  %23 = bitcast double* %22 to <2 x double>*
  %wide.load187 = load <2 x double>, <2 x double>* %23, align 8, !alias.scope !1
  %24 = fsub <2 x double> %wide.load187, %7
  %25 = add nsw i64 %offset.idx178, -1
  %26 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv119, i64 %indvars.iv115, i64 %25
  %27 = bitcast double* %26 to <2 x double>*
  %wide.load188 = load <2 x double>, <2 x double>* %27, align 8, !alias.scope !1
  %28 = fadd <2 x double> %24, %wide.load188
  %29 = fmul <2 x double> %28, <double 1.250000e-01, double 1.250000e-01>
  %30 = fadd <2 x double> %20, %29
  %31 = fadd <2 x double> %wide.load183, %30
  %32 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv119, i64 %indvars.iv115, i64 %offset.idx178
  %33 = bitcast double* %32 to <2 x double>*
  store <2 x double> %31, <2 x double>* %33, align 8, !alias.scope !4, !noalias !1
  %index.next175 = add nuw nsw i64 %index174, 2
  %34 = icmp eq i64 %index.next175, 118
  br i1 %34, label %for.inc95.us.loopexit190, label %vector.body151, !llvm.loop !6
...
for.inc95.us.loopexit190:                         ; preds = %vector.body151
  br label %for.inc95.us

for.inc95.us:                                     ; preds = %for.inc95.us.loopexit190, %for.inc95.us.loopexit
  %exitcond118 = icmp eq i64 %add34.us, 119
  br i1 %exitcond118, label %for.inc98, label %for.cond8.preheader.us

for.inc98:                                        ; preds = %for.inc95.us
  %exitcond122 = icmp eq i64 %add, 119
...
for.cond105.preheader:                            ; preds = %for.cond105.preheader.preheader, %for.inc206
  %indvar = phi i64 [ %42, %for.inc206 ], [ 0, %for.cond105.preheader.preheader ]
  %indvars.iv131 = phi i64 [ %add113, %for.inc206 ], [ 1, %for.cond105.preheader.preheader ]
...
for.cond109.preheader:                            ; preds = %for.inc203, %for.cond105.preheader
  %indvar136 = phi i64 [ %44, %for.inc203 ], [ 0, %for.cond105.preheader ]
  %indvars.iv127 = phi i64 [ %add139, %for.inc203 ], [ 1, %for.cond105.preheader ]
  %44 = add nuw nsw i64 %indvar136, 1
  %scevgep = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %42, i64 %44, i64 1
  %scevgep139 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %42, i64 %44, i64 119
  %scevgep141 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvar, i64 %44, i64 1
  %scevgep143 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %43, i64 %44, i64 119
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %45 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %add113, i64 %indvars.iv127, i64 %offset.idx
  %46 = bitcast double* %45 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %46, align 8, !alias.scope !10
  %47 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv131, i64 %indvars.iv127, i64 %offset.idx
  %48 = bitcast double* %47 to <2 x double>*
  %wide.load145 = load <2 x double>, <2 x double>* %48, align 8, !alias.scope !10
  %49 = fmul <2 x double> %wide.load145, <double 2.000000e+00, double 2.000000e+00>
  %50 = fsub <2 x double> %wide.load, %49
  %51 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %sub128, i64 %indvars.iv127, i64 %offset.idx
  %52 = bitcast double* %51 to <2 x double>*
  %wide.load146 = load <2 x double>, <2 x double>* %52, align 8, !alias.scope !10
  %53 = fadd <2 x double> %wide.load146, %50
  %54 = fmul <2 x double> %53, <double 1.250000e-01, double 1.250000e-01>
  %55 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv131, i64 %add139, i64 %offset.idx
  %56 = bitcast double* %55 to <2 x double>*
  %wide.load147 = load <2 x double>, <2 x double>* %56, align 8, !alias.scope !10
  %57 = fsub <2 x double> %wide.load147, %49
  %58 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv131, i64 %sub154, i64 %offset.idx
  %59 = bitcast double* %58 to <2 x double>*
  %wide.load148 = load <2 x double>, <2 x double>* %59, align 8, !alias.scope !10
  %60 = fadd <2 x double> %57, %wide.load148
  %61 = fmul <2 x double> %60, <double 1.250000e-01, double 1.250000e-01>
  %62 = fadd <2 x double> %54, %61
  %63 = add nuw nsw i64 %offset.idx, 1
  %64 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv131, i64 %indvars.iv127, i64 %63
  %65 = bitcast double* %64 to <2 x double>*
  %wide.load149 = load <2 x double>, <2 x double>* %65, align 8, !alias.scope !10
  %66 = fsub <2 x double> %wide.load149, %49
  %67 = add nsw i64 %offset.idx, -1
  %68 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv131, i64 %indvars.iv127, i64 %67
  %69 = bitcast double* %68 to <2 x double>*
  %wide.load150 = load <2 x double>, <2 x double>* %69, align 8, !alias.scope !10
  %70 = fadd <2 x double> %66, %wide.load150
  %71 = fmul <2 x double> %70, <double 1.250000e-01, double 1.250000e-01>
  %72 = fadd <2 x double> %62, %71
  %73 = fadd <2 x double> %wide.load145, %72
  %74 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv131, i64 %indvars.iv127, i64 %offset.idx
  %75 = bitcast double* %74 to <2 x double>*
  store <2 x double> %73, <2 x double>* %75, align 8, !alias.scope !13, !noalias !10
  %index.next = add nuw nsw i64 %index, 2
  %76 = icmp eq i64 %index.next, 118
  br i1 %76, label %for.inc203.loopexit189, label %vector.body, !llvm.loop !15

for.inc200:                                       ; preds = %for.inc200.preheader, %for.inc200
  %indvars.iv123 = phi i64 [ %add166, %for.inc200 ], [ 1, %for.inc200.preheader ]
  ...
  %exitcond126 = icmp eq i64 %add166, 119
  br i1 %exitcond126, label %for.inc203.loopexit, label %for.inc200, !llvm.loop !16

for.inc203.loopexit:                              ; preds = %for.inc200
  br label %for.inc203

for.inc203.loopexit189:                           ; preds = %vector.body
  br label %for.inc203

for.inc203:                                       ; preds = %for.inc203.loopexit189, %for.inc203.loopexit
  %exitcond130 = icmp eq i64 %add139, 119
  br i1 %exitcond130, label %for.inc206, label %for.cond109.preheader

for.inc206:                                       ; preds = %for.inc203
  %exitcond134 = icmp eq i64 %add113, 119
