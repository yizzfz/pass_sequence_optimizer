...
._crit_edge.us:                                   ; preds = %._crit_edge.us.preheader, %.loopexit
  %18 = phi i32 [ %44, %.loopexit ], [ 0, %._crit_edge.us.preheader ]
...
scalar.ph49.preheader:                            ; preds = %middle.block48, %vector.memcheck68, %min.iters.checked52, %._crit_edge.us
  %indvars.iv.us.ph = phi i64 [ 1, %vector.memcheck68 ], [ 1, %min.iters.checked52 ], [ 1, %._crit_edge.us ], [ %ind.end73, %middle.block48 ]
...
vector.body47:                                    ; preds = %vector.body47.preheader, %vector.body47
  ...
  %wide.load80 = load <2 x double>, <2 x double>* %21, align 8, !alias.scope !10
  %22 = getelementptr double, double* %20, i64 2
  %23 = bitcast double* %22 to <2 x double>*
  %wide.load81 = load <2 x double>, <2 x double>* %23, align 8, !alias.scope !10
  %24 = getelementptr inbounds double, double* %2, i64 %offset.idx75
  %25 = bitcast double* %24 to <2 x double>*
  %wide.load82 = load <2 x double>, <2 x double>* %25, align 8, !alias.scope !10
  %26 = getelementptr double, double* %24, i64 2
  %27 = bitcast double* %26 to <2 x double>*
  %wide.load83 = load <2 x double>, <2 x double>* %27, align 8, !alias.scope !10
  ...
  %wide.load84 = load <2 x double>, <2 x double>* %32, align 8, !alias.scope !10
  %33 = getelementptr double, double* %31, i64 2
  %34 = bitcast double* %33 to <2 x double>*
  %wide.load85 = load <2 x double>, <2 x double>* %34, align 8, !alias.scope !10
...
.lr.ph4.us:                                       ; preds = %.lr.ph4.us.preheader87, %.lr.ph4.us
  %indvars.iv7.us = phi i64 [ %indvars.iv.next8.us, %.lr.ph4.us ], [ %indvars.iv7.us.ph, %.lr.ph4.us.preheader87 ]
  %46 = add nsw i64 %indvars.iv7.us, -1
  %47 = getelementptr inbounds double, double* %3, i64 %46
  %48 = load double, double* %47, align 8
  %49 = getelementptr inbounds double, double* %3, i64 %indvars.iv7.us
  %50 = load double, double* %49, align 8
  %51 = fadd double %48, %50
  %indvars.iv.next8.us = add nuw nsw i64 %indvars.iv7.us, 1
  %52 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next8.us
  %53 = load double, double* %52, align 8
  %54 = fadd double %51, %53
  %55 = fmul double %54, 3.333300e-01
  %56 = getelementptr inbounds double, double* %2, i64 %indvars.iv7.us
  store double %55, double* %56, align 8
  %57 = icmp slt i64 %indvars.iv.next8.us, %9
  br i1 %57, label %.lr.ph4.us, label %.loopexit.loopexit, !llvm.loop !16

scalar.ph49:                                      ; preds = %scalar.ph49.preheader, %scalar.ph49
  %indvars.iv.us = phi i64 [ %indvars.iv.next.us, %scalar.ph49 ], [ %indvars.iv.us.ph, %scalar.ph49.preheader ]
  %58 = add nsw i64 %indvars.iv.us, -1
  %59 = getelementptr inbounds double, double* %2, i64 %58
  %60 = load double, double* %59, align 8
  %61 = getelementptr inbounds double, double* %2, i64 %indvars.iv.us
  %62 = load double, double* %61, align 8
  %63 = fadd double %60, %62
  %indvars.iv.next.us = add nuw nsw i64 %indvars.iv.us, 1
  %64 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next.us
  %65 = load double, double* %64, align 8
  %66 = fadd double %63, %65
  %67 = fmul double %66, 3.333300e-01
  %68 = getelementptr inbounds double, double* %3, i64 %indvars.iv.us
  store double %67, double* %68, align 8
  %69 = icmp slt i64 %indvars.iv.next.us, %9
  br i1 %69, label %scalar.ph49, label %.lr.ph4.us.preheader.loopexit, !llvm.loop !17
...
.lr.ph4.us.preheader:                             ; preds = %.lr.ph4.us.preheader.loopexit, %middle.block48
  br i1 %min.iters.check, label %.lr.ph4.us.preheader87, label %min.iters.checked

.lr.ph4.us.preheader87:                           ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.lr.ph4.us.preheader
  %indvars.iv7.us.ph = phi i64 [ 1, %vector.memcheck ], [ 1, %min.iters.checked ], [ 1, %.lr.ph4.us.preheader ], [ %ind.end, %middle.block ]
  br label %.lr.ph4.us

min.iters.checked:                                ; preds = %.lr.ph4.us.preheader
  br i1 %cmp.zero, label %.lr.ph4.us.preheader87, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  br i1 %memcheck.conflict, label %.lr.ph4.us.preheader87, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load = load <2 x double>, <2 x double>* %72, align 8, !alias.scope !18
  %73 = getelementptr double, double* %71, i64 2
  %74 = bitcast double* %73 to <2 x double>*
  %wide.load42 = load <2 x double>, <2 x double>* %74, align 8, !alias.scope !18
  ...
  %79 = fadd <2 x double> %wide.load, %wide.load43
  %80 = fadd <2 x double> %wide.load42, %wide.load44
  %81 = add nuw nsw i64 %offset.idx, 1
  %82 = getelementptr inbounds double, double* %3, i64 %81
  %83 = bitcast double* %82 to <2 x double>*
  %wide.load45 = load <2 x double>, <2 x double>* %83, align 8, !alias.scope !18
  %84 = getelementptr double, double* %82, i64 2
  %85 = bitcast double* %84 to <2 x double>*
  %wide.load46 = load <2 x double>, <2 x double>* %85, align 8, !alias.scope !18
  %86 = fadd <2 x double> %79, %wide.load45
  %87 = fadd <2 x double> %80, %wide.load46
  ...
  store <2 x double> %88, <2 x double>* %91, align 8, !alias.scope !21, !noalias !18
  %92 = getelementptr double, double* %90, i64 2
  %93 = bitcast double* %92 to <2 x double>*
  store <2 x double> %89, <2 x double>* %93, align 8, !alias.scope !21, !noalias !18
  %index.next = add i64 %index, 4
  %94 = icmp eq i64 %index.next, %n.vec
  br i1 %94, label %middle.block, label %vector.body, !llvm.loop !23

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %.loopexit, label %.lr.ph4.us.preheader87

._crit_edge.lr.ph.split.loopexit:                 ; preds = %.loopexit
