...
; <label>:4:                                      ; preds = %._crit_edge, %.lr.ph34
  ...
  %5 = add nuw i64 %indvars.iv42, 4294967295
...
.lr.ph:                                           ; preds = %4
  %xtraiter47 = and i64 %indvars.iv42, 1
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %4, %.prol.loopexit.unr-lcssa
  %.lcssa = phi double [ %.lcssa37.unr.ph, %.prol.loopexit.unr-lcssa ], [ %7, %4 ], [ %29, %._crit_edge.loopexit ]
