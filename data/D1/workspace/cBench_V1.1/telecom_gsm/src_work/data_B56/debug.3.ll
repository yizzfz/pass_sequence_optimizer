...
@__llvm_prf_nm = private constant [71 x i8] c"E\00gsm_debug_words\01gsm_debug_longwords\01gsm_debug_longword\01gsm_debug_word", section "__llvm_prf_names"
@llvm.used = appending global [5 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_gsm_debug_words to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_gsm_debug_longwords to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_gsm_debug_longword to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_gsm_debug_word to i8*), i8* getelementptr inbounds ([71 x i8], [71 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
