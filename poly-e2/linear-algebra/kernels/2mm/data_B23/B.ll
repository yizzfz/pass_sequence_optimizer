...
; Function Attrs: noinline nounwind uwtable
define internal fastcc void @init_array(double* %alpha, double* %beta, [1100 x double]* %A, [900 x double]* %B, [1200 x double]* %C, [1200 x double]* %D) unnamed_addr #0 {
entry:
...
for.cond1.preheader:                              ; preds = %for.inc7, %entry
  %indvars.iv2837 = phi i64 [ 0, %entry ], [ %indvars.iv.next29, %for.inc7 ]
  br label %for.body3

for.body3:                                        ; preds = %for.body3, %for.cond1.preheader
  %indvars.iv2436 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next25, %for.body3 ]
  %0 = mul nuw nsw i64 %indvars.iv2436, %indvars.iv2837
  %1 = add nuw nsw i64 %0, 1
  %2 = trunc i64 %1 to i32
  %rem = srem i32 %2, 800
  %conv = sitofp i32 %rem to double
  %div = fdiv double %conv, 8.000000e+02
  %arrayidx6 = getelementptr inbounds [1100 x double], [1100 x double]* %A, i64 %indvars.iv2837, i64 %indvars.iv2436
  store double %div, double* %arrayidx6, align 8
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv2436, 1
  %exitcond43 = icmp eq i64 %indvars.iv.next25, 1100
  br i1 %exitcond43, label %for.inc7, label %for.body3

for.inc7:                                         ; preds = %for.body3
  %indvars.iv.next29 = add nuw nsw i64 %indvars.iv2837, 1
  %exitcond44 = icmp eq i64 %indvars.iv.next29, 800
  br i1 %exitcond44, label %for.cond14.preheader.preheader, label %for.cond1.preheader

for.cond14.preheader.preheader:                   ; preds = %for.inc7
  br label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond14.preheader.preheader, %for.inc31
  %indvars.iv2235 = phi i64 [ %indvars.iv.next23, %for.inc31 ], [ 0, %for.cond14.preheader.preheader ]
  br label %for.body17

for.body17:                                       ; preds = %for.body17, %for.cond14.preheader
  %indvars.iv1934 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next20.1, %for.body17 ]
  %indvars.iv.next20 = or i64 %indvars.iv1934, 1
  %3 = mul nuw nsw i64 %indvars.iv.next20, %indvars.iv2235
  %4 = trunc i64 %3 to i32
  %rem20 = srem i32 %4, 900
  %conv21 = sitofp i32 %rem20 to double
  %arrayidx27 = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv2235, i64 %indvars.iv1934
  %indvars.iv.next20.1 = add nsw i64 %indvars.iv1934, 2
  %5 = mul nuw nsw i64 %indvars.iv.next20.1, %indvars.iv2235
  ...
  %exitcond41.1 = icmp eq i64 %indvars.iv.next20.1, 900
  br i1 %exitcond41.1, label %for.inc31, label %for.body17

for.inc31:                                        ; preds = %for.body17
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv2235, 1
  %exitcond42 = icmp eq i64 %indvars.iv.next23, 1100
...
for.cond38.preheader:                             ; preds = %for.cond38.preheader.preheader, %for.inc56
  %indvars.iv1733 = phi i64 [ %indvars.iv.next18, %for.inc56 ], [ 0, %for.cond38.preheader.preheader ]
  br label %for.body41

for.body41:                                       ; preds = %for.body41, %for.cond38.preheader
  %indvars.iv1232 = phi i64 [ 0, %for.cond38.preheader ], [ %indvars.iv.next13, %for.body41 ]
  %8 = add nuw nsw i64 %indvars.iv1232, 3
  %9 = mul nuw nsw i64 %8, %indvars.iv1733
  %10 = add nuw nsw i64 %9, 1
  %11 = trunc i64 %10 to i32
  %rem45 = srem i32 %11, 1200
  %conv46 = sitofp i32 %rem45 to double
  %div48 = fdiv double %conv46, 1.200000e+03
  %arrayidx52 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv1733, i64 %indvars.iv1232
  store double %div48, double* %arrayidx52, align 8
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv1232, 1
  %exitcond39 = icmp eq i64 %indvars.iv.next13, 1200
  br i1 %exitcond39, label %for.inc56, label %for.body41

for.inc56:                                        ; preds = %for.body41
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv1733, 1
  %exitcond40 = icmp eq i64 %indvars.iv.next18, 900
  br i1 %exitcond40, label %for.cond63.preheader.preheader, label %for.cond38.preheader
...
for.cond63.preheader:                             ; preds = %for.cond63.preheader.preheader, %for.inc80
  %indvars.iv1031 = phi i64 [ %indvars.iv.next11, %for.inc80 ], [ 0, %for.cond63.preheader.preheader ]
  br label %for.body66
...
for.body66:                                       ; preds = %for.body66, %for.cond63.preheader
  ...
  %13 = mul nuw nsw i64 %12, %indvars.iv1031
  %14 = trunc i64 %13 to i32
  %rem69 = srem i32 %14, 1100
  %conv70 = sitofp i32 %rem69 to double
  %div72 = fdiv double %conv70, 1.100000e+03
  %arrayidx76 = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv1031, i64 %indvars.iv30
...
for.inc80:                                        ; preds = %for.body66
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv1031, 1
  %exitcond38 = icmp eq i64 %indvars.iv.next11, 800
  br i1 %exitcond38, label %for.end82, label %for.cond63.preheader
...
; Function Attrs: noinline nounwind uwtable
define internal fastcc void @kernel_2mm(double %alpha, double %beta, [900 x double]* %tmp, [1100 x double]* %A, [900 x double]* %B, [1200 x double]* %C, [1200 x double]* %D) unnamed_addr #0 {
entry:
  br label %for.cond4.preheader

for.cond4.preheader:                              ; preds = %for.inc28, %entry
  %indvars.iv1421 = phi i64 [ 0, %entry ], [ %indvars.iv.next15, %for.inc28 ]
  br label %for.body6

for.body6:                                        ; preds = %for.inc25, %for.cond4.preheader
  %indvars.iv1220 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next13, %for.inc25 ]
  %arrayidx8 = getelementptr inbounds [900 x double], [900 x double]* %tmp, i64 %indvars.iv1421, i64 %indvars.iv1220
...
for.body11:                                       ; preds = %for.body11, %for.body6
  ...
  %indvars.iv1019 = phi i64 [ 0, %for.body6 ], [ %indvars.iv.next11.1, %for.body11 ]
  %arrayidx15 = getelementptr inbounds [1100 x double], [1100 x double]* %A, i64 %indvars.iv1421, i64 %indvars.iv1019
  %1 = load double, double* %arrayidx15, align 8
  %mul = fmul double %1, %alpha
  %arrayidx19 = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv1019, i64 %indvars.iv1220
  ...
  %indvars.iv.next11 = or i64 %indvars.iv1019, 1
  %arrayidx15.1 = getelementptr inbounds [1100 x double], [1100 x double]* %A, i64 %indvars.iv1421, i64 %indvars.iv.next11
  %3 = load double, double* %arrayidx15.1, align 8
  %mul.1 = fmul double %3, %alpha
  %arrayidx19.1 = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv.next11, i64 %indvars.iv1220
  ...
  %indvars.iv.next11.1 = add nsw i64 %indvars.iv1019, 2
  %exitcond24.1 = icmp eq i64 %indvars.iv.next11.1, 1100
  br i1 %exitcond24.1, label %for.inc25, label %for.body11

for.inc25:                                        ; preds = %for.body11
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv1220, 1
  %exitcond25 = icmp eq i64 %indvars.iv.next13, 900
  br i1 %exitcond25, label %for.inc28, label %for.body6

for.inc28:                                        ; preds = %for.inc25
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv1421, 1
  %exitcond27 = icmp eq i64 %indvars.iv.next15, 800
  br i1 %exitcond27, label %for.cond34.preheader.preheader, label %for.cond4.preheader

for.cond34.preheader.preheader:                   ; preds = %for.inc28
  br label %for.cond34.preheader

for.cond34.preheader:                             ; preds = %for.cond34.preheader.preheader, %for.inc65
  %indvars.iv818 = phi i64 [ %indvars.iv.next9, %for.inc65 ], [ 0, %for.cond34.preheader.preheader ]
  br label %for.body36

for.body36:                                       ; preds = %for.inc62, %for.cond34.preheader
  %indvars.iv617 = phi i64 [ 0, %for.cond34.preheader ], [ %indvars.iv.next7, %for.inc62 ]
  %arrayidx40 = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv818, i64 %indvars.iv617
...
for.body44:                                       ; preds = %for.body44, %for.body36
  ...
  %indvars.iv16 = phi i64 [ 0, %for.body36 ], [ %indvars.iv.next.2, %for.body44 ]
  %arrayidx48 = getelementptr inbounds [900 x double], [900 x double]* %tmp, i64 %indvars.iv818, i64 %indvars.iv16
  %7 = load double, double* %arrayidx48, align 8
  %arrayidx52 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv16, i64 %indvars.iv617
  ...
  %arrayidx48.1 = getelementptr inbounds [900 x double], [900 x double]* %tmp, i64 %indvars.iv818, i64 %indvars.iv.next
  %9 = load double, double* %arrayidx48.1, align 8
  %arrayidx52.1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv.next, i64 %indvars.iv617
  ...
  %arrayidx48.2 = getelementptr inbounds [900 x double], [900 x double]* %tmp, i64 %indvars.iv818, i64 %indvars.iv.next.1
  %11 = load double, double* %arrayidx48.2, align 8
  %arrayidx52.2 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv.next.1, i64 %indvars.iv617
  ...
  %indvars.iv.next.2 = add nsw i64 %indvars.iv16, 3
...
for.inc62:                                        ; preds = %for.body44
  ...
  %exitcond22 = icmp eq i64 %indvars.iv.next7, 1200
  br i1 %exitcond22, label %for.inc65, label %for.body36

for.inc65:                                        ; preds = %for.inc62
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv818, 1
  %exitcond23 = icmp eq i64 %indvars.iv.next9, 800
  br i1 %exitcond23, label %for.end67, label %for.cond34.preheader
...
if.end:                                           ; preds = %if.then, %for.body4
  ...
  %arrayidx8 = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv37, i64 %indvars.iv6
