...
for.inc.lr.ph:                                    ; preds = %entry, %for.inc47
  %indvars.iv53 = phi i64 [ 1, %entry ], [ %indvars.iv.next54, %for.inc47 ]
  %indvar = phi i64 [ 0, %entry ], [ %indvar.next, %for.inc47 ]
  %6 = phi double [ %sub3, %entry ], [ %div, %for.inc47 ]
  %beta.032 = phi double [ 1.000000e+00, %entry ], [ %mul5, %for.inc47 ]
  %7 = add i64 %indvar, -1
  %8 = shl i64 %indvar, 3
...
for.inc32.lr.ph:                                  ; preds = %for.inc32.lr.ph.loopexit, %for.inc.prol.loopexit
  ...
  %arrayidx16 = getelementptr inbounds double, double* %r, i64 %indvars.iv53
  ...
  %28 = and i64 %indvar, 1
  %lcmp.mod59 = icmp eq i64 %28, 0
  br i1 %lcmp.mod59, label %for.inc32.prol, label %for.inc32.prol.loopexit

for.inc32.prol:                                   ; preds = %for.inc32.lr.ph
  %29 = load double, double* %y, align 8
  %sunkaddr60 = shl i64 %indvars.iv53, 3
  %sunkaddr61 = add i64 %3, %sunkaddr60
  %sunkaddr62 = add i64 %sunkaddr61, -8
  %sunkaddr63 = inttoptr i64 %sunkaddr62 to double*
  %30 = load double, double* %sunkaddr63, align 8
...
for.inc32.prol.loopexit:                          ; preds = %for.inc32.prol, %for.inc32.lr.ph
  %indvars.iv38.unr.ph = phi i64 [ 1, %for.inc32.prol ], [ 0, %for.inc32.lr.ph ]
...
for.inc32.preheader:                              ; preds = %for.inc32.prol.loopexit
  %32 = sub i64 %7, %indvars.iv38.unr.ph
  %33 = lshr i64 %32, 1
  %34 = add nuw i64 %33, 1
...
min.iters.checked:                                ; preds = %for.inc32.preheader
  ...
  %35 = or i64 %indvars.iv38.unr.ph, 2
  %36 = shl nuw i64 %33, 1
  %37 = add i64 %35, %36
...
vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert70 = insertelement <2 x double> undef, double %div, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %39 = shl i64 %index, 1
  %offset.idx = or i64 %indvars.iv38.unr.ph, %39
  ...
  %strided.vec65 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  ...
  %wide.vec66 = load <4 x double>, <4 x double>* %45, align 8
  %strided.vec67 = shufflevector <4 x double> %wide.vec66, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %reverse = shufflevector <2 x double> %strided.vec67, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %strided.vec68 = shufflevector <4 x double> %wide.vec66, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %reverse69 = shufflevector <2 x double> %strided.vec68, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %46 = fmul <2 x double> %broadcast.splat71, %reverse69
  %47 = fadd <2 x double> %strided.vec, %46
  %48 = add nuw nsw i64 %offset.idx, 1
  %49 = fmul <2 x double> %broadcast.splat71, %reverse
  %50 = fadd <2 x double> %strided.vec65, %49
...
for.inc32.preheader1:                             ; preds = %middle.block, %min.iters.checked, %for.inc32.preheader
  %indvars.iv38.ph = phi i64 [ %indvars.iv38.unr.ph, %min.iters.checked ], [ %indvars.iv38.unr.ph, %for.inc32.preheader ], [ %ind.end, %middle.block ]
...
for.inc32:                                        ; preds = %for.inc32.preheader1, %for.inc32
  %indvars.iv38 = phi i64 [ %indvars.iv.next39.1, %for.inc32 ], [ %indvars.iv38.ph, %for.inc32.preheader1 ]
  %arrayidx23 = getelementptr inbounds double, double* %y, i64 %indvars.iv38
  %56 = bitcast double* %arrayidx23 to <2 x double>*
  %arrayidx31 = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %indvars.iv38
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  %57 = load <2 x double>, <2 x double>* %56, align 8
  %58 = sub nsw i64 %27, %indvars.iv.next39
  ...
  %exitcond44.1 = icmp eq i64 %indvars.iv.next39.1, %indvars.iv53
  br i1 %exitcond44.1, label %for.inc47.loopexit, label %for.inc32, !llvm.loop !6
...
for.inc47:                                        ; preds = %for.inc47.loopexit, %middle.block, %for.inc32.prol.loopexit
  ...
  %arrayidx46 = getelementptr inbounds double, double* %y, i64 %indvars.iv53
  store double %div, double* %arrayidx46, align 8
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %indvar.next = add nuw nsw i64 %indvar, 1
  %exitcond57 = icmp eq i64 %indvar.next, 1999
  br i1 %exitcond57, label %for.end49, label %for.inc.lr.ph
