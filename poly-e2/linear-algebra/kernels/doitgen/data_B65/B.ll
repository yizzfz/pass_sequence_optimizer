...
for.cond4.preheader.lr.ph:                        ; preds = %for.cond1.preheader
  ...
  %idxprom30.us = sext i32 %storemerge52 to i64
...
for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.inc39.us
  %13 = phi i32 [ %split20.us77, %for.inc39.us ], [ %storemerge52, %for.cond4.preheader.us.preheader ]
  %indvars.iv1124.us = phi i64 [ %indvars.iv.next12.us, %for.inc39.us ], [ 0, %for.cond4.preheader.us.preheader ]
  br i1 %6, label %for.cond4.for.cond25.preheader_crit_edge.us.thread, label %for.body6.us29.preheader
...
for.inc39.us:                                     ; preds = %for.inc39.us.loopexit, %for.body27.us.prol.loopexit, %for.cond4.for.cond25.preheader_crit_edge.us, %for.cond4.for.cond25.preheader_crit_edge.us.thread
  %split20.us77 = phi i32 [ %13, %for.cond4.for.cond25.preheader_crit_edge.us.thread ], [ %storemerge52, %for.cond4.for.cond25.preheader_crit_edge.us ], [ %storemerge52, %for.body27.us.prol.loopexit ], [ %storemerge52, %for.inc39.us.loopexit ]
...
for.body9.us32.prol.loopexit:                     ; preds = %for.body6.us29, %for.body9.us32.prol
  ...
  br i1 %8, label %for.cond7.for.inc22_crit_edge.us46, label %for.body9.us32.preheader
...
for.body9.us32:                                   ; preds = %for.body9.us32, %for.body9.us32.preheader
  %28 = phi double [ %.unr.ph, %for.body9.us32.preheader ], [ %add.us37.1, %for.body9.us32 ]
...
for.cond7.for.inc22_crit_edge.us46:               ; preds = %for.cond7.for.inc22_crit_edge.us46.loopexit, %for.body9.us32.prol.loopexit
  ...
  br i1 %exitcond57, label %for.cond4.for.cond25.preheader_crit_edge.us, label %for.body6.us29

for.cond4.for.cond25.preheader_crit_edge.us:      ; preds = %for.cond7.for.inc22_crit_edge.us46
...
for.body27.prol:                                  ; preds = %for.body27.prol.preheader, %for.body27.prol
  ...
  %arrayidx35.prol = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %idxprom30.us, i64 %indvars.iv1124, i64 %indvars.iv922.prol
...
for.body27:                                       ; preds = %for.body27.preheader, %for.body27
  ...
  %arrayidx35 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %idxprom30.us, i64 %indvars.iv1124, i64 %indvars.iv922
  ...
  %arrayidx35.1 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %idxprom30.us, i64 %indvars.iv1124, i64 %indvars.iv.next10
  ...
  %arrayidx35.2 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %idxprom30.us, i64 %indvars.iv1124, i64 %indvars.iv.next10.1
  ...
  %arrayidx35.3 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %idxprom30.us, i64 %indvars.iv1124, i64 %indvars.iv.next10.2
...
for.inc39:                                        ; preds = %for.inc39.loopexit, %for.body27.prol.loopexit, %for.cond4.preheader
  ...
  br i1 %exitcond56, label %for.inc42.loopexit80, label %for.cond4.preheader

for.inc42.loopexit:                               ; preds = %for.inc39.us
  br label %for.inc42

for.inc42.loopexit80:                             ; preds = %for.inc39
  br label %for.inc42

for.inc42:                                        ; preds = %for.inc42.loopexit80, %for.inc42.loopexit, %for.cond1.preheader
  %.lcssa14 = phi i32 [ %storemerge52, %for.cond1.preheader ], [ %split20.us77, %for.inc42.loopexit ], [ %storemerge52, %for.inc42.loopexit80 ]
