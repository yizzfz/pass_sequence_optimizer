...
for.body:                                         ; preds = %for.body, %entry
  %indvars.iv17 = phi i64 [ 0, %entry ], [ %indvars.iv.next18.4, %for.body ]
...
for.body42.us.preheader.new:                      ; preds = %for.body42.us.preheader.new.loopexit, %for.cond40.preheader.us
  %indvars.iv55.ph = phi i64 [ 1, %for.cond40.preheader.us ], [ 1197, %for.body42.us.preheader.new.loopexit ]
...
for.body76.us.preheader:                          ; preds = %for.body76.us.preheader.loopexit, %for.cond73.preheader.us
  %indvars.iv63.ph = phi i64 [ 0, %for.cond73.preheader.us ], [ 1196, %for.body76.us.preheader.loopexit ]
...
for.body4.us:                                     ; preds = %if.end.us, %for.cond2.preheader.us
  %indvars.iv53 = phi i64 [ 0, %for.cond2.preheader.us ], [ %indvars.iv.next54, %if.end.us ]
...
for.body21.us:                                    ; preds = %if.end28.us, %for.cond19.preheader.us
  %indvars.iv43 = phi i64 [ 0, %for.cond19.preheader.us ], [ %indvars.iv.next44, %if.end28.us ]
