...
.lver.check:                                      ; preds = %._crit_edge12.us, %.preheader7
  %indvar = phi i64 [ 0, %.preheader7 ], [ %6, %._crit_edge12.us ]
  %indvars.iv31 = phi i64 [ 1, %.preheader7 ], [ %indvars.iv.next32, %._crit_edge12.us ]
  %6 = add i64 %indvar, 1
  %scevgep = getelementptr [1000 x double], [1000 x double]* %4, i64 %6, i64 0
  %scevgep45 = getelementptr [1000 x double], [1000 x double]* %4, i64 %6, i64 999
  %scevgep47 = getelementptr [1000 x double], [1000 x double]* %5, i64 %6, i64 0
  %scevgep49 = getelementptr [1000 x double], [1000 x double]* %5, i64 %6, i64 999
  %7 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 0, i64 %indvars.iv31
  store double 1.000000e+00, double* %7, align 8
  %8 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv31, i64 0
  store double 0.000000e+00, double* %8, align 8
  %9 = bitcast double* %7 to i64*
  %10 = load i64, i64* %9, align 8
  %11 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv31
  %12 = bitcast [1000 x double]* %11 to i64*
  store i64 %10, i64* %12, align 8
  %13 = add nsw i64 %indvars.iv31, -1
...
.ph.lver.orig:                                    ; preds = %.ph.lver.orig.preheader, %.ph.lver.orig
  ...
  %15 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv31, i64 %14
  %16 = load double, double* %15, align 8
  %17 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv31, i64 %indvars.iv.lver.orig
  %18 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv.lver.orig, i64 %13
  %19 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv.lver.orig, i64 %indvars.iv.next32
  %20 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv31, i64 %14
  ...
  %36 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv31, i64 %indvars.iv.lver.orig
...
.ph:                                              ; preds = %.lver.check
  ...
  %load_initial53 = load double, double* %scevgep47, align 8
  br label %53

._crit_edge12.us:                                 ; preds = %.lr.ph11.us
  %exitcond41 = icmp eq i64 %indvars.iv.next32, 999
  br i1 %exitcond41, label %.lver.check69.preheader, label %.lver.check

.lver.check69.preheader:                          ; preds = %._crit_edge12.us
  br label %.lver.check69

.lr.ph11.us:                                      ; preds = %.lr.ph11.us, %._crit_edge.us
  %indvars.iv29 = phi i64 [ 998, %._crit_edge.us ], [ %indvars.iv.next30.1, %.lr.ph11.us ]
  %37 = phi double [ 1.000000e+00, %._crit_edge.us ], [ %50, %.lr.ph11.us ]
  %38 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv31, i64 %indvars.iv29
  %39 = load double, double* %38, align 8
  %40 = fmul double %39, %37
  %41 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv31, i64 %indvars.iv29
  %42 = load double, double* %41, align 8
  %43 = fadd double %40, %42
  %44 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv29, i64 %indvars.iv31
  store double %43, double* %44, align 8
  %indvars.iv.next30 = add nsw i64 %indvars.iv29, -1
  %45 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv31, i64 %indvars.iv.next30
  %46 = load double, double* %45, align 8
  %47 = fmul double %46, %43
  %48 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv31, i64 %indvars.iv.next30
  %49 = load double, double* %48, align 8
  %50 = fadd double %47, %49
  %51 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv.next30, i64 %indvars.iv31
  store double %50, double* %51, align 8
  %52 = icmp sgt i64 %indvars.iv.next30, 1
  %indvars.iv.next30.1 = add nsw i64 %indvars.iv29, -2
  br i1 %52, label %.lr.ph11.us, label %._crit_edge12.us

; <label>:53:                                     ; preds = %53, %.ph
  %store_forwarded54 = phi double [ %load_initial53, %.ph ], [ %70, %53 ]
  %store_forwarded = phi double [ %load_initial, %.ph ], [ %58, %53 ]
  %indvars.iv = phi i64 [ 1, %.ph ], [ %indvars.iv.next, %53 ]
  %54 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv31, i64 %indvars.iv
  %55 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv, i64 %13
  %56 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv, i64 %indvars.iv.next32
  ...
  %71 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv31, i64 %indvars.iv
  store double %70, double* %71, align 8
  %exitcond = icmp eq i64 %indvars.iv, 998
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br i1 %exitcond, label %._crit_edge.us.loopexit78, label %53

._crit_edge.us.loopexit:                          ; preds = %.ph.lver.orig
  br label %._crit_edge.us

._crit_edge.us.loopexit78:                        ; preds = %53
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit78, %._crit_edge.us.loopexit
  %72 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 999, i64 %indvars.iv31
  store double 1.000000e+00, double* %72, align 8
  br label %.lr.ph11.us

.lver.check69:                                    ; preds = %.lver.check69.preheader, %._crit_edge22.us
  %indvar55 = phi i64 [ %73, %._crit_edge22.us ], [ 0, %.lver.check69.preheader ]
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %._crit_edge22.us ], [ 1, %.lver.check69.preheader ]
  %73 = add i64 %indvar55, 1
  %scevgep57 = getelementptr [1000 x double], [1000 x double]* %4, i64 %73, i64 0
  %scevgep59 = getelementptr [1000 x double], [1000 x double]* %4, i64 %73, i64 999
  %scevgep61 = getelementptr [1000 x double], [1000 x double]* %5, i64 %73, i64 0
  %scevgep63 = getelementptr [1000 x double], [1000 x double]* %5, i64 %73, i64 999
  ...
  %75 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv39, i64 0
  store double 0.000000e+00, double* %75, align 8
  %76 = bitcast double* %74 to i64*
  %77 = load i64, i64* %76, align 8
  %78 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv39
...
.ph70.lver.orig:                                  ; preds = %.ph70.lver.orig.preheader, %.ph70.lver.orig
  %indvars.iv33.lver.orig = phi i64 [ %indvars.iv.next34.lver.orig, %.ph70.lver.orig ], [ 1, %.ph70.lver.orig.preheader ]
  %81 = add nsw i64 %indvars.iv33.lver.orig, -1
  %82 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv39, i64 %81
  %83 = load double, double* %82, align 8
  %84 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv39, i64 %indvars.iv33.lver.orig
  %85 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %80, i64 %indvars.iv33.lver.orig
  %86 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv39, i64 %indvars.iv33.lver.orig
  %87 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv.next40, i64 %indvars.iv33.lver.orig
  %88 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv39, i64 %81
  ...
  %108 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv39, i64 %indvars.iv33.lver.orig
  ...
  br i1 %exitcond36.lver.orig, label %._crit_edge18.us.loopexit, label %.ph70.lver.orig

.ph70:                                            ; preds = %.lver.check69
  %load_initial72 = load double, double* %scevgep57, align 8
  %load_initial75 = load double, double* %scevgep61, align 8
  br label %125

._crit_edge22.us:                                 ; preds = %.lr.ph21.us
  %exitcond42 = icmp eq i64 %indvars.iv.next40, 999
  br i1 %exitcond42, label %._crit_edge25, label %.lver.check69

.lr.ph21.us:                                      ; preds = %.lr.ph21.us, %._crit_edge18.us
  %indvars.iv37 = phi i64 [ 998, %._crit_edge18.us ], [ %indvars.iv.next38.1, %.lr.ph21.us ]
  %109 = phi double [ 1.000000e+00, %._crit_edge18.us ], [ %122, %.lr.ph21.us ]
  %110 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv39, i64 %indvars.iv37
  %111 = load double, double* %110, align 8
  %112 = fmul double %111, %109
  %113 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv39, i64 %indvars.iv37
  %114 = load double, double* %113, align 8
  %115 = fadd double %112, %114
  %116 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv39, i64 %indvars.iv37
  store double %115, double* %116, align 8
  %indvars.iv.next38 = add nsw i64 %indvars.iv37, -1
  %117 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv39, i64 %indvars.iv.next38
  %118 = load double, double* %117, align 8
  %119 = fmul double %118, %115
  %120 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv39, i64 %indvars.iv.next38
  %121 = load double, double* %120, align 8
  %122 = fadd double %119, %121
  %123 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv39, i64 %indvars.iv.next38
  store double %122, double* %123, align 8
  %124 = icmp sgt i64 %indvars.iv.next38, 1
  %indvars.iv.next38.1 = add nsw i64 %indvars.iv37, -2
  br i1 %124, label %.lr.ph21.us, label %._crit_edge22.us

; <label>:125:                                    ; preds = %125, %.ph70
  %store_forwarded76 = phi double [ %load_initial75, %.ph70 ], [ %147, %125 ]
  %store_forwarded73 = phi double [ %load_initial72, %.ph70 ], [ %136, %125 ]
  %indvars.iv33 = phi i64 [ 1, %.ph70 ], [ %indvars.iv.next34, %125 ]
  %126 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv39, i64 %indvars.iv33
  %127 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %80, i64 %indvars.iv33
  %128 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv39, i64 %indvars.iv33
  %129 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv.next40, i64 %indvars.iv33
  ...
  %148 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv39, i64 %indvars.iv33
  store double %147, double* %148, align 8
  %exitcond36 = icmp eq i64 %indvars.iv33, 998
  %indvars.iv.next34 = add nuw nsw i64 %indvars.iv33, 1
  br i1 %exitcond36, label %._crit_edge18.us.loopexit77, label %125

._crit_edge18.us.loopexit:                        ; preds = %.ph70.lver.orig
  br label %._crit_edge18.us

._crit_edge18.us.loopexit77:                      ; preds = %125
  br label %._crit_edge18.us

._crit_edge18.us:                                 ; preds = %._crit_edge18.us.loopexit77, %._crit_edge18.us.loopexit
  %149 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv39, i64 999
  store double 1.000000e+00, double* %149, align 8
  br label %.lr.ph21.us

._crit_edge25:                                    ; preds = %._crit_edge22.us
  %150 = add nuw nsw i32 %storemerge26, 1
  %exitcond43 = icmp eq i32 %150, 501
  br i1 %exitcond43, label %._crit_edge27, label %.preheader7
