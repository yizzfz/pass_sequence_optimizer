...
for.body68.us:                                    ; preds = %for.inc96.us, %for.body68.lr.ph.for.body68.us_crit_edge
  %indvar140 = phi i64 [ %indvar.next141, %for.inc96.us ], [ 0, %for.body68.lr.ph.for.body68.us_crit_edge ]
  %indvars.iv81 = phi i64 [ %indvars.iv.next82, %for.inc96.us ], [ %49, %for.body68.lr.ph.for.body68.us_crit_edge ]
  %55 = add i64 %49, %indvar140
  %scevgep142 = getelementptr [2000 x double], [2000 x double]* %47, i64 0, i64 %55
  %56 = add i64 %53, %indvar140
  %scevgep144 = getelementptr [2000 x double], [2000 x double]* %47, i64 %51, i64 %56
...
for.inc96.us.for.cond65.for.end98_crit_edge_crit_edge: ; preds = %for.inc96.us
  %57 = trunc i64 %indvars.iv.next82 to i32
  br label %for.cond65.for.end98_crit_edge

for.body72.us.us:                                 ; preds = %for.body68.us, %for.inc93.us.us
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.inc93.us.us ], [ 0, %for.body68.us ]
  %scevgep136 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %48, i64 0, i64 %indvars.iv79, i64 0
  %scevgep138 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %48, i64 0, i64 %indvars.iv79, i64 %52
...
for.inc90.us.us.preheader:                        ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.body72.us.us
  ...
  %58 = sub nsw i64 %54, %indvars.iv75.ph
  %xtraiter189 = and i64 %58, 1
  %lcmp.mod190 = icmp eq i64 %xtraiter189, 0
  br i1 %lcmp.mod190, label %for.inc90.us.us.prol.loopexit, label %for.inc90.us.us.prol
...
for.inc90.us.us.prol:                             ; preds = %for.inc90.us.us.preheader
  ...
  %60 = load double, double* %arrayidx84.us.us.prol, align 8
  %mul.us.us.prol = fmul double %59, %60
  ...
  %61 = load double, double* %arrayidx88.us.us.prol, align 8
  %add89.us.us.prol = fadd double %61, %mul.us.us.prol
...
for.inc90.us.us.prol.loopexit:                    ; preds = %for.inc90.us.us.prol, %for.inc90.us.us.preheader
  ...
  %62 = icmp eq i64 %51, %indvars.iv75.ph
  br i1 %62, label %for.inc93.us.us, label %for.inc90.us.us.preheader.new
...
vector.memcheck:                                  ; preds = %min.iters.checked
  ...
  %bound0147 = icmp ult double* %scevgep136, %arrayidx80.us.us
  %bound1148 = icmp ult double* %arrayidx80.us.us, %scevgep138
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %64 = or i64 %index, 2
  %65 = or i64 %index, 3
  %66 = load double, double* %arrayidx80.us.us, align 8, !alias.scope !1
  ...
  %71 = getelementptr inbounds [2000 x double], [2000 x double]* %47, i64 %index, i64 %indvars.iv81
  %72 = getelementptr inbounds [2000 x double], [2000 x double]* %47, i64 %63, i64 %indvars.iv81
  ...
  %83 = fmul <2 x double> %68, %80
  %84 = fmul <2 x double> %70, %82
  %85 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %48, i64 0, i64 %indvars.iv79, i64 %index
  %86 = bitcast double* %85 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %86, align 8, !alias.scope !6, !noalias !8
  %87 = getelementptr double, double* %85, i64 2
  %88 = bitcast double* %87 to <2 x double>*
  %wide.load151 = load <2 x double>, <2 x double>* %88, align 8, !alias.scope !6, !noalias !8
  %89 = fadd <2 x double> %wide.load, %83
  %90 = fadd <2 x double> %wide.load151, %84
  %91 = bitcast double* %85 to <2 x double>*
  store <2 x double> %89, <2 x double>* %91, align 8, !alias.scope !6, !noalias !8
  ...
  br i1 %93, label %middle.block, label %vector.body, !llvm.loop !9
...
for.inc93.us.us:                                  ; preds = %for.inc93.us.us.loopexit, %for.inc90.us.us.prol.loopexit, %middle.block
  ...
  br i1 %exitcond126, label %for.inc96.us, label %for.body72.us.us
...
for.inc90.us.us:                                  ; preds = %for.inc90.us.us, %for.inc90.us.us.preheader.new
  ...
  %94 = load double, double* %arrayidx80.us.us, align 8
  %arrayidx84.us.us = getelementptr inbounds [2000 x double], [2000 x double]* %47, i64 %indvars.iv75, i64 %indvars.iv81
  %95 = load double, double* %arrayidx84.us.us, align 8
  %mul.us.us = fmul double %94, %95
  ...
  %96 = load double, double* %arrayidx88.us.us, align 8
  %add89.us.us = fadd double %96, %mul.us.us
  store double %add89.us.us, double* %arrayidx88.us.us, align 8
  %indvars.iv.next76 = add nuw nsw i64 %indvars.iv75, 1
  %97 = load double, double* %arrayidx80.us.us, align 8
  %arrayidx84.us.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %47, i64 %indvars.iv.next76, i64 %indvars.iv81
  %98 = load double, double* %arrayidx84.us.us.1, align 8
  %mul.us.us.1 = fmul double %97, %98
  ...
  %99 = load double, double* %arrayidx88.us.us.1, align 8
  %add89.us.us.1 = fadd double %99, %mul.us.us.1
...
for.body68.for.cond65.for.end98_crit_edge_crit_edge: ; preds = %for.body68.lr.ph
  ...
  %100 = add i32 %t.promoted, 1
  %101 = icmp sgt i32 %45, %100
  %smax83 = select i1 %101, i32 %45, i32 %100
  br label %for.cond65.for.end98_crit_edge
...
for.cond65.for.end98_crit_edge:                   ; preds = %for.body68.for.cond65.for.end98_crit_edge_crit_edge, %for.inc96.us.for.cond65.for.end98_crit_edge_crit_edge
  %inc91.lcssa20.lcssa25.lcssa = phi i32 [ %45, %for.inc96.us.for.cond65.for.end98_crit_edge_crit_edge ], [ %s.promoted, %for.body68.for.cond65.for.end98_crit_edge_crit_edge ]
  %inc97.lcssa = phi i32 [ %57, %for.inc96.us.for.cond65.for.end98_crit_edge_crit_edge ], [ %smax83, %for.body68.for.cond65.for.end98_crit_edge_crit_edge ]
...
for.body102.lr.ph:                                ; preds = %for.end98
  ...
  %104 = load [2000 x [2000 x double]]*, [2000 x [2000 x double]]** %B, align 8
  %105 = load [2000 x double]*, [2000 x double]** %A.addr, align 8
  %r.promoted = load i32, i32* %r, align 4
  %106 = sext i32 %r.promoted to i64
  %cmp1041 = icmp sgt i32 %102, 0
...
for.body102.lr.ph.for.body102.us_crit_edge:       ; preds = %for.body102.lr.ph
  ...
  %min.iters.check155 = icmp ult i64 %109, 4
  %n.vec158 = and i64 %109, 8589934588
  %cmp.zero159 = icmp eq i64 %n.vec158, 0
  %114 = and i64 %112, 1
  %lcmp.mod = icmp eq i64 %114, 0
  %115 = icmp eq i64 %112, 0
  %cmp.n180 = icmp eq i64 %109, %n.vec158
  br label %for.body102.us

for.body102.us:                                   ; preds = %for.inc118.us, %for.body102.lr.ph.for.body102.us_crit_edge
  %indvar161 = phi i64 [ %indvar.next162, %for.inc118.us ], [ 0, %for.body102.lr.ph.for.body102.us_crit_edge ]
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.inc118.us ], [ %106, %for.body102.lr.ph.for.body102.us_crit_edge ]
  %116 = add i64 %106, %indvar161
  %scevgep163 = getelementptr [2000 x double], [2000 x double]* %105, i64 %116, i64 0
  %scevgep165 = getelementptr [2000 x double], [2000 x double]* %105, i64 %116, i64 %109
  %scevgep167 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %104, i64 0, i64 %116, i64 0
  %scevgep169 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %104, i64 0, i64 %116, i64 %109
  br i1 %min.iters.check155, label %for.inc115.us.preheader, label %min.iters.checked156

min.iters.checked156:                             ; preds = %for.body102.us
  br i1 %cmp.zero159, label %for.inc115.us.preheader, label %vector.memcheck175
...
vector.memcheck175:                               ; preds = %min.iters.checked156
  ...
  br i1 %memcheck.conflict174, label %for.inc115.us.preheader, label %vector.body152.preheader

vector.body152.preheader:                         ; preds = %vector.memcheck175
  br i1 %lcmp.mod, label %vector.body152.prol, label %vector.body152.prol.loopexit

vector.body152.prol:                              ; preds = %vector.body152.preheader
  %117 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %104, i64 0, i64 %indvars.iv72, i64 0
  %118 = bitcast double* %117 to <2 x i64>*
  %wide.load185.prol = load <2 x i64>, <2 x i64>* %118, align 8, !alias.scope !13
  %119 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %104, i64 0, i64 %indvars.iv72, i64 2
  %120 = bitcast double* %119 to <2 x i64>*
  %wide.load186.prol = load <2 x i64>, <2 x i64>* %120, align 8, !alias.scope !13
  %121 = getelementptr inbounds [2000 x double], [2000 x double]* %105, i64 %indvars.iv72, i64 0
  %122 = bitcast double* %121 to <2 x i64>*
  store <2 x i64> %wide.load185.prol, <2 x i64>* %122, align 8, !alias.scope !16, !noalias !13
  %123 = getelementptr [2000 x double], [2000 x double]* %105, i64 %indvars.iv72, i64 2
  %124 = bitcast double* %123 to <2 x i64>*
  store <2 x i64> %wide.load186.prol, <2 x i64>* %124, align 8, !alias.scope !16, !noalias !13
  br label %vector.body152.prol.loopexit

vector.body152.prol.loopexit:                     ; preds = %vector.body152.prol, %vector.body152.preheader
  %index177.unr.ph = phi i64 [ 4, %vector.body152.prol ], [ 0, %vector.body152.preheader ]
  br i1 %115, label %middle.block153, label %vector.body152.preheader.new
...
vector.body152:                                   ; preds = %vector.body152, %vector.body152.preheader.new
  ...
  %125 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %104, i64 0, i64 %indvars.iv72, i64 %index177
  %126 = bitcast double* %125 to <2 x i64>*
  %wide.load185 = load <2 x i64>, <2 x i64>* %126, align 8, !alias.scope !13
  %127 = getelementptr double, double* %125, i64 2
  %128 = bitcast double* %127 to <2 x i64>*
  %wide.load186 = load <2 x i64>, <2 x i64>* %128, align 8, !alias.scope !13
  %129 = getelementptr inbounds [2000 x double], [2000 x double]* %105, i64 %indvars.iv72, i64 %index177
  %130 = bitcast double* %129 to <2 x i64>*
  store <2 x i64> %wide.load185, <2 x i64>* %130, align 8, !alias.scope !16, !noalias !13
  %131 = getelementptr double, double* %129, i64 2
  %132 = bitcast double* %131 to <2 x i64>*
  store <2 x i64> %wide.load186, <2 x i64>* %132, align 8, !alias.scope !16, !noalias !13
  %index.next178 = add i64 %index177, 4
  %133 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %104, i64 0, i64 %indvars.iv72, i64 %index.next178
  %134 = bitcast double* %133 to <2 x i64>*
  %wide.load185.1 = load <2 x i64>, <2 x i64>* %134, align 8, !alias.scope !13
  %135 = getelementptr double, double* %133, i64 2
  %136 = bitcast double* %135 to <2 x i64>*
  %wide.load186.1 = load <2 x i64>, <2 x i64>* %136, align 8, !alias.scope !13
  %137 = getelementptr inbounds [2000 x double], [2000 x double]* %105, i64 %indvars.iv72, i64 %index.next178
  %138 = bitcast double* %137 to <2 x i64>*
  store <2 x i64> %wide.load185.1, <2 x i64>* %138, align 8, !alias.scope !16, !noalias !13
  %139 = getelementptr double, double* %137, i64 2
  %140 = bitcast double* %139 to <2 x i64>*
  store <2 x i64> %wide.load186.1, <2 x i64>* %140, align 8, !alias.scope !16, !noalias !13
  %index.next178.1 = add i64 %index177, 8
  %141 = icmp eq i64 %index.next178.1, %n.vec158
  br i1 %141, label %middle.block153.loopexit, label %vector.body152, !llvm.loop !18

middle.block153.loopexit:                         ; preds = %vector.body152
  br label %middle.block153

middle.block153:                                  ; preds = %middle.block153.loopexit, %vector.body152.prol.loopexit
  br i1 %cmp.n180, label %for.inc118.us, label %for.inc115.us.preheader

for.inc115.us.preheader:                          ; preds = %middle.block153, %vector.memcheck175, %min.iters.checked156, %for.body102.us
  %indvars.iv.ph = phi i64 [ 0, %vector.memcheck175 ], [ 0, %min.iters.checked156 ], [ 0, %for.body102.us ], [ %n.vec158, %middle.block153 ]
  %142 = sub nsw i64 %113, %indvars.iv.ph
  %143 = sub nsw i64 %108, %indvars.iv.ph
  %xtraiter187 = and i64 %142, 3
  %lcmp.mod188 = icmp eq i64 %xtraiter187, 0
  br i1 %lcmp.mod188, label %for.inc115.us.prol.loopexit, label %for.inc115.us.prol.preheader
...
for.inc115.us.prol:                               ; preds = %for.inc115.us.prol, %for.inc115.us.prol.preheader
  ...
  %prol.iter = phi i64 [ %prol.iter.sub, %for.inc115.us.prol ], [ %xtraiter187, %for.inc115.us.prol.preheader ]
  %arrayidx110.us.prol = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %104, i64 0, i64 %indvars.iv72, i64 %indvars.iv.prol
  %144 = bitcast double* %arrayidx110.us.prol to i64*
  %145 = load i64, i64* %144, align 8
  %arrayidx114.us.prol = getelementptr inbounds [2000 x double], [2000 x double]* %105, i64 %indvars.iv72, i64 %indvars.iv.prol
  %146 = bitcast double* %arrayidx114.us.prol to i64*
...
for.inc115.us.prol.loopexit:                      ; preds = %for.inc115.us.prol.loopexit.loopexit, %for.inc115.us.preheader
  ...
  %147 = icmp ult i64 %143, 3
  br i1 %147, label %for.inc118.us, label %for.inc115.us.preheader.new
...
for.inc115.us:                                    ; preds = %for.inc115.us, %for.inc115.us.preheader.new
  ...
  %arrayidx110.us = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %104, i64 0, i64 %indvars.iv72, i64 %indvars.iv
  %148 = bitcast double* %arrayidx110.us to i64*
  %149 = load i64, i64* %148, align 8
  %arrayidx114.us = getelementptr inbounds [2000 x double], [2000 x double]* %105, i64 %indvars.iv72, i64 %indvars.iv
  %150 = bitcast double* %arrayidx114.us to i64*
  store i64 %149, i64* %150, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx110.us.1 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %104, i64 0, i64 %indvars.iv72, i64 %indvars.iv.next
  %151 = bitcast double* %arrayidx110.us.1 to i64*
  %152 = load i64, i64* %151, align 8
  %arrayidx114.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %105, i64 %indvars.iv72, i64 %indvars.iv.next
  %153 = bitcast double* %arrayidx114.us.1 to i64*
  store i64 %152, i64* %153, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %arrayidx110.us.2 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %104, i64 0, i64 %indvars.iv72, i64 %indvars.iv.next.1
  %154 = bitcast double* %arrayidx110.us.2 to i64*
  %155 = load i64, i64* %154, align 8
  %arrayidx114.us.2 = getelementptr inbounds [2000 x double], [2000 x double]* %105, i64 %indvars.iv72, i64 %indvars.iv.next.1
  %156 = bitcast double* %arrayidx114.us.2 to i64*
  store i64 %155, i64* %156, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %arrayidx110.us.3 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %104, i64 0, i64 %indvars.iv72, i64 %indvars.iv.next.2
  %157 = bitcast double* %arrayidx110.us.3 to i64*
  %158 = load i64, i64* %157, align 8
  %arrayidx114.us.3 = getelementptr inbounds [2000 x double], [2000 x double]* %105, i64 %indvars.iv72, i64 %indvars.iv.next.2
  %159 = bitcast double* %arrayidx114.us.3 to i64*
  store i64 %158, i64* %159, align 8
  %exitcond124.3 = icmp eq i64 %indvars.iv.next.2, %108
...
for.inc118.us:                                    ; preds = %for.inc118.us.loopexit, %for.inc115.us.prol.loopexit, %middle.block153
  %indvars.iv.next73 = add nsw i64 %indvars.iv72, 1
  %cmp100.us = icmp slt i64 %indvars.iv.next73, %103
...
for.inc118.us.for.cond99.for.end120_crit_edge_crit_edge: ; preds = %for.inc118.us
  %160 = trunc i64 %indvars.iv.next73 to i32
  br label %for.cond99.for.end120_crit_edge

for.body102.for.cond99.for.end120_crit_edge_crit_edge: ; preds = %for.body102.lr.ph
  %161 = add i32 %r.promoted, 1
  %162 = icmp sgt i32 %102, %161
  %smax = select i1 %162, i32 %102, i32 %161
  br label %for.cond99.for.end120_crit_edge
...
for.cond99.for.end120_crit_edge:                  ; preds = %for.body102.for.cond99.for.end120_crit_edge_crit_edge, %for.inc118.us.for.cond99.for.end120_crit_edge_crit_edge
  %inc116.lcssa15.lcssa = phi i32 [ %102, %for.inc118.us.for.cond99.for.end120_crit_edge_crit_edge ], [ 0, %for.body102.for.cond99.for.end120_crit_edge_crit_edge ]
  %inc119.lcssa = phi i32 [ %160, %for.inc118.us.for.cond99.for.end120_crit_edge_crit_edge ], [ %smax, %for.body102.for.cond99.for.end120_crit_edge_crit_edge ]
...
for.end120:                                       ; preds = %for.end98, %for.end98.thread, %for.cond99.for.end120_crit_edge
  %163 = bitcast [2000 x [2000 x double]]** %B to i8**
