...
.lr.ph204.split.us.new:                           ; preds = %.lr.ph204.split.us.new.preheader384, %.lr.ph204.split.us.new
  ...
  %indvars.iv.next249.us.1 = add nsw i64 %indvars.iv248.us, 2
...
define internal fastcc void @print_array(i32, i32, [2160 x float]* nocapture readonly) unnamed_addr #0 {
  ...
  br i1 true, label %.lr.ph15, label %._crit_edge16

.lr.ph15:                                         ; preds = %3
  br i1 true, label %.lr.ph15.split.us.preheader, label %._crit_edge16
...
.lr.ph15.split.us:                                ; preds = %.lr.ph15.split.us.preheader, %._crit_edge.us
  %indvars.iv17.us = phi i64 [ %indvars.iv.next18.us, %._crit_edge.us ], [ 0, %.lr.ph15.split.us.preheader ]
  %8 = mul nsw i64 %indvars.iv17.us, 2160
  br label %9

; <label>:9:                                      ; preds = %16, %.lr.ph15.split.us
  %indvars.iv.us = phi i64 [ 0, %.lr.ph15.split.us ], [ %indvars.iv.next.us, %16 ]
...
; <label>:16:                                     ; preds = %14, %9
  ...
  %18 = getelementptr inbounds [2160 x float], [2160 x float]* %2, i64 %indvars.iv17.us, i64 %indvars.iv.us
...
._crit_edge.us:                                   ; preds = %16
  ...
  br i1 %exitcond20.us, label %._crit_edge16.loopexit, label %.lr.ph15.split.us

._crit_edge16.loopexit:                           ; preds = %._crit_edge.us
  br label %._crit_edge16

._crit_edge16:                                    ; preds = %._crit_edge16.loopexit, %.lr.ph15, %3
