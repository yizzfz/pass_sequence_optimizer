...
._crit_edge223.us:                                ; preds = %._crit_edge223.us.loopexit, %.prol.loopexit284
  ...
  br i1 %exitcond267.us, label %._crit_edge227, label %.lr.ph226.split.us

._crit_edge227:                                   ; preds = %._crit_edge223.us
  br i1 true, label %.lr.ph215, label %._crit_edge204

.lr.ph215:                                        ; preds = %._crit_edge227
  br i1 true, label %.lr.ph215.split.us.preheader, label %._crit_edge173
...
._crit_edge212.us:                                ; preds = %64
  ...
  br i1 %exitcond259.us, label %._crit_edge216, label %.lr.ph215.split.us

._crit_edge216:                                   ; preds = %._crit_edge212.us
  br i1 true, label %.lr.ph203, label %._crit_edge204

.lr.ph203:                                        ; preds = %._crit_edge216
  br i1 true, label %.lr.ph203.split.us.preheader, label %._crit_edge173
...
.lr.ph203.split.us:                               ; preds = %.lr.ph203.split.us.preheader, %._crit_edge200.us
  ...
  %scevgep298 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv250.us, i64 2
  %scevgep304 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv250.us, i64 2
  %scevgep310 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv250.us, i64 2
...
.lr.ph203.split.us.new.preheader:                 ; preds = %.prol.loopexit280
  ...
  br i1 false, label %.lr.ph203.split.us.new.preheader374, label %min.iters.checked

min.iters.checked:                                ; preds = %.lr.ph203.split.us.new.preheader
  %n.mod.vf = and i64 %88, 3
  %n.vec = sub nsw i64 %88, %n.mod.vf
  br i1 false, label %.lr.ph203.split.us.new.preheader374, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %scevgep296 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv250.us, i64 %indvars.iv246.us.unr.ph
  %89 = sub nsw i64 2158, %indvars.iv246.us.unr.ph
  %90 = and i64 %89, 2158
  %91 = or i64 %indvars.iv246.us.unr.ph, %90
  %scevgep299 = getelementptr float, float* %scevgep298, i64 %91
  %scevgep302 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv250.us, i64 %indvars.iv246.us.unr.ph
  %scevgep305 = getelementptr float, float* %scevgep304, i64 %91
  %scevgep308 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv250.us, i64 %indvars.iv246.us.unr.ph
  %scevgep311 = getelementptr float, float* %scevgep310, i64 %91
  %bound0 = icmp ult float* %scevgep296, %scevgep305
  %bound1 = icmp ult float* %scevgep302, %scevgep299
  %found.conflict = and i1 %bound0, %bound1
  %bound0313 = icmp ult float* %scevgep296, %scevgep311
  %bound1314 = icmp ult float* %scevgep308, %scevgep299
  ...
  br i1 %conflict.rdx, label %.lr.ph203.split.us.new.preheader374, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.vec317 = load <8 x float>, <8 x float>* %100, align 4, !alias.scope !9
  %101 = fadd <8 x float> %wide.vec, %wide.vec317
  %102 = shufflevector <8 x float> %101, <8 x float> undef, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %103 = add nuw nsw i64 %offset.idx, 1
  %104 = fadd <8 x float> %wide.vec, %wide.vec317
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %._crit_edge200.us, label %.lr.ph203.split.us.new.preheader374

.lr.ph203.split.us.new.preheader374:              ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.lr.ph203.split.us.new.preheader
...
.lr.ph203.split.us.new:                           ; preds = %.lr.ph203.split.us.new.preheader374, %.lr.ph203.split.us.new
  %indvars.iv246.us = phi i64 [ %indvars.iv.next247.us.1, %.lr.ph203.split.us.new ], [ %indvars.iv246.us.ph, %.lr.ph203.split.us.new.preheader374 ]
...
._crit_edge204:                                   ; preds = %._crit_edge204.loopexit, %._crit_edge227, %7, %._crit_edge216
...
._crit_edge192.us:                                ; preds = %._crit_edge192.us.loopexit, %.prol.loopexit276
  ...
  br i1 %exitcond245.us, label %._crit_edge196, label %.lr.ph195.split.us

._crit_edge196:                                   ; preds = %._crit_edge192.us
  br i1 true, label %.lr.ph184, label %._crit_edge185

.lr.ph184:                                        ; preds = %._crit_edge196
  br i1 true, label %.lr.ph184.split.us.preheader, label %._crit_edge185
...
._crit_edge185:                                   ; preds = %._crit_edge185.loopexit, %.lr.ph184, %._crit_edge204, %._crit_edge196
  %166 = phi i1 [ false, %._crit_edge204 ], [ false, %._crit_edge196 ], [ true, %.lr.ph184 ], [ true, %._crit_edge185.loopexit ]
  br i1 true, label %.lr.ph172, label %._crit_edge173

.lr.ph172:                                        ; preds = %._crit_edge185
  br i1 %166, label %.lr.ph172.split.us.preheader, label %._crit_edge173
...
.lr.ph172.split.us:                               ; preds = %.lr.ph172.split.us.preheader, %._crit_edge.us
  ...
  %scevgep332 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv228.us, i64 2
  %scevgep338 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv228.us, i64 2
  %scevgep344 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv228.us, i64 2
...
.lr.ph172.split.us.new.preheader:                 ; preds = %.prol.loopexit
  ...
  br i1 false, label %.lr.ph172.split.us.new.preheader373, label %min.iters.checked324

min.iters.checked324:                             ; preds = %.lr.ph172.split.us.new.preheader
  %n.mod.vf325 = and i64 %169, 3
  %n.vec326 = sub nsw i64 %169, %n.mod.vf325
  br i1 false, label %.lr.ph172.split.us.new.preheader373, label %vector.memcheck355

vector.memcheck355:                               ; preds = %min.iters.checked324
  %scevgep330 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv228.us, i64 %indvars.iv.us.unr.ph
  %170 = sub nsw i64 2158, %indvars.iv.us.unr.ph
  %171 = and i64 %170, 2158
  %172 = or i64 %indvars.iv.us.unr.ph, %171
  %scevgep333 = getelementptr float, float* %scevgep332, i64 %172
  %scevgep336 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv228.us, i64 %indvars.iv.us.unr.ph
  %scevgep339 = getelementptr float, float* %scevgep338, i64 %172
  %scevgep342 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv228.us, i64 %indvars.iv.us.unr.ph
  %scevgep345 = getelementptr float, float* %scevgep344, i64 %172
  %bound0347 = icmp ult float* %scevgep330, %scevgep339
  %bound1348 = icmp ult float* %scevgep336, %scevgep333
  %found.conflict349 = and i1 %bound0347, %bound1348
  %bound0350 = icmp ult float* %scevgep330, %scevgep345
  %bound1351 = icmp ult float* %scevgep342, %scevgep333
  ...
  %176 = shl nuw nsw i64 %n.mod.vf325, 1
  %ind.end360 = sub nsw i64 %175, %176
  br i1 %conflict.rdx353, label %.lr.ph172.split.us.new.preheader373, label %vector.body320.preheader

vector.body320.preheader:                         ; preds = %vector.memcheck355
  br label %vector.body320

vector.body320:                                   ; preds = %vector.body320.preheader, %vector.body320
  %index357 = phi i64 [ %index.next358, %vector.body320 ], [ 0, %vector.body320.preheader ]
  %177 = shl i64 %index357, 1
  %offset.idx362 = or i64 %indvars.iv.us.unr.ph, %177
  %178 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv228.us, i64 %offset.idx362
  %179 = bitcast float* %178 to <8 x float>*
  %wide.vec366 = load <8 x float>, <8 x float>* %179, align 4, !alias.scope !16
  %180 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv228.us, i64 %offset.idx362
  %181 = bitcast float* %180 to <8 x float>*
  %wide.vec369 = load <8 x float>, <8 x float>* %181, align 4, !alias.scope !19
  %182 = fadd <8 x float> %wide.vec366, %wide.vec369
  %183 = shufflevector <8 x float> %182, <8 x float> undef, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %184 = add nuw nsw i64 %offset.idx362, 1
  %185 = fadd <8 x float> %wide.vec366, %wide.vec369
  %186 = shufflevector <8 x float> %185, <8 x float> undef, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %187 = getelementptr inbounds [2160 x float], [2160 x float]* %4, i64 %indvars.iv228.us, i64 %184
  %188 = getelementptr float, float* %187, i64 -1
  %189 = bitcast float* %188 to <8 x float>*
  %interleaved.vec372 = shufflevector <4 x float> %183, <4 x float> %186, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x float> %interleaved.vec372, <8 x float>* %189, align 4, !alias.scope !21, !noalias !23
  %index.next358 = add i64 %index357, 4
  %190 = icmp eq i64 %index.next358, %n.vec326
  br i1 %190, label %middle.block321, label %vector.body320, !llvm.loop !24

middle.block321:                                  ; preds = %vector.body320
  %cmp.n361 = icmp eq i64 %n.mod.vf325, 0
  br i1 %cmp.n361, label %._crit_edge.us, label %.lr.ph172.split.us.new.preheader373

.lr.ph172.split.us.new.preheader373:              ; preds = %middle.block321, %vector.memcheck355, %min.iters.checked324, %.lr.ph172.split.us.new.preheader
  %indvars.iv.us.ph = phi i64 [ %indvars.iv.us.unr.ph, %vector.memcheck355 ], [ %indvars.iv.us.unr.ph, %min.iters.checked324 ], [ %indvars.iv.us.unr.ph, %.lr.ph172.split.us.new.preheader ], [ %ind.end360, %middle.block321 ]
  br label %.lr.ph172.split.us.new

.lr.ph172.split.us.new:                           ; preds = %.lr.ph172.split.us.new.preheader373, %.lr.ph172.split.us.new
  %indvars.iv.us = phi i64 [ %indvars.iv.next.us.1, %.lr.ph172.split.us.new ], [ %indvars.iv.us.ph, %.lr.ph172.split.us.new.preheader373 ]
  %191 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv228.us, i64 %indvars.iv.us
  %192 = load float, float* %191, align 4
  %193 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv228.us, i64 %indvars.iv.us
  %194 = load float, float* %193, align 4
  %195 = fadd float %192, %194
  %196 = getelementptr inbounds [2160 x float], [2160 x float]* %4, i64 %indvars.iv228.us, i64 %indvars.iv.us
  store float %195, float* %196, align 4
  %indvars.iv.next.us = add nuw nsw i64 %indvars.iv.us, 1
  %197 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv228.us, i64 %indvars.iv.next.us
  %198 = load float, float* %197, align 4
  %199 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv228.us, i64 %indvars.iv.next.us
  %200 = load float, float* %199, align 4
  %201 = fadd float %198, %200
  %202 = getelementptr inbounds [2160 x float], [2160 x float]* %4, i64 %indvars.iv228.us, i64 %indvars.iv.next.us
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %middle.block321, %.prol.loopexit
...
._crit_edge173:                                   ; preds = %._crit_edge173.loopexit, %.lr.ph203, %.lr.ph226, %.lr.ph215, %.lr.ph195, %.lr.ph172, %._crit_edge185
  ret void
}
...
define internal fastcc void @print_array(i32, i32, [2160 x float]* nocapture readonly) unnamed_addr #0 {
  ...
  br i1 true, label %.lr.ph18, label %._crit_edge19

.lr.ph18:                                         ; preds = %3
  br i1 true, label %.lr.ph18.split.us.preheader, label %._crit_edge19

.lr.ph18.split.us.preheader:                      ; preds = %.lr.ph18
  br label %.lr.ph18.split.us

.lr.ph18.split.us:                                ; preds = %.lr.ph18.split.us.preheader, %._crit_edge14.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %._crit_edge14.us ], [ 0, %.lr.ph18.split.us.preheader ]
  %8 = mul i64 %indvars.iv, 2160
  br label %9

; <label>:9:                                      ; preds = %._crit_edge.us, %.lr.ph18.split.us
  %indvars.iv.us = phi i64 [ 0, %.lr.ph18.split.us ], [ %indvars.iv.next.us, %._crit_edge.us ]
...
._crit_edge.us:                                   ; preds = %9, %14
  ...
  br i1 %exitcond.us, label %._crit_edge14.us, label %9
...
._crit_edge19.loopexit:                           ; preds = %._crit_edge14.us
  br label %._crit_edge19

._crit_edge19:                                    ; preds = %._crit_edge19.loopexit, %.lr.ph18, %3
