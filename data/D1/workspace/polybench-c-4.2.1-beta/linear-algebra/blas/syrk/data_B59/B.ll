...
.preheader28.us:                                  ; preds = %._crit_edge35.us, %.preheader28.us.preheader
  %indvars.iv47 = phi i64 [ 0, %.preheader28.us.preheader ], [ %indvars.iv.next48, %._crit_edge35.us ]
  br label %4
...
.preheader.us39:                                  ; preds = %._crit_edge.us42, %.preheader.us39.preheader
  %indvars.iv59 = phi i64 [ 0, %.preheader.us39.preheader ], [ %indvars.iv.next60, %._crit_edge.us42 ]
  %32 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv65, i64 %indvars.iv59
  br i1 %73, label %.prol.loopexit55, label %.prol.preheader54
...
.prol.preheader54:                                ; preds = %.preheader.us39
  ...
  %38 = load double, double* %72, align 8
  %39 = fadd double %38, %37
  store double %39, double* %72, align 8
...
.lr.ph.us:                                        ; preds = %._crit_edge33.us..lr.ph.us_crit_edge, %.lr.ph.us.preheader
  %indvars.iv87 = phi i2 [ 1, %.lr.ph.us.preheader ], [ %indvars.iv.next88, %._crit_edge33.us..lr.ph.us_crit_edge ]
  %indvars.iv65 = phi i64 [ 0, %.lr.ph.us.preheader ], [ %indvars.iv.next66, %._crit_edge33.us..lr.ph.us_crit_edge ]
  %indvars.iv63 = phi i64 [ 1, %.lr.ph.us.preheader ], [ %indvars.iv.next64, %._crit_edge33.us..lr.ph.us_crit_edge ]
  %40 = add nsw i64 %indvars.iv65, -3
...
.preheader.us39.preheader:                        ; preds = %.preheader.us39.preheader.loopexit, %middle.block, %.prol.loopexit
  %xtraiter5685 = and i64 %indvars.iv.next66, 1
  %72 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv65, i64 0
  %73 = icmp eq i64 %xtraiter5685, 0
...
.preheader.us:                                    ; preds = %._crit_edge.us, %.preheader.us.preheader
  ...
  %5 = mul nuw nsw i64 %indvars.iv14, 1200
  br label %6
...
; <label>:13:                                     ; preds = %6, %11
  ...
  %15 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv14, i64 %indvars.iv
