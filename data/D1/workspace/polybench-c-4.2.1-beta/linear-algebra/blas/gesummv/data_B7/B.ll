...
define i32 @main(i32, i8** nocapture readonly) local_unnamed_addr #0 {
  ...
  tail call fastcc void @kernel_gesummv(double %13, double %14, [1300 x double]* %10, [1300 x double]* %11, double* %15, double* %12, double* %16)
...
.lr.ph.us:                                        ; preds = %._crit_edge.us, %.lr.ph30
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %._crit_edge.us ], [ 0, %.lr.ph30 ]
  %5 = trunc i64 %indvars.iv32 to i32
  %6 = sitofp i32 %5 to double
  %7 = fdiv double %6, 1.300000e+03
  %8 = getelementptr inbounds double, double* %4, i64 %indvars.iv32
  store double %7, double* %8, align 8
  br label %9

; <label>:9:                                      ; preds = %9, %.lr.ph.us
  %indvars.iv = phi i64 [ 0, %.lr.ph.us ], [ %indvars.iv.next, %9 ]
  %10 = mul nuw nsw i64 %indvars.iv, %indvars.iv32
  %11 = add nuw nsw i64 %10, 1
  %12 = trunc i64 %11 to i32
  %13 = srem i32 %12, 1300
  %14 = sitofp i32 %13 to double
  %15 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv32, i64 %indvars.iv
  ...
  %25 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv32, i64 %indvars.iv
...
._crit_edge.us:                                   ; preds = %9
  ...
  br i1 %exitcond35, label %._crit_edge31, label %.lr.ph.us
...
.lr.ph39.split.us.preheader:
  %sunkaddr52 = ptrtoint double* %4 to i64
  %sunkaddr = ptrtoint double* %4 to i64
  %sunkaddr48 = ptrtoint double* %6 to i64
  %sunkaddr56 = ptrtoint double* %6 to i64
  br label %.lr.ph39.split.us

.lr.ph39.split.us:                                ; preds = %.lr.ph39.split.us.preheader, %._crit_edge.us
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %._crit_edge.us ], [ 0, %.lr.ph39.split.us.preheader ]
  %7 = getelementptr inbounds double, double* %4, i64 %indvars.iv41
  store double 0.000000e+00, double* %7, align 8
  %8 = getelementptr inbounds double, double* %6, i64 %indvars.iv41
  store double 0.000000e+00, double* %8, align 8
  %sunkaddr45 = shl nuw nsw i64 %indvars.iv41, 3
  %sunkaddr46 = add i64 %sunkaddr, %sunkaddr45
  %sunkaddr47 = inttoptr i64 %sunkaddr46 to double*
  %sunkaddr49 = shl nuw nsw i64 %indvars.iv41, 3
  %sunkaddr50 = add i64 %sunkaddr48, %sunkaddr49
  %sunkaddr51 = inttoptr i64 %sunkaddr50 to double*
  br label %9

; <label>:9:                                      ; preds = %9, %.lr.ph39.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph39.split.us ], [ %indvars.iv.next, %9 ]
  %10 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv41, i64 %indvars.iv
  %11 = load double, double* %10, align 8
  %12 = getelementptr inbounds double, double* %5, i64 %indvars.iv
  %13 = load double, double* %12, align 8
  %14 = fmul double %11, %13
  %15 = load double, double* %sunkaddr47, align 8
  %16 = fadd double %14, %15
  store double %16, double* %sunkaddr47, align 8
  %17 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv41, i64 %indvars.iv
  %18 = load double, double* %17, align 8
  %19 = load double, double* %12, align 8
  %20 = fmul double %18, %19
  %21 = load double, double* %sunkaddr51, align 8
  %22 = fadd double %20, %21
  store double %22, double* %sunkaddr51, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
  br i1 %exitcond, label %._crit_edge.us, label %9

._crit_edge.us:                                   ; preds = %9
  %sunkaddr53 = shl nuw nsw i64 %indvars.iv41, 3
  %sunkaddr54 = add i64 %sunkaddr52, %sunkaddr53
  %sunkaddr55 = inttoptr i64 %sunkaddr54 to double*
  %23 = load double, double* %sunkaddr55, align 8
  %24 = fmul double %23, %0
  %25 = fmul double %22, %1
  %26 = fadd double %25, %24
  %sunkaddr57 = shl nuw nsw i64 %indvars.iv41, 3
  %sunkaddr58 = add i64 %sunkaddr56, %sunkaddr57
  %sunkaddr59 = inttoptr i64 %sunkaddr58 to double*
  store double %26, double* %sunkaddr59, align 8
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  %exitcond44 = icmp eq i64 %indvars.iv.next42, 1300
  br i1 %exitcond44, label %._crit_edge40, label %.lr.ph39.split.us
