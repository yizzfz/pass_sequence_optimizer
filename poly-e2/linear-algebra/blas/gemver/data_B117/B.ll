...
for.body66.us:                                    ; preds = %for.cond64.preheader.us, %for.body66.us
  ...
  %57 = phi double [ %add77.us.1, %for.body66.us ], [ %.pre36, %for.cond64.preheader.us ]
...
for.body50:                                       ; preds = %for.body50.preheader, %for.body50
  ...
  br i1 %exitcond45.3, label %for.cond64.preheader.us.preheader.loopexit, label %for.body50, !llvm.loop !23
