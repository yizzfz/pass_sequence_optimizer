...
.prol.loopexit20:                                 ; preds = %.prol.preheader19, %.preheader4.us
  ...
  br i1 false, label %._crit_edge10.us, label %.prol.loopexit20..preheader4.us.new_crit_edge
...
.preheader4.us.new:                               ; preds = %.prol.loopexit20..preheader4.us.new_crit_edge, %.preheader4.us.new
  %14 = phi double [ %26, %.preheader4.us.new ], [ %.pre, %.prol.loopexit20..preheader4.us.new_crit_edge ]
  %indvars.iv15 = phi i64 [ %indvars.iv.next16.1, %.preheader4.us.new ], [ %indvars.iv15.unr.ph, %.prol.loopexit20..preheader4.us.new_crit_edge ]
...
.preheader.us.new:                                ; preds = %.prol.loopexit..preheader.us.new_crit_edge, %.preheader.us.new
  %34 = phi double [ %46, %.preheader.us.new ], [ %.pre27, %.prol.loopexit..preheader.us.new_crit_edge ]
...
.lr.ph:                                           ; preds = %._crit_edge8, %27
  %indvars.iv = phi i64 [ %indvars.iv.next, %27 ], [ 0, %._crit_edge8 ]
