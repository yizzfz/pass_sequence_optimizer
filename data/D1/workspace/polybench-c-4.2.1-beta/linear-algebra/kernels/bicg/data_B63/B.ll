...
define i32 @main(i32, i8** nocapture readonly) local_unnamed_addr #0 {
  ...
  %.cast = bitcast i8* %7 to double*
  %9 = bitcast i8* %6 to double*
  tail call fastcc void @init_array([1900 x double]* %8, double* %.cast, double* %9)
  tail call void (...) @polybench_timer_start() #4
  %10 = bitcast i8* %4 to double*
  %11 = bitcast i8* %5 to double*
  tail call fastcc void @kernel_bicg([1900 x double]* %8, double* %10, double* %11, double* %9, double* %.cast)
...
; <label>:16:                                     ; preds = %13
  tail call fastcc void @print_array(double* %10, double* %11)
  br label %17
