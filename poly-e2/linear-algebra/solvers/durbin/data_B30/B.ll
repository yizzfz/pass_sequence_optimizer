...
for.inc32.lr.ph:                                  ; preds = %for.inc32.lr.ph.loopexit, %for.inc.prol.loopexit
  ...
  %26 = add nsw i64 %indvars.iv62, -1
  %27 = and i64 %indvar, 1
  %lcmp.mod68 = icmp eq i64 %27, 0
...
for.inc32.prol:                                   ; preds = %for.inc32.lr.ph
  ...
  %sunkaddr1 = shl i64 %indvars.iv62, 3
...
for.inc32.preheader:                              ; preds = %for.inc32.prol.loopexit
  ...
  %32 = lshr i64 %31, 1
  %33 = and i64 %32, 1
  %lcmp.mod9 = icmp eq i64 %33, 0
  br i1 %lcmp.mod9, label %for.inc32.prol.preheader, label %for.inc32.prol.loopexit7.unr-lcssa

for.inc32.prol.preheader:                         ; preds = %for.inc32.preheader
  br label %for.inc32.prol10

for.inc32.prol10:                                 ; preds = %for.inc32.prol.preheader
  ...
  %36 = sub nsw i64 %26, %indvars.iv.next48.prol
  ...
  %add29.prol11 = fadd <2 x double> %35, %add29.v.i1.prol
  %40 = bitcast double* %arrayidx31.prol to <2 x double>*
  store <2 x double> %add29.prol11, <2 x double>* %40, align 8
  %indvars.iv.next48.1.prol = or i64 %indvars.iv47.unr.ph, 2
  br label %for.inc32.prol.loopexit7.unr-lcssa

for.inc32.prol.loopexit7.unr-lcssa:               ; preds = %for.inc32.preheader, %for.inc32.prol10
  %indvars.iv47.unr.ph12 = phi i64 [ %indvars.iv.next48.1.prol, %for.inc32.prol10 ], [ %indvars.iv47.unr.ph, %for.inc32.preheader ]
  br label %for.inc32.prol.loopexit7

for.inc32.prol.loopexit7:                         ; preds = %for.inc32.prol.loopexit7.unr-lcssa
  %41 = icmp eq i64 %32, 0
  br i1 %41, label %for.inc47.loopexit, label %for.inc32.preheader.new

for.inc32.preheader.new:                          ; preds = %for.inc32.prol.loopexit7
...
for.inc32:                                        ; preds = %for.inc32, %for.inc32.preheader.new
  %indvars.iv47 = phi i64 [ %indvars.iv47.unr.ph12, %for.inc32.preheader.new ], [ %indvars.iv.next48.1.1, %for.inc32 ]
  ...
  %46 = sub nsw i64 %26, %indvars.iv.next48
  ...
  %indvars.iv.next48.113 = add nsw i64 %indvars.iv47, 3
  %51 = load <2 x double>, <2 x double>* %50, align 8
  %52 = sub nsw i64 %26, %indvars.iv.next48.113
...
for.inc47.loopexit:                               ; preds = %for.inc32.prol.loopexit7, %for.inc47.loopexit.unr-lcssa
  br label %for.inc47
