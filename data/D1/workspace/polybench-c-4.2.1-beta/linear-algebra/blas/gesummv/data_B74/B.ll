...
; <label>:6:                                      ; preds = %28, %5
  %indvars.iv3 = phi i64 [ 0, %5 ], [ %indvars.iv.next4, %28 ]
...
; <label>:11:                                     ; preds = %11, %6
  ...
  %27 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv3, i64 %indvars.iv
  store double %26, double* %27, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
  br i1 %exitcond, label %28, label %11

; <label>:28:                                     ; preds = %11
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv3, 1
  %exitcond5 = icmp eq i64 %indvars.iv.next4, 1300
  br i1 %exitcond5, label %29, label %6
...
; <label>:9:                                      ; preds = %26, %7
  ...
  %11 = getelementptr inbounds double, double* %6, i64 %indvars.iv3
...
; <label>:12:                                     ; preds = %12, %9
  ...
  %13 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv3, i64 %indvars.iv
  %14 = load double, double* %13, align 8
  %15 = getelementptr inbounds double, double* %5, i64 %indvars.iv
  %16 = load double, double* %15, align 8
  %17 = fmul double %14, %16
  %18 = load double, double* %sunkaddr8, align 8
  %19 = fadd double %17, %18
  store double %19, double* %sunkaddr8, align 8
  %20 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv3, i64 %indvars.iv
  %21 = load double, double* %20, align 8
  %22 = load double, double* %15, align 8
  %23 = fmul double %21, %22
  %24 = load double, double* %sunkaddr12, align 8
  %25 = fadd double %23, %24
  store double %25, double* %sunkaddr12, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
...
; <label>:26:                                     ; preds = %12
  ...
  %27 = load double, double* %sunkaddr16, align 8
  %28 = fmul double %27, %0
  %29 = fmul double %25, %1
  ...
  store double %30, double* %sunkaddr20, align 8
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv3, 1
  %exitcond5 = icmp eq i64 %indvars.iv.next4, 1300
  br i1 %exitcond5, label %31, label %9
