...
define i32 @main(i32, i8**) #0 {
  ...
  %32 = inttoptr i64 %31 to [800 x [1000 x double]]*
  %33 = getelementptr inbounds [800 x [1000 x double]], [800 x [1000 x double]]* %32, i64 0, i64 0
  %34 = ptrtoint i8* %21 to i64
  %35 = inttoptr i64 %34 to [1000 x [900 x double]]*
  %36 = getelementptr inbounds [1000 x [900 x double]], [1000 x [900 x double]]* %35, i64 0, i64 0
  %37 = ptrtoint i8* %25 to i64
  %38 = inttoptr i64 %37 to [900 x [1200 x double]]*
  %39 = getelementptr inbounds [900 x [1200 x double]], [900 x [1200 x double]]* %38, i64 0, i64 0
  %40 = ptrtoint i8* %27 to i64
  %41 = inttoptr i64 %40 to [1200 x [1100 x double]]*
  %42 = getelementptr inbounds [1200 x [1100 x double]], [1200 x [1100 x double]]* %41, i64 0, i64 0
  tail call void @init_array(i32 800, i32 900, i32 1000, i32 1100, i32 1200, [1000 x double]* %33, [900 x double]* %36, [1200 x double]* %39, [1100 x double]* %42)
  tail call void (...) @polybench_timer_start() #4
  %43 = ptrtoint i8* %17 to i64
  %44 = inttoptr i64 %43 to [800 x [900 x double]]*
  %45 = getelementptr inbounds [800 x [900 x double]], [800 x [900 x double]]* %44, i64 0, i64 0
  %46 = ptrtoint i8* %23 to i64
  %47 = inttoptr i64 %46 to [900 x [1100 x double]]*
  %48 = getelementptr inbounds [900 x [1100 x double]], [900 x [1100 x double]]* %47, i64 0, i64 0
  %49 = ptrtoint i8* %29 to i64
  %50 = inttoptr i64 %49 to [800 x [1100 x double]]*
  %51 = getelementptr inbounds [800 x [1100 x double]], [800 x [1100 x double]]* %50, i64 0, i64 0
  tail call void @kernel_3mm(i32 800, i32 900, i32 1000, i32 1100, i32 1200, [900 x double]* %45, [1000 x double]* %33, [900 x double]* %36, [1100 x double]* %48, [1200 x double]* %39, [1100 x double]* %42, [1100 x double]* %51)
  tail call void (...) @polybench_timer_stop() #4
  tail call void (...) @polybench_timer_print() #4
  %52 = icmp sgt i32 %0, 42
  br i1 %52, label %53, label %._crit_edge

; <label>:53:                                     ; preds = %2
  %54 = load i8*, i8** %1, align 8
  %strcmpload = load i8, i8* %54, align 1
  %55 = icmp eq i8 %strcmpload, 0
  br i1 %55, label %56, label %._crit_edge

; <label>:56:                                     ; preds = %53
  tail call void @print_array(i32 800, i32 1100, [1100 x double]* %51)
  br label %._crit_edge

._crit_edge:                                      ; preds = %53, %2, %56
...
._crit_edge91:                                    ; preds = %._crit_edge91, %.preheader11.us
  %indvars.iv72 = phi i64 [ 0, %.preheader11.us ], [ %indvars.iv.next73, %._crit_edge91 ]
  ...
  br i1 %exitcond, label %._crit_edge35.us, label %._crit_edge91

._crit_edge35.us:                                 ; preds = %._crit_edge91
...
._crit_edge92:                                    ; preds = %._crit_edge92, %.preheader9.us
  %indvars.iv66 = phi i64 [ 0, %.preheader9.us ], [ %indvars.iv.next67, %._crit_edge92 ]
  ...
  br i1 %63, label %._crit_edge92, label %._crit_edge25.us

._crit_edge25.us:                                 ; preds = %._crit_edge92
...
._crit_edge93:                                    ; preds = %._crit_edge93, %.preheader.us
  %indvars.iv = phi i64 [ 0, %.preheader.us ], [ %indvars.iv.next, %._crit_edge93 ]
  ...
  br i1 %81, label %._crit_edge93, label %._crit_edge.us
...
._crit_edge15:                                    ; preds = %._crit_edge14, %.preheader.us
  ...
  %18 = srem i32 %17, 20
  %19 = icmp eq i32 %18, 0
  br i1 %19, label %20, label %._crit_edge14
...
._crit_edge14:                                    ; preds = %._crit_edge15, %20
