...
for.body:                                         ; preds = %for.end.for.body_crit_edge, %entry
  %indvars.iv4 = phi i64 [ 0, %entry ], [ %indvars.iv.next5, %for.end.for.body_crit_edge ]
...
for.body5:                                        ; preds = %for.body5.for.body5_crit_edge, %for.body
  %indvars.iv = phi i64 [ 0, %for.body ], [ %indvars.iv.next, %for.body5.for.body5_crit_edge ]
  %1 = mul nuw nsw i64 %indvars.iv, %indvars.iv4
  %2 = add nuw nsw i64 %1, 1
  %3 = trunc i64 %2 to i32
  %rem6 = srem i32 %3, 1300
  %conv7 = sitofp i32 %rem6 to double
  %arrayidx13 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv4, i64 %indvars.iv
  ...
  %arrayidx23 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv4, i64 %indvars.iv
  store double %div9.v.r2, double* %arrayidx23, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
  br i1 %exitcond, label %for.end, label %for.body5.for.body5_crit_edge
...
for.end:                                          ; preds = %for.body5
  ...
  br i1 %exitcond6, label %for.end26, label %for.end.for.body_crit_edge
...
entry:
  ...
  %sunkaddr20 = ptrtoint double* %y to i64
  br label %for.body

for.body:                                         ; preds = %for.end.for.body_crit_edge, %entry
  %indvars.iv1 = phi i64 [ 0, %entry ], [ %indvars.iv.next2, %for.end.for.body_crit_edge ]
  %arrayidx = getelementptr inbounds double, double* %tmp, i64 %indvars.iv1
  store double 0.000000e+00, double* %arrayidx, align 8
  %arrayidx4 = getelementptr inbounds double, double* %y, i64 %indvars.iv1
  store double 0.000000e+00, double* %arrayidx4, align 8
  %sunkaddr17 = shl i64 %indvars.iv1, 3
  %sunkaddr18 = add i64 %sunkaddr, %sunkaddr17
  %sunkaddr19 = inttoptr i64 %sunkaddr18 to double*
  %sunkaddr21 = shl i64 %indvars.iv1, 3
...
for.body7:                                        ; preds = %for.body7.for.body7_crit_edge, %for.body
  %indvars.iv = phi i64 [ 0, %for.body ], [ %indvars.iv.next, %for.body7.for.body7_crit_edge ]
  %arrayidx11 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv1, i64 %indvars.iv
  %1 = load double, double* %arrayidx11, align 8
  %arrayidx13 = getelementptr inbounds double, double* %x, i64 %indvars.iv
  %2 = load double, double* %arrayidx13, align 8
  %mul = fmul double %1, %2
  %3 = load double, double* %sunkaddr19, align 8
  %add = fadd double %mul, %3
  store double %add, double* %sunkaddr19, align 8
  %arrayidx21 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv1, i64 %indvars.iv
  %4 = load double, double* %arrayidx21, align 8
  %arrayidx23 = getelementptr inbounds double, double* %x, i64 %indvars.iv
  %5 = load double, double* %arrayidx23, align 8
  %mul24 = fmul double %4, %5
  %6 = load double, double* %sunkaddr23, align 8
  %add27 = fadd double %mul24, %6
  store double %add27, double* %sunkaddr23, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
  br i1 %exitcond, label %for.end, label %for.body7.for.body7_crit_edge

for.body7.for.body7_crit_edge:                    ; preds = %for.body7
  br label %for.body7

for.end:                                          ; preds = %for.body7
  %sunkaddr14 = shl i64 %indvars.iv1, 3
  %sunkaddr15 = add i64 %0, %sunkaddr14
  %sunkaddr16 = inttoptr i64 %sunkaddr15 to double*
  %7 = load double, double* %sunkaddr16, align 8
  %mul32 = fmul double %7, %alpha
  %arrayidx34 = getelementptr inbounds double, double* %y, i64 %indvars.iv1
  ...
  br i1 %exitcond3, label %for.end41, label %for.end.for.body_crit_edge
