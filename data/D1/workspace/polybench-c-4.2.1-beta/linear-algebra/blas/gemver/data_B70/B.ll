...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  br i1 %45, label %middle.block.loopexit81, label %vector.body, !llvm.loop !13
...
.preheader65:                                     ; preds = %87, %.preheader65.preheader
  %indvars.iv10 = phi i64 [ 0, %.preheader65.preheader ], [ %indvars.iv.next11, %87 ]
...
._crit_edge19:                                    ; preds = %._crit_edge19, %.preheader65
  ...
  %sunkaddr69 = ptrtoint double* %8 to i64
  %sunkaddr70 = mul i64 %indvars.iv10, 8
  ...
  store double %86, double* %sunkaddr72, align 8
...
.preheader64.preheader:                           ; preds = %87
...
.preheader:                                       ; preds = %133, %.preheader.preheader
  %indvars.iv1 = phi i64 [ 0, %.preheader.preheader ], [ %indvars.iv.next2, %133 ]
  br label %._crit_edge21

._crit_edge21:                                    ; preds = %._crit_edge21, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %._crit_edge21 ]
  %sunkaddr73 = ptrtoint double* %7 to i64
  %sunkaddr74 = mul i64 %indvars.iv1, 8
  %sunkaddr75 = add i64 %sunkaddr73, %sunkaddr74
  %sunkaddr76 = inttoptr i64 %sunkaddr75 to double*
  %118 = load double, double* %sunkaddr76, align 8
  ...
  store double %125, double* %sunkaddr80, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %132, double* %sunkaddr80, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
