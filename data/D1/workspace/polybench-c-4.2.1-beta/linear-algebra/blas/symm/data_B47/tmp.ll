...
; <label>:18:                                     ; preds = %._crit_edge17, %._crit_edge, %17
...
define internal void @init_array(i32, i32, double*, double*, [1200 x double]*, [1000 x double]*, [1200 x double]*) #2 {
  ...
  %8 = icmp sgt i32 %0, 0
  br i1 %8, label %.preheader40.lr.ph, label %.._crit_edge47_crit_edge

.._crit_edge47_crit_edge:                         ; preds = %7
...
.preheader40.us:                                  ; preds = %._crit_edge50.us..preheader40.us_crit_edge, %.preheader40.us.preheader
  %indvars.iv75 = phi i64 [ 0, %.preheader40.us.preheader ], [ %indvars.iv.next76, %._crit_edge50.us..preheader40.us_crit_edge ]
  %12 = add i64 %indvars.iv75, %11
  %13 = trunc i64 %12 to i32
  br label %14

; <label>:14:                                     ; preds = %._crit_edge83, %.preheader40.us
  %indvars.iv72 = phi i64 [ 0, %.preheader40.us ], [ %indvars.iv.next73, %._crit_edge83 ]
  ...
  br i1 %exitcond74, label %._crit_edge50.us, label %._crit_edge83

._crit_edge83:                                    ; preds = %14
  br label %14

._crit_edge50.us:                                 ; preds = %14
  %indvars.iv.next76 = add nuw nsw i64 %indvars.iv75, 1
  %exitcond78 = icmp eq i64 %indvars.iv.next76, %wide.trip.count77
  br i1 %exitcond78, label %.preheader39, label %._crit_edge50.us..preheader40.us_crit_edge

._crit_edge50.us..preheader40.us_crit_edge:       ; preds = %._crit_edge50.us
  br label %.preheader40.us

.preheader39:                                     ; preds = %._crit_edge50.us
  %27 = icmp sgt i32 %0, 0
  br i1 %27, label %.preheader39..preheader.lr.ph_crit_edge, label %.preheader39.._crit_edge47_crit_edge

.preheader39.._crit_edge47_crit_edge:             ; preds = %.preheader39
  br label %._crit_edge47

.preheader39..preheader.lr.ph_crit_edge:          ; preds = %.preheader39
  br label %.preheader.lr.ph

.preheader.lr.ph:                                 ; preds = %.preheader39..preheader.lr.ph_crit_edge, %.preheader40.lr.ph..preheader.lr.ph_crit_edge
...
.loopexit:                                        ; preds = %middle.block..loopexit_crit_edge, %.prol.loopexit62..loopexit_crit_edge, %._crit_edge..loopexit_crit_edge, %.loopexit.loopexit
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  %exitcond = icmp eq i64 %indvars.iv.next70, %wide.trip.count71
  br i1 %exitcond, label %._crit_edge47.loopexit, label %.loopexit..lr.ph_crit_edge

.loopexit..lr.ph_crit_edge:                       ; preds = %.loopexit
  br label %.lr.ph

.lr.ph:                                           ; preds = %.loopexit..lr.ph_crit_edge, %.preheader.lr.ph
  %indvars.iv69 = phi i64 [ 0, %.preheader.lr.ph ], [ %indvars.iv.next70, %.loopexit..lr.ph_crit_edge ]
  %indvars.iv67 = phi i64 [ 1, %.preheader.lr.ph ], [ %indvars.iv.next68, %.loopexit..lr.ph_crit_edge ]
...
.prol.loopexit:                                   ; preds = %.lr.ph..prol.loopexit_crit_edge, %.prol.preheader
  ...
  br i1 %43, label %.prol.loopexit.._crit_edge_crit_edge, label %.lr.ph.new.preheader
...
._crit_edge:                                      ; preds = %.prol.loopexit.._crit_edge_crit_edge, %._crit_edge.loopexit
  ...
  br i1 %56, label %.lr.ph44, label %._crit_edge..loopexit_crit_edge
...
.lr.ph44:                                         ; preds = %._crit_edge
  ...
  br i1 %lcmp.mod64, label %.lr.ph44..prol.loopexit62_crit_edge, label %.prol.preheader61.preheader

.lr.ph44..prol.loopexit62_crit_edge:              ; preds = %.lr.ph44
...
.prol.preheader61:                                ; preds = %.prol.preheader61..prol.preheader61_crit_edge, %.prol.preheader61.preheader
  %indvars.iv58.prol = phi i64 [ %indvars.iv.next59.prol, %.prol.preheader61..prol.preheader61_crit_edge ], [ %indvars.iv67, %.prol.preheader61.preheader ]
  %prol.iter = phi i32 [ %prol.iter.sub, %.prol.preheader61..prol.preheader61_crit_edge ], [ %xtraiter63, %.prol.preheader61.preheader ]
  ...
  br i1 %prol.iter.cmp, label %.prol.loopexit62.loopexit, label %.prol.preheader61..prol.preheader61_crit_edge, !llvm.loop !1
...
.prol.loopexit62:                                 ; preds = %.lr.ph44..prol.loopexit62_crit_edge, %.prol.loopexit62.loopexit
  %indvars.iv58.unr = phi i64 [ %indvars.iv67, %.lr.ph44..prol.loopexit62_crit_edge ], [ %indvars.iv.next59.prol, %.prol.loopexit62.loopexit ]
  %58 = icmp ult i32 %37, 7
  br i1 %58, label %.prol.loopexit62..loopexit_crit_edge, label %.lr.ph44.new.preheader

.prol.loopexit62..loopexit_crit_edge:             ; preds = %.prol.loopexit62
  br label %.loopexit
...
.lr.ph44.new.preheader:                           ; preds = %.prol.loopexit62
  ...
  br i1 %min.iters.check, label %.lr.ph44.new.preheader..lr.ph44.new.preheader82_crit_edge, label %min.iters.checked

.lr.ph44.new.preheader..lr.ph44.new.preheader82_crit_edge: ; preds = %.lr.ph44.new.preheader
  br label %.lr.ph44.new.preheader82
...
min.iters.checked:                                ; preds = %.lr.ph44.new.preheader
  ...
  br i1 %cmp.zero, label %min.iters.checked..lr.ph44.new.preheader82_crit_edge, label %vector.body.preheader

min.iters.checked..lr.ph44.new.preheader82_crit_edge: ; preds = %min.iters.checked
  br label %.lr.ph44.new.preheader82
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %middle.block..loopexit_crit_edge, label %middle.block..lr.ph44.new.preheader82_crit_edge

middle.block..lr.ph44.new.preheader82_crit_edge:  ; preds = %middle.block
  br label %.lr.ph44.new.preheader82

middle.block..loopexit_crit_edge:                 ; preds = %middle.block
  br label %.loopexit

.lr.ph44.new.preheader82:                         ; preds = %middle.block..lr.ph44.new.preheader82_crit_edge, %min.iters.checked..lr.ph44.new.preheader82_crit_edge, %.lr.ph44.new.preheader..lr.ph44.new.preheader82_crit_edge
  %indvars.iv58.ph = phi i64 [ %indvars.iv58.unr, %min.iters.checked..lr.ph44.new.preheader82_crit_edge ], [ %indvars.iv58.unr, %.lr.ph44.new.preheader..lr.ph44.new.preheader82_crit_edge ], [ %ind.end, %middle.block..lr.ph44.new.preheader82_crit_edge ]
  br label %.lr.ph44.new

.lr.ph44.new:                                     ; preds = %.lr.ph44.new..lr.ph44.new_crit_edge, %.lr.ph44.new.preheader82
  %indvars.iv58 = phi i64 [ %indvars.iv.next59.7, %.lr.ph44.new..lr.ph44.new_crit_edge ], [ %indvars.iv58.ph, %.lr.ph44.new.preheader82 ]
  ...
  br i1 %exitcond.7, label %.loopexit.loopexit, label %.lr.ph44.new..lr.ph44.new_crit_edge, !llvm.loop !6
...
._crit_edge47:                                    ; preds = %.preheader39.._crit_edge47_crit_edge, %.._crit_edge47_crit_edge, %._crit_edge47.loopexit
  ret void
}
...
define internal void @kernel_symm(i32, i32, double, double, [1200 x double]*, [1000 x double]*, [1200 x double]*) #2 {
  ...
  %9 = icmp sgt i32 %1, 0
  %or.cond = and i1 %8, %9
  br i1 %or.cond, label %.preheader44.us.preheader, label %.._crit_edge55_crit_edge

.._crit_edge55_crit_edge:                         ; preds = %7
...
.preheader44.us:                                  ; preds = %._crit_edge51.us..preheader44.us_crit_edge, %.preheader44.us.preheader
  %indvars.iv82 = phi i64 [ %indvars.iv.next83, %._crit_edge51.us..preheader44.us_crit_edge ], [ 0, %.preheader44.us.preheader ]
...
.preheader.us61.preheader:                        ; preds = %.preheader44.us
  br i1 %min.iters.check, label %.preheader.us61.preheader..preheader.us61.preheader110_crit_edge, label %min.iters.checked

.preheader.us61.preheader..preheader.us61.preheader110_crit_edge: ; preds = %.preheader.us61.preheader
  br label %.preheader.us61.preheader110

min.iters.checked:                                ; preds = %.preheader.us61.preheader
  br i1 %cmp.zero, label %min.iters.checked..preheader.us61.preheader110_crit_edge, label %vector.memcheck

min.iters.checked..preheader.us61.preheader110_crit_edge: ; preds = %min.iters.checked
  br label %.preheader.us61.preheader110
...
vector.memcheck:                                  ; preds = %min.iters.checked
  ...
  br i1 %conflict.rdx, label %vector.memcheck..preheader.us61.preheader110_crit_edge, label %vector.ph

vector.memcheck..preheader.us61.preheader110_crit_edge: ; preds = %vector.memcheck
  br label %.preheader.us61.preheader110
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.ph
  ...
  br i1 %40, label %middle.block, label %vector.body.vector.body_crit_edge, !llvm.loop !16

vector.body.vector.body_crit_edge:                ; preds = %vector.body
  br label %vector.body

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %middle.block.._crit_edge51.us_crit_edge, label %middle.block..preheader.us61.preheader110_crit_edge

middle.block..preheader.us61.preheader110_crit_edge: ; preds = %middle.block
  br label %.preheader.us61.preheader110

middle.block.._crit_edge51.us_crit_edge:          ; preds = %middle.block
  br label %._crit_edge51.us

.preheader.us61.preheader110:                     ; preds = %middle.block..preheader.us61.preheader110_crit_edge, %vector.memcheck..preheader.us61.preheader110_crit_edge, %min.iters.checked..preheader.us61.preheader110_crit_edge, %.preheader.us61.preheader..preheader.us61.preheader110_crit_edge
  %indvars.iv.ph = phi i64 [ 0, %vector.memcheck..preheader.us61.preheader110_crit_edge ], [ 0, %min.iters.checked..preheader.us61.preheader110_crit_edge ], [ 0, %.preheader.us61.preheader..preheader.us61.preheader110_crit_edge ], [ %n.vec, %middle.block..preheader.us61.preheader110_crit_edge ]
  %41 = sub nsw i64 %wide.trip.count80, %indvars.iv.ph
  %xtraiter = and i64 %41, 1
  %lcmp.mod = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod, label %.preheader.us61.preheader110..preheader.us61.prol.loopexit.unr-lcssa_crit_edge, label %.preheader.us61.prol.preheader

.preheader.us61.preheader110..preheader.us61.prol.loopexit.unr-lcssa_crit_edge: ; preds = %.preheader.us61.preheader110
...
.preheader.us61.prol.loopexit.unr-lcssa:          ; preds = %.preheader.us61.preheader110..preheader.us61.prol.loopexit.unr-lcssa_crit_edge, %.preheader.us61.prol
  %indvars.iv.unr.ph = phi i64 [ %indvars.iv.next.prol, %.preheader.us61.prol ], [ %indvars.iv.ph, %.preheader.us61.preheader110..preheader.us61.prol.loopexit.unr-lcssa_crit_edge ]
...
.preheader.us61.prol.loopexit:                    ; preds = %.preheader.us61.prol.loopexit.unr-lcssa
  ...
  br i1 %52, label %.preheader.us61.prol.loopexit.._crit_edge51.us.loopexit111_crit_edge, label %.preheader.us61.preheader110.new

.preheader.us61.prol.loopexit.._crit_edge51.us.loopexit111_crit_edge: ; preds = %.preheader.us61.prol.loopexit
...
.preheader.us61:                                  ; preds = %.preheader.us61..preheader.us61_crit_edge, %.preheader.us61.preheader110.new
  %indvars.iv = phi i64 [ %indvars.iv.unr.ph, %.preheader.us61.preheader110.new ], [ %indvars.iv.next.1, %.preheader.us61..preheader.us61_crit_edge ]
  ...
  br i1 %exitcond.1, label %._crit_edge51.us.loopexit111.unr-lcssa, label %.preheader.us61..preheader.us61_crit_edge, !llvm.loop !17

.preheader.us61..preheader.us61_crit_edge:        ; preds = %.preheader.us61
  br label %.preheader.us61
...
._crit_edge51.us.loopexit111:                     ; preds = %.preheader.us61.prol.loopexit.._crit_edge51.us.loopexit111_crit_edge, %._crit_edge51.us.loopexit111.unr-lcssa
  br label %._crit_edge51.us

._crit_edge51.us:                                 ; preds = %middle.block.._crit_edge51.us_crit_edge, %._crit_edge51.us.loopexit111, %._crit_edge51.us.loopexit
  %indvars.iv.next83 = add nuw nsw i64 %indvars.iv82, 1
  %exitcond85 = icmp eq i64 %indvars.iv.next83, %wide.trip.count84
  br i1 %exitcond85, label %._crit_edge55.loopexit, label %._crit_edge51.us..preheader44.us_crit_edge

._crit_edge51.us..preheader44.us_crit_edge:       ; preds = %._crit_edge51.us
  br label %.preheader44.us

.preheader.us.us:                                 ; preds = %._crit_edge.us.us..preheader.us.us_crit_edge, %.preheader.us.us.preheader
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %._crit_edge.us.us..preheader.us.us_crit_edge ], [ 0, %.preheader.us.us.preheader ]
...
._crit_edge.us.us:                                ; preds = %85
  ...
  br i1 %exitcond81, label %._crit_edge51.us.loopexit, label %._crit_edge.us.us..preheader.us.us_crit_edge

._crit_edge.us.us..preheader.us.us_crit_edge:     ; preds = %._crit_edge.us.us
  br label %.preheader.us.us

; <label>:85:                                     ; preds = %._crit_edge, %.preheader.us.us
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %._crit_edge ], [ 0, %.preheader.us.us ]
  %.047.us.us = phi double [ %98, %._crit_edge ], [ 0.000000e+00, %.preheader.us.us ]
...
._crit_edge55:                                    ; preds = %.._crit_edge55_crit_edge, %._crit_edge55.loopexit
  ret void
}
...
define internal void @print_array(i32, i32, [1200 x double]*) #0 {
  ...
  %9 = icmp sgt i32 %1, 0
  %or.cond = and i1 %8, %9
  br i1 %or.cond, label %.preheader.us.preheader, label %.._crit_edge13_crit_edge

.._crit_edge13_crit_edge:                         ; preds = %3
...
; <label>:12:                                     ; preds = %._crit_edge20, %.preheader.us
  %indvars.iv = phi i64 [ 0, %.preheader.us ], [ %indvars.iv.next, %._crit_edge20 ]
...
._crit_edge.us:                                   ; preds = %19
  ...
  br i1 %exitcond18, label %._crit_edge13.loopexit, label %._crit_edge.us..preheader.us_crit_edge
