...
._crit_edge18.us:                                 ; preds = %._crit_edge78
  ...
  %exitcond91 = icmp eq i64 %indvars.iv.next75, 800
  br i1 %exitcond91, label %.lr.ph14.split.us.preheader, label %.lr.ph20.split.us
...
._crit_edge12.us:                                 ; preds = %.lr.ph14.split.us.new
  ...
  %exitcond90 = icmp eq i64 %indvars.iv.next67, 1100
  br i1 %exitcond90, label %.lr.ph8.split.us.preheader, label %.lr.ph14.split.us
...
._crit_edge81:                                    ; preds = %._crit_edge81, %.lr.ph8.split.us
  %indvars.iv54 = phi i64 [ 0, %.lr.ph8.split.us ], [ %indvars.iv.next55, %._crit_edge81 ]
  ...
  br i1 %exitcond57, label %._crit_edge6.us, label %._crit_edge81

._crit_edge6.us:                                  ; preds = %._crit_edge81
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  %exitcond89 = icmp eq i64 %indvars.iv.next59, 900
  br i1 %exitcond89, label %.lr.ph2.split.us.preheader, label %.lr.ph8.split.us
...
._crit_edge83:                                    ; preds = %._crit_edge83, %.lr.ph2.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph2.split.us ], [ %indvars.iv.next, %._crit_edge83 ]
  ...
  br i1 %exitcond, label %._crit_edge.us, label %._crit_edge83

._crit_edge.us:                                   ; preds = %._crit_edge83
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1
  %exitcond88 = icmp eq i64 %indvars.iv.next53, 800
  br i1 %exitcond88, label %._crit_edge82, label %.lr.ph2.split.us
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph8.us.us
  ...
  %exitcond95.1 = icmp eq i64 %indvars.iv.next75.1, 1100
  br i1 %exitcond95.1, label %._crit_edge9.us.us, label %._crit_edge
...
._crit_edge3.us:                                  ; preds = %._crit_edge.us.us
  ...
  br i1 %exitcond98, label %._crit_edge90, label %.lr.ph2.us
...
._crit_edge.us.us:                                ; preds = %._crit_edge91
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1
  %exitcond67 = icmp eq i64 %indvars.iv.next65, 1200
  br i1 %exitcond67, label %._crit_edge3.us, label %.lr.ph.us.us

._crit_edge91:                                    ; preds = %._crit_edge91, %.lr.ph.us.us
  %30 = phi double [ %29, %.lr.ph.us.us ], [ %48, %._crit_edge91 ]
  %indvars.iv62 = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next63.2, %._crit_edge91 ]
  ...
  br i1 %exitcond.2, label %._crit_edge.us.us, label %._crit_edge91

._crit_edge90:                                    ; preds = %._crit_edge3.us
  ret void
}
...
.lr.ph2.split.us:                                 ; preds = %._crit_edge.us, %.lr.ph2
  %indvars.iv10 = phi i64 [ 0, %.lr.ph2 ], [ %indvars.iv.next11, %._crit_edge.us ]
...
._crit_edge.us:                                   ; preds = %._crit_edge12
  ...
  br i1 %exitcond15, label %._crit_edge, label %.lr.ph2.split.us
