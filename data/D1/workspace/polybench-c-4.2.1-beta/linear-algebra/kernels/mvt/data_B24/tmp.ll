...
.preheader27.us:                                  ; preds = %.preheader27.us.preheader, %._crit_edge33.us
  ...
  %7 = getelementptr inbounds double, double* %1, i64 %indvars.iv46
  br i1 true, label %.prol.loopexit43, label %.prol.preheader42

.prol.preheader42:                                ; preds = %.preheader27.us
  %8 = load double, double* %7, align 8
  %9 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv46, i64 0
...
.prol.loopexit43:                                 ; preds = %.prol.preheader42, %.preheader27.us
  ...
  br i1 false, label %._crit_edge33.us, label %.prol.loopexit43..preheader27.us.new_crit_edge

.prol.loopexit43..preheader27.us.new_crit_edge:   ; preds = %.prol.loopexit43
  %.pre = load double, double* %7, align 8
  br label %.preheader27.us.new

.preheader27.us.new:                              ; preds = %.prol.loopexit43..preheader27.us.new_crit_edge, %.preheader27.us.new
  %14 = phi double [ %26, %.preheader27.us.new ], [ %.pre, %.prol.loopexit43..preheader27.us.new_crit_edge ]
  %indvars.iv38 = phi i64 [ %indvars.iv.next39.1, %.preheader27.us.new ], [ %indvars.iv38.unr.ph, %.prol.loopexit43..preheader27.us.new_crit_edge ]
  %15 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv46, i64 %indvars.iv38
  %16 = load double, double* %15, align 8
  %17 = getelementptr inbounds double, double* %3, i64 %indvars.iv38
  %18 = load double, double* %17, align 8
  %19 = fmul double %16, %18
  %20 = fadd double %14, %19
  store double %20, double* %7, align 8
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  %21 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv46, i64 %indvars.iv.next39
  %22 = load double, double* %21, align 8
  %23 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next39
...
.prol.loopexit..preheader.us.new_crit_edge:       ; preds = %.prol.loopexit
  %.pre50 = load double, double* %27, align 8
  br label %.preheader.us.new

.preheader.us.new:                                ; preds = %.prol.loopexit..preheader.us.new_crit_edge, %.preheader.us.new
  %34 = phi double [ %46, %.preheader.us.new ], [ %.pre50, %.prol.loopexit..preheader.us.new_crit_edge ]
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.preheader.us.new ], [ %indvars.iv.unr.ph, %.prol.loopexit..preheader.us.new_crit_edge ]
...
.lr.ph:                                           ; preds = %._crit_edge17, %27
  %indvars.iv = phi i64 [ %indvars.iv.next, %27 ], [ 0, %._crit_edge17 ]
