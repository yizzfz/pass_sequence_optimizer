...
.lr.ph10.us.new:                                  ; preds = %.lr.ph10.us.new.preheader, %.lr.ph10.us.new
  ...
  %exitcond49.3 = icmp eq i64 %indvars.iv.next47.3, %wide.trip.count44
...
.lr.ph.us.us.new:                                 ; preds = %.lr.ph.us.us.new.preheader, %.lr.ph.us.us.new
  ...
  %exitcond37.1 = icmp eq i64 %indvars.iv.next35.1, %wide.trip.count44
...
.prol.loopexit54:                                 ; preds = %.prol.loopexit54.loopexit, %.lr.ph10.us
  ...
  br i1 %12, label %._crit_edge11.us, label %.lr.ph10.us.new.preheader
