...
if.then:                                          ; preds = %land.lhs.true
  ...
  tail call fastcc void @print_array(double* %3)
  br label %if.end
...
for.inc.us:                                       ; preds = %for.inc.us, %for.body.us
  ...
  %exitcond8.1 = icmp eq i64 %indvars.iv.next, 1999
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  br i1 %exitcond8.1, label %for.cond35.for.cond.loopexit_crit_edge.us, label %for.inc.us
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc20_crit_edge.us, %entry
  %indvars.iv31 = phi i64 [ 0, %entry ], [ %indvars.iv.next32, %for.cond1.for.inc20_crit_edge.us ]
  %sunkaddr1 = shl i64 %indvars.iv31, 3
  %sunkaddr2 = add i64 %sunkaddr, %sunkaddr1
  %sunkaddr3 = inttoptr i64 %sunkaddr2 to double*
  %sunkaddr5 = shl i64 %indvars.iv31, 3
  %sunkaddr6 = add i64 %sunkaddr4, %sunkaddr5
  %sunkaddr7 = inttoptr i64 %sunkaddr6 to double*
  br label %for.inc.us

for.inc.us:                                       ; preds = %for.inc.us, %for.cond1.preheader.us
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc.us ], [ 0, %for.cond1.preheader.us ]
  ...
  %exitcond35 = icmp eq i64 %indvars.iv27, 1999
  %indvars.iv.next28 = add nuw nsw i64 %indvars.iv27, 1
  br i1 %exitcond35, label %for.cond1.for.inc20_crit_edge.us, label %for.inc.us

for.cond1.for.inc20_crit_edge.us:                 ; preds = %for.inc.us
  %indvars.iv.next32 = add nuw i64 %indvars.iv31, 1
  %cmp.us = icmp slt i64 %indvars.iv.next32, 2000
...
for.cond26.preheader.us.preheader:                ; preds = %for.cond1.for.inc20_crit_edge.us
  ...
  %sunkaddr8.1 = ptrtoint double* %x to i64
...
for.cond26.preheader.us:                          ; preds = %for.cond26.preheader.us.preheader, %for.cond26.for.inc45_crit_edge.us
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.cond26.for.inc45_crit_edge.us ], [ 0, %for.cond26.preheader.us.preheader ]
  %arrayidx30.us = getelementptr inbounds double, double* %x, i64 %indvars.iv25
  %.pre = load double, double* %arrayidx30.us, align 8
  %sunkaddr9 = shl i64 %indvars.iv25, 3
  %sunkaddr10 = add i64 %sunkaddr8, %sunkaddr9
  %sunkaddr11 = inttoptr i64 %sunkaddr10 to double*
  %sunkaddr9.1 = shl i64 %indvars.iv25, 3
  %sunkaddr10.1 = add i64 %sunkaddr8.1, %sunkaddr9.1
  %sunkaddr11.1 = inttoptr i64 %sunkaddr10.1 to double*
  br label %for.inc42.us

for.inc42.us:                                     ; preds = %for.inc42.us, %for.cond26.preheader.us
  %5 = phi double [ %.pre, %for.cond26.preheader.us ], [ %add39.us.1, %for.inc42.us ]
  %indvars.iv21 = phi i64 [ 0, %for.cond26.preheader.us ], [ %indvars.iv.next22.1, %for.inc42.us ]
  %arrayidx34.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv21, i64 %indvars.iv25
  %6 = load double, double* %arrayidx34.us, align 8
  %mul35.us = fmul double %6, %beta
  %arrayidx37.us = getelementptr inbounds double, double* %y, i64 %indvars.iv21
  ...
  %arrayidx34.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv.next22, i64 %indvars.iv25
  %8 = load double, double* %arrayidx34.us.1, align 8
  %mul35.us.1 = fmul double %8, %beta
  %arrayidx37.us.1 = getelementptr inbounds double, double* %y, i64 %indvars.iv.next22
  ...
  store double %add39.us.1, double* %sunkaddr11.1, align 8
  %exitcond34.1 = icmp eq i64 %indvars.iv.next22, 1999
  %indvars.iv.next22.1 = add nsw i64 %indvars.iv21, 2
  br i1 %exitcond34.1, label %for.cond26.for.inc45_crit_edge.us, label %for.inc42.us

for.cond26.for.inc45_crit_edge.us:                ; preds = %for.inc42.us
  %indvars.iv.next26 = add nuw i64 %indvars.iv25, 1
  %cmp24.us = icmp slt i64 %indvars.iv.next26, 2000
  br i1 %cmp24.us, label %for.cond26.preheader.us, label %vector.memcheck
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %wide.load22 = load <2 x double>, <2 x double>* %13, align 8, !alias.scope !1, !noalias !4
  %14 = getelementptr inbounds double, double* %z, i64 %index
  %15 = bitcast double* %14 to <2 x double>*
  %wide.load23 = load <2 x double>, <2 x double>* %15, align 8, !alias.scope !4
  %16 = getelementptr double, double* %14, i64 2
  %17 = bitcast double* %16 to <2 x double>*
  %wide.load24 = load <2 x double>, <2 x double>* %17, align 8, !alias.scope !4
  %18 = fadd <2 x double> %wide.load, %wide.load23
  %19 = fadd <2 x double> %wide.load22, %wide.load24
  ...
  %wide.load22.1 = load <2 x double>, <2 x double>* %25, align 8, !alias.scope !1, !noalias !4
  %26 = getelementptr inbounds double, double* %z, i64 %index.next
  %27 = bitcast double* %26 to <2 x double>*
  %wide.load23.1 = load <2 x double>, <2 x double>* %27, align 8, !alias.scope !4
  %28 = getelementptr double, double* %26, i64 2
  %29 = bitcast double* %28 to <2 x double>*
  %wide.load24.1 = load <2 x double>, <2 x double>* %29, align 8, !alias.scope !4
  %30 = fadd <2 x double> %wide.load.1, %wide.load23.1
  %31 = fadd <2 x double> %wide.load22.1, %wide.load24.1
  ...
  br i1 %34, label %for.cond64.preheader.us.preheader.loopexit25, label %vector.body, !llvm.loop !6

for.cond64.preheader.us.preheader.loopexit:       ; preds = %for.inc58
  br label %for.cond64.preheader.us.preheader

for.cond64.preheader.us.preheader.loopexit25:     ; preds = %vector.body
  br label %for.cond64.preheader.us.preheader

for.cond64.preheader.us.preheader:                ; preds = %for.cond64.preheader.us.preheader.loopexit25, %for.cond64.preheader.us.preheader.loopexit
  %sunkaddr12 = ptrtoint double* %w to i64
  %sunkaddr12.1 = ptrtoint double* %w to i64
...
for.cond64.preheader.us:                          ; preds = %for.cond64.preheader.us.preheader, %for.cond64.for.inc83_crit_edge.us
  ...
  %.pre39 = load double, double* %arrayidx68.us, align 8
  %sunkaddr13 = shl i64 %indvars.iv15, 3
  %sunkaddr14 = add i64 %sunkaddr12, %sunkaddr13
  %sunkaddr15 = inttoptr i64 %sunkaddr14 to double*
  %sunkaddr13.1 = shl i64 %indvars.iv15, 3
  %sunkaddr14.1 = add i64 %sunkaddr12.1, %sunkaddr13.1
  %sunkaddr15.1 = inttoptr i64 %sunkaddr14.1 to double*
  br label %for.inc80.us

for.inc80.us:                                     ; preds = %for.inc80.us, %for.cond64.preheader.us
  %35 = phi double [ %.pre39, %for.cond64.preheader.us ], [ %add77.us.1, %for.inc80.us ]
  ...
  store double %add77.us.1, double* %sunkaddr15.1, align 8
  %exitcond33.1 = icmp eq i64 %indvars.iv.next, 1999
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  br i1 %exitcond33.1, label %for.cond64.for.inc83_crit_edge.us, label %for.inc80.us

for.cond64.for.inc83_crit_edge.us:                ; preds = %for.inc80.us
  %indvars.iv.next16 = add nuw i64 %indvars.iv15, 1
  %cmp62.us = icmp slt i64 %indvars.iv.next16, 2000
  br i1 %cmp62.us, label %for.cond64.preheader.us, label %for.end85

for.inc58:                                        ; preds = %for.inc58, %for.inc58.preheader
  %indvars.iv17 = phi i64 [ 0, %for.inc58.preheader ], [ %indvars.iv.next18.4, %for.inc58 ]
  %arrayidx52 = getelementptr inbounds double, double* %x, i64 %indvars.iv17
  %40 = load double, double* %arrayidx52, align 8
  %arrayidx54 = getelementptr inbounds double, double* %z, i64 %indvars.iv17
  %41 = load double, double* %arrayidx54, align 8
  %add55 = fadd double %40, %41
  store double %add55, double* %arrayidx52, align 8
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  %arrayidx52.1 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next18
  %42 = load double, double* %arrayidx52.1, align 8
  %arrayidx54.1 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next18
  ...
  %arrayidx52.2 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next18.1
  %44 = load double, double* %arrayidx52.2, align 8
  %arrayidx54.2 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next18.1
  ...
  %arrayidx52.3 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next18.2
  %46 = load double, double* %arrayidx52.3, align 8
  %arrayidx54.3 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next18.2
  ...
  %arrayidx52.4 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next18.3
  %48 = load double, double* %arrayidx52.4, align 8
  %arrayidx54.4 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next18.3
  %49 = load double, double* %arrayidx54.4, align 8
  %add55.4 = fadd double %48, %49
  store double %add55.4, double* %arrayidx52.4, align 8
  %exitcond.4 = icmp eq i64 %indvars.iv.next18.3, 1999
  %indvars.iv.next18.4 = add nsw i64 %indvars.iv17, 5
  br i1 %exitcond.4, label %for.cond64.preheader.us.preheader.loopexit, label %for.inc58, !llvm.loop !9
