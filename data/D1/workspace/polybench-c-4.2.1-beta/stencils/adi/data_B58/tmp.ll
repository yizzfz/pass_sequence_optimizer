...
.lver.check:                                      ; preds = %._crit_edge.us, %._crit_edge.preheader
  ...
  %indvars.iv29 = phi i64 [ 1, %._crit_edge.preheader ], [ %indvars.iv.next30, %._crit_edge.us ]
  %6 = add i64 %indvar, 1
  %7 = add i64 %indvar, 1
...
.lr.ph10.us:                                      ; preds = %.lr.ph10.us, %._crit_edge7.us
  ...
  %38 = phi double [ 1.000000e+00, %._crit_edge7.us ], [ %51, %.lr.ph10.us ]
...
; <label>:54:                                     ; preds = %54, %.ph
  ...
  br i1 %exitcond, label %._crit_edge7.us.loopexit75, label %54

._crit_edge7.us.loopexit:                         ; preds = %.ph.lver.orig
  br label %._crit_edge7.us

._crit_edge7.us.loopexit75:                       ; preds = %54
  br label %._crit_edge7.us

._crit_edge7.us:                                  ; preds = %._crit_edge7.us.loopexit75, %._crit_edge7.us.loopexit
...
.ph67.lver.orig:                                  ; preds = %.ph67.lver.orig.preheader, %.ph67.lver.orig
  ...
  br i1 %exitcond34.lver.orig, label %._crit_edge17.us.loopexit, label %.ph67.lver.orig
...
.lr.ph20.us:                                      ; preds = %.lr.ph20.us, %._crit_edge17.us
  %indvars.iv35 = phi i64 [ 998, %._crit_edge17.us ], [ %indvars.iv.next36.1, %.lr.ph20.us ]
  %112 = phi double [ 1.000000e+00, %._crit_edge17.us ], [ %125, %.lr.ph20.us ]
...
; <label>:128:                                    ; preds = %128, %.ph67
  ...
  br i1 %exitcond34, label %._crit_edge17.us.loopexit74, label %128

._crit_edge17.us.loopexit:                        ; preds = %.ph67.lver.orig
  br label %._crit_edge17.us

._crit_edge17.us.loopexit74:                      ; preds = %128
  br label %._crit_edge17.us

._crit_edge17.us:                                 ; preds = %._crit_edge17.us.loopexit74, %._crit_edge17.us.loopexit
...
._crit_edge4._crit_edge:                          ; preds = %._crit_edge4.us
  ...
  br i1 %153, label %._crit_edge.preheader, label %._crit_edge25
