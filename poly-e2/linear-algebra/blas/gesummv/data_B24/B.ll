...
for.body:                                         ; preds = %for.end, %entry
  %indvars.iv48 = phi i64 [ 0, %entry ], [ %indvars.iv.next5, %for.end ]
...
for.body5:                                        ; preds = %for.body5, %for.body
  ...
  %1 = mul nuw nsw i64 %indvars.iv6, %indvars.iv48
  %2 = add nuw nsw i64 %1, 1
  %3 = trunc i64 %2 to i32
  %rem6 = srem i32 %3, 1300
  %conv7 = sitofp i32 %rem6 to double
  %arrayidx13 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv48, i64 %indvars.iv6
  ...
  %arrayidx23 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv48, i64 %indvars.iv6
...
entry:
  ...
  %sunkaddr22 = ptrtoint double* %y to i64
  br label %for.body

for.body:                                         ; preds = %for.end, %entry
  %indvars.iv15 = phi i64 [ 0, %entry ], [ %indvars.iv.next2, %for.end ]
  %arrayidx = getelementptr inbounds double, double* %tmp, i64 %indvars.iv15
  store double 0.000000e+00, double* %arrayidx, align 8
  %arrayidx4 = getelementptr inbounds double, double* %y, i64 %indvars.iv15
  store double 0.000000e+00, double* %arrayidx4, align 8
  %sunkaddr19 = shl i64 %indvars.iv15, 3
  %sunkaddr20 = add i64 %sunkaddr, %sunkaddr19
  %sunkaddr21 = inttoptr i64 %sunkaddr20 to double*
  %sunkaddr23 = shl i64 %indvars.iv15, 3
...
for.body7:                                        ; preds = %for.body7, %for.body
  ...
  %arrayidx11 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv15, i64 %indvars.iv3
  ...
  store double %add, double* %sunkaddr21, align 8
  %arrayidx21 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv15, i64 %indvars.iv3
...
for.end:                                          ; preds = %for.body7
  ...
  %exitcond4 = icmp eq i64 %indvars.iv.next2, 1300
