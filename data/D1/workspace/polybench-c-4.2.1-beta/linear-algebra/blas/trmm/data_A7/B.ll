...
define internal fastcc void @init_array(i32, i32, double* nocapture, [1000 x double]*, [1200 x double]*) unnamed_addr #2 {
  ...
  %6 = icmp sgt i32 %0, 0
  br i1 %6, label %.preheader.lr.ph, label %._crit_edge27
...
.preheader.us.preheader:                          ; preds = %.preheader.lr.ph
  ...
  %wide.trip.count33.1 = zext i32 %1 to i64
  br label %.preheader.us

.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge24.us
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %._crit_edge24.us ], [ 0, %.preheader.us.preheader ]
  %11 = add nuw i64 %indvars.iv42, 4294967295
  %12 = icmp sgt i64 %indvars.iv42, 0
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %.prol.loopexit, %.preheader.us
  %13 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv42, i64 %indvars.iv42
  store double 1.000000e+00, double* %13, align 8
  %14 = trunc i64 %indvars.iv42 to i32
  %15 = add i32 %14, %1
  br i1 %lcmp.mod37, label %.prol.loopexit35, label %.prol.preheader34

.prol.preheader34:                                ; preds = %._crit_edge.us
  %16 = srem i32 %15, %1
  %17 = sitofp i32 %16 to double
  %18 = fdiv double %17, %8
  %19 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv42, i64 0
  store double %18, double* %19, align 8
  br label %.prol.loopexit35

.prol.loopexit35:                                 ; preds = %.prol.preheader34, %._crit_edge.us
  %indvars.iv31.unr.ph = phi i64 [ 1, %.prol.preheader34 ], [ 0, %._crit_edge.us ]
  br i1 %10, label %._crit_edge24.us, label %._crit_edge.us.new.preheader

._crit_edge.us.new.preheader:                     ; preds = %.prol.loopexit35
  br label %._crit_edge.us.new

._crit_edge.us.new:                               ; preds = %._crit_edge.us.new.preheader, %._crit_edge.us.new
  %indvars.iv31 = phi i64 [ %indvars.iv.next32.1, %._crit_edge.us.new ], [ %indvars.iv31.unr.ph, %._crit_edge.us.new.preheader ]
  %20 = trunc i64 %indvars.iv31 to i32
  %21 = sub i32 %15, %20
  %22 = srem i32 %21, %1
  %23 = sitofp i32 %22 to double
  %24 = fdiv double %23, %8
  %25 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv42, i64 %indvars.iv31
  store double %24, double* %25, align 8
  %indvars.iv.next32 = add nuw nsw i64 %indvars.iv31, 1
  %26 = trunc i64 %indvars.iv.next32 to i32
  %27 = sub i32 %15, %26
  %28 = srem i32 %27, %1
  %29 = sitofp i32 %28 to double
  %30 = fdiv double %29, %8
  %31 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv42, i64 %indvars.iv.next32
  store double %30, double* %31, align 8
  %indvars.iv.next32.1 = add nuw nsw i64 %indvars.iv31, 2
  %exitcond.139 = icmp eq i64 %indvars.iv.next32.1, %wide.trip.count33.1
  br i1 %exitcond.139, label %._crit_edge24.us.loopexit, label %._crit_edge.us.new
...
.lr.ph.us.new:                                    ; preds = %.lr.ph.us.new.preheader, %.lr.ph.us.new
  ...
  %32 = add nuw nsw i64 %indvars.iv, %indvars.iv42
  %33 = trunc i64 %32 to i32
  %34 = srem i32 %33, %0
  %35 = sitofp i32 %34 to double
  %36 = fdiv double %35, %9
  %37 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv42, i64 %indvars.iv
  store double %36, double* %37, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %38 = add nuw nsw i64 %indvars.iv.next, %indvars.iv42
  %39 = trunc i64 %38 to i32
  %40 = srem i32 %39, %0
  %41 = sitofp i32 %40 to double
  %42 = fdiv double %41, %9
  %43 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv42, i64 %indvars.iv.next
...
.lr.ph.us:                                        ; preds = %.preheader.us
  %xtraiter61 = and i64 %indvars.iv42, 1
  %lcmp.mod = icmp eq i64 %xtraiter61, 0
  br i1 %lcmp.mod, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.lr.ph.us
  %44 = trunc i64 %indvars.iv42 to i32
  %45 = srem i32 %44, %0
  %46 = sitofp i32 %45 to double
  %47 = fdiv double %46, %9
  %48 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv42, i64 0
...
._crit_edge24.us:                                 ; preds = %._crit_edge24.us.loopexit, %.prol.loopexit35
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1
  %exitcond = icmp eq i64 %indvars.iv.next43, %wide.trip.count44
  br i1 %exitcond, label %._crit_edge27.loopexit, label %.preheader.us

.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %._crit_edge ], [ 0, %.preheader.preheader ]
  %51 = add nuw i64 %indvars.iv56, 4294967295
  %52 = icmp sgt i64 %indvars.iv56, 0
  br i1 %52, label %.lr.ph, label %._crit_edge

.lr.ph:                                           ; preds = %.preheader
  %xtraiter5260 = and i64 %indvars.iv56, 1
  %lcmp.mod53 = icmp eq i64 %xtraiter5260, 0
  br i1 %lcmp.mod53, label %.prol.loopexit51, label %.prol.preheader50

.prol.preheader50:                                ; preds = %.lr.ph
  %53 = trunc i64 %indvars.iv56 to i32
  %54 = srem i32 %53, %0
  %55 = sitofp i32 %54 to double
  %56 = fdiv double %55, %9
  %57 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv56, i64 0
  store double %56, double* %57, align 8
  br label %.prol.loopexit51

.prol.loopexit51:                                 ; preds = %.prol.preheader50, %.lr.ph
  %indvars.iv45.unr.ph = phi i64 [ 1, %.prol.preheader50 ], [ 0, %.lr.ph ]
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  %indvars.iv45 = phi i64 [ %indvars.iv.next46.1, %.lr.ph.new ], [ %indvars.iv45.unr.ph, %.lr.ph.new.preheader ]
  %60 = add nuw nsw i64 %indvars.iv45, %indvars.iv56
  %61 = trunc i64 %60 to i32
  %62 = srem i32 %61, %0
  %63 = sitofp i32 %62 to double
  %64 = fdiv double %63, %9
  %65 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv56, i64 %indvars.iv45
  store double %64, double* %65, align 8
  %indvars.iv.next46 = add nuw nsw i64 %indvars.iv45, 1
  %66 = add nuw nsw i64 %indvars.iv.next46, %indvars.iv56
  %67 = trunc i64 %66 to i32
  %68 = srem i32 %67, %0
  %69 = sitofp i32 %68 to double
  %70 = fdiv double %69, %9
  %71 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv56, i64 %indvars.iv.next46
  ...
  br i1 %exitcond49.1, label %._crit_edge.loopexit, label %.lr.ph.new

._crit_edge.loopexit:                             ; preds = %.lr.ph.new
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit51, %.preheader
  %72 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv56, i64 %indvars.iv56
  store double 1.000000e+00, double* %72, align 8
  %indvars.iv.next57 = add nuw nsw i64 %indvars.iv56, 1
  %exitcond59 = icmp eq i64 %indvars.iv.next57, %wide.trip.count58
  br i1 %exitcond59, label %._crit_edge27.loopexit64, label %.preheader

._crit_edge27.loopexit:                           ; preds = %._crit_edge24.us
  br label %._crit_edge27

._crit_edge27.loopexit64:                         ; preds = %._crit_edge
  br label %._crit_edge27

._crit_edge27:                                    ; preds = %._crit_edge27.loopexit64, %._crit_edge27.loopexit, %5
  ret void
}
...
define internal fastcc void @kernel_trmm(i32, i32, double, [1000 x double]*, [1200 x double]*) unnamed_addr #2 {
  ...
  %7 = icmp sgt i32 %1, 0
  %or.cond = and i1 %6, %7
  br i1 %or.cond, label %.preheader22.us.preheader, label %._crit_edge28
...
.preheader22.us.preheader:                        ; preds = %5
  ...
  %wide.trip.count43.1 = zext i32 %0 to i64
  ...
  %16 = add nsw i64 %wide.trip.count49, -4
...
.preheader22.us:                                  ; preds = %._crit_edge26.us, %.preheader22.us.preheader
  %indvars.iv50 = phi i64 [ 0, %.preheader22.us.preheader ], [ %indvars.iv.next51, %._crit_edge26.us ]
  %indvars.iv39 = phi i64 [ 1, %.preheader22.us.preheader ], [ %indvars.iv.next40, %._crit_edge26.us ]
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1
  %17 = icmp slt i64 %indvars.iv.next51, %11
  br i1 %17, label %.preheader.us.us.preheader, label %.preheader.us31.preheader

.preheader.us.us.preheader:                       ; preds = %.preheader22.us
  %18 = sub nsw i64 0, %indvars.iv50
  %19 = trunc i64 %18 to i32
  %20 = add i32 %9, %19
  %xtraiter44 = and i32 %20, 1
  %lcmp.mod45 = icmp eq i32 %xtraiter44, 0
  %21 = sub i32 0, %19
  %22 = icmp eq i32 %10, %21
  %23 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv39, i64 %indvars.iv50
  %indvars.iv.next42.prol = add nuw nsw i64 %indvars.iv39, 1
...
.preheader.us31.prol:                             ; preds = %.preheader.us31.prol.preheader, %.preheader.us31.prol
  ...
  %24 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv50, i64 %indvars.iv.prol
...
.preheader.us31.prol.loopexit:                    ; preds = %.preheader.us31.prol.loopexit.loopexit, %.preheader.us31.preheader
  ...
  br i1 %12, label %._crit_edge26.us, label %.preheader.us31.preheader57

.preheader.us31.preheader57:                      ; preds = %.preheader.us31.prol.loopexit
  %27 = sub nsw i64 %16, %indvars.iv.unr
  %28 = lshr i64 %27, 2
  %29 = add nuw nsw i64 %28, 1
  %min.iters.check = icmp ult i64 %29, 2
  br i1 %min.iters.check, label %.preheader.us31.preheader65, label %min.iters.checked

min.iters.checked:                                ; preds = %.preheader.us31.preheader57
  ...
  br i1 %cmp.zero, label %.preheader.us31.preheader65, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %36 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv50, i64 %35
  ...
  %38 = fmul <2 x double> %strided.vec, %broadcast.splat64
  %39 = fmul <2 x double> %strided.vec60, %broadcast.splat64
  %40 = fmul <2 x double> %strided.vec61, %broadcast.splat64
  %41 = add nsw i64 %35, 3
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv50, i64 %41
  %43 = fmul <2 x double> %strided.vec62, %broadcast.splat64
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %._crit_edge26.us, label %.preheader.us31.preheader65

.preheader.us31.preheader65:                      ; preds = %middle.block, %min.iters.checked, %.preheader.us31.preheader57
  %indvars.iv.ph = phi i64 [ %indvars.iv.unr, %min.iters.checked ], [ %indvars.iv.unr, %.preheader.us31.preheader57 ], [ %ind.end, %middle.block ]
  br label %.preheader.us31

.preheader.us31:                                  ; preds = %.preheader.us31.preheader65, %.preheader.us31
  %indvars.iv = phi i64 [ %indvars.iv.next.3, %.preheader.us31 ], [ %indvars.iv.ph, %.preheader.us31.preheader65 ]
  %49 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv50, i64 %indvars.iv
  %50 = load double, double* %49, align 8
  %51 = fmul double %50, %2
  store double %51, double* %49, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv50, i64 %indvars.iv.next
  %53 = load double, double* %52, align 8
  %54 = fmul double %53, %2
  store double %54, double* %52, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %55 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv50, i64 %indvars.iv.next.1
  %56 = load double, double* %55, align 8
  %57 = fmul double %56, %2
  store double %57, double* %55, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %58 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv50, i64 %indvars.iv.next.2
  %59 = load double, double* %58, align 8
  %60 = fmul double %59, %2
  store double %60, double* %58, align 8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %exitcond.3 = icmp eq i64 %indvars.iv.next.3, %wide.trip.count49
  br i1 %exitcond.3, label %._crit_edge26.us.loopexit66, label %.preheader.us31, !llvm.loop !6

._crit_edge26.us.loopexit:                        ; preds = %._crit_edge.us.us
  br label %._crit_edge26.us

._crit_edge26.us.loopexit66:                      ; preds = %.preheader.us31
  br label %._crit_edge26.us

._crit_edge26.us:                                 ; preds = %._crit_edge26.us.loopexit66, %._crit_edge26.us.loopexit, %middle.block, %.preheader.us31.prol.loopexit
  %indvars.iv.next40 = add nuw nsw i64 %indvars.iv39, 1
  %exitcond53 = icmp eq i64 %indvars.iv.next51, %wide.trip.count43.1
  br i1 %exitcond53, label %._crit_edge28.loopexit, label %.preheader22.us

.preheader.us.us:                                 ; preds = %.preheader.us.us.preheader, %._crit_edge.us.us
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %._crit_edge.us.us ], [ 0, %.preheader.us.us.preheader ]
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv50, i64 %indvars.iv47
  br i1 %lcmp.mod45, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.preheader.us.us
  %62 = load double, double* %23, align 8
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv39, i64 %indvars.iv47
...
.prol.loopexit:                                   ; preds = %.prol.preheader, %.preheader.us.us
  %indvars.iv41.unr.ph = phi i64 [ %indvars.iv.next42.prol, %.prol.preheader ], [ %indvars.iv39, %.preheader.us.us ]
  %.pre59 = load double, double* %61, align 8
...
._crit_edge.us.us:                                ; preds = %._crit_edge.us.us.loopexit, %.prol.loopexit
  %68 = phi double [ %.pre59, %.prol.loopexit ], [ %82, %._crit_edge.us.us.loopexit ]
  %69 = fmul double %68, %2
  store double %69, double* %61, align 8
  %indvars.iv.next48 = add nuw nsw i64 %indvars.iv47, 1
  %exitcond = icmp eq i64 %indvars.iv.next48, %wide.trip.count49
  br i1 %exitcond, label %._crit_edge26.us.loopexit, label %.preheader.us.us

.preheader.us.us.new:                             ; preds = %.preheader.us.us.new.preheader, %.preheader.us.us.new
  %70 = phi double [ %82, %.preheader.us.us.new ], [ %.pre59, %.preheader.us.us.new.preheader ]
  %indvars.iv41 = phi i64 [ %indvars.iv.next42.1, %.preheader.us.us.new ], [ %indvars.iv41.unr.ph, %.preheader.us.us.new.preheader ]
  %71 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv41, i64 %indvars.iv50
  %72 = load double, double* %71, align 8
  %73 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %indvars.iv47
  %74 = load double, double* %73, align 8
  %75 = fmul double %72, %74
  %76 = fadd double %70, %75
  store double %76, double* %61, align 8
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  %77 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv.next42, i64 %indvars.iv50
  %78 = load double, double* %77, align 8
  %79 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv.next42, i64 %indvars.iv47
  %80 = load double, double* %79, align 8
  %81 = fmul double %78, %80
  %82 = fadd double %76, %81
  store double %82, double* %61, align 8
  %indvars.iv.next42.1 = add nsw i64 %indvars.iv41, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next42.1, %wide.trip.count43.1
...
._crit_edge28:                                    ; preds = %._crit_edge28.loopexit, %5
  ret void
}
