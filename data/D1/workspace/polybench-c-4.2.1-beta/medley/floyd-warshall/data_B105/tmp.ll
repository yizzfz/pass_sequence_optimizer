...
.preheader:                                       ; preds = %15, %1
  %indvars.iv11 = phi i64 [ 0, %1 ], [ %indvars.iv.next12, %15 ]
...
._crit_edge10:                                    ; preds = %._crit_edge10, %.preheader
  ...
  %4 = srem i32 %3, 7
  %5 = add nsw i32 %4, 1
  %6 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv11, i64 %indvars.iv
  %7 = add nuw nsw i64 %indvars.iv11, %indvars.iv
  ...
  %. = select i1 %or.cond5, i32 999, i32 %5
  store i32 %., i32* %6, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 2800
  br i1 %exitcond, label %15, label %._crit_edge10

; <label>:15:                                     ; preds = %._crit_edge10
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond13 = icmp eq i64 %indvars.iv.next12, 2800
  br i1 %exitcond13, label %16, label %.preheader
...
.preheader3:                                      ; preds = %41, %1
  %indvars.iv9 = phi i64 [ 0, %1 ], [ %indvars.iv.next10, %41 ]
  %scevgep4 = getelementptr [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv9, i64 0
  %2 = add nuw nsw i64 %indvars.iv9, 1
  %scevgep6 = getelementptr [2800 x i32], [2800 x i32]* %0, i64 %2, i64 0
  br label %.preheader

.preheader:                                       ; preds = %middle.block, %.preheader3
  %indvars.iv7 = phi i64 [ 0, %.preheader3 ], [ %indvars.iv.next8, %middle.block ]
  %scevgep = getelementptr [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv7, i64 0
  %3 = add nuw nsw i64 %indvars.iv7, 1
  %scevgep2 = getelementptr [2800 x i32], [2800 x i32]* %0, i64 %3, i64 0
  %4 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv7, i64 %indvars.iv9
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %5 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv7, i64 %index
  ...
  %14 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv9, i64 %index
...
scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader
  ...
  %27 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv7, i64 %indvars.iv
  %28 = load i32, i32* %27, align 4
  %29 = load i32, i32* %4, align 4
  %30 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv9, i64 %indvars.iv
  ...
  %34 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv7, i64 %indvars.iv.next
  %35 = load i32, i32* %34, align 4
  %36 = load i32, i32* %4, align 4
  %37 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv9, i64 %indvars.iv.next
...
middle.block:                                     ; preds = %middle.block.loopexit16, %middle.block.loopexit
  ...
  br i1 %exitcond11, label %41, label %.preheader

; <label>:41:                                     ; preds = %middle.block
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  %exitcond12 = icmp eq i64 %indvars.iv.next10, 2800
  br i1 %exitcond12, label %42, label %.preheader3
...
._crit_edge:                                      ; preds = %._crit_edge3, %11
  ...
  %14 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv4, i64 %indvars.iv
