...
for.body.lr.ph.split.us:                          ; preds = %for.body.lr.ph
  ...
  %smax96 = select i1 %1, i64 %sub14, i64 2
  %2 = add nsw i64 %smax96, -1
  %scevgep103 = getelementptr double, double* %A, i64 1
  %scevgep106 = getelementptr double, double* %A, i64 %smax96
  %3 = add nuw nsw i64 %smax96, 1
  %scevgep108 = getelementptr double, double* %B, i64 %3
  %scevgep142 = getelementptr double, double* %B, i64 1
  %scevgep145 = getelementptr double, double* %B, i64 %smax96
  %scevgep147 = getelementptr double, double* %A, i64 %3
  %min.iters.check136 = icmp ult i64 %2, 4
  %n.vec100 = and i64 %2, -4
  %cmp.zero101 = icmp eq i64 %n.vec100, 0
  %bound0110 = icmp ult double* %scevgep103, %scevgep108
  %bound1111 = icmp ugt double* %scevgep106, %B
  %found.conflict112 = and i1 %bound0110, %bound1111
  %ind.end119 = or i64 %n.vec100, 1
  %cmp.n120 = icmp eq i64 %2, %n.vec100
  %bound0149 = icmp ult double* %scevgep142, %scevgep147
  %bound1150 = icmp ugt double* %scevgep145, %A
...
for.body16.us.preheader:                          ; preds = %for.body16.us.preheader.loopexit, %middle.block133
  br i1 %min.iters.check136, label %for.body16.us.preheader171, label %min.iters.checked98

for.body16.us.preheader171:                       ; preds = %middle.block94, %vector.memcheck114, %min.iters.checked98, %for.body16.us.preheader
  %indvars.iv65.ph = phi i64 [ 1, %vector.memcheck114 ], [ 1, %min.iters.checked98 ], [ 1, %for.body16.us.preheader ], [ %ind.end119, %middle.block94 ]
  br label %for.body16.us

min.iters.checked98:                              ; preds = %for.body16.us.preheader
  br i1 %cmp.zero101, label %for.body16.us.preheader171, label %vector.memcheck114

vector.memcheck114:                               ; preds = %min.iters.checked98
  br i1 %found.conflict112, label %for.body16.us.preheader171, label %vector.body93.preheader
...
vector.body93:                                    ; preds = %vector.body93.preheader, %vector.body93
  ...
  %4 = getelementptr inbounds double, double* %B, i64 %index116
  %5 = bitcast double* %4 to <2 x double>*
  %wide.load126 = load <2 x double>, <2 x double>* %5, align 8, !alias.scope !1
  %6 = getelementptr double, double* %4, i64 2
  %7 = bitcast double* %6 to <2 x double>*
  %wide.load127 = load <2 x double>, <2 x double>* %7, align 8, !alias.scope !1
  %8 = getelementptr inbounds double, double* %B, i64 %offset.idx121
  %9 = bitcast double* %8 to <2 x double>*
  %wide.load128 = load <2 x double>, <2 x double>* %9, align 8, !alias.scope !1
  %10 = getelementptr double, double* %8, i64 2
  %11 = bitcast double* %10 to <2 x double>*
  %wide.load129 = load <2 x double>, <2 x double>* %11, align 8, !alias.scope !1
  %12 = fadd <2 x double> %wide.load126, %wide.load128
  %13 = fadd <2 x double> %wide.load127, %wide.load129
  %14 = add nuw nsw i64 %offset.idx121, 1
  %15 = getelementptr inbounds double, double* %B, i64 %14
  %16 = getelementptr double, double* %15, i64 2
  %17 = bitcast double* %16 to <2 x double>*
  %wide.load131 = load <2 x double>, <2 x double>* %17, align 8, !alias.scope !1
  %18 = fadd <2 x double> %12, %wide.load127
  %19 = fadd <2 x double> %13, %wide.load131
  ...
  %22 = getelementptr inbounds double, double* %A, i64 %offset.idx121
  ...
  %26 = icmp eq i64 %index.next117, %n.vec100
  br i1 %26, label %middle.block94, label %vector.body93, !llvm.loop !6

middle.block94:                                   ; preds = %vector.body93
  br i1 %cmp.n120, label %for.inc33.us, label %for.body16.us.preheader171
...
for.inc33.us:                                     ; preds = %for.inc33.us.loopexit, %middle.block94
  ...
  br i1 %cmp.us, label %for.body3.lr.ph.us, label %for.end35.loopexit

for.body16.us:                                    ; preds = %for.body16.us.preheader171, %for.body16.us
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.body16.us ], [ %indvars.iv65.ph, %for.body16.us.preheader171 ]
...
for.body3.lr.ph.us:                               ; preds = %for.body.lr.ph.split.us, %for.inc33.us
  %inc3413.us = phi i32 [ 0, %for.body.lr.ph.split.us ], [ %inc34.us, %for.inc33.us ]
  br i1 %min.iters.check136, label %for.body3.us.preheader, label %min.iters.checked137

for.body3.us.preheader:                           ; preds = %middle.block133, %vector.memcheck153, %min.iters.checked137, %for.body3.lr.ph.us
  %indvars.iv.ph = phi i64 [ 1, %vector.memcheck153 ], [ 1, %min.iters.checked137 ], [ 1, %for.body3.lr.ph.us ], [ %ind.end119, %middle.block133 ]
  br label %for.body3.us

min.iters.checked137:                             ; preds = %for.body3.lr.ph.us
  br i1 %cmp.zero101, label %for.body3.us.preheader, label %vector.memcheck153

vector.memcheck153:                               ; preds = %min.iters.checked137
  br i1 %found.conflict151, label %for.body3.us.preheader, label %vector.body132.preheader

vector.body132.preheader:                         ; preds = %vector.memcheck153
  br label %vector.body132

vector.body132:                                   ; preds = %vector.body132.preheader, %vector.body132
  %index155 = phi i64 [ %index.next156, %vector.body132 ], [ 0, %vector.body132.preheader ]
  %offset.idx160 = or i64 %index155, 1
  %35 = getelementptr inbounds double, double* %A, i64 %index155
  %36 = bitcast double* %35 to <2 x double>*
  %wide.load165 = load <2 x double>, <2 x double>* %36, align 8, !alias.scope !11
  %37 = getelementptr double, double* %35, i64 2
  %38 = bitcast double* %37 to <2 x double>*
  %wide.load166 = load <2 x double>, <2 x double>* %38, align 8, !alias.scope !11
  %39 = getelementptr inbounds double, double* %A, i64 %offset.idx160
  %40 = bitcast double* %39 to <2 x double>*
  %wide.load167 = load <2 x double>, <2 x double>* %40, align 8, !alias.scope !11
  %41 = getelementptr double, double* %39, i64 2
  %42 = bitcast double* %41 to <2 x double>*
  %wide.load168 = load <2 x double>, <2 x double>* %42, align 8, !alias.scope !11
  %43 = fadd <2 x double> %wide.load165, %wide.load167
  %44 = fadd <2 x double> %wide.load166, %wide.load168
  %45 = add nuw nsw i64 %offset.idx160, 1
  %46 = getelementptr inbounds double, double* %A, i64 %45
  %47 = getelementptr double, double* %46, i64 2
  %48 = bitcast double* %47 to <2 x double>*
  %wide.load170 = load <2 x double>, <2 x double>* %48, align 8, !alias.scope !11
  %49 = fadd <2 x double> %43, %wide.load166
  %50 = fadd <2 x double> %44, %wide.load170
  ...
  %53 = getelementptr inbounds double, double* %B, i64 %offset.idx160
  ...
  %57 = icmp eq i64 %index.next156, %n.vec100
  br i1 %57, label %middle.block133, label %vector.body132, !llvm.loop !16

middle.block133:                                  ; preds = %vector.body132
  br i1 %cmp.n120, label %for.body16.us.preheader, label %for.body3.us.preheader
