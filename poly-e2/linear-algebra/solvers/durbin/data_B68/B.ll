...
vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert41 = insertelement <2 x double> undef, double %div, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load37 = load <2 x double>, <2 x double>* %27, align 8
  %28 = sub nsw i64 %6, %index
  %29 = getelementptr inbounds double, double* %y, i64 %28
  %30 = getelementptr double, double* %29, i64 -1
  %31 = bitcast double* %30 to <2 x double>*
  %wide.load38 = load <2 x double>, <2 x double>* %31, align 8
  %reverse = shufflevector <2 x double> %wide.load38, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %32 = getelementptr double, double* %29, i64 -2
  %33 = getelementptr double, double* %32, i64 -1
  %34 = bitcast double* %33 to <2 x double>*
  %wide.load39 = load <2 x double>, <2 x double>* %34, align 8
  %reverse40 = shufflevector <2 x double> %wide.load39, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %35 = fmul <2 x double> %broadcast.splat42, %reverse
  %36 = fmul <2 x double> %broadcast.splat42, %reverse40
  %37 = fadd <2 x double> %wide.load, %35
  %38 = fadd <2 x double> %wide.load37, %36
...
for.inc47:                                        ; preds = %for.inc47.loopexit, %middle.block
  ...
  %exitcond35 = icmp eq i64 %indvars.iv.next30, 1999
