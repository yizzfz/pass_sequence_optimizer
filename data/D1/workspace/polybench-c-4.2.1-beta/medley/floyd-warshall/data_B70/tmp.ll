...
.preheader.us:                                    ; preds = %.loopexit.us..preheader.us_crit_edge, %.preheader.lr.ph..preheader.us_crit_edge
  %indvars.iv17 = phi i64 [ 0, %.preheader.lr.ph..preheader.us_crit_edge ], [ %indvars.iv.next18, %.loopexit.us..preheader.us_crit_edge ]
  br label %._crit_edge15

._crit_edge15:                                    ; preds = %._crit_edge15.._crit_edge15_crit_edge, %.preheader.us
  %indvars.iv = phi i64 [ 0, %.preheader.us ], [ %indvars.iv.next, %._crit_edge15.._crit_edge15_crit_edge ]
  ...
  br i1 %exitcond, label %.loopexit.us, label %._crit_edge15.._crit_edge15_crit_edge
...
.preheader.us:                                    ; preds = %.loopexit.us..preheader.us_crit_edge, %.preheader.lr.ph..preheader.us_crit_edge
  %indvars.iv14 = phi i64 [ 0, %.preheader.lr.ph..preheader.us_crit_edge ], [ %indvars.iv.next15, %.loopexit.us..preheader.us_crit_edge ]
  %6 = mul nuw nsw i64 %indvars.iv14, 2800
  br label %._crit_edge12

._crit_edge12:                                    ; preds = %._crit_edge11.._crit_edge12_crit_edge, %.preheader.us
  %indvars.iv = phi i64 [ 0, %.preheader.us ], [ %indvars.iv.next, %._crit_edge11.._crit_edge12_crit_edge ]
  %7 = add nuw nsw i64 %6, %indvars.iv
  %8 = trunc i64 %7 to i32
  %9 = srem i32 %8, 20
  %10 = icmp eq i32 %9, 0
  br i1 %10, label %11, label %._crit_edge12.._crit_edge11_crit_edge
...
._crit_edge11:                                    ; preds = %._crit_edge12.._crit_edge11_crit_edge, %11
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 2800
  br i1 %exitcond, label %.loopexit.us, label %._crit_edge11.._crit_edge12_crit_edge

._crit_edge11.._crit_edge12_crit_edge:            ; preds = %._crit_edge11
  br label %._crit_edge12

.loopexit.us:                                     ; preds = %._crit_edge11
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  %exitcond16 = icmp eq i64 %indvars.iv.next15, 2800
  br i1 %exitcond16, label %._crit_edge, label %.loopexit.us..preheader.us_crit_edge
