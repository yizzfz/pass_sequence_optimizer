...
for.body.us:                                      ; preds = %for.inc16.us, %entry
  %indvars.iv65 = phi i64 [ 0, %entry ], [ %indvars.iv.next66, %for.inc16.us ]
  %0 = add i64 %indvars.iv65, 1200
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us, %for.body.us
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.body3.us ], [ 0, %for.body.us ]
  ...
  br i1 %exitcond64, label %for.inc16.us, label %for.body3.us

for.inc16.us:                                     ; preds = %for.body3.us
  %indvars.iv.next66 = add nuw nsw i64 %indvars.iv65, 1
  %exitcond69 = icmp eq i64 %indvars.iv.next66, 1000
  br i1 %exitcond69, label %for.body26.lr.ph.preheader, label %for.body.us
...
for.body26.lr.ph:                                 ; preds = %for.body26.lr.ph.preheader, %for.inc51
  %indvars.iv75 = phi i3 [ %indvars.iv.next76, %for.inc51 ], [ -1, %for.body26.lr.ph.preheader ]
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.inc51 ], [ 2, %for.body26.lr.ph.preheader ]
  ...
  %5 = zext i3 %indvars.iv75 to i64
  %6 = add nuw nsw i64 %5, 4294967295
  %7 = and i64 %6, 4294967295
  %8 = add i64 %indvars.iv73, %7
...
for.body43.prol.loopexit:                         ; preds = %for.body43.prol.loopexit.loopexit, %for.body43.lr.ph
  %indvars.iv48.unr = phi i64 [ %indvars.iv55, %for.body43.lr.ph ], [ %8, %for.body43.prol.loopexit.loopexit ]
...
for.body43.preheader:                             ; preds = %for.body43.prol.loopexit
  ...
  br i1 %min.iters.check, label %for.body43.preheader77, label %min.iters.checked
...
min.iters.checked:                                ; preds = %for.body43.preheader
  ...
  br i1 %cmp.zero, label %for.body43.preheader77, label %vector.body.preheader
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.inc51, label %for.body43.preheader77

for.body43.preheader77:                           ; preds = %middle.block, %min.iters.checked, %for.body43.preheader
  %indvars.iv48.ph = phi i64 [ %indvars.iv48.unr, %min.iters.checked ], [ %indvars.iv48.unr, %for.body43.preheader ], [ %ind.end, %middle.block ]
  br label %for.body43

for.body43:                                       ; preds = %for.body43.preheader77, %for.body43
  %indvars.iv48 = phi i64 [ %indvars.iv.next49.7, %for.body43 ], [ %indvars.iv48.ph, %for.body43.preheader77 ]
...
for.inc51:                                        ; preds = %for.inc51.loopexit, %middle.block, %for.body43.prol.loopexit, %for.end38
  ...
  %indvars.iv.next76 = add i3 %indvars.iv75, -1
...
entry:
  ...
  %broadcast.splatinsert71 = insertelement <2 x double> undef, double %beta, i32 0
  %broadcast.splat72 = shufflevector <2 x double> %broadcast.splatinsert71, <2 x double> undef, <2 x i32> zeroinitializer
  %broadcast.splatinsert75 = insertelement <2 x double> undef, double %alpha, i32 0
  %broadcast.splat76 = shufflevector <2 x double> %broadcast.splatinsert75, <2 x double> undef, <2 x i32> zeroinitializer
  %broadcast.splatinsert77 = insertelement <2 x double> undef, double %mul44, i32 0
...
for.body:                                         ; preds = %for.inc53, %entry
  ...
  %scevgep59 = getelementptr [1200 x double], [1200 x double]* %C, i64 %0, i64 0
...
vector.memcheck:                                  ; preds = %for.body
  %scevgep63 = getelementptr [1200 x double], [1200 x double]* %B, i64 %0, i64 0
  %scevgep61 = getelementptr [1200 x double], [1200 x double]* %B, i64 %indvars.iv51, i64 0
  %bound0 = icmp ult double* %scevgep, %scevgep63
  %bound1 = icmp ult double* %scevgep61, %scevgep59
  %found.conflict = and i1 %bound0, %bound1
  %bound066 = icmp ult double* %scevgep, %arrayidx41
  %bound167 = icmp ult double* %arrayidx41, %scevgep59
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load70 = load <2 x double>, <2 x double>* %4, align 8, !alias.scope !8, !noalias !11
  %5 = fmul <2 x double> %wide.load, %broadcast.splat72
  %6 = fmul <2 x double> %wide.load70, %broadcast.splat72
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv51, i64 %index
  %8 = bitcast double* %7 to <2 x double>*
  %wide.load73 = load <2 x double>, <2 x double>* %8, align 8, !alias.scope !14
  %9 = getelementptr double, double* %7, i64 2
  %10 = bitcast double* %9 to <2 x double>*
  %wide.load74 = load <2 x double>, <2 x double>* %10, align 8, !alias.scope !14
  %11 = fmul <2 x double> %wide.load73, %broadcast.splat76
  %12 = fmul <2 x double> %wide.load74, %broadcast.splat76
  ...
  %22 = fadd <2 x double> %20, %broadcast.splat78
  %23 = fadd <2 x double> %21, %broadcast.splat78
  ...
  br i1 %26, label %for.inc53.loopexit82, label %vector.body, !llvm.loop !16

for.body3.us:                                     ; preds = %for.body3.us.preheader, %for.end.us
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.end.us ], [ 0, %for.body3.us.preheader ]
...
for.body6.us:                                     ; preds = %for.body6.us, %for.body3.us
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.body6.us ], [ 0, %for.body3.us ]
  %temp2.034.us = phi double [ %add27.us, %for.body6.us ], [ 0.000000e+00, %for.body3.us ]
  %27 = load double, double* %arrayidx8.us, align 8
  %mul.us = fmul double %27, %alpha
  %arrayidx12.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv51, i64 %indvars.iv41
  %28 = load double, double* %arrayidx12.us, align 8
  %mul13.us = fmul double %mul.us, %28
  %arrayidx17.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv41, i64 %indvars.iv47
  ...
  %arrayidx21.us = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv41, i64 %indvars.iv47
  ...
  %exitcond46 = icmp eq i64 %indvars.iv.next42, %indvars.iv51
...
for.end.us:                                       ; preds = %for.body6.us
  ...
  br i1 %exitcond50, label %for.inc53.loopexit, label %for.body3.us
...
for.body3:                                        ; preds = %for.body3, %for.body3.preheader
  ...
  br i1 %exitcond.1, label %for.inc53.loopexit81, label %for.body3, !llvm.loop !17

for.inc53.loopexit:                               ; preds = %for.end.us
  br label %for.inc53

for.inc53.loopexit81:                             ; preds = %for.body3
  br label %for.inc53

for.inc53.loopexit82:                             ; preds = %vector.body
  br label %for.inc53

for.inc53:                                        ; preds = %for.inc53.loopexit82, %for.inc53.loopexit81, %for.inc53.loopexit
  %indvars.iv.next52 = add nuw nsw i64 %indvars.iv51, 1
  %exitcond54 = icmp eq i64 %indvars.iv.next52, 1000
  br i1 %exitcond54, label %for.end55, label %for.body
...
for.body.us:                                      ; preds = %for.inc10.us, %entry
  %indvars.iv14 = phi i64 [ 0, %entry ], [ %indvars.iv.next15, %for.inc10.us ]
