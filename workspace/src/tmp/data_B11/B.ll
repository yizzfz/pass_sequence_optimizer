...
; <label>:19:                                     ; preds = %._crit_edge7
  ...
  br i1 %16, label %._crit_edge6.us.preheader, label %._crit_edge6.preheader

._crit_edge6.preheader:                           ; preds = %19
  br label %._crit_edge6

._crit_edge6.us.preheader:                        ; preds = %19
...
._crit_edge2:                                     ; preds = %._crit_edge2.loopexit, %._crit_edge6
  ...
  br i1 %83, label %._crit_edge1.loopexit, label %._crit_edge6

._crit_edge1.loopexit:                            ; preds = %._crit_edge2
  br label %._crit_edge1

._crit_edge1:                                     ; preds = %._crit_edge1.loopexit, %._crit_edge6.us.preheader, %._crit_edge7
...
._crit_edge1:                                     ; preds = %._crit_edge1, %._crit_edge2
  %20 = phi i64 [ 0, %._crit_edge2 ], [ %102, %._crit_edge1 ]
  %21 = phi float [ 0.000000e+00, %._crit_edge2 ], [ %101, %._crit_edge1 ]
  %22 = phi float [ 0.000000e+00, %._crit_edge2 ], [ %98, %._crit_edge1 ]
  %23 = phi float [ 0.000000e+00, %._crit_edge2 ], [ %97, %._crit_edge1 ]
  ...
  br i1 %103, label %104, label %._crit_edge1

; <label>:104:                                    ; preds = %._crit_edge1
  %105 = fmul float %97, %97
  %106 = fmul float %101, %98
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %._crit_edge3
  %113 = phi i32 [ 0, %._crit_edge3 ], [ %110, %._crit_edge.loopexit ]
...
; <label>:119:                                    ; preds = %._crit_edge
  ...
  br i1 %121, label %122, label %._crit_edge4
...
._crit_edge4:                                     ; preds = %117, %.loopexit
...
; <label>:117:                                    ; preds = %._crit_edge5
  ...
  br i1 %119, label %.loopexit.loopexit, label %._crit_edge4
...
._crit_edge3:                                     ; preds = %._crit_edge, %._crit_edge4
  %27 = phi i64 [ 0, %._crit_edge4 ], [ %140, %._crit_edge ]
  %28 = add nsw i64 %27, -4
...
._crit_edge2:                                     ; preds = %._crit_edge2, %._crit_edge1
  %52 = phi i64 [ 0, %._crit_edge1 ], [ %134, %._crit_edge2 ]
  %53 = phi float [ 0.000000e+00, %._crit_edge1 ], [ %133, %._crit_edge2 ]
  %54 = phi float [ 0.000000e+00, %._crit_edge1 ], [ %130, %._crit_edge2 ]
  %55 = phi float [ 0.000000e+00, %._crit_edge1 ], [ %129, %._crit_edge2 ]
  ...
  br i1 %135, label %42, label %._crit_edge2

._crit_edge.loopexit:                             ; preds = %42
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %._crit_edge3
  %136 = phi i32 [ 0, %._crit_edge3 ], [ %48, %._crit_edge.loopexit ]
  ...
  br i1 %141, label %142, label %._crit_edge3

; <label>:142:                                    ; preds = %._crit_edge
  %143 = add nuw nsw i64 %23, 1
  %144 = icmp eq i64 %143, 219
  br i1 %144, label %145, label %._crit_edge4
...
; <label>:151:                                    ; preds = %._crit_edge6
  %152 = add nuw nsw i64 %17, 1
  %153 = icmp eq i64 %152, 223
  br i1 %153, label %19, label %._crit_edge5

._crit_edge6:                                     ; preds = %._crit_edge6, %._crit_edge5
  %154 = phi i64 [ 0, %._crit_edge5 ], [ %160, %._crit_edge6 ]
  ...
  br i1 %161, label %151, label %._crit_edge6

._crit_edge7:                                     ; preds = %167, %145
...
; <label>:167:                                    ; preds = %._crit_edge8
  %168 = add nuw nsw i64 %162, 1
  %169 = icmp eq i64 %168, 223
  br i1 %169, label %164, label %._crit_edge7

._crit_edge8:                                     ; preds = %._crit_edge8, %._crit_edge7
  %170 = phi i64 [ 0, %._crit_edge7 ], [ %180, %._crit_edge8 ]
  ...
  br i1 %181, label %167, label %._crit_edge8
}
