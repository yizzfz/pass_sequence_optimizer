...
._crit_edge89:                                    ; preds = %._crit_edge89, %.lr.ph20.split.us
  %indvars.iv70 = phi i64 [ 0, %.lr.ph20.split.us ], [ %indvars.iv.next71, %._crit_edge89 ]
  ...
  br i1 %exitcond73, label %._crit_edge18.us, label %._crit_edge89

._crit_edge18.us:                                 ; preds = %._crit_edge89
  %indvars.iv.next75 = add nuw nsw i64 %indvars.iv74, 1
  %exitcond85 = icmp eq i64 %indvars.iv.next75, 800
  br i1 %exitcond85, label %.lr.ph14.split.us.preheader, label %.lr.ph20.split.us
...
._crit_edge12.us:                                 ; preds = %.lr.ph14.split.us.new
  ...
  br i1 %exitcond84, label %.lr.ph8.split.us.preheader, label %.lr.ph14.split.us
...
._crit_edge90:                                    ; preds = %._crit_edge90, %.lr.ph8.split.us
  %indvars.iv54 = phi i64 [ 0, %.lr.ph8.split.us ], [ %indvars.iv.next55, %._crit_edge90 ]
  ...
  br i1 %exitcond57, label %._crit_edge6.us, label %._crit_edge90

._crit_edge6.us:                                  ; preds = %._crit_edge90
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  %exitcond83 = icmp eq i64 %indvars.iv.next59, 900
  br i1 %exitcond83, label %.lr.ph2.split.us.preheader, label %.lr.ph8.split.us
...
._crit_edge91:                                    ; preds = %._crit_edge91, %.lr.ph2.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph2.split.us ], [ %indvars.iv.next, %._crit_edge91 ]
  ...
  br i1 %exitcond, label %._crit_edge.us, label %._crit_edge91

._crit_edge.us:                                   ; preds = %._crit_edge91
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1
  %exitcond82 = icmp eq i64 %indvars.iv.next53, 800
  br i1 %exitcond82, label %._crit_edge3, label %.lr.ph2.split.us
