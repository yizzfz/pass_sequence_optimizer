...
for.body5.us:                                     ; preds = %for.body5.us.preheader, %for.inc27.us
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.inc27.us ], [ 0, %for.body5.us.preheader ]
...
for.inc24.us:                                     ; preds = %for.inc24.us, %for.body5.us
  ...
  br i1 %exitcond.1, label %for.inc27.us, label %for.inc24.us
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal void @kernel_bicg([1900 x double]* nocapture readonly %A, double* nocapture %s, double* nocapture %q, double* nocapture readonly %p, double* nocapture readonly %r) #2 {
for.body3.us.preheader:
  %s6 = bitcast double* %s to i8*
  call void @llvm.memset.p0i8.i64(i8* %s6, i8 0, i64 15200, i32 8, i1 false)
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.inc34.us, %for.body3.us.preheader
  %indvars.iv1 = phi i64 [ 0, %for.body3.us.preheader ], [ %indvars.iv.next2, %for.inc34.us ]
...
for.inc31.us:                                     ; preds = %for.inc31.us, %for.body3.us
  ...
  %sunkaddr14 = mul i64 %indvars.iv1, 8
  ...
  store double %add28.us, double* %sunkaddr20, align 8
  %exitcond = icmp eq i64 %indvars.iv, 1899
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br i1 %exitcond, label %for.inc34.us, label %for.inc31.us
