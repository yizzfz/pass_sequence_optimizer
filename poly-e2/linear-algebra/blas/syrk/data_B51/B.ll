...
for.cond1.preheader.us:                           ; preds = %entry, %for.inc7.us
  %indvars.iv919.us = phi i64 [ %indvars.iv.next10.us, %for.inc7.us ], [ 0, %entry ]
...
for.body3.us:                                     ; preds = %for.body3.us, %for.cond1.preheader.us
  ...
  %exitcond21.us = icmp eq i64 %indvars.iv.next6.us, 1000
  br i1 %exitcond21.us, label %for.inc7.us, label %for.body3.us
...
for.inc7.us:                                      ; preds = %for.body3.us
  ...
  br i1 %exitcond23, label %for.cond14.preheader.preheader, label %for.cond1.preheader.us
...
for.cond1.preheader.us:                           ; preds = %for.inc32.us, %entry
  %indvars.iv1122.us = phi i64 [ %indvars.iv.next12.us, %for.inc32.us ], [ 1, %entry ]
  %indvars.iv1320.us = phi i64 [ %3, %for.inc32.us ], [ 0, %entry ]
...
for.inc29.us:                                     ; preds = %for.body11.us.prol.loopexit, %for.body11.us, %middle.block
  %exitcond24.us = icmp eq i64 %29, 1000
  br i1 %exitcond24.us, label %for.inc32.us, label %for.cond9.preheader.us

for.inc32.us:                                     ; preds = %for.inc29.us
  %exitcond25 = icmp eq i64 %3, 1200
  %indvars.iv.next12.us = add nuw nsw i64 %indvars.iv1122.us, 1
  br i1 %exitcond25, label %for.end34, label %for.cond1.preheader.us
...
for.cond2.preheader:                              ; preds = %for.inc10, %entry
  %indvars.iv28 = phi i64 [ 0, %entry ], [ %indvars.iv.next3, %for.inc10 ]
