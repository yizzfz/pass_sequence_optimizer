...
; <label>:21:                                     ; preds = %18
  ...
  tail call void @print_array(i32 1300, double* %22)
  br label %._crit_edge
...
; <label>:10:                                     ; preds = %10, %.lr.ph30.split.us
  ...
  store double %17, double* %sunkaddr38, align 8
  ...
  store double %23, double* %sunkaddr42, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
  br i1 %exitcond, label %._crit_edge.us, label %10
...
._crit_edge.us:                                   ; preds = %10
  ...
  %24 = load double, double* %sunkaddr46, align 8
  %25 = fmul double %24, %1
  %sunkaddr48 = shl i64 %indvars.iv32, 3
  %sunkaddr49 = add i64 %sunkaddr47, %sunkaddr48
  %sunkaddr50 = inttoptr i64 %sunkaddr49 to double*
  %26 = load double, double* %sunkaddr50, align 8
  %27 = fmul double %26, %2
  %28 = fadd double %25, %27
  store double %28, double* %sunkaddr50, align 8
