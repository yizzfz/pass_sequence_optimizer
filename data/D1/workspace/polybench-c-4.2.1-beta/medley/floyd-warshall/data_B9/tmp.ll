...
.preheader:                                       ; preds = %18, %1
  %indvars.iv24 = phi i64 [ 0, %1 ], [ %indvars.iv.next25, %18 ]
  br label %2
...
; <label>:2:                                      ; preds = %2, %.preheader
  ...
  %5 = srem i32 %4, 7
  %6 = add nsw i32 %5, 1
  %7 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv24, i64 %indvars.iv
  %8 = add nuw nsw i64 %indvars.iv, %indvars.iv24
  ...
  %16 = srem i32 %15, 11
  %17 = icmp eq i32 %16, 0
  %or.cond21 = or i1 %17, %or.cond
  %. = select i1 %or.cond21, i32 999, i32 %6
...
; <label>:18:                                     ; preds = %2
  ...
  br i1 %exitcond26, label %19, label %.preheader
...
.preheader29:                                     ; preds = %19, %1
  %indvars.iv35 = phi i64 [ 0, %1 ], [ %indvars.iv.next36, %19 ]
  br label %.preheader

.preheader:                                       ; preds = %18, %.preheader29
  %indvars.iv33 = phi i64 [ 0, %.preheader29 ], [ %indvars.iv.next34, %18 ]
  %2 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv33, i64 %indvars.iv35
  br label %3

; <label>:3:                                      ; preds = %3, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %3 ]
  %4 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv33, i64 %indvars.iv
  %5 = load i32, i32* %4, align 4
  %6 = load i32, i32* %2, align 4
  %7 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv35, i64 %indvars.iv
  ...
  %11 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv33, i64 %indvars.iv.next
  %12 = load i32, i32* %11, align 4
  %13 = load i32, i32* %2, align 4
  %14 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv35, i64 %indvars.iv.next
...
; <label>:19:                                     ; preds = %18
  ...
  br i1 %exitcond37, label %20, label %.preheader29
...
.preheader:                                       ; preds = %19, %1
  %indvars.iv13 = phi i64 [ 0, %1 ], [ %indvars.iv.next14, %19 ]
...
; <label>:14:                                     ; preds = %12, %7
  ...
  %16 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv13, i64 %indvars.iv
