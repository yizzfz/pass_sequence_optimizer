...
.lr.ph.us.new:                                    ; preds = %.lr.ph.us.new.preheader, %.lr.ph.us.new
  ...
  %10 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %indvars.iv
...
.preheader.us15.new:                              ; preds = %.preheader.us15.new.preheader, %.preheader.us15.new
  ...
  %21 = fmul double %20, %2
  %22 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv25, i64 %indvars.iv35
  %23 = load double, double* %22, align 8
  %24 = fmul double %21, %23
  %25 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %indvars.iv25
  ...
  %29 = fmul double %28, %2
  %30 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv.next26, i64 %indvars.iv35
  %31 = load double, double* %30, align 8
  %32 = fmul double %29, %31
  %33 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %indvars.iv.next26
...
.preheader.us15:                                  ; preds = %._crit_edge.us18, %.preheader.us15.preheader
  ...
  %36 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv41, i64 %indvars.iv35
  br i1 %lcmp.mod33, label %.prol.loopexit31, label %.prol.preheader30

.prol.preheader30:                                ; preds = %.preheader.us15
  %37 = load double, double* %36, align 8
  %38 = fmul double %37, %2
  %39 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 0, i64 %indvars.iv35
  %40 = load double, double* %39, align 8
  %41 = fmul double %38, %40
  %42 = load double, double* %54, align 8
...
.prol.loopexit31:                                 ; preds = %.preheader.us15, %.prol.preheader30
  ...
  br i1 %53, label %._crit_edge.us18, label %.preheader.us15.new.preheader
...
.lr.ph.us:                                        ; preds = %._crit_edge9.us..lr.ph.us_crit_edge, %.preheader4.lr.ph
  ...
  %48 = trunc i64 %indvars.iv.next42 to i32
...
.prol.preheader:                                  ; preds = %.prol.preheader.preheader, %.prol.preheader
  ...
  %49 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %indvars.iv.prol
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.loopexit, %.lr.ph.us
  %indvars.iv.unr = phi i64 [ 0, %.lr.ph.us ], [ %47, %.prol.loopexit.loopexit ]
  %52 = icmp ult i64 %indvars.iv41, 3
  br i1 %52, label %.preheader.us15.preheader, label %.lr.ph.us.new.preheader
...
.preheader.us15.preheader:                        ; preds = %.preheader.us15.preheader.loopexit, %.prol.loopexit
  ...
  %53 = icmp eq i64 %indvars.iv41, 0
  %54 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 0
