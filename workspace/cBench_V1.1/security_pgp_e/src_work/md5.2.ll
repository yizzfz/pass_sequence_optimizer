...
@__llvm_prf_nm = private constant [41 x i8] c"'\00MD5Init\01MD5Update\01MD5Transform\01MD5Final", section "__llvm_prf_names"
@llvm.used = appending global [5 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_MD5Init to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_MD5Update to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_MD5Transform to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_MD5Final to i8*), i8* getelementptr inbounds ([41 x i8], [41 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
