...
for.end:                                          ; preds = %for.body6.prol.loopexit.unr-lcssa, %for.end.unr-lcssa
...
for.body5.prol.loopexit.unr-lcssa:                ; preds = %for.body5.preheader, %for.body5.prol.preheader
  %sub.lcssa.unr.ph = phi double [ %sub.prol, %for.body5.prol.preheader ], [ undef, %for.body5.preheader ]
  %indvars.iv.unr.ph = phi i64 [ 1, %for.body5.prol.preheader ], [ 0, %for.body5.preheader ]
  %.unr.ph = phi double [ %sub.prol, %for.body5.prol.preheader ], [ %6, %for.body5.preheader ]
  %10 = icmp eq i64 %2, 0
  br i1 %10, label %for.end.loopexit, label %for.body5.preheader.new

for.body5.preheader.new:                          ; preds = %for.body5.prol.loopexit.unr-lcssa
  br label %for.body5
...
for.end.loopexit:                                 ; preds = %for.body5.prol.loopexit.unr-lcssa, %for.end.loopexit.unr-lcssa
  %sub.lcssa = phi double [ %sub.lcssa.unr.ph, %for.body5.prol.loopexit.unr-lcssa ], [ %sub.1, %for.end.loopexit.unr-lcssa ]
  br label %for.end
