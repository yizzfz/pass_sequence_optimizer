...
.lr.ph3.split.us:                                 ; preds = %.lr.ph3.split.us.preheader, %._crit_edge.us
  ...
  %sunkaddr31 = shl i64 %indvars.iv15, 3
  %sunkaddr32 = add i64 %sunkaddr30, %sunkaddr31
  %sunkaddr33 = inttoptr i64 %sunkaddr32 to double*
  br label %6

; <label>:6:                                      ; preds = %.lr.ph3.split.us, %6
  %indvars.iv = phi i64 [ 0, %.lr.ph3.split.us ], [ %indvars.iv.next, %6 ]
  ...
  %14 = load double, double* %sunkaddr33, align 8
  ...
  br i1 %20, label %6, label %._crit_edge.us
...
; <label>:22:                                     ; preds = %22, %.lr.ph9
  %indvars.iv19 = phi i64 [ 0, %.lr.ph9 ], [ %indvars.iv.next20.24, %22 ]
  %indvars.iv.next20.24 = add nsw i64 %indvars.iv19, 25
  %23 = icmp slt i64 %indvars.iv.next20.24, 1900
  br i1 %23, label %22, label %.lr.ph3.split.us.preheader
