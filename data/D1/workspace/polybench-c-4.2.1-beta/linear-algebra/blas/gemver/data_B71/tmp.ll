...
._crit_edge:                                      ; preds = %._crit_edge, %.preheader5
  ...
  %sunkaddr19 = shl i64 %indvars.iv21, 3
...
.preheader3:                                      ; preds = %52, %.preheader3.preheader
  %indvars.iv15 = phi i64 [ 0, %.preheader3.preheader ], [ %indvars.iv.next16, %52 ]
...
._crit_edge1:                                     ; preds = %._crit_edge1, %.preheader3
  ...
  %sunkaddr27 = shl i64 %indvars.iv15, 3
  %sunkaddr28 = add i64 %sunkaddr26, %sunkaddr27
  %sunkaddr29 = inttoptr i64 %sunkaddr28 to double*
  %37 = load double, double* %sunkaddr29, align 8
  %38 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv12, i64 %indvars.iv15
  ...
  store double %44, double* %sunkaddr29, align 8
  %indvars.iv.next13 = or i64 %indvars.iv12, 1
  %45 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next13, i64 %indvars.iv15
  %46 = load double, double* %45, align 8
  %47 = fmul double %46, %1
  %48 = getelementptr inbounds double, double* %9, i64 %indvars.iv.next13
  %49 = load double, double* %48, align 8
  %50 = fmul double %47, %49
  %51 = fadd double %44, %50
  store double %51, double* %sunkaddr29, align 8
  %indvars.iv.next13.1 = add nuw nsw i64 %indvars.iv12, 2
  %exitcond14.1 = icmp eq i64 %indvars.iv.next13.1, 2000
  br i1 %exitcond14.1, label %52, label %._crit_edge1

; <label>:52:                                     ; preds = %._crit_edge1
...
.preheader2:                                      ; preds = %.preheader2, %.preheader2.preheader
  ...
  %53 = getelementptr inbounds double, double* %8, i64 %indvars.iv9
  %54 = load double, double* %53, align 8
  %55 = getelementptr inbounds double, double* %10, i64 %indvars.iv9
  %56 = load double, double* %55, align 8
  %57 = fadd double %54, %56
  store double %57, double* %53, align 8
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  %58 = getelementptr inbounds double, double* %8, i64 %indvars.iv.next10
  %59 = load double, double* %58, align 8
  %60 = getelementptr inbounds double, double* %10, i64 %indvars.iv.next10
  %61 = load double, double* %60, align 8
  %62 = fadd double %59, %61
  store double %62, double* %58, align 8
  %indvars.iv.next10.1 = add nuw nsw i64 %indvars.iv9, 2
  %63 = getelementptr inbounds double, double* %8, i64 %indvars.iv.next10.1
  %64 = load double, double* %63, align 8
  %65 = getelementptr inbounds double, double* %10, i64 %indvars.iv.next10.1
  %66 = load double, double* %65, align 8
  %67 = fadd double %64, %66
  store double %67, double* %63, align 8
  %indvars.iv.next10.2 = add nuw nsw i64 %indvars.iv9, 3
  %68 = getelementptr inbounds double, double* %8, i64 %indvars.iv.next10.2
  %69 = load double, double* %68, align 8
  %70 = getelementptr inbounds double, double* %10, i64 %indvars.iv.next10.2
  %71 = load double, double* %70, align 8
  %72 = fadd double %69, %71
  store double %72, double* %68, align 8
  %indvars.iv.next10.3 = add nuw nsw i64 %indvars.iv9, 4
  %73 = getelementptr inbounds double, double* %8, i64 %indvars.iv.next10.3
  %74 = load double, double* %73, align 8
  %75 = getelementptr inbounds double, double* %10, i64 %indvars.iv.next10.3
...
.preheader:                                       ; preds = %93, %.preheader.preheader
  %indvars.iv6 = phi i64 [ 0, %.preheader.preheader ], [ %indvars.iv.next7, %93 ]
...
._crit_edge3:                                     ; preds = %._crit_edge3, %.preheader
  ...
  %sunkaddr31 = shl i64 %indvars.iv6, 3
  %sunkaddr32 = add i64 %sunkaddr30, %sunkaddr31
  %sunkaddr33 = inttoptr i64 %sunkaddr32 to double*
  %78 = load double, double* %sunkaddr33, align 8
  %79 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv6, i64 %indvars.iv
  ...
  store double %85, double* %sunkaddr33, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %86 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv6, i64 %indvars.iv.next
  ...
  store double %92, double* %sunkaddr33, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %93, label %._crit_edge3

; <label>:93:                                     ; preds = %._crit_edge3
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %exitcond8 = icmp eq i64 %indvars.iv.next7, 2000
  br i1 %exitcond8, label %94, label %.preheader
