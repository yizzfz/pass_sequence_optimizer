...
.preheader.us15.preheader:                        ; preds = %.preheader.us15.preheader.loopexit, %middle.block109, %.prol.loopexit
  %min.iters.check67 = icmp ult i64 %72, 2
  %n.vec70 = and i64 %72, -2
  %cmp.zero71 = icmp eq i64 %n.vec70, 0
  %cmp.n102 = icmp eq i64 %72, %n.vec70
...
.preheader.us15:                                  ; preds = %.preheader.us15.preheader, %._crit_edge.us18
  %indvars.iv30 = phi i64 [ %36, %._crit_edge.us18 ], [ 0, %.preheader.us15.preheader ]
...
vector.ph98:                                      ; preds = %vector.memcheck
  %.pre = load double, double* %37, align 8, !alias.scope !6
  %.pre141 = load double, double* %38, align 8, !alias.scope !9
  %39 = insertelement <2 x double> undef, double %.pre, i32 0
  %40 = shufflevector <2 x double> %39, <2 x double> undef, <2 x i32> zeroinitializer
  %41 = insertelement <2 x double> undef, double %.pre141, i32 0
...
vector.body64:                                    ; preds = %vector.body64, %vector.ph98
  ...
  store <2 x double> %63, <2 x double>* %62, align 8, !alias.scope !15, !noalias !17
  %index.next100 = add i64 %index99, 2
  %64 = icmp eq i64 %index.next100, %n.vec70
  br i1 %64, label %middle.block65, label %vector.body64, !llvm.loop !18
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %._crit_edge9.us
  ...
  %indvars.iv37 = phi i64 [ 0, %.lr.ph.us.preheader ], [ %72, %._crit_edge9.us ]
  %indvars.iv35 = phi i64 [ 1, %.lr.ph.us.preheader ], [ %indvars.iv.next36, %._crit_edge9.us ]
  %65 = zext i2 %indvars.iv137 to i64
  ...
  %70 = mul i64 %indvars.iv37, 1201
  %71 = add i64 %70, 1
  %scevgep74 = getelementptr [1200 x double], [1200 x double]* %4, i64 0, i64 %71
...
.lr.ph.us.new.preheader:                          ; preds = %.prol.loopexit
  ...
  %min.iters.check111 = icmp ult i64 %80, 2
...
min.iters.checked112:                             ; preds = %.lr.ph.us.new.preheader
  %n.mod.vf113 = and i64 %80, 1
  %n.vec114 = sub nsw i64 %80, %n.mod.vf113
  %cmp.zero115 = icmp eq i64 %n.vec114, 0
  %81 = add nsw i64 %indvars.iv.unr, 4
  %82 = shl nuw i64 %79, 2
  %83 = add i64 %81, %82
  %84 = shl nuw nsw i64 %n.mod.vf113, 2
  %ind.end120 = sub i64 %83, %84
...
vector.body108:                                   ; preds = %vector.body108, %vector.ph116
  ...
  %wide.vec126 = load <8 x double>, <8 x double>* %88, align 8
  ...
  %89 = fmul <2 x double> %strided.vec127, %broadcast.splat132
  %90 = fmul <2 x double> %strided.vec128, %broadcast.splat132
  %91 = fmul <2 x double> %strided.vec129, %broadcast.splat132
  %92 = add nsw i64 %86, 3
  %93 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv37, i64 %92
  %94 = fmul <2 x double> %strided.vec130, %broadcast.splat132
  ...
  %interleaved.vec133 = shufflevector <4 x double> %97, <4 x double> %98, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 1, i32 3, i32 5, i32 7>
  store <8 x double> %interleaved.vec133, <8 x double>* %96, align 8
  %index.next118 = add i64 %index117, 2
  %99 = icmp eq i64 %index.next118, %n.vec114
  br i1 %99, label %middle.block109, label %vector.body108, !llvm.loop !21
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.preheader3
  ...
  %100 = zext i2 %indvars.iv139 to i64
  %101 = add nuw nsw i64 %100, 4294967295
  %102 = and i64 %101, 4294967295
  %103 = add nuw nsw i64 %102, 1
  %104 = add nsw i64 %indvars.iv53, -3
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %105 = trunc i64 %indvars.iv.next54 to i32
  %xtraiter48 = and i32 %105, 3
...
.prol.preheader46:                                ; preds = %.prol.preheader46.preheader, %.prol.preheader46
  ...
  %106 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %indvars.iv41.prol
...
.prol.loopexit47:                                 ; preds = %.prol.loopexit47.loopexit, %.lr.ph
  %indvars.iv41.unr = phi i64 [ 0, %.lr.ph ], [ %103, %.prol.loopexit47.loopexit ]
  %109 = icmp ult i64 %indvars.iv53, 3
  br i1 %109, label %.preheader3, label %.lr.ph.new.preheader

.lr.ph.new.preheader:                             ; preds = %.prol.loopexit47
  %110 = sub i64 %104, %indvars.iv41.unr
  %111 = lshr i64 %110, 2
...
min.iters.checked:                                ; preds = %.lr.ph.new.preheader
  ...
  %113 = add nsw i64 %indvars.iv41.unr, 4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %117 = shl i64 %index, 2
  %118 = add i64 %indvars.iv41.unr, %117
  %119 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %118
  ...
  %121 = fmul <2 x double> %strided.vec, %broadcast.splat63
  %122 = fmul <2 x double> %strided.vec59, %broadcast.splat63
  %123 = fmul <2 x double> %strided.vec60, %broadcast.splat63
  %124 = add nsw i64 %118, 3
  %125 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %124
  %126 = fmul <2 x double> %strided.vec61, %broadcast.splat63
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader135, %.lr.ph.new
  ...
  %132 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %indvars.iv41
  %133 = load double, double* %132, align 8
  %134 = fmul double %133, %3
  store double %134, double* %132, align 8
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  %135 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %indvars.iv.next42
  %136 = load double, double* %135, align 8
  %137 = fmul double %136, %3
  store double %137, double* %135, align 8
  %indvars.iv.next42.1 = add nsw i64 %indvars.iv41, 2
  %138 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %indvars.iv.next42.1
  %139 = load double, double* %138, align 8
  %140 = fmul double %139, %3
  store double %140, double* %138, align 8
  %indvars.iv.next42.2 = add nsw i64 %indvars.iv41, 3
  %141 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %indvars.iv.next42.2
