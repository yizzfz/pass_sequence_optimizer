...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc7_crit_edge.us, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge
  %indvars.iv919.us = phi i64 [ 0, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge ], [ %indvars.iv.next10.us, %for.cond1.for.inc7_crit_edge.us ]
...
for.cond1.for.inc7_crit_edge.us:                  ; preds = %for.body3.us
  ...
  %exitcond26 = icmp eq i64 %indvars.iv.next10.us, 1200
  br i1 %exitcond26, label %for.cond14.preheader.preheader, label %for.cond1.preheader.us
...
for.inc31:                                        ; preds = %for.body17
  ...
  br i1 %exitcond27, label %for.end33, label %for.cond14.preheader
...
for.cond1.preheader.us:                           ; preds = %for.cond6.for.inc32_crit_edge.us, %for.cond1.preheader.us.preheader
  ...
  %indvars.iv1320.us = phi i64 [ %0, %for.cond6.for.inc32_crit_edge.us ], [ 0, %for.cond1.preheader.us.preheader ]
  ...
  %3 = mul nuw nsw i64 %indvars.iv1320.us, 1201
...
vector.body16.prol.preheader:                     ; preds = %vector.ph24
  %6 = bitcast double* %scevgep to <2 x double>*
  %wide.load33.prol = load <2 x double>, <2 x double>* %6, align 8
  %7 = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv1320.us, i64 2
  %8 = bitcast double* %7 to <2 x double>*
  %wide.load34.prol = load <2 x double>, <2 x double>* %8, align 8
  %9 = fmul <2 x double> %wide.load33.prol, %broadcast.splat36
  %10 = fmul <2 x double> %wide.load34.prol, %broadcast.splat36
  store <2 x double> %9, <2 x double>* %6, align 8
  store <2 x double> %10, <2 x double>* %8, align 8
  br label %vector.body16.prol.loopexit.unr-lcssa

vector.body16.prol.loopexit.unr-lcssa:            ; preds = %vector.ph24, %vector.body16.prol.preheader
  %index25.unr.ph = phi i64 [ 4, %vector.body16.prol.preheader ], [ 0, %vector.ph24 ]
  %11 = icmp eq i64 %2, 0
  br i1 %11, label %middle.block17, label %vector.ph24.new

vector.ph24.new:                                  ; preds = %vector.body16.prol.loopexit.unr-lcssa
...
vector.body16:                                    ; preds = %vector.body16, %vector.ph24.new
  ...
  %12 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv1320.us, i64 %index25
  %13 = bitcast double* %12 to <2 x double>*
  %wide.load33 = load <2 x double>, <2 x double>* %13, align 8
  %14 = getelementptr double, double* %12, i64 2
  %15 = bitcast double* %14 to <2 x double>*
  %wide.load34 = load <2 x double>, <2 x double>* %15, align 8
  %16 = fmul <2 x double> %wide.load33, %broadcast.splat36
  ...
  %18 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv1320.us, i64 %index.next26
  %19 = bitcast double* %18 to <2 x double>*
  %wide.load33.1 = load <2 x double>, <2 x double>* %19, align 8
  %20 = getelementptr double, double* %18, i64 2
  %21 = bitcast double* %20 to <2 x double>*
  %wide.load34.1 = load <2 x double>, <2 x double>* %21, align 8
  %22 = fmul <2 x double> %wide.load33.1, %broadcast.splat36
  %23 = fmul <2 x double> %wide.load34.1, %broadcast.splat36
  store <2 x double> %22, <2 x double>* %19, align 8
  store <2 x double> %23, <2 x double>* %21, align 8
  %index.next26.1 = add i64 %index25, 8
  %24 = icmp eq i64 %index.next26.1, %n.vec22
  br i1 %24, label %middle.block17.unr-lcssa, label %vector.body16, !llvm.loop !1

middle.block17.unr-lcssa:                         ; preds = %vector.body16
  br label %middle.block17

middle.block17:                                   ; preds = %vector.body16.prol.loopexit.unr-lcssa, %middle.block17.unr-lcssa
...
for.cond9.preheader.us.preheader:                 ; preds = %for.cond9.preheader.us.preheader.loopexit, %middle.block17
  %n.vec.pre-phi = phi i64 [ %.pre39, %for.cond9.preheader.us.preheader.loopexit ], [ %n.vec22, %middle.block17 ]
  %cmp.zero = icmp eq i64 %n.vec.pre-phi, 0
  %cmp.n = icmp eq i64 %0, %n.vec.pre-phi
  br label %for.cond9.preheader.us

for.cond9.preheader.us:                           ; preds = %for.cond9.preheader.us.preheader, %for.inc29.us
  %indvars.iv918.us = phi i64 [ %26, %for.inc29.us ], [ 0, %for.cond9.preheader.us.preheader ]
  %scevgep4 = getelementptr [1000 x double], [1000 x double]* %A, i64 0, i64 %indvars.iv918.us
  %26 = add nuw nsw i64 %indvars.iv918.us, 1
  %scevgep6 = getelementptr [1000 x double], [1000 x double]* %A, i64 %indvars.iv1320.us, i64 %26
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %28 = fmul <2 x double> %27, %broadcast.splatinsert13
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %34 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %30, i64 %indvars.iv918.us
  %35 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %31, i64 %indvars.iv918.us
  %36 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %32, i64 %indvars.iv918.us
  %37 = load double, double* %33, align 8, !alias.scope !9
  %38 = load double, double* %34, align 8, !alias.scope !9
  ...
  %45 = fmul <2 x double> %29, %42
  %46 = fmul <2 x double> %29, %44
  %47 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv1320.us, i64 %index
  %48 = bitcast double* %47 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %48, align 8, !alias.scope !11, !noalias !13
  %49 = getelementptr double, double* %47, i64 2
  %50 = bitcast double* %49 to <2 x double>*
  %wide.load15 = load <2 x double>, <2 x double>* %50, align 8, !alias.scope !11, !noalias !13
  %51 = fadd <2 x double> %wide.load, %45
  %52 = fadd <2 x double> %wide.load15, %46
  store <2 x double> %51, <2 x double>* %48, align 8, !alias.scope !11, !noalias !13
  store <2 x double> %52, <2 x double>* %50, align 8, !alias.scope !11, !noalias !13
  %index.next = add i64 %index, 4
  %53 = icmp eq i64 %index.next, %n.vec.pre-phi
...
for.body11.us.preheader:                          ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.cond9.preheader.us
  %indvars.iv316.us.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %min.iters.checked ], [ 0, %for.cond9.preheader.us ], [ %n.vec.pre-phi, %middle.block ]
  %54 = sub i64 %0, %indvars.iv316.us.ph
  %xtraiter37 = and i64 %54, 1
...
for.body11.us.prol.loopexit.unr-lcssa:            ; preds = %for.body11.us.preheader, %for.body11.us.prol.preheader
  %indvars.iv316.us.unr.ph = phi i64 [ %indvars.iv.next4.us.prol, %for.body11.us.prol.preheader ], [ %indvars.iv316.us.ph, %for.body11.us.preheader ]
  %58 = icmp eq i64 %indvars.iv1320.us, %indvars.iv316.us.ph
  br i1 %58, label %for.inc29.us.loopexit, label %for.body11.us.preheader.new

for.body11.us.preheader.new:                      ; preds = %for.body11.us.prol.loopexit.unr-lcssa
...
for.body11.us:                                    ; preds = %for.body11.us, %for.body11.us.preheader.new
  ...
  %59 = load double, double* %arrayidx15.us, align 8
  %mul16.us = fmul double %59, %alpha
  ...
  %mul21.us.1 = fmul double %mul16.us.1, %63
  %arrayidx25.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv1320.us, i64 %indvars.iv.next4.us
  %64 = load double, double* %arrayidx25.us.1, align 8
  %add.us.1 = fadd double %64, %mul21.us.1
  ...
  br i1 %exitcond8.us.1, label %for.inc29.us.loopexit.unr-lcssa, label %for.body11.us, !llvm.loop !15

for.inc29.us.loopexit.unr-lcssa:                  ; preds = %for.body11.us
  br label %for.inc29.us.loopexit

for.inc29.us.loopexit:                            ; preds = %for.body11.us.prol.loopexit.unr-lcssa, %for.inc29.us.loopexit.unr-lcssa
  br label %for.inc29.us

for.inc29.us:                                     ; preds = %for.inc29.us.loopexit, %middle.block
  %exitcond25 = icmp eq i64 %26, 1000
