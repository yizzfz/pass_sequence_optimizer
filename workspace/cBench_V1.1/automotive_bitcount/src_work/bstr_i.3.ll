...
@__llvm_prf_nm = private constant [16 x i8] c"\06\0Ex\DAK*.)\8A\CF\04\00\08\DE\02\84", section "__llvm_prf_names"
@llvm.used = appending global [2 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_bstr_i to i8*), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
