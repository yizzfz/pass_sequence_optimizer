...
.preheader4.us.new:                               ; preds = %.preheader4.us.new, %.preheader4.us.new.preheader
  %14 = phi double [ %.pre, %.preheader4.us.new.preheader ], [ %26, %.preheader4.us.new ]
  %indvars.iv15 = phi i64 [ %indvars.iv15.unr.ph, %.preheader4.us.new.preheader ], [ %indvars.iv.next16.1, %.preheader4.us.new ]
...
.preheader.us.new.preheader:                      ; preds = %.prol.loopexit
  %.pre28 = load double, double* %27, align 8
  br label %.preheader.us.new

.preheader.us.new:                                ; preds = %.preheader.us.new, %.preheader.us.new.preheader
  %34 = phi double [ %.pre28, %.preheader.us.new.preheader ], [ %46, %.preheader.us.new ]
...
define internal fastcc void @print_array(i32, double* nocapture readonly, double* nocapture readonly) unnamed_addr #0 {
  ...
  br i1 true, label %.lr.ph7.preheader, label %._crit_edge8.._crit_edge_crit_edge.critedge
...
._crit_edge:                                      ; preds = %._crit_edge8.._crit_edge_crit_edge, %._crit_edge.loopexit, %._crit_edge8.._crit_edge_crit_edge.critedge
