...
@__llvm_prf_nm = private constant [65 x i8] c"a?x\DA\CBML\89/\AE\CC+\C9\88\CF\CC\CB,a\CC\85ssKKR\91\B8iE\89\B9\A9\8C%\B9\05\86z99VP\B1\D2\9C\1C4\A1\8C\C4\9C4\B8PJr\89\B1\11\00-$$P", section "__llvm_prf_names"
@llvm.used = appending global [8 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_mad_synth_init to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_mad_synth_mute to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_mad_synth_frame to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_synth_full to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_synth_half to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_dct32 to i8*), i8* bitcast ([10 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([65 x i8], [65 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
