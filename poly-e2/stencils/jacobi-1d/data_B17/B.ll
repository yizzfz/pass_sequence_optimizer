...
entry:
  %call = call i8* @polybench_alloc_data(i64 2000, i32 8) #3
...
for.inc.us.preheader:                             ; preds = %middle.block131, %vector.memcheck151, %min.iters.checked135, %for.cond1.preheader.us
  %indvars.iv.ph = phi i64 [ 1, %vector.memcheck151 ], [ 1, %min.iters.checked135 ], [ 1, %for.cond1.preheader.us ], [ %ind.end117, %middle.block131 ]
  br label %for.inc.us

min.iters.checked135:                             ; preds = %for.cond1.preheader.us
...
vector.body130:                                   ; preds = %vector.body130.preheader, %vector.body130
  ...
  %4 = getelementptr inbounds double, double* %A, i64 %index153
  %5 = bitcast double* %4 to <2 x double>*
  %wide.load163 = load <2 x double>, <2 x double>* %5, align 8, !alias.scope !1
  %6 = getelementptr double, double* %4, i64 2
  %7 = bitcast double* %6 to <2 x double>*
  %wide.load164 = load <2 x double>, <2 x double>* %7, align 8, !alias.scope !1
  %8 = getelementptr inbounds double, double* %A, i64 %offset.idx158
  %9 = bitcast double* %8 to <2 x double>*
  %wide.load165 = load <2 x double>, <2 x double>* %9, align 8, !alias.scope !1
  %10 = getelementptr double, double* %8, i64 2
  %11 = bitcast double* %10 to <2 x double>*
  %wide.load166 = load <2 x double>, <2 x double>* %11, align 8, !alias.scope !1
  %12 = fadd <2 x double> %wide.load163, %wide.load165
  %13 = fadd <2 x double> %wide.load164, %wide.load166
  %14 = add nuw nsw i64 %offset.idx158, 1
  %15 = getelementptr inbounds double, double* %A, i64 %14
  %16 = getelementptr double, double* %15, i64 2
  %17 = bitcast double* %16 to <2 x double>*
  %wide.load168 = load <2 x double>, <2 x double>* %17, align 8, !alias.scope !1
  %18 = fadd <2 x double> %12, %wide.load164
  %19 = fadd <2 x double> %13, %wide.load168
  ...
  %22 = getelementptr inbounds double, double* %B, i64 %offset.idx158
  ...
  %26 = icmp eq i64 %index.next154, %n.vec98
  br i1 %26, label %middle.block131, label %vector.body130, !llvm.loop !6
...
for.inc30.us:                                     ; preds = %for.inc30.us.preheader169, %for.inc30.us
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.inc30.us ], [ %indvars.iv65.ph, %for.inc30.us.preheader169 ]
...
for.inc30.us.preheader169:                        ; preds = %middle.block92, %vector.memcheck112, %min.iters.checked96, %for.inc30.us.preheader
  %indvars.iv65.ph = phi i64 [ 1, %vector.memcheck112 ], [ 1, %min.iters.checked96 ], [ 1, %for.inc30.us.preheader ], [ %ind.end117, %middle.block92 ]
...
vector.body91:                                    ; preds = %vector.body91.preheader, %vector.body91
  ...
  %35 = getelementptr inbounds double, double* %B, i64 %index114
  ...
  %39 = getelementptr inbounds double, double* %B, i64 %offset.idx119
  %40 = bitcast double* %39 to <2 x double>*
  %wide.load126 = load <2 x double>, <2 x double>* %40, align 8, !alias.scope !11
  %41 = getelementptr double, double* %39, i64 2
  %42 = bitcast double* %41 to <2 x double>*
  %wide.load127 = load <2 x double>, <2 x double>* %42, align 8, !alias.scope !11
  %43 = fadd <2 x double> %wide.load124, %wide.load126
  %44 = fadd <2 x double> %wide.load125, %wide.load127
  %45 = add nuw nsw i64 %offset.idx119, 1
  %46 = getelementptr inbounds double, double* %B, i64 %45
  %47 = getelementptr double, double* %46, i64 2
  %48 = bitcast double* %47 to <2 x double>*
  %wide.load129 = load <2 x double>, <2 x double>* %48, align 8, !alias.scope !11
  %49 = fadd <2 x double> %43, %wide.load125
  %50 = fadd <2 x double> %44, %wide.load129
  ...
  %53 = getelementptr inbounds double, double* %A, i64 %offset.idx119
  ...
  %57 = icmp eq i64 %index.next115, %n.vec98
  br i1 %57, label %middle.block92, label %vector.body91, !llvm.loop !16
...
if.then:                                          ; preds = %for.body
  ...
  %fputc = call i32 @fputc(i32 10, %struct._IO_FILE* %5) #4
  br label %for.inc
...
for.inc:                                          ; preds = %for.body, %if.then
  ...
  %call4 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %6, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i64 0, i64 0), double %7) #5
