...
for.body3.us:                                     ; preds = %for.cond6.for.inc34_crit_edge.us, %for.body3.us.preheader
  %indvars.iv11 = phi i64 [ 0, %for.body3.us.preheader ], [ %indvars.iv.next12, %for.cond6.for.inc34_crit_edge.us ]
  %arrayidx5.us = getelementptr inbounds double, double* %q, i64 %indvars.iv11
...
for.inc31.us:                                     ; preds = %for.inc31.us, %for.body3.us
  ...
  %sunkaddr33 = mul i64 %indvars.iv11, 8
  %sunkaddr34 = add i64 %sunkaddr, %sunkaddr33
  %sunkaddr35 = inttoptr i64 %sunkaddr34 to double*
  %1 = load double, double* %sunkaddr35, align 8
  %arrayidx16.us = getelementptr inbounds [1900 x double], [1900 x double]* %A, i64 %indvars.iv11, i64 %indvars.iv
  ...
  %sunkaddr36 = ptrtoint double* %q to i64
  %sunkaddr38 = add i64 %sunkaddr36, %sunkaddr33
  %sunkaddr39 = inttoptr i64 %sunkaddr38 to double*
  %3 = load double, double* %sunkaddr39, align 8
  ...
  store double %add28.us, double* %sunkaddr39, align 8
...
for.cond6.for.inc34_crit_edge.us:                 ; preds = %for.inc31.us
  ...
  %exitcond13 = icmp eq i64 %indvars.iv.next12, 2100
  br i1 %exitcond13, label %for.end36, label %for.body3.us
