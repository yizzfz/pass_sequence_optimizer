...
for.body.us:                                      ; preds = %for.cond35.for.inc46_crit_edge.us, %for.body.us.preheader
  %indvars.iv12 = phi i64 [ 0, %for.body.us.preheader ], [ %indvars.iv.next13, %for.cond35.for.inc46_crit_edge.us ]
  %0 = trunc i64 %indvars.iv12 to i32
  %conv2.us = sitofp i32 %0 to double
  %arrayidx.us = getelementptr inbounds double, double* %u1, i64 %indvars.iv12
  store double %conv2.us, double* %arrayidx.us, align 8
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %1 = trunc i64 %indvars.iv.next13 to i32
  %conv3.us = sitofp i32 %1 to double
  %arrayidx6.us = getelementptr inbounds double, double* %u2, i64 %indvars.iv12
  ...
  %arrayidx12.us = getelementptr inbounds double, double* %v1, i64 %indvars.iv12
  store double %div4.v.r2.us, double* %arrayidx12.us, align 8
  %arrayidx18.us = getelementptr inbounds double, double* %v2, i64 %indvars.iv12
  ...
  %arrayidx24.us = getelementptr inbounds double, double* %y, i64 %indvars.iv12
  ...
  %arrayidx30.us = getelementptr inbounds double, double* %z, i64 %indvars.iv12
  store double %div28.us, double* %arrayidx30.us, align 8
  %arrayidx32.us = getelementptr inbounds double, double* %x, i64 %indvars.iv12
  store double 0.000000e+00, double* %arrayidx32.us, align 8
  %arrayidx34.us = getelementptr inbounds double, double* %w, i64 %indvars.iv12
...
for.inc.us:                                       ; preds = %for.inc.us, %for.body.us
  ...
  %5 = mul nuw nsw i64 %indvars.iv12, %indvars.iv
  %6 = trunc i64 %5 to i32
  %rem.us = srem i32 %6, 2000
  %conv39.us = sitofp i32 %rem.us to double
  %arrayidx45.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv12, i64 %indvars.iv
  %indvars.iv.next = or i64 %indvars.iv, 1
  %7 = mul nuw nsw i64 %indvars.iv12, %indvars.iv.next
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc20_crit_edge.us, %for.cond1.preheader.us.preheader
  %indvars.iv58 = phi i64 [ 0, %for.cond1.preheader.us.preheader ], [ %indvars.iv.next59, %for.cond1.for.inc20_crit_edge.us ]
  %sunkaddr1 = shl i64 %indvars.iv58, 3
...
for.inc.us:                                       ; preds = %for.inc.us, %for.cond1.preheader.us
  ...
  %arrayidx5.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv58, i64 %indvars.iv55
  ...
  %arrayidx5.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv58, i64 %indvars.iv.next56
  ...
  %exitcond57.1 = icmp eq i64 %indvars.iv.next56.1, 2000
  br i1 %exitcond57.1, label %for.cond1.for.inc20_crit_edge.us, label %for.inc.us

for.cond1.for.inc20_crit_edge.us:                 ; preds = %for.inc.us
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  %exitcond60 = icmp eq i64 %indvars.iv.next59, 2000
  br i1 %exitcond60, label %for.cond26.preheader.us.preheader, label %for.cond1.preheader.us
...
for.cond26.preheader.us:                          ; preds = %for.cond26.preheader.us.preheader, %for.cond26.for.inc45_crit_edge.us
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.cond26.for.inc45_crit_edge.us ], [ 0, %for.cond26.preheader.us.preheader ]
  %arrayidx30.us = getelementptr inbounds double, double* %x, i64 %indvars.iv51
  %.pre = load double, double* %arrayidx30.us, align 8
  %sunkaddr9 = shl i64 %indvars.iv51, 3
...
for.inc42.us:                                     ; preds = %for.inc42.us, %for.cond26.preheader.us
  %indvars.iv48 = phi i64 [ 0, %for.cond26.preheader.us ], [ %indvars.iv.next49.1, %for.inc42.us ]
  %10 = phi double [ %.pre, %for.cond26.preheader.us ], [ %add39.us.1, %for.inc42.us ]
  %arrayidx34.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv48, i64 %indvars.iv51
  ...
  %arrayidx34.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv.next49, i64 %indvars.iv51
  ...
  br i1 %exitcond50.1, label %for.cond26.for.inc45_crit_edge.us, label %for.inc42.us

for.cond26.for.inc45_crit_edge.us:                ; preds = %for.inc42.us
  %indvars.iv.next52 = add nuw nsw i64 %indvars.iv51, 1
  %exitcond53 = icmp eq i64 %indvars.iv.next52, 2000
  br i1 %exitcond53, label %for.inc58.preheader, label %for.cond26.preheader.us
...
for.cond64.preheader.us:                          ; preds = %for.cond64.preheader.us.preheader, %for.cond64.for.inc83_crit_edge.us
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.cond64.for.inc83_crit_edge.us ], [ 0, %for.cond64.preheader.us.preheader ]
  %arrayidx68.us = getelementptr inbounds double, double* %w, i64 %indvars.iv41
  %.pre40 = load double, double* %arrayidx68.us, align 8
  %sunkaddr13 = shl i64 %indvars.iv41, 3
...
for.inc80.us:                                     ; preds = %for.inc80.us, %for.cond64.preheader.us
  ...
  %15 = phi double [ %.pre40, %for.cond64.preheader.us ], [ %add77.us.1, %for.inc80.us ]
...
for.cond64.for.inc83_crit_edge.us:                ; preds = %for.inc80.us
  ...
  br i1 %exitcond43, label %for.end85, label %for.cond64.preheader.us

for.inc58:                                        ; preds = %for.inc58.preheader, %for.inc58
  %indvars.iv45 = phi i64 [ %indvars.iv.next46.4, %for.inc58 ], [ 0, %for.inc58.preheader ]
  %arrayidx52 = getelementptr inbounds double, double* %x, i64 %indvars.iv45
  %20 = load double, double* %arrayidx52, align 8
  %arrayidx54 = getelementptr inbounds double, double* %z, i64 %indvars.iv45
  %21 = load double, double* %arrayidx54, align 8
  %add55 = fadd double %20, %21
  store double %add55, double* %arrayidx52, align 8
  %indvars.iv.next46 = add nuw nsw i64 %indvars.iv45, 1
  %arrayidx52.1 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next46
  %22 = load double, double* %arrayidx52.1, align 8
  %arrayidx54.1 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next46
  ...
  %arrayidx52.2 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next46.1
  %24 = load double, double* %arrayidx52.2, align 8
  %arrayidx54.2 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next46.1
  ...
  %arrayidx52.3 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next46.2
  %26 = load double, double* %arrayidx52.3, align 8
  %arrayidx54.3 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next46.2
  ...
  %arrayidx52.4 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next46.3
  %28 = load double, double* %arrayidx52.4, align 8
  %arrayidx54.4 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next46.3
  %29 = load double, double* %arrayidx54.4, align 8
  %add55.4 = fadd double %28, %29
  store double %add55.4, double* %arrayidx52.4, align 8
  %indvars.iv.next46.4 = add nuw nsw i64 %indvars.iv45, 5
  %exitcond47.4 = icmp eq i64 %indvars.iv.next46.4, 2000
  br i1 %exitcond47.4, label %for.cond64.preheader.us.preheader, label %for.inc58
