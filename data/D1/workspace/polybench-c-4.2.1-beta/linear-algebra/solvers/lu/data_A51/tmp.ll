...
.lr.ph84:                                         ; preds = %.preheader62.lr.ph, %._crit_edge88..preheader62_crit_edge
  %indvars.iv126 = phi i64 [ %indvars.iv.next127, %._crit_edge88..preheader62_crit_edge ], [ 0, %.preheader62.lr.ph ]
  %1 = sub i64 1998, %indvars.iv126
  %2 = shl i64 %1, 3
...
.preheader61:                                     ; preds = %5
  ...
  %4 = icmp slt i64 %indvars.iv.next127, 2000
  br i1 %4, label %._crit_edge88..preheader62_crit_edge, label %.preheader60.us.preheader

; <label>:5:                                      ; preds = %5, %.lr.ph84
  %indvars.iv112 = phi i64 [ 0, %.lr.ph84 ], [ %indvars.iv.next113, %5 ]
  %6 = sub nsw i64 0, %indvars.iv112
  %7 = trunc i64 %6 to i32
  %8 = srem i32 %7, 2000
  %9 = sitofp i32 %8 to double
  %10 = fdiv double %9, 2.000000e+03
  %11 = fadd double %10, 1.000000e+00
  %12 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv126, i64 %indvars.iv112
  store double %11, double* %12, align 8
  %indvars.iv.next113 = add nuw nsw i64 %indvars.iv112, 1
  %exitcond117 = icmp eq i64 %indvars.iv112, %indvars.iv126
  br i1 %exitcond117, label %.preheader61, label %5

._crit_edge88..preheader62_crit_edge:             ; preds = %.preheader61
  %13 = add nuw nsw i64 %3, 8
  %scevgep124 = getelementptr [2000 x double], [2000 x double]* %0, i64 %indvars.iv126, i64 %indvars.iv.next127
  %scevgep124125 = bitcast double* %scevgep124 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep124125, i8 0, i64 %13, i32 8, i1 false)
  %14 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv126, i64 %indvars.iv126
  store double 1.000000e+00, double* %14, align 8
  br label %.lr.ph84

.preheader60.us.preheader:                        ; preds = %.preheader61
  %15 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv126, i64 %indvars.iv126
...
._crit_edge81.us:                                 ; preds = %._crit_edge81.us, %.preheader60.us.preheader
  %indvars.iv110 = phi i64 [ 0, %.preheader60.us.preheader ], [ %indvars.iv.next111.7, %._crit_edge81.us ]
  ...
  %exitcond45.7 = icmp eq i64 %indvars.iv.next111.7, 2000
...
.preheader57.us.us.preheader:                     ; preds = %._crit_edge70.us, %.preheader57.us.us.preheader.preheader
  %indvars.iv104 = phi i64 [ %indvars.iv.next105, %._crit_edge70.us ], [ 0, %.preheader57.us.us.preheader.preheader ]
  %scevgep3 = getelementptr [2000 x double], [2000 x double]* %0, i64 0, i64 %indvars.iv104
  %28 = add nuw nsw i64 %indvars.iv104, 1
...
.preheader57.us.us:                               ; preds = %._crit_edge68.us.us, %.preheader57.us.us.preheader
  %indvars.iv102 = phi i64 [ 0, %.preheader57.us.us.preheader ], [ %indvars.iv.next103, %._crit_edge68.us.us ]
  %38 = mul nuw nsw i64 %indvars.iv102, 16000
  %scevgep1 = getelementptr i8, i8* %16, i64 %38
  %39 = add nuw nsw i64 %38, 16000
  %scevgep2 = getelementptr i8, i8* %16, i64 %39
  %40 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv102, i64 %indvars.iv104
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %47 = or i64 %index, 2
  %48 = or i64 %index, 3
  %49 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %index, i64 %indvars.iv104
  %50 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %46, i64 %indvars.iv104
  %51 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %47, i64 %indvars.iv104
  %52 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %48, i64 %indvars.iv104
  ...
  %63 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %27, i64 0, i64 %indvars.iv102, i64 %index
...
._crit_edge68.us.us:                              ; preds = %._crit_edge68.us.us.loopexit47, %._crit_edge68.us.us.loopexit
  ...
  %exitcond43 = icmp eq i64 %indvars.iv.next103, 2000
...
scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader
  ...
  %73 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv98, i64 %indvars.iv104
  %74 = load double, double* %73, align 8
  %75 = fmul double %72, %74
  %76 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %25, i64 0, i64 %indvars.iv102, i64 %indvars.iv98
  ...
  %80 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv.next99, i64 %indvars.iv104
  %81 = load double, double* %80, align 8
  %82 = fmul double %79, %81
  %83 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv102, i64 %indvars.iv.next99
  ...
  br i1 %exitcond101.1, label %._crit_edge68.us.us.loopexit, label %scalar.ph, !llvm.loop !12
