...
; <label>:17:                                     ; preds = %.loopexit1, %8
  %18 = phi i64 [ 0, %8 ], [ %89, %.loopexit1 ]
  %19 = mul i64 %18, 280
  %scevgep = getelementptr i8, i8* %2, i64 %19
  br i1 %10, label %20, label %.loopexit1

; <label>:20:                                     ; preds = %17
  %21 = mul nuw nsw i64 %18, 280
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %.split
  ...
  br i1 %88, label %.loopexit1.loopexit18, label %.split
...
.loopexit1:                                       ; preds = %.loopexit1.loopexit18, %.loopexit1.loopexit, %17
  ...
  br i1 %90, label %.loopexit2.loopexit, label %17
...
; <label>:23:                                     ; preds = %.loopexit2, %9
  %24 = phi i64 [ 0, %9 ], [ %103, %.loopexit2 ]
  %25 = trunc i64 %24 to i32
  %26 = mul i64 %24, 1202590842880
  %27 = ashr exact i64 %26, 32
  %28 = getelementptr i8, i8* %1, i64 %27
  br i1 %11, label %29, label %.loopexit2

; <label>:29:                                     ; preds = %23
  %30 = mul nuw nsw i64 %24, 280
  br i1 %12, label %.preheader1.preheader, label %32
...
; <label>:32:                                     ; preds = %29
  tail call void @llvm.memset.p0i8.i64(i8* %28, i8 0, i64 %15, i32 1, i1 false)
  br label %.loopexit2

.preheader1:                                      ; preds = %.preheader1.preheader, %.us-lcssa.us
  %33 = phi i64 [ %67, %.us-lcssa.us ], [ 0, %.preheader1.preheader ]
...
.us-lcssa.us:                                     ; preds = %.us-lcssa.us.loopexit15, %.us-lcssa.us.loopexit, %.split.us
  %.lcssa4 = phi float [ undef, %.split.us ], [ %59, %.us-lcssa.us.loopexit ], [ %80, %.us-lcssa.us.loopexit15 ]
  %64 = fptoui float %.lcssa4 to i8
  %65 = add nuw nsw i64 %33, %30
...
.split:                                           ; preds = %.split.preheader, %.loopexit
  ...
  %69 = phi float [ %80, %.loopexit ], [ 0.000000e+00, %.split.preheader ]
  %70 = add nuw nsw i64 %indvars.iv, %31
  %71 = mul nsw i64 %70, 280
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %.split
  %80 = phi float [ %79, %.split ], [ %100, %.loopexit.loopexit ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %81 = icmp eq i64 %indvars.iv.next, %22
  br i1 %81, label %.us-lcssa.us.loopexit15, label %.split

.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  %82 = phi i64 [ %101, %.preheader ], [ 1, %.preheader.preheader ]
  %83 = phi float [ %100, %.preheader ], [ %79, %.preheader.preheader ]
  ...
  br i1 %102, label %.loopexit.loopexit, label %.preheader
...
.loopexit2:                                       ; preds = %.loopexit2.loopexit, %32, %23
  ...
  br i1 %104, label %.loopexit3.loopexit, label %23
}
...
; <label>:3:                                      ; preds = %120, %.loopexit
  %4 = phi i64 [ 0, %.loopexit ], [ %121, %120 ]
  %5 = mul nuw nsw i64 %4, 280
  %6 = getelementptr i8, i8* %1, i64 %5
  %7 = add nuw nsw i64 %5, 277
  %8 = getelementptr i8, i8* %1, i64 %7
...
; <label>:27:                                     ; preds = %3
  %28 = bitcast i8* %10 to <16 x i8>*
  %29 = load <16 x i8>, <16 x i8>* %28, align 1, !tbaa !1, !alias.scope !13
  %30 = getelementptr i8, i8* %10, i64 16
  %31 = bitcast i8* %30 to <16 x i8>*
  %32 = load <16 x i8>, <16 x i8>* %31, align 1, !tbaa !1, !alias.scope !13
  %33 = bitcast i8* %6 to <16 x i8>*
  store <16 x i8> %29, <16 x i8>* %33, align 1, !tbaa !1, !alias.scope !16, !noalias !13
  %34 = getelementptr i8, i8* %6, i64 16
  %35 = bitcast i8* %34 to <16 x i8>*
  store <16 x i8> %32, <16 x i8>* %35, align 1, !tbaa !1, !alias.scope !16, !noalias !13
  %36 = add nuw nsw i64 %5, 32
  %37 = add nuw nsw i64 %5, 31
  %38 = getelementptr inbounds i8, i8* %0, i64 %37
  %39 = bitcast i8* %38 to <16 x i8>*
  %40 = load <16 x i8>, <16 x i8>* %39, align 1, !tbaa !1, !alias.scope !13
  %41 = getelementptr i8, i8* %38, i64 16
  %42 = bitcast i8* %41 to <16 x i8>*
  %43 = load <16 x i8>, <16 x i8>* %42, align 1, !tbaa !1, !alias.scope !13
  %44 = getelementptr inbounds i8, i8* %1, i64 %36
  %45 = bitcast i8* %44 to <16 x i8>*
  store <16 x i8> %40, <16 x i8>* %45, align 1, !tbaa !1, !alias.scope !16, !noalias !13
  %46 = getelementptr i8, i8* %44, i64 16
  %47 = bitcast i8* %46 to <16 x i8>*
  store <16 x i8> %43, <16 x i8>* %47, align 1, !tbaa !1, !alias.scope !16, !noalias !13
  %48 = add nuw nsw i64 %5, 64
  %49 = add nuw nsw i64 %5, 63
  ...
  %55 = load <16 x i8>, <16 x i8>* %54, align 1, !tbaa !1, !alias.scope !13
  %56 = getelementptr inbounds i8, i8* %1, i64 %48
  %57 = bitcast i8* %56 to <16 x i8>*
  store <16 x i8> %52, <16 x i8>* %57, align 1, !tbaa !1, !alias.scope !16, !noalias !13
  %58 = getelementptr i8, i8* %56, i64 16
  %59 = bitcast i8* %58 to <16 x i8>*
  store <16 x i8> %55, <16 x i8>* %59, align 1, !tbaa !1, !alias.scope !16, !noalias !13
  %60 = add nuw nsw i64 %5, 96
  %61 = add nuw nsw i64 %5, 95
  %62 = getelementptr inbounds i8, i8* %0, i64 %61
  %63 = bitcast i8* %62 to <16 x i8>*
  %64 = load <16 x i8>, <16 x i8>* %63, align 1, !tbaa !1, !alias.scope !13
  %65 = getelementptr i8, i8* %62, i64 16
  %66 = bitcast i8* %65 to <16 x i8>*
  %67 = load <16 x i8>, <16 x i8>* %66, align 1, !tbaa !1, !alias.scope !13
  %68 = getelementptr inbounds i8, i8* %1, i64 %60
  %69 = bitcast i8* %68 to <16 x i8>*
  store <16 x i8> %64, <16 x i8>* %69, align 1, !tbaa !1, !alias.scope !16, !noalias !13
  %70 = getelementptr i8, i8* %68, i64 16
  %71 = bitcast i8* %70 to <16 x i8>*
  store <16 x i8> %67, <16 x i8>* %71, align 1, !tbaa !1, !alias.scope !16, !noalias !13
  %72 = add nuw nsw i64 %5, 128
  %73 = add nuw nsw i64 %5, 127
  ...
  %79 = load <16 x i8>, <16 x i8>* %78, align 1, !tbaa !1, !alias.scope !13
  %80 = getelementptr inbounds i8, i8* %1, i64 %72
  %81 = bitcast i8* %80 to <16 x i8>*
  store <16 x i8> %76, <16 x i8>* %81, align 1, !tbaa !1, !alias.scope !16, !noalias !13
  %82 = getelementptr i8, i8* %80, i64 16
  %83 = bitcast i8* %82 to <16 x i8>*
  store <16 x i8> %79, <16 x i8>* %83, align 1, !tbaa !1, !alias.scope !16, !noalias !13
  %84 = add nuw nsw i64 %5, 160
  %85 = add nuw nsw i64 %5, 159
  ...
  %91 = load <16 x i8>, <16 x i8>* %90, align 1, !tbaa !1, !alias.scope !13
  %92 = getelementptr inbounds i8, i8* %1, i64 %84
  %93 = bitcast i8* %92 to <16 x i8>*
  store <16 x i8> %88, <16 x i8>* %93, align 1, !tbaa !1, !alias.scope !16, !noalias !13
  %94 = getelementptr i8, i8* %92, i64 16
  %95 = bitcast i8* %94 to <16 x i8>*
  store <16 x i8> %91, <16 x i8>* %95, align 1, !tbaa !1, !alias.scope !16, !noalias !13
  %96 = add nuw nsw i64 %5, 192
  %97 = add nuw nsw i64 %5, 191
  ...
  %103 = load <16 x i8>, <16 x i8>* %102, align 1, !tbaa !1, !alias.scope !13
  %104 = getelementptr inbounds i8, i8* %1, i64 %96
  %105 = bitcast i8* %104 to <16 x i8>*
  store <16 x i8> %100, <16 x i8>* %105, align 1, !tbaa !1, !alias.scope !16, !noalias !13
  %106 = getelementptr i8, i8* %104, i64 16
  %107 = bitcast i8* %106 to <16 x i8>*
  store <16 x i8> %103, <16 x i8>* %107, align 1, !tbaa !1, !alias.scope !16, !noalias !13
  %108 = add nuw nsw i64 %5, 224
  %109 = add nuw nsw i64 %5, 223
  ...
  %115 = load <16 x i8>, <16 x i8>* %114, align 1, !tbaa !1, !alias.scope !13
  %116 = getelementptr inbounds i8, i8* %1, i64 %108
  %117 = bitcast i8* %116 to <16 x i8>*
  store <16 x i8> %112, <16 x i8>* %117, align 1, !tbaa !1, !alias.scope !16, !noalias !13
  %118 = getelementptr i8, i8* %116, i64 16
  %119 = bitcast i8* %118 to <16 x i8>*
  store <16 x i8> %115, <16 x i8>* %119, align 1, !tbaa !1, !alias.scope !16, !noalias !13
  br label %16

; <label>:120:                                    ; preds = %123
  %121 = add nuw nsw i64 %4, 1
  %122 = icmp eq i64 %121, 220
  br i1 %122, label %.loopexit.loopexit, label %3

; <label>:123:                                    ; preds = %123, %16
  %124 = phi i64 [ %23, %16 ], [ %144, %123 ]
  %125 = add i64 %124, %5
  %126 = add nsw i64 %125, -1
  %127 = getelementptr inbounds i8, i8* %0, i64 %126
  %128 = load i8, i8* %127, align 1, !tbaa !1
  %129 = getelementptr inbounds i8, i8* %1, i64 %125
...
; <label>:160:                                    ; preds = %166, %142
  %161 = phi i64 [ 0, %142 ], [ %167, %166 ]
  %162 = mul nuw nsw i64 %161, 280
  br label %169

; <label>:163:                                    ; preds = %166
  %164 = call i32 @fclose(%struct._IO_FILE* %144)
  %165 = call i32 @fclose(%struct._IO_FILE* %145)
...
; <label>:166:                                    ; preds = %169
  ...
  %168 = icmp eq i64 %167, 223
  br i1 %168, label %163, label %160

; <label>:169:                                    ; preds = %169, %160
  %170 = phi i64 [ 0, %160 ], [ %180, %169 ]
  %171 = add nuw nsw i64 %170, %162
  %172 = getelementptr inbounds i8, i8* %7, i64 %171
  %173 = load i8, i8* %172, align 1, !tbaa !1
  %174 = zext i8 %173 to i32
  %175 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %144, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.11, i64 0, i64 0), i32 %174)
  %176 = getelementptr inbounds i8, i8* %8, i64 %171
  %177 = load i8, i8* %176, align 1, !tbaa !1
  %178 = zext i8 %177 to i32
  %179 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %145, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.11, i64 0, i64 0), i32 %178)
  %180 = add nuw nsw i64 %170, 1
  %181 = icmp eq i64 %180, 280
  br i1 %181, label %166, label %169
}
