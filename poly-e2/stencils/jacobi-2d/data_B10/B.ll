...
for.body3.us:                                     ; preds = %for.body3.us, %for.cond1.preheader.us
  ...
  %exitcond11 = icmp eq i64 %indvars.iv.next, %0
  br i1 %exitcond11, label %for.cond1.for.inc20_crit_edge.us, label %for.body3.us

for.cond1.for.inc20_crit_edge.us:                 ; preds = %for.body3.us
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %exitcond = icmp eq i64 %indvars.iv.next8, %1
...
for.cond1.preheader.lr.ph:                        ; preds = %entry
  ...
  %1 = add nsw i64 %0, -1
  %min.iters.check50 = icmp ult i64 %1, 4
  %n.vec53 = and i64 %1, -4
  %cmp.zero54 = icmp eq i64 %n.vec53, 0
  %ind.end75 = or i64 %n.vec53, 1
  %cmp.n76 = icmp eq i64 %1, %n.vec53
...
for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.cond4.for.inc37_crit_edge.us
  %indvar56 = phi i64 [ %indvar.next57, %for.cond4.for.inc37_crit_edge.us ], [ 0, %for.cond4.preheader.us.preheader ]
  ...
  %scevgep58 = getelementptr [1300 x double], [1300 x double]* %B, i64 %2, i64 1
  %scevgep60 = getelementptr [1300 x double], [1300 x double]* %B, i64 %2, i64 %0
  %scevgep62 = getelementptr [1300 x double], [1300 x double]* %A, i64 %indvar56, i64 1
  %3 = add i64 %indvar56, 2
  %scevgep64 = getelementptr [1300 x double], [1300 x double]* %A, i64 %3, i64 %0
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %4 = add nsw i64 %indvars.iv12, -1
  br i1 %min.iters.check50, label %for.body7.us.preheader, label %min.iters.checked51

min.iters.checked51:                              ; preds = %for.cond4.preheader.us
  br i1 %cmp.zero54, label %for.body7.us.preheader, label %vector.memcheck70
...
vector.memcheck70:                                ; preds = %min.iters.checked51
  ...
  br i1 %memcheck.conflict69, label %for.body7.us.preheader, label %vector.body47.preheader
...
vector.body47:                                    ; preds = %vector.body47.preheader, %vector.body47
  ...
  %5 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv12, i64 %offset.idx77
  ...
  %23 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv.next13, i64 %offset.idx77
  ...
  %29 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %4, i64 %offset.idx77
  ...
  %37 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv12, i64 %offset.idx77
  ...
  %41 = icmp eq i64 %index.next73, %n.vec53
  br i1 %41, label %middle.block48, label %vector.body47, !llvm.loop !6

middle.block48:                                   ; preds = %vector.body47
  br i1 %cmp.n76, label %for.cond4.for.inc37_crit_edge.us, label %for.body7.us.preheader

for.body7.us.preheader:                           ; preds = %middle.block48, %vector.memcheck70, %min.iters.checked51, %for.cond4.preheader.us
  %indvars.iv.ph = phi i64 [ 1, %vector.memcheck70 ], [ 1, %min.iters.checked51 ], [ 1, %for.cond4.preheader.us ], [ %ind.end75, %middle.block48 ]
...
for.body7.us:                                     ; preds = %for.body7.us.preheader, %for.body7.us
  ...
  %exitcond29 = icmp eq i64 %indvars.iv.next, %0
...
for.cond4.for.inc37_crit_edge.us:                 ; preds = %for.cond4.for.inc37_crit_edge.us.loopexit, %middle.block48
...
for.cond44.preheader.us:                          ; preds = %for.cond44.preheader.us.preheader, %for.cond44.for.inc84_crit_edge.us
  ...
  %scevgep31 = getelementptr [1300 x double], [1300 x double]* %A, i64 %48, i64 %0
  %scevgep33 = getelementptr [1300 x double], [1300 x double]* %B, i64 %indvar, i64 1
  %49 = add i64 %indvar, 2
  %scevgep35 = getelementptr [1300 x double], [1300 x double]* %B, i64 %49, i64 %0
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load38 = load <2 x double>, <2 x double>* %54, align 8, !alias.scope !10
  ...
  %wide.load40 = load <2 x double>, <2 x double>* %59, align 8, !alias.scope !10
  %60 = fadd <2 x double> %wide.load, %wide.load39
  %61 = fadd <2 x double> %wide.load38, %wide.load40
  %62 = add nuw nsw i64 %offset.idx, 1
  %63 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv22, i64 %62
  %64 = bitcast double* %63 to <2 x double>*
  %wide.load41 = load <2 x double>, <2 x double>* %64, align 8, !alias.scope !10
  %65 = getelementptr double, double* %63, i64 2
  %66 = bitcast double* %65 to <2 x double>*
  %wide.load42 = load <2 x double>, <2 x double>* %66, align 8, !alias.scope !10
  ...
  %wide.load43 = load <2 x double>, <2 x double>* %70, align 8, !alias.scope !10
  %71 = getelementptr double, double* %69, i64 2
  %72 = bitcast double* %71 to <2 x double>*
  %wide.load44 = load <2 x double>, <2 x double>* %72, align 8, !alias.scope !10
  ...
  %wide.load45 = load <2 x double>, <2 x double>* %76, align 8, !alias.scope !10
  %77 = getelementptr double, double* %75, i64 2
  %78 = bitcast double* %77 to <2 x double>*
  %wide.load46 = load <2 x double>, <2 x double>* %78, align 8, !alias.scope !10
...
for.body47.us:                                    ; preds = %for.body47.us.preheader, %for.body47.us
  ...
  %exitcond = icmp eq i64 %indvars.iv.next18, %0
