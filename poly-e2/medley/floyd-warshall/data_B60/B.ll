...
for.cond1.preheader:                              ; preds = %for.end37, %entry
  %indvars.iv4 = phi i64 [ 0, %entry ], [ %indvars.iv.next5, %for.end37 ]
...
for.cond4.preheader:                              ; preds = %for.end, %for.cond1.preheader
  %indvars.iv2 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next3, %for.end ]
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  br i1 %23, label %for.end.loopexit18, label %vector.body, !llvm.loop !9
...
for.body6:                                        ; preds = %for.body6, %for.body6.preheader
  ...
  br i1 %exitcond.1, label %for.end.loopexit, label %for.body6, !llvm.loop !12

for.end.loopexit:                                 ; preds = %for.body6
  br label %for.end

for.end.loopexit18:                               ; preds = %vector.body
  br label %for.end

for.end:                                          ; preds = %for.end.loopexit18, %for.end.loopexit
  %indvars.iv.next3 = add nuw nsw i64 %indvars.iv2, 1
  %exitcond16 = icmp eq i64 %indvars.iv.next3, 2800
  br i1 %exitcond16, label %for.end37, label %for.cond4.preheader
