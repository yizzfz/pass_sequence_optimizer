...
.lr.ph126.split.us.preheader:
  %sunkaddr = ptrtoint double* %3 to i64
  br label %.lr.ph126.split.us

.lr.ph126.split.us:                               ; preds = %._crit_edge.us, %.lr.ph126.split.us.preheader
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %._crit_edge.us ], [ 0, %.lr.ph126.split.us.preheader ]
...
; <label>:6:                                      ; preds = %6, %.lr.ph126.split.us
  %indvars.iv189 = phi i64 [ 0, %.lr.ph126.split.us ], [ %indvars.iv.next190.1.1, %6 ]
  %7 = phi double [ 0.000000e+00, %.lr.ph126.split.us ], [ %19, %6 ]
  ...
  %indvars.iv.next190.123 = or i64 %indvars.iv189, 3
  %17 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next190.123, i64 %indvars.iv16
...
._crit_edge.us:                                   ; preds = %6
  ...
  br i1 %exitcond18, label %.lr.ph120.split.us.preheader, label %.lr.ph126.split.us

.lr.ph120.split.us.preheader:                     ; preds = %._crit_edge.us
  %sunkaddr212 = ptrtoint double* %4 to i64
  br label %.lr.ph120.split.us

.lr.ph120.split.us:                               ; preds = %._crit_edge117.us, %.lr.ph120.split.us.preheader
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %._crit_edge117.us ], [ 0, %.lr.ph120.split.us.preheader ]
...
; <label>:22:                                     ; preds = %22, %.lr.ph120.split.us
  %indvars.iv183 = phi i64 [ 0, %.lr.ph120.split.us ], [ %indvars.iv.next184.1, %22 ]
  %23 = phi double [ 0.000000e+00, %.lr.ph120.split.us ], [ %35, %22 ]
  %24 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv183, i64 %indvars.iv13
  ...
  %30 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next184, i64 %indvars.iv13
  ...
  br i1 %exitcond185.1, label %._crit_edge117.us, label %22

._crit_edge117.us:                                ; preds = %22
  %36 = fdiv double %35, %0
  store double %36, double* %sunkaddr215, align 8
  %37 = tail call double @sqrt(double %36) #4
  %38 = fcmp ugt double %37, 1.000000e-01
  %. = select i1 %38, double %37, double 1.000000e+00
  store double %., double* %sunkaddr215, align 8
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 1200
  br i1 %exitcond15, label %._crit_edge90.._crit_edge92_crit_edge.us.preheader, label %.lr.ph120.split.us

._crit_edge90.._crit_edge92_crit_edge.us.preheader: ; preds = %._crit_edge117.us
  br label %._crit_edge90.._crit_edge92_crit_edge.us

._crit_edge90.._crit_edge92_crit_edge.us:         ; preds = %._crit_edge90.us, %._crit_edge90.._crit_edge92_crit_edge.us.preheader
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %._crit_edge90.us ], [ 0, %._crit_edge90.._crit_edge92_crit_edge.us.preheader ]
...
._crit_edge92.us:                                 ; preds = %._crit_edge92.us, %._crit_edge90.._crit_edge92_crit_edge.us
  ...
  %39 = getelementptr inbounds double, double* %3, i64 %indvars.iv179
  %40 = load double, double* %39, align 8
  %41 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv10, i64 %indvars.iv179
  %42 = load double, double* %41, align 8
  %43 = fsub double %42, %40
  store double %43, double* %41, align 8
  %44 = tail call double @sqrt(double %0) #4
  %45 = getelementptr inbounds double, double* %4, i64 %indvars.iv179
  ...
  br i1 %exitcond181, label %._crit_edge90.us, label %._crit_edge92.us

._crit_edge90.us:                                 ; preds = %._crit_edge92.us
...
.lr.ph.us.us.preheader:                           ; preds = %.lr.ph.us.us.preheader.preheader, %._crit_edge93.us
  ...
  %50 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv8, i64 %indvars.iv8
...
.lr.ph.us.us:                                     ; preds = %._crit_edge102.us.us, %.lr.ph.us.us.preheader
  ...
  %51 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv8, i64 %indvars.iv5
  store double 0.000000e+00, double* %51, align 8
  br label %53

._crit_edge102.us.us:                             ; preds = %53
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv5, i64 %indvars.iv8
...
; <label>:53:                                     ; preds = %53, %.lr.ph.us.us
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %53 ]
  %54 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %66, %53 ]
  %55 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv8
  ...
  %indvars.iv.next = or i64 %indvars.iv, 1
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv8
  ...
  br i1 %exitcond.1, label %._crit_edge102.us.us, label %53
