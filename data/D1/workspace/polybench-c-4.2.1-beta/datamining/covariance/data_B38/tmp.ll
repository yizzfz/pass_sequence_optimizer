...
.lr.ph80.split.us.preheader:
  ...
  %sunkaddr145 = ptrtoint double* %5 to i64
...
.lr.ph80.split.us:                                ; preds = %._crit_edge77.us, %.lr.ph80.split.us.preheader
  ...
  %6 = getelementptr inbounds double, double* %5, i64 %indvars.iv110
  store double 0.000000e+00, double* %6, align 8
  %sunkaddr122 = shl i64 %indvars.iv110, 3
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph80.split.us
  %7 = phi double [ 0.000000e+00, %.lr.ph80.split.us ], [ %19, %._crit_edge ]
  %indvars.iv107 = phi i64 [ 0, %.lr.ph80.split.us ], [ %indvars.iv.next108.3, %._crit_edge ]
  %8 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv107, i64 %indvars.iv110
  %9 = load double, double* %8, align 8
  %10 = fadd double %9, %7
  store double %10, double* %sunkaddr124, align 8
  %indvars.iv.next108 = or i64 %indvars.iv107, 1
  %11 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next108, i64 %indvars.iv110
  %12 = load double, double* %11, align 8
  %13 = fadd double %12, %10
  store double %13, double* %sunkaddr124, align 8
  %indvars.iv.next108.1 = or i64 %indvars.iv107, 2
  %14 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next108.1, i64 %indvars.iv110
  %15 = load double, double* %14, align 8
  %16 = fadd double %15, %13
  store double %16, double* %sunkaddr124, align 8
  %indvars.iv.next108.2 = or i64 %indvars.iv107, 3
  %17 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next108.2, i64 %indvars.iv110
  %18 = load double, double* %17, align 8
  %19 = fadd double %18, %16
  store double %19, double* %sunkaddr124, align 8
  %indvars.iv.next108.3 = add nuw nsw i64 %indvars.iv107, 4
  %exitcond109.3 = icmp eq i64 %indvars.iv.next108.3, 1400
  br i1 %exitcond109.3, label %._crit_edge77.us, label %._crit_edge

._crit_edge77.us:                                 ; preds = %._crit_edge
  %20 = fdiv double %19, %2
  %sunkaddr146 = shl i64 %indvars.iv110, 3
  %sunkaddr147 = add i64 %sunkaddr145, %sunkaddr146
  %sunkaddr148 = inttoptr i64 %sunkaddr147 to double*
  store double %20, double* %sunkaddr148, align 8
...
._crit_edge77.us..preheader56.us_crit_edge:       ; preds = %._crit_edge77.us
  %scevgep133 = getelementptr double, double* %5, i64 1200
  br label %.preheader56.us

.preheader56.us:                                  ; preds = %._crit_edge72.us, %._crit_edge77.us..preheader56.us_crit_edge
  %indvars.iv103 = phi i64 [ 0, %._crit_edge77.us..preheader56.us_crit_edge ], [ %21, %._crit_edge72.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %3, i64 %indvars.iv103, i64 0
  %21 = add i64 %indvars.iv103, 1
  %scevgep131 = getelementptr [1200 x double], [1200 x double]* %3, i64 %21, i64 0
  %bound0 = icmp ult double* %scevgep, %scevgep133
  %bound1 = icmp ugt double* %scevgep131, %5
  %memcheck.conflict = and i1 %bound0, %bound1
  br i1 %memcheck.conflict, label %._crit_edge118.preheader, label %vector.body.preheader

vector.body.preheader:                            ; preds = %.preheader56.us
  br label %vector.body

._crit_edge118.preheader:                         ; preds = %.preheader56.us
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %24 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv103, i64 %offset.idx
  %25 = bitcast double* %24 to <8 x double>*
  %wide.vec138 = load <8 x double>, <8 x double>* %25, align 8, !alias.scope !4, !noalias !1
  %26 = fsub <8 x double> %wide.vec138, %wide.vec
  ...
  %31 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv103, i64 %30
  ...
  br i1 %37, label %._crit_edge72.us.loopexit149, label %vector.body, !llvm.loop !6

._crit_edge118:                                   ; preds = %._crit_edge118.preheader, %._crit_edge118
  %indvars.iv100 = phi i64 [ %indvars.iv.next101.3, %._crit_edge118 ], [ 0, %._crit_edge118.preheader ]
  %38 = getelementptr inbounds double, double* %5, i64 %indvars.iv100
  %39 = load double, double* %38, align 8
  %40 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv103, i64 %indvars.iv100
  %41 = load double, double* %40, align 8
  %42 = fsub double %41, %39
  store double %42, double* %40, align 8
  %indvars.iv.next101 = or i64 %indvars.iv100, 1
  %43 = getelementptr inbounds double, double* %5, i64 %indvars.iv.next101
  %44 = load double, double* %43, align 8
  %45 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv103, i64 %indvars.iv.next101
  %46 = load double, double* %45, align 8
  %47 = fsub double %46, %44
  store double %47, double* %45, align 8
  %indvars.iv.next101.1 = or i64 %indvars.iv100, 2
  %48 = getelementptr inbounds double, double* %5, i64 %indvars.iv.next101.1
  %49 = load double, double* %48, align 8
  %50 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv103, i64 %indvars.iv.next101.1
  %51 = load double, double* %50, align 8
  %52 = fsub double %51, %49
  store double %52, double* %50, align 8
  %indvars.iv.next101.2 = or i64 %indvars.iv100, 3
  %53 = getelementptr inbounds double, double* %5, i64 %indvars.iv.next101.2
  %54 = load double, double* %53, align 8
  %55 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv103, i64 %indvars.iv.next101.2
  ...
  br i1 %exitcond102.3, label %._crit_edge72.us.loopexit, label %._crit_edge118, !llvm.loop !9

._crit_edge72.us.loopexit:                        ; preds = %._crit_edge118
  br label %._crit_edge72.us

._crit_edge72.us.loopexit149:                     ; preds = %vector.body
  br label %._crit_edge72.us

._crit_edge72.us:                                 ; preds = %._crit_edge72.us.loopexit149, %._crit_edge72.us.loopexit
  %exitcond105 = icmp eq i64 %21, 1400
...
.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph60.us
  ...
  %59 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv89, i64 %indvars.iv86
  store double 0.000000e+00, double* %59, align 8
  br label %._crit_edge119

._crit_edge.us.us:                                ; preds = %._crit_edge119
  %60 = fdiv double %74, %58
  store double %60, double* %59, align 8
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv86, i64 %indvars.iv89
...
._crit_edge119:                                   ; preds = %._crit_edge119, %.lr.ph.us.us
  %62 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %74, %._crit_edge119 ]
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %._crit_edge119 ]
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv, i64 %indvars.iv89
  %64 = load double, double* %63, align 8
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv, i64 %indvars.iv86
  %66 = load double, double* %65, align 8
  %67 = fmul double %64, %66
  %68 = fadd double %62, %67
  store double %68, double* %59, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %69 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next, i64 %indvars.iv89
  %70 = load double, double* %69, align 8
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next, i64 %indvars.iv86
  ...
  br i1 %exitcond.1, label %._crit_edge.us.us, label %._crit_edge119
