...
; <label>:4:                                      ; preds = %4, %.preheader.us
  ...
  br i1 %exitcond7.1, label %._crit_edge.us, label %4
...
.lver.check:                                      ; preds = %._crit_edge9.us, %.lr.ph11.split.us.preheader
  %indvar = phi i64 [ 0, %.lr.ph11.split.us.preheader ], [ %6, %._crit_edge9.us ]
...
.ph.lver.orig:                                    ; preds = %.ph.lver.orig.preheader, %.ph.lver.orig
  ...
  br i1 %exitcond38.lver.orig, label %.lr.ph8.us.preheader.loopexit, label %.ph.lver.orig
...
.lr.ph8.us:                                       ; preds = %.lr.ph8.us, %.lr.ph8.us.preheader
  ...
  %37 = phi double [ 1.000000e+00, %.lr.ph8.us.preheader ], [ %50, %.lr.ph8.us ]
...
; <label>:53:                                     ; preds = %53, %.ph
  %store_forwarded51 = phi double [ %load_initial50, %.ph ], [ %70, %53 ]
  ...
  br i1 %exitcond38, label %.lr.ph8.us.preheader.loopexit75, label %53
...
.lver.check66:                                    ; preds = %.lver.check66.preheader, %._crit_edge19.us
  %indvar52 = phi i64 [ %73, %._crit_edge19.us ], [ 0, %.lver.check66.preheader ]
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %._crit_edge19.us ], [ 1, %.lver.check66.preheader ]
...
.ph67.lver.orig:                                  ; preds = %.ph67.lver.orig.preheader, %.ph67.lver.orig
  %indvars.iv30.lver.orig = phi i64 [ %indvars.iv.next31.lver.orig, %.ph67.lver.orig ], [ 1, %.ph67.lver.orig.preheader ]
  ...
  br i1 %exitcond.lver.orig, label %.lr.ph18.us.preheader.loopexit, label %.ph67.lver.orig
...
; <label>:126:                                    ; preds = %126, %.ph67
  %store_forwarded73 = phi double [ %load_initial72, %.ph67 ], [ %148, %126 ]
  %store_forwarded70 = phi double [ %load_initial69, %.ph67 ], [ %137, %126 ]
  %indvars.iv30 = phi i64 [ 1, %.ph67 ], [ %indvars.iv.next31, %126 ]
  ...
  br i1 %exitcond, label %.lr.ph18.us.preheader.loopexit74, label %126
