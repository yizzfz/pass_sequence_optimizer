...
for.cond1.preheader:                              ; preds = %for.inc113, %entry
  ...
  %arrayidx = getelementptr inbounds double, double* %_fict_, i64 %indvars.iv49
...
for.cond10.preheader.us:                          ; preds = %for.cond10.preheader.us.preheader, %for.cond10.for.inc34_crit_edge.us
  ...
  %scevgep72 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %1, i64 0
  %scevgep75 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %1, i64 1200
  %scevgep78 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvar, i64 0
  %scevgep81 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %1, i64 1200
  ...
  br i1 %memcheck.conflict86, label %for.body12.us.preheader, label %vector.body62.preheader
...
vector.body62:                                    ; preds = %vector.body62.preheader, %vector.body62
  ...
  %3 = shl i64 %index89, 1
  %4 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv25, i64 %3
  %5 = bitcast double* %4 to <4 x double>*
  %wide.vec98 = load <4 x double>, <4 x double>* %5, align 8, !alias.scope !3, !noalias !6
  ...
  %6 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv25, i64 %3
  %7 = bitcast double* %6 to <4 x double>*
  %wide.vec101 = load <4 x double>, <4 x double>* %7, align 8, !alias.scope !6
  %8 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %2, i64 %3
  %9 = bitcast double* %8 to <4 x double>*
  %wide.vec104 = load <4 x double>, <4 x double>* %9, align 8, !alias.scope !6
  %10 = fsub <4 x double> %wide.vec101, %wide.vec104
  ...
  %13 = fsub <2 x double> %strided.vec99, %12
  %14 = or i64 %3, 1
  %15 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv25, i64 %14
  %16 = fsub <4 x double> %wide.vec101, %wide.vec104
  %17 = shufflevector <4 x double> %16, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %18 = fmul <2 x double> %17, <double 5.000000e-01, double 5.000000e-01>
  %19 = fsub <2 x double> %strided.vec100, %18
  %20 = getelementptr double, double* %15, i64 -1
  %21 = bitcast double* %20 to <4 x double>*
  %interleaved.vec107 = shufflevector <2 x double> %13, <2 x double> %19, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec107, <4 x double>* %21, align 8, !alias.scope !3, !noalias !6
  %index.next90 = add nuw nsw i64 %index89, 2
  %22 = icmp eq i64 %index.next90, 600
  br i1 %22, label %middle.block63, label %vector.body62, !llvm.loop !8

middle.block63:                                   ; preds = %vector.body62
  br i1 true, label %for.cond10.for.inc34_crit_edge.us, label %for.body12.us.preheader

for.body12.us.preheader:                          ; preds = %middle.block63, %for.cond10.preheader.us
  %indvars.iv21.ph = phi i64 [ 0, %for.cond10.preheader.us ], [ 1200, %middle.block63 ]
  br label %for.body12.us

for.body12.us:                                    ; preds = %for.body12.us.preheader, %for.body12.us
  %indvars.iv21 = phi i64 [ %indvars.iv.next22.1, %for.body12.us ], [ %indvars.iv21.ph, %for.body12.us.preheader ]
  ...
  %24 = load double, double* %arrayidx20.us, align 8
  %arrayidx24.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %2, i64 %indvars.iv21
  %25 = load double, double* %arrayidx24.us, align 8
  %sub25.us = fsub double %24, %25
  %mul.us = fmul double %sub25.us, 5.000000e-01
  %sub26.us = fsub double %23, %mul.us
  ...
  %26 = load double, double* %arrayidx16.us.1, align 8
  %arrayidx20.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv25, i64 %indvars.iv.next22
  %27 = load double, double* %arrayidx20.us.1, align 8
  %arrayidx24.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %2, i64 %indvars.iv.next22
  %28 = load double, double* %arrayidx24.us.1, align 8
  %sub25.us.1 = fsub double %27, %28
  %mul.us.1 = fmul double %sub25.us.1, 5.000000e-01
  %sub26.us.1 = fsub double %26, %mul.us.1
...
for.body3:                                        ; preds = %for.cond1.preheader, %for.body3
  ...
  %30 = bitcast double* %arrayidx6 to i64*
  ...
  %32 = bitcast double* %arrayidx6.1 to i64*
  ...
  %34 = bitcast double* %arrayidx6.2 to i64*
  ...
  %36 = bitcast double* %arrayidx6.3 to i64*
  ...
  %38 = bitcast double* %arrayidx6.4 to i64*
  ...
  %40 = bitcast double* %arrayidx6.5 to i64*
  ...
  %42 = bitcast double* %arrayidx6.6 to i64*
  ...
  %44 = bitcast double* %arrayidx6.7 to i64*
...
for.cond40.preheader.us:                          ; preds = %for.cond40.preheader.us.preheader, %for.cond40.for.inc66_crit_edge.us
  ...
  %scevgep31 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv36, i64 2
  %scevgep34 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv36, i64 1200
  %scevgep37 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv36, i64 1
  %scevgep40 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv36, i64 1200
  ...
  br i1 %memcheck.conflict45, label %for.body42.us.preheader, label %vector.body25.preheader
...
vector.body25:                                    ; preds = %vector.body25.preheader, %vector.body25
  ...
  %48 = shl i64 %index48, 1
  %offset.idx = or i64 %48, 2
  %49 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv36, i64 %offset.idx
  ...
  %51 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv36, i64 %offset.idx
  %52 = getelementptr double, double* %51, i64 -1
  %53 = bitcast double* %52 to <4 x double>*
  %wide.vec56 = load <4 x double>, <4 x double>* %53, align 8, !alias.scope !15
  ...
  %54 = fsub <2 x double> %strided.vec58, %strided.vec57
  %55 = fmul <2 x double> %54, <double 5.000000e-01, double 5.000000e-01>
  %56 = fsub <2 x double> %strided.vec, %55
  %57 = or i64 %48, 3
  %58 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv36, i64 %57
  %59 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv36, i64 %57
  %60 = getelementptr double, double* %59, i64 -1
  %61 = bitcast double* %60 to <4 x double>*
  %wide.vec59 = load <4 x double>, <4 x double>* %61, align 8, !alias.scope !15
  ...
  %62 = fsub <2 x double> %strided.vec61, %strided.vec60
  %63 = fmul <2 x double> %62, <double 5.000000e-01, double 5.000000e-01>
  %64 = fsub <2 x double> %strided.vec55, %63
  ...
  %67 = icmp eq i64 %index.next49, 598
  br i1 %67, label %middle.block26, label %vector.body25, !llvm.loop !17

middle.block26:                                   ; preds = %vector.body25
  br i1 false, label %for.cond40.for.inc66_crit_edge.us, label %for.body42.us.preheader

for.body42.us.preheader:                          ; preds = %middle.block26, %for.cond40.preheader.us
  %indvars.iv31.ph = phi i64 [ 2, %for.cond40.preheader.us ], [ 1198, %middle.block26 ]
...
for.body42.us:                                    ; preds = %for.body42.us.preheader, %for.body42.us
  ...
  %arrayidx55.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv36, i64 %70
  ...
  br i1 %exitcond35.1, label %for.cond40.for.inc66_crit_edge.us.loopexit, label %for.body42.us, !llvm.loop !18

for.cond40.for.inc66_crit_edge.us.loopexit:       ; preds = %for.body42.us
  br label %for.cond40.for.inc66_crit_edge.us

for.cond40.for.inc66_crit_edge.us:                ; preds = %for.cond40.for.inc66_crit_edge.us.loopexit, %middle.block26
...
for.cond73.preheader.us:                          ; preds = %for.cond73.preheader.us.preheader, %for.cond73.for.inc110_crit_edge.us
  ...
  %scevgep2 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv45, i64 1199
  %scevgep4 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv45, i64 0
  %75 = add nuw nsw i64 %indvars.iv45, 1
  %scevgep6 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %75, i64 0
  %scevgep8 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %indvars.iv45, i64 0
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %76 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv45, i64 %index
  ...
  %80 = or i64 %index, 1
  %81 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv45, i64 %80
  ...
  %85 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv45, i64 %index
  ...
  %91 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv.next46, i64 %index
  ...
  %97 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv45, i64 %index
