...
for.body:                                         ; preds = %for.end44, %entry
  ...
  %alpha.027 = phi double [ %sub3, %entry ], [ %div, %for.end44 ]
  %beta.026 = phi double [ 1.000000e+00, %entry ], [ %mul5, %for.end44 ]
  %indvars.iv1925 = phi i64 [ 1, %entry ], [ %indvars.iv.next20, %for.end44 ]
  %6 = add i64 %indvar, -1
  %7 = add i64 %indvar, 1
  %8 = shl i64 %indvar, 3
...
for.body8.prol:                                   ; preds = %for.body8.prol.preheader, %for.body8.prol
  %sum.022.prol = phi double [ %add.prol, %for.body8.prol ], [ 0.000000e+00, %for.body8.prol.preheader ]
  %indvars.iv21.prol = phi i64 [ %indvars.iv.next.prol, %for.body8.prol ], [ 0, %for.body8.prol.preheader ]
...
for.body8.prol.loopexit:                          ; preds = %for.body8.prol.loopexit.loopexit, %for.body
  ...
  %sum.022.unr = phi double [ 0.000000e+00, %for.body ], [ %add.prol, %for.body8.prol.loopexit.loopexit ]
  %indvars.iv21.unr = phi i64 [ 0, %for.body ], [ %indvars.iv.next.prol, %for.body8.prol.loopexit.loopexit ]
...
for.body8:                                        ; preds = %for.body8.preheader, %for.body8
  %sum.022 = phi double [ %add.3, %for.body8 ], [ %sum.022.unr, %for.body8.preheader ]
  %indvars.iv21 = phi i64 [ %indvars.iv.next.3, %for.body8 ], [ %indvars.iv21.unr, %for.body8.preheader ]
