...
for.body8.us:                                     ; preds = %for.body8.us, %for.cond5.preheader.us
  ...
  br i1 %exitcond, label %for.body8.us, label %for.cond5.for.inc39_crit_edge.us

for.cond5.for.inc39_crit_edge.us:                 ; preds = %for.body8.us
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  %exitcond1 = icmp ne i64 %indvars.iv.next18, 1000
  br i1 %exitcond1, label %for.cond5.preheader.us, label %for.end41

for.body:                                         ; preds = %for.body, %entry
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.body ], [ 0, %entry ]
...
for.body3:                                        ; preds = %for.body3, %for.cond1.preheader
  ...
  %sunkaddr94 = mul i64 %indvars.iv73, 8
  ...
  %sunkaddr98 = mul i64 %indvars.iv73, 8
  ...
  %sunkaddr102 = mul i64 %indvars.iv73, 8
  ...
  %sunkaddr106 = mul i64 %indvars.iv73, 8
  ...
  %sunkaddr110 = mul i64 %indvars.iv73, 8
...
for.cond40.preheader.us:                          ; preds = %for.cond40.preheader.us.preheader, %for.cond40.for.inc66_crit_edge.us
  ...
  %38 = add nuw nsw i64 %indvars.iv64, 1
...
for.cond73.preheader.us:                          ; preds = %for.cond73.preheader.us.preheader, %for.cond73.for.inc110_crit_edge.us
  ...
  %70 = add nuw nsw i64 %indvars.iv69, 1
...
for.inc113:                                       ; preds = %for.cond73.for.inc110_crit_edge.us
  ...
  %exitcond93 = icmp ne i64 %indvars.iv.next74, 500
...
for.cond2.preheader.us:                           ; preds = %for.cond2.for.inc10_crit_edge.us, %entry
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.cond2.for.inc10_crit_edge.us ], [ 0, %entry ]
  %3 = mul nuw nsw i64 %indvars.iv63, 1000
  br label %for.body4.us

for.body4.us:                                     ; preds = %if.end.us, %for.cond2.preheader.us
  %indvars.iv58 = phi i64 [ 0, %for.cond2.preheader.us ], [ %indvars.iv.next59, %if.end.us ]
  %4 = add nuw nsw i64 %3, %indvars.iv58
...
for.cond2.for.inc10_crit_edge.us:                 ; preds = %if.end.us
  ...
  %exitcond3 = icmp ne i64 %indvars.iv.next64, 1000
  br i1 %exitcond3, label %for.cond2.preheader.us, label %for.cond.for.end12_crit_edge
...
for.cond19.preheader.us:                          ; preds = %for.cond19.for.inc37_crit_edge.us, %for.cond.for.end12_crit_edge
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.cond19.for.inc37_crit_edge.us ], [ 0, %for.cond.for.end12_crit_edge ]
  %13 = mul nuw nsw i64 %indvars.iv53, 1000
...
for.body21.us:                                    ; preds = %if.end28.us, %for.cond19.preheader.us
  ...
  %14 = add nuw nsw i64 %13, %indvars.iv48
  %15 = trunc i64 %14 to i32
...
for.cond19.for.inc37_crit_edge.us:                ; preds = %if.end28.us
  ...
  %exitcond2 = icmp ne i64 %indvars.iv.next54, 1000
...
for.cond45.preheader.us:                          ; preds = %for.cond45.for.inc63_crit_edge.us, %for.end39
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.cond45.for.inc63_crit_edge.us ], [ 0, %for.end39 ]
  %21 = mul nuw nsw i64 %indvars.iv45, 1000
...
for.cond45.for.inc63_crit_edge.us:                ; preds = %if.end54.us
  ...
  %exitcond1 = icmp ne i64 %indvars.iv.next46, 1000
