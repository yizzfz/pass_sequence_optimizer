...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.ph
  ...
  %vec.ind4 = phi <2 x i32> [ <i32 0, i32 1>, %vector.ph ], [ %vec.ind.next5, %vector.body.vector.body_crit_edge ]
  ...
  br i1 %16, label %middle.block, label %vector.body.vector.body_crit_edge, !llvm.loop !6
...
scalar.ph.preheader:                              ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.lr.ph
  %indvars.iv.ph = phi i64 [ %n.vec, %middle.block ], [ 0, %vector.memcheck ], [ 0, %min.iters.checked ], [ 0, %.lr.ph ]
...
._crit_edge.us:                                   ; preds = %._crit_edge5.us, %._crit_edge.us.preheader
  %18 = phi i32 [ 0, %._crit_edge.us.preheader ], [ %44, %._crit_edge5.us ]
...
scalar.ph49.preheader:                            ; preds = %middle.block48, %vector.memcheck68, %min.iters.checked52, %._crit_edge.us
  %indvars.iv.ph = phi i64 [ %ind.end73, %middle.block48 ], [ 1, %vector.memcheck68 ], [ 1, %min.iters.checked52 ], [ 1, %._crit_edge.us ]
...
._crit_edge5.us:                                  ; preds = %._crit_edge5.us.loopexit, %middle.block
  ...
  br i1 %45, label %._crit_edge.us, label %._crit_edge.loopexit

.lr.ph4.us:                                       ; preds = %.lr.ph4.us.preheader87, %.lr.ph4.us
  %indvars.iv25 = phi i64 [ %52, %.lr.ph4.us ], [ %indvars.iv25.ph, %.lr.ph4.us.preheader87 ]
  ...
  br i1 %58, label %.lr.ph4.us, label %._crit_edge5.us.loopexit, !llvm.loop !16
...
scalar.ph49:                                      ; preds = %scalar.ph49.preheader, %scalar.ph49
  ...
  br i1 %71, label %scalar.ph49, label %.lr.ph4.us.preheader.loopexit, !llvm.loop !17
...
.lr.ph4.us.preheader87:                           ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.lr.ph4.us.preheader
  %indvars.iv25.ph = phi i64 [ %ind.end, %middle.block ], [ 1, %vector.memcheck ], [ 1, %min.iters.checked ], [ 1, %.lr.ph4.us.preheader ]
  br label %.lr.ph4.us
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load42 = load <2 x double>, <2 x double>* %76, align 8, !alias.scope !18
  %77 = getelementptr inbounds double, double* %3, i64 %offset.idx
  %78 = bitcast double* %77 to <2 x double>*
  %wide.load43 = load <2 x double>, <2 x double>* %78, align 8, !alias.scope !18
  %79 = getelementptr double, double* %77, i64 2
  %80 = bitcast double* %79 to <2 x double>*
  %wide.load44 = load <2 x double>, <2 x double>* %80, align 8, !alias.scope !18
  ...
  %wide.load45 = load <2 x double>, <2 x double>* %85, align 8, !alias.scope !18
  %86 = getelementptr double, double* %84, i64 2
  %87 = bitcast double* %86 to <2 x double>*
  %wide.load46 = load <2 x double>, <2 x double>* %87, align 8, !alias.scope !18
...
middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %._crit_edge5.us, label %.lr.ph4.us.preheader87
...
._crit_edge:                                      ; preds = %._crit_edge._crit_edge, %12
  ...
  br i1 %18, label %._crit_edge._crit_edge, label %._crit_edge3.loopexit
