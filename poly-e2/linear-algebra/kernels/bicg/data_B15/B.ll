...
entry:
  ...
  tail call void @kernel_bicg([1900 x double]* %arraydecay, double* %arraydecay8, double* %arraydecay9, double* %arraydecay6, double* %arraydecay5)
...
for.body5.us:                                     ; preds = %for.body5.us.preheader, %for.cond12.for.inc27_crit_edge.us
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.cond12.for.inc27_crit_edge.us ], [ 0, %for.body5.us.preheader ]
  %0 = trunc i64 %indvars.iv9 to i32
  %conv7.us = sitofp i32 %0 to double
  %div9.us = fdiv double %conv7.us, 2.100000e+03
  %arrayidx11.us = getelementptr inbounds double, double* %r, i64 %indvars.iv9
...
for.inc24.us:                                     ; preds = %for.inc24.us, %for.body5.us
  ...
  %1 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv9
  %2 = trunc i64 %1 to i32
  %rem16.us = srem i32 %2, 2100
  %conv17.us = sitofp i32 %rem16.us to double
  %arrayidx23.us = getelementptr inbounds [1900 x double], [1900 x double]* %A, i64 %indvars.iv9, i64 %indvars.iv
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %3 = mul nuw nsw i64 %indvars.iv.next.1, %indvars.iv9
...
for.cond12.for.inc27_crit_edge.us:                ; preds = %for.inc24.us
  ...
  %exitcond = icmp eq i64 %indvars.iv.next10, 2100
  br i1 %exitcond, label %for.end29, label %for.body5.us

for.inc:                                          ; preds = %for.inc, %for.inc.lr.ph
  %indvars.iv11 = phi i64 [ 0, %for.inc.lr.ph ], [ %indvars.iv.next12.1.1, %for.inc ]
  %6 = trunc i64 %indvars.iv11 to i32
  %conv = sitofp i32 %6 to double
  %arrayidx = getelementptr inbounds double, double* %p, i64 %indvars.iv11
  ...
  %10 = trunc i64 %indvars.iv.next12.1 to i32
  %conv.114 = sitofp i32 %10 to double
  %arrayidx.1 = getelementptr inbounds double, double* %p, i64 %indvars.iv.next12.1
  %11 = trunc i64 %indvars.iv.next12.1 to i32
  %12 = or i32 %11, 1
  %conv.1.1 = sitofp i32 %12 to double
  %div.v.i0.1.1 = insertelement <2 x double> undef, double %conv.114, i32 0
  ...
  %exitcond13.1.1 = icmp eq i64 %indvars.iv.next12.1.1, 1900
  br i1 %exitcond13.1.1, label %for.body5.us.preheader, label %for.inc
...
for.body3.us.preheader:
  %s14 = bitcast double* %s to i8*
  call void @llvm.memset.p0i8.i64(i8* %s14, i8 0, i64 15200, i32 8, i1 false)
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.cond6.for.inc34_crit_edge.us, %for.body3.us.preheader
  %indvars.iv7 = phi i64 [ 0, %for.body3.us.preheader ], [ %indvars.iv.next8, %for.cond6.for.inc34_crit_edge.us ]
  %arrayidx5.us = getelementptr inbounds double, double* %q, i64 %indvars.iv7
...
for.inc31.us:                                     ; preds = %for.inc31.us, %for.body3.us
  ...
  %sunkaddr22 = mul i64 %indvars.iv7, 8
  %sunkaddr23 = add i64 %sunkaddr, %sunkaddr22
  %sunkaddr24 = inttoptr i64 %sunkaddr23 to double*
  %1 = load double, double* %sunkaddr24, align 8
  %arrayidx16.us = getelementptr inbounds [1900 x double], [1900 x double]* %A, i64 %indvars.iv7, i64 %indvars.iv
  ...
  %sunkaddr25 = ptrtoint double* %q to i64
  %sunkaddr26 = mul i64 %indvars.iv7, 8
  %sunkaddr27 = add i64 %sunkaddr25, %sunkaddr26
  %sunkaddr28 = inttoptr i64 %sunkaddr27 to double*
  %3 = load double, double* %sunkaddr28, align 8
  ...
  store double %add28.us, double* %sunkaddr28, align 8
...
for.cond6.for.inc34_crit_edge.us:                 ; preds = %for.inc31.us
  ...
  %exitcond9 = icmp eq i64 %indvars.iv.next8, 2100
  br i1 %exitcond9, label %for.end36, label %for.body3.us
...
for.body:                                         ; preds = %for.inc, %for.body.preheader
  %indvars.iv8 = phi i64 [ 0, %for.body.preheader ], [ %indvars.iv.next9, %for.inc ]
...
for.inc:                                          ; preds = %for.body, %if.then
  ...
  %exitcond10 = icmp eq i64 %indvars.iv.next9, 1900
  br i1 %exitcond10, label %for.body9.preheader, label %for.body
