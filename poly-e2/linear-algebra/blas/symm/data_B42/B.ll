...
for.inc36.lr.ph:                                  ; preds = %for.inc36.lr.ph.preheader, %for.inc51
  %indvars.iv67 = phi i3 [ %indvars.iv.next68, %for.inc51 ], [ -1, %for.inc36.lr.ph.preheader ]
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.inc51 ], [ 2, %for.inc36.lr.ph.preheader ]
  ...
  %5 = zext i3 %indvars.iv67 to i64
  %6 = add nuw nsw i64 %5, 4294967295
  %7 = and i64 %6, 4294967295
  %8 = add i64 %indvars.iv65, %7
  %9 = sub nuw nsw i64 999, %indvars.iv53
  %10 = sub nsw i64 998, %indvars.iv53
...
for.inc48.prol.loopexit:                          ; preds = %for.inc48.prol.loopexit.loopexit, %for.inc48.lr.ph
  %indvars.iv45.unr = phi i64 [ %indvars.iv51, %for.inc48.lr.ph ], [ %8, %for.inc48.prol.loopexit.loopexit ]
...
for.inc48.preheader:                              ; preds = %for.inc48.prol.loopexit
  %16 = sub i64 992, %indvars.iv45.unr
  %17 = lshr i64 %16, 3
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %23 = shl i64 %index, 3
  %24 = add i64 %indvars.iv45.unr, %23
  %25 = add nsw i64 %24, 7
  %26 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv53, i64 %25
...
for.inc36:                                        ; preds = %for.inc36.preheader, %for.inc36
  ...
  %30 = add nuw nsw i64 %indvars.iv, %indvars.iv53
  ...
  %32 = add nuw nsw i64 %indvars.iv.next, %indvars.iv53
  %33 = trunc i64 %32 to i32
  %rem28.1 = srem i32 %33, 100
  %conv29.1 = sitofp i32 %rem28.1 to double
  %div31.1 = fdiv double %conv29.1, 1.000000e+03
  %arrayidx35.1 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv53, i64 %indvars.iv.next
...
for.inc48:                                        ; preds = %for.inc48.preheader69, %for.inc48
  %indvars.iv45 = phi i64 [ %indvars.iv.next46.7, %for.inc48 ], [ %indvars.iv45.ph, %for.inc48.preheader69 ]
...
for.inc51:                                        ; preds = %for.inc51.loopexit, %middle.block, %for.inc48.prol.loopexit, %for.cond40.preheader
  ...
  %indvars.iv.next68 = add i3 %indvars.iv67, -1
...
for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.cond4.for.inc50_crit_edge.us
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.cond4.for.inc50_crit_edge.us ], [ 0, %for.cond4.preheader.us.preheader ]
...
for.inc.us:                                       ; preds = %for.inc.us, %for.cond4.preheader.us
  %indvars.iv41 = phi i64 [ 0, %for.cond4.preheader.us ], [ %indvars.iv.next42, %for.inc.us ]
  ...
  br i1 %exitcond45, label %for.cond4.for.inc50_crit_edge.us, label %for.inc.us
