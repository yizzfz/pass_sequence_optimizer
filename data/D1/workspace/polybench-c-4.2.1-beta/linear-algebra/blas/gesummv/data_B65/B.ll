...
; <label>:8:                                      ; preds = %25, %7
  ...
  %sunkaddr7 = add i64 %sunkaddr21, %sunkaddr6
...
; <label>:25:                                     ; preds = %11
  %26 = load double, double* %sunkaddr8, align 8
  %27 = fmul double %26, %0
  %28 = fmul double %24, %1
  %29 = fadd double %27, %28
  store double %29, double* %sunkaddr16, align 8
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv3, 1
  %exitcond5 = icmp eq i64 %indvars.iv.next4, 1300
  br i1 %exitcond5, label %30, label %8
