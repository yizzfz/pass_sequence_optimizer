...
.lr.ph14.new:                                     ; preds = %.lr.ph14.new..lr.ph14.new_crit_edge, %.lr.ph14
  %indvars.iv412 = phi i64 [ 0, %.lr.ph14 ], [ %indvars.iv.next5.1, %.lr.ph14.new..lr.ph14.new_crit_edge ]
  ...
  br i1 %exitcond19.1, label %.lr.ph10.split.us.preheader, label %.lr.ph14.new..lr.ph14.new_crit_edge

.lr.ph14.new..lr.ph14.new_crit_edge:              ; preds = %.lr.ph14.new
  br label %.lr.ph14.new

.lr.ph10.split.us.preheader:                      ; preds = %.lr.ph14.new
  br label %.lr.ph10.split.us

.lr.ph10.split.us:                                ; preds = %._crit_edge.us..lr.ph10.split.us_crit_edge, %.lr.ph10.split.us.preheader
  %indvars.iv27.us = phi i64 [ %indvars.iv.next3.us, %._crit_edge.us..lr.ph10.split.us_crit_edge ], [ 0, %.lr.ph10.split.us.preheader ]
...
.lr.ph10.split.us.new:                            ; preds = %.lr.ph10.split.us.new..lr.ph10.split.us.new_crit_edge, %.lr.ph10.split.us
  %indvars.iv6.us = phi i64 [ 0, %.lr.ph10.split.us ], [ %indvars.iv.next.us.1, %.lr.ph10.split.us.new..lr.ph10.split.us.new_crit_edge ]
  ...
  br i1 %exitcond.1, label %._crit_edge.us, label %.lr.ph10.split.us.new..lr.ph10.split.us.new_crit_edge

.lr.ph10.split.us.new..lr.ph10.split.us.new_crit_edge: ; preds = %.lr.ph10.split.us.new
  br label %.lr.ph10.split.us.new
...
._crit_edge.us:                                   ; preds = %.lr.ph10.split.us.new
  ...
  br i1 %exitcond17, label %._crit_edge11, label %._crit_edge.us..lr.ph10.split.us_crit_edge

._crit_edge.us..lr.ph10.split.us_crit_edge:       ; preds = %._crit_edge.us
  br label %.lr.ph10.split.us
...
.lr.ph14.preheader:
  ...
  %sunkaddr23 = ptrtoint double* %2 to i64
  br label %.lr.ph10.split.us

.lr.ph10.split.us:                                ; preds = %._crit_edge.us..lr.ph10.split.us_crit_edge, %.lr.ph14.preheader
  %indvars.iv27.us = phi i64 [ 0, %.lr.ph14.preheader ], [ %indvars.iv.next3.us, %._crit_edge.us..lr.ph10.split.us_crit_edge ]
  %6 = getelementptr inbounds double, double* %2, i64 %indvars.iv27.us
  store double 0.000000e+00, double* %6, align 8
  %sunkaddr20 = shl i64 %indvars.iv27.us, 3
...
._crit_edge:                                      ; preds = %._crit_edge.._crit_edge_crit_edge, %.lr.ph10.split.us
  %indvars.iv6.us = phi i64 [ 0, %.lr.ph10.split.us ], [ %indvars.iv.next.us, %._crit_edge.._crit_edge_crit_edge ]
  %7 = getelementptr inbounds double, double* %1, i64 %indvars.iv6.us
  %8 = load double, double* %7, align 8
  %9 = load double, double* %sunkaddr22, align 8
  %10 = getelementptr inbounds [1900 x double], [1900 x double]* %0, i64 %indvars.iv27.us, i64 %indvars.iv6.us
  %11 = load double, double* %10, align 8
  %12 = fmul double %9, %11
  %13 = fadd double %8, %12
  store double %13, double* %7, align 8
  %14 = load double, double* %sunkaddr26, align 8
  %15 = load double, double* %10, align 8
  %16 = getelementptr inbounds double, double* %3, i64 %indvars.iv6.us
...
.lr.ph9:                                          ; preds = %.lr.ph9._crit_edge..lr.ph9_crit_edge, %.lr.ph9.preheader
  %indvars.iv17 = phi i64 [ 0, %.lr.ph9.preheader ], [ %indvars.iv.next2, %.lr.ph9._crit_edge..lr.ph9_crit_edge ]
  %6 = trunc i64 %indvars.iv17 to i32
  %7 = srem i32 %6, 20
  %8 = icmp eq i32 %7, 0
  br i1 %8, label %9, label %.lr.ph9..lr.ph9._crit_edge_crit_edge

.lr.ph9..lr.ph9._crit_edge_crit_edge:             ; preds = %.lr.ph9
...
.lr.ph9._crit_edge:                               ; preds = %.lr.ph9..lr.ph9._crit_edge_crit_edge, %9
  ...
  br i1 %exitcond11, label %._crit_edge10, label %.lr.ph9._crit_edge..lr.ph9_crit_edge

.lr.ph9._crit_edge..lr.ph9_crit_edge:             ; preds = %.lr.ph9._crit_edge
  br label %.lr.ph9
...
.lr.ph:                                           ; preds = %.lr.ph._crit_edge..lr.ph_crit_edge, %._crit_edge10
  %indvars.iv6 = phi i64 [ 0, %._crit_edge10 ], [ %indvars.iv.next, %.lr.ph._crit_edge..lr.ph_crit_edge ]
  %19 = trunc i64 %indvars.iv6 to i32
  %20 = srem i32 %19, 20
  %21 = icmp eq i32 %20, 0
  br i1 %21, label %22, label %.lr.ph..lr.ph._crit_edge_crit_edge
...
.lr.ph._crit_edge:                                ; preds = %.lr.ph..lr.ph._crit_edge_crit_edge, %22
