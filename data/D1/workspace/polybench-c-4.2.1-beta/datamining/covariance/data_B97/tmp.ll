...
._crit_edge:                                      ; preds = %._crit_edge, %.preheader
  ...
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv22, i64 %indvars.iv1
...
.lr.ph51.split.us:                                ; preds = %._crit_edge47.us, %.lr.ph51.split.us.preheader
  ...
  %6 = getelementptr inbounds double, double* %3, i64 %indvars.iv2149.us
  store double 0.000000e+00, double* %6, align 8
  %sunkaddr9 = shl i64 %indvars.iv2149.us, 3
  %sunkaddr10 = add i64 %4, %sunkaddr9
  %sunkaddr11 = inttoptr i64 %sunkaddr10 to double*
  %sunkaddr9.1 = shl i64 %indvars.iv2149.us, 3
  %sunkaddr10.1 = add i64 %5, %sunkaddr9.1
  %sunkaddr11.1 = inttoptr i64 %sunkaddr10.1 to double*
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph51.split.us
  %7 = phi double [ 0.000000e+00, %.lr.ph51.split.us ], [ %13, %._crit_edge ]
  %indvars.iv1944.us = phi i64 [ 0, %.lr.ph51.split.us ], [ %indvars.iv.next20.us.1, %._crit_edge ]
  %8 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1944.us, i64 %indvars.iv2149.us
  %9 = load double, double* %8, align 8
  %10 = fadd double %7, %9
  store double %10, double* %sunkaddr11, align 8
  %indvars.iv.next20.us = or i64 %indvars.iv1944.us, 1
  %11 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next20.us, i64 %indvars.iv2149.us
  %12 = load double, double* %11, align 8
  %13 = fadd double %10, %12
  store double %13, double* %sunkaddr11.1, align 8
  %indvars.iv.next20.us.1 = add nuw nsw i64 %indvars.iv1944.us, 2
  %exitcond70.1 = icmp eq i64 %indvars.iv.next20.us.1, 1400
  br i1 %exitcond70.1, label %._crit_edge47.us, label %._crit_edge

._crit_edge47.us:                                 ; preds = %._crit_edge
  %14 = fdiv double %13, %0
  %sunkaddr38 = shl i64 %indvars.iv2149.us, 3
...
vector.memcheck:                                  ; preds = %._crit_edge41.us, %._crit_edge47.us..preheader6.us_crit_edge
  %indvars.iv1742.us = phi i64 [ 0, %._crit_edge47.us..preheader6.us_crit_edge ], [ %15, %._crit_edge41.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv1742.us, i64 0
  %15 = add nuw nsw i64 %indvars.iv1742.us, 1
  %scevgep24 = getelementptr [1200 x double], [1200 x double]* %1, i64 %15, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %wide.load29 = load <2 x double>, <2 x double>* %19, align 8, !alias.scope !1
  %20 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1742.us, i64 %index
  %21 = bitcast double* %20 to <2 x double>*
  %wide.load30 = load <2 x double>, <2 x double>* %21, align 8, !alias.scope !4, !noalias !1
  %22 = getelementptr double, double* %20, i64 2
  %23 = bitcast double* %22 to <2 x double>*
  %wide.load31 = load <2 x double>, <2 x double>* %23, align 8, !alias.scope !4, !noalias !1
  %24 = fsub <2 x double> %wide.load30, %wide.load
  %25 = fsub <2 x double> %wide.load31, %wide.load29
  ...
  %wide.load29.1 = load <2 x double>, <2 x double>* %29, align 8, !alias.scope !1
  %30 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1742.us, i64 %index.next
  %31 = bitcast double* %30 to <2 x double>*
  %wide.load30.1 = load <2 x double>, <2 x double>* %31, align 8, !alias.scope !4, !noalias !1
  %32 = getelementptr double, double* %30, i64 2
  %33 = bitcast double* %32 to <2 x double>*
  %wide.load31.1 = load <2 x double>, <2 x double>* %33, align 8, !alias.scope !4, !noalias !1
  %34 = fsub <2 x double> %wide.load30.1, %wide.load.1
  %35 = fsub <2 x double> %wide.load31.1, %wide.load29.1
  ...
  br i1 %36, label %._crit_edge41.us.loopexit41, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader
  %indvars.iv1539.us = phi i64 [ 0, %scalar.ph.preheader ], [ %indvars.iv.next16.us.3, %scalar.ph ]
  %37 = getelementptr inbounds double, double* %3, i64 %indvars.iv1539.us
  %38 = load double, double* %37, align 8
  %39 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1742.us, i64 %indvars.iv1539.us
  %40 = load double, double* %39, align 8
  %41 = fsub double %40, %38
  store double %41, double* %39, align 8
  %indvars.iv.next16.us = or i64 %indvars.iv1539.us, 1
  %42 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next16.us
  %43 = load double, double* %42, align 8
  %44 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1742.us, i64 %indvars.iv.next16.us
  %45 = load double, double* %44, align 8
  %46 = fsub double %45, %43
  store double %46, double* %44, align 8
  %indvars.iv.next16.us.1 = or i64 %indvars.iv1539.us, 2
  %47 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next16.us.1
  %48 = load double, double* %47, align 8
  %49 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1742.us, i64 %indvars.iv.next16.us.1
  %50 = load double, double* %49, align 8
  %51 = fsub double %50, %48
  store double %51, double* %49, align 8
  %indvars.iv.next16.us.2 = or i64 %indvars.iv1539.us, 3
  %52 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next16.us.2
  %53 = load double, double* %52, align 8
  %54 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1742.us, i64 %indvars.iv.next16.us.2
...
._crit_edge41.us:                                 ; preds = %._crit_edge41.us.loopexit41, %._crit_edge41.us.loopexit
  %exitcond68 = icmp eq i64 %15, 1400
...
._crit_edge35.us-lcssa.us.us:                     ; preds = %._crit_edge.us.us
  ...
  %exitcond = icmp eq i64 %indvars.iv.next14.us, 1200
  br i1 %exitcond, label %._crit_edge38, label %.lr.ph.us.us.preheader
...
.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph.us.us.preheader
  ...
  %58 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv1336.us, i64 %indvars.iv1133.us.us
...
._crit_edge.us.us:                                ; preds = %._crit_edge35
  ...
  %60 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv1133.us.us, i64 %indvars.iv1336.us
...
._crit_edge35:                                    ; preds = %._crit_edge35, %.lr.ph.us.us
  %61 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %73, %._crit_edge35 ]
  %indvars.iv31.us.us = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.us.us.1, %._crit_edge35 ]
  %62 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv31.us.us, i64 %indvars.iv1336.us
  %63 = load double, double* %62, align 8
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv31.us.us, i64 %indvars.iv1133.us.us
  %65 = load double, double* %64, align 8
  %66 = fmul double %63, %65
  %67 = fadd double %61, %66
  store double %67, double* %58, align 8
  %indvars.iv.next.us.us = or i64 %indvars.iv31.us.us, 1
  %68 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next.us.us, i64 %indvars.iv1336.us
  %69 = load double, double* %68, align 8
  %70 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next.us.us, i64 %indvars.iv1133.us.us
  ...
  br i1 %exitcond66.1, label %._crit_edge.us.us, label %._crit_edge35
...
._crit_edge:                                      ; preds = %._crit_edge5, %10
  ...
  br i1 %exitcond.us, label %._crit_edge.us, label %._crit_edge5
