...
.lver.check:                                      ; preds = %50, %.lr.ph31.split.us.preheader
  %indvar = phi i64 [ %18, %50 ], [ 0, %.lr.ph31.split.us.preheader ]
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %50 ], [ 1, %.lr.ph31.split.us.preheader ]
  %18 = add i64 %indvar, 1
  %scevgep = getelementptr [1000 x double], [1000 x double]* %138, i64 %18, i64 0
  %scevgep46 = getelementptr [1000 x double], [1000 x double]* %138, i64 %18, i64 999
  %scevgep48 = getelementptr [1000 x double], [1000 x double]* %133, i64 %18, i64 0
  %scevgep50 = getelementptr [1000 x double], [1000 x double]* %133, i64 %18, i64 999
...
.ph:                                              ; preds = %.lver.check
  ...
  %load_initial54 = load double, double* %scevgep48, align 8
  br label %68

; <label>:50:                                     ; preds = %51
  %exitcond24 = icmp eq i64 %indvars.iv.next17, 999
  br i1 %exitcond24, label %._crit_edge32, label %.lver.check
...
; <label>:68:                                     ; preds = %68, %.ph
  %store_forwarded55 = phi double [ %load_initial54, %.ph ], [ %86, %68 ]
  ...
  %84 = fmul double %114, %store_forwarded55
  ...
  br i1 %exitcond13, label %._crit_edge30.us.loopexit56, label %68

._crit_edge30.us.loopexit:                        ; preds = %.ph.lver.orig
  br label %._crit_edge30.us

._crit_edge30.us.loopexit56:                      ; preds = %68
  br label %._crit_edge30.us

._crit_edge30.us:                                 ; preds = %._crit_edge30.us.loopexit56, %._crit_edge30.us.loopexit
