...
entry:
  ...
  tail call void @init_array([1900 x double]* %arraydecay1, double* %arraydecay52, double* %arraydecay63)
  tail call void (...) @polybench_timer_start() #4
  %arraydecay85 = bitcast i8* %call1 to double*
  %arraydecay96 = bitcast i8* %call2 to double*
  tail call void @kernel_bicg([1900 x double]* %arraydecay1, double* %arraydecay85, double* %arraydecay96, double* %arraydecay63, double* %arraydecay52)
