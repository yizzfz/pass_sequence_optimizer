...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %22 = fadd <2 x double> %broadcast.splat78, %20
  %23 = fadd <2 x double> %broadcast.splat78, %21
...
for.cond4.preheader:                              ; preds = %for.cond4.preheader, %for.cond4.preheader.preheader
  ...
  br i1 %exitcond.1, label %for.inc53.loopexit81, label %for.cond4.preheader, !llvm.loop !17

for.inc53.loopexit:                               ; preds = %for.cond4.for.end_crit_edge.us
  br label %for.inc53

for.inc53.loopexit81:                             ; preds = %for.cond4.preheader
  br label %for.inc53
