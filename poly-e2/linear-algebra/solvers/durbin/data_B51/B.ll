...
for.body21.preheader:                             ; preds = %for.body21.prol.loopexit
  ...
  %33 = sub i64 %7, %indvars.iv36.unr.ph
  %34 = lshr i64 %33, 1
  %35 = and i64 %34, 1
  %lcmp.mod4 = icmp eq i64 %35, 0
  br i1 %lcmp.mod4, label %for.body21.prol.preheader, label %for.body21.prol.loopexit2.unr-lcssa

for.body21.prol.preheader:                        ; preds = %for.body21.preheader
  br label %for.body21.prol5

for.body21.prol5:                                 ; preds = %for.body21.prol.preheader
  ...
  %38 = sub nsw i64 %27, %indvars.iv.next37.prol
  ...
  %add29.prol6 = fadd <2 x double> %37, %add29.v.i1.prol
  %41 = bitcast double* %arrayidx31.prol to <2 x double>*
  store <2 x double> %add29.prol6, <2 x double>* %41, align 8
  %indvars.iv.next37.1.prol = or i64 %indvars.iv36.unr.ph, 2
  br label %for.body21.prol.loopexit2.unr-lcssa

for.body21.prol.loopexit2.unr-lcssa:              ; preds = %for.body21.preheader, %for.body21.prol5
  %indvars.iv36.unr.ph7 = phi i64 [ %indvars.iv.next37.1.prol, %for.body21.prol5 ], [ %indvars.iv36.unr.ph, %for.body21.preheader ]
  br label %for.body21.prol.loopexit2

for.body21.prol.loopexit2:                        ; preds = %for.body21.prol.loopexit2.unr-lcssa
  %42 = icmp eq i64 %34, 0
  br i1 %42, label %for.end44.loopexit, label %for.body21.preheader.new

for.body21.preheader.new:                         ; preds = %for.body21.prol.loopexit2
  br label %for.body21

for.body21:                                       ; preds = %for.body21, %for.body21.preheader.new
  %indvars.iv36 = phi i64 [ %indvars.iv36.unr.ph7, %for.body21.preheader.new ], [ %indvars.iv.next37.1.1, %for.body21 ]
  ...
  %45 = sub nsw i64 %27, %indvars.iv.next37
  ...
  %indvars.iv.next37.18 = add nsw i64 %indvars.iv36, 3
  %50 = load <2 x double>, <2 x double>* %49, align 8
  %51 = sub nsw i64 %27, %indvars.iv.next37.18
...
for.end44.loopexit:                               ; preds = %for.body21.prol.loopexit2, %for.end44.loopexit.unr-lcssa
  br label %for.end44
