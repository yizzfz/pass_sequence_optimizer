...
.preheader24:                                     ; preds = %20, %2
  %indvars.iv30 = phi i64 [ 0, %2 ], [ %indvars.iv.next31, %20 ]
  br label %.preheader

.preheader:                                       ; preds = %19, %.preheader24
  %indvars.iv28 = phi i64 [ 0, %.preheader24 ], [ %indvars.iv.next29, %19 ]
  %3 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv28, i64 %indvars.iv30
  br label %4

; <label>:4:                                      ; preds = %4, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %4 ]
  %5 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv28, i64 %indvars.iv
  %6 = load i32, i32* %5, align 4
  %7 = load i32, i32* %3, align 4
  %8 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv30, i64 %indvars.iv
  ...
  %12 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv28, i64 %indvars.iv.next
  %13 = load i32, i32* %12, align 4
  %14 = load i32, i32* %3, align 4
  %15 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv30, i64 %indvars.iv.next
...
; <label>:20:                                     ; preds = %19
  ...
  br i1 %exitcond32, label %21, label %.preheader24
...
.preheader:                                       ; preds = %20, %2
  %indvars.iv11 = phi i64 [ 0, %2 ], [ %indvars.iv.next12, %20 ]
  %7 = mul nuw nsw i64 %indvars.iv11, 2800
  br label %8
...
; <label>:15:                                     ; preds = %13, %8
  ...
  %17 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv11, i64 %indvars.iv
...
; <label>:20:                                     ; preds = %15
  ...
  br i1 %exitcond13, label %21, label %.preheader
