...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %._crit_edge.us
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %._crit_edge.us ], [ 0, %.lr.ph.us.preheader ]
...
._crit_edge.us:                                   ; preds = %.lr.ph.us.new
  ...
  %exitcond22 = icmp eq i64 %indvars.iv.next17, 2100
  br i1 %exitcond22, label %._crit_edge5, label %.lr.ph.us

.lr.ph10.new:                                     ; preds = %.lr.ph10, %.lr.ph10.new
  %indvars.iv20 = phi i64 [ %indvars.iv.next21.1, %.lr.ph10.new ], [ 0, %.lr.ph10 ]
  %21 = trunc i64 %indvars.iv20 to i32
  %22 = srem i32 %21, 1900
  %23 = sitofp i32 %22 to double
  %24 = getelementptr inbounds double, double* %2, i64 %indvars.iv20
  ...
  br i1 %exitcond24.1, label %.lr.ph.us.preheader, label %.lr.ph10.new

.lr.ph.us.preheader:                              ; preds = %.lr.ph10.new
  br label %.lr.ph.us
...
.lr.ph.us:                                        ; preds = %._crit_edge.us, %.lr.ph9
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %._crit_edge.us ], [ 0, %.lr.ph9 ]
  %6 = getelementptr inbounds double, double* %2, i64 %indvars.iv12
  store double 0.000000e+00, double* %6, align 8
  %7 = getelementptr inbounds double, double* %4, i64 %indvars.iv12
  br label %8
...
; <label>:8:                                      ; preds = %8, %.lr.ph.us
  ...
  %12 = getelementptr inbounds [1900 x double], [1900 x double]* %0, i64 %indvars.iv12, i64 %indvars.iv
...
._crit_edge.us:                                   ; preds = %8
  ...
  %exitcond19 = icmp eq i64 %indvars.iv.next13, 2100
  br i1 %exitcond19, label %._crit_edge4, label %.lr.ph.us
