...
for.cond7.preheader.us:                           ; preds = %for.cond7.preheader.us.preheader, %for.cond7.for.inc22_crit_edge.us
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.cond7.for.inc22_crit_edge.us ], [ 0, %for.cond7.preheader.us.preheader ]
...
for.body10.us:                                    ; preds = %for.cond7.preheader.us, %for.body10.us
  ...
  %0 = add nsw i64 %indvars.iv18, %indvars.iv
  %1 = trunc i64 %0 to i32
  %rem.us = srem i32 %1, 2100
  %conv12.us = sitofp i32 %rem.us to double
  %arrayidx18.us = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv18, i64 %indvars.iv
  %indvars.iv.next = or i64 %indvars.iv, 1
  %2 = add nsw i64 %indvars.iv18, %indvars.iv.next
...
for.cond7.for.inc22_crit_edge.us:                 ; preds = %for.body10.us
  ...
  %cmp4.us = icmp slt i64 %indvars.iv.next19, 1900
...
for.body5.us.preheader:                           ; preds = %vector.body
  ...
  %scevgep93 = getelementptr double, double* %y, i64 2100
  %26 = ptrtoint double* %tmp to i64
  %27 = bitcast double* %scevgep93 to i8*
  %28 = bitcast double* %scevgep to i8*
  br label %for.body5.us

for.body5.us:                                     ; preds = %for.inc42.us, %for.body5.us.preheader
  %indvar = phi i64 [ %29, %for.inc42.us ], [ 0, %for.body5.us.preheader ]
  %inc4313.us = phi i32 [ %inc43.us, %for.inc42.us ], [ 0, %for.body5.us.preheader ]
  %scevgep95 = getelementptr [2100 x double], [2100 x double]* %A, i64 %indvar, i64 1
  %29 = add i64 %indvar, 1
  %scevgep97 = getelementptr [2100 x double], [2100 x double]* %A, i64 %29, i64 0
  %idxprom6.us = sext i32 %inc4313.us to i64
  ...
  %sunkaddr67 = shl nsw i64 %idxprom6.us, 3
  %sunkaddr68 = add i64 %26, %sunkaddr67
  %sunkaddr69 = inttoptr i64 %sunkaddr68 to double*
  %.pre115 = load double, double* %sunkaddr69, align 8
  %30 = inttoptr i64 %sunkaddr68 to double*
  br label %for.body10.us

for.inc42.us:                                     ; preds = %for.body26.us.for.body26.us_crit_edge
  %inc43.us = add nsw i32 %inc4313.us, 1
  %cmp4.us = icmp slt i32 %inc43.us, 1900
...
for.body26.us.for.body26.us_crit_edge:            ; preds = %for.body26.us.for.body26.us_crit_edge.preheader, %for.body26.us.for.body26.us_crit_edge
  %indvars.iv.next7885 = phi i64 [ %indvars.iv.next78, %for.body26.us.for.body26.us_crit_edge ], [ %indvars.iv.next7885.ph, %for.body26.us.for.body26.us_crit_edge.preheader ]
  %.pre = load double, double* %43, align 8
  %arrayidx28.us = getelementptr inbounds double, double* %y, i64 %indvars.iv.next7885
  %31 = load double, double* %arrayidx28.us, align 8
  %arrayidx32.us = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %idxprom6.us, i64 %indvars.iv.next7885
  %32 = load double, double* %arrayidx32.us, align 8
  %mul35.us = fmul double %32, %.pre
  %add36.us = fadd double %31, %mul35.us
  store double %add36.us, double* %arrayidx28.us, align 8
  %indvars.iv.next78 = add nuw nsw i64 %indvars.iv.next7885, 1
  %cmp25.us = icmp slt i64 %indvars.iv.next78, 2100
...
for.body10.us:                                    ; preds = %for.body10.us, %for.body5.us
  %33 = phi double [ %.pre115, %for.body5.us ], [ %add.us.2, %for.body10.us ]
  %indvars.iv = phi i64 [ 0, %for.body5.us ], [ %indvars.iv.next.2, %for.body10.us ]
  %arrayidx16.us = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %idxprom6.us, i64 %indvars.iv
  ...
  %arrayidx16.us.1 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %idxprom6.us, i64 %indvars.iv.next
  ...
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %arrayidx16.us.2 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %idxprom6.us, i64 %indvars.iv.next.1
...
for.body10.us.for.body26.us_crit_edge:            ; preds = %for.body10.us
  ...
  %arrayidx32.us82 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %idxprom6.us, i64 0
  %41 = load double, double* %arrayidx32.us82, align 8
  %mul35.us83 = fmul double %41, %add.us.2
  %add36.us84 = fadd double %40, %mul35.us83
  store double %add36.us84, double* %y, align 8
  %bc = inttoptr i64 %sunkaddr68 to i8*
  %bound0 = icmp ult i8* %28, %bc
  %bound1 = icmp ult i8* %bc, %27
  %found.conflict = and i1 %bound0, %bound1
  %bound0100 = icmp ult double* %scevgep, %scevgep97
  %bound1101 = icmp ult double* %scevgep95, %scevgep93
  %found.conflict102 = and i1 %bound0100, %bound1101
  %conflict.rdx = or i1 %found.conflict, %found.conflict102
  br i1 %conflict.rdx, label %for.body26.us.for.body26.us_crit_edge.preheader, label %vector.body87.preheader

vector.body87.preheader:                          ; preds = %for.body10.us.for.body26.us_crit_edge
  %42 = inttoptr i64 %sunkaddr68 to double*
  br label %vector.body87

for.body26.us.for.body26.us_crit_edge.preheader.loopexit: ; preds = %vector.body87
...
for.body26.us.for.body26.us_crit_edge.preheader:  ; preds = %for.body26.us.for.body26.us_crit_edge.preheader.loopexit, %for.body10.us.for.body26.us_crit_edge
  %indvars.iv.next7885.ph = phi i64 [ 1, %for.body10.us.for.body26.us_crit_edge ], [ 2097, %for.body26.us.for.body26.us_crit_edge.preheader.loopexit ]
  %43 = inttoptr i64 %sunkaddr68 to double*
  br label %for.body26.us.for.body26.us_crit_edge

vector.body87:                                    ; preds = %vector.body87.preheader, %vector.body87
  %index104 = phi i64 [ %index.next105, %vector.body87 ], [ 0, %vector.body87.preheader ]
  ...
  %wide.load112 = load <2 x double>, <2 x double>* %50, align 8, !alias.scope !8, !noalias !10
  %51 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %idxprom6.us, i64 %offset.idx
  %52 = bitcast double* %51 to <2 x double>*
  %wide.load113 = load <2 x double>, <2 x double>* %52, align 8, !alias.scope !12
  %53 = getelementptr double, double* %51, i64 2
  %54 = bitcast double* %53 to <2 x double>*
  %wide.load114 = load <2 x double>, <2 x double>* %54, align 8, !alias.scope !12
  %55 = fmul <2 x double> %wide.load113, %46
  %56 = fmul <2 x double> %wide.load114, %46
  %57 = fadd <2 x double> %wide.load, %55
  %58 = fadd <2 x double> %wide.load112, %56
  ...
  %59 = icmp eq i64 %index.next105, 2096
  br i1 %59, label %for.body26.us.for.body26.us_crit_edge.preheader.loopexit, label %vector.body87, !llvm.loop !13
