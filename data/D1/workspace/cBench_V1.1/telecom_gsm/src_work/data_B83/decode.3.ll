...
@__llvm_prf_nm = private constant [36 x i8] c"\22\00Gsm_Decoder\01tmp1.ll:Postprocessing", section "__llvm_prf_names"
@llvm.used = appending global [3 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_Gsm_Decoder to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_Postprocessing to i8*), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
