...
for.body3:                                        ; preds = %for.inc, %for.cond1.preheader
  ...
  %or.cond8 = or i1 %or.cond, %cmp15
  br i1 %or.cond8, label %if.then, label %for.inc

if.then:                                          ; preds = %for.body3
  br label %for.inc

for.inc:                                          ; preds = %for.body3, %if.then
  %storemerge = phi i32 [ 999, %if.then ], [ %add, %for.body3 ]
...
for.cond1.preheader:                              ; preds = %for.inc38, %entry
  %indvars.iv3 = phi i64 [ 0, %entry ], [ %indvars.iv.next4, %for.inc38 ]
  %scevgep8 = getelementptr [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv3, i64 0
  %0 = add nuw nsw i64 %indvars.iv3, 1
  %scevgep10 = getelementptr [2800 x i32], [2800 x i32]* %path, i64 %0, i64 0
  br label %for.cond4.preheader

for.cond4.preheader:                              ; preds = %for.inc35, %for.cond1.preheader
  %indvars.iv1 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next2, %for.inc35 ]
  %scevgep = getelementptr [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv1, i64 0
  %1 = add nuw nsw i64 %indvars.iv1, 1
  %scevgep6 = getelementptr [2800 x i32], [2800 x i32]* %path, i64 %1, i64 0
  %arrayidx12 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv1, i64 %indvars.iv3
  %bound0 = icmp ult i32* %scevgep, %arrayidx12
  %bound1 = icmp ult i32* %arrayidx12, %scevgep6
  %found.conflict = and i1 %bound0, %bound1
  %bound013 = icmp ult i32* %scevgep, %scevgep10
  %bound114 = icmp ult i32* %scevgep8, %scevgep6
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %2 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv1, i64 %index
  %3 = bitcast i32* %2 to <4 x i32>*
  %wide.load = load <4 x i32>, <4 x i32>* %3, align 4, !alias.scope !1, !noalias !4
  %4 = getelementptr i32, i32* %2, i64 4
  %5 = bitcast i32* %4 to <4 x i32>*
  %wide.load17 = load <4 x i32>, <4 x i32>* %5, align 4, !alias.scope !1, !noalias !4
  ...
  %11 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv3, i64 %index
  %12 = bitcast i32* %11 to <4 x i32>*
  %wide.load18 = load <4 x i32>, <4 x i32>* %12, align 4, !alias.scope !8
  %13 = getelementptr i32, i32* %11, i64 4
  %14 = bitcast i32* %13 to <4 x i32>*
  %wide.load19 = load <4 x i32>, <4 x i32>* %14, align 4, !alias.scope !8
  %15 = add nsw <4 x i32> %wide.load18, %8
  %16 = add nsw <4 x i32> %wide.load19, %10
  %17 = icmp sge <4 x i32> %wide.load, %15
  %18 = icmp sge <4 x i32> %wide.load17, %16
  %predphi = select <4 x i1> %17, <4 x i32> %15, <4 x i32> %wide.load
  %predphi20 = select <4 x i1> %18, <4 x i32> %16, <4 x i32> %wide.load17
  %19 = bitcast i32* %2 to <4 x i32>*
  store <4 x i32> %predphi, <4 x i32>* %19, align 4, !alias.scope !1, !noalias !4
  %20 = bitcast i32* %4 to <4 x i32>*
  store <4 x i32> %predphi20, <4 x i32>* %20, align 4, !alias.scope !1, !noalias !4
  %index.next = add nuw nsw i64 %index, 8
  %21 = icmp eq i64 %index.next, 2800
  br i1 %21, label %for.inc35.loopexit22, label %vector.body, !llvm.loop !9

for.body6:                                        ; preds = %for.body6, %for.body6.preheader
  %indvars.iv = phi i64 [ 0, %for.body6.preheader ], [ %indvars.iv.next.1, %for.body6 ]
  %arrayidx8 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv1, i64 %indvars.iv
  %22 = load i32, i32* %arrayidx8, align 4
  %23 = load i32, i32* %arrayidx12, align 4
  %arrayidx16 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv3, i64 %indvars.iv
  %24 = load i32, i32* %arrayidx16, align 4
  %add = add nsw i32 %24, %23
  %cmp17 = icmp slt i32 %22, %add
  %.add = select i1 %cmp17, i32 %22, i32 %add
  store i32 %.add, i32* %arrayidx8, align 4
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx8.1 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv1, i64 %indvars.iv.next
  %25 = load i32, i32* %arrayidx8.1, align 4
  %26 = load i32, i32* %arrayidx12, align 4
  %arrayidx16.1 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv3, i64 %indvars.iv.next
  %27 = load i32, i32* %arrayidx16.1, align 4
  %add.1 = add nsw i32 %27, %26
  %cmp17.1 = icmp slt i32 %25, %add.1
  %.add.1 = select i1 %cmp17.1, i32 %25, i32 %add.1
  store i32 %.add.1, i32* %arrayidx8.1, align 4
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond23.1 = icmp eq i64 %indvars.iv.next.1, 2800
  br i1 %exitcond23.1, label %for.inc35.loopexit, label %for.body6, !llvm.loop !12

for.inc35.loopexit:                               ; preds = %for.body6
  br label %for.inc35

for.inc35.loopexit22:                             ; preds = %vector.body
  br label %for.inc35

for.inc35:                                        ; preds = %for.inc35.loopexit22, %for.inc35.loopexit
...
for.inc38:                                        ; preds = %for.inc35
  ...
  %exitcond21 = icmp eq i64 %indvars.iv.next4, 2800
  br i1 %exitcond21, label %for.end40, label %for.cond1.preheader
