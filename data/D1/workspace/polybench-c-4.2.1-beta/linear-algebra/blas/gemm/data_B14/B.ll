...
define internal fastcc void @kernel_gemm(i32, i32, i32, double, double, [1100 x double]* nocapture, [1200 x double]* nocapture readonly, [1100 x double]* nocapture readonly) unnamed_addr #2 {
  %broadcast.splatinsert29 = insertelement <2 x double> undef, double %3, i32 0
  br label %._crit_edge.preheader

._crit_edge.preheader:                            ; preds = %.._crit_edge.preheader_crit_edge, %8
  %indvars.iv15 = phi i64 [ 0, %8 ], [ %9, %.._crit_edge.preheader_crit_edge ]
  %scevgep = getelementptr [1100 x double], [1100 x double]* %5, i64 %indvars.iv15, i64 0
  %9 = add nuw nsw i64 %indvars.iv15, 1
  %scevgep19 = getelementptr [1100 x double], [1100 x double]* %5, i64 %9, i64 0
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.._crit_edge_crit_edge, %._crit_edge.preheader
  %indvars.iv = phi i64 [ 0, %._crit_edge.preheader ], [ %indvars.iv.next.4, %._crit_edge.._crit_edge_crit_edge ]
  %10 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv15, i64 %indvars.iv
  %11 = load double, double* %10, align 8
  %12 = fmul double %11, %4
  store double %12, double* %10, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %13 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv15, i64 %indvars.iv.next
  %14 = load double, double* %13, align 8
  %15 = fmul double %14, %4
  store double %15, double* %13, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %16 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv15, i64 %indvars.iv.next.1
  %17 = load double, double* %16, align 8
  %18 = fmul double %17, %4
  store double %18, double* %16, align 8
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %19 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv15, i64 %indvars.iv.next.2
  %20 = load double, double* %19, align 8
  %21 = fmul double %20, %4
  store double %21, double* %19, align 8
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %22 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv15, i64 %indvars.iv.next.3
...
._crit_edge4.preheader:                           ; preds = %._crit_edge3.._crit_edge4.preheader_crit_edge, %._crit_edge4.preheader.preheader
  %indvars.iv12 = phi i64 [ %25, %._crit_edge3.._crit_edge4.preheader_crit_edge ], [ 0, %._crit_edge4.preheader.preheader ]
  %scevgep21 = getelementptr [1100 x double], [1100 x double]* %7, i64 %indvars.iv12, i64 0
  %25 = add nuw nsw i64 %indvars.iv12, 1
  %scevgep23 = getelementptr [1100 x double], [1100 x double]* %7, i64 %25, i64 0
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv15, i64 %indvars.iv12
  %bound0 = icmp ult double* %scevgep, %26
  %bound1 = icmp ult double* %26, %scevgep19
  %found.conflict = and i1 %bound0, %bound1
  %bound026 = icmp ult double* %scevgep, %scevgep23
  %bound127 = icmp ult double* %scevgep21, %scevgep19
  %found.conflict28 = and i1 %bound026, %bound127
  %conflict.rdx = or i1 %found.conflict, %found.conflict28
  br i1 %conflict.rdx, label %._crit_edge4.preheader35, label %vector.ph

._crit_edge4.preheader35:                         ; preds = %._crit_edge4.preheader
...
vector.ph:                                        ; preds = %._crit_edge4.preheader
  ...
  %28 = fmul <2 x double> %27, %broadcast.splatinsert29
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.ph
  ...
  %30 = getelementptr inbounds [1100 x double], [1100 x double]* %7, i64 %indvars.iv12, i64 %offset.idx
  ...
  %33 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv15, i64 %offset.idx
  %34 = bitcast double* %33 to <4 x double>*
  %wide.vec32 = load <4 x double>, <4 x double>* %34, align 8, !alias.scope !6, !noalias !8
  %strided.vec33 = shufflevector <4 x double> %wide.vec32, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %strided.vec34 = shufflevector <4 x double> %wide.vec32, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %35 = fadd <2 x double> %strided.vec33, %32
  %36 = or i64 %offset.idx, 1
  %37 = fmul <2 x double> %29, %strided.vec31
  %38 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv15, i64 %36
  %39 = fadd <2 x double> %strided.vec34, %37
  ...
  br i1 %42, label %._crit_edge3.loopexit36, label %vector.body.vector.body_crit_edge, !llvm.loop !9

vector.body.vector.body_crit_edge:                ; preds = %vector.body
  br label %vector.body

._crit_edge4:                                     ; preds = %._crit_edge4.._crit_edge4_crit_edge, %._crit_edge4.preheader35
  %indvars.iv9 = phi i64 [ %indvars.iv.next10.1, %._crit_edge4.._crit_edge4_crit_edge ], [ 0, %._crit_edge4.preheader35 ]
  %43 = load double, double* %26, align 8
  %44 = fmul double %43, %3
  %45 = getelementptr inbounds [1100 x double], [1100 x double]* %7, i64 %indvars.iv12, i64 %indvars.iv9
  %46 = load double, double* %45, align 8
  %47 = fmul double %44, %46
  %48 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv15, i64 %indvars.iv9
  ...
  %52 = fmul double %51, %3
  %53 = getelementptr inbounds [1100 x double], [1100 x double]* %7, i64 %indvars.iv12, i64 %indvars.iv.next10
  %54 = load double, double* %53, align 8
  %55 = fmul double %52, %54
  %56 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv15, i64 %indvars.iv.next10
  ...
  br i1 %exitcond11.1, label %._crit_edge3.loopexit, label %._crit_edge4.._crit_edge4_crit_edge, !llvm.loop !12
...
._crit_edge3.loopexit36:                          ; preds = %vector.body
  br label %._crit_edge3

._crit_edge3:                                     ; preds = %._crit_edge3.loopexit36, %._crit_edge3.loopexit
  %exitcond14 = icmp eq i64 %25, 1200
  br i1 %exitcond14, label %59, label %._crit_edge3.._crit_edge4.preheader_crit_edge

._crit_edge3.._crit_edge4.preheader_crit_edge:    ; preds = %._crit_edge3
  br label %._crit_edge4.preheader

; <label>:59:                                     ; preds = %._crit_edge3
  %exitcond17 = icmp eq i64 %9, 1000
  br i1 %exitcond17, label %60, label %.._crit_edge.preheader_crit_edge

.._crit_edge.preheader_crit_edge:                 ; preds = %59
  br label %._crit_edge.preheader
...
; <label>:9:                                      ; preds = %._crit_edge2._crit_edge, %._crit_edge.preheader
  %indvars.iv = phi i64 [ 0, %._crit_edge.preheader ], [ %indvars.iv.next, %._crit_edge2._crit_edge ]
  %10 = add nuw nsw i64 %indvars.iv, %8
  %11 = trunc i64 %10 to i32
  %12 = srem i32 %11, 20
  %13 = icmp eq i32 %12, 0
  br i1 %13, label %14, label %.._crit_edge2_crit_edge

.._crit_edge2_crit_edge:                          ; preds = %9
...
._crit_edge2:                                     ; preds = %.._crit_edge2_crit_edge, %14
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1100
  br i1 %exitcond, label %20, label %._crit_edge2._crit_edge
...
; <label>:20:                                     ; preds = %._crit_edge2
  ...
  br i1 %exitcond7, label %21, label %.._crit_edge.preheader_crit_edge

.._crit_edge.preheader_crit_edge:                 ; preds = %20
  br label %._crit_edge.preheader
