...
for.body:                                         ; preds = %for.end47.for.body_crit_edge, %for.body.lr.ph
  %indvars.iv39 = phi i2 [ %indvars.iv.next40, %for.end47.for.body_crit_edge ], [ 0, %for.body.lr.ph ]
...
for.body30.prol:                                  ; preds = %for.body30.prol, %for.body30.prol.preheader
  ...
  %prol.iter = phi i64 [ %xtraiter36, %for.body30.prol.preheader ], [ %prol.iter.sub, %for.body30.prol ]
...
for.body30:                                       ; preds = %for.body30, %for.body30.lr.ph.new
  %22 = phi double [ %.unr38, %for.body30.lr.ph.new ], [ %sub44.3, %for.body30 ]
