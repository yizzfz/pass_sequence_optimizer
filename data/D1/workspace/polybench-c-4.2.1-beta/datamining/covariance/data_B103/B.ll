...
.lr.ph74.split.us:                                ; preds = %._crit_edge71.us, %.lr.ph74.split.us.preheader
  %indvars.iv117 = phi i64 [ 0, %.lr.ph74.split.us.preheader ], [ %indvars.iv.next118, %._crit_edge71.us ]
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv117
  store double 0.000000e+00, double* %5, align 8
  %sunkaddr150 = shl i64 %indvars.iv117, 3
  %sunkaddr151 = add i64 %4, %sunkaddr150
  %sunkaddr152 = inttoptr i64 %sunkaddr151 to double*
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph74.split.us
  %6 = phi double [ 0.000000e+00, %.lr.ph74.split.us ], [ %21, %._crit_edge ]
  %indvars.iv113 = phi i64 [ 0, %.lr.ph74.split.us ], [ %indvars.iv.next114.4, %._crit_edge ]
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv113, i64 %indvars.iv117
  %8 = load double, double* %7, align 8
  %9 = fadd double %6, %8
  store double %9, double* %sunkaddr152, align 8
  %indvars.iv.next114 = add nuw nsw i64 %indvars.iv113, 1
  %10 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next114, i64 %indvars.iv117
  %11 = load double, double* %10, align 8
  %12 = fadd double %9, %11
  store double %12, double* %sunkaddr152, align 8
  %indvars.iv.next114.1 = add nuw nsw i64 %indvars.iv113, 2
  %13 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next114.1, i64 %indvars.iv117
  %14 = load double, double* %13, align 8
  %15 = fadd double %12, %14
  store double %15, double* %sunkaddr152, align 8
  %indvars.iv.next114.2 = add nuw nsw i64 %indvars.iv113, 3
  %16 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next114.2, i64 %indvars.iv117
  %17 = load double, double* %16, align 8
  %18 = fadd double %15, %17
  store double %18, double* %sunkaddr152, align 8
  %indvars.iv.next114.3 = add nuw nsw i64 %indvars.iv113, 4
  %19 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next114.3, i64 %indvars.iv117
  %20 = load double, double* %19, align 8
  %21 = fadd double %18, %20
  store double %21, double* %sunkaddr152, align 8
  %indvars.iv.next114.4 = add nuw nsw i64 %indvars.iv113, 5
  %exitcond131.4 = icmp eq i64 %indvars.iv.next114.4, 1400
  br i1 %exitcond131.4, label %._crit_edge71.us, label %._crit_edge

._crit_edge71.us:                                 ; preds = %._crit_edge
  %22 = fdiv double %21, %0
  %sunkaddr24 = shl i64 %indvars.iv117, 3
  ...
  %exitcond132 = icmp eq i64 %indvars.iv.next118, 1200
  br i1 %exitcond132, label %._crit_edge71.us..preheader56.us_crit_edge, label %.lr.ph74.split.us

._crit_edge71.us..preheader56.us_crit_edge:       ; preds = %._crit_edge71.us
  %scevgep10 = getelementptr double, double* %3, i64 1200
  br label %vector.memcheck

vector.memcheck:                                  ; preds = %._crit_edge66.us, %._crit_edge71.us..preheader56.us_crit_edge
  %indvars.iv108 = phi i64 [ 0, %._crit_edge71.us..preheader56.us_crit_edge ], [ %23, %._crit_edge66.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv108, i64 0
  %23 = add nuw nsw i64 %indvars.iv108, 1
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv108, i64 %offset.idx
  ...
  %33 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv108, i64 %32
  ...
  br i1 %39, label %._crit_edge66.us.loopexit27, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv104 = phi i64 [ %indvars.iv.next105.3, %scalar.ph ], [ 0, %scalar.ph.preheader ]
  %40 = getelementptr inbounds double, double* %3, i64 %indvars.iv104
  %41 = load double, double* %40, align 8
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv108, i64 %indvars.iv104
  %43 = load double, double* %42, align 8
  %44 = fsub double %43, %41
  store double %44, double* %42, align 8
  %indvars.iv.next105 = or i64 %indvars.iv104, 1
  %45 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next105
  %46 = load double, double* %45, align 8
  %47 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv108, i64 %indvars.iv.next105
  %48 = load double, double* %47, align 8
  %49 = fsub double %48, %46
  store double %49, double* %47, align 8
  %indvars.iv.next105.1 = or i64 %indvars.iv104, 2
  %50 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next105.1
  %51 = load double, double* %50, align 8
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv108, i64 %indvars.iv.next105.1
  %53 = load double, double* %52, align 8
  %54 = fsub double %53, %51
  store double %54, double* %52, align 8
  %indvars.iv.next105.2 = or i64 %indvars.iv104, 3
  %55 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next105.2
  %56 = load double, double* %55, align 8
  %57 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv108, i64 %indvars.iv.next105.2
  %58 = load double, double* %57, align 8
  %59 = fsub double %58, %56
  store double %59, double* %57, align 8
  %indvars.iv.next105.3 = add nuw nsw i64 %indvars.iv104, 4
  %exitcond129.3 = icmp eq i64 %indvars.iv.next105.3, 1200
  br i1 %exitcond129.3, label %._crit_edge66.us.loopexit, label %scalar.ph, !llvm.loop !9

._crit_edge66.us.loopexit:                        ; preds = %scalar.ph
  br label %._crit_edge66.us

._crit_edge66.us.loopexit27:                      ; preds = %vector.body
  br label %._crit_edge66.us

._crit_edge66.us:                                 ; preds = %._crit_edge66.us.loopexit27, %._crit_edge66.us.loopexit
  %exitcond130 = icmp eq i64 %23, 1400
  br i1 %exitcond130, label %.preheader.us.preheader, label %vector.memcheck
...
.lr.ph60.us:                                      ; preds = %._crit_edge61.us-lcssa.us.us, %.preheader.us.preheader
  %indvars.iv90 = phi i64 [ 0, %.preheader.us.preheader ], [ %indvars.iv.next91, %._crit_edge61.us-lcssa.us.us ]
...
.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph60.us
  ...
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv90, i64 %indvars.iv86
...
._crit_edge.us.us:                                ; preds = %._crit_edge21
  ...
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv86, i64 %indvars.iv90
...
._crit_edge21:                                    ; preds = %._crit_edge21, %.lr.ph.us.us
  ...
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv90
  %66 = load double, double* %65, align 8
  %67 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv86
  %68 = load double, double* %67, align 8
  %69 = fmul double %66, %68
  %70 = fadd double %64, %69
  store double %70, double* %61, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv90
  %72 = load double, double* %71, align 8
  %73 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv86
  ...
  br i1 %exitcond127.1, label %._crit_edge.us.us, label %._crit_edge21
