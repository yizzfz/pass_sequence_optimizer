...
; <label>:11:                                     ; preds = %11, %.lr.ph3.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph3.split.us ], [ %indvars.iv.next, %11 ]
...
._crit_edge.us:                                   ; preds = %11
  ...
  br i1 %exitcond15, label %.loopexit, label %.lr.ph3.split.us
...
.lr.ph2.split.us.preheader:
  %sunkaddr36 = ptrtoint double* %5 to i64
...
.lr.ph2.split.us:                                 ; preds = %._crit_edge.us, %.lr.ph2.split.us.preheader
  ...
  %8 = getelementptr inbounds double, double* %5, i64 %indvars.iv10
  store double 0.000000e+00, double* %8, align 8
  %9 = getelementptr inbounds double, double* %7, i64 %indvars.iv10
...
; <label>:10:                                     ; preds = %10, %.lr.ph2.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph2.split.us ], [ %indvars.iv.next, %10 ]
  %11 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv10, i64 %indvars.iv
  ...
  %18 = getelementptr inbounds [1300 x double], [1300 x double]* %4, i64 %indvars.iv10, i64 %indvars.iv
  %19 = load double, double* %18, align 8
  %20 = load double, double* %13, align 8
  %21 = fmul double %19, %20
  %22 = load double, double* %sunkaddr29, align 8
  %23 = fadd double %21, %22
  store double %23, double* %sunkaddr29, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
  br i1 %exitcond, label %._crit_edge.us, label %10

._crit_edge.us:                                   ; preds = %10
  %sunkaddr37 = shl i64 %indvars.iv10, 3
  ...
  %25 = fmul double %24, %1
  %sunkaddr41 = shl i64 %indvars.iv10, 3
  ...
  br i1 %exitcond34, label %.loopexit, label %.lr.ph2.split.us
