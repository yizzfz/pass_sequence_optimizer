...
._crit_edge52:                                    ; preds = %._crit_edge52, %.lr.ph3.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph3.split.us ], [ %indvars.iv.next, %._crit_edge52 ]
  ...
  %45 = load double, double* %sunkaddr37, align 8
  %46 = fadd double %44, %45
  store double %46, double* %sunkaddr41, align 8
  ...
  %52 = load double, double* %sunkaddr45, align 8
  %53 = fadd double %51, %52
  store double %53, double* %sunkaddr49, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %54 = icmp slt i64 %indvars.iv.next, %35
  br i1 %54, label %._crit_edge52, label %._crit_edge.us
...
.lr.ph3.split:                                    ; preds = %.lr.ph3.split, %.lr.ph3.split.preheader
  ...
  br i1 %71, label %.lr.ph3.split, label %._crit_edge4.loopexit53
...
._crit_edge4:                                     ; preds = %._crit_edge4.loopexit53, %._crit_edge4.loopexit
  %.lcssa6.in = phi i64 [ %indvars.iv.next12, %._crit_edge4.loopexit ], [ %indvars.iv.next16, %._crit_edge4.loopexit53 ]
