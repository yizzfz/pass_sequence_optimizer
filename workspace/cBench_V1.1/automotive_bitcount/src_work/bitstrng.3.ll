...
@__llvm_prf_nm = private constant [19 x i8] c"\09\11x\DAK\CA,).)\CA\CCK\07\00\13+\03\D7", section "__llvm_prf_names"
@llvm.used = appending global [2 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_bitstring to i8*), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
