...
for.inc.lr.ph:                                    ; preds = %entry, %for.inc47
  %indvars.iv34 = phi i64 [ 1, %entry ], [ %indvars.iv.next35, %for.inc47 ]
  %indvar = phi i64 [ 0, %entry ], [ %indvar.next, %for.inc47 ]
  %alpha.016 = phi double [ %sub3, %entry ], [ %div, %for.inc47 ]
  %beta.015 = phi double [ 1.000000e+00, %entry ], [ %mul5, %for.inc47 ]
  %6 = add i64 %indvar, -1
  %7 = shl i64 %indvar, 3
  ...
  %9 = add i64 %indvar, 1
  %sub9 = add nsw i64 %indvars.iv34, -1
...
for.inc.prol:                                     ; preds = %for.inc.prol.preheader, %for.inc.prol
  ...
  %sum.08.prol = phi double [ %add.prol, %for.inc.prol ], [ 0.000000e+00, %for.inc.prol.preheader ]
...
for.inc.prol.loopexit:                            ; preds = %for.inc.prol.loopexit.loopexit, %for.inc.lr.ph
  ...
  %sum.08.unr = phi double [ 0.000000e+00, %for.inc.lr.ph ], [ %add.prol, %for.inc.prol.loopexit.loopexit ]
...
for.inc:                                          ; preds = %for.inc.preheader, %for.inc
  ...
  %sum.08 = phi double [ %add.3, %for.inc ], [ %sum.08.unr, %for.inc.preheader ]
...
for.inc32.lr.ph:                                  ; preds = %for.inc32.lr.ph.loopexit, %for.inc.prol.loopexit
  ...
  %sub24 = add nsw i64 %indvars.iv34, -1
  %22 = and i64 %indvar, 1
  %lcmp.mod38 = icmp eq i64 %22, 0
  br i1 %lcmp.mod38, label %for.inc32.prol, label %for.inc32.prol.loopexit

for.inc32.prol:                                   ; preds = %for.inc32.lr.ph
  %23 = load double, double* %y, align 8
  %sunkaddr39 = shl i64 %indvars.iv34, 3
  %sunkaddr40 = add i64 %3, %sunkaddr39
  %sunkaddr41 = add i64 %sunkaddr40, -8
  %sunkaddr42 = inttoptr i64 %sunkaddr41 to double*
  %24 = load double, double* %sunkaddr42, align 8
  %mul28.prol = fmul double %div, %24
  %add29.prol = fadd double %23, %mul28.prol
...
for.inc32.prol.loopexit:                          ; preds = %for.inc32.prol, %for.inc32.lr.ph
  %indvars.iv20.unr.ph = phi i64 [ 1, %for.inc32.prol ], [ 0, %for.inc32.lr.ph ]
  %25 = icmp eq i64 %indvar, 0
  br i1 %25, label %for.inc47, label %for.inc32.preheader

for.inc32.preheader:                              ; preds = %for.inc32.prol.loopexit
  %26 = sub i64 %6, %indvars.iv20.unr.ph
  %27 = lshr i64 %26, 1
  %28 = add nuw i64 %27, 1
...
min.iters.checked:                                ; preds = %for.inc32.preheader
  ...
  %29 = or i64 %indvars.iv20.unr.ph, 2
  %30 = shl nuw i64 %27, 1
  %31 = add i64 %29, %30
...
vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert49 = insertelement <2 x double> undef, double %div, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %33 = shl i64 %index, 1
  %offset.idx = or i64 %indvars.iv20.unr.ph, %33
  %34 = getelementptr inbounds double, double* %y, i64 %offset.idx
  %35 = bitcast double* %34 to <4 x double>*
  %wide.vec = load <4 x double>, <4 x double>* %35, align 8
  %strided.vec = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %strided.vec44 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %36 = sub nsw i64 %sub24, %offset.idx
  %37 = getelementptr inbounds double, double* %y, i64 %36
  %38 = getelementptr double, double* %37, i64 -3
  %39 = bitcast double* %38 to <4 x double>*
  %wide.vec45 = load <4 x double>, <4 x double>* %39, align 8
  %strided.vec46 = shufflevector <4 x double> %wide.vec45, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %reverse = shufflevector <2 x double> %strided.vec46, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %strided.vec47 = shufflevector <4 x double> %wide.vec45, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %reverse48 = shufflevector <2 x double> %strided.vec47, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %40 = fmul <2 x double> %broadcast.splat50, %reverse48
  %41 = fadd <2 x double> %strided.vec, %40
  %42 = add nuw nsw i64 %offset.idx, 1
  %43 = fmul <2 x double> %broadcast.splat50, %reverse
  %44 = fadd <2 x double> %strided.vec44, %43
  %45 = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %42
  %46 = getelementptr double, double* %45, i64 -1
  %47 = bitcast double* %46 to <4 x double>*
  %interleaved.vec = shufflevector <2 x double> %41, <2 x double> %44, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec, <4 x double>* %47, align 8
...
for.inc32.preheader1:                             ; preds = %middle.block, %min.iters.checked, %for.inc32.preheader
  %indvars.iv20.ph = phi i64 [ %indvars.iv20.unr.ph, %min.iters.checked ], [ %indvars.iv20.unr.ph, %for.inc32.preheader ], [ %ind.end, %middle.block ]
  %49 = insertelement <2 x double> undef, double %div, i32 0
  %mul28.v.i0.2 = shufflevector <2 x double> %49, <2 x double> undef, <2 x i32> zeroinitializer
  br label %for.inc32

for.inc32:                                        ; preds = %for.inc32.preheader1, %for.inc32
  %indvars.iv20 = phi i64 [ %indvars.iv.next21.1, %for.inc32 ], [ %indvars.iv20.ph, %for.inc32.preheader1 ]
  %arrayidx23 = getelementptr inbounds double, double* %y, i64 %indvars.iv20
  %50 = bitcast double* %arrayidx23 to <2 x double>*
  %arrayidx31 = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %indvars.iv20
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  %51 = load <2 x double>, <2 x double>* %50, align 8
  %sub25.1 = sub nsw i64 %sub24, %indvars.iv.next21
  %arrayidx27.1 = getelementptr inbounds double, double* %y, i64 %sub25.1
  %52 = bitcast double* %arrayidx27.1 to <2 x double>*
  %53 = load <2 x double>, <2 x double>* %52, align 8
  %mul28.1 = fmul <2 x double> %mul28.v.i0.2, %53
  %add29.v.i1 = shufflevector <2 x double> %mul28.1, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %add29 = fadd <2 x double> %51, %add29.v.i1
  %54 = bitcast double* %arrayidx31 to <2 x double>*
  store <2 x double> %add29, <2 x double>* %54, align 8
  %indvars.iv.next21.1 = add nsw i64 %indvars.iv20, 2
  %exitcond25.1 = icmp eq i64 %indvars.iv.next21.1, %indvars.iv34
...
for.inc47:                                        ; preds = %for.inc47.loopexit, %middle.block, %for.inc32.prol.loopexit
  ...
  br i1 %exitcond36, label %for.end49, label %for.inc.lr.ph
