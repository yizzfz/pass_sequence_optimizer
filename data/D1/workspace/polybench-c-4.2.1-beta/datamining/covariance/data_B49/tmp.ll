...
; <label>:12:                                     ; preds = %2
  ...
  br i1 %14, label %15, label %.._crit_edge_crit_edge4

.._crit_edge_crit_edge4:                          ; preds = %12
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %.._crit_edge_crit_edge4, %.._crit_edge_crit_edge, %15
...
.preheader:                                       ; preds = %..preheader_crit_edge, %3
  %indvars.iv4 = phi i64 [ 0, %3 ], [ %indvars.iv.next5, %..preheader_crit_edge ]
...
.lr.ph37.split.us.preheader:
  ...
  %sunkaddr104 = ptrtoint double* %5 to i64
  br label %.lr.ph37.split.us

.lr.ph37.split.us:                                ; preds = %._crit_edge34.us..lr.ph37.split.us_crit_edge, %.lr.ph37.split.us.preheader
  %indvars.iv67 = phi i64 [ 0, %.lr.ph37.split.us.preheader ], [ %indvars.iv.next68, %._crit_edge34.us..lr.ph37.split.us_crit_edge ]
  %7 = getelementptr inbounds double, double* %5, i64 %indvars.iv67
  store double 0.000000e+00, double* %7, align 8
  %sunkaddr8.us = shl i64 %indvars.iv67, 3
  %sunkaddr9.us = add i64 %6, %sunkaddr8.us
  %sunkaddr10.us = inttoptr i64 %sunkaddr9.us to double*
  %.pre = load double, double* %sunkaddr10.us, align 8
  %sunkaddr101 = shl i64 %indvars.iv67, 3
  %sunkaddr102 = add i64 %sunkaddr, %sunkaddr101
  %sunkaddr103 = inttoptr i64 %sunkaddr102 to double*
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.._crit_edge_crit_edge, %.lr.ph37.split.us
  %8 = phi double [ %.pre, %.lr.ph37.split.us ], [ %20, %._crit_edge.._crit_edge_crit_edge ]
  %indvars.iv64 = phi i64 [ 0, %.lr.ph37.split.us ], [ %indvars.iv.next65.3, %._crit_edge.._crit_edge_crit_edge ]
  %9 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv64, i64 %indvars.iv67
  %10 = load double, double* %9, align 8
  %11 = fadd double %10, %8
  store double %11, double* %sunkaddr103, align 8
  ...
  store double %14, double* %sunkaddr103, align 8
  ...
  store double %17, double* %sunkaddr103, align 8
  ...
  store double %20, double* %sunkaddr103, align 8
  %indvars.iv.next65.3 = add nsw i64 %indvars.iv64, 4
  %exitcond66.3 = icmp eq i64 %indvars.iv.next65.3, 1400
  br i1 %exitcond66.3, label %._crit_edge34.us, label %._crit_edge.._crit_edge_crit_edge
...
._crit_edge34.us:                                 ; preds = %._crit_edge
  %21 = fdiv double %20, %2
  %sunkaddr105 = shl i64 %indvars.iv67, 3
  ...
  br i1 %exitcond69, label %._crit_edge34.us..preheader6.us_crit_edge, label %._crit_edge34.us..lr.ph37.split.us_crit_edge

._crit_edge34.us..lr.ph37.split.us_crit_edge:     ; preds = %._crit_edge34.us
  br label %.lr.ph37.split.us
...
.preheader6.us:                                   ; preds = %._crit_edge29.us..preheader6.us_crit_edge, %._crit_edge34.us..preheader6.us_crit_edge
  %indvars.iv60 = phi i64 [ 0, %._crit_edge34.us..preheader6.us_crit_edge ], [ %22, %._crit_edge29.us..preheader6.us_crit_edge ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %3, i64 %indvars.iv60, i64 0
  %22 = add i64 %indvars.iv60, 1
  %scevgep87 = getelementptr [1200 x double], [1200 x double]* %3, i64 %22, i64 0
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.body.preheader
  ...
  %wide.vec94 = load <8 x double>, <8 x double>* %26, align 8, !alias.scope !4, !noalias !1
  %27 = fsub <8 x double> %wide.vec94, %wide.vec
  ...
  br i1 %38, label %._crit_edge29.us.loopexit108, label %vector.body.vector.body_crit_edge, !llvm.loop !6

vector.body.vector.body_crit_edge:                ; preds = %vector.body
  br label %vector.body

._crit_edge74:                                    ; preds = %._crit_edge74.._crit_edge74_crit_edge, %._crit_edge74.preheader
  %indvars.iv57 = phi i64 [ %indvars.iv.next58.3, %._crit_edge74.._crit_edge74_crit_edge ], [ 0, %._crit_edge74.preheader ]
  ...
  br i1 %exitcond59.3, label %._crit_edge29.us.loopexit, label %._crit_edge74.._crit_edge74_crit_edge, !llvm.loop !9
...
._crit_edge29.us.loopexit108:                     ; preds = %vector.body
  br label %._crit_edge29.us

._crit_edge29.us:                                 ; preds = %._crit_edge29.us.loopexit108, %._crit_edge29.us.loopexit
  %exitcond62 = icmp eq i64 %22, 1400
  br i1 %exitcond62, label %.preheader.us.preheader, label %._crit_edge29.us..preheader6.us_crit_edge

._crit_edge29.us..preheader6.us_crit_edge:        ; preds = %._crit_edge29.us
  br label %.preheader6.us
...
._crit_edge18.us-lcssa.us.us:                     ; preds = %._crit_edge.us.us
  ...
  br i1 %exitcond48, label %._crit_edge20, label %._crit_edge18.us-lcssa.us.us..lr.ph17.us_crit_edge

._crit_edge18.us-lcssa.us.us..lr.ph17.us_crit_edge: ; preds = %._crit_edge18.us-lcssa.us.us
  br label %.lr.ph17.us

.lr.ph17.us:                                      ; preds = %._crit_edge18.us-lcssa.us.us..lr.ph17.us_crit_edge, %.preheader.us.preheader
  %indvars.iv46 = phi i64 [ 0, %.preheader.us.preheader ], [ %indvars.iv.next47, %._crit_edge18.us-lcssa.us.us..lr.ph17.us_crit_edge ]
  br label %.lr.ph.us.us

.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us..lr.ph.us.us_crit_edge, %.lr.ph17.us
  %indvars.iv43 = phi i64 [ %indvars.iv46, %.lr.ph17.us ], [ %indvars.iv.next44, %._crit_edge.us.us..lr.ph.us.us_crit_edge ]
...
._crit_edge.us.us:                                ; preds = %._crit_edge75
  ...
  br i1 %exitcond45, label %._crit_edge18.us-lcssa.us.us, label %._crit_edge.us.us..lr.ph.us.us_crit_edge

._crit_edge.us.us..lr.ph.us.us_crit_edge:         ; preds = %._crit_edge.us.us
  br label %.lr.ph.us.us

._crit_edge75:                                    ; preds = %._crit_edge75.._crit_edge75_crit_edge, %.lr.ph.us.us
  %63 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %75, %._crit_edge75.._crit_edge75_crit_edge ]
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %._crit_edge75.._crit_edge75_crit_edge ]
  ...
  br i1 %exitcond.1, label %._crit_edge.us.us, label %._crit_edge75.._crit_edge75_crit_edge
