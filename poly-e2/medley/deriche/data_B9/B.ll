...
entry:
  ...
  tail call void @kernel_deriche(i32 4096, i32 2160, float %0, [2160 x float]* %arraydecay, [2160 x float]* %arraydecay6, [2160 x float]* %arraydecay7, [2160 x float]* %arraydecay8)
...
if.then:                                          ; preds = %land.lhs.true
  tail call void @print_array(i32 4096, i32 2160, [2160 x float]* %arraydecay6)
  br label %if.end
...
define internal void @init_array(i32 %w, i32 %h, float* nocapture %alpha, [2160 x float]* nocapture %imgIn) #2 {
entry:
...
for.cond31.preheader.us:                          ; preds = %for.cond31.preheader.us.preheader, %for.cond31.for.inc55_crit_edge.us
  ...
  br i1 %lcmp.mod92, label %for.inc.us.prol.loopexit, label %for.inc.us.prol
...
for.inc.us.prol.loopexit:                         ; preds = %for.inc.us.prol, %for.cond31.preheader.us
  %indvars.iv87.unr.ph = phi i64 [ 1, %for.inc.us.prol ], [ 0, %for.cond31.preheader.us ]
  %xm1.036.us.unr.ph = phi float [ %3, %for.inc.us.prol ], [ 0.000000e+00, %for.cond31.preheader.us ]
  %ym1.035.us.unr.ph = phi float [ %add42.us.prol, %for.inc.us.prol ], [ 0.000000e+00, %for.cond31.preheader.us ]
...
for.inc.us:                                       ; preds = %for.inc.us.preheader, %for.inc.us
  %indvars.iv87 = phi i64 [ %indvars.iv.next88.1, %for.inc.us ], [ %indvars.iv87.unr.ph, %for.inc.us.preheader ]
  %ym2.038.us = phi float [ %add42.us, %for.inc.us ], [ 0.000000e+00, %for.inc.us.preheader ]
  %xm1.036.us = phi float [ %7, %for.inc.us ], [ %xm1.036.us.unr.ph, %for.inc.us.preheader ]
  %ym1.035.us = phi float [ %add42.us.1, %for.inc.us ], [ %ym1.035.us.unr.ph, %for.inc.us.preheader ]
  ...
  br i1 %exitcond90.1, label %for.cond31.for.inc55_crit_edge.us.loopexit, label %for.inc.us
...
for.inc84.us:                                     ; preds = %for.cond62.preheader.us, %for.inc84.us
  %indvars.iv80 = phi i64 [ %8, %for.cond62.preheader.us ], [ %indvars.iv.next81, %for.inc84.us ]
  %yp2.030.us = phi float [ 0.000000e+00, %for.cond62.preheader.us ], [ %yp1.029.us, %for.inc84.us ]
  %yp1.029.us = phi float [ 0.000000e+00, %for.cond62.preheader.us ], [ %add71.us, %for.inc84.us ]
  %xp2.028.us = phi float [ 0.000000e+00, %for.cond62.preheader.us ], [ %xp1.027.us, %for.inc84.us ]
  %xp1.027.us = phi float [ 0.000000e+00, %for.cond62.preheader.us ], [ %9, %for.inc84.us ]
...
for.cond92.preheader.us:                          ; preds = %for.cond92.preheader.us.preheader, %for.cond92.for.inc112_crit_edge.us
  ...
  br i1 %lcmp.mod74, label %for.inc109.us.prol.loopexit, label %for.inc109.us.prol
...
for.inc109.us.prol.loopexit:                      ; preds = %for.inc109.us.prol, %for.cond92.preheader.us
  %indvars.iv69.unr.ph = phi i64 [ 1, %for.inc109.us.prol ], [ 0, %for.cond92.preheader.us ]
...
for.inc109.us.preheader:                          ; preds = %for.inc109.us.prol.loopexit
  ...
  br i1 %min.iters.check, label %for.inc109.us.preheader193, label %min.iters.checked

min.iters.checked:                                ; preds = %for.inc109.us.preheader
  %n.mod.vf = and i64 %17, 3
  %n.vec = sub i64 %17, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  br i1 %cmp.zero, label %for.inc109.us.preheader193, label %vector.memcheck
...
vector.memcheck:                                  ; preds = %min.iters.checked
  ...
  br i1 %conflict.rdx, label %for.inc109.us.preheader193, label %vector.body.preheader
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.cond92.for.inc112_crit_edge.us, label %for.inc109.us.preheader193

for.inc109.us.preheader193:                       ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.inc109.us.preheader
  %indvars.iv69.ph = phi i64 [ %indvars.iv69.unr.ph, %vector.memcheck ], [ %indvars.iv69.unr.ph, %min.iters.checked ], [ %indvars.iv69.unr.ph, %for.inc109.us.preheader ], [ %ind.end, %middle.block ]
  br label %for.inc109.us

for.inc109.us:                                    ; preds = %for.inc109.us.preheader193, %for.inc109.us
  %indvars.iv69 = phi i64 [ %indvars.iv.next70.1, %for.inc109.us ], [ %indvars.iv69.ph, %for.inc109.us.preheader193 ]
  ...
  br i1 %exitcond72.1, label %for.cond92.for.inc112_crit_edge.us.loopexit, label %for.inc109.us, !llvm.loop !15
...
for.cond118.preheader.us:                         ; preds = %for.cond118.preheader.us.preheader, %for.cond118.for.inc147_crit_edge.us
  ...
  br i1 %lcmp.mod63, label %for.inc144.us.prol.loopexit, label %for.inc144.us.prol
...
for.inc144.us.prol.loopexit:                      ; preds = %for.inc144.us.prol, %for.cond118.preheader.us
  %indvars.iv58.unr.ph = phi i64 [ 1, %for.inc144.us.prol ], [ 0, %for.cond118.preheader.us ]
  %tm1.016.us.unr.ph = phi float [ %45, %for.inc144.us.prol ], [ 0.000000e+00, %for.cond118.preheader.us ]
  %ym1.115.us.unr.ph = phi float [ %add131.us.prol, %for.inc144.us.prol ], [ 0.000000e+00, %for.cond118.preheader.us ]
...
for.inc144.us:                                    ; preds = %for.inc144.us.preheader, %for.inc144.us
  %indvars.iv58 = phi i64 [ %indvars.iv.next59.1, %for.inc144.us ], [ %indvars.iv58.unr.ph, %for.inc144.us.preheader ]
  %ym2.118.us = phi float [ %add131.us, %for.inc144.us ], [ 0.000000e+00, %for.inc144.us.preheader ]
  %tm1.016.us = phi float [ %49, %for.inc144.us ], [ %tm1.016.us.unr.ph, %for.inc144.us.preheader ]
  %ym1.115.us = phi float [ %add131.us.1, %for.inc144.us ], [ %ym1.115.us.unr.ph, %for.inc144.us.preheader ]
  ...
  br i1 %exitcond61.1, label %for.cond118.for.inc147_crit_edge.us.loopexit, label %for.inc144.us
...
for.inc176.us:                                    ; preds = %for.cond154.preheader.us, %for.inc176.us
  %indvars.iv51 = phi i64 [ %50, %for.cond154.preheader.us ], [ %indvars.iv.next52, %for.inc176.us ]
  %yp2.110.us = phi float [ 0.000000e+00, %for.cond154.preheader.us ], [ %yp1.19.us, %for.inc176.us ]
  %yp1.19.us = phi float [ 0.000000e+00, %for.cond154.preheader.us ], [ %add163.us, %for.inc176.us ]
  %tp2.08.us = phi float [ 0.000000e+00, %for.cond154.preheader.us ], [ %tp1.07.us, %for.inc176.us ]
  %tp1.07.us = phi float [ 0.000000e+00, %for.cond154.preheader.us ], [ %51, %for.inc176.us ]
...
for.inc202.us.preheader:                          ; preds = %for.inc202.us.prol.loopexit
  ...
  br i1 %min.iters.check142, label %for.inc202.us.preheader192, label %min.iters.checked143

min.iters.checked143:                             ; preds = %for.inc202.us.preheader
  %n.mod.vf144 = and i64 %59, 3
  %n.vec145 = sub i64 %59, %n.mod.vf144
  %cmp.zero146 = icmp eq i64 %n.vec145, 0
  br i1 %cmp.zero146, label %for.inc202.us.preheader192, label %vector.memcheck174
...
vector.memcheck174:                               ; preds = %min.iters.checked143
  ...
  br i1 %conflict.rdx172, label %for.inc202.us.preheader192, label %vector.body139.preheader
...
middle.block140:                                  ; preds = %vector.body139
  ...
  br i1 %cmp.n180, label %for.cond185.for.inc205_crit_edge.us, label %for.inc202.us.preheader192

for.inc202.us.preheader192:                       ; preds = %middle.block140, %vector.memcheck174, %min.iters.checked143, %for.inc202.us.preheader
  %indvars.iv.ph = phi i64 [ %indvars.iv.unr.ph, %vector.memcheck174 ], [ %indvars.iv.unr.ph, %min.iters.checked143 ], [ %indvars.iv.unr.ph, %for.inc202.us.preheader ], [ %ind.end179, %middle.block140 ]
  br label %for.inc202.us

for.inc202.us:                                    ; preds = %for.inc202.us.preheader192, %for.inc202.us
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %for.inc202.us ], [ %indvars.iv.ph, %for.inc202.us.preheader192 ]
...
for.cond185.for.inc205_crit_edge.us:              ; preds = %for.cond185.for.inc205_crit_edge.us.loopexit, %middle.block140, %for.inc202.us.prol.loopexit
