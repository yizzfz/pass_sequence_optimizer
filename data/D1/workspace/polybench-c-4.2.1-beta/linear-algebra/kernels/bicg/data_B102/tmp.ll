...
.lr.ph9.split.us:                                 ; preds = %._crit_edge.us..lr.ph9.split.us_crit_edge, %.lr.ph9.split.us.preheader
  %indvars.iv27.us = phi i64 [ %indvars.iv.next3.us, %._crit_edge.us..lr.ph9.split.us_crit_edge ], [ 0, %.lr.ph9.split.us.preheader ]
  %3 = trunc i64 %indvars.iv27.us to i32
  %4 = srem i32 %3, 2100
  %5 = sitofp i32 %4 to double
  %6 = fdiv double %5, 2.100000e+03
  %7 = getelementptr inbounds double, double* %1, i64 %indvars.iv27.us
  store double %6, double* %7, align 8
  br label %.lr.ph9.split.us.new

.lr.ph9.split.us.new:                             ; preds = %.lr.ph9.split.us.new..lr.ph9.split.us.new_crit_edge, %.lr.ph9.split.us
  %indvars.iv6.us = phi i64 [ %indvars.iv.next.us.1, %.lr.ph9.split.us.new..lr.ph9.split.us.new_crit_edge ], [ 0, %.lr.ph9.split.us ]
  %indvars.iv.next.us = or i64 %indvars.iv6.us, 1
  %8 = mul nuw nsw i64 %indvars.iv.next.us, %indvars.iv27.us
  ...
  %13 = mul nuw nsw i64 %indvars.iv.next.us.1, %indvars.iv27.us
  ...
  br i1 %exitcond.1, label %._crit_edge.us, label %.lr.ph9.split.us.new..lr.ph9.split.us.new_crit_edge

.lr.ph9.split.us.new..lr.ph9.split.us.new_crit_edge: ; preds = %.lr.ph9.split.us.new
  br label %.lr.ph9.split.us.new

._crit_edge.us:                                   ; preds = %.lr.ph9.split.us.new
  %indvars.iv.next3.us = add nuw nsw i64 %indvars.iv27.us, 1
  %exitcond16 = icmp eq i64 %indvars.iv.next3.us, 2100
  br i1 %exitcond16, label %._crit_edge10, label %._crit_edge.us..lr.ph9.split.us_crit_edge

._crit_edge.us..lr.ph9.split.us_crit_edge:        ; preds = %._crit_edge.us
  br label %.lr.ph9.split.us

.lr.ph13.new:                                     ; preds = %.lr.ph13.new..lr.ph13.new_crit_edge, %.lr.ph13
  %indvars.iv411 = phi i64 [ %indvars.iv.next5.1, %.lr.ph13.new..lr.ph13.new_crit_edge ], [ 0, %.lr.ph13 ]
  %21 = trunc i64 %indvars.iv411 to i32
  %22 = srem i32 %21, 1900
  %23 = sitofp i32 %22 to double
  %24 = getelementptr inbounds double, double* %2, i64 %indvars.iv411
  %25 = trunc i64 %indvars.iv411 to i32
  %26 = or i32 %25, 1
  %27 = srem i32 %26, 1900
  ...
  %indvars.iv.next5.1 = add nsw i64 %indvars.iv411, 2
  %exitcond18.1 = icmp eq i64 %indvars.iv.next5.1, 1900
  br i1 %exitcond18.1, label %.lr.ph9.split.us.preheader, label %.lr.ph13.new..lr.ph13.new_crit_edge

.lr.ph13.new..lr.ph13.new_crit_edge:              ; preds = %.lr.ph13.new
  br label %.lr.ph13.new

.lr.ph9.split.us.preheader:                       ; preds = %.lr.ph13.new
  br label %.lr.ph9.split.us
...
.lr.ph9.split.us:                                 ; preds = %._crit_edge.us..lr.ph9.split.us_crit_edge, %.lr.ph13.preheader
  %indvars.iv27.us = phi i64 [ %indvars.iv.next3.us, %._crit_edge.us..lr.ph9.split.us_crit_edge ], [ 0, %.lr.ph13.preheader ]
  %6 = getelementptr inbounds double, double* %2, i64 %indvars.iv27.us
  store double 0.000000e+00, double* %6, align 8
  %sunkaddr15 = shl nuw nsw i64 %indvars.iv27.us, 3
...
; <label>:7:                                      ; preds = %._crit_edge, %.lr.ph9.split.us
  %indvars.iv6.us = phi i64 [ 0, %.lr.ph9.split.us ], [ %indvars.iv.next.us, %._crit_edge ]
  %8 = getelementptr inbounds double, double* %1, i64 %indvars.iv6.us
  %9 = load double, double* %8, align 8
  %10 = load double, double* %sunkaddr17, align 8
  ...
  %15 = load double, double* %sunkaddr21, align 8
  ...
  store double %20, double* %sunkaddr21, align 8
...
._crit_edge.us:                                   ; preds = %7
  %indvars.iv.next3.us = add nuw nsw i64 %indvars.iv27.us, 1
  %exitcond27 = icmp eq i64 %indvars.iv.next3.us, 2100
  br i1 %exitcond27, label %._crit_edge10, label %._crit_edge.us..lr.ph9.split.us_crit_edge
...
.lr.ph9:                                          ; preds = %..lr.ph9_crit_edge, %.lr.ph9.preheader
  %indvars.iv17 = phi i64 [ %indvars.iv.next2, %..lr.ph9_crit_edge ], [ 0, %.lr.ph9.preheader ]
  %6 = trunc i64 %indvars.iv17 to i32
  %7 = srem i32 %6, 20
  %8 = icmp eq i32 %7, 0
  br i1 %8, label %9, label %.lr.ph9._crit_edge

.lr.ph9._crit_edge:                               ; preds = %.lr.ph9
  br label %11
...
; <label>:11:                                     ; preds = %.lr.ph9._crit_edge, %9
  ...
  br i1 %exitcond11, label %._crit_edge10, label %..lr.ph9_crit_edge

..lr.ph9_crit_edge:                               ; preds = %11
  br label %.lr.ph9
...
.lr.ph:                                           ; preds = %..lr.ph_crit_edge, %._crit_edge10
  %indvars.iv6 = phi i64 [ %indvars.iv.next, %..lr.ph_crit_edge ], [ 0, %._crit_edge10 ]
