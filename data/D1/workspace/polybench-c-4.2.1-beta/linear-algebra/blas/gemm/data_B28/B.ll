...
._crit_edge.preheader:                            ; preds = %58, %8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %41, label %._crit_edge3.loopexit34, label %vector.body, !llvm.loop !9
...
._crit_edge3:                                     ; preds = %._crit_edge3.loopexit34, %._crit_edge3.loopexit
  ...
  br i1 %exitcond, label %58, label %._crit_edge4.preheader

; <label>:58:                                     ; preds = %._crit_edge3
  %exitcond15 = icmp eq i64 %11, 1000
  br i1 %exitcond15, label %59, label %._crit_edge.preheader
