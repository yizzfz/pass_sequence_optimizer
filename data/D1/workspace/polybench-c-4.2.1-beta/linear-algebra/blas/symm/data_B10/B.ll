...
._crit_edge48:                                    ; preds = %._crit_edge48, %.preheader7.us
  %indvars.iv44 = phi i64 [ 0, %.preheader7.us ], [ %indvars.iv.next45, %._crit_edge48 ]
  ...
  br i1 %42, label %._crit_edge48, label %._crit_edge19.us

._crit_edge19.us:                                 ; preds = %._crit_edge48
...
.preheader5:                                      ; preds = %._crit_edge, %.preheader5.lr.ph
  %indvars.iv42 = phi i64 [ %54, %.preheader5.lr.ph ], [ %indvars.iv.next43, %._crit_edge ]
  %indvars.iv32 = phi i64 [ %49, %.preheader5.lr.ph ], [ %indvars.iv.next33, %._crit_edge ]
  %indvar = phi i32 [ 0, %.preheader5.lr.ph ], [ %indvar.next, %._crit_edge ]
  %indvars.iv30 = phi i32 [ %48, %.preheader5.lr.ph ], [ %indvars.iv.next31, %._crit_edge ]
  %57 = sub i32 %51, %indvar
  %58 = sub i32 %53, %indvar
  %59 = icmp slt i64 %indvars.iv42, 0
  br i1 %59, label %.preheader, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader5
  %60 = add i32 %48, %indvar
  %xtraiter = and i32 %60, 1
  %lcmp.mod = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.lr.ph
  %61 = trunc i64 %indvars.iv42 to i32
  %62 = srem i32 %61, 100
  %63 = sitofp i32 %62 to double
  %64 = fdiv double %63, %47
  %65 = getelementptr inbounds [1000 x double], [1000 x double]* %46, i64 %indvars.iv42, i64 0
...
.prol.loopexit:                                   ; preds = %.lr.ph, %.prol.preheader
  ...
  %66 = sub i32 0, %indvar
  %67 = icmp eq i32 %.promoted, %66
  br i1 %67, label %.preheader, label %.prol.loopexit..lr.ph.new_crit_edge
...
.preheader:                                       ; preds = %.preheader.loopexit, %.prol.loopexit, %.preheader5
  ...
  %68 = icmp slt i64 %indvars.iv.next43, %56
  br i1 %68, label %.lr.ph11, label %._crit_edge

.lr.ph11:                                         ; preds = %.preheader
  %xtraiter38 = and i32 %57, 7
...
.prol.preheader36:                                ; preds = %.prol.preheader36.preheader, %.prol.preheader36
  ...
  %69 = getelementptr inbounds [1000 x double], [1000 x double]* %46, i64 %indvars.iv42, i64 %indvars.iv34.prol
...
.prol.loopexit37:                                 ; preds = %.prol.loopexit37.loopexit, %.lr.ph11
  ...
  %70 = icmp ult i32 %58, 7
  br i1 %70, label %._crit_edge, label %.lr.ph11.new.preheader
...
.lr.ph.new:                                       ; preds = %.lr.ph.new, %.prol.loopexit..lr.ph.new_crit_edge
  %indvars.iv = phi i64 [ %indvars.iv.unr.ph, %.prol.loopexit..lr.ph.new_crit_edge ], [ %indvars.iv.next.1, %.lr.ph.new ]
  %71 = add nsw i64 %indvars.iv, %indvars.iv42
  %72 = trunc i64 %71 to i32
  %73 = srem i32 %72, 100
  %74 = sitofp i32 %73 to double
  %75 = fdiv double %74, %47
  %76 = getelementptr inbounds [1000 x double], [1000 x double]* %46, i64 %indvars.iv42, i64 %indvars.iv
  store double %75, double* %76, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %77 = add nsw i64 %indvars.iv.next, %indvars.iv42
  %78 = trunc i64 %77 to i32
  %79 = srem i32 %78, 100
  %80 = sitofp i32 %79 to double
  %81 = fdiv double %80, %47
  %82 = getelementptr inbounds [1000 x double], [1000 x double]* %46, i64 %indvars.iv42, i64 %indvars.iv.next
...
.lr.ph11.new:                                     ; preds = %.lr.ph11.new.preheader, %.lr.ph11.new
  ...
  %83 = getelementptr inbounds [1000 x double], [1000 x double]* %46, i64 %indvars.iv42, i64 %indvars.iv34
  store double -9.990000e+02, double* %83, align 8
  %indvars.iv.next35 = add nsw i64 %indvars.iv34, 1
  %84 = getelementptr inbounds [1000 x double], [1000 x double]* %46, i64 %indvars.iv42, i64 %indvars.iv.next35
  store double -9.990000e+02, double* %84, align 8
  %indvars.iv.next35.1 = add nsw i64 %indvars.iv34, 2
  %85 = getelementptr inbounds [1000 x double], [1000 x double]* %46, i64 %indvars.iv42, i64 %indvars.iv.next35.1
  store double -9.990000e+02, double* %85, align 8
  %indvars.iv.next35.2 = add nsw i64 %indvars.iv34, 3
  %86 = getelementptr inbounds [1000 x double], [1000 x double]* %46, i64 %indvars.iv42, i64 %indvars.iv.next35.2
  store double -9.990000e+02, double* %86, align 8
  %indvars.iv.next35.3 = add nsw i64 %indvars.iv34, 4
  %87 = getelementptr inbounds [1000 x double], [1000 x double]* %46, i64 %indvars.iv42, i64 %indvars.iv.next35.3
  store double -9.990000e+02, double* %87, align 8
  %indvars.iv.next35.4 = add nsw i64 %indvars.iv34, 5
  %88 = getelementptr inbounds [1000 x double], [1000 x double]* %46, i64 %indvars.iv42, i64 %indvars.iv.next35.4
  store double -9.990000e+02, double* %88, align 8
  %indvars.iv.next35.5 = add nsw i64 %indvars.iv34, 6
  %89 = getelementptr inbounds [1000 x double], [1000 x double]* %46, i64 %indvars.iv42, i64 %indvars.iv.next35.5
  store double -9.990000e+02, double* %89, align 8
  %indvars.iv.next35.6 = add nsw i64 %indvars.iv34, 7
  %90 = getelementptr inbounds [1000 x double], [1000 x double]* %46, i64 %indvars.iv42, i64 %indvars.iv.next35.6
  ...
  %exitcond.7 = icmp eq i32 %lftr.wideiv.7, %45
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit37, %.preheader
  %91 = icmp slt i64 %indvars.iv.next43, %55
  %indvars.iv.next31 = add i32 %indvars.iv30, 1
  %indvar.next = add i32 %indvar, 1
  %indvars.iv.next33 = add nsw i64 %indvars.iv32, 1
  br i1 %91, label %.preheader5, label %._crit_edge14

._crit_edge14:                                    ; preds = %._crit_edge
  %92 = trunc i64 %indvars.iv.next43 to i32
...
.preheader.lr.ph:                                 ; preds = %7
  ...
  %33 = fmul double %25, 0.000000e+00
  ...
  %broadcast.splatinsert53 = insertelement <2 x double> undef, double %23, i32 0
  %broadcast.splat54 = shufflevector <2 x double> %broadcast.splatinsert53, <2 x double> undef, <2 x i32> zeroinitializer
  %broadcast.splatinsert57 = insertelement <2 x double> undef, double %25, i32 0
...
.preheader:                                       ; preds = %._crit_edge6, %.preheader.lr.ph
  ...
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %._crit_edge6 ], [ %31, %.preheader.lr.ph ]
  %indvars.iv33 = phi i32 [ %indvars.iv.next34, %._crit_edge6 ], [ %.promoted, %.preheader.lr.ph ]
  ...
  %scevgep = getelementptr [1200 x double], [1200 x double]* %24, i64 %36, i64 0
  %scevgep41 = getelementptr [1200 x double], [1200 x double]* %24, i64 %36, i64 %smax40
  %scevgep43 = getelementptr [1200 x double], [1200 x double]* %26, i64 %36, i64 0
  %scevgep45 = getelementptr [1200 x double], [1200 x double]* %26, i64 %36, i64 %smax40
  br i1 %21, label %.lr.ph5, label %._crit_edge6

.lr.ph5:                                          ; preds = %.preheader
  %37 = icmp sgt i64 %indvars.iv35, 0
  %38 = getelementptr inbounds [1000 x double], [1000 x double]* %27, i64 %indvars.iv35, i64 %indvars.iv35
  br i1 %37, label %.lr.ph5..lr.ph5.split.us_crit_edge, label %.lr.ph5.split.preheader
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %44 = getelementptr inbounds [1200 x double], [1200 x double]* %24, i64 %indvars.iv35, i64 %index
  ...
  %wide.load52 = load <2 x double>, <2 x double>* %47, align 8, !alias.scope !6, !noalias !8
  %48 = fmul <2 x double> %broadcast.splat54, %wide.load
  %49 = fmul <2 x double> %broadcast.splat54, %wide.load52
  %50 = getelementptr inbounds [1200 x double], [1200 x double]* %26, i64 %indvars.iv35, i64 %index
  %51 = bitcast double* %50 to <2 x double>*
  %wide.load55 = load <2 x double>, <2 x double>* %51, align 8, !alias.scope !10
  %52 = getelementptr double, double* %50, i64 2
  %53 = bitcast double* %52 to <2 x double>*
  %wide.load56 = load <2 x double>, <2 x double>* %53, align 8, !alias.scope !10
  %54 = fmul <2 x double> %broadcast.splat58, %wide.load55
  %55 = fmul <2 x double> %broadcast.splat58, %wide.load56
...
.lr.ph5.split.us:                                 ; preds = %._crit_edge.us, %.lr.ph5..lr.ph5.split.us_crit_edge
  %indvars.iv31 = phi i64 [ 0, %.lr.ph5..lr.ph5.split.us_crit_edge ], [ %indvars.iv.next32, %._crit_edge.us ]
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %26, i64 %indvars.iv35, i64 %indvars.iv31
  br label %._crit_edge37

._crit_edge37:                                    ; preds = %._crit_edge37, %.lr.ph5.split.us
  %indvars.iv25 = phi i64 [ 0, %.lr.ph5.split.us ], [ %indvars.iv.next26, %._crit_edge37 ]
  %66 = phi double [ 0.000000e+00, %.lr.ph5.split.us ], [ %80, %._crit_edge37 ]
  %67 = load double, double* %65, align 8
  %68 = fmul double %25, %67
  %69 = getelementptr inbounds [1000 x double], [1000 x double]* %27, i64 %indvars.iv35, i64 %indvars.iv25
  %70 = load double, double* %69, align 8
  %71 = fmul double %68, %70
  %72 = getelementptr inbounds [1200 x double], [1200 x double]* %24, i64 %indvars.iv25, i64 %indvars.iv31
  %73 = load double, double* %72, align 8
  %74 = fadd double %71, %73
  store double %74, double* %72, align 8
  %75 = getelementptr inbounds [1200 x double], [1200 x double]* %26, i64 %indvars.iv25, i64 %indvars.iv31
  %76 = load double, double* %75, align 8
  %77 = getelementptr inbounds [1000 x double], [1000 x double]* %27, i64 %indvars.iv35, i64 %indvars.iv25
  %78 = load double, double* %77, align 8
  %79 = fmul double %76, %78
  %80 = fadd double %66, %79
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  %exitcond = icmp eq i64 %indvars.iv.next26, %wide.trip.count
  br i1 %exitcond, label %._crit_edge.us, label %._crit_edge37

._crit_edge.us:                                   ; preds = %._crit_edge37
  %81 = getelementptr inbounds [1200 x double], [1200 x double]* %24, i64 %indvars.iv35, i64 %indvars.iv31
  %82 = load double, double* %81, align 8
  %83 = fmul double %23, %82
  %84 = getelementptr inbounds [1200 x double], [1200 x double]* %26, i64 %indvars.iv35, i64 %indvars.iv31
  %85 = load double, double* %84, align 8
  %86 = fmul double %25, %85
  %87 = load double, double* %38, align 8
  %88 = fmul double %86, %87
  %89 = fadd double %83, %88
  %90 = fmul double %25, %80
  %91 = fadd double %89, %90
  %92 = getelementptr inbounds [1200 x double], [1200 x double]* %24, i64 %indvars.iv35, i64 %indvars.iv31
  store double %91, double* %92, align 8
  %indvars.iv.next32 = add nuw nsw i64 %indvars.iv31, 1
  %93 = icmp slt i64 %indvars.iv.next32, %30
  br i1 %93, label %.lr.ph5.split.us, label %._crit_edge6.loopexit
...
.lr.ph5.split:                                    ; preds = %.lr.ph5.split.preheader61, %.lr.ph5.split
  ...
  %94 = getelementptr inbounds [1200 x double], [1200 x double]* %24, i64 %indvars.iv35, i64 %indvars.iv
  %95 = load double, double* %94, align 8
  %96 = fmul double %23, %95
  %97 = getelementptr inbounds [1200 x double], [1200 x double]* %26, i64 %indvars.iv35, i64 %indvars.iv
  %98 = load double, double* %97, align 8
  %99 = fmul double %25, %98
  %100 = load double, double* %38, align 8
  %101 = fmul double %99, %100
  %102 = fadd double %96, %101
  %103 = fadd double %102, %33
  %104 = getelementptr inbounds [1200 x double], [1200 x double]* %24, i64 %indvars.iv35, i64 %indvars.iv
  store double %103, double* %104, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %105 = icmp slt i64 %indvars.iv.next, %29
  br i1 %105, label %.lr.ph5.split, label %._crit_edge6.loopexit62, !llvm.loop !14
...
._crit_edge6:                                     ; preds = %._crit_edge6.loopexit62, %._crit_edge6.loopexit, %middle.block, %.preheader
  %.lcssa411.lcssa21 = phi double [ %.lcssa411.lcssa20, %.preheader ], [ 0.000000e+00, %middle.block ], [ %80, %._crit_edge6.loopexit ], [ 0.000000e+00, %._crit_edge6.loopexit62 ]
  ...
  %106 = icmp slt i64 %indvars.iv.next36, %32
  %indvar.next = add i64 %indvar, 1
  br i1 %106, label %.preheader, label %._crit_edge12

._crit_edge12:                                    ; preds = %._crit_edge6
  %107 = trunc i64 %indvars.iv.next36 to i32
...
define internal fastcc void @print_array(i32, i32, [1200 x double]*) unnamed_addr #0 {
  ...
  %11 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %10, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #4
...
; <label>:26:                                     ; preds = %._crit_edge12
  ...
  %fputc.us = tail call i32 @fputc(i32 10, %struct._IO_FILE* %27) #4
  br label %._crit_edge11

._crit_edge11:                                    ; preds = %._crit_edge12, %26
  %28 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %29 = getelementptr inbounds [1200 x double], [1200 x double]* %17, i64 %indvars.iv9, i64 %indvars.iv
  %30 = load double, double* %29, align 8
  %31 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %28, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i64 0, i64 0), double %30) #4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
._crit_edge.us:                                   ; preds = %._crit_edge11
  ...
  %32 = icmp slt i64 %indvars.iv.next10, %20
  br i1 %32, label %.preheader.us, label %._crit_edge3.loopexit
...
._crit_edge:                                      ; preds = %3, %._crit_edge3
  ...
  %37 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %36, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #4
  %38 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %39 = tail call i64 @fwrite(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.7, i64 0, i64 0), i64 22, i64 1, %struct._IO_FILE* %38) #4
  ret void
}
