...
; <label>:6:                                      ; preds = %6, %.preheader4.us
  ...
  br i1 %exitcond22, label %._crit_edge11.us, label %6
...
.preheader.us15.new:                              ; preds = %.preheader.us15.new.preheader, %.preheader.us15.new
  ...
  %19 = fmul double %18, %2
  %20 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv25, i64 %indvars.iv35
  %21 = load double, double* %20, align 8
  %22 = fmul double %19, %21
  %23 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %indvars.iv25
  ...
  %27 = fmul double %26, %2
  %28 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv.next26, i64 %indvars.iv35
  %29 = load double, double* %28, align 8
  %30 = fmul double %27, %29
  %31 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %indvars.iv.next26
...
.preheader.us15:                                  ; preds = %._crit_edge.us18, %.preheader.us15.preheader
  ...
  %34 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv41, i64 %indvars.iv35
  br i1 %lcmp.mod33, label %.prol.loopexit31, label %.prol.preheader30

.prol.preheader30:                                ; preds = %.preheader.us15
  %35 = load double, double* %34, align 8
  %36 = fmul double %35, %2
  %37 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 0, i64 %indvars.iv35
...
.prol.loopexit31:                                 ; preds = %.preheader.us15, %.prol.preheader30
  ...
  br i1 %74, label %._crit_edge.us18, label %.preheader.us15.new.preheader
...
.lr.ph.us:                                        ; preds = %._crit_edge9.us..lr.ph.us_crit_edge, %.preheader4.us.preheader
  %indvars.iv62 = phi i2 [ 1, %.preheader4.us.preheader ], [ %indvars.iv.next63, %._crit_edge9.us..lr.ph.us_crit_edge ]
  %indvars.iv41 = phi i64 [ 0, %.preheader4.us.preheader ], [ %indvars.iv.next42, %._crit_edge9.us..lr.ph.us_crit_edge ]
  %indvars.iv39 = phi i64 [ 1, %.preheader4.us.preheader ], [ %indvars.iv.next40, %._crit_edge9.us..lr.ph.us_crit_edge ]
  %42 = add i64 %indvars.iv41, -3
  %43 = zext i2 %indvars.iv62 to i64
...
.prol.preheader:                                  ; preds = %.prol.preheader.preheader, %.prol.preheader
  ...
  %48 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %indvars.iv.prol
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.loopexit, %.lr.ph.us
  ...
  br i1 %51, label %.preheader.us15.preheader, label %.prol.loopexit..lr.ph.us.new_crit_edge
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %60
  ...
  %63 = fmul <2 x double> %strided.vec, %broadcast.splat68
  %64 = fmul <2 x double> %strided.vec64, %broadcast.splat68
  %65 = fmul <2 x double> %strided.vec65, %broadcast.splat68
  %66 = add nsw i64 %60, 3
  %67 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %66
  %68 = fmul <2 x double> %strided.vec66, %broadcast.splat68
...
.preheader.us15.preheader:                        ; preds = %.preheader.us15.preheader.loopexit, %.prol.loopexit, %middle.block
  ...
  %74 = icmp eq i64 %indvars.iv41, 0
  %75 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 0
...
._crit_edge.us18:                                 ; preds = %._crit_edge.us18.loopexit, %.prol.loopexit31
  ...
  %exitcond = icmp eq i64 %indvars.iv.next36, 1000
...
._crit_edge9.us:                                  ; preds = %._crit_edge.us18
  ...
  br i1 %exitcond44, label %._crit_edge13, label %._crit_edge9.us..lr.ph.us_crit_edge
