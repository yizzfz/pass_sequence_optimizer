...
entry:
  ...
  tail call fastcc void @init_array(i32 2000, [2000 x double]* %arraydecay2)
  tail call void (...) @polybench_timer_start() #4
  tail call fastcc void @kernel_seidel_2d(i32 500, i32 2000, [2000 x double]* %arraydecay2)
...
if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(i32 2000, [2000 x double]* %arraydecay2)
  br label %if.end
...
entry:
  ...
  br i1 %cmp10, label %for.cond1.preheader.lr.ph, label %for.end11
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc9_crit_edge.us, %for.cond1.preheader.lr.ph
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.cond1.for.inc9_crit_edge.us ], [ 0, %for.cond1.preheader.lr.ph ]
...
for.inc.us.prol:                                  ; preds = %for.cond1.preheader.us
  ...
  %arrayidx8.us.prol = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv13, i64 0
...
for.inc.us.prol.loopexit:                         ; preds = %for.inc.us.prol, %for.cond1.preheader.us
  ...
  br i1 %1, label %for.cond1.for.inc9_crit_edge.us, label %for.inc.us.preheader
...
for.inc.us:                                       ; preds = %for.inc.us.preheader, %for.inc.us
  ...
  br i1 %exitcond.1, label %for.cond1.for.inc9_crit_edge.us.loopexit, label %for.inc.us

for.cond1.for.inc9_crit_edge.us.loopexit:         ; preds = %for.inc.us
  br label %for.cond1.for.inc9_crit_edge.us

for.cond1.for.inc9_crit_edge.us:                  ; preds = %for.cond1.for.inc9_crit_edge.us.loopexit, %for.inc.us.prol.loopexit
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond16 = icmp eq i64 %indvars.iv.next14, %wide.trip.count15
  br i1 %exitcond16, label %for.end11.loopexit, label %for.cond1.preheader.us
...
entry:
  %cmp38 = icmp sgt i32 %tsteps, 0
  br i1 %cmp38, label %for.cond1.preheader.lr.ph, label %for.end71

for.cond1.preheader.lr.ph:                        ; preds = %entry
  %sub2 = add nsw i32 %n, -2
  %cmp336 = icmp slt i32 %sub2, 1
  %0 = add i32 %n, -1
...
for.cond1.preheader:                              ; preds = %for.inc69, %for.cond1.preheader.lr.ph
  %t.039 = phi i32 [ 0, %for.cond1.preheader.lr.ph ], [ %inc70, %for.inc69 ]
  br i1 %cmp336, label %for.inc69, label %for.cond5.preheader.preheader
...
for.cond5.preheader:                              ; preds = %for.cond5.preheader.preheader, %for.inc66
  ...
  %sub9 = add nsw i64 %indvars.iv40, -1
  %add42 = add nuw nsw i64 %indvars.iv40, 1
...
for.inc:                                          ; preds = %for.inc, %for.cond5.preheader
  ...
  %4 = load double, double* %arrayidx23, align 8
  %add24 = fadd double %add, %4
  ...
  %5 = load double, double* %arrayidx34, align 8
  %add35 = fadd double %add30, %5
  %arrayidx40 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv40, i64 %add21
  %6 = load double, double* %arrayidx40, align 8
  %add41 = fadd double %add35, %6
  ...
  %add48 = fadd double %add41, %7
  %arrayidx53 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %add42, i64 %indvars.iv
  %8 = load double, double* %arrayidx53, align 8
  %add54 = fadd double %add48, %8
...
for.inc66:                                        ; preds = %for.inc
  ...
  br i1 %exitcond43, label %for.inc69.loopexit, label %for.cond5.preheader
...
for.inc69:                                        ; preds = %for.inc69.loopexit, %for.cond1.preheader
  ...
  %exitcond44 = icmp eq i32 %inc70, %tsteps
  br i1 %exitcond44, label %for.end71.loopexit, label %for.cond1.preheader
