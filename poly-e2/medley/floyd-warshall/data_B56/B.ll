...
for.cond1.preheader.us:                           ; preds = %for.inc20.us, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge
  %indvars.iv11 = phi i64 [ 0, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge ], [ %indvars.iv.next12, %for.inc20.us ]
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us, %for.cond1.preheader.us
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next, %for.body3.us ]
  %0 = mul nuw nsw i64 %indvars.iv11, %indvars.iv
  ...
  %2 = add nuw nsw i64 %indvars.iv, %indvars.iv11
...
for.cond1.preheader.us.for.cond4.preheader.us.us_crit_edge: ; preds = %for.inc38.us, %entry
  %indvars.iv47 = phi i64 [ 0, %entry ], [ %indvars.iv.next48, %for.inc38.us ]
  %scevgep4 = getelementptr [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv47, i64 0
  %0 = add nuw nsw i64 %indvars.iv47, 1
  %scevgep6 = getelementptr [2800 x i32], [2800 x i32]* %path, i64 %0, i64 0
  br label %for.cond4.preheader.us.us

for.inc38.us:                                     ; preds = %for.inc35.us.us
  %indvars.iv.next48 = add nuw nsw i64 %indvars.iv47, 1
  %exitcond17 = icmp eq i64 %indvars.iv.next48, 2800
  br i1 %exitcond17, label %for.end40, label %for.cond1.preheader.us.for.cond4.preheader.us.us_crit_edge

for.cond4.preheader.us.us:                        ; preds = %for.inc35.us.us, %for.cond1.preheader.us.for.cond4.preheader.us.us_crit_edge
  %indvars.iv45 = phi i64 [ 0, %for.cond1.preheader.us.for.cond4.preheader.us.us_crit_edge ], [ %indvars.iv.next46, %for.inc35.us.us ]
  ...
  %arrayidx12.us.us = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv45, i64 %indvars.iv47
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %11 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv47, i64 %index
  ...
  br i1 %23, label %for.inc35.us.us.loopexit18, label %vector.body, !llvm.loop !9

for.inc35.us.us.loopexit:                         ; preds = %for.body6.us.us
  br label %for.inc35.us.us

for.inc35.us.us.loopexit18:                       ; preds = %vector.body
  br label %for.inc35.us.us

for.inc35.us.us:                                  ; preds = %for.inc35.us.us.loopexit18, %for.inc35.us.us.loopexit
  %indvars.iv.next46 = add nuw nsw i64 %indvars.iv45, 1
  %exitcond16 = icmp eq i64 %indvars.iv.next46, 2800
  br i1 %exitcond16, label %for.inc38.us, label %for.cond4.preheader.us.us
...
for.body6.us.us:                                  ; preds = %for.body6.us.us, %for.body6.us.us.preheader
  ...
  %arrayidx16.us.us = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv47, i64 %indvars.iv
  ...
  %arrayidx16.us.us.1 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv47, i64 %indvars.iv.next
