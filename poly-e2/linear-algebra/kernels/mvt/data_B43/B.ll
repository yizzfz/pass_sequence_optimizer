...
for.inc:                                          ; preds = %for.inc, %for.cond1.preheader
  %indvars.iv24 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next25.1, %for.inc ]
  %0 = phi double [ %.pre, %for.cond1.preheader ], [ %add.1, %for.inc ]
...
for.inc33:                                        ; preds = %for.inc33, %for.cond18.preheader
  %indvars.iv = phi i64 [ 0, %for.cond18.preheader ], [ %indvars.iv.next.1, %for.inc33 ]
  %5 = phi double [ %.pre20, %for.cond18.preheader ], [ %add30.1, %for.inc33 ]
