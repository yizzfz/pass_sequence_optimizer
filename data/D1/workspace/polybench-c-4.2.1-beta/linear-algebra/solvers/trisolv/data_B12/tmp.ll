...
; <label>:4:                                      ; preds = %._crit_edge, %.lr.ph12
  %indvars.iv18 = phi i64 [ 0, %.lr.ph12 ], [ %indvars.iv.next19, %._crit_edge ]
...
.prol.preheader:                                  ; preds = %.lr.ph
  %9 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv18, i64 0
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %22 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv18, i64 %indvars.iv.next
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %4
  %.lcssa = phi double [ %6, %4 ], [ %.lcssa15.unr.ph, %.prol.loopexit ], [ %27, %._crit_edge.loopexit ]
  %28 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv18, i64 %indvars.iv18
  ...
  store double %30, double* %sunkaddr8, align 8
  %indvars.iv.next19 = add nuw nsw i64 %indvars.iv18, 1
  %exitcond21 = icmp eq i64 %indvars.iv.next19, 2000
  br i1 %exitcond21, label %._crit_edge13, label %4
