...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit
  ...
  br i1 %exitcond14, label %._crit_edge6, label %.lr.ph
...
.lr.ph12:                                         ; preds = %._crit_edge, %.lr.ph12.preheader
  %indvars.iv21 = phi i64 [ 0, %.lr.ph12.preheader ], [ %indvars.iv.next22, %._crit_edge ]
  %4 = getelementptr inbounds double, double* %3, i64 %indvars.iv21
  %5 = load double, double* %4, align 8
  %6 = getelementptr inbounds double, double* %2, i64 %indvars.iv21
...
.prol.preheader:                                  ; preds = %.lr.ph
  %8 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv21, i64 0
  %9 = load double, double* %8, align 8
  %10 = load double, double* %2, align 8
  %11 = fmul double %9, %10
  %12 = fsub double %5, %11
  %sunkaddr14.prol = shl nsw i64 %indvars.iv21, 3
  %sunkaddr15.prol = add i64 %sunkaddr, %sunkaddr14.prol
  %sunkaddr16.prol = inttoptr i64 %sunkaddr15.prol to double*
  store double %12, double* %sunkaddr16.prol, align 8
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.lr.ph, %.prol.preheader
  %indvars.iv.unr.ph = phi i64 [ 1, %.prol.preheader ], [ 0, %.lr.ph ]
  %.unr.ph = phi double [ %12, %.prol.preheader ], [ %5, %.lr.ph ]
  %.lcssa18.unr.ph = phi double [ %12, %.prol.preheader ], [ undef, %.lr.ph ]
  %13 = icmp eq i64 %indvars.iv21, 1
  br i1 %13, label %._crit_edge, label %.lr.ph.new.preheader

.lr.ph.new.preheader:                             ; preds = %.prol.loopexit
  %sunkaddr14 = shl nsw i64 %indvars.iv21, 3
...
.lr.ph.new:                                       ; preds = %.lr.ph.new, %.lr.ph.new.preheader
  ...
  %14 = phi double [ %.unr.ph, %.lr.ph.new.preheader ], [ %26, %.lr.ph.new ]
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %21 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv21, i64 %indvars.iv.next
  %22 = load double, double* %21, align 8
  %23 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next
  %24 = load double, double* %23, align 8
  %25 = fmul double %22, %24
  %26 = fsub double %20, %25
  store double %26, double* %sunkaddr16, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %.lr.ph12
  %.lcssa = phi double [ %5, %.lr.ph12 ], [ %.lcssa18.unr.ph, %.prol.loopexit ], [ %26, %._crit_edge.loopexit ]
  %27 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv21, i64 %indvars.iv21
  %28 = load double, double* %27, align 8
  %29 = fdiv double %.lcssa, %28
  %sunkaddr6 = shl nsw i64 %indvars.iv21, 3
  %sunkaddr7 = add i64 %sunkaddr, %sunkaddr6
  %sunkaddr8 = inttoptr i64 %sunkaddr7 to double*
  store double %29, double* %sunkaddr8, align 8
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  %exitcond24 = icmp eq i64 %indvars.iv.next22, 2000
  br i1 %exitcond24, label %._crit_edge13, label %.lr.ph12
