...
for.inc31:                                        ; preds = %for.body17
  ...
  %cmp11 = icmp slt i64 %indvars.iv.next4, 1200
...
for.cond1.preheader.us:                           ; preds = %for.cond6.for.inc32_crit_edge.us, %for.cond1.preheader.us.preheader
  ...
  %indvars.iv1320.us = phi i64 [ %3, %for.cond6.for.inc32_crit_edge.us ], [ 0, %for.cond1.preheader.us.preheader ]
...
for.cond9.preheader.us:                           ; preds = %for.cond9.preheader.us.preheader, %for.inc29.us
  %indvars.iv918.us = phi i64 [ %28, %for.inc29.us ], [ 0, %for.cond9.preheader.us.preheader ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %37 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %33, i64 %indvars.iv918.us
  ...
  %49 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv1320.us, i64 %index
...
for.body11.us.preheader:                          ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.cond9.preheader.us
  ...
  %56 = sub i64 %0, %indvars.iv316.us.ph
...
for.body11.us.prol.loopexit:                      ; preds = %for.body11.us.prol.loopexit.unr-lcssa
  %60 = icmp eq i64 %indvars.iv1320.us, %indvars.iv316.us.ph
