...
@__llvm_prf_nm = private constant [139 x i8] c"\88\01\00Gsm_Long_Term_Predictor\01tmp1.ll:Calculation_of_the_LTP_parameters\01tmp1.ll:Long_term_analysis_filtering\01Gsm_Long_Term_Synthesis_Filtering", section "__llvm_prf_names"
@llvm.used = appending global [5 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_Gsm_Long_Term_Predictor to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_Calculation_of_the_LTP_parameters to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_Long_term_analysis_filtering to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_Gsm_Long_Term_Synthesis_Filtering to i8*), i8* getelementptr inbounds ([139 x i8], [139 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
