...
._crit_edge4:                                     ; preds = %48, %11
  %indvars.iv1 = phi i64 [ 0, %11 ], [ %indvars.iv.next2, %48 ]
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge4
  ...
  br i1 %exitcond.1, label %48, label %._crit_edge
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  br i1 %45, label %middle.block.loopexit66, label %vector.body, !llvm.loop !13
...
.preheader65:                                     ; preds = %86, %.preheader65.preheader
  %indvars.iv10 = phi i64 [ 0, %.preheader65.preheader ], [ %indvars.iv.next11, %86 ]
...
._crit_edge19:                                    ; preds = %._crit_edge19, %.preheader65
  %71 = phi double [ %.pre, %.preheader65 ], [ %85, %._crit_edge19 ]
...
.preheader64.preheader:                           ; preds = %86
...
.preheader:                                       ; preds = %128, %.preheader.preheader
  ...
  %.pre22 = load double, double* %112, align 8
  br label %._crit_edge21

._crit_edge21:                                    ; preds = %._crit_edge21, %.preheader
  %113 = phi double [ %.pre22, %.preheader ], [ %127, %._crit_edge21 ]
  ...
  store double %120, double* %sunkaddr65, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %127, double* %sunkaddr65, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %128, label %._crit_edge21
