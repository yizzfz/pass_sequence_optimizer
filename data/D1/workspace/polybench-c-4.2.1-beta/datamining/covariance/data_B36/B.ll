...
.lr.ph30.split.us:                                ; preds = %._crit_edge27.us, %.lr.ph30.split.us.preheader
  ...
  %sunkaddr2 = shl i64 %indvars.iv60, 3
...
._crit_edge27.us:                                 ; preds = %._crit_edge
  %18 = fdiv double %17, %0
  %sunkaddr27 = shl i64 %indvars.iv60, 3
...
.preheader6.us:                                   ; preds = %._crit_edge22.us, %._crit_edge27.us..preheader6.us_crit_edge
  ...
  %scevgep12 = getelementptr [1200 x double], [1200 x double]* %1, i64 %19, i64 0
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.vec19 = load <8 x double>, <8 x double>* %23, align 8, !alias.scope !4, !noalias !1
  %24 = fsub <8 x double> %wide.vec19, %wide.vec
  ...
  br i1 %35, label %._crit_edge22.us.loopexit30, label %vector.body, !llvm.loop !6
...
._crit_edge22.us.loopexit30:                      ; preds = %vector.body
  br label %._crit_edge22.us

._crit_edge22.us:                                 ; preds = %._crit_edge22.us.loopexit30, %._crit_edge22.us.loopexit
...
._crit_edge69:                                    ; preds = %._crit_edge69, %.lr.ph.us.us
  %60 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %72, %._crit_edge69 ]
