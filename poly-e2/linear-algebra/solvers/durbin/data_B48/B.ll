...
for.inc32.prol:                                   ; preds = %for.inc32.lr.ph
  ...
  %28 = load double, double* %sunkaddr39, align 8
...
for.inc32.preheader:                              ; preds = %for.inc32.prol.loopexit
  ...
  br i1 %min.iters.check, label %for.inc32.preheader9, label %min.iters.checked
...
min.iters.checked:                                ; preds = %for.inc32.preheader
  ...
  br i1 %cmp.zero, label %for.inc32.preheader9, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec2 = load <4 x double>, <4 x double>* %43, align 8
  ...
  %44 = fmul <2 x double> %broadcast.splat7, %reverse5
  %45 = fadd <2 x double> %strided.vec, %44
  %46 = add nuw nsw i64 %offset.idx, 1
  %47 = fmul <2 x double> %broadcast.splat7, %reverse
  %48 = fadd <2 x double> %strided.vec1, %47
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.inc47, label %for.inc32.preheader9

for.inc32.preheader9:                             ; preds = %middle.block, %min.iters.checked, %for.inc32.preheader
...
for.inc32:                                        ; preds = %for.inc32.preheader9, %for.inc32
  %indvars.iv14 = phi i64 [ %indvars.iv.next15.1, %for.inc32 ], [ %indvars.iv14.ph, %for.inc32.preheader9 ]
  ...
  %56 = sub nsw i64 %10, %indvars.iv.next15
