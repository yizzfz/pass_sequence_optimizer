...
; <label>:35:                                     ; preds = %35, %.lr.ph4.split.us
...
.lr.ph3.split.preheader:                          ; preds = %.lr.ph3
  ...
  br i1 %min.iters.check, label %.lr.ph3.split.preheader52, label %min.iters.checked

.lr.ph3.split.preheader52:                        ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.lr.ph3.split.preheader
...
min.iters.checked:                                ; preds = %.lr.ph3.split.preheader
  ...
  br i1 %cmp.zero, label %.lr.ph3.split.preheader52, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %scevgep = getelementptr double, double* %20, i64 %32
  %37 = add nsw i64 %32, 1
  %38 = icmp sgt i64 %37, %23
  %smax39 = select i1 %38, i64 %37, i64 %23
  %scevgep40 = getelementptr double, double* %20, i64 %smax39
  %scevgep42 = getelementptr double, double* %21, i64 %32
  %scevgep44 = getelementptr double, double* %21, i64 %smax39
  %bound0 = icmp ult double* %scevgep, %scevgep44
  %bound1 = icmp ult double* %scevgep42, %scevgep40
  %memcheck.conflict = and i1 %bound0, %bound1
  %ind.end = add nsw i64 %32, %n.vec
  br i1 %memcheck.conflict, label %.lr.ph3.split.preheader52, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %broadcast.splatinsert48 = insertelement <2 x double> undef, double %25, i32 0
  %broadcast.splat49 = shufflevector <2 x double> %broadcast.splatinsert48, <2 x double> undef, <2 x i32> zeroinitializer
  %broadcast.splatinsert50 = insertelement <2 x double> undef, double %33, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load47 = load <2 x double>, <2 x double>* %49, align 8, !alias.scope !1, !noalias !4
  %50 = fmul <2 x double> %broadcast.splat49, %wide.load
  %51 = fmul <2 x double> %broadcast.splat49, %wide.load47
  %52 = fadd <2 x double> %50, %broadcast.splat51
  %53 = fadd <2 x double> %51, %broadcast.splat51
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %._crit_edge4, label %.lr.ph3.split.preheader52
...
; <label>:63:                                     ; preds = %63, %.lr.ph3.split.us
...
.lr.ph3.split:                                    ; preds = %.lr.ph3.split.preheader52, %.lr.ph3.split
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %.lr.ph3.split ], [ %indvars.iv15.ph, %.lr.ph3.split.preheader52 ]
...
._crit_edge4:                                     ; preds = %._crit_edge4.loopexit53, %._crit_edge4.loopexit, %middle.block
  %.lcssa6.in = phi i64 [ %ind.end, %middle.block ], [ %indvars.iv.next12, %._crit_edge4.loopexit ], [ %indvars.iv.next16, %._crit_edge4.loopexit53 ]
  %.lcssa6 = trunc i64 %.lcssa6.in to i32
  store i32 %.lcssa6, i32* %17, align 4
  br label %96

; <label>:96:                                     ; preds = %8, %._crit_edge4
  ret void
}
...
; <label>:16:                                     ; preds = %._crit_edge, %.lr.ph
