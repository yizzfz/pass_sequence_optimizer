...
for.inc.lr.ph:                                    ; preds = %for.inc47, %entry
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc47 ], [ 1, %entry ]
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc47 ], [ 0, %entry ]
  %beta.042 = phi double [ %mul5, %for.inc47 ], [ 1.000000e+00, %entry ]
  %alpha.041 = phi double [ %div, %for.inc47 ], [ %sub3, %entry ]
  %4 = add i64 %indvars.iv62, 1
  %5 = add i64 %indvars.iv62, 1
  %mul = fmul double %alpha.041, %alpha.041
  %6 = add nsw i64 %indvars.iv64, -1
...
for.inc.prol:                                     ; preds = %for.inc.prol, %for.inc.prol.preheader
  ...
  %sum.035.prol = phi double [ 0.000000e+00, %for.inc.prol.preheader ], [ %add.prol, %for.inc.prol ]
...
for.inc.prol.loopexit:                            ; preds = %for.inc.lr.ph, %for.inc.prol.loopexit.unr-lcssa
  ...
  %sum.035.unr = phi double [ 0.000000e+00, %for.inc.lr.ph ], [ %add.prol, %for.inc.prol.loopexit.unr-lcssa ]
  %10 = icmp ult i64 %indvars.iv62, 3
...
for.inc:                                          ; preds = %for.inc, %for.inc.lr.ph.new
  ...
  %sum.035 = phi double [ %sum.035.unr, %for.inc.lr.ph.new ], [ %add.3, %for.inc ]
...
for.inc32.preheader:                              ; preds = %middle.block, %min.iters.checked, %for.inc32.lr.ph
  %indvars.iv47.ph = phi i64 [ 0, %min.iters.checked ], [ 0, %for.inc32.lr.ph ], [ %n.vec, %middle.block ]
  br label %for.inc32

for.inc32:                                        ; preds = %for.inc32.preheader, %for.inc32
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc32 ], [ %indvars.iv47.ph, %for.inc32.preheader ]
  %arrayidx23 = getelementptr inbounds double, double* %y, i64 %indvars.iv47
  %44 = load double, double* %arrayidx23, align 8
  %45 = sub nsw i64 %6, %indvars.iv47
  ...
  %exitcond53 = icmp eq i64 %indvars.iv47, %indvars.iv62
  br i1 %exitcond53, label %for.inc47.loopexit, label %for.inc32, !llvm.loop !6

for.inc47.loopexit:                               ; preds = %for.inc32
  br label %for.inc47

for.inc47:                                        ; preds = %for.inc47.loopexit, %middle.block
  %47 = shl i64 %indvars.iv62, 3
  ...
  %exitcond1 = icmp eq i64 %indvars.iv.next63, 1999
