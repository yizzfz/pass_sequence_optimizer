...
.preheader5:                                      ; preds = %middle.block._crit_edge, %11
  %indvars.iv16 = phi i64 [ 0, %11 ], [ %12, %middle.block._crit_edge ]
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  br i1 %39, label %middle.block._crit_edge.loopexit66, label %vector.body, !llvm.loop !13
...
.preheader3.preheader:                            ; preds = %middle.block._crit_edge
  br label %.preheader3

.preheader3:                                      ; preds = %80, %.preheader3.preheader
  %indvars.iv10 = phi i64 [ 0, %.preheader3.preheader ], [ %indvars.iv.next11, %80 ]
...
._crit_edge19:                                    ; preds = %._crit_edge19, %.preheader3
  %65 = phi double [ %.pre, %.preheader3 ], [ %79, %._crit_edge19 ]
  ...
  store double %72, double* %sunkaddr61, align 8
...
.preheader:                                       ; preds = %122, %.preheader.preheader
  ...
  %.pre22 = load double, double* %106, align 8
  br label %._crit_edge21

._crit_edge21:                                    ; preds = %._crit_edge21, %.preheader
  %107 = phi double [ %.pre22, %.preheader ], [ %121, %._crit_edge21 ]
  ...
  store double %114, double* %sunkaddr65, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %121, double* %sunkaddr65, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %122, label %._crit_edge21
