...
define internal fastcc void @init_array(i32, i32, double* nocapture, [1000 x double]* nocapture, [1200 x double]* nocapture) unnamed_addr #2 {
  ...
  %6 = icmp sgt i32 %0, 0
  br i1 %6, label %.lr.ph7, label %._crit_edge51
...
._crit_edge3.us:                                  ; preds = %._crit_edge3.us.loopexit, %.prol.loopexit21
  ...
  br i1 %exitcond, label %._crit_edge51.loopexit, label %._crit_edge3.us..lr.ph7.split.us_crit_edge
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit34, %.lr.ph7.split
  ...
  br i1 %exitcond49, label %._crit_edge51.loopexit52, label %._crit_edge..lr.ph7.split_crit_edge

._crit_edge..lr.ph7.split_crit_edge:              ; preds = %._crit_edge
  %indvar.next36 = add nuw nsw i32 %indvar35, 1
  br label %.lr.ph7.split

._crit_edge51.loopexit:                           ; preds = %._crit_edge3.us
  br label %._crit_edge51

._crit_edge51.loopexit52:                         ; preds = %._crit_edge
  br label %._crit_edge51

._crit_edge51:                                    ; preds = %._crit_edge51.loopexit52, %._crit_edge51.loopexit, %5
  ret void
}
