...
; <label>:3:                                      ; preds = %3, %.lr.ph14.new
  %indvars.iv412 = phi i64 [ 0, %.lr.ph14.new ], [ %indvars.iv.next5.1, %3 ]
  ...
  br i1 %exitcond19.1, label %.lr.ph10.split.us.new.preheader, label %3

.lr.ph10.split.us.new.preheader:                  ; preds = %3
  br label %.lr.ph10.split.us.new

.lr.ph10.split.us.new:                            ; preds = %._crit_edge.us, %.lr.ph10.split.us.new.preheader
  %indvars.iv27.us = phi i64 [ 0, %.lr.ph10.split.us.new.preheader ], [ %indvars.iv.next3.us, %._crit_edge.us ]
...
; <label>:21:                                     ; preds = %21, %.lr.ph10.split.us.new
  %indvars.iv6.us = phi i64 [ 0, %.lr.ph10.split.us.new ], [ %indvars.iv.next.us.1, %21 ]
...
._crit_edge.us:                                   ; preds = %21
  ...
  br i1 %exitcond17, label %._crit_edge11, label %.lr.ph10.split.us.new
...
.lr.ph10.split.us:                                ; preds = %._crit_edge.us, %.lr.ph10.split.us.preheader
  %indvars.iv27.us = phi i64 [ 0, %.lr.ph10.split.us.preheader ], [ %indvars.iv.next3.us, %._crit_edge.us ]
...
; <label>:7:                                      ; preds = %7, %.lr.ph10.split.us
  ...
  %sunkaddr1 = mul i64 %indvars.iv27.us, 8
  ...
  %sunkaddr5 = mul i64 %indvars.iv27.us, 8
...
.lr.ph9:                                          ; preds = %11, %.lr.ph9.preheader
  %indvars.iv17 = phi i64 [ 0, %.lr.ph9.preheader ], [ %indvars.iv.next2, %11 ]
...
.lr.ph:                                           ; preds = %25, %.lr.ph.preheader
  %indvars.iv6 = phi i64 [ 0, %.lr.ph.preheader ], [ %indvars.iv.next, %25 ]
