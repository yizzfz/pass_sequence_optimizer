...
for.cond31.preheader.us:                          ; preds = %for.cond31.for.inc55_crit_edge.us, %for.cond31.preheader.us.preheader
  %indvars.iv173 = phi i64 [ 0, %for.cond31.preheader.us.preheader ], [ %indvars.iv.next174, %for.cond31.for.inc55_crit_edge.us ]
  %arrayidx35.us37 = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv173, i64 0
  ...
  %arrayidx46.us45 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv173, i64 0
...
for.inc.us.for.inc.us_crit_edge:                  ; preds = %for.inc.us.for.inc.us_crit_edge.1, %for.cond31.preheader.us
  ...
  %indvars.iv17046 = phi i64 [ 0, %for.cond31.preheader.us ], [ %indvars.iv.next171.1, %for.inc.us.for.inc.us_crit_edge.1 ]
  %indvars.iv.next171 = or i64 %indvars.iv17046, 1
  %4 = load float, float* %arrayidx35.us47, align 4
  %arrayidx35.us = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv173, i64 %indvars.iv.next171
  ...
  %arrayidx46.us = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv173, i64 %indvars.iv.next171
  store float %add42.us, float* %arrayidx46.us, align 4
  %exitcond172 = icmp eq i64 %indvars.iv.next171, 2159
  br i1 %exitcond172, label %for.cond31.for.inc55_crit_edge.us, label %for.inc.us.for.inc.us_crit_edge.1

for.cond31.for.inc55_crit_edge.us:                ; preds = %for.inc.us.for.inc.us_crit_edge
  %indvars.iv.next174 = add nuw i64 %indvars.iv173, 1
  %cmp.us = icmp slt i64 %indvars.iv.next174, 4096
...
for.cond62.preheader.us.preheader:                ; preds = %for.cond31.for.inc55_crit_edge.us
  ...
  %add69.us29 = fadd float %mul39.us41, %add67.us27
  %add71.us31 = fadd float %mul41.us43, %add69.us29
...
for.cond62.preheader.us:                          ; preds = %for.cond62.preheader.us.preheader, %for.cond62.for.inc86_crit_edge.us
  %indvars.iv167 = phi i64 [ %indvars.iv.next168, %for.cond62.for.inc86_crit_edge.us ], [ 0, %for.cond62.preheader.us.preheader ]
  %arrayidx75.us32 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv167, i64 2159
  store float %add71.us31, float* %arrayidx75.us32, align 4
  %arrayidx79.us33 = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv167, i64 2159
...
for.inc84.us.for.inc84.us_crit_edge:              ; preds = %for.cond62.preheader.us, %for.inc84.us.for.inc84.us_crit_edge
  ...
  %indvars.iv.next16635 = phi i64 [ 2159, %for.cond62.preheader.us ], [ %indvars.iv.next166, %for.inc84.us.for.inc84.us_crit_edge ]
  ...
  %indvars.iv.next166 = add nsw i64 %indvars.iv.next16635, -1
  ...
  %arrayidx75.us = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv167, i64 %indvars.iv.next166
  store float %add71.us, float* %arrayidx75.us, align 4
  %arrayidx79.us = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv167, i64 %indvars.iv.next166
  %cmp63.us = icmp sgt i64 %indvars.iv.next16635, 1
...
for.cond62.for.inc86_crit_edge.us:                ; preds = %for.inc84.us.for.inc84.us_crit_edge
  ...
  %cmp59.us = icmp slt i64 %indvars.iv.next168, 4096
...
for.cond92.preheader.us:                          ; preds = %for.cond92.preheader.us.preheader, %for.cond92.for.inc112_crit_edge.us
  %indvars.iv162 = phi i64 [ %indvars.iv.next163, %for.cond92.for.inc112_crit_edge.us ], [ 0, %for.cond92.preheader.us.preheader ]
  %scevgep = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv162, i64 0
  %10 = add i64 %indvars.iv162, 1
  %scevgep50 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %10, i64 0
  %scevgep52 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv162, i64 0
  %scevgep54 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %10, i64 0
  %scevgep56 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv162, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %11 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv162, i64 %index
  ...
  %15 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv162, i64 %index
  ...
  %21 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv162, i64 %index
  ...
  %25 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv162, i64 %index.next
  ...
  %29 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv162, i64 %index.next
  ...
  %35 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv162, i64 %index.next
...
for.inc109.us:                                    ; preds = %for.inc109.us, %for.inc109.us.preheader
  %indvars.iv159 = phi i64 [ 0, %for.inc109.us.preheader ], [ %indvars.iv.next160.2, %for.inc109.us ]
  %arrayidx98.us = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv162, i64 %indvars.iv159
  %40 = load float, float* %arrayidx98.us, align 4
  %arrayidx102.us = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv162, i64 %indvars.iv159
  %41 = load float, float* %arrayidx102.us, align 4
  %add103.us = fadd float %40, %41
  %arrayidx108.us = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv162, i64 %indvars.iv159
  store float %add103.us, float* %arrayidx108.us, align 4
  %indvars.iv.next160 = add nuw nsw i64 %indvars.iv159, 1
  %arrayidx98.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv162, i64 %indvars.iv.next160
  %42 = load float, float* %arrayidx98.us.1, align 4
  %arrayidx102.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv162, i64 %indvars.iv.next160
  %43 = load float, float* %arrayidx102.us.1, align 4
  %add103.us.1 = fadd float %42, %43
  %arrayidx108.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv162, i64 %indvars.iv.next160
  store float %add103.us.1, float* %arrayidx108.us.1, align 4
  %indvars.iv.next160.1 = add nsw i64 %indvars.iv159, 2
  %arrayidx98.us.2 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv162, i64 %indvars.iv.next160.1
  %44 = load float, float* %arrayidx98.us.2, align 4
  %arrayidx102.us.2 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv162, i64 %indvars.iv.next160.1
  %45 = load float, float* %arrayidx102.us.2, align 4
  %add103.us.2 = fadd float %44, %45
  %arrayidx108.us.2 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv162, i64 %indvars.iv.next160.1
  store float %add103.us.2, float* %arrayidx108.us.2, align 4
  %exitcond161.2 = icmp eq i64 %indvars.iv.next160.1, 2159
  %indvars.iv.next160.2 = add nsw i64 %indvars.iv159, 3
  br i1 %exitcond161.2, label %for.cond92.for.inc112_crit_edge.us.loopexit, label %for.inc109.us, !llvm.loop !13
...
for.cond92.for.inc112_crit_edge.us:               ; preds = %for.cond92.for.inc112_crit_edge.us.loopexit110, %for.cond92.for.inc112_crit_edge.us.loopexit
  ...
  %cmp90.us = icmp slt i64 %indvars.iv.next163, 4096
...
for.cond118.preheader.us:                         ; preds = %for.cond118.preheader.us.preheader, %for.cond118.for.inc147_crit_edge.us
  %indvars.iv156 = phi i64 [ %indvars.iv.next157, %for.cond118.for.inc147_crit_edge.us ], [ 0, %for.cond118.preheader.us.preheader ]
  %arrayidx124.us13 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 0, i64 %indvars.iv156
  %46 = load float, float* %arrayidx124.us13, align 4
  %mul125.us14 = fmul float %div, %46
  %add127.us16 = fadd float %mul37.us39, %mul125.us14
  %add129.us18 = fadd float %mul39.us41, %add127.us16
  %add131.us20 = fadd float %mul41.us43, %add129.us18
  %arrayidx135.us21 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 0, i64 %indvars.iv156
...
for.inc144.us.for.inc144.us_crit_edge:            ; preds = %for.inc144.us.for.inc144.us_crit_edge.1, %for.cond118.preheader.us
  ...
  %arrayidx124.us = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv.next154, i64 %indvars.iv156
  ...
  %arrayidx135.us = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv.next154, i64 %indvars.iv156
  store float %add131.us, float* %arrayidx135.us, align 4
  %exitcond155 = icmp eq i64 %indvars.iv.next154, 4095
  br i1 %exitcond155, label %for.cond118.for.inc147_crit_edge.us, label %for.inc144.us.for.inc144.us_crit_edge.1
...
for.cond118.for.inc147_crit_edge.us:              ; preds = %for.inc144.us.for.inc144.us_crit_edge
  ...
  %cmp116.us = icmp slt i64 %indvars.iv.next157, 2160
...
for.cond154.preheader.us:                         ; preds = %for.cond154.preheader.us.preheader, %for.cond154.for.inc179_crit_edge.us
  ...
  store float %add71.us31, float* %arrayidx167.us8, align 4
...
for.inc176.us.for.inc176.us_crit_edge:            ; preds = %for.cond154.preheader.us, %for.inc176.us.for.inc176.us_crit_edge
  ...
  %add163.us12 = phi float [ %add71.us31, %for.cond154.preheader.us ], [ %add163.us, %for.inc176.us.for.inc176.us_crit_edge ]
...
for.inc144.us.for.inc144.us_crit_edge.1:          ; preds = %for.inc144.us.for.inc144.us_crit_edge
  ...
  %arrayidx124.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv.next154.1, i64 %indvars.iv156
  ...
  %arrayidx135.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv.next154.1, i64 %indvars.iv156
...
for.inc.us.for.inc.us_crit_edge.1:                ; preds = %for.inc.us.for.inc.us_crit_edge
  %indvars.iv.next171.1 = add nsw i64 %indvars.iv17046, 2
  %92 = load float, float* %arrayidx35.us, align 4
  %arrayidx35.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv173, i64 %indvars.iv.next171.1
  ...
  %arrayidx46.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv173, i64 %indvars.iv.next171.1
