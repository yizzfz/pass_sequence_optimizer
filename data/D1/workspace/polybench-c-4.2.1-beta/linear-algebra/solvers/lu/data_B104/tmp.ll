...
.lr.ph:                                           ; preds = %._crit_edge.thread, %1
  %indvars.iv42 = phi i64 [ 0, %1 ], [ %indvars.iv.next43, %._crit_edge.thread ]
  %2 = sub i64 1998, %indvars.iv42
  %3 = shl i64 %2, 3
...
.preheader71:                                     ; preds = %8
  ...
  %5 = icmp slt i64 %indvars.iv.next43, 2000
  br i1 %5, label %._crit_edge.thread, label %16

._crit_edge.thread:                               ; preds = %.preheader71
  %6 = add nuw nsw i64 %4, 8
  %scevgep40 = getelementptr [2000 x double], [2000 x double]* %0, i64 %indvars.iv42, i64 %indvars.iv.next43
  %scevgep4041 = bitcast double* %scevgep40 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep4041, i8 0, i64 %6, i32 8, i1 false)
  %7 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv42, i64 %indvars.iv42
  store double 1.000000e+00, double* %7, align 8
  br label %.lr.ph

; <label>:8:                                      ; preds = %8, %.lr.ph
  %indvars.iv30 = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next31, %8 ]
  %9 = sub nsw i64 0, %indvars.iv30
  %10 = trunc i64 %9 to i32
  %11 = srem i32 %10, 2000
  %12 = sitofp i32 %11 to double
  %13 = fdiv double %12, 2.000000e+03
  %14 = fadd double %13, 1.000000e+00
  %15 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv42, i64 %indvars.iv30
  store double %14, double* %15, align 8
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  %exitcond34 = icmp eq i64 %indvars.iv30, %indvars.iv42
  br i1 %exitcond34, label %.preheader71, label %8

; <label>:16:                                     ; preds = %.preheader71
  %17 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv42, i64 %indvars.iv42
  store double 1.000000e+00, double* %17, align 8
  %18 = tail call i8* @polybench_alloc_data(i64 4000000, i32 8) #4
  br label %19

; <label>:19:                                     ; preds = %19, %16
  %indvars.iv28 = phi i64 [ 0, %16 ], [ %indvars.iv.next29.7, %19 ]
  %20 = mul nuw nsw i64 %indvars.iv28, 16000
  %scevgep = getelementptr i8, i8* %18, i64 %20
  call void @llvm.memset.p0i8.i64(i8* %scevgep, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next29 = or i64 %indvars.iv28, 1
  %21 = mul nuw nsw i64 %indvars.iv.next29, 16000
  %scevgep.1 = getelementptr i8, i8* %18, i64 %21
  call void @llvm.memset.p0i8.i64(i8* %scevgep.1, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next29.1 = or i64 %indvars.iv28, 2
  %22 = mul nuw nsw i64 %indvars.iv.next29.1, 16000
  %scevgep.2 = getelementptr i8, i8* %18, i64 %22
  call void @llvm.memset.p0i8.i64(i8* %scevgep.2, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next29.2 = or i64 %indvars.iv28, 3
  %23 = mul nuw nsw i64 %indvars.iv.next29.2, 16000
  %scevgep.3 = getelementptr i8, i8* %18, i64 %23
  call void @llvm.memset.p0i8.i64(i8* %scevgep.3, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next29.3 = or i64 %indvars.iv28, 4
  %24 = mul nuw nsw i64 %indvars.iv.next29.3, 16000
  %scevgep.4 = getelementptr i8, i8* %18, i64 %24
  call void @llvm.memset.p0i8.i64(i8* %scevgep.4, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next29.4 = or i64 %indvars.iv28, 5
  %25 = mul nuw nsw i64 %indvars.iv.next29.4, 16000
  %scevgep.5 = getelementptr i8, i8* %18, i64 %25
  call void @llvm.memset.p0i8.i64(i8* %scevgep.5, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next29.5 = or i64 %indvars.iv28, 6
  %26 = mul nuw nsw i64 %indvars.iv.next29.5, 16000
  %scevgep.6 = getelementptr i8, i8* %18, i64 %26
  call void @llvm.memset.p0i8.i64(i8* %scevgep.6, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next29.6 = or i64 %indvars.iv28, 7
  %27 = mul nuw nsw i64 %indvars.iv.next29.6, 16000
  %scevgep.7 = getelementptr i8, i8* %18, i64 %27
  call void @llvm.memset.p0i8.i64(i8* %scevgep.7, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next29.7 = add nsw i64 %indvars.iv28, 8
  %exitcond89.7 = icmp eq i64 %indvars.iv.next29.7, 2000
  br i1 %exitcond89.7, label %.preheader68.preheader, label %19

.preheader68.preheader:                           ; preds = %19
...
.preheader68:                                     ; preds = %82, %.preheader68.preheader
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %82 ], [ 0, %.preheader68.preheader ]
  %scevgep46 = getelementptr [2000 x double], [2000 x double]* %0, i64 0, i64 %indvars.iv23
  %31 = add nuw nsw i64 %indvars.iv23, 1
  %scevgep48 = getelementptr [2000 x double], [2000 x double]* %0, i64 1999, i64 %31
  %32 = bitcast double* %scevgep48 to i8*
  %33 = bitcast double* %scevgep46 to i8*
  br label %.preheader67

.preheader67:                                     ; preds = %middle.block, %.preheader68
  %indvars.iv21 = phi i64 [ 0, %.preheader68 ], [ %indvars.iv.next22, %middle.block ]
  %34 = mul nuw nsw i64 %indvars.iv21, 16000
  %scevgep44 = getelementptr i8, i8* %18, i64 %34
  %35 = add nuw nsw i64 %34, 16000
  %scevgep45 = getelementptr i8, i8* %18, i64 %35
  %36 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv21, i64 %indvars.iv23
  %bound0 = icmp ult i8* %scevgep44, %32
  %bound1 = icmp ult i8* %33, %scevgep45
  %found.conflict = and i1 %bound0, %bound1
  %bc = bitcast double* %36 to i8*
  %bc50 = bitcast double* %36 to i8*
  %bound051 = icmp ult i8* %scevgep44, %bc50
  %bound152 = icmp ult i8* %bc, %scevgep45
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %45 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %index, i64 %indvars.iv23
  %46 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %37, i64 %indvars.iv23
  %47 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %38, i64 %indvars.iv23
  %48 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %39, i64 %indvars.iv23
  ...
  %59 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %30, i64 0, i64 %indvars.iv21, i64 %index
  ...
  %wide.load55 = load <2 x double>, <2 x double>* %62, align 8, !alias.scope !6, !noalias !8
  %63 = fadd <2 x double> %wide.load, %57
  %64 = fadd <2 x double> %wide.load55, %58
  ...
  br i1 %67, label %middle.block.loopexit91, label %vector.body, !llvm.loop !9

scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader
  %indvars.iv18 = phi i64 [ 0, %scalar.ph.preheader ], [ %indvars.iv.next19.1, %scalar.ph ]
  %68 = load double, double* %36, align 8
  %69 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv18, i64 %indvars.iv23
  %70 = load double, double* %69, align 8
  %71 = fmul double %68, %70
  %72 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %28, i64 0, i64 %indvars.iv21, i64 %indvars.iv18
  ...
  %76 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv.next19, i64 %indvars.iv23
  %77 = load double, double* %76, align 8
  %78 = fmul double %75, %77
  %79 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %29, i64 0, i64 %indvars.iv21, i64 %indvars.iv.next19
  %80 = load double, double* %79, align 8
  %81 = fadd double %80, %78
  store double %81, double* %79, align 8
  %indvars.iv.next19.1 = add nsw i64 %indvars.iv18, 2
  %exitcond20.1 = icmp eq i64 %indvars.iv.next19, 1999
  br i1 %exitcond20.1, label %middle.block.loopexit, label %scalar.ph, !llvm.loop !12

middle.block.loopexit:                            ; preds = %scalar.ph
  br label %middle.block

middle.block.loopexit91:                          ; preds = %vector.body
  br label %middle.block

middle.block:                                     ; preds = %middle.block.loopexit91, %middle.block.loopexit
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  %exitcond87 = icmp eq i64 %indvars.iv.next22, 2000
  br i1 %exitcond87, label %82, label %.preheader67

; <label>:82:                                     ; preds = %middle.block
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  %exitcond88 = icmp eq i64 %indvars.iv.next24, 2000
  br i1 %exitcond88, label %.preheader.preheader, label %.preheader68
...
.preheader:                                       ; preds = %middle.block57, %.preheader.preheader
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %middle.block57 ], [ 0, %.preheader.preheader ]
  %scevgep61 = getelementptr [2000 x double], [2000 x double]* %0, i64 %indvars.iv16, i64 0
  %scevgep6162 = bitcast double* %scevgep61 to i8*
  %90 = add nuw nsw i64 %indvars.iv16, 1
  %scevgep63 = getelementptr [2000 x double], [2000 x double]* %0, i64 %90, i64 0
  %scevgep6364 = bitcast double* %scevgep63 to i8*
  %91 = mul nuw nsw i64 %indvars.iv16, 16000
  %scevgep65 = getelementptr i8, i8* %18, i64 %91
  %92 = add nuw nsw i64 %91, 16000
  %scevgep66 = getelementptr i8, i8* %18, i64 %92
  ...
  br i1 %memcheck.conflict70, label %scalar.ph58.preheader, label %vector.body56.preheader

vector.body56.preheader:                          ; preds = %.preheader
  br label %vector.body56

scalar.ph58.preheader:                            ; preds = %.preheader
  br label %scalar.ph58

vector.body56:                                    ; preds = %vector.body56, %vector.body56.preheader
  %index73 = phi i64 [ 0, %vector.body56.preheader ], [ %index.next74.1, %vector.body56 ]
  %93 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %88, i64 0, i64 %indvars.iv16, i64 %index73
  %94 = bitcast double* %93 to <2 x i64>*
  %wide.load81 = load <2 x i64>, <2 x i64>* %94, align 8, !alias.scope !13
  %95 = getelementptr double, double* %93, i64 2
  %96 = bitcast double* %95 to <2 x i64>*
  %wide.load82 = load <2 x i64>, <2 x i64>* %96, align 8, !alias.scope !13
  %97 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv16, i64 %index73
  %98 = bitcast double* %97 to <2 x i64>*
  store <2 x i64> %wide.load81, <2 x i64>* %98, align 8, !alias.scope !16, !noalias !13
  %99 = getelementptr double, double* %97, i64 2
  %100 = bitcast double* %99 to <2 x i64>*
  store <2 x i64> %wide.load82, <2 x i64>* %100, align 8, !alias.scope !16, !noalias !13
  %index.next74 = or i64 %index73, 4
  %101 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %89, i64 0, i64 %indvars.iv16, i64 %index.next74
  %102 = bitcast double* %101 to <2 x i64>*
  %wide.load81.1 = load <2 x i64>, <2 x i64>* %102, align 8, !alias.scope !13
  %103 = getelementptr double, double* %101, i64 2
  %104 = bitcast double* %103 to <2 x i64>*
  %wide.load82.1 = load <2 x i64>, <2 x i64>* %104, align 8, !alias.scope !13
  %105 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv16, i64 %index.next74
  %106 = bitcast double* %105 to <2 x i64>*
  store <2 x i64> %wide.load81.1, <2 x i64>* %106, align 8, !alias.scope !16, !noalias !13
  %107 = getelementptr double, double* %105, i64 2
  %108 = bitcast double* %107 to <2 x i64>*
  store <2 x i64> %wide.load82.1, <2 x i64>* %108, align 8, !alias.scope !16, !noalias !13
  %index.next74.1 = add nsw i64 %index73, 8
  %109 = icmp eq i64 %index.next74.1, 2000
  br i1 %109, label %middle.block57.loopexit90, label %vector.body56, !llvm.loop !18

scalar.ph58:                                      ; preds = %scalar.ph58, %scalar.ph58.preheader
  %indvars.iv = phi i64 [ 0, %scalar.ph58.preheader ], [ %indvars.iv.next.4, %scalar.ph58 ]
  %110 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %83, i64 0, i64 %indvars.iv16, i64 %indvars.iv
  %111 = bitcast double* %110 to i64*
  %112 = load i64, i64* %111, align 8
  %113 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv16, i64 %indvars.iv
  %114 = bitcast double* %113 to i64*
  store i64 %112, i64* %114, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %115 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %84, i64 0, i64 %indvars.iv16, i64 %indvars.iv.next
  %116 = bitcast double* %115 to i64*
  %117 = load i64, i64* %116, align 8
  %118 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv16, i64 %indvars.iv.next
  %119 = bitcast double* %118 to i64*
  store i64 %117, i64* %119, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %120 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %85, i64 0, i64 %indvars.iv16, i64 %indvars.iv.next.1
  %121 = bitcast double* %120 to i64*
  %122 = load i64, i64* %121, align 8
  %123 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv16, i64 %indvars.iv.next.1
  %124 = bitcast double* %123 to i64*
  store i64 %122, i64* %124, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %125 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %86, i64 0, i64 %indvars.iv16, i64 %indvars.iv.next.2
  %126 = bitcast double* %125 to i64*
  %127 = load i64, i64* %126, align 8
  %128 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv16, i64 %indvars.iv.next.2
  %129 = bitcast double* %128 to i64*
  store i64 %127, i64* %129, align 8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %130 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %87, i64 0, i64 %indvars.iv16, i64 %indvars.iv.next.3
  %131 = bitcast double* %130 to i64*
  %132 = load i64, i64* %131, align 8
  %133 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv16, i64 %indvars.iv.next.3
  %134 = bitcast double* %133 to i64*
  store i64 %132, i64* %134, align 8
  %indvars.iv.next.4 = add nsw i64 %indvars.iv, 5
  %exitcond.4 = icmp eq i64 %indvars.iv.next.3, 1999
  br i1 %exitcond.4, label %middle.block57.loopexit, label %scalar.ph58, !llvm.loop !19

middle.block57.loopexit:                          ; preds = %scalar.ph58
  br label %middle.block57

middle.block57.loopexit90:                        ; preds = %vector.body56
  br label %middle.block57

middle.block57:                                   ; preds = %middle.block57.loopexit90, %middle.block57.loopexit
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  %exitcond86 = icmp eq i64 %indvars.iv.next17, 2000
  br i1 %exitcond86, label %135, label %.preheader

; <label>:135:                                    ; preds = %middle.block57
...
.preheader.us.preheader:                          ; preds = %._crit_edge
  ...
  %7 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv34, i64 0
  %8 = icmp eq i64 %3, 0
...
.preheader.us:                                    ; preds = %._crit_edge5.us, %.preheader.us.preheader
  ...
  %9 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv34, i64 %indvars.iv30
...
.prol.loopexit40.unr-lcssa:                       ; preds = %.preheader.us, %10
  %indvars.iv22.unr.ph = phi i64 [ 1, %10 ], [ 0, %.preheader.us ]
  %.unr43.ph = phi double [ %15, %10 ], [ %.pre16, %.preheader.us ]
...
.preheader.us.new:                                ; preds = %.prol.loopexit40
  br label %16

; <label>:16:                                     ; preds = %16, %.preheader.us.new
  %indvars.iv22 = phi i64 [ %indvars.iv22.unr.ph, %.preheader.us.new ], [ %indvars.iv.next23.1, %16 ]
  %17 = phi double [ %.unr43.ph, %.preheader.us.new ], [ %29, %16 ]
  %18 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv34, i64 %indvars.iv22
  ...
  %24 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv34, i64 %indvars.iv.next23
...
._crit_edge5.us:                                  ; preds = %.prol.loopexit40, %._crit_edge5.us.unr-lcssa
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
...
.preheader41:                                     ; preds = %._crit_edge, %.preheader41.preheader
  ...
  %33 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv34, i64 %indvars.iv19
...
; <label>:42:                                     ; preds = %42, %.lr.ph.new
  ...
  %44 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv34, i64 %indvars.iv
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %50 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv34, i64 %indvars.iv.next
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader41
  ...
  br i1 %exitcond36, label %.preheader.us.preheader, label %.preheader41
...
._crit_edge7:                                     ; preds = %._crit_edge7.loopexit, %.preheader43
  ...
  br i1 %exitcond38, label %60, label %.preheader43
