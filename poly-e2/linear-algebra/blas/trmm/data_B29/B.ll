...
entry:
  ...
  tail call fastcc void @kernel_trmm(i32 1000, i32 1200, double %0, [1000 x double]* %1, [1200 x double]* %2)
...
define internal fastcc void @init_array(i32 %m, i32 %n, double* nocapture %alpha, [1000 x double]* %A, [1200 x double]* %B) unnamed_addr #2 {
entry:
...
for.cond1.preheader.us:                           ; preds = %for.cond11.for.inc27_crit_edge.us.for.cond1.preheader.us_crit_edge, %for.cond1.preheader.us.preheader
  ...
  br i1 %cmp23.us, label %for.inc.lr.ph.us, label %for.cond1.preheader.us.for.end.us_crit_edge
...
for.end.us:                                       ; preds = %for.inc.us.prol.loopexit.for.end.us_crit_edge, %for.cond1.preheader.us.for.end.us_crit_edge, %for.end.us.loopexit
  ...
  br i1 true, label %for.end.us.for.inc24.us.prol.loopexit_crit_edge, label %for.inc24.us.prol

for.end.us.for.inc24.us.prol.loopexit_crit_edge:  ; preds = %for.end.us
...
for.inc24.us.prol.loopexit:                       ; preds = %for.end.us.for.inc24.us.prol.loopexit_crit_edge, %for.inc24.us.prol
  %indvars.iv16.unr.ph = phi i64 [ 1, %for.inc24.us.prol ], [ 0, %for.end.us.for.inc24.us.prol.loopexit_crit_edge ]
...
for.inc24.us:                                     ; preds = %for.inc24.us.for.inc24.us_crit_edge, %for.inc24.us.preheader
  %indvars.iv16 = phi i64 [ %indvars.iv.next17.1, %for.inc24.us.for.inc24.us_crit_edge ], [ %indvars.iv16.unr.ph, %for.inc24.us.preheader ]
  ...
  br i1 %exitcond.122, label %for.cond11.for.inc27_crit_edge.us.loopexit, label %for.inc24.us.for.inc24.us_crit_edge
...
for.inc.us:                                       ; preds = %for.inc.us.for.inc.us_crit_edge, %for.inc.us.preheader
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %for.inc.us.for.inc.us_crit_edge ], [ %indvars.iv.unr.ph, %for.inc.us.preheader ]
  ...
  br i1 %exitcond.1, label %for.end.us.loopexit, label %for.inc.us.for.inc.us_crit_edge
...
for.inc.lr.ph.us:                                 ; preds = %for.cond1.preheader.us
  ...
  br i1 %lcmp.mod, label %for.inc.lr.ph.us.for.inc.us.prol.loopexit_crit_edge, label %for.inc.us.prol
...
for.inc.us.prol.loopexit:                         ; preds = %for.inc.lr.ph.us.for.inc.us.prol.loopexit_crit_edge, %for.inc.us.prol
  %indvars.iv.unr.ph = phi i64 [ 1, %for.inc.us.prol ], [ 0, %for.inc.lr.ph.us.for.inc.us.prol.loopexit_crit_edge ]
  %10 = icmp eq i32 %indvar, 1
  br i1 %10, label %for.inc.us.prol.loopexit.for.end.us_crit_edge, label %for.inc.us.preheader

for.inc.us.prol.loopexit.for.end.us_crit_edge:    ; preds = %for.inc.us.prol.loopexit
  br label %for.end.us
...
for.cond1.preheader:                              ; preds = %for.end.for.cond1.preheader_crit_edge, %for.cond1.preheader.preheader
  ...
  br i1 %cmp23, label %for.inc.lr.ph, label %for.cond1.preheader.for.end_crit_edge
...
for.inc.lr.ph:                                    ; preds = %for.cond1.preheader
  ...
  br i1 %lcmp.mod34, label %for.inc.lr.ph.for.inc.prol.loopexit_crit_edge, label %for.inc.prol
...
for.inc.prol.loopexit:                            ; preds = %for.inc.lr.ph.for.inc.prol.loopexit_crit_edge, %for.inc.prol
  %indvars.iv25.unr.ph = phi i64 [ 1, %for.inc.prol ], [ 0, %for.inc.lr.ph.for.inc.prol.loopexit_crit_edge ]
  %12 = icmp eq i32 %indvar31, 1
  br i1 %12, label %for.inc.prol.loopexit.for.end_crit_edge, label %for.inc.preheader
...
for.inc:                                          ; preds = %for.inc.for.inc_crit_edge, %for.inc.preheader
  %indvars.iv25 = phi i64 [ %indvars.iv.next26.1, %for.inc.for.inc_crit_edge ], [ %indvars.iv25.unr.ph, %for.inc.preheader ]
  ...
  br i1 %exitcond.136, label %for.end.loopexit, label %for.inc.for.inc_crit_edge
...
for.end:                                          ; preds = %for.inc.prol.loopexit.for.end_crit_edge, %for.cond1.preheader.for.end_crit_edge, %for.end.loopexit
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc void @kernel_trmm(i32 %m, i32 %n, double %alpha, [1000 x double]* %A, [1200 x double]* %B) unnamed_addr #2 {
entry:
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc30_crit_edge.us.for.cond1.preheader.us_crit_edge, %for.cond1.preheader.us.preheader
  ...
  %2 = icmp slt i64 %1, 1000
  %3 = icmp eq i32 %xtraiter, 0
  %4 = icmp eq i32 998, %indvar
  br label %for.cond4.preheader.us

for.inc27.us.loopexit:                            ; preds = %for.inc.us
  br label %for.inc27.us

for.inc27.us:                                     ; preds = %for.inc.us.prol.loopexit.for.inc27.us_crit_edge, %for.inc27.us.loopexit, %for.cond4.preheader.us.for.inc27.us_crit_edge
  %arrayidx21.us.pre-phi = phi double* [ %.pre30, %for.cond4.preheader.us.for.inc27.us_crit_edge ], [ %arrayidx16.us, %for.inc.us.prol.loopexit.for.inc27.us_crit_edge ], [ %arrayidx16.us, %for.inc27.us.loopexit ]
  %5 = load double, double* %arrayidx21.us.pre-phi, align 8
  %mul22.us = fmul double %5, %alpha
  store double %mul22.us, double* %arrayidx21.us.pre-phi, align 8
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  %exitcond = icmp eq i64 %indvars.iv.next24, 1200
  br i1 %exitcond, label %for.cond1.for.inc30_crit_edge.us, label %for.inc27.us.for.cond4.preheader.us_crit_edge

for.inc27.us.for.cond4.preheader.us_crit_edge:    ; preds = %for.inc27.us
  br label %for.cond4.preheader.us

for.inc.us:                                       ; preds = %for.inc.us.for.inc.us_crit_edge, %for.inc.us.prol.loopexit.for.inc.us_crit_edge
  %6 = phi double [ %add17.us.1, %for.inc.us.for.inc.us_crit_edge ], [ %.pre, %for.inc.us.prol.loopexit.for.inc.us_crit_edge ]
  %indvars.iv17 = phi i64 [ %indvars.iv.next18.1, %for.inc.us.for.inc.us_crit_edge ], [ %indvars.iv17.unr.ph, %for.inc.us.prol.loopexit.for.inc.us_crit_edge ]
  ...
  br i1 %exitcond.1, label %for.inc27.us.loopexit, label %for.inc.us.for.inc.us_crit_edge

for.inc.us.for.inc.us_crit_edge:                  ; preds = %for.inc.us
  br label %for.inc.us

for.cond4.preheader.us:                           ; preds = %for.inc27.us.for.cond4.preheader.us_crit_edge, %for.cond1.preheader.us
  %indvars.iv23 = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next24, %for.inc27.us.for.cond4.preheader.us_crit_edge ]
  br i1 %2, label %for.inc.lr.ph.us, label %for.cond4.preheader.us.for.inc27.us_crit_edge
...
for.inc.lr.ph.us:                                 ; preds = %for.cond4.preheader.us
  ...
  br i1 %3, label %for.inc.lr.ph.us.for.inc.us.prol.loopexit_crit_edge, label %for.inc.us.prol

for.inc.lr.ph.us.for.inc.us.prol.loopexit_crit_edge: ; preds = %for.inc.lr.ph.us
  br label %for.inc.us.prol.loopexit

for.inc.us.prol:                                  ; preds = %for.inc.lr.ph.us
  %11 = load double, double* %arrayidx8.us.prol, align 8
  %arrayidx12.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv, i64 %indvars.iv23
  %12 = load double, double* %arrayidx12.us.prol, align 8
  %mul.us.prol = fmul double %11, %12
  %13 = load double, double* %arrayidx16.us, align 8
  %add17.us.prol = fadd double %mul.us.prol, %13
  store double %add17.us.prol, double* %arrayidx16.us, align 8
  br label %for.inc.us.prol.loopexit

for.inc.us.prol.loopexit:                         ; preds = %for.inc.lr.ph.us.for.inc.us.prol.loopexit_crit_edge, %for.inc.us.prol
  %indvars.iv17.unr.ph = phi i64 [ %indvars.iv.next18.prol, %for.inc.us.prol ], [ %indvars.iv, %for.inc.lr.ph.us.for.inc.us.prol.loopexit_crit_edge ]
  br i1 %4, label %for.inc.us.prol.loopexit.for.inc27.us_crit_edge, label %for.inc.us.prol.loopexit.for.inc.us_crit_edge

for.inc.us.prol.loopexit.for.inc27.us_crit_edge:  ; preds = %for.inc.us.prol.loopexit
  br label %for.inc27.us
...
for.cond1.for.inc30_crit_edge.us:                 ; preds = %for.inc27.us
  %indvar.next = add i32 %indvar, 1
  br i1 %2, label %for.cond1.for.inc30_crit_edge.us.for.cond1.preheader.us_crit_edge, label %for.cond.for.end32_crit_edge.loopexit
...
for.cond2.for.inc10_crit_edge.us:                 ; preds = %for.inc.us
  ...
  br i1 %cmp.us, label %for.cond2.for.inc10_crit_edge.us.for.cond2.preheader.us_crit_edge, label %for.cond.for.end12_crit_edge.loopexit
