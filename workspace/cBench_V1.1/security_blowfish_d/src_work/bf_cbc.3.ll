...
@__llvm_prf_nm = private constant [24 x i8] c"\0E\16x\DAsr\8BONJ\8EO\CDK.\AA,(\01\00&\01\05t", section "__llvm_prf_names"
@llvm.used = appending global [2 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_BF_cbc_encrypt to i8*), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
