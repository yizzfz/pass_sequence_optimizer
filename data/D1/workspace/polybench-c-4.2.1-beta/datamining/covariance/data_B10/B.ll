...
._crit_edge36:                                    ; preds = %21, %6
  %indvars.iv32 = phi i64 [ 0, %6 ], [ %indvars.iv.next33, %21 ]
  %7 = getelementptr inbounds double, double* %5, i64 %indvars.iv32
...
._crit_edge35:                                    ; preds = %._crit_edge35, %._crit_edge36
  %8 = phi double [ 0.000000e+00, %._crit_edge36 ], [ %20, %._crit_edge35 ]
  %indvars.iv29 = phi i64 [ 0, %._crit_edge36 ], [ %indvars.iv.next30.3, %._crit_edge35 ]
  %9 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv29, i64 %indvars.iv32
  %10 = load double, double* %9, align 8
  %11 = fadd double %10, %8
  store double %11, double* %sunkaddr45, align 8
  %indvars.iv.next30 = or i64 %indvars.iv29, 1
  %12 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next30, i64 %indvars.iv32
  %13 = load double, double* %12, align 8
  %14 = fadd double %13, %11
  store double %14, double* %sunkaddr45, align 8
  %indvars.iv.next30.1 = or i64 %indvars.iv29, 2
  %15 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next30.1, i64 %indvars.iv32
  %16 = load double, double* %15, align 8
  %17 = fadd double %16, %14
  store double %17, double* %sunkaddr45, align 8
  %indvars.iv.next30.2 = or i64 %indvars.iv29, 3
  %18 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next30.2, i64 %indvars.iv32
  ...
  br i1 %exitcond31.3, label %21, label %._crit_edge35

; <label>:21:                                     ; preds = %._crit_edge35
  %22 = fdiv double %20, %2
  store double %22, double* %sunkaddr45, align 8
  %indvars.iv.next33 = add nuw nsw i64 %indvars.iv32, 1
  %exitcond34 = icmp eq i64 %indvars.iv.next33, 1200
  br i1 %exitcond34, label %..preheader6_crit_edge, label %._crit_edge36

..preheader6_crit_edge:                           ; preds = %21
  %scevgep54 = getelementptr double, double* %5, i64 1200
  br label %.preheader6

.preheader6:                                      ; preds = %middle.block, %..preheader6_crit_edge
  %indvars.iv26 = phi i64 [ 0, %..preheader6_crit_edge ], [ %23, %middle.block ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %3, i64 %indvars.iv26, i64 0
  %23 = add i64 %indvars.iv26, 1
  %scevgep52 = getelementptr [1200 x double], [1200 x double]* %3, i64 %23, i64 0
  %bound0 = icmp ult double* %scevgep, %scevgep54
  %bound1 = icmp ugt double* %scevgep52, %5
  %memcheck.conflict = and i1 %bound0, %bound1
  br i1 %memcheck.conflict, label %._crit_edge37.preheader, label %vector.body.preheader

vector.body.preheader:                            ; preds = %.preheader6
  br label %vector.body

._crit_edge37.preheader:                          ; preds = %.preheader6
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv26, i64 %offset.idx
  %27 = bitcast double* %26 to <8 x double>*
  %wide.vec59 = load <8 x double>, <8 x double>* %27, align 8, !alias.scope !4, !noalias !1
  %28 = fsub <8 x double> %wide.vec59, %wide.vec
  ...
  %33 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv26, i64 %32
  ...
  br i1 %39, label %middle.block.loopexit64, label %vector.body, !llvm.loop !6

.preheader5:                                      ; preds = %middle.block
  %40 = fadd double %2, -1.000000e+00
  br label %.lr.ph

._crit_edge37:                                    ; preds = %._crit_edge37.preheader, %._crit_edge37
  %indvars.iv23 = phi i64 [ %indvars.iv.next24.3, %._crit_edge37 ], [ 0, %._crit_edge37.preheader ]
  %41 = getelementptr inbounds double, double* %5, i64 %indvars.iv23
  %42 = load double, double* %41, align 8
  %43 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv26, i64 %indvars.iv23
  %44 = load double, double* %43, align 8
  %45 = fsub double %44, %42
  store double %45, double* %43, align 8
  %indvars.iv.next24 = or i64 %indvars.iv23, 1
  %46 = getelementptr inbounds double, double* %5, i64 %indvars.iv.next24
  %47 = load double, double* %46, align 8
  %48 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv26, i64 %indvars.iv.next24
  %49 = load double, double* %48, align 8
  %50 = fsub double %49, %47
  store double %50, double* %48, align 8
  %indvars.iv.next24.1 = or i64 %indvars.iv23, 2
  %51 = getelementptr inbounds double, double* %5, i64 %indvars.iv.next24.1
  %52 = load double, double* %51, align 8
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv26, i64 %indvars.iv.next24.1
  %54 = load double, double* %53, align 8
  %55 = fsub double %54, %52
  store double %55, double* %53, align 8
  %indvars.iv.next24.2 = or i64 %indvars.iv23, 3
  %56 = getelementptr inbounds double, double* %5, i64 %indvars.iv.next24.2
  %57 = load double, double* %56, align 8
  %58 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv26, i64 %indvars.iv.next24.2
  ...
  br i1 %exitcond25.3, label %middle.block.loopexit, label %._crit_edge37, !llvm.loop !9

middle.block.loopexit:                            ; preds = %._crit_edge37
  br label %middle.block

middle.block.loopexit64:                          ; preds = %vector.body
  br label %middle.block

middle.block:                                     ; preds = %middle.block.loopexit64, %middle.block.loopexit
  %exitcond28 = icmp eq i64 %23, 1400
  br i1 %exitcond28, label %.preheader5, label %.preheader6

.lr.ph:                                           ; preds = %._crit_edge, %.preheader5
  %indvars.iv20 = phi i64 [ 0, %.preheader5 ], [ %indvars.iv.next21, %._crit_edge ]
  br label %._crit_edge40

._crit_edge40:                                    ; preds = %75, %.lr.ph
  %indvars.iv17 = phi i64 [ %indvars.iv20, %.lr.ph ], [ %indvars.iv.next18, %75 ]
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv20, i64 %indvars.iv17
  store double 0.000000e+00, double* %61, align 8
  br label %._crit_edge39

._crit_edge39:                                    ; preds = %._crit_edge39, %._crit_edge40
  %62 = phi double [ 0.000000e+00, %._crit_edge40 ], [ %74, %._crit_edge39 ]
  %indvars.iv = phi i64 [ 0, %._crit_edge40 ], [ %indvars.iv.next.1, %._crit_edge39 ]
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv, i64 %indvars.iv20
  %64 = load double, double* %63, align 8
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv, i64 %indvars.iv17
  %66 = load double, double* %65, align 8
  %67 = fmul double %64, %66
  %68 = fadd double %62, %67
  store double %68, double* %61, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %69 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next, i64 %indvars.iv20
  %70 = load double, double* %69, align 8
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next, i64 %indvars.iv17
  ...
  br i1 %exitcond.1, label %75, label %._crit_edge39

; <label>:75:                                     ; preds = %._crit_edge39
  %76 = fdiv double %74, %40
  store double %76, double* %61, align 8
  %77 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv17, i64 %indvars.iv20
  store double %76, double* %77, align 8
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  %exitcond = icmp eq i64 %indvars.iv.next18, 1200
  br i1 %exitcond, label %._crit_edge, label %._crit_edge40

._crit_edge:                                      ; preds = %75
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  %exitcond22 = icmp eq i64 %indvars.iv.next21, 1200
  br i1 %exitcond22, label %78, label %.lr.ph
...
._crit_edge:                                      ; preds = %._crit_edge7, %12
  ...
  %15 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv4, i64 %indvars.iv
  %16 = load double, double* %15, align 8
