...
.lr.ph5:                                          ; preds = %.lr.ph5.preheader17, %.lr.ph5
  ...
  %38 = trunc i64 %indvars.iv12 to i32
  %39 = or i32 %38, 1
  ...
  %43 = trunc i64 %indvars.iv.next13.1 to i32
  %44 = sitofp i32 %43 to double
  %45 = getelementptr inbounds double, double* %6, i64 %indvars.iv.next13.1
  %46 = bitcast double* %45 to <2 x double>*
  %47 = trunc i64 %indvars.iv12 to i32
  %48 = or i32 %47, 3
  ...
  %52 = trunc i64 %indvars.iv.next13.3 to i32
  %53 = sitofp i32 %52 to double
  %54 = getelementptr inbounds double, double* %6, i64 %indvars.iv.next13.3
  %55 = bitcast double* %54 to <2 x double>*
  %indvars.iv.next13.4 = add nsw i64 %indvars.iv12, 5
  %56 = trunc i64 %indvars.iv.next13.4 to i32
  ...
  %60 = trunc i64 %indvars.iv.next13.5 to i32
  %61 = sitofp i32 %60 to double
  %62 = getelementptr inbounds double, double* %6, i64 %indvars.iv.next13.5
  %63 = bitcast double* %62 to <2 x double>*
  %indvars.iv.next13.6 = add nsw i64 %indvars.iv12, 7
  %64 = trunc i64 %indvars.iv.next13.6 to i32
...
; <label>:10:                                     ; preds = %17, %.preheader8.us
  ...
  %11 = add nuw nsw i64 %indvars.iv33, %9
...
; <label>:15:                                     ; preds = %10
  ...
  %fputc6.us = tail call i32 @fputc(i32 10, %struct._IO_FILE* %16) #4
  br label %17
...
; <label>:34:                                     ; preds = %29
  ...
  %fputc3.us = tail call i32 @fputc(i32 10, %struct._IO_FILE* %35) #4
  br label %36
...
.preheader.us:                                    ; preds = %._crit_edge.us, %._crit_edge12
  ...
  %45 = mul nuw nsw i64 %indvars.iv19, 1000
  br label %46
