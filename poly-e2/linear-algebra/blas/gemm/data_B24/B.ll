...
for.cond1.preheader.us:                           ; preds = %entry, %for.inc7.us
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc7.us ], [ 0, %entry ]
...
for.cond2.preheader.us:                           ; preds = %for.inc10.us, %entry
  %indvars.iv8 = phi i64 [ 0, %entry ], [ %indvars.iv.next9, %for.inc10.us ]
