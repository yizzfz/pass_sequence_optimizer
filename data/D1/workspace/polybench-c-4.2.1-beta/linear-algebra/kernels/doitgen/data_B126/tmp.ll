...
.preheader5.preheader:                            ; preds = %.preheader5.lr.ph
  br i1 %lcmp.mod114, label %.preheader5.prol.loopexit, label %.preheader5.prol.preheader
...
.preheader5.prol:                                 ; preds = %.preheader5.prol, %.preheader5.prol.preheader
  ...
  %prol.iter = phi i64 [ %prol.iter.sub, %.preheader5.prol ], [ %xtraiter113, %.preheader5.prol.preheader ]
...
.preheader5.prol.loopexit:                        ; preds = %.preheader5.preheader, %.preheader5.prol.loopexit.unr-lcssa
  ...
  br i1 %19, label %._crit_edge16.loopexit110, label %.preheader5.preheader.new
...
._crit_edge14.us:                                 ; preds = %._crit_edge14.us.loopexit, %middle.block
  ...
  br i1 %exitcond111, label %._crit_edge16.loopexit, label %.preheader5.us

.lr.ph13.us:                                      ; preds = %.lr.ph13.us.preheader109, %.lr.ph13.us
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %.lr.ph13.us ], [ %indvars.iv60.ph, %.lr.ph13.us.preheader109 ]
...
.lr.ph13.us.preheader:                            ; preds = %._crit_edge.us.us
  ...
  br i1 %min.iters.check, label %.lr.ph13.us.preheader109, label %min.iters.checked

.lr.ph13.us.preheader109:                         ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.lr.ph13.us.preheader
...
min.iters.checked:                                ; preds = %.lr.ph13.us.preheader
  br i1 %cmp.zero, label %.lr.ph13.us.preheader109, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %bound0 = icmp ult double* %scevgep, %scevgep73
  %bound1 = icmp ugt double* %scevgep71, %5
  %memcheck.conflict = and i1 %bound0, %bound1
  br i1 %memcheck.conflict, label %.lr.ph13.us.preheader109, label %vector.body.preheader

vector.body.preheader:                            ; preds = %vector.memcheck
  br i1 %lcmp.mod116, label %vector.body.prol.loopexit, label %vector.body.prol.preheader
...
vector.body.prol:                                 ; preds = %vector.body.prol, %vector.body.prol.preheader
  ...
  %prol.iter117 = phi i64 [ %prol.iter117.sub, %vector.body.prol ], [ %xtraiter115, %vector.body.prol.preheader ]
  ...
  br i1 %prol.iter117.cmp, label %vector.body.prol.loopexit.unr-lcssa, label %vector.body.prol, !llvm.loop !11
...
middle.block:                                     ; preds = %vector.body.prol.loopexit, %middle.block.unr-lcssa
  br i1 %cmp.n, label %._crit_edge14.us, label %.lr.ph13.us.preheader109
...
.preheader5:                                      ; preds = %.preheader5, %.preheader5.preheader.new
  ...
  br i1 %exitcond.7, label %._crit_edge16.loopexit110.unr-lcssa, label %.preheader5
...
._crit_edge16.loopexit110:                        ; preds = %.preheader5.prol.loopexit, %._crit_edge16.loopexit110.unr-lcssa
  br label %._crit_edge16

._crit_edge16:                                    ; preds = %._crit_edge16.loopexit110, %._crit_edge16.loopexit, %.preheader6
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1
  %exitcond112 = icmp eq i64 %indvars.iv.next65, %12
  br i1 %exitcond112, label %._crit_edge32.loopexit, label %.preheader6
