...
for.cond1.for.inc16_crit_edge.us:                 ; preds = %for.body3.us
  ...
  br i1 %exitcond75, label %for.body26.lr.ph.preheader, label %for.cond1.preheader.us
...
for.body26.lr.ph:                                 ; preds = %for.body26.lr.ph.preheader, %for.inc51
  %indvars.iv72 = phi i3 [ %indvars.iv.next73, %for.inc51 ], [ -1, %for.body26.lr.ph.preheader ]
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc51 ], [ 2, %for.body26.lr.ph.preheader ]
...
for.body43.preheader:                             ; preds = %for.body43.prol.loopexit
  ...
  br i1 %min.iters.check, label %for.body43.preheader78, label %min.iters.checked

for.body43.preheader78:                           ; preds = %middle.block, %min.iters.checked, %for.body43.preheader
...
min.iters.checked:                                ; preds = %for.body43.preheader
  ...
  br i1 %cmp.zero, label %for.body43.preheader78, label %vector.body.preheader
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.inc51, label %for.body43.preheader78
...
for.body43:                                       ; preds = %for.body43.preheader78, %for.body43
  %indvars.iv48 = phi i64 [ %indvars.iv.next49.7, %for.body43 ], [ %indvars.iv48.ph, %for.body43.preheader78 ]
...
for.inc51:                                        ; preds = %for.inc51.loopexit, %middle.block, %for.body43.prol.loopexit, %for.cond40.preheader
  ...
  br i1 %exitcond74, label %for.end53, label %for.body26.lr.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %26, label %for.inc53.loopexit86, label %vector.body, !llvm.loop !16
...
for.cond4.preheader:                              ; preds = %for.cond4.preheader, %for.cond4.preheader.preheader
  ...
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %exitcond57.1 = icmp eq i64 %indvars.iv.next.1, 1200
  br i1 %exitcond57.1, label %for.inc53.loopexit85, label %for.cond4.preheader, !llvm.loop !17

for.inc53.loopexit:                               ; preds = %for.cond4.for.end_crit_edge.us
  br label %for.inc53

for.inc53.loopexit85:                             ; preds = %for.cond4.preheader
  br label %for.inc53

for.inc53.loopexit86:                             ; preds = %vector.body
  br label %for.inc53

for.inc53:                                        ; preds = %for.inc53.loopexit86, %for.inc53.loopexit85, %for.inc53.loopexit
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %exitcond58 = icmp eq i64 %indvars.iv.next54, 1000
  br i1 %exitcond58, label %for.end55, label %for.cond1.preheader
