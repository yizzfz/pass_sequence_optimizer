...
@__llvm_prf_nm = private constant [49 x i8] c"9/x\DAKI,*J\AC\8CO+JMet\81\B23\F3R\18S \EC\94\D4\9C\D4\92T\C6\92\DC\02C\BD\9C\1C\AB\14\84\0A\00p\F5\15\85", section "__llvm_prf_names"
@llvm.used = appending global [5 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_darray_free to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_Darray_find to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_darray_delete to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_darray_find to i8*), i8* getelementptr inbounds ([49 x i8], [49 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
