...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc16_crit_edge.us, %for.cond1.preheader.us.preheader
  %indvars.iv62 = phi i64 [ 0, %for.cond1.preheader.us.preheader ], [ %indvars.iv.next63, %for.cond1.for.inc16_crit_edge.us ]
  %0 = add i64 %indvars.iv62, 1200
  %1 = trunc i64 %0 to i32
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us, %for.cond1.preheader.us
  %indvars.iv58 = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next59, %for.body3.us ]
  %2 = add nuw nsw i64 %indvars.iv58, %indvars.iv62
  %3 = trunc i64 %2 to i32
  %rem.us = srem i32 %3, 100
  %conv.us = sitofp i32 %rem.us to double
  %div.us = fdiv double %conv.us, 1.000000e+03
  %arrayidx6.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv62, i64 %indvars.iv58
  ...
  %arrayidx15.us = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv62, i64 %indvars.iv58
  store double %div11.us, double* %arrayidx15.us, align 8
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  %exitcond = icmp eq i64 %indvars.iv58, 1199
...
for.cond1.for.inc16_crit_edge.us:                 ; preds = %for.body3.us
  ...
  br i1 %exitcond66, label %for.body26.lr.ph.preheader, label %for.cond1.preheader.us
...
for.cond19.loopexit:                              ; preds = %for.cond19.loopexit.loopexit, %middle.block, %for.body43.prol.loopexit, %for.end38
  %exitcond57 = icmp eq i64 %9, 1000
  br i1 %exitcond57, label %for.end53, label %for.cond19.loopexit.for.body26.lr.ph_crit_edge

for.cond19.loopexit.for.body26.lr.ph_crit_edge:   ; preds = %for.cond19.loopexit
  %indvars.iv.next73 = add nuw i64 %indvars.iv72, 1
  %indvars.iv.next75 = add i3 %indvars.iv74, -1
  br label %for.body26.lr.ph

for.body26.lr.ph:                                 ; preds = %for.body26.lr.ph.preheader, %for.cond19.loopexit.for.body26.lr.ph_crit_edge
  %indvars.iv74 = phi i3 [ %indvars.iv.next75, %for.cond19.loopexit.for.body26.lr.ph_crit_edge ], [ -1, %for.body26.lr.ph.preheader ]
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.cond19.loopexit.for.body26.lr.ph_crit_edge ], [ 1, %for.body26.lr.ph.preheader ]
  %indvars.iv54 = phi i64 [ %9, %for.cond19.loopexit.for.body26.lr.ph_crit_edge ], [ 0, %for.body26.lr.ph.preheader ]
  %5 = zext i3 %indvars.iv74 to i64
  %6 = add i64 %indvars.iv72, %5
  %7 = sub i64 1007, %indvars.iv54
  %8 = sub i64 998, %indvars.iv54
  %9 = add nuw nsw i64 %indvars.iv54, 1
...
for.body26:                                       ; preds = %for.body26.preheader, %for.body26
  ...
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, %indvars.iv72
...
for.body43.lr.ph:                                 ; preds = %for.end38
  %xtraiter69 = and i64 %7, 7
  %lcmp.mod70 = icmp eq i64 %xtraiter69, 0
  br i1 %lcmp.mod70, label %for.body43.prol.loopexit, label %for.body43.prol.preheader
...
for.body43.prol:                                  ; preds = %for.body43.prol.preheader, %for.body43.prol
  %indvars.iv48.prol = phi i64 [ %indvars.iv.next49.prol, %for.body43.prol ], [ %indvars.iv72, %for.body43.prol.preheader ]
  %prol.iter = phi i64 [ %prol.iter.sub, %for.body43.prol ], [ %xtraiter69, %for.body43.prol.preheader ]
  %arrayidx47.prol = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv54, i64 %indvars.iv48.prol
...
for.body43.prol.loopexit:                         ; preds = %for.body43.prol.loopexit.loopexit, %for.body43.lr.ph
  %indvars.iv48.unr = phi i64 [ %indvars.iv72, %for.body43.lr.ph ], [ %6, %for.body43.prol.loopexit.loopexit ]
  %17 = icmp ult i64 %8, 7
  br i1 %17, label %for.cond19.loopexit, label %for.body43.preheader

for.body43.preheader:                             ; preds = %for.body43.prol.loopexit
  %18 = sub i64 992, %indvars.iv48.unr
  %19 = lshr i64 %18, 3
  %20 = add nuw nsw i64 %19, 1
  %min.iters.check = icmp ult i64 %20, 2
  br i1 %min.iters.check, label %for.body43.preheader76, label %min.iters.checked

min.iters.checked:                                ; preds = %for.body43.preheader
  %n.mod.vf = and i64 %20, 1
  %n.vec = sub nsw i64 %20, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  %21 = add i64 %indvars.iv48.unr, 8
  %22 = shl nuw i64 %19, 3
  %23 = add i64 %21, %22
  %24 = shl nuw nsw i64 %n.mod.vf, 3
  %ind.end = sub i64 %23, %24
  br i1 %cmp.zero, label %for.body43.preheader76, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %25 = shl i64 %index, 3
  %26 = add i64 %indvars.iv48.unr, %25
  %27 = add nsw i64 %26, 7
  %28 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv54, i64 %27
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.cond19.loopexit, label %for.body43.preheader76

for.body43.preheader76:                           ; preds = %middle.block, %min.iters.checked, %for.body43.preheader
  %indvars.iv48.ph = phi i64 [ %indvars.iv48.unr, %min.iters.checked ], [ %indvars.iv48.unr, %for.body43.preheader ], [ %ind.end, %middle.block ]
  br label %for.body43

for.body43:                                       ; preds = %for.body43.preheader76, %for.body43
  %indvars.iv48 = phi i64 [ %indvars.iv.next49.7, %for.body43 ], [ %indvars.iv48.ph, %for.body43.preheader76 ]
  %arrayidx47 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv54, i64 %indvars.iv48
  store double -9.990000e+02, double* %arrayidx47, align 8
  %indvars.iv.next49 = add nuw nsw i64 %indvars.iv48, 1
  %arrayidx47.1 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv54, i64 %indvars.iv.next49
  store double -9.990000e+02, double* %arrayidx47.1, align 8
  %indvars.iv.next49.1 = add nsw i64 %indvars.iv48, 2
  %arrayidx47.2 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv54, i64 %indvars.iv.next49.1
  store double -9.990000e+02, double* %arrayidx47.2, align 8
  %indvars.iv.next49.2 = add nsw i64 %indvars.iv48, 3
  %arrayidx47.3 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv54, i64 %indvars.iv.next49.2
  store double -9.990000e+02, double* %arrayidx47.3, align 8
  %indvars.iv.next49.3 = add nsw i64 %indvars.iv48, 4
  %arrayidx47.4 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv54, i64 %indvars.iv.next49.3
  store double -9.990000e+02, double* %arrayidx47.4, align 8
  %indvars.iv.next49.4 = add nsw i64 %indvars.iv48, 5
  %arrayidx47.5 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv54, i64 %indvars.iv.next49.4
  store double -9.990000e+02, double* %arrayidx47.5, align 8
  %indvars.iv.next49.5 = add nsw i64 %indvars.iv48, 6
  %arrayidx47.6 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv54, i64 %indvars.iv.next49.5
  store double -9.990000e+02, double* %arrayidx47.6, align 8
  %indvars.iv.next49.6 = add nsw i64 %indvars.iv48, 7
  %arrayidx47.7 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv54, i64 %indvars.iv.next49.6
  store double -9.990000e+02, double* %arrayidx47.7, align 8
  %indvars.iv.next49.7 = add nsw i64 %indvars.iv48, 8
  %exitcond51.7 = icmp eq i64 %indvars.iv.next49.7, 1000
  br i1 %exitcond51.7, label %for.cond19.loopexit.loopexit, label %for.body43, !llvm.loop !6
...
for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge:
  %mul44.us55 = fmul double %alpha, 0.000000e+00
  ...
  %broadcast.splatinsert122 = insertelement <2 x double> undef, double %mul44.us55, i32 0
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc53_crit_edge.us, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge
  %indvars.iv93 = phi i64 [ 0, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge ], [ %indvars.iv.next94, %for.cond1.for.inc53_crit_edge.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv93, i64 0
  %0 = add i64 %indvars.iv93, 1
  %scevgep104 = getelementptr [1200 x double], [1200 x double]* %C, i64 %0, i64 0
  %cmp532.us = icmp sgt i64 %indvars.iv93, 0
  %arrayidx41.us.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv93, i64 %indvars.iv93
...
vector.memcheck:                                  ; preds = %for.cond1.preheader.us
  ...
  %scevgep106 = getelementptr [1200 x double], [1200 x double]* %B, i64 %indvars.iv93, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv93, i64 %index
  ...
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv93, i64 %index
  ...
  br i1 %26, label %for.cond1.for.inc53_crit_edge.us.loopexit127, label %vector.body, !llvm.loop !16
...
for.cond4.preheader.us41:                         ; preds = %for.cond4.preheader.us41, %for.cond4.preheader.us41.preheader
  ...
  %arrayidx31.us48 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv93, i64 %indvars.iv
  %27 = load double, double* %arrayidx31.us48, align 8
  %mul32.us49 = fmul double %27, %beta
  %arrayidx36.us50 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv93, i64 %indvars.iv
  %28 = load double, double* %arrayidx36.us50, align 8
  %mul37.us51 = fmul double %28, %alpha
  %29 = load double, double* %arrayidx41.us.us, align 8
  %mul42.us53 = fmul double %mul37.us51, %29
  %add43.us54 = fadd double %mul32.us49, %mul42.us53
  %add45.us56 = fadd double %mul44.us55, %add43.us54
  store double %add45.us56, double* %arrayidx31.us48, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx31.us48.1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv93, i64 %indvars.iv.next
  %30 = load double, double* %arrayidx31.us48.1, align 8
  %mul32.us49.1 = fmul double %30, %beta
  %arrayidx36.us50.1 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv93, i64 %indvars.iv.next
  %31 = load double, double* %arrayidx36.us50.1, align 8
  %mul37.us51.1 = fmul double %31, %alpha
  %32 = load double, double* %arrayidx41.us.us, align 8
  %mul42.us53.1 = fmul double %mul37.us51.1, %32
  %add43.us54.1 = fadd double %mul32.us49.1, %mul42.us53.1
  %add45.us56.1 = fadd double %mul44.us55, %add43.us54.1
  store double %add45.us56.1, double* %arrayidx31.us48.1, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %exitcond100.1 = icmp eq i64 %indvars.iv.next, 1199
  br i1 %exitcond100.1, label %for.cond1.for.inc53_crit_edge.us.loopexit126, label %for.cond4.preheader.us41, !llvm.loop !17
...
for.cond1.for.inc53_crit_edge.us.loopexit126:     ; preds = %for.cond4.preheader.us41
  br label %for.cond1.for.inc53_crit_edge.us

for.cond1.for.inc53_crit_edge.us.loopexit127:     ; preds = %vector.body
  br label %for.cond1.for.inc53_crit_edge.us

for.cond1.for.inc53_crit_edge.us:                 ; preds = %for.cond1.for.inc53_crit_edge.us.loopexit127, %for.cond1.for.inc53_crit_edge.us.loopexit126, %for.cond1.for.inc53_crit_edge.us.loopexit
  %indvars.iv.next94 = add nuw nsw i64 %indvars.iv93, 1
  %exitcond96 = icmp eq i64 %indvars.iv.next94, 1000
  br i1 %exitcond96, label %for.end55, label %for.cond1.preheader.us

for.cond4.preheader.us.us:                        ; preds = %for.cond4.preheader.us.us.preheader, %for.cond4.for.end_crit_edge.us.us
  %indvars.iv89 = phi i64 [ %indvars.iv.next90, %for.cond4.for.end_crit_edge.us.us ], [ 0, %for.cond4.preheader.us.us.preheader ]
  %arrayidx8.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv93, i64 %indvars.iv89
  br label %for.body6.us.us

for.cond4.for.end_crit_edge.us.us:                ; preds = %for.body6.us.us
  %arrayidx31.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv93, i64 %indvars.iv89
  ...
  br i1 %exitcond92, label %for.cond1.for.inc53_crit_edge.us.loopexit, label %for.cond4.preheader.us.us

for.body6.us.us:                                  ; preds = %for.body6.us.us, %for.cond4.preheader.us.us
  %indvars.iv83 = phi i64 [ 0, %for.cond4.preheader.us.us ], [ %indvars.iv.next84, %for.body6.us.us ]
  ...
  %arrayidx12.us.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv93, i64 %indvars.iv83
  ...
  %exitcond88 = icmp eq i64 %indvars.iv.next84, %indvars.iv93
  br i1 %exitcond88, label %for.cond4.for.end_crit_edge.us.us, label %for.body6.us.us
