...
entry:
  ...
  call fastcc void @init_array(double* %0, double* %1, double* %2, double* %arraydecay74, [2000 x double]* %3)
  call void (...) @polybench_timer_start() #3
  call fastcc void @kernel_mvt(double* %0, double* %1, double* %2, double* %arraydecay74, [2000 x double]* %3)
...
if.then:                                          ; preds = %land.lhs.true
  ...
  call fastcc void @print_array(double* %6, double* %5)
  br label %if.end
...
for.cond1.preheader:                              ; preds = %for.inc12, %entry
  ...
  %arrayidx = getelementptr inbounds double, double* %x1, i64 %indvars.iv31
...
for.inc:                                          ; preds = %for.inc, %for.cond1.preheader
  %indvars.iv24 = phi i64 [ %indvars.iv.next25.1, %for.inc ], [ 0, %for.cond1.preheader ]
...
for.inc12:                                        ; preds = %for.inc
  ...
  br i1 %exitcond, label %for.cond18.preheader.preheader, label %for.cond1.preheader
...
for.inc36:                                        ; preds = %for.inc33
  ...
  br i1 %exitcond35, label %for.end38, label %for.cond18.preheader
...
if.then:                                          ; preds = %for.body
  ...
  %fputc4 = call i32 @fputc(i32 10, %struct._IO_FILE* %4) #4
  br label %if.end
