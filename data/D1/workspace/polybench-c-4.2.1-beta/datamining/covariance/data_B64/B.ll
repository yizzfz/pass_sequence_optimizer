...
.lr.ph34.split.us.preheader:
  ...
  %sunkaddr3 = ptrtoint double* %3 to i64
...
.lr.ph34.split.us:                                ; preds = %._crit_edge30.us, %.lr.ph34.split.us.preheader
  ...
  %sunkaddr83 = shl i64 %indvars.iv73, 3
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph34.split.us
  ...
  store double %14, double* %sunkaddr85, align 8
  ...
  store double %17, double* %sunkaddr85, align 8
  ...
  store double %20, double* %sunkaddr85, align 8
...
._crit_edge30.us:                                 ; preds = %._crit_edge
  %21 = fdiv double %20, %0
  %sunkaddr4 = shl i64 %indvars.iv73, 3
  %sunkaddr5 = add i64 %sunkaddr3, %sunkaddr4
  %sunkaddr6 = inttoptr i64 %sunkaddr5 to double*
  store double %21, double* %sunkaddr6, align 8
...
._crit_edge30.us..preheader6.us_crit_edge:        ; preds = %._crit_edge30.us
  %scevgep95 = getelementptr double, double* %3, i64 1200
...
.preheader6.us:                                   ; preds = %._crit_edge25.us, %._crit_edge30.us..preheader6.us_crit_edge
  ...
  %scevgep93 = getelementptr [1200 x double], [1200 x double]* %1, i64 %22, i64 0
  %bound0 = icmp ult double* %scevgep, %scevgep95
  %bound1 = icmp ugt double* %scevgep93, %3
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.vec100 = load <8 x double>, <8 x double>* %26, align 8, !alias.scope !4, !noalias !1
  %27 = fsub <8 x double> %wide.vec100, %wide.vec
  ...
  br i1 %38, label %._crit_edge25.us.loopexit7, label %vector.body, !llvm.loop !6
...
._crit_edge80:                                    ; preds = %._crit_edge80.preheader, %._crit_edge80
  ...
  br i1 %exitcond65.3, label %._crit_edge25.us.loopexit, label %._crit_edge80, !llvm.loop !9

._crit_edge25.us.loopexit:                        ; preds = %._crit_edge80
  br label %._crit_edge25.us

._crit_edge25.us.loopexit7:                       ; preds = %vector.body
  br label %._crit_edge25.us

._crit_edge25.us:                                 ; preds = %._crit_edge25.us.loopexit7, %._crit_edge25.us.loopexit
...
._crit_edge81:                                    ; preds = %._crit_edge81, %.lr.ph.us.us
  ...
  %63 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %75, %._crit_edge81 ]
