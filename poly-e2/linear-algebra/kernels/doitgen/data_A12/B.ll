...
for.cond1.preheader.lr.ph:                        ; preds = %entry
  ...
  %6 = add nsw i64 %wide.trip.count81, -1
  %xtraiter = and i64 %wide.trip.count81, 7
...
for.cond4.preheader.prol:                         ; preds = %for.cond4.preheader.prol, %for.cond4.preheader.prol.preheader
  %indvars.iv55.prol = phi i64 [ %indvars.iv.next56.prol, %for.cond4.preheader.prol ], [ 0, %for.cond4.preheader.prol.preheader ]
...
for.cond4.preheader.prol.loopexit:                ; preds = %for.cond4.preheader.preheader, %for.cond4.preheader.prol.loopexit.unr-lcssa
  %indvars.iv55.unr = phi i64 [ 0, %for.cond4.preheader.preheader ], [ %indvars.iv.next56.prol, %for.cond4.preheader.prol.loopexit.unr-lcssa ]
  br i1 %7, label %for.inc42.loopexit101, label %for.cond4.preheader.preheader.new
...
for.body6.us.us:                                  ; preds = %for.cond4.preheader.us, %for.cond7.for.inc22_crit_edge.us.us
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.cond7.for.inc22_crit_edge.us.us ], [ 0, %for.cond4.preheader.us ]
...
for.inc.us.us.prol:                               ; preds = %for.body6.us.us
  ...
  %22 = load double, double* %sunkaddr94, align 8
...
for.inc.us.us.preheader:                          ; preds = %for.inc.us.us.prol.loopexit
  ...
  %.pre = load double, double* %sunkaddr98, align 8
...
for.cond7.for.inc22_crit_edge.us.us:              ; preds = %for.cond7.for.inc22_crit_edge.us.us.loopexit, %for.inc.us.us.prol.loopexit
  ...
  br i1 %exitcond71, label %for.inc36.lr.ph.us, label %for.body6.us.us

for.inc.us.us:                                    ; preds = %for.inc.us.us.preheader, %for.inc.us.us
  %23 = phi double [ %add.us.us.1, %for.inc.us.us ], [ %.pre, %for.inc.us.us.preheader ]
...
for.cond4.preheader:                              ; preds = %for.cond4.preheader, %for.cond4.preheader.preheader.new
  %indvars.iv55 = phi i64 [ %indvars.iv55.unr, %for.cond4.preheader.preheader.new ], [ %indvars.iv.next56.7, %for.cond4.preheader ]
  %indvars.iv.next56.7 = add nsw i64 %indvars.iv55, 8
  %exitcond58.7 = icmp eq i64 %indvars.iv.next56.7, %wide.trip.count81
  br i1 %exitcond58.7, label %for.inc42.loopexit101.unr-lcssa, label %for.cond4.preheader

for.inc42.loopexit:                               ; preds = %for.inc39.us
  br label %for.inc42

for.inc42.loopexit101.unr-lcssa:                  ; preds = %for.cond4.preheader
...
if.then:                                          ; preds = %land.lhs.true
  tail call void @print_array([140 x [160 x double]]* %arraydecay)
  br label %if.end
...
; Function Attrs: noinline nounwind uwtable
define internal void @print_array([140 x [160 x double]]* %A) #0 {
entry:
