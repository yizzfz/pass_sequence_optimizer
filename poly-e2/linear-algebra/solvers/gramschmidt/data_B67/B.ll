...
for.body3.lr.ph.us:                               ; preds = %for.inc12.us, %entry
  %indvars.iv23 = phi i64 [ 0, %entry ], [ %indvars.iv.next24, %for.inc12.us ]
...
for.inc12.us:                                     ; preds = %for.body3.us
  ...
  %exitcond29 = icmp eq i64 %indvars.iv.next24, 1000
  br i1 %exitcond29, label %for.inc30.us.3.preheader, label %for.body3.lr.ph.us

for.inc30.us.3.preheader:                         ; preds = %for.inc12.us
  br label %for.inc30.us.3

for.inc30.us.3:                                   ; preds = %for.inc30.us.3, %for.inc30.us.3.preheader
  %indvars.iv12 = phi i64 [ 0, %for.inc30.us.3.preheader ], [ %indvars.iv.next13.3.1, %for.inc30.us.3 ]
  ...
  br i1 %exitcond15.3.1, label %for.inc30.us.3.for.end32_crit_edge, label %for.inc30.us.3

for.inc30.us.3.for.end32_crit_edge:               ; preds = %for.inc30.us.3
  ret void
}
...
for.cond1.preheader:                              ; preds = %for.inc86.for.cond1.preheader_crit_edge, %entry
  %indvars.iv73 = phi i64 [ 0, %entry ], [ %indvars.iv.next74, %for.inc86.for.cond1.preheader_crit_edge ]
  %indvars.iv65 = phi i64 [ 1, %entry ], [ %indvars.iv.next66, %for.inc86.for.cond1.preheader_crit_edge ]
  br label %for.body3
...
for.body42.lr.ph.us:                              ; preds = %for.body42.lr.ph.us.preheader, %for.cond33.loopexit.us
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.cond33.loopexit.us ], [ %indvars.iv65, %for.body42.lr.ph.us.preheader ]
...
for.body42.us:                                    ; preds = %for.body42.us, %for.body42.lr.ph.us
  %indvars.iv57 = phi i64 [ 0, %for.body42.lr.ph.us ], [ %indvars.iv.next58.1, %for.body42.us ]
  ...
  br i1 %exitcond60.1, label %for.body62.us.preheader, label %for.body42.us
...
for.body62.us:                                    ; preds = %for.body62.us.preheader, %for.body62.us.for.body62.us_crit_edge
  %9 = phi double [ %.pre86, %for.body62.us.for.body62.us_crit_edge ], [ %add56.us.1, %for.body62.us.preheader ]
...
for.body62.us.for.body62.us_crit_edge:            ; preds = %for.body62.us
  %.pre86 = load double, double* %arrayidx39.us, align 8
  br label %for.body62.us
...
for.body16.for.cond33.preheader_crit_edge:        ; preds = %for.body16
  ...
  br i1 %cmp3411, label %for.body42.lr.ph.us.preheader, label %for.inc86
...
for.inc86:                                        ; preds = %for.inc86.loopexit, %for.body16.for.cond33.preheader_crit_edge
  %exitcond85 = icmp eq i64 %indvars.iv.next74, 1200
  br i1 %exitcond85, label %for.end88, label %for.inc86.for.cond1.preheader_crit_edge
