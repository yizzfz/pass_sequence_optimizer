...
; <label>:12:                                     ; preds = %12, %.preheader.us
  ...
  %27 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv5, i64 %indvars.iv
...
.preheader6.lr.ph:                                ; preds = %4
  ...
  %min.iters.check50 = icmp ult i64 %9, 4
  %n.vec53 = and i64 %9, -4
  %cmp.zero54 = icmp eq i64 %n.vec53, 0
  %ind.end75 = or i64 %n.vec53, 1
  %cmp.n76 = icmp eq i64 %9, %n.vec53
...
.preheader4.us:                                   ; preds = %.preheader4.us.preheader, %._crit_edge.us
  ...
  %10 = add i64 %indvar56, 1
  %scevgep58 = getelementptr [1300 x double], [1300 x double]* %3, i64 %10, i64 1
  %scevgep60 = getelementptr [1300 x double], [1300 x double]* %3, i64 %10, i64 %wide.trip.count22
  %scevgep62 = getelementptr [1300 x double], [1300 x double]* %2, i64 %indvar56, i64 1
  %11 = add i64 %indvar56, 2
  %scevgep64 = getelementptr [1300 x double], [1300 x double]* %2, i64 %11, i64 %wide.trip.count22
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  %12 = add nsw i64 %indvars.iv16, -1
  br i1 %min.iters.check50, label %scalar.ph49.preheader, label %min.iters.checked51

min.iters.checked51:                              ; preds = %.preheader4.us
  br i1 %cmp.zero54, label %scalar.ph49.preheader, label %vector.memcheck70
...
vector.body47:                                    ; preds = %vector.body47.preheader, %vector.body47
  ...
  %13 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv16, i64 %offset.idx77
  %14 = bitcast double* %13 to <2 x double>*
  %wide.load82 = load <2 x double>, <2 x double>* %14, align 8, !alias.scope !1
  ...
  %29 = fadd <2 x double> %22, %wide.load86
  %30 = fadd <2 x double> %23, %wide.load87
  %31 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv.next17, i64 %offset.idx77
  ...
  %37 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %12, i64 %offset.idx77
  %38 = bitcast double* %37 to <2 x double>*
  %wide.load90 = load <2 x double>, <2 x double>* %38, align 8, !alias.scope !1
  %39 = getelementptr double, double* %37, i64 2
  %40 = bitcast double* %39 to <2 x double>*
  %wide.load91 = load <2 x double>, <2 x double>* %40, align 8, !alias.scope !1
  %41 = fadd <2 x double> %35, %wide.load90
  %42 = fadd <2 x double> %36, %wide.load91
  ...
  %45 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv16, i64 %offset.idx77
  ...
  %49 = icmp eq i64 %index.next73, %n.vec53
  br i1 %49, label %middle.block48, label %vector.body47, !llvm.loop !6

middle.block48:                                   ; preds = %vector.body47
  br i1 %cmp.n76, label %._crit_edge.us, label %scalar.ph49.preheader

scalar.ph49.preheader:                            ; preds = %middle.block48, %vector.memcheck70, %min.iters.checked51, %.preheader4.us
...
scalar.ph49:                                      ; preds = %scalar.ph49.preheader, %scalar.ph49
  ...
  %exitcond = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond, label %._crit_edge.us.loopexit, label %scalar.ph49, !llvm.loop !9

._crit_edge.us.loopexit:                          ; preds = %scalar.ph49
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge11.us
  ...
  %scevgep31 = getelementptr [1300 x double], [1300 x double]* %2, i64 %67, i64 %wide.trip.count22
  %scevgep33 = getelementptr [1300 x double], [1300 x double]* %3, i64 %indvar, i64 1
  %68 = add i64 %indvar, 2
  %scevgep35 = getelementptr [1300 x double], [1300 x double]* %3, i64 %68, i64 %wide.trip.count22
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load38 = load <2 x double>, <2 x double>* %73, align 8, !alias.scope !10
  ...
  %wide.load45 = load <2 x double>, <2 x double>* %95, align 8, !alias.scope !10
  %96 = getelementptr double, double* %94, i64 2
  %97 = bitcast double* %96 to <2 x double>*
  %wide.load46 = load <2 x double>, <2 x double>* %97, align 8, !alias.scope !10
  %98 = fadd <2 x double> %92, %wide.load45
  %99 = fadd <2 x double> %93, %wide.load46
