...
.lr.ph34.split.us.preheader:
  ...
  %sunkaddr7.1 = ptrtoint double* %3 to i64
  %sunkaddr = ptrtoint double* %3 to i64
  br label %.lr.ph34.split.us

.lr.ph34.split.us:                                ; preds = %._crit_edge30.us, %.lr.ph34.split.us.preheader
  %indvars.iv77 = phi i64 [ 0, %.lr.ph34.split.us.preheader ], [ %indvars.iv.next78, %._crit_edge30.us ]
  %4 = getelementptr inbounds double, double* %3, i64 %indvars.iv77
  store double 0.000000e+00, double* %4, align 8
  %sunkaddr8 = shl i64 %indvars.iv77, 3
  %sunkaddr9 = add i64 %sunkaddr7, %sunkaddr8
  %sunkaddr10 = inttoptr i64 %sunkaddr9 to double*
  %sunkaddr8.1 = shl i64 %indvars.iv77, 3
  %sunkaddr9.1 = add i64 %sunkaddr7.1, %sunkaddr8.1
  %sunkaddr10.1 = inttoptr i64 %sunkaddr9.1 to double*
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph34.split.us
  %indvars.iv74 = phi i64 [ 0, %.lr.ph34.split.us ], [ %indvars.iv.next75.1.1, %._crit_edge ]
  %5 = phi double [ 0.000000e+00, %.lr.ph34.split.us ], [ %17, %._crit_edge ]
  %6 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv74, i64 %indvars.iv77
  %7 = load double, double* %6, align 8
  %8 = fadd double %5, %7
  store double %8, double* %sunkaddr10, align 8
  %indvars.iv.next75 = or i64 %indvars.iv74, 1
  %9 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next75, i64 %indvars.iv77
  %10 = load double, double* %9, align 8
  %11 = fadd double %8, %10
  store double %11, double* %sunkaddr10, align 8
  %indvars.iv.next75.1 = or i64 %indvars.iv74, 2
  %12 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next75.1, i64 %indvars.iv77
  %13 = load double, double* %12, align 8
  %14 = fadd double %11, %13
  store double %14, double* %sunkaddr10.1, align 8
  %indvars.iv.next75.143 = or i64 %indvars.iv74, 3
  %15 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next75.143, i64 %indvars.iv77
  %16 = load double, double* %15, align 8
  %17 = fadd double %14, %16
  store double %17, double* %sunkaddr10.1, align 8
  %indvars.iv.next75.1.1 = add nsw i64 %indvars.iv74, 4
  %exitcond76.1.1 = icmp eq i64 %indvars.iv.next75.1.1, 1400
  br i1 %exitcond76.1.1, label %._crit_edge30.us, label %._crit_edge

._crit_edge30.us:                                 ; preds = %._crit_edge
  %18 = fdiv double %17, %0
  %sunkaddr38 = shl i64 %indvars.iv77, 3
  %sunkaddr39 = add i64 %sunkaddr, %sunkaddr38
  %sunkaddr40 = inttoptr i64 %sunkaddr39 to double*
  store double %18, double* %sunkaddr40, align 8
  %indvars.iv.next78 = add nuw nsw i64 %indvars.iv77, 1
  %exitcond79 = icmp eq i64 %indvars.iv.next78, 1200
  br i1 %exitcond79, label %._crit_edge30.us..preheader6.us_crit_edge, label %.lr.ph34.split.us
...
.preheader6.us:                                   ; preds = %._crit_edge25.us, %._crit_edge30.us..preheader6.us_crit_edge
  %indvars.iv70 = phi i64 [ 0, %._crit_edge30.us..preheader6.us_crit_edge ], [ %19, %._crit_edge25.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv70, i64 0
  %19 = add nuw nsw i64 %indvars.iv70, 1
  %scevgep22 = getelementptr [1200 x double], [1200 x double]* %1, i64 %19, i64 0
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %22 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv70, i64 %offset.idx
  %23 = bitcast double* %22 to <8 x double>*
  %wide.vec29 = load <8 x double>, <8 x double>* %23, align 8, !alias.scope !4, !noalias !1
  %24 = fsub <8 x double> %wide.vec29, %wide.vec
  ...
  %29 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv70, i64 %28
  ...
  br i1 %35, label %._crit_edge25.us.loopexit41, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv67 = phi i64 [ %indvars.iv.next68.3, %scalar.ph ], [ 0, %scalar.ph.preheader ]
  %36 = getelementptr inbounds double, double* %3, i64 %indvars.iv67
  %37 = load double, double* %36, align 8
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv70, i64 %indvars.iv67
  %39 = load double, double* %38, align 8
  %40 = fsub double %39, %37
  store double %40, double* %38, align 8
  %indvars.iv.next68 = or i64 %indvars.iv67, 1
  %41 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next68
  %42 = load double, double* %41, align 8
  %43 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv70, i64 %indvars.iv.next68
  %44 = load double, double* %43, align 8
  %45 = fsub double %44, %42
  store double %45, double* %43, align 8
  %indvars.iv.next68.1 = or i64 %indvars.iv67, 2
  %46 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next68.1
  %47 = load double, double* %46, align 8
  %48 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv70, i64 %indvars.iv.next68.1
  %49 = load double, double* %48, align 8
  %50 = fsub double %49, %47
  store double %50, double* %48, align 8
  %indvars.iv.next68.2 = or i64 %indvars.iv67, 3
  %51 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next68.2
  %52 = load double, double* %51, align 8
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv70, i64 %indvars.iv.next68.2
  %54 = load double, double* %53, align 8
  %55 = fsub double %54, %52
  store double %55, double* %53, align 8
  %indvars.iv.next68.3 = add nuw nsw i64 %indvars.iv67, 4
  %exitcond69.3 = icmp eq i64 %indvars.iv.next68.3, 1200
  br i1 %exitcond69.3, label %._crit_edge25.us.loopexit, label %scalar.ph, !llvm.loop !9

._crit_edge25.us.loopexit:                        ; preds = %scalar.ph
  br label %._crit_edge25.us

._crit_edge25.us.loopexit41:                      ; preds = %vector.body
  br label %._crit_edge25.us

._crit_edge25.us:                                 ; preds = %._crit_edge25.us.loopexit41, %._crit_edge25.us.loopexit
  %exitcond72 = icmp eq i64 %19, 1400
  br i1 %exitcond72, label %.preheader.us.preheader, label %.preheader6.us
...
.lr.ph19.us:                                      ; preds = %._crit_edge20.us-lcssa.us.us, %.preheader.us.preheader
  %indvars.iv56 = phi i64 [ 0, %.preheader.us.preheader ], [ %indvars.iv.next57, %._crit_edge20.us-lcssa.us.us ]
  br label %.lr.ph.us.us

._crit_edge20.us-lcssa.us.us:                     ; preds = %._crit_edge.us.us
  %indvars.iv.next57 = add nuw nsw i64 %indvars.iv56, 1
  %exitcond58 = icmp eq i64 %indvars.iv.next57, 1200
  br i1 %exitcond58, label %._crit_edge22, label %.lr.ph19.us

.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph19.us
  %indvars.iv53 = phi i64 [ %indvars.iv56, %.lr.ph19.us ], [ %indvars.iv.next54, %._crit_edge.us.us ]
  %57 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv56, i64 %indvars.iv53
...
._crit_edge.us.us:                                ; preds = %._crit_edge35
  ...
  %59 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv53, i64 %indvars.iv56
  store double %58, double* %59, align 8
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %exitcond55 = icmp eq i64 %indvars.iv.next54, 1200
  br i1 %exitcond55, label %._crit_edge20.us-lcssa.us.us, label %.lr.ph.us.us

._crit_edge35:                                    ; preds = %._crit_edge35, %.lr.ph.us.us
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %._crit_edge35 ]
  %60 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %72, %._crit_edge35 ]
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv56
  %62 = load double, double* %61, align 8
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv53
  %64 = load double, double* %63, align 8
  %65 = fmul double %62, %64
  %66 = fadd double %60, %65
  store double %66, double* %57, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %67 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv56
  %68 = load double, double* %67, align 8
  %69 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv53
  ...
  br i1 %exitcond.1, label %._crit_edge.us.us, label %._crit_edge35
