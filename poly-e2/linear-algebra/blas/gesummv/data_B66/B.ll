...
entry:
  %sunkaddr27 = ptrtoint double* %tmp to i64
  %sunkaddr = ptrtoint double* %tmp to i64
  %sunkaddr23 = ptrtoint double* %y to i64
  %sunkaddr31 = ptrtoint double* %y to i64
  br label %for.body.us
...
for.body7.us:                                     ; preds = %for.body7.us, %for.body.us
  ...
  %2 = load double, double* %sunkaddr22, align 8
  %add.us = fadd double %mul.us, %2
  store double %add.us, double* %sunkaddr22, align 8
