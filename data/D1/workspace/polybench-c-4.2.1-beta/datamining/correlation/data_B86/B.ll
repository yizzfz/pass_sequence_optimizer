...
.lr.ph150.split.us:                               ; preds = %._crit_edge.us, %.lr.ph150
  %indvars.iv44 = phi i64 [ 0, %.lr.ph150 ], [ %indvars.iv.next45, %._crit_edge.us ]
  %6 = getelementptr inbounds double, double* %3, i64 %indvars.iv44
  store double 0.000000e+00, double* %6, align 8
  %.pre231 = shl nsw i64 %indvars.iv44, 3
  %sunkaddr152 = add i64 %5, %.pre231
  %7 = inttoptr i64 %sunkaddr152 to double*
  %8 = inttoptr i64 %sunkaddr152 to double*
  br label %.lr.ph150.split.us.new

.lr.ph150.split.us.new:                           ; preds = %.lr.ph150.split.us.new, %.lr.ph150.split.us
  %indvars.iv214 = phi i64 [ 0, %.lr.ph150.split.us ], [ %indvars.iv.next215.1.1, %.lr.ph150.split.us.new ]
  %9 = phi double [ 0.000000e+00, %.lr.ph150.split.us ], [ %21, %.lr.ph150.split.us.new ]
  %10 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv214, i64 %indvars.iv44
  %11 = load double, double* %10, align 8
  %12 = fadd double %11, %9
  store double %12, double* %7, align 8
  %indvars.iv.next215 = or i64 %indvars.iv214, 1
  %13 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next215, i64 %indvars.iv44
  %14 = load double, double* %13, align 8
  %15 = fadd double %14, %12
  store double %15, double* %7, align 8
  %indvars.iv.next215.1 = or i64 %indvars.iv214, 2
  %16 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next215.1, i64 %indvars.iv44
  %17 = load double, double* %16, align 8
  %18 = fadd double %17, %15
  store double %18, double* %8, align 8
  %indvars.iv.next215.152 = or i64 %indvars.iv214, 3
  %19 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next215.152, i64 %indvars.iv44
  %20 = load double, double* %19, align 8
  %21 = fadd double %20, %18
  store double %21, double* %8, align 8
  %indvars.iv.next215.1.1 = add nsw i64 %indvars.iv214, 4
  %exitcond217.1.1 = icmp eq i64 %indvars.iv.next215.1.1, 1400
  br i1 %exitcond217.1.1, label %._crit_edge.us, label %.lr.ph150.split.us.new

._crit_edge.us:                                   ; preds = %.lr.ph150.split.us.new
  %22 = fdiv double %21, %0
  store double %22, double* %8, align 8
  %indvars.iv.next45 = add nuw nsw i64 %indvars.iv44, 1
  %exitcond46 = icmp eq i64 %indvars.iv.next45, 1200
  br i1 %exitcond46, label %.lr.ph144.split.us.preheader, label %.lr.ph150.split.us

.lr.ph144.split.us.preheader:                     ; preds = %._crit_edge.us
...
.lr.ph144.split.us:                               ; preds = %.lr.ph144.split.us.preheader, %._crit_edge141.us
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %._crit_edge141.us ], [ 0, %.lr.ph144.split.us.preheader ]
  %24 = getelementptr inbounds double, double* %4, i64 %indvars.iv41
  store double 0.000000e+00, double* %24, align 8
  %.pre235 = shl nsw i64 %indvars.iv41, 3
  %sunkaddr164 = add i64 %23, %.pre235
  %25 = inttoptr i64 %sunkaddr164 to double*
  %sunkaddr255 = add i64 %5, %.pre235
  %sunkaddr256 = inttoptr i64 %sunkaddr255 to double*
  br label %.lr.ph144.split.us.new

.lr.ph144.split.us.new:                           ; preds = %.lr.ph144.split.us, %.lr.ph144.split.us.new
  %indvars.iv199 = phi i64 [ %indvars.iv.next200.1, %.lr.ph144.split.us.new ], [ 0, %.lr.ph144.split.us ]
  %26 = phi double [ %38, %.lr.ph144.split.us.new ], [ 0.000000e+00, %.lr.ph144.split.us ]
  %27 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv199, i64 %indvars.iv41
  %28 = load double, double* %27, align 8
  %29 = load double, double* %sunkaddr256, align 8
  %30 = fsub double %28, %29
  %31 = fmul double %30, %30
  %32 = fadd double %26, %31
  store double %32, double* %25, align 8
  %indvars.iv.next200 = or i64 %indvars.iv199, 1
  %33 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next200, i64 %indvars.iv41
  %34 = load double, double* %33, align 8
  %35 = load double, double* %sunkaddr256, align 8
  %36 = fsub double %34, %35
  %37 = fmul double %36, %36
  %38 = fadd double %32, %37
  store double %38, double* %25, align 8
  %indvars.iv.next200.1 = add nuw nsw i64 %indvars.iv199, 2
  %exitcond202.1 = icmp eq i64 %indvars.iv.next200.1, 1400
  br i1 %exitcond202.1, label %._crit_edge141.us, label %.lr.ph144.split.us.new

._crit_edge141.us:                                ; preds = %.lr.ph144.split.us.new
  %39 = fdiv double %38, %0
  ...
  br i1 %exitcond43, label %._crit_edge105.._crit_edge107_crit_edge.us.preheader, label %.lr.ph144.split.us

._crit_edge105.._crit_edge107_crit_edge.us.preheader: ; preds = %._crit_edge141.us
  br label %._crit_edge105.._crit_edge107_crit_edge.us

._crit_edge105.._crit_edge107_crit_edge.us:       ; preds = %._crit_edge105.._crit_edge107_crit_edge.us.preheader, %._crit_edge107._crit_edge.us
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %._crit_edge107._crit_edge.us ], [ 0, %._crit_edge105.._crit_edge107_crit_edge.us.preheader ]
  br label %._crit_edge107.us

._crit_edge107.us:                                ; preds = %._crit_edge107.us, %._crit_edge105.._crit_edge107_crit_edge.us
  %indvars.iv194 = phi i64 [ 0, %._crit_edge105.._crit_edge107_crit_edge.us ], [ %indvars.iv.next195, %._crit_edge107.us ]
  %43 = getelementptr inbounds double, double* %3, i64 %indvars.iv194
  %44 = load double, double* %43, align 8
  %45 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv38, i64 %indvars.iv194
  %46 = load double, double* %45, align 8
  %47 = fsub double %46, %44
  store double %47, double* %45, align 8
  %48 = tail call double @sqrt(double %0) #4
  %49 = getelementptr inbounds double, double* %4, i64 %indvars.iv194
  ...
  %exitcond197 = icmp eq i64 %indvars.iv.next195, 1200
  br i1 %exitcond197, label %._crit_edge107._crit_edge.us, label %._crit_edge107.us

._crit_edge107._crit_edge.us:                     ; preds = %._crit_edge107.us
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  %exitcond40 = icmp eq i64 %indvars.iv.next39, 1400
  br i1 %exitcond40, label %.lr.ph125.split.us.preheader, label %._crit_edge105.._crit_edge107_crit_edge.us

.lr.ph125.split.us.preheader:                     ; preds = %._crit_edge107._crit_edge.us
  br label %.lr.ph125.split.us

.lr.ph125.split.us:                               ; preds = %.lr.ph125.split.us.preheader, %._crit_edge108.us
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %._crit_edge108.us ], [ 0, %.lr.ph125.split.us.preheader ]
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %._crit_edge108.us ], [ 1, %.lr.ph125.split.us.preheader ]
...
._crit_edge108.us:                                ; preds = %._crit_edge117.us.us
  %indvars.iv.next32 = add nuw nsw i64 %indvars.iv31, 1
  %exitcond37 = icmp eq i64 %indvars.iv.next36, 1199
  br i1 %exitcond37, label %._crit_edge108._crit_edge, label %.lr.ph125.split.us

.lr.ph.us.us:                                     ; preds = %._crit_edge117.us.us, %.lr.ph125.split.us
  %indvars.iv33 = phi i64 [ %indvars.iv31, %.lr.ph125.split.us ], [ %indvars.iv.next34, %._crit_edge117.us.us ]
...
._crit_edge117.us.us:                             ; preds = %.lr.ph.us.us.new
  ...
  br i1 %exitcond, label %._crit_edge108.us, label %.lr.ph.us.us
...
.lr.ph.us.us.new:                                 ; preds = %.lr.ph.us.us, %.lr.ph.us.us.new
  ...
  br i1 %exitcond.1, label %._crit_edge117.us.us, label %.lr.ph.us.us.new

._crit_edge108._crit_edge:                        ; preds = %._crit_edge108.us
...
; <label>:6:                                      ; preds = %._crit_edge12.us, %.._crit_edge_crit_edge.us
  %indvars.iv = phi i64 [ 0, %.._crit_edge_crit_edge.us ], [ %indvars.iv.next, %._crit_edge12.us ]
