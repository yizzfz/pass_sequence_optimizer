...
for.body:                                         ; preds = %for.body, %entry
  %indvars.iv23 = phi i64 [ 0, %entry ], [ %indvars.iv.next24.2, %for.body ]
  %0 = trunc i64 %indvars.iv23 to i32
  %conv2 = sitofp i32 %0 to double
  %arrayidx = getelementptr inbounds double, double* %x, i64 %indvars.iv23
  ...
  %3 = trunc i64 %indvars.iv.next24.1 to i32
  %conv2.2 = sitofp i32 %3 to double
  %div.2 = fdiv double %conv2.2, 2.100000e+03
  %add.2 = fadd double %div.2, 1.000000e+00
  %arrayidx.2 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next24.1
  ...
  br i1 %exitcond25.2, label %for.body6.us.preheader, label %for.body

for.body6.us.preheader:                           ; preds = %for.body
  br label %for.body6.us

for.body6.us:                                     ; preds = %for.body6.us.preheader, %for.cond7.for.end21_crit_edge.us
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.cond7.for.end21_crit_edge.us ], [ 0, %for.body6.us.preheader ]
  br label %for.body10.us

for.body10.us:                                    ; preds = %for.body10.us, %for.body6.us
  %indvars.iv = phi i64 [ 0, %for.body6.us ], [ %indvars.iv.next.1, %for.body10.us ]
  %4 = add nuw nsw i64 %indvars.iv20, %indvars.iv
  ...
  %6 = add nuw nsw i64 %indvars.iv20, %indvars.iv.next
  ...
  br i1 %exitcond.1, label %for.cond7.for.end21_crit_edge.us, label %for.body10.us

for.cond7.for.end21_crit_edge.us:                 ; preds = %for.body10.us
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  %exitcond22 = icmp eq i64 %indvars.iv.next21, 1900
  br i1 %exitcond22, label %for.end24, label %for.body6.us

for.end24:                                        ; preds = %for.cond7.for.end21_crit_edge.us
  ret void
}
...
for.body5.us.preheader:                           ; preds = %vector.body
  ...
  %scevgep103 = getelementptr double, double* %y, i64 2100
  %29 = ptrtoint double* %tmp to i64
  %30 = bitcast double* %scevgep103 to i8*
  %31 = bitcast double* %scevgep to i8*
  br label %for.body5.us

for.body5.us:                                     ; preds = %for.inc42.us, %for.body5.us.preheader
  %indvars.iv85 = phi i64 [ %44, %for.inc42.us ], [ 0, %for.body5.us.preheader ]
  %arrayidx7.us = getelementptr inbounds double, double* %tmp, i64 %indvars.iv85
  store double 0.000000e+00, double* %arrayidx7.us, align 8
  %sunkaddr70 = shl nsw i64 %indvars.iv85, 3
  %sunkaddr71 = add i64 %29, %sunkaddr70
  %sunkaddr72 = inttoptr i64 %sunkaddr71 to double*
  %.pre95 = load double, double* %sunkaddr72, align 8
  %32 = inttoptr i64 %sunkaddr71 to double*
  br label %for.body10.us

for.inc42.us:                                     ; preds = %for.body26.us.for.body26.us_crit_edge
  %exitcond87 = icmp eq i64 %44, 1900
...
for.body26.us.for.body26.us_crit_edge:            ; preds = %for.body26.us.for.body26.us_crit_edge, %for.body26.us.for.body26.us_crit_edge.preheader.new
  %indvars.iv8094 = phi i64 [ %indvars.iv8094.ph, %for.body26.us.for.body26.us_crit_edge.preheader.new ], [ %indvars.iv.next81.1, %for.body26.us.for.body26.us_crit_edge ]
  %indvars.iv.next81 = add nuw nsw i64 %indvars.iv8094, 1
  %.pre = load double, double* %51, align 8
  %arrayidx28.us = getelementptr inbounds double, double* %y, i64 %indvars.iv.next81
  %33 = load double, double* %arrayidx28.us, align 8
  %arrayidx32.us = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv85, i64 %indvars.iv.next81
  %34 = load double, double* %arrayidx32.us, align 8
  %mul35.us = fmul double %34, %.pre
  %add36.us = fadd double %33, %mul35.us
  store double %add36.us, double* %arrayidx28.us, align 8
  %indvars.iv.next81.1 = add nsw i64 %indvars.iv8094, 2
  %.pre.1 = load double, double* %51, align 8
  %arrayidx28.us.1 = getelementptr inbounds double, double* %y, i64 %indvars.iv.next81.1
  %35 = load double, double* %arrayidx28.us.1, align 8
  %arrayidx32.us.1 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv85, i64 %indvars.iv.next81.1
  %36 = load double, double* %arrayidx32.us.1, align 8
  %mul35.us.1 = fmul double %36, %.pre.1
  %add36.us.1 = fadd double %35, %mul35.us.1
  store double %add36.us.1, double* %arrayidx28.us.1, align 8
  %exitcond84.1 = icmp eq i64 %indvars.iv.next81.1, 2099
  br i1 %exitcond84.1, label %for.inc42.us, label %for.body26.us.for.body26.us_crit_edge, !llvm.loop !4

for.body10.us:                                    ; preds = %for.body10.us, %for.body5.us
  %37 = phi double [ %.pre95, %for.body5.us ], [ %add.us.2, %for.body10.us ]
  %indvars.iv = phi i64 [ 0, %for.body5.us ], [ %indvars.iv.next.2, %for.body10.us ]
  %arrayidx16.us = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv85, i64 %indvars.iv
  ...
  store double %add.us, double* %32, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx16.us.1 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv85, i64 %indvars.iv.next
  ...
  store double %add.us.1, double* %32, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %arrayidx16.us.2 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv85, i64 %indvars.iv.next.1
  ...
  store double %add.us.2, double* %32, align 8
...
for.body26.us.preheader:                          ; preds = %for.body10.us
  %44 = add nuw nsw i64 %indvars.iv85, 1
  %scevgep105 = getelementptr [2100 x double], [2100 x double]* %A, i64 %indvars.iv85, i64 1
  %scevgep107 = getelementptr [2100 x double], [2100 x double]* %A, i64 %44, i64 0
  %45 = load double, double* %y, align 8
  %arrayidx32.us91 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv85, i64 0
  %46 = load double, double* %arrayidx32.us91, align 8
  %mul35.us92 = fmul double %46, %add.us.2
  %add36.us93 = fadd double %45, %mul35.us92
  store double %add36.us93, double* %y, align 8
  %bc = inttoptr i64 %sunkaddr71 to i8*
  %bound0 = icmp ult i8* %31, %bc
  %bound1 = icmp ult i8* %bc, %30
  %found.conflict = and i1 %bound0, %bound1
  %bound0110 = icmp ult double* %scevgep, %scevgep107
  %bound1111 = icmp ult double* %scevgep105, %scevgep103
  %found.conflict112 = and i1 %bound0110, %bound1111
  %conflict.rdx = or i1 %found.conflict, %found.conflict112
  br i1 %conflict.rdx, label %for.body26.us.for.body26.us_crit_edge.preheader.new, label %vector.body97.preheader

vector.body97.preheader:                          ; preds = %for.body26.us.preheader
  %47 = inttoptr i64 %sunkaddr71 to double*
  br label %vector.body97

for.body26.us.for.body26.us_crit_edge.preheader.new.loopexit: ; preds = %vector.body97
...
for.body26.us.for.body26.us_crit_edge.preheader.new: ; preds = %for.body26.us.for.body26.us_crit_edge.preheader.new.loopexit, %for.body26.us.preheader
  %indvars.iv8094.ph = phi i64 [ 1, %for.body26.us.preheader ], [ 2097, %for.body26.us.for.body26.us_crit_edge.preheader.new.loopexit ]
  %48 = inttoptr i64 %sunkaddr71 to double*
  %.pre.prol = load double, double* %48, align 8
  %arrayidx28.us.prol = getelementptr inbounds double, double* %y, i64 %indvars.iv8094.ph
  %49 = load double, double* %arrayidx28.us.prol, align 8
  %arrayidx32.us.prol = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv85, i64 %indvars.iv8094.ph
  %50 = load double, double* %arrayidx32.us.prol, align 8
  %mul35.us.prol = fmul double %50, %.pre.prol
  %add36.us.prol = fadd double %49, %mul35.us.prol
  store double %add36.us.prol, double* %arrayidx28.us.prol, align 8
  %51 = inttoptr i64 %sunkaddr71 to double*
  br label %for.body26.us.for.body26.us_crit_edge

vector.body97:                                    ; preds = %vector.body97.preheader, %vector.body97
  %index114 = phi i64 [ %index.next115, %vector.body97 ], [ 0, %vector.body97.preheader ]
  %52 = or i64 %index114, 1
  %53 = load double, double* %47, align 8, !alias.scope !5
  %54 = insertelement <2 x double> undef, double %53, i32 0
  %55 = shufflevector <2 x double> %54, <2 x double> undef, <2 x i32> zeroinitializer
  %56 = getelementptr inbounds double, double* %y, i64 %52
  %57 = bitcast double* %56 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %57, align 8, !alias.scope !8, !noalias !10
  %58 = getelementptr double, double* %56, i64 2
  %59 = bitcast double* %58 to <2 x double>*
  %wide.load122 = load <2 x double>, <2 x double>* %59, align 8, !alias.scope !8, !noalias !10
  %60 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv85, i64 %52
  %61 = bitcast double* %60 to <2 x double>*
  %wide.load123 = load <2 x double>, <2 x double>* %61, align 8, !alias.scope !12
  %62 = getelementptr double, double* %60, i64 2
  %63 = bitcast double* %62 to <2 x double>*
  %wide.load124 = load <2 x double>, <2 x double>* %63, align 8, !alias.scope !12
  %64 = fmul <2 x double> %wide.load123, %55
  %65 = fmul <2 x double> %wide.load124, %55
  %66 = fadd <2 x double> %wide.load, %64
  %67 = fadd <2 x double> %wide.load122, %65
  store <2 x double> %66, <2 x double>* %57, align 8, !alias.scope !8, !noalias !10
  store <2 x double> %67, <2 x double>* %59, align 8, !alias.scope !8, !noalias !10
  %index.next115 = add nuw nsw i64 %index114, 4
  %68 = icmp eq i64 %index.next115, 2096
  br i1 %68, label %for.body26.us.for.body26.us_crit_edge.preheader.new.loopexit, label %vector.body97, !llvm.loop !13
