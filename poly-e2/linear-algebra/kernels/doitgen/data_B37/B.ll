...
for.cond1.preheader.lr.ph:                        ; preds = %entry
  ...
  %8 = icmp sgt i32 %np, 0
  %9 = icmp eq i64 %xtraiter67, 0
  %10 = icmp ult i64 %3, 3
  %11 = icmp eq i64 %xtraiter65, 0
  %12 = icmp eq i32 %np, 1
  %sunkaddr = ptrtoint double* %sum to i64
  %13 = ptrtoint double* %sum to i64
...
for.cond4.preheader.us:                           ; preds = %for.inc39.us, %for.cond4.preheader.lr.ph.for.cond4.preheader.us_crit_edge
  %17 = phi i32 [ %storemerge52, %for.cond4.preheader.lr.ph.for.cond4.preheader.us_crit_edge ], [ %split20.us, %for.inc39.us ]
  %indvars.iv1124.us = phi i64 [ 0, %for.cond4.preheader.lr.ph.for.cond4.preheader.us_crit_edge ], [ %indvars.iv.next12.us, %for.inc39.us ]
...
for.body27.us:                                    ; preds = %for.body27.us, %for.body27.us.prol.loopexit.for.body27.us_crit_edge
  %indvars.iv922.us = phi i64 [ %indvars.iv922.us.unr, %for.body27.us.prol.loopexit.for.body27.us_crit_edge ], [ %indvars.iv.next10.us.3, %for.body27.us ]
...
for.body6.us29:                                   ; preds = %for.cond7.for.inc22_crit_edge.us46, %for.body6.us29.preheader
  %indvars.iv718.us30 = phi i64 [ 0, %for.body6.us29.preheader ], [ %indvars.iv.next8.us43, %for.cond7.for.inc22_crit_edge.us46 ]
  ...
  br i1 %11, label %for.body9.us32.prol.loopexit, label %for.body9.us32.prol

for.body9.us32.prol:                              ; preds = %for.body6.us29
  %30 = load double, double* %arrayidx15.us34.prol, align 8
  %arrayidx19.us35.prol = getelementptr inbounds [160 x double], [160 x double]* %C4, i64 0, i64 %indvars.iv718.us30
  %31 = load double, double* %arrayidx19.us35.prol, align 8
  %mul.us36.prol = fmul double %30, %31
  %add.us37.prol = fadd double %mul.us36.prol, 0.000000e+00
  %sunkaddr70 = shl i64 %indvars.iv718.us30, 3
  %sunkaddr71 = add i64 %13, %sunkaddr70
...
for.body9.us32.prol.loopexit:                     ; preds = %for.body6.us29, %for.body9.us32.prol
  ...
  br i1 %12, label %for.cond7.for.inc22_crit_edge.us46, label %for.body9.us32.preheader

for.body9.us32.preheader:                         ; preds = %for.body9.us32.prol.loopexit
  %sunkaddr81 = shl i64 %indvars.iv718.us30, 3
  %sunkaddr82 = add i64 %sunkaddr, %sunkaddr81
  %sunkaddr83 = inttoptr i64 %sunkaddr82 to double*
  br label %for.body9.us32

for.body9.us32:                                   ; preds = %for.body9.us32, %for.body9.us32.preheader
  %32 = phi double [ %.unr.ph, %for.body9.us32.preheader ], [ %add.us37.1, %for.body9.us32 ]
  %indvars.iv16.us33 = phi i64 [ %indvars.iv16.us33.unr.ph, %for.body9.us32.preheader ], [ %indvars.iv.next.us38.1, %for.body9.us32 ]
  ...
  %33 = load double, double* %arrayidx15.us34, align 8
  %arrayidx19.us35 = getelementptr inbounds [160 x double], [160 x double]* %C4, i64 %indvars.iv16.us33, i64 %indvars.iv718.us30
  %34 = load double, double* %arrayidx19.us35, align 8
  %mul.us36 = fmul double %33, %34
  %add.us37 = fadd double %32, %mul.us36
  store double %add.us37, double* %sunkaddr83, align 8
  ...
  %35 = load double, double* %arrayidx15.us34.1, align 8
  %arrayidx19.us35.1 = getelementptr inbounds [160 x double], [160 x double]* %C4, i64 %indvars.iv.next.us38, i64 %indvars.iv718.us30
  %36 = load double, double* %arrayidx19.us35.1, align 8
  %mul.us36.1 = fmul double %35, %36
  %add.us37.1 = fadd double %add.us37, %mul.us36.1
  store double %add.us37.1, double* %sunkaddr83, align 8
...
for.cond7.for.inc22_crit_edge.us46:               ; preds = %for.cond7.for.inc22_crit_edge.us46.loopexit, %for.body9.us32.prol.loopexit
  ...
  br i1 %exitcond57, label %for.cond4.for.cond25.preheader_crit_edge.us.loopexit84, label %for.body6.us29
...
for.cond4.for.cond25.preheader_crit_edge.us.loopexit84: ; preds = %for.cond7.for.inc22_crit_edge.us46
  br label %for.cond4.for.cond25.preheader_crit_edge.us
...
for.cond4.for.cond25.preheader_crit_edge.us:      ; preds = %for.cond4.for.cond25.preheader_crit_edge.us.loopexit84, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit
  %split20.us = phi i32 [ %17, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit ], [ %storemerge52, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit84 ]
...
for.body27.lr.ph.us:                              ; preds = %for.cond4.for.cond25.preheader_crit_edge.us
  ...
  br i1 %9, label %for.body27.us.prol.loopexit, label %for.body27.lr.ph.us.for.body27.us.prol_crit_edge

for.body27.lr.ph.us.for.body27.us.prol_crit_edge: ; preds = %for.body27.lr.ph.us
  br label %for.body27.us.prol

for.body27.us.prol:                               ; preds = %for.body27.us.prol, %for.body27.lr.ph.us.for.body27.us.prol_crit_edge
  %indvars.iv922.us.prol = phi i64 [ 0, %for.body27.lr.ph.us.for.body27.us.prol_crit_edge ], [ %indvars.iv.next10.us.prol, %for.body27.us.prol ]
  %prol.iter69 = phi i64 [ %xtraiter67, %for.body27.lr.ph.us.for.body27.us.prol_crit_edge ], [ %prol.iter69.sub, %for.body27.us.prol ]
...
for.body27.us.prol.loopexit:                      ; preds = %for.body27.us.prol.loopexit.loopexit, %for.body27.lr.ph.us
  ...
  br i1 %10, label %for.inc39.us, label %for.body27.us.prol.loopexit.for.body27.us_crit_edge
...
for.cond4.preheader:                              ; preds = %for.inc39, %for.cond4.preheader.preheader
  %indvars.iv1124 = phi i64 [ 0, %for.cond4.preheader.preheader ], [ %indvars.iv.next12, %for.inc39 ]
  br i1 %14, label %for.body27.lr.ph, label %for.inc39

for.body27.lr.ph:                                 ; preds = %for.cond4.preheader
  br i1 %15, label %for.body27.prol.loopexit, label %for.body27.lr.ph.for.body27.prol_crit_edge

for.body27.lr.ph.for.body27.prol_crit_edge:       ; preds = %for.body27.lr.ph
  br label %for.body27.prol

for.body27.prol:                                  ; preds = %for.body27.prol, %for.body27.lr.ph.for.body27.prol_crit_edge
  %indvars.iv922.prol = phi i64 [ 0, %for.body27.lr.ph.for.body27.prol_crit_edge ], [ %indvars.iv.next10.prol, %for.body27.prol ]
  %prol.iter = phi i64 [ %xtraiter, %for.body27.lr.ph.for.body27.prol_crit_edge ], [ %prol.iter.sub, %for.body27.prol ]
...
for.body27.prol.loopexit:                         ; preds = %for.body27.prol.loopexit.loopexit, %for.body27.lr.ph
  ...
  br i1 %16, label %for.inc39, label %for.body27.prol.loopexit.for.body27_crit_edge

for.body27.prol.loopexit.for.body27_crit_edge:    ; preds = %for.body27.prol.loopexit
  br label %for.body27

for.body27:                                       ; preds = %for.body27, %for.body27.prol.loopexit.for.body27_crit_edge
  %indvars.iv922 = phi i64 [ %indvars.iv922.unr, %for.body27.prol.loopexit.for.body27_crit_edge ], [ %indvars.iv.next10.3, %for.body27 ]
  %arrayidx29 = getelementptr inbounds double, double* %sum, i64 %indvars.iv922
  %43 = bitcast double* %arrayidx29 to i64*
  ...
  %45 = bitcast double* %arrayidx35 to i64*
  ...
  %46 = bitcast double* %arrayidx29.1 to i64*
  ...
  %48 = bitcast double* %arrayidx35.1 to i64*
  ...
  %49 = bitcast double* %arrayidx29.2 to i64*
  ...
  %51 = bitcast double* %arrayidx35.2 to i64*
  ...
  %52 = bitcast double* %arrayidx29.3 to i64*
  ...
  %54 = bitcast double* %arrayidx35.3 to i64*
...
for.inc39:                                        ; preds = %for.inc39.loopexit, %for.body27.prol.loopexit, %for.cond4.preheader
  ...
  br i1 %exitcond56, label %for.inc42.loopexit85, label %for.cond4.preheader
...
for.inc42:                                        ; preds = %for.inc42.loopexit85, %for.inc42.loopexit, %for.cond1.preheader
  %.lcssa14 = phi i32 [ %storemerge52, %for.cond1.preheader ], [ %split20.us, %for.inc42.loopexit ], [ %storemerge52, %for.inc42.loopexit85 ]
...
for.body6:                                        ; preds = %for.body6, %for.cond4.preheader
  ...
  %indvars.iv.next9.1 = add nuw nsw i64 %indvars.iv818, 2
...
for.inc15:                                        ; preds = %for.inc12
  ...
  br i1 %exitcond24, label %for.inc15.for.cond22.preheader_crit_edge, label %for.cond1.preheader

for.inc15.for.cond22.preheader_crit_edge:         ; preds = %for.inc15
  br label %for.cond22.preheader

for.cond22.preheader:                             ; preds = %for.inc38, %for.inc15.for.cond22.preheader_crit_edge
  %indvars.iv617 = phi i64 [ 0, %for.inc15.for.cond22.preheader_crit_edge ], [ %indvars.iv.next7, %for.inc38 ]
  br label %for.body25
