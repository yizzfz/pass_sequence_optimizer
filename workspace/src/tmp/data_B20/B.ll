...
; <label>:5:                                      ; preds = %114, %.loopexit
  %6 = phi i64 [ 0, %.loopexit ], [ %115, %114 ]
  %7 = mul nuw nsw i64 %6, 280
  %8 = getelementptr i8, i8* %1, i64 %7
  %9 = add nuw nsw i64 %7, 277
  %10 = getelementptr i8, i8* %1, i64 %9
  %11 = add nsw i64 %7, -1
  %12 = getelementptr i8, i8* %0, i64 %11
  %13 = add nuw nsw i64 %7, 276
  %14 = getelementptr i8, i8* %0, i64 %13
  %15 = icmp ult i8* %8, %14
  %16 = icmp ult i8* %12, %10
  %17 = and i1 %15, %16
  br i1 %17, label %.preheader, label %27

.preheader:                                       ; preds = %5, %27
  %.ph = phi i64 [ 0, %5 ], [ 256, %27 ]
  %18 = add nuw nsw i64 %.ph, %7
  %19 = add nsw i64 %18, -1
  %20 = getelementptr inbounds i8, i8* %0, i64 %19
...
; <label>:27:                                     ; preds = %5
  ...
  %30 = add nuw nsw i64 %7, 32
  %31 = add nuw nsw i64 %7, 31
  ...
  %42 = add nuw nsw i64 %7, 64
  %43 = add nuw nsw i64 %7, 63
  ...
  %54 = add nuw nsw i64 %7, 96
  %55 = add nuw nsw i64 %7, 95
  ...
  %66 = add nuw nsw i64 %7, 128
  %67 = add nuw nsw i64 %7, 127
  ...
  %78 = add nuw nsw i64 %7, 160
  %79 = add nuw nsw i64 %7, 159
  ...
  %90 = add nuw nsw i64 %7, 192
  %91 = add nuw nsw i64 %7, 191
  ...
  %102 = add nuw nsw i64 %7, 224
  %103 = add nuw nsw i64 %7, 223
...
; <label>:114:                                    ; preds = %117
  ...
  br i1 %116, label %.loopexit.loopexit, label %5

; <label>:117:                                    ; preds = %.preheader, %117
  %118 = phi i64 [ %138, %117 ], [ %23, %.preheader ]
  %119 = add i64 %118, %7
