...
for.body5.us:                                     ; preds = %for.body5.us.for.body5.us_crit_edge, %for.body.us
  ...
  br i1 %exitcond, label %for.cond2.for.inc24_crit_edge.us, label %for.body5.us.for.body5.us_crit_edge
...
for.body5.us.for.body5.us_crit_edge:              ; preds = %for.body5.us
  ...
  store i64 %6, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @__profc_B.ll_init_array, i64 0, i64 0)
  br label %for.body5.us
...
for.cond2.for.inc24_crit_edge.us:                 ; preds = %for.body5.us
  ...
  store i64 %7, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @__profc_B.ll_init_array, i64 0, i64 1)
...
for.end26.loopexit:                               ; preds = %for.cond2.for.inc24_crit_edge.us
  ...
  store i64 %8, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @__profc_B.ll_init_array, i64 0, i64 3)
  br label %for.end26
...
for.end26:                                        ; preds = %for.end26.loopexit, %entry
  ...
  store i64 %9, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @__profc_B.ll_init_array, i64 0, i64 2)
  ret void
}
...
for.body7.us:                                     ; preds = %for.body7.us.for.body7.us_crit_edge, %for.body.us
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond, label %for.cond5.for.end_crit_edge.us, label %for.body7.us.for.body7.us_crit_edge
...
for.body7.us.for.body7.us_crit_edge:              ; preds = %for.body7.us
  ...
  %6 = add i64 %pgocount, 1
  store i64 %6, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @__profc_B.ll_kernel_gesummv, i64 0, i64 0)
  br label %for.body7.us
...
for.cond5.for.end_crit_edge.us:                   ; preds = %for.body7.us
  ...
  %7 = add i64 %pgocount1, 1
  store i64 %7, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @__profc_B.ll_kernel_gesummv, i64 0, i64 1)
  %8 = load double, double* %arrayidx.us, align 8
  %mul32.us = fmul double %8, %alpha
  %9 = load double, double* %arrayidx4.us, align 8
...
for.end41.loopexit:                               ; preds = %for.cond5.for.end_crit_edge.us
  ...
  store i64 %10, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @__profc_B.ll_kernel_gesummv, i64 0, i64 3)
  br label %for.end41
...
for.end41:                                        ; preds = %for.end41.loopexit, %entry
  ...
  store i64 %11, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @__profc_B.ll_kernel_gesummv, i64 0, i64 2)
  ret void
}
