...
for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.inc39.us
  %6 = phi i32 [ %split20.us, %for.inc39.us ], [ %storemerge52, %for.cond4.preheader.us.preheader ]
...
for.body27.us:                                    ; preds = %for.body27.us.preheader, %for.body27.us
  ...
  %exitcond57.3 = icmp eq i64 %indvars.iv.next10.us.3, %0
...
for.body6.us29:                                   ; preds = %for.cond7.for.inc22_crit_edge.us46, %for.body6.us29.preheader
  ...
  br i1 %20, label %for.body9.us32.prol.loopexit, label %for.body9.us32.prol

for.body9.us32.prol:                              ; preds = %for.body6.us29
  %21 = ptrtoint double* %sum to i64
  %22 = load double, double* %arrayidx15.us34.prol, align 8
  %arrayidx19.us35.prol = getelementptr inbounds [160 x double], [160 x double]* %C4, i64 0, i64 %indvars.iv718.us30
  %23 = load double, double* %arrayidx19.us35.prol, align 8
  %mul.us36.prol = fmul double %22, %23
  %add.us37.prol = fadd double %mul.us36.prol, 0.000000e+00
  %sunkaddr70 = shl i64 %indvars.iv718.us30, 3
  %sunkaddr71 = add i64 %21, %sunkaddr70
...
for.body9.us32.prol.loopexit:                     ; preds = %for.body6.us29, %for.body9.us32.prol
  ...
  %24 = icmp eq i32 %np, 1
  br i1 %24, label %for.cond7.for.inc22_crit_edge.us46, label %for.body9.us32.preheader
...
for.body9.us32:                                   ; preds = %for.body9.us32, %for.body9.us32.preheader
  %25 = phi double [ %add.us37.1, %for.body9.us32 ], [ %.unr.ph, %for.body9.us32.preheader ]
  ...
  %26 = load double, double* %arrayidx15.us34, align 8
  %arrayidx19.us35 = getelementptr inbounds [160 x double], [160 x double]* %C4, i64 %indvars.iv16.us33, i64 %indvars.iv718.us30
  %27 = load double, double* %arrayidx19.us35, align 8
  %mul.us36 = fmul double %26, %27
  %add.us37 = fadd double %25, %mul.us36
  %sunkaddr = ptrtoint double* %sum to i64
  %sunkaddr83 = mul i64 %indvars.iv718.us30, 8
  %sunkaddr84 = add i64 %sunkaddr, %sunkaddr83
  %sunkaddr85 = inttoptr i64 %sunkaddr84 to double*
  store double %add.us37, double* %sunkaddr85, align 8
  ...
  %28 = load double, double* %arrayidx15.us34.1, align 8
  %arrayidx19.us35.1 = getelementptr inbounds [160 x double], [160 x double]* %C4, i64 %indvars.iv.next.us38, i64 %indvars.iv718.us30
  %29 = load double, double* %arrayidx19.us35.1, align 8
  %mul.us36.1 = fmul double %28, %29
  %add.us37.1 = fadd double %add.us37, %mul.us36.1
  store double %add.us37.1, double* %sunkaddr85, align 8
...
for.cond7.for.inc22_crit_edge.us46:               ; preds = %for.cond7.for.inc22_crit_edge.us46.loopexit, %for.body9.us32.prol.loopexit
  ...
  %exitcond55 = icmp eq i64 %indvars.iv.next8.us43, %0
  br i1 %exitcond55, label %for.cond4.for.cond25.preheader_crit_edge.us.loopexit86, label %for.body6.us29

for.cond4.for.cond25.preheader_crit_edge.us.loopexit: ; preds = %for.cond4.preheader.us
  %30 = bitcast double* %sum to i8*
  call void @llvm.memset.p0i8.i64(i8* %30, i8 0, i64 %2, i32 8, i1 false)
  br label %for.cond4.for.cond25.preheader_crit_edge.us

for.cond4.for.cond25.preheader_crit_edge.us.loopexit86: ; preds = %for.cond7.for.inc22_crit_edge.us46
  br label %for.cond4.for.cond25.preheader_crit_edge.us

for.cond4.for.cond25.preheader_crit_edge.us:      ; preds = %for.cond4.for.cond25.preheader_crit_edge.us.loopexit86, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit
  %split20.us = phi i32 [ %6, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit ], [ %storemerge52, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit86 ]
  %31 = icmp sgt i32 %np, 0
  br i1 %31, label %for.body27.lr.ph.us, label %for.inc39.us

for.body27.lr.ph.us:                              ; preds = %for.cond4.for.cond25.preheader_crit_edge.us
  %32 = icmp eq i64 %xtraiter67, 0
  %idxprom30.us = sext i32 %split20.us to i64
  br i1 %32, label %for.body27.us.prol.loopexit, label %for.body27.us.prol.preheader
...
for.body27.us.prol.loopexit:                      ; preds = %for.body27.us.prol.loopexit.loopexit, %for.body27.lr.ph.us
  ...
  %36 = icmp ult i64 %3, 3
  br i1 %36, label %for.inc39.us, label %for.body27.us.preheader
...
for.cond4.preheader:                              ; preds = %for.inc39, %for.cond4.preheader.preheader
  ...
  %37 = icmp sgt i32 %np, 0
  br i1 %37, label %for.body27.lr.ph, label %for.inc39

for.body27.lr.ph:                                 ; preds = %for.cond4.preheader
  %38 = icmp eq i64 %xtraiter, 0
  br i1 %38, label %for.body27.prol.loopexit, label %for.body27.prol.preheader
...
for.body27.prol.loopexit:                         ; preds = %for.body27.prol.loopexit.loopexit, %for.body27.lr.ph
  ...
  %42 = icmp ult i64 %3, 3
  br i1 %42, label %for.inc39, label %for.body27.preheader
...
for.inc39:                                        ; preds = %for.inc39.loopexit, %for.body27.prol.loopexit, %for.cond4.preheader
  ...
  %exitcond59 = icmp eq i64 %indvars.iv.next12, %1
  br i1 %exitcond59, label %for.inc42.loopexit87, label %for.cond4.preheader

for.inc42.loopexit:                               ; preds = %for.inc39.us
  br label %for.inc42

for.inc42.loopexit87:                             ; preds = %for.inc39
  br label %for.inc42

for.inc42:                                        ; preds = %for.inc42.loopexit87, %for.inc42.loopexit, %for.cond1.preheader
  %.lcssa14 = phi i32 [ %storemerge52, %for.cond1.preheader ], [ %split20.us, %for.inc42.loopexit ], [ %storemerge52, %for.inc42.loopexit87 ]
