...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.end_crit_edge.us, %entry
  %indvars.iv14.us = phi i64 [ 0, %entry ], [ %indvars.iv.next11.us, %for.cond1.for.end_crit_edge.us ]
...
for.cond15.preheader:                             ; preds = %for.end236, %entry
  %storemerge140 = phi i32 [ 1, %entry ], [ %inc238, %for.end236 ]
  br label %for.body34.us.lver.check

for.body34.us.lver.check:                         ; preds = %for.end119.us, %for.cond15.preheader
  %indvar = phi i64 [ 0, %for.cond15.preheader ], [ %indvar.next, %for.end119.us ]
  %indvars.iv121.us = phi i64 [ 1, %for.cond15.preheader ], [ %6, %for.end119.us ]
  %0 = add i64 %indvar, 1
  %1 = add i64 %indvar, 1
...
for.end233.us:                                    ; preds = %for.body211.us
  %exitcond146 = icmp eq i64 %27, 999
  %indvar.next14 = add i64 %indvar13, 1
  br i1 %exitcond146, label %for.end236, label %for.body144.us.lver.check
...
for.cond2.preheader.us:                           ; preds = %for.cond2.for.end_crit_edge.us, %entry
  %indvars.iv14.us = phi i64 [ 0, %entry ], [ %indvars.iv.next11.us, %for.cond2.for.end_crit_edge.us ]
