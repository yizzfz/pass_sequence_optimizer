...
for.body8.us:                                     ; preds = %for.body8.us, %for.body3.us
  ...
  %sunkaddr34 = ptrtoint double* %q to i64
  %sunkaddr35 = mul i64 %indvars.iv1, 8
  %sunkaddr36 = add i64 %sunkaddr34, %sunkaddr35
  %sunkaddr37 = inttoptr i64 %sunkaddr36 to double*
  %3 = load double, double* %sunkaddr37, align 8
  ...
  %sunkaddr38 = ptrtoint double* %q to i64
  %sunkaddr39 = mul i64 %indvars.iv1, 8
  %sunkaddr40 = add i64 %sunkaddr38, %sunkaddr39
  %sunkaddr41 = inttoptr i64 %sunkaddr40 to double*
  store double %add28.us, double* %sunkaddr41, align 8
