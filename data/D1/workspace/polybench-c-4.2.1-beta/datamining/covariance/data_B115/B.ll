...
.lr.ph28.split.us:                                ; preds = %._crit_edge25.us, %.lr.ph28.split.us.preheader
  ...
  %sunkaddr105 = shl i64 %indvars.iv72, 3
  %sunkaddr106 = add i64 %4, %sunkaddr105
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph28.split.us
  ...
  store double %15, double* %sunkaddr107, align 8
  ...
  store double %18, double* %sunkaddr107, align 8
  ...
  store double %21, double* %sunkaddr107, align 8
...
._crit_edge25.us:                                 ; preds = %._crit_edge
  %22 = fdiv double %21, %0
  %sunkaddr26 = shl i64 %indvars.iv72, 3
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  br i1 %39, label %._crit_edge17.us.loopexit29, label %vector.body, !llvm.loop !6
...
._crit_edge17.us.loopexit29:                      ; preds = %vector.body
  br label %._crit_edge17.us

._crit_edge17.us:                                 ; preds = %._crit_edge17.us.loopexit29, %._crit_edge17.us.loopexit
...
._crit_edge23:                                    ; preds = %._crit_edge23, %.lr.ph.us.us
  ...
  br i1 %exitcond82.1, label %._crit_edge.us.us, label %._crit_edge23
