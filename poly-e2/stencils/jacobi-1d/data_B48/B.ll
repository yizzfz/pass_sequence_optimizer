...
for.cond1.preheader:                              ; preds = %for.inc33, %for.cond1.preheader.lr.ph
  ...
  br i1 %1, label %for.inc.lr.ph, label %for.inc33

for.inc.lr.ph:                                    ; preds = %for.cond1.preheader
  br i1 %min.iters.check30, label %for.inc.preheader, label %min.iters.checked31

for.inc.preheader:                                ; preds = %middle.block28, %vector.memcheck47, %min.iters.checked31, %for.inc.lr.ph
  %indvars.iv7.ph = phi i64 [ 1, %vector.memcheck47 ], [ 1, %min.iters.checked31 ], [ 1, %for.inc.lr.ph ], [ %ind.end, %middle.block28 ]
...
for.inc.prol.loopexit.unr-lcssa:                  ; preds = %for.inc.preheader, %for.inc.prol.preheader
  %indvars.iv7.unr.ph = phi i64 [ %add7.prol, %for.inc.prol.preheader ], [ %indvars.iv7.ph, %for.inc.preheader ]
...
min.iters.checked31:                              ; preds = %for.inc.lr.ph
  br i1 %cmp.zero, label %for.inc.preheader, label %vector.memcheck47

vector.memcheck47:                                ; preds = %min.iters.checked31
  br i1 %found.conflict45, label %for.inc.preheader, label %vector.body27.preheader
...
for.inc30.lr.ph:                                  ; preds = %for.cond13.preheader
  br i1 %min.iters.check30, label %for.inc30.preheader, label %min.iters.checked

for.inc30.preheader:                              ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.inc30.lr.ph
  %indvars.iv49.ph = phi i64 [ 1, %vector.memcheck ], [ 1, %min.iters.checked ], [ 1, %for.inc30.lr.ph ], [ %ind.end, %middle.block ]
...
for.inc30.prol.loopexit.unr-lcssa:                ; preds = %for.inc30.preheader, %for.inc30.prol.preheader
  %indvars.iv49.unr.ph = phi i64 [ %add23.prol, %for.inc30.prol.preheader ], [ %indvars.iv49.ph, %for.inc30.preheader ]
  %36 = icmp eq i64 %2, %indvars.iv49.ph
  br i1 %36, label %for.inc33.loopexit, label %for.inc30.preheader.new
...
for.inc:                                          ; preds = %for.inc, %for.inc.preheader.new
  %indvars.iv7 = phi i64 [ %indvars.iv7.unr.ph, %for.inc.preheader.new ], [ %add7.1, %for.inc ]
...
for.inc30:                                        ; preds = %for.inc30, %for.inc30.preheader.new
  %indvars.iv49 = phi i64 [ %indvars.iv49.unr.ph, %for.inc30.preheader.new ], [ %add23.1, %for.inc30 ]
  ...
  br i1 %exitcond13.1, label %for.inc33.loopexit.unr-lcssa, label %for.inc30, !llvm.loop !16
