...
.preheader1.lr.ph:
  br label %.lr.ph5.split.us.preheader

.lr.ph5.split.us.preheader:                       ; preds = %.preheader1.lr.ph, %._crit_edge13
  %4 = phi i32 [ 1, %.preheader1.lr.ph ], [ %153, %._crit_edge13 ]
  br label %.lver.check

.lver.check:                                      ; preds = %._crit_edge4.us, %.lr.ph5.split.us.preheader
  %indvar = phi i64 [ 0, %.lr.ph5.split.us.preheader ], [ %5, %._crit_edge4.us ]
  %indvars.iv18 = phi i64 [ 1, %.lr.ph5.split.us.preheader ], [ %13, %._crit_edge4.us ]
  %5 = add i64 %indvar, 1
...
.ph.lver.orig:                                    ; preds = %.ph.lver.orig.preheader, %.ph.lver.orig
  ...
  br i1 %exitcond.lver.orig, label %.lr.ph3.us.preheader.loopexit, label %.ph.lver.orig
...
.lver.check28.preheader:                          ; preds = %._crit_edge4.us
  br label %.lver.check28

.lr.ph3.us:                                       ; preds = %.lr.ph3.us, %.lr.ph3.us.preheader
  %37 = phi double [ 1.000000e+00, %.lr.ph3.us.preheader ], [ %50, %.lr.ph3.us ]
  %indvars.iv16 = phi i64 [ 998, %.lr.ph3.us.preheader ], [ %indvars.iv.next17.1, %.lr.ph3.us ]
...
; <label>:53:                                     ; preds = %53, %.ph
  %store_forwarded13 = phi double [ %load_initial12, %.ph ], [ %70, %53 ]
  ...
  %55 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv, i64 %12
  %56 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv, i64 %13
  ...
  %68 = fmul double %store_forwarded13, 0xC09F400000000001
  ...
  br i1 %exitcond, label %.lr.ph3.us.preheader.loopexit37, label %53

.lr.ph3.us.preheader.loopexit:                    ; preds = %.ph.lver.orig
  br label %.lr.ph3.us.preheader

.lr.ph3.us.preheader.loopexit37:                  ; preds = %53
  br label %.lr.ph3.us.preheader

.lr.ph3.us.preheader:                             ; preds = %.lr.ph3.us.preheader.loopexit37, %.lr.ph3.us.preheader.loopexit
...
.lver.check28:                                    ; preds = %.lver.check28.preheader, %._crit_edge11.us
  %indvar14 = phi i64 [ %73, %._crit_edge11.us ], [ 0, %.lver.check28.preheader ]
  %indvars.iv26 = phi i64 [ %82, %._crit_edge11.us ], [ 1, %.lver.check28.preheader ]
  ...
  %74 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv26, i64 0
  ...
  %76 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv26
  %77 = bitcast [1000 x double]* %76 to i64*
  %78 = load i64, i64* %77, align 8
  %79 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv26
  %80 = bitcast [1000 x double]* %79 to i64*
  store i64 %78, i64* %80, align 8
  %81 = add nsw i64 %indvars.iv26, -1
  %82 = add nuw nsw i64 %indvars.iv26, 1
...
.ph29.lver.orig:                                  ; preds = %.ph29.lver.orig.preheader, %.ph29.lver.orig
  %indvars.iv20.lver.orig = phi i64 [ %indvars.iv.next21.lver.orig, %.ph29.lver.orig ], [ 1, %.ph29.lver.orig.preheader ]
  ...
  %87 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %81, i64 %indvars.iv20.lver.orig
  ...
  %101 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %82, i64 %indvars.iv20.lver.orig
  ...
  br i1 %exitcond23.lver.orig, label %.lr.ph10.us.preheader.loopexit, label %.ph29.lver.orig
...
._crit_edge11.us:                                 ; preds = %.lr.ph10.us
  %exitcond2 = icmp eq i64 %82, 999
  br i1 %exitcond2, label %._crit_edge13, label %.lver.check28

.lr.ph10.us:                                      ; preds = %.lr.ph10.us, %.lr.ph10.us.preheader
  %111 = phi double [ 1.000000e+00, %.lr.ph10.us.preheader ], [ %124, %.lr.ph10.us ]
  %indvars.iv24 = phi i64 [ 998, %.lr.ph10.us.preheader ], [ %indvars.iv.next25.1, %.lr.ph10.us ]
...
; <label>:127:                                    ; preds = %127, %.ph29
  %store_forwarded35 = phi double [ %load_initial34, %.ph29 ], [ %149, %127 ]
  %store_forwarded32 = phi double [ %load_initial31, %.ph29 ], [ %136, %127 ]
  %indvars.iv20 = phi i64 [ 1, %.ph29 ], [ %indvars.iv.next21, %127 ]
  %128 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv26, i64 %indvars.iv20
  %129 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %81, i64 %indvars.iv20
  %130 = insertelement <2 x double> undef, double %store_forwarded32, i32 0
  ...
  %143 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %82, i64 %indvars.iv20
  %144 = load double, double* %143, align 8
  %145 = fmul double %144, 0xC09F400000000001
  %146 = fsub double %142, %145
  %147 = fmul double %store_forwarded35, 0xC08F400000000001
  ...
  br i1 %exitcond23, label %.lr.ph10.us.preheader.loopexit36, label %127

.lr.ph10.us.preheader.loopexit:                   ; preds = %.ph29.lver.orig
  br label %.lr.ph10.us.preheader

.lr.ph10.us.preheader.loopexit36:                 ; preds = %127
  br label %.lr.ph10.us.preheader

.lr.ph10.us.preheader:                            ; preds = %.lr.ph10.us.preheader.loopexit36, %.lr.ph10.us.preheader.loopexit
...
._crit_edge13:                                    ; preds = %._crit_edge11.us
  ...
  br i1 %152, label %.lr.ph5.split.us.preheader, label %._crit_edge14
