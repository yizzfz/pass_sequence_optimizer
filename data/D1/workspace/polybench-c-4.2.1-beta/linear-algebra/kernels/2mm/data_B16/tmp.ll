...
.preheader10:                                     ; preds = %._crit_edge27, %.preheader10.preheader
  %indvars.iv19 = phi i64 [ 0, %.preheader10.preheader ], [ %indvars.iv.next20, %._crit_edge27 ]
  br label %._crit_edge28

._crit_edge28:                                    ; preds = %._crit_edge28, %.preheader10
  %indvars.iv16 = phi i64 [ 0, %.preheader10 ], [ %indvars.iv.next17, %._crit_edge28 ]
  ...
  br i1 %exitcond18, label %._crit_edge27, label %._crit_edge28

._crit_edge27:                                    ; preds = %._crit_edge28
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  %exitcond21 = icmp eq i64 %indvars.iv.next20, 800
  br i1 %exitcond21, label %.preheader8.preheader, label %.preheader10

.preheader8.preheader:                            ; preds = %._crit_edge27
  br label %.preheader8

.preheader8:                                      ; preds = %.preheader8.preheader, %._crit_edge22
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %._crit_edge22 ], [ 0, %.preheader8.preheader ]
  br label %._crit_edge29

._crit_edge29:                                    ; preds = %._crit_edge29, %.preheader8
  %indvars.iv10 = phi i64 [ 0, %.preheader8 ], [ %indvars.iv.next11.1, %._crit_edge29 ]
  ...
  br i1 %exitcond12.1, label %._crit_edge22, label %._crit_edge29

._crit_edge22:                                    ; preds = %._crit_edge29
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 1100
  br i1 %exitcond15, label %.preheader6.preheader, label %.preheader8

.preheader6.preheader:                            ; preds = %._crit_edge22
  br label %.preheader6

.preheader6:                                      ; preds = %.preheader6.preheader, %._crit_edge17
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %._crit_edge17 ], [ 0, %.preheader6.preheader ]
  br label %._crit_edge30

._crit_edge30:                                    ; preds = %._crit_edge30, %.preheader6
  %indvars.iv4 = phi i64 [ 0, %.preheader6 ], [ %indvars.iv.next5, %._crit_edge30 ]
  ...
  br i1 %exitcond6, label %._crit_edge17, label %._crit_edge30

._crit_edge17:                                    ; preds = %._crit_edge30
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %exitcond9 = icmp eq i64 %indvars.iv.next8, 900
  br i1 %exitcond9, label %.preheader.preheader, label %.preheader6

.preheader.preheader:                             ; preds = %._crit_edge17
  br label %.preheader
...
._crit_edge:                                      ; preds = %._crit_edge31
  ...
  br i1 %exitcond3, label %._crit_edge14, label %.preheader
...
.preheader6:                                      ; preds = %._crit_edge19, %.preheader6.preheader
  %indvars.iv13 = phi i64 [ 0, %.preheader6.preheader ], [ %indvars.iv.next14, %._crit_edge19 ]
  br label %.lr.ph15

.lr.ph15:                                         ; preds = %._crit_edge16, %.preheader6
  %indvars.iv9 = phi i64 [ 0, %.preheader6 ], [ %indvars.iv.next10, %._crit_edge16 ]
  %7 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv13, i64 %indvars.iv9
  store double 0.000000e+00, double* %7, align 8
  br label %._crit_edge20

._crit_edge20:                                    ; preds = %._crit_edge20, %.lr.ph15
  %indvars.iv6 = phi i64 [ 0, %.lr.ph15 ], [ %indvars.iv.next7.1, %._crit_edge20 ]
  %8 = phi double [ 0.000000e+00, %.lr.ph15 ], [ %22, %._crit_edge20 ]
  ...
  br i1 %exitcond8.1, label %._crit_edge16, label %._crit_edge20

._crit_edge16:                                    ; preds = %._crit_edge20
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  %exitcond11 = icmp eq i64 %indvars.iv.next10, 900
  br i1 %exitcond11, label %._crit_edge19, label %.lr.ph15

._crit_edge19:                                    ; preds = %._crit_edge16
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 800
  br i1 %exitcond15, label %.preheader.preheader, label %.preheader6

.preheader.preheader:                             ; preds = %._crit_edge19
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge10
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %._crit_edge10 ], [ 0, %.preheader.preheader ]
  br label %.lr.ph
...
._crit_edge21:                                    ; preds = %._crit_edge21, %.lr.ph
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next.2, %._crit_edge21 ]
  %26 = phi double [ %25, %.lr.ph ], [ %44, %._crit_edge21 ]
...
._crit_edge8:                                     ; preds = %._crit_edge7, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %._crit_edge7 ]
  %6 = add nuw nsw i64 %indvars.iv, %5
  %7 = trunc i64 %6 to i32
  %8 = srem i32 %7, 20
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %10, label %._crit_edge7
...
._crit_edge7:                                     ; preds = %._crit_edge8, %10
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1200
  br i1 %exitcond, label %._crit_edge, label %._crit_edge8

._crit_edge:                                      ; preds = %._crit_edge7
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 800
  br i1 %exitcond3, label %._crit_edge5, label %.preheader
