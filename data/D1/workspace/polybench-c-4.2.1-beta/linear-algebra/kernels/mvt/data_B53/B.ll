...
.lr.ph:                                           ; preds = %._crit_edge8, %26
  %indvars.iv = phi i64 [ %indvars.iv.next, %26 ], [ 0, %._crit_edge8 ]
...
._crit_edge.loopexit:                             ; preds = %26
  %.pre = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %._crit_edge.critedge
  %31 = phi %struct._IO_FILE* [ %.pre, %._crit_edge.loopexit ], [ undef, %._crit_edge.critedge ]
