...
define i32 @main(i32, i8**) #0 {
  ...
  tail call void @init_array(i32 2800, [2800 x i32]* %9)
  tail call void (...) @polybench_timer_start() #4
  %10 = load i32, i32* %5, align 4
  %11 = bitcast i8* %7 to [2800 x i32]*
  tail call void @kernel_floyd_warshall(i32 %10, [2800 x i32]* %11)
...
; <label>:18:                                     ; preds = %14
  ...
  tail call void @print_array(i32 %19, [2800 x i32]* %21)
  br label %22
...
._crit_edge.us:                                   ; preds = %20
  ...
  %exitcond19 = icmp eq i64 %indvars.iv.next15, 2800
  br i1 %exitcond19, label %._crit_edge7.loopexit, label %.preheader.us
