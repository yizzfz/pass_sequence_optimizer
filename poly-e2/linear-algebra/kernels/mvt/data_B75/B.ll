...
for.body:                                         ; preds = %for.body25.for.cond.loopexit_crit_edge, %entry
  %indvars.iv6 = phi i64 [ 0, %entry ], [ %indvars.iv.next7, %for.body25.for.cond.loopexit_crit_edge ]
  ...
  %arrayidx7 = getelementptr inbounds double, double* %x2, i64 %indvars.iv6
  ...
  %arrayidx14 = getelementptr inbounds double, double* %y_1, i64 %indvars.iv6
  ...
  %arrayidx21 = getelementptr inbounds double, double* %y_2, i64 %indvars.iv6
...
for.body25:                                       ; preds = %for.body25, %for.body
  ...
  %arrayidx33 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv6, i64 %indvars.iv
  ...
  br i1 %exitcond.1, label %for.body25.for.cond.loopexit_crit_edge, label %for.body25

for.body25.for.cond.loopexit_crit_edge:           ; preds = %for.body25
  %13 = icmp eq i64 %indvars.iv.next7, 2000
  br i1 %13, label %for.end36, label %for.body

for.end36:                                        ; preds = %for.body25.for.cond.loopexit_crit_edge
  ret void
}
...
for.cond1.preheader:                              ; preds = %for.end, %entry
  %indvars.iv23 = phi i64 [ 0, %entry ], [ %indvars.iv.next24, %for.end ]
...
for.body3:                                        ; preds = %for.body3, %for.cond1.preheader
  %indvars.iv16 = phi i64 [ %indvars.iv.next17.1, %for.body3 ], [ 0, %for.cond1.preheader ]
  %0 = phi double [ %add.1, %for.body3 ], [ %.pre, %for.cond1.preheader ]
  %arrayidx7 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv23, i64 %indvars.iv16
  %1 = load double, double* %arrayidx7, align 8
  %arrayidx9 = getelementptr inbounds double, double* %y_1, i64 %indvars.iv16
  ...
  %arrayidx7.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv23, i64 %indvars.iv.next17
  %3 = load double, double* %arrayidx7.1, align 8
  %arrayidx9.1 = getelementptr inbounds double, double* %y_1, i64 %indvars.iv.next17
  ...
  br i1 %exitcond19.1, label %for.end, label %for.body3
...
for.cond18.preheader:                             ; preds = %for.cond18.preheader.preheader, %for.end35
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.end35 ], [ 0, %for.cond18.preheader.preheader ]
  %arrayidx22 = getelementptr inbounds double, double* %x2, i64 %indvars.iv13
  %.pre12 = load double, double* %arrayidx22, align 8
  %sunkaddr5 = mul i64 %indvars.iv13, 8
...
for.body20:                                       ; preds = %for.body20, %for.cond18.preheader
  ...
  %5 = phi double [ %add30.1, %for.body20 ], [ %.pre12, %for.cond18.preheader ]
  %arrayidx26 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv, i64 %indvars.iv13
  ...
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx26.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv.next, i64 %indvars.iv13
...
for.end35:                                        ; preds = %for.body20
  ...
  %exitcond27 = icmp eq i64 %indvars.iv.next14, 2000
  br i1 %exitcond27, label %for.end38, label %for.cond18.preheader
