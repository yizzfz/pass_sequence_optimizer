...
entry:
  ...
  call fastcc void @init_array(double* nonnull %alpha, double* nonnull %beta, [1200 x double]* %arraydecay12, [1000 x double]* %arraydecay313, [1200 x double]* %arraydecay414)
  call void (...) @polybench_timer_start() #3
  %0 = load double, double* %alpha, align 8
  %1 = load double, double* %beta, align 8
  call fastcc void @kernel_symm(double %0, double %1, [1200 x double]* %arraydecay12, [1000 x double]* %arraydecay313, [1200 x double]* %arraydecay414)
...
for.inc.us:                                       ; preds = %for.inc.us, %for.cond1.preheader.us
  ...
  %exitcond74 = icmp eq i64 %indvars.iv.next62, 1200
  br i1 %exitcond74, label %for.cond1.for.inc16_crit_edge.us, label %for.inc.us

for.cond1.for.inc16_crit_edge.us:                 ; preds = %for.inc.us
  %indvars.iv.next67 = add nuw nsw i64 %indvars.iv66, 1
  %exitcond75 = icmp eq i64 %indvars.iv.next67, 1000
...
for.inc36.lr.ph:                                  ; preds = %for.inc36.lr.ph.preheader, %for.inc51
  %indvars.iv81 = phi i3 [ %indvars.iv.next82, %for.inc51 ], [ -1, %for.inc36.lr.ph.preheader ]
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.inc51 ], [ 1, %for.inc36.lr.ph.preheader ]
  %indvars.iv57 = phi i64 [ %10, %for.inc51 ], [ 0, %for.inc36.lr.ph.preheader ]
  %6 = zext i3 %indvars.iv81 to i64
  %7 = add i64 %indvars.iv79, %6
  %8 = sub i64 1007, %indvars.iv57
  %9 = sub i64 998, %indvars.iv57
  %10 = add nuw nsw i64 %indvars.iv57, 1
...
for.inc36.prol.loopexit.unr-lcssa:                ; preds = %for.inc36.lr.ph, %for.inc36.prol.preheader
  ...
  %12 = icmp eq i64 %indvars.iv57, 0
  br i1 %12, label %for.cond40.preheader, label %for.inc36.preheader
...
for.inc48.prol:                                   ; preds = %for.inc48.prol.preheader, %for.inc48.prol
  %indvars.iv51.prol = phi i64 [ %indvars.iv.next52.prol, %for.inc48.prol ], [ %indvars.iv79, %for.inc48.prol.preheader ]
  %prol.iter = phi i64 [ %prol.iter.sub, %for.inc48.prol ], [ %xtraiter76, %for.inc48.prol.preheader ]
...
for.inc48.prol.loopexit:                          ; preds = %for.inc48.prol.loopexit.loopexit, %for.inc48.lr.ph
  %indvars.iv51.unr = phi i64 [ %indvars.iv79, %for.inc48.lr.ph ], [ %7, %for.inc48.prol.loopexit.loopexit ]
  %13 = icmp ult i64 %9, 7
  br i1 %13, label %for.inc51, label %for.inc48.prol.loopexit.for.inc48_crit_edge

for.inc48.prol.loopexit.for.inc48_crit_edge:      ; preds = %for.inc48.prol.loopexit
  %14 = sub i64 992, %indvars.iv51.unr
  %15 = lshr i64 %14, 3
...
for.inc48.preheader:                              ; preds = %middle.block, %min.iters.checked, %for.inc48.prol.loopexit.for.inc48_crit_edge
  %indvars.iv51.ph = phi i64 [ %indvars.iv51.unr, %min.iters.checked ], [ %indvars.iv51.unr, %for.inc48.prol.loopexit.for.inc48_crit_edge ], [ %ind.end, %middle.block ]
  br label %for.inc48

min.iters.checked:                                ; preds = %for.inc48.prol.loopexit.for.inc48_crit_edge
  %n.mod.vf = and i64 %16, 1
  %n.vec = sub nsw i64 %16, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  %17 = add i64 %indvars.iv51.unr, 8
  %18 = shl nuw i64 %15, 3
  %19 = add i64 %17, %18
  %20 = shl nuw nsw i64 %n.mod.vf, 3
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %21 = shl i64 %index, 3
  %22 = add i64 %indvars.iv51.unr, %21
  %23 = add nsw i64 %22, 7
  %24 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv57, i64 %23
  %25 = getelementptr double, double* %24, i64 -7
  %26 = bitcast double* %25 to <16 x double>*
  store <16 x double> <double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02>, <16 x double>* %26, align 8
...
for.inc36:                                        ; preds = %for.inc36.preheader, %for.inc36
  ...
  %28 = add nuw nsw i64 %indvars.iv, %indvars.iv57
  ...
  %30 = add nuw nsw i64 %indvars.iv.next, %indvars.iv57
  %31 = trunc i64 %30 to i32
  %rem28.1 = srem i32 %31, 100
  ...
  %32 = bitcast double* %arrayidx35 to <2 x double>*
  store <2 x double> %div31, <2 x double>* %32, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, %indvars.iv79
  br i1 %exitcond.1, label %for.cond40.preheader.loopexit, label %for.inc36

for.inc48:                                        ; preds = %for.inc48.preheader, %for.inc48
  %indvars.iv51 = phi i64 [ %indvars.iv.next52.7, %for.inc48 ], [ %indvars.iv51.ph, %for.inc48.preheader ]
  ...
  %exitcond72.7 = icmp eq i64 %indvars.iv.next52.7, 1000
  br i1 %exitcond72.7, label %for.inc51.loopexit, label %for.inc48, !llvm.loop !6
...
for.inc51:                                        ; preds = %for.inc51.loopexit, %middle.block, %for.inc48.prol.loopexit, %for.cond40.preheader
  ...
  %exitcond73 = icmp eq i64 %10, 1000
  %indvars.iv.next82 = add i3 %indvars.iv81, -1
  br i1 %exitcond73, label %for.end53, label %for.inc36.lr.ph
...
for.cond1.preheader:                              ; preds = %for.inc53, %entry
  %indvars.iv51 = phi i64 [ 0, %entry ], [ %indvars.iv.next52, %for.inc53 ]
...
vector.memcheck:                                  ; preds = %for.cond1.preheader
  ...
  %scevgep5 = getelementptr [1200 x double], [1200 x double]* %B, i64 %indvars.iv51, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %26, label %for.inc53.loopexit26, label %vector.body, !llvm.loop !16

for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.cond4.for.inc50_crit_edge.us
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.cond4.for.inc50_crit_edge.us ], [ 0, %for.cond4.preheader.us.preheader ]
  %arrayidx8.us = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv51, i64 %indvars.iv47
  br label %for.inc.us
...
for.inc.us:                                       ; preds = %for.inc.us, %for.cond4.preheader.us
  ...
  %arrayidx17.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv43, i64 %indvars.iv47
  ...
  %arrayidx21.us = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv43, i64 %indvars.iv47
  ...
  %exitcond46 = icmp eq i64 %indvars.iv.next44, %indvars.iv51
  br i1 %exitcond46, label %for.cond4.for.inc50_crit_edge.us, label %for.inc.us

for.cond4.for.inc50_crit_edge.us:                 ; preds = %for.inc.us
  %arrayidx31.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv51, i64 %indvars.iv47
  ...
  %exitcond = icmp eq i64 %indvars.iv.next48, 1200
  br i1 %exitcond, label %for.inc53.loopexit, label %for.cond4.preheader.us
...
for.cond4.preheader:                              ; preds = %for.cond4.preheader, %for.cond4.preheader.preheader
  ...
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %exitcond55.1 = icmp eq i64 %indvars.iv.next.1, 1200
  br i1 %exitcond55.1, label %for.inc53.loopexit25, label %for.cond4.preheader, !llvm.loop !17

for.inc53.loopexit:                               ; preds = %for.cond4.for.inc50_crit_edge.us
  br label %for.inc53

for.inc53.loopexit25:                             ; preds = %for.cond4.preheader
  br label %for.inc53
...
for.inc53:                                        ; preds = %for.inc53.loopexit26, %for.inc53.loopexit25, %for.inc53.loopexit
  %indvars.iv.next52 = add nuw nsw i64 %indvars.iv51, 1
  %exitcond56 = icmp eq i64 %indvars.iv.next52, 1000
