...
; <label>:6:                                      ; preds = %2
  ...
  %12 = tail call i8* %10(%struct.jpeg_common_struct* %11, i32 0, i64 56) #3
...
; <label>:13:                                     ; preds = %6, %2
  ...
  %sunkaddr5 = inttoptr i64 %sunkaddr4 to %struct.my_destination_mgr**
  %14 = load %struct.my_destination_mgr*, %struct.my_destination_mgr** %sunkaddr5, align 8
  ...
  store %struct._IO_FILE* %1, %struct._IO_FILE** %18, align 8
  ret void
}
...
; <label>:19:                                     ; preds = %1, %11
  ...
  %sunkaddr1 = add i64 %sunkaddr, 48
  %sunkaddr2 = inttoptr i64 %sunkaddr1 to i64*
  %20 = load i64, i64* %sunkaddr2, align 8
