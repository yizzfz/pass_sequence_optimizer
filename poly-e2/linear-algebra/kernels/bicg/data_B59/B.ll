...
for.body5.us:                                     ; preds = %for.body5.us.preheader, %for.end26.us
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.end26.us ], [ 0, %for.body5.us.preheader ]
...
for.body15.us:                                    ; preds = %for.body15.us, %for.body5.us
  ...
  br i1 %exitcond.1, label %for.end26.us, label %for.body15.us

for.end26.us:                                     ; preds = %for.body15.us
  %indvars.iv.next3 = add nuw nsw i64 %indvars.iv2, 1
  %exitcond = icmp eq i64 %indvars.iv.next3, 2100
  br i1 %exitcond, label %for.end29, label %for.body5.us

for.body:                                         ; preds = %for.body, %for.body.lr.ph
  %indvars.iv4 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next5.1.1, %for.body ]
  ...
  br i1 %exitcond6.1.1, label %for.body5.us.preheader, label %for.body

for.body5.us.preheader:                           ; preds = %for.body
  br label %for.body5.us

for.end29:                                        ; preds = %for.end26.us
  ret void
}
...
for.body3.us:                                     ; preds = %for.end33.us, %for.body3.us.preheader
  %indvars.iv1 = phi i64 [ 0, %for.body3.us.preheader ], [ %indvars.iv.next2, %for.end33.us ]
...
for.body8.us:                                     ; preds = %for.body8.us, %for.body3.us
  ...
  %sunkaddr23 = mul i64 %indvars.iv1, 8
  ...
  %sunkaddr27 = mul i64 %indvars.iv1, 8
  ...
  br i1 %exitcond, label %for.end33.us, label %for.body8.us

for.end33.us:                                     ; preds = %for.body8.us
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 2100
  br i1 %exitcond3, label %for.end36, label %for.body3.us

for.end36:                                        ; preds = %for.end33.us
  ret void
}
