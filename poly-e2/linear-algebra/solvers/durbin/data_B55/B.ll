...
for.inc.lr.ph:                                    ; preds = %entry, %for.inc47
  ...
  %indvar = phi i64 [ 0, %entry ], [ %9, %for.inc47 ]
...
for.inc32.prol:                                   ; preds = %for.inc32.lr.ph
  ...
  %28 = load double, double* %sunkaddr72, align 8
...
for.inc32.preheader:                              ; preds = %for.inc32.prol.loopexit
  %30 = sub i64 %6, %indvars.iv47.unr.ph
  %31 = lshr i64 %30, 1
  %32 = add nuw i64 %31, 1
...
min.iters.checked:                                ; preds = %for.inc32.preheader
  ...
  %33 = or i64 %indvars.iv47.unr.ph, 2
  %34 = shl nuw i64 %31, 1
  %35 = add i64 %33, %34
...
vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert79 = insertelement <2 x double> undef, double %div, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %37 = shl i64 %index, 1
  %offset.idx = or i64 %indvars.iv47.unr.ph, %37
  ...
  %strided.vec74 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  ...
  %wide.vec75 = load <4 x double>, <4 x double>* %43, align 8
  %strided.vec76 = shufflevector <4 x double> %wide.vec75, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %reverse = shufflevector <2 x double> %strided.vec76, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %strided.vec77 = shufflevector <4 x double> %wide.vec75, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %reverse78 = shufflevector <2 x double> %strided.vec77, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %44 = fmul <2 x double> %broadcast.splat80, %reverse78
  %45 = fadd <2 x double> %strided.vec, %44
  %46 = add nuw nsw i64 %offset.idx, 1
  %47 = fmul <2 x double> %broadcast.splat80, %reverse
  %48 = fadd <2 x double> %strided.vec74, %47
...
for.inc32:                                        ; preds = %for.inc32.preheader1, %for.inc32
  %indvars.iv47 = phi i64 [ %indvars.iv.next48.1, %for.inc32 ], [ %indvars.iv47.ph, %for.inc32.preheader1 ]
  ...
  %56 = sub nsw i64 %10, %indvars.iv.next48
