...
.lr.ph87:                                         ; preds = %._crit_edge89.thread, %.preheader72.lr.ph
  %indvars.iv130 = phi i64 [ 0, %.preheader72.lr.ph ], [ %indvars.iv.next131, %._crit_edge89.thread ]
...
.preheader71:                                     ; preds = %7
  ...
  br i1 %4, label %._crit_edge89.thread, label %.preheader70.us.preheader
...
; <label>:7:                                      ; preds = %7, %.lr.ph87
  %indvars.iv118 = phi i64 [ 0, %.lr.ph87 ], [ %indvars.iv.next119, %7 ]
...
._crit_edge84.us:                                 ; preds = %._crit_edge84.us, %.preheader70.us.preheader
  %indvars.iv116 = phi i64 [ 0, %.preheader70.us.preheader ], [ %indvars.iv.next117.7, %._crit_edge84.us ]
  ...
  %exitcond15.7 = icmp eq i64 %indvars.iv.next117.7, 2000
  br i1 %exitcond15.7, label %.preheader67.us.us.preheader.preheader, label %._crit_edge84.us

.preheader67.us.us.preheader.preheader:           ; preds = %._crit_edge84.us
...
._crit_edge80.us:                                 ; preds = %._crit_edge78.us.us
  ...
  %exitcond14 = icmp eq i64 %indvars.iv.next112, 2000
  br i1 %exitcond14, label %.preheader.us.preheader, label %.preheader67.us.us.preheader

.preheader.us.preheader:                          ; preds = %._crit_edge80.us
  %27 = bitcast i8* %16 to [2000 x [2000 x double]]*
  %28 = bitcast i8* %16 to [2000 x [2000 x double]]*
  %29 = bitcast i8* %16 to [2000 x [2000 x double]]*
...
.preheader67.us.us:                               ; preds = %._crit_edge78.us.us, %.preheader67.us.us.preheader
  ...
  %35 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv109, i64 %indvars.iv111
  br label %36

._crit_edge78.us.us:                              ; preds = %36
  %indvars.iv.next110 = add nuw nsw i64 %indvars.iv109, 1
  %exitcond13 = icmp eq i64 %indvars.iv.next110, 2000
  br i1 %exitcond13, label %._crit_edge80.us, label %.preheader67.us.us

; <label>:36:                                     ; preds = %36, %.preheader67.us.us
  %indvars.iv106 = phi i64 [ 0, %.preheader67.us.us ], [ %indvars.iv.next107.1, %36 ]
  %37 = load double, double* %35, align 8
  %38 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv106, i64 %indvars.iv111
  %39 = load double, double* %38, align 8
  %40 = fmul double %37, %39
  %41 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %25, i64 0, i64 %indvars.iv109, i64 %indvars.iv106
  ...
  %45 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv.next107, i64 %indvars.iv111
  %46 = load double, double* %45, align 8
  %47 = fmul double %44, %46
  %48 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv109, i64 %indvars.iv.next107
  ...
  br i1 %exitcond108.1, label %._crit_edge78.us.us, label %36

.preheader.us:                                    ; preds = %._crit_edge.us, %.preheader.us.preheader
  %indvars.iv104 = phi i64 [ %indvars.iv.next105, %._crit_edge.us ], [ 0, %.preheader.us.preheader ]
  %scevgep1 = getelementptr [2000 x double], [2000 x double]* %0, i64 %indvars.iv104, i64 0
  %51 = add nuw nsw i64 %indvars.iv104, 1
  %scevgep3 = getelementptr [2000 x double], [2000 x double]* %0, i64 %51, i64 0
  %scevgep5 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %27, i64 0, i64 %indvars.iv104, i64 0
  %scevgep7 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %27, i64 0, i64 %51, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %52 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %33, i64 0, i64 %indvars.iv104, i64 %index
  %53 = bitcast double* %52 to <2 x i64>*
  %wide.load = load <2 x i64>, <2 x i64>* %53, align 8, !alias.scope !1
  %54 = getelementptr double, double* %52, i64 2
  %55 = bitcast double* %54 to <2 x i64>*
  %wide.load10 = load <2 x i64>, <2 x i64>* %55, align 8, !alias.scope !1
  %56 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv104, i64 %index
  %57 = bitcast double* %56 to <2 x i64>*
  store <2 x i64> %wide.load, <2 x i64>* %57, align 8, !alias.scope !4, !noalias !1
  %58 = getelementptr double, double* %56, i64 2
  %59 = bitcast double* %58 to <2 x i64>*
  store <2 x i64> %wide.load10, <2 x i64>* %59, align 8, !alias.scope !4, !noalias !1
  %index.next = or i64 %index, 4
  %60 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %34, i64 0, i64 %indvars.iv104, i64 %index.next
  %61 = bitcast double* %60 to <2 x i64>*
  %wide.load.1 = load <2 x i64>, <2 x i64>* %61, align 8, !alias.scope !1
  %62 = getelementptr double, double* %60, i64 2
  %63 = bitcast double* %62 to <2 x i64>*
  %wide.load10.1 = load <2 x i64>, <2 x i64>* %63, align 8, !alias.scope !1
  %64 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv104, i64 %index.next
  %65 = bitcast double* %64 to <2 x i64>*
  store <2 x i64> %wide.load.1, <2 x i64>* %65, align 8, !alias.scope !4, !noalias !1
  %66 = getelementptr double, double* %64, i64 2
  %67 = bitcast double* %66 to <2 x i64>*
  store <2 x i64> %wide.load10.1, <2 x i64>* %67, align 8, !alias.scope !4, !noalias !1
  %index.next.1 = add nsw i64 %index, 8
  %68 = icmp eq i64 %index.next.1, 2000
  br i1 %68, label %._crit_edge.us.loopexit16, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader
  %indvars.iv = phi i64 [ 0, %scalar.ph.preheader ], [ %indvars.iv.next.4, %scalar.ph ]
  %69 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %28, i64 0, i64 %indvars.iv104, i64 %indvars.iv
  %70 = bitcast double* %69 to i64*
  %71 = load i64, i64* %70, align 8
  %72 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv104, i64 %indvars.iv
  %73 = bitcast double* %72 to i64*
  store i64 %71, i64* %73, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %74 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %29, i64 0, i64 %indvars.iv104, i64 %indvars.iv.next
  %75 = bitcast double* %74 to i64*
  %76 = load i64, i64* %75, align 8
  %77 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv104, i64 %indvars.iv.next
  %78 = bitcast double* %77 to i64*
  store i64 %76, i64* %78, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %79 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %30, i64 0, i64 %indvars.iv104, i64 %indvars.iv.next.1
  %80 = bitcast double* %79 to i64*
  %81 = load i64, i64* %80, align 8
  %82 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv104, i64 %indvars.iv.next.1
  %83 = bitcast double* %82 to i64*
  store i64 %81, i64* %83, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %84 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %31, i64 0, i64 %indvars.iv104, i64 %indvars.iv.next.2
  %85 = bitcast double* %84 to i64*
  %86 = load i64, i64* %85, align 8
  %87 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv104, i64 %indvars.iv.next.2
  %88 = bitcast double* %87 to i64*
  store i64 %86, i64* %88, align 8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %89 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %32, i64 0, i64 %indvars.iv104, i64 %indvars.iv.next.3
  %90 = bitcast double* %89 to i64*
  %91 = load i64, i64* %90, align 8
  %92 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv104, i64 %indvars.iv.next.3
  %93 = bitcast double* %92 to i64*
  store i64 %91, i64* %93, align 8
  %indvars.iv.next.4 = add nsw i64 %indvars.iv, 5
  %exitcond.4 = icmp eq i64 %indvars.iv.next.3, 1999
  br i1 %exitcond.4, label %._crit_edge.us.loopexit, label %scalar.ph, !llvm.loop !9

._crit_edge.us.loopexit:                          ; preds = %scalar.ph
  br label %._crit_edge.us

._crit_edge.us.loopexit16:                        ; preds = %vector.body
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit16, %._crit_edge.us.loopexit
  %indvars.iv.next105 = add nuw nsw i64 %indvars.iv104, 1
  %exitcond12 = icmp eq i64 %indvars.iv.next105, 2000
  br i1 %exitcond12, label %._crit_edge75, label %.preheader.us
...
.preheader43:                                     ; preds = %._crit_edge50, %.preheader43.preheader
  ...
  %indvars.iv66 = phi i32 [ %indvars.iv.next67, %._crit_edge50 ], [ -1, %.preheader43.preheader ]
...
.preheader.us:                                    ; preds = %._crit_edge48.us, %.preheader.us.preheader
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %._crit_edge48.us ], [ %indvars.iv1, %.preheader.us.preheader ]
  %8 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv1, i64 %indvars.iv72
...
; <label>:9:                                      ; preds = %.prol.preheader6
  ...
  %11 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 0, i64 %indvars.iv72
...
.prol.loopexit7.unr-lcssa:                        ; preds = %.preheader.us, %9
  %indvars.iv64.unr.ph = phi i64 [ 1, %9 ], [ 0, %.preheader.us ]
  %.unr10.ph = phi double [ %14, %9 ], [ %.pre58, %.preheader.us ]
...
; <label>:15:                                     ; preds = %15, %.preheader.us.new
  %indvars.iv64 = phi i64 [ %indvars.iv64.unr.ph, %.preheader.us.new ], [ %indvars.iv.next65.1, %15 ]
  %16 = phi double [ %.unr10.ph, %.preheader.us.new ], [ %28, %15 ]
  %17 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv1, i64 %indvars.iv64
  %18 = load double, double* %17, align 8
  %19 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv64, i64 %indvars.iv72
  %20 = load double, double* %19, align 8
  %21 = fmul double %18, %20
  %22 = fsub double %16, %21
  store double %22, double* %8, align 8
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1
  %23 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv1, i64 %indvars.iv.next65
  %24 = load double, double* %23, align 8
  %25 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv.next65, i64 %indvars.iv72
  %26 = load double, double* %25, align 8
  %27 = fmul double %24, %26
  %28 = fsub double %22, %27
  store double %28, double* %8, align 8
  %indvars.iv.next65.1 = add nsw i64 %indvars.iv64, 2
  %exitcond69.1 = icmp eq i64 %indvars.iv.next65, %wide.trip.count68
  br i1 %exitcond69.1, label %._crit_edge48.us.unr-lcssa, label %15
...
._crit_edge48.us:                                 ; preds = %.prol.loopexit7, %._crit_edge48.us.unr-lcssa
  ...
  %exitcond4 = icmp eq i64 %indvars.iv.next73, 2000
...
.preheader41:                                     ; preds = %._crit_edge, %.preheader41.preheader
  ...
  %indvars.iv59 = phi i32 [ %indvars.iv.next60, %._crit_edge ], [ -1, %.preheader41.preheader ]
  %29 = add i64 %indvars.iv61, 4294967295
  %30 = and i64 %29, 4294967295
  %31 = icmp sgt i64 %indvars.iv61, 0
  %32 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv1, i64 %indvars.iv61
...
; <label>:34:                                     ; preds = %.prol.preheader
  ...
  %36 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 0, i64 %indvars.iv61
...
; <label>:41:                                     ; preds = %41, %.lr.ph.new
  ...
  %45 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv, i64 %indvars.iv61
  %46 = load double, double* %45, align 8
  %47 = fmul double %44, %46
  ...
  %51 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv.next, i64 %indvars.iv61
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader41
  ...
  %56 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv61, i64 %indvars.iv61
  %57 = load double, double* %56, align 8
  %58 = fdiv double %55, %57
  store double %58, double* %32, align 8
  %indvars.iv.next62 = add nuw nsw i64 %indvars.iv61, 1
  %indvars.iv.next60 = add nsw i32 %indvars.iv59, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next62, %indvars.iv1
...
._crit_edge50:                                    ; preds = %._crit_edge50.loopexit, %.preheader43
  ...
  br i1 %exitcond5, label %._crit_edge52, label %.preheader43
