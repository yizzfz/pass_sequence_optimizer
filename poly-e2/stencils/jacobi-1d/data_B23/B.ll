...
entry:
  ...
  br i1 %cmp1, label %for.inc.preheader, label %entry.for.end_crit_edge
...
for.inc.prol.loopexit:                            ; preds = %for.inc.preheader.for.inc.prol.loopexit_crit_edge, %for.inc.prol.preheader
  %indvars.iv2.unr = phi i64 [ 0, %for.inc.preheader.for.inc.prol.loopexit_crit_edge ], [ 1, %for.inc.prol.preheader ]
  %2 = icmp eq i32 %n, 1
  br i1 %2, label %for.inc.prol.loopexit.for.end.loopexit_crit_edge, label %for.inc.preheader.new
...
for.inc:                                          ; preds = %for.inc.for.inc_crit_edge, %for.inc.preheader.new
  %indvars.iv2 = phi i64 [ %indvars.iv2.unr, %for.inc.preheader.new ], [ %indvars.iv.next.1, %for.inc.for.inc_crit_edge ]
...
entry:
  ...
  br i1 %cmp12, label %for.cond1.preheader.lr.ph, label %entry.for.end35_crit_edge
...
for.cond1.preheader:                              ; preds = %for.inc33.for.cond1.preheader_crit_edge, %for.cond1.preheader.lr.ph
  %storemerge13 = phi i32 [ 0, %for.cond1.preheader.lr.ph ], [ %inc34, %for.inc33.for.cond1.preheader_crit_edge ]
  br i1 %cmp28, label %for.inc.lr.ph, label %for.cond1.preheader.for.inc33_crit_edge

for.cond1.preheader.for.inc33_crit_edge:          ; preds = %for.cond1.preheader
  br label %for.inc33

for.inc.lr.ph:                                    ; preds = %for.cond1.preheader
  br i1 %min.iters.check29, label %for.inc.lr.ph.for.inc.preheader_crit_edge, label %min.iters.checked30

for.inc.lr.ph.for.inc.preheader_crit_edge:        ; preds = %for.inc.lr.ph
  br label %for.inc.preheader

for.inc.preheader:                                ; preds = %middle.block27.for.inc.preheader_crit_edge, %vector.memcheck46.for.inc.preheader_crit_edge, %min.iters.checked30.for.inc.preheader_crit_edge, %for.inc.lr.ph.for.inc.preheader_crit_edge
  %indvars.iv9.ph = phi i64 [ 1, %vector.memcheck46.for.inc.preheader_crit_edge ], [ 1, %min.iters.checked30.for.inc.preheader_crit_edge ], [ 1, %for.inc.lr.ph.for.inc.preheader_crit_edge ], [ %ind.end, %middle.block27.for.inc.preheader_crit_edge ]
  br label %for.inc

min.iters.checked30:                              ; preds = %for.inc.lr.ph
  br i1 %cmp.zero, label %min.iters.checked30.for.inc.preheader_crit_edge, label %vector.memcheck46

min.iters.checked30.for.inc.preheader_crit_edge:  ; preds = %min.iters.checked30
  br label %for.inc.preheader

vector.memcheck46:                                ; preds = %min.iters.checked30
  br i1 %found.conflict44, label %vector.memcheck46.for.inc.preheader_crit_edge, label %vector.body26.preheader

vector.memcheck46.for.inc.preheader_crit_edge:    ; preds = %vector.memcheck46
  br label %for.inc.preheader

vector.body26.preheader:                          ; preds = %vector.memcheck46
  br label %vector.body26

vector.body26:                                    ; preds = %vector.body26.vector.body26_crit_edge, %vector.body26.preheader
  %index48 = phi i64 [ %index.next49, %vector.body26.vector.body26_crit_edge ], [ 0, %vector.body26.preheader ]
  ...
  br i1 %25, label %middle.block27, label %vector.body26.vector.body26_crit_edge, !llvm.loop !6

vector.body26.vector.body26_crit_edge:            ; preds = %vector.body26
  br label %vector.body26

middle.block27:                                   ; preds = %vector.body26
  br i1 %cmp.n, label %middle.block27.for.cond13.preheader_crit_edge, label %middle.block27.for.inc.preheader_crit_edge

middle.block27.for.inc.preheader_crit_edge:       ; preds = %middle.block27
  br label %for.inc.preheader

middle.block27.for.cond13.preheader_crit_edge:    ; preds = %middle.block27
  br label %for.cond13.preheader

for.cond13.preheader.loopexit:                    ; preds = %for.inc
  br label %for.cond13.preheader

for.cond13.preheader:                             ; preds = %middle.block27.for.cond13.preheader_crit_edge, %for.cond13.preheader.loopexit
...
for.inc30.lr.ph:                                  ; preds = %for.cond13.preheader
  br i1 %min.iters.check29, label %for.inc30.lr.ph.for.inc30.preheader_crit_edge, label %min.iters.checked

for.inc30.lr.ph.for.inc30.preheader_crit_edge:    ; preds = %for.inc30.lr.ph
  br label %for.inc30.preheader

for.inc30.preheader:                              ; preds = %middle.block.for.inc30.preheader_crit_edge, %vector.memcheck.for.inc30.preheader_crit_edge, %min.iters.checked.for.inc30.preheader_crit_edge, %for.inc30.lr.ph.for.inc30.preheader_crit_edge
  %indvars.iv511.ph = phi i64 [ 1, %vector.memcheck.for.inc30.preheader_crit_edge ], [ 1, %min.iters.checked.for.inc30.preheader_crit_edge ], [ 1, %for.inc30.lr.ph.for.inc30.preheader_crit_edge ], [ %ind.end, %middle.block.for.inc30.preheader_crit_edge ]
  br label %for.inc30

min.iters.checked:                                ; preds = %for.inc30.lr.ph
  br i1 %cmp.zero, label %min.iters.checked.for.inc30.preheader_crit_edge, label %vector.memcheck

min.iters.checked.for.inc30.preheader_crit_edge:  ; preds = %min.iters.checked
  br label %for.inc30.preheader

vector.memcheck:                                  ; preds = %min.iters.checked
  br i1 %found.conflict, label %vector.memcheck.for.inc30.preheader_crit_edge, label %vector.body.preheader

vector.memcheck.for.inc30.preheader_crit_edge:    ; preds = %vector.memcheck
  br label %for.inc30.preheader
...
middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %middle.block.for.inc33_crit_edge, label %middle.block.for.inc30.preheader_crit_edge

middle.block.for.inc30.preheader_crit_edge:       ; preds = %middle.block
  br label %for.inc30.preheader
...
for.inc:                                          ; preds = %for.inc.for.inc_crit_edge, %for.inc.preheader
  %indvars.iv9 = phi i64 [ %indvars.iv.next, %for.inc.for.inc_crit_edge ], [ %indvars.iv9.ph, %for.inc.preheader ]
  ...
  br i1 %cmp2, label %for.inc.for.inc_crit_edge, label %for.cond13.preheader.loopexit, !llvm.loop !15

for.inc.for.inc_crit_edge:                        ; preds = %for.inc
  br label %for.inc

for.inc30:                                        ; preds = %for.inc30.for.inc30_crit_edge, %for.inc30.preheader
  %indvars.iv511 = phi i64 [ %indvars.iv.next6, %for.inc30.for.inc30_crit_edge ], [ %indvars.iv511.ph, %for.inc30.preheader ]
  ...
  br i1 %cmp15, label %for.inc30.for.inc30_crit_edge, label %for.inc33.loopexit, !llvm.loop !16
...
for.inc33:                                        ; preds = %middle.block.for.inc33_crit_edge, %for.cond13.preheader.for.inc33_crit_edge, %for.cond1.preheader.for.inc33_crit_edge, %for.inc33.loopexit
  ...
  br i1 %cmp, label %for.inc33.for.cond1.preheader_crit_edge, label %for.end35.loopexit
...
for.body:                                         ; preds = %for.inc.for.body_crit_edge, %for.body.preheader
  %indvars.iv2 = phi i64 [ %indvars.iv.next, %for.inc.for.body_crit_edge ], [ 0, %for.body.preheader ]
