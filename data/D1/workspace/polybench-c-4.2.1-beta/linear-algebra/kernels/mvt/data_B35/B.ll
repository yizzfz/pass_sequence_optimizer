...
..loopexit_crit_edge.us:                          ; preds = %.prol.loopexit...loopexit_crit_edge.us_crit_edge, %..loopexit_crit_edge.us.loopexit
  br i1 %9, label %._crit_edge.loopexit, label %..loopexit_crit_edge.us..lr.ph.us_crit_edge
...
.preheader4.us.new:                               ; preds = %.preheader4.us.new..preheader4.us.new_crit_edge, %.preheader4.us.new.preheader
  %7 = phi double [ %19, %.preheader4.us.new..preheader4.us.new_crit_edge ], [ %.pre, %.preheader4.us.new.preheader ]
...
.preheader.us.new:                                ; preds = %.preheader.us.new..preheader.us.new_crit_edge, %.preheader.us.new.preheader
  %21 = phi double [ %33, %.preheader.us.new..preheader.us.new_crit_edge ], [ %.pre27, %.preheader.us.new.preheader ]
...
; <label>:12:                                     ; preds = %.lr.ph7._crit_edge, %10
...
; <label>:26:                                     ; preds = %.lr.ph._crit_edge, %24
