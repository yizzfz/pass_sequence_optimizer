...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph51.split.us
  ...
  %4 = mul nuw nsw i64 %indvars.iv84, %indvars.iv88
  %5 = add nuw nsw i64 %4, 1
  %6 = trunc i64 %5 to i32
  %7 = srem i32 %6, 800
  %8 = sitofp i32 %7 to double
  %9 = fdiv double %8, 4.000000e+03
  %10 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv88, i64 %indvars.iv84
...
._crit_edge93:                                    ; preds = %._crit_edge93, %.lr.ph38.split.us
  ...
  %11 = mul nuw nsw i64 %indvars.iv.next76, %indvars.iv79
  %12 = add nuw nsw i64 %11, 2
  %13 = trunc i64 %12 to i32
  %14 = srem i32 %13, 900
  %15 = sitofp i32 %14 to double
  %16 = fdiv double %15, 4.500000e+03
  %17 = getelementptr inbounds [900 x double], [900 x double]* %1, i64 %indvars.iv79, i64 %indvars.iv75
...
._crit_edge94:                                    ; preds = %._crit_edge94, %.lr.ph25.split.us
  ...
  %18 = add nuw nsw i64 %indvars.iv66, 3
  %19 = mul nuw nsw i64 %18, %indvars.iv70
  %20 = trunc i64 %19 to i32
  %21 = srem i32 %20, 1100
  %22 = sitofp i32 %21 to double
  %23 = fdiv double %22, 5.500000e+03
  %24 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv70, i64 %indvars.iv66
...
._crit_edge95:                                    ; preds = %._crit_edge95, %.lr.ph13.split.us
  ...
  %26 = mul nuw nsw i64 %25, %indvars.iv61
  %27 = add nuw nsw i64 %26, 2
  %28 = trunc i64 %27 to i32
  %29 = srem i32 %28, 1000
  %30 = sitofp i32 %29 to double
  %31 = fdiv double %30, 5.000000e+03
  %32 = getelementptr inbounds [1100 x double], [1100 x double]* %3, i64 %indvars.iv61, i64 %indvars.iv
