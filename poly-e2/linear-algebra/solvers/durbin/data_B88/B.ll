...
for.inc.lr.ph:                                    ; preds = %for.inc47, %entry
  %indvars.iv69 = phi i64 [ %indvars.iv.next70, %for.inc47 ], [ 1, %entry ]
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.inc47 ], [ 0, %entry ]
  %beta.049 = phi double [ %mul5, %for.inc47 ], [ 1.000000e+00, %entry ]
  %alpha.048 = phi double [ %div, %for.inc47 ], [ %sub3, %entry ]
  %4 = add i64 %indvars.iv67, 1
  %5 = add i64 %indvars.iv67, 1
  %mul = fmul double %alpha.048, %alpha.048
  %sub9 = add nsw i64 %indvars.iv69, -1
...
for.inc.prol:                                     ; preds = %for.inc.prol, %for.inc.prol.preheader
  ...
  %sum.041.prol = phi double [ 0.000000e+00, %for.inc.prol.preheader ], [ %add.prol, %for.inc.prol ]
  ...
  %add.prol = fadd double %sum.041.prol, %mul14.prol
...
for.inc.prol.loopexit:                            ; preds = %for.inc.lr.ph, %for.inc.prol.loopexit.unr-lcssa
  ...
  %sum.041.unr = phi double [ 0.000000e+00, %for.inc.lr.ph ], [ %add.prol, %for.inc.prol.loopexit.unr-lcssa ]
...
for.inc:                                          ; preds = %for.inc, %for.inc.lr.ph.new
  ...
  %sum.041 = phi double [ %sum.041.unr, %for.inc.lr.ph.new ], [ %add.3, %for.inc ]
  ...
  %12 = load double, double* %arrayidx13.1, align 8
  %mul14.1 = fmul double %11, %12
  ...
  %13 = load double, double* %arrayidx11.2, align 8
  %arrayidx13.2 = getelementptr inbounds double, double* %y, i64 %indvars.iv.next.1
  %14 = load double, double* %arrayidx13.2, align 8
  %mul14.2 = fmul double %13, %14
  ...
  %15 = load double, double* %arrayidx11.3, align 8
  %arrayidx13.3 = getelementptr inbounds double, double* %y, i64 %indvars.iv.next.2
  %16 = load double, double* %arrayidx13.3, align 8
  %mul14.3 = fmul double %15, %16
  %add.3 = fadd double %add.2, %mul14.3
  %exitcond.3 = icmp eq i64 %indvars.iv.next.2, %indvars.iv67
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
...
for.inc32.lr.ph:                                  ; preds = %for.inc.prol.loopexit, %for.inc32.lr.ph.unr-lcssa
  ...
  %mul5 = fmul double %beta.049, %sub4
  %arrayidx16 = getelementptr inbounds double, double* %r, i64 %indvars.iv69
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load5 = load <2 x double>, <2 x double>* %28, align 8
  %reverse6 = shufflevector <2 x double> %wide.load5, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %29 = fmul <2 x double> %broadcast.splat8, %reverse
  %30 = fmul <2 x double> %broadcast.splat8, %reverse6
  %31 = fadd <2 x double> %wide.load, %29
  %32 = fadd <2 x double> %wide.load3, %30
...
for.inc32.preheader:                              ; preds = %middle.block, %min.iters.checked, %for.inc32.lr.ph
  %indvars.iv53.ph = phi i64 [ 0, %min.iters.checked ], [ 0, %for.inc32.lr.ph ], [ %n.vec, %middle.block ]
  br label %for.inc32

for.inc32:                                        ; preds = %for.inc32.preheader, %for.inc32
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc32 ], [ %indvars.iv53.ph, %for.inc32.preheader ]
  %arrayidx23 = getelementptr inbounds double, double* %y, i64 %indvars.iv53
  %38 = load double, double* %arrayidx23, align 8
  %sub25 = sub nsw i64 %sub9, %indvars.iv53
  ...
  %arrayidx31 = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %indvars.iv53
  store double %add29, double* %arrayidx31, align 8
  %exitcond58 = icmp eq i64 %indvars.iv53, %indvars.iv67
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  br i1 %exitcond58, label %for.inc47.loopexit, label %for.inc32, !llvm.loop !6

for.inc47.loopexit:                               ; preds = %for.inc32
  br label %for.inc47

for.inc47:                                        ; preds = %for.inc47.loopexit, %middle.block
  %40 = shl i64 %indvars.iv67, 3
  %41 = add nuw nsw i64 %40, 8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* nonnull %3, i64 %41, i32 8, i1 false)
  %arrayidx46 = getelementptr inbounds double, double* %y, i64 %indvars.iv69
  store double %div, double* %arrayidx46, align 8
  %indvars.iv.next70 = add nuw nsw i64 %indvars.iv69, 1
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  %exitcond1 = icmp eq i64 %indvars.iv.next68, 1999
