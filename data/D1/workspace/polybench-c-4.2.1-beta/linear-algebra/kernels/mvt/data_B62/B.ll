...
define internal fastcc void @init_array(i32, double* nocapture, double* nocapture, double* nocapture, double* nocapture, [2000 x double]* nocapture) unnamed_addr #2 {
  br i1 true, label %.lr.ph35, label %._crit_edge

.lr.ph35:                                         ; preds = %6
  %7 = fdiv double 0.000000e+00, 2.000000e+03
  br label %.lr.ph.us

.lr.ph.us:                                        ; preds = %..loopexit_crit_edge.us, %.lr.ph35
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %..loopexit_crit_edge.us ], [ 0, %.lr.ph35 ]
  %8 = trunc i64 %indvars.iv36 to i32
  %9 = sitofp i32 %8 to double
  %10 = getelementptr inbounds double, double* %1, i64 %indvars.iv36
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  %11 = icmp eq i64 %indvars.iv.next37, 2000
  %12 = trunc i64 %indvars.iv.next37 to i32
  ...
  %21 = add nuw nsw i64 %indvars.iv36, 3
  %22 = trunc i64 %21 to i32
  %23 = srem i32 %22, 2000
  %24 = sitofp i32 %23 to double
  %25 = getelementptr inbounds double, double* %3, i64 %indvars.iv36
  %26 = add nuw nsw i64 %indvars.iv36, 4
  ...
  %35 = getelementptr inbounds double, double* %4, i64 %indvars.iv36
  store double %34, double* %35, align 8
  br i1 true, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.lr.ph.us
  %36 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv36, i64 0
...
.lr.ph.us.new:                                    ; preds = %.lr.ph.us.new.preheader, %.lr.ph.us.new
  ...
  %37 = mul nuw nsw i64 %indvars.iv, %indvars.iv36
  %38 = trunc i64 %37 to i32
  %39 = srem i32 %38, 2000
  %40 = sitofp i32 %39 to double
  %41 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv36, i64 %indvars.iv
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %42 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv36
...
define internal fastcc void @kernel_mvt(i32, double* nocapture, double* nocapture, double* nocapture readonly, double* nocapture readonly, [2000 x double]* nocapture readonly) unnamed_addr #2 {
  br i1 true, label %.preheader32.us.preheader, label %._crit_edge35

.preheader32.us.preheader:                        ; preds = %6
  br label %.preheader32.us

.preheader32.us:                                  ; preds = %.preheader32.us.preheader, %._crit_edge38.us
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %._crit_edge38.us ], [ 0, %.preheader32.us.preheader ]
  %7 = getelementptr inbounds double, double* %1, i64 %indvars.iv51
  br i1 true, label %.prol.loopexit48, label %.prol.preheader47

.prol.preheader47:                                ; preds = %.preheader32.us
  %8 = load double, double* %7, align 8
  %9 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv51, i64 0
...
.prol.loopexit48:                                 ; preds = %.prol.preheader47, %.preheader32.us
  %indvars.iv43.unr.ph = phi i64 [ 1, %.prol.preheader47 ], [ 0, %.preheader32.us ]
  br i1 false, label %._crit_edge38.us, label %.preheader32.us.new.preheader

.preheader32.us.new.preheader:                    ; preds = %.prol.loopexit48
...
.preheader32.us.new:                              ; preds = %.preheader32.us.new.preheader, %.preheader32.us.new
  %14 = phi double [ %26, %.preheader32.us.new ], [ %.pre, %.preheader32.us.new.preheader ]
  %indvars.iv43 = phi i64 [ %indvars.iv.next44.1, %.preheader32.us.new ], [ %indvars.iv43.unr.ph, %.preheader32.us.new.preheader ]
  %15 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv51, i64 %indvars.iv43
  %16 = load double, double* %15, align 8
  %17 = getelementptr inbounds double, double* %3, i64 %indvars.iv43
  %18 = load double, double* %17, align 8
  %19 = fmul double %16, %18
  %20 = fadd double %14, %19
  store double %20, double* %7, align 8
  %indvars.iv.next44 = add nuw nsw i64 %indvars.iv43, 1
  %21 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv51, i64 %indvars.iv.next44
  %22 = load double, double* %21, align 8
  %23 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next44
  %24 = load double, double* %23, align 8
  %25 = fmul double %22, %24
  %26 = fadd double %20, %25
  store double %26, double* %7, align 8
  %indvars.iv.next44.1 = add nuw nsw i64 %indvars.iv43, 2
  %exitcond46.1 = icmp eq i64 %indvars.iv.next44.1, 2000
  br i1 %exitcond46.1, label %._crit_edge38.us.loopexit, label %.preheader32.us.new

._crit_edge38.us.loopexit:                        ; preds = %.preheader32.us.new
  br label %._crit_edge38.us

._crit_edge38.us:                                 ; preds = %._crit_edge38.us.loopexit, %.prol.loopexit48
  %indvars.iv.next52 = add nuw nsw i64 %indvars.iv51, 1
  %exitcond54 = icmp eq i64 %indvars.iv.next52, 2000
  br i1 %exitcond54, label %.preheader.us.preheader, label %.preheader32.us

.preheader.us.preheader:                          ; preds = %._crit_edge38.us
  br label %.preheader.us

.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %._crit_edge.us ], [ 0, %.preheader.us.preheader ]
  %27 = getelementptr inbounds double, double* %2, i64 %indvars.iv40
  br i1 true, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.preheader.us
  %28 = load double, double* %27, align 8
  %29 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 0, i64 %indvars.iv40
...
.preheader.us.new.preheader:                      ; preds = %.prol.loopexit
  %.pre55 = load double, double* %27, align 8
  br label %.preheader.us.new

.preheader.us.new:                                ; preds = %.preheader.us.new.preheader, %.preheader.us.new
  %34 = phi double [ %46, %.preheader.us.new ], [ %.pre55, %.preheader.us.new.preheader ]
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.preheader.us.new ], [ %indvars.iv.unr.ph, %.preheader.us.new.preheader ]
  %35 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv, i64 %indvars.iv40
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %41 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv.next, i64 %indvars.iv40
...
._crit_edge35.loopexit:                           ; preds = %._crit_edge.us
...
define internal fastcc void @print_array(i32, double* nocapture readonly, double* nocapture readonly) unnamed_addr #0 {
  ...
  br i1 true, label %.lr.ph17.preheader, label %._crit_edge.critedge

.lr.ph17.preheader:                               ; preds = %3
  br label %.lr.ph17

.lr.ph17:                                         ; preds = %.lr.ph17.preheader, %13
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %13 ], [ 0, %.lr.ph17.preheader ]
  %8 = trunc i64 %indvars.iv19 to i32
  %9 = srem i32 %8, 20
  %10 = icmp eq i32 %9, 0
  br i1 %10, label %11, label %13

; <label>:11:                                     ; preds = %.lr.ph17
  %12 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %fputc13 = tail call i32 @fputc(i32 10, %struct._IO_FILE* %12) #5
  br label %13

; <label>:13:                                     ; preds = %.lr.ph17, %11
  %14 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %15 = getelementptr inbounds double, double* %1, i64 %indvars.iv19
  %16 = load double, double* %15, align 8
  %17 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %14, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i64 0, i64 0), double %16) #6
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  %exitcond22 = icmp eq i64 %indvars.iv.next20, 2000
  br i1 %exitcond22, label %._crit_edge18, label %.lr.ph17
...
._crit_edge18:                                    ; preds = %13
  ...
  br i1 true, label %.lr.ph.preheader, label %._crit_edge18.._crit_edge_crit_edge

._crit_edge18.._crit_edge_crit_edge:              ; preds = %._crit_edge18
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %._crit_edge18.._crit_edge_crit_edge, %._crit_edge.loopexit, %._crit_edge.critedge
