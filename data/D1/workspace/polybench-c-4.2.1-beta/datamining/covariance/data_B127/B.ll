...
; <label>:17:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond6, label %18, label %._crit_edge4
...
.lr.ph28.split.us:                                ; preds = %._crit_edge25.us, %.lr.ph28.split.us.preheader
  ...
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv72
  store double 0.000000e+00, double* %5, align 8
  %sunkaddr9 = shl i64 %indvars.iv72, 3
  %sunkaddr10 = add i64 %4, %sunkaddr9
  %sunkaddr11 = inttoptr i64 %sunkaddr10 to double*
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph28.split.us
  %6 = phi double [ 0.000000e+00, %.lr.ph28.split.us ], [ %21, %._crit_edge ]
  %indvars.iv68 = phi i64 [ 0, %.lr.ph28.split.us ], [ %indvars.iv.next69.4, %._crit_edge ]
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv68, i64 %indvars.iv72
  %8 = load double, double* %7, align 8
  %9 = fadd double %8, %6
  store double %9, double* %sunkaddr11, align 8
  %indvars.iv.next69 = add nuw nsw i64 %indvars.iv68, 1
  %10 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next69, i64 %indvars.iv72
  %11 = load double, double* %10, align 8
  %12 = fadd double %11, %9
  store double %12, double* %sunkaddr11, align 8
  %indvars.iv.next69.1 = add nuw nsw i64 %indvars.iv68, 2
  %13 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next69.1, i64 %indvars.iv72
  %14 = load double, double* %13, align 8
  %15 = fadd double %14, %12
  store double %15, double* %sunkaddr11, align 8
  %indvars.iv.next69.2 = add nuw nsw i64 %indvars.iv68, 3
  %16 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next69.2, i64 %indvars.iv72
  %17 = load double, double* %16, align 8
  %18 = fadd double %17, %15
  store double %18, double* %sunkaddr11, align 8
  %indvars.iv.next69.3 = add nuw nsw i64 %indvars.iv68, 4
  %19 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next69.3, i64 %indvars.iv72
  %20 = load double, double* %19, align 8
  %21 = fadd double %20, %18
  store double %21, double* %sunkaddr11, align 8
  %indvars.iv.next69.4 = add nuw nsw i64 %indvars.iv68, 5
  %exitcond86.4 = icmp eq i64 %indvars.iv.next69.4, 1400
  br i1 %exitcond86.4, label %._crit_edge25.us, label %._crit_edge

._crit_edge25.us:                                 ; preds = %._crit_edge
  %22 = fdiv double %21, %0
  %sunkaddr41 = shl i64 %indvars.iv72, 3
  %sunkaddr42 = add i64 %sunkaddr, %sunkaddr41
  %sunkaddr43 = inttoptr i64 %sunkaddr42 to double*
  store double %22, double* %sunkaddr43, align 8
  %indvars.iv.next73 = add nuw nsw i64 %indvars.iv72, 1
  %exitcond87 = icmp eq i64 %indvars.iv.next73, 1200
  br i1 %exitcond87, label %._crit_edge25.us..lr.ph20.split.us_crit_edge, label %.lr.ph28.split.us

._crit_edge25.us..lr.ph20.split.us_crit_edge:     ; preds = %._crit_edge25.us
  %scevgep27 = getelementptr double, double* %3, i64 1200
  br label %vector.memcheck

vector.memcheck:                                  ; preds = %._crit_edge17.us, %._crit_edge25.us..lr.ph20.split.us_crit_edge
  %indvars.iv63 = phi i64 [ 0, %._crit_edge25.us..lr.ph20.split.us_crit_edge ], [ %23, %._crit_edge17.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv63, i64 0
  %23 = add nuw nsw i64 %indvars.iv63, 1
  %scevgep25 = getelementptr [1200 x double], [1200 x double]* %1, i64 %23, i64 0
  %bound0 = icmp ult double* %scevgep, %scevgep27
  %bound1 = icmp ugt double* %scevgep25, %3
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv63, i64 %offset.idx
  %27 = bitcast double* %26 to <8 x double>*
  %wide.vec32 = load <8 x double>, <8 x double>* %27, align 8, !alias.scope !4, !noalias !1
  %28 = fsub <8 x double> %wide.vec32, %wide.vec
  ...
  %33 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv63, i64 %32
  ...
  br i1 %39, label %._crit_edge17.us.loopexit44, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv59 = phi i64 [ %indvars.iv.next60.3, %scalar.ph ], [ 0, %scalar.ph.preheader ]
  %40 = getelementptr inbounds double, double* %3, i64 %indvars.iv59
  %41 = load double, double* %40, align 8
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv63, i64 %indvars.iv59
  %43 = load double, double* %42, align 8
  %44 = fsub double %43, %41
  store double %44, double* %42, align 8
  %indvars.iv.next60 = or i64 %indvars.iv59, 1
  %45 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next60
  %46 = load double, double* %45, align 8
  %47 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv63, i64 %indvars.iv.next60
  %48 = load double, double* %47, align 8
  %49 = fsub double %48, %46
  store double %49, double* %47, align 8
  %indvars.iv.next60.1 = or i64 %indvars.iv59, 2
  %50 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next60.1
  %51 = load double, double* %50, align 8
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv63, i64 %indvars.iv.next60.1
  %53 = load double, double* %52, align 8
  %54 = fsub double %53, %51
  store double %54, double* %52, align 8
  %indvars.iv.next60.2 = or i64 %indvars.iv59, 3
  %55 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next60.2
  %56 = load double, double* %55, align 8
  %57 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv63, i64 %indvars.iv.next60.2
  %58 = load double, double* %57, align 8
  %59 = fsub double %58, %56
  store double %59, double* %57, align 8
  %indvars.iv.next60.3 = add nuw nsw i64 %indvars.iv59, 4
  %exitcond84.3 = icmp eq i64 %indvars.iv.next60.3, 1200
  br i1 %exitcond84.3, label %._crit_edge17.us.loopexit, label %scalar.ph, !llvm.loop !9

._crit_edge17.us.loopexit:                        ; preds = %scalar.ph
  br label %._crit_edge17.us

._crit_edge17.us.loopexit44:                      ; preds = %vector.body
  br label %._crit_edge17.us

._crit_edge17.us:                                 ; preds = %._crit_edge17.us.loopexit44, %._crit_edge17.us.loopexit
  %exitcond85 = icmp eq i64 %23, 1400
  br i1 %exitcond85, label %.lr.ph12.split.us.preheader, label %vector.memcheck
...
.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph8.us
  ...
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv45, i64 %indvars.iv41
  store double 0.000000e+00, double* %61, align 8
  br label %._crit_edge38

._crit_edge.us.us:                                ; preds = %._crit_edge38
  %62 = fdiv double %76, %60
  store double %62, double* %61, align 8
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv41, i64 %indvars.iv45
  store double %62, double* %63, align 8
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  %exitcond = icmp eq i64 %indvars.iv.next42, 1200
  br i1 %exitcond, label %._crit_edge9.us-lcssa.us.us, label %.lr.ph.us.us

._crit_edge38:                                    ; preds = %._crit_edge38, %.lr.ph.us.us
  %64 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %76, %._crit_edge38 ]
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %._crit_edge38 ]
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv45
  %66 = load double, double* %65, align 8
  %67 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv41
  %68 = load double, double* %67, align 8
  %69 = fmul double %66, %68
  %70 = fadd double %64, %69
  store double %70, double* %61, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv45
  %72 = load double, double* %71, align 8
  %73 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv41
  %74 = load double, double* %73, align 8
  %75 = fmul double %72, %74
  %76 = fadd double %70, %75
  store double %76, double* %61, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond82.1 = icmp eq i64 %indvars.iv.next.1, 1400
  br i1 %exitcond82.1, label %._crit_edge.us.us, label %._crit_edge38
...
._crit_edge4:                                     ; preds = %._crit_edge, %.lr.ph5.split.us
...
._crit_edge:                                      ; preds = %._crit_edge4, %10
  ...
  br i1 %exitcond11, label %._crit_edge.us, label %._crit_edge4
