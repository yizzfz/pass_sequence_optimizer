...
for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.cond4.for.inc37_crit_edge.us
  ...
  %3 = add i64 %indvar55, 1
  %scevgep57 = getelementptr [1300 x double], [1300 x double]* %B, i64 %3, i64 1
  %scevgep59 = getelementptr [1300 x double], [1300 x double]* %B, i64 %3, i64 %wide.trip.count20
  %scevgep61 = getelementptr [1300 x double], [1300 x double]* %A, i64 %indvar55, i64 1
  %4 = add i64 %indvar55, 2
  %scevgep63 = getelementptr [1300 x double], [1300 x double]* %A, i64 %4, i64 %wide.trip.count20
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %5 = add nsw i64 %indvars.iv12, -1
...
vector.body46:                                    ; preds = %vector.body46.preheader, %vector.body46
  ...
  %6 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv12, i64 %offset.idx76
  %7 = bitcast double* %6 to <2 x double>*
  %wide.load81 = load <2 x double>, <2 x double>* %7, align 8, !alias.scope !1
  %8 = getelementptr double, double* %6, i64 2
  %9 = bitcast double* %8 to <2 x double>*
  %wide.load82 = load <2 x double>, <2 x double>* %9, align 8, !alias.scope !1
  %10 = add nsw i64 %offset.idx76, -1
  %11 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv12, i64 %10
  %12 = bitcast double* %11 to <2 x double>*
  %wide.load83 = load <2 x double>, <2 x double>* %12, align 8, !alias.scope !1
  %13 = getelementptr double, double* %11, i64 2
  %14 = bitcast double* %13 to <2 x double>*
  %wide.load84 = load <2 x double>, <2 x double>* %14, align 8, !alias.scope !1
  %15 = fadd <2 x double> %wide.load81, %wide.load83
  %16 = fadd <2 x double> %wide.load82, %wide.load84
  %17 = add nuw nsw i64 %offset.idx76, 1
  %18 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv12, i64 %17
  %19 = bitcast double* %18 to <2 x double>*
  %wide.load85 = load <2 x double>, <2 x double>* %19, align 8, !alias.scope !1
  %20 = getelementptr double, double* %18, i64 2
  %21 = bitcast double* %20 to <2 x double>*
  %wide.load86 = load <2 x double>, <2 x double>* %21, align 8, !alias.scope !1
  %22 = fadd <2 x double> %15, %wide.load85
  %23 = fadd <2 x double> %16, %wide.load86
  %24 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv.next13, i64 %offset.idx76
  ...
  %28 = fadd <2 x double> %22, %wide.load87
  %29 = fadd <2 x double> %23, %wide.load88
  %30 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %5, i64 %offset.idx76
  %31 = bitcast double* %30 to <2 x double>*
  %wide.load89 = load <2 x double>, <2 x double>* %31, align 8, !alias.scope !1
  %32 = getelementptr double, double* %30, i64 2
  %33 = bitcast double* %32 to <2 x double>*
  %wide.load90 = load <2 x double>, <2 x double>* %33, align 8, !alias.scope !1
  %34 = fadd <2 x double> %28, %wide.load89
  %35 = fadd <2 x double> %29, %wide.load90
  ...
  %38 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv12, i64 %offset.idx76
  ...
  %42 = icmp eq i64 %index.next72, %n.vec52
  br i1 %42, label %middle.block47, label %vector.body46, !llvm.loop !6
...
for.body7.us:                                     ; preds = %for.body7.us.preheader, %for.body7.us
  ...
  %arrayidx14.us = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv12, i64 %44
...
for.cond40.preheader:                             ; preds = %for.cond4.for.inc37_crit_edge.us
  br i1 %2, label %for.cond44.preheader.us.preheader, label %for.inc87
...
for.cond44.preheader.us:                          ; preds = %for.cond44.preheader.us.preheader, %for.cond44.for.inc84_crit_edge.us
  ...
  %scevgep30 = getelementptr [1300 x double], [1300 x double]* %A, i64 %49, i64 %wide.trip.count20
  %scevgep32 = getelementptr [1300 x double], [1300 x double]* %B, i64 %indvar, i64 1
  %50 = add i64 %indvar, 2
  %scevgep34 = getelementptr [1300 x double], [1300 x double]* %B, i64 %50, i64 %wide.trip.count20
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  %51 = add nsw i64 %indvars.iv22, -1
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %52 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv22, i64 %offset.idx
  %53 = bitcast double* %52 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %53, align 8, !alias.scope !10
  %54 = getelementptr double, double* %52, i64 2
  %55 = bitcast double* %54 to <2 x double>*
  %wide.load37 = load <2 x double>, <2 x double>* %55, align 8, !alias.scope !10
  %56 = add nsw i64 %offset.idx, -1
  %57 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv22, i64 %56
  %58 = bitcast double* %57 to <2 x double>*
  %wide.load38 = load <2 x double>, <2 x double>* %58, align 8, !alias.scope !10
  %59 = getelementptr double, double* %57, i64 2
  %60 = bitcast double* %59 to <2 x double>*
  %wide.load39 = load <2 x double>, <2 x double>* %60, align 8, !alias.scope !10
  %61 = fadd <2 x double> %wide.load, %wide.load38
  %62 = fadd <2 x double> %wide.load37, %wide.load39
  %63 = add nuw nsw i64 %offset.idx, 1
  %64 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv22, i64 %63
  %65 = bitcast double* %64 to <2 x double>*
  %wide.load40 = load <2 x double>, <2 x double>* %65, align 8, !alias.scope !10
  %66 = getelementptr double, double* %64, i64 2
  %67 = bitcast double* %66 to <2 x double>*
  %wide.load41 = load <2 x double>, <2 x double>* %67, align 8, !alias.scope !10
  %68 = fadd <2 x double> %61, %wide.load40
  %69 = fadd <2 x double> %62, %wide.load41
  %70 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv.next23, i64 %offset.idx
  %71 = bitcast double* %70 to <2 x double>*
  %wide.load42 = load <2 x double>, <2 x double>* %71, align 8, !alias.scope !10
  %72 = getelementptr double, double* %70, i64 2
  %73 = bitcast double* %72 to <2 x double>*
  %wide.load43 = load <2 x double>, <2 x double>* %73, align 8, !alias.scope !10
  %74 = fadd <2 x double> %68, %wide.load42
  %75 = fadd <2 x double> %69, %wide.load43
  ...
  %80 = fadd <2 x double> %74, %wide.load44
  %81 = fadd <2 x double> %75, %wide.load45
  ...
  %84 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv22, i64 %offset.idx
...
for.body47.us:                                    ; preds = %for.body47.us.preheader, %for.body47.us
  ...
  %arrayidx56.us = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv22, i64 %90
  ...
  %arrayidx74.us = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %51, i64 %indvars.iv17
