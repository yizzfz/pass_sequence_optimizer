...
@__llvm_prf_nm = private constant [48 x i8] c"/.x\DA\F3uI\CB\CCI5\88\CFI\CDc\F4\05\B3\19Kr\0B\0C\F5rr\AC \5C\03\A0p|bJJRiZZj\11\00w:\0F\EA", section "__llvm_prf_names"
@llvm.used = appending global [5 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_MDfile0_len to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_MDfile to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_MDfile0 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_MD_addbuffer to i8*), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
