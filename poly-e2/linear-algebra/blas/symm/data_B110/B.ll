...
for.cond1.preheader.us:                           ; preds = %for.inc16.loopexit.us, %entry
  %indvars.iv67 = phi i64 [ 0, %entry ], [ %indvars.iv.next68, %for.inc16.loopexit.us ]
  %0 = add i64 %indvars.iv67, 1200
  %1 = trunc i64 %0 to i32
  br label %for.inc.us

for.inc.us:                                       ; preds = %for.inc.us, %for.cond1.preheader.us
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc.us ], [ 0, %for.cond1.preheader.us ]
  ...
  br i1 %exitcond66, label %for.inc16.loopexit.us, label %for.inc.us

for.inc16.loopexit.us:                            ; preds = %for.inc.us
...
for.inc36.lr.ph.preheader:                        ; preds = %for.inc16.loopexit.us
  br label %for.inc36.lr.ph

for.inc36.lr.ph:                                  ; preds = %for.inc36.lr.ph.preheader, %for.inc51
  %indvars.iv77 = phi i3 [ %indvars.iv.next78, %for.inc51 ], [ -1, %for.inc36.lr.ph.preheader ]
  %indvars.iv75 = phi i64 [ %indvars.iv.next76, %for.inc51 ], [ 2, %for.inc36.lr.ph.preheader ]
...
for.inc48.preheader:                              ; preds = %for.inc48.prol.loopexit
  %21 = sub i64 992, %indvars.iv51.unr
  %22 = lshr i64 %21, 3
  %23 = add nuw nsw i64 %22, 1
  %min.iters.check = icmp ult i64 %23, 2
  br i1 %min.iters.check, label %for.inc48.preheader79, label %min.iters.checked

min.iters.checked:                                ; preds = %for.inc48.preheader
  %n.mod.vf = and i64 %23, 1
  %n.vec = sub nsw i64 %23, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  %24 = add i64 %indvars.iv51.unr, 8
  %25 = shl nuw i64 %22, 3
  %26 = add i64 %24, %25
  %27 = shl nuw nsw i64 %n.mod.vf, 3
  %ind.end = sub i64 %26, %27
  br i1 %cmp.zero, label %for.inc48.preheader79, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %28 = shl i64 %index, 3
  %29 = add i64 %indvars.iv51.unr, %28
  %30 = add nsw i64 %29, 7
  %31 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv60, i64 %30
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.inc51, label %for.inc48.preheader79

for.inc48.preheader79:                            ; preds = %middle.block, %min.iters.checked, %for.inc48.preheader
  %indvars.iv51.ph = phi i64 [ %indvars.iv51.unr, %min.iters.checked ], [ %indvars.iv51.unr, %for.inc48.preheader ], [ %ind.end, %middle.block ]
  br label %for.inc48

for.inc48:                                        ; preds = %for.inc48.preheader79, %for.inc48
  %indvars.iv51 = phi i64 [ %indvars.iv.next52.7, %for.inc48 ], [ %indvars.iv51.ph, %for.inc48.preheader79 ]
...
vector.memcheck:                                  ; preds = %for.cond1.preheader
  ...
  %scevgep62 = getelementptr [1200 x double], [1200 x double]* %B, i64 %indvars.iv51, i64 0
...
for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.inc50.loopexit.us
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc50.loopexit.us ], [ 0, %for.cond4.preheader.us.preheader ]
...
for.inc.us:                                       ; preds = %for.inc.us, %for.cond4.preheader.us
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc.us ], [ 0, %for.cond4.preheader.us ]
  ...
  br i1 %exitcond46, label %for.inc50.loopexit.us, label %for.inc.us

for.inc50.loopexit.us:                            ; preds = %for.inc.us
...
for.cond4.preheader:                              ; preds = %for.cond4.preheader, %for.cond4.preheader.preheader
  ...
  br i1 %exitcond.1, label %for.inc53.loopexit82, label %for.cond4.preheader, !llvm.loop !17

for.inc53.loopexit:                               ; preds = %for.inc50.loopexit.us
  br label %for.inc53
...
for.inc53:                                        ; preds = %for.inc53.loopexit83, %for.inc53.loopexit82, %for.inc53.loopexit
  ...
  br i1 %exitcond54, label %for.end55, label %for.cond1.preheader
...
for.cond2.preheader.us:                           ; preds = %for.inc10.loopexit.us, %entry
  %indvars.iv15 = phi i64 [ 0, %entry ], [ %indvars.iv.next16, %for.inc10.loopexit.us ]
...
for.inc.us:                                       ; preds = %if.then.us, %for.body4.us
  ...
  br i1 %exitcond, label %for.inc10.loopexit.us, label %for.body4.us

for.inc10.loopexit.us:                            ; preds = %for.inc.us
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  %exitcond19 = icmp eq i64 %indvars.iv.next16, 1000
