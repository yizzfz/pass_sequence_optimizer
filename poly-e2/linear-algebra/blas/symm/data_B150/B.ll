...
for.body22:                                       ; preds = %for.inc51.for.body22_crit_edge, %for.body22.preheader
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc51.for.body22_crit_edge ], [ 0, %for.body22.preheader ]
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc51.for.body22_crit_edge ], [ 1, %for.body22.preheader ]
  %indvar = phi i32 [ %7, %for.inc51.for.body22_crit_edge ], [ 0, %for.body22.preheader ]
  %indvars.iv20 = phi i32 [ %indvars.iv.next21, %for.inc51.for.body22_crit_edge ], [ 1, %for.body22.preheader ]
  %5 = sub i32 1007, %indvar
  %6 = sub i32 998, %indvar
  %7 = add i32 %indvar, 1
  %cmp242 = icmp sgt i64 %indvars.iv30, -1
  br i1 %cmp242, label %for.body26.lr.ph, label %for.end38

for.body26.lr.ph:                                 ; preds = %for.body22
...
for.end38:                                        ; preds = %for.end38.loopexit, %for.body26.prol.loopexit.unr-lcssa, %for.body22
...
for.body43.prol:                                  ; preds = %for.body43.prol, %for.body43.prol.preheader
  %indvars.iv24.prol = phi i64 [ %indvars.iv22, %for.body43.prol.preheader ], [ %indvars.iv.next25.prol, %for.body43.prol ]
  %prol.iter = phi i32 [ %xtraiter26, %for.body43.prol.preheader ], [ %prol.iter.sub, %for.body43.prol ]
...
for.body43.prol.loopexit:                         ; preds = %for.body43.prol.loopexit.loopexit, %for.body43.lr.ph
  %indvars.iv24.unr = phi i64 [ %indvars.iv22, %for.body43.lr.ph ], [ %indvars.iv.next25.prol, %for.body43.prol.loopexit.loopexit ]
  %15 = icmp ult i32 %6, 7
  br i1 %15, label %for.inc51.for.body22_crit_edge, label %for.body43.preheader

for.body43.preheader:                             ; preds = %for.body43.prol.loopexit
  br label %for.body43

for.body43:                                       ; preds = %for.body43, %for.body43.preheader
  %indvars.iv24 = phi i64 [ %indvars.iv24.unr, %for.body43.preheader ], [ %indvars.iv.next25.7, %for.body43 ]
...
for.body:                                         ; preds = %for.inc53.for.body_crit_edge, %entry
  %indvars.iv32 = phi i64 [ 0, %entry ], [ %0, %for.inc53.for.body_crit_edge ]
  %indvars.iv28 = phi i32 [ 0, %entry ], [ %indvars.iv.next29, %for.inc53.for.body_crit_edge ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %20 = fadd <2 x double> %18, %broadcast.splat57
  %21 = fadd <2 x double> %19, %broadcast.splat57
  ...
  br i1 %22, label %for.inc53.loopexit61, label %vector.body, !llvm.loop !11
...
for.body3:                                        ; preds = %for.body3, %for.body3.preheader
  ...
  br i1 %exitcond, label %for.inc53.loopexit60, label %for.body3, !llvm.loop !14
...
for.inc53:                                        ; preds = %for.inc53.loopexit61, %for.inc53.loopexit60, %for.inc53.loopexit
  ...
  br i1 %cmp, label %for.inc53.for.body_crit_edge, label %for.end55
