...
._crit_edge:                                      ; preds = %._crit_edge, %.preheader13
  %indvars.iv16 = phi i64 [ 0, %.preheader13 ], [ %indvars.iv.next17, %._crit_edge ]
...
.preheader11:                                     ; preds = %.preheader11.preheader, %28
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %28 ], [ 0, %.preheader11.preheader ]
  br label %._crit_edge22

._crit_edge22:                                    ; preds = %._crit_edge22, %.preheader11
  %indvars.iv10 = phi i64 [ 0, %.preheader11 ], [ %indvars.iv.next11.1, %._crit_edge22 ]
  ...
  br i1 %exitcond12.1, label %28, label %._crit_edge22
...
.preheader9:                                      ; preds = %.preheader9.preheader, %37
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %37 ], [ 0, %.preheader9.preheader ]
  br label %._crit_edge23

._crit_edge23:                                    ; preds = %._crit_edge23, %.preheader9
  %indvars.iv4 = phi i64 [ 0, %.preheader9 ], [ %indvars.iv.next5, %._crit_edge23 ]
  ...
  br i1 %exitcond6, label %37, label %._crit_edge23
...
._crit_edge24:                                    ; preds = %._crit_edge24, %.preheader
  ...
  br i1 %exitcond, label %45, label %._crit_edge24
...
.preheader7:                                      ; preds = %25, %7
  %indvars.iv14 = phi i64 [ 0, %7 ], [ %indvars.iv.next15, %25 ]
  br label %._crit_edge17

._crit_edge17:                                    ; preds = %24, %.preheader7
  %indvars.iv10 = phi i64 [ 0, %.preheader7 ], [ %indvars.iv.next11, %24 ]
...
; <label>:25:                                     ; preds = %24
  ...
  br i1 %exitcond16, label %.preheader.preheader, label %.preheader7
...
._crit_edge19:                                    ; preds = %48, %.preheader
...
._crit_edge18:                                    ; preds = %._crit_edge18, %._crit_edge19
  %indvars.iv = phi i64 [ 0, %._crit_edge19 ], [ %indvars.iv.next.2, %._crit_edge18 ]
  %29 = phi double [ %28, %._crit_edge19 ], [ %47, %._crit_edge18 ]
  ...
  br i1 %exitcond.2, label %48, label %._crit_edge18

; <label>:48:                                     ; preds = %._crit_edge18
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 1200
  br i1 %exitcond3, label %49, label %._crit_edge19
