...
entry:
  ...
  %sunkaddr11 = ptrtoint double* %y to i64
  br label %for.body
...
for.end:                                          ; preds = %for.body7
  ...
  %8 = load double, double* %sunkaddr14, align 8
  %mul35 = fmul double %8, %beta
  %add36 = fadd double %mul32, %mul35
  store double %add36, double* %sunkaddr14, align 8
