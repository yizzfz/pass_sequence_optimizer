...
.preheader152:                                    ; preds = %._crit_edge164, %4
  %.0165 = phi i32 [ 1, %4 ], [ %157, %._crit_edge164 ]
  br label %.lver.check

.lver.check:                                      ; preds = %37, %.preheader152
  %indvar = phi i64 [ %5, %37 ], [ 0, %.preheader152 ]
  %indvars.iv3 = phi i64 [ %13, %37 ], [ 1, %.preheader152 ]
  %5 = add i64 %indvar, 1
...
; <label>:114:                                    ; preds = %114, %._crit_edge160.us
  %115 = phi double [ 1.000000e+00, %._crit_edge160.us ], [ %128, %114 ]
  %indvars.iv8 = phi i64 [ 998, %._crit_edge160.us ], [ %indvars.iv.next9.1, %114 ]
...
; <label>:131:                                    ; preds = %131, %.ph40
  ...
  br i1 %exitcond7, label %._crit_edge160.us.loopexit47, label %131

._crit_edge160.us.loopexit:                       ; preds = %.ph40.lver.orig
  br label %._crit_edge160.us

._crit_edge160.us.loopexit47:                     ; preds = %131
  br label %._crit_edge160.us
...
._crit_edge164:                                   ; preds = %113
  %156 = icmp sgt i32 %.0165, 499
  %157 = add nuw nsw i32 %.0165, 1
  br i1 %156, label %158, label %.preheader152

; <label>:158:                                    ; preds = %._crit_edge164
  ret void
}
