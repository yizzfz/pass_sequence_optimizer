...
.lr.ph6.us:                                       ; preds = %.lr.ph6.us.preheader90, %.lr.ph6.us
  %indvars.iv29 = phi i64 [ %52, %.lr.ph6.us ], [ %indvars.iv29.ph, %.lr.ph6.us.preheader90 ]
...
scalar.ph53:                                      ; preds = %scalar.ph53.preheader, %scalar.ph53
  %indvars.iv = phi i64 [ %65, %scalar.ph53 ], [ %indvars.iv.ph, %scalar.ph53.preheader ]
  ...
  br i1 %71, label %scalar.ph53, label %.lr.ph6.us.preheader.loopexit, !llvm.loop !10
...
.lr.ph6.us.preheader:                             ; preds = %.lr.ph6.us.preheader.loopexit, %middle.block52
  br i1 %min.iters.check, label %.lr.ph6.us.preheader90, label %min.iters.checked
...
min.iters.checked:                                ; preds = %.lr.ph6.us.preheader
  br i1 %cmp.zero, label %.lr.ph6.us.preheader90, label %vector.memcheck
...
middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %._crit_edge7.us, label %.lr.ph6.us.preheader90
