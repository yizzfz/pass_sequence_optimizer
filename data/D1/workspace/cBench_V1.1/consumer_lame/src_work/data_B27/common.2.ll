...
@__llvm_prf_nm = private constant [70 x i8] c"D\00decode_header\01print_header\01print_header_compact\01getbits\01getbits_fast", section "__llvm_prf_names"
@llvm.used = appending global [6 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_decode_header to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_print_header to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_print_header_compact to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_getbits to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_getbits_fast to i8*), i8* getelementptr inbounds ([70 x i8], [70 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
