...
for.body.us:                                      ; preds = %for.cond22.for.cond.loopexit_crit_edge.us, %entry
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.cond22.for.cond.loopexit_crit_edge.us ], [ 0, %entry ]
  ...
  %1 = icmp eq i64 %indvars.iv.next5, 2000
  ...
  %6 = add nuw nsw i64 %indvars.iv4, 4
...
for.body25.us:                                    ; preds = %for.body.us, %for.body25.us
  ...
  %10 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv4
...
for.cond22.for.cond.loopexit_crit_edge.us:        ; preds = %for.body25.us
  %13 = icmp eq i64 %indvars.iv.next5, 2000
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.end_crit_edge.us, %entry
  %indvars.iv13 = phi i64 [ 0, %entry ], [ %indvars.iv.next14, %for.cond1.for.end_crit_edge.us ]
  %arrayidx.us = getelementptr inbounds double, double* %x1, i64 %indvars.iv13
  %.pre = load double, double* %arrayidx.us, align 8
  %sunkaddr1 = mul i64 %indvars.iv13, 8
...
for.body3.us:                                     ; preds = %for.cond1.preheader.us, %for.body3.us
  ...
  %indvars.iv9 = phi i64 [ %indvars.iv.next10.1, %for.body3.us ], [ 0, %for.cond1.preheader.us ]
  %arrayidx7.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv13, i64 %indvars.iv9
  %1 = load double, double* %arrayidx7.us, align 8
  %arrayidx9.us = getelementptr inbounds double, double* %y_1, i64 %indvars.iv9
  ...
  %arrayidx7.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv13, i64 %indvars.iv.next10
  %3 = load double, double* %arrayidx7.us.1, align 8
  %arrayidx9.us.1 = getelementptr inbounds double, double* %y_1, i64 %indvars.iv.next10
  ...
  %exitcond12.1 = icmp eq i64 %indvars.iv.next10.1, 2000
  br i1 %exitcond12.1, label %for.cond1.for.end_crit_edge.us, label %for.body3.us

for.cond1.for.end_crit_edge.us:                   ; preds = %for.body3.us
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond19 = icmp eq i64 %indvars.iv.next14, 2000
  br i1 %exitcond19, label %for.cond18.preheader.us.preheader, label %for.cond1.preheader.us

for.cond18.preheader.us.preheader:                ; preds = %for.cond1.for.end_crit_edge.us
  %sunkaddr4 = ptrtoint double* %x2 to i64
  br label %for.cond18.preheader.us

for.cond18.preheader.us:                          ; preds = %for.cond18.preheader.us.preheader, %for.cond18.for.end35_crit_edge.us
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.cond18.for.end35_crit_edge.us ], [ 0, %for.cond18.preheader.us.preheader ]
  %arrayidx22.us = getelementptr inbounds double, double* %x2, i64 %indvars.iv5
  %.pre21 = load double, double* %arrayidx22.us, align 8
  %sunkaddr5 = mul i64 %indvars.iv5, 8
...
for.body20.us:                                    ; preds = %for.cond18.preheader.us, %for.body20.us
  %5 = phi double [ %add30.us.1, %for.body20.us ], [ %.pre21, %for.cond18.preheader.us ]
  ...
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %for.cond18.for.end35_crit_edge.us, label %for.body20.us

for.cond18.for.end35_crit_edge.us:                ; preds = %for.body20.us
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1
  %exitcond = icmp eq i64 %indvars.iv.next6, 2000
  br i1 %exitcond, label %for.end38, label %for.cond18.preheader.us

for.end38:                                        ; preds = %for.cond18.for.end35_crit_edge.us
  ret void
}
...
if.end14:                                         ; preds = %for.body9, %if.then12
  ...
  %exitcond10 = icmp eq i64 %indvars.iv.next, 2000
  br i1 %exitcond10, label %for.end20, label %for.body9
