...
for.body5.us:                                     ; preds = %for.inc42.us, %for.body5.us.preheader
  ...
  %scevgep89 = getelementptr [2100 x double], [2100 x double]* %A, i64 %26, i64 0
...
for.body26.us.for.body26.us_crit_edge:            ; preds = %for.body26.us.for.body26.us_crit_edge.preheader, %for.body26.us.for.body26.us_crit_edge
  %indvars.iv.next6477 = phi i64 [ %indvars.iv.next64, %for.body26.us.for.body26.us_crit_edge ], [ %indvars.iv.next6477.ph, %for.body26.us.for.body26.us_crit_edge.preheader ]
...
for.body26.us.preheader:                          ; preds = %for.body10.us
  ...
  %37 = load double, double* %arrayidx32.us74, align 8
  %mul35.us75 = fmul double %37, %add.us.2
  %add36.us76 = fadd double %36, %mul35.us75
...
for.body26.us.for.body26.us_crit_edge.preheader:  ; preds = %for.body26.us.for.body26.us_crit_edge.preheader.loopexit, %for.body26.us.preheader
  %indvars.iv.next6477.ph = phi i64 [ 1, %for.body26.us.preheader ], [ 2097, %for.body26.us.for.body26.us_crit_edge.preheader.loopexit ]
...
vector.body79:                                    ; preds = %vector.body79.preheader, %vector.body79
  ...
  %wide.load104 = load <2 x double>, <2 x double>* %44, align 8, !alias.scope !8, !noalias !10
  %45 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 %offset.idx
  %46 = bitcast double* %45 to <2 x double>*
  %wide.load105 = load <2 x double>, <2 x double>* %46, align 8, !alias.scope !12
  %47 = getelementptr double, double* %45, i64 2
  %48 = bitcast double* %47 to <2 x double>*
  %wide.load106 = load <2 x double>, <2 x double>* %48, align 8, !alias.scope !12
  %49 = fmul <2 x double> %wide.load105, %40
  %50 = fmul <2 x double> %wide.load106, %40
  %51 = fadd <2 x double> %wide.load, %49
  %52 = fadd <2 x double> %wide.load104, %50
  ...
  %53 = icmp eq i64 %index.next97, 2096
  br i1 %53, label %for.body26.us.for.body26.us_crit_edge.preheader.loopexit, label %vector.body79, !llvm.loop !13
