...
.lr.ph39.split.us:                                ; preds = %._crit_edge35.us, %.lr.ph39.split.us.preheader
  %indvars.iv96 = phi i64 [ 0, %.lr.ph39.split.us.preheader ], [ %indvars.iv.next97, %._crit_edge35.us ]
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv96
  store double 0.000000e+00, double* %5, align 8
  %sunkaddr130 = shl i64 %indvars.iv96, 3
  %sunkaddr131 = add i64 %4, %sunkaddr130
  %sunkaddr132 = inttoptr i64 %sunkaddr131 to double*
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph39.split.us
  %6 = phi double [ 0.000000e+00, %.lr.ph39.split.us ], [ %21, %._crit_edge ]
  %indvars.iv93 = phi i64 [ 0, %.lr.ph39.split.us ], [ %indvars.iv.next94.4, %._crit_edge ]
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv93, i64 %indvars.iv96
  %8 = load double, double* %7, align 8
  %9 = fadd double %6, %8
  store double %9, double* %sunkaddr132, align 8
  %indvars.iv.next94 = add nuw nsw i64 %indvars.iv93, 1
  %10 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next94, i64 %indvars.iv96
  %11 = load double, double* %10, align 8
  %12 = fadd double %9, %11
  store double %12, double* %sunkaddr132, align 8
  %indvars.iv.next94.1 = add nuw nsw i64 %indvars.iv93, 2
  %13 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next94.1, i64 %indvars.iv96
  %14 = load double, double* %13, align 8
  %15 = fadd double %12, %14
  store double %15, double* %sunkaddr132, align 8
  %indvars.iv.next94.2 = add nuw nsw i64 %indvars.iv93, 3
  %16 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next94.2, i64 %indvars.iv96
  %17 = load double, double* %16, align 8
  %18 = fadd double %15, %17
  store double %18, double* %sunkaddr132, align 8
  %indvars.iv.next94.3 = add nuw nsw i64 %indvars.iv93, 4
  %19 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next94.3, i64 %indvars.iv96
  %20 = load double, double* %19, align 8
  %21 = fadd double %18, %20
  store double %21, double* %sunkaddr132, align 8
  %indvars.iv.next94.4 = add nuw nsw i64 %indvars.iv93, 5
  %exitcond111.4 = icmp eq i64 %indvars.iv.next94.4, 1400
  br i1 %exitcond111.4, label %._crit_edge35.us, label %._crit_edge

._crit_edge35.us:                                 ; preds = %._crit_edge
  %22 = fdiv double %21, %0
  %sunkaddr25 = shl i64 %indvars.iv96, 3
  ...
  %exitcond112 = icmp eq i64 %indvars.iv.next97, 1200
  br i1 %exitcond112, label %._crit_edge35.us..lr.ph28.split.us_crit_edge, label %.lr.ph39.split.us

._crit_edge35.us..lr.ph28.split.us_crit_edge:     ; preds = %._crit_edge35.us
  %scevgep10 = getelementptr double, double* %3, i64 1200
  br label %vector.memcheck

vector.memcheck:                                  ; preds = %._crit_edge25.us, %._crit_edge35.us..lr.ph28.split.us_crit_edge
  %indvars.iv91 = phi i64 [ 0, %._crit_edge35.us..lr.ph28.split.us_crit_edge ], [ %23, %._crit_edge25.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv91, i64 0
  %23 = add nuw nsw i64 %indvars.iv91, 1
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv91, i64 %offset.idx
  ...
  %33 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv91, i64 %32
  ...
  br i1 %39, label %._crit_edge25.us.loopexit28, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv89 = phi i64 [ %indvars.iv.next90.3, %scalar.ph ], [ 0, %scalar.ph.preheader ]
  %40 = getelementptr inbounds double, double* %3, i64 %indvars.iv89
  %41 = load double, double* %40, align 8
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv91, i64 %indvars.iv89
  %43 = load double, double* %42, align 8
  %44 = fsub double %43, %41
  store double %44, double* %42, align 8
  %indvars.iv.next90 = or i64 %indvars.iv89, 1
  %45 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next90
  %46 = load double, double* %45, align 8
  %47 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv91, i64 %indvars.iv.next90
  %48 = load double, double* %47, align 8
  %49 = fsub double %48, %46
  store double %49, double* %47, align 8
  %indvars.iv.next90.1 = or i64 %indvars.iv89, 2
  %50 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next90.1
  %51 = load double, double* %50, align 8
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv91, i64 %indvars.iv.next90.1
  %53 = load double, double* %52, align 8
  %54 = fsub double %53, %51
  store double %54, double* %52, align 8
  %indvars.iv.next90.2 = or i64 %indvars.iv89, 3
  %55 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next90.2
  %56 = load double, double* %55, align 8
  %57 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv91, i64 %indvars.iv.next90.2
  %58 = load double, double* %57, align 8
  %59 = fsub double %58, %56
  store double %59, double* %57, align 8
  %indvars.iv.next90.3 = add nuw nsw i64 %indvars.iv89, 4
  %exitcond108.3 = icmp eq i64 %indvars.iv.next90.3, 1200
  br i1 %exitcond108.3, label %._crit_edge25.us.loopexit, label %scalar.ph, !llvm.loop !9

._crit_edge25.us.loopexit:                        ; preds = %scalar.ph
  br label %._crit_edge25.us

._crit_edge25.us.loopexit28:                      ; preds = %vector.body
  br label %._crit_edge25.us

._crit_edge25.us:                                 ; preds = %._crit_edge25.us.loopexit28, %._crit_edge25.us.loopexit
  %exitcond109 = icmp eq i64 %23, 1400
  br i1 %exitcond109, label %.lr.ph14.split.us.preheader, label %vector.memcheck

.lr.ph14.split.us.preheader:                      ; preds = %._crit_edge25.us
  %60 = fadd double %0, -1.000000e+00
  br label %.lr.ph8.us

.lr.ph8.us:                                       ; preds = %._crit_edge9.us-lcssa.us.us, %.lr.ph14.split.us.preheader
  %indvars.iv75 = phi i64 [ 0, %.lr.ph14.split.us.preheader ], [ %indvars.iv.next76, %._crit_edge9.us-lcssa.us.us ]
  br label %.lr.ph.us.us

._crit_edge9.us-lcssa.us.us:                      ; preds = %._crit_edge.us.us
  %indvars.iv.next76 = add nuw nsw i64 %indvars.iv75, 1
  %exitcond105 = icmp eq i64 %indvars.iv.next76, 1200
  br i1 %exitcond105, label %._crit_edge15, label %.lr.ph8.us

.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph8.us
  %indvars.iv67 = phi i64 [ %indvars.iv75, %.lr.ph8.us ], [ %indvars.iv.next68, %._crit_edge.us.us ]
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv75, i64 %indvars.iv67
...
._crit_edge.us.us:                                ; preds = %._crit_edge22
  ...
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv67, i64 %indvars.iv75
  store double %62, double* %63, align 8
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  %exitcond104 = icmp eq i64 %indvars.iv.next68, 1200
  br i1 %exitcond104, label %._crit_edge9.us-lcssa.us.us, label %.lr.ph.us.us

._crit_edge22:                                    ; preds = %._crit_edge22, %.lr.ph.us.us
  %64 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %76, %._crit_edge22 ]
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %._crit_edge22 ]
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv75
  %66 = load double, double* %65, align 8
  %67 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv67
  %68 = load double, double* %67, align 8
  %69 = fmul double %66, %68
  %70 = fadd double %64, %69
  store double %70, double* %61, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv75
  %72 = load double, double* %71, align 8
  %73 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv67
  ...
  br i1 %exitcond.1, label %._crit_edge.us.us, label %._crit_edge22

._crit_edge15:                                    ; preds = %._crit_edge9.us-lcssa.us.us
  ret void
}
...
.lr.ph3.split.us:                                 ; preds = %._crit_edge.us, %.lr.ph3.split.us.preheader
  ...
  %5 = mul nuw nsw i64 %indvars.iv11, 1200
  br label %._crit_edge2

._crit_edge2:                                     ; preds = %._crit_edge, %.lr.ph3.split.us
