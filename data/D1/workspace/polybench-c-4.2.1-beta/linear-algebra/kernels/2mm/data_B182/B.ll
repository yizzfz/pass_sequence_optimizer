...
._crit_edge26:                                    ; preds = %14, %6
  %indvars.iv19 = phi i64 [ 0, %6 ], [ %indvars.iv.next20, %14 ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge26
  %indvars.iv16 = phi i64 [ 0, %._crit_edge26 ], [ %indvars.iv.next17, %._crit_edge ]
...
; <label>:14:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond21, label %.preheader2.preheader, label %._crit_edge26

.preheader2.preheader:                            ; preds = %14
  br label %.preheader2

.preheader2:                                      ; preds = %.preheader2.preheader, %28
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %28 ], [ 0, %.preheader2.preheader ]
  br label %._crit_edge27

._crit_edge27:                                    ; preds = %._crit_edge27, %.preheader2
  %indvars.iv10 = phi i64 [ 0, %.preheader2 ], [ %indvars.iv.next11.1, %._crit_edge27 ]
  ...
  br i1 %exitcond12.1, label %28, label %._crit_edge27

; <label>:28:                                     ; preds = %._crit_edge27
...
.preheader1:                                      ; preds = %.preheader1.preheader, %37
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %37 ], [ 0, %.preheader1.preheader ]
  br label %._crit_edge28

._crit_edge28:                                    ; preds = %._crit_edge28, %.preheader1
  %indvars.iv4 = phi i64 [ 0, %.preheader1 ], [ %indvars.iv.next5, %._crit_edge28 ]
  ...
  br i1 %exitcond6, label %37, label %._crit_edge28

; <label>:37:                                     ; preds = %._crit_edge28
...
._crit_edge29:                                    ; preds = %._crit_edge29, %.preheader
  ...
  br i1 %exitcond, label %45, label %._crit_edge29

; <label>:45:                                     ; preds = %._crit_edge29
...
._crit_edge23:                                    ; preds = %25, %7
  %indvars.iv13 = phi i64 [ 0, %7 ], [ %indvars.iv.next14, %25 ]
  br label %._crit_edge22

._crit_edge22:                                    ; preds = %24, %._crit_edge23
  %indvars.iv10 = phi i64 [ 0, %._crit_edge23 ], [ %indvars.iv.next11, %24 ]
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge22
  %indvars.iv7 = phi i64 [ 0, %._crit_edge22 ], [ %indvars.iv.next8.1, %._crit_edge ]
  %9 = phi double [ 0.000000e+00, %._crit_edge22 ], [ %23, %._crit_edge ]
...
; <label>:24:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond12, label %25, label %._crit_edge22

; <label>:25:                                     ; preds = %24
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 800
  br i1 %exitcond15, label %._crit_edge26.preheader, label %._crit_edge23

._crit_edge26.preheader:                          ; preds = %25
  br label %._crit_edge26

._crit_edge26:                                    ; preds = %._crit_edge26.preheader, %49
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %49 ], [ 0, %._crit_edge26.preheader ]
  br label %._crit_edge25

._crit_edge25:                                    ; preds = %48, %._crit_edge26
  %indvars.iv1 = phi i64 [ 0, %._crit_edge26 ], [ %indvars.iv.next2, %48 ]
...
._crit_edge24:                                    ; preds = %._crit_edge24, %._crit_edge25
  %indvars.iv = phi i64 [ 0, %._crit_edge25 ], [ %indvars.iv.next.2, %._crit_edge24 ]
  %29 = phi double [ %28, %._crit_edge25 ], [ %47, %._crit_edge24 ]
  ...
  br i1 %exitcond.2, label %48, label %._crit_edge24

; <label>:48:                                     ; preds = %._crit_edge24
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 1200
  br i1 %exitcond3, label %49, label %._crit_edge25

; <label>:49:                                     ; preds = %48
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1
  %exitcond6 = icmp eq i64 %indvars.iv.next5, 800
  br i1 %exitcond6, label %50, label %._crit_edge26
