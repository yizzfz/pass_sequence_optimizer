...
@__llvm_prf_nm = private constant [115 x i8] c"q\00TIFFVGetFieldDefaulted\01tmp1.ll:TIFFDefaultTransferFunction\01tmp1.ll:TIFFDefaultRefBlackWhite\01TIFFGetFieldDefaulted", section "__llvm_prf_names"
@llvm.used = appending global [5 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_TIFFVGetFieldDefaulted to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_TIFFDefaultTransferFunction to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_TIFFDefaultRefBlackWhite to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_TIFFGetFieldDefaulted to i8*), i8* getelementptr inbounds ([115 x i8], [115 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
