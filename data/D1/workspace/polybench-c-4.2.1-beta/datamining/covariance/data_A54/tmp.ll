...
.lr.ph42.split.us.preheader:
  %sunkaddr = ptrtoint double* %5 to i64
  %sunkaddr107 = ptrtoint double* %5 to i64
  br label %.lr.ph42.split.us

.lr.ph42.split.us:                                ; preds = %._crit_edge38.us, %.lr.ph42.split.us.preheader
  %indvars.iv73 = phi i64 [ 0, %.lr.ph42.split.us.preheader ], [ %indvars.iv.next74, %._crit_edge38.us ]
  %6 = getelementptr inbounds double, double* %5, i64 %indvars.iv73
  store double 0.000000e+00, double* %6, align 8
  %sunkaddr84 = shl i64 %indvars.iv73, 3
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph42.split.us
  %indvars.iv70 = phi i64 [ 0, %.lr.ph42.split.us ], [ %indvars.iv.next71.4, %._crit_edge ]
  %7 = phi double [ 0.000000e+00, %.lr.ph42.split.us ], [ %22, %._crit_edge ]
  %8 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv70, i64 %indvars.iv73
  %9 = load double, double* %8, align 8
  %10 = fadd double %7, %9
  store double %10, double* %sunkaddr86, align 8
  %indvars.iv.next71 = add nuw nsw i64 %indvars.iv70, 1
  %11 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next71, i64 %indvars.iv73
  %12 = load double, double* %11, align 8
  %13 = fadd double %10, %12
  store double %13, double* %sunkaddr86, align 8
  ...
  store double %16, double* %sunkaddr86, align 8
  ...
  store double %19, double* %sunkaddr86, align 8
  ...
  br i1 %exitcond72.4, label %._crit_edge38.us, label %._crit_edge

._crit_edge38.us:                                 ; preds = %._crit_edge
  %23 = fdiv double %22, %2
  %sunkaddr108 = shl i64 %indvars.iv73, 3
  %sunkaddr109 = add i64 %sunkaddr107, %sunkaddr108
  %sunkaddr110 = inttoptr i64 %sunkaddr109 to double*
  store double %23, double* %sunkaddr110, align 8
  %indvars.iv.next74 = add nuw nsw i64 %indvars.iv73, 1
  %exitcond75 = icmp eq i64 %indvars.iv.next74, 1200
  br i1 %exitcond75, label %._crit_edge38.us..preheader6.us_crit_edge, label %.lr.ph42.split.us

._crit_edge38.us..preheader6.us_crit_edge:        ; preds = %._crit_edge38.us
  %scevgep95 = getelementptr double, double* %5, i64 1200
  br label %.preheader6.us

.preheader6.us:                                   ; preds = %._crit_edge33.us, %._crit_edge38.us..preheader6.us_crit_edge
  %indvars.iv66 = phi i64 [ 0, %._crit_edge38.us..preheader6.us_crit_edge ], [ %24, %._crit_edge33.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %3, i64 %indvars.iv66, i64 0
  %24 = add nuw nsw i64 %indvars.iv66, 1
  %scevgep93 = getelementptr [1200 x double], [1200 x double]* %3, i64 %24, i64 0
  %bound0 = icmp ult double* %scevgep, %scevgep95
  %bound1 = icmp ugt double* %scevgep93, %5
  %memcheck.conflict = and i1 %bound0, %bound1
  br i1 %memcheck.conflict, label %._crit_edge80.preheader, label %vector.body.preheader

vector.body.preheader:                            ; preds = %.preheader6.us
  br label %vector.body

._crit_edge80.preheader:                          ; preds = %.preheader6.us
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.vec100 = load <8 x double>, <8 x double>* %28, align 8, !alias.scope !4, !noalias !1
  %29 = fsub <8 x double> %wide.vec100, %wide.vec
  ...
  br i1 %40, label %._crit_edge33.us.loopexit111, label %vector.body, !llvm.loop !6

._crit_edge80:                                    ; preds = %._crit_edge80.preheader, %._crit_edge80
  %indvars.iv63 = phi i64 [ %indvars.iv.next64.3, %._crit_edge80 ], [ 0, %._crit_edge80.preheader ]
  ...
  br i1 %exitcond65.3, label %._crit_edge33.us.loopexit, label %._crit_edge80, !llvm.loop !9

._crit_edge33.us.loopexit:                        ; preds = %._crit_edge80
  br label %._crit_edge33.us

._crit_edge33.us.loopexit111:                     ; preds = %vector.body
  br label %._crit_edge33.us

._crit_edge33.us:                                 ; preds = %._crit_edge33.us.loopexit111, %._crit_edge33.us.loopexit
...
._crit_edge.us.us:                                ; preds = %._crit_edge81
...
._crit_edge81:                                    ; preds = %._crit_edge81, %.lr.ph.us.us
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %._crit_edge81 ]
  %65 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %77, %._crit_edge81 ]
  ...
  br i1 %exitcond.1, label %._crit_edge.us.us, label %._crit_edge81
