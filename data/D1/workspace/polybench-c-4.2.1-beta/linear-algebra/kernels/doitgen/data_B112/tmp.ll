...
.lr.ph18:                                         ; preds = %20
  br i1 %12, label %.lr.ph.us.us.preheader.preheader, label %._crit_edge15.preheader

._crit_edge15.preheader:                          ; preds = %.lr.ph18
  br i1 %lcmp.mod94, label %._crit_edge15.prol.loopexit, label %._crit_edge15.prol.preheader

._crit_edge15.prol.preheader:                     ; preds = %._crit_edge15.preheader
  br label %._crit_edge15.prol

._crit_edge15.prol:                               ; preds = %._crit_edge15.prol, %._crit_edge15.prol.preheader
  %indvars.iv53.prol = phi i64 [ %indvars.iv.next54.prol, %._crit_edge15.prol ], [ 0, %._crit_edge15.prol.preheader ]
  %prol.iter = phi i64 [ %prol.iter.sub, %._crit_edge15.prol ], [ %xtraiter93, %._crit_edge15.prol.preheader ]
  %indvars.iv.next54.prol = add nuw nsw i64 %indvars.iv53.prol, 1
  %prol.iter.sub = add i64 %prol.iter, -1
  %prol.iter.cmp = icmp eq i64 %prol.iter.sub, 0
  br i1 %prol.iter.cmp, label %._crit_edge15.prol.loopexit.unr-lcssa, label %._crit_edge15.prol, !llvm.loop !1

._crit_edge15.prol.loopexit.unr-lcssa:            ; preds = %._crit_edge15.prol
  br label %._crit_edge15.prol.loopexit

._crit_edge15.prol.loopexit:                      ; preds = %._crit_edge15.preheader, %._crit_edge15.prol.loopexit.unr-lcssa
  %indvars.iv53.unr = phi i64 [ 0, %._crit_edge15.preheader ], [ %indvars.iv.next54.prol, %._crit_edge15.prol.loopexit.unr-lcssa ]
  br i1 %19, label %._crit_edge19.loopexit90, label %._crit_edge15.preheader.new

._crit_edge15.preheader.new:                      ; preds = %._crit_edge15.prol.loopexit
  br label %._crit_edge15

.lr.ph.us.us.preheader.preheader:                 ; preds = %.lr.ph18
  br label %.lr.ph.us.us.preheader

.lr.ph.us.us.preheader:                           ; preds = %._crit_edge15.us, %.lr.ph.us.us.preheader.preheader
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %._crit_edge15.us ], [ 0, %.lr.ph.us.us.preheader.preheader ]
...
._crit_edge15.us:                                 ; preds = %._crit_edge15.us.loopexit, %middle.block
  ...
  %exitcond91 = icmp eq i64 %indvars.iv.next68, %9
  br i1 %exitcond91, label %._crit_edge19.loopexit, label %.lr.ph.us.us.preheader

.lr.ph14.us:                                      ; preds = %.lr.ph14.us.preheader89, %.lr.ph14.us
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %.lr.ph14.us ], [ %indvars.iv65.ph, %.lr.ph14.us.preheader89 ]
  ...
  %26 = icmp slt i64 %indvars.iv.next66, %8
  br i1 %26, label %.lr.ph14.us, label %._crit_edge15.us.loopexit, !llvm.loop !3
...
.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph.us.us.preheader
  ...
  %27 = getelementptr inbounds double, double* %5, i64 %indvars.iv61
  store double 0.000000e+00, double* %27, align 8
  br i1 %lcmp.mod, label %.prol.loopexit.unr-lcssa, label %.prol.preheader

.prol.preheader:                                  ; preds = %.lr.ph.us.us
  %28 = load double, double* %scevgep, align 8
  %29 = getelementptr inbounds [160 x double], [160 x double]* %4, i64 0, i64 %indvars.iv61
  %30 = load double, double* %29, align 8
  %31 = fmul double %28, %30
  %32 = fadd double %31, 0.000000e+00
  %sunkaddr73 = shl i64 %indvars.iv61, 3
  %sunkaddr74 = add i64 %sunkaddr76, %sunkaddr73
  %sunkaddr75 = inttoptr i64 %sunkaddr74 to double*
  store double %32, double* %sunkaddr75, align 8
  br label %.prol.loopexit.unr-lcssa

.prol.loopexit.unr-lcssa:                         ; preds = %.lr.ph.us.us, %.prol.preheader
  %33 = phi double [ %32, %.prol.preheader ], [ 0.000000e+00, %.lr.ph.us.us ]
...
.lr.ph.us.us.new.preheader:                       ; preds = %.prol.loopexit.unr-lcssa
  %sunkaddr77 = shl i64 %indvars.iv61, 3
...
._crit_edge.us.us:                                ; preds = %._crit_edge.us.us.loopexit, %.prol.loopexit.unr-lcssa
  %wide.trip.count63.pre-phi = phi i64 [ 1, %.prol.loopexit.unr-lcssa ], [ %wide.trip.count59, %._crit_edge.us.us.loopexit ]
  %indvars.iv.next62 = add nuw nsw i64 %indvars.iv61, 1
  %exitcond64 = icmp eq i64 %indvars.iv.next62, %wide.trip.count63.pre-phi
  br i1 %exitcond64, label %.lr.ph14.us.preheader, label %.lr.ph.us.us

.lr.ph14.us.preheader:                            ; preds = %._crit_edge.us.us
  %scevgep83 = getelementptr [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv69, i64 %indvars.iv67, i64 %8
  br i1 %min.iters.check, label %.lr.ph14.us.preheader89, label %min.iters.checked

.lr.ph14.us.preheader89:                          ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.lr.ph14.us.preheader
...
min.iters.checked:                                ; preds = %.lr.ph14.us.preheader
  br i1 %cmp.zero, label %.lr.ph14.us.preheader89, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %bound0 = icmp ult double* %scevgep, %scevgep85
  %bound1 = icmp ugt double* %scevgep83, %5
  %memcheck.conflict = and i1 %bound0, %bound1
  br i1 %memcheck.conflict, label %.lr.ph14.us.preheader89, label %vector.body.preheader
...
vector.body.prol:                                 ; preds = %vector.body.prol, %vector.body.prol.preheader
  ...
  %wide.load88.prol = load <2 x i64>, <2 x i64>* %37, align 8, !alias.scope !6
  %38 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv69, i64 %indvars.iv67, i64 %index.prol
  ...
  store <2 x i64> %wide.load88.prol, <2 x i64>* %41, align 8, !alias.scope !9, !noalias !6
  %index.next.prol = add i64 %index.prol, 4
  %prol.iter97.sub = add i64 %prol.iter97, -1
  %prol.iter97.cmp = icmp eq i64 %prol.iter97.sub, 0
  br i1 %prol.iter97.cmp, label %vector.body.prol.loopexit.unr-lcssa, label %vector.body.prol, !llvm.loop !11
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader.new
  ...
  %wide.load88 = load <2 x i64>, <2 x i64>* %45, align 8, !alias.scope !6
  %46 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv69, i64 %indvars.iv67, i64 %index
  ...
  store <2 x i64> %wide.load88, <2 x i64>* %49, align 8, !alias.scope !9, !noalias !6
  ...
  %wide.load88.1 = load <2 x i64>, <2 x i64>* %53, align 8, !alias.scope !6
  %54 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv69, i64 %indvars.iv67, i64 %index.next
  ...
  store <2 x i64> %wide.load88.1, <2 x i64>* %57, align 8, !alias.scope !9, !noalias !6
  ...
  %wide.load88.2 = load <2 x i64>, <2 x i64>* %61, align 8, !alias.scope !6
  %62 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv69, i64 %indvars.iv67, i64 %index.next.1
  ...
  store <2 x i64> %wide.load88.2, <2 x i64>* %65, align 8, !alias.scope !9, !noalias !6
  ...
  %wide.load88.3 = load <2 x i64>, <2 x i64>* %69, align 8, !alias.scope !6
  %70 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv69, i64 %indvars.iv67, i64 %index.next.2
  ...
  store <2 x i64> %wide.load88.3, <2 x i64>* %73, align 8, !alias.scope !9, !noalias !6
...
middle.block:                                     ; preds = %vector.body.prol.loopexit, %middle.block.unr-lcssa
  br i1 %cmp.n, label %._crit_edge15.us, label %.lr.ph14.us.preheader89

.lr.ph.us.us.new:                                 ; preds = %.lr.ph.us.us.new.preheader, %.lr.ph.us.us.new
  %75 = phi double [ %87, %.lr.ph.us.us.new ], [ %33, %.lr.ph.us.us.new.preheader ]
...
._crit_edge15:                                    ; preds = %._crit_edge15, %._crit_edge15.preheader.new
  %indvars.iv53 = phi i64 [ %indvars.iv53.unr, %._crit_edge15.preheader.new ], [ %indvars.iv.next54.7, %._crit_edge15 ]
  %indvars.iv.next54.7 = add nsw i64 %indvars.iv53, 8
  %exitcond.7 = icmp eq i64 %indvars.iv.next54.7, %9
  br i1 %exitcond.7, label %._crit_edge19.loopexit90.unr-lcssa, label %._crit_edge15

._crit_edge19.loopexit:                           ; preds = %._crit_edge15.us
  br label %._crit_edge19

._crit_edge19.loopexit90.unr-lcssa:               ; preds = %._crit_edge15
  br label %._crit_edge19.loopexit90

._crit_edge19.loopexit90:                         ; preds = %._crit_edge15.prol.loopexit, %._crit_edge19.loopexit90.unr-lcssa
  br label %._crit_edge19

._crit_edge19:                                    ; preds = %._crit_edge19.loopexit90, %._crit_edge19.loopexit, %20
  %indvars.iv.next70 = add nuw nsw i64 %indvars.iv69, 1
  %exitcond92 = icmp eq i64 %indvars.iv.next70, %10
  br i1 %exitcond92, label %._crit_edge37.loopexit, label %20
...
.lr.ph15.us.us.preheader:                         ; preds = %._crit_edge20.us, %.lr.ph26.split.us.preheader
  %indvars.iv61 = phi i64 [ 0, %.lr.ph26.split.us.preheader ], [ %indvars.iv.next62, %._crit_edge20.us ]
  br label %.lr.ph15.us.us

._crit_edge20.us:                                 ; preds = %._crit_edge16.us.us
  %indvars.iv.next62 = add nuw nsw i64 %indvars.iv61, 1
  %exitcond2 = icmp eq i64 %indvars.iv.next62, 150
  br i1 %exitcond2, label %.lr.ph7.split.us.preheader, label %.lr.ph15.us.us.preheader
...
.lr.ph15.us.us:                                   ; preds = %._crit_edge16.us.us, %.lr.ph15.us.us.preheader
  %indvars.iv57 = phi i64 [ 0, %.lr.ph15.us.us.preheader ], [ %indvars.iv.next58, %._crit_edge16.us.us ]
...
.lr.ph.us.us.preheader:                           ; preds = %._crit_edge6.us, %.lr.ph12.split.us.preheader
  %indvars.iv39 = phi i64 [ 0, %.lr.ph12.split.us.preheader ], [ %indvars.iv.next40, %._crit_edge6.us ]
...
.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph.us.us.preheader
  %indvars.iv35 = phi i64 [ 0, %.lr.ph.us.us.preheader ], [ %indvars.iv.next36, %._crit_edge.us.us ]
