...
for.body32.preheader:                             ; preds = %for.end27
  ...
  br i1 %min.iters.check, label %for.body32.preheader223, label %min.iters.checked

min.iters.checked:                                ; preds = %for.body32.preheader
  %n.vec = and i64 %26, -4
  %cmp.zero = icmp eq i64 %n.vec, 0
  %ind.end = add nsw i64 %28, %n.vec
  br i1 %cmp.zero, label %for.body32.preheader223, label %vector.body.preheader

vector.body.preheader:                            ; preds = %min.iters.checked
  %xtraiter229 = and i64 %23, 3
  %lcmp.mod230 = icmp eq i64 %xtraiter229, 0
  br i1 %lcmp.mod230, label %vector.body.prol.loopexit, label %vector.body.prol.preheader
...
vector.body.prol:                                 ; preds = %vector.body.prol, %vector.body.prol.preheader
  ...
  %prol.iter231 = phi i64 [ %prol.iter231.sub, %vector.body.prol ], [ %xtraiter229, %vector.body.prol.preheader ]
  %offset.idx.prol = add i64 %28, %index.prol
  %31 = getelementptr inbounds [2000 x double], [2000 x double]* %13, i64 %indvars.iv114, i64 %offset.idx.prol
  ...
  br i1 %prol.iter231.cmp, label %vector.body.prol.loopexit.loopexit, label %vector.body.prol, !llvm.loop !1
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader.new
  ...
  %36 = getelementptr inbounds [2000 x double], [2000 x double]* %13, i64 %indvars.iv114, i64 %offset.idx
  ...
  %40 = getelementptr inbounds [2000 x double], [2000 x double]* %13, i64 %indvars.iv114, i64 %offset.idx.1
  ...
  %44 = getelementptr inbounds [2000 x double], [2000 x double]* %13, i64 %indvars.iv114, i64 %offset.idx.2
  ...
  %48 = getelementptr inbounds [2000 x double], [2000 x double]* %13, i64 %indvars.iv114, i64 %offset.idx.3
...
middle.block:                                     ; preds = %middle.block.loopexit, %vector.body.prol.loopexit
  ...
  br i1 %cmp.n, label %for.end39, label %for.body32.preheader223

for.body32.preheader223:                          ; preds = %middle.block, %min.iters.checked, %for.body32.preheader
  %indvars.iv110.ph = phi i64 [ %28, %min.iters.checked ], [ %28, %for.body32.preheader ], [ %ind.end, %middle.block ]
  br label %for.body32

for.body32:                                       ; preds = %for.body32.preheader223, %for.body32
  %indvars.iv110 = phi i64 [ %indvars.iv.next111, %for.body32 ], [ %indvars.iv110.ph, %for.body32.preheader223 ]
...
for.cond9.for.end46_crit_edge:                    ; preds = %for.end39
  %53 = trunc i64 %indvars.iv.next115 to i32
...
for.cond51.preheader.lr.ph.for.cond51.preheader.us_crit_edge: ; preds = %for.cond51.preheader.lr.ph
  ...
  %59 = add i32 %56, -1
  %60 = sext i32 %r.promoted66 to i64
...
for.inc62.us:                                     ; preds = %for.inc62.us, %for.cond51.preheader.lr.ph.for.cond51.preheader.us_crit_edge
  %indvars.iv98 = phi i64 [ %indvars.iv.next99, %for.inc62.us ], [ %60, %for.cond51.preheader.lr.ph.for.cond51.preheader.us_crit_edge ]
  %indvar = phi i64 [ %indvar.next, %for.inc62.us ], [ 0, %for.cond51.preheader.lr.ph.for.cond51.preheader.us_crit_edge ]
  %64 = add nsw i64 %60, %indvar
  ...
  call void @llvm.memset.p0i8.i64(i8* %scevgep97, i8 0, i64 %63, i32 8, i1 false)
  %indvars.iv.next99 = add nsw i64 %indvars.iv98, 1
  %cmp48.us = icmp slt i64 %indvars.iv.next99, %57
...
for.cond65.preheader:                             ; preds = %for.cond65.preheader.loopexit, %for.cond51.preheader.lr.ph
  %inc60.lcssa69.lcssa = phi i32 [ 0, %for.cond51.preheader.lr.ph ], [ %56, %for.cond65.preheader.loopexit ]
...
for.cond69.preheader.lr.ph:                       ; preds = %for.cond65.preheader
  ...
  %cmp7411 = icmp sgt i32 %65, 0
  %67 = load [2000 x double]*, [2000 x double]** %A.addr, align 8
...
for.cond69.preheader.lr.ph.for.cond69.preheader.us_crit_edge: ; preds = %for.cond69.preheader.lr.ph
  ...
  %min.iters.check152 = icmp ult i64 %72, 4
  %n.vec155 = and i64 %72, 8589934588
  %cmp.zero156 = icmp eq i64 %n.vec155, 0
  %cmp.n178 = icmp eq i64 %72, %n.vec155
...
for.cond69.preheader.us:                          ; preds = %for.inc96.us, %for.cond69.preheader.lr.ph.for.cond69.preheader.us_crit_edge
  %indvar164 = phi i64 [ %indvar.next165, %for.inc96.us ], [ 0, %for.cond69.preheader.lr.ph.for.cond69.preheader.us_crit_edge ]
  %indvars.iv90 = phi i64 [ %indvars.iv.next91, %for.inc96.us ], [ %69, %for.cond69.preheader.lr.ph.for.cond69.preheader.us_crit_edge ]
  ...
  %75 = add nsw i64 %69, %indvar164
  %scevgep166 = getelementptr [2000 x double], [2000 x double]* %67, i64 0, i64 %75
  %76 = add nsw i64 %73, %indvar164
  %scevgep168 = getelementptr [2000 x double], [2000 x double]* %67, i64 %71, i64 %76
  %cmp7012.us = icmp slt i32 %inc94.lcssa34.us, %65
...
for.cond73.preheader.lr.ph.us:                    ; preds = %for.cond69.preheader.us
  %77 = sext i32 %inc94.lcssa34.us to i64
...
for.inc96.us:                                     ; preds = %for.inc96.us.loopexit, %for.cond69.preheader.us
  %inc91.lcssa32.lcssa37.us = phi i32 [ %inc91.lcssa32.lcssa36.us, %for.cond69.preheader.us ], [ %65, %for.inc96.us.loopexit ]
  %indvars.iv.next91 = add nsw i64 %indvars.iv90, 1
  %cmp66.us = icmp slt i64 %indvars.iv.next91, %66
...
for.inc96.us.for.cond65.for.cond99.preheader_crit_edge_crit_edge: ; preds = %for.inc96.us
  %78 = trunc i64 %indvars.iv.next91 to i32
...
for.cond73.preheader.us.us:                       ; preds = %for.inc93.us.us, %for.cond73.preheader.lr.ph.us
  %indvar158 = phi i64 [ %indvar.next159, %for.inc93.us.us ], [ 0, %for.cond73.preheader.lr.ph.us ]
  %indvars.iv88 = phi i64 [ %indvars.iv.next89, %for.inc93.us.us ], [ %77, %for.cond73.preheader.lr.ph.us ]
  %79 = add i64 %77, %indvar158
  %scevgep160 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %68, i64 0, i64 %79, i64 0
  %scevgep162 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %68, i64 0, i64 %79, i64 %72
  %arrayidx80.us.us = getelementptr inbounds [2000 x double], [2000 x double]* %67, i64 %indvars.iv88, i64 %indvars.iv90
...
for.body76.us.us.preheader:                       ; preds = %middle.block150, %vector.memcheck, %min.iters.checked153, %for.cond73.preheader.us.us
  %indvars.iv84.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %min.iters.checked153 ], [ 0, %for.cond73.preheader.us.us ], [ %n.vec155, %middle.block150 ]
  %80 = sub nsw i64 %74, %indvars.iv84.ph
  %xtraiter227 = and i64 %80, 1
  %lcmp.mod228 = icmp eq i64 %xtraiter227, 0
  br i1 %lcmp.mod228, label %for.body76.us.us.prol.loopexit, label %for.body76.us.us.prol

for.body76.us.us.prol:                            ; preds = %for.body76.us.us.preheader
  %81 = load double, double* %arrayidx80.us.us, align 8
  %arrayidx84.us.us.prol = getelementptr inbounds [2000 x double], [2000 x double]* %67, i64 %indvars.iv84.ph, i64 %indvars.iv90
  %82 = load double, double* %arrayidx84.us.us.prol, align 8
  %mul.us.us.prol = fmul double %81, %82
  %arrayidx88.us.us.prol = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %68, i64 0, i64 %indvars.iv88, i64 %indvars.iv84.ph
  %83 = load double, double* %arrayidx88.us.us.prol, align 8
  %add89.us.us.prol = fadd double %mul.us.us.prol, %83
...
for.body76.us.us.prol.loopexit:                   ; preds = %for.body76.us.us.prol, %for.body76.us.us.preheader
  ...
  %84 = icmp eq i64 %71, %indvars.iv84.ph
  br i1 %84, label %for.inc93.us.us, label %for.body76.us.us.preheader.new
...
vector.memcheck:                                  ; preds = %min.iters.checked153
  %bound0 = icmp ult double* %scevgep160, %scevgep168
  %bound1 = icmp ult double* %scevgep166, %scevgep162
  %found.conflict = and i1 %bound0, %bound1
  %bound0171 = icmp ult double* %scevgep160, %arrayidx80.us.us
  %bound1172 = icmp ult double* %arrayidx80.us.us, %scevgep162
...
vector.body149:                                   ; preds = %vector.body149.preheader, %vector.body149
  %index175 = phi i64 [ %index.next176, %vector.body149 ], [ 0, %vector.body149.preheader ]
  %85 = or i64 %index175, 1
  %86 = or i64 %index175, 2
  %87 = or i64 %index175, 3
  %88 = load double, double* %arrayidx80.us.us, align 8, !alias.scope !8
  %89 = insertelement <2 x double> undef, double %88, i32 0
  %90 = shufflevector <2 x double> %89, <2 x double> undef, <2 x i32> zeroinitializer
  %91 = insertelement <2 x double> undef, double %88, i32 0
  %92 = shufflevector <2 x double> %91, <2 x double> undef, <2 x i32> zeroinitializer
  %93 = getelementptr inbounds [2000 x double], [2000 x double]* %67, i64 %index175, i64 %indvars.iv90
  %94 = getelementptr inbounds [2000 x double], [2000 x double]* %67, i64 %85, i64 %indvars.iv90
  %95 = getelementptr inbounds [2000 x double], [2000 x double]* %67, i64 %86, i64 %indvars.iv90
  %96 = getelementptr inbounds [2000 x double], [2000 x double]* %67, i64 %87, i64 %indvars.iv90
  %97 = load double, double* %93, align 8, !alias.scope !11
  %98 = load double, double* %94, align 8, !alias.scope !11
  ...
  %105 = fmul <2 x double> %90, %102
  %106 = fmul <2 x double> %92, %104
  %107 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %68, i64 0, i64 %indvars.iv88, i64 %index175
  %108 = bitcast double* %107 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %108, align 8, !alias.scope !13, !noalias !15
  %109 = getelementptr double, double* %107, i64 2
  %110 = bitcast double* %109 to <2 x double>*
  %wide.load183 = load <2 x double>, <2 x double>* %110, align 8, !alias.scope !13, !noalias !15
  %111 = fadd <2 x double> %105, %wide.load
  %112 = fadd <2 x double> %106, %wide.load183
  %113 = bitcast double* %107 to <2 x double>*
  store <2 x double> %111, <2 x double>* %113, align 8, !alias.scope !13, !noalias !15
  %114 = bitcast double* %109 to <2 x double>*
  store <2 x double> %112, <2 x double>* %114, align 8, !alias.scope !13, !noalias !15
  %index.next176 = add i64 %index175, 4
  %115 = icmp eq i64 %index.next176, %n.vec155
  br i1 %115, label %middle.block150, label %vector.body149, !llvm.loop !16

middle.block150:                                  ; preds = %vector.body149
  br i1 %cmp.n178, label %for.inc93.us.us, label %for.body76.us.us.preheader
...
for.inc93.us.us:                                  ; preds = %for.inc93.us.us.loopexit, %for.body76.us.us.prol.loopexit, %middle.block150
  ...
  %exitcond130 = icmp eq i64 %indvars.iv.next89, %66
  %indvar.next159 = add i64 %indvar158, 1
...
for.body76.us.us:                                 ; preds = %for.body76.us.us, %for.body76.us.us.preheader.new
  ...
  %116 = load double, double* %arrayidx80.us.us, align 8
  %arrayidx84.us.us = getelementptr inbounds [2000 x double], [2000 x double]* %67, i64 %indvars.iv84, i64 %indvars.iv90
  %117 = load double, double* %arrayidx84.us.us, align 8
  %mul.us.us = fmul double %116, %117
  %arrayidx88.us.us = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %68, i64 0, i64 %indvars.iv88, i64 %indvars.iv84
  %118 = load double, double* %arrayidx88.us.us, align 8
  %add89.us.us = fadd double %mul.us.us, %118
  store double %add89.us.us, double* %arrayidx88.us.us, align 8
  %indvars.iv.next85 = add nuw nsw i64 %indvars.iv84, 1
  %119 = load double, double* %arrayidx80.us.us, align 8
  %arrayidx84.us.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %67, i64 %indvars.iv.next85, i64 %indvars.iv90
  %120 = load double, double* %arrayidx84.us.us.1, align 8
  %mul.us.us.1 = fmul double %119, %120
  %arrayidx88.us.us.1 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %68, i64 0, i64 %indvars.iv88, i64 %indvars.iv.next85
  %121 = load double, double* %arrayidx88.us.us.1, align 8
  %add89.us.us.1 = fadd double %mul.us.us.1, %121
  store double %add89.us.us.1, double* %arrayidx88.us.us.1, align 8
  %exitcond.1 = icmp eq i64 %indvars.iv.next85, %71
...
for.cond65.for.cond99.preheader_crit_edge:        ; preds = %for.cond65.for.cond99.preheader_crit_edge.loopexit, %for.inc96.us.for.cond65.for.cond99.preheader_crit_edge_crit_edge
  ...
  %inc97.lcssa = phi i32 [ %78, %for.inc96.us.for.cond65.for.cond99.preheader_crit_edge_crit_edge ], [ %inc97, %for.cond65.for.cond99.preheader_crit_edge.loopexit ]
  store i32 0, i32* %r, align 4
...
for.cond103.preheader.lr.ph:                      ; preds = %for.cond99.preheader
  ...
  %cmp1049 = icmp sgt i32 %124, 0
  %126 = load [2000 x [2000 x double]]*, [2000 x [2000 x double]]** %B, align 8
  %127 = load [2000 x double]*, [2000 x double]** %A.addr, align 8
  %r.promoted = load i32, i32* %r, align 4
  %128 = sext i32 %r.promoted to i64
...
for.cond103.preheader.lr.ph.for.cond103.preheader.us_crit_edge: ; preds = %for.cond103.preheader.lr.ph
  ...
  %132 = and i64 %131, 8589934588
  %133 = add nsw i64 %132, -4
  %134 = lshr exact i64 %133, 2
  %135 = add nuw nsw i64 %130, 1
  %min.iters.check187 = icmp ult i64 %131, 4
  %n.vec190 = and i64 %131, 8589934588
  %cmp.zero191 = icmp eq i64 %n.vec190, 0
  %136 = and i64 %134, 1
  %lcmp.mod = icmp eq i64 %136, 0
  %137 = icmp eq i64 %134, 0
  %cmp.n212 = icmp eq i64 %131, %n.vec190
...
for.cond103.preheader.us:                         ; preds = %for.inc118.us, %for.cond103.preheader.lr.ph.for.cond103.preheader.us_crit_edge
  %indvar193 = phi i64 [ %indvar.next194, %for.inc118.us ], [ 0, %for.cond103.preheader.lr.ph.for.cond103.preheader.us_crit_edge ]
  %indvars.iv82 = phi i64 [ %indvars.iv.next83, %for.inc118.us ], [ %128, %for.cond103.preheader.lr.ph.for.cond103.preheader.us_crit_edge ]
  %138 = add nsw i64 %128, %indvar193
  %scevgep195 = getelementptr [2000 x double], [2000 x double]* %127, i64 %138, i64 0
  %scevgep197 = getelementptr [2000 x double], [2000 x double]* %127, i64 %138, i64 %131
  %scevgep199 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %126, i64 0, i64 %138, i64 0
  %scevgep201 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %126, i64 0, i64 %138, i64 %131
  br i1 %min.iters.check187, label %for.body106.us.preheader, label %min.iters.checked188

min.iters.checked188:                             ; preds = %for.cond103.preheader.us
  br i1 %cmp.zero191, label %for.body106.us.preheader, label %vector.memcheck207

vector.memcheck207:                               ; preds = %min.iters.checked188
  %bound0203 = icmp ult double* %scevgep195, %scevgep201
  %bound1204 = icmp ult double* %scevgep199, %scevgep197
  %memcheck.conflict206 = and i1 %bound0203, %bound1204
  br i1 %memcheck.conflict206, label %for.body106.us.preheader, label %vector.body184.preheader

vector.body184.preheader:                         ; preds = %vector.memcheck207
  br i1 %lcmp.mod, label %vector.body184.prol, label %vector.body184.prol.loopexit

vector.body184.prol:                              ; preds = %vector.body184.preheader
  %139 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %126, i64 0, i64 %indvars.iv82, i64 0
  %140 = bitcast double* %139 to <2 x i64>*
  %wide.load217.prol = load <2 x i64>, <2 x i64>* %140, align 8, !alias.scope !18
  %141 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %126, i64 0, i64 %indvars.iv82, i64 2
  %142 = bitcast double* %141 to <2 x i64>*
  %wide.load218.prol = load <2 x i64>, <2 x i64>* %142, align 8, !alias.scope !18
  %143 = getelementptr inbounds [2000 x double], [2000 x double]* %127, i64 %indvars.iv82, i64 0
  %144 = bitcast double* %143 to <2 x i64>*
  store <2 x i64> %wide.load217.prol, <2 x i64>* %144, align 8, !alias.scope !21, !noalias !18
  %145 = getelementptr [2000 x double], [2000 x double]* %127, i64 %indvars.iv82, i64 2
  %146 = bitcast double* %145 to <2 x i64>*
  store <2 x i64> %wide.load218.prol, <2 x i64>* %146, align 8, !alias.scope !21, !noalias !18
  br label %vector.body184.prol.loopexit

vector.body184.prol.loopexit:                     ; preds = %vector.body184.prol, %vector.body184.preheader
  %index209.unr.ph = phi i64 [ 4, %vector.body184.prol ], [ 0, %vector.body184.preheader ]
  br i1 %137, label %middle.block185, label %vector.body184.preheader.new

vector.body184.preheader.new:                     ; preds = %vector.body184.prol.loopexit
  br label %vector.body184

vector.body184:                                   ; preds = %vector.body184, %vector.body184.preheader.new
  %index209 = phi i64 [ %index209.unr.ph, %vector.body184.preheader.new ], [ %index.next210.1, %vector.body184 ]
  %147 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %126, i64 0, i64 %indvars.iv82, i64 %index209
  %148 = bitcast double* %147 to <2 x i64>*
  %wide.load217 = load <2 x i64>, <2 x i64>* %148, align 8, !alias.scope !18
  %149 = getelementptr double, double* %147, i64 2
  %150 = bitcast double* %149 to <2 x i64>*
  %wide.load218 = load <2 x i64>, <2 x i64>* %150, align 8, !alias.scope !18
  %151 = getelementptr inbounds [2000 x double], [2000 x double]* %127, i64 %indvars.iv82, i64 %index209
  %152 = bitcast double* %151 to <2 x i64>*
  store <2 x i64> %wide.load217, <2 x i64>* %152, align 8, !alias.scope !21, !noalias !18
  %153 = getelementptr double, double* %151, i64 2
  %154 = bitcast double* %153 to <2 x i64>*
  store <2 x i64> %wide.load218, <2 x i64>* %154, align 8, !alias.scope !21, !noalias !18
  %index.next210 = add i64 %index209, 4
  %155 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %126, i64 0, i64 %indvars.iv82, i64 %index.next210
  %156 = bitcast double* %155 to <2 x i64>*
  %wide.load217.1 = load <2 x i64>, <2 x i64>* %156, align 8, !alias.scope !18
  %157 = getelementptr double, double* %155, i64 2
  %158 = bitcast double* %157 to <2 x i64>*
  %wide.load218.1 = load <2 x i64>, <2 x i64>* %158, align 8, !alias.scope !18
  %159 = getelementptr inbounds [2000 x double], [2000 x double]* %127, i64 %indvars.iv82, i64 %index.next210
  %160 = bitcast double* %159 to <2 x i64>*
  store <2 x i64> %wide.load217.1, <2 x i64>* %160, align 8, !alias.scope !21, !noalias !18
  %161 = getelementptr double, double* %159, i64 2
  %162 = bitcast double* %161 to <2 x i64>*
  store <2 x i64> %wide.load218.1, <2 x i64>* %162, align 8, !alias.scope !21, !noalias !18
  %index.next210.1 = add i64 %index209, 8
  %163 = icmp eq i64 %index.next210.1, %n.vec190
  br i1 %163, label %middle.block185.loopexit, label %vector.body184, !llvm.loop !23

middle.block185.loopexit:                         ; preds = %vector.body184
  br label %middle.block185

middle.block185:                                  ; preds = %middle.block185.loopexit, %vector.body184.prol.loopexit
  br i1 %cmp.n212, label %for.inc118.us, label %for.body106.us.preheader

for.body106.us.preheader:                         ; preds = %middle.block185, %vector.memcheck207, %min.iters.checked188, %for.cond103.preheader.us
  %indvars.iv.ph = phi i64 [ 0, %vector.memcheck207 ], [ 0, %min.iters.checked188 ], [ 0, %for.cond103.preheader.us ], [ %n.vec190, %middle.block185 ]
  %164 = sub nsw i64 %135, %indvars.iv.ph
  %165 = sub nsw i64 %130, %indvars.iv.ph
  %xtraiter225 = and i64 %164, 3
  %lcmp.mod226 = icmp eq i64 %xtraiter225, 0
  br i1 %lcmp.mod226, label %for.body106.us.prol.loopexit, label %for.body106.us.prol.preheader
...
for.body106.us.prol:                              ; preds = %for.body106.us.prol, %for.body106.us.prol.preheader
  ...
  %prol.iter = phi i64 [ %prol.iter.sub, %for.body106.us.prol ], [ %xtraiter225, %for.body106.us.prol.preheader ]
  %arrayidx110.us.prol = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %126, i64 0, i64 %indvars.iv82, i64 %indvars.iv.prol
  %166 = bitcast double* %arrayidx110.us.prol to i64*
  %167 = load i64, i64* %166, align 8
  %arrayidx114.us.prol = getelementptr inbounds [2000 x double], [2000 x double]* %127, i64 %indvars.iv82, i64 %indvars.iv.prol
  %168 = bitcast double* %arrayidx114.us.prol to i64*
...
for.body106.us.prol.loopexit:                     ; preds = %for.body106.us.prol.loopexit.loopexit, %for.body106.us.preheader
  ...
  %169 = icmp ult i64 %165, 3
  br i1 %169, label %for.inc118.us, label %for.body106.us.preheader.new
...
for.body106.us:                                   ; preds = %for.body106.us, %for.body106.us.preheader.new
  ...
  %arrayidx110.us = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %126, i64 0, i64 %indvars.iv82, i64 %indvars.iv
  %170 = bitcast double* %arrayidx110.us to i64*
  %171 = load i64, i64* %170, align 8
  %arrayidx114.us = getelementptr inbounds [2000 x double], [2000 x double]* %127, i64 %indvars.iv82, i64 %indvars.iv
  %172 = bitcast double* %arrayidx114.us to i64*
  store i64 %171, i64* %172, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx110.us.1 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %126, i64 0, i64 %indvars.iv82, i64 %indvars.iv.next
  %173 = bitcast double* %arrayidx110.us.1 to i64*
  %174 = load i64, i64* %173, align 8
  %arrayidx114.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %127, i64 %indvars.iv82, i64 %indvars.iv.next
  %175 = bitcast double* %arrayidx114.us.1 to i64*
  store i64 %174, i64* %175, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %arrayidx110.us.2 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %126, i64 0, i64 %indvars.iv82, i64 %indvars.iv.next.1
  %176 = bitcast double* %arrayidx110.us.2 to i64*
  %177 = load i64, i64* %176, align 8
  %arrayidx114.us.2 = getelementptr inbounds [2000 x double], [2000 x double]* %127, i64 %indvars.iv82, i64 %indvars.iv.next.1
  %178 = bitcast double* %arrayidx114.us.2 to i64*
  store i64 %177, i64* %178, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %arrayidx110.us.3 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %126, i64 0, i64 %indvars.iv82, i64 %indvars.iv.next.2
  %179 = bitcast double* %arrayidx110.us.3 to i64*
  %180 = load i64, i64* %179, align 8
  %arrayidx114.us.3 = getelementptr inbounds [2000 x double], [2000 x double]* %127, i64 %indvars.iv82, i64 %indvars.iv.next.2
  %181 = bitcast double* %arrayidx114.us.3 to i64*
  store i64 %180, i64* %181, align 8
  %exitcond128.3 = icmp eq i64 %indvars.iv.next.2, %130
...
for.inc118.us:                                    ; preds = %for.inc118.us.loopexit, %for.body106.us.prol.loopexit, %middle.block185
  %indvars.iv.next83 = add nsw i64 %indvars.iv82, 1
  %cmp100.us = icmp slt i64 %indvars.iv.next83, %125
...
for.inc118.us.for.cond99.for.end120_crit_edge_crit_edge: ; preds = %for.inc118.us
  %182 = trunc i64 %indvars.iv.next83 to i32
...
for.cond103.preheader.for.cond99.for.end120_crit_edge_crit_edge: ; preds = %for.cond103.preheader.lr.ph
  %183 = add i32 %r.promoted, 1
  %184 = icmp sgt i32 %124, %183
  %smax = select i1 %184, i32 %124, i32 %183
  br label %for.cond99.for.end120_crit_edge
...
for.cond99.for.end120_crit_edge:                  ; preds = %for.cond103.preheader.for.cond99.for.end120_crit_edge_crit_edge, %for.inc118.us.for.cond99.for.end120_crit_edge_crit_edge
  %inc116.lcssa27.lcssa = phi i32 [ %124, %for.inc118.us.for.cond99.for.end120_crit_edge_crit_edge ], [ 0, %for.cond103.preheader.for.cond99.for.end120_crit_edge_crit_edge ]
  %inc119.lcssa = phi i32 [ %182, %for.inc118.us.for.cond99.for.end120_crit_edge_crit_edge ], [ %smax, %for.cond103.preheader.for.cond99.for.end120_crit_edge_crit_edge ]
...
for.end120:                                       ; preds = %for.cond99.preheader, %for.cond99.for.end120_crit_edge
  %185 = bitcast [2000 x [2000 x double]]** %B to i8**
  %186 = load i8*, i8** %185, align 8
  tail call void @free(i8* %186) #4
  ret void
}
