...
for.body8.lr.ph:                                  ; preds = %for.end44.for.body8.lr.ph_crit_edge, %entry
  %indvars.iv41 = phi i64 [ 1, %entry ], [ %indvars.iv.next42, %for.end44.for.body8.lr.ph_crit_edge ]
  %indvars.iv29 = phi i64 [ 1, %entry ], [ %indvars.iv.next30, %for.end44.for.body8.lr.ph_crit_edge ]
  %indvar = phi i64 [ 0, %entry ], [ %indvar.next, %for.end44.for.body8.lr.ph_crit_edge ]
  %alpha.09 = phi double [ %sub3, %entry ], [ %div, %for.end44.for.body8.lr.ph_crit_edge ]
  %beta.08 = phi double [ 1.000000e+00, %entry ], [ %mul5, %for.end44.for.body8.lr.ph_crit_edge ]
  %6 = add i64 %indvar, -1
  %7 = and i64 %indvars.iv41, 3
  %8 = shl i64 %indvar, 3
...
for.body8.prol:                                   ; preds = %for.body8.prol.for.body8.prol_crit_edge, %for.body8.prol.preheader
  ...
  %sum.02.prol = phi double [ %add.prol, %for.body8.prol.for.body8.prol_crit_edge ], [ 0.000000e+00, %for.body8.prol.preheader ]
...
for.body8.prol.loopexit:                          ; preds = %for.body8.lr.ph.for.body8.prol.loopexit_crit_edge, %for.body8.prol.loopexit.loopexit
  ...
  %sum.02.unr = phi double [ 0.000000e+00, %for.body8.lr.ph.for.body8.prol.loopexit_crit_edge ], [ %add.prol, %for.body8.prol.loopexit.loopexit ]
...
for.body8:                                        ; preds = %for.body8.for.body8_crit_edge, %for.body8.preheader
  ...
  %sum.02 = phi double [ %add.3, %for.body8.for.body8_crit_edge ], [ %sum.02.unr, %for.body8.preheader ]
...
for.body21.lr.ph:                                 ; preds = %for.body8.prol.loopexit.for.body21.lr.ph_crit_edge, %for.body21.lr.ph.loopexit
  ...
  %27 = add nsw i64 %indvars.iv29, -1
  %28 = and i64 %indvar, 1
  %lcmp.mod35 = icmp eq i64 %28, 0
  br i1 %lcmp.mod35, label %for.body21.prol, label %for.body21.lr.ph.for.body21.prol.loopexit_crit_edge
...
for.body21.prol.loopexit:                         ; preds = %for.body21.lr.ph.for.body21.prol.loopexit_crit_edge, %for.body21.prol
  %indvars.iv14.unr.ph = phi i64 [ 1, %for.body21.prol ], [ 0, %for.body21.lr.ph.for.body21.prol.loopexit_crit_edge ]
...
for.body21.preheader:                             ; preds = %for.body21.prol.loopexit
  %32 = sub i64 %6, %indvars.iv14.unr.ph
  %33 = lshr i64 %32, 1
  %34 = add nuw i64 %33, 1
  %min.iters.check = icmp ult i64 %34, 2
  br i1 %min.iters.check, label %for.body21.preheader.for.body21.preheader1_crit_edge, label %min.iters.checked

for.body21.preheader.for.body21.preheader1_crit_edge: ; preds = %for.body21.preheader
...
min.iters.checked:                                ; preds = %for.body21.preheader
  ...
  %35 = or i64 %indvars.iv14.unr.ph, 2
  %36 = shl nuw i64 %33, 1
  %37 = add i64 %35, %36
  %38 = shl nuw nsw i64 %n.mod.vf, 1
  %ind.end = sub i64 %37, %38
  br i1 %cmp.zero, label %min.iters.checked.for.body21.preheader1_crit_edge, label %vector.ph

min.iters.checked.for.body21.preheader1_crit_edge: ; preds = %min.iters.checked
  br label %for.body21.preheader1

vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert48 = insertelement <2 x double> undef, double %div, i32 0
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.ph
  ...
  %39 = shl i64 %index, 1
  %offset.idx = or i64 %indvars.iv14.unr.ph, %39
  ...
  %wide.vec44 = load <4 x double>, <4 x double>* %45, align 8
  %strided.vec45 = shufflevector <4 x double> %wide.vec44, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %reverse = shufflevector <2 x double> %strided.vec45, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %strided.vec46 = shufflevector <4 x double> %wide.vec44, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %reverse47 = shufflevector <2 x double> %strided.vec46, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %46 = fmul <2 x double> %broadcast.splat49, %reverse47
  %47 = fadd <2 x double> %strided.vec, %46
  %48 = add nuw nsw i64 %offset.idx, 1
  %49 = fmul <2 x double> %broadcast.splat49, %reverse
  %50 = fadd <2 x double> %strided.vec43, %49
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %middle.block.for.end44_crit_edge, label %middle.block.for.body21.preheader1_crit_edge

middle.block.for.body21.preheader1_crit_edge:     ; preds = %middle.block
  br label %for.body21.preheader1

middle.block.for.end44_crit_edge:                 ; preds = %middle.block
  br label %for.end44

for.body21.preheader1:                            ; preds = %middle.block.for.body21.preheader1_crit_edge, %min.iters.checked.for.body21.preheader1_crit_edge, %for.body21.preheader.for.body21.preheader1_crit_edge
  %indvars.iv14.ph = phi i64 [ %indvars.iv14.unr.ph, %min.iters.checked.for.body21.preheader1_crit_edge ], [ %indvars.iv14.unr.ph, %for.body21.preheader.for.body21.preheader1_crit_edge ], [ %ind.end, %middle.block.for.body21.preheader1_crit_edge ]
...
for.body21:                                       ; preds = %for.body21.for.body21_crit_edge, %for.body21.preheader1
  %indvars.iv14 = phi i64 [ %indvars.iv.next15.1, %for.body21.for.body21_crit_edge ], [ %indvars.iv14.ph, %for.body21.preheader1 ]
  ...
  %58 = sub nsw i64 %27, %indvars.iv.next15
  ...
  br i1 %exitcond20.1, label %for.end44.loopexit, label %for.body21.for.body21_crit_edge, !llvm.loop !6
...
for.end44:                                        ; preds = %middle.block.for.end44_crit_edge, %for.body21.prol.loopexit.for.end44_crit_edge, %for.end44.loopexit
  ...
  br i1 %exitcond33, label %for.end49, label %for.end44.for.body8.lr.ph_crit_edge
