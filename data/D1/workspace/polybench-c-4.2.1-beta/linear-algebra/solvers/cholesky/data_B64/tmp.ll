...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph35
  ...
  %8 = sub nsw i64 0, %indvars.iv71
  %9 = trunc i64 %8 to i32
  %10 = srem i32 %9, 2000
  %11 = sitofp i32 %10 to double
  %12 = fdiv double %11, 2.000000e+03
  %13 = fadd double %12, 1.000000e+00
  %14 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv89, i64 %indvars.iv71
...
._crit_edge36:                                    ; preds = %._crit_edge
  ...
  %17 = icmp slt i64 %indvars.iv.next90, 2000
  br i1 %17, label %._crit_edge40.loopexit, label %._crit_edge40
...
._crit_edge40:                                    ; preds = %._crit_edge36, %._crit_edge40.loopexit
  ...
  br i1 %exitcond92, label %._crit_edge42, label %.lr.ph35
...
._crit_edge32.us.prol:                            ; preds = %._crit_edge32.us.prol, %._crit_edge32.us.prol.preheader
  %indvars.iv67.prol = phi i64 [ 0, %._crit_edge32.us.prol.preheader ], [ %indvars.iv.next68.prol, %._crit_edge32.us.prol ]
  %prol.iter147 = phi i64 [ 0, %._crit_edge32.us.prol.preheader ], [ %prol.iter147.sub, %._crit_edge32.us.prol ]
  ...
  br i1 %prol.iter147.cmp, label %._crit_edge32.us.prol.loopexit.unr-lcssa, label %._crit_edge32.us.prol, !llvm.loop !1
...
._crit_edge32.us:                                 ; preds = %._crit_edge32.us, %._crit_edge42.new
  %indvars.iv67 = phi i64 [ 0, %._crit_edge42.new ], [ %indvars.iv.next68.7, %._crit_edge32.us ]
  ...
  %indvars.iv.next68.6 = add nsw i64 %indvars.iv67, 7
  %35 = mul nuw nsw i64 %indvars.iv.next68.6, 16000
  %scevgep.7 = getelementptr i8, i8* %19, i64 %35
  call void @llvm.memset.p0i8.i64(i8* %scevgep.7, i8 0, i64 16000, i32 8, i1 false)
  %exitcond96.7 = icmp eq i64 %indvars.iv.next68.6, 1999
  %indvars.iv.next68.7 = add nsw i64 %indvars.iv67, 8
  br i1 %exitcond96.7, label %.preheader10.lr.ph.unr-lcssa, label %._crit_edge32.us
...
.preheader9.us.us.preheader:                      ; preds = %._crit_edge21.us, %.preheader10.lr.ph
  %indvars.iv59 = phi i64 [ 0, %.preheader10.lr.ph ], [ %indvars.iv.next60, %._crit_edge21.us ]
  %scevgep102 = getelementptr [2000 x double], [2000 x double]* %1, i64 0, i64 %indvars.iv59
  %scevgep102103 = bitcast double* %scevgep102 to i8*
  %36 = add nsw i64 %indvars.iv59, -1999
  %scevgep104 = getelementptr [2000 x double], [2000 x double]* %1, i64 2000, i64 %36
...
.preheader9.us.us:                                ; preds = %._crit_edge19.us.us, %.preheader9.us.us.preheader
  ...
  %scevgep100 = getelementptr i8, i8* %19, i64 %37
  %38 = add i64 16000, %37
  %scevgep101 = getelementptr i8, i8* %19, i64 %38
  %39 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv55, i64 %indvars.iv59
...
scalar.ph.prol:                                   ; preds = %scalar.ph.prol.preheader
  ...
  %41 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv51.ph, i64 %indvars.iv59
  %42 = load double, double* %41, align 8
  %43 = fmul double %40, %42
  %44 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv55, i64 %indvars.iv51.ph
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %55 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %index, i64 %indvars.iv59
  %56 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %47, i64 %indvars.iv59
  %57 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %48, i64 %indvars.iv59
  %58 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %49, i64 %indvars.iv59
  ...
  %69 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv55, i64 %index
  ...
  %wide.load111 = load <2 x double>, <2 x double>* %72, align 8, !alias.scope !8, !noalias !10
  %73 = fadd <2 x double> %wide.load, %67
  %74 = fadd <2 x double> %wide.load111, %68
...
scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader.new
  ...
  %79 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv51, i64 %indvars.iv59
  %80 = load double, double* %79, align 8
  %81 = fmul double %78, %80
  %82 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv55, i64 %indvars.iv51
  %83 = load double, double* %82, align 8
  %84 = fadd double %83, %81
  store double %84, double* %82, align 8
  %indvars.iv.next52 = add nuw nsw i64 %indvars.iv51, 1
  %85 = load double, double* %39, align 8
  %86 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv.next52, i64 %indvars.iv59
  %87 = load double, double* %86, align 8
  %88 = fmul double %85, %87
  %89 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv55, i64 %indvars.iv.next52
  %90 = load double, double* %89, align 8
  %91 = fadd double %90, %88
  store double %91, double* %89, align 8
  %exitcond95.1 = icmp eq i64 %indvars.iv.next52, 1999
  %indvars.iv.next52.1 = add nsw i64 %indvars.iv51, 2
  br i1 %exitcond95.1, label %._crit_edge19.us.us.loopexit.unr-lcssa, label %scalar.ph, !llvm.loop !14
...
.preheader.us:                                    ; preds = %._crit_edge.us, %.preheader.us.preheader
  ...
  %scevgep121 = getelementptr [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 0
  %scevgep121122 = bitcast double* %scevgep121 to i8*
  %scevgep123 = getelementptr [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 2000
  %scevgep123124 = bitcast double* %scevgep123 to i8*
  %92 = mul nuw nsw i64 %indvars.iv47, 16000
  %scevgep125 = getelementptr i8, i8* %19, i64 %92
  %93 = add i64 16000, %92
  %scevgep126 = getelementptr i8, i8* %19, i64 %93
  br i1 false, label %scalar.ph114.preheader, label %min.iters.checked116

min.iters.checked116:                             ; preds = %.preheader.us
  br i1 false, label %scalar.ph114.preheader, label %vector.memcheck131
...
vector.memcheck131:                               ; preds = %min.iters.checked116
  ...
  br i1 %memcheck.conflict130, label %scalar.ph114.preheader, label %vector.body112.preheader
...
vector.body112:                                   ; preds = %vector.body112.preheader, %vector.body112
  ...
  %94 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv47, i64 %index133
  %95 = bitcast double* %94 to <2 x i64>*
  %wide.load141 = load <2 x i64>, <2 x i64>* %95, align 8, !alias.scope !15
  %96 = getelementptr double, double* %94, i64 2
  %97 = bitcast double* %96 to <2 x i64>*
  %wide.load142 = load <2 x i64>, <2 x i64>* %97, align 8, !alias.scope !15
  %98 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 %index133
  %99 = bitcast double* %98 to <2 x i64>*
  store <2 x i64> %wide.load141, <2 x i64>* %99, align 8, !alias.scope !18, !noalias !15
  %100 = getelementptr double, double* %98, i64 2
  %101 = bitcast double* %100 to <2 x i64>*
  store <2 x i64> %wide.load142, <2 x i64>* %101, align 8, !alias.scope !18, !noalias !15
  %index.next134 = add i64 %index133, 4
  %102 = icmp eq i64 %index.next134, 2000
  br i1 %102, label %middle.block113, label %vector.body112, !llvm.loop !20

middle.block113:                                  ; preds = %vector.body112
  br i1 true, label %._crit_edge.us, label %scalar.ph114.preheader

scalar.ph114.preheader:                           ; preds = %middle.block113, %vector.memcheck131, %min.iters.checked116, %.preheader.us
  ...
  br i1 true, label %scalar.ph114.prol.loopexit, label %scalar.ph114.prol.preheader

scalar.ph114.prol.preheader:                      ; preds = %scalar.ph114.preheader
  br label %scalar.ph114.prol

scalar.ph114.prol:                                ; preds = %scalar.ph114.prol, %scalar.ph114.prol.preheader
  %indvars.iv.prol = phi i64 [ %indvars.iv.next.prol, %scalar.ph114.prol ], [ %indvars.iv.ph, %scalar.ph114.prol.preheader ]
  %prol.iter = phi i64 [ %prol.iter.sub, %scalar.ph114.prol ], [ 0, %scalar.ph114.prol.preheader ]
  %104 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv47, i64 %indvars.iv.prol
  %105 = bitcast double* %104 to i64*
  %106 = load i64, i64* %105, align 8
  %107 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 %indvars.iv.prol
  %108 = bitcast double* %107 to i64*
  store i64 %106, i64* %108, align 8
  %indvars.iv.next.prol = add nuw nsw i64 %indvars.iv.prol, 1
  %prol.iter.sub = add nsw i64 %prol.iter, -1
  %prol.iter.cmp = icmp eq i64 %prol.iter.sub, 0
  br i1 %prol.iter.cmp, label %scalar.ph114.prol.loopexit.unr-lcssa, label %scalar.ph114.prol, !llvm.loop !21

scalar.ph114.prol.loopexit.unr-lcssa:             ; preds = %scalar.ph114.prol
  br label %scalar.ph114.prol.loopexit

scalar.ph114.prol.loopexit:                       ; preds = %scalar.ph114.preheader, %scalar.ph114.prol.loopexit.unr-lcssa
  %109 = icmp ult i64 %103, 3
  br i1 %109, label %._crit_edge.us.loopexit, label %scalar.ph114.preheader.new

scalar.ph114.preheader.new:                       ; preds = %scalar.ph114.prol.loopexit
  br label %scalar.ph114

scalar.ph114:                                     ; preds = %scalar.ph114, %scalar.ph114.preheader.new
  %indvars.iv = phi i64 [ %indvars.iv.ph, %scalar.ph114.preheader.new ], [ %indvars.iv.next.3, %scalar.ph114 ]
  %110 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv47, i64 %indvars.iv
  %111 = bitcast double* %110 to i64*
  %112 = load i64, i64* %111, align 8
  %113 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 %indvars.iv
  %114 = bitcast double* %113 to i64*
  store i64 %112, i64* %114, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %115 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv47, i64 %indvars.iv.next
  %116 = bitcast double* %115 to i64*
  %117 = load i64, i64* %116, align 8
  %118 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 %indvars.iv.next
  %119 = bitcast double* %118 to i64*
  store i64 %117, i64* %119, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %120 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv47, i64 %indvars.iv.next.1
  %121 = bitcast double* %120 to i64*
  %122 = load i64, i64* %121, align 8
  %123 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 %indvars.iv.next.1
  %124 = bitcast double* %123 to i64*
  store i64 %122, i64* %124, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %125 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv47, i64 %indvars.iv.next.2
  %126 = bitcast double* %125 to i64*
  %127 = load i64, i64* %126, align 8
  %128 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 %indvars.iv.next.2
  %129 = bitcast double* %128 to i64*
  store i64 %127, i64* %129, align 8
  %exitcond.3 = icmp eq i64 %indvars.iv.next.2, 1999
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  br i1 %exitcond.3, label %._crit_edge.us.loopexit.unr-lcssa, label %scalar.ph114, !llvm.loop !22

._crit_edge.us.loopexit.unr-lcssa:                ; preds = %scalar.ph114
  br label %._crit_edge.us.loopexit

._crit_edge.us.loopexit:                          ; preds = %scalar.ph114.prol.loopexit, %._crit_edge.us.loopexit.unr-lcssa
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %middle.block113
  %indvars.iv.next48 = add nuw nsw i64 %indvars.iv47, 1
  %exitcond50 = icmp eq i64 %indvars.iv.next48, 2000
  br i1 %exitcond50, label %._crit_edge16.loopexit, label %.preheader.us

._crit_edge16.loopexit:                           ; preds = %._crit_edge.us
  br label %._crit_edge16

._crit_edge16:                                    ; preds = %._crit_edge16.loopexit, %._crit_edge42.thread
  %130 = phi i8* [ %3, %._crit_edge42.thread ], [ %19, %._crit_edge16.loopexit ]
