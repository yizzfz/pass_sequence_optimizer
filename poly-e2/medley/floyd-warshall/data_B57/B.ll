...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %predphi = select <4 x i1> %17, <4 x i32> %wide.load, <4 x i32> %15
  %predphi16 = select <4 x i1> %18, <4 x i32> %wide.load13, <4 x i32> %16
  ...
  br i1 %21, label %for.inc35.loopexit18, label %vector.body, !llvm.loop !9
...
for.body6:                                        ; preds = %for.body6, %for.body6.preheader
  ...
  br i1 %exitcond19.1, label %for.inc35.loopexit, label %for.body6, !llvm.loop !12
