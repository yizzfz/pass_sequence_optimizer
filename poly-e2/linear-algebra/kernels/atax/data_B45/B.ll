...
for.inc:                                          ; preds = %for.inc, %entry
  %indvars.iv20 = phi i64 [ 0, %entry ], [ %indvars.iv.next21.2, %for.inc ]
  ...
  br i1 %exitcond22.2, label %for.cond7.preheader.us.preheader, label %for.inc
...
for.body5.us:                                     ; preds = %for.inc42.us, %for.body5.us.preheader
  ...
  %29 = add nuw nsw i64 %indvars.iv65, 1
...
for.inc39.us.for.inc39.us_crit_edge:              ; preds = %for.inc39.us.for.inc39.us_crit_edge, %for.inc39.us.for.inc39.us_crit_edge.preheader.new
  %indvars.iv.next6476 = phi i64 [ %indvars.iv.next64.prol, %for.inc39.us.for.inc39.us_crit_edge.preheader.new ], [ %indvars.iv.next64.1, %for.inc39.us.for.inc39.us_crit_edge ]
  ...
  %exitcond77.1 = icmp eq i64 %indvars.iv.next64.1, 2100
  br i1 %exitcond77.1, label %for.inc42.us, label %for.inc39.us.for.inc39.us_crit_edge, !llvm.loop !4

for.inc21.us:                                     ; preds = %for.inc21.us, %for.body5.us
  %34 = phi double [ %.pre, %for.body5.us ], [ %add.us.2, %for.inc21.us ]
...
for.inc39.us.preheader:                           ; preds = %for.inc21.us
  ...
  %42 = load double, double* %arrayidx32.us73, align 8
  %mul35.us74 = fmul double %42, %add.us.2
  %add36.us75 = fadd double %41, %mul35.us74
  ...
  br i1 %conflict.rdx, label %for.inc39.us.for.inc39.us_crit_edge.preheader.new, label %vector.body83.preheader

vector.body83.preheader:                          ; preds = %for.inc39.us.preheader
  br label %vector.body83

for.inc39.us.for.inc39.us_crit_edge.preheader.new.loopexit: ; preds = %vector.body83
...
for.inc39.us.for.inc39.us_crit_edge.preheader.new: ; preds = %for.inc39.us.for.inc39.us_crit_edge.preheader.new.loopexit, %for.inc39.us.preheader
  %indvars.iv.next6476.ph = phi i64 [ 1, %for.inc39.us.preheader ], [ 2097, %for.inc39.us.for.inc39.us_crit_edge.preheader.new.loopexit ]
  %.pre71.prol = load double, double* %arrayidx12.us, align 8
  %arrayidx28.us.prol = getelementptr inbounds double, double* %y, i64 %indvars.iv.next6476.ph
  %43 = load double, double* %arrayidx28.us.prol, align 8
  %arrayidx32.us.prol = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 %indvars.iv.next6476.ph
  ...
  %indvars.iv.next64.prol = add nuw nsw i64 %indvars.iv.next6476.ph, 1
...
vector.body83:                                    ; preds = %vector.body83.preheader, %vector.body83
  ...
  %index.next101 = add nuw nsw i64 %index100, 4
  %60 = icmp eq i64 %index.next101, 2096
  br i1 %60, label %for.inc39.us.for.inc39.us_crit_edge.preheader.new.loopexit, label %vector.body83, !llvm.loop !13
