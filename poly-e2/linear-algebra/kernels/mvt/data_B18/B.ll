...
for.body.us:                                      ; preds = %for.cond22.for.inc34_crit_edge.us, %entry
  %indvars.iv14 = phi i64 [ 0, %entry ], [ %indvars.iv.next15, %for.cond22.for.inc34_crit_edge.us ]
  ...
  %arrayidx7.us = getelementptr inbounds double, double* %x2, i64 %indvars.iv14
  store double %div.us.v.r2, double* %arrayidx7.us, align 8
  %2 = add nsw i64 %indvars.iv14, 3
  %3 = trunc i64 %2 to i32
  %rem9.us = srem i32 %3, 2000
  %conv10.us = sitofp i32 %rem9.us to double
  %arrayidx14.us = getelementptr inbounds double, double* %y_1, i64 %indvars.iv14
  %4 = add nsw i64 %indvars.iv14, 4
  ...
  %arrayidx21.us = getelementptr inbounds double, double* %y_2, i64 %indvars.iv14
...
for.inc.us:                                       ; preds = %for.inc.us, %for.body.us
  ...
  %6 = mul nuw nsw i64 %indvars.iv, %indvars.iv14
  %7 = trunc i64 %6 to i32
  %rem26.us = srem i32 %7, 2000
  %conv27.us = sitofp i32 %rem26.us to double
  %div29.us = fdiv double %conv27.us, 2.000000e+03
  %arrayidx33.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv14, i64 %indvars.iv
  store double %div29.us, double* %arrayidx33.us, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %8 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv14
  %9 = trunc i64 %8 to i32
  %rem26.us.1 = srem i32 %9, 2000
  %conv27.us.1 = sitofp i32 %rem26.us.1 to double
  %div29.us.1 = fdiv double %conv27.us.1, 2.000000e+03
  %arrayidx33.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv14, i64 %indvars.iv.next
  store double %div29.us.1, double* %arrayidx33.us.1, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %cmp23.us.1 = icmp slt i64 %indvars.iv.next.1, 2000
  br i1 %cmp23.us.1, label %for.inc.us, label %for.cond22.for.inc34_crit_edge.us

for.cond22.for.inc34_crit_edge.us:                ; preds = %for.inc.us
  %cmp.us = icmp slt i64 %indvars.iv.next15, 2000
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc12_crit_edge.us, %entry
  %indvars.iv26 = phi i64 [ 0, %entry ], [ %indvars.iv.next27, %for.cond1.for.inc12_crit_edge.us ]
  %arrayidx.us = getelementptr inbounds double, double* %x1, i64 %indvars.iv26
  %.pre = load double, double* %arrayidx.us, align 8
  %sunkaddr1 = mul i64 %indvars.iv26, 8
...
for.inc.us:                                       ; preds = %for.inc.us, %for.cond1.preheader.us
  ...
  %indvars.iv23 = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next24.1, %for.inc.us ]
  %arrayidx7.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv26, i64 %indvars.iv23
  ...
  %arrayidx7.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv26, i64 %indvars.iv.next24
  ...
  %cmp2.us.1 = icmp slt i64 %indvars.iv.next24.1, 2000
  br i1 %cmp2.us.1, label %for.inc.us, label %for.cond1.for.inc12_crit_edge.us

for.cond1.for.inc12_crit_edge.us:                 ; preds = %for.inc.us
  %indvars.iv.next27 = add nsw i64 %indvars.iv26, 1
  %cmp.us = icmp slt i64 %indvars.iv.next27, 2000
...
for.cond18.preheader.us:                          ; preds = %for.cond18.preheader.us.preheader, %for.cond18.for.inc36_crit_edge.us
  ...
  %.pre31 = load double, double* %arrayidx22.us, align 8
...
for.inc33.us:                                     ; preds = %for.inc33.us, %for.cond18.preheader.us
  %5 = phi double [ %.pre31, %for.cond18.preheader.us ], [ %add30.us.1, %for.inc33.us ]
  ...
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %cmp19.us.1 = icmp slt i64 %indvars.iv.next.1, 2000
  br i1 %cmp19.us.1, label %for.inc33.us, label %for.cond18.for.inc36_crit_edge.us
