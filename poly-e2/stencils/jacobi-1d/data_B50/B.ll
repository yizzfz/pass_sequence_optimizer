...
entry:
  ...
  %scevgep74 = getelementptr double, double* %A, i64 1999
  %scevgep77 = getelementptr double, double* %B, i64 2000
  %scevgep90 = getelementptr double, double* %B, i64 1
  %scevgep92 = getelementptr double, double* %B, i64 1999
  %scevgep95 = getelementptr double, double* %A, i64 2000
  %bound097 = icmp ult double* %scevgep90, %scevgep95
  %bound198 = icmp ugt double* %scevgep92, %A
  %found.conflict99 = and i1 %bound097, %bound198
  %bound0 = icmp ult double* %scevgep, %scevgep77
  %bound1 = icmp ugt double* %scevgep74, %B
  %found.conflict = and i1 %bound0, %bound1
  br label %for.body.us

for.body.us:                                      ; preds = %for.inc33.us, %entry
  %inc3413.us = phi i32 [ %inc34.us, %for.inc33.us ], [ 0, %entry ]
  br i1 %found.conflict99, label %for.inc.us.preheader, label %vector.body85.preheader

vector.body85.preheader:                          ; preds = %for.body.us
  br label %vector.body85

for.inc.us.preheader.loopexit:                    ; preds = %vector.body85
...
vector.body85:                                    ; preds = %vector.body85.preheader, %vector.body85
  %index103 = phi i64 [ %index.next104, %vector.body85 ], [ 0, %vector.body85.preheader ]
  %offset.idx107 = or i64 %index103, 1
  %0 = getelementptr inbounds double, double* %A, i64 %index103
  %1 = bitcast double* %0 to <2 x double>*
  %wide.load112 = load <2 x double>, <2 x double>* %1, align 8, !alias.scope !1
  %2 = getelementptr double, double* %0, i64 2
  %3 = bitcast double* %2 to <2 x double>*
  %wide.load113 = load <2 x double>, <2 x double>* %3, align 8, !alias.scope !1
  %4 = getelementptr inbounds double, double* %A, i64 %offset.idx107
  %5 = bitcast double* %4 to <2 x double>*
  %wide.load114 = load <2 x double>, <2 x double>* %5, align 8, !alias.scope !1
  %6 = getelementptr double, double* %4, i64 2
  %7 = bitcast double* %6 to <2 x double>*
  %wide.load115 = load <2 x double>, <2 x double>* %7, align 8, !alias.scope !1
  %8 = fadd <2 x double> %wide.load112, %wide.load114
  %9 = fadd <2 x double> %wide.load113, %wide.load115
  %10 = add nuw nsw i64 %offset.idx107, 1
  %11 = getelementptr inbounds double, double* %A, i64 %10
  %12 = getelementptr double, double* %11, i64 2
  %13 = bitcast double* %12 to <2 x double>*
  %wide.load117 = load <2 x double>, <2 x double>* %13, align 8, !alias.scope !1
  %14 = fadd <2 x double> %8, %wide.load113
  %15 = fadd <2 x double> %9, %wide.load117
  ...
  %18 = getelementptr inbounds double, double* %B, i64 %offset.idx107
  ...
  %index.next104 = add nuw nsw i64 %index103, 4
  %22 = icmp eq i64 %index.next104, 1996
  br i1 %22, label %for.inc.us.preheader.loopexit, label %vector.body85, !llvm.loop !6
...
for.inc33.us:                                     ; preds = %for.inc30.us.prol.loopexit.unr-lcssa.for.inc33.us_crit_edge, %for.inc33.us.unr-lcssa
  ...
  %exitcond72 = icmp eq i32 %inc34.us, 500
  br i1 %exitcond72, label %for.end35, label %for.body.us

for.inc30.us:                                     ; preds = %for.inc30.us, %for.inc30.us.preheader.new
  %indvars.iv65 = phi i64 [ %indvars.iv65.ph, %for.inc30.us.preheader.new ], [ %indvars.iv.next66.1, %for.inc30.us ]
  ...
  %arrayidx25.us.1 = getelementptr inbounds double, double* %B, i64 %indvars.iv.next66.1
  ...
  %arrayidx29.us.1 = getelementptr inbounds double, double* %A, i64 %indvars.iv.next66
  store double %mul27.us.1, double* %arrayidx29.us.1, align 8
  %exitcond71.1 = icmp eq i64 %indvars.iv.next66.1, 1999
  br i1 %exitcond71.1, label %for.inc33.us.unr-lcssa, label %for.inc30.us, !llvm.loop !9
...
for.inc.us:                                       ; preds = %for.inc.us, %for.inc.us.preheader.new
  ...
  br i1 %exitcond.1, label %vector.memcheck.unr-lcssa, label %for.inc.us, !llvm.loop !10
...
for.inc30.us.preheader:                           ; preds = %for.inc30.us.preheader.loopexit, %vector.memcheck
  %indvars.iv65.ph = phi i64 [ 1, %vector.memcheck ], [ 1997, %for.inc30.us.preheader.loopexit ]
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load80 = load <2 x double>, <2 x double>* %40, align 8, !alias.scope !11
  %41 = getelementptr inbounds double, double* %B, i64 %offset.idx
  %42 = bitcast double* %41 to <2 x double>*
  %wide.load81 = load <2 x double>, <2 x double>* %42, align 8, !alias.scope !11
  %43 = getelementptr double, double* %41, i64 2
  %44 = bitcast double* %43 to <2 x double>*
  %wide.load82 = load <2 x double>, <2 x double>* %44, align 8, !alias.scope !11
  %45 = fadd <2 x double> %wide.load, %wide.load81
  %46 = fadd <2 x double> %wide.load80, %wide.load82
  ...
  %wide.load84 = load <2 x double>, <2 x double>* %50, align 8, !alias.scope !11
  %51 = fadd <2 x double> %45, %wide.load80
  %52 = fadd <2 x double> %46, %wide.load84
