...
@__llvm_prf_nm = private constant [100 x i8] c"\A8\01ax\DA\CB\CA\CC\CB,\89/JML\89O\CA-`,\C9-0\D4\CB\C9\B1*.I,*\89\CF\CC+(-A\11O\03*/\CE\C0\22\016!9?'\BF(7\11M4\A9\B2$\15.RP\94\9A\93\0F\14\CC\CCMLG\88\A6\A7\96\C4[$\81\1C\92_\8E\22hd\02\15\05\00\C2\87>.", section "__llvm_prf_names"
@llvm.used = appending global [10 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jinit_read_bmp to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_start_input_bmp to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_finish_input_bmp to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_read_colormap to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_read_byte to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_preload_image to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_get_8bit_row to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_get_24bit_row to i8*), i8* bitcast ([30 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([100 x i8], [100 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
