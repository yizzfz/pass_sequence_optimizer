...
define i64 @jdiv_round_up(i64, i64) local_unnamed_addr #0 {
  %3 = add i64 %0, -1
  %4 = add i64 %3, %1
  %5 = sdiv i64 %4, %1
  ret i64 %5
...
; Function Attrs: noinline norecurse nounwind readnone uwtable
define i64 @jround_up(i64, i64) local_unnamed_addr #0 {
  %3 = add i64 %0, -1
  %4 = add i64 %3, %1
  %5 = srem i64 %4, %1
  %6 = sub nsw i64 %4, %5
...
define void @jcopy_sample_rows(i8** nocapture readonly, i32, i8** nocapture readonly, i32, i32, i32) local_unnamed_addr #1 {
  %7 = zext i32 %5 to i64
  %8 = icmp sgt i32 %4, 0
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %.05 = phi i8** [ %16, %.lr.ph ], [ %12, %.lr.ph.preheader ]
  %.014 = phi i32 [ %17, %.lr.ph ], [ %4, %.lr.ph.preheader ]
  %.023 = phi i8** [ %15, %.lr.ph ], [ %10, %.lr.ph.preheader ]
  %13 = load i8*, i8** %.05, align 8
  %14 = load i8*, i8** %.023, align 8
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* %14, i8* %13, i64 %7, i32 1, i1 false)
  %15 = getelementptr inbounds i8*, i8** %.023, i64 1
  %16 = getelementptr inbounds i8*, i8** %.05, i64 1
...
; Function Attrs: noinline nounwind uwtable
define void @jcopy_block_row([64 x i16]* nocapture readonly, [64 x i16]* nocapture, i32) local_unnamed_addr #1 {
  %4 = bitcast [64 x i16]* %1 to i8*
  %5 = bitcast [64 x i16]* %0 to i8*
  %6 = zext i32 %2 to i64
  %7 = shl nuw nsw i64 %6, 7
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* %4, i8* %5, i64 %7, i32 1, i1 false)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define void @jzero_far(i8* nocapture, i64) local_unnamed_addr #1 {
