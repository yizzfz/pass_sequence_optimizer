...
entry:
  ...
  tail call void @kernel_trmm(i32 1000, i32 1200, double %1, [1000 x double]* %0, [1200 x double]* %.cast)
...
if.then:                                          ; preds = %land.lhs.true
  tail call void @print_array(i32 1000, i32 1200, [1200 x double]* %.cast)
  br label %if.end
...
for.end:                                          ; preds = %for.end.loopexit, %for.inc.prol.loopexit, %for.cond1.preheader
  ...
  br i1 %cmp, label %for.cond1.preheader, label %for.end29.loopexit41
...
for.cond1.for.inc30_crit_edge.us:                 ; preds = %for.inc27.us
  %indvar.next = add i32 %indvar, 1
  br i1 %cmp54.us, label %for.cond1.preheader.us, label %for.end32.loopexit
