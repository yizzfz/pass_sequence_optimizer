...
.preheader174.us:                                 ; preds = %.preheader174.us.preheader, %._crit_edge200.us
  ...
  %scevgep287 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv240.us, i64 2
  %scevgep293 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv240.us, i64 2
  %scevgep299 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv240.us, i64 2
...
vector.memcheck:                                  ; preds = %min.iters.checked
  %scevgep285 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv240.us, i64 %indvars.iv236.us.unr.ph
  %95 = sub nsw i64 2158, %indvars.iv236.us.unr.ph
  %96 = and i64 %95, 2158
  %97 = or i64 %indvars.iv236.us.unr.ph, %96
  %scevgep288 = getelementptr float, float* %scevgep287, i64 %97
  %scevgep291 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv240.us, i64 %indvars.iv236.us.unr.ph
  %scevgep294 = getelementptr float, float* %scevgep293, i64 %97
  %scevgep297 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv240.us, i64 %indvars.iv236.us.unr.ph
  %scevgep300 = getelementptr float, float* %scevgep299, i64 %97
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.vec306 = load <8 x float>, <8 x float>* %106, align 4, !alias.scope !9
  %107 = fadd <8 x float> %wide.vec, %wide.vec306
  %108 = shufflevector <8 x float> %107, <8 x float> undef, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %109 = add nuw nsw i64 %offset.idx, 1
  %110 = fadd <8 x float> %wide.vec, %wide.vec306
...
.preheader174.us.new:                             ; preds = %.preheader174.us.new.preheader363, %.preheader174.us.new
  %indvars.iv236.us = phi i64 [ %indvars.iv.next237.us.1, %.preheader174.us.new ], [ %indvars.iv236.us.ph, %.preheader174.us.new.preheader363 ]
...
.preheader169:                                    ; preds = %.preheader169.loopexit, %.preheader178.lr.ph, %.preheader176.lr.ph, %.preheader174.lr.ph, %.preheader173
  %178 = phi i1 [ false, %.preheader173 ], [ false, %.preheader174.lr.ph ], [ false, %.preheader176.lr.ph ], [ false, %.preheader178.lr.ph ], [ true, %.preheader169.loopexit ]
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  ...
  %scevgep321 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv218.us, i64 2
  %scevgep327 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv218.us, i64 2
  %scevgep333 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv218.us, i64 2
...
min.iters.checked313:                             ; preds = %.preheader.us.new.preheader
  %n.mod.vf314 = and i64 %181, 3
  %n.vec315 = sub nsw i64 %181, %n.mod.vf314
  br i1 false, label %.preheader.us.new.preheader362, label %vector.memcheck344

vector.memcheck344:                               ; preds = %min.iters.checked313
  %scevgep319 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv218.us, i64 %indvars.iv.us.unr.ph
  %182 = sub nsw i64 2158, %indvars.iv.us.unr.ph
  %183 = and i64 %182, 2158
  %184 = or i64 %indvars.iv.us.unr.ph, %183
  %scevgep322 = getelementptr float, float* %scevgep321, i64 %184
  %scevgep325 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv218.us, i64 %indvars.iv.us.unr.ph
  %scevgep328 = getelementptr float, float* %scevgep327, i64 %184
  %scevgep331 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv218.us, i64 %indvars.iv.us.unr.ph
  %scevgep334 = getelementptr float, float* %scevgep333, i64 %184
  ...
  %188 = shl nuw nsw i64 %n.mod.vf314, 1
  %ind.end349 = sub nsw i64 %187, %188
...
vector.body309:                                   ; preds = %vector.body309.preheader, %vector.body309
  ...
  %189 = shl i64 %index346, 1
  %offset.idx351 = or i64 %indvars.iv.us.unr.ph, %189
  %190 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv218.us, i64 %offset.idx351
  %191 = bitcast float* %190 to <8 x float>*
  %wide.vec355 = load <8 x float>, <8 x float>* %191, align 4, !alias.scope !16
  %192 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv218.us, i64 %offset.idx351
  %193 = bitcast float* %192 to <8 x float>*
  %wide.vec358 = load <8 x float>, <8 x float>* %193, align 4, !alias.scope !19
  %194 = fadd <8 x float> %wide.vec355, %wide.vec358
  %195 = shufflevector <8 x float> %194, <8 x float> undef, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %196 = add nuw nsw i64 %offset.idx351, 1
  %197 = fadd <8 x float> %wide.vec355, %wide.vec358
  ...
  %interleaved.vec361 = shufflevector <4 x float> %195, <4 x float> %198, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x float> %interleaved.vec361, <8 x float>* %201, align 4, !alias.scope !21, !noalias !23
  %index.next347 = add i64 %index346, 4
  %202 = icmp eq i64 %index.next347, %n.vec315
  br i1 %202, label %middle.block310, label %vector.body309, !llvm.loop !24
...
.preheader.us.new.preheader362:                   ; preds = %middle.block310, %vector.memcheck344, %min.iters.checked313, %.preheader.us.new.preheader
  %indvars.iv.us.ph = phi i64 [ %indvars.iv.us.unr.ph, %vector.memcheck344 ], [ %indvars.iv.us.unr.ph, %min.iters.checked313 ], [ %indvars.iv.us.unr.ph, %.preheader.us.new.preheader ], [ %ind.end349, %middle.block310 ]
  br label %.preheader.us.new

.preheader.us.new:                                ; preds = %.preheader.us.new.preheader362, %.preheader.us.new
  %indvars.iv.us = phi i64 [ %indvars.iv.next.us.1, %.preheader.us.new ], [ %indvars.iv.us.ph, %.preheader.us.new.preheader362 ]
...
._crit_edge181:                                   ; preds = %._crit_edge181.loopexit, %.preheader172.lr.ph, %.preheader170.lr.ph, %.preheader.lr.ph, %.preheader169
  ret void
}
