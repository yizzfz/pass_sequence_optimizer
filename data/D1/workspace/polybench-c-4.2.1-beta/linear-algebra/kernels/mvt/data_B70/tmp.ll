...
._crit_edge10.us:                                 ; preds = %._crit_edge10.us.loopexit, %.prol.loopexit20
  ...
  br i1 %exitcond, label %.preheader.us.preheader, label %.preheader4.us
...
.preheader.us.new:                                ; preds = %.preheader.us.new.preheader, %.preheader.us.new
  %34 = phi double [ %46, %.preheader.us.new ], [ %.pre28, %.preheader.us.new.preheader ]
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %.prol.loopexit
  ...
  %exitcond27 = icmp eq i64 %indvars.iv.next13, 2000
