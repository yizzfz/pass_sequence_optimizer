...
define internal fastcc void @init_array(i32 %n, double* nocapture %alpha, double* nocapture %beta, [1300 x double]* nocapture %A, [1300 x double]* %B, double* nocapture %x) unnamed_addr #2 {
entry:
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %0 = load [1300 x double]*, [1300 x double]** %B.addr, align 8
...
for.body.us:                                      ; preds = %for.cond2.for.end_crit_edge.us, %for.body.lr.ph
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.cond2.for.end_crit_edge.us ], [ 0, %for.body.lr.ph ]
...
for.body5.us:                                     ; preds = %for.body5.us, %for.body.us
  ...
  %arrayidx23.us = getelementptr inbounds [1300 x double], [1300 x double]* %0, i64 %indvars.iv6, i64 %indvars.iv
...
for.body7.us:                                     ; preds = %for.body7.us, %for.body.us
  ...
  %arrayidx11.us = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv3, i64 %indvars.iv
  %6 = load double, double* %arrayidx11.us, align 8
  %arrayidx13.us = getelementptr inbounds double, double* %3, i64 %indvars.iv
  %7 = load double, double* %arrayidx13.us, align 8
  %mul.us = fmul double %6, %7
  %8 = load double, double* %sunkaddr10, align 8
  %add.us = fadd double %mul.us, %8
  store double %add.us, double* %sunkaddr10, align 8
  %arrayidx21.us = getelementptr inbounds [1300 x double], [1300 x double]* %4, i64 %indvars.iv3, i64 %indvars.iv
  %9 = load double, double* %arrayidx21.us, align 8
  %arrayidx23.us = getelementptr inbounds double, double* %3, i64 %indvars.iv
  %10 = load double, double* %arrayidx23.us, align 8
  %mul24.us = fmul double %9, %10
  %11 = load double, double* %sunkaddr14, align 8
  %add27.us = fadd double %mul24.us, %11
  store double %add27.us, double* %sunkaddr14, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond, label %for.cond5.for.end_crit_edge.us, label %for.body7.us

for.cond5.for.end_crit_edge.us:                   ; preds = %for.body7.us
  %sunkaddr16 = shl i64 %indvars.iv3, 3
  %sunkaddr17 = add i64 %sunkaddr15, %sunkaddr16
  %sunkaddr18 = inttoptr i64 %sunkaddr17 to double*
  %12 = load double, double* %sunkaddr18, align 8
  %mul32.us = fmul double %12, %alpha
  %arrayidx34.us = getelementptr inbounds double, double* %1, i64 %indvars.iv3
  %13 = load double, double* %arrayidx34.us, align 8
  %mul35.us = fmul double %0, %13
  ...
  br i1 %exitcond6, label %for.end41.loopexit, label %for.body.us
