...
for.cond1.preheader.lr.ph:                        ; preds = %entry
  ...
  %9 = icmp eq i64 %xtraiter62, 0
  %10 = icmp ult i64 %3, 3
  %11 = icmp eq i64 %xtraiter60, 0
  %12 = icmp eq i32 %np, 1
...
for.cond1.preheader:                              ; preds = %for.cond1.preheader.lr.ph, %for.end41
  %15 = phi i32 [ 0, %for.cond1.preheader.lr.ph ], [ %inc43, %for.end41 ]
  br i1 %5, label %for.cond4.preheader.lr.ph, label %for.end41

for.cond4.preheader.lr.ph:                        ; preds = %for.cond1.preheader
  %idxprom10 = sext i32 %15 to i64
  br i1 %6, label %for.cond4.preheader.us.preheader, label %for.end38.preheader
...
for.end38.prol:                                   ; preds = %for.end38.prol, %for.end38.prol.preheader
  %indvars.iv720.prol = phi i64 [ %indvars.iv.next8.prol, %for.end38.prol ], [ 0, %for.end38.prol.preheader ]
...
for.end38.prol.loopexit:                          ; preds = %for.end38.preheader, %for.end38.prol.loopexit.unr-lcssa
  %indvars.iv720.unr = phi i64 [ 0, %for.end38.preheader ], [ %indvars.iv.next8.prol, %for.end38.prol.loopexit.unr-lcssa ]
  br i1 %14, label %for.end41.loopexit79, label %for.end38.preheader.new
...
for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.end38.us
  %16 = phi i32 [ %split16.us, %for.end38.us ], [ %15, %for.cond4.preheader.us.preheader ]
...
for.body6.us25:                                   ; preds = %for.body6.us25.preheader, %for.cond7.for.end_crit_edge.us42
  ...
  br i1 %11, label %for.body9.us28.prol.loopexit, label %for.body9.us28.prol
...
for.body9.us28.prol:                              ; preds = %for.body6.us25
  ...
  %sunkaddr66 = add i64 %13, %sunkaddr65
...
for.body9.us28.prol.loopexit:                     ; preds = %for.body9.us28.prol, %for.body6.us25
  ...
  br i1 %12, label %for.cond7.for.end_crit_edge.us42, label %for.body9.us28.preheader

for.body9.us28.preheader:                         ; preds = %for.body9.us28.prol.loopexit
  %sunkaddr74 = shl i64 %indvars.iv314.us26, 3
...
for.body9.us28:                                   ; preds = %for.body9.us28.preheader, %for.body9.us28
  %31 = phi double [ %add.us33.1, %for.body9.us28 ], [ %.unr.ph, %for.body9.us28.preheader ]
  ...
  store double %add.us33, double* %sunkaddr76, align 8
  ...
  store double %add.us33.1, double* %sunkaddr76, align 8
...
for.body27.lr.ph.us:                              ; preds = %for.body27.lr.ph.us.loopexit, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit
  %split16.us = phi i32 [ %16, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit ], [ %15, %for.body27.lr.ph.us.loopexit ]
...
for.end38:                                        ; preds = %for.end38, %for.end38.preheader.new
  %indvars.iv720 = phi i64 [ %indvars.iv720.unr, %for.end38.preheader.new ], [ %indvars.iv.next8.7, %for.end38 ]
  %indvars.iv.next8.7 = add nsw i64 %indvars.iv720, 8
  %exitcond51.7 = icmp eq i64 %indvars.iv.next8.7, %1
  br i1 %exitcond51.7, label %for.end41.loopexit79.unr-lcssa, label %for.end38

for.end41.loopexit:                               ; preds = %for.end38.us
  br label %for.end41

for.end41.loopexit79.unr-lcssa:                   ; preds = %for.end38
  br label %for.end41.loopexit79

for.end41.loopexit79:                             ; preds = %for.end38.prol.loopexit, %for.end41.loopexit79.unr-lcssa
  br label %for.end41

for.end41:                                        ; preds = %for.end41.loopexit79, %for.end41.loopexit, %for.cond1.preheader
  %.lcssa10 = phi i32 [ %15, %for.cond1.preheader ], [ %split16.us, %for.end41.loopexit ], [ %15, %for.end41.loopexit79 ]
