...
@__llvm_prf_nm = private constant [34 x i8] c") x\DA\CB*HM\8F\CFLI.\897\A90a\CC\82\F3\8C*\8C\90x\86\15\86\00:\AA\0E\B1", section "__llvm_prf_names"
@llvm.used = appending global [4 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_idct_4x4 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_idct_2x2 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_idct_1x1 to i8*), i8* getelementptr inbounds ([34 x i8], [34 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
