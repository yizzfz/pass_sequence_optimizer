...
for.inc.lr.ph:                                    ; preds = %entry, %for.inc47
  ...
  %indvar = phi i64 [ 0, %entry ], [ %6, %for.inc47 ]
  %2 = phi double [ %sub3, %entry ], [ %div, %for.inc47 ]
...
for.inc.prol:                                     ; preds = %for.inc.prol.preheader, %for.inc.prol
  ...
  %8 = load double, double* %arrayidx13.prol, align 8
...
for.inc:                                          ; preds = %for.inc.preheader, %for.inc
  ...
  %10 = bitcast double* %arrayidx13 to <2 x double>*
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %sub10.1 = sub nsw i64 %sub9, %indvars.iv.next
  %arrayidx11.1 = getelementptr inbounds double, double* %r, i64 %sub10.1
  %11 = bitcast double* %arrayidx11.1 to <2 x double>*
  %12 = load <2 x double>, <2 x double>* %11, align 8
  %13 = load <2 x double>, <2 x double>* %10, align 8
  %mul14.v.i0 = shufflevector <2 x double> %12, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %mul14 = fmul <2 x double> %mul14.v.i0, %13
  ...
  %14 = bitcast double* %arrayidx13.2 to <2 x double>*
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %sub10.3 = sub nsw i64 %sub9, %indvars.iv.next.2
  %arrayidx11.3 = getelementptr inbounds double, double* %r, i64 %sub10.3
  %15 = bitcast double* %arrayidx11.3 to <2 x double>*
  %16 = load <2 x double>, <2 x double>* %15, align 8
  %17 = load <2 x double>, <2 x double>* %14, align 8
  %mul14.2.v.i0 = shufflevector <2 x double> %16, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %mul14.2 = fmul <2 x double> %mul14.2.v.i0, %17
...
for.inc32.prol.loopexit:                          ; preds = %for.inc32.prol, %for.inc32.lr.ph
  ...
  %24 = icmp eq i64 %indvar, 0
  br i1 %24, label %for.inc47, label %for.inc32.preheader

for.inc32.preheader:                              ; preds = %for.inc32.prol.loopexit
  %25 = sub i64 %3, %indvars.iv43.unr.ph
  %26 = lshr i64 %25, 1
  %27 = add nuw i64 %26, 1
...
min.iters.checked:                                ; preds = %for.inc32.preheader
  ...
  %28 = or i64 %indvars.iv43.unr.ph, 2
  %29 = shl nuw i64 %26, 1
  %30 = add i64 %28, %29
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %32 = shl i64 %index, 1
  %offset.idx = or i64 %indvars.iv43.unr.ph, %32
  %33 = getelementptr inbounds double, double* %y, i64 %offset.idx
  %34 = bitcast double* %33 to <4 x double>*
  %wide.vec = load <4 x double>, <4 x double>* %34, align 8
  %strided.vec = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %strided.vec67 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %35 = sub nsw i64 %sub9, %offset.idx
  %36 = getelementptr inbounds double, double* %y, i64 %35
  %37 = getelementptr double, double* %36, i64 -3
  %38 = bitcast double* %37 to <4 x double>*
  %wide.vec68 = load <4 x double>, <4 x double>* %38, align 8
  ...
  %39 = fmul <2 x double> %broadcast.splat73, %reverse71
  %40 = fadd <2 x double> %strided.vec, %39
  %41 = add nuw nsw i64 %offset.idx, 1
  %42 = fmul <2 x double> %broadcast.splat73, %reverse
  %43 = fadd <2 x double> %strided.vec67, %42
  %44 = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %41
  %45 = getelementptr double, double* %44, i64 -1
  %46 = bitcast double* %45 to <4 x double>*
  %interleaved.vec = shufflevector <2 x double> %40, <2 x double> %43, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec, <4 x double>* %46, align 8
...
for.inc32.preheader1:                             ; preds = %middle.block, %min.iters.checked, %for.inc32.preheader
  ...
  %48 = insertelement <2 x double> undef, double %div, i32 0
  %mul28.v.i0.2 = shufflevector <2 x double> %48, <2 x double> undef, <2 x i32> zeroinitializer
  br label %for.inc32
...
for.inc32:                                        ; preds = %for.inc32.preheader1, %for.inc32
  ...
  %49 = bitcast double* %arrayidx23 to <2 x double>*
  ...
  %sub25.1 = sub nsw i64 %sub9, %indvars.iv.next44
  %arrayidx27.1 = getelementptr inbounds double, double* %y, i64 %sub25.1
  %51 = bitcast double* %arrayidx27.1 to <2 x double>*
  %52 = load <2 x double>, <2 x double>* %51, align 8
  %mul28.1 = fmul <2 x double> %mul28.v.i0.2, %52
  %add29.v.i1 = shufflevector <2 x double> %mul28.1, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %add29 = fadd <2 x double> %50, %add29.v.i1
  %53 = bitcast double* %arrayidx31 to <2 x double>*
  store <2 x double> %add29, <2 x double>* %53, align 8
