...
@__llvm_prf_nm = private constant [101 x i8] c"c\00phone_append\01tmp1.ll:darray_find\01phone_to_elm\01tmp1.ll:enter_phonemes\01tmp1.ll:enter\01tmp1.ll:find_elm", section "__llvm_prf_names"
@llvm.used = appending global [7 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_phone_append to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_darray_find to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_phone_to_elm to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_enter_phonemes to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_enter to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_find_elm to i8*), i8* getelementptr inbounds ([101 x i8], [101 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
...
declare i8* @trie_lookup(%struct.trie_s**, i8**) #1
...
declare void @trie_insert(%struct.trie_s**, i8*, i8*) #1
