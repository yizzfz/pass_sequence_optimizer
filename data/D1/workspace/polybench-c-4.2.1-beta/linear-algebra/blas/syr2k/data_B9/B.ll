...
.lr.ph.us.preheader:                              ; preds = %.preheader32.lr.ph
  ...
  %broadcast.splatinsert136 = insertelement <2 x double> undef, double %2, i32 0
  %broadcast.splat137 = shufflevector <2 x double> %broadcast.splatinsert136, <2 x double> undef, <2 x i32> zeroinitializer
  %broadcast.splatinsert161 = insertelement <2 x double> undef, double %3, i32 0
  %broadcast.splat162 = shufflevector <2 x double> %broadcast.splatinsert161, <2 x double> undef, <2 x i32> zeroinitializer
  br label %.lr.ph.us

.lr.ph.us.new:                                    ; preds = %.lr.ph.us.new.preheader164, %.lr.ph.us.new
  %indvars.iv = phi i64 [ %indvars.iv.next.3, %.lr.ph.us.new ], [ %indvars.iv.ph, %.lr.ph.us.new.preheader164 ]
...
.preheader.us43.preheader:                        ; preds = %.preheader.us43.preheader.loopexit, %middle.block139, %.prol.loopexit
  %min.iters.check97 = icmp ult i64 %71, 2
  %n.vec100 = and i64 %71, -2
  %cmp.zero101 = icmp eq i64 %n.vec100, 0
  %cmp.n132 = icmp eq i64 %71, %n.vec100
  br label %.preheader.us43

scalar.ph96:                                      ; preds = %scalar.ph96.preheader, %scalar.ph96
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %scalar.ph96 ], [ %indvars.iv53.ph, %scalar.ph96.preheader ]
  ...
  br i1 %exitcond58, label %._crit_edge.us46.loopexit, label %scalar.ph96, !llvm.loop !5
...
.preheader.us43:                                  ; preds = %.preheader.us43.preheader, %._crit_edge.us46
  ...
  %scevgep106 = getelementptr [1000 x double], [1000 x double]* %5, i64 0, i64 %indvars.iv59
  %36 = add i64 %indvars.iv59, 1
  %scevgep108 = getelementptr [1000 x double], [1000 x double]* %5, i64 %indvars.iv66, i64 %36
  %scevgep110 = getelementptr [1000 x double], [1000 x double]* %6, i64 0, i64 %indvars.iv59
  %scevgep112 = getelementptr [1000 x double], [1000 x double]* %6, i64 %indvars.iv66, i64 %36
...
scalar.ph96.preheader:                            ; preds = %middle.block95, %vector.memcheck, %min.iters.checked98, %.preheader.us43
  %indvars.iv53.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %min.iters.checked98 ], [ 0, %.preheader.us43 ], [ %n.vec100, %middle.block95 ]
  br label %scalar.ph96

min.iters.checked98:                              ; preds = %.preheader.us43
  br i1 %cmp.zero101, label %scalar.ph96.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked98
  %bound0 = icmp ult double* %scevgep, %38
  %bound1 = icmp ult double* %38, %scevgep104
  %found.conflict = and i1 %bound0, %bound1
  %bound0115 = icmp ult double* %scevgep, %scevgep108
  %bound1116 = icmp ult double* %scevgep106, %scevgep104
  %found.conflict117 = and i1 %bound0115, %bound1116
  %conflict.rdx = or i1 %found.conflict, %found.conflict117
  %bound0118 = icmp ult double* %scevgep, %scevgep112
  %bound1119 = icmp ult double* %scevgep110, %scevgep104
  %found.conflict120 = and i1 %bound0118, %bound1119
  %conflict.rdx121 = or i1 %conflict.rdx, %found.conflict120
  %bound0124 = icmp ult double* %scevgep, %37
  %bound1125 = icmp ult double* %37, %scevgep104
  %found.conflict126 = and i1 %bound0124, %bound1125
  %conflict.rdx127 = or i1 %conflict.rdx121, %found.conflict126
  br i1 %conflict.rdx127, label %scalar.ph96.preheader, label %vector.ph128

vector.ph128:                                     ; preds = %vector.memcheck
  br label %vector.body94

vector.body94:                                    ; preds = %vector.body94, %vector.ph128
  %index129 = phi i64 [ 0, %vector.ph128 ], [ %index.next130, %vector.body94 ]
  %39 = or i64 %index129, 1
  %40 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %index129, i64 %indvars.iv59
  ...
  %46 = fmul <2 x double> %45, %broadcast.splat137
  ...
  %51 = getelementptr inbounds [1000 x double], [1000 x double]* %6, i64 %index129, i64 %indvars.iv59
  ...
  %57 = fmul <2 x double> %56, %broadcast.splat137
  ...
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv66, i64 %index129
  ...
  %67 = icmp eq i64 %index.next130, %n.vec100
  br i1 %67, label %middle.block95, label %vector.body94, !llvm.loop !18

middle.block95:                                   ; preds = %vector.body94
  br i1 %cmp.n132, label %._crit_edge.us46, label %scalar.ph96.preheader
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %._crit_edge37.us
  ...
  %70 = add i64 %69, 1
  %scevgep104 = getelementptr [1200 x double], [1200 x double]* %4, i64 0, i64 %70
...
.lr.ph.us.new.preheader:                          ; preds = %.prol.loopexit
  ...
  %min.iters.check141 = icmp ult i64 %79, 2
  br i1 %min.iters.check141, label %.lr.ph.us.new.preheader164, label %min.iters.checked142

.lr.ph.us.new.preheader164:                       ; preds = %middle.block139, %min.iters.checked142, %.lr.ph.us.new.preheader
  %indvars.iv.ph = phi i64 [ %indvars.iv.unr, %min.iters.checked142 ], [ %indvars.iv.unr, %.lr.ph.us.new.preheader ], [ %ind.end150, %middle.block139 ]
  br label %.lr.ph.us.new

min.iters.checked142:                             ; preds = %.lr.ph.us.new.preheader
  %n.mod.vf143 = and i64 %79, 1
  %n.vec144 = sub nsw i64 %79, %n.mod.vf143
  %cmp.zero145 = icmp eq i64 %n.vec144, 0
  %80 = add i64 %indvars.iv.unr, 4
  %81 = shl nuw i64 %78, 2
  %82 = add i64 %80, %81
  %83 = shl nuw nsw i64 %n.mod.vf143, 2
  %ind.end150 = sub i64 %82, %83
  br i1 %cmp.zero145, label %.lr.ph.us.new.preheader164, label %vector.ph146
...
vector.body138:                                   ; preds = %vector.body138, %vector.ph146
  ...
  %wide.vec156 = load <8 x double>, <8 x double>* %87, align 8
  %strided.vec157 = shufflevector <8 x double> %wide.vec156, <8 x double> undef, <2 x i32> <i32 0, i32 4>
  %strided.vec158 = shufflevector <8 x double> %wide.vec156, <8 x double> undef, <2 x i32> <i32 1, i32 5>
  %strided.vec159 = shufflevector <8 x double> %wide.vec156, <8 x double> undef, <2 x i32> <i32 2, i32 6>
  %strided.vec160 = shufflevector <8 x double> %wide.vec156, <8 x double> undef, <2 x i32> <i32 3, i32 7>
  %88 = fmul <2 x double> %strided.vec157, %broadcast.splat162
  %89 = fmul <2 x double> %strided.vec158, %broadcast.splat162
  %90 = fmul <2 x double> %strided.vec159, %broadcast.splat162
  %91 = add nsw i64 %85, 3
  %92 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv66, i64 %91
  %93 = fmul <2 x double> %strided.vec160, %broadcast.splat162
  ...
  %interleaved.vec163 = shufflevector <4 x double> %96, <4 x double> %97, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 1, i32 3, i32 5, i32 7>
  store <8 x double> %interleaved.vec163, <8 x double>* %95, align 8
  %index.next148 = add i64 %index147, 2
  %98 = icmp eq i64 %index.next148, %n.vec144
  br i1 %98, label %middle.block139, label %vector.body138, !llvm.loop !21

middle.block139:                                  ; preds = %vector.body138
  %cmp.n151 = icmp eq i64 %n.mod.vf143, 0
  br i1 %cmp.n151, label %.preheader.us43.preheader, label %.lr.ph.us.new.preheader164

._crit_edge.us46.loopexit:                        ; preds = %scalar.ph96
  br label %._crit_edge.us46

._crit_edge.us46:                                 ; preds = %._crit_edge.us46.loopexit, %middle.block95
...
.lr.ph.new.preheader:                             ; preds = %.prol.loopexit82
  ...
  br i1 %min.iters.check, label %.lr.ph.new.preheader165, label %min.iters.checked
...
min.iters.checked:                                ; preds = %.lr.ph.new.preheader
  ...
  br i1 %cmp.zero, label %.lr.ph.new.preheader165, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %116 = fmul <2 x double> %strided.vec, %broadcast.splat93
  %117 = fmul <2 x double> %strided.vec89, %broadcast.splat93
  %118 = fmul <2 x double> %strided.vec90, %broadcast.splat93
  %119 = add nsw i64 %113, 3
  %120 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv77, i64 %119
  %121 = fmul <2 x double> %strided.vec91, %broadcast.splat93
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %.preheader31, label %.lr.ph.new.preheader165

.lr.ph.new.preheader165:                          ; preds = %middle.block, %min.iters.checked, %.lr.ph.new.preheader
  %indvars.iv70.ph = phi i64 [ %indvars.iv70.unr, %min.iters.checked ], [ %indvars.iv70.unr, %.lr.ph.new.preheader ], [ %ind.end, %middle.block ]
  br label %.lr.ph.new

.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader165, %.lr.ph.new
  %indvars.iv70 = phi i64 [ %indvars.iv.next71.3, %.lr.ph.new ], [ %indvars.iv70.ph, %.lr.ph.new.preheader165 ]
...
.preheader31:                                     ; preds = %.preheader31.loopexit, %middle.block, %.prol.loopexit82
  ...
  br i1 %exitcond80, label %._crit_edge41.loopexit166, label %.lr.ph

._crit_edge41.loopexit:                           ; preds = %._crit_edge37.us
  br label %._crit_edge41

._crit_edge41.loopexit166:                        ; preds = %.preheader31
  br label %._crit_edge41

._crit_edge41:                                    ; preds = %._crit_edge41.loopexit166, %._crit_edge41.loopexit, %7
  ret void
}
