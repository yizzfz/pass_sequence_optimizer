...
.preheader:                                       ; preds = %18, %1
  %indvars.iv21 = phi i64 [ 0, %1 ], [ %indvars.iv.next22, %18 ]
  br label %2
...
; <label>:18:                                     ; preds = %2
  ...
  br i1 %exitcond23, label %19, label %.preheader
...
.preheader26:                                     ; preds = %19, %1
  %indvars.iv32 = phi i64 [ 0, %1 ], [ %indvars.iv.next33, %19 ]
  br label %.preheader

.preheader:                                       ; preds = %18, %.preheader26
  %indvars.iv30 = phi i64 [ 0, %.preheader26 ], [ %indvars.iv.next31, %18 ]
  %2 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv30, i64 %indvars.iv32
  br label %3
...
; <label>:3:                                      ; preds = %3, %.preheader
  ...
  %7 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv32, i64 %indvars.iv
  ...
  %14 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv32, i64 %indvars.iv.next
...
; <label>:18:                                     ; preds = %3
  ...
  %exitcond = icmp eq i64 %indvars.iv.next31, 2800
  br i1 %exitcond, label %19, label %.preheader

; <label>:19:                                     ; preds = %18
  %indvars.iv.next33 = add nuw nsw i64 %indvars.iv32, 1
  %exitcond34 = icmp eq i64 %indvars.iv.next33, 2800
  br i1 %exitcond34, label %20, label %.preheader26
...
._crit_edge:                                      ; preds = %7, %12
  ...
  %15 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv12, i64 %indvars.iv
  %16 = load i32, i32* %15, align 4
  %17 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %14, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i64 0, i64 0), i32 %16) #5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 2800
