...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %29 = fmul <2 x double> %28, %broadcast.splatinsert51
  %30 = shufflevector <2 x double> %29, <2 x double> undef, <2 x i32> zeroinitializer
  %31 = getelementptr inbounds [1100 x double], [1100 x double]* %7, i64 %indvars.iv35, i64 %offset.idx
  ...
  %34 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv37, i64 %offset.idx
  %35 = bitcast double* %34 to <4 x double>*
  %wide.vec54 = load <4 x double>, <4 x double>* %35, align 8, !alias.scope !6, !noalias !8
  ...
  %36 = fadd <2 x double> %strided.vec55, %33
  %37 = or i64 %offset.idx, 1
  %38 = fmul <2 x double> %30, %strided.vec53
  %39 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv37, i64 %37
  %40 = fadd <2 x double> %strided.vec56, %38
  ...
  br i1 %43, label %._crit_edge27.loopexit58, label %vector.body, !llvm.loop !9
...
._crit_edge28:                                    ; preds = %._crit_edge28.preheader57, %._crit_edge28
  ...
  %45 = fmul double %44, %3
  %46 = getelementptr inbounds [1100 x double], [1100 x double]* %7, i64 %indvars.iv35, i64 %indvars.iv33
  %47 = load double, double* %46, align 8
  %48 = fmul double %45, %47
  %49 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv37, i64 %indvars.iv33
  ...
  %53 = fmul double %52, %3
  %54 = getelementptr inbounds [1100 x double], [1100 x double]* %7, i64 %indvars.iv35, i64 %indvars.iv.next34
  %55 = load double, double* %54, align 8
  %56 = fmul double %53, %55
  %57 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv37, i64 %indvars.iv.next34
...
._crit_edge27:                                    ; preds = %._crit_edge27.loopexit58, %._crit_edge27.loopexit
  ...
  br i1 %exitcond, label %60, label %._crit_edge28.preheader

; <label>:60:                                     ; preds = %._crit_edge27
  %exitcond39 = icmp eq i64 %9, 1000
  br i1 %exitcond39, label %61, label %._crit_edge.preheader
