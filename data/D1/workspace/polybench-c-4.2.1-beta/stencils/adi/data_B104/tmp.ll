...
.lr.ph29.split.us:                                ; preds = %._crit_edge27.us, %.preheader7
  ...
  %18 = getelementptr inbounds [1000 x double], [1000 x double]* %17, i64 0, i64 %indvars.iv76
  store double 1.000000e+00, double* %18, align 8
  %19 = getelementptr inbounds [1000 x double], [1000 x double]* %16, i64 %indvars.iv76, i64 0
  store double 0.000000e+00, double* %19, align 8
  %20 = load [1000 x double]*, [1000 x double]** %5, align 8
  %21 = getelementptr inbounds [1000 x double], [1000 x double]* %20, i64 0, i64 %indvars.iv76
  %22 = bitcast double* %21 to i64*
  %23 = load i64, i64* %22, align 8
  %24 = load [1000 x double]*, [1000 x double]** %7, align 8
  %25 = getelementptr inbounds [1000 x double], [1000 x double]* %24, i64 %indvars.iv76
...
.lr.ph26.us:                                      ; preds = %.lr.ph26.us, %._crit_edge.us
  ...
  %29 = getelementptr inbounds [1000 x double], [1000 x double]* %81, i64 %indvars.iv76, i64 %indvars.iv74
  %30 = load double, double* %29, align 8
  %31 = fmul double %30, %28
  %32 = getelementptr inbounds [1000 x double], [1000 x double]* %76, i64 %indvars.iv76, i64 %indvars.iv74
  %33 = load double, double* %32, align 8
  %34 = fadd double %31, %33
  %35 = getelementptr inbounds [1000 x double], [1000 x double]* %20, i64 %indvars.iv74, i64 %indvars.iv76
  store double %34, double* %35, align 8
  %indvars.iv.next75 = add nsw i64 %indvars.iv74, -1
  %36 = getelementptr inbounds [1000 x double], [1000 x double]* %81, i64 %indvars.iv76, i64 %indvars.iv.next75
  %37 = load double, double* %36, align 8
  %38 = fmul double %37, %34
  %39 = getelementptr inbounds [1000 x double], [1000 x double]* %76, i64 %indvars.iv76, i64 %indvars.iv.next75
  %40 = load double, double* %39, align 8
  %41 = fadd double %38, %40
  %42 = getelementptr inbounds [1000 x double], [1000 x double]* %20, i64 %indvars.iv.next75, i64 %indvars.iv76
  store double %41, double* %42, align 8
  %43 = icmp sgt i64 %indvars.iv.next75, 1
...
; <label>:44:                                     ; preds = %44, %.lr.ph29.split.us
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %44 ], [ 1, %.lr.ph29.split.us ]
  %45 = phi double [ %85, %44 ], [ %.pre62, %.lr.ph29.split.us ]
  %46 = phi double [ %75, %44 ], [ %.pre, %.lr.ph29.split.us ]
  %47 = phi [1000 x double]* [ %81, %44 ], [ %16, %.lr.ph29.split.us ]
  %48 = load double, double* %10, align 8
  %49 = fsub double -0.000000e+00, %48
  %50 = add nsw i64 %indvars.iv72, -1
  %51 = getelementptr inbounds [1000 x double], [1000 x double]* %47, i64 %indvars.iv76, i64 %50
  %52 = load double, double* %51, align 8
  %53 = fmul double %46, %52
  %54 = fadd double %53, %45
  %55 = fdiv double %49, %54
  %56 = getelementptr inbounds [1000 x double], [1000 x double]* %47, i64 %indvars.iv76, i64 %indvars.iv72
  store double %55, double* %56, align 8
  %57 = load double, double* %11, align 8
  %58 = load [1000 x double]*, [1000 x double]** %4, align 8
  %59 = getelementptr inbounds [1000 x double], [1000 x double]* %58, i64 %indvars.iv72, i64 %27
  ...
  %71 = getelementptr inbounds [1000 x double], [1000 x double]* %58, i64 %indvars.iv72, i64 %indvars.iv.next77
  %72 = load double, double* %71, align 8
  %73 = fmul double %70, %72
  %74 = fsub double %69, %73
  %75 = load double, double* %8, align 8
  %76 = load [1000 x double]*, [1000 x double]** %7, align 8
  %77 = getelementptr inbounds [1000 x double], [1000 x double]* %76, i64 %indvars.iv76, i64 %50
  %78 = load double, double* %77, align 8
  %79 = fmul double %75, %78
  %80 = fsub double %74, %79
  %81 = load [1000 x double]*, [1000 x double]** %6, align 8
  %82 = getelementptr inbounds [1000 x double], [1000 x double]* %81, i64 %indvars.iv76, i64 %50
  %83 = load double, double* %82, align 8
  %84 = fmul double %75, %83
  %85 = load double, double* %9, align 8
  %86 = fadd double %84, %85
  %87 = fdiv double %80, %86
  %88 = getelementptr inbounds [1000 x double], [1000 x double]* %76, i64 %indvars.iv76, i64 %indvars.iv72
...
._crit_edge.us:                                   ; preds = %44
  %89 = getelementptr inbounds [1000 x double], [1000 x double]* %20, i64 999, i64 %indvars.iv76
  store double 1.000000e+00, double* %89, align 8
  br label %.lr.ph26.us

.lr.ph38.us.preheader:                            ; preds = %._crit_edge27.us
  %.pre98 = load double, double* %12, align 8
  %.pre99 = load [1000 x double]*, [1000 x double]** %5, align 8
  %.pre100 = load double, double* %10, align 8
...
.lver.check:                                      ; preds = %._crit_edge43.us, %.lr.ph38.us.preheader
  ...
  %scevgep112 = getelementptr [1000 x double], [1000 x double]* %81, i64 %93, i64 999
  %scevgep114 = getelementptr [1000 x double], [1000 x double]* %76, i64 %93, i64 0
  %scevgep116 = getelementptr [1000 x double], [1000 x double]* %76, i64 %93, i64 999
  %94 = getelementptr inbounds [1000 x double], [1000 x double]* %58, i64 %indvars.iv84, i64 0
  store double 1.000000e+00, double* %94, align 8
  %95 = getelementptr inbounds [1000 x double], [1000 x double]* %81, i64 %indvars.iv84, i64 0
  store double 0.000000e+00, double* %95, align 8
  %96 = bitcast double* %94 to i64*
  %97 = load i64, i64* %96, align 8
  %98 = getelementptr inbounds [1000 x double], [1000 x double]* %76, i64 %indvars.iv84
  %99 = bitcast [1000 x double]* %98 to i64*
  store i64 %97, i64* %99, align 8
  %100 = add nsw i64 %indvars.iv84, -1
...
.ph.lver.orig:                                    ; preds = %.ph.lver.orig.preheader, %.ph.lver.orig
  ...
  %101 = add nsw i64 %indvars.iv78.lver.orig, -1
  %102 = getelementptr inbounds [1000 x double], [1000 x double]* %81, i64 %indvars.iv84, i64 %101
  %103 = load double, double* %102, align 8
  %104 = fmul double %57, %103
  %105 = fadd double %104, %.pre98
  %106 = fdiv double %90, %105
  %107 = getelementptr inbounds [1000 x double], [1000 x double]* %81, i64 %indvars.iv84, i64 %indvars.iv78.lver.orig
  store double %106, double* %107, align 8
  %108 = getelementptr inbounds [1000 x double], [1000 x double]* %.pre99, i64 %100, i64 %indvars.iv78.lver.orig
  %109 = load double, double* %108, align 8
  %110 = fmul double %75, %109
  %111 = getelementptr inbounds [1000 x double], [1000 x double]* %.pre99, i64 %indvars.iv84, i64 %indvars.iv78.lver.orig
  %112 = load double, double* %111, align 8
  %113 = fmul double %92, %112
  %114 = fsub double %113, %110
  %115 = getelementptr inbounds [1000 x double], [1000 x double]* %.pre99, i64 %indvars.iv.next85, i64 %indvars.iv78.lver.orig
  %116 = load double, double* %115, align 8
  %117 = fmul double %.pre100, %116
  %118 = fsub double %114, %117
  %119 = getelementptr inbounds [1000 x double], [1000 x double]* %76, i64 %indvars.iv84, i64 %101
  %120 = load double, double* %119, align 8
  %121 = fmul double %57, %120
  %122 = fsub double %118, %121
  %123 = fdiv double %122, %105
  %124 = getelementptr inbounds [1000 x double], [1000 x double]* %76, i64 %indvars.iv84, i64 %indvars.iv78.lver.orig
...
.lr.ph42.us:                                      ; preds = %.lr.ph42.us, %._crit_edge39.us
  ...
  %126 = getelementptr inbounds [1000 x double], [1000 x double]* %81, i64 %indvars.iv84, i64 %indvars.iv82
  %127 = load double, double* %126, align 8
  %128 = fmul double %127, %125
  %129 = getelementptr inbounds [1000 x double], [1000 x double]* %76, i64 %indvars.iv84, i64 %indvars.iv82
  %130 = load double, double* %129, align 8
  %131 = fadd double %128, %130
  %132 = getelementptr inbounds [1000 x double], [1000 x double]* %58, i64 %indvars.iv84, i64 %indvars.iv82
  store double %131, double* %132, align 8
  %indvars.iv.next83 = add nsw i64 %indvars.iv82, -1
  %133 = getelementptr inbounds [1000 x double], [1000 x double]* %81, i64 %indvars.iv84, i64 %indvars.iv.next83
  %134 = load double, double* %133, align 8
  %135 = fmul double %134, %131
  %136 = getelementptr inbounds [1000 x double], [1000 x double]* %76, i64 %indvars.iv84, i64 %indvars.iv.next83
  %137 = load double, double* %136, align 8
  %138 = fadd double %135, %137
  %139 = getelementptr inbounds [1000 x double], [1000 x double]* %58, i64 %indvars.iv84, i64 %indvars.iv.next83
  store double %138, double* %139, align 8
  %140 = icmp sgt i64 %indvars.iv.next83, 1
  %indvars.iv.next83.1 = add nsw i64 %indvars.iv82, -2
  br i1 %140, label %.lr.ph42.us, label %._crit_edge43.us

; <label>:141:                                    ; preds = %141, %.ph
  %store_forwarded121 = phi double [ %load_initial120, %.ph ], [ %159, %141 ]
  %store_forwarded = phi double [ %load_initial, %.ph ], [ %144, %141 ]
  %indvars.iv78 = phi i64 [ 1, %.ph ], [ %indvars.iv.next79, %141 ]
  %142 = fmul double %57, %store_forwarded
  %143 = fadd double %142, %.pre98
  %144 = fdiv double %90, %143
  %145 = getelementptr inbounds [1000 x double], [1000 x double]* %81, i64 %indvars.iv84, i64 %indvars.iv78
  store double %144, double* %145, align 8
  %146 = getelementptr inbounds [1000 x double], [1000 x double]* %.pre99, i64 %100, i64 %indvars.iv78
  %147 = load double, double* %146, align 8
  %148 = fmul double %75, %147
  %149 = getelementptr inbounds [1000 x double], [1000 x double]* %.pre99, i64 %indvars.iv84, i64 %indvars.iv78
  %150 = load double, double* %149, align 8
  %151 = fmul double %92, %150
  %152 = fsub double %151, %148
  %153 = getelementptr inbounds [1000 x double], [1000 x double]* %.pre99, i64 %indvars.iv.next85, i64 %indvars.iv78
  %154 = load double, double* %153, align 8
  %155 = fmul double %.pre100, %154
  %156 = fsub double %152, %155
  %157 = fmul double %57, %store_forwarded121
  %158 = fsub double %156, %157
  %159 = fdiv double %158, %143
  %160 = getelementptr inbounds [1000 x double], [1000 x double]* %76, i64 %indvars.iv84, i64 %indvars.iv78
  store double %159, double* %160, align 8
  %exitcond81 = icmp eq i64 %indvars.iv78, 998
  %indvars.iv.next79 = add nuw nsw i64 %indvars.iv78, 1
  br i1 %exitcond81, label %._crit_edge39.us.loopexit122, label %141

._crit_edge39.us.loopexit:                        ; preds = %.ph.lver.orig
  br label %._crit_edge39.us

._crit_edge39.us.loopexit122:                     ; preds = %141
  br label %._crit_edge39.us

._crit_edge39.us:                                 ; preds = %._crit_edge39.us.loopexit122, %._crit_edge39.us.loopexit
  %161 = getelementptr inbounds [1000 x double], [1000 x double]* %58, i64 %indvars.iv84, i64 999
