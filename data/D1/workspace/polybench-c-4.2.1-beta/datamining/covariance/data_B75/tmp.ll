...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph34.split.us
  ...
  store double %14, double* %sunkaddr92, align 8
  ...
  store double %17, double* %sunkaddr92, align 8
  ...
  store double %20, double* %sunkaddr92, align 8
...
._crit_edge30.us:                                 ; preds = %._crit_edge
  %21 = fdiv double %20, %0
  %sunkaddr24 = shl i64 %indvars.iv73, 3
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  br i1 %38, label %._crit_edge25.us.loopexit27, label %vector.body, !llvm.loop !6
...
._crit_edge21:                                    ; preds = %._crit_edge21, %.lr.ph.us.us
  ...
  %63 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %75, %._crit_edge21 ]
