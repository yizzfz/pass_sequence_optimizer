...
for.inc.preheader:                                ; preds = %middle.block28, %vector.memcheck47, %min.iters.checked31, %for.inc.lr.ph
  %indvars.iv7.ph = phi i64 [ %ind.end, %middle.block28 ], [ 1, %vector.memcheck47 ], [ 1, %min.iters.checked31 ], [ 1, %for.inc.lr.ph ]
...
for.inc30.preheader:                              ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.inc30.lr.ph
  %indvars.iv49.ph = phi i64 [ %ind.end, %middle.block ], [ 1, %vector.memcheck ], [ 1, %min.iters.checked ], [ 1, %for.inc30.lr.ph ]
