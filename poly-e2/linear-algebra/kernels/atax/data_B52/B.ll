...
for.body10.us:                                    ; preds = %for.body10.us, %for.body6.us
  ...
  %1 = add nuw nsw i64 %indvars.iv16, %indvars.iv
  ...
  %3 = add nuw nsw i64 %indvars.iv16, %indvars.iv.next
...
for.body5.us.preheader:                           ; preds = %vector.body
  ...
  %scevgep13 = getelementptr double, double* %y, i64 2100
  br label %for.body5.us

for.body5.us:                                     ; preds = %for.inc42.us, %for.body5.us.preheader
  %indvars.iv65 = phi i64 [ 0, %for.body5.us.preheader ], [ %26, %for.inc42.us ]
  %scevgep15 = getelementptr [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 1
  %26 = add i64 %indvars.iv65, 1
  %scevgep17 = getelementptr [2100 x double], [2100 x double]* %A, i64 %26, i64 0
  %sext71 = shl i64 %indvars.iv65, 32
...
for.body26.us.for.body26.us_crit_edge:            ; preds = %for.body26.us.for.body26.us_crit_edge.preheader, %for.body26.us.for.body26.us_crit_edge
  %indvars.iv.next645 = phi i64 [ %indvars.iv.next64, %for.body26.us.for.body26.us_crit_edge ], [ %indvars.iv.next645.ph, %for.body26.us.for.body26.us_crit_edge.preheader ]
  %.pre72 = load double, double* %arrayidx12.us, align 8
  %arrayidx28.us = getelementptr inbounds double, double* %y, i64 %indvars.iv.next645
  %27 = load double, double* %arrayidx28.us, align 8
  %arrayidx32.us = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 %indvars.iv.next645
  %28 = load double, double* %arrayidx32.us, align 8
  %mul35.us = fmul double %28, %.pre72
  %add36.us = fadd double %27, %mul35.us
  store double %add36.us, double* %arrayidx28.us, align 8
  %indvars.iv.next64 = add nuw nsw i64 %indvars.iv.next645, 1
...
for.body26.us.preheader:                          ; preds = %for.body10.us
  ...
  %arrayidx32.us2 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 0
  %37 = load double, double* %arrayidx32.us2, align 8
  %mul35.us3 = fmul double %37, %add.us.2
  %add36.us4 = fadd double %36, %mul35.us3
  store double %add36.us4, double* %y, align 8
  %bound0 = icmp ult double* %scevgep, %arrayidx12.us
  %bound1 = icmp ult double* %arrayidx12.us, %scevgep13
  %found.conflict = and i1 %bound0, %bound1
  %bound020 = icmp ult double* %scevgep, %scevgep17
  %bound121 = icmp ult double* %scevgep15, %scevgep13
  %found.conflict22 = and i1 %bound020, %bound121
  %conflict.rdx = or i1 %found.conflict, %found.conflict22
  br i1 %conflict.rdx, label %for.body26.us.for.body26.us_crit_edge.preheader, label %vector.body7.preheader

vector.body7.preheader:                           ; preds = %for.body26.us.preheader
  br label %vector.body7

for.body26.us.for.body26.us_crit_edge.preheader.loopexit: ; preds = %vector.body7
...
for.body26.us.for.body26.us_crit_edge.preheader:  ; preds = %for.body26.us.for.body26.us_crit_edge.preheader.loopexit, %for.body26.us.preheader
  %indvars.iv.next645.ph = phi i64 [ 1, %for.body26.us.preheader ], [ 2097, %for.body26.us.for.body26.us_crit_edge.preheader.loopexit ]
  br label %for.body26.us.for.body26.us_crit_edge

vector.body7:                                     ; preds = %vector.body7.preheader, %vector.body7
  %index24 = phi i64 [ %index.next25, %vector.body7 ], [ 0, %vector.body7.preheader ]
  %offset.idx = or i64 %index24, 1
  ...
  %wide.load32 = load <2 x double>, <2 x double>* %44, align 8, !alias.scope !8, !noalias !10
  %45 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 %offset.idx
  %46 = bitcast double* %45 to <2 x double>*
  %wide.load33 = load <2 x double>, <2 x double>* %46, align 8, !alias.scope !12
  %47 = getelementptr double, double* %45, i64 2
  %48 = bitcast double* %47 to <2 x double>*
  %wide.load34 = load <2 x double>, <2 x double>* %48, align 8, !alias.scope !12
  %49 = fmul <2 x double> %wide.load33, %40
  %50 = fmul <2 x double> %wide.load34, %40
  %51 = fadd <2 x double> %wide.load, %49
  %52 = fadd <2 x double> %wide.load32, %50
  ...
  %index.next25 = add i64 %index24, 4
  %53 = icmp eq i64 %index.next25, 2096
  br i1 %53, label %for.body26.us.for.body26.us_crit_edge.preheader.loopexit, label %vector.body7, !llvm.loop !13
