...
define void @_Z13Stereo_VisionPhS_S_ii(i8* nocapture readonly, i8* nocapture readonly, i8* nocapture, i32, i32) local_unnamed_addr #2 {
  %6 = sub nsw i32 223, %4
  %7 = icmp sgt i32 %6, 0
  br i1 %7, label %8, label %..loopexit2_crit_edge

..loopexit2_crit_edge:                            ; preds = %5
  br label %.loopexit2
...
; <label>:17:                                     ; preds = %.loopexit1._crit_edge, %8
  %18 = phi i64 [ 0, %8 ], [ %88, %.loopexit1._crit_edge ]
  %19 = mul i64 %18, 280
  %scevgep = getelementptr i8, i8* %2, i64 %19
  br i1 %15, label %20, label %..loopexit1_crit_edge

..loopexit1_crit_edge:                            ; preds = %17
  br label %.loopexit1
...
.split:                                           ; preds = %.loopexit..split_crit_edge, %.split.preheader
  %22 = phi i64 [ %86, %.loopexit..split_crit_edge ], [ 0, %.split.preheader ]
  %23 = sub nsw i64 %22, %10
  %24 = icmp slt i64 %23, %11
  %25 = trunc i64 %23 to i32
  %26 = select i1 %24, i32 %25, i32 %3
  %27 = icmp slt i32 %26, 0
  br i1 %27, label %.split..loopexit_crit_edge, label %28

.split..loopexit_crit_edge:                       ; preds = %.split
  br label %.loopexit
...
; <label>:30:                                     ; preds = %._crit_edge, %28
  %31 = phi float [ %41, %._crit_edge ], [ 0.000000e+00, %28 ]
  %32 = phi i32 [ %40, %._crit_edge ], [ 0, %28 ]
  %33 = phi i32 [ %42, %._crit_edge ], [ 0, %28 ]
  %34 = sub i32 %29, %33
  br label %43
...
; <label>:43:                                     ; preds = %._crit_edge30, %30
  %44 = phi float [ %79, %._crit_edge30 ], [ 0.000000e+00, %30 ]
  %45 = phi float [ %76, %._crit_edge30 ], [ 0.000000e+00, %30 ]
  %46 = phi float [ %73, %._crit_edge30 ], [ 0.000000e+00, %30 ]
  %47 = phi i32 [ %53, %._crit_edge30 ], [ 0, %30 ]
...
; <label>:52:                                     ; preds = %55
  ...
  %54 = icmp eq i32 %53, %4
  br i1 %54, label %35, label %._crit_edge30

._crit_edge30:                                    ; preds = %52
  br label %43

; <label>:55:                                     ; preds = %._crit_edge31, %43
  %56 = phi i64 [ %80, %._crit_edge31 ], [ 0, %43 ]
  %57 = phi float [ %79, %._crit_edge31 ], [ %44, %43 ]
  %58 = phi float [ %76, %._crit_edge31 ], [ %45, %43 ]
  %59 = phi float [ %73, %._crit_edge31 ], [ %46, %43 ]
  ...
  br i1 %81, label %52, label %._crit_edge31
...
.loopexit:                                        ; preds = %.split..loopexit_crit_edge, %.loopexit.loopexit
  %82 = phi i32 [ 0, %.split..loopexit_crit_edge ], [ %40, %.loopexit.loopexit ]
  ...
  br i1 %87, label %.loopexit1.loopexit23, label %.loopexit..split_crit_edge

.loopexit..split_crit_edge:                       ; preds = %.loopexit
  br label %.split
...
.loopexit1.loopexit23:                            ; preds = %.loopexit
  br label %.loopexit1

.loopexit1:                                       ; preds = %..loopexit1_crit_edge, %.loopexit1.loopexit23, %.loopexit1.loopexit
  %88 = add nuw nsw i64 %18, 1
  %89 = icmp eq i64 %88, %14
  br i1 %89, label %.loopexit2.loopexit, label %.loopexit1._crit_edge

.loopexit1._crit_edge:                            ; preds = %.loopexit1
  br label %17
...
; <label>:6:                                      ; preds = %._crit_edge24, %4
  %7 = phi i64 [ 0, %4 ], [ %124, %._crit_edge24 ]
  %8 = mul nuw nsw i64 %7, 280
  br label %9

; <label>:9:                                      ; preds = %.loopexit._crit_edge, %6
  %10 = phi i64 [ 0, %6 ], [ %121, %.loopexit._crit_edge ]
  %11 = add nsw i64 %10, -4
  %12 = icmp slt i64 %11, %5
  %13 = trunc i64 %11 to i32
  %14 = select i1 %12, i32 %13, i32 %3
  %15 = icmp slt i32 %14, 0
  br i1 %15, label %..loopexit_crit_edge, label %16
...
; <label>:18:                                     ; preds = %._crit_edge23, %16
  %19 = phi i64 [ %116, %._crit_edge23 ], [ 0, %16 ]
  %20 = phi float [ %115, %._crit_edge23 ], [ 0.000000e+00, %16 ]
  %21 = phi i32 [ %114, %._crit_edge23 ], [ 0, %16 ]
  %22 = sub nsw i64 %10, %19
  br label %23

; <label>:23:                                     ; preds = %._crit_edge, %18
  %24 = phi i64 [ 0, %18 ], [ %106, %._crit_edge ]
  %25 = phi float [ 0.000000e+00, %18 ], [ %105, %._crit_edge ]
  %26 = phi float [ 0.000000e+00, %18 ], [ %102, %._crit_edge ]
  %27 = phi float [ 0.000000e+00, %18 ], [ %101, %._crit_edge ]
...
; <label>:108:                                    ; preds = %23
  ...
  br i1 %exitcond, label %.loopexit.loopexit, label %._crit_edge23

._crit_edge23:                                    ; preds = %108
  br label %18
...
.loopexit:                                        ; preds = %..loopexit_crit_edge, %.loopexit.loopexit
  %117 = phi i32 [ 0, %..loopexit_crit_edge ], [ %114, %.loopexit.loopexit ]
  ...
  br i1 %122, label %123, label %.loopexit._crit_edge
...
; <label>:123:                                    ; preds = %.loopexit
  ...
  br i1 %125, label %126, label %._crit_edge24

._crit_edge24:                                    ; preds = %123
  br label %6
...
define void @_Z4blurPhS_i(i8* nocapture readonly, i8* nocapture, i32) local_unnamed_addr #2 {
  ...
  %7 = sub nsw i32 223, %2
  %8 = icmp sgt i32 %7, 0
  br i1 %8, label %9, label %..loopexit3_crit_edge
...
; <label>:22:                                     ; preds = %.loopexit2._crit_edge, %9
  %23 = phi i64 [ 0, %9 ], [ %101, %.loopexit2._crit_edge ]
  %24 = trunc i64 %23 to i32
  %25 = mul i64 %23, 1202590842880
  %26 = ashr exact i64 %25, 32
  %27 = getelementptr i8, i8* %1, i64 %26
  br i1 %18, label %28, label %..loopexit2_crit_edge

..loopexit2_crit_edge:                            ; preds = %22
  br label %.loopexit2
...
.preheader1:                                      ; preds = %.us-lcssa.us..preheader1_crit_edge, %.preheader1.preheader
  %32 = phi i64 [ %65, %.us-lcssa.us..preheader1_crit_edge ], [ 0, %.preheader1.preheader ]
...
.split.us:                                        ; preds = %.preheader1
  br i1 %21, label %.split.us..us-lcssa.us_crit_edge, label %.split.us.split.preheader

.split.us..us-lcssa.us_crit_edge:                 ; preds = %.split.us
  br label %.us-lcssa.us

.split.us.split.preheader:                        ; preds = %.split.us
  br label %.split.us.split

.split.us.split:                                  ; preds = %.loopexit.us..split.us.split_crit_edge, %.split.us.split.preheader
  %34 = phi i32 [ %60, %.loopexit.us..split.us.split_crit_edge ], [ 0, %.split.us.split.preheader ]
  %35 = phi float [ %57, %.loopexit.us..split.us.split_crit_edge ], [ 0.000000e+00, %.split.us.split.preheader ]
  %36 = add nuw nsw i32 %34, %24
  %37 = mul nsw i32 %36, 280
  %38 = add i32 %37, %33
  br label %39

; <label>:39:                                     ; preds = %._crit_edge, %.split.us.split
  %40 = phi i64 [ %58, %._crit_edge ], [ 0, %.split.us.split ]
  %41 = phi float [ %57, %._crit_edge ], [ %35, %.split.us.split ]
  ...
  br i1 %59, label %.loopexit.us, label %._crit_edge
...
.loopexit.us:                                     ; preds = %39
  ...
  %61 = icmp eq i32 %60, %2
  br i1 %61, label %.us-lcssa.us.loopexit, label %.loopexit.us..split.us.split_crit_edge

.loopexit.us..split.us.split_crit_edge:           ; preds = %.loopexit.us
  br label %.split.us.split

.us-lcssa.us.loopexit:                            ; preds = %.loopexit.us
  br label %.us-lcssa.us

.us-lcssa.us.loopexit19:                          ; preds = %.loopexit
  br label %.us-lcssa.us

.us-lcssa.us:                                     ; preds = %.split.us..us-lcssa.us_crit_edge, %.us-lcssa.us.loopexit19, %.us-lcssa.us.loopexit
  %.lcssa4 = phi float [ undef, %.split.us..us-lcssa.us_crit_edge ], [ %57, %.us-lcssa.us.loopexit ], [ %78, %.us-lcssa.us.loopexit19 ]
  ...
  br i1 %66, label %.loopexit2.loopexit, label %.us-lcssa.us..preheader1_crit_edge

.us-lcssa.us..preheader1_crit_edge:               ; preds = %.us-lcssa.us
  br label %.preheader1

.split:                                           ; preds = %.loopexit..split_crit_edge, %.split.preheader
  %indvars.iv = phi i64 [ %indvars.iv.next, %.loopexit..split_crit_edge ], [ 0, %.split.preheader ]
  %67 = phi float [ %78, %.loopexit..split_crit_edge ], [ 0.000000e+00, %.split.preheader ]
  ...
  %76 = fmul float %6, %75
  %77 = fadd float %67, %76
  br i1 %21, label %.split..loopexit_crit_edge, label %.preheader.preheader
...
.loopexit:                                        ; preds = %.split..loopexit_crit_edge, %.loopexit.loopexit
  %78 = phi float [ %77, %.split..loopexit_crit_edge ], [ %98, %.loopexit.loopexit ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %79 = icmp eq i64 %indvars.iv.next, %14
  br i1 %79, label %.us-lcssa.us.loopexit19, label %.loopexit..split_crit_edge

.loopexit..split_crit_edge:                       ; preds = %.loopexit
  br label %.split

.preheader:                                       ; preds = %.preheader..preheader_crit_edge, %.preheader.preheader
  %80 = phi i64 [ %99, %.preheader..preheader_crit_edge ], [ 1, %.preheader.preheader ]
  %81 = phi float [ %98, %.preheader..preheader_crit_edge ], [ %77, %.preheader.preheader ]
  ...
  br i1 %100, label %.loopexit.loopexit, label %.preheader..preheader_crit_edge
...
.loopexit3:                                       ; preds = %..loopexit3_crit_edge, %.loopexit3.loopexit
  ret void

.loopexit2.loopexit:                              ; preds = %.us-lcssa.us
  br label %.loopexit2

.loopexit2:                                       ; preds = %..loopexit2_crit_edge, %.loopexit2.loopexit, %31
  %101 = add nuw nsw i64 %23, 1
  %102 = icmp eq i64 %101, %16
  br i1 %102, label %.loopexit3.loopexit, label %.loopexit2._crit_edge

.loopexit2._crit_edge:                            ; preds = %.loopexit2
  br label %22
}
...
; <label>:3:                                      ; preds = %._crit_edge, %2
  ...
  %16 = icmp ult i8* %9, %8
  %17 = and i1 %15, %16
  br i1 %17, label %..preheader.preheader_crit_edge, label %.preheader1.preheader

..preheader.preheader_crit_edge:                  ; preds = %3
...
.preheader.preheader:                             ; preds = %..preheader.preheader_crit_edge, %.preheader.preheader.loopexit
  %.ph = phi i64 [ 0, %..preheader.preheader_crit_edge ], [ 272, %.preheader.preheader.loopexit ]
  br label %.preheader

.preheader1:                                      ; preds = %.preheader1..preheader1_crit_edge, %.preheader1.preheader
  %18 = phi i64 [ %85, %.preheader1..preheader1_crit_edge ], [ 0, %.preheader1.preheader ]
  ...
  br i1 %86, label %.preheader.preheader.loopexit, label %.preheader1..preheader1_crit_edge, !llvm.loop !9
...
.preheader:                                       ; preds = %.preheader..preheader_crit_edge, %.preheader.preheader
  %88 = phi i64 [ %145, %.preheader..preheader_crit_edge ], [ %.ph, %.preheader.preheader ]
  ...
  br i1 %146, label %147, label %.preheader..preheader_crit_edge, !llvm.loop !12
...
; <label>:147:                                    ; preds = %.preheader
  ...
  br i1 %148, label %87, label %._crit_edge
...
; <label>:3:                                      ; preds = %._crit_edge, %.loopexit
  %4 = phi i64 [ 0, %.loopexit ], [ %113, %._crit_edge ]
  %5 = mul nuw nsw i64 %4, 280
  %6 = getelementptr i8, i8* %1, i64 %5
  %7 = add nuw nsw i64 %5, 277
  %8 = getelementptr i8, i8* %1, i64 %7
  ...
  %14 = icmp ult i8* %10, %8
  %15 = and i1 %13, %14
  br i1 %15, label %..preheader_crit_edge, label %25

..preheader_crit_edge:                            ; preds = %3
  br label %.preheader

.preheader:                                       ; preds = %..preheader_crit_edge, %25
  %.ph = phi i64 [ 0, %..preheader_crit_edge ], [ 256, %25 ]
...
; <label>:115:                                    ; preds = %._crit_edge16, %.preheader
  %116 = phi i64 [ %136, %._crit_edge16 ], [ %21, %.preheader ]
  %117 = add i64 %116, %5
  ...
  br i1 %137, label %112, label %._crit_edge16, !llvm.loop !18

._crit_edge16:                                    ; preds = %115
  br label %115
}
...
; <label>:16:                                     ; preds = %._crit_edge25, %0
  %17 = phi i64 [ 0, %0 ], [ %156, %._crit_edge25 ]
...
; <label>:23:                                     ; preds = %._crit_edge24, %19
  %24 = phi i64 [ 0, %19 ], [ %147, %._crit_edge24 ]
  %25 = mul nuw nsw i64 %24, 280
  %26 = shl i64 %24, 32
  %27 = ashr exact i64 %26, 32
  br label %28

; <label>:28:                                     ; preds = %.loopexit._crit_edge, %23
  %29 = phi i64 [ 0, %23 ], [ %144, %.loopexit._crit_edge ]
  %30 = add nsw i64 %29, -4
  %31 = icmp slt i64 %30, 60
  %32 = select i1 %31, i64 %30, i64 60
  %33 = trunc i64 %32 to i32
  %34 = icmp slt i32 %33, 0
  br i1 %34, label %..loopexit_crit_edge, label %35
...
; <label>:40:                                     ; preds = %._crit_edge, %35
  %41 = phi i64 [ %53, %._crit_edge ], [ 0, %35 ]
  %42 = phi float [ %52, %._crit_edge ], [ 0.000000e+00, %35 ]
  %43 = phi i32 [ %51, %._crit_edge ], [ 0, %35 ]
  %44 = sub nsw i64 %37, %41
  br label %55

; <label>:45:                                     ; preds = %55
  %46 = fmul float %133, %133
  %47 = fmul float %134, %137
  %48 = fdiv float %46, %47
  ...
  br i1 %54, label %._crit_edge, label %.loopexit.loopexit

._crit_edge:                                      ; preds = %45
  br label %40

; <label>:55:                                     ; preds = %._crit_edge23, %40
  %56 = phi i64 [ %138, %._crit_edge23 ], [ 0, %40 ]
  %57 = phi float [ %137, %._crit_edge23 ], [ 0.000000e+00, %40 ]
  %58 = phi float [ %134, %._crit_edge23 ], [ 0.000000e+00, %40 ]
  %59 = phi float [ %133, %._crit_edge23 ], [ 0.000000e+00, %40 ]
  ...
  br i1 %139, label %45, label %._crit_edge23
...
.loopexit:                                        ; preds = %..loopexit_crit_edge, %.loopexit.loopexit
  %140 = phi i32 [ 0, %..loopexit_crit_edge ], [ %51, %.loopexit.loopexit ]
  ...
  br i1 %145, label %146, label %.loopexit._crit_edge
...
; <label>:146:                                    ; preds = %.loopexit
  ...
  br i1 %148, label %149, label %._crit_edge24
...
; <label>:155:                                    ; preds = %158
  ...
  br i1 %157, label %19, label %._crit_edge25

._crit_edge25:                                    ; preds = %155
  br label %16

; <label>:158:                                    ; preds = %._crit_edge26, %16
  %159 = phi i64 [ 0, %16 ], [ %165, %._crit_edge26 ]
  ...
  br i1 %166, label %155, label %._crit_edge26

._crit_edge26:                                    ; preds = %158
  br label %158

; <label>:167:                                    ; preds = %._crit_edge27, %149
  %168 = phi i64 [ 0, %149 ], [ %174, %._crit_edge27 ]
...
; <label>:173:                                    ; preds = %176
  ...
  br i1 %175, label %170, label %._crit_edge27

._crit_edge27:                                    ; preds = %173
  br label %167

; <label>:176:                                    ; preds = %._crit_edge28, %167
  %177 = phi i64 [ 0, %167 ], [ %187, %._crit_edge28 ]
  ...
  br i1 %188, label %173, label %._crit_edge28

._crit_edge28:                                    ; preds = %176
  br label %176
}
