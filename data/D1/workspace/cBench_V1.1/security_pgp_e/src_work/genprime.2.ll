...
@__llvm_prf_nm = private constant [138 x i8] c"\87\01\00randomprime\01tmp1.ll:randombits\01tmp1.ll:nextprime\01mp_gcd\01mp_inv\01tmp1.ll:randomunit\01tmp1.ll:buildsieve\01tmp1.ll:fastsieve\01tmp1.ll:slowtest", section "__llvm_prf_names"
@llvm.used = appending global [10 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_randomprime to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_randombits to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_nextprime to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_mp_gcd to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_mp_inv to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_randomunit to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_buildsieve to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_fastsieve to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_slowtest to i8*), i8* getelementptr inbounds ([138 x i8], [138 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
...
; <label>:60:                                     ; preds = %47
  ...
  %74 = call i8* (i64, ...) bitcast (i8* (...)* @malloc to i8* (i64, ...)*)(i64 2058)
...
; <label>:139:                                    ; preds = %124
  ...
  %141 = call i32 (i16*, ...) bitcast (i32 (...)* @free to i32 (i16*, ...)*)(i16* %140)
