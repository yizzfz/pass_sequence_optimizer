...
@__llvm_prf_nm = private constant [28 x i8] c"\15\1Ax\DAKI.13a,\C9-0\D4\CB\C9\B1J\01\F1\E2\0D\01J2\06\9E", section "__llvm_prf_names"
@llvm.used = appending global [3 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_dct64 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_dct64_1 to i8*), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
