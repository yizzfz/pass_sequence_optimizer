...
for.body17:                                       ; preds = %for.inc36, %for.body17.preheader
...
if.end:                                           ; preds = %for.body, %if.then
  ...
  br i1 %exitcond12, label %for.cond.for.end_crit_edge, label %for.body
...
for.body9:                                        ; preds = %if.end14, %for.cond.for.end_crit_edge
  %indvars.iv = phi i64 [ %indvars.iv.next, %if.end14 ], [ 0, %for.cond.for.end_crit_edge ]
  %9 = trunc i64 %indvars.iv to i32
  %rem10 = srem i32 %9, 20
