...
for.cond10.preheader.us:                          ; preds = %for.cond10.preheader.us.preheader, %for.cond10.for.inc34_crit_edge.us
  ...
  %scevgep135 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %0, i64 0
  %scevgep138 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %0, i64 1200
  %scevgep141 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvar, i64 0
  %scevgep144 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %0, i64 1200
  %bound0146 = icmp ult double* %scevgep135, %scevgep144
  %bound1147 = icmp ult double* %scevgep141, %scevgep138
  %memcheck.conflict149 = and i1 %bound0146, %bound1147
  br i1 %memcheck.conflict149, label %for.body12.us.preheader, label %vector.body125.preheader

vector.body125.preheader:                         ; preds = %for.cond10.preheader.us
  br label %vector.body125

vector.body125:                                   ; preds = %vector.body125.preheader, %vector.body125
  %index152 = phi i64 [ %index.next153, %vector.body125 ], [ 0, %vector.body125.preheader ]
  %2 = shl i64 %index152, 1
  %3 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv26, i64 %2
  %4 = bitcast double* %3 to <4 x double>*
  %wide.vec161 = load <4 x double>, <4 x double>* %4, align 8, !alias.scope !3, !noalias !6
  %strided.vec162 = shufflevector <4 x double> %wide.vec161, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  ...
  %wide.vec164 = load <4 x double>, <4 x double>* %6, align 8, !alias.scope !6
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %1, i64 %2
  %8 = bitcast double* %7 to <4 x double>*
  %wide.vec167 = load <4 x double>, <4 x double>* %8, align 8, !alias.scope !6
  %9 = fsub <4 x double> %wide.vec164, %wide.vec167
  ...
  %18 = fsub <2 x double> %strided.vec163, %17
  %19 = getelementptr double, double* %14, i64 -1
  %20 = bitcast double* %19 to <4 x double>*
  %interleaved.vec170 = shufflevector <2 x double> %12, <2 x double> %18, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec170, <4 x double>* %20, align 8, !alias.scope !3, !noalias !6
  %index.next153 = add i64 %index152, 2
  %21 = icmp eq i64 %index.next153, 600
  br i1 %21, label %middle.block126, label %vector.body125, !llvm.loop !8
...
for.cond10.for.inc34_crit_edge.us:                ; preds = %for.cond10.for.inc34_crit_edge.us.loopexit, %middle.block126
...
for.body3:                                        ; preds = %for.cond1.preheader, %for.body3
  ...
  %sunkaddr171 = mul i64 %indvars.iv51, 8
  %sunkaddr172 = add i64 %sunkaddr, %sunkaddr171
  %sunkaddr173 = inttoptr i64 %sunkaddr172 to i64*
  %28 = load i64, i64* %sunkaddr173, align 8
  ...
  %30 = load i64, i64* %sunkaddr173, align 8
  ...
  %32 = load i64, i64* %sunkaddr173, align 8
  ...
  %34 = load i64, i64* %sunkaddr173, align 8
  ...
  %36 = load i64, i64* %sunkaddr173, align 8
  ...
  %38 = load i64, i64* %sunkaddr173, align 8
  ...
  %40 = load i64, i64* %sunkaddr173, align 8
  ...
  %42 = load i64, i64* %sunkaddr173, align 8
...
for.cond40.preheader.us:                          ; preds = %for.cond40.preheader.us.preheader, %for.cond40.for.inc66_crit_edge.us
  ...
  %scevgep94 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv38, i64 2
  %scevgep97 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv38, i64 1200
  %scevgep100 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv38, i64 1
  %scevgep103 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv38, i64 1200
  %bound0105 = icmp ult double* %scevgep94, %scevgep103
  %bound1106 = icmp ult double* %scevgep100, %scevgep97
  %memcheck.conflict108 = and i1 %bound0105, %bound1106
  br i1 %memcheck.conflict108, label %for.body42.us.preheader, label %vector.body88.preheader

vector.body88.preheader:                          ; preds = %for.cond40.preheader.us
...
vector.body88:                                    ; preds = %vector.body88.preheader, %vector.body88
  ...
  %strided.vec118 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  ...
  %wide.vec119 = load <4 x double>, <4 x double>* %52, align 8, !alias.scope !15
  ...
  %53 = fsub <2 x double> %strided.vec121, %strided.vec120
  ...
  %wide.vec122 = load <4 x double>, <4 x double>* %60, align 8, !alias.scope !15
  ...
  %61 = fsub <2 x double> %strided.vec124, %strided.vec123
  %62 = fmul <2 x double> %61, <double 5.000000e-01, double 5.000000e-01>
  %63 = fsub <2 x double> %strided.vec118, %62
  ...
  %66 = icmp eq i64 %index.next112, 598
  br i1 %66, label %middle.block89, label %vector.body88, !llvm.loop !17

middle.block89:                                   ; preds = %vector.body88
  br label %for.body42.us.preheader

for.body42.us.preheader:                          ; preds = %middle.block89, %for.cond40.preheader.us
  %indvars.iv31.ph = phi i64 [ 2, %for.cond40.preheader.us ], [ 1198, %middle.block89 ]
...
for.cond73.preheader.us:                          ; preds = %for.cond73.preheader.us.preheader, %for.cond73.for.inc110_crit_edge.us
  ...
  %scevgep65 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv47, i64 1199
  %scevgep67 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv47, i64 0
  %74 = add i64 %indvars.iv47, 1
  %scevgep69 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %74, i64 0
  %scevgep71 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %indvars.iv47, i64 0
  %scevgep73 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %74, i64 1199
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load79 = load <2 x double>, <2 x double>* %78, align 8, !alias.scope !19, !noalias !22
  %79 = or i64 %index, 1
  %80 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv47, i64 %79
  %81 = bitcast double* %80 to <2 x double>*
  %wide.load80 = load <2 x double>, <2 x double>* %81, align 8, !alias.scope !25
  %82 = getelementptr double, double* %80, i64 2
  %83 = bitcast double* %82 to <2 x double>*
  %wide.load81 = load <2 x double>, <2 x double>* %83, align 8, !alias.scope !25
  %84 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv47, i64 %index
  %85 = bitcast double* %84 to <2 x double>*
  %wide.load82 = load <2 x double>, <2 x double>* %85, align 8, !alias.scope !25
  %86 = getelementptr double, double* %84, i64 2
  %87 = bitcast double* %86 to <2 x double>*
  %wide.load83 = load <2 x double>, <2 x double>* %87, align 8, !alias.scope !25
  %88 = fsub <2 x double> %wide.load80, %wide.load82
  %89 = fsub <2 x double> %wide.load81, %wide.load83
  %90 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv.next48, i64 %index
  %91 = bitcast double* %90 to <2 x double>*
  %wide.load84 = load <2 x double>, <2 x double>* %91, align 8, !alias.scope !26
  %92 = getelementptr double, double* %90, i64 2
  %93 = bitcast double* %92 to <2 x double>*
  %wide.load85 = load <2 x double>, <2 x double>* %93, align 8, !alias.scope !26
  %94 = fadd <2 x double> %88, %wide.load84
  %95 = fadd <2 x double> %89, %wide.load85
  %96 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv47, i64 %index
  %97 = bitcast double* %96 to <2 x double>*
  %wide.load86 = load <2 x double>, <2 x double>* %97, align 8, !alias.scope !26
  %98 = getelementptr double, double* %96, i64 2
  %99 = bitcast double* %98 to <2 x double>*
  %wide.load87 = load <2 x double>, <2 x double>* %99, align 8, !alias.scope !26
  %100 = fsub <2 x double> %94, %wide.load86
  %101 = fsub <2 x double> %95, %wide.load87
  ...
  %105 = fsub <2 x double> %wide.load79, %103
