...
.loopexit:                                        ; preds = %.loopexit.loopexit, %.split
  ...
  br i1 %87, label %.loopexit1.loopexit21, label %.split

.loopexit1.loopexit:                              ; preds = %20
  call void @llvm.memset.p0i8.i64(i8* %scevgep, i8 0, i64 %13, i32 1, i1 false)
  br label %.loopexit1

.loopexit1.loopexit21:                            ; preds = %.loopexit
  br label %.loopexit1

.loopexit1:                                       ; preds = %.loopexit1.loopexit21, %.loopexit1.loopexit, %17
...
; <label>:22:                                     ; preds = %.loopexit2, %9
  ...
  br i1 %11, label %28, label %.loopexit2

; <label>:28:                                     ; preds = %22
  %29 = mul nuw nsw i64 %23, 280
  br i1 %12, label %.preheader1.preheader, label %31
...
.us-lcssa.us.loopexit17:                          ; preds = %.loopexit
  br label %.us-lcssa.us

.us-lcssa.us:                                     ; preds = %.us-lcssa.us.loopexit17, %.us-lcssa.us.loopexit, %.split.us
  %.lcssa4 = phi float [ undef, %.split.us ], [ %57, %.us-lcssa.us.loopexit ], [ %78, %.us-lcssa.us.loopexit17 ]
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %.split
  ...
  %79 = icmp eq i64 %indvars.iv.next, %16
  br i1 %79, label %.us-lcssa.us.loopexit17, label %.split
