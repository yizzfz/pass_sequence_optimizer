...
._crit_edge18.us:                                 ; preds = %._crit_edge
  ...
  %exitcond81 = icmp eq i64 %indvars.iv.next75, 800
  br i1 %exitcond81, label %.lr.ph14.split.us.new.preheader.preheader, label %.lr.ph20.split.us
...
._crit_edge12.us:                                 ; preds = %.lr.ph14.split.us.new
  ...
  %exitcond80 = icmp eq i64 %indvars.iv.next67, 1100
  br i1 %exitcond80, label %.lr.ph8.split.us.preheader, label %.lr.ph14.split.us.new.preheader
...
._crit_edge6.us:                                  ; preds = %._crit_edge94
  ...
  %exitcond79 = icmp eq i64 %indvars.iv.next59, 900
  br i1 %exitcond79, label %.lr.ph2.split.us.preheader, label %.lr.ph8.split.us
...
._crit_edge.us:                                   ; preds = %._crit_edge95
  ...
  %exitcond78 = icmp eq i64 %indvars.iv.next53, 800
  br i1 %exitcond78, label %45, label %.lr.ph2.split.us
...
._crit_edge12.us:                                 ; preds = %._crit_edge9.us.us
  ...
  %exitcond93 = icmp eq i64 %indvar.next, 800
  br i1 %exitcond93, label %.lr.ph.us.us.preheader.preheader, label %.lr.ph8.us.us.preheader
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph8.us.us
  ...
  %exitcond92.1 = icmp eq i64 %indvars.iv.next75.1, 1100
  br i1 %exitcond92.1, label %._crit_edge9.us.us, label %._crit_edge
...
._crit_edge3.us:                                  ; preds = %._crit_edge.us.us
  ...
  %exitcond99 = icmp eq i64 %indvars.iv.next69, 800
  br i1 %exitcond99, label %49, label %.lr.ph.us.us.preheader
...
._crit_edge.us.us:                                ; preds = %._crit_edge98
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1
  %exitcond67 = icmp eq i64 %indvars.iv.next65, 1200
  br i1 %exitcond67, label %._crit_edge3.us, label %.lr.ph.us.us

._crit_edge98:                                    ; preds = %._crit_edge98, %.lr.ph.us.us
  %30 = phi double [ %29, %.lr.ph.us.us ], [ %48, %._crit_edge98 ]
  %indvars.iv62 = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next63.2, %._crit_edge98 ]
  ...
  br i1 %exitcond.2, label %._crit_edge.us.us, label %._crit_edge98
...
._crit_edge15:                                    ; preds = %._crit_edge, %.lr.ph2.split.us
...
._crit_edge.us:                                   ; preds = %._crit_edge
  ...
  br i1 %exitcond12, label %18, label %.lr.ph2.split.us
