...
.loopexit:                                        ; preds = %32
  br i1 %10, label %46, label %.loopexit._crit_edge

.loopexit._crit_edge:                             ; preds = %.loopexit
  br label %6

; <label>:6:                                      ; preds = %.loopexit._crit_edge, %5
  %indvars.iv4 = phi i64 [ 0, %5 ], [ %indvars.iv.next5, %.loopexit._crit_edge ]
...
; <label>:32:                                     ; preds = %._crit_edge, %6
  %indvars.iv = phi i64 [ 0, %6 ], [ %indvars.iv.next.1, %._crit_edge ]
...
.preheader4:                                      ; preds = %..preheader4_crit_edge, %5
  %indvars.iv14 = phi i64 [ 0, %5 ], [ %indvars.iv.next15, %..preheader4_crit_edge ]
  %6 = getelementptr inbounds double, double* %0, i64 %indvars.iv14
  %.pre = load double, double* %6, align 8
  br label %7

; <label>:7:                                      ; preds = %._crit_edge, %.preheader4
  %8 = phi double [ %.pre, %.preheader4 ], [ %20, %._crit_edge ]
  %indvars.iv11 = phi i64 [ 0, %.preheader4 ], [ %indvars.iv.next12.1, %._crit_edge ]
  ...
  br i1 %exitcond13.1, label %21, label %._crit_edge
...
; <label>:21:                                     ; preds = %7
  ...
  br i1 %exitcond16, label %.preheader.preheader, label %..preheader4_crit_edge

..preheader4_crit_edge:                           ; preds = %21
  br label %.preheader4
...
.preheader:                                       ; preds = %..preheader_crit_edge, %.preheader.preheader
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %..preheader_crit_edge ], [ 0, %.preheader.preheader ]
  %22 = getelementptr inbounds double, double* %1, i64 %indvars.iv9
  %.pre17 = load double, double* %22, align 8
  br label %23

; <label>:23:                                     ; preds = %._crit_edge1, %.preheader
  %24 = phi double [ %.pre17, %.preheader ], [ %36, %._crit_edge1 ]
  ...
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %37, label %._crit_edge1

._crit_edge1:                                     ; preds = %23
  br label %23

; <label>:37:                                     ; preds = %23
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  %exitcond = icmp eq i64 %indvars.iv.next10, 2000
  br i1 %exitcond, label %38, label %..preheader_crit_edge
...
; <label>:7:                                      ; preds = %._crit_edge1, %2
  %indvars.iv7 = phi i64 [ 0, %2 ], [ %indvars.iv.next8, %._crit_edge1 ]
  %8 = trunc i64 %indvars.iv7 to i32
  %9 = srem i32 %8, 20
  %10 = icmp eq i32 %9, 0
...
; <label>:13:                                     ; preds = %._crit_edge, %11
  ...
  %15 = getelementptr inbounds double, double* %0, i64 %indvars.iv7
  %16 = load double, double* %15, align 8
  %17 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %14, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i64 0, i64 0), double %16) #6
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %exitcond9 = icmp eq i64 %indvars.iv.next8, 2000
  br i1 %exitcond9, label %18, label %._crit_edge1
...
; <label>:23:                                     ; preds = %._crit_edge3, %18
  %indvars.iv = phi i64 [ 0, %18 ], [ %indvars.iv.next, %._crit_edge3 ]
...
; <label>:29:                                     ; preds = %._crit_edge2, %27
  ...
  br i1 %exitcond, label %34, label %._crit_edge3
