...
for.cond1.preheader:                              ; preds = %for.end41, %for.cond1.preheader.lr.ph
  %14 = phi i32 [ 0, %for.cond1.preheader.lr.ph ], [ %inc43, %for.end41 ]
  br i1 %5, label %for.cond4.preheader.lr.ph, label %for.end41

for.cond4.preheader.lr.ph:                        ; preds = %for.cond1.preheader
  %idxprom10 = sext i32 %14 to i64
  br i1 %6, label %for.cond4.preheader.us.preheader, label %for.cond4.preheader.lr.ph.for.cond4.preheader_crit_edge

for.cond4.preheader.us.preheader:                 ; preds = %for.cond4.preheader.lr.ph
  br label %for.cond4.preheader.us

for.cond4.preheader.lr.ph.for.cond4.preheader_crit_edge: ; preds = %for.cond4.preheader.lr.ph
  %idxprom30 = sext i32 %14 to i64
  br label %for.cond4.preheader

for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.end38.us
  %15 = phi i32 [ %split16.us, %for.end38.us ], [ %14, %for.cond4.preheader.us.preheader ]
  %indvars.iv720.us = phi i64 [ %indvars.iv.next8.us, %for.end38.us ], [ 0, %for.cond4.preheader.us.preheader ]
  br i1 %7, label %for.cond4.for.cond25.preheader_crit_edge.us.loopexit, label %for.cond4.preheader.us.for.body6.us25_crit_edge
...
for.body27.us:                                    ; preds = %for.body27.us.preheader, %for.body27.us
  ...
  %indvars.iv.next6.us.3 = add nuw nsw i64 %indvars.iv518.us, 4
  %exitcond56.3 = icmp eq i64 %indvars.iv.next6.us.3, %0
  br i1 %exitcond56.3, label %for.end38.us.loopexit, label %for.body27.us

for.body6.us25:                                   ; preds = %for.cond7.for.end_crit_edge.us42, %for.cond4.preheader.us.for.body6.us25_crit_edge
  %indvars.iv314.us26 = phi i64 [ 0, %for.cond4.preheader.us.for.body6.us25_crit_edge ], [ %indvars.iv.next4.us39, %for.cond7.for.end_crit_edge.us42 ]
...
for.body9.us28.prol:                              ; preds = %for.body6.us25
  %28 = load double, double* %arrayidx15.us30.prol, align 8
  %arrayidx19.us31.prol = getelementptr inbounds [160 x double], [160 x double]* %2, i64 0, i64 %indvars.iv314.us26
  %29 = load double, double* %arrayidx19.us31.prol, align 8
  %mul.us32.prol = fmul double %28, %29
...
for.body9.us28.prol.loopexit:                     ; preds = %for.body6.us25, %for.body9.us28.prol
  ...
  br i1 %11, label %for.cond7.for.end_crit_edge.us42, label %for.body9.us28.prol.loopexit.for.body9.us28_crit_edge

for.body9.us28.prol.loopexit.for.body9.us28_crit_edge: ; preds = %for.body9.us28.prol.loopexit
...
for.body9.us28:                                   ; preds = %for.body9.us28, %for.body9.us28.prol.loopexit.for.body9.us28_crit_edge
  %30 = phi double [ %.unr.ph, %for.body9.us28.prol.loopexit.for.body9.us28_crit_edge ], [ %add.us33.1, %for.body9.us28 ]
  %indvars.iv12.us29 = phi i64 [ %indvars.iv12.us29.unr.ph, %for.body9.us28.prol.loopexit.for.body9.us28_crit_edge ], [ %indvars.iv.next.us34.1, %for.body9.us28 ]
  ...
  %31 = load double, double* %arrayidx15.us30, align 8
  %arrayidx19.us31 = getelementptr inbounds [160 x double], [160 x double]* %2, i64 %indvars.iv12.us29, i64 %indvars.iv314.us26
  %32 = load double, double* %arrayidx19.us31, align 8
  %mul.us32 = fmul double %31, %32
  %add.us33 = fadd double %30, %mul.us32
  ...
  %33 = load double, double* %arrayidx15.us30.1, align 8
  %arrayidx19.us31.1 = getelementptr inbounds [160 x double], [160 x double]* %2, i64 %indvars.iv.next.us34, i64 %indvars.iv314.us26
  %34 = load double, double* %arrayidx19.us31.1, align 8
  %mul.us32.1 = fmul double %33, %34
  %add.us33.1 = fadd double %add.us33, %mul.us32.1
  store double %add.us33.1, double* %sunkaddr71, align 8
  %indvars.iv.next.us34.1 = add nuw nsw i64 %indvars.iv12.us29, 2
...
for.cond7.for.end_crit_edge.us42:                 ; preds = %for.cond7.for.end_crit_edge.us42.loopexit, %for.body9.us28.prol.loopexit
  ...
  br i1 %exitcond52, label %for.cond4.for.cond25.preheader_crit_edge.us.loopexit76, label %for.body6.us25
...
for.cond4.for.cond25.preheader_crit_edge.us.loopexit76: ; preds = %for.cond7.for.end_crit_edge.us42
  br label %for.cond4.for.cond25.preheader_crit_edge.us

for.cond4.for.cond25.preheader_crit_edge.us:      ; preds = %for.cond4.for.cond25.preheader_crit_edge.us.loopexit76, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit
  %split16.us = phi i32 [ %15, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit ], [ %14, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit76 ]
...
for.body27.us.prol:                               ; preds = %for.body27.us.prol.preheader, %for.body27.us.prol.for.body27.us.prol_crit_edge
  %indvars.iv518.us.prol = phi i64 [ %indvars.iv.next6.us.prol, %for.body27.us.prol.for.body27.us.prol_crit_edge ], [ 0, %for.body27.us.prol.preheader ]
  %prol.iter64 = phi i64 [ %prol.iter64.sub, %for.body27.us.prol.for.body27.us.prol_crit_edge ], [ %xtraiter62, %for.body27.us.prol.preheader ]
  ...
  %prol.iter64.sub = add nsw i64 %prol.iter64, -1
  %prol.iter64.cmp = icmp eq i64 %prol.iter64.sub, 0
  br i1 %prol.iter64.cmp, label %for.body27.us.prol.loopexit.loopexit, label %for.body27.us.prol.for.body27.us.prol_crit_edge, !llvm.loop !1
...
for.body27.us.prol.loopexit:                      ; preds = %for.body27.us.prol.loopexit.loopexit, %for.body27.lr.ph.us
  %indvars.iv518.us.unr = phi i64 [ 0, %for.body27.lr.ph.us ], [ %xtraiter, %for.body27.us.prol.loopexit.loopexit ]
  br i1 %10, label %for.end38.us, label %for.body27.us.preheader

for.body27.us.preheader:                          ; preds = %for.body27.us.prol.loopexit
  br label %for.body27.us

for.cond4.preheader:                              ; preds = %for.end38, %for.cond4.preheader.lr.ph.for.cond4.preheader_crit_edge
  %indvars.iv720 = phi i64 [ 0, %for.cond4.preheader.lr.ph.for.cond4.preheader_crit_edge ], [ %indvars.iv.next8, %for.end38 ]
...
for.body27.prol:                                  ; preds = %for.body27.prol.preheader, %for.body27.prol.for.body27.prol_crit_edge
  %indvars.iv518.prol = phi i64 [ %indvars.iv.next6.prol, %for.body27.prol.for.body27.prol_crit_edge ], [ 0, %for.body27.prol.preheader ]
  %prol.iter = phi i64 [ %prol.iter.sub, %for.body27.prol.for.body27.prol_crit_edge ], [ %xtraiter, %for.body27.prol.preheader ]
  %arrayidx29.prol = getelementptr inbounds double, double* %sum, i64 %indvars.iv518.prol
  %38 = bitcast double* %arrayidx29.prol to i64*
  %39 = load i64, i64* %38, align 8
  %arrayidx35.prol = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %idxprom30, i64 %indvars.iv720, i64 %indvars.iv518.prol
...
for.body27.prol.for.body27.prol_crit_edge:        ; preds = %for.body27.prol
  %indvars.iv.next6.prol = add nuw nsw i64 %indvars.iv518.prol, 1
  br label %for.body27.prol
...
for.body27.prol.loopexit:                         ; preds = %for.body27.prol.loopexit.loopexit, %for.body27.lr.ph
  %indvars.iv518.unr = phi i64 [ 0, %for.body27.lr.ph ], [ %xtraiter, %for.body27.prol.loopexit.loopexit ]
...
for.body27:                                       ; preds = %for.body27.preheader, %for.body27
  %indvars.iv518 = phi i64 [ %indvars.iv.next6.3, %for.body27 ], [ %indvars.iv518.unr, %for.body27.preheader ]
  ...
  %arrayidx35.1 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %idxprom30, i64 %indvars.iv720, i64 %indvars.iv.next6
  ...
  %arrayidx35.2 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %idxprom30, i64 %indvars.iv720, i64 %indvars.iv.next6.1
  %49 = bitcast double* %arrayidx35.2 to i64*
  store i64 %48, i64* %49, align 8
  %indvars.iv.next6.2 = add nsw i64 %indvars.iv518, 3
  %arrayidx29.3 = getelementptr inbounds double, double* %sum, i64 %indvars.iv.next6.2
  %50 = bitcast double* %arrayidx29.3 to i64*
  %51 = load i64, i64* %50, align 8
  %arrayidx35.3 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %idxprom30, i64 %indvars.iv720, i64 %indvars.iv.next6.2
  %52 = bitcast double* %arrayidx35.3 to i64*
  store i64 %51, i64* %52, align 8
  %indvars.iv.next6.3 = add nuw nsw i64 %indvars.iv518, 4
...
for.end38:                                        ; preds = %for.end38.loopexit, %for.body27.prol.loopexit, %for.cond4.preheader
  ...
  %exitcond51 = icmp eq i64 %indvars.iv.next8, %1
  br i1 %exitcond51, label %for.end41.loopexit77, label %for.cond4.preheader

for.end41.loopexit:                               ; preds = %for.end38.us
  br label %for.end41

for.end41.loopexit77:                             ; preds = %for.end38
  br label %for.end41

for.end41:                                        ; preds = %for.end41.loopexit77, %for.end41.loopexit, %for.cond1.preheader
  %.lcssa10 = phi i32 [ %14, %for.cond1.preheader ], [ %split16.us, %for.end41.loopexit ], [ %14, %for.end41.loopexit77 ]
