...
for.inc24.us.prol.loopexit:                       ; preds = %for.body5.us, %for.inc24.us.prol
...
for.inc31.us:                                     ; preds = %for.inc31.us, %for.body3.us
  ...
  %sunkaddr39 = add i64 %33, %sunkaddr
  %sunkaddr40 = inttoptr i64 %sunkaddr39 to double*
  %37 = load double, double* %sunkaddr40, align 8
  ...
  %sunkaddr41 = ptrtoint double* %21 to i64
  %sunkaddr42 = mul i64 %indvars.iv14, 8
  %sunkaddr43 = add i64 %sunkaddr41, %sunkaddr42
  %sunkaddr44 = inttoptr i64 %sunkaddr43 to double*
  %39 = load double, double* %sunkaddr44, align 8
