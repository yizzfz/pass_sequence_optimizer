...
.prol.loopexit282:                                ; preds = %.preheader178.us, %.prol.preheader281
  ...
  br i1 false, label %._crit_edge216.us, label %.prol.loopexit282..preheader178.us.new_crit_edge

.prol.loopexit282..preheader178.us.new_crit_edge: ; preds = %.prol.loopexit282
  br label %.preheader178.us.new

.preheader178.us.new:                             ; preds = %.preheader178.us.new, %.prol.loopexit282..preheader178.us.new_crit_edge
  %indvars.iv250.us = phi i64 [ %indvars.iv250.us.unr.ph, %.prol.loopexit282..preheader178.us.new_crit_edge ], [ %indvars.iv.next251.us.1, %.preheader178.us.new ]
  %.0155213.us = phi float [ 0.000000e+00, %.prol.loopexit282..preheader178.us.new_crit_edge ], [ %63, %.preheader178.us.new ]
  %.0157212.us = phi float [ 0.000000e+00, %.prol.loopexit282..preheader178.us.new_crit_edge ], [ %61, %.preheader178.us.new ]
  %.0159211.us = phi float [ 0.000000e+00, %.prol.loopexit282..preheader178.us.new_crit_edge ], [ %49, %.preheader178.us.new ]
...
.prol.loopexit278:                                ; preds = %.preheader176.us, %.prol.preheader277
  ...
  br i1 false, label %._crit_edge209.us, label %.prol.loopexit278..preheader176.us.new_crit_edge

.prol.loopexit278..preheader176.us.new_crit_edge: ; preds = %.prol.loopexit278
  br label %.preheader176.us.new

.preheader176.us.new:                             ; preds = %.preheader176.us.new, %.prol.loopexit278..preheader176.us.new_crit_edge
  %indvars.iv244.us.in = phi i64 [ %indvars.iv244.us.in.unr.ph, %.prol.loopexit278..preheader176.us.new_crit_edge ], [ %indvars.iv244.us.1, %.preheader176.us.new ]
  %.0161206.us = phi float [ 0.000000e+00, %.prol.loopexit278..preheader176.us.new_crit_edge ], [ %90, %.preheader176.us.new ]
  %.0162205.us = phi float [ 0.000000e+00, %.prol.loopexit278..preheader176.us.new_crit_edge ], [ %80, %.preheader176.us.new ]
  %.0165204.us = phi float [ %.0165204.us.unr.ph, %.prol.loopexit278..preheader176.us.new_crit_edge ], [ %87, %.preheader176.us.new ]
  %.0167203.us = phi float [ 0.000000e+00, %.prol.loopexit278..preheader176.us.new_crit_edge ], [ %77, %.preheader176.us.new ]
...
vector.memcheck:                                  ; preds = %min.iters.checked
  ...
  br i1 %conflict.rdx, label %.preheader174.us.new.preheader372, label %vector.memcheck.vector.body_crit_edge
...
.preheader174.us.new.preheader372:                ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.preheader174.us.new.preheader
  %indvars.iv236.us.ph = phi i64 [ %indvars.iv236.us.unr.ph, %.preheader174.us.new.preheader ], [ %indvars.iv236.us.unr.ph, %min.iters.checked ], [ %indvars.iv236.us.unr.ph, %vector.memcheck ], [ %ind.end, %middle.block ]
  br label %.preheader174.us.new

.preheader174.us.new:                             ; preds = %.preheader174.us.new, %.preheader174.us.new.preheader372
  %indvars.iv236.us = phi i64 [ %indvars.iv236.us.ph, %.preheader174.us.new.preheader372 ], [ %indvars.iv.next237.us.1, %.preheader174.us.new ]
...
.prol.loopexit270:                                ; preds = %.preheader172.us, %.prol.preheader269
  ...
  br i1 false, label %._crit_edge196.us, label %.prol.loopexit270..preheader172.us.new_crit_edge

.prol.loopexit270..preheader172.us.new_crit_edge: ; preds = %.prol.loopexit270
  br label %.preheader172.us.new

.preheader172.us.new:                             ; preds = %.preheader172.us.new, %.prol.loopexit270..preheader172.us.new_crit_edge
  %indvars.iv228.us = phi i64 [ %indvars.iv228.us.unr.ph, %.prol.loopexit270..preheader172.us.new_crit_edge ], [ %indvars.iv.next229.us.1, %.preheader172.us.new ]
  %.0156193.us = phi float [ 0.000000e+00, %.prol.loopexit270..preheader172.us.new_crit_edge ], [ %149, %.preheader172.us.new ]
  %.1158192.us = phi float [ 0.000000e+00, %.prol.loopexit270..preheader172.us.new_crit_edge ], [ %147, %.preheader172.us.new ]
  %.1160191.us = phi float [ 0.000000e+00, %.prol.loopexit270..preheader172.us.new_crit_edge ], [ %136, %.preheader172.us.new ]
...
.prol.loopexit266:                                ; preds = %.preheader170.us, %.prol.preheader265
  ...
  br i1 false, label %._crit_edge189.us, label %.prol.loopexit266..preheader170.us.new_crit_edge

.prol.loopexit266..preheader170.us.new_crit_edge: ; preds = %.prol.loopexit266
  br label %.preheader170.us.new

.preheader170.us.new:                             ; preds = %.preheader170.us.new, %.prol.loopexit266..preheader170.us.new_crit_edge
  %indvars.iv222.us.in = phi i64 [ %indvars.iv222.us.in.unr.ph, %.prol.loopexit266..preheader170.us.new_crit_edge ], [ %indvars.iv222.us.1, %.preheader170.us.new ]
  %.0163186.us = phi float [ 0.000000e+00, %.prol.loopexit266..preheader170.us.new_crit_edge ], [ %176, %.preheader170.us.new ]
  %.0164185.us = phi float [ 0.000000e+00, %.prol.loopexit266..preheader170.us.new_crit_edge ], [ %166, %.preheader170.us.new ]
  %.1166184.us = phi float [ %.1166184.us.unr.ph, %.prol.loopexit266..preheader170.us.new_crit_edge ], [ %173, %.preheader170.us.new ]
  %.1168183.us = phi float [ 0.000000e+00, %.prol.loopexit266..preheader170.us.new_crit_edge ], [ %163, %.preheader170.us.new ]
...
vector.memcheck353:                               ; preds = %min.iters.checked322
  ...
  br i1 %conflict.rdx351, label %.preheader.us.new.preheader371, label %vector.memcheck353.vector.body318_crit_edge

vector.memcheck353.vector.body318_crit_edge:      ; preds = %vector.memcheck353
  br label %vector.body318

vector.body318:                                   ; preds = %vector.body318, %vector.memcheck353.vector.body318_crit_edge
  %index355 = phi i64 [ 0, %vector.memcheck353.vector.body318_crit_edge ], [ %index.next356, %vector.body318 ]
...
.preheader.us.new.preheader371:                   ; preds = %middle.block319, %vector.memcheck353, %min.iters.checked322, %.preheader.us.new.preheader
  %indvars.iv.us.ph = phi i64 [ %indvars.iv.us.unr.ph, %.preheader.us.new.preheader ], [ %indvars.iv.us.unr.ph, %min.iters.checked322 ], [ %indvars.iv.us.unr.ph, %vector.memcheck353 ], [ %ind.end358, %middle.block319 ]
  br label %.preheader.us.new

.preheader.us.new:                                ; preds = %.preheader.us.new, %.preheader.us.new.preheader371
  %indvars.iv.us = phi i64 [ %indvars.iv.us.ph, %.preheader.us.new.preheader371 ], [ %indvars.iv.next.us.1, %.preheader.us.new ]
...
.preheader.lr.ph:                                 ; preds = %3
  br i1 true, label %.preheader.lr.ph..preheader.us_crit_edge, label %._crit_edge14
...
.preheader.us:                                    ; preds = %._crit_edge.us, %.preheader.lr.ph..preheader.us_crit_edge
  %indvars.iv15.us = phi i64 [ 0, %.preheader.lr.ph..preheader.us_crit_edge ], [ %indvars.iv.next16.us, %._crit_edge.us ]
