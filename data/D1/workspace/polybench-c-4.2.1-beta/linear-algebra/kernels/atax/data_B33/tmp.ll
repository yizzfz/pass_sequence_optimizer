...
.lr.ph5.split.us:                                 ; preds = %._crit_edge3.us, %.lr.ph5.split.us.preheader
  %indvars.iv17 = phi i64 [ 0, %.lr.ph5.split.us.preheader ], [ %indvars.iv.next18, %._crit_edge3.us ]
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv17
  store double 0.000000e+00, double* %5, align 8
  %sunkaddr22 = shl nuw nsw i64 %indvars.iv17, 3
  %sunkaddr23 = add i64 %sunkaddr, %sunkaddr22
  %sunkaddr24 = inttoptr i64 %sunkaddr23 to double*
  %sunkaddr26 = shl nuw nsw i64 %indvars.iv17, 3
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph5.split.us
  ...
  %7 = getelementptr inbounds [2100 x double], [2100 x double]* %0, i64 %indvars.iv17, i64 %indvars.iv
...
.lr.ph2.us:                                       ; preds = %.lr.ph2.us.preheader, %.lr.ph2.us
  %indvars.iv14 = phi i64 [ %indvars.iv.next15.1, %.lr.ph2.us ], [ 0, %.lr.ph2.us.preheader ]
  %19 = getelementptr inbounds double, double* %2, i64 %indvars.iv14
  %20 = load double, double* %19, align 8
  %21 = getelementptr inbounds [2100 x double], [2100 x double]* %0, i64 %indvars.iv17, i64 %indvars.iv14
  %22 = load double, double* %21, align 8
  %23 = load double, double* %sunkaddr32, align 8
  %24 = fmul double %22, %23
  %25 = fadd double %20, %24
  store double %25, double* %19, align 8
  %indvars.iv.next15 = or i64 %indvars.iv14, 1
  %26 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next15
  %27 = load double, double* %26, align 8
  %28 = getelementptr inbounds [2100 x double], [2100 x double]* %0, i64 %indvars.iv17, i64 %indvars.iv.next15
  %29 = load double, double* %28, align 8
  %30 = load double, double* %sunkaddr36, align 8
  %31 = fmul double %29, %30
  %32 = fadd double %27, %31
  store double %32, double* %26, align 8
  %indvars.iv.next15.1 = add nuw nsw i64 %indvars.iv14, 2
  %exitcond.116 = icmp eq i64 %indvars.iv.next15.1, 2100
  br i1 %exitcond.116, label %._crit_edge3.us, label %.lr.ph2.us
