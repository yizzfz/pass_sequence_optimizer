...
define i32 @main(i32, i8** nocapture readonly) local_unnamed_addr #0 {
  ...
  tail call fastcc void @init_array(i32 2000, double* %.cast)
  tail call void (...) @polybench_timer_start() #4
  %5 = bitcast i8* %4 to double*
  tail call fastcc void @kernel_durbin(i32 2000, double* %.cast, double* %5)
...
._crit_edge2:                                     ; preds = %._crit_edge2, %.lr.ph
  ...
  br i1 %exitcond.4, label %._crit_edge1, label %._crit_edge2
...
.lr.ph:                                           ; preds = %._crit_edge23, %.lr.ph28.preheader
  %indvars.iv46 = phi i64 [ 1, %.lr.ph28.preheader ], [ %indvars.iv.next47, %._crit_edge23 ]
  %indvar = phi i64 [ 0, %.lr.ph28.preheader ], [ %55, %._crit_edge23 ]
  %10 = phi double [ %7, %.lr.ph28.preheader ], [ %62, %._crit_edge23 ]
  %11 = phi double [ 1.000000e+00, %.lr.ph28.preheader ], [ %57, %._crit_edge23 ]
  %12 = add i64 %indvar, 1
  %13 = fmul double %10, %10
  %14 = add nsw i64 %indvars.iv46, -1
...
._crit_edge51.prol:                               ; preds = %._crit_edge51.prol, %._crit_edge51.prol.preheader
  ...
  %15 = phi double [ 0.000000e+00, %._crit_edge51.prol.preheader ], [ %22, %._crit_edge51.prol ]
...
._crit_edge51.prol.loopexit:                      ; preds = %.lr.ph, %._crit_edge51.prol.loopexit.unr-lcssa
  %.lcssa.unr = phi double [ undef, %.lr.ph ], [ %22, %._crit_edge51.prol.loopexit.unr-lcssa ]
  %indvars.iv.unr = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next.prol, %._crit_edge51.prol.loopexit.unr-lcssa ]
  %.unr = phi double [ 0.000000e+00, %.lr.ph ], [ %22, %._crit_edge51.prol.loopexit.unr-lcssa ]
  %23 = icmp ult i64 %indvar, 3
  br i1 %23, label %.lr.ph19, label %.lr.ph.new
...
._crit_edge51:                                    ; preds = %._crit_edge51, %.lr.ph.new
  ...
  %24 = phi double [ %.unr, %.lr.ph.new ], [ %52, %._crit_edge51 ]
  ...
  br i1 %exitcond.3, label %.lr.ph19.unr-lcssa, label %._crit_edge51

.lr.ph19.unr-lcssa:                               ; preds = %._crit_edge51
  br label %.lr.ph19

.lr.ph19:                                         ; preds = %._crit_edge51.prol.loopexit, %.lr.ph19.unr-lcssa
  %.lcssa = phi double [ %.lcssa.unr, %._crit_edge51.prol.loopexit ], [ %52, %.lr.ph19.unr-lcssa ]
  %53 = shl i64 %indvar, 3
  %54 = fsub double 1.000000e+00, %13
  %55 = add nuw nsw i64 %indvar, 1
  %56 = add nuw nsw i64 %53, 8
  %57 = fmul double %11, %54
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %78 = getelementptr inbounds [2000 x double], [2000 x double]* %3, i64 0, i64 %index
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %._crit_edge23, label %._crit_edge52.preheader

._crit_edge52.preheader:                          ; preds = %middle.block, %min.iters.checked, %.lr.ph19
  %indvars.iv34.ph = phi i64 [ 0, %min.iters.checked ], [ 0, %.lr.ph19 ], [ %n.vec, %middle.block ]
...
._crit_edge52:                                    ; preds = %._crit_edge52.preheader, %._crit_edge52
  ...
  %85 = sub nsw i64 %14, %indvars.iv34
  %86 = getelementptr inbounds double, double* %2, i64 %85
  %87 = load double, double* %86, align 8
  %88 = fmul double %62, %87
  %89 = fadd double %84, %88
  %90 = getelementptr inbounds [2000 x double], [2000 x double]* %3, i64 0, i64 %indvars.iv34
  store double %89, double* %90, align 8
  %indvars.iv.next35 = add nuw nsw i64 %indvars.iv34, 1
  %exitcond39 = icmp eq i64 %indvars.iv.next35, %indvars.iv46
  br i1 %exitcond39, label %._crit_edge23.loopexit, label %._crit_edge52, !llvm.loop !6

._crit_edge23.loopexit:                           ; preds = %._crit_edge52
  br label %._crit_edge23

._crit_edge23:                                    ; preds = %._crit_edge23.loopexit, %middle.block
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull %9, i8* nonnull %8, i64 %56, i32 8, i1 false)
  ...
  br i1 %exitcond49, label %._crit_edge50, label %.lr.ph

._crit_edge50:                                    ; preds = %._crit_edge23
  ret void
}
