...
.lr.ph24.split.us.preheader:
  ...
  %sunkaddr96 = ptrtoint double* %5 to i64
  br label %.lr.ph24.split.us

.lr.ph24.split.us:                                ; preds = %._crit_edge21.us, %.lr.ph24.split.us.preheader
  %indvars.iv60 = phi i64 [ 0, %.lr.ph24.split.us.preheader ], [ %indvars.iv.next61, %._crit_edge21.us ]
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph24.split.us
  %7 = phi double [ 0.000000e+00, %.lr.ph24.split.us ], [ %19, %._crit_edge ]
  %indvars.iv57 = phi i64 [ 0, %.lr.ph24.split.us ], [ %indvars.iv.next58.3, %._crit_edge ]
  ...
  store double %16, double* %sunkaddr74, align 8
  ...
  store double %19, double* %sunkaddr74, align 8
  %indvars.iv.next58.3 = add nuw nsw i64 %indvars.iv57, 4
  %exitcond59.3 = icmp eq i64 %indvars.iv.next58.3, 1400
  br i1 %exitcond59.3, label %._crit_edge21.us, label %._crit_edge

._crit_edge21.us:                                 ; preds = %._crit_edge
  %20 = fdiv double %19, %2
  %sunkaddr97 = shl i64 %indvars.iv60, 3
  %sunkaddr98 = add i64 %sunkaddr96, %sunkaddr97
  %sunkaddr99 = inttoptr i64 %sunkaddr98 to double*
  store double %20, double* %sunkaddr99, align 8
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  %exitcond62 = icmp eq i64 %indvars.iv.next61, 1200
  br i1 %exitcond62, label %._crit_edge21.us..preheader6.us_crit_edge, label %.lr.ph24.split.us

._crit_edge21.us..preheader6.us_crit_edge:        ; preds = %._crit_edge21.us
  %scevgep83 = getelementptr double, double* %5, i64 1200
  br label %.preheader6.us

.preheader6.us:                                   ; preds = %._crit_edge16.us, %._crit_edge21.us..preheader6.us_crit_edge
  %indvars.iv53 = phi i64 [ 0, %._crit_edge21.us..preheader6.us_crit_edge ], [ %21, %._crit_edge16.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %3, i64 %indvars.iv53, i64 0
  %21 = add nuw nsw i64 %indvars.iv53, 1
  %scevgep81 = getelementptr [1200 x double], [1200 x double]* %3, i64 %21, i64 0
...
._crit_edge68.preheader:                          ; preds = %.preheader6.us
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.vec88 = load <8 x double>, <8 x double>* %25, align 8, !alias.scope !4, !noalias !1
  %26 = fsub <8 x double> %wide.vec88, %wide.vec
  ...
  br i1 %37, label %._crit_edge16.us.loopexit100, label %vector.body, !llvm.loop !6

._crit_edge68:                                    ; preds = %._crit_edge68.preheader, %._crit_edge68
  %indvars.iv50 = phi i64 [ %indvars.iv.next51.3, %._crit_edge68 ], [ 0, %._crit_edge68.preheader ]
  ...
  br i1 %exitcond52.3, label %._crit_edge16.us.loopexit, label %._crit_edge68, !llvm.loop !9

._crit_edge16.us.loopexit:                        ; preds = %._crit_edge68
  br label %._crit_edge16.us

._crit_edge16.us.loopexit100:                     ; preds = %vector.body
  br label %._crit_edge16.us

._crit_edge16.us:                                 ; preds = %._crit_edge16.us.loopexit100, %._crit_edge16.us.loopexit
...
._crit_edge.us.us:                                ; preds = %._crit_edge69
...
._crit_edge69:                                    ; preds = %._crit_edge69, %.lr.ph.us.us
  %62 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %74, %._crit_edge69 ]
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %._crit_edge69 ]
  ...
  br i1 %exitcond.1, label %._crit_edge.us.us, label %._crit_edge69
