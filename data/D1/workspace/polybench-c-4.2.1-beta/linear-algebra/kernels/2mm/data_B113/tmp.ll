...
.lr.ph20.split.us:                                ; preds = %._crit_edge18.us, %.lr.ph20
  %indvars.iv74 = phi i64 [ 0, %.lr.ph20 ], [ %indvars.iv.next75, %._crit_edge18.us ]
  br label %._crit_edge78

._crit_edge78:                                    ; preds = %._crit_edge78, %.lr.ph20.split.us
  %indvars.iv70 = phi i64 [ 0, %.lr.ph20.split.us ], [ %indvars.iv.next71, %._crit_edge78 ]
  ...
  br i1 %exitcond73, label %._crit_edge18.us, label %._crit_edge78

._crit_edge18.us:                                 ; preds = %._crit_edge78
  %indvars.iv.next75 = add nuw nsw i64 %indvars.iv74, 1
  %exitcond92 = icmp eq i64 %indvars.iv.next75, 800
  br i1 %exitcond92, label %.lr.ph14.split.us.preheader, label %.lr.ph20.split.us
...
.lr.ph14.split.us:                                ; preds = %.lr.ph14.split.us.preheader, %._crit_edge12.us
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %._crit_edge12.us ], [ 0, %.lr.ph14.split.us.preheader ]
  br label %.lr.ph14.split.us.new

.lr.ph14.split.us.new:                            ; preds = %.lr.ph14.split.us.new, %.lr.ph14.split.us
  %indvars.iv62 = phi i64 [ 0, %.lr.ph14.split.us ], [ %indvars.iv.next63.1, %.lr.ph14.split.us.new ]
  ...
  %23 = mul nuw nsw i64 %indvars.iv.next63.1, %indvars.iv66
...
._crit_edge12.us:                                 ; preds = %.lr.ph14.split.us.new
  ...
  %exitcond91 = icmp eq i64 %indvars.iv.next67, 1100
  br i1 %exitcond91, label %.lr.ph8.split.us.preheader, label %.lr.ph14.split.us
...
._crit_edge82:                                    ; preds = %._crit_edge82, %.lr.ph8.split.us
  %indvars.iv54 = phi i64 [ 0, %.lr.ph8.split.us ], [ %indvars.iv.next55, %._crit_edge82 ]
  %29 = add nuw nsw i64 %indvars.iv54, 3
  %30 = mul nuw nsw i64 %29, %indvars.iv58
  ...
  br i1 %exitcond57, label %._crit_edge6.us, label %._crit_edge82

._crit_edge6.us:                                  ; preds = %._crit_edge82
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  %exitcond90 = icmp eq i64 %indvars.iv.next59, 900
  br i1 %exitcond90, label %.lr.ph2.split.us.preheader, label %.lr.ph8.split.us
...
._crit_edge84:                                    ; preds = %._crit_edge84, %.lr.ph2.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph2.split.us ], [ %indvars.iv.next, %._crit_edge84 ]
  %37 = add nuw nsw i64 %indvars.iv, 2
  %38 = mul nuw nsw i64 %37, %indvars.iv52
  ...
  br i1 %exitcond, label %._crit_edge.us, label %._crit_edge84

._crit_edge.us:                                   ; preds = %._crit_edge84
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1
  %exitcond89 = icmp eq i64 %indvars.iv.next53, 800
  br i1 %exitcond89, label %._crit_edge83, label %.lr.ph2.split.us
...
._crit_edge12.us:                                 ; preds = %._crit_edge9.us.us
  ...
  br i1 %exitcond99, label %.lr.ph2.us.preheader, label %.lr.ph11.us
...
._crit_edge88:                                    ; preds = %._crit_edge88, %.lr.ph8.us.us
  %12 = phi double [ 0.000000e+00, %.lr.ph8.us.us ], [ %26, %._crit_edge88 ]
  %indvars.iv74 = phi i64 [ 0, %.lr.ph8.us.us ], [ %indvars.iv.next75.1, %._crit_edge88 ]
  ...
  %exitcond96.1 = icmp eq i64 %indvars.iv.next75.1, 1100
  br i1 %exitcond96.1, label %._crit_edge9.us.us, label %._crit_edge88
...
._crit_edge3.us:                                  ; preds = %._crit_edge.us.us
  ...
  br i1 %exitcond98, label %._crit_edge89, label %.lr.ph2.us
...
._crit_edge90:                                    ; preds = %._crit_edge90, %.lr.ph.us.us
  %30 = phi double [ %29, %.lr.ph.us.us ], [ %48, %._crit_edge90 ]
  %indvars.iv62 = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next63.2, %._crit_edge90 ]
  ...
  br i1 %exitcond.2, label %._crit_edge.us.us, label %._crit_edge90
