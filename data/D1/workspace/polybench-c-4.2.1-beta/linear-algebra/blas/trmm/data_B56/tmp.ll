...
._crit_edge.us:                                   ; preds = %.prol.loopexit.._crit_edge.us_crit_edge, %.lr.ph.us.new.._crit_edge.us_crit_edge, %.preheader.us.._crit_edge.us_crit_edge
  ...
  %15 = add i32 %14, %1
  br i1 %lcmp.mod45, label %._crit_edge.us..prol.loopexit43_crit_edge, label %.prol.preheader42
...
.prol.loopexit43:                                 ; preds = %._crit_edge.us..prol.loopexit43_crit_edge, %.prol.preheader42
  ...
  br i1 %10, label %.prol.loopexit43.._crit_edge32.us_crit_edge, label %.prol.loopexit43.._crit_edge.us.new_crit_edge

.prol.loopexit43.._crit_edge.us.new_crit_edge:    ; preds = %.prol.loopexit43
  br label %._crit_edge.us.new

.prol.loopexit43.._crit_edge32.us_crit_edge:      ; preds = %.prol.loopexit43
  br label %._crit_edge32.us

._crit_edge.us.new:                               ; preds = %._crit_edge.us.new.._crit_edge.us.new_crit_edge, %.prol.loopexit43.._crit_edge.us.new_crit_edge
  %indvars.iv39 = phi i64 [ %indvars.iv39.unr.ph, %.prol.loopexit43.._crit_edge.us.new_crit_edge ], [ %indvars.iv.next40.1, %._crit_edge.us.new.._crit_edge.us.new_crit_edge ]
  ...
  br i1 %exitcond.147, label %._crit_edge.us.new.._crit_edge32.us_crit_edge, label %._crit_edge.us.new.._crit_edge.us.new_crit_edge
...
.prol.preheader:                                  ; preds = %.lr.ph.us
  %44 = trunc i64 %indvars.iv50 to i32
  %45 = srem i32 %44, %0
  %46 = sitofp i32 %45 to double
  %47 = fdiv double %46, %9
  %48 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv50, i64 0
...
._crit_edge32.us:                                 ; preds = %._crit_edge.us.new.._crit_edge32.us_crit_edge, %.prol.loopexit43.._crit_edge32.us_crit_edge
...
.preheader:                                       ; preds = %._crit_edge..preheader_crit_edge, %.preheader.preheader
  ...
  %51 = add nuw i64 %indvars.iv64, 4294967295
  %52 = icmp sgt i64 %indvars.iv64, 0
...
.prol.preheader58:                                ; preds = %.lr.ph
  %53 = trunc i64 %indvars.iv64 to i32
  %54 = srem i32 %53, %0
  %55 = sitofp i32 %54 to double
  %56 = fdiv double %55, %9
  %57 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv64, i64 0
...
.prol.loopexit59:                                 ; preds = %.lr.ph..prol.loopexit59_crit_edge, %.prol.preheader58
  ...
  %59 = icmp eq i32 %58, 0
  br i1 %59, label %.prol.loopexit59.._crit_edge_crit_edge, label %.prol.loopexit59..lr.ph.new_crit_edge

.prol.loopexit59..lr.ph.new_crit_edge:            ; preds = %.prol.loopexit59
  br label %.lr.ph.new

.prol.loopexit59.._crit_edge_crit_edge:           ; preds = %.prol.loopexit59
  br label %._crit_edge

.lr.ph.new:                                       ; preds = %.lr.ph.new..lr.ph.new_crit_edge, %.prol.loopexit59..lr.ph.new_crit_edge
  %indvars.iv53 = phi i64 [ %indvars.iv53.unr.ph, %.prol.loopexit59..lr.ph.new_crit_edge ], [ %indvars.iv.next54.1, %.lr.ph.new..lr.ph.new_crit_edge ]
  %60 = add nuw nsw i64 %indvars.iv53, %indvars.iv64
  %61 = trunc i64 %60 to i32
  %62 = srem i32 %61, %0
  %63 = sitofp i32 %62 to double
  %64 = fdiv double %63, %9
  %65 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv64, i64 %indvars.iv53
  store double %64, double* %65, align 8
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %66 = add nuw nsw i64 %indvars.iv.next54, %indvars.iv64
  %67 = trunc i64 %66 to i32
  %68 = srem i32 %67, %0
  %69 = sitofp i32 %68 to double
  %70 = fdiv double %69, %9
  %71 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv64, i64 %indvars.iv.next54
  ...
  br i1 %exitcond57.1, label %.lr.ph.new.._crit_edge_crit_edge, label %.lr.ph.new..lr.ph.new_crit_edge
...
._crit_edge:                                      ; preds = %.lr.ph.new.._crit_edge_crit_edge, %.prol.loopexit59.._crit_edge_crit_edge, %.preheader.._crit_edge_crit_edge
  %72 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv64, i64 %indvars.iv64
  store double 1.000000e+00, double* %72, align 8
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1
  %exitcond67 = icmp eq i64 %indvars.iv.next65, %wide.trip.count66
  br i1 %exitcond67, label %._crit_edge.._crit_edge35_crit_edge, label %._crit_edge..preheader_crit_edge
...
.preheader.us32.prol.loopexit:                    ; preds = %.preheader.us32.prol..preheader.us32.prol.loopexit_crit_edge, %.preheader.us32.preheader..preheader.us32.prol.loopexit_crit_edge
  ...
  br i1 %12, label %.preheader.us32.prol.loopexit.._crit_edge29.us_crit_edge, label %.preheader.us32.preheader58
...
.preheader.us32.preheader58:                      ; preds = %.preheader.us32.prol.loopexit
  ...
  br i1 %min.iters.check, label %.preheader.us32.preheader58..preheader.us32_crit_edge, label %min.iters.checked

.preheader.us32.preheader58..preheader.us32_crit_edge: ; preds = %.preheader.us32.preheader58
  br label %.preheader.us32.preheader66
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %middle.block.._crit_edge29.us_crit_edge, label %middle.block..preheader.us32_crit_edge

middle.block..preheader.us32_crit_edge:           ; preds = %middle.block
  br label %.preheader.us32.preheader66

.preheader.us32.preheader66:                      ; preds = %.preheader.us32.preheader58..preheader.us32_crit_edge, %min.iters.checked..preheader.us32_crit_edge, %middle.block..preheader.us32_crit_edge
  %indvars.iv.ph = phi i64 [ %ind.end, %middle.block..preheader.us32_crit_edge ], [ %indvars.iv.unr, %min.iters.checked..preheader.us32_crit_edge ], [ %indvars.iv.unr, %.preheader.us32.preheader58..preheader.us32_crit_edge ]
  br label %.preheader.us32

middle.block.._crit_edge29.us_crit_edge:          ; preds = %middle.block
  br label %._crit_edge29.us

.preheader.us32:                                  ; preds = %.preheader.us32.preheader66, %.preheader.us32..preheader.us32_crit_edge
  %indvars.iv = phi i64 [ %indvars.iv.next.3, %.preheader.us32..preheader.us32_crit_edge ], [ %indvars.iv.ph, %.preheader.us32.preheader66 ]
  ...
  br i1 %exitcond.3, label %.preheader.us32.._crit_edge29.us_crit_edge, label %.preheader.us32..preheader.us32_crit_edge, !llvm.loop !6

.preheader.us32..preheader.us32_crit_edge:        ; preds = %.preheader.us32
  br label %.preheader.us32

.preheader.us32.._crit_edge29.us_crit_edge:       ; preds = %.preheader.us32
  br label %._crit_edge29.us

._crit_edge29.us:                                 ; preds = %._crit_edge.us.us.._crit_edge29.us_crit_edge, %.preheader.us32.._crit_edge29.us_crit_edge, %middle.block.._crit_edge29.us_crit_edge, %.preheader.us32.prol.loopexit.._crit_edge29.us_crit_edge
  %exitcond54 = icmp eq i64 %indvars.iv.next52, %wide.trip.count44.1
  br i1 %exitcond54, label %._crit_edge29.us.._crit_edge31_crit_edge, label %._crit_edge29.us..preheader27.us_crit_edge

._crit_edge29.us.._crit_edge31_crit_edge:         ; preds = %._crit_edge29.us
  br label %._crit_edge31
...
.preheader.us.us:                                 ; preds = %._crit_edge.us.us..preheader.us.us_crit_edge, %.preheader.us.us.preheader
  ...
  br i1 %lcmp.mod46, label %.preheader.us.us..prol.loopexit_crit_edge, label %.prol.preheader
...
.prol.loopexit:                                   ; preds = %.preheader.us.us..prol.loopexit_crit_edge, %.prol.preheader
  %indvars.iv42.unr.ph = phi i64 [ %indvars.iv.next43.prol, %.prol.preheader ], [ %indvars.iv40, %.preheader.us.us..prol.loopexit_crit_edge ]
...
._crit_edge.us.us:                                ; preds = %.preheader.us.us.new.._crit_edge.us.us_crit_edge, %.prol.loopexit.._crit_edge.us.us_crit_edge
  %68 = phi double [ %.pre60, %.prol.loopexit.._crit_edge.us.us_crit_edge ], [ %82, %.preheader.us.us.new.._crit_edge.us.us_crit_edge ]
  %69 = fmul double %68, %2
  store double %69, double* %61, align 8
  %indvars.iv.next49 = add nuw nsw i64 %indvars.iv48, 1
  %exitcond = icmp eq i64 %indvars.iv.next49, %wide.trip.count50
  br i1 %exitcond, label %._crit_edge.us.us.._crit_edge29.us_crit_edge, label %._crit_edge.us.us..preheader.us.us_crit_edge

._crit_edge.us.us..preheader.us.us_crit_edge:     ; preds = %._crit_edge.us.us
  br label %.preheader.us.us

._crit_edge.us.us.._crit_edge29.us_crit_edge:     ; preds = %._crit_edge.us.us
  br label %._crit_edge29.us

.preheader.us.us.new:                             ; preds = %.preheader.us.us.new..preheader.us.us.new_crit_edge, %.prol.loopexit..preheader.us.us.new_crit_edge
  %70 = phi double [ %.pre60, %.prol.loopexit..preheader.us.us.new_crit_edge ], [ %82, %.preheader.us.us.new..preheader.us.us.new_crit_edge ]
...
._crit_edge31:                                    ; preds = %._crit_edge29.us.._crit_edge31_crit_edge, %.._crit_edge31_crit_edge
  ret void
}
