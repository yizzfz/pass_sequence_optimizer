...
for.cond1.preheader.us:                           ; preds = %for.inc7.us, %for.cond1.preheader.us.preheader
  %indvars.iv5979.us = phi i64 [ 0, %for.cond1.preheader.us.preheader ], [ %indvars.iv.next60.us, %for.inc7.us ]
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us, %for.cond1.preheader.us
  %indvars.iv5577.us = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next56.us, %for.body3.us ]
  %0 = mul nuw nsw i64 %indvars.iv5577.us, %indvars.iv5979.us
  ...
  %exitcond10 = icmp eq i64 %indvars.iv.next56.us, 1100
  br i1 %exitcond10, label %for.inc7.us, label %for.body3.us

for.inc7.us:                                      ; preds = %for.body3.us
  %indvars.iv.next60.us = add nuw nsw i64 %indvars.iv5979.us, 1
  %exitcond11 = icmp eq i64 %indvars.iv.next60.us, 800
...
for.cond14.preheader.us:                          ; preds = %for.cond14.preheader.us.preheader, %for.inc31.us
  %indvars.iv5374.us = phi i64 [ %indvars.iv.next54.us, %for.inc31.us ], [ 0, %for.cond14.preheader.us.preheader ]
  br label %for.body17.us

for.body17.us:                                    ; preds = %for.body17.us, %for.cond14.preheader.us
  %indvars.iv5072.us = phi i64 [ 0, %for.cond14.preheader.us ], [ %indvars.iv.next51.us.1, %for.body17.us ]
  %indvars.iv.next51.us = or i64 %indvars.iv5072.us, 1
  %3 = mul nuw nsw i64 %indvars.iv.next51.us, %indvars.iv5374.us
  ...
  %5 = mul nuw nsw i64 %indvars.iv.next51.us.1, %indvars.iv5374.us
  ...
  %exitcond8.1 = icmp eq i64 %indvars.iv.next51.us.1, 900
...
for.inc31.us:                                     ; preds = %for.body17.us
  ...
  %exitcond9 = icmp eq i64 %indvars.iv.next54.us, 1100
...
for.cond38.preheader.us:                          ; preds = %for.cond38.preheader.us.preheader, %for.inc56.us
  %indvars.iv4869.us = phi i64 [ %indvars.iv.next49.us, %for.inc56.us ], [ 0, %for.cond38.preheader.us.preheader ]
...
for.body41.us:                                    ; preds = %for.body41.us, %for.cond38.preheader.us
  ...
  %8 = add nuw nsw i64 %indvars.iv4367.us, 3
  %9 = mul nuw nsw i64 %8, %indvars.iv4869.us
  ...
  %exitcond6 = icmp eq i64 %indvars.iv.next44.us, 1200
  br i1 %exitcond6, label %for.inc56.us, label %for.body41.us

for.inc56.us:                                     ; preds = %for.body41.us
  %indvars.iv.next49.us = add nuw nsw i64 %indvars.iv4869.us, 1
  %exitcond7 = icmp eq i64 %indvars.iv.next49.us, 900
...
for.cond63.preheader.us:                          ; preds = %for.cond63.preheader.us.preheader, %for.inc80.us
  %indvars.iv4164.us = phi i64 [ %indvars.iv.next42.us, %for.inc80.us ], [ 0, %for.cond63.preheader.us.preheader ]
...
for.body66.us:                                    ; preds = %for.body66.us, %for.cond63.preheader.us
  ...
  %12 = add nuw nsw i64 %indvars.iv62.us, 2
  %13 = mul nuw nsw i64 %12, %indvars.iv4164.us
...
for.inc80.us:                                     ; preds = %for.body66.us
  ...
  %exitcond5 = icmp eq i64 %indvars.iv.next42.us, 800
...
for.inc28.us:                                     ; preds = %for.inc25.us.us
  ...
  %exitcond9 = icmp eq i64 %indvars.iv.next40.us, 800
...
for.body11.us.us:                                 ; preds = %for.body11.us.us, %for.body6.us.us
  ...
  %indvars.iv3550.us.us = phi i64 [ 0, %for.body6.us.us ], [ %indvars.iv.next36.us.us.1, %for.body11.us.us ]
  ...
  br i1 %exitcond7.1, label %for.inc25.us.us, label %for.body11.us.us
...
for.body44.us.us:                                 ; preds = %for.body44.us.us, %for.body36.us.us
  ...
  %indvars.iv42.us.us = phi i64 [ 0, %for.body36.us.us ], [ %indvars.iv.next.us.us.2, %for.body44.us.us ]
  ...
  br i1 %exitcond.2, label %for.inc62.us.us, label %for.body44.us.us
...
for.cond2.preheader.us:                           ; preds = %for.inc10.us, %for.cond2.preheader.us.preheader
  %indvars.iv814.us = phi i64 [ 0, %for.cond2.preheader.us.preheader ], [ %indvars.iv.next9.us, %for.inc10.us ]
  %3 = mul nuw nsw i64 %indvars.iv814.us, 800
  br label %for.body4.us

for.body4.us:                                     ; preds = %if.end.us, %for.cond2.preheader.us
  %indvars.iv12.us = phi i64 [ 0, %for.cond2.preheader.us ], [ %indvars.iv.next.us, %if.end.us ]
  %4 = add nuw nsw i64 %indvars.iv12.us, %3
...
for.inc10.us:                                     ; preds = %if.end.us
  ...
  %exitcond2 = icmp eq i64 %indvars.iv.next9.us, 800
