...
.lr.ph5.split.us:                                 ; preds = %.lr.ph5.split.us.preheader, %._crit_edge.us
  %.13.us = phi i32 [ %20, %._crit_edge.us ], [ 0, %.lr.ph5.split.us.preheader ]
  %3 = sitofp i32 %.13.us to double
  %4 = fdiv double %3, 2.100000e+03
  %5 = sext i32 %.13.us to i64
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph5.split.us
  ...
  %7 = mul nuw nsw i64 %indvars.iv.next, %5
  %8 = trunc i64 %7 to i32
  %9 = srem i32 %8, 2100
  %10 = sitofp i32 %9 to double
  %11 = getelementptr inbounds [1900 x double], [1900 x double]* %0, i64 %5, i64 %indvars.iv
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %12 = mul nuw nsw i64 %indvars.iv.next.1, %5
...
._crit_edge.us:                                   ; preds = %._crit_edge
  %20 = add nsw i32 %.13.us, 1
  %21 = icmp slt i32 %20, 2100
  br i1 %21, label %.lr.ph5.split.us, label %._crit_edge6

.lr.ph9.new:                                      ; preds = %.lr.ph9.new, %.lr.ph9
  %indvars.iv16 = phi i64 [ 0, %.lr.ph9 ], [ %indvars.iv.next17.1.1, %.lr.ph9.new ]
  %22 = trunc i64 %indvars.iv16 to i32
  %23 = sitofp i32 %22 to double
  %24 = getelementptr inbounds double, double* %2, i64 %indvars.iv16
  ...
  %32 = trunc i64 %indvars.iv.next17.1 to i32
  %33 = sitofp i32 %32 to double
  %34 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next17.1
  %35 = trunc i64 %indvars.iv.next17.1 to i32
  %36 = or i32 %35, 1
...
.lr.ph4.split.us:                                 ; preds = %._crit_edge.us, %.lr.ph8.preheader
  %.13.us = phi i32 [ 0, %.lr.ph8.preheader ], [ %21, %._crit_edge.us ]
  %6 = sext i32 %.13.us to i64
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph4.split.us
  ...
  br i1 %exitcond30, label %._crit_edge.us, label %._crit_edge

._crit_edge.us:                                   ; preds = %._crit_edge
  %21 = add nsw i32 %.13.us, 1
...
.lr.ph:                                           ; preds = %.lr.ph._crit_edge, %._crit_edge8
  %indvars.iv = phi i64 [ 0, %._crit_edge8 ], [ %indvars.iv.next, %.lr.ph._crit_edge ]
