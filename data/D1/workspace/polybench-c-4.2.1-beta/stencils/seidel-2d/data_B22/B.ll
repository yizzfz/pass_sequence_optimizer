...
; <label>:3:                                      ; preds = %3, %.preheader.us
  ...
  %10 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv2, i64 %indvars.iv
  ...
  %17 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv2, i64 %indvars.iv.next
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_seidel_2d([2000 x double]*) #0 {
.preheader3.lr.ph:
  br label %.preheader3

.preheader3:                                      ; preds = %._crit_edge4, %.preheader3.lr.ph
  %.05 = phi i32 [ 0, %.preheader3.lr.ph ], [ %24, %._crit_edge4 ]
  br label %.preheader

.preheader:                                       ; preds = %._crit_edge, %.preheader3
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %._crit_edge ], [ 1, %.preheader3 ]
  ...
  %.phi.trans.insert10 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %1, i64 1
  %.pre11 = load double, double* %.phi.trans.insert10, align 8
  %.phi.trans.insert12 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv8, i64 0
  %.pre13 = load double, double* %.phi.trans.insert12, align 8
  %.phi.trans.insert14 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv8, i64 1
  %.pre15 = load double, double* %.phi.trans.insert14, align 8
  %.phi.trans.insert16 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv.next9, i64 0
  %.pre17 = load double, double* %.phi.trans.insert16, align 8
  %.phi.trans.insert18 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv.next9, i64 1
  %.pre19 = load double, double* %.phi.trans.insert18, align 8
  br label %._crit_edge7

._crit_edge7:                                     ; preds = %._crit_edge7, %.preheader
  %2 = phi double [ %.pre19, %.preheader ], [ %21, %._crit_edge7 ]
  %3 = phi double [ %.pre17, %.preheader ], [ %2, %._crit_edge7 ]
  %4 = phi double [ %.pre15, %.preheader ], [ %16, %._crit_edge7 ]
  %5 = phi double [ %.pre13, %.preheader ], [ %23, %._crit_edge7 ]
  %6 = phi double [ %.pre11, %.preheader ], [ %10, %._crit_edge7 ]
  %7 = phi double [ %.pre, %.preheader ], [ %6, %._crit_edge7 ]
  %indvars.iv = phi i64 [ 1, %.preheader ], [ %indvars.iv.next, %._crit_edge7 ]
  %8 = fadd double %7, %6
  ...
  %14 = fadd double %12, %4
  %15 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv8, i64 %indvars.iv.next
  %16 = load double, double* %15, align 8
  %17 = fadd double %14, %16
  %18 = fadd double %17, %3
  %19 = fadd double %18, %2
  %20 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv.next9, i64 %indvars.iv.next
  %21 = load double, double* %20, align 8
  %22 = fadd double %19, %21
  %23 = fdiv double %22, 9.000000e+00
  store double %23, double* %13, align 8
  %exitcond = icmp eq i64 %indvars.iv, 1998
  br i1 %exitcond, label %._crit_edge, label %._crit_edge7

._crit_edge:                                      ; preds = %._crit_edge7
  %exitcond1 = icmp eq i64 %indvars.iv.next9, 1999
  br i1 %exitcond1, label %._crit_edge4, label %.preheader

._crit_edge4:                                     ; preds = %._crit_edge
  %24 = add nuw nsw i32 %.05, 1
  %exitcond2 = icmp eq i32 %24, 500
  br i1 %exitcond2, label %._crit_edge6, label %.preheader3
