...
for.body:                                         ; preds = %for.inc14, %for.body.lr.ph
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc14 ], [ 0, %for.body.lr.ph ]
  ...
  br i1 true, label %for.body6.lr.ph, label %for.inc14

for.body6.lr.ph:                                  ; preds = %for.body
  %add = add i32 %1, 1
  %sub = add i32 %add, %n
  %2 = and i64 %indvars.iv10, 1
...
for.inc14:                                        ; preds = %for.inc14.loopexit, %for.body
  ...
  %exitcond = icmp ne i64 %indvars.iv.next11, %0
...
for.body:                                         ; preds = %for.end, %for.body.lr.ph
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.end ], [ 0, %for.body.lr.ph ]
  %indvars.iv6 = phi i32 [ %indvars.iv.next7, %for.end ], [ -1, %for.body.lr.ph ]
  %1 = add nuw nsw i64 %indvars.iv8, 4294967295
...
for.body5.prol.loopexit.unr-lcssa:                ; preds = %for.body5.lr.ph, %for.body5.prol
  ...
  %.unr.ph = phi double [ %sub.prol, %for.body5.prol ], [ %6, %for.body5.lr.ph ]
...
for.body5.prol.loopexit:                          ; preds = %for.body5.prol.loopexit.unr-lcssa
  %10 = icmp eq i64 %2, 0
  br i1 %10, label %for.end.loopexit, label %for.body5.lr.ph.new

for.body5.lr.ph.new:                              ; preds = %for.body5.prol.loopexit
  br label %for.body5

for.body5:                                        ; preds = %for.body5, %for.body5.lr.ph.new
  %11 = phi double [ %.unr.ph, %for.body5.lr.ph.new ], [ %sub.1, %for.body5 ]
...
for.end:                                          ; preds = %for.end.loopexit, %for.body
  %16 = phi double [ %6, %for.body ], [ %sub.lcssa, %for.end.loopexit ]
