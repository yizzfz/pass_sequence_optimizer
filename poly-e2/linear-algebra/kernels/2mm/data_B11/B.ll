...
entry:
  ...
  tail call void @kernel_2mm(double %0, double %1, [900 x double]* %arraydecay12, [1100 x double]* %arraydecay, [900 x double]* %arraydecay9, [1200 x double]* %arraydecay10, [1200 x double]* %arraydecay11)
...
if.then:                                          ; preds = %land.lhs.true
  tail call void @print_array([1200 x double]* %arraydecay11)
  br label %if.end
...
for.cond1.preheader:                              ; preds = %for.end, %entry
  %indvars.iv2130 = phi i64 [ 0, %entry ], [ %indvars.iv.next22, %for.end ]
  br label %for.body3

for.body3:                                        ; preds = %for.body3, %for.cond1.preheader
  %indvars.iv1729 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next18, %for.body3 ]
...
for.cond14.preheader:                             ; preds = %for.cond14.preheader.preheader, %for.end30
  %indvars.iv1528 = phi i64 [ %indvars.iv.next16, %for.end30 ], [ 0, %for.cond14.preheader.preheader ]
  br label %for.body17

for.body17:                                       ; preds = %for.body17, %for.cond14.preheader
  %indvars.iv1227 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next13.1, %for.body17 ]
...
for.cond38.preheader:                             ; preds = %for.cond38.preheader.preheader, %for.end55
  %indvars.iv1026 = phi i64 [ %indvars.iv.next11, %for.end55 ], [ 0, %for.cond38.preheader.preheader ]
  br label %for.body41

for.body41:                                       ; preds = %for.body41, %for.cond38.preheader
  %indvars.iv525 = phi i64 [ 0, %for.cond38.preheader ], [ %indvars.iv.next6, %for.body41 ]
  %8 = add nuw nsw i64 %indvars.iv525, 3
  %9 = mul nuw nsw i64 %8, %indvars.iv1026
...
for.cond63.preheader:                             ; preds = %for.cond63.preheader.preheader, %for.end79
  %indvars.iv324 = phi i64 [ %indvars.iv.next4, %for.end79 ], [ 0, %for.cond63.preheader.preheader ]
  br label %for.body66

for.body66:                                       ; preds = %for.body66, %for.cond63.preheader
  %indvars.iv23 = phi i64 [ 0, %for.cond63.preheader ], [ %indvars.iv.next, %for.body66 ]
...
for.cond4.preheader:                              ; preds = %for.end27, %entry
  %indvars.iv916 = phi i64 [ 0, %entry ], [ %indvars.iv.next10, %for.end27 ]
  br label %for.body6

for.body6:                                        ; preds = %for.end, %for.cond4.preheader
  %indvars.iv715 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next8, %for.end ]
...
for.body11:                                       ; preds = %for.body11, %for.body6
  ...
  %indvars.iv514 = phi i64 [ 0, %for.body6 ], [ %indvars.iv.next6.1, %for.body11 ]
...
for.cond34.preheader:                             ; preds = %for.cond34.preheader.preheader, %for.end64
  %indvars.iv313 = phi i64 [ %indvars.iv.next4, %for.end64 ], [ 0, %for.cond34.preheader.preheader ]
  br label %for.body36

for.body36:                                       ; preds = %for.end61, %for.cond34.preheader
  %indvars.iv112 = phi i64 [ 0, %for.cond34.preheader ], [ %indvars.iv.next2, %for.end61 ]
