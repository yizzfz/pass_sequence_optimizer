...
for.body.us.preheader:                            ; preds = %for.body.lr.ph
  ...
  %3 = add nsw i64 %0, -2
  %scevgep157 = getelementptr double, double* %B, i64 %sub
  %scevgep159 = getelementptr double, double* %A, i64 %0
  %4 = add nsw i64 %0, 1
  %min.iters.check149 = icmp ult i64 %3, 4
  %n.vec152 = and i64 %3, -4
  ...
  %ind.end170 = or i64 %n.vec152, 1
  %cmp.n171 = icmp eq i64 %3, %n.vec152
...
for.inc.us.preheader:                             ; preds = %middle.block147, %vector.memcheck165, %min.iters.checked150, %for.body.us
  %indvars.iv.ph = phi i64 [ %ind.end170, %middle.block147 ], [ 1, %vector.memcheck165 ], [ 1, %min.iters.checked150 ], [ 1, %for.body.us ]
  %5 = sub nsw i64 %4, %indvars.iv.ph
  %xtraiter184 = and i64 %5, 1
  %lcmp.mod185 = icmp eq i64 %xtraiter184, 0
  br i1 %lcmp.mod185, label %for.inc.us.prol.loopexit.unr-lcssa, label %for.inc.us.prol.preheader
...
min.iters.checked150:                             ; preds = %for.body.us
  br i1 %cmp.zero153, label %for.inc.us.preheader, label %vector.memcheck165

vector.memcheck165:                               ; preds = %min.iters.checked150
  br i1 %found.conflict163, label %for.inc.us.preheader, label %vector.body146.preheader

vector.body146.preheader:                         ; preds = %vector.memcheck165
  br label %vector.body146

vector.body146:                                   ; preds = %vector.body146.preheader, %vector.body146
  %index167 = phi i64 [ %index.next168, %vector.body146 ], [ 0, %vector.body146.preheader ]
  %offset.idx172 = or i64 %index167, 1
  %11 = getelementptr inbounds double, double* %A, i64 %index167
  %12 = bitcast double* %11 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %12, align 8, !alias.scope !1
  %13 = getelementptr double, double* %11, i64 2
  %14 = bitcast double* %13 to <2 x double>*
  %wide.load177 = load <2 x double>, <2 x double>* %14, align 8, !alias.scope !1
  %15 = getelementptr inbounds double, double* %A, i64 %offset.idx172
  %16 = bitcast double* %15 to <2 x double>*
  %wide.load178 = load <2 x double>, <2 x double>* %16, align 8, !alias.scope !1
  %17 = getelementptr double, double* %15, i64 2
  %18 = bitcast double* %17 to <2 x double>*
  %wide.load179 = load <2 x double>, <2 x double>* %18, align 8, !alias.scope !1
  %19 = fadd <2 x double> %wide.load, %wide.load178
  %20 = fadd <2 x double> %wide.load177, %wide.load179
  ...
  %wide.load181 = load <2 x double>, <2 x double>* %24, align 8, !alias.scope !1
  %25 = fadd <2 x double> %19, %wide.load177
  %26 = fadd <2 x double> %20, %wide.load181
  ...
  %29 = getelementptr inbounds double, double* %B, i64 %offset.idx172
  ...
  %33 = icmp eq i64 %index.next168, %n.vec152
  br i1 %33, label %middle.block147, label %vector.body146, !llvm.loop !6

middle.block147:                                  ; preds = %vector.body146
  br i1 %cmp.n171, label %for.inc30.us.preheader, label %for.inc.us.preheader
...
for.inc.us:                                       ; preds = %for.inc.us, %for.inc.us.preheader.new
  ...
  %exitcond.1186 = icmp eq i64 %indvars.iv.next.1, %sub
  br i1 %exitcond.1186, label %for.inc30.us.preheader.loopexit.unr-lcssa, label %for.inc.us, !llvm.loop !10
...
for.inc30.us.prol.loopexit:                       ; preds = %for.inc30.us.preheader, %for.inc30.us.prol
  ...
  br i1 %1, label %for.inc33.us, label %for.inc30.us.preheader78

for.inc30.us.preheader78:                         ; preds = %for.inc30.us.prol.loopexit
  %51 = sub nsw i64 %2, %indvars.iv63.unr.ph
  %52 = lshr i64 %51, 1
  %53 = add nuw i64 %52, 1
  %min.iters.check104 = icmp ult i64 %53, 2
  br i1 %min.iters.check104, label %for.inc30.us.preheader183, label %min.iters.checked105

for.inc30.us.preheader183:                        ; preds = %middle.block102, %vector.memcheck125, %min.iters.checked105, %for.inc30.us.preheader78
  %indvars.iv63.ph = phi i64 [ %ind.end130, %middle.block102 ], [ %indvars.iv63.unr.ph, %vector.memcheck125 ], [ %indvars.iv63.unr.ph, %min.iters.checked105 ], [ %indvars.iv63.unr.ph, %for.inc30.us.preheader78 ]
  br label %for.inc30.us

min.iters.checked105:                             ; preds = %for.inc30.us.preheader78
  %n.mod.vf106 = and i64 %53, 1
  %n.vec107 = sub i64 %53, %n.mod.vf106
  %cmp.zero108 = icmp eq i64 %n.vec107, 0
  br i1 %cmp.zero108, label %for.inc30.us.preheader183, label %vector.memcheck125
...
vector.memcheck125:                               ; preds = %min.iters.checked105
  ...
  %scevgep113 = getelementptr double, double* %scevgep112, i64 %55
  %scevgep116 = getelementptr double, double* %scevgep115, i64 %indvars.iv63.unr.ph
  %scevgep119 = getelementptr double, double* %scevgep118, i64 %55
  ...
  %57 = add i64 %56, %54
  %58 = shl nuw nsw i64 %n.mod.vf106, 1
  %ind.end130 = sub i64 %57, %58
  br i1 %found.conflict123, label %for.inc30.us.preheader183, label %vector.body101.preheader
...
vector.body101:                                   ; preds = %vector.body101.preheader, %vector.body101
  ...
  %59 = shl i64 %index127, 1
  %offset.idx132 = or i64 %indvars.iv63.unr.ph, %59
  %60 = add nsw i64 %offset.idx132, -1
  %61 = getelementptr inbounds double, double* %B, i64 %60
  %62 = bitcast double* %61 to <4 x double>*
  %wide.vec136 = load <4 x double>, <4 x double>* %62, align 8, !alias.scope !11
  ...
  %63 = fadd <2 x double> %strided.vec137, %strided.vec138
  %64 = add nuw nsw i64 %offset.idx132, 1
  ...
  %interleaved.vec145 = shufflevector <2 x double> %69, <2 x double> %74, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec145, <4 x double>* %77, align 8, !alias.scope !14, !noalias !11
  %index.next128 = add i64 %index127, 2
  %78 = icmp eq i64 %index.next128, %n.vec107
  br i1 %78, label %middle.block102, label %vector.body101, !llvm.loop !16

middle.block102:                                  ; preds = %vector.body101
  %cmp.n131 = icmp eq i64 %n.mod.vf106, 0
  br i1 %cmp.n131, label %for.inc33.us, label %for.inc30.us.preheader183
