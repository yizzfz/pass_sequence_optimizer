...
entry:
  ...
  %arraydecay2 = bitcast i8* %call to [2800 x i32]*
  tail call fastcc void @init_array([2800 x i32]* %arraydecay2)
  tail call void (...) @polybench_timer_start() #4
  tail call fastcc void @kernel_floyd_warshall([2800 x i32]* %arraydecay2)
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  br i1 %23, label %for.inc35.loopexit19, label %vector.body, !llvm.loop !9
...
for.inc35.loopexit19:                             ; preds = %vector.body
  br label %for.inc35

for.inc35:                                        ; preds = %for.inc35.loopexit19, %for.inc35.loopexit
