...
@__llvm_prf_nm = private constant [102 x i8] c"d\00main1\01tmp1.ll:usage\01tmp1.ll:tiffcvt\01tmp1.ll:cvt_by_tile\01tmp1.ll:cvt_by_strip\01tmp1.ll:cvt_whole_image", section "__llvm_prf_names"
@llvm.used = appending global [7 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_main1 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_usage to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_tiffcvt to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_cvt_by_tile to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_cvt_by_strip to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_cvt_whole_image to i8*), i8* getelementptr inbounds ([102 x i8], [102 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
