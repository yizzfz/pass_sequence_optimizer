...
@__llvm_prf_nm = private constant [104 x i8] c"\85\02ex\DA}\CCK\0A\800\0CEQ\DC\90\A0C7\13\0A\8D6\92\B6\A1\89\1F\5C\BD\E0D\07\B5\D3{\1Eo\A5D\06>\1FI]\14\C6\D2Y\94\A1g\9E\D4\5C1\10\A7\FA\E1WQjy\DE\98\95.\04\8D9[hN*\16\C6}\F8\E9c\E3\F2\E1J\A7d\B5\8C\A7\B8\E4\A1\D0\12\0C\D0/x\032\17c(", section "__llvm_prf_names"
@llvm.used = appending global [12 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jinit_downsampler to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_start_pass_downsample to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_sep_downsample to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_fullsize_smooth_downsample to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_fullsize_downsample to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_h2v1_downsample to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_h2v2_smooth_downsample to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_h2v2_downsample to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_int_downsample to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_expand_right_edge to i8*), i8* bitcast ([10 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([104 x i8], [104 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
