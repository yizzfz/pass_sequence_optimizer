...
.lr.ph35:                                         ; preds = %._crit_edge40, %.preheader13.lr.ph
  ...
  %5 = sub i64 1998, %indvars.iv89
  %6 = shl i64 %5, 3
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph35
  %indvars.iv71 = phi i64 [ 0, %.lr.ph35 ], [ %indvars.iv.next72, %._crit_edge ]
  %7 = sub nsw i64 0, %indvars.iv71
  %8 = trunc i64 %7 to i32
  %9 = srem i32 %8, 2000
  %10 = sitofp i32 %9 to double
  %11 = fdiv double %10, 2.000000e+03
  %12 = fadd double %11, 1.000000e+00
  %13 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv89, i64 %indvars.iv71
...
._crit_edge36:                                    ; preds = %._crit_edge
  ...
  %scevgep83 = getelementptr [2000 x double], [2000 x double]* %1, i64 0, i64 %14
...
._crit_edge32.us.prol:                            ; preds = %._crit_edge32.us.prol, %._crit_edge32.us.prol.preheader
  ...
  %prol.iter112 = phi i64 [ 0, %._crit_edge32.us.prol.preheader ], [ %prol.iter112.sub, %._crit_edge32.us.prol ]
  ...
  %prol.iter112.sub = add nsw i64 %prol.iter112, -1
  %prol.iter112.cmp = icmp eq i64 %prol.iter112.sub, 0
  br i1 %prol.iter112.cmp, label %._crit_edge32.us.prol.loopexit.unr-lcssa, label %._crit_edge32.us.prol, !llvm.loop !1
...
._crit_edge32.us:                                 ; preds = %._crit_edge32.us, %._crit_edge42.new
  ...
  br i1 %exitcond70.7, label %.preheader9.us.us.preheader.preheader.unr-lcssa, label %._crit_edge32.us

.preheader9.us.us.preheader.preheader.unr-lcssa:  ; preds = %._crit_edge32.us
  br label %.preheader9.us.us.preheader.preheader

.preheader9.us.us.preheader.preheader:            ; preds = %._crit_edge32.us.prol.loopexit, %.preheader9.us.us.preheader.preheader.unr-lcssa
...
.preheader9.us.us.preheader:                      ; preds = %.preheader9.us.us.preheader.preheader, %._crit_edge21.us
  ...
  %40 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 0, i64 %indvars.iv59
...
._crit_edge93.prol:                               ; preds = %._crit_edge93.prol.preheader
  ...
  %45 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %39, i64 0, i64 %indvars.iv55, i64 0
...
._crit_edge93.prol.loopexit:                      ; preds = %._crit_edge93.prol.loopexit.unr-lcssa
  br i1 false, label %._crit_edge19.us.us, label %.preheader9.us.us.new

.preheader9.us.us.new:                            ; preds = %._crit_edge93.prol.loopexit
  br label %._crit_edge93

._crit_edge19.us.us.unr-lcssa:                    ; preds = %._crit_edge93
  br label %._crit_edge19.us.us

._crit_edge19.us.us:                              ; preds = %._crit_edge93.prol.loopexit, %._crit_edge19.us.us.unr-lcssa
  %.lcssa = phi [2000 x [2000 x double]]* [ %39, %._crit_edge93.prol.loopexit ], [ %38, %._crit_edge19.us.us.unr-lcssa ]
...
._crit_edge93:                                    ; preds = %._crit_edge93, %.preheader9.us.us.new
  ...
  %49 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv51, i64 %indvars.iv59
  %50 = load double, double* %49, align 8
  %51 = fmul double %48, %50
  %52 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %37, i64 0, i64 %indvars.iv55, i64 %indvars.iv51
  %53 = load double, double* %52, align 8
  %54 = fadd double %53, %51
  store double %54, double* %52, align 8
  %indvars.iv.next52 = add nuw nsw i64 %indvars.iv51, 1
  %55 = load double, double* %41, align 8
  %56 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv.next52, i64 %indvars.iv59
  %57 = load double, double* %56, align 8
  %58 = fmul double %55, %57
  %59 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %38, i64 0, i64 %indvars.iv55, i64 %indvars.iv.next52
  ...
  br i1 %exitcond54.1, label %._crit_edge19.us.us.unr-lcssa, label %._crit_edge93

.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %._crit_edge.us ], [ 0, %.preheader.us.preheader ]
  %scevgep98 = getelementptr [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 0
  %scevgep100 = getelementptr [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 2000
  %scevgep102 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %.lcssa, i64 0, i64 %indvars.iv47, i64 0
  %scevgep104 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %.lcssa, i64 0, i64 %indvars.iv47, i64 2000
  br i1 false, label %._crit_edge94.preheader, label %min.iters.checked

min.iters.checked:                                ; preds = %.preheader.us
  br i1 false, label %._crit_edge94.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %bound0 = icmp ult double* %scevgep98, %scevgep104
  %bound1 = icmp ult double* %scevgep102, %scevgep100
  %memcheck.conflict = and i1 %bound0, %bound1
  br i1 %memcheck.conflict, label %._crit_edge94.preheader, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %62 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %.lcssa, i64 0, i64 %indvars.iv47, i64 %index
  ...
  %wide.load107 = load <2 x i64>, <2 x i64>* %65, align 8, !alias.scope !3
  %66 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 %index
  ...
  store <2 x i64> %wide.load107, <2 x i64>* %69, align 8, !alias.scope !6, !noalias !3
...
._crit_edge94.preheader:                          ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.preheader.us
...
._crit_edge94.prol:                               ; preds = %._crit_edge94.prol, %._crit_edge94.prol.preheader
  ...
  %72 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %.lcssa, i64 0, i64 %indvars.iv47, i64 %indvars.iv.prol
  %73 = bitcast double* %72 to i64*
  %74 = load i64, i64* %73, align 8
  %75 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 %indvars.iv.prol
  %76 = bitcast double* %75 to i64*
  store i64 %74, i64* %76, align 8
  %indvars.iv.next.prol = add nuw nsw i64 %indvars.iv.prol, 1
  %prol.iter.sub = add nsw i64 %prol.iter, -1
  %prol.iter.cmp = icmp eq i64 %prol.iter.sub, 0
  br i1 %prol.iter.cmp, label %._crit_edge94.prol.loopexit.unr-lcssa, label %._crit_edge94.prol, !llvm.loop !11
...
._crit_edge94.prol.loopexit:                      ; preds = %._crit_edge94.preheader, %._crit_edge94.prol.loopexit.unr-lcssa
  ...
  br i1 %77, label %._crit_edge.us.loopexit, label %._crit_edge94.preheader.new
...
._crit_edge94:                                    ; preds = %._crit_edge94, %._crit_edge94.preheader.new
  ...
  %78 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %.lcssa, i64 0, i64 %indvars.iv47, i64 %indvars.iv
  %79 = bitcast double* %78 to i64*
  %80 = load i64, i64* %79, align 8
  %81 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 %indvars.iv
  %82 = bitcast double* %81 to i64*
  store i64 %80, i64* %82, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %83 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %.lcssa, i64 0, i64 %indvars.iv47, i64 %indvars.iv.next
  %84 = bitcast double* %83 to i64*
  %85 = load i64, i64* %84, align 8
  %86 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 %indvars.iv.next
  %87 = bitcast double* %86 to i64*
  store i64 %85, i64* %87, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %88 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %.lcssa, i64 0, i64 %indvars.iv47, i64 %indvars.iv.next.1
  %89 = bitcast double* %88 to i64*
  %90 = load i64, i64* %89, align 8
  %91 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 %indvars.iv.next.1
  %92 = bitcast double* %91 to i64*
  store i64 %90, i64* %92, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %93 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %.lcssa, i64 0, i64 %indvars.iv47, i64 %indvars.iv.next.2
  %94 = bitcast double* %93 to i64*
  %95 = load i64, i64* %94, align 8
  %96 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 %indvars.iv.next.2
  %97 = bitcast double* %96 to i64*
  store i64 %95, i64* %97, align 8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %exitcond46.3 = icmp eq i64 %indvars.iv.next.3, 2000
  br i1 %exitcond46.3, label %._crit_edge.us.loopexit.unr-lcssa, label %._crit_edge94, !llvm.loop !12
...
._crit_edge16:                                    ; preds = %._crit_edge16.loopexit, %._crit_edge42.thread
  %98 = phi i8* [ %3, %._crit_edge42.thread ], [ %20, %._crit_edge16.loopexit ]
...
._crit_edge39.prol:                               ; preds = %._crit_edge39.prol, %._crit_edge39.prol.preheader
  ...
  %prol.iter.sub = add nsw i64 %prol.iter, -1
  %prol.iter.cmp = icmp eq i64 %prol.iter.sub, 0
  br i1 %prol.iter.cmp, label %._crit_edge39.prol.loopexit.unr-lcssa, label %._crit_edge39.prol, !llvm.loop !13
