...
.lr.ph8:                                          ; preds = %.lr.ph8, %.lr.ph8.preheader
  %indvars.iv15 = phi i64 [ 0, %.lr.ph8.preheader ], [ %indvars.iv.next16.2, %.lr.ph8 ]
  %2 = trunc i64 %indvars.iv15 to i32
  %3 = sitofp i32 %2 to double
  %4 = getelementptr inbounds double, double* %1, i64 %indvars.iv15
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  %5 = trunc i64 %indvars.iv.next16 to i32
  ...
  %16 = getelementptr inbounds double, double* %1, i64 %indvars.iv.next16.1
  store double %15, double* %16, align 8
  %indvars.iv.next16.2 = add nuw nsw i64 %indvars.iv15, 3
  %exitcond17.2 = icmp eq i64 %indvars.iv.next16.2, 2100
  br i1 %exitcond17.2, label %.lr.ph5.preheader, label %.lr.ph8

.lr.ph5.preheader:                                ; preds = %.lr.ph8
  br label %.lr.ph5

.lr.ph5:                                          ; preds = %.lr.ph5.preheader, %._crit_edge
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %._crit_edge ], [ 0, %.lr.ph5.preheader ]
  br label %._crit_edge18

._crit_edge18:                                    ; preds = %._crit_edge18, %.lr.ph5
  %indvars.iv = phi i64 [ 0, %.lr.ph5 ], [ %indvars.iv.next.1, %._crit_edge18 ]
  %17 = add nuw nsw i64 %indvars.iv13, %indvars.iv
  %18 = trunc i64 %17 to i32
  %19 = srem i32 %18, 2100
  %20 = sitofp i32 %19 to double
  %21 = getelementptr inbounds [2100 x double], [2100 x double]* %0, i64 %indvars.iv13, i64 %indvars.iv
  %indvars.iv.next = or i64 %indvars.iv, 1
  %22 = add nuw nsw i64 %indvars.iv13, %indvars.iv.next
  ...
  br i1 %exitcond.1, label %._crit_edge, label %._crit_edge18

._crit_edge:                                      ; preds = %._crit_edge18
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond = icmp eq i64 %indvars.iv.next14, 1900
  br i1 %exitcond, label %30, label %.lr.ph5
...
.lr.ph8.preheader:
  ...
  %sunkaddr35 = ptrtoint double* %3 to i64
  br label %.lr.ph8

.lr.ph8:                                          ; preds = %._crit_edge6, %.lr.ph8.preheader
  %indvars.iv20 = phi i64 [ 0, %.lr.ph8.preheader ], [ %indvars.iv.next21, %._crit_edge6 ]
  %8 = getelementptr inbounds double, double* %3, i64 %indvars.iv20
  store double 0.000000e+00, double* %8, align 8
  %9 = load [2100 x double]*, [2100 x double]** %4, align 8
  %10 = load double*, double** %5, align 8
  %sunkaddr32 = shl nuw nsw i64 %indvars.iv20, 3
  %sunkaddr33 = add i64 %sunkaddr, %sunkaddr32
  %sunkaddr34 = inttoptr i64 %sunkaddr33 to double*
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph8
  %indvars.iv = phi i64 [ 0, %.lr.ph8 ], [ %indvars.iv.next.2, %._crit_edge ]
  %11 = load double, double* %sunkaddr34, align 8
  %12 = getelementptr inbounds [2100 x double], [2100 x double]* %9, i64 %indvars.iv20, i64 %indvars.iv
  %13 = load double, double* %12, align 8
  %14 = getelementptr inbounds double, double* %10, i64 %indvars.iv
  %15 = load double, double* %14, align 8
  %16 = fmul double %13, %15
  %17 = fadd double %11, %16
  store double %17, double* %sunkaddr34, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %18 = getelementptr inbounds [2100 x double], [2100 x double]* %9, i64 %indvars.iv20, i64 %indvars.iv.next
  %19 = load double, double* %18, align 8
  %20 = getelementptr inbounds double, double* %10, i64 %indvars.iv.next
  %21 = load double, double* %20, align 8
  %22 = fmul double %19, %21
  %23 = fadd double %17, %22
  store double %23, double* %sunkaddr34, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %24 = getelementptr inbounds [2100 x double], [2100 x double]* %9, i64 %indvars.iv20, i64 %indvars.iv.next.1
  %25 = load double, double* %24, align 8
  %26 = getelementptr inbounds double, double* %10, i64 %indvars.iv.next.1
  %27 = load double, double* %26, align 8
  %28 = fmul double %25, %27
  %29 = fadd double %23, %28
  store double %29, double* %sunkaddr34, align 8
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %exitcond.2 = icmp eq i64 %indvars.iv.next.2, 2100
  br i1 %exitcond.2, label %.lr.ph5.preheader, label %._crit_edge

.lr.ph5.preheader:                                ; preds = %._crit_edge
  %sunkaddr36 = shl nuw nsw i64 %indvars.iv20, 3
  %sunkaddr37 = add i64 %sunkaddr35, %sunkaddr36
  %sunkaddr38 = inttoptr i64 %sunkaddr37 to double*
  br label %.lr.ph5

.lr.ph5:                                          ; preds = %.lr.ph5.preheader, %.lr.ph5
  %indvars.iv18 = phi i64 [ %indvars.iv.next19.1, %.lr.ph5 ], [ 0, %.lr.ph5.preheader ]
  %30 = load double*, double** %6, align 8
  %31 = getelementptr inbounds double, double* %30, i64 %indvars.iv18
  %32 = load double, double* %31, align 8
  %33 = load [2100 x double]*, [2100 x double]** %4, align 8
  %34 = getelementptr inbounds [2100 x double], [2100 x double]* %33, i64 %indvars.iv20, i64 %indvars.iv18
  %35 = load double, double* %34, align 8
  %36 = load double, double* %sunkaddr38, align 8
  %37 = fmul double %35, %36
  %38 = fadd double %32, %37
  store double %38, double* %31, align 8
  %indvars.iv.next19 = or i64 %indvars.iv18, 1
  %39 = load double*, double** %6, align 8
  %40 = getelementptr inbounds double, double* %39, i64 %indvars.iv.next19
  %41 = load double, double* %40, align 8
  %42 = load [2100 x double]*, [2100 x double]** %4, align 8
  %43 = getelementptr inbounds [2100 x double], [2100 x double]* %42, i64 %indvars.iv20, i64 %indvars.iv.next19
  %44 = load double, double* %43, align 8
  %45 = load double, double* %sunkaddr38, align 8
  %46 = fmul double %44, %45
  %47 = fadd double %41, %46
  store double %47, double* %40, align 8
  %indvars.iv.next19.1 = add nuw nsw i64 %indvars.iv18, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next19.1, 2100
  br i1 %exitcond.1, label %._crit_edge6, label %.lr.ph5

._crit_edge6:                                     ; preds = %.lr.ph5
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  %exitcond = icmp eq i64 %indvars.iv.next21, 1900
  br i1 %exitcond, label %48, label %.lr.ph8
...
.lr.ph._crit_edge:                                ; preds = %.lr.ph, %8
  ...
  br i1 %exitcond, label %14, label %.lr.ph

; <label>:14:                                     ; preds = %.lr.ph._crit_edge
