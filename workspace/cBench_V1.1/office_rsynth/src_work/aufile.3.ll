...
@__llvm_prf_nm = private constant [60 x i8] c"K:x\DAK,\8D\CFHMLI-b,\C9-0\D4\CB\C9\B1*O\CA\C9\CFKgL\CB\CCI\8D\CF\CC\CB,\81K$\96\82\C5\CA\8B2KR\D1\05KR\8Br\01\10\F7\1B\B2", section "__llvm_prf_names"
@llvm.used = appending global [6 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_au_header to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_wblong to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_file_init to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_aufile_write to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_aufile_term to i8*), i8* getelementptr inbounds ([60 x i8], [60 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
