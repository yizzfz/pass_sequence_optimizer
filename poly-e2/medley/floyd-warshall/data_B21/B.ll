...
for.body6:                                        ; preds = %for.body6.preheader, %for.body6.for.body6_crit_edge
  ...
  %exitcond = icmp eq i64 %indvars.iv, 2799
  br i1 %exitcond, label %for.inc35.loopexit, label %for.body6.for.body6_crit_edge, !llvm.loop !12
...
for.inc35:                                        ; preds = %for.inc35.loopexit16, %for.inc35.loopexit
  ...
  %exitcond17 = icmp eq i64 %indvars.iv.next28, 2800
  br i1 %exitcond17, label %for.inc38, label %for.cond4.preheader

for.inc38:                                        ; preds = %for.inc35
  %indvars.iv.next30 = add nuw nsw i64 %indvars.iv29, 1
  %exitcond18 = icmp eq i64 %indvars.iv.next30, 2800
  br i1 %exitcond18, label %for.end40, label %for.cond1.preheader
