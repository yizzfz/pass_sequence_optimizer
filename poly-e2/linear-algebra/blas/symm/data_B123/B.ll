...
for.cond1.for.inc16_crit_edge.us:                 ; preds = %for.inc.us
  ...
  %exitcond80 = icmp eq i64 %indvars.iv.next68, 1000
  br i1 %exitcond80, label %for.inc36.lr.ph.preheader, label %for.cond1.preheader.us
...
for.inc48.preheader:                              ; preds = %for.inc48.prol.loopexit
  %16 = sub i64 992, %indvars.iv51.unr
  %17 = lshr i64 %16, 3
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %23 = shl i64 %index, 3
  %24 = add i64 %indvars.iv51.unr, %23
  %25 = add nsw i64 %24, 7
  %26 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv60, i64 %25
...
for.inc36:                                        ; preds = %for.inc36.preheader, %for.inc36
  ...
  %30 = add nuw nsw i64 %indvars.iv, %indvars.iv60
  ...
  %32 = add nuw nsw i64 %indvars.iv.next, %indvars.iv60
  ...
  %34 = bitcast double* %arrayidx35 to <2 x double>*
  store <2 x double> %div31, <2 x double>* %34, align 8
...
for.inc51:                                        ; preds = %for.inc51.loopexit, %middle.block, %for.inc48.prol.loopexit, %for.cond40.preheader
  ...
  %exitcond79 = icmp eq i64 %indvars.iv.next61, 1000
  br i1 %exitcond79, label %for.end53, label %for.inc36.lr.ph
...
for.cond4.preheader:                              ; preds = %for.cond4.preheader, %for.cond4.preheader.preheader
  ...
  br i1 %exitcond58.1, label %for.inc53.loopexit85, label %for.cond4.preheader, !llvm.loop !17
