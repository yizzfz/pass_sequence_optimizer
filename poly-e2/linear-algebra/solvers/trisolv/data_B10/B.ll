...
for.body5.preheader:                              ; preds = %for.body
  %sunkaddr7 = shl i64 %indvars.iv5, 3
...
for.body5.prol:                                   ; preds = %for.body5.prol.preheader
  ...
  store double %sub.prol, double* %sunkaddr9, align 8
...
for.body5:                                        ; preds = %for.body5, %for.body5.preheader.new
  ...
  store double %sub, double* %sunkaddr9, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  ...
  store double %sub.1, double* %sunkaddr9, align 8
...
for.end:                                          ; preds = %for.end.loopexit, %for.body
  ...
  store double %div, double* %sunkaddr13, align 8
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1
