...
if.then:                                          ; preds = %land.lhs.true
  call fastcc void @print_array(double* %arraydecay1, double* %arraydecay52)
  br label %if.end
...
for.inc:                                          ; preds = %for.inc, %for.body
  %indvars.iv18 = phi i64 [ %indvars.iv.next19.1, %for.inc ], [ 0, %for.body ]
  ...
  br i1 %exitcond21.1, label %for.inc12, label %for.inc
