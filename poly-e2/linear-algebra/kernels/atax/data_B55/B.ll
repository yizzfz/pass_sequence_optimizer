...
entry:
  ...
  call fastcc void @init_array([2100 x double]* %0, double* %1)
  call void (...) @polybench_timer_start() #4
  %2 = bitcast i8* %call2 to double*
  %3 = bitcast i8* %call3 to double*
  call fastcc void @kernel_atax([2100 x double]* %0, double* %1, double* %2, double* %3)
...
for.body5.us:                                     ; preds = %for.body5.us.preheader, %for.inc42.us
  ...
  %sunkaddr5 = shl i64 %indvars.iv66, 3
...
for.body26.us.for.body26.us_crit_edge:            ; preds = %for.body26.us.for.body26.us_crit_edge.1, %for.body26.us.preheader
  %indvars.iv.next6511 = phi i64 [ 1, %for.body26.us.preheader ], [ %indvars.iv.next65.1, %for.body26.us.for.body26.us_crit_edge.1 ]
  %.pre = load double, double* %sunkaddr14, align 8
  %arrayidx28.us = getelementptr inbounds double, double* %y, i64 %indvars.iv.next6511
  %0 = load double, double* %arrayidx28.us, align 8
  %arrayidx32.us = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv66, i64 %indvars.iv.next6511
  ...
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv.next6511, 1
...
for.body10.us:                                    ; preds = %for.body10.us, %for.body5.us
  ...
  store double %add.us, double* %sunkaddr7, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %add.us.1, double* %sunkaddr7, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
...
for.body26.us.preheader:                          ; preds = %for.body10.us
  ...
  %arrayidx32.us8 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv66, i64 0
  %8 = load double, double* %arrayidx32.us8, align 8
  %mul35.us9 = fmul double %8, %add.us.1
  %add36.us10 = fadd double %7, %mul35.us9
  store double %add36.us10, double* %y, align 8
  %sunkaddr12 = mul i64 %indvars.iv66, 8
  %sunkaddr13 = add i64 %sunkaddr, %sunkaddr12
  %sunkaddr14 = inttoptr i64 %sunkaddr13 to double*
  %sunkaddr16 = mul i64 %indvars.iv66, 8
...
for.body26.us.for.body26.us_crit_edge.1:          ; preds = %for.body26.us.for.body26.us_crit_edge
  %.pre.1 = load double, double* %sunkaddr18, align 8
  %sunkaddr20 = mul i64 %indvars.iv.next6511, 8
  ...
  store double %add36.us.1, double* %sunkaddr23, align 8
  %indvars.iv.next65.1 = add nsw i64 %indvars.iv.next6511, 2
  br label %for.body26.us.for.body26.us_crit_edge
}
