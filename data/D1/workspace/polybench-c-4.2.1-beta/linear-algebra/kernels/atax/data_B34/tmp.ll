...
._crit_edge1:                                     ; preds = %._crit_edge1, %.lr.ph2
  ...
  %17 = add nuw nsw i64 %indvars.iv10, %indvars.iv
  %18 = trunc i64 %17 to i32
  %19 = srem i32 %18, 2100
  %20 = sitofp i32 %19 to double
  %21 = getelementptr inbounds [2100 x double], [2100 x double]* %0, i64 %indvars.iv10, i64 %indvars.iv
  %indvars.iv.next = or i64 %indvars.iv, 1
  %22 = add nuw nsw i64 %indvars.iv10, %indvars.iv.next
...
._crit_edge:                                      ; preds = %._crit_edge1
  ...
  br i1 %exitcond, label %30, label %.lr.ph2
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph5
  %indvars.iv = phi i64 [ 0, %.lr.ph5 ], [ %indvars.iv.next.2, %._crit_edge ]
  %11 = load double, double* %sunkaddr31, align 8
  %12 = getelementptr inbounds [2100 x double], [2100 x double]* %9, i64 %indvars.iv17, i64 %indvars.iv
  ...
  %18 = getelementptr inbounds [2100 x double], [2100 x double]* %9, i64 %indvars.iv17, i64 %indvars.iv.next
  %19 = load double, double* %18, align 8
  %20 = getelementptr inbounds double, double* %10, i64 %indvars.iv.next
  %21 = load double, double* %20, align 8
  %22 = fmul double %19, %21
  %23 = fadd double %17, %22
  store double %23, double* %sunkaddr31, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %24 = getelementptr inbounds [2100 x double], [2100 x double]* %9, i64 %indvars.iv17, i64 %indvars.iv.next.1
  %25 = load double, double* %24, align 8
  %26 = getelementptr inbounds double, double* %10, i64 %indvars.iv.next.1
  %27 = load double, double* %26, align 8
  %28 = fmul double %25, %27
  %29 = fadd double %23, %28
  store double %29, double* %sunkaddr31, align 8
...
.lr.ph2:                                          ; preds = %.lr.ph2.preheader, %.lr.ph2
  ...
  %31 = getelementptr inbounds double, double* %30, i64 %indvars.iv15
  %32 = load double, double* %31, align 8
  %33 = load [2100 x double]*, [2100 x double]** %4, align 8
  %34 = getelementptr inbounds [2100 x double], [2100 x double]* %33, i64 %indvars.iv17, i64 %indvars.iv15
  %35 = load double, double* %34, align 8
  %36 = load double, double* %sunkaddr35, align 8
  %37 = fmul double %35, %36
  %38 = fadd double %32, %37
  store double %38, double* %31, align 8
  %indvars.iv.next16 = or i64 %indvars.iv15, 1
  %39 = load double*, double** %6, align 8
  %40 = getelementptr inbounds double, double* %39, i64 %indvars.iv.next16
  %41 = load double, double* %40, align 8
  %42 = load [2100 x double]*, [2100 x double]** %4, align 8
  %43 = getelementptr inbounds [2100 x double], [2100 x double]* %42, i64 %indvars.iv17, i64 %indvars.iv.next16
  %44 = load double, double* %43, align 8
  %45 = load double, double* %sunkaddr35, align 8
...
._crit_edge3:                                     ; preds = %.lr.ph2
  ...
  br i1 %exitcond, label %48, label %.lr.ph5
