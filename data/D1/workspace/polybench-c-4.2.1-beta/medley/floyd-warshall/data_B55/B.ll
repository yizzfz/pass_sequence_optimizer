...
.preheader.us:                                    ; preds = %._crit_edge23.us, %.preheader.us.preheader
  %indvars.iv29 = phi i64 [ 0, %.preheader.us.preheader ], [ %indvars.iv.next30, %._crit_edge23.us ]
  br label %1

; <label>:1:                                      ; preds = %._crit_edge3.us, %.preheader.us
  %indvars.iv = phi i64 [ 0, %.preheader.us ], [ %indvars.iv.next, %._crit_edge3.us ]
  %2 = mul nuw nsw i64 %indvars.iv, %indvars.iv29
  %3 = trunc i64 %2 to i32
  %4 = srem i32 %3, 7
  %5 = add nsw i32 %4, 1
  %6 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv29, i64 %indvars.iv
  %7 = add nuw nsw i64 %indvars.iv, %indvars.iv29
  ...
  br i1 %or.cond3, label %._crit_edge.us, label %._crit_edge3.us

._crit_edge.us:                                   ; preds = %1
  br label %._crit_edge3.us

._crit_edge3.us:                                  ; preds = %1, %._crit_edge.us
  %storemerge = phi i32 [ 999, %._crit_edge.us ], [ %5, %1 ]
  store i32 %storemerge, i32* %6, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 2800
  br i1 %exitcond, label %._crit_edge23.us, label %1

._crit_edge23.us:                                 ; preds = %._crit_edge3.us
  %indvars.iv.next30 = add nuw nsw i64 %indvars.iv29, 1
  %exitcond4 = icmp eq i64 %indvars.iv.next30, 2800
  br i1 %exitcond4, label %._crit_edge26, label %.preheader.us
...
.preheader.us.us.preheader:                       ; preds = %._crit_edge32.us, %.preheader29.lr.ph
  %indvars.iv45 = phi i64 [ 0, %.preheader29.lr.ph ], [ %indvars.iv.next46, %._crit_edge32.us ]
  %scevgep4 = getelementptr [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv45, i64 0
  %1 = add nuw nsw i64 %indvars.iv45, 1
  %scevgep6 = getelementptr [2800 x i32], [2800 x i32]* %0, i64 %1, i64 0
  br label %.preheader.us.us

._crit_edge32.us:                                 ; preds = %._crit_edge.us.us
  %indvars.iv.next46 = add nuw nsw i64 %indvars.iv45, 1
  %exitcond18 = icmp eq i64 %indvars.iv.next46, 2800
  br i1 %exitcond18, label %._crit_edge34, label %.preheader.us.us.preheader

.preheader.us.us:                                 ; preds = %._crit_edge.us.us, %.preheader.us.us.preheader
  %indvars.iv43 = phi i64 [ 0, %.preheader.us.us.preheader ], [ %indvars.iv.next44, %._crit_edge.us.us ]
  %scevgep = getelementptr [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv43, i64 0
  %2 = add nuw nsw i64 %indvars.iv43, 1
  %scevgep2 = getelementptr [2800 x i32], [2800 x i32]* %0, i64 %2, i64 0
  %3 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv43, i64 %indvars.iv45
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %4 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv43, i64 %index
  ...
  %13 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv45, i64 %index
  ...
  br i1 %25, label %._crit_edge.us.us.loopexit19, label %vector.body, !llvm.loop !9

._crit_edge.us.us.loopexit:                       ; preds = %scalar.ph
  br label %._crit_edge.us.us

._crit_edge.us.us.loopexit19:                     ; preds = %vector.body
  br label %._crit_edge.us.us

._crit_edge.us.us:                                ; preds = %._crit_edge.us.us.loopexit19, %._crit_edge.us.us.loopexit
  %indvars.iv.next44 = add nuw nsw i64 %indvars.iv43, 1
  %exitcond17 = icmp eq i64 %indvars.iv.next44, 2800
  br i1 %exitcond17, label %._crit_edge32.us, label %.preheader.us.us

scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader
  %indvars.iv = phi i64 [ 0, %scalar.ph.preheader ], [ %indvars.iv.next.1, %scalar.ph ]
  %26 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv43, i64 %indvars.iv
  %27 = load i32, i32* %26, align 4
  %28 = load i32, i32* %3, align 4
  %29 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv45, i64 %indvars.iv
  ...
  %33 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv43, i64 %indvars.iv.next
  %34 = load i32, i32* %33, align 4
  %35 = load i32, i32* %3, align 4
  %36 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv45, i64 %indvars.iv.next
  ...
  br i1 %exitcond.1, label %._crit_edge.us.us.loopexit, label %scalar.ph, !llvm.loop !12

._crit_edge34:                                    ; preds = %._crit_edge32.us
  ret void
}
...
.preheader.us:                                    ; preds = %._crit_edge12.us, %.preheader.us.preheader
  ...
  %5 = mul nuw nsw i64 %indvars.iv15, 2800
  br label %6
...
._crit_edge.us:                                   ; preds = %6, %11
  ...
  %14 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv15, i64 %indvars.iv
...
._crit_edge12.us:                                 ; preds = %._crit_edge.us
  ...
  %exitcond1 = icmp eq i64 %indvars.iv.next16, 2800
