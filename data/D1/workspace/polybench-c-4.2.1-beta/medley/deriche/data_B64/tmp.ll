...
.preheader178.us.new:                             ; preds = %.preheader178.us.new.preheader, %._crit_edge
  %indvars.iv250.us = phi i64 [ %indvars.iv.next251.us.1, %._crit_edge ], [ %indvars.iv250.us.unr.ph, %.preheader178.us.new.preheader ]
  %.0155213.us = phi float [ %63, %._crit_edge ], [ 0.000000e+00, %.preheader178.us.new.preheader ]
  %.0157212.us = phi float [ %60, %._crit_edge ], [ 0.000000e+00, %.preheader178.us.new.preheader ]
  %.0159211.us = phi float [ %49, %._crit_edge ], [ 0.000000e+00, %.preheader178.us.new.preheader ]
  ...
  br i1 %exitcond253.us.1, label %._crit_edge216.us.loopexit, label %._crit_edge

._crit_edge:                                      ; preds = %.preheader178.us.new
...
.preheader176.us.new:                             ; preds = %.preheader176.us.new.preheader, %._crit_edge285
  %indvars.iv244.us.in = phi i64 [ %indvars.iv244.us.1, %._crit_edge285 ], [ %indvars.iv244.us.in.unr.ph, %.preheader176.us.new.preheader ]
  %.0161206.us = phi float [ %91, %._crit_edge285 ], [ 0.000000e+00, %.preheader176.us.new.preheader ]
  %.0162205.us = phi float [ %80, %._crit_edge285 ], [ 0.000000e+00, %.preheader176.us.new.preheader ]
  %.0165204.us = phi float [ %87, %._crit_edge285 ], [ %.0165204.us.unr.ph, %.preheader176.us.new.preheader ]
  %.0167203.us = phi float [ %77, %._crit_edge285 ], [ 0.000000e+00, %.preheader176.us.new.preheader ]
  ...
  br i1 %89, label %._crit_edge285, label %._crit_edge209.us.loopexit

._crit_edge285:                                   ; preds = %.preheader176.us.new
  %90 = getelementptr inbounds [2160 x float], [2160 x float]* %3, i64 %indvars.iv246.us, i64 %indvars.iv244.us.1
...
.preheader174.us:                                 ; preds = %.preheader174.us.preheader, %._crit_edge200.us
  ...
  %scevgep301 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv240.us, i64 2
  %scevgep307 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv240.us, i64 2
  %scevgep313 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv240.us, i64 2
...
vector.memcheck:                                  ; preds = %min.iters.checked
  %scevgep299 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv240.us, i64 %indvars.iv236.us.unr.ph
  ...
  %scevgep305 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv240.us, i64 %indvars.iv236.us.unr.ph
  %scevgep308 = getelementptr float, float* %scevgep307, i64 %97
  %scevgep311 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv240.us, i64 %indvars.iv236.us.unr.ph
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %._crit_edge200.us, label %.preheader174.us.new.preheader377
...
.preheader174.us.new:                             ; preds = %.preheader174.us.new.preheader377, %.preheader174.us.new
  %indvars.iv236.us = phi i64 [ %indvars.iv.next237.us.1, %.preheader174.us.new ], [ %indvars.iv236.us.ph, %.preheader174.us.new.preheader377 ]
...
.preheader172.us.new:                             ; preds = %.preheader172.us.new.preheader, %._crit_edge287
  %indvars.iv228.us = phi i64 [ %indvars.iv.next229.us.1, %._crit_edge287 ], [ %indvars.iv228.us.unr.ph, %.preheader172.us.new.preheader ]
  %.0156193.us = phi float [ %149, %._crit_edge287 ], [ 0.000000e+00, %.preheader172.us.new.preheader ]
  %.1158192.us = phi float [ %147, %._crit_edge287 ], [ 0.000000e+00, %.preheader172.us.new.preheader ]
  %.1160191.us = phi float [ %136, %._crit_edge287 ], [ 0.000000e+00, %.preheader172.us.new.preheader ]
  ...
  br i1 %exitcond231.us.1, label %._crit_edge196.us.loopexit, label %._crit_edge287

._crit_edge287:                                   ; preds = %.preheader172.us.new
...
.preheader170.us.new:                             ; preds = %.preheader170.us.new.preheader, %._crit_edge288
  %indvars.iv222.us.in = phi i64 [ %indvars.iv222.us.1, %._crit_edge288 ], [ %indvars.iv222.us.in.unr.ph, %.preheader170.us.new.preheader ]
  %.0163186.us = phi float [ %177, %._crit_edge288 ], [ 0.000000e+00, %.preheader170.us.new.preheader ]
  %.0164185.us = phi float [ %166, %._crit_edge288 ], [ 0.000000e+00, %.preheader170.us.new.preheader ]
  %.1166184.us = phi float [ %173, %._crit_edge288 ], [ %.1166184.us.unr.ph, %.preheader170.us.new.preheader ]
  %.1168183.us = phi float [ %163, %._crit_edge288 ], [ 0.000000e+00, %.preheader170.us.new.preheader ]
  ...
  br i1 %175, label %._crit_edge288, label %._crit_edge189.us.loopexit

._crit_edge288:                                   ; preds = %.preheader170.us.new
  %176 = getelementptr inbounds [2160 x float], [2160 x float]* %4, i64 %indvars.iv222.us.1, i64 %indvars.iv224.us
...
.preheader.us:                                    ; preds = %._crit_edge.us, %.preheader.us.preheader
  ...
  %scevgep335 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv218.us, i64 2
  %scevgep341 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv218.us, i64 2
  %scevgep347 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv218.us, i64 2
...
vector.memcheck358:                               ; preds = %min.iters.checked327
  %scevgep333 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv218.us, i64 %indvars.iv.us.unr.ph
  ...
  %scevgep339 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv218.us, i64 %indvars.iv.us.unr.ph
  %scevgep342 = getelementptr float, float* %scevgep341, i64 %184
  %scevgep345 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv218.us, i64 %indvars.iv.us.unr.ph
...
vector.body323:                                   ; preds = %vector.body323.preheader, %vector.body323
  ...
  %190 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv218.us, i64 %offset.idx365
  %191 = bitcast float* %190 to <8 x float>*
  %wide.vec369 = load <8 x float>, <8 x float>* %191, align 4, !alias.scope !16
  %192 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv218.us, i64 %offset.idx365
...
.preheader.lr.ph:                                 ; preds = %3
  br i1 true, label %.preheader.us.preheader, label %._crit_edge16

.preheader.us.preheader:                          ; preds = %.preheader.lr.ph
  br label %.preheader.us

.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge13.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %._crit_edge13.us ], [ 0, %.preheader.us.preheader ]
...
._crit_edge.us:                                   ; preds = %._crit_edge.us._crit_edge, %13
  ...
  br i1 %exitcond.us, label %._crit_edge13.us, label %._crit_edge.us._crit_edge
...
._crit_edge16:                                    ; preds = %._crit_edge16.loopexit, %.preheader.lr.ph, %3
