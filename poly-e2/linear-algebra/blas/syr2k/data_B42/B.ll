...
for.cond24.preheader.lr.ph:                       ; preds = %for.cond1.preheader.lr.ph.for.cond24.preheader.lr.ph_crit_edge, %for.cond20.preheader
  %wide.trip.count.pre-phi = phi i64 [ %.pre, %for.cond1.preheader.lr.ph.for.cond24.preheader.lr.ph_crit_edge ], [ %wide.trip.count27, %for.cond20.preheader ]
...
for.end43:                                        ; preds = %for.end43.loopexit, %for.cond20.preheader.for.end43_crit_edge, %entry
  ret void
}
...
for.inc.us:                                       ; preds = %for.inc.us.preheader150, %for.inc.us
  %indvars.iv = phi i64 [ %indvars.iv.next.3, %for.inc.us ], [ %indvars.iv.ph, %for.inc.us.preheader150 ]
...
for.inc.lr.ph.us:                                 ; preds = %for.inc.lr.ph.us.preheader, %for.cond6.for.inc43_crit_edge.us
  %indvars.iv54 = phi i64 [ %39, %for.cond6.for.inc43_crit_edge.us ], [ 0, %for.inc.lr.ph.us.preheader ]
...
for.inc.us.prol.loopexit:                         ; preds = %for.inc.us.prol.loopexit.loopexit, %for.inc.lr.ph.us
  ...
  br i1 %42, label %for.cond9.preheader.us12.preheader, label %for.inc.us.preheader
...
for.inc.us.preheader:                             ; preds = %for.inc.us.prol.loopexit
  ...
  br i1 %min.iters.check126, label %for.inc.us.preheader150, label %min.iters.checked127

for.inc.us.preheader150:                          ; preds = %middle.block124, %min.iters.checked127, %for.inc.us.preheader
...
min.iters.checked127:                             ; preds = %for.inc.us.preheader
  ...
  br i1 %cmp.zero130, label %for.inc.us.preheader150, label %vector.ph131
...
vector.body123:                                   ; preds = %vector.body123, %vector.ph131
  ...
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv54, i64 %51
  %53 = bitcast double* %52 to <8 x double>*
  %wide.vec141 = load <8 x double>, <8 x double>* %53, align 8
  ...
  %54 = fmul <2 x double> %strided.vec142, %broadcast.splat147
  %55 = fmul <2 x double> %strided.vec143, %broadcast.splat147
  %56 = fmul <2 x double> %strided.vec144, %broadcast.splat147
  %57 = add nsw i64 %51, 3
  %58 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv54, i64 %57
  %59 = fmul <2 x double> %strided.vec145, %broadcast.splat147
  ...
  %interleaved.vec148 = shufflevector <4 x double> %62, <4 x double> %63, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 1, i32 3, i32 5, i32 7>
  store <8 x double> %interleaved.vec148, <8 x double>* %61, align 8
  %index.next133 = add i64 %index132, 2
  %64 = icmp eq i64 %index.next133, %n.vec129
  br i1 %64, label %middle.block124, label %vector.body123, !llvm.loop !21

middle.block124:                                  ; preds = %vector.body123
  %cmp.n136 = icmp eq i64 %n.mod.vf128, 0
  br i1 %cmp.n136, label %for.cond9.preheader.us12.preheader, label %for.inc.us.preheader150
...
for.inc.lr.ph:                                    ; preds = %for.inc.lr.ph.preheader, %for.inc43
  ...
  %65 = add i64 %indvars.iv68, -3
  %indvars.iv.next69 = add nuw nsw i64 %indvars.iv68, 1
  %66 = trunc i64 %indvars.iv.next69 to i32
  %xtraiter63 = and i32 %66, 3
...
for.inc.prol:                                     ; preds = %for.inc.prol.preheader, %for.inc.prol
  ...
  %67 = load double, double* %arrayidx5.prol, align 8
  %mul.prol = fmul double %67, %beta
...
for.inc.prol.loopexit:                            ; preds = %for.inc.prol.loopexit.loopexit, %for.inc.lr.ph
  ...
  %68 = icmp ult i64 %indvars.iv68, 3
  br i1 %68, label %for.inc43, label %for.inc.preheader

for.inc.preheader:                                ; preds = %for.inc.prol.loopexit
  %69 = sub i64 %65, %indvars.iv58.unr
  %70 = lshr i64 %69, 2
  %71 = add nuw nsw i64 %70, 1
  %min.iters.check = icmp ult i64 %71, 2
  br i1 %min.iters.check, label %for.inc.preheader151, label %min.iters.checked

min.iters.checked:                                ; preds = %for.inc.preheader
  %n.mod.vf = and i64 %71, 1
  %n.vec = sub nsw i64 %71, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  %72 = add i64 %indvars.iv58.unr, 4
  %73 = shl nuw i64 %70, 2
  %74 = add i64 %72, %73
  %75 = shl nuw nsw i64 %n.mod.vf, 2
  %ind.end = sub i64 %74, %75
  br i1 %cmp.zero, label %for.inc.preheader151, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %76 = shl i64 %index, 2
  %77 = add i64 %indvars.iv58.unr, %76
  %78 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv68, i64 %77
  %79 = bitcast double* %78 to <8 x double>*
  %wide.vec = load <8 x double>, <8 x double>* %79, align 8
  ...
  %80 = fmul <2 x double> %strided.vec, %broadcast.splat78
  %81 = fmul <2 x double> %strided.vec74, %broadcast.splat78
  %82 = fmul <2 x double> %strided.vec75, %broadcast.splat78
  %83 = add nsw i64 %77, 3
  %84 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv68, i64 %83
  %85 = fmul <2 x double> %strided.vec76, %broadcast.splat78
  %86 = getelementptr double, double* %84, i64 -3
  %87 = bitcast double* %86 to <8 x double>*
  %88 = shufflevector <2 x double> %80, <2 x double> %81, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %89 = shufflevector <2 x double> %82, <2 x double> %85, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %interleaved.vec = shufflevector <4 x double> %88, <4 x double> %89, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 1, i32 3, i32 5, i32 7>
  store <8 x double> %interleaved.vec, <8 x double>* %87, align 8
  %index.next = add i64 %index, 2
  %90 = icmp eq i64 %index.next, %n.vec
  br i1 %90, label %middle.block, label %vector.body, !llvm.loop !23

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.mod.vf, 0
  br i1 %cmp.n, label %for.inc43, label %for.inc.preheader151

for.inc.preheader151:                             ; preds = %middle.block, %min.iters.checked, %for.inc.preheader
  %indvars.iv58.ph = phi i64 [ %indvars.iv58.unr, %min.iters.checked ], [ %indvars.iv58.unr, %for.inc.preheader ], [ %ind.end, %middle.block ]
  br label %for.inc

for.inc:                                          ; preds = %for.inc.preheader151, %for.inc
  %indvars.iv58 = phi i64 [ %indvars.iv.next59.3, %for.inc ], [ %indvars.iv58.ph, %for.inc.preheader151 ]
  %arrayidx5 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv68, i64 %indvars.iv58
  %91 = load double, double* %arrayidx5, align 8
  %mul = fmul double %91, %beta
  ...
  %92 = load double, double* %arrayidx5.1, align 8
  %mul.1 = fmul double %92, %beta
  ...
  %93 = load double, double* %arrayidx5.2, align 8
  %mul.2 = fmul double %93, %beta
  ...
  %94 = load double, double* %arrayidx5.3, align 8
  %mul.3 = fmul double %94, %beta
...
for.inc43:                                        ; preds = %for.inc43.loopexit, %middle.block, %for.inc.prol.loopexit
  ...
  br i1 %exitcond71, label %for.end45.loopexit152, label %for.inc.lr.ph
