...
@__llvm_prf_nm = private constant [20 x i8] c"\0A\12x\DAK/\CE\8DO.JM,I\05\00\16\AC\04\1B", section "__llvm_prf_names"
@llvm.used = appending global [2 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_gsm_create to i8*), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
