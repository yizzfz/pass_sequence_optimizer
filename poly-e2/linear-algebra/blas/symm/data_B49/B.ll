...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc16_crit_edge.us, %entry
  %indvars.iv33 = phi i64 [ 0, %entry ], [ %indvars.iv.next34, %for.cond1.for.inc16_crit_edge.us ]
  %0 = add nuw nsw i64 %indvars.iv33, 1200
...
for.body26.lr.ph:                                 ; preds = %for.body26.lr.ph.preheader, %for.inc51
  %indvars.iv4 = phi i3 [ -1, %for.body26.lr.ph.preheader ], [ %indvars.iv.next5, %for.inc51 ]
  %indvars.iv2 = phi i64 [ 1, %for.body26.lr.ph.preheader ], [ %indvars.iv.next3, %for.inc51 ]
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc51 ], [ 0, %for.body26.lr.ph.preheader ]
  %5 = zext i3 %indvars.iv4 to i64
  %6 = add i64 %indvars.iv2, %5
  %7 = sub nuw nsw i64 1007, %indvars.iv25
  %8 = sub nsw i64 998, %indvars.iv25
  %9 = and i64 %indvars.iv25, 1
...
for.body26.prol:                                  ; preds = %for.body26.lr.ph
  %10 = trunc i64 %indvars.iv25 to i32
...
for.body26.prol.loopexit:                         ; preds = %for.body26.prol, %for.body26.lr.ph
  ...
  %11 = icmp eq i64 %indvars.iv25, 0
  br i1 %11, label %for.cond40.preheader, label %for.body26.preheader
...
for.body43.prol:                                  ; preds = %for.body43.prol.preheader, %for.body43.prol
  %indvars.iv19.prol = phi i64 [ %indvars.iv.next20.prol, %for.body43.prol ], [ %indvars.iv2, %for.body43.prol.preheader ]
...
for.body43.prol.loopexit:                         ; preds = %for.body43.prol.loopexit.loopexit, %for.body43.lr.ph
  %indvars.iv19.unr = phi i64 [ %indvars.iv2, %for.body43.lr.ph ], [ %6, %for.body43.prol.loopexit.loopexit ]
  %12 = icmp ult i64 %8, 7
  br i1 %12, label %for.inc51, label %for.body43.preheader

for.body43.preheader:                             ; preds = %for.body43.prol.loopexit
  %13 = sub i64 992, %indvars.iv19.unr
  %14 = lshr i64 %13, 3
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %20 = shl i64 %index, 3
  %21 = add i64 %indvars.iv19.unr, %20
  %22 = add nsw i64 %21, 7
  %23 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv25, i64 %22
...
for.body26:                                       ; preds = %for.body26.preheader, %for.body26
  ...
  %27 = add nuw nsw i64 %indvars.iv, %indvars.iv25
  ...
  %29 = add nuw nsw i64 %indvars.iv.next, %indvars.iv25
...
entry:
  ...
  %broadcast.splatinsert20 = insertelement <2 x double> undef, double %mul44.us23, i32 0
...
for.cond1.preheader.us:                           ; preds = %entry, %for.cond1.for.inc53_crit_edge.us
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.cond1.for.inc53_crit_edge.us ], [ 0, %entry ]
...
vector.memcheck:                                  ; preds = %for.cond1.preheader.us
  ...
  %scevgep4 = getelementptr [1200 x double], [1200 x double]* %B, i64 %indvars.iv64, i64 0
  %bound0 = icmp ult double* %scevgep, %scevgep6
  %bound1 = icmp ult double* %scevgep4, %scevgep2
  %found.conflict = and i1 %bound0, %bound1
  %bound09 = icmp ult double* %scevgep, %arrayidx41.us.us
  %bound110 = icmp ult double* %arrayidx41.us.us, %scevgep2
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load13 = load <2 x double>, <2 x double>* %9, align 8, !alias.scope !11, !noalias !13
  %10 = fmul <2 x double> %wide.load, %broadcast.splat15
  %11 = fmul <2 x double> %wide.load13, %broadcast.splat15
  %12 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv64, i64 %index
  %13 = bitcast double* %12 to <2 x double>*
  %wide.load16 = load <2 x double>, <2 x double>* %13, align 8, !alias.scope !15
  %14 = getelementptr double, double* %12, i64 2
  %15 = bitcast double* %14 to <2 x double>*
  %wide.load17 = load <2 x double>, <2 x double>* %15, align 8, !alias.scope !15
  %16 = fmul <2 x double> %wide.load16, %broadcast.splat19
  %17 = fmul <2 x double> %wide.load17, %broadcast.splat19
  %18 = fmul <2 x double> %16, %3
  %19 = fmul <2 x double> %17, %5
  %20 = fadd <2 x double> %10, %18
  %21 = fadd <2 x double> %11, %19
  %22 = fadd <2 x double> %broadcast.splat21, %20
  %23 = fadd <2 x double> %broadcast.splat21, %21
  ...
  br i1 %26, label %for.cond1.for.inc53_crit_edge.us.loopexit23, label %vector.body, !llvm.loop !16
...
for.cond4.preheader.us41:                         ; preds = %for.cond4.preheader.us41, %for.cond4.preheader.us41.preheader
  ...
  br i1 %exitcond.1, label %for.cond1.for.inc53_crit_edge.us.loopexit22, label %for.cond4.preheader.us41, !llvm.loop !17
...
for.cond1.for.inc53_crit_edge.us.loopexit22:      ; preds = %for.cond4.preheader.us41
  br label %for.cond1.for.inc53_crit_edge.us

for.cond1.for.inc53_crit_edge.us.loopexit23:      ; preds = %vector.body
  br label %for.cond1.for.inc53_crit_edge.us

for.cond1.for.inc53_crit_edge.us:                 ; preds = %for.cond1.for.inc53_crit_edge.us.loopexit23, %for.cond1.for.inc53_crit_edge.us.loopexit22, %for.cond1.for.inc53_crit_edge.us.loopexit
