...
define i32 @main(i32, i8**) local_unnamed_addr #0 {
  ...
  tail call fastcc void @init_array(double* %.cast, double* %.cast1)
...
; <label>:2:                                      ; preds = %2, %.lr.ph
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next.1, %2 ]
  ...
  %19 = shufflevector <2 x double> %9, <2 x double> %18, <2 x i32> <i32 0, i32 2>
  store <2 x double> %19, <2 x double>* %10, align 8
  %20 = shufflevector <2 x double> %9, <2 x double> %18, <2 x i32> <i32 1, i32 3>
  store <2 x double> %20, <2 x double>* %12, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %21 = icmp slt i64 %indvars.iv.next.1, 2000
...
vector.memcheck61:                                ; preds = %._crit_edge.us.preheader, %._crit_edge5.us
  %2 = phi i32 [ %28, %._crit_edge5.us ], [ 0, %._crit_edge.us.preheader ]
...
vector.body46:                                    ; preds = %vector.body46.preheader, %vector.body46
  ...
  %wide.load72 = load <2 x double>, <2 x double>* %5, align 8, !alias.scope !1
  %6 = getelementptr double, double* %4, i64 2
  %7 = bitcast double* %6 to <2 x double>*
  %wide.load73 = load <2 x double>, <2 x double>* %7, align 8, !alias.scope !1
  ...
  br i1 %27, label %scalar.ph48.preheader.loopexit, label %vector.body46, !llvm.loop !6

._crit_edge5.us:                                  ; preds = %.lr.ph4.us
  %28 = add nsw i32 %2, 1
  %29 = icmp slt i32 %28, 500
  br i1 %29, label %vector.memcheck61, label %81

.lr.ph4.us:                                       ; preds = %.lr.ph4.us.preheader, %.lr.ph4.us
  %indvars.iv25 = phi i64 [ %36, %.lr.ph4.us ], [ %indvars.iv25.ph, %.lr.ph4.us.preheader ]
  ...
  %36 = add nuw nsw i64 %indvars.iv25, 1
  %37 = getelementptr inbounds double, double* %1, i64 %36
  %38 = load double, double* %37, align 8
  %39 = fadd double %35, %38
  %40 = fmul double %39, 3.333300e-01
  %41 = getelementptr inbounds double, double* %0, i64 %indvars.iv25
  store double %40, double* %41, align 8
  %42 = icmp slt i64 %36, 1999
  br i1 %42, label %.lr.ph4.us, label %._crit_edge5.us, !llvm.loop !9

scalar.ph48:                                      ; preds = %scalar.ph48.preheader, %scalar.ph48
  %indvars.iv = phi i64 [ %49, %scalar.ph48 ], [ %indvars.iv.ph, %scalar.ph48.preheader ]
  ...
  br i1 %55, label %scalar.ph48, label %vector.memcheck, !llvm.loop !10
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load41 = load <2 x double>, <2 x double>* %60, align 8, !alias.scope !11
  %61 = getelementptr inbounds double, double* %1, i64 %offset.idx
  %62 = bitcast double* %61 to <2 x double>*
  %wide.load42 = load <2 x double>, <2 x double>* %62, align 8, !alias.scope !11
  %63 = getelementptr double, double* %61, i64 2
  %64 = bitcast double* %63 to <2 x double>*
  %wide.load43 = load <2 x double>, <2 x double>* %64, align 8, !alias.scope !11
  %65 = fadd <2 x double> %wide.load, %wide.load42
  %66 = fadd <2 x double> %wide.load41, %wide.load43
  %67 = add nuw nsw i64 %offset.idx, 1
  %68 = getelementptr inbounds double, double* %1, i64 %67
  %69 = bitcast double* %68 to <2 x double>*
  %wide.load44 = load <2 x double>, <2 x double>* %69, align 8, !alias.scope !11
  %70 = getelementptr double, double* %68, i64 2
  %71 = bitcast double* %70 to <2 x double>*
  %wide.load45 = load <2 x double>, <2 x double>* %71, align 8, !alias.scope !11
  %72 = fadd <2 x double> %65, %wide.load44
  ...
  br i1 %80, label %.lr.ph4.us.preheader.loopexit, label %vector.body, !llvm.loop !16

; <label>:81:                                     ; preds = %._crit_edge5.us
  ret void
}
