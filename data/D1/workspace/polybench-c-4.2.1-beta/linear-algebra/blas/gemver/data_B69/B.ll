...
._crit_edge19:                                    ; preds = %middle.block._crit_edge, %11
  %indvars.iv16 = phi i64 [ 0, %11 ], [ %indvars.iv.next17, %middle.block._crit_edge ]
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %36 = fmul <2 x double> %35, %strided.vec47
  %37 = fadd <2 x double> %strided.vec44, %36
  ...
  %41 = fmul <2 x double> %40, %strided.vec50
  ...
  br i1 %45, label %middle.block._crit_edge.loopexit66, label %vector.body, !llvm.loop !13
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge.preheader
  ...
  br i1 %exitcond15.1, label %middle.block._crit_edge.loopexit, label %._crit_edge, !llvm.loop !16

middle.block._crit_edge.loopexit:                 ; preds = %._crit_edge
  br label %middle.block._crit_edge

middle.block._crit_edge.loopexit66:               ; preds = %vector.body
  br label %middle.block._crit_edge

middle.block._crit_edge:                          ; preds = %middle.block._crit_edge.loopexit66, %middle.block._crit_edge.loopexit
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  %exitcond18 = icmp eq i64 %indvars.iv.next17, 2000
  br i1 %exitcond18, label %.preheader71.preheader, label %._crit_edge19

.preheader71.preheader:                           ; preds = %middle.block._crit_edge
  br label %.preheader71

.preheader71:                                     ; preds = %85, %.preheader71.preheader
  %indvars.iv10 = phi i64 [ 0, %.preheader71.preheader ], [ %indvars.iv.next11, %85 ]
  br label %._crit_edge20

._crit_edge20:                                    ; preds = %._crit_edge20, %.preheader71
  %indvars.iv7 = phi i64 [ 0, %.preheader71 ], [ %indvars.iv.next8.1, %._crit_edge20 ]
  ...
  %70 = load double, double* %sunkaddr61, align 8
  ...
  store double %77, double* %sunkaddr61, align 8
  ...
  store double %84, double* %sunkaddr61, align 8
  %indvars.iv.next8.1 = add nuw nsw i64 %indvars.iv7, 2
  %exitcond9.1 = icmp eq i64 %indvars.iv.next8.1, 2000
  br i1 %exitcond9.1, label %85, label %._crit_edge20

; <label>:85:                                     ; preds = %._crit_edge20
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %exitcond12 = icmp eq i64 %indvars.iv.next11, 2000
  br i1 %exitcond12, label %.preheader70.preheader, label %.preheader71

.preheader70.preheader:                           ; preds = %85
  br label %.preheader70

.preheader70:                                     ; preds = %.preheader70, %.preheader70.preheader
  %indvars.iv4 = phi i64 [ 0, %.preheader70.preheader ], [ %indvars.iv.next5.4, %.preheader70 ]
  ...
  br i1 %exitcond6.4, label %.preheader.preheader, label %.preheader70
...
._crit_edge22:                                    ; preds = %._crit_edge22, %.preheader
  ...
  %111 = load double, double* %sunkaddr65, align 8
  ...
  store double %118, double* %sunkaddr65, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %125, double* %sunkaddr65, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %126, label %._crit_edge22

; <label>:126:                                    ; preds = %._crit_edge22
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 2000
