...
define internal fastcc void @kernel_gemver(double, double, [2000 x double]*, double* readonly, double* readonly, double* readonly, double* readonly, double*, double*, double* nocapture readonly, double* nocapture readonly) unnamed_addr #2 {
  %scevgep32 = getelementptr double, double* %4, i64 2000
  %scevgep34 = getelementptr double, double* %6, i64 2000
  br label %._crit_edge21

._crit_edge21:                                    ; preds = %middle.block, %11
  ...
  %scevgep30 = getelementptr [2000 x double], [2000 x double]* %2, i64 %12, i64 0
  ...
  %bound1 = icmp ult double* %13, %scevgep30
  %found.conflict = and i1 %bound0, %bound1
  %bound037 = icmp ult double* %scevgep, %scevgep32
  %bound138 = icmp ugt double* %scevgep30, %4
  %found.conflict39 = and i1 %bound037, %bound138
  %conflict.rdx = or i1 %found.conflict, %found.conflict39
  %bound042 = icmp ult double* %scevgep, %14
  %bound143 = icmp ult double* %14, %scevgep30
  %found.conflict44 = and i1 %bound042, %bound143
  %conflict.rdx45 = or i1 %conflict.rdx, %found.conflict44
  %bound046 = icmp ult double* %scevgep, %scevgep34
  %bound147 = icmp ugt double* %scevgep30, %6
  %found.conflict48 = and i1 %bound046, %bound147
  %conflict.rdx49 = or i1 %conflict.rdx45, %found.conflict48
  br i1 %conflict.rdx49, label %._crit_edge.preheader, label %vector.body.preheader

vector.body.preheader:                            ; preds = %._crit_edge21
  br label %vector.body

._crit_edge.preheader:                            ; preds = %._crit_edge21
  br label %._crit_edge
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %strided.vec50 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  ...
  %wide.vec51 = load <4 x double>, <4 x double>* %21, align 8, !alias.scope !10
  %strided.vec52 = shufflevector <4 x double> %wide.vec51, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %strided.vec53 = shufflevector <4 x double> %wide.vec51, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %22 = fmul <2 x double> %19, %strided.vec52
  ...
  %wide.vec54 = load <4 x double>, <4 x double>* %28, align 8, !alias.scope !12
  ...
  %29 = fmul <2 x double> %26, %strided.vec55
  ...
  %36 = fmul <2 x double> %35, %strided.vec53
  %37 = fadd <2 x double> %strided.vec50, %36
  ...
  %41 = fmul <2 x double> %40, %strided.vec56
  ...
  br i1 %45, label %middle.block.loopexit72, label %vector.body, !llvm.loop !13
...
middle.block:                                     ; preds = %middle.block.loopexit72, %middle.block.loopexit
  ...
  br i1 %exitcond18, label %._crit_edge20.preheader, label %._crit_edge21

._crit_edge20.preheader:                          ; preds = %middle.block
  br label %._crit_edge20

._crit_edge20:                                    ; preds = %86, %._crit_edge20.preheader
  %indvars.iv10 = phi i64 [ 0, %._crit_edge20.preheader ], [ %indvars.iv.next11, %86 ]
  %70 = getelementptr inbounds double, double* %8, i64 %indvars.iv10
  %.pre = load double, double* %70, align 8
  br label %._crit_edge22

._crit_edge22:                                    ; preds = %._crit_edge22, %._crit_edge20
  %71 = phi double [ %.pre, %._crit_edge20 ], [ %85, %._crit_edge22 ]
  %indvars.iv7 = phi i64 [ 0, %._crit_edge20 ], [ %indvars.iv.next8.1, %._crit_edge22 ]
  ...
  store double %78, double* %sunkaddr67, align 8
  ...
  store double %85, double* %sunkaddr67, align 8
  %indvars.iv.next8.1 = add nuw nsw i64 %indvars.iv7, 2
  %exitcond9.1 = icmp eq i64 %indvars.iv.next8.1, 2000
  br i1 %exitcond9.1, label %86, label %._crit_edge22

; <label>:86:                                     ; preds = %._crit_edge22
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %exitcond12 = icmp eq i64 %indvars.iv.next11, 2000
  br i1 %exitcond12, label %._crit_edge23.preheader, label %._crit_edge20

._crit_edge23.preheader:                          ; preds = %86
  br label %._crit_edge23

._crit_edge23:                                    ; preds = %._crit_edge23, %._crit_edge23.preheader
  %indvars.iv4 = phi i64 [ 0, %._crit_edge23.preheader ], [ %indvars.iv.next5.4, %._crit_edge23 ]
  ...
  br i1 %exitcond6.4, label %._crit_edge25.preheader, label %._crit_edge23

._crit_edge25.preheader:                          ; preds = %._crit_edge23
  br label %._crit_edge25

._crit_edge25:                                    ; preds = %128, %._crit_edge25.preheader
  %indvars.iv1 = phi i64 [ 0, %._crit_edge25.preheader ], [ %indvars.iv.next2, %128 ]
  %112 = getelementptr inbounds double, double* %7, i64 %indvars.iv1
  %.pre19 = load double, double* %112, align 8
  br label %._crit_edge27

._crit_edge27:                                    ; preds = %._crit_edge27, %._crit_edge25
  %113 = phi double [ %.pre19, %._crit_edge25 ], [ %127, %._crit_edge27 ]
  %indvars.iv = phi i64 [ 0, %._crit_edge25 ], [ %indvars.iv.next.1, %._crit_edge27 ]
  ...
  %sunkaddr68 = ptrtoint double* %7 to i64
  %sunkaddr69 = mul i64 %indvars.iv1, 8
  %sunkaddr70 = add i64 %sunkaddr68, %sunkaddr69
  %sunkaddr71 = inttoptr i64 %sunkaddr70 to double*
  store double %120, double* %sunkaddr71, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %127, double* %sunkaddr71, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %128, label %._crit_edge27

; <label>:128:                                    ; preds = %._crit_edge27
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 2000
  br i1 %exitcond3, label %129, label %._crit_edge25
