...
for.body8.lr.ph:                                  ; preds = %entry, %for.end44
  %indvars.iv72 = phi i64 [ 1, %entry ], [ %indvars.iv.next73, %for.end44 ]
...
for.body21.lr.ph:                                 ; preds = %for.body21.lr.ph.loopexit, %for.body8.prol.loopexit
  ...
  %28 = and i64 %indvar, 1
  %lcmp.mod66 = icmp eq i64 %28, 0
  br i1 %lcmp.mod66, label %for.body21.prol, label %for.body21.prol.loopexit

for.body21.prol:                                  ; preds = %for.body21.lr.ph
  %29 = load double, double* %y, align 8
  %sunkaddr67 = shl nuw nsw i64 %indvars.iv60, 3
  %sunkaddr68 = add i64 %3, %sunkaddr67
  %sunkaddr69 = add i64 %sunkaddr68, -8
  %sunkaddr70 = inttoptr i64 %sunkaddr69 to double*
  %30 = load double, double* %sunkaddr70, align 8
...
for.body21.preheader:                             ; preds = %for.body21.prol.loopexit
  %32 = sub i64 %6, %indvars.iv45.unr.ph
  %33 = lshr i64 %32, 1
  %34 = add nuw i64 %33, 1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec2 = load <4 x double>, <4 x double>* %45, align 8
  ...
  %46 = fmul <2 x double> %broadcast.splat7, %reverse5
  %47 = fadd <2 x double> %strided.vec, %46
  %48 = add nuw nsw i64 %offset.idx, 1
  %49 = fmul <2 x double> %broadcast.splat7, %reverse
  %50 = fadd <2 x double> %strided.vec1, %49
...
for.body21:                                       ; preds = %for.body21.preheader9, %for.body21
  %indvars.iv45 = phi i64 [ %indvars.iv.next46.1, %for.body21 ], [ %indvars.iv45.ph, %for.body21.preheader9 ]
