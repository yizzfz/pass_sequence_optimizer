...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge.preheader
  %indvars.iv = phi i64 [ 0, %._crit_edge.preheader ], [ %5, %._crit_edge ]
  ...
  %11 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv4, i64 %indvars.iv
  ...
  %18 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv4, i64 %indvars.iv.next
...
._crit_edge.preheader:                            ; preds = %._crit_edge._crit_edge, %3
  %.026 = phi i32 [ 0, %3 ], [ %27, %._crit_edge._crit_edge ]
  br label %._crit_edge3.preheader

._crit_edge3.preheader:                           ; preds = %._crit_edge.preheader, %._crit_edge
  %indvar = phi i64 [ 0, %._crit_edge.preheader ], [ %4, %._crit_edge ]
  %indvars.iv7 = phi i64 [ 1, %._crit_edge.preheader ], [ %indvars.iv.next8, %._crit_edge ]
  %4 = add i64 %indvar, 1
  %scevgep = getelementptr [2000 x double], [2000 x double]* %2, i64 %4, i64 0
  %5 = add nsw i64 %indvars.iv7, -1
  ...
  %.phi.trans.insert11 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %5, i64 1
  %.pre12 = load double, double* %.phi.trans.insert11, align 8
  %.phi.trans.insert13 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv7, i64 1
  %.pre14 = load double, double* %.phi.trans.insert13, align 8
  %.phi.trans.insert15 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next8, i64 0
  %.pre16 = load double, double* %.phi.trans.insert15, align 8
  %.phi.trans.insert17 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next8, i64 1
  %.pre18 = load double, double* %.phi.trans.insert17, align 8
  br label %._crit_edge3

._crit_edge3:                                     ; preds = %._crit_edge3.preheader, %._crit_edge3
  %6 = phi double [ %.pre18, %._crit_edge3.preheader ], [ %24, %._crit_edge3 ]
  %7 = phi double [ %.pre16, %._crit_edge3.preheader ], [ %6, %._crit_edge3 ]
  %8 = phi double [ %.pre14, %._crit_edge3.preheader ], [ %19, %._crit_edge3 ]
  %9 = phi double [ %.pre12, %._crit_edge3.preheader ], [ %13, %._crit_edge3 ]
  ...
  %16 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv7, i64 %indvars.iv
  %17 = fadd double %15, %8
  %18 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv7, i64 %indvars.iv.next
  %19 = load double, double* %18, align 8
  %20 = fadd double %17, %19
  %21 = fadd double %20, %7
  %22 = fadd double %21, %6
  %23 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next8, i64 %indvars.iv.next
...
._crit_edge:                                      ; preds = %._crit_edge3
  ...
  br i1 %exitcond9, label %._crit_edge._crit_edge, label %._crit_edge3.preheader

._crit_edge._crit_edge:                           ; preds = %._crit_edge
  %27 = add nuw nsw i32 %.026, 1
  %exitcond10 = icmp eq i32 %27, 500
  br i1 %exitcond10, label %28, label %._crit_edge.preheader

; <label>:28:                                     ; preds = %._crit_edge._crit_edge
  ret void
}
