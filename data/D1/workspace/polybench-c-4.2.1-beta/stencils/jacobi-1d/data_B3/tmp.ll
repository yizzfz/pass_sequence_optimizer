...
define i32 @main(i32, i8** nocapture readonly) #0 {
  ...
  tail call void @kernel_jacobi_1d(i32 500, i32 2000, double* %5, double* %6)
...
; <label>:11:                                     ; preds = %8
  tail call void @print_array(i32 2000, double* %5)
  br label %._crit_edge
...
define internal void @init_array(i32, double* nocapture, double* nocapture) #2 {
  %4 = icmp sgt i32 %0, 0
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal void @kernel_jacobi_1d(i32, i32, double* nocapture, double* nocapture) #2 {
  %5 = icmp sgt i32 %0, 0
