...
entry:
  br label %for.body25.prol.loopexit.unr-lcssa.for.body25_crit_edge

for.body25.prol.loopexit.unr-lcssa.for.body25_crit_edge: ; preds = %for.inc34, %entry
...
for.body25:                                       ; preds = %for.body25, %for.body25.prol.loopexit.unr-lcssa.for.body25_crit_edge
  %indvars.iv = phi i64 [ 0, %for.body25.prol.loopexit.unr-lcssa.for.body25_crit_edge ], [ %indvars.iv.next.1, %for.body25 ]
  %8 = mul nuw nsw i64 %indvars.iv7, %indvars.iv
  ...
  %10 = mul nuw nsw i64 %indvars.iv7, %indvars.iv.next
...
for.inc34:                                        ; preds = %for.body25
  ...
  br i1 %13, label %for.end36, label %for.body25.prol.loopexit.unr-lcssa.for.body25_crit_edge
...
entry:
  %sunkaddr33 = ptrtoint double* %x1 to i64
  br label %for.body3.prol.loopexit.unr-lcssa.for.body3_crit_edge

for.body3.prol.loopexit.unr-lcssa.for.body3_crit_edge: ; preds = %for.inc12, %entry
  %indvars.iv25 = phi i64 [ 0, %entry ], [ %indvars.iv.next26, %for.inc12 ]
  %arrayidx = getelementptr inbounds double, double* %x1, i64 %indvars.iv25
  %.pre = load double, double* %arrayidx, align 8
  %sunkaddr34 = shl i64 %indvars.iv25, 3
  %sunkaddr35 = add i64 %sunkaddr33, %sunkaddr34
  %sunkaddr36 = inttoptr i64 %sunkaddr35 to double*
  br label %for.body3

for.body3:                                        ; preds = %for.body3, %for.body3.prol.loopexit.unr-lcssa.for.body3_crit_edge
  %indvars.iv18 = phi i64 [ 0, %for.body3.prol.loopexit.unr-lcssa.for.body3_crit_edge ], [ %indvars.iv.next19.1, %for.body3 ]
  %0 = phi double [ %.pre, %for.body3.prol.loopexit.unr-lcssa.for.body3_crit_edge ], [ %add.1, %for.body3 ]
  ...
  store double %add, double* %sunkaddr36, align 8
  ...
  store double %add.1, double* %sunkaddr36, align 8
...
for.inc12:                                        ; preds = %for.body3
  ...
  %exitcond28 = icmp eq i64 %indvars.iv.next26, 2000
  br i1 %exitcond28, label %for.inc12.for.body20.prol.loopexit.unr-lcssa.for.body20_crit_edge_crit_edge, label %for.body3.prol.loopexit.unr-lcssa.for.body3_crit_edge

for.inc12.for.body20.prol.loopexit.unr-lcssa.for.body20_crit_edge_crit_edge: ; preds = %for.inc12
  %sunkaddr41 = ptrtoint double* %x2 to i64
  br label %for.body20.prol.loopexit.unr-lcssa.for.body20_crit_edge

for.body20.prol.loopexit.unr-lcssa.for.body20_crit_edge: ; preds = %for.inc36, %for.inc12.for.body20.prol.loopexit.unr-lcssa.for.body20_crit_edge_crit_edge
  %indvars.iv15 = phi i64 [ 0, %for.inc12.for.body20.prol.loopexit.unr-lcssa.for.body20_crit_edge_crit_edge ], [ %indvars.iv.next16, %for.inc36 ]
  %arrayidx22 = getelementptr inbounds double, double* %x2, i64 %indvars.iv15
  %.pre14 = load double, double* %arrayidx22, align 8
  %sunkaddr42 = shl i64 %indvars.iv15, 3
  %sunkaddr43 = add i64 %sunkaddr41, %sunkaddr42
  %sunkaddr44 = inttoptr i64 %sunkaddr43 to double*
  br label %for.body20

for.body20:                                       ; preds = %for.body20, %for.body20.prol.loopexit.unr-lcssa.for.body20_crit_edge
  %indvars.iv = phi i64 [ 0, %for.body20.prol.loopexit.unr-lcssa.for.body20_crit_edge ], [ %indvars.iv.next.1, %for.body20 ]
  %5 = phi double [ %.pre14, %for.body20.prol.loopexit.unr-lcssa.for.body20_crit_edge ], [ %add30.1, %for.body20 ]
  ...
  store double %add30, double* %sunkaddr44, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %add30.1, double* %sunkaddr44, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
...
for.inc36:                                        ; preds = %for.body20
  ...
  br i1 %exitcond, label %for.end38, label %for.body20.prol.loopexit.unr-lcssa.for.body20_crit_edge
