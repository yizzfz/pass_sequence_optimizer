...
for.body:                                         ; preds = %for.body.for.body_crit_edge, %for.body.lr.ph
  %indvars.iv17 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next18.2, %for.body.for.body_crit_edge ]
  ...
  br i1 %exitcond20.2, label %for.body6.us.preheader, label %for.body.for.body_crit_edge
...
for.body6.us:                                     ; preds = %for.cond7.for.inc22_crit_edge.us.for.body6.us_crit_edge, %for.body6.us.preheader
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.cond7.for.inc22_crit_edge.us.for.body6.us_crit_edge ], [ 0, %for.body6.us.preheader ]
  br label %for.body10.us

for.body10.us:                                    ; preds = %for.body10.us.for.body10.us_crit_edge, %for.body6.us
  %indvars.iv = phi i64 [ 0, %for.body6.us ], [ %indvars.iv.next.1, %for.body10.us.for.body10.us_crit_edge ]
  %4 = add nuw nsw i64 %indvars.iv, %indvars.iv15
  ...
  %6 = add nuw nsw i64 %indvars.iv.next, %indvars.iv15
  ...
  br i1 %exitcond.1, label %for.cond7.for.inc22_crit_edge.us, label %for.body10.us.for.body10.us_crit_edge
...
for.cond7.for.inc22_crit_edge.us:                 ; preds = %for.body10.us
  ...
  br i1 %exitcond, label %for.end24, label %for.cond7.for.inc22_crit_edge.us.for.body6.us_crit_edge

for.cond7.for.inc22_crit_edge.us.for.body6.us_crit_edge: ; preds = %for.cond7.for.inc22_crit_edge.us
  br label %for.body6.us
...
for.body:                                         ; preds = %for.body.for.body_crit_edge, %for.body.lr.ph
  %indvars.iv77 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next78.24, %for.body.for.body_crit_edge ]
  %indvars.iv.next78.24 = add nsw i64 %indvars.iv77, 25
  %exitcond86.24 = icmp eq i64 %indvars.iv.next78.24, 2100
  br i1 %exitcond86.24, label %for.body5.us.preheader, label %for.body.for.body_crit_edge

for.body.for.body_crit_edge:                      ; preds = %for.body
  br label %for.body

for.body5.us.preheader:                           ; preds = %for.body
  %sunkaddr94 = ptrtoint double* %tmp to i64
  %sunkaddr = ptrtoint double* %tmp to i64
  br label %for.body5.us

for.body5.us:                                     ; preds = %for.inc42.us.for.body5.us_crit_edge, %for.body5.us.preheader
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc42.us.for.body5.us_crit_edge ], [ 0, %for.body5.us.preheader ]
  ...
  %sunkaddr95 = shl i64 %indvars.iv66, 3
...
for.inc42.us:                                     ; preds = %for.body26.us.for.body26.us_crit_edge
  ...
  %exitcond85 = icmp eq i64 %indvars.iv.next67, 1900
  br i1 %exitcond85, label %for.end44, label %for.inc42.us.for.body5.us_crit_edge

for.inc42.us.for.body5.us_crit_edge:              ; preds = %for.inc42.us
  br label %for.body5.us

for.body26.us.for.body26.us_crit_edge:            ; preds = %for.body26.us.for.body26.us_crit_edge.for.body26.us.for.body26.us_crit_edge_crit_edge, %for.body26.us.preheader
  %indvars.iv.next6590 = phi i64 [ 1, %for.body26.us.preheader ], [ %indvars.iv.next65, %for.body26.us.for.body26.us_crit_edge.for.body26.us.for.body26.us_crit_edge_crit_edge ]
  %.pre = load double, double* %sunkaddr100, align 8
  %arrayidx28.us = getelementptr inbounds double, double* %y, i64 %indvars.iv.next6590
  %0 = load double, double* %arrayidx28.us, align 8
  %arrayidx32.us = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv66, i64 %indvars.iv.next6590
  ...
  %exitcond84 = icmp eq i64 %indvars.iv.next6590, 2099
  br i1 %exitcond84, label %for.inc42.us, label %for.body26.us.for.body26.us_crit_edge.for.body26.us.for.body26.us_crit_edge_crit_edge

for.body26.us.for.body26.us_crit_edge.for.body26.us.for.body26.us_crit_edge_crit_edge: ; preds = %for.body26.us.for.body26.us_crit_edge
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv.next6590, 1
  br label %for.body26.us.for.body26.us_crit_edge

for.body10.us:                                    ; preds = %for.body10.us.for.body10.us_crit_edge, %for.body5.us
  %2 = phi double [ 0.000000e+00, %for.body5.us ], [ %add.us.1, %for.body10.us.for.body10.us_crit_edge ]
  %indvars.iv = phi i64 [ 0, %for.body5.us ], [ %indvars.iv.next.1, %for.body10.us.for.body10.us_crit_edge ]
  ...
  store double %add.us, double* %sunkaddr97, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %add.us.1, double* %sunkaddr97, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2100
  br i1 %exitcond.1, label %for.body26.us.preheader, label %for.body10.us.for.body10.us_crit_edge
...
for.body26.us.preheader:                          ; preds = %for.body10.us
  ...
  %arrayidx32.us87 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv66, i64 0
  %8 = load double, double* %arrayidx32.us87, align 8
  %mul35.us88 = fmul double %8, %add.us.1
  %add36.us89 = fadd double %7, %mul35.us88
