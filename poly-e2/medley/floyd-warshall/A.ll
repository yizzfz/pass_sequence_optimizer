...
entry:
  ...
  %0 = bitcast i8* %call to [2800 x [2800 x i32]]*
  store [2800 x [2800 x i32]]* %0, [2800 x [2800 x i32]]** %path, align 8
  %1 = load i32, i32* %n, align 4
  %2 = load [2800 x [2800 x i32]]*, [2800 x [2800 x i32]]** %path, align 8
  %arraydecay = getelementptr inbounds [2800 x [2800 x i32]], [2800 x [2800 x i32]]* %2, i32 0, i32 0
  call void @init_array(i32 %1, [2800 x i32]* %arraydecay)
  call void (...) @polybench_timer_start()
  %3 = load i32, i32* %n, align 4
  %4 = load [2800 x [2800 x i32]]*, [2800 x [2800 x i32]]** %path, align 8
  %arraydecay1 = getelementptr inbounds [2800 x [2800 x i32]], [2800 x [2800 x i32]]* %4, i32 0, i32 0
  call void @kernel_floyd_warshall(i32 %3, [2800 x i32]* %arraydecay1)
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %9 = load [2800 x [2800 x i32]]*, [2800 x [2800 x i32]]** %path, align 8
  %arraydecay3 = getelementptr inbounds [2800 x [2800 x i32]], [2800 x [2800 x i32]]* %9, i32 0, i32 0
  call void @print_array(i32 %8, [2800 x i32]* %arraydecay3)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  %10 = load [2800 x [2800 x i32]]*, [2800 x [2800 x i32]]** %path, align 8
  %11 = bitcast [2800 x [2800 x i32]]* %10 to i8*
...
entry:
  ...
  store [2800 x i32]* %path, [2800 x i32]** %path.addr, align 8
...
for.body3:                                        ; preds = %for.cond1
  ...
  %6 = load [2800 x i32]*, [2800 x i32]** %path.addr, align 8
  %7 = load i32, i32* %i, align 4
  %idxprom = sext i32 %7 to i64
  %arrayidx = getelementptr inbounds [2800 x i32], [2800 x i32]* %6, i64 %idxprom
...
if.then:                                          ; preds = %lor.lhs.false12, %lor.lhs.false, %for.body3
  %15 = load [2800 x i32]*, [2800 x i32]** %path.addr, align 8
  %16 = load i32, i32* %i, align 4
  %idxprom16 = sext i32 %16 to i64
  %arrayidx17 = getelementptr inbounds [2800 x i32], [2800 x i32]* %15, i64 %idxprom16
...
for.body6:                                        ; preds = %for.cond4
  ...
  %10 = load [2800 x i32]*, [2800 x i32]** %path.addr, align 8
  %11 = load i32, i32* %i, align 4
  %idxprom9 = sext i32 %11 to i64
  %arrayidx10 = getelementptr inbounds [2800 x i32], [2800 x i32]* %10, i64 %idxprom9
  ...
  %14 = load [2800 x i32]*, [2800 x i32]** %path.addr, align 8
  %15 = load i32, i32* %k, align 4
  %idxprom13 = sext i32 %15 to i64
  %arrayidx14 = getelementptr inbounds [2800 x i32], [2800 x i32]* %14, i64 %idxprom13
...
cond.true:                                        ; preds = %for.body6
  %18 = load [2800 x i32]*, [2800 x i32]** %path.addr, align 8
  %19 = load i32, i32* %i, align 4
  %idxprom18 = sext i32 %19 to i64
  %arrayidx19 = getelementptr inbounds [2800 x i32], [2800 x i32]* %18, i64 %idxprom18
...
cond.false:                                       ; preds = %for.body6
  %22 = load [2800 x i32]*, [2800 x i32]** %path.addr, align 8
  %23 = load i32, i32* %i, align 4
  %idxprom22 = sext i32 %23 to i64
  %arrayidx23 = getelementptr inbounds [2800 x i32], [2800 x i32]* %22, i64 %idxprom22
  ...
  %26 = load [2800 x i32]*, [2800 x i32]** %path.addr, align 8
  %27 = load i32, i32* %k, align 4
  %idxprom26 = sext i32 %27 to i64
  %arrayidx27 = getelementptr inbounds [2800 x i32], [2800 x i32]* %26, i64 %idxprom26
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %30 = load [2800 x i32]*, [2800 x i32]** %path.addr, align 8
  %31 = load i32, i32* %i, align 4
  %idxprom31 = sext i32 %31 to i64
  %arrayidx32 = getelementptr inbounds [2800 x i32], [2800 x i32]* %30, i64 %idxprom31
...
entry:
  ...
  %call1 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %for.cond
...
if.end:                                           ; preds = %if.then, %for.body4
  ...
  %11 = load [2800 x i32]*, [2800 x i32]** %path.addr, align 8
  %12 = load i32, i32* %i, align 4
  %idxprom = sext i32 %12 to i64
  %arrayidx = getelementptr inbounds [2800 x i32], [2800 x i32]* %11, i64 %idxprom
  %13 = load i32, i32* %j, align 4
  %idxprom7 = sext i32 %13 to i64
  %arrayidx8 = getelementptr inbounds [2800 x i32], [2800 x i32]* %arrayidx, i64 0, i64 %idxprom7
  %14 = load i32, i32* %arrayidx8, align 4
  %call9 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %10, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i32 0, i32 0), i32 %14)
  br label %for.inc
...
for.end12:                                        ; preds = %for.cond
  ...
  %call13 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %17, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0))
