...
vector.memcheck65:                                ; preds = %._crit_edge.us.preheader, %._crit_edge7.us
...
vector.body50:                                    ; preds = %vector.body50.preheader, %vector.body50
  ...
  %wide.load81 = load <2 x double>, <2 x double>* %18, align 8, !alias.scope !1
  %19 = fadd <2 x double> %12, %wide.load80
  ...
  %23 = getelementptr inbounds double, double* %1, i64 %offset.idx71
  ...
  %27 = icmp eq i64 %index.next68, 1996
  br i1 %27, label %scalar.ph52.preheader.loopexit, label %vector.body50, !llvm.loop !6

._crit_edge7.us:                                  ; preds = %.lr.ph6.us
  %28 = add nsw i32 %2, 1
  %29 = icmp slt i32 %28, 500
  br i1 %29, label %vector.memcheck65, label %81
...
scalar.ph52:                                      ; preds = %scalar.ph52.preheader, %scalar.ph52
  %indvars.iv = phi i64 [ %49, %scalar.ph52 ], [ %indvars.iv.ph, %scalar.ph52.preheader ]
  ...
  br i1 %55, label %scalar.ph52, label %vector.memcheck, !llvm.loop !10
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load45 = load <2 x double>, <2 x double>* %60, align 8, !alias.scope !11
  %61 = getelementptr inbounds double, double* %1, i64 %offset.idx
  %62 = bitcast double* %61 to <2 x double>*
  %wide.load46 = load <2 x double>, <2 x double>* %62, align 8, !alias.scope !11
  %63 = getelementptr double, double* %61, i64 2
  %64 = bitcast double* %63 to <2 x double>*
  %wide.load47 = load <2 x double>, <2 x double>* %64, align 8, !alias.scope !11
  %65 = fadd <2 x double> %wide.load, %wide.load46
  %66 = fadd <2 x double> %wide.load45, %wide.load47
  %67 = add nuw nsw i64 %offset.idx, 1
  %68 = getelementptr inbounds double, double* %1, i64 %67
  %69 = bitcast double* %68 to <2 x double>*
  %wide.load48 = load <2 x double>, <2 x double>* %69, align 8, !alias.scope !11
  %70 = getelementptr double, double* %68, i64 2
  %71 = bitcast double* %70 to <2 x double>*
  %wide.load49 = load <2 x double>, <2 x double>* %71, align 8, !alias.scope !11
  %72 = fadd <2 x double> %65, %wide.load48
