...
.lr.ph:                                           ; preds = %.lr.ph.backedge, %.lr.ph20
  %indvars.iv26 = phi i64 [ 0, %.lr.ph20 ], [ %indvars.iv26.be, %.lr.ph.backedge ]
  %indvars.iv24 = phi i64 [ 1, %.lr.ph20 ], [ %indvars.iv24.be, %.lr.ph.backedge ]
...
.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph
  ...
  br i1 %15, label %.lr.ph.backedge, label %.lr.ph.new.preheader
...
._crit_edge:                                      ; preds = %.lr.ph.new
  ...
  br i1 %exitcond29, label %._crit_edge21, label %.lr.ph.backedge

.lr.ph.backedge:                                  ; preds = %.prol.loopexit, %._crit_edge
  %indvars.iv26.be = phi i64 [ %indvars.iv.next27, %._crit_edge ], [ 1, %.prol.loopexit ]
  %indvars.iv24.be = add nuw nsw i64 %indvars.iv24, 1
  br label %.lr.ph
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %4
  %.lcssa = phi double [ %6, %4 ], [ %.lcssa37.unr.ph, %.prol.loopexit ], [ %27, %._crit_edge.loopexit ]
  ...
  store double %30, double* %sunkaddr30, align 8
