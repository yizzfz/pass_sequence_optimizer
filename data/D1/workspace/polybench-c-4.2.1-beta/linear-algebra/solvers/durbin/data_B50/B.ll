...
define internal fastcc void @kernel_durbin(i32, double*, double*) unnamed_addr #0 {
  ...
  %9 = icmp sgt i32 %0, 1
  br i1 %9, label %.lr.ph17.preheader, label %.._crit_edge18_crit_edge
...
.lr.ph:                                           ; preds = %._crit_edge12..lr.ph_crit_edge, %.lr.ph17.preheader
  ...
  %indvar = phi i64 [ 0, %.lr.ph17.preheader ], [ %54, %._crit_edge12..lr.ph_crit_edge ]
  %.0314 = phi double [ %11, %.lr.ph17.preheader ], [ %61, %._crit_edge12..lr.ph_crit_edge ]
  %.0413 = phi double [ 1.000000e+00, %.lr.ph17.preheader ], [ %56, %._crit_edge12..lr.ph_crit_edge ]
  %13 = add i64 %indvar, 1
  %14 = shl i64 %indvar, 3
  ...
  %lcmp.mod = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod, label %.lr.ph.._crit_edge37.prol.loopexit_crit_edge, label %._crit_edge37.prol.preheader

.lr.ph.._crit_edge37.prol.loopexit_crit_edge:     ; preds = %.lr.ph
  br label %._crit_edge37.prol.loopexit

._crit_edge37.prol.preheader:                     ; preds = %.lr.ph
  br label %._crit_edge37.prol

._crit_edge37.prol:                               ; preds = %._crit_edge37.prol.._crit_edge37.prol_crit_edge, %._crit_edge37.prol.preheader
  %indvars.iv.prol = phi i64 [ 0, %._crit_edge37.prol.preheader ], [ %indvars.iv.next.prol, %._crit_edge37.prol.._crit_edge37.prol_crit_edge ]
  %.025.prol = phi double [ 0.000000e+00, %._crit_edge37.prol.preheader ], [ %24, %._crit_edge37.prol.._crit_edge37.prol_crit_edge ]
  %prol.iter = phi i64 [ %xtraiter, %._crit_edge37.prol.preheader ], [ %prol.iter.sub, %._crit_edge37.prol.._crit_edge37.prol_crit_edge ]
  ...
  %prol.iter.sub = add i64 %prol.iter, -1
  %prol.iter.cmp = icmp eq i64 %prol.iter.sub, 0
  br i1 %prol.iter.cmp, label %._crit_edge37.prol.loopexit.unr-lcssa, label %._crit_edge37.prol.._crit_edge37.prol_crit_edge, !llvm.loop !3

._crit_edge37.prol.._crit_edge37.prol_crit_edge:  ; preds = %._crit_edge37.prol
  br label %._crit_edge37.prol

._crit_edge37.prol.loopexit.unr-lcssa:            ; preds = %._crit_edge37.prol
  br label %._crit_edge37.prol.loopexit

._crit_edge37.prol.loopexit:                      ; preds = %.lr.ph.._crit_edge37.prol.loopexit_crit_edge, %._crit_edge37.prol.loopexit.unr-lcssa
  %.lcssa.unr = phi double [ undef, %.lr.ph.._crit_edge37.prol.loopexit_crit_edge ], [ %24, %._crit_edge37.prol.loopexit.unr-lcssa ]
  %indvars.iv.unr = phi i64 [ 0, %.lr.ph.._crit_edge37.prol.loopexit_crit_edge ], [ %indvars.iv.next.prol, %._crit_edge37.prol.loopexit.unr-lcssa ]
  %.025.unr = phi double [ 0.000000e+00, %.lr.ph.._crit_edge37.prol.loopexit_crit_edge ], [ %24, %._crit_edge37.prol.loopexit.unr-lcssa ]
  %25 = icmp ult i64 %indvar, 3
  br i1 %25, label %._crit_edge37.prol.loopexit..lr.ph9_crit_edge, label %.lr.ph.new

._crit_edge37.prol.loopexit..lr.ph9_crit_edge:    ; preds = %._crit_edge37.prol.loopexit
  br label %.lr.ph9

.lr.ph.new:                                       ; preds = %._crit_edge37.prol.loopexit
  br label %._crit_edge37

._crit_edge37:                                    ; preds = %._crit_edge37.._crit_edge37_crit_edge, %.lr.ph.new
  %indvars.iv = phi i64 [ %indvars.iv.unr, %.lr.ph.new ], [ %indvars.iv.next.3, %._crit_edge37.._crit_edge37_crit_edge ]
  %.025 = phi double [ %.025.unr, %.lr.ph.new ], [ %53, %._crit_edge37.._crit_edge37_crit_edge ]
  ...
  br i1 %exitcond.3, label %.lr.ph9.unr-lcssa, label %._crit_edge37.._crit_edge37_crit_edge
...
.lr.ph9:                                          ; preds = %._crit_edge37.prol.loopexit..lr.ph9_crit_edge, %.lr.ph9.unr-lcssa
  %.lcssa = phi double [ %.lcssa.unr, %._crit_edge37.prol.loopexit..lr.ph9_crit_edge ], [ %53, %.lr.ph9.unr-lcssa ]
  ...
  br i1 %min.iters.check, label %.lr.ph9.._crit_edge38.preheader_crit_edge, label %min.iters.checked

.lr.ph9.._crit_edge38.preheader_crit_edge:        ; preds = %.lr.ph9
  br label %._crit_edge38.preheader

min.iters.checked:                                ; preds = %.lr.ph9
  %n.vec = and i64 %54, -4
  %cmp.zero = icmp eq i64 %n.vec, 0
  br i1 %cmp.zero, label %min.iters.checked.._crit_edge38.preheader_crit_edge, label %vector.ph

min.iters.checked.._crit_edge38.preheader_crit_edge: ; preds = %min.iters.checked
  br label %._crit_edge38.preheader
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %middle.block.._crit_edge12_crit_edge, label %middle.block.._crit_edge38.preheader_crit_edge

middle.block.._crit_edge38.preheader_crit_edge:   ; preds = %middle.block
  br label %._crit_edge38.preheader

middle.block.._crit_edge12_crit_edge:             ; preds = %middle.block
  br label %._crit_edge12

._crit_edge38.preheader:                          ; preds = %middle.block.._crit_edge38.preheader_crit_edge, %min.iters.checked.._crit_edge38.preheader_crit_edge, %.lr.ph9.._crit_edge38.preheader_crit_edge
  %indvars.iv21.ph = phi i64 [ 0, %min.iters.checked.._crit_edge38.preheader_crit_edge ], [ 0, %.lr.ph9.._crit_edge38.preheader_crit_edge ], [ %n.vec, %middle.block.._crit_edge38.preheader_crit_edge ]
  br label %._crit_edge38

._crit_edge38:                                    ; preds = %._crit_edge38.._crit_edge38_crit_edge, %._crit_edge38.preheader
  ...
  br i1 %exitcond26, label %._crit_edge12.loopexit, label %._crit_edge38.._crit_edge38_crit_edge, !llvm.loop !7
...
._crit_edge12:                                    ; preds = %middle.block.._crit_edge12_crit_edge, %._crit_edge12.loopexit
  ...
  br i1 %exitcond36, label %._crit_edge18.loopexit, label %._crit_edge12..lr.ph_crit_edge
