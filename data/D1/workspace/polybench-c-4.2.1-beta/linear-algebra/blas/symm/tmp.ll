...
.preheader5:                                      ; preds = %.loopexit..preheader5_crit_edge, %.preheader5.preheader
...
.preheader.loopexit:                              ; preds = %.preheader.loopexit.unr-lcssa, %.lr.ph.prol.loopexit
  br label %.preheader
...
.lr.ph12:                                         ; preds = %.lr.ph12, %.lr.ph12.preheader56
...
.preheader6._crit_edge:                           ; preds = %.loopexit, %.preheader
  ret void
}
...
.lr.ph4.split.us:                                 ; preds = %.loopexit.us, %.lr.ph4.split.us.preheader
