...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge2
  %indvars.iv = phi i64 [ 0, %._crit_edge2 ], [ %indvars.iv.next.1.1, %._crit_edge ]
...
; <label>:27:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond6, label %28, label %._crit_edge2
...
._crit_edge25.us:                                 ; preds = %._crit_edge
  %22 = fdiv double %21, %0
  store double %22, double* %sunkaddr107, align 8
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  br i1 %39, label %._crit_edge17.us.loopexit27, label %vector.body, !llvm.loop !6
...
._crit_edge17.us.loopexit27:                      ; preds = %vector.body
  br label %._crit_edge17.us

._crit_edge17.us:                                 ; preds = %._crit_edge17.us.loopexit27, %._crit_edge17.us.loopexit
...
._crit_edge21:                                    ; preds = %._crit_edge21, %.lr.ph.us.us
  ...
  br i1 %exitcond82.1, label %._crit_edge.us.us, label %._crit_edge21
