...
for.inc.us:                                       ; preds = %for.inc.us, %for.body.us
  %indvars.iv31 = phi i64 [ 0, %for.body.us ], [ %indvars.iv.next32, %for.inc.us ]
  %1 = add nsw i64 %indvars.iv36, %indvars.iv31
...
for.body22:                                       ; preds = %for.body22.preheader, %for.inc51
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc51 ], [ 0, %for.body22.preheader ]
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc51 ], [ 1, %for.body22.preheader ]
  %indvar = phi i32 [ %7, %for.inc51 ], [ 0, %for.body22.preheader ]
  %indvars.iv19 = phi i32 [ %indvars.iv.next20, %for.inc51 ], [ 1, %for.body22.preheader ]
  %5 = sub i32 1007, %indvar
  %6 = sub i32 998, %indvar
  %7 = add i32 %indvar, 1
  %cmp241 = icmp sgt i64 %indvars.iv29, -1
  br i1 %cmp241, label %for.inc36.lr.ph, label %for.end38
...
for.inc36:                                        ; preds = %for.inc36.preheader, %for.inc36
  ...
  %10 = add nsw i64 %indvars.iv29, %indvars.iv
  ...
  %12 = add nsw i64 %indvars.iv29, %indvars.iv.next
...
for.end38:                                        ; preds = %for.end38.loopexit, %for.inc36.prol.loopexit.unr-lcssa, %for.body22
  ...
  br i1 %cmp413, label %for.inc48.lr.ph, label %for.end53

for.inc48.lr.ph:                                  ; preds = %for.end38
  %xtraiter25 = and i32 %5, 7
...
for.inc48.prol:                                   ; preds = %for.inc48.prol.preheader, %for.inc48.prol
  %indvars.iv23.prol = phi i64 [ %indvars.iv.next24.prol, %for.inc48.prol ], [ %indvars.iv21, %for.inc48.prol.preheader ]
  %prol.iter = phi i32 [ %prol.iter.sub, %for.inc48.prol ], [ %xtraiter25, %for.inc48.prol.preheader ]
  ...
  %indvars.iv.next24.prol = add nsw i64 %indvars.iv23.prol, 1
...
for.inc48.prol.loopexit:                          ; preds = %for.inc48.prol.loopexit.loopexit, %for.inc48.lr.ph
  %indvars.iv23.unr = phi i64 [ %indvars.iv21, %for.inc48.lr.ph ], [ %indvars.iv.next24.prol, %for.inc48.prol.loopexit.loopexit ]
  %15 = icmp ult i32 %6, 7
...
for.inc48:                                        ; preds = %for.inc48.preheader, %for.inc48
  %indvars.iv23 = phi i64 [ %indvars.iv.next24.7, %for.inc48 ], [ %indvars.iv23.unr, %for.inc48.preheader ]
...
for.inc51:                                        ; preds = %for.inc51.loopexit, %for.inc48.prol.loopexit
  %16 = icmp slt i64 %indvars.iv.next30, 1000
