...
.preheader152:                                    ; preds = %170, %6
  %.0159 = phi i32 [ 1, %6 ], [ %172, %170 ]
  br label %.lver.check
...
.lver.check203:                                   ; preds = %.lver.check203.preheader, %169
  %indvar189 = phi i64 [ %indvar.next190, %169 ], [ 0, %.lver.check203.preheader ]
  %indvars.iv174 = phi i64 [ %indvars.iv.next175, %169 ], [ 1, %.lver.check203.preheader ]
  ...
  %90 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv174
  %91 = getelementptr inbounds [1000 x double], [1000 x double]* %90, i64 0, i64 0
  store double 1.000000e+00, double* %91, align 8
  %92 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv174, i64 0
  store double 0.000000e+00, double* %92, align 8
  %93 = bitcast [1000 x double]* %90 to i64*
  %94 = load i64, i64* %93, align 8
  %95 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv174
  %96 = bitcast [1000 x double]* %95 to i64*
  store i64 %94, i64* %96, align 8
  %97 = add nsw i64 %indvars.iv174, -1
...
.ph204.lver.orig:                                 ; preds = %.ph204.lver.orig.preheader, %.ph204.lver.orig
  ...
  %98 = add nsw i64 %indvars.iv169.lver.orig, -1
  %99 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv174, i64 %98
  %100 = load double, double* %99, align 8
  %101 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv174, i64 %indvars.iv169.lver.orig
  %102 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %97, i64 %indvars.iv169.lver.orig
  %103 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv174, i64 %indvars.iv169.lver.orig
  %104 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv.next175, i64 %indvars.iv169.lver.orig
  %105 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv174, i64 %98
  %106 = insertelement <2 x double> undef, double %100, i32 0
  %107 = shufflevector <2 x double> %106, <2 x double> undef, <2 x i32> zeroinitializer
  %108 = fmul <2 x double> %107, <double 0xC08F400000000001, double 0xC08F400000000001>
  %109 = fadd <2 x double> %108, <double 0x409F440000000001, double 0x409F440000000001>
  %110 = extractelement <2 x double> %109, i32 0
  %111 = extractelement <2 x double> %109, i32 1
  %112 = fdiv double 0x408F400000000001, %110
  store double %112, double* %101, align 8
  %113 = load double, double* %102, align 8
  ...
  %124 = fdiv double %123, %111
  %125 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv174, i64 %indvars.iv169.lver.orig
...
; <label>:126:                                    ; preds = %126, %.ph204
  %store_forwarded210 = phi double [ %load_initial209, %.ph204 ], [ %148, %126 ]
  %store_forwarded207 = phi double [ %load_initial206, %.ph204 ], [ %137, %126 ]
  %indvars.iv169 = phi i64 [ 1, %.ph204 ], [ %indvars.iv.next170, %126 ]
  %127 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv174, i64 %indvars.iv169
  %128 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %97, i64 %indvars.iv169
  %129 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv174, i64 %indvars.iv169
  %130 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv.next175, i64 %indvars.iv169
  %131 = insertelement <2 x double> undef, double %store_forwarded207, i32 0
  ...
  %146 = fmul double %store_forwarded210, 0xC08F400000000001
  %147 = fsub double %145, %146
  %148 = fdiv double %147, %136
  %149 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv174, i64 %indvars.iv169
  store double %148, double* %149, align 8
  %exitcond171 = icmp eq i64 %indvars.iv169, 998
  %indvars.iv.next170 = add nuw nsw i64 %indvars.iv169, 1
  br i1 %exitcond171, label %.loopexit211, label %126

.loopexit:                                        ; preds = %.ph204.lver.orig
  br label %150

.loopexit211:                                     ; preds = %126
  br label %150

; <label>:150:                                    ; preds = %.loopexit211, %.loopexit
  %151 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv174, i64 999
  store double 1.000000e+00, double* %151, align 8
  br label %152

; <label>:152:                                    ; preds = %152, %150
  %indvars.iv172 = phi i64 [ 998, %150 ], [ %indvars.iv.next173.1, %152 ]
  %153 = phi double [ 1.000000e+00, %150 ], [ %166, %152 ]
  %154 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv174, i64 %indvars.iv172
  %155 = load double, double* %154, align 8
  %156 = fmul double %155, %153
  %157 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv174, i64 %indvars.iv172
  %158 = load double, double* %157, align 8
  %159 = fadd double %156, %158
  %160 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv174, i64 %indvars.iv172
  store double %159, double* %160, align 8
  %indvars.iv.next173 = add nsw i64 %indvars.iv172, -1
  %161 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv174, i64 %indvars.iv.next173
  %162 = load double, double* %161, align 8
  %163 = fmul double %162, %159
  %164 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv174, i64 %indvars.iv.next173
  %165 = load double, double* %164, align 8
  %166 = fadd double %163, %165
  %167 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv174, i64 %indvars.iv.next173
  store double %166, double* %167, align 8
  %168 = icmp sgt i64 %indvars.iv.next173, 1
  %indvars.iv.next173.1 = add nsw i64 %indvars.iv172, -2
  br i1 %168, label %152, label %169

; <label>:169:                                    ; preds = %152
  %exitcond177 = icmp eq i64 %indvars.iv.next175, 999
  %indvar.next190 = add i64 %indvar189, 1
  br i1 %exitcond177, label %170, label %.lver.check203

; <label>:170:                                    ; preds = %169
  %171 = icmp sgt i32 %.0159, 499
  %172 = add nuw nsw i32 %.0159, 1
  br i1 %171, label %173, label %.preheader152
