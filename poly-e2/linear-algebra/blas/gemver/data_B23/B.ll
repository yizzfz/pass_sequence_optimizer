...
for.inc42.us:                                     ; preds = %for.cond26.preheader.us, %for.inc42.us
  ...
  %indvars.iv24 = phi i64 [ %indvars.iv.next25.1, %for.inc42.us ], [ 0, %for.cond26.preheader.us ]
...
for.inc80.us:                                     ; preds = %for.cond64.preheader.us, %for.inc80.us
  %66 = phi double [ %add77.us.1, %for.inc80.us ], [ %.pre2, %for.cond64.preheader.us ]
...
for.inc58:                                        ; preds = %for.inc58.preheader, %for.inc58
  ...
  br i1 %exitcond21.3, label %for.cond64.preheader.us.preheader.loopexit, label %for.inc58, !llvm.loop !23
