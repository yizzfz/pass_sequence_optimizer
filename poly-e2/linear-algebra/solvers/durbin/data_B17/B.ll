...
for.body8.lr.ph:                                  ; preds = %entry, %for.end44
  %indvars.iv37 = phi i64 [ 1, %entry ], [ %indvars.iv.next38, %for.end44 ]
  %5 = phi double [ %sub, %entry ], [ %div, %for.end44 ]
  %indvars.iv29 = phi i64 [ 1, %entry ], [ %indvars.iv.next30, %for.end44 ]
  %indvar = phi i64 [ 0, %entry ], [ %8, %for.end44 ]
  %alpha.09 = phi double [ %sub3, %entry ], [ %div, %for.end44 ]
  %beta.08 = phi double [ 1.000000e+00, %entry ], [ %mul5, %for.end44 ]
  %6 = add nsw i64 %indvar, -1
  %7 = and i64 %indvars.iv37, 3
...
for.body8.prol:                                   ; preds = %for.body8.prol.preheader, %for.body8.prol
  ...
  %sum.02.prol = phi double [ %add.prol, %for.body8.prol ], [ 0.000000e+00, %for.body8.prol.preheader ]
...
for.body8.prol.loopexit:                          ; preds = %for.body8.prol.loopexit.loopexit, %for.body8.lr.ph
  %indvars.iv.unr = phi i64 [ 0, %for.body8.lr.ph ], [ %7, %for.body8.prol.loopexit.loopexit ]
  %sum.02.unr = phi double [ 0.000000e+00, %for.body8.lr.ph ], [ %add.prol, %for.body8.prol.loopexit.loopexit ]
...
for.body8:                                        ; preds = %for.body8.preheader, %for.body8
  ...
  %sum.02 = phi double [ %add.3, %for.body8 ], [ %sum.02.unr, %for.body8.preheader ]
...
for.body21.lr.ph:                                 ; preds = %for.body21.lr.ph.loopexit, %for.body8.prol.loopexit
  ...
  %xtraiter34 = and i64 %8, 1
  %lcmp.mod35 = icmp eq i64 %xtraiter34, 0
  br i1 %lcmp.mod35, label %for.body21.prol.loopexit.unr-lcssa, label %for.body21.prol.preheader

for.body21.prol.preheader:                        ; preds = %for.body21.lr.ph
  ...
  br label %for.body21.prol.loopexit.unr-lcssa

for.body21.prol.loopexit.unr-lcssa:               ; preds = %for.body21.lr.ph, %for.body21.prol.preheader
  %indvars.iv14.unr.ph = phi i64 [ 1, %for.body21.prol.preheader ], [ 0, %for.body21.lr.ph ]
  %29 = icmp eq i64 %indvar, 0
  br i1 %29, label %for.end44, label %for.body21.preheader

for.body21.preheader:                             ; preds = %for.body21.prol.loopexit.unr-lcssa
  %30 = sub i64 %6, %indvars.iv14.unr.ph
  %31 = lshr i64 %30, 1
  %32 = add nuw i64 %31, 1
  %min.iters.check = icmp ult i64 %32, 2
  br i1 %min.iters.check, label %for.body21.preheader47, label %min.iters.checked

min.iters.checked:                                ; preds = %for.body21.preheader
  %n.mod.vf = and i64 %32, 1
  %n.vec = sub i64 %32, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  %33 = or i64 %indvars.iv14.unr.ph, 2
  %34 = shl nuw i64 %31, 1
  %35 = add i64 %33, %34
  %36 = shl nuw nsw i64 %n.mod.vf, 1
  %ind.end = sub i64 %35, %36
  br i1 %cmp.zero, label %for.body21.preheader47, label %vector.ph

vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert44 = insertelement <2 x double> undef, double %div, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %37 = shl i64 %index, 1
  %offset.idx = or i64 %indvars.iv14.unr.ph, %37
  ...
  %40 = sub nsw i64 %27, %offset.idx
  %41 = getelementptr inbounds double, double* %y, i64 %40
  %42 = getelementptr double, double* %41, i64 -3
  %43 = bitcast double* %42 to <4 x double>*
  %wide.vec40 = load <4 x double>, <4 x double>* %43, align 8
  %strided.vec41 = shufflevector <4 x double> %wide.vec40, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %reverse = shufflevector <2 x double> %strided.vec41, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %strided.vec42 = shufflevector <4 x double> %wide.vec40, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %reverse43 = shufflevector <2 x double> %strided.vec42, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %44 = fmul <2 x double> %broadcast.splat45, %reverse43
  %45 = fadd <2 x double> %strided.vec, %44
  %46 = add nuw nsw i64 %offset.idx, 1
  %47 = fmul <2 x double> %broadcast.splat45, %reverse
  %48 = fadd <2 x double> %strided.vec39, %47
  ...
  br i1 %52, label %middle.block, label %vector.body, !llvm.loop !3

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.mod.vf, 0
  br i1 %cmp.n, label %for.end44, label %for.body21.preheader47

for.body21.preheader47:                           ; preds = %middle.block, %min.iters.checked, %for.body21.preheader
  %indvars.iv14.ph = phi i64 [ %indvars.iv14.unr.ph, %min.iters.checked ], [ %indvars.iv14.unr.ph, %for.body21.preheader ], [ %ind.end, %middle.block ]
...
for.body21:                                       ; preds = %for.body21.preheader47, %for.body21
  %indvars.iv14 = phi i64 [ %indvars.iv.next15.1, %for.body21 ], [ %indvars.iv14.ph, %for.body21.preheader47 ]
  ...
  %56 = sub nsw i64 %27, %indvars.iv.next15
  ...
  br i1 %exitcond20.1, label %for.end44.loopexit, label %for.body21, !llvm.loop !6

for.end44.loopexit:                               ; preds = %for.body21
  br label %for.end44

for.end44:                                        ; preds = %for.end44.loopexit, %middle.block, %for.body21.prol.loopexit.unr-lcssa
  ...
  %exitcond33 = icmp eq i64 %8, 1999
  %indvars.iv.next38 = add nuw nsw i64 %7, 1
  br i1 %exitcond33, label %for.end49, label %for.body8.lr.ph
