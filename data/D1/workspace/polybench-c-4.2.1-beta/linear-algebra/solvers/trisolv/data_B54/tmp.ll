...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit
  ...
  br i1 %exitcond31, label %._crit_edge22, label %.lr.ph
...
; <label>:5:                                      ; preds = %._crit_edge, %.lr.ph34
  ...
  %6 = add nuw i64 %indvars.iv42, 4294967295
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  store double %30, double* %sunkaddr55, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %5
  ...
  %exitcond47 = icmp eq i64 %indvars.iv.next43, 2000
  br i1 %exitcond47, label %._crit_edge35, label %5
...
; <label>:16:                                     ; preds = %14, %.lr.ph
  ...
  br i1 %exitcond9, label %._crit_edge, label %.lr.ph
