...
._crit_edge24:                                    ; preds = %._crit_edge24, %.preheader9
  %indvars.iv4 = phi i64 [ 0, %.preheader9 ], [ %indvars.iv.next5, %._crit_edge24 ]
  ...
  br i1 %exitcond6, label %36, label %._crit_edge24

; <label>:36:                                     ; preds = %._crit_edge24
...
._crit_edge26:                                    ; preds = %._crit_edge26, %.preheader
  ...
  br i1 %exitcond, label %44, label %._crit_edge26

; <label>:44:                                     ; preds = %._crit_edge26
