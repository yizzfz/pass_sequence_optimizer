...
for.body6.lr.ph:                                  ; preds = %for.inc14, %for.body.lr.ph
  %indvars.iv7 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next8, %for.inc14 ]
  ...
  %1 = add nuw nsw i64 %indvars.iv7, 1
  %2 = trunc i64 %1 to i32
  %sub = add i32 %2, 2000
  %3 = and i64 %indvars.iv7, 1
...
for.body6.prol.loopexit:                          ; preds = %for.body6.lr.ph, %for.body6.prol
  ...
  %4 = icmp eq i64 %indvars.iv7, 0
  br i1 %4, label %for.inc14, label %for.body6.preheader
...
for.inc14:                                        ; preds = %for.inc14.loopexit, %for.body6.prol.loopexit
  ...
  %exitcond = icmp ne i64 %indvars.iv.next8, 2000
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc void @kernel_trisolv(i32 %n, [2000 x double]* nocapture readonly %L, double* %x, double* nocapture readonly %b) unnamed_addr #2 {
entry:
...
for.body:                                         ; preds = %for.end, %for.body.preheader
  ...
  %indvars.iv5 = phi i32 [ %indvars.iv.next6, %for.end ], [ -1, %for.body.preheader ]
  %0 = add nuw nsw i64 %indvars.iv7, 4294967295
...
for.body5.prol:                                   ; preds = %for.body5.preheader
  ...
  %sunkaddr9.prol = shl i64 %indvars.iv7, 3
  %sunkaddr10.prol = add i64 %sunkaddr.prol, %sunkaddr9.prol
  %sunkaddr11.prol = inttoptr i64 %sunkaddr10.prol to double*
  store double %sub.prol, double* %sunkaddr11.prol, align 8
...
for.body5.prol.loopexit:                          ; preds = %for.body5.preheader, %for.body5.prol
  ...
  %9 = icmp eq i64 %1, 0
  br i1 %9, label %for.end, label %for.body5.preheader16
...
for.body5.preheader16:                            ; preds = %for.body5.prol.loopexit
  ...
  %sunkaddr9.1 = shl i64 %indvars.iv7, 3
  %sunkaddr10.1 = add i64 %sunkaddr.1, %sunkaddr9.1
  %sunkaddr11.1 = inttoptr i64 %sunkaddr10.1 to double*
  %wide.trip.count.1 = zext i32 %indvars.iv5 to i64
  br label %for.body5

for.body5:                                        ; preds = %for.body5, %for.body5.preheader16
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %for.body5 ], [ %indvars.iv.unr.ph, %for.body5.preheader16 ]
  %10 = phi double [ %sub.1, %for.body5 ], [ %.unr.ph, %for.body5.preheader16 ]
  ...
  store double %sub.1, double* %sunkaddr11.1, align 8
...
for.end:                                          ; preds = %for.end.loopexit, %for.body5.prol.loopexit, %for.body
  %.lcssa = phi double [ %5, %for.body ], [ %sub.lcssa.unr.ph, %for.body5.prol.loopexit ], [ %sub.1, %for.end.loopexit ]
...
for.body:                                         ; preds = %for.inc, %for.body.preheader
  ...
  %4 = phi %struct._IO_FILE* [ %3, %for.body.preheader ], [ %8, %for.inc ]
