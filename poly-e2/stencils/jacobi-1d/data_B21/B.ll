...
for.cond1.preheader.lr.ph:                        ; preds = %entry
  ...
  %scevgep14 = getelementptr double, double* %A, i64 %0
  %2 = add nsw i64 %0, 1
  %scevgep17 = getelementptr double, double* %B, i64 %2
  %scevgep34 = getelementptr double, double* %B, i64 1
  %scevgep36 = getelementptr double, double* %B, i64 %0
  %scevgep39 = getelementptr double, double* %A, i64 %2
  %cmp26 = icmp sgt i32 %sub, 1
  %min.iters.check28 = icmp ult i64 %1, 4
  %n.vec = and i64 %1, -4
...
for.body3.lr.ph:                                  ; preds = %for.cond1.preheader
  br i1 %min.iters.check28, label %for.body3.preheader, label %min.iters.checked29

for.body3.preheader:                              ; preds = %middle.block26, %vector.memcheck45, %min.iters.checked29, %for.body3.lr.ph
  %indvars.iv7.ph = phi i64 [ 1, %vector.memcheck45 ], [ 1, %min.iters.checked29 ], [ 1, %for.body3.lr.ph ], [ %ind.end, %middle.block26 ]
  br label %for.body3

min.iters.checked29:                              ; preds = %for.body3.lr.ph
  br i1 %cmp.zero, label %for.body3.preheader, label %vector.memcheck45

vector.memcheck45:                                ; preds = %min.iters.checked29
  br i1 %found.conflict43, label %for.body3.preheader, label %vector.body25.preheader
...
vector.body25:                                    ; preds = %vector.body25.preheader, %vector.body25
  ...
  %3 = getelementptr inbounds double, double* %A, i64 %index47
  %4 = bitcast double* %3 to <2 x double>*
  %wide.load57 = load <2 x double>, <2 x double>* %4, align 8, !alias.scope !1
  %5 = getelementptr double, double* %3, i64 2
  %6 = bitcast double* %5 to <2 x double>*
  %wide.load58 = load <2 x double>, <2 x double>* %6, align 8, !alias.scope !1
  %7 = getelementptr inbounds double, double* %A, i64 %offset.idx52
  %8 = bitcast double* %7 to <2 x double>*
  %wide.load59 = load <2 x double>, <2 x double>* %8, align 8, !alias.scope !1
  %9 = getelementptr double, double* %7, i64 2
  %10 = bitcast double* %9 to <2 x double>*
  %wide.load60 = load <2 x double>, <2 x double>* %10, align 8, !alias.scope !1
  %11 = fadd <2 x double> %wide.load57, %wide.load59
  %12 = fadd <2 x double> %wide.load58, %wide.load60
  %13 = add nuw nsw i64 %offset.idx52, 1
  ...
  %17 = fadd <2 x double> %11, %wide.load58
  %18 = fadd <2 x double> %12, %wide.load62
  ...
  %21 = getelementptr inbounds double, double* %B, i64 %offset.idx52
  ...
  %25 = icmp eq i64 %index.next48, %n.vec
  br i1 %25, label %middle.block26, label %vector.body25, !llvm.loop !6
...
for.cond13.preheader:                             ; preds = %for.cond13.preheader.loopexit, %middle.block26
...
for.body16.lr.ph:                                 ; preds = %for.cond13.preheader
  br i1 %min.iters.check28, label %for.body16.preheader, label %min.iters.checked
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load20 = load <2 x double>, <2 x double>* %29, align 8, !alias.scope !9
  %30 = getelementptr inbounds double, double* %B, i64 %offset.idx
  %31 = bitcast double* %30 to <2 x double>*
  %wide.load21 = load <2 x double>, <2 x double>* %31, align 8, !alias.scope !9
  %32 = getelementptr double, double* %30, i64 2
  %33 = bitcast double* %32 to <2 x double>*
  %wide.load22 = load <2 x double>, <2 x double>* %33, align 8, !alias.scope !9
  %34 = fadd <2 x double> %wide.load, %wide.load21
  %35 = fadd <2 x double> %wide.load20, %wide.load22
  ...
  %wide.load24 = load <2 x double>, <2 x double>* %39, align 8, !alias.scope !9
  %40 = fadd <2 x double> %34, %wide.load20
  %41 = fadd <2 x double> %35, %wide.load24
...
for.body3:                                        ; preds = %for.body3.preheader, %for.body3
  %indvars.iv7 = phi i64 [ %add7, %for.body3 ], [ %indvars.iv7.ph, %for.body3.preheader ]
...
for.body16:                                       ; preds = %for.body16.preheader, %for.body16
  %indvars.iv49 = phi i64 [ %add23, %for.body16 ], [ %indvars.iv49.ph, %for.body16.preheader ]
