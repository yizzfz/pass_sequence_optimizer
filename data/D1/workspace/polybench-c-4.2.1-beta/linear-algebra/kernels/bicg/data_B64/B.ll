...
.lr.ph9.new:                                      ; preds = %.lr.ph9.new, %.lr.ph9
  ...
  %indvars.iv.next20.1.1 = add nuw nsw i64 %indvars.iv19, 4
...
; <label>:8:                                      ; preds = %8, %.lr.ph4.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph4.split.us ], [ %indvars.iv.next, %8 ]
  ...
  br i1 %exitcond22, label %._crit_edge.us, label %8
