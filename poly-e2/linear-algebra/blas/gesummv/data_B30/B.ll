...
entry:
  %sunkaddr10 = ptrtoint double* %tmp to i64
...
for.body:                                         ; preds = %for.end, %entry
  %indvars.iv1 = phi i64 [ 0, %entry ], [ %indvars.iv.next2, %for.end ]
  ...
  %sunkaddr1 = shl i64 %indvars.iv1, 3
  %sunkaddr2 = add i64 %sunkaddr, %sunkaddr1
  %sunkaddr3 = inttoptr i64 %sunkaddr2 to double*
  %sunkaddr5 = shl i64 %indvars.iv1, 3
  %sunkaddr8 = add i64 %sunkaddr4, %sunkaddr5
...
for.body7:                                        ; preds = %for.body7, %for.body
  ...
  %5 = load double, double* %sunkaddr9, align 8
  %add27 = fadd double %mul24, %5
  store double %add27, double* %sunkaddr9, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
  br i1 %exitcond, label %for.end, label %for.body7

for.end:                                          ; preds = %for.body7
  %sunkaddr11 = shl i64 %indvars.iv1, 3
  ...
  store double %add36, double* %sunkaddr17, align 8
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 1300
  br i1 %exitcond3, label %for.end41, label %for.body
