...
for.body30.us.preheader:                          ; preds = %for.body30.lr.ph
  %5 = and i64 %indvars.iv156, 1
  %lcmp.mod23 = icmp eq i64 %5, 0
...
vector.body.preheader:                            ; preds = %min.iters.checked
  %7 = and i64 %2, 1
  %lcmp.mod21 = icmp eq i64 %7, 0
  br i1 %lcmp.mod21, label %vector.body.prol, label %vector.body.prol.loopexit

vector.body.prol:                                 ; preds = %vector.body.preheader
  %8 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv2, i64 %indvars.iv2
  %9 = bitcast double* %8 to <2 x i64>*
  %wide.load.prol = load <2 x i64>, <2 x i64>* %9, align 8
  %10 = getelementptr double, double* %8, i64 2
  %11 = bitcast double* %10 to <2 x i64>*
  %wide.load8.prol = load <2 x i64>, <2 x i64>* %11, align 8
  %12 = bitcast double* %8 to <2 x i64>*
  store <2 x i64> %wide.load.prol, <2 x i64>* %12, align 8
  %13 = bitcast double* %10 to <2 x i64>*
  store <2 x i64> %wide.load8.prol, <2 x i64>* %13, align 8
...
vector.body.prol.loopexit:                        ; preds = %vector.body.prol, %vector.body.preheader
  ...
  %14 = icmp eq i64 %2, 0
  br i1 %14, label %middle.block, label %vector.body.preheader.new
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader.new
  ...
  %15 = add i64 %indvars.iv2, %index
  %16 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv2, i64 %15
  %17 = bitcast double* %16 to <2 x i64>*
  %wide.load = load <2 x i64>, <2 x i64>* %17, align 8
  %18 = getelementptr double, double* %16, i64 2
  %19 = bitcast double* %18 to <2 x i64>*
  %wide.load8 = load <2 x i64>, <2 x i64>* %19, align 8
  %20 = bitcast double* %16 to <2 x i64>*
  store <2 x i64> %wide.load, <2 x i64>* %20, align 8
  %21 = bitcast double* %18 to <2 x i64>*
  store <2 x i64> %wide.load8, <2 x i64>* %21, align 8
  %index.next = add i64 %index, 4
  %22 = add i64 %indvars.iv2, %index.next
  %23 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv2, i64 %22
  ...
  %wide.load8.1 = load <2 x i64>, <2 x i64>* %26, align 8
  %27 = bitcast double* %23 to <2 x i64>*
  store <2 x i64> %wide.load.1, <2 x i64>* %27, align 8
  %28 = bitcast double* %25 to <2 x i64>*
  store <2 x i64> %wide.load8.1, <2 x i64>* %28, align 8
  %index.next.1 = add i64 %index, 8
  %29 = icmp eq i64 %index.next.1, %n.vec
  br i1 %29, label %middle.block.loopexit, label %vector.body, !llvm.loop !20
