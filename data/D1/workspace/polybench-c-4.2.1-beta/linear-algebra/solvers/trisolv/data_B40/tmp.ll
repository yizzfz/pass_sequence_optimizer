...
.lr.ph:                                           ; preds = %._crit_edge, %.lr.ph20
  ...
  %9 = add i32 %8, 2001
  %xtraiter30 = and i64 %indvars.iv.next27, 1
...
._crit_edge._crit_edge:                           ; preds = %._crit_edge, %.lr.ph34
  ...
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv42
  %6 = load double, double* %5, align 8
  %7 = getelementptr inbounds double, double* %2, i64 %indvars.iv42
  store double %6, double* %7, align 8
...
.lr.ph:                                           ; preds = %._crit_edge._crit_edge
  ...
  %xtraiter46 = and i64 %indvars.iv42, 1
  %lcmp.mod = icmp eq i64 %xtraiter46, 0
  br i1 %lcmp.mod, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.lr.ph
  %9 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv42, i64 0
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %17 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv42, i64 %indvars.iv
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %23 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv42, i64 %indvars.iv.next
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %._crit_edge._crit_edge
  %.lcssa = phi double [ %6, %._crit_edge._crit_edge ], [ %.lcssa37.unr.ph, %.prol.loopexit ], [ %28, %._crit_edge.loopexit ]
  %29 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv42, i64 %indvars.iv42
