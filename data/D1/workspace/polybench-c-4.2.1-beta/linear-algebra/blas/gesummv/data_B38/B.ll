...
; <label>:21:                                     ; preds = %18
  ...
  call fastcc void @print_array(double* %22)
  br label %._crit_edge
...
._crit_edge6:                                     ; preds = %26, %5
  %indvars.iv3 = phi i64 [ 0, %5 ], [ %indvars.iv.next4, %26 ]
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge6
  ...
  %25 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv3, i64 %indvars.iv
  store double %24, double* %25, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
  br i1 %exitcond, label %26, label %._crit_edge

; <label>:26:                                     ; preds = %._crit_edge
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv3, 1
  %exitcond5 = icmp eq i64 %indvars.iv.next4, 1300
  br i1 %exitcond5, label %27, label %._crit_edge6
...
define internal fastcc void @kernel_gesummv(double, double, [1300 x double]* nocapture readonly, [1300 x double]* nocapture readonly, double* nocapture, double* nocapture readonly, double* nocapture) unnamed_addr #2 {
  ...
  %sunkaddr9 = ptrtoint double* %6 to i64
  %sunkaddr17 = ptrtoint double* %6 to i64
  br label %._crit_edge21

._crit_edge21:                                    ; preds = %24, %7
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge21
  %indvars.iv = phi i64 [ 0, %._crit_edge21 ], [ %indvars.iv.next, %._crit_edge ]
  %11 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv3, i64 %indvars.iv
  %12 = load double, double* %11, align 8
  %13 = getelementptr inbounds double, double* %5, i64 %indvars.iv
  %14 = load double, double* %13, align 8
  %15 = fmul double %12, %14
  %16 = load double, double* %sunkaddr8, align 8
  %17 = fadd double %15, %16
  store double %17, double* %sunkaddr8, align 8
  %18 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv3, i64 %indvars.iv
  %19 = load double, double* %18, align 8
  %20 = load double, double* %13, align 8
  %21 = fmul double %19, %20
  %22 = load double, double* %sunkaddr12, align 8
  %23 = fadd double %21, %22
  store double %23, double* %sunkaddr12, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
...
; <label>:24:                                     ; preds = %._crit_edge
  ...
  %sunkaddr15 = add i64 %8, %sunkaddr14
  ...
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv3, 1
  %exitcond5 = icmp eq i64 %indvars.iv.next4, 1300
  br i1 %exitcond5, label %29, label %._crit_edge21
