...
.preheader40:                                     ; preds = %._crit_edge43, %.preheader40.lr.ph
  %.03944 = phi i32 [ 0, %.preheader40.lr.ph ], [ %37, %._crit_edge43 ]
...
; <label>:10:                                     ; preds = %10, %.preheader
  ...
  %21 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv46, i64 %indvars.iv
  %22 = load double, double* %21, align 8
  %23 = fadd double %20, %22
  %24 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv46, i64 %indvars.iv.next
  %25 = load double, double* %24, align 8
  %26 = fadd double %23, %25
  %27 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next47, i64 %11
  %28 = load double, double* %27, align 8
  %29 = fadd double %26, %28
  %30 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next47, i64 %indvars.iv
  %31 = load double, double* %30, align 8
  %32 = fadd double %29, %31
  %33 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next47, i64 %indvars.iv.next
...
._crit_edge43:                                    ; preds = %._crit_edge43.loopexit, %.preheader40
  %37 = add nuw nsw i32 %.03944, 1
  %exitcond50 = icmp eq i32 %37, %0
