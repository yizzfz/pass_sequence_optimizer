...
define internal fastcc void @init_array(i32, i32, double* nocapture, [1000 x double]* nocapture, [1200 x double]* nocapture) unnamed_addr #2 {
  ...
  %6 = icmp sgt i32 %0, 0
  br i1 %6, label %.preheader.lr.ph, label %.._crit_edge9_crit_edge

.._crit_edge9_crit_edge:                          ; preds = %5
...
.preheader.us:                                    ; preds = %._crit_edge6.us..preheader.us_crit_edge, %.preheader.us.preheader
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %._crit_edge6.us..preheader.us_crit_edge ], [ 0, %.preheader.us.preheader ]
...
._crit_edge.us:                                   ; preds = %.prol.loopexit.._crit_edge.us_crit_edge, %.preheader.us.._crit_edge.us_crit_edge, %._crit_edge.us.loopexit
  ...
  %15 = add i32 %14, %1
  br i1 %lcmp.mod19, label %._crit_edge.us..prol.loopexit17_crit_edge, label %.prol.preheader16

._crit_edge.us..prol.loopexit17_crit_edge:        ; preds = %._crit_edge.us
...
.prol.loopexit17:                                 ; preds = %._crit_edge.us..prol.loopexit17_crit_edge, %.prol.preheader16
  %indvars.iv13.unr.ph = phi i64 [ 1, %.prol.preheader16 ], [ 0, %._crit_edge.us..prol.loopexit17_crit_edge ]
  br i1 %10, label %.prol.loopexit17.._crit_edge6.us_crit_edge, label %._crit_edge.us.new.preheader

.prol.loopexit17.._crit_edge6.us_crit_edge:       ; preds = %.prol.loopexit17
...
.prol.loopexit:                                   ; preds = %.lr.ph.us..prol.loopexit_crit_edge, %.prol.preheader
  ...
  %50 = icmp eq i32 %49, 0
  br i1 %50, label %.prol.loopexit.._crit_edge.us_crit_edge, label %.lr.ph.us.new.preheader
...
._crit_edge6.us:                                  ; preds = %.prol.loopexit17.._crit_edge6.us_crit_edge, %._crit_edge6.us.loopexit
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  %exitcond = icmp eq i64 %indvars.iv.next25, %wide.trip.count26
  br i1 %exitcond, label %._crit_edge9.loopexit, label %._crit_edge6.us..preheader.us_crit_edge

._crit_edge6.us..preheader.us_crit_edge:          ; preds = %._crit_edge6.us
  br label %.preheader.us

.preheader:                                       ; preds = %._crit_edge..preheader_crit_edge, %.preheader.preheader
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %._crit_edge..preheader_crit_edge ], [ 0, %.preheader.preheader ]
...
.lr.ph:                                           ; preds = %.preheader
  ...
  br i1 %lcmp.mod35, label %.lr.ph..prol.loopexit33_crit_edge, label %.prol.preheader32

.lr.ph..prol.loopexit33_crit_edge:                ; preds = %.lr.ph
...
.prol.loopexit33:                                 ; preds = %.lr.ph..prol.loopexit33_crit_edge, %.prol.preheader32
  %indvars.iv27.unr.ph = phi i64 [ 1, %.prol.preheader32 ], [ 0, %.lr.ph..prol.loopexit33_crit_edge ]
  %58 = trunc i64 %51 to i32
  %59 = icmp eq i32 %58, 0
  br i1 %59, label %.prol.loopexit33.._crit_edge_crit_edge, label %.lr.ph.new.preheader

.prol.loopexit33.._crit_edge_crit_edge:           ; preds = %.prol.loopexit33
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %.prol.loopexit33.._crit_edge_crit_edge, %.preheader.._crit_edge_crit_edge, %._crit_edge.loopexit
  ...
  br i1 %exitcond41, label %._crit_edge9.loopexit46, label %._crit_edge..preheader_crit_edge
...
._crit_edge9:                                     ; preds = %.._crit_edge9_crit_edge, %._crit_edge9.loopexit46, %._crit_edge9.loopexit
  ret void
}
...
define internal fastcc void @kernel_trmm(i32, i32, double, [1000 x double]* nocapture readonly, [1200 x double]* nocapture) unnamed_addr #2 {
  ...
  %7 = icmp sgt i32 %1, 0
  %or.cond = and i1 %6, %7
  br i1 %or.cond, label %.preheader3.us.preheader, label %.._crit_edge9_crit_edge
...
.preheader3.us:                                   ; preds = %._crit_edge7.us..preheader3.us_crit_edge, %.preheader3.us.preheader
  %indvars.iv31 = phi i64 [ 0, %.preheader3.us.preheader ], [ %indvars.iv.next32, %._crit_edge7.us..preheader3.us_crit_edge ]
  %indvars.iv20 = phi i64 [ 1, %.preheader3.us.preheader ], [ %indvars.iv.next21, %._crit_edge7.us..preheader3.us_crit_edge ]
...
.preheader.us12.preheader:                        ; preds = %.preheader3.us
  br i1 %lcmp.mod, label %.preheader.us12.preheader..preheader.us12.prol.loopexit_crit_edge, label %.preheader.us12.prol.preheader

.preheader.us12.preheader..preheader.us12.prol.loopexit_crit_edge: ; preds = %.preheader.us12.preheader
...
.preheader.us12.prol.loopexit:                    ; preds = %.preheader.us12.preheader..preheader.us12.prol.loopexit_crit_edge, %.preheader.us12.prol.loopexit.loopexit
  %indvars.iv.unr = phi i64 [ 0, %.preheader.us12.preheader..preheader.us12.prol.loopexit_crit_edge ], [ %indvars.iv.next.prol, %.preheader.us12.prol.loopexit.loopexit ]
  br i1 %12, label %.preheader.us12.prol.loopexit.._crit_edge7.us_crit_edge, label %.preheader.us12.preheader38

.preheader.us12.prol.loopexit.._crit_edge7.us_crit_edge: ; preds = %.preheader.us12.prol.loopexit
...
.preheader.us12.preheader38:                      ; preds = %.preheader.us12.prol.loopexit
  ...
  br i1 %min.iters.check, label %.preheader.us12.preheader38..preheader.us12.preheader45_crit_edge, label %min.iters.checked

.preheader.us12.preheader38..preheader.us12.preheader45_crit_edge: ; preds = %.preheader.us12.preheader38
  br label %.preheader.us12.preheader45
...
min.iters.checked:                                ; preds = %.preheader.us12.preheader38
  ...
  br i1 %cmp.zero, label %min.iters.checked..preheader.us12.preheader45_crit_edge, label %vector.ph

min.iters.checked..preheader.us12.preheader45_crit_edge: ; preds = %min.iters.checked
  br label %.preheader.us12.preheader45
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.ph
  ...
  br i1 %46, label %middle.block, label %vector.body.vector.body_crit_edge, !llvm.loop !3
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %middle.block.._crit_edge7.us_crit_edge, label %middle.block..preheader.us12.preheader45_crit_edge

middle.block..preheader.us12.preheader45_crit_edge: ; preds = %middle.block
  br label %.preheader.us12.preheader45

middle.block.._crit_edge7.us_crit_edge:           ; preds = %middle.block
  br label %._crit_edge7.us

.preheader.us12.preheader45:                      ; preds = %middle.block..preheader.us12.preheader45_crit_edge, %min.iters.checked..preheader.us12.preheader45_crit_edge, %.preheader.us12.preheader38..preheader.us12.preheader45_crit_edge
  %indvars.iv.ph = phi i64 [ %indvars.iv.unr, %min.iters.checked..preheader.us12.preheader45_crit_edge ], [ %indvars.iv.unr, %.preheader.us12.preheader38..preheader.us12.preheader45_crit_edge ], [ %ind.end, %middle.block..preheader.us12.preheader45_crit_edge ]
...
._crit_edge7.us:                                  ; preds = %middle.block.._crit_edge7.us_crit_edge, %.preheader.us12.prol.loopexit.._crit_edge7.us_crit_edge, %._crit_edge7.us.loopexit46, %._crit_edge7.us.loopexit
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  %exitcond34 = icmp eq i64 %indvars.iv.next32, %wide.trip.count33
  br i1 %exitcond34, label %._crit_edge9.loopexit, label %._crit_edge7.us..preheader3.us_crit_edge
...
.preheader.us.us:                                 ; preds = %._crit_edge.us.us..preheader.us.us_crit_edge, %.preheader.us.us.preheader
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %._crit_edge.us.us..preheader.us.us_crit_edge ], [ 0, %.preheader.us.us.preheader ]
  %59 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv31, i64 %indvars.iv28
  br i1 %lcmp.mod26, label %.preheader.us.us..prol.loopexit_crit_edge, label %.prol.preheader
...
.prol.loopexit:                                   ; preds = %.preheader.us.us..prol.loopexit_crit_edge, %.prol.preheader
  %indvars.iv22.unr.ph = phi i64 [ %indvars.iv.next23.prol, %.prol.preheader ], [ %indvars.iv20, %.preheader.us.us..prol.loopexit_crit_edge ]
...
._crit_edge.us.us:                                ; preds = %.prol.loopexit.._crit_edge.us.us_crit_edge, %._crit_edge.us.us.loopexit
  ...
  br i1 %exitcond, label %._crit_edge7.us.loopexit, label %._crit_edge.us.us..preheader.us.us_crit_edge
...
._crit_edge9:                                     ; preds = %.._crit_edge9_crit_edge, %._crit_edge9.loopexit
  ret void
}
