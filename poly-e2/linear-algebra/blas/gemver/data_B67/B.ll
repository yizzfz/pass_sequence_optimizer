...
for.body.us:                                      ; preds = %for.cond35.for.inc46_crit_edge.us, %entry
  %indvars.iv7 = phi i64 [ 0, %entry ], [ %indvars.iv.next8, %for.cond35.for.inc46_crit_edge.us ]
  %0 = trunc i64 %indvars.iv7 to i32
  %conv2.us = sitofp i32 %0 to double
  %arrayidx.us = getelementptr inbounds double, double* %u1, i64 %indvars.iv7
  store double %conv2.us, double* %arrayidx.us, align 8
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %1 = trunc i64 %indvars.iv.next8 to i32
  %conv3.us = sitofp i32 %1 to double
  %arrayidx6.us = getelementptr inbounds double, double* %u2, i64 %indvars.iv7
  ...
  %arrayidx12.us = getelementptr inbounds double, double* %v1, i64 %indvars.iv7
  store double %div4.us.v.r2, double* %arrayidx12.us, align 8
  %arrayidx18.us = getelementptr inbounds double, double* %v2, i64 %indvars.iv7
  %div21.us = fdiv double %conv3.us, 2.000000e+03
  %div22.us = fmul double %div21.us, 1.250000e-01
  %arrayidx24.us = getelementptr inbounds double, double* %y, i64 %indvars.iv7
  ...
  %arrayidx30.us = getelementptr inbounds double, double* %z, i64 %indvars.iv7
  store double %div16.us.v.r2, double* %arrayidx30.us, align 8
  %arrayidx32.us = getelementptr inbounds double, double* %x, i64 %indvars.iv7
  store double 0.000000e+00, double* %arrayidx32.us, align 8
  %arrayidx34.us = getelementptr inbounds double, double* %w, i64 %indvars.iv7
...
for.inc.us:                                       ; preds = %for.inc.us, %for.body.us
  ...
  %arrayidx45.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv7, i64 %indvars.iv
  %indvars.iv.next = or i64 %indvars.iv, 1
  %5 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv7
...
for.cond35.for.inc46_crit_edge.us:                ; preds = %for.inc.us
  ...
  br i1 %exitcond10, label %for.end48, label %for.body.us
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc20_crit_edge.us, %entry
  %indvars.iv35 = phi i64 [ 0, %entry ], [ %0, %for.cond1.for.inc20_crit_edge.us ]
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %7 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv35, i64 %offset.idx
  ...
  %wide.vec25 = load <4 x double>, <4 x double>* %10, align 8, !alias.scope !11
  ...
  %11 = fmul <2 x double> %3, %strided.vec26
  ...
  %15 = fmul <2 x double> %6, %strided.vec29
  ...
  %19 = fmul <2 x double> %3, %strided.vec27
...
for.inc80.us:                                     ; preds = %for.inc80.us, %for.cond64.preheader.us
  %57 = phi double [ %.pre50, %for.cond64.preheader.us ], [ %add77.us.1, %for.inc80.us ]
