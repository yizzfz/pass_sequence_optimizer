...
._crit_edge6:                                     ; preds = %23, %7
  %indvars.iv3 = phi i64 [ 0, %7 ], [ %indvars.iv.next4, %23 ]
  ...
  %sunkaddr16 = add i64 %sunkaddr14, %sunkaddr7
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge6
  ...
  %21 = load double, double* %sunkaddr17, align 8
  %22 = fadd double %20, %21
  store double %22, double* %sunkaddr17, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
...
; <label>:23:                                     ; preds = %._crit_edge
  ...
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv3, 1
  %exitcond5 = icmp eq i64 %indvars.iv.next4, 1300
  br i1 %exitcond5, label %29, label %._crit_edge6
