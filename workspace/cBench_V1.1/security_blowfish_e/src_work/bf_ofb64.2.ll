...
@__llvm_prf_nm = private constant [18 x i8] c"\10\00BF_ofb64_encrypt", section "__llvm_prf_names"
@llvm.used = appending global [2 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_BF_ofb64_encrypt to i8*), i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
