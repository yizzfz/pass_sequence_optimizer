...
for.body:                                         ; preds = %for.body, %entry
  ...
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 2
  %cmp.1 = icmp slt i64 %indvars.iv.next2, 2100
...
vector.body:                                      ; preds = %vector.body, %entry
  %indvars.iv1 = phi i64 [ %indvars.iv.next2, %vector.body ], [ 0, %entry ]
  %0 = getelementptr inbounds double, double* %y, i64 %indvars.iv1
  ...
  %4 = add nuw nsw i64 %indvars.iv1, 4
  ...
  %9 = add nuw nsw i64 %indvars.iv1, 8
  ...
  %14 = add nuw nsw i64 %indvars.iv1, 12
  ...
  %19 = add nuw nsw i64 %indvars.iv1, 16
  ...
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 20
  %24 = icmp eq i64 %indvars.iv.next2, 2100
  br i1 %24, label %for.body5.us.preheader, label %vector.body, !llvm.loop !1

for.body5.us:                                     ; preds = %for.body5.us.preheader, %for.inc42.us
  %indvars.iv65 = phi i64 [ %25, %for.inc42.us ], [ 0, %for.body5.us.preheader ]
  %25 = add nuw nsw i64 %indvars.iv65, 1
...
for.body26.us.for.body26.us_crit_edge:            ; preds = %for.body26.us.for.body26.us_crit_edge.preheader, %for.body26.us.for.body26.us_crit_edge
  %indvars.iv.next6475 = phi i64 [ %indvars.iv.next64, %for.body26.us.for.body26.us_crit_edge ], [ %indvars.iv.next6475.ph, %for.body26.us.for.body26.us_crit_edge.preheader ]
...
for.body26.us.preheader:                          ; preds = %for.body10.us
  %scevgep85 = getelementptr [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 1
  %scevgep87 = getelementptr [2100 x double], [2100 x double]* %A, i64 %25, i64 0
  ...
  %36 = load double, double* %arrayidx32.us72, align 8
  %mul35.us73 = fmul double %36, %add.us.2
  %add36.us74 = fadd double %35, %mul35.us73
  store double %add36.us74, double* %y, align 8
  %bound0 = icmp ult double* %scevgep, %arrayidx12.us
  %bound1 = icmp ult double* %arrayidx12.us, %scevgep83
  %found.conflict = and i1 %bound0, %bound1
  %bound090 = icmp ult double* %scevgep, %scevgep87
  %bound191 = icmp ult double* %scevgep85, %scevgep83
  %found.conflict92 = and i1 %bound090, %bound191
  %conflict.rdx = or i1 %found.conflict, %found.conflict92
  br i1 %conflict.rdx, label %for.body26.us.for.body26.us_crit_edge.preheader, label %vector.body77.preheader

vector.body77.preheader:                          ; preds = %for.body26.us.preheader
  br label %vector.body77

for.body26.us.for.body26.us_crit_edge.preheader.loopexit: ; preds = %vector.body77
...
for.body26.us.for.body26.us_crit_edge.preheader:  ; preds = %for.body26.us.for.body26.us_crit_edge.preheader.loopexit, %for.body26.us.preheader
  %indvars.iv.next6475.ph = phi i64 [ 1, %for.body26.us.preheader ], [ 2097, %for.body26.us.for.body26.us_crit_edge.preheader.loopexit ]
  br label %for.body26.us.for.body26.us_crit_edge

vector.body77:                                    ; preds = %vector.body77.preheader, %vector.body77
  %index94 = phi i64 [ %index.next95, %vector.body77 ], [ 0, %vector.body77.preheader ]
  %offset.idx = or i64 %index94, 1
  ...
  %wide.load102 = load <2 x double>, <2 x double>* %43, align 8, !alias.scope !8, !noalias !10
  %44 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 %offset.idx
  %45 = bitcast double* %44 to <2 x double>*
  %wide.load103 = load <2 x double>, <2 x double>* %45, align 8, !alias.scope !12
  %46 = getelementptr double, double* %44, i64 2
  %47 = bitcast double* %46 to <2 x double>*
  %wide.load104 = load <2 x double>, <2 x double>* %47, align 8, !alias.scope !12
  %48 = fmul <2 x double> %wide.load103, %39
  %49 = fmul <2 x double> %wide.load104, %39
  %50 = fadd <2 x double> %wide.load, %48
  %51 = fadd <2 x double> %wide.load102, %49
  ...
  %52 = icmp eq i64 %index.next95, 2096
  br i1 %52, label %for.body26.us.for.body26.us_crit_edge.preheader.loopexit, label %vector.body77, !llvm.loop !13

for.body5.us.preheader:                           ; preds = %vector.body
  %scevgep = getelementptr double, double* %y, i64 1
  %scevgep83 = getelementptr double, double* %y, i64 2100
