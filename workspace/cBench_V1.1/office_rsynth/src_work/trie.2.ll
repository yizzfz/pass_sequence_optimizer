...
@__llvm_prf_nm = private constant [30 x i8] c"\17\1Cx\DA+)\CAL\8D\CF\CC+N-*a,\01\B1s\F2\F3\B3K\0B\00o\C0\09W", section "__llvm_prf_names"
@llvm.used = appending global [3 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_trie_insert to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_trie_lookup to i8*), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
