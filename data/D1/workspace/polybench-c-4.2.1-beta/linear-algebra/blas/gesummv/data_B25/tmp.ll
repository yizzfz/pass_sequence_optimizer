...
._crit_edge18:                                    ; preds = %._crit_edge18, %.lr.ph4.split.us
  ...
  %52 = icmp slt i64 %indvars.iv.next, %26
...
.lr.ph3.split.preheader52:                        ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.lr.ph3.split.preheader
  %indvars.iv15.ph = phi i64 [ %ind.end, %middle.block ], [ %32, %vector.memcheck ], [ %32, %min.iters.checked ], [ %32, %.lr.ph3.split.preheader ]
...
._crit_edge51:                                    ; preds = %._crit_edge51, %.lr.ph3.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph3.split.us ], [ %indvars.iv.next, %._crit_edge51 ]
  ...
  %68 = load double, double* %sunkaddr22, align 8
  %69 = fadd double %67, %68
  store double %69, double* %sunkaddr26, align 8
  ...
  %75 = load double, double* %sunkaddr30, align 8
  %76 = fadd double %74, %75
  store double %76, double* %sunkaddr34, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %77 = icmp slt i64 %indvars.iv.next, %58
  br i1 %77, label %._crit_edge51, label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge51
  ...
  %indvars.iv.next12 = add nsw i64 %indvars.iv11, 1
  %86 = icmp slt i64 %indvars.iv.next12, %60
...
.lr.ph3.split:                                    ; preds = %.lr.ph3.split.preheader52, %.lr.ph3.split
  ...
  %87 = getelementptr inbounds double, double* %20, i64 %indvars.iv15
  store double 0.000000e+00, double* %87, align 8
  %88 = getelementptr inbounds double, double* %21, i64 %indvars.iv15
  store double 0.000000e+00, double* %88, align 8
  %89 = getelementptr inbounds double, double* %20, i64 %indvars.iv15
  %90 = load double, double* %89, align 8
  %91 = fmul double %25, %90
  %92 = fadd double %91, %33
  %93 = getelementptr inbounds double, double* %21, i64 %indvars.iv15
  store double %92, double* %93, align 8
  %indvars.iv.next16 = add nsw i64 %indvars.iv15, 1
  %94 = icmp slt i64 %indvars.iv.next16, %23
  br i1 %94, label %.lr.ph3.split, label %._crit_edge4.loopexit53, !llvm.loop !9
