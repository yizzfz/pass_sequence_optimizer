...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  br i1 %39, label %middle.block.loopexit67, label %vector.body, !llvm.loop !13
...
.preheader71.preheader:                           ; preds = %middle.block
  br label %.preheader71

.preheader71:                                     ; preds = %80, %.preheader71.preheader
  %indvars.iv10 = phi i64 [ 0, %.preheader71.preheader ], [ %indvars.iv.next11, %80 ]
...
._crit_edge20:                                    ; preds = %._crit_edge20, %.preheader71
  %65 = phi double [ %.pre, %.preheader71 ], [ %79, %._crit_edge20 ]
  ...
  store double %72, double* %sunkaddr62, align 8
...
.preheader:                                       ; preds = %122, %.preheader.preheader
  %indvars.iv1 = phi i64 [ 0, %.preheader.preheader ], [ %indvars.iv.next2, %122 ]
  %106 = getelementptr inbounds double, double* %7, i64 %indvars.iv1
  %.pre51 = load double, double* %106, align 8
  br label %._crit_edge22

._crit_edge22:                                    ; preds = %._crit_edge22, %.preheader
  %107 = phi double [ %.pre51, %.preheader ], [ %121, %._crit_edge22 ]
  ...
  store double %114, double* %sunkaddr66, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %121, double* %sunkaddr66, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %122, label %._crit_edge22

; <label>:122:                                    ; preds = %._crit_edge22
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 2000
  br i1 %exitcond3, label %123, label %.preheader
