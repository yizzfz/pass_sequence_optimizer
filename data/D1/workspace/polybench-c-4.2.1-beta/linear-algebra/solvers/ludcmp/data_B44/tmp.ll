...
define internal fastcc void @init_array(i32, [2000 x double]*, double*, double*, double*) unnamed_addr #0 {
  ...
  %10 = icmp sgt i32 %0, 0
  br i1 %10, label %.lr.ph62, label %.preheader15.thread
...
._crit_edge.prol.preheader:                       ; preds = %.lr.ph62
...
._crit_edge.prol.loopexit:                        ; preds = %.lr.ph62, %._crit_edge.prol
  %indvars.iv125.unr = phi i64 [ 0, %.lr.ph62 ], [ 1, %._crit_edge.prol ]
  %15 = icmp eq i32 %0, 1
  br i1 %15, label %.preheader15, label %.lr.ph62.new

.lr.ph62.new:                                     ; preds = %._crit_edge.prol.loopexit
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph62.new
  %indvars.iv125 = phi i64 [ %indvars.iv125.unr, %.lr.ph62.new ], [ %indvars.iv.next126.1, %._crit_edge ]
...
.preheader14:                                     ; preds = %._crit_edge52, %.preheader14.lr.ph
  %indvar135 = phi i32 [ %40, %._crit_edge52 ], [ 0, %.preheader14.lr.ph ]
  %indvars.iv123 = phi i64 [ %indvars.iv.next124, %._crit_edge52 ], [ 0, %.preheader14.lr.ph ]
  %indvars.iv119.in = phi i32 [ %indvars.iv119, %._crit_edge52 ], [ 0, %.preheader14.lr.ph ]
  %indvars.iv115 = phi i32 [ %indvars.iv.next116, %._crit_edge52 ], [ 0, %.preheader14.lr.ph ]
  ...
  br i1 %44, label %._crit_edge46, label %.lr.ph45
...
; <label>:45:                                     ; preds = %45, %.lr.ph45
  %indvars.iv111 = phi i64 [ %indvars.iv.next112, %45 ], [ 0, %.lr.ph45 ]
  ...
  br i1 %exitcond118, label %._crit_edge46.loopexit, label %45

._crit_edge46.loopexit:                           ; preds = %45
  br label %._crit_edge46

._crit_edge46:                                    ; preds = %._crit_edge46.loopexit, %.preheader14
  %indvars.iv.next124 = add i64 %indvars.iv123, 1
  %53 = icmp slt i64 %indvars.iv.next124, %11
  br i1 %53, label %.lr.ph51.preheader, label %._crit_edge52

.lr.ph51.preheader:                               ; preds = %._crit_edge46
  %min.iters.check = icmp ult i64 %42, 4
  br i1 %min.iters.check, label %.lr.ph51.preheader208, label %min.iters.checked

min.iters.checked:                                ; preds = %.lr.ph51.preheader
  %n.vec = and i64 %42, -4
  %cmp.zero = icmp eq i64 %n.vec, 0
  %ind.end = add nsw i64 %43, %n.vec
  br i1 %cmp.zero, label %.lr.ph51.preheader208, label %vector.body.preheader
...
middle.block:                                     ; preds = %vector.body.prol.loopexit, %middle.block.unr-lcssa
  ...
  br i1 %cmp.n, label %._crit_edge52, label %.lr.ph51.preheader208

.lr.ph51.preheader208:                            ; preds = %middle.block, %min.iters.checked, %.lr.ph51.preheader
  %indvars.iv121.ph = phi i64 [ %43, %min.iters.checked ], [ %43, %.lr.ph51.preheader ], [ %ind.end, %middle.block ]
  br label %.lr.ph51

.lr.ph51:                                         ; preds = %.lr.ph51.preheader208, %.lr.ph51
  %indvars.iv121 = phi i64 [ %indvars.iv.next122, %.lr.ph51 ], [ %indvars.iv121.ph, %.lr.ph51.preheader208 ]
  ...
  br i1 %exitcond, label %._crit_edge52.loopexit, label %.lr.ph51, !llvm.loop !6

._crit_edge52.loopexit:                           ; preds = %.lr.ph51
  br label %._crit_edge52

._crit_edge52:                                    ; preds = %._crit_edge52.loopexit, %middle.block, %._crit_edge46
  ...
  br i1 %53, label %.preheader14, label %._crit_edge56

._crit_edge56:                                    ; preds = %._crit_edge52
  br label %.preheader15._crit_edge

.preheader15._crit_edge:                          ; preds = %.preheader15..preheader15._crit_edge_crit_edge, %.preheader15.thread, %._crit_edge56
...
.preheader13.lr.ph..preheader13.us_crit_edge:     ; preds = %.preheader13.lr.ph
  ...
  br i1 %lcmp.mod218, label %._crit_edge38.us.prol.loopexit, label %._crit_edge38.us.prol.preheader

._crit_edge38.us.prol.preheader:                  ; preds = %.preheader13.lr.ph..preheader13.us_crit_edge
  br label %._crit_edge38.us.prol

._crit_edge38.us.prol:                            ; preds = %._crit_edge38.us.prol, %._crit_edge38.us.prol.preheader
  %indvars.iv108.prol = phi i64 [ %indvars.iv.next109.prol, %._crit_edge38.us.prol ], [ 0, %._crit_edge38.us.prol.preheader ]
  %indvar.prol = phi i64 [ %indvar.next.prol, %._crit_edge38.us.prol ], [ 0, %._crit_edge38.us.prol.preheader ]
  %prol.iter219 = phi i64 [ %prol.iter219.sub, %._crit_edge38.us.prol ], [ %xtraiter217, %._crit_edge38.us.prol.preheader ]
  ...
  br i1 %prol.iter219.cmp, label %._crit_edge38.us.prol.loopexit.unr-lcssa, label %._crit_edge38.us.prol, !llvm.loop !8

._crit_edge38.us.prol.loopexit.unr-lcssa:         ; preds = %._crit_edge38.us.prol
  br label %._crit_edge38.us.prol.loopexit

._crit_edge38.us.prol.loopexit:                   ; preds = %.preheader13.lr.ph..preheader13.us_crit_edge, %._crit_edge38.us.prol.loopexit.unr-lcssa
  %indvars.iv108.unr = phi i64 [ 0, %.preheader13.lr.ph..preheader13.us_crit_edge ], [ %indvars.iv.next109.prol, %._crit_edge38.us.prol.loopexit.unr-lcssa ]
  %indvar.unr = phi i64 [ 0, %.preheader13.lr.ph..preheader13.us_crit_edge ], [ %indvar.next.prol, %._crit_edge38.us.prol.loopexit.unr-lcssa ]
  %92 = icmp ult i64 %91, 3
  br i1 %92, label %.preheader12.loopexit, label %.preheader13.lr.ph..preheader13.us_crit_edge.new

.preheader13.lr.ph..preheader13.us_crit_edge.new: ; preds = %._crit_edge38.us.prol.loopexit
  br label %._crit_edge38.us

._crit_edge38.us:                                 ; preds = %._crit_edge38.us, %.preheader13.lr.ph..preheader13.us_crit_edge.new
  %indvars.iv108 = phi i64 [ %indvars.iv108.unr, %.preheader13.lr.ph..preheader13.us_crit_edge.new ], [ %indvars.iv.next109.3, %._crit_edge38.us ]
  %indvar = phi i64 [ %indvar.unr, %.preheader13.lr.ph..preheader13.us_crit_edge.new ], [ %indvar.next.3, %._crit_edge38.us ]
  ...
  br i1 %93, label %._crit_edge38.us, label %.preheader12.loopexit.unr-lcssa

.preheader12.loopexit.unr-lcssa:                  ; preds = %._crit_edge38.us
  br label %.preheader12.loopexit

.preheader12.loopexit:                            ; preds = %._crit_edge38.us.prol.loopexit, %.preheader12.loopexit.unr-lcssa
...
.preheader11.us:                                  ; preds = %._crit_edge26.us-lcssa.us.us, %.preheader11.lr.ph..preheader11.us_crit_edge
  %indvar153 = phi i64 [ %102, %._crit_edge26.us-lcssa.us.us ], [ 0, %.preheader11.lr.ph..preheader11.us_crit_edge ]
  %indvars.iv103 = phi i64 [ %indvars.iv.next104, %._crit_edge26.us-lcssa.us.us ], [ 0, %.preheader11.lr.ph..preheader11.us_crit_edge ]
  ...
  br i1 true, label %.preheader10.lr.ph.us, label %.preheader11.us.._crit_edge26.us-lcssa.us.us_crit_edge

.preheader11.us.._crit_edge26.us-lcssa.us.us_crit_edge: ; preds = %.preheader11.us
  br label %._crit_edge26.us-lcssa.us.us

.preheader10.lr.ph.us:                            ; preds = %.preheader11.us
  br label %.preheader10.us.us

._crit_edge26.us-lcssa.us.us.loopexit:            ; preds = %._crit_edge24.us.us
  br label %._crit_edge26.us-lcssa.us.us

._crit_edge26.us-lcssa.us.us:                     ; preds = %.preheader11.us.._crit_edge26.us-lcssa.us.us_crit_edge, %._crit_edge26.us-lcssa.us.us.loopexit
  %indvars.iv.next104 = add i64 %indvars.iv103, 1
  %103 = icmp slt i64 %indvars.iv.next104, %99
  br i1 %103, label %.preheader11.us, label %._crit_edge26.us-lcssa.us.us...preheader9_crit_edge_crit_edge

._crit_edge26.us-lcssa.us.us...preheader9_crit_edge_crit_edge: ; preds = %._crit_edge26.us-lcssa.us.us
  br label %..preheader9_crit_edge

.preheader10.us.us:                               ; preds = %._crit_edge24.us.us, %.preheader10.lr.ph.us
  %indvar147 = phi i64 [ %indvar.next148, %._crit_edge24.us.us ], [ 0, %.preheader10.lr.ph.us ]
  %indvars.iv101 = phi i64 [ %indvars.iv.next102, %._crit_edge24.us.us ], [ 0, %.preheader10.lr.ph.us ]
...
scalar.ph140.prol.loopexit:                       ; preds = %scalar.ph140.prol.loopexit.unr-lcssa
  ...
  br i1 %113, label %._crit_edge24.us.us.loopexit, label %scalar.ph140.preheader.new
...
middle.block139:                                  ; preds = %vector.body138
  br i1 %cmp.n167, label %._crit_edge24.us.us, label %scalar.ph140.preheader

._crit_edge24.us.us.loopexit.unr-lcssa:           ; preds = %scalar.ph140
  br label %._crit_edge24.us.us.loopexit

._crit_edge24.us.us.loopexit:                     ; preds = %scalar.ph140.prol.loopexit, %._crit_edge24.us.us.loopexit.unr-lcssa
  br label %._crit_edge24.us.us

._crit_edge24.us.us:                              ; preds = %._crit_edge24.us.us.loopexit, %middle.block139
  %indvars.iv.next102 = add i64 %indvars.iv101, 1
  %141 = icmp slt i64 %indvars.iv.next102, %99
  %indvar.next148 = add i64 %indvar147, 1
  br i1 %141, label %.preheader10.us.us, label %._crit_edge26.us-lcssa.us.us.loopexit
...
scalar.ph140:                                     ; preds = %scalar.ph140, %scalar.ph140.preheader.new
  ...
  br i1 %exitcond100.1, label %._crit_edge24.us.us.loopexit.unr-lcssa, label %scalar.ph140, !llvm.loop !19
...
..preheader9_crit_edge:                           ; preds = %..preheader9_crit_edge.loopexit, %._crit_edge26.us-lcssa.us.us...preheader9_crit_edge_crit_edge
  br label %.preheader9
...
.preheader.lr.ph:                                 ; preds = %.preheader9
  ...
  br i1 true, label %.preheader.lr.ph..preheader.us_crit_edge, label %.preheader.._crit_edge18_crit_edge
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %middle.block174
  ...
  br i1 %223, label %.preheader.us, label %._crit_edge.us.._crit_edge18_crit_edge

._crit_edge.us.._crit_edge18_crit_edge:           ; preds = %._crit_edge.us
  br label %._crit_edge18

.preheader.._crit_edge18_crit_edge:               ; preds = %.preheader.lr.ph
  br label %._crit_edge18

._crit_edge18:                                    ; preds = %.preheader.._crit_edge18_crit_edge, %._crit_edge.us.._crit_edge18_crit_edge
  br label %.preheader9._crit_edge

.preheader9._crit_edge:                           ; preds = %.preheader9..preheader9._crit_edge_crit_edge, %._crit_edge18
  %224 = phi i8* [ %.pre, %.preheader9..preheader9._crit_edge_crit_edge ], [ %160, %._crit_edge18 ]
...
.preheader9:                                      ; preds = %._crit_edge53, %.preheader9.lr.ph
  %indvars.iv135 = phi i64 [ %indvars.iv.next136, %._crit_edge53 ], [ 0, %.preheader9.lr.ph ]
  %indvars.iv127 = phi i32 [ %14, %._crit_edge53 ], [ -1, %.preheader9.lr.ph ]
  ...
  br i1 %15, label %.lr.ph39.preheader, label %._crit_edge40
...
.preheader:                                       ; preds = %5, %..preheader_crit_edge
  br i1 %6, label %.lr.ph27, label %.preheader._crit_edge.thread
...
.lr.ph39:                                         ; preds = %.lr.ph39.preheader, %._crit_edge67
  %indvars.iv112 = phi i64 [ %indvars.iv.next113, %._crit_edge67 ], [ 0, %.lr.ph39.preheader ]
  %indvars.iv108 = phi i32 [ %20, %._crit_edge67 ], [ -1, %.lr.ph39.preheader ]
...
.prol.loopexit162.unr-lcssa:                      ; preds = %.lr.ph34, %25
  %.lcssa152.unr.ph = phi double [ %30, %25 ], [ undef, %.lr.ph34 ]
  %indvars.iv102.unr.ph = phi i64 [ 1, %25 ], [ 0, %.lr.ph34 ]
  %.unr165.ph = phi double [ %30, %25 ], [ %22, %.lr.ph34 ]
...
.lr.ph34.new:                                     ; preds = %.prol.loopexit162
  br label %32

; <label>:32:                                     ; preds = %32, %.lr.ph34.new
  %indvars.iv102 = phi i64 [ %indvars.iv102.unr.ph, %.lr.ph34.new ], [ %indvars.iv.next103.1, %32 ]
  %33 = phi double [ %.unr165.ph, %.lr.ph34.new ], [ %47, %32 ]
  ...
  br i1 %exitcond111.1, label %._crit_edge35.unr-lcssa, label %32

._crit_edge35.unr-lcssa:                          ; preds = %32
  br label %._crit_edge35

._crit_edge35:                                    ; preds = %.prol.loopexit162, %._crit_edge35.unr-lcssa
  %.lcssa152 = phi double [ %.lcssa152.unr.ph, %.prol.loopexit162 ], [ %47, %._crit_edge35.unr-lcssa ]
  br label %._crit_edge67

._crit_edge67:                                    ; preds = %.lr.ph39, %._crit_edge35
  %48 = phi double [ %.lcssa152, %._crit_edge35 ], [ %22, %.lr.ph39 ]
  ...
  br i1 %52, label %.lr.ph39, label %._crit_edge40.loopexit

._crit_edge40.loopexit:                           ; preds = %._crit_edge67
  br label %._crit_edge40

._crit_edge40:                                    ; preds = %._crit_edge40.loopexit, %.preheader9
  %53 = icmp slt i64 %indvars.iv135, %8
  br i1 %53, label %.lr.ph52, label %._crit_edge53

.lr.ph52:                                         ; preds = %._crit_edge40
  br i1 %15, label %.lr.ph52.split.us.preheader, label %.lr.ph52.split.preheader

.lr.ph52.split.preheader:                         ; preds = %.lr.ph52
  %xtraiter166 = and i64 %12, 3
  %lcmp.mod167 = icmp eq i64 %xtraiter166, 0
  br i1 %lcmp.mod167, label %.lr.ph52.split.prol.loopexit, label %.lr.ph52.split.prol.preheader

.lr.ph52.split.prol.preheader:                    ; preds = %.lr.ph52.split.preheader
  br label %.lr.ph52.split.prol

.lr.ph52.split.prol:                              ; preds = %.lr.ph52.split.prol, %.lr.ph52.split.prol.preheader
  %indvars.iv116.prol = phi i64 [ %indvars.iv.next117.prol, %.lr.ph52.split.prol ], [ %indvars.iv135, %.lr.ph52.split.prol.preheader ]
  %prol.iter168 = phi i64 [ %prol.iter168.sub, %.lr.ph52.split.prol ], [ %xtraiter166, %.lr.ph52.split.prol.preheader ]
  ...
  br i1 %prol.iter168.cmp, label %.lr.ph52.split.prol.loopexit.unr-lcssa, label %.lr.ph52.split.prol, !llvm.loop !28

.lr.ph52.split.prol.loopexit.unr-lcssa:           ; preds = %.lr.ph52.split.prol
  br label %.lr.ph52.split.prol.loopexit

.lr.ph52.split.prol.loopexit:                     ; preds = %.lr.ph52.split.preheader, %.lr.ph52.split.prol.loopexit.unr-lcssa
  %indvars.iv116.unr = phi i64 [ %indvars.iv135, %.lr.ph52.split.preheader ], [ %indvars.iv.next117.prol, %.lr.ph52.split.prol.loopexit.unr-lcssa ]
  %54 = icmp ult i64 %13, 3
  br i1 %54, label %._crit_edge53.loopexit138, label %.lr.ph52.split.preheader.new

.lr.ph52.split.preheader.new:                     ; preds = %.lr.ph52.split.prol.loopexit
  br label %.lr.ph52.split

.lr.ph52.split.us.preheader:                      ; preds = %.lr.ph52
  %wide.trip.count129 = zext i32 %indvars.iv127 to i64
  %55 = and i64 %10, 1
  %lcmp.mod172 = icmp eq i64 %55, 0
  %56 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv135, i64 0
  %57 = icmp eq i64 %11, 0
  br label %.lr.ph52.split.us

.lr.ph52.split.us:                                ; preds = %.lr.ph52.split.us.preheader, %._crit_edge46.us
  %indvars.iv133 = phi i64 [ %indvars.iv.next134, %._crit_edge46.us ], [ %indvars.iv135, %.lr.ph52.split.us.preheader ]
...
.prol.preheader169:                               ; preds = %.lr.ph52.split.us
  br label %60

; <label>:60:                                     ; preds = %.prol.preheader169
...
.prol.loopexit170.unr-lcssa:                      ; preds = %.lr.ph52.split.us, %60
  %.lcssa154.unr.ph = phi double [ %65, %60 ], [ undef, %.lr.ph52.split.us ]
  %indvars.iv121.unr.ph = phi i64 [ 1, %60 ], [ 0, %.lr.ph52.split.us ]
  %.unr173.ph = phi double [ %65, %60 ], [ %59, %.lr.ph52.split.us ]
  br label %.prol.loopexit170

.prol.loopexit170:                                ; preds = %.prol.loopexit170.unr-lcssa
  br i1 %57, label %._crit_edge46.us, label %.lr.ph52.split.us.new

.lr.ph52.split.us.new:                            ; preds = %.prol.loopexit170
  br label %66

; <label>:66:                                     ; preds = %66, %.lr.ph52.split.us.new
  %indvars.iv121 = phi i64 [ %indvars.iv121.unr.ph, %.lr.ph52.split.us.new ], [ %indvars.iv.next122.1, %66 ]
  %67 = phi double [ %.unr173.ph, %.lr.ph52.split.us.new ], [ %81, %66 ]
  ...
  br i1 %exitcond130.1, label %._crit_edge46.us.unr-lcssa, label %66

._crit_edge46.us.unr-lcssa:                       ; preds = %66
  br label %._crit_edge46.us

._crit_edge46.us:                                 ; preds = %.prol.loopexit170, %._crit_edge46.us.unr-lcssa
  %.lcssa154 = phi double [ %.lcssa154.unr.ph, %.prol.loopexit170 ], [ %81, %._crit_edge46.us.unr-lcssa ]
  store double %.lcssa154, double* %58, align 8
  %indvars.iv.next134 = add i64 %indvars.iv133, 1
  %82 = icmp slt i64 %indvars.iv.next134, %8
  br i1 %82, label %.lr.ph52.split.us, label %._crit_edge53.loopexit

.lr.ph52.split:                                   ; preds = %.lr.ph52.split, %.lr.ph52.split.preheader.new
  %indvars.iv116 = phi i64 [ %indvars.iv116.unr, %.lr.ph52.split.preheader.new ], [ %indvars.iv.next117.3, %.lr.ph52.split ]
  ...
  br i1 %exitcond119.3, label %._crit_edge53.loopexit138.unr-lcssa, label %.lr.ph52.split

._crit_edge53.loopexit138.unr-lcssa:              ; preds = %.lr.ph52.split
  br label %._crit_edge53.loopexit138

._crit_edge53.loopexit138:                        ; preds = %.lr.ph52.split.prol.loopexit, %._crit_edge53.loopexit138.unr-lcssa
  br label %._crit_edge53

._crit_edge53.loopexit:                           ; preds = %._crit_edge46.us
  br label %._crit_edge53

._crit_edge53:                                    ; preds = %._crit_edge53.loopexit, %._crit_edge53.loopexit138, %._crit_edge40
...
; <label>:84:                                     ; preds = %._crit_edge71, %.lr.ph27
  %indvars.iv100 = phi i64 [ %indvars.iv.next101, %._crit_edge71 ], [ 0, %.lr.ph27 ]
  %indvars.iv96 = phi i32 [ %indvars.iv.next97, %._crit_edge71 ], [ -1, %.lr.ph27 ]
  ...
  br i1 %90, label %.lr.ph22, label %._crit_edge71

.lr.ph22:                                         ; preds = %84
  %wide.trip.count98 = zext i32 %indvars.iv96 to i64
  %xtraiter157 = and i64 %indvars.iv100, 3
  %lcmp.mod158 = icmp eq i64 %xtraiter157, 0
  br i1 %lcmp.mod158, label %.prol.loopexit156, label %.prol.preheader155

.prol.preheader155:                               ; preds = %.lr.ph22
  br label %92

; <label>:92:                                     ; preds = %92, %.prol.preheader155
  %indvars.iv90.prol = phi i64 [ %indvars.iv.next91.prol, %92 ], [ 0, %.prol.preheader155 ]
  %93 = phi double [ %99, %92 ], [ %91, %.prol.preheader155 ]
  %prol.iter159 = phi i64 [ %prol.iter159.sub, %92 ], [ %xtraiter157, %.prol.preheader155 ]
  ...
  br i1 %prol.iter159.cmp, label %.prol.loopexit156.unr-lcssa, label %92, !llvm.loop !29

.prol.loopexit156.unr-lcssa:                      ; preds = %92
  br label %.prol.loopexit156

.prol.loopexit156:                                ; preds = %.lr.ph22, %.prol.loopexit156.unr-lcssa
  %.lcssa151.unr = phi double [ undef, %.lr.ph22 ], [ %99, %.prol.loopexit156.unr-lcssa ]
  %indvars.iv90.unr = phi i64 [ 0, %.lr.ph22 ], [ %indvars.iv.next91.prol, %.prol.loopexit156.unr-lcssa ]
  %.unr160 = phi double [ %91, %.lr.ph22 ], [ %99, %.prol.loopexit156.unr-lcssa ]
  %100 = icmp ult i64 %86, 3
  br i1 %100, label %._crit_edge23, label %.lr.ph22.new

.lr.ph22.new:                                     ; preds = %.prol.loopexit156
  br label %101

; <label>:101:                                    ; preds = %101, %.lr.ph22.new
  %indvars.iv90 = phi i64 [ %indvars.iv90.unr, %.lr.ph22.new ], [ %indvars.iv.next91.3, %101 ]
  %102 = phi double [ %.unr160, %.lr.ph22.new ], [ %124, %101 ]
  ...
  br i1 %exitcond99.3, label %._crit_edge23.unr-lcssa, label %101

._crit_edge23.unr-lcssa:                          ; preds = %101
  br label %._crit_edge23

._crit_edge23:                                    ; preds = %.prol.loopexit156, %._crit_edge23.unr-lcssa
  %.lcssa151 = phi double [ %.lcssa151.unr, %.prol.loopexit156 ], [ %124, %._crit_edge23.unr-lcssa ]
  %125 = bitcast double %.lcssa151 to i64
  br label %._crit_edge71

._crit_edge71:                                    ; preds = %84, %._crit_edge23
  %126 = phi i64 [ %89, %84 ], [ %125, %._crit_edge23 ]
...
.preheader._crit_edge:                            ; preds = %._crit_edge71
  br i1 true, label %.lr.ph15, label %.preheader._crit_edge.._crit_edge74_crit_edge

.preheader._crit_edge.._crit_edge74_crit_edge:    ; preds = %.preheader._crit_edge
  br label %._crit_edge74

.lr.ph15:                                         ; preds = %.preheader._crit_edge
  %storemerge213 = add i32 %0, -1
  %130 = sext i32 %storemerge213 to i64
  %131 = add nsw i64 %130, 1
  br label %132

; <label>:132:                                    ; preds = %._crit_edge75, %.lr.ph15
  %indvar = phi i32 [ %indvar.next, %._crit_edge75 ], [ 0, %.lr.ph15 ]
  %indvars.iv87 = phi i64 [ %indvars.iv.next88, %._crit_edge75 ], [ %130, %.lr.ph15 ]
  %indvars.iv = phi i32 [ %indvars.iv.next, %._crit_edge75 ], [ %0, %.lr.ph15 ]
...
._crit_edge75:                                    ; preds = %132, %._crit_edge
  ...
  br i1 %180, label %132, label %._crit_edge16

._crit_edge16:                                    ; preds = %._crit_edge75
  br label %._crit_edge74

._crit_edge74:                                    ; preds = %.preheader._crit_edge.._crit_edge74_crit_edge, %.preheader._crit_edge.thread, %._crit_edge16
  ret void
}
