...
._crit_edge:                                      ; preds = %._crit_edge, %3
  %indvars.iv43 = phi i64 [ 0, %3 ], [ %indvars.iv.next5.1, %._crit_edge ]
  %4 = trunc i64 %indvars.iv43 to i32
  %5 = srem i32 %4, 1900
  %6 = sitofp i32 %5 to double
  %7 = getelementptr inbounds double, double* %2, i64 %indvars.iv43
  ...
  %indvars.iv.next5.1 = add nsw i64 %indvars.iv43, 2
  %exitcond5.1 = icmp eq i64 %indvars.iv.next5.1, 1900
  br i1 %exitcond5.1, label %.preheader.preheader, label %._crit_edge

.preheader.preheader:                             ; preds = %._crit_edge
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %34
  %indvars.iv22 = phi i64 [ %indvars.iv.next3, %34 ], [ 0, %.preheader.preheader ]
  %16 = trunc i64 %indvars.iv22 to i32
  %17 = srem i32 %16, 2100
  %18 = sitofp i32 %17 to double
  %19 = fdiv double %18, 2.100000e+03
  %20 = getelementptr inbounds double, double* %1, i64 %indvars.iv22
  store double %19, double* %20, align 8
  br label %._crit_edge8

._crit_edge8:                                     ; preds = %._crit_edge8, %.preheader
  %indvars.iv1 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %._crit_edge8 ]
  %indvars.iv.next = or i64 %indvars.iv1, 1
  %21 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv22
  %22 = trunc i64 %21 to i32
  %23 = srem i32 %22, 2100
  %24 = sitofp i32 %23 to double
  %25 = getelementptr inbounds [1900 x double], [1900 x double]* %0, i64 %indvars.iv22, i64 %indvars.iv1
  %indvars.iv.next.1 = add nsw i64 %indvars.iv1, 2
  %26 = mul nuw nsw i64 %indvars.iv.next.1, %indvars.iv22
...
.preheader:                                       ; preds = %20, %.preheader.preheader
  %indvars.iv22 = phi i64 [ 0, %.preheader.preheader ], [ %indvars.iv.next3, %20 ]
...
._crit_edge:                                      ; preds = %._crit_edge, %.preheader
  ...
  %7 = getelementptr inbounds double, double* %1, i64 %indvars.iv1
  %8 = load double, double* %7, align 8
  %sunkaddr = ptrtoint double* %4 to i64
  %sunkaddr6 = mul i64 %indvars.iv22, 8
  %sunkaddr7 = add i64 %sunkaddr, %sunkaddr6
  %sunkaddr8 = inttoptr i64 %sunkaddr7 to double*
  %9 = load double, double* %sunkaddr8, align 8
  %10 = getelementptr inbounds [1900 x double], [1900 x double]* %0, i64 %indvars.iv22, i64 %indvars.iv1
  %11 = load double, double* %10, align 8
  %12 = fmul double %9, %11
  %13 = fadd double %8, %12
  store double %13, double* %7, align 8
  %sunkaddr9 = ptrtoint double* %2 to i64
  %sunkaddr10 = mul i64 %indvars.iv22, 8
  %sunkaddr11 = add i64 %sunkaddr9, %sunkaddr10
  %sunkaddr12 = inttoptr i64 %sunkaddr11 to double*
  %14 = load double, double* %sunkaddr12, align 8
  %15 = load double, double* %10, align 8
  %16 = getelementptr inbounds double, double* %3, i64 %indvars.iv1
  %17 = load double, double* %16, align 8
  %18 = fmul double %15, %17
  %19 = fadd double %14, %18
  store double %19, double* %sunkaddr12, align 8
...
._crit_edge8:                                     ; preds = %._crit_edge, %2
  %indvars.iv13 = phi i64 [ 0, %2 ], [ %indvars.iv.next2, %._crit_edge ]
...
._crit_edge:                                      ; preds = %._crit_edge8, %10
  ...
  %13 = getelementptr inbounds double, double* %0, i64 %indvars.iv13
  ...
  %exitcond4 = icmp eq i64 %indvars.iv.next2, 1900
  br i1 %exitcond4, label %16, label %._crit_edge8
...
._crit_edge9:                                     ; preds = %._crit_edge6, %16
  %indvars.iv2 = phi i64 [ 0, %16 ], [ %indvars.iv.next, %._crit_edge6 ]
  %21 = trunc i64 %indvars.iv2 to i32
  %22 = srem i32 %21, 20
  %23 = icmp eq i32 %22, 0
  br i1 %23, label %24, label %._crit_edge6
...
._crit_edge6:                                     ; preds = %._crit_edge9, %24
  %26 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %27 = getelementptr inbounds double, double* %1, i64 %indvars.iv2
  ...
  br i1 %exitcond, label %30, label %._crit_edge9
