...
; <label>:355:                                    ; preds = %351
  ...
  %358 = call i8* @strchr(i8* %357, i32 93) #9
...
; <label>:413:                                    ; preds = %._crit_edge, %._crit_edge1, %402
...
; <label>:448:                                    ; preds = %438, %._crit_edge8, %418
...
; <label>:454:                                    ; preds = %._crit_edge2, %._crit_edge3, %._crit_edge4, %._crit_edge5, %._crit_edge6, %._crit_edge7, %402
...
; <label>:460:                                    ; preds = %402
  ...
  %462 = call i8* @strchr(i8* %461, i32 93) #9
...
define internal void @darray_init(%struct.darray_t*, i32, i32) #4 {
...
; Function Attrs: inlinehint nounwind uwtable
define internal i8* @darray_find(%struct.darray_t*, i32) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca %struct.darray_t*, align 8
  %5 = alloca i32, align 4
