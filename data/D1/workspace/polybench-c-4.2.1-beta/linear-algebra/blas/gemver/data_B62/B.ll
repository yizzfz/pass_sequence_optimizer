...
.lr.ph6.split:                                    ; preds = %.lr.ph6.split, %.lr.ph6.split.preheader
  ...
  br i1 %137, label %.lr.ph6.split, label %._crit_edge7.loopexit24
...
.preheader11.us.preheader:                        ; preds = %.preheader11.lr.ph
  ...
  %smax74 = select i1 %39, i64 %37, i64 1
  %40 = icmp sgt i64 %37, 1
  %smax76 = select i1 %40, i64 %37, i64 1
  %scevgep79 = getelementptr double, double* %33, i64 %smax76
  %scevgep81 = getelementptr double, double* %35, i64 %smax76
  %n.vec = and i64 %smax74, 9223372036854775804
  br label %.preheader11.us

.preheader11.us:                                  ; preds = %._crit_edge32.us, %.preheader11.us.preheader
  %indvar = phi i64 [ 0, %.preheader11.us.preheader ], [ %indvar.next, %._crit_edge32.us ]
  %indvars.iv61 = phi i64 [ %38, %.preheader11.us.preheader ], [ %indvars.iv.next62, %._crit_edge32.us ]
  %41 = icmp ult i64 %smax74, 4
  %42 = add nsw i64 %38, %indvar
  %scevgep = getelementptr [2000 x double], [2000 x double]* %31, i64 %42, i64 0
  %scevgep77 = getelementptr [2000 x double], [2000 x double]* %31, i64 %42, i64 %smax76
...
vector.memcheck:                                  ; preds = %min.iters.checked
  ...
  %bound1 = icmp ult double* %43, %scevgep77
  %found.conflict = and i1 %bound0, %bound1
  %bound084 = icmp ult double* %scevgep, %scevgep79
  %bound185 = icmp ult double* %33, %scevgep77
  %found.conflict86 = and i1 %bound084, %bound185
  %conflict.rdx = or i1 %found.conflict, %found.conflict86
  %bound089 = icmp ult double* %scevgep, %44
  %bound190 = icmp ult double* %44, %scevgep77
  %found.conflict91 = and i1 %bound089, %bound190
  %conflict.rdx92 = or i1 %conflict.rdx, %found.conflict91
  %bound093 = icmp ult double* %scevgep, %scevgep81
  %bound194 = icmp ult double* %35, %scevgep77
  %found.conflict95 = and i1 %bound093, %bound194
  %conflict.rdx96 = or i1 %conflict.rdx92, %found.conflict95
  br i1 %conflict.rdx96, label %._crit_edge.preheader, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %wide.load98 = load <2 x double>, <2 x double>* %49, align 8, !alias.scope !1, !noalias !4
  ...
  %wide.load100 = load <2 x double>, <2 x double>* %58, align 8, !alias.scope !10
  %59 = fmul <2 x double> %52, %wide.load99
  %60 = fmul <2 x double> %54, %wide.load100
  %61 = fadd <2 x double> %wide.load, %59
  %62 = fadd <2 x double> %wide.load98, %60
  ...
  %wide.load102 = load <2 x double>, <2 x double>* %71, align 8, !alias.scope !12
  %72 = fmul <2 x double> %65, %wide.load101
  %73 = fmul <2 x double> %67, %wide.load102
...
._crit_edge32.us:                                 ; preds = %._crit_edge32.us.loopexit, %middle.block
  ...
  br i1 %93, label %.preheader11.us, label %.preheader10.loopexit
...
.prol.preheader65:                                ; preds = %.preheader9.us
  ...
  %sunkaddr104 = shl i64 %indvars.iv55, 3
  %sunkaddr105 = add i64 %105, %sunkaddr104
  %sunkaddr106 = inttoptr i64 %sunkaddr105 to double*
  %106 = load double, double* %sunkaddr106, align 8
  ...
  store double %112, double* %sunkaddr106, align 8
...
.preheader9.us.new:                               ; preds = %.preheader9.us.new, %.preheader9.us.new.preheader
  ...
  store double %121, double* %sunkaddr121, align 8
  ...
  store double %128, double* %sunkaddr121, align 8
...
.prol.preheader:                                  ; preds = %.preheader.us
  ...
  %sunkaddr112 = shl i64 %indvars.iv48, 3
  %sunkaddr113 = add i64 %145, %sunkaddr112
  %sunkaddr114 = inttoptr i64 %sunkaddr113 to double*
  %146 = load double, double* %sunkaddr114, align 8
  ...
  store double %152, double* %sunkaddr114, align 8
...
.preheader.us.new:                                ; preds = %.preheader.us.new, %.preheader.us.new.preheader
  ...
  %sunkaddr122 = ptrtoint double* %138 to i64
  %sunkaddr123 = mul i64 %indvars.iv48, 8
  %sunkaddr124 = add i64 %sunkaddr122, %sunkaddr123
  %sunkaddr125 = inttoptr i64 %sunkaddr124 to double*
  %154 = load double, double* %sunkaddr125, align 8
  ...
  store double %161, double* %sunkaddr125, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  ...
  store double %168, double* %sunkaddr125, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
