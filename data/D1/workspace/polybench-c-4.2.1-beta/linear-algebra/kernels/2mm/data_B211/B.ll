...
._crit_edge7:                                     ; preds = %14, %6
  %indvars.iv22 = phi i64 [ 0, %6 ], [ %indvars.iv.next20, %14 ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge7
  %indvars.iv19 = phi i64 [ 0, %._crit_edge7 ], [ %indvars.iv.next17, %._crit_edge ]
...
; <label>:14:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond21, label %.preheader2.preheader, label %._crit_edge7
...
._crit_edge8:                                     ; preds = %._crit_edge8, %.preheader2
  %indvars.iv13 = phi i64 [ 0, %.preheader2 ], [ %indvars.iv.next11.1, %._crit_edge8 ]
  ...
  br i1 %exitcond12.1, label %28, label %._crit_edge8
...
._crit_edge9:                                     ; preds = %._crit_edge9, %.preheader1
  %indvars.iv7 = phi i64 [ 0, %.preheader1 ], [ %indvars.iv.next5, %._crit_edge9 ]
  ...
  br i1 %exitcond6, label %37, label %._crit_edge9
...
._crit_edge10:                                    ; preds = %._crit_edge10, %.preheader
  %indvars.iv1 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %._crit_edge10 ]
...
._crit_edge7:                                     ; preds = %25, %7
  %indvars.iv16 = phi i64 [ 0, %7 ], [ %indvars.iv.next14, %25 ]
  br label %._crit_edge6

._crit_edge6:                                     ; preds = %24, %._crit_edge7
  %indvars.iv13 = phi i64 [ 0, %._crit_edge7 ], [ %indvars.iv.next11, %24 ]
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge6
  %9 = phi double [ 0.000000e+00, %._crit_edge6 ], [ %23, %._crit_edge ]
  %indvars.iv10 = phi i64 [ 0, %._crit_edge6 ], [ %indvars.iv.next8.1, %._crit_edge ]
...
; <label>:24:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond12, label %25, label %._crit_edge6

; <label>:25:                                     ; preds = %24
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv16, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 800
  br i1 %exitcond15, label %.preheader.preheader, label %._crit_edge7

.preheader.preheader:                             ; preds = %25
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %49
  %indvars.iv7 = phi i64 [ %indvars.iv.next5, %49 ], [ 0, %.preheader.preheader ]
  br label %._crit_edge9

._crit_edge9:                                     ; preds = %48, %.preheader
  %indvars.iv4 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next2, %48 ]
...
._crit_edge8:                                     ; preds = %._crit_edge8, %._crit_edge9
  ...
  %indvars.iv1 = phi i64 [ 0, %._crit_edge9 ], [ %indvars.iv.next.2, %._crit_edge8 ]
...
; <label>:48:                                     ; preds = %._crit_edge8
  ...
  br i1 %exitcond3, label %49, label %._crit_edge9

; <label>:49:                                     ; preds = %48
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv7, 1
  %exitcond6 = icmp eq i64 %indvars.iv.next5, 800
  br i1 %exitcond6, label %50, label %.preheader
