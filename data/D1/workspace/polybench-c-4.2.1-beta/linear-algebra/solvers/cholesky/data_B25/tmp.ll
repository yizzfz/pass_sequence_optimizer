...
define internal fastcc void @init_array(i32, [2000 x double]* nocapture) unnamed_addr #0 {
  br i1 true, label %.preheader14.preheader.lr.ph, label %._crit_edge73.thread

._crit_edge73.thread:                             ; preds = %2
  %3 = tail call i8* @polybench_alloc_data(i64 4000000, i32 8) #3
  br label %._crit_edge
...
.preheader14.preheader:                           ; preds = %.preheader13._crit_edge, %.preheader14.preheader.lr.ph
  %indvars.iv4572 = phi i64 [ 1, %.preheader14.preheader.lr.ph ], [ %indvars.iv.next46, %.preheader13._crit_edge ]
  %indvars.iv4771 = phi i64 [ 0, %.preheader14.preheader.lr.ph ], [ %indvars.iv.next48, %.preheader13._crit_edge ]
  %4 = mul i64 %indvars.iv4771, 2001
  %5 = add i64 %4, 1
  %scevgep101 = getelementptr [2000 x double], [2000 x double]* %1, i64 0, i64 %5
  br label %.preheader14

.preheader13.preheader:                           ; preds = %.preheader14
  %6 = mul i64 %indvars.iv4771, -8
  %exitcond4468 = icmp eq i64 %indvars.iv4771, 1999
  br i1 %exitcond4468, label %.preheader13._crit_edge, label %.preheader13._crit_edge.loopexit

.preheader14:                                     ; preds = %.preheader14, %.preheader14.preheader
  %indvars.iv3366 = phi i64 [ 0, %.preheader14.preheader ], [ %indvars.iv.next34, %.preheader14 ]
  %7 = sub nsw i64 0, %indvars.iv3366
  %8 = trunc i64 %7 to i32
  %9 = srem i32 %8, 2000
  %10 = sitofp i32 %9 to double
  %11 = fdiv double %10, 2.000000e+03
  %12 = fadd double %11, 1.000000e+00
  %13 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv4771, i64 %indvars.iv3366
  store double %12, double* %13, align 8
  %indvars.iv.next34 = add nuw nsw i64 %indvars.iv3366, 1
  %exitcond38 = icmp eq i64 %indvars.iv.next34, %indvars.iv4572
...
.preheader13._crit_edge.loopexit:                 ; preds = %.preheader13.preheader
  ...
  call void @llvm.memset.p0i8.i64(i8* nonnull %scevgep101102, i8 0, i64 %14, i32 8, i1 false)
  br label %.preheader13._crit_edge

.preheader13._crit_edge:                          ; preds = %.preheader13.preheader, %.preheader13._crit_edge.loopexit
  %15 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv4771, i64 %indvars.iv4771
  store double 1.000000e+00, double* %15, align 8
  %indvars.iv.next48 = add nuw nsw i64 %indvars.iv4771, 1
  %exitcond99 = icmp eq i64 %indvars.iv.next48, 2000
  %indvars.iv.next46 = add nuw nsw i64 %indvars.iv4572, 1
  br i1 %exitcond99, label %._crit_edge73, label %.preheader14.preheader

._crit_edge73:                                    ; preds = %.preheader13._crit_edge
...
.preheader12._crit_edge.prol.preheader:           ; preds = %._crit_edge73
...
.preheader12._crit_edge.prol:                     ; preds = %.preheader12._crit_edge.prol, %.preheader12._crit_edge.prol.preheader
  %indvars.iv3164.prol = phi i64 [ 0, %.preheader12._crit_edge.prol.preheader ], [ %indvars.iv.next32.prol, %.preheader12._crit_edge.prol ]
  %prol.iter155 = phi i64 [ 0, %.preheader12._crit_edge.prol.preheader ], [ %prol.iter155.sub, %.preheader12._crit_edge.prol ]
  %18 = mul nuw nsw i64 %indvars.iv3164.prol, 16000
  %scevgep.prol = getelementptr i8, i8* %16, i64 %18
  call void @llvm.memset.p0i8.i64(i8* %scevgep.prol, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next32.prol = add nuw nsw i64 %indvars.iv3164.prol, 1
  %prol.iter155.sub = add nsw i64 %prol.iter155, -1
  %prol.iter155.cmp = icmp eq i64 %prol.iter155.sub, 0
  br i1 %prol.iter155.cmp, label %.preheader12._crit_edge.prol.loopexit.unr-lcssa, label %.preheader12._crit_edge.prol, !llvm.loop !1
...
.preheader12._crit_edge.prol.loopexit:            ; preds = %._crit_edge73, %.preheader12._crit_edge.prol.loopexit.unr-lcssa
  br i1 false, label %.preheader10.preheader.preheader, label %._crit_edge73.new

._crit_edge73.new:                                ; preds = %.preheader12._crit_edge.prol.loopexit
...
.preheader12._crit_edge:                          ; preds = %.preheader12._crit_edge, %._crit_edge73.new
  %indvars.iv3164 = phi i64 [ 0, %._crit_edge73.new ], [ %indvars.iv.next32.7, %.preheader12._crit_edge ]
  %19 = mul nuw nsw i64 %indvars.iv3164, 16000
  %scevgep = getelementptr i8, i8* %16, i64 %19
  call void @llvm.memset.p0i8.i64(i8* %scevgep, i8 0, i64 16000, i32 8, i1 false)
  %20 = mul i64 %indvars.iv3164, 16000
  %21 = add i64 %20, 16000
  %scevgep.1 = getelementptr i8, i8* %16, i64 %21
  call void @llvm.memset.p0i8.i64(i8* %scevgep.1, i8 0, i64 16000, i32 8, i1 false)
  %22 = mul i64 %indvars.iv3164, 16000
  %23 = add i64 %22, 32000
  %scevgep.2 = getelementptr i8, i8* %16, i64 %23
  call void @llvm.memset.p0i8.i64(i8* %scevgep.2, i8 0, i64 16000, i32 8, i1 false)
  %24 = mul i64 %indvars.iv3164, 16000
  %25 = add i64 %24, 48000
  %scevgep.3 = getelementptr i8, i8* %16, i64 %25
  call void @llvm.memset.p0i8.i64(i8* %scevgep.3, i8 0, i64 16000, i32 8, i1 false)
  %26 = mul i64 %indvars.iv3164, 16000
  %27 = add i64 %26, 64000
  %scevgep.4 = getelementptr i8, i8* %16, i64 %27
  call void @llvm.memset.p0i8.i64(i8* %scevgep.4, i8 0, i64 16000, i32 8, i1 false)
  %28 = mul i64 %indvars.iv3164, 16000
  %29 = add i64 %28, 80000
  %scevgep.5 = getelementptr i8, i8* %16, i64 %29
  call void @llvm.memset.p0i8.i64(i8* %scevgep.5, i8 0, i64 16000, i32 8, i1 false)
  %30 = mul i64 %indvars.iv3164, 16000
  %31 = add i64 %30, 96000
  %scevgep.6 = getelementptr i8, i8* %16, i64 %31
  call void @llvm.memset.p0i8.i64(i8* %scevgep.6, i8 0, i64 16000, i32 8, i1 false)
  %32 = mul i64 %indvars.iv3164, 16000
  %33 = add i64 %32, 112000
  %scevgep.7 = getelementptr i8, i8* %16, i64 %33
  call void @llvm.memset.p0i8.i64(i8* %scevgep.7, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next32.7 = add nsw i64 %indvars.iv3164, 8
  %exitcond98.7 = icmp eq i64 %indvars.iv.next32.7, 2000
  br i1 %exitcond98.7, label %.preheader10.preheader.preheader.unr-lcssa, label %.preheader12._crit_edge
...
.preheader9.preheader.preheader:                  ; preds = %.preheader10._crit_edge, %.preheader10.preheader.preheader
  ...
  %scevgep108 = getelementptr [2000 x double], [2000 x double]* %1, i64 0, i64 %indvars.iv2559
  %scevgep108109 = bitcast double* %scevgep108 to i8*
  %34 = add nsw i64 %indvars.iv2559, -1999
  %scevgep110 = getelementptr [2000 x double], [2000 x double]* %1, i64 2000, i64 %34
...
.preheader9.preheader:                            ; preds = %.preheader10, %.preheader9.preheader.preheader
  ...
  %scevgep106 = getelementptr i8, i8* %16, i64 %35
  %36 = add i64 16000, %35
  %scevgep107 = getelementptr i8, i8* %16, i64 %36
  %37 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv2157, i64 %indvars.iv2559
  br i1 false, label %.preheader9.preheader150, label %min.iters.checked

min.iters.checked:                                ; preds = %.preheader9.preheader
  br i1 false, label %.preheader9.preheader150, label %vector.memcheck
...
vector.memcheck:                                  ; preds = %min.iters.checked
  ...
  %bc112 = bitcast double* %37 to i8*
  %bound0113 = icmp ult i8* %scevgep106, %bc112
  ...
  br i1 %conflict.rdx, label %.preheader9.preheader150, label %vector.body.preheader

vector.body.preheader:                            ; preds = %vector.memcheck
  %38 = load double, double* %37, align 8, !alias.scope !3
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %47 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %43, i64 %indvars.iv2559
  %48 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %44, i64 %indvars.iv2559
  %49 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %45, i64 %indvars.iv2559
  ...
  %58 = fmul <2 x double> %40, %55
  %59 = fmul <2 x double> %42, %57
  %60 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %17, i64 0, i64 %indvars.iv2157, i64 %index
  ...
  %wide.load117 = load <2 x double>, <2 x double>* %63, align 8, !alias.scope !8, !noalias !10
  %64 = fadd <2 x double> %wide.load, %58
  %65 = fadd <2 x double> %wide.load117, %59
...
middle.block:                                     ; preds = %vector.body
  br i1 true, label %.preheader10, label %.preheader9.preheader150

.preheader9.preheader150:                         ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.preheader9.preheader
...
.preheader9.prol.preheader:                       ; preds = %.preheader9.preheader150
...
.preheader9.prol:                                 ; preds = %.preheader9.prol.preheader
  ...
  %73 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %17, i64 0, i64 %indvars.iv2157, i64 %indvars.iv1754.ph
...
.preheader9.prol.loopexit.unr-lcssa:              ; preds = %.preheader9.preheader150, %.preheader9.prol
  %indvars.iv1754.unr.ph = phi i64 [ %indvars.iv.next18.prol, %.preheader9.prol ], [ %indvars.iv1754.ph, %.preheader9.preheader150 ]
  br label %.preheader9.prol.loopexit

.preheader9.prol.loopexit:                        ; preds = %.preheader9.prol.loopexit.unr-lcssa
  br i1 false, label %.preheader10.loopexit, label %.preheader9.preheader150.new

.preheader9.preheader150.new:                     ; preds = %.preheader9.prol.loopexit
  br label %.preheader9

.preheader9:                                      ; preds = %.preheader9, %.preheader9.preheader150.new
  %indvars.iv1754 = phi i64 [ %indvars.iv1754.unr.ph, %.preheader9.preheader150.new ], [ %indvars.iv.next18.1, %.preheader9 ]
  ...
  %80 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %17, i64 0, i64 %indvars.iv2157, i64 %indvars.iv1754
  ...
  %87 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %17, i64 0, i64 %indvars.iv2157, i64 %indvars.iv.next18
...
.preheader.preheader:                             ; preds = %.preheader._crit_edge, %.preheader.preheader.preheader
  ...
  %scevgep127 = getelementptr [2000 x double], [2000 x double]* %1, i64 %indvars.iv1551, i64 0
  %scevgep127128 = bitcast double* %scevgep127 to i8*
  %scevgep129 = getelementptr [2000 x double], [2000 x double]* %1, i64 %indvars.iv1551, i64 2000
  %scevgep129130 = bitcast double* %scevgep129 to i8*
  %90 = mul nuw nsw i64 %indvars.iv1551, 16000
  %scevgep131 = getelementptr i8, i8* %16, i64 %90
  %91 = add i64 16000, %90
  %scevgep132 = getelementptr i8, i8* %16, i64 %91
  br i1 false, label %.preheader.preheader149, label %min.iters.checked122

min.iters.checked122:                             ; preds = %.preheader.preheader
  br i1 false, label %.preheader.preheader149, label %vector.memcheck137

vector.memcheck137:                               ; preds = %min.iters.checked122
  %bound0133 = icmp ult i8* %scevgep127128, %scevgep132
  %bound1134 = icmp ult i8* %scevgep131, %scevgep129130
  %memcheck.conflict136 = and i1 %bound0133, %bound1134
  br i1 %memcheck.conflict136, label %.preheader.preheader149, label %vector.body118.preheader

vector.body118.preheader:                         ; preds = %vector.memcheck137
  br label %vector.body118

vector.body118:                                   ; preds = %vector.body118.preheader, %vector.body118
  %index139 = phi i64 [ %index.next140, %vector.body118 ], [ 0, %vector.body118.preheader ]
  %92 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %17, i64 0, i64 %indvars.iv1551, i64 %index139
  %93 = bitcast double* %92 to <2 x i64>*
  %wide.load147 = load <2 x i64>, <2 x i64>* %93, align 8, !alias.scope !15
  %94 = getelementptr double, double* %92, i64 2
  %95 = bitcast double* %94 to <2 x i64>*
  %wide.load148 = load <2 x i64>, <2 x i64>* %95, align 8, !alias.scope !15
  %96 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv1551, i64 %index139
  %97 = bitcast double* %96 to <2 x i64>*
  store <2 x i64> %wide.load147, <2 x i64>* %97, align 8, !alias.scope !18, !noalias !15
  %98 = getelementptr double, double* %96, i64 2
  %99 = bitcast double* %98 to <2 x i64>*
  store <2 x i64> %wide.load148, <2 x i64>* %99, align 8, !alias.scope !18, !noalias !15
  %index.next140 = add i64 %index139, 4
  %100 = icmp eq i64 %index.next140, 2000
  br i1 %100, label %middle.block119, label %vector.body118, !llvm.loop !20

middle.block119:                                  ; preds = %vector.body118
  br i1 true, label %.preheader._crit_edge, label %.preheader.preheader149

.preheader.preheader149:                          ; preds = %middle.block119, %vector.memcheck137, %min.iters.checked122, %.preheader.preheader
  %indvars.iv50.ph = phi i64 [ 0, %vector.memcheck137 ], [ 0, %min.iters.checked122 ], [ 0, %.preheader.preheader ], [ 2000, %middle.block119 ]
  %101 = sub nsw i64 1999, %indvars.iv50.ph
  br i1 true, label %.preheader.prol.loopexit, label %.preheader.prol.preheader

.preheader.prol.preheader:                        ; preds = %.preheader.preheader149
...
.preheader.prol:                                  ; preds = %.preheader.prol, %.preheader.prol.preheader
  ...
  %102 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %17, i64 0, i64 %indvars.iv1551, i64 %indvars.iv50.prol
...
.preheader.prol.loopexit:                         ; preds = %.preheader.preheader149, %.preheader.prol.loopexit.unr-lcssa
  %107 = icmp ult i64 %101, 3
  br i1 %107, label %.preheader._crit_edge.loopexit, label %.preheader.preheader149.new

.preheader.preheader149.new:                      ; preds = %.preheader.prol.loopexit
  br label %.preheader

.preheader:                                       ; preds = %.preheader, %.preheader.preheader149.new
  %indvars.iv50 = phi i64 [ %indvars.iv50.ph, %.preheader.preheader149.new ], [ %indvars.iv.next.3, %.preheader ]
  %108 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %17, i64 0, i64 %indvars.iv1551, i64 %indvars.iv50
  ...
  %113 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %17, i64 0, i64 %indvars.iv1551, i64 %indvars.iv.next
  ...
  %118 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %17, i64 0, i64 %indvars.iv1551, i64 %indvars.iv.next.1
  ...
  %123 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %17, i64 0, i64 %indvars.iv1551, i64 %indvars.iv.next.2
...
.preheader._crit_edge:                            ; preds = %.preheader._crit_edge.loopexit, %middle.block119
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv1551, 1
  %exitcond94 = icmp eq i64 %indvars.iv.next16, 2000
  br i1 %exitcond94, label %._crit_edge.loopexit, label %.preheader.preheader

._crit_edge.loopexit:                             ; preds = %.preheader._crit_edge
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %._crit_edge73.thread
  %128 = phi i8* [ %3, %._crit_edge73.thread ], [ %16, %._crit_edge.loopexit ]
...
.preheader3:                                      ; preds = %.preheader3, %.lr.ph26.new
  ...
  %indvars.iv.next14.3 = add nsw i64 %indvars.iv1325, 4
