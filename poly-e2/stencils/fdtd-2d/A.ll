...
entry:
  ...
  store i32 500, i32* %tmax, align 4
  store i32 1000, i32* %nx, align 4
  store i32 1200, i32* %ny, align 4
  %call = call i8* @polybench_alloc_data(i64 1200000, i32 8)
  %0 = bitcast i8* %call to [1000 x [1200 x double]]*
  store [1000 x [1200 x double]]* %0, [1000 x [1200 x double]]** %ex, align 8
  %call1 = call i8* @polybench_alloc_data(i64 1200000, i32 8)
  %1 = bitcast i8* %call1 to [1000 x [1200 x double]]*
  store [1000 x [1200 x double]]* %1, [1000 x [1200 x double]]** %ey, align 8
  %call2 = call i8* @polybench_alloc_data(i64 1200000, i32 8)
  %2 = bitcast i8* %call2 to [1000 x [1200 x double]]*
  store [1000 x [1200 x double]]* %2, [1000 x [1200 x double]]** %hz, align 8
  %call3 = call i8* @polybench_alloc_data(i64 500, i32 8)
  %3 = bitcast i8* %call3 to [500 x double]*
  store [500 x double]* %3, [500 x double]** %_fict_, align 8
  %4 = load i32, i32* %tmax, align 4
  %5 = load i32, i32* %nx, align 4
  %6 = load i32, i32* %ny, align 4
  %7 = load [1000 x [1200 x double]]*, [1000 x [1200 x double]]** %ex, align 8
  %arraydecay = getelementptr inbounds [1000 x [1200 x double]], [1000 x [1200 x double]]* %7, i32 0, i32 0
  %8 = load [1000 x [1200 x double]]*, [1000 x [1200 x double]]** %ey, align 8
  %arraydecay4 = getelementptr inbounds [1000 x [1200 x double]], [1000 x [1200 x double]]* %8, i32 0, i32 0
  %9 = load [1000 x [1200 x double]]*, [1000 x [1200 x double]]** %hz, align 8
  %arraydecay5 = getelementptr inbounds [1000 x [1200 x double]], [1000 x [1200 x double]]* %9, i32 0, i32 0
  %10 = load [500 x double]*, [500 x double]** %_fict_, align 8
  %arraydecay6 = getelementptr inbounds [500 x double], [500 x double]* %10, i32 0, i32 0
  call void @init_array(i32 %4, i32 %5, i32 %6, [1200 x double]* %arraydecay, [1200 x double]* %arraydecay4, [1200 x double]* %arraydecay5, double* %arraydecay6)
  call void (...) @polybench_timer_start()
  %11 = load i32, i32* %tmax, align 4
  %12 = load i32, i32* %nx, align 4
  %13 = load i32, i32* %ny, align 4
  %14 = load [1000 x [1200 x double]]*, [1000 x [1200 x double]]** %ex, align 8
  %arraydecay7 = getelementptr inbounds [1000 x [1200 x double]], [1000 x [1200 x double]]* %14, i32 0, i32 0
  %15 = load [1000 x [1200 x double]]*, [1000 x [1200 x double]]** %ey, align 8
  %arraydecay8 = getelementptr inbounds [1000 x [1200 x double]], [1000 x [1200 x double]]* %15, i32 0, i32 0
  %16 = load [1000 x [1200 x double]]*, [1000 x [1200 x double]]** %hz, align 8
  %arraydecay9 = getelementptr inbounds [1000 x [1200 x double]], [1000 x [1200 x double]]* %16, i32 0, i32 0
  %17 = load [500 x double]*, [500 x double]** %_fict_, align 8
  %arraydecay10 = getelementptr inbounds [500 x double], [500 x double]* %17, i32 0, i32 0
  call void @kernel_fdtd_2d(i32 %11, i32 %12, i32 %13, [1200 x double]* %arraydecay7, [1200 x double]* %arraydecay8, [1200 x double]* %arraydecay9, double* %arraydecay10)
...
land.lhs.true:                                    ; preds = %entry
  ...
  %call11 = call i32 @strcmp(i8* %20, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i32 0, i32 0)) #4
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %23 = load [1000 x [1200 x double]]*, [1000 x [1200 x double]]** %ex, align 8
  %arraydecay12 = getelementptr inbounds [1000 x [1200 x double]], [1000 x [1200 x double]]* %23, i32 0, i32 0
  %24 = load [1000 x [1200 x double]]*, [1000 x [1200 x double]]** %ey, align 8
  %arraydecay13 = getelementptr inbounds [1000 x [1200 x double]], [1000 x [1200 x double]]* %24, i32 0, i32 0
  %25 = load [1000 x [1200 x double]]*, [1000 x [1200 x double]]** %hz, align 8
  %arraydecay14 = getelementptr inbounds [1000 x [1200 x double]], [1000 x [1200 x double]]* %25, i32 0, i32 0
  call void @print_array(i32 %21, i32 %22, [1200 x double]* %arraydecay12, [1200 x double]* %arraydecay13, [1200 x double]* %arraydecay14)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  %26 = load [1000 x [1200 x double]]*, [1000 x [1200 x double]]** %ex, align 8
  %27 = bitcast [1000 x [1200 x double]]* %26 to i8*
  call void @free(i8* %27) #5
  %28 = load [1000 x [1200 x double]]*, [1000 x [1200 x double]]** %ey, align 8
  %29 = bitcast [1000 x [1200 x double]]* %28 to i8*
  call void @free(i8* %29) #5
  %30 = load [1000 x [1200 x double]]*, [1000 x [1200 x double]]** %hz, align 8
  %31 = bitcast [1000 x [1200 x double]]* %30 to i8*
  call void @free(i8* %31) #5
  %32 = load [500 x double]*, [500 x double]** %_fict_, align 8
  %33 = bitcast [500 x double]* %32 to i8*
...
entry:
  ...
  store [1200 x double]* %ex, [1200 x double]** %ex.addr, align 8
  store [1200 x double]* %ey, [1200 x double]** %ey.addr, align 8
  store [1200 x double]* %hz, [1200 x double]** %hz.addr, align 8
...
for.body8:                                        ; preds = %for.cond5
  ...
  %13 = load [1200 x double]*, [1200 x double]** %ex.addr, align 8
  %14 = load i32, i32* %i, align 4
  %idxprom12 = sext i32 %14 to i64
  %arrayidx13 = getelementptr inbounds [1200 x double], [1200 x double]* %13, i64 %idxprom12
  ...
  %19 = load [1200 x double]*, [1200 x double]** %ey.addr, align 8
  %20 = load i32, i32* %i, align 4
  %idxprom22 = sext i32 %20 to i64
  %arrayidx23 = getelementptr inbounds [1200 x double], [1200 x double]* %19, i64 %idxprom22
  ...
  %25 = load [1200 x double]*, [1200 x double]** %hz.addr, align 8
  %26 = load i32, i32* %i, align 4
  %idxprom32 = sext i32 %26 to i64
  %arrayidx33 = getelementptr inbounds [1200 x double], [1200 x double]* %25, i64 %idxprom32
...
for.body3:                                        ; preds = %for.cond1
  ...
  %7 = load [1200 x double]*, [1200 x double]** %ey.addr, align 8
  %arrayidx4 = getelementptr inbounds [1200 x double], [1200 x double]* %7, i64 0
  %8 = load i32, i32* %j, align 4
...
for.body12:                                       ; preds = %for.cond10
  %14 = load [1200 x double]*, [1200 x double]** %ey.addr, align 8
  %15 = load i32, i32* %i, align 4
  %idxprom13 = sext i32 %15 to i64
  %arrayidx14 = getelementptr inbounds [1200 x double], [1200 x double]* %14, i64 %idxprom13
  ...
  %18 = load [1200 x double]*, [1200 x double]** %hz.addr, align 8
  %19 = load i32, i32* %i, align 4
  %idxprom17 = sext i32 %19 to i64
  %arrayidx18 = getelementptr inbounds [1200 x double], [1200 x double]* %18, i64 %idxprom17
  ...
  %22 = load [1200 x double]*, [1200 x double]** %hz.addr, align 8
  %23 = load i32, i32* %i, align 4
  %sub = sub nsw i32 %23, 1
  %idxprom21 = sext i32 %sub to i64
  %arrayidx22 = getelementptr inbounds [1200 x double], [1200 x double]* %22, i64 %idxprom21
  ...
  %26 = load [1200 x double]*, [1200 x double]** %ey.addr, align 8
  %27 = load i32, i32* %i, align 4
  %idxprom27 = sext i32 %27 to i64
  %arrayidx28 = getelementptr inbounds [1200 x double], [1200 x double]* %26, i64 %idxprom27
  %28 = load i32, i32* %j, align 4
...
for.body42:                                       ; preds = %for.cond40
  %35 = load [1200 x double]*, [1200 x double]** %ex.addr, align 8
  %36 = load i32, i32* %i, align 4
  %idxprom43 = sext i32 %36 to i64
  %arrayidx44 = getelementptr inbounds [1200 x double], [1200 x double]* %35, i64 %idxprom43
  ...
  %39 = load [1200 x double]*, [1200 x double]** %hz.addr, align 8
  %40 = load i32, i32* %i, align 4
  %idxprom47 = sext i32 %40 to i64
  %arrayidx48 = getelementptr inbounds [1200 x double], [1200 x double]* %39, i64 %idxprom47
  ...
  %43 = load [1200 x double]*, [1200 x double]** %hz.addr, align 8
  %44 = load i32, i32* %i, align 4
  %idxprom51 = sext i32 %44 to i64
  %arrayidx52 = getelementptr inbounds [1200 x double], [1200 x double]* %43, i64 %idxprom51
  ...
  %47 = load [1200 x double]*, [1200 x double]** %ex.addr, align 8
  %48 = load i32, i32* %i, align 4
  %idxprom59 = sext i32 %48 to i64
  %arrayidx60 = getelementptr inbounds [1200 x double], [1200 x double]* %47, i64 %idxprom59
...
for.body76:                                       ; preds = %for.cond73
  %56 = load [1200 x double]*, [1200 x double]** %hz.addr, align 8
  %57 = load i32, i32* %i, align 4
  %idxprom77 = sext i32 %57 to i64
  %arrayidx78 = getelementptr inbounds [1200 x double], [1200 x double]* %56, i64 %idxprom77
  ...
  %60 = load [1200 x double]*, [1200 x double]** %ex.addr, align 8
  %61 = load i32, i32* %i, align 4
  %idxprom81 = sext i32 %61 to i64
  %arrayidx82 = getelementptr inbounds [1200 x double], [1200 x double]* %60, i64 %idxprom81
  ...
  %64 = load [1200 x double]*, [1200 x double]** %ex.addr, align 8
  %65 = load i32, i32* %i, align 4
  %idxprom85 = sext i32 %65 to i64
  %arrayidx86 = getelementptr inbounds [1200 x double], [1200 x double]* %64, i64 %idxprom85
  ...
  %68 = load [1200 x double]*, [1200 x double]** %ey.addr, align 8
  %69 = load i32, i32* %i, align 4
  %add90 = add nsw i32 %69, 1
  %idxprom91 = sext i32 %add90 to i64
  %arrayidx92 = getelementptr inbounds [1200 x double], [1200 x double]* %68, i64 %idxprom91
  ...
  %72 = load [1200 x double]*, [1200 x double]** %ey.addr, align 8
  %73 = load i32, i32* %i, align 4
  %idxprom96 = sext i32 %73 to i64
  %arrayidx97 = getelementptr inbounds [1200 x double], [1200 x double]* %72, i64 %idxprom96
  ...
  %76 = load [1200 x double]*, [1200 x double]** %hz.addr, align 8
  %77 = load i32, i32* %i, align 4
  %idxprom103 = sext i32 %77 to i64
  %arrayidx104 = getelementptr inbounds [1200 x double], [1200 x double]* %76, i64 %idxprom103
...
entry:
  ...
  %call1 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %for.cond
...
if.end:                                           ; preds = %if.then, %for.body4
  ...
  %11 = load [1200 x double]*, [1200 x double]** %ex.addr, align 8
...
for.end12:                                        ; preds = %for.cond
  ...
  %call13 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %17, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0))
  ...
  %call15 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %19, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %for.cond16
...
if.then26:                                        ; preds = %for.body21
  ...
  %call27 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %27, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  br label %if.end28

if.end28:                                         ; preds = %if.then26, %for.body21
  %28 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %29 = load [1200 x double]*, [1200 x double]** %ey.addr, align 8
  %30 = load i32, i32* %i, align 4
  %idxprom29 = sext i32 %30 to i64
  %arrayidx30 = getelementptr inbounds [1200 x double], [1200 x double]* %29, i64 %idxprom29
  ...
  %call33 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %28, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i32 0, i32 0), double %32)
  br label %for.inc34
...
for.end39:                                        ; preds = %for.cond16
  ...
  %call40 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %35, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8, i32 0, i32 0))
  %36 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %call41 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %36, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.9, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %for.cond42
...
if.then52:                                        ; preds = %for.body47
  ...
  %call53 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %44, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  br label %if.end54

if.end54:                                         ; preds = %if.then52, %for.body47
  %45 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %46 = load [1200 x double]*, [1200 x double]** %hz.addr, align 8
  %47 = load i32, i32* %i, align 4
  %idxprom55 = sext i32 %47 to i64
  %arrayidx56 = getelementptr inbounds [1200 x double], [1200 x double]* %46, i64 %idxprom55
  ...
  %call59 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %45, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i32 0, i32 0), double %49)
  br label %for.inc60
...
for.end65:                                        ; preds = %for.cond42
  ...
  %call66 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %52, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.9, i32 0, i32 0))
  ret void
}
