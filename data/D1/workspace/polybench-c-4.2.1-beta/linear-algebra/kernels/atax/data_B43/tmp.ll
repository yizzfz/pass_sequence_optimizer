...
.lr.ph5:                                          ; preds = %.lr.ph5, %.lr.ph5.preheader
  ...
  %15 = getelementptr inbounds double, double* %1, i64 %indvars.iv.next13.1
  %16 = trunc i64 %indvars.iv.next13.1 to i32
  %17 = or i32 %16, 1
...
.lr.ph5.split.us.new:                             ; preds = %.lr.ph5.split.us.new, %.lr.ph5.split.us
  ...
  %sunkaddr1 = mul i64 %indvars.iv24, 8
...
.lr.ph2.us.new:                                   ; preds = %.lr.ph2.us.new.preheader, %.lr.ph2.us.new
  %indvars.iv15 = phi i64 [ %indvars.iv.next16.1, %.lr.ph2.us.new ], [ 0, %.lr.ph2.us.new.preheader ]
  %19 = getelementptr inbounds double, double* %2, i64 %indvars.iv15
  %20 = load double, double* %19, align 8
  %21 = getelementptr inbounds [2100 x double], [2100 x double]* %0, i64 %indvars.iv24, i64 %indvars.iv15
  ...
  %23 = load double, double* %sunkaddr7, align 8
  ...
  %30 = load double, double* %sunkaddr7, align 8
  ...
  br i1 %exitcond.123, label %._crit_edge3.us, label %.lr.ph2.us.new
