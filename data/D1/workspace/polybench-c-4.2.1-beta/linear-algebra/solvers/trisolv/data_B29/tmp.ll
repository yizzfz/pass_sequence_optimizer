...
.lr.ph:                                           ; preds = %3, %._crit_edge
  %indvars.iv5 = phi i64 [ 0, %3 ], [ %indvars.iv.next6, %._crit_edge ]
  %indvars.iv3 = phi i64 [ 1, %3 ], [ %indvars.iv.next4, %._crit_edge ]
...
; <label>:4:                                      ; preds = %._crit_edge, %3
  ...
  %5 = add nuw nsw i64 %indvars.iv16, 4294967295
...
; <label>:7:                                      ; preds = %17, %1
  ...
  %8 = phi %struct._IO_FILE* [ %6, %1 ], [ %18, %17 ]
