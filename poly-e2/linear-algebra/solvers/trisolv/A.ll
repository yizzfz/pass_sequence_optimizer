...
entry:
  ...
  store [2000 x [2000 x double]]* %0, [2000 x [2000 x double]]** %L, align 8
  %call1 = call i8* @polybench_alloc_data(i64 2000, i32 8)
  %1 = bitcast i8* %call1 to [2000 x double]*
  store [2000 x double]* %1, [2000 x double]** %x, align 8
  %call2 = call i8* @polybench_alloc_data(i64 2000, i32 8)
  %2 = bitcast i8* %call2 to [2000 x double]*
  store [2000 x double]* %2, [2000 x double]** %b, align 8
  %3 = load i32, i32* %n, align 4
  %4 = load [2000 x [2000 x double]]*, [2000 x [2000 x double]]** %L, align 8
  %arraydecay = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %4, i32 0, i32 0
  %5 = load [2000 x double]*, [2000 x double]** %x, align 8
  %arraydecay3 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i32 0, i32 0
  %6 = load [2000 x double]*, [2000 x double]** %b, align 8
  %arraydecay4 = getelementptr inbounds [2000 x double], [2000 x double]* %6, i32 0, i32 0
  call void @init_array(i32 %3, [2000 x double]* %arraydecay, double* %arraydecay3, double* %arraydecay4)
  call void (...) @polybench_timer_start()
  %7 = load i32, i32* %n, align 4
  %8 = load [2000 x [2000 x double]]*, [2000 x [2000 x double]]** %L, align 8
  %arraydecay5 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %8, i32 0, i32 0
  %9 = load [2000 x double]*, [2000 x double]** %x, align 8
  %arraydecay6 = getelementptr inbounds [2000 x double], [2000 x double]* %9, i32 0, i32 0
  %10 = load [2000 x double]*, [2000 x double]** %b, align 8
  %arraydecay7 = getelementptr inbounds [2000 x double], [2000 x double]* %10, i32 0, i32 0
  call void @kernel_trisolv(i32 %7, [2000 x double]* %arraydecay5, double* %arraydecay6, double* %arraydecay7)
...
land.lhs.true:                                    ; preds = %entry
  ...
  %call8 = call i32 @strcmp(i8* %13, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i32 0, i32 0)) #4
  %tobool = icmp ne i32 %call8, 0
  br i1 %tobool, label %if.end, label %if.then

if.then:                                          ; preds = %land.lhs.true
  %14 = load i32, i32* %n, align 4
  %15 = load [2000 x double]*, [2000 x double]** %x, align 8
  %arraydecay9 = getelementptr inbounds [2000 x double], [2000 x double]* %15, i32 0, i32 0
  call void @print_array(i32 %14, double* %arraydecay9)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  %16 = load [2000 x [2000 x double]]*, [2000 x [2000 x double]]** %L, align 8
  %17 = bitcast [2000 x [2000 x double]]* %16 to i8*
  ...
  %20 = load [2000 x double]*, [2000 x double]** %b, align 8
...
for.body6:                                        ; preds = %for.cond3
  ...
  %13 = load [2000 x double]*, [2000 x double]** %L.addr, align 8
  %14 = load i32, i32* %i, align 4
  %idxprom10 = sext i32 %14 to i64
  %arrayidx11 = getelementptr inbounds [2000 x double], [2000 x double]* %13, i64 %idxprom10
  %15 = load i32, i32* %j, align 4
  %idxprom12 = sext i32 %15 to i64
  %arrayidx13 = getelementptr inbounds [2000 x double], [2000 x double]* %arrayidx11, i64 0, i64 %idxprom12
...
for.body5:                                        ; preds = %for.cond3
  %9 = load [2000 x double]*, [2000 x double]** %L.addr, align 8
  %10 = load i32, i32* %i, align 4
  %idxprom6 = sext i32 %10 to i64
  %arrayidx7 = getelementptr inbounds [2000 x double], [2000 x double]* %9, i64 %idxprom6
  %11 = load i32, i32* %j, align 4
  %idxprom8 = sext i32 %11 to i64
  %arrayidx9 = getelementptr inbounds [2000 x double], [2000 x double]* %arrayidx7, i64 0, i64 %idxprom8
...
for.end:                                          ; preds = %for.cond3
  ...
  %23 = load [2000 x double]*, [2000 x double]** %L.addr, align 8
  %24 = load i32, i32* %i, align 4
  %idxprom16 = sext i32 %24 to i64
  %arrayidx17 = getelementptr inbounds [2000 x double], [2000 x double]* %23, i64 %idxprom16
...
for.body:                                         ; preds = %for.cond
  ...
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i32 0, i32 0), double %7)
  %8 = load i32, i32* %i, align 4
  %rem = srem i32 %8, 20
...
if.then:                                          ; preds = %for.body
  ...
  %call4 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %9, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
  br label %if.end
