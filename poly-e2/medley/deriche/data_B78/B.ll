...
for.body33.us.for.body33.us_crit_edge.preheader:  ; preds = %for.cond31.preheader.us
  br i1 %lcmp.mod228, label %for.body33.us.for.body33.us_crit_edge.prol.loopexit, label %for.body33.us.for.body33.us_crit_edge.prol
...
for.body64.us.for.body64.us_crit_edge.preheader:  ; preds = %for.cond62.preheader.us
  br i1 %lcmp.mod226, label %for.body64.us.for.body64.us_crit_edge.prol, label %for.body64.us.for.body64.us_crit_edge.prol.loopexit
...
for.body64.us.for.body64.us_crit_edge.prol.loopexit: ; preds = %for.body64.us.for.body64.us_crit_edge.prol, %for.body64.us.for.body64.us_crit_edge.preheader
  ...
  br i1 %14, label %for.cond62.for.inc86_crit_edge.us, label %for.body64.us.for.body64.us_crit_edge.preheader.new
...
for.body120.us.for.body120.us_crit_edge.preheader: ; preds = %for.cond118.preheader.us
  br i1 %lcmp.mod220, label %for.body120.us.for.body120.us_crit_edge.prol.loopexit, label %for.body120.us.for.body120.us_crit_edge.prol
...
for.body156.us.for.body156.us_crit_edge.preheader: ; preds = %for.cond154.preheader.us
  br i1 %lcmp.mod218, label %for.body156.us.for.body156.us_crit_edge.prol, label %for.body156.us.for.body156.us_crit_edge.prol.loopexit
...
for.body156.us.for.body156.us_crit_edge.prol.loopexit: ; preds = %for.body156.us.for.body156.us_crit_edge.prol, %for.body156.us.for.body156.us_crit_edge.preheader
  ...
  %tp1.07.us109.unr.ph = phi float [ %90, %for.body156.us.for.body156.us_crit_edge.prol ], [ 0.000000e+00, %for.body156.us.for.body156.us_crit_edge.preheader ]
  ...
  br i1 %89, label %for.cond154.for.inc179_crit_edge.us, label %for.body156.us.for.body156.us_crit_edge.preheader.new
...
for.body156.us.for.body156.us_crit_edge:          ; preds = %for.body156.us.for.body156.us_crit_edge, %for.body156.us.for.body156.us_crit_edge.preheader.new
  ...
  %tp1.07.us109 = phi float [ %tp1.07.us109.unr.ph, %for.body156.us.for.body156.us_crit_edge.preheader.new ], [ %92, %for.body156.us.for.body156.us_crit_edge ]
...
for.cond182.preheader:                            ; preds = %for.cond182.preheader.loopexit, %for.cond115.preheader
  %cmp116198789 = phi i1 [ true, %for.cond115.preheader ], [ false, %for.cond182.preheader.loopexit ]
  %.not = icmp slt i32 %w, 1
  %brmerge = or i1 %.not, %cmp116198789
...
for.cond185.preheader.us.preheader:               ; preds = %for.cond182.preheader
  ...
  %95 = add nuw nsw i64 %wide.trip.count, 1
  %96 = and i64 %95, 8589934584
  %97 = add nsw i64 %96, -8
  %98 = lshr exact i64 %97, 3
  %99 = add nuw nsw i64 %wide.trip.count, 1
  %min.iters.check175 = icmp ult i64 %95, 8
  %n.vec178 = and i64 %95, 8589934584
  %cmp.zero179 = icmp eq i64 %n.vec178, 0
  %100 = and i64 %98, 1
  %lcmp.mod = icmp eq i64 %100, 0
  %101 = icmp eq i64 %98, 0
  %cmp.n206 = icmp eq i64 %95, %n.vec178
...
for.cond185.preheader.us:                         ; preds = %for.cond185.for.inc205_crit_edge.us, %for.cond185.preheader.us.preheader
  ...
  %scevgep183 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv47, i64 %95
  %scevgep185 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv47, i64 0
  %scevgep187 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv47, i64 %95
  %scevgep189 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 0
  %scevgep191 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 %95
...
vector.body172.prol:                              ; preds = %vector.body172.preheader
  %102 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv47, i64 0
  %103 = bitcast float* %102 to <4 x float>*
  %wide.load211.prol = load <4 x float>, <4 x float>* %103, align 4, !alias.scope !16
  %104 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv47, i64 4
  %105 = bitcast float* %104 to <4 x float>*
  %wide.load212.prol = load <4 x float>, <4 x float>* %105, align 4, !alias.scope !16
  %106 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 0
  %107 = bitcast float* %106 to <4 x float>*
  %wide.load213.prol = load <4 x float>, <4 x float>* %107, align 4, !alias.scope !19
  %108 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 4
  %109 = bitcast float* %108 to <4 x float>*
  %wide.load214.prol = load <4 x float>, <4 x float>* %109, align 4, !alias.scope !19
  %110 = fadd <4 x float> %wide.load211.prol, %wide.load213.prol
  %111 = fadd <4 x float> %wide.load212.prol, %wide.load214.prol
  %112 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv47, i64 0
  %113 = bitcast float* %112 to <4 x float>*
  store <4 x float> %110, <4 x float>* %113, align 4, !alias.scope !21, !noalias !23
  %114 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv47, i64 4
...
vector.body172.prol.loopexit:                     ; preds = %vector.body172.prol, %vector.body172.preheader
  ...
  br i1 %101, label %middle.block173, label %vector.body172.preheader.new
...
vector.body172:                                   ; preds = %vector.body172, %vector.body172.preheader.new
  ...
  %116 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv47, i64 %index203
  %117 = bitcast float* %116 to <4 x float>*
  %wide.load211 = load <4 x float>, <4 x float>* %117, align 4, !alias.scope !16
  %118 = getelementptr float, float* %116, i64 4
  %119 = bitcast float* %118 to <4 x float>*
  %wide.load212 = load <4 x float>, <4 x float>* %119, align 4, !alias.scope !16
  %120 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 %index203
  %121 = bitcast float* %120 to <4 x float>*
  %wide.load213 = load <4 x float>, <4 x float>* %121, align 4, !alias.scope !19
  %122 = getelementptr float, float* %120, i64 4
  %123 = bitcast float* %122 to <4 x float>*
  %wide.load214 = load <4 x float>, <4 x float>* %123, align 4, !alias.scope !19
  %124 = fadd <4 x float> %wide.load211, %wide.load213
  %125 = fadd <4 x float> %wide.load212, %wide.load214
  %126 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv47, i64 %index203
  ...
  %130 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv47, i64 %index.next204
  %131 = bitcast float* %130 to <4 x float>*
  %wide.load211.1 = load <4 x float>, <4 x float>* %131, align 4, !alias.scope !16
  %132 = getelementptr float, float* %130, i64 4
  %133 = bitcast float* %132 to <4 x float>*
  %wide.load212.1 = load <4 x float>, <4 x float>* %133, align 4, !alias.scope !16
  %134 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 %index.next204
  %135 = bitcast float* %134 to <4 x float>*
  %wide.load213.1 = load <4 x float>, <4 x float>* %135, align 4, !alias.scope !19
  %136 = getelementptr float, float* %134, i64 4
  %137 = bitcast float* %136 to <4 x float>*
  %wide.load214.1 = load <4 x float>, <4 x float>* %137, align 4, !alias.scope !19
  %138 = fadd <4 x float> %wide.load211.1, %wide.load213.1
  %139 = fadd <4 x float> %wide.load212.1, %wide.load214.1
  %140 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv47, i64 %index.next204
  %141 = bitcast float* %140 to <4 x float>*
  store <4 x float> %138, <4 x float>* %141, align 4, !alias.scope !21, !noalias !23
  %142 = getelementptr float, float* %140, i64 4
  %143 = bitcast float* %142 to <4 x float>*
  store <4 x float> %139, <4 x float>* %143, align 4, !alias.scope !21, !noalias !23
  %index.next204.1 = add i64 %index203, 16
  %144 = icmp eq i64 %index.next204.1, %n.vec178
  br i1 %144, label %middle.block173.loopexit, label %vector.body172, !llvm.loop !24
...
for.body187.us.preheader:                         ; preds = %middle.block173, %vector.memcheck201, %min.iters.checked176, %for.cond185.preheader.us
  ...
  %145 = sub nsw i64 %99, %indvars.iv.ph
  %xtraiter215 = and i64 %145, 1
...
for.body187.us.prol:                              ; preds = %for.body187.us.preheader
  ...
  %146 = load float, float* %arrayidx191.us.prol, align 4
  %arrayidx195.us.prol = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 %indvars.iv.ph
  %147 = load float, float* %arrayidx195.us.prol, align 4
  %add196.us.prol = fadd float %146, %147
...
for.body187.us.prol.loopexit:                     ; preds = %for.body187.us.prol, %for.body187.us.preheader
  ...
  %148 = icmp eq i64 %wide.trip.count, %indvars.iv.ph
  br i1 %148, label %for.cond185.for.inc205_crit_edge.us, label %for.body187.us.preheader.new
...
for.body187.us:                                   ; preds = %for.body187.us, %for.body187.us.preheader.new
  ...
  %149 = load float, float* %arrayidx191.us, align 4
  %arrayidx195.us = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 %indvars.iv
  %150 = load float, float* %arrayidx195.us, align 4
  %add196.us = fadd float %149, %150
  ...
  %151 = load float, float* %arrayidx191.us.1, align 4
  %arrayidx195.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 %indvars.iv.next
  %152 = load float, float* %arrayidx195.us.1, align 4
  %add196.us.1 = fadd float %151, %152
...
for.cond185.for.inc205_crit_edge.us:              ; preds = %for.cond185.for.inc205_crit_edge.us.loopexit, %for.body187.us.prol.loopexit, %middle.block173
  ...
  %cmp183.us = icmp slt i64 %indvars.iv.next48, %94
