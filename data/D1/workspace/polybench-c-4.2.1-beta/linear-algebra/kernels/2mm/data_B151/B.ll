...
._crit_edge18.us:                                 ; preds = %._crit_edge
  ...
  %exitcond84 = icmp eq i64 %indvars.iv.next75, 800
  br i1 %exitcond84, label %.lr.ph14.split.us.new.preheader.preheader, label %.lr.ph20.split.us

.lr.ph14.split.us.new.preheader.preheader:        ; preds = %._crit_edge18.us
  br label %.lr.ph14.split.us.new.preheader

.lr.ph14.split.us.new.preheader:                  ; preds = %.lr.ph14.split.us.new.preheader.preheader, %._crit_edge12.us
...
._crit_edge12.us:                                 ; preds = %.lr.ph14.split.us.new
  ...
  %exitcond83 = icmp eq i64 %indvars.iv.next67, 1100
  br i1 %exitcond83, label %.lr.ph8.split.us.preheader, label %.lr.ph14.split.us.new.preheader
...
._crit_edge94:                                    ; preds = %._crit_edge94, %.lr.ph8.split.us
  %indvars.iv54 = phi i64 [ 0, %.lr.ph8.split.us ], [ %indvars.iv.next55, %._crit_edge94 ]
  ...
  br i1 %exitcond57, label %._crit_edge6.us, label %._crit_edge94

._crit_edge6.us:                                  ; preds = %._crit_edge94
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  %exitcond82 = icmp eq i64 %indvars.iv.next59, 900
  br i1 %exitcond82, label %.lr.ph2.split.us.preheader, label %.lr.ph8.split.us
...
._crit_edge95:                                    ; preds = %._crit_edge95, %.lr.ph2.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph2.split.us ], [ %indvars.iv.next, %._crit_edge95 ]
...
._crit_edge.us:                                   ; preds = %._crit_edge95
  ...
  %exitcond81 = icmp eq i64 %indvars.iv.next53, 800
  br i1 %exitcond81, label %44, label %.lr.ph2.split.us

; <label>:44:                                     ; preds = %._crit_edge.us
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define internal fastcc void @kernel_2mm(i32, i32, i32, i32, double, double, [900 x double]* nocapture, [1100 x double]* nocapture readonly, [900 x double]* nocapture readonly, [1200 x double]* nocapture readonly, [1200 x double]* nocapture) unnamed_addr #0 {
.lr.ph14.split.us:
...
._crit_edge12.us:                                 ; preds = %._crit_edge9.us.us
  ...
  %exitcond94 = icmp eq i64 %indvar.next, 800
  br i1 %exitcond94, label %.lr.ph.us.us.preheader.preheader, label %.lr.ph8.us.us.preheader
...
.lr.ph.us.us.preheader:                           ; preds = %.lr.ph.us.us.preheader.preheader, %._crit_edge3.us.loopexit
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %._crit_edge3.us.loopexit ], [ 0, %.lr.ph.us.us.preheader.preheader ]
  br label %.lr.ph.us.us

._crit_edge3.us.loopexit:                         ; preds = %._crit_edge.us.us
  %indvars.iv.next69 = add nuw nsw i64 %indvars.iv68, 1
  %exitcond92 = icmp eq i64 %indvars.iv.next69, 800
  br i1 %exitcond92, label %49, label %.lr.ph.us.us.preheader
...
._crit_edge.us.us:                                ; preds = %._crit_edge123
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1
  %exitcond67 = icmp eq i64 %indvars.iv.next65, 1200
  br i1 %exitcond67, label %._crit_edge3.us.loopexit, label %.lr.ph.us.us

._crit_edge123:                                   ; preds = %._crit_edge123, %.lr.ph.us.us
  %30 = phi double [ %29, %.lr.ph.us.us ], [ %48, %._crit_edge123 ]
  %indvars.iv62 = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next63.2, %._crit_edge123 ]
  ...
  br i1 %exitcond.2, label %._crit_edge.us.us, label %._crit_edge123

; <label>:49:                                     ; preds = %._crit_edge3.us.loopexit
  ret void
}
...
._crit_edge2.us:                                  ; preds = %._crit_edge.us
  ...
  br i1 %exitcond14, label %18, label %.lr.ph4.split.us

; <label>:18:                                     ; preds = %._crit_edge2.us
