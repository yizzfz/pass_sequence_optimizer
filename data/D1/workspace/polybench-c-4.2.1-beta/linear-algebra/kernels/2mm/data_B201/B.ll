...
._crit_edge18.us:                                 ; preds = %._crit_edge
  ...
  %exitcond95 = icmp eq i64 %indvars.iv.next75, 800
  br i1 %exitcond95, label %.lr.ph14.split.us.new.preheader.preheader, label %.lr.ph20.split.us
...
._crit_edge12.us:                                 ; preds = %.lr.ph14.split.us.new
  ...
  %exitcond94 = icmp eq i64 %indvars.iv.next67, 1100
  br i1 %exitcond94, label %.lr.ph8.split.us.preheader, label %.lr.ph14.split.us.new.preheader
...
._crit_edge96:                                    ; preds = %._crit_edge96, %.lr.ph8.split.us
  %indvars.iv54 = phi i64 [ 0, %.lr.ph8.split.us ], [ %indvars.iv.next55, %._crit_edge96 ]
  ...
  br i1 %exitcond57, label %._crit_edge6.us, label %._crit_edge96

._crit_edge6.us:                                  ; preds = %._crit_edge96
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  %exitcond93 = icmp eq i64 %indvars.iv.next59, 900
  br i1 %exitcond93, label %.lr.ph2.split.us.preheader, label %.lr.ph8.split.us
...
._crit_edge97:                                    ; preds = %._crit_edge97, %.lr.ph2.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph2.split.us ], [ %indvars.iv.next, %._crit_edge97 ]
  ...
  br i1 %exitcond, label %._crit_edge.us, label %._crit_edge97

._crit_edge.us:                                   ; preds = %._crit_edge97
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1
  %exitcond92 = icmp eq i64 %indvars.iv.next53, 800
  br i1 %exitcond92, label %45, label %.lr.ph2.split.us
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph8.us.us
  ...
  %exitcond94.1 = icmp eq i64 %indvars.iv.next75.1, 1100
  br i1 %exitcond94.1, label %._crit_edge9.us.us, label %._crit_edge

.lr.ph.us.us.preheader:                           ; preds = %.lr.ph.us.us.preheader.preheader, %._crit_edge3.us
...
._crit_edge3.us:                                  ; preds = %._crit_edge.us.us
  ...
  br i1 %exitcond102, label %49, label %.lr.ph.us.us.preheader
...
._crit_edge104:                                   ; preds = %._crit_edge104, %.lr.ph.us.us
  ...
  %indvars.iv62 = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next63.2, %._crit_edge104 ]
...
._crit_edge2.us:                                  ; preds = %._crit_edge.us
  ...
  br i1 %exitcond16, label %18, label %.lr.ph4.split.us
