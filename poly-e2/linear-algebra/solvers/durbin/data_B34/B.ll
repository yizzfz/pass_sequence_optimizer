...
for.inc.lr.ph:                                    ; preds = %for.end44.for.inc.lr.ph_crit_edge, %entry
  %indvars.iv2 = phi i2 [ 1, %entry ], [ %indvars.iv.next3, %for.end44.for.inc.lr.ph_crit_edge ]
  %indvars.iv29 = phi i64 [ 1, %entry ], [ %indvars.iv.next30, %for.end44.for.inc.lr.ph_crit_edge ]
  %indvar = phi i64 [ 0, %entry ], [ %indvar.next, %for.end44.for.inc.lr.ph_crit_edge ]
  %alpha.09 = phi double [ %sub3, %entry ], [ %div, %for.end44.for.inc.lr.ph_crit_edge ]
  %beta.08 = phi double [ 1.000000e+00, %entry ], [ %mul5, %for.end44.for.inc.lr.ph_crit_edge ]
  %6 = zext i2 %indvars.iv2 to i64
  %7 = add nsw i64 %indvar, -1
  %8 = shl i64 %indvar, 3
...
for.inc.prol.loopexit:                            ; preds = %for.inc.lr.ph.for.inc.prol.loopexit_crit_edge, %for.inc.prol.loopexit.loopexit
  %indvars.iv.unr = phi i64 [ 0, %for.inc.lr.ph.for.inc.prol.loopexit_crit_edge ], [ %6, %for.inc.prol.loopexit.loopexit ]
  ...
  br i1 %15, label %for.inc.prol.loopexit.for.body21.lr.ph_crit_edge, label %for.inc.preheader

for.inc.prol.loopexit.for.body21.lr.ph_crit_edge: ; preds = %for.inc.prol.loopexit
...
for.body21.lr.ph:                                 ; preds = %for.inc.prol.loopexit.for.body21.lr.ph_crit_edge, %for.body21.lr.ph.loopexit
  %sum.0.lcssa = phi double [ %add.lcssa.unr, %for.inc.prol.loopexit.for.body21.lr.ph_crit_edge ], [ %add.3, %for.body21.lr.ph.loopexit ]
...
for.body21.preheader:                             ; preds = %for.body21.prol.loopexit
  %32 = sub i64 %7, %indvars.iv14.unr.ph
  %33 = lshr i64 %32, 1
  %34 = add nuw i64 %33, 1
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.ph
  ...
  %wide.vec42 = load <4 x double>, <4 x double>* %45, align 8
  ...
  %46 = fmul <2 x double> %broadcast.splat47, %reverse45
  %47 = fadd <2 x double> %strided.vec, %46
  %48 = add nuw nsw i64 %offset.idx, 1
  %49 = fmul <2 x double> %broadcast.splat47, %reverse
  %50 = fadd <2 x double> %strided.vec41, %49
...
for.end44:                                        ; preds = %middle.block.for.end44_crit_edge, %for.body21.prol.loopexit.for.end44_crit_edge, %for.end44.loopexit
  ...
  br i1 %exitcond33, label %for.end49, label %for.end44.for.inc.lr.ph_crit_edge

for.end44.for.inc.lr.ph_crit_edge:                ; preds = %for.end44
