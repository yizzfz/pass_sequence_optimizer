...
.lr.ph:                                           ; preds = %._crit_edge38, %.lr.ph43.preheader
  ...
  %indvar = phi i64 [ 0, %.lr.ph43.preheader ], [ %15, %._crit_edge38 ]
  %13 = phi double [ %11, %.lr.ph43.preheader ], [ %61, %._crit_edge38 ]
  %.03039 = phi double [ 1.000000e+00, %.lr.ph43.preheader ], [ %56, %._crit_edge38 ]
  %14 = add i64 %indvar, 1
  %15 = add nuw nsw i64 %indvar, 1
  %16 = add nsw i64 %indvars.iv59, -1
...
._crit_edge63.prol:                               ; preds = %._crit_edge63.prol, %._crit_edge63.prol.preheader
  ...
  %.031.prol = phi double [ 0.000000e+00, %._crit_edge63.prol.preheader ], [ %23, %._crit_edge63.prol ]
...
._crit_edge63.prol.loopexit:                      ; preds = %.lr.ph, %._crit_edge63.prol.loopexit.unr-lcssa
  %.lcssa.unr = phi double [ undef, %.lr.ph ], [ %23, %._crit_edge63.prol.loopexit.unr-lcssa ]
  %indvars.iv.unr = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next.prol, %._crit_edge63.prol.loopexit.unr-lcssa ]
  %.031.unr = phi double [ 0.000000e+00, %.lr.ph ], [ %23, %._crit_edge63.prol.loopexit.unr-lcssa ]
...
._crit_edge63:                                    ; preds = %._crit_edge63, %.lr.ph.new
  ...
  %.031 = phi double [ %.031.unr, %.lr.ph.new ], [ %52, %._crit_edge63 ]
...
.lr.ph35:                                         ; preds = %._crit_edge63.prol.loopexit, %.lr.ph35.unr-lcssa
  %.lcssa = phi double [ %.lcssa.unr, %._crit_edge63.prol.loopexit ], [ %52, %.lr.ph35.unr-lcssa ]
  %53 = fmul double %13, %13
  %54 = shl i64 %indvar, 3
  %55 = fsub double 1.000000e+00, %53
  %56 = fmul double %.03039, %55
...
vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert70 = insertelement <2 x double> undef, double %61, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load66 = load <2 x double>, <2 x double>* %65, align 8
  %66 = sub nsw i64 %16, %index
  %67 = getelementptr inbounds double, double* %2, i64 %66
  %68 = getelementptr double, double* %67, i64 -1
  %69 = bitcast double* %68 to <2 x double>*
  %wide.load67 = load <2 x double>, <2 x double>* %69, align 8
  ...
  %wide.load68 = load <2 x double>, <2 x double>* %72, align 8
  %reverse69 = shufflevector <2 x double> %wide.load68, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %73 = fmul <2 x double> %broadcast.splat71, %reverse
  %74 = fmul <2 x double> %broadcast.splat71, %reverse69
  %75 = fadd <2 x double> %wide.load, %73
  %76 = fadd <2 x double> %wide.load66, %74
...
._crit_edge64:                                    ; preds = %._crit_edge64.preheader, %._crit_edge64
  ...
  %82 = getelementptr inbounds double, double* %2, i64 %indvars.iv47
  %83 = load double, double* %82, align 8
  %84 = sub nsw i64 %16, %indvars.iv47
  %85 = getelementptr inbounds double, double* %2, i64 %84
  %86 = load double, double* %85, align 8
  %87 = fmul double %61, %86
  %88 = fadd double %83, %87
  %89 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 0, i64 %indvars.iv47
...
._crit_edge38:                                    ; preds = %._crit_edge38.loopexit, %middle.block
  %90 = add nuw nsw i64 %54, 8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull %4, i8* nonnull %6, i64 %90, i32 8, i1 false)
  %91 = getelementptr inbounds double, double* %2, i64 %indvars.iv59
  store double %61, double* %91, align 8
  %exitcond62 = icmp eq i64 %15, %wide.trip.count61
