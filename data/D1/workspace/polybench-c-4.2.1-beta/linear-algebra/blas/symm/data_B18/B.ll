...
; <label>:47:                                     ; preds = %._crit_edge1, %._crit_edge, %42
...
; <label>:30:                                     ; preds = %._crit_edge48, %.preheader7.us
  ...
  br i1 %43, label %._crit_edge48, label %._crit_edge19.us

._crit_edge48:                                    ; preds = %30
  br label %30
...
.preheader5:                                      ; preds = %._crit_edge..preheader5_crit_edge, %.preheader5.lr.ph
  %indvars.iv42 = phi i64 [ %55, %.preheader5.lr.ph ], [ %indvars.iv.next43, %._crit_edge..preheader5_crit_edge ]
  %indvars.iv32 = phi i64 [ %50, %.preheader5.lr.ph ], [ %indvars.iv.next33, %._crit_edge..preheader5_crit_edge ]
  %indvar = phi i32 [ 0, %.preheader5.lr.ph ], [ %indvar.next, %._crit_edge..preheader5_crit_edge ]
  %indvars.iv30 = phi i32 [ %49, %.preheader5.lr.ph ], [ %indvars.iv.next31, %._crit_edge..preheader5_crit_edge ]
  %58 = sub i32 %52, %indvar
  %59 = sub i32 %54, %indvar
  %60 = icmp slt i64 %indvars.iv42, 0
  br i1 %60, label %.preheader5..preheader_crit_edge, label %.lr.ph
...
.prol.loopexit:                                   ; preds = %.lr.ph..prol.loopexit_crit_edge, %.prol.preheader
  ...
  br i1 %68, label %.prol.loopexit..preheader_crit_edge, label %.lr.ph.new.preheader
...
.preheader:                                       ; preds = %.prol.loopexit..preheader_crit_edge, %.preheader5..preheader_crit_edge, %.preheader.loopexit
  %indvars.iv.next43 = add nsw i64 %indvars.iv42, 1
  %69 = icmp slt i64 %indvars.iv.next43, %57
  br i1 %69, label %.lr.ph11, label %.preheader.._crit_edge_crit_edge
...
.lr.ph11:                                         ; preds = %.preheader
  ...
  br i1 %lcmp.mod39, label %.lr.ph11..prol.loopexit37_crit_edge, label %.prol.preheader36.preheader

.lr.ph11..prol.loopexit37_crit_edge:              ; preds = %.lr.ph11
  br label %.prol.loopexit37

.prol.preheader36.preheader:                      ; preds = %.lr.ph11
  br label %.prol.preheader36

.prol.preheader36:                                ; preds = %.prol.preheader36..prol.preheader36_crit_edge, %.prol.preheader36.preheader
  %indvars.iv34.prol = phi i64 [ %indvars.iv.next35.prol, %.prol.preheader36..prol.preheader36_crit_edge ], [ %indvars.iv32, %.prol.preheader36.preheader ]
  %prol.iter = phi i32 [ %prol.iter.sub, %.prol.preheader36..prol.preheader36_crit_edge ], [ %xtraiter38, %.prol.preheader36.preheader ]
  ...
  br i1 %prol.iter.cmp, label %.prol.loopexit37.loopexit, label %.prol.preheader36..prol.preheader36_crit_edge, !llvm.loop !1

.prol.preheader36..prol.preheader36_crit_edge:    ; preds = %.prol.preheader36
  br label %.prol.preheader36

.prol.loopexit37.loopexit:                        ; preds = %.prol.preheader36
  br label %.prol.loopexit37

.prol.loopexit37:                                 ; preds = %.lr.ph11..prol.loopexit37_crit_edge, %.prol.loopexit37.loopexit
  %indvars.iv34.unr = phi i64 [ %indvars.iv32, %.lr.ph11..prol.loopexit37_crit_edge ], [ %indvars.iv.next35.prol, %.prol.loopexit37.loopexit ]
  %71 = icmp ult i32 %59, 7
  br i1 %71, label %.prol.loopexit37.._crit_edge_crit_edge, label %.lr.ph11.new.preheader

.prol.loopexit37.._crit_edge_crit_edge:           ; preds = %.prol.loopexit37
  br label %._crit_edge
...
.lr.ph11.new:                                     ; preds = %.lr.ph11.new..lr.ph11.new_crit_edge, %.lr.ph11.new.preheader
  %indvars.iv34 = phi i64 [ %indvars.iv.next35.7, %.lr.ph11.new..lr.ph11.new_crit_edge ], [ %indvars.iv34.unr, %.lr.ph11.new.preheader ]
  ...
  br i1 %exitcond.7, label %._crit_edge.loopexit, label %.lr.ph11.new..lr.ph11.new_crit_edge
...
._crit_edge:                                      ; preds = %.prol.loopexit37.._crit_edge_crit_edge, %.preheader.._crit_edge_crit_edge, %._crit_edge.loopexit
  %92 = icmp slt i64 %indvars.iv.next43, %56
  %indvars.iv.next31 = add i32 %indvars.iv30, 1
  %indvar.next = add i32 %indvar, 1
  %indvars.iv.next33 = add nsw i64 %indvars.iv32, 1
  br i1 %92, label %._crit_edge..preheader5_crit_edge, label %._crit_edge14
...
; <label>:94:                                     ; preds = %.preheader6._crit_edge, %.preheader6.thread, %._crit_edge14
  ret void
}
...
.preheader:                                       ; preds = %._crit_edge6..preheader_crit_edge, %.preheader.lr.ph
  %indvar = phi i64 [ 0, %.preheader.lr.ph ], [ %indvar.next, %._crit_edge6..preheader_crit_edge ]
  %indvars.iv35 = phi i64 [ %31, %.preheader.lr.ph ], [ %indvars.iv.next36, %._crit_edge6..preheader_crit_edge ]
  %indvars.iv33 = phi i32 [ %.promoted, %.preheader.lr.ph ], [ %indvars.iv.next34, %._crit_edge6..preheader_crit_edge ]
  %.lcssa411.lcssa20 = phi double [ %.promoted19, %.preheader.lr.ph ], [ %.lcssa411.lcssa21, %._crit_edge6..preheader_crit_edge ]
  %.lcssa10.lcssa17 = phi i32 [ %.promoted16, %.preheader.lr.ph ], [ %.lcssa10.lcssa18, %._crit_edge6..preheader_crit_edge ]
...
.lr.ph5.split.preheader:                          ; preds = %.lr.ph5
  br i1 %min.iters.check, label %.lr.ph5.split.preheader..lr.ph5.split.preheader61_crit_edge, label %min.iters.checked

.lr.ph5.split.preheader..lr.ph5.split.preheader61_crit_edge: ; preds = %.lr.ph5.split.preheader
  br label %.lr.ph5.split.preheader61

.lr.ph5.split.preheader61:                        ; preds = %middle.block..lr.ph5.split.preheader61_crit_edge, %vector.memcheck..lr.ph5.split.preheader61_crit_edge, %min.iters.checked..lr.ph5.split.preheader61_crit_edge, %.lr.ph5.split.preheader..lr.ph5.split.preheader61_crit_edge
  %indvars.iv.ph = phi i64 [ 0, %vector.memcheck..lr.ph5.split.preheader61_crit_edge ], [ 0, %min.iters.checked..lr.ph5.split.preheader61_crit_edge ], [ 0, %.lr.ph5.split.preheader..lr.ph5.split.preheader61_crit_edge ], [ %n.vec, %middle.block..lr.ph5.split.preheader61_crit_edge ]
  br label %.lr.ph5.split

min.iters.checked:                                ; preds = %.lr.ph5.split.preheader
  br i1 %cmp.zero, label %min.iters.checked..lr.ph5.split.preheader61_crit_edge, label %vector.memcheck

min.iters.checked..lr.ph5.split.preheader61_crit_edge: ; preds = %min.iters.checked
  br label %.lr.ph5.split.preheader61
...
vector.memcheck:                                  ; preds = %min.iters.checked
  ...
  br i1 %conflict.rdx, label %vector.memcheck..lr.ph5.split.preheader61_crit_edge, label %vector.ph

vector.memcheck..lr.ph5.split.preheader61_crit_edge: ; preds = %vector.memcheck
  br label %.lr.ph5.split.preheader61
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.ph
  ...
  %44 = getelementptr inbounds [1200 x double], [1200 x double]* %23, i64 %indvars.iv35, i64 %index
  ...
  %50 = getelementptr inbounds [1200 x double], [1200 x double]* %25, i64 %indvars.iv35, i64 %index
  ...
  br i1 %64, label %middle.block, label %vector.body.vector.body_crit_edge, !llvm.loop !11

vector.body.vector.body_crit_edge:                ; preds = %vector.body
  br label %vector.body

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %middle.block.._crit_edge6_crit_edge, label %middle.block..lr.ph5.split.preheader61_crit_edge

middle.block..lr.ph5.split.preheader61_crit_edge: ; preds = %middle.block
  br label %.lr.ph5.split.preheader61
...
.lr.ph5.split.us:                                 ; preds = %._crit_edge.us..lr.ph5.split.us_crit_edge, %.lr.ph5.split.us.preheader
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %._crit_edge.us..lr.ph5.split.us_crit_edge ], [ 0, %.lr.ph5.split.us.preheader ]
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %25, i64 %indvars.iv35, i64 %indvars.iv31
  br label %66

; <label>:66:                                     ; preds = %._crit_edge63, %.lr.ph5.split.us
  %indvars.iv25 = phi i64 [ 0, %.lr.ph5.split.us ], [ %indvars.iv.next26, %._crit_edge63 ]
  %67 = phi double [ 0.000000e+00, %.lr.ph5.split.us ], [ %81, %._crit_edge63 ]
...
._crit_edge.us:                                   ; preds = %66
  ...
  br i1 %94, label %._crit_edge.us..lr.ph5.split.us_crit_edge, label %._crit_edge6.loopexit

._crit_edge.us..lr.ph5.split.us_crit_edge:        ; preds = %._crit_edge.us
  br label %.lr.ph5.split.us

.lr.ph5.split:                                    ; preds = %.lr.ph5.split..lr.ph5.split_crit_edge, %.lr.ph5.split.preheader61
  %indvars.iv = phi i64 [ %indvars.iv.next, %.lr.ph5.split..lr.ph5.split_crit_edge ], [ %indvars.iv.ph, %.lr.ph5.split.preheader61 ]
  ...
  br i1 %106, label %.lr.ph5.split..lr.ph5.split_crit_edge, label %._crit_edge6.loopexit62, !llvm.loop !14
...
._crit_edge6:                                     ; preds = %middle.block.._crit_edge6_crit_edge, %.preheader.._crit_edge6_crit_edge, %._crit_edge6.loopexit62, %._crit_edge6.loopexit
  %.lcssa411.lcssa21 = phi double [ %.lcssa411.lcssa20, %.preheader.._crit_edge6_crit_edge ], [ 0.000000e+00, %middle.block.._crit_edge6_crit_edge ], [ %81, %._crit_edge6.loopexit ], [ 0.000000e+00, %._crit_edge6.loopexit62 ]
  %.lcssa10.lcssa18 = phi i32 [ %.lcssa10.lcssa17, %.preheader.._crit_edge6_crit_edge ], [ 0, %middle.block.._crit_edge6_crit_edge ], [ %indvars.iv33, %._crit_edge6.loopexit ], [ 0, %._crit_edge6.loopexit62 ]
  %indvars.iv.next36 = add nsw i64 %indvars.iv35, 1
  %indvars.iv.next34 = add i32 %indvars.iv33, 1
  %107 = icmp slt i64 %indvars.iv.next36, %32
  %indvar.next = add i64 %indvar, 1
  br i1 %107, label %._crit_edge6..preheader_crit_edge, label %._crit_edge12
...
; <label>:109:                                    ; preds = %._crit_edge, %._crit_edge12
  ret void
}
...
.preheader.us:                                    ; preds = %._crit_edge.us..preheader.us_crit_edge, %.preheader.us.preheader
  %indvars.iv9 = phi i64 [ %18, %.preheader.us.preheader ], [ %indvars.iv.next10, %._crit_edge.us..preheader.us_crit_edge ]
  %21 = mul nsw i64 %19, %indvars.iv9
  br label %22

; <label>:22:                                     ; preds = %._crit_edge12, %.preheader.us
  %indvars.iv = phi i64 [ 0, %.preheader.us ], [ %indvars.iv.next, %._crit_edge12 ]
  %23 = add nsw i64 %21, %indvars.iv
  %24 = trunc i64 %23 to i32
  %25 = srem i32 %24, 20
  %26 = icmp eq i32 %25, 0
  br i1 %26, label %27, label %._crit_edge11
...
; <label>:29:                                     ; preds = %._crit_edge11, %27
...
; <label>:38:                                     ; preds = %._crit_edge, %._crit_edge3
