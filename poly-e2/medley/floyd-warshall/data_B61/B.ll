...
for.cond1.preheader:                              ; preds = %for.inc38, %entry
  ...
  %scevgep6 = getelementptr [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv29, i64 0
