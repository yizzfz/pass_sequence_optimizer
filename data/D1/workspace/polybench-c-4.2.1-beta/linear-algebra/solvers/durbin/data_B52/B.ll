...
._crit_edge5.prol.loopexit:                       ; preds = %.lr.ph, %._crit_edge5.prol.loopexit.unr-lcssa
  %indvars.iv.unr = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next.prol, %._crit_edge5.prol.loopexit.unr-lcssa ]
  %10 = icmp ult i64 %5, 3
...
.lr.ph:                                           ; preds = %._crit_edge38..lr.ph_crit_edge, %.lr.ph43.preheader
  %indvars.iv59 = phi i64 [ 1, %.lr.ph43.preheader ], [ %indvars.iv.next60, %._crit_edge38..lr.ph_crit_edge ]
  %indvar = phi i64 [ 0, %.lr.ph43.preheader ], [ %indvar.next, %._crit_edge38..lr.ph_crit_edge ]
  %14 = phi double [ %11, %.lr.ph43.preheader ], [ %61, %._crit_edge38..lr.ph_crit_edge ]
  %.03039 = phi double [ 1.000000e+00, %.lr.ph43.preheader ], [ %56, %._crit_edge38..lr.ph_crit_edge ]
  %15 = add i64 %indvar, 1
  %16 = shl i64 %indvar, 3
...
.lr.ph35:                                         ; preds = %._crit_edge63.prol.loopexit, %.lr.ph35.unr-lcssa
  ...
  %56 = fmul double %.03039, %18
  %57 = getelementptr inbounds double, double* %1, i64 %indvars.iv59
  %58 = load double, double* %57, align 8
  %59 = fadd double %.lcssa, %58
  %60 = fsub double -0.000000e+00, %59
  %61 = fdiv double %60, %56
  %62 = and i64 %indvar, 1
  %lcmp.mod66 = icmp eq i64 %62, 0
  br i1 %lcmp.mod66, label %._crit_edge64.prol.preheader, label %._crit_edge64.prol.loopexit.unr-lcssa

._crit_edge64.prol.preheader:                     ; preds = %.lr.ph35
  br label %._crit_edge64.prol

._crit_edge64.prol:                               ; preds = %._crit_edge64.prol.preheader
  %63 = load double, double* %2, align 8
  %64 = getelementptr inbounds double, double* %2, i64 %19
...
._crit_edge64.prol.loopexit.unr-lcssa:            ; preds = %.lr.ph35, %._crit_edge64.prol
  %indvars.iv47.unr.ph = phi i64 [ 1, %._crit_edge64.prol ], [ 0, %.lr.ph35 ]
...
._crit_edge64.prol.loopexit:                      ; preds = %._crit_edge64.prol.loopexit.unr-lcssa
  ...
  br i1 %68, label %._crit_edge38, label %.lr.ph35.new

.lr.ph35.new:                                     ; preds = %._crit_edge64.prol.loopexit
  br label %._crit_edge64

._crit_edge64:                                    ; preds = %._crit_edge64, %.lr.ph35.new
  %indvars.iv47 = phi i64 [ %indvars.iv47.unr.ph, %.lr.ph35.new ], [ %indvars.iv.next48.1, %._crit_edge64 ]
  %69 = getelementptr inbounds double, double* %2, i64 %indvars.iv47
  %70 = load double, double* %69, align 8
  %71 = sub nsw i64 %19, %indvars.iv47
  %72 = getelementptr inbounds double, double* %2, i64 %71
  %73 = load double, double* %72, align 8
  %74 = fmul double %61, %73
  %75 = fadd double %70, %74
  %76 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 0, i64 %indvars.iv47
  store double %75, double* %76, align 8
  %indvars.iv.next48 = add nuw nsw i64 %indvars.iv47, 1
  %77 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next48
  %78 = load double, double* %77, align 8
  %79 = sub nsw i64 %19, %indvars.iv.next48
  %80 = getelementptr inbounds double, double* %2, i64 %79
  %81 = load double, double* %80, align 8
  %82 = fmul double %61, %81
  %83 = fadd double %78, %82
  %84 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 0, i64 %indvars.iv.next48
  store double %83, double* %84, align 8
  %indvars.iv.next48.1 = add nsw i64 %indvars.iv47, 2
  %exitcond52.1 = icmp eq i64 %indvars.iv.next48.1, %indvars.iv59
  br i1 %exitcond52.1, label %._crit_edge38.unr-lcssa, label %._crit_edge64

._crit_edge38.unr-lcssa:                          ; preds = %._crit_edge64
  br label %._crit_edge38

._crit_edge38:                                    ; preds = %._crit_edge64.prol.loopexit, %._crit_edge38.unr-lcssa
  %85 = add nuw nsw i64 %16, 8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull %4, i8* nonnull %6, i64 %85, i32 8, i1 false)
  %86 = getelementptr inbounds double, double* %2, i64 %indvars.iv59
  store double %61, double* %86, align 8
  %indvar.next = add nuw nsw i64 %indvar, 1
  %exitcond62 = icmp eq i64 %indvar.next, %wide.trip.count61
  br i1 %exitcond62, label %._crit_edge44.loopexit, label %._crit_edge38..lr.ph_crit_edge

._crit_edge38..lr.ph_crit_edge:                   ; preds = %._crit_edge38
