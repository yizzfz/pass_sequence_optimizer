...
vector.body224:                                   ; preds = %vector.body224, %vector.body224.preheader
  ...
  br i1 %44, label %.preheader74.us.preheader.loopexit2, label %vector.body224, !llvm.loop !6

.preheader74.us.preheader.loopexit:               ; preds = %scalar.ph226
  br label %.preheader74.us.preheader

.preheader74.us.preheader.loopexit2:              ; preds = %vector.body224
  br label %.preheader74.us.preheader

.preheader74.us.preheader:                        ; preds = %.preheader74.us.preheader.loopexit2, %.preheader74.us.preheader.loopexit
...
vector.body191.preheader:                         ; preds = %.preheader74.us
  br label %vector.body191

scalar.ph193.preheader:                           ; preds = %.preheader74.us
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit1, %._crit_edge.us.loopexit
  ...
  br i1 %exitcond130, label %.preheader73.us.preheader, label %.preheader74.us
...
scalar.ph226:                                     ; preds = %scalar.ph226, %scalar.ph226.preheader
  ...
  br i1 %exitcond.7, label %.preheader74.us.preheader.loopexit, label %scalar.ph226, !llvm.loop !16

.preheader73.us:                                  ; preds = %.preheader73.us.preheader, %._crit_edge85.us
  %indvars.iv112 = phi i64 [ %indvars.iv.next113, %._crit_edge85.us ], [ 0, %.preheader73.us.preheader ]
...
vector.body158.preheader:                         ; preds = %.preheader73.us
...
scalar.ph160.preheader:                           ; preds = %scalar.ph160.preheader.loopexit, %.preheader73.us
  %indvars.iv108.ph = phi i64 [ 1, %.preheader73.us ], [ 1197, %scalar.ph160.preheader.loopexit ]
...
._crit_edge85.us:                                 ; preds = %scalar.ph160.prol.loopexit, %._crit_edge85.us.unr-lcssa
  ...
  br i1 %exitcond131, label %.preheader.us.preheader, label %.preheader73.us

.preheader.us.preheader:                          ; preds = %._crit_edge85.us
  br label %.preheader.us

.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge89.us
  %indvars.iv119 = phi i64 [ %indvars.iv.next120, %._crit_edge89.us ], [ 0, %.preheader.us.preheader ]
...
._crit_edge99.preheader:                          ; preds = %._crit_edge99.preheader.loopexit, %.preheader.us
  %indvars.iv115.ph = phi i64 [ 0, %.preheader.us ], [ 1196, %._crit_edge99.preheader.loopexit ]
...
._crit_edge89.us:                                 ; preds = %._crit_edge99
  %exitcond132 = icmp eq i64 %indvars.iv.next120, 999
  br i1 %exitcond132, label %._crit_edge91, label %.preheader.us

._crit_edge91:                                    ; preds = %._crit_edge89.us
  %indvars.iv.next122 = add nuw nsw i64 %indvars.iv121, 1
  %exitcond133 = icmp eq i64 %indvars.iv.next122, 500
...
._crit_edge56.us:                                 ; preds = %._crit_edge
  ...
  br i1 %exitcond85, label %._crit_edge58, label %.preheader45.us
...
._crit_edge51.us:                                 ; preds = %._crit_edge63
  ...
  br i1 %exitcond83, label %._crit_edge53, label %.preheader44.us
...
.preheader.us:                                    ; preds = %._crit_edge.us, %._crit_edge53
  %indvars.iv67 = phi i64 [ 0, %._crit_edge53 ], [ %indvars.iv.next68, %._crit_edge.us ]
