...
._crit_edge.preheader:                            ; preds = %.._crit_edge.preheader_crit_edge, %8
  %indvars.iv13 = phi i64 [ 0, %8 ], [ %9, %.._crit_edge.preheader_crit_edge ]
...
._crit_edge4.preheader:                           ; preds = %._crit_edge3.._crit_edge4.preheader_crit_edge, %._crit_edge4.preheader.preheader
  %indvars.iv11 = phi i64 [ %25, %._crit_edge3.._crit_edge4.preheader_crit_edge ], [ 0, %._crit_edge4.preheader.preheader ]
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.ph
  ...
  %30 = getelementptr inbounds [1100 x double], [1100 x double]* %7, i64 %indvars.iv11, i64 %offset.idx
  ...
  %33 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv13, i64 %offset.idx
  ...
  %38 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv13, i64 %36
  ...
  br i1 %42, label %._crit_edge3.loopexit34, label %vector.body.vector.body_crit_edge, !llvm.loop !9

vector.body.vector.body_crit_edge:                ; preds = %vector.body
  br label %vector.body

._crit_edge4:                                     ; preds = %._crit_edge4.._crit_edge4_crit_edge, %._crit_edge4.preheader33
  %indvars.iv9 = phi i64 [ %indvars.iv.next10.1, %._crit_edge4.._crit_edge4_crit_edge ], [ 0, %._crit_edge4.preheader33 ]
  %43 = load double, double* %26, align 8
  %44 = fmul double %43, %3
  %45 = getelementptr inbounds [1100 x double], [1100 x double]* %7, i64 %indvars.iv11, i64 %indvars.iv9
  %46 = load double, double* %45, align 8
  %47 = fmul double %44, %46
  %48 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv13, i64 %indvars.iv9
  ...
  %52 = fmul double %51, %3
  %53 = getelementptr inbounds [1100 x double], [1100 x double]* %7, i64 %indvars.iv11, i64 %indvars.iv.next10
  %54 = load double, double* %53, align 8
  %55 = fmul double %52, %54
  %56 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv13, i64 %indvars.iv.next10
  ...
  br i1 %exitcond.1, label %._crit_edge3.loopexit, label %._crit_edge4.._crit_edge4_crit_edge, !llvm.loop !12
...
._crit_edge3:                                     ; preds = %._crit_edge3.loopexit34, %._crit_edge3.loopexit
  ...
  br i1 %exitcond, label %59, label %._crit_edge3.._crit_edge4.preheader_crit_edge
...
; <label>:59:                                     ; preds = %._crit_edge3
  ...
  br i1 %exitcond15, label %60, label %.._crit_edge.preheader_crit_edge
...
._crit_edge.preheader:                            ; preds = %.._crit_edge.preheader_crit_edge, %3
  %indvars.iv6 = phi i64 [ 0, %3 ], [ %indvars.iv.next7, %.._crit_edge.preheader_crit_edge ]
  %8 = mul nuw nsw i64 %indvars.iv6, 1000
  br label %9

; <label>:9:                                      ; preds = %._crit_edge._crit_edge, %._crit_edge.preheader
  %indvars.iv = phi i64 [ 0, %._crit_edge.preheader ], [ %indvars.iv.next, %._crit_edge._crit_edge ]
...
; <label>:20:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond8, label %21, label %.._crit_edge.preheader_crit_edge
