...
.lr.ph4:                                          ; preds = %.lr.ph4, %.lr.ph4.preheader
  ...
  %exitcond11.4 = icmp eq i64 %indvars.iv.next10.3, 499
  %indvars.iv.next10.4 = add nsw i64 %indvars.iv9, 5
  br i1 %exitcond11.4, label %.preheader.us.preheader, label %.lr.ph4
...
.preheader6.lr.ph:
  %scevgep135 = getelementptr [1200 x double], [1200 x double]* %1, i64 1, i64 0
  br label %.lr.ph

.lr.ph:                                           ; preds = %._crit_edge12, %.preheader6.lr.ph
  %indvars.iv38 = phi i64 [ 0, %.preheader6.lr.ph ], [ %indvars.iv.next39, %._crit_edge12 ]
  %4 = getelementptr inbounds double, double* %3, i64 %indvars.iv38
  %5 = bitcast double* %4 to [1200 x double]*
  %bound0138 = icmp ugt [1200 x double]* %5, %1
  %bound1139 = icmp ult double* %4, %scevgep135
  %memcheck.conflict141 = and i1 %bound0138, %bound1139
  br i1 %memcheck.conflict141, label %scalar.ph132.preheader, label %vector.body130.preheader

vector.body130.preheader:                         ; preds = %.lr.ph
  %6 = bitcast double* %4 to i64*
  %7 = bitcast double* %4 to i64*
  %8 = bitcast double* %4 to i64*
  br label %vector.body130

scalar.ph132.preheader:                           ; preds = %.lr.ph
...
vector.body130:                                   ; preds = %vector.body130, %vector.body130.preheader
  %index144 = phi i64 [ 0, %vector.body130.preheader ], [ %index.next145.2, %vector.body130 ]
  ...
  %22 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 0, i64 %index144
  ...
  %31 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 0, i64 %index.next145
  ...
  %index.next145.1 = add nsw i64 %index144, 8
  ...
  %40 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 0, i64 %index.next145.1
  ...
  %index.next145.2 = add nsw i64 %index144, 12
  %44 = icmp eq i64 %index.next145.2, 1200
  br i1 %44, label %.preheader2.us.preheader.loopexit2, label %vector.body130, !llvm.loop !6

.preheader2.us.preheader.loopexit:                ; preds = %scalar.ph132
  br label %.preheader2.us.preheader

.preheader2.us.preheader.loopexit2:               ; preds = %vector.body130
  br label %.preheader2.us.preheader
...
.preheader2.us:                                   ; preds = %._crit_edge.us, %.preheader2.us.preheader
  ...
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %._crit_edge.us ], [ 1, %.preheader2.us.preheader ]
  %45 = add nuw nsw i64 %indvar, 1
  %scevgep102 = getelementptr [1200 x double], [1200 x double]* %1, i64 %45, i64 0
  %46 = add nuw nsw i64 %indvar, 2
  %scevgep104 = getelementptr [1200 x double], [1200 x double]* %1, i64 %46, i64 0
  %scevgep106 = getelementptr [1200 x double], [1200 x double]* %2, i64 %indvar, i64 0
  %scevgep108 = getelementptr [1200 x double], [1200 x double]* %2, i64 %46, i64 0
  %47 = add nsw i64 %indvars.iv24, -1
  ...
  br i1 %memcheck.conflict113, label %scalar.ph99.preheader, label %vector.body97.preheader

vector.body97.preheader:                          ; preds = %.preheader2.us
  br label %vector.body97

scalar.ph99.preheader:                            ; preds = %.preheader2.us
  br label %scalar.ph99

vector.body97:                                    ; preds = %vector.body97.preheader, %vector.body97
  %index116 = phi i64 [ %index.next117, %vector.body97 ], [ 0, %vector.body97.preheader ]
  %48 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv24, i64 %index116
  %49 = bitcast double* %48 to <2 x double>*
  %wide.load124 = load <2 x double>, <2 x double>* %49, align 8, !alias.scope !9, !noalias !12
  %50 = getelementptr double, double* %48, i64 2
  %51 = bitcast double* %50 to <2 x double>*
  %wide.load125 = load <2 x double>, <2 x double>* %51, align 8, !alias.scope !9, !noalias !12
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv24, i64 %index116
  %53 = bitcast double* %52 to <2 x double>*
  %wide.load126 = load <2 x double>, <2 x double>* %53, align 8, !alias.scope !12
  %54 = getelementptr double, double* %52, i64 2
  %55 = bitcast double* %54 to <2 x double>*
  %wide.load127 = load <2 x double>, <2 x double>* %55, align 8, !alias.scope !12
  %56 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %47, i64 %index116
  %57 = bitcast double* %56 to <2 x double>*
  %wide.load128 = load <2 x double>, <2 x double>* %57, align 8, !alias.scope !12
  %58 = getelementptr double, double* %56, i64 2
  %59 = bitcast double* %58 to <2 x double>*
  %wide.load129 = load <2 x double>, <2 x double>* %59, align 8, !alias.scope !12
  %60 = fsub <2 x double> %wide.load126, %wide.load128
  %61 = fsub <2 x double> %wide.load127, %wide.load129
  ...
  %64 = fsub <2 x double> %wide.load124, %62
  %65 = fsub <2 x double> %wide.load125, %63
  ...
  %68 = icmp eq i64 %index.next117, 1200
  br i1 %68, label %._crit_edge.us.loopexit1, label %vector.body97, !llvm.loop !14

scalar.ph99:                                      ; preds = %scalar.ph99, %scalar.ph99.preheader
  %indvars.iv21 = phi i64 [ 0, %scalar.ph99.preheader ], [ %indvars.iv.next22.1, %scalar.ph99 ]
  %69 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv24, i64 %indvars.iv21
  %70 = load double, double* %69, align 8
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv24, i64 %indvars.iv21
  %72 = load double, double* %71, align 8
  %73 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %47, i64 %indvars.iv21
  ...
  %78 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv24, i64 %indvars.iv.next22
  %79 = load double, double* %78, align 8
  %80 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv24, i64 %indvars.iv.next22
  %81 = load double, double* %80, align 8
  %82 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %47, i64 %indvars.iv.next22
  %83 = load double, double* %82, align 8
  %84 = fsub double %81, %83
  %85 = fmul double %84, 5.000000e-01
  %86 = fsub double %79, %85
  store double %86, double* %78, align 8
  %exitcond23.1 = icmp eq i64 %indvars.iv.next22, 1199
  %indvars.iv.next22.1 = add nsw i64 %indvars.iv21, 2
  br i1 %exitcond23.1, label %._crit_edge.us.loopexit, label %scalar.ph99, !llvm.loop !15

._crit_edge.us.loopexit:                          ; preds = %scalar.ph99
  br label %._crit_edge.us

._crit_edge.us.loopexit1:                         ; preds = %vector.body97
  br label %._crit_edge.us
...
scalar.ph132:                                     ; preds = %scalar.ph132, %scalar.ph132.preheader
  %indvars.iv = phi i64 [ 0, %scalar.ph132.preheader ], [ %indvars.iv.next.7, %scalar.ph132 ]
  ...
  br i1 %exitcond.7, label %.preheader2.us.preheader.loopexit, label %scalar.ph132, !llvm.loop !16

.preheader1.us:                                   ; preds = %._crit_edge9.us, %.preheader1.us.preheader
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %._crit_edge9.us ], [ 0, %.preheader1.us.preheader ]
  %scevgep69 = getelementptr [1200 x double], [1200 x double]* %0, i64 %indvars.iv30, i64 1
  %111 = add nuw nsw i64 %indvars.iv30, 1
  %scevgep71 = getelementptr [1200 x double], [1200 x double]* %0, i64 %111, i64 0
  %scevgep73 = getelementptr [1200 x double], [1200 x double]* %2, i64 %indvars.iv30, i64 0
  %scevgep75 = getelementptr [1200 x double], [1200 x double]* %2, i64 %111, i64 0
  ...
  br i1 %memcheck.conflict80, label %scalar.ph66.preheader, label %vector.body64.preheader

vector.body64.preheader:                          ; preds = %.preheader1.us
  br label %vector.body64

vector.body64:                                    ; preds = %vector.body64.preheader, %vector.body64
  %index83 = phi i64 [ %index.next84, %vector.body64 ], [ 0, %vector.body64.preheader ]
  %offset.idx = or i64 %index83, 1
  %112 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv30, i64 %offset.idx
  %113 = bitcast double* %112 to <2 x double>*
  %wide.load91 = load <2 x double>, <2 x double>* %113, align 8, !alias.scope !17, !noalias !20
  %114 = getelementptr double, double* %112, i64 2
  %115 = bitcast double* %114 to <2 x double>*
  %wide.load92 = load <2 x double>, <2 x double>* %115, align 8, !alias.scope !17, !noalias !20
  %116 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv30, i64 %offset.idx
  %117 = bitcast double* %116 to <2 x double>*
  %wide.load93 = load <2 x double>, <2 x double>* %117, align 8, !alias.scope !20
  %118 = getelementptr double, double* %116, i64 2
  %119 = bitcast double* %118 to <2 x double>*
  %wide.load94 = load <2 x double>, <2 x double>* %119, align 8, !alias.scope !20
  %120 = add nsw i64 %offset.idx, -1
  %121 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv30, i64 %120
  %122 = bitcast double* %121 to <2 x double>*
  %wide.load95 = load <2 x double>, <2 x double>* %122, align 8, !alias.scope !20
  %123 = getelementptr double, double* %121, i64 2
  %124 = bitcast double* %123 to <2 x double>*
  %wide.load96 = load <2 x double>, <2 x double>* %124, align 8, !alias.scope !20
  %125 = fsub <2 x double> %wide.load93, %wide.load95
  %126 = fsub <2 x double> %wide.load94, %wide.load96
  ...
  %129 = fsub <2 x double> %wide.load91, %127
  %130 = fsub <2 x double> %wide.load92, %128
  ...
  %index.next84 = add nuw nsw i64 %index83, 4
  %133 = icmp eq i64 %index.next84, 1196
  br i1 %133, label %scalar.ph66.preheader.loopexit, label %vector.body64, !llvm.loop !22

scalar.ph66.preheader.loopexit:                   ; preds = %vector.body64
  br label %scalar.ph66.preheader

scalar.ph66.preheader:                            ; preds = %scalar.ph66.preheader.loopexit, %.preheader1.us
  %indvars.iv27.ph = phi i64 [ 1, %.preheader1.us ], [ 1197, %scalar.ph66.preheader.loopexit ]
  br i1 true, label %scalar.ph66.prol.preheader, label %scalar.ph66.prol.loopexit.unr-lcssa

scalar.ph66.prol.preheader:                       ; preds = %scalar.ph66.preheader
  br label %scalar.ph66.prol

scalar.ph66.prol:                                 ; preds = %scalar.ph66.prol.preheader
  %134 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv30, i64 %indvars.iv27.ph
  %135 = load double, double* %134, align 8
  %136 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv30, i64 %indvars.iv27.ph
  %137 = load double, double* %136, align 8
  %138 = add nsw i64 %indvars.iv27.ph, -1
  %139 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv30, i64 %138
  ...
  br label %scalar.ph66.prol.loopexit.unr-lcssa

scalar.ph66.prol.loopexit.unr-lcssa:              ; preds = %scalar.ph66.preheader, %scalar.ph66.prol
  %indvars.iv27.unr.ph = phi i64 [ %indvars.iv.next28.prol, %scalar.ph66.prol ], [ %indvars.iv27.ph, %scalar.ph66.preheader ]
  br label %scalar.ph66.prol.loopexit

scalar.ph66.prol.loopexit:                        ; preds = %scalar.ph66.prol.loopexit.unr-lcssa
  br i1 false, label %._crit_edge9.us, label %scalar.ph66.preheader.new
...
scalar.ph66:                                      ; preds = %scalar.ph66, %scalar.ph66.preheader.new
  %indvars.iv27 = phi i64 [ %indvars.iv27.unr.ph, %scalar.ph66.preheader.new ], [ %indvars.iv.next28.1, %scalar.ph66 ]
  %144 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv30, i64 %indvars.iv27
  %145 = load double, double* %144, align 8
  %146 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv30, i64 %indvars.iv27
  %147 = load double, double* %146, align 8
  %148 = add nsw i64 %indvars.iv27, -1
  %149 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv30, i64 %148
  ...
  %154 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv30, i64 %indvars.iv.next28
  %155 = load double, double* %154, align 8
  %156 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv30, i64 %indvars.iv.next28
  %157 = load double, double* %156, align 8
  %158 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv30, i64 %indvars.iv27
  %159 = load double, double* %158, align 8
  %160 = fsub double %157, %159
  %161 = fmul double %160, 5.000000e-01
  %162 = fsub double %155, %161
  store double %162, double* %154, align 8
  %exitcond29.1 = icmp eq i64 %indvars.iv.next28, 1199
  %indvars.iv.next28.1 = add nsw i64 %indvars.iv27, 2
  br i1 %exitcond29.1, label %._crit_edge9.us.unr-lcssa, label %scalar.ph66, !llvm.loop !23

._crit_edge9.us.unr-lcssa:                        ; preds = %scalar.ph66
  br label %._crit_edge9.us

._crit_edge9.us:                                  ; preds = %scalar.ph66.prol.loopexit, %._crit_edge9.us.unr-lcssa
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  %exitcond4 = icmp eq i64 %indvars.iv.next31, 1000
...
.preheader.us:                                    ; preds = %._crit_edge11.us, %.preheader.us.preheader
  ...
  %scevgep41 = getelementptr [1200 x double], [1200 x double]* %2, i64 %indvars.iv36, i64 1199
  %scevgep43 = getelementptr [1200 x double], [1200 x double]* %0, i64 %indvars.iv36, i64 0
  %163 = add nuw nsw i64 %indvars.iv36, 1
  %scevgep45 = getelementptr [1200 x double], [1200 x double]* %0, i64 %163, i64 0
  %scevgep47 = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv36, i64 0
  %scevgep49 = getelementptr [1200 x double], [1200 x double]* %1, i64 %163, i64 1199
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  %bound0 = icmp ult double* %scevgep, %scevgep45
  %bound1 = icmp ult double* %scevgep43, %scevgep41
  %found.conflict = and i1 %bound0, %bound1
  %bound051 = icmp ult double* %scevgep, %scevgep49
  %bound152 = icmp ult double* %scevgep47, %scevgep41
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %164 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv36, i64 %index
  ...
  %wide.load55 = load <2 x double>, <2 x double>* %167, align 8, !alias.scope !24, !noalias !27
  %168 = or i64 %index, 1
  %169 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv36, i64 %168
  %170 = bitcast double* %169 to <2 x double>*
  %wide.load56 = load <2 x double>, <2 x double>* %170, align 8, !alias.scope !30
  %171 = getelementptr double, double* %169, i64 2
  %172 = bitcast double* %171 to <2 x double>*
  %wide.load57 = load <2 x double>, <2 x double>* %172, align 8, !alias.scope !30
  %173 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv36, i64 %index
  %174 = bitcast double* %173 to <2 x double>*
  %wide.load58 = load <2 x double>, <2 x double>* %174, align 8, !alias.scope !30
  %175 = getelementptr double, double* %173, i64 2
  %176 = bitcast double* %175 to <2 x double>*
  %wide.load59 = load <2 x double>, <2 x double>* %176, align 8, !alias.scope !30
  %177 = fsub <2 x double> %wide.load56, %wide.load58
  %178 = fsub <2 x double> %wide.load57, %wide.load59
  %179 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next37, i64 %index
  %180 = bitcast double* %179 to <2 x double>*
  %wide.load60 = load <2 x double>, <2 x double>* %180, align 8, !alias.scope !31
  %181 = getelementptr double, double* %179, i64 2
  %182 = bitcast double* %181 to <2 x double>*
  %wide.load61 = load <2 x double>, <2 x double>* %182, align 8, !alias.scope !31
  %183 = fadd <2 x double> %177, %wide.load60
  %184 = fadd <2 x double> %178, %wide.load61
  %185 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv36, i64 %index
  %186 = bitcast double* %185 to <2 x double>*
  %wide.load62 = load <2 x double>, <2 x double>* %186, align 8, !alias.scope !31
  %187 = getelementptr double, double* %185, i64 2
  %188 = bitcast double* %187 to <2 x double>*
  %wide.load63 = load <2 x double>, <2 x double>* %188, align 8, !alias.scope !31
  %189 = fsub <2 x double> %183, %wide.load62
  %190 = fsub <2 x double> %184, %wide.load63
  ...
  %194 = fsub <2 x double> %wide.load55, %192
  ...
  br i1 %197, label %._crit_edge19.preheader.loopexit, label %vector.body, !llvm.loop !32
...
._crit_edge19.preheader:                          ; preds = %._crit_edge19.preheader.loopexit, %.preheader.us
  %indvars.iv33.ph = phi i64 [ 0, %.preheader.us ], [ 1196, %._crit_edge19.preheader.loopexit ]
  br label %._crit_edge19

._crit_edge19:                                    ; preds = %._crit_edge19.preheader, %._crit_edge19
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %._crit_edge19 ], [ %indvars.iv33.ph, %._crit_edge19.preheader ]
  %198 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv36, i64 %indvars.iv33
  %199 = load double, double* %198, align 8
  %indvars.iv.next34 = add nuw nsw i64 %indvars.iv33, 1
  %200 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv36, i64 %indvars.iv.next34
  %201 = load double, double* %200, align 8
  %202 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv36, i64 %indvars.iv33
  %203 = load double, double* %202, align 8
  %204 = fsub double %201, %203
  %205 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next37, i64 %indvars.iv33
  %206 = load double, double* %205, align 8
  %207 = fadd double %204, %206
  %208 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv36, i64 %indvars.iv33
  %209 = load double, double* %208, align 8
  %210 = fsub double %207, %209
  %211 = fmul double %210, 7.000000e-01
  %212 = fsub double %199, %211
  store double %212, double* %198, align 8
  %exitcond35 = icmp eq i64 %indvars.iv33, 1198
  br i1 %exitcond35, label %._crit_edge11.us, label %._crit_edge19, !llvm.loop !33

._crit_edge11.us:                                 ; preds = %._crit_edge19
  %exitcond5 = icmp eq i64 %indvars.iv.next37, 999
  br i1 %exitcond5, label %._crit_edge12, label %.preheader.us

._crit_edge12:                                    ; preds = %._crit_edge11.us
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  %exitcond6 = icmp eq i64 %indvars.iv.next39, 500
  br i1 %exitcond6, label %._crit_edge13, label %.lr.ph
...
.preheader8.us:                                   ; preds = %._crit_edge17.us, %.preheader8.us.preheader
  %indvars.iv31 = phi i64 [ 0, %.preheader8.us.preheader ], [ %indvars.iv.next32, %._crit_edge17.us ]
  %7 = mul nuw nsw i64 %indvars.iv31, 1000
  br label %._crit_edge.us._crit_edge

._crit_edge.us._crit_edge:                        ; preds = %._crit_edge.us, %.preheader8.us
  %indvars.iv29 = phi i64 [ 0, %.preheader8.us ], [ %indvars.iv.next30, %._crit_edge.us ]
...
._crit_edge17.us:                                 ; preds = %._crit_edge.us
  ...
  br i1 %exitcond5, label %.preheader7.us.preheader, label %.preheader8.us

.preheader7.us.preheader:                         ; preds = %._crit_edge17.us
...
.preheader7.us:                                   ; preds = %._crit_edge14.us, %.preheader7.us.preheader
  %indvars.iv26 = phi i64 [ 0, %.preheader7.us.preheader ], [ %indvars.iv.next27, %._crit_edge14.us ]
  %24 = mul nuw nsw i64 %indvars.iv26, 1000
  br label %._crit_edge9.us._crit_edge

._crit_edge9.us._crit_edge:                       ; preds = %._crit_edge9.us, %.preheader7.us
  %indvars.iv24 = phi i64 [ 0, %.preheader7.us ], [ %indvars.iv.next25, %._crit_edge9.us ]
  %25 = add nuw nsw i64 %indvars.iv24, %24
  %26 = trunc i64 %25 to i32
  %27 = srem i32 %26, 20
  %28 = icmp eq i32 %27, 0
  br i1 %28, label %29, label %._crit_edge9.us

; <label>:29:                                     ; preds = %._crit_edge9.us._crit_edge
  %30 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %fputc3.us = tail call i32 @fputc(i32 10, %struct._IO_FILE* %30) #4
  br label %._crit_edge9.us

._crit_edge9.us:                                  ; preds = %._crit_edge9.us._crit_edge, %29
  ...
  br i1 %exitcond2, label %._crit_edge14.us, label %._crit_edge9.us._crit_edge

._crit_edge14.us:                                 ; preds = %._crit_edge9.us
...
._crit_edge10.us._crit_edge:                      ; preds = %._crit_edge10.us, %.preheader.us
  %indvars.iv = phi i64 [ 0, %.preheader.us ], [ %indvars.iv.next, %._crit_edge10.us ]
  %40 = add nuw nsw i64 %indvars.iv, %39
  %41 = trunc i64 %40 to i32
  %42 = srem i32 %41, 20
  %43 = icmp eq i32 %42, 0
  br i1 %43, label %44, label %._crit_edge10.us

; <label>:44:                                     ; preds = %._crit_edge10.us._crit_edge
  %45 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %fputc.us = tail call i32 @fputc(i32 10, %struct._IO_FILE* %45) #4
  br label %._crit_edge10.us

._crit_edge10.us:                                 ; preds = %._crit_edge10.us._crit_edge, %44
  ...
  br i1 %exitcond, label %._crit_edge11.us, label %._crit_edge10.us._crit_edge

._crit_edge11.us:                                 ; preds = %._crit_edge10.us
