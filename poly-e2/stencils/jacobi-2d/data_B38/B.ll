...
for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.cond4.for.inc37_crit_edge.us
  ...
  %0 = add i64 %indvar55, 1
  %scevgep57 = getelementptr [1300 x double], [1300 x double]* %B, i64 %0, i64 1
  %scevgep59 = getelementptr [1300 x double], [1300 x double]* %B, i64 %0, i64 1299
  %scevgep61 = getelementptr [1300 x double], [1300 x double]* %A, i64 %indvar55, i64 1
  %1 = add i64 %indvar55, 2
  %scevgep63 = getelementptr [1300 x double], [1300 x double]* %A, i64 %1, i64 1299
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %2 = add nsw i64 %indvars.iv12, -1
  br i1 false, label %for.inc.us.preheader, label %min.iters.checked50

min.iters.checked50:                              ; preds = %for.cond4.preheader.us
  br i1 false, label %for.inc.us.preheader, label %vector.memcheck69
...
vector.body46:                                    ; preds = %vector.body46.preheader, %vector.body46
  ...
  %3 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv12, i64 %offset.idx76
  %4 = bitcast double* %3 to <2 x double>*
  %wide.load81 = load <2 x double>, <2 x double>* %4, align 8, !alias.scope !1
  %5 = getelementptr double, double* %3, i64 2
  %6 = bitcast double* %5 to <2 x double>*
  %wide.load82 = load <2 x double>, <2 x double>* %6, align 8, !alias.scope !1
  %7 = add nsw i64 %offset.idx76, -1
  %8 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv12, i64 %7
  %9 = bitcast double* %8 to <2 x double>*
  %wide.load83 = load <2 x double>, <2 x double>* %9, align 8, !alias.scope !1
  %10 = getelementptr double, double* %8, i64 2
  %11 = bitcast double* %10 to <2 x double>*
  %wide.load84 = load <2 x double>, <2 x double>* %11, align 8, !alias.scope !1
  %12 = fadd <2 x double> %wide.load81, %wide.load83
  %13 = fadd <2 x double> %wide.load82, %wide.load84
  %14 = add nuw nsw i64 %offset.idx76, 1
  ...
  %19 = fadd <2 x double> %12, %wide.load85
  %20 = fadd <2 x double> %13, %wide.load86
  ...
  %27 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %2, i64 %offset.idx76
  ...
  %39 = icmp eq i64 %index.next72, 1296
  br i1 %39, label %middle.block47, label %vector.body46, !llvm.loop !6

middle.block47:                                   ; preds = %vector.body46
  br i1 false, label %for.cond4.for.inc37_crit_edge.us, label %for.inc.us.preheader

for.inc.us.preheader:                             ; preds = %middle.block47, %vector.memcheck69, %min.iters.checked50, %for.cond4.preheader.us
  %indvars.iv.ph = phi i64 [ 1, %vector.memcheck69 ], [ 1, %min.iters.checked50 ], [ 1, %for.cond4.preheader.us ], [ 1297, %middle.block47 ]
  br label %for.inc.us
...
for.cond44.preheader.us:                          ; preds = %for.cond44.preheader.us.preheader, %for.cond44.for.inc84_crit_edge.us
  ...
  %scevgep30 = getelementptr [1300 x double], [1300 x double]* %A, i64 %46, i64 1299
  %scevgep32 = getelementptr [1300 x double], [1300 x double]* %B, i64 %indvar, i64 1
  %47 = add i64 %indvar, 2
  %scevgep34 = getelementptr [1300 x double], [1300 x double]* %B, i64 %47, i64 1299
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  %48 = add nsw i64 %indvars.iv22, -1
  br i1 false, label %for.inc81.us.preheader, label %min.iters.checked

min.iters.checked:                                ; preds = %for.cond44.preheader.us
  br i1 false, label %for.inc81.us.preheader, label %vector.memcheck
...
middle.block:                                     ; preds = %vector.body
  br i1 false, label %for.cond44.for.inc84_crit_edge.us, label %for.inc81.us.preheader
...
for.cond2.for.inc10_crit_edge.us:                 ; preds = %for.inc.us
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %exitcond11 = icmp eq i64 %indvars.iv.next8, 1300
