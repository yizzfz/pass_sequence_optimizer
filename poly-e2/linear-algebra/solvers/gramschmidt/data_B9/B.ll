...
for.cond19.for.inc30_crit_edge.us.3.prol.loopexit: ; preds = %for.cond19.for.inc30_crit_edge.us.3.prol.preheader, %for.cond19.for.inc30_crit_edge.us.3.preheader
  %indvars.iv.unr31 = phi i64 [ %indvars.iv.unr, %for.cond19.for.inc30_crit_edge.us.3.preheader ], [ %indvars.iv.next.3.prol, %for.cond19.for.inc30_crit_edge.us.3.prol.preheader ]
  %16 = icmp eq i64 %14, 0
...
for.body3.prol:                                   ; preds = %for.body3.prol.preheader, %for.body3.prol.for.body3.prol_crit_edge
  ...
  %prol.iter = phi i32 [ %prol.iter.sub, %for.body3.prol.for.body3.prol_crit_edge ], [ %4, %for.body3.prol.preheader ]
...
for.body3.prol.loopexit:                          ; preds = %for.body3.prol.loopexit.loopexit, %for.body3.lr.ph
  ...
  br i1 %9, label %for.end, label %for.body3.preheader
