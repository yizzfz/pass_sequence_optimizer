...
.prol.loopexit25:                                 ; preds = %.lr.ph9, %.prol.preheader24
...
.lr.ph5.split.prol.loopexit:                      ; preds = %.lr.ph5.split.preheader, %.lr.ph5.split.prol
  ...
  %14 = icmp eq i32 %1, 1
  br i1 %14, label %._crit_edge6, label %.lr.ph5.split.preheader28
...
.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph5.split.us
  ...
  %25 = icmp eq i32 %0, 1
  br i1 %25, label %._crit_edge.us, label %.lr.ph5.split.us.new.preheader
...
.lr.ph9.new:                                      ; preds = %.lr.ph9.new.preheader, %.lr.ph9.new
  ...
  %38 = trunc i64 %indvars.iv20 to i32
  %39 = sitofp i32 %38 to double
  %40 = fdiv double %39, %7
  %41 = getelementptr inbounds double, double* %4, i64 %indvars.iv20
  store double %40, double* %41, align 8
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  %42 = trunc i64 %indvars.iv.next21 to i32
  %43 = sitofp i32 %42 to double
  %44 = fdiv double %43, %7
  %45 = getelementptr inbounds double, double* %4, i64 %indvars.iv.next21
...
.lr.ph5.split:                                    ; preds = %.lr.ph5.split.preheader28, %.lr.ph5.split
  ...
  %46 = trunc i64 %indvars.iv14 to i32
  %47 = sitofp i32 %46 to double
  %48 = fdiv double %47, %11
  %49 = getelementptr inbounds double, double* %3, i64 %indvars.iv14
  store double %48, double* %49, align 8
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  %50 = trunc i64 %indvars.iv.next15 to i32
  %51 = sitofp i32 %50 to double
  %52 = fdiv double %51, %11
  %53 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next15
...
; <label>:17:                                     ; preds = %17, %.lr.ph4.split.us
  ...
  %sunkaddr22 = mul i64 %indvars.iv10, 8
  ...
  %sunkaddr26 = mul i64 %indvars.iv10, 8
