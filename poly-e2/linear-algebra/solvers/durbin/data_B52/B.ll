...
for.body:                                         ; preds = %for.end44.for.body_crit_edge, %entry
  %indvars.iv = phi i2 [ %indvars.iv.next10, %for.end44.for.body_crit_edge ], [ 1, %entry ]
...
for.inc.prol.loopexit:                            ; preds = %for.inc.prol.loopexit.loopexit, %for.body
  ...
  %indvars.iv21.unr = phi i64 [ 0, %for.body ], [ %6, %for.inc.prol.loopexit.loopexit ]
...
for.body21.preheader:                             ; preds = %for.body21.prol.loopexit
  %31 = sub i64 %7, %indvars.iv523.unr.ph
  %32 = lshr i64 %31, 1
  %33 = add nuw i64 %32, 1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %strided.vec2 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  ...
  %wide.vec3 = load <4 x double>, <4 x double>* %44, align 8
  %strided.vec4 = shufflevector <4 x double> %wide.vec3, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %reverse = shufflevector <2 x double> %strided.vec4, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %strided.vec5 = shufflevector <4 x double> %wide.vec3, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %reverse6 = shufflevector <2 x double> %strided.vec5, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %45 = fmul <2 x double> %broadcast.splat8, %reverse6
  %46 = fadd <2 x double> %strided.vec, %45
  %47 = add nuw nsw i64 %offset.idx, 1
  %48 = fmul <2 x double> %broadcast.splat8, %reverse
  %49 = fadd <2 x double> %strided.vec2, %48
...
for.body21:                                       ; preds = %for.body21.preheader9, %for.body21
  %indvars.iv523 = phi i64 [ %indvars.iv.next6.1, %for.body21 ], [ %indvars.iv523.ph, %for.body21.preheader9 ]
