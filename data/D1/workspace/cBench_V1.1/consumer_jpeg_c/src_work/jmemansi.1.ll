...
define noalias i8* @jpeg_get_small(%struct.jpeg_common_struct* nocapture readnone, i64) local_unnamed_addr #0 {
...
; Function Attrs: noinline nounwind uwtable
define void @jpeg_free_small(%struct.jpeg_common_struct* nocapture readnone, i8* nocapture, i64) local_unnamed_addr #0 {
...
; Function Attrs: noinline nounwind uwtable
define noalias i8* @jpeg_get_large(%struct.jpeg_common_struct* nocapture readnone, i64) local_unnamed_addr #0 {
  %3 = tail call noalias i8* @malloc(i64 %1) #5
  ret i8* %3
}

; Function Attrs: noinline nounwind uwtable
define void @jpeg_free_large(%struct.jpeg_common_struct* nocapture readnone, i8* nocapture, i64) local_unnamed_addr #0 {
  tail call void @free(i8* %1) #5
  ret void
}

; Function Attrs: noinline norecurse nounwind readonly uwtable
define i64 @jpeg_mem_available(%struct.jpeg_common_struct* nocapture readonly, i64, i64, i64) local_unnamed_addr #2 {
...
; Function Attrs: noinline nounwind uwtable
define void @jpeg_open_backing_store(%struct.jpeg_common_struct*, %struct.backing_store_struct* nocapture, i64) local_unnamed_addr #0 {
...
; Function Attrs: nounwind
declare noalias %struct._IO_FILE* @tmpfile() local_unnamed_addr #1
...
; <label>:17:                                     ; preds = %5, %10
  %sunkaddr = ptrtoint %struct.backing_store_struct* %1 to i64
  %sunkaddr1 = add i64 %sunkaddr, 24
  %sunkaddr2 = inttoptr i64 %sunkaddr1 to %struct._IO_FILE**
  %18 = load %struct._IO_FILE*, %struct._IO_FILE** %sunkaddr2, align 8
...
; <label>:21:                                     ; preds = %17
  ...
  %25 = bitcast %struct.jpeg_common_struct* %0 to void (%struct.jpeg_common_struct*)***
...
define i64 @jpeg_mem_init(%struct.jpeg_common_struct* nocapture readnone) local_unnamed_addr #3 {
  ret i64 1000000
}

; Function Attrs: noinline norecurse nounwind readnone uwtable
define void @jpeg_mem_term(%struct.jpeg_common_struct* nocapture) local_unnamed_addr #3 {
  ret void
}
