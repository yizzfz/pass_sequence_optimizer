...
.lr.ph24.split.us:                                ; preds = %._crit_edge21.us, %.lr.ph24.split.us.preheader
  ...
  %sunkaddr5 = shl i64 %indvars.iv60, 3
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph24.split.us
  %5 = phi double [ 0.000000e+00, %.lr.ph24.split.us ], [ %17, %._crit_edge ]
  ...
  %8 = fadd double %7, %5
  store double %8, double* %sunkaddr7, align 8
  ...
  %11 = fadd double %10, %8
  store double %11, double* %sunkaddr7, align 8
  ...
  store double %14, double* %sunkaddr7, align 8
  ...
  store double %17, double* %sunkaddr7, align 8
...
._crit_edge21.us:                                 ; preds = %._crit_edge
  %18 = fdiv double %17, %0
  %sunkaddr29 = shl i64 %indvars.iv60, 3
...
vector.memcheck:                                  ; preds = %._crit_edge16.us, %._crit_edge21.us..preheader6.us_crit_edge
  %indvars.iv53 = phi i64 [ 0, %._crit_edge21.us..preheader6.us_crit_edge ], [ %19, %._crit_edge16.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv53, i64 0
  %19 = add i64 %indvars.iv53, 1
  %scevgep14 = getelementptr [1200 x double], [1200 x double]* %1, i64 %19, i64 0
...
._crit_edge1.preheader:                           ; preds = %vector.memcheck
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.vec21 = load <8 x double>, <8 x double>* %23, align 8, !alias.scope !4, !noalias !1
  %24 = fsub <8 x double> %wide.vec21, %wide.vec
  ...
  br i1 %35, label %._crit_edge16.us.loopexit32, label %vector.body, !llvm.loop !6

._crit_edge1:                                     ; preds = %._crit_edge1.preheader, %._crit_edge1
  %indvars.iv50 = phi i64 [ %indvars.iv.next51.3, %._crit_edge1 ], [ 0, %._crit_edge1.preheader ]
  ...
  br i1 %exitcond52.3, label %._crit_edge16.us.loopexit, label %._crit_edge1, !llvm.loop !9

._crit_edge16.us.loopexit:                        ; preds = %._crit_edge1
  br label %._crit_edge16.us

._crit_edge16.us.loopexit32:                      ; preds = %vector.body
  br label %._crit_edge16.us

._crit_edge16.us:                                 ; preds = %._crit_edge16.us.loopexit32, %._crit_edge16.us.loopexit
  %exitcond55 = icmp eq i64 %19, 1400
  br i1 %exitcond55, label %.preheader.us.preheader, label %vector.memcheck
...
._crit_edge2:                                     ; preds = %._crit_edge2, %.lr.ph.us.us
  %60 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %72, %._crit_edge2 ]
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %._crit_edge2 ]
