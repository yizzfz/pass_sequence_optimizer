...
._crit_edge:                                      ; preds = %._crit_edge, %2
  ...
  br i1 %exitcond6.2, label %.preheader1.preheader.preheader, label %._crit_edge

.preheader1.preheader.preheader:                  ; preds = %._crit_edge
  br label %.preheader1.preheader

.preheader1.preheader:                            ; preds = %.preheader1.preheader.preheader, %.preheader
  %indvars.iv13 = phi i64 [ %indvars.iv.next2, %.preheader ], [ 0, %.preheader1.preheader.preheader ]
  br label %.preheader1

.preheader1:                                      ; preds = %.preheader1, %.preheader1.preheader
  %indvars.iv2 = phi i64 [ 0, %.preheader1.preheader ], [ %indvars.iv.next.1, %.preheader1 ]
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal void @kernel_atax([2100 x double]* nocapture readonly, double* nocapture readonly, double* nocapture, double*) #2 {
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %4
  %indvars.iv711 = phi i64 [ 0, %4 ], [ %indvars.iv.next8.11, %._crit_edge ]
  %5 = getelementptr inbounds double, double* %2, i64 %indvars.iv711
  store double 0.000000e+00, double* %5, align 8
  %indvars.iv.next8 = or i64 %indvars.iv711, 1
  %6 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8
  store double 0.000000e+00, double* %6, align 8
  %indvars.iv.next8.1 = or i64 %indvars.iv711, 2
  %7 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.1
  store double 0.000000e+00, double* %7, align 8
  %indvars.iv.next8.2 = or i64 %indvars.iv711, 3
  ...
  %indvars.iv.next8.5 = add nsw i64 %indvars.iv711, 6
  %11 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.5
  store double 0.000000e+00, double* %11, align 8
  %indvars.iv.next8.6 = add nsw i64 %indvars.iv711, 7
  %12 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.6
  store double 0.000000e+00, double* %12, align 8
  %indvars.iv.next8.7 = add nsw i64 %indvars.iv711, 8
  %13 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.7
  store double 0.000000e+00, double* %13, align 8
  %indvars.iv.next8.8 = add nsw i64 %indvars.iv711, 9
  %14 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.8
  store double 0.000000e+00, double* %14, align 8
  %indvars.iv.next8.9 = add nsw i64 %indvars.iv711, 10
  %15 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.9
  store double 0.000000e+00, double* %15, align 8
  %indvars.iv.next8.10 = add nsw i64 %indvars.iv711, 11
  %16 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.10
  store double 0.000000e+00, double* %16, align 8
  %indvars.iv.next8.11 = add nsw i64 %indvars.iv711, 12
  %exitcond9.11 = icmp eq i64 %indvars.iv.next8.11, 2100
  br i1 %exitcond9.11, label %._crit_edge14.preheader, label %._crit_edge

._crit_edge14.preheader:                          ; preds = %._crit_edge
  %sunkaddr = ptrtoint double* %3 to i64
  %sunkaddr.1 = ptrtoint double* %3 to i64
  %sunkaddr15 = ptrtoint double* %3 to i64
  br label %._crit_edge14

._crit_edge14:                                    ; preds = %._crit_edge14.preheader, %39
  %indvars.iv410 = phi i64 [ %indvars.iv.next5, %39 ], [ 0, %._crit_edge14.preheader ]
  %17 = getelementptr inbounds double, double* %3, i64 %indvars.iv410
  store double 0.000000e+00, double* %17, align 8
  %sunkaddr1 = shl nuw nsw i64 %indvars.iv410, 3
  %sunkaddr2 = add i64 %sunkaddr, %sunkaddr1
  %sunkaddr3 = inttoptr i64 %sunkaddr2 to double*
  %sunkaddr1.1 = shl nuw nsw i64 %indvars.iv410, 3
  %sunkaddr2.1 = add i64 %sunkaddr.1, %sunkaddr1.1
  %sunkaddr3.1 = inttoptr i64 %sunkaddr2.1 to double*
  br label %._crit_edge12

._crit_edge12:                                    ; preds = %._crit_edge12, %._crit_edge14
  %indvars.iv8 = phi i64 [ 0, %._crit_edge14 ], [ %indvars.iv.next.1, %._crit_edge12 ]
  %18 = load double, double* %sunkaddr3, align 8
  %19 = getelementptr inbounds [2100 x double], [2100 x double]* %0, i64 %indvars.iv410, i64 %indvars.iv8
  %20 = load double, double* %19, align 8
  %21 = getelementptr inbounds double, double* %1, i64 %indvars.iv8
  %22 = load double, double* %21, align 8
  %23 = fmul double %20, %22
  %24 = fadd double %18, %23
  store double %24, double* %sunkaddr3, align 8
  %indvars.iv.next = or i64 %indvars.iv8, 1
  %25 = load double, double* %sunkaddr3.1, align 8
  %26 = getelementptr inbounds [2100 x double], [2100 x double]* %0, i64 %indvars.iv410, i64 %indvars.iv.next
  %27 = load double, double* %26, align 8
  %28 = getelementptr inbounds double, double* %1, i64 %indvars.iv.next
  %29 = load double, double* %28, align 8
  %30 = fmul double %27, %29
  %31 = fadd double %25, %30
  store double %31, double* %sunkaddr3.1, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv8, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2100
  br i1 %exitcond.1, label %.preheader.preheader, label %._crit_edge12

.preheader.preheader:                             ; preds = %._crit_edge12
  %sunkaddr16 = mul i64 %indvars.iv410, 8
  %sunkaddr17 = add i64 %sunkaddr15, %sunkaddr16
  %sunkaddr18 = inttoptr i64 %sunkaddr17 to double*
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge13
  %32 = phi double [ %.pre, %._crit_edge13 ], [ %31, %.preheader.preheader ]
  %indvars.iv19 = phi i64 [ %indvars.iv.next2, %._crit_edge13 ], [ 0, %.preheader.preheader ]
  %33 = getelementptr inbounds double, double* %2, i64 %indvars.iv19
  %34 = load double, double* %33, align 8
  %35 = getelementptr inbounds [2100 x double], [2100 x double]* %0, i64 %indvars.iv410, i64 %indvars.iv19
  ...
  br i1 %exitcond3, label %39, label %._crit_edge13

._crit_edge13:                                    ; preds = %.preheader
  %.pre = load double, double* %sunkaddr18, align 8
  br label %.preheader

; <label>:39:                                     ; preds = %.preheader
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv410, 1
  %exitcond6 = icmp eq i64 %indvars.iv.next5, 1900
  br i1 %exitcond6, label %40, label %._crit_edge14
