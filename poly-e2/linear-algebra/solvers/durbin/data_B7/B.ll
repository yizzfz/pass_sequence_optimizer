...
for.inc.lr.ph:                                    ; preds = %for.inc47.for.inc.lr.ph_crit_edge, %entry
  %indvars.iv42 = phi i64 [ 1, %entry ], [ %indvars.iv.next43, %for.inc47.for.inc.lr.ph_crit_edge ]
  %indvars.iv29 = phi i64 [ 1, %entry ], [ %indvars.iv.next30, %for.inc47.for.inc.lr.ph_crit_edge ]
  %indvar = phi i64 [ 0, %entry ], [ %indvar.next, %for.inc47.for.inc.lr.ph_crit_edge ]
  %alpha.09 = phi double [ %sub3, %entry ], [ %div, %for.inc47.for.inc.lr.ph_crit_edge ]
  %beta.08 = phi double [ 1.000000e+00, %entry ], [ %mul5, %for.inc47.for.inc.lr.ph_crit_edge ]
  %6 = add nsw i64 %indvar, -1
  %7 = and i64 %indvars.iv42, 3
  %8 = shl i64 %indvar, 3
...
for.inc32.preheader:                              ; preds = %for.inc32.prol.loopexit
  %32 = insertelement <2 x double> undef, double %div, i32 0
  %mul28.v.i0.2 = shufflevector <2 x double> %32, <2 x double> undef, <2 x i32> zeroinitializer
  %33 = sub i64 %6, %indvars.iv14.unr.ph
  %34 = lshr i64 %33, 1
  %35 = and i64 %34, 1
  %lcmp.mod46 = icmp eq i64 %35, 0
  br i1 %lcmp.mod46, label %for.inc32.prol.preheader, label %for.inc32.prol.loopexit44.unr-lcssa

for.inc32.prol.preheader:                         ; preds = %for.inc32.preheader
  br label %for.inc32.prol47

for.inc32.prol47:                                 ; preds = %for.inc32.prol.preheader
  %arrayidx23.prol = getelementptr inbounds double, double* %y, i64 %indvars.iv14.unr.ph
  %36 = bitcast double* %arrayidx23.prol to <2 x double>*
  %arrayidx31.prol = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %indvars.iv14.unr.ph
  %indvars.iv.next15.prol = add nuw nsw i64 %indvars.iv14.unr.ph, 1
  %37 = load <2 x double>, <2 x double>* %36, align 8
  %38 = sub nsw i64 %27, %indvars.iv.next15.prol
  %arrayidx27.1.prol = getelementptr inbounds double, double* %y, i64 %38
  %39 = bitcast double* %arrayidx27.1.prol to <2 x double>*
  %40 = load <2 x double>, <2 x double>* %39, align 8
  %mul28.1.prol = fmul <2 x double> %mul28.v.i0.2, %40
  %add29.v.i1.prol = shufflevector <2 x double> %mul28.1.prol, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %add29.prol48 = fadd <2 x double> %37, %add29.v.i1.prol
  %41 = bitcast double* %arrayidx31.prol to <2 x double>*
  store <2 x double> %add29.prol48, <2 x double>* %41, align 8
  %indvars.iv.next15.1.prol = or i64 %indvars.iv14.unr.ph, 2
  br label %for.inc32.prol.loopexit44.unr-lcssa

for.inc32.prol.loopexit44.unr-lcssa:              ; preds = %for.inc32.preheader, %for.inc32.prol47
  %indvars.iv14.unr.ph49 = phi i64 [ %indvars.iv.next15.1.prol, %for.inc32.prol47 ], [ %indvars.iv14.unr.ph, %for.inc32.preheader ]
  br label %for.inc32.prol.loopexit44

for.inc32.prol.loopexit44:                        ; preds = %for.inc32.prol.loopexit44.unr-lcssa
  %42 = icmp eq i64 %34, 0
  br i1 %42, label %for.inc47.loopexit, label %for.inc32.preheader.new

for.inc32.preheader.new:                          ; preds = %for.inc32.prol.loopexit44
  br label %for.inc32

for.inc32:                                        ; preds = %for.inc32, %for.inc32.preheader.new
  %indvars.iv14 = phi i64 [ %indvars.iv14.unr.ph49, %for.inc32.preheader.new ], [ %indvars.iv.next15.1.1, %for.inc32 ]
  ...
  %45 = sub nsw i64 %27, %indvars.iv.next15
  ...
  %arrayidx23.1 = getelementptr inbounds double, double* %y, i64 %indvars.iv.next15.1
  %49 = bitcast double* %arrayidx23.1 to <2 x double>*
  %arrayidx31.1 = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %indvars.iv.next15.1
  %indvars.iv.next15.150 = add nsw i64 %indvars.iv14, 3
  %50 = load <2 x double>, <2 x double>* %49, align 8
  %51 = sub nsw i64 %27, %indvars.iv.next15.150
  ...
  %mul28.1.1 = fmul <2 x double> %mul28.v.i0.2, %53
  ...
  %exitcond20.1.1 = icmp eq i64 %indvars.iv.next15.1.1, %indvars.iv29
  br i1 %exitcond20.1.1, label %for.inc47.loopexit.unr-lcssa, label %for.inc32

for.inc47.loopexit.unr-lcssa:                     ; preds = %for.inc32
  br label %for.inc47.loopexit

for.inc47.loopexit:                               ; preds = %for.inc32.prol.loopexit44, %for.inc47.loopexit.unr-lcssa
  br label %for.inc47
