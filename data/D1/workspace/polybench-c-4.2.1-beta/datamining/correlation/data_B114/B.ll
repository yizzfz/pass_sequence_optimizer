...
; <label>:11:                                     ; preds = %._crit_edge, %.lr.ph55.split.us
  %indvars.iv108 = phi i64 [ 0, %.lr.ph55.split.us ], [ %indvars.iv.next109.1, %._crit_edge ]
  %12 = phi double [ 0.000000e+00, %.lr.ph55.split.us ], [ %18, %._crit_edge ]
  ...
  %exitcond110.1 = icmp eq i64 %indvars.iv.next109.1, 1400
  br i1 %exitcond110.1, label %._crit_edge52.us, label %._crit_edge
...
._crit_edge52.us:                                 ; preds = %11
  %19 = fdiv double %18, %0
  store double %19, double* %sunkaddr128, align 8
...
.lr.ph49.split.us:                                ; preds = %._crit_edge47.us..lr.ph49.split.us_crit_edge, %.lr.ph49.split.us.preheader
  ...
  %22 = phi double* [ %20, %._crit_edge47.us..lr.ph49.split.us_crit_edge ], [ %4, %.lr.ph49.split.us.preheader ]
  %23 = getelementptr inbounds double, double* %22, i64 %indvars.iv15
  ...
  %sunkaddr137 = ptrtoint double* %22 to i64
  %sunkaddr139 = add i64 %sunkaddr137, %sunkaddr134
  %sunkaddr140 = inttoptr i64 %sunkaddr139 to double*
  br label %24

; <label>:24:                                     ; preds = %._crit_edge29, %.lr.ph49.split.us
  %indvars.iv102 = phi i64 [ 0, %.lr.ph49.split.us ], [ %indvars.iv.next103.1, %._crit_edge29 ]
  %25 = phi double [ 0.000000e+00, %.lr.ph49.split.us ], [ %37, %._crit_edge29 ]
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv102, i64 %indvars.iv15
  %27 = load double, double* %26, align 8
  %28 = load double, double* %sunkaddr136, align 8
  %29 = fsub double %27, %28
  %30 = fmul double %29, %29
  %31 = fadd double %30, %25
  store double %31, double* %sunkaddr140, align 8
  %indvars.iv.next103 = or i64 %indvars.iv102, 1
  %32 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next103, i64 %indvars.iv15
  ...
  br i1 %exitcond104.1, label %._crit_edge47.us, label %._crit_edge29

._crit_edge29:                                    ; preds = %24
  br label %24

._crit_edge47.us:                                 ; preds = %24
  %38 = fdiv double %37, %0
  store double %38, double* %sunkaddr140, align 8
  %39 = getelementptr inbounds double, double* %20, i64 %indvars.iv15
  %40 = load double, double* %39, align 8
  %41 = tail call double @sqrt(double %40) #4
  %42 = fcmp ugt double %41, %21
...
._crit_edge11.us:                                 ; preds = %._crit_edge42.us.._crit_edge11.us_crit_edge, %._crit_edge11.us.preheader
  ...
  %44 = phi [1200 x double]* [ %58, %._crit_edge42.us.._crit_edge11.us_crit_edge ], [ %1, %._crit_edge11.us.preheader ]
  br label %45

; <label>:45:                                     ; preds = %._crit_edge30, %._crit_edge11.us
  %indvars.iv98 = phi i64 [ 0, %._crit_edge11.us ], [ %indvars.iv.next99, %._crit_edge30 ]
  %46 = phi [1200 x double]* [ %44, %._crit_edge11.us ], [ %58, %._crit_edge30 ]
  %47 = getelementptr inbounds double, double* %3, i64 %indvars.iv98
  %48 = load double, double* %47, align 8
  %49 = getelementptr inbounds [1200 x double], [1200 x double]* %46, i64 %indvars.iv12, i64 %indvars.iv98
  ...
  %55 = getelementptr inbounds double, double* %54, i64 %indvars.iv98
  %56 = load double, double* %55, align 8
  %57 = fmul double %53, %56
  %58 = load [1200 x double]*, [1200 x double]** %6, align 8
  %59 = getelementptr inbounds [1200 x double], [1200 x double]* %58, i64 %indvars.iv12, i64 %indvars.iv98
  %60 = load double, double* %59, align 8
  %61 = fdiv double %60, %57
  store double %61, double* %59, align 8
  %indvars.iv.next99 = add nuw nsw i64 %indvars.iv98, 1
  %exitcond100 = icmp eq i64 %indvars.iv.next99, 1200
  br i1 %exitcond100, label %._crit_edge42.us, label %._crit_edge30

._crit_edge30:                                    ; preds = %45
  br label %45

._crit_edge42.us:                                 ; preds = %45
...
.lr.ph.us.us.preheader:                           ; preds = %._crit_edge29.us-lcssa.us.us..lr.ph.us.us.preheader_crit_edge, %.lr.ph.us.us.preheader.preheader
  ...
  %62 = phi [1200 x double]* [ %67, %._crit_edge29.us-lcssa.us.us..lr.ph.us.us.preheader_crit_edge ], [ %2, %.lr.ph.us.us.preheader.preheader ]
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %62, i64 %indvars.iv9, i64 %indvars.iv9
...
.lr.ph.us.us:                                     ; preds = %._crit_edge24.us.us..lr.ph.us.us_crit_edge, %.lr.ph.us.us.preheader
  ...
  %64 = phi [1200 x double]* [ %67, %._crit_edge24.us.us..lr.ph.us.us_crit_edge ], [ %62, %.lr.ph.us.us.preheader ]
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %64, i64 %indvars.iv9, i64 %indvars.iv7
...
._crit_edge24.us.us:                              ; preds = %70
  %69 = getelementptr inbounds [1200 x double], [1200 x double]* %67, i64 %indvars.iv7, i64 %indvars.iv9
...
; <label>:70:                                     ; preds = %._crit_edge32, %.lr.ph.us.us
  %71 = phi double [ %.pre, %.lr.ph.us.us ], [ %83, %._crit_edge32 ]
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %._crit_edge32 ]
  %72 = getelementptr inbounds [1200 x double], [1200 x double]* %66, i64 %indvars.iv, i64 %indvars.iv9
  %73 = load double, double* %72, align 8
  %74 = getelementptr inbounds [1200 x double], [1200 x double]* %66, i64 %indvars.iv, i64 %indvars.iv7
  %75 = load double, double* %74, align 8
  %76 = fmul double %73, %75
  %77 = fadd double %76, %71
  store double %77, double* %68, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %78 = getelementptr inbounds [1200 x double], [1200 x double]* %66, i64 %indvars.iv.next, i64 %indvars.iv9
  %79 = load double, double* %78, align 8
  %80 = getelementptr inbounds [1200 x double], [1200 x double]* %66, i64 %indvars.iv.next, i64 %indvars.iv7
  ...
  br i1 %exitcond.1, label %._crit_edge24.us.us, label %._crit_edge32

._crit_edge32:                                    ; preds = %70
  br label %70
