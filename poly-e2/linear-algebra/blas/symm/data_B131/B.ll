...
for.cond1.preheader:                              ; preds = %for.inc16, %for.cond1.preheader.preheader
  %indvars.iv66 = phi i64 [ 0, %for.cond1.preheader.preheader ], [ %indvars.iv.next67, %for.inc16 ]
  %0 = add nuw nsw i64 %indvars.iv66, 1200
  br label %for.inc

for.inc:                                          ; preds = %for.inc, %for.cond1.preheader
  %indvars.iv61 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next62, %for.inc ]
  %1 = add nuw nsw i64 %indvars.iv66, %indvars.iv61
  %2 = trunc i64 %1 to i32
  %rem = srem i32 %2, 100
  %conv = sitofp i32 %rem to double
  %div = fdiv double %conv, 1.000000e+03
  %arrayidx6 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv66, i64 %indvars.iv61
  ...
  %arrayidx15 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv66, i64 %indvars.iv61
  store double %div11, double* %arrayidx15, align 8
  %indvars.iv.next62 = add nuw nsw i64 %indvars.iv61, 1
  %exitcond65 = icmp eq i64 %indvars.iv.next62, 1200
  br i1 %exitcond65, label %for.inc16, label %for.inc

for.inc16:                                        ; preds = %for.inc
  %indvars.iv.next67 = add nuw nsw i64 %indvars.iv66, 1
  %exitcond69 = icmp eq i64 %indvars.iv.next67, 1000
  br i1 %exitcond69, label %for.inc36.lr.ph.preheader, label %for.cond1.preheader

for.inc36.lr.ph.preheader:                        ; preds = %for.inc16
  br label %for.inc36.lr.ph

for.inc36.lr.ph:                                  ; preds = %for.inc36.lr.ph.preheader, %for.inc51
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc51 ], [ 0, %for.inc36.lr.ph.preheader ]
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc51 ], [ 1, %for.inc36.lr.ph.preheader ]
  %5 = sub i64 999, %indvars.iv59
  %6 = sub i64 998, %indvars.iv59
  %indvars.iv.next60 = add nuw nsw i64 %indvars.iv59, 1
  %xtraiter70 = and i64 %indvars.iv.next60, 1
...
for.inc36.prol.preheader:                         ; preds = %for.inc36.lr.ph
  ...
  %arrayidx35.prol = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 0
...
for.cond40.preheader:                             ; preds = %for.cond40.preheader.loopexit, %for.inc36.prol.loopexit.unr-lcssa
  %cmp4135 = icmp slt i64 %indvars.iv.next60, 1000
  br i1 %cmp4135, label %for.inc48.lr.ph, label %for.inc51

for.inc48.lr.ph:                                  ; preds = %for.cond40.preheader
  %9 = trunc i64 %5 to i32
  %xtraiter55 = and i32 %9, 7
  %lcmp.mod56 = icmp eq i32 %xtraiter55, 0
  br i1 %lcmp.mod56, label %for.inc48.prol.loopexit, label %for.inc48.prol.preheader
...
for.inc48.prol:                                   ; preds = %for.inc48.prol.preheader, %for.inc48.prol
  %indvars.iv53.prol = phi i64 [ %indvars.iv.next54.prol, %for.inc48.prol ], [ %indvars.iv57, %for.inc48.prol.preheader ]
  %prol.iter = phi i32 [ %prol.iter.sub, %for.inc48.prol ], [ %xtraiter55, %for.inc48.prol.preheader ]
  %arrayidx47.prol = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 %indvars.iv53.prol
...
for.inc48.prol.loopexit:                          ; preds = %for.inc48.prol.loopexit.loopexit, %for.inc48.lr.ph
  %indvars.iv53.unr = phi i64 [ %indvars.iv57, %for.inc48.lr.ph ], [ %indvars.iv.next54.prol, %for.inc48.prol.loopexit.loopexit ]
  %10 = trunc i64 %6 to i32
  %11 = icmp ult i32 %10, 7
  br i1 %11, label %for.inc51, label %for.inc48.preheader

for.inc48.preheader:                              ; preds = %for.inc48.prol.loopexit
  %12 = sub i64 992, %indvars.iv53.unr
  %13 = lshr i64 %12, 3
...
for.inc48.preheader71:                            ; preds = %middle.block, %min.iters.checked, %for.inc48.preheader
  %indvars.iv53.ph = phi i64 [ %indvars.iv53.unr, %min.iters.checked ], [ %indvars.iv53.unr, %for.inc48.preheader ], [ %ind.end, %middle.block ]
  br label %for.inc48
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %19 = shl i64 %index, 3
  %20 = add i64 %indvars.iv53.unr, %19
  %21 = add nsw i64 %20, 7
  %22 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 %21
...
for.inc36:                                        ; preds = %for.inc36.preheader, %for.inc36
  ...
  %26 = add nuw nsw i64 %indvars.iv59, %indvars.iv
  %27 = trunc i64 %26 to i32
  %rem28 = srem i32 %27, 100
  %conv29 = sitofp i32 %rem28 to double
  %arrayidx35 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 %indvars.iv
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %28 = add nuw nsw i64 %indvars.iv59, %indvars.iv.next
  ...
  %exitcond50.1 = icmp eq i64 %indvars.iv.next.1, %indvars.iv57
  br i1 %exitcond50.1, label %for.cond40.preheader.loopexit, label %for.inc36

for.inc48:                                        ; preds = %for.inc48.preheader71, %for.inc48
  %indvars.iv53 = phi i64 [ %indvars.iv.next54.7, %for.inc48 ], [ %indvars.iv53.ph, %for.inc48.preheader71 ]
  %arrayidx47 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 %indvars.iv53
  store double -9.990000e+02, double* %arrayidx47, align 8
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %arrayidx47.1 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 %indvars.iv.next54
  store double -9.990000e+02, double* %arrayidx47.1, align 8
  %indvars.iv.next54.1 = add nsw i64 %indvars.iv53, 2
  %arrayidx47.2 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 %indvars.iv.next54.1
  store double -9.990000e+02, double* %arrayidx47.2, align 8
  %indvars.iv.next54.2 = add nsw i64 %indvars.iv53, 3
  %arrayidx47.3 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 %indvars.iv.next54.2
  store double -9.990000e+02, double* %arrayidx47.3, align 8
  %indvars.iv.next54.3 = add nsw i64 %indvars.iv53, 4
  %arrayidx47.4 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 %indvars.iv.next54.3
  store double -9.990000e+02, double* %arrayidx47.4, align 8
  %indvars.iv.next54.4 = add nsw i64 %indvars.iv53, 5
  %arrayidx47.5 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 %indvars.iv.next54.4
  store double -9.990000e+02, double* %arrayidx47.5, align 8
  %indvars.iv.next54.5 = add nsw i64 %indvars.iv53, 6
  %arrayidx47.6 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 %indvars.iv.next54.5
  store double -9.990000e+02, double* %arrayidx47.6, align 8
  %indvars.iv.next54.6 = add nsw i64 %indvars.iv53, 7
  %arrayidx47.7 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 %indvars.iv.next54.6
...
for.cond1.preheader:                              ; preds = %for.inc53, %for.cond1.preheader.preheader
  %indvars.iv54 = phi i64 [ 0, %for.cond1.preheader.preheader ], [ %0, %for.inc53 ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %20 = fadd <2 x double> %18, %broadcast.splat81
  %21 = fadd <2 x double> %19, %broadcast.splat81
  ...
  br i1 %22, label %for.inc53.loopexit85, label %vector.body, !llvm.loop !16

for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.inc50.us
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc50.us ], [ 0, %for.cond4.preheader.us.preheader ]
  %arrayidx8.us = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv54, i64 %indvars.iv51
  br label %for.inc.us

for.inc.us:                                       ; preds = %for.inc.us, %for.cond4.preheader.us
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc.us ], [ 0, %for.cond4.preheader.us ]
  ...
  %arrayidx12.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv54, i64 %indvars.iv42
  %24 = load double, double* %arrayidx12.us, align 8
  %mul13.us = fmul double %mul.us, %24
  %arrayidx17.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv42, i64 %indvars.iv51
  %25 = load double, double* %arrayidx17.us, align 8
  %add.us = fadd double %25, %mul13.us
  store double %add.us, double* %arrayidx17.us, align 8
  %arrayidx21.us = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv42, i64 %indvars.iv51
  ...
  %exitcond50 = icmp eq i64 %indvars.iv.next43, %indvars.iv54
  br i1 %exitcond50, label %for.inc50.us, label %for.inc.us

for.inc50.us:                                     ; preds = %for.inc.us
  %arrayidx31.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv54, i64 %indvars.iv51
  ...
  %exitcond53 = icmp eq i64 %indvars.iv.next52, 1200
...
for.cond4.preheader:                              ; preds = %for.cond4.preheader, %for.cond4.preheader.preheader
  ...
  %31 = bitcast double* %arrayidx31 to <2 x double>*
  ...
  %34 = load <2 x double>, <2 x double>* %31, align 8
  ...
  %mul32 = fmul <2 x double> %34, %mul32.v.i1.2
...
for.inc53.loopexit:                               ; preds = %for.inc50.us
  br label %for.inc53
...
for.cond2.preheader:                              ; preds = %for.inc10, %for.cond2.preheader.preheader
  %indvars.iv13 = phi i64 [ 0, %for.cond2.preheader.preheader ], [ %indvars.iv.next14, %for.inc10 ]
...
for.inc:                                          ; preds = %for.body4, %if.then
  ...
  %arrayidx8 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv13, i64 %indvars.iv
