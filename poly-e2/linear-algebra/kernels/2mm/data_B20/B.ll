...
for.body:                                         ; preds = %for.end, %entry
  %indvars.iv2136 = phi i64 [ 0, %entry ], [ %indvars.iv.next22, %for.end ]
  br label %for.body3

for.body3:                                        ; preds = %for.body3, %for.body
  %indvars.iv1734 = phi i64 [ 0, %for.body ], [ %indvars.iv.next18, %for.body3 ]
  %0 = mul nuw nsw i64 %indvars.iv1734, %indvars.iv2136
  %1 = add nuw nsw i64 %0, 1
  %2 = trunc i64 %1 to i32
  %rem = srem i32 %2, 800
  %conv = sitofp i32 %rem to double
  %div = fdiv double %conv, 8.000000e+02
  %arrayidx6 = getelementptr inbounds [1100 x double], [1100 x double]* %A, i64 %indvars.iv2136, i64 %indvars.iv1734
  store double %div, double* %arrayidx6, align 8
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv1734, 1
  %exitcond43 = icmp eq i64 %indvars.iv.next18, 1100
  br i1 %exitcond43, label %for.end, label %for.body3

for.end:                                          ; preds = %for.body3
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv2136, 1
  %exitcond44 = icmp eq i64 %indvars.iv.next22, 800
  br i1 %exitcond44, label %for.body13.preheader, label %for.body

for.body13.preheader:                             ; preds = %for.end
  br label %for.body13

for.body13:                                       ; preds = %for.body13.preheader, %for.end30
  %indvars.iv1532 = phi i64 [ %indvars.iv.next16, %for.end30 ], [ 0, %for.body13.preheader ]
  br label %for.body17

for.body17:                                       ; preds = %for.body17, %for.body13
  %indvars.iv1230 = phi i64 [ 0, %for.body13 ], [ %indvars.iv.next13.1, %for.body17 ]
  %indvars.iv.next13 = or i64 %indvars.iv1230, 1
  %3 = mul nuw nsw i64 %indvars.iv.next13, %indvars.iv1532
  %4 = trunc i64 %3 to i32
  %rem20 = srem i32 %4, 900
  %conv21 = sitofp i32 %rem20 to double
  %arrayidx27 = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv1532, i64 %indvars.iv1230
  %indvars.iv.next13.1 = add nsw i64 %indvars.iv1230, 2
  %5 = mul nuw nsw i64 %indvars.iv.next13.1, %indvars.iv1532
  ...
  %exitcond41.1 = icmp eq i64 %indvars.iv.next13.1, 900
  br i1 %exitcond41.1, label %for.end30, label %for.body17

for.end30:                                        ; preds = %for.body17
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv1532, 1
  %exitcond42 = icmp eq i64 %indvars.iv.next16, 1100
  br i1 %exitcond42, label %for.body37.preheader, label %for.body13

for.body37.preheader:                             ; preds = %for.end30
  br label %for.body37

for.body37:                                       ; preds = %for.body37.preheader, %for.end55
  %indvars.iv1028 = phi i64 [ %indvars.iv.next11, %for.end55 ], [ 0, %for.body37.preheader ]
  br label %for.body41

for.body41:                                       ; preds = %for.body41, %for.body37
  %indvars.iv526 = phi i64 [ 0, %for.body37 ], [ %indvars.iv.next6, %for.body41 ]
  %8 = add nuw nsw i64 %indvars.iv526, 3
  %9 = mul nuw nsw i64 %8, %indvars.iv1028
  %10 = add nuw nsw i64 %9, 1
  %11 = trunc i64 %10 to i32
  %rem45 = srem i32 %11, 1200
  %conv46 = sitofp i32 %rem45 to double
  %div48 = fdiv double %conv46, 1.200000e+03
  %arrayidx52 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv1028, i64 %indvars.iv526
  store double %div48, double* %arrayidx52, align 8
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv526, 1
  %exitcond39 = icmp eq i64 %indvars.iv.next6, 1200
  br i1 %exitcond39, label %for.end55, label %for.body41

for.end55:                                        ; preds = %for.body41
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv1028, 1
  %exitcond40 = icmp eq i64 %indvars.iv.next11, 900
  br i1 %exitcond40, label %for.body62.preheader, label %for.body37

for.body62.preheader:                             ; preds = %for.end55
  br label %for.body62

for.body62:                                       ; preds = %for.body62.preheader, %for.end79
  %indvars.iv324 = phi i64 [ %indvars.iv.next4, %for.end79 ], [ 0, %for.body62.preheader ]
  br label %for.body66

for.body66:                                       ; preds = %for.body66, %for.body62
  %indvars.iv23 = phi i64 [ 0, %for.body62 ], [ %indvars.iv.next, %for.body66 ]
  %12 = add nuw nsw i64 %indvars.iv23, 2
  %13 = mul nuw nsw i64 %12, %indvars.iv324
  %14 = trunc i64 %13 to i32
  %rem69 = srem i32 %14, 1100
  %conv70 = sitofp i32 %rem69 to double
  %div72 = fdiv double %conv70, 1.100000e+03
  %arrayidx76 = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv324, i64 %indvars.iv23
...
for.end79:                                        ; preds = %for.body66
  ...
  %exitcond38 = icmp eq i64 %indvars.iv.next4, 800
  br i1 %exitcond38, label %for.end82, label %for.body62
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc void @kernel_2mm(i32 %ni, i32 %nj, i32 %nk, i32 %nl, double %alpha, double %beta, [900 x double]* %tmp, [1100 x double]* nocapture readonly %A, [900 x double]* nocapture readonly %B, [1200 x double]* %C, [1200 x double]* nocapture %D) unnamed_addr #2 {
entry:
...
for.body:                                         ; preds = %for.end27, %entry
  %indvars.iv920 = phi i64 [ 0, %entry ], [ %indvars.iv.next10, %for.end27 ]
  br label %for.body6

for.body6:                                        ; preds = %for.end, %for.body
  %indvars.iv718 = phi i64 [ 0, %for.body ], [ %indvars.iv.next8, %for.end ]
  %arrayidx8 = getelementptr inbounds [900 x double], [900 x double]* %tmp, i64 %indvars.iv920, i64 %indvars.iv718
...
for.body11:                                       ; preds = %for.body11, %for.body6
  ...
  %indvars.iv516 = phi i64 [ 0, %for.body6 ], [ %indvars.iv.next6.1, %for.body11 ]
  %arrayidx15 = getelementptr inbounds [1100 x double], [1100 x double]* %A, i64 %indvars.iv920, i64 %indvars.iv516
  %1 = load double, double* %arrayidx15, align 8
  %mul = fmul double %1, %alpha
  %arrayidx19 = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv516, i64 %indvars.iv718
  ...
  %indvars.iv.next6 = or i64 %indvars.iv516, 1
  %arrayidx15.1 = getelementptr inbounds [1100 x double], [1100 x double]* %A, i64 %indvars.iv920, i64 %indvars.iv.next6
  %3 = load double, double* %arrayidx15.1, align 8
  %mul.1 = fmul double %3, %alpha
  %arrayidx19.1 = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv.next6, i64 %indvars.iv718
  ...
  %indvars.iv.next6.1 = add nsw i64 %indvars.iv516, 2
  %exitcond24.1 = icmp eq i64 %indvars.iv.next6.1, 1100
  br i1 %exitcond24.1, label %for.end, label %for.body11

for.end:                                          ; preds = %for.body11
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv718, 1
  %exitcond25 = icmp eq i64 %indvars.iv.next8, 900
  br i1 %exitcond25, label %for.end27, label %for.body6

for.end27:                                        ; preds = %for.end
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv920, 1
  %exitcond27 = icmp eq i64 %indvars.iv.next10, 800
  br i1 %exitcond27, label %for.end30, label %for.body

for.end30:                                        ; preds = %for.end27
  %5 = load [900 x double]*, [900 x double]** %tmp.addr, align 8
  %6 = load [1200 x double]*, [1200 x double]** %C.addr, align 8
  br label %for.body33

for.body33:                                       ; preds = %for.end64, %for.end30
  %indvars.iv314 = phi i64 [ 0, %for.end30 ], [ %indvars.iv.next4, %for.end64 ]
  br label %for.body36

for.body36:                                       ; preds = %for.end61, %for.body33
  %indvars.iv112 = phi i64 [ 0, %for.body33 ], [ %indvars.iv.next2, %for.end61 ]
  %arrayidx40 = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv314, i64 %indvars.iv112
...
for.body44:                                       ; preds = %for.body44, %for.body36
  %8 = phi double [ %mul41, %for.body36 ], [ %add58.2, %for.body44 ]
  %indvars.iv11 = phi i64 [ 0, %for.body36 ], [ %indvars.iv.next.2, %for.body44 ]
  %arrayidx48 = getelementptr inbounds [900 x double], [900 x double]* %5, i64 %indvars.iv314, i64 %indvars.iv11
  %9 = load double, double* %arrayidx48, align 8
  %arrayidx52 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv11, i64 %indvars.iv112
  ...
  %arrayidx48.1 = getelementptr inbounds [900 x double], [900 x double]* %5, i64 %indvars.iv314, i64 %indvars.iv.next
  %11 = load double, double* %arrayidx48.1, align 8
  %arrayidx52.1 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv.next, i64 %indvars.iv112
  ...
  %arrayidx48.2 = getelementptr inbounds [900 x double], [900 x double]* %5, i64 %indvars.iv314, i64 %indvars.iv.next.1
  %13 = load double, double* %arrayidx48.2, align 8
  %arrayidx52.2 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv.next.1, i64 %indvars.iv112
  %14 = load double, double* %arrayidx52.2, align 8
  %mul53.2 = fmul double %13, %14
  %add58.2 = fadd double %add58.1, %mul53.2
  store double %add58.2, double* %arrayidx40, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv11, 3
...
for.end61:                                        ; preds = %for.body44
  ...
  %exitcond22 = icmp eq i64 %indvars.iv.next2, 1200
  br i1 %exitcond22, label %for.end64, label %for.body36

for.end64:                                        ; preds = %for.end61
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv314, 1
  %exitcond23 = icmp eq i64 %indvars.iv.next4, 800
  br i1 %exitcond23, label %for.end67, label %for.body33
...
if.end:                                           ; preds = %for.body4, %if.then
  ...
  %arrayidx8 = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv26, i64 %indvars.iv5
