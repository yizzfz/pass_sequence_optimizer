...
._crit_edge.preheader:                            ; preds = %16, %8
  %indvars.iv1623 = phi i64 [ 0, %8 ], [ %indvars.iv.next17, %16 ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge.preheader
  %indvars.iv1422 = phi i64 [ 0, %._crit_edge.preheader ], [ %indvars.iv.next15, %._crit_edge ]
  %9 = mul nuw nsw i64 %indvars.iv1422, %indvars.iv1623
  %10 = add nuw nsw i64 %9, 1
  %11 = trunc i64 %10 to i32
  %12 = srem i32 %11, 1000
  %13 = sitofp i32 %12 to double
  %14 = fdiv double %13, 1.000000e+03
  %15 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv1623, i64 %indvars.iv1422
  store double %14, double* %15, align 8
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv1422, 1
  %exitcond27 = icmp eq i64 %indvars.iv.next15, 1100
  br i1 %exitcond27, label %16, label %._crit_edge

; <label>:16:                                     ; preds = %._crit_edge
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv1623, 1
  %exitcond28 = icmp eq i64 %indvars.iv.next17, 1000
...
._crit_edge5.preheader:                           ; preds = %._crit_edge5.preheader.preheader, %._crit_edge4
  %indvars.iv1221 = phi i64 [ %indvars.iv.next13, %._crit_edge4 ], [ 0, %._crit_edge5.preheader.preheader ]
  br label %._crit_edge5

._crit_edge5:                                     ; preds = %._crit_edge5, %._crit_edge5.preheader
  %indvars.iv1020 = phi i64 [ 0, %._crit_edge5.preheader ], [ %indvars.iv.next11.1, %._crit_edge5 ]
  %indvars.iv.next11 = or i64 %indvars.iv1020, 1
  %17 = mul nuw nsw i64 %indvars.iv.next11, %indvars.iv1221
  %18 = trunc i64 %17 to i32
  %19 = srem i32 %18, 1200
  %20 = sitofp i32 %19 to double
  %21 = fdiv double %20, 1.200000e+03
  %22 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv1221, i64 %indvars.iv1020
  store double %21, double* %22, align 8
  %indvars.iv.next11.1 = add nuw nsw i64 %indvars.iv1020, 2
  %23 = mul nuw nsw i64 %indvars.iv.next11.1, %indvars.iv1221
  %24 = trunc i64 %23 to i32
  %25 = srem i32 %24, 1200
  %26 = sitofp i32 %25 to double
  %27 = fdiv double %26, 1.200000e+03
  %28 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv1221, i64 %indvars.iv.next11
  store double %27, double* %28, align 8
  %exitcond25.1 = icmp eq i64 %indvars.iv.next11.1, 1200
  br i1 %exitcond25.1, label %._crit_edge4, label %._crit_edge5

._crit_edge4:                                     ; preds = %._crit_edge5
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv1221, 1
  %exitcond26 = icmp eq i64 %indvars.iv.next13, 1000
  br i1 %exitcond26, label %._crit_edge7.preheader.preheader, label %._crit_edge5.preheader
...
._crit_edge7.preheader:                           ; preds = %._crit_edge7.preheader.preheader, %._crit_edge6
  %indvars.iv819 = phi i64 [ %indvars.iv.next9, %._crit_edge6 ], [ 0, %._crit_edge7.preheader.preheader ]
  br label %._crit_edge7

._crit_edge7:                                     ; preds = %._crit_edge7, %._crit_edge7.preheader
  %indvars.iv18 = phi i64 [ 0, %._crit_edge7.preheader ], [ %indvars.iv.next, %._crit_edge7 ]
  %29 = add nuw nsw i64 %indvars.iv18, 2
  %30 = mul nuw nsw i64 %29, %indvars.iv819
  %31 = trunc i64 %30 to i32
  %32 = srem i32 %31, 1100
  %33 = sitofp i32 %32 to double
  %34 = fdiv double %33, 1.100000e+03
  %35 = getelementptr inbounds [1100 x double], [1100 x double]* %7, i64 %indvars.iv819, i64 %indvars.iv18
...
._crit_edge6:                                     ; preds = %._crit_edge7
  ...
  %exitcond24 = icmp eq i64 %indvars.iv.next9, 1200
  br i1 %exitcond24, label %36, label %._crit_edge7.preheader
...
._crit_edge.preheader:                            ; preds = %59, %8
  %indvars.iv914 = phi i64 [ 0, %8 ], [ %9, %59 ]
  %scevgep = getelementptr [1100 x double], [1100 x double]* %5, i64 %indvars.iv914, i64 0
  %9 = add i64 %indvars.iv914, 1
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge.preheader
  ...
  %10 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv914, i64 %indvars.iv11
  %11 = load double, double* %10, align 8
  %12 = fmul double %11, %4
  store double %12, double* %10, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv11, 1
  %13 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv914, i64 %indvars.iv.next
  %14 = load double, double* %13, align 8
  %15 = fmul double %14, %4
  store double %15, double* %13, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv11, 2
  %16 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv914, i64 %indvars.iv.next.1
  %17 = load double, double* %16, align 8
  %18 = fmul double %17, %4
  store double %18, double* %16, align 8
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv11, 3
  %19 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv914, i64 %indvars.iv.next.2
  %20 = load double, double* %19, align 8
  %21 = fmul double %20, %4
  store double %21, double* %19, align 8
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv11, 4
  %22 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv914, i64 %indvars.iv.next.3
...
._crit_edge4.preheader:                           ; preds = %._crit_edge4.preheader.preheader, %._crit_edge3
  %indvars.iv713 = phi i64 [ %25, %._crit_edge3 ], [ 0, %._crit_edge4.preheader.preheader ]
  %scevgep19 = getelementptr [1100 x double], [1100 x double]* %7, i64 %indvars.iv713, i64 0
  %25 = add i64 %indvars.iv713, 1
  %scevgep21 = getelementptr [1100 x double], [1100 x double]* %7, i64 %25, i64 0
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv914, i64 %indvars.iv713
...
vector.ph:                                        ; preds = %._crit_edge4.preheader
  ...
  %28 = fmul <2 x double> %27, %broadcast.splatinsert27
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %30 = getelementptr inbounds [1100 x double], [1100 x double]* %7, i64 %indvars.iv713, i64 %offset.idx
  ...
  %33 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv914, i64 %offset.idx
  %34 = bitcast double* %33 to <4 x double>*
  %wide.vec30 = load <4 x double>, <4 x double>* %34, align 8, !alias.scope !6, !noalias !8
  ...
  %35 = fadd <2 x double> %strided.vec31, %32
  %36 = or i64 %offset.idx, 1
  %37 = fmul <2 x double> %29, %strided.vec29
  %38 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv914, i64 %36
  %39 = fadd <2 x double> %strided.vec32, %37
  ...
  br i1 %42, label %._crit_edge3.loopexit34, label %vector.body, !llvm.loop !9

._crit_edge4:                                     ; preds = %._crit_edge4.preheader33, %._crit_edge4
  %indvars.iv512 = phi i64 [ %indvars.iv.next6.1, %._crit_edge4 ], [ 0, %._crit_edge4.preheader33 ]
  %43 = load double, double* %26, align 8
  %44 = fmul double %43, %3
  %45 = getelementptr inbounds [1100 x double], [1100 x double]* %7, i64 %indvars.iv713, i64 %indvars.iv512
  %46 = load double, double* %45, align 8
  %47 = fmul double %44, %46
  %48 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv914, i64 %indvars.iv512
  %49 = load double, double* %48, align 8
  %50 = fadd double %49, %47
  store double %50, double* %48, align 8
  %indvars.iv.next6 = or i64 %indvars.iv512, 1
  %51 = load double, double* %26, align 8
  %52 = fmul double %51, %3
  %53 = getelementptr inbounds [1100 x double], [1100 x double]* %7, i64 %indvars.iv713, i64 %indvars.iv.next6
  %54 = load double, double* %53, align 8
  %55 = fmul double %52, %54
  %56 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv914, i64 %indvars.iv.next6
  %57 = load double, double* %56, align 8
  %58 = fadd double %57, %55
  store double %58, double* %56, align 8
  %indvars.iv.next6.1 = add nuw nsw i64 %indvars.iv512, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next6.1, 1100
...
; <label>:59:                                     ; preds = %._crit_edge3
  ...
  br i1 %exitcond15, label %60, label %._crit_edge.preheader
...
._crit_edge2:                                     ; preds = %9, %14
  ...
  %17 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv36, i64 %indvars.iv5
...
; <label>:20:                                     ; preds = %._crit_edge2
  ...
  %exitcond7 = icmp eq i64 %indvars.iv.next4, 1000
