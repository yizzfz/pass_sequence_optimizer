...
._crit_edge.us.preheader:                         ; preds = %._crit_edge.lr.ph
  ...
  %12 = icmp sgt i64 %9, 2
  %smax43 = select i1 %12, i64 %9, i64 2
  %scevgep44 = getelementptr double, double* %2, i64 %smax43
  %13 = add nuw nsw i64 %smax43, 1
  %scevgep46 = getelementptr double, double* %3, i64 %13
  %14 = icmp sgt i64 %9, 2
  %smax57 = select i1 %14, i64 %9, i64 2
  %15 = add nsw i64 %smax57, -1
  %scevgep64 = getelementptr double, double* %3, i64 1
  %16 = icmp sgt i64 %9, 2
  %smax66 = select i1 %16, i64 %9, i64 2
  %scevgep67 = getelementptr double, double* %3, i64 %smax66
  %17 = add nuw nsw i64 %smax66, 1
  %scevgep69 = getelementptr double, double* %2, i64 %17
  %min.iters.check58 = icmp ult i64 %15, 4
  %min.iters.check = icmp ult i64 %11, 4
  %n.vec = and i64 %11, -4
  %cmp.zero = icmp eq i64 %n.vec, 0
  %bound0 = icmp ult double* %scevgep, %scevgep46
  %bound1 = icmp ugt double* %scevgep44, %3
  %memcheck.conflict = and i1 %bound0, %bound1
  %ind.end = or i64 %n.vec, 1
  %cmp.n = icmp eq i64 %11, %n.vec
  %n.vec61 = and i64 %15, -4
  %cmp.zero62 = icmp eq i64 %n.vec61, 0
  %bound071 = icmp ult double* %scevgep64, %scevgep69
  %bound172 = icmp ugt double* %scevgep67, %2
  %memcheck.conflict74 = and i1 %bound071, %bound172
  %ind.end80 = or i64 %n.vec61, 1
  %cmp.n81 = icmp eq i64 %15, %n.vec61
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.us.preheader, %._crit_edge7.us
  %18 = phi i32 [ %44, %._crit_edge7.us ], [ 0, %._crit_edge.us.preheader ]
  br i1 %min.iters.check58, label %scalar.ph56.preheader, label %min.iters.checked59

scalar.ph56.preheader:                            ; preds = %middle.block55, %vector.memcheck75, %min.iters.checked59, %._crit_edge.us
  %indvars.iv.ph = phi i64 [ 1, %vector.memcheck75 ], [ 1, %min.iters.checked59 ], [ 1, %._crit_edge.us ], [ %ind.end80, %middle.block55 ]
  br label %scalar.ph56

min.iters.checked59:                              ; preds = %._crit_edge.us
  br i1 %cmp.zero62, label %scalar.ph56.preheader, label %vector.memcheck75

vector.memcheck75:                                ; preds = %min.iters.checked59
  br i1 %memcheck.conflict74, label %scalar.ph56.preheader, label %vector.body54.preheader

vector.body54.preheader:                          ; preds = %vector.memcheck75
  br label %vector.body54

vector.body54:                                    ; preds = %vector.body54.preheader, %vector.body54
  %index77 = phi i64 [ %index.next78, %vector.body54 ], [ 0, %vector.body54.preheader ]
  %offset.idx82 = or i64 %index77, 1
  %19 = add nsw i64 %offset.idx82, -1
  %20 = getelementptr inbounds double, double* %2, i64 %19
  %21 = bitcast double* %20 to <2 x double>*
  %wide.load87 = load <2 x double>, <2 x double>* %21, align 8, !alias.scope !1
  %22 = getelementptr double, double* %20, i64 2
  %23 = bitcast double* %22 to <2 x double>*
  %wide.load88 = load <2 x double>, <2 x double>* %23, align 8, !alias.scope !1
  %24 = getelementptr inbounds double, double* %2, i64 %offset.idx82
  ...
  %28 = fadd <2 x double> %wide.load87, %wide.load89
  %29 = fadd <2 x double> %wide.load88, %wide.load90
  %30 = add nuw nsw i64 %offset.idx82, 1
  ...
  %wide.load92 = load <2 x double>, <2 x double>* %34, align 8, !alias.scope !1
  %35 = fadd <2 x double> %28, %wide.load91
  %36 = fadd <2 x double> %29, %wide.load92
  ...
  %39 = getelementptr inbounds double, double* %3, i64 %offset.idx82
  ...
  %43 = icmp eq i64 %index.next78, %n.vec61
  br i1 %43, label %middle.block55, label %vector.body54, !llvm.loop !6

middle.block55:                                   ; preds = %vector.body54
  br i1 %cmp.n81, label %.lr.ph6.us.preheader, label %scalar.ph56.preheader
...
.lr.ph6.us:                                       ; preds = %.lr.ph6.us.preheader93, %.lr.ph6.us
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %.lr.ph6.us ], [ %indvars.iv29.ph, %.lr.ph6.us.preheader93 ]
...
scalar.ph56:                                      ; preds = %scalar.ph56.preheader, %scalar.ph56
  ...
  br i1 %69, label %scalar.ph56, label %.lr.ph6.us.preheader.loopexit, !llvm.loop !10

.lr.ph6.us.preheader.loopexit:                    ; preds = %scalar.ph56
  br label %.lr.ph6.us.preheader

.lr.ph6.us.preheader:                             ; preds = %.lr.ph6.us.preheader.loopexit, %middle.block55
  br i1 %min.iters.check, label %.lr.ph6.us.preheader93, label %min.iters.checked

.lr.ph6.us.preheader93:                           ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.lr.ph6.us.preheader
...
min.iters.checked:                                ; preds = %.lr.ph6.us.preheader
  br i1 %cmp.zero, label %.lr.ph6.us.preheader93, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  br i1 %memcheck.conflict, label %.lr.ph6.us.preheader93, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load49 = load <2 x double>, <2 x double>* %74, align 8, !alias.scope !11
  %75 = getelementptr inbounds double, double* %3, i64 %offset.idx
  %76 = bitcast double* %75 to <2 x double>*
  %wide.load50 = load <2 x double>, <2 x double>* %76, align 8, !alias.scope !11
  %77 = getelementptr double, double* %75, i64 2
  %78 = bitcast double* %77 to <2 x double>*
  %wide.load51 = load <2 x double>, <2 x double>* %78, align 8, !alias.scope !11
  %79 = fadd <2 x double> %wide.load, %wide.load50
  %80 = fadd <2 x double> %wide.load49, %wide.load51
  %81 = add nuw nsw i64 %offset.idx, 1
  %82 = getelementptr inbounds double, double* %3, i64 %81
  %83 = bitcast double* %82 to <2 x double>*
  %wide.load52 = load <2 x double>, <2 x double>* %83, align 8, !alias.scope !11
  %84 = getelementptr double, double* %82, i64 2
  %85 = bitcast double* %84 to <2 x double>*
  %wide.load53 = load <2 x double>, <2 x double>* %85, align 8, !alias.scope !11
  %86 = fadd <2 x double> %79, %wide.load52
  %87 = fadd <2 x double> %80, %wide.load53
...
middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %._crit_edge7.us, label %.lr.ph6.us.preheader93
