...
.loopexit:                                        ; preds = %._crit_edge
  ...
  br i1 %exitcond3, label %48, label %.loopexit..loopexit._crit_edge_crit_edge
...
.loopexit._crit_edge:                             ; preds = %.loopexit..loopexit._crit_edge_crit_edge, %11
  ...
  %21 = fmul <2 x double> %20, <double 5.000000e-01, double 2.500000e-01>
  %22 = extractelement <2 x double> %21, i32 0
  %23 = extractelement <2 x double> %21, i32 1
  store double %22, double* %17, align 8
  %24 = getelementptr inbounds double, double* %4, i64 %indvars.iv1
  store double %23, double* %24, align 8
  %25 = getelementptr inbounds double, double* %6, i64 %indvars.iv1
  %26 = fdiv double %16, 2.000000e+03
  %27 = fmul double %26, 1.250000e-01
  %28 = getelementptr inbounds double, double* %9, i64 %indvars.iv1
  store double %27, double* %28, align 8
  %29 = fdiv <2 x double> %20, <double 6.000000e+00, double 9.000000e+00>
  %30 = extractelement <2 x double> %29, i32 0
  %31 = extractelement <2 x double> %29, i32 1
  store double %30, double* %25, align 8
  %32 = getelementptr inbounds double, double* %10, i64 %indvars.iv1
  store double %31, double* %32, align 8
  %33 = getelementptr inbounds double, double* %8, i64 %indvars.iv1
  store double 0.000000e+00, double* %33, align 8
  %34 = getelementptr inbounds double, double* %7, i64 %indvars.iv1
...
._crit_edge:                                      ; preds = %._crit_edge.._crit_edge_crit_edge, %.loopexit._crit_edge
  ...
  %35 = mul nuw nsw i64 %indvars.iv, %indvars.iv1
  %36 = trunc i64 %35 to i32
  %37 = srem i32 %36, 2000
  %38 = sitofp i32 %37 to double
  %39 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv1, i64 %indvars.iv
  %indvars.iv.next = or i64 %indvars.iv, 1
  %40 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv1
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc void @kernel_gemver(double, double, [2000 x double]*, double* readonly, double* readonly, double* readonly, double* readonly, double* nocapture, double* nocapture, double* nocapture readonly, double* nocapture readonly) unnamed_addr #2 {
  %scevgep25 = getelementptr double, double* %4, i64 2000
  %scevgep27 = getelementptr double, double* %6, i64 2000
  br label %.preheader60

.preheader60:                                     ; preds = %middle.block..preheader60_crit_edge, %11
  %indvars.iv16 = phi i64 [ 0, %11 ], [ %indvars.iv.next17, %middle.block..preheader60_crit_edge ]
  %scevgep = getelementptr [2000 x double], [2000 x double]* %2, i64 %indvars.iv16, i64 0
  %12 = add nuw i64 %indvars.iv16, 1
...
vector.body.preheader:                            ; preds = %.preheader60
  br label %vector.body

._crit_edge.preheader:                            ; preds = %.preheader60
  br label %._crit_edge
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.body.preheader
  ...
  br i1 %45, label %middle.block.loopexit50, label %vector.body.vector.body_crit_edge, !llvm.loop !13
...
middle.block.loopexit50:                          ; preds = %vector.body
  br label %middle.block

middle.block:                                     ; preds = %middle.block.loopexit50, %middle.block.loopexit
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  %exitcond18 = icmp eq i64 %indvars.iv.next17, 2000
  br i1 %exitcond18, label %.preheader58.preheader, label %middle.block..preheader60_crit_edge

middle.block..preheader60_crit_edge:              ; preds = %middle.block
  br label %.preheader60

.preheader58.preheader:                           ; preds = %middle.block
  br label %.preheader58

.preheader58:                                     ; preds = %..preheader58_crit_edge, %.preheader58.preheader
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %..preheader58_crit_edge ], [ 0, %.preheader58.preheader ]
  %70 = getelementptr inbounds double, double* %8, i64 %indvars.iv10
  br label %._crit_edge19

._crit_edge19:                                    ; preds = %._crit_edge19.._crit_edge19_crit_edge, %.preheader58
  %indvars.iv7 = phi i64 [ 0, %.preheader58 ], [ %indvars.iv.next8.1, %._crit_edge19.._crit_edge19_crit_edge ]
  ...
  br i1 %exitcond9.1, label %86, label %._crit_edge19.._crit_edge19_crit_edge

._crit_edge19.._crit_edge19_crit_edge:            ; preds = %._crit_edge19
  br label %._crit_edge19

; <label>:86:                                     ; preds = %._crit_edge19
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %exitcond12 = icmp eq i64 %indvars.iv.next11, 2000
  br i1 %exitcond12, label %.preheader57.preheader, label %..preheader58_crit_edge

..preheader58_crit_edge:                          ; preds = %86
  br label %.preheader58

.preheader57.preheader:                           ; preds = %86
  br label %.preheader57

.preheader57:                                     ; preds = %.preheader57..preheader57_crit_edge, %.preheader57.preheader
  %indvars.iv4 = phi i64 [ %indvars.iv.next5.4, %.preheader57..preheader57_crit_edge ], [ 0, %.preheader57.preheader ]
  ...
  br i1 %exitcond6.4, label %.preheader.preheader, label %.preheader57..preheader57_crit_edge

.preheader57..preheader57_crit_edge:              ; preds = %.preheader57
  br label %.preheader57
...
._crit_edge21:                                    ; preds = %._crit_edge21.._crit_edge21_crit_edge, %.preheader
  ...
  store double %127, double* %112, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %128, label %._crit_edge21.._crit_edge21_crit_edge

._crit_edge21.._crit_edge21_crit_edge:            ; preds = %._crit_edge21
  br label %._crit_edge21

; <label>:128:                                    ; preds = %._crit_edge21
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 2000
  br i1 %exitcond3, label %129, label %..preheader_crit_edge

..preheader_crit_edge:                            ; preds = %128
  br label %.preheader
