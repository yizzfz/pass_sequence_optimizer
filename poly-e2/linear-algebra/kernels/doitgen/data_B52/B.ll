...
for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.inc39.us
  %17 = phi i32 [ %split20.us, %for.inc39.us ], [ %storemerge52, %for.cond4.preheader.us.preheader ]
...
for.body9.us32:                                   ; preds = %for.body9.us32.preheader, %for.body9.us32
  %32 = phi double [ %add.us37.1, %for.body9.us32 ], [ %.unr.ph, %for.body9.us32.preheader ]
...
for.cond7.for.inc22_crit_edge.us46:               ; preds = %for.cond7.for.inc22_crit_edge.us46.loopexit, %for.body9.us32.prol.loopexit
  ...
  br i1 %exitcond57, label %for.cond4.for.cond25.preheader_crit_edge.us.loopexit86, label %for.body6.us29
...
for.cond4.for.cond25.preheader_crit_edge.us:      ; preds = %for.cond4.for.cond25.preheader_crit_edge.us.loopexit86, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit
  %split20.us = phi i32 [ %17, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit ], [ %storemerge52, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit86 ]
...
for.body27.lr.ph:                                 ; preds = %for.cond4.preheader
  br i1 %15, label %for.body27.prol.loopexit, label %for.body27.prol.preheader
...
for.body27.prol.loopexit:                         ; preds = %for.body27.prol.loopexit.loopexit, %for.body27.lr.ph
  ...
  br i1 %16, label %for.inc39, label %for.body27.preheader
...
for.inc39:                                        ; preds = %for.inc39.loopexit, %for.body27.prol.loopexit, %for.cond4.preheader
  ...
  br i1 %exitcond56, label %for.inc42.loopexit87, label %for.cond4.preheader
