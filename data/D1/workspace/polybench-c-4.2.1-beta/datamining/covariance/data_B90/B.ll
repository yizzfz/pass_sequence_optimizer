...
.lr.ph51.split.us:                                ; preds = %._crit_edge47.us, %.lr.ph51.split.us.preheader
  ...
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv2149.us
  store double 0.000000e+00, double* %5, align 8
  %sunkaddr92 = shl i64 %indvars.iv2149.us, 3
  %sunkaddr93 = add i64 %4, %sunkaddr92
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph51.split.us
  ...
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1944.us, i64 %indvars.iv2149.us
  %8 = load double, double* %7, align 8
  %9 = fadd double %6, %8
  store double %9, double* %sunkaddr94, align 8
  %indvars.iv.next20.us = add nuw nsw i64 %indvars.iv1944.us, 1
  %10 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next20.us, i64 %indvars.iv2149.us
  %11 = load double, double* %10, align 8
  %12 = fadd double %9, %11
  store double %12, double* %sunkaddr94, align 8
  %indvars.iv.next20.us.1 = add nuw nsw i64 %indvars.iv1944.us, 2
  %13 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next20.us.1, i64 %indvars.iv2149.us
  %14 = load double, double* %13, align 8
  %15 = fadd double %12, %14
  store double %15, double* %sunkaddr94, align 8
  %indvars.iv.next20.us.2 = add nuw nsw i64 %indvars.iv1944.us, 3
  %16 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next20.us.2, i64 %indvars.iv2149.us
  %17 = load double, double* %16, align 8
  %18 = fadd double %15, %17
  store double %18, double* %sunkaddr94, align 8
  %indvars.iv.next20.us.3 = add nuw nsw i64 %indvars.iv1944.us, 4
  %19 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next20.us.3, i64 %indvars.iv2149.us
  %20 = load double, double* %19, align 8
  %21 = fadd double %18, %20
  store double %21, double* %sunkaddr94, align 8
...
._crit_edge47.us:                                 ; preds = %._crit_edge
  %22 = fdiv double %21, %0
  %sunkaddr24 = shl i64 %indvars.iv2149.us, 3
...
vector.memcheck:                                  ; preds = %._crit_edge41.us, %._crit_edge47.us..preheader6.us_crit_edge
  %indvars.iv1742.us = phi i64 [ 0, %._crit_edge47.us..preheader6.us_crit_edge ], [ %23, %._crit_edge41.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv1742.us, i64 0
  %23 = add nuw nsw i64 %indvars.iv1742.us, 1
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1742.us, i64 %offset.idx
  ...
  %33 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1742.us, i64 %32
  ...
  br i1 %39, label %._crit_edge41.us.loopexit27, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv1539.us = phi i64 [ %indvars.iv.next16.us.3, %scalar.ph ], [ 0, %scalar.ph.preheader ]
  %40 = getelementptr inbounds double, double* %3, i64 %indvars.iv1539.us
  %41 = load double, double* %40, align 8
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1742.us, i64 %indvars.iv1539.us
  %43 = load double, double* %42, align 8
  %44 = fsub double %43, %41
  store double %44, double* %42, align 8
  %indvars.iv.next16.us = or i64 %indvars.iv1539.us, 1
  %45 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next16.us
  %46 = load double, double* %45, align 8
  %47 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1742.us, i64 %indvars.iv.next16.us
  %48 = load double, double* %47, align 8
  %49 = fsub double %48, %46
  store double %49, double* %47, align 8
  %indvars.iv.next16.us.1 = or i64 %indvars.iv1539.us, 2
  %50 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next16.us.1
  %51 = load double, double* %50, align 8
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1742.us, i64 %indvars.iv.next16.us.1
  %53 = load double, double* %52, align 8
  %54 = fsub double %53, %51
  store double %54, double* %52, align 8
  %indvars.iv.next16.us.2 = or i64 %indvars.iv1539.us, 3
  %55 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next16.us.2
  %56 = load double, double* %55, align 8
  %57 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv1742.us, i64 %indvars.iv.next16.us.2
...
._crit_edge41.us.loopexit27:                      ; preds = %vector.body
  br label %._crit_edge41.us

._crit_edge41.us:                                 ; preds = %._crit_edge41.us.loopexit27, %._crit_edge41.us.loopexit
...
.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph.us.us.preheader
  ...
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv1336.us, i64 %indvars.iv1133.us.us
...
._crit_edge.us.us:                                ; preds = %._crit_edge21
  ...
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv1133.us.us, i64 %indvars.iv1336.us
...
._crit_edge21:                                    ; preds = %._crit_edge21, %.lr.ph.us.us
  ...
  %indvars.iv31.us.us = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.us.us.1, %._crit_edge21 ]
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv31.us.us, i64 %indvars.iv1336.us
  %66 = load double, double* %65, align 8
  %67 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv31.us.us, i64 %indvars.iv1133.us.us
  %68 = load double, double* %67, align 8
  %69 = fmul double %66, %68
  %70 = fadd double %64, %69
  store double %70, double* %61, align 8
  %indvars.iv.next.us.us = or i64 %indvars.iv31.us.us, 1
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next.us.us, i64 %indvars.iv1336.us
  %72 = load double, double* %71, align 8
  %73 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next.us.us, i64 %indvars.iv1133.us.us
  ...
  br i1 %exitcond66.1, label %._crit_edge.us.us, label %._crit_edge21
