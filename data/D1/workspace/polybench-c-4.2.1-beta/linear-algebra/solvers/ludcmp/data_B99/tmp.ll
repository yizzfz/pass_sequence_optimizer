...
._crit_edge85:                                    ; preds = %._crit_edge85.preheader, %99
  %indvars.iv115 = phi i64 [ %53, %99 ], [ 0, %._crit_edge85.preheader ]
...
middle.block:                                     ; preds = %middle.block.loopexit185, %middle.block.loopexit
  ...
  %98 = icmp slt i64 %indvars.iv.next114, 2000
...
._crit_edge88:                                    ; preds = %._crit_edge88.preheader, %middle.block157
  %indvars.iv108 = phi i64 [ %108, %middle.block157 ], [ 0, %._crit_edge88.preheader ]
  ...
  %108 = add i64 %indvars.iv108, 1
  %scevgep163 = getelementptr [2000 x double], [2000 x double]* %1, i64 %108, i64 0
  %scevgep163164 = bitcast double* %scevgep163 to i8*
  %109 = mul i64 %indvars.iv108, 16000
  %scevgep165 = getelementptr i8, i8* %40, i64 %109
  %110 = add i64 %109, 16000
  %scevgep166 = getelementptr i8, i8* %40, i64 %110
...
vector.body156:                                   ; preds = %vector.body156, %vector.body156.preheader
  ...
  %111 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %106, i64 0, i64 %indvars.iv108, i64 %index173
  %112 = bitcast double* %111 to <2 x i64>*
  %wide.load181 = load <2 x i64>, <2 x i64>* %112, align 8, !alias.scope !13
  %113 = getelementptr double, double* %111, i64 2
  %114 = bitcast double* %113 to <2 x i64>*
  %wide.load182 = load <2 x i64>, <2 x i64>* %114, align 8, !alias.scope !13
  %115 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv108, i64 %index173
  %116 = bitcast double* %115 to <2 x i64>*
  store <2 x i64> %wide.load181, <2 x i64>* %116, align 8, !alias.scope !16, !noalias !13
  %117 = getelementptr double, double* %115, i64 2
  %118 = bitcast double* %117 to <2 x i64>*
  store <2 x i64> %wide.load182, <2 x i64>* %118, align 8, !alias.scope !16, !noalias !13
  %index.next174 = or i64 %index173, 4
  %119 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %107, i64 0, i64 %indvars.iv108, i64 %index.next174
  %120 = bitcast double* %119 to <2 x i64>*
  %wide.load181.1 = load <2 x i64>, <2 x i64>* %120, align 8, !alias.scope !13
  %121 = getelementptr double, double* %119, i64 2
  %122 = bitcast double* %121 to <2 x i64>*
  %wide.load182.1 = load <2 x i64>, <2 x i64>* %122, align 8, !alias.scope !13
  %123 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv108, i64 %index.next174
  %124 = bitcast double* %123 to <2 x i64>*
  store <2 x i64> %wide.load181.1, <2 x i64>* %124, align 8, !alias.scope !16, !noalias !13
  %125 = getelementptr double, double* %123, i64 2
  %126 = bitcast double* %125 to <2 x i64>*
  store <2 x i64> %wide.load182.1, <2 x i64>* %126, align 8, !alias.scope !16, !noalias !13
  %index.next174.1 = add nsw i64 %index173, 8
  %127 = icmp eq i64 %index.next174.1, 2000
  br i1 %127, label %middle.block157.loopexit184, label %vector.body156, !llvm.loop !18
...
scalar.ph158:                                     ; preds = %scalar.ph158, %scalar.ph158.preheader
  ...
  %128 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %101, i64 0, i64 %indvars.iv108, i64 %indvars.iv
  %129 = bitcast double* %128 to i64*
  %130 = load i64, i64* %129, align 8
  %131 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv108, i64 %indvars.iv
  %132 = bitcast double* %131 to i64*
  store i64 %130, i64* %132, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %133 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %102, i64 0, i64 %indvars.iv108, i64 %indvars.iv.next
  %134 = bitcast double* %133 to i64*
  %135 = load i64, i64* %134, align 8
  %136 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv108, i64 %indvars.iv.next
  %137 = bitcast double* %136 to i64*
  store i64 %135, i64* %137, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %138 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %103, i64 0, i64 %indvars.iv108, i64 %indvars.iv.next.1
  %139 = bitcast double* %138 to i64*
  %140 = load i64, i64* %139, align 8
  %141 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv108, i64 %indvars.iv.next.1
  %142 = bitcast double* %141 to i64*
  store i64 %140, i64* %142, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %143 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %104, i64 0, i64 %indvars.iv108, i64 %indvars.iv.next.2
  %144 = bitcast double* %143 to i64*
  %145 = load i64, i64* %144, align 8
  %146 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv108, i64 %indvars.iv.next.2
  %147 = bitcast double* %146 to i64*
  store i64 %145, i64* %147, align 8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %148 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %105, i64 0, i64 %indvars.iv108, i64 %indvars.iv.next.3
  %149 = bitcast double* %148 to i64*
  %150 = load i64, i64* %149, align 8
  %151 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv108, i64 %indvars.iv.next.3
...
; <label>:154:                                    ; preds = %middle.block157
...
.lr.ph127.split.preheader:                        ; preds = %.lr.ph127..lr.ph127.split.preheader_crit_edge, %._crit_edge
  ...
  br i1 %min.iters.check, label %.lr.ph127.split.preheader194, label %min.iters.checked

.lr.ph127.split.preheader194:                     ; preds = %middle.block, %min.iters.checked, %.lr.ph127.split.preheader
...
min.iters.checked:                                ; preds = %.lr.ph127.split.preheader
  ...
  br i1 %cmp.zero, label %.lr.ph127.split.preheader194, label %vector.body.preheader

vector.body.preheader:                            ; preds = %min.iters.checked
  %14 = and i64 %10, 1
  %lcmp.mod208 = icmp eq i64 %14, 0
...
vector.body.prol:                                 ; preds = %vector.body.prol.preheader
  ...
  %wide.load193.prol = load <2 x i64>, <2 x i64>* %18, align 8
  store <2 x i64> %wide.load.prol, <2 x i64>* %16, align 8
  store <2 x i64> %wide.load193.prol, <2 x i64>* %18, align 8
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader.new
  ...
  %wide.load193 = load <2 x i64>, <2 x i64>* %24, align 8
  store <2 x i64> %wide.load, <2 x i64>* %22, align 8
  store <2 x i64> %wide.load193, <2 x i64>* %24, align 8
  %index.next = add i64 %index, 4
  ...
  %wide.load193.1 = load <2 x i64>, <2 x i64>* %29, align 8
  store <2 x i64> %wide.load.1, <2 x i64>* %27, align 8
  store <2 x i64> %wide.load193.1, <2 x i64>* %29, align 8
...
middle.block:                                     ; preds = %vector.body.prol.loopexit, %middle.block.unr-lcssa
  ...
  br i1 %cmp.n, label %._crit_edge128, label %.lr.ph127.split.preheader194
...
.lr.ph127.split.us:                               ; preds = %.lr.ph127.split.us.preheader, %._crit_edge124.us
  %indvars.iv179 = phi i64 [ %indvars.iv.next180, %._crit_edge124.us ], [ %indvars.iv181, %.lr.ph127.split.us.preheader ]
...
.prol.loopexit.unr-lcssa:                         ; preds = %.lr.ph127.split.us, %36
  %.lcssa201.unr.ph = phi double [ %41, %36 ], [ undef, %.lr.ph127.split.us ]
...
._crit_edge124.us:                                ; preds = %.prol.loopexit, %._crit_edge124.us.unr-lcssa
  %.lcssa201 = phi double [ %.lcssa201.unr.ph, %.prol.loopexit ], [ %56, %._crit_edge124.us.unr-lcssa ]
  store double %.lcssa201, double* %34, align 8
...
.lr.ph115.preheader:                              ; preds = %.lr.ph119
  ...
  %63 = and i64 %58, 1
  %lcmp.mod206 = icmp eq i64 %63, 0
  br i1 %lcmp.mod206, label %.lr.ph115.prol.preheader, label %.lr.ph115.prol.loopexit.unr-lcssa
...
.lr.ph115.prol.loopexit.unr-lcssa:                ; preds = %.lr.ph115.preheader, %.lr.ph115.prol
  %.lcssa200.unr.ph = phi double [ %68, %.lr.ph115.prol ], [ undef, %.lr.ph115.preheader ]
  %indvars.iv151.unr.ph = phi i64 [ 1, %.lr.ph115.prol ], [ 0, %.lr.ph115.preheader ]
  %.0113.unr.ph = phi double [ %68, %.lr.ph115.prol ], [ %61, %.lr.ph115.preheader ]
  br label %.lr.ph115.prol.loopexit

.lr.ph115.prol.loopexit:                          ; preds = %.lr.ph115.prol.loopexit.unr-lcssa
  %69 = icmp eq i64 %59, 0
  br i1 %69, label %._crit_edge116.loopexit, label %.lr.ph115.preheader.new
...
.lr.ph115:                                        ; preds = %.lr.ph115, %.lr.ph115.preheader.new
  ...
  %.0113 = phi double [ %.0113.unr.ph, %.lr.ph115.preheader.new ], [ %83, %.lr.ph115 ]
...
._crit_edge116.loopexit:                          ; preds = %.lr.ph115.prol.loopexit, %._crit_edge116.loopexit.unr-lcssa
  %.lcssa200 = phi double [ %.lcssa200.unr.ph, %.lr.ph115.prol.loopexit ], [ %83, %._crit_edge116.loopexit.unr-lcssa ]
  br label %._crit_edge116

._crit_edge116:                                   ; preds = %._crit_edge116.loopexit, %.lr.ph119
  %.0.lcssa = phi double [ %61, %.lr.ph119 ], [ %.lcssa200, %._crit_edge116.loopexit ]
  ...
  br i1 %87, label %.lr.ph119, label %.lr.ph127

.lr.ph127.split:                                  ; preds = %.lr.ph127.split.preheader194, %.lr.ph127.split
  %indvars.iv164 = phi i64 [ %indvars.iv.next165, %.lr.ph127.split ], [ %indvars.iv164.ph, %.lr.ph127.split.preheader194 ]
  %exitcond166 = icmp eq i64 %indvars.iv164, 1999
  %indvars.iv.next165 = add nuw i64 %indvars.iv164, 1
  br i1 %exitcond166, label %._crit_edge128.loopexit195, label %.lr.ph127.split, !llvm.loop !21

._crit_edge128.loopexit:                          ; preds = %._crit_edge124.us
  br label %._crit_edge128

._crit_edge128.loopexit195:                       ; preds = %.lr.ph127.split
  br label %._crit_edge128

._crit_edge128:                                   ; preds = %._crit_edge128.loopexit195, %._crit_edge128.loopexit, %middle.block
...
._crit_edge93:                                    ; preds = %._crit_edge93.preheader, %._crit_edge108
  ...
  br i1 %93, label %.lr.ph107.preheader, label %._crit_edge108

.lr.ph107.preheader:                              ; preds = %._crit_edge93
  %wide.trip.count147 = zext i32 %indvars.iv145 to i64
  %xtraiter202 = and i64 %indvars.iv149, 3
  %lcmp.mod203 = icmp eq i64 %xtraiter202, 0
  br i1 %lcmp.mod203, label %.lr.ph107.prol.loopexit, label %.lr.ph107.prol.preheader
...
.lr.ph107.prol:                                   ; preds = %.lr.ph107.prol, %.lr.ph107.prol.preheader
  ...
  %.2105.prol = phi double [ %99, %.lr.ph107.prol ], [ %92, %.lr.ph107.prol.preheader ]
  %prol.iter204 = phi i64 [ %prol.iter204.sub, %.lr.ph107.prol ], [ %xtraiter202, %.lr.ph107.prol.preheader ]
  ...
  br i1 %prol.iter204.cmp, label %.lr.ph107.prol.loopexit.unr-lcssa, label %.lr.ph107.prol, !llvm.loop !23
...
.lr.ph107.prol.loopexit:                          ; preds = %.lr.ph107.preheader, %.lr.ph107.prol.loopexit.unr-lcssa
  %.lcssa199.unr = phi double [ undef, %.lr.ph107.preheader ], [ %99, %.lr.ph107.prol.loopexit.unr-lcssa ]
  %indvars.iv140.unr = phi i64 [ 0, %.lr.ph107.preheader ], [ %indvars.iv.next141.prol, %.lr.ph107.prol.loopexit.unr-lcssa ]
  %.2105.unr = phi double [ %92, %.lr.ph107.preheader ], [ %99, %.lr.ph107.prol.loopexit.unr-lcssa ]
  %100 = icmp ult i64 %90, 3
  br i1 %100, label %._crit_edge108.loopexit, label %.lr.ph107.preheader.new
...
.lr.ph107:                                        ; preds = %.lr.ph107, %.lr.ph107.preheader.new
  ...
  %.2105 = phi double [ %.2105.unr, %.lr.ph107.preheader.new ], [ %122, %.lr.ph107 ]
...
._crit_edge108.loopexit:                          ; preds = %.lr.ph107.prol.loopexit, %._crit_edge108.loopexit.unr-lcssa
  %.lcssa199 = phi double [ %.lcssa199.unr, %.lr.ph107.prol.loopexit ], [ %122, %._crit_edge108.loopexit.unr-lcssa ]
  br label %._crit_edge108

._crit_edge108:                                   ; preds = %._crit_edge108.loopexit, %._crit_edge93
  %.2.lcssa = phi double [ %92, %._crit_edge93 ], [ %.lcssa199, %._crit_edge108.loopexit ]
  ...
  br i1 %124, label %._crit_edge93, label %._crit_edge95.preheader
...
._crit_edge95:                                    ; preds = %._crit_edge95.preheader, %._crit_edge100.._crit_edge95_crit_edge
  ...
  %indvars.iv = phi i32 [ 2000, %._crit_edge95.preheader ], [ %indvars.iv.next, %._crit_edge100.._crit_edge95_crit_edge ]
...
.lr.ph.prol.loopexit:                             ; preds = %._crit_edge95..lr.ph_crit_edge, %.lr.ph.prol.loopexit.unr-lcssa
  ...
  %indvars.iv136.unr = phi i64 [ %131, %._crit_edge95..lr.ph_crit_edge ], [ %indvars.iv.next137.prol, %.lr.ph.prol.loopexit.unr-lcssa ]
