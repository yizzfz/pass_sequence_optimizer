...
vector.body140:                                   ; preds = %vector.body140, %vector.body140.preheader
  ...
  %14 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 0, i64 %index154
  ...
  %23 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 0, i64 %index.next155
  ...
  %32 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 0, i64 %index.next155.1
  ...
  %36 = icmp eq i64 %index.next155.2, 1200
  br i1 %36, label %.preheader2.us.preheader.loopexit4, label %vector.body140, !llvm.loop !6

.preheader2.us.preheader.loopexit:                ; preds = %scalar.ph142
  br label %.preheader2.us.preheader

.preheader2.us.preheader.loopexit4:               ; preds = %vector.body140
  br label %.preheader2.us.preheader

.preheader2.us.preheader:                         ; preds = %.preheader2.us.preheader.loopexit4, %.preheader2.us.preheader.loopexit
...
.preheader2.us:                                   ; preds = %.preheader2.us.preheader, %._crit_edge.us
  ...
  %scevgep112 = getelementptr [1200 x double], [1200 x double]* %1, i64 %37, i64 0
  %38 = add nuw nsw i64 %indvar, 2
  %scevgep114 = getelementptr [1200 x double], [1200 x double]* %1, i64 %38, i64 0
  %scevgep116 = getelementptr [1200 x double], [1200 x double]* %2, i64 %indvar, i64 0
  %scevgep118 = getelementptr [1200 x double], [1200 x double]* %2, i64 %38, i64 0
  %39 = add nsw i64 %indvars.iv25, -1
...
vector.body107:                                   ; preds = %vector.body107.preheader, %vector.body107
  ...
  %40 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv25, i64 %index126
  %41 = bitcast double* %40 to <2 x double>*
  %wide.load134 = load <2 x double>, <2 x double>* %41, align 8, !alias.scope !9, !noalias !12
  %42 = getelementptr double, double* %40, i64 2
  %43 = bitcast double* %42 to <2 x double>*
  %wide.load135 = load <2 x double>, <2 x double>* %43, align 8, !alias.scope !9, !noalias !12
  %44 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv25, i64 %index126
  %45 = bitcast double* %44 to <2 x double>*
  %wide.load136 = load <2 x double>, <2 x double>* %45, align 8, !alias.scope !12
  %46 = getelementptr double, double* %44, i64 2
  %47 = bitcast double* %46 to <2 x double>*
  %wide.load137 = load <2 x double>, <2 x double>* %47, align 8, !alias.scope !12
  %48 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %39, i64 %index126
  %49 = bitcast double* %48 to <2 x double>*
  %wide.load138 = load <2 x double>, <2 x double>* %49, align 8, !alias.scope !12
  %50 = getelementptr double, double* %48, i64 2
  %51 = bitcast double* %50 to <2 x double>*
  %wide.load139 = load <2 x double>, <2 x double>* %51, align 8, !alias.scope !12
  %52 = fsub <2 x double> %wide.load136, %wide.load138
  %53 = fsub <2 x double> %wide.load137, %wide.load139
  ...
  %56 = fsub <2 x double> %wide.load134, %54
  %57 = fsub <2 x double> %wide.load135, %55
  ...
  %60 = icmp eq i64 %index.next127, 1200
  br i1 %60, label %._crit_edge.us.loopexit3, label %vector.body107, !llvm.loop !14
...
scalar.ph109:                                     ; preds = %scalar.ph109, %scalar.ph109.preheader
  ...
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv25, i64 %indvars.iv21
  %62 = load double, double* %61, align 8
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv25, i64 %indvars.iv21
  %64 = load double, double* %63, align 8
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %39, i64 %indvars.iv21
  ...
  %70 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv25, i64 %indvars.iv.next22
  %71 = load double, double* %70, align 8
  %72 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv25, i64 %indvars.iv.next22
  %73 = load double, double* %72, align 8
  %74 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %39, i64 %indvars.iv.next22
...
._crit_edge.us.loopexit3:                         ; preds = %vector.body107
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit3, %._crit_edge.us.loopexit
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  %indvar.next = add nuw nsw i64 %indvar, 1
  %exitcond162 = icmp eq i64 %indvar.next, 999
  br i1 %exitcond162, label %.preheader1.us.preheader, label %.preheader2.us
...
.preheader1.us:                                   ; preds = %.preheader1.us.preheader, %._crit_edge9.us
  ...
  %scevgep81 = getelementptr [1200 x double], [1200 x double]* %0, i64 %111, i64 0
  %scevgep83 = getelementptr [1200 x double], [1200 x double]* %2, i64 %indvars.iv32, i64 0
  %scevgep85 = getelementptr [1200 x double], [1200 x double]* %2, i64 %111, i64 0
...
vector.body74:                                    ; preds = %vector.body74.preheader, %vector.body74
  ...
  %wide.load101 = load <2 x double>, <2 x double>* %113, align 8, !alias.scope !17, !noalias !20
  %114 = getelementptr double, double* %112, i64 2
  %115 = bitcast double* %114 to <2 x double>*
  %wide.load102 = load <2 x double>, <2 x double>* %115, align 8, !alias.scope !17, !noalias !20
  %116 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv32, i64 %offset.idx
  %117 = bitcast double* %116 to <2 x double>*
  %wide.load103 = load <2 x double>, <2 x double>* %117, align 8, !alias.scope !20
  %118 = getelementptr double, double* %116, i64 2
  %119 = bitcast double* %118 to <2 x double>*
  %wide.load104 = load <2 x double>, <2 x double>* %119, align 8, !alias.scope !20
  %120 = add nsw i64 %offset.idx, -1
  %121 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv32, i64 %120
  %122 = bitcast double* %121 to <2 x double>*
  %wide.load105 = load <2 x double>, <2 x double>* %122, align 8, !alias.scope !20
  %123 = getelementptr double, double* %121, i64 2
  %124 = bitcast double* %123 to <2 x double>*
  %wide.load106 = load <2 x double>, <2 x double>* %124, align 8, !alias.scope !20
  %125 = fsub <2 x double> %wide.load103, %wide.load105
  %126 = fsub <2 x double> %wide.load104, %wide.load106
  ...
  %129 = fsub <2 x double> %wide.load101, %127
  %130 = fsub <2 x double> %wide.load102, %128
  ...
  %133 = icmp eq i64 %index.next94, 1196
  br i1 %133, label %scalar.ph76.preheader.new.loopexit, label %vector.body74, !llvm.loop !22
...
._crit_edge9.us:                                  ; preds = %scalar.ph76
  ...
  %exitcond163 = icmp eq i64 %indvars.iv.next33, 1000
  br i1 %exitcond163, label %.preheader.us.preheader, label %.preheader1.us
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge11.us
  ...
  %scevgep55 = getelementptr [1200 x double], [1200 x double]* %0, i64 %163, i64 0
  %scevgep57 = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv39, i64 0
  %scevgep59 = getelementptr [1200 x double], [1200 x double]* %1, i64 %163, i64 1199
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load65 = load <2 x double>, <2 x double>* %167, align 8, !alias.scope !24, !noalias !27
  %168 = or i64 %index, 1
  %169 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv39, i64 %168
  %170 = bitcast double* %169 to <2 x double>*
  %wide.load66 = load <2 x double>, <2 x double>* %170, align 8, !alias.scope !30
  %171 = getelementptr double, double* %169, i64 2
  %172 = bitcast double* %171 to <2 x double>*
  %wide.load67 = load <2 x double>, <2 x double>* %172, align 8, !alias.scope !30
  %173 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv39, i64 %index
  %174 = bitcast double* %173 to <2 x double>*
  %wide.load68 = load <2 x double>, <2 x double>* %174, align 8, !alias.scope !30
  %175 = getelementptr double, double* %173, i64 2
  %176 = bitcast double* %175 to <2 x double>*
  %wide.load69 = load <2 x double>, <2 x double>* %176, align 8, !alias.scope !30
  %177 = fsub <2 x double> %wide.load66, %wide.load68
  %178 = fsub <2 x double> %wide.load67, %wide.load69
  ...
  %wide.load70 = load <2 x double>, <2 x double>* %180, align 8, !alias.scope !31
  %181 = getelementptr double, double* %179, i64 2
  %182 = bitcast double* %181 to <2 x double>*
  %wide.load71 = load <2 x double>, <2 x double>* %182, align 8, !alias.scope !31
  %183 = fadd <2 x double> %177, %wide.load70
  %184 = fadd <2 x double> %178, %wide.load71
  %185 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv39, i64 %index
  %186 = bitcast double* %185 to <2 x double>*
  %wide.load72 = load <2 x double>, <2 x double>* %186, align 8, !alias.scope !31
  %187 = getelementptr double, double* %185, i64 2
  %188 = bitcast double* %187 to <2 x double>*
  %wide.load73 = load <2 x double>, <2 x double>* %188, align 8, !alias.scope !31
  %189 = fsub <2 x double> %183, %wide.load72
  %190 = fsub <2 x double> %184, %wide.load73
  ...
  %194 = fsub <2 x double> %wide.load65, %192
...
._crit_edge11.us:                                 ; preds = %._crit_edge19
  %exitcond164 = icmp eq i64 %indvars.iv.next40, 999
  br i1 %exitcond164, label %._crit_edge12, label %.preheader.us

._crit_edge12:                                    ; preds = %._crit_edge11.us
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  %exitcond165 = icmp eq i64 %indvars.iv.next42, 500
  br i1 %exitcond165, label %._crit_edge13, label %.preheader6
...
._crit_edge:                                      ; preds = %._crit_edge19, %12
  ...
  br i1 %exitcond41, label %._crit_edge14.us, label %._crit_edge19

._crit_edge14.us:                                 ; preds = %._crit_edge
  %indvars.iv.next34 = add nuw nsw i64 %indvars.iv33, 1
  %exitcond42 = icmp eq i64 %indvars.iv.next34, 1000
  br i1 %exitcond42, label %._crit_edge15, label %.preheader8.us
...
._crit_edge20:                                    ; preds = %._crit_edge21, %29
  ...
  %exitcond39 = icmp eq i64 %indvars.iv.next27, 1200
  br i1 %exitcond39, label %._crit_edge11.us, label %._crit_edge21

._crit_edge11.us:                                 ; preds = %._crit_edge20
  %indvars.iv.next29 = add nuw nsw i64 %indvars.iv28, 1
  %exitcond40 = icmp eq i64 %indvars.iv.next29, 1000
  br i1 %exitcond40, label %._crit_edge12, label %.preheader7.us
...
._crit_edge.us:                                   ; preds = %._crit_edge22
  ...
  %exitcond38 = icmp eq i64 %indvars.iv.next25, 1000
  br i1 %exitcond38, label %._crit_edge9, label %.preheader.us
