...
@__llvm_prf_nm = private constant [280 x i8] c"\95\02\00init_layer3\01do_layer3\01tmp1.ll:III_get_side_info_2\01tmp1.ll:III_get_side_info_1\01tmp1.ll:III_get_scale_factors_2\01tmp1.ll:III_get_scale_factors_1\01tmp1.ll:III_dequantize_sample\01tmp1.ll:III_i_stereo\01tmp1.ll:III_antialias\01tmp1.ll:III_hybrid\01tmp1.ll:get1bit\01tmp1.ll:dct36\01tmp1.ll:dct12", section "__llvm_prf_names"
@llvm.used = appending global [14 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_init_layer3 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_do_layer3 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_III_get_side_info_2 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_III_get_side_info_1 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_III_get_scale_factors_2 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_III_get_scale_factors_1 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_III_dequantize_sample to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_III_i_stereo to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_III_antialias to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_III_hybrid to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_get1bit to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_dct36 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_dct12 to i8*), i8* getelementptr inbounds ([280 x i8], [280 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
