...
.lr.ph14.new.preheader:
  br label %.lr.ph14.new

.lr.ph14.new:                                     ; preds = %.lr.ph14.new.preheader, %.lr.ph14.new
  %indvars.iv412 = phi i64 [ %indvars.iv.next5.1, %.lr.ph14.new ], [ 0, %.lr.ph14.new.preheader ]
  ...
  br i1 %exitcond19.1, label %.lr.ph10.split.us.new.preheader.preheader, label %.lr.ph14.new

.lr.ph10.split.us.new.preheader.preheader:        ; preds = %.lr.ph14.new
  br label %.lr.ph10.split.us.new.preheader

.lr.ph10.split.us.new.preheader:                  ; preds = %.lr.ph10.split.us.new.preheader.preheader, %._crit_edge.us
  %indvars.iv27.us = phi i64 [ %indvars.iv.next3.us, %._crit_edge.us ], [ 0, %.lr.ph10.split.us.new.preheader.preheader ]
  %14 = trunc i64 %indvars.iv27.us to i32
  %15 = srem i32 %14, 2100
  %16 = sitofp i32 %15 to double
  %17 = fdiv double %16, 2.100000e+03
  %18 = getelementptr inbounds double, double* %1, i64 %indvars.iv27.us
  store double %17, double* %18, align 8
  br label %.lr.ph10.split.us.new

.lr.ph10.split.us.new:                            ; preds = %.lr.ph10.split.us.new.preheader, %.lr.ph10.split.us.new
  %indvars.iv6.us = phi i64 [ %indvars.iv.next.us.1, %.lr.ph10.split.us.new ], [ 0, %.lr.ph10.split.us.new.preheader ]
  %indvars.iv.next.us = or i64 %indvars.iv6.us, 1
  %19 = mul nuw nsw i64 %indvars.iv.next.us, %indvars.iv27.us
  %20 = trunc i64 %19 to i32
  %21 = srem i32 %20, 2100
  %22 = sitofp i32 %21 to double
  %23 = getelementptr inbounds [1900 x double], [1900 x double]* %0, i64 %indvars.iv27.us, i64 %indvars.iv6.us
  %indvars.iv.next.us.1 = add nsw i64 %indvars.iv6.us, 2
  %24 = mul nuw nsw i64 %indvars.iv.next.us.1, %indvars.iv27.us
  %25 = trunc i64 %24 to i32
  %26 = srem i32 %25, 2100
  %27 = sitofp i32 %26 to double
  %28 = insertelement <2 x double> undef, double %22, i32 0
  %29 = insertelement <2 x double> %28, double %27, i32 1
  %30 = fdiv <2 x double> %29, <double 2.100000e+03, double 2.100000e+03>
...
._crit_edge.us:                                   ; preds = %.lr.ph10.split.us.new
  ...
  br i1 %exitcond17, label %._crit_edge11, label %.lr.ph10.split.us.new.preheader
...
; <label>:7:                                      ; preds = %7, %.lr.ph10.split.us
  ...
  %10 = load double, double* %sunkaddr34, align 8
  ...
  store double %20, double* %sunkaddr38, align 8
