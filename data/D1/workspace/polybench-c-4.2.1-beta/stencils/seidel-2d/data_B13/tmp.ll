...
.preheader.us.new:                                ; preds = %.preheader.us.new, %.preheader.us
  ...
  %17 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv5, i64 %indvars.iv.next
...
.preheader:                                       ; preds = %._crit_edge, %.preheader3
  %indvar = phi i64 [ %indvar.next, %._crit_edge ], [ 0, %.preheader3 ]
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %._crit_edge ], [ 1, %.preheader3 ]
  %3 = add i64 %indvar, 1
...
; <label>:5:                                      ; preds = %5, %.preheader
  ...
  %19 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv9, i64 %indvars.iv.next
  %20 = load double, double* %19, align 8
  %21 = fadd double %18, %20
  %22 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next10, i64 %6
  %23 = load double, double* %22, align 8
  %24 = fadd double %21, %23
  %25 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next10, i64 %indvars.iv
  ...
  %exitcond14 = icmp eq i64 %indvars.iv.next, 1999
  br i1 %exitcond14, label %._crit_edge, label %5
...
._crit_edge6:                                     ; preds = %._crit_edge
  ...
  %exitcond13 = icmp eq i32 %32, 500
  br i1 %exitcond13, label %._crit_edge8, label %.preheader3
