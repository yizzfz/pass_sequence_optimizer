...
.preheader176.us:                                 ; preds = %.preheader176.lr.ph, %._crit_edge209.us
  %indvars.iv246.us = phi i64 [ %indvars.iv.next247.us, %._crit_edge209.us ], [ 0, %.preheader176.lr.ph ]
...
.preheader174.us:                                 ; preds = %.preheader174.us.preheader, %._crit_edge200.us
  ...
  %scevgep293 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv240.us, i64 0
  %scevgep296 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv240.us, i64 2160
  %scevgep299 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv240.us, i64 0
  %scevgep302 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv240.us, i64 2160
  %scevgep305 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv240.us, i64 0
  %scevgep308 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv240.us, i64 2160
  %bound0 = icmp ult float* %scevgep293, %scevgep302
  %bound1 = icmp ult float* %scevgep299, %scevgep296
  %found.conflict = and i1 %bound0, %bound1
  %bound0310 = icmp ult float* %scevgep293, %scevgep308
  %bound1311 = icmp ult float* %scevgep305, %scevgep296
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %84 = shl i64 %index, 1
  %85 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv240.us, i64 %84
  %86 = bitcast float* %85 to <8 x float>*
  %wide.vec = load <8 x float>, <8 x float>* %86, align 4, !alias.scope !4
  %87 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv240.us, i64 %84
  %88 = bitcast float* %87 to <8 x float>*
  %wide.vec314 = load <8 x float>, <8 x float>* %88, align 4, !alias.scope !7
  %89 = fadd <8 x float> %wide.vec, %wide.vec314
  %90 = shufflevector <8 x float> %89, <8 x float> undef, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %91 = or i64 %84, 1
  %92 = fadd <8 x float> %wide.vec, %wide.vec314
  ...
  br i1 %97, label %._crit_edge200.us.loopexit371, label %vector.body, !llvm.loop !12
...
._crit_edge200.us.loopexit371:                    ; preds = %vector.body
  br label %._crit_edge200.us

._crit_edge200.us:                                ; preds = %._crit_edge200.us.loopexit371, %._crit_edge200.us.loopexit
...
.preheader170.us:                                 ; preds = %.preheader170.lr.ph, %._crit_edge189.us
  %indvars.iv224.us = phi i64 [ %indvars.iv.next225.us, %._crit_edge189.us ], [ 0, %.preheader170.lr.ph ]
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  ...
  %scevgep327 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv218.us, i64 0
  %scevgep330 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv218.us, i64 2160
  %scevgep333 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv218.us, i64 0
  %scevgep336 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv218.us, i64 2160
  %scevgep339 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv218.us, i64 0
  %scevgep342 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv218.us, i64 2160
  %bound0344 = icmp ult float* %scevgep327, %scevgep336
  %bound1345 = icmp ult float* %scevgep333, %scevgep330
  %found.conflict346 = and i1 %bound0344, %bound1345
  %bound0347 = icmp ult float* %scevgep327, %scevgep342
  %bound1348 = icmp ult float* %scevgep339, %scevgep330
  %found.conflict349 = and i1 %bound0347, %bound1348
  %conflict.rdx350 = or i1 %found.conflict346, %found.conflict349
  br i1 %conflict.rdx350, label %.preheader.us.new.preheader, label %vector.body317.preheader

vector.body317.preheader:                         ; preds = %.preheader.us
  br label %vector.body317

vector.body317:                                   ; preds = %vector.body317.preheader, %vector.body317
  %index354 = phi i64 [ %index.next355, %vector.body317 ], [ 0, %vector.body317.preheader ]
  %153 = shl i64 %index354, 1
  %154 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv218.us, i64 %153
  %155 = bitcast float* %154 to <8 x float>*
  %wide.vec363 = load <8 x float>, <8 x float>* %155, align 4, !alias.scope !14
  %156 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv218.us, i64 %153
  %157 = bitcast float* %156 to <8 x float>*
  %wide.vec366 = load <8 x float>, <8 x float>* %157, align 4, !alias.scope !17
  %158 = fadd <8 x float> %wide.vec363, %wide.vec366
  %159 = shufflevector <8 x float> %158, <8 x float> undef, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %160 = or i64 %153, 1
  %161 = fadd <8 x float> %wide.vec363, %wide.vec366
  ...
  %interleaved.vec369 = shufflevector <4 x float> %159, <4 x float> %162, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x float> %interleaved.vec369, <8 x float>* %165, align 4, !alias.scope !19, !noalias !21
  %index.next355 = add nuw nsw i64 %index354, 4
  %166 = icmp eq i64 %index.next355, 1080
  br i1 %166, label %._crit_edge.us.loopexit370, label %vector.body317, !llvm.loop !22
...
._crit_edge.us.loopexit370:                       ; preds = %vector.body317
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit370, %._crit_edge.us.loopexit
