...
entry:
  ...
  tail call fastcc void @kernel_gesummv(double %0, double %1, [1300 x double]* %arraydecay, [1300 x double]* %arraydecay7, double* %arraydecay11, double* %arraydecay8, double* %arraydecay13)
...
for.body:                                         ; preds = %for.end, %entry
  %indvars.iv62 = phi i64 [ 0, %entry ], [ %indvars.iv.next7, %for.end ]
  %0 = trunc i64 %indvars.iv62 to i32
  %rem = srem i32 %0, 1300
  %conv = sitofp i32 %rem to double
  %div = fdiv double %conv, 1.300000e+03
  %arrayidx = getelementptr inbounds double, double* %x, i64 %indvars.iv62
  store double %div, double* %arrayidx, align 8
  br label %for.body5

for.body5:                                        ; preds = %for.body5, %for.body
  %indvars.iv1 = phi i64 [ 0, %for.body ], [ %indvars.iv.next, %for.body5 ]
  %1 = mul nuw nsw i64 %indvars.iv1, %indvars.iv62
  %2 = add nuw nsw i64 %1, 1
  %3 = trunc i64 %2 to i32
  %rem6 = srem i32 %3, 1300
  %conv7 = sitofp i32 %rem6 to double
  %arrayidx13 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv62, i64 %indvars.iv1
  ...
  %arrayidx23 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv62, i64 %indvars.iv1
  store double %div9.v.r2, double* %arrayidx23, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv1, 1
  %exitcond5 = icmp eq i64 %indvars.iv.next, 1300
  br i1 %exitcond5, label %for.end, label %for.body5

for.end:                                          ; preds = %for.body5
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv62, 1
  %exitcond = icmp eq i64 %indvars.iv.next7, 1300
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc void @kernel_gesummv(double %alpha, double %beta, [1300 x double]* nocapture readonly %A, [1300 x double]* nocapture readonly %B, double* nocapture %tmp, double* nocapture readonly %x, double* %y) unnamed_addr #2 {
entry:
  %0 = ptrtoint double* %tmp to i64
  %sunkaddr = ptrtoint double* %tmp to i64
  %sunkaddr19 = ptrtoint double* %y to i64
  br label %for.body

for.body:                                         ; preds = %for.end, %entry
  %indvars.iv32 = phi i64 [ 0, %entry ], [ %indvars.iv.next4, %for.end ]
  %arrayidx = getelementptr inbounds double, double* %tmp, i64 %indvars.iv32
  store double 0.000000e+00, double* %arrayidx, align 8
  %arrayidx4 = getelementptr inbounds double, double* %y, i64 %indvars.iv32
  store double 0.000000e+00, double* %arrayidx4, align 8
  %sunkaddr16 = shl i64 %indvars.iv32, 3
  %sunkaddr17 = add i64 %sunkaddr, %sunkaddr16
  %sunkaddr18 = inttoptr i64 %sunkaddr17 to double*
  %sunkaddr20 = shl i64 %indvars.iv32, 3
  %sunkaddr21 = add i64 %sunkaddr19, %sunkaddr20
  %sunkaddr22 = inttoptr i64 %sunkaddr21 to double*
  br label %for.body7

for.body7:                                        ; preds = %for.body7, %for.body
  %indvars.iv1 = phi i64 [ 0, %for.body ], [ %indvars.iv.next, %for.body7 ]
  %arrayidx11 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv32, i64 %indvars.iv1
  %1 = load double, double* %arrayidx11, align 8
  %arrayidx13 = getelementptr inbounds double, double* %x, i64 %indvars.iv1
  ...
  %arrayidx21 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv32, i64 %indvars.iv1
  %4 = load double, double* %arrayidx21, align 8
  %arrayidx23 = getelementptr inbounds double, double* %x, i64 %indvars.iv1
  %5 = load double, double* %arrayidx23, align 8
  %mul24 = fmul double %4, %5
  %6 = load double, double* %sunkaddr22, align 8
  %add27 = fadd double %mul24, %6
  store double %add27, double* %sunkaddr22, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv1, 1
  %exitcond2 = icmp eq i64 %indvars.iv.next, 1300
  br i1 %exitcond2, label %for.end, label %for.body7

for.end:                                          ; preds = %for.body7
  %sunkaddr13 = shl i64 %indvars.iv32, 3
  %sunkaddr14 = add i64 %0, %sunkaddr13
  %sunkaddr15 = inttoptr i64 %sunkaddr14 to double*
  %7 = load double, double* %sunkaddr15, align 8
  %mul32 = fmul double %7, %alpha
  %arrayidx34 = getelementptr inbounds double, double* %y, i64 %indvars.iv32
  ...
  %exitcond = icmp eq i64 %indvars.iv.next4, 1300
