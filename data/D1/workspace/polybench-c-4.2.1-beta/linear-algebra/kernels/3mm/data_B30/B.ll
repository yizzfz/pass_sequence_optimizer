...
define i32 @main(i32, i8** nocapture readonly) #0 {
  ...
  call void @init_array(i32 800, i32 900, i32 1000, i32 1100, i32 1200, [1000 x double]* %10, [900 x double]* %11, [1200 x double]* %12, [1100 x double]* %13)
  call void (...) @polybench_timer_start() #4
  %14 = bitcast i8* %3 to [900 x double]*
  %15 = bitcast i8* %6 to [1100 x double]*
  %16 = bitcast i8* %9 to [1100 x double]*
  call void @kernel_3mm(i32 800, i32 900, i32 1000, i32 1100, i32 1200, [900 x double]* %14, [1000 x double]* %10, [900 x double]* %11, [1100 x double]* %15, [1200 x double]* %12, [1100 x double]* %13, [1100 x double]* %16)
...
; <label>:21:                                     ; preds = %18
  call void @print_array(i32 800, i32 1100, [1100 x double]* %16)
  br label %._crit_edge
...
.lr.ph51.split.us:                                ; preds = %._crit_edge46.us, %.lr.ph51
  %indvars.iv88 = phi i64 [ 0, %.lr.ph51 ], [ %indvars.iv.next89, %._crit_edge46.us ]
  br label %._crit_edge
...
.lr.ph62.us.us.new:                               ; preds = %.lr.ph62.us.us.new, %.lr.ph62.us.us
  ...
  %13 = phi double [ 0.000000e+00, %.lr.ph62.us.us ], [ %25, %.lr.ph62.us.us.new ]
...
.lr.ph34.us.us.new:                               ; preds = %.lr.ph34.us.us.new, %.lr.ph34.us.us
  ...
  %27 = phi double [ 0.000000e+00, %.lr.ph34.us.us ], [ %39, %.lr.ph34.us.us.new ]
...
.lr.ph6.split.us:                                 ; preds = %._crit_edge3.us, %.lr.ph6.split.us.preheader
  %indvars.iv12 = phi i64 [ 0, %.lr.ph6.split.us.preheader ], [ %indvars.iv.next13, %._crit_edge3.us ]
  %7 = mul nsw i64 %indvars.iv12, 800
  br label %._crit_edge.us._crit_edge

._crit_edge.us._crit_edge:                        ; preds = %._crit_edge.us, %.lr.ph6.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph6.split.us ], [ %indvars.iv.next, %._crit_edge.us ]
...
._crit_edge3.us:                                  ; preds = %._crit_edge.us
  ...
  br i1 %exitcond15, label %._crit_edge7, label %.lr.ph6.split.us
