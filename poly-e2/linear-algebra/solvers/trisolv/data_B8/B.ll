...
define internal fastcc void @init_array([2000 x double]* %L, double* %x, double* %b) unnamed_addr #2 {
for.body.lr.ph:
...
for.body6.lr.ph:                                  ; preds = %for.end.for.body6.lr.ph_crit_edge, %for.body.lr.ph
  ...
  %1 = add nuw nsw i64 %indvars.iv5, 2001
  %2 = trunc i64 %1 to i32
  %3 = and i64 %indvars.iv5, 1
...
for.body6.prol:                                   ; preds = %for.body6.prol.preheader
  ...
  %arrayidx13.prol = getelementptr inbounds [2000 x double], [2000 x double]* %L, i64 %indvars.iv5, i64 0
...
for.body6.prol.loopexit:                          ; preds = %for.body6.prol.loopexit.unr-lcssa
  %4 = icmp eq i64 %indvars.iv5, 0
  br i1 %4, label %for.body6.prol.loopexit.for.end_crit_edge, label %for.body6.lr.ph.new
...
for.body6:                                        ; preds = %for.body6.for.body6_crit_edge, %for.body6.lr.ph.new
  ...
  %exitcond.1 = icmp eq i64 %indvars.iv.next, %indvars.iv5
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  br i1 %exitcond.1, label %for.end.unr-lcssa, label %for.body6.for.body6_crit_edge
...
for.end:                                          ; preds = %for.body6.prol.loopexit.for.end_crit_edge, %for.end.unr-lcssa
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1
  %exitcond8 = icmp eq i64 %indvars.iv.next6, 2000
  br i1 %exitcond8, label %for.end16, label %for.end.for.body6.lr.ph_crit_edge
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc void @kernel_trisolv([2000 x double]* %L, double* %x, double* %b) unnamed_addr #2 {
for.body.preheader:
  br label %for.body

for.body:                                         ; preds = %for.end.for.body_crit_edge, %for.body.preheader
  %indvars.iv7 = phi i32 [ %indvars.iv.next8, %for.end.for.body_crit_edge ], [ -1, %for.body.preheader ]
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.end.for.body_crit_edge ], [ 0, %for.body.preheader ]
  %0 = add nuw nsw i64 %indvars.iv5, 4294967295
  %1 = and i64 %0, 4294967295
  %2 = zext i32 %indvars.iv7 to i64
...
for.body5.preheader:                              ; preds = %for.body
  ...
  br i1 %lcmp.mod, label %for.body5.prol.preheader, label %for.body5.preheader.for.body5.prol.loopexit.unr-lcssa_crit_edge

for.body5.preheader.for.body5.prol.loopexit.unr-lcssa_crit_edge: ; preds = %for.body5.preheader
...
for.body5.prol.loopexit.unr-lcssa:                ; preds = %for.body5.preheader.for.body5.prol.loopexit.unr-lcssa_crit_edge, %for.body5.prol
  %sub.lcssa.unr.ph = phi double [ %sub.prol, %for.body5.prol ], [ undef, %for.body5.preheader.for.body5.prol.loopexit.unr-lcssa_crit_edge ]
  %indvars.iv.unr.ph = phi i64 [ 1, %for.body5.prol ], [ 0, %for.body5.preheader.for.body5.prol.loopexit.unr-lcssa_crit_edge ]
  %.unr.ph = phi double [ %sub.prol, %for.body5.prol ], [ %3, %for.body5.preheader.for.body5.prol.loopexit.unr-lcssa_crit_edge ]
  br label %for.body5.prol.loopexit

for.body5.prol.loopexit:                          ; preds = %for.body5.prol.loopexit.unr-lcssa
  %7 = icmp eq i64 %1, 0
  br i1 %7, label %for.body5.prol.loopexit.for.end.loopexit_crit_edge, label %for.body5.preheader.new
...
for.body5:                                        ; preds = %for.body5.for.body5_crit_edge, %for.body5.preheader.new
  %indvars.iv = phi i64 [ %indvars.iv.unr.ph, %for.body5.preheader.new ], [ %indvars.iv.next.1, %for.body5.for.body5_crit_edge ]
  %8 = phi double [ %.unr.ph, %for.body5.preheader.new ], [ %sub.1, %for.body5.for.body5_crit_edge ]
  ...
  %exitcond9.1 = icmp eq i64 %indvars.iv.next, %2
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  br i1 %exitcond9.1, label %for.end.loopexit.unr-lcssa, label %for.body5.for.body5_crit_edge
...
for.end.loopexit:                                 ; preds = %for.body5.prol.loopexit.for.end.loopexit_crit_edge, %for.end.loopexit.unr-lcssa
  %sub.lcssa = phi double [ %sub.lcssa.unr.ph, %for.body5.prol.loopexit.for.end.loopexit_crit_edge ], [ %sub.1, %for.end.loopexit.unr-lcssa ]
  br label %for.end

for.end:                                          ; preds = %for.body.for.end_crit_edge, %for.end.loopexit
  %.lcssa = phi double [ %3, %for.body.for.end_crit_edge ], [ %sub.lcssa, %for.end.loopexit ]
  ...
  br i1 %exitcond, label %for.end.for.body_crit_edge, label %for.end24
...
for.body:                                         ; preds = %if.end.for.body_crit_edge, %for.body.preheader
  ...
  %4 = phi %struct._IO_FILE* [ %3, %for.body.preheader ], [ %8, %if.end.for.body_crit_edge ]
