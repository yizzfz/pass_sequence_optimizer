...
for.cond1.preheader.us:                           ; preds = %entry, %for.cond1.for.end_crit_edge.us
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.cond1.for.end_crit_edge.us ], [ 0, %entry ]
...
for.body3.us:                                     ; preds = %for.body3.us, %for.cond1.preheader.us
  ...
  %arrayidx6.us = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv47, i64 %indvars.iv41
  store double %div.us, double* %arrayidx6.us, align 8
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  %exitcond46 = icmp eq i64 %indvars.iv.next42, 1100
  br i1 %exitcond46, label %for.cond1.for.end_crit_edge.us, label %for.body3.us
...
for.cond14.preheader.us:                          ; preds = %for.cond14.preheader.us.preheader, %for.cond14.for.end30_crit_edge.us
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.cond14.for.end30_crit_edge.us ], [ 0, %for.cond14.preheader.us.preheader ]
  br label %for.body17.us

for.body17.us:                                    ; preds = %for.cond14.preheader.us, %for.body17.us
  %indvars.iv31 = phi i64 [ %indvars.iv.next32.1, %for.body17.us ], [ 0, %for.cond14.preheader.us ]
  %indvars.iv.next32 = or i64 %indvars.iv31, 1
  %3 = mul nuw nsw i64 %indvars.iv.next32, %indvars.iv36
  %4 = trunc i64 %3 to i32
  %rem20.us = srem i32 %4, 1200
  %conv21.us = sitofp i32 %rem20.us to double
  %arrayidx27.us = getelementptr inbounds [1200 x double], [1200 x double]* %A, i64 %indvars.iv36, i64 %indvars.iv31
  %indvars.iv.next32.1 = add nuw nsw i64 %indvars.iv31, 2
  %5 = mul nuw nsw i64 %indvars.iv.next32.1, %indvars.iv36
  ...
  br i1 %exitcond35.1, label %for.cond14.for.end30_crit_edge.us, label %for.body17.us

for.cond14.for.end30_crit_edge.us:                ; preds = %for.body17.us
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  %exitcond39 = icmp eq i64 %indvars.iv.next37, 1000
  br i1 %exitcond39, label %for.cond38.preheader.us.preheader, label %for.cond14.preheader.us
...
for.cond38.preheader.us:                          ; preds = %for.cond38.preheader.us.preheader, %for.cond38.for.end54_crit_edge.us
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.cond38.for.end54_crit_edge.us ], [ 0, %for.cond38.preheader.us.preheader ]
...
for.body41.us:                                    ; preds = %for.body41.us, %for.cond38.preheader.us
  ...
  %9 = mul nuw nsw i64 %8, %indvars.iv26
...
for.cond38.for.end54_crit_edge.us:                ; preds = %for.body41.us
  ...
  %exitcond29 = icmp eq i64 %indvars.iv.next27, 1200
  br i1 %exitcond29, label %for.end57, label %for.cond38.preheader.us
...
for.cond1.preheader.us:                           ; preds = %for.end31.us, %entry
  %indvars.iv44 = phi i64 [ 0, %entry ], [ %indvars.iv.next45, %for.end31.us ]
  br label %for.body3.us

for.end31.us:                                     ; preds = %for.cond9.for.end28_crit_edge.us.us
  %indvars.iv.next45 = add nuw nsw i64 %indvars.iv44, 1
  %exitcond47 = icmp eq i64 %indvars.iv.next45, 1000
  br i1 %exitcond47, label %for.end34, label %for.cond1.preheader.us
...
for.body3.us:                                     ; preds = %for.body3.us.1, %for.cond1.preheader.us
  ...
  %arrayidx5.us = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv44, i64 %indvars.iv
  ...
  %arrayidx5.us.2 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv44, i64 %indvars.iv.next.1
...
for.cond9.preheader.us.us.preheader:              ; preds = %for.body3.us
  %scevgep1 = getelementptr [1100 x double], [1100 x double]* %C, i64 %indvars.iv44, i64 0
  %scevgep4 = getelementptr [1100 x double], [1100 x double]* %C, i64 %indvars.iv44, i64 1100
...
for.cond9.preheader.us.us:                        ; preds = %for.cond9.preheader.us.us.preheader, %for.cond9.for.end28_crit_edge.us.us
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.cond9.for.end28_crit_edge.us.us ], [ 0, %for.cond9.preheader.us.us.preheader ]
  %arrayidx15.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %A, i64 %indvars.iv44, i64 %indvars.iv40
  %scevgep7 = getelementptr [1100 x double], [1100 x double]* %B, i64 %indvars.iv40, i64 0
  %scevgep10 = getelementptr [1100 x double], [1100 x double]* %B, i64 %indvars.iv40, i64 1100
...
for.body11.us.us.preheader:                       ; preds = %middle.block.for.body11.us.us.preheader_crit_edge, %for.cond9.preheader.us.us
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %8 = fmul <2 x double> %7, %broadcast.splatinsert16
  %9 = shufflevector <2 x double> %8, <2 x double> undef, <2 x i32> zeroinitializer
  %10 = getelementptr inbounds [1100 x double], [1100 x double]* %B, i64 %indvars.iv40, i64 %5
  %11 = bitcast double* %10 to <4 x double>*
  %wide.vec = load <4 x double>, <4 x double>* %11, align 8, !alias.scope !4
  %strided.vec = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %strided.vec18 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %12 = fmul <2 x double> %9, %strided.vec
  %13 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv44, i64 %5
  %14 = bitcast double* %13 to <4 x double>*
  %wide.vec19 = load <4 x double>, <4 x double>* %14, align 8, !alias.scope !6, !noalias !8
  ...
  %15 = fadd <2 x double> %strided.vec20, %12
  %16 = or i64 %5, 1
  %17 = fmul <2 x double> %9, %strided.vec18
  %18 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv44, i64 %16
  %19 = fadd <2 x double> %strided.vec21, %17
  %20 = getelementptr double, double* %18, i64 -1
  %21 = bitcast double* %20 to <4 x double>*
  %interleaved.vec = shufflevector <2 x double> %15, <2 x double> %19, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec, <4 x double>* %21, align 8, !alias.scope !6, !noalias !8
  %index.next = add nuw nsw i64 %index, 2
  %22 = icmp eq i64 %index.next, 550
  br i1 %22, label %middle.block, label %vector.body, !llvm.loop !9

middle.block:                                     ; preds = %vector.body
  br i1 true, label %for.cond9.for.end28_crit_edge.us.us, label %middle.block.for.body11.us.us.preheader_crit_edge

middle.block.for.body11.us.us.preheader_crit_edge: ; preds = %middle.block
  br label %for.body11.us.us.preheader

for.cond9.for.end28_crit_edge.us.us.loopexit:     ; preds = %for.body11.us.us
  br label %for.cond9.for.end28_crit_edge.us.us

for.cond9.for.end28_crit_edge.us.us:              ; preds = %for.cond9.for.end28_crit_edge.us.us.loopexit, %middle.block
  %indvars.iv.next41 = add nuw nsw i64 %indvars.iv40, 1
  %exitcond43 = icmp eq i64 %indvars.iv.next41, 1200
  br i1 %exitcond43, label %for.end31.us, label %for.cond9.preheader.us.us

for.body11.us.us:                                 ; preds = %for.body11.us.us.preheader, %for.body11.us.us
  %indvars.iv36 = phi i64 [ %indvars.iv.next37.1, %for.body11.us.us ], [ 0, %for.body11.us.us.preheader ]
  %23 = load double, double* %arrayidx15.us.us, align 8
  %mul16.us.us = fmul double %23, %alpha
  %arrayidx20.us.us = getelementptr inbounds [1100 x double], [1100 x double]* %B, i64 %indvars.iv40, i64 %indvars.iv36
  %24 = load double, double* %arrayidx20.us.us, align 8
  %mul21.us.us = fmul double %mul16.us.us, %24
  %arrayidx25.us.us = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv44, i64 %indvars.iv36
  %25 = load double, double* %arrayidx25.us.us, align 8
  %add.us.us = fadd double %25, %mul21.us.us
  ...
  %mul16.us.us.1 = fmul double %26, %alpha
  %arrayidx20.us.us.1 = getelementptr inbounds [1100 x double], [1100 x double]* %B, i64 %indvars.iv40, i64 %indvars.iv.next37
  %27 = load double, double* %arrayidx20.us.us.1, align 8
  %mul21.us.us.1 = fmul double %mul16.us.us.1, %27
  %arrayidx25.us.us.1 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv44, i64 %indvars.iv.next37
  %28 = load double, double* %arrayidx25.us.us.1, align 8
  %add.us.us.1 = fadd double %28, %mul21.us.us.1
  store double %add.us.us.1, double* %arrayidx25.us.us.1, align 8
  %indvars.iv.next37.1 = add nuw nsw i64 %indvars.iv36, 2
  %exitcond39.1 = icmp eq i64 %indvars.iv.next37.1, 1100
  br i1 %exitcond39.1, label %for.cond9.for.end28_crit_edge.us.us.loopexit, label %for.body11.us.us, !llvm.loop !12

for.end34:                                        ; preds = %for.end31.us
  ret void

for.body3.us.1:                                   ; preds = %for.body3.us
  %arrayidx5.us.1 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv44, i64 %indvars.iv.next.3
  %29 = bitcast double* %arrayidx5.us.1 to <2 x double>*
  %30 = load <2 x double>, <2 x double>* %29, align 8
  %mul.us.1 = fmul <2 x double> %30, %mul.us.v.i1.2
  store <2 x double> %mul.us.1, <2 x double>* %29, align 8
  %indvars.iv.next.1.1 = or i64 %indvars.iv, 6
  %arrayidx5.us.2.1 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv44, i64 %indvars.iv.next.1.1
  %31 = bitcast double* %arrayidx5.us.2.1 to <2 x double>*
  %32 = load <2 x double>, <2 x double>* %31, align 8
  %mul.us.2.1 = fmul <2 x double> %32, %mul.us.v.i1.2
  store <2 x double> %mul.us.2.1, <2 x double>* %31, align 8
...
for.cond2.preheader.us:                           ; preds = %for.cond2.for.end_crit_edge.us, %entry
  %indvars.iv8 = phi i64 [ 0, %entry ], [ %indvars.iv.next9, %for.cond2.for.end_crit_edge.us ]
