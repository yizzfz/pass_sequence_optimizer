...
@__llvm_prf_nm = private constant [136 x i8] c"\82\02\84\01x\DA]\8C[\0E\021\08E\D3%\B9\22\82\1D\EC\10[Zy\C4\EDkc'\19\E7\8Bs\CF\05\C2\B0P*\E4,>\07p\9Bb\C4A_\0F\DE!\F2\8E\9A\8C<\06\DC\95\CB\EEBfP\C3\D3C\89\AE\CE\C2P`(K\E6Q\E9\9A\C1\1A\D6\9A\1Am\8C\92H*j9\96\AC\F5\EE;KI\B4\15\82M\F1\BD\9Ai\17\CE\CA\CE\BC>\E6\AEBz>\FA\19\FBO\F0\0A\CE\CF\D4\90\E5\F6\01^\9Ac\A8", section "__llvm_prf_names"
@llvm.used = appending global [21 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_usage to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_getint to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_get_image to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_put_image to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_int_to_uchar to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_setup_brightness_lut to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_free_brightness_lut to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_susan_principle to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_susan_principle_small to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_median to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_enlarge to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_susan_smoothing to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_edge_draw to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_susan_thin to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_susan_edges to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_susan_edges_small to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_corner_draw to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_susan_corners to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_susan_corners_quick to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_main1 to i8*), i8* getelementptr inbounds ([136 x i8], [136 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
...
; <label>:929:                                    ; preds = %._crit_edge, %907, %872, %856, %853
...
; <label>:1575:                                   ; preds = %._crit_edge19, %1539
  br label %1576

; <label>:1576:                                   ; preds = %._crit_edge18, %1575
  br label %1577

; <label>:1577:                                   ; preds = %._crit_edge17, %1576
  br label %1578

; <label>:1578:                                   ; preds = %._crit_edge16, %1577
  br label %1579

; <label>:1579:                                   ; preds = %._crit_edge15, %1578
  br label %1580

; <label>:1580:                                   ; preds = %._crit_edge14, %1579
  br label %1581

; <label>:1581:                                   ; preds = %._crit_edge13, %1580
  br label %1582

; <label>:1582:                                   ; preds = %._crit_edge12, %1581
  br label %1583

; <label>:1583:                                   ; preds = %._crit_edge11, %1582
  br label %1584

; <label>:1584:                                   ; preds = %._crit_edge10, %1583
  br label %1585

; <label>:1585:                                   ; preds = %._crit_edge9, %1584
  br label %1586

; <label>:1586:                                   ; preds = %._crit_edge8, %1585
  br label %1587

; <label>:1587:                                   ; preds = %._crit_edge6, %1586
  br label %1588

; <label>:1588:                                   ; preds = %._crit_edge4, %1587
  br label %1589

; <label>:1589:                                   ; preds = %._crit_edge2, %1588
  br label %1590

; <label>:1590:                                   ; preds = %._crit_edge1, %1589
  br label %1591

; <label>:1591:                                   ; preds = %1590, %369
  br label %1592

; <label>:1592:                                   ; preds = %._crit_edge, %1591
  br label %1593

; <label>:1593:                                   ; preds = %._crit_edge7, %1592
...
; <label>:1595:                                   ; preds = %._crit_edge5, %1593
  br label %1596

; <label>:1596:                                   ; preds = %._crit_edge3, %1595
  br label %1597
...
; <label>:2407:                                   ; preds = %._crit_edge40, %._crit_edge39, %._crit_edge38, %._crit_edge37, %._crit_edge36, %._crit_edge35, %._crit_edge34, %._crit_edge33, %._crit_edge32, %._crit_edge31, %._crit_edge30, %._crit_edge29, %._crit_edge28, %._crit_edge27, %._crit_edge26, %._crit_edge25, %._crit_edge24, %._crit_edge23, %._crit_edge22, %._crit_edge21, %._crit_edge20, %2405, %2321, %2306, %2291, %2277, %2262, %2247, %2232, %2217, %2202, %2187, %2173, %2158, %2143, %2128, %2113, %2098, %2083, %2069, %2054, %2039, %2024, %2010, %1996, %1982, %1968, %1955, %1629
...
; <label>:626:                                    ; preds = %._crit_edge17, %614
...
; <label>:628:                                    ; preds = %._crit_edge16, %626
  br label %629

; <label>:629:                                    ; preds = %._crit_edge15, %628
  br label %630

; <label>:630:                                    ; preds = %._crit_edge14, %629
  br label %631

; <label>:631:                                    ; preds = %._crit_edge13, %630
  br label %632

; <label>:632:                                    ; preds = %._crit_edge12, %631
  br label %633

; <label>:633:                                    ; preds = %._crit_edge11, %632
  br label %634

; <label>:634:                                    ; preds = %._crit_edge10, %633
  br label %635

; <label>:635:                                    ; preds = %._crit_edge9, %634
  br label %636

; <label>:636:                                    ; preds = %._crit_edge8, %635
  br label %637

; <label>:637:                                    ; preds = %._crit_edge6, %636
  br label %638

; <label>:638:                                    ; preds = %._crit_edge4, %637
  br label %639

; <label>:639:                                    ; preds = %._crit_edge2, %638
  br label %640

; <label>:640:                                    ; preds = %._crit_edge1, %639
  br label %641

; <label>:641:                                    ; preds = %640, %348
  br label %642

; <label>:642:                                    ; preds = %._crit_edge, %641
  br label %643

; <label>:643:                                    ; preds = %._crit_edge7, %642
...
; <label>:645:                                    ; preds = %._crit_edge5, %643
  br label %646

; <label>:646:                                    ; preds = %._crit_edge3, %645
  br label %647
