...
._crit_edge1:                                     ; preds = %._crit_edge1, %.lr.ph40
  ...
  %6 = load double, double* %sunkaddr56, align 8
...
.lr.ph38.preheader:                               ; preds = %._crit_edge1
  %sunkaddr58 = shl i64 %indvars.iv48, 3
...
.lr.ph38:                                         ; preds = %.lr.ph38, %.lr.ph38.preheader
  ...
  %36 = load double, double* %sunkaddr60, align 8
  ...
  %43 = load double, double* %sunkaddr60, align 8
