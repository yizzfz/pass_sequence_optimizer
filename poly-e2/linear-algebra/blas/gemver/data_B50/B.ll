...
if.then:                                          ; preds = %land.lhs.true
  ...
  call fastcc void @print_array(i32 2000, double* %12)
  br label %if.end
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc void @kernel_gemver(i32 %n, double %alpha, double %beta, [2000 x double]* %A, double* readonly %u1, double* readonly %v1, double* readonly %u2, double* readonly %v2, double* %w, double* %x, double* nocapture readonly %y, double* readonly %z) unnamed_addr #2 {
for.cond1.preheader.us.preheader:
  %scevgep71 = getelementptr double, double* %v1, i64 2000
  %scevgep74 = getelementptr double, double* %v2, i64 2000
  br label %vector.memcheck

vector.memcheck:                                  ; preds = %for.cond1.for.inc20_crit_edge.us, %for.cond1.preheader.us.preheader
  %indvars.iv51 = phi i64 [ 0, %for.cond1.preheader.us.preheader ], [ %indvars.iv.next52, %for.cond1.for.inc20_crit_edge.us ]
...
for.inc.us.preheader:                             ; preds = %vector.memcheck
  br label %for.inc.us
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  br i1 %33, label %for.cond1.for.inc20_crit_edge.us.loopexit149, label %vector.body, !llvm.loop !13
...
for.cond1.for.inc20_crit_edge.us.loopexit149:     ; preds = %vector.body
  br label %for.cond1.for.inc20_crit_edge.us

for.cond1.for.inc20_crit_edge.us:                 ; preds = %for.cond1.for.inc20_crit_edge.us.loopexit149, %for.cond1.for.inc20_crit_edge.us.loopexit
  %indvars.iv.next52 = add nuw nsw i64 %indvars.iv51, 1
  %exitcond66 = icmp eq i64 %indvars.iv.next52, 2000
  br i1 %exitcond66, label %for.inc42.us.prol.loopexit.for.inc42.us_crit_edge.preheader, label %vector.memcheck

for.inc42.us.prol.loopexit.for.inc42.us_crit_edge.preheader: ; preds = %for.cond1.for.inc20_crit_edge.us
  %sunkaddr128 = ptrtoint double* %x to i64
  %sunkaddr132 = ptrtoint double* %x to i64
  br label %for.inc42.us.prol.loopexit.for.inc42.us_crit_edge

for.inc42.us.prol.loopexit.for.inc42.us_crit_edge: ; preds = %for.inc42.us.prol.loopexit.for.inc42.us_crit_edge.preheader, %for.cond26.for.inc45_crit_edge.us
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.cond26.for.inc45_crit_edge.us ], [ 0, %for.inc42.us.prol.loopexit.for.inc42.us_crit_edge.preheader ]
  %sunkaddr129 = shl i64 %indvars.iv45, 3
  %sunkaddr130 = add i64 %sunkaddr128, %sunkaddr129
  %sunkaddr131 = inttoptr i64 %sunkaddr130 to double*
  %.pre = load double, double* %sunkaddr131, align 8
  %sunkaddr133 = shl i64 %indvars.iv45, 3
  %sunkaddr134 = add i64 %sunkaddr132, %sunkaddr133
  %sunkaddr135 = inttoptr i64 %sunkaddr134 to double*
  br label %for.inc42.us

for.inc42.us:                                     ; preds = %for.inc42.us.prol.loopexit.for.inc42.us_crit_edge, %for.inc42.us
  %44 = phi double [ %add39.us.1, %for.inc42.us ], [ %.pre, %for.inc42.us.prol.loopexit.for.inc42.us_crit_edge ]
  %indvars.iv41 = phi i64 [ %indvars.iv.next42.1, %for.inc42.us ], [ 0, %for.inc42.us.prol.loopexit.for.inc42.us_crit_edge ]
  ...
  store double %add39.us, double* %sunkaddr135, align 8
  ...
  store double %add39.us.1, double* %sunkaddr135, align 8
...
for.cond26.for.inc45_crit_edge.us:                ; preds = %for.inc42.us
  ...
  br i1 %exitcond64, label %vector.memcheck111, label %for.inc42.us.prol.loopexit.for.inc42.us_crit_edge
...
vector.body96:                                    ; preds = %vector.body96, %vector.body96.preheader
  ...
  br i1 %73, label %for.inc80.us.prol.loopexit.for.inc80.us_crit_edge.preheader.loopexit148, label %vector.body96, !llvm.loop !22

for.inc80.us.prol.loopexit.for.inc80.us_crit_edge.preheader.loopexit: ; preds = %for.inc58
  br label %for.inc80.us.prol.loopexit.for.inc80.us_crit_edge.preheader

for.inc80.us.prol.loopexit.for.inc80.us_crit_edge.preheader.loopexit148: ; preds = %vector.body96
  br label %for.inc80.us.prol.loopexit.for.inc80.us_crit_edge.preheader

for.inc80.us.prol.loopexit.for.inc80.us_crit_edge.preheader: ; preds = %for.inc80.us.prol.loopexit.for.inc80.us_crit_edge.preheader.loopexit148, %for.inc80.us.prol.loopexit.for.inc80.us_crit_edge.preheader.loopexit
  %sunkaddr140 = ptrtoint double* %w to i64
  %sunkaddr144 = ptrtoint double* %w to i64
  br label %for.inc80.us.prol.loopexit.for.inc80.us_crit_edge

for.inc80.us.prol.loopexit.for.inc80.us_crit_edge: ; preds = %for.inc80.us.prol.loopexit.for.inc80.us_crit_edge.preheader, %for.cond64.for.inc83_crit_edge.us
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.cond64.for.inc83_crit_edge.us ], [ 0, %for.inc80.us.prol.loopexit.for.inc80.us_crit_edge.preheader ]
  %sunkaddr141 = shl i64 %indvars.iv36, 3
  %sunkaddr142 = add i64 %sunkaddr140, %sunkaddr141
  %sunkaddr143 = inttoptr i64 %sunkaddr142 to double*
  %.pre62 = load double, double* %sunkaddr143, align 8
  %sunkaddr145 = shl i64 %indvars.iv36, 3
  %sunkaddr146 = add i64 %sunkaddr144, %sunkaddr145
  %sunkaddr147 = inttoptr i64 %sunkaddr146 to double*
  br label %for.inc80.us

for.inc80.us:                                     ; preds = %for.inc80.us.prol.loopexit.for.inc80.us_crit_edge, %for.inc80.us
  %74 = phi double [ %add77.us.1, %for.inc80.us ], [ %.pre62, %for.inc80.us.prol.loopexit.for.inc80.us_crit_edge ]
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %for.inc80.us ], [ 0, %for.inc80.us.prol.loopexit.for.inc80.us_crit_edge ]
  ...
  store double %add77.us, double* %sunkaddr147, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %add77.us.1, double* %sunkaddr147, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
...
for.cond64.for.inc83_crit_edge.us:                ; preds = %for.inc80.us
  ...
  br i1 %exitcond, label %for.end85, label %for.inc80.us.prol.loopexit.for.inc80.us_crit_edge
...
for.inc58:                                        ; preds = %for.inc58, %for.inc58.preheader
  ...
  br i1 %exitcond63.4, label %for.inc80.us.prol.loopexit.for.inc80.us_crit_edge.preheader.loopexit, label %for.inc58, !llvm.loop !23
