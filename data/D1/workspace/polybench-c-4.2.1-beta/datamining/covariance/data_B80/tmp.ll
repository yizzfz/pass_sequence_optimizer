...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph24.split.us
  %6 = phi double [ 0.000000e+00, %.lr.ph24.split.us ], [ %18, %._crit_edge ]
  %indvars.iv63 = phi i64 [ 0, %.lr.ph24.split.us ], [ %indvars.iv.next64.1.1, %._crit_edge ]
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv63, i64 %indvars.iv67
  %8 = load double, double* %7, align 8
  %9 = fadd double %8, %6
  %sunkaddr = ptrtoint double* %3 to i64
  %sunkaddr50 = mul nuw nsw i64 %indvars.iv67, 8
  %sunkaddr51 = add i64 %sunkaddr, %sunkaddr50
  %sunkaddr52 = inttoptr i64 %sunkaddr51 to double*
  store double %9, double* %sunkaddr52, align 8
  ...
  %sunkaddr53 = ptrtoint double* %3 to i64
  %sunkaddr54 = mul nuw nsw i64 %indvars.iv67, 8
  %sunkaddr55 = add i64 %sunkaddr53, %sunkaddr54
  %sunkaddr56 = inttoptr i64 %sunkaddr55 to double*
  store double %15, double* %sunkaddr56, align 8
  %indvars.iv.next64.148 = or i64 %indvars.iv63, 3
  %16 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next64.148, i64 %indvars.iv67
  %17 = load double, double* %16, align 8
  %18 = fadd double %17, %15
  store double %18, double* %sunkaddr56, align 8
  %indvars.iv.next64.1.1 = add nuw nsw i64 %indvars.iv63, 4
  %exitcond81.1.1 = icmp eq i64 %indvars.iv.next64.1.1, 1400
  br i1 %exitcond81.1.1, label %._crit_edge21.us, label %._crit_edge

._crit_edge21.us:                                 ; preds = %._crit_edge
  %19 = fdiv double %18, %0
  %sunkaddr43 = shl i64 %indvars.iv67, 3
  %sunkaddr44 = add i64 %4, %sunkaddr43
  %sunkaddr45 = inttoptr i64 %sunkaddr44 to double*
  store double %19, double* %sunkaddr45, align 8
...
._crit_edge21.us..preheader6.us_crit_edge:        ; preds = %._crit_edge21.us
  %scevgep29 = getelementptr double, double* %3, i64 1200
  br label %vector.memcheck

vector.memcheck:                                  ; preds = %._crit_edge16.us, %._crit_edge21.us..preheader6.us_crit_edge
  %indvars.iv58 = phi i64 [ 0, %._crit_edge21.us..preheader6.us_crit_edge ], [ %20, %._crit_edge16.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv58, i64 0
  %20 = add nuw nsw i64 %indvars.iv58, 1
  %scevgep27 = getelementptr [1200 x double], [1200 x double]* %1, i64 %20, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %23 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv58, i64 %offset.idx
  %24 = bitcast double* %23 to <8 x double>*
  %wide.vec34 = load <8 x double>, <8 x double>* %24, align 8, !alias.scope !4, !noalias !1
  %25 = fsub <8 x double> %wide.vec34, %wide.vec
  ...
  %30 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv58, i64 %29
  ...
  br i1 %36, label %._crit_edge16.us.loopexit57, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader
  %indvars.iv54 = phi i64 [ 0, %scalar.ph.preheader ], [ %indvars.iv.next55.3, %scalar.ph ]
  %37 = getelementptr inbounds double, double* %3, i64 %indvars.iv54
  %38 = load double, double* %37, align 8
  %39 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv58, i64 %indvars.iv54
  %40 = load double, double* %39, align 8
  %41 = fsub double %40, %38
  store double %41, double* %39, align 8
  %indvars.iv.next55 = or i64 %indvars.iv54, 1
  %42 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next55
  %43 = load double, double* %42, align 8
  %44 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv58, i64 %indvars.iv.next55
  %45 = load double, double* %44, align 8
  %46 = fsub double %45, %43
  store double %46, double* %44, align 8
  %indvars.iv.next55.1 = or i64 %indvars.iv54, 2
  %47 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next55.1
  %48 = load double, double* %47, align 8
  %49 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv58, i64 %indvars.iv.next55.1
  %50 = load double, double* %49, align 8
  %51 = fsub double %50, %48
  store double %51, double* %49, align 8
  %indvars.iv.next55.2 = or i64 %indvars.iv54, 3
  %52 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next55.2
  %53 = load double, double* %52, align 8
  %54 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv58, i64 %indvars.iv.next55.2
...
._crit_edge16.us.loopexit57:                      ; preds = %vector.body
  br label %._crit_edge16.us

._crit_edge16.us:                                 ; preds = %._crit_edge16.us.loopexit57, %._crit_edge16.us.loopexit
  %exitcond80 = icmp eq i64 %20, 1400
...
.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph10.us
  ...
  %58 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv40, i64 %indvars.iv36
...
._crit_edge.us.us:                                ; preds = %._crit_edge40
  ...
  %60 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv36, i64 %indvars.iv40
...
._crit_edge40:                                    ; preds = %._crit_edge40, %.lr.ph.us.us
  %61 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %73, %._crit_edge40 ]
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %._crit_edge40 ]
  %62 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv40
  ...
  %68 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv40
  ...
  br i1 %exitcond77.1, label %._crit_edge.us.us, label %._crit_edge40
