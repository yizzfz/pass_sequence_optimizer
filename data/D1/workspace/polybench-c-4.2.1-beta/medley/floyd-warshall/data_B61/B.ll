...
.preheader:                                       ; preds = %19, %2
  %indvars.iv25 = phi i64 [ 0, %2 ], [ %indvars.iv.next26, %19 ]
  br label %3

; <label>:3:                                      ; preds = %3, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %3 ]
  %4 = mul nuw nsw i64 %indvars.iv, %indvars.iv25
  %5 = trunc i64 %4 to i32
  %6 = srem i32 %5, 7
  %7 = add nsw i32 %6, 1
  %8 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv25, i64 %indvars.iv
  %9 = add nuw nsw i64 %indvars.iv, %indvars.iv25
  ...
  %17 = srem i32 %16, 11
  %18 = icmp eq i32 %17, 0
  %or.cond22 = or i1 %18, %or.cond
  %. = select i1 %or.cond22, i32 999, i32 %7
...
; <label>:19:                                     ; preds = %3
  ...
  br i1 %exitcond27, label %20, label %.preheader
...
.preheader31:                                     ; preds = %20, %2
  %indvars.iv37 = phi i64 [ 0, %2 ], [ %indvars.iv.next38, %20 ]
  br label %.preheader

.preheader:                                       ; preds = %19, %.preheader31
  %indvars.iv35 = phi i64 [ 0, %.preheader31 ], [ %indvars.iv.next36, %19 ]
  %3 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv35, i64 %indvars.iv37
  br label %4

; <label>:4:                                      ; preds = %4, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %4 ]
  %5 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv35, i64 %indvars.iv
  %6 = load i32, i32* %5, align 4
  %7 = load i32, i32* %3, align 4
  %8 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv37, i64 %indvars.iv
  ...
  %12 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv35, i64 %indvars.iv.next
  %13 = load i32, i32* %12, align 4
  %14 = load i32, i32* %3, align 4
  %15 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv37, i64 %indvars.iv.next
...
; <label>:20:                                     ; preds = %19
  ...
  br i1 %exitcond39, label %21, label %.preheader31
...
.preheader:                                       ; preds = %20, %2
  %indvars.iv14 = phi i64 [ 0, %2 ], [ %indvars.iv.next15, %20 ]
  %7 = mul nuw nsw i64 %indvars.iv14, 2800
  br label %8
...
; <label>:15:                                     ; preds = %8, %13
  ...
  %17 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv14, i64 %indvars.iv
...
; <label>:20:                                     ; preds = %15
  ...
  br i1 %exitcond16, label %21, label %.preheader
