...
entry:
  ...
  tail call void @init_array([1200 x double]* %arraydecay1, [1200 x double]* %arraydecay42, [1200 x double]* %arraydecay53, double* %arraydecay6)
  tail call void (...) @polybench_timer_start() #4
  tail call void @kernel_fdtd_2d([1200 x double]* %arraydecay1, [1200 x double]* %arraydecay42, [1200 x double]* %arraydecay53, double* %arraydecay6)
...
for.cond5.preheader.us:                           ; preds = %for.cond5.preheader.us.preheader, %for.cond5.for.inc39_crit_edge.us
  ...
  %mul.v.i1.1.us = insertelement <2 x double> undef, double %conv16.us, i32 0
...
for.body8.us:                                     ; preds = %for.body8.us, %for.cond5.preheader.us
  ...
  %mul.v.i0.1.us = insertelement <2 x double> undef, double %conv10.us, i32 0
  %mul.v.i0.2.us = insertelement <2 x double> %mul.v.i0.1.us, double %conv16.us, i32 1
...
for.cond5.for.inc39_crit_edge.us:                 ; preds = %for.body8.us
  ...
  br i1 %exitcond20, label %for.end41, label %for.cond5.preheader.us

for.body:                                         ; preds = %for.body, %for.body.preheader
  %indvars.iv22 = phi i64 [ 0, %for.body.preheader ], [ %indvars.iv.next23.4, %for.body ]
  ...
  %7 = trunc i64 %indvars.iv.next23 to i32
  %conv.1 = sitofp i32 %7 to double
  %arrayidx.1 = getelementptr inbounds double, double* %_fict_, i64 %indvars.iv.next23
  store double %conv.1, double* %arrayidx.1, align 8
  %indvars.iv.next23.1 = add nsw i64 %indvars.iv22, 2
  %8 = trunc i64 %indvars.iv.next23.1 to i32
  ...
  %9 = trunc i64 %indvars.iv.next23.2 to i32
  %conv.3 = sitofp i32 %9 to double
  %arrayidx.3 = getelementptr inbounds double, double* %_fict_, i64 %indvars.iv.next23.2
  store double %conv.3, double* %arrayidx.3, align 8
  %indvars.iv.next23.3 = add nsw i64 %indvars.iv22, 4
  %10 = trunc i64 %indvars.iv.next23.3 to i32
  ...
  %exitcond25.4 = icmp eq i64 %indvars.iv.next23.4, 500
  br i1 %exitcond25.4, label %for.cond5.preheader.us.preheader, label %for.body
...
for.body3.preheader:                              ; preds = %for.inc113, %for.cond1.preheader.lr.ph
  %indvars.iv80 = phi i64 [ 0, %for.cond1.preheader.lr.ph ], [ %indvars.iv.next81, %for.inc113 ]
  br label %for.body3
...
vector.body58:                                    ; preds = %vector.body58.preheader, %vector.body58
  ...
  %3 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv56, i64 %index78
  ...
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv56, i64 %index78
...
for.body12.us:                                    ; preds = %for.body12.us, %for.body12.us.preheader
  %indvars.iv52 = phi i64 [ 0, %for.body12.us.preheader ], [ %indvars.iv.next53.1, %for.body12.us ]
  ...
  br i1 %exitcond55.1, label %for.cond10.for.inc34_crit_edge.us.loopexit, label %for.body12.us, !llvm.loop !9
...
for.cond10.for.inc34_crit_edge.us:                ; preds = %for.cond10.for.inc34_crit_edge.us.loopexit112, %for.cond10.for.inc34_crit_edge.us.loopexit
  ...
  %exitcond60 = icmp eq i64 %indvars.iv.next57, 1000
  br i1 %exitcond60, label %for.cond40.preheader.us.preheader, label %for.cond10.preheader.us
...
for.body3:                                        ; preds = %for.body3, %for.body3.preheader
  %indvars.iv = phi i64 [ 0, %for.body3.preheader ], [ %indvars.iv.next.4, %for.body3 ]
  %sunkaddr = ptrtoint double* %_fict_ to i64
  %sunkaddr93 = mul i64 %indvars.iv80, 8
  ...
  %sunkaddr97 = mul i64 %indvars.iv80, 8
  ...
  %sunkaddr101 = mul i64 %indvars.iv80, 8
  ...
  %sunkaddr105 = mul i64 %indvars.iv80, 8
  ...
  %sunkaddr109 = mul i64 %indvars.iv80, 8
...
for.cond40.preheader.us:                          ; preds = %for.cond40.preheader.us.preheader, %for.cond40.for.inc66_crit_edge.us
  %indvars.iv67 = phi i64 [ %38, %for.cond40.for.inc66_crit_edge.us ], [ 0, %for.cond40.preheader.us.preheader ]
  %scevgep30 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv67, i64 1
  %38 = add i64 %indvars.iv67, 1
...
vector.body25:                                    ; preds = %vector.body25.preheader, %vector.body25
  ...
  %39 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv67, i64 %offset.idx
  ...
  %43 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv67, i64 %offset.idx
  ...
  %48 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv67, i64 %47
...
for.body42.us.preheader.new:                      ; preds = %for.body42.us.preheader.new.loopexit, %for.cond40.preheader.us
  %indvars.iv62.ph = phi i64 [ 1, %for.cond40.preheader.us ], [ 1197, %for.body42.us.preheader.new.loopexit ]
  %arrayidx46.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv67, i64 %indvars.iv62.ph
  %59 = load double, double* %arrayidx46.us.prol, align 8
  %arrayidx50.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv67, i64 %indvars.iv62.ph
  %60 = load double, double* %arrayidx50.us.prol, align 8
  %61 = add nsw i64 %indvars.iv62.ph, -1
  %arrayidx55.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv67, i64 %61
...
for.body42.us:                                    ; preds = %for.body42.us, %for.body42.us.preheader.new
  %indvars.iv62 = phi i64 [ %indvars.iv.next63.prol, %for.body42.us.preheader.new ], [ %indvars.iv.next63.1, %for.body42.us ]
  ...
  %65 = add nsw i64 %indvars.iv62, -1
  %arrayidx55.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv67, i64 %65
  ...
  %arrayidx55.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv67, i64 %indvars.iv62
  ...
  br i1 %exitcond66.1, label %for.cond40.for.inc66_crit_edge.us, label %for.body42.us, !llvm.loop !16

for.cond40.for.inc66_crit_edge.us:                ; preds = %for.body42.us
  %exitcond70 = icmp eq i64 %38, 1000
...
for.cond73.preheader.us:                          ; preds = %for.cond73.preheader.us.preheader, %for.cond73.for.inc110_crit_edge.us
  %indvars.iv76 = phi i64 [ %70, %for.cond73.for.inc110_crit_edge.us ], [ 0, %for.cond73.preheader.us.preheader ]
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv76, i64 %index
  ...
  %75 = or i64 %index, 1
  %76 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv76, i64 %75
  ...
  %80 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv76, i64 %index
  ...
  %92 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv76, i64 %index
...
for.body76.us.preheader:                          ; preds = %for.body76.us.preheader.loopexit, %for.cond73.preheader.us
  %indvars.iv72.ph = phi i64 [ 0, %for.cond73.preheader.us ], [ 1196, %for.body76.us.preheader.loopexit ]
  br label %for.body76.us

for.body76.us:                                    ; preds = %for.body76.us.preheader, %for.body76.us
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.body76.us ], [ %indvars.iv72.ph, %for.body76.us.preheader ]
  ...
  %arrayidx94.us = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %70, i64 %indvars.iv72
  ...
  %exitcond75 = icmp eq i64 %indvars.iv.next73, 1199
  br i1 %exitcond75, label %for.cond73.for.inc110_crit_edge.us, label %for.body76.us, !llvm.loop !26

for.cond73.for.inc110_crit_edge.us:               ; preds = %for.body76.us
  %exitcond79 = icmp eq i64 %70, 999
...
for.inc113:                                       ; preds = %for.cond73.for.inc110_crit_edge.us
  ...
  br i1 %exitcond83, label %for.end115, label %for.body3.preheader
...
for.cond2.preheader.us:                           ; preds = %for.cond2.for.inc10_crit_edge.us, %for.cond2.preheader.us.preheader
  %indvars.iv65 = phi i64 [ 0, %for.cond2.preheader.us.preheader ], [ %indvars.iv.next66, %for.cond2.for.inc10_crit_edge.us ]
  %3 = mul nsw i64 %indvars.iv65, 1000
  br label %for.body4.us

for.body4.us:                                     ; preds = %if.end.us, %for.cond2.preheader.us
  %indvars.iv60 = phi i64 [ 0, %for.cond2.preheader.us ], [ %indvars.iv.next61, %if.end.us ]
  %4 = add nsw i64 %3, %indvars.iv60
  %5 = trunc i64 %4 to i32
...
if.end.us:                                        ; preds = %for.body4.us, %if.then.us
  ...
  %arrayidx8.us = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv65, i64 %indvars.iv60
...
for.cond2.for.inc10_crit_edge.us:                 ; preds = %if.end.us
  ...
  br i1 %exitcond69, label %for.cond19.preheader.us.preheader, label %for.cond2.preheader.us
...
for.cond19.preheader.us:                          ; preds = %for.cond19.for.inc37_crit_edge.us, %for.cond19.preheader.us.preheader
  %indvars.iv54 = phi i64 [ 0, %for.cond19.preheader.us.preheader ], [ %indvars.iv.next55, %for.cond19.for.inc37_crit_edge.us ]
  %13 = mul nsw i64 %indvars.iv54, 1000
  br label %for.body21.us

for.body21.us:                                    ; preds = %if.end28.us, %for.cond19.preheader.us
  %indvars.iv49 = phi i64 [ 0, %for.cond19.preheader.us ], [ %indvars.iv.next50, %if.end28.us ]
  %14 = add nsw i64 %13, %indvars.iv49
...
if.end28.us:                                      ; preds = %for.body21.us, %if.then26.us
  ...
  %arrayidx32.us = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv54, i64 %indvars.iv49
  ...
  %exitcond53 = icmp eq i64 %indvars.iv.next50, 1200
  br i1 %exitcond53, label %for.cond19.for.inc37_crit_edge.us, label %for.body21.us

for.cond19.for.inc37_crit_edge.us:                ; preds = %if.end28.us
  %indvars.iv.next55 = add nuw nsw i64 %indvars.iv54, 1
  %exitcond58 = icmp eq i64 %indvars.iv.next55, 1000
  br i1 %exitcond58, label %for.cond45.preheader.us.preheader, label %for.cond19.preheader.us
...
for.cond45.preheader.us:                          ; preds = %for.cond45.for.inc63_crit_edge.us, %for.cond45.preheader.us.preheader
  %indvars.iv43 = phi i64 [ 0, %for.cond45.preheader.us.preheader ], [ %indvars.iv.next44, %for.cond45.for.inc63_crit_edge.us ]
...
for.cond45.for.inc63_crit_edge.us:                ; preds = %if.end54.us
  ...
  %exitcond47 = icmp eq i64 %indvars.iv.next44, 1000
  br i1 %exitcond47, label %for.end65, label %for.cond45.preheader.us
