...
entry:
  ...
  br i1 %cmp4, label %for.body.us.preheader, label %for.end41

for.body.us.preheader:                            ; preds = %entry
  %sunkaddr18 = ptrtoint double* %tmp to i64
...
for.body7.us:                                     ; preds = %for.body7.us, %for.body.us
  ...
  %2 = load double, double* %sunkaddr13, align 8
  %add.us = fadd double %mul.us, %2
  store double %add.us, double* %sunkaddr13, align 8
