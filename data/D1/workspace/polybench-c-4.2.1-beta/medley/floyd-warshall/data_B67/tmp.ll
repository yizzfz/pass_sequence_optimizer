...
._crit_edge14:                                    ; preds = %._crit_edge14, %.preheader.us
  ...
  %6 = add nuw nsw i64 %indvars.iv, %indvars.iv15
...
.loopexit.us:                                     ; preds = %._crit_edge14
  ...
  br i1 %exitcond17, label %.loopexit7, label %.preheader.us
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  br i1 %26, label %.loopexit.us.us.loopexit54, label %vector.body, !llvm.loop !9

.loopexit.us.us.loopexit:                         ; preds = %scalar.ph
  br label %.loopexit.us.us

.loopexit.us.us.loopexit54:                       ; preds = %vector.body
  br label %.loopexit.us.us

.loopexit.us.us:                                  ; preds = %.loopexit.us.us.loopexit54, %.loopexit.us.us.loopexit
  %indvars.iv.next34 = add nuw nsw i64 %indvars.iv33, 1
  %exitcond = icmp eq i64 %indvars.iv.next34, 2800
  br i1 %exitcond, label %.loopexit7.us, label %.preheader.us.us

scalar.ph:                                        ; preds = %scalar.ph.preheader, %._crit_edge53
  %indvars.iv = phi i64 [ %indvars.iv.next, %._crit_edge53 ], [ 0, %scalar.ph.preheader ]
  ...
  %exitcond32 = icmp eq i64 %indvars.iv, 2799
  br i1 %exitcond32, label %.loopexit.us.us.loopexit, label %._crit_edge53, !llvm.loop !12

._crit_edge53:                                    ; preds = %scalar.ph
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %scalar.ph
