...
for.inc.lr.ph:                                    ; preds = %entry, %for.end44
...
for.inc.prol.loopexit:                            ; preds = %for.inc.prol.loopexit.loopexit, %for.inc.lr.ph
  ...
  br i1 %14, label %for.body21.lr.ph, label %for.inc.preheader
...
for.inc:                                          ; preds = %for.inc.preheader, %for.inc
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %18 = sub nsw i64 %10, %indvars.iv.next
  ...
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %21 = sub nsw i64 %10, %indvars.iv.next.1
  ...
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %24 = sub nsw i64 %10, %indvars.iv.next.2
...
for.body21.lr.ph:                                 ; preds = %for.body21.lr.ph.loopexit, %for.inc.prol.loopexit
  ...
  %29 = and i64 %indvar, 1
  %lcmp.mod35 = icmp eq i64 %29, 0
  br i1 %lcmp.mod35, label %for.body21.prol, label %for.body21.prol.loopexit
...
for.body21.prol:                                  ; preds = %for.body21.lr.ph
  ...
  %31 = load double, double* %sunkaddr39, align 8
...
for.body21.prol.loopexit:                         ; preds = %for.body21.prol, %for.body21.lr.ph
  %indvars.iv14.unr.ph = phi i64 [ 1, %for.body21.prol ], [ 0, %for.body21.lr.ph ]
...
for.body21.preheader:                             ; preds = %for.body21.prol.loopexit
  ...
  br i1 %min.iters.check, label %for.body21.preheader49, label %min.iters.checked

min.iters.checked:                                ; preds = %for.body21.preheader
  %n.mod.vf = and i64 %35, 1
  %n.vec = sub i64 %35, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  %36 = or i64 %indvars.iv14.unr.ph, 2
  %37 = shl nuw i64 %34, 1
  %38 = add i64 %36, %37
  %39 = shl nuw nsw i64 %n.mod.vf, 1
  %ind.end = sub i64 %38, %39
  br i1 %cmp.zero, label %for.body21.preheader49, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %40 = shl i64 %index, 1
  %offset.idx = or i64 %indvars.iv14.unr.ph, %40
  %41 = getelementptr inbounds double, double* %y, i64 %offset.idx
  %42 = bitcast double* %41 to <4 x double>*
  %wide.vec = load <4 x double>, <4 x double>* %42, align 8
  %strided.vec = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %strided.vec41 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %43 = sub nsw i64 %28, %offset.idx
  %44 = getelementptr inbounds double, double* %y, i64 %43
  %45 = getelementptr double, double* %44, i64 -3
  %46 = bitcast double* %45 to <4 x double>*
  %wide.vec42 = load <4 x double>, <4 x double>* %46, align 8
  ...
  %47 = fmul <2 x double> %broadcast.splat47, %reverse45
  %48 = fadd <2 x double> %strided.vec, %47
  %49 = add nuw nsw i64 %offset.idx, 1
  %50 = fmul <2 x double> %broadcast.splat47, %reverse
  %51 = fadd <2 x double> %strided.vec41, %50
  %52 = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %49
  %53 = getelementptr double, double* %52, i64 -1
  %54 = bitcast double* %53 to <4 x double>*
  %interleaved.vec = shufflevector <2 x double> %48, <2 x double> %51, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec, <4 x double>* %54, align 8
  %index.next = add i64 %index, 2
  %55 = icmp eq i64 %index.next, %n.vec
  br i1 %55, label %middle.block, label %vector.body, !llvm.loop !3

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.mod.vf, 0
  br i1 %cmp.n, label %for.end44, label %for.body21.preheader49

for.body21.preheader49:                           ; preds = %middle.block, %min.iters.checked, %for.body21.preheader
...
for.body21:                                       ; preds = %for.body21.preheader49, %for.body21
  %indvars.iv14 = phi i64 [ %indvars.iv.next15.1, %for.body21 ], [ %indvars.iv14.ph, %for.body21.preheader49 ]
  %arrayidx23 = getelementptr inbounds double, double* %y, i64 %indvars.iv14
  %56 = load double, double* %arrayidx23, align 8
  %57 = sub nsw i64 %28, %indvars.iv14
  %arrayidx27 = getelementptr inbounds double, double* %y, i64 %57
  %58 = load double, double* %arrayidx27, align 8
  %mul28 = fmul double %div, %58
  %add29 = fadd double %56, %mul28
  ...
  %arrayidx23.1 = getelementptr inbounds double, double* %y, i64 %indvars.iv.next15
  %59 = load double, double* %arrayidx23.1, align 8
  %60 = sub nsw i64 %28, %indvars.iv.next15
  %arrayidx27.1 = getelementptr inbounds double, double* %y, i64 %60
  %61 = load double, double* %arrayidx27.1, align 8
  %mul28.1 = fmul double %div, %61
  %add29.1 = fadd double %59, %mul28.1
  %arrayidx31.1 = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %indvars.iv.next15
