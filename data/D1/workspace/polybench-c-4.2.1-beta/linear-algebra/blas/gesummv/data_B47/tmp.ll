...
define internal fastcc void @init_array(i32, double* nocapture, double* nocapture, [1300 x double]*, [1300 x double]*, double*) unnamed_addr #2 {
  ...
  br i1 %13, label %.lr.ph3, label %61
...
.lr.ph3:                                          ; preds = %6
  ...
  br i1 %23, label %.lr.ph3.split.us.preheader, label %.lr.ph3.split.preheader
...
.lr.ph3.split.us:                                 ; preds = %.lr.ph3.split.us.preheader, %._crit_edge.us
  %indvars.iv10 = phi i64 [ %27, %.lr.ph3.split.us.preheader ], [ %indvars.iv.next11, %._crit_edge.us ]
  %30 = trunc i64 %indvars.iv10 to i32
  %31 = srem i32 %30, %14
  %32 = sitofp i32 %31 to double
  %33 = fdiv double %32, %17
  %34 = getelementptr inbounds double, double* %18, i64 %indvars.iv10
  store double %33, double* %34, align 8
  br label %35

; <label>:35:                                     ; preds = %.lr.ph3.split.us, %35
  %indvars.iv = phi i64 [ 0, %.lr.ph3.split.us ], [ %indvars.iv.next, %35 ]
  %36 = mul nsw i64 %indvars.iv, %indvars.iv10
  %37 = add nsw i64 %36, 1
  %38 = trunc i64 %37 to i32
  %39 = srem i32 %38, %14
  %40 = sitofp i32 %39 to double
  %41 = getelementptr inbounds [1300 x double], [1300 x double]* %20, i64 %indvars.iv10, i64 %indvars.iv
  %42 = mul nsw i64 %indvars.iv, %indvars.iv10
  %43 = add nsw i64 %42, 2
  ...
  %52 = getelementptr inbounds [1300 x double], [1300 x double]* %22, i64 %indvars.iv10, i64 %indvars.iv
...
._crit_edge.us:                                   ; preds = %35
  ...
  %54 = icmp slt i64 %indvars.iv.next11, %15
  br i1 %54, label %.lr.ph3.split.us, label %._crit_edge4.loopexit

.lr.ph3.split:                                    ; preds = %.lr.ph3.split.preheader, %.lr.ph3.split
  %indvars.iv12 = phi i64 [ %24, %.lr.ph3.split.preheader ], [ %indvars.iv.next13, %.lr.ph3.split ]
  %55 = trunc i64 %indvars.iv12 to i32
  %56 = srem i32 %55, %14
  %57 = sitofp i32 %56 to double
  %58 = fdiv double %57, %17
  %59 = getelementptr inbounds double, double* %18, i64 %indvars.iv12
  store double %58, double* %59, align 8
  %indvars.iv.next13 = add nsw i64 %indvars.iv12, 1
  %60 = icmp slt i64 %indvars.iv.next13, %16
  br i1 %60, label %.lr.ph3.split, label %._crit_edge4.loopexit17
...
._crit_edge4:                                     ; preds = %._crit_edge4.loopexit17, %._crit_edge4.loopexit
  %.lcssa7.in = phi i64 [ %indvars.iv.next11, %._crit_edge4.loopexit ], [ %indvars.iv.next13, %._crit_edge4.loopexit17 ]
  %.lcssa7 = trunc i64 %.lcssa7.in to i32
  store i32 %.lcssa7, i32* %11, align 4
  br label %61

; <label>:61:                                     ; preds = %._crit_edge4, %6
  ret void
}
...
define internal fastcc void @kernel_gesummv(i32, double, double, [1300 x double]*, [1300 x double]*, double*, double*, double*) unnamed_addr #2 {
  ...
  br i1 %19, label %.lr.ph2, label %96
...
.lr.ph2:                                          ; preds = %8
  ...
  %26 = load [1300 x double]*, [1300 x double]** %12, align 8
  %27 = load double*, double** %15, align 8
  %28 = load double*, double** %14, align 8
  %29 = load [1300 x double]*, [1300 x double]** %13, align 8
  %30 = load double*, double** %16, align 8
  %.promoted4 = load i32, i32* %17, align 4
  %31 = sext i32 %.promoted4 to i64
  %32 = icmp sgt i32 %22, 0
  br i1 %32, label %.lr.ph2.split.us.preheader, label %.lr.ph2.split.preheader
...
.lr.ph2.split.preheader50:                        ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.lr.ph2.split.preheader
  %indvars.iv14.ph = phi i64 [ %31, %vector.memcheck ], [ %31, %min.iters.checked ], [ %31, %.lr.ph2.split.preheader ], [ %ind.end, %middle.block ]
...
vector.memcheck:                                  ; preds = %min.iters.checked
  %scevgep = getelementptr double, double* %20, i64 %31
  %37 = add nsw i64 %31, 1
  %38 = icmp sgt i64 %37, %23
  %smax37 = select i1 %38, i64 %37, i64 %23
  %scevgep38 = getelementptr double, double* %20, i64 %smax37
  %scevgep40 = getelementptr double, double* %21, i64 %31
  %scevgep42 = getelementptr double, double* %21, i64 %smax37
  %bound0 = icmp ult double* %scevgep, %scevgep42
  %bound1 = icmp ult double* %scevgep40, %scevgep38
  %memcheck.conflict = and i1 %bound0, %bound1
  %ind.end = add nsw i64 %31, %n.vec
  br i1 %memcheck.conflict, label %.lr.ph2.split.preheader50, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %broadcast.splatinsert46 = insertelement <2 x double> undef, double %24, i32 0
  %broadcast.splat47 = shufflevector <2 x double> %broadcast.splatinsert46, <2 x double> undef, <2 x i32> zeroinitializer
  %broadcast.splatinsert48 = insertelement <2 x double> undef, double %33, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load45 = load <2 x double>, <2 x double>* %49, align 8, !alias.scope !1, !noalias !4
  %50 = fmul <2 x double> %broadcast.splat47, %wide.load
  %51 = fmul <2 x double> %broadcast.splat47, %wide.load45
  %52 = fadd <2 x double> %50, %broadcast.splat49
  %53 = fadd <2 x double> %51, %broadcast.splat49
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %._crit_edge3, label %.lr.ph2.split.preheader50

.lr.ph2.split.us.preheader:                       ; preds = %.lr.ph2
  %57 = load i32, i32* %9, align 4
  %58 = sext i32 %57 to i64
  %59 = sext i32 %.promoted4 to i64
  %60 = sext i32 %22 to i64
  %sunkaddr = ptrtoint double* %28 to i64
  %sunkaddr22 = ptrtoint double* %28 to i64
  %sunkaddr26 = ptrtoint double* %30 to i64
  %sunkaddr30 = ptrtoint double* %30 to i64
  br label %.lr.ph2.split.us

.lr.ph2.split.us:                                 ; preds = %.lr.ph2.split.us.preheader, %._crit_edge.us
  %indvars.iv10 = phi i64 [ %59, %.lr.ph2.split.us.preheader ], [ %indvars.iv.next11, %._crit_edge.us ]
  %61 = getelementptr inbounds double, double* %20, i64 %indvars.iv10
  store double 0.000000e+00, double* %61, align 8
  %62 = getelementptr inbounds double, double* %21, i64 %indvars.iv10
...
; <label>:63:                                     ; preds = %.lr.ph2.split.us, %63
  %indvars.iv = phi i64 [ 0, %.lr.ph2.split.us ], [ %indvars.iv.next, %63 ]
  %64 = getelementptr inbounds [1300 x double], [1300 x double]* %26, i64 %indvars.iv10, i64 %indvars.iv
  %65 = load double, double* %64, align 8
  %66 = getelementptr inbounds double, double* %27, i64 %indvars.iv
  %67 = load double, double* %66, align 8
  %68 = fmul double %65, %67
  %69 = load double, double* %sunkaddr21, align 8
  %70 = fadd double %68, %69
  store double %70, double* %sunkaddr25, align 8
  %71 = getelementptr inbounds [1300 x double], [1300 x double]* %29, i64 %indvars.iv10, i64 %indvars.iv
  %72 = load double, double* %71, align 8
  %73 = getelementptr inbounds double, double* %27, i64 %indvars.iv
  %74 = load double, double* %73, align 8
  %75 = fmul double %72, %74
  %76 = load double, double* %sunkaddr29, align 8
  %77 = fadd double %75, %76
  store double %77, double* %sunkaddr33, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %78 = icmp slt i64 %indvars.iv.next, %58
  br i1 %78, label %63, label %._crit_edge.us

._crit_edge.us:                                   ; preds = %63
  %79 = getelementptr inbounds double, double* %20, i64 %indvars.iv10
  %80 = load double, double* %79, align 8
  %81 = fmul double %24, %80
  %82 = getelementptr inbounds double, double* %21, i64 %indvars.iv10
  %83 = load double, double* %82, align 8
  %84 = fmul double %25, %83
  %85 = fadd double %81, %84
  %86 = getelementptr inbounds double, double* %21, i64 %indvars.iv10
  store double %85, double* %86, align 8
  %indvars.iv.next11 = add nsw i64 %indvars.iv10, 1
  %87 = icmp slt i64 %indvars.iv.next11, %60
  br i1 %87, label %.lr.ph2.split.us, label %._crit_edge3.loopexit
...
.lr.ph2.split:                                    ; preds = %.lr.ph2.split.preheader50, %.lr.ph2.split
  ...
  %88 = getelementptr inbounds double, double* %20, i64 %indvars.iv14
  store double 0.000000e+00, double* %88, align 8
  %89 = getelementptr inbounds double, double* %21, i64 %indvars.iv14
  store double 0.000000e+00, double* %89, align 8
  %90 = getelementptr inbounds double, double* %20, i64 %indvars.iv14
  %91 = load double, double* %90, align 8
  %92 = fmul double %24, %91
  %93 = fadd double %92, %33
  %94 = getelementptr inbounds double, double* %21, i64 %indvars.iv14
  store double %93, double* %94, align 8
  %indvars.iv.next15 = add nsw i64 %indvars.iv14, 1
  %95 = icmp slt i64 %indvars.iv.next15, %23
  br i1 %95, label %.lr.ph2.split, label %._crit_edge3.loopexit51, !llvm.loop !9
...
._crit_edge3:                                     ; preds = %._crit_edge3.loopexit51, %._crit_edge3.loopexit, %middle.block
  %.lcssa5.in = phi i64 [ %ind.end, %middle.block ], [ %indvars.iv.next11, %._crit_edge3.loopexit ], [ %indvars.iv.next15, %._crit_edge3.loopexit51 ]
  %.lcssa5 = trunc i64 %.lcssa5.in to i32
  store i32 %.lcssa5, i32* %17, align 4
  br label %96

; <label>:96:                                     ; preds = %._crit_edge3, %8
  ret void
}
...
; <label>:20:                                     ; preds = %16
  ...
  %fputc = call i32 @fputc(i32 10, %struct._IO_FILE* %21) #5
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %16, %20
  ...
  %25 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %22, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i64 0, i64 0), double %24) #6
...
; <label>:28:                                     ; preds = %._crit_edge2, %2
  ...
  %30 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %29, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #6
  %31 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %32 = call i64 @fwrite(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.7, i64 0, i64 0), i64 22, i64 1, %struct._IO_FILE* %31) #5
  ret void
}
