...
for.body3.us:                                     ; preds = %for.body3.us, %for.body.us
  %indvars.iv38 = phi i64 [ 0, %for.body.us ], [ %indvars.iv.next39, %for.body3.us ]
...
for.cond1.for.inc16_crit_edge.us:                 ; preds = %for.body3.us
  ...
  %exitcond51 = icmp eq i64 %indvars.iv.next42, 1000
  br i1 %exitcond51, label %for.body26.lr.ph.preheader, label %for.body.us
...
for.body26.lr.ph:                                 ; preds = %for.body26.lr.ph.preheader, %for.inc51
  %indvars.iv49 = phi i3 [ %indvars.iv.next50, %for.inc51 ], [ -1, %for.body26.lr.ph.preheader ]
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc51 ], [ 2, %for.body26.lr.ph.preheader ]
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc51 ], [ 0, %for.body26.lr.ph.preheader ]
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc51 ], [ 1, %for.body26.lr.ph.preheader ]
  %indvar = phi i32 [ %11, %for.inc51 ], [ 0, %for.body26.lr.ph.preheader ]
  %indvars.iv26 = phi i32 [ %indvars.iv.next27, %for.inc51 ], [ 1, %for.body26.lr.ph.preheader ]
...
for.body26:                                       ; preds = %for.body26, %for.body26.preheader
  ...
  %14 = add nsw i64 %indvars.iv, %indvars.iv36
  ...
  %16 = add nsw i64 %indvars.iv.next, %indvars.iv36
...
for.body43.prol:                                  ; preds = %for.body43.prol, %for.body43.prol.preheader
  %indvars.iv30.prol = phi i64 [ %indvars.iv28, %for.body43.prol.preheader ], [ %indvars.iv.next31.prol, %for.body43.prol ]
  %prol.iter = phi i32 [ %xtraiter32, %for.body43.prol.preheader ], [ %prol.iter.sub, %for.body43.prol ]
...
for.body43:                                       ; preds = %for.body43, %for.body43.preheader
  %indvars.iv30 = phi i64 [ %indvars.iv30.unr, %for.body43.preheader ], [ %indvars.iv.next31.7, %for.body43 ]
...
for.body:                                         ; preds = %for.inc53, %entry
  %indvars.iv37 = phi i64 [ 0, %entry ], [ %indvars.iv.next38, %for.inc53 ]
...
for.inc53:                                        ; preds = %for.inc53.loopexit65, %for.inc53.loopexit64, %for.inc53.loopexit
  ...
  br i1 %exitcond39, label %for.end55, label %for.body
