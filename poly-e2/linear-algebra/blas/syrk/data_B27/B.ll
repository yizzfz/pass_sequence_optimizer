...
for.cond1.preheader.us:                           ; preds = %for.inc7.us, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge
  %indvars.iv32 = phi i64 [ 0, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge ], [ %indvars.iv.next33, %for.inc7.us ]
...
for.inc7.us:                                      ; preds = %for.body3.us
  ...
  %exitcond37 = icmp eq i64 %indvars.iv.next33, 1200
  br i1 %exitcond37, label %for.cond14.preheader.us.preheader, label %for.cond1.preheader.us
...
for.cond14.preheader.us:                          ; preds = %for.cond14.preheader.us.preheader, %for.inc31.us
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc31.us ], [ 0, %for.cond14.preheader.us.preheader ]
...
for.body17.us:                                    ; preds = %for.body17.us, %for.cond14.preheader.us
  ...
  %3 = mul nuw nsw i64 %indvars.iv23, %indvars.iv
  %4 = add nuw nsw i64 %3, 2
  %5 = trunc i64 %4 to i32
  %rem20.us = srem i32 %5, 1000
  %conv21.us = sitofp i32 %rem20.us to double
  %div23.us = fdiv double %conv21.us, 1.000000e+03
  %arrayidx27.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv23, i64 %indvars.iv
  store double %div23.us, double* %arrayidx27.us, align 8
  %exitcond36 = icmp eq i64 %indvars.iv, 1199
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br i1 %exitcond36, label %for.inc31.us, label %for.body17.us

for.inc31.us:                                     ; preds = %for.body17.us
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  %exitcond38 = icmp eq i64 %indvars.iv.next24, 1200
  br i1 %exitcond38, label %for.end33, label %for.cond14.preheader.us
...
for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge:
  ...
  br label %for.cond1.preheader.us.for.body3.us_crit_edge

for.cond1.preheader.us.for.body3.us_crit_edge:    ; preds = %for.inc32.us, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge
  %indvars.iv60 = phi i64 [ 0, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge ], [ %3, %for.inc32.us ]
  %0 = add i64 %indvars.iv60, 1
  %1 = add i64 %indvars.iv60, -3
  %2 = lshr i64 %1, 2
  %3 = add i64 %indvars.iv60, 1
  %scevgep = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv60, i64 0
  %4 = mul i64 %indvars.iv60, 1201
  %5 = add i64 %4, 1
...
min.iters.checked20:                              ; preds = %for.cond1.preheader.us.for.body3.us_crit_edge
  %n.vec22 = and i64 %3, -4
...
vector.body16.prol:                               ; preds = %vector.ph24
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv60, i64 0
  %8 = bitcast double* %7 to <2 x double>*
  %wide.load33.prol = load <2 x double>, <2 x double>* %8, align 8
  %9 = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv60, i64 2
...
vector.body16:                                    ; preds = %vector.body16, %vector.ph24.new
  ...
  %14 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv60, i64 %index25
  ...
  %20 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv60, i64 %index.next26
...
middle.block17:                                   ; preds = %vector.body16, %vector.body16.prol.loopexit
  ...
  br i1 %cmp.n28, label %for.cond9.preheader.us21.preheader, label %for.body3.us.preheader

for.body3.us.preheader:                           ; preds = %middle.block17, %min.iters.checked20, %for.cond1.preheader.us.for.body3.us_crit_edge
  %indvars.iv.ph = phi i64 [ 0, %min.iters.checked20 ], [ 0, %for.cond1.preheader.us.for.body3.us_crit_edge ], [ %n.vec22, %middle.block17 ]
  br label %for.body3.us
...
for.body3.us:                                     ; preds = %for.body3.us.preheader, %for.body3.us
  ...
  %exitcond = icmp eq i64 %indvars.iv, %indvars.iv60
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br i1 %exitcond, label %for.cond9.preheader.us21.preheader, label %for.body3.us, !llvm.loop !4

for.cond9.preheader.us21.preheader:               ; preds = %for.body3.us, %middle.block17
  %n.vec = and i64 %3, -4
  br label %for.cond9.preheader.us21

for.cond9.preheader.us21:                         ; preds = %for.cond9.preheader.us21.preheader, %for.inc29.us40
  %indvars.iv57 = phi i64 [ %29, %for.inc29.us40 ], [ 0, %for.cond9.preheader.us21.preheader ]
  %28 = icmp ult i64 %3, 4
  %scevgep4 = getelementptr [1000 x double], [1000 x double]* %A, i64 0, i64 %indvars.iv57
  %29 = add i64 %indvars.iv57, 1
  %scevgep6 = getelementptr [1000 x double], [1000 x double]* %A, i64 %indvars.iv60, i64 %29
  %arrayidx15.us29 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv60, i64 %indvars.iv57
  br i1 %28, label %for.body11.us25.preheader, label %min.iters.checked

min.iters.checked:                                ; preds = %for.cond9.preheader.us21
  %30 = icmp eq i64 %n.vec, 0
  br i1 %30, label %for.body11.us25.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %bound0 = icmp ult double* %scevgep, %scevgep6
  %bound1 = icmp ult double* %scevgep4, %scevgep2
  %found.conflict = and i1 %bound0, %bound1
  %bound09 = icmp ult double* %scevgep, %arrayidx15.us29
  %bound110 = icmp ult double* %arrayidx15.us29, %scevgep2
  %found.conflict11 = and i1 %bound09, %bound110
  %conflict.rdx = or i1 %found.conflict, %found.conflict11
  br i1 %conflict.rdx, label %for.body11.us25.preheader, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %.pre = load double, double* %arrayidx15.us29, align 8, !alias.scope !6
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %35 = or i64 %index, 2
  %36 = or i64 %index, 3
  %37 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %index, i64 %indvars.iv57
  %38 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %34, i64 %indvars.iv57
  %39 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %35, i64 %indvars.iv57
  %40 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %36, i64 %indvars.iv57
  ...
  %51 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv60, i64 %index
  ...
  %55 = fadd <2 x double> %49, %wide.load
  %56 = fadd <2 x double> %50, %wide.load15
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %58, label %for.inc29.us40, label %for.body11.us25.preheader

for.body11.us25.preheader:                        ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.cond9.preheader.us21
  %indvars.iv51.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %min.iters.checked ], [ 0, %for.cond9.preheader.us21 ], [ %n.vec, %middle.block ]
  %59 = sub i64 %0, %indvars.iv51.ph
  %xtraiter37 = and i64 %59, 1
  %lcmp.mod38 = icmp eq i64 %xtraiter37, 0
  br i1 %lcmp.mod38, label %for.body11.us25.prol.loopexit, label %for.body11.us25.prol

for.body11.us25.prol:                             ; preds = %for.body11.us25.preheader
  %60 = load double, double* %arrayidx15.us29, align 8
  %mul16.us30.prol = fmul double %60, %alpha
  %arrayidx20.us32.prol = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv51.ph, i64 %indvars.iv57
  %61 = load double, double* %arrayidx20.us32.prol, align 8
  %mul21.us33.prol = fmul double %mul16.us30.prol, %61
  %arrayidx25.us34.prol = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv60, i64 %indvars.iv51.ph
  %62 = load double, double* %arrayidx25.us34.prol, align 8
  %add.us35.prol = fadd double %mul21.us33.prol, %62
  store double %add.us35.prol, double* %arrayidx25.us34.prol, align 8
  %indvars.iv.next52.prol = or i64 %indvars.iv51.ph, 1
  br label %for.body11.us25.prol.loopexit

for.body11.us25.prol.loopexit:                    ; preds = %for.body11.us25.prol, %for.body11.us25.preheader
  %indvars.iv51.unr.ph = phi i64 [ %indvars.iv.next52.prol, %for.body11.us25.prol ], [ %indvars.iv51.ph, %for.body11.us25.preheader ]
  %63 = icmp eq i64 %indvars.iv60, %indvars.iv51.ph
  br i1 %63, label %for.inc29.us40, label %for.body11.us25.preheader.new

for.body11.us25.preheader.new:                    ; preds = %for.body11.us25.prol.loopexit
  br label %for.body11.us25

for.body11.us25:                                  ; preds = %for.body11.us25, %for.body11.us25.preheader.new
  %indvars.iv51 = phi i64 [ %indvars.iv51.unr.ph, %for.body11.us25.preheader.new ], [ %indvars.iv.next52.1, %for.body11.us25 ]
  %64 = load double, double* %arrayidx15.us29, align 8
  %mul16.us30 = fmul double %64, %alpha
  %arrayidx20.us32 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv51, i64 %indvars.iv57
  %65 = load double, double* %arrayidx20.us32, align 8
  %mul21.us33 = fmul double %mul16.us30, %65
  %arrayidx25.us34 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv60, i64 %indvars.iv51
  %66 = load double, double* %arrayidx25.us34, align 8
  %add.us35 = fadd double %mul21.us33, %66
  store double %add.us35, double* %arrayidx25.us34, align 8
  %indvars.iv.next52 = add nuw nsw i64 %indvars.iv51, 1
  %67 = load double, double* %arrayidx15.us29, align 8
  %mul16.us30.1 = fmul double %67, %alpha
  %arrayidx20.us32.1 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv.next52, i64 %indvars.iv57
  %68 = load double, double* %arrayidx20.us32.1, align 8
  %mul21.us33.1 = fmul double %mul16.us30.1, %68
  %arrayidx25.us34.1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv60, i64 %indvars.iv.next52
  %69 = load double, double* %arrayidx25.us34.1, align 8
  %add.us35.1 = fadd double %mul21.us33.1, %69
  store double %add.us35.1, double* %arrayidx25.us34.1, align 8
  %exitcond56.1 = icmp eq i64 %indvars.iv.next52, %indvars.iv60
  %indvars.iv.next52.1 = add nsw i64 %indvars.iv51, 2
  br i1 %exitcond56.1, label %for.inc29.us40, label %for.body11.us25, !llvm.loop !15

for.inc29.us40:                                   ; preds = %for.body11.us25.prol.loopexit, %for.body11.us25, %middle.block
  %exitcond70 = icmp eq i64 %29, 1000
  br i1 %exitcond70, label %for.inc32.us, label %for.cond9.preheader.us21

for.inc32.us:                                     ; preds = %for.inc29.us40
  %exitcond71 = icmp eq i64 %3, 1200
  br i1 %exitcond71, label %for.end34, label %for.cond1.preheader.us.for.body3.us_crit_edge
...
for.cond2.preheader.us:                           ; preds = %for.inc10.us, %for.cond2.preheader.lr.ph.for.cond2.preheader.us_crit_edge
  %indvars.iv9 = phi i64 [ 0, %for.cond2.preheader.lr.ph.for.cond2.preheader.us_crit_edge ], [ %indvars.iv.next10, %for.inc10.us ]
  %3 = mul nuw nsw i64 %indvars.iv9, 1200
...
for.inc10.us:                                     ; preds = %if.end.us
  ...
  %exitcond12 = icmp eq i64 %indvars.iv.next10, 1200
