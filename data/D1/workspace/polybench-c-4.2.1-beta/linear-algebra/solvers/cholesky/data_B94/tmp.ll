...
.preheader71.lr.ph:                               ; preds = %1
  br label %.lr.ph93

.lr.ph93:                                         ; preds = %._crit_edge98, %.preheader71.lr.ph
  %indvars.iv147 = phi i64 [ 0, %.preheader71.lr.ph ], [ %indvars.iv.next148, %._crit_edge98 ]
  %indvars.iv145 = phi i64 [ 1, %.preheader71.lr.ph ], [ %indvars.iv.next146, %._crit_edge98 ]
  %3 = mul nuw nsw i64 %indvars.iv147, 2001
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph93
  ...
  %13 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv147, i64 %indvars.iv129
...
._crit_edge94:                                    ; preds = %._crit_edge
  %scevgep141 = getelementptr [2000 x double], [2000 x double]* %0, i64 0, i64 %4
  %14 = and i64 %6, 34359738360
  %scevgep141142 = bitcast double* %scevgep141 to i8*
  %15 = add nuw nsw i64 %14, 8
  %indvars.iv.next148 = add nuw nsw i64 %indvars.iv147, 1
  %16 = icmp slt i64 %indvars.iv.next148, 2000
  br i1 %16, label %._crit_edge98.loopexit, label %._crit_edge98

._crit_edge98.loopexit:                           ; preds = %._crit_edge94
  call void @llvm.memset.p0i8.i64(i8* nonnull %scevgep141142, i8 0, i64 %15, i32 8, i1 false)
  br label %._crit_edge98

._crit_edge98:                                    ; preds = %._crit_edge94, %._crit_edge98.loopexit
  %17 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv147, i64 %indvars.iv147
  store double 1.000000e+00, double* %17, align 8
  %exitcond150 = icmp eq i64 %indvars.iv.next148, 2000
  %indvars.iv.next146 = add nuw nsw i64 %indvars.iv145, 1
  br i1 %exitcond150, label %._crit_edge100, label %.lr.ph93
...
._crit_edge90.us.prol:                            ; preds = %._crit_edge90.us.prol, %._crit_edge90.us.prol.preheader
  ...
  %20 = mul nuw nsw i64 %indvars.iv125.prol, 16000
  ...
  br i1 %prol.iter203.cmp, label %._crit_edge90.us.prol.loopexit.unr-lcssa, label %._crit_edge90.us.prol, !llvm.loop !1
...
._crit_edge90.us:                                 ; preds = %._crit_edge90.us, %._crit_edge100.new
  ...
  %21 = mul nuw nsw i64 %indvars.iv125, 16000
  %scevgep = getelementptr i8, i8* %18, i64 %21
  call void @llvm.memset.p0i8.i64(i8* %scevgep, i8 0, i64 16000, i32 8, i1 false)
  %22 = mul i64 %indvars.iv125, 16000
  %23 = add i64 %22, 16000
  ...
  br i1 %exitcond128.7, label %.preheader67.us.us.preheader.preheader.unr-lcssa, label %._crit_edge90.us

.preheader67.us.us.preheader.preheader.unr-lcssa: ; preds = %._crit_edge90.us
  br label %.preheader67.us.us.preheader.preheader

.preheader67.us.us.preheader.preheader:           ; preds = %._crit_edge90.us.prol.loopexit, %.preheader67.us.us.preheader.preheader.unr-lcssa
...
.preheader67.us.us.preheader:                     ; preds = %.preheader67.us.us.preheader.preheader, %._crit_edge79.us
  ...
  %scevgep158 = getelementptr [2000 x double], [2000 x double]* %0, i64 0, i64 %indvars.iv117
  %scevgep158159 = bitcast double* %scevgep158 to i8*
  %36 = add nsw i64 %indvars.iv117, -1999
  %scevgep160 = getelementptr [2000 x double], [2000 x double]* %0, i64 2000, i64 %36
...
.preheader67.us.us:                               ; preds = %._crit_edge77.us.us, %.preheader67.us.us.preheader
  ...
  %37 = mul nuw nsw i64 %indvars.iv113, 16000
  %scevgep156 = getelementptr i8, i8* %18, i64 %37
  %38 = add i64 16000, %37
  %scevgep157 = getelementptr i8, i8* %18, i64 %38
  %39 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv113, i64 %indvars.iv117
...
._crit_edge151.preheader:                         ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.preheader67.us.us
  %indvars.iv109.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %min.iters.checked ], [ 0, %.preheader67.us.us ], [ 2000, %middle.block ]
  br i1 true, label %._crit_edge151.prol.loopexit.unr-lcssa, label %._crit_edge151.prol.preheader

._crit_edge151.prol.preheader:                    ; preds = %._crit_edge151.preheader
  br label %._crit_edge151.prol

._crit_edge151.prol:                              ; preds = %._crit_edge151.prol.preheader
  %40 = load double, double* %39, align 8
  %41 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv109.ph, i64 %indvars.iv117
  %42 = load double, double* %41, align 8
  %43 = fmul double %40, %42
  %44 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %19, i64 0, i64 %indvars.iv113, i64 %indvars.iv109.ph
  %45 = load double, double* %44, align 8
  %46 = fadd double %45, %43
  store double %46, double* %44, align 8
  %indvars.iv.next110.prol = add nuw nsw i64 %indvars.iv109.ph, 1
  br label %._crit_edge151.prol.loopexit.unr-lcssa

._crit_edge151.prol.loopexit.unr-lcssa:           ; preds = %._crit_edge151.preheader, %._crit_edge151.prol
...
._crit_edge151.prol.loopexit:                     ; preds = %._crit_edge151.prol.loopexit.unr-lcssa
  br i1 false, label %._crit_edge77.us.us.loopexit, label %._crit_edge151.preheader.new
...
vector.memcheck:                                  ; preds = %min.iters.checked
  %bound0 = icmp ult i8* %scevgep156, %scevgep160161
  %bound1 = icmp ult i8* %scevgep158159, %scevgep157
  %found.conflict = and i1 %bound0, %bound1
  %bc = bitcast double* %39 to i8*
  %bc162 = bitcast double* %39 to i8*
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %55 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %index, i64 %indvars.iv117
  %56 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %47, i64 %indvars.iv117
  %57 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %48, i64 %indvars.iv117
  %58 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %49, i64 %indvars.iv117
  ...
  %69 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %19, i64 0, i64 %indvars.iv113, i64 %index
  ...
  %wide.load167 = load <2 x double>, <2 x double>* %72, align 8, !alias.scope !8, !noalias !10
  %73 = fadd <2 x double> %wide.load, %67
  %74 = fadd <2 x double> %wide.load167, %68
...
._crit_edge77.us.us.loopexit.unr-lcssa:           ; preds = %._crit_edge151
  br label %._crit_edge77.us.us.loopexit

._crit_edge77.us.us.loopexit:                     ; preds = %._crit_edge151.prol.loopexit, %._crit_edge77.us.us.loopexit.unr-lcssa
...
._crit_edge151:                                   ; preds = %._crit_edge151, %._crit_edge151.preheader.new
  ...
  %79 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv109, i64 %indvars.iv117
  %80 = load double, double* %79, align 8
  %81 = fmul double %78, %80
  %82 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %19, i64 0, i64 %indvars.iv113, i64 %indvars.iv109
  %83 = load double, double* %82, align 8
  %84 = fadd double %83, %81
  store double %84, double* %82, align 8
  %indvars.iv.next110 = add nuw nsw i64 %indvars.iv109, 1
  %85 = load double, double* %39, align 8
  %86 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv.next110, i64 %indvars.iv117
  %87 = load double, double* %86, align 8
  %88 = fmul double %85, %87
  %89 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %19, i64 0, i64 %indvars.iv113, i64 %indvars.iv.next110
  ...
  br i1 %exitcond112.1, label %._crit_edge77.us.us.loopexit.unr-lcssa, label %._crit_edge151, !llvm.loop !14
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  ...
  %scevgep177 = getelementptr [2000 x double], [2000 x double]* %0, i64 %indvars.iv105, i64 0
  %scevgep177178 = bitcast double* %scevgep177 to i8*
  %scevgep179 = getelementptr [2000 x double], [2000 x double]* %0, i64 %indvars.iv105, i64 2000
  %scevgep179180 = bitcast double* %scevgep179 to i8*
  %92 = mul nuw nsw i64 %indvars.iv105, 16000
  %scevgep181 = getelementptr i8, i8* %18, i64 %92
  %93 = add i64 16000, %92
  %scevgep182 = getelementptr i8, i8* %18, i64 %93
...
vector.memcheck187:                               ; preds = %min.iters.checked172
  %bound0183 = icmp ult i8* %scevgep177178, %scevgep182
  %bound1184 = icmp ult i8* %scevgep181, %scevgep179180
...
vector.body168:                                   ; preds = %vector.body168.preheader, %vector.body168
  ...
  %94 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %19, i64 0, i64 %indvars.iv105, i64 %index189
  %95 = bitcast double* %94 to <2 x i64>*
  %wide.load197 = load <2 x i64>, <2 x i64>* %95, align 8, !alias.scope !15
  %96 = getelementptr double, double* %94, i64 2
  %97 = bitcast double* %96 to <2 x i64>*
  %wide.load198 = load <2 x i64>, <2 x i64>* %97, align 8, !alias.scope !15
  %98 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv105, i64 %index189
  %99 = bitcast double* %98 to <2 x i64>*
  store <2 x i64> %wide.load197, <2 x i64>* %99, align 8, !alias.scope !18, !noalias !15
  %100 = getelementptr double, double* %98, i64 2
  %101 = bitcast double* %100 to <2 x i64>*
  store <2 x i64> %wide.load198, <2 x i64>* %101, align 8, !alias.scope !18, !noalias !15
  %index.next190 = add i64 %index189, 4
  %102 = icmp eq i64 %index.next190, 2000
  br i1 %102, label %middle.block169, label %vector.body168, !llvm.loop !20
...
._crit_edge152.preheader:                         ; preds = %middle.block169, %vector.memcheck187, %min.iters.checked172, %.preheader.us
  %indvars.iv.ph = phi i64 [ 0, %vector.memcheck187 ], [ 0, %min.iters.checked172 ], [ 0, %.preheader.us ], [ 2000, %middle.block169 ]
...
._crit_edge152.prol:                              ; preds = %._crit_edge152.prol, %._crit_edge152.prol.preheader
  ...
  %104 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %19, i64 0, i64 %indvars.iv105, i64 %indvars.iv.prol
  %105 = bitcast double* %104 to i64*
  %106 = load i64, i64* %105, align 8
  %107 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv105, i64 %indvars.iv.prol
...
._crit_edge152.prol.loopexit:                     ; preds = %._crit_edge152.preheader, %._crit_edge152.prol.loopexit.unr-lcssa
  ...
  br i1 %109, label %._crit_edge.us.loopexit, label %._crit_edge152.preheader.new
...
._crit_edge152:                                   ; preds = %._crit_edge152, %._crit_edge152.preheader.new
  ...
  %110 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %19, i64 0, i64 %indvars.iv105, i64 %indvars.iv
  %111 = bitcast double* %110 to i64*
  %112 = load i64, i64* %111, align 8
  %113 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv105, i64 %indvars.iv
  %114 = bitcast double* %113 to i64*
  store i64 %112, i64* %114, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %115 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %19, i64 0, i64 %indvars.iv105, i64 %indvars.iv.next
  %116 = bitcast double* %115 to i64*
  %117 = load i64, i64* %116, align 8
  %118 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv105, i64 %indvars.iv.next
  %119 = bitcast double* %118 to i64*
  store i64 %117, i64* %119, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %120 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %19, i64 0, i64 %indvars.iv105, i64 %indvars.iv.next.1
  %121 = bitcast double* %120 to i64*
  %122 = load i64, i64* %121, align 8
  %123 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv105, i64 %indvars.iv.next.1
  %124 = bitcast double* %123 to i64*
  store i64 %122, i64* %124, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %125 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %19, i64 0, i64 %indvars.iv105, i64 %indvars.iv.next.2
  %126 = bitcast double* %125 to i64*
  %127 = load i64, i64* %126, align 8
  %128 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv105, i64 %indvars.iv.next.2
  %129 = bitcast double* %128 to i64*
  store i64 %127, i64* %129, align 8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %exitcond104.3 = icmp eq i64 %indvars.iv.next.3, 2000
  br i1 %exitcond104.3, label %._crit_edge.us.loopexit.unr-lcssa, label %._crit_edge152, !llvm.loop !22

._crit_edge.us.loopexit.unr-lcssa:                ; preds = %._crit_edge152
  br label %._crit_edge.us.loopexit

._crit_edge.us.loopexit:                          ; preds = %._crit_edge152.prol.loopexit, %._crit_edge.us.loopexit.unr-lcssa
...
._crit_edge74:                                    ; preds = %._crit_edge74.loopexit, %._crit_edge100.thread
  %130 = phi i8* [ %2, %._crit_edge100.thread ], [ %18, %._crit_edge74.loopexit ]
...
.preheader41:                                     ; preds = %.preheader41.preheader, %._crit_edge46
  %indvars.iv84 = phi i2 [ 0, %.preheader41.preheader ], [ %indvars.iv.next85, %._crit_edge46 ]
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %._crit_edge46 ], [ 0, %.preheader41.preheader ]
...
.preheader.preheader:                             ; preds = %.preheader41
  %5 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv71, i64 0
  br label %.preheader

.lr.ph45:                                         ; preds = %._crit_edge
  %6 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv71, i64 %indvars.iv71
...
._crit_edge76.prol:                               ; preds = %._crit_edge76.prol, %._crit_edge76.prol.preheader
  ...
  %8 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv71, i64 %indvars.iv63.prol
  ...
  %prol.iter.sub = add nsw i64 %prol.iter, -1
  %prol.iter.cmp = icmp eq i64 %prol.iter.sub, 0
  br i1 %prol.iter.cmp, label %._crit_edge76.prol.loopexit.unr-lcssa, label %._crit_edge76.prol, !llvm.loop !23
...
.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge
  ...
  %14 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv71, i64 %indvars.iv55
...
._crit_edge75.prol:                               ; preds = %._crit_edge75.prol.preheader
  ...
  %16 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv55, i64 0
...
._crit_edge75:                                    ; preds = %._crit_edge75, %._crit_edge75.preheader.new
  ...
  %22 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv71, i64 %indvars.iv
  %23 = load double, double* %22, align 8
  %24 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv55, i64 %indvars.iv
  %25 = load double, double* %24, align 8
  %26 = fmul double %23, %25
  %27 = fsub double %21, %26
  store double %27, double* %14, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %28 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv71, i64 %indvars.iv.next
  %29 = load double, double* %28, align 8
  %30 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv55, i64 %indvars.iv.next
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader
  ...
  %35 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv55, i64 %indvars.iv55
...
._crit_edge76:                                    ; preds = %._crit_edge76, %.lr.ph45.new
  ...
  %39 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv71, i64 %indvars.iv63
  %40 = load double, double* %39, align 8
  %41 = fmul double %40, %40
  %42 = fsub double %38, %41
  store double %42, double* %6, align 8
  %indvars.iv.next64 = add nuw nsw i64 %indvars.iv63, 1
  %43 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv71, i64 %indvars.iv.next64
  %44 = load double, double* %43, align 8
  %45 = fmul double %44, %44
  %46 = fsub double %42, %45
  store double %46, double* %6, align 8
  %indvars.iv.next64.1 = add nsw i64 %indvars.iv63, 2
  %47 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv71, i64 %indvars.iv.next64.1
  %48 = load double, double* %47, align 8
  %49 = fmul double %48, %48
  %50 = fsub double %46, %49
  store double %50, double* %6, align 8
  %indvars.iv.next64.2 = add nsw i64 %indvars.iv63, 3
  %51 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv71, i64 %indvars.iv.next64.2
...
._crit_edge46:                                    ; preds = %._crit_edge46.loopexit, %.preheader41
  %55 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv71, i64 %indvars.iv71
...
.lr.ph:                                           ; preds = %._crit_edge, %.preheader.preheader
  ...
  %6 = mul nsw i64 %indvars.iv22, 2000
