...
entry:
  ...
  %2 = load [2000 x [2000 x double]]*, [2000 x [2000 x double]]** %A, align 8
  %arraydecay = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %2, i32 0, i32 0
  call void @init_array(i32 %1, [2000 x double]* %arraydecay)
  call void (...) @polybench_timer_start()
  %3 = load i32, i32* %n, align 4
  %4 = load [2000 x [2000 x double]]*, [2000 x [2000 x double]]** %A, align 8
  %arraydecay1 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %4, i32 0, i32 0
  call void @kernel_cholesky(i32 %3, [2000 x double]* %arraydecay1)
...
land.lhs.true:                                    ; preds = %entry
  ...
  %call2 = call i32 @strcmp(i8* %7, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i32 0, i32 0)) #4
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %arraydecay3 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %9, i32 0, i32 0
  call void @print_array(i32 %8, [2000 x double]* %arraydecay3)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  %10 = load [2000 x [2000 x double]]*, [2000 x [2000 x double]]** %A, align 8
  %11 = bitcast [2000 x [2000 x double]]* %10 to i8*
...
for.body11:                                       ; preds = %for.cond8
  ...
  %arrayidx13 = getelementptr inbounds [2000 x double], [2000 x double]* %14, i64 %idxprom12
...
for.end18:                                        ; preds = %for.cond8
  ...
  %arrayidx20 = getelementptr inbounds [2000 x double], [2000 x double]* %18, i64 %idxprom19
  %20 = load i32, i32* %i, align 4
  %idxprom21 = sext i32 %20 to i64
  %arrayidx22 = getelementptr inbounds [2000 x double], [2000 x double]* %arrayidx20, i64 0, i64 %idxprom21
...
for.end25:                                        ; preds = %for.cond
  ...
  store [2000 x [2000 x double]]* %22, [2000 x [2000 x double]]** %B, align 8
...
for.body33:                                       ; preds = %for.cond30
  ...
  %arrayidx35 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %27, i64 0, i64 %idxprom34
  %29 = load i32, i32* %s, align 4
  %idxprom36 = sext i32 %29 to i64
  %arrayidx37 = getelementptr inbounds [2000 x double], [2000 x double]* %arrayidx35, i64 0, i64 %idxprom36
...
for.body55:                                       ; preds = %for.cond52
  ...
  %arrayidx57 = getelementptr inbounds [2000 x double], [2000 x double]* %38, i64 %idxprom56
  ...
  %arrayidx61 = getelementptr inbounds [2000 x double], [2000 x double]* %42, i64 %idxprom60
  %44 = load i32, i32* %t, align 4
  %idxprom62 = sext i32 %44 to i64
  %arrayidx63 = getelementptr inbounds [2000 x double], [2000 x double]* %arrayidx61, i64 0, i64 %idxprom62
  %45 = load double, double* %arrayidx63, align 8
  %mul = fmul double %41, %45
  %46 = load [2000 x [2000 x double]]*, [2000 x [2000 x double]]** %B, align 8
  %47 = load i32, i32* %r, align 4
  %idxprom64 = sext i32 %47 to i64
  %arrayidx65 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %46, i64 0, i64 %idxprom64
  %48 = load i32, i32* %s, align 4
  %idxprom66 = sext i32 %48 to i64
  %arrayidx67 = getelementptr inbounds [2000 x double], [2000 x double]* %arrayidx65, i64 0, i64 %idxprom66
  %49 = load double, double* %arrayidx67, align 8
  %add68 = fadd double %49, %mul
...
for.body85:                                       ; preds = %for.cond82
  %57 = load [2000 x [2000 x double]]*, [2000 x [2000 x double]]** %B, align 8
  %58 = load i32, i32* %r, align 4
  %idxprom86 = sext i32 %58 to i64
  %arrayidx87 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %57, i64 0, i64 %idxprom86
  %59 = load i32, i32* %s, align 4
  %idxprom88 = sext i32 %59 to i64
  %arrayidx89 = getelementptr inbounds [2000 x double], [2000 x double]* %arrayidx87, i64 0, i64 %idxprom88
  ...
  %arrayidx91 = getelementptr inbounds [2000 x double], [2000 x double]* %61, i64 %idxprom90
  %63 = load i32, i32* %s, align 4
  %idxprom92 = sext i32 %63 to i64
  %arrayidx93 = getelementptr inbounds [2000 x double], [2000 x double]* %arrayidx91, i64 0, i64 %idxprom92
...
for.end99:                                        ; preds = %for.cond78
  %66 = load [2000 x [2000 x double]]*, [2000 x [2000 x double]]** %B, align 8
  %67 = bitcast [2000 x [2000 x double]]* %66 to i8*
...
for.end:                                          ; preds = %for.cond4
  ...
  %arrayidx22 = getelementptr inbounds [2000 x double], [2000 x double]* %23, i64 %idxprom21
...
for.body30:                                       ; preds = %for.cond28
  ...
  %arrayidx32 = getelementptr inbounds [2000 x double], [2000 x double]* %30, i64 %idxprom31
  ...
  %34 = load [2000 x double]*, [2000 x double]** %A.addr, align 8
  ...
  %arrayidx38 = getelementptr inbounds [2000 x double], [2000 x double]* %arrayidx36, i64 0, i64 %idxprom37
  %37 = load double, double* %arrayidx38, align 8
  %mul39 = fmul double %33, %37
  %38 = load [2000 x double]*, [2000 x double]** %A.addr, align 8
  %39 = load i32, i32* %i, align 4
  %idxprom40 = sext i32 %39 to i64
  %arrayidx41 = getelementptr inbounds [2000 x double], [2000 x double]* %38, i64 %idxprom40
...
for.end47:                                        ; preds = %for.cond28
  %43 = load [2000 x double]*, [2000 x double]** %A.addr, align 8
  ...
  %arrayidx51 = getelementptr inbounds [2000 x double], [2000 x double]* %arrayidx49, i64 0, i64 %idxprom50
  %46 = load double, double* %arrayidx51, align 8
  %call = call double @sqrt(double %46) #5
  %47 = load [2000 x double]*, [2000 x double]** %A.addr, align 8
  %48 = load i32, i32* %i, align 4
  %idxprom52 = sext i32 %48 to i64
  %arrayidx53 = getelementptr inbounds [2000 x double], [2000 x double]* %47, i64 %idxprom52
  %49 = load i32, i32* %i, align 4
  %idxprom54 = sext i32 %49 to i64
  %arrayidx55 = getelementptr inbounds [2000 x double], [2000 x double]* %arrayidx53, i64 0, i64 %idxprom54
