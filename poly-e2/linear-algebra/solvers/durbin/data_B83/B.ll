...
for.inc.lr.ph:                                    ; preds = %for.inc47, %entry
  ...
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc47 ], [ 1, %entry ]
...
for.inc:                                          ; preds = %for.inc, %for.inc.lr.ph.new
  ...
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %exitcond.3 = icmp eq i64 %indvars.iv.next.3, %indvars.iv32
...
for.inc32.lr.ph:                                  ; preds = %for.inc32.lr.ph.loopexit, %for.inc.prol.loopexit
  ...
  %arrayidx16 = getelementptr inbounds double, double* %r, i64 %indvars.iv32
...
for.inc32:                                        ; preds = %for.inc32.preheader, %for.inc32
  ...
  %exitcond25 = icmp eq i64 %indvars.iv.next20, %indvars.iv32
...
for.inc47:                                        ; preds = %for.inc47.loopexit, %middle.block
  ...
  %arrayidx46 = getelementptr inbounds double, double* %y, i64 %indvars.iv32
  store double %div, double* %arrayidx46, align 8
  %indvars.iv.next33 = add nuw nsw i64 %indvars.iv32, 1
  %exitcond36 = icmp eq i64 %indvars.iv.next33, 2000
