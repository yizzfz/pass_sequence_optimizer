...
.lr.ph:                                           ; preds = %2
  ...
  br i1 %lcmp.mod, label %._crit_edge7.prol.loopexit, label %._crit_edge7.prol.preheader

._crit_edge7.prol.preheader:                      ; preds = %.lr.ph
  br label %._crit_edge7.prol

._crit_edge7.prol:                                ; preds = %._crit_edge7.prol, %._crit_edge7.prol.preheader
  %indvars.iv.prol = phi i64 [ 0, %._crit_edge7.prol.preheader ], [ %indvars.iv.next.prol, %._crit_edge7.prol ]
  %prol.iter = phi i64 [ %xtraiter, %._crit_edge7.prol.preheader ], [ %prol.iter.sub, %._crit_edge7.prol ]
  ...
  br i1 %prol.iter.cmp, label %._crit_edge7.prol.loopexit.unr-lcssa, label %._crit_edge7.prol, !llvm.loop !1

._crit_edge7.prol.loopexit.unr-lcssa:             ; preds = %._crit_edge7.prol
  br label %._crit_edge7.prol.loopexit

._crit_edge7.prol.loopexit:                       ; preds = %.lr.ph, %._crit_edge7.prol.loopexit.unr-lcssa
  %indvars.iv.unr = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next.prol, %._crit_edge7.prol.loopexit.unr-lcssa ]
  %11 = icmp ult i64 %6, 3
  br i1 %11, label %._crit_edge.loopexit, label %.lr.ph.new

.lr.ph.new:                                       ; preds = %._crit_edge7.prol.loopexit
  br label %._crit_edge7

._crit_edge7:                                     ; preds = %._crit_edge7, %.lr.ph.new
  %indvars.iv = phi i64 [ %indvars.iv.unr, %.lr.ph.new ], [ %indvars.iv.next.3, %._crit_edge7 ]
  ...
  %exitcond8.3 = icmp eq i64 %indvars.iv.next.3, %5
  br i1 %exitcond8.3, label %._crit_edge.loopexit.unr-lcssa, label %._crit_edge7

._crit_edge.loopexit.unr-lcssa:                   ; preds = %._crit_edge7
  br label %._crit_edge.loopexit

._crit_edge.loopexit:                             ; preds = %._crit_edge7.prol.loopexit, %._crit_edge.loopexit.unr-lcssa
  br label %._crit_edge
...
.lr.ph:                                           ; preds = %._crit_edge51, %.lr.ph56.preheader
  ...
  %indvar = phi i64 [ 0, %.lr.ph56.preheader ], [ %14, %._crit_edge51 ]
  %.04253 = phi double [ 1.000000e+00, %.lr.ph56.preheader ], [ %55, %._crit_edge51 ]
  %.04352 = phi double [ %9, %.lr.ph56.preheader ], [ %60, %._crit_edge51 ]
  %13 = add i64 %indvar, 1
  %14 = add nuw nsw i64 %indvar, 1
  %15 = fmul double %.04352, %.04352
  %16 = add nsw i64 %indvars.iv72, -1
...
._crit_edge76.prol:                               ; preds = %._crit_edge76.prol, %._crit_edge76.prol.preheader
  ...
  %.04144.prol = phi double [ 0.000000e+00, %._crit_edge76.prol.preheader ], [ %23, %._crit_edge76.prol ]
  ...
  %23 = fadd double %.04144.prol, %22
  %indvars.iv.next.prol = add nuw nsw i64 %indvars.iv.prol, 1
  %prol.iter.sub = add i64 %prol.iter, -1
  %prol.iter.cmp = icmp eq i64 %prol.iter.sub, 0
  br i1 %prol.iter.cmp, label %._crit_edge76.prol.loopexit.unr-lcssa, label %._crit_edge76.prol, !llvm.loop !3
...
._crit_edge76.prol.loopexit:                      ; preds = %.lr.ph, %._crit_edge76.prol.loopexit.unr-lcssa
  %.lcssa.unr = phi double [ undef, %.lr.ph ], [ %23, %._crit_edge76.prol.loopexit.unr-lcssa ]
  %indvars.iv.unr = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next.prol, %._crit_edge76.prol.loopexit.unr-lcssa ]
  %.04144.unr = phi double [ 0.000000e+00, %.lr.ph ], [ %23, %._crit_edge76.prol.loopexit.unr-lcssa ]
  %24 = icmp ult i64 %indvar, 3
  br i1 %24, label %.lr.ph48, label %.lr.ph.new
...
._crit_edge76:                                    ; preds = %._crit_edge76, %.lr.ph.new
  ...
  %.04144 = phi double [ %.04144.unr, %.lr.ph.new ], [ %52, %._crit_edge76 ]
...
.lr.ph48:                                         ; preds = %._crit_edge76.prol.loopexit, %.lr.ph48.unr-lcssa
  %.lcssa = phi double [ %.lcssa.unr, %._crit_edge76.prol.loopexit ], [ %52, %.lr.ph48.unr-lcssa ]
  %53 = shl i64 %indvar, 3
  %54 = fsub double 1.000000e+00, %15
  %55 = fmul double %.04253, %54
  %56 = getelementptr inbounds double, double* %1, i64 %indvars.iv72
...
vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert83 = insertelement <2 x double> undef, double %60, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load81 = load <2 x double>, <2 x double>* %71, align 8
  %reverse82 = shufflevector <2 x double> %wide.load81, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %72 = fmul <2 x double> %broadcast.splat84, %reverse
  %73 = fmul <2 x double> %broadcast.splat84, %reverse82
  %74 = fadd <2 x double> %wide.load, %72
  %75 = fadd <2 x double> %wide.load79, %73
...
._crit_edge77:                                    ; preds = %._crit_edge77.preheader, %._crit_edge77
  ...
  %81 = getelementptr inbounds double, double* %2, i64 %indvars.iv60
  %82 = load double, double* %81, align 8
  %83 = sub nsw i64 %16, %indvars.iv60
  %84 = getelementptr inbounds double, double* %2, i64 %83
  %85 = load double, double* %84, align 8
  %86 = fmul double %60, %85
  %87 = fadd double %82, %86
  %88 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 0, i64 %indvars.iv60
  store double %87, double* %88, align 8
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  %exitcond65 = icmp eq i64 %indvars.iv.next61, %indvars.iv72
  br i1 %exitcond65, label %._crit_edge51.loopexit, label %._crit_edge77, !llvm.loop !7
...
._crit_edge51:                                    ; preds = %._crit_edge51.loopexit, %middle.block
  ...
  %90 = getelementptr inbounds double, double* %2, i64 %indvars.iv72
  store double %60, double* %90, align 8
  %exitcond75 = icmp eq i64 %14, %wide.trip.count74
...
.lr.ph._crit_edge:                                ; preds = %.lr.ph, %12
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond6 = icmp eq i64 %indvars.iv.next, %8
  br i1 %exitcond6, label %._crit_edge.loopexit, label %.lr.ph
