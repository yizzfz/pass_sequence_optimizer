...
._crit_edge8:                                     ; preds = %14, %6
  %indvars.iv19 = phi i64 [ 0, %6 ], [ %indvars.iv.next20, %14 ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge8
  %indvars.iv16 = phi i64 [ 0, %._crit_edge8 ], [ %indvars.iv.next17, %._crit_edge ]
...
; <label>:14:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond21, label %._crit_edge10.preheader, label %._crit_edge8

._crit_edge10.preheader:                          ; preds = %14
  br label %._crit_edge10

._crit_edge10:                                    ; preds = %._crit_edge10.preheader, %28
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %28 ], [ 0, %._crit_edge10.preheader ]
  br label %._crit_edge9

._crit_edge9:                                     ; preds = %._crit_edge9, %._crit_edge10
  %indvars.iv10 = phi i64 [ 0, %._crit_edge10 ], [ %indvars.iv.next11.1, %._crit_edge9 ]
  ...
  br i1 %exitcond12.1, label %28, label %._crit_edge9

; <label>:28:                                     ; preds = %._crit_edge9
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 1100
  br i1 %exitcond15, label %._crit_edge12.preheader, label %._crit_edge10

._crit_edge12.preheader:                          ; preds = %28
  br label %._crit_edge12

._crit_edge12:                                    ; preds = %._crit_edge12.preheader, %37
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %37 ], [ 0, %._crit_edge12.preheader ]
  br label %._crit_edge11

._crit_edge11:                                    ; preds = %._crit_edge11, %._crit_edge12
  %indvars.iv4 = phi i64 [ 0, %._crit_edge12 ], [ %indvars.iv.next5, %._crit_edge11 ]
  ...
  br i1 %exitcond6, label %37, label %._crit_edge11

; <label>:37:                                     ; preds = %._crit_edge11
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %exitcond9 = icmp eq i64 %indvars.iv.next8, 900
  br i1 %exitcond9, label %._crit_edge14.preheader, label %._crit_edge12

._crit_edge14.preheader:                          ; preds = %37
  br label %._crit_edge14

._crit_edge14:                                    ; preds = %._crit_edge14.preheader, %45
  %indvars.iv1 = phi i64 [ %indvars.iv.next2, %45 ], [ 0, %._crit_edge14.preheader ]
  br label %._crit_edge13

._crit_edge13:                                    ; preds = %._crit_edge13, %._crit_edge14
  %indvars.iv = phi i64 [ 0, %._crit_edge14 ], [ %indvars.iv.next, %._crit_edge13 ]
  ...
  br i1 %exitcond, label %45, label %._crit_edge13

; <label>:45:                                     ; preds = %._crit_edge13
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 800
  br i1 %exitcond3, label %46, label %._crit_edge14
...
._crit_edge6:                                     ; preds = %24, %._crit_edge7
  %indvars.iv10 = phi i64 [ 0, %._crit_edge7 ], [ %indvars.iv.next11, %24 ]
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge6
  %indvars.iv7 = phi i64 [ 0, %._crit_edge6 ], [ %indvars.iv.next8.1, %._crit_edge ]
...
; <label>:25:                                     ; preds = %24
  ...
  br i1 %exitcond15, label %._crit_edge10.preheader, label %._crit_edge7

._crit_edge10.preheader:                          ; preds = %25
  br label %._crit_edge10

._crit_edge10:                                    ; preds = %._crit_edge10.preheader, %49
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %49 ], [ 0, %._crit_edge10.preheader ]
  br label %._crit_edge9

._crit_edge9:                                     ; preds = %48, %._crit_edge10
  %indvars.iv1 = phi i64 [ 0, %._crit_edge10 ], [ %indvars.iv.next2, %48 ]
...
; <label>:49:                                     ; preds = %48
  ...
  br i1 %exitcond6, label %50, label %._crit_edge10
