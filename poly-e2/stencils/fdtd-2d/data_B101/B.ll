...
for.inc:                                          ; preds = %for.inc, %entry
  ...
  %8 = insertelement <2 x double> undef, double %conv, i32 0
  %9 = insertelement <2 x double> %8, double %conv.1, i32 1
  ...
  %10 = bitcast double* %arrayidx.2 to <2 x double>*
  %inc.2 = add nsw i32 %inc12, 3
  %conv.3 = sitofp i32 %inc.2 to double
  %11 = insertelement <2 x double> undef, double %conv.2, i32 0
  %12 = insertelement <2 x double> %11, double %conv.3, i32 1
