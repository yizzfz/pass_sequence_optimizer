...
.preheader4:                                      ; preds = %.preheader4.preheader, %28
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %28 ], [ 0, %.preheader4.preheader ]
  br label %._crit_edge36

._crit_edge36:                                    ; preds = %._crit_edge36, %.preheader4
  %indvars.iv24 = phi i64 [ 0, %.preheader4 ], [ %indvars.iv.next25.1, %._crit_edge36 ]
  %indvars.iv.next25 = or i64 %indvars.iv24, 1
  %15 = mul nuw nsw i64 %indvars.iv.next25, %indvars.iv27
  %16 = trunc i64 %15 to i32
  %17 = srem i32 %16, 900
  %18 = sitofp i32 %17 to double
  %19 = getelementptr inbounds [900 x double], [900 x double]* %3, i64 %indvars.iv27, i64 %indvars.iv24
  %indvars.iv.next25.1 = add nsw i64 %indvars.iv24, 2
  %20 = mul nuw nsw i64 %indvars.iv.next25.1, %indvars.iv27
  ...
  br i1 %exitcond26.1, label %28, label %._crit_edge36

; <label>:28:                                     ; preds = %._crit_edge36
  %indvars.iv.next28 = add nuw nsw i64 %indvars.iv27, 1
  %exitcond29 = icmp eq i64 %indvars.iv.next28, 1100
  br i1 %exitcond29, label %.preheader2.preheader, label %.preheader4

.preheader2.preheader:                            ; preds = %28
  br label %.preheader2

.preheader2:                                      ; preds = %.preheader2.preheader, %37
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %37 ], [ 0, %.preheader2.preheader ]
  br label %._crit_edge37

._crit_edge37:                                    ; preds = %._crit_edge37, %.preheader2
  %indvars.iv18 = phi i64 [ 0, %.preheader2 ], [ %indvars.iv.next19, %._crit_edge37 ]
  %29 = add nuw nsw i64 %indvars.iv18, 3
  %30 = mul nuw nsw i64 %29, %indvars.iv21
  %31 = add nuw nsw i64 %30, 1
  %32 = trunc i64 %31 to i32
  %33 = srem i32 %32, 1200
  %34 = sitofp i32 %33 to double
  %35 = fdiv double %34, 1.200000e+03
  %36 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv21, i64 %indvars.iv18
  store double %35, double* %36, align 8
  %indvars.iv.next19 = add nuw nsw i64 %indvars.iv18, 1
  %exitcond20 = icmp eq i64 %indvars.iv.next19, 1200
  br i1 %exitcond20, label %37, label %._crit_edge37

; <label>:37:                                     ; preds = %._crit_edge37
...
.preheader:                                       ; preds = %.preheader.preheader, %45
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %45 ], [ 0, %.preheader.preheader ]
...
._crit_edge38:                                    ; preds = %._crit_edge38, %.preheader
  ...
  %39 = mul nuw nsw i64 %38, %indvars.iv15
  %40 = trunc i64 %39 to i32
  %41 = srem i32 %40, 1100
  %42 = sitofp i32 %41 to double
  %43 = fdiv double %42, 1.100000e+03
  %44 = getelementptr inbounds [1200 x double], [1200 x double]* %5, i64 %indvars.iv15, i64 %indvars.iv
  store double %43, double* %44, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1200
  br i1 %exitcond, label %45, label %._crit_edge38

; <label>:45:                                     ; preds = %._crit_edge38
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  %exitcond17 = icmp eq i64 %indvars.iv.next16, 800
  br i1 %exitcond17, label %46, label %.preheader
...
.preheader2:                                      ; preds = %25, %7
  %indvars.iv22 = phi i64 [ 0, %7 ], [ %indvars.iv.next23, %25 ]
  br label %._crit_edge25

._crit_edge25:                                    ; preds = %24, %.preheader2
  %indvars.iv18 = phi i64 [ 0, %.preheader2 ], [ %indvars.iv.next19, %24 ]
  %8 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv22, i64 %indvars.iv18
  store double 0.000000e+00, double* %8, align 8
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge25
  %9 = phi double [ 0.000000e+00, %._crit_edge25 ], [ %23, %._crit_edge ]
  %indvars.iv15 = phi i64 [ 0, %._crit_edge25 ], [ %indvars.iv.next16.1, %._crit_edge ]
  %10 = getelementptr inbounds [1100 x double], [1100 x double]* %3, i64 %indvars.iv22, i64 %indvars.iv15
  %11 = load double, double* %10, align 8
  %12 = fmul double %11, %0
  %13 = getelementptr inbounds [900 x double], [900 x double]* %4, i64 %indvars.iv15, i64 %indvars.iv18
  %14 = load double, double* %13, align 8
  %15 = fmul double %12, %14
  %16 = fadd double %9, %15
  store double %16, double* %8, align 8
  %indvars.iv.next16 = or i64 %indvars.iv15, 1
  %17 = getelementptr inbounds [1100 x double], [1100 x double]* %3, i64 %indvars.iv22, i64 %indvars.iv.next16
  %18 = load double, double* %17, align 8
  %19 = fmul double %18, %0
  %20 = getelementptr inbounds [900 x double], [900 x double]* %4, i64 %indvars.iv.next16, i64 %indvars.iv18
  %21 = load double, double* %20, align 8
  %22 = fmul double %19, %21
  %23 = fadd double %16, %22
  store double %23, double* %8, align 8
  %indvars.iv.next16.1 = add nsw i64 %indvars.iv15, 2
  %exitcond17.1 = icmp eq i64 %indvars.iv.next16.1, 1100
  br i1 %exitcond17.1, label %24, label %._crit_edge

; <label>:24:                                     ; preds = %._crit_edge
  %indvars.iv.next19 = add nuw nsw i64 %indvars.iv18, 1
  %exitcond20 = icmp eq i64 %indvars.iv.next19, 900
  br i1 %exitcond20, label %25, label %._crit_edge25

; <label>:25:                                     ; preds = %24
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  %exitcond24 = icmp eq i64 %indvars.iv.next23, 800
  br i1 %exitcond24, label %.preheader.preheader, label %.preheader2

.preheader.preheader:                             ; preds = %25
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %43
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %43 ], [ 0, %.preheader.preheader ]
  br label %._crit_edge27

._crit_edge27:                                    ; preds = %42, %.preheader
  %indvars.iv9 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next10, %42 ]
...
._crit_edge26:                                    ; preds = %._crit_edge26, %._crit_edge27
  %29 = phi double [ %28, %._crit_edge27 ], [ %41, %._crit_edge26 ]
  %indvars.iv = phi i64 [ 0, %._crit_edge27 ], [ %indvars.iv.next.1, %._crit_edge26 ]
  ...
  br i1 %exitcond.1, label %42, label %._crit_edge26

; <label>:42:                                     ; preds = %._crit_edge26
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  %exitcond11 = icmp eq i64 %indvars.iv.next10, 1200
  br i1 %exitcond11, label %43, label %._crit_edge27

; <label>:43:                                     ; preds = %42
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %exitcond14 = icmp eq i64 %indvars.iv.next13, 800
  br i1 %exitcond14, label %44, label %.preheader
