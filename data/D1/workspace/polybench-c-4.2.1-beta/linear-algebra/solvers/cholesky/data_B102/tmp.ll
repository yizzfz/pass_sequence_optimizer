...
.preheader13:                                     ; preds = %._crit_edge
  ...
  br i1 %10, label %.lr.ph39.preheader, label %._crit_edge40
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph36
  ...
  %17 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv85, i64 %indvars.iv69
...
._crit_edge40:                                    ; preds = %.preheader13, %.lr.ph39.preheader
  ...
  br i1 %exitcond96, label %._crit_edge42, label %.lr.ph36
...
.preheader12.us.prol:                             ; preds = %.preheader12.us.prol, %.preheader12.us.prol.preheader
  %indvars.iv65.prol = phi i64 [ 0, %.preheader12.us.prol.preheader ], [ %indvars.iv.next66.prol, %.preheader12.us.prol ]
  %prol.iter149 = phi i64 [ 0, %.preheader12.us.prol.preheader ], [ %prol.iter149.sub, %.preheader12.us.prol ]
  ...
  br i1 %prol.iter149.cmp, label %.preheader12.us.prol.loopexit.unr-lcssa, label %.preheader12.us.prol, !llvm.loop !1
...
.preheader12.us:                                  ; preds = %.preheader12.us, %._crit_edge42.new
  %indvars.iv65 = phi i64 [ 0, %._crit_edge42.new ], [ %indvars.iv.next66.7, %.preheader12.us ]
  ...
  br i1 %exitcond94.7, label %.preheader10.lr.ph.unr-lcssa, label %.preheader12.us

.preheader10.lr.ph.unr-lcssa:                     ; preds = %.preheader12.us
  br label %.preheader10.lr.ph

.preheader10.lr.ph:                               ; preds = %.preheader12.us.prol.loopexit, %.preheader10.lr.ph.unr-lcssa
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %57 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %53, i64 %indvars.iv57
  %58 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %54, i64 %indvars.iv57
  %59 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %55, i64 %indvars.iv57
  ...
  %wide.load113 = load <2 x double>, <2 x double>* %73, align 8, !alias.scope !8, !noalias !10
  %74 = fadd <2 x double> %wide.load, %68
  %75 = fadd <2 x double> %wide.load113, %69
...
.preheader.us:                                    ; preds = %._crit_edge.us, %.preheader.us.preheader
  ...
  %scevgep127 = getelementptr i8, i8* %19, i64 %93
  %94 = add i64 16000, %93
  %scevgep128 = getelementptr i8, i8* %19, i64 %94
...
vector.body114:                                   ; preds = %vector.body114.preheader, %vector.body114
  ...
  %95 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv45, i64 %index135
  %96 = bitcast double* %95 to <2 x i64>*
  %wide.load143 = load <2 x i64>, <2 x i64>* %96, align 8, !alias.scope !15
  %97 = getelementptr double, double* %95, i64 2
  %98 = bitcast double* %97 to <2 x i64>*
  %wide.load144 = load <2 x i64>, <2 x i64>* %98, align 8, !alias.scope !15
  %99 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv45, i64 %index135
  %100 = bitcast double* %99 to <2 x i64>*
  store <2 x i64> %wide.load143, <2 x i64>* %100, align 8, !alias.scope !18, !noalias !15
  %101 = getelementptr double, double* %99, i64 2
  %102 = bitcast double* %101 to <2 x i64>*
  store <2 x i64> %wide.load144, <2 x i64>* %102, align 8, !alias.scope !18, !noalias !15
  %index.next136 = add i64 %index135, 4
  %103 = icmp eq i64 %index.next136, 2000
  br i1 %103, label %middle.block115, label %vector.body114, !llvm.loop !20
...
._crit_edge98.prol.loopexit:                      ; preds = %._crit_edge98.preheader, %._crit_edge98.prol.loopexit.unr-lcssa
  ...
  br i1 %110, label %._crit_edge.us.loopexit, label %._crit_edge98.preheader.new
...
.preheader4:                                      ; preds = %._crit_edge9, %.preheader4.preheader
  %indvars.iv48 = phi i2 [ %indvars.iv.next49, %._crit_edge9 ], [ 0, %.preheader4.preheader ]
...
.preheader3.._crit_edge9_crit_edge:               ; preds = %.preheader4
  %.phi.trans.insert34 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv25, i64 %indvars.iv25
...
.lr.ph8:                                          ; preds = %._crit_edge
  ...
  %xtraiter42 = and i64 %indvars.iv25, 3
  %lcmp.mod43 = icmp eq i64 %xtraiter42, 0
  br i1 %lcmp.mod43, label %._crit_edge31.prol.loopexit, label %._crit_edge31.prol.preheader
...
._crit_edge31.prol:                               ; preds = %._crit_edge31.prol, %._crit_edge31.prol.preheader
  ...
  %prol.iter = phi i64 [ %xtraiter42, %._crit_edge31.prol.preheader ], [ %prol.iter.sub, %._crit_edge31.prol ]
...
._crit_edge31.prol.loopexit:                      ; preds = %.lr.ph8, %._crit_edge31.prol.loopexit.unr-lcssa
  %.lcssa41.unr = phi double [ undef, %.lr.ph8 ], [ %12, %._crit_edge31.prol.loopexit.unr-lcssa ]
  %.unr44 = phi double [ %.pre33, %.lr.ph8 ], [ %12, %._crit_edge31.prol.loopexit.unr-lcssa ]
...
._crit_edge31:                                    ; preds = %._crit_edge31, %.lr.ph8.new
  %39 = phi double [ %.unr44, %.lr.ph8.new ], [ %55, %._crit_edge31 ]
...
._crit_edge9.loopexit:                            ; preds = %._crit_edge31.prol.loopexit, %._crit_edge9.loopexit.unr-lcssa
  %.lcssa41 = phi double [ %.lcssa41.unr, %._crit_edge31.prol.loopexit ], [ %55, %._crit_edge9.loopexit.unr-lcssa ]
  br label %._crit_edge9

._crit_edge9:                                     ; preds = %._crit_edge9.loopexit, %.preheader3.._crit_edge9_crit_edge
  %.pre-phi36 = phi double* [ %.phi.trans.insert34, %.preheader3.._crit_edge9_crit_edge ], [ %7, %._crit_edge9.loopexit ]
  %56 = phi double [ %.pre35, %.preheader3.._crit_edge9_crit_edge ], [ %.lcssa41, %._crit_edge9.loopexit ]
  %57 = tail call double @sqrt(double %56) #3
  store double %57, double* %.pre-phi36, align 8
