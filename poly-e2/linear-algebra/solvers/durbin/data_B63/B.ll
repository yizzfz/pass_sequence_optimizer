...
for.inc:                                          ; preds = %for.inc.for.inc_crit_edge, %entry
  %indvars.iv = phi i64 [ 0, %entry ], [ %indvars.iv.next.4, %for.inc.for.inc_crit_edge ]
  ...
  br i1 %exitcond.4, label %for.end, label %for.inc.for.inc_crit_edge
...
for.inc.lr.ph:                                    ; preds = %for.inc47.for.inc.lr.ph_crit_edge, %entry
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc47.for.inc.lr.ph_crit_edge ], [ 1, %entry ]
  %indvar = phi i64 [ %indvar.next, %for.inc47.for.inc.lr.ph_crit_edge ], [ 0, %entry ]
...
for.inc.prol:                                     ; preds = %for.inc.prol.for.inc.prol_crit_edge, %for.inc.prol.preheader
  ...
  br i1 %prol.iter.cmp, label %for.inc.prol.loopexit.loopexit, label %for.inc.prol.for.inc.prol_crit_edge, !llvm.loop !1
...
for.inc.prol.loopexit:                            ; preds = %for.inc.lr.ph.for.inc.prol.loopexit_crit_edge, %for.inc.prol.loopexit.loopexit
  %indvars.iv.unr = phi i64 [ 0, %for.inc.lr.ph.for.inc.prol.loopexit_crit_edge ], [ %indvars.iv.next.prol, %for.inc.prol.loopexit.loopexit ]
  %sum.02.unr = phi double [ 0.000000e+00, %for.inc.lr.ph.for.inc.prol.loopexit_crit_edge ], [ %add.prol, %for.inc.prol.loopexit.loopexit ]
  %add.lcssa.unr = phi double [ undef, %for.inc.lr.ph.for.inc.prol.loopexit_crit_edge ], [ %add.prol, %for.inc.prol.loopexit.loopexit ]
  %14 = icmp ult i64 %indvar, 3
  br i1 %14, label %for.inc.prol.loopexit.for.inc32.lr.ph_crit_edge, label %for.inc.preheader

for.inc.prol.loopexit.for.inc32.lr.ph_crit_edge:  ; preds = %for.inc.prol.loopexit
...
for.inc:                                          ; preds = %for.inc.for.inc_crit_edge, %for.inc.preheader
  ...
  br i1 %exitcond.3, label %for.inc32.lr.ph.loopexit, label %for.inc.for.inc_crit_edge
...
for.inc32.lr.ph:                                  ; preds = %for.inc.prol.loopexit.for.inc32.lr.ph_crit_edge, %for.inc32.lr.ph.loopexit
  %sum.0.lcssa = phi double [ %add.lcssa.unr, %for.inc.prol.loopexit.for.inc32.lr.ph_crit_edge ], [ %add.3, %for.inc32.lr.ph.loopexit ]
  ...
  br i1 %lcmp.mod35, label %for.inc32.prol, label %for.inc32.lr.ph.for.inc32.prol.loopexit_crit_edge

for.inc32.lr.ph.for.inc32.prol.loopexit_crit_edge: ; preds = %for.inc32.lr.ph
...
for.inc32.prol:                                   ; preds = %for.inc32.lr.ph
  ...
  %sunkaddr39 = add i64 %3, %sunkaddr38
  %sunkaddr40 = add i64 %sunkaddr39, -8
  %sunkaddr41 = inttoptr i64 %sunkaddr40 to double*
  %29 = load double, double* %sunkaddr41, align 8
  %mul28.prol = fmul double %div, %29
  %add29.prol = fadd double %28, %mul28.prol
  store double %add29.prol, double* %2, align 16
  br label %for.inc32.prol.loopexit

for.inc32.prol.loopexit:                          ; preds = %for.inc32.lr.ph.for.inc32.prol.loopexit_crit_edge, %for.inc32.prol
  %indvars.iv14.unr.ph = phi i64 [ 1, %for.inc32.prol ], [ 0, %for.inc32.lr.ph.for.inc32.prol.loopexit_crit_edge ]
  %30 = icmp eq i64 %indvar, 0
  br i1 %30, label %for.inc32.prol.loopexit.for.inc47_crit_edge, label %for.inc32.preheader

for.inc32.prol.loopexit.for.inc47_crit_edge:      ; preds = %for.inc32.prol.loopexit
  br label %for.inc47
...
for.inc32.preheader:                              ; preds = %for.inc32.prol.loopexit
  ...
  br i1 %min.iters.check, label %for.inc32.preheader.for.inc32.preheader9_crit_edge, label %min.iters.checked

for.inc32.preheader.for.inc32.preheader9_crit_edge: ; preds = %for.inc32.preheader
  br label %for.inc32.preheader9
...
min.iters.checked:                                ; preds = %for.inc32.preheader
  ...
  br i1 %cmp.zero, label %min.iters.checked.for.inc32.preheader9_crit_edge, label %vector.ph

min.iters.checked.for.inc32.preheader9_crit_edge: ; preds = %min.iters.checked
  br label %for.inc32.preheader9
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.ph
  ...
  %strided.vec1 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  ...
  %wide.vec2 = load <4 x double>, <4 x double>* %44, align 8
  %strided.vec3 = shufflevector <4 x double> %wide.vec2, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %reverse = shufflevector <2 x double> %strided.vec3, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %strided.vec4 = shufflevector <4 x double> %wide.vec2, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %reverse5 = shufflevector <2 x double> %strided.vec4, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %45 = fmul <2 x double> %broadcast.splat7, %reverse5
  %46 = fadd <2 x double> %strided.vec, %45
  %47 = add nuw nsw i64 %offset.idx, 1
  %48 = fmul <2 x double> %broadcast.splat7, %reverse
  %49 = fadd <2 x double> %strided.vec1, %48
  ...
  br i1 %53, label %middle.block, label %vector.body.vector.body_crit_edge, !llvm.loop !3
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %middle.block.for.inc47_crit_edge, label %middle.block.for.inc32.preheader9_crit_edge

middle.block.for.inc32.preheader9_crit_edge:      ; preds = %middle.block
  br label %for.inc32.preheader9

middle.block.for.inc47_crit_edge:                 ; preds = %middle.block
  br label %for.inc47

for.inc32.preheader9:                             ; preds = %middle.block.for.inc32.preheader9_crit_edge, %min.iters.checked.for.inc32.preheader9_crit_edge, %for.inc32.preheader.for.inc32.preheader9_crit_edge
  %indvars.iv14.ph = phi i64 [ %indvars.iv14.unr.ph, %min.iters.checked.for.inc32.preheader9_crit_edge ], [ %indvars.iv14.unr.ph, %for.inc32.preheader.for.inc32.preheader9_crit_edge ], [ %ind.end, %middle.block.for.inc32.preheader9_crit_edge ]
...
for.inc32:                                        ; preds = %for.inc32.for.inc32_crit_edge, %for.inc32.preheader9
  %indvars.iv14 = phi i64 [ %indvars.iv.next15.1, %for.inc32.for.inc32_crit_edge ], [ %indvars.iv14.ph, %for.inc32.preheader9 ]
  ...
  br i1 %exitcond20.1, label %for.inc47.loopexit, label %for.inc32.for.inc32_crit_edge, !llvm.loop !6
...
for.inc47:                                        ; preds = %middle.block.for.inc47_crit_edge, %for.inc32.prol.loopexit.for.inc47_crit_edge, %for.inc47.loopexit
  ...
  br i1 %exitcond33, label %for.end49, label %for.inc47.for.inc.lr.ph_crit_edge
