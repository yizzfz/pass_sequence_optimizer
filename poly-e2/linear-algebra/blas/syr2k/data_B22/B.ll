...
entry:
  ...
  call fastcc void @init_array(i32 1200, i32 1000, double* nonnull %alpha, double* nonnull %beta, [1200 x double]* %arraydecay1, [1000 x double]* %arraydecay32, [1000 x double]* %arraydecay43)
  tail call void (...) @polybench_timer_start() #4
  %0 = load double, double* %alpha, align 8
  %1 = load double, double* %beta, align 8
  tail call fastcc void @kernel_syr2k(i32 1200, i32 1000, double %0, double %1, [1200 x double]* %arraydecay1, [1000 x double]* %arraydecay32, [1000 x double]* %arraydecay43)
...
for.inc.us:                                       ; preds = %for.inc.us, %for.inc.us.prol.loopexit.for.inc.us_crit_edge
  %indvars.iv = phi i64 [ %indvars.iv.unr, %for.inc.us.prol.loopexit.for.inc.us_crit_edge ], [ %indvars.iv.next.3, %for.inc.us ]
...
for.cond9.preheader.us12:                         ; preds = %for.cond9.for.inc40_crit_edge.us35, %for.cond9.preheader.us12.preheader
  ...
  br i1 %10, label %for.inc37.us14.preheader, label %min.iters.checked

min.iters.checked:                                ; preds = %for.cond9.preheader.us12
  %12 = icmp eq i64 %n.vec, 0
  br i1 %12, label %for.inc37.us14.preheader, label %vector.memcheck
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %13 = or i64 %index, 1
  %14 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %index, i64 %indvars.iv47
  %15 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %13, i64 %indvars.iv47
  %16 = load double, double* %14, align 8, !alias.scope !1
  %17 = load double, double* %15, align 8, !alias.scope !1
  %18 = insertelement <2 x double> undef, double %16, i32 0
  %19 = insertelement <2 x double> %18, double %17, i32 1
  %20 = fmul <2 x double> %19, %broadcast.splat100
  %21 = load double, double* %arrayidx20.us33, align 8, !alias.scope !4
  ...
  %25 = getelementptr inbounds [1000 x double], [1000 x double]* %B, i64 %index, i64 %indvars.iv47
  %26 = getelementptr inbounds [1000 x double], [1000 x double]* %B, i64 %13, i64 %indvars.iv47
  %27 = load double, double* %25, align 8, !alias.scope !6
  %28 = load double, double* %26, align 8, !alias.scope !6
  %29 = insertelement <2 x double> undef, double %27, i32 0
  %30 = insertelement <2 x double> %29, double %28, i32 1
  %31 = fmul <2 x double> %30, %broadcast.splat100
  %32 = load double, double* %arrayidx30.us34, align 8, !alias.scope !8
  ...
  %37 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv54, i64 %index
  %38 = bitcast double* %37 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %38, align 8, !alias.scope !10, !noalias !12
  %39 = fadd <2 x double> %wide.load, %36
  %40 = bitcast double* %37 to <2 x double>*
  store <2 x double> %39, <2 x double>* %40, align 8, !alias.scope !10, !noalias !12
  %index.next = add i64 %index, 2
  %41 = icmp eq i64 %index.next, %n.vec
  br i1 %41, label %middle.block, label %vector.body, !llvm.loop !13

middle.block:                                     ; preds = %vector.body
  %42 = icmp eq i64 %50, %n.vec
  br i1 %42, label %for.cond9.for.inc40_crit_edge.us35, label %for.inc37.us14.preheader

for.inc37.us14.preheader:                         ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.cond9.preheader.us12
  %indvars.iv42.ph = phi i64 [ 0, %for.cond9.preheader.us12 ], [ 0, %min.iters.checked ], [ 0, %vector.memcheck ], [ %n.vec, %middle.block ]
...
for.inc37.us14:                                   ; preds = %for.inc37.us14, %for.inc37.us14.preheader
  ...
  %43 = load double, double* %arrayidx15.us17, align 8
  %mul16.us18 = fmul double %43, %alpha
  %44 = load double, double* %arrayidx20.us33, align 8
  %mul21.us19 = fmul double %mul16.us18, %44
  %arrayidx25.us20 = getelementptr inbounds [1000 x double], [1000 x double]* %B, i64 %indvars.iv42, i64 %indvars.iv47
  %45 = load double, double* %arrayidx25.us20, align 8
  %mul26.us21 = fmul double %45, %alpha
  %46 = load double, double* %arrayidx30.us34, align 8
  %mul31.us22 = fmul double %mul26.us21, %46
  ...
  %47 = load double, double* %arrayidx35.us24, align 8
  %add36.us25 = fadd double %47, %add.us23
...
for.inc.lr.ph.us:                                 ; preds = %for.cond6.for.inc43_crit_edge.us.for.inc.lr.ph.us_crit_edge, %for.inc.lr.ph.us.preheader
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.cond6.for.inc43_crit_edge.us.for.inc.lr.ph.us_crit_edge ], [ 0, %for.inc.lr.ph.us.preheader ]
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.cond6.for.inc43_crit_edge.us.for.inc.lr.ph.us_crit_edge ], [ 1, %for.inc.lr.ph.us.preheader ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv54, i64 0
  %48 = mul i64 %indvars.iv54, 1201
  %49 = add i64 %48, 1
  %scevgep75 = getelementptr [1200 x double], [1200 x double]* %C, i64 0, i64 %49
  %50 = add i64 %indvars.iv54, 1
  %indvars.iv.next55 = add nuw nsw i64 %indvars.iv54, 1
  %51 = trunc i64 %indvars.iv.next55 to i32
...
for.inc.us.prol:                                  ; preds = %for.inc.us.prol, %for.inc.lr.ph.us.for.inc.us.prol_crit_edge
  ...
  %52 = load double, double* %arrayidx5.us.prol, align 8
  %mul.us.prol = fmul double %52, %beta
...
for.inc.us.prol.loopexit:                         ; preds = %for.inc.us.prol.loopexit.loopexit, %for.inc.lr.ph.us
  ...
  %53 = icmp ult i64 %indvars.iv54, 3
  br i1 %53, label %for.cond9.preheader.us12.preheader, label %for.inc.us.prol.loopexit.for.inc.us_crit_edge
...
for.inc.lr.ph:                                    ; preds = %for.inc43.for.inc.lr.ph_crit_edge, %for.inc.lr.ph.preheader
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.inc43.for.inc.lr.ph_crit_edge ], [ 0, %for.inc.lr.ph.preheader ]
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc43.for.inc.lr.ph_crit_edge ], [ 1, %for.inc.lr.ph.preheader ]
  %indvars.iv.next69 = add nuw nsw i64 %indvars.iv68, 1
  %54 = trunc i64 %indvars.iv.next69 to i32
  %xtraiter63 = and i32 %54, 3
  %lcmp.mod64 = icmp eq i32 %xtraiter63, 0
  br i1 %lcmp.mod64, label %for.inc.prol.loopexit, label %for.inc.lr.ph.for.inc.prol_crit_edge

for.inc.lr.ph.for.inc.prol_crit_edge:             ; preds = %for.inc.lr.ph
  br label %for.inc.prol

for.inc.prol:                                     ; preds = %for.inc.prol, %for.inc.lr.ph.for.inc.prol_crit_edge
  %indvars.iv58.prol = phi i64 [ 0, %for.inc.lr.ph.for.inc.prol_crit_edge ], [ %indvars.iv.next59.prol, %for.inc.prol ]
  %prol.iter65 = phi i32 [ %xtraiter63, %for.inc.lr.ph.for.inc.prol_crit_edge ], [ %prol.iter65.sub, %for.inc.prol ]
  %arrayidx5.prol = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv68, i64 %indvars.iv58.prol
  %55 = load double, double* %arrayidx5.prol, align 8
  %mul.prol = fmul double %55, %beta
...
for.inc.prol.loopexit:                            ; preds = %for.inc.prol.loopexit.loopexit, %for.inc.lr.ph
  ...
  %56 = icmp ult i64 %indvars.iv68, 3
  br i1 %56, label %for.inc43, label %for.inc.prol.loopexit.for.inc_crit_edge

for.inc.prol.loopexit.for.inc_crit_edge:          ; preds = %for.inc.prol.loopexit
  br label %for.inc

for.inc:                                          ; preds = %for.inc, %for.inc.prol.loopexit.for.inc_crit_edge
  %indvars.iv58 = phi i64 [ %indvars.iv58.unr, %for.inc.prol.loopexit.for.inc_crit_edge ], [ %indvars.iv.next59.3, %for.inc ]
  %arrayidx5 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv68, i64 %indvars.iv58
  %57 = bitcast double* %arrayidx5 to <2 x double>*
  %58 = load <2 x double>, <2 x double>* %57, align 8
  %mul = fmul <2 x double> %58, %mul.v.i1.2
  %59 = bitcast double* %arrayidx5 to <2 x double>*
  store <2 x double> %mul, <2 x double>* %59, align 8
  ...
  %60 = bitcast double* %arrayidx5.2 to <2 x double>*
  %61 = load <2 x double>, <2 x double>* %60, align 8
  %mul.2 = fmul <2 x double> %61, %mul.2.v.i1.2
  %62 = bitcast double* %arrayidx5.2 to <2 x double>*
  store <2 x double> %mul.2, <2 x double>* %62, align 8
...
for.inc43:                                        ; preds = %for.inc43.loopexit, %for.inc.prol.loopexit
  ...
  br i1 %exitcond71, label %for.end45.loopexit101, label %for.inc43.for.inc.lr.ph_crit_edge
