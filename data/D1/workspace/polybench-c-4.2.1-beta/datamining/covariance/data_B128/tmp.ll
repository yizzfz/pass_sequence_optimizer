...
; <label>:15:                                     ; preds = %12
  call fastcc void @print_array([1200 x double]* %9)
  br label %._crit_edge
...
.lr.ph24.split.us:                                ; preds = %._crit_edge21.us, %.lr.ph24.split.us.preheader
  %indvars.iv67 = phi i64 [ 0, %.lr.ph24.split.us.preheader ], [ %indvars.iv.next68, %._crit_edge21.us ]
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv67
  store double 0.000000e+00, double* %5, align 8
  %sunkaddr96 = shl i64 %indvars.iv67, 3
  %sunkaddr97 = add i64 %4, %sunkaddr96
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph24.split.us
  ...
  %indvars.iv63 = phi i64 [ 0, %.lr.ph24.split.us ], [ %indvars.iv.next64.4, %._crit_edge ]
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv63, i64 %indvars.iv67
  %8 = load double, double* %7, align 8
  %9 = fadd double %6, %8
  store double %9, double* %sunkaddr98, align 8
  %indvars.iv.next64 = add nuw nsw i64 %indvars.iv63, 1
  %10 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next64, i64 %indvars.iv67
  %11 = load double, double* %10, align 8
  %12 = fadd double %9, %11
  store double %12, double* %sunkaddr98, align 8
  %indvars.iv.next64.1 = add nuw nsw i64 %indvars.iv63, 2
  %13 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next64.1, i64 %indvars.iv67
  %14 = load double, double* %13, align 8
  %15 = fadd double %12, %14
  store double %15, double* %sunkaddr98, align 8
  %indvars.iv.next64.2 = add nuw nsw i64 %indvars.iv63, 3
  %16 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next64.2, i64 %indvars.iv67
  %17 = load double, double* %16, align 8
  %18 = fadd double %15, %17
  store double %18, double* %sunkaddr98, align 8
  %indvars.iv.next64.3 = add nuw nsw i64 %indvars.iv63, 4
  %19 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next64.3, i64 %indvars.iv67
  %20 = load double, double* %19, align 8
  %21 = fadd double %18, %20
  store double %21, double* %sunkaddr98, align 8
  %indvars.iv.next64.4 = add nuw nsw i64 %indvars.iv63, 5
  %exitcond66.4 = icmp eq i64 %indvars.iv.next64.4, 1400
  br i1 %exitcond66.4, label %._crit_edge21.us, label %._crit_edge

._crit_edge21.us:                                 ; preds = %._crit_edge
  %22 = fdiv double %21, %0
  store double %22, double* %sunkaddr98, align 8
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  %exitcond70 = icmp eq i64 %indvars.iv.next68, 1200
  br i1 %exitcond70, label %._crit_edge21.us..preheader6.us_crit_edge, label %.lr.ph24.split.us

._crit_edge21.us..preheader6.us_crit_edge:        ; preds = %._crit_edge21.us
  %scevgep16 = getelementptr double, double* %3, i64 1200
  br label %vector.memcheck

vector.memcheck:                                  ; preds = %._crit_edge16.us, %._crit_edge21.us..preheader6.us_crit_edge
  %indvars.iv58 = phi i64 [ 0, %._crit_edge21.us..preheader6.us_crit_edge ], [ %23, %._crit_edge16.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv58, i64 0
  %23 = add nuw nsw i64 %indvars.iv58, 1
  %scevgep14 = getelementptr [1200 x double], [1200 x double]* %1, i64 %23, i64 0
  %bound0 = icmp ult double* %scevgep, %scevgep16
  %bound1 = icmp ugt double* %scevgep14, %3
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv58, i64 %offset.idx
  %27 = bitcast double* %26 to <8 x double>*
  %wide.vec21 = load <8 x double>, <8 x double>* %27, align 8, !alias.scope !4, !noalias !1
  %28 = fsub <8 x double> %wide.vec21, %wide.vec
  ...
  %33 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv58, i64 %32
  ...
  br i1 %39, label %._crit_edge16.us.loopexit33, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv54 = phi i64 [ %indvars.iv.next55.3, %scalar.ph ], [ 0, %scalar.ph.preheader ]
  %40 = getelementptr inbounds double, double* %3, i64 %indvars.iv54
  %41 = load double, double* %40, align 8
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv58, i64 %indvars.iv54
  %43 = load double, double* %42, align 8
  %44 = fsub double %43, %41
  store double %44, double* %42, align 8
  %indvars.iv.next55 = or i64 %indvars.iv54, 1
  %45 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next55
  %46 = load double, double* %45, align 8
  %47 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv58, i64 %indvars.iv.next55
  %48 = load double, double* %47, align 8
  %49 = fsub double %48, %46
  store double %49, double* %47, align 8
  %indvars.iv.next55.1 = or i64 %indvars.iv54, 2
  %50 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next55.1
  %51 = load double, double* %50, align 8
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv58, i64 %indvars.iv.next55.1
  %53 = load double, double* %52, align 8
  %54 = fsub double %53, %51
  store double %54, double* %52, align 8
  %indvars.iv.next55.2 = or i64 %indvars.iv54, 3
  %55 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next55.2
  %56 = load double, double* %55, align 8
  %57 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv58, i64 %indvars.iv.next55.2
  %58 = load double, double* %57, align 8
  %59 = fsub double %58, %56
  store double %59, double* %57, align 8
  %indvars.iv.next55.3 = add nuw nsw i64 %indvars.iv54, 4
  %exitcond57.3 = icmp eq i64 %indvars.iv.next55.3, 1200
  br i1 %exitcond57.3, label %._crit_edge16.us.loopexit, label %scalar.ph, !llvm.loop !9

._crit_edge16.us.loopexit:                        ; preds = %scalar.ph
  br label %._crit_edge16.us

._crit_edge16.us.loopexit33:                      ; preds = %vector.body
  br label %._crit_edge16.us

._crit_edge16.us:                                 ; preds = %._crit_edge16.us.loopexit33, %._crit_edge16.us.loopexit
  %exitcond61 = icmp eq i64 %23, 1400
  br i1 %exitcond61, label %.preheader.us.preheader, label %vector.memcheck
...
.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph10.us
  ...
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv40, i64 %indvars.iv36
  store double 0.000000e+00, double* %61, align 8
  br label %._crit_edge27

._crit_edge.us.us:                                ; preds = %._crit_edge27
  %62 = fdiv double %76, %60
  store double %62, double* %61, align 8
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv36, i64 %indvars.iv40
...
._crit_edge27:                                    ; preds = %._crit_edge27, %.lr.ph.us.us
  %64 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %76, %._crit_edge27 ]
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %._crit_edge27 ]
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv40
  ...
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv40
  ...
  br i1 %exitcond.1, label %._crit_edge.us.us, label %._crit_edge27
