...
@__llvm_prf_nm = private constant [27 x i8] c"\19\00BF_options\01BF_ecb_encrypt", section "__llvm_prf_names"
@llvm.used = appending global [3 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_BF_options to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_BF_ecb_encrypt to i8*), i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
