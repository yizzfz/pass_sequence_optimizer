...
@__llvm_prf_nm = private constant [42 x i8] c"\22(x\DAK\CA\CD\C8\8C\CF\CC\CB,aL\CA\C8\CD\8CO\CEIM\CC+-`L\02\09\17\A7&\16%g\00\00\E3\DA\0D\12", section "__llvm_prf_names"
@llvm.used = appending global [4 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_bmhi_init to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_bhmi_cleanup to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_bmhi_search to i8*), i8* getelementptr inbounds ([42 x i8], [42 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
