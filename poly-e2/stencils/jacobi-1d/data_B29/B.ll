...
for.body.us.preheader:                            ; preds = %for.body.lr.ph
  ...
  %scevgep105 = getelementptr double, double* %A, i64 1999
  %scevgep107 = getelementptr double, double* %B, i64 2000
  %scevgep141 = getelementptr double, double* %B, i64 1
  %scevgep144 = getelementptr double, double* %B, i64 1999
  %scevgep146 = getelementptr double, double* %A, i64 2000
...
for.body.us:                                      ; preds = %for.body.us.preheader, %for.inc33.us
  ...
  br i1 false, label %for.body.us.for.body3.us.preheader_crit_edge, label %min.iters.checked136

for.body.us.for.body3.us.preheader_crit_edge:     ; preds = %for.body.us
  br label %for.body3.us.preheader

for.body3.us.preheader:                           ; preds = %min.iters.checked136.for.body3.us.preheader_crit_edge, %for.body.us.for.body3.us.preheader_crit_edge, %middle.block132, %vector.memcheck152
  %indvars.iv.ph = phi i64 [ 1, %vector.memcheck152 ], [ undef, %min.iters.checked136.for.body3.us.preheader_crit_edge ], [ undef, %for.body.us.for.body3.us.preheader_crit_edge ], [ 1997, %middle.block132 ]
  br label %for.body3.us

min.iters.checked136:                             ; preds = %for.body.us
  br i1 false, label %min.iters.checked136.for.body3.us.preheader_crit_edge, label %vector.memcheck152

min.iters.checked136.for.body3.us.preheader_crit_edge: ; preds = %min.iters.checked136
  br label %for.body3.us.preheader

vector.memcheck152:                               ; preds = %min.iters.checked136
  br i1 %found.conflict150, label %for.body3.us.preheader, label %vector.body131.preheader
...
vector.body131:                                   ; preds = %vector.body131.preheader, %vector.body131
  ...
  %0 = getelementptr inbounds double, double* %A, i64 %index154
  %1 = bitcast double* %0 to <2 x double>*
  %wide.load164 = load <2 x double>, <2 x double>* %1, align 8, !alias.scope !1
  %2 = getelementptr double, double* %0, i64 2
  %3 = bitcast double* %2 to <2 x double>*
  %wide.load165 = load <2 x double>, <2 x double>* %3, align 8, !alias.scope !1
  %4 = getelementptr inbounds double, double* %A, i64 %offset.idx159
  %5 = bitcast double* %4 to <2 x double>*
  %wide.load166 = load <2 x double>, <2 x double>* %5, align 8, !alias.scope !1
  %6 = getelementptr double, double* %4, i64 2
  %7 = bitcast double* %6 to <2 x double>*
  %wide.load167 = load <2 x double>, <2 x double>* %7, align 8, !alias.scope !1
  %8 = fadd <2 x double> %wide.load164, %wide.load166
  %9 = fadd <2 x double> %wide.load165, %wide.load167
  %10 = add nuw nsw i64 %offset.idx159, 1
  %11 = getelementptr inbounds double, double* %A, i64 %10
  %12 = getelementptr double, double* %11, i64 2
  %13 = bitcast double* %12 to <2 x double>*
  %wide.load169 = load <2 x double>, <2 x double>* %13, align 8, !alias.scope !1
  %14 = fadd <2 x double> %8, %wide.load165
  %15 = fadd <2 x double> %9, %wide.load169
  ...
  %18 = getelementptr inbounds double, double* %B, i64 %offset.idx159
  ...
  %22 = icmp eq i64 %index.next155, 1996
  br i1 %22, label %middle.block132, label %vector.body131, !llvm.loop !6

middle.block132:                                  ; preds = %vector.body131
  br i1 false, label %middle.block132.for.body16.us.preheader_crit_edge, label %for.body3.us.preheader

middle.block132.for.body16.us.preheader_crit_edge: ; preds = %middle.block132
...
for.body16.us:                                    ; preds = %for.body16.us.preheader170, %for.body16.us
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.body16.us ], [ %indvars.iv65.ph, %for.body16.us.preheader170 ]
...
for.body16.us.preheader:                          ; preds = %middle.block132.for.body16.us.preheader_crit_edge, %for.body16.us.preheader.loopexit
  br i1 false, label %for.body16.us.preheader.for.body16.us.preheader170_crit_edge, label %min.iters.checked97

for.body16.us.preheader.for.body16.us.preheader170_crit_edge: ; preds = %for.body16.us.preheader
  br label %for.body16.us.preheader170

for.body16.us.preheader170:                       ; preds = %min.iters.checked97.for.body16.us.preheader170_crit_edge, %for.body16.us.preheader.for.body16.us.preheader170_crit_edge, %middle.block93, %vector.memcheck113
  %indvars.iv65.ph = phi i64 [ 1, %vector.memcheck113 ], [ undef, %min.iters.checked97.for.body16.us.preheader170_crit_edge ], [ undef, %for.body16.us.preheader.for.body16.us.preheader170_crit_edge ], [ 1997, %middle.block93 ]
  br label %for.body16.us

min.iters.checked97:                              ; preds = %for.body16.us.preheader
  br i1 false, label %min.iters.checked97.for.body16.us.preheader170_crit_edge, label %vector.memcheck113

min.iters.checked97.for.body16.us.preheader170_crit_edge: ; preds = %min.iters.checked97
  br label %for.body16.us.preheader170

vector.memcheck113:                               ; preds = %min.iters.checked97
  br i1 %found.conflict111, label %for.body16.us.preheader170, label %vector.body92.preheader
...
vector.body92:                                    ; preds = %vector.body92.preheader, %vector.body92
  ...
  %31 = getelementptr inbounds double, double* %B, i64 %index115
  %32 = bitcast double* %31 to <2 x double>*
  %wide.load125 = load <2 x double>, <2 x double>* %32, align 8, !alias.scope !11
  %33 = getelementptr double, double* %31, i64 2
  %34 = bitcast double* %33 to <2 x double>*
  %wide.load126 = load <2 x double>, <2 x double>* %34, align 8, !alias.scope !11
  %35 = getelementptr inbounds double, double* %B, i64 %offset.idx120
  %36 = bitcast double* %35 to <2 x double>*
  %wide.load127 = load <2 x double>, <2 x double>* %36, align 8, !alias.scope !11
  %37 = getelementptr double, double* %35, i64 2
  %38 = bitcast double* %37 to <2 x double>*
  %wide.load128 = load <2 x double>, <2 x double>* %38, align 8, !alias.scope !11
  %39 = fadd <2 x double> %wide.load125, %wide.load127
  %40 = fadd <2 x double> %wide.load126, %wide.load128
  %41 = add nuw nsw i64 %offset.idx120, 1
  %42 = getelementptr inbounds double, double* %B, i64 %41
  %43 = getelementptr double, double* %42, i64 2
  %44 = bitcast double* %43 to <2 x double>*
  %wide.load130 = load <2 x double>, <2 x double>* %44, align 8, !alias.scope !11
  %45 = fadd <2 x double> %39, %wide.load126
  %46 = fadd <2 x double> %40, %wide.load130
  ...
  %49 = getelementptr inbounds double, double* %A, i64 %offset.idx120
  ...
  %53 = icmp eq i64 %index.next116, 1996
  br i1 %53, label %middle.block93, label %vector.body92, !llvm.loop !16

middle.block93:                                   ; preds = %vector.body92
  br i1 false, label %middle.block93.for.inc33.us_crit_edge, label %for.body16.us.preheader170
