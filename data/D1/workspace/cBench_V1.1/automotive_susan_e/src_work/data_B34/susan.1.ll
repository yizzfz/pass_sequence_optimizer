...
.lr.ph10:                                         ; preds = %.lr.ph10.preheader23, %.lr.ph10
...
.lr.ph.preheader:                                 ; preds = %._crit_edge11.thread, %._crit_edge11
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %3, %.lr.ph.prol.loopexit, %._crit_edge11
  ret void
}
...
._crit_edge:                                      ; preds = %.lr.ph.6, %104, %.backedge, %.backedge.1, %.backedge.2, %.backedge.3, %.backedge.4, %.backedge.5
...
._crit_edge8:                                     ; preds = %._crit_edge8.loopexit, %.preheader3, %.preheader2
  %96 = shl nsw i32 %4, 1
...
.preheader24:                                     ; preds = %.preheader24.preheader, %._crit_edge81
...
.preheader22:                                     ; preds = %.preheader22.lr.ph, %._crit_edge46
...
.lr.ph45.split:                                   ; preds = %.lr.ph45.split.preheader, %139
...
._crit_edge40.thread:                             ; preds = %.lr.ph45.split, %._crit_edge40
...
.preheader25:                                     ; preds = %.preheader25.preheader, %._crit_edge88
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %.preheader26, %._crit_edge77
  ret void
}
...
._crit_edge.loopexit:                             ; preds = %.lr.ph.new.prol.loopexit, %._crit_edge.loopexit.unr-lcssa
  br label %._crit_edge
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.thread60
...
.thread60:                                        ; preds = %84, %83, %335, %364, %368, %427, %270, %329, %323, %317, %308, %306, %.lr.ph, %434, %508, %469, %432
...
; <label>:526:                                    ; preds = %134, %154, %174, %190, %194, %184, %164, %144, %124
...
.thread:                                          ; preds = %681, %709, %731, %699, %721, %361, %1057, %1077, %1099, %1067, %1089
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, %wide.trip.count
...
.thread:                                          ; preds = %207, %235, %225, %120, %316, %336, %326
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, %wide.trip.count
...
; <label>:563:                                    ; preds = %49, %212, %231, %252, %272, %292, %312, %332, %351, %371, %543, %554, %381, %362, %342, %322, %301, %282, %262, %242, %222, %201
  %indvars.iv.next101 = add nuw nsw i64 %indvars.iv100, 1
...
; <label>:844:                                    ; preds = %578, %823, %818, %813, %808, %804, %799, %794, %788, %783, %778, %773, %769, %764, %759, %753, %748, %743, %738, %734, %729, %724, %718, %713, %708, %703, %698, %693, %688, %683, %678, %673, %669, %664, %659, %653, %648, %643, %638, %634, %629, %624, %618, %613, %608, %603, %599, %594, %589, %583
...
._crit_edge80:                                    ; preds = %._crit_edge80.loopexit, %7, %.preheader72
...
; <label>:375:                                    ; preds = %40, %203, %222, %243, %263, %283, %303, %323, %342, %362, %372, %353, %333, %313, %292, %273, %253, %233, %213, %192
  %indvars.iv.next55 = add nuw nsw i64 %indvars.iv54, 1
...
; <label>:823:                                    ; preds = %390, %635, %630, %625, %620, %616, %611, %606, %600, %595, %590, %585, %581, %576, %571, %565, %560, %555, %550, %546, %541, %536, %530, %525, %520, %515, %510, %505, %500, %495, %490, %485, %481, %476, %471, %465, %460, %455, %450, %446, %441, %436, %430, %425, %420, %415, %411, %406, %401, %395
...
._crit_edge45:                                    ; preds = %._crit_edge45.loopexit, %7, %.preheader37
...
; <label>:52:                                     ; preds = %19, %23, %24, %25, %26, %27, %28, %29, %30, %46, %35
