...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %16 = icmp sge <4 x i32> %wide.load, %14
  %17 = icmp sge <4 x i32> %wide.load73, %15
  %predphi = select <4 x i1> %16, <4 x i32> %14, <4 x i32> %wide.load
  %predphi76 = select <4 x i1> %17, <4 x i32> %15, <4 x i32> %wide.load73
...
for.inc35.us.us.for.inc38.us_crit_edge:           ; preds = %for.inc35.us.us
  ...
  %exitcond78 = icmp eq i64 %indvars.iv.next60, %0
  br i1 %exitcond78, label %for.end40.loopexit, label %for.cond1.preheader.us
