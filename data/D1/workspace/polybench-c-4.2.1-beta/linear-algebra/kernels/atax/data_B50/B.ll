...
.lr.ph5:                                          ; preds = %.lr.ph5, %.lr.ph5.preheader
  %indvars.iv7 = phi i64 [ 0, %.lr.ph5.preheader ], [ %indvars.iv.next8.2, %.lr.ph5 ]
  ...
  br i1 %exitcond9.2, label %.lr.ph2.preheader, label %.lr.ph5

.lr.ph2.preheader:                                ; preds = %.lr.ph5
  br label %.lr.ph2

.lr.ph2:                                          ; preds = %.lr.ph2.preheader, %._crit_edge
  %17 = phi i32 [ %33, %._crit_edge ], [ 0, %.lr.ph2.preheader ]
...
._crit_edge1:                                     ; preds = %._crit_edge1, %.lr.ph2
  ...
  %20 = add nuw nsw i64 %19, %indvars.iv
  %21 = trunc i64 %20 to i32
  %22 = srem i32 %21, 2100
  %23 = sitofp i32 %22 to double
  %24 = getelementptr inbounds [2100 x double], [2100 x double]* %0, i64 %18, i64 %indvars.iv
  %indvars.iv.next = or i64 %indvars.iv, 1
  %25 = add nuw nsw i64 %19, %indvars.iv.next
...
.lr.ph5:
  ...
  %sunkaddr30 = ptrtoint double* %3 to i64
  br label %.lr.ph

.lr.ph:                                           ; preds = %._crit_edge3, %.lr.ph5
  %6 = phi i32 [ 0, %.lr.ph5 ], [ %36, %._crit_edge3 ]
  %7 = sext i32 %6 to i64
  %8 = getelementptr inbounds double, double* %3, i64 %7
  store double 0.000000e+00, double* %8, align 8
  %sunkaddr10 = shl nsw i64 %7, 3
  %sunkaddr11 = add i64 %5, %sunkaddr10
  %sunkaddr12 = inttoptr i64 %sunkaddr11 to double*
  %.pre = load double, double* %sunkaddr12, align 8
  %sunkaddr23 = shl nsw i64 %7, 3
  %sunkaddr24 = add i64 %sunkaddr, %sunkaddr23
  %sunkaddr25 = inttoptr i64 %sunkaddr24 to double*
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph
  %9 = phi double [ %.pre, %.lr.ph ], [ %21, %._crit_edge ]
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next.1, %._crit_edge ]
  %10 = getelementptr inbounds [2100 x double], [2100 x double]* %0, i64 %7, i64 %indvars.iv
  %11 = load double, double* %10, align 8
  %12 = getelementptr inbounds double, double* %1, i64 %indvars.iv
  %13 = load double, double* %12, align 8
  %14 = fmul double %11, %13
  %15 = fadd double %9, %14
  store double %15, double* %sunkaddr25, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %16 = getelementptr inbounds [2100 x double], [2100 x double]* %0, i64 %7, i64 %indvars.iv.next
  %17 = load double, double* %16, align 8
  %18 = getelementptr inbounds double, double* %1, i64 %indvars.iv.next
  %19 = load double, double* %18, align 8
  %20 = fmul double %17, %19
  %21 = fadd double %15, %20
  store double %21, double* %sunkaddr25, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2100
  br i1 %exitcond.1, label %.lr.ph2.preheader, label %._crit_edge

.lr.ph2.preheader:                                ; preds = %._crit_edge
  %sunkaddr27 = shl nsw i64 %7, 3
  %sunkaddr28 = add i64 %sunkaddr26, %sunkaddr27
  %sunkaddr29 = inttoptr i64 %sunkaddr28 to double*
  %sunkaddr31 = shl nsw i64 %7, 3
  %sunkaddr32 = add i64 %sunkaddr30, %sunkaddr31
  %sunkaddr33 = inttoptr i64 %sunkaddr32 to double*
  br label %.lr.ph2

.lr.ph2:                                          ; preds = %.lr.ph2.preheader, %.lr.ph2..lr.ph2_crit_edge
  %22 = phi double [ %.pre22, %.lr.ph2..lr.ph2_crit_edge ], [ %21, %.lr.ph2.preheader ]
  %indvars.iv17 = phi i64 [ %indvars.iv.next18.1, %.lr.ph2..lr.ph2_crit_edge ], [ 0, %.lr.ph2.preheader ]
  %23 = getelementptr inbounds double, double* %2, i64 %indvars.iv17
  %24 = load double, double* %23, align 8
  %25 = getelementptr inbounds [2100 x double], [2100 x double]* %0, i64 %7, i64 %indvars.iv17
  %26 = load double, double* %25, align 8
  %27 = fmul double %26, %22
  %28 = fadd double %24, %27
  store double %28, double* %23, align 8
  %indvars.iv.next18 = or i64 %indvars.iv17, 1
  %29 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next18
  %30 = load double, double* %29, align 8
  %31 = getelementptr inbounds [2100 x double], [2100 x double]* %0, i64 %7, i64 %indvars.iv.next18
  %32 = load double, double* %31, align 8
  %33 = load double, double* %sunkaddr29, align 8
  %34 = fmul double %32, %33
  %35 = fadd double %30, %34
  store double %35, double* %29, align 8
  %indvars.iv.next18.1 = add nuw nsw i64 %indvars.iv17, 2
  %exitcond.119 = icmp eq i64 %indvars.iv.next18.1, 2100
  br i1 %exitcond.119, label %._crit_edge3, label %.lr.ph2..lr.ph2_crit_edge

.lr.ph2..lr.ph2_crit_edge:                        ; preds = %.lr.ph2
  %.pre22 = load double, double* %sunkaddr33, align 8
  br label %.lr.ph2

._crit_edge3:                                     ; preds = %.lr.ph2
  %36 = add nsw i32 %6, 1
  %37 = icmp slt i32 %36, 1900
  br i1 %37, label %.lr.ph, label %._crit_edge6
