...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %._crit_edge9.us
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %._crit_edge9.us ], [ 0, %.lr.ph.us.preheader ]
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.loopexit, %.lr.ph.us
  ...
  br i1 %76, label %.preheader.us15.preheader, label %.lr.ph.us.new.preheader
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.preheader3
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %.preheader3 ], [ 0, %.lr.ph.preheader ]
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %.preheader3 ], [ 1, %.lr.ph.preheader ]
  %99 = add i64 %indvars.iv49, -3
  %100 = add i64 %indvars.iv49, 1
  %xtraiter55 = and i64 %100, 3
...
.prol.preheader53:                                ; preds = %.prol.preheader53.preheader, %.prol.preheader53
  ...
  %101 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv49, i64 %indvars.iv42.prol
...
.prol.loopexit54:                                 ; preds = %.prol.loopexit54.loopexit, %.lr.ph
  %indvars.iv42.unr = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next43.prol, %.prol.loopexit54.loopexit ]
  %104 = icmp ult i64 %indvars.iv49, 3
  br i1 %104, label %.preheader3, label %.lr.ph.new.preheader
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %114 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv49, i64 %113
  ...
  %120 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv49, i64 %119
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader136, %.lr.ph.new
  ...
  %127 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv49, i64 %indvars.iv42
  %128 = load double, double* %127, align 8
  %129 = fmul double %128, %3
  store double %129, double* %127, align 8
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1
  %130 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv49, i64 %indvars.iv.next43
  %131 = load double, double* %130, align 8
  %132 = fmul double %131, %3
  store double %132, double* %130, align 8
  %indvars.iv.next43.1 = add nsw i64 %indvars.iv42, 2
  %133 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv49, i64 %indvars.iv.next43.1
  %134 = load double, double* %133, align 8
  %135 = fmul double %134, %3
  store double %135, double* %133, align 8
  %indvars.iv.next43.2 = add nsw i64 %indvars.iv42, 3
  %136 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv49, i64 %indvars.iv.next43.2
