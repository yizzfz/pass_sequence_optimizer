...
; <label>:46:                                     ; preds = %46, %.preheader6.us
  %indvars.iv39 = phi i64 [ 0, %.preheader6.us ], [ %indvars.iv.next40, %46 ]
  ...
  br i1 %exitcond42, label %._crit_edge17.us, label %46
...
.preheader.lr.ph:                                 ; preds = %.preheader5
  ...
  br i1 %55, label %.preheader.us.preheader, label %._crit_edge14
...
; <label>:57:                                     ; preds = %57, %.preheader.us
  ...
  %59 = mul nuw nsw i64 %58, %indvars.iv34
  %60 = trunc i64 %59 to i32
  %61 = srem i32 %60, %2
  %62 = sitofp i32 %61 to double
  %63 = fdiv double %62, %56
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %9, i64 %indvars.iv34, i64 %indvars.iv
...
.prol.loopexit61:                                 ; preds = %.prol.preheader60, %.lr.ph21.us.us
  %28 = phi double [ %27, %.prol.preheader60 ], [ 0.000000e+00, %.lr.ph21.us.us ]
  %indvars.iv56.unr.ph = phi i64 [ 1, %.prol.preheader60 ], [ 0, %.lr.ph21.us.us ]
  br i1 %19, label %._crit_edge22.us.us, label %.lr.ph21.us.us.new.preheader
...
.lr.ph21.us.us.new:                               ; preds = %.lr.ph21.us.us.new.preheader, %.lr.ph21.us.us.new
  %29 = phi double [ %43, %.lr.ph21.us.us.new ], [ %28, %.lr.ph21.us.us.new.preheader ]
  %indvars.iv56 = phi i64 [ %indvars.iv.next57.1, %.lr.ph21.us.us.new ], [ %indvars.iv56.unr.ph, %.lr.ph21.us.us.new.preheader ]
  %30 = getelementptr inbounds [1100 x double], [1100 x double]* %7, i64 %indvars.iv70, i64 %indvars.iv56
  %31 = load double, double* %30, align 8
  %32 = fmul double %31, %4
  %33 = getelementptr inbounds [900 x double], [900 x double]* %8, i64 %indvars.iv56, i64 %indvars.iv64
...
.preheader.lr.ph:                                 ; preds = %.preheader.lr.ph.loopexit, %.preheader6.lr.ph
  %44 = icmp sgt i32 %3, 0
  br i1 %44, label %.preheader.us.preheader, label %._crit_edge12
...
.preheader.us.preheader:                          ; preds = %.preheader.lr.ph
  ...
  %48 = add nsw i64 %wide.trip.count.3, -4
  %49 = add nsw i32 %xtraiter, -1
...
.lr.ph9..lr.ph9.split_crit_edge.us.prol.loopexit: ; preds = %.lr.ph9..lr.ph9.split_crit_edge.us.prol.loopexit.loopexit, %.lr.ph9..lr.ph9.split_crit_edge.us.preheader
  %indvars.iv.unr = phi i64 [ 0, %.lr.ph9..lr.ph9.split_crit_edge.us.preheader ], [ %51, %.lr.ph9..lr.ph9.split_crit_edge.us.prol.loopexit.loopexit ]
  br i1 %46, label %._crit_edge10.us, label %.lr.ph9..lr.ph9.split_crit_edge.us.preheader78

.lr.ph9..lr.ph9.split_crit_edge.us.preheader78:   ; preds = %.lr.ph9..lr.ph9.split_crit_edge.us.prol.loopexit
  %56 = sub nsw i64 %48, %indvars.iv.unr
  %57 = lshr i64 %56, 2
...
.lr.ph9..lr.ph9.split_crit_edge.us:               ; preds = %.lr.ph9..lr.ph9.split_crit_edge.us.preheader85, %.lr.ph9..lr.ph9.split_crit_edge.us
  %indvars.iv = phi i64 [ %indvars.iv.next.3, %.lr.ph9..lr.ph9.split_crit_edge.us ], [ %indvars.iv.ph, %.lr.ph9..lr.ph9.split_crit_edge.us.preheader85 ]
  ...
  br i1 %exitcond.3, label %._crit_edge10.us.loopexit86, label %.lr.ph9..lr.ph9.split_crit_edge.us, !llvm.loop !6
...
.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph.us.us
  ...
  br i1 %47, label %._crit_edge.us.us, label %.lr.ph.us.us.new.preheader
...
.lr.ph.us.us.new:                                 ; preds = %.lr.ph.us.us.new.preheader, %.lr.ph.us.us.new
  ...
  %100 = getelementptr inbounds [900 x double], [900 x double]* %6, i64 %indvars.iv46, i64 %indvars.iv37
  %101 = load double, double* %100, align 8
  %102 = getelementptr inbounds [1200 x double], [1200 x double]* %9, i64 %indvars.iv37, i64 %indvars.iv43
...
._crit_edge12:                                    ; preds = %._crit_edge12.loopexit, %11, %.preheader.lr.ph
  ret void
}
