...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.end_crit_edge.us, %entry
  %indvars.iv29 = phi i64 [ 0, %entry ], [ %indvars.iv.next30, %for.cond1.for.end_crit_edge.us ]
...
for.body3.us:                                     ; preds = %for.body3.us, %for.cond1.preheader.us
  ...
  br i1 %exitcond28, label %for.cond1.for.end_crit_edge.us, label %for.body3.us
...
for.body26.prol.loopexit:                         ; preds = %for.body26.lr.ph, %for.body26.prol
...
entry:
  %mul44.us20 = fmul double %alpha, 0.000000e+00
  ...
  %broadcast.splatinsert83 = insertelement <2 x double> undef, double %mul44.us20, i32 0
...
for.cond1.preheader.us:                           ; preds = %entry, %for.cond1.for.end52_crit_edge.us
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.cond1.for.end52_crit_edge.us ], [ 0, %entry ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv56, i64 0
  %0 = add i64 %indvars.iv56, 1
  %scevgep65 = getelementptr [1200 x double], [1200 x double]* %C, i64 %0, i64 0
  %cmp51.us = icmp sgt i64 %indvars.iv56, 0
  %arrayidx41.us.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv56, i64 %indvars.iv56
...
vector.memcheck:                                  ; preds = %for.cond1.preheader.us
  %scevgep69 = getelementptr [1200 x double], [1200 x double]* %B, i64 %0, i64 0
  %scevgep67 = getelementptr [1200 x double], [1200 x double]* %B, i64 %indvars.iv56, i64 0
  %bound0 = icmp ult double* %scevgep, %scevgep69
  %bound1 = icmp ult double* %scevgep67, %scevgep65
  %found.conflict = and i1 %bound0, %bound1
  %bound072 = icmp ult double* %scevgep, %arrayidx41.us.us
  %bound173 = icmp ult double* %arrayidx41.us.us, %scevgep65
  %found.conflict74 = and i1 %bound072, %bound173
  %conflict.rdx = or i1 %found.conflict, %found.conflict74
  br i1 %conflict.rdx, label %for.cond4.preheader.us7.preheader, label %vector.ph

for.cond4.preheader.us7.preheader:                ; preds = %vector.memcheck
  br label %for.cond4.preheader.us7
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load76 = load <2 x double>, <2 x double>* %4, align 8, !alias.scope !8, !noalias !11
  %5 = fmul <2 x double> %wide.load, %broadcast.splat78
  %6 = fmul <2 x double> %wide.load76, %broadcast.splat78
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv56, i64 %index
  %8 = bitcast double* %7 to <2 x double>*
  %wide.load79 = load <2 x double>, <2 x double>* %8, align 8, !alias.scope !14
  %9 = getelementptr double, double* %7, i64 2
  %10 = bitcast double* %9 to <2 x double>*
  %wide.load80 = load <2 x double>, <2 x double>* %10, align 8, !alias.scope !14
  %11 = fmul <2 x double> %wide.load79, %broadcast.splat82
  %12 = fmul <2 x double> %wide.load80, %broadcast.splat82
  ...
  %22 = fadd <2 x double> %broadcast.splat84, %20
  %23 = fadd <2 x double> %broadcast.splat84, %21
  ...
  br i1 %26, label %for.cond1.for.end52_crit_edge.us.loopexit88, label %vector.body, !llvm.loop !16

for.cond4.preheader.us7:                          ; preds = %for.cond4.preheader.us7, %for.cond4.preheader.us7.preheader
  %indvars.iv = phi i64 [ 0, %for.cond4.preheader.us7.preheader ], [ %indvars.iv.next.1, %for.cond4.preheader.us7 ]
  %arrayidx31.us13 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv56, i64 %indvars.iv
  %27 = load double, double* %arrayidx31.us13, align 8
  %mul32.us14 = fmul double %27, %beta
  %arrayidx36.us15 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv56, i64 %indvars.iv
  %28 = load double, double* %arrayidx36.us15, align 8
  %mul37.us16 = fmul double %28, %alpha
  %29 = load double, double* %arrayidx41.us.us, align 8
  %mul42.us18 = fmul double %mul37.us16, %29
  %add43.us19 = fadd double %mul32.us14, %mul42.us18
  %add45.us21 = fadd double %mul44.us20, %add43.us19
  store double %add45.us21, double* %arrayidx31.us13, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx31.us13.1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv56, i64 %indvars.iv.next
  %30 = load double, double* %arrayidx31.us13.1, align 8
  %mul32.us14.1 = fmul double %30, %beta
  %arrayidx36.us15.1 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv56, i64 %indvars.iv.next
  %31 = load double, double* %arrayidx36.us15.1, align 8
  %mul37.us16.1 = fmul double %31, %alpha
  %32 = load double, double* %arrayidx41.us.us, align 8
  %mul42.us18.1 = fmul double %mul37.us16.1, %32
  %add43.us19.1 = fadd double %mul32.us14.1, %mul42.us18.1
  %add45.us21.1 = fadd double %mul44.us20, %add43.us19.1
  store double %add45.us21.1, double* %arrayidx31.us13.1, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 1200
  br i1 %exitcond.1, label %for.cond1.for.end52_crit_edge.us.loopexit87, label %for.cond4.preheader.us7, !llvm.loop !17
...
for.cond1.for.end52_crit_edge.us.loopexit87:      ; preds = %for.cond4.preheader.us7
  br label %for.cond1.for.end52_crit_edge.us

for.cond1.for.end52_crit_edge.us.loopexit88:      ; preds = %vector.body
  br label %for.cond1.for.end52_crit_edge.us

for.cond1.for.end52_crit_edge.us:                 ; preds = %for.cond1.for.end52_crit_edge.us.loopexit88, %for.cond1.for.end52_crit_edge.us.loopexit87, %for.cond1.for.end52_crit_edge.us.loopexit
  %indvars.iv.next57 = add nuw nsw i64 %indvars.iv56, 1
  %exitcond59 = icmp eq i64 %indvars.iv.next57, 1000
  br i1 %exitcond59, label %for.end55, label %for.cond1.preheader.us

for.cond4.preheader.us.us:                        ; preds = %for.cond4.preheader.us.us.preheader, %for.cond4.for.end_crit_edge.us.us
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.cond4.for.end_crit_edge.us.us ], [ 0, %for.cond4.preheader.us.us.preheader ]
  %arrayidx8.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv56, i64 %indvars.iv52
  br label %for.body6.us.us

for.cond4.for.end_crit_edge.us.us:                ; preds = %for.body6.us.us
  %arrayidx31.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv56, i64 %indvars.iv52
  ...
  br i1 %exitcond55, label %for.cond1.for.end52_crit_edge.us.loopexit, label %for.cond4.preheader.us.us

for.body6.us.us:                                  ; preds = %for.body6.us.us, %for.cond4.preheader.us.us
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.body6.us.us ], [ 0, %for.cond4.preheader.us.us ]
  %36 = phi double [ %add27.us.us, %for.body6.us.us ], [ 0.000000e+00, %for.cond4.preheader.us.us ]
  %37 = load double, double* %arrayidx8.us.us, align 8
  %mul.us.us = fmul double %37, %alpha
  %arrayidx12.us.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv56, i64 %indvars.iv46
  %38 = load double, double* %arrayidx12.us.us, align 8
  %mul13.us.us = fmul double %mul.us.us, %38
  %arrayidx17.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv46, i64 %indvars.iv52
  ...
  %arrayidx21.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv46, i64 %indvars.iv52
  ...
  %exitcond51 = icmp eq i64 %indvars.iv.next47, %indvars.iv56
  br i1 %exitcond51, label %for.cond4.for.end_crit_edge.us.us, label %for.body6.us.us
...
for.cond2.preheader.us:                           ; preds = %for.cond2.for.end_crit_edge.us, %entry
  %indvars.iv5 = phi i64 [ 0, %entry ], [ %indvars.iv.next6, %for.cond2.for.end_crit_edge.us ]
