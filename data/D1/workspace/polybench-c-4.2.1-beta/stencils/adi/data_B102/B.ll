...
.preheader4:                                      ; preds = %._crit_edge22..preheader4_crit_edge, %.preheader4.lr.ph
  %.0323 = phi i32 [ 1, %.preheader4.lr.ph ], [ %93, %._crit_edge22..preheader4_crit_edge ]
...
.lr.ph8.us:                                       ; preds = %.lr.ph8.us..lr.ph8.us_crit_edge, %._crit_edge.us
  ...
  %11 = phi double [ %17, %.lr.ph8.us..lr.ph8.us_crit_edge ], [ 1.000000e+00, %._crit_edge.us ]
...
; <label>:20:                                     ; preds = %._crit_edge, %.lr.ph11.split.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %._crit_edge ], [ 1, %.lr.ph11.split.us ]
  %21 = add nsw i64 %indvars.iv, -1
  %22 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv28, i64 %21
  %23 = load double, double* %22, align 8
  %24 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv28, i64 %indvars.iv
  %25 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv, i64 %10
  %26 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv, i64 %indvars.iv.next29
  %27 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv28, i64 %21
  ...
  %43 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv28, i64 %indvars.iv
...
._crit_edge.us:                                   ; preds = %20
  %44 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 999, i64 %indvars.iv28
...
.lr.ph14.us:                                      ; preds = %.lr.ph14.us.preheader, %._crit_edge19.us
  ...
  %45 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv36
  %46 = bitcast [1000 x double]* %45 to double*
  store double 1.000000e+00, double* %46, align 8
  %47 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv36, i64 0
  store double 0.000000e+00, double* %47, align 8
  %48 = bitcast [1000 x double]* %45 to i64*
  %49 = load i64, i64* %48, align 8
  %50 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv36
  %51 = bitcast [1000 x double]* %50 to i64*
  store i64 %49, i64* %51, align 8
  %52 = add nsw i64 %indvars.iv36, -1
...
.lr.ph18.us:                                      ; preds = %.lr.ph18.us..lr.ph18.us_crit_edge, %._crit_edge15.us
  ...
  %53 = phi double [ %59, %.lr.ph18.us..lr.ph18.us_crit_edge ], [ 1.000000e+00, %._crit_edge15.us ]
  %54 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv36, i64 %indvars.iv34
  %55 = load double, double* %54, align 8
  %56 = fmul double %55, %53
  %57 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv36, i64 %indvars.iv34
  %58 = load double, double* %57, align 8
  %59 = fadd double %56, %58
  %60 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv36, i64 %indvars.iv34
  store double %59, double* %60, align 8
  %61 = icmp sgt i64 %indvars.iv34, 1
  br i1 %61, label %.lr.ph18.us..lr.ph18.us_crit_edge, label %._crit_edge19.us

.lr.ph18.us..lr.ph18.us_crit_edge:                ; preds = %.lr.ph18.us
  %indvars.iv.next35 = add nsw i64 %indvars.iv34, -1
  br label %.lr.ph18.us

; <label>:62:                                     ; preds = %._crit_edge40, %.lr.ph14.us
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %._crit_edge40 ], [ 1, %.lr.ph14.us ]
  %63 = add nsw i64 %indvars.iv30, -1
  %64 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv36, i64 %63
  %65 = load double, double* %64, align 8
  %66 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv36, i64 %indvars.iv30
  %67 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %52, i64 %indvars.iv30
  %68 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv36, i64 %indvars.iv30
  %69 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv.next37, i64 %indvars.iv30
  %70 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv36, i64 %63
  ...
  %90 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv36, i64 %indvars.iv30
  store double %89, double* %90, align 8
  %exitcond33 = icmp eq i64 %indvars.iv30, 998
  br i1 %exitcond33, label %._crit_edge15.us, label %._crit_edge40

._crit_edge40:                                    ; preds = %62
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  br label %62

._crit_edge15.us:                                 ; preds = %62
  %91 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv36, i64 999
  store double 1.000000e+00, double* %91, align 8
  br label %.lr.ph18.us

._crit_edge22:                                    ; preds = %._crit_edge19.us
  %92 = icmp slt i32 %.0323, 500
  br i1 %92, label %._crit_edge22..preheader4_crit_edge, label %._crit_edge24

._crit_edge22..preheader4_crit_edge:              ; preds = %._crit_edge22
  %93 = add nuw nsw i32 %.0323, 1
  br label %.preheader4
