...
.preheader40:                                     ; preds = %._crit_edge43, %.preheader40.lr.ph
  %.03944 = phi i32 [ 0, %.preheader40.lr.ph ], [ %36, %._crit_edge43 ]
...
.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge
  ...
  %9 = add nsw i64 %indvars.iv46, -1
  %indvars.iv.next47 = add nuw nsw i64 %indvars.iv46, 1
  %load_initial = load double, double* %scevgep, align 8
  br label %._crit_edge51

._crit_edge51:                                    ; preds = %._crit_edge51, %.preheader
  %store_forwarded = phi double [ %load_initial, %.preheader ], [ %35, %._crit_edge51 ]
  %indvars.iv = phi i64 [ 1, %.preheader ], [ %indvars.iv.next, %._crit_edge51 ]
  ...
  %23 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv46, i64 %indvars.iv.next
  %24 = load double, double* %23, align 8
  %25 = fadd double %22, %24
  %26 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next47, i64 %10
  %27 = load double, double* %26, align 8
  %28 = fadd double %25, %27
  %29 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next47, i64 %indvars.iv
  %30 = load double, double* %29, align 8
  %31 = fadd double %28, %30
  %32 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next47, i64 %indvars.iv.next
  %33 = load double, double* %32, align 8
  %34 = fadd double %31, %33
  %35 = fdiv double %34, 9.000000e+00
  store double %35, double* %20, align 8
  %exitcond = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond, label %._crit_edge, label %._crit_edge51

._crit_edge:                                      ; preds = %._crit_edge51
...
._crit_edge43:                                    ; preds = %._crit_edge43.loopexit, %.preheader40
  %36 = add nuw nsw i32 %.03944, 1
  %exitcond50 = icmp eq i32 %36, %0
