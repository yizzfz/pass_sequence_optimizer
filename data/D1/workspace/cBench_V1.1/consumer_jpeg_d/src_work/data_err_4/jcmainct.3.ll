...
@__llvm_prf_nm = private constant [82 x i8] c"P\00jinit_c_main_controller\01tmp1.ll:start_pass_main\01tmp1.ll:process_data_simple_main", section "__llvm_prf_names"
@llvm.used = appending global [5 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jinit_c_main_controller to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_start_pass_main to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_process_data_simple_main to i8*), i8* bitcast ([12 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([82 x i8], [82 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
