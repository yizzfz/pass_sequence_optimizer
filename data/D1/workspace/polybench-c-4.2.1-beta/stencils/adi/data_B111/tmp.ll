...
.lr.ph159.split.us.preheader:                     ; preds = %.preheader152.lr.ph, %._crit_edge170
  %.0171 = phi i32 [ 1, %.preheader152.lr.ph ], [ %152, %._crit_edge170 ]
  br label %.lver.check

.lver.check:                                      ; preds = %._crit_edge157.us, %.lr.ph159.split.us.preheader
  %indvar = phi i64 [ 0, %.lr.ph159.split.us.preheader ], [ %6, %._crit_edge157.us ]
  %indvars.iv176 = phi i64 [ 1, %.lr.ph159.split.us.preheader ], [ %indvars.iv.next177, %._crit_edge157.us ]
  %6 = add i64 %indvar, 1
...
.ph.lver.orig:                                    ; preds = %.ph.lver.orig.preheader, %.ph.lver.orig
  ...
  br i1 %exitcond.lver.orig, label %.lr.ph156.us.preheader.loopexit, label %.ph.lver.orig
...
.lr.ph156.us:                                     ; preds = %.lr.ph156.us, %.lr.ph156.us.preheader
  %indvars.iv174 = phi i64 [ 998, %.lr.ph156.us.preheader ], [ %indvars.iv.next175.1, %.lr.ph156.us ]
  %37 = phi double [ 1.000000e+00, %.lr.ph156.us.preheader ], [ %50, %.lr.ph156.us ]
...
; <label>:53:                                     ; preds = %53, %.ph
  ...
  br i1 %exitcond, label %.lr.ph156.us.preheader.loopexit222, label %53

.lr.ph156.us.preheader.loopexit:                  ; preds = %.ph.lver.orig
  br label %.lr.ph156.us.preheader

.lr.ph156.us.preheader.loopexit222:               ; preds = %53
  br label %.lr.ph156.us.preheader

.lr.ph156.us.preheader:                           ; preds = %.lr.ph156.us.preheader.loopexit222, %.lr.ph156.us.preheader.loopexit
...
.ph214.lver.orig:                                 ; preds = %.ph214.lver.orig.preheader, %.ph214.lver.orig
  ...
  br i1 %exitcond181.lver.orig, label %.lr.ph166.us.preheader.loopexit, label %.ph214.lver.orig
...
.lr.ph166.us:                                     ; preds = %.lr.ph166.us, %.lr.ph166.us.preheader
  %indvars.iv182 = phi i64 [ 998, %.lr.ph166.us.preheader ], [ %indvars.iv.next183.1, %.lr.ph166.us ]
  %110 = phi double [ 1.000000e+00, %.lr.ph166.us.preheader ], [ %123, %.lr.ph166.us ]
...
; <label>:126:                                    ; preds = %126, %.ph214
  ...
  br i1 %exitcond181, label %.lr.ph166.us.preheader.loopexit221, label %126

.lr.ph166.us.preheader.loopexit:                  ; preds = %.ph214.lver.orig
  br label %.lr.ph166.us.preheader

.lr.ph166.us.preheader.loopexit221:               ; preds = %126
  br label %.lr.ph166.us.preheader

.lr.ph166.us.preheader:                           ; preds = %.lr.ph166.us.preheader.loopexit221, %.lr.ph166.us.preheader.loopexit
...
._crit_edge170:                                   ; preds = %._crit_edge167.us
  ...
  br i1 %151, label %.lr.ph159.split.us.preheader, label %._crit_edge172
