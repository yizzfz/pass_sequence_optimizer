...
for.cond1.preheader.us:                           ; preds = %for.inc7.us, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge
  %indvars.iv2232.us = phi i64 [ 0, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge ], [ %indvars.iv.next23.us, %for.inc7.us ]
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us, %for.cond1.preheader.us
  %indvars.iv1830.us = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next19.us, %for.body3.us ]
  %0 = mul nuw nsw i64 %indvars.iv1830.us, %indvars.iv2232.us
  %1 = add nuw nsw i64 %0, 1
  %2 = trunc i64 %1 to i32
  %rem.us = srem i32 %2, 1200
  %conv.us = sitofp i32 %rem.us to double
  %div.us = fdiv double %conv.us, 1.200000e+03
  %arrayidx6.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv2232.us, i64 %indvars.iv1830.us
  store double %div.us, double* %arrayidx6.us, align 8
  %exitcond34 = icmp eq i64 %indvars.iv1830.us, 999
  %indvars.iv.next19.us = add nuw nsw i64 %indvars.iv1830.us, 1
  br i1 %exitcond34, label %for.inc7.us, label %for.body3.us

for.inc7.us:                                      ; preds = %for.body3.us
  %indvars.iv.next23.us = add nuw nsw i64 %indvars.iv2232.us, 1
  %exitcond37 = icmp eq i64 %indvars.iv.next23.us, 1200
  br i1 %exitcond37, label %for.cond14.preheader.preheader, label %for.cond1.preheader.us

for.cond14.preheader.preheader:                   ; preds = %for.inc7.us
  br label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond14.preheader.preheader, %for.inc31
  %indvars.iv1627 = phi i64 [ %indvars.iv.next17, %for.inc31 ], [ 0, %for.cond14.preheader.preheader ]
  br label %for.body17

for.body17:                                       ; preds = %for.body17, %for.cond14.preheader
  %indvars.iv25 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next, %for.body17 ]
  %3 = mul nuw nsw i64 %indvars.iv25, %indvars.iv1627
  %4 = add nuw nsw i64 %3, 2
  %5 = trunc i64 %4 to i32
  %rem20 = srem i32 %5, 1000
  %conv21 = sitofp i32 %rem20 to double
  %div23 = fdiv double %conv21, 1.000000e+03
  %arrayidx27 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv1627, i64 %indvars.iv25
...
for.inc31:                                        ; preds = %for.body17
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv1627, 1
  %exitcond38 = icmp eq i64 %indvars.iv.next17, 1200
...
for.cond1.preheader.us:                           ; preds = %for.inc32.us, %for.cond1.preheader.us.preheader
  %indvars.iv2536.us = phi i64 [ %indvars.iv.next26.us, %for.inc32.us ], [ 1, %for.cond1.preheader.us.preheader ]
  %indvars.iv2734.us = phi i64 [ %3, %for.inc32.us ], [ 0, %for.cond1.preheader.us.preheader ]
  %0 = add i64 %indvars.iv2734.us, 1
  %1 = add i64 %indvars.iv2734.us, -3
  %2 = lshr i64 %1, 2
  %3 = add i64 %indvars.iv2734.us, 1
  %scevgep = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv2734.us, i64 0
  %4 = mul i64 %indvars.iv2734.us, 1201
  %5 = add i64 %4, 1
...
vector.body16.prol:                               ; preds = %vector.ph24
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv2734.us, i64 0
  %8 = bitcast double* %7 to <2 x double>*
  %wide.load33.prol = load <2 x double>, <2 x double>* %8, align 8
  %9 = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv2734.us, i64 2
...
vector.body16:                                    ; preds = %vector.body16, %vector.ph24.new
  ...
  %14 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv2734.us, i64 %index25
  ...
  %20 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv2734.us, i64 %index.next26
...
for.body3.us.preheader:                           ; preds = %middle.block17, %min.iters.checked20, %for.cond1.preheader.us
  %indvars.iv29.us.ph = phi i64 [ 0, %min.iters.checked20 ], [ 0, %for.cond1.preheader.us ], [ %n.vec22, %middle.block17 ]
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us.preheader, %for.body3.us
  %indvars.iv29.us = phi i64 [ %indvars.iv.next.us, %for.body3.us ], [ %indvars.iv29.us.ph, %for.body3.us.preheader ]
  ...
  %exitcond.us = icmp eq i64 %indvars.iv.next.us, %indvars.iv2536.us
...
for.cond9.preheader.us:                           ; preds = %for.cond9.preheader.us.preheader, %for.inc29.us
  %indvars.iv2332.us = phi i64 [ %29, %for.inc29.us ], [ 0, %for.cond9.preheader.us.preheader ]
  %28 = icmp ult i64 %3, 4
  %scevgep4 = getelementptr [1000 x double], [1000 x double]* %A, i64 0, i64 %indvars.iv2332.us
  %29 = add i64 %indvars.iv2332.us, 1
  %scevgep6 = getelementptr [1000 x double], [1000 x double]* %A, i64 %indvars.iv2734.us, i64 %29
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %35 = or i64 %index, 2
  %36 = or i64 %index, 3
  %37 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %index, i64 %indvars.iv2332.us
  %38 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %34, i64 %indvars.iv2332.us
  %39 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %35, i64 %indvars.iv2332.us
  %40 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %36, i64 %indvars.iv2332.us
  ...
  %51 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv2734.us, i64 %index
...
for.body11.us.preheader:                          ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.cond9.preheader.us
  %indvars.iv1730.us.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %min.iters.checked ], [ 0, %for.cond9.preheader.us ], [ %n.vec, %middle.block ]
  %59 = sub i64 %0, %indvars.iv1730.us.ph
...
for.body11.us.prol:                               ; preds = %for.body11.us.preheader
  ...
  %arrayidx20.us.prol = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv1730.us.ph, i64 %indvars.iv2332.us
  %61 = load double, double* %arrayidx20.us.prol, align 8
  %mul21.us.prol = fmul double %mul16.us.prol, %61
  %arrayidx25.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv2734.us, i64 %indvars.iv1730.us.ph
  ...
  %indvars.iv.next18.us.prol = or i64 %indvars.iv1730.us.ph, 1
  br label %for.body11.us.prol.loopexit

for.body11.us.prol.loopexit:                      ; preds = %for.body11.us.prol, %for.body11.us.preheader
  %indvars.iv1730.us.unr.ph = phi i64 [ %indvars.iv.next18.us.prol, %for.body11.us.prol ], [ %indvars.iv1730.us.ph, %for.body11.us.preheader ]
  %63 = icmp eq i64 %indvars.iv2734.us, %indvars.iv1730.us.ph
...
for.body11.us:                                    ; preds = %for.body11.us, %for.body11.us.preheader.new
  %indvars.iv1730.us = phi i64 [ %indvars.iv1730.us.unr.ph, %for.body11.us.preheader.new ], [ %indvars.iv.next18.us.1, %for.body11.us ]
  ...
  %indvars.iv.next18.us.1 = add nsw i64 %indvars.iv1730.us, 2
  %exitcond22.us.1 = icmp eq i64 %indvars.iv.next18.us.1, %indvars.iv2536.us
  br i1 %exitcond22.us.1, label %for.inc29.us, label %for.body11.us, !llvm.loop !15

for.inc29.us:                                     ; preds = %for.body11.us.prol.loopexit, %for.body11.us, %middle.block
  %exitcond39 = icmp eq i64 %29, 1000
  br i1 %exitcond39, label %for.inc32.us, label %for.cond9.preheader.us
...
for.cond2.preheader:                              ; preds = %for.inc10, %for.cond2.preheader.lr.ph.for.cond2.preheader_crit_edge
  %indvars.iv713 = phi i64 [ 0, %for.cond2.preheader.lr.ph.for.cond2.preheader_crit_edge ], [ %indvars.iv.next8, %for.inc10 ]
  %3 = mul nuw nsw i64 %indvars.iv713, 1200
  br label %for.body4
...
if.end:                                           ; preds = %for.body4, %if.then
  ...
  %arrayidx8 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv713, i64 %indvars.iv11
...
for.inc10:                                        ; preds = %if.end
  ...
  %exitcond15 = icmp eq i64 %indvars.iv.next8, 1200
