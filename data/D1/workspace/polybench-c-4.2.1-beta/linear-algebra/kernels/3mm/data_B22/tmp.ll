...
; <label>:12:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond21, label %.preheader55.preheader, label %._crit_edge22

.preheader55.preheader:                           ; preds = %12
  br label %.preheader55

.preheader55:                                     ; preds = %.preheader55.preheader, %20
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %20 ], [ 0, %.preheader55.preheader ]
  br label %._crit_edge23

._crit_edge23:                                    ; preds = %._crit_edge23, %.preheader55
  %indvars.iv10 = phi i64 [ 0, %.preheader55 ], [ %indvars.iv.next11, %._crit_edge23 ]
...
; <label>:20:                                     ; preds = %._crit_edge23
  ...
  br i1 %exitcond15, label %.preheader54.preheader, label %.preheader55

.preheader54.preheader:                           ; preds = %20
  br label %.preheader54

.preheader54:                                     ; preds = %.preheader54.preheader, %28
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %28 ], [ 0, %.preheader54.preheader ]
  br label %._crit_edge24

._crit_edge24:                                    ; preds = %._crit_edge24, %.preheader54
  %indvars.iv4 = phi i64 [ 0, %.preheader54 ], [ %indvars.iv.next5, %._crit_edge24 ]
...
; <label>:28:                                     ; preds = %._crit_edge24
  ...
  br i1 %exitcond9, label %.preheader.preheader, label %.preheader54
...
; <label>:23:                                     ; preds = %22
  ...
  br i1 %exitcond26, label %.preheader67.preheader, label %._crit_edge28

.preheader67.preheader:                           ; preds = %23
  br label %.preheader67

.preheader67:                                     ; preds = %.preheader67.preheader, %45
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %45 ], [ 0, %.preheader67.preheader ]
  br label %._crit_edge30

._crit_edge30:                                    ; preds = %44, %.preheader67
  %indvars.iv10 = phi i64 [ 0, %.preheader67 ], [ %indvars.iv.next11, %44 ]
...
; <label>:45:                                     ; preds = %44
  ...
  br i1 %exitcond16, label %.preheader.preheader, label %.preheader67
