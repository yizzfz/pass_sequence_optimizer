...
entry:
  ...
  tail call fastcc void @init_array([1900 x double]* %arraydecay15, double* %arraydecay516, double* %arraydecay617)
  tail call void (...) @polybench_timer_start() #4
  %arraydecay818 = bitcast i8* %call1 to double*
  %arraydecay919 = bitcast i8* %call2 to double*
  tail call fastcc void @kernel_bicg([1900 x double]* %arraydecay15, double* %arraydecay818, double* %arraydecay919, double* %arraydecay617, double* %arraydecay516)
...
for.body5.us:                                     ; preds = %for.body5.us.preheader, %for.cond12.for.inc27_crit_edge.us
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.cond12.for.inc27_crit_edge.us ], [ 0, %for.body5.us.preheader ]
  %0 = trunc i64 %indvars.iv29 to i32
  %conv7.us = sitofp i32 %0 to double
  %div9.us = fdiv double %conv7.us, 2.100000e+03
  %arrayidx11.us = getelementptr inbounds double, double* %r, i64 %indvars.iv29
  store double %div9.us, double* %arrayidx11.us, align 8
  br label %for.body15.us

for.body15.us:                                    ; preds = %for.body15.us, %for.body5.us
  %indvars.iv = phi i64 [ 0, %for.body5.us ], [ %indvars.iv.next.1, %for.body15.us ]
  %indvars.iv.next = or i64 %indvars.iv, 1
  %1 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv29
  %2 = trunc i64 %1 to i32
  %rem16.us = srem i32 %2, 2100
  %conv17.us = sitofp i32 %rem16.us to double
  %arrayidx23.us = getelementptr inbounds [1900 x double], [1900 x double]* %A, i64 %indvars.iv29, i64 %indvars.iv
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %3 = mul nuw nsw i64 %indvars.iv.next.1, %indvars.iv29
...
for.cond12.for.inc27_crit_edge.us:                ; preds = %for.body15.us
  ...
  br i1 %exitcond31, label %for.end29, label %for.body5.us

for.inc:                                          ; preds = %for.inc, %for.inc.lr.ph
  %indvars.iv32 = phi i64 [ 0, %for.inc.lr.ph ], [ %indvars.iv.next33.1, %for.inc ]
  %6 = trunc i64 %indvars.iv32 to i32
  %conv = sitofp i32 %6 to double
  %arrayidx = getelementptr inbounds double, double* %p, i64 %indvars.iv32
  %indvars.iv.next33 = or i64 %indvars.iv32, 1
  %7 = trunc i64 %indvars.iv.next33 to i32
  ...
  %exitcond34.1 = icmp eq i64 %indvars.iv.next33.1, 1900
  br i1 %exitcond34.1, label %for.body5.us.preheader, label %for.inc
...
for.body3.us.preheader:
  %s1 = bitcast double* %s to i8*
  call void @llvm.memset.p0i8.i64(i8* %s1, i8 0, i64 15200, i32 8, i1 false)
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.cond6.for.inc34_crit_edge.us, %for.body3.us.preheader
  %indvars.iv33 = phi i64 [ 0, %for.body3.us.preheader ], [ %indvars.iv.next34, %for.cond6.for.inc34_crit_edge.us ]
  %arrayidx5.us = getelementptr inbounds double, double* %q, i64 %indvars.iv33
...
for.inc31.us:                                     ; preds = %for.inc31.us, %for.body3.us
  ...
  %sunkaddr9 = mul i64 %indvars.iv33, 8
  %sunkaddr10 = add i64 %sunkaddr, %sunkaddr9
  %sunkaddr11 = inttoptr i64 %sunkaddr10 to double*
  %1 = load double, double* %sunkaddr11, align 8
  %arrayidx16.us = getelementptr inbounds [1900 x double], [1900 x double]* %A, i64 %indvars.iv33, i64 %indvars.iv
  ...
  %sunkaddr12 = ptrtoint double* %q to i64
  %sunkaddr13 = mul i64 %indvars.iv33, 8
  %sunkaddr14 = add i64 %sunkaddr12, %sunkaddr13
  %sunkaddr15 = inttoptr i64 %sunkaddr14 to double*
  %3 = load double, double* %sunkaddr15, align 8
  ...
  store double %add28.us, double* %sunkaddr15, align 8
...
for.cond6.for.inc34_crit_edge.us:                 ; preds = %for.inc31.us
  ...
  %exitcond35 = icmp eq i64 %indvars.iv.next34, 2100
  br i1 %exitcond35, label %for.end36, label %for.body3.us
...
if.end:                                           ; preds = %for.body, %if.then
  ...
  %exitcond17 = icmp eq i64 %indvars.iv.next16, 1900
  br i1 %exitcond17, label %for.body9.preheader, label %for.body
