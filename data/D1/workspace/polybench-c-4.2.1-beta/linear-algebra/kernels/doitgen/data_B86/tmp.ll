...
define void @kernel_doitgen(i32, i32, i32, [140 x [160 x double]]*, [160 x double]*, double*) local_unnamed_addr #0 {
  %7 = icmp sgt i32 %0, 0
  br i1 %7, label %.preheader6.lr.ph, label %._crit_edge12
...
.preheader6.lr.ph:                                ; preds = %6
  ...
  %xtraiter122 = and i64 %14, 3
  %lcmp.mod123 = icmp eq i64 %xtraiter122, 0
  %19 = icmp ult i64 %12, 12
  %cmp.n = icmp eq i64 %8, %n.vec
  %xtraiter121 = and i64 %9, 7
  %lcmp.mod = icmp eq i64 %xtraiter121, 0
  %20 = icmp ult i64 %11, 7
  br label %.preheader6

.preheader6:                                      ; preds = %._crit_edge11, %.preheader6.lr.ph
  %indvars.iv64 = phi i64 [ 0, %.preheader6.lr.ph ], [ %indvars.iv.next65, %._crit_edge11 ]
  br i1 %15, label %.preheader5.lr.ph, label %._crit_edge11
...
.preheader5.prol:                                 ; preds = %.preheader5.prol, %.preheader5.prol.preheader
  ...
  %prol.iter = phi i64 [ %prol.iter.sub, %.preheader5.prol ], [ %xtraiter121, %.preheader5.prol.preheader ]
...
.preheader5.prol.loopexit:                        ; preds = %.preheader5.preheader, %.preheader5.prol.loopexit.unr-lcssa
  ...
  br i1 %20, label %._crit_edge11.loopexit118, label %.preheader5.preheader.new
...
.preheader5.us:                                   ; preds = %._crit_edge10.us, %.preheader5.us.preheader
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %._crit_edge10.us ], [ 0, %.preheader5.us.preheader ]
...
._crit_edge10.us:                                 ; preds = %._crit_edge10.us.loopexit, %middle.block
  %indvars.iv.next63 = add nuw nsw i64 %indvars.iv62, 1
  %exitcond119 = icmp eq i64 %indvars.iv.next63, %9
  br i1 %exitcond119, label %._crit_edge11.loopexit, label %.preheader5.us

.lr.ph9.us:                                       ; preds = %.lr.ph9.us.preheader117, %.lr.ph9.us
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %.lr.ph9.us ], [ %indvars.iv60.ph, %.lr.ph9.us.preheader117 ]
  ...
  br i1 %27, label %.lr.ph9.us, label %._crit_edge10.us.loopexit, !llvm.loop !3

.lr.ph9.us.preheader:                             ; preds = %._crit_edge.us.us
...
.lr.ph9.us.preheader117:                          ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.lr.ph9.us.preheader
  %indvars.iv60.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %min.iters.checked ], [ 0, %.lr.ph9.us.preheader ], [ %n.vec, %middle.block ]
  br label %.lr.ph9.us

min.iters.checked:                                ; preds = %.lr.ph9.us.preheader
...
.prol.preheader:                                  ; preds = %.lr.ph.us.us
  ...
  %71 = getelementptr inbounds [160 x double], [160 x double]* %4, i64 0, i64 %indvars.iv56
  ...
  %74 = load double, double* %sunkaddr72, align 8
  %75 = fadd double %73, %74
  store double %75, double* %sunkaddr72, align 8
...
._crit_edge.us.us:                                ; preds = %._crit_edge.us.us.loopexit, %.prol.loopexit
  ...
  br i1 %exitcond59, label %.lr.ph9.us.preheader, label %.lr.ph.us.us
...
.lr.ph.us.us.new:                                 ; preds = %.lr.ph.us.us.new.preheader, %.lr.ph.us.us.new
  ...
  %81 = load double, double* %sunkaddr76, align 8
  %82 = fadd double %80, %81
  store double %82, double* %sunkaddr76, align 8
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1
  %83 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv64, i64 %indvars.iv62, i64 %indvars.iv.next53
  %84 = load double, double* %83, align 8
  %85 = getelementptr inbounds [160 x double], [160 x double]* %4, i64 %indvars.iv.next53, i64 %indvars.iv56
  %86 = load double, double* %85, align 8
  %87 = fmul double %84, %86
  %88 = fadd double %87, %82
  store double %88, double* %sunkaddr76, align 8
...
.preheader5:                                      ; preds = %.preheader5, %.preheader5.preheader.new
  ...
  br i1 %exitcond.7, label %._crit_edge11.loopexit118.unr-lcssa, label %.preheader5

._crit_edge11.loopexit:                           ; preds = %._crit_edge10.us
  br label %._crit_edge11

._crit_edge11.loopexit118.unr-lcssa:              ; preds = %.preheader5
  br label %._crit_edge11.loopexit118

._crit_edge11.loopexit118:                        ; preds = %.preheader5.prol.loopexit, %._crit_edge11.loopexit118.unr-lcssa
  br label %._crit_edge11

._crit_edge11:                                    ; preds = %._crit_edge11.loopexit118, %._crit_edge11.loopexit, %.preheader6
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1
  %exitcond120 = icmp eq i64 %indvars.iv.next65, %10
  br i1 %exitcond120, label %._crit_edge12.loopexit, label %.preheader6

._crit_edge12.loopexit:                           ; preds = %._crit_edge11
  br label %._crit_edge12

._crit_edge12:                                    ; preds = %._crit_edge12.loopexit, %6
  ret void
}
...
.preheader7.us:                                   ; preds = %._crit_edge13.us, %.preheader7.lr.ph
  %indvars.iv57 = phi i64 [ 0, %.preheader7.lr.ph ], [ %indvars.iv.next58, %._crit_edge13.us ]
  br label %.preheader6.us.us

._crit_edge13.us:                                 ; preds = %._crit_edge12.us.us
  %indvars.iv.next58 = add nuw nsw i64 %indvars.iv57, 1
  %exitcond63 = icmp eq i64 %indvars.iv.next58, 150
  br i1 %exitcond63, label %.preheader.us.preheader, label %.preheader7.us

.preheader.us.preheader:                          ; preds = %._crit_edge13.us
  br label %.preheader.us

.preheader6.us.us:                                ; preds = %.preheader7.us, %._crit_edge12.us.us
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %._crit_edge12.us.us ], [ 0, %.preheader7.us ]
  %5 = mul nuw nsw i64 %indvars.iv53, %indvars.iv57
  br label %6

._crit_edge12.us.us:                              ; preds = %6
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %exitcond56 = icmp eq i64 %indvars.iv.next54, 140
  br i1 %exitcond56, label %._crit_edge13.us, label %.preheader6.us.us
...
; <label>:6:                                      ; preds = %6, %.preheader6.us.us
  ...
  br i1 %exitcond52.1, label %._crit_edge12.us.us, label %6
...
._crit_edge.us:                                   ; preds = %20
  ...
  br i1 %exitcond62, label %._crit_edge9, label %.preheader.us
...
._crit_edge6.us:                                  ; preds = %._crit_edge5.us.us
  ...
  br i1 %exitcond, label %._crit_edge7, label %.preheader3.us
