...
; <label>:4:                                      ; preds = %.lr.ph3, %._crit_edge
  ...
  %indvar = phi i32 [ 0, %.lr.ph3 ], [ %11, %._crit_edge ]
  %indvars.iv8 = phi i32 [ 1, %.lr.ph3 ], [ %indvars.iv.next9, %._crit_edge ]
  %5 = phi i32 [ 0, %.lr.ph3 ], [ %31, %._crit_edge ]
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %4, %.prol.loopexit
  ...
  %31 = add nsw i32 %5, 1
  %32 = icmp slt i64 %indvars.iv.next11, 2000
  %indvars.iv.next9 = add i32 %indvars.iv8, 1
  br i1 %32, label %4, label %._crit_edge4
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %4
  ...
  br i1 %36, label %4, label %._crit_edge3
