...
; <label>:3:                                      ; preds = %3, %.lr.ph13
  %indvars.iv311 = phi i64 [ 0, %.lr.ph13 ], [ %indvars.iv.next4.1, %3 ]
  %4 = trunc i64 %indvars.iv311 to i32
  %5 = srem i32 %4, 1900
  %6 = sitofp i32 %5 to double
  %7 = getelementptr inbounds double, double* %2, i64 %indvars.iv311
  %8 = trunc i64 %indvars.iv311 to i32
  %9 = or i32 %8, 1
  %10 = srem i32 %9, 1900
  ...
  %indvars.iv.next4.1 = add nuw nsw i64 %indvars.iv311, 2
  %exitcond18.1 = icmp eq i64 %indvars.iv.next4.1, 1900
  br i1 %exitcond18.1, label %.lr.ph9.split.us.preheader, label %3

.lr.ph9.split.us.preheader:                       ; preds = %3
  br label %.lr.ph9.split.us

.lr.ph9.split.us:                                 ; preds = %.lr.ph9.split.us.preheader, %._crit_edge.us
  %indvars.iv16.us = phi i64 [ %indvars.iv.next2.us, %._crit_edge.us ], [ 0, %.lr.ph9.split.us.preheader ]
  %16 = trunc i64 %indvars.iv16.us to i32
  %17 = srem i32 %16, 2100
  %18 = sitofp i32 %17 to double
  %19 = fdiv double %18, 2.100000e+03
  %20 = getelementptr inbounds double, double* %1, i64 %indvars.iv16.us
  store double %19, double* %20, align 8
  br label %21

; <label>:21:                                     ; preds = %21, %.lr.ph9.split.us
  %indvars.iv5.us = phi i64 [ 0, %.lr.ph9.split.us ], [ %indvars.iv.next.us.1, %21 ]
  %indvars.iv.next.us = or i64 %indvars.iv5.us, 1
  %22 = mul nuw nsw i64 %indvars.iv.next.us, %indvars.iv16.us
  %23 = trunc i64 %22 to i32
  %24 = srem i32 %23, 2100
  %25 = sitofp i32 %24 to double
  %26 = getelementptr inbounds [1900 x double], [1900 x double]* %0, i64 %indvars.iv16.us, i64 %indvars.iv5.us
  %indvars.iv.next.us.1 = add nuw nsw i64 %indvars.iv5.us, 2
  %27 = mul nuw nsw i64 %indvars.iv.next.us.1, %indvars.iv16.us
...
._crit_edge.us:                                   ; preds = %21
  ...
  %exitcond16 = icmp eq i64 %indvars.iv.next2.us, 2100
  br i1 %exitcond16, label %._crit_edge10, label %.lr.ph9.split.us
...
.lr.ph9.split.us:                                 ; preds = %._crit_edge.us, %.lr.ph9.split.us.preheader
  %indvars.iv16.us = phi i64 [ %indvars.iv.next2.us, %._crit_edge.us ], [ 0, %.lr.ph9.split.us.preheader ]
  %6 = getelementptr inbounds double, double* %2, i64 %indvars.iv16.us
  store double 0.000000e+00, double* %6, align 8
  %7 = getelementptr inbounds double, double* %4, i64 %indvars.iv16.us
  br label %8

; <label>:8:                                      ; preds = %8, %.lr.ph9.split.us
  %indvars.iv5.us = phi i64 [ 0, %.lr.ph9.split.us ], [ %indvars.iv.next.us, %8 ]
  %9 = getelementptr inbounds double, double* %1, i64 %indvars.iv5.us
  %10 = load double, double* %9, align 8
  %11 = load double, double* %7, align 8
  %12 = getelementptr inbounds [1900 x double], [1900 x double]* %0, i64 %indvars.iv16.us, i64 %indvars.iv5.us
  ...
  %18 = getelementptr inbounds double, double* %3, i64 %indvars.iv5.us
...
.lr.ph9:                                          ; preds = %11, %.lr.ph9.preheader
...
; <label>:11:                                     ; preds = %9, %.lr.ph9
  ...
  br i1 %exitcond11, label %.lr.ph.preheader, label %.lr.ph9
...
.lr.ph:                                           ; preds = %25, %.lr.ph.preheader
  %indvars.iv6 = phi i64 [ %indvars.iv.next, %25 ], [ 0, %.lr.ph.preheader ]
