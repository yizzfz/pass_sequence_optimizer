...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load39 = load <2 x double>, <2 x double>* %35, align 8
  %reverse40 = shufflevector <2 x double> %wide.load39, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %36 = fmul <2 x double> %broadcast.splat42, %reverse
  %37 = fmul <2 x double> %broadcast.splat42, %reverse40
  %38 = fadd <2 x double> %wide.load, %36
  %39 = fadd <2 x double> %wide.load37, %37
