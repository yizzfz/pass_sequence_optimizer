...
@__llvm_prf_nm = private constant [92 x i8] c"Z\00jinit_forward_dct\01tmp1.ll:start_pass_fdctmgr\01tmp1.ll:forward_DCT\01tmp1.ll:forward_DCT_float", section "__llvm_prf_names"
@llvm.used = appending global [6 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jinit_forward_dct to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_start_pass_fdctmgr to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_forward_DCT to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_forward_DCT_float to i8*), i8* bitcast ([18 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([92 x i8], [92 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
