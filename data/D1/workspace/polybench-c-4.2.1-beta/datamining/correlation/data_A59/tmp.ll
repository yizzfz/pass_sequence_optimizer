...
define internal fastcc void @print_array(i32, [1200 x double]* nocapture readonly) unnamed_addr #0 {
  ...
  %7 = icmp sgt i32 %0, 0
  br i1 %7, label %.._crit_edge2_crit_edge.us.preheader, label %._crit_edge12

.._crit_edge2_crit_edge.us.preheader:             ; preds = %2
  %wide.trip.count = zext i32 %0 to i64
  br label %.._crit_edge2_crit_edge.us

.._crit_edge2_crit_edge.us:                       ; preds = %.._crit_edge2_crit_edge.us.preheader, %._crit_edge2._crit_edge.us
  %storemerge11.us = phi i32 [ %22, %._crit_edge2._crit_edge.us ], [ 0, %.._crit_edge2_crit_edge.us.preheader ]
  %8 = mul nsw i32 %storemerge11.us, %0
  %9 = sext i32 %storemerge11.us to i64
  %10 = zext i32 %8 to i64
  br label %11

; <label>:11:                                     ; preds = %._crit_edge.us, %.._crit_edge2_crit_edge.us
...
._crit_edge.us:                                   ; preds = %11, %16
  ...
  br i1 %exitcond, label %._crit_edge2._crit_edge.us, label %11

._crit_edge2._crit_edge.us:                       ; preds = %._crit_edge.us
  %22 = add nsw i32 %storemerge11.us, 1
  %23 = icmp slt i32 %22, %0
  br i1 %23, label %.._crit_edge2_crit_edge.us, label %._crit_edge12.loopexit
