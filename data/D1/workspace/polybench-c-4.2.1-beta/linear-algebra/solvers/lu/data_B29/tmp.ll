...
.lr.ph84:                                         ; preds = %._crit_edge88..lr.ph84_crit_edge, %.preheader62.lr.ph
  %indvars.iv140 = phi i64 [ 0, %.preheader62.lr.ph ], [ %9, %._crit_edge88..lr.ph84_crit_edge ]
...
.preheader60.us.prol.loopexit:                    ; preds = %.preheader60.us.preheader..preheader60.us.prol.loopexit_crit_edge, %.preheader60.us.prol.loopexit.loopexit
  %indvars.iv116.unr = phi i64 [ 0, %.preheader60.us.preheader..preheader60.us.prol.loopexit_crit_edge ], [ %32, %.preheader60.us.prol.loopexit.loopexit ]
  %33 = icmp ult i32 %25, 3
  br i1 %33, label %.preheader60.us.prol.loopexit..preheader58.lr.ph_crit_edge, label %._crit_edge81.us.3.preheader
...
._crit_edge81.us.3.prol:                          ; preds = %._crit_edge81.us.3.prol.preheader
  ...
  %scevgep.prol153 = getelementptr i8, i8* %24, i64 %38
  call void @llvm.memset.p0i8.i64(i8* %scevgep.prol153, i8 0, i64 %28, i32 8, i1 false)
  %39 = add i64 %38, 16000
...
._crit_edge81.us.3.prol.loopexit:                 ; preds = %._crit_edge81.us.3.preheader.._crit_edge81.us.3.prol.loopexit_crit_edge, %._crit_edge81.us.3.prol
  %indvars.iv116.unr154 = phi i64 [ %indvars.iv116.unr, %._crit_edge81.us.3.preheader.._crit_edge81.us.3.prol.loopexit_crit_edge ], [ %indvars.iv.next117.3.prol, %._crit_edge81.us.3.prol ]
  %42 = icmp eq i64 %36, 0
  br i1 %42, label %._crit_edge81.us.3.prol.loopexit..preheader58.lr.ph.loopexit_crit_edge, label %._crit_edge81.us.3.preheader.new
...
.preheader57.us.us.preheader:                     ; preds = %._crit_edge70.us..preheader57.us.us.preheader_crit_edge, %.preheader58.lr.ph
  ...
  %sunkaddr149 = shl i64 %indvars.iv108, 3
...
.preheader.us.preheader:                          ; preds = %._crit_edge70.us
  %47 = add nsw i32 %xtraiter120, -1
  %48 = zext i32 %47 to i64
  %49 = add nuw nsw i64 %48, 1
  %50 = icmp eq i32 %xtraiter120, 0
...
.preheader57.us.us:                               ; preds = %._crit_edge68.us.us..preheader57.us.us_crit_edge, %.preheader57.us.us.preheader
  ...
  %54 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv104, i64 %indvars.iv108
  br i1 %43, label %.preheader57.us.us..prol.loopexit101_crit_edge, label %55

.preheader57.us.us..prol.loopexit101_crit_edge:   ; preds = %.preheader57.us.us
  br label %.prol.loopexit101

; <label>:55:                                     ; preds = %.preheader57.us.us
  %56 = load double, double* %54, align 8
  %57 = load double, double* %sunkaddr151, align 8
  %58 = fmul double %56, %57
  %59 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %46, i64 0, i64 %indvars.iv104, i64 0
  %60 = load double, double* %59, align 8
  %61 = fadd double %60, %58
  store double %61, double* %59, align 8
  br label %.prol.loopexit101

.prol.loopexit101:                                ; preds = %.preheader57.us.us..prol.loopexit101_crit_edge, %55
  %indvars.iv96.unr.ph = phi i64 [ 1, %55 ], [ 0, %.preheader57.us.us..prol.loopexit101_crit_edge ]
  br i1 %44, label %.prol.loopexit101.._crit_edge68.us.us_crit_edge, label %.preheader57.us.us.new.preheader
...
.preheader57.us.us.new:                           ; preds = %.preheader57.us.us.new..preheader57.us.us.new_crit_edge, %.preheader57.us.us.new.preheader
  ...
  %63 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv96, i64 %indvars.iv108
  %64 = load double, double* %63, align 8
  %65 = fmul double %62, %64
  %66 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %45, i64 0, i64 %indvars.iv104, i64 %indvars.iv96
  %67 = load double, double* %66, align 8
  %68 = fadd double %67, %65
  store double %68, double* %66, align 8
  %indvars.iv.next97 = add nuw nsw i64 %indvars.iv96, 1
  %69 = load double, double* %54, align 8
  %70 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv.next97, i64 %indvars.iv108
  %71 = load double, double* %70, align 8
  %72 = fmul double %69, %71
  %73 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %45, i64 0, i64 %indvars.iv104, i64 %indvars.iv.next97
...
.preheader.us:                                    ; preds = %._crit_edge.us..preheader.us_crit_edge, %.preheader.us.preheader
  ...
  br i1 %50, label %.preheader.us..prol.loopexit_crit_edge, label %.prol.preheader.preheader
...
.prol.preheader:                                  ; preds = %.prol.preheader..prol.preheader_crit_edge, %.prol.preheader.preheader
  ...
  %prol.iter = phi i32 [ %prol.iter.sub, %.prol.preheader..prol.preheader_crit_edge ], [ %xtraiter120, %.prol.preheader.preheader ]
  %76 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %53, i64 0, i64 %indvars.iv93, i64 %indvars.iv.prol
  %77 = bitcast double* %76 to i64*
  %78 = load i64, i64* %77, align 8
  %79 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv93, i64 %indvars.iv.prol
...
.prol.loopexit:                                   ; preds = %.preheader.us..prol.loopexit_crit_edge, %.prol.loopexit.loopexit
  %indvars.iv.unr = phi i64 [ 0, %.preheader.us..prol.loopexit_crit_edge ], [ %49, %.prol.loopexit.loopexit ]
  br i1 %51, label %.prol.loopexit.._crit_edge.us_crit_edge, label %.preheader.us.new.preheader
...
.preheader.us.new:                                ; preds = %.preheader.us.new..preheader.us.new_crit_edge, %.preheader.us.new.preheader
  ...
  %81 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %52, i64 0, i64 %indvars.iv93, i64 %indvars.iv
  %82 = bitcast double* %81 to i64*
  %83 = load i64, i64* %82, align 8
  %84 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv93, i64 %indvars.iv
  %85 = bitcast double* %84 to i64*
  store i64 %83, i64* %85, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %86 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %52, i64 0, i64 %indvars.iv93, i64 %indvars.iv.next
  %87 = bitcast double* %86 to i64*
  %88 = load i64, i64* %87, align 8
  %89 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv93, i64 %indvars.iv.next
  %90 = bitcast double* %89 to i64*
  store i64 %88, i64* %90, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %91 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %52, i64 0, i64 %indvars.iv93, i64 %indvars.iv.next.1
  %92 = bitcast double* %91 to i64*
  %93 = load i64, i64* %92, align 8
  %94 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv93, i64 %indvars.iv.next.1
  %95 = bitcast double* %94 to i64*
  store i64 %93, i64* %95, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %96 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %52, i64 0, i64 %indvars.iv93, i64 %indvars.iv.next.2
  %97 = bitcast double* %96 to i64*
  %98 = load i64, i64* %97, align 8
  %99 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv93, i64 %indvars.iv.next.2
...
._crit_edge65:                                    ; preds = %._crit_edge65.loopexit, %._crit_edge90.thread
  %101 = phi i8* [ %4, %._crit_edge90.thread ], [ %24, %._crit_edge65.loopexit ]
  tail call void @free(i8* %101) #4
  ret void

._crit_edge81.us.3:                               ; preds = %._crit_edge81.us.3.._crit_edge81.us.3_crit_edge, %._crit_edge81.us.3.preheader.new
  %indvars.iv116 = phi i64 [ %indvars.iv116.unr154, %._crit_edge81.us.3.preheader.new ], [ %indvars.iv.next117.3.1, %._crit_edge81.us.3.._crit_edge81.us.3_crit_edge ]
  %102 = mul i64 %indvars.iv116, 16000
  ...
  %106 = mul i64 %indvars.iv116, 16000
  %107 = add i64 %106, 64000
  %scevgep.1155 = getelementptr i8, i8* %24, i64 %107
  call void @llvm.memset.p0i8.i64(i8* %scevgep.1155, i8 0, i64 %28, i32 8, i1 false)
