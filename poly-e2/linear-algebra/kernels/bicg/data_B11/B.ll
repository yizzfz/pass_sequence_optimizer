...
entry:
  ...
  tail call fastcc void @init_array(i32 1900, i32 2100, [1900 x double]* %arraydecay1, double* %arraydecay52, double* %arraydecay63)
  tail call void (...) @polybench_timer_start() #4
  %arraydecay85 = bitcast i8* %call1 to double*
  %arraydecay96 = bitcast i8* %call2 to double*
  tail call fastcc void @kernel_bicg(i32 1900, i32 2100, [1900 x double]* %arraydecay1, double* %arraydecay85, double* %arraydecay96, double* %arraydecay63, double* %arraydecay52)
...
for.inc24.us:                                     ; preds = %for.inc24.us, %for.body5.us
  ...
  %1 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv10
  ...
  %3 = mul nuw nsw i64 %indvars.iv.next.1, %indvars.iv10
...
for.inc:                                          ; preds = %for.inc, %for.inc.lr.ph
  %indvars.iv12 = phi i64 [ 0, %for.inc.lr.ph ], [ %indvars.iv.next13.1.1, %for.inc ]
  %6 = trunc i64 %indvars.iv12 to i32
  %conv = sitofp i32 %6 to double
  %arrayidx = getelementptr inbounds double, double* %p, i64 %indvars.iv12
  %7 = or i32 %6, 1
  ...
  %9 = trunc i64 %indvars.iv.next13.1 to i32
  %conv.115 = sitofp i32 %9 to double
  %arrayidx.1 = getelementptr inbounds double, double* %p, i64 %indvars.iv.next13.1
  %10 = or i32 %9, 1
  %conv.1.1 = sitofp i32 %10 to double
  %div.v.i0.1.1 = insertelement <2 x double> undef, double %conv.115, i32 0
  ...
  %exitcond14.1.1 = icmp eq i64 %indvars.iv.next13.1.1, 1900
  br i1 %exitcond14.1.1, label %for.body5.us.preheader, label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal fastcc void @kernel_bicg(i32 %m, i32 %n, [1900 x double]* nocapture readonly %A, double* nocapture %s, double* %q, double* nocapture readonly %p, double* %r) unnamed_addr #0 {
for.body3.us.preheader:
  %s15 = bitcast double* %s to i8*
  call void @llvm.memset.p0i8.i64(i8* %s15, i8 0, i64 15200, i32 8, i1 false)
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.cond6.for.inc34_crit_edge.us, %for.body3.us.preheader
  %indvars.iv8 = phi i64 [ 0, %for.body3.us.preheader ], [ %indvars.iv.next9, %for.cond6.for.inc34_crit_edge.us ]
...
for.cond6.for.inc34_crit_edge.us:                 ; preds = %for.inc31.us
  ...
  %exitcond10 = icmp eq i64 %indvars.iv.next9, 2100
  br i1 %exitcond10, label %for.end36, label %for.body3.us
