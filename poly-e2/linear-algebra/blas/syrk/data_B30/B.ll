...
for.inc.us:                                       ; preds = %for.inc.us.for.inc.us_crit_edge, %for.cond1.preheader.us
  %indvars.iv517.us = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next6.us, %for.inc.us.for.inc.us_crit_edge ]
  ...
  br i1 %exitcond21, label %for.inc7.us, label %for.inc.us.for.inc.us_crit_edge
...
for.inc7.us:                                      ; preds = %for.inc.us
  ...
  br i1 %exitcond24, label %for.inc7.us.for.cond14.preheader_crit_edge, label %for.cond1.preheader.us

for.inc7.us.for.cond14.preheader_crit_edge:       ; preds = %for.inc7.us
  br label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.inc31, %for.inc7.us.for.cond14.preheader_crit_edge
  %indvars.iv314 = phi i64 [ 0, %for.inc7.us.for.cond14.preheader_crit_edge ], [ %indvars.iv.next4, %for.inc31 ]
  br label %for.inc28

for.inc28:                                        ; preds = %for.inc28, %for.cond14.preheader
  %indvars.iv12 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next, %for.inc28 ]
...
for.inc31:                                        ; preds = %for.inc28
  ...
  br i1 %exitcond25, label %for.end33, label %for.cond14.preheader
...
for.cond1.preheader.us:                           ; preds = %for.inc32.us.for.cond1.preheader.us_crit_edge, %for.cond1.preheader.us.preheader
  %indvars.iv1122.us = phi i64 [ %indvars.iv.next12.us, %for.inc32.us.for.cond1.preheader.us_crit_edge ], [ 1, %for.cond1.preheader.us.preheader ]
  %indvars.iv1320.us = phi i64 [ %0, %for.inc32.us.for.cond1.preheader.us_crit_edge ], [ 0, %for.cond1.preheader.us.preheader ]
...
vector.body16:                                    ; preds = %vector.body16, %vector.ph24
  ...
  %3 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv1320.us, i64 %index25
...
for.inc.us.preheader:                             ; preds = %middle.block17, %min.iters.checked20, %for.cond1.preheader.us
  %indvars.iv15.us.ph = phi i64 [ 0, %for.cond1.preheader.us ], [ 0, %min.iters.checked20 ], [ %n.vec22, %middle.block17 ]
  br label %for.inc.us

for.inc.us:                                       ; preds = %for.inc.us, %for.inc.us.preheader
  %indvars.iv15.us = phi i64 [ %indvars.iv15.us.ph, %for.inc.us.preheader ], [ %indvars.iv.next.us, %for.inc.us ]
...
for.cond9.preheader.us:                           ; preds = %for.inc29.us, %for.cond9.preheader.us.preheader
  %indvars.iv918.us = phi i64 [ 0, %for.cond9.preheader.us.preheader ], [ %12, %for.inc29.us ]
  %11 = icmp ult i64 %0, 4
  %scevgep4 = getelementptr [1000 x double], [1000 x double]* %A, i64 0, i64 %indvars.iv918.us
  %12 = add i64 %indvars.iv918.us, 1
  %scevgep6 = getelementptr [1000 x double], [1000 x double]* %A, i64 %indvars.iv1320.us, i64 %12
  %arrayidx15.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv1320.us, i64 %indvars.iv918.us
  br i1 %11, label %for.inc26.us.preheader, label %min.iters.checked

min.iters.checked:                                ; preds = %for.cond9.preheader.us
  %13 = icmp eq i64 %n.vec, 0
  br i1 %13, label %for.inc26.us.preheader, label %vector.memcheck
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %21 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %index, i64 %indvars.iv918.us
  %22 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %14, i64 %indvars.iv918.us
  %23 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %15, i64 %indvars.iv918.us
  %24 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %16, i64 %indvars.iv918.us
  ...
  %35 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv1320.us, i64 %index
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %42, label %for.inc29.us, label %for.inc26.us.preheader

for.inc26.us.preheader:                           ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.cond9.preheader.us
  %indvars.iv316.us.ph = phi i64 [ 0, %for.cond9.preheader.us ], [ 0, %min.iters.checked ], [ 0, %vector.memcheck ], [ %n.vec, %middle.block ]
  br label %for.inc26.us

for.inc26.us:                                     ; preds = %for.inc26.us, %for.inc26.us.preheader
  %indvars.iv316.us = phi i64 [ %indvars.iv316.us.ph, %for.inc26.us.preheader ], [ %indvars.iv.next4.us, %for.inc26.us ]
  ...
  br i1 %exitcond8.us, label %for.inc29.us, label %for.inc26.us, !llvm.loop !15

for.inc29.us:                                     ; preds = %for.inc26.us, %middle.block
  %exitcond25 = icmp eq i64 %12, 1000
  br i1 %exitcond25, label %for.inc32.us, label %for.cond9.preheader.us
