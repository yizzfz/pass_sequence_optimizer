...
..loopexit_crit_edge.us:                          ; preds = %.lr.ph.us.new
  ...
  br i1 %46, label %._crit_edge, label %.lr.ph.us
...
.preheader5.us:                                   ; preds = %._crit_edge11.us, %.preheader5.lr.ph
  ...
  %5 = getelementptr inbounds double, double* %0, i64 %indvars.iv27
  %.pre = load double, double* %5, align 8
  br label %.preheader5.us.new

.preheader5.us.new:                               ; preds = %.preheader5.us, %.preheader5.us.new
  %6 = phi double [ %18, %.preheader5.us.new ], [ %.pre, %.preheader5.us ]
  %indvars.iv19 = phi i64 [ %indvars.iv.next20.1, %.preheader5.us.new ], [ 0, %.preheader5.us ]
  %7 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 %indvars.iv27, i64 %indvars.iv19
  %8 = load double, double* %7, align 8
  %9 = getelementptr inbounds double, double* %2, i64 %indvars.iv19
  %10 = load double, double* %9, align 8
  %11 = fmul double %8, %10
  %12 = fadd double %6, %11
  %sunkaddr = ptrtoint double* %0 to i64
  %sunkaddr1 = mul i64 %indvars.iv27, 8
  ...
  %13 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 %indvars.iv27, i64 %indvars.iv.next20
  %14 = load double, double* %13, align 8
  %15 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next20
  %16 = load double, double* %15, align 8
  %17 = fmul double %14, %16
  %18 = fadd double %12, %17
  store double %18, double* %sunkaddr3, align 8
  %indvars.iv.next20.1 = add nuw nsw i64 %indvars.iv19, 2
  %exitcond22.1 = icmp eq i64 %indvars.iv.next20.1, 2000
  br i1 %exitcond22.1, label %._crit_edge11.us, label %.preheader5.us.new

._crit_edge11.us:                                 ; preds = %.preheader5.us.new
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  ...
  %19 = getelementptr inbounds double, double* %1, i64 %indvars.iv16
  %.pre31 = load double, double* %19, align 8
  br label %.preheader.us.new

.preheader.us.new:                                ; preds = %.preheader.us, %.preheader.us.new
  %20 = phi double [ %32, %.preheader.us.new ], [ %.pre31, %.preheader.us ]
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.preheader.us.new ], [ 0, %.preheader.us ]
  %21 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 %indvars.iv, i64 %indvars.iv16
  ...
  %sunkaddr5 = mul i64 %indvars.iv16, 8
  %sunkaddr6 = add i64 %sunkaddr4, %sunkaddr5
  %sunkaddr7 = inttoptr i64 %sunkaddr6 to double*
  store double %26, double* %sunkaddr7, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %27 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 %indvars.iv.next, i64 %indvars.iv16
...
.lr.ph7:                                          ; preds = %.lr.ph7.preheader, %11
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %11 ], [ 0, %.lr.ph7.preheader ]
...
; <label>:9:                                      ; preds = %.lr.ph7
  ...
  %fputc5 = tail call i32 @fputc(i32 10, %struct._IO_FILE* %10) #5
  br label %11
...
; <label>:11:                                     ; preds = %9, %.lr.ph7
  ...
  br i1 %exitcond13, label %._crit_edge8, label %.lr.ph7
...
.lr.ph:                                           ; preds = %._crit_edge8, %25
  %indvars.iv = phi i64 [ %indvars.iv.next, %25 ], [ 0, %._crit_edge8 ]
