...
vector.body64:                                    ; preds = %vector.body64, %vector.ph98
  ...
  %31 = or i64 %index99, 1
  %32 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %index99, i64 %indvars.iv30
  %33 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %31, i64 %indvars.iv30
  ...
  %38 = fmul <2 x double> %37, %broadcast.splat107
  %39 = fmul <2 x double> %38, %27
  %40 = getelementptr inbounds [1000 x double], [1000 x double]* %6, i64 %index99, i64 %indvars.iv30
  %41 = getelementptr inbounds [1000 x double], [1000 x double]* %6, i64 %31, i64 %indvars.iv30
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.loopexit, %.lr.ph.us
  ...
  br i1 %76, label %.preheader.us14.preheader, label %.lr.ph.us.new.preheader
