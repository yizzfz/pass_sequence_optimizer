...
.preheader3:                                      ; preds = %._crit_edge11.us
  %26 = icmp sgt i32 %0, 0
  br i1 %26, label %.preheader.lr.ph, label %._crit_edge8
...
scalar.ph66:                                      ; preds = %scalar.ph66.preheader, %scalar.ph66
  ...
  %24 = fmul double %23, %2
  %25 = load double, double* %38, align 8
...
.preheader.us15:                                  ; preds = %.preheader.us15.preheader, %._crit_edge.us18
  ...
  %36 = icmp ult i64 %74, 2
  %scevgep76 = getelementptr [1000 x double], [1000 x double]* %5, i64 0, i64 %indvars.iv30
  %37 = add i64 %indvars.iv30, 1
  %scevgep78 = getelementptr [1000 x double], [1000 x double]* %5, i64 %indvars.iv37, i64 %37
  %scevgep80 = getelementptr [1000 x double], [1000 x double]* %6, i64 0, i64 %indvars.iv30
  %scevgep82 = getelementptr [1000 x double], [1000 x double]* %6, i64 %indvars.iv37, i64 %37
  %38 = getelementptr inbounds [1000 x double], [1000 x double]* %6, i64 %indvars.iv37, i64 %indvars.iv30
  %39 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv37, i64 %indvars.iv30
  br i1 %36, label %scalar.ph66.preheader, label %min.iters.checked68
...
min.iters.checked68:                              ; preds = %.preheader.us15
  %40 = icmp eq i64 %n.vec70, 0
  br i1 %40, label %scalar.ph66.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked68
  %bound0 = icmp ult double* %scevgep, %39
  %bound1 = icmp ult double* %39, %scevgep74
  ...
  %bound094 = icmp ult double* %scevgep, %38
  %bound195 = icmp ult double* %38, %scevgep74
...
vector.body64:                                    ; preds = %vector.body64, %vector.ph98
  ...
  %41 = or i64 %index99, 1
  %42 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %index99, i64 %indvars.iv30
  %43 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %41, i64 %indvars.iv30
  %44 = load double, double* %42, align 8, !alias.scope !6
  ...
  %48 = fmul <2 x double> %47, %broadcast.splat107
  %49 = load double, double* %38, align 8, !alias.scope !9
  ...
  %53 = getelementptr inbounds [1000 x double], [1000 x double]* %6, i64 %index99, i64 %indvars.iv30
  %54 = getelementptr inbounds [1000 x double], [1000 x double]* %6, i64 %41, i64 %indvars.iv30
  ...
  %59 = fmul <2 x double> %58, %broadcast.splat107
  %60 = load double, double* %39, align 8, !alias.scope !13
  ...
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv37, i64 %index99
  %66 = bitcast double* %65 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %66, align 8, !alias.scope !15, !noalias !17
  %67 = fadd <2 x double> %wide.load, %64
  %68 = bitcast double* %65 to <2 x double>*
  store <2 x double> %67, <2 x double>* %68, align 8, !alias.scope !15, !noalias !17
  %index.next100 = add i64 %index99, 2
  %69 = icmp eq i64 %index.next100, %n.vec70
  br i1 %69, label %middle.block65, label %vector.body64, !llvm.loop !18

middle.block65:                                   ; preds = %vector.body64
  %70 = icmp eq i64 %74, %n.vec70
  br i1 %70, label %._crit_edge.us18, label %scalar.ph66.preheader
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %._crit_edge9.us
  ...
  %71 = add i64 %indvars.iv37, -3
  %scevgep = getelementptr [1200 x double], [1200 x double]* %4, i64 %indvars.iv37, i64 0
  %72 = mul i64 %indvars.iv37, 1201
  %73 = add i64 %72, 1
  %scevgep74 = getelementptr [1200 x double], [1200 x double]* %4, i64 0, i64 %73
  %74 = add i64 %indvars.iv37, 1
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.loopexit, %.lr.ph.us
  ...
  br i1 %79, label %.preheader.us15.preheader, label %.lr.ph.us.new.preheader

.lr.ph.us.new.preheader:                          ; preds = %.prol.loopexit
  %80 = sub i64 %71, %indvars.iv.unr
  %81 = lshr i64 %80, 2
  %82 = add nuw nsw i64 %81, 1
  %min.iters.check111 = icmp ult i64 %82, 2
...
min.iters.checked112:                             ; preds = %.lr.ph.us.new.preheader
  %n.mod.vf113 = and i64 %82, 1
  %n.vec114 = sub nsw i64 %82, %n.mod.vf113
  %cmp.zero115 = icmp eq i64 %n.vec114, 0
  %83 = add i64 %indvars.iv.unr, 4
  %84 = shl nuw i64 %81, 2
  %85 = add i64 %83, %84
  %86 = shl nuw nsw i64 %n.mod.vf113, 2
  %ind.end120 = sub i64 %85, %86
...
vector.body108:                                   ; preds = %vector.body108, %vector.ph116
  ...
  %wide.vec126 = load <8 x double>, <8 x double>* %90, align 8
  ...
  %91 = fmul <2 x double> %strided.vec127, %broadcast.splat132
  %92 = fmul <2 x double> %strided.vec128, %broadcast.splat132
  %93 = fmul <2 x double> %strided.vec129, %broadcast.splat132
  %94 = add nsw i64 %88, 3
  %95 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv37, i64 %94
  %96 = fmul <2 x double> %strided.vec130, %broadcast.splat132
  ...
  %interleaved.vec133 = shufflevector <4 x double> %99, <4 x double> %100, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 1, i32 3, i32 5, i32 7>
  store <8 x double> %interleaved.vec133, <8 x double>* %98, align 8
  %index.next118 = add i64 %index117, 2
  %101 = icmp eq i64 %index.next118, %n.vec114
  br i1 %101, label %middle.block109, label %vector.body108, !llvm.loop !21
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.preheader3
  ...
  %102 = add i64 %indvars.iv53, -3
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %103 = trunc i64 %indvars.iv.next54 to i32
  %xtraiter48 = and i32 %103, 3
...
.prol.preheader46:                                ; preds = %.prol.preheader46.preheader, %.prol.preheader46
  ...
  %104 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %indvars.iv41.prol
...
.prol.loopexit47:                                 ; preds = %.prol.loopexit47.loopexit, %.lr.ph
  ...
  %107 = icmp ult i64 %indvars.iv53, 3
  br i1 %107, label %.preheader3, label %.lr.ph.new.preheader

.lr.ph.new.preheader:                             ; preds = %.prol.loopexit47
  %108 = sub i64 %102, %indvars.iv41.unr
  %109 = lshr i64 %108, 2
...
min.iters.checked:                                ; preds = %.lr.ph.new.preheader
  ...
  %111 = add i64 %indvars.iv41.unr, 4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %115 = shl i64 %index, 2
  %116 = add i64 %indvars.iv41.unr, %115
  %117 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %116
  %118 = bitcast double* %117 to <8 x double>*
  %wide.vec = load <8 x double>, <8 x double>* %118, align 8
  ...
  %119 = fmul <2 x double> %strided.vec, %broadcast.splat63
  %120 = fmul <2 x double> %strided.vec59, %broadcast.splat63
  %121 = fmul <2 x double> %strided.vec60, %broadcast.splat63
  %122 = add nsw i64 %116, 3
  %123 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %122
  %124 = fmul <2 x double> %strided.vec61, %broadcast.splat63
  %125 = getelementptr double, double* %123, i64 -3
  %126 = bitcast double* %125 to <8 x double>*
  %127 = shufflevector <2 x double> %119, <2 x double> %120, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %128 = shufflevector <2 x double> %121, <2 x double> %124, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %interleaved.vec = shufflevector <4 x double> %127, <4 x double> %128, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 1, i32 3, i32 5, i32 7>
  store <8 x double> %interleaved.vec, <8 x double>* %126, align 8
  %index.next = add i64 %index, 2
  %129 = icmp eq i64 %index.next, %n.vec
  br i1 %129, label %middle.block, label %vector.body, !llvm.loop !23
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader135, %.lr.ph.new
  ...
  %130 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %indvars.iv41
  %131 = load double, double* %130, align 8
  %132 = fmul double %131, %3
  store double %132, double* %130, align 8
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  %133 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %indvars.iv.next42
  %134 = load double, double* %133, align 8
  %135 = fmul double %134, %3
  store double %135, double* %133, align 8
  %indvars.iv.next42.1 = add nsw i64 %indvars.iv41, 2
  %136 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %indvars.iv.next42.1
  %137 = load double, double* %136, align 8
  %138 = fmul double %137, %3
  store double %138, double* %136, align 8
  %indvars.iv.next42.2 = add nsw i64 %indvars.iv41, 3
  %139 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %indvars.iv.next42.2
...
.preheader3:                                      ; preds = %.preheader3.loopexit, %middle.block, %.prol.loopexit47
  ...
  br i1 %exitcond56, label %._crit_edge13.loopexit137, label %.lr.ph
