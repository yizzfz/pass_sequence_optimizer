...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph30.split.us
  ...
  store double %10, double* %sunkaddr103, align 8
  ...
  store double %13, double* %sunkaddr103, align 8
  ...
  store double %16, double* %sunkaddr103, align 8
  ...
  store double %19, double* %sunkaddr103, align 8
...
._crit_edge27.us:                                 ; preds = %._crit_edge
  ...
  %sunkaddr96 = add i64 %20, %sunkaddr95
  %sunkaddr97 = inttoptr i64 %sunkaddr96 to double*
  store double %21, double* %sunkaddr97, align 8
...
.preheader6.us:                                   ; preds = %._crit_edge22.us, %._crit_edge27.us..preheader6.us_crit_edge
  ...
  %scevgep80 = getelementptr [1200 x double], [1200 x double]* %3, i64 %22, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %wide.vec87 = load <8 x double>, <8 x double>* %26, align 8, !alias.scope !4, !noalias !1
  %27 = fsub <8 x double> %wide.vec87, %wide.vec
...
._crit_edge67:                                    ; preds = %._crit_edge67, %._crit_edge67.preheader
  %indvars.iv50 = phi i64 [ 0, %._crit_edge67.preheader ], [ %indvars.iv.next51.3, %._crit_edge67 ]
...
._crit_edge68:                                    ; preds = %._crit_edge68, %.lr.ph.us.us
  %63 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %75, %._crit_edge68 ]
