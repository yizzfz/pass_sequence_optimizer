...
; Function Attrs: noinline norecurse nounwind uwtable
define internal void @kernel_gesummv(i32, double, double, [1300 x double]* nocapture readonly, [1300 x double]* nocapture readonly, double* nocapture, double* nocapture readonly, double* nocapture) #2 {
  %9 = icmp sgt i32 %0, 0
