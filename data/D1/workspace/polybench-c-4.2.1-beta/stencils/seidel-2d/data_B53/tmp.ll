...
.preheader3:                                      ; preds = %._crit_edge7, %.preheader3.lr.ph
  %.028 = phi i32 [ 0, %.preheader3.lr.ph ], [ %32, %._crit_edge7 ]
  br label %.preheader

.preheader:                                       ; preds = %.preheader3, %._crit_edge
  %indvar = phi i64 [ 0, %.preheader3 ], [ %indvar.next, %._crit_edge ]
  %indvars.iv10 = phi i64 [ 1, %.preheader3 ], [ %indvars.iv.next11, %._crit_edge ]
  %3 = add i64 %indvar, 1
...
._crit_edge:                                      ; preds = %5
  ...
  br i1 %exitcond13, label %._crit_edge7, label %.preheader

._crit_edge7:                                     ; preds = %._crit_edge
  %32 = add nuw nsw i32 %.028, 1
  %exitcond14 = icmp eq i32 %32, 500
  br i1 %exitcond14, label %._crit_edge9, label %.preheader3
...
; <label>:14:                                     ; preds = %12, %7
  ...
  %16 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv6, i64 %indvars.iv
  %17 = load double, double* %16, align 8
