...
._crit_edge12:                                    ; preds = %._crit_edge11, %.preheader.us
  ...
  %1 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv13, i64 %indvars.iv
  ...
  %8 = srem i32 %3, 11
  %9 = icmp eq i32 %8, 0
  %or.cond17 = or i1 %or.cond, %9
  br i1 %or.cond17, label %._crit_edge11, label %._crit_edge12.._crit_edge11_crit_edge

._crit_edge12.._crit_edge11_crit_edge:            ; preds = %._crit_edge12
...
._crit_edge11:                                    ; preds = %._crit_edge12, %._crit_edge12.._crit_edge11_crit_edge
  %storemerge = phi i32 [ %13, %._crit_edge12.._crit_edge11_crit_edge ], [ 999, %._crit_edge12 ]
...
.loopexit.us:                                     ; preds = %._crit_edge11
  ...
  %exitcond18 = icmp eq i64 %indvars.iv.next14, 2800
  br i1 %exitcond18, label %.loopexit3, label %.preheader.us
...
.preheader3.us..preheader.us.us_crit_edge:        ; preds = %.loopexit6.us, %.preheader3.lr.ph..preheader3.us_crit_edge
  %indvars.iv29 = phi i64 [ 0, %.preheader3.lr.ph..preheader3.us_crit_edge ], [ %indvars.iv.next30, %.loopexit6.us ]
  %scevgep4 = getelementptr [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv29, i64 0
...
.loopexit6.us:                                    ; preds = %.loopexit.us.us
  ...
  br i1 %exitcond32, label %.loopexit7, label %.preheader3.us..preheader.us.us_crit_edge

.preheader.us.us:                                 ; preds = %.loopexit.us.us, %.preheader3.us..preheader.us.us_crit_edge
  %indvars.iv27 = phi i64 [ 0, %.preheader3.us..preheader.us.us_crit_edge ], [ %indvars.iv.next28, %.loopexit.us.us ]
  %scevgep = getelementptr [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv27, i64 0
  %2 = add nuw nsw i64 %indvars.iv27, 1
  %scevgep2 = getelementptr [2800 x i32], [2800 x i32]* %0, i64 %2, i64 0
  %3 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv27, i64 %indvars.iv29
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %4 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv27, i64 %index
  ...
  %13 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv29, i64 %index
...
.loopexit.us.us:                                  ; preds = %.loopexit.us.us.loopexit16, %.loopexit.us.us.loopexit
  ...
  %exitcond31 = icmp eq i64 %indvars.iv.next28, 2800
  br i1 %exitcond31, label %.loopexit6.us, label %.preheader.us.us
...
._crit_edge26:                                    ; preds = %._crit_edge26, %._crit_edge26.preheader
  ...
  %26 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv27, i64 %indvars.iv
  %27 = load i32, i32* %26, align 4
  %28 = load i32, i32* %3, align 4
  %29 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv29, i64 %indvars.iv
  ...
  %33 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv27, i64 %indvars.iv.next
  %34 = load i32, i32* %33, align 4
  %35 = load i32, i32* %3, align 4
  %36 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv29, i64 %indvars.iv.next
...
.preheader.us:                                    ; preds = %.loopexit.us, %.preheader.lr.ph..preheader.us_crit_edge
  %indvars.iv11 = phi i64 [ 0, %.preheader.lr.ph..preheader.us_crit_edge ], [ %indvars.iv.next12, %.loopexit.us ]
  %5 = mul nuw nsw i64 %indvars.iv11, 2800
...
._crit_edge9:                                     ; preds = %._crit_edge10, %10
  ...
  %13 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv11, i64 %indvars.iv
...
.loopexit.us:                                     ; preds = %._crit_edge9
  ...
  br i1 %exitcond13, label %.loopexit3, label %.preheader.us
