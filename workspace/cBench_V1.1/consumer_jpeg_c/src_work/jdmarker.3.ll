...
@__llvm_prf_nm = private constant [134 x i8] c"\C9\02\82\01x\DAu\8D\D1\0A\830\0CE\F1\87d\82O\FB\99\92\D9\E8\A2\B5fI\18\DB\DF\AF\82\15Z\D9[\CF\B97\BD3\E3\E4\04\F5\1B\07g\DB\FE2\10kl\E5\AE\0D\E1\1E\F1cn\05YP\9A\99\22eHE\F0\C9\E5^\BA\C3\FF\19\F8#\D2R\1Eky g\BA\10\BB7\08\C1#\E0i\A74\00\CC\B7Zt\FDiF\12\BD\FC\B6\D7t\A3\8A\C7\8A\B5`\0FC\C9O+\F9U\B1\D0\0FT\1Ax\B1", section "__llvm_prf_names"
@llvm.used = appending global [19 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_resync_to_restart to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_next_marker to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jinit_marker_reader to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_reset_marker_reader to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_read_markers to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_read_restart_marker to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_skip_variable to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_get_app0 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_get_app14 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_first_marker to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_get_soi to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_get_sof to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_get_sos to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_get_dac to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_get_dht to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_get_dqt to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_get_dri to i8*), i8* bitcast ([105 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([134 x i8], [134 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
...
; <label>:109:                                    ; preds = %._crit_edge15, %._crit_edge16, %._crit_edge17, %._crit_edge18, %._crit_edge19, %._crit_edge20, %._crit_edge21, %._crit_edge22, %33
...
; <label>:190:                                    ; preds = %._crit_edge, %._crit_edge1, %._crit_edge2, %._crit_edge3, %._crit_edge4, %._crit_edge5, %._crit_edge6, %._crit_edge7, %._crit_edge8, %._crit_edge9, %._crit_edge10, %._crit_edge11, %._crit_edge12, %._crit_edge13, %._crit_edge14, %33
...
; <label>:224:                                    ; preds = %._crit_edge23, %._crit_edge24, %._crit_edge25, %._crit_edge26, %._crit_edge27, %._crit_edge28, %._crit_edge29, %._crit_edge30, %33
