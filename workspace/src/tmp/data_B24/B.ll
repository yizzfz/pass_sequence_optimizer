...
.us-lcssa.us.loopexit16:                          ; preds = %.loopexit
  br label %.us-lcssa.us

.us-lcssa.us:                                     ; preds = %.us-lcssa.us.loopexit16, %.us-lcssa.us.loopexit, %.split.us
  %.lcssa5 = phi float [ undef, %.split.us ], [ %57, %.us-lcssa.us.loopexit ], [ %78, %.us-lcssa.us.loopexit16 ]
  %62 = fptoui float %.lcssa5 to i8
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %.split
  ...
  br i1 %79, label %.us-lcssa.us.loopexit16, label %.split
