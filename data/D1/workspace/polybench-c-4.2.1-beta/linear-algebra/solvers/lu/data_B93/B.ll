...
.lr.ph93:                                         ; preds = %._crit_edge95.thread, %.preheader71.lr.ph
  %indvars.iv126 = phi i64 [ 0, %.preheader71.lr.ph ], [ %indvars.iv.next127, %._crit_edge95.thread ]
  %1 = shl i64 %indvars.iv126, 32
...
.preheader70:                                     ; preds = %8
  ...
  br i1 %4, label %._crit_edge95.thread, label %.preheader69.lr.ph

._crit_edge95.thread:                             ; preds = %.preheader70
  %5 = sub nsw i64 16000, %3
  %scevgep130 = getelementptr [2000 x double], [2000 x double]* %0, i64 %indvars.iv126, i64 %2
  %6 = bitcast double* %scevgep130 to i8*
  call void @llvm.memset.p0i8.i64(i8* %6, i8 0, i64 %5, i32 8, i1 false)
  %7 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv126, i64 %indvars.iv126
  store double 1.000000e+00, double* %7, align 8
  br label %.lr.ph93

; <label>:8:                                      ; preds = %8, %.lr.ph93
  %indvars.iv116 = phi i64 [ 0, %.lr.ph93 ], [ %indvars.iv.next117, %8 ]
  %9 = sub nsw i64 0, %indvars.iv116
  %10 = trunc i64 %9 to i32
  %11 = srem i32 %10, 2000
  %12 = sitofp i32 %11 to double
  %13 = fdiv double %12, 2.000000e+03
  %14 = fadd double %13, 1.000000e+00
  %15 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv126, i64 %indvars.iv116
  store double %14, double* %15, align 8
  %indvars.iv.next117 = add nuw nsw i64 %indvars.iv116, 1
  %exitcond120 = icmp eq i64 %indvars.iv116, %indvars.iv126
  br i1 %exitcond120, label %.preheader70, label %8

.preheader69.lr.ph:                               ; preds = %.preheader70
  %16 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv126, i64 %indvars.iv126
  store double 1.000000e+00, double* %16, align 8
  %17 = call i8* @polybench_alloc_data(i64 4000000, i32 8) #4
  br label %._crit_edge90.us

._crit_edge90.us:                                 ; preds = %._crit_edge90.us, %.preheader69.lr.ph
  %indvars.iv114 = phi i64 [ 0, %.preheader69.lr.ph ], [ %indvars.iv.next115.7, %._crit_edge90.us ]
  %18 = mul nuw nsw i64 %indvars.iv114, 16000
  %scevgep = getelementptr i8, i8* %17, i64 %18
  call void @llvm.memset.p0i8.i64(i8* %scevgep, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next115 = or i64 %indvars.iv114, 1
  %19 = mul nuw nsw i64 %indvars.iv.next115, 16000
  %scevgep.1 = getelementptr i8, i8* %17, i64 %19
  call void @llvm.memset.p0i8.i64(i8* %scevgep.1, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next115.1 = or i64 %indvars.iv114, 2
  %20 = mul nuw nsw i64 %indvars.iv.next115.1, 16000
  %scevgep.2 = getelementptr i8, i8* %17, i64 %20
  call void @llvm.memset.p0i8.i64(i8* %scevgep.2, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next115.2 = or i64 %indvars.iv114, 3
  %21 = mul nuw nsw i64 %indvars.iv.next115.2, 16000
  %scevgep.3 = getelementptr i8, i8* %17, i64 %21
  call void @llvm.memset.p0i8.i64(i8* %scevgep.3, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next115.3 = or i64 %indvars.iv114, 4
  %22 = mul nuw nsw i64 %indvars.iv.next115.3, 16000
  %scevgep.4 = getelementptr i8, i8* %17, i64 %22
  call void @llvm.memset.p0i8.i64(i8* %scevgep.4, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next115.4 = or i64 %indvars.iv114, 5
  %23 = mul nuw nsw i64 %indvars.iv.next115.4, 16000
  %scevgep.5 = getelementptr i8, i8* %17, i64 %23
  call void @llvm.memset.p0i8.i64(i8* %scevgep.5, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next115.5 = or i64 %indvars.iv114, 6
  %24 = mul nuw nsw i64 %indvars.iv.next115.5, 16000
  %scevgep.6 = getelementptr i8, i8* %17, i64 %24
  call void @llvm.memset.p0i8.i64(i8* %scevgep.6, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next115.6 = or i64 %indvars.iv114, 7
  %25 = mul nuw nsw i64 %indvars.iv.next115.6, 16000
  %scevgep.7 = getelementptr i8, i8* %17, i64 %25
  call void @llvm.memset.p0i8.i64(i8* %scevgep.7, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next115.7 = add nsw i64 %indvars.iv114, 8
  %exitcond45.7 = icmp eq i64 %indvars.iv.next115.7, 2000
  br i1 %exitcond45.7, label %.preheader67.us.us.preheader.preheader, label %._crit_edge90.us
...
.preheader67.us.us.preheader:                     ; preds = %._crit_edge._crit_edge.us, %.preheader67.us.us.preheader.preheader
  %indvars.iv109 = phi i64 [ %indvars.iv.next110, %._crit_edge._crit_edge.us ], [ 0, %.preheader67.us.us.preheader.preheader ]
  %scevgep3 = getelementptr [2000 x double], [2000 x double]* %0, i64 0, i64 %indvars.iv109
  %29 = add nuw nsw i64 %indvars.iv109, 1
...
._crit_edge._crit_edge.us:                        ; preds = %._crit_edge77.us.us
  %indvars.iv.next110 = add nuw nsw i64 %indvars.iv109, 1
  %exitcond44 = icmp eq i64 %indvars.iv.next110, 2000
  br i1 %exitcond44, label %.preheader.us.preheader, label %.preheader67.us.us.preheader

.preheader.us.preheader:                          ; preds = %._crit_edge._crit_edge.us
...
.preheader67.us.us:                               ; preds = %._crit_edge77.us.us, %.preheader67.us.us.preheader
  %indvars.iv107 = phi i64 [ 0, %.preheader67.us.us.preheader ], [ %indvars.iv.next108, %._crit_edge77.us.us ]
  %39 = mul nuw nsw i64 %indvars.iv107, 16000
  %scevgep1 = getelementptr i8, i8* %17, i64 %39
  %40 = add nuw nsw i64 %39, 16000
  %scevgep2 = getelementptr i8, i8* %17, i64 %40
  %41 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv107, i64 %indvars.iv109
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %50 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %index, i64 %indvars.iv109
  %51 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %42, i64 %indvars.iv109
  %52 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %43, i64 %indvars.iv109
  %53 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %44, i64 %indvars.iv109
  ...
  %64 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %28, i64 0, i64 %indvars.iv107, i64 %index
  ...
  br i1 %72, label %._crit_edge77.us.us.loopexit47, label %vector.body, !llvm.loop !9

._crit_edge77.us.us.loopexit:                     ; preds = %scalar.ph
  br label %._crit_edge77.us.us

._crit_edge77.us.us.loopexit47:                   ; preds = %vector.body
  br label %._crit_edge77.us.us

._crit_edge77.us.us:                              ; preds = %._crit_edge77.us.us.loopexit47, %._crit_edge77.us.us.loopexit
  %indvars.iv.next108 = add nuw nsw i64 %indvars.iv107, 1
  %exitcond43 = icmp eq i64 %indvars.iv.next108, 2000
  br i1 %exitcond43, label %._crit_edge._crit_edge.us, label %.preheader67.us.us

scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader
  %indvars.iv104 = phi i64 [ 0, %scalar.ph.preheader ], [ %indvars.iv.next105.1, %scalar.ph ]
  %73 = load double, double* %41, align 8
  %74 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv104, i64 %indvars.iv109
  %75 = load double, double* %74, align 8
  %76 = fmul double %73, %75
  %77 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv107, i64 %indvars.iv104
  ...
  %81 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv.next105, i64 %indvars.iv109
  %82 = load double, double* %81, align 8
  %83 = fmul double %80, %82
  %84 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %27, i64 0, i64 %indvars.iv107, i64 %indvars.iv.next105
  %85 = load double, double* %84, align 8
  %86 = fadd double %85, %83
  store double %86, double* %84, align 8
  %indvars.iv.next105.1 = add nsw i64 %indvars.iv104, 2
  %exitcond106.1 = icmp eq i64 %indvars.iv.next105, 1999
  br i1 %exitcond106.1, label %._crit_edge77.us.us.loopexit, label %scalar.ph, !llvm.loop !12

.preheader.us:                                    ; preds = %._crit_edge73.us, %.preheader.us.preheader
  %indvars.iv102 = phi i64 [ %indvars.iv.next103, %._crit_edge73.us ], [ 0, %.preheader.us.preheader ]
  %scevgep18 = getelementptr [2000 x double], [2000 x double]* %0, i64 %indvars.iv102, i64 0
...
vector.body13:                                    ; preds = %vector.body13, %vector.body13.preheader
  ...
  %90 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %37, i64 0, i64 %indvars.iv102, i64 %index30
  ...
  %94 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv102, i64 %index30
  ...
  %98 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %38, i64 0, i64 %indvars.iv102, i64 %index.next31
  ...
  %102 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv102, i64 %index.next31
  ...
  br i1 %106, label %._crit_edge73.us.loopexit46, label %vector.body13, !llvm.loop !18
...
scalar.ph15:                                      ; preds = %scalar.ph15, %scalar.ph15.preheader
  ...
  br i1 %exitcond.4, label %._crit_edge73.us.loopexit, label %scalar.ph15, !llvm.loop !19

._crit_edge73.us.loopexit:                        ; preds = %scalar.ph15
  br label %._crit_edge73.us

._crit_edge73.us.loopexit46:                      ; preds = %vector.body13
  br label %._crit_edge73.us

._crit_edge73.us:                                 ; preds = %._crit_edge73.us.loopexit46, %._crit_edge73.us.loopexit
  %indvars.iv.next103 = add nuw nsw i64 %indvars.iv102, 1
  %exitcond42 = icmp eq i64 %indvars.iv.next103, 2000
  br i1 %exitcond42, label %._crit_edge66._crit_edge, label %.preheader.us

._crit_edge66._crit_edge:                         ; preds = %._crit_edge73.us
  call void @free(i8* nonnull %17) #4
  ret void
}
