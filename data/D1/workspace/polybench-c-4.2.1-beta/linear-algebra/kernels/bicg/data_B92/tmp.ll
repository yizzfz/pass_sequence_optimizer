...
.lr.ph:                                           ; preds = %._crit_edge13, %._crit_edge6
  %indvars.iv7 = phi i64 [ %indvars.iv.next, %._crit_edge6 ], [ 0, %._crit_edge13 ]
  %19 = trunc i64 %indvars.iv7 to i32
  %20 = srem i32 %19, 20
  %21 = icmp eq i32 %20, 0
  br i1 %21, label %22, label %._crit_edge6
