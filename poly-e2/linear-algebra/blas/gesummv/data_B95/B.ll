...
for.end:                                          ; preds = %for.body5
  ...
  br i1 %exitcond6, label %for.end26, label %for.body
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc void @kernel_gesummv(i32 %n, double %alpha, double %beta, [1300 x double]* %A, [1300 x double]* %B, double* nocapture %tmp, double* %x, double* %y) unnamed_addr #2 {
entry:
...
for.body:                                         ; preds = %for.end, %entry
  %indvars.iv8 = phi i64 [ 0, %entry ], [ %indvars.iv.next9, %for.end ]
  %1 = phi double* [ %y, %entry ], [ %15, %for.end ]
  %arrayidx = getelementptr inbounds double, double* %tmp, i64 %indvars.iv8
  store double 0.000000e+00, double* %arrayidx, align 8
  %arrayidx4 = getelementptr inbounds double, double* %1, i64 %indvars.iv8
  store double 0.000000e+00, double* %arrayidx4, align 8
  %sunkaddr15 = shl i64 %indvars.iv8, 3
...
for.body7:                                        ; preds = %for.body7, %for.body
  ...
  %arrayidx11 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv8, i64 %indvars.iv
  %3 = load double, double* %arrayidx11, align 8
  %4 = load double*, double** %x.addr, align 8
  %arrayidx13 = getelementptr inbounds double, double* %4, i64 %indvars.iv
  %5 = load double, double* %arrayidx13, align 8
  %mul = fmul double %3, %5
  %6 = load double, double* %sunkaddr17, align 8
  %add = fadd double %mul, %6
  store double %add, double* %sunkaddr17, align 8
  %7 = load [1300 x double]*, [1300 x double]** %B.addr, align 8
  %arrayidx21 = getelementptr inbounds [1300 x double], [1300 x double]* %7, i64 %indvars.iv8, i64 %indvars.iv
  %8 = load double, double* %arrayidx21, align 8
  %9 = load double*, double** %x.addr, align 8
  %arrayidx23 = getelementptr inbounds double, double* %9, i64 %indvars.iv
  %10 = load double, double* %arrayidx23, align 8
  %mul24 = fmul double %8, %10
  %11 = load double*, double** %y.addr, align 8
  %arrayidx26 = getelementptr inbounds double, double* %11, i64 %indvars.iv8
...
for.end:                                          ; preds = %for.body7
  %sunkaddr5 = shl nsw i64 %indvars.iv8, 3
  %sunkaddr6 = add i64 %0, %sunkaddr5
  %sunkaddr7 = inttoptr i64 %sunkaddr6 to double*
  %13 = load double, double* %sunkaddr7, align 8
  %mul32 = fmul double %13, %alpha
  %14 = load double, double* %beta.addr, align 8
  %15 = load double*, double** %y.addr, align 8
  %arrayidx34 = getelementptr inbounds double, double* %15, i64 %indvars.iv8
  ...
  %exitcond10 = icmp eq i64 %indvars.iv.next9, 1300
  br i1 %exitcond10, label %for.end41, label %for.body
