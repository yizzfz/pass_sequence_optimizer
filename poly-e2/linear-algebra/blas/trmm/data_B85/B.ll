...
for.body14.us:                                    ; preds = %for.body14.us.preheader, %for.body14.us
  %indvars.iv15 = phi i64 [ %indvars.iv.next16.1, %for.body14.us ], [ 0, %for.body14.us.preheader ]
...
for.end29:                                        ; preds = %entry.for.end29_crit_edge, %for.end29.loopexit43, %for.end29.loopexit
  ret void
}
...
for.body.us:                                      ; preds = %for.cond1.for.inc30_crit_edge.us, %for.body.us.preheader
  ...
  %indvars.iv22 = phi i64 [ 1, %for.body.us.preheader ], [ %3, %for.cond1.for.inc30_crit_edge.us ]
