...
for.body3:                                        ; preds = %for.inc, %for.cond1.preheader
  ...
  br i1 %or.cond1, label %for.inc, label %for.body3.for.inc_crit_edge
...
for.inc20:                                        ; preds = %for.inc
  ...
  %exitcond8 = icmp eq i64 %indvars.iv.next7, 2800
...
for.cond1.preheader:                              ; preds = %for.inc38, %entry
  %indvars.iv6 = phi i64 [ 0, %entry ], [ %indvars.iv.next7, %for.inc38 ]
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load21 = load <4 x i32>, <4 x i32>* %12, align 4, !alias.scope !8
  %13 = getelementptr i32, i32* %11, i64 4
  %14 = bitcast i32* %13 to <4 x i32>*
  %wide.load22 = load <4 x i32>, <4 x i32>* %14, align 4, !alias.scope !8
  %15 = add nsw <4 x i32> %wide.load21, %8
  %16 = add nsw <4 x i32> %wide.load22, %10
  %17 = icmp slt <4 x i32> %wide.load, %15
  %18 = icmp slt <4 x i32> %wide.load20, %16
  %19 = select <4 x i1> %17, <4 x i32> %wide.load, <4 x i32> %15
  %20 = select <4 x i1> %18, <4 x i32> %wide.load20, <4 x i32> %16
  ...
  br i1 %23, label %for.inc35.loopexit25, label %vector.body, !llvm.loop !9
...
for.inc35:                                        ; preds = %for.inc35.loopexit25, %for.inc35.loopexit
  ...
  %exitcond23 = icmp eq i64 %indvars.iv.next5, 2800
  br i1 %exitcond23, label %for.inc38, label %for.cond4.preheader

for.inc38:                                        ; preds = %for.inc35
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %exitcond24 = icmp eq i64 %indvars.iv.next7, 2800
