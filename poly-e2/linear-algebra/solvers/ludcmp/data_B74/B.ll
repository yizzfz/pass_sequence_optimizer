...
for.inc:                                          ; preds = %for.inc, %entry
  %indvars.iv137 = phi i64 [ 0, %entry ], [ %indvars.iv.next138.1, %for.inc ]
  ...
  %exitcond148.1 = icmp eq i64 %indvars.iv.next138, 1999
  br i1 %exitcond148.1, label %for.inc25.lr.ph.preheader, label %for.inc

for.inc25.lr.ph.preheader:                        ; preds = %for.inc
  br label %for.inc25.lr.ph

for.inc25.lr.ph:                                  ; preds = %for.inc25.lr.ph.preheader, %for.inc44
  %indvars.iv135 = phi i64 [ %indvars.iv.next136, %for.inc44 ], [ 0, %for.inc25.lr.ph.preheader ]
  %5 = shl i64 %indvars.iv135, 32
  %sext = add nuw nsw i64 %5, 4294967296
  %6 = ashr exact i64 %sext, 32
  br label %for.inc25

for.cond13.for.cond29_crit_edge:                  ; preds = %for.inc25
...
for.inc25:                                        ; preds = %for.inc25, %for.inc25.lr.ph
  ...
  br i1 %exitcond128, label %for.cond13.for.cond29_crit_edge, label %for.inc25

for.inc37.for.inc44_crit_edge:                    ; preds = %for.cond13.for.cond29_crit_edge
  %9 = sub nsw i64 2000, %6
  %10 = shl nsw i64 %9, 3
  %scevgep146 = getelementptr [2000 x double], [2000 x double]* %A, i64 %indvars.iv135, i64 %6
  %11 = bitcast double* %scevgep146 to i8*
  call void @llvm.memset.p0i8.i64(i8* nonnull %11, i8 0, i64 %10, i32 8, i1 false)
  br label %for.inc44

for.inc44:                                        ; preds = %for.cond13.for.cond29_crit_edge, %for.inc37.for.inc44_crit_edge
  ...
  %exitcond167 = icmp eq i64 %indvars.iv.next136, 2000
  br i1 %exitcond167, label %for.end46, label %for.inc25.lr.ph
...
for.cond65.for.cond69_crit_edge.lr.ph:            ; preds = %for.inc62.us
  ...
  br label %for.cond65.for.cond69_crit_edge.us.for.cond69.for.cond73_crit_edge.us.us_crit_edge

for.cond65.for.cond69_crit_edge.us.for.cond69.for.cond73_crit_edge.us.us_crit_edge: ; preds = %for.inc96.us, %for.cond65.for.cond69_crit_edge.lr.ph
  %indvars.iv114 = phi i64 [ 0, %for.cond65.for.cond69_crit_edge.lr.ph ], [ %indvars.iv.next115, %for.inc96.us ]
  %scevgep3 = getelementptr [2000 x double], [2000 x double]* %A, i64 0, i64 %indvars.iv114
  %23 = add i64 %indvars.iv114, 1
  ...
  br label %for.cond69.for.cond73_crit_edge.us.us

for.inc96.us:                                     ; preds = %for.inc93.us.us
  %indvars.iv.next115 = add nuw nsw i64 %indvars.iv114, 1
  %exitcond165 = icmp eq i64 %indvars.iv.next115, 2000
  br i1 %exitcond165, label %for.cond99.for.cond103_crit_edge.us.preheader, label %for.cond65.for.cond69_crit_edge.us.for.cond69.for.cond73_crit_edge.us.us_crit_edge

for.cond99.for.cond103_crit_edge.us.preheader:    ; preds = %for.inc96.us
  ...
  br label %for.cond99.for.cond103_crit_edge.us

for.cond69.for.cond73_crit_edge.us.us:            ; preds = %for.inc93.us.us, %for.cond65.for.cond69_crit_edge.us.for.cond69.for.cond73_crit_edge.us.us_crit_edge
  %indvars.iv112 = phi i64 [ 0, %for.cond65.for.cond69_crit_edge.us.for.cond69.for.cond73_crit_edge.us.us_crit_edge ], [ %indvars.iv.next113, %for.inc93.us.us ]
  %33 = mul i64 %indvars.iv112, 16000
  %scevgep1 = getelementptr i8, i8* %call, i64 %33
  %34 = add i64 %33, 16000
  %scevgep2 = getelementptr i8, i8* %call, i64 %34
...
vector.body.preheader:                            ; preds = %for.cond69.for.cond73_crit_edge.us.us
  br label %vector.body

for.inc90.us.us.preheader:                        ; preds = %for.cond69.for.cond73_crit_edge.us.us
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %36 = or i64 %index, 2
  %37 = or i64 %index, 3
  %38 = load double, double* %arrayidx80.us.us, align 8, !alias.scope !1
  ...
  %43 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %index, i64 %indvars.iv114
  %44 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %35, i64 %indvars.iv114
  %45 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %36, i64 %indvars.iv114
  %46 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %37, i64 %indvars.iv114
  ...
  %55 = fmul <2 x double> %40, %52
  %56 = fmul <2 x double> %42, %54
  %57 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %22, i64 0, i64 %indvars.iv112, i64 %index
  %58 = bitcast double* %57 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %58, align 8, !alias.scope !6, !noalias !8
  %59 = getelementptr double, double* %57, i64 2
  %60 = bitcast double* %59 to <2 x double>*
  %wide.load12 = load <2 x double>, <2 x double>* %60, align 8, !alias.scope !6, !noalias !8
  %61 = fadd <2 x double> %wide.load, %55
  %62 = fadd <2 x double> %wide.load12, %56
  ...
  %65 = icmp eq i64 %index.next, 2000
  br i1 %65, label %for.inc93.us.us.loopexit43, label %vector.body, !llvm.loop !9
...
for.inc93.us.us:                                  ; preds = %for.inc93.us.us.loopexit43, %for.inc93.us.us.loopexit
  ...
  %exitcond164 = icmp eq i64 %indvars.iv.next113, 2000
  br i1 %exitcond164, label %for.inc96.us, label %for.cond69.for.cond73_crit_edge.us.us
...
for.inc90.us.us:                                  ; preds = %for.inc90.us.us, %for.inc90.us.us.preheader
  ...
  %67 = load double, double* %arrayidx84.us.us, align 8
  %mul.us.us = fmul double %66, %67
  %arrayidx88.us.us = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv112, i64 %indvars.iv108
  %68 = load double, double* %arrayidx88.us.us, align 8
  %add89.us.us = fadd double %68, %mul.us.us
  store double %add89.us.us, double* %arrayidx88.us.us, align 8
  %indvars.iv.next109 = or i64 %indvars.iv108, 1
  %69 = load double, double* %arrayidx80.us.us, align 8
  %arrayidx84.us.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv.next109, i64 %indvars.iv114
  %70 = load double, double* %arrayidx84.us.us.1, align 8
  %mul.us.us.1 = fmul double %69, %70
  %arrayidx88.us.us.1 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %21, i64 0, i64 %indvars.iv112, i64 %indvars.iv.next109
  %71 = load double, double* %arrayidx88.us.us.1, align 8
  %add89.us.us.1 = fadd double %71, %mul.us.us.1
  store double %add89.us.us.1, double* %arrayidx88.us.us.1, align 8
  %exitcond.1 = icmp eq i64 %indvars.iv.next109, 1999
...
for.cond99.for.cond103_crit_edge.us:              ; preds = %for.cond99.for.cond103_crit_edge.us.preheader, %for.inc118.us
  %indvars.iv106 = phi i64 [ %indvars.iv.next107, %for.inc118.us ], [ 0, %for.cond99.for.cond103_crit_edge.us.preheader ]
  %scevgep18 = getelementptr [2000 x double], [2000 x double]* %A, i64 %indvars.iv106, i64 0
  %scevgep1819 = bitcast double* %scevgep18 to i8*
  %72 = add i64 %indvars.iv106, 1
  %scevgep20 = getelementptr [2000 x double], [2000 x double]* %A, i64 %72, i64 0
  %scevgep2021 = bitcast double* %scevgep20 to i8*
  %73 = mul i64 %indvars.iv106, 16000
  %scevgep22 = getelementptr i8, i8* %call, i64 %73
  %74 = add i64 %73, 16000
  %scevgep23 = getelementptr i8, i8* %call, i64 %74
...
vector.body13.preheader:                          ; preds = %for.cond99.for.cond103_crit_edge.us
  br label %vector.body13

for.inc115.us.preheader:                          ; preds = %for.cond99.for.cond103_crit_edge.us
...
vector.body13:                                    ; preds = %vector.body13, %vector.body13.preheader
  ...
  %75 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %31, i64 0, i64 %indvars.iv106, i64 %index30
  %76 = bitcast double* %75 to <2 x i64>*
  %wide.load38 = load <2 x i64>, <2 x i64>* %76, align 8, !alias.scope !13
  %77 = getelementptr double, double* %75, i64 2
  %78 = bitcast double* %77 to <2 x i64>*
  %wide.load39 = load <2 x i64>, <2 x i64>* %78, align 8, !alias.scope !13
  %79 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv106, i64 %index30
  %80 = bitcast double* %79 to <2 x i64>*
  store <2 x i64> %wide.load38, <2 x i64>* %80, align 8, !alias.scope !16, !noalias !13
  %81 = getelementptr double, double* %79, i64 2
  %82 = bitcast double* %81 to <2 x i64>*
  store <2 x i64> %wide.load39, <2 x i64>* %82, align 8, !alias.scope !16, !noalias !13
  %index.next31 = or i64 %index30, 4
  %83 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %32, i64 0, i64 %indvars.iv106, i64 %index.next31
  %84 = bitcast double* %83 to <2 x i64>*
  %wide.load38.1 = load <2 x i64>, <2 x i64>* %84, align 8, !alias.scope !13
  %85 = getelementptr double, double* %83, i64 2
  %86 = bitcast double* %85 to <2 x i64>*
  %wide.load39.1 = load <2 x i64>, <2 x i64>* %86, align 8, !alias.scope !13
  %87 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv106, i64 %index.next31
  %88 = bitcast double* %87 to <2 x i64>*
  store <2 x i64> %wide.load38.1, <2 x i64>* %88, align 8, !alias.scope !16, !noalias !13
  %89 = getelementptr double, double* %87, i64 2
  %90 = bitcast double* %89 to <2 x i64>*
  store <2 x i64> %wide.load39.1, <2 x i64>* %90, align 8, !alias.scope !16, !noalias !13
  %index.next31.1 = add nsw i64 %index30, 8
  %91 = icmp eq i64 %index.next31.1, 2000
  br i1 %91, label %for.inc118.us.loopexit42, label %vector.body13, !llvm.loop !18
...
for.inc115.us:                                    ; preds = %for.inc115.us, %for.inc115.us.preheader
  ...
  %arrayidx110.us = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv106, i64 %indvars.iv
  %92 = bitcast double* %arrayidx110.us to i64*
  %93 = load i64, i64* %92, align 8
  %arrayidx114.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv106, i64 %indvars.iv
  %94 = bitcast double* %arrayidx114.us to i64*
  store i64 %93, i64* %94, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx110.us.1 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %27, i64 0, i64 %indvars.iv106, i64 %indvars.iv.next
  %95 = bitcast double* %arrayidx110.us.1 to i64*
  %96 = load i64, i64* %95, align 8
  %arrayidx114.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv106, i64 %indvars.iv.next
  %97 = bitcast double* %arrayidx114.us.1 to i64*
  store i64 %96, i64* %97, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %arrayidx110.us.2 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %28, i64 0, i64 %indvars.iv106, i64 %indvars.iv.next.1
  %98 = bitcast double* %arrayidx110.us.2 to i64*
  %99 = load i64, i64* %98, align 8
  %arrayidx114.us.2 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv106, i64 %indvars.iv.next.1
  %100 = bitcast double* %arrayidx114.us.2 to i64*
  store i64 %99, i64* %100, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %arrayidx110.us.3 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %29, i64 0, i64 %indvars.iv106, i64 %indvars.iv.next.2
  %101 = bitcast double* %arrayidx110.us.3 to i64*
  %102 = load i64, i64* %101, align 8
  %arrayidx114.us.3 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv106, i64 %indvars.iv.next.2
  %103 = bitcast double* %arrayidx114.us.3 to i64*
  store i64 %102, i64* %103, align 8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %arrayidx110.us.4 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %30, i64 0, i64 %indvars.iv106, i64 %indvars.iv.next.3
  %104 = bitcast double* %arrayidx110.us.4 to i64*
  %105 = load i64, i64* %104, align 8
  %arrayidx114.us.4 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv106, i64 %indvars.iv.next.3
  %106 = bitcast double* %arrayidx114.us.4 to i64*
...
for.inc118.us:                                    ; preds = %for.inc118.us.loopexit42, %for.inc118.us.loopexit
  ...
  %exitcond163 = icmp eq i64 %indvars.iv.next107, 2000
  br i1 %exitcond163, label %for.end120, label %for.cond99.for.cond103_crit_edge.us
...
for.cond.for.cond1_crit_edge:                     ; preds = %for.inc58, %entry
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.inc58 ], [ 0, %entry ]
  %indvars.iv142 = phi i64 [ %indvars.iv.next143, %for.inc58 ], [ 4294967295, %entry ]
  %0 = and i64 %indvars.iv142, 4294967295
  %cmp294 = icmp sgt i64 %indvars.iv2, 0
  br i1 %cmp294, label %for.body3.preheader, label %for.inc58

for.body3.preheader:                              ; preds = %for.cond.for.cond1_crit_edge
...
for.body30.us:                                    ; preds = %for.body30.us.preheader, %for.inc55.us
  ...
  br i1 %lcmp.mod13, label %for.inc48.us.prol, label %for.inc48.us.prol.loopexit
...
for.inc48.us.prol.loopexit:                       ; preds = %for.inc48.us.prol, %for.body30.us
  ...
  br i1 %20, label %for.inc55.us, label %for.body30.us.new
...
for.inc48.us:                                     ; preds = %for.inc48.us, %for.body30.us.new
  ...
  %exitcond144.1 = icmp eq i64 %indvars.iv.next125, %0
  %indvars.iv.next125.1 = add nsw i64 %indvars.iv124, 2
  br i1 %exitcond144.1, label %for.inc55.us.loopexit, label %for.inc48.us
...
for.body3:                                        ; preds = %for.body3.preheader, %for.inc25
  %indvars.iv139 = phi i64 [ %indvars.iv.next140, %for.inc25 ], [ 4294967295, %for.body3.preheader ]
  %indvars.iv121 = phi i64 [ %indvars.iv.next122, %for.inc25 ], [ 0, %for.body3.preheader ]
  %8 = and i64 %indvars.iv139, 4294967295
...
for.inc.preheader:                                ; preds = %for.body3
  %10 = and i64 %indvars.iv139, 1
  %lcmp.mod11 = icmp eq i64 %10, 0
...
for.inc.prol.loopexit:                            ; preds = %for.inc.prol, %for.inc.preheader
  ...
  %w.092.unr.ph = phi double [ %sub.prol, %for.inc.prol ], [ %9, %for.inc.preheader ]
  %13 = icmp eq i64 %8, 0
  br i1 %13, label %for.inc25, label %for.inc.preheader.new
...
for.inc:                                          ; preds = %for.inc, %for.inc.preheader.new
  ...
  %exitcond141.1 = icmp eq i64 %indvars.iv.next116, %8
  %indvars.iv.next116.1 = add nsw i64 %indvars.iv115, 2
  br i1 %exitcond141.1, label %for.inc25.loopexit, label %for.inc

for.inc25.loopexit:                               ; preds = %for.inc
  br label %for.inc25

for.inc25:                                        ; preds = %for.inc25.loopexit, %for.inc.prol.loopexit, %for.body3
  %w.0.lcssa = phi double [ %9, %for.body3 ], [ %sub.lcssa.unr.ph, %for.inc.prol.loopexit ], [ %sub.1, %for.inc25.loopexit ]
  ...
  %div = fdiv double %w.0.lcssa, %18
  store double %div, double* %arrayidx5, align 8
  %indvars.iv.next122 = add nuw nsw i64 %indvars.iv121, 1
  %indvars.iv.next140 = add nuw nsw i64 %8, 1
...
for.body30.us.preheader:                          ; preds = %for.inc25
  %19 = and i64 %indvars.iv142, 1
  %lcmp.mod13 = icmp eq i64 %19, 0
...
for.inc58:                                        ; preds = %for.inc58.loopexit, %for.cond.for.cond1_crit_edge
  %indvars.iv.next3 = add nuw nsw i64 %indvars.iv2, 1
  %indvars.iv.next143 = add nuw nsw i64 %0, 1
  %exitcond6 = icmp eq i64 %indvars.iv.next3, 2000
  br i1 %exitcond6, label %for.body63.preheader, label %for.cond.for.cond1_crit_edge

for.body63.preheader:                             ; preds = %for.inc58
  br label %for.body63

for.cond61.for.cond86_crit_edge.for.body88_crit_edge: ; preds = %for.inc82
  %21 = ptrtoint double* %x to i64
  br label %for.body88

for.body63:                                       ; preds = %for.body63.preheader, %for.inc82
  %indvars.iv136 = phi i64 [ %indvars.iv.next137, %for.inc82 ], [ 4294967295, %for.body63.preheader ]
  %indvars.iv113 = phi i64 [ %indvars.iv.next114, %for.inc82 ], [ 0, %for.body63.preheader ]
  %22 = and i64 %indvars.iv136, 4294967295
...
for.inc77.preheader:                              ; preds = %for.body63
  %24 = add nsw i64 %indvars.iv136, 1
  %xtraiter7 = and i64 %24, 3
...
for.inc77.prol:                                   ; preds = %for.inc77.prol, %for.inc77.prol.preheader
  ...
  %w.286.prol = phi double [ %sub76.prol, %for.inc77.prol ], [ %23, %for.inc77.prol.preheader ]
...
for.inc77.prol.loopexit:                          ; preds = %for.inc77.prol.loopexit.loopexit, %for.inc77.preheader
  ...
  %w.286.unr = phi double [ %23, %for.inc77.preheader ], [ %sub76.prol, %for.inc77.prol.loopexit.loopexit ]
  %27 = icmp ult i64 %22, 3
  br i1 %27, label %for.inc82, label %for.inc77.preheader.new
...
for.inc77:                                        ; preds = %for.inc77, %for.inc77.preheader.new
  ...
  %exitcond138.3 = icmp eq i64 %indvars.iv.next.2, %22
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  br i1 %exitcond138.3, label %for.inc82.loopexit, label %for.inc77

for.inc82.loopexit:                               ; preds = %for.inc77
  br label %for.inc82

for.inc82:                                        ; preds = %for.inc82.loopexit, %for.inc77.prol.loopexit, %for.body63
  %w.2.lcssa = phi double [ %23, %for.body63 ], [ %sub76.lcssa.unr, %for.inc77.prol.loopexit ], [ %sub76.3, %for.inc82.loopexit ]
  ...
  %indvars.iv.next137 = add nuw nsw i64 %22, 1
  %exitcond1 = icmp eq i64 %indvars.iv.next114, 2000
  br i1 %exitcond1, label %for.cond61.for.cond86_crit_edge.for.body88_crit_edge, label %for.body63

for.body88:                                       ; preds = %for.inc112, %for.cond61.for.cond86_crit_edge.for.body88_crit_edge
  %indvar = phi i64 [ %indvar.next, %for.inc112 ], [ 0, %for.cond61.for.cond86_crit_edge.for.body88_crit_edge ]
  %indvars.iv107 = phi i64 [ %indvars.iv.next108, %for.inc112 ], [ 2000, %for.cond61.for.cond86_crit_edge.for.body88_crit_edge ]
  %36 = add i64 %indvar, -1
...
for.inc102.prol.loopexit:                         ; preds = %for.inc102.prol.loopexit.loopexit, %for.inc102.preheader
  ...
  br i1 %40, label %for.inc112, label %for.inc102.preheader.new
...
for.inc112:                                       ; preds = %for.inc112.loopexit, %for.inc102.prol.loopexit, %for.body88
  %w.3.lcssa = phi double [ %37, %for.body88 ], [ %sub101.lcssa.unr, %for.inc102.prol.loopexit ], [ %sub101.3, %for.inc112.loopexit ]
  ...
  %sunkaddr149 = add i64 %21, %sunkaddr148
