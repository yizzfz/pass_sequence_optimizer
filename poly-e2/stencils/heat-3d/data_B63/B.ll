...
for.cond1.preheader.us:                           ; preds = %for.cond1.preheader.us.preheader, %for.inc22.us
  %indvars.iv51 = phi i64 [ %3, %for.cond1.preheader.us.preheader ], [ %indvars.iv.next52, %for.inc22.us ]
...
for.cond4.preheader.us.us.preheader:              ; preds = %for.cond1.preheader.us
  %7 = trunc i64 %indvars.iv51 to i32
...
for.inc22.us:                                     ; preds = %for.inc22.us.loopexit, %for.cond1.preheader.us
  ...
  %cmp.us = icmp slt i64 %indvars.iv.next52, %4
...
for.cond4.preheader.us.us:                        ; preds = %for.cond4.preheader.us.us.preheader, %for.inc19.us.us
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc19.us.us ], [ 0, %for.cond4.preheader.us.us.preheader ]
  %8 = trunc i64 %indvars.iv47 to i32
  %sub.us.us = add i32 %8, %7
...
for.body6.us.us.prol:                             ; preds = %for.cond4.preheader.us.us
  ...
  %arrayidx12.us.us.prol = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv51, i64 %indvars.iv47, i64 0
  store double %div.us.us.prol, double* %arrayidx12.us.us.prol, align 8
  %arrayidx18.us.us.prol = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvars.iv51, i64 %indvars.iv47, i64 0
...
for.body6.us.us.prol.loopexit:                    ; preds = %for.body6.us.us.prol, %for.cond4.preheader.us.us
  ...
  br i1 %6, label %for.inc19.us.us, label %for.body6.us.us.preheader
...
for.inc19.us.us:                                  ; preds = %for.inc19.us.us.loopexit, %for.body6.us.us.prol.loopexit
  ...
  br i1 %exitcond50, label %for.inc22.us.loopexit, label %for.cond4.preheader.us.us
...
for.body6.us.us:                                  ; preds = %for.body6.us.us.preheader, %for.body6.us.us
  ...
  %arrayidx12.us.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv51, i64 %indvars.iv47, i64 %indvars.iv
  store double %div.us.us, double* %arrayidx12.us.us, align 8
  %arrayidx18.us.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvars.iv51, i64 %indvars.iv47, i64 %indvars.iv
  ...
  %arrayidx12.us.us.1 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv51, i64 %indvars.iv47, i64 %indvars.iv.next
  store double %div.us.us.1, double* %arrayidx12.us.us.1, align 8
  %arrayidx18.us.us.1 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvars.iv51, i64 %indvars.iv47, i64 %indvars.iv.next
  store double %div.us.us.1, double* %arrayidx18.us.us.1, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond46.1 = icmp eq i64 %indvars.iv.next.1, %wide.trip.count.1
  br i1 %exitcond46.1, label %for.inc19.us.us.loopexit, label %for.body6.us.us
...
entry:
  ...
  %smax74 = select i1 %14, i64 %10, i64 2
  %15 = icmp sgt i64 %7, 2
  %smax93 = select i1 %15, i64 %7, i64 2
  %16 = add nsw i64 %smax93, -1
  %17 = icmp sgt i64 %7, 2
  %smax106 = select i1 %17, i64 %7, i64 2
  %min.iters.check = icmp ult i64 %13, 2
  %n.vec = and i64 %13, -2
  %cmp.zero = icmp eq i64 %n.vec, 0
  %ind.end = or i64 %13, 1
  %cmp.n = icmp eq i64 %13, %n.vec
  %min.iters.check94 = icmp ult i64 %16, 2
  %n.vec97 = and i64 %16, -2
  %cmp.zero98 = icmp eq i64 %n.vec97, 0
  %ind.end122 = or i64 %16, 1
  %cmp.n123 = icmp eq i64 %16, %n.vec97
...
for.cond4.preheader:                              ; preds = %for.cond4.preheader.preheader, %for.inc98
  %indvar100 = phi i64 [ %indvar.next101, %for.inc98 ], [ 0, %for.cond4.preheader.preheader ]
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc98 ], [ 1, %for.cond4.preheader.preheader ]
  %18 = add nuw nsw i64 %indvar100, 1
  %19 = add nuw nsw i64 %indvar100, 2
...
for.cond8.preheader.us:                           ; preds = %for.cond8.preheader.us.preheader, %for.inc95.us
  %indvar102 = phi i64 [ %indvar.next103, %for.inc95.us ], [ 0, %for.cond8.preheader.us.preheader ]
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc95.us ], [ 1, %for.cond8.preheader.us.preheader ]
  %22 = add nuw nsw i64 %indvar102, 1
  %scevgep104 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %6, i64 %18, i64 %22, i64 1
  %scevgep107 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %6, i64 %18, i64 %22, i64 %smax106
  %scevgep109 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %5, i64 %indvar100, i64 %22, i64 1
  %scevgep111 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %5, i64 %19, i64 %22, i64 %smax106
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %23 = add nsw i64 %indvars.iv53, -1
  br i1 %min.iters.check94, label %for.body11.us.preheader, label %min.iters.checked95

min.iters.checked95:                              ; preds = %for.cond8.preheader.us
  br i1 %cmp.zero98, label %for.body11.us.preheader, label %vector.memcheck117

vector.memcheck117:                               ; preds = %min.iters.checked95
  %bound0113 = icmp ult double* %scevgep104, %scevgep111
  %bound1114 = icmp ult double* %scevgep109, %scevgep107
  %memcheck.conflict116 = and i1 %bound0113, %bound1114
  br i1 %memcheck.conflict116, label %for.body11.us.preheader, label %vector.body90.preheader

vector.body90.preheader:                          ; preds = %vector.memcheck117
  br label %vector.body90

vector.body90:                                    ; preds = %vector.body90.preheader, %vector.body90
  %index119 = phi i64 [ %index.next120, %vector.body90 ], [ 0, %vector.body90.preheader ]
  %offset.idx124 = or i64 %index119, 1
  %24 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %5, i64 %20, i64 %indvars.iv53, i64 %offset.idx124
  %25 = bitcast double* %24 to <2 x double>*
  %wide.load128 = load <2 x double>, <2 x double>* %25, align 8, !alias.scope !1
  %26 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %5, i64 %indvars.iv56, i64 %indvars.iv53, i64 %offset.idx124
  %27 = bitcast double* %26 to <2 x double>*
  %wide.load129 = load <2 x double>, <2 x double>* %27, align 8, !alias.scope !1
  %28 = fmul <2 x double> %wide.load129, <double 2.000000e+00, double 2.000000e+00>
  %29 = fsub <2 x double> %wide.load128, %28
  %30 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %5, i64 %21, i64 %indvars.iv53, i64 %offset.idx124
  %31 = bitcast double* %30 to <2 x double>*
  %wide.load130 = load <2 x double>, <2 x double>* %31, align 8, !alias.scope !1
  %32 = fadd <2 x double> %29, %wide.load130
  %33 = fmul <2 x double> %32, <double 1.250000e-01, double 1.250000e-01>
  %34 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %5, i64 %indvars.iv56, i64 %indvars.iv.next54, i64 %offset.idx124
  %35 = bitcast double* %34 to <2 x double>*
  %wide.load131 = load <2 x double>, <2 x double>* %35, align 8, !alias.scope !1
  %36 = bitcast double* %26 to <2 x double>*
  %wide.load132 = load <2 x double>, <2 x double>* %36, align 8, !alias.scope !1
  %37 = fmul <2 x double> %wide.load132, <double 2.000000e+00, double 2.000000e+00>
  %38 = fsub <2 x double> %wide.load131, %37
  %39 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %5, i64 %indvars.iv56, i64 %23, i64 %offset.idx124
  %40 = bitcast double* %39 to <2 x double>*
  %wide.load133 = load <2 x double>, <2 x double>* %40, align 8, !alias.scope !1
  %41 = fadd <2 x double> %38, %wide.load133
  %42 = fmul <2 x double> %41, <double 1.250000e-01, double 1.250000e-01>
  %43 = fadd <2 x double> %33, %42
  %44 = add nuw nsw i64 %offset.idx124, 1
  %45 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %5, i64 %indvars.iv56, i64 %indvars.iv53, i64 %44
  %46 = bitcast double* %45 to <2 x double>*
  %wide.load134 = load <2 x double>, <2 x double>* %46, align 8, !alias.scope !1
  %47 = bitcast double* %26 to <2 x double>*
  %wide.load135 = load <2 x double>, <2 x double>* %47, align 8, !alias.scope !1
  %48 = fmul <2 x double> %wide.load135, <double 2.000000e+00, double 2.000000e+00>
  %49 = fsub <2 x double> %wide.load134, %48
  %50 = add nsw i64 %offset.idx124, -1
  %51 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %5, i64 %indvars.iv56, i64 %indvars.iv53, i64 %50
  %52 = bitcast double* %51 to <2 x double>*
  %wide.load136 = load <2 x double>, <2 x double>* %52, align 8, !alias.scope !1
  %53 = fadd <2 x double> %49, %wide.load136
  %54 = fmul <2 x double> %53, <double 1.250000e-01, double 1.250000e-01>
  %55 = fadd <2 x double> %43, %54
  %56 = bitcast double* %26 to <2 x double>*
  %wide.load137 = load <2 x double>, <2 x double>* %56, align 8, !alias.scope !1
  %57 = fadd <2 x double> %55, %wide.load137
  %58 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %6, i64 %indvars.iv56, i64 %indvars.iv53, i64 %offset.idx124
  %59 = bitcast double* %58 to <2 x double>*
  store <2 x double> %57, <2 x double>* %59, align 8, !alias.scope !4, !noalias !1
  %index.next120 = add i64 %index119, 2
  %60 = icmp eq i64 %index.next120, %n.vec97
  br i1 %60, label %middle.block91, label %vector.body90, !llvm.loop !6

middle.block91:                                   ; preds = %vector.body90
  br i1 %cmp.n123, label %for.inc95.us, label %for.body11.us.preheader

for.body11.us.preheader:                          ; preds = %middle.block91, %vector.memcheck117, %min.iters.checked95, %for.cond8.preheader.us
  %indvars.iv.ph = phi i64 [ 1, %vector.memcheck117 ], [ 1, %min.iters.checked95 ], [ 1, %for.cond8.preheader.us ], [ %ind.end122, %middle.block91 ]
...
for.inc95.us:                                     ; preds = %for.inc95.us.loopexit, %middle.block91
...
for.cond105.preheader:                            ; preds = %for.cond105.preheader.preheader, %for.inc206
  ...
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.inc206 ], [ 1, %for.cond105.preheader.preheader ]
...
for.cond109.preheader.lr.ph:                      ; preds = %for.cond105.preheader
  %74 = add nuw nsw i64 %indvars.iv67, 1
  %75 = add nsw i64 %indvars.iv67, -1
...
for.cond109.preheader.us:                         ; preds = %for.cond109.preheader.us.preheader, %for.inc203.us
  %indvar71 = phi i64 [ %indvar.next72, %for.inc203.us ], [ 0, %for.cond109.preheader.us.preheader ]
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc203.us ], [ 1, %for.cond109.preheader.us.preheader ]
  %76 = add nuw nsw i64 %indvar71, 1
  %scevgep = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %72, i64 %76, i64 1
  %scevgep75 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %72, i64 %76, i64 %smax74
  %scevgep77 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvar, i64 %76, i64 1
  %scevgep79 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %73, i64 %76, i64 %smax74
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %80 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv67, i64 %indvars.iv63, i64 %offset.idx
  %81 = bitcast double* %80 to <2 x double>*
  %wide.load81 = load <2 x double>, <2 x double>* %81, align 8, !alias.scope !10
  %82 = fmul <2 x double> %wide.load81, <double 2.000000e+00, double 2.000000e+00>
  ...
  %wide.load82 = load <2 x double>, <2 x double>* %85, align 8, !alias.scope !10
  %86 = fadd <2 x double> %83, %wide.load82
  %87 = fmul <2 x double> %86, <double 1.250000e-01, double 1.250000e-01>
  %88 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv67, i64 %indvars.iv.next64, i64 %offset.idx
  %89 = bitcast double* %88 to <2 x double>*
  %wide.load83 = load <2 x double>, <2 x double>* %89, align 8, !alias.scope !10
  %90 = bitcast double* %80 to <2 x double>*
  %wide.load84 = load <2 x double>, <2 x double>* %90, align 8, !alias.scope !10
  %91 = fmul <2 x double> %wide.load84, <double 2.000000e+00, double 2.000000e+00>
  %92 = fsub <2 x double> %wide.load83, %91
  %93 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv67, i64 %77, i64 %offset.idx
  %94 = bitcast double* %93 to <2 x double>*
  %wide.load85 = load <2 x double>, <2 x double>* %94, align 8, !alias.scope !10
  %95 = fadd <2 x double> %92, %wide.load85
  %96 = fmul <2 x double> %95, <double 1.250000e-01, double 1.250000e-01>
  %97 = fadd <2 x double> %87, %96
  %98 = add nuw nsw i64 %offset.idx, 1
  %99 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv67, i64 %indvars.iv63, i64 %98
  %100 = bitcast double* %99 to <2 x double>*
  %wide.load86 = load <2 x double>, <2 x double>* %100, align 8, !alias.scope !10
  %101 = bitcast double* %80 to <2 x double>*
  %wide.load87 = load <2 x double>, <2 x double>* %101, align 8, !alias.scope !10
  %102 = fmul <2 x double> %wide.load87, <double 2.000000e+00, double 2.000000e+00>
  %103 = fsub <2 x double> %wide.load86, %102
  %104 = add nsw i64 %offset.idx, -1
  %105 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv67, i64 %indvars.iv63, i64 %104
  %106 = bitcast double* %105 to <2 x double>*
  %wide.load88 = load <2 x double>, <2 x double>* %106, align 8, !alias.scope !10
  %107 = fadd <2 x double> %103, %wide.load88
  ...
  %wide.load89 = load <2 x double>, <2 x double>* %110, align 8, !alias.scope !10
  %111 = fadd <2 x double> %109, %wide.load89
  %112 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvars.iv67, i64 %indvars.iv63, i64 %offset.idx
...
for.body112.us:                                   ; preds = %for.body112.us.preheader, %for.body112.us
  ...
  %arrayidx125.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv67, i64 %indvars.iv63, i64 %indvars.iv60
  ...
  %arrayidx143.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv67, i64 %indvars.iv.next64, i64 %indvars.iv60
  %118 = load double, double* %arrayidx143.us, align 8
  %arrayidx149.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv67, i64 %indvars.iv63, i64 %indvars.iv60
  %119 = load double, double* %arrayidx149.us, align 8
  %mul150.us = fmul double %119, 2.000000e+00
  %sub151.us = fsub double %118, %mul150.us
  %arrayidx158.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv67, i64 %77, i64 %indvars.iv60
  ...
  %arrayidx168.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv67, i64 %indvars.iv63, i64 %indvars.iv.next61
  %121 = load double, double* %arrayidx168.us, align 8
  %arrayidx174.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv67, i64 %indvars.iv63, i64 %indvars.iv60
  ...
  %arrayidx183.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv67, i64 %indvars.iv63, i64 %123
  ...
  %arrayidx192.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv67, i64 %indvars.iv63, i64 %indvars.iv60
  %125 = load double, double* %arrayidx192.us, align 8
  %add193.us = fadd double %add186.us, %125
  %arrayidx199.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvars.iv67, i64 %indvars.iv63, i64 %indvars.iv60
...
for.inc203.us:                                    ; preds = %for.inc203.us.loopexit, %middle.block
  ...
  %indvar.next72 = add nuw nsw i64 %indvar71, 1
  br i1 %exitcond66, label %for.inc206.loopexit, label %for.cond109.preheader.us
...
for.inc206:                                       ; preds = %for.inc206.loopexit, %for.cond109.preheader.lr.ph, %for.cond105.preheader
  ...
  %cmp103 = icmp slt i64 %indvars.iv.next68, %11
...
for.cond2.preheader.us:                           ; preds = %for.cond2.preheader.us.preheader, %for.inc21.us
  %indvars.iv53 = phi i64 [ %6, %for.cond2.preheader.us.preheader ], [ %indvars.iv.next54, %for.inc21.us ]
...
for.inc21.us:                                     ; preds = %for.inc21.us.loopexit, %for.cond2.preheader.us
  ...
  %cmp.us = icmp slt i64 %indvars.iv.next54, %8
...
for.cond5.preheader.us.us:                        ; preds = %for.cond5.preheader.us.us.preheader, %for.inc18.us.us
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc18.us.us ], [ 0, %for.cond5.preheader.us.us.preheader ]
...
for.inc18.us.us:                                  ; preds = %if.end.us.us
  ...
  br i1 %exitcond52, label %for.inc21.us.loopexit, label %for.cond5.preheader.us.us
...
if.end.us.us:                                     ; preds = %if.then.us.us, %for.body7.us.us
  ...
  %arrayidx16.us.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %5, i64 %indvars.iv53, i64 %indvars.iv49, i64 %indvars.iv
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond48 = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond48, label %for.inc18.us.us, label %for.body7.us.us

for.cond.for.end23_crit_edge.loopexit:            ; preds = %for.inc21.us
  %18 = trunc i64 %indvars.iv.next54 to i32
