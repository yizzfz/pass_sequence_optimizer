...
; <label>:8:                                      ; preds = %._crit_edge, %.preheader
  ...
  br i1 %exitcond.1, label %23, label %._crit_edge
...
; <label>:23:                                     ; preds = %8
  ...
  br i1 %25, label %..preheader_crit_edge, label %26
...
; <label>:26:                                     ; preds = %23
  ...
  br i1 %28, label %..preheader23_crit_edge, label %29

..preheader23_crit_edge:                          ; preds = %26
  br label %.preheader23
...
.preheader116:                                    ; preds = %..preheader116_crit_edge, %2
  %.0111123 = phi i32 [ 1, %2 ], [ %162, %..preheader116_crit_edge ]
  br label %.preheader114

.preheader114:                                    ; preds = %..preheader114_crit_edge, %.preheader116
  %indvar21 = phi i64 [ 0, %.preheader116 ], [ %indvar.next22, %..preheader114_crit_edge ]
  %.0109119 = phi i32 [ 1, %.preheader116 ], [ %80, %..preheader114_crit_edge ]
...
.preheader112:                                    ; preds = %middle.block17..preheader112_crit_edge, %.preheader114
  %indvar23 = phi i64 [ 0, %.preheader114 ], [ %indvar.next24, %middle.block17..preheader112_crit_edge ]
  %.0107118 = phi i32 [ 1, %.preheader114 ], [ %77, %middle.block17..preheader112_crit_edge ]
...
vector.body16:                                    ; preds = %vector.body16.vector.body16_crit_edge, %vector.body16.preheader
  %index39 = phi i64 [ %index.next40, %vector.body16.vector.body16_crit_edge ], [ 0, %vector.body16.preheader ]
  ...
  br i1 %47, label %middle.block17.loopexit56, label %vector.body16.vector.body16_crit_edge, !llvm.loop !6

vector.body16.vector.body16_crit_edge:            ; preds = %vector.body16
  br label %vector.body16

scalar.ph18:                                      ; preds = %scalar.ph18.scalar.ph18_crit_edge, %scalar.ph18.preheader
  %indvars.iv = phi i64 [ %indvars.iv.next, %scalar.ph18.scalar.ph18_crit_edge ], [ 1, %scalar.ph18.preheader ]
  ...
  br i1 %exitcond, label %middle.block17.loopexit, label %scalar.ph18.scalar.ph18_crit_edge, !llvm.loop !9

scalar.ph18.scalar.ph18_crit_edge:                ; preds = %scalar.ph18
  br label %scalar.ph18
...
middle.block17:                                   ; preds = %middle.block17.loopexit56, %middle.block17.loopexit
  ...
  br i1 %78, label %middle.block17..preheader112_crit_edge, label %79

middle.block17..preheader112_crit_edge:           ; preds = %middle.block17
  br label %.preheader112
...
; <label>:79:                                     ; preds = %middle.block17
  ...
  br i1 %81, label %..preheader114_crit_edge, label %.preheader113.preheader

..preheader114_crit_edge:                         ; preds = %79
  br label %.preheader114

.preheader113.preheader:                          ; preds = %79
  br label %.preheader113

.preheader113:                                    ; preds = %..preheader113_crit_edge, %.preheader113.preheader
  %indvar = phi i64 [ %indvar.next, %..preheader113_crit_edge ], [ 0, %.preheader113.preheader ]
  %.1110122 = phi i32 [ %159, %..preheader113_crit_edge ], [ 1, %.preheader113.preheader ]
  %82 = add i64 %indvar, 1
  %83 = add i64 %indvar, 2
...
.preheader:                                       ; preds = %middle.block..preheader_crit_edge, %.preheader113
  %indvar1 = phi i64 [ 0, %.preheader113 ], [ %indvar.next2, %middle.block..preheader_crit_edge ]
  %.1108121 = phi i32 [ 1, %.preheader113 ], [ %156, %middle.block..preheader_crit_edge ]
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.body.preheader
  ...
  br i1 %126, label %middle.block.loopexit55, label %vector.body.vector.body_crit_edge, !llvm.loop !15

vector.body.vector.body_crit_edge:                ; preds = %vector.body
  br label %vector.body

scalar.ph:                                        ; preds = %scalar.ph.scalar.ph_crit_edge, %scalar.ph.preheader
  %indvars.iv124 = phi i64 [ %indvars.iv.next125, %scalar.ph.scalar.ph_crit_edge ], [ 1, %scalar.ph.preheader ]
  ...
  br i1 %exitcond126, label %middle.block.loopexit, label %scalar.ph.scalar.ph_crit_edge, !llvm.loop !16
...
middle.block:                                     ; preds = %middle.block.loopexit55, %middle.block.loopexit
  ...
  br i1 %157, label %middle.block..preheader_crit_edge, label %158
...
; <label>:158:                                    ; preds = %middle.block
  ...
  br i1 %160, label %..preheader113_crit_edge, label %161

..preheader113_crit_edge:                         ; preds = %158
  br label %.preheader113

; <label>:161:                                    ; preds = %158
  %162 = add nuw nsw i32 %.0111123, 1
  %exitcond127 = icmp eq i32 %162, 501
  br i1 %exitcond127, label %163, label %..preheader116_crit_edge

..preheader116_crit_edge:                         ; preds = %161
  br label %.preheader116
...
; <label>:12:                                     ; preds = %._crit_edge1, %.preheader
...
; <label>:19:                                     ; preds = %._crit_edge, %17
  ...
  br i1 %exitcond, label %24, label %._crit_edge1
...
; <label>:24:                                     ; preds = %19
  ...
  br i1 %26, label %..preheader_crit_edge, label %27
...
; <label>:27:                                     ; preds = %24
  ...
  br i1 %29, label %..preheader20_crit_edge, label %30

..preheader20_crit_edge:                          ; preds = %27
  br label %.preheader20
