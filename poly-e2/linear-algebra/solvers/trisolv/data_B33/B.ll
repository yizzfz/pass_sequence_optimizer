...
entry:
  ...
  %8 = bitcast [2000 x double]** %b to double**
  %9 = load double*, double** %8, align 8
  tail call fastcc void @init_array(i32 %3, [2000 x double]* %5, double* %7, double* %9)
  tail call void (...) @polybench_timer_start() #4
  %10 = load i32, i32* %n, align 4
  %11 = bitcast [2000 x [2000 x double]]** %L to [2000 x double]**
  %12 = load [2000 x double]*, [2000 x double]** %11, align 8
  %13 = bitcast [2000 x double]** %x to double**
  %14 = load double*, double** %13, align 8
  %15 = bitcast [2000 x double]** %b to double**
  %16 = load double*, double** %15, align 8
  tail call fastcc void @kernel_trisolv(i32 %10, [2000 x double]* %12, double* %14, double* %16)
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %21 = bitcast [2000 x double]** %x to double**
  %22 = load double*, double** %21, align 8
  tail call fastcc void @print_array(i32 %20, double* %22)
  br label %if.end

if.end:                                           ; preds = %land.lhs.true, %entry, %if.then
  %23 = bitcast [2000 x [2000 x double]]** %L to i8**
  %24 = load i8*, i8** %23, align 8
  tail call void @free(i8* %24) #4
  %25 = bitcast [2000 x double]** %x to i8**
  %26 = load i8*, i8** %25, align 8
  tail call void @free(i8* %26) #4
  %27 = bitcast [2000 x double]** %b to i8**
...
for.body:                                         ; preds = %for.inc14, %for.body.lr.ph
  ...
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc14 ], [ %4, %for.body.lr.ph ]
  %indvars.iv6 = phi i32 [ %indvars.iv.next7, %for.inc14 ], [ %i.promoted, %for.body.lr.ph ]
  ...
  %cmp41 = icmp sgt i64 %indvars.iv8, -1
  br i1 %cmp41, label %for.body6.preheader, label %for.inc14
...
for.body6.prol:                                   ; preds = %for.body6.prol.preheader
  ...
  %arrayidx13.prol = getelementptr inbounds [2000 x double], [2000 x double]* %3, i64 %indvars.iv8, i64 0
...
for.body6.prol.loopexit:                          ; preds = %for.body6.prol.loopexit.unr-lcssa
  %10 = icmp eq i32 %6, 0
  br i1 %10, label %for.inc14.loopexit, label %for.body6.preheader.new
...
for.body6:                                        ; preds = %for.body6, %for.body6.preheader.new
  ...
  %arrayidx13 = getelementptr inbounds [2000 x double], [2000 x double]* %3, i64 %indvars.iv8, i64 %indvars.iv
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %12 = trunc i64 %indvars.iv.next to i32
  %add7.1 = sub i32 %sub, %12
...
for.inc14:                                        ; preds = %for.inc14.loopexit, %for.body
  ...
  %cmp = icmp slt i64 %indvars.iv.next9, %5
...
for.body:                                         ; preds = %for.end, %for.body.lr.ph
  ...
  br i1 %cmp41, label %for.body5.lr.ph, label %for.end
...
for.body:                                         ; preds = %for.inc, %for.body.lr.ph
  ...
  %call2 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %9, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i64 0, i64 0), double %10) #4
  %11 = trunc i64 %indvars.iv to i32
  %rem = srem i32 %11, 20
