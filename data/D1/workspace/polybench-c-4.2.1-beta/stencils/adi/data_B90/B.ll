...
.preheader4:                                      ; preds = %._crit_edge22..preheader4_crit_edge, %.preheader4.lr.ph
  %.0323 = phi i32 [ 1, %.preheader4.lr.ph ], [ %152, %._crit_edge22..preheader4_crit_edge ]
  br label %.lver.check

.lver.check:                                      ; preds = %._crit_edge9.us..lver.check_crit_edge, %.preheader4
  %indvar = phi i64 [ 0, %.preheader4 ], [ %6, %._crit_edge9.us..lver.check_crit_edge ]
  %indvars.iv28 = phi i64 [ 1, %.preheader4 ], [ %indvars.iv.next29, %._crit_edge9.us..lver.check_crit_edge ]
  %6 = add i64 %indvar, 1
...
._crit_edge9.us:                                  ; preds = %.lr.ph8.us
  ...
  br i1 %exitcond38, label %.lver.check65.preheader, label %._crit_edge9.us..lver.check_crit_edge
...
.lr.ph8.us:                                       ; preds = %.lr.ph8.us..lr.ph8.us_crit_edge, %._crit_edge.us
  %indvars.iv26 = phi i64 [ 998, %._crit_edge.us ], [ %indvars.iv.next27.1, %.lr.ph8.us..lr.ph8.us_crit_edge ]
  %37 = phi double [ 1.000000e+00, %._crit_edge.us ], [ %50, %.lr.ph8.us..lr.ph8.us_crit_edge ]
...
; <label>:53:                                     ; preds = %._crit_edge, %.ph
  %store_forwarded50 = phi double [ %load_initial49, %.ph ], [ %70, %._crit_edge ]
  ...
  br i1 %exitcond, label %._crit_edge.us.loopexit74, label %._crit_edge
...
.lver.check65:                                    ; preds = %._crit_edge19.us..lver.check65_crit_edge, %.lver.check65.preheader
  %indvar51 = phi i64 [ %73, %._crit_edge19.us..lver.check65_crit_edge ], [ 0, %.lver.check65.preheader ]
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %._crit_edge19.us..lver.check65_crit_edge ], [ 1, %.lver.check65.preheader ]
  %73 = add i64 %indvar51, 1
...
.ph66.lver.orig:                                  ; preds = %.ph66.lver.orig..ph66.lver.orig_crit_edge, %.ph66.lver.orig.preheader
  %indvars.iv30.lver.orig = phi i64 [ %indvars.iv.next31.lver.orig, %.ph66.lver.orig..ph66.lver.orig_crit_edge ], [ 1, %.ph66.lver.orig.preheader ]
  ...
  br i1 %exitcond33.lver.orig, label %._crit_edge15.us.loopexit, label %.ph66.lver.orig..ph66.lver.orig_crit_edge

.ph66.lver.orig..ph66.lver.orig_crit_edge:        ; preds = %.ph66.lver.orig
  br label %.ph66.lver.orig
...
._crit_edge19.us:                                 ; preds = %.lr.ph18.us
  ...
  br i1 %exitcond39, label %._crit_edge22, label %._crit_edge19.us..lver.check65_crit_edge

._crit_edge19.us..lver.check65_crit_edge:         ; preds = %._crit_edge19.us
  br label %.lver.check65

.lr.ph18.us:                                      ; preds = %.lr.ph18.us..lr.ph18.us_crit_edge, %._crit_edge15.us
  %indvars.iv34 = phi i64 [ 998, %._crit_edge15.us ], [ %indvars.iv.next35.1, %.lr.ph18.us..lr.ph18.us_crit_edge ]
  %110 = phi double [ 1.000000e+00, %._crit_edge15.us ], [ %123, %.lr.ph18.us..lr.ph18.us_crit_edge ]
...
; <label>:126:                                    ; preds = %._crit_edge75, %.ph66
  %store_forwarded72 = phi double [ %load_initial71, %.ph66 ], [ %148, %._crit_edge75 ]
  %store_forwarded69 = phi double [ %load_initial68, %.ph66 ], [ %137, %._crit_edge75 ]
  %indvars.iv30 = phi i64 [ 1, %.ph66 ], [ %indvars.iv.next31, %._crit_edge75 ]
  ...
  %131 = insertelement <2 x double> undef, double %store_forwarded69, i32 0
  ...
  %146 = fmul double %store_forwarded72, 0xC08F400000000001
  ...
  br i1 %exitcond33, label %._crit_edge15.us.loopexit73, label %._crit_edge75

._crit_edge75:                                    ; preds = %126
  br label %126

._crit_edge15.us.loopexit:                        ; preds = %.ph66.lver.orig
  br label %._crit_edge15.us

._crit_edge15.us.loopexit73:                      ; preds = %126
  br label %._crit_edge15.us
...
._crit_edge22:                                    ; preds = %._crit_edge19.us
  ...
  br i1 %151, label %._crit_edge22..preheader4_crit_edge, label %._crit_edge24
