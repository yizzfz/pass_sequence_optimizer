...
define internal fastcc void @kernel_gesummv(double, double, [1300 x double]* nocapture readonly, [1300 x double]* nocapture readonly, double* nocapture, double* nocapture readonly, double* nocapture) unnamed_addr #2 {
  %sunkaddr21 = ptrtoint double* %4 to i64
  %sunkaddr = ptrtoint double* %4 to i64
  %sunkaddr13 = ptrtoint double* %6 to i64
  %sunkaddr25 = ptrtoint double* %6 to i64
  br label %8

; <label>:8:                                      ; preds = %25, %7
  %indvars.iv3 = phi i64 [ 0, %7 ], [ %indvars.iv.next4, %25 ]
  ...
  %sunkaddr15 = add i64 %sunkaddr13, %sunkaddr6
...
; <label>:11:                                     ; preds = %11, %8
  ...
  %23 = load double, double* %sunkaddr16, align 8
  %24 = fadd double %22, %23
  store double %24, double* %sunkaddr16, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
  br i1 %exitcond, label %25, label %11

; <label>:25:                                     ; preds = %11
  %sunkaddr22 = shl nuw nsw i64 %indvars.iv3, 3
