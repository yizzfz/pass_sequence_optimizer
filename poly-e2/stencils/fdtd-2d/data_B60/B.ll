...
for.cond5.preheader.us:                           ; preds = %for.cond5.preheader.us.preheader, %for.end38.us
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.end38.us ], [ 0, %for.cond5.preheader.us.preheader ]
...
for.body8.us:                                     ; preds = %for.body8.us, %for.cond5.preheader.us
  ...
  br i1 %exitcond, label %for.end38.us, label %for.body8.us

for.end38.us:                                     ; preds = %for.body8.us
...
for.cond1.preheader:                              ; preds = %for.end112, %entry
  %indvars.iv42 = phi i64 [ 0, %entry ], [ %indvars.iv.next43, %for.end112 ]
  br label %for.body3

for.cond10.preheader.us:                          ; preds = %for.cond10.preheader.us.preheader, %for.end33.us
  %indvar = phi i64 [ %indvar.next, %for.end33.us ], [ 0, %for.cond10.preheader.us.preheader ]
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.end33.us ], [ 1, %for.cond10.preheader.us.preheader ]
  %0 = add i64 %indvar, 1
  %1 = add nsw i64 %indvars.iv18, -1
  %scevgep123 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %0, i64 0
  %scevgep126 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %0, i64 1200
  %scevgep129 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvar, i64 0
  %scevgep132 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %0, i64 1200
  %bound0134 = icmp ult double* %scevgep123, %scevgep132
  %bound1135 = icmp ult double* %scevgep129, %scevgep126
  %memcheck.conflict137 = and i1 %bound0134, %bound1135
  br i1 %memcheck.conflict137, label %for.body12.us.preheader, label %vector.body113.preheader

vector.body113.preheader:                         ; preds = %for.cond10.preheader.us
...
vector.body113:                                   ; preds = %vector.body113.preheader, %vector.body113
  ...
  %2 = shl i64 %index140, 1
  %3 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv18, i64 %2
  %4 = bitcast double* %3 to <4 x double>*
  %wide.vec149 = load <4 x double>, <4 x double>* %4, align 8, !alias.scope !3, !noalias !6
  ...
  %5 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv18, i64 %2
  %6 = bitcast double* %5 to <4 x double>*
  %wide.vec152 = load <4 x double>, <4 x double>* %6, align 8, !alias.scope !6
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %1, i64 %2
  %8 = bitcast double* %7 to <4 x double>*
  %wide.vec155 = load <4 x double>, <4 x double>* %8, align 8, !alias.scope !6
  %9 = fsub <4 x double> %wide.vec152, %wide.vec155
  ...
  %12 = fsub <2 x double> %strided.vec150, %11
  %13 = or i64 %2, 1
  %14 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv18, i64 %13
  %15 = fsub <4 x double> %wide.vec152, %wide.vec155
  ...
  %18 = fsub <2 x double> %strided.vec151, %17
  %19 = getelementptr double, double* %14, i64 -1
  %20 = bitcast double* %19 to <4 x double>*
  %interleaved.vec158 = shufflevector <2 x double> %12, <2 x double> %18, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec158, <4 x double>* %20, align 8, !alias.scope !3, !noalias !6
  %index.next141 = add i64 %index140, 2
  %21 = icmp eq i64 %index.next141, 600
  br i1 %21, label %middle.block114, label %vector.body113, !llvm.loop !8
...
for.body12.us:                                    ; preds = %for.body12.us.preheader, %for.body12.us
  %indvars.iv14 = phi i64 [ %indvars.iv.next15.1, %for.body12.us ], [ 0, %for.body12.us.preheader ]
  %arrayidx16.us = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv18, i64 %indvars.iv14
  %22 = load double, double* %arrayidx16.us, align 8
  %arrayidx20.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv18, i64 %indvars.iv14
  %23 = load double, double* %arrayidx20.us, align 8
  %arrayidx24.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %1, i64 %indvars.iv14
  ...
  %arrayidx16.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv18, i64 %indvars.iv.next15
  %25 = load double, double* %arrayidx16.us.1, align 8
  %arrayidx20.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv18, i64 %indvars.iv.next15
  %26 = load double, double* %arrayidx20.us.1, align 8
  %arrayidx24.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %1, i64 %indvars.iv.next15
  ...
  %exitcond17.1 = icmp eq i64 %indvars.iv.next15.1, 1200
  br i1 %exitcond17.1, label %for.end33.us.loopexit, label %for.body12.us, !llvm.loop !11

for.end33.us.loopexit:                            ; preds = %for.body12.us
  br label %for.end33.us

for.end33.us:                                     ; preds = %for.end33.us.loopexit, %middle.block114
  %indvars.iv.next19 = add nuw nsw i64 %indvars.iv18, 1
  %exitcond22 = icmp eq i64 %indvars.iv.next19, 1000
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond22, label %for.cond40.preheader.us.preheader, label %for.cond10.preheader.us

for.cond40.preheader.us.preheader:                ; preds = %for.end33.us
...
for.body3:                                        ; preds = %for.body3, %for.cond1.preheader
  ...
  %sunkaddr187 = mul i64 %indvars.iv42, 8
...
for.cond40.preheader.us:                          ; preds = %for.cond40.preheader.us.preheader, %for.end65.us
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.end65.us ], [ 0, %for.cond40.preheader.us.preheader ]
  %arrayidx46.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv29, i64 1
  %44 = load double, double* %arrayidx46.us.prol, align 8
  %arrayidx50.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv29, i64 1
  %45 = load double, double* %arrayidx50.us.prol, align 8
  %arrayidx55.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv29, i64 0
  ...
  %scevgep82 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv29, i64 2
  %scevgep85 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv29, i64 1200
  %scevgep88 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv29, i64 1
  %scevgep91 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv29, i64 1200
  %bound093 = icmp ult double* %scevgep82, %scevgep91
  %bound194 = icmp ult double* %scevgep88, %scevgep85
  %memcheck.conflict96 = and i1 %bound093, %bound194
  br i1 %memcheck.conflict96, label %for.body42.us.preheader, label %vector.body76.preheader

vector.body76.preheader:                          ; preds = %for.cond40.preheader.us
...
vector.body76:                                    ; preds = %vector.body76.preheader, %vector.body76
  ...
  %wide.vec107 = load <4 x double>, <4 x double>* %52, align 8, !alias.scope !15
  ...
  %53 = fsub <2 x double> %strided.vec109, %strided.vec108
  ...
  %wide.vec110 = load <4 x double>, <4 x double>* %60, align 8, !alias.scope !15
  ...
  %61 = fsub <2 x double> %strided.vec112, %strided.vec111
  %62 = fmul <2 x double> %61, <double 5.000000e-01, double 5.000000e-01>
  %63 = fsub <2 x double> %strided.vec106, %62
  ...
  %66 = icmp eq i64 %index.next100, 598
  br i1 %66, label %middle.block77, label %vector.body76, !llvm.loop !17

middle.block77:                                   ; preds = %vector.body76
  br label %for.body42.us.preheader

for.body42.us.preheader:                          ; preds = %middle.block77, %for.cond40.preheader.us
  %indvars.iv24.ph = phi i64 [ 2, %for.cond40.preheader.us ], [ 1198, %middle.block77 ]
...
for.body42.us:                                    ; preds = %for.body42.us.preheader, %for.body42.us
  ...
  %arrayidx46.us = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv29, i64 %indvars.iv24
  %67 = load double, double* %arrayidx46.us, align 8
  %arrayidx50.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv29, i64 %indvars.iv24
  %68 = load double, double* %arrayidx50.us, align 8
  %69 = add nsw i64 %indvars.iv24, -1
  %arrayidx55.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv29, i64 %69
  ...
  %arrayidx46.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv29, i64 %indvars.iv.next25
  %71 = load double, double* %arrayidx46.us.1, align 8
  %arrayidx50.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv29, i64 %indvars.iv.next25
  %72 = load double, double* %arrayidx50.us.1, align 8
  %arrayidx55.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv29, i64 %indvars.iv24
  ...
  br i1 %exitcond28.1, label %for.end65.us, label %for.body42.us, !llvm.loop !18

for.end65.us:                                     ; preds = %for.body42.us
  %indvars.iv.next30 = add nuw nsw i64 %indvars.iv29, 1
  %exitcond32 = icmp eq i64 %indvars.iv.next30, 1000
  br i1 %exitcond32, label %for.cond73.preheader.us.preheader, label %for.cond40.preheader.us

for.cond73.preheader.us.preheader:                ; preds = %for.end65.us
  br label %for.cond73.preheader.us

for.cond73.preheader.us:                          ; preds = %for.cond73.preheader.us.preheader, %for.end109.us
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.end109.us ], [ 0, %for.cond73.preheader.us.preheader ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv38, i64 0
  %scevgep53 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv38, i64 1199
  %scevgep55 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv38, i64 0
  %74 = add i64 %indvars.iv38, 1
  %scevgep57 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %74, i64 0
  %scevgep59 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %indvars.iv38, i64 0
  %scevgep61 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %74, i64 1199
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %75 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv38, i64 %index
  ...
  %wide.load67 = load <2 x double>, <2 x double>* %78, align 8, !alias.scope !19, !noalias !22
  %79 = or i64 %index, 1
  %80 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv38, i64 %79
  %81 = bitcast double* %80 to <2 x double>*
  %wide.load68 = load <2 x double>, <2 x double>* %81, align 8, !alias.scope !25
  %82 = getelementptr double, double* %80, i64 2
  %83 = bitcast double* %82 to <2 x double>*
  %wide.load69 = load <2 x double>, <2 x double>* %83, align 8, !alias.scope !25
  %84 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv38, i64 %index
  %85 = bitcast double* %84 to <2 x double>*
  %wide.load70 = load <2 x double>, <2 x double>* %85, align 8, !alias.scope !25
  %86 = getelementptr double, double* %84, i64 2
  %87 = bitcast double* %86 to <2 x double>*
  %wide.load71 = load <2 x double>, <2 x double>* %87, align 8, !alias.scope !25
  %88 = fsub <2 x double> %wide.load68, %wide.load70
  %89 = fsub <2 x double> %wide.load69, %wide.load71
  %90 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv.next39, i64 %index
  %91 = bitcast double* %90 to <2 x double>*
  %wide.load72 = load <2 x double>, <2 x double>* %91, align 8, !alias.scope !26
  %92 = getelementptr double, double* %90, i64 2
  %93 = bitcast double* %92 to <2 x double>*
  %wide.load73 = load <2 x double>, <2 x double>* %93, align 8, !alias.scope !26
  %94 = fadd <2 x double> %88, %wide.load72
  %95 = fadd <2 x double> %89, %wide.load73
  %96 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv38, i64 %index
  %97 = bitcast double* %96 to <2 x double>*
  %wide.load74 = load <2 x double>, <2 x double>* %97, align 8, !alias.scope !26
  %98 = getelementptr double, double* %96, i64 2
  %99 = bitcast double* %98 to <2 x double>*
  %wide.load75 = load <2 x double>, <2 x double>* %99, align 8, !alias.scope !26
  ...
  %105 = fsub <2 x double> %wide.load67, %103
...
for.body76.us.preheader:                          ; preds = %for.body76.us.preheader.loopexit, %for.cond73.preheader.us
  %indvars.iv34.ph = phi i64 [ 0, %for.cond73.preheader.us ], [ 1196, %for.body76.us.preheader.loopexit ]
  br label %for.body76.us

for.body76.us:                                    ; preds = %for.body76.us.preheader, %for.body76.us
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.body76.us ], [ %indvars.iv34.ph, %for.body76.us.preheader ]
  %arrayidx80.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv38, i64 %indvars.iv34
  %109 = load double, double* %arrayidx80.us, align 8
  %indvars.iv.next35 = add nuw nsw i64 %indvars.iv34, 1
  %arrayidx84.us = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv38, i64 %indvars.iv.next35
  %110 = load double, double* %arrayidx84.us, align 8
  %arrayidx88.us = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv38, i64 %indvars.iv34
  %111 = load double, double* %arrayidx88.us, align 8
  %sub89.us = fsub double %110, %111
  %arrayidx94.us = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv.next39, i64 %indvars.iv34
  %112 = load double, double* %arrayidx94.us, align 8
  %add95.us = fadd double %sub89.us, %112
  %arrayidx99.us = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv38, i64 %indvars.iv34
  ...
  %exitcond37 = icmp eq i64 %indvars.iv.next35, 1199
  br i1 %exitcond37, label %for.end109.us, label %for.body76.us, !llvm.loop !28

for.end109.us:                                    ; preds = %for.body76.us
  %exitcond41 = icmp eq i64 %indvars.iv.next39, 999
  br i1 %exitcond41, label %for.end112, label %for.cond73.preheader.us

for.end112:                                       ; preds = %for.end109.us
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1
  %exitcond45 = icmp eq i64 %indvars.iv.next43, 500
...
for.cond2.preheader.us:                           ; preds = %for.end.us, %entry
  %indvars.iv39 = phi i64 [ 0, %entry ], [ %indvars.iv.next40, %for.end.us ]
...
if.end.us:                                        ; preds = %for.body4.us, %if.then.us
  ...
  br i1 %exitcond38, label %for.end.us, label %for.body4.us
...
for.cond19.preheader.us:                          ; preds = %for.end36.us, %for.end12
  %indvars.iv28 = phi i64 [ 0, %for.end12 ], [ %indvars.iv.next29, %for.end36.us ]
...
for.cond45.preheader.us:                          ; preds = %for.end62.us, %for.end39
  %indvars.iv17 = phi i64 [ 0, %for.end39 ], [ %indvars.iv.next18, %for.end62.us ]
