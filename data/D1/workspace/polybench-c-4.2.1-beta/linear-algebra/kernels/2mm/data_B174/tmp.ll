...
._crit_edge28:                                    ; preds = %14, %6
  %indvars.iv19 = phi i64 [ 0, %6 ], [ %indvars.iv.next20, %14 ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge28
  %indvars.iv16 = phi i64 [ 0, %._crit_edge28 ], [ %indvars.iv.next17, %._crit_edge ]
...
; <label>:14:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond21, label %.preheader23.preheader, label %._crit_edge28

.preheader23.preheader:                           ; preds = %14
  br label %.preheader23

.preheader23:                                     ; preds = %.preheader23.preheader, %28
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %28 ], [ 0, %.preheader23.preheader ]
  br label %._crit_edge29

._crit_edge29:                                    ; preds = %._crit_edge29, %.preheader23
  %indvars.iv10 = phi i64 [ 0, %.preheader23 ], [ %indvars.iv.next11.1, %._crit_edge29 ]
  ...
  br i1 %exitcond12.1, label %28, label %._crit_edge29
...
.preheader22:                                     ; preds = %.preheader22.preheader, %37
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %37 ], [ 0, %.preheader22.preheader ]
  br label %._crit_edge30

._crit_edge30:                                    ; preds = %._crit_edge30, %.preheader22
  %indvars.iv4 = phi i64 [ 0, %.preheader22 ], [ %indvars.iv.next5, %._crit_edge30 ]
  ...
  br i1 %exitcond6, label %37, label %._crit_edge30
...
.preheader:                                       ; preds = %.preheader.preheader, %45
  %indvars.iv1 = phi i64 [ %indvars.iv.next2, %45 ], [ 0, %.preheader.preheader ]
...
._crit_edge31:                                    ; preds = %._crit_edge31, %.preheader
  ...
  br i1 %exitcond, label %45, label %._crit_edge31
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc void @kernel_2mm(double, double, [900 x double]*, [1100 x double]* nocapture readonly, [900 x double]* nocapture readonly, [1200 x double]*, [1200 x double]*) unnamed_addr #2 {
  %8 = alloca [900 x double]*, align 8
  %9 = alloca [1200 x double]*, align 8
  store [900 x double]* %2, [900 x double]** %8, align 8
  store [1200 x double]* %5, [1200 x double]** %9, align 8
  br label %._crit_edge38

._crit_edge38:                                    ; preds = %28, %7
  %indvars.iv13 = phi i64 [ 0, %7 ], [ %indvars.iv.next14, %28 ]
  %10 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv13
  %sunkaddr = ptrtoint [900 x double]* %10 to i64
  br label %._crit_edge37

._crit_edge37:                                    ; preds = %27, %._crit_edge38
  %indvars.iv10 = phi i64 [ 0, %._crit_edge38 ], [ %indvars.iv.next11, %27 ]
  %11 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv13, i64 %indvars.iv10
  store double 0.000000e+00, double* %11, align 8
  %sunkaddr17 = shl i64 %indvars.iv10, 3
  %sunkaddr18 = add i64 %sunkaddr, %sunkaddr17
  %sunkaddr19 = inttoptr i64 %sunkaddr18 to double*
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge37
  %indvars.iv7 = phi i64 [ 0, %._crit_edge37 ], [ %indvars.iv.next8.1, %._crit_edge ]
  %12 = phi double [ 0.000000e+00, %._crit_edge37 ], [ %26, %._crit_edge ]
  %13 = getelementptr inbounds [1100 x double], [1100 x double]* %3, i64 %indvars.iv13, i64 %indvars.iv7
  %14 = load double, double* %13, align 8
  %15 = fmul double %14, %0
  %16 = getelementptr inbounds [900 x double], [900 x double]* %4, i64 %indvars.iv7, i64 %indvars.iv10
  %17 = load double, double* %16, align 8
  %18 = fmul double %15, %17
  %19 = fadd double %12, %18
  store double %19, double* %sunkaddr19, align 8
  %indvars.iv.next8 = or i64 %indvars.iv7, 1
  %20 = getelementptr inbounds [1100 x double], [1100 x double]* %3, i64 %indvars.iv13, i64 %indvars.iv.next8
  %21 = load double, double* %20, align 8
  %22 = fmul double %21, %0
  %23 = getelementptr inbounds [900 x double], [900 x double]* %4, i64 %indvars.iv.next8, i64 %indvars.iv10
  %24 = load double, double* %23, align 8
  %25 = fmul double %22, %24
  %26 = fadd double %19, %25
  store double %26, double* %sunkaddr19, align 8
  %indvars.iv.next8.1 = add nuw nsw i64 %indvars.iv7, 2
  %exitcond9.1 = icmp eq i64 %indvars.iv.next8.1, 1100
  br i1 %exitcond9.1, label %27, label %._crit_edge

; <label>:27:                                     ; preds = %._crit_edge
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %exitcond12 = icmp eq i64 %indvars.iv.next11, 900
  br i1 %exitcond12, label %28, label %._crit_edge37

; <label>:28:                                     ; preds = %27
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 800
  br i1 %exitcond15, label %29, label %._crit_edge38

; <label>:29:                                     ; preds = %28
  %30 = load [900 x double]*, [900 x double]** %8, align 8
  %31 = load [1200 x double]*, [1200 x double]** %9, align 8
  br label %._crit_edge41

._crit_edge41:                                    ; preds = %50, %29
  %indvars.iv4 = phi i64 [ 0, %29 ], [ %indvars.iv.next5, %50 ]
  %32 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv4
  %sunkaddr24 = ptrtoint [1200 x double]* %32 to i64
  br label %._crit_edge40

._crit_edge40:                                    ; preds = %49, %._crit_edge41
  %indvars.iv1 = phi i64 [ 0, %._crit_edge41 ], [ %indvars.iv.next2, %49 ]
  %33 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv4, i64 %indvars.iv1
  %34 = load double, double* %33, align 8
  %35 = fmul double %34, %1
  store double %35, double* %33, align 8
  %sunkaddr25 = shl i64 %indvars.iv1, 3
  %sunkaddr26 = add i64 %sunkaddr24, %sunkaddr25
  %sunkaddr27 = inttoptr i64 %sunkaddr26 to double*
  br label %._crit_edge39

._crit_edge39:                                    ; preds = %._crit_edge39, %._crit_edge40
  %indvars.iv = phi i64 [ 0, %._crit_edge40 ], [ %indvars.iv.next.1, %._crit_edge39 ]
  %36 = phi double [ %35, %._crit_edge40 ], [ %48, %._crit_edge39 ]
  %37 = getelementptr inbounds [900 x double], [900 x double]* %30, i64 %indvars.iv4, i64 %indvars.iv
  %38 = load double, double* %37, align 8
  %39 = getelementptr inbounds [1200 x double], [1200 x double]* %31, i64 %indvars.iv, i64 %indvars.iv1
  %40 = load double, double* %39, align 8
  %41 = fmul double %38, %40
  %42 = fadd double %36, %41
  store double %42, double* %sunkaddr27, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %43 = getelementptr inbounds [900 x double], [900 x double]* %30, i64 %indvars.iv4, i64 %indvars.iv.next
  %44 = load double, double* %43, align 8
  %45 = getelementptr inbounds [1200 x double], [1200 x double]* %31, i64 %indvars.iv.next, i64 %indvars.iv1
  %46 = load double, double* %45, align 8
  %47 = fmul double %44, %46
  %48 = fadd double %42, %47
  store double %48, double* %sunkaddr27, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 900
  br i1 %exitcond.1, label %49, label %._crit_edge39

; <label>:49:                                     ; preds = %._crit_edge39
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 1200
  br i1 %exitcond3, label %50, label %._crit_edge40

; <label>:50:                                     ; preds = %49
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1
  %exitcond6 = icmp eq i64 %indvars.iv.next5, 800
  br i1 %exitcond6, label %51, label %._crit_edge41
