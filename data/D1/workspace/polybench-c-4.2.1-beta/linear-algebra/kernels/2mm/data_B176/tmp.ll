...
._crit_edge23.us:                                 ; preds = %._crit_edge
  ...
  %exitcond90 = icmp eq i64 %indvars.iv.next84, 800
  br i1 %exitcond90, label %.lr.ph19.split.us.new.preheader.preheader, label %.lr.ph26.split.us
...
._crit_edge16.us:                                 ; preds = %.lr.ph19.split.us.new
  ...
  %exitcond89 = icmp eq i64 %indvars.iv.next76, 1100
  br i1 %exitcond89, label %.lr.ph12.split.us.preheader, label %.lr.ph19.split.us.new.preheader
...
._crit_edge103:                                   ; preds = %._crit_edge103, %.lr.ph12.split.us
  %indvars.iv63 = phi i64 [ 0, %.lr.ph12.split.us ], [ %indvars.iv.next64, %._crit_edge103 ]
  ...
  br i1 %exitcond66, label %._crit_edge9.us, label %._crit_edge103

._crit_edge9.us:                                  ; preds = %._crit_edge103
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  %exitcond88 = icmp eq i64 %indvars.iv.next68, 900
  br i1 %exitcond88, label %.lr.ph5.split.us.preheader, label %.lr.ph12.split.us
...
._crit_edge104:                                   ; preds = %._crit_edge104, %.lr.ph5.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph5.split.us ], [ %indvars.iv.next, %._crit_edge104 ]
  ...
  br i1 %exitcond, label %._crit_edge.us, label %._crit_edge104

._crit_edge.us:                                   ; preds = %._crit_edge104
  %indvars.iv.next62 = add nuw nsw i64 %indvars.iv61, 1
  %exitcond87 = icmp eq i64 %indvars.iv.next62, 800
  br i1 %exitcond87, label %45, label %.lr.ph5.split.us
...
._crit_edge12.us:                                 ; preds = %._crit_edge9.us.us
  ...
  %exitcond96 = icmp eq i64 %indvar.next, 800
  br i1 %exitcond96, label %.lr.ph.us.us.preheader.preheader, label %.lr.ph8.us.us.preheader
...
._crit_edge3.us:                                  ; preds = %._crit_edge.us.us
  ...
  %exitcond103 = icmp eq i64 %indvars.iv.next69, 800
  br i1 %exitcond103, label %49, label %.lr.ph.us.us.preheader
...
._crit_edge.us.us:                                ; preds = %._crit_edge102
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1
  %exitcond67 = icmp eq i64 %indvars.iv.next65, 1200
  br i1 %exitcond67, label %._crit_edge3.us, label %.lr.ph.us.us

._crit_edge102:                                   ; preds = %._crit_edge102, %.lr.ph.us.us
  %30 = phi double [ %29, %.lr.ph.us.us ], [ %48, %._crit_edge102 ]
  %indvars.iv62 = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next63.2, %._crit_edge102 ]
  ...
  br i1 %exitcond.2, label %._crit_edge.us.us, label %._crit_edge102
