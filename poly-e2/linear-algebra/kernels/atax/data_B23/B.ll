...
for.inc:                                          ; preds = %for.inc, %entry
  ...
  br i1 %cmp.1, label %for.inc, label %for.body6.us.preheader
...
for.body5.us:                                     ; preds = %for.inc42.us, %for.body5.us.preheader
  ...
  %scevgep87 = getelementptr [2100 x double], [2100 x double]* %A, i64 %26, i64 0
...
for.inc39.us.for.inc39.us_crit_edge:              ; preds = %for.inc39.us.for.inc39.us_crit_edge.preheader, %for.inc39.us.for.inc39.us_crit_edge
  %indvars.iv.next6475 = phi i64 [ %indvars.iv.next64, %for.inc39.us.for.inc39.us_crit_edge ], [ %indvars.iv.next6475.ph, %for.inc39.us.for.inc39.us_crit_edge.preheader ]
  ...
  br i1 %cmp25.us, label %for.inc39.us.for.inc39.us_crit_edge, label %for.inc42.us, !llvm.loop !4

for.inc21.us:                                     ; preds = %for.inc21.us, %for.body5.us
  %29 = phi double [ %.pre, %for.body5.us ], [ %add.us.2, %for.inc21.us ]
...
for.inc39.us.preheader:                           ; preds = %for.inc21.us
  ...
  %37 = load double, double* %arrayidx32.us72, align 8
  %mul35.us73 = fmul double %37, %add.us.2
  %add36.us74 = fadd double %36, %mul35.us73
  ...
  br i1 %conflict.rdx, label %for.inc39.us.for.inc39.us_crit_edge.preheader, label %vector.body77.preheader

vector.body77.preheader:                          ; preds = %for.inc39.us.preheader
  br label %vector.body77

for.inc39.us.for.inc39.us_crit_edge.preheader.loopexit: ; preds = %vector.body77
...
for.inc39.us.for.inc39.us_crit_edge.preheader:    ; preds = %for.inc39.us.for.inc39.us_crit_edge.preheader.loopexit, %for.inc39.us.preheader
  %indvars.iv.next6475.ph = phi i64 [ 1, %for.inc39.us.preheader ], [ 2097, %for.inc39.us.for.inc39.us_crit_edge.preheader.loopexit ]
...
vector.body77:                                    ; preds = %vector.body77.preheader, %vector.body77
  ...
  %wide.load102 = load <2 x double>, <2 x double>* %44, align 8, !alias.scope !8, !noalias !10
  %45 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 %offset.idx
  %46 = bitcast double* %45 to <2 x double>*
  %wide.load103 = load <2 x double>, <2 x double>* %46, align 8, !alias.scope !12
  %47 = getelementptr double, double* %45, i64 2
  %48 = bitcast double* %47 to <2 x double>*
  %wide.load104 = load <2 x double>, <2 x double>* %48, align 8, !alias.scope !12
  %49 = fmul <2 x double> %wide.load103, %40
  %50 = fmul <2 x double> %wide.load104, %40
  %51 = fadd <2 x double> %wide.load, %49
  %52 = fadd <2 x double> %wide.load102, %50
  ...
  %53 = icmp eq i64 %index.next95, 2096
  br i1 %53, label %for.inc39.us.for.inc39.us_crit_edge.preheader.loopexit, label %vector.body77, !llvm.loop !13
