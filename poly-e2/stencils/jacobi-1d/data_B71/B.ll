...
for.body:                                         ; preds = %for.inc33, %for.body.lr.ph
...
for.body16:                                       ; preds = %for.body16.preheader, %for.body16
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.body16 ], [ 1, %for.body16.preheader ]
  %6 = add nsw i64 %indvars.iv15, -1
  %arrayidx19 = getelementptr inbounds double, double* %B, i64 %6
  %7 = load double, double* %arrayidx19, align 8
  ...
  %9 = load double, double* %arrayidx25, align 8
  %add26 = fadd double %add22, %9
  ...
  br i1 %cmp15, label %for.body16, label %for.inc33.loopexit
