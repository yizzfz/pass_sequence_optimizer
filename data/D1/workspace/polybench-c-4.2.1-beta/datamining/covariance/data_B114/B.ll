...
.lr.ph24.split.us:                                ; preds = %._crit_edge22.us, %.lr.ph24.split.us.preheader
  %indvars.iv66 = phi i64 [ 0, %.lr.ph24.split.us.preheader ], [ %indvars.iv.next67, %._crit_edge22.us ]
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv66
  store double 0.000000e+00, double* %5, align 8
  %sunkaddr99 = shl i64 %indvars.iv66, 3
  %sunkaddr100 = add i64 %4, %sunkaddr99
  %sunkaddr101 = inttoptr i64 %sunkaddr100 to double*
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph24.split.us
  %indvars.iv62 = phi i64 [ 0, %.lr.ph24.split.us ], [ %indvars.iv.next63.4, %._crit_edge ]
  %6 = phi double [ 0.000000e+00, %.lr.ph24.split.us ], [ %21, %._crit_edge ]
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv62, i64 %indvars.iv66
  %8 = load double, double* %7, align 8
  %9 = fadd double %6, %8
  store double %9, double* %sunkaddr101, align 8
  %indvars.iv.next63 = add nuw nsw i64 %indvars.iv62, 1
  %10 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next63, i64 %indvars.iv66
  %11 = load double, double* %10, align 8
  %12 = fadd double %9, %11
  store double %12, double* %sunkaddr101, align 8
  %indvars.iv.next63.1 = add nuw nsw i64 %indvars.iv62, 2
  %13 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next63.1, i64 %indvars.iv66
  %14 = load double, double* %13, align 8
  %15 = fadd double %12, %14
  store double %15, double* %sunkaddr101, align 8
  %indvars.iv.next63.2 = add nuw nsw i64 %indvars.iv62, 3
  %16 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next63.2, i64 %indvars.iv66
  %17 = load double, double* %16, align 8
  %18 = fadd double %15, %17
  store double %18, double* %sunkaddr101, align 8
  %indvars.iv.next63.3 = add nuw nsw i64 %indvars.iv62, 4
  %19 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next63.3, i64 %indvars.iv66
  %20 = load double, double* %19, align 8
  %21 = fadd double %18, %20
  store double %21, double* %sunkaddr101, align 8
  %indvars.iv.next63.4 = add nuw nsw i64 %indvars.iv62, 5
  %exitcond80.4 = icmp eq i64 %indvars.iv.next63.4, 1400
  br i1 %exitcond80.4, label %._crit_edge22.us, label %._crit_edge

._crit_edge22.us:                                 ; preds = %._crit_edge
  %22 = fdiv double %21, %0
  %sunkaddr24 = shl i64 %indvars.iv66, 3
  ...
  %exitcond81 = icmp eq i64 %indvars.iv.next67, 1200
  br i1 %exitcond81, label %._crit_edge22.us..lr.ph18.split.us_crit_edge, label %.lr.ph24.split.us

._crit_edge22.us..lr.ph18.split.us_crit_edge:     ; preds = %._crit_edge22.us
  %scevgep10 = getelementptr double, double* %3, i64 1200
  br label %vector.memcheck

vector.memcheck:                                  ; preds = %._crit_edge16.us, %._crit_edge22.us..lr.ph18.split.us_crit_edge
  %indvars.iv57 = phi i64 [ 0, %._crit_edge22.us..lr.ph18.split.us_crit_edge ], [ %23, %._crit_edge16.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv57, i64 0
  %23 = add nuw nsw i64 %indvars.iv57, 1
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv57, i64 %offset.idx
  ...
  %33 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv57, i64 %32
  ...
  br i1 %39, label %._crit_edge16.us.loopexit27, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv53 = phi i64 [ %indvars.iv.next54.3, %scalar.ph ], [ 0, %scalar.ph.preheader ]
  %40 = getelementptr inbounds double, double* %3, i64 %indvars.iv53
  %41 = load double, double* %40, align 8
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv57, i64 %indvars.iv53
  %43 = load double, double* %42, align 8
  %44 = fsub double %43, %41
  store double %44, double* %42, align 8
  %indvars.iv.next54 = or i64 %indvars.iv53, 1
  %45 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next54
  %46 = load double, double* %45, align 8
  %47 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv57, i64 %indvars.iv.next54
  %48 = load double, double* %47, align 8
  %49 = fsub double %48, %46
  store double %49, double* %47, align 8
  %indvars.iv.next54.1 = or i64 %indvars.iv53, 2
  %50 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next54.1
  %51 = load double, double* %50, align 8
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv57, i64 %indvars.iv.next54.1
  %53 = load double, double* %52, align 8
  %54 = fsub double %53, %51
  store double %54, double* %52, align 8
  %indvars.iv.next54.2 = or i64 %indvars.iv53, 3
  %55 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next54.2
  %56 = load double, double* %55, align 8
  %57 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv57, i64 %indvars.iv.next54.2
  %58 = load double, double* %57, align 8
  %59 = fsub double %58, %56
  store double %59, double* %57, align 8
  %indvars.iv.next54.3 = add nuw nsw i64 %indvars.iv53, 4
  %exitcond78.3 = icmp eq i64 %indvars.iv.next54.3, 1200
  br i1 %exitcond78.3, label %._crit_edge16.us.loopexit, label %scalar.ph, !llvm.loop !9

._crit_edge16.us.loopexit:                        ; preds = %scalar.ph
  br label %._crit_edge16.us

._crit_edge16.us.loopexit27:                      ; preds = %vector.body
  br label %._crit_edge16.us

._crit_edge16.us:                                 ; preds = %._crit_edge16.us.loopexit27, %._crit_edge16.us.loopexit
  %exitcond79 = icmp eq i64 %23, 1400
  br i1 %exitcond79, label %.lr.ph12.split.us.preheader, label %vector.memcheck

.lr.ph12.split.us.preheader:                      ; preds = %._crit_edge16.us
  %60 = fadd double %0, -1.000000e+00
  br label %.lr.ph9.us

.lr.ph9.us:                                       ; preds = %._crit_edge10.us-lcssa.us.us, %.lr.ph12.split.us.preheader
  %indvars.iv39 = phi i64 [ 0, %.lr.ph12.split.us.preheader ], [ %indvars.iv.next40, %._crit_edge10.us-lcssa.us.us ]
  br label %.lr.ph.us.us

._crit_edge10.us-lcssa.us.us:                     ; preds = %._crit_edge.us.us
  %indvars.iv.next40 = add nuw nsw i64 %indvars.iv39, 1
  %exitcond42 = icmp eq i64 %indvars.iv.next40, 1200
  br i1 %exitcond42, label %._crit_edge13, label %.lr.ph9.us

.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph9.us
  %indvars.iv35 = phi i64 [ %indvars.iv39, %.lr.ph9.us ], [ %indvars.iv.next36, %._crit_edge.us.us ]
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv39, i64 %indvars.iv35
...
._crit_edge.us.us:                                ; preds = %._crit_edge21
  ...
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv35, i64 %indvars.iv39
  store double %62, double* %63, align 8
  %indvars.iv.next36 = add nuw nsw i64 %indvars.iv35, 1
  %exitcond = icmp eq i64 %indvars.iv.next36, 1200
  br i1 %exitcond, label %._crit_edge10.us-lcssa.us.us, label %.lr.ph.us.us
...
._crit_edge21:                                    ; preds = %._crit_edge21, %.lr.ph.us.us
  ...
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv39
  %66 = load double, double* %65, align 8
  %67 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv35
  %68 = load double, double* %67, align 8
  %69 = fmul double %66, %68
  %70 = fadd double %64, %69
  store double %70, double* %61, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv39
  %72 = load double, double* %71, align 8
  %73 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv35
  %74 = load double, double* %73, align 8
  %75 = fmul double %72, %74
  %76 = fadd double %70, %75
  store double %76, double* %61, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond76.1 = icmp eq i64 %indvars.iv.next.1, 1400
  br i1 %exitcond76.1, label %._crit_edge.us.us, label %._crit_edge21

._crit_edge13:                                    ; preds = %._crit_edge10.us-lcssa.us.us
  ret void
}
...
.lr.ph2.split.us:                                 ; preds = %._crit_edge.us, %.lr.ph2.split.us.preheader
  %indvars.iv4 = phi i64 [ 0, %.lr.ph2.split.us.preheader ], [ %indvars.iv.next5, %._crit_edge.us ]
  %5 = mul nuw nsw i64 %indvars.iv4, 1200
  br label %._crit_edge2

._crit_edge2:                                     ; preds = %._crit_edge, %.lr.ph2.split.us
...
._crit_edge:                                      ; preds = %._crit_edge2, %10
  ...
  %exitcond8 = icmp eq i64 %indvars.iv.next, 1200
  br i1 %exitcond8, label %._crit_edge.us, label %._crit_edge2

._crit_edge.us:                                   ; preds = %._crit_edge
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1
  %exitcond7 = icmp eq i64 %indvars.iv.next5, 1200
  br i1 %exitcond7, label %._crit_edge3, label %.lr.ph2.split.us
