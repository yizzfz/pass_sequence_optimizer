...
@__llvm_prf_nm = private constant [52 x i8] c"62x\DA\CBI\CCM\8D/-NLOe\CC\0113Rs\0A \AC\82\A2\D4\E2\D4\92\E2\F8\CC\BC\B4|\A8HbQqj|bQz1\009\97\14\F2", section "__llvm_prf_names"
@llvm.used = appending global [5 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_lame_usage to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_lame_help to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_lame_presets_info to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_lame_parse_args to i8*), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
...
; <label>:92:                                     ; preds = %._crit_edge10, %85
  br label %93
...
; <label>:760:                                    ; preds = %._crit_edge4, %757
...
; <label>:770:                                    ; preds = %._crit_edge6, %766
  br label %1006
...
; <label>:778:                                    ; preds = %._crit_edge5, %777
...
; <label>:784:                                    ; preds = %._crit_edge7, %782
  br label %1006
...
; <label>:1021:                                   ; preds = %._crit_edge9, %1019
  br label %668
...
; <label>:1082:                                   ; preds = %._crit_edge, %1079
...
; <label>:1113:                                   ; preds = %._crit_edge1, %1112
...
; <label>:1130:                                   ; preds = %._crit_edge2, %1129
