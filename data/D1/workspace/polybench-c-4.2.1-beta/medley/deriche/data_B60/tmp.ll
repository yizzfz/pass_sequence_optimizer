...
._crit_edge15:                                    ; preds = %._crit_edge15.loopexit, %.preheader.lr.ph, %2
  ret void
}
...
.preheader173:                                    ; preds = %.preheader173.loopexit, %.preheader177, %5, %.preheader175
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %._crit_edge.us ], [ 0, %.preheader.us.preheader ]
  %6 = mul i64 %indvars.iv, 2160
  br label %7

; <label>:7:                                      ; preds = %14, %.preheader.us
  %indvars.iv.us = phi i64 [ 0, %.preheader.us ], [ %indvars.iv.next.us, %14 ]
  %8 = add i64 %indvars.iv.us, %6
...
; <label>:14:                                     ; preds = %12, %7
  ...
  %16 = getelementptr inbounds [2160 x float], [2160 x float]* %0, i64 %indvars.iv, i64 %indvars.iv.us
...
._crit_edge15:                                    ; preds = %._crit_edge15.loopexit, %.preheader.lr.ph, %1
