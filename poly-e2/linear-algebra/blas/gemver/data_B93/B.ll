...
for.inc.us:                                       ; preds = %for.inc.us, %for.body.us
  ...
  %arrayidx45.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv10, i64 %indvars.iv.next
  store double %div41.us.1, double* %arrayidx45.us.1, align 8
  %exitcond18.1 = icmp eq i64 %indvars.iv.next, 1999
...
for.body.us:                                      ; preds = %for.cond1.for.inc20_crit_edge.us, %entry
  %indvars.iv52 = phi i64 [ 0, %entry ], [ %0, %for.cond1.for.inc20_crit_edge.us ]
  %scevgep = getelementptr [2000 x double], [2000 x double]* %A, i64 %indvars.iv52, i64 0
  %0 = add i64 %indvars.iv52, 1
  %scevgep2 = getelementptr [2000 x double], [2000 x double]* %A, i64 %0, i64 0
  %arrayidx7.us = getelementptr inbounds double, double* %u1, i64 %indvars.iv52
  %arrayidx11.us = getelementptr inbounds double, double* %u2, i64 %indvars.iv52
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv52, i64 %index
  ...
  %wide.load25 = load <2 x double>, <2 x double>* %4, align 8, !alias.scope !1, !noalias !4
  %5 = load double, double* %arrayidx7.us, align 8, !alias.scope !9
  %6 = insertelement <2 x double> undef, double %5, i32 0
  %7 = shufflevector <2 x double> %6, <2 x double> undef, <2 x i32> zeroinitializer
  %8 = getelementptr inbounds double, double* %v1, i64 %index
  %9 = bitcast double* %8 to <2 x double>*
  %wide.load26 = load <2 x double>, <2 x double>* %9, align 8, !alias.scope !10
  %10 = getelementptr double, double* %8, i64 2
  %11 = bitcast double* %10 to <2 x double>*
  %wide.load27 = load <2 x double>, <2 x double>* %11, align 8, !alias.scope !10
  %12 = fmul <2 x double> %7, %wide.load26
  %13 = fmul <2 x double> %7, %wide.load27
  %14 = fadd <2 x double> %wide.load, %12
  %15 = fadd <2 x double> %wide.load25, %13
  %16 = load double, double* %arrayidx11.us, align 8, !alias.scope !11
  %17 = insertelement <2 x double> undef, double %16, i32 0
  %18 = shufflevector <2 x double> %17, <2 x double> undef, <2 x i32> zeroinitializer
  %19 = getelementptr inbounds double, double* %v2, i64 %index
  %20 = bitcast double* %19 to <2 x double>*
  %wide.load28 = load <2 x double>, <2 x double>* %20, align 8, !alias.scope !12
  %21 = getelementptr double, double* %19, i64 2
  %22 = bitcast double* %21 to <2 x double>*
  %wide.load29 = load <2 x double>, <2 x double>* %22, align 8, !alias.scope !12
  %23 = fmul <2 x double> %18, %wide.load28
  %24 = fmul <2 x double> %18, %wide.load29
  %25 = fadd <2 x double> %14, %23
  %26 = fadd <2 x double> %15, %24
  store <2 x double> %25, <2 x double>* %2, align 8, !alias.scope !1, !noalias !4
  store <2 x double> %26, <2 x double>* %4, align 8, !alias.scope !1, !noalias !4
  %index.next = add i64 %index, 4
  %27 = icmp eq i64 %index.next, 2000
  br i1 %27, label %for.cond1.for.inc20_crit_edge.us.loopexit60, label %vector.body, !llvm.loop !13

for.inc.us:                                       ; preds = %for.inc.us, %for.inc.us.preheader
  %indvars.iv48 = phi i64 [ 0, %for.inc.us.preheader ], [ %indvars.iv.next49.1, %for.inc.us ]
  %arrayidx5.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv52, i64 %indvars.iv48
  %28 = load double, double* %arrayidx5.us, align 8
  %29 = load double, double* %arrayidx7.us, align 8
  %arrayidx9.us = getelementptr inbounds double, double* %v1, i64 %indvars.iv48
  %30 = load double, double* %arrayidx9.us, align 8
  %mul.us = fmul double %29, %30
  %add.us = fadd double %28, %mul.us
  %31 = load double, double* %arrayidx11.us, align 8
  %arrayidx13.us = getelementptr inbounds double, double* %v2, i64 %indvars.iv48
  %32 = load double, double* %arrayidx13.us, align 8
  %mul14.us = fmul double %31, %32
  ...
  %arrayidx5.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv52, i64 %indvars.iv.next49
  %33 = load double, double* %arrayidx5.us.1, align 8
  %34 = load double, double* %arrayidx7.us, align 8
  %arrayidx9.us.1 = getelementptr inbounds double, double* %v1, i64 %indvars.iv.next49
  %35 = load double, double* %arrayidx9.us.1, align 8
  %mul.us.1 = fmul double %34, %35
  %add.us.1 = fadd double %33, %mul.us.1
  %36 = load double, double* %arrayidx11.us, align 8
  %arrayidx13.us.1 = getelementptr inbounds double, double* %v2, i64 %indvars.iv.next49
  %37 = load double, double* %arrayidx13.us.1, align 8
  %mul14.us.1 = fmul double %36, %37
  %add15.us.1 = fadd double %add.us.1, %mul14.us.1
  store double %add15.us.1, double* %arrayidx5.us.1, align 8
  %exitcond57.1 = icmp eq i64 %indvars.iv.next49, 1999
  %indvars.iv.next49.1 = add nsw i64 %indvars.iv48, 2
  br i1 %exitcond57.1, label %for.cond1.for.inc20_crit_edge.us.loopexit, label %for.inc.us, !llvm.loop !16
...
for.cond1.for.inc20_crit_edge.us:                 ; preds = %for.cond1.for.inc20_crit_edge.us.loopexit60, %for.cond1.for.inc20_crit_edge.us.loopexit
  %exitcond60 = icmp eq i64 %0, 2000
  br i1 %exitcond60, label %for.body25.us.preheader, label %for.body.us
...
for.body25.us:                                    ; preds = %for.body25.us.preheader, %for.cond26.for.inc45_crit_edge.us
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.cond26.for.inc45_crit_edge.us ], [ 0, %for.body25.us.preheader ]
...
for.inc42.us:                                     ; preds = %for.inc42.us, %for.body25.us
  %indvars.iv41 = phi i64 [ 0, %for.body25.us ], [ %indvars.iv.next42.1, %for.inc42.us ]
  %38 = phi double [ %.pre, %for.body25.us ], [ %add39.us.1, %for.inc42.us ]
  %arrayidx34.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv41, i64 %indvars.iv45
  %39 = load double, double* %arrayidx34.us, align 8
  %mul35.us = fmul double %39, %beta
  %arrayidx37.us = getelementptr inbounds double, double* %y, i64 %indvars.iv41
  %40 = load double, double* %arrayidx37.us, align 8
  %mul38.us = fmul double %mul35.us, %40
  %add39.us = fadd double %38, %mul38.us
  ...
  %41 = load double, double* %arrayidx34.us.1, align 8
  %mul35.us.1 = fmul double %41, %beta
  %arrayidx37.us.1 = getelementptr inbounds double, double* %y, i64 %indvars.iv.next42
  %42 = load double, double* %arrayidx37.us.1, align 8
  %mul38.us.1 = fmul double %mul35.us.1, %42
  %add39.us.1 = fadd double %add39.us, %mul38.us.1
  store double %add39.us.1, double* %arrayidx30.us, align 8
  %exitcond56.1 = icmp eq i64 %indvars.iv.next42, 1999
  %indvars.iv.next42.1 = add nsw i64 %indvars.iv41, 2
  br i1 %exitcond56.1, label %for.cond26.for.inc45_crit_edge.us, label %for.inc42.us

for.cond26.for.inc45_crit_edge.us:                ; preds = %for.inc42.us
  %indvars.iv.next46 = add nuw nsw i64 %indvars.iv45, 1
  %exitcond59 = icmp eq i64 %indvars.iv.next46, 2000
  br i1 %exitcond59, label %vector.memcheck45, label %for.body25.us
...
vector.body30:                                    ; preds = %vector.body30, %vector.body30.preheader
  ...
  %43 = getelementptr inbounds double, double* %x, i64 %index47
  %44 = bitcast double* %43 to <2 x double>*
  %wide.load55 = load <2 x double>, <2 x double>* %44, align 8, !alias.scope !17, !noalias !20
  %45 = getelementptr double, double* %43, i64 2
  %46 = bitcast double* %45 to <2 x double>*
  %wide.load56 = load <2 x double>, <2 x double>* %46, align 8, !alias.scope !17, !noalias !20
  %47 = getelementptr inbounds double, double* %z, i64 %index47
  %48 = bitcast double* %47 to <2 x double>*
  %wide.load57 = load <2 x double>, <2 x double>* %48, align 8, !alias.scope !20
  %49 = getelementptr double, double* %47, i64 2
  %50 = bitcast double* %49 to <2 x double>*
  %wide.load58 = load <2 x double>, <2 x double>* %50, align 8, !alias.scope !20
  %51 = fadd <2 x double> %wide.load55, %wide.load57
  %52 = fadd <2 x double> %wide.load56, %wide.load58
  store <2 x double> %51, <2 x double>* %44, align 8, !alias.scope !17, !noalias !20
  store <2 x double> %52, <2 x double>* %46, align 8, !alias.scope !17, !noalias !20
  %index.next48 = or i64 %index47, 4
  %53 = getelementptr inbounds double, double* %x, i64 %index.next48
  %54 = bitcast double* %53 to <2 x double>*
  %wide.load55.1 = load <2 x double>, <2 x double>* %54, align 8, !alias.scope !17, !noalias !20
  %55 = getelementptr double, double* %53, i64 2
  %56 = bitcast double* %55 to <2 x double>*
  %wide.load56.1 = load <2 x double>, <2 x double>* %56, align 8, !alias.scope !17, !noalias !20
  %57 = getelementptr inbounds double, double* %z, i64 %index.next48
  %58 = bitcast double* %57 to <2 x double>*
  %wide.load57.1 = load <2 x double>, <2 x double>* %58, align 8, !alias.scope !20
  %59 = getelementptr double, double* %57, i64 2
  %60 = bitcast double* %59 to <2 x double>*
  %wide.load58.1 = load <2 x double>, <2 x double>* %60, align 8, !alias.scope !20
  %61 = fadd <2 x double> %wide.load55.1, %wide.load57.1
  %62 = fadd <2 x double> %wide.load56.1, %wide.load58.1
  store <2 x double> %61, <2 x double>* %54, align 8, !alias.scope !17, !noalias !20
  store <2 x double> %62, <2 x double>* %56, align 8, !alias.scope !17, !noalias !20
  %index.next48.1 = add nsw i64 %index47, 8
  %63 = icmp eq i64 %index.next48.1, 2000
  br i1 %63, label %for.body63.us.preheader.loopexit59, label %vector.body30, !llvm.loop !22

for.inc58:                                        ; preds = %for.inc58, %for.inc58.preheader
  %indvars.iv37 = phi i64 [ 0, %for.inc58.preheader ], [ %indvars.iv.next38.4, %for.inc58 ]
  %arrayidx52 = getelementptr inbounds double, double* %x, i64 %indvars.iv37
  %64 = load double, double* %arrayidx52, align 8
  %arrayidx54 = getelementptr inbounds double, double* %z, i64 %indvars.iv37
  %65 = load double, double* %arrayidx54, align 8
  %add55 = fadd double %64, %65
  store double %add55, double* %arrayidx52, align 8
  %indvars.iv.next38 = add nuw nsw i64 %indvars.iv37, 1
  %arrayidx52.1 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next38
  %66 = load double, double* %arrayidx52.1, align 8
  %arrayidx54.1 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next38
  %67 = load double, double* %arrayidx54.1, align 8
  %add55.1 = fadd double %66, %67
  store double %add55.1, double* %arrayidx52.1, align 8
  %indvars.iv.next38.1 = add nsw i64 %indvars.iv37, 2
  %arrayidx52.2 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next38.1
  %68 = load double, double* %arrayidx52.2, align 8
  %arrayidx54.2 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next38.1
  %69 = load double, double* %arrayidx54.2, align 8
  %add55.2 = fadd double %68, %69
  store double %add55.2, double* %arrayidx52.2, align 8
  %indvars.iv.next38.2 = add nsw i64 %indvars.iv37, 3
  %arrayidx52.3 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next38.2
  %70 = load double, double* %arrayidx52.3, align 8
  %arrayidx54.3 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next38.2
  %71 = load double, double* %arrayidx54.3, align 8
  %add55.3 = fadd double %70, %71
  store double %add55.3, double* %arrayidx52.3, align 8
  %indvars.iv.next38.3 = add nsw i64 %indvars.iv37, 4
  %arrayidx52.4 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next38.3
  %72 = load double, double* %arrayidx52.4, align 8
  %arrayidx54.4 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next38.3
  %73 = load double, double* %arrayidx54.4, align 8
  %add55.4 = fadd double %72, %73
  store double %add55.4, double* %arrayidx52.4, align 8
  %exitcond.4 = icmp eq i64 %indvars.iv.next38.3, 1999
...
for.body63.us.preheader.loopexit59:               ; preds = %vector.body30
  br label %for.body63.us.preheader

for.body63.us.preheader:                          ; preds = %for.body63.us.preheader.loopexit59, %for.body63.us.preheader.loopexit
  br label %for.body63.us

for.body63.us:                                    ; preds = %for.body63.us.preheader, %for.cond64.for.inc83_crit_edge.us
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.cond64.for.inc83_crit_edge.us ], [ 0, %for.body63.us.preheader ]
  %arrayidx68.us = getelementptr inbounds double, double* %w, i64 %indvars.iv34
  %.pre33 = load double, double* %arrayidx68.us, align 8
...
for.inc80.us:                                     ; preds = %for.inc80.us, %for.body63.us
  ...
  %74 = phi double [ %.pre33, %for.body63.us ], [ %add77.us.1, %for.inc80.us ]
  %arrayidx72.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv34, i64 %indvars.iv
  ...
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx72.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv34, i64 %indvars.iv.next
  ...
  %exitcond55.1 = icmp eq i64 %indvars.iv.next, 1999
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  br i1 %exitcond55.1, label %for.cond64.for.inc83_crit_edge.us, label %for.inc80.us

for.cond64.for.inc83_crit_edge.us:                ; preds = %for.inc80.us
  %indvars.iv.next35 = add nuw nsw i64 %indvars.iv34, 1
  %exitcond58 = icmp eq i64 %indvars.iv.next35, 2000
  br i1 %exitcond58, label %for.end85, label %for.body63.us
