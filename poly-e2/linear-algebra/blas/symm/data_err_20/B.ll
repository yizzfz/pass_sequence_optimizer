...
entry:
  ...
  call fastcc void @kernel_symm(double %0, double %1, [1200 x double]* %arraydecay, [1000 x double]* %arraydecay3, [1200 x double]* %arraydecay7)
...
for.inc.us:                                       ; preds = %for.cond1.preheader.us, %for.inc.us
  %indvars.iv37 = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next38, %for.inc.us ]
...
for.inc36.prol.loopexit:                          ; preds = %for.inc36.prol, %for.inc36.preheader
  ...
  br i1 %9, label %for.cond40.preheader, label %for.inc36.preheader.new
...
for.cond40.preheader:                             ; preds = %for.cond40.preheader.loopexit, %for.inc36.prol.loopexit, %for.cond23.preheader
  ...
  br i1 %cmp4110, label %for.inc48.lr.ph, label %for.end53
...
for.inc48.prol:                                   ; preds = %for.inc48.prol.preheader, %for.inc48.prol
  %indvars.iv32.prol = phi i64 [ %indvars.iv.next33.prol, %for.inc48.prol ], [ %indvars.iv30, %for.inc48.prol.preheader ]
...
for.inc48.prol.loopexit:                          ; preds = %for.inc48.prol.loopexit.loopexit, %for.inc48.lr.ph
  %indvars.iv32.unr = phi i64 [ %indvars.iv30, %for.inc48.lr.ph ], [ %indvars.iv.next33.prol, %for.inc48.prol.loopexit.loopexit ]
  %10 = icmp ult i32 %6, 7
...
for.inc48:                                        ; preds = %for.inc48.preheader, %for.inc48
  %indvars.iv32 = phi i64 [ %indvars.iv.next33.7, %for.inc48 ], [ %indvars.iv32.unr, %for.inc48.preheader ]
  ...
  br i1 %exitcond34.7, label %for.inc51.loopexit, label %for.inc48
...
for.body3.preheader:                              ; preds = %for.cond1.preheader
  ...
  br i1 %conflict.rdx, label %for.body3.preheader1, label %vector.ph

for.body3.preheader1:                             ; preds = %for.body3.preheader
  br label %for.body3
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %26, label %for.inc53.loopexit5, label %vector.body, !llvm.loop !11
...
for.body3:                                        ; preds = %for.body3, %for.body3.preheader1
  %indvars.iv = phi i64 [ 0, %for.body3.preheader1 ], [ %indvars.iv.next.1, %for.body3 ]
  ...
  br i1 %cmp2.1, label %for.body3, label %for.inc53.loopexit4, !llvm.loop !14

for.inc53.loopexit:                               ; preds = %for.cond4.for.inc50_crit_edge.us
  br label %for.inc53

for.inc53.loopexit4:                              ; preds = %for.body3
  br label %for.inc53

for.inc53.loopexit5:                              ; preds = %vector.body
  br label %for.inc53

for.inc53:                                        ; preds = %for.inc53.loopexit5, %for.inc53.loopexit4, %for.inc53.loopexit
