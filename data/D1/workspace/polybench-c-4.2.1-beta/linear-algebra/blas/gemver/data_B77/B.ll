...
; <label>:43:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond3, label %44, label %._crit_edge1
...
._crit_edge1:                                     ; preds = %36, %11
  %indvars.iv18 = phi i64 [ 0, %11 ], [ %indvars.iv.next19, %36 ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge1
  %indvars.iv15 = phi i64 [ 0, %._crit_edge1 ], [ %indvars.iv.next16.1, %._crit_edge ]
  %12 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv18, i64 %indvars.iv15
  %13 = load double, double* %12, align 8
  %sunkaddr = ptrtoint double* %3 to i64
  %sunkaddr20 = mul i64 %indvars.iv18, 8
  %sunkaddr21 = add i64 %sunkaddr, %sunkaddr20
  %sunkaddr22 = inttoptr i64 %sunkaddr21 to double*
  %14 = load double, double* %sunkaddr22, align 8
  %15 = getelementptr inbounds double, double* %4, i64 %indvars.iv15
  %16 = load double, double* %15, align 8
  %17 = fmul double %14, %16
  %18 = fadd double %13, %17
  %sunkaddr23 = ptrtoint double* %5 to i64
  %sunkaddr24 = mul i64 %indvars.iv18, 8
  %sunkaddr25 = add i64 %sunkaddr23, %sunkaddr24
  %sunkaddr26 = inttoptr i64 %sunkaddr25 to double*
  %19 = load double, double* %sunkaddr26, align 8
  %20 = getelementptr inbounds double, double* %6, i64 %indvars.iv15
  %21 = load double, double* %20, align 8
  %22 = fmul double %19, %21
  %23 = fadd double %18, %22
  store double %23, double* %12, align 8
  %indvars.iv.next16 = or i64 %indvars.iv15, 1
  %24 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv18, i64 %indvars.iv.next16
  %25 = load double, double* %24, align 8
  %26 = load double, double* %sunkaddr22, align 8
  %27 = getelementptr inbounds double, double* %4, i64 %indvars.iv.next16
  %28 = load double, double* %27, align 8
  %29 = fmul double %26, %28
  %30 = fadd double %25, %29
  %31 = load double, double* %sunkaddr26, align 8
  %32 = getelementptr inbounds double, double* %6, i64 %indvars.iv.next16
  ...
  br i1 %exitcond17.1, label %36, label %._crit_edge

; <label>:36:                                     ; preds = %._crit_edge
  %indvars.iv.next19 = add nuw nsw i64 %indvars.iv18, 1
  %exitcond20 = icmp eq i64 %indvars.iv.next19, 2000
  br i1 %exitcond20, label %.preheader2.preheader, label %._crit_edge1

.preheader2.preheader:                            ; preds = %36
  br label %.preheader2

.preheader2:                                      ; preds = %52, %.preheader2.preheader
  %indvars.iv12 = phi i64 [ 0, %.preheader2.preheader ], [ %indvars.iv.next13, %52 ]
  br label %._crit_edge2

._crit_edge2:                                     ; preds = %._crit_edge2, %.preheader2
  %indvars.iv9 = phi i64 [ 0, %.preheader2 ], [ %indvars.iv.next10.1, %._crit_edge2 ]
  %sunkaddr27 = ptrtoint double* %8 to i64
  %sunkaddr28 = mul i64 %indvars.iv12, 8
  ...
  %38 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv9, i64 %indvars.iv12
  %39 = load double, double* %38, align 8
  %40 = fmul double %39, %1
  %41 = getelementptr inbounds double, double* %9, i64 %indvars.iv9
  %42 = load double, double* %41, align 8
  %43 = fmul double %40, %42
  %44 = fadd double %37, %43
  store double %44, double* %sunkaddr30, align 8
  %indvars.iv.next10 = or i64 %indvars.iv9, 1
  %45 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next10, i64 %indvars.iv12
  %46 = load double, double* %45, align 8
  %47 = fmul double %46, %1
  %48 = getelementptr inbounds double, double* %9, i64 %indvars.iv.next10
  %49 = load double, double* %48, align 8
  %50 = fmul double %47, %49
  %51 = fadd double %44, %50
  store double %51, double* %sunkaddr30, align 8
  %indvars.iv.next10.1 = add nuw nsw i64 %indvars.iv9, 2
  %exitcond11.1 = icmp eq i64 %indvars.iv.next10.1, 2000
  br i1 %exitcond11.1, label %52, label %._crit_edge2

; <label>:52:                                     ; preds = %._crit_edge2
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %exitcond14 = icmp eq i64 %indvars.iv.next13, 2000
  br i1 %exitcond14, label %.preheader1.preheader, label %.preheader2

.preheader1.preheader:                            ; preds = %52
  br label %.preheader1

.preheader1:                                      ; preds = %.preheader1, %.preheader1.preheader
  %indvars.iv6 = phi i64 [ 0, %.preheader1.preheader ], [ %indvars.iv.next7.4, %.preheader1 ]
  %53 = getelementptr inbounds double, double* %8, i64 %indvars.iv6
  %54 = load double, double* %53, align 8
  %55 = getelementptr inbounds double, double* %10, i64 %indvars.iv6
  %56 = load double, double* %55, align 8
  %57 = fadd double %54, %56
  store double %57, double* %53, align 8
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %58 = getelementptr inbounds double, double* %8, i64 %indvars.iv.next7
  %59 = load double, double* %58, align 8
  %60 = getelementptr inbounds double, double* %10, i64 %indvars.iv.next7
  %61 = load double, double* %60, align 8
  %62 = fadd double %59, %61
  store double %62, double* %58, align 8
  %indvars.iv.next7.1 = add nuw nsw i64 %indvars.iv6, 2
  %63 = getelementptr inbounds double, double* %8, i64 %indvars.iv.next7.1
  %64 = load double, double* %63, align 8
  %65 = getelementptr inbounds double, double* %10, i64 %indvars.iv.next7.1
  %66 = load double, double* %65, align 8
  %67 = fadd double %64, %66
  store double %67, double* %63, align 8
  %indvars.iv.next7.2 = add nuw nsw i64 %indvars.iv6, 3
  %68 = getelementptr inbounds double, double* %8, i64 %indvars.iv.next7.2
  %69 = load double, double* %68, align 8
  %70 = getelementptr inbounds double, double* %10, i64 %indvars.iv.next7.2
  %71 = load double, double* %70, align 8
  %72 = fadd double %69, %71
  store double %72, double* %68, align 8
  %indvars.iv.next7.3 = add nuw nsw i64 %indvars.iv6, 4
  %73 = getelementptr inbounds double, double* %8, i64 %indvars.iv.next7.3
  %74 = load double, double* %73, align 8
  %75 = getelementptr inbounds double, double* %10, i64 %indvars.iv.next7.3
  %76 = load double, double* %75, align 8
  %77 = fadd double %74, %76
  store double %77, double* %73, align 8
  %indvars.iv.next7.4 = add nuw nsw i64 %indvars.iv6, 5
  %exitcond8.4 = icmp eq i64 %indvars.iv.next7.4, 2000
  br i1 %exitcond8.4, label %.preheader.preheader, label %.preheader1

.preheader.preheader:                             ; preds = %.preheader1
  br label %.preheader

.preheader:                                       ; preds = %93, %.preheader.preheader
  %indvars.iv3 = phi i64 [ 0, %.preheader.preheader ], [ %indvars.iv.next4, %93 ]
  br label %._crit_edge4

._crit_edge4:                                     ; preds = %._crit_edge4, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %._crit_edge4 ]
  %sunkaddr31 = ptrtoint double* %7 to i64
  %sunkaddr32 = mul i64 %indvars.iv3, 8
  %sunkaddr33 = add i64 %sunkaddr31, %sunkaddr32
  %sunkaddr34 = inttoptr i64 %sunkaddr33 to double*
  %78 = load double, double* %sunkaddr34, align 8
  %79 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv3, i64 %indvars.iv
  ...
  store double %85, double* %sunkaddr34, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %86 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv3, i64 %indvars.iv.next
  ...
  store double %92, double* %sunkaddr34, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %93, label %._crit_edge4

; <label>:93:                                     ; preds = %._crit_edge4
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv3, 1
  %exitcond5 = icmp eq i64 %indvars.iv.next4, 2000
  br i1 %exitcond5, label %94, label %.preheader
