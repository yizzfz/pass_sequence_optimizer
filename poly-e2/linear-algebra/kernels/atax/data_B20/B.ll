...
entry:
  %scevgep7879 = bitcast double* %y to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep7879, i8 0, i64 16800, i32 8, i1 false)
  br label %for.body

for.body5.us:                                     ; preds = %for.body5.us.preheader, %for.inc42.us
  %indvars.iv66 = phi i64 [ %0, %for.inc42.us ], [ 0, %for.body5.us.preheader ]
  %scevgep88 = getelementptr [2100 x double], [2100 x double]* %A, i64 %indvars.iv66, i64 1
  %0 = add i64 %indvars.iv66, 1
  %scevgep90 = getelementptr [2100 x double], [2100 x double]* %A, i64 %0, i64 0
...
for.body26.us.for.body26.us_crit_edge:            ; preds = %for.body26.us.for.body26.us_crit_edge.preheader, %for.body26.us.for.body26.us_crit_edge
  %indvars.iv.next6584 = phi i64 [ %indvars.iv.next65, %for.body26.us.for.body26.us_crit_edge ], [ %indvars.iv.next6584.ph, %for.body26.us.for.body26.us_crit_edge.preheader ]
  %.pre = load double, double* %arrayidx7.us, align 8
  %arrayidx28.us = getelementptr inbounds double, double* %y, i64 %indvars.iv.next6584
  %1 = load double, double* %arrayidx28.us, align 8
  %arrayidx32.us = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv66, i64 %indvars.iv.next6584
  ...
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv.next6584, 1
...
for.body26.us.preheader:                          ; preds = %for.body10.us
  ...
  %arrayidx32.us81 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv66, i64 0
  %11 = load double, double* %arrayidx32.us81, align 8
  %mul35.us82 = fmul double %11, %add.us.2
  %add36.us83 = fadd double %10, %mul35.us82
  store double %add36.us83, double* %y, align 8
  %bound0 = icmp ult double* %scevgep, %arrayidx7.us
  %bound1 = icmp ult double* %arrayidx7.us, %scevgep86
  %found.conflict = and i1 %bound0, %bound1
  %bound093 = icmp ult double* %scevgep, %scevgep90
  %bound194 = icmp ult double* %scevgep88, %scevgep86
...
for.body26.us.for.body26.us_crit_edge.preheader:  ; preds = %for.body26.us.for.body26.us_crit_edge.preheader.loopexit, %for.body26.us.preheader
  %indvars.iv.next6584.ph = phi i64 [ 1, %for.body26.us.preheader ], [ 2097, %for.body26.us.for.body26.us_crit_edge.preheader.loopexit ]
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load97 = load <2 x double>, <2 x double>* %18, align 8, !alias.scope !7, !noalias !9
  %19 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv66, i64 %offset.idx
  %20 = bitcast double* %19 to <2 x double>*
  %wide.load98 = load <2 x double>, <2 x double>* %20, align 8, !alias.scope !11
  %21 = getelementptr double, double* %19, i64 2
  %22 = bitcast double* %21 to <2 x double>*
  %wide.load99 = load <2 x double>, <2 x double>* %22, align 8, !alias.scope !11
  %23 = fmul <2 x double> %wide.load98, %14
  %24 = fmul <2 x double> %wide.load99, %14
  %25 = fadd <2 x double> %wide.load, %23
  %26 = fadd <2 x double> %wide.load97, %24
...
for.body:                                         ; preds = %for.body, %entry
  %indvars.iv75 = phi i64 [ 0, %entry ], [ %indvars.iv.next76.24, %for.body ]
  %indvars.iv.next76.24 = add nsw i64 %indvars.iv75, 25
  %cmp.24 = icmp slt i64 %indvars.iv.next76.24, 2100
...
for.body5.us.preheader:                           ; preds = %for.body
  ...
  %scevgep86 = getelementptr double, double* %y, i64 2100
