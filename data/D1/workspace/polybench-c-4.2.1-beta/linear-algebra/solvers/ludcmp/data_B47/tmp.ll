...
.lr.ph64:                                         ; preds = %5
  ...
  %xtraiter204 = and i64 %11, 1
  %lcmp.mod205 = icmp eq i64 %xtraiter204, 0
  br i1 %lcmp.mod205, label %._crit_edge77.prol.loopexit, label %._crit_edge77.prol.preheader
...
._crit_edge11:                                    ; preds = %._crit_edge54, %._crit_edge11.lr.ph
  %indvar199 = phi i64 [ %indvar.next200, %._crit_edge54 ], [ 0, %._crit_edge11.lr.ph ]
  %36 = phi i32 [ %storemerge1051, %._crit_edge54 ], [ 0, %._crit_edge11.lr.ph ]
  %37 = sub i64 %wide.trip.count, %indvar199
  %38 = sub i64 %17, %indvar199
...
._crit_edge48:                                    ; preds = %._crit_edge11.._crit_edge48_crit_edge, %._crit_edge48.loopexit
  %.pre-phi = phi i64 [ %.pre191, %._crit_edge11.._crit_edge48_crit_edge ], [ %40, %._crit_edge48.loopexit ]
...
.lr.ph53:                                         ; preds = %._crit_edge48
  ...
  %xtraiter201 = and i64 %37, 7
  %lcmp.mod202 = icmp eq i64 %xtraiter201, 0
  br i1 %lcmp.mod202, label %.prol.loopexit, label %.prol.preheader
...
; <label>:51:                                     ; preds = %51, %.prol.preheader
  ...
  %prol.iter203 = phi i64 [ %prol.iter203.sub, %51 ], [ %xtraiter201, %.prol.preheader ]
  ...
  br i1 %prol.iter203.cmp, label %.prol.loopexit.unr-lcssa, label %51, !llvm.loop !1
...
._crit_edge12.lr.ph.._crit_edge12.us_crit_edge:   ; preds = %._crit_edge12.lr.ph
  ...
  %72 = add nsw i64 %67, -1
  %xtraiter196 = and i64 %67, 3
  %lcmp.mod197 = icmp eq i64 %xtraiter196, 0
  br i1 %lcmp.mod197, label %._crit_edge40.us.prol.loopexit, label %._crit_edge40.us.prol.preheader
...
._crit_edge40.us.prol:                            ; preds = %._crit_edge40.us.prol, %._crit_edge40.us.prol.preheader
  ...
  %prol.iter198 = phi i64 [ %prol.iter198.sub, %._crit_edge40.us.prol ], [ %xtraiter196, %._crit_edge40.us.prol.preheader ]
  ...
  br i1 %prol.iter198.cmp, label %._crit_edge40.us.prol.loopexit.unr-lcssa, label %._crit_edge40.us.prol, !llvm.loop !3
...
._crit_edge14.us:                                 ; preds = %._crit_edge29.us, %._crit_edge14.lr.ph.._crit_edge14.us_crit_edge
  %indvar141 = phi i64 [ %84, %._crit_edge29.us ], [ 0, %._crit_edge14.lr.ph.._crit_edge14.us_crit_edge ]
  %indvars.iv108 = phi i64 [ %indvars.iv.next109, %._crit_edge29.us ], [ 0, %._crit_edge14.lr.ph.._crit_edge14.us_crit_edge ]
  %scevgep143 = getelementptr [2000 x double], [2000 x double]* %78, i64 0, i64 %indvar141
  %84 = add i64 %indvar141, 1
  %scevgep145 = getelementptr [2000 x double], [2000 x double]* %78, i64 %wide.trip.count104, i64 %84
...
._crit_edge16.us.us:                              ; preds = %._crit_edge16.us.us.preheader, %._crit_edge27.us.us
  ...
  %scevgep137 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %79, i64 0, i64 %indvars.iv106, i64 0
  %scevgep139 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %79, i64 0, i64 %indvars.iv106, i64 %82
...
scalar.ph.preheader:                              ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %._crit_edge16.us.us
  ...
  %xtraiter194 = and i64 %87, 1
  %lcmp.mod195 = icmp eq i64 %xtraiter194, 0
  br i1 %lcmp.mod195, label %scalar.ph.prol.loopexit.unr-lcssa, label %scalar.ph.prol.preheader
...
vector.memcheck:                                  ; preds = %min.iters.checked
  ...
  %bound0148 = icmp ult double* %scevgep137, %86
  %bound1149 = icmp ult double* %86, %scevgep139
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load152 = load <2 x double>, <2 x double>* %119, align 8, !alias.scope !9, !noalias !11
  %120 = fadd <2 x double> %wide.load, %114
  %121 = fadd <2 x double> %wide.load152, %115
...
._crit_edge17.lr.ph.._crit_edge17.us_crit_edge:   ; preds = %._crit_edge17.lr.ph
  ...
  %min.iters.check156 = icmp ult i64 %145, 4
  %n.vec159 = and i64 %145, 8589934588
  %cmp.zero160 = icmp eq i64 %n.vec159, 0
  %150 = and i64 %148, 1
  %lcmp.mod = icmp eq i64 %150, 0
  %151 = icmp eq i64 %148, 0
  %cmp.n181 = icmp eq i64 %145, %n.vec159
  br label %._crit_edge17.us

._crit_edge17.us:                                 ; preds = %._crit_edge19.us, %._crit_edge17.lr.ph.._crit_edge17.us_crit_edge
  %indvar162 = phi i64 [ %indvar.next163, %._crit_edge19.us ], [ 0, %._crit_edge17.lr.ph.._crit_edge17.us_crit_edge ]
  %indvars.iv100 = phi i64 [ %indvars.iv.next101, %._crit_edge19.us ], [ 0, %._crit_edge17.lr.ph.._crit_edge17.us_crit_edge ]
  %scevgep164 = getelementptr [2000 x double], [2000 x double]* %139, i64 %indvar162, i64 0
  %scevgep166 = getelementptr [2000 x double], [2000 x double]* %139, i64 %indvar162, i64 %145
  %scevgep168 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %140, i64 0, i64 %indvar162, i64 0
  %scevgep170 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %140, i64 0, i64 %indvar162, i64 %145
  br i1 %min.iters.check156, label %scalar.ph155.preheader, label %min.iters.checked157

min.iters.checked157:                             ; preds = %._crit_edge17.us
  br i1 %cmp.zero160, label %scalar.ph155.preheader, label %vector.memcheck176
...
vector.memcheck176:                               ; preds = %min.iters.checked157
  ...
  br i1 %memcheck.conflict175, label %scalar.ph155.preheader, label %vector.body153.preheader

vector.body153.preheader:                         ; preds = %vector.memcheck176
  br i1 %lcmp.mod, label %vector.body153.prol.preheader, label %vector.body153.prol.loopexit.unr-lcssa
...
vector.body153.prol:                              ; preds = %vector.body153.prol.preheader
  ...
  %wide.load186.prol = load <2 x i64>, <2 x i64>* %153, align 8, !alias.scope !16
  ...
  %wide.load187.prol = load <2 x i64>, <2 x i64>* %155, align 8, !alias.scope !16
  %156 = getelementptr inbounds [2000 x double], [2000 x double]* %139, i64 %indvars.iv100, i64 0
  %157 = bitcast double* %156 to <2 x i64>*
  store <2 x i64> %wide.load186.prol, <2 x i64>* %157, align 8, !alias.scope !19, !noalias !16
  %158 = getelementptr [2000 x double], [2000 x double]* %139, i64 %indvars.iv100, i64 2
  %159 = bitcast double* %158 to <2 x i64>*
  store <2 x i64> %wide.load187.prol, <2 x i64>* %159, align 8, !alias.scope !19, !noalias !16
  br label %vector.body153.prol.loopexit.unr-lcssa

vector.body153.prol.loopexit.unr-lcssa:           ; preds = %vector.body153.preheader, %vector.body153.prol
  %index178.unr.ph = phi i64 [ 4, %vector.body153.prol ], [ 0, %vector.body153.preheader ]
  br label %vector.body153.prol.loopexit

vector.body153.prol.loopexit:                     ; preds = %vector.body153.prol.loopexit.unr-lcssa
  br i1 %151, label %middle.block154, label %vector.body153.preheader.new
...
vector.body153:                                   ; preds = %vector.body153, %vector.body153.preheader.new
  ...
  %160 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %140, i64 0, i64 %indvars.iv100, i64 %index178
  %161 = bitcast double* %160 to <2 x i64>*
  %wide.load186 = load <2 x i64>, <2 x i64>* %161, align 8, !alias.scope !16
  %162 = getelementptr double, double* %160, i64 2
  %163 = bitcast double* %162 to <2 x i64>*
  %wide.load187 = load <2 x i64>, <2 x i64>* %163, align 8, !alias.scope !16
  %164 = getelementptr inbounds [2000 x double], [2000 x double]* %139, i64 %indvars.iv100, i64 %index178
  %165 = bitcast double* %164 to <2 x i64>*
  store <2 x i64> %wide.load186, <2 x i64>* %165, align 8, !alias.scope !19, !noalias !16
  %166 = getelementptr double, double* %164, i64 2
  %167 = bitcast double* %166 to <2 x i64>*
  store <2 x i64> %wide.load187, <2 x i64>* %167, align 8, !alias.scope !19, !noalias !16
  %index.next179 = add i64 %index178, 4
  %168 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %140, i64 0, i64 %indvars.iv100, i64 %index.next179
  %169 = bitcast double* %168 to <2 x i64>*
  %wide.load186.1 = load <2 x i64>, <2 x i64>* %169, align 8, !alias.scope !16
  %170 = getelementptr double, double* %168, i64 2
  %171 = bitcast double* %170 to <2 x i64>*
  %wide.load187.1 = load <2 x i64>, <2 x i64>* %171, align 8, !alias.scope !16
  %172 = getelementptr inbounds [2000 x double], [2000 x double]* %139, i64 %indvars.iv100, i64 %index.next179
  %173 = bitcast double* %172 to <2 x i64>*
  store <2 x i64> %wide.load186.1, <2 x i64>* %173, align 8, !alias.scope !19, !noalias !16
  %174 = getelementptr double, double* %172, i64 2
  %175 = bitcast double* %174 to <2 x i64>*
  store <2 x i64> %wide.load187.1, <2 x i64>* %175, align 8, !alias.scope !19, !noalias !16
  %index.next179.1 = add i64 %index178, 8
  %176 = icmp eq i64 %index.next179.1, %n.vec159
  br i1 %176, label %middle.block154.unr-lcssa, label %vector.body153, !llvm.loop !21
...
middle.block154:                                  ; preds = %vector.body153.prol.loopexit, %middle.block154.unr-lcssa
  br i1 %cmp.n181, label %._crit_edge19.us, label %scalar.ph155.preheader

scalar.ph155.preheader:                           ; preds = %middle.block154, %vector.memcheck176, %min.iters.checked157, %._crit_edge17.us
  %indvars.iv.ph = phi i64 [ 0, %vector.memcheck176 ], [ 0, %min.iters.checked157 ], [ 0, %._crit_edge17.us ], [ %n.vec159, %middle.block154 ]
  %177 = sub nsw i64 %149, %indvars.iv.ph
  %178 = sub nsw i64 %wide.trip.count98, %indvars.iv.ph
  %xtraiter192 = and i64 %177, 3
  %lcmp.mod193 = icmp eq i64 %xtraiter192, 0
  br i1 %lcmp.mod193, label %scalar.ph155.prol.loopexit, label %scalar.ph155.prol.preheader

scalar.ph155.prol.preheader:                      ; preds = %scalar.ph155.preheader
  br label %scalar.ph155.prol

scalar.ph155.prol:                                ; preds = %scalar.ph155.prol, %scalar.ph155.prol.preheader
  %indvars.iv.prol = phi i64 [ %indvars.iv.next.prol, %scalar.ph155.prol ], [ %indvars.iv.ph, %scalar.ph155.prol.preheader ]
  %prol.iter = phi i64 [ %prol.iter.sub, %scalar.ph155.prol ], [ %xtraiter192, %scalar.ph155.prol.preheader ]
  ...
  br i1 %prol.iter.cmp, label %scalar.ph155.prol.loopexit.unr-lcssa, label %scalar.ph155.prol, !llvm.loop !22

scalar.ph155.prol.loopexit.unr-lcssa:             ; preds = %scalar.ph155.prol
  br label %scalar.ph155.prol.loopexit

scalar.ph155.prol.loopexit:                       ; preds = %scalar.ph155.preheader, %scalar.ph155.prol.loopexit.unr-lcssa
  %indvars.iv.unr = phi i64 [ %indvars.iv.ph, %scalar.ph155.preheader ], [ %indvars.iv.next.prol, %scalar.ph155.prol.loopexit.unr-lcssa ]
  %184 = icmp ult i64 %178, 3
  br i1 %184, label %._crit_edge19.us.loopexit, label %scalar.ph155.preheader.new

scalar.ph155.preheader.new:                       ; preds = %scalar.ph155.prol.loopexit
  br label %scalar.ph155

scalar.ph155:                                     ; preds = %scalar.ph155, %scalar.ph155.preheader.new
  %indvars.iv = phi i64 [ %indvars.iv.unr, %scalar.ph155.preheader.new ], [ %indvars.iv.next.3, %scalar.ph155 ]
  ...
  br i1 %exitcond99.3, label %._crit_edge19.us.loopexit.unr-lcssa, label %scalar.ph155, !llvm.loop !23

._crit_edge19.us.loopexit.unr-lcssa:              ; preds = %scalar.ph155
  br label %._crit_edge19.us.loopexit

._crit_edge19.us.loopexit:                        ; preds = %scalar.ph155.prol.loopexit, %._crit_edge19.us.loopexit.unr-lcssa
  br label %._crit_edge19.us

._crit_edge19.us:                                 ; preds = %._crit_edge19.us.loopexit, %middle.block154
...
.lr.ph36:                                         ; preds = %.lr.ph41
  ...
  %24 = and i64 %18, 1
  %lcmp.mod176 = icmp eq i64 %24, 0
  br i1 %lcmp.mod176, label %.prol.preheader173, label %.prol.loopexit174.unr-lcssa

.prol.preheader173:                               ; preds = %.lr.ph36
  br label %25

; <label>:25:                                     ; preds = %.prol.preheader173
...
.prol.loopexit174.unr-lcssa:                      ; preds = %.lr.ph36, %25
  %.lcssa164.unr.ph = phi double [ %30, %25 ], [ undef, %.lr.ph36 ]
  %indvars.iv104.unr.ph = phi i64 [ 1, %25 ], [ 0, %.lr.ph36 ]
  %.unr177.ph = phi double [ %30, %25 ], [ %22, %.lr.ph36 ]
...
._crit_edge37:                                    ; preds = %.prol.loopexit174, %._crit_edge37.unr-lcssa
  %.lcssa164 = phi double [ %.lcssa164.unr.ph, %.prol.loopexit174 ], [ %47, %._crit_edge37.unr-lcssa ]
  br label %._crit_edge69

._crit_edge69:                                    ; preds = %.lr.ph41, %._crit_edge37
  %48 = phi double [ %.lcssa164, %._crit_edge37 ], [ %22, %.lr.ph41 ]
...
.lr.ph54.split.preheader:                         ; preds = %.lr.ph54
  %xtraiter178 = and i64 %13, 3
  %lcmp.mod179 = icmp eq i64 %xtraiter178, 0
  br i1 %lcmp.mod179, label %.lr.ph54.split.prol.loopexit, label %.lr.ph54.split.prol.preheader
...
.lr.ph54.split.prol:                              ; preds = %.lr.ph54.split.prol, %.lr.ph54.split.prol.preheader
  ...
  %prol.iter180 = phi i64 [ %prol.iter180.sub, %.lr.ph54.split.prol ], [ %xtraiter178, %.lr.ph54.split.prol.preheader ]
  %indvars.iv.next119.prol = add i64 %indvars.iv118.prol, 1
  %prol.iter180.sub = add i64 %prol.iter180, -1
  %prol.iter180.cmp = icmp eq i64 %prol.iter180.sub, 0
  br i1 %prol.iter180.cmp, label %.lr.ph54.split.prol.loopexit.unr-lcssa, label %.lr.ph54.split.prol, !llvm.loop !24
...
.lr.ph54.split.us:                                ; preds = %._crit_edge48.us, %.lr.ph54.split.us.preheader
  ...
  br i1 %lcmp.mod184, label %.prol.preheader181, label %.prol.loopexit182.unr-lcssa

.prol.preheader181:                               ; preds = %.lr.ph54.split.us
  br label %60

; <label>:60:                                     ; preds = %.prol.preheader181
  ...
  br label %.prol.loopexit182.unr-lcssa

.prol.loopexit182.unr-lcssa:                      ; preds = %.lr.ph54.split.us, %60
  %.lcssa166.unr.ph = phi double [ %65, %60 ], [ undef, %.lr.ph54.split.us ]
  %indvars.iv123.unr.ph = phi i64 [ 1, %60 ], [ 0, %.lr.ph54.split.us ]
  %.unr185.ph = phi double [ %65, %60 ], [ %59, %.lr.ph54.split.us ]
  br label %.prol.loopexit182

.prol.loopexit182:                                ; preds = %.prol.loopexit182.unr-lcssa
  br i1 %57, label %._crit_edge48.us, label %.lr.ph54.split.us.new

.lr.ph54.split.us.new:                            ; preds = %.prol.loopexit182
  br label %66
...
; <label>:66:                                     ; preds = %66, %.lr.ph54.split.us.new
  ...
  %67 = phi double [ %.unr185.ph, %.lr.ph54.split.us.new ], [ %81, %66 ]
...
._crit_edge48.us:                                 ; preds = %.prol.loopexit182, %._crit_edge48.us.unr-lcssa
  %.lcssa166 = phi double [ %.lcssa166.unr.ph, %.prol.loopexit182 ], [ %81, %._crit_edge48.us.unr-lcssa ]
  store double %.lcssa166, double* %58, align 8
...
._crit_edge55:                                    ; preds = %._crit_edge55.loopexit, %._crit_edge42, %._crit_edge55.loopexit140
...
.lr.ph24:                                         ; preds = %84
  ...
  %xtraiter169 = and i64 %indvars.iv102, 3
  %lcmp.mod170 = icmp eq i64 %xtraiter169, 0
  br i1 %lcmp.mod170, label %.prol.loopexit168, label %.prol.preheader167

.prol.preheader167:                               ; preds = %.lr.ph24
  br label %92

; <label>:92:                                     ; preds = %92, %.prol.preheader167
  %indvars.iv92.prol = phi i64 [ %indvars.iv.next93.prol, %92 ], [ 0, %.prol.preheader167 ]
  %93 = phi double [ %99, %92 ], [ %91, %.prol.preheader167 ]
  %prol.iter171 = phi i64 [ %prol.iter171.sub, %92 ], [ %xtraiter169, %.prol.preheader167 ]
  ...
  %prol.iter171.sub = add i64 %prol.iter171, -1
  %prol.iter171.cmp = icmp eq i64 %prol.iter171.sub, 0
  br i1 %prol.iter171.cmp, label %.prol.loopexit168.unr-lcssa, label %92, !llvm.loop !25

.prol.loopexit168.unr-lcssa:                      ; preds = %92
  br label %.prol.loopexit168

.prol.loopexit168:                                ; preds = %.lr.ph24, %.prol.loopexit168.unr-lcssa
  %.lcssa162.unr = phi double [ undef, %.lr.ph24 ], [ %99, %.prol.loopexit168.unr-lcssa ]
  %indvars.iv92.unr = phi i64 [ 0, %.lr.ph24 ], [ %indvars.iv.next93.prol, %.prol.loopexit168.unr-lcssa ]
  %.unr172 = phi double [ %91, %.lr.ph24 ], [ %99, %.prol.loopexit168.unr-lcssa ]
  %100 = icmp ult i64 %86, 3
  br i1 %100, label %._crit_edge25, label %.lr.ph24.new

.lr.ph24.new:                                     ; preds = %.prol.loopexit168
  br label %101

; <label>:101:                                    ; preds = %101, %.lr.ph24.new
  %indvars.iv92 = phi i64 [ %indvars.iv92.unr, %.lr.ph24.new ], [ %indvars.iv.next93.3, %101 ]
  %102 = phi double [ %.unr172, %.lr.ph24.new ], [ %124, %101 ]
...
._crit_edge25:                                    ; preds = %.prol.loopexit168, %._crit_edge25.unr-lcssa
  %.lcssa162 = phi double [ %.lcssa162.unr, %.prol.loopexit168 ], [ %124, %._crit_edge25.unr-lcssa ]
  %125 = bitcast double %.lcssa162 to i64
