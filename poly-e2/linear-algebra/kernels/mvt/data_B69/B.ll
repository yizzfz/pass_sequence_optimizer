...
for.body:                                         ; preds = %for.inc34, %entry
  %indvars.iv8 = phi i64 [ 0, %entry ], [ %indvars.iv.next9, %for.inc34 ]
  %0 = trunc i64 %indvars.iv8 to i32
  %conv = sitofp i32 %0 to double
  %arrayidx = getelementptr inbounds double, double* %x1, i64 %indvars.iv8
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  %1 = icmp eq i64 %indvars.iv.next9, 2000
  %2 = trunc i64 %indvars.iv.next9 to i32
  ...
  %arrayidx7 = getelementptr inbounds double, double* %x2, i64 %indvars.iv8
  ...
  %arrayidx14 = getelementptr inbounds double, double* %y_1, i64 %indvars.iv8
  %6 = add nuw nsw i64 %indvars.iv8, 4
  ...
  %arrayidx21 = getelementptr inbounds double, double* %y_2, i64 %indvars.iv8
...
for.body25:                                       ; preds = %for.body25, %for.body
  ...
  %arrayidx33 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv8, i64 %indvars.iv
  %indvars.iv.next = or i64 %indvars.iv, 1
  %10 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv8
...
for.inc34:                                        ; preds = %for.body25
  %13 = icmp eq i64 %indvars.iv.next9, 2000
...
for.cond.for.cond1_crit_edge:                     ; preds = %for.inc12, %entry
  %indvars.iv26 = phi i64 [ 0, %entry ], [ %indvars.iv.next27, %for.inc12 ]
  %arrayidx = getelementptr inbounds double, double* %x1, i64 %indvars.iv26
  %.pre = load double, double* %arrayidx, align 8
  %sunkaddr1 = shl i64 %indvars.iv26, 3
...
for.body3:                                        ; preds = %for.body3, %for.cond.for.cond1_crit_edge
  %indvars.iv22 = phi i64 [ %indvars.iv.next23.1, %for.body3 ], [ 0, %for.cond.for.cond1_crit_edge ]
  %0 = phi double [ %add.1, %for.body3 ], [ %.pre, %for.cond.for.cond1_crit_edge ]
  %arrayidx7 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv26, i64 %indvars.iv22
  ...
  %arrayidx7.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv26, i64 %indvars.iv.next23
  ...
  br i1 %exitcond25.1, label %for.inc12, label %for.body3

for.inc12:                                        ; preds = %for.body3
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv26, 1
  %exitcond33 = icmp eq i64 %indvars.iv.next27, 2000
  br i1 %exitcond33, label %for.cond15.for.cond18_crit_edge.preheader, label %for.cond.for.cond1_crit_edge

for.cond15.for.cond18_crit_edge.preheader:        ; preds = %for.inc12
  %sunkaddr4 = ptrtoint double* %x2 to i64
  br label %for.cond15.for.cond18_crit_edge

for.cond15.for.cond18_crit_edge:                  ; preds = %for.cond15.for.cond18_crit_edge.preheader, %for.inc36
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc36 ], [ 0, %for.cond15.for.cond18_crit_edge.preheader ]
  %arrayidx22 = getelementptr inbounds double, double* %x2, i64 %indvars.iv18
  %.pre17 = load double, double* %arrayidx22, align 8
  %sunkaddr5 = shl i64 %indvars.iv18, 3
  %sunkaddr6 = add i64 %sunkaddr4, %sunkaddr5
  %sunkaddr7 = inttoptr i64 %sunkaddr6 to double*
  br label %for.body20

for.body20:                                       ; preds = %for.body20, %for.cond15.for.cond18_crit_edge
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %for.body20 ], [ 0, %for.cond15.for.cond18_crit_edge ]
  %5 = phi double [ %add30.1, %for.body20 ], [ %.pre17, %for.cond15.for.cond18_crit_edge ]
  %arrayidx26 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv, i64 %indvars.iv18
  ...
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx26.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv.next, i64 %indvars.iv18
...
for.inc36:                                        ; preds = %for.body20
  ...
  br i1 %exitcond, label %for.end38, label %for.cond15.for.cond18_crit_edge
...
if.end14:                                         ; preds = %for.body9, %if.then12
  ...
  br i1 %exitcond14, label %for.end20, label %for.body9
