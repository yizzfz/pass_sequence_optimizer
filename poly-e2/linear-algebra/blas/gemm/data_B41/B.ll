...
for.body3.us:                                     ; preds = %for.body3.us, %for.cond1.preheader.us
  ...
  br i1 %exitcond51, label %for.cond1.for.inc7_crit_edge.us, label %for.body3.us

for.cond1.for.inc7_crit_edge.us:                  ; preds = %for.body3.us
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1
  %exitcond52 = icmp eq i64 %indvars.iv.next43, 1000
  br i1 %exitcond52, label %for.cond14.preheader.us.preheader, label %for.cond1.preheader.us
...
for.cond14.for.inc31_crit_edge.us:                ; preds = %for.body17.us
  ...
  br i1 %exitcond50, label %for.cond38.preheader.us.preheader, label %for.cond14.preheader.us
...
for.body41.us:                                    ; preds = %for.body41.us, %for.cond38.preheader.us
  ...
  br i1 %exitcond49, label %for.cond38.for.inc55_crit_edge.us, label %for.body41.us
