...
; <label>:121:                                    ; preds = %._crit_edge9, %116
  store i32 2, i32* @opMode, align 4
  br label %122

; <label>:122:                                    ; preds = %._crit_edge8, %121
...
; <label>:141:                                    ; preds = %._crit_edge10, %136, %131, %127
...
; <label>:235:                                    ; preds = %._crit_edge2, %._crit_edge1
  call void @license()
  br label %252
...
; <label>:257:                                    ; preds = %._crit_edge4, %._crit_edge, %256
  br label %258
...
; <label>:478:                                    ; preds = %._crit_edge7, %476, %472, %464
...
; <label>:698:                                    ; preds = %._crit_edge5, %694
...
; <label>:29:                                     ; preds = %._crit_edge2, %26, %21, %20
...
; <label>:79:                                     ; preds = %._crit_edge2, %72, %69
...
attributes #5 = { noreturn nounwind uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
