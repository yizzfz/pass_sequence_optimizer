...
; <label>:3:                                      ; preds = %3, %.lr.ph14
  ...
  %8 = getelementptr inbounds double, double* %2, i64 %indvars.iv412
  ...
  %13 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next5
  store double %12, double* %13, align 8
  %exitcond19.1 = icmp eq i64 %indvars.iv.next5, 1899
  %indvars.iv.next5.1 = add nsw i64 %indvars.iv412, 2
  br i1 %exitcond19.1, label %.lr.ph10.split.us.preheader, label %3
...
._crit_edge17:                                    ; preds = %._crit_edge17, %.lr.ph10.split.us
  %indvars.iv6.us = phi i64 [ 0, %.lr.ph10.split.us ], [ %indvars.iv.next.us.1, %._crit_edge17 ]
  ...
  %30 = getelementptr inbounds [1900 x double], [1900 x double]* %0, i64 %indvars.iv27.us, i64 %indvars.iv.next.us
  store double %29, double* %30, align 8
  %exitcond.1 = icmp eq i64 %indvars.iv.next.us, 1899
  br i1 %exitcond.1, label %._crit_edge.us, label %._crit_edge17

._crit_edge.us:                                   ; preds = %._crit_edge17
  %indvars.iv.next3.us = add nuw nsw i64 %indvars.iv27.us, 1
  %31 = icmp slt i64 %indvars.iv.next3.us, 2100
  br i1 %31, label %.lr.ph10.split.us, label %._crit_edge11
...
.lr.ph10.split.us:                                ; preds = %._crit_edge.us, %..lr.ph14_crit_edge
  %indvars.iv27.us = phi i64 [ 0, %..lr.ph14_crit_edge ], [ %indvars.iv.next3.us, %._crit_edge.us ]
...
; <label>:8:                                      ; preds = %8, %.lr.ph10.split.us
  ...
  %exitcond = icmp eq i64 %indvars.iv6.us, 1899
  %indvars.iv.next.us = add nuw nsw i64 %indvars.iv6.us, 1
  br i1 %exitcond, label %._crit_edge.us, label %8

._crit_edge.us:                                   ; preds = %8
  %indvars.iv.next3.us = add nuw nsw i64 %indvars.iv27.us, 1
  %22 = icmp slt i64 %indvars.iv.next3.us, 2100
  br i1 %22, label %.lr.ph10.split.us, label %._crit_edge11
...
.lr.ph9:                                          ; preds = %.lr.ph9.preheader, %.lr.ph9._crit_edge
  %indvars.iv17 = phi i64 [ %indvars.iv.next2, %.lr.ph9._crit_edge ], [ 0, %.lr.ph9.preheader ]
...
.lr.ph9._crit_edge:                               ; preds = %.lr.ph9, %9
  ...
  %15 = icmp slt i64 %indvars.iv.next2, 1900
...
.lr.ph:                                           ; preds = %._crit_edge10, %.lr.ph._crit_edge
  %indvars.iv6 = phi i64 [ %indvars.iv.next, %.lr.ph._crit_edge ], [ 0, %._crit_edge10 ]
...
.lr.ph._crit_edge:                                ; preds = %.lr.ph, %23
  ...
  %26 = getelementptr inbounds double, double* %1, i64 %indvars.iv6
