...
@__llvm_prf_nm = private constant [118 x i8] c"t\00TIFFInitPackBits\01tmp1.ll:PackBitsDecode\01tmp1.ll:PackBitsPreEncode\01tmp1.ll:PackBitsEncode\01tmp1.ll:PackBitsEncodeChunk", section "__llvm_prf_names"
@llvm.used = appending global [6 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_TIFFInitPackBits to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_PackBitsDecode to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_PackBitsPreEncode to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_PackBitsEncode to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_PackBitsEncodeChunk to i8*), i8* getelementptr inbounds ([118 x i8], [118 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
