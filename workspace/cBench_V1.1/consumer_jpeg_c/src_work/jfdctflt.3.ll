...
@__llvm_prf_nm = private constant [25 x i8] c"\0F\17x\DA\CB*HM\8FOKI.\89O\CB\C9O,\01\000\9E\06\1C", section "__llvm_prf_names"
@llvm.used = appending global [2 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_fdct_float to i8*), i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
