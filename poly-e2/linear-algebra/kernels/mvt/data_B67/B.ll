...
entry:
  %sunkaddr39 = ptrtoint double* %x1 to i64
...
for.inc:                                          ; preds = %for.inc, %for.cond1.preheader
  ...
  store double %add, double* %sunkaddr42, align 8
  ...
  store double %add.1, double* %sunkaddr42, align 8
...
for.cond18.preheader.preheader:                   ; preds = %for.inc12
  %sunkaddr47 = ptrtoint double* %x2 to i64
...
for.cond18.preheader:                             ; preds = %for.cond18.preheader.preheader, %for.inc36
  ...
  %sunkaddr48 = shl i64 %indvars.iv21, 3
...
for.inc33:                                        ; preds = %for.inc33, %for.cond18.preheader
  ...
  store double %add30, double* %sunkaddr50, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %add30.1, double* %sunkaddr50, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
