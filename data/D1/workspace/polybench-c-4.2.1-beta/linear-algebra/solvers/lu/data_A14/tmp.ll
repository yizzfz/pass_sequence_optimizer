...
define internal fastcc void @init_array(i32, [2000 x double]* nocapture) unnamed_addr #0 {
  %3 = icmp sgt i32 %0, 0
  br i1 %3, label %.preheader6.lr.ph, label %._crit_edge23.thread
...
.lr.ph18:                                         ; preds = %._crit_edge22, %.preheader6.lr.ph
  %indvars.iv73 = phi i64 [ 0, %.preheader6.lr.ph ], [ %indvars.iv.next74, %._crit_edge22 ]
  %indvars.iv71 = phi i64 [ 1, %.preheader6.lr.ph ], [ %indvars.iv.next72, %._crit_edge22 ]
  %9 = add nuw nsw i64 %indvars.iv73, 1
  %10 = sub i64 %7, %indvars.iv73
  %11 = shl i64 %10, 3
  %12 = and i64 %11, 34359738360
  br label %13

; <label>:13:                                     ; preds = %13, %.lr.ph18
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %13 ], [ 0, %.lr.ph18 ]
  %14 = sub nsw i64 0, %indvars.iv56
  %15 = trunc i64 %14 to i32
  %16 = srem i32 %15, %0
  %17 = sitofp i32 %16 to double
  %18 = fdiv double %17, %5
  %19 = fadd double %18, 1.000000e+00
  %20 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv73, i64 %indvars.iv56
  store double %19, double* %20, align 8
  %indvars.iv.next57 = add nuw nsw i64 %indvars.iv56, 1
  %exitcond61 = icmp eq i64 %indvars.iv.next57, %indvars.iv71
  br i1 %exitcond61, label %._crit_edge19, label %13

._crit_edge19:                                    ; preds = %13
  %indvars.iv.next74 = add nuw nsw i64 %indvars.iv73, 1
  %21 = icmp slt i64 %indvars.iv.next74, %8
  br i1 %21, label %.lr.ph21.preheader, label %._crit_edge22

.lr.ph21.preheader:                               ; preds = %._crit_edge19
  %22 = add nuw nsw i64 %12, 8
  %scevgep68 = getelementptr [2000 x double], [2000 x double]* %1, i64 0, i64 %9
  %23 = mul nuw nsw i64 %indvars.iv73, 2000
  %scevgep69 = getelementptr double, double* %scevgep68, i64 %23
  %scevgep6970 = bitcast double* %scevgep69 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep6970, i8 0, i64 %22, i32 8, i1 false)
  br label %._crit_edge22

._crit_edge22:                                    ; preds = %.lr.ph21.preheader, %._crit_edge19
  %24 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv73, i64 %indvars.iv73
  store double 1.000000e+00, double* %24, align 8
  %indvars.iv.next72 = add nuw nsw i64 %indvars.iv71, 1
  %exitcond76 = icmp eq i64 %indvars.iv.next74, %wide.trip.count75
  br i1 %exitcond76, label %._crit_edge23, label %.lr.ph18

._crit_edge23:                                    ; preds = %._crit_edge22
  %25 = icmp sgt i32 %0, 0
  %26 = tail call i8* @polybench_alloc_data(i64 4000000, i32 8) #4
  br i1 %25, label %.preheader5.us.preheader, label %._crit_edge7

.preheader5.us.preheader:                         ; preds = %._crit_edge23
  %27 = add i32 %0, -1
  %28 = zext i32 %27 to i64
  %29 = shl nuw nsw i64 %28, 3
  %30 = add nuw nsw i64 %29, 8
  %xtraiter53 = and i32 %0, 3
  %lcmp.mod54 = icmp eq i32 %xtraiter53, 0
  br i1 %lcmp.mod54, label %.preheader5.us.prol.loopexit, label %._crit_edge17.us.prol.preheader

._crit_edge17.us.prol.preheader:                  ; preds = %.preheader5.us.preheader
  %31 = add nsw i32 %xtraiter53, -1
  %32 = zext i32 %31 to i64
  br label %._crit_edge17.us.prol

._crit_edge17.us.prol:                            ; preds = %._crit_edge17.us.prol.preheader, %._crit_edge17.us.prol
  %indvars.iv49.prol = phi i64 [ %indvars.iv.next50.prol, %._crit_edge17.us.prol ], [ 0, %._crit_edge17.us.prol.preheader ]
  %prol.iter55 = phi i32 [ %prol.iter55.sub, %._crit_edge17.us.prol ], [ %xtraiter53, %._crit_edge17.us.prol.preheader ]
  %33 = mul nuw nsw i64 %indvars.iv49.prol, 16000
  ...
  %prol.iter55.sub = add nsw i32 %prol.iter55, -1
  %prol.iter55.cmp = icmp eq i32 %prol.iter55.sub, 0
  br i1 %prol.iter55.cmp, label %.preheader5.us.prol.loopexit.loopexit, label %._crit_edge17.us.prol, !llvm.loop !1

.preheader5.us.prol.loopexit.loopexit:            ; preds = %._crit_edge17.us.prol
...
.preheader5.us.prol.loopexit:                     ; preds = %.preheader5.us.prol.loopexit.loopexit, %.preheader5.us.preheader
  %indvars.iv49.unr = phi i64 [ 0, %.preheader5.us.preheader ], [ %34, %.preheader5.us.prol.loopexit.loopexit ]
  %35 = icmp ult i32 %27, 3
  br i1 %35, label %.preheader3.lr.ph, label %._crit_edge17.us.3.preheader

._crit_edge17.us.3.preheader:                     ; preds = %.preheader5.us.prol.loopexit
  %wide.trip.count51.3 = zext i32 %0 to i64
  %36 = add nsw i64 %wide.trip.count51.3, -4
  %37 = sub nsw i64 %36, %indvars.iv49.unr
  %38 = lshr i64 %37, 2
  %39 = and i64 %38, 1
  %lcmp.mod = icmp eq i64 %39, 0
  br i1 %lcmp.mod, label %._crit_edge17.us.3.prol.preheader, label %._crit_edge17.us.3.prol.loopexit

._crit_edge17.us.3.prol.preheader:                ; preds = %._crit_edge17.us.3.preheader
  br label %._crit_edge17.us.3.prol

._crit_edge17.us.3.prol:                          ; preds = %._crit_edge17.us.3.prol.preheader
  %40 = mul nuw nsw i64 %indvars.iv49.unr, 16000
  %scevgep.prol84 = getelementptr i8, i8* %26, i64 %40
  call void @llvm.memset.p0i8.i64(i8* %scevgep.prol84, i8 0, i64 %30, i32 8, i1 false)
  %41 = mul nsw i64 %indvars.iv49.unr, 16000
  %42 = add i64 %41, 16000
  %scevgep.1.prol = getelementptr i8, i8* %26, i64 %42
  call void @llvm.memset.p0i8.i64(i8* %scevgep.1.prol, i8 0, i64 %30, i32 8, i1 false)
  %43 = mul nsw i64 %indvars.iv49.unr, 16000
  %44 = add i64 %43, 32000
  %scevgep.2.prol = getelementptr i8, i8* %26, i64 %44
  call void @llvm.memset.p0i8.i64(i8* %scevgep.2.prol, i8 0, i64 %30, i32 8, i1 false)
  %45 = mul nsw i64 %indvars.iv49.unr, 16000
  %46 = add i64 %45, 48000
  %scevgep.3.prol = getelementptr i8, i8* %26, i64 %46
  call void @llvm.memset.p0i8.i64(i8* %scevgep.3.prol, i8 0, i64 %30, i32 8, i1 false)
  %indvars.iv.next50.3.prol = add nsw i64 %indvars.iv49.unr, 4
  br label %._crit_edge17.us.3.prol.loopexit

._crit_edge17.us.3.prol.loopexit:                 ; preds = %._crit_edge17.us.3.prol, %._crit_edge17.us.3.preheader
  %indvars.iv49.unr85 = phi i64 [ %indvars.iv49.unr, %._crit_edge17.us.3.preheader ], [ %indvars.iv.next50.3.prol, %._crit_edge17.us.3.prol ]
  %47 = icmp eq i64 %38, 0
  br i1 %47, label %.preheader4, label %._crit_edge17.us.3.preheader.new

._crit_edge17.us.3.preheader.new:                 ; preds = %._crit_edge17.us.3.prol.loopexit
  br label %._crit_edge17.us.3

.preheader4.unr-lcssa:                            ; preds = %._crit_edge17.us.3
  br label %.preheader4

.preheader4:                                      ; preds = %._crit_edge17.us.3.prol.loopexit, %.preheader4.unr-lcssa
  %48 = icmp sgt i32 %0, 0
  br i1 %48, label %.preheader3.lr.ph, label %._crit_edge7

.preheader3.lr.ph:                                ; preds = %.preheader5.us.prol.loopexit, %.preheader4
  %xtraiter35 = and i32 %0, 1
  %wide.trip.count39 = zext i32 %0 to i64
  %wide.trip.count31.1 = zext i32 %0 to i64
  %wide.trip.count43 = zext i32 %0 to i64
  %49 = icmp eq i32 %xtraiter35, 0
  %50 = icmp eq i32 %0, 1
...
.preheader2.us.us.preheader:                      ; preds = %._crit_edge10.us, %.preheader3.lr.ph
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %._crit_edge10.us ], [ 0, %.preheader3.lr.ph ]
  %sunkaddr79 = shl i64 %indvars.iv41, 3
...
._crit_edge10.us:                                 ; preds = %._crit_edge9.us.us
  ...
  br i1 %exitcond44, label %.preheader1, label %.preheader2.us.us.preheader

.preheader2.us.us:                                ; preds = %._crit_edge9.us.us, %.preheader2.us.us.preheader
  %indvars.iv37 = phi i64 [ 0, %.preheader2.us.us.preheader ], [ %indvars.iv.next38, %._crit_edge9.us.us ]
  %53 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv37, i64 %indvars.iv41
  br i1 %49, label %.prol.loopexit34, label %54

; <label>:54:                                     ; preds = %.preheader2.us.us
  %55 = load double, double* %53, align 8
  %56 = load double, double* %sunkaddr81, align 8
  %57 = fmul double %55, %56
  %58 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %52, i64 0, i64 %indvars.iv37, i64 0
  %59 = load double, double* %58, align 8
  %60 = fadd double %59, %57
  store double %60, double* %58, align 8
  br label %.prol.loopexit34

.prol.loopexit34:                                 ; preds = %.preheader2.us.us, %54
  %indvars.iv29.unr.ph = phi i64 [ 1, %54 ], [ 0, %.preheader2.us.us ]
  br i1 %50, label %._crit_edge9.us.us, label %.preheader2.us.us.new.preheader

.preheader2.us.us.new.preheader:                  ; preds = %.prol.loopexit34
  br label %.preheader2.us.us.new

._crit_edge9.us.us.loopexit:                      ; preds = %.preheader2.us.us.new
  br label %._crit_edge9.us.us

._crit_edge9.us.us:                               ; preds = %._crit_edge9.us.us.loopexit, %.prol.loopexit34
  %indvars.iv.next38 = add nuw nsw i64 %indvars.iv37, 1
  %exitcond40 = icmp eq i64 %indvars.iv.next38, %wide.trip.count39
  br i1 %exitcond40, label %._crit_edge10.us, label %.preheader2.us.us

.preheader2.us.us.new:                            ; preds = %.preheader2.us.us.new.preheader, %.preheader2.us.us.new
  %indvars.iv29 = phi i64 [ %indvars.iv.next30.1, %.preheader2.us.us.new ], [ %indvars.iv29.unr.ph, %.preheader2.us.us.new.preheader ]
  %61 = load double, double* %53, align 8
  %62 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv29, i64 %indvars.iv41
  %63 = load double, double* %62, align 8
  %64 = fmul double %61, %63
  %65 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %51, i64 0, i64 %indvars.iv37, i64 %indvars.iv29
  %66 = load double, double* %65, align 8
  %67 = fadd double %66, %64
  store double %67, double* %65, align 8
  %indvars.iv.next30 = add nuw nsw i64 %indvars.iv29, 1
  %68 = load double, double* %53, align 8
  %69 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv.next30, i64 %indvars.iv41
  %70 = load double, double* %69, align 8
  %71 = fmul double %68, %70
  %72 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %51, i64 0, i64 %indvars.iv37, i64 %indvars.iv.next30
  ...
  br i1 %exitcond32.1, label %._crit_edge9.us.us.loopexit, label %.preheader2.us.us.new

.preheader1:                                      ; preds = %._crit_edge10.us
  %75 = icmp sgt i32 %0, 0
  br i1 %75, label %.preheader.us.preheader, label %._crit_edge7
...
.prol.preheader:                                  ; preds = %.prol.preheader.preheader, %.prol.preheader
  ...
  %84 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %83, i64 0, i64 %indvars.iv26, i64 %indvars.iv.prol
  %85 = bitcast double* %84 to i64*
  %86 = load i64, i64* %85, align 8
  %87 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv26, i64 %indvars.iv.prol
...
.preheader.us.new:                                ; preds = %.preheader.us.new.preheader, %.preheader.us.new
  ...
  %89 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %82, i64 0, i64 %indvars.iv26, i64 %indvars.iv
  %90 = bitcast double* %89 to i64*
  %91 = load i64, i64* %90, align 8
  %92 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv26, i64 %indvars.iv
  %93 = bitcast double* %92 to i64*
  store i64 %91, i64* %93, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %94 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %82, i64 0, i64 %indvars.iv26, i64 %indvars.iv.next
  %95 = bitcast double* %94 to i64*
  %96 = load i64, i64* %95, align 8
  %97 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv26, i64 %indvars.iv.next
  %98 = bitcast double* %97 to i64*
  store i64 %96, i64* %98, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %99 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %82, i64 0, i64 %indvars.iv26, i64 %indvars.iv.next.1
  %100 = bitcast double* %99 to i64*
  %101 = load i64, i64* %100, align 8
  %102 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv26, i64 %indvars.iv.next.1
  %103 = bitcast double* %102 to i64*
  store i64 %101, i64* %103, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %104 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %82, i64 0, i64 %indvars.iv26, i64 %indvars.iv.next.2
  %105 = bitcast double* %104 to i64*
  %106 = load i64, i64* %105, align 8
  %107 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv26, i64 %indvars.iv.next.2
...
._crit_edge7:                                     ; preds = %._crit_edge7.loopexit, %._crit_edge23, %._crit_edge23.thread, %.preheader4, %.preheader1
  %109 = phi i8* [ %26, %.preheader1 ], [ %26, %.preheader4 ], [ %26, %._crit_edge23 ], [ %4, %._crit_edge23.thread ], [ %26, %._crit_edge7.loopexit ]
  tail call void @free(i8* %109) #4
  ret void

._crit_edge17.us.3:                               ; preds = %._crit_edge17.us.3, %._crit_edge17.us.3.preheader.new
  %indvars.iv49 = phi i64 [ %indvars.iv49.unr85, %._crit_edge17.us.3.preheader.new ], [ %indvars.iv.next50.3.1, %._crit_edge17.us.3 ]
  %110 = mul nuw nsw i64 %indvars.iv49, 16000
  %scevgep = getelementptr i8, i8* %26, i64 %110
  call void @llvm.memset.p0i8.i64(i8* %scevgep, i8 0, i64 %30, i32 8, i1 false)
  %111 = mul i64 %indvars.iv49, 16000
  ...
  %113 = mul i64 %indvars.iv49, 16000
  ...
  %115 = mul i64 %indvars.iv49, 16000
  ...
  %117 = mul nuw nsw i64 %indvars.iv.next50.3, 16000
  %scevgep.186 = getelementptr i8, i8* %26, i64 %117
  call void @llvm.memset.p0i8.i64(i8* %scevgep.186, i8 0, i64 %30, i32 8, i1 false)
  %118 = mul i64 %indvars.iv.next50.3, 16000
  ...
  %120 = mul i64 %indvars.iv.next50.3, 16000
  ...
  %122 = mul i64 %indvars.iv.next50.3, 16000
  ...
  %indvars.iv.next50.3.1 = add nsw i64 %indvars.iv49, 8
  %exitcond52.3.1 = icmp eq i64 %indvars.iv.next50.3.1, %wide.trip.count51.3
  br i1 %exitcond52.3.1, label %.preheader4.unr-lcssa, label %._crit_edge17.us.3
}
