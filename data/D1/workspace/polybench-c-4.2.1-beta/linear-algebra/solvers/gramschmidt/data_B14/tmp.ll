...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %.preheader66
  ...
  br i1 %16, label %.lr.ph71.preheader, label %.preheader65
...
.lr.ph71.prol.loopexit:                           ; preds = %.lr.ph71.prol, %.lr.ph71.preheader
  ...
  br i1 %17, label %.preheader65, label %.lr.ph71.preheader143
...
.preheader65:                                     ; preds = %.preheader65.loopexit, %.lr.ph71.prol.loopexit, %._crit_edge
  ...
  %53 = icmp slt i64 %indvars.iv.next115, %7
  br i1 %53, label %.lr.ph77, label %._crit_edge78

.lr.ph77:                                         ; preds = %.preheader65
  br i1 %18, label %.lr.ph77.split.us.preheader, label %._crit_edge78.loopexit89
...
.prol.loopexit123:                                ; preds = %.prol.preheader122, %.lr.ph77.split.us
  ...
  br i1 %19, label %.preheader.us, label %.lr.ph77.split.us.new.preheader
...
.lr.ph77.split.us.new:                            ; preds = %.lr.ph77.split.us.new.preheader, %.lr.ph77.split.us.new
  ...
  %exitcond.1127 = icmp eq i64 %indvars.iv.next101.1, %8
...
.preheader.us:                                    ; preds = %.preheader.us.loopexit, %.prol.loopexit123
  br i1 %20, label %.lr.ph76.us.preheader, label %.loopexit.us
...
.lr.ph76.us.prol.loopexit:                        ; preds = %.lr.ph76.us.prol, %.lr.ph76.us.preheader
  ...
  br i1 %21, label %.loopexit.us, label %.lr.ph76.us.preheader142
...
.lr.ph76.us:                                      ; preds = %.lr.ph76.us.preheader142, %.lr.ph76.us
  ...
  %exitcond.1131 = icmp eq i64 %indvars.iv.next105.1, %8
...
._crit_edge78.loopexit89:                         ; preds = %.lr.ph77
  ...
  call void @llvm.memset.p0i8.i64(i8* nonnull %105, i8 0, i64 %25, i32 8, i1 false)
...
._crit_edge78:                                    ; preds = %._crit_edge78.loopexit, %._crit_edge78.loopexit89, %.preheader65
  ...
  %exitcond134 = icmp eq i64 %indvars.iv.next115, %10
...
; <label>:14:                                     ; preds = %21, %.preheader4.us
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %21 ], [ 0, %.preheader4.us ]
