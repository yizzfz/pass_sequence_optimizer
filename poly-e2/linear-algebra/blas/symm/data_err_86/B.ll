...
for.body26:                                       ; preds = %for.body26.preheader, %for.body26
  ...
  %arrayidx35.1 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv30, i64 %indvars.iv.next
...
vector.memcheck:                                  ; preds = %for.body
  ...
  %scevgep41 = getelementptr [1200 x double], [1200 x double]* %B, i64 %indvars.iv32, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load50 = load <2 x double>, <2 x double>* %4, align 8, !alias.scope !3, !noalias !6
  %5 = fmul <2 x double> %wide.load, %broadcast.splat52
  %6 = fmul <2 x double> %wide.load50, %broadcast.splat52
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv32, i64 %index
  %8 = bitcast double* %7 to <2 x double>*
  %wide.load53 = load <2 x double>, <2 x double>* %8, align 8, !alias.scope !9
  %9 = getelementptr double, double* %7, i64 2
  %10 = bitcast double* %9 to <2 x double>*
  %wide.load54 = load <2 x double>, <2 x double>* %10, align 8, !alias.scope !9
  %11 = fmul <2 x double> %wide.load53, %broadcast.splat56
  %12 = fmul <2 x double> %wide.load54, %broadcast.splat56
  ...
  %22 = fadd <2 x double> %20, %broadcast.splat58
  ...
  br i1 %26, label %for.inc53.loopexit62, label %vector.body, !llvm.loop !11
...
for.body3:                                        ; preds = %for.body3, %for.body3.preheader
  ...
  br i1 %exitcond.1, label %for.inc53.loopexit61, label %for.body3, !llvm.loop !14
