...
for.body6:                                        ; preds = %for.body6, %for.body6.lr.ph.new
  ...
  %14 = insertelement <2 x double> undef, double %conv9, i32 0
  %div.v.i1.2 = shufflevector <2 x double> %14, <2 x double> undef, <2 x i32> zeroinitializer
...
for.inc14:                                        ; preds = %for.body6.prol.loopexit, %for.inc14.unr-lcssa
  ...
  %exitcond = icmp eq i64 %indvars.iv.next9, %1
...
for.end:                                          ; preds = %for.end.loopexit, %for.body
  ...
  %exitcond = icmp eq i64 %indvars.iv.next7, %0
...
for.body:                                         ; preds = %for.inc, %for.body.preheader
  ...
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %5, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i64 0, i64 0), double %6) #3
