...
@__llvm_prf_nm = private constant [34 x i8] c"\1D x\DA\0B\F1ts\0BN-q-*\CA/\F2H\CCK\C9I-b\0C\01\8A\81\05\00\99\06\0AR", section "__llvm_prf_names"
@llvm.used = appending global [4 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_TIFFSetErrorHandler to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_TIFFError to i8*), i8* bitcast ([10 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([34 x i8], [34 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
