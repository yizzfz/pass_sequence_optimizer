...
.lr.ph:                                           ; preds = %.lr.ph3, %._crit_edge
  ...
  %4 = getelementptr inbounds double, double* %2, i64 %indvars.iv9
  store double -9.990000e+02, double* %4, align 8
  %5 = trunc i64 %indvars.iv9 to i32
  %6 = sitofp i32 %5 to double
  %7 = getelementptr inbounds double, double* %3, i64 %indvars.iv9
...
.prol.preheader:                                  ; preds = %.lr.ph
  ...
  %12 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv9, i64 0
  store double %11, double* %12, align 8
  br label %.prol.loopexit.unr-lcssa

.prol.loopexit.unr-lcssa:                         ; preds = %.lr.ph, %.prol.preheader
  %indvars.iv.unr.ph = phi i64 [ 1, %.prol.preheader ], [ 0, %.lr.ph ]
  %13 = icmp eq i64 %indvars.iv9, 0
...
; <label>:4:                                      ; preds = %._crit_edge, %.lr.ph10
  %indvars.iv18 = phi i64 [ 0, %.lr.ph10 ], [ %indvars.iv.next19, %._crit_edge ]
  %5 = add i64 %indvars.iv18, 4294967295
  %6 = getelementptr inbounds double, double* %3, i64 %indvars.iv18
  %7 = bitcast double* %6 to i64*
  %8 = load i64, i64* %7, align 8
  %9 = getelementptr inbounds double, double* %2, i64 %indvars.iv18
...
.lr.ph:                                           ; preds = %4
  %xtraiter23 = and i64 %indvars.iv18, 1
  %lcmp.mod = icmp eq i64 %xtraiter23, 0
  br i1 %lcmp.mod, label %.prol.loopexit.unr-lcssa, label %.prol.preheader

.prol.preheader:                                  ; preds = %.lr.ph
  %13 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv18, i64 0
...
.prol.loopexit.unr-lcssa:                         ; preds = %.lr.ph, %.prol.preheader
  %indvars.iv.unr.ph = phi i64 [ 1, %.prol.preheader ], [ 0, %.lr.ph ]
  %.unr.ph = phi double [ %17, %.prol.preheader ], [ %11, %.lr.ph ]
  %.lcssa13.unr.ph = phi double [ %17, %.prol.preheader ], [ undef, %.lr.ph ]
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.lr.ph.new ], [ %indvars.iv.unr.ph, %.lr.ph.new.preheader ]
  %20 = phi double [ %32, %.lr.ph.new ], [ %.unr.ph, %.lr.ph.new.preheader ]
  %21 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv18, i64 %indvars.iv
  %22 = load double, double* %21, align 8
  %23 = getelementptr inbounds double, double* %2, i64 %indvars.iv
  %24 = load double, double* %23, align 8
  %25 = fmul double %22, %24
  %26 = fsub double %20, %25
  store double %26, double* %sunkaddr4, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %27 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv18, i64 %indvars.iv.next
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %4, %.prol.loopexit.unr-lcssa
  %.lcssa = phi double [ %.lcssa13.unr.ph, %.prol.loopexit.unr-lcssa ], [ %11, %4 ], [ %32, %._crit_edge.loopexit ]
  %33 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv18, i64 %indvars.iv18
  %34 = load double, double* %33, align 8
  %35 = fdiv double %.lcssa, %34
  store double %35, double* %sunkaddr4, align 8
  %indvars.iv.next19 = add nuw nsw i64 %indvars.iv18, 1
  %exitcond = icmp eq i64 %indvars.iv.next19, 2000
  br i1 %exitcond, label %._crit_edge11, label %4
