...
._crit_edge33.us.prol.loopexit:                   ; preds = %._crit_edge40, %._crit_edge33.us.prol.loopexit.unr-lcssa
  br i1 false, label %.preheader9.us.us.preheader.preheader, label %._crit_edge40.new
...
._crit_edge33.us:                                 ; preds = %._crit_edge33.us, %._crit_edge40.new
  ...
  br i1 %exitcond68.7, label %.preheader9.us.us.preheader.preheader.unr-lcssa, label %._crit_edge33.us
...
.preheader9.us.us.preheader:                      ; preds = %.preheader9.us.us.preheader.preheader, %._crit_edge22.us
  ...
  %scevgep100 = getelementptr [2000 x double], [2000 x double]* %1, i64 2000, i64 %37
...
.preheader9.us.us:                                ; preds = %._crit_edge20.us.us, %.preheader9.us.us.preheader
  ...
  %scevgep96 = getelementptr i8, i8* %19, i64 %38
  %39 = add i64 16000, %38
  %scevgep97 = getelementptr i8, i8* %19, i64 %39
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load107 = load <2 x double>, <2 x double>* %73, align 8, !alias.scope !8, !noalias !10
  %74 = fadd <2 x double> %wide.load, %68
  %75 = fadd <2 x double> %wide.load107, %69
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  ...
  %scevgep121 = getelementptr i8, i8* %19, i64 %93
  %94 = add i64 16000, %93
  %scevgep122 = getelementptr i8, i8* %19, i64 %94
  br i1 false, label %._crit_edge92.preheader, label %min.iters.checked112

min.iters.checked112:                             ; preds = %.preheader.us
  br i1 false, label %._crit_edge92.preheader, label %vector.memcheck127
...
vector.memcheck127:                               ; preds = %min.iters.checked112
  ...
  br i1 %memcheck.conflict126, label %._crit_edge92.preheader, label %vector.body108.preheader
...
vector.body108:                                   ; preds = %vector.body108.preheader, %vector.body108
  ...
  %95 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv45, i64 %index129
  %96 = bitcast double* %95 to <2 x i64>*
  %wide.load137 = load <2 x i64>, <2 x i64>* %96, align 8, !alias.scope !15
  %97 = getelementptr double, double* %95, i64 2
  %98 = bitcast double* %97 to <2 x i64>*
  %wide.load138 = load <2 x i64>, <2 x i64>* %98, align 8, !alias.scope !15
  %99 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv45, i64 %index129
  %100 = bitcast double* %99 to <2 x i64>*
  store <2 x i64> %wide.load137, <2 x i64>* %100, align 8, !alias.scope !18, !noalias !15
  %101 = getelementptr double, double* %99, i64 2
  %102 = bitcast double* %101 to <2 x i64>*
  store <2 x i64> %wide.load138, <2 x i64>* %102, align 8, !alias.scope !18, !noalias !15
  %index.next130 = add i64 %index129, 4
  %103 = icmp eq i64 %index.next130, 2000
  br i1 %103, label %middle.block109, label %vector.body108, !llvm.loop !20

middle.block109:                                  ; preds = %vector.body108
  br i1 true, label %._crit_edge.us, label %._crit_edge92.preheader

._crit_edge92.preheader:                          ; preds = %middle.block109, %vector.memcheck127, %min.iters.checked112, %.preheader.us
