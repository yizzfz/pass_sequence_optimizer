...
; <label>:14:                                     ; preds = %14, %.lr.ph.new
  ...
  %33 = icmp slt i64 %indvars.iv.next.1, %6
  br i1 %33, label %14, label %.loopexit.loopexit.unr-lcssa
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.preheader, %._crit_edge5.us
  ...
  br i1 %min.iters.check52, label %scalar.ph50.preheader, label %min.iters.checked53

scalar.ph50.preheader:                            ; preds = %middle.block49, %vector.memcheck69, %min.iters.checked53, %._crit_edge.us
  %indvars.iv.ph = phi i64 [ 1, %vector.memcheck69 ], [ 1, %min.iters.checked53 ], [ 1, %._crit_edge.us ], [ %ind.end74, %middle.block49 ]
  br label %scalar.ph50

min.iters.checked53:                              ; preds = %._crit_edge.us
  br i1 %cmp.zero56, label %scalar.ph50.preheader, label %vector.memcheck69

vector.memcheck69:                                ; preds = %min.iters.checked53
  br i1 %memcheck.conflict68, label %scalar.ph50.preheader, label %vector.body48.preheader
...
vector.body48:                                    ; preds = %vector.body48.preheader, %vector.body48
  ...
  %wide.load81 = load <2 x double>, <2 x double>* %21, align 8, !alias.scope !1
  ...
  %wide.load84 = load <2 x double>, <2 x double>* %27, align 8, !alias.scope !1
  ...
  br i1 %43, label %middle.block49, label %vector.body48, !llvm.loop !6

middle.block49:                                   ; preds = %vector.body48
  br i1 %cmp.n75, label %.lr.ph4.us.preheader, label %scalar.ph50.preheader
...
scalar.ph50:                                      ; preds = %scalar.ph50.preheader, %scalar.ph50
  %indvars.iv = phi i64 [ %65, %scalar.ph50 ], [ %indvars.iv.ph, %scalar.ph50.preheader ]
  ...
  br i1 %71, label %scalar.ph50, label %.lr.ph4.us.preheader.loopexit, !llvm.loop !10

.lr.ph4.us.preheader.loopexit:                    ; preds = %scalar.ph50
  br label %.lr.ph4.us.preheader

.lr.ph4.us.preheader:                             ; preds = %.lr.ph4.us.preheader.loopexit, %middle.block49
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load43 = load <2 x double>, <2 x double>* %76, align 8, !alias.scope !11
  %77 = getelementptr inbounds double, double* %3, i64 %offset.idx
  %78 = bitcast double* %77 to <2 x double>*
  %wide.load44 = load <2 x double>, <2 x double>* %78, align 8, !alias.scope !11
  %79 = getelementptr double, double* %77, i64 2
  %80 = bitcast double* %79 to <2 x double>*
  %wide.load45 = load <2 x double>, <2 x double>* %80, align 8, !alias.scope !11
  ...
  %wide.load46 = load <2 x double>, <2 x double>* %85, align 8, !alias.scope !11
  %86 = getelementptr double, double* %84, i64 2
  %87 = bitcast double* %86 to <2 x double>*
  %wide.load47 = load <2 x double>, <2 x double>* %87, align 8, !alias.scope !11
