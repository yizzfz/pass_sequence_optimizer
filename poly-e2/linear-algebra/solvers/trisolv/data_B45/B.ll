...
for.body:                                         ; preds = %for.inc14, %for.body.lr.ph
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc14 ], [ 0, %for.body.lr.ph ]
...
for.body6.prol.loopexit:                          ; preds = %for.body6.prol.loopexit.unr-lcssa
  ...
  br i1 %3, label %for.inc14.loopexit, label %for.body6.lr.ph.new
...
for.inc14:                                        ; preds = %for.inc14.loopexit, %for.body
  ...
  %exitcond = icmp ne i64 %indvars.iv.next7, %wide.trip.count8
...
for.body.preheader:                               ; preds = %entry
  %0 = sext i32 %n to i64
  %sunkaddr11 = ptrtoint double* %x to i64
...
for.body5.prol:                                   ; preds = %for.body5.prol.preheader
  ...
  store double %sub.prol, double* %sunkaddr10, align 8
...
for.body5:                                        ; preds = %for.body5, %for.body5.preheader.new
  ...
  store double %sub.1, double* %sunkaddr10, align 8
