...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %23 = shl i64 %index, 3
  %offset.idx = add i64 %indvars.iv51.unr, %23
  %24 = add nsw i64 %offset.idx, 7
  %25 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv60, i64 %24
...
for.inc36:                                        ; preds = %for.inc36.preheader, %for.inc36
  ...
  %29 = add nuw nsw i64 %indvars.iv, %indvars.iv60
  %30 = trunc i64 %29 to i32
  %rem28 = srem i32 %30, 100
  ...
  %31 = add nuw nsw i64 %indvars.iv.next, %indvars.iv60
  %32 = trunc i64 %31 to i32
  %rem28.1 = srem i32 %32, 100
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %20 = fadd <2 x double> %broadcast.splat81, %18
  %21 = fadd <2 x double> %broadcast.splat81, %19
