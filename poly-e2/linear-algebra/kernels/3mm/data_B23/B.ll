...
if.then:                                          ; preds = %land.lhs.true
  tail call void @print_array([1100 x double]* %arraydecay167)
  br label %if.end
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal void @kernel_3mm([900 x double]* %E, [1000 x double]* nocapture readonly %A, [900 x double]* nocapture readonly %B, [1100 x double]* %F, [1200 x double]* nocapture readonly %C, [1100 x double]* nocapture readonly %D, [1100 x double]* %G) #2 {
entry:
  br label %for.cond1.preheader

for.cond1.preheader:                              ; preds = %for.end23.for.cond1.preheader_crit_edge, %entry
  %indvar33 = phi i64 [ 0, %entry ], [ %indvar.next34, %for.end23.for.cond1.preheader_crit_edge ]
  %0 = phi i64 [ 0, %entry ], [ %inc25, %for.end23.for.cond1.preheader_crit_edge ]
  %sext = shl i64 %0, 32
  %idxprom = ashr exact i64 %sext, 32
  %arrayidx = getelementptr inbounds [900 x double], [900 x double]* %E, i64 %idxprom
  %sunkaddr = ptrtoint [900 x double]* %arrayidx to i64
  br label %for.body3

for.body3:                                        ; preds = %for.end, %for.cond1.preheader
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.end ], [ 0, %for.cond1.preheader ]
  %arrayidx5 = getelementptr inbounds [900 x double], [900 x double]* %E, i64 %idxprom, i64 %indvars.iv45
  store double 0.000000e+00, double* %arrayidx5, align 8
  %sunkaddr3 = shl nsw i64 %indvars.iv45, 3
  %sunkaddr12 = add i64 %sunkaddr, %sunkaddr3
  %sunkaddr13 = inttoptr i64 %sunkaddr12 to double*
  br label %for.body8

for.body8:                                        ; preds = %for.body8, %for.body3
  %indvars.iv30 = phi i64 [ 0, %for.body3 ], [ %indvars.iv.next31.1, %for.body8 ]
  %1 = phi double [ 0.000000e+00, %for.body3 ], [ %add.1, %for.body8 ]
  %arrayidx12 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %idxprom, i64 %indvars.iv30
  %2 = load double, double* %arrayidx12, align 8
  %arrayidx16 = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv30, i64 %indvars.iv45
  %3 = load double, double* %arrayidx16, align 8
  %mul = fmul double %2, %3
  %add = fadd double %1, %mul
  store double %add, double* %sunkaddr13, align 8
  %indvars.iv.next31 = or i64 %indvars.iv30, 1
  %arrayidx12.1 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %idxprom, i64 %indvars.iv.next31
  %4 = load double, double* %arrayidx12.1, align 8
  %arrayidx16.1 = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv.next31, i64 %indvars.iv45
  %5 = load double, double* %arrayidx16.1, align 8
  %mul.1 = fmul double %4, %5
  %add.1 = fadd double %add, %mul.1
  store double %add.1, double* %sunkaddr13, align 8
  %indvars.iv.next31.1 = add nuw nsw i64 %indvars.iv30, 2
  %exitcond32.1 = icmp eq i64 %indvars.iv.next31.1, 1000
  br i1 %exitcond32.1, label %for.end, label %for.body8

for.end:                                          ; preds = %for.body8
  %indvars.iv.next46 = add nuw nsw i64 %indvars.iv45, 1
  %exitcond47 = icmp ne i64 %indvars.iv.next46, 900
  br i1 %exitcond47, label %for.body3, label %for.end23

for.end23:                                        ; preds = %for.end
  %indvar.next34 = add nuw nsw i64 %indvar33, 1
  %exitcond36 = icmp eq i64 %indvar.next34, 800
  br i1 %exitcond36, label %for.cond30.preheader.preheader, label %for.end23.for.cond1.preheader_crit_edge
...
for.cond30.preheader:                             ; preds = %for.cond30.preheader.preheader, %for.end59.for.cond30.preheader_crit_edge
  %indvar26 = phi i64 [ %indvar.next27, %for.end59.for.cond30.preheader_crit_edge ], [ 0, %for.cond30.preheader.preheader ]
  %6 = phi i64 [ %inc61, %for.end59.for.cond30.preheader_crit_edge ], [ 0, %for.cond30.preheader.preheader ]
  %sext37 = shl i64 %6, 32
  %idxprom33 = ashr exact i64 %sext37, 32
  %arrayidx34 = getelementptr inbounds [1100 x double], [1100 x double]* %F, i64 %idxprom33
  %sunkaddr14 = ptrtoint [1100 x double]* %arrayidx34 to i64
  br label %for.body32

for.body32:                                       ; preds = %for.end56, %for.cond30.preheader
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.end56 ], [ 0, %for.cond30.preheader ]
  %arrayidx36 = getelementptr inbounds [1100 x double], [1100 x double]* %F, i64 %idxprom33, i64 %indvars.iv42
  store double 0.000000e+00, double* %arrayidx36, align 8
  %sunkaddr15 = shl nsw i64 %indvars.iv42, 3
...
for.body39:                                       ; preds = %for.body39, %for.body32
  %indvars.iv23 = phi i64 [ 0, %for.body32 ], [ %indvars.iv.next24.1, %for.body39 ]
  %7 = phi double [ 0.000000e+00, %for.body32 ], [ %add53.1, %for.body39 ]
  %arrayidx43 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %idxprom33, i64 %indvars.iv23
  %8 = load double, double* %arrayidx43, align 8
  %arrayidx47 = getelementptr inbounds [1100 x double], [1100 x double]* %D, i64 %indvars.iv23, i64 %indvars.iv42
  %9 = load double, double* %arrayidx47, align 8
  %mul48 = fmul double %8, %9
  %add53 = fadd double %7, %mul48
  store double %add53, double* %sunkaddr17, align 8
  %indvars.iv.next24 = or i64 %indvars.iv23, 1
  %arrayidx43.1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %idxprom33, i64 %indvars.iv.next24
  %10 = load double, double* %arrayidx43.1, align 8
  %arrayidx47.1 = getelementptr inbounds [1100 x double], [1100 x double]* %D, i64 %indvars.iv.next24, i64 %indvars.iv42
  %11 = load double, double* %arrayidx47.1, align 8
  %mul48.1 = fmul double %10, %11
  %add53.1 = fadd double %add53, %mul48.1
  store double %add53.1, double* %sunkaddr17, align 8
  %indvars.iv.next24.1 = add nuw nsw i64 %indvars.iv23, 2
  %exitcond25.1 = icmp eq i64 %indvars.iv.next24.1, 1200
  br i1 %exitcond25.1, label %for.end56, label %for.body39

for.end56:                                        ; preds = %for.body39
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1
  %exitcond44 = icmp ne i64 %indvars.iv.next43, 1100
  br i1 %exitcond44, label %for.body32, label %for.end59

for.end59:                                        ; preds = %for.end56
  %indvar.next27 = add nuw nsw i64 %indvar26, 1
  %exitcond29 = icmp eq i64 %indvar.next27, 900
  br i1 %exitcond29, label %for.cond66.preheader.preheader, label %for.end59.for.cond30.preheader_crit_edge
...
for.cond66.preheader:                             ; preds = %for.cond66.preheader.preheader, %for.end95.for.cond66.preheader_crit_edge
  ...
  %12 = phi i64 [ %inc97, %for.end95.for.cond66.preheader_crit_edge ], [ 0, %for.cond66.preheader.preheader ]
  %sext38 = shl i64 %12, 32
  %idxprom69 = ashr exact i64 %sext38, 32
  %arrayidx70 = getelementptr inbounds [1100 x double], [1100 x double]* %G, i64 %idxprom69
  %sunkaddr18 = ptrtoint [1100 x double]* %arrayidx70 to i64
  br label %for.body68

for.body68:                                       ; preds = %for.end92, %for.cond66.preheader
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.end92 ], [ 0, %for.cond66.preheader ]
  %arrayidx72 = getelementptr inbounds [1100 x double], [1100 x double]* %G, i64 %idxprom69, i64 %indvars.iv39
  store double 0.000000e+00, double* %arrayidx72, align 8
  %sunkaddr19 = shl nsw i64 %indvars.iv39, 3
...
for.body75:                                       ; preds = %for.body75, %for.body68
  %indvars.iv = phi i64 [ 0, %for.body68 ], [ %indvars.iv.next.1, %for.body75 ]
  %13 = phi double [ 0.000000e+00, %for.body68 ], [ %add89.1, %for.body75 ]
  %arrayidx79 = getelementptr inbounds [900 x double], [900 x double]* %E, i64 %idxprom69, i64 %indvars.iv
  %14 = load double, double* %arrayidx79, align 8
  %arrayidx83 = getelementptr inbounds [1100 x double], [1100 x double]* %F, i64 %indvars.iv, i64 %indvars.iv39
  %15 = load double, double* %arrayidx83, align 8
  %mul84 = fmul double %14, %15
  %add89 = fadd double %13, %mul84
  store double %add89, double* %sunkaddr21, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx79.1 = getelementptr inbounds [900 x double], [900 x double]* %E, i64 %idxprom69, i64 %indvars.iv.next
  %16 = load double, double* %arrayidx79.1, align 8
  %arrayidx83.1 = getelementptr inbounds [1100 x double], [1100 x double]* %F, i64 %indvars.iv.next, i64 %indvars.iv39
  %17 = load double, double* %arrayidx83.1, align 8
  %mul84.1 = fmul double %16, %17
  %add89.1 = fadd double %add89, %mul84.1
  store double %add89.1, double* %sunkaddr21, align 8
...
for.end92:                                        ; preds = %for.body75
  ...
  %exitcond41 = icmp ne i64 %indvars.iv.next40, 1100
  br i1 %exitcond41, label %for.body68, label %for.end95
