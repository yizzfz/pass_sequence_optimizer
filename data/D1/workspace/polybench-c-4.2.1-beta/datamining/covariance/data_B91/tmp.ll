...
.lr.ph34.split.us:                                ; preds = %._crit_edge30.us, %.lr.ph34.split.us.preheader
  ...
  %sunkaddr6 = shl i64 %indvars.iv79, 3
...
._crit_edge30.us:                                 ; preds = %._crit_edge
  %22 = fdiv double %21, %0
  %sunkaddr38 = shl i64 %indvars.iv79, 3
...
vector.memcheck:                                  ; preds = %._crit_edge25.us, %._crit_edge30.us..preheader6.us_crit_edge
  %indvars.iv70 = phi i64 [ 0, %._crit_edge30.us..preheader6.us_crit_edge ], [ %23, %._crit_edge25.us ]
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  br i1 %39, label %._crit_edge25.us.loopexit41, label %vector.body, !llvm.loop !6
...
._crit_edge35:                                    ; preds = %._crit_edge35, %.lr.ph.us.us
  ...
  br i1 %exitcond89.1, label %._crit_edge.us.us, label %._crit_edge35
