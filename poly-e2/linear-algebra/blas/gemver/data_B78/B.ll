...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv59, i64 %offset.idx
  ...
  %18 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv59, i64 %17
...
for.inc80.us:                                     ; preds = %for.cond64.preheader.us, %for.inc80.us
  ...
  %57 = phi double [ %add77.us.1, %for.inc80.us ], [ %.pre36, %for.cond64.preheader.us ]
