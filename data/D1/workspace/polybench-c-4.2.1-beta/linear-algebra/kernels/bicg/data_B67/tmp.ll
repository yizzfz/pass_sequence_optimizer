...
.lr.ph14.new:                                     ; preds = %.lr.ph14.new..lr.ph14.new_crit_edge, %.lr.ph14
  %indvars.iv412 = phi i64 [ %indvars.iv.next5.1, %.lr.ph14.new..lr.ph14.new_crit_edge ], [ 0, %.lr.ph14 ]
...
.lr.ph10.split.us.new:                            ; preds = %.lr.ph10.split.us.new..lr.ph10.split.us.new_crit_edge, %.lr.ph10.split.us
  %indvars.iv6.us = phi i64 [ %indvars.iv.next.us.1, %.lr.ph10.split.us.new..lr.ph10.split.us.new_crit_edge ], [ 0, %.lr.ph10.split.us ]
  ...
  %indvars.iv.next.us.1 = add nuw nsw i64 %indvars.iv6.us, 2
...
.lr.ph10.split.us:                                ; preds = %._crit_edge.us..lr.ph10.split.us_crit_edge, %.lr.ph14.preheader
  %indvars.iv27.us = phi i64 [ %indvars.iv.next3.us, %._crit_edge.us..lr.ph10.split.us_crit_edge ], [ 0, %.lr.ph14.preheader ]
...
; <label>:8:                                      ; preds = %._crit_edge, %.lr.ph10.split.us
