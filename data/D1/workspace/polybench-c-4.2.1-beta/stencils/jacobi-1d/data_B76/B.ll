...
._crit_edge.lr.ph:
  ...
  %scevgep39 = getelementptr double, double* %0, i64 1999
  %scevgep41 = getelementptr double, double* %1, i64 2000
  %scevgep59 = getelementptr double, double* %1, i64 1
  %scevgep62 = getelementptr double, double* %1, i64 1999
  %scevgep64 = getelementptr double, double* %0, i64 2000
  %bound066 = icmp ult double* %scevgep59, %scevgep64
  %bound167 = icmp ugt double* %scevgep62, %0
  %memcheck.conflict69 = and i1 %bound066, %bound167
  %bound0 = icmp ult double* %scevgep, %scevgep41
  %bound1 = icmp ugt double* %scevgep39, %1
  %memcheck.conflict = and i1 %bound0, %bound1
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.lr.ph, %._crit_edge7.us
  %2 = phi i32 [ %28, %._crit_edge7.us ], [ 0, %._crit_edge.lr.ph ]
  br i1 %memcheck.conflict69, label %scalar.ph51.preheader, label %vector.body49.preheader

vector.body49.preheader:                          ; preds = %._crit_edge.us
  br label %vector.body49

scalar.ph51.preheader.loopexit:                   ; preds = %vector.body49
  br label %scalar.ph51.preheader

scalar.ph51.preheader:                            ; preds = %scalar.ph51.preheader.loopexit, %._crit_edge.us
  %indvars.iv.ph = phi i64 [ 1, %._crit_edge.us ], [ 1997, %scalar.ph51.preheader.loopexit ]
...
vector.body49:                                    ; preds = %vector.body49.preheader, %vector.body49
  ...
  %3 = add nsw i64 %offset.idx77, -1
  %4 = getelementptr inbounds double, double* %0, i64 %3
  %5 = bitcast double* %4 to <2 x double>*
  %wide.load82 = load <2 x double>, <2 x double>* %5, align 8, !alias.scope !1
  %6 = getelementptr double, double* %4, i64 2
  %7 = bitcast double* %6 to <2 x double>*
  %wide.load83 = load <2 x double>, <2 x double>* %7, align 8, !alias.scope !1
  %8 = getelementptr inbounds double, double* %0, i64 %offset.idx77
  %9 = bitcast double* %8 to <2 x double>*
  %wide.load84 = load <2 x double>, <2 x double>* %9, align 8, !alias.scope !1
  %10 = getelementptr double, double* %8, i64 2
  %11 = bitcast double* %10 to <2 x double>*
  %wide.load85 = load <2 x double>, <2 x double>* %11, align 8, !alias.scope !1
  %12 = fadd <2 x double> %wide.load82, %wide.load84
  %13 = fadd <2 x double> %wide.load83, %wide.load85
  %14 = add nuw nsw i64 %offset.idx77, 1
  ...
  %wide.load87 = load <2 x double>, <2 x double>* %18, align 8, !alias.scope !1
  %19 = fadd <2 x double> %12, %wide.load86
  %20 = fadd <2 x double> %13, %wide.load87
  ...
  %23 = getelementptr inbounds double, double* %1, i64 %offset.idx77
  ...
  %27 = icmp eq i64 %index.next73, 1996
  br i1 %27, label %scalar.ph51.preheader.loopexit, label %vector.body49, !llvm.loop !6
...
scalar.ph51:                                      ; preds = %scalar.ph51.preheader, %scalar.ph51
  %indvars.iv = phi i64 [ %49, %scalar.ph51 ], [ %indvars.iv.ph, %scalar.ph51.preheader ]
  ...
  br i1 %55, label %scalar.ph51, label %vector.memcheck, !llvm.loop !10

vector.memcheck:                                  ; preds = %scalar.ph51
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load44 = load <2 x double>, <2 x double>* %60, align 8, !alias.scope !11
  %61 = getelementptr inbounds double, double* %1, i64 %offset.idx
  %62 = bitcast double* %61 to <2 x double>*
  %wide.load45 = load <2 x double>, <2 x double>* %62, align 8, !alias.scope !11
  %63 = getelementptr double, double* %61, i64 2
  %64 = bitcast double* %63 to <2 x double>*
  %wide.load46 = load <2 x double>, <2 x double>* %64, align 8, !alias.scope !11
  %65 = fadd <2 x double> %wide.load, %wide.load45
  %66 = fadd <2 x double> %wide.load44, %wide.load46
  ...
  %72 = fadd <2 x double> %65, %wide.load47
  %73 = fadd <2 x double> %66, %wide.load48
