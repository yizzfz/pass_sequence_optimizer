...
._crit_edge3:                                     ; preds = %._crit_edge3, %.preheader
  ...
  %16 = srem i32 %15, 11
  %17 = icmp eq i32 %16, 0
  %or.cond7 = or i1 %17, %or.cond
  %. = select i1 %or.cond7, i32 999, i32 %6
  store i32 %., i32* %7, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 2800
  br i1 %exitcond, label %18, label %._crit_edge3

; <label>:18:                                     ; preds = %._crit_edge3
...
.preheader:                                       ; preds = %18, %.preheader3
  ...
  %3 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv7, i64 %indvars.iv10
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %._crit_edge, %.preheader
  ...
  %14 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv10, i64 %indvars.iv.next
