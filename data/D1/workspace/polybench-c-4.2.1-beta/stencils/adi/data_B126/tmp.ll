...
.preheader:                                       ; preds = %15, %1
  ...
  %2 = add nuw nsw i64 %indvars.iv14, 1000
  br label %3
...
; <label>:3:                                      ; preds = %3, %.preheader
  ...
  %7 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv14, i64 %indvars.iv
...
; <label>:15:                                     ; preds = %3
  ...
  br i1 %exitcond1, label %16, label %.preheader
...
.lver.check:                                      ; preds = %36, %.preheader152
  ...
  %indvars.iv171 = phi i64 [ %indvars.iv.next172, %36 ], [ 1, %.preheader152 ]
  %5 = add i64 %indvar, 1
  ...
  %6 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 0, i64 %indvars.iv171
  store double 1.000000e+00, double* %6, align 8
  %7 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv171, i64 0
  store double 0.000000e+00, double* %7, align 8
  %8 = bitcast double* %6 to i64*
  %9 = load i64, i64* %8, align 8
  %10 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv171
  %11 = bitcast [1000 x double]* %10 to i64*
  store i64 %9, i64* %11, align 8
  %12 = add nsw i64 %indvars.iv171, -1
...
.ph.lver.orig:                                    ; preds = %.ph.lver.orig.preheader, %.ph.lver.orig
  ...
  %14 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv171, i64 %13
  %15 = load double, double* %14, align 8
  %16 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv171, i64 %indvars.iv.lver.orig
  %17 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv.lver.orig, i64 %12
  %18 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv.lver.orig, i64 %indvars.iv.next172
  %19 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv171, i64 %13
  ...
  %35 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv171, i64 %indvars.iv.lver.orig
...
; <label>:36:                                     ; preds = %37
  %exitcond1 = icmp eq i64 %indvars.iv.next172, 999
  br i1 %exitcond1, label %.lver.check28.preheader, label %.lver.check

.lver.check28.preheader:                          ; preds = %36
  br label %.lver.check28

; <label>:37:                                     ; preds = %37, %._crit_edge.us
  %indvars.iv169 = phi i64 [ 998, %._crit_edge.us ], [ %indvars.iv.next170.1, %37 ]
  %38 = phi double [ 1.000000e+00, %._crit_edge.us ], [ %51, %37 ]
  %39 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv171, i64 %indvars.iv169
  %40 = load double, double* %39, align 8
  %41 = fmul double %40, %38
  %42 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv171, i64 %indvars.iv169
  %43 = load double, double* %42, align 8
  %44 = fadd double %41, %43
  %45 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv169, i64 %indvars.iv171
  store double %44, double* %45, align 8
  %indvars.iv.next170 = add nsw i64 %indvars.iv169, -1
  %46 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv171, i64 %indvars.iv.next170
  %47 = load double, double* %46, align 8
  %48 = fmul double %47, %44
  %49 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv171, i64 %indvars.iv.next170
  %50 = load double, double* %49, align 8
  %51 = fadd double %48, %50
  %52 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv.next170, i64 %indvars.iv171
  store double %51, double* %52, align 8
  %53 = icmp sgt i64 %indvars.iv.next170, 1
  %indvars.iv.next170.1 = add nsw i64 %indvars.iv169, -2
  br i1 %53, label %37, label %36

; <label>:54:                                     ; preds = %54, %.ph
  %store_forwarded13 = phi double [ %load_initial12, %.ph ], [ %71, %54 ]
  %store_forwarded = phi double [ %load_initial, %.ph ], [ %59, %54 ]
  %indvars.iv = phi i64 [ 1, %.ph ], [ %indvars.iv.next, %54 ]
  %55 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv171, i64 %indvars.iv
  %56 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv, i64 %12
  %57 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv, i64 %indvars.iv.next172
  ...
  %69 = fmul double %store_forwarded13, 0xC09F400000000001
  %70 = fsub double %68, %69
  %71 = fdiv double %70, %58
  %72 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv171, i64 %indvars.iv
  store double %71, double* %72, align 8
  %exitcond = icmp eq i64 %indvars.iv, 998
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br i1 %exitcond, label %._crit_edge.us.loopexit37, label %54

._crit_edge.us.loopexit:                          ; preds = %.ph.lver.orig
  br label %._crit_edge.us

._crit_edge.us.loopexit37:                        ; preds = %54
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit37, %._crit_edge.us.loopexit
  %73 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 999, i64 %indvars.iv171
  store double 1.000000e+00, double* %73, align 8
  br label %37

.lver.check28:                                    ; preds = %.lver.check28.preheader, %110
  %indvar14 = phi i64 [ %74, %110 ], [ 0, %.lver.check28.preheader ]
  %indvars.iv178 = phi i64 [ %indvars.iv.next179, %110 ], [ 1, %.lver.check28.preheader ]
  ...
  %75 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv178, i64 0
  store double 1.000000e+00, double* %75, align 8
  %76 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv178, i64 0
  store double 0.000000e+00, double* %76, align 8
  %77 = bitcast double* %75 to i64*
  %78 = load i64, i64* %77, align 8
  %79 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv178
  %80 = bitcast [1000 x double]* %79 to i64*
  store i64 %78, i64* %80, align 8
  %81 = add nsw i64 %indvars.iv178, -1
...
.ph29.lver.orig:                                  ; preds = %.ph29.lver.orig.preheader, %.ph29.lver.orig
  %indvars.iv173.lver.orig = phi i64 [ %indvars.iv.next174.lver.orig, %.ph29.lver.orig ], [ 1, %.ph29.lver.orig.preheader ]
  %82 = add nsw i64 %indvars.iv173.lver.orig, -1
  %83 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv178, i64 %82
  %84 = load double, double* %83, align 8
  %85 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv178, i64 %indvars.iv173.lver.orig
  %86 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %81, i64 %indvars.iv173.lver.orig
  %87 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv178, i64 %indvars.iv173.lver.orig
  %88 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv.next179, i64 %indvars.iv173.lver.orig
  %89 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv178, i64 %82
  ...
  %109 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv178, i64 %indvars.iv173.lver.orig
  store double %108, double* %109, align 8
  %exitcond175.lver.orig = icmp eq i64 %indvars.iv173.lver.orig, 998
  %indvars.iv.next174.lver.orig = add nuw nsw i64 %indvars.iv173.lver.orig, 1
  br i1 %exitcond175.lver.orig, label %._crit_edge160.us.loopexit, label %.ph29.lver.orig

.ph29:                                            ; preds = %.lver.check28
  %load_initial31 = load double, double* %scevgep16, align 8
  %load_initial34 = load double, double* %scevgep20, align 8
  br label %128

; <label>:110:                                    ; preds = %111
  %exitcond2 = icmp eq i64 %indvars.iv.next179, 999
  br i1 %exitcond2, label %._crit_edge164, label %.lver.check28

; <label>:111:                                    ; preds = %111, %._crit_edge160.us
  %112 = phi double [ 1.000000e+00, %._crit_edge160.us ], [ %125, %111 ]
  %indvars.iv176 = phi i64 [ 998, %._crit_edge160.us ], [ %indvars.iv.next177.1, %111 ]
  %113 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv178, i64 %indvars.iv176
  %114 = load double, double* %113, align 8
  %115 = fmul double %114, %112
  %116 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv178, i64 %indvars.iv176
  %117 = load double, double* %116, align 8
  %118 = fadd double %115, %117
  %119 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv178, i64 %indvars.iv176
  store double %118, double* %119, align 8
  %indvars.iv.next177 = add nsw i64 %indvars.iv176, -1
  %120 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv178, i64 %indvars.iv.next177
  %121 = load double, double* %120, align 8
  %122 = fmul double %121, %118
  %123 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv178, i64 %indvars.iv.next177
  %124 = load double, double* %123, align 8
  %125 = fadd double %122, %124
  %126 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv178, i64 %indvars.iv.next177
  store double %125, double* %126, align 8
  %127 = icmp sgt i64 %indvars.iv.next177, 1
  %indvars.iv.next177.1 = add nsw i64 %indvars.iv176, -2
  br i1 %127, label %111, label %110

; <label>:128:                                    ; preds = %128, %.ph29
  %store_forwarded35 = phi double [ %load_initial34, %.ph29 ], [ %150, %128 ]
  %store_forwarded32 = phi double [ %load_initial31, %.ph29 ], [ %139, %128 ]
  %indvars.iv173 = phi i64 [ 1, %.ph29 ], [ %indvars.iv.next174, %128 ]
  %129 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv178, i64 %indvars.iv173
  %130 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %81, i64 %indvars.iv173
  %131 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv178, i64 %indvars.iv173
  %132 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv.next179, i64 %indvars.iv173
  %133 = insertelement <2 x double> undef, double %store_forwarded32, i32 0
  ...
  %148 = fmul double %store_forwarded35, 0xC08F400000000001
  %149 = fsub double %147, %148
  %150 = fdiv double %149, %138
  %151 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv178, i64 %indvars.iv173
  store double %150, double* %151, align 8
  %exitcond175 = icmp eq i64 %indvars.iv173, 998
  %indvars.iv.next174 = add nuw nsw i64 %indvars.iv173, 1
  br i1 %exitcond175, label %._crit_edge160.us.loopexit36, label %128

._crit_edge160.us.loopexit:                       ; preds = %.ph29.lver.orig
  br label %._crit_edge160.us

._crit_edge160.us.loopexit36:                     ; preds = %128
  br label %._crit_edge160.us

._crit_edge160.us:                                ; preds = %._crit_edge160.us.loopexit36, %._crit_edge160.us.loopexit
  %152 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv178, i64 999
...
._crit_edge:                                      ; preds = %._crit_edge13, %11
  ...
  %14 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv14, i64 %indvars.iv
  %15 = load double, double* %14, align 8
