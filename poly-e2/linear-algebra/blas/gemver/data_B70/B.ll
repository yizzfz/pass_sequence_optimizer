...
for.body.us.preheader:
  ...
  br label %for.inc.us.prol.loopexit.for.inc.us_crit_edge

for.inc.us.prol.loopexit.for.inc.us_crit_edge:    ; preds = %for.cond35.for.cond.loopexit_crit_edge.us, %for.body.us.preheader
  %indvars.iv34 = phi i64 [ 0, %for.body.us.preheader ], [ %indvars.iv.next35, %for.cond35.for.cond.loopexit_crit_edge.us ]
...
for.inc.us:                                       ; preds = %for.inc.us, %for.inc.us.prol.loopexit.for.inc.us_crit_edge
  %indvars.iv = phi i64 [ 0, %for.inc.us.prol.loopexit.for.inc.us_crit_edge ], [ %indvars.iv.next.1, %for.inc.us ]
  %2 = mul nuw nsw i64 %indvars.iv, %indvars.iv34
  ...
  %4 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv34
...
for.cond35.for.cond.loopexit_crit_edge.us:        ; preds = %for.inc.us
  ...
  br i1 %exitcond37, label %for.end48, label %for.inc.us.prol.loopexit.for.inc.us_crit_edge
...
entry.for.cond1.preheader.us_crit_edge:
  %sunkaddr103 = ptrtoint double* %u1 to i64
  %sunkaddr107 = ptrtoint double* %u2 to i64
  %scevgep5 = getelementptr double, double* %v1, i64 2000
  %scevgep8 = getelementptr double, double* %v2, i64 2000
  br label %for.inc.us.prol.loopexit.for.inc.us_crit_edge

for.inc.us.prol.loopexit.for.inc.us_crit_edge:    ; preds = %for.cond1.for.inc20_crit_edge.us, %entry.for.cond1.preheader.us_crit_edge
  %indvars.iv82 = phi i64 [ 0, %entry.for.cond1.preheader.us_crit_edge ], [ %indvars.iv.next83, %for.cond1.for.inc20_crit_edge.us ]
  %scevgep = getelementptr [2000 x double], [2000 x double]* %A, i64 %indvars.iv82, i64 0
  %scevgep1 = bitcast double* %scevgep to i8*
  %0 = add i64 %indvars.iv82, 1
  %scevgep2 = getelementptr [2000 x double], [2000 x double]* %A, i64 %0, i64 0
  %scevgep23 = bitcast double* %scevgep2 to i8*
  %sunkaddr104 = shl i64 %indvars.iv82, 3
  %sunkaddr105 = add i64 %sunkaddr103, %sunkaddr104
  %sunkaddr106 = inttoptr i64 %sunkaddr105 to double*
  %sunkaddr109 = add i64 %sunkaddr107, %sunkaddr104
  %sunkaddr110 = inttoptr i64 %sunkaddr109 to double*
  %bc = inttoptr i64 %sunkaddr105 to i8*
  %bc10 = inttoptr i64 %sunkaddr105 to i8*
  %bound0 = icmp ult i8* %scevgep1, %bc10
  ...
  %bc14 = inttoptr i64 %sunkaddr109 to i8*
  %bc15 = inttoptr i64 %sunkaddr109 to i8*
  %bound016 = icmp ult i8* %scevgep1, %bc15
...
vector.body.preheader:                            ; preds = %for.inc.us.prol.loopexit.for.inc.us_crit_edge
  %1 = load double, double* %sunkaddr106, align 8, !alias.scope !1
  %2 = insertelement <2 x double> undef, double %1, i32 0
  %3 = shufflevector <2 x double> %2, <2 x double> undef, <2 x i32> zeroinitializer
  %4 = load double, double* %sunkaddr110, align 8, !alias.scope !4
  %5 = insertelement <2 x double> undef, double %4, i32 0
  %6 = shufflevector <2 x double> %5, <2 x double> undef, <2 x i32> zeroinitializer
  %7 = load double, double* %sunkaddr106, align 8, !alias.scope !1
  %8 = insertelement <2 x double> undef, double %7, i32 0
  %9 = shufflevector <2 x double> %8, <2 x double> undef, <2 x i32> zeroinitializer
  %10 = load double, double* %sunkaddr110, align 8, !alias.scope !4
...
for.inc.us.preheader:                             ; preds = %for.inc.us.prol.loopexit.for.inc.us_crit_edge
  br label %for.inc.us

vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  %index = phi i64 [ %index.next, %vector.body ], [ 0, %vector.body.preheader ]
  %offset.idx = shl i64 %index, 1
  %13 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv82, i64 %offset.idx
  ...
  %wide.vec25 = load <4 x double>, <4 x double>* %16, align 8, !alias.scope !11
  ...
  %17 = fmul <2 x double> %3, %strided.vec26
  %18 = fadd <2 x double> %strided.vec, %17
  %19 = getelementptr inbounds double, double* %v2, i64 %offset.idx
  %20 = bitcast double* %19 to <4 x double>*
  %wide.vec28 = load <4 x double>, <4 x double>* %20, align 8, !alias.scope !12
  ...
  %21 = fmul <2 x double> %6, %strided.vec29
  %22 = fadd <2 x double> %18, %21
  %23 = or i64 %offset.idx, 1
  %24 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv82, i64 %23
  %25 = fmul <2 x double> %9, %strided.vec27
  %26 = fadd <2 x double> %strided.vec24, %25
  %27 = fmul <2 x double> %12, %strided.vec30
...
for.inc.us:                                       ; preds = %for.inc.us.preheader, %for.inc.us
  %indvars.iv78 = phi i64 [ %indvars.iv.next79.1, %for.inc.us ], [ 0, %for.inc.us.preheader ]
  %arrayidx5.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv82, i64 %indvars.iv78
  %32 = load double, double* %arrayidx5.us, align 8
  %33 = load double, double* %sunkaddr106, align 8
  %arrayidx9.us = getelementptr inbounds double, double* %v1, i64 %indvars.iv78
  %34 = load double, double* %arrayidx9.us, align 8
  %mul.us = fmul double %33, %34
  %add.us = fadd double %32, %mul.us
  %35 = load double, double* %sunkaddr110, align 8
  %arrayidx13.us = getelementptr inbounds double, double* %v2, i64 %indvars.iv78
  ...
  %arrayidx5.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv82, i64 %indvars.iv.next79
  %37 = load double, double* %arrayidx5.us.1, align 8
  %38 = load double, double* %sunkaddr106, align 8
  %arrayidx9.us.1 = getelementptr inbounds double, double* %v1, i64 %indvars.iv.next79
  %39 = load double, double* %arrayidx9.us.1, align 8
  %mul.us.1 = fmul double %38, %39
  %add.us.1 = fadd double %37, %mul.us.1
  %40 = load double, double* %sunkaddr110, align 8
  %arrayidx13.us.1 = getelementptr inbounds double, double* %v2, i64 %indvars.iv.next79
  ...
  %exitcond81.1 = icmp eq i64 %indvars.iv.next79.1, 2000
  br i1 %exitcond81.1, label %for.cond1.for.inc20_crit_edge.us.loopexit, label %for.inc.us, !llvm.loop !16
...
for.cond1.for.inc20_crit_edge.us:                 ; preds = %for.cond1.for.inc20_crit_edge.us.loopexit68, %for.cond1.for.inc20_crit_edge.us.loopexit
  ...
  br i1 %exitcond85, label %for.cond23.preheader.for.cond26.preheader.us_crit_edge, label %for.inc.us.prol.loopexit.for.inc.us_crit_edge

for.cond23.preheader.for.cond26.preheader.us_crit_edge: ; preds = %for.cond1.for.inc20_crit_edge.us
  %sunkaddr115 = ptrtoint double* %x to i64
  br label %for.inc42.us.prol.loopexit.for.inc42.us_crit_edge

for.inc42.us.prol.loopexit.for.inc42.us_crit_edge: ; preds = %for.cond26.for.inc45_crit_edge.us, %for.cond23.preheader.for.cond26.preheader.us_crit_edge
  %indvars.iv74 = phi i64 [ 0, %for.cond23.preheader.for.cond26.preheader.us_crit_edge ], [ %indvars.iv.next75, %for.cond26.for.inc45_crit_edge.us ]
  %sunkaddr116 = shl i64 %indvars.iv74, 3
  %sunkaddr117 = add i64 %sunkaddr115, %sunkaddr116
  %sunkaddr118 = inttoptr i64 %sunkaddr117 to double*
  %.pre = load double, double* %sunkaddr118, align 8
  br label %for.inc42.us

for.inc42.us:                                     ; preds = %for.inc42.us, %for.inc42.us.prol.loopexit.for.inc42.us_crit_edge
  %42 = phi double [ %.pre, %for.inc42.us.prol.loopexit.for.inc42.us_crit_edge ], [ %add39.us.1, %for.inc42.us ]
  %indvars.iv70 = phi i64 [ 0, %for.inc42.us.prol.loopexit.for.inc42.us_crit_edge ], [ %indvars.iv.next71.1, %for.inc42.us ]
  %arrayidx34.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv70, i64 %indvars.iv74
  %43 = load double, double* %arrayidx34.us, align 8
  %mul35.us = fmul double %43, %beta
  %arrayidx37.us = getelementptr inbounds double, double* %y, i64 %indvars.iv70
  %44 = load double, double* %arrayidx37.us, align 8
  %mul38.us = fmul double %mul35.us, %44
  %add39.us = fadd double %42, %mul38.us
  store double %add39.us, double* %sunkaddr118, align 8
  %indvars.iv.next71 = or i64 %indvars.iv70, 1
  %arrayidx34.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv.next71, i64 %indvars.iv74
  %45 = load double, double* %arrayidx34.us.1, align 8
  %mul35.us.1 = fmul double %45, %beta
  %arrayidx37.us.1 = getelementptr inbounds double, double* %y, i64 %indvars.iv.next71
  ...
  store double %add39.us.1, double* %sunkaddr118, align 8
  %indvars.iv.next71.1 = add nuw nsw i64 %indvars.iv70, 2
  %exitcond73.1 = icmp eq i64 %indvars.iv.next71.1, 2000
  br i1 %exitcond73.1, label %for.cond26.for.inc45_crit_edge.us, label %for.inc42.us

for.cond26.for.inc45_crit_edge.us:                ; preds = %for.inc42.us
  %indvars.iv.next75 = add nuw nsw i64 %indvars.iv74, 1
  %exitcond77 = icmp eq i64 %indvars.iv.next75, 2000
  br i1 %exitcond77, label %vector.memcheck46, label %for.inc42.us.prol.loopexit.for.inc42.us_crit_edge
...
vector.body31:                                    ; preds = %vector.body31.preheader, %vector.body31
  ...
  br i1 %65, label %for.cond61.preheader.for.cond64.preheader.us_crit_edge.loopexit67, label %vector.body31, !llvm.loop !22

for.cond61.preheader.for.cond64.preheader.us_crit_edge.loopexit: ; preds = %for.inc58
  br label %for.cond61.preheader.for.cond64.preheader.us_crit_edge

for.cond61.preheader.for.cond64.preheader.us_crit_edge.loopexit67: ; preds = %vector.body31
  br label %for.cond61.preheader.for.cond64.preheader.us_crit_edge

for.cond61.preheader.for.cond64.preheader.us_crit_edge: ; preds = %for.cond61.preheader.for.cond64.preheader.us_crit_edge.loopexit67, %for.cond61.preheader.for.cond64.preheader.us_crit_edge.loopexit
  %sunkaddr127 = ptrtoint double* %w to i64
  br label %for.inc80.us.prol.loopexit.for.inc80.us_crit_edge

for.inc80.us.prol.loopexit.for.inc80.us_crit_edge: ; preds = %for.cond64.for.inc83_crit_edge.us, %for.cond61.preheader.for.cond64.preheader.us_crit_edge
  %indvars.iv62 = phi i64 [ 0, %for.cond61.preheader.for.cond64.preheader.us_crit_edge ], [ %indvars.iv.next63, %for.cond64.for.inc83_crit_edge.us ]
  %sunkaddr128 = shl i64 %indvars.iv62, 3
  %sunkaddr129 = add i64 %sunkaddr127, %sunkaddr128
  %sunkaddr130 = inttoptr i64 %sunkaddr129 to double*
  %.pre95 = load double, double* %sunkaddr130, align 8
  br label %for.inc80.us

for.inc80.us:                                     ; preds = %for.inc80.us, %for.inc80.us.prol.loopexit.for.inc80.us_crit_edge
  %66 = phi double [ %.pre95, %for.inc80.us.prol.loopexit.for.inc80.us_crit_edge ], [ %add77.us.1, %for.inc80.us ]
  %indvars.iv = phi i64 [ 0, %for.inc80.us.prol.loopexit.for.inc80.us_crit_edge ], [ %indvars.iv.next.1, %for.inc80.us ]
  ...
  store double %add77.us, double* %sunkaddr130, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %add77.us.1, double* %sunkaddr130, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
...
for.cond64.for.inc83_crit_edge.us:                ; preds = %for.inc80.us
  ...
  br i1 %exitcond65, label %for.end85, label %for.inc80.us.prol.loopexit.for.inc80.us_crit_edge

for.inc58:                                        ; preds = %for.inc58.preheader, %for.inc58
  %indvars.iv66 = phi i64 [ %indvars.iv.next67.3, %for.inc58 ], [ 0, %for.inc58.preheader ]
  %arrayidx52 = getelementptr inbounds double, double* %x, i64 %indvars.iv66
  %71 = load double, double* %arrayidx52, align 8
  %arrayidx54 = getelementptr inbounds double, double* %z, i64 %indvars.iv66
  ...
  %arrayidx52.1 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next67
  %73 = load double, double* %arrayidx52.1, align 8
  %arrayidx54.1 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next67
  ...
  %arrayidx52.2 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next67.1
  %75 = load double, double* %arrayidx52.2, align 8
  %arrayidx54.2 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next67.1
  ...
  %arrayidx52.3 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next67.2
  %77 = load double, double* %arrayidx52.3, align 8
  %arrayidx54.3 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next67.2
  ...
  %exitcond69.3 = icmp eq i64 %indvars.iv.next67.3, 2000
  br i1 %exitcond69.3, label %for.cond61.preheader.for.cond64.preheader.us_crit_edge.loopexit, label %for.inc58, !llvm.loop !23
