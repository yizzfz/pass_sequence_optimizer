...
.preheader.us.new:                                ; preds = %.preheader.us.new.preheader, %.preheader.us.new
  ...
  %exitcond.1 = icmp eq i64 %12, %wide.trip.count7
...
.preheader3:                                      ; preds = %._crit_edge6, %.preheader3.lr.ph
  %.027 = phi i32 [ 0, %.preheader3.lr.ph ], [ %32, %._crit_edge6 ]
...
.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge
  ...
  %.phi.trans.insert14 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %8, i64 1
  %.pre15 = load double, double* %.phi.trans.insert14, align 8
  %.phi.trans.insert16 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv9, i64 0
  %.pre17 = load double, double* %.phi.trans.insert16, align 8
  %.phi.trans.insert18 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv9, i64 1
  %.pre19 = load double, double* %.phi.trans.insert18, align 8
  %.phi.trans.insert20 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next10, i64 0
  %.pre21 = load double, double* %.phi.trans.insert20, align 8
  %.phi.trans.insert22 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next10, i64 1
  %.pre23 = load double, double* %.phi.trans.insert22, align 8
  br label %9

; <label>:9:                                      ; preds = %9, %.preheader
  %10 = phi double [ %29, %9 ], [ %.pre23, %.preheader ]
  %11 = phi double [ %10, %9 ], [ %.pre21, %.preheader ]
  %12 = phi double [ %24, %9 ], [ %.pre19, %.preheader ]
  %13 = phi double [ %31, %9 ], [ %.pre17, %.preheader ]
  %14 = phi double [ %18, %9 ], [ %.pre15, %.preheader ]
  %15 = phi double [ %14, %9 ], [ %.pre, %.preheader ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %9 ], [ 1, %.preheader ]
  %16 = fadd double %15, %14
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %17 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %8, i64 %indvars.iv.next
  %18 = load double, double* %17, align 8
  %19 = fadd double %16, %18
  %20 = fadd double %19, %13
  %21 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv9, i64 %indvars.iv
  %22 = fadd double %20, %12
  ...
  %28 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next10, i64 %indvars.iv.next
...
._crit_edge6:                                     ; preds = %._crit_edge6.loopexit, %.preheader3
  %32 = add nuw nsw i32 %.027, 1
  %exitcond13 = icmp eq i32 %32, %0
