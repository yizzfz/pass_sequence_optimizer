...
; <label>:7:                                      ; preds = %0
  ...
  %11 = call i64 @read(i32 0, i8* bitcast ([1000 x i16]* @sbuf to i8*), i64 2000) #4
...
; <label>:20:                                     ; preds = %20, %.lr.ph
  ...
  call void @adpcm_coder(i16* getelementptr inbounds ([1000 x i16], [1000 x i16]* @sbuf, i64 0, i64 0), i8* getelementptr inbounds ([500 x i8], [500 x i8]* @abuf, i64 0, i64 0), i32 %19, %struct.adpcm_state* nonnull @state) #4
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader
  ...
  %26 = call i64 @write(i32 1, i8* getelementptr inbounds ([500 x i8], [500 x i8]* @abuf, i64 0, i64 0), i64 %25) #4
  %27 = load i32, i32* bitcast (%struct.adpcm_state* @state to i32*), align 2
  %28 = call i64 @read(i32 0, i8* bitcast ([1000 x i16]* @sbuf to i8*), i64 2000) #4
...
declare void @adpcm_coder(i16*, i8*, i32, %struct.adpcm_state*) local_unnamed_addr #3
