...
.lr.ph38.split.us.preheader:
  %sunkaddr118 = ptrtoint double* %3 to i64
  %sunkaddr = ptrtoint double* %3 to i64
  br label %.lr.ph38.split.us

.lr.ph38.split.us:                                ; preds = %._crit_edge34.us, %.lr.ph38.split.us.preheader
  %indvars.iv84 = phi i64 [ 0, %.lr.ph38.split.us.preheader ], [ %indvars.iv.next85, %._crit_edge34.us ]
  %4 = getelementptr inbounds double, double* %3, i64 %indvars.iv84
  store double 0.000000e+00, double* %4, align 8
  %sunkaddr119 = shl i64 %indvars.iv84, 3
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph38.split.us
  %indvars.iv80 = phi i64 [ 0, %.lr.ph38.split.us ], [ %indvars.iv.next81.4, %._crit_edge ]
  %5 = phi double [ 0.000000e+00, %.lr.ph38.split.us ], [ %20, %._crit_edge ]
  %6 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv80, i64 %indvars.iv84
  %7 = load double, double* %6, align 8
  %8 = fadd double %5, %7
  store double %8, double* %sunkaddr121, align 8
  %indvars.iv.next81 = add nuw nsw i64 %indvars.iv80, 1
  %9 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next81, i64 %indvars.iv84
  %10 = load double, double* %9, align 8
  %11 = fadd double %8, %10
  store double %11, double* %sunkaddr121, align 8
  %indvars.iv.next81.1 = add nuw nsw i64 %indvars.iv80, 2
  %12 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next81.1, i64 %indvars.iv84
  %13 = load double, double* %12, align 8
  %14 = fadd double %11, %13
  store double %14, double* %sunkaddr121, align 8
  %indvars.iv.next81.2 = add nuw nsw i64 %indvars.iv80, 3
  %15 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next81.2, i64 %indvars.iv84
  %16 = load double, double* %15, align 8
  %17 = fadd double %14, %16
  store double %17, double* %sunkaddr121, align 8
  %indvars.iv.next81.3 = add nuw nsw i64 %indvars.iv80, 4
  %18 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next81.3, i64 %indvars.iv84
  %19 = load double, double* %18, align 8
  %20 = fadd double %17, %19
  store double %20, double* %sunkaddr121, align 8
  %indvars.iv.next81.4 = add nuw nsw i64 %indvars.iv80, 5
  %exitcond98.4 = icmp eq i64 %indvars.iv.next81.4, 1400
  br i1 %exitcond98.4, label %._crit_edge34.us, label %._crit_edge

._crit_edge34.us:                                 ; preds = %._crit_edge
  %21 = fdiv double %20, %0
  %sunkaddr26 = shl i64 %indvars.iv84, 3
  %sunkaddr27 = add i64 %sunkaddr, %sunkaddr26
  %sunkaddr28 = inttoptr i64 %sunkaddr27 to double*
  store double %21, double* %sunkaddr28, align 8
  %indvars.iv.next85 = add nuw nsw i64 %indvars.iv84, 1
  %exitcond99 = icmp eq i64 %indvars.iv.next85, 1200
  br i1 %exitcond99, label %._crit_edge34.us..lr.ph29.split.us_crit_edge, label %.lr.ph38.split.us

._crit_edge34.us..lr.ph29.split.us_crit_edge:     ; preds = %._crit_edge34.us
  %scevgep13 = getelementptr double, double* %3, i64 1200
  br label %vector.memcheck

vector.memcheck:                                  ; preds = %._crit_edge26.us, %._crit_edge34.us..lr.ph29.split.us_crit_edge
  %indvars.iv75 = phi i64 [ 0, %._crit_edge34.us..lr.ph29.split.us_crit_edge ], [ %22, %._crit_edge26.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv75, i64 0
  %22 = add nuw nsw i64 %indvars.iv75, 1
  %scevgep11 = getelementptr [1200 x double], [1200 x double]* %1, i64 %22, i64 0
  %bound0 = icmp ult double* %scevgep, %scevgep13
  %bound1 = icmp ugt double* %scevgep11, %3
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %vector.memcheck.scalar.ph_crit_edge, label %vector.memcheck.vector.body_crit_edge
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck.vector.body_crit_edge
  ...
  %25 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv75, i64 %offset.idx
  %26 = bitcast double* %25 to <8 x double>*
  %wide.vec18 = load <8 x double>, <8 x double>* %26, align 8, !alias.scope !4, !noalias !1
  %27 = fsub <8 x double> %wide.vec18, %wide.vec
  ...
  %32 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv75, i64 %31
  ...
  br i1 %38, label %._crit_edge26.us.loopexit29, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph, %vector.memcheck.scalar.ph_crit_edge
  %indvars.iv71 = phi i64 [ 0, %vector.memcheck.scalar.ph_crit_edge ], [ %indvars.iv.next72.3, %scalar.ph ]
  %39 = getelementptr inbounds double, double* %3, i64 %indvars.iv71
  %40 = load double, double* %39, align 8
  %41 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv75, i64 %indvars.iv71
  %42 = load double, double* %41, align 8
  %43 = fsub double %42, %40
  store double %43, double* %41, align 8
  %indvars.iv.next72 = or i64 %indvars.iv71, 1
  %44 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next72
  %45 = load double, double* %44, align 8
  %46 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv75, i64 %indvars.iv.next72
  %47 = load double, double* %46, align 8
  %48 = fsub double %47, %45
  store double %48, double* %46, align 8
  %indvars.iv.next72.1 = or i64 %indvars.iv71, 2
  %49 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next72.1
  %50 = load double, double* %49, align 8
  %51 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv75, i64 %indvars.iv.next72.1
  %52 = load double, double* %51, align 8
  %53 = fsub double %52, %50
  store double %53, double* %51, align 8
  %indvars.iv.next72.2 = or i64 %indvars.iv71, 3
  %54 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next72.2
  %55 = load double, double* %54, align 8
  %56 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv75, i64 %indvars.iv.next72.2
  %57 = load double, double* %56, align 8
  %58 = fsub double %57, %55
  store double %58, double* %56, align 8
  %indvars.iv.next72.3 = add nuw nsw i64 %indvars.iv71, 4
  %exitcond96.3 = icmp eq i64 %indvars.iv.next72.3, 1200
  br i1 %exitcond96.3, label %._crit_edge26.us.loopexit, label %scalar.ph, !llvm.loop !9

._crit_edge26.us.loopexit:                        ; preds = %scalar.ph
  br label %._crit_edge26.us

._crit_edge26.us.loopexit29:                      ; preds = %vector.body
  br label %._crit_edge26.us

._crit_edge26.us:                                 ; preds = %._crit_edge26.us.loopexit29, %._crit_edge26.us.loopexit
  %exitcond97 = icmp eq i64 %22, 1400
  br i1 %exitcond97, label %.lr.ph21.split.us.preheader, label %vector.memcheck
...
._crit_edge18.us-lcssa.us.us:                     ; preds = %._crit_edge.us.us
  ...
  %exitcond102 = icmp eq i64 %indvars.iv.next58, 1200
  br i1 %exitcond102, label %._crit_edge22, label %.lr.ph17.us

.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph17.us
  %indvars.iv53 = phi i64 [ %indvars.iv57, %.lr.ph17.us ], [ %indvars.iv.next54, %._crit_edge.us.us ]
  %60 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv57, i64 %indvars.iv53
...
._crit_edge.us.us:                                ; preds = %._crit_edge24
  ...
  %62 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv53, i64 %indvars.iv57
  store double %61, double* %62, align 8
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %exitcond = icmp eq i64 %indvars.iv.next54, 1200
  br i1 %exitcond, label %._crit_edge18.us-lcssa.us.us, label %.lr.ph.us.us

._crit_edge24:                                    ; preds = %._crit_edge24, %.lr.ph.us.us
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %._crit_edge24 ]
  %63 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %75, %._crit_edge24 ]
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv57
  %65 = load double, double* %64, align 8
  %66 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv53
  %67 = load double, double* %66, align 8
  %68 = fmul double %65, %67
  %69 = fadd double %63, %68
  store double %69, double* %60, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %70 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv57
  %71 = load double, double* %70, align 8
  %72 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv53
  %73 = load double, double* %72, align 8
  %74 = fmul double %71, %73
  %75 = fadd double %69, %74
  store double %75, double* %60, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond94.1 = icmp eq i64 %indvars.iv.next.1, 1400
  br i1 %exitcond94.1, label %._crit_edge.us.us, label %._crit_edge24
