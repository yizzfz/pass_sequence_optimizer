...
.lr.ph:                                           ; preds = %._crit_edge..lr.ph_crit_edge, %.lr.ph21
  %indvars.iv27 = phi i64 [ 0, %.lr.ph21 ], [ %indvars.iv.next28, %._crit_edge..lr.ph_crit_edge ]
  %indvars.iv25 = phi i64 [ 1, %.lr.ph21 ], [ %indvars.iv.next26, %._crit_edge..lr.ph_crit_edge ]
  %indvars.iv.next28 = add nuw nsw i64 %indvars.iv27, 1
  %4 = getelementptr inbounds double, double* %2, i64 %indvars.iv27
  store double -9.990000e+02, double* %4, align 8
  %5 = trunc i64 %indvars.iv27 to i32
  %6 = sitofp i32 %5 to double
  %7 = getelementptr inbounds double, double* %3, i64 %indvars.iv27
  store double %6, double* %7, align 8
  %8 = add i32 %5, 2001
  %xtraiter30 = and i64 %indvars.iv.next28, 1
  %lcmp.mod = icmp eq i64 %xtraiter30, 0
...
.prol.preheader:                                  ; preds = %.lr.ph
  ...
  %12 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv27, i64 0
...
.lr.ph.new:                                       ; preds = %.lr.ph.new..lr.ph.new_crit_edge, %.lr.ph.new.preheader
  ...
  %17 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv27, i64 %indvars.iv
...
._crit_edge:                                      ; preds = %.prol.loopexit.._crit_edge_crit_edge, %._crit_edge.loopexit
  ...
  br i1 %exitcond, label %._crit_edge22, label %._crit_edge..lr.ph_crit_edge
...
.lr.ph34:
  ...
  %sunkaddr54 = ptrtoint double* %2 to i64
  %sunkaddr = ptrtoint double* %2 to i64
  br label %5

; <label>:5:                                      ; preds = %._crit_edge._crit_edge, %.lr.ph34
  %indvars.iv42 = phi i64 [ 0, %.lr.ph34 ], [ %indvars.iv.next43, %._crit_edge._crit_edge ]
  %6 = add i64 %indvars.iv42, 4294967295
  ...
  %sunkaddr25 = add i64 %4, %sunkaddr24
...
.prol.preheader:                                  ; preds = %.lr.ph
  ...
  %15 = fsub double %8, %14
  %sunkaddr51 = shl i64 %indvars.iv42, 3
  %sunkaddr52 = add i64 %sunkaddr, %sunkaddr51
  %sunkaddr53 = inttoptr i64 %sunkaddr52 to double*
  store double %15, double* %sunkaddr53, align 8
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.lr.ph..prol.loopexit_crit_edge, %.prol.preheader
  %indvars.iv.unr.ph = phi i64 [ 1, %.prol.preheader ], [ 0, %.lr.ph..prol.loopexit_crit_edge ]
  %.unr.ph = phi double [ %15, %.prol.preheader ], [ %8, %.lr.ph..prol.loopexit_crit_edge ]
  %.lcssa37.unr.ph = phi double [ %15, %.prol.preheader ], [ undef, %.lr.ph..prol.loopexit_crit_edge ]
...
.lr.ph.new.preheader:                             ; preds = %.prol.loopexit
  %sunkaddr55 = shl i64 %indvars.iv42, 3
...
.lr.ph.new:                                       ; preds = %.lr.ph.new..lr.ph.new_crit_edge, %.lr.ph.new.preheader
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.lr.ph.new..lr.ph.new_crit_edge ], [ %indvars.iv.unr.ph, %.lr.ph.new.preheader ]
  %18 = phi double [ %30, %.lr.ph.new..lr.ph.new_crit_edge ], [ %.unr.ph, %.lr.ph.new.preheader ]
  ...
  store double %24, double* %sunkaddr57, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  ...
  store double %30, double* %sunkaddr57, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
...
._crit_edge:                                      ; preds = %.prol.loopexit.._crit_edge_crit_edge, %.._crit_edge_crit_edge, %._crit_edge.loopexit
  %.lcssa = phi double [ %.lcssa37.unr.ph, %.prol.loopexit.._crit_edge_crit_edge ], [ %8, %.._crit_edge_crit_edge ], [ %30, %._crit_edge.loopexit ]
  %sunkaddr30.pre-phi = inttoptr i64 %sunkaddr25 to double*
  %31 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv42, i64 %indvars.iv42
  %32 = load double, double* %31, align 8
  %33 = fdiv double %.lcssa, %32
  store double %33, double* %sunkaddr30.pre-phi, align 8
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1
  %exitcond = icmp eq i64 %indvars.iv.next43, 2000
  br i1 %exitcond, label %._crit_edge35, label %._crit_edge._crit_edge
...
.lr.ph:                                           ; preds = %..lr.ph_crit_edge, %.lr.ph.preheader
  ...
  %7 = phi %struct._IO_FILE* [ %17, %..lr.ph_crit_edge ], [ %6, %.lr.ph.preheader ]
