...
.lr.ph:                                           ; preds = %._crit_edge..lr.ph_crit_edge, %.lr.ph20
  %indvars.iv26 = phi i64 [ 0, %.lr.ph20 ], [ %indvars.iv.next27, %._crit_edge..lr.ph_crit_edge ]
  %indvars.iv24 = phi i64 [ 1, %.lr.ph20 ], [ %indvars.iv.next25, %._crit_edge..lr.ph_crit_edge ]
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit
  ...
  br i1 %exitcond, label %._crit_edge21, label %._crit_edge..lr.ph_crit_edge
...
._crit_edge._crit_edge:                           ; preds = %._crit_edge, %.lr.ph34
  ...
  %4 = add nuw i64 %indvars.iv40, 4294967295
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv40
  %6 = bitcast double* %5 to i64*
  %7 = load i64, i64* %6, align 8
  %8 = getelementptr inbounds double, double* %2, i64 %indvars.iv40
  %9 = bitcast double* %8 to i64*
  store i64 %7, i64* %9, align 8
  %10 = icmp sgt i64 %indvars.iv40, 0
...
.lr.ph:                                           ; preds = %._crit_edge._crit_edge
  ...
  %xtraiter43 = and i64 %indvars.iv40, 1
  %lcmp.mod = icmp eq i64 %xtraiter43, 0
  br i1 %lcmp.mod, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.lr.ph
  %11 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv40, i64 0
  %12 = load double, double* %11, align 8
  %13 = load double, double* %2, align 8
  %14 = fmul double %12, %13
  %15 = load double, double* %sunkaddr26, align 8
  %16 = fsub double %15, %14
  store double %16, double* %sunkaddr26, align 8
  br label %.prol.loopexit
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.lr.ph.new ], [ %indvars.iv.unr.ph, %.lr.ph.new.preheader ]
  %19 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv40, i64 %indvars.iv
  %20 = load double, double* %19, align 8
  %21 = getelementptr inbounds double, double* %2, i64 %indvars.iv
  %22 = load double, double* %21, align 8
  %23 = fmul double %20, %22
  %24 = load double, double* %sunkaddr26, align 8
  %25 = fsub double %24, %23
  store double %25, double* %sunkaddr26, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %26 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv40, i64 %indvars.iv.next
  ...
  store double %32, double* %sunkaddr26, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %._crit_edge._crit_edge
  ...
  %33 = load double, double* %sunkaddr30, align 8
  %34 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv40, i64 %indvars.iv40
  %35 = load double, double* %34, align 8
  %36 = fdiv double %33, %35
  store double %36, double* %sunkaddr30, align 8
