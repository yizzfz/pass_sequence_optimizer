...
for.body8.lr.ph:                                  ; preds = %entry, %for.end44
  ...
  %indvars.iv21 = phi i64 [ 1, %entry ], [ %indvars.iv.next22, %for.end44 ]
...
for.body8:                                        ; preds = %for.body8.preheader, %for.body8
  ...
  %19 = bitcast double* %arrayidx13 to <2 x double>*
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %20 = sub nsw i64 %12, %indvars.iv.next
  %arrayidx11.1 = getelementptr inbounds double, double* %r, i64 %20
  %21 = bitcast double* %arrayidx11.1 to <2 x double>*
  %22 = load <2 x double>, <2 x double>* %21, align 8
  %23 = load <2 x double>, <2 x double>* %19, align 8
  %mul14.v.i0 = shufflevector <2 x double> %22, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %mul14 = fmul <2 x double> %mul14.v.i0, %23
  %mul14.v.r1 = extractelement <2 x double> %mul14, i32 0
  %mul14.v.r2 = extractelement <2 x double> %mul14, i32 1
  %add = fadd double %18, %mul14.v.r1
  %add.1 = fadd double %add, %mul14.v.r2
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %arrayidx13.2 = getelementptr inbounds double, double* %y, i64 %indvars.iv.next.1
  %24 = bitcast double* %arrayidx13.2 to <2 x double>*
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %25 = sub nsw i64 %12, %indvars.iv.next.2
  %arrayidx11.3 = getelementptr inbounds double, double* %r, i64 %25
  %26 = bitcast double* %arrayidx11.3 to <2 x double>*
  %27 = load <2 x double>, <2 x double>* %26, align 8
  %28 = load <2 x double>, <2 x double>* %24, align 8
  %mul14.2.v.i0 = shufflevector <2 x double> %27, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %mul14.2 = fmul <2 x double> %mul14.2.v.i0, %28
  ...
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %exitcond.3 = icmp eq i64 %indvars.iv.next.3, %indvars.iv21
...
for.body21.lr.ph:                                 ; preds = %for.body21.lr.ph.loopexit, %for.body8.prol.loopexit
  ...
  %add17 = fadd double %.lcssa, %29
  %sub18 = fsub double -0.000000e+00, %add17
  %div = fdiv double %sub18, %mul5
  %30 = add nsw i64 %indvars.iv21, -1
  %31 = and i64 %indvar, 1
  %lcmp.mod29 = icmp eq i64 %31, 0
...
for.body21.prol.loopexit:                         ; preds = %for.body21.prol, %for.body21.lr.ph
  ...
  %34 = icmp eq i64 %indvar, 0
  br i1 %34, label %for.end44, label %for.body21.preheader

for.body21.preheader:                             ; preds = %for.body21.prol.loopexit
  %35 = insertelement <2 x double> undef, double %div, i32 0
  %mul28.v.i0.2 = shufflevector <2 x double> %35, <2 x double> undef, <2 x i32> zeroinitializer
  %36 = sub i64 %8, %indvars.iv8.unr.ph
  %37 = lshr i64 %36, 1
  %38 = and i64 %37, 1
  %lcmp.mod3 = icmp eq i64 %38, 0
...
for.body21.prol4:                                 ; preds = %for.body21.prol.preheader
  %arrayidx23.prol = getelementptr inbounds double, double* %y, i64 %indvars.iv8.unr.ph
  %39 = bitcast double* %arrayidx23.prol to <2 x double>*
  %arrayidx31.prol = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %indvars.iv8.unr.ph
  %indvars.iv.next9.prol = add nuw nsw i64 %indvars.iv8.unr.ph, 1
  %40 = load <2 x double>, <2 x double>* %39, align 8
  %41 = sub nsw i64 %30, %indvars.iv.next9.prol
  %arrayidx27.1.prol = getelementptr inbounds double, double* %y, i64 %41
  %42 = bitcast double* %arrayidx27.1.prol to <2 x double>*
  %43 = load <2 x double>, <2 x double>* %42, align 8
  %mul28.1.prol = fmul <2 x double> %mul28.v.i0.2, %43
  %add29.v.i1.prol = shufflevector <2 x double> %mul28.1.prol, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %add29.prol5 = fadd <2 x double> %40, %add29.v.i1.prol
  %44 = bitcast double* %arrayidx31.prol to <2 x double>*
  store <2 x double> %add29.prol5, <2 x double>* %44, align 8
  %indvars.iv.next9.1.prol = or i64 %indvars.iv8.unr.ph, 2
...
for.body21.prol.loopexit1.unr-lcssa:              ; preds = %for.body21.preheader, %for.body21.prol4
  %indvars.iv8.unr.ph6 = phi i64 [ %indvars.iv.next9.1.prol, %for.body21.prol4 ], [ %indvars.iv8.unr.ph, %for.body21.preheader ]
  br label %for.body21.prol.loopexit1

for.body21.prol.loopexit1:                        ; preds = %for.body21.prol.loopexit1.unr-lcssa
  %45 = icmp eq i64 %37, 0
  br i1 %45, label %for.end44.loopexit, label %for.body21.preheader.new

for.body21.preheader.new:                         ; preds = %for.body21.prol.loopexit1
  br label %for.body21

for.body21:                                       ; preds = %for.body21, %for.body21.preheader.new
  %indvars.iv8 = phi i64 [ %indvars.iv8.unr.ph6, %for.body21.preheader.new ], [ %indvars.iv.next9.1.1, %for.body21 ]
  %arrayidx23 = getelementptr inbounds double, double* %y, i64 %indvars.iv8
  %46 = bitcast double* %arrayidx23 to <2 x double>*
  ...
  %48 = sub nsw i64 %30, %indvars.iv.next9
  %arrayidx27.1 = getelementptr inbounds double, double* %y, i64 %48
  %49 = bitcast double* %arrayidx27.1 to <2 x double>*
  %50 = load <2 x double>, <2 x double>* %49, align 8
  %mul28.1 = fmul <2 x double> %mul28.v.i0.2, %50
  %add29.v.i1 = shufflevector <2 x double> %mul28.1, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %add29 = fadd <2 x double> %47, %add29.v.i1
  %51 = bitcast double* %arrayidx31 to <2 x double>*
  store <2 x double> %add29, <2 x double>* %51, align 8
  %indvars.iv.next9.1 = add nsw i64 %indvars.iv8, 2
  %arrayidx23.1 = getelementptr inbounds double, double* %y, i64 %indvars.iv.next9.1
  %52 = bitcast double* %arrayidx23.1 to <2 x double>*
  %arrayidx31.1 = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %indvars.iv.next9.1
  %indvars.iv.next9.17 = add nsw i64 %indvars.iv8, 3
  %53 = load <2 x double>, <2 x double>* %52, align 8
  %54 = sub nsw i64 %30, %indvars.iv.next9.17
  %arrayidx27.1.1 = getelementptr inbounds double, double* %y, i64 %54
  %55 = bitcast double* %arrayidx27.1.1 to <2 x double>*
  %56 = load <2 x double>, <2 x double>* %55, align 8
  %mul28.1.1 = fmul <2 x double> %mul28.v.i0.2, %56
  %add29.v.i1.1 = shufflevector <2 x double> %mul28.1.1, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %add29.1 = fadd <2 x double> %53, %add29.v.i1.1
  %57 = bitcast double* %arrayidx31.1 to <2 x double>*
  store <2 x double> %add29.1, <2 x double>* %57, align 8
  %indvars.iv.next9.1.1 = add nsw i64 %indvars.iv8, 4
  %exitcond14.1.1 = icmp eq i64 %indvars.iv.next9.1.1, %indvars.iv21
  br i1 %exitcond14.1.1, label %for.end44.loopexit.unr-lcssa, label %for.body21
...
for.end44:                                        ; preds = %for.end44.loopexit, %for.body21.prol.loopexit
  ...
  %exitcond25 = icmp eq i64 %indvars.iv.next22, 2000
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond25, label %for.end49, label %for.body8.lr.ph
