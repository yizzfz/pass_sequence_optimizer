...
define internal fastcc void @init_array(i32, double* nocapture, double* nocapture, [1300 x double]*, [1300 x double]*, double*) unnamed_addr #2 {
  ...
  br i1 %13, label %.lr.ph6, label %._crit_edge
...
._crit_edge:                                      ; preds = %6, %._crit_edge7
  ret void
}
...
; <label>:42:                                     ; preds = %42, %.lr.ph5.split.us
...
._crit_edge:                                      ; preds = %8, %._crit_edge6
  ret void
}
...
define internal fastcc void @print_array(i32, double*) unnamed_addr #0 {
  ...
  br i1 %11, label %.lr.ph, label %._crit_edge5
...
._crit_edge5:                                     ; preds = %2, %._crit_edge3
