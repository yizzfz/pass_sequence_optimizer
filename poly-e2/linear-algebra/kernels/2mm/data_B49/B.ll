...
entry:
  ...
  call fastcc void @kernel_2mm(double %0, double %1, [900 x double]* %arraydecay125, [1100 x double]* %arraydecay1, [900 x double]* %arraydecay92, [1200 x double]* %arraydecay103, [1200 x double]* %arraydecay114)
...
if.then:                                          ; preds = %land.lhs.true
  call fastcc void @print_array([1200 x double]* %arraydecay114)
  br label %if.end
