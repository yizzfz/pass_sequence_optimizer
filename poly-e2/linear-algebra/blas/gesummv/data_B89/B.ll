...
for.body.us:                                      ; preds = %for.cond2.for.end_crit_edge.us, %entry
  %indvars.iv410.us = phi i64 [ 0, %entry ], [ %indvars.iv.next5.us, %for.cond2.for.end_crit_edge.us ]
  %0 = trunc i64 %indvars.iv410.us to i32
  %rem.us = srem i32 %0, 1300
  %conv.us = sitofp i32 %rem.us to double
  %div.us = fdiv double %conv.us, 1.300000e+03
  %arrayidx.us = getelementptr inbounds double, double* %x, i64 %indvars.iv410.us
  store double %div.us, double* %arrayidx.us, align 8
  br label %for.body5.us

for.body5.us:                                     ; preds = %for.body5.us, %for.body.us
  %indvars.iv8.us = phi i64 [ 0, %for.body.us ], [ %indvars.iv.next.us, %for.body5.us ]
  %1 = mul nuw nsw i64 %indvars.iv8.us, %indvars.iv410.us
  %2 = add nuw nsw i64 %1, 1
  %3 = trunc i64 %2 to i32
  %rem6.us = srem i32 %3, 1300
  %conv7.us = sitofp i32 %rem6.us to double
  %arrayidx13.us = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv410.us, i64 %indvars.iv8.us
  ...
  %arrayidx23.us = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv410.us, i64 %indvars.iv8.us
  store double %div9.v.r2.us, double* %arrayidx23.us, align 8
  %indvars.iv.next.us = add nuw nsw i64 %indvars.iv8.us, 1
  %exitcond6.us = icmp eq i64 %indvars.iv.next.us, 1300
  br i1 %exitcond6.us, label %for.cond2.for.end_crit_edge.us, label %for.body5.us

for.cond2.for.end_crit_edge.us:                   ; preds = %for.body5.us
  %indvars.iv.next5.us = add nuw nsw i64 %indvars.iv410.us, 1
  %exitcond = icmp eq i64 %indvars.iv.next5.us, 1300
...
entry:
  ...
  %sunkaddr30 = ptrtoint double* %y to i64
  br label %for.body.us

for.body.us:                                      ; preds = %for.cond5.for.end_crit_edge.us, %entry
  %indvars.iv17.us = phi i64 [ 0, %entry ], [ %indvars.iv.next2.us, %for.cond5.for.end_crit_edge.us ]
  %arrayidx.us = getelementptr inbounds double, double* %tmp, i64 %indvars.iv17.us
  store double 0.000000e+00, double* %arrayidx.us, align 8
  %arrayidx4.us = getelementptr inbounds double, double* %y, i64 %indvars.iv17.us
  store double 0.000000e+00, double* %arrayidx4.us, align 8
  %sunkaddr27 = shl i64 %indvars.iv17.us, 3
  %sunkaddr28 = add i64 %sunkaddr, %sunkaddr27
  %sunkaddr29 = inttoptr i64 %sunkaddr28 to double*
  %sunkaddr31 = shl i64 %indvars.iv17.us, 3
...
for.body7.us:                                     ; preds = %for.body7.us, %for.body.us
  %indvars.iv5.us = phi i64 [ 0, %for.body.us ], [ %indvars.iv.next.us, %for.body7.us ]
  %arrayidx11.us = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv17.us, i64 %indvars.iv5.us
  %2 = load double, double* %arrayidx11.us, align 8
  %arrayidx13.us = getelementptr inbounds double, double* %x, i64 %indvars.iv5.us
  %3 = load double, double* %arrayidx13.us, align 8
  %mul.us = fmul double %2, %3
  %4 = load double, double* %sunkaddr29, align 8
  %add.us = fadd double %mul.us, %4
  store double %add.us, double* %sunkaddr29, align 8
  %arrayidx21.us = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv17.us, i64 %indvars.iv5.us
  %5 = load double, double* %arrayidx21.us, align 8
  %6 = load double, double* %arrayidx13.us, align 8
  %mul24.us = fmul double %5, %6
  %7 = load double, double* %sunkaddr33, align 8
  %add27.us = fadd double %mul24.us, %7
  store double %add27.us, double* %sunkaddr33, align 8
  %indvars.iv.next.us = add nuw nsw i64 %indvars.iv5.us, 1
  %exitcond3.us = icmp eq i64 %indvars.iv.next.us, 1300
  br i1 %exitcond3.us, label %for.cond5.for.end_crit_edge.us, label %for.body7.us

for.cond5.for.end_crit_edge.us:                   ; preds = %for.body7.us
  %sunkaddr20 = shl nuw nsw i64 %indvars.iv17.us, 3
  %sunkaddr21 = add i64 %1, %sunkaddr20
  %sunkaddr22 = inttoptr i64 %sunkaddr21 to double*
  %8 = load double, double* %sunkaddr22, align 8
  %mul32.us = fmul double %8, %alpha
  %mul35.us = fmul double %add27.us, %beta
  %add36.us = fadd double %mul32.us, %mul35.us
  %sunkaddr24 = shl nuw nsw i64 %indvars.iv17.us, 3
  %sunkaddr25 = add i64 %0, %sunkaddr24
  %sunkaddr26 = inttoptr i64 %sunkaddr25 to double*
  store double %add36.us, double* %sunkaddr26, align 8
  %indvars.iv.next2.us = add nuw nsw i64 %indvars.iv17.us, 1
  %exitcond = icmp eq i64 %indvars.iv.next2.us, 1300
...
for.body:                                         ; preds = %if.end, %entry
  %indvars.iv2 = phi i64 [ 0, %entry ], [ %indvars.iv.next, %if.end ]
