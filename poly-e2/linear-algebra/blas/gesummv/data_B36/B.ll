...
for.end:                                          ; preds = %for.body5
  ...
  %exitcond1 = icmp eq i64 %indvars.iv.next5, 1300
...
entry:
  ...
  %sunkaddr18 = ptrtoint double* %y to i64
  br label %for.body
...
for.body7:                                        ; preds = %for.body7, %for.body
  ...
  %mul = fmul double %1, %2
  %3 = load double, double* %sunkaddr17, align 8
  ...
  store double %add27, double* %sunkaddr21, align 8
...
for.end:                                          ; preds = %for.body7
  ...
  %7 = load double, double* %sunkaddr14, align 8
  ...
  %exitcond1 = icmp eq i64 %indvars.iv.next2, 1300
