...
for.body3.us.us.preheader:                        ; preds = %for.cond1.for.inc24_crit_edge.us.for.body3.us.us.preheader_crit_edge, %for.cond1.preheader.us.preheader
  %indvar150 = phi i64 [ 0, %for.cond1.preheader.us.preheader ], [ %indvar.next151, %for.cond1.for.inc24_crit_edge.us.for.body3.us.us.preheader_crit_edge ]
  ...
  %sext165 = shl i64 %storemerge78.us, 32
  %idxprom.us = ashr exact i64 %sext165, 32
  br label %for.body3.us.us

for.cond1.for.inc24_crit_edge.us:                 ; preds = %for.cond6.for.inc21_crit_edge.us.us
  %indvar.next151 = add nuw nsw i64 %indvar150, 1
  %exitcond162 = icmp eq i64 %indvar.next151, 800
  br i1 %exitcond162, label %for.body32.us.us.preheader.preheader, label %for.cond1.for.inc24_crit_edge.us.for.body3.us.us.preheader_crit_edge
...
for.body8.us.us:                                  ; preds = %for.body8.us.us, %for.body3.us.us
  %indvars.iv154 = phi i64 [ 0, %for.body3.us.us ], [ %indvars.iv.next155.1, %for.body8.us.us ]
  %0 = phi double [ 0.000000e+00, %for.body3.us.us ], [ %add.us.us.1, %for.body8.us.us ]
  %arrayidx12.us.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %idxprom.us, i64 %indvars.iv154
  %1 = load double, double* %arrayidx12.us.us, align 8
  %arrayidx16.us.us = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv154, i64 %indvars.iv5
  ...
  %arrayidx12.us.us.1 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %idxprom.us, i64 %indvars.iv.next155
  %3 = load double, double* %arrayidx12.us.us.1, align 8
  %arrayidx16.us.us.1 = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv.next155, i64 %indvars.iv5
  ...
  %exitcond157.1 = icmp eq i64 %indvars.iv.next155.1, 1000
  br i1 %exitcond157.1, label %for.cond6.for.inc21_crit_edge.us.us, label %for.body8.us.us
...
for.body32.us.us.preheader:                       ; preds = %for.body32.us.us.preheader.preheader, %for.cond30.for.inc60_crit_edge.us.for.body32.us.us.preheader_crit_edge
  %indvar132 = phi i64 [ %indvar.next133, %for.cond30.for.inc60_crit_edge.us.for.body32.us.us.preheader_crit_edge ], [ 0, %for.body32.us.us.preheader.preheader ]
  ...
  %sext164 = shl i64 %storemerge145.us, 32
  %idxprom33.us = ashr exact i64 %sext164, 32
...
for.cond30.for.inc60_crit_edge.us:                ; preds = %for.cond37.for.inc57_crit_edge.us.us
  ...
  %exitcond144 = icmp eq i64 %indvar.next133, 900
  br i1 %exitcond144, label %for.body68.us.us.preheader.preheader, label %for.cond30.for.inc60_crit_edge.us.for.body32.us.us.preheader_crit_edge
...
for.body39.us.us:                                 ; preds = %for.body39.us.us, %for.body32.us.us
  %indvars.iv136 = phi i64 [ 0, %for.body32.us.us ], [ %indvars.iv.next137.1, %for.body39.us.us ]
  %5 = phi double [ 0.000000e+00, %for.body32.us.us ], [ %add53.us.us.1, %for.body39.us.us ]
  %arrayidx43.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %idxprom33.us, i64 %indvars.iv136
  %6 = load double, double* %arrayidx43.us.us, align 8
  %arrayidx47.us.us = getelementptr inbounds [1100 x double], [1100 x double]* %D, i64 %indvars.iv136, i64 %indvars.iv3
  ...
  %arrayidx43.us.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %idxprom33.us, i64 %indvars.iv.next137
  %8 = load double, double* %arrayidx43.us.us.1, align 8
  %arrayidx47.us.us.1 = getelementptr inbounds [1100 x double], [1100 x double]* %D, i64 %indvars.iv.next137, i64 %indvars.iv3
  ...
  %exitcond139.1 = icmp eq i64 %indvars.iv.next137.1, 1200
  br i1 %exitcond139.1, label %for.cond37.for.inc57_crit_edge.us.us, label %for.body39.us.us
