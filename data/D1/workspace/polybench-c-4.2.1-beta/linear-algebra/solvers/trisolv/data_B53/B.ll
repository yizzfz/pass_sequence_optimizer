...
; <label>:5:                                      ; preds = %._crit_edge, %.lr.ph12
  %indvars.iv23 = phi i64 [ 0, %.lr.ph12 ], [ %indvars.iv.next24, %._crit_edge ]
  %6 = add nuw i64 %indvars.iv23, 4294967295
  ...
  %11 = load [2000 x double]*, [2000 x double]** %4, align 8
  br i1 %10, label %.lr.ph, label %._crit_edge

.lr.ph:                                           ; preds = %5
  %sunkaddr2 = shl nsw i64 %indvars.iv23, 3
...
.prol.preheader:                                  ; preds = %.lr.ph
  %12 = getelementptr inbounds [2000 x double], [2000 x double]* %11, i64 %indvars.iv23, i64 0
  %13 = load double, double* %12, align 8
  %14 = load double, double* %2, align 8
  %15 = fmul double %13, %14
  %16 = fsub double %8, %15
  store double %16, double* %sunkaddr4, align 8
  %17 = load [2000 x double]*, [2000 x double]** %4, align 8
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.lr.ph, %.prol.preheader
  %indvars.iv.unr.ph = phi i64 [ 1, %.prol.preheader ], [ 0, %.lr.ph ]
  %.unr.ph = phi [2000 x double]* [ %17, %.prol.preheader ], [ %11, %.lr.ph ]
  %.unr20.ph = phi double [ %16, %.prol.preheader ], [ %8, %.lr.ph ]
  %.lcssa17.unr.ph = phi double [ %16, %.prol.preheader ], [ undef, %.lr.ph ]
  %.lcssa16.unr.ph = phi [2000 x double]* [ %17, %.prol.preheader ], [ undef, %.lr.ph ]
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.lr.ph.new ], [ %indvars.iv.unr.ph, %.lr.ph.new.preheader ]
  %20 = phi [2000 x double]* [ %35, %.lr.ph.new ], [ %.unr.ph, %.lr.ph.new.preheader ]
  %21 = phi double [ %34, %.lr.ph.new ], [ %.unr20.ph, %.lr.ph.new.preheader ]
  %22 = getelementptr inbounds [2000 x double], [2000 x double]* %20, i64 %indvars.iv23, i64 %indvars.iv
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %28 = load [2000 x double]*, [2000 x double]** %4, align 8
  %29 = getelementptr inbounds [2000 x double], [2000 x double]* %28, i64 %indvars.iv23, i64 %indvars.iv.next
  ...
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %35 = load [2000 x double]*, [2000 x double]** %4, align 8
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %5
  %.lcssa9 = phi double [ %8, %5 ], [ %.lcssa17.unr.ph, %.prol.loopexit ], [ %34, %._crit_edge.loopexit ]
  %.lcssa = phi [2000 x double]* [ %11, %5 ], [ %.lcssa16.unr.ph, %.prol.loopexit ], [ %35, %._crit_edge.loopexit ]
  %36 = getelementptr inbounds [2000 x double], [2000 x double]* %.lcssa, i64 %indvars.iv23, i64 %indvars.iv23
  %37 = load double, double* %36, align 8
  %38 = fdiv double %.lcssa9, %37
  ...
  br i1 %exitcond, label %._crit_edge13, label %5
