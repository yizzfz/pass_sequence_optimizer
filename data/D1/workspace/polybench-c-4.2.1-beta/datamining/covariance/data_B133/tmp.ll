...
.lr.ph36.split.us:                                ; preds = %._crit_edge32.us, %.lr.ph36.split.us.preheader
  ...
  %sunkaddr124 = shl i64 %indvars.iv92, 3
  %sunkaddr125 = add i64 %4, %sunkaddr124
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph36.split.us
  ...
  store double %15, double* %sunkaddr126, align 8
  ...
  store double %18, double* %sunkaddr126, align 8
  ...
  store double %21, double* %sunkaddr126, align 8
  %indvars.iv.next90.4 = add nuw nsw i64 %indvars.iv89, 5
  %exitcond105.4 = icmp eq i64 %indvars.iv.next90.4, 1400
  br i1 %exitcond105.4, label %._crit_edge32.us, label %._crit_edge

._crit_edge32.us:                                 ; preds = %._crit_edge
  %22 = fdiv double %21, %0
  %sunkaddr24 = shl i64 %indvars.iv92, 3
  ...
  %exitcond106 = icmp eq i64 %indvars.iv.next93, 1200
  br i1 %exitcond106, label %._crit_edge32.us..preheader7.us_crit_edge, label %.lr.ph36.split.us
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  br i1 %39, label %._crit_edge25.us.loopexit27, label %vector.body, !llvm.loop !6
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %exitcond103.3 = icmp eq i64 %indvars.iv.next86.3, 1200
  br i1 %exitcond103.3, label %._crit_edge25.us.loopexit, label %scalar.ph, !llvm.loop !9

._crit_edge25.us.loopexit:                        ; preds = %scalar.ph
  br label %._crit_edge25.us

._crit_edge25.us.loopexit27:                      ; preds = %vector.body
  br label %._crit_edge25.us

._crit_edge25.us:                                 ; preds = %._crit_edge25.us.loopexit27, %._crit_edge25.us.loopexit
  %exitcond104 = icmp eq i64 %23, 1400
  br i1 %exitcond104, label %.lr.ph15.split.us.preheader, label %vector.memcheck
...
._crit_edge11.us-lcssa.us.us:                     ; preds = %._crit_edge.us.us
  ...
  %exitcond102 = icmp eq i64 %indvars.iv.next72, 1200
  br i1 %exitcond102, label %77, label %.lr.ph10.us
...
._crit_edge.us.us:                                ; preds = %._crit_edge21
  ...
  %exitcond101 = icmp eq i64 %indvars.iv.next64, 1200
  br i1 %exitcond101, label %._crit_edge11.us-lcssa.us.us, label %.lr.ph.us.us
...
._crit_edge21:                                    ; preds = %._crit_edge21, %.lr.ph.us.us
  ...
  br i1 %exitcond.1, label %._crit_edge.us.us, label %._crit_edge21

; <label>:77:                                     ; preds = %._crit_edge11.us-lcssa.us.us
  ret void
}
...
._crit_edge.us:                                   ; preds = %._crit_edge
  ...
  br i1 %exitcond11, label %16, label %.preheader.us

; <label>:16:                                     ; preds = %._crit_edge.us
  %17 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %18 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %17, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0)) #6
