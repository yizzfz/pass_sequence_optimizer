...
._crit_edge3.us._crit_edge:                       ; preds = %._crit_edge3.us._crit_edge, %.preheader.us
  ...
  %2 = mul nuw nsw i64 %indvars.iv19, %indvars.iv
  %3 = trunc i64 %2 to i32
  %4 = srem i32 %3, 7
  %5 = add nsw i32 %4, 1
  %6 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv19, i64 %indvars.iv
  %7 = add nuw nsw i64 %indvars.iv, %indvars.iv19
  ...
  %13 = srem i32 %8, 11
  %14 = icmp eq i32 %13, 0
  %or.cond6.us = or i1 %14, %or.cond.us
  %. = select i1 %or.cond6.us, i32 999, i32 %5
...
.loopexit.us:                                     ; preds = %._crit_edge3.us._crit_edge
  ...
  br i1 %exitcond21, label %._crit_edge, label %.preheader.us
