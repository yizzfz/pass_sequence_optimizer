...
for.body:                                         ; preds = %for.body, %for.body.lr.ph
  %indvars.iv17 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next18.4, %for.body ]
...
for.cond1.preheader.lr.ph:
  br label %for.cond1.preheader.for.body3_crit_edge

for.cond1.preheader.for.body3_crit_edge:          ; preds = %for.cond1.preheader.lr.ph, %for.inc113
  %indvars.iv69 = phi i64 [ 0, %for.cond1.preheader.lr.ph ], [ %indvars.iv.next70, %for.inc113 ]
  br label %for.body3

vector.memcheck76:                                ; preds = %vector.memcheck76.preheader, %for.cond10.for.inc34_crit_edge.us
  %indvar = phi i64 [ %0, %for.cond10.for.inc34_crit_edge.us ], [ 0, %vector.memcheck76.preheader ]
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.cond10.for.inc34_crit_edge.us ], [ 1, %vector.memcheck76.preheader ]
  %0 = add i64 %indvar, 1
...
vector.body58.preheader:                          ; preds = %vector.memcheck76
  br label %vector.body58

for.body12.us.preheader:                          ; preds = %vector.memcheck76
...
for.body12.us:                                    ; preds = %for.body12.us, %for.body12.us.preheader
  %indvars.iv48 = phi i64 [ 0, %for.body12.us.preheader ], [ %indvars.iv.next49.1, %for.body12.us ]
...
for.cond10.for.inc34_crit_edge.us:                ; preds = %for.cond10.for.inc34_crit_edge.us.loopexit112, %for.cond10.for.inc34_crit_edge.us.loopexit
  ...
  br i1 %exitcond54, label %vector.memcheck42.preheader, label %vector.memcheck76

vector.memcheck42.preheader:                      ; preds = %for.cond10.for.inc34_crit_edge.us
  br label %vector.memcheck42

for.body3:                                        ; preds = %for.body3, %for.cond1.preheader.for.body3_crit_edge
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader.for.body3_crit_edge ], [ %indvars.iv.next.4, %for.body3 ]
  ...
  br i1 %exitcond.4, label %vector.memcheck76.preheader, label %for.body3

vector.memcheck76.preheader:                      ; preds = %for.body3
  br label %vector.memcheck76

vector.memcheck42:                                ; preds = %vector.memcheck42.preheader, %for.cond40.for.inc66_crit_edge.us
  %indvars.iv60 = phi i64 [ %38, %for.cond40.for.inc66_crit_edge.us ], [ 0, %vector.memcheck42.preheader ]
...
vector.body25.preheader:                          ; preds = %vector.memcheck42
...
for.body42.us.preheader.new:                      ; preds = %for.body42.us.preheader.new.loopexit, %vector.memcheck42
  %indvars.iv55.ph = phi i64 [ 1, %vector.memcheck42 ], [ 1197, %for.body42.us.preheader.new.loopexit ]
...
for.body42.us:                                    ; preds = %for.body42.us, %for.body42.us.preheader.new
  %indvars.iv55 = phi i64 [ %indvars.iv.next56.prol, %for.body42.us.preheader.new ], [ %indvars.iv.next56.1, %for.body42.us ]
  ...
  br i1 %exitcond59.1, label %for.cond40.for.inc66_crit_edge.us, label %for.body42.us, !llvm.loop !16

for.cond40.for.inc66_crit_edge.us:                ; preds = %for.body42.us
  %cmp38.us = icmp slt i64 %38, 1000
  br i1 %cmp38.us, label %vector.memcheck42, label %vector.memcheck.preheader
...
vector.memcheck:                                  ; preds = %vector.memcheck.preheader, %for.cond73.for.inc110_crit_edge.us
  %indvars.iv65 = phi i64 [ %70, %for.cond73.for.inc110_crit_edge.us ], [ 0, %vector.memcheck.preheader ]
...
for.body76.us.preheader:                          ; preds = %for.body76.us.preheader.loopexit, %vector.memcheck
  %indvars.iv63.ph = phi i64 [ 0, %vector.memcheck ], [ 1196, %for.body76.us.preheader.loopexit ]
  br label %for.body76.us

for.body76.us:                                    ; preds = %for.body76.us.preheader, %for.body76.us
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.body76.us ], [ %indvars.iv63.ph, %for.body76.us.preheader ]
...
for.cond73.for.inc110_crit_edge.us:               ; preds = %for.body76.us
  ...
  br i1 %exitcond68, label %for.inc113, label %vector.memcheck

for.inc113:                                       ; preds = %for.cond73.for.inc110_crit_edge.us
  %indvars.iv.next70 = add nsw i64 %indvars.iv69, 1
  %cmp = icmp slt i64 %indvars.iv.next70, 500
  br i1 %cmp, label %for.cond1.preheader.for.body3_crit_edge, label %for.end115
...
for.cond2.preheader.us:                           ; preds = %for.cond2.for.inc10_crit_edge.us, %for.cond2.preheader.lr.ph.for.cond2.preheader.us_crit_edge
  %indvars.iv60 = phi i64 [ 0, %for.cond2.preheader.lr.ph.for.cond2.preheader.us_crit_edge ], [ %indvars.iv.next61, %for.cond2.for.inc10_crit_edge.us ]
  %3 = mul nsw i64 %indvars.iv60, 1000
  br label %for.body4.us

for.body4.us:                                     ; preds = %if.end.us, %for.cond2.preheader.us
  %indvars.iv55 = phi i64 [ 0, %for.cond2.preheader.us ], [ %indvars.iv.next56, %if.end.us ]
...
for.cond19.preheader.us:                          ; preds = %for.cond19.for.inc37_crit_edge.us, %for.cond19.preheader.lr.ph.for.cond19.preheader.us_crit_edge
  %indvars.iv50 = phi i64 [ 0, %for.cond19.preheader.lr.ph.for.cond19.preheader.us_crit_edge ], [ %indvars.iv.next51, %for.cond19.for.inc37_crit_edge.us ]
  %13 = mul nsw i64 %indvars.iv50, 1000
  br label %for.body21.us

for.body21.us:                                    ; preds = %if.end28.us, %for.cond19.preheader.us
  %indvars.iv45 = phi i64 [ 0, %for.cond19.preheader.us ], [ %indvars.iv.next46, %if.end28.us ]
...
for.cond45.preheader.us:                          ; preds = %for.cond45.for.inc63_crit_edge.us, %for.cond45.preheader.lr.ph.for.cond45.preheader.us_crit_edge
  %indvars.iv42 = phi i64 [ 0, %for.cond45.preheader.lr.ph.for.cond45.preheader.us_crit_edge ], [ %indvars.iv.next43, %for.cond45.for.inc63_crit_edge.us ]
