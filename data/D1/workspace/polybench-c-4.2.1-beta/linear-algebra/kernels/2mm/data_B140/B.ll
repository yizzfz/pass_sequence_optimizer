...
._crit_edge23:                                    ; preds = %14, %6
  %indvars.iv19 = phi i64 [ 0, %6 ], [ %indvars.iv.next20, %14 ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge23
  %indvars.iv16 = phi i64 [ 0, %._crit_edge23 ], [ %indvars.iv.next17, %._crit_edge ]
...
; <label>:14:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond21, label %._crit_edge22.preheader, label %._crit_edge23

._crit_edge22.preheader:                          ; preds = %14
  br label %._crit_edge22

._crit_edge22:                                    ; preds = %._crit_edge22.preheader, %27
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %27 ], [ 0, %._crit_edge22.preheader ]
  br label %._crit_edge24

._crit_edge24:                                    ; preds = %._crit_edge24, %._crit_edge22
  %indvars.iv10 = phi i64 [ 0, %._crit_edge22 ], [ %indvars.iv.next11.1, %._crit_edge24 ]
  ...
  br i1 %exitcond12.1, label %27, label %._crit_edge24

; <label>:27:                                     ; preds = %._crit_edge24
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 1100
  br i1 %exitcond15, label %._crit_edge25.preheader, label %._crit_edge22

._crit_edge25.preheader:                          ; preds = %27
  br label %._crit_edge25

._crit_edge25:                                    ; preds = %._crit_edge25.preheader, %36
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %36 ], [ 0, %._crit_edge25.preheader ]
  br label %._crit_edge27

._crit_edge27:                                    ; preds = %._crit_edge27, %._crit_edge25
  %indvars.iv4 = phi i64 [ 0, %._crit_edge25 ], [ %indvars.iv.next5, %._crit_edge27 ]
...
; <label>:36:                                     ; preds = %._crit_edge27
  ...
  br i1 %exitcond9, label %._crit_edge28.preheader, label %._crit_edge25
...
._crit_edge30:                                    ; preds = %._crit_edge30, %._crit_edge28
  %indvars.iv = phi i64 [ 0, %._crit_edge28 ], [ %indvars.iv.next, %._crit_edge30 ]
  ...
  br i1 %exitcond, label %44, label %._crit_edge30

; <label>:44:                                     ; preds = %._crit_edge30
