...
._crit_edge:                                      ; preds = %._crit_edge, %2
  ...
  br i1 %exitcond6.2, label %.preheader7..preheader_crit_edge.preheader, label %._crit_edge

.preheader7..preheader_crit_edge.preheader:       ; preds = %._crit_edge
  br label %.preheader7..preheader_crit_edge

.preheader7..preheader_crit_edge:                 ; preds = %.preheader7..preheader_crit_edge.preheader, %.preheader7
  %indvars.iv19 = phi i64 [ %indvars.iv.next2, %.preheader7 ], [ 0, %.preheader7..preheader_crit_edge.preheader ]
  br label %.preheader

.preheader:                                       ; preds = %.preheader, %.preheader7..preheader_crit_edge
  %indvars.iv8 = phi i64 [ 0, %.preheader7..preheader_crit_edge ], [ %indvars.iv.next.1, %.preheader ]
  ...
  br i1 %exitcond.1, label %.preheader7, label %.preheader

.preheader7:                                      ; preds = %.preheader
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv19, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 1900
  br i1 %exitcond3, label %31, label %.preheader7..preheader_crit_edge

; <label>:31:                                     ; preds = %.preheader7
  ret void
}
...
._crit_edge:                                      ; preds = %._crit_edge, %4
  %indvars.iv721 = phi i64 [ 0, %4 ], [ %indvars.iv.next8.11, %._crit_edge ]
  ...
  br i1 %exitcond9.11, label %.preheader10, label %._crit_edge

._crit_edge3:                                     ; preds = %52, %.preheader10
  %indvars.iv420 = phi i64 [ 0, %.preheader10 ], [ %indvars.iv.next5, %52 ]
  %23 = getelementptr inbounds double, double* %3, i64 %indvars.iv420
  store double 0.000000e+00, double* %23, align 8
  %sunkaddr11 = shl nuw nsw i64 %indvars.iv420, 3
  %sunkaddr12 = add i64 %sunkaddr, %sunkaddr11
  %sunkaddr13 = inttoptr i64 %sunkaddr12 to double*
  %sunkaddr11.1 = shl nuw nsw i64 %indvars.iv420, 3
...
._crit_edge1:                                     ; preds = %._crit_edge1, %._crit_edge3
  %indvars.iv18 = phi i64 [ 0, %._crit_edge3 ], [ %indvars.iv.next.1, %._crit_edge1 ]
...
; <label>:52:                                     ; preds = %.preheader
  ...
  br i1 %exitcond6, label %53, label %._crit_edge3
