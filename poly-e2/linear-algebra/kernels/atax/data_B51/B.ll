...
for.body5.us.preheader:                           ; preds = %for.body
  ...
  %scevgep97 = getelementptr double, double* %y, i64 2100
  %0 = ptrtoint double* %tmp to i64
  %1 = bitcast double* %scevgep97 to i8*
...
for.body5.us:                                     ; preds = %for.inc42.us, %for.body5.us.preheader
  ...
  %scevgep99 = getelementptr [2100 x double], [2100 x double]* %A, i64 %indvars.iv66, i64 1
  %3 = add i64 %indvars.iv66, 1
  %scevgep101 = getelementptr [2100 x double], [2100 x double]* %A, i64 %3, i64 0
...
for.body26.us.for.body26.us_crit_edge:            ; preds = %for.body26.us.for.body26.us_crit_edge.preheader, %for.body26.us.for.body26.us_crit_edge
  %indvars.iv.next6595 = phi i64 [ %indvars.iv.next65, %for.body26.us.for.body26.us_crit_edge ], [ %indvars.iv.next6595.ph, %for.body26.us.for.body26.us_crit_edge.preheader ]
  %.pre = load double, double* %17, align 8
  %arrayidx28.us = getelementptr inbounds double, double* %y, i64 %indvars.iv.next6595
  %5 = load double, double* %arrayidx28.us, align 8
  %arrayidx32.us = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv66, i64 %indvars.iv.next6595
  ...
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv.next6595, 1
...
for.body10.us.for.body26.us_crit_edge:            ; preds = %for.body10.us
  ...
  %arrayidx32.us92 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv66, i64 0
  %15 = load double, double* %arrayidx32.us92, align 8
  %mul35.us93 = fmul double %15, %add.us.2
  %add36.us94 = fadd double %14, %mul35.us93
  store double %add36.us94, double* %y, align 8
  %bc = inttoptr i64 %sunkaddr88 to i8*
  %bound0 = icmp ult i8* %2, %bc
  %bound1 = icmp ult i8* %bc, %1
  %found.conflict = and i1 %bound0, %bound1
  %bound0104 = icmp ult double* %scevgep, %scevgep101
  %bound1105 = icmp ult double* %scevgep99, %scevgep97
...
for.body26.us.for.body26.us_crit_edge.preheader:  ; preds = %for.body26.us.for.body26.us_crit_edge.preheader.loopexit, %for.body10.us.for.body26.us_crit_edge
  %indvars.iv.next6595.ph = phi i64 [ 1, %for.body10.us.for.body26.us_crit_edge ], [ 2097, %for.body26.us.for.body26.us_crit_edge.preheader.loopexit ]
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load108 = load <2 x double>, <2 x double>* %24, align 8, !alias.scope !7, !noalias !9
  %25 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv66, i64 %offset.idx
  %26 = bitcast double* %25 to <2 x double>*
  %wide.load109 = load <2 x double>, <2 x double>* %26, align 8, !alias.scope !11
  %27 = getelementptr double, double* %25, i64 2
  %28 = bitcast double* %27 to <2 x double>*
  %wide.load110 = load <2 x double>, <2 x double>* %28, align 8, !alias.scope !11
  %29 = fmul <2 x double> %wide.load109, %20
  %30 = fmul <2 x double> %wide.load110, %20
  %31 = fadd <2 x double> %wide.load, %29
  %32 = fadd <2 x double> %wide.load108, %30
