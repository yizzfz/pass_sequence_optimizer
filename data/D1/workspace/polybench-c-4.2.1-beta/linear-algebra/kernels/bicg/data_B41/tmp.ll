...
.lr.ph5.split.us.new:                             ; preds = %.lr.ph5.split.us, %.lr.ph5.split.us.new
  ...
  br i1 %exitcond23.1, label %._crit_edge.us, label %.lr.ph5.split.us.new
...
.lr.ph9.new:                                      ; preds = %.lr.ph9.new, %.lr.ph9
  %indvars.iv19 = phi i64 [ 0, %.lr.ph9 ], [ %indvars.iv.next20.1.1, %.lr.ph9.new ]
  ...
  %29 = trunc i64 %indvars.iv.next20.1 to i32
  %30 = sitofp i32 %29 to double
  %31 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next20.1
  %32 = or i32 %29, 1
  ...
  br i1 %exitcond25.1.1, label %.lr.ph5.split.us.preheader, label %.lr.ph9.new
...
; <label>:7:                                      ; preds = %7, %.lr.ph4.split.us
  ...
  %10 = load double, double* %sunkaddr27, align 8
  ...
  store double %20, double* %sunkaddr31, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond22 = icmp eq i64 %indvars.iv.next, 1900
  br i1 %exitcond22, label %._crit_edge.us, label %7
