...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc7_crit_edge.us.for.cond1.preheader.us_crit_edge, %entry
  %indvars.iv5 = phi i64 [ 0, %entry ], [ %indvars.iv.next6, %for.cond1.for.inc7_crit_edge.us.for.cond1.preheader.us_crit_edge ]
  %0 = add i64 %indvars.iv5, 1000
  %1 = trunc i64 %0 to i32
  br label %for.inc.us

for.inc.us:                                       ; preds = %for.inc.us.for.inc.us_crit_edge, %for.cond1.preheader.us
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next.1, %for.inc.us.for.inc.us_crit_edge ]
  ...
  br i1 %exitcond.1, label %for.cond1.for.inc7_crit_edge.us, label %for.inc.us.for.inc.us_crit_edge
...
for.cond1.for.inc7_crit_edge.us:                  ; preds = %for.inc.us
  ...
  br i1 %cmp.us, label %for.cond1.for.inc7_crit_edge.us.for.cond1.preheader.us_crit_edge, label %for.end9
...
for.cond15.preheader:                             ; preds = %for.inc237.for.cond15.preheader_crit_edge, %entry
  %t.014 = phi i32 [ 1, %entry ], [ %inc238, %for.inc237.for.cond15.preheader_crit_edge ]
  br label %for.inc.us.lver.check

for.inc.us.lver.check:                            ; preds = %for.inc120.us.for.inc.us.lver.check_crit_edge, %for.cond15.preheader
  %indvar = phi i64 [ 0, %for.cond15.preheader ], [ %indvar.next, %for.inc120.us.for.inc.us.lver.check_crit_edge ]
  %indvars.iv18 = phi i64 [ 1, %for.cond15.preheader ], [ %indvars.iv.next19, %for.inc120.us.for.inc.us.lver.check_crit_edge ]
  %0 = add i64 %indvar, 1
  %1 = add i64 %indvar, 1
  ...
  %arrayidx20.us = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 0, i64 %indvars.iv18
  store double 1.000000e+00, double* %arrayidx20.us, align 8
  %arrayidx23.us = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv18, i64 0
  store double 0.000000e+00, double* %arrayidx23.us, align 8
  %2 = bitcast double* %arrayidx20.us to i64*
  %3 = load i64, i64* %2, align 8
  %arrayidx28.us = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv18
  %4 = bitcast [1000 x double]* %arrayidx28.us to i64*
  store i64 %3, i64* %4, align 8
  %5 = add nsw i64 %indvars.iv18, -1
...
for.inc.us.lver.orig:                             ; preds = %for.inc.us.lver.orig.for.inc.us.lver.orig_crit_edge, %for.inc.us.lver.orig.preheader
  %indvars.iv.lver.orig = phi i64 [ %indvars.iv.next.lver.orig, %for.inc.us.lver.orig.for.inc.us.lver.orig_crit_edge ], [ 1, %for.inc.us.lver.orig.preheader ]
  %6 = add nsw i64 %indvars.iv.lver.orig, -1
  %arrayidx40.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv18, i64 %6
  %7 = load double, double* %arrayidx40.us.lver.orig, align 8
  %arrayidx47.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv18, i64 %indvars.iv.lver.orig
  %arrayidx53.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv.lver.orig, i64 %5
  %arrayidx67.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv.lver.orig, i64 %indvars.iv.next19
  %arrayidx74.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv18, i64 %6
  ...
  %arrayidx88.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv18, i64 %indvars.iv.lver.orig
  ...
  br i1 %exitcond.lver.orig, label %for.cond30.for.end_crit_edge.us.loopexit, label %for.inc.us.lver.orig.for.inc.us.lver.orig_crit_edge

for.inc.us.lver.orig.for.inc.us.lver.orig_crit_edge: ; preds = %for.inc.us.lver.orig
  br label %for.inc.us.lver.orig
...
for.inc120.us:                                    ; preds = %for.inc118.us
  %cmp17.us = icmp slt i64 %indvars.iv.next19, 999
  %indvar.next = add i64 %indvar, 1
  br i1 %cmp17.us, label %for.inc120.us.for.inc.us.lver.check_crit_edge, label %for.body127.us.preheader
...
for.inc118.us:                                    ; preds = %for.inc118.us.for.inc118.us_crit_edge, %for.cond30.for.end_crit_edge.us
  %indvars.iv16 = phi i64 [ 998, %for.cond30.for.end_crit_edge.us ], [ %indvars.iv.next17.1, %for.inc118.us.for.inc118.us_crit_edge ]
  %12 = phi double [ 1.000000e+00, %for.cond30.for.end_crit_edge.us ], [ %add113.us.1, %for.inc118.us.for.inc118.us_crit_edge ]
  %arrayidx102.us = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv18, i64 %indvars.iv16
  %13 = load double, double* %arrayidx102.us, align 8
  %mul108.us = fmul double %13, %12
  %arrayidx112.us = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv18, i64 %indvars.iv16
  %14 = load double, double* %arrayidx112.us, align 8
  %add113.us = fadd double %mul108.us, %14
  %arrayidx117.us = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %indvars.iv16, i64 %indvars.iv18
  store double %add113.us, double* %arrayidx117.us, align 8
  %indvars.iv.next17 = add nsw i64 %indvars.iv16, -1
  %arrayidx102.us.1 = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv18, i64 %indvars.iv.next17
  %15 = load double, double* %arrayidx102.us.1, align 8
  %mul108.us.1 = fmul double %15, %add113.us
  %arrayidx112.us.1 = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv18, i64 %indvars.iv.next17
  %16 = load double, double* %arrayidx112.us.1, align 8
  %add113.us.1 = fadd double %mul108.us.1, %16
  %arrayidx117.us.1 = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %indvars.iv.next17, i64 %indvars.iv18
  ...
  br i1 %cmp96.us.1, label %for.inc118.us.for.inc118.us_crit_edge, label %for.inc120.us

for.inc118.us.for.inc118.us_crit_edge:            ; preds = %for.inc118.us
  br label %for.inc118.us

for.inc.us:                                       ; preds = %for.inc.us.for.inc.us_crit_edge, %for.inc.us.ph
  %store_forwarded11 = phi double [ %load_initial10, %for.inc.us.ph ], [ %div84.us, %for.inc.us.for.inc.us_crit_edge ]
  %store_forwarded = phi double [ %load_initial, %for.inc.us.ph ], [ %div43.us, %for.inc.us.for.inc.us_crit_edge ]
  %indvars.iv = phi i64 [ 1, %for.inc.us.ph ], [ %indvars.iv.next, %for.inc.us.for.inc.us_crit_edge ]
  %arrayidx47.us = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv18, i64 %indvars.iv
  %arrayidx53.us = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv, i64 %5
  %arrayidx67.us = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv, i64 %indvars.iv.next19
  ...
  %arrayidx88.us = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv18, i64 %indvars.iv
  store double %div84.us, double* %arrayidx88.us, align 8
  %exitcond = icmp eq i64 %indvars.iv, 998
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br i1 %exitcond, label %for.cond30.for.end_crit_edge.us.loopexit33, label %for.inc.us.for.inc.us_crit_edge
...
for.cond30.for.end_crit_edge.us:                  ; preds = %for.cond30.for.end_crit_edge.us.loopexit33, %for.cond30.for.end_crit_edge.us.loopexit
  ...
  %arrayidx93.us = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 999, i64 %indvars.iv18
...
for.inc199.us.lver.check:                         ; preds = %for.inc234.us.for.inc199.us.lver.check_crit_edge, %for.body127.us.preheader
  %indvar12 = phi i64 [ %indvar.next13, %for.inc234.us.for.inc199.us.lver.check_crit_edge ], [ 0, %for.body127.us.preheader ]
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc234.us.for.inc199.us.lver.check_crit_edge ], [ 1, %for.body127.us.preheader ]
  ...
  %arrayidx130.us = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv28, i64 0
  store double 1.000000e+00, double* %arrayidx130.us, align 8
  %arrayidx133.us = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv28, i64 0
  store double 0.000000e+00, double* %arrayidx133.us, align 8
  %23 = bitcast double* %arrayidx130.us to i64*
  %24 = load i64, i64* %23, align 8
  %arrayidx138.us = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv28
  %25 = bitcast [1000 x double]* %arrayidx138.us to i64*
  store i64 %24, i64* %25, align 8
  %26 = add nsw i64 %indvars.iv28, -1
...
for.inc199.us.lver.orig:                          ; preds = %for.inc199.us.lver.orig.for.inc199.us.lver.orig_crit_edge, %for.inc199.us.lver.orig.preheader
  %indvars.iv21.lver.orig = phi i64 [ %indvars.iv.next22.lver.orig, %for.inc199.us.lver.orig.for.inc199.us.lver.orig_crit_edge ], [ 1, %for.inc199.us.lver.orig.preheader ]
  %27 = add nsw i64 %indvars.iv21.lver.orig, -1
  %arrayidx150.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv28, i64 %27
  %28 = load double, double* %arrayidx150.us.lver.orig, align 8
  %arrayidx157.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv28, i64 %indvars.iv21.lver.orig
  %arrayidx163.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %26, i64 %indvars.iv21.lver.orig
  %arrayidx170.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %indvars.iv28, i64 %indvars.iv21.lver.orig
  %arrayidx177.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %indvars.iv.next29, i64 %indvars.iv21.lver.orig
  %arrayidx184.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv28, i64 %27
  %29 = insertelement <2 x double> undef, double %28, i32 0
  %mul151.v.i1.2.us.lver.orig = shufflevector <2 x double> %29, <2 x double> undef, <2 x i32> zeroinitializer
  ...
  %arrayidx198.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv28, i64 %indvars.iv21.lver.orig
  store double %div194.us.lver.orig, double* %arrayidx198.us.lver.orig, align 8
  %exitcond25.lver.orig = icmp eq i64 %indvars.iv21.lver.orig, %indvars.iv.lcssa
  %indvars.iv.next22.lver.orig = add nuw nsw i64 %indvars.iv21.lver.orig, 1
  br i1 %exitcond25.lver.orig, label %for.cond140.for.end201_crit_edge.us.loopexit, label %for.inc199.us.lver.orig.for.inc199.us.lver.orig_crit_edge

for.inc199.us.lver.orig.for.inc199.us.lver.orig_crit_edge: ; preds = %for.inc199.us.lver.orig
  br label %for.inc199.us.lver.orig
...
for.inc234.us:                                    ; preds = %for.inc231.us
  %cmp125.us = icmp slt i64 %indvars.iv.next29, 999
  %indvar.next13 = add i64 %indvar12, 1
  br i1 %cmp125.us, label %for.inc234.us.for.inc199.us.lver.check_crit_edge, label %for.inc237
...
for.inc231.us:                                    ; preds = %for.inc231.us.for.inc231.us_crit_edge, %for.cond140.for.end201_crit_edge.us
  %indvars.iv26 = phi i64 [ 998, %for.cond140.for.end201_crit_edge.us ], [ %indvars.iv.next27.1, %for.inc231.us.for.inc231.us_crit_edge ]
  %35 = phi double [ 1.000000e+00, %for.cond140.for.end201_crit_edge.us ], [ %add226.us.1, %for.inc231.us.for.inc231.us_crit_edge ]
  %arrayidx215.us = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv28, i64 %indvars.iv26
  %36 = load double, double* %arrayidx215.us, align 8
  %mul221.us = fmul double %36, %35
  %arrayidx225.us = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv28, i64 %indvars.iv26
  %37 = load double, double* %arrayidx225.us, align 8
  %add226.us = fadd double %mul221.us, %37
  %arrayidx230.us = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv28, i64 %indvars.iv26
  store double %add226.us, double* %arrayidx230.us, align 8
  %indvars.iv.next27 = add nsw i64 %indvars.iv26, -1
  %arrayidx215.us.1 = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv28, i64 %indvars.iv.next27
  %38 = load double, double* %arrayidx215.us.1, align 8
  %mul221.us.1 = fmul double %38, %add226.us
  %arrayidx225.us.1 = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv28, i64 %indvars.iv.next27
  %39 = load double, double* %arrayidx225.us.1, align 8
  %add226.us.1 = fadd double %mul221.us.1, %39
  %arrayidx230.us.1 = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv28, i64 %indvars.iv.next27
  store double %add226.us.1, double* %arrayidx230.us.1, align 8
  %cmp209.us.1 = icmp sgt i64 %indvars.iv.next27, 1
  %indvars.iv.next27.1 = add nsw i64 %indvars.iv26, -2
  br i1 %cmp209.us.1, label %for.inc231.us.for.inc231.us_crit_edge, label %for.inc234.us

for.inc231.us.for.inc231.us_crit_edge:            ; preds = %for.inc231.us
  br label %for.inc231.us

for.inc199.us:                                    ; preds = %for.inc199.us.for.inc199.us_crit_edge, %for.inc199.us.ph
  %store_forwarded31 = phi double [ %load_initial30, %for.inc199.us.ph ], [ %div194.us, %for.inc199.us.for.inc199.us_crit_edge ]
  %store_forwarded28 = phi double [ %load_initial27, %for.inc199.us.ph ], [ %div153.us, %for.inc199.us.for.inc199.us_crit_edge ]
  %indvars.iv21 = phi i64 [ 1, %for.inc199.us.ph ], [ %indvars.iv.next22, %for.inc199.us.for.inc199.us_crit_edge ]
  %arrayidx157.us = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv28, i64 %indvars.iv21
  %arrayidx163.us = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %26, i64 %indvars.iv21
  %arrayidx170.us = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %indvars.iv28, i64 %indvars.iv21
  %arrayidx177.us = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %indvars.iv.next29, i64 %indvars.iv21
  ...
  %arrayidx198.us = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv28, i64 %indvars.iv21
  store double %div194.us, double* %arrayidx198.us, align 8
  %exitcond25 = icmp eq i64 %indvars.iv21, %indvars.iv.lcssa
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  br i1 %exitcond25, label %for.cond140.for.end201_crit_edge.us.loopexit32, label %for.inc199.us.for.inc199.us_crit_edge

for.inc199.us.for.inc199.us_crit_edge:            ; preds = %for.inc199.us
  br label %for.inc199.us
...
for.cond140.for.end201_crit_edge.us:              ; preds = %for.cond140.for.end201_crit_edge.us.loopexit32, %for.cond140.for.end201_crit_edge.us.loopexit
  %arrayidx206.us = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv28, i64 999
