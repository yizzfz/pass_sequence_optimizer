...
for.body.us:                                      ; preds = %for.cond2.for.end_crit_edge.us, %for.body.us.preheader
  %indvars.iv14 = phi i64 [ %6, %for.body.us.preheader ], [ %indvars.iv.next15, %for.cond2.for.end_crit_edge.us ]
  %7 = phi i32 [ %0, %for.body.us.preheader ], [ %2, %for.cond2.for.end_crit_edge.us ]
  %8 = phi i32 [ 0, %for.body.us.preheader ], [ %15, %for.cond2.for.end_crit_edge.us ]
  %rem.us = srem i32 %8, %7
...
for.body5.us:                                     ; preds = %for.body5.us, %for.body.us
  ...
  %9 = mul nsw i64 %indvars.iv14, %indvars.iv
  %10 = add nsw i64 %9, 1
  %11 = trunc i64 %10 to i32
  %rem6.us = srem i32 %11, %2
  %conv7.us = sitofp i32 %rem6.us to double
  %arrayidx13.us = getelementptr inbounds [1300 x double], [1300 x double]* %4, i64 %indvars.iv14, i64 %indvars.iv
  %12 = mul nsw i64 %indvars.iv, %indvars.iv14
  %13 = add nsw i64 %12, 2
  ...
  %arrayidx23.us = getelementptr inbounds [1300 x double], [1300 x double]* %5, i64 %indvars.iv14, i64 %indvars.iv
...
for.cond2.for.end_crit_edge.us:                   ; preds = %for.body5.us
  ...
  %cmp.us = icmp slt i64 %indvars.iv.next15, %3
  %15 = trunc i64 %indvars.iv.next15 to i32
  br i1 %cmp.us, label %for.body.us, label %for.cond.for.end26_crit_edge.loopexit

for.body:                                         ; preds = %for.body.preheader, %for.body
  %inc255 = phi i32 [ %inc25, %for.body ], [ %i.promoted, %for.body.preheader ]
  %16 = phi i32 [ %2, %for.body ], [ %0, %for.body.preheader ]
  %17 = phi i32 [ %inc25, %for.body ], [ 0, %for.body.preheader ]
  %rem = srem i32 %17, %16
  ...
  %inc25 = add nsw i32 %inc255, 1
  %cmp = icmp slt i32 %inc25, %2
  br i1 %cmp, label %for.body, label %for.cond.for.end26_crit_edge.loopexit21

for.cond.for.end26_crit_edge.loopexit:            ; preds = %for.cond2.for.end_crit_edge.us
  %18 = trunc i64 %indvars.iv.next15 to i32
  br label %for.cond.for.end26_crit_edge

for.cond.for.end26_crit_edge.loopexit21:          ; preds = %for.body
  br label %for.cond.for.end26_crit_edge

for.cond.for.end26_crit_edge:                     ; preds = %for.cond.for.end26_crit_edge.loopexit21, %for.cond.for.end26_crit_edge.loopexit
  %inc25.lcssa = phi i32 [ %18, %for.cond.for.end26_crit_edge.loopexit ], [ %inc25, %for.cond.for.end26_crit_edge.loopexit21 ]
...
for.body.us:                                      ; preds = %for.cond5.for.end_crit_edge.us, %for.body.us.preheader
  %indvars.iv9 = phi i64 [ %16, %for.body.us.preheader ], [ %indvars.iv.next10, %for.cond5.for.end_crit_edge.us ]
  %18 = phi i64 [ 0, %for.body.us.preheader ], [ %indvars.iv.next10, %for.cond5.for.end_crit_edge.us ]
...
for.body:                                         ; preds = %if.end, %for.body.lr.ph
  ...
  %8 = phi i32 [ 0, %for.body.lr.ph ], [ %12, %if.end ]
  %rem = srem i32 %8, 20
