...
@__llvm_prf_nm = private constant [42 x i8] c"!(x\DA+*N\8C\CFN\ADLO\CDc,\C9-0\D4\CB\C9\B1JI-\CA,K\8D/*N\04J\14\03\00\D6 \0C\CC", section "__llvm_prf_names"
@llvm.used = appending global [3 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_rsa_keygen to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_derive_rsakeys to i8*), i8* getelementptr inbounds ([42 x i8], [42 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
