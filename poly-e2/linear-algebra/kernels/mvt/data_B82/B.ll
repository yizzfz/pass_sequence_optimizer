...
for.body.lr.ph:
  br label %for.inc.prol.loopexit.for.inc_crit_edge

for.inc.prol.loopexit.for.inc_crit_edge:          ; preds = %for.inc34, %for.body.lr.ph
  %indvars.iv11 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next12, %for.inc34 ]
...
for.inc:                                          ; preds = %for.inc, %for.inc.prol.loopexit.for.inc_crit_edge
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %for.inc ], [ 0, %for.inc.prol.loopexit.for.inc_crit_edge ]
...
for.inc34:                                        ; preds = %for.inc
  ...
  br i1 %13, label %for.end36, label %for.inc.prol.loopexit.for.inc_crit_edge
...
for.cond1.preheader.preheader:
  ...
  %sunkaddr4 = ptrtoint double* %x1 to i64
  br label %for.inc.prol.loopexit.for.inc_crit_edge

for.inc.prol.loopexit.for.inc_crit_edge:          ; preds = %for.cond1.preheader.preheader, %for.inc12
  %indvars.iv31 = phi i64 [ 0, %for.cond1.preheader.preheader ], [ %indvars.iv.next32, %for.inc12 ]
...
for.inc:                                          ; preds = %for.inc, %for.inc.prol.loopexit.for.inc_crit_edge
  %indvars.iv24 = phi i64 [ %indvars.iv.next25.1, %for.inc ], [ 0, %for.inc.prol.loopexit.for.inc_crit_edge ]
  %0 = phi double [ %add.1, %for.inc ], [ %.pre, %for.inc.prol.loopexit.for.inc_crit_edge ]
  %arrayidx7 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv31, i64 %indvars.iv24
  ...
  store double %add, double* %sunkaddr7, align 8
  %indvars.iv.next25 = or i64 %indvars.iv24, 1
  %arrayidx7.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv31, i64 %indvars.iv.next25
  ...
  store double %add.1, double* %sunkaddr7, align 8
  %indvars.iv.next25.1 = add nuw nsw i64 %indvars.iv24, 2
  %exitcond27.1 = icmp eq i64 %indvars.iv.next25.1, 2000
  br i1 %exitcond27.1, label %for.inc12, label %for.inc

for.inc12:                                        ; preds = %for.inc
  %indvars.iv.next32 = add nuw nsw i64 %indvars.iv31, 1
  %exitcond = icmp eq i64 %indvars.iv.next32, 2000
  br i1 %exitcond, label %for.inc33.prol.loopexit.for.inc33_crit_edge.preheader, label %for.inc.prol.loopexit.for.inc_crit_edge

for.inc33.prol.loopexit.for.inc33_crit_edge.preheader: ; preds = %for.inc12
  %sunkaddr8 = ptrtoint double* %x2 to i64
  %sunkaddr12 = ptrtoint double* %x2 to i64
  br label %for.inc33.prol.loopexit.for.inc33_crit_edge

for.inc33.prol.loopexit.for.inc33_crit_edge:      ; preds = %for.inc33.prol.loopexit.for.inc33_crit_edge.preheader, %for.inc36
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc36 ], [ 0, %for.inc33.prol.loopexit.for.inc33_crit_edge.preheader ]
  %sunkaddr9 = shl i64 %indvars.iv21, 3
  %sunkaddr10 = add i64 %sunkaddr8, %sunkaddr9
  %sunkaddr11 = inttoptr i64 %sunkaddr10 to double*
  %.pre20 = load double, double* %sunkaddr11, align 8
  %sunkaddr13 = shl i64 %indvars.iv21, 3
  %sunkaddr14 = add i64 %sunkaddr12, %sunkaddr13
  %sunkaddr15 = inttoptr i64 %sunkaddr14 to double*
  br label %for.inc33

for.inc33:                                        ; preds = %for.inc33, %for.inc33.prol.loopexit.for.inc33_crit_edge
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %for.inc33 ], [ 0, %for.inc33.prol.loopexit.for.inc33_crit_edge ]
  %5 = phi double [ %add30.1, %for.inc33 ], [ %.pre20, %for.inc33.prol.loopexit.for.inc33_crit_edge ]
  ...
  store double %add30, double* %sunkaddr15, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %add30.1, double* %sunkaddr15, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
...
for.inc36:                                        ; preds = %for.inc33
  ...
  %exitcond35 = icmp eq i64 %indvars.iv.next22, 2000
  br i1 %exitcond35, label %for.end38, label %for.inc33.prol.loopexit.for.inc33_crit_edge
...
for.body:                                         ; preds = %if.end, %for.body.preheader
  %indvars.iv13 = phi i64 [ 0, %for.body.preheader ], [ %indvars.iv.next14, %if.end ]
