...
for.body5.prol.loopexit:                          ; preds = %for.body5.preheader, %for.body5.prol
  ...
  %2 = icmp eq i32 %n, 1
  br i1 %2, label %for.end29, label %for.body5.preheader25
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  %indvars.iv19 = phi i64 [ %indvars.iv.next20.1, %for.body ], [ %indvars.iv19.unr, %for.body.preheader ]
  ...
  br i1 %exitcond22.1, label %for.cond2.preheader.loopexit, label %for.body

for.body5:                                        ; preds = %for.body5.preheader25, %for.body5
  %indvars.iv13 = phi i64 [ %indvars.iv.next14.1, %for.body5 ], [ %indvars.iv13.unr, %for.body5.preheader25 ]
  ...
  br i1 %exitcond16.1, label %for.end29.loopexit28, label %for.body5
