...
; <label>:9:                                      ; preds = %.prol.preheader
  %10 = fdiv <2 x double> <double 2.000000e+00, double 3.000000e+00>, %7
...
; <label>:14:                                     ; preds = %14, %.lr.ph.new
  ...
  %33 = icmp slt i64 %indvars.iv.next.1, %8
...
scalar.ph49:                                      ; preds = %scalar.ph49.preheader, %scalar.ph49
  ...
  br i1 %69, label %scalar.ph49, label %.lr.ph4.us.preheader.loopexit, !llvm.loop !10
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load42 = load <2 x double>, <2 x double>* %74, align 8, !alias.scope !11
  ...
  %wide.load45 = load <2 x double>, <2 x double>* %83, align 8, !alias.scope !11
