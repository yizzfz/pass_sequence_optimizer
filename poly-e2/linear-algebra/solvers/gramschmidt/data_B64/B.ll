...
for.inc12.us:                                     ; preds = %for.body3.us
  ...
  br i1 %exitcond28, label %for.cond15.preheader.loopexit, label %for.body3.lr.ph.us
...
for.end.thread:                                   ; preds = %for.cond1.preheader
  %arrayidx1385 = getelementptr inbounds [1200 x double], [1200 x double]* %R, i64 %indvars.iv73, i64 %indvars.iv73
  store double 0.000000e+00, double* %arrayidx1385, align 8
...
for.inc86:                                        ; preds = %for.inc86.loopexit, %for.cond33.preheader, %for.body35.preheader
  %exitcond83 = icmp eq i64 %indvars.iv.next74, %5
  br i1 %exitcond83, label %for.end88.loopexit, label %for.inc86.for.cond1.preheader_crit_edge
