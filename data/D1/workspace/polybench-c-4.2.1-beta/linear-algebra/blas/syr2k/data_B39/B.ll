...
.preheader.us15:                                  ; preds = %.preheader.us15.preheader, %._crit_edge.us18
  ...
  %36 = add nuw nsw i64 %indvars.iv30, 1
...
vector.body64:                                    ; preds = %vector.body64, %vector.ph98
  ...
  %45 = or i64 %index99, 1
  %46 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %index99, i64 %indvars.iv30
  %47 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %45, i64 %indvars.iv30
  ...
  %52 = fmul <2 x double> %51, %broadcast.splat107
  %53 = fmul <2 x double> %52, %41
  %54 = getelementptr inbounds [1000 x double], [1000 x double]* %6, i64 %index99, i64 %indvars.iv30
  %55 = getelementptr inbounds [1000 x double], [1000 x double]* %6, i64 %45, i64 %indvars.iv30
  ...
  %60 = fmul <2 x double> %59, %broadcast.splat107
  ...
  br i1 %67, label %middle.block65, label %vector.body64, !llvm.loop !18
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %._crit_edge9.us
  %indvars.iv134 = phi i2 [ 1, %.lr.ph.us.preheader ], [ %indvars.iv.next135, %._crit_edge9.us ]
  ...
  %68 = zext i2 %indvars.iv134 to i64
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.loopexit, %.lr.ph.us
  ...
  br i1 %80, label %.preheader.us15.preheader, label %.lr.ph.us.new.preheader
...
.lr.ph.us.new.preheader:                          ; preds = %.prol.loopexit
  ...
  br i1 %min.iters.check111, label %.lr.ph.us.new.preheader138, label %min.iters.checked112

.lr.ph.us.new.preheader138:                       ; preds = %middle.block109, %min.iters.checked112, %.lr.ph.us.new.preheader
...
min.iters.checked112:                             ; preds = %.lr.ph.us.new.preheader
  ...
  br i1 %cmp.zero115, label %.lr.ph.us.new.preheader138, label %vector.ph116
...
vector.body108:                                   ; preds = %vector.body108, %vector.ph116
  ...
  %offset.idx122 = add i64 %indvars.iv.unr, %88
  %89 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv37, i64 %offset.idx122
  ...
  %94 = add nsw i64 %offset.idx122, 3
...
middle.block109:                                  ; preds = %vector.body108
  ...
  br i1 %cmp.n121, label %.preheader.us15.preheader, label %.lr.ph.us.new.preheader138
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.preheader3
  %indvars.iv136 = phi i2 [ 1, %.lr.ph.preheader ], [ %indvars.iv.next137, %.preheader3 ]
  ...
  %102 = zext i2 %indvars.iv136 to i64
  %103 = add nuw nsw i64 %102, 4294967295
  %104 = and i64 %103, 4294967295
  %105 = add nuw nsw i64 %104, 1
  %106 = add nsw i64 %indvars.iv53, -3
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %107 = trunc i64 %indvars.iv.next54 to i32
  %xtraiter48 = and i32 %107, 3
...
.prol.preheader46:                                ; preds = %.prol.preheader46.preheader, %.prol.preheader46
  ...
  %108 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %indvars.iv41.prol
...
.prol.loopexit47:                                 ; preds = %.prol.loopexit47.loopexit, %.lr.ph
  %indvars.iv41.unr = phi i64 [ 0, %.lr.ph ], [ %105, %.prol.loopexit47.loopexit ]
  %111 = icmp ult i64 %indvars.iv53, 3
  br i1 %111, label %.preheader3, label %.lr.ph.new.preheader

.lr.ph.new.preheader:                             ; preds = %.prol.loopexit47
  %112 = sub i64 %106, %indvars.iv41.unr
  %113 = lshr i64 %112, 2
  %114 = add nuw nsw i64 %113, 1
  %min.iters.check = icmp ult i64 %114, 2
  br i1 %min.iters.check, label %.lr.ph.new.preheader139, label %min.iters.checked

min.iters.checked:                                ; preds = %.lr.ph.new.preheader
  %n.mod.vf = and i64 %114, 1
  %n.vec = sub nsw i64 %114, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  %115 = add nsw i64 %indvars.iv41.unr, 4
  %116 = shl nuw i64 %113, 2
  %117 = add i64 %115, %116
  %118 = shl nuw nsw i64 %n.mod.vf, 2
  %ind.end = sub i64 %117, %118
  br i1 %cmp.zero, label %.lr.ph.new.preheader139, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %119 = shl i64 %index, 2
  %offset.idx = add i64 %indvars.iv41.unr, %119
  %120 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %offset.idx
  %121 = bitcast double* %120 to <8 x double>*
  %wide.vec = load <8 x double>, <8 x double>* %121, align 8
  ...
  %122 = fmul <2 x double> %strided.vec, %broadcast.splat63
  %123 = fmul <2 x double> %strided.vec59, %broadcast.splat63
  %124 = fmul <2 x double> %strided.vec60, %broadcast.splat63
  %125 = add nsw i64 %offset.idx, 3
  %126 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %125
  %127 = fmul <2 x double> %strided.vec61, %broadcast.splat63
  %128 = getelementptr double, double* %126, i64 -3
  %129 = bitcast double* %128 to <8 x double>*
  %130 = shufflevector <2 x double> %122, <2 x double> %123, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %131 = shufflevector <2 x double> %124, <2 x double> %127, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %interleaved.vec = shufflevector <4 x double> %130, <4 x double> %131, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 1, i32 3, i32 5, i32 7>
  store <8 x double> %interleaved.vec, <8 x double>* %129, align 8
  %index.next = add i64 %index, 2
  %132 = icmp eq i64 %index.next, %n.vec
  br i1 %132, label %middle.block, label %vector.body, !llvm.loop !23

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.mod.vf, 0
  br i1 %cmp.n, label %.preheader3, label %.lr.ph.new.preheader139

.lr.ph.new.preheader139:                          ; preds = %middle.block, %min.iters.checked, %.lr.ph.new.preheader
  %indvars.iv41.ph = phi i64 [ %indvars.iv41.unr, %min.iters.checked ], [ %indvars.iv41.unr, %.lr.ph.new.preheader ], [ %ind.end, %middle.block ]
  br label %.lr.ph.new

.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader139, %.lr.ph.new
  %indvars.iv41 = phi i64 [ %indvars.iv.next42.3, %.lr.ph.new ], [ %indvars.iv41.ph, %.lr.ph.new.preheader139 ]
  %133 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %indvars.iv41
  %134 = load double, double* %133, align 8
  %135 = fmul double %134, %3
  store double %135, double* %133, align 8
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  %136 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %indvars.iv.next42
  %137 = load double, double* %136, align 8
  %138 = fmul double %137, %3
  store double %138, double* %136, align 8
  %indvars.iv.next42.1 = add nsw i64 %indvars.iv41, 2
  %139 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %indvars.iv.next42.1
  %140 = load double, double* %139, align 8
  %141 = fmul double %140, %3
  store double %141, double* %139, align 8
  %indvars.iv.next42.2 = add nsw i64 %indvars.iv41, 3
  %142 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %indvars.iv.next42.2
...
.preheader3:                                      ; preds = %.preheader3.loopexit, %middle.block, %.prol.loopexit47
  ...
  br i1 %exitcond56, label %._crit_edge13.loopexit140, label %.lr.ph

._crit_edge13.loopexit:                           ; preds = %._crit_edge9.us
  br label %._crit_edge13

._crit_edge13.loopexit140:                        ; preds = %.preheader3
  br label %._crit_edge13

._crit_edge13:                                    ; preds = %._crit_edge13.loopexit140, %._crit_edge13.loopexit, %7
  ret void
}
