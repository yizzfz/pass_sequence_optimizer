...
._crit_edge:                                      ; preds = %._crit_edge, %.preheader5.us
  %indvars.iv30 = phi i64 [ 0, %.preheader5.us ], [ %indvars.iv.next31, %._crit_edge ]
  %22 = mul nsw i64 %indvars.iv34, %indvars.iv30
  %23 = add nsw i64 %22, 1
  %24 = trunc i64 %23 to i32
  %25 = srem i32 %24, %16
  %26 = sitofp i32 %25 to double
  %27 = fdiv double %26, %17
  %28 = getelementptr inbounds [1000 x double], [1000 x double]* %18, i64 %indvars.iv34, i64 %indvars.iv30
  store double %27, double* %28, align 8
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  %exitcond = icmp eq i64 %indvars.iv.next31, %21
  br i1 %exitcond, label %._crit_edge15.us, label %._crit_edge

._crit_edge15.us:                                 ; preds = %._crit_edge
  %indvars.iv.next35 = add nsw i64 %indvars.iv34, 1
  %29 = icmp slt i64 %indvars.iv.next35, %20
...
.preheader.lr.ph:                                 ; preds = %.preheader4
  ...
  br i1 %32, label %.preheader.us.preheader, label %._crit_edge9.loopexit23
...
.preheader.us:                                    ; preds = %._crit_edge.us, %.preheader.us.preheader
  %indvars.iv28 = phi i64 [ %36, %.preheader.us.preheader ], [ %indvars.iv.next29, %._crit_edge.us ]
  br label %._crit_edge39

._crit_edge39:                                    ; preds = %._crit_edge39, %.preheader.us
  %indvars.iv = phi i64 [ 0, %.preheader.us ], [ %indvars.iv.next, %._crit_edge39 ]
  %39 = mul nsw i64 %indvars.iv28, %indvars.iv
  %40 = add nsw i64 %39, 2
  %41 = trunc i64 %40 to i32
  %42 = srem i32 %41, %33
  %43 = sitofp i32 %42 to double
  %44 = fdiv double %43, %34
  %45 = getelementptr inbounds [1200 x double], [1200 x double]* %35, i64 %indvars.iv28, i64 %indvars.iv
  store double %44, double* %45, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond40 = icmp eq i64 %indvars.iv.next, %38
  br i1 %exitcond40, label %._crit_edge.us, label %._crit_edge39

._crit_edge.us:                                   ; preds = %._crit_edge39
  %indvars.iv.next29 = add nsw i64 %indvars.iv28, 1
  %46 = icmp slt i64 %indvars.iv.next29, %37
  br i1 %46, label %.preheader.us, label %._crit_edge9.loopexit

._crit_edge9.loopexit:                            ; preds = %._crit_edge.us
  %47 = trunc i64 %indvars.iv.next29 to i32
...
._crit_edge9:                                     ; preds = %._crit_edge9.loopexit23, %._crit_edge9.loopexit
  %.lcssa12 = phi i32 [ %47, %._crit_edge9.loopexit ], [ %smax, %._crit_edge9.loopexit23 ]
...
.preheader5.preheader:                            ; preds = %.preheader5.lr.ph
  %broadcast.splatinsert77 = insertelement <2 x double> undef, double %22, i32 0
...
.preheader5.us.preheader:                         ; preds = %.preheader5.lr.ph
  ...
  %broadcast.splatinsert102 = insertelement <2 x double> undef, double %22, i32 0
...
.preheader5.us:                                   ; preds = %._crit_edge11.us..preheader5.us_crit_edge, %.preheader5.us.preheader
  %indvars.iv69 = phi i2 [ %indvars.iv.next70, %._crit_edge11.us..preheader5.us_crit_edge ], [ %26, %.preheader5.us.preheader ]
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %._crit_edge11.us..preheader5.us_crit_edge ], [ %24, %.preheader5.us.preheader ]
  %indvars.iv40 = phi i32 [ %indvars.iv.next41, %._crit_edge11.us..preheader5.us_crit_edge ], [ %23, %.preheader5.us.preheader ]
  %indvar = phi i32 [ %indvar.next, %._crit_edge11.us..preheader5.us_crit_edge ], [ 0, %.preheader5.us.preheader ]
  %28 = add i32 %23, %indvar
  %29 = zext i32 %28 to i64
  %30 = zext i2 %indvars.iv69 to i64
...
.lr.ph.us.prol.loopexit:                          ; preds = %.lr.ph.us.prol.loopexit.loopexit, %.lr.ph.us.preheader
  ...
  br i1 %41, label %.preheader.lr.ph.us, label %.lr.ph.us.preheader66

.lr.ph.us.preheader66:                            ; preds = %.lr.ph.us.prol.loopexit
  %wide.trip.count.3 = zext i32 %indvars.iv40 to i64
  %42 = add nsw i64 %29, -4
  %43 = sub nsw i64 %42, %indvars.iv.unr
  %44 = lshr i64 %43, 2
  %45 = add nuw nsw i64 %44, 1
  %min.iters.check82 = icmp ult i64 %45, 2
  br i1 %min.iters.check82, label %.lr.ph.us.preheader105, label %min.iters.checked83

min.iters.checked83:                              ; preds = %.lr.ph.us.preheader66
  %n.mod.vf84 = and i64 %45, 1
  %n.vec85 = sub nsw i64 %45, %n.mod.vf84
  %cmp.zero86 = icmp eq i64 %n.vec85, 0
  %46 = add nsw i64 %indvars.iv.unr, 4
  %47 = shl nuw i64 %44, 2
  %48 = add i64 %46, %47
  %49 = shl nuw nsw i64 %n.mod.vf84, 2
  %ind.end91 = sub i64 %48, %49
  br i1 %cmp.zero86, label %.lr.ph.us.preheader105, label %vector.ph87

vector.ph87:                                      ; preds = %min.iters.checked83
  br label %vector.body79

vector.body79:                                    ; preds = %vector.body79, %vector.ph87
  %index88 = phi i64 [ 0, %vector.ph87 ], [ %index.next89, %vector.body79 ]
  %50 = shl i64 %index88, 2
  ...
  %wide.vec97 = load <8 x double>, <8 x double>* %53, align 8
  %strided.vec98 = shufflevector <8 x double> %wide.vec97, <8 x double> undef, <2 x i32> <i32 0, i32 4>
  %strided.vec99 = shufflevector <8 x double> %wide.vec97, <8 x double> undef, <2 x i32> <i32 1, i32 5>
  %strided.vec100 = shufflevector <8 x double> %wide.vec97, <8 x double> undef, <2 x i32> <i32 2, i32 6>
  %strided.vec101 = shufflevector <8 x double> %wide.vec97, <8 x double> undef, <2 x i32> <i32 3, i32 7>
  %54 = fmul <2 x double> %broadcast.splat103, %strided.vec98
  %55 = fmul <2 x double> %broadcast.splat103, %strided.vec99
  %56 = fmul <2 x double> %broadcast.splat103, %strided.vec100
  %57 = add nsw i64 %51, 3
  %58 = getelementptr inbounds [1200 x double], [1200 x double]* %20, i64 %indvars.iv50, i64 %57
  %59 = fmul <2 x double> %broadcast.splat103, %strided.vec101
  ...
  %interleaved.vec104 = shufflevector <4 x double> %62, <4 x double> %63, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 1, i32 3, i32 5, i32 7>
  store <8 x double> %interleaved.vec104, <8 x double>* %61, align 8
  %index.next89 = add i64 %index88, 2
  %64 = icmp eq i64 %index.next89, %n.vec85
  br i1 %64, label %middle.block80, label %vector.body79, !llvm.loop !3

middle.block80:                                   ; preds = %vector.body79
  %cmp.n92 = icmp eq i64 %n.mod.vf84, 0
  br i1 %cmp.n92, label %.preheader.lr.ph.us, label %.lr.ph.us.preheader105

.lr.ph.us.preheader105:                           ; preds = %middle.block80, %min.iters.checked83, %.lr.ph.us.preheader66
  %indvars.iv.ph = phi i64 [ %indvars.iv.unr, %min.iters.checked83 ], [ %indvars.iv.unr, %.lr.ph.us.preheader66 ], [ %ind.end91, %middle.block80 ]
  br label %.lr.ph.us

.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader105, %.lr.ph.us
  %indvars.iv = phi i64 [ %indvars.iv.next.3, %.lr.ph.us ], [ %indvars.iv.ph, %.lr.ph.us.preheader105 ]
...
._crit_edge65:                                    ; preds = %._crit_edge65, %._crit_edge65.preheader
  %indvars.iv38 = phi i64 [ %indvars.iv.next39.1, %._crit_edge65 ], [ %indvars.iv38.unr.ph, %._crit_edge65.preheader ]
  ...
  br i1 %exitcond.1, label %._crit_edge.us27.loopexit, label %._crit_edge65
...
.prol.loopexit:                                   ; preds = %.preheader.us25, %.prol.preheader
  ...
  br i1 %105, label %._crit_edge.us27, label %._crit_edge65.preheader

._crit_edge65.preheader:                          ; preds = %.prol.loopexit
...
._crit_edge.us27.loopexit:                        ; preds = %._crit_edge65
  br label %._crit_edge.us27

._crit_edge.us27:                                 ; preds = %._crit_edge.us27.loopexit, %.prol.loopexit
  %indvars.iv.next47 = add nuw nsw i64 %indvars.iv46, 1
  %exitcond71 = icmp eq i64 %indvars.iv.next47, %27
  br i1 %exitcond71, label %._crit_edge11.us.loopexit, label %.preheader.us25

.preheader.lr.ph.us.loopexit:                     ; preds = %.lr.ph.us
  br label %.preheader.lr.ph.us

.preheader.lr.ph.us:                              ; preds = %.preheader.lr.ph.us.loopexit, %middle.block80, %.lr.ph.us.prol.loopexit
...
.preheader5:                                      ; preds = %.preheader5.preheader, %.preheader4..preheader5_crit_edge
  %indvars.iv72 = phi i2 [ %indvars.iv.next73, %.preheader4..preheader5_crit_edge ], [ %26, %.preheader5.preheader ]
  ...
  %110 = zext i2 %indvars.iv72 to i64
...
.lr.ph.prol.loopexit:                             ; preds = %.lr.ph.prol.loopexit.loopexit, %.lr.ph.preheader
  ...
  br i1 %120, label %.preheader4, label %.lr.ph.preheader67

.lr.ph.preheader67:                               ; preds = %.lr.ph.prol.loopexit
  ...
  br i1 %min.iters.check, label %.lr.ph.preheader106, label %min.iters.checked

min.iters.checked:                                ; preds = %.lr.ph.preheader67
  ...
  br i1 %cmp.zero, label %.lr.ph.preheader106, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %133 = fmul <2 x double> %broadcast.splat78, %strided.vec
  %134 = fmul <2 x double> %broadcast.splat78, %strided.vec74
  %135 = fmul <2 x double> %broadcast.splat78, %strided.vec75
  %136 = add nsw i64 %130, 3
  %137 = getelementptr inbounds [1200 x double], [1200 x double]* %20, i64 %indvars.iv63, i64 %136
  %138 = fmul <2 x double> %broadcast.splat78, %strided.vec76
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %.preheader4, label %.lr.ph.preheader106

.lr.ph.preheader106:                              ; preds = %middle.block, %min.iters.checked, %.lr.ph.preheader67
  %indvars.iv52.ph = phi i64 [ %indvars.iv52.unr, %min.iters.checked ], [ %indvars.iv52.unr, %.lr.ph.preheader67 ], [ %ind.end, %middle.block ]
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader106, %.lr.ph
  %indvars.iv52 = phi i64 [ %indvars.iv.next53.3, %.lr.ph ], [ %indvars.iv52.ph, %.lr.ph.preheader106 ]
...
.preheader4:                                      ; preds = %.preheader4.loopexit, %middle.block, %.lr.ph.prol.loopexit, %.preheader5
  ...
  br i1 %156, label %.preheader4..preheader5_crit_edge, label %._crit_edge16.loopexit107
...
._crit_edge16.loopexit107:                        ; preds = %.preheader4
  br label %._crit_edge16

._crit_edge16:                                    ; preds = %._crit_edge16.loopexit107, %._crit_edge16.loopexit
  %.lcssa20.in = phi i64 [ %indvars.iv.next51, %._crit_edge16.loopexit ], [ %indvars.iv.next64, %._crit_edge16.loopexit107 ]
...
.preheader.lr.ph:                                 ; preds = %2
  ...
  %.promoted6 = load i32, i32* %5, align 4
  br i1 %13, label %.preheader.us.preheader, label %._crit_edge5.loopexit10

.preheader.us.preheader:                          ; preds = %.preheader.lr.ph
  %15 = sext i32 %.promoted6 to i64
...
.preheader.us:                                    ; preds = %._crit_edge3.us, %.preheader.us.preheader
  %indvars.iv12 = phi i64 [ %15, %.preheader.us.preheader ], [ %indvars.iv.next13, %._crit_edge3.us ]
  %19 = mul nsw i64 %indvars.iv12, %16
...
._crit_edge.us._crit_edge:                        ; preds = %._crit_edge.us, %.preheader.us
  ...
  %22 = srem i32 %21, 20
  %23 = icmp eq i32 %22, 0
  br i1 %23, label %24, label %._crit_edge.us

; <label>:24:                                     ; preds = %._crit_edge.us._crit_edge
  %25 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %fputc.us = tail call i32 @fputc(i32 10, %struct._IO_FILE* %25) #5
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.us._crit_edge, %24
  %26 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %27 = getelementptr inbounds [1200 x double], [1200 x double]* %14, i64 %indvars.iv12, i64 %indvars.iv
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond14 = icmp eq i64 %indvars.iv.next, %18
  br i1 %exitcond14, label %._crit_edge3.us, label %._crit_edge.us._crit_edge

._crit_edge3.us:                                  ; preds = %._crit_edge.us
  %indvars.iv.next13 = add nsw i64 %indvars.iv12, 1
  %30 = icmp slt i64 %indvars.iv.next13, %17
  br i1 %30, label %.preheader.us, label %._crit_edge5.loopexit

._crit_edge5.loopexit:                            ; preds = %._crit_edge3.us
  %31 = trunc i64 %indvars.iv.next13 to i32
  br label %._crit_edge5

._crit_edge5.loopexit10:                          ; preds = %.preheader.lr.ph
  %32 = add i32 %.promoted6, 1
  %33 = icmp sgt i32 %12, %32
  %smax = select i1 %33, i32 %12, i32 %32
  br label %._crit_edge5

._crit_edge5:                                     ; preds = %._crit_edge5.loopexit10, %._crit_edge5.loopexit
  %.lcssa7 = phi i32 [ %31, %._crit_edge5.loopexit ], [ %smax, %._crit_edge5.loopexit10 ]
