...
.lr.ph4.split.us:                                 ; preds = %.lr.ph4.split.us.preheader, %._crit_edge.us
  %3 = phi i32 [ %23, %._crit_edge.us ], [ 0, %.lr.ph4.split.us.preheader ]
  %4 = srem i32 %3, 2100
...
._crit_edge.us:                                   ; preds = %9
  ...
  br i1 %24, label %.lr.ph4.split.us, label %._crit_edge5
...
; <label>:25:                                     ; preds = %25, %.lr.ph10
  ...
  %35 = fdiv <2 x double> %34, <double 1.900000e+03, double 1.900000e+03>
  ...
  %37 = icmp slt i64 %indvars.iv.next19.1, 1900
  br i1 %37, label %25, label %.lr.ph4.split.us.preheader

.lr.ph4.split.us.preheader:                       ; preds = %25
...
; <label>:6:                                      ; preds = %.lr.ph7, %12
  %indvars.iv12 = phi i64 [ 0, %.lr.ph7 ], [ %indvars.iv.next13, %12 ]
...
; <label>:12:                                     ; preds = %10, %6
  ...
  %14 = getelementptr inbounds double, double* %0, i64 %indvars.iv12
  ...
  %17 = icmp slt i64 %indvars.iv.next13, 1900
  br i1 %17, label %6, label %._crit_edge8
...
; <label>:22:                                     ; preds = %._crit_edge8, %28
  %indvars.iv = phi i64 [ 0, %._crit_edge8 ], [ %indvars.iv.next, %28 ]
