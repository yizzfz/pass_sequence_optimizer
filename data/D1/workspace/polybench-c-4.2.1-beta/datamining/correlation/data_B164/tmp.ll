...
.lr.ph55.split.us:                                ; preds = %._crit_edge52.us, %.lr.ph55.split.us.preheader
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %._crit_edge52.us ], [ 0, %.lr.ph55.split.us.preheader ]
  %10 = getelementptr inbounds double, double* %3, i64 %indvars.iv18
  store double 0.000000e+00, double* %10, align 8
  %sunkaddr127 = shl i64 %indvars.iv18, 3
  %sunkaddr128 = add i64 %sunkaddr, %sunkaddr127
  %sunkaddr129 = inttoptr i64 %sunkaddr128 to double*
  br label %11

; <label>:11:                                     ; preds = %11, %.lr.ph55.split.us
  %indvars.iv109 = phi i64 [ 0, %.lr.ph55.split.us ], [ %indvars.iv.next110.1.1, %11 ]
  %12 = phi double [ 0.000000e+00, %.lr.ph55.split.us ], [ %24, %11 ]
  %13 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv109, i64 %indvars.iv18
  %14 = load double, double* %13, align 8
  %15 = fadd double %14, %12
  store double %15, double* %sunkaddr129, align 8
  %indvars.iv.next110 = or i64 %indvars.iv109, 1
  %16 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next110, i64 %indvars.iv18
  %17 = load double, double* %16, align 8
  %18 = fadd double %17, %15
  store double %18, double* %sunkaddr129, align 8
  %indvars.iv.next110.1 = or i64 %indvars.iv109, 2
  %19 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next110.1, i64 %indvars.iv18
  %20 = load double, double* %19, align 8
  %21 = fadd double %20, %18
  store double %21, double* %sunkaddr129, align 8
  %indvars.iv.next110.140 = or i64 %indvars.iv109, 3
  %22 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next110.140, i64 %indvars.iv18
  %23 = load double, double* %22, align 8
  %24 = fadd double %23, %21
  store double %24, double* %sunkaddr129, align 8
  %indvars.iv.next110.1.1 = add nsw i64 %indvars.iv109, 4
  %exitcond111.1.1 = icmp eq i64 %indvars.iv.next110.1.1, 1400
  br i1 %exitcond111.1.1, label %._crit_edge52.us, label %11

._crit_edge52.us:                                 ; preds = %11
  %25 = fdiv double %24, %0
  store double %25, double* %sunkaddr129, align 8
  %indvars.iv.next19 = add nuw nsw i64 %indvars.iv18, 1
  %exitcond20 = icmp eq i64 %indvars.iv.next19, 1200
  br i1 %exitcond20, label %.lr.ph49.split.us.preheader, label %.lr.ph55.split.us
...
.lr.ph49.split.us:                                ; preds = %._crit_edge47.us, %.lr.ph49.split.us.preheader
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %._crit_edge47.us ], [ 0, %.lr.ph49.split.us.preheader ]
  ...
  %sunkaddr135 = shl i64 %indvars.iv15, 3
  %sunkaddr30 = add i64 %sunkaddr, %sunkaddr135
  %sunkaddr31 = inttoptr i64 %sunkaddr30 to double*
  %sunkaddr138 = ptrtoint double* %28 to i64
  %sunkaddr140 = add i64 %sunkaddr138, %sunkaddr135
  %sunkaddr141 = inttoptr i64 %sunkaddr140 to double*
  br label %30

; <label>:30:                                     ; preds = %30, %.lr.ph49.split.us
  %indvars.iv103 = phi i64 [ 0, %.lr.ph49.split.us ], [ %indvars.iv.next104.1, %30 ]
  %31 = phi double [ 0.000000e+00, %.lr.ph49.split.us ], [ %43, %30 ]
  %32 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv103, i64 %indvars.iv15
  %33 = load double, double* %32, align 8
  %34 = load double, double* %sunkaddr31, align 8
  %35 = fsub double %33, %34
  %36 = fmul double %35, %35
  %37 = fadd double %36, %31
  store double %37, double* %sunkaddr141, align 8
  %indvars.iv.next104 = or i64 %indvars.iv103, 1
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next104, i64 %indvars.iv15
  %39 = load double, double* %38, align 8
  %40 = load double, double* %sunkaddr31, align 8
  %41 = fsub double %39, %40
  %42 = fmul double %41, %41
  %43 = fadd double %42, %37
  store double %43, double* %sunkaddr141, align 8
  %indvars.iv.next104.1 = add nuw nsw i64 %indvars.iv103, 2
  %exitcond105.1 = icmp eq i64 %indvars.iv.next104.1, 1400
  br i1 %exitcond105.1, label %._crit_edge47.us, label %30

._crit_edge47.us:                                 ; preds = %30
  %44 = fdiv double %43, %0
  store double %44, double* %sunkaddr141, align 8
  ...
  br i1 %exitcond17, label %._crit_edge11.us.preheader, label %.lr.ph49.split.us

._crit_edge11.us.preheader:                       ; preds = %._crit_edge47.us
  br label %._crit_edge11.us

._crit_edge11.us:                                 ; preds = %._crit_edge42.us, %._crit_edge11.us.preheader
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %._crit_edge42.us ], [ 0, %._crit_edge11.us.preheader ]
  %50 = phi [1200 x double]* [ %64, %._crit_edge42.us ], [ %1, %._crit_edge11.us.preheader ]
  br label %51

; <label>:51:                                     ; preds = %51, %._crit_edge11.us
  %indvars.iv99 = phi i64 [ 0, %._crit_edge11.us ], [ %indvars.iv.next100, %51 ]
  %52 = phi [1200 x double]* [ %50, %._crit_edge11.us ], [ %64, %51 ]
  %53 = getelementptr inbounds double, double* %3, i64 %indvars.iv99
  %54 = load double, double* %53, align 8
  %55 = getelementptr inbounds [1200 x double], [1200 x double]* %52, i64 %indvars.iv12, i64 %indvars.iv99
  ...
  %61 = getelementptr inbounds double, double* %60, i64 %indvars.iv99
  %62 = load double, double* %61, align 8
  %63 = fmul double %59, %62
  %64 = load [1200 x double]*, [1200 x double]** %6, align 8
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %64, i64 %indvars.iv12, i64 %indvars.iv99
  %66 = load double, double* %65, align 8
  %67 = fdiv double %66, %63
  store double %67, double* %65, align 8
  %indvars.iv.next100 = add nuw nsw i64 %indvars.iv99, 1
  %exitcond101 = icmp eq i64 %indvars.iv.next100, 1200
  br i1 %exitcond101, label %._crit_edge42.us, label %51
...
.lr.ph.us.us.preheader:                           ; preds = %._crit_edge29.us-lcssa.us.us, %.lr.ph.us.us.preheader.preheader
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %._crit_edge29.us-lcssa.us.us ], [ 0, %.lr.ph.us.us.preheader.preheader ]
...
._crit_edge29.us-lcssa.us.us:                     ; preds = %._crit_edge24.us.us
  ...
  br i1 %exitcond11, label %._crit_edge31, label %.lr.ph.us.us.preheader
