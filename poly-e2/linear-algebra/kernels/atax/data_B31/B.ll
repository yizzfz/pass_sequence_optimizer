...
for.body:                                         ; preds = %for.body, %entry
  %indvars.iv19 = phi i64 [ 0, %entry ], [ %indvars.iv.next20.2, %for.body ]
  ...
  %3 = trunc i64 %indvars.iv.next20.1 to i32
  %conv2.2 = sitofp i32 %3 to double
  %div.2 = fdiv double %conv2.2, 2.100000e+03
  %add.2 = fadd double %div.2, 1.000000e+00
  %arrayidx.2 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next20.1
  store double %add.2, double* %arrayidx.2, align 8
  %indvars.iv.next20.2 = add nsw i64 %indvars.iv19, 3
  %exitcond21.2 = icmp eq i64 %indvars.iv.next20.1, 2099
  br i1 %exitcond21.2, label %for.body6.us.preheader, label %for.body
...
for.body5.us.preheader:                           ; preds = %vector.body
  ...
  %scevgep90 = getelementptr double, double* %y, i64 2100
  br label %for.body5.us

for.body5.us:                                     ; preds = %for.inc42.us, %for.body5.us.preheader
  %indvars.iv65 = phi i64 [ 0, %for.body5.us.preheader ], [ %29, %for.inc42.us ]
  %scevgep92 = getelementptr [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 1
  %29 = add i64 %indvars.iv65, 1
  %scevgep94 = getelementptr [2100 x double], [2100 x double]* %A, i64 %29, i64 0
...
for.body26.us.for.body26.us_crit_edge:            ; preds = %for.body26.us.for.body26.us_crit_edge, %for.body26.us.for.body26.us_crit_edge.preheader.new
  %indvars.iv6382 = phi i64 [ %indvars.iv6382.ph, %for.body26.us.for.body26.us_crit_edge.preheader.new ], [ %indvars.iv.next64.1, %for.body26.us.for.body26.us_crit_edge ]
  ...
  %indvars.iv.next64.1 = add nsw i64 %indvars.iv6382, 2
  ...
  %exitcond72.1 = icmp eq i64 %indvars.iv.next64.1, 2099
  br i1 %exitcond72.1, label %for.inc42.us, label %for.body26.us.for.body26.us_crit_edge, !llvm.loop !4
...
for.body26.us.preheader:                          ; preds = %for.body10.us
  ...
  %arrayidx32.us79 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 0
  %42 = load double, double* %arrayidx32.us79, align 8
  %mul35.us80 = fmul double %42, %add.us.2
  %add36.us81 = fadd double %41, %mul35.us80
  store double %add36.us81, double* %y, align 8
  %bound0 = icmp ult double* %scevgep, %arrayidx12.us
  %bound1 = icmp ult double* %arrayidx12.us, %scevgep90
  %found.conflict = and i1 %bound0, %bound1
  %bound097 = icmp ult double* %scevgep, %scevgep94
  %bound198 = icmp ult double* %scevgep92, %scevgep90
  %found.conflict99 = and i1 %bound097, %bound198
  %conflict.rdx = or i1 %found.conflict, %found.conflict99
  br i1 %conflict.rdx, label %for.body26.us.for.body26.us_crit_edge.preheader.new, label %vector.body84.preheader

vector.body84.preheader:                          ; preds = %for.body26.us.preheader
  br label %vector.body84

for.body26.us.for.body26.us_crit_edge.preheader.new.loopexit: ; preds = %vector.body84
...
for.body26.us.for.body26.us_crit_edge.preheader.new: ; preds = %for.body26.us.for.body26.us_crit_edge.preheader.new.loopexit, %for.body26.us.preheader
  %indvars.iv6382.ph = phi i64 [ 1, %for.body26.us.preheader ], [ 2097, %for.body26.us.for.body26.us_crit_edge.preheader.new.loopexit ]
  %.pre71.prol = load double, double* %arrayidx12.us, align 8
  %arrayidx28.us.prol = getelementptr inbounds double, double* %y, i64 %indvars.iv6382.ph
  %43 = load double, double* %arrayidx28.us.prol, align 8
  %arrayidx32.us.prol = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 %indvars.iv6382.ph
...
vector.body84:                                    ; preds = %vector.body84.preheader, %vector.body84
  %index101 = phi i64 [ %index.next102, %vector.body84 ], [ 0, %vector.body84.preheader ]
  %45 = or i64 %index101, 1
  %46 = load double, double* %arrayidx12.us, align 8, !alias.scope !5
  %47 = insertelement <2 x double> undef, double %46, i32 0
  %48 = shufflevector <2 x double> %47, <2 x double> undef, <2 x i32> zeroinitializer
  %49 = getelementptr inbounds double, double* %y, i64 %45
  %50 = bitcast double* %49 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %50, align 8, !alias.scope !8, !noalias !10
  %51 = getelementptr double, double* %49, i64 2
  %52 = bitcast double* %51 to <2 x double>*
  %wide.load109 = load <2 x double>, <2 x double>* %52, align 8, !alias.scope !8, !noalias !10
  %53 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 %45
  %54 = bitcast double* %53 to <2 x double>*
  %wide.load110 = load <2 x double>, <2 x double>* %54, align 8, !alias.scope !12
  %55 = getelementptr double, double* %53, i64 2
  %56 = bitcast double* %55 to <2 x double>*
  %wide.load111 = load <2 x double>, <2 x double>* %56, align 8, !alias.scope !12
  %57 = fmul <2 x double> %wide.load110, %48
  %58 = fmul <2 x double> %wide.load111, %48
  %59 = fadd <2 x double> %wide.load, %57
  %60 = fadd <2 x double> %wide.load109, %58
  store <2 x double> %59, <2 x double>* %50, align 8, !alias.scope !8, !noalias !10
  store <2 x double> %60, <2 x double>* %52, align 8, !alias.scope !8, !noalias !10
  %index.next102 = add i64 %index101, 4
  %61 = icmp eq i64 %index.next102, 2096
  br i1 %61, label %for.body26.us.for.body26.us_crit_edge.preheader.new.loopexit, label %vector.body84, !llvm.loop !13
