...
entry:
  ...
  call fastcc void @init_array(i32 1000, i32 1200, double* nonnull %alpha, double* nonnull %beta, [1200 x double]* %arraydecay1, [1000 x double]* %arraydecay32, [1200 x double]* %arraydecay43)
  call void (...) @polybench_timer_start() #4
  %0 = load double, double* %alpha, align 8
  %1 = load double, double* %beta, align 8
  call fastcc void @kernel_symm(i32 1000, i32 1200, double %0, double %1, [1200 x double]* %arraydecay1, [1000 x double]* %arraydecay32, [1200 x double]* %arraydecay43)
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc16_crit_edge.us, %entry
  %indvars.iv62 = phi i64 [ 0, %entry ], [ %indvars.iv.next63, %for.cond1.for.inc16_crit_edge.us ]
...
for.body3.us:                                     ; preds = %for.body3.us, %for.cond1.preheader.us
  ...
  br i1 %exitcond61, label %for.cond1.for.inc16_crit_edge.us, label %for.body3.us
...
for.cond19.loopexit:                              ; preds = %for.cond19.loopexit.loopexit, %middle.block, %for.body43.prol.loopexit, %for.end38
  ...
  %exitcond57 = icmp eq i64 %7, 1000
  br i1 %exitcond57, label %for.end53, label %for.body26.lr.ph

for.body26.lr.ph:                                 ; preds = %for.body26.lr.ph.preheader, %for.cond19.loopexit
  %indvars.iv54 = phi i64 [ %7, %for.cond19.loopexit ], [ 0, %for.body26.lr.ph.preheader ]
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.cond19.loopexit ], [ 1, %for.body26.lr.ph.preheader ]
  %5 = sub i64 1007, %indvars.iv54
  %6 = sub i64 998, %indvars.iv54
  %7 = add i64 %indvars.iv54, 1
...
for.body26:                                       ; preds = %for.body26.preheader, %for.body26
  ...
  %10 = add nuw nsw i64 %indvars.iv, %indvars.iv54
  ...
  %12 = add nuw nsw i64 %indvars.iv.next, %indvars.iv54
...
for.body43.prol:                                  ; preds = %for.body43.prol.preheader, %for.body43.prol
  %indvars.iv48.prol = phi i64 [ %indvars.iv.next49.prol, %for.body43.prol ], [ %indvars.iv52, %for.body43.prol.preheader ]
  %prol.iter = phi i64 [ %prol.iter.sub, %for.body43.prol ], [ %xtraiter68, %for.body43.prol.preheader ]
...
for.body43.prol.loopexit:                         ; preds = %for.body43.prol.loopexit.loopexit, %for.body43.lr.ph
  %indvars.iv48.unr = phi i64 [ %indvars.iv52, %for.body43.lr.ph ], [ %indvars.iv.next49.prol, %for.body43.prol.loopexit.loopexit ]
  %15 = icmp ult i64 %6, 7
  br i1 %15, label %for.cond19.loopexit, label %for.body43.preheader

for.body43.preheader:                             ; preds = %for.body43.prol.loopexit
  %16 = sub i64 992, %indvars.iv48.unr
  %17 = lshr i64 %16, 3
  %18 = add nuw nsw i64 %17, 1
  %min.iters.check = icmp ult i64 %18, 2
  br i1 %min.iters.check, label %for.body43.preheader71, label %min.iters.checked

min.iters.checked:                                ; preds = %for.body43.preheader
  %n.mod.vf = and i64 %18, 1
  %n.vec = sub nsw i64 %18, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  %19 = add i64 %indvars.iv48.unr, 8
  %20 = shl nuw i64 %17, 3
  %21 = add i64 %19, %20
  %22 = shl nuw nsw i64 %n.mod.vf, 3
  %ind.end = sub i64 %21, %22
  br i1 %cmp.zero, label %for.body43.preheader71, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %23 = shl i64 %index, 3
  %24 = add i64 %indvars.iv48.unr, %23
  %25 = add nsw i64 %24, 7
  %26 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv54, i64 %25
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.cond19.loopexit, label %for.body43.preheader71

for.body43.preheader71:                           ; preds = %middle.block, %min.iters.checked, %for.body43.preheader
  %indvars.iv48.ph = phi i64 [ %indvars.iv48.unr, %min.iters.checked ], [ %indvars.iv48.unr, %for.body43.preheader ], [ %ind.end, %middle.block ]
  br label %for.body43

for.body43:                                       ; preds = %for.body43.preheader71, %for.body43
  %indvars.iv48 = phi i64 [ %indvars.iv.next49.7, %for.body43 ], [ %indvars.iv48.ph, %for.body43.preheader71 ]
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc void @kernel_symm(i32 %m, i32 %n, double %alpha, double %beta, [1200 x double]* %C, [1000 x double]* readonly %A, [1200 x double]* readonly %B) unnamed_addr #2 {
entry:
...
for.cond4.preheader.us72:                         ; preds = %for.cond4.preheader.us72, %for.cond4.preheader.us72.preheader
  ...
  br i1 %exitcond.1, label %for.cond1.for.inc53_crit_edge.us.loopexit126, label %for.cond4.preheader.us72, !llvm.loop !17
...
for.cond1.for.inc53_crit_edge.us.loopexit126:     ; preds = %for.cond4.preheader.us72
  br label %for.cond1.for.inc53_crit_edge.us
...
for.cond4.preheader.us.us:                        ; preds = %for.cond4.preheader.us.us.preheader, %for.cond4.for.end_crit_edge.us.us
  %indvars.iv91 = phi i64 [ %indvars.iv.next92, %for.cond4.for.end_crit_edge.us.us ], [ 0, %for.cond4.preheader.us.us.preheader ]
...
for.body6.us.us:                                  ; preds = %for.body6.us.us, %for.cond4.preheader.us.us
  %indvars.iv85 = phi i64 [ %indvars.iv.next86, %for.body6.us.us ], [ 0, %for.cond4.preheader.us.us ]
