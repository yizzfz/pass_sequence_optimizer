...
@__llvm_prf_nm = private constant [153 x i8] c"\96\01\00TIFFInitLZW\01tmp1.ll:LZWSetupDecode\01tmp1.ll:LZWPreDecode\01tmp1.ll:LZWDecode\01tmp1.ll:_LZWtrue\01tmp1.ll:LZWCleanup\01tmp1.ll:LZWDecodeCompat\01tmp1.ll:codeLoop", section "__llvm_prf_names"
@llvm.used = appending global [10 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_TIFFInitLZW to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_LZWSetupDecode to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_LZWPreDecode to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_LZWDecode to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll__LZWtrue to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_LZWCleanup to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_LZWDecodeCompat to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_codeLoop to i8*), i8* bitcast ([10 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([153 x i8], [153 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
