...
for.body:                                         ; preds = %for.end.for.body_crit_edge, %entry
  %indvars.iv47 = phi i64 [ 0, %entry ], [ %indvars.iv.next5, %for.end.for.body_crit_edge ]
...
for.body5:                                        ; preds = %for.body5.for.body5_crit_edge, %for.body
  %indvars.iv6 = phi i64 [ 0, %for.body ], [ %indvars.iv.next, %for.body5.for.body5_crit_edge ]
...
for.end:                                          ; preds = %for.body5
  ...
  br i1 %exitcond9, label %for.end26, label %for.end.for.body_crit_edge
...
for.body:                                         ; preds = %for.end.for.body_crit_edge, %entry
  %1 = phi double* [ %y, %entry ], [ %15, %for.end.for.body_crit_edge ]
  %indvars.iv111 = phi i64 [ 0, %entry ], [ %indvars.iv.next2, %for.end.for.body_crit_edge ]
  ...
  %sunkaddr18 = shl i64 %indvars.iv111, 3
...
for.body7:                                        ; preds = %for.body7.for.body7_crit_edge, %for.body
  %indvars.iv10 = phi i64 [ 0, %for.body ], [ %indvars.iv.next, %for.body7.for.body7_crit_edge ]
  ...
  store double %add, double* %sunkaddr20, align 8
...
for.end:                                          ; preds = %for.body7
  ...
  %exitcond13 = icmp eq i64 %indvars.iv.next2, 1300
  br i1 %exitcond13, label %for.end41, label %for.end.for.body_crit_edge
