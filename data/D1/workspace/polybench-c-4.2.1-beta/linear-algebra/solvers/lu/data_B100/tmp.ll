...
.lr.ph51.preheader:                               ; preds = %._crit_edge47
  ...
  br i1 %min.iters.check, label %.lr.ph51.preheader31, label %min.iters.checked

min.iters.checked:                                ; preds = %.lr.ph51.preheader
  %n.vec = and i64 %13, -4
  %cmp.zero = icmp eq i64 %n.vec, 0
  %ind.end = add nsw i64 %11, %n.vec
  br i1 %cmp.zero, label %.lr.ph51.preheader31, label %vector.body.preheader
...
middle.block:                                     ; preds = %vector.body.prol.loopexit, %middle.block.unr-lcssa
  ...
  br i1 %cmp.n, label %._crit_edge52, label %.lr.ph51.preheader31

.lr.ph51.preheader31:                             ; preds = %middle.block, %min.iters.checked, %.lr.ph51.preheader
  %indvars.iv116.ph = phi i64 [ %11, %min.iters.checked ], [ %11, %.lr.ph51.preheader ], [ %ind.end, %middle.block ]
  br label %.lr.ph51

.lr.ph51:                                         ; preds = %.lr.ph51.preheader31, %.lr.ph51
  %indvars.iv116 = phi i64 [ %indvars.iv.next117, %.lr.ph51 ], [ %indvars.iv116.ph, %.lr.ph51.preheader31 ]
...
._crit_edge35.us:                                 ; preds = %._crit_edge35.us, %.lr.ph39.split.us.preheader
  ...
  br i1 %exitcond35.7, label %.lr.ph13.us.preheader, label %._crit_edge35.us
...
._crit_edge14.us-lcssa.us.us:                     ; preds = %._crit_edge11.us.us
  ...
  br i1 %exitcond34, label %.lr.ph3.split.us.preheader, label %.lr.ph13.us
...
._crit_edge11.us.us:                              ; preds = %60
  ...
  br i1 %exitcond33, label %._crit_edge14.us-lcssa.us.us, label %.lr.ph10.us.us
...
.lr.ph3.split.us:                                 ; preds = %._crit_edge.us, %.lr.ph3.split.us.preheader
  ...
  %scevgep12 = getelementptr [2000 x double], [2000 x double]* %76, i64 %indvars.iv91, i64 0
  %77 = add nuw nsw i64 %indvars.iv91, 1
  %scevgep14 = getelementptr [2000 x double], [2000 x double]* %76, i64 %77, i64 0
  %scevgep16 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %75, i64 0, i64 %indvars.iv91, i64 0
  %scevgep18 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %75, i64 0, i64 %77, i64 0
  %bound0 = icmp ult double* %scevgep12, %scevgep18
  %bound1 = icmp ult double* %scevgep16, %scevgep14
  %memcheck.conflict = and i1 %bound0, %bound1
  br i1 %memcheck.conflict, label %scalar.ph9.preheader, label %vector.body7.preheader

vector.body7.preheader:                           ; preds = %.lr.ph3.split.us
  br label %vector.body7

scalar.ph9.preheader:                             ; preds = %.lr.ph3.split.us
  br label %scalar.ph9

vector.body7:                                     ; preds = %vector.body7, %vector.body7.preheader
  %index21 = phi i64 [ 0, %vector.body7.preheader ], [ %index.next22.1, %vector.body7 ]
  %78 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %75, i64 0, i64 %indvars.iv91, i64 %index21
  ...
  %wide.load29 = load <2 x i64>, <2 x i64>* %81, align 8, !alias.scope !8
  %82 = getelementptr inbounds [2000 x double], [2000 x double]* %76, i64 %indvars.iv91, i64 %index21
  ...
  store <2 x i64> %wide.load29, <2 x i64>* %85, align 8, !alias.scope !11, !noalias !8
  %index.next22 = or i64 %index21, 4
  %86 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %75, i64 0, i64 %indvars.iv91, i64 %index.next22
  ...
  %wide.load29.1 = load <2 x i64>, <2 x i64>* %89, align 8, !alias.scope !8
  %90 = getelementptr inbounds [2000 x double], [2000 x double]* %76, i64 %indvars.iv91, i64 %index.next22
  ...
  store <2 x i64> %wide.load29.1, <2 x i64>* %93, align 8, !alias.scope !11, !noalias !8
  %index.next22.1 = add nsw i64 %index21, 8
  %94 = icmp eq i64 %index.next22.1, 2000
  br i1 %94, label %._crit_edge.us.loopexit36, label %vector.body7, !llvm.loop !13

scalar.ph9:                                       ; preds = %scalar.ph9, %scalar.ph9.preheader
  %indvars.iv = phi i64 [ 0, %scalar.ph9.preheader ], [ %indvars.iv.next.4, %scalar.ph9 ]
  ...
  br i1 %exitcond.4, label %._crit_edge.us.loopexit, label %scalar.ph9, !llvm.loop !14

._crit_edge.us.loopexit:                          ; preds = %scalar.ph9
  br label %._crit_edge.us

._crit_edge.us.loopexit36:                        ; preds = %vector.body7
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit36, %._crit_edge.us.loopexit
  %indvars.iv.next92 = add nuw nsw i64 %indvars.iv91, 1
  %exitcond32 = icmp eq i64 %indvars.iv.next92, 2000
  br i1 %exitcond32, label %120, label %.lr.ph3.split.us
