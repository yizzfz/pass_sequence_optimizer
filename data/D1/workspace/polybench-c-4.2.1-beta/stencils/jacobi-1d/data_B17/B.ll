...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %22 = fadd <2 x double> %21, <double 2.000000e+00, double 3.000000e+00>
  %23 = insertelement <2 x double> undef, double %6, i32 0
  %24 = insertelement <2 x double> %23, double %6, i32 1
  ...
  %28 = getelementptr inbounds double, double* %2, i64 %indvars.iv1
...
define internal fastcc void @print_array(i32, double* nocapture readonly) unnamed_addr #0 {
  ...
  %7 = sext i32 %0 to i64
  %8 = icmp sgt i32 %0, 0
  br i1 %8, label %.lr.ph.preheader, label %._crit_edge3
