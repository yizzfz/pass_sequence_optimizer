...
._crit_edge:                                      ; preds = %.._crit_edge_crit_edge, %2
  %indvars.iv8 = phi i64 [ 0, %2 ], [ %indvars.iv.next9, %.._crit_edge_crit_edge ]
...
define internal fastcc void @kernel_correlation(i32, i32, double, [1200 x double]* nocapture, [1200 x double]* nocapture, double* nocapture, double* nocapture) unnamed_addr #0 {
  %8 = icmp sgt i32 %0, 0
  br i1 %8, label %.lr.ph126, label %.._crit_edge89_crit_edge

.._crit_edge89_crit_edge:                         ; preds = %7
...
.lr.ph126.split.preheader:                        ; preds = %.lr.ph126
  ...
  br i1 %lcmp.mod199, label %.lr.ph126.split.preheader..lr.ph126.split.prol.loopexit_crit_edge, label %.lr.ph126.split.prol.preheader

.lr.ph126.split.preheader..lr.ph126.split.prol.loopexit_crit_edge: ; preds = %.lr.ph126.split.preheader
...
.lr.ph126.split.prol:                             ; preds = %.lr.ph126.split.prol..lr.ph126.split.prol_crit_edge, %.lr.ph126.split.prol.preheader
  %indvars.iv194.prol = phi i64 [ %indvars.iv.next195.prol, %.lr.ph126.split.prol..lr.ph126.split.prol_crit_edge ], [ 0, %.lr.ph126.split.prol.preheader ]
  %prol.iter200 = phi i32 [ %prol.iter200.sub, %.lr.ph126.split.prol..lr.ph126.split.prol_crit_edge ], [ %xtraiter198, %.lr.ph126.split.prol.preheader ]
  ...
  br i1 %prol.iter200.cmp, label %.lr.ph126.split.prol.loopexit.loopexit, label %.lr.ph126.split.prol..lr.ph126.split.prol_crit_edge, !llvm.loop !1

.lr.ph126.split.prol..lr.ph126.split.prol_crit_edge: ; preds = %.lr.ph126.split.prol
  br label %.lr.ph126.split.prol

.lr.ph126.split.prol.loopexit.loopexit:           ; preds = %.lr.ph126.split.prol
  br label %.lr.ph126.split.prol.loopexit

.lr.ph126.split.prol.loopexit:                    ; preds = %.lr.ph126.split.preheader..lr.ph126.split.prol.loopexit_crit_edge, %.lr.ph126.split.prol.loopexit.loopexit
  %indvars.iv194.unr = phi i64 [ 0, %.lr.ph126.split.preheader..lr.ph126.split.prol.loopexit_crit_edge ], [ %indvars.iv.next195.prol, %.lr.ph126.split.prol.loopexit.loopexit ]
  %13 = icmp ult i32 %10, 3
  br i1 %13, label %.lr.ph126.split.prol.loopexit..lr.ph119_crit_edge, label %.lr.ph126.split.preheader206

.lr.ph126.split.prol.loopexit..lr.ph119_crit_edge: ; preds = %.lr.ph126.split.prol.loopexit
  br label %.lr.ph119
...
.lr.ph126.split.preheader206:                     ; preds = %.lr.ph126.split.prol.loopexit
  ...
  br i1 %min.iters.check, label %.lr.ph126.split.preheader206..lr.ph126.split.preheader225_crit_edge, label %min.iters.checked

.lr.ph126.split.preheader206..lr.ph126.split.preheader225_crit_edge: ; preds = %.lr.ph126.split.preheader206
  br label %.lr.ph126.split.preheader225

.lr.ph126.split.preheader225:                     ; preds = %middle.block..lr.ph126.split.preheader225_crit_edge, %min.iters.checked..lr.ph126.split.preheader225_crit_edge, %.lr.ph126.split.preheader206..lr.ph126.split.preheader225_crit_edge
  %indvars.iv194.ph = phi i64 [ %indvars.iv194.unr, %min.iters.checked..lr.ph126.split.preheader225_crit_edge ], [ %indvars.iv194.unr, %.lr.ph126.split.preheader206..lr.ph126.split.preheader225_crit_edge ], [ %ind.end, %middle.block..lr.ph126.split.preheader225_crit_edge ]
...
min.iters.checked:                                ; preds = %.lr.ph126.split.preheader206
  ...
  br i1 %cmp.zero, label %min.iters.checked..lr.ph126.split.preheader225_crit_edge, label %vector.ph

min.iters.checked..lr.ph126.split.preheader225_crit_edge: ; preds = %min.iters.checked
  br label %.lr.ph126.split.preheader225
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.ph
  ...
  br i1 %32, label %middle.block, label %vector.body.vector.body_crit_edge, !llvm.loop !3
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %middle.block.._crit_edge_crit_edge, label %middle.block..lr.ph126.split.preheader225_crit_edge

middle.block..lr.ph126.split.preheader225_crit_edge: ; preds = %middle.block
  br label %.lr.ph126.split.preheader225
...
.lr.ph126.split.us:                               ; preds = %._crit_edge123.us..lr.ph126.split.us_crit_edge, %.lr.ph126.split.us.preheader
  %indvars.iv190 = phi i64 [ 0, %.lr.ph126.split.us.preheader ], [ %indvars.iv.next191, %._crit_edge123.us..lr.ph126.split.us_crit_edge ]
  %35 = getelementptr inbounds double, double* %5, i64 %indvars.iv190
  store double 0.000000e+00, double* %35, align 8
  br i1 %lcmp.mod188, label %.lr.ph126.split.us..prol.loopexit186_crit_edge, label %.prol.preheader185.preheader

.lr.ph126.split.us..prol.loopexit186_crit_edge:   ; preds = %.lr.ph126.split.us
  br label %.prol.loopexit186

.prol.preheader185.preheader:                     ; preds = %.lr.ph126.split.us
  br label %.prol.preheader185

.prol.preheader185:                               ; preds = %.prol.preheader185..prol.preheader185_crit_edge, %.prol.preheader185.preheader
  %36 = phi double [ %39, %.prol.preheader185..prol.preheader185_crit_edge ], [ 0.000000e+00, %.prol.preheader185.preheader ]
  %indvars.iv181.prol = phi i64 [ %indvars.iv.next182.prol, %.prol.preheader185..prol.preheader185_crit_edge ], [ 0, %.prol.preheader185.preheader ]
  %prol.iter189 = phi i32 [ %prol.iter189.sub, %.prol.preheader185..prol.preheader185_crit_edge ], [ %xtraiter187, %.prol.preheader185.preheader ]
  ...
  br i1 %prol.iter189.cmp, label %.prol.loopexit186.loopexit, label %.prol.preheader185..prol.preheader185_crit_edge, !llvm.loop !6

.prol.preheader185..prol.preheader185_crit_edge:  ; preds = %.prol.preheader185
  br label %.prol.preheader185

.prol.loopexit186.loopexit:                       ; preds = %.prol.preheader185
  br label %.prol.loopexit186

.prol.loopexit186:                                ; preds = %.lr.ph126.split.us..prol.loopexit186_crit_edge, %.prol.loopexit186.loopexit
  %40 = phi double [ 0.000000e+00, %.lr.ph126.split.us..prol.loopexit186_crit_edge ], [ %39, %.prol.loopexit186.loopexit ]
  %indvars.iv181.unr = phi i64 [ 0, %.lr.ph126.split.us..prol.loopexit186_crit_edge ], [ %indvars.iv.next182.prol, %.prol.loopexit186.loopexit ]
  br i1 %34, label %.prol.loopexit186.._crit_edge123.us_crit_edge, label %.lr.ph126.split.us.new.preheader

.prol.loopexit186.._crit_edge123.us_crit_edge:    ; preds = %.prol.loopexit186
  br label %._crit_edge123.us

.lr.ph126.split.us.new.preheader:                 ; preds = %.prol.loopexit186
  br label %.lr.ph126.split.us.new

.lr.ph126.split.us.new:                           ; preds = %.lr.ph126.split.us.new..lr.ph126.split.us.new_crit_edge, %.lr.ph126.split.us.new.preheader
  %41 = phi double [ %53, %.lr.ph126.split.us.new..lr.ph126.split.us.new_crit_edge ], [ %40, %.lr.ph126.split.us.new.preheader ]
  %indvars.iv181 = phi i64 [ %indvars.iv.next182.3, %.lr.ph126.split.us.new..lr.ph126.split.us.new_crit_edge ], [ %indvars.iv181.unr, %.lr.ph126.split.us.new.preheader ]
  ...
  br i1 %exitcond184.3, label %._crit_edge123.us.loopexit, label %.lr.ph126.split.us.new..lr.ph126.split.us.new_crit_edge
...
._crit_edge123.us:                                ; preds = %.prol.loopexit186.._crit_edge123.us_crit_edge, %._crit_edge123.us.loopexit
  %54 = phi double [ %40, %.prol.loopexit186.._crit_edge123.us_crit_edge ], [ %53, %._crit_edge123.us.loopexit ]
  %55 = fdiv double %54, %2
  store double %55, double* %35, align 8
  %indvars.iv.next191 = add nuw nsw i64 %indvars.iv190, 1
  %exitcond193 = icmp eq i64 %indvars.iv.next191, %wide.trip.count192
  br i1 %exitcond193, label %._crit_edge.loopexit, label %._crit_edge123.us..lr.ph126.split.us_crit_edge
...
._crit_edge:                                      ; preds = %middle.block.._crit_edge_crit_edge, %._crit_edge.loopexit226, %._crit_edge.loopexit
  br i1 true, label %._crit_edge..lr.ph119_crit_edge, label %._crit_edge.._crit_edge89_crit_edge

._crit_edge..lr.ph119_crit_edge:                  ; preds = %._crit_edge
  br label %.lr.ph119

._crit_edge.._crit_edge89_crit_edge:              ; preds = %._crit_edge
  br label %._crit_edge89

.lr.ph119:                                        ; preds = %._crit_edge..lr.ph119_crit_edge, %.lr.ph126.split.prol.loopexit..lr.ph119_crit_edge
...
.lr.ph119.split.preheader:                        ; preds = %.lr.ph119
  ...
  br i1 %lcmp.mod180, label %.lr.ph119.split.preheader..lr.ph119.split.prol.loopexit_crit_edge, label %.lr.ph119.split.prol

.lr.ph119.split.preheader..lr.ph119.split.prol.loopexit_crit_edge: ; preds = %.lr.ph119.split.preheader
...
.lr.ph119.split.prol.loopexit:                    ; preds = %.lr.ph119.split.preheader..lr.ph119.split.prol.loopexit_crit_edge, %.lr.ph119.split.prol
  %indvars.iv175.unr = phi i64 [ 0, %.lr.ph119.split.preheader..lr.ph119.split.prol.loopexit_crit_edge ], [ 1, %.lr.ph119.split.prol ]
  %61 = icmp eq i32 %0, 1
  br i1 %61, label %.lr.ph119.split.prol.loopexit.._crit_edge89_crit_edge, label %.lr.ph119.split.preheader204

.lr.ph119.split.prol.loopexit.._crit_edge89_crit_edge: ; preds = %.lr.ph119.split.prol.loopexit
  br label %._crit_edge89
...
.lr.ph119.split.us:                               ; preds = %._crit_edge117.us..lr.ph119.split.us_crit_edge, %.lr.ph119.split.us.preheader
  ...
  br i1 %lcmp.mod170, label %.lr.ph119.split.us..prol.loopexit168_crit_edge, label %.prol.preheader167

.lr.ph119.split.us..prol.loopexit168_crit_edge:   ; preds = %.lr.ph119.split.us
...
.prol.loopexit168:                                ; preds = %.lr.ph119.split.us..prol.loopexit168_crit_edge, %.prol.preheader167
  %71 = phi double [ %70, %.prol.preheader167 ], [ 0.000000e+00, %.lr.ph119.split.us..prol.loopexit168_crit_edge ]
  %indvars.iv163.unr.ph = phi i64 [ 1, %.prol.preheader167 ], [ 0, %.lr.ph119.split.us..prol.loopexit168_crit_edge ]
  br i1 %56, label %.prol.loopexit168.._crit_edge117.us_crit_edge, label %.lr.ph119.split.us.new.preheader

.prol.loopexit168.._crit_edge117.us_crit_edge:    ; preds = %.prol.loopexit168
  br label %._crit_edge117.us

.lr.ph119.split.us.new.preheader:                 ; preds = %.prol.loopexit168
  br label %.lr.ph119.split.us.new

.lr.ph119.split.us.new:                           ; preds = %.lr.ph119.split.us.new..lr.ph119.split.us.new_crit_edge, %.lr.ph119.split.us.new.preheader
  %72 = phi double [ %84, %.lr.ph119.split.us.new..lr.ph119.split.us.new_crit_edge ], [ %71, %.lr.ph119.split.us.new.preheader ]
  %indvars.iv163 = phi i64 [ %indvars.iv.next164.1, %.lr.ph119.split.us.new..lr.ph119.split.us.new_crit_edge ], [ %indvars.iv163.unr.ph, %.lr.ph119.split.us.new.preheader ]
  ...
  br i1 %exitcond166.1, label %._crit_edge117.us.loopexit, label %.lr.ph119.split.us.new..lr.ph119.split.us.new_crit_edge
...
._crit_edge117.us:                                ; preds = %.prol.loopexit168.._crit_edge117.us_crit_edge, %._crit_edge117.us.loopexit
  %85 = phi double [ %71, %.prol.loopexit168.._crit_edge117.us_crit_edge ], [ %84, %._crit_edge117.us.loopexit ]
  %86 = fdiv double %85, %2
  ...
  br i1 %exitcond174, label %._crit_edge89.loopexit, label %._crit_edge117.us..lr.ph119.split.us_crit_edge

._crit_edge117.us..lr.ph119.split.us_crit_edge:   ; preds = %._crit_edge117.us
  br label %.lr.ph119.split.us

.lr.ph126.split:                                  ; preds = %.lr.ph126.split..lr.ph126.split_crit_edge, %.lr.ph126.split.preheader225
  %indvars.iv194 = phi i64 [ %indvars.iv.next195.3, %.lr.ph126.split..lr.ph126.split_crit_edge ], [ %indvars.iv194.ph, %.lr.ph126.split.preheader225 ]
  ...
  br i1 %exitcond197.3, label %._crit_edge.loopexit226, label %.lr.ph126.split..lr.ph126.split_crit_edge, !llvm.loop !7

.lr.ph126.split..lr.ph126.split_crit_edge:        ; preds = %.lr.ph126.split
  br label %.lr.ph126.split
...
._crit_edge89:                                    ; preds = %.lr.ph119.split.prol.loopexit.._crit_edge89_crit_edge, %.._crit_edge89_crit_edge, %._crit_edge89.loopexit224, %._crit_edge89.loopexit, %._crit_edge.._crit_edge89_crit_edge
  %94 = icmp sgt i32 %1, 0
  br i1 %94, label %._crit_edge90.lr.ph, label %._crit_edge89.._crit_edge91_crit_edge

._crit_edge89.._crit_edge91_crit_edge:            ; preds = %._crit_edge89
...
; <label>:96:                                     ; preds = %._crit_edge233, %._crit_edge90.us
  %indvars.iv154 = phi i64 [ 0, %._crit_edge90.us ], [ %indvars.iv.next155, %._crit_edge233 ]
  ...
  br i1 %exitcond157, label %._crit_edge112.us, label %._crit_edge233
...
._crit_edge112.us:                                ; preds = %96
  ...
  br i1 %exitcond161, label %._crit_edge91.loopexit, label %._crit_edge112.us.._crit_edge90.us_crit_edge

._crit_edge112.us.._crit_edge90.us_crit_edge:     ; preds = %._crit_edge112.us
  br label %._crit_edge90.us

.lr.ph119.split:                                  ; preds = %.lr.ph119.split..lr.ph119.split_crit_edge, %.lr.ph119.split.preheader204
  %indvars.iv175 = phi i64 [ %indvars.iv.next176.1, %.lr.ph119.split..lr.ph119.split_crit_edge ], [ %indvars.iv175.unr, %.lr.ph119.split.preheader204 ]
  ...
  br i1 %exitcond178.1, label %._crit_edge89.loopexit224, label %.lr.ph119.split..lr.ph119.split_crit_edge

.lr.ph119.split..lr.ph119.split_crit_edge:        ; preds = %.lr.ph119.split
  br label %.lr.ph119.split

._crit_edge91.loopexit:                           ; preds = %._crit_edge112.us
  br label %._crit_edge91

._crit_edge91:                                    ; preds = %._crit_edge89.._crit_edge91_crit_edge, %._crit_edge91.loopexit
  %116 = add nsw i32 %0, -1
  %117 = icmp sgt i32 %0, 1
  br i1 %117, label %.lr.ph101, label %._crit_edge91.._crit_edge102_crit_edge

._crit_edge91.._crit_edge102_crit_edge:           ; preds = %._crit_edge91
  br label %._crit_edge102
...
.lr.ph101.split.us:                               ; preds = %._crit_edge99.us-lcssa.us.us..lr.ph101.split.us_crit_edge, %.lr.ph101.split.us.preheader
  %indvars.iv137 = phi i64 [ 0, %.lr.ph101.split.us.preheader ], [ %indvars.iv.next138, %._crit_edge99.us-lcssa.us.us..lr.ph101.split.us_crit_edge ]
  %indvars.iv131 = phi i64 [ 1, %.lr.ph101.split.us.preheader ], [ %indvars.iv.next132, %._crit_edge99.us-lcssa.us.us..lr.ph101.split.us_crit_edge ]
  ...
  br i1 %125, label %.lr.ph.us.us.preheader, label %.lr.ph101.split.us.._crit_edge99.us-lcssa.us.us_crit_edge
...
._crit_edge99.us-lcssa.us.us:                     ; preds = %.lr.ph101.split.us.._crit_edge99.us-lcssa.us.us_crit_edge, %._crit_edge99.us-lcssa.us.us.loopexit
  ...
  br i1 %exitcond140, label %._crit_edge102.loopexit, label %._crit_edge99.us-lcssa.us.us..lr.ph101.split.us_crit_edge
...
.prol.loopexit:                                   ; preds = %.lr.ph.us.us..prol.loopexit_crit_edge, %.prol.preheader
  %134 = phi i64 [ %133, %.prol.preheader ], [ 0, %.lr.ph.us.us..prol.loopexit_crit_edge ]
  %135 = phi double [ %132, %.prol.preheader ], [ 0.000000e+00, %.lr.ph.us.us..prol.loopexit_crit_edge ]
  %indvars.iv.unr.ph = phi i64 [ 1, %.prol.preheader ], [ 0, %.lr.ph.us.us..prol.loopexit_crit_edge ]
  br i1 %123, label %.prol.loopexit.._crit_edge94.us.us_crit_edge, label %.lr.ph.us.us.new.preheader

.prol.loopexit.._crit_edge94.us.us_crit_edge:     ; preds = %.prol.loopexit
...
._crit_edge94.us.us:                              ; preds = %.prol.loopexit.._crit_edge94.us.us_crit_edge, %._crit_edge94.us.us.loopexit
  %137 = phi i64 [ %134, %.prol.loopexit.._crit_edge94.us.us_crit_edge ], [ %136, %._crit_edge94.us.us.loopexit ]
...
.lr.ph.us.us.new:                                 ; preds = %.lr.ph.us.us.new..lr.ph.us.us.new_crit_edge, %.lr.ph.us.us.new.preheader
  %140 = phi double [ %152, %.lr.ph.us.us.new..lr.ph.us.us.new_crit_edge ], [ %135, %.lr.ph.us.us.new.preheader ]
  ...
  br i1 %exitcond.1, label %._crit_edge94.us.us.loopexit, label %.lr.ph.us.us.new..lr.ph.us.us.new_crit_edge

.lr.ph.us.us.new..lr.ph.us.us.new_crit_edge:      ; preds = %.lr.ph.us.us.new
  br label %.lr.ph.us.us.new

.lr.ph101.split:                                  ; preds = %._crit_edge99..lr.ph101.split_crit_edge, %.lr.ph101.split.preheader
  %indvars.iv150 = phi i64 [ 0, %.lr.ph101.split.preheader ], [ %indvars.iv.next151, %._crit_edge99..lr.ph101.split_crit_edge ]
  %indvars.iv141 = phi i64 [ 1, %.lr.ph101.split.preheader ], [ %indvars.iv.next142, %._crit_edge99..lr.ph101.split_crit_edge ]
  ...
  br i1 %156, label %.lr.ph98.split.preheader, label %.lr.ph101.split.._crit_edge99_crit_edge

.lr.ph101.split.._crit_edge99_crit_edge:          ; preds = %.lr.ph101.split
...
.lr.ph98.split.preheader:                         ; preds = %.lr.ph101.split
  ...
  br i1 %lcmp.mod149, label %.lr.ph98.split.preheader..lr.ph98.split.prol.loopexit_crit_edge, label %.lr.ph98.split.prol.preheader

.lr.ph98.split.preheader..lr.ph98.split.prol.loopexit_crit_edge: ; preds = %.lr.ph98.split.preheader
...
.lr.ph98.split.prol:                              ; preds = %.lr.ph98.split.prol..lr.ph98.split.prol_crit_edge, %.lr.ph98.split.prol.preheader
  %indvars.iv143.prol = phi i64 [ %indvars.iv.next144.prol, %.lr.ph98.split.prol..lr.ph98.split.prol_crit_edge ], [ %indvars.iv141, %.lr.ph98.split.prol.preheader ]
  %prol.iter = phi i32 [ %prol.iter.sub, %.lr.ph98.split.prol..lr.ph98.split.prol_crit_edge ], [ %xtraiter148, %.lr.ph98.split.prol.preheader ]
  ...
  br i1 %prol.iter.cmp, label %.lr.ph98.split.prol.loopexit.loopexit, label %.lr.ph98.split.prol..lr.ph98.split.prol_crit_edge, !llvm.loop !9

.lr.ph98.split.prol..lr.ph98.split.prol_crit_edge: ; preds = %.lr.ph98.split.prol
  br label %.lr.ph98.split.prol

.lr.ph98.split.prol.loopexit.loopexit:            ; preds = %.lr.ph98.split.prol
  br label %.lr.ph98.split.prol.loopexit

.lr.ph98.split.prol.loopexit:                     ; preds = %.lr.ph98.split.preheader..lr.ph98.split.prol.loopexit_crit_edge, %.lr.ph98.split.prol.loopexit.loopexit
  %indvars.iv143.unr = phi i64 [ %indvars.iv141, %.lr.ph98.split.preheader..lr.ph98.split.prol.loopexit_crit_edge ], [ %indvars.iv.next144.prol, %.lr.ph98.split.prol.loopexit.loopexit ]
  %162 = icmp ult i32 %154, 3
  br i1 %162, label %.lr.ph98.split.prol.loopexit.._crit_edge99_crit_edge, label %.lr.ph98.split.preheader222

.lr.ph98.split.prol.loopexit.._crit_edge99_crit_edge: ; preds = %.lr.ph98.split.prol.loopexit
  br label %._crit_edge99

.lr.ph98.split.preheader222:                      ; preds = %.lr.ph98.split.prol.loopexit
  br label %.lr.ph98.split

.lr.ph98.split:                                   ; preds = %.lr.ph98.split..lr.ph98.split_crit_edge, %.lr.ph98.split.preheader222
  %indvars.iv143 = phi i64 [ %indvars.iv.next144.3, %.lr.ph98.split..lr.ph98.split_crit_edge ], [ %indvars.iv143.unr, %.lr.ph98.split.preheader222 ]
  ...
  br i1 %exitcond146.3, label %._crit_edge99.loopexit, label %.lr.ph98.split..lr.ph98.split_crit_edge

.lr.ph98.split..lr.ph98.split_crit_edge:          ; preds = %.lr.ph98.split
  br label %.lr.ph98.split

._crit_edge99.loopexit:                           ; preds = %.lr.ph98.split
  br label %._crit_edge99

._crit_edge99:                                    ; preds = %.lr.ph98.split.prol.loopexit.._crit_edge99_crit_edge, %.lr.ph101.split.._crit_edge99_crit_edge, %._crit_edge99.loopexit
  %indvars.iv.next142 = add nuw nsw i64 %indvars.iv141, 1
  %exitcond153 = icmp eq i64 %indvars.iv.next151, %118
  br i1 %exitcond153, label %._crit_edge102.loopexit223, label %._crit_edge99..lr.ph101.split_crit_edge

._crit_edge99..lr.ph101.split_crit_edge:          ; preds = %._crit_edge99
  br label %.lr.ph101.split
...
._crit_edge102:                                   ; preds = %._crit_edge91.._crit_edge102_crit_edge, %._crit_edge102.loopexit223, %._crit_edge102.loopexit, %._crit_edge91.thread
  %175 = phi i32 [ %95, %._crit_edge91.thread ], [ %116, %._crit_edge91.._crit_edge102_crit_edge ], [ %116, %._crit_edge102.loopexit ], [ %116, %._crit_edge102.loopexit223 ]
...
define internal fastcc void @print_array(i32, [1200 x double]* nocapture readonly) unnamed_addr #0 {
  ...
  %7 = icmp sgt i32 %0, 0
  br i1 %7, label %._crit_edge.us.preheader, label %.._crit_edge13_crit_edge
...
; <label>:10:                                     ; preds = %._crit_edge9.us._crit_edge, %._crit_edge.us
  %indvars.iv = phi i64 [ 0, %._crit_edge.us ], [ %indvars.iv.next, %._crit_edge9.us._crit_edge ]
  %11 = add nsw i64 %indvars.iv, %9
  %12 = trunc i64 %11 to i32
  %13 = srem i32 %12, 20
  %14 = icmp eq i32 %13, 0
  br i1 %14, label %15, label %.._crit_edge9.us_crit_edge

.._crit_edge9.us_crit_edge:                       ; preds = %10
...
._crit_edge9.us:                                  ; preds = %.._crit_edge9.us_crit_edge, %15
...
._crit_edge11.us:                                 ; preds = %._crit_edge9.us
  ...
  br i1 %exitcond17, label %._crit_edge13.loopexit, label %._crit_edge11.us.._crit_edge.us_crit_edge
