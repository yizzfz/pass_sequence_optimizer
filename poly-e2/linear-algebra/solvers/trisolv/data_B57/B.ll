...
for.end:                                          ; preds = %for.body6.prol.loopexit, %for.end.unr-lcssa
  ...
  %exitcond10 = icmp eq i64 %indvars.iv.next8, %0
  br i1 %exitcond10, label %for.end16.loopexit, label %for.body6.lr.ph
...
for.body:                                         ; preds = %for.end, %for.body.preheader
  ...
  %1 = add nuw i64 %indvars.iv7, 4294967295
...
for.end:                                          ; preds = %for.end.loopexit, %for.body
  %.lcssa = phi double [ %6, %for.body ], [ %sub.lcssa, %for.end.loopexit ]
  ...
  %exitcond16 = icmp eq i64 %indvars.iv.next8, %0
  br i1 %exitcond16, label %for.end24.loopexit, label %for.body
