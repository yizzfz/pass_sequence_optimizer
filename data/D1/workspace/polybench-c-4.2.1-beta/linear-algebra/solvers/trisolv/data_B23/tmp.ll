...
._crit_edge:                                      ; preds = %.prol.loopexit.._crit_edge_crit_edge, %._crit_edge._crit_edge.._crit_edge_crit_edge, %._crit_edge.loopexit
  ...
  store double %31, double* %sunkaddr7, align 8
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  %exitcond = icmp eq i64 %indvars.iv.next18, 2000
  br i1 %exitcond, label %._crit_edge10, label %._crit_edge.._crit_edge._crit_edge_crit_edge
...
.lr.ph:                                           ; preds = %.lr.ph._crit_edge..lr.ph_crit_edge, %.lr.ph.preheader
  ...
  %7 = phi %struct._IO_FILE* [ %16, %.lr.ph._crit_edge..lr.ph_crit_edge ], [ %6, %.lr.ph.preheader ]
  ...
  %12 = srem i32 %11, 20
  %13 = icmp eq i32 %12, 0
  br i1 %13, label %14, label %.lr.ph..lr.ph._crit_edge_crit_edge
...
.lr.ph._crit_edge:                                ; preds = %.lr.ph..lr.ph._crit_edge_crit_edge, %14
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
