...
.preheader.us:                                    ; preds = %._crit_edge32.us, %.preheader.lr.ph
  ...
  %5 = add nuw nsw i64 %indvars.iv50, 4294967295
...
.preheader27.us:                                  ; preds = %..loopexit_crit_edge.us, %.preheader27.lr.ph
  %indvars.iv53 = phi i64 [ 0, %.preheader27.lr.ph ], [ %indvars.iv.next54, %..loopexit_crit_edge.us ]
  %indvars.iv42 = phi i64 [ 1, %.preheader27.lr.ph ], [ %indvars.iv.next43.pre-phi, %..loopexit_crit_edge.us ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %6 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %offset.idx
  ...
  %8 = fmul <2 x double> %strided.vec, %broadcast.splat67
  %9 = fmul <2 x double> %strided.vec63, %broadcast.splat67
  %10 = fmul <2 x double> %strided.vec64, %broadcast.splat67
  %11 = or i64 %offset.idx, 3
  %12 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv53, i64 %11
  %13 = fmul <2 x double> %strided.vec65, %broadcast.splat67
  ...
  br i1 %18, label %..loopexit_crit_edge.us.loopexit60, label %vector.body, !llvm.loop !1

.preheader.us.us.preheader:                       ; preds = %.preheader27.us
  %19 = sub nsw i64 0, %indvars.iv53
  %20 = trunc i64 %19 to i32
  %21 = and i64 %indvars.iv53, 1
  %lcmp.mod48 = icmp eq i64 %21, 0
  %22 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv42, i64 %indvars.iv53
  %indvars.iv.next45.prol = add nuw nsw i64 %indvars.iv42, 1
  %23 = icmp eq i32 %20, -998
  br label %.preheader.us.us

..loopexit_crit_edge.us.loopexit60:               ; preds = %vector.body
  %.pre62 = add nuw nsw i64 %indvars.iv42, 1
  br label %..loopexit_crit_edge.us

..loopexit_crit_edge.us.loopexit:                 ; preds = %._crit_edge.us.us
  br label %..loopexit_crit_edge.us

..loopexit_crit_edge.us:                          ; preds = %..loopexit_crit_edge.us.loopexit, %..loopexit_crit_edge.us.loopexit60
  %indvars.iv.next43.pre-phi = phi i64 [ %.pre62, %..loopexit_crit_edge.us.loopexit60 ], [ %indvars.iv.next45.prol, %..loopexit_crit_edge.us.loopexit ]
  %exitcond56 = icmp eq i64 %indvars.iv.next54, 1000
  br i1 %exitcond56, label %._crit_edge31, label %.preheader27.us
...
.prol.loopexit:                                   ; preds = %.preheader.us.us, %.prol.preheader
  ...
  %.pre61 = load double, double* %24, align 8
...
._crit_edge.us.us:                                ; preds = %._crit_edge.us.us.loopexit, %.prol.loopexit
  %31 = phi double [ %.pre61, %.prol.loopexit ], [ %45, %._crit_edge.us.us.loopexit ]
  %32 = fmul double %31, %2
...
.preheader.us.us.new:                             ; preds = %.preheader.us.us.new.preheader, %.preheader.us.us.new
  %33 = phi double [ %45, %.preheader.us.us.new ], [ %.pre61, %.preheader.us.us.new.preheader ]
