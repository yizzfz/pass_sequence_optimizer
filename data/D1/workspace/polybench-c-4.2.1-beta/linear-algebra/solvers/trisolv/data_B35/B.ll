...
.lr.ph34:
  %sunkaddr51 = ptrtoint double* %1 to i64
...
; <label>:4:                                      ; preds = %._crit_edge, %.lr.ph34
  ...
  %6 = getelementptr inbounds double, double* %2, i64 %indvars.iv42
  %7 = load double, double* %6, align 8
  %8 = getelementptr inbounds double, double* %1, i64 %indvars.iv42
...
.prol.preheader:                                  ; preds = %.lr.ph
  %10 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv42, i64 0
  ...
  store double %14, double* %sunkaddr50, align 8
  br label %.prol.loopexit
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %18 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv42, i64 %indvars.iv
  %19 = load double, double* %18, align 8
  %20 = getelementptr inbounds double, double* %1, i64 %indvars.iv
  %21 = load double, double* %20, align 8
  %22 = fmul double %19, %21
  %23 = fsub double %17, %22
  store double %23, double* %sunkaddr54, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %24 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv42, i64 %indvars.iv.next
  %25 = load double, double* %24, align 8
  %26 = getelementptr inbounds double, double* %1, i64 %indvars.iv.next
  %27 = load double, double* %26, align 8
  %28 = fmul double %25, %27
  %29 = fsub double %23, %28
  store double %29, double* %sunkaddr54, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %4
  %.lcssa = phi double [ %7, %4 ], [ %.lcssa37.unr.ph, %.prol.loopexit ], [ %29, %._crit_edge.loopexit ]
  %30 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv42, i64 %indvars.iv42
  %31 = load double, double* %30, align 8
  %32 = fdiv double %.lcssa, %31
  %sunkaddr28 = shl nsw i64 %indvars.iv42, 3
  %sunkaddr29 = add i64 %3, %sunkaddr28
