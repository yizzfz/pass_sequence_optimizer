...
for.cond1.preheader.us:                           ; preds = %for.inc7.us.for.cond1.preheader.us_crit_edge, %for.cond1.preheader.us.preheader
  %indvars.iv8 = phi i64 [ 0, %for.cond1.preheader.us.preheader ], [ %indvars.iv.next9, %for.inc7.us.for.cond1.preheader.us_crit_edge ]
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %for.cond1.preheader.us
  ...
  br i1 %9, label %for.inc7.us, label %vector.body.vector.body_crit_edge, !llvm.loop !1

vector.body.vector.body_crit_edge:                ; preds = %vector.body
  br label %vector.body

for.inc7.us:                                      ; preds = %vector.body
  %indvars.iv.next9 = add nuw i64 %indvars.iv8, 1
  %cmp.us = icmp slt i64 %indvars.iv.next9, 4096
  br i1 %cmp.us, label %for.inc7.us.for.cond1.preheader.us_crit_edge, label %for.end9
...
for.cond31.preheader.us:                          ; preds = %for.inc55.us.for.cond31.preheader.us_crit_edge, %for.cond31.preheader.us.preheader
  %indvars.iv69 = phi i64 [ 0, %for.cond31.preheader.us.preheader ], [ %indvars.iv.next70, %for.inc55.us.for.cond31.preheader.us_crit_edge ]
  %arrayidx35.us38 = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv69, i64 0
  ...
  %arrayidx46.us46 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv69, i64 0
...
for.inc.us.for.inc.us_crit_edge:                  ; preds = %for.inc.us.for.inc.us_crit_edge.1, %for.cond31.preheader.us
  ...
  %indvars.iv6647 = phi i64 [ 0, %for.cond31.preheader.us ], [ %indvars.iv.next67.1, %for.inc.us.for.inc.us_crit_edge.1 ]
  %indvars.iv.next67 = or i64 %indvars.iv6647, 1
  %3 = load float, float* %arrayidx35.us49, align 4
  %arrayidx35.us = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv69, i64 %indvars.iv.next67
  ...
  %arrayidx46.us = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv69, i64 %indvars.iv.next67
  store float %add42.us, float* %arrayidx46.us, align 4
  %exitcond68 = icmp eq i64 %indvars.iv.next67, 2159
  br i1 %exitcond68, label %for.inc55.us, label %for.inc.us.for.inc.us_crit_edge.1

for.inc55.us:                                     ; preds = %for.inc.us.for.inc.us_crit_edge
  %indvars.iv.next70 = add nuw i64 %indvars.iv69, 1
  %cmp.us = icmp slt i64 %indvars.iv.next70, 4096
  br i1 %cmp.us, label %for.inc55.us.for.cond31.preheader.us_crit_edge, label %for.cond62.preheader.us.preheader

for.inc55.us.for.cond31.preheader.us_crit_edge:   ; preds = %for.inc55.us
  br label %for.cond31.preheader.us
...
for.cond62.preheader.us:                          ; preds = %for.inc86.us.for.cond62.preheader.us_crit_edge, %for.cond62.preheader.us.preheader
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc86.us.for.cond62.preheader.us_crit_edge ], [ 0, %for.cond62.preheader.us.preheader ]
  %arrayidx75.us33 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv64, i64 2159
...
for.inc84.us.for.inc84.us_crit_edge:              ; preds = %for.inc84.us.for.inc84.us_crit_edge.1, %for.cond62.preheader.us
  ...
  %xp1.027.us36 = phi float [ 0.000000e+00, %for.cond62.preheader.us ], [ %85, %for.inc84.us.for.inc84.us_crit_edge.1 ]
  %yp1.029.us35 = phi float [ 0.000000e+00, %for.cond62.preheader.us ], [ %add71.us, %for.inc84.us.for.inc84.us_crit_edge.1 ]
  %indvars.iv6234 = phi i64 [ 2159, %for.cond62.preheader.us ], [ %indvars.iv.next63.1, %for.inc84.us.for.inc84.us_crit_edge.1 ]
  %indvars.iv.next63 = add nsw i64 %indvars.iv6234, -1
  %arrayidx79.us = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv64, i64 %indvars.iv6234
  %5 = load float, float* %arrayidx79.us, align 4
  %mul65.us = fmul float %mul16.v.r2, %5
  %mul66.us = fmul float %xp1.027.us36, %mul25
  %add67.us = fadd float %mul65.us, %mul66.us
  %mul68.us = fmul float %exp2, %add71.us37
  %add69.us = fadd float %add67.us, %mul68.us
  %mul70.us = fmul float %yp1.029.us35, %sub30
  %add71.us = fadd float %add69.us, %mul70.us
  %arrayidx75.us = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv64, i64 %indvars.iv.next63
  store float %add71.us, float* %arrayidx75.us, align 4
  %cmp63.us = icmp sgt i64 %indvars.iv6234, 1
  br i1 %cmp63.us, label %for.inc84.us.for.inc84.us_crit_edge.1, label %for.inc86.us

for.inc86.us:                                     ; preds = %for.inc84.us.for.inc84.us_crit_edge
  %indvars.iv.next65 = add nuw i64 %indvars.iv64, 1
  %cmp59.us = icmp slt i64 %indvars.iv.next65, 4096
  br i1 %cmp59.us, label %for.inc86.us.for.cond62.preheader.us_crit_edge, label %for.cond92.preheader.us.preheader

for.inc86.us.for.cond62.preheader.us_crit_edge:   ; preds = %for.inc86.us
  br label %for.cond62.preheader.us

for.cond92.preheader.us.preheader:                ; preds = %for.inc86.us
  br label %for.cond92.preheader.us

for.cond92.preheader.us:                          ; preds = %for.inc112.us.for.cond92.preheader.us_crit_edge, %for.cond92.preheader.us.preheader
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.inc112.us.for.cond92.preheader.us_crit_edge ], [ 0, %for.cond92.preheader.us.preheader ]
  %scevgep = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv60, i64 0
  %6 = add i64 %indvars.iv60, 1
  %scevgep52 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %6, i64 0
  %scevgep54 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv60, i64 0
  %scevgep56 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %6, i64 0
  %scevgep58 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv60, i64 0
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.body.preheader
  ...
  %7 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv60, i64 %index
  %8 = bitcast float* %7 to <4 x float>*
  ...
  %11 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv60, i64 %index
  ...
  %17 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv60, i64 %index
  ...
  %21 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv60, i64 %index.next
  ...
  %25 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv60, i64 %index.next
  ...
  %31 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv60, i64 %index.next
  ...
  br i1 %35, label %for.inc112.us.loopexit111, label %vector.body.vector.body_crit_edge, !llvm.loop !12

vector.body.vector.body_crit_edge:                ; preds = %vector.body
  br label %vector.body

for.inc109.us:                                    ; preds = %for.inc109.us.for.inc109.us_crit_edge, %for.inc109.us.preheader
  %indvars.iv57 = phi i64 [ 0, %for.inc109.us.preheader ], [ %indvars.iv.next58.2, %for.inc109.us.for.inc109.us_crit_edge ]
  %arrayidx98.us = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv60, i64 %indvars.iv57
  %36 = load float, float* %arrayidx98.us, align 4
  %arrayidx102.us = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv60, i64 %indvars.iv57
  %37 = load float, float* %arrayidx102.us, align 4
  %add103.us = fadd float %36, %37
  %arrayidx108.us = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv60, i64 %indvars.iv57
  store float %add103.us, float* %arrayidx108.us, align 4
  %indvars.iv.next58 = add nuw nsw i64 %indvars.iv57, 1
  %arrayidx98.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv60, i64 %indvars.iv.next58
  %38 = load float, float* %arrayidx98.us.1, align 4
  %arrayidx102.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv60, i64 %indvars.iv.next58
  %39 = load float, float* %arrayidx102.us.1, align 4
  %add103.us.1 = fadd float %38, %39
  %arrayidx108.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv60, i64 %indvars.iv.next58
  store float %add103.us.1, float* %arrayidx108.us.1, align 4
  %indvars.iv.next58.1 = add nsw i64 %indvars.iv57, 2
  %arrayidx98.us.2 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv60, i64 %indvars.iv.next58.1
  %40 = load float, float* %arrayidx98.us.2, align 4
  %arrayidx102.us.2 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv60, i64 %indvars.iv.next58.1
  %41 = load float, float* %arrayidx102.us.2, align 4
  %add103.us.2 = fadd float %40, %41
  %arrayidx108.us.2 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv60, i64 %indvars.iv.next58.1
  store float %add103.us.2, float* %arrayidx108.us.2, align 4
  %exitcond59.2 = icmp eq i64 %indvars.iv.next58.1, 2159
  %indvars.iv.next58.2 = add nsw i64 %indvars.iv57, 3
  br i1 %exitcond59.2, label %for.inc112.us.loopexit, label %for.inc109.us.for.inc109.us_crit_edge, !llvm.loop !13
...
for.inc112.us.loopexit111:                        ; preds = %vector.body
  br label %for.inc112.us

for.inc112.us:                                    ; preds = %for.inc112.us.loopexit111, %for.inc112.us.loopexit
  %indvars.iv.next61 = add nuw i64 %indvars.iv60, 1
  %cmp90.us = icmp slt i64 %indvars.iv.next61, 4096
  br i1 %cmp90.us, label %for.inc112.us.for.cond92.preheader.us_crit_edge, label %for.cond118.preheader.us.preheader

for.inc112.us.for.cond92.preheader.us_crit_edge:  ; preds = %for.inc112.us
  br label %for.cond92.preheader.us

for.cond118.preheader.us.preheader:               ; preds = %for.inc112.us
...
for.cond118.preheader.us:                         ; preds = %for.inc147.us.for.cond118.preheader.us_crit_edge, %for.cond118.preheader.us.preheader
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.inc147.us.for.cond118.preheader.us_crit_edge ], [ 0, %for.cond118.preheader.us.preheader ]
  %arrayidx124.us13 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 0, i64 %indvars.iv55
  ...
  %arrayidx135.us21 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 0, i64 %indvars.iv55
...
for.inc144.us.for.inc144.us_crit_edge:            ; preds = %for.inc144.us.for.inc144.us_crit_edge.1, %for.cond118.preheader.us
  ...
  %indvars.iv5222 = phi i64 [ 0, %for.cond118.preheader.us ], [ %indvars.iv.next53.1, %for.inc144.us.for.inc144.us_crit_edge.1 ]
  %indvars.iv.next53 = or i64 %indvars.iv5222, 1
  %43 = load float, float* %arrayidx124.us24, align 4
  %arrayidx124.us = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv.next53, i64 %indvars.iv55
  ...
  %arrayidx135.us = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv.next53, i64 %indvars.iv55
  store float %add131.us, float* %arrayidx135.us, align 4
  %exitcond54 = icmp eq i64 %indvars.iv.next53, 4095
  br i1 %exitcond54, label %for.inc147.us, label %for.inc144.us.for.inc144.us_crit_edge.1

for.inc147.us:                                    ; preds = %for.inc144.us.for.inc144.us_crit_edge
  %indvars.iv.next56 = add nuw i64 %indvars.iv55, 1
  %cmp116.us = icmp slt i64 %indvars.iv.next56, 2160
  br i1 %cmp116.us, label %for.inc147.us.for.cond118.preheader.us_crit_edge, label %for.cond154.preheader.us.preheader

for.inc147.us.for.cond118.preheader.us_crit_edge: ; preds = %for.inc147.us
  br label %for.cond118.preheader.us
...
for.cond154.preheader.us:                         ; preds = %for.inc179.us.for.cond154.preheader.us_crit_edge, %for.cond154.preheader.us.preheader
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc179.us.for.cond154.preheader.us_crit_edge ], [ 0, %for.cond154.preheader.us.preheader ]
  %arrayidx167.us8 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 4095, i64 %indvars.iv50
...
for.inc176.us.for.inc176.us_crit_edge:            ; preds = %for.inc176.us.for.inc176.us_crit_edge.1, %for.cond154.preheader.us
  %add163.us12 = phi float [ %add163.us7, %for.cond154.preheader.us ], [ %add163.us.1, %for.inc176.us.for.inc176.us_crit_edge.1 ]
  %tp1.07.us11 = phi float [ 0.000000e+00, %for.cond154.preheader.us ], [ %82, %for.inc176.us.for.inc176.us_crit_edge.1 ]
  %yp1.19.us10 = phi float [ 0.000000e+00, %for.cond154.preheader.us ], [ %add163.us, %for.inc176.us.for.inc176.us_crit_edge.1 ]
  %indvars.iv489 = phi i64 [ 4095, %for.cond154.preheader.us ], [ %indvars.iv.next49.1, %for.inc176.us.for.inc176.us_crit_edge.1 ]
  %indvars.iv.next49 = add nsw i64 %indvars.iv489, -1
  %arrayidx171.us = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv489, i64 %indvars.iv50
  %45 = load float, float* %arrayidx171.us, align 4
  %mul157.us = fmul float %mul16.v.r2, %45
  %mul158.us = fmul float %tp1.07.us11, %mul25
  %add159.us = fadd float %mul157.us, %mul158.us
  %mul160.us = fmul float %exp2, %add163.us12
  %add161.us = fadd float %add159.us, %mul160.us
  %mul162.us = fmul float %yp1.19.us10, %sub30
  %add163.us = fadd float %add161.us, %mul162.us
  %arrayidx167.us = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv.next49, i64 %indvars.iv50
  store float %add163.us, float* %arrayidx167.us, align 4
  %cmp155.us = icmp sgt i64 %indvars.iv489, 1
  br i1 %cmp155.us, label %for.inc176.us.for.inc176.us_crit_edge.1, label %for.inc179.us

for.inc179.us:                                    ; preds = %for.inc176.us.for.inc176.us_crit_edge
  %indvars.iv.next51 = add nuw i64 %indvars.iv50, 1
  %cmp151.us = icmp slt i64 %indvars.iv.next51, 2160
  br i1 %cmp151.us, label %for.inc179.us.for.cond154.preheader.us_crit_edge, label %for.cond185.preheader.us.preheader

for.inc179.us.for.cond154.preheader.us_crit_edge: ; preds = %for.inc179.us
  br label %for.cond154.preheader.us

for.cond185.preheader.us.preheader:               ; preds = %for.inc179.us
  br label %for.cond185.preheader.us

for.cond185.preheader.us:                         ; preds = %for.inc205.us.for.cond185.preheader.us_crit_edge, %for.cond185.preheader.us.preheader
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc205.us.for.cond185.preheader.us_crit_edge ], [ 0, %for.cond185.preheader.us.preheader ]
  %scevgep74 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv46, i64 0
  %46 = add i64 %indvars.iv46, 1
  %scevgep76 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %46, i64 0
  %scevgep78 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv46, i64 0
  %scevgep80 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %46, i64 0
  %scevgep82 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv46, i64 0
...
vector.body69:                                    ; preds = %vector.body69.vector.body69_crit_edge, %vector.body69.preheader
  %index96 = phi i64 [ 0, %vector.body69.preheader ], [ %index.next97.1, %vector.body69.vector.body69_crit_edge ]
  %47 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv46, i64 %index96
  ...
  %51 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv46, i64 %index96
  ...
  %57 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv46, i64 %index96
  ...
  %61 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv46, i64 %index.next97
  ...
  %65 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv46, i64 %index.next97
  ...
  %71 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv46, i64 %index.next97
  ...
  br i1 %75, label %for.inc205.us.loopexit110, label %vector.body69.vector.body69_crit_edge, !llvm.loop !22

vector.body69.vector.body69_crit_edge:            ; preds = %vector.body69
  br label %vector.body69

for.inc202.us:                                    ; preds = %for.inc202.us.for.inc202.us_crit_edge, %for.inc202.us.preheader
  %indvars.iv = phi i64 [ 0, %for.inc202.us.preheader ], [ %indvars.iv.next.2, %for.inc202.us.for.inc202.us_crit_edge ]
  %arrayidx191.us = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv46, i64 %indvars.iv
  %76 = load float, float* %arrayidx191.us, align 4
  %arrayidx195.us = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv46, i64 %indvars.iv
  %77 = load float, float* %arrayidx195.us, align 4
  %add196.us = fadd float %76, %77
  %arrayidx201.us = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv46, i64 %indvars.iv
  store float %add196.us, float* %arrayidx201.us, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx191.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv46, i64 %indvars.iv.next
  %78 = load float, float* %arrayidx191.us.1, align 4
  %arrayidx195.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv46, i64 %indvars.iv.next
  %79 = load float, float* %arrayidx195.us.1, align 4
  %add196.us.1 = fadd float %78, %79
  %arrayidx201.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv46, i64 %indvars.iv.next
  store float %add196.us.1, float* %arrayidx201.us.1, align 4
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %arrayidx191.us.2 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv46, i64 %indvars.iv.next.1
  %80 = load float, float* %arrayidx191.us.2, align 4
  %arrayidx195.us.2 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv46, i64 %indvars.iv.next.1
  %81 = load float, float* %arrayidx195.us.2, align 4
  %add196.us.2 = fadd float %80, %81
  %arrayidx201.us.2 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv46, i64 %indvars.iv.next.1
  store float %add196.us.2, float* %arrayidx201.us.2, align 4
  %exitcond.2 = icmp eq i64 %indvars.iv.next.1, 2159
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  br i1 %exitcond.2, label %for.inc205.us.loopexit, label %for.inc202.us.for.inc202.us_crit_edge, !llvm.loop !23
...
for.inc205.us.loopexit110:                        ; preds = %vector.body69
  br label %for.inc205.us

for.inc205.us:                                    ; preds = %for.inc205.us.loopexit110, %for.inc205.us.loopexit
  %indvars.iv.next47 = add nuw i64 %indvars.iv46, 1
  %cmp183.us = icmp slt i64 %indvars.iv.next47, 4096
  br i1 %cmp183.us, label %for.inc205.us.for.cond185.preheader.us_crit_edge, label %for.end207

for.inc205.us.for.cond185.preheader.us_crit_edge: ; preds = %for.inc205.us
  br label %for.cond185.preheader.us

for.end207:                                       ; preds = %for.inc205.us
  ret void

for.inc176.us.for.inc176.us_crit_edge.1:          ; preds = %for.inc176.us.for.inc176.us_crit_edge
  %indvars.iv.next49.1 = add nsw i64 %indvars.iv489, -2
  %arrayidx171.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv.next49, i64 %indvars.iv50
  ...
  %arrayidx167.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv.next49.1, i64 %indvars.iv50
...
for.inc144.us.for.inc144.us_crit_edge.1:          ; preds = %for.inc144.us.for.inc144.us_crit_edge
  %indvars.iv.next53.1 = add nsw i64 %indvars.iv5222, 2
  %83 = load float, float* %arrayidx124.us, align 4
  %arrayidx124.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv.next53.1, i64 %indvars.iv55
  ...
  %arrayidx135.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv.next53.1, i64 %indvars.iv55
...
for.inc84.us.for.inc84.us_crit_edge.1:            ; preds = %for.inc84.us.for.inc84.us_crit_edge
  %indvars.iv.next63.1 = add nsw i64 %indvars.iv6234, -2
  %arrayidx79.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv64, i64 %indvars.iv.next63
  ...
  %arrayidx75.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv64, i64 %indvars.iv.next63.1
...
for.inc.us.for.inc.us_crit_edge.1:                ; preds = %for.inc.us.for.inc.us_crit_edge
  %indvars.iv.next67.1 = add nsw i64 %indvars.iv6647, 2
  %86 = load float, float* %arrayidx35.us, align 4
  %arrayidx35.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv69, i64 %indvars.iv.next67.1
  ...
  %arrayidx46.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv69, i64 %indvars.iv.next67.1
...
for.inc.us:                                       ; preds = %for.body4.us.for.inc.us_crit_edge, %if.then.us
  ...
  br i1 %cmp3.us, label %for.inc.us.for.body4.us_crit_edge, label %for.inc10.us
...
for.inc10.us:                                     ; preds = %for.inc.us
  %indvars.iv.next9 = add nuw i64 %indvars.iv8, 1
  %cmp.us = icmp slt i64 %indvars.iv.next9, 4096
  br i1 %cmp.us, label %for.inc10.us.for.cond2.preheader.us_crit_edge, label %for.end12
