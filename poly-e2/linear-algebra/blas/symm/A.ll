...
entry:
  ...
  store [1000 x [1200 x double]]* %0, [1000 x [1200 x double]]** %C, align 8
  %call1 = call i8* @polybench_alloc_data(i64 1000000, i32 8)
  %1 = bitcast i8* %call1 to [1000 x [1000 x double]]*
  store [1000 x [1000 x double]]* %1, [1000 x [1000 x double]]** %A, align 8
  %call2 = call i8* @polybench_alloc_data(i64 1200000, i32 8)
  %2 = bitcast i8* %call2 to [1000 x [1200 x double]]*
  store [1000 x [1200 x double]]* %2, [1000 x [1200 x double]]** %B, align 8
  %3 = load i32, i32* %m, align 4
  %4 = load i32, i32* %n, align 4
  %5 = load [1000 x [1200 x double]]*, [1000 x [1200 x double]]** %C, align 8
  %arraydecay = getelementptr inbounds [1000 x [1200 x double]], [1000 x [1200 x double]]* %5, i32 0, i32 0
  %6 = load [1000 x [1000 x double]]*, [1000 x [1000 x double]]** %A, align 8
  %arraydecay3 = getelementptr inbounds [1000 x [1000 x double]], [1000 x [1000 x double]]* %6, i32 0, i32 0
  %7 = load [1000 x [1200 x double]]*, [1000 x [1200 x double]]** %B, align 8
  %arraydecay4 = getelementptr inbounds [1000 x [1200 x double]], [1000 x [1200 x double]]* %7, i32 0, i32 0
  call void @init_array(i32 %3, i32 %4, double* %alpha, double* %beta, [1200 x double]* %arraydecay, [1000 x double]* %arraydecay3, [1200 x double]* %arraydecay4)
  call void (...) @polybench_timer_start()
  %8 = load i32, i32* %m, align 4
  %9 = load i32, i32* %n, align 4
  %10 = load double, double* %alpha, align 8
  %11 = load double, double* %beta, align 8
  %12 = load [1000 x [1200 x double]]*, [1000 x [1200 x double]]** %C, align 8
  %arraydecay5 = getelementptr inbounds [1000 x [1200 x double]], [1000 x [1200 x double]]* %12, i32 0, i32 0
  %13 = load [1000 x [1000 x double]]*, [1000 x [1000 x double]]** %A, align 8
  %arraydecay6 = getelementptr inbounds [1000 x [1000 x double]], [1000 x [1000 x double]]* %13, i32 0, i32 0
  %14 = load [1000 x [1200 x double]]*, [1000 x [1200 x double]]** %B, align 8
  %arraydecay7 = getelementptr inbounds [1000 x [1200 x double]], [1000 x [1200 x double]]* %14, i32 0, i32 0
  call void @kernel_symm(i32 %8, i32 %9, double %10, double %11, [1200 x double]* %arraydecay5, [1000 x double]* %arraydecay6, [1200 x double]* %arraydecay7)
...
land.lhs.true:                                    ; preds = %entry
  ...
  %call8 = call i32 @strcmp(i8* %17, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i32 0, i32 0)) #4
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %20 = load [1000 x [1200 x double]]*, [1000 x [1200 x double]]** %C, align 8
  %arraydecay9 = getelementptr inbounds [1000 x [1200 x double]], [1000 x [1200 x double]]* %20, i32 0, i32 0
  call void @print_array(i32 %18, i32 %19, [1200 x double]* %arraydecay9)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  %21 = load [1000 x [1200 x double]]*, [1000 x [1200 x double]]** %C, align 8
  %22 = bitcast [1000 x [1200 x double]]* %21 to i8*
  call void @free(i8* %22) #5
  %23 = load [1000 x [1000 x double]]*, [1000 x [1000 x double]]** %A, align 8
  %24 = bitcast [1000 x [1000 x double]]* %23 to i8*
  call void @free(i8* %24) #5
  %25 = load [1000 x [1200 x double]]*, [1000 x [1200 x double]]** %B, align 8
...
for.body3:                                        ; preds = %for.cond1
  ...
  %9 = load [1200 x double]*, [1200 x double]** %C.addr, align 8
  %10 = load i32, i32* %i, align 4
  %idxprom = sext i32 %10 to i64
  %arrayidx = getelementptr inbounds [1200 x double], [1200 x double]* %9, i64 %idxprom
  ...
  %16 = load [1200 x double]*, [1200 x double]** %B.addr, align 8
  %17 = load i32, i32* %i, align 4
  %idxprom12 = sext i32 %17 to i64
  %arrayidx13 = getelementptr inbounds [1200 x double], [1200 x double]* %16, i64 %idxprom12
...
for.body26:                                       ; preds = %for.cond23
  ...
  %arrayidx33 = getelementptr inbounds [1000 x double], [1000 x double]* %28, i64 %idxprom32
...
for.body43:                                       ; preds = %for.cond40
  %35 = load [1000 x double]*, [1000 x double]** %A.addr, align 8
  %36 = load i32, i32* %i, align 4
  %idxprom44 = sext i32 %36 to i64
  %arrayidx45 = getelementptr inbounds [1000 x double], [1000 x double]* %35, i64 %idxprom44
...
for.body6:                                        ; preds = %for.cond4
  ...
  %7 = load [1200 x double]*, [1200 x double]** %B.addr, align 8
  %8 = load i32, i32* %i, align 4
  %idxprom = sext i32 %8 to i64
  %arrayidx = getelementptr inbounds [1200 x double], [1200 x double]* %7, i64 %idxprom
  ...
  %arrayidx10 = getelementptr inbounds [1000 x double], [1000 x double]* %11, i64 %idxprom9
  ...
  %15 = load [1200 x double]*, [1200 x double]** %C.addr, align 8
  %16 = load i32, i32* %k, align 4
  %idxprom14 = sext i32 %16 to i64
  %arrayidx15 = getelementptr inbounds [1200 x double], [1200 x double]* %15, i64 %idxprom14
  ...
  %19 = load [1200 x double]*, [1200 x double]** %B.addr, align 8
  %20 = load i32, i32* %k, align 4
  %idxprom18 = sext i32 %20 to i64
  %arrayidx19 = getelementptr inbounds [1200 x double], [1200 x double]* %19, i64 %idxprom18
  ...
  %23 = load [1000 x double]*, [1000 x double]** %A.addr, align 8
  %24 = load i32, i32* %i, align 4
...
for.end:                                          ; preds = %for.cond4
  ...
  %35 = load [1200 x double]*, [1200 x double]** %B.addr, align 8
  %36 = load i32, i32* %i, align 4
  %idxprom33 = sext i32 %36 to i64
  %arrayidx34 = getelementptr inbounds [1200 x double], [1200 x double]* %35, i64 %idxprom33
  %37 = load i32, i32* %j, align 4
  ...
  %arrayidx39 = getelementptr inbounds [1000 x double], [1000 x double]* %39, i64 %idxprom38
  ...
  %45 = load [1200 x double]*, [1200 x double]** %C.addr, align 8
