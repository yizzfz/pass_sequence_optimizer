...
for.cond29.preheader:                             ; preds = %for.body16
  ...
  %cmp3038 = icmp slt i64 %indvars.iv.next92, %4
...
for.cond51.for.inc62_crit_edge.us.prol:           ; preds = %for.cond51.for.inc62_crit_edge.us.prol.preheader, %for.cond51.for.inc62_crit_edge.us.prol
  ...
  %23 = mul nuw nsw i64 %indvars.iv67.prol, 16000
...
for.cond51.preheader.us.prol.loopexit:            ; preds = %for.cond51.preheader.us.prol.loopexit.loopexit, %for.cond51.preheader.us.preheader
  ...
  br i1 %24, label %for.cond69.preheader.lr.ph, label %for.cond51.for.inc62_crit_edge.us.3.preheader
...
for.cond51.for.inc62_crit_edge.us.3.preheader:    ; preds = %for.cond51.preheader.us.prol.loopexit
  ...
  %25 = add nsw i64 %wide.trip.count69.3, -4
  %26 = sub i64 %25, %indvars.iv67.unr
  %27 = lshr i64 %26, 2
  %28 = and i64 %27, 1
  %lcmp.mod119 = icmp eq i64 %28, 0
...
for.cond51.for.inc62_crit_edge.us.3.prol:         ; preds = %for.cond51.for.inc62_crit_edge.us.3.prol.preheader
  %29 = mul nuw nsw i64 %indvars.iv67.unr, 16000
  %scevgep.prol121 = getelementptr i8, i8* %call, i64 %29
  call void @llvm.memset.p0i8.i64(i8* %scevgep.prol121, i8 0, i64 %22, i32 8, i1 false)
  ...
  %32 = mul i64 %indvars.iv67.unr, 16000
  %33 = add i64 %32, 32000
  ...
  %34 = mul i64 %indvars.iv67.unr, 16000
  %35 = add i64 %34, 48000
...
for.cond51.for.inc62_crit_edge.us.3.prol.loopexit: ; preds = %for.cond51.for.inc62_crit_edge.us.3.prol, %for.cond51.for.inc62_crit_edge.us.3.preheader
  ...
  %36 = icmp eq i64 %27, 0
  br i1 %36, label %for.cond65.preheader, label %for.cond51.for.inc62_crit_edge.us.3.preheader.new
...
for.body76.us.us.prol:                            ; preds = %for.cond73.preheader.us.us
  ...
  %arrayidx88.us.us.prol = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %18, i64 0, i64 %indvars.iv55, i64 0
...
for.body76.us.us.prol.loopexit:                   ; preds = %for.body76.us.us.prol, %for.cond73.preheader.us.us
  ...
  br i1 %37, label %for.cond73.for.inc93_crit_edge.us.us, label %for.body76.us.us.preheader
...
for.body76.us.us:                                 ; preds = %for.body76.us.us.preheader, %for.body76.us.us
  ...
  %arrayidx88.us.us = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %18, i64 0, i64 %indvars.iv55, i64 %indvars.iv49
  ...
  %arrayidx88.us.us.1 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %18, i64 0, i64 %indvars.iv55, i64 %indvars.iv.next50
...
for.body106.us.prol:                              ; preds = %for.body106.us.prol.preheader, %for.body106.us.prol
  ...
  %arrayidx110.us.prol = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %18, i64 0, i64 %indvars.iv46, i64 %indvars.iv.prol
...
for.body106.us.prol.loopexit:                     ; preds = %for.body106.us.prol.loopexit.loopexit, %for.cond103.preheader.us
  ...
  br i1 %48, label %for.cond103.for.inc118_crit_edge.us, label %for.body106.us.preheader
...
for.body106.us:                                   ; preds = %for.body106.us.preheader, %for.body106.us
  ...
  %arrayidx110.us = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %18, i64 0, i64 %indvars.iv46, i64 %indvars.iv
  ...
  %arrayidx110.us.1 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %18, i64 0, i64 %indvars.iv46, i64 %indvars.iv.next
  ...
  %arrayidx110.us.2 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %18, i64 0, i64 %indvars.iv46, i64 %indvars.iv.next.1
  ...
  %arrayidx110.us.3 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %18, i64 0, i64 %indvars.iv46, i64 %indvars.iv.next.2
...
for.cond51.for.inc62_crit_edge.us.3:              ; preds = %for.cond51.for.inc62_crit_edge.us.3, %for.cond51.for.inc62_crit_edge.us.3.preheader.new
  ...
  %64 = mul nuw nsw i64 %indvars.iv67, 16000
  ...
  %71 = mul nuw nsw i64 %indvars.iv.next68.3, 16000
  %scevgep.1123 = getelementptr i8, i8* %call, i64 %71
  call void @llvm.memset.p0i8.i64(i8* %scevgep.1123, i8 0, i64 %22, i32 8, i1 false)
