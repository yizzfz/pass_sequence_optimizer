...
for.cond1.preheader.lr.ph:                        ; preds = %entry
  ...
  br i1 %cmp232, label %for.cond1.preheader.us.preheader, label %for.cond1.preheader.lr.ph.for.cond24.preheader.lr.ph_crit_edge
...
for.cond1.for.inc17_crit_edge.us:                 ; preds = %for.inc.us
  ...
  br i1 %exitcond54, label %for.cond24.preheader.lr.ph.loopexit, label %for.cond1.preheader.us
...
for.cond24.preheader.lr.ph:                       ; preds = %for.cond24.preheader.lr.ph.loopexit, %for.cond1.preheader.lr.ph.for.cond24.preheader.lr.ph_crit_edge
  %wide.trip.count.pre-phi = phi i64 [ %.pre, %for.cond1.preheader.lr.ph.for.cond24.preheader.lr.ph_crit_edge ], [ %wide.trip.count53, %for.cond24.preheader.lr.ph.loopexit ]
...
for.cond24.for.inc41_crit_edge.us:                ; preds = %for.inc38.us
  ...
  %exitcond43 = icmp eq i64 %indvars.iv.next41, %wide.trip.count.pre-phi
...
for.inc.lr.ph.us.preheader:                       ; preds = %for.cond1.preheader.lr.ph
  ...
  %broadcast.splatinsert169 = insertelement <2 x double> undef, double %beta, i32 0
  %broadcast.splat170 = shufflevector <2 x double> %broadcast.splatinsert169, <2 x double> undef, <2 x i32> zeroinitializer
...
for.inc.us:                                       ; preds = %for.inc.us.preheader172, %for.inc.us
  %indvars.iv = phi i64 [ %indvars.iv.next.3, %for.inc.us ], [ %indvars.iv.ph, %for.inc.us.preheader172 ]
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx5.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv77, i64 %indvars.iv.next
  ...
  %arrayidx5.us.3 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv77, i64 %indvars.iv.next.2
  ...
  %exitcond.3 = icmp eq i64 %indvars.iv.next.3, %indvars.iv75
...
for.cond9.preheader.us34.preheader:               ; preds = %for.cond9.preheader.us34.preheader.loopexit, %middle.block147, %for.inc.us.prol.loopexit
  %min.iters.check105 = icmp ult i64 %42, 2
  %n.vec108 = and i64 %42, -2
  %cmp.zero109 = icmp eq i64 %n.vec108, 0
  %cmp.n140 = icmp eq i64 %42, %n.vec108
...
for.cond9.preheader.us34:                         ; preds = %for.cond9.preheader.us34.preheader, %for.cond9.for.inc40_crit_edge.us57
  ...
  %scevgep114 = getelementptr [1000 x double], [1000 x double]* %A, i64 0, i64 %indvars.iv70
  %4 = add i64 %indvars.iv70, 1
  %scevgep116 = getelementptr [1000 x double], [1000 x double]* %A, i64 %indvars.iv77, i64 %4
  %scevgep118 = getelementptr [1000 x double], [1000 x double]* %B, i64 0, i64 %indvars.iv70
  %scevgep120 = getelementptr [1000 x double], [1000 x double]* %B, i64 %indvars.iv77, i64 %4
  ...
  br i1 %min.iters.check105, label %for.inc37.us36.preheader, label %min.iters.checked106

min.iters.checked106:                             ; preds = %for.cond9.preheader.us34
  br i1 %cmp.zero109, label %for.inc37.us36.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked106
  %bound0 = icmp ult double* %scevgep, %arrayidx30.us56
  %bound1 = icmp ult double* %arrayidx30.us56, %scevgep112
  %found.conflict = and i1 %bound0, %bound1
  %bound0123 = icmp ult double* %scevgep, %scevgep116
  %bound1124 = icmp ult double* %scevgep114, %scevgep112
  %found.conflict125 = and i1 %bound0123, %bound1124
  %conflict.rdx = or i1 %found.conflict, %found.conflict125
  %bound0126 = icmp ult double* %scevgep, %scevgep120
  %bound1127 = icmp ult double* %scevgep118, %scevgep112
  %found.conflict128 = and i1 %bound0126, %bound1127
  %conflict.rdx129 = or i1 %conflict.rdx, %found.conflict128
  %bound0132 = icmp ult double* %scevgep, %arrayidx20.us55
  %bound1133 = icmp ult double* %arrayidx20.us55, %scevgep112
  %found.conflict134 = and i1 %bound0132, %bound1133
  %conflict.rdx135 = or i1 %conflict.rdx129, %found.conflict134
  br i1 %conflict.rdx135, label %for.inc37.us36.preheader, label %vector.ph136

vector.ph136:                                     ; preds = %vector.memcheck
  br label %vector.body102

vector.body102:                                   ; preds = %vector.body102, %vector.ph136
  %index137 = phi i64 [ 0, %vector.ph136 ], [ %index.next138, %vector.body102 ]
  %5 = or i64 %index137, 1
  %6 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %index137, i64 %indvars.iv70
  %7 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %5, i64 %indvars.iv70
  ...
  %12 = fmul <2 x double> %11, %broadcast.splat145
  ...
  %17 = getelementptr inbounds [1000 x double], [1000 x double]* %B, i64 %index137, i64 %indvars.iv70
  %18 = getelementptr inbounds [1000 x double], [1000 x double]* %B, i64 %5, i64 %indvars.iv70
  ...
  %23 = fmul <2 x double> %22, %broadcast.splat145
  ...
  %29 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv77, i64 %index137
  ...
  %33 = icmp eq i64 %index.next138, %n.vec108
  br i1 %33, label %middle.block103, label %vector.body102, !llvm.loop !17

middle.block103:                                  ; preds = %vector.body102
  br i1 %cmp.n140, label %for.cond9.for.inc40_crit_edge.us57, label %for.inc37.us36.preheader

for.inc37.us36.preheader:                         ; preds = %middle.block103, %vector.memcheck, %min.iters.checked106, %for.cond9.preheader.us34
  %indvars.iv64.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %min.iters.checked106 ], [ 0, %for.cond9.preheader.us34 ], [ %n.vec108, %middle.block103 ]
...
for.inc37.us36:                                   ; preds = %for.inc37.us36.preheader, %for.inc37.us36
  ...
  br i1 %exitcond69, label %for.cond9.for.inc40_crit_edge.us57.loopexit, label %for.inc37.us36, !llvm.loop !18

for.inc.lr.ph.us:                                 ; preds = %for.inc.lr.ph.us.preheader, %for.cond6.for.inc43_crit_edge.us
  %indvars.iv77 = phi i64 [ %43, %for.cond6.for.inc43_crit_edge.us ], [ 0, %for.inc.lr.ph.us.preheader ]
  %indvars.iv75 = phi i64 [ %indvars.iv.next76, %for.cond6.for.inc43_crit_edge.us ], [ 1, %for.inc.lr.ph.us.preheader ]
  %39 = add i64 %indvars.iv77, -3
  %scevgep = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv77, i64 0
  %40 = mul i64 %indvars.iv77, 1201
  %41 = add i64 %40, 1
  %scevgep112 = getelementptr [1200 x double], [1200 x double]* %C, i64 0, i64 %41
  %42 = add i64 %indvars.iv77, 1
  %43 = add i64 %indvars.iv77, 1
...
for.inc.us.prol.loopexit:                         ; preds = %for.inc.us.prol.loopexit.loopexit, %for.inc.lr.ph.us
  ...
  %45 = icmp ult i64 %indvars.iv77, 3
...
for.inc.us.preheader:                             ; preds = %for.inc.us.prol.loopexit
  ...
  %min.iters.check149 = icmp ult i64 %48, 2
  br i1 %min.iters.check149, label %for.inc.us.preheader172, label %min.iters.checked150

for.inc.us.preheader172:                          ; preds = %middle.block147, %min.iters.checked150, %for.inc.us.preheader
  %indvars.iv.ph = phi i64 [ %indvars.iv.unr, %min.iters.checked150 ], [ %indvars.iv.unr, %for.inc.us.preheader ], [ %ind.end158, %middle.block147 ]
  br label %for.inc.us

min.iters.checked150:                             ; preds = %for.inc.us.preheader
  %n.mod.vf151 = and i64 %48, 1
  %n.vec152 = sub nsw i64 %48, %n.mod.vf151
  %cmp.zero153 = icmp eq i64 %n.vec152, 0
  %49 = add i64 %indvars.iv.unr, 4
  %50 = shl nuw i64 %47, 2
  %51 = add i64 %49, %50
  %52 = shl nuw nsw i64 %n.mod.vf151, 2
  %ind.end158 = sub i64 %51, %52
  br i1 %cmp.zero153, label %for.inc.us.preheader172, label %vector.ph154

vector.ph154:                                     ; preds = %min.iters.checked150
  br label %vector.body146

vector.body146:                                   ; preds = %vector.body146, %vector.ph154
  %index155 = phi i64 [ 0, %vector.ph154 ], [ %index.next156, %vector.body146 ]
  %53 = shl i64 %index155, 2
  %54 = add i64 %indvars.iv.unr, %53
  %55 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv77, i64 %54
  %56 = bitcast double* %55 to <8 x double>*
  %wide.vec164 = load <8 x double>, <8 x double>* %56, align 8
  %strided.vec165 = shufflevector <8 x double> %wide.vec164, <8 x double> undef, <2 x i32> <i32 0, i32 4>
  %strided.vec166 = shufflevector <8 x double> %wide.vec164, <8 x double> undef, <2 x i32> <i32 1, i32 5>
  %strided.vec167 = shufflevector <8 x double> %wide.vec164, <8 x double> undef, <2 x i32> <i32 2, i32 6>
  %strided.vec168 = shufflevector <8 x double> %wide.vec164, <8 x double> undef, <2 x i32> <i32 3, i32 7>
  %57 = fmul <2 x double> %strided.vec165, %broadcast.splat170
  %58 = fmul <2 x double> %strided.vec166, %broadcast.splat170
  %59 = fmul <2 x double> %strided.vec167, %broadcast.splat170
  %60 = add nsw i64 %54, 3
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv77, i64 %60
  %62 = fmul <2 x double> %strided.vec168, %broadcast.splat170
  ...
  %interleaved.vec171 = shufflevector <4 x double> %65, <4 x double> %66, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 1, i32 3, i32 5, i32 7>
  store <8 x double> %interleaved.vec171, <8 x double>* %64, align 8
  %index.next156 = add i64 %index155, 2
  %67 = icmp eq i64 %index.next156, %n.vec152
  br i1 %67, label %middle.block147, label %vector.body146, !llvm.loop !21

middle.block147:                                  ; preds = %vector.body146
  %cmp.n159 = icmp eq i64 %n.mod.vf151, 0
  br i1 %cmp.n159, label %for.cond9.preheader.us34.preheader, label %for.inc.us.preheader172

for.cond9.for.inc40_crit_edge.us57.loopexit:      ; preds = %for.inc37.us36
  br label %for.cond9.for.inc40_crit_edge.us57

for.cond9.for.inc40_crit_edge.us57:               ; preds = %for.cond9.for.inc40_crit_edge.us57.loopexit, %middle.block103
...
for.cond6.for.inc43_crit_edge.us:                 ; preds = %for.cond9.for.inc40_crit_edge.us57
  ...
  %exitcond80 = icmp eq i64 %43, %wide.trip.count79
  br i1 %exitcond80, label %for.end45.loopexit, label %for.inc.lr.ph.us

for.inc.lr.ph:                                    ; preds = %for.inc.lr.ph.preheader, %for.inc43
  %indvars.iv88 = phi i64 [ %69, %for.inc43 ], [ 0, %for.inc.lr.ph.preheader ]
  %indvars.iv86 = phi i64 [ %indvars.iv.next87, %for.inc43 ], [ 1, %for.inc.lr.ph.preheader ]
  %68 = add i64 %indvars.iv88, -3
  %69 = add i64 %indvars.iv88, 1
  %xtraiter92 = and i64 %69, 3
...
for.inc.prol:                                     ; preds = %for.inc.prol.preheader, %for.inc.prol
  ...
  %prol.iter94.sub = add i64 %prol.iter94, -1
  %prol.iter94.cmp = icmp eq i64 %prol.iter94.sub, 0
  br i1 %prol.iter94.cmp, label %for.inc.prol.loopexit.loopexit, label %for.inc.prol, !llvm.loop !22
...
for.inc.prol.loopexit:                            ; preds = %for.inc.prol.loopexit.loopexit, %for.inc.lr.ph
  %indvars.iv81.unr = phi i64 [ 0, %for.inc.lr.ph ], [ %indvars.iv.next82.prol, %for.inc.prol.loopexit.loopexit ]
  %71 = icmp ult i64 %indvars.iv88, 3
  br i1 %71, label %for.inc43, label %for.inc.preheader

for.inc.preheader:                                ; preds = %for.inc.prol.loopexit
  %72 = sub i64 %68, %indvars.iv81.unr
  %73 = lshr i64 %72, 2
  %74 = add nuw nsw i64 %73, 1
  %min.iters.check = icmp ult i64 %74, 2
  br i1 %min.iters.check, label %for.inc.preheader173, label %min.iters.checked

min.iters.checked:                                ; preds = %for.inc.preheader
  %n.mod.vf = and i64 %74, 1
  %n.vec = sub nsw i64 %74, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  %75 = add i64 %indvars.iv81.unr, 4
  %76 = shl nuw i64 %73, 2
  %77 = add i64 %75, %76
  %78 = shl nuw nsw i64 %n.mod.vf, 2
  %ind.end = sub i64 %77, %78
  br i1 %cmp.zero, label %for.inc.preheader173, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %79 = shl i64 %index, 2
  %80 = add i64 %indvars.iv81.unr, %79
  %81 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv88, i64 %80
  %82 = bitcast double* %81 to <8 x double>*
  %wide.vec = load <8 x double>, <8 x double>* %82, align 8
  %strided.vec = shufflevector <8 x double> %wide.vec, <8 x double> undef, <2 x i32> <i32 0, i32 4>
  %strided.vec97 = shufflevector <8 x double> %wide.vec, <8 x double> undef, <2 x i32> <i32 1, i32 5>
  %strided.vec98 = shufflevector <8 x double> %wide.vec, <8 x double> undef, <2 x i32> <i32 2, i32 6>
  %strided.vec99 = shufflevector <8 x double> %wide.vec, <8 x double> undef, <2 x i32> <i32 3, i32 7>
  %83 = fmul <2 x double> %strided.vec, %broadcast.splat101
  %84 = fmul <2 x double> %strided.vec97, %broadcast.splat101
  %85 = fmul <2 x double> %strided.vec98, %broadcast.splat101
  %86 = add nsw i64 %80, 3
  %87 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv88, i64 %86
  %88 = fmul <2 x double> %strided.vec99, %broadcast.splat101
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.inc43, label %for.inc.preheader173

for.inc.preheader173:                             ; preds = %middle.block, %min.iters.checked, %for.inc.preheader
  %indvars.iv81.ph = phi i64 [ %indvars.iv81.unr, %min.iters.checked ], [ %indvars.iv81.unr, %for.inc.preheader ], [ %ind.end, %middle.block ]
  br label %for.inc

for.inc:                                          ; preds = %for.inc.preheader173, %for.inc
  %indvars.iv81 = phi i64 [ %indvars.iv.next82.3, %for.inc ], [ %indvars.iv81.ph, %for.inc.preheader173 ]
  ...
  %arrayidx5.1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv88, i64 %indvars.iv.next82
  ...
  %indvars.iv.next82.2 = add nsw i64 %indvars.iv81, 3
  %arrayidx5.3 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv88, i64 %indvars.iv.next82.2
  %97 = load double, double* %arrayidx5.3, align 8
  %mul.3 = fmul double %97, %beta
  store double %mul.3, double* %arrayidx5.3, align 8
  %indvars.iv.next82.3 = add nsw i64 %indvars.iv81, 4
  %exitcond85.3 = icmp eq i64 %indvars.iv.next82.3, %indvars.iv86
  br i1 %exitcond85.3, label %for.inc43.loopexit, label %for.inc, !llvm.loop !24
...
for.inc43:                                        ; preds = %for.inc43.loopexit, %middle.block, %for.inc.prol.loopexit
  ...
  %exitcond91 = icmp eq i64 %69, %wide.trip.count90
  br i1 %exitcond91, label %for.end45.loopexit174, label %for.inc.lr.ph

for.end45.loopexit:                               ; preds = %for.cond6.for.inc43_crit_edge.us
  br label %for.end45

for.end45.loopexit174:                            ; preds = %for.inc43
  br label %for.end45

for.end45:                                        ; preds = %for.end45.loopexit174, %for.end45.loopexit, %entry
  ret void
}
...
for.cond2.for.inc10_crit_edge.us:                 ; preds = %for.inc.us
  ...
  %exitcond18 = icmp eq i64 %indvars.iv.next15, %wide.trip.count
