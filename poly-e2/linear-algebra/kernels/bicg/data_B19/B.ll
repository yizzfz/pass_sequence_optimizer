...
entry:
  ...
  tail call fastcc void @init_array([1900 x double]* %arraydecay1, double* %arraydecay52, double* %arraydecay63)
  tail call void (...) @polybench_timer_start() #4
  %arraydecay74 = bitcast i8* %call to [1900 x double]*
  %arraydecay85 = bitcast i8* %call1 to double*
  %arraydecay96 = bitcast i8* %call2 to double*
  %arraydecay107 = bitcast i8* %call3 to double*
  %arraydecay118 = bitcast i8* %call4 to double*
  tail call fastcc void @kernel_bicg([1900 x double]* %arraydecay74, double* %arraydecay85, double* %arraydecay96, double* %arraydecay107, double* %arraydecay118)
...
if.then:                                          ; preds = %land.lhs.true
  %arraydecay1310 = bitcast i8* %call1 to double*
  %arraydecay1411 = bitcast i8* %call2 to double*
  tail call fastcc void @print_array(double* %arraydecay1310, double* %arraydecay1411)
  br label %if.end
...
for.cond12.for.inc27_crit_edge.us:                ; preds = %for.inc24.us
  ...
  %cmp3.us = icmp slt i64 %indvars.iv.next3, 2100
  br i1 %cmp3.us, label %for.body5.us, label %for.end29

for.inc:                                          ; preds = %for.inc, %for.inc.lr.ph
  %indvars.iv4 = phi i64 [ 0, %for.inc.lr.ph ], [ %indvars.iv.next5.1, %for.inc ]
  ...
  %7 = trunc i64 %indvars.iv.next5 to i32
  ...
  %exitcond6.1 = icmp eq i64 %indvars.iv.next5, 1899
  %indvars.iv.next5.1 = add nsw i64 %indvars.iv4, 2
  br i1 %exitcond6.1, label %for.body5.us.preheader, label %for.inc
...
for.body3.us.preheader:
  %s6 = bitcast double* %s to i8*
  call void @llvm.memset.p0i8.i64(i8* %s6, i8 0, i64 15200, i32 8, i1 false)
...
for.inc31.us:                                     ; preds = %for.inc31.us, %for.body3.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc31.us ], [ 0, %for.body3.us ]
  ...
  %sunkaddr26 = mul i64 %indvars.iv1, 8
...
for.cond6.for.inc34_crit_edge.us:                 ; preds = %for.inc31.us
  ...
  %cmp2.us = icmp slt i64 %indvars.iv.next2, 2100
...
for.inc:                                          ; preds = %for.body, %if.then
  ...
  %indvars.iv.next2 = add nuw i64 %indvars.iv1, 1
  %cmp = icmp slt i64 %indvars.iv.next2, 1900
  br i1 %cmp, label %for.body, label %for.body9.preheader
