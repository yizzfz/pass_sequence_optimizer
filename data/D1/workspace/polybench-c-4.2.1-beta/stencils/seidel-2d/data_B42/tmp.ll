...
; <label>:21:                                     ; preds = %7
  ...
  br i1 %exitcond6, label %22, label %.preheader
...
.preheader3:                                      ; preds = %._crit_edge6, %3
  %.027 = phi i32 [ 0, %3 ], [ %33, %._crit_edge6 ]
  br label %.preheader

.preheader:                                       ; preds = %.preheader3, %._crit_edge
  %indvar = phi i64 [ 0, %.preheader3 ], [ %indvar.next, %._crit_edge ]
  %indvars.iv8 = phi i64 [ 1, %.preheader3 ], [ %indvars.iv.next9, %._crit_edge ]
  %4 = add i64 %indvar, 1
...
; <label>:6:                                      ; preds = %.preheader, %6
  ...
  %17 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv8, i64 %indvars.iv
  %18 = load double, double* %17, align 8
  %19 = fadd double %16, %18
  %20 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv8, i64 %indvars.iv.next
  %21 = load double, double* %20, align 8
  %22 = fadd double %19, %21
  %23 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next9, i64 %7
  %24 = load double, double* %23, align 8
  %25 = fadd double %22, %24
  %26 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next9, i64 %indvars.iv
  %27 = load double, double* %26, align 8
  %28 = fadd double %25, %27
  %29 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next9, i64 %indvars.iv.next
...
._crit_edge:                                      ; preds = %6
  %exitcond10 = icmp eq i64 %indvars.iv.next9, 1999
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond10, label %._crit_edge6, label %.preheader

._crit_edge6:                                     ; preds = %._crit_edge
  %33 = add nuw nsw i32 %.027, 1
  %exitcond11 = icmp eq i32 %33, 500
  br i1 %exitcond11, label %34, label %.preheader3
...
; <label>:15:                                     ; preds = %13, %8
  ...
  %17 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv4, i64 %indvars.iv
  %18 = load double, double* %17, align 8
