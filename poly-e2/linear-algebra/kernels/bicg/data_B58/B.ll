...
for.body15.us:                                    ; preds = %for.body15.us, %for.body5.us
  ...
  br i1 %exitcond.1, label %for.inc27.us, label %for.body15.us

for.inc27.us:                                     ; preds = %for.body15.us
...
for.body8.us:                                     ; preds = %for.body8.us, %for.body3.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body8.us ], [ 0, %for.body3.us ]
  ...
  br i1 %exitcond, label %for.inc34.us, label %for.body8.us

for.inc34.us:                                     ; preds = %for.body8.us
