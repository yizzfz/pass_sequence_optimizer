...
for.cond12.for.inc27_crit_edge.us:                ; preds = %for.inc24.us
  ...
  %exitcond12 = icmp eq i64 %indvars.iv.next11, 2100
  br i1 %exitcond12, label %for.end29, label %for.body5.us

for.inc:                                          ; preds = %for.inc, %for.inc.lr.ph
  %indvars.iv16 = phi i64 [ 0, %for.inc.lr.ph ], [ %indvars.iv.next17.1.1, %for.inc ]
  %6 = trunc i64 %indvars.iv16 to i32
  %conv = sitofp i32 %6 to double
  %arrayidx = getelementptr inbounds double, double* %p, i64 %indvars.iv16
  ...
  %conv.119 = sitofp i32 %10 to double
  %arrayidx.1 = getelementptr inbounds double, double* %p, i64 %indvars.iv.next17.1
  %11 = trunc i64 %indvars.iv.next17.1 to i32
  %12 = or i32 %11, 1
  %conv.1.1 = sitofp i32 %12 to double
  %div.v.i0.1.1 = insertelement <2 x double> undef, double %conv.119, i32 0
  ...
  %exitcond18.1.1 = icmp eq i64 %indvars.iv.next17.1.1, 1900
  br i1 %exitcond18.1.1, label %for.body5.us.preheader, label %for.inc
...
for.inc31.us:                                     ; preds = %for.inc31.us, %for.body3.us
  ...
  %sunkaddr29 = ptrtoint double* %q to i64
  %sunkaddr30 = mul i64 %indvars.iv8, 8
  %sunkaddr31 = add i64 %sunkaddr29, %sunkaddr30
  %sunkaddr32 = inttoptr i64 %sunkaddr31 to double*
  %3 = load double, double* %sunkaddr32, align 8
  ...
  store double %add28.us, double* %sunkaddr32, align 8
