...
entry:
  ...
  br i1 %cmp16, label %for.body.lr.ph, label %for.end26
...
for.body.us:                                      ; preds = %for.cond2.for.inc24_crit_edge.us, %for.body.lr.ph
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.cond2.for.inc24_crit_edge.us ], [ 0, %for.body.lr.ph ]
  %0 = trunc i64 %indvars.iv22 to i32
  %conv.us = sitofp i32 %0 to double
  %div.us = fdiv double %conv.us, %conv1
  %arrayidx.us = getelementptr inbounds double, double* %x, i64 %indvars.iv22
...
for.inc.us:                                       ; preds = %for.inc.us, %for.body.us
  ...
  %arrayidx13.us = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv22, i64 %indvars.iv
  ...
  %arrayidx23.us = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv22, i64 %indvars.iv
...
for.cond2.for.inc24_crit_edge.us:                 ; preds = %for.inc.us
  ...
  br i1 %exitcond25, label %for.end26.loopexit, label %for.body.us
...
entry:
  ...
  br i1 %cmp21, label %for.body.us.preheader, label %for.end41

for.body.us.preheader:                            ; preds = %entry
  %wide.trip.count = zext i32 %n to i64
  br label %for.body.us

for.body.us:                                      ; preds = %for.body.us.preheader, %for.cond5.for.inc39_crit_edge.us
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.cond5.for.inc39_crit_edge.us ], [ 0, %for.body.us.preheader ]
  %arrayidx.us = getelementptr inbounds double, double* %tmp, i64 %indvars.iv23
  store double 0.000000e+00, double* %arrayidx.us, align 8
  %arrayidx4.us = getelementptr inbounds double, double* %y, i64 %indvars.iv23
  store double 0.000000e+00, double* %arrayidx4.us, align 8
  br label %for.inc.us

for.inc.us:                                       ; preds = %for.inc.us, %for.body.us
  %indvars.iv = phi i64 [ 0, %for.body.us ], [ %indvars.iv.next, %for.inc.us ]
  %arrayidx11.us = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv23, i64 %indvars.iv
  ...
  %arrayidx21.us = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv23, i64 %indvars.iv
...
for.cond5.for.inc39_crit_edge.us:                 ; preds = %for.inc.us
  ...
  br i1 %exitcond26, label %for.end41.loopexit, label %for.body.us
