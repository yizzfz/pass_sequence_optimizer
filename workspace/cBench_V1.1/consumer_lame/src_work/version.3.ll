...
@__llvm_prf_nm = private constant [70 x i8] c"D\00lame_print_version\01get_lame_version\01get_psy_version\01get_mp3x_version", section "__llvm_prf_names"
@llvm.used = appending global [5 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_lame_print_version to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_get_lame_version to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_get_psy_version to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_get_mp3x_version to i8*), i8* getelementptr inbounds ([70 x i8], [70 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
