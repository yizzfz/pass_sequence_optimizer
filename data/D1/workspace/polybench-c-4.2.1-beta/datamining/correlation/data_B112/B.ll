...
.lr.ph135.split.us:                               ; preds = %._crit_edge.us, %.lr.ph135.split.us.preheader
  %indvars.iv81 = phi i64 [ %indvars.iv.next82, %._crit_edge.us ], [ 0, %.lr.ph135.split.us.preheader ]
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv81
  store double 0.000000e+00, double* %5, align 8
  %sunkaddr46 = shl i64 %indvars.iv81, 3
  %sunkaddr47 = add i64 %sunkaddr, %sunkaddr46
  %sunkaddr48 = inttoptr i64 %sunkaddr47 to double*
  br label %6

; <label>:6:                                      ; preds = %6, %.lr.ph135.split.us
  %indvars.iv32 = phi i64 [ 0, %.lr.ph135.split.us ], [ %indvars.iv.next33.1.1, %6 ]
  %7 = phi double [ 0.000000e+00, %.lr.ph135.split.us ], [ %19, %6 ]
  %8 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv32, i64 %indvars.iv81
  %9 = load double, double* %8, align 8
  %10 = fadd double %9, %7
  store double %10, double* %sunkaddr48, align 8
  %indvars.iv.next33 = or i64 %indvars.iv32, 1
  %11 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next33, i64 %indvars.iv81
  %12 = load double, double* %11, align 8
  %13 = fadd double %12, %10
  store double %13, double* %sunkaddr48, align 8
  %indvars.iv.next33.1 = or i64 %indvars.iv32, 2
  %14 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next33.1, i64 %indvars.iv81
  %15 = load double, double* %14, align 8
  %16 = fadd double %15, %13
  store double %16, double* %sunkaddr48, align 8
  %indvars.iv.next33.196 = or i64 %indvars.iv32, 3
  %17 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next33.196, i64 %indvars.iv81
  %18 = load double, double* %17, align 8
  %19 = fadd double %18, %16
  store double %19, double* %sunkaddr48, align 8
  %indvars.iv.next33.1.1 = add nsw i64 %indvars.iv32, 4
  %exitcond34.1.1 = icmp eq i64 %indvars.iv.next33.1.1, 1400
  br i1 %exitcond34.1.1, label %._crit_edge.us, label %6

._crit_edge.us:                                   ; preds = %6
  %20 = fdiv double %19, %0
  store double %20, double* %sunkaddr48, align 8
  %indvars.iv.next82 = add nuw nsw i64 %indvars.iv81, 1
  %exitcond83 = icmp eq i64 %indvars.iv.next82, 1200
  br i1 %exitcond83, label %.lr.ph129.split.us.preheader, label %.lr.ph135.split.us

.lr.ph129.split.us.preheader:                     ; preds = %._crit_edge.us
  %sunkaddr57 = ptrtoint double* %4 to i64
  br label %.lr.ph129.split.us

.lr.ph129.split.us:                               ; preds = %._crit_edge126.us, %.lr.ph129.split.us.preheader
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %._crit_edge126.us ], [ 0, %.lr.ph129.split.us.preheader ]
  %21 = getelementptr inbounds double, double* %4, i64 %indvars.iv78
  store double 0.000000e+00, double* %21, align 8
  %sunkaddr54 = shl i64 %indvars.iv78, 3
  %sunkaddr55 = add i64 %sunkaddr, %sunkaddr54
  %sunkaddr56 = inttoptr i64 %sunkaddr55 to double*
  %sunkaddr59 = add i64 %sunkaddr57, %sunkaddr54
  %sunkaddr60 = inttoptr i64 %sunkaddr59 to double*
  br label %22

; <label>:22:                                     ; preds = %22, %.lr.ph129.split.us
  %indvars.iv26 = phi i64 [ 0, %.lr.ph129.split.us ], [ %indvars.iv.next27.1, %22 ]
  %23 = phi double [ 0.000000e+00, %.lr.ph129.split.us ], [ %35, %22 ]
  %24 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv26, i64 %indvars.iv78
  %25 = load double, double* %24, align 8
  %26 = load double, double* %sunkaddr56, align 8
  %27 = fsub double %25, %26
  %28 = fmul double %27, %27
  %29 = fadd double %23, %28
  store double %29, double* %sunkaddr60, align 8
  %indvars.iv.next27 = or i64 %indvars.iv26, 1
  %30 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next27, i64 %indvars.iv78
  %31 = load double, double* %30, align 8
  %32 = load double, double* %sunkaddr56, align 8
  %33 = fsub double %31, %32
  %34 = fmul double %33, %33
  %35 = fadd double %29, %34
  store double %35, double* %sunkaddr60, align 8
  %indvars.iv.next27.1 = add nuw nsw i64 %indvars.iv26, 2
  %exitcond28.1 = icmp eq i64 %indvars.iv.next27.1, 1400
  br i1 %exitcond28.1, label %._crit_edge126.us, label %22

._crit_edge126.us:                                ; preds = %22
  %36 = fdiv double %35, %0
  store double %36, double* %sunkaddr60, align 8
  %37 = tail call double @sqrt(double %36) #4
  %38 = fcmp ugt double %37, 1.000000e-01
  %39 = select i1 %38, double %37, double 1.000000e+00
  store double %39, double* %sunkaddr60, align 8
  %indvars.iv.next79 = add nuw nsw i64 %indvars.iv78, 1
  %exitcond80 = icmp eq i64 %indvars.iv.next79, 1200
  br i1 %exitcond80, label %._crit_edge90.._crit_edge92_crit_edge.us.preheader, label %.lr.ph129.split.us
...
._crit_edge90.._crit_edge92_crit_edge.us:         ; preds = %._crit_edge92._crit_edge.us, %._crit_edge90.._crit_edge92_crit_edge.us.preheader
  %indvars.iv75 = phi i64 [ %indvars.iv.next76, %._crit_edge92._crit_edge.us ], [ 0, %._crit_edge90.._crit_edge92_crit_edge.us.preheader ]
  br label %._crit_edge92.us

._crit_edge92.us:                                 ; preds = %._crit_edge92.us, %._crit_edge90.._crit_edge92_crit_edge.us
  %indvars.iv22 = phi i64 [ 0, %._crit_edge90.._crit_edge92_crit_edge.us ], [ %indvars.iv.next23, %._crit_edge92.us ]
  %40 = getelementptr inbounds double, double* %3, i64 %indvars.iv22
  %41 = load double, double* %40, align 8
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv75, i64 %indvars.iv22
  %43 = load double, double* %42, align 8
  %44 = fsub double %43, %41
  store double %44, double* %42, align 8
  %45 = tail call double @sqrt(double %0) #4
  %46 = getelementptr inbounds double, double* %4, i64 %indvars.iv22
  ...
  br i1 %exitcond24, label %._crit_edge92._crit_edge.us, label %._crit_edge92.us

._crit_edge92._crit_edge.us:                      ; preds = %._crit_edge92.us
  %indvars.iv.next76 = add nuw nsw i64 %indvars.iv75, 1
  %exitcond77 = icmp eq i64 %indvars.iv.next76, 1400
  br i1 %exitcond77, label %.lr.ph.us.us.preheader.preheader, label %._crit_edge90.._crit_edge92_crit_edge.us
...
.lr.ph.us.us.preheader:                           ; preds = %.lr.ph.us.us.preheader.preheader, %._crit_edge93.us
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %._crit_edge93.us ], [ 0, %.lr.ph.us.us.preheader.preheader ]
  %indvars.iv69 = phi i64 [ %indvars.iv.next70, %._crit_edge93.us ], [ 1, %.lr.ph.us.us.preheader.preheader ]
  %51 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv73, i64 %indvars.iv73
  store double 1.000000e+00, double* %51, align 8
  br label %.lr.ph.us.us

._crit_edge93.us:                                 ; preds = %._crit_edge102.us.us
  %indvars.iv.next74 = add nuw nsw i64 %indvars.iv73, 1
  %exitcond11 = icmp eq i64 %indvars.iv.next74, 1199
  %indvars.iv.next70 = add nuw nsw i64 %indvars.iv69, 1
  br i1 %exitcond11, label %._crit_edge93._crit_edge, label %.lr.ph.us.us.preheader

.lr.ph.us.us:                                     ; preds = %._crit_edge102.us.us, %.lr.ph.us.us.preheader
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %._crit_edge102.us.us ], [ %indvars.iv69, %.lr.ph.us.us.preheader ]
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv73, i64 %indvars.iv71
  store double 0.000000e+00, double* %52, align 8
  br label %54

._crit_edge102.us.us:                             ; preds = %54
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv71, i64 %indvars.iv73
  store double %67, double* %53, align 8
  %indvars.iv.next72 = add nuw nsw i64 %indvars.iv71, 1
  %exitcond = icmp eq i64 %indvars.iv.next72, 1200
...
; <label>:54:                                     ; preds = %54, %.lr.ph.us.us
  ...
  %56 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv73
  %57 = load double, double* %56, align 8
  %58 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv71
  %59 = load double, double* %58, align 8
  %60 = fmul double %57, %59
  %61 = fadd double %55, %60
  store double %61, double* %52, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %62 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv73
  %63 = load double, double* %62, align 8
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv71
