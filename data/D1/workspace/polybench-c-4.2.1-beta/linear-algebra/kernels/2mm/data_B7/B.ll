...
; <label>:18:                                     ; preds = %2
  ...
  br i1 %20, label %21, label %.._crit_edge_crit_edge4

.._crit_edge_crit_edge4:                          ; preds = %18
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %.._crit_edge_crit_edge4, %.._crit_edge_crit_edge, %21
...
.preheader10.us:                                  ; preds = %._crit_edge27.us..preheader10.us_crit_edge, %.preheader10.us.preheader
  %indvars.iv61 = phi i64 [ 0, %.preheader10.us.preheader ], [ %indvars.iv.next62, %._crit_edge27.us..preheader10.us_crit_edge ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.._crit_edge_crit_edge, %.preheader10.us
  %indvars.iv57 = phi i64 [ 0, %.preheader10.us ], [ %indvars.iv.next58, %._crit_edge.._crit_edge_crit_edge ]
  ...
  br i1 %exitcond60, label %._crit_edge27.us, label %._crit_edge.._crit_edge_crit_edge
...
.preheader9:                                      ; preds = %..preheader9_crit_edge, %.preheader9.loopexit
  %21 = icmp sgt i32 %2, 0
  br i1 %21, label %.preheader8.lr.ph, label %.preheader9..preheader7_crit_edge
...
.preheader8.lr.ph:                                ; preds = %.preheader9
  ...
  br i1 %22, label %.preheader8.us.preheader, label %.preheader8.lr.ph..preheader5_crit_edge
...
.preheader8.us:                                   ; preds = %._crit_edge22.us..preheader8.us_crit_edge, %.preheader8.us.preheader
  %indvars.iv52 = phi i64 [ 0, %.preheader8.us.preheader ], [ %indvars.iv.next53, %._crit_edge22.us..preheader8.us_crit_edge ]
  br i1 %24, label %.preheader8.us..prol.loopexit_crit_edge, label %.prol.preheader
...
.preheader6.us:                                   ; preds = %._crit_edge17.us..preheader6.us_crit_edge, %.preheader6.us.preheader
  %indvars.iv43 = phi i64 [ 0, %.preheader6.us.preheader ], [ %indvars.iv.next44, %._crit_edge17.us..preheader6.us_crit_edge ]
  br label %._crit_edge67

._crit_edge67:                                    ; preds = %._crit_edge67.._crit_edge67_crit_edge, %.preheader6.us
  %indvars.iv39 = phi i64 [ 0, %.preheader6.us ], [ %indvars.iv.next40, %._crit_edge67.._crit_edge67_crit_edge ]
  ...
  br i1 %exitcond42, label %._crit_edge17.us, label %._crit_edge67.._crit_edge67_crit_edge

._crit_edge67.._crit_edge67_crit_edge:            ; preds = %._crit_edge67
  br label %._crit_edge67
...
.preheader5:                                      ; preds = %.preheader6.lr.ph..preheader5_crit_edge, %.preheader7..preheader5_crit_edge, %.preheader8.lr.ph..preheader5_crit_edge, %.preheader5.loopexit
  br i1 %11, label %.preheader.lr.ph, label %.preheader5.._crit_edge14_crit_edge
...
.preheader.lr.ph:                                 ; preds = %.preheader5
  ...
  br i1 %54, label %.preheader.us.preheader, label %.preheader.lr.ph.._crit_edge14_crit_edge
...
.preheader.us:                                    ; preds = %._crit_edge.us..preheader.us_crit_edge, %.preheader.us.preheader
  %indvars.iv34 = phi i64 [ 0, %.preheader.us.preheader ], [ %indvars.iv.next35, %._crit_edge.us..preheader.us_crit_edge ]
  br label %._crit_edge68

._crit_edge68:                                    ; preds = %._crit_edge68.._crit_edge68_crit_edge, %.preheader.us
  %indvars.iv = phi i64 [ 0, %.preheader.us ], [ %indvars.iv.next, %._crit_edge68.._crit_edge68_crit_edge ]
  ...
  br i1 %exitcond, label %._crit_edge.us, label %._crit_edge68.._crit_edge68_crit_edge
...
._crit_edge25.us:                                 ; preds = %._crit_edge25.us.loopexit, %._crit_edge25.us.loopexit35
  ...
  br i1 %exitcond73, label %.preheader.lr.ph.loopexit, label %._crit_edge25.us..preheader6.us_crit_edge
...
.lr.ph21.us.us:                                   ; preds = %._crit_edge22.us.us..lr.ph21.us.us_crit_edge, %.lr.ph21.us.us.preheader
  %indvars.iv64 = phi i64 [ 0, %.lr.ph21.us.us.preheader ], [ %indvars.iv.next65, %._crit_edge22.us.us..lr.ph21.us.us_crit_edge ]
  %22 = getelementptr inbounds [900 x double], [900 x double]* %6, i64 %indvars.iv70, i64 %indvars.iv64
  store double 0.000000e+00, double* %22, align 8
  br i1 %19, label %.lr.ph21.us.us..prol.loopexit61_crit_edge, label %.prol.preheader60
...
.prol.loopexit61:                                 ; preds = %.lr.ph21.us.us..prol.loopexit61_crit_edge, %.prol.preheader60
  %29 = phi double [ %28, %.prol.preheader60 ], [ 0.000000e+00, %.lr.ph21.us.us..prol.loopexit61_crit_edge ]
...
.lr.ph21.us.us.new:                               ; preds = %.lr.ph21.us.us.new..lr.ph21.us.us.new_crit_edge, %.lr.ph21.us.us.new.preheader
  %30 = phi double [ %44, %.lr.ph21.us.us.new..lr.ph21.us.us.new_crit_edge ], [ %29, %.lr.ph21.us.us.new.preheader ]
...
.preheader.lr.ph:                                 ; preds = %.preheader6.lr.ph..preheader.lr.ph_crit_edge, %.preheader.lr.ph.loopexit
  %45 = icmp sgt i32 %3, 0
  br i1 %45, label %.preheader.us.preheader, label %.preheader.lr.ph.._crit_edge12_crit_edge
...
.preheader.us.preheader:                          ; preds = %.preheader.lr.ph
  ...
  %broadcast.splatinsert85 = insertelement <2 x double> undef, double %5, i32 0
...
.lr.ph9..lr.ph9.split_crit_edge.us.preheader:     ; preds = %.preheader.us
  br i1 %50, label %.lr.ph9..lr.ph9.split_crit_edge.us.preheader..lr.ph9..lr.ph9.split_crit_edge.us.prol.loopexit_crit_edge, label %.lr.ph9..lr.ph9.split_crit_edge.us.prol.preheader
...
.lr.ph9..lr.ph9.split_crit_edge.us.prol.loopexit: ; preds = %.lr.ph9..lr.ph9.split_crit_edge.us.preheader..lr.ph9..lr.ph9.split_crit_edge.us.prol.loopexit_crit_edge, %.lr.ph9..lr.ph9.split_crit_edge.us.prol.loopexit.loopexit
  ...
  br i1 %51, label %.lr.ph9..lr.ph9.split_crit_edge.us.prol.loopexit.._crit_edge10.us_crit_edge, label %.lr.ph9..lr.ph9.split_crit_edge.us.preheader79
...
.lr.ph9..lr.ph9.split_crit_edge.us.preheader79:   ; preds = %.lr.ph9..lr.ph9.split_crit_edge.us.prol.loopexit
  %56 = sub i64 %47, %indvars.iv.unr
  %57 = lshr i64 %56, 2
  %58 = add nuw nsw i64 %57, 1
  %min.iters.check = icmp ult i64 %58, 2
  br i1 %min.iters.check, label %.lr.ph9..lr.ph9.split_crit_edge.us.preheader79..lr.ph9..lr.ph9.split_crit_edge.us.preheader87_crit_edge, label %min.iters.checked

.lr.ph9..lr.ph9.split_crit_edge.us.preheader79..lr.ph9..lr.ph9.split_crit_edge.us.preheader87_crit_edge: ; preds = %.lr.ph9..lr.ph9.split_crit_edge.us.preheader79
  br label %.lr.ph9..lr.ph9.split_crit_edge.us.preheader87

min.iters.checked:                                ; preds = %.lr.ph9..lr.ph9.split_crit_edge.us.preheader79
  ...
  br i1 %cmp.zero, label %min.iters.checked..lr.ph9..lr.ph9.split_crit_edge.us.preheader87_crit_edge, label %vector.ph

min.iters.checked..lr.ph9..lr.ph9.split_crit_edge.us.preheader87_crit_edge: ; preds = %min.iters.checked
  br label %.lr.ph9..lr.ph9.split_crit_edge.us.preheader87
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.ph
  ...
  %strided.vec82 = shufflevector <8 x double> %wide.vec, <8 x double> undef, <2 x i32> <i32 1, i32 5>
  %strided.vec83 = shufflevector <8 x double> %wide.vec, <8 x double> undef, <2 x i32> <i32 2, i32 6>
  %strided.vec84 = shufflevector <8 x double> %wide.vec, <8 x double> undef, <2 x i32> <i32 3, i32 7>
  %66 = fmul <2 x double> %strided.vec, %broadcast.splat86
  %67 = fmul <2 x double> %strided.vec82, %broadcast.splat86
  %68 = fmul <2 x double> %strided.vec83, %broadcast.splat86
  %69 = add nsw i64 %offset.idx, 3
  %70 = getelementptr inbounds [1200 x double], [1200 x double]* %10, i64 %indvars.iv46, i64 %69
  %71 = fmul <2 x double> %strided.vec84, %broadcast.splat86
  ...
  br i1 %76, label %middle.block, label %vector.body.vector.body_crit_edge, !llvm.loop !3
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %middle.block.._crit_edge10.us_crit_edge, label %middle.block..lr.ph9..lr.ph9.split_crit_edge.us.preheader87_crit_edge

middle.block..lr.ph9..lr.ph9.split_crit_edge.us.preheader87_crit_edge: ; preds = %middle.block
  br label %.lr.ph9..lr.ph9.split_crit_edge.us.preheader87

middle.block.._crit_edge10.us_crit_edge:          ; preds = %middle.block
  br label %._crit_edge10.us

.lr.ph9..lr.ph9.split_crit_edge.us.preheader87:   ; preds = %middle.block..lr.ph9..lr.ph9.split_crit_edge.us.preheader87_crit_edge, %min.iters.checked..lr.ph9..lr.ph9.split_crit_edge.us.preheader87_crit_edge, %.lr.ph9..lr.ph9.split_crit_edge.us.preheader79..lr.ph9..lr.ph9.split_crit_edge.us.preheader87_crit_edge
  %indvars.iv.ph = phi i64 [ %ind.end, %middle.block..lr.ph9..lr.ph9.split_crit_edge.us.preheader87_crit_edge ], [ %indvars.iv.unr, %min.iters.checked..lr.ph9..lr.ph9.split_crit_edge.us.preheader87_crit_edge ], [ %indvars.iv.unr, %.lr.ph9..lr.ph9.split_crit_edge.us.preheader79..lr.ph9..lr.ph9.split_crit_edge.us.preheader87_crit_edge ]
  br label %.lr.ph9..lr.ph9.split_crit_edge.us

.lr.ph9..lr.ph9.split_crit_edge.us:               ; preds = %.lr.ph9..lr.ph9.split_crit_edge.us..lr.ph9..lr.ph9.split_crit_edge.us_crit_edge, %.lr.ph9..lr.ph9.split_crit_edge.us.preheader87
  %indvars.iv = phi i64 [ %indvars.iv.next.3, %.lr.ph9..lr.ph9.split_crit_edge.us..lr.ph9..lr.ph9.split_crit_edge.us_crit_edge ], [ %indvars.iv.ph, %.lr.ph9..lr.ph9.split_crit_edge.us.preheader87 ]
  ...
  br i1 %exitcond.3, label %._crit_edge10.us.loopexit88, label %.lr.ph9..lr.ph9.split_crit_edge.us..lr.ph9..lr.ph9.split_crit_edge.us_crit_edge, !llvm.loop !6
...
._crit_edge10.us.loopexit88:                      ; preds = %.lr.ph9..lr.ph9.split_crit_edge.us
  br label %._crit_edge10.us

._crit_edge10.us:                                 ; preds = %middle.block.._crit_edge10.us_crit_edge, %.lr.ph9..lr.ph9.split_crit_edge.us.prol.loopexit.._crit_edge10.us_crit_edge, %._crit_edge10.us.loopexit88, %._crit_edge10.us.loopexit
...
.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us..lr.ph.us.us_crit_edge, %.lr.ph.us.us.preheader
  %indvars.iv43 = phi i64 [ 0, %.lr.ph.us.us.preheader ], [ %indvars.iv.next44, %._crit_edge.us.us..lr.ph.us.us_crit_edge ]
  ...
  br i1 %48, label %.lr.ph.us.us..prol.loopexit_crit_edge, label %.prol.preheader
...
.prol.loopexit:                                   ; preds = %.lr.ph.us.us..prol.loopexit_crit_edge, %.prol.preheader
  %97 = phi double [ %96, %.prol.preheader ], [ %91, %.lr.ph.us.us..prol.loopexit_crit_edge ]
  %indvars.iv37.unr.ph = phi i64 [ 1, %.prol.preheader ], [ 0, %.lr.ph.us.us..prol.loopexit_crit_edge ]
  br i1 %49, label %.prol.loopexit.._crit_edge.us.us_crit_edge, label %.lr.ph.us.us.new.preheader
...
.lr.ph.us.us.new:                                 ; preds = %.lr.ph.us.us.new..lr.ph.us.us.new_crit_edge, %.lr.ph.us.us.new.preheader
  %98 = phi double [ %110, %.lr.ph.us.us.new..lr.ph.us.us.new_crit_edge ], [ %97, %.lr.ph.us.us.new.preheader ]
...
._crit_edge12:                                    ; preds = %.preheader.lr.ph.._crit_edge12_crit_edge, %.._crit_edge12_crit_edge, %._crit_edge12.loopexit
  ret void
}
...
define internal void @print_array(i32, i32, [1200 x double]* nocapture readonly) #0 {
  ...
  %9 = icmp sgt i32 %1, 0
  %or.cond = and i1 %8, %9
  br i1 %or.cond, label %.preheader.us.preheader, label %.._crit_edge5_crit_edge
...
.preheader.us:                                    ; preds = %._crit_edge3.us..preheader.us_crit_edge, %.preheader.us.preheader
  %indvars.iv7 = phi i64 [ 0, %.preheader.us.preheader ], [ %indvars.iv.next8, %._crit_edge3.us..preheader.us_crit_edge ]
...
._crit_edge.us._crit_edge:                        ; preds = %._crit_edge.us.._crit_edge.us._crit_edge_crit_edge, %.preheader.us
  ...
  %14 = srem i32 %13, 20
  %15 = icmp eq i32 %14, 0
  br i1 %15, label %16, label %._crit_edge.us._crit_edge.._crit_edge.us_crit_edge
...
._crit_edge.us:                                   ; preds = %._crit_edge.us._crit_edge.._crit_edge.us_crit_edge, %16
...
._crit_edge3.us:                                  ; preds = %._crit_edge.us
  ...
  br i1 %exitcond10, label %._crit_edge5.loopexit, label %._crit_edge3.us..preheader.us_crit_edge
