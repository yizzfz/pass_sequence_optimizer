...
for.body3.lr.ph:                                  ; preds = %for.cond1.preheader
  ...
  %20 = bitcast double** %r.addr to i64*
  %21 = load i64, i64* %20, align 8
  %22 = load [1900 x double]*, [1900 x double]** %A.addr, align 8
  %23 = load double*, double** %q.addr, align 8
  %24 = load double*, double** %p.addr, align 8
  %i.promoted = load i32, i32* %i, align 4
  %25 = sext i32 %i.promoted to i64
  %26 = sext i32 %i.promoted to i64
  br i1 %cmp73, label %for.body3.us.preheader, label %for.body3.preheader

for.body3.preheader:                              ; preds = %for.body3.lr.ph
  %scevgep = getelementptr double, double* %14, i64 %26
  %scevgep19 = bitcast double* %scevgep to i8*
  %27 = add i32 %i.promoted, 1
  %28 = icmp sgt i32 %16, %27
  %smax = select i1 %28, i32 %16, i32 %27
  %29 = add i32 %smax, -1
  %30 = sub i32 %29, %i.promoted
  %31 = zext i32 %30 to i64
  %32 = shl nuw nsw i64 %31, 3
  %33 = add nuw nsw i64 %32, 8
  call void @llvm.memset.p0i8.i64(i8* %scevgep19, i8 0, i64 %33, i32 8, i1 false)
  br label %for.body3
...
for.body3.us:                                     ; preds = %for.body3.us.preheader, %for.cond6.for.inc34_crit_edge.us
  %indvars.iv14 = phi i64 [ %25, %for.body3.us.preheader ], [ %indvars.iv.next15, %for.cond6.for.inc34_crit_edge.us ]
...
for.inc31.us:                                     ; preds = %for.body3.us, %for.inc31.us
  ...
  %sunkaddr40 = add i64 %21, %sunkaddr
  %sunkaddr41 = inttoptr i64 %sunkaddr40 to double*
  %37 = load double, double* %sunkaddr41, align 8
  %arrayidx16.us = getelementptr inbounds [1900 x double], [1900 x double]* %22, i64 %indvars.iv14, i64 %indvars.iv
  ...
  %sunkaddr42 = ptrtoint double* %23 to i64
  ...
  %arrayidx24.us = getelementptr inbounds [1900 x double], [1900 x double]* %22, i64 %indvars.iv14, i64 %indvars.iv
  %40 = load double, double* %arrayidx24.us, align 8
  %arrayidx26.us = getelementptr inbounds double, double* %24, i64 %indvars.iv
  %41 = load double, double* %arrayidx26.us, align 8
  %mul27.us = fmul double %40, %41
  %add28.us = fadd double %39, %mul27.us
  %sunkaddr46 = ptrtoint double* %23 to i64
...
for.body3:                                        ; preds = %for.body3.preheader, %for.body3
  %indvars.iv17 = phi i64 [ %26, %for.body3.preheader ], [ %indvars.iv.next18, %for.body3 ]
