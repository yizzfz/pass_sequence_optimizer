...
for.body:                                         ; preds = %for.body, %entry
  ...
  %8 = trunc i64 %indvars.iv.next20.1 to i32
  ...
  %exitcond21.2 = icmp eq i64 %indvars.iv.next20.2, 2100
  br i1 %exitcond21.2, label %for.cond7.preheader.us.preheader, label %for.body
...
for.inc42.us:                                     ; preds = %for.body26.us.for.body26.us_crit_edge
  %exitcond73 = icmp eq i64 %29, 1900
...
for.body26.us.for.body26.us_crit_edge:            ; preds = %for.body26.us.for.body26.us_crit_edge, %for.body26.us.for.body26.us_crit_edge.preheader.new
  %indvars.iv.next6480 = phi i64 [ %indvars.iv.next64.prol, %for.body26.us.for.body26.us_crit_edge.preheader.new ], [ %indvars.iv.next64.1, %for.body26.us.for.body26.us_crit_edge ]
  %.pre71 = load double, double* %arrayidx12.us, align 8
  %arrayidx28.us = getelementptr inbounds double, double* %y, i64 %indvars.iv.next6480
  %30 = load double, double* %arrayidx28.us, align 8
  %arrayidx32.us = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 %indvars.iv.next6480
  ...
  %indvars.iv.next64 = add nuw nsw i64 %indvars.iv.next6480, 1
  ...
  %indvars.iv.next64.1 = add nsw i64 %indvars.iv.next6480, 2
  %exitcond72.1 = icmp eq i64 %indvars.iv.next64, 2099
...
for.body26.us.preheader:                          ; preds = %for.body10.us
  ...
  %arrayidx32.us77 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 0
  %42 = load double, double* %arrayidx32.us77, align 8
  %mul35.us78 = fmul double %42, %add.us.2
  %add36.us79 = fadd double %41, %mul35.us78
...
for.body26.us.for.body26.us_crit_edge.preheader.new: ; preds = %for.body26.us.for.body26.us_crit_edge.preheader.new.loopexit, %for.body26.us.preheader
  %indvars.iv.next6480.ph = phi i64 [ 1, %for.body26.us.preheader ], [ 2097, %for.body26.us.for.body26.us_crit_edge.preheader.new.loopexit ]
  %.pre71.prol = load double, double* %arrayidx12.us, align 8
  %arrayidx28.us.prol = getelementptr inbounds double, double* %y, i64 %indvars.iv.next6480.ph
  %43 = load double, double* %arrayidx28.us.prol, align 8
  %arrayidx32.us.prol = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 %indvars.iv.next6480.ph
  ...
  %indvars.iv.next64.prol = add nuw nsw i64 %indvars.iv.next6480.ph, 1
