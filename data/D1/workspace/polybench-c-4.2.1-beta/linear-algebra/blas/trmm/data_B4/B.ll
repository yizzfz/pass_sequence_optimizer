...
define i32 @main(i32, i8** nocapture readonly) #0 {
  ...
  tail call void @kernel_trmm(i32 1000, i32 1200, double %8, [1000 x double]* %6, [1200 x double]* %7)
...
; <label>:13:                                     ; preds = %10
  tail call void @print_array(i32 1000, i32 1200, [1200 x double]* %7)
  br label %14
...
define internal void @init_array(i32, i32, double* nocapture, [1000 x double]* nocapture, [1200 x double]* nocapture) #2 {
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal void @kernel_trmm(i32, i32, double, [1000 x double]* nocapture readonly, [1200 x double]* nocapture) #2 {
  %6 = icmp sgt i32 %0, 0
  %7 = icmp sgt i32 %1, 0
  %or.cond = and i1 %6, %7
  br i1 %or.cond, label %.preheader3.us.preheader, label %._crit_edge7
...
.preheader3.us.preheader:                         ; preds = %5
  ...
  %13 = add nsw i64 %wide.trip.count28, -4
  %broadcast.splatinsert41 = insertelement <2 x double> undef, double %2, i32 0
...
.preheader3.us:                                   ; preds = %..loopexit_crit_edge.us, %.preheader3.us.preheader
  %indvars.iv29 = phi i64 [ 0, %.preheader3.us.preheader ], [ %indvars.iv.next30, %..loopexit_crit_edge.us ]
  %indvars.iv18 = phi i64 [ 1, %.preheader3.us.preheader ], [ %indvars.iv.next19, %..loopexit_crit_edge.us ]
  %14 = sub nsw i64 0, %indvars.iv29
  %indvars.iv.next30 = add nuw nsw i64 %indvars.iv29, 1
  %15 = icmp slt i64 %indvars.iv.next30, %11
  br i1 %15, label %.preheader.us.us.preheader, label %.preheader.us9.preheader

.preheader.us.us.preheader:                       ; preds = %.preheader3.us
  %16 = trunc i64 %14 to i32
  %17 = trunc i64 %14 to i32
  %18 = add i32 %9, %17
  %xtraiter23 = and i32 %18, 1
  %lcmp.mod24 = icmp eq i32 %xtraiter23, 0
  %19 = sub i32 0, %16
  %20 = icmp eq i32 %10, %19
  %21 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv18, i64 %indvars.iv29
  %indvars.iv.next21.prol = add nuw nsw i64 %indvars.iv18, 1
  br label %.preheader.us.us

.preheader.us9.preheader:                         ; preds = %.preheader3.us
  br i1 %lcmp.mod, label %.preheader.us9.prol.loopexit, label %.preheader.us9.prol.preheader

.preheader.us9.prol.preheader:                    ; preds = %.preheader.us9.preheader
  br label %.preheader.us9.prol

.preheader.us9.prol:                              ; preds = %.preheader.us9.prol.preheader, %.preheader.us9.prol
  %indvars.iv.prol = phi i64 [ %indvars.iv.next.prol, %.preheader.us9.prol ], [ 0, %.preheader.us9.prol.preheader ]
  %prol.iter = phi i32 [ %prol.iter.sub, %.preheader.us9.prol ], [ %xtraiter, %.preheader.us9.prol.preheader ]
  %22 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv29, i64 %indvars.iv.prol
  ...
  br i1 %prol.iter.cmp, label %.preheader.us9.prol.loopexit.loopexit, label %.preheader.us9.prol, !llvm.loop !1

.preheader.us9.prol.loopexit.loopexit:            ; preds = %.preheader.us9.prol
  br label %.preheader.us9.prol.loopexit

.preheader.us9.prol.loopexit:                     ; preds = %.preheader.us9.prol.loopexit.loopexit, %.preheader.us9.preheader
  %indvars.iv.unr = phi i64 [ 0, %.preheader.us9.preheader ], [ %indvars.iv.next.prol, %.preheader.us9.prol.loopexit.loopexit ]
  br i1 %12, label %..loopexit_crit_edge.us, label %.preheader.us9.preheader36

.preheader.us9.preheader36:                       ; preds = %.preheader.us9.prol.loopexit
  %25 = sub i64 %13, %indvars.iv.unr
  %26 = lshr i64 %25, 2
  %27 = add nuw nsw i64 %26, 1
  %min.iters.check = icmp ult i64 %27, 2
  br i1 %min.iters.check, label %.preheader.us9.preheader43, label %min.iters.checked

min.iters.checked:                                ; preds = %.preheader.us9.preheader36
  ...
  br i1 %cmp.zero, label %.preheader.us9.preheader43, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %34 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv29, i64 %33
  ...
  %36 = fmul <2 x double> %strided.vec, %broadcast.splat42
  %37 = fmul <2 x double> %strided.vec38, %broadcast.splat42
  %38 = fmul <2 x double> %strided.vec39, %broadcast.splat42
  %39 = add nsw i64 %33, 3
  %40 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv29, i64 %39
  %41 = fmul <2 x double> %strided.vec40, %broadcast.splat42
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %..loopexit_crit_edge.us, label %.preheader.us9.preheader43

.preheader.us9.preheader43:                       ; preds = %middle.block, %min.iters.checked, %.preheader.us9.preheader36
  %indvars.iv.ph = phi i64 [ %indvars.iv.unr, %min.iters.checked ], [ %indvars.iv.unr, %.preheader.us9.preheader36 ], [ %ind.end, %middle.block ]
  br label %.preheader.us9

.preheader.us9:                                   ; preds = %.preheader.us9.preheader43, %.preheader.us9
  %indvars.iv = phi i64 [ %indvars.iv.next.3, %.preheader.us9 ], [ %indvars.iv.ph, %.preheader.us9.preheader43 ]
  %47 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv29, i64 %indvars.iv
  %48 = load double, double* %47, align 8
  %49 = fmul double %48, %2
  store double %49, double* %47, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %50 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv29, i64 %indvars.iv.next
  %51 = load double, double* %50, align 8
  %52 = fmul double %51, %2
  store double %52, double* %50, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv29, i64 %indvars.iv.next.1
  %54 = load double, double* %53, align 8
  %55 = fmul double %54, %2
  store double %55, double* %53, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %56 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv29, i64 %indvars.iv.next.2
  %57 = load double, double* %56, align 8
  %58 = fmul double %57, %2
  store double %58, double* %56, align 8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %exitcond.3 = icmp eq i64 %indvars.iv.next.3, %wide.trip.count.3
  br i1 %exitcond.3, label %..loopexit_crit_edge.us.loopexit44, label %.preheader.us9, !llvm.loop !6

..loopexit_crit_edge.us.loopexit:                 ; preds = %._crit_edge.us.us
  br label %..loopexit_crit_edge.us

..loopexit_crit_edge.us.loopexit44:               ; preds = %.preheader.us9
  br label %..loopexit_crit_edge.us

..loopexit_crit_edge.us:                          ; preds = %..loopexit_crit_edge.us.loopexit44, %..loopexit_crit_edge.us.loopexit, %middle.block, %.preheader.us9.prol.loopexit
  %indvars.iv.next19 = add nuw nsw i64 %indvars.iv18, 1
  %exitcond32 = icmp eq i64 %indvars.iv.next30, %wide.trip.count31
  br i1 %exitcond32, label %._crit_edge7.loopexit, label %.preheader3.us

.preheader.us.us:                                 ; preds = %.preheader.us.us.preheader, %._crit_edge.us.us
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %._crit_edge.us.us ], [ 0, %.preheader.us.us.preheader ]
  %59 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv29, i64 %indvars.iv26
  br i1 %lcmp.mod24, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.preheader.us.us
  %60 = load double, double* %21, align 8
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv18, i64 %indvars.iv26
...
.prol.loopexit:                                   ; preds = %.prol.preheader, %.preheader.us.us
  %indvars.iv20.unr.ph = phi i64 [ %indvars.iv.next21.prol, %.prol.preheader ], [ %indvars.iv18, %.preheader.us.us ]
...
._crit_edge.us.us:                                ; preds = %._crit_edge.us.us.loopexit, %.prol.loopexit
  %66 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv29, i64 %indvars.iv26
...
.preheader.us.us.new:                             ; preds = %.preheader.us.us.new.preheader, %.preheader.us.us.new
  %indvars.iv20 = phi i64 [ %indvars.iv.next21.1, %.preheader.us.us.new ], [ %indvars.iv20.unr.ph, %.preheader.us.us.new.preheader ]
  %69 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv20, i64 %indvars.iv29
  %70 = load double, double* %69, align 8
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv20, i64 %indvars.iv26
  ...
  %76 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv.next21, i64 %indvars.iv29
  %77 = load double, double* %76, align 8
  %78 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv.next21, i64 %indvars.iv26
...
._crit_edge7.loopexit:                            ; preds = %..loopexit_crit_edge.us
