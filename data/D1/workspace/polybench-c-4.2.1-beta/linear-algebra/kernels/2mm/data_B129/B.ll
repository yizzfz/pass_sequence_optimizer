...
._crit_edge29:                                    ; preds = %._crit_edge29, %.preheader23
  ...
  br i1 %exitcond12.1, label %27, label %._crit_edge29

; <label>:27:                                     ; preds = %._crit_edge29
...
._crit_edge30:                                    ; preds = %._crit_edge30, %.preheader22
  ...
  br i1 %exitcond6, label %36, label %._crit_edge30

; <label>:36:                                     ; preds = %._crit_edge30
...
._crit_edge31:                                    ; preds = %._crit_edge31, %.preheader
  ...
  br i1 %exitcond, label %44, label %._crit_edge31

; <label>:44:                                     ; preds = %._crit_edge31
...
._crit_edge22:                                    ; preds = %25, %7
  %indvars.iv13 = phi i64 [ 0, %7 ], [ %indvars.iv.next14, %25 ]
  br label %._crit_edge21

._crit_edge21:                                    ; preds = %24, %._crit_edge22
  %indvars.iv10 = phi i64 [ 0, %._crit_edge22 ], [ %indvars.iv.next11, %24 ]
  %8 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv13, i64 %indvars.iv10
  store double 0.000000e+00, double* %8, align 8
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge21
  %indvars.iv7 = phi i64 [ 0, %._crit_edge21 ], [ %indvars.iv.next8.1, %._crit_edge ]
  %9 = phi double [ 0.000000e+00, %._crit_edge21 ], [ %23, %._crit_edge ]
...
; <label>:24:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond12, label %25, label %._crit_edge21

; <label>:25:                                     ; preds = %24
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 800
  br i1 %exitcond15, label %.preheader.preheader, label %._crit_edge22
...
._crit_edge24:                                    ; preds = %48, %.preheader
