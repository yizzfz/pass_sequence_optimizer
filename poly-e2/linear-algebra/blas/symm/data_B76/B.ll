...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc16_crit_edge.us, %entry
  %indvars.iv45 = phi i64 [ 0, %entry ], [ %indvars.iv.next46, %for.cond1.for.inc16_crit_edge.us ]
  %0 = add i64 %indvars.iv45, 1200
  %1 = trunc i64 %0 to i32
  br label %for.inc.us

for.inc.us:                                       ; preds = %for.inc.us, %for.cond1.preheader.us
  %indvars.iv41 = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next42, %for.inc.us ]
  ...
  br i1 %exitcond44, label %for.cond1.for.inc16_crit_edge.us, label %for.inc.us

for.cond1.for.inc16_crit_edge.us:                 ; preds = %for.inc.us
  %indvars.iv.next46 = add nuw nsw i64 %indvars.iv45, 1
  %exitcond49 = icmp eq i64 %indvars.iv.next46, 1000
  br i1 %exitcond49, label %for.inc36.lr.ph.preheader, label %for.cond1.preheader.us
...
for.inc36.lr.ph:                                  ; preds = %for.inc36.lr.ph.preheader, %for.inc51
  %indvars.iv55 = phi i3 [ %indvars.iv.next56, %for.inc51 ], [ -1, %for.inc36.lr.ph.preheader ]
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc51 ], [ 2, %for.inc36.lr.ph.preheader ]
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc51 ], [ 0, %for.inc36.lr.ph.preheader ]
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc51 ], [ 1, %for.inc36.lr.ph.preheader ]
  %5 = zext i3 %indvars.iv55 to i64
  %6 = add nuw nsw i64 %5, 4294967295
  %7 = and i64 %6, 4294967295
  %8 = add i64 %indvars.iv53, %7
  %9 = sub nsw i64 0, %indvars.iv38
...
for.inc36.prol.loopexit.unr-lcssa:                ; preds = %for.inc36.lr.ph, %for.inc36.prol.preheader
  ...
  %14 = icmp eq i64 %indvars.iv38, 0
  br i1 %14, label %for.cond40.preheader, label %for.inc36.preheader
...
for.inc48.prol:                                   ; preds = %for.inc48.prol.preheader, %for.inc48.prol
  %indvars.iv29.prol = phi i64 [ %indvars.iv.next30.prol, %for.inc48.prol ], [ %indvars.iv36, %for.inc48.prol.preheader ]
...
for.inc48.prol.loopexit:                          ; preds = %for.inc48.prol.loopexit.loopexit, %for.inc48.lr.ph
  %indvars.iv29.unr = phi i64 [ %indvars.iv36, %for.inc48.lr.ph ], [ %8, %for.inc48.prol.loopexit.loopexit ]
  %15 = icmp ult i32 %12, 7
  br i1 %15, label %for.inc51, label %for.inc48.preheader

for.inc48.preheader:                              ; preds = %for.inc48.prol.loopexit
  %16 = sub i64 992, %indvars.iv29.unr
  %17 = lshr i64 %16, 3
  %18 = add nuw nsw i64 %17, 1
  %min.iters.check = icmp ult i64 %18, 2
  br i1 %min.iters.check, label %for.inc48.preheader57, label %min.iters.checked

for.inc48.preheader57:                            ; preds = %middle.block, %min.iters.checked, %for.inc48.preheader
  %indvars.iv29.ph = phi i64 [ %indvars.iv29.unr, %min.iters.checked ], [ %indvars.iv29.unr, %for.inc48.preheader ], [ %ind.end, %middle.block ]
  br label %for.inc48
...
min.iters.checked:                                ; preds = %for.inc48.preheader
  ...
  %19 = add i64 %indvars.iv29.unr, 8
  %20 = shl nuw i64 %17, 3
  %21 = add i64 %19, %20
  %22 = shl nuw nsw i64 %n.mod.vf, 3
  %ind.end = sub i64 %21, %22
  br i1 %cmp.zero, label %for.inc48.preheader57, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %23 = shl i64 %index, 3
  %24 = add i64 %indvars.iv29.unr, %23
  %25 = add nsw i64 %24, 7
  %26 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv38, i64 %25
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.inc51, label %for.inc48.preheader57
...
for.inc36:                                        ; preds = %for.inc36.preheader, %for.inc36
  ...
  %30 = add nuw nsw i64 %indvars.iv, %indvars.iv38
  %31 = trunc i64 %30 to i32
  %rem28 = srem i32 %31, 100
  ...
  %32 = add nuw nsw i64 %indvars.iv.next, %indvars.iv38
  %33 = trunc i64 %32 to i32
  %rem28.1 = srem i32 %33, 100
  %conv29.1 = sitofp i32 %rem28.1 to double
  %div31.1 = fdiv double %conv29.1, 1.000000e+03
  %arrayidx35.1 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv38, i64 %indvars.iv.next
...
for.inc48:                                        ; preds = %for.inc48.preheader57, %for.inc48
  %indvars.iv29 = phi i64 [ %indvars.iv.next30.7, %for.inc48 ], [ %indvars.iv29.ph, %for.inc48.preheader57 ]
...
for.inc51:                                        ; preds = %for.inc51.loopexit, %middle.block, %for.inc48.prol.loopexit, %for.cond40.preheader
  ...
  %indvars.iv.next56 = add i3 %indvars.iv55, -1
...
entry:
  ...
  %broadcast.splatinsert59 = insertelement <2 x double> undef, double %alpha, i32 0
  %broadcast.splat60 = shufflevector <2 x double> %broadcast.splatinsert59, <2 x double> undef, <2 x i32> zeroinitializer
  %broadcast.splatinsert61 = insertelement <2 x double> undef, double %mul44, i32 0
...
for.cond1.preheader:                              ; preds = %for.inc53, %entry
  %indvars.iv29 = phi i64 [ 0, %entry ], [ %indvars.iv.next30, %for.inc53 ]
  ...
  br i1 %cmp53, label %for.body3.us.preheader, label %for.body3.preheader35

for.body3.us.preheader:                           ; preds = %for.cond1.preheader
  br label %for.body3.us

for.body3.preheader35:                            ; preds = %for.cond1.preheader
  %scevgep38 = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv29, i64 0
  %scevgep41 = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv29, i64 1200
  %scevgep44 = getelementptr [1200 x double], [1200 x double]* %B, i64 %indvars.iv29, i64 0
  %scevgep47 = getelementptr [1200 x double], [1200 x double]* %B, i64 %indvars.iv29, i64 1200
  %bound0 = icmp ult double* %scevgep38, %scevgep47
  %bound1 = icmp ult double* %scevgep44, %scevgep41
  %found.conflict = and i1 %bound0, %bound1
  %bound050 = icmp ult double* %scevgep38, %arrayidx41
  %bound151 = icmp ult double* %arrayidx41, %scevgep41
...
for.body3.preheader:                              ; preds = %for.body3.preheader35
  br label %for.body3

vector.ph:                                        ; preds = %for.body3.preheader35
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %0 = shl i64 %index, 1
  %1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv29, i64 %0
  %2 = bitcast double* %1 to <4 x double>*
  %wide.vec = load <4 x double>, <4 x double>* %2, align 8, !alias.scope !8, !noalias !11
  %strided.vec = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %strided.vec53 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %3 = fmul <2 x double> %strided.vec, %broadcast.splat55
  %4 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv29, i64 %0
  %5 = bitcast double* %4 to <4 x double>*
  %wide.vec56 = load <4 x double>, <4 x double>* %5, align 8, !alias.scope !14
  ...
  %6 = fmul <2 x double> %strided.vec57, %broadcast.splat60
  %7 = load double, double* %arrayidx41, align 8, !alias.scope !15
  ...
  %11 = fadd <2 x double> %3, %10
  %12 = fadd <2 x double> %11, %broadcast.splat62
  %13 = or i64 %0, 1
  %14 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv29, i64 %13
  %15 = fmul <2 x double> %strided.vec53, %broadcast.splat55
  %16 = fmul <2 x double> %strided.vec58, %broadcast.splat60
  %17 = load double, double* %arrayidx41, align 8, !alias.scope !15
  ...
  %22 = fadd <2 x double> %21, %broadcast.splat62
  %23 = getelementptr double, double* %14, i64 -1
  %24 = bitcast double* %23 to <4 x double>*
  %interleaved.vec = shufflevector <2 x double> %12, <2 x double> %22, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec, <4 x double>* %24, align 8, !alias.scope !8, !noalias !11
  %index.next = add i64 %index, 2
  %25 = icmp eq i64 %index.next, 600
...
for.body3.us:                                     ; preds = %for.body3.us.preheader, %for.cond4.for.inc50_crit_edge.us
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.cond4.for.inc50_crit_edge.us ], [ 0, %for.body3.us.preheader ]
...
for.inc.us:                                       ; preds = %for.inc.us, %for.body3.us
  ...
  %26 = load double, double* %arrayidx8.us, align 8
  %mul.us = fmul double %26, %alpha
  ...
  %mul13.us = fmul double %mul.us, %27
  %arrayidx17.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv20, i64 %indvars.iv25
  %28 = load double, double* %arrayidx17.us, align 8
  %add.us = fadd double %mul13.us, %28
  ...
  %30 = load double, double* %arrayidx12.us, align 8
  %mul26.us = fmul double %29, %30
...
for.cond4.for.inc50_crit_edge.us:                 ; preds = %for.inc.us
  ...
  %31 = load double, double* %arrayidx31.us, align 8
  %mul32.us = fmul double %31, %beta
  %32 = load double, double* %arrayidx8.us, align 8
  %mul37.us = fmul double %32, %alpha
  %33 = load double, double* %arrayidx41, align 8
  %mul42.us = fmul double %mul37.us, %33
...
for.body3:                                        ; preds = %for.body3.preheader, %for.body3
  ...
  %mul37 = fmul double %35, %alpha
  %36 = load double, double* %arrayidx41, align 8
  %mul42 = fmul double %mul37, %36
  ...
  %37 = load double, double* %arrayidx31.1, align 8
  %mul32.1 = fmul double %37, %beta
  %arrayidx36.1 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv29, i64 %indvars.iv.next
  %38 = load double, double* %arrayidx36.1, align 8
  %mul37.1 = fmul double %38, %alpha
  %39 = load double, double* %arrayidx41, align 8
  %mul42.1 = fmul double %mul37.1, %39
  ...
  br i1 %exitcond.1, label %for.inc53.loopexit64, label %for.body3, !llvm.loop !17
...
for.inc53:                                        ; preds = %for.inc53.loopexit64, %for.inc53.loopexit, %middle.block
  %indvars.iv.next30 = add nuw nsw i64 %indvars.iv29, 1
  %exitcond32 = icmp eq i64 %indvars.iv.next30, 1000
  br i1 %exitcond32, label %for.end55, label %for.cond1.preheader
