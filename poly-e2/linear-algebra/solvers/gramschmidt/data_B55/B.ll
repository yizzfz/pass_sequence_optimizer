...
for.cond1.preheader.lr.ph:                        ; preds = %entry
  ...
  br i1 %cmp222, label %for.body3.lr.ph.us.preheader, label %for.end32
...
for.body3.lr.ph.us:                               ; preds = %for.inc12.us, %for.body3.lr.ph.us.preheader
  %indvars.iv40 = phi i64 [ 0, %for.body3.lr.ph.us.preheader ], [ %indvars.iv.next41, %for.inc12.us ]
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us, %for.body3.lr.ph.us
  %indvars.iv33 = phi i64 [ 0, %for.body3.lr.ph.us ], [ %indvars.iv.next34, %for.body3.us ]
...
for.inc12.us:                                     ; preds = %for.body3.us
  ...
  br i1 %exitcond47, label %for.cond15.preheader.loopexit, label %for.body3.lr.ph.us
...
for.cond15.preheader:                             ; preds = %for.cond15.preheader.loopexit, %entry
  ...
  br i1 %cmp1620, label %for.body22.lr.ph.us.preheader, label %for.end32
...
for.body22.lr.ph.us.prol:                         ; preds = %for.body22.lr.ph.us.prol.preheader, %for.body22.lr.ph.us.prol.for.body22.lr.ph.us.prol_crit_edge
  %indvars.iv29.prol = phi i64 [ %indvars.iv.next30.prol, %for.body22.lr.ph.us.prol.for.body22.lr.ph.us.prol_crit_edge ], [ 0, %for.body22.lr.ph.us.prol.preheader ]
...
for.body22.lr.ph.us.prol.loopexit:                ; preds = %for.body22.lr.ph.us.prol.loopexit.loopexit, %for.body22.lr.ph.us.preheader
  %indvars.iv29.unr = phi i64 [ 0, %for.body22.lr.ph.us.preheader ], [ %xtraiter, %for.body22.lr.ph.us.prol.loopexit.loopexit ]
  %10 = icmp ult i64 %9, 3
  br i1 %10, label %for.end32, label %for.body22.lr.ph.us.preheader48

for.body22.lr.ph.us.preheader48:                  ; preds = %for.body22.lr.ph.us.prol.loopexit
  %11 = add nsw i64 %8, -4
  %12 = sub nsw i64 %11, %indvars.iv29.unr
  %13 = lshr i64 %12, 2
  %14 = and i64 %13, 1
  %lcmp.mod52 = icmp eq i64 %14, 0
  br i1 %lcmp.mod52, label %for.body22.lr.ph.us.prol.preheader49, label %for.body22.lr.ph.us.prol.loopexit50

for.body22.lr.ph.us.prol.preheader49:             ; preds = %for.body22.lr.ph.us.preheader48
  br label %for.body22.lr.ph.us.prol53

for.body22.lr.ph.us.prol53:                       ; preds = %for.body22.lr.ph.us.prol.preheader49
  %scevgep.prol55 = getelementptr [1200 x double], [1200 x double]* %R, i64 %indvars.iv29.unr, i64 0
  %scevgep28.prol56 = bitcast double* %scevgep.prol55 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep28.prol56, i8 0, i64 %7, i32 8, i1 false)
  %indvars.iv.next30.prol57 = add nuw nsw i64 %indvars.iv29.unr, 1
  %scevgep.1.prol = getelementptr [1200 x double], [1200 x double]* %R, i64 %indvars.iv.next30.prol57, i64 0
  ...
  br label %for.body22.lr.ph.us.prol.loopexit50

for.body22.lr.ph.us.prol.loopexit50:              ; preds = %for.body22.lr.ph.us.prol53, %for.body22.lr.ph.us.preheader48
  %indvars.iv29.unr58 = phi i64 [ %indvars.iv29.unr, %for.body22.lr.ph.us.preheader48 ], [ %indvars.iv.next30.3.prol, %for.body22.lr.ph.us.prol53 ]
  %15 = icmp eq i64 %13, 0
  br i1 %15, label %for.end32.loopexit, label %for.body22.lr.ph.us.preheader48.new

for.body22.lr.ph.us.preheader48.new:              ; preds = %for.body22.lr.ph.us.prol.loopexit50
  br label %for.body22.lr.ph.us

for.body22.lr.ph.us:                              ; preds = %for.body22.lr.ph.us, %for.body22.lr.ph.us.preheader48.new
  %indvars.iv29 = phi i64 [ %indvars.iv29.unr58, %for.body22.lr.ph.us.preheader48.new ], [ %indvars.iv.next30.3.1, %for.body22.lr.ph.us ]
  ...
  %scevgep.159 = getelementptr [1200 x double], [1200 x double]* %R, i64 %indvars.iv.next30.3, i64 0
  %scevgep28.160 = bitcast double* %scevgep.159 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep28.160, i8 0, i64 %7, i32 8, i1 false)
  %indvars.iv.next30.161 = add nsw i64 %indvars.iv29, 5
  %scevgep.1.1 = getelementptr [1200 x double], [1200 x double]* %R, i64 %indvars.iv.next30.161, i64 0
  ...
  br i1 %exitcond32.3.1, label %for.end32.loopexit.unr-lcssa, label %for.body22.lr.ph.us

for.end32.loopexit.unr-lcssa:                     ; preds = %for.body22.lr.ph.us
  br label %for.end32.loopexit

for.end32.loopexit:                               ; preds = %for.body22.lr.ph.us.prol.loopexit50, %for.end32.loopexit.unr-lcssa
  br label %for.end32
...
entry:
  ...
  br i1 %cmp66, label %for.cond1.preheader.preheader, label %for.end88
...
for.body16.prol.loopexit.unr-lcssa:               ; preds = %for.end, %for.body16.prol.preheader
  ...
  br i1 %8, label %for.end31, label %for.body16.preheader
...
for.body42.lr.ph.us:                              ; preds = %for.inc83.us, %for.body42.lr.ph.us.preheader
  %indvars.iv120 = phi i64 [ %indvars.iv118, %for.body42.lr.ph.us.preheader ], [ %indvars.iv.next121, %for.inc83.us ]
...
for.body42.us.prol.loopexit.unr-lcssa:            ; preds = %for.body42.lr.ph.us, %for.body42.us.prol.preheader
  %27 = phi double [ %add56.us.prol, %for.body42.us.prol.preheader ], [ 0.000000e+00, %for.body42.lr.ph.us ]
  %indvars.iv110.unr.ph = phi i64 [ 1, %for.body42.us.prol.preheader ], [ 0, %for.body42.lr.ph.us ]
...
for.body42.us:                                    ; preds = %for.body42.us.preheader, %for.body42.us
  %28 = phi double [ %add56.us.1, %for.body42.us ], [ %27, %for.body42.us.preheader ]
...
for.body62.us.preheader:                          ; preds = %for.body62.us.preheader.loopexit, %for.body42.us.prol.loopexit.unr-lcssa
  %33 = phi double [ %27, %for.body42.us.prol.loopexit.unr-lcssa ], [ %add56.us.1, %for.body62.us.preheader.loopexit ]
...
for.body62.us.prol.loopexit.unr-lcssa:            ; preds = %for.body62.us.preheader, %for.body62.us.prol.preheader
  ...
  br i1 %8, label %for.inc83.us, label %for.body62.us.preheader141

for.body62.us.preheader141:                       ; preds = %for.body62.us.prol.loopexit.unr-lcssa
  br label %for.body62.us

for.body62.us:                                    ; preds = %for.body62.us.preheader141, %for.body62.us
  %indvars.iv114 = phi i64 [ %indvars.iv.next115.1, %for.body62.us ], [ %indvars.iv114.unr.ph, %for.body62.us.preheader141 ]
...
if.then.us:                                       ; preds = %for.body4.us
  ...
  %fputc20.us = tail call i32 @fputc(i32 10, %struct._IO_FILE* %8) #6
  br label %if.end.us
