...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge9
  %indvars.iv = phi i64 [ 0, %._crit_edge9 ], [ %indvars.iv.next.1, %._crit_edge ]
...
; <label>:19:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond5, label %20, label %._crit_edge9
...
.lr.ph88.split.us:                                ; preds = %._crit_edge84.us, %.lr.ph88.split.us.preheader
  %indvars.iv128 = phi i64 [ 0, %.lr.ph88.split.us.preheader ], [ %indvars.iv.next129, %._crit_edge84.us ]
  %6 = getelementptr inbounds double, double* %5, i64 %indvars.iv128
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph88.split.us
  %indvars.iv125 = phi i64 [ 0, %.lr.ph88.split.us ], [ %indvars.iv.next126.4, %._crit_edge ]
  %7 = phi double [ 0.000000e+00, %.lr.ph88.split.us ], [ %22, %._crit_edge ]
  %8 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv125, i64 %indvars.iv128
  %9 = load double, double* %8, align 8
  %10 = fadd double %7, %9
  store double %10, double* %sunkaddr147, align 8
  %indvars.iv.next126 = add nuw nsw i64 %indvars.iv125, 1
  %11 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next126, i64 %indvars.iv128
  %12 = load double, double* %11, align 8
  %13 = fadd double %10, %12
  store double %13, double* %sunkaddr147, align 8
  %indvars.iv.next126.1 = add nuw nsw i64 %indvars.iv125, 2
  %14 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next126.1, i64 %indvars.iv128
  %15 = load double, double* %14, align 8
  %16 = fadd double %13, %15
  store double %16, double* %sunkaddr147, align 8
  %indvars.iv.next126.2 = add nuw nsw i64 %indvars.iv125, 3
  %17 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next126.2, i64 %indvars.iv128
  %18 = load double, double* %17, align 8
  %19 = fadd double %16, %18
  store double %19, double* %sunkaddr147, align 8
  %indvars.iv.next126.3 = add nuw nsw i64 %indvars.iv125, 4
  %20 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next126.3, i64 %indvars.iv128
  %21 = load double, double* %20, align 8
  %22 = fadd double %19, %21
  store double %22, double* %sunkaddr147, align 8
  %indvars.iv.next126.4 = add nuw nsw i64 %indvars.iv125, 5
  %exitcond127.4 = icmp eq i64 %indvars.iv.next126.4, 1400
  br i1 %exitcond127.4, label %._crit_edge84.us, label %._crit_edge

._crit_edge84.us:                                 ; preds = %._crit_edge
  %23 = fdiv double %22, %2
  %sunkaddr175 = shl i64 %indvars.iv128, 3
  %sunkaddr176 = add i64 %sunkaddr, %sunkaddr175
  %sunkaddr177 = inttoptr i64 %sunkaddr176 to double*
  store double %23, double* %sunkaddr177, align 8
  %indvars.iv.next129 = add nuw nsw i64 %indvars.iv128, 1
  %exitcond130 = icmp eq i64 %indvars.iv.next129, 1200
  br i1 %exitcond130, label %._crit_edge84.us..lr.ph79.split.us_crit_edge, label %.lr.ph88.split.us

._crit_edge84.us..lr.ph79.split.us_crit_edge:     ; preds = %._crit_edge84.us
  %scevgep161 = getelementptr double, double* %5, i64 1200
  br label %vector.memcheck

vector.memcheck:                                  ; preds = %._crit_edge76.us, %._crit_edge84.us..lr.ph79.split.us_crit_edge
  %indvars.iv121 = phi i64 [ 0, %._crit_edge84.us..lr.ph79.split.us_crit_edge ], [ %24, %._crit_edge76.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %3, i64 %indvars.iv121, i64 0
  %24 = add nuw nsw i64 %indvars.iv121, 1
  %scevgep159 = getelementptr [1200 x double], [1200 x double]* %3, i64 %24, i64 0
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %27 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv121, i64 %offset.idx
  %28 = bitcast double* %27 to <8 x double>*
  %wide.vec166 = load <8 x double>, <8 x double>* %28, align 8, !alias.scope !4, !noalias !1
  ...
  %34 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv121, i64 %33
  ...
  br i1 %40, label %._crit_edge76.us.loopexit178, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv118 = phi i64 [ %indvars.iv.next119.3, %scalar.ph ], [ 0, %scalar.ph.preheader ]
  %41 = getelementptr inbounds double, double* %5, i64 %indvars.iv118
  %42 = load double, double* %41, align 8
  %43 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv121, i64 %indvars.iv118
  %44 = load double, double* %43, align 8
  %45 = fsub double %44, %42
  store double %45, double* %43, align 8
  %indvars.iv.next119 = or i64 %indvars.iv118, 1
  %46 = getelementptr inbounds double, double* %5, i64 %indvars.iv.next119
  %47 = load double, double* %46, align 8
  %48 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv121, i64 %indvars.iv.next119
  %49 = load double, double* %48, align 8
  %50 = fsub double %49, %47
  store double %50, double* %48, align 8
  %indvars.iv.next119.1 = or i64 %indvars.iv118, 2
  %51 = getelementptr inbounds double, double* %5, i64 %indvars.iv.next119.1
  %52 = load double, double* %51, align 8
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv121, i64 %indvars.iv.next119.1
  %54 = load double, double* %53, align 8
  %55 = fsub double %54, %52
  store double %55, double* %53, align 8
  %indvars.iv.next119.2 = or i64 %indvars.iv118, 3
  %56 = getelementptr inbounds double, double* %5, i64 %indvars.iv.next119.2
  %57 = load double, double* %56, align 8
  %58 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv121, i64 %indvars.iv.next119.2
  ...
  br i1 %exitcond120.3, label %._crit_edge76.us.loopexit, label %scalar.ph, !llvm.loop !9

._crit_edge76.us.loopexit:                        ; preds = %scalar.ph
  br label %._crit_edge76.us

._crit_edge76.us.loopexit178:                     ; preds = %vector.body
  br label %._crit_edge76.us

._crit_edge76.us:                                 ; preds = %._crit_edge76.us.loopexit178, %._crit_edge76.us.loopexit
  %exitcond123 = icmp eq i64 %24, 1400
  br i1 %exitcond123, label %.lr.ph71.split.us.preheader, label %vector.memcheck

.lr.ph71.split.us.preheader:                      ; preds = %._crit_edge76.us
  %61 = fadd double %2, -1.000000e+00
  br label %.lr.ph67.us

.lr.ph67.us:                                      ; preds = %._crit_edge68.us-lcssa.us.us, %.lr.ph71.split.us.preheader
  %indvars.iv107 = phi i64 [ 0, %.lr.ph71.split.us.preheader ], [ %indvars.iv.next108, %._crit_edge68.us-lcssa.us.us ]
  br label %.lr.ph.us.us

._crit_edge68.us-lcssa.us.us:                     ; preds = %._crit_edge.us.us
  %indvars.iv.next108 = add nuw nsw i64 %indvars.iv107, 1
  %exitcond109 = icmp eq i64 %indvars.iv.next108, 1200
  br i1 %exitcond109, label %._crit_edge72, label %.lr.ph67.us

.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph67.us
  %indvars.iv104 = phi i64 [ %indvars.iv107, %.lr.ph67.us ], [ %indvars.iv.next105, %._crit_edge.us.us ]
  %62 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv107, i64 %indvars.iv104
  store double 0.000000e+00, double* %62, align 8
  br label %._crit_edge172

._crit_edge.us.us:                                ; preds = %._crit_edge172
  %63 = fdiv double %77, %61
  store double %63, double* %62, align 8
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv104, i64 %indvars.iv107
  store double %63, double* %64, align 8
  %indvars.iv.next105 = add nuw nsw i64 %indvars.iv104, 1
  %exitcond106 = icmp eq i64 %indvars.iv.next105, 1200
  br i1 %exitcond106, label %._crit_edge68.us-lcssa.us.us, label %.lr.ph.us.us

._crit_edge172:                                   ; preds = %._crit_edge172, %.lr.ph.us.us
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %._crit_edge172 ]
  %65 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %77, %._crit_edge172 ]
  %66 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv, i64 %indvars.iv107
  %67 = load double, double* %66, align 8
  %68 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv, i64 %indvars.iv104
  %69 = load double, double* %68, align 8
  %70 = fmul double %67, %69
  %71 = fadd double %65, %70
  store double %71, double* %62, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %72 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next, i64 %indvars.iv107
  %73 = load double, double* %72, align 8
  %74 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next, i64 %indvars.iv104
  ...
  br i1 %exitcond.1, label %._crit_edge.us.us, label %._crit_edge172
...
.lr.ph13.split.us:                                ; preds = %._crit_edge.us, %.lr.ph13.split.us.preheader
  %indvars.iv15 = phi i64 [ 0, %.lr.ph13.split.us.preheader ], [ %indvars.iv.next16, %._crit_edge.us ]
  %6 = mul nuw nsw i64 %indvars.iv15, 1200
  br label %._crit_edge21

._crit_edge21:                                    ; preds = %._crit_edge, %.lr.ph13.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph13.split.us ], [ %indvars.iv.next, %._crit_edge ]
...
._crit_edge.us:                                   ; preds = %._crit_edge
  ...
  br i1 %exitcond17, label %._crit_edge14, label %.lr.ph13.split.us
