...
.lr.ph5:                                          ; preds = %.lr.ph5.preheader1, %.lr.ph5
  ...
  %49 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next13.3
  %50 = bitcast double* %49 to <2 x double>*
  %indvars.iv.next13.4 = add nsw i64 %indvars.iv12, 5
  %51 = trunc i64 %indvars.iv.next13.4 to i32
  ...
  %55 = trunc i64 %indvars.iv.next13.5 to i32
  %56 = sitofp i32 %55 to double
  %57 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next13.5
  %58 = bitcast double* %57 to <2 x double>*
  %indvars.iv.next13.6 = add nsw i64 %indvars.iv12, 7
  %59 = trunc i64 %indvars.iv.next13.6 to i32
