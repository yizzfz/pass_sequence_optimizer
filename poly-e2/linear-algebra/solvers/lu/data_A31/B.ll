...
for.end18.loopexit:                               ; preds = %for.cond8.preheader
  ...
  %5 = add nuw nsw i64 %indvars.iv89, 1
  %6 = add nuw nsw i64 %4, 8
  %scevgep84 = getelementptr [2000 x double], [2000 x double]* %A, i64 0, i64 %5
  %7 = mul nuw nsw i64 %indvars.iv89, 2000
  %scevgep85 = getelementptr double, double* %scevgep84, i64 %7
  %scevgep8586 = bitcast double* %scevgep85 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep8586, i8 0, i64 %6, i32 8, i1 false)
  br label %for.end18
...
for.cond52.preheader.us.us.preheader:             ; preds = %for.cond52.preheader.us.us.preheader.preheader, %for.cond48.for.end74_crit_edge.us
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.cond48.for.end74_crit_edge.us ], [ 0, %for.cond52.preheader.us.us.preheader.preheader ]
  ...
  %scevgep110 = getelementptr [2000 x double], [2000 x double]* %A, i64 1999, i64 %19
...
for.cond48.for.end74_crit_edge.us:                ; preds = %for.cond52.for.end71_crit_edge.us.us
  ...
  %exitcond105 = icmp eq i64 %indvars.iv.next60, 2000
...
for.cond52.preheader.us.us:                       ; preds = %for.cond52.for.end71_crit_edge.us.us, %for.cond52.preheader.us.us.preheader
  ...
  %27 = mul i64 %indvars.iv55, 16000
  %scevgep106 = getelementptr i8, i8* %call, i64 %27
  %28 = add i64 %27, 16000
  %scevgep107 = getelementptr i8, i8* %call, i64 %28
  ...
  %bc112 = bitcast double* %arrayidx59.us.us to i8*
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %37 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %index, i64 %indvars.iv59
  %38 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %29, i64 %indvars.iv59
  %39 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %30, i64 %indvars.iv59
  %40 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %31, i64 %indvars.iv59
  ...
  %51 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %18, i64 0, i64 %indvars.iv55, i64 %index
  ...
  %wide.load117 = load <2 x double>, <2 x double>* %54, align 8, !alias.scope !6, !noalias !8
  %55 = fadd <2 x double> %wide.load, %49
  %56 = fadd <2 x double> %wide.load117, %50
  ...
  br i1 %59, label %for.cond52.for.end71_crit_edge.us.us.loopexit146, label %vector.body, !llvm.loop !9
...
for.body55.us.us:                                 ; preds = %for.body55.us.us, %for.body55.us.us.preheader
  ...
  %60 = load double, double* %arrayidx59.us.us, align 8
  %arrayidx63.us.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv51, i64 %indvars.iv59
  %61 = load double, double* %arrayidx63.us.us, align 8
  %mul.us.us = fmul double %60, %61
  %arrayidx67.us.us = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %16, i64 0, i64 %indvars.iv55, i64 %indvars.iv51
  %62 = load double, double* %arrayidx67.us.us, align 8
  %add68.us.us = fadd double %62, %mul.us.us
  store double %add68.us.us, double* %arrayidx67.us.us, align 8
  %indvars.iv.next52 = or i64 %indvars.iv51, 1
  %63 = load double, double* %arrayidx59.us.us, align 8
  %arrayidx63.us.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv.next52, i64 %indvars.iv59
  %64 = load double, double* %arrayidx63.us.us.1, align 8
  %mul.us.us.1 = fmul double %63, %64
  %arrayidx67.us.us.1 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %17, i64 0, i64 %indvars.iv55, i64 %indvars.iv.next52
  %65 = load double, double* %arrayidx67.us.us.1, align 8
  %add68.us.us.1 = fadd double %65, %mul.us.us.1
...
for.cond82.preheader.us:                          ; preds = %for.cond82.preheader.us.preheader, %for.cond82.for.end96_crit_edge.us
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.cond82.for.end96_crit_edge.us ], [ 0, %for.cond82.preheader.us.preheader ]
  ...
  %66 = add i64 %indvars.iv47, 1
  %scevgep125 = getelementptr [2000 x double], [2000 x double]* %A, i64 %66, i64 0
  %scevgep125126 = bitcast double* %scevgep125 to i8*
  %67 = mul i64 %indvars.iv47, 16000
  %scevgep127 = getelementptr i8, i8* %call, i64 %67
  %68 = add i64 %67, 16000
  %scevgep128 = getelementptr i8, i8* %call, i64 %68
...
vector.body118:                                   ; preds = %vector.body118, %vector.body118.preheader
  ...
  %69 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %25, i64 0, i64 %indvars.iv47, i64 %index135
  %70 = bitcast double* %69 to <2 x i64>*
  %wide.load143 = load <2 x i64>, <2 x i64>* %70, align 8, !alias.scope !13
  %71 = getelementptr double, double* %69, i64 2
  %72 = bitcast double* %71 to <2 x i64>*
  %wide.load144 = load <2 x i64>, <2 x i64>* %72, align 8, !alias.scope !13
  %73 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv47, i64 %index135
  %74 = bitcast double* %73 to <2 x i64>*
  store <2 x i64> %wide.load143, <2 x i64>* %74, align 8, !alias.scope !16, !noalias !13
  %75 = getelementptr double, double* %73, i64 2
  %76 = bitcast double* %75 to <2 x i64>*
  store <2 x i64> %wide.load144, <2 x i64>* %76, align 8, !alias.scope !16, !noalias !13
  %index.next136 = or i64 %index135, 4
  %77 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv47, i64 %index.next136
  %78 = bitcast double* %77 to <2 x i64>*
  %wide.load143.1 = load <2 x i64>, <2 x i64>* %78, align 8, !alias.scope !13
  %79 = getelementptr double, double* %77, i64 2
  %80 = bitcast double* %79 to <2 x i64>*
  %wide.load144.1 = load <2 x i64>, <2 x i64>* %80, align 8, !alias.scope !13
  %81 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv47, i64 %index.next136
  %82 = bitcast double* %81 to <2 x i64>*
  store <2 x i64> %wide.load143.1, <2 x i64>* %82, align 8, !alias.scope !16, !noalias !13
  %83 = getelementptr double, double* %81, i64 2
  %84 = bitcast double* %83 to <2 x i64>*
  store <2 x i64> %wide.load144.1, <2 x i64>* %84, align 8, !alias.scope !16, !noalias !13
  %index.next136.1 = add nsw i64 %index135, 8
  %85 = icmp eq i64 %index.next136.1, 2000
  br i1 %85, label %for.cond82.for.end96_crit_edge.us.loopexit145, label %vector.body118, !llvm.loop !18
...
for.body85.us:                                    ; preds = %for.body85.us, %for.body85.us.preheader
  ...
  %arrayidx89.us = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv47, i64 %indvars.iv
  %86 = bitcast double* %arrayidx89.us to i64*
  %87 = load i64, i64* %86, align 8
  %arrayidx93.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv47, i64 %indvars.iv
  %88 = bitcast double* %arrayidx93.us to i64*
  store i64 %87, i64* %88, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx89.us.1 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %21, i64 0, i64 %indvars.iv47, i64 %indvars.iv.next
  %89 = bitcast double* %arrayidx89.us.1 to i64*
  %90 = load i64, i64* %89, align 8
  %arrayidx93.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv47, i64 %indvars.iv.next
  %91 = bitcast double* %arrayidx93.us.1 to i64*
  store i64 %90, i64* %91, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %arrayidx89.us.2 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %22, i64 0, i64 %indvars.iv47, i64 %indvars.iv.next.1
  %92 = bitcast double* %arrayidx89.us.2 to i64*
  %93 = load i64, i64* %92, align 8
  %arrayidx93.us.2 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv47, i64 %indvars.iv.next.1
  %94 = bitcast double* %arrayidx93.us.2 to i64*
  store i64 %93, i64* %94, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %arrayidx89.us.3 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %23, i64 0, i64 %indvars.iv47, i64 %indvars.iv.next.2
  %95 = bitcast double* %arrayidx89.us.3 to i64*
  %96 = load i64, i64* %95, align 8
  %arrayidx93.us.3 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv47, i64 %indvars.iv.next.2
  %97 = bitcast double* %arrayidx93.us.3 to i64*
  store i64 %96, i64* %97, align 8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %arrayidx89.us.4 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %24, i64 0, i64 %indvars.iv47, i64 %indvars.iv.next.3
  %98 = bitcast double* %arrayidx89.us.4 to i64*
  %99 = load i64, i64* %98, align 8
  %arrayidx93.us.4 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv47, i64 %indvars.iv.next.3
  %100 = bitcast double* %arrayidx93.us.4 to i64*
...
for.cond82.for.end96_crit_edge.us:                ; preds = %for.cond82.for.end96_crit_edge.us.loopexit145, %for.cond82.for.end96_crit_edge.us.loopexit
  ...
  %exitcond103 = icmp eq i64 %indvars.iv.next48, 2000
...
for.cond31.preheader.us.preheader:                ; preds = %for.cond31.preheader.lr.ph
  ...
  %1 = icmp eq i64 %indvars.iv37, 1
  %arrayidx37.us.prol = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv37, i64 0
...
for.body33.us.prol.loopexit.unr-lcssa:            ; preds = %for.cond31.preheader.us, %for.body33.us.prol
  ...
  %.unr45.ph = phi double [ %sub47.us.prol, %for.body33.us.prol ], [ %.pre15, %for.cond31.preheader.us ]
...
for.body33.us:                                    ; preds = %for.body33.us, %for.cond31.preheader.us.new
  ...
  %4 = phi double [ %.unr45.ph, %for.cond31.preheader.us.new ], [ %sub47.us.1, %for.body33.us ]
