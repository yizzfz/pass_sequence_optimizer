...
; <label>:18:                                     ; preds = %43, %13
  ...
  %20 = call i64 @read(i32 0, i8* bitcast ([1000 x i16]* @sbuf to i8*), i64 2000)
...
; <label>:35:                                     ; preds = %31
  ...
  %39 = sdiv i32 %38, 2
  call void @adpcm_coder(i16* getelementptr inbounds ([1000 x i16], [1000 x i16]* @sbuf, i32 0, i32 0), i8* getelementptr inbounds ([500 x i8], [500 x i8]* @abuf, i32 0, i32 0), i32 %39, %struct.adpcm_state* @state)
  br label %40
...
; <label>:43:                                     ; preds = %31
  ...
  %48 = call i64 @write(i32 1, i8* getelementptr inbounds ([500 x i8], [500 x i8]* @abuf, i32 0, i32 0), i64 %47)
  br label %18
