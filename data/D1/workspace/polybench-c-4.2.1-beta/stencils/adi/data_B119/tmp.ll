...
.preheader4:                                      ; preds = %._crit_edge16, %4
  %.0317 = phi i32 [ 1, %4 ], [ %154, %._crit_edge16 ]
  br label %.lver.check

.lver.check:                                      ; preds = %36, %.preheader4
  %indvar = phi i64 [ %5, %36 ], [ 0, %.preheader4 ]
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %36 ], [ 1, %.preheader4 ]
  %5 = add i64 %indvar, 1
  ...
  %6 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 0, i64 %indvars.iv23
  store double 1.000000e+00, double* %6, align 8
  %7 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv23, i64 0
  store double 0.000000e+00, double* %7, align 8
  %8 = bitcast double* %6 to i64*
  %9 = load i64, i64* %8, align 8
  %10 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv23
...
.ph.lver.orig:                                    ; preds = %.ph.lver.orig.preheader, %.ph.lver.orig
  ...
  %14 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv23, i64 %13
  %15 = load double, double* %14, align 8
  %16 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv23, i64 %indvars.iv.lver.orig
  %17 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv.lver.orig, i64 %12
  %18 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv.lver.orig, i64 %indvars.iv.next24
  %19 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv23, i64 %13
  ...
  %35 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv23, i64 %indvars.iv.lver.orig
...
; <label>:36:                                     ; preds = %37
  %exitcond1 = icmp eq i64 %indvars.iv.next24, 999
...
; <label>:37:                                     ; preds = %37, %._crit_edge.us
  ...
  %indvars.iv21 = phi i64 [ 998, %._crit_edge.us ], [ %indvars.iv.next22.1, %37 ]
  %39 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv23, i64 %indvars.iv21
  %40 = load double, double* %39, align 8
  %41 = fmul double %40, %38
  %42 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv23, i64 %indvars.iv21
  %43 = load double, double* %42, align 8
  %44 = fadd double %41, %43
  %45 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv21, i64 %indvars.iv23
  store double %44, double* %45, align 8
  %indvars.iv.next22 = add nsw i64 %indvars.iv21, -1
  %46 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv23, i64 %indvars.iv.next22
  %47 = load double, double* %46, align 8
  %48 = fmul double %47, %44
  %49 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv23, i64 %indvars.iv.next22
  %50 = load double, double* %49, align 8
  %51 = fadd double %48, %50
  %52 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv.next22, i64 %indvars.iv23
  store double %51, double* %52, align 8
  %53 = icmp sgt i64 %indvars.iv.next22, 1
...
; <label>:54:                                     ; preds = %54, %.ph
  ...
  %55 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv23, i64 %indvars.iv
  %56 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv, i64 %12
  %57 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv, i64 %indvars.iv.next24
  ...
  %72 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv23, i64 %indvars.iv
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit37, %._crit_edge.us.loopexit
  %73 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 999, i64 %indvars.iv23
...
.lver.check28:                                    ; preds = %.lver.check28.preheader, %110
  ...
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %110 ], [ 1, %.lver.check28.preheader ]
  ...
  %75 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv30, i64 0
  store double 1.000000e+00, double* %75, align 8
  %76 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv30, i64 0
  store double 0.000000e+00, double* %76, align 8
  %77 = bitcast double* %75 to i64*
  %78 = load i64, i64* %77, align 8
  %79 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv30
...
.ph29.lver.orig:                                  ; preds = %.ph29.lver.orig.preheader, %.ph29.lver.orig
  %indvars.iv25.lver.orig = phi i64 [ %indvars.iv.next26.lver.orig, %.ph29.lver.orig ], [ 1, %.ph29.lver.orig.preheader ]
  %82 = add nsw i64 %indvars.iv25.lver.orig, -1
  %83 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv30, i64 %82
  %84 = load double, double* %83, align 8
  %85 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv30, i64 %indvars.iv25.lver.orig
  %86 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %81, i64 %indvars.iv25.lver.orig
  %87 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv30, i64 %indvars.iv25.lver.orig
  %88 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv.next31, i64 %indvars.iv25.lver.orig
  %89 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv30, i64 %82
  ...
  %109 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv30, i64 %indvars.iv25.lver.orig
  store double %108, double* %109, align 8
  %exitcond27.lver.orig = icmp eq i64 %indvars.iv25.lver.orig, 998
  %indvars.iv.next26.lver.orig = add nuw nsw i64 %indvars.iv25.lver.orig, 1
  br i1 %exitcond27.lver.orig, label %._crit_edge12.us.loopexit, label %.ph29.lver.orig
...
; <label>:110:                                    ; preds = %111
  %exitcond2 = icmp eq i64 %indvars.iv.next31, 999
  br i1 %exitcond2, label %._crit_edge16, label %.lver.check28

; <label>:111:                                    ; preds = %111, %._crit_edge12.us
  %indvars.iv28 = phi i64 [ 998, %._crit_edge12.us ], [ %indvars.iv.next29.1, %111 ]
  %112 = phi double [ 1.000000e+00, %._crit_edge12.us ], [ %125, %111 ]
  %113 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv30, i64 %indvars.iv28
  %114 = load double, double* %113, align 8
  %115 = fmul double %114, %112
  %116 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv30, i64 %indvars.iv28
  %117 = load double, double* %116, align 8
  %118 = fadd double %115, %117
  %119 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv30, i64 %indvars.iv28
  store double %118, double* %119, align 8
  %indvars.iv.next29 = add nsw i64 %indvars.iv28, -1
  %120 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv30, i64 %indvars.iv.next29
  %121 = load double, double* %120, align 8
  %122 = fmul double %121, %118
  %123 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv30, i64 %indvars.iv.next29
  %124 = load double, double* %123, align 8
  %125 = fadd double %122, %124
  %126 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv30, i64 %indvars.iv.next29
  store double %125, double* %126, align 8
  %127 = icmp sgt i64 %indvars.iv.next29, 1
...
; <label>:128:                                    ; preds = %128, %.ph29
  ...
  %indvars.iv25 = phi i64 [ 1, %.ph29 ], [ %indvars.iv.next26, %128 ]
  %129 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv30, i64 %indvars.iv25
  %130 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %81, i64 %indvars.iv25
  %131 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv30, i64 %indvars.iv25
  %132 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv.next31, i64 %indvars.iv25
  ...
  %151 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv30, i64 %indvars.iv25
  store double %150, double* %151, align 8
  %exitcond27 = icmp eq i64 %indvars.iv25, 998
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  br i1 %exitcond27, label %._crit_edge12.us.loopexit36, label %128

._crit_edge12.us.loopexit:                        ; preds = %.ph29.lver.orig
  br label %._crit_edge12.us

._crit_edge12.us.loopexit36:                      ; preds = %128
  br label %._crit_edge12.us

._crit_edge12.us:                                 ; preds = %._crit_edge12.us.loopexit36, %._crit_edge12.us.loopexit
  %152 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv30, i64 999
  store double 1.000000e+00, double* %152, align 8
  br label %111

._crit_edge16:                                    ; preds = %110
  %153 = icmp sgt i32 %.0317, 499
  %154 = add nuw nsw i32 %.0317, 1
  br i1 %153, label %155, label %.preheader4

; <label>:155:                                    ; preds = %._crit_edge16
  ret void
}
