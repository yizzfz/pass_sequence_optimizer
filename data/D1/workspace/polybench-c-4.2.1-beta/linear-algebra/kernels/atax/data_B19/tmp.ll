...
.lr.ph5:                                          ; preds = %.lr.ph5, %.lr.ph5.preheader
  ...
  br i1 %exitcond12.2, label %.lr.ph2.preheader, label %.lr.ph5
...
._crit_edge:                                      ; preds = %._crit_edge1
  ...
  br i1 %exitcond9, label %._crit_edge3, label %.lr.ph2
...
.lr.ph:                                           ; preds = %._crit_edge3, %.lr.ph5
  ...
  %sunkaddr27 = shl nuw nsw i64 %indvars.iv13, 3
...
.lr.ph2.preheader:                                ; preds = %._crit_edge
  %sunkaddr31 = shl nuw nsw i64 %indvars.iv13, 3
...
.lr.ph2:                                          ; preds = %.lr.ph2.preheader, %.lr.ph2
  ...
  %29 = load double, double* %sunkaddr33, align 8
  ...
  %36 = load double, double* %sunkaddr33, align 8
  ...
  %43 = load double, double* %sunkaddr33, align 8
  %44 = fmul double %42, %43
  %45 = fadd double %40, %44
  store double %45, double* %39, align 8
  %indvars.iv.next11.2 = add nuw nsw i64 %indvars.iv10, 3
  %exitcond12.2 = icmp eq i64 %indvars.iv.next11.2, 2100
  br i1 %exitcond12.2, label %._crit_edge3, label %.lr.ph2

._crit_edge3:                                     ; preds = %.lr.ph2
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 1900
