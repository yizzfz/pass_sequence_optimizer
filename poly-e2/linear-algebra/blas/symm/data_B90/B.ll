...
for.body26.lr.ph:                                 ; preds = %for.body26.lr.ph.preheader, %for.inc51
  %indvars.iv78 = phi i3 [ -1, %for.body26.lr.ph.preheader ], [ %indvars.iv.next79, %for.inc51 ]
  %indvars.iv76 = phi i64 [ 2, %for.body26.lr.ph.preheader ], [ %indvars.iv.next77, %for.inc51 ]
  ...
  %5 = zext i3 %indvars.iv78 to i32
  %6 = add i32 %5, -1
  %7 = zext i32 %6 to i64
  %8 = add i64 %indvars.iv76, %7
...
for.body43.prol.loopexit:                         ; preds = %for.body43.prol.loopexit.loopexit, %for.body43.lr.ph
  %indvars.iv51.unr = phi i64 [ %indvars.iv58, %for.body43.lr.ph ], [ %8, %for.body43.prol.loopexit.loopexit ]
...
for.inc51:                                        ; preds = %for.inc51.loopexit, %middle.block, %for.body43.prol.loopexit, %for.cond40.preheader
  ...
  %indvars.iv.next79 = add i3 %indvars.iv78, -1
