...
._crit_edge.us:                                   ; preds = %17
  ...
  br i1 %18, label %.preheader.us, label %._crit_edge7
...
define internal fastcc void @kernel_floyd_warshall(i32, [2800 x i32]*) unnamed_addr #2 {
  %3 = icmp sgt i32 %0, 0
  br i1 %3, label %.preheader3.us.preheader, label %30

.preheader3.us.preheader:                         ; preds = %2
...
.preheader.us.us.preheader:                       ; preds = %._crit_edge5.us, %.preheader3.us.preheader
  %indvars.iv34 = phi i64 [ 0, %.preheader3.us.preheader ], [ %indvars.iv.next35, %._crit_edge5.us ]
  %7 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv34, i64 0
  br label %.preheader.us.us

._crit_edge5.us:                                  ; preds = %._crit_edge.us.us
  %indvars.iv.next35 = add nsw i64 %indvars.iv34, 1
  %8 = icmp slt i64 %indvars.iv.next35, %4
  br i1 %8, label %.preheader.us.us.preheader, label %.loopexit

.preheader.us.us:                                 ; preds = %.preheader.us.us.preheader, %._crit_edge.us.us
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %._crit_edge.us.us ], [ 0, %.preheader.us.us.preheader ]
  %9 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv31, i64 %indvars.iv34
  br i1 %5, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.preheader.us.us
  %10 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv31, i64 0
  %11 = load i32, i32* %10, align 4
  %12 = load i32, i32* %9, align 4
  %13 = load i32, i32* %7, align 4
  %14 = add nsw i32 %13, %12
  %15 = icmp slt i32 %11, %14
  %..us.us.prol = select i1 %15, i32 %11, i32 %14
  store i32 %..us.us.prol, i32* %10, align 4
...
._crit_edge.us.us:                                ; preds = %._crit_edge.us.us.loopexit, %.prol.loopexit
  ...
  br i1 %exitcond, label %._crit_edge5.us, label %.preheader.us.us
...
.preheader.us.us.new:                             ; preds = %.preheader.us.us.new.preheader, %.preheader.us.us.new
  ...
  %16 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv31, i64 %indvars.iv
  %17 = load i32, i32* %16, align 4
  %18 = load i32, i32* %9, align 4
  %19 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv34, i64 %indvars.iv
  %20 = load i32, i32* %19, align 4
  %21 = add nsw i32 %20, %18
  %22 = icmp slt i32 %17, %21
  %..us.us = select i1 %22, i32 %17, i32 %21
  store i32 %..us.us, i32* %16, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %23 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv31, i64 %indvars.iv.next
  %24 = load i32, i32* %23, align 4
  %25 = load i32, i32* %9, align 4
  %26 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv34, i64 %indvars.iv.next
  %27 = load i32, i32* %26, align 4
  %28 = add nsw i32 %27, %25
  %29 = icmp slt i32 %24, %28
  %..us.us.1 = select i1 %29, i32 %24, i32 %28
  store i32 %..us.us.1, i32* %23, align 4
...
define internal fastcc void @print_array(i32, [2800 x i32]*) unnamed_addr #0 {
  ...
  %7 = icmp sgt i32 %0, 0
  br i1 %7, label %.preheader.us.preheader, label %23
...
; <label>:17:                                     ; preds = %15, %10
  ...
  %19 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv11, i64 %indvars.iv
  %20 = load i32, i32* %19, align 4
...
._crit_edge.us:                                   ; preds = %17
  ...
  %22 = icmp slt i64 %indvars.iv.next12, %8
  br i1 %22, label %.preheader.us, label %.loopexit

.loopexit:                                        ; preds = %._crit_edge.us
  br label %23

; <label>:23:                                     ; preds = %.loopexit, %2
