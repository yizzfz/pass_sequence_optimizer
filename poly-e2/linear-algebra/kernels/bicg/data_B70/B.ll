...
entry:
  ...
  %arraydecay15 = bitcast i8* %call to [1900 x double]*
  %arraydecay516 = bitcast i8* %call4 to double*
  %arraydecay617 = bitcast i8* %call3 to double*
  tail call void @init_array([1900 x double]* %arraydecay15, double* %arraydecay516, double* %arraydecay617)
  tail call void (...) @polybench_timer_start() #4
  %arraydecay818 = bitcast i8* %call1 to double*
  %arraydecay919 = bitcast i8* %call2 to double*
  tail call void @kernel_bicg([1900 x double]* %arraydecay15, double* %arraydecay818, double* %arraydecay919, double* %arraydecay617, double* %arraydecay516)
...
for.body5.us:                                     ; preds = %for.body5.us.preheader, %for.cond12.for.inc27_crit_edge.us
  %indvars.iv2128.us = phi i64 [ %indvars.iv.next22.us, %for.cond12.for.inc27_crit_edge.us ], [ 0, %for.body5.us.preheader ]
  %0 = trunc i64 %indvars.iv2128.us to i32
  %rem6.us = srem i32 %0, 2100
  %conv7.us = sitofp i32 %rem6.us to double
  %div9.us = fdiv double %conv7.us, 2.100000e+03
  %arrayidx11.us = getelementptr inbounds double, double* %r, i64 %indvars.iv2128.us
  store double %div9.us, double* %arrayidx11.us, align 8
  br label %for.body15.us

for.body15.us:                                    ; preds = %for.body15.us, %for.body5.us
  %indvars.iv26.us = phi i64 [ 0, %for.body5.us ], [ %indvars.iv.next.us.1, %for.body15.us ]
  %indvars.iv.next.us = or i64 %indvars.iv26.us, 1
  %1 = mul nuw nsw i64 %indvars.iv.next.us, %indvars.iv2128.us
  %2 = trunc i64 %1 to i32
  %rem16.us = srem i32 %2, 2100
  %conv17.us = sitofp i32 %rem16.us to double
  %arrayidx23.us = getelementptr inbounds [1900 x double], [1900 x double]* %A, i64 %indvars.iv2128.us, i64 %indvars.iv26.us
  %indvars.iv.next.us.1 = add nsw i64 %indvars.iv26.us, 2
  %3 = mul nuw nsw i64 %indvars.iv.next.us.1, %indvars.iv2128.us
...
for.cond12.for.inc27_crit_edge.us:                ; preds = %for.body15.us
  %indvars.iv.next22.us = add nuw nsw i64 %indvars.iv2128.us, 1
  %exitcond = icmp eq i64 %indvars.iv.next22.us, 2100
  br i1 %exitcond, label %for.end29, label %for.body5.us

for.inc:                                          ; preds = %for.inc, %for.inc.lr.ph
  %indvars.iv2331 = phi i64 [ 0, %for.inc.lr.ph ], [ %indvars.iv.next24.1, %for.inc ]
  %6 = trunc i64 %indvars.iv2331 to i32
  %rem = srem i32 %6, 1900
  %conv = sitofp i32 %rem to double
  %arrayidx = getelementptr inbounds double, double* %p, i64 %indvars.iv2331
  %7 = trunc i64 %indvars.iv2331 to i32
  %8 = or i32 %7, 1
  %rem.1 = srem i32 %8, 1900
  ...
  %exitcond1.1 = icmp eq i64 %indvars.iv.next24.1, 1900
  br i1 %exitcond1.1, label %for.body5.us.preheader, label %for.inc
...
for.body3.us.preheader:
  %s4 = bitcast double* %s to i8*
  call void @llvm.memset.p0i8.i64(i8* %s4, i8 0, i64 15200, i32 8, i1 false)
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.cond6.for.inc34_crit_edge.us, %for.body3.us.preheader
  %indvars.iv2633.us = phi i64 [ %indvars.iv.next27.us, %for.cond6.for.inc34_crit_edge.us ], [ 0, %for.body3.us.preheader ]
  %arrayidx5.us = getelementptr inbounds double, double* %q, i64 %indvars.iv2633.us
  store double 0.000000e+00, double* %arrayidx5.us, align 8
  br label %for.inc31.us

for.inc31.us:                                     ; preds = %for.inc31.us, %for.body3.us
  %indvars.iv31.us = phi i64 [ 0, %for.body3.us ], [ %indvars.iv.next.us, %for.inc31.us ]
  %arrayidx10.us = getelementptr inbounds double, double* %s, i64 %indvars.iv31.us
  %0 = load double, double* %arrayidx10.us, align 8
  %sunkaddr = ptrtoint double* %r to i64
  %sunkaddr12 = mul i64 %indvars.iv2633.us, 8
  %sunkaddr13 = add i64 %sunkaddr, %sunkaddr12
  %sunkaddr14 = inttoptr i64 %sunkaddr13 to double*
  %1 = load double, double* %sunkaddr14, align 8
  %arrayidx16.us = getelementptr inbounds [1900 x double], [1900 x double]* %A, i64 %indvars.iv2633.us, i64 %indvars.iv31.us
  ...
  %sunkaddr15 = ptrtoint double* %q to i64
  %sunkaddr16 = mul i64 %indvars.iv2633.us, 8
  %sunkaddr17 = add i64 %sunkaddr15, %sunkaddr16
  %sunkaddr18 = inttoptr i64 %sunkaddr17 to double*
  %3 = load double, double* %sunkaddr18, align 8
  %4 = load double, double* %arrayidx16.us, align 8
  %arrayidx26.us = getelementptr inbounds double, double* %p, i64 %indvars.iv31.us
  %5 = load double, double* %arrayidx26.us, align 8
  %mul27.us = fmul double %4, %5
  %add28.us = fadd double %3, %mul27.us
  store double %add28.us, double* %sunkaddr18, align 8
...
for.cond6.for.inc34_crit_edge.us:                 ; preds = %for.inc31.us
  %indvars.iv.next27.us = add nuw nsw i64 %indvars.iv2633.us, 1
  %exitcond1 = icmp eq i64 %indvars.iv.next27.us, 2100
  br i1 %exitcond1, label %for.end36, label %for.body3.us
...
for.body:                                         ; preds = %for.inc, %for.body.preheader
  %indvars.iv816 = phi i64 [ %indvars.iv.next9, %for.inc ], [ 0, %for.body.preheader ]
  %3 = trunc i64 %indvars.iv816 to i32
  %rem = srem i32 %3, 20
...
if.then:                                          ; preds = %for.body
  ...
  %fputc12 = tail call i32 @fputc(i32 10, %struct._IO_FILE* %4) #6
  br label %for.inc

for.inc:                                          ; preds = %for.body, %if.then
  %5 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %arrayidx = getelementptr inbounds double, double* %s, i64 %indvars.iv816
  ...
  %exitcond1 = icmp eq i64 %indvars.iv.next9, 1900
  br i1 %exitcond1, label %for.body9.preheader, label %for.body
...
for.body9:                                        ; preds = %for.inc18, %for.body9.preheader
  %indvars.iv14 = phi i64 [ %indvars.iv.next, %for.inc18 ], [ 0, %for.body9.preheader ]
