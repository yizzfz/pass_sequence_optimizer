...
entry:
  ...
  %arraydecay31 = bitcast i8* %call to [1000 x double]*
  %arraydecay42 = bitcast i8* %call1 to [1200 x double]*
  call void @kernel_trmm(i32 1000, i32 1200, double %0, [1000 x double]* %arraydecay31, [1200 x double]* %arraydecay42)
...
if.then:                                          ; preds = %land.lhs.true
  ...
  call void @print_array(i32 1000, i32 1200, [1200 x double]* %2)
  br label %if.end
...
for.cond1.preheader.us:                           ; preds = %for.cond1.preheader.us.preheader, %for.cond11.for.inc27_crit_edge.us
  %indvars.iv23 = phi i64 [ 0, %for.cond1.preheader.us.preheader ], [ %indvars.iv.next24, %for.cond11.for.inc27_crit_edge.us ]
...
for.inc24.us:                                     ; preds = %for.inc24.us.preheader, %for.inc24.us
  ...
  br i1 %exitcond.122, label %for.cond11.for.inc27_crit_edge.us.loopexit, label %for.inc24.us
...
for.cond1.preheader.us:                           ; preds = %for.cond1.preheader.us.preheader, %for.cond1.for.cond.loopexit_crit_edge.us
  %indvars.iv20 = phi i64 [ 0, %for.cond1.preheader.us.preheader ], [ %indvars.iv.next21, %for.cond1.for.cond.loopexit_crit_edge.us ]
  %0 = phi i32 [ 0, %for.cond1.preheader.us.preheader ], [ %add.us, %for.cond1.for.cond.loopexit_crit_edge.us ]
...
for.inc27.us:                                     ; preds = %for.inc27.us.loopexit, %for.cond4.preheader.us.for.inc27.us_crit_edge, %for.inc.us.prol.loopexit
  %arrayidx21.us.pre-phi = phi double* [ %.pre22, %for.cond4.preheader.us.for.inc27.us_crit_edge ], [ %arrayidx16.us, %for.inc.us.prol.loopexit ], [ %arrayidx16.us, %for.inc27.us.loopexit ]
...
for.inc.us:                                       ; preds = %for.inc.us.prol.loopexit.for.inc.us_crit_edge, %for.inc.us
  %3 = phi double [ %add17.us.1, %for.inc.us ], [ %.pre, %for.inc.us.prol.loopexit.for.inc.us_crit_edge ]
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %for.inc.us ], [ %indvars.iv.unr.ph, %for.inc.us.prol.loopexit.for.inc.us_crit_edge ]
  %arrayidx8.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv, i64 %indvars.iv20
  ...
  %arrayidx8.us.1 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv.next, i64 %indvars.iv20
...
for.cond4.preheader.us:                           ; preds = %for.inc27.us, %for.cond1.preheader.us
  ...
  %add7.us = phi i32 [ %1, %for.cond1.preheader.us ], [ %add.us, %for.inc27.us ]
  %cmp53.us = icmp slt i32 %add7.us, 1000
  br i1 %cmp53.us, label %for.inc.lr.ph.us, label %for.cond4.preheader.us.for.inc27.us_crit_edge

for.cond4.preheader.us.for.inc27.us_crit_edge:    ; preds = %for.cond4.preheader.us
  %.pre22 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv20, i64 %indvars.iv17
  br label %for.inc27.us

for.inc.lr.ph.us:                                 ; preds = %for.cond4.preheader.us
  %arrayidx16.us = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv20, i64 %indvars.iv17
  %8 = sext i32 %add7.us to i64
  %9 = sub i32 1000, %add7.us
  %xtraiter = and i32 %9, 1
  %lcmp.mod = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod, label %for.inc.us.prol.loopexit, label %for.inc.us.prol

for.inc.us.prol:                                  ; preds = %for.inc.lr.ph.us
  %arrayidx8.us.prol = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %8, i64 %indvars.iv20
  %10 = load double, double* %arrayidx8.us.prol, align 8
  %arrayidx12.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %8, i64 %indvars.iv17
...
for.inc.us.prol.loopexit:                         ; preds = %for.inc.us.prol, %for.inc.lr.ph.us
  %indvars.iv.unr.ph = phi i64 [ %indvars.iv.next.prol, %for.inc.us.prol ], [ %8, %for.inc.lr.ph.us ]
  %13 = icmp eq i32 999, %add7.us
  br i1 %13, label %for.inc27.us, label %for.inc.us.prol.loopexit.for.inc.us_crit_edge

for.inc.us.prol.loopexit.for.inc.us_crit_edge:    ; preds = %for.inc.us.prol.loopexit
  %.pre = load double, double* %arrayidx16.us, align 8
  br label %for.inc.us

for.cond1.for.cond.loopexit_crit_edge.us:         ; preds = %for.inc27.us
  %cmp.us = icmp slt i64 %indvars.iv.next21, 1000
  br i1 %cmp.us, label %for.cond1.preheader.us, label %for.cond.for.end32_crit_edge.loopexit

for.cond.for.end32_crit_edge.loopexit16:          ; preds = %for.cond1.preheader.lr.ph
  br label %for.cond.for.end32_crit_edge

for.cond.for.end32_crit_edge.loopexit:            ; preds = %for.cond1.for.cond.loopexit_crit_edge.us
  br label %for.cond.for.end32_crit_edge

for.cond.for.end32_crit_edge:                     ; preds = %for.cond.for.end32_crit_edge.loopexit, %for.cond.for.end32_crit_edge.loopexit16
  br label %for.end32
