...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array(i32, [2000 x double]* nocapture, double* nocapture, double* nocapture, double* nocapture) #0 {
...
.preheader15.preheader:                           ; preds = %.lr.ph47.prol.loopexit, %.preheader16
  %13 = add i32 %0, -2
...
.lr.ph47:                                         ; preds = %.lr.ph47.preheader111, %.lr.ph47
...
.lr.ph38:                                         ; preds = %.preheader15.preheader, %._crit_edge42
...
._crit_edge19:                                    ; preds = %._crit_edge19.loopexit, %._crit_edge44, %._crit_edge44.thread, %.preheader12, %.preheader9
...
define internal void @kernel_ludcmp(i32, [2000 x double]* nocapture, double* nocapture readonly, double* nocapture, double* nocapture) #2 {
  %6 = icmp sgt i32 %0, 0
...
.lr.ph31:                                         ; preds = %.lr.ph31.preheader123, %.lr.ph31
...
._crit_edge44:                                    ; preds = %._crit_edge44.loopexit, %.preheader12, %.lr.ph43
...
.lr.ph23:                                         ; preds = %.lr.ph23.preheader122, %.lr.ph23
...
._crit_edge19:                                    ; preds = %._crit_edge19.loopexit, %5, %.preheader10, %.preheader
  ret void
}
