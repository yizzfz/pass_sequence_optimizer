...
@__llvm_prf_nm = private constant [38 x i8] c"\1F$x\DA\0B\F1ts\F3\CC\CB,\F1K\8D\08a,\C9-0\D4\CB\C9\B1\02q\5CR\93\F3SR\01\A4\08\0A\83", section "__llvm_prf_names"
@llvm.used = appending global [3 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_TIFFInitNeXT to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_NeXTDecode to i8*), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
