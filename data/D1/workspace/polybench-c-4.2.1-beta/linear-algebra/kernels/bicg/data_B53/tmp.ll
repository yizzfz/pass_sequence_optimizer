...
.lr.ph6.split.us:                                 ; preds = %.lr.ph6.split.us.preheader, %._crit_edge4.us
  %3 = phi i32 [ %22, %._crit_edge4.us ], [ 0, %.lr.ph6.split.us.preheader ]
  %4 = srem i32 %3, 2100
...
; <label>:9:                                      ; preds = %9, %.lr.ph6.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph6.split.us ], [ %indvars.iv.next.1, %9 ]
  ...
  br i1 %exitcond22.1, label %._crit_edge4.us, label %9

._crit_edge4.us:                                  ; preds = %9
  %22 = add nsw i32 %3, 1
  %23 = icmp slt i32 %22, 2100
  br i1 %23, label %.lr.ph6.split.us, label %._crit_edge7

; <label>:24:                                     ; preds = %24, %.lr.ph12
  %indvars.iv20 = phi i64 [ 0, %.lr.ph12 ], [ %indvars.iv.next21.1, %24 ]
  %25 = trunc i64 %indvars.iv20 to i32
  %26 = srem i32 %25, 1900
  %27 = sitofp i32 %26 to double
  %28 = fdiv double %27, 1.900000e+03
  %29 = getelementptr inbounds double, double* %2, i64 %indvars.iv20
  ...
  %34 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next21
  store double %33, double* %34, align 8
  %indvars.iv.next21.1 = add nsw i64 %indvars.iv20, 2
  %35 = icmp slt i64 %indvars.iv.next21.1, 1900
  br i1 %35, label %24, label %.lr.ph6.split.us.preheader

.lr.ph6.split.us.preheader:                       ; preds = %24
...
.lr.ph5.split.us.preheader:                       ; preds = %25
  %sunkaddr = ptrtoint double* %4 to i64
  %sunkaddr18 = ptrtoint double* %2 to i64
  br label %.lr.ph5.split.us

.lr.ph5.split.us:                                 ; preds = %.lr.ph5.split.us.preheader, %._crit_edge4.us
  %5 = phi i32 [ %23, %._crit_edge4.us ], [ 0, %.lr.ph5.split.us.preheader ]
  %6 = sext i32 %5 to i64
...
; <label>:8:                                      ; preds = %.lr.ph5.split.us, %8
  %indvars.iv = phi i64 [ 0, %.lr.ph5.split.us ], [ %indvars.iv.next, %8 ]
  %9 = getelementptr inbounds double, double* %1, i64 %indvars.iv
  %10 = load double, double* %9, align 8
  %11 = load double, double* %sunkaddr17, align 8
  ...
  store double %21, double* %sunkaddr21, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %22 = icmp slt i64 %indvars.iv.next, 1900
  br i1 %22, label %8, label %._crit_edge4.us

._crit_edge4.us:                                  ; preds = %8
  %23 = add nsw i32 %5, 1
  %24 = icmp slt i32 %23, 2100
  br i1 %24, label %.lr.ph5.split.us, label %._crit_edge6

; <label>:25:                                     ; preds = %25, %.lr.ph11
  %indvars.iv30 = phi i64 [ 0, %.lr.ph11 ], [ %indvars.iv.next31.24, %25 ]
  %indvars.iv.next31.24 = add nsw i64 %indvars.iv30, 25
  %26 = icmp slt i64 %indvars.iv.next31.24, 1900
  br i1 %26, label %25, label %.lr.ph5.split.us.preheader
...
; <label>:21:                                     ; preds = %._crit_edge10, %._crit_edge5
  %indvars.iv = phi i64 [ 0, %._crit_edge10 ], [ %indvars.iv.next, %._crit_edge5 ]
  %22 = trunc i64 %indvars.iv to i32
  %23 = srem i32 %22, 20
  %24 = icmp eq i32 %23, 0
  br i1 %24, label %25, label %._crit_edge5
