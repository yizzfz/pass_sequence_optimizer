...
._crit_edge22:                                    ; preds = %._crit_edge22.._crit_edge22_crit_edge, %.preheader11
  ...
  br i1 %exitcond12.1, label %27, label %._crit_edge22.._crit_edge22_crit_edge

._crit_edge22.._crit_edge22_crit_edge:            ; preds = %._crit_edge22
  br label %._crit_edge22

; <label>:27:                                     ; preds = %._crit_edge22
...
..preheader11_crit_edge:                          ; preds = %27
  br label %.preheader11
...
._crit_edge24:                                    ; preds = %._crit_edge24.._crit_edge24_crit_edge, %.preheader
  ...
  br i1 %exitcond, label %44, label %._crit_edge24.._crit_edge24_crit_edge

._crit_edge24.._crit_edge24_crit_edge:            ; preds = %._crit_edge24
  br label %._crit_edge24

; <label>:44:                                     ; preds = %._crit_edge24
...
.preheader7:                                      ; preds = %..preheader7_crit_edge, %7
  %indvars.iv14 = phi i64 [ 0, %7 ], [ %indvars.iv.next15, %..preheader7_crit_edge ]
...
._crit_edge17:                                    ; preds = %.._crit_edge17_crit_edge, %.preheader7
  ...
  %8 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv14, i64 %indvars.iv10
...
._crit_edge:                                      ; preds = %._crit_edge.._crit_edge_crit_edge, %._crit_edge17
  ...
  %10 = getelementptr inbounds [1100 x double], [1100 x double]* %3, i64 %indvars.iv14, i64 %indvars.iv7
  ...
  %17 = getelementptr inbounds [1100 x double], [1100 x double]* %3, i64 %indvars.iv14, i64 %indvars.iv.next8
...
; <label>:25:                                     ; preds = %24
  ...
  br i1 %exitcond16, label %.preheader.preheader, label %..preheader7_crit_edge
