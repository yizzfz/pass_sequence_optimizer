...
define internal void @init_array(i32, [2000 x double]* nocapture) #0 {
  %3 = icmp sgt i32 %0, 0
  br i1 %3, label %.preheader14.lr.ph, label %._crit_edge33.thread

._crit_edge33.thread:                             ; preds = %2
...
.lr.ph29:                                         ; preds = %.preheader14.lr.ph, %._crit_edge31
  %indvars.iv89 = phi i64 [ 0, %.preheader14.lr.ph ], [ %indvars.iv.next90, %._crit_edge31 ]
  %indvars.iv87 = phi i64 [ 1, %.preheader14.lr.ph ], [ %indvars.iv.next88, %._crit_edge31 ]
...
.preheader13:                                     ; preds = %16
  ...
  br i1 %15, label %._crit_edge31.loopexit, label %._crit_edge31

; <label>:16:                                     ; preds = %16, %.lr.ph29
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %16 ], [ 0, %.lr.ph29 ]
  %17 = sub nsw i64 0, %indvars.iv73
  %18 = trunc i64 %17 to i32
  %19 = srem i32 %18, %0
  %20 = sitofp i32 %19 to double
  %21 = fdiv double %20, %5
  %22 = fadd double %21, 1.000000e+00
  %23 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv89, i64 %indvars.iv73
  store double %22, double* %23, align 8
  %indvars.iv.next74 = add nuw nsw i64 %indvars.iv73, 1
  %exitcond78 = icmp eq i64 %indvars.iv.next74, %indvars.iv87
  br i1 %exitcond78, label %.preheader13, label %16
...
._crit_edge31:                                    ; preds = %._crit_edge31.loopexit, %.preheader13
  ...
  br i1 %exitcond92, label %._crit_edge33, label %.lr.ph29
...
.preheader12.us.preheader:                        ; preds = %._crit_edge33
  %28 = add i32 %0, -1
  ...
  br i1 %lcmp.mod71, label %.preheader12.us.prol.loopexit, label %._crit_edge26.us.prol.preheader

._crit_edge26.us.prol.preheader:                  ; preds = %.preheader12.us.preheader
  br label %._crit_edge26.us.prol

._crit_edge26.us.prol:                            ; preds = %._crit_edge26.us.prol.preheader, %._crit_edge26.us.prol
  %indvars.iv66.prol = phi i64 [ %indvars.iv.next67.prol, %._crit_edge26.us.prol ], [ 0, %._crit_edge26.us.prol.preheader ]
  %prol.iter72 = phi i32 [ %prol.iter72.sub, %._crit_edge26.us.prol ], [ %xtraiter70, %._crit_edge26.us.prol.preheader ]
  %32 = mul nuw nsw i64 %indvars.iv66.prol, 16000
  ...
  br i1 %prol.iter72.cmp, label %.preheader12.us.prol.loopexit.loopexit, label %._crit_edge26.us.prol, !llvm.loop !1

.preheader12.us.prol.loopexit.loopexit:           ; preds = %._crit_edge26.us.prol
...
.preheader12.us.prol.loopexit:                    ; preds = %.preheader12.us.prol.loopexit.loopexit, %.preheader12.us.preheader
  ...
  br i1 %33, label %.preheader10.lr.ph, label %._crit_edge26.us.3.preheader

._crit_edge26.us.3.preheader:                     ; preds = %.preheader12.us.prol.loopexit
  %wide.trip.count68.3 = zext i32 %0 to i64
  %34 = add nsw i64 %wide.trip.count68.3, -4
  %35 = sub i64 %34, %indvars.iv66.unr
  %36 = lshr i64 %35, 2
  %37 = and i64 %36, 1
  %lcmp.mod98 = icmp eq i64 %37, 0
  br i1 %lcmp.mod98, label %._crit_edge26.us.3.prol.preheader, label %._crit_edge26.us.3.prol.loopexit

._crit_edge26.us.3.prol.preheader:                ; preds = %._crit_edge26.us.3.preheader
  br label %._crit_edge26.us.3.prol

._crit_edge26.us.3.prol:                          ; preds = %._crit_edge26.us.3.prol.preheader
  %38 = mul nuw nsw i64 %indvars.iv66.unr, 16000
  %scevgep.prol100 = getelementptr i8, i8* %25, i64 %38
  call void @llvm.memset.p0i8.i64(i8* %scevgep.prol100, i8 0, i64 %31, i32 8, i1 false)
  %39 = mul i64 %indvars.iv66.unr, 16000
  %40 = add i64 %39, 16000
  %scevgep.1.prol = getelementptr i8, i8* %25, i64 %40
  call void @llvm.memset.p0i8.i64(i8* %scevgep.1.prol, i8 0, i64 %31, i32 8, i1 false)
  %41 = mul i64 %indvars.iv66.unr, 16000
  %42 = add i64 %41, 32000
  %scevgep.2.prol = getelementptr i8, i8* %25, i64 %42
  call void @llvm.memset.p0i8.i64(i8* %scevgep.2.prol, i8 0, i64 %31, i32 8, i1 false)
  %43 = mul i64 %indvars.iv66.unr, 16000
  %44 = add i64 %43, 48000
  ...
  br label %._crit_edge26.us.3.prol.loopexit

._crit_edge26.us.3.prol.loopexit:                 ; preds = %._crit_edge26.us.3.prol, %._crit_edge26.us.3.preheader
  %indvars.iv66.unr101 = phi i64 [ %indvars.iv66.unr, %._crit_edge26.us.3.preheader ], [ %indvars.iv.next67.3.prol, %._crit_edge26.us.3.prol ]
  %45 = icmp eq i64 %36, 0
  br i1 %45, label %.preheader11, label %._crit_edge26.us.3.preheader.new

._crit_edge26.us.3.preheader.new:                 ; preds = %._crit_edge26.us.3.prol.loopexit
  br label %._crit_edge26.us.3

.preheader11.unr-lcssa:                           ; preds = %._crit_edge26.us.3
  br label %.preheader11

.preheader11:                                     ; preds = %._crit_edge26.us.3.prol.loopexit, %.preheader11.unr-lcssa
  %46 = icmp sgt i32 %0, 0
...
.preheader9.us.us.preheader:                      ; preds = %.preheader10.lr.ph, %._crit_edge22.us
  ...
  %48 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 0, i64 %indvars.iv58
...
.preheader9.us.us:                                ; preds = %._crit_edge20.us.us, %.preheader9.us.us.preheader
  ...
  %49 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv54, i64 %indvars.iv58
...
.prol.preheader50:                                ; preds = %.preheader9.us.us
  ...
  %53 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv54, i64 0
...
.preheader9.us.us.new:                            ; preds = %.preheader9.us.us.new.preheader, %.preheader9.us.us.new
  ...
  %57 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv46, i64 %indvars.iv58
  %58 = load double, double* %57, align 8
  %59 = fmul double %56, %58
  %60 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv54, i64 %indvars.iv46
  %61 = load double, double* %60, align 8
  %62 = fadd double %61, %59
  store double %62, double* %60, align 8
  %indvars.iv.next47 = add nuw nsw i64 %indvars.iv46, 1
  %63 = load double, double* %49, align 8
  %64 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv.next47, i64 %indvars.iv58
  %65 = load double, double* %64, align 8
  %66 = fmul double %63, %65
  %67 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv54, i64 %indvars.iv.next47
...
.prol.preheader:                                  ; preds = %.prol.preheader.preheader, %.prol.preheader
  ...
  %73 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv43, i64 %indvars.iv.prol
  %74 = bitcast double* %73 to i64*
  %75 = load i64, i64* %74, align 8
  %76 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv43, i64 %indvars.iv.prol
...
.preheader.us.new:                                ; preds = %.preheader.us.new.preheader, %.preheader.us.new
  ...
  %78 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv43, i64 %indvars.iv
  %79 = bitcast double* %78 to i64*
  %80 = load i64, i64* %79, align 8
  %81 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv43, i64 %indvars.iv
  %82 = bitcast double* %81 to i64*
  store i64 %80, i64* %82, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %83 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv43, i64 %indvars.iv.next
  %84 = bitcast double* %83 to i64*
  %85 = load i64, i64* %84, align 8
  %86 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv43, i64 %indvars.iv.next
  %87 = bitcast double* %86 to i64*
  store i64 %85, i64* %87, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %88 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv43, i64 %indvars.iv.next.1
  %89 = bitcast double* %88 to i64*
  %90 = load i64, i64* %89, align 8
  %91 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv43, i64 %indvars.iv.next.1
  %92 = bitcast double* %91 to i64*
  store i64 %90, i64* %92, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %93 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv43, i64 %indvars.iv.next.2
  %94 = bitcast double* %93 to i64*
  %95 = load i64, i64* %94, align 8
  %96 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv43, i64 %indvars.iv.next.2
...
._crit_edge17:                                    ; preds = %._crit_edge17.loopexit, %._crit_edge33, %._crit_edge33.thread, %.preheader11, %.preheader8
  %98 = phi i8* [ %25, %.preheader8 ], [ %25, %.preheader11 ], [ %25, %._crit_edge33 ], [ %4, %._crit_edge33.thread ], [ %25, %._crit_edge17.loopexit ]
  tail call void @free(i8* %98) #3
  ret void

._crit_edge26.us.3:                               ; preds = %._crit_edge26.us.3, %._crit_edge26.us.3.preheader.new
  %indvars.iv66 = phi i64 [ %indvars.iv66.unr101, %._crit_edge26.us.3.preheader.new ], [ %indvars.iv.next67.3.1, %._crit_edge26.us.3 ]
  %99 = mul nuw nsw i64 %indvars.iv66, 16000
  %scevgep = getelementptr i8, i8* %25, i64 %99
  call void @llvm.memset.p0i8.i64(i8* %scevgep, i8 0, i64 %31, i32 8, i1 false)
  %100 = mul i64 %indvars.iv66, 16000
  ...
  %102 = mul i64 %indvars.iv66, 16000
  ...
  %104 = mul i64 %indvars.iv66, 16000
  ...
  %106 = mul nuw nsw i64 %indvars.iv.next67.3, 16000
  %scevgep.1102 = getelementptr i8, i8* %25, i64 %106
  call void @llvm.memset.p0i8.i64(i8* %scevgep.1102, i8 0, i64 %31, i32 8, i1 false)
  %107 = mul i64 %indvars.iv.next67.3, 16000
  ...
  %109 = mul i64 %indvars.iv.next67.3, 16000
  ...
  %111 = mul i64 %indvars.iv.next67.3, 16000
  ...
  br i1 %exitcond69.3.1, label %.preheader11.unr-lcssa, label %._crit_edge26.us.3
}
