...
._crit_edge25:                                    ; preds = %._crit_edge25, %.preheader23
  ...
  br i1 %exitcond12.1, label %28, label %._crit_edge25

; <label>:28:                                     ; preds = %._crit_edge25
...
._crit_edge26:                                    ; preds = %._crit_edge26, %.preheader22
  ...
  br i1 %exitcond6, label %37, label %._crit_edge26

; <label>:37:                                     ; preds = %._crit_edge26
...
._crit_edge27:                                    ; preds = %._crit_edge27, %.preheader
  ...
  br i1 %exitcond, label %45, label %._crit_edge27

; <label>:45:                                     ; preds = %._crit_edge27
...
._crit_edge32:                                    ; preds = %27, %._crit_edge33
  %indvars.iv10 = phi i64 [ 0, %._crit_edge33 ], [ %indvars.iv.next11, %27 ]
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge32
  %indvars.iv7 = phi i64 [ 0, %._crit_edge32 ], [ %indvars.iv.next8.1, %._crit_edge ]
  %12 = phi double [ 0.000000e+00, %._crit_edge32 ], [ %26, %._crit_edge ]
...
; <label>:27:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond12, label %28, label %._crit_edge32

; <label>:28:                                     ; preds = %27
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 800
  br i1 %exitcond15, label %29, label %._crit_edge33
...
._crit_edge35:                                    ; preds = %49, %._crit_edge36
  %indvars.iv1 = phi i64 [ 0, %._crit_edge36 ], [ %indvars.iv.next2, %49 ]
...
._crit_edge34:                                    ; preds = %._crit_edge34, %._crit_edge35
  %indvars.iv = phi i64 [ 0, %._crit_edge35 ], [ %indvars.iv.next.1, %._crit_edge34 ]
  %36 = phi double [ %35, %._crit_edge35 ], [ %48, %._crit_edge34 ]
  ...
  br i1 %exitcond.1, label %49, label %._crit_edge34

; <label>:49:                                     ; preds = %._crit_edge34
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 1200
  br i1 %exitcond3, label %50, label %._crit_edge35

; <label>:50:                                     ; preds = %49
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1
  %exitcond6 = icmp eq i64 %indvars.iv.next5, 800
  br i1 %exitcond6, label %51, label %._crit_edge36
