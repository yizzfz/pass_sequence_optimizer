...
@__llvm_prf_nm = private constant [62 x i8] c"<\00mad_layer_I\01tmp1.ll:I_sample\01mad_layer_II\01tmp1.ll:II_samples", section "__llvm_prf_names"
@llvm.used = appending global [5 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_mad_layer_I to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_I_sample to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_mad_layer_II to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_II_samples to i8*), i8* getelementptr inbounds ([62 x i8], [62 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
