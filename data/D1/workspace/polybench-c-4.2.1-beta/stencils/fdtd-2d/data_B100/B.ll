...
._crit_edge.us:                                   ; preds = %._crit_edge
  ...
  %exitcond45 = icmp eq i64 %indvars.iv.next39, 1000
  br i1 %exitcond45, label %._crit_edge33, label %.preheader.us
...
.preheader78.lr.ph:
  %scevgep229 = getelementptr [1200 x double], [1200 x double]* %1, i64 1, i64 0
  br label %vector.memcheck236

vector.memcheck236:                               ; preds = %._crit_edge91, %.preheader78.lr.ph
  ...
  %bound0232 = icmp ugt [1200 x double]* %5, %1
  %bound1233 = icmp ult double* %4, %scevgep229
  %memcheck.conflict235 = and i1 %bound0232, %bound1233
  br i1 %memcheck.conflict235, label %scalar.ph226.preheader, label %vector.body224.preheader

vector.body224.preheader:                         ; preds = %vector.memcheck236
  %6 = bitcast double* %4 to i64*
  %7 = bitcast double* %4 to i64*
  %8 = bitcast double* %4 to i64*
  br label %vector.body224

scalar.ph226.preheader:                           ; preds = %vector.memcheck236
...
vector.body224:                                   ; preds = %vector.body224, %vector.body224.preheader
  %index238 = phi i64 [ 0, %vector.body224.preheader ], [ %index.next239.2, %vector.body224 ]
  ...
  %22 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 0, i64 %index238
  ...
  %index.next239 = add nuw nsw i64 %index238, 4
  ...
  %31 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 0, i64 %index.next239
  ...
  %index.next239.1 = add nsw i64 %index238, 8
  ...
  %40 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 0, i64 %index.next239.1
  ...
  %index.next239.2 = add nsw i64 %index238, 12
  %44 = icmp eq i64 %index.next239.2, 1200
  br i1 %44, label %vector.memcheck208.preheader.loopexit2, label %vector.body224, !llvm.loop !6

vector.memcheck208.preheader.loopexit:            ; preds = %scalar.ph226
  br label %vector.memcheck208.preheader

vector.memcheck208.preheader.loopexit2:           ; preds = %vector.body224
  br label %vector.memcheck208.preheader

vector.memcheck208.preheader:                     ; preds = %vector.memcheck208.preheader.loopexit2, %vector.memcheck208.preheader.loopexit
  br label %vector.memcheck208

vector.memcheck208:                               ; preds = %vector.memcheck208.preheader, %._crit_edge.us
  %indvar = phi i64 [ %indvar.next, %._crit_edge.us ], [ 0, %vector.memcheck208.preheader ]
  %indvars.iv105 = phi i64 [ %indvars.iv.next106, %._crit_edge.us ], [ 1, %vector.memcheck208.preheader ]
  %45 = add nuw nsw i64 %indvar, 1
  %scevgep196 = getelementptr [1200 x double], [1200 x double]* %1, i64 %45, i64 0
  %46 = add nuw nsw i64 %indvar, 2
  %scevgep198 = getelementptr [1200 x double], [1200 x double]* %1, i64 %46, i64 0
  %scevgep200 = getelementptr [1200 x double], [1200 x double]* %2, i64 %indvar, i64 0
  %scevgep202 = getelementptr [1200 x double], [1200 x double]* %2, i64 %46, i64 0
  %47 = add nsw i64 %indvars.iv105, -1
  %bound0204 = icmp ult double* %scevgep196, %scevgep202
  %bound1205 = icmp ult double* %scevgep200, %scevgep198
  %memcheck.conflict207 = and i1 %bound0204, %bound1205
  br i1 %memcheck.conflict207, label %scalar.ph193.preheader, label %vector.body191.preheader

vector.body191.preheader:                         ; preds = %vector.memcheck208
  br label %vector.body191

scalar.ph193.preheader:                           ; preds = %vector.memcheck208
  br label %scalar.ph193

vector.body191:                                   ; preds = %vector.body191.preheader, %vector.body191
  %index210 = phi i64 [ %index.next211, %vector.body191 ], [ 0, %vector.body191.preheader ]
  %48 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv105, i64 %index210
  %49 = bitcast double* %48 to <2 x double>*
  %wide.load218 = load <2 x double>, <2 x double>* %49, align 8, !alias.scope !9, !noalias !12
  %50 = getelementptr double, double* %48, i64 2
  %51 = bitcast double* %50 to <2 x double>*
  %wide.load219 = load <2 x double>, <2 x double>* %51, align 8, !alias.scope !9, !noalias !12
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv105, i64 %index210
  %53 = bitcast double* %52 to <2 x double>*
  %wide.load220 = load <2 x double>, <2 x double>* %53, align 8, !alias.scope !12
  %54 = getelementptr double, double* %52, i64 2
  %55 = bitcast double* %54 to <2 x double>*
  %wide.load221 = load <2 x double>, <2 x double>* %55, align 8, !alias.scope !12
  %56 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %47, i64 %index210
  %57 = bitcast double* %56 to <2 x double>*
  %wide.load222 = load <2 x double>, <2 x double>* %57, align 8, !alias.scope !12
  %58 = getelementptr double, double* %56, i64 2
  %59 = bitcast double* %58 to <2 x double>*
  %wide.load223 = load <2 x double>, <2 x double>* %59, align 8, !alias.scope !12
  %60 = fsub <2 x double> %wide.load220, %wide.load222
  %61 = fsub <2 x double> %wide.load221, %wide.load223
  ...
  %64 = fsub <2 x double> %wide.load218, %62
  %65 = fsub <2 x double> %wide.load219, %63
  ...
  %68 = icmp eq i64 %index.next211, 1200
  br i1 %68, label %._crit_edge.us.loopexit1, label %vector.body191, !llvm.loop !14

scalar.ph193:                                     ; preds = %scalar.ph193, %scalar.ph193.preheader
  %indvars.iv101 = phi i64 [ 0, %scalar.ph193.preheader ], [ %indvars.iv.next102.1, %scalar.ph193 ]
  ...
  br i1 %exitcond104.1, label %._crit_edge.us.loopexit, label %scalar.ph193, !llvm.loop !15

._crit_edge.us.loopexit:                          ; preds = %scalar.ph193
  br label %._crit_edge.us

._crit_edge.us.loopexit1:                         ; preds = %vector.body191
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit1, %._crit_edge.us.loopexit
  %indvars.iv.next106 = add nuw nsw i64 %indvars.iv105, 1
  %exitcond130 = icmp eq i64 %indvars.iv.next106, 1000
  %indvar.next = add nuw nsw i64 %indvar, 1
  br i1 %exitcond130, label %vector.memcheck175.preheader, label %vector.memcheck208

vector.memcheck175.preheader:                     ; preds = %._crit_edge.us
  br label %vector.memcheck175

scalar.ph226:                                     ; preds = %scalar.ph226, %scalar.ph226.preheader
  %indvars.iv = phi i64 [ 0, %scalar.ph226.preheader ], [ %indvars.iv.next.7, %scalar.ph226 ]
  ...
  br i1 %exitcond.7, label %vector.memcheck208.preheader.loopexit, label %scalar.ph226, !llvm.loop !16

vector.memcheck175:                               ; preds = %vector.memcheck175.preheader, %._crit_edge85.us
  %indvars.iv112 = phi i64 [ %indvars.iv.next113, %._crit_edge85.us ], [ 0, %vector.memcheck175.preheader ]
  %scevgep163 = getelementptr [1200 x double], [1200 x double]* %0, i64 %indvars.iv112, i64 1
  %111 = add nuw nsw i64 %indvars.iv112, 1
  %scevgep165 = getelementptr [1200 x double], [1200 x double]* %0, i64 %111, i64 0
  %scevgep167 = getelementptr [1200 x double], [1200 x double]* %2, i64 %indvars.iv112, i64 0
  %scevgep169 = getelementptr [1200 x double], [1200 x double]* %2, i64 %111, i64 0
...
vector.body158:                                   ; preds = %vector.body158.preheader, %vector.body158
  ...
  %offset.idx = or i64 %index177, 1
  %112 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv112, i64 %offset.idx
  %113 = bitcast double* %112 to <2 x double>*
  %wide.load185 = load <2 x double>, <2 x double>* %113, align 8, !alias.scope !17, !noalias !20
  %114 = getelementptr double, double* %112, i64 2
  %115 = bitcast double* %114 to <2 x double>*
  %wide.load186 = load <2 x double>, <2 x double>* %115, align 8, !alias.scope !17, !noalias !20
  %116 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv112, i64 %offset.idx
  %117 = bitcast double* %116 to <2 x double>*
  %wide.load187 = load <2 x double>, <2 x double>* %117, align 8, !alias.scope !20
  %118 = getelementptr double, double* %116, i64 2
  %119 = bitcast double* %118 to <2 x double>*
  %wide.load188 = load <2 x double>, <2 x double>* %119, align 8, !alias.scope !20
  %120 = add nsw i64 %offset.idx, -1
  %121 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv112, i64 %120
  %122 = bitcast double* %121 to <2 x double>*
  %wide.load189 = load <2 x double>, <2 x double>* %122, align 8, !alias.scope !20
  %123 = getelementptr double, double* %121, i64 2
  %124 = bitcast double* %123 to <2 x double>*
  %wide.load190 = load <2 x double>, <2 x double>* %124, align 8, !alias.scope !20
  %125 = fsub <2 x double> %wide.load187, %wide.load189
  %126 = fsub <2 x double> %wide.load188, %wide.load190
  ...
  %129 = fsub <2 x double> %wide.load185, %127
  %130 = fsub <2 x double> %wide.load186, %128
  ...
  %133 = icmp eq i64 %index.next178, 1196
  br i1 %133, label %scalar.ph160.preheader.loopexit, label %vector.body158, !llvm.loop !22

scalar.ph160.preheader.loopexit:                  ; preds = %vector.body158
  br label %scalar.ph160.preheader

scalar.ph160.preheader:                           ; preds = %scalar.ph160.preheader.loopexit, %vector.memcheck175
  %indvars.iv108.ph = phi i64 [ 1, %vector.memcheck175 ], [ 1197, %scalar.ph160.preheader.loopexit ]
  br i1 true, label %scalar.ph160.prol.preheader, label %scalar.ph160.prol.loopexit.unr-lcssa

scalar.ph160.prol.preheader:                      ; preds = %scalar.ph160.preheader
  br label %scalar.ph160.prol

scalar.ph160.prol:                                ; preds = %scalar.ph160.prol.preheader
  ...
  br label %scalar.ph160.prol.loopexit.unr-lcssa

scalar.ph160.prol.loopexit.unr-lcssa:             ; preds = %scalar.ph160.preheader, %scalar.ph160.prol
  %indvars.iv108.unr.ph = phi i64 [ %indvars.iv.next109.prol, %scalar.ph160.prol ], [ %indvars.iv108.ph, %scalar.ph160.preheader ]
  br label %scalar.ph160.prol.loopexit

scalar.ph160.prol.loopexit:                       ; preds = %scalar.ph160.prol.loopexit.unr-lcssa
  br i1 false, label %._crit_edge85.us, label %scalar.ph160.preheader.new
...
scalar.ph160:                                     ; preds = %scalar.ph160, %scalar.ph160.preheader.new
  %indvars.iv108 = phi i64 [ %indvars.iv108.unr.ph, %scalar.ph160.preheader.new ], [ %indvars.iv.next109.1, %scalar.ph160 ]
  ...
  br i1 %exitcond111.1, label %._crit_edge85.us.unr-lcssa, label %scalar.ph160, !llvm.loop !23

._crit_edge85.us.unr-lcssa:                       ; preds = %scalar.ph160
  br label %._crit_edge85.us

._crit_edge85.us:                                 ; preds = %scalar.ph160.prol.loopexit, %._crit_edge85.us.unr-lcssa
  %indvars.iv.next113 = add nuw nsw i64 %indvars.iv112, 1
  %exitcond131 = icmp eq i64 %indvars.iv.next113, 1000
  br i1 %exitcond131, label %vector.memcheck.preheader, label %vector.memcheck175

vector.memcheck.preheader:                        ; preds = %._crit_edge85.us
  br label %vector.memcheck

vector.memcheck:                                  ; preds = %vector.memcheck.preheader, %._crit_edge89.us
  ...
  %scevgep135 = getelementptr [1200 x double], [1200 x double]* %2, i64 %indvars.iv119, i64 1199
  %scevgep137 = getelementptr [1200 x double], [1200 x double]* %0, i64 %indvars.iv119, i64 0
  %163 = add nuw nsw i64 %indvars.iv119, 1
  %scevgep139 = getelementptr [1200 x double], [1200 x double]* %0, i64 %163, i64 0
  %scevgep141 = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv119, i64 0
  %scevgep143 = getelementptr [1200 x double], [1200 x double]* %1, i64 %163, i64 1199
  %indvars.iv.next120 = add nuw nsw i64 %indvars.iv119, 1
  %bound0 = icmp ult double* %scevgep, %scevgep139
  %bound1 = icmp ult double* %scevgep137, %scevgep135
  %found.conflict = and i1 %bound0, %bound1
  %bound0145 = icmp ult double* %scevgep, %scevgep143
  %bound1146 = icmp ult double* %scevgep141, %scevgep135
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load149 = load <2 x double>, <2 x double>* %167, align 8, !alias.scope !24, !noalias !27
  %168 = or i64 %index, 1
  %169 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv119, i64 %168
  %170 = bitcast double* %169 to <2 x double>*
  %wide.load150 = load <2 x double>, <2 x double>* %170, align 8, !alias.scope !30
  %171 = getelementptr double, double* %169, i64 2
  %172 = bitcast double* %171 to <2 x double>*
  %wide.load151 = load <2 x double>, <2 x double>* %172, align 8, !alias.scope !30
  %173 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv119, i64 %index
  %174 = bitcast double* %173 to <2 x double>*
  %wide.load152 = load <2 x double>, <2 x double>* %174, align 8, !alias.scope !30
  %175 = getelementptr double, double* %173, i64 2
  %176 = bitcast double* %175 to <2 x double>*
  %wide.load153 = load <2 x double>, <2 x double>* %176, align 8, !alias.scope !30
  %177 = fsub <2 x double> %wide.load150, %wide.load152
  %178 = fsub <2 x double> %wide.load151, %wide.load153
  ...
  %wide.load154 = load <2 x double>, <2 x double>* %180, align 8, !alias.scope !31
  %181 = getelementptr double, double* %179, i64 2
  %182 = bitcast double* %181 to <2 x double>*
  %wide.load155 = load <2 x double>, <2 x double>* %182, align 8, !alias.scope !31
  %183 = fadd <2 x double> %177, %wide.load154
  %184 = fadd <2 x double> %178, %wide.load155
  %185 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv119, i64 %index
  %186 = bitcast double* %185 to <2 x double>*
  %wide.load156 = load <2 x double>, <2 x double>* %186, align 8, !alias.scope !31
  %187 = getelementptr double, double* %185, i64 2
  %188 = bitcast double* %187 to <2 x double>*
  %wide.load157 = load <2 x double>, <2 x double>* %188, align 8, !alias.scope !31
  %189 = fsub <2 x double> %183, %wide.load156
  %190 = fsub <2 x double> %184, %wide.load157
  ...
  %194 = fsub <2 x double> %wide.load149, %192
...
._crit_edge89.us:                                 ; preds = %._crit_edge99
  %exitcond133 = icmp eq i64 %indvars.iv.next120, 999
  br i1 %exitcond133, label %._crit_edge91, label %vector.memcheck

._crit_edge91:                                    ; preds = %._crit_edge89.us
  %indvars.iv.next122 = add nuw nsw i64 %indvars.iv121, 1
  %exitcond132 = icmp eq i64 %indvars.iv.next122, 500
  br i1 %exitcond132, label %._crit_edge93, label %vector.memcheck236
...
._crit_edge:                                      ; preds = %._crit_edge62, %12
  ...
  %exitcond84 = icmp eq i64 %indvars.iv.next75, 1200
  br i1 %exitcond84, label %._crit_edge56.us, label %._crit_edge62

._crit_edge56.us:                                 ; preds = %._crit_edge
  %indvars.iv.next77 = add nuw nsw i64 %indvars.iv76, 1
  %exitcond85 = icmp eq i64 %indvars.iv.next77, 1000
  br i1 %exitcond85, label %.preheader44.us.preheader, label %.preheader45.us
...
._crit_edge63:                                    ; preds = %._crit_edge64, %29
  ...
  %exitcond82 = icmp eq i64 %indvars.iv.next70, 1200
  br i1 %exitcond82, label %._crit_edge51.us, label %._crit_edge64

._crit_edge51.us:                                 ; preds = %._crit_edge63
  %indvars.iv.next72 = add nuw nsw i64 %indvars.iv71, 1
  %exitcond83 = icmp eq i64 %indvars.iv.next72, 1000
  br i1 %exitcond83, label %.preheader.us.preheader, label %.preheader44.us
...
._crit_edge.us:                                   ; preds = %._crit_edge65
  ...
  %exitcond81 = icmp eq i64 %indvars.iv.next68, 1000
  br i1 %exitcond81, label %._crit_edge48, label %.preheader.us
