...
; <label>:17:                                     ; preds = %._crit_edge1, %8
  %18 = phi i64 [ 0, %8 ], [ %88, %._crit_edge1 ]
  %19 = mul i64 %18, 280
  %scevgep = getelementptr i8, i8* %2, i64 %19
  br i1 %10, label %20, label %._crit_edge1

; <label>:20:                                     ; preds = %17
  %21 = trunc i64 %18 to i32
  br i1 %16, label %._crit_edge1.loopexit, label %.split.preheader

.split.preheader:                                 ; preds = %20
  br label %.split

.split:                                           ; preds = %.split.preheader, %._crit_edge2
  %22 = phi i64 [ %86, %._crit_edge2 ], [ 0, %.split.preheader ]
  %23 = sub nsw i64 %22, %11
  %24 = icmp slt i64 %23, %12
  %25 = trunc i64 %23 to i32
  %26 = select i1 %24, i32 %25, i32 %3
  %27 = icmp slt i32 %26, 0
  br i1 %27, label %._crit_edge2, label %28
...
; <label>:35:                                     ; preds = %52
  ...
  br i1 %exitcond, label %._crit_edge2.loopexit, label %30
...
._crit_edge2.loopexit:                            ; preds = %35
  br label %._crit_edge2

._crit_edge2:                                     ; preds = %._crit_edge2.loopexit, %.split
  %82 = phi i32 [ 0, %.split ], [ %40, %._crit_edge2.loopexit ]
  ...
  br i1 %87, label %._crit_edge1.loopexit26, label %.split

._crit_edge1.loopexit:                            ; preds = %20
  call void @llvm.memset.p0i8.i64(i8* %scevgep, i8 0, i64 %13, i32 1, i1 false)
  br label %._crit_edge1

._crit_edge1.loopexit26:                          ; preds = %._crit_edge2
  br label %._crit_edge1

._crit_edge1:                                     ; preds = %._crit_edge1.loopexit26, %._crit_edge1.loopexit, %17
  %88 = add nuw nsw i64 %18, 1
  %89 = icmp eq i64 %88, %15
  br i1 %89, label %._crit_edge.loopexit, label %17
...
; <label>:108:                                    ; preds = %23
  ...
  br i1 %exitcond, label %._crit_edge.loopexit, label %18

._crit_edge.loopexit:                             ; preds = %108
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %9
  %117 = phi i32 [ 0, %9 ], [ %114, %._crit_edge.loopexit ]
...
; <label>:22:                                     ; preds = %._crit_edge1, %9
  %23 = phi i64 [ 0, %9 ], [ %109, %._crit_edge1 ]
  %24 = trunc i64 %23 to i32
  %25 = mul i64 %23, 1202590842880
  %26 = ashr exact i64 %25, 32
  %27 = getelementptr i8, i8* %1, i64 %26
  br i1 %11, label %28, label %._crit_edge1

; <label>:28:                                     ; preds = %22
  %29 = mul nuw nsw i64 %23, 280
  br i1 %12, label %._crit_edge2.preheader, label %32

._crit_edge2.preheader:                           ; preds = %28
  %sext = shl i64 %23, 32
  %30 = ashr exact i64 %sext, 32
  %31 = mul nsw i64 %30, 280
  br label %._crit_edge2

; <label>:32:                                     ; preds = %28
  tail call void @llvm.memset.p0i8.i64(i8* %27, i8 0, i64 %15, i32 1, i1 false)
  br label %._crit_edge1

._crit_edge2:                                     ; preds = %._crit_edge2.preheader, %.us-lcssa.us
  %33 = phi i64 [ %73, %.us-lcssa.us ], [ 0, %._crit_edge2.preheader ]
  %34 = trunc i64 %33 to i32
  br i1 %20, label %.split.us.preheader, label %.split

.split.us.preheader:                              ; preds = %._crit_edge2
  br label %.split.us

.split.us:                                        ; preds = %.split.us.preheader, %._crit_edge9.us
  %35 = phi i32 [ %61, %._crit_edge9.us ], [ 0, %.split.us.preheader ]
  %36 = phi float [ %60, %._crit_edge9.us ], [ 0.000000e+00, %.split.us.preheader ]
  %37 = add nuw nsw i32 %35, %24
  %38 = mul nsw i32 %37, 280
  %39 = add i32 %38, %34
  br i1 %21, label %._crit_edge9.us, label %._crit_edge7.us.preheader

._crit_edge7.us.preheader:                        ; preds = %.split.us
  br label %._crit_edge7.us

._crit_edge7.us:                                  ; preds = %._crit_edge7.us.preheader, %._crit_edge7.us
  %40 = phi i64 [ %58, %._crit_edge7.us ], [ 0, %._crit_edge7.us.preheader ]
  %41 = phi float [ %57, %._crit_edge7.us ], [ %36, %._crit_edge7.us.preheader ]
  ...
  br i1 %59, label %._crit_edge9.us.loopexit, label %._crit_edge7.us

._crit_edge9.us.loopexit:                         ; preds = %._crit_edge7.us
  br label %._crit_edge9.us

._crit_edge9.us:                                  ; preds = %._crit_edge9.us.loopexit, %.split.us
  %60 = phi float [ undef, %.split.us ], [ %57, %._crit_edge9.us.loopexit ]
  %61 = add nuw nsw i32 %35, 1
  %62 = icmp eq i32 %61, %2
  br i1 %62, label %.us-lcssa.us.loopexit, label %.split.us

.split:                                           ; preds = %._crit_edge2
  br i1 %21, label %.us-lcssa.us.loopexit19, label %.split.split.preheader
...
.us-lcssa.us.loopexit19:                          ; preds = %.split
  %63 = add i64 %31, %33
  %sext29 = shl i64 %63, 32
  %64 = ashr exact i64 %sext29, 32
...
.us-lcssa.us.loopexit:                            ; preds = %._crit_edge9.us
  br label %.us-lcssa.us

.us-lcssa.us.loopexit39:                          ; preds = %._crit_edge9
  br label %.us-lcssa.us

.us-lcssa.us:                                     ; preds = %.us-lcssa.us.loopexit39, %.us-lcssa.us.loopexit, %.us-lcssa.us.loopexit19
  %.lcssa13 = phi float [ %69, %.us-lcssa.us.loopexit19 ], [ %60, %.us-lcssa.us.loopexit ], [ %105, %.us-lcssa.us.loopexit39 ]
  %70 = fptoui float %.lcssa13 to i8
  %71 = add nuw nsw i64 %33, %29
  %72 = getelementptr inbounds i8, i8* %1, i64 %71
  store i8 %70, i8* %72, align 1, !tbaa !1
  %73 = add nuw nsw i64 %33, 1
  %74 = icmp eq i64 %73, %17
  br i1 %74, label %._crit_edge1.loopexit, label %._crit_edge2

.split.split:                                     ; preds = %.split.split.preheader, %._crit_edge9
  %indvars.iv = phi i64 [ %indvars.iv.next, %._crit_edge9 ], [ 0, %.split.split.preheader ]
  %75 = phi float [ %105, %._crit_edge9 ], [ 0.000000e+00, %.split.split.preheader ]
  %76 = add nuw nsw i64 %indvars.iv, %30
  %77 = mul nsw i64 %76, 280
...
; <label>:86:                                     ; preds = %86, %.split.split
  %87 = phi i64 [ %106, %86 ], [ 1, %.split.split ]
  %88 = phi float [ %105, %86 ], [ %85, %.split.split ]
  ...
  br i1 %107, label %._crit_edge9, label %86

._crit_edge9:                                     ; preds = %86
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %108 = icmp eq i64 %indvars.iv.next, %16
  br i1 %108, label %.us-lcssa.us.loopexit39, label %.split.split
...
._crit_edge1:                                     ; preds = %._crit_edge1.loopexit, %22, %32
  %109 = add nuw nsw i64 %23, 1
  %110 = icmp eq i64 %109, %18
  br i1 %110, label %._crit_edge.loopexit, label %22
}
...
; <label>:3:                                      ; preds = %147, %2
  ...
  %16 = icmp ult i8* %9, %8
  %17 = and i1 %15, %16
  br i1 %17, label %.preheader.preheader, label %._crit_edge1.preheader

._crit_edge1.preheader:                           ; preds = %3
  br label %._crit_edge1

.preheader.preheader.loopexit:                    ; preds = %._crit_edge1
...
._crit_edge1:                                     ; preds = %._crit_edge1.preheader, %._crit_edge1
  %18 = phi i64 [ %85, %._crit_edge1 ], [ 0, %._crit_edge1.preheader ]
  ...
  br i1 %86, label %.preheader.preheader.loopexit, label %._crit_edge1, !llvm.loop !9
...
._crit_edge3.loopexit:                            ; preds = %118
  br label %._crit_edge3

._crit_edge3:                                     ; preds = %._crit_edge3.loopexit, %2
  br label %3

; <label>:3:                                      ; preds = %118, %._crit_edge3
  %4 = phi i64 [ 0, %._crit_edge3 ], [ %119, %118 ]
  %5 = mul nuw nsw i64 %4, 280
  %6 = getelementptr i8, i8* %1, i64 %5
  %7 = add nuw nsw i64 %5, 277
  %8 = getelementptr i8, i8* %1, i64 %7
  ...
  %14 = icmp ult i8* %10, %8
  %15 = and i1 %13, %14
  br i1 %15, label %._crit_edge1, label %25

._crit_edge1:                                     ; preds = %3, %25
...
; <label>:118:                                    ; preds = %121
  ...
  br i1 %120, label %._crit_edge3.loopexit, label %3

; <label>:121:                                    ; preds = %121, %._crit_edge1
  %122 = phi i64 [ %142, %121 ], [ %21, %._crit_edge1 ]
  %123 = add i64 %122, %5
...
; <label>:29:                                     ; preds = %._crit_edge, %24
  %30 = phi i64 [ 0, %24 ], [ %145, %._crit_edge ]
  %31 = add nsw i64 %30, -4
...
; <label>:46:                                     ; preds = %56
  ...
  br i1 %55, label %41, label %._crit_edge.loopexit
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %29
  %141 = phi i32 [ 0, %29 ], [ %52, %._crit_edge.loopexit ]
