...
for.body.us:                                      ; preds = %for.cond1.for.inc16_crit_edge.us, %for.body.us.preheader
  %indvars.iv36 = phi i64 [ 0, %for.body.us.preheader ], [ %indvars.iv.next37, %for.cond1.for.inc16_crit_edge.us ]
  %0 = add i64 %indvars.iv36, 1200
  %1 = trunc i64 %0 to i32
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us, %for.body.us
  %indvars.iv32 = phi i64 [ 0, %for.body.us ], [ %indvars.iv.next33, %for.body3.us ]
...
for.cond1.for.inc16_crit_edge.us:                 ; preds = %for.body3.us
  ...
  br i1 %cmp.us, label %for.body.us, label %for.body26.lr.ph.preheader

for.body26.lr.ph.preheader:                       ; preds = %for.cond1.for.inc16_crit_edge.us
  br label %for.body26.lr.ph

for.body26.lr.ph:                                 ; preds = %for.body26.lr.ph.preheader, %for.inc51.for.body22_crit_edge
  %indvars.iv44 = phi i3 [ %indvars.iv.next45, %for.inc51.for.body22_crit_edge ], [ -1, %for.body26.lr.ph.preheader ]
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc51.for.body22_crit_edge ], [ 2, %for.body26.lr.ph.preheader ]
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc51.for.body22_crit_edge ], [ 0, %for.body26.lr.ph.preheader ]
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc51.for.body22_crit_edge ], [ 1, %for.body26.lr.ph.preheader ]
  %indvar = phi i32 [ %11, %for.inc51.for.body22_crit_edge ], [ 0, %for.body26.lr.ph.preheader ]
  %indvars.iv20 = phi i32 [ %indvars.iv.next21, %for.inc51.for.body22_crit_edge ], [ 1, %for.body26.lr.ph.preheader ]
...
for.body26:                                       ; preds = %for.body26, %for.body26.preheader
  %indvars.iv = phi i64 [ %indvars.iv.unr.ph, %for.body26.preheader ], [ %indvars.iv.next.1, %for.body26 ]
  %14 = add nsw i64 %indvars.iv, %indvars.iv30
  ...
  %16 = add nsw i64 %indvars.iv.next, %indvars.iv30
...
for.end38:                                        ; preds = %for.end38.loopexit, %for.body26.prol.loopexit.unr-lcssa
  ...
  br i1 %cmp414, label %for.body43.lr.ph, label %for.end53

for.body43.lr.ph:                                 ; preds = %for.end38
  %xtraiter26 = and i32 %9, 7
  %lcmp.mod27 = icmp eq i32 %xtraiter26, 0
  br i1 %lcmp.mod27, label %for.body43.prol.loopexit, label %for.body43.prol.preheader

for.body43.prol.preheader:                        ; preds = %for.body43.lr.ph
  br label %for.body43.prol

for.body43.prol:                                  ; preds = %for.body43.prol.preheader, %for.body43.prol.for.body43.prol_crit_edge
  %indvars.iv24.prol = phi i64 [ %indvars.iv.next25.prol, %for.body43.prol.for.body43.prol_crit_edge ], [ %indvars.iv22, %for.body43.prol.preheader ]
  %prol.iter = phi i32 [ %prol.iter.sub, %for.body43.prol.for.body43.prol_crit_edge ], [ %xtraiter26, %for.body43.prol.preheader ]
...
for.body43.prol.loopexit:                         ; preds = %for.body43.prol.loopexit.loopexit, %for.body43.lr.ph
  %indvars.iv24.unr = phi i64 [ %indvars.iv22, %for.body43.lr.ph ], [ %8, %for.body43.prol.loopexit.loopexit ]
  %19 = icmp ult i32 %10, 7
  br i1 %19, label %for.inc51.for.body22_crit_edge, label %for.body43.preheader

for.body43.preheader:                             ; preds = %for.body43.prol.loopexit
  br label %for.body43

for.body43:                                       ; preds = %for.body43.preheader, %for.body43
  %indvars.iv24 = phi i64 [ %indvars.iv.next25.7, %for.body43 ], [ %indvars.iv24.unr, %for.body43.preheader ]
  ...
  br i1 %exitcond.7, label %for.inc51.for.body22_crit_edge.loopexit, label %for.body43

for.inc51.for.body22_crit_edge.loopexit:          ; preds = %for.body43
  br label %for.inc51.for.body22_crit_edge

for.inc51.for.body22_crit_edge:                   ; preds = %for.inc51.for.body22_crit_edge.loopexit, %for.body43.prol.loopexit
...
for.body3.lr.ph:                                  ; preds = %for.inc53.for.body3.lr.ph_crit_edge, %for.body.lr.ph
  %indvars.iv32 = phi i64 [ 0, %for.body.lr.ph ], [ %0, %for.inc53.for.body3.lr.ph_crit_edge ]
  %indvars.iv28 = phi i32 [ 0, %for.body.lr.ph ], [ %indvars.iv.next29, %for.inc53.for.body3.lr.ph_crit_edge ]
...
vector.memcheck:                                  ; preds = %for.body3.lr.ph
  ...
  %scevgep39 = getelementptr [1200 x double], [1200 x double]* %B, i64 %indvars.iv32, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %20 = fadd <2 x double> %18, %broadcast.splat56
  %21 = fadd <2 x double> %19, %broadcast.splat56
  store <2 x double> %20, <2 x double>* %2, align 8, !alias.scope !3, !noalias !6
  store <2 x double> %21, <2 x double>* %4, align 8, !alias.scope !3, !noalias !6
  %index.next = add i64 %index, 4
  %22 = icmp eq i64 %index.next, 1200
  br i1 %22, label %for.inc53.loopexit6, label %vector.body, !llvm.loop !11
...
for.body3.us:                                     ; preds = %for.cond4.for.end_crit_edge.us, %for.body3.us.preheader
  %indvars.iv26 = phi i64 [ 0, %for.body3.us.preheader ], [ %indvars.iv.next27, %for.cond4.for.end_crit_edge.us ]
...
for.body3:                                        ; preds = %for.body3, %for.body3.preheader
  ...
  br i1 %exitcond.1, label %for.inc53.loopexit5, label %for.body3, !llvm.loop !14

for.inc53.loopexit:                               ; preds = %for.cond4.for.end_crit_edge.us
  br label %for.inc53

for.inc53.loopexit5:                              ; preds = %for.body3
  br label %for.inc53

for.inc53.loopexit6:                              ; preds = %vector.body
  br label %for.inc53

for.inc53:                                        ; preds = %for.inc53.loopexit6, %for.inc53.loopexit5, %for.inc53.loopexit
  %cmp = icmp slt i64 %0, 1000
  br i1 %cmp, label %for.inc53.for.body3.lr.ph_crit_edge, label %for.end55

for.inc53.for.body3.lr.ph_crit_edge:              ; preds = %for.inc53
