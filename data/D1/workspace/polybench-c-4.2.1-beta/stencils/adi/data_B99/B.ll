...
; <label>:4:                                      ; preds = %4, %.preheader.us
  ...
  %8 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv6, i64 %indvars.iv
...
.preheader4:                                      ; preds = %._crit_edge24, %.preheader4.lr.ph
  %.0325 = phi i32 [ 1, %.preheader4.lr.ph ], [ %151, %._crit_edge24 ]
  br label %.lver.check

.lver.check:                                      ; preds = %._crit_edge9.us, %.preheader4
  %indvar = phi i64 [ %6, %._crit_edge9.us ], [ 0, %.preheader4 ]
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %._crit_edge9.us ], [ 1, %.preheader4 ]
  %6 = add i64 %indvar, 1
  %scevgep49 = getelementptr [1000 x double], [1000 x double]* %4, i64 %6, i64 0
  %scevgep50 = getelementptr [1000 x double], [1000 x double]* %5, i64 %6, i64 0
  %scevgep43 = getelementptr [1000 x double], [1000 x double]* %4, i64 %6, i64 999
  %scevgep47 = getelementptr [1000 x double], [1000 x double]* %5, i64 %6, i64 999
  %7 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 0, i64 %indvars.iv30
  store double 1.000000e+00, double* %7, align 8
  %8 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv30, i64 0
  store double 0.000000e+00, double* %8, align 8
  %9 = bitcast double* %7 to i64*
  %10 = load i64, i64* %9, align 8
  %11 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv30
  %12 = bitcast [1000 x double]* %11 to i64*
  store i64 %10, i64* %12, align 8
  %13 = add nsw i64 %indvars.iv30, -1
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  %bound0 = icmp ult double* %scevgep49, %scevgep47
  %bound1 = icmp ult double* %scevgep50, %scevgep43
...
.ph.lver.orig:                                    ; preds = %.ph.lver.orig.preheader, %.ph.lver.orig
  ...
  %15 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv30, i64 %14
  %16 = load double, double* %15, align 8
  %17 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv30, i64 %indvars.iv.lver.orig
  %18 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv.lver.orig, i64 %13
  %19 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv.lver.orig, i64 %indvars.iv.next31
  %20 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv30, i64 %14
  ...
  %36 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv30, i64 %indvars.iv.lver.orig
...
.ph:                                              ; preds = %.lver.check
  %load_initial = load double, double* %scevgep49, align 8
  %load_initial51 = load double, double* %scevgep50, align 8
  br label %53

._crit_edge9.us:                                  ; preds = %.lr.ph8.us
  %exitcond40 = icmp eq i64 %indvars.iv.next31, 999
  br i1 %exitcond40, label %.lver.check67.preheader, label %.lver.check

.lver.check67.preheader:                          ; preds = %._crit_edge9.us
  br label %.lver.check67
...
.lr.ph8.us:                                       ; preds = %.lr.ph8.us, %._crit_edge.us
  ...
  %38 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv30, i64 %indvars.iv28
  %39 = load double, double* %38, align 8
  %40 = fmul double %39, %37
  %41 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv30, i64 %indvars.iv28
  %42 = load double, double* %41, align 8
  %43 = fadd double %40, %42
  %44 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv28, i64 %indvars.iv30
  store double %43, double* %44, align 8
  %indvars.iv.next29 = add nsw i64 %indvars.iv28, -1
  %45 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv30, i64 %indvars.iv.next29
  %46 = load double, double* %45, align 8
  %47 = fmul double %46, %43
  %48 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv30, i64 %indvars.iv.next29
  %49 = load double, double* %48, align 8
  %50 = fadd double %47, %49
  %51 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv.next29, i64 %indvars.iv30
  store double %50, double* %51, align 8
  %52 = icmp sgt i64 %indvars.iv.next29, 1
  %indvars.iv.next29.1 = add nsw i64 %indvars.iv28, -2
  br i1 %52, label %.lr.ph8.us, label %._crit_edge9.us

; <label>:53:                                     ; preds = %53, %.ph
  %store_forwarded52 = phi double [ %load_initial51, %.ph ], [ %70, %53 ]
  ...
  %68 = fmul double %store_forwarded52, 0xC09F400000000001
  ...
  br i1 %exitcond, label %._crit_edge.us.loopexit76, label %53

._crit_edge.us.loopexit:                          ; preds = %.ph.lver.orig
  br label %._crit_edge.us

._crit_edge.us.loopexit76:                        ; preds = %53
  br label %._crit_edge.us
...
.lver.check67:                                    ; preds = %.lver.check67.preheader, %._crit_edge20.us
  %indvar53 = phi i64 [ %73, %._crit_edge20.us ], [ 0, %.lver.check67.preheader ]
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %._crit_edge20.us ], [ 1, %.lver.check67.preheader ]
  %73 = add i64 %indvar53, 1
  %scevgep69 = getelementptr [1000 x double], [1000 x double]* %4, i64 %73, i64 0
  %scevgep72 = getelementptr [1000 x double], [1000 x double]* %5, i64 %73, i64 0
  %scevgep57 = getelementptr [1000 x double], [1000 x double]* %4, i64 %73, i64 999
  %scevgep61 = getelementptr [1000 x double], [1000 x double]* %5, i64 %73, i64 999
  ...
  %75 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv38, i64 0
  store double 0.000000e+00, double* %75, align 8
  %76 = bitcast double* %74 to i64*
  %77 = load i64, i64* %76, align 8
  %78 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv38
  %79 = bitcast [1000 x double]* %78 to i64*
  store i64 %77, i64* %79, align 8
  %80 = add nsw i64 %indvars.iv38, -1
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  %bound063 = icmp ult double* %scevgep69, %scevgep61
  %bound164 = icmp ult double* %scevgep72, %scevgep57
  %found.conflict65 = and i1 %bound063, %bound164
  br i1 %found.conflict65, label %.ph68.lver.orig.preheader, label %.ph68

.ph68.lver.orig.preheader:                        ; preds = %.lver.check67
  br label %.ph68.lver.orig

.ph68.lver.orig:                                  ; preds = %.ph68.lver.orig.preheader, %.ph68.lver.orig
  %indvars.iv32.lver.orig = phi i64 [ %indvars.iv.next33.lver.orig, %.ph68.lver.orig ], [ 1, %.ph68.lver.orig.preheader ]
  %81 = add nsw i64 %indvars.iv32.lver.orig, -1
  %82 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv38, i64 %81
  %83 = load double, double* %82, align 8
  %84 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv38, i64 %indvars.iv32.lver.orig
  %85 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %80, i64 %indvars.iv32.lver.orig
  %86 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv38, i64 %indvars.iv32.lver.orig
  %87 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv.next39, i64 %indvars.iv32.lver.orig
  %88 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv38, i64 %81
  ...
  %108 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv38, i64 %indvars.iv32.lver.orig
  ...
  br i1 %exitcond35.lver.orig, label %._crit_edge16.us.loopexit, label %.ph68.lver.orig
...
._crit_edge20.us:                                 ; preds = %.lr.ph19.us
  ...
  br i1 %exitcond41, label %._crit_edge24, label %.lver.check67

.lr.ph19.us:                                      ; preds = %.lr.ph19.us, %._crit_edge16.us
  %indvars.iv36 = phi i64 [ 998, %._crit_edge16.us ], [ %indvars.iv.next37.1, %.lr.ph19.us ]
  %109 = phi double [ 1.000000e+00, %._crit_edge16.us ], [ %122, %.lr.ph19.us ]
  %110 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv38, i64 %indvars.iv36
  %111 = load double, double* %110, align 8
  %112 = fmul double %111, %109
  %113 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv38, i64 %indvars.iv36
  %114 = load double, double* %113, align 8
  %115 = fadd double %112, %114
  %116 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv38, i64 %indvars.iv36
  store double %115, double* %116, align 8
  %indvars.iv.next37 = add nsw i64 %indvars.iv36, -1
  %117 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv38, i64 %indvars.iv.next37
  %118 = load double, double* %117, align 8
  %119 = fmul double %118, %115
  %120 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv38, i64 %indvars.iv.next37
  %121 = load double, double* %120, align 8
  %122 = fadd double %119, %121
  %123 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv38, i64 %indvars.iv.next37
  store double %122, double* %123, align 8
  %124 = icmp sgt i64 %indvars.iv.next37, 1
  %indvars.iv.next37.1 = add nsw i64 %indvars.iv36, -2
  br i1 %124, label %.lr.ph19.us, label %._crit_edge20.us

; <label>:125:                                    ; preds = %125, %.ph68
  %store_forwarded74 = phi double [ %load_initial73, %.ph68 ], [ %147, %125 ]
  %store_forwarded71 = phi double [ %load_initial70, %.ph68 ], [ %136, %125 ]
  %indvars.iv32 = phi i64 [ 1, %.ph68 ], [ %indvars.iv.next33, %125 ]
  %126 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv38, i64 %indvars.iv32
  %127 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %80, i64 %indvars.iv32
  %128 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv38, i64 %indvars.iv32
  %129 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv.next39, i64 %indvars.iv32
  %130 = insertelement <2 x double> undef, double %store_forwarded71, i32 0
  ...
  %145 = fmul double %store_forwarded74, 0xC08F400000000001
  %146 = fsub double %144, %145
  %147 = fdiv double %146, %135
  %148 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv38, i64 %indvars.iv32
  store double %147, double* %148, align 8
  %exitcond35 = icmp eq i64 %indvars.iv32, 998
  %indvars.iv.next33 = add nuw nsw i64 %indvars.iv32, 1
  br i1 %exitcond35, label %._crit_edge16.us.loopexit75, label %125

._crit_edge16.us.loopexit:                        ; preds = %.ph68.lver.orig
  br label %._crit_edge16.us

._crit_edge16.us.loopexit75:                      ; preds = %125
  br label %._crit_edge16.us

._crit_edge16.us:                                 ; preds = %._crit_edge16.us.loopexit75, %._crit_edge16.us.loopexit
  %149 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv38, i64 999
  store double 1.000000e+00, double* %149, align 8
  br label %.lr.ph19.us

._crit_edge24:                                    ; preds = %._crit_edge20.us
  %150 = icmp slt i32 %.0325, 500
  %151 = add nuw nsw i32 %.0325, 1
  br i1 %150, label %.preheader4, label %._crit_edge26
