...
for.body3.lr.ph.us:                               ; preds = %for.end.us, %for.body3.lr.ph.us.preheader
  %indvars.iv13 = phi i64 [ 0, %for.body3.lr.ph.us.preheader ], [ %indvars.iv.next14, %for.end.us ]
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us, %for.body3.lr.ph.us
  %indvars.iv7 = phi i64 [ 0, %for.body3.lr.ph.us ], [ %indvars.iv.next8, %for.body3.us ]
...
for.end.us:                                       ; preds = %for.body3.us
  ...
  br i1 %exitcond15, label %for.end32, label %for.body3.lr.ph.us
...
for.body3:                                        ; preds = %for.body3, %for.body3.lr.ph
  %indvars.iv = phi i64 [ 0, %for.body3.lr.ph ], [ %indvars.iv.next.4, %for.body3 ]
  %nrm.07 = phi double [ 0.000000e+00, %for.body3.lr.ph ], [ %add.4, %for.body3 ]
  ...
  br i1 %exitcond.4, label %for.body16.preheader, label %for.body3
...
for.body42.lr.ph.us:                              ; preds = %for.body42.lr.ph.us.preheader, %for.cond33.loopexit.us
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.cond33.loopexit.us ], [ %indvars.iv11, %for.body42.lr.ph.us.preheader ]
...
for.body42.us:                                    ; preds = %for.body42.us, %for.body42.lr.ph.us
  %indvars.iv5 = phi i64 [ 0, %for.body42.lr.ph.us ], [ %indvars.iv.next6.1, %for.body42.us ]
  ...
  br i1 %exitcond7.1, label %for.body62.us.preheader, label %for.body42.us
...
for.cond33.loopexit.us:                           ; preds = %for.body62.us
  ...
  br i1 %exitcond15, label %for.end85.loopexit, label %for.body42.lr.ph.us
...
for.body4.lr.ph.us:                               ; preds = %for.end.us, %for.body4.lr.ph.us.preheader
  %indvars.iv11 = phi i64 [ 0, %for.body4.lr.ph.us.preheader ], [ %indvars.iv.next12, %for.end.us ]
  %3 = mul nuw nsw i64 %indvars.iv11, 1200
  br label %for.body4.us

for.body4.us:                                     ; preds = %if.end.us, %for.body4.lr.ph.us
  %indvars.iv7 = phi i64 [ 0, %for.body4.lr.ph.us ], [ %indvars.iv.next8, %if.end.us ]
...
if.end.us:                                        ; preds = %for.body4.us, %if.then.us
  ...
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %exitcond10 = icmp eq i64 %indvars.iv.next8, 1200
  br i1 %exitcond10, label %for.end.us, label %for.body4.us

for.end.us:                                       ; preds = %if.end.us
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond14 = icmp eq i64 %indvars.iv.next12, 1200
  br i1 %exitcond14, label %for.body20.lr.ph.us.preheader, label %for.body4.lr.ph.us
...
for.body20.lr.ph.us:                              ; preds = %for.end35.us, %for.body20.lr.ph.us.preheader
  %indvars.iv3 = phi i64 [ 0, %for.body20.lr.ph.us.preheader ], [ %indvars.iv.next4, %for.end35.us ]
...
for.end35.us:                                     ; preds = %if.end27.us
  ...
  br i1 %exitcond6, label %for.end38, label %for.body20.lr.ph.us
