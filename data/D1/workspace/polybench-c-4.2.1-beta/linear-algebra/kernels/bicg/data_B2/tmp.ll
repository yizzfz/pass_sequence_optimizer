...
.lr.ph5.split.us.new:                             ; preds = %.lr.ph5.split.us, %.lr.ph5.split.us.new
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.lr.ph5.split.us.new ], [ 0, %.lr.ph5.split.us ]
  ...
  %12 = getelementptr inbounds [1900 x double], [1900 x double]* %0, i64 %indvars.iv11, i64 %indvars.iv
  store double %11, double* %12, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %13 = mul nuw nsw i64 %indvars.iv.next.1, %indvars.iv11
  %14 = trunc i64 %13 to i32
  %15 = srem i32 %14, 2100
  %16 = sitofp i32 %15 to double
  %17 = fdiv double %16, 2.100000e+03
  %18 = getelementptr inbounds [1900 x double], [1900 x double]* %0, i64 %indvars.iv11, i64 %indvars.iv.next
  store double %17, double* %18, align 8
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 1900
  br i1 %exitcond.1, label %._crit_edge.us, label %.lr.ph5.split.us.new
...
.lr.ph9.new:                                      ; preds = %.lr.ph9, %.lr.ph9.new
  %indvars.iv20 = phi i64 [ %indvars.iv.next21.1, %.lr.ph9.new ], [ 0, %.lr.ph9 ]
  %19 = trunc i64 %indvars.iv20 to i32
  %20 = sitofp i32 %19 to double
  %21 = fdiv double %20, 1.900000e+03
  %22 = getelementptr inbounds double, double* %2, i64 %indvars.iv20
  store double %21, double* %22, align 8
  %indvars.iv.next21 = or i64 %indvars.iv20, 1
  %23 = trunc i64 %indvars.iv.next21 to i32
  %24 = sitofp i32 %23 to double
  %25 = fdiv double %24, 1.900000e+03
  %26 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next21
  store double %25, double* %26, align 8
  %indvars.iv.next21.1 = add nsw i64 %indvars.iv20, 2
  %exitcond23.1 = icmp eq i64 %indvars.iv.next21.1, 1900
  br i1 %exitcond23.1, label %.lr.ph5.split.us.preheader, label %.lr.ph9.new
...
._crit_edge.us:                                   ; preds = %7
  ...
  %exitcond13 = icmp eq i64 %indvars.iv.next11, 2100
...
.lr.ph7:                                          ; preds = %.lr.ph7.preheader, %11
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %11 ], [ 0, %.lr.ph7.preheader ]
...
; <label>:11:                                     ; preds = %9, %.lr.ph7
  ...
  %exitcond12 = icmp eq i64 %indvars.iv.next10, 1900
