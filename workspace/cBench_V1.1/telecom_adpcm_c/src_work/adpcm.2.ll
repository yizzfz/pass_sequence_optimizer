...
@__llvm_prf_nm = private constant [28 x i8] c"\19\1Ax\DAKL)H\CE\8DO\CEOI-bL\04\B3SR\C1<\00|\FD\09\AD", section "__llvm_prf_names"
@llvm.used = appending global [3 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_adpcm_coder to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_adpcm_decoder to i8*), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
