...
for.body16:                                       ; preds = %for.body16, %for.end
  %indvars.iv54 = phi i64 [ 0, %for.end ], [ %indvars.iv.next55.1, %for.body16 ]
  ...
  br i1 %exitcond57.1, label %for.body16.for.cond33.preheader_crit_edge, label %for.body16
...
for.end85:                                        ; preds = %for.end85.loopexit, %for.body16.for.cond33.preheader_crit_edge
  %exitcond94 = icmp eq i64 %indvars.iv.next82, 1200
