...
; <label>:4:                                      ; preds = %._crit_edge10, %.preheader.us
...
._crit_edge10:                                    ; preds = %4
  br label %4

._crit_edge.us:                                   ; preds = %4
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %exitcond9 = icmp eq i64 %indvars.iv.next8, 1000
  br i1 %exitcond9, label %._crit_edge, label %._crit_edge.us..preheader.us_crit_edge
...
.preheader7:                                      ; preds = %._crit_edge46..preheader7_crit_edge, %.preheader7.lr.ph
  %16 = phi i32 [ 1, %.preheader7.lr.ph ], [ %166, %._crit_edge46..preheader7_crit_edge ]
  %17 = phi [1000 x double]* [ %4, %.preheader7.lr.ph ], [ %83, %._crit_edge46..preheader7_crit_edge ]
...
.lr.ph29.split.us:                                ; preds = %._crit_edge27.us..lr.ph29.split.us_crit_edge, %.preheader7
  ...
  %18 = phi [1000 x double]* [ %83, %._crit_edge27.us..lr.ph29.split.us_crit_edge ], [ %17, %.preheader7 ]
...
.lr.ph26.us:                                      ; preds = %.lr.ph26.us..lr.ph26.us_crit_edge, %._crit_edge.us
  %indvars.iv74 = phi i64 [ 998, %._crit_edge.us ], [ %indvars.iv.next75.1, %.lr.ph26.us..lr.ph26.us_crit_edge ]
  %30 = phi double [ 1.000000e+00, %._crit_edge.us ], [ %43, %.lr.ph26.us..lr.ph26.us_crit_edge ]
  ...
  br i1 %45, label %.lr.ph26.us..lr.ph26.us_crit_edge, label %._crit_edge27.us

.lr.ph26.us..lr.ph26.us_crit_edge:                ; preds = %.lr.ph26.us
  br label %.lr.ph26.us

; <label>:46:                                     ; preds = %._crit_edge128, %.lr.ph29.split.us
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %._crit_edge128 ], [ 1, %.lr.ph29.split.us ]
  %47 = phi double [ %87, %._crit_edge128 ], [ %.pre62, %.lr.ph29.split.us ]
  %48 = phi double [ %77, %._crit_edge128 ], [ %.pre, %.lr.ph29.split.us ]
  %49 = phi [1000 x double]* [ %83, %._crit_edge128 ], [ %18, %.lr.ph29.split.us ]
  ...
  br i1 %exitcond, label %._crit_edge.us, label %._crit_edge128
...
.lr.ph42.us:                                      ; preds = %.lr.ph42.us..lr.ph42.us_crit_edge, %._crit_edge39.us
  %indvars.iv82 = phi i64 [ 998, %._crit_edge39.us ], [ %indvars.iv.next83.1, %.lr.ph42.us..lr.ph42.us_crit_edge ]
  %128 = phi double [ 1.000000e+00, %._crit_edge39.us ], [ %141, %.lr.ph42.us..lr.ph42.us_crit_edge ]
  ...
  br i1 %143, label %.lr.ph42.us..lr.ph42.us_crit_edge, label %._crit_edge43.us

.lr.ph42.us..lr.ph42.us_crit_edge:                ; preds = %.lr.ph42.us
  br label %.lr.ph42.us

; <label>:144:                                    ; preds = %._crit_edge129, %.ph
  %store_forwarded116 = phi double [ %load_initial115, %.ph ], [ %162, %._crit_edge129 ]
  %store_forwarded = phi double [ %load_initial, %.ph ], [ %147, %._crit_edge129 ]
  %indvars.iv78 = phi i64 [ 1, %.ph ], [ %indvars.iv.next79, %._crit_edge129 ]
  ...
  br i1 %exitcond81, label %._crit_edge39.us.loopexit117, label %._crit_edge129

._crit_edge129:                                   ; preds = %144
  br label %144
...
._crit_edge46:                                    ; preds = %._crit_edge43.us
  ...
  br i1 %165, label %._crit_edge46..preheader7_crit_edge, label %._crit_edge
