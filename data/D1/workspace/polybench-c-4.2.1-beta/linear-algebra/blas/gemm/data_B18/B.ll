...
._crit_edge27.us:                                 ; preds = %13
  ...
  %21 = icmp slt i64 %indvars.iv.next58, %11
...
._crit_edge18.us:                                 ; preds = %._crit_edge18.us.loopexit, %.prol.loopexit
  ...
  %43 = icmp slt i64 %indvars.iv.next50, %11
...
._crit_edge.us:                                   ; preds = %48
  ...
  %56 = icmp slt i64 %indvars.iv.next44, %46
...
.preheader5.preheader:                            ; preds = %.preheader5.lr.ph
  ...
  %lcmp.mod = icmp eq i64 %xtraiter144, 0
...
.preheader5.us.preheader:                         ; preds = %.preheader5.lr.ph
  ...
  %smax77 = select i1 %15, i64 %11, i64 1
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.loopexit, %.preheader5.us
  ...
  br i1 %18, label %..preheader4_crit_edge.us, label %.preheader5.us.new.preheader
...
._crit_edge9.us:                                  ; preds = %._crit_edge9.us.loopexit, %..preheader4_crit_edge.us
  ...
  %45 = icmp slt i64 %indvars.iv.next40, %12
...
scalar.ph76:                                      ; preds = %scalar.ph76.preheader, %scalar.ph76
  ...
  %83 = icmp slt i64 %indvars.iv.next35, %11
...
._crit_edge9.1:                                   ; preds = %._crit_edge.us.1, %._crit_edge9
  ...
  %85 = icmp slt i64 %indvars.iv.next49.1, %12
  br i1 %85, label %.preheader5, label %._crit_edge14.loopexit143.unr-lcssa
}
