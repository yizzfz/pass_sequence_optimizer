...
for.cond5.preheader.us:                           ; preds = %for.cond5.preheader.us.preheader, %for.cond5.for.inc39_crit_edge.us
  ...
  %0 = trunc i64 %indvars.iv1825.us to i32
...
for.inc36.us:                                     ; preds = %for.inc36.us, %for.cond5.preheader.us
  ...
  %3 = add nuw nsw i64 %indvars.iv23.us, 2
  ...
  %5 = add nuw nsw i64 %indvars.iv23.us, 3
...
for.inc:                                          ; preds = %for.inc, %entry
  %indvars.iv2028 = phi i64 [ 0, %entry ], [ %indvars.iv.next21.4, %for.inc ]
  %7 = trunc i64 %indvars.iv2028 to i32
  ...
  %arrayidx.1 = getelementptr inbounds double, double* %_fict_, i64 %indvars.iv.next21
  store double %conv.1, double* %arrayidx.1, align 8
  %indvars.iv.next21.1 = add nsw i64 %indvars.iv2028, 2
  %9 = trunc i64 %indvars.iv.next21.1 to i32
  ...
  %10 = trunc i64 %indvars.iv.next21.2 to i32
  %conv.3 = sitofp i32 %10 to double
  %arrayidx.3 = getelementptr inbounds double, double* %_fict_, i64 %indvars.iv.next21.2
  store double %conv.3, double* %arrayidx.3, align 8
  %indvars.iv.next21.3 = add nsw i64 %indvars.iv2028, 4
  %11 = trunc i64 %indvars.iv.next21.3 to i32
  ...
  %exitcond32.4 = icmp eq i64 %indvars.iv.next21.4, 500
  br i1 %exitcond32.4, label %for.cond5.preheader.us.preheader, label %for.inc
...
for.inc31.us:                                     ; preds = %for.inc31.us, %for.inc31.us.preheader
  %indvars.iv6080.us = phi i64 [ 0, %for.inc31.us.preheader ], [ %indvars.iv.next61.us.1, %for.inc31.us ]
  ...
  br i1 %exitcond100.1, label %for.cond10.for.inc34_crit_edge.us.loopexit, label %for.inc31.us, !llvm.loop !9
...
for.inc:                                          ; preds = %for.inc, %for.cond1.preheader
  %indvars.iv78 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next.4, %for.inc ]
...
for.inc63.us.preheader.new:                       ; preds = %for.inc63.us.preheader.new.loopexit, %for.cond40.preheader.us
  %indvars.iv6585.us.ph = phi i64 [ 1, %for.cond40.preheader.us ], [ 1197, %for.inc63.us.preheader.new.loopexit ]
...
for.inc63.us:                                     ; preds = %for.inc63.us, %for.inc63.us.preheader.new
  %indvars.iv6585.us = phi i64 [ %indvars.iv.next66.us.prol, %for.inc63.us.preheader.new ], [ %indvars.iv.next66.us.1, %for.inc63.us ]
  ...
  br i1 %exitcond103.1, label %for.cond40.for.inc66_crit_edge.us, label %for.inc63.us, !llvm.loop !16
