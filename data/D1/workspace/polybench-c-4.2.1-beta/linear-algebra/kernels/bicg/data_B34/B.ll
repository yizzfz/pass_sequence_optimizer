...
; <label>:21:                                     ; preds = %21, %.lr.ph10
  %indvars.iv20 = phi i64 [ 0, %.lr.ph10 ], [ %indvars.iv.next21.1, %21 ]
  ...
  %exitcond24.1 = icmp eq i64 %indvars.iv.next21.1, 1900
  br i1 %exitcond24.1, label %.lr.ph4.split.us.preheader, label %21

.lr.ph4.split.us.preheader:                       ; preds = %21
...
._crit_edge.us:                                   ; preds = %7
  ...
  %exitcond27 = icmp eq i64 %indvars.iv.next16, 2100
  br i1 %exitcond27, label %._crit_edge4, label %.lr.ph3.split.us

; <label>:21:                                     ; preds = %21, %.lr.ph9
  %indvars.iv19 = phi i64 [ 0, %.lr.ph9 ], [ %indvars.iv.next20.24, %21 ]
  %indvars.iv.next20.24 = add nsw i64 %indvars.iv19, 25
  %exitcond28.24 = icmp eq i64 %indvars.iv.next20.24, 1900
  br i1 %exitcond28.24, label %.lr.ph3.split.us.preheader, label %21

.lr.ph3.split.us.preheader:                       ; preds = %21
...
; <label>:6:                                      ; preds = %._crit_edge14, %.lr.ph6
  ...
  %8 = srem i32 %7, 20
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %10, label %._crit_edge14
...
._crit_edge7:                                     ; preds = %._crit_edge14
...
; <label>:20:                                     ; preds = %._crit_edge16, %._crit_edge7
