...
.lr.ph:                                           ; preds = %.lr.ph21, %._crit_edge
...
; <label>:6:                                      ; preds = %._crit_edge, %.lr.ph34
  %indvars.iv40 = phi i64 [ 0, %.lr.ph34 ], [ %indvars.iv.next41, %._crit_edge ]
  %7 = add i64 %indvars.iv40, 4294967295
  %8 = getelementptr inbounds double, double* %3, i64 %indvars.iv40
  %9 = bitcast double* %8 to i64*
  %10 = load i64, i64* %9, align 8
  %11 = getelementptr inbounds double, double* %2, i64 %indvars.iv40
  %12 = bitcast double* %11 to i64*
  store i64 %10, i64* %12, align 8
  %13 = icmp sgt i64 %indvars.iv40, 0
...
.prol.preheader:                                  ; preds = %.lr.ph
  %14 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv40, i64 0
  %15 = load double, double* %14, align 8
  %16 = load double, double* %2, align 8
  %17 = fmul double %15, %16
  %18 = load double, double* %sunkaddr26, align 8
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.lr.ph.new ], [ %indvars.iv.unr.ph, %.lr.ph.new.preheader ]
  %22 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv40, i64 %indvars.iv
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %29 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv40, i64 %indvars.iv.next
  %30 = load double, double* %29, align 8
  %31 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next
  %32 = load double, double* %31, align 8
  %33 = fmul double %30, %32
  %34 = load double, double* %sunkaddr26, align 8
  %35 = fsub double %34, %33
  store double %35, double* %sunkaddr26, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %6
  ...
  %36 = load double, double* %sunkaddr30, align 8
  %37 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv40, i64 %indvars.iv40
  %38 = load double, double* %37, align 8
  %39 = fdiv double %36, %38
  store double %39, double* %sunkaddr30, align 8
  %indvars.iv.next41 = add nuw nsw i64 %indvars.iv40, 1
  %exitcond = icmp eq i64 %indvars.iv.next41, %wide.trip.count42
  br i1 %exitcond, label %._crit_edge35.loopexit, label %6
