...
.lr.ph36.split.us:                                ; preds = %._crit_edge32.us, %.lr.ph36.split.us.preheader
  ...
  %sunkaddr127 = add i64 %4, %sunkaddr126
...
._crit_edge32.us:                                 ; preds = %._crit_edge
  %22 = fdiv double %21, %0
  %sunkaddr26 = shl i64 %indvars.iv92, 3
...
vector.memcheck:                                  ; preds = %._crit_edge25.us, %._crit_edge32.us..preheader7.us_crit_edge
  ...
  %scevgep10 = getelementptr [1200 x double], [1200 x double]* %1, i64 %23, i64 0
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.vec17 = load <8 x double>, <8 x double>* %27, align 8, !alias.scope !4, !noalias !1
  %28 = fsub <8 x double> %wide.vec17, %wide.vec
  ...
  br i1 %39, label %._crit_edge25.us.loopexit29, label %vector.body, !llvm.loop !6
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %exitcond104.3, label %._crit_edge25.us.loopexit, label %scalar.ph, !llvm.loop !9

._crit_edge25.us.loopexit:                        ; preds = %scalar.ph
  br label %._crit_edge25.us

._crit_edge25.us.loopexit29:                      ; preds = %vector.body
  br label %._crit_edge25.us

._crit_edge25.us:                                 ; preds = %._crit_edge25.us.loopexit29, %._crit_edge25.us.loopexit
...
._crit_edge.us.us:                                ; preds = %._crit_edge23
...
._crit_edge23:                                    ; preds = %._crit_edge23, %.lr.ph.us.us
  %64 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %76, %._crit_edge23 ]
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %._crit_edge23 ]
  ...
  br i1 %exitcond.1, label %._crit_edge.us.us, label %._crit_edge23
