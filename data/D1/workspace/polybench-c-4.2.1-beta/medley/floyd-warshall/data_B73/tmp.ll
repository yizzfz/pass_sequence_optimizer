...
._crit_edge13:                                    ; preds = %._crit_edge13, %.preheader.us
  ...
  %1 = mul nuw nsw i64 %indvars.iv, %indvars.iv15
  ...
  %12 = srem i32 %7, 11
  %13 = icmp eq i32 %12, 0
  %or.cond19 = or i1 %or.cond, %13
  %. = select i1 %or.cond19, i32 999, i32 %4
...
.loopexit.us:                                     ; preds = %._crit_edge13
  ...
  br i1 %exitcond20, label %.loopexit3, label %.preheader.us
...
.loopexit.us:                                     ; preds = %._crit_edge9
  ...
  br i1 %exitcond14, label %.loopexit3, label %.preheader.us
