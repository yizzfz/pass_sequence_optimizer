...
define internal fastcc void @kernel_gemver(i32, double, double, [2000 x double]*, double*, double*, double*, double*, double*, double*, double*, double*) unnamed_addr #2 {
  ...
  br i1 %27, label %.lr.ph36, label %.thread
...
.lr.ph36:                                         ; preds = %12
  ...
  br i1 %30, label %.lr.ph36.split.us.preheader, label %._crit_edge37.loopexit

.lr.ph36.split.us.preheader:                      ; preds = %.lr.ph36
  %.promoted38 = load i32, i32* %25, align 4
  %36 = load i32, i32* %13, align 4
  %37 = sext i32 %36 to i64
  %38 = sext i32 %.promoted38 to i64
  %39 = icmp sgt i64 %37, 1
  %smax82 = select i1 %39, i64 %37, i64 1
  %40 = icmp sgt i64 %37, 1
  %smax84 = select i1 %40, i64 %37, i64 1
  %scevgep87 = getelementptr double, double* %33, i64 %smax84
  %scevgep89 = getelementptr double, double* %35, i64 %smax84
  %n.vec = and i64 %smax82, 9223372036854775804
  br label %.lr.ph36.split.us

.lr.ph36.split.us:                                ; preds = %._crit_edge32.us, %.lr.ph36.split.us.preheader
  %indvar = phi i64 [ 0, %.lr.ph36.split.us.preheader ], [ %indvar.next, %._crit_edge32.us ]
  %indvars.iv66 = phi i64 [ %38, %.lr.ph36.split.us.preheader ], [ %indvars.iv.next67, %._crit_edge32.us ]
  %41 = icmp ult i64 %smax82, 4
  %42 = add i64 %38, %indvar
  %scevgep = getelementptr [2000 x double], [2000 x double]* %31, i64 %42, i64 0
  %scevgep85 = getelementptr [2000 x double], [2000 x double]* %31, i64 %42, i64 %smax84
  %43 = getelementptr inbounds double, double* %32, i64 %indvars.iv66
  %44 = getelementptr inbounds double, double* %34, i64 %indvars.iv66
  br i1 %41, label %._crit_edge.preheader, label %min.iters.checked

min.iters.checked:                                ; preds = %.lr.ph36.split.us
  %45 = icmp eq i64 %n.vec, 0
  br i1 %45, label %._crit_edge.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %bound0 = icmp ult double* %scevgep, %43
  %bound1 = icmp ult double* %43, %scevgep85
  %found.conflict = and i1 %bound0, %bound1
  %bound092 = icmp ult double* %scevgep, %scevgep87
  %bound193 = icmp ult double* %33, %scevgep85
  %found.conflict94 = and i1 %bound092, %bound193
  %conflict.rdx = or i1 %found.conflict, %found.conflict94
  %bound097 = icmp ult double* %scevgep, %44
  %bound198 = icmp ult double* %44, %scevgep85
  %found.conflict99 = and i1 %bound097, %bound198
  %conflict.rdx100 = or i1 %conflict.rdx, %found.conflict99
  %bound0101 = icmp ult double* %scevgep, %scevgep89
  %bound1102 = icmp ult double* %35, %scevgep85
  %found.conflict103 = and i1 %bound0101, %bound1102
  %conflict.rdx104 = or i1 %conflict.rdx100, %found.conflict103
  br i1 %conflict.rdx104, label %._crit_edge.preheader, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %46 = getelementptr inbounds [2000 x double], [2000 x double]* %31, i64 %indvars.iv66, i64 %index
  ...
  %wide.load106 = load <2 x double>, <2 x double>* %49, align 8, !alias.scope !1, !noalias !4
  ...
  %wide.load107 = load <2 x double>, <2 x double>* %56, align 8, !alias.scope !10
  %57 = getelementptr double, double* %55, i64 2
  %58 = bitcast double* %57 to <2 x double>*
  %wide.load108 = load <2 x double>, <2 x double>* %58, align 8, !alias.scope !10
  %59 = fmul <2 x double> %52, %wide.load107
  %60 = fmul <2 x double> %54, %wide.load108
  %61 = fadd <2 x double> %wide.load, %59
  %62 = fadd <2 x double> %wide.load106, %60
  ...
  %wide.load109 = load <2 x double>, <2 x double>* %69, align 8, !alias.scope !12
  %70 = getelementptr double, double* %68, i64 2
  %71 = bitcast double* %70 to <2 x double>*
  %wide.load110 = load <2 x double>, <2 x double>* %71, align 8, !alias.scope !12
  %72 = fmul <2 x double> %65, %wide.load109
  %73 = fmul <2 x double> %67, %wide.load110
...
middle.block:                                     ; preds = %vector.body
  %79 = icmp eq i64 %smax82, %n.vec
  br i1 %79, label %._crit_edge32.us, label %._crit_edge.preheader

._crit_edge.preheader:                            ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.lr.ph36.split.us
  %indvars.iv64.ph = phi i64 [ 0, %.lr.ph36.split.us ], [ 0, %min.iters.checked ], [ 0, %vector.memcheck ], [ %n.vec, %middle.block ]
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge.preheader
  ...
  %80 = getelementptr inbounds [2000 x double], [2000 x double]* %31, i64 %indvars.iv66, i64 %indvars.iv64
  %81 = load double, double* %80, align 8
  %82 = load double, double* %43, align 8
  %83 = getelementptr inbounds double, double* %33, i64 %indvars.iv64
  %84 = load double, double* %83, align 8
  %85 = fmul double %82, %84
  %86 = fadd double %81, %85
  %87 = load double, double* %44, align 8
  %88 = getelementptr inbounds double, double* %35, i64 %indvars.iv64
  %89 = load double, double* %88, align 8
  %90 = fmul double %87, %89
  %91 = fadd double %86, %90
  %92 = getelementptr inbounds [2000 x double], [2000 x double]* %31, i64 %indvars.iv66, i64 %indvars.iv64
  store double %91, double* %92, align 8
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1
  %93 = icmp slt i64 %indvars.iv.next65, %37
  br i1 %93, label %._crit_edge, label %._crit_edge32.us.loopexit, !llvm.loop !16
...
._crit_edge32.us:                                 ; preds = %._crit_edge32.us.loopexit, %middle.block
  ...
  %94 = icmp slt i64 %indvars.iv.next67, %29
  %indvar.next = add i64 %indvar, 1
  br i1 %94, label %.lr.ph36.split.us, label %._crit_edge37.loopexit.loopexit

._crit_edge37.loopexit.loopexit:                  ; preds = %._crit_edge32.us
  br label %._crit_edge37.loopexit

._crit_edge37.loopexit:                           ; preds = %._crit_edge37.loopexit.loopexit, %.lr.ph36
  %.pr = load i32, i32* %13, align 4
  store i32 0, i32* %25, align 4
  %95 = icmp sgt i32 %.pr, 0
  br i1 %95, label %.lr.ph24, label %.thread75

.lr.ph24:                                         ; preds = %._crit_edge37.loopexit
  ...
  br i1 %98, label %.lr.ph24.split.us.preheader, label %.thread

.lr.ph24.split.us.preheader:                      ; preds = %.lr.ph24
  %.promoted26 = load i32, i32* %25, align 4
  %103 = sext i32 %.promoted26 to i64
  %104 = and i32 %96, 1
  br label %.lr.ph24.split.us

.lr.ph24.split.us:                                ; preds = %._crit_edge20.us, %.lr.ph24.split.us.preheader
  %indvars.iv60 = phi i64 [ %103, %.lr.ph24.split.us.preheader ], [ %indvars.iv.next61, %._crit_edge20.us ]
  %105 = icmp eq i32 %104, 0
  br i1 %105, label %.prol.loopexit71, label %.prol.preheader70

.prol.preheader70:                                ; preds = %.lr.ph24.split.us
  %106 = ptrtoint double* %99 to i64
  %107 = ptrtoint double* %99 to i64
  %sunkaddr148 = shl i64 %indvars.iv60, 3
  %sunkaddr149 = add i64 %107, %sunkaddr148
  %sunkaddr150 = inttoptr i64 %sunkaddr149 to double*
  %108 = load double, double* %sunkaddr150, align 8
  ...
  %sunkaddr152 = shl i64 %indvars.iv60, 3
  %sunkaddr153 = add i64 %106, %sunkaddr152
  %sunkaddr154 = inttoptr i64 %sunkaddr153 to double*
  store double %114, double* %sunkaddr154, align 8
  br label %.prol.loopexit71

.prol.loopexit71:                                 ; preds = %.lr.ph24.split.us, %.prol.preheader70
  %indvars.iv56.unr.ph = phi i64 [ 1, %.prol.preheader70 ], [ 0, %.lr.ph24.split.us ]
  %115 = icmp eq i32 %96, 1
  br i1 %115, label %._crit_edge20.us, label %.lr.ph24.split.us.new.preheader

.lr.ph24.split.us.new.preheader:                  ; preds = %.prol.loopexit71
  br label %.lr.ph24.split.us.new

.lr.ph24.split.us.new:                            ; preds = %.lr.ph24.split.us.new, %.lr.ph24.split.us.new.preheader
  %indvars.iv56 = phi i64 [ %indvars.iv56.unr.ph, %.lr.ph24.split.us.new.preheader ], [ %indvars.iv.next57.1, %.lr.ph24.split.us.new ]
  %sunkaddr = ptrtoint double* %99 to i64
  %sunkaddr179 = mul i64 %indvars.iv60, 8
  %sunkaddr180 = add i64 %sunkaddr, %sunkaddr179
  %sunkaddr181 = inttoptr i64 %sunkaddr180 to double*
  %116 = load double, double* %sunkaddr181, align 8
  ...
  %sunkaddr182 = ptrtoint double* %99 to i64
  %sunkaddr183 = mul i64 %indvars.iv60, 8
  %sunkaddr184 = add i64 %sunkaddr182, %sunkaddr183
  %sunkaddr185 = inttoptr i64 %sunkaddr184 to double*
  store double %123, double* %sunkaddr185, align 8
  ...
  store double %130, double* %sunkaddr185, align 8
  %indvars.iv.next57.1 = add nuw nsw i64 %indvars.iv56, 2
  %exitcond59.1 = icmp eq i64 %indvars.iv.next57.1, %wide.trip.count58.1
  br i1 %exitcond59.1, label %._crit_edge20.us.loopexit, label %.lr.ph24.split.us.new

._crit_edge20.us.loopexit:                        ; preds = %.lr.ph24.split.us.new
  br label %._crit_edge20.us

._crit_edge20.us:                                 ; preds = %._crit_edge20.us.loopexit, %.prol.loopexit71
  %indvars.iv.next61 = add nsw i64 %indvars.iv60, 1
  %131 = icmp slt i64 %indvars.iv.next61, %97
  br i1 %131, label %.lr.ph24.split.us, label %.thread.loopexit

.thread.loopexit:                                 ; preds = %._crit_edge20.us
  br label %.thread

.thread:                                          ; preds = %.thread.loopexit, %.lr.ph24, %12
  %.pr74 = load i32, i32* %13, align 4
  store i32 0, i32* %25, align 4
  %132 = icmp sgt i32 %.pr74, 0
  br i1 %132, label %.lr.ph15, label %.thread77

.thread77:                                        ; preds = %.thread
  store i32 0, i32* %25, align 4
  br label %._crit_edge79

.lr.ph15:                                         ; preds = %.thread
  ...
  %smax114 = select i1 %139, i64 %138, i64 %137
  %140 = sub nsw i64 %smax114, %136
  %min.iters.check115 = icmp ult i64 %140, 4
  br i1 %min.iters.check115, label %._crit_edge78.preheader, label %min.iters.checked116

min.iters.checked116:                             ; preds = %.lr.ph15
  %n.vec118 = and i64 %140, -4
  %cmp.zero119 = icmp eq i64 %n.vec118, 0
  br i1 %cmp.zero119, label %._crit_edge78.preheader, label %vector.memcheck134

vector.memcheck134:                               ; preds = %min.iters.checked116
  %scevgep121 = getelementptr double, double* %133, i64 %136
  %141 = add nsw i64 %136, 1
  %142 = icmp sgt i64 %141, %137
  %smax123 = select i1 %142, i64 %141, i64 %137
  %scevgep124 = getelementptr double, double* %133, i64 %smax123
  %scevgep126 = getelementptr double, double* %134, i64 %136
  %scevgep128 = getelementptr double, double* %134, i64 %smax123
  %bound0130 = icmp ult double* %scevgep121, %scevgep128
  %bound1131 = icmp ult double* %scevgep126, %scevgep124
  %memcheck.conflict133 = and i1 %bound0130, %bound1131
  %ind.end = add nsw i64 %136, %n.vec118
  br i1 %memcheck.conflict133, label %._crit_edge78.preheader, label %vector.body111.preheader

vector.body111.preheader:                         ; preds = %vector.memcheck134
  %143 = add nsw i64 %n.vec118, -4
...
vector.body111.prol:                              ; preds = %vector.body111.preheader
  %146 = getelementptr inbounds double, double* %133, i64 %136
  %147 = bitcast double* %146 to <2 x double>*
  %wide.load144.prol = load <2 x double>, <2 x double>* %147, align 8, !alias.scope !17, !noalias !20
  %148 = getelementptr double, double* %146, i64 2
  %149 = bitcast double* %148 to <2 x double>*
  %wide.load145.prol = load <2 x double>, <2 x double>* %149, align 8, !alias.scope !17, !noalias !20
  %150 = getelementptr inbounds double, double* %134, i64 %136
  %151 = bitcast double* %150 to <2 x double>*
  %wide.load146.prol = load <2 x double>, <2 x double>* %151, align 8, !alias.scope !20
  %152 = getelementptr double, double* %150, i64 2
  %153 = bitcast double* %152 to <2 x double>*
  %wide.load147.prol = load <2 x double>, <2 x double>* %153, align 8, !alias.scope !20
  %154 = fadd <2 x double> %wide.load144.prol, %wide.load146.prol
  %155 = fadd <2 x double> %wide.load145.prol, %wide.load147.prol
...
vector.body111.prol.loopexit:                     ; preds = %vector.body111.preheader, %vector.body111.prol
  %index136.unr = phi i64 [ 4, %vector.body111.prol ], [ 0, %vector.body111.preheader ]
  %158 = icmp eq i64 %144, 0
  br i1 %158, label %middle.block112, label %vector.body111.preheader.new

vector.body111.preheader.new:                     ; preds = %vector.body111.prol.loopexit
  br label %vector.body111

vector.body111:                                   ; preds = %vector.body111, %vector.body111.preheader.new
  %index136 = phi i64 [ %index136.unr, %vector.body111.preheader.new ], [ %index.next137.1, %vector.body111 ]
  %159 = add i64 %136, %index136
  %160 = getelementptr inbounds double, double* %133, i64 %159
  %161 = bitcast double* %160 to <2 x double>*
  %wide.load144 = load <2 x double>, <2 x double>* %161, align 8, !alias.scope !17, !noalias !20
  %162 = getelementptr double, double* %160, i64 2
  %163 = bitcast double* %162 to <2 x double>*
  %wide.load145 = load <2 x double>, <2 x double>* %163, align 8, !alias.scope !17, !noalias !20
  %164 = getelementptr inbounds double, double* %134, i64 %159
  %165 = bitcast double* %164 to <2 x double>*
  %wide.load146 = load <2 x double>, <2 x double>* %165, align 8, !alias.scope !20
  %166 = getelementptr double, double* %164, i64 2
  %167 = bitcast double* %166 to <2 x double>*
  %wide.load147 = load <2 x double>, <2 x double>* %167, align 8, !alias.scope !20
  %168 = fadd <2 x double> %wide.load144, %wide.load146
  %169 = fadd <2 x double> %wide.load145, %wide.load147
  ...
  %172 = add i64 %136, %index.next137
  %173 = getelementptr inbounds double, double* %133, i64 %172
  %174 = bitcast double* %173 to <2 x double>*
  %wide.load144.1 = load <2 x double>, <2 x double>* %174, align 8, !alias.scope !17, !noalias !20
  %175 = getelementptr double, double* %173, i64 2
  %176 = bitcast double* %175 to <2 x double>*
  %wide.load145.1 = load <2 x double>, <2 x double>* %176, align 8, !alias.scope !17, !noalias !20
  %177 = getelementptr inbounds double, double* %134, i64 %172
  %178 = bitcast double* %177 to <2 x double>*
  %wide.load146.1 = load <2 x double>, <2 x double>* %178, align 8, !alias.scope !20
  %179 = getelementptr double, double* %177, i64 2
  %180 = bitcast double* %179 to <2 x double>*
  %wide.load147.1 = load <2 x double>, <2 x double>* %180, align 8, !alias.scope !20
  %181 = fadd <2 x double> %wide.load144.1, %wide.load146.1
  %182 = fadd <2 x double> %wide.load145.1, %wide.load147.1
  ...
  %185 = icmp eq i64 %index.next137.1, %n.vec118
  br i1 %185, label %middle.block112.loopexit, label %vector.body111, !llvm.loop !22
...
middle.block112:                                  ; preds = %middle.block112.loopexit, %vector.body111.prol.loopexit
  %cmp.n139 = icmp eq i64 %140, %n.vec118
  br i1 %cmp.n139, label %.thread75, label %._crit_edge78.preheader

._crit_edge78.preheader:                          ; preds = %middle.block112, %vector.memcheck134, %min.iters.checked116, %.lr.ph15
  %indvars.iv53.ph = phi i64 [ %136, %.lr.ph15 ], [ %136, %min.iters.checked116 ], [ %136, %vector.memcheck134 ], [ %ind.end, %middle.block112 ]
...
.thread75:                                        ; preds = %.thread75.loopexit, %middle.block112, %._crit_edge37.loopexit
...
.lr.ph8:                                          ; preds = %.thread75
  ...
  %.promoted10 = load i32, i32* %25, align 4
  %201 = sext i32 %.promoted10 to i64
...
.prol.preheader:                                  ; preds = %.lr.ph8.split.us
  ...
  %sunkaddr164 = shl i64 %indvars.iv51, 3
  %sunkaddr165 = add i64 %205, %sunkaddr164
  %sunkaddr166 = inttoptr i64 %sunkaddr165 to double*
  %206 = load double, double* %sunkaddr166, align 8
  ...
  %sunkaddr168 = shl i64 %indvars.iv51, 3
  %sunkaddr169 = add i64 %204, %sunkaddr168
  %sunkaddr170 = inttoptr i64 %sunkaddr169 to double*
  store double %212, double* %sunkaddr170, align 8
  br label %.prol.loopexit
...
.lr.ph8.split.us.new:                             ; preds = %.lr.ph8.split.us.new, %.lr.ph8.split.us.new.preheader
  ...
  %sunkaddr186 = ptrtoint double* %197 to i64
  %sunkaddr187 = mul i64 %indvars.iv51, 8
  %sunkaddr188 = add i64 %sunkaddr186, %sunkaddr187
  %sunkaddr189 = inttoptr i64 %sunkaddr188 to double*
  %214 = load double, double* %sunkaddr189, align 8
  ...
  %sunkaddr190 = ptrtoint double* %197 to i64
  %sunkaddr191 = mul i64 %indvars.iv51, 8
  %sunkaddr192 = add i64 %sunkaddr190, %sunkaddr191
  %sunkaddr193 = inttoptr i64 %sunkaddr192 to double*
  store double %221, double* %sunkaddr193, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  ...
  store double %228, double* %sunkaddr193, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, %wide.trip.count.1
...
._crit_edge9.loopexit42:                          ; preds = %.lr.ph8
  %231 = add i32 %.promoted10, 1
  %232 = icmp sgt i32 %194, %231
  %smax = select i1 %232, i32 %194, i32 %231
  br label %._crit_edge9

._crit_edge9:                                     ; preds = %._crit_edge9.loopexit42, %._crit_edge9.loopexit
  %.lcssa11 = phi i32 [ %230, %._crit_edge9.loopexit ], [ %smax, %._crit_edge9.loopexit42 ]
  store i32 %.lcssa11, i32* %25, align 4
  br label %._crit_edge79
