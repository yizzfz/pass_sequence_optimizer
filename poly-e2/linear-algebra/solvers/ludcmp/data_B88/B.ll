...
for.inc:                                          ; preds = %for.inc, %entry
  ...
  %exitcond151.1 = icmp eq i64 %indvars.iv.next144, 1999
  br i1 %exitcond151.1, label %for.inc25.lr.ph.preheader, label %for.inc
...
for.inc44:                                        ; preds = %for.cond29.preheader, %for.inc37.for.inc44_crit_edge
  ...
  %exitcond167 = icmp eq i64 %indvars.iv.next142, 2000
...
for.inc62.us:                                     ; preds = %for.inc62.us, %for.end46
  ...
  %exitcond150.7 = icmp eq i64 %indvars.iv.next124.6, 1999
  %indvars.iv.next124.7 = add nsw i64 %indvars.iv123, 8
  br i1 %exitcond150.7, label %for.cond69.preheader.us.for.cond73.preheader.us.us_crit_edge.preheader, label %for.inc62.us
...
for.inc96.us:                                     ; preds = %for.inc93.us.us
  ...
  %exitcond166 = icmp eq i64 %indvars.iv.next118, 2000
...
for.inc93.us.us:                                  ; preds = %for.inc93.us.us.loopexit43, %for.inc93.us.us.loopexit
  ...
  %exitcond165 = icmp eq i64 %indvars.iv.next116, 2000
...
for.inc90.us.us:                                  ; preds = %for.inc90.us.us, %for.inc90.us.us.preheader
  ...
  %exitcond.1 = icmp eq i64 %indvars.iv.next112, 1999
...
for.inc115.us:                                    ; preds = %for.inc115.us, %for.inc115.us.preheader
  ...
  %exitcond149.4 = icmp eq i64 %indvars.iv.next.3, 1999
  %indvars.iv.next.4 = add nsw i64 %indvars.iv, 5
  br i1 %exitcond149.4, label %for.inc118.us.loopexit, label %for.inc115.us, !llvm.loop !19
...
for.inc118.us:                                    ; preds = %for.inc118.us.loopexit42, %for.inc118.us.loopexit
  ...
  %exitcond164 = icmp eq i64 %indvars.iv.next110, 2000
  br i1 %exitcond164, label %for.end120, label %for.cond103.preheader.us
...
for.cond1.preheader:                              ; preds = %for.inc58, %entry
  ...
  %4 = and i64 %indvars.iv152, 4294967295
...
for.inc48.us:                                     ; preds = %for.inc48.us, %for.body30.us.new
  ...
  %exitcond154.1 = icmp eq i64 %indvars.iv.next134, %4
  %indvars.iv.next134.1 = add nsw i64 %indvars.iv133, 2
  br i1 %exitcond154.1, label %for.inc55.us.loopexit, label %for.inc48.us
...
for.body3:                                        ; preds = %for.body3.preheader, %for.inc25
  %indvars.iv148 = phi i64 [ %indvars.iv.next149, %for.inc25 ], [ 4294967295, %for.body3.preheader ]
  %indvars.iv124 = phi i64 [ %indvars.iv.next125, %for.inc25 ], [ 0, %for.body3.preheader ]
  %37 = and i64 %indvars.iv148, 4294967295
...
for.inc:                                          ; preds = %for.inc, %for.inc.preheader.new
  ...
  %exitcond150.1 = icmp eq i64 %indvars.iv.next119, %37
  %indvars.iv.next119.1 = add nsw i64 %indvars.iv118, 2
  br i1 %exitcond150.1, label %for.inc25.loopexit, label %for.inc
...
for.inc25:                                        ; preds = %for.inc25.loopexit, %for.inc.prol.loopexit, %for.body3
  ...
  %indvars.iv.next149 = add nuw nsw i64 %37, 1
...
for.body30:                                       ; preds = %for.body30.preheader13, %for.body30
  ...
  %exitcond151 = icmp eq i64 %indvars.iv128, 1999
  %indvars.iv.next129 = add nuw nsw i64 %indvars.iv128, 1
  br i1 %exitcond151, label %for.inc58.loopexit24, label %for.body30, !llvm.loop !21
...
for.inc58:                                        ; preds = %for.inc58.loopexit24, %for.inc58.loopexit, %middle.block
  ...
  %indvars.iv.next153 = add nuw nsw i64 %4, 1
...
for.body63:                                       ; preds = %for.body63.preheader, %for.inc82
  %indvars.iv145 = phi i64 [ %indvars.iv.next146, %for.inc82 ], [ 4294967295, %for.body63.preheader ]
  %indvars.iv116 = phi i64 [ %indvars.iv.next117, %for.inc82 ], [ 0, %for.body63.preheader ]
  %51 = and i64 %indvars.iv145, 4294967295
...
for.inc77.preheader:                              ; preds = %for.body63
  %53 = add nsw i64 %indvars.iv145, 1
...
for.inc77:                                        ; preds = %for.inc77, %for.inc77.preheader.new
  ...
  %exitcond147.3 = icmp eq i64 %indvars.iv.next.2, %51
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  br i1 %exitcond147.3, label %for.inc82.loopexit, label %for.inc77
...
for.inc82:                                        ; preds = %for.inc82.loopexit, %for.inc77.prol.loopexit, %for.body63
  ...
  %indvars.iv.next146 = add nuw nsw i64 %51, 1
