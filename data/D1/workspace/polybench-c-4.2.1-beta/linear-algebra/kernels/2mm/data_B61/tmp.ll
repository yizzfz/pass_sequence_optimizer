...
._crit_edge.preheader:                            ; preds = %14, %6
  %indvars.iv19 = phi i64 [ 0, %6 ], [ %indvars.iv.next20, %14 ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge.preheader
  %indvars.iv16 = phi i64 [ 0, %._crit_edge.preheader ], [ %indvars.iv.next17, %._crit_edge ]
...
; <label>:14:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond21, label %._crit_edge9.preheader.preheader, label %._crit_edge.preheader

._crit_edge9.preheader.preheader:                 ; preds = %14
  br label %._crit_edge9.preheader

._crit_edge9.preheader:                           ; preds = %._crit_edge9.preheader.preheader, %._crit_edge8
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %._crit_edge8 ], [ 0, %._crit_edge9.preheader.preheader ]
  br label %._crit_edge9

._crit_edge9:                                     ; preds = %._crit_edge9, %._crit_edge9.preheader
  %indvars.iv10 = phi i64 [ 0, %._crit_edge9.preheader ], [ %indvars.iv.next11.1, %._crit_edge9 ]
  ...
  br i1 %exitcond12.1, label %._crit_edge8, label %._crit_edge9

._crit_edge8:                                     ; preds = %._crit_edge9
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 1100
  br i1 %exitcond15, label %._crit_edge11.preheader.preheader, label %._crit_edge9.preheader

._crit_edge11.preheader.preheader:                ; preds = %._crit_edge8
  br label %._crit_edge11.preheader

._crit_edge11.preheader:                          ; preds = %._crit_edge11.preheader.preheader, %._crit_edge10
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %._crit_edge10 ], [ 0, %._crit_edge11.preheader.preheader ]
  br label %._crit_edge11

._crit_edge11:                                    ; preds = %._crit_edge11, %._crit_edge11.preheader
  %indvars.iv4 = phi i64 [ 0, %._crit_edge11.preheader ], [ %indvars.iv.next5, %._crit_edge11 ]
  %27 = add nuw nsw i64 %indvars.iv4, 3
  %28 = mul nuw nsw i64 %27, %indvars.iv7
  %29 = add nuw nsw i64 %28, 1
  %30 = trunc i64 %29 to i32
  %31 = srem i32 %30, 1200
  %32 = sitofp i32 %31 to double
  %33 = fdiv double %32, 1.200000e+03
  %34 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv7, i64 %indvars.iv4
  store double %33, double* %34, align 8
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1
  %exitcond6 = icmp eq i64 %indvars.iv.next5, 1200
  br i1 %exitcond6, label %._crit_edge10, label %._crit_edge11

._crit_edge10:                                    ; preds = %._crit_edge11
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %exitcond9 = icmp eq i64 %indvars.iv.next8, 900
  br i1 %exitcond9, label %._crit_edge13.preheader.preheader, label %._crit_edge11.preheader

._crit_edge13.preheader.preheader:                ; preds = %._crit_edge10
  br label %._crit_edge13.preheader

._crit_edge13.preheader:                          ; preds = %._crit_edge13.preheader.preheader, %._crit_edge12
  %indvars.iv1 = phi i64 [ %indvars.iv.next2, %._crit_edge12 ], [ 0, %._crit_edge13.preheader.preheader ]
  br label %._crit_edge13

._crit_edge13:                                    ; preds = %._crit_edge13, %._crit_edge13.preheader
  %indvars.iv = phi i64 [ 0, %._crit_edge13.preheader ], [ %indvars.iv.next, %._crit_edge13 ]
  %35 = add nuw nsw i64 %indvars.iv, 2
  %36 = mul nuw nsw i64 %35, %indvars.iv1
  %37 = trunc i64 %36 to i32
  %38 = srem i32 %37, 1100
  %39 = sitofp i32 %38 to double
  %40 = fdiv double %39, 1.100000e+03
  %41 = getelementptr inbounds [1200 x double], [1200 x double]* %5, i64 %indvars.iv1, i64 %indvars.iv
  store double %40, double* %41, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1200
  br i1 %exitcond, label %._crit_edge12, label %._crit_edge13

._crit_edge12:                                    ; preds = %._crit_edge13
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 800
  br i1 %exitcond3, label %42, label %._crit_edge13.preheader
...
._crit_edge.preheader:                            ; preds = %24, %7
  %indvars.iv13 = phi i64 [ 0, %7 ], [ %indvars.iv.next14, %24 ]
  br label %._crit_edge._crit_edge

._crit_edge._crit_edge:                           ; preds = %._crit_edge, %._crit_edge.preheader
...
._crit_edge21:                                    ; preds = %._crit_edge21, %._crit_edge._crit_edge
  %indvars.iv7 = phi i64 [ 0, %._crit_edge._crit_edge ], [ %indvars.iv.next8.1, %._crit_edge21 ]
  %9 = phi double [ 0.000000e+00, %._crit_edge._crit_edge ], [ %23, %._crit_edge21 ]
  ...
  br i1 %exitcond9.1, label %._crit_edge, label %._crit_edge21

._crit_edge:                                      ; preds = %._crit_edge21
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %exitcond12 = icmp eq i64 %indvars.iv.next11, 900
  br i1 %exitcond12, label %24, label %._crit_edge._crit_edge

; <label>:24:                                     ; preds = %._crit_edge
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 800
  br i1 %exitcond15, label %._crit_edge7.preheader.preheader, label %._crit_edge.preheader

._crit_edge7.preheader.preheader:                 ; preds = %24
  br label %._crit_edge7.preheader

._crit_edge7.preheader:                           ; preds = %._crit_edge7.preheader.preheader, %._crit_edge6
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %._crit_edge6 ], [ 0, %._crit_edge7.preheader.preheader ]
  br label %._crit_edge7._crit_edge

._crit_edge7._crit_edge:                          ; preds = %._crit_edge7, %._crit_edge7.preheader
  %indvars.iv1 = phi i64 [ 0, %._crit_edge7.preheader ], [ %indvars.iv.next2, %._crit_edge7 ]
  %25 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv4, i64 %indvars.iv1
  %26 = load double, double* %25, align 8
  %27 = fmul double %26, %1
  store double %27, double* %25, align 8
  br label %._crit_edge22

._crit_edge22:                                    ; preds = %._crit_edge22, %._crit_edge7._crit_edge
  %indvars.iv = phi i64 [ 0, %._crit_edge7._crit_edge ], [ %indvars.iv.next.2, %._crit_edge22 ]
  %28 = phi double [ %27, %._crit_edge7._crit_edge ], [ %46, %._crit_edge22 ]
  %29 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv4, i64 %indvars.iv
  %30 = load double, double* %29, align 8
  %31 = getelementptr inbounds [1200 x double], [1200 x double]* %5, i64 %indvars.iv, i64 %indvars.iv1
  %32 = load double, double* %31, align 8
  %33 = fmul double %30, %32
  %34 = fadd double %28, %33
  store double %34, double* %25, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %35 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv4, i64 %indvars.iv.next
  %36 = load double, double* %35, align 8
  %37 = getelementptr inbounds [1200 x double], [1200 x double]* %5, i64 %indvars.iv.next, i64 %indvars.iv1
  %38 = load double, double* %37, align 8
  %39 = fmul double %36, %38
  %40 = fadd double %34, %39
  store double %40, double* %25, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %41 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv4, i64 %indvars.iv.next.1
  %42 = load double, double* %41, align 8
  %43 = getelementptr inbounds [1200 x double], [1200 x double]* %5, i64 %indvars.iv.next.1, i64 %indvars.iv1
  ...
  br i1 %exitcond.2, label %._crit_edge7, label %._crit_edge22

._crit_edge7:                                     ; preds = %._crit_edge22
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 1200
  br i1 %exitcond3, label %._crit_edge6, label %._crit_edge7._crit_edge

._crit_edge6:                                     ; preds = %._crit_edge7
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1
  %exitcond6 = icmp eq i64 %indvars.iv.next5, 800
  br i1 %exitcond6, label %47, label %._crit_edge7.preheader
