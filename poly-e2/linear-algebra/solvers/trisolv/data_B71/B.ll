...
for.body:                                         ; preds = %for.inc14, %for.body.lr.ph
  ...
  %indvars.iv12 = phi i32 [ %indvars.iv.next13, %for.inc14 ], [ %i.promoted, %for.body.lr.ph ]
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc14 ], [ %4, %for.body.lr.ph ]
  %6 = add i32 %i.promoted, %indvar
  %7 = zext i32 %indvars.iv12 to i64
...
for.body6.prol.loopexit:                          ; preds = %for.body6.prol.loopexit.unr-lcssa
  %11 = icmp eq i32 %6, 0
  br i1 %11, label %for.inc14.loopexit, label %for.body6.preheader.new
...
for.body6:                                        ; preds = %for.body6, %for.body6.preheader.new
  ...
  %exitcond14.1 = icmp eq i64 %indvars.iv.next, %7
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  br i1 %exitcond14.1, label %for.inc14.loopexit.unr-lcssa, label %for.body6
...
for.body:                                         ; preds = %for.end, %for.body.lr.ph
  ...
  %indvars.iv15 = phi i32 [ %indvars.iv.next16, %for.end ], [ %4, %for.body.lr.ph ]
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.end ], [ %5, %for.body.lr.ph ]
  %7 = add i32 %4, %indvar
  %8 = zext i32 %indvars.iv15 to i64
  %arrayidx = getelementptr inbounds double, double* %0, i64 %indvars.iv10
  %9 = bitcast double* %arrayidx to i64*
  %10 = load i64, i64* %9, align 8
  %arrayidx2 = getelementptr inbounds double, double* %1, i64 %indvars.iv10
  %11 = bitcast double* %arrayidx2 to i64*
  store i64 %10, i64* %11, align 8
  %cmp42 = icmp sgt i64 %indvars.iv10, 0
  br i1 %cmp42, label %for.body5.lr.ph, label %for.end

for.body5.lr.ph:                                  ; preds = %for.body
  %sunkaddr12 = shl i64 %indvars.iv10, 3
...
for.body5.prol:                                   ; preds = %for.body5.prol.preheader
  %arrayidx9.prol = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv10, i64 0
  %13 = load double, double* %arrayidx9.prol, align 8
  %14 = load double, double* %1, align 8
  %mul.prol = fmul double %13, %14
  %15 = load double, double* %sunkaddr14, align 8
  %sub.prol = fsub double %15, %mul.prol
  store double %sub.prol, double* %sunkaddr14, align 8
...
for.body5.prol.loopexit:                          ; preds = %for.body5.prol.loopexit.unr-lcssa
  %16 = icmp eq i32 %7, 0
  br i1 %16, label %for.end.loopexit, label %for.body5.lr.ph.new
...
for.body5:                                        ; preds = %for.body5, %for.body5.lr.ph.new
  ...
  %19 = load double, double* %sunkaddr14, align 8
  %sub = fsub double %19, %mul
  store double %sub, double* %sunkaddr14, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx9.1 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv10, i64 %indvars.iv.next
  %20 = load double, double* %arrayidx9.1, align 8
  %arrayidx11.1 = getelementptr inbounds double, double* %1, i64 %indvars.iv.next
  %21 = load double, double* %arrayidx11.1, align 8
  %mul.1 = fmul double %20, %21
  %22 = load double, double* %sunkaddr14, align 8
  %sub.1 = fsub double %22, %mul.1
  store double %sub.1, double* %sunkaddr14, align 8
  %exitcond17.1 = icmp eq i64 %indvars.iv.next, %8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  br i1 %exitcond17.1, label %for.end.loopexit.unr-lcssa, label %for.body5
...
for.cond.for.end24_crit_edge:                     ; preds = %for.end
  %25 = trunc i64 %indvars.iv.next11 to i32
...
for.body:                                         ; preds = %for.inc, %for.body.lr.ph
  ...
  %call2 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %9, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i64 0, i64 0), double %10) #5
...
for.end:                                          ; preds = %entry, %for.cond.for.end_crit_edge
  ...
  %16 = tail call i64 @fwrite(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.7, i64 0, i64 0), i64 22, i64 1, %struct._IO_FILE* %15) #4
  ret void
}
