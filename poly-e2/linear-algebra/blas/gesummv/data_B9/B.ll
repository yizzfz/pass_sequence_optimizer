...
entry:
  ...
  %arraydecay14 = bitcast i8* %call to [1300 x double]*
  %arraydecay715 = bitcast i8* %call1 to [1300 x double]*
  %arraydecay816 = bitcast i8* %call4 to double*
  call fastcc void @init_array(i32 1300, double* nonnull %alpha, double* nonnull %beta, [1300 x double]* %arraydecay14, [1300 x double]* %arraydecay715, double* %arraydecay816)
  call void (...) @polybench_timer_start() #4
  %0 = load double, double* %alpha, align 8
  %1 = load double, double* %beta, align 8
  %arraydecay1119 = bitcast i8* %call2 to double*
  %arraydecay1321 = bitcast i8* %call6 to double*
  call fastcc void @kernel_gesummv(i32 1300, double %0, double %1, [1300 x double]* %arraydecay14, [1300 x double]* %arraydecay715, double* %arraydecay1119, double* %arraydecay816, double* %arraydecay1321)
...
entry:
  ...
  br i1 %cmp21, label %for.body.lr.ph, label %for.end26
...
for.body.us:                                      ; preds = %for.cond2.for.inc24_crit_edge.us, %for.body.lr.ph
  %indvars.iv27 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next28, %for.cond2.for.inc24_crit_edge.us ]
  %0 = trunc i64 %indvars.iv27 to i32
  %conv.us = sitofp i32 %0 to double
  %div.us = fdiv double %conv.us, %conv1
  %arrayidx.us = getelementptr inbounds double, double* %x, i64 %indvars.iv27
...
for.body5.us:                                     ; preds = %for.body5.us, %for.body.us
  ...
  %1 = mul nuw nsw i64 %indvars.iv, %indvars.iv27
  %2 = add nuw nsw i64 %1, 1
  %3 = trunc i64 %2 to i32
  %rem6.us = srem i32 %3, %n
  %conv7.us = sitofp i32 %rem6.us to double
  %div9.us = fdiv double %conv7.us, %conv1
  %arrayidx13.us = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv27, i64 %indvars.iv
  ...
  %arrayidx23.us = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv27, i64 %indvars.iv
...
for.cond2.for.inc24_crit_edge.us:                 ; preds = %for.body5.us
  ...
  br i1 %exitcond30, label %for.end26.loopexit, label %for.body.us
...
entry:
  ...
  br i1 %cmp44, label %for.body.lr.ph, label %for.end41
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %sunkaddr55 = ptrtoint double* %y to i64
  br label %for.body.us

for.body.us:                                      ; preds = %for.cond5.for.end_crit_edge.us, %for.body.lr.ph
  %indvars.iv46 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next47, %for.cond5.for.end_crit_edge.us ]
  %arrayidx.us = getelementptr inbounds double, double* %tmp, i64 %indvars.iv46
  store double 0.000000e+00, double* %arrayidx.us, align 8
  %arrayidx4.us = getelementptr inbounds double, double* %y, i64 %indvars.iv46
  store double 0.000000e+00, double* %arrayidx4.us, align 8
  %sunkaddr52 = shl i64 %indvars.iv46, 3
  %sunkaddr53 = add i64 %sunkaddr, %sunkaddr52
  %sunkaddr54 = inttoptr i64 %sunkaddr53 to double*
  %sunkaddr56 = shl i64 %indvars.iv46, 3
...
for.body7.us:                                     ; preds = %for.body7.us, %for.body.us
  ...
  %arrayidx11.us = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv46, i64 %indvars.iv
  ...
  store double %add.us, double* %sunkaddr54, align 8
  %arrayidx21.us = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv46, i64 %indvars.iv
  %5 = load double, double* %arrayidx21.us, align 8
  %6 = load double, double* %arrayidx13.us, align 8
  %mul24.us = fmul double %5, %6
  %7 = load double, double* %sunkaddr58, align 8
  %add27.us = fadd double %mul24.us, %7
  store double %add27.us, double* %sunkaddr58, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond, label %for.cond5.for.end_crit_edge.us, label %for.body7.us

for.cond5.for.end_crit_edge.us:                   ; preds = %for.body7.us
  %sunkaddr35.us = shl nsw i64 %indvars.iv46, 3
  %sunkaddr36.us = add i64 %sunkaddr35.us, %1
  %sunkaddr37.us = inttoptr i64 %sunkaddr36.us to double*
  %8 = load double, double* %sunkaddr37.us, align 8
  %mul32.us = fmul double %8, %alpha
  %sunkaddr39.us = shl nsw i64 %indvars.iv46, 3
  %sunkaddr40.us = add i64 %sunkaddr39.us, %0
  %sunkaddr41.us = inttoptr i64 %sunkaddr40.us to double*
  %9 = load double, double* %sunkaddr41.us, align 8
  %mul35.us = fmul double %9, %beta
  %add36.us = fadd double %mul32.us, %mul35.us
  store double %add36.us, double* %sunkaddr41.us, align 8
  %indvars.iv.next47 = add nuw nsw i64 %indvars.iv46, 1
  %exitcond49 = icmp eq i64 %indvars.iv.next47, %wide.trip.count48
  br i1 %exitcond49, label %for.end41.loopexit, label %for.body.us
