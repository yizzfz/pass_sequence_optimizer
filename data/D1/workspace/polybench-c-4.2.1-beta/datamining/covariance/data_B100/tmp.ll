...
.lr.ph36.split.us:                                ; preds = %._crit_edge32.us, %.lr.ph36.split.us.preheader
  %indvars.iv92 = phi i64 [ 0, %.lr.ph36.split.us.preheader ], [ %indvars.iv.next93, %._crit_edge32.us ]
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv92
  store double 0.000000e+00, double* %5, align 8
  %sunkaddr128 = shl i64 %indvars.iv92, 3
  %sunkaddr129 = add i64 %4, %sunkaddr128
  %sunkaddr130 = inttoptr i64 %sunkaddr129 to double*
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph36.split.us
  %6 = phi double [ 0.000000e+00, %.lr.ph36.split.us ], [ %21, %._crit_edge ]
  %indvars.iv89 = phi i64 [ 0, %.lr.ph36.split.us ], [ %indvars.iv.next90.4, %._crit_edge ]
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv89, i64 %indvars.iv92
  %8 = load double, double* %7, align 8
  %9 = fadd double %6, %8
  store double %9, double* %sunkaddr130, align 8
  %indvars.iv.next90 = add nuw nsw i64 %indvars.iv89, 1
  %10 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next90, i64 %indvars.iv92
  %11 = load double, double* %10, align 8
  %12 = fadd double %9, %11
  store double %12, double* %sunkaddr130, align 8
  %indvars.iv.next90.1 = add nuw nsw i64 %indvars.iv89, 2
  %13 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next90.1, i64 %indvars.iv92
  %14 = load double, double* %13, align 8
  %15 = fadd double %12, %14
  store double %15, double* %sunkaddr130, align 8
  %indvars.iv.next90.2 = add nuw nsw i64 %indvars.iv89, 3
  %16 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next90.2, i64 %indvars.iv92
  %17 = load double, double* %16, align 8
  %18 = fadd double %15, %17
  store double %18, double* %sunkaddr130, align 8
  %indvars.iv.next90.3 = add nuw nsw i64 %indvars.iv89, 4
  %19 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next90.3, i64 %indvars.iv92
  %20 = load double, double* %19, align 8
  %21 = fadd double %18, %20
  store double %21, double* %sunkaddr130, align 8
  %indvars.iv.next90.4 = add nuw nsw i64 %indvars.iv89, 5
  %exitcond107.4 = icmp eq i64 %indvars.iv.next90.4, 1400
  br i1 %exitcond107.4, label %._crit_edge32.us, label %._crit_edge

._crit_edge32.us:                                 ; preds = %._crit_edge
  %22 = fdiv double %21, %0
  %sunkaddr20 = shl i64 %indvars.iv92, 3
  %sunkaddr21 = add i64 %sunkaddr, %sunkaddr20
  %sunkaddr22 = inttoptr i64 %sunkaddr21 to double*
  store double %22, double* %sunkaddr22, align 8
  %indvars.iv.next93 = add nuw nsw i64 %indvars.iv92, 1
  %exitcond108 = icmp eq i64 %indvars.iv.next93, 1200
  br i1 %exitcond108, label %._crit_edge32.us..preheader7.us_crit_edge, label %.lr.ph36.split.us

._crit_edge32.us..preheader7.us_crit_edge:        ; preds = %._crit_edge32.us
  %scevgep8 = getelementptr double, double* %3, i64 1200
  br label %vector.memcheck

vector.memcheck:                                  ; preds = %._crit_edge25.us, %._crit_edge32.us..preheader7.us_crit_edge
  %indvars.iv87 = phi i64 [ 0, %._crit_edge32.us..preheader7.us_crit_edge ], [ %23, %._crit_edge25.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv87, i64 0
  %23 = add nuw nsw i64 %indvars.iv87, 1
  %scevgep6 = getelementptr [1200 x double], [1200 x double]* %1, i64 %23, i64 0
  %bound0 = icmp ult double* %scevgep, %scevgep8
  %bound1 = icmp ugt double* %scevgep6, %3
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %._crit_edge119.preheader, label %vector.body.preheader

vector.body.preheader:                            ; preds = %vector.memcheck
  br label %vector.body

._crit_edge119.preheader:                         ; preds = %vector.memcheck
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv87, i64 %offset.idx
  %27 = bitcast double* %26 to <8 x double>*
  %wide.vec13 = load <8 x double>, <8 x double>* %27, align 8, !alias.scope !4, !noalias !1
  %28 = fsub <8 x double> %wide.vec13, %wide.vec
  ...
  %33 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv87, i64 %32
  ...
  br i1 %39, label %._crit_edge25.us.loopexit23, label %vector.body, !llvm.loop !6

._crit_edge119:                                   ; preds = %._crit_edge119.preheader, %._crit_edge119
  %indvars.iv85 = phi i64 [ %indvars.iv.next86.3, %._crit_edge119 ], [ 0, %._crit_edge119.preheader ]
  %40 = getelementptr inbounds double, double* %3, i64 %indvars.iv85
  %41 = load double, double* %40, align 8
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv87, i64 %indvars.iv85
  ...
  %47 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv87, i64 %indvars.iv.next86
  ...
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv87, i64 %indvars.iv.next86.1
  ...
  %57 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv87, i64 %indvars.iv.next86.2
  %58 = load double, double* %57, align 8
  %59 = fsub double %58, %56
  store double %59, double* %57, align 8
  %indvars.iv.next86.3 = add nuw nsw i64 %indvars.iv85, 4
  %exitcond104.3 = icmp eq i64 %indvars.iv.next86.3, 1200
  br i1 %exitcond104.3, label %._crit_edge25.us.loopexit, label %._crit_edge119, !llvm.loop !9

._crit_edge25.us.loopexit:                        ; preds = %._crit_edge119
  br label %._crit_edge25.us

._crit_edge25.us.loopexit23:                      ; preds = %vector.body
  br label %._crit_edge25.us

._crit_edge25.us:                                 ; preds = %._crit_edge25.us.loopexit23, %._crit_edge25.us.loopexit
  %exitcond105 = icmp eq i64 %23, 1400
  br i1 %exitcond105, label %.lr.ph15.split.us.preheader, label %vector.memcheck

.lr.ph15.split.us.preheader:                      ; preds = %._crit_edge25.us
  %60 = fadd double %0, -1.000000e+00
  br label %.lr.ph10.us

.lr.ph10.us:                                      ; preds = %._crit_edge11.us-lcssa.us.us, %.lr.ph15.split.us.preheader
  %indvars.iv71 = phi i64 [ 0, %.lr.ph15.split.us.preheader ], [ %indvars.iv.next72, %._crit_edge11.us-lcssa.us.us ]
  br label %.lr.ph.us.us

._crit_edge11.us-lcssa.us.us:                     ; preds = %._crit_edge.us.us
  %indvars.iv.next72 = add nuw nsw i64 %indvars.iv71, 1
  %exitcond101 = icmp eq i64 %indvars.iv.next72, 1200
  br i1 %exitcond101, label %._crit_edge16, label %.lr.ph10.us

.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph10.us
  %indvars.iv63 = phi i64 [ %indvars.iv71, %.lr.ph10.us ], [ %indvars.iv.next64, %._crit_edge.us.us ]
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv71, i64 %indvars.iv63
  store double 0.000000e+00, double* %61, align 8
  br label %._crit_edge120

._crit_edge.us.us:                                ; preds = %._crit_edge120
  %62 = fdiv double %76, %60
  store double %62, double* %61, align 8
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv63, i64 %indvars.iv71
  store double %62, double* %63, align 8
  %indvars.iv.next64 = add nuw nsw i64 %indvars.iv63, 1
  %exitcond100 = icmp eq i64 %indvars.iv.next64, 1200
  br i1 %exitcond100, label %._crit_edge11.us-lcssa.us.us, label %.lr.ph.us.us

._crit_edge120:                                   ; preds = %._crit_edge120, %.lr.ph.us.us
  %64 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %76, %._crit_edge120 ]
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %._crit_edge120 ]
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv71
  %66 = load double, double* %65, align 8
  %67 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv63
  %68 = load double, double* %67, align 8
  %69 = fmul double %66, %68
  %70 = fadd double %64, %69
  store double %70, double* %61, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv71
  %72 = load double, double* %71, align 8
  %73 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv63
  ...
  br i1 %exitcond.1, label %._crit_edge.us.us, label %._crit_edge120
...
.preheader.us:                                    ; preds = %._crit_edge.us, %.preheader.us.preheader
  ...
  %5 = mul nuw nsw i64 %indvars.iv9, 1200
...
._crit_edge13:                                    ; preds = %._crit_edge14, %10
  %12 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %13 = getelementptr inbounds [1200 x double], [1200 x double]* %0, i64 %indvars.iv9, i64 %indvars.iv
  %14 = load double, double* %13, align 8
