...
for.inc.lr.ph:                                    ; preds = %for.inc47, %entry
  ...
  %indvars.iv27 = phi i64 [ 1, %entry ], [ %indvars.iv.next28, %for.inc47 ]
...
for.inc32.prol:                                   ; preds = %for.inc32.lr.ph
  ...
  %sunkaddr36 = shl i64 %indvars.iv27, 3
...
vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert47 = insertelement <2 x double> undef, double %div, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec43 = load <4 x double>, <4 x double>* %44, align 8
  %strided.vec44 = shufflevector <4 x double> %wide.vec43, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %reverse = shufflevector <2 x double> %strided.vec44, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %strided.vec45 = shufflevector <4 x double> %wide.vec43, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %reverse46 = shufflevector <2 x double> %strided.vec45, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %45 = fmul <2 x double> %broadcast.splat48, %reverse46
  %46 = fadd <2 x double> %strided.vec, %45
  %47 = add nuw nsw i64 %offset.idx, 1
  %48 = fmul <2 x double> %broadcast.splat48, %reverse
  %49 = fadd <2 x double> %strided.vec42, %48
...
for.inc32:                                        ; preds = %for.inc32.preheader1, %for.inc32
  ...
  %exitcond20.1 = icmp eq i64 %indvars.iv.next15.1, %indvars.iv27
...
for.inc47:                                        ; preds = %for.inc47.loopexit, %middle.block, %for.inc32.prol.loopexit
  ...
  %exitcond31 = icmp eq i64 %indvars.iv.next28, 2000
  %indvar.next = add nuw nsw i64 %indvar, 1
  br i1 %exitcond31, label %for.end49, label %for.inc.lr.ph
