...
entry:
  br i1 true, label %for.body.lr.ph, label %for.end16

for.body.lr.ph:                                   ; preds = %entry
  br label %for.body

for.body:                                         ; preds = %for.inc14, %for.body.lr.ph
  %indvars.iv513 = phi i64 [ 1, %for.body.lr.ph ], [ %indvars.iv.next6, %for.inc14 ]
  %indvars.iv712 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next8, %for.inc14 ]
  %arrayidx = getelementptr inbounds double, double* %x, i64 %indvars.iv712
  store double -9.990000e+02, double* %arrayidx, align 8
  %0 = trunc i64 %indvars.iv712 to i32
  %conv = sitofp i32 %0 to double
  %arrayidx2 = getelementptr inbounds double, double* %b, i64 %indvars.iv712
  store double %conv, double* %arrayidx2, align 8
  %1 = add nuw nsw i64 %indvars.iv712, 1
  %2 = trunc i64 %1 to i32
  %sub = add i32 %2, 2000
  %3 = and i64 %indvars.iv712, 1
  %lcmp.mod = icmp eq i64 %3, 0
  br i1 %lcmp.mod, label %for.body6.prol.preheader, label %for.body6.prol.loopexit.unr-lcssa

for.body6.prol.preheader:                         ; preds = %for.body
  br label %for.body6.prol

for.body6.prol:                                   ; preds = %for.body6.prol.preheader
  %add7.prol = add i32 %2, 2000
  ...
  %arrayidx13.prol = getelementptr inbounds [2000 x double], [2000 x double]* %L, i64 %indvars.iv712, i64 0
  store double %div.prol, double* %arrayidx13.prol, align 8
  br label %for.body6.prol.loopexit.unr-lcssa

for.body6.prol.loopexit.unr-lcssa:                ; preds = %for.body, %for.body6.prol
  %indvars.iv10.unr.ph = phi i64 [ 1, %for.body6.prol ], [ 0, %for.body ]
  br label %for.body6.prol.loopexit

for.body6.prol.loopexit:                          ; preds = %for.body6.prol.loopexit.unr-lcssa
  %4 = icmp eq i64 %indvars.iv712, 0
  br i1 %4, label %for.inc14, label %for.body.new

for.body.new:                                     ; preds = %for.body6.prol.loopexit
  br label %for.body6

for.body6:                                        ; preds = %for.body6, %for.body.new
  %indvars.iv10 = phi i64 [ %indvars.iv10.unr.ph, %for.body.new ], [ %indvars.iv.next.1, %for.body6 ]
  %5 = sub nsw i64 0, %indvars.iv10
  %6 = trunc i64 %5 to i32
  %add7 = add i32 %sub, %6
  %conv8 = sitofp i32 %add7 to double
  %arrayidx13 = getelementptr inbounds [2000 x double], [2000 x double]* %L, i64 %indvars.iv712, i64 %indvars.iv10
  %7 = trunc i64 %indvars.iv10 to i32
  %8 = xor i32 %7, -1
  %add7.1 = add i32 %sub, %8
  ...
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, %indvars.iv513
...
for.inc14:                                        ; preds = %for.body6.prol.loopexit, %for.inc14.unr-lcssa
  ...
  %exitcond16 = icmp eq i64 %indvars.iv.next8, 2000
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv513, 1
  br i1 %exitcond16, label %for.end16.loopexit, label %for.body
...
entry:
  br i1 true, label %for.body.preheader, label %for.end24

for.body.preheader:                               ; preds = %entry
  br label %for.body

for.body:                                         ; preds = %for.body.preheader, %for.end
  %indvars.iv410 = phi i64 [ %indvars.iv.next5, %for.end ], [ 0, %for.body.preheader ]
  %arrayidx = getelementptr inbounds double, double* %b, i64 %indvars.iv410
  %0 = bitcast double* %arrayidx to i64*
  %1 = load i64, i64* %0, align 8
  %arrayidx2 = getelementptr inbounds double, double* %x, i64 %indvars.iv410
  %2 = bitcast double* %arrayidx2 to i64*
  store i64 %1, i64* %2, align 8
  %3 = bitcast i64 %1 to double
  %exitcond6 = icmp eq i64 %indvars.iv410, 0
  br i1 %exitcond6, label %for.end, label %for.body5.preheader

for.body5.preheader:                              ; preds = %for.body
  %xtraiter = and i64 %indvars.iv410, 1
...
for.body5.prol:                                   ; preds = %for.body5.prol.preheader
  %arrayidx9.prol = getelementptr inbounds [2000 x double], [2000 x double]* %L, i64 %indvars.iv410, i64 0
...
for.body5.prol.loopexit.unr-lcssa:                ; preds = %for.body5.preheader, %for.body5.prol
  ...
  %indvars.iv7.unr.ph = phi i64 [ 1, %for.body5.prol ], [ 0, %for.body5.preheader ]
  br label %for.body5.prol.loopexit

for.body5.prol.loopexit:                          ; preds = %for.body5.prol.loopexit.unr-lcssa
  %6 = icmp eq i64 %indvars.iv410, 1
  br i1 %6, label %for.end.loopexit, label %for.body5.preheader.new

for.body5.preheader.new:                          ; preds = %for.body5.prol.loopexit
  br label %for.body5

for.body5:                                        ; preds = %for.body5, %for.body5.preheader.new
  %7 = phi double [ %.unr.ph, %for.body5.preheader.new ], [ %sub.1, %for.body5 ]
  %indvars.iv7 = phi i64 [ %indvars.iv7.unr.ph, %for.body5.preheader.new ], [ %indvars.iv.next.1, %for.body5 ]
  %arrayidx9 = getelementptr inbounds [2000 x double], [2000 x double]* %L, i64 %indvars.iv410, i64 %indvars.iv7
  %8 = load double, double* %arrayidx9, align 8
  %arrayidx11 = getelementptr inbounds double, double* %x, i64 %indvars.iv7
  ...
  %arrayidx9.1 = getelementptr inbounds [2000 x double], [2000 x double]* %L, i64 %indvars.iv410, i64 %indvars.iv.next
...
for.end:                                          ; preds = %for.end.loopexit, %for.body
  ...
  %arrayidx19 = getelementptr inbounds [2000 x double], [2000 x double]* %L, i64 %indvars.iv410, i64 %indvars.iv410
  %12 = load double, double* %arrayidx19, align 8
  %div = fdiv double %.lcssa, %12
  store double %div, double* %arrayidx2, align 8
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv410, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next5, 2000
  br i1 %exitcond15, label %for.end24.loopexit, label %for.body
