...
.lr.ph37.split.preheader:                         ; preds = %.lr.ph37..lr.ph37.split.preheader_crit_edge, %._crit_edge
  ...
  br i1 %min.iters.check, label %.lr.ph37.split.preheader109, label %min.iters.checked

.lr.ph37.split.preheader109:                      ; preds = %middle.block, %min.iters.checked, %.lr.ph37.split.preheader
...
min.iters.checked:                                ; preds = %.lr.ph37.split.preheader
  ...
  br i1 %cmp.zero, label %.lr.ph37.split.preheader109, label %vector.body.preheader
...
middle.block:                                     ; preds = %vector.body.prol.loopexit, %middle.block.unr-lcssa
  ...
  br i1 %cmp.n, label %._crit_edge38, label %.lr.ph37.split.preheader109
...
.prol.loopexit.unr-lcssa:                         ; preds = %.lr.ph37.split.us, %35
  %.lcssa116.unr.ph = phi double [ %40, %35 ], [ undef, %.lr.ph37.split.us ]
...
._crit_edge33.us:                                 ; preds = %.prol.loopexit, %._crit_edge33.us.unr-lcssa
  %.lcssa116 = phi double [ %.lcssa116.unr.ph, %.prol.loopexit ], [ %55, %._crit_edge33.us.unr-lcssa ]
...
.lr.ph24.preheader:                               ; preds = %.lr.ph28
  ...
  br i1 %lcmp.mod121, label %.lr.ph24.prol.preheader, label %.lr.ph24.prol.loopexit.unr-lcssa
...
.lr.ph24.prol.loopexit.unr-lcssa:                 ; preds = %.lr.ph24.preheader, %.lr.ph24.prol
  %.lcssa115.unr.ph = phi double [ %67, %.lr.ph24.prol ], [ undef, %.lr.ph24.preheader ]
...
._crit_edge25.loopexit:                           ; preds = %.lr.ph24.prol.loopexit, %._crit_edge25.loopexit.unr-lcssa
  %.lcssa115 = phi double [ %.lcssa115.unr.ph, %.lr.ph24.prol.loopexit ], [ %82, %._crit_edge25.loopexit.unr-lcssa ]
  br label %._crit_edge25

._crit_edge25:                                    ; preds = %._crit_edge25.loopexit, %.lr.ph28
  %.0.lcssa = phi double [ %60, %.lr.ph28 ], [ %.lcssa115, %._crit_edge25.loopexit ]
...
.lr.ph37.split:                                   ; preds = %.lr.ph37.split.preheader109, %.lr.ph37.split
  %indvars.iv75 = phi i64 [ %indvars.iv.next76, %.lr.ph37.split ], [ %indvars.iv75.ph, %.lr.ph37.split.preheader109 ]
  %exitcond77 = icmp eq i64 %indvars.iv75, 1999
  %indvars.iv.next76 = add nuw i64 %indvars.iv75, 1
  br i1 %exitcond77, label %._crit_edge38.loopexit110, label %.lr.ph37.split, !llvm.loop !21

._crit_edge38.loopexit:                           ; preds = %._crit_edge33.us
  br label %._crit_edge38

._crit_edge38.loopexit110:                        ; preds = %.lr.ph37.split
  br label %._crit_edge38

._crit_edge38:                                    ; preds = %._crit_edge38.loopexit110, %._crit_edge38.loopexit, %middle.block
...
.lr.ph16.preheader:                               ; preds = %._crit_edge1
  ...
  br i1 %lcmp.mod118, label %.lr.ph16.prol.loopexit, label %.lr.ph16.prol.preheader
...
.lr.ph16.prol:                                    ; preds = %.lr.ph16.prol, %.lr.ph16.prol.preheader
  ...
  %prol.iter119 = phi i64 [ %prol.iter119.sub, %.lr.ph16.prol ], [ %xtraiter117, %.lr.ph16.prol.preheader ]
  ...
  br i1 %prol.iter119.cmp, label %.lr.ph16.prol.loopexit.unr-lcssa, label %.lr.ph16.prol, !llvm.loop !23
...
.lr.ph16.prol.loopexit:                           ; preds = %.lr.ph16.preheader, %.lr.ph16.prol.loopexit.unr-lcssa
  %.lcssa114.unr = phi double [ undef, %.lr.ph16.preheader ], [ %98, %.lr.ph16.prol.loopexit.unr-lcssa ]
...
._crit_edge17.loopexit:                           ; preds = %.lr.ph16.prol.loopexit, %._crit_edge17.loopexit.unr-lcssa
  %.lcssa114 = phi double [ %.lcssa114.unr, %.lr.ph16.prol.loopexit ], [ %121, %._crit_edge17.loopexit.unr-lcssa ]
  br label %._crit_edge17

._crit_edge17:                                    ; preds = %._crit_edge17.loopexit, %._crit_edge1
  %.2.lcssa = phi double [ %91, %._crit_edge1 ], [ %.lcssa114, %._crit_edge17.loopexit ]
