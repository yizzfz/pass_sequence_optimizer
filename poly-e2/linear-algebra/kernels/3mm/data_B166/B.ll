...
for.body3.us.us.preheader:                        ; preds = %for.cond1.for.inc24_crit_edge.us.for.body3.us.us.preheader_crit_edge, %for.cond1.preheader.us.preheader
  %indvar178 = phi i64 [ 0, %for.cond1.preheader.us.preheader ], [ %indvar.next179, %for.cond1.for.inc24_crit_edge.us.for.body3.us.us.preheader_crit_edge ]
  ...
  %sext193 = shl i64 %inc25102.us, 32
  %idxprom.us = ashr exact i64 %sext193, 32
  br label %for.body3.us.us

for.cond1.for.inc24_crit_edge.us:                 ; preds = %for.cond6.for.inc21_crit_edge.us.us
  %indvar.next179 = add nuw nsw i64 %indvar178, 1
  %exitcond190 = icmp eq i64 %indvar.next179, 800
  br i1 %exitcond190, label %for.body32.us.us.preheader.preheader, label %for.cond1.for.inc24_crit_edge.us.for.body3.us.us.preheader_crit_edge
...
for.body8.us.us:                                  ; preds = %for.body8.us.us, %for.body3.us.us
  %indvars.iv182 = phi i64 [ 0, %for.body3.us.us ], [ %indvars.iv.next183.1, %for.body8.us.us ]
  %0 = phi double [ 0.000000e+00, %for.body3.us.us ], [ %add.us.us.1, %for.body8.us.us ]
  %arrayidx12.us.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %idxprom.us, i64 %indvars.iv182
  %1 = load double, double* %arrayidx12.us.us, align 8
  %arrayidx16.us.us = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv182, i64 %indvars.iv5
  ...
  %arrayidx12.us.us.1 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %idxprom.us, i64 %indvars.iv.next183
  %3 = load double, double* %arrayidx12.us.us.1, align 8
  %arrayidx16.us.us.1 = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv.next183, i64 %indvars.iv5
  ...
  br i1 %exitcond185.1, label %for.cond6.for.inc21_crit_edge.us.us, label %for.body8.us.us
...
for.body32.us.us.preheader:                       ; preds = %for.body32.us.us.preheader.preheader, %for.cond30.for.inc60_crit_edge.us.for.body32.us.us.preheader_crit_edge
  ...
  %sext192 = shl i64 %inc6158.us, 32
  %idxprom33.us = ashr exact i64 %sext192, 32
...
for.cond30.for.inc60_crit_edge.us:                ; preds = %for.cond37.for.inc57_crit_edge.us.us
  ...
  %exitcond172 = icmp eq i64 %indvar.next161, 900
  br i1 %exitcond172, label %for.body68.us.us.preheader.preheader, label %for.cond30.for.inc60_crit_edge.us.for.body32.us.us.preheader_crit_edge
...
for.body39.us.us:                                 ; preds = %for.body39.us.us, %for.body32.us.us
  %indvars.iv164 = phi i64 [ 0, %for.body32.us.us ], [ %indvars.iv.next165.1, %for.body39.us.us ]
  ...
  %arrayidx47.us.us = getelementptr inbounds [1100 x double], [1100 x double]* %D, i64 %indvars.iv164, i64 %indvars.iv3
  ...
  %arrayidx47.us.us.1 = getelementptr inbounds [1100 x double], [1100 x double]* %D, i64 %indvars.iv.next165, i64 %indvars.iv3
  ...
  br i1 %exitcond167.1, label %for.cond37.for.inc57_crit_edge.us.us, label %for.body39.us.us
