...
entry:
  ...
  tail call fastcc void @init_array([1200 x double]* %arraydecay1, [1200 x double]* %arraydecay42, [1200 x double]* %arraydecay53, double* %arraydecay64)
  tail call void (...) @polybench_timer_start() #4
  tail call fastcc void @kernel_fdtd_2d([1200 x double]* %arraydecay1, [1200 x double]* %arraydecay42, [1200 x double]* %arraydecay53, double* %arraydecay64)
...
for.cond5.for.inc39_crit_edge.us:                 ; preds = %for.inc36.us
  ...
  %cmp2.us = icmp slt i64 %indvars.iv.next19, 1000
...
for.inc31.us:                                     ; preds = %for.inc31.us, %for.inc31.us.preheader
  %indvars.iv51 = phi i64 [ 0, %for.inc31.us.preheader ], [ %indvars.iv.next52.1, %for.inc31.us ]
...
for.cond10.for.inc34_crit_edge.us:                ; preds = %for.cond10.for.inc34_crit_edge.us.loopexit112, %for.cond10.for.inc34_crit_edge.us.loopexit
  ...
  %exitcond71 = icmp eq i64 %indvars.iv.next54, 1000
  br i1 %exitcond71, label %for.cond40.preheader.us.preheader, label %for.cond10.preheader.us
...
for.cond40.preheader.us:                          ; preds = %for.cond40.preheader.us.preheader, %for.cond40.for.inc66_crit_edge.us
  %indvars.iv59 = phi i64 [ %38, %for.cond40.for.inc66_crit_edge.us ], [ 0, %for.cond40.preheader.us.preheader ]
...
for.inc63.us.preheader.new:                       ; preds = %for.inc63.us.preheader.new.loopexit, %for.cond40.preheader.us
  %indvars.iv56.ph = phi i64 [ 1, %for.cond40.preheader.us ], [ 1197, %for.inc63.us.preheader.new.loopexit ]
...
for.inc63.us:                                     ; preds = %for.inc63.us, %for.inc63.us.preheader.new
  %indvars.iv56 = phi i64 [ %indvars.iv.next57.prol, %for.inc63.us.preheader.new ], [ %indvars.iv.next57.1, %for.inc63.us ]
  ...
  %exitcond72.1 = icmp eq i64 %indvars.iv.next57.1, 1200
  br i1 %exitcond72.1, label %for.cond40.for.inc66_crit_edge.us, label %for.inc63.us, !llvm.loop !16
...
for.cond73.preheader.us:                          ; preds = %for.cond73.preheader.us.preheader, %for.cond73.for.inc110_crit_edge.us
  %indvars.iv64 = phi i64 [ %70, %for.cond73.for.inc110_crit_edge.us ], [ 0, %for.cond73.preheader.us.preheader ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv64, i64 0
  %scevgep2 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv64, i64 1199
  %scevgep4 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv64, i64 0
  %70 = add i64 %indvars.iv64, 1
  %scevgep6 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %70, i64 0
  %scevgep8 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %indvars.iv64, i64 0
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv64, i64 %index
  ...
  %75 = or i64 %index, 1
  %76 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv64, i64 %75
  ...
  %80 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv64, i64 %index
  ...
  %92 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv64, i64 %index
...
for.inc107.us:                                    ; preds = %for.inc107.us.preheader, %for.inc107.us
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc107.us ], [ %indvars.iv61.ph, %for.inc107.us.preheader ]
  %arrayidx80.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv64, i64 %indvars.iv61
  %103 = load double, double* %arrayidx80.us, align 8
  %indvars.iv.next62 = add nuw nsw i64 %indvars.iv61, 1
  %arrayidx84.us = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv64, i64 %indvars.iv.next62
  %104 = load double, double* %arrayidx84.us, align 8
  %arrayidx88.us = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv64, i64 %indvars.iv61
  ...
  %arrayidx99.us = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv64, i64 %indvars.iv61
  ...
  %cmp75.us = icmp slt i64 %indvars.iv.next62, 1199
...
for.inc.us:                                       ; preds = %for.body4.us, %if.then.us
  ...
  %arrayidx8.us = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv68, i64 %indvars.iv54
  %8 = load double, double* %arrayidx8.us, align 8
  %call9.us = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %7, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i64 0, i64 0), double %8) #6
  %indvars.iv.next55 = add nuw nsw i64 %indvars.iv54, 1
  %cmp3.us = icmp slt i64 %indvars.iv.next55, 1200
  br i1 %cmp3.us, label %for.body4.us, label %for.cond2.for.inc10_crit_edge.us

for.cond2.for.inc10_crit_edge.us:                 ; preds = %for.inc.us
  %indvars.iv.next69 = add nsw i64 %indvars.iv68, 1
  %cmp.us = icmp slt i64 %indvars.iv.next69, 1000
...
for.inc34.us:                                     ; preds = %for.body21.us, %if.then26.us
  ...
  %arrayidx32.us = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv64, i64 %indvars.iv48
...
for.cond19.for.inc37_crit_edge.us:                ; preds = %for.inc34.us
  ...
  %cmp17.us = icmp slt i64 %indvars.iv.next65, 1000
...
for.cond45.preheader.us:                          ; preds = %for.cond45.for.inc63_crit_edge.us, %for.end39
  %indvars.iv60 = phi i64 [ 0, %for.end39 ], [ %indvars.iv.next61, %for.cond45.for.inc63_crit_edge.us ]
  %21 = mul nsw i64 %indvars.iv60, 1000
...
for.inc60.us:                                     ; preds = %for.body47.us, %if.then52.us
  ...
  %arrayidx58.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv60, i64 %indvars.iv
...
for.cond45.for.inc63_crit_edge.us:                ; preds = %for.inc60.us
  ...
  %cmp43.us = icmp slt i64 %indvars.iv.next61, 1000
