...
.lr.ph20.split.preheader:                         ; preds = %.lr.ph20
  br i1 %lcmp.mod122, label %.lr.ph20.split.prol.loopexit, label %.lr.ph20.split.prol.preheader
...
.lr.ph20.split.prol.loopexit:                     ; preds = %.lr.ph20.split.preheader, %.lr.ph20.split.prol.loopexit.unr-lcssa
  ...
  br i1 %19, label %._crit_edge21.loopexit118, label %.lr.ph20.split.preheader.new
...
.lr.ph16.us:                                      ; preds = %.lr.ph16.us.preheader117, %.lr.ph16.us
  ...
  %27 = icmp slt i64 %indvars.iv.next69, %10
...
._crit_edge21:                                    ; preds = %._crit_edge21.loopexit118, %._crit_edge21.loopexit, %20
  %indvars.iv.next73 = add nuw nsw i64 %indvars.iv72, 1
  %exitcond120 = icmp eq i64 %indvars.iv.next73, %12
  br i1 %exitcond120, label %._crit_edge40.loopexit, label %20
