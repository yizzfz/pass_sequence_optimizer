...
@__llvm_prf_nm = private constant [108 x i8] c"\C8\01ix\DA}\8EK\0A\850\0CEqC\82S7\13b\89XMcL\D2\FD[\07*\C8\E3M\CF\E1~\D6,9 \8B\D6\80\B4K\D8\CEL\D6E\D1\A1g\1E\1B\F2Z\08\0A\DAF\E6\0F7r\FA\13\F3@\BB\B5\A2\BF\B9\B9\CD\F9\F2\CB\5C?22\B4\DE\AA\0FU2\F0\84\F2\C1\8C\91\168*J@\E0\C4\E4'm\AAM\05", section "__llvm_prf_names"
@llvm.used = appending global [10 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jinit_input_controller to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_consume_markers to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_reset_input_controller to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_start_input_pass to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_finish_input_pass to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_initial_setup to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_per_scan_setup to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_latch_quant_tables to i8*), i8* bitcast ([16 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([108 x i8], [108 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
