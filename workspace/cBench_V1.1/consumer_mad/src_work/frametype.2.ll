...
@__llvm_prf_nm = private constant [43 x i8] c"!)x\DA\CBL1\8EO+J\CCM-\A9,H\8D\CF\C9\CF\CF.-`,\C9-0\D4\CB\C9\B1\CAH,\CE\00\00\D8\FD\0C\8D", section "__llvm_prf_names"
@llvm.used = appending global [3 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_id3_frametype_lookup to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_hash to i8*), i8* getelementptr inbounds ([43 x i8], [43 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
