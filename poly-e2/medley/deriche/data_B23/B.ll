...
for.cond1.preheader.us:                           ; preds = %for.inc7.loopexit.us, %for.cond1.preheader.us.preheader
  %indvars.iv9 = phi i64 [ 0, %for.cond1.preheader.us.preheader ], [ %indvars.iv.next10, %for.inc7.loopexit.us ]
  %3 = mul nsw i64 %indvars.iv9, 313
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %10 = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv9, i64 %index
...
middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %for.inc7.loopexit.us, label %for.body3.us.preheader
...
for.body3.us:                                     ; preds = %for.body3.us.preheader, %for.body3.us
  ...
  %arrayidx6.us = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv9, i64 %indvars.iv
  store float %div.us, float* %arrayidx6.us, align 4
  %exitcond = icmp eq i64 %indvars.iv, %wide.trip.count
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br i1 %exitcond, label %for.inc7.loopexit.us.loopexit, label %for.body3.us, !llvm.loop !4

for.inc7.loopexit.us.loopexit:                    ; preds = %for.body3.us
  br label %for.inc7.loopexit.us

for.inc7.loopexit.us:                             ; preds = %for.inc7.loopexit.us.loopexit, %middle.block
  %indvars.iv.next10 = add nuw i64 %indvars.iv9, 1
  %cmp.us = icmp slt i64 %indvars.iv.next10, %1
  br i1 %cmp.us, label %for.cond1.preheader.us, label %for.end9.loopexit

for.end9.loopexit:                                ; preds = %for.inc7.loopexit.us
  br label %for.end9
...
for.cond31.preheader.us:                          ; preds = %for.inc55.loopexit.us, %for.cond31.preheader.us.preheader
  %indvars.iv78 = phi i64 [ 0, %for.cond31.preheader.us.preheader ], [ %indvars.iv.next79, %for.inc55.loopexit.us ]
  ...
  br i1 %exitcond77149, label %for.inc55.loopexit.us, label %for.body33.us.for.body33.us_crit_edge.preheader

for.body33.us.for.body33.us_crit_edge.preheader:  ; preds = %for.cond31.preheader.us
  br i1 %lcmp.mod228, label %for.body33.us.for.body33.us_crit_edge.prol.loopexit.unr-lcssa, label %for.body33.us.for.body33.us_crit_edge.prol.preheader
...
for.body33.us.for.body33.us_crit_edge.prol.loopexit: ; preds = %for.body33.us.for.body33.us_crit_edge.prol.loopexit.unr-lcssa
  br i1 %4, label %for.inc55.loopexit.us.loopexit, label %for.body33.us.for.body33.us_crit_edge.preheader.new
...
for.body33.us.for.body33.us_crit_edge:            ; preds = %for.body33.us.for.body33.us_crit_edge, %for.body33.us.for.body33.us_crit_edge.preheader.new
  ...
  br i1 %exitcond77.1, label %for.inc55.loopexit.us.loopexit.unr-lcssa, label %for.body33.us.for.body33.us_crit_edge

for.inc55.loopexit.us.loopexit.unr-lcssa:         ; preds = %for.body33.us.for.body33.us_crit_edge
  br label %for.inc55.loopexit.us.loopexit

for.inc55.loopexit.us.loopexit:                   ; preds = %for.body33.us.for.body33.us_crit_edge.prol.loopexit, %for.inc55.loopexit.us.loopexit.unr-lcssa
  br label %for.inc55.loopexit.us

for.inc55.loopexit.us:                            ; preds = %for.inc55.loopexit.us.loopexit, %for.cond31.preheader.us
...
for.cond62.preheader.us.preheader:                ; preds = %for.inc55.loopexit.us
...
for.cond62.preheader.us:                          ; preds = %for.inc86.loopexit.us, %for.cond62.preheader.us.preheader
  %indvars.iv71 = phi i64 [ 0, %for.cond62.preheader.us.preheader ], [ %indvars.iv.next72, %for.inc86.loopexit.us ]
  ...
  br i1 %cmp63.us135, label %for.body64.us.for.body64.us_crit_edge.preheader, label %for.inc86.loopexit.us

for.body64.us.for.body64.us_crit_edge.preheader:  ; preds = %for.cond62.preheader.us
  br i1 %lcmp.mod226, label %for.body64.us.for.body64.us_crit_edge.prol.preheader, label %for.body64.us.for.body64.us_crit_edge.prol.loopexit.unr-lcssa
...
for.body64.us.for.body64.us_crit_edge.prol.loopexit: ; preds = %for.body64.us.for.body64.us_crit_edge.prol.loopexit.unr-lcssa
  br i1 %14, label %for.inc86.loopexit.us.loopexit, label %for.body64.us.for.body64.us_crit_edge.preheader.new
...
for.body64.us.for.body64.us_crit_edge:            ; preds = %for.body64.us.for.body64.us_crit_edge, %for.body64.us.for.body64.us_crit_edge.preheader.new
  ...
  br i1 %cmp63.us.1, label %for.body64.us.for.body64.us_crit_edge, label %for.inc86.loopexit.us.loopexit.unr-lcssa

for.inc86.loopexit.us.loopexit.unr-lcssa:         ; preds = %for.body64.us.for.body64.us_crit_edge
  br label %for.inc86.loopexit.us.loopexit

for.inc86.loopexit.us.loopexit:                   ; preds = %for.body64.us.for.body64.us_crit_edge.prol.loopexit, %for.inc86.loopexit.us.loopexit.unr-lcssa
  br label %for.inc86.loopexit.us

for.inc86.loopexit.us:                            ; preds = %for.inc86.loopexit.us.loopexit, %for.cond62.preheader.us
...
for.cond92.preheader.us.preheader:                ; preds = %for.inc86.loopexit.us
...
for.cond92.preheader.us:                          ; preds = %for.inc112.loopexit.us, %for.cond92.preheader.us.preheader
  %indvars.iv66 = phi i64 [ 0, %for.cond92.preheader.us.preheader ], [ %indvars.iv.next67, %for.inc112.loopexit.us ]
...
vector.body.preheader:                            ; preds = %vector.memcheck
  br i1 %lcmp.mod222, label %vector.body.prol.preheader, label %vector.body.prol.loopexit.unr-lcssa
...
middle.block:                                     ; preds = %vector.body.prol.loopexit, %middle.block.unr-lcssa
  br i1 %cmp.n, label %for.inc112.loopexit.us, label %for.body94.us.preheader
...
for.body94.us.preheader:                          ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.cond92.preheader.us
  ...
  br i1 %lcmp.mod224, label %for.body94.us.prol.loopexit.unr-lcssa, label %for.body94.us.prol.preheader
...
for.body94.us.prol.loopexit:                      ; preds = %for.body94.us.prol.loopexit.unr-lcssa
  ...
  br i1 %71, label %for.inc112.loopexit.us.loopexit, label %for.body94.us.preheader.new
...
for.body94.us:                                    ; preds = %for.body94.us, %for.body94.us.preheader.new
  ...
  br i1 %exitcond65.1, label %for.inc112.loopexit.us.loopexit.unr-lcssa, label %for.body94.us, !llvm.loop !15

for.inc112.loopexit.us.loopexit.unr-lcssa:        ; preds = %for.body94.us
  br label %for.inc112.loopexit.us.loopexit

for.inc112.loopexit.us.loopexit:                  ; preds = %for.body94.us.prol.loopexit, %for.inc112.loopexit.us.loopexit.unr-lcssa
  br label %for.inc112.loopexit.us

for.inc112.loopexit.us:                           ; preds = %for.inc112.loopexit.us.loopexit, %middle.block
...
for.cond115.preheader.loopexit:                   ; preds = %for.inc112.loopexit.us
...
for.cond118.preheader.us.preheader:               ; preds = %for.cond118.preheader.lr.ph
  ...
  %exitcond58121 = icmp eq i32 %76, 0
...
for.cond118.preheader.us:                         ; preds = %for.inc147.loopexit.us, %for.cond118.preheader.us.preheader
  %indvars.iv59 = phi i64 [ 0, %for.cond118.preheader.us.preheader ], [ %indvars.iv.next60, %for.inc147.loopexit.us ]
  %arrayidx124.us112 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 0, i64 %indvars.iv59
  %79 = load float, float* %arrayidx124.us112, align 4
  %mul125.us113 = fmul float %div, %79
  ...
  br i1 %exitcond58121, label %for.inc147.loopexit.us, label %for.body120.us.for.body120.us_crit_edge.preheader

for.body120.us.for.body120.us_crit_edge.preheader: ; preds = %for.cond118.preheader.us
  br i1 %lcmp.mod220, label %for.body120.us.for.body120.us_crit_edge.prol.loopexit.unr-lcssa, label %for.body120.us.for.body120.us_crit_edge.prol.preheader
...
for.body120.us.for.body120.us_crit_edge.prol.loopexit: ; preds = %for.body120.us.for.body120.us_crit_edge.prol.loopexit.unr-lcssa
  br i1 %78, label %for.inc147.loopexit.us.loopexit, label %for.body120.us.for.body120.us_crit_edge.preheader.new
...
for.body120.us.for.body120.us_crit_edge:          ; preds = %for.body120.us.for.body120.us_crit_edge, %for.body120.us.for.body120.us_crit_edge.preheader.new
  ...
  %82 = load float, float* %arrayidx124.us124, align 4
  ...
  br i1 %exitcond58.1, label %for.inc147.loopexit.us.loopexit.unr-lcssa, label %for.body120.us.for.body120.us_crit_edge

for.inc147.loopexit.us.loopexit.unr-lcssa:        ; preds = %for.body120.us.for.body120.us_crit_edge
  br label %for.inc147.loopexit.us.loopexit

for.inc147.loopexit.us.loopexit:                  ; preds = %for.body120.us.for.body120.us_crit_edge.prol.loopexit, %for.inc147.loopexit.us.loopexit.unr-lcssa
  br label %for.inc147.loopexit.us

for.inc147.loopexit.us:                           ; preds = %for.inc147.loopexit.us.loopexit, %for.cond118.preheader.us
  %indvars.iv.next60 = add nuw i64 %indvars.iv59, 1
  %cmp116.us = icmp slt i64 %indvars.iv.next60, %77
  br i1 %cmp116.us, label %for.cond118.preheader.us, label %for.cond154.preheader.us.preheader

for.cond154.preheader.us.preheader:               ; preds = %for.inc147.loopexit.us
  %86 = sext i32 %w to i64
  %indvars.iv.next5198 = add nsw i64 %86, -1
  ...
  %87 = and i64 %86, 1
  %lcmp.mod218 = icmp eq i64 %87, 0
  %indvars.iv.next51.prol = add nsw i64 %86, -2
...
for.cond154.preheader.us:                         ; preds = %for.inc179.loopexit.us, %for.cond154.preheader.us.preheader
  %indvars.iv52 = phi i64 [ 0, %for.cond154.preheader.us.preheader ], [ %indvars.iv.next53, %for.inc179.loopexit.us ]
  ...
  br i1 %cmp155.us107, label %for.body156.us.for.body156.us_crit_edge.preheader, label %for.inc179.loopexit.us

for.body156.us.for.body156.us_crit_edge.preheader: ; preds = %for.cond154.preheader.us
  br i1 %lcmp.mod218, label %for.body156.us.for.body156.us_crit_edge.prol.preheader, label %for.body156.us.for.body156.us_crit_edge.prol.loopexit.unr-lcssa
...
for.body156.us.for.body156.us_crit_edge.prol.loopexit.unr-lcssa: ; preds = %for.body156.us.for.body156.us_crit_edge.preheader, %for.body156.us.for.body156.us_crit_edge.prol
  ...
  %tp1.07.us109.unr.ph = phi float [ %89, %for.body156.us.for.body156.us_crit_edge.prol ], [ 0.000000e+00, %for.body156.us.for.body156.us_crit_edge.preheader ]
...
for.body156.us.for.body156.us_crit_edge.prol.loopexit: ; preds = %for.body156.us.for.body156.us_crit_edge.prol.loopexit.unr-lcssa
  br i1 %88, label %for.inc179.loopexit.us.loopexit, label %for.body156.us.for.body156.us_crit_edge.preheader.new
...
for.body156.us.for.body156.us_crit_edge:          ; preds = %for.body156.us.for.body156.us_crit_edge, %for.body156.us.for.body156.us_crit_edge.preheader.new
  ...
  %tp1.07.us109 = phi float [ %tp1.07.us109.unr.ph, %for.body156.us.for.body156.us_crit_edge.preheader.new ], [ %91, %for.body156.us.for.body156.us_crit_edge ]
  ...
  br i1 %cmp155.us.1, label %for.body156.us.for.body156.us_crit_edge, label %for.inc179.loopexit.us.loopexit.unr-lcssa

for.inc179.loopexit.us.loopexit.unr-lcssa:        ; preds = %for.body156.us.for.body156.us_crit_edge
  br label %for.inc179.loopexit.us.loopexit

for.inc179.loopexit.us.loopexit:                  ; preds = %for.body156.us.for.body156.us_crit_edge.prol.loopexit, %for.inc179.loopexit.us.loopexit.unr-lcssa
  br label %for.inc179.loopexit.us

for.inc179.loopexit.us:                           ; preds = %for.inc179.loopexit.us.loopexit, %for.cond154.preheader.us
  %indvars.iv.next53 = add nuw i64 %indvars.iv52, 1
  %cmp151.us = icmp slt i64 %indvars.iv.next53, %77
  br i1 %cmp151.us, label %for.cond154.preheader.us, label %for.cond182.preheader.loopexit

for.cond182.preheader.loopexit:                   ; preds = %for.inc179.loopexit.us
...
for.cond185.preheader.us.preheader:               ; preds = %for.cond182.preheader
  ...
  %min.iters.check175 = icmp ult i64 %94, 8
  %n.vec178 = and i64 %94, 8589934584
  %cmp.zero179 = icmp eq i64 %n.vec178, 0
  %99 = and i64 %97, 1
  %lcmp.mod = icmp eq i64 %99, 0
  %100 = icmp eq i64 %97, 0
  %cmp.n206 = icmp eq i64 %94, %n.vec178
  br label %for.cond185.preheader.us

for.cond185.preheader.us:                         ; preds = %for.inc205.loopexit.us, %for.cond185.preheader.us.preheader
  %indvars.iv47 = phi i64 [ 0, %for.cond185.preheader.us.preheader ], [ %indvars.iv.next48, %for.inc205.loopexit.us ]
  %scevgep181 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv47, i64 0
  %scevgep183 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv47, i64 %94
  %scevgep185 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv47, i64 0
  %scevgep187 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv47, i64 %94
  %scevgep189 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 0
  %scevgep191 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 %94
  br i1 %min.iters.check175, label %for.body187.us.preheader, label %min.iters.checked176

min.iters.checked176:                             ; preds = %for.cond185.preheader.us
  br i1 %cmp.zero179, label %for.body187.us.preheader, label %vector.memcheck201
...
vector.body172.preheader:                         ; preds = %vector.memcheck201
  br i1 %lcmp.mod, label %vector.body172.prol.preheader, label %vector.body172.prol.loopexit.unr-lcssa
...
vector.body172.prol:                              ; preds = %vector.body172.prol.preheader
  %101 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv47, i64 0
  %102 = bitcast float* %101 to <4 x float>*
  %wide.load211.prol = load <4 x float>, <4 x float>* %102, align 4, !alias.scope !16
  %103 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv47, i64 4
  %104 = bitcast float* %103 to <4 x float>*
  %wide.load212.prol = load <4 x float>, <4 x float>* %104, align 4, !alias.scope !16
  %105 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 0
  %106 = bitcast float* %105 to <4 x float>*
  %wide.load213.prol = load <4 x float>, <4 x float>* %106, align 4, !alias.scope !19
  %107 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 4
  %108 = bitcast float* %107 to <4 x float>*
  %wide.load214.prol = load <4 x float>, <4 x float>* %108, align 4, !alias.scope !19
  %109 = fadd <4 x float> %wide.load211.prol, %wide.load213.prol
  %110 = fadd <4 x float> %wide.load212.prol, %wide.load214.prol
  %111 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv47, i64 0
  %112 = bitcast float* %111 to <4 x float>*
  store <4 x float> %109, <4 x float>* %112, align 4, !alias.scope !21, !noalias !23
  %113 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv47, i64 4
...
vector.body172.prol.loopexit:                     ; preds = %vector.body172.prol.loopexit.unr-lcssa
  br i1 %100, label %middle.block173, label %vector.body172.preheader.new
...
vector.body172:                                   ; preds = %vector.body172, %vector.body172.preheader.new
  ...
  %115 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv47, i64 %index203
  %116 = bitcast float* %115 to <4 x float>*
  %wide.load211 = load <4 x float>, <4 x float>* %116, align 4, !alias.scope !16
  %117 = getelementptr float, float* %115, i64 4
  %118 = bitcast float* %117 to <4 x float>*
  %wide.load212 = load <4 x float>, <4 x float>* %118, align 4, !alias.scope !16
  %119 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 %index203
  %120 = bitcast float* %119 to <4 x float>*
  %wide.load213 = load <4 x float>, <4 x float>* %120, align 4, !alias.scope !19
  %121 = getelementptr float, float* %119, i64 4
  %122 = bitcast float* %121 to <4 x float>*
  %wide.load214 = load <4 x float>, <4 x float>* %122, align 4, !alias.scope !19
  %123 = fadd <4 x float> %wide.load211, %wide.load213
  %124 = fadd <4 x float> %wide.load212, %wide.load214
  %125 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv47, i64 %index203
  ...
  %129 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv47, i64 %index.next204
  %130 = bitcast float* %129 to <4 x float>*
  %wide.load211.1 = load <4 x float>, <4 x float>* %130, align 4, !alias.scope !16
  %131 = getelementptr float, float* %129, i64 4
  %132 = bitcast float* %131 to <4 x float>*
  %wide.load212.1 = load <4 x float>, <4 x float>* %132, align 4, !alias.scope !16
  %133 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv47, i64 %index.next204
  %134 = bitcast float* %133 to <4 x float>*
  %wide.load213.1 = load <4 x float>, <4 x float>* %134, align 4, !alias.scope !19
  %135 = getelementptr float, float* %133, i64 4
  %136 = bitcast float* %135 to <4 x float>*
  %wide.load214.1 = load <4 x float>, <4 x float>* %136, align 4, !alias.scope !19
  %137 = fadd <4 x float> %wide.load211.1, %wide.load213.1
  %138 = fadd <4 x float> %wide.load212.1, %wide.load214.1
  %139 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv47, i64 %index.next204
  ...
  %143 = icmp eq i64 %index.next204.1, %n.vec178
  br i1 %143, label %middle.block173.unr-lcssa, label %vector.body172, !llvm.loop !24
...
middle.block173:                                  ; preds = %vector.body172.prol.loopexit, %middle.block173.unr-lcssa
  br i1 %cmp.n206, label %for.inc205.loopexit.us, label %for.body187.us.preheader
...
for.body187.us.preheader:                         ; preds = %middle.block173, %vector.memcheck201, %min.iters.checked176, %for.cond185.preheader.us
  ...
  %xtraiter215 = and i64 %144, 1
  %lcmp.mod216 = icmp eq i64 %xtraiter215, 0
  br i1 %lcmp.mod216, label %for.body187.us.prol.loopexit.unr-lcssa, label %for.body187.us.prol.preheader
...
for.body187.us.prol.loopexit:                     ; preds = %for.body187.us.prol.loopexit.unr-lcssa
  ...
  br i1 %147, label %for.inc205.loopexit.us.loopexit, label %for.body187.us.preheader.new
...
for.body187.us:                                   ; preds = %for.body187.us, %for.body187.us.preheader.new
  ...
  br i1 %exitcond.1, label %for.inc205.loopexit.us.loopexit.unr-lcssa, label %for.body187.us, !llvm.loop !25

for.inc205.loopexit.us.loopexit.unr-lcssa:        ; preds = %for.body187.us
  br label %for.inc205.loopexit.us.loopexit

for.inc205.loopexit.us.loopexit:                  ; preds = %for.body187.us.prol.loopexit, %for.inc205.loopexit.us.loopexit.unr-lcssa
  br label %for.inc205.loopexit.us

for.inc205.loopexit.us:                           ; preds = %for.inc205.loopexit.us.loopexit, %middle.block173
  %indvars.iv.next48 = add nuw i64 %indvars.iv47, 1
  %cmp183.us = icmp slt i64 %indvars.iv.next48, %93
  br i1 %cmp183.us, label %for.cond185.preheader.us, label %for.end207.loopexit

for.end207.loopexit:                              ; preds = %for.inc205.loopexit.us
  br label %for.end207
...
for.cond2.preheader.us:                           ; preds = %for.inc10.loopexit.us, %for.cond2.preheader.us.preheader
  %indvars.iv9 = phi i64 [ 0, %for.cond2.preheader.us.preheader ], [ %indvars.iv.next10, %for.inc10.loopexit.us ]
...
if.end.us:                                        ; preds = %for.body4.us, %if.then.us
  ...
  %arrayidx8.us = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv9, i64 %indvars.iv
  ...
  br i1 %cmp3.us, label %for.body4.us, label %for.inc10.loopexit.us

for.inc10.loopexit.us:                            ; preds = %if.end.us
  %indvars.iv.next10 = add nuw i64 %indvars.iv9, 1
  %cmp.us = icmp slt i64 %indvars.iv.next10, %4
