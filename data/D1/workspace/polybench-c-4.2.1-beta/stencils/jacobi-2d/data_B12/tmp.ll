...
.preheader6.lr.ph:                                ; preds = %4
  ...
  %7 = add nsw i64 %wide.trip.count22, -1
  %8 = icmp sgt i32 %6, 1
  %min.iters.check49 = icmp ult i64 %7, 4
  %n.vec52 = and i64 %7, -4
  %cmp.zero53 = icmp eq i64 %n.vec52, 0
  %ind.end74 = or i64 %n.vec52, 1
  %cmp.n75 = icmp eq i64 %7, %n.vec52
  %9 = icmp sgt i32 %6, 1
...
.preheader6:                                      ; preds = %._crit_edge13, %.preheader6.lr.ph
  ...
  br i1 %8, label %.preheader4.us.preheader, label %._crit_edge13

.preheader4.us.preheader:                         ; preds = %.preheader6
  br label %.preheader4.us

.preheader4.us:                                   ; preds = %.preheader4.us.preheader, %._crit_edge.us..preheader4.us_crit_edge
  %indvar55 = phi i64 [ %indvar.next56, %._crit_edge.us..preheader4.us_crit_edge ], [ 0, %.preheader4.us.preheader ]
...
scalar.ph48.preheader:                            ; preds = %middle.block47, %vector.memcheck69, %min.iters.checked50, %.preheader4.us
  %indvars.iv.ph = phi i64 [ %ind.end74, %middle.block47 ], [ 1, %vector.memcheck69 ], [ 1, %min.iters.checked50 ], [ 1, %.preheader4.us ]
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %middle.block47
  ...
  br i1 %exitcond19, label %.preheader5, label %._crit_edge.us..preheader4.us_crit_edge
...
scalar.ph.preheader:                              ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.preheader.us
  %indvars.iv20.ph = phi i64 [ %ind.end, %middle.block ], [ 1, %vector.memcheck ], [ 1, %min.iters.checked ], [ 1, %.preheader.us ]
  br label %scalar.ph
...
._crit_edge11.us:                                 ; preds = %._crit_edge11.us.loopexit, %middle.block
  ...
  br i1 %exitcond27, label %._crit_edge13.loopexit, label %._crit_edge11.us..preheader.us_crit_edge
