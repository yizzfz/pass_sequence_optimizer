...
for.body3.us:                                     ; preds = %for.body3.us, %for.cond1.preheader.us
  %indvars.iv2537.us = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next26.us, %for.body3.us ]
  ...
  br i1 %exitcond41, label %for.inc7.us, label %for.body3.us
...
for.body17:                                       ; preds = %for.body17, %for.cond14.preheader
  %indvars.iv32 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next, %for.body17 ]
...
for.body4:                                        ; preds = %if.end, %for.cond2.preheader
  %indvars.iv14 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next, %if.end ]
