...
; <label>:4:                                      ; preds = %._crit_edge, %.lr.ph10
  %indvars.iv21 = phi i64 [ 0, %.lr.ph10 ], [ %indvars.iv.next22, %._crit_edge ]
  %5 = add nuw i64 %indvars.iv21, 4294967295
  %6 = getelementptr inbounds double, double* %3, i64 %indvars.iv21
  %7 = bitcast double* %6 to i64*
  %8 = load i64, i64* %7, align 8
  %9 = getelementptr inbounds double, double* %2, i64 %indvars.iv21
  %10 = bitcast double* %9 to i64*
  store i64 %8, i64* %10, align 8
  %11 = bitcast i64 %8 to double
  %12 = icmp sgt i64 %indvars.iv21, 0
...
.prol.preheader:                                  ; preds = %.lr.ph
  %13 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv21, i64 0
...
.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph
  ...
  %.lcssa16.unr.ph = phi double [ %17, %.prol.preheader ], [ undef, %.lr.ph ]
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %21 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv21, i64 %indvars.iv
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %27 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv21, i64 %indvars.iv.next
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %4, %.prol.loopexit
  %.lcssa = phi double [ %.lcssa16.unr.ph, %.prol.loopexit ], [ %11, %4 ], [ %32, %._crit_edge.loopexit ]
  %33 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv21, i64 %indvars.iv21
  ...
  br i1 %exitcond26, label %._crit_edge11, label %4
