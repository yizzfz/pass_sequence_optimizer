...
@__llvm_prf_nm = private constant [176 x i8] c"\AD\01\00BZ2_blockSort\01tmp1.ll:fallbackSort\01tmp1.ll:mainSort\01tmp1.ll:fallbackQSort3\01tmp1.ll:fallbackSimpleSort\01tmp1.ll:mainQSort3\01tmp1.ll:mainSimpleSort\01tmp1.ll:mmed3\01tmp1.ll:mainGtU", section "__llvm_prf_names"
@llvm.used = appending global [10 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_BZ2_blockSort to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_fallbackSort to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_mainSort to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_fallbackQSort3 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_fallbackSimpleSort to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_mainQSort3 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_mainSimpleSort to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_mmed3 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_mainGtU to i8*), i8* getelementptr inbounds ([176 x i8], [176 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
