...
if.then:                                          ; preds = %land.lhs.true
  call fastcc void @print_array(double* %arraydecay3)
  br label %if.end
...
for.body6.lr.ph:                                  ; preds = %for.inc14, %for.body.lr.ph
  ...
  %1 = add nuw nsw i64 %indvars.iv8, 2000
  %2 = and i64 %indvars.iv8, 1
...
for.body6.prol:                                   ; preds = %for.body6.prol.preheader
  %3 = add nuw nsw i64 %indvars.iv8, 2001
  %4 = trunc i64 %3 to i32
  %conv8.prol = sitofp i32 %4 to double
...
for.body6:                                        ; preds = %for.body6, %for.body6.lr.ph.new
  ...
  %9 = sub i64 %1, %indvars.iv.next
  %10 = add i64 %9, 1
  %11 = trunc i64 %10 to i32
  %conv8.1 = sitofp i32 %11 to double
  ...
  store <2 x double> %div, <2 x double>* %12, align 8
...
for.inc14:                                        ; preds = %for.body6.prol.loopexit, %for.inc14.unr-lcssa
  ...
  %exitcond = icmp ne i64 %indvars.iv.next9, 2000
...
for.end:                                          ; preds = %for.end.loopexit, %entry
  ...
  %call5 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %.lcssa, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #3
