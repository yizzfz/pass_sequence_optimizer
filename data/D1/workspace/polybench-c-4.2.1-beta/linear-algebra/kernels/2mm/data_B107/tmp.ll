...
._crit_edge23.us:                                 ; preds = %._crit_edge
  ...
  %exitcond97 = icmp eq i64 %indvars.iv.next84, 800
  br i1 %exitcond97, label %.lr.ph19.split.us.new.preheader.preheader, label %.lr.ph26.split.us
...
._crit_edge16.us:                                 ; preds = %.lr.ph19.split.us.new
  ...
  %exitcond96 = icmp eq i64 %indvars.iv.next76, 1100
  br i1 %exitcond96, label %.lr.ph12.split.us.preheader, label %.lr.ph19.split.us.new.preheader
...
._crit_edge98:                                    ; preds = %._crit_edge98, %.lr.ph12.split.us
  %indvars.iv63 = phi i64 [ 0, %.lr.ph12.split.us ], [ %indvars.iv.next64, %._crit_edge98 ]
  ...
  br i1 %exitcond66, label %._crit_edge9.us, label %._crit_edge98

._crit_edge9.us:                                  ; preds = %._crit_edge98
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  %exitcond95 = icmp eq i64 %indvars.iv.next68, 900
  br i1 %exitcond95, label %.lr.ph5.split.us.preheader, label %.lr.ph12.split.us
...
._crit_edge99:                                    ; preds = %._crit_edge99, %.lr.ph5.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph5.split.us ], [ %indvars.iv.next, %._crit_edge99 ]
...
._crit_edge.us:                                   ; preds = %._crit_edge99
  ...
  %exitcond94 = icmp eq i64 %indvars.iv.next62, 800
  br i1 %exitcond94, label %45, label %.lr.ph5.split.us
...
._crit_edge12.us:                                 ; preds = %._crit_edge9.us.us
  ...
  br i1 %exitcond97, label %.lr.ph.us.us.preheader.preheader, label %.lr.ph8.us.us.preheader
...
._crit_edge3.us.loopexit:                         ; preds = %._crit_edge.us.us
  ...
  br i1 %exitcond96, label %49, label %.lr.ph.us.us.preheader
...
._crit_edge.us.us:                                ; preds = %._crit_edge107
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1
  %exitcond67 = icmp eq i64 %indvars.iv.next65, 1200
  br i1 %exitcond67, label %._crit_edge3.us.loopexit, label %.lr.ph.us.us

._crit_edge107:                                   ; preds = %._crit_edge107, %.lr.ph.us.us
  %30 = phi double [ %29, %.lr.ph.us.us ], [ %48, %._crit_edge107 ]
  %indvars.iv62 = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next63.2, %._crit_edge107 ]
  ...
  br i1 %exitcond.2, label %._crit_edge.us.us, label %._crit_edge107
...
._crit_edge2.us:                                  ; preds = %._crit_edge.us
  ...
  br i1 %exitcond15, label %18, label %.lr.ph4.split.us
