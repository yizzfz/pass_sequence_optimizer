...
; <label>:4:                                      ; preds = %._crit_edge, %.preheader.us
  ...
  br i1 %exitcond7.1, label %._crit_edge.us, label %._crit_edge
...
._crit_edge.us:                                   ; preds = %4
  ...
  br i1 %exitcond, label %._crit_edge4, label %._crit_edge.us..preheader.us_crit_edge
...
.lr.ph11.split.us.preheader:                      ; preds = %._crit_edge22..lr.ph11.split.us.preheader_crit_edge, %.preheader4.lr.ph
  %.0323 = phi i32 [ 1, %.preheader4.lr.ph ], [ %152, %._crit_edge22..lr.ph11.split.us.preheader_crit_edge ]
  br label %.lver.check

.lver.check:                                      ; preds = %._crit_edge9.us..lver.check_crit_edge, %.lr.ph11.split.us.preheader
  %indvar = phi i64 [ 0, %.lr.ph11.split.us.preheader ], [ %6, %._crit_edge9.us..lver.check_crit_edge ]
  %indvars.iv28 = phi i64 [ 1, %.lr.ph11.split.us.preheader ], [ %indvars.iv.next29, %._crit_edge9.us..lver.check_crit_edge ]
  %6 = add i64 %indvar, 1
  %scevgep = getelementptr [1000 x double], [1000 x double]* %4, i64 %6, i64 0
  %scevgep42 = getelementptr [1000 x double], [1000 x double]* %4, i64 %6, i64 999
  %scevgep44 = getelementptr [1000 x double], [1000 x double]* %5, i64 %6, i64 0
  %scevgep46 = getelementptr [1000 x double], [1000 x double]* %5, i64 %6, i64 999
...
.ph.lver.orig:                                    ; preds = %.ph.lver.orig..ph.lver.orig_crit_edge, %.ph.lver.orig.preheader
  ...
  br i1 %exitcond38.lver.orig, label %.lr.ph8.us.preheader.loopexit, label %.ph.lver.orig..ph.lver.orig_crit_edge
...
._crit_edge9.us:                                  ; preds = %.lr.ph8.us
  ...
  br i1 %exitcond39, label %.lver.check66.preheader, label %._crit_edge9.us..lver.check_crit_edge
...
.lr.ph8.us:                                       ; preds = %.lr.ph8.us..lr.ph8.us_crit_edge, %.lr.ph8.us.preheader
  %indvars.iv26 = phi i64 [ 998, %.lr.ph8.us.preheader ], [ %indvars.iv.next27.1, %.lr.ph8.us..lr.ph8.us_crit_edge ]
  %37 = phi double [ 1.000000e+00, %.lr.ph8.us.preheader ], [ %50, %.lr.ph8.us..lr.ph8.us_crit_edge ]
  ...
  br i1 %52, label %.lr.ph8.us..lr.ph8.us_crit_edge, label %._crit_edge9.us

.lr.ph8.us..lr.ph8.us_crit_edge:                  ; preds = %.lr.ph8.us
  br label %.lr.ph8.us

; <label>:53:                                     ; preds = %._crit_edge, %.ph
  %store_forwarded51 = phi double [ %load_initial50, %.ph ], [ %70, %._crit_edge ]
  %store_forwarded = phi double [ %load_initial, %.ph ], [ %58, %._crit_edge ]
  ...
  %68 = fmul double %store_forwarded51, 0xC09F400000000001
  ...
  br i1 %exitcond38, label %.lr.ph8.us.preheader.loopexit75, label %._crit_edge
...
.lr.ph8.us.preheader.loopexit75:                  ; preds = %53
  br label %.lr.ph8.us.preheader
...
.lver.check66:                                    ; preds = %._crit_edge19.us..lver.check66_crit_edge, %.lver.check66.preheader
  %indvar52 = phi i64 [ %73, %._crit_edge19.us..lver.check66_crit_edge ], [ 0, %.lver.check66.preheader ]
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %._crit_edge19.us..lver.check66_crit_edge ], [ 1, %.lver.check66.preheader ]
  %73 = add i64 %indvar52, 1
  %scevgep54 = getelementptr [1000 x double], [1000 x double]* %4, i64 %73, i64 0
  %scevgep56 = getelementptr [1000 x double], [1000 x double]* %4, i64 %73, i64 999
  %scevgep58 = getelementptr [1000 x double], [1000 x double]* %5, i64 %73, i64 0
  %scevgep60 = getelementptr [1000 x double], [1000 x double]* %5, i64 %73, i64 999
  %74 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv36
  %75 = getelementptr inbounds [1000 x double], [1000 x double]* %74, i64 0, i64 0
  store double 1.000000e+00, double* %75, align 8
  %76 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv36, i64 0
  store double 0.000000e+00, double* %76, align 8
  %77 = bitcast [1000 x double]* %74 to i64*
  %78 = load i64, i64* %77, align 8
  %79 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv36
...
.ph67.lver.orig:                                  ; preds = %.ph67.lver.orig..ph67.lver.orig_crit_edge, %.ph67.lver.orig.preheader
  %indvars.iv30.lver.orig = phi i64 [ %indvars.iv.next31.lver.orig, %.ph67.lver.orig..ph67.lver.orig_crit_edge ], [ 1, %.ph67.lver.orig.preheader ]
  %82 = add nsw i64 %indvars.iv30.lver.orig, -1
  %83 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv36, i64 %82
  %84 = load double, double* %83, align 8
  %85 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv36, i64 %indvars.iv30.lver.orig
  %86 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %81, i64 %indvars.iv30.lver.orig
  %87 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv36, i64 %indvars.iv30.lver.orig
  %88 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv.next37, i64 %indvars.iv30.lver.orig
  %89 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv36, i64 %82
  ...
  %109 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv36, i64 %indvars.iv30.lver.orig
  ...
  br i1 %exitcond.lver.orig, label %.lr.ph18.us.preheader.loopexit, label %.ph67.lver.orig..ph67.lver.orig_crit_edge

.ph67.lver.orig..ph67.lver.orig_crit_edge:        ; preds = %.ph67.lver.orig
  br label %.ph67.lver.orig

.ph67:                                            ; preds = %.lver.check66
  %load_initial69 = load double, double* %scevgep54, align 8
  %load_initial72 = load double, double* %scevgep58, align 8
  br label %126

._crit_edge19.us:                                 ; preds = %.lr.ph18.us
  %exitcond40 = icmp eq i64 %indvars.iv.next37, 999
  br i1 %exitcond40, label %._crit_edge22, label %._crit_edge19.us..lver.check66_crit_edge

._crit_edge19.us..lver.check66_crit_edge:         ; preds = %._crit_edge19.us
  br label %.lver.check66

.lr.ph18.us:                                      ; preds = %.lr.ph18.us..lr.ph18.us_crit_edge, %.lr.ph18.us.preheader
  %110 = phi double [ 1.000000e+00, %.lr.ph18.us.preheader ], [ %123, %.lr.ph18.us..lr.ph18.us_crit_edge ]
  %indvars.iv34 = phi i64 [ 998, %.lr.ph18.us.preheader ], [ %indvars.iv.next35.1, %.lr.ph18.us..lr.ph18.us_crit_edge ]
  %111 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv36, i64 %indvars.iv34
  %112 = load double, double* %111, align 8
  %113 = fmul double %112, %110
  %114 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv36, i64 %indvars.iv34
  %115 = load double, double* %114, align 8
  %116 = fadd double %113, %115
  %117 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv36, i64 %indvars.iv34
  store double %116, double* %117, align 8
  %indvars.iv.next35 = add nsw i64 %indvars.iv34, -1
  %118 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv36, i64 %indvars.iv.next35
  %119 = load double, double* %118, align 8
  %120 = fmul double %119, %116
  %121 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv36, i64 %indvars.iv.next35
  %122 = load double, double* %121, align 8
  %123 = fadd double %120, %122
  %124 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv36, i64 %indvars.iv.next35
  store double %123, double* %124, align 8
  %125 = icmp sgt i64 %indvars.iv.next35, 1
  %indvars.iv.next35.1 = add nsw i64 %indvars.iv34, -2
  br i1 %125, label %.lr.ph18.us..lr.ph18.us_crit_edge, label %._crit_edge19.us

.lr.ph18.us..lr.ph18.us_crit_edge:                ; preds = %.lr.ph18.us
  br label %.lr.ph18.us

; <label>:126:                                    ; preds = %._crit_edge76, %.ph67
  %store_forwarded73 = phi double [ %load_initial72, %.ph67 ], [ %148, %._crit_edge76 ]
  %store_forwarded70 = phi double [ %load_initial69, %.ph67 ], [ %137, %._crit_edge76 ]
  %indvars.iv30 = phi i64 [ 1, %.ph67 ], [ %indvars.iv.next31, %._crit_edge76 ]
  %127 = getelementptr inbounds [1000 x double], [1000 x double]* %4, i64 %indvars.iv36, i64 %indvars.iv30
  %128 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %81, i64 %indvars.iv30
  %129 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv36, i64 %indvars.iv30
  %130 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv.next37, i64 %indvars.iv30
  %131 = insertelement <2 x double> undef, double %store_forwarded70, i32 0
  ...
  %146 = fmul double %store_forwarded73, 0xC08F400000000001
  %147 = fsub double %145, %146
  %148 = fdiv double %147, %136
  %149 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv36, i64 %indvars.iv30
  store double %148, double* %149, align 8
  %exitcond = icmp eq i64 %indvars.iv30, 998
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  br i1 %exitcond, label %.lr.ph18.us.preheader.loopexit74, label %._crit_edge76

._crit_edge76:                                    ; preds = %126
  br label %126

.lr.ph18.us.preheader.loopexit:                   ; preds = %.ph67.lver.orig
  br label %.lr.ph18.us.preheader

.lr.ph18.us.preheader.loopexit74:                 ; preds = %126
  br label %.lr.ph18.us.preheader

.lr.ph18.us.preheader:                            ; preds = %.lr.ph18.us.preheader.loopexit74, %.lr.ph18.us.preheader.loopexit
  %150 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv36, i64 999
...
._crit_edge22:                                    ; preds = %._crit_edge19.us
  ...
  br i1 %151, label %._crit_edge22..lr.ph11.split.us.preheader_crit_edge, label %._crit_edge24
