...
._crit_edge18.us:                                 ; preds = %._crit_edge
  ...
  br i1 %exitcond97, label %.lr.ph14.split.us.new.preheader.preheader, label %.lr.ph20.split.us
...
._crit_edge12.us:                                 ; preds = %.lr.ph14.split.us.new
  ...
  br i1 %exitcond96, label %.lr.ph8.split.us.preheader, label %.lr.ph14.split.us.new.preheader
...
._crit_edge92:                                    ; preds = %._crit_edge92, %.lr.ph8.split.us
  %indvars.iv54 = phi i64 [ 0, %.lr.ph8.split.us ], [ %indvars.iv.next55, %._crit_edge92 ]
  ...
  br i1 %exitcond57, label %._crit_edge6.us, label %._crit_edge92

._crit_edge6.us:                                  ; preds = %._crit_edge92
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  %exitcond95 = icmp eq i64 %indvars.iv.next59, 900
  br i1 %exitcond95, label %.lr.ph2.split.us.preheader, label %.lr.ph8.split.us
...
._crit_edge93:                                    ; preds = %._crit_edge93, %.lr.ph2.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph2.split.us ], [ %indvars.iv.next, %._crit_edge93 ]
...
._crit_edge.us:                                   ; preds = %._crit_edge93
  ...
  br i1 %exitcond94, label %45, label %.lr.ph2.split.us
...
._crit_edge3.us:                                  ; preds = %._crit_edge.us.us
  ...
  br i1 %exitcond101, label %49, label %.lr.ph.us.us.preheader
...
._crit_edge100:                                   ; preds = %._crit_edge100, %.lr.ph.us.us
  %30 = phi double [ %29, %.lr.ph.us.us ], [ %48, %._crit_edge100 ]
