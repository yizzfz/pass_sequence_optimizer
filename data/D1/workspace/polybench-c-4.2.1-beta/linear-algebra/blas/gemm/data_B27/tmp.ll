...
._crit_edge4.preheader:                           ; preds = %._crit_edge4.preheader.preheader, %._crit_edge3
  %indvars.iv12 = phi i64 [ %25, %._crit_edge3 ], [ 0, %._crit_edge4.preheader.preheader ]
  %scevgep21 = getelementptr [1100 x double], [1100 x double]* %7, i64 %indvars.iv12, i64 0
  %25 = add i64 %indvars.iv12, 1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %42, label %._crit_edge3.loopexit36, label %vector.body, !llvm.loop !9

._crit_edge4:                                     ; preds = %._crit_edge4.preheader35, %._crit_edge4
  %indvars.iv9 = phi i64 [ %indvars.iv.next10.1, %._crit_edge4 ], [ 0, %._crit_edge4.preheader35 ]
...
._crit_edge3:                                     ; preds = %._crit_edge3.loopexit36, %._crit_edge3.loopexit
  ...
  br i1 %exitcond14, label %59, label %._crit_edge4.preheader

; <label>:59:                                     ; preds = %._crit_edge3
  %exitcond17 = icmp eq i64 %9, 1000
  br i1 %exitcond17, label %60, label %._crit_edge.preheader
