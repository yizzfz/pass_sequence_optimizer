...
.lr.ph9:                                          ; preds = %.lr.ph9.preheader, %11
  %indvars.iv47 = phi i64 [ %indvars.iv.next5, %11 ], [ 0, %.lr.ph9.preheader ]
  %6 = trunc i64 %indvars.iv47 to i32
  %7 = srem i32 %6, 20
  %8 = icmp eq i32 %7, 0
...
; <label>:11:                                     ; preds = %.lr.ph9, %9
  ...
  %13 = getelementptr inbounds double, double* %0, i64 %indvars.iv47
  ...
  %exitcond11 = icmp eq i64 %indvars.iv.next5, 1900
