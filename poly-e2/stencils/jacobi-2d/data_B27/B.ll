...
for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.cond4.for.inc37_crit_edge.us
  ...
  %scevgep59 = getelementptr [1300 x double], [1300 x double]* %B, i64 %2, i64 %wide.trip.count15
  %scevgep61 = getelementptr [1300 x double], [1300 x double]* %A, i64 %indvar55, i64 1
  %3 = add i64 %indvar55, 2
  %scevgep63 = getelementptr [1300 x double], [1300 x double]* %A, i64 %3, i64 %wide.trip.count15
...
vector.body46:                                    ; preds = %vector.body46.preheader, %vector.body46
  ...
  %5 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv12, i64 %offset.idx76
  %6 = bitcast double* %5 to <2 x double>*
  %wide.load81 = load <2 x double>, <2 x double>* %6, align 8, !alias.scope !1
  %7 = getelementptr double, double* %5, i64 2
  %8 = bitcast double* %7 to <2 x double>*
  %wide.load82 = load <2 x double>, <2 x double>* %8, align 8, !alias.scope !1
  %9 = add nsw i64 %offset.idx76, -1
  %10 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv12, i64 %9
  %11 = bitcast double* %10 to <2 x double>*
  %wide.load83 = load <2 x double>, <2 x double>* %11, align 8, !alias.scope !1
  %12 = getelementptr double, double* %10, i64 2
  %13 = bitcast double* %12 to <2 x double>*
  %wide.load84 = load <2 x double>, <2 x double>* %13, align 8, !alias.scope !1
  %14 = fadd <2 x double> %wide.load81, %wide.load83
  %15 = fadd <2 x double> %wide.load82, %wide.load84
  %16 = add nuw nsw i64 %offset.idx76, 1
  %17 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv12, i64 %16
  %18 = bitcast double* %17 to <2 x double>*
  %wide.load85 = load <2 x double>, <2 x double>* %18, align 8, !alias.scope !1
  %19 = getelementptr double, double* %17, i64 2
  %20 = bitcast double* %19 to <2 x double>*
  %wide.load86 = load <2 x double>, <2 x double>* %20, align 8, !alias.scope !1
  %21 = fadd <2 x double> %14, %wide.load85
  %22 = fadd <2 x double> %15, %wide.load86
  %23 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv.next13, i64 %offset.idx76
  %24 = bitcast double* %23 to <2 x double>*
  %wide.load87 = load <2 x double>, <2 x double>* %24, align 8, !alias.scope !1
  %25 = getelementptr double, double* %23, i64 2
  %26 = bitcast double* %25 to <2 x double>*
  %wide.load88 = load <2 x double>, <2 x double>* %26, align 8, !alias.scope !1
  %27 = fadd <2 x double> %21, %wide.load87
  %28 = fadd <2 x double> %22, %wide.load88
  %29 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %4, i64 %offset.idx76
  %30 = bitcast double* %29 to <2 x double>*
  %wide.load89 = load <2 x double>, <2 x double>* %30, align 8, !alias.scope !1
  %31 = getelementptr double, double* %29, i64 2
  %32 = bitcast double* %31 to <2 x double>*
  %wide.load90 = load <2 x double>, <2 x double>* %32, align 8, !alias.scope !1
  %33 = fadd <2 x double> %27, %wide.load89
  ...
  %37 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv12, i64 %offset.idx76
  ...
  %41 = icmp eq i64 %index.next72, %n.vec52
  br i1 %41, label %middle.block47, label %vector.body46, !llvm.loop !6

middle.block47:                                   ; preds = %vector.body46
  br i1 %cmp.n75, label %for.cond4.for.inc37_crit_edge.us, label %for.body7.us.preheader

for.body7.us.preheader:                           ; preds = %middle.block47, %vector.memcheck69, %min.iters.checked50, %for.cond4.preheader.us
...
for.body7.us:                                     ; preds = %for.body7.us.preheader, %for.body7.us
  ...
  %arrayidx14.us = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv12, i64 %43
...
for.cond4.for.inc37_crit_edge.us:                 ; preds = %for.cond4.for.inc37_crit_edge.us.loopexit, %middle.block47
  ...
  br i1 %exitcond16, label %for.cond44.preheader.us.preheader, label %for.cond4.preheader.us
...
for.cond44.preheader.us:                          ; preds = %for.cond44.preheader.us.preheader, %for.cond44.for.inc84_crit_edge.us
  ...
  %scevgep30 = getelementptr [1300 x double], [1300 x double]* %A, i64 %48, i64 %wide.trip.count15
  %scevgep32 = getelementptr [1300 x double], [1300 x double]* %B, i64 %indvar, i64 1
  %49 = add i64 %indvar, 2
  %scevgep34 = getelementptr [1300 x double], [1300 x double]* %B, i64 %49, i64 %wide.trip.count15
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  %50 = add nsw i64 %indvars.iv22, -1
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %51 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv22, i64 %offset.idx
  %52 = bitcast double* %51 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %52, align 8, !alias.scope !10
  %53 = getelementptr double, double* %51, i64 2
  %54 = bitcast double* %53 to <2 x double>*
  %wide.load37 = load <2 x double>, <2 x double>* %54, align 8, !alias.scope !10
  %55 = add nsw i64 %offset.idx, -1
  %56 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv22, i64 %55
  %57 = bitcast double* %56 to <2 x double>*
  %wide.load38 = load <2 x double>, <2 x double>* %57, align 8, !alias.scope !10
  %58 = getelementptr double, double* %56, i64 2
  %59 = bitcast double* %58 to <2 x double>*
  %wide.load39 = load <2 x double>, <2 x double>* %59, align 8, !alias.scope !10
  %60 = fadd <2 x double> %wide.load, %wide.load38
  %61 = fadd <2 x double> %wide.load37, %wide.load39
  %62 = add nuw nsw i64 %offset.idx, 1
  %63 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv22, i64 %62
  %64 = bitcast double* %63 to <2 x double>*
  %wide.load40 = load <2 x double>, <2 x double>* %64, align 8, !alias.scope !10
  %65 = getelementptr double, double* %63, i64 2
  %66 = bitcast double* %65 to <2 x double>*
  %wide.load41 = load <2 x double>, <2 x double>* %66, align 8, !alias.scope !10
  %67 = fadd <2 x double> %60, %wide.load40
  %68 = fadd <2 x double> %61, %wide.load41
  %69 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv.next23, i64 %offset.idx
  ...
  %73 = fadd <2 x double> %67, %wide.load42
  %74 = fadd <2 x double> %68, %wide.load43
  %75 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %50, i64 %offset.idx
  %76 = bitcast double* %75 to <2 x double>*
  %wide.load44 = load <2 x double>, <2 x double>* %76, align 8, !alias.scope !10
  %77 = getelementptr double, double* %75, i64 2
  %78 = bitcast double* %77 to <2 x double>*
  %wide.load45 = load <2 x double>, <2 x double>* %78, align 8, !alias.scope !10
  %79 = fadd <2 x double> %73, %wide.load44
  %80 = fadd <2 x double> %74, %wide.load45
  ...
  %83 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv22, i64 %offset.idx
...
for.body47.us:                                    ; preds = %for.body47.us.preheader, %for.body47.us
  ...
  %89 = add nsw i64 %indvars.iv17, -1
  %arrayidx56.us = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv22, i64 %89
  ...
  %arrayidx74.us = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %50, i64 %indvars.iv17
  ...
  br i1 %exitcond21, label %for.cond44.for.inc84_crit_edge.us.loopexit, label %for.body47.us, !llvm.loop !16
...
for.inc87:                                        ; preds = %for.inc87.loopexit, %for.cond1.preheader
