...
.lr.ph94:                                         ; preds = %.preheader72.lr.ph, %._crit_edge96..preheader72_crit_edge
  %indvars.iv134 = phi i64 [ %indvars.iv.next135, %._crit_edge96..preheader72_crit_edge ], [ 0, %.preheader72.lr.ph ]
...
.preheader71:                                     ; preds = %4
  ...
  %3 = icmp slt i64 %indvars.iv.next135, 2000
  br i1 %3, label %._crit_edge96..preheader72_crit_edge, label %.preheader70.us.preheader

; <label>:4:                                      ; preds = %4, %.lr.ph94
  %indvars.iv120 = phi i64 [ 0, %.lr.ph94 ], [ %indvars.iv.next121, %4 ]
  %5 = sub nsw i64 0, %indvars.iv120
  %6 = trunc i64 %5 to i32
  %7 = srem i32 %6, 2000
  %8 = sitofp i32 %7 to double
  %9 = fdiv double %8, 2.000000e+03
  %10 = fadd double %9, 1.000000e+00
  %11 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv134, i64 %indvars.iv120
  store double %10, double* %11, align 8
  %indvars.iv.next121 = add nuw nsw i64 %indvars.iv120, 1
  %exitcond125 = icmp eq i64 %indvars.iv120, %indvars.iv134
  br i1 %exitcond125, label %.preheader71, label %4

._crit_edge96..preheader72_crit_edge:             ; preds = %.preheader71
  ...
  call void @llvm.memset.p0i8.i64(i8* %scevgep132133, i8 0, i64 %13, i32 8, i1 false)
  %14 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv134, i64 %indvars.iv134
...
._crit_edge91.us:                                 ; preds = %._crit_edge91.us, %.preheader70.us.preheader
  %indvars.iv118 = phi i64 [ 0, %.preheader70.us.preheader ], [ %indvars.iv.next119.7, %._crit_edge91.us ]
  ...
  %exitcond4.7 = icmp eq i64 %indvars.iv.next119.7, 2000
...
.preheader67.us.us:                               ; preds = %._crit_edge78.us.us, %.preheader67.us.us.preheader
  ...
  %38 = mul nuw nsw i64 %indvars.iv110, 16000
  %scevgep5 = getelementptr i8, i8* %16, i64 %38
  %39 = add nuw nsw i64 %38, 16000
  %scevgep6 = getelementptr i8, i8* %16, i64 %39
  %40 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv110, i64 %indvars.iv112
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %47 = or i64 %index, 2
  %48 = or i64 %index, 3
  %49 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %index, i64 %indvars.iv112
  %50 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %46, i64 %indvars.iv112
  %51 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %47, i64 %indvars.iv112
  %52 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %48, i64 %indvars.iv112
  ...
  %63 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %27, i64 0, i64 %indvars.iv110, i64 %index
...
scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader
  ...
  %73 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv106, i64 %indvars.iv112
  %74 = load double, double* %73, align 8
  %75 = fmul double %72, %74
  %76 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %25, i64 0, i64 %indvars.iv110, i64 %indvars.iv106
  ...
  %80 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv.next107, i64 %indvars.iv112
  %81 = load double, double* %80, align 8
  %82 = fmul double %79, %81
  %83 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv110, i64 %indvars.iv.next107
  %84 = load double, double* %83, align 8
  %85 = fadd double %84, %82
  store double %85, double* %83, align 8
  %indvars.iv.next107.1 = add nsw i64 %indvars.iv106, 2
  %exitcond109.1 = icmp eq i64 %indvars.iv.next107, 1999
  br i1 %exitcond109.1, label %._crit_edge78.us.us.loopexit, label %scalar.ph, !llvm.loop !12
...
.preheader43:                                     ; preds = %._crit_edge50, %.preheader43.preheader
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %._crit_edge50 ], [ 0, %.preheader43.preheader ]
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %._crit_edge50 ], [ 4294967295, %.preheader43.preheader ]
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge48.us
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %._crit_edge48.us ], [ %indvars.iv7, %.preheader.us.preheader ]
  %4 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv7, i64 %indvars.iv74
...
.prol.loopexit.unr-lcssa:                         ; preds = %.preheader.us, %5
  ...
  %.unr13.ph = phi double [ %10, %5 ], [ %.pre60, %.preheader.us ]
...
; <label>:11:                                     ; preds = %11, %.preheader.us.new
  ...
  %13 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv7, i64 %indvars.iv66
  ...
  %19 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv7, i64 %indvars.iv.next67
...
.preheader41:                                     ; preds = %._crit_edge, %.preheader41.preheader
  %indvars.iv1 = phi i64 [ %indvars.iv.next2, %._crit_edge ], [ 4294967295, %.preheader41.preheader ]
  ...
  %27 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv7, i64 %indvars.iv63
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader41
  ...
  %exitcond9 = icmp eq i64 %indvars.iv.next64, %indvars.iv7
  br i1 %exitcond9, label %.preheader.us.preheader, label %.preheader41
...
._crit_edge50:                                    ; preds = %._crit_edge50.loopexit, %.preheader43
  ...
  br i1 %exitcond10, label %._crit_edge54, label %.preheader43
