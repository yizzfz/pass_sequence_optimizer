...
; <label>:6:                                      ; preds = %6, %.preheader28.us
  %indvars.iv43 = phi i64 [ 0, %.preheader28.us ], [ %indvars.iv.next44, %6 ]
  ...
  br i1 %exitcond54, label %._crit_edge35.us, label %6
...
; <label>:14:                                     ; preds = %14, %.preheader.us
  ...
  br i1 %exitcond53, label %._crit_edge.us, label %14
...
._crit_edge:                                      ; preds = %7, %12
  ...
  br i1 %exitcond18, label %._crit_edge.us, label %7
