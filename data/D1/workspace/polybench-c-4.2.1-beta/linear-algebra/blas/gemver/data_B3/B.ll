...
; <label>:29:                                     ; preds = %26
  tail call void @print_array(i32 2000, double* %19)
  br label %30
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %39 = shl i64 %index, 1
  %offset.idx = or i64 %indvars.iv43.unr.ph, %39
  %40 = getelementptr inbounds [2000 x double], [2000 x double]* %3, i64 %indvars.iv51, i64 %offset.idx
  %41 = bitcast double* %40 to <4 x double>*
  %wide.vec = load <4 x double>, <4 x double>* %41, align 8, !alias.scope !1, !noalias !4
  %strided.vec = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %strided.vec86 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %42 = load double, double* %17, align 8, !alias.scope !9
  %43 = insertelement <2 x double> undef, double %42, i32 0
  %44 = shufflevector <2 x double> %43, <2 x double> undef, <2 x i32> zeroinitializer
  %45 = getelementptr inbounds double, double* %5, i64 %offset.idx
  %46 = bitcast double* %45 to <4 x double>*
  %wide.vec87 = load <4 x double>, <4 x double>* %46, align 8, !alias.scope !10
  ...
  %47 = fmul <2 x double> %44, %strided.vec88
  %48 = fadd <2 x double> %strided.vec, %47
  %49 = load double, double* %18, align 8, !alias.scope !11
  %50 = insertelement <2 x double> undef, double %49, i32 0
  %51 = shufflevector <2 x double> %50, <2 x double> undef, <2 x i32> zeroinitializer
  %52 = getelementptr inbounds double, double* %7, i64 %offset.idx
  %53 = bitcast double* %52 to <4 x double>*
  %wide.vec90 = load <4 x double>, <4 x double>* %53, align 8, !alias.scope !12
  ...
  %54 = fmul <2 x double> %51, %strided.vec91
  %55 = fadd <2 x double> %48, %54
  %56 = add nuw nsw i64 %offset.idx, 1
  %57 = getelementptr inbounds [2000 x double], [2000 x double]* %3, i64 %indvars.iv51, i64 %56
  %58 = load double, double* %17, align 8, !alias.scope !9
  %59 = insertelement <2 x double> undef, double %58, i32 0
  %60 = shufflevector <2 x double> %59, <2 x double> undef, <2 x i32> zeroinitializer
  %61 = fmul <2 x double> %60, %strided.vec89
  %62 = fadd <2 x double> %strided.vec86, %61
  %63 = load double, double* %18, align 8, !alias.scope !11
  %64 = insertelement <2 x double> undef, double %63, i32 0
  %65 = shufflevector <2 x double> %64, <2 x double> undef, <2 x i32> zeroinitializer
  %66 = fmul <2 x double> %65, %strided.vec92
  %67 = fadd <2 x double> %62, %66
  %68 = getelementptr double, double* %57, i64 -1
  %69 = bitcast double* %68 to <4 x double>*
  %interleaved.vec = shufflevector <2 x double> %55, <2 x double> %67, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec, <4 x double>* %69, align 8, !alias.scope !1, !noalias !4
...
.lr.ph13.prol:                                    ; preds = %.lr.ph13.prol.preheader, %.lr.ph13.prol
  ...
  %122 = getelementptr inbounds double, double* %9, i64 %indvars.iv25.prol
  %123 = load double, double* %122, align 8
  %124 = getelementptr inbounds double, double* %11, i64 %indvars.iv25.prol
...
.lr.ph13.prol.loopexit:                           ; preds = %.lr.ph13.prol.loopexit.loopexit, %.lr.ph13.preheader
  ...
  br i1 %127, label %.preheader.us.preheader, label %.lr.ph13.preheader56

.lr.ph13.preheader56:                             ; preds = %.lr.ph13.prol.loopexit
  %wide.trip.count27.3 = zext i32 %0 to i64
  %128 = add nsw i64 %wide.trip.count45.1, -4
  %129 = sub i64 %128, %indvars.iv25.unr
  %130 = lshr i64 %129, 2
  %131 = add nuw nsw i64 %130, 1
  %min.iters.check96 = icmp ult i64 %131, 2
...
min.iters.checked97:                              ; preds = %.lr.ph13.preheader56
  %n.mod.vf98 = and i64 %131, 1
  %n.vec99 = sub nsw i64 %131, %n.mod.vf98
...
vector.memcheck114:                               ; preds = %min.iters.checked97
  ...
  %132 = add nsw i64 %wide.trip.count45.1, -4
  %133 = sub i64 %132, %indvars.iv25.unr
  %134 = and i64 %133, -4
  %135 = add i64 %indvars.iv25.unr, %134
  %136 = add i64 %135, 4
  %scevgep104 = getelementptr double, double* %9, i64 %136
  %scevgep106 = getelementptr double, double* %11, i64 %indvars.iv25.unr
  %scevgep108 = getelementptr double, double* %11, i64 %136
  ...
  %138 = add i64 %indvars.iv25.unr, %137
  %139 = add i64 %138, 4
  %140 = shl nuw nsw i64 %n.mod.vf98, 2
  %ind.end119 = sub i64 %139, %140
...
vector.body93:                                    ; preds = %vector.body93.preheader, %vector.body93
  ...
  %141 = shl i64 %index116, 2
  %142 = add i64 %indvars.iv25.unr, %141
  %143 = getelementptr inbounds double, double* %9, i64 %142
  %144 = bitcast double* %143 to <8 x double>*
  %wide.vec125 = load <8 x double>, <8 x double>* %144, align 8, !alias.scope !19, !noalias !22
  %145 = getelementptr inbounds double, double* %11, i64 %142
  %146 = bitcast double* %145 to <8 x double>*
  %wide.vec130 = load <8 x double>, <8 x double>* %146, align 8, !alias.scope !22
  %147 = fadd <8 x double> %wide.vec125, %wide.vec130
  %148 = shufflevector <8 x double> %147, <8 x double> undef, <2 x i32> <i32 0, i32 4>
  %149 = fadd <8 x double> %wide.vec125, %wide.vec130
  %150 = shufflevector <8 x double> %149, <8 x double> undef, <2 x i32> <i32 1, i32 5>
  %151 = fadd <8 x double> %wide.vec125, %wide.vec130
  ...
  %155 = fadd <8 x double> %wide.vec125, %wide.vec130
  ...
  %interleaved.vec135 = shufflevector <4 x double> %159, <4 x double> %160, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 1, i32 3, i32 5, i32 7>
  store <8 x double> %interleaved.vec135, <8 x double>* %158, align 8, !alias.scope !19, !noalias !22
  %index.next117 = add i64 %index116, 2
  %161 = icmp eq i64 %index.next117, %n.vec99
  br i1 %161, label %middle.block94, label %vector.body93, !llvm.loop !24
...
.preheader4:                                      ; preds = %.preheader4.loopexit, %middle.block94
  ...
  br i1 %162, label %.preheader.us.preheader, label %._crit_edge11
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  ...
  %164 = getelementptr inbounds double, double* %8, i64 %indvars.iv22
  br i1 %lcmp.mod, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.preheader.us
  %165 = load double, double* %164, align 8
  %166 = getelementptr inbounds [2000 x double], [2000 x double]* %3, i64 %indvars.iv22, i64 0
...
.prol.loopexit:                                   ; preds = %.prol.preheader, %.preheader.us
  ...
  br i1 %163, label %._crit_edge.us, label %.preheader.us.new.preheader
...
.preheader.us.new:                                ; preds = %.preheader.us.new.preheader, %.preheader.us.new
  ...
  %173 = getelementptr inbounds [2000 x double], [2000 x double]* %3, i64 %indvars.iv22, i64 %indvars.iv
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %180 = getelementptr inbounds [2000 x double], [2000 x double]* %3, i64 %indvars.iv22, i64 %indvars.iv.next
...
.lr.ph13:                                         ; preds = %.lr.ph13.preheader136, %.lr.ph13
  ...
  %187 = getelementptr inbounds double, double* %9, i64 %indvars.iv25
  %188 = load double, double* %187, align 8
  %189 = getelementptr inbounds double, double* %11, i64 %indvars.iv25
  %190 = load double, double* %189, align 8
  %191 = fadd double %188, %190
  store double %191, double* %187, align 8
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  %192 = getelementptr inbounds double, double* %9, i64 %indvars.iv.next26
  %193 = load double, double* %192, align 8
  %194 = getelementptr inbounds double, double* %11, i64 %indvars.iv.next26
  %195 = load double, double* %194, align 8
  %196 = fadd double %193, %195
  store double %196, double* %192, align 8
  %indvars.iv.next26.1 = add nsw i64 %indvars.iv25, 2
  %197 = getelementptr inbounds double, double* %9, i64 %indvars.iv.next26.1
  %198 = load double, double* %197, align 8
  %199 = getelementptr inbounds double, double* %11, i64 %indvars.iv.next26.1
  %200 = load double, double* %199, align 8
  %201 = fadd double %198, %200
  store double %201, double* %197, align 8
  %indvars.iv.next26.2 = add nsw i64 %indvars.iv25, 3
  %202 = getelementptr inbounds double, double* %9, i64 %indvars.iv.next26.2
  %203 = load double, double* %202, align 8
  %204 = getelementptr inbounds double, double* %11, i64 %indvars.iv.next26.2
