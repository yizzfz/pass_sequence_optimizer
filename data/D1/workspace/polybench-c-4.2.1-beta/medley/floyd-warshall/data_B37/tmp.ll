...
.preheader:                                       ; preds = %17, %2
  %indvars.iv28 = phi i64 [ 0, %2 ], [ %indvars.iv.next3, %17 ]
  br label %3

; <label>:3:                                      ; preds = %.preheader, %3
  %indvars.iv7 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %3 ]
  %4 = mul nuw nsw i64 %indvars.iv7, %indvars.iv28
  %5 = trunc i64 %4 to i32
  %6 = srem i32 %5, 7
  %7 = add nsw i32 %6, 1
  %8 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv28, i64 %indvars.iv7
  %9 = add nuw nsw i64 %indvars.iv7, %indvars.iv28
...
.preheader9:                                      ; preds = %20, %2
  %indvars.iv712 = phi i64 [ 0, %2 ], [ %indvars.iv.next8, %20 ]
  br label %.preheader

.preheader:                                       ; preds = %.preheader9, %19
  %indvars.iv311 = phi i64 [ 0, %.preheader9 ], [ %indvars.iv.next4, %19 ]
  %3 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv311, i64 %indvars.iv712
  br label %4

; <label>:4:                                      ; preds = %4, %.preheader
  %indvars.iv10 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %4 ]
  %5 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv311, i64 %indvars.iv10
  %6 = load i32, i32* %5, align 4
  %7 = load i32, i32* %3, align 4
  %8 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv712, i64 %indvars.iv10
  ...
  %12 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv311, i64 %indvars.iv.next
  %13 = load i32, i32* %12, align 4
  %14 = load i32, i32* %3, align 4
  %15 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv712, i64 %indvars.iv.next
...
; <label>:19:                                     ; preds = %4
  ...
  %exitcond6 = icmp eq i64 %indvars.iv.next4, 2800
...
; <label>:20:                                     ; preds = %19
  ...
  br i1 %exitcond, label %21, label %.preheader9
...
.preheader:                                       ; preds = %20, %2
  %indvars.iv25 = phi i64 [ 0, %2 ], [ %indvars.iv.next3, %20 ]
  %7 = mul nuw nsw i64 %indvars.iv25, 2800
  br label %8

; <label>:8:                                      ; preds = %.preheader, %15
  %indvars.iv4 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %15 ]
...
; <label>:15:                                     ; preds = %13, %8
  ...
  %17 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv25, i64 %indvars.iv4
