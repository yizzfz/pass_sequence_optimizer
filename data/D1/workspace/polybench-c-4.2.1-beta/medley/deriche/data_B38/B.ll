...
.preheader174.us.new.preheader:                   ; preds = %.prol.loopexit274
  ...
  br i1 false, label %.preheader174.us.new.preheader370, label %min.iters.checked

min.iters.checked:                                ; preds = %.preheader174.us.new.preheader
  %n.mod.vf = and i64 %94, 3
  %n.vec = sub nsw i64 %94, %n.mod.vf
  br i1 false, label %.preheader174.us.new.preheader370, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %scevgep292 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv240.us, i64 %indvars.iv236.us.unr.ph
  %95 = sub nsw i64 2158, %indvars.iv236.us.unr.ph
  %96 = and i64 %95, 2158
  %97 = or i64 %indvars.iv236.us.unr.ph, %96
  %scevgep295 = getelementptr float, float* %scevgep294, i64 %97
  %scevgep298 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv240.us, i64 %indvars.iv236.us.unr.ph
  %scevgep301 = getelementptr float, float* %scevgep300, i64 %97
  %scevgep304 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv240.us, i64 %indvars.iv236.us.unr.ph
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.vec313 = load <8 x float>, <8 x float>* %106, align 4, !alias.scope !9
  %107 = fadd <8 x float> %wide.vec, %wide.vec313
  %108 = shufflevector <8 x float> %107, <8 x float> undef, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %109 = add nuw nsw i64 %offset.idx, 1
  %110 = fadd <8 x float> %wide.vec, %wide.vec313
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %._crit_edge200.us, label %.preheader174.us.new.preheader370

.preheader174.us.new.preheader370:                ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.preheader174.us.new.preheader
...
.preheader174.us.new:                             ; preds = %.preheader174.us.new.preheader370, %.preheader174.us.new
  %indvars.iv236.us = phi i64 [ %indvars.iv.next237.us.1, %.preheader174.us.new ], [ %indvars.iv236.us.ph, %.preheader174.us.new.preheader370 ]
...
.preheader.us.new.preheader:                      ; preds = %.prol.loopexit
  %178 = sub nsw i64 2158, %indvars.iv.us.unr.ph
  %179 = lshr i64 %178, 1
  %180 = add nuw nsw i64 %179, 1
  br i1 false, label %.preheader.us.new.preheader369, label %min.iters.checked320

min.iters.checked320:                             ; preds = %.preheader.us.new.preheader
  %n.mod.vf321 = and i64 %180, 3
  %n.vec322 = sub nsw i64 %180, %n.mod.vf321
  br i1 false, label %.preheader.us.new.preheader369, label %vector.memcheck351

vector.memcheck351:                               ; preds = %min.iters.checked320
  %scevgep326 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv218.us, i64 %indvars.iv.us.unr.ph
  %181 = sub nsw i64 2158, %indvars.iv.us.unr.ph
  %182 = and i64 %181, 2158
  %183 = or i64 %indvars.iv.us.unr.ph, %182
  %scevgep329 = getelementptr float, float* %scevgep328, i64 %183
  %scevgep332 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv218.us, i64 %indvars.iv.us.unr.ph
  %scevgep335 = getelementptr float, float* %scevgep334, i64 %183
  %scevgep338 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv218.us, i64 %indvars.iv.us.unr.ph
  %scevgep341 = getelementptr float, float* %scevgep340, i64 %183
  ...
  %184 = or i64 %indvars.iv.us.unr.ph, 2
  %185 = shl nuw nsw i64 %179, 1
  %186 = add nuw nsw i64 %184, %185
  %187 = shl nuw nsw i64 %n.mod.vf321, 1
  %ind.end356 = sub nsw i64 %186, %187
...
vector.body316:                                   ; preds = %vector.body316.preheader, %vector.body316
  ...
  %188 = shl i64 %index353, 1
  %offset.idx358 = or i64 %indvars.iv.us.unr.ph, %188
  %189 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv218.us, i64 %offset.idx358
  %190 = bitcast float* %189 to <8 x float>*
  %wide.vec362 = load <8 x float>, <8 x float>* %190, align 4, !alias.scope !16
  %191 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv218.us, i64 %offset.idx358
  %192 = bitcast float* %191 to <8 x float>*
  %wide.vec365 = load <8 x float>, <8 x float>* %192, align 4, !alias.scope !19
  %193 = fadd <8 x float> %wide.vec362, %wide.vec365
  %194 = shufflevector <8 x float> %193, <8 x float> undef, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %195 = add nuw nsw i64 %offset.idx358, 1
  %196 = fadd <8 x float> %wide.vec362, %wide.vec365
  %197 = shufflevector <8 x float> %196, <8 x float> undef, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %198 = getelementptr inbounds [2160 x float], [2160 x float]* %4, i64 %indvars.iv218.us, i64 %195
  %199 = getelementptr float, float* %198, i64 -1
  %200 = bitcast float* %199 to <8 x float>*
  %interleaved.vec368 = shufflevector <4 x float> %194, <4 x float> %197, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x float> %interleaved.vec368, <8 x float>* %200, align 4, !alias.scope !21, !noalias !23
  %index.next354 = add i64 %index353, 4
  %201 = icmp eq i64 %index.next354, %n.vec322
  br i1 %201, label %middle.block317, label %vector.body316, !llvm.loop !24

middle.block317:                                  ; preds = %vector.body316
  %cmp.n357 = icmp eq i64 %n.mod.vf321, 0
  br i1 %cmp.n357, label %._crit_edge.us, label %.preheader.us.new.preheader369

.preheader.us.new.preheader369:                   ; preds = %middle.block317, %vector.memcheck351, %min.iters.checked320, %.preheader.us.new.preheader
  %indvars.iv.us.ph = phi i64 [ %indvars.iv.us.unr.ph, %vector.memcheck351 ], [ %indvars.iv.us.unr.ph, %min.iters.checked320 ], [ %indvars.iv.us.unr.ph, %.preheader.us.new.preheader ], [ %ind.end356, %middle.block317 ]
  br label %.preheader.us.new

.preheader.us.new:                                ; preds = %.preheader.us.new.preheader369, %.preheader.us.new
  %indvars.iv.us = phi i64 [ %indvars.iv.next.us.1, %.preheader.us.new ], [ %indvars.iv.us.ph, %.preheader.us.new.preheader369 ]
  %202 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv218.us, i64 %indvars.iv.us
  %203 = load float, float* %202, align 4
  %204 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv218.us, i64 %indvars.iv.us
  %205 = load float, float* %204, align 4
  %206 = fadd float %203, %205
  %207 = getelementptr inbounds [2160 x float], [2160 x float]* %4, i64 %indvars.iv218.us, i64 %indvars.iv.us
  store float %206, float* %207, align 4
  %indvars.iv.next.us = add nuw nsw i64 %indvars.iv.us, 1
  %208 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv218.us, i64 %indvars.iv.next.us
  %209 = load float, float* %208, align 4
  %210 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv218.us, i64 %indvars.iv.next.us
  %211 = load float, float* %210, align 4
  %212 = fadd float %209, %211
  %213 = getelementptr inbounds [2160 x float], [2160 x float]* %4, i64 %indvars.iv218.us, i64 %indvars.iv.next.us
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %middle.block317, %.prol.loopexit
...
._crit_edge181:                                   ; preds = %._crit_edge181.loopexit, %.preheader172.lr.ph, %.preheader170.lr.ph, %.preheader176.lr.ph, %.preheader178.lr.ph, %.preheader174.lr.ph, %.preheader.lr.ph, %.preheader169
  ret void
}
