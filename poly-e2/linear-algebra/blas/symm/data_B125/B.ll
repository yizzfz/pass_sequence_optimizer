...
for.cond1.preheader.us:                           ; preds = %entry, %for.cond1.for.inc16_crit_edge.us
  %i.043.us = phi i32 [ %inc17.us, %for.cond1.for.inc16_crit_edge.us ], [ 0, %entry ]
  %idxprom.us = sext i32 %i.043.us to i64
  %add7.us = add nsw i32 %i.043.us, 1200
  br label %for.inc.us

for.inc.us:                                       ; preds = %for.inc.us, %for.cond1.preheader.us
  %indvars.iv63 = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next64, %for.inc.us ]
  %0 = add nuw nsw i64 %indvars.iv63, %idxprom.us
  %1 = trunc i64 %0 to i32
  %rem.us = srem i32 %1, 100
  %conv.us = sitofp i32 %rem.us to double
  %div.us = fdiv double %conv.us, 1.000000e+03
  %arrayidx6.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %idxprom.us, i64 %indvars.iv63
  ...
  %arrayidx15.us = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %idxprom.us, i64 %indvars.iv63
...
for.cond1.for.inc16_crit_edge.us:                 ; preds = %for.inc.us
  %inc17.us = add nsw i32 %i.043.us, 1
...
for.inc36.lr.ph:                                  ; preds = %for.inc36.lr.ph.preheader, %for.inc51
  ...
  %3 = sub nsw i64 0, %indvars.iv60
  %4 = trunc i64 %3 to i32
  %5 = add i32 %4, 7
  %6 = add i32 %4, 998
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  %xtraiter68 = and i64 %indvars.iv.next61, 1
...
for.inc48.prol.loopexit:                          ; preds = %for.inc48.prol.loopexit.loopexit, %for.inc48.lr.ph
  ...
  %9 = icmp ult i32 %6, 7
  br i1 %9, label %for.inc51, label %for.inc48.preheader

for.inc48.preheader:                              ; preds = %for.inc48.prol.loopexit
  %10 = sub i64 992, %indvars.iv51.unr
  %11 = lshr i64 %10, 3
  %12 = add nuw nsw i64 %11, 1
  %min.iters.check = icmp ult i64 %12, 2
  br i1 %min.iters.check, label %for.inc48.preheader70, label %min.iters.checked

for.inc48.preheader70:                            ; preds = %middle.block, %min.iters.checked, %for.inc48.preheader
...
min.iters.checked:                                ; preds = %for.inc48.preheader
  ...
  %13 = add i64 %indvars.iv51.unr, 8
  %14 = shl nuw i64 %11, 3
  %15 = add i64 %13, %14
  %16 = shl nuw nsw i64 %n.mod.vf, 3
  %ind.end = sub i64 %15, %16
  br i1 %cmp.zero, label %for.inc48.preheader70, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %17 = shl i64 %index, 3
  %18 = add i64 %indvars.iv51.unr, %17
  %19 = add nsw i64 %18, 7
  %20 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv60, i64 %19
  %21 = getelementptr double, double* %20, i64 -7
  %22 = bitcast double* %21 to <16 x double>*
  store <16 x double> <double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02>, <16 x double>* %22, align 8
  %index.next = add i64 %index, 2
  %23 = icmp eq i64 %index.next, %n.vec
  br i1 %23, label %middle.block, label %vector.body, !llvm.loop !3

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.mod.vf, 0
  br i1 %cmp.n, label %for.inc51, label %for.inc48.preheader70
...
for.inc36:                                        ; preds = %for.inc36.preheader, %for.inc36
  ...
  %24 = add nuw nsw i64 %indvars.iv, %indvars.iv60
  %25 = trunc i64 %24 to i32
  %rem28 = srem i32 %25, 100
  ...
  %26 = add nuw nsw i64 %indvars.iv.next, %indvars.iv60
  %27 = trunc i64 %26 to i32
  %rem28.1 = srem i32 %27, 100
  ...
  %28 = bitcast double* %arrayidx35 to <2 x double>*
  store <2 x double> %div31, <2 x double>* %28, align 8
...
for.inc48:                                        ; preds = %for.inc48.preheader70, %for.inc48
  %indvars.iv51 = phi i64 [ %indvars.iv.next52.7, %for.inc48 ], [ %indvars.iv51.ph, %for.inc48.preheader70 ]
...
for.cond1.preheader:                              ; preds = %entry, %for.inc53
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc53 ], [ 0, %entry ]
...
vector.memcheck:                                  ; preds = %for.cond1.preheader
  ...
  %scevgep59 = getelementptr [1200 x double], [1200 x double]* %B, i64 %indvars.iv49, i64 0
...
for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.cond4.for.inc50_crit_edge.us
  %j.037.us = phi i32 [ %inc51.us, %for.cond4.for.inc50_crit_edge.us ], [ 0, %for.cond4.preheader.us.preheader ]
  %idxprom7.us = sext i32 %j.037.us to i64
  %arrayidx8.us = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv49, i64 %idxprom7.us
  br label %for.inc.us
...
for.inc.us:                                       ; preds = %for.inc.us, %for.cond4.preheader.us
  ...
  %arrayidx12.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv49, i64 %indvars.iv43
  %28 = load double, double* %arrayidx12.us, align 8
  %mul13.us = fmul double %mul.us, %28
  %arrayidx17.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv43, i64 %idxprom7.us
  ...
  %arrayidx21.us = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv43, i64 %idxprom7.us
  ...
  %exitcond48 = icmp eq i64 %indvars.iv.next44, %indvars.iv49
...
for.cond4.for.inc50_crit_edge.us:                 ; preds = %for.inc.us
  %arrayidx31.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv49, i64 %idxprom7.us
  ...
  %inc51.us = add nsw i32 %j.037.us, 1
  %cmp2.us = icmp slt i32 %inc51.us, 1200
...
for.inc53:                                        ; preds = %for.inc53.loopexit80, %for.inc53.loopexit79, %for.inc53.loopexit
  ...
  %exitcond52 = icmp eq i64 %indvars.iv.next50, 1000
  br i1 %exitcond52, label %for.end55, label %for.cond1.preheader
...
for.cond2.preheader.us:                           ; preds = %entry, %for.cond2.for.inc10_crit_edge.us
  %i.011.us = phi i32 [ %inc11.us, %for.cond2.for.inc10_crit_edge.us ], [ 0, %entry ]
  %mul.us = mul nsw i32 %i.011.us, 1000
  %idxprom.us = sext i32 %i.011.us to i64
...
for.cond2.for.inc10_crit_edge.us:                 ; preds = %for.inc.us
  %inc11.us = add nsw i32 %i.011.us, 1
