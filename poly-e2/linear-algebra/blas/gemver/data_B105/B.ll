...
for.inc.us:                                       ; preds = %for.body.us, %for.inc.us
  ...
  %2 = mul nuw nsw i64 %indvars.iv11, %indvars.iv
  ...
  %4 = mul nuw nsw i64 %indvars.iv11, %indvars.iv.next
...
for.body25.us:                                    ; preds = %for.body25.us.preheader, %for.cond26.for.inc45_crit_edge.us
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.cond26.for.inc45_crit_edge.us ], [ 0, %for.body25.us.preheader ]
...
for.inc42.us:                                     ; preds = %for.body25.us, %for.inc42.us
  %indvars.iv46 = phi i64 [ %indvars.iv.next47.1, %for.inc42.us ], [ 0, %for.body25.us ]
...
for.inc58:                                        ; preds = %for.inc58.preheader, %for.inc58
  ...
  br i1 %exitcond45.3, label %for.body63.us.preheader.loopexit, label %for.inc58, !llvm.loop !23
...
for.body63.us:                                    ; preds = %for.body63.us.preheader, %for.cond64.for.inc83_crit_edge.us
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.cond64.for.inc83_crit_edge.us ], [ 0, %for.body63.us.preheader ]
...
for.inc80.us:                                     ; preds = %for.body63.us, %for.inc80.us
  ...
  %63 = phi double [ %add77.us.1, %for.inc80.us ], [ %.pre36, %for.body63.us ]
