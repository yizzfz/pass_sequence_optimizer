...
.lr.ph34.split.us:                                ; preds = %._crit_edge30.us, %.lr.ph34.split.us.preheader
  ...
  %sunkaddr115 = add i64 %4, %sunkaddr114
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph34.split.us
  ...
  store double %15, double* %sunkaddr116, align 8
  ...
  store double %18, double* %sunkaddr116, align 8
  ...
  store double %21, double* %sunkaddr116, align 8
...
._crit_edge30.us:                                 ; preds = %._crit_edge
  ...
  store double %22, double* %sunkaddr29, align 8
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  br i1 %39, label %._crit_edge25.us.loopexit30, label %vector.body, !llvm.loop !6
