...
for.body.lr.ph:
  ...
  br i1 %found.conflict, label %for.body.preheader, label %vector.body.preheader
...
for.cond1.preheader.us:                           ; preds = %for.inc33.us, %for.cond1.preheader.us.preheader
  %t.025.us = phi i32 [ 0, %for.cond1.preheader.us.preheader ], [ %inc34.us, %for.inc33.us ]
  br i1 %found.conflict60, label %for.body3.us.preheader, label %vector.body46.preheader

vector.body46.preheader:                          ; preds = %for.cond1.preheader.us
  br label %vector.body46

for.body3.us.preheader.loopexit:                  ; preds = %vector.body46
  br label %for.body3.us.preheader

for.body3.us.preheader:                           ; preds = %for.body3.us.preheader.loopexit, %for.cond1.preheader.us
  %indvars.iv.ph = phi i64 [ 1, %for.cond1.preheader.us ], [ 1997, %for.body3.us.preheader.loopexit ]
...
vector.body46:                                    ; preds = %vector.body46.preheader, %vector.body46
  ...
  br i1 %18, label %for.body3.us.preheader.loopexit, label %vector.body46, !llvm.loop !15
...
for.body16.us:                                    ; preds = %for.body16.us.preheader, %for.body16.us
  %indvars.iv28 = phi i64 [ %indvars.iv.next29.1, %for.body16.us ], [ %indvars.iv28.ph, %for.body16.us.preheader ]
  ...
  br i1 %exitcond31.1, label %for.inc33.us, label %for.body16.us, !llvm.loop !16

for.body3.us:                                     ; preds = %for.body3.us.preheader, %for.body3.us
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %for.body3.us ], [ %indvars.iv.ph, %for.body3.us.preheader ]
  ...
  br i1 %exitcond.1, label %vector.memcheck, label %for.body3.us, !llvm.loop !17
...
for.body16.us.preheader:                          ; preds = %for.body16.us.preheader.loopexit, %vector.memcheck
  %indvars.iv28.ph = phi i64 [ 1, %vector.memcheck ], [ 1997, %for.body16.us.preheader.loopexit ]
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  br i1 %51, label %for.body16.us.preheader.loopexit, label %vector.body, !llvm.loop !23
