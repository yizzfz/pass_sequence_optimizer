...
; <label>:11:                                     ; preds = %1
  ...
  %14 = call i8* @strchr(i8* %13, i32 58) #4
...
; <label>:27:                                     ; preds = %23
  ...
  %38 = sub i64 %36, %37
  %39 = call i32 @strncasecmp(i8* %28, i8* %33, i64 %38) #4
  %40 = icmp eq i32 %39, 0
...
; <label>:71:                                     ; preds = %11
  ...
  %74 = call i32 @strcmp(i8* %73, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.15, i32 0, i32 0)) #4
  %75 = icmp eq i32 %74, 0
...
; <label>:78:                                     ; preds = %71
  ...
  %81 = call i32 @strncmp(i8* %80, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.16, i32 0, i32 0), i64 5) #4
  %82 = icmp eq i32 %81, 0
...
; <label>:85:                                     ; preds = %78
  ...
  %88 = call i8* @strrchr(i8* %87, i32 46) #4
...
; <label>:98:                                     ; preds = %94
  ...
  %105 = call i32 @strcasecmp(i8* %99, i8* %104) #4
...
; Function Attrs: noinline nounwind uwtable
define i64 @audio_linear_round(i32, i32, %struct.audio_stats*) #0 {
...
; Function Attrs: noinline nounwind uwtable
define internal void @clip(i32*, %struct.audio_stats*) #0 {
...
; Function Attrs: noinline nounwind uwtable
define i64 @audio_linear_dither(i32, i32, %struct.audio_dither*, %struct.audio_stats*) #0 {
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal i64 @prng(i64) #0 {
...
; Function Attrs: noinline nounwind uwtable
define zeroext i8 @audio_mulaw_round(i32, %struct.audio_stats*) #0 {
...
; Function Attrs: noinline nounwind uwtable
define zeroext i8 @audio_mulaw_dither(i32, %struct.audio_dither*, %struct.audio_stats*) #0 {
