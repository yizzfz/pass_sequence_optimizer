...
._crit_edge.preheader:                            ; preds = %13, %5
  %indvars.iv2028 = phi i64 [ 0, %5 ], [ %indvars.iv.next21, %13 ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge.preheader
  %indvars.iv1727 = phi i64 [ 0, %._crit_edge.preheader ], [ %indvars.iv.next18, %._crit_edge ]
  %6 = mul nuw nsw i64 %indvars.iv1727, %indvars.iv2028
  %7 = add nuw nsw i64 %6, 1
  %8 = trunc i64 %7 to i32
  %9 = srem i32 %8, 1000
  %10 = sitofp i32 %9 to double
  %11 = fdiv double %10, 1.000000e+03
  %12 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv2028, i64 %indvars.iv1727
  store double %11, double* %12, align 8
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv1727, 1
  %exitcond19 = icmp eq i64 %indvars.iv.next18, 1100
  br i1 %exitcond19, label %13, label %._crit_edge

; <label>:13:                                     ; preds = %._crit_edge
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv2028, 1
  %exitcond22 = icmp eq i64 %indvars.iv.next21, 1000
  br i1 %exitcond22, label %._crit_edge5.preheader.preheader, label %._crit_edge.preheader
...
._crit_edge5.preheader:                           ; preds = %._crit_edge5.preheader.preheader, %._crit_edge4
  %indvars.iv1426 = phi i64 [ %indvars.iv.next15, %._crit_edge4 ], [ 0, %._crit_edge5.preheader.preheader ]
  br label %._crit_edge5

._crit_edge5:                                     ; preds = %._crit_edge5, %._crit_edge5.preheader
  %indvars.iv1125 = phi i64 [ 0, %._crit_edge5.preheader ], [ %indvars.iv.next12.1, %._crit_edge5 ]
  %indvars.iv.next12 = or i64 %indvars.iv1125, 1
  %14 = mul nuw nsw i64 %indvars.iv.next12, %indvars.iv1426
  %15 = trunc i64 %14 to i32
  %16 = srem i32 %15, 1200
  %17 = sitofp i32 %16 to double
  %18 = fdiv double %17, 1.200000e+03
  %19 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv1426, i64 %indvars.iv1125
  store double %18, double* %19, align 8
  %indvars.iv.next12.1 = add nsw i64 %indvars.iv1125, 2
  %20 = mul nuw nsw i64 %indvars.iv.next12.1, %indvars.iv1426
  %21 = trunc i64 %20 to i32
  %22 = srem i32 %21, 1200
  %23 = sitofp i32 %22 to double
  %24 = fdiv double %23, 1.200000e+03
  %25 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv1426, i64 %indvars.iv.next12
  store double %24, double* %25, align 8
  %exitcond13.1 = icmp eq i64 %indvars.iv.next12.1, 1200
  br i1 %exitcond13.1, label %._crit_edge4, label %._crit_edge5
...
._crit_edge4:                                     ; preds = %._crit_edge5
  ...
  br i1 %exitcond16, label %._crit_edge7.preheader.preheader, label %._crit_edge5.preheader
...
._crit_edge7.preheader:                           ; preds = %._crit_edge7.preheader.preheader, %._crit_edge6
  %indvars.iv824 = phi i64 [ %indvars.iv.next9, %._crit_edge6 ], [ 0, %._crit_edge7.preheader.preheader ]
  br label %._crit_edge7

._crit_edge7:                                     ; preds = %._crit_edge7, %._crit_edge7.preheader
  %indvars.iv23 = phi i64 [ 0, %._crit_edge7.preheader ], [ %indvars.iv.next, %._crit_edge7 ]
  %26 = add nuw nsw i64 %indvars.iv23, 2
  %27 = mul nuw nsw i64 %26, %indvars.iv824
  %28 = trunc i64 %27 to i32
  %29 = srem i32 %28, 1100
  %30 = sitofp i32 %29 to double
  %31 = fdiv double %30, 1.100000e+03
  %32 = getelementptr inbounds [1100 x double], [1100 x double]* %4, i64 %indvars.iv824, i64 %indvars.iv23
...
._crit_edge6:                                     ; preds = %._crit_edge7
  ...
  %exitcond10 = icmp eq i64 %indvars.iv.next9, 1200
  br i1 %exitcond10, label %33, label %._crit_edge7.preheader
...
._crit_edge.preheader:                            ; preds = %56, %5
  %indvars.iv1117 = phi i64 [ 0, %5 ], [ %6, %56 ]
  %scevgep = getelementptr [1100 x double], [1100 x double]* %2, i64 %indvars.iv1117, i64 0
  %6 = add i64 %indvars.iv1117, 1
  %scevgep2 = getelementptr [1100 x double], [1100 x double]* %2, i64 %6, i64 0
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge.preheader
  %indvars.iv14 = phi i64 [ 0, %._crit_edge.preheader ], [ %indvars.iv.next.4, %._crit_edge ]
  %7 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv1117, i64 %indvars.iv14
  %8 = load double, double* %7, align 8
  %9 = fmul double %8, %1
  store double %9, double* %7, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv14, 1
  %10 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv1117, i64 %indvars.iv.next
  %11 = load double, double* %10, align 8
  %12 = fmul double %11, %1
  store double %12, double* %10, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv14, 2
  %13 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv1117, i64 %indvars.iv.next.1
  %14 = load double, double* %13, align 8
  %15 = fmul double %14, %1
  store double %15, double* %13, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv14, 3
  %16 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv1117, i64 %indvars.iv.next.2
  %17 = load double, double* %16, align 8
  %18 = fmul double %17, %1
  store double %18, double* %16, align 8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv14, 4
  %19 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv1117, i64 %indvars.iv.next.3
...
._crit_edge4.preheader:                           ; preds = %._crit_edge4.preheader.preheader, %._crit_edge3
  %indvars.iv816 = phi i64 [ %22, %._crit_edge3 ], [ 0, %._crit_edge4.preheader.preheader ]
  %scevgep4 = getelementptr [1100 x double], [1100 x double]* %4, i64 %indvars.iv816, i64 0
  %22 = add i64 %indvars.iv816, 1
  %scevgep6 = getelementptr [1100 x double], [1100 x double]* %4, i64 %22, i64 0
  %23 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv1117, i64 %indvars.iv816
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %27 = getelementptr inbounds [1100 x double], [1100 x double]* %4, i64 %indvars.iv816, i64 %offset.idx
  ...
  %30 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv1117, i64 %offset.idx
  ...
  %35 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv1117, i64 %33
  ...
  br i1 %39, label %._crit_edge3.loopexit19, label %vector.body, !llvm.loop !9

._crit_edge4:                                     ; preds = %._crit_edge4.preheader18, %._crit_edge4
  %indvars.iv515 = phi i64 [ %indvars.iv.next6.1, %._crit_edge4 ], [ 0, %._crit_edge4.preheader18 ]
  %40 = load double, double* %23, align 8
  %41 = fmul double %40, %0
  %42 = getelementptr inbounds [1100 x double], [1100 x double]* %4, i64 %indvars.iv816, i64 %indvars.iv515
  %43 = load double, double* %42, align 8
  %44 = fmul double %41, %43
  %45 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv1117, i64 %indvars.iv515
  ...
  %49 = fmul double %48, %0
  %50 = getelementptr inbounds [1100 x double], [1100 x double]* %4, i64 %indvars.iv816, i64 %indvars.iv.next6
  %51 = load double, double* %50, align 8
  %52 = fmul double %49, %51
  %53 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv1117, i64 %indvars.iv.next6
  %54 = load double, double* %53, align 8
  %55 = fadd double %54, %52
  store double %55, double* %53, align 8
  %indvars.iv.next6.1 = add nsw i64 %indvars.iv515, 2
  %exitcond7.1 = icmp eq i64 %indvars.iv.next6.1, 1100
  br i1 %exitcond7.1, label %._crit_edge3.loopexit, label %._crit_edge4, !llvm.loop !12
...
._crit_edge3:                                     ; preds = %._crit_edge3.loopexit19, %._crit_edge3.loopexit
  %exitcond10 = icmp eq i64 %22, 1200
  br i1 %exitcond10, label %56, label %._crit_edge4.preheader

; <label>:56:                                     ; preds = %._crit_edge3
  %exitcond13 = icmp eq i64 %6, 1000
  br i1 %exitcond13, label %57, label %._crit_edge.preheader
...
._crit_edge.preheader:                            ; preds = %18, %1
  %indvars.iv37 = phi i64 [ 0, %1 ], [ %indvars.iv.next4, %18 ]
  %6 = mul nuw nsw i64 %indvars.iv37, 1000
  br label %7

; <label>:7:                                      ; preds = %._crit_edge2, %._crit_edge.preheader
  %indvars.iv6 = phi i64 [ 0, %._crit_edge.preheader ], [ %indvars.iv.next, %._crit_edge2 ]
  %8 = add nuw nsw i64 %indvars.iv6, %6
...
._crit_edge2:                                     ; preds = %7, %12
  ...
  %15 = getelementptr inbounds [1100 x double], [1100 x double]* %0, i64 %indvars.iv37, i64 %indvars.iv6
...
; <label>:18:                                     ; preds = %._crit_edge2
  ...
  br i1 %exitcond5, label %19, label %._crit_edge.preheader
