...
._crit_edge44:                                    ; preds = %._crit_edge44, %._crit_edge44.preheader
  ...
  %18 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv59, i64 %indvars.iv56
  %indvars.iv.next57.1 = add nsw i64 %indvars.iv56, 2
  %19 = mul nuw nsw i64 %indvars.iv.next57.1, %indvars.iv59
...
._crit_edge46:                                    ; preds = %._crit_edge46, %._crit_edge46.preheader
  ...
  %28 = mul nuw nsw i64 %27, %indvars.iv53
  %29 = trunc i64 %28 to i32
  %30 = srem i32 %29, 1100
  %31 = sitofp i32 %30 to double
  %32 = fdiv double %31, 1.100000e+03
  %33 = getelementptr inbounds [1100 x double], [1100 x double]* %4, i64 %indvars.iv53, i64 %indvars.iv
...
._crit_edge45:                                    ; preds = %._crit_edge46
  ...
  br i1 %exitcond55, label %34, label %._crit_edge46.preheader
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge.preheader
  ...
  %9 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv37, i64 %indvars.iv
  ...
  %17 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv37, i64 %indvars.iv.next.3
...
._crit_edge28.preheader:                          ; preds = %._crit_edge28.preheader.preheader, %._crit_edge27
  %indvars.iv35 = phi i64 [ %20, %._crit_edge27 ], [ 0, %._crit_edge28.preheader.preheader ]
  %scevgep4 = getelementptr [1100 x double], [1100 x double]* %4, i64 %indvars.iv35, i64 0
  %20 = add i64 %indvars.iv35, 1
  %scevgep6 = getelementptr [1100 x double], [1100 x double]* %4, i64 %20, i64 0
  %21 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv37, i64 %indvars.iv35
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %26 = getelementptr inbounds [1100 x double], [1100 x double]* %4, i64 %indvars.iv35, i64 %offset.idx
  ...
  %29 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv37, i64 %offset.idx
  ...
  %34 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv37, i64 %32
  ...
  br i1 %38, label %._crit_edge27.loopexit19, label %vector.body, !llvm.loop !9
...
._crit_edge28:                                    ; preds = %._crit_edge28.preheader18, %._crit_edge28
  ...
  %40 = fmul double %39, %0
  %41 = getelementptr inbounds [1100 x double], [1100 x double]* %4, i64 %indvars.iv35, i64 %indvars.iv33
  %42 = load double, double* %41, align 8
  %43 = fmul double %40, %42
  %44 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv37, i64 %indvars.iv33
  ...
  %48 = fmul double %47, %0
  %49 = getelementptr inbounds [1100 x double], [1100 x double]* %4, i64 %indvars.iv35, i64 %indvars.iv.next34
  %50 = load double, double* %49, align 8
  %51 = fmul double %48, %50
  %52 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv37, i64 %indvars.iv.next34
...
._crit_edge27:                                    ; preds = %._crit_edge27.loopexit19, %._crit_edge27.loopexit
  %exitcond = icmp eq i64 %20, 1200
  br i1 %exitcond, label %55, label %._crit_edge28.preheader

; <label>:55:                                     ; preds = %._crit_edge27
  %exitcond39 = icmp eq i64 %8, 1000
  br i1 %exitcond39, label %56, label %._crit_edge.preheader
