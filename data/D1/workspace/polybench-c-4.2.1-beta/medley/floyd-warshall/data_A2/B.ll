...
define internal fastcc void @init_array(i32, [2800 x i32]* nocapture) unnamed_addr #2 {
  %3 = icmp sgt i32 %0, 0
  br i1 %3, label %.preheader.us.preheader, label %.._crit_edge8_crit_edge
...
.preheader.us:                                    ; preds = %._crit_edge.us..preheader.us_crit_edge, %.preheader.us.preheader
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %._crit_edge.us..preheader.us_crit_edge ], [ 0, %.preheader.us.preheader ]
  br label %4
...
._crit_edge.us:                                   ; preds = %4
  ...
  br i1 %exitcond12, label %._crit_edge8.loopexit, label %._crit_edge.us..preheader.us_crit_edge
...
define internal fastcc void @kernel_floyd_warshall(i32, [2800 x i32]* nocapture) unnamed_addr #2 {
  %3 = icmp sgt i32 %0, 0
  br i1 %3, label %.preheader.us.us.preheader.preheader, label %.._crit_edge8_crit_edge
...
.preheader.us.us.preheader:                       ; preds = %._crit_edge6.us..preheader.us.us.preheader_crit_edge, %.preheader.us.us.preheader.preheader
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %._crit_edge6.us..preheader.us.us.preheader_crit_edge ], [ 0, %.preheader.us.us.preheader.preheader ]
...
; <label>:17:                                     ; preds = %._crit_edge, %15
  ...
  %21 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %18, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i64 0, i64 0), i32 %20) #6
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, %wide.trip.count
