...
._crit_edge:                                      ; preds = %._crit_edge, %2
  %indvars.iv44 = phi i64 [ 0, %2 ], [ %indvars.iv.next5.2, %._crit_edge ]
  %3 = trunc i64 %indvars.iv44 to i32
  %4 = sitofp i32 %3 to double
  %5 = getelementptr inbounds double, double* %1, i64 %indvars.iv44
  ...
  %indvars.iv.next5.1 = add nsw i64 %indvars.iv44, 2
  ...
  %indvars.iv.next5.2 = add nsw i64 %indvars.iv44, 3
  %exitcond6.2 = icmp eq i64 %indvars.iv.next5.2, 2100
  br i1 %exitcond6.2, label %.preheader.preheader.preheader, label %._crit_edge

.preheader.preheader.preheader:                   ; preds = %._crit_edge
  br label %.preheader.preheader

.preheader.preheader:                             ; preds = %.preheader.preheader.preheader, %.preheader1
  %indvars.iv13 = phi i64 [ %indvars.iv.next2, %.preheader1 ], [ 0, %.preheader.preheader.preheader ]
  br label %.preheader

.preheader:                                       ; preds = %.preheader, %.preheader.preheader
  %indvars.iv2 = phi i64 [ 0, %.preheader.preheader ], [ %indvars.iv.next.1, %.preheader ]
  %18 = add nuw nsw i64 %indvars.iv13, %indvars.iv2
  %19 = trunc i64 %18 to i32
  %20 = srem i32 %19, 2100
  %21 = sitofp i32 %20 to double
  %22 = getelementptr inbounds [2100 x double], [2100 x double]* %0, i64 %indvars.iv13, i64 %indvars.iv2
  %indvars.iv.next = or i64 %indvars.iv2, 1
  %23 = add nuw nsw i64 %indvars.iv13, %indvars.iv.next
...
.preheader1:                                      ; preds = %.preheader
  ...
  br i1 %exitcond3, label %31, label %.preheader.preheader
...
.preheader1:                                      ; preds = %._crit_edge
  ...
  %sunkaddr5.1 = ptrtoint double* %3 to i64
  br label %._crit_edge15

._crit_edge:                                      ; preds = %._crit_edge, %4
  %indvars.iv712 = phi i64 [ 0, %4 ], [ %indvars.iv.next8.11, %._crit_edge ]
  %11 = getelementptr inbounds double, double* %2, i64 %indvars.iv712
  store double 0.000000e+00, double* %11, align 8
  %indvars.iv.next8 = or i64 %indvars.iv712, 1
  %12 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8
  store double 0.000000e+00, double* %12, align 8
  %indvars.iv.next8.1 = or i64 %indvars.iv712, 2
  %13 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.1
  store double 0.000000e+00, double* %13, align 8
  %indvars.iv.next8.2 = or i64 %indvars.iv712, 3
  %14 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.2
  store double 0.000000e+00, double* %14, align 8
  %indvars.iv.next8.3 = add nsw i64 %indvars.iv712, 4
  %15 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.3
  store double 0.000000e+00, double* %15, align 8
  %indvars.iv.next8.4 = add nsw i64 %indvars.iv712, 5
  %16 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.4
  store double 0.000000e+00, double* %16, align 8
  %indvars.iv.next8.5 = add nsw i64 %indvars.iv712, 6
  %17 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.5
  store double 0.000000e+00, double* %17, align 8
  %indvars.iv.next8.6 = add nsw i64 %indvars.iv712, 7
  %18 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.6
  store double 0.000000e+00, double* %18, align 8
  %indvars.iv.next8.7 = add nsw i64 %indvars.iv712, 8
  %19 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.7
  store double 0.000000e+00, double* %19, align 8
  %indvars.iv.next8.8 = add nsw i64 %indvars.iv712, 9
  %20 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.8
  store double 0.000000e+00, double* %20, align 8
  %indvars.iv.next8.9 = add nsw i64 %indvars.iv712, 10
  %21 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.9
  store double 0.000000e+00, double* %21, align 8
  %indvars.iv.next8.10 = add nsw i64 %indvars.iv712, 11
  %22 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.10
  store double 0.000000e+00, double* %22, align 8
  %indvars.iv.next8.11 = add nsw i64 %indvars.iv712, 12
  %exitcond9.11 = icmp eq i64 %indvars.iv.next8.11, 2100
  br i1 %exitcond9.11, label %.preheader1, label %._crit_edge

._crit_edge15:                                    ; preds = %52, %.preheader1
  %indvars.iv411 = phi i64 [ 0, %.preheader1 ], [ %indvars.iv.next5, %52 ]
  %23 = getelementptr inbounds double, double* %3, i64 %indvars.iv411
  store double 0.000000e+00, double* %23, align 8
  %sunkaddr2 = shl nuw nsw i64 %indvars.iv411, 3
  %sunkaddr3 = add i64 %sunkaddr, %sunkaddr2
  %sunkaddr4 = inttoptr i64 %sunkaddr3 to double*
  %sunkaddr2.1 = shl nuw nsw i64 %indvars.iv411, 3
  %sunkaddr3.1 = add i64 %sunkaddr.1, %sunkaddr2.1
  %sunkaddr4.1 = inttoptr i64 %sunkaddr3.1 to double*
  br label %._crit_edge13

._crit_edge13:                                    ; preds = %._crit_edge13, %._crit_edge15
  %indvars.iv9 = phi i64 [ 0, %._crit_edge15 ], [ %indvars.iv.next.1, %._crit_edge13 ]
  %24 = load double, double* %sunkaddr4, align 8
  %25 = getelementptr inbounds [2100 x double], [2100 x double]* %8, i64 %indvars.iv411, i64 %indvars.iv9
  %26 = load double, double* %25, align 8
  %27 = getelementptr inbounds double, double* %9, i64 %indvars.iv9
  %28 = load double, double* %27, align 8
  %29 = fmul double %26, %28
  %30 = fadd double %24, %29
  store double %30, double* %sunkaddr4, align 8
  %indvars.iv.next = or i64 %indvars.iv9, 1
  %31 = load double, double* %sunkaddr4.1, align 8
  %32 = getelementptr inbounds [2100 x double], [2100 x double]* %8, i64 %indvars.iv411, i64 %indvars.iv.next
  %33 = load double, double* %32, align 8
  %34 = getelementptr inbounds double, double* %9, i64 %indvars.iv.next
  %35 = load double, double* %34, align 8
  %36 = fmul double %33, %35
  %37 = fadd double %31, %36
  store double %37, double* %sunkaddr4.1, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv9, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2100
  br i1 %exitcond.1, label %.preheader.preheader, label %._crit_edge13

.preheader.preheader:                             ; preds = %._crit_edge13
  %sunkaddr6 = shl nuw nsw i64 %indvars.iv411, 3
  %sunkaddr7 = add i64 %sunkaddr5, %sunkaddr6
  %sunkaddr8 = inttoptr i64 %sunkaddr7 to double*
  %sunkaddr6.1 = shl nuw nsw i64 %indvars.iv411, 3
  %sunkaddr7.1 = add i64 %sunkaddr5.1, %sunkaddr6.1
  %sunkaddr8.1 = inttoptr i64 %sunkaddr7.1 to double*
  br label %.preheader

.preheader:                                       ; preds = %.preheader, %.preheader.preheader
  %indvars.iv110 = phi i64 [ 0, %.preheader.preheader ], [ %indvars.iv.next2.1, %.preheader ]
  %38 = getelementptr inbounds double, double* %10, i64 %indvars.iv110
  %39 = load double, double* %38, align 8
  %40 = getelementptr inbounds [2100 x double], [2100 x double]* %8, i64 %indvars.iv411, i64 %indvars.iv110
  %41 = load double, double* %40, align 8
  %42 = load double, double* %sunkaddr8, align 8
  %43 = fmul double %41, %42
  %44 = fadd double %39, %43
  store double %44, double* %38, align 8
  %indvars.iv.next2 = or i64 %indvars.iv110, 1
  %45 = getelementptr inbounds double, double* %10, i64 %indvars.iv.next2
  %46 = load double, double* %45, align 8
  %47 = getelementptr inbounds [2100 x double], [2100 x double]* %8, i64 %indvars.iv411, i64 %indvars.iv.next2
  %48 = load double, double* %47, align 8
  %49 = load double, double* %sunkaddr8.1, align 8
  %50 = fmul double %48, %49
  %51 = fadd double %46, %50
  store double %51, double* %45, align 8
  %indvars.iv.next2.1 = add nsw i64 %indvars.iv110, 2
  %exitcond3.1 = icmp eq i64 %indvars.iv.next2.1, 2100
  br i1 %exitcond3.1, label %52, label %.preheader

; <label>:52:                                     ; preds = %.preheader
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv411, 1
  %exitcond6 = icmp eq i64 %indvars.iv.next5, 1900
  br i1 %exitcond6, label %53, label %._crit_edge15
