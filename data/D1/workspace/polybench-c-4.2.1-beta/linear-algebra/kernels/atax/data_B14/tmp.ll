...
._crit_edge1:                                     ; preds = %._crit_edge1, %.lr.ph
  ...
  store double %24, double* %sunkaddr29, align 8
...
.lr.ph2:                                          ; preds = %.lr.ph2.preheader, %._crit_edge15
  %25 = phi double [ %.pre, %._crit_edge15 ], [ %24, %.lr.ph2.preheader ]
  %indvars.iv7 = phi i64 [ %indvars.iv.next8.2, %._crit_edge15 ], [ 0, %.lr.ph2.preheader ]
  %26 = getelementptr inbounds double, double* %2, i64 %indvars.iv7
  %27 = load double, double* %26, align 8
  %28 = getelementptr inbounds [2100 x double], [2100 x double]* %0, i64 %indvars.iv10, i64 %indvars.iv7
  ...
  %36 = load double, double* %sunkaddr29, align 8
  ...
  %43 = load double, double* %sunkaddr29, align 8
  %44 = fmul double %42, %43
  %45 = fadd double %40, %44
  store double %45, double* %39, align 8
  %indvars.iv.next8.2 = add nuw nsw i64 %indvars.iv7, 3
  %exitcond.29 = icmp eq i64 %indvars.iv.next8.2, 2100
  br i1 %exitcond.29, label %._crit_edge, label %._crit_edge15

._crit_edge15:                                    ; preds = %.lr.ph2
  %.pre = load double, double* %sunkaddr29, align 8
  br label %.lr.ph2
