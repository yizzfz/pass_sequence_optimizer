...
entry:
  ...
  %arraydecay6 = bitcast i8* %call to [2800 x i32]*
  tail call fastcc void @init_array([2800 x i32]* %arraydecay6)
  tail call void (...) @polybench_timer_start() #4
  tail call fastcc void @kernel_floyd_warshall([2800 x i32]* %arraydecay6)
...
if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array([2800 x i32]* %arraydecay6)
  br label %if.end
...
define internal fastcc void @init_array([2800 x i32]* %path) unnamed_addr #2 {
entry:
  br label %for.cond1.preheader

for.cond1.preheader:                              ; preds = %for.inc20, %entry
  %indvars.iv24 = phi i64 [ 0, %entry ], [ %indvars.iv.next25, %for.inc20 ]
  %arrayidx = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv24
  %sunkaddr = ptrtoint [2800 x i32]* %arrayidx to i64
  br label %for.body3

for.body3:                                        ; preds = %for.inc, %for.cond1.preheader
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next, %for.inc ]
  %0 = mul nuw nsw i64 %indvars.iv, %indvars.iv24
  %1 = trunc i64 %0 to i32
  %rem = srem i32 %1, 7
  %add = add nsw i32 %rem, 1
  %arrayidx5 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv24, i64 %indvars.iv
  ...
  %or.cond19 = or i1 %cmp15, %or.cond
  br i1 %or.cond19, label %if.then, label %for.inc

if.then:                                          ; preds = %for.body3
  %sunkaddr16 = shl nsw i64 %indvars.iv, 2
  %sunkaddr17 = add i64 %sunkaddr16, %sunkaddr
  %sunkaddr18 = inttoptr i64 %sunkaddr17 to i32*
  store i32 999, i32* %sunkaddr18, align 4
  br label %for.inc
...
for.inc20:                                        ; preds = %for.inc
  ...
  %exitcond1 = icmp eq i64 %indvars.iv.next25, 2800
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc void @kernel_floyd_warshall([2800 x i32]* %path) unnamed_addr #2 {
entry:
  br label %for.cond1.preheader

for.cond1.preheader:                              ; preds = %for.inc38, %entry
  %indvars.iv32 = phi i64 [ 0, %entry ], [ %indvars.iv.next33, %for.inc38 ]
  br label %for.cond4.preheader

for.cond4.preheader:                              ; preds = %for.inc35, %for.cond1.preheader
  %indvars.iv30 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next31, %for.inc35 ]
  %arrayidx = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv30
  %arrayidx12 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv30, i64 %indvars.iv32
  %sunkaddr = ptrtoint [2800 x i32]* %arrayidx to i64
  br label %for.body6

for.body6:                                        ; preds = %for.body6, %for.cond4.preheader
  %indvars.iv = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next.1, %for.body6 ]
  %arrayidx8 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv30, i64 %indvars.iv
  ...
  %sunkaddr24 = shl nsw i64 %indvars.iv, 2
  %sunkaddr25 = add i64 %sunkaddr24, %sunkaddr
  %sunkaddr26 = inttoptr i64 %sunkaddr25 to i32*
  store i32 %.add, i32* %sunkaddr26, align 4
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx8.1 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv30, i64 %indvars.iv.next
  ...
  %sunkaddr24.1 = shl nsw i64 %indvars.iv.next, 2
  %sunkaddr25.1 = add i64 %sunkaddr24.1, %sunkaddr
  %sunkaddr26.1 = inttoptr i64 %sunkaddr25.1 to i32*
  store i32 %.add.1, i32* %sunkaddr26.1, align 4
...
for.inc35:                                        ; preds = %for.body6
  ...
  %exitcond1 = icmp eq i64 %indvars.iv.next31, 2800
  br i1 %exitcond1, label %for.inc38, label %for.cond4.preheader

for.inc38:                                        ; preds = %for.inc35
  %indvars.iv.next33 = add nuw nsw i64 %indvars.iv32, 1
  %exitcond2 = icmp eq i64 %indvars.iv.next33, 2800
