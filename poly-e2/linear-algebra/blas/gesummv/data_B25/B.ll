...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  br i1 %cmp, label %for.body, label %for.cond.for.end26_crit_edge.loopexit23
...
for.cond.for.end26_crit_edge.loopexit23:          ; preds = %for.body
  br label %for.cond.for.end26_crit_edge

for.cond.for.end26_crit_edge:                     ; preds = %for.cond.for.end26_crit_edge.loopexit23, %for.cond.for.end26_crit_edge.loopexit
  %inc25.lcssa = phi i32 [ %19, %for.cond.for.end26_crit_edge.loopexit ], [ %inc25, %for.cond.for.end26_crit_edge.loopexit23 ]
...
for.body.us:                                      ; preds = %for.cond5.for.inc39_crit_edge.us, %for.body.us.preheader
  ...
  %sunkaddr24 = add i64 %10, %sunkaddr
  %sunkaddr25 = inttoptr i64 %sunkaddr24 to double*
  %sunkaddr26 = shl i64 %indvars.iv9, 3
...
for.inc.us:                                       ; preds = %for.inc.us, %for.body.us
  ...
  %21 = load double, double* %sunkaddr25, align 8
  %add.us = fadd double %mul.us, %21
  store double %add.us, double* %sunkaddr25, align 8
  ...
  %24 = load double, double* %sunkaddr28, align 8
  %add27.us = fadd double %mul24.us, %24
  store double %add27.us, double* %sunkaddr28, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.body:                                         ; preds = %for.body, %for.body.preheader
  ...
  br i1 %cmp, label %for.body, label %for.cond.for.end41_crit_edge.loopexit31

for.cond.for.end41_crit_edge.loopexit:            ; preds = %for.cond5.for.inc39_crit_edge.us
  br label %for.cond.for.end41_crit_edge

for.cond.for.end41_crit_edge.loopexit31:          ; preds = %for.body
  br label %for.cond.for.end41_crit_edge

for.cond.for.end41_crit_edge:                     ; preds = %for.cond.for.end41_crit_edge.loopexit31, %for.cond.for.end41_crit_edge.loopexit
  %inc40.lcssa.in = phi i64 [ %indvars.iv.next10, %for.cond.for.end41_crit_edge.loopexit ], [ %indvars.iv.next13, %for.cond.for.end41_crit_edge.loopexit31 ]
