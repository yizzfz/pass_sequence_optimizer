...
entry:
  ...
  br i1 %cmp18, label %for.body.lr.ph, label %for.end36
...
for.body.us:                                      ; preds = %for.cond22.for.cond.loopexit_crit_edge.us, %for.body.lr.ph
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.cond22.for.cond.loopexit_crit_edge.us ], [ 0, %for.body.lr.ph ]
  %2 = trunc i64 %indvars.iv21 to i32
  %conv.us = sitofp i32 %2 to double
  %div.us = fdiv double %conv.us, %conv1
  %arrayidx.us = getelementptr inbounds double, double* %x1, i64 %indvars.iv21
  store double %div.us, double* %arrayidx.us, align 8
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  %3 = icmp eq i64 %indvars.iv.next22, %0
  %4 = trunc i64 %indvars.iv.next22 to i32
  %5 = sitofp i32 %4 to double
  %conv3.us = select i1 %3, double 0.000000e+00, double %5
  %div5.us = fdiv double %conv3.us, %conv1
  %arrayidx7.us = getelementptr inbounds double, double* %x2, i64 %indvars.iv21
  store double %div5.us, double* %arrayidx7.us, align 8
  %6 = add nuw nsw i64 %indvars.iv21, 3
  %7 = trunc i64 %6 to i32
  %rem9.us = srem i32 %7, %n
  %conv10.us = sitofp i32 %rem9.us to double
  %div12.us = fdiv double %conv10.us, %conv1
  %arrayidx14.us = getelementptr inbounds double, double* %y_1, i64 %indvars.iv21
  store double %div12.us, double* %arrayidx14.us, align 8
  %8 = add nuw nsw i64 %indvars.iv21, 4
  %9 = trunc i64 %8 to i32
  %rem16.us = srem i32 %9, %n
  %conv17.us = sitofp i32 %rem16.us to double
  %div19.us = fdiv double %conv17.us, %conv1
  %arrayidx21.us = getelementptr inbounds double, double* %y_2, i64 %indvars.iv21
...
for.body25.us.prol:                               ; preds = %for.body.us
  %arrayidx33.us.prol = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv21, i64 0
...
for.body25.us:                                    ; preds = %for.body25.us.preheader, %for.body25.us
  ...
  %10 = mul nuw nsw i64 %indvars.iv, %indvars.iv21
  %11 = trunc i64 %10 to i32
  %rem26.us = srem i32 %11, %n
  %conv27.us = sitofp i32 %rem26.us to double
  %div29.us = fdiv double %conv27.us, %conv1
  %arrayidx33.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv21, i64 %indvars.iv
  store double %div29.us, double* %arrayidx33.us, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %12 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv21
  %13 = trunc i64 %12 to i32
  %rem26.us.1 = srem i32 %13, %n
  %conv27.us.1 = sitofp i32 %rem26.us.1 to double
  %div29.us.1 = fdiv double %conv27.us.1, %conv1
  %arrayidx33.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv21, i64 %indvars.iv.next
...
for.cond22.for.cond.loopexit_crit_edge.us:        ; preds = %for.cond22.for.cond.loopexit_crit_edge.us.loopexit, %for.body25.us.prol.loopexit
  %exitcond26 = icmp eq i64 %indvars.iv.next22, %0
  br i1 %exitcond26, label %for.end36.loopexit, label %for.body.us
...
entry:
  ...
  br i1 %cmp26, label %for.cond1.preheader.us.preheader, label %for.end38

for.cond1.preheader.us.preheader:                 ; preds = %entry
  %0 = zext i32 %n to i64
  %xtraiter35 = and i32 %n, 1
  %lcmp.mod36 = icmp eq i32 %xtraiter35, 0
  %1 = icmp eq i32 %n, 1
  %wide.trip.count33.1 = zext i32 %n to i64
  br label %for.cond1.preheader.us

for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc12_crit_edge.us, %for.cond1.preheader.us.preheader
  %indvars.iv37 = phi i64 [ 0, %for.cond1.preheader.us.preheader ], [ %indvars.iv.next38, %for.cond1.for.inc12_crit_edge.us ]
  %arrayidx.us = getelementptr inbounds double, double* %x1, i64 %indvars.iv37
  br i1 %lcmp.mod36, label %for.body3.us.prol.loopexit, label %for.body3.us.prol

for.body3.us.prol:                                ; preds = %for.cond1.preheader.us
  %2 = load double, double* %arrayidx.us, align 8
  %arrayidx7.us.prol = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv37, i64 0
...
for.body3.us.prol.loopexit:                       ; preds = %for.body3.us.prol, %for.cond1.preheader.us
  %indvars.iv31.unr.ph = phi i64 [ 1, %for.body3.us.prol ], [ 0, %for.cond1.preheader.us ]
...
for.body3.us:                                     ; preds = %for.body3.us.preheader, %for.body3.us
  %indvars.iv31 = phi i64 [ %indvars.iv.next32.1, %for.body3.us ], [ %indvars.iv31.unr.ph, %for.body3.us.preheader ]
  %5 = load double, double* %arrayidx.us, align 8
  %arrayidx7.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv37, i64 %indvars.iv31
  %6 = load double, double* %arrayidx7.us, align 8
  %arrayidx9.us = getelementptr inbounds double, double* %y_1, i64 %indvars.iv31
  ...
  %arrayidx7.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv37, i64 %indvars.iv.next32
  %8 = load double, double* %arrayidx7.us.1, align 8
  %arrayidx9.us.1 = getelementptr inbounds double, double* %y_1, i64 %indvars.iv.next32
  ...
  br i1 %exitcond34.1, label %for.cond1.for.inc12_crit_edge.us.loopexit, label %for.body3.us
...
for.cond1.for.inc12_crit_edge.us:                 ; preds = %for.cond1.for.inc12_crit_edge.us.loopexit, %for.body3.us.prol.loopexit
  ...
  %exitcond = icmp eq i64 %indvars.iv.next38, %0
...
for.cond15.preheader:                             ; preds = %for.cond1.for.inc12_crit_edge.us
  %cmp1622 = icmp sgt i32 %n, 0
  br i1 %cmp1622, label %for.cond18.preheader.us.preheader, label %for.end38
...
for.cond18.preheader.us:                          ; preds = %for.cond18.for.inc36_crit_edge.us, %for.cond18.preheader.us.preheader
  %indvars.iv28 = phi i64 [ 0, %for.cond18.preheader.us.preheader ], [ %indvars.iv.next29, %for.cond18.for.inc36_crit_edge.us ]
  %arrayidx22.us = getelementptr inbounds double, double* %x2, i64 %indvars.iv28
...
for.body20.us.prol:                               ; preds = %for.cond18.preheader.us
  ...
  %arrayidx26.us.prol = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 0, i64 %indvars.iv28
...
for.body20.us:                                    ; preds = %for.body20.us.preheader, %for.body20.us
  ...
  %arrayidx26.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv, i64 %indvars.iv28
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx26.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv.next, i64 %indvars.iv28
...
for.cond18.for.inc36_crit_edge.us:                ; preds = %for.cond18.for.inc36_crit_edge.us.loopexit, %for.body20.us.prol.loopexit
  ...
  %exitcond41 = icmp eq i64 %indvars.iv.next29, %10
  br i1 %exitcond41, label %for.end38.loopexit, label %for.cond18.preheader.us
...
for.body:                                         ; preds = %if.end, %for.body.preheader
  %indvars.iv15 = phi i64 [ 0, %for.body.preheader ], [ %indvars.iv.next16, %if.end ]
...
if.end:                                           ; preds = %for.body, %if.then
  ...
  %arrayidx = getelementptr inbounds double, double* %x1, i64 %indvars.iv15
  ...
  %exitcond = icmp eq i64 %indvars.iv.next16, %3
...
for.end:                                          ; preds = %for.end.loopexit, %entry
  ...
  %cmp811 = icmp sgt i32 %n, 0
  br i1 %cmp811, label %for.body9.preheader, label %for.end20
...
if.end14:                                         ; preds = %for.body9, %if.then12
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond19 = icmp eq i64 %indvars.iv.next, %10
  br i1 %exitcond19, label %for.end20.loopexit, label %for.body9
