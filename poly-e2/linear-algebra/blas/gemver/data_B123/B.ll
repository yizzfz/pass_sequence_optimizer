...
for.inc.us:                                       ; preds = %for.body.us, %for.inc.us
  ...
  %2 = mul nuw nsw i64 %indvars.iv5, %indvars.iv
  %3 = trunc i64 %2 to i32
  %rem.us = srem i32 %3, 2000
  %conv39.us = sitofp i32 %rem.us to double
  %arrayidx45.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv5, i64 %indvars.iv
  %indvars.iv.next = or i64 %indvars.iv, 1
  %4 = mul nuw nsw i64 %indvars.iv5, %indvars.iv.next
  ...
  br i1 %exitcond9.1, label %for.cond35.for.inc46_crit_edge.us, label %for.inc.us

for.cond35.for.inc46_crit_edge.us:                ; preds = %for.inc.us
  %exitcond8 = icmp eq i64 %indvars.iv.next6, 2000
  br i1 %exitcond8, label %for.end48, label %for.body.us
...
for.body.us:                                      ; preds = %for.cond1.for.inc20_crit_edge.us, %entry
  %indvars.iv31 = phi i64 [ 0, %entry ], [ %0, %for.cond1.for.inc20_crit_edge.us ]
  %scevgep = getelementptr [2000 x double], [2000 x double]* %A, i64 %indvars.iv31, i64 0
  %0 = add i64 %indvars.iv31, 1
  %scevgep2 = getelementptr [2000 x double], [2000 x double]* %A, i64 %0, i64 0
  %arrayidx7.us = getelementptr inbounds double, double* %u1, i64 %indvars.iv31
  %arrayidx11.us = getelementptr inbounds double, double* %u2, i64 %indvars.iv31
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv31, i64 %offset.idx
  ...
  %18 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv31, i64 %17
...
for.inc.us:                                       ; preds = %for.inc.us.preheader, %for.inc.us
  %indvars.iv27 = phi i64 [ %indvars.iv.next28.1, %for.inc.us ], [ 0, %for.inc.us.preheader ]
  %arrayidx5.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv31, i64 %indvars.iv27
  %26 = load double, double* %arrayidx5.us, align 8
  %27 = load double, double* %arrayidx7.us, align 8
  %arrayidx9.us = getelementptr inbounds double, double* %v1, i64 %indvars.iv27
  ...
  %arrayidx13.us = getelementptr inbounds double, double* %v2, i64 %indvars.iv27
  ...
  %arrayidx5.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv31, i64 %indvars.iv.next28
  %31 = load double, double* %arrayidx5.us.1, align 8
  %32 = load double, double* %arrayidx7.us, align 8
  %arrayidx9.us.1 = getelementptr inbounds double, double* %v1, i64 %indvars.iv.next28
  ...
  %arrayidx13.us.1 = getelementptr inbounds double, double* %v2, i64 %indvars.iv.next28
  ...
  %exitcond38.1 = icmp eq i64 %indvars.iv.next28.1, 2000
  br i1 %exitcond38.1, label %for.cond1.for.inc20_crit_edge.us.loopexit, label %for.inc.us, !llvm.loop !16
...
for.cond1.for.inc20_crit_edge.us:                 ; preds = %for.cond1.for.inc20_crit_edge.us.loopexit68, %for.cond1.for.inc20_crit_edge.us.loopexit
  %exitcond34 = icmp eq i64 %0, 2000
  br i1 %exitcond34, label %for.body25.us.preheader, label %for.body.us
...
for.body25.us:                                    ; preds = %for.body25.us.preheader, %for.cond26.for.inc45_crit_edge.us
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.cond26.for.inc45_crit_edge.us ], [ 0, %for.body25.us.preheader ]
  %arrayidx30.us = getelementptr inbounds double, double* %x, i64 %indvars.iv23
...
for.inc42.us:                                     ; preds = %for.body25.us, %for.inc42.us
  ...
  %indvars.iv19 = phi i64 [ %indvars.iv.next20.1, %for.inc42.us ], [ 0, %for.body25.us ]
  %arrayidx34.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv19, i64 %indvars.iv23
  %37 = load double, double* %arrayidx34.us, align 8
  %mul35.us = fmul double %37, %beta
  %arrayidx37.us = getelementptr inbounds double, double* %y, i64 %indvars.iv19
  ...
  %arrayidx34.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv.next20, i64 %indvars.iv23
  %39 = load double, double* %arrayidx34.us.1, align 8
  %mul35.us.1 = fmul double %39, %beta
  %arrayidx37.us.1 = getelementptr inbounds double, double* %y, i64 %indvars.iv.next20
  ...
  %exitcond37.1 = icmp eq i64 %indvars.iv.next20.1, 2000
  br i1 %exitcond37.1, label %for.cond26.for.inc45_crit_edge.us, label %for.inc42.us

for.cond26.for.inc45_crit_edge.us:                ; preds = %for.inc42.us
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  %exitcond26 = icmp eq i64 %indvars.iv.next24, 2000
  br i1 %exitcond26, label %vector.memcheck46, label %for.body25.us
...
for.inc58:                                        ; preds = %for.inc58.preheader, %for.inc58
  %indvars.iv15 = phi i64 [ %indvars.iv.next16.3, %for.inc58 ], [ 0, %for.inc58.preheader ]
  %arrayidx52 = getelementptr inbounds double, double* %x, i64 %indvars.iv15
  %57 = load double, double* %arrayidx52, align 8
  %arrayidx54 = getelementptr inbounds double, double* %z, i64 %indvars.iv15
  ...
  %arrayidx52.1 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next16
  %59 = load double, double* %arrayidx52.1, align 8
  %arrayidx54.1 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next16
  ...
  %arrayidx52.2 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next16.1
  %61 = load double, double* %arrayidx52.2, align 8
  %arrayidx54.2 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next16.1
  ...
  %arrayidx52.3 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next16.2
  %63 = load double, double* %arrayidx52.3, align 8
  %arrayidx54.3 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next16.2
  %64 = load double, double* %arrayidx54.3, align 8
  %add55.3 = fadd double %63, %64
  store double %add55.3, double* %arrayidx52.3, align 8
  %indvars.iv.next16.3 = add nuw nsw i64 %indvars.iv15, 4
  %exitcond.3 = icmp eq i64 %indvars.iv.next16.3, 2000
  br i1 %exitcond.3, label %for.body63.us.preheader.loopexit, label %for.inc58, !llvm.loop !23
...
for.body63.us:                                    ; preds = %for.body63.us.preheader, %for.cond64.for.inc83_crit_edge.us
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.cond64.for.inc83_crit_edge.us ], [ 0, %for.body63.us.preheader ]
  %arrayidx68.us = getelementptr inbounds double, double* %w, i64 %indvars.iv11
  %.pre35 = load double, double* %arrayidx68.us, align 8
  br label %for.inc80.us

for.inc80.us:                                     ; preds = %for.body63.us, %for.inc80.us
  %65 = phi double [ %add77.us.1, %for.inc80.us ], [ %.pre35, %for.body63.us ]
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %for.inc80.us ], [ 0, %for.body63.us ]
  %arrayidx72.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv11, i64 %indvars.iv
  ...
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx72.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv11, i64 %indvars.iv.next
  ...
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond36.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond36.1, label %for.cond64.for.inc83_crit_edge.us, label %for.inc80.us

for.cond64.for.inc83_crit_edge.us:                ; preds = %for.inc80.us
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond14 = icmp eq i64 %indvars.iv.next12, 2000
  br i1 %exitcond14, label %for.end85, label %for.body63.us
