...
.preheader5.us.new:                               ; preds = %.preheader5.us.new, %.preheader5.us
...
.lr.ph9:                                          ; preds = %._crit_edge, %.lr.ph9.preheader
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %._crit_edge ], [ 0, %.lr.ph9.preheader ]
...
._crit_edge:                                      ; preds = %.lr.ph9, %9
  ...
  br i1 %exitcond15, label %._crit_edge10, label %.lr.ph9
...
.lr.ph:                                           ; preds = %._crit_edge5, %._crit_edge10
  %indvars.iv = phi i64 [ %indvars.iv.next, %._crit_edge5 ], [ 0, %._crit_edge10 ]
  %19 = trunc i64 %indvars.iv to i32
  %20 = srem i32 %19, 20
  %21 = icmp eq i32 %20, 0
  br i1 %21, label %22, label %._crit_edge5
