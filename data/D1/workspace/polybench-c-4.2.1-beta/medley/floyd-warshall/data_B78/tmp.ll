...
._crit_edge13:                                    ; preds = %._crit_edge13, %.preheader.us
  ...
  %13 = srem i32 %8, 11
  %14 = icmp eq i32 %13, 0
  %or.cond20 = or i1 %or.cond, %14
  %. = select i1 %or.cond20, i32 999, i32 %5
...
.loopexit.us:                                     ; preds = %._crit_edge13
  ...
  br i1 %exitcond17, label %._crit_edge, label %.preheader.us
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  br i1 %26, label %.loopexit.us.us.loopexit50, label %vector.body, !llvm.loop !9
