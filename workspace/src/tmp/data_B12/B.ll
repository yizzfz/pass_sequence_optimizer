...
.loopexit1._crit_edge:                            ; preds = %.loopexit1, %8
  %17 = phi i64 [ 0, %8 ], [ %84, %.loopexit1 ]
  %18 = mul i64 %17, 280
  %scevgep = getelementptr i8, i8* %2, i64 %18
  br i1 %15, label %19, label %.loopexit1
...
._crit_edge10:                                    ; preds = %49, %._crit_edge
...
; <label>:49:                                     ; preds = %._crit_edge11
  %50 = add nuw nsw i32 %44, 1
  %51 = icmp eq i32 %50, %4
  br i1 %51, label %33, label %._crit_edge10

._crit_edge11:                                    ; preds = %._crit_edge11, %._crit_edge10
  %52 = phi i64 [ 0, %._crit_edge10 ], [ %76, %._crit_edge11 ]
  %53 = phi float [ %41, %._crit_edge10 ], [ %75, %._crit_edge11 ]
  %54 = phi float [ %42, %._crit_edge10 ], [ %72, %._crit_edge11 ]
  %55 = phi float [ %43, %._crit_edge10 ], [ %69, %._crit_edge11 ]
  ...
  br i1 %77, label %49, label %._crit_edge11
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %.split
  ...
  br i1 %83, label %.loopexit1.loopexit, label %.split

.loopexit1.loopexit:                              ; preds = %.loopexit
  br label %.loopexit1

.loopexit1:                                       ; preds = %.loopexit1.loopexit, %.loopexit1._crit_edge, %.split.us.preheader
  %84 = add nuw nsw i64 %17, 1
  %85 = icmp eq i64 %84, %14
  br i1 %85, label %.loopexit2.loopexit, label %.loopexit1._crit_edge
...
._crit_edge9:                                     ; preds = %119, %4
  %6 = phi i64 [ 0, %4 ], [ %120, %119 ]
  %7 = mul nuw nsw i64 %6, 280
  br label %.loopexit._crit_edge

.loopexit._crit_edge:                             ; preds = %.loopexit, %._crit_edge9
  %8 = phi i64 [ 0, %._crit_edge9 ], [ %117, %.loopexit ]
  %9 = add nsw i64 %8, -4
  %10 = icmp slt i64 %9, %5
...
._crit_edge8:                                     ; preds = %104, %14
  %16 = phi i64 [ 0, %14 ], [ %112, %104 ]
  %17 = phi float [ 0.000000e+00, %14 ], [ %111, %104 ]
  %18 = phi i32 [ 0, %14 ], [ %110, %104 ]
  %19 = sub nsw i64 %8, %16
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge8
  %20 = phi i64 [ 0, %._crit_edge8 ], [ %102, %._crit_edge ]
  %21 = phi float [ 0.000000e+00, %._crit_edge8 ], [ %101, %._crit_edge ]
  %22 = phi float [ 0.000000e+00, %._crit_edge8 ], [ %98, %._crit_edge ]
  %23 = phi float [ 0.000000e+00, %._crit_edge8 ], [ %97, %._crit_edge ]
...
; <label>:104:                                    ; preds = %._crit_edge
  ...
  br i1 %exitcond, label %.loopexit.loopexit, label %._crit_edge8

.loopexit.loopexit:                               ; preds = %104
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %.loopexit._crit_edge
  %113 = phi i32 [ 0, %.loopexit._crit_edge ], [ %110, %.loopexit.loopexit ]
  ...
  br i1 %118, label %119, label %.loopexit._crit_edge
...
.loopexit2._crit_edge:                            ; preds = %.loopexit2, %9
  ...
  br i1 %18, label %27, label %.loopexit2

; <label>:27:                                     ; preds = %.loopexit2._crit_edge
  %28 = mul nuw nsw i64 %22, 280
  br i1 %19, label %.preheader1.preheader, label %30
...
.us-lcssa.us.loopexit14:                          ; preds = %.loopexit
  br label %.us-lcssa.us

.us-lcssa.us:                                     ; preds = %.us-lcssa.us.loopexit14, %.us-lcssa.us.loopexit, %.split.us
  %.lcssa4 = phi float [ undef, %.split.us ], [ %55, %.us-lcssa.us.loopexit ], [ %76, %.us-lcssa.us.loopexit14 ]
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %.split
  ...
  %77 = icmp eq i64 %indvars.iv.next, %14
  br i1 %77, label %.us-lcssa.us.loopexit14, label %.split
...
._crit_edge10:                                    ; preds = %151, %0
  %17 = phi i64 [ 0, %0 ], [ %152, %151 ]
...
._crit_edge9:                                     ; preds = %142, %19
  %23 = phi i64 [ 0, %19 ], [ %143, %142 ]
...
.loopexit._crit_edge:                             ; preds = %.loopexit, %._crit_edge9
  %27 = phi i64 [ 0, %._crit_edge9 ], [ %140, %.loopexit ]
  %28 = add nsw i64 %27, -4
...
._crit_edge8:                                     ; preds = %._crit_edge8, %._crit_edge
  %52 = phi i64 [ 0, %._crit_edge ], [ %134, %._crit_edge8 ]
  %53 = phi float [ 0.000000e+00, %._crit_edge ], [ %133, %._crit_edge8 ]
  %54 = phi float [ 0.000000e+00, %._crit_edge ], [ %130, %._crit_edge8 ]
  %55 = phi float [ 0.000000e+00, %._crit_edge ], [ %129, %._crit_edge8 ]
  ...
  br i1 %135, label %42, label %._crit_edge8

.loopexit.loopexit:                               ; preds = %42
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %.loopexit._crit_edge
  %136 = phi i32 [ 0, %.loopexit._crit_edge ], [ %48, %.loopexit.loopexit ]
  ...
  br i1 %141, label %142, label %.loopexit._crit_edge
...
; <label>:151:                                    ; preds = %._crit_edge11
  %152 = add nuw nsw i64 %17, 1
  %153 = icmp eq i64 %152, 223
  br i1 %153, label %19, label %._crit_edge10

._crit_edge11:                                    ; preds = %._crit_edge11, %._crit_edge10
  %154 = phi i64 [ 0, %._crit_edge10 ], [ %160, %._crit_edge11 ]
  ...
  br i1 %161, label %151, label %._crit_edge11

._crit_edge12:                                    ; preds = %167, %145
  %162 = phi i64 [ 0, %145 ], [ %168, %167 ]
...
; <label>:167:                                    ; preds = %._crit_edge13
  %168 = add nuw nsw i64 %162, 1
  %169 = icmp eq i64 %168, 223
  br i1 %169, label %164, label %._crit_edge12

._crit_edge13:                                    ; preds = %._crit_edge13, %._crit_edge12
  %170 = phi i64 [ 0, %._crit_edge12 ], [ %180, %._crit_edge13 ]
  ...
  br i1 %181, label %167, label %._crit_edge13
}
