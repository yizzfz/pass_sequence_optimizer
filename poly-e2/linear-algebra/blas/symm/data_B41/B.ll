...
for.body26.lr.ph:                                 ; preds = %for.body26.lr.ph.preheader, %for.cond19.loopexit
  %indvars.iv4 = phi i3 [ -1, %for.body26.lr.ph.preheader ], [ %indvars.iv.next5, %for.cond19.loopexit ]
  %indvars.iv2 = phi i64 [ 2, %for.body26.lr.ph.preheader ], [ %indvars.iv.next3, %for.cond19.loopexit ]
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.cond19.loopexit ], [ 0, %for.body26.lr.ph.preheader ]
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.cond19.loopexit ], [ 1, %for.body26.lr.ph.preheader ]
  %5 = zext i3 %indvars.iv4 to i32
  %6 = add i32 %5, -1
  %7 = zext i32 %6 to i64
  %8 = add i64 %indvars.iv2, %7
  %9 = sub nuw nsw i64 999, %indvars.iv55
  %10 = sub nsw i64 998, %indvars.iv55
...
for.body26.prol.preheader:                        ; preds = %for.body26.lr.ph
  %11 = trunc i64 %indvars.iv55 to i32
...
for.body26:                                       ; preds = %for.body26.preheader, %for.body26
  ...
  %13 = add nuw nsw i64 %indvars.iv, %indvars.iv55
  ...
  %15 = add nuw nsw i64 %indvars.iv.next, %indvars.iv55
...
for.body43.prol.loopexit:                         ; preds = %for.body43.prol.loopexit.loopexit, %for.body43.lr.ph
  %indvars.iv47.unr = phi i64 [ %indvars.iv53, %for.body43.lr.ph ], [ %8, %for.body43.prol.loopexit.loopexit ]
  %18 = trunc i64 %10 to i32
  %19 = icmp ult i32 %18, 7
  br i1 %19, label %for.cond19.loopexit, label %for.body43.preheader

for.body43.preheader:                             ; preds = %for.body43.prol.loopexit
  %20 = sub i64 992, %indvars.iv47.unr
  %21 = lshr i64 %20, 3
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %27 = shl i64 %index, 3
  %28 = add i64 %indvars.iv47.unr, %27
  %29 = add nsw i64 %28, 7
  %30 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv55, i64 %29
...
for.body43:                                       ; preds = %for.body43.preheader1, %for.body43
  %indvars.iv47 = phi i64 [ %indvars.iv.next48.7, %for.body43 ], [ %indvars.iv47.ph, %for.body43.preheader1 ]
...
for.cond1.preheader.us.preheader:
  %mul44.us76 = fmul double %alpha, 0.000000e+00
  ...
  %broadcast.splatinsert21 = insertelement <2 x double> undef, double %mul44.us76, i32 0
  %broadcast.splat22 = shufflevector <2 x double> %broadcast.splatinsert21, <2 x double> undef, <2 x i32> zeroinitializer
  br label %for.cond1.preheader.us

for.cond1.preheader.us:                           ; preds = %for.inc53.us, %for.cond1.preheader.us.preheader
  %indvars.iv91 = phi i64 [ 0, %for.cond1.preheader.us.preheader ], [ %indvars.iv.next92, %for.inc53.us ]
...
vector.memcheck:                                  ; preds = %for.cond1.preheader.us
  ...
  %scevgep5 = getelementptr [1200 x double], [1200 x double]* %B, i64 %indvars.iv91, i64 0
  %bound0 = icmp ult double* %scevgep, %scevgep7
  %bound1 = icmp ult double* %scevgep5, %scevgep3
  %found.conflict = and i1 %bound0, %bound1
  %bound010 = icmp ult double* %scevgep, %arrayidx41.us.us
  %bound111 = icmp ult double* %arrayidx41.us.us, %scevgep3
  %found.conflict12 = and i1 %bound010, %bound111
  %conflict.rdx = or i1 %found.conflict, %found.conflict12
  br i1 %conflict.rdx, label %for.cond4.preheader.us42.preheader, label %vector.ph

for.cond4.preheader.us42.preheader:               ; preds = %vector.memcheck
  br label %for.cond4.preheader.us42
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %26, label %for.inc53.us.loopexit26, label %vector.body, !llvm.loop !16

for.cond4.preheader.us42:                         ; preds = %for.cond4.preheader.us42, %for.cond4.preheader.us42.preheader
  %indvars.iv = phi i64 [ 0, %for.cond4.preheader.us42.preheader ], [ %indvars.iv.next.1, %for.cond4.preheader.us42 ]
  %arrayidx31.us69 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv91, i64 %indvars.iv
  %27 = load double, double* %arrayidx31.us69, align 8
  %mul32.us70 = fmul double %27, %beta
  %arrayidx36.us71 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv91, i64 %indvars.iv
  %28 = load double, double* %arrayidx36.us71, align 8
  %mul37.us72 = fmul double %28, %alpha
  %29 = load double, double* %arrayidx41.us.us, align 8
  %mul42.us74 = fmul double %mul37.us72, %29
  %add43.us75 = fadd double %mul32.us70, %mul42.us74
  %add45.us77 = fadd double %mul44.us76, %add43.us75
  store double %add45.us77, double* %arrayidx31.us69, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx31.us69.1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv91, i64 %indvars.iv.next
  %30 = load double, double* %arrayidx31.us69.1, align 8
  %mul32.us70.1 = fmul double %30, %beta
  %arrayidx36.us71.1 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv91, i64 %indvars.iv.next
  %31 = load double, double* %arrayidx36.us71.1, align 8
  %mul37.us72.1 = fmul double %31, %alpha
  %32 = load double, double* %arrayidx41.us.us, align 8
  %mul42.us74.1 = fmul double %mul37.us72.1, %32
  %add43.us75.1 = fadd double %mul32.us70.1, %mul42.us74.1
  %add45.us77.1 = fadd double %mul44.us76, %add43.us75.1
  store double %add45.us77.1, double* %arrayidx31.us69.1, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 1200
  br i1 %exitcond.1, label %for.inc53.us.loopexit25, label %for.cond4.preheader.us42, !llvm.loop !17

for.inc53.us.loopexit:                            ; preds = %for.end.us.us
  br label %for.inc53.us

for.inc53.us.loopexit25:                          ; preds = %for.cond4.preheader.us42
  br label %for.inc53.us

for.inc53.us.loopexit26:                          ; preds = %vector.body
  br label %for.inc53.us

for.inc53.us:                                     ; preds = %for.inc53.us.loopexit26, %for.inc53.us.loopexit25, %for.inc53.us.loopexit
  %indvars.iv.next92 = add nuw nsw i64 %indvars.iv91, 1
  %exitcond93 = icmp eq i64 %indvars.iv.next92, 1000
  br i1 %exitcond93, label %for.end55, label %for.cond1.preheader.us

for.cond4.preheader.us.us:                        ; preds = %for.cond4.preheader.us.us.preheader, %for.end.us.us
  %indvars.iv88 = phi i64 [ %indvars.iv.next89, %for.end.us.us ], [ 0, %for.cond4.preheader.us.us.preheader ]
  %arrayidx8.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv91, i64 %indvars.iv88
  br label %for.body6.us.us

for.end.us.us:                                    ; preds = %for.body6.us.us
  %arrayidx31.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv91, i64 %indvars.iv88
  ...
  %exitcond90 = icmp eq i64 %indvars.iv.next89, 1200
  br i1 %exitcond90, label %for.inc53.us.loopexit, label %for.cond4.preheader.us.us

for.body6.us.us:                                  ; preds = %for.body6.us.us, %for.cond4.preheader.us.us
  %indvars.iv83 = phi i64 [ %indvars.iv.next84, %for.body6.us.us ], [ 0, %for.cond4.preheader.us.us ]
  ...
  %arrayidx17.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv83, i64 %indvars.iv88
  ...
  %arrayidx21.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv83, i64 %indvars.iv88
  ...
  %exitcond87 = icmp eq i64 %indvars.iv.next84, %indvars.iv91
  br i1 %exitcond87, label %for.end.us.us, label %for.body6.us.us
