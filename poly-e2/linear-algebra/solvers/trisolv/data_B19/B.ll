...
for.body6.lr.ph:                                  ; preds = %for.end, %for.body.lr.ph
  %indvars.iv8 = phi i64 [ 0, %for.body.lr.ph ], [ %1, %for.end ]
  %indvars.iv6 = phi i64 [ 1, %for.body.lr.ph ], [ %indvars.iv.next7, %for.end ]
  ...
  %1 = add nuw nsw i64 %indvars.iv8, 1
  %2 = trunc i64 %1 to i32
  %sub = add i32 %2, %n
  %3 = and i64 %indvars.iv8, 1
...
for.end:                                          ; preds = %for.body6.prol.loopexit, %for.end.unr-lcssa
  %exitcond12 = icmp eq i64 %1, %wide.trip.count11
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  br i1 %exitcond12, label %for.end16.loopexit, label %for.body6.lr.ph
...
for.end:                                          ; preds = %for.end.loopexit, %for.body
  %.lcssa = phi double [ %0, %for.body ], [ %sub.lcssa, %for.end.loopexit ]
...
for.body:                                         ; preds = %if.end, %for.body.preheader
  ...
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %3, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i64 0, i64 0), double %4) #5
  %5 = trunc i64 %indvars.iv to i32
  %rem = srem i32 %5, 20
...
for.end:                                          ; preds = %for.end.loopexit, %entry
  ...
  %call5 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %7, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #5
