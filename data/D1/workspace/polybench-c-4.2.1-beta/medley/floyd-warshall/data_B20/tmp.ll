...
.preheader:                                       ; preds = %19, %2
  %indvars.iv24 = phi i64 [ 0, %2 ], [ %indvars.iv.next25, %19 ]
  br label %3

; <label>:3:                                      ; preds = %3, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %3 ]
  %4 = mul nuw nsw i64 %indvars.iv, %indvars.iv24
  %5 = trunc i64 %4 to i32
  %6 = srem i32 %5, 7
  %7 = add nsw i32 %6, 1
  %8 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv24, i64 %indvars.iv
  %9 = add nuw nsw i64 %indvars.iv, %indvars.iv24
  ...
  %17 = srem i32 %16, 11
  %18 = icmp eq i32 %17, 0
  %or.cond21 = or i1 %18, %or.cond
  %. = select i1 %or.cond21, i32 999, i32 %7
...
; <label>:19:                                     ; preds = %3
  ...
  br i1 %exitcond26, label %20, label %.preheader
...
.preheader29:                                     ; preds = %20, %2
  %indvars.iv36 = phi i64 [ 0, %2 ], [ %indvars.iv.next37, %20 ]
  br label %.preheader

.preheader:                                       ; preds = %19, %.preheader29
  %indvars.iv33 = phi i64 [ 0, %.preheader29 ], [ %indvars.iv.next34, %19 ]
  %3 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv33, i64 %indvars.iv36
  br label %4

; <label>:4:                                      ; preds = %4, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %4 ]
  %5 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv33, i64 %indvars.iv
  %6 = load i32, i32* %5, align 4
  %7 = load i32, i32* %3, align 4
  %8 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv36, i64 %indvars.iv
  ...
  %12 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv33, i64 %indvars.iv.next
  %13 = load i32, i32* %12, align 4
  %14 = load i32, i32* %3, align 4
  %15 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv36, i64 %indvars.iv.next
...
; <label>:19:                                     ; preds = %4
  ...
  br i1 %exitcond35, label %20, label %.preheader

; <label>:20:                                     ; preds = %19
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  %exitcond38 = icmp eq i64 %indvars.iv.next37, 2800
  br i1 %exitcond38, label %21, label %.preheader29
...
.preheader:                                       ; preds = %20, %2
  %indvars.iv13 = phi i64 [ 0, %2 ], [ %indvars.iv.next14, %20 ]
  %7 = mul nuw nsw i64 %indvars.iv13, 2800
  br label %8
...
; <label>:15:                                     ; preds = %13, %8
  ...
  %17 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv13, i64 %indvars.iv
...
; <label>:20:                                     ; preds = %15
  ...
  br i1 %exitcond15, label %21, label %.preheader
