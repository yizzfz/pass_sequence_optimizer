...
@__llvm_prf_nm = private constant [23 x i8] c"\0D\15x\DAK\CE\CF-H,Je\CCM\CC\CC3\04\00#\06\04\BF", section "__llvm_prf_names"
@llvm.used = appending global [3 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_compare to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_main1 to i8*), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
