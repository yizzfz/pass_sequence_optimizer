...
.lr.ph.us.new:                                    ; preds = %.lr.ph.us.new, %.lr.ph.us.new.preheader.new
  %indvars.iv = phi i64 [ %indvars.iv.unr91.ph, %.lr.ph.us.new.preheader.new ], [ %indvars.iv.next.3.1, %.lr.ph.us.new ]
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %._crit_edge9.us
  %indvars.iv87 = phi i2 [ 1, %.lr.ph.us.preheader ], [ %indvars.iv.next, %._crit_edge9.us ]
  ...
  %85 = zext i2 %indvars.iv87 to i64
...
.lr.ph.us.new.preheader:                          ; preds = %.prol.loopexit
  ...
  %98 = lshr i64 %97, 2
  %99 = and i64 %98, 1
  %lcmp.mod89 = icmp eq i64 %99, 0
  br i1 %lcmp.mod89, label %.lr.ph.us.new.prol.preheader, label %.lr.ph.us.new.prol.loopexit.unr-lcssa
...
.lr.ph.us.new.prol.loopexit.unr-lcssa:            ; preds = %.lr.ph.us.new.preheader, %.lr.ph.us.new.prol
  %indvars.iv.unr91.ph = phi i64 [ %indvars.iv.next.3.prol, %.lr.ph.us.new.prol ], [ %indvars.iv.unr, %.lr.ph.us.new.preheader ]
...
._crit_edge9.us:                                  ; preds = %._crit_edge.us18
  ...
  %indvars.iv.next = add i2 %indvars.iv87, 1
  br i1 %exitcond40, label %._crit_edge13.loopexit, label %.lr.ph.us

.lr.ph:                                           ; preds = %.lr.ph.preheader, %.preheader3
  %indvars.iv92 = phi i2 [ 1, %.lr.ph.preheader ], [ %indvars.iv.next93, %.preheader3 ]
  ...
  %110 = zext i2 %indvars.iv92 to i64
...
.lr.ph.new.preheader:                             ; preds = %.prol.loopexit47
  ...
  %120 = lshr i64 %119, 2
  %121 = and i64 %120, 1
  %lcmp.mod95 = icmp eq i64 %121, 0
  br i1 %lcmp.mod95, label %.lr.ph.new.prol.preheader, label %.lr.ph.new.prol.loopexit.unr-lcssa
...
.lr.ph.new.prol.loopexit.unr-lcssa:               ; preds = %.lr.ph.new.preheader, %.lr.ph.new.prol
  %indvars.iv41.unr97.ph = phi i64 [ %indvars.iv.next42.3.prol, %.lr.ph.new.prol ], [ %indvars.iv41.unr, %.lr.ph.new.preheader ]
...
.lr.ph.new:                                       ; preds = %.lr.ph.new, %.lr.ph.new.preheader.new
  %indvars.iv41 = phi i64 [ %indvars.iv41.unr97.ph, %.lr.ph.new.preheader.new ], [ %indvars.iv.next42.3.1, %.lr.ph.new ]
...
.preheader3:                                      ; preds = %.preheader3.loopexit, %.prol.loopexit47
  ...
  br i1 %exitcond56, label %._crit_edge13.loopexit86, label %.lr.ph

._crit_edge13.loopexit:                           ; preds = %._crit_edge9.us
  br label %._crit_edge13

._crit_edge13.loopexit86:                         ; preds = %.preheader3
  br label %._crit_edge13

._crit_edge13:                                    ; preds = %._crit_edge13.loopexit86, %._crit_edge13.loopexit, %7
  ret void
}
