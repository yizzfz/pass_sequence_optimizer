...
for.inc36.lr.ph:                                  ; preds = %for.inc36.lr.ph.preheader, %for.inc51
  ...
  %5 = sub nsw i64 0, %indvars.iv59
  %6 = trunc i64 %5 to i32
  %7 = add i32 %6, 7
  %8 = add i32 %6, 998
  %indvars.iv.next60 = add nuw nsw i64 %indvars.iv59, 1
  %xtraiter73 = and i64 %indvars.iv.next60, 1
...
for.inc36.prol.loopexit.unr-lcssa:                ; preds = %for.inc36.lr.ph, %for.inc36.prol.preheader
  ...
  %10 = icmp eq i64 %indvars.iv59, 0
  br i1 %10, label %for.cond40.preheader, label %for.inc36.preheader
...
for.inc48.prol:                                   ; preds = %for.inc48.prol.preheader, %for.inc48.prol
  %indvars.iv50.prol = phi i64 [ %indvars.iv.next51.prol, %for.inc48.prol ], [ %indvars.iv57, %for.inc48.prol.preheader ]
  %prol.iter = phi i32 [ %prol.iter.sub, %for.inc48.prol ], [ %xtraiter53, %for.inc48.prol.preheader ]
  %arrayidx47.prol = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 %indvars.iv50.prol
...
for.inc48.prol.loopexit:                          ; preds = %for.inc48.prol.loopexit.loopexit, %for.inc48.lr.ph
  %indvars.iv50.unr = phi i64 [ %indvars.iv57, %for.inc48.lr.ph ], [ %indvars.iv.next51.prol, %for.inc48.prol.loopexit.loopexit ]
  %11 = icmp ult i32 %8, 7
  br i1 %11, label %for.inc51, label %for.inc48.preheader

for.inc48.preheader:                              ; preds = %for.inc48.prol.loopexit
  %12 = sub i64 992, %indvars.iv50.unr
  %13 = lshr i64 %12, 3
...
for.inc48.preheader74:                            ; preds = %middle.block, %min.iters.checked, %for.inc48.preheader
  %indvars.iv50.ph = phi i64 [ %indvars.iv50.unr, %min.iters.checked ], [ %indvars.iv50.unr, %for.inc48.preheader ], [ %ind.end, %middle.block ]
  br label %for.inc48
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %19 = shl i64 %index, 3
  %20 = add i64 %indvars.iv50.unr, %19
  %21 = add nsw i64 %20, 7
...
for.inc48:                                        ; preds = %for.inc48.preheader74, %for.inc48
  %indvars.iv50 = phi i64 [ %indvars.iv.next51.7, %for.inc48 ], [ %indvars.iv50.ph, %for.inc48.preheader74 ]
  %arrayidx47 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 %indvars.iv50
  store double -9.990000e+02, double* %arrayidx47, align 8
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1
  %arrayidx47.1 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 %indvars.iv.next51
  store double -9.990000e+02, double* %arrayidx47.1, align 8
  %indvars.iv.next51.1 = add nsw i64 %indvars.iv50, 2
  %arrayidx47.2 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 %indvars.iv.next51.1
  store double -9.990000e+02, double* %arrayidx47.2, align 8
  %indvars.iv.next51.2 = add nsw i64 %indvars.iv50, 3
  %arrayidx47.3 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 %indvars.iv.next51.2
  store double -9.990000e+02, double* %arrayidx47.3, align 8
  %indvars.iv.next51.3 = add nsw i64 %indvars.iv50, 4
  %arrayidx47.4 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 %indvars.iv.next51.3
  store double -9.990000e+02, double* %arrayidx47.4, align 8
  %indvars.iv.next51.4 = add nsw i64 %indvars.iv50, 5
  %arrayidx47.5 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 %indvars.iv.next51.4
  store double -9.990000e+02, double* %arrayidx47.5, align 8
  %indvars.iv.next51.5 = add nsw i64 %indvars.iv50, 6
  %arrayidx47.6 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 %indvars.iv.next51.5
  store double -9.990000e+02, double* %arrayidx47.6, align 8
  %indvars.iv.next51.6 = add nsw i64 %indvars.iv50, 7
  %arrayidx47.7 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv59, i64 %indvars.iv.next51.6
  store double -9.990000e+02, double* %arrayidx47.7, align 8
  %indvars.iv.next51.7 = add nsw i64 %indvars.iv50, 8
  %exitcond.7 = icmp eq i64 %indvars.iv.next51.7, 1000
...
for.cond4.preheader.lr.ph:                        ; preds = %for.cond1.preheader.lr.ph, %for.inc53
  %indvars.iv53 = phi i64 [ 0, %for.cond1.preheader.lr.ph ], [ %indvars.iv.next54, %for.inc53 ]
...
for.inc53:                                        ; preds = %for.inc53.loopexit85, %for.inc53.loopexit84, %for.inc53.loopexit
  ...
  br i1 %exitcond56, label %for.end55, label %for.cond4.preheader.lr.ph
