...
.preheader:                                       ; preds = %18, %1
  %indvars.iv7 = phi i64 [ 0, %1 ], [ %indvars.iv.next8, %18 ]
  br label %2
...
; <label>:18:                                     ; preds = %2
  ...
  br i1 %exitcond9, label %19, label %.preheader
...
.preheader3:                                      ; preds = %19, %1
  %indvars.iv10 = phi i64 [ 0, %1 ], [ %indvars.iv.next11, %19 ]
  br label %.preheader

.preheader:                                       ; preds = %18, %.preheader3
  %indvars.iv7 = phi i64 [ 0, %.preheader3 ], [ %indvars.iv.next8, %18 ]
  %2 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv7, i64 %indvars.iv10
  br label %3
...
; <label>:3:                                      ; preds = %3, %.preheader
  ...
  %7 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv10, i64 %indvars.iv
  ...
  %14 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv10, i64 %indvars.iv.next
...
; <label>:19:                                     ; preds = %18
  ...
  br i1 %exitcond12, label %20, label %.preheader3
