...
; <label>:10:                                     ; preds = %2
  ...
  br i1 %12, label %13, label %.._crit_edge_crit_edge4

.._crit_edge_crit_edge4:                          ; preds = %10
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %.._crit_edge_crit_edge4, %.._crit_edge_crit_edge, %13
...
.lr.ph:                                           ; preds = %._crit_edge..lr.ph_crit_edge, %.lr.ph2
  %indvars.iv10 = phi i64 [ 0, %.lr.ph2 ], [ %indvars.iv.next11, %._crit_edge..lr.ph_crit_edge ]
  %indvars.iv8 = phi i64 [ 1, %.lr.ph2 ], [ %indvars.iv.next9, %._crit_edge..lr.ph_crit_edge ]
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %4 = getelementptr inbounds double, double* %2, i64 %indvars.iv10
  store double -9.990000e+02, double* %4, align 8
  %5 = trunc i64 %indvars.iv10 to i32
  %6 = sitofp i32 %5 to double
  %7 = getelementptr inbounds double, double* %3, i64 %indvars.iv10
  store double %6, double* %7, align 8
  %8 = add i32 %5, 2001
  %xtraiter13 = and i64 %indvars.iv.next11, 1
...
.prol.loopexit:                                   ; preds = %.lr.ph..prol.loopexit_crit_edge, %.prol.preheader
  ...
  %13 = icmp eq i64 %indvars.iv10, 0
  br i1 %13, label %.prol.loopexit.._crit_edge_crit_edge, label %.lr.ph.new.preheader
...
._crit_edge:                                      ; preds = %.prol.loopexit.._crit_edge_crit_edge, %._crit_edge.loopexit
  ...
  br i1 %exitcond14, label %._crit_edge15, label %._crit_edge..lr.ph_crit_edge
...
._crit_edge._crit_edge:                           ; preds = %._crit_edge.._crit_edge._crit_edge_crit_edge, %.lr.ph13
  %indvars.iv21 = phi i64 [ 0, %.lr.ph13 ], [ %indvars.iv.next22, %._crit_edge.._crit_edge._crit_edge_crit_edge ]
  %4 = add nuw i64 %indvars.iv21, 4294967295
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv21
  %6 = load double, double* %5, align 8
  %7 = getelementptr inbounds double, double* %2, i64 %indvars.iv21
  store double %6, double* %7, align 8
  %8 = icmp sgt i64 %indvars.iv21, 0
  %sunkaddr2 = shl nsw i64 %indvars.iv21, 3
  %sunkaddr3 = add i64 %sunkaddr5, %sunkaddr2
  %sunkaddr4 = inttoptr i64 %sunkaddr3 to double*
  br i1 %8, label %.lr.ph, label %._crit_edge._crit_edge.._crit_edge_crit_edge
...
.prol.preheader:                                  ; preds = %.lr.ph
  %9 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv21, i64 0
...
.prol.loopexit:                                   ; preds = %.lr.ph..prol.loopexit_crit_edge, %.prol.preheader
  %indvars.iv.unr.ph = phi i64 [ 1, %.prol.preheader ], [ 0, %.lr.ph..prol.loopexit_crit_edge ]
  %.unr.ph = phi double [ %13, %.prol.preheader ], [ %6, %.lr.ph..prol.loopexit_crit_edge ]
  %.lcssa.unr.ph = phi double [ %13, %.prol.preheader ], [ undef, %.lr.ph..prol.loopexit_crit_edge ]
...
.lr.ph.new:                                       ; preds = %.lr.ph.new..lr.ph.new_crit_edge, %.lr.ph.new.preheader
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %23 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv21, i64 %indvars.iv.next
...
._crit_edge:                                      ; preds = %.prol.loopexit.._crit_edge_crit_edge, %._crit_edge._crit_edge.._crit_edge_crit_edge, %._crit_edge.loopexit
  %.lcssa9 = phi double [ %6, %._crit_edge._crit_edge.._crit_edge_crit_edge ], [ %.lcssa.unr.ph, %.prol.loopexit.._crit_edge_crit_edge ], [ %28, %._crit_edge.loopexit ]
  %29 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv21, i64 %indvars.iv21
  %30 = load double, double* %29, align 8
  %31 = fdiv double %.lcssa9, %30
  store double %31, double* %sunkaddr4, align 8
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  %exitcond26 = icmp eq i64 %indvars.iv.next22, 2000
  br i1 %exitcond26, label %._crit_edge27, label %._crit_edge.._crit_edge._crit_edge_crit_edge
...
.lr.ph:                                           ; preds = %._crit_edge..lr.ph_crit_edge, %.lr.ph.preheader
  ...
  %7 = phi %struct._IO_FILE* [ %6, %.lr.ph.preheader ], [ %16, %._crit_edge..lr.ph_crit_edge ]
  ...
  %12 = srem i32 %11, 20
  %13 = icmp eq i32 %12, 0
  br i1 %13, label %14, label %.lr.ph.._crit_edge_crit_edge
...
._crit_edge:                                      ; preds = %.lr.ph.._crit_edge_crit_edge, %14
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %16 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %exitcond7 = icmp eq i64 %indvars.iv.next, 2000
  br i1 %exitcond7, label %._crit_edge8, label %._crit_edge..lr.ph_crit_edge
