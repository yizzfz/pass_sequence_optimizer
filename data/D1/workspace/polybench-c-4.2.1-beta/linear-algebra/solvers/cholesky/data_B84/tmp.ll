...
.lr.ph84:                                         ; preds = %._crit_edge88, %.preheader62.lr.ph
  ...
  %6 = sub i64 1998, %indvars.iv137
  %7 = shl i64 %6, 3
  br label %._crit_edge

.preheader61:                                     ; preds = %._crit_edge
  %scevgep131 = getelementptr [2000 x double], [2000 x double]* %1, i64 0, i64 %5
  %8 = and i64 %7, 34359738360
  %scevgep131132 = bitcast double* %scevgep131 to i8*
  %9 = add nuw nsw i64 %8, 8
  %indvars.iv.next138 = add nuw nsw i64 %indvars.iv137, 1
  %10 = icmp slt i64 %indvars.iv.next138, 2000
  br i1 %10, label %._crit_edge88.loopexit, label %._crit_edge88

._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph84
  %indvars.iv119 = phi i64 [ 0, %.lr.ph84 ], [ %indvars.iv.next120, %._crit_edge ]
  %11 = sub nsw i64 0, %indvars.iv119
  %12 = trunc i64 %11 to i32
  %13 = srem i32 %12, 2000
  %14 = sitofp i32 %13 to double
  %15 = fdiv double %14, 2.000000e+03
  %16 = fadd double %15, 1.000000e+00
  %17 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv137, i64 %indvars.iv119
...
._crit_edge88.loopexit:                           ; preds = %.preheader61
  call void @llvm.memset.p0i8.i64(i8* nonnull %scevgep131132, i8 0, i64 %9, i32 8, i1 false)
  br label %._crit_edge88

._crit_edge88:                                    ; preds = %.preheader61, %._crit_edge88.loopexit
  %18 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv137, i64 %indvars.iv137
...
._crit_edge81.us.prol:                            ; preds = %._crit_edge81.us.prol, %._crit_edge81.us.prol.preheader
  ...
  %21 = mul nuw nsw i64 %indvars.iv115.prol, 16000
...
._crit_edge81.us.prol.loopexit:                   ; preds = %._crit_edge90, %._crit_edge81.us.prol.loopexit.unr-lcssa
  br i1 false, label %.preheader57.us.us.preheader.preheader, label %._crit_edge90.new
...
._crit_edge81.us:                                 ; preds = %._crit_edge81.us, %._crit_edge90.new
  %indvars.iv115 = phi i64 [ 0, %._crit_edge90.new ], [ %indvars.iv.next116.7, %._crit_edge81.us ]
  %22 = mul nuw nsw i64 %indvars.iv115, 16000
  ...
  %33 = mul i64 %indvars.iv115, 16000
  %34 = add i64 %33, 96000
  %scevgep.6 = getelementptr i8, i8* %19, i64 %34
  call void @llvm.memset.p0i8.i64(i8* %scevgep.6, i8 0, i64 16000, i32 8, i1 false)
  %35 = mul i64 %indvars.iv115, 16000
...
.preheader57.us.us.preheader:                     ; preds = %.preheader57.us.us.preheader.preheader, %._crit_edge70.us
  ...
  %37 = add nsw i64 %indvars.iv107, -1999
  %scevgep150 = getelementptr [2000 x double], [2000 x double]* %1, i64 2000, i64 %37
...
.preheader57.us.us:                               ; preds = %._crit_edge68.us.us, %.preheader57.us.us.preheader
  ...
  %scevgep146 = getelementptr i8, i8* %19, i64 %38
  %39 = add i64 16000, %38
  %scevgep147 = getelementptr i8, i8* %19, i64 %39
  %40 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv103, i64 %indvars.iv107
...
._crit_edge141.prol:                              ; preds = %._crit_edge141.prol.preheader
  ...
  %42 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv99.ph, i64 %indvars.iv107
  %43 = load double, double* %42, align 8
  %44 = fmul double %41, %43
  %45 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv103, i64 %indvars.iv99.ph
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %54 = or i64 %index, 2
  %55 = or i64 %index, 3
  %56 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %index, i64 %indvars.iv107
  %57 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %53, i64 %indvars.iv107
  %58 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %54, i64 %indvars.iv107
  %59 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %55, i64 %indvars.iv107
  ...
  %70 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv103, i64 %index
  ...
  %wide.load157 = load <2 x double>, <2 x double>* %73, align 8, !alias.scope !8, !noalias !10
  %74 = fadd <2 x double> %wide.load, %68
  %75 = fadd <2 x double> %wide.load157, %69
...
._crit_edge141:                                   ; preds = %._crit_edge141, %._crit_edge141.preheader.new
  ...
  %80 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv99, i64 %indvars.iv107
  %81 = load double, double* %80, align 8
  %82 = fmul double %79, %81
  %83 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv103, i64 %indvars.iv99
  %84 = load double, double* %83, align 8
  %85 = fadd double %84, %82
  store double %85, double* %83, align 8
  %indvars.iv.next100 = add nuw nsw i64 %indvars.iv99, 1
  %86 = load double, double* %40, align 8
  %87 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv.next100, i64 %indvars.iv107
  %88 = load double, double* %87, align 8
  %89 = fmul double %86, %88
  %90 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv103, i64 %indvars.iv.next100
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  ...
  %scevgep169 = getelementptr [2000 x double], [2000 x double]* %1, i64 %indvars.iv95, i64 2000
  %scevgep169170 = bitcast double* %scevgep169 to i8*
  %93 = mul nuw nsw i64 %indvars.iv95, 16000
  %scevgep171 = getelementptr i8, i8* %19, i64 %93
  %94 = add i64 16000, %93
  %scevgep172 = getelementptr i8, i8* %19, i64 %94
...
vector.body158:                                   ; preds = %vector.body158.preheader, %vector.body158
  ...
  %95 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv95, i64 %index179
  %96 = bitcast double* %95 to <2 x i64>*
  %wide.load187 = load <2 x i64>, <2 x i64>* %96, align 8, !alias.scope !15
  %97 = getelementptr double, double* %95, i64 2
  %98 = bitcast double* %97 to <2 x i64>*
  %wide.load188 = load <2 x i64>, <2 x i64>* %98, align 8, !alias.scope !15
  %99 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv95, i64 %index179
  %100 = bitcast double* %99 to <2 x i64>*
  store <2 x i64> %wide.load187, <2 x i64>* %100, align 8, !alias.scope !18, !noalias !15
  %101 = getelementptr double, double* %99, i64 2
  %102 = bitcast double* %101 to <2 x i64>*
  store <2 x i64> %wide.load188, <2 x i64>* %102, align 8, !alias.scope !18, !noalias !15
  %index.next180 = add i64 %index179, 4
  %103 = icmp eq i64 %index.next180, 2000
  br i1 %103, label %middle.block159, label %vector.body158, !llvm.loop !20
...
._crit_edge142.prol:                              ; preds = %._crit_edge142.prol, %._crit_edge142.prol.preheader
  ...
  %105 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv95, i64 %indvars.iv.prol
  %106 = bitcast double* %105 to i64*
  %107 = load i64, i64* %106, align 8
  %108 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv95, i64 %indvars.iv.prol
...
._crit_edge142.prol.loopexit:                     ; preds = %._crit_edge142.preheader, %._crit_edge142.prol.loopexit.unr-lcssa
  ...
  br i1 %110, label %._crit_edge.us.loopexit, label %._crit_edge142.preheader.new
...
._crit_edge142:                                   ; preds = %._crit_edge142, %._crit_edge142.preheader.new
  ...
  %111 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv95, i64 %indvars.iv
  %112 = bitcast double* %111 to i64*
  %113 = load i64, i64* %112, align 8
  %114 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv95, i64 %indvars.iv
  %115 = bitcast double* %114 to i64*
  store i64 %113, i64* %115, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %116 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv95, i64 %indvars.iv.next
  %117 = bitcast double* %116 to i64*
  %118 = load i64, i64* %117, align 8
  %119 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv95, i64 %indvars.iv.next
  %120 = bitcast double* %119 to i64*
  store i64 %118, i64* %120, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %121 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv95, i64 %indvars.iv.next.1
  %122 = bitcast double* %121 to i64*
  %123 = load i64, i64* %122, align 8
  %124 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv95, i64 %indvars.iv.next.1
  %125 = bitcast double* %124 to i64*
  store i64 %123, i64* %125, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %126 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv95, i64 %indvars.iv.next.2
  %127 = bitcast double* %126 to i64*
  %128 = load i64, i64* %127, align 8
  %129 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv95, i64 %indvars.iv.next.2
...
._crit_edge65:                                    ; preds = %._crit_edge65.loopexit, %._crit_edge90.thread
  %131 = phi i8* [ %3, %._crit_edge90.thread ], [ %19, %._crit_edge65.loopexit ]
