...
; <label>:53:                                     ; preds = %53, %.ph
  ...
  br i1 %exitcond, label %._crit_edge.us.loopexit224, label %53

._crit_edge.us.loopexit:                          ; preds = %.ph.lver.orig
  br label %._crit_edge.us

._crit_edge.us.loopexit224:                       ; preds = %53
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit224, %._crit_edge.us.loopexit
...
; <label>:125:                                    ; preds = %125, %.ph214
  ...
  br i1 %exitcond181, label %._crit_edge163.us.loopexit223, label %125

._crit_edge163.us.loopexit:                       ; preds = %.ph214.lver.orig
  br label %._crit_edge163.us

._crit_edge163.us.loopexit223:                    ; preds = %125
  br label %._crit_edge163.us

._crit_edge163.us:                                ; preds = %._crit_edge163.us.loopexit223, %._crit_edge163.us.loopexit
