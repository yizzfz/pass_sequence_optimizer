...
; <label>:21:                                     ; preds = %18
  call fastcc void @print_array(i32 1300, double* %16)
  br label %._crit_edge
...
define internal fastcc void @init_array(i32, double*, double*, [1300 x double]*, [1300 x double]*, double*) unnamed_addr #2 {
.lr.ph30:
...
; <label>:10:                                     ; preds = %10, %.lr.ph.us
  ...
  %26 = getelementptr inbounds [1300 x double], [1300 x double]* %4, i64 %indvars.iv32, i64 %indvars.iv
...
.lr.ph39.split.us:                                ; preds = %.lr.ph39.split.us.preheader, %._crit_edge.us
  ...
  %sunkaddr46 = add i64 %sunkaddr52, %sunkaddr45
  %sunkaddr47 = inttoptr i64 %sunkaddr46 to double*
  %sunkaddr50 = add i64 %sunkaddr48, %sunkaddr45
...
; <label>:10:                                     ; preds = %10, %.lr.ph39.split.us
  ...
  store double %17, double* %sunkaddr47, align 8
  ...
  %22 = load double, double* %sunkaddr51, align 8
  %23 = fadd double %21, %22
  store double %23, double* %sunkaddr51, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
  br i1 %exitcond, label %._crit_edge.us, label %10

._crit_edge.us:                                   ; preds = %10
  %24 = load double, double* %sunkaddr47, align 8
  %25 = fmul double %24, %1
  %26 = fmul double %23, %2
  %27 = fadd double %25, %26
  store double %27, double* %sunkaddr51, align 8
