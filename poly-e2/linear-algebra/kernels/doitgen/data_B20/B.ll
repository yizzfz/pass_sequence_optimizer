...
for.body27.us:                                    ; preds = %for.body27.us.preheader, %for.body27.us
  ...
  %exitcond56.3 = icmp eq i64 %indvars.iv.next10.us.3, %0
...
for.cond7.for.inc22_crit_edge.us46:               ; preds = %for.cond7.for.inc22_crit_edge.us46.loopexit, %for.body9.us32.prol.loopexit
  ...
  %exitcond54 = icmp eq i64 %indvars.iv.next8.us43, %0
  br i1 %exitcond54, label %for.cond4.for.cond25.preheader_crit_edge.us.loopexit81, label %for.body6.us29
...
for.body27.us.prol.loopexit:                      ; preds = %for.body27.us.prol.loopexit.loopexit, %for.body27.lr.ph.us
  %indvars.iv922.us.unr = phi i64 [ 0, %for.body27.lr.ph.us ], [ %xtraiter67, %for.body27.us.prol.loopexit.loopexit ]
...
for.body27:                                       ; preds = %for.body27.preheader, %for.body27
  ...
  %exitcond53.3 = icmp eq i64 %indvars.iv.next10.3, %0
  br i1 %exitcond53.3, label %for.inc39.loopexit, label %for.body27
...
for.inc39:                                        ; preds = %for.inc39.loopexit, %for.body27.prol.loopexit, %for.cond4.preheader
  ...
  %exitcond = icmp eq i64 %indvars.iv.next12, %1
  br i1 %exitcond, label %for.inc42.loopexit82, label %for.cond4.preheader
