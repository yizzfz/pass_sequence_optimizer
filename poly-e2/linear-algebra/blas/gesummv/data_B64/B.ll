...
for.body.us:                                      ; preds = %for.cond2.for.end_crit_edge.us, %for.body.lr.ph
  %indvars.iv6 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next7, %for.cond2.for.end_crit_edge.us ]
...
for.body5.us:                                     ; preds = %for.body5.us, %for.body.us
  ...
  %1 = mul nuw nsw i64 %indvars.iv, %indvars.iv6
...
for.cond2.for.end_crit_edge.us:                   ; preds = %for.body5.us
  ...
  br i1 %exitcond9, label %for.end26, label %for.body.us
...
for.body.us:                                      ; preds = %for.cond5.for.end_crit_edge.us, %for.body.lr.ph
  %indvars.iv3 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next4, %for.cond5.for.end_crit_edge.us ]
  ...
  %sunkaddr23 = shl i64 %indvars.iv3, 3
...
for.body7.us:                                     ; preds = %for.body7.us, %for.body.us
  ...
  store double %add.us, double* %sunkaddr21, align 8
  ...
  %arrayidx23.us = getelementptr inbounds double, double* %x, i64 %indvars.iv
  ...
  store double %add27.us, double* %sunkaddr25, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
...
for.cond5.for.end_crit_edge.us:                   ; preds = %for.body7.us
  ...
  %arrayidx34.us = getelementptr inbounds double, double* %y, i64 %indvars.iv3
  ...
  %exitcond6 = icmp eq i64 %indvars.iv.next4, 1300
  br i1 %exitcond6, label %for.end41, label %for.body.us
