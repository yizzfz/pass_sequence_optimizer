...
.lr.ph3:                                          ; preds = %6
  ...
  br i1 %18, label %.lr.ph3.split.us.preheader, label %.lr.ph3.split.preheader
...
.lr.ph3.split.us:                                 ; preds = %.lr.ph3.split.us.preheader, %._crit_edge.us
  %indvars.iv11 = phi i64 [ %26, %.lr.ph3.split.us.preheader ], [ %indvars.iv.next12, %._crit_edge.us ]
...
; <label>:35:                                     ; preds = %.lr.ph3.split.us, %35
  ...
  %41 = getelementptr inbounds [1300 x double], [1300 x double]* %20, i64 %indvars.iv11, i64 %indvars.iv
  ...
  %52 = getelementptr inbounds [1300 x double], [1300 x double]* %22, i64 %indvars.iv11, i64 %indvars.iv
...
._crit_edge.us:                                   ; preds = %35
  ...
  %54 = icmp slt i64 %indvars.iv.next12, %27
  br i1 %54, label %.lr.ph3.split.us, label %._crit_edge4.loopexit

.lr.ph3.split:                                    ; preds = %.lr.ph3.split.preheader, %.lr.ph3.split
  %indvars.iv13 = phi i64 [ %23, %.lr.ph3.split.preheader ], [ %indvars.iv.next14, %.lr.ph3.split ]
  %55 = trunc i64 %indvars.iv13 to i32
  %56 = srem i32 %55, %14
  %57 = sitofp i32 %56 to double
  %58 = fdiv double %57, %16
  %59 = getelementptr inbounds double, double* %17, i64 %indvars.iv13
  store double %58, double* %59, align 8
  %indvars.iv.next14 = add nsw i64 %indvars.iv13, 1
  %60 = icmp slt i64 %indvars.iv.next14, %15
...
._crit_edge4:                                     ; preds = %._crit_edge4.loopexit18, %._crit_edge4.loopexit
  %.lcssa8.in = phi i64 [ %indvars.iv.next12, %._crit_edge4.loopexit ], [ %indvars.iv.next14, %._crit_edge4.loopexit18 ]
...
.lr.ph3.split.preheader51:                        ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.lr.ph3.split.preheader
  %indvars.iv15.ph = phi i64 [ %32, %vector.memcheck ], [ %32, %min.iters.checked ], [ %32, %.lr.ph3.split.preheader ], [ %ind.end, %middle.block ]
  br label %.lr.ph3.split
...
; <label>:63:                                     ; preds = %.lr.ph3.split.us, %63
  ...
  %69 = load double, double* %sunkaddr23, align 8
  %70 = fadd double %68, %69
  store double %70, double* %sunkaddr27, align 8
  ...
  %76 = load double, double* %sunkaddr31, align 8
  %77 = fadd double %75, %76
  store double %77, double* %sunkaddr35, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
.lr.ph3.split:                                    ; preds = %.lr.ph3.split.preheader51, %.lr.ph3.split
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %.lr.ph3.split ], [ %indvars.iv15.ph, %.lr.ph3.split.preheader51 ]
  %88 = getelementptr inbounds double, double* %20, i64 %indvars.iv15
  store double 0.000000e+00, double* %88, align 8
  %89 = getelementptr inbounds double, double* %21, i64 %indvars.iv15
  store double 0.000000e+00, double* %89, align 8
  %90 = getelementptr inbounds double, double* %20, i64 %indvars.iv15
  %91 = load double, double* %90, align 8
  %92 = fmul double %25, %91
  %93 = fadd double %92, %33
  %94 = getelementptr inbounds double, double* %21, i64 %indvars.iv15
  store double %93, double* %94, align 8
  %indvars.iv.next16 = add nsw i64 %indvars.iv15, 1
  %95 = icmp slt i64 %indvars.iv.next16, %23
  br i1 %95, label %.lr.ph3.split, label %._crit_edge4.loopexit52, !llvm.loop !9

._crit_edge4.loopexit:                            ; preds = %._crit_edge.us
  br label %._crit_edge4

._crit_edge4.loopexit52:                          ; preds = %.lr.ph3.split
  br label %._crit_edge4

._crit_edge4:                                     ; preds = %._crit_edge4.loopexit52, %._crit_edge4.loopexit, %middle.block
  %.lcssa6.in = phi i64 [ %ind.end, %middle.block ], [ %indvars.iv.next12, %._crit_edge4.loopexit ], [ %indvars.iv.next16, %._crit_edge4.loopexit52 ]
...
; <label>:20:                                     ; preds = %16
  ...
  %fputc = tail call i32 @fputc(i32 10, %struct._IO_FILE* %21) #4
  br label %._crit_edge
