...
@__llvm_prf_nm = private constant [39 x i8] c" %x\DA\CBN\AD\CCM,I\CE`,JML\89/.I\C9\CCc,/\CA,I\05\B1\F3KK\00\CD\02\0C\A3", section "__llvm_prf_names"
@llvm.used = appending global [4 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_keymatch to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_read_stdin to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_write_stdout to i8*), i8* getelementptr inbounds ([39 x i8], [39 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
