...
for.cond1.preheader.us:                           ; preds = %for.cond1.preheader.us.preheader, %for.cond1.for.inc16_crit_edge.us
  %indvars.iv59.us = phi i64 [ %indvars.iv.next56.us, %for.cond1.for.inc16_crit_edge.us ], [ 0, %for.cond1.preheader.us.preheader ]
  %0 = add nuw nsw i64 %indvars.iv59.us, 1200
...
for.inc.us:                                       ; preds = %for.inc.us, %for.cond1.preheader.us
  ...
  %exitcond61 = icmp eq i64 %indvars.iv.next51.us, 1200
  br i1 %exitcond61, label %for.cond1.for.inc16_crit_edge.us, label %for.inc.us

for.cond1.for.inc16_crit_edge.us:                 ; preds = %for.inc.us
  %indvars.iv.next56.us = add nuw nsw i64 %indvars.iv59.us, 1
  %exitcond62 = icmp eq i64 %indvars.iv.next56.us, 1000
  br i1 %exitcond62, label %for.cond23.preheader.preheader, label %for.cond1.preheader.us
...
for.cond23.preheader:                             ; preds = %for.cond23.preheader.preheader, %for.inc51
  %indvars.iv70 = phi i3 [ %indvars.iv.next71, %for.inc51 ], [ -1, %for.cond23.preheader.preheader ]
  %indvars.iv = phi i64 [ %indvars.iv.next69, %for.inc51 ], [ 0, %for.cond23.preheader.preheader ]
  %indvars.iv4450 = phi i64 [ %indvars.iv.next45, %for.inc51 ], [ 1, %for.cond23.preheader.preheader ]
  %6 = zext i3 %indvars.iv70 to i64
  %7 = add i64 %indvars.iv, %6
  %8 = sub nuw nsw i64 999, %indvars.iv
  %9 = sub nsw i64 998, %indvars.iv
  %indvars.iv.next69 = add nuw nsw i64 %indvars.iv, 1
  %xtraiter = and i64 %indvars.iv.next69, 1
...
for.inc36.prol.loopexit.unr-lcssa:                ; preds = %for.cond23.preheader, %for.inc36.prol.preheader
  %indvars.iv35.unr.ph = phi i64 [ 1, %for.inc36.prol.preheader ], [ 0, %for.cond23.preheader ]
  %11 = icmp eq i64 %indvars.iv, 0
  br i1 %11, label %for.inc48.lr.ph, label %for.inc36.preheader

for.inc36.preheader:                              ; preds = %for.inc36.prol.loopexit.unr-lcssa
  br label %for.inc36

for.cond40.preheader:                             ; preds = %for.inc36
  %exitcond4042 = icmp eq i64 %indvars.iv, 999
  br i1 %exitcond4042, label %for.inc51, label %for.inc48.lr.ph

for.inc48.lr.ph:                                  ; preds = %for.inc36.prol.loopexit.unr-lcssa, %for.cond40.preheader
  %xtraiter66 = and i64 %8, 7
  %lcmp.mod67 = icmp eq i64 %xtraiter66, 0
  br i1 %lcmp.mod67, label %for.inc48.prol.loopexit, label %for.inc48.prol.preheader
...
for.inc48.prol:                                   ; preds = %for.inc48.prol.preheader, %for.inc48.prol
  %indvars.iv.next3843.in.prol = phi i64 [ %indvars.iv.next3843.prol, %for.inc48.prol ], [ %indvars.iv, %for.inc48.prol.preheader ]
  %prol.iter = phi i64 [ %prol.iter.sub, %for.inc48.prol ], [ %xtraiter66, %for.inc48.prol.preheader ]
  %indvars.iv.next3843.prol = add nuw nsw i64 %indvars.iv.next3843.in.prol, 1
  %arrayidx47.prol = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv, i64 %indvars.iv.next3843.prol
...
for.inc48.prol.loopexit:                          ; preds = %for.inc48.prol.loopexit.loopexit, %for.inc48.lr.ph
  %indvars.iv.next3843.in.unr = phi i64 [ %indvars.iv, %for.inc48.lr.ph ], [ %7, %for.inc48.prol.loopexit.loopexit ]
  %12 = icmp ult i64 %9, 7
  br i1 %12, label %for.inc51, label %for.inc48.preheader

for.inc48.preheader:                              ; preds = %for.inc48.prol.loopexit
  %13 = sub i64 991, %indvars.iv.next3843.in.unr
  %14 = lshr i64 %13, 3
...
for.inc48.preheader72:                            ; preds = %middle.block, %min.iters.checked, %for.inc48.preheader
  %indvars.iv.next3843.in.ph = phi i64 [ %indvars.iv.next3843.in.unr, %min.iters.checked ], [ %indvars.iv.next3843.in.unr, %for.inc48.preheader ], [ %ind.end, %middle.block ]
  br label %for.inc48
...
min.iters.checked:                                ; preds = %for.inc48.preheader
  ...
  %16 = add i64 %indvars.iv.next3843.in.unr, 8
  %17 = shl nuw i64 %14, 3
  %18 = add i64 %16, %17
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %20 = shl i64 %index, 3
  %21 = add i64 %indvars.iv.next3843.in.unr, %20
  %22 = add nsw i64 %21, 8
  %23 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv, i64 %22
  %24 = getelementptr double, double* %23, i64 -7
  %25 = bitcast double* %24 to <16 x double>*
  store <16 x double> <double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02, double -9.990000e+02>, <16 x double>* %25, align 8
  %index.next = add i64 %index, 2
  %26 = icmp eq i64 %index.next, %n.vec
  br i1 %26, label %middle.block, label %vector.body, !llvm.loop !3
...
for.inc36:                                        ; preds = %for.inc36.preheader, %for.inc36
  %indvars.iv35 = phi i64 [ %indvars.iv.next.1, %for.inc36 ], [ %indvars.iv35.unr.ph, %for.inc36.preheader ]
  %27 = add nuw nsw i64 %indvars.iv35, %indvars.iv
  %28 = trunc i64 %27 to i32
  %rem28 = srem i32 %28, 100
  %conv29 = sitofp i32 %rem28 to double
  %arrayidx35 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv, i64 %indvars.iv35
  %indvars.iv.next = add nuw nsw i64 %indvars.iv35, 1
  %29 = add nuw nsw i64 %indvars.iv.next, %indvars.iv
  %30 = trunc i64 %29 to i32
  %rem28.1 = srem i32 %30, 100
  ...
  %31 = bitcast double* %arrayidx35 to <2 x double>*
  store <2 x double> %div31, <2 x double>* %31, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv35, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, %indvars.iv4450
  br i1 %exitcond.1, label %for.cond40.preheader, label %for.inc36

for.inc48:                                        ; preds = %for.inc48.preheader72, %for.inc48
  %indvars.iv.next3843.in = phi i64 [ %indvars.iv.next3843.7, %for.inc48 ], [ %indvars.iv.next3843.in.ph, %for.inc48.preheader72 ]
  %indvars.iv.next3843 = add nuw nsw i64 %indvars.iv.next3843.in, 1
  %arrayidx47 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv, i64 %indvars.iv.next3843
  store double -9.990000e+02, double* %arrayidx47, align 8
  %indvars.iv.next3843.1 = add nsw i64 %indvars.iv.next3843.in, 2
  %arrayidx47.1 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv, i64 %indvars.iv.next3843.1
  store double -9.990000e+02, double* %arrayidx47.1, align 8
  %indvars.iv.next3843.2 = add nsw i64 %indvars.iv.next3843.in, 3
  %arrayidx47.2 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv, i64 %indvars.iv.next3843.2
  store double -9.990000e+02, double* %arrayidx47.2, align 8
  %indvars.iv.next3843.3 = add nsw i64 %indvars.iv.next3843.in, 4
  %arrayidx47.3 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv, i64 %indvars.iv.next3843.3
  store double -9.990000e+02, double* %arrayidx47.3, align 8
  %indvars.iv.next3843.4 = add nsw i64 %indvars.iv.next3843.in, 5
  %arrayidx47.4 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv, i64 %indvars.iv.next3843.4
  store double -9.990000e+02, double* %arrayidx47.4, align 8
  %indvars.iv.next3843.5 = add nsw i64 %indvars.iv.next3843.in, 6
  %arrayidx47.5 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv, i64 %indvars.iv.next3843.5
  store double -9.990000e+02, double* %arrayidx47.5, align 8
  %indvars.iv.next3843.6 = add nsw i64 %indvars.iv.next3843.in, 7
  %arrayidx47.6 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv, i64 %indvars.iv.next3843.6
  store double -9.990000e+02, double* %arrayidx47.6, align 8
  %indvars.iv.next3843.7 = add nsw i64 %indvars.iv.next3843.in, 8
  %arrayidx47.7 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv, i64 %indvars.iv.next3843.7
  store double -9.990000e+02, double* %arrayidx47.7, align 8
  %exitcond40.7 = icmp eq i64 %indvars.iv.next3843.7, 999
...
for.inc51:                                        ; preds = %for.inc51.loopexit, %middle.block, %for.inc48.prol.loopexit, %for.cond40.preheader
  %indvars.iv.next45 = add nuw nsw i64 %indvars.iv4450, 1
  %exitcond64 = icmp eq i64 %indvars.iv.next69, 1000
  %indvars.iv.next71 = add i3 %indvars.iv70, -1
...
for.cond1.preheader.us.preheader:
  ...
  %broadcast.splatinsert106 = insertelement <2 x double> undef, double %mul44.us54, i32 0
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc53_crit_edge.us, %for.cond1.preheader.us.preheader
  %indvars.iv43.us = phi i64 [ %indvars.iv.next41.us, %for.cond1.for.inc53_crit_edge.us ], [ 0, %for.cond1.preheader.us.preheader ]
  %exitcond34.us = icmp eq i64 %indvars.iv43.us, 0
  %arrayidx41.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv43.us, i64 %indvars.iv43.us
  br i1 %exitcond34.us, label %vector.memcheck, label %for.cond4.preheader.us.us.preheader
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %28, label %for.cond1.for.inc53_crit_edge.us.loopexit110, label %vector.body, !llvm.loop !16

for.cond4.preheader.us74:                         ; preds = %for.cond4.preheader.us74, %for.cond4.preheader.us74.preheader
  %indvars.iv39.us75 = phi i64 [ 0, %for.cond4.preheader.us74.preheader ], [ %indvars.iv.next37.us57.1, %for.cond4.preheader.us74 ]
  %arrayidx31.us48 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 0, i64 %indvars.iv39.us75
  %29 = load double, double* %arrayidx31.us48, align 8
  %mul32.us49 = fmul double %29, %beta
  %arrayidx36.us50 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 0, i64 %indvars.iv39.us75
  %30 = load double, double* %arrayidx36.us50, align 8
  %mul37.us51 = fmul double %30, %alpha
  %31 = load double, double* %arrayidx41.us, align 8
  %mul42.us52 = fmul double %mul37.us51, %31
  %add43.us53 = fadd double %mul32.us49, %mul42.us52
  %add45.us55 = fadd double %mul44.us54, %add43.us53
  store double %add45.us55, double* %arrayidx31.us48, align 8
  %indvars.iv.next37.us57 = or i64 %indvars.iv39.us75, 1
  %arrayidx31.us48.1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 0, i64 %indvars.iv.next37.us57
  %32 = load double, double* %arrayidx31.us48.1, align 8
  %mul32.us49.1 = fmul double %32, %beta
  %arrayidx36.us50.1 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 0, i64 %indvars.iv.next37.us57
  %33 = load double, double* %arrayidx36.us50.1, align 8
  %mul37.us51.1 = fmul double %33, %alpha
  %34 = load double, double* %arrayidx41.us, align 8
  %mul42.us52.1 = fmul double %mul37.us51.1, %34
  %add43.us53.1 = fadd double %mul32.us49.1, %mul42.us52.1
  %add45.us55.1 = fadd double %mul44.us54, %add43.us53.1
  store double %add45.us55.1, double* %arrayidx31.us48.1, align 8
  %indvars.iv.next37.us57.1 = add nsw i64 %indvars.iv39.us75, 2
  %exitcond82.1 = icmp eq i64 %indvars.iv.next37.us57.1, 1200
...
for.cond1.for.inc53_crit_edge.us.loopexit110:     ; preds = %vector.body
  br label %for.cond1.for.inc53_crit_edge.us

for.cond1.for.inc53_crit_edge.us.loopexit111:     ; preds = %for.cond4.for.inc50_crit_edge.us.us
  br label %for.cond1.for.inc53_crit_edge.us

for.cond1.for.inc53_crit_edge.us:                 ; preds = %for.cond1.for.inc53_crit_edge.us.loopexit111, %for.cond1.for.inc53_crit_edge.us.loopexit110, %for.cond1.for.inc53_crit_edge.us.loopexit
  %indvars.iv.next41.us = add nuw nsw i64 %indvars.iv43.us, 1
  %exitcond = icmp eq i64 %indvars.iv.next41.us, 1000
...
for.cond4.preheader.us.us:                        ; preds = %for.cond4.preheader.us.us.preheader, %for.cond4.for.inc50_crit_edge.us.us
  %indvars.iv39.us.us = phi i64 [ %indvars.iv.next37.us.us, %for.cond4.for.inc50_crit_edge.us.us ], [ 0, %for.cond4.preheader.us.us.preheader ]
  %arrayidx8.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv43.us, i64 %indvars.iv39.us.us
  br label %for.inc.us.us

for.cond4.for.inc50_crit_edge.us.us:              ; preds = %for.inc.us.us
  %arrayidx31.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv43.us, i64 %indvars.iv39.us.us
  ...
  %indvars.iv.next37.us.us = add nuw nsw i64 %indvars.iv39.us.us, 1
  %exitcond40.us = icmp eq i64 %indvars.iv.next37.us.us, 1200
  br i1 %exitcond40.us, label %for.cond1.for.inc53_crit_edge.us.loopexit111, label %for.cond4.preheader.us.us

for.inc.us.us:                                    ; preds = %for.inc.us.us, %for.cond4.preheader.us.us
  %temp2.036.us.us = phi double [ 0.000000e+00, %for.cond4.preheader.us.us ], [ %add27.us.us, %for.inc.us.us ]
  %indvars.iv35.us.us = phi i64 [ 0, %for.cond4.preheader.us.us ], [ %indvars.iv.next.us.us, %for.inc.us.us ]
  %38 = load double, double* %arrayidx8.us.us, align 8
  %mul.us.us = fmul double %38, %alpha
  %arrayidx12.us.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv43.us, i64 %indvars.iv35.us.us
  %39 = load double, double* %arrayidx12.us.us, align 8
  %mul13.us.us = fmul double %mul.us.us, %39
  %arrayidx17.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv35.us.us, i64 %indvars.iv39.us.us
  ...
  %arrayidx21.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv35.us.us, i64 %indvars.iv39.us.us
  ...
  %add27.us.us = fadd double %temp2.036.us.us, %mul26.us.us
  %indvars.iv.next.us.us = add nuw nsw i64 %indvars.iv35.us.us, 1
  %exitcond.us.us = icmp eq i64 %indvars.iv.next.us.us, %indvars.iv43.us
...
for.cond2.preheader.us:                           ; preds = %for.cond2.preheader.us.preheader, %for.cond2.for.inc10_crit_edge.us
  %indvars.iv14.us = phi i64 [ %indvars.iv.next11.us, %for.cond2.for.inc10_crit_edge.us ], [ 0, %for.cond2.preheader.us.preheader ]
...
for.inc.us:                                       ; preds = %if.then.us, %for.body4.us
  ...
  %arrayidx8.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv14.us, i64 %indvars.iv10.us
...
for.cond2.for.inc10_crit_edge.us:                 ; preds = %for.inc.us
  ...
  %exitcond15 = icmp eq i64 %indvars.iv.next11.us, 1000
