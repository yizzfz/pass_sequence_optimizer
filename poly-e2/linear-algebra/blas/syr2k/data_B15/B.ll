...
if.then:                                          ; preds = %land.lhs.true
  call void @print_array(i32 1200, [1200 x double]* %arraydecay)
  br label %if.end
...
vector.body79:                                    ; preds = %vector.body79, %vector.ph113
  ...
  %11 = or i64 %index114, 1
  %12 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %index114, i64 %indvars.iv47
  ...
  %18 = fmul <2 x double> %17, %broadcast.splat122
  %19 = fmul <2 x double> %18, %7
  %20 = getelementptr inbounds [1000 x double], [1000 x double]* %B, i64 %index114, i64 %indvars.iv47
  ...
  %26 = fmul <2 x double> %25, %broadcast.splat122
