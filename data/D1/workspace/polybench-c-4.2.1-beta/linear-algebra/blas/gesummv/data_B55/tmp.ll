...
.lr.ph3.split:                                    ; preds = %.lr.ph3.split.preheader, %.lr.ph3.split
  ...
  br i1 %60, label %.lr.ph3.split, label %._crit_edge4.loopexit18

._crit_edge4.loopexit:                            ; preds = %._crit_edge.us
  br label %._crit_edge4

._crit_edge4.loopexit18:                          ; preds = %.lr.ph3.split
  br label %._crit_edge4

._crit_edge4:                                     ; preds = %._crit_edge4.loopexit18, %._crit_edge4.loopexit
  %.lcssa7.in = phi i64 [ %indvars.iv.next11, %._crit_edge4.loopexit ], [ %indvars.iv.next13, %._crit_edge4.loopexit18 ]
...
.lr.ph2.split.preheader:                          ; preds = %.lr.ph2
  ...
  br i1 %min.iters.check, label %.lr.ph2.split.preheader51, label %min.iters.checked

.lr.ph2.split.preheader51:                        ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.lr.ph2.split.preheader
...
min.iters.checked:                                ; preds = %.lr.ph2.split.preheader
  ...
  br i1 %cmp.zero, label %.lr.ph2.split.preheader51, label %vector.memcheck
...
vector.memcheck:                                  ; preds = %min.iters.checked
  ...
  %scevgep41 = getelementptr double, double* %21, i64 %31
  ...
  br i1 %memcheck.conflict, label %.lr.ph2.split.preheader51, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %broadcast.splatinsert47 = insertelement <2 x double> undef, double %24, i32 0
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %._crit_edge3, label %.lr.ph2.split.preheader51
...
.lr.ph2.split:                                    ; preds = %.lr.ph2.split.preheader51, %.lr.ph2.split
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %.lr.ph2.split ], [ %indvars.iv14.ph, %.lr.ph2.split.preheader51 ]
  ...
  br i1 %95, label %.lr.ph2.split, label %._crit_edge3.loopexit52, !llvm.loop !9

._crit_edge3.loopexit:                            ; preds = %._crit_edge.us
  br label %._crit_edge3

._crit_edge3.loopexit52:                          ; preds = %.lr.ph2.split
  br label %._crit_edge3

._crit_edge3:                                     ; preds = %._crit_edge3.loopexit52, %._crit_edge3.loopexit, %middle.block
  %.lcssa5.in = phi i64 [ %ind.end, %middle.block ], [ %indvars.iv.next11, %._crit_edge3.loopexit ], [ %indvars.iv.next15, %._crit_edge3.loopexit52 ]
