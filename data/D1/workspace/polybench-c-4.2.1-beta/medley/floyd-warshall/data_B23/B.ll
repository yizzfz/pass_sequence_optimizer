...
.preheader:                                       ; preds = %22, %2
  %indvars.iv7 = phi i64 [ 0, %2 ], [ %indvars.iv.next8, %22 ]
  br label %3

; <label>:3:                                      ; preds = %21, %.preheader
  ...
  br i1 %or.cond4, label %19, label %21

; <label>:19:                                     ; preds = %3
  %20 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv7, i64 %indvars.iv
...
; <label>:22:                                     ; preds = %21
  ...
  br i1 %exitcond9, label %23, label %.preheader
...
.preheader1:                                      ; preds = %20, %2
  %indvars.iv5 = phi i64 [ 0, %2 ], [ %indvars.iv.next6, %20 ]
  br label %.preheader

.preheader:                                       ; preds = %19, %.preheader1
  %indvars.iv3 = phi i64 [ 0, %.preheader1 ], [ %indvars.iv.next4, %19 ]
  %3 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv3, i64 %indvars.iv5
  br label %4

; <label>:4:                                      ; preds = %4, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %4 ]
  %5 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv3, i64 %indvars.iv
  %6 = load i32, i32* %5, align 4
  %7 = load i32, i32* %3, align 4
  %8 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv5, i64 %indvars.iv
  ...
  %12 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv3, i64 %indvars.iv.next
  %13 = load i32, i32* %12, align 4
  %14 = load i32, i32* %3, align 4
  %15 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv5, i64 %indvars.iv.next
