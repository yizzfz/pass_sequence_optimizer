...
for.body.us.new:                                  ; preds = %for.body.us.preheader, %for.cond35.for.cond.loopexit_crit_edge.us
  %indvars.iv25 = phi i64 [ 0, %for.body.us.preheader ], [ %indvars.iv.next26, %for.cond35.for.cond.loopexit_crit_edge.us ]
...
for.cond1.preheader.us.preheader:
  %scevgep91 = getelementptr double, double* %v1, i64 2000
  %scevgep94 = getelementptr double, double* %v2, i64 2000
...
for.cond1.preheader.us.new:                       ; preds = %for.cond1.preheader.us.preheader, %for.cond1.for.inc20_crit_edge.us
  %indvars.iv83 = phi i64 [ 0, %for.cond1.preheader.us.preheader ], [ %indvars.iv.next84, %for.cond1.for.inc20_crit_edge.us ]
  %scevgep = getelementptr [2000 x double], [2000 x double]* %A, i64 %indvars.iv83, i64 0
  %0 = add i64 %indvars.iv83, 1
  %scevgep88 = getelementptr [2000 x double], [2000 x double]* %A, i64 %0, i64 0
  ...
  %bound198 = icmp ugt double* %scevgep88, %v1
  %found.conflict99 = and i1 %bound097, %bound198
  %conflict.rdx = or i1 %found.conflict, %found.conflict99
  %bound0102 = icmp ult double* %scevgep, %arrayidx11.us
  %bound1103 = icmp ult double* %arrayidx11.us, %scevgep88
  %found.conflict104 = and i1 %bound0102, %bound1103
  %conflict.rdx105 = or i1 %conflict.rdx, %found.conflict104
  %bound0106 = icmp ult double* %scevgep, %scevgep94
  %bound1107 = icmp ugt double* %scevgep88, %v2
  %found.conflict108 = and i1 %bound0106, %bound1107
  %conflict.rdx109 = or i1 %conflict.rdx105, %found.conflict108
  br i1 %conflict.rdx109, label %for.inc.us.preheader, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.vec111 = load <4 x double>, <4 x double>* %16, align 8, !alias.scope !11
  ...
  %17 = fmul <2 x double> %3, %strided.vec112
  %18 = fadd <2 x double> %strided.vec, %17
  %19 = getelementptr inbounds double, double* %v2, i64 %offset.idx
  %20 = bitcast double* %19 to <4 x double>*
  %wide.vec114 = load <4 x double>, <4 x double>* %20, align 8, !alias.scope !12
  ...
  %21 = fmul <2 x double> %6, %strided.vec115
  ...
  %25 = fmul <2 x double> %9, %strided.vec113
  %26 = fadd <2 x double> %strided.vec110, %25
  %27 = fmul <2 x double> %12, %strided.vec116
  ...
  br i1 %31, label %for.cond1.for.inc20_crit_edge.us.loopexit154, label %vector.body, !llvm.loop !13

for.inc.us:                                       ; preds = %for.inc.us.preheader, %for.inc.us
  %indvars.iv77 = phi i64 [ %indvars.iv.next78.1, %for.inc.us ], [ 0, %for.inc.us.preheader ]
  ...
  br i1 %exitcond80.1, label %for.cond1.for.inc20_crit_edge.us.loopexit, label %for.inc.us, !llvm.loop !16

for.cond1.for.inc20_crit_edge.us.loopexit:        ; preds = %for.inc.us
  br label %for.cond1.for.inc20_crit_edge.us

for.cond1.for.inc20_crit_edge.us.loopexit154:     ; preds = %vector.body
  br label %for.cond1.for.inc20_crit_edge.us

for.cond1.for.inc20_crit_edge.us:                 ; preds = %for.cond1.for.inc20_crit_edge.us.loopexit154, %for.cond1.for.inc20_crit_edge.us.loopexit
  %indvars.iv.next84 = add nuw nsw i64 %indvars.iv83, 1
  %exitcond86 = icmp eq i64 %indvars.iv.next84, 2000
  br i1 %exitcond86, label %for.cond26.preheader.us.new.preheader, label %for.cond1.preheader.us.new
...
for.cond26.preheader.us.new:                      ; preds = %for.cond26.preheader.us.new.preheader, %for.cond26.for.inc45_crit_edge.us
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.cond26.for.inc45_crit_edge.us ], [ 0, %for.cond26.preheader.us.new.preheader ]
...
for.inc42.us:                                     ; preds = %for.inc42.us, %for.cond26.preheader.us.new
  %indvars.iv67 = phi i64 [ 0, %for.cond26.preheader.us.new ], [ %indvars.iv.next68.1, %for.inc42.us ]
  %42 = load double, double* %arrayidx30.us, align 8
  ...
  br i1 %exitcond70.1, label %for.cond26.for.inc45_crit_edge.us, label %for.inc42.us

for.cond26.for.inc45_crit_edge.us:                ; preds = %for.inc42.us
  %indvars.iv.next74 = add nuw nsw i64 %indvars.iv73, 1
  %exitcond76 = icmp eq i64 %indvars.iv.next74, 2000
  br i1 %exitcond76, label %vector.memcheck132, label %for.cond26.preheader.us.new

vector.memcheck132:                               ; preds = %for.cond26.for.inc45_crit_edge.us
  %scevgep123 = getelementptr double, double* %x, i64 2000
  %scevgep126 = getelementptr double, double* %z, i64 2000
  %bound0128 = icmp ugt double* %scevgep126, %x
  %bound1129 = icmp ugt double* %scevgep123, %z
  %memcheck.conflict131 = and i1 %bound0128, %bound1129
  br i1 %memcheck.conflict131, label %for.inc58.preheader, label %vector.body117.preheader

vector.body117.preheader:                         ; preds = %vector.memcheck132
  br label %vector.body117

for.inc58.preheader:                              ; preds = %vector.memcheck132
  br label %for.inc58

vector.body117:                                   ; preds = %vector.body117.preheader, %vector.body117
  %index134 = phi i64 [ %index.next135, %vector.body117 ], [ 0, %vector.body117.preheader ]
  %offset.idx138 = shl i64 %index134, 2
  %47 = getelementptr inbounds double, double* %x, i64 %offset.idx138
  %48 = bitcast double* %47 to <8 x double>*
  %wide.vec142 = load <8 x double>, <8 x double>* %48, align 8, !alias.scope !17, !noalias !20
  %49 = getelementptr inbounds double, double* %z, i64 %offset.idx138
  %50 = bitcast double* %49 to <8 x double>*
  %wide.vec147 = load <8 x double>, <8 x double>* %50, align 8, !alias.scope !20
  %51 = fadd <8 x double> %wide.vec142, %wide.vec147
  %52 = shufflevector <8 x double> %51, <8 x double> undef, <2 x i32> <i32 0, i32 4>
  %53 = fadd <8 x double> %wide.vec142, %wide.vec147
  %54 = shufflevector <8 x double> %53, <8 x double> undef, <2 x i32> <i32 1, i32 5>
  %55 = fadd <8 x double> %wide.vec142, %wide.vec147
  %56 = shufflevector <8 x double> %55, <8 x double> undef, <2 x i32> <i32 2, i32 6>
  %57 = or i64 %offset.idx138, 3
  %58 = getelementptr inbounds double, double* %x, i64 %57
  %59 = fadd <8 x double> %wide.vec142, %wide.vec147
  ...
  %interleaved.vec152 = shufflevector <4 x double> %63, <4 x double> %64, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 1, i32 3, i32 5, i32 7>
  store <8 x double> %interleaved.vec152, <8 x double>* %62, align 8, !alias.scope !17, !noalias !20
  %index.next135 = add i64 %index134, 2
  %65 = icmp eq i64 %index.next135, 500
  br i1 %65, label %for.cond64.preheader.us.new.preheader.loopexit153, label %vector.body117, !llvm.loop !22

for.cond64.preheader.us.new.preheader.loopexit:   ; preds = %for.inc58
  br label %for.cond64.preheader.us.new.preheader

for.cond64.preheader.us.new.preheader.loopexit153: ; preds = %vector.body117
  br label %for.cond64.preheader.us.new.preheader

for.cond64.preheader.us.new.preheader:            ; preds = %for.cond64.preheader.us.new.preheader.loopexit153, %for.cond64.preheader.us.new.preheader.loopexit
...
for.cond64.preheader.us.new:                      ; preds = %for.cond64.preheader.us.new.preheader, %for.cond64.for.inc83_crit_edge.us
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.cond64.for.inc83_crit_edge.us ], [ 0, %for.cond64.preheader.us.new.preheader ]
...
for.inc80.us:                                     ; preds = %for.inc80.us, %for.cond64.preheader.us.new
  ...
  %66 = load double, double* %arrayidx68.us, align 8
...
for.inc58:                                        ; preds = %for.inc58.preheader, %for.inc58
  %indvars.iv61 = phi i64 [ %indvars.iv.next62.3, %for.inc58 ], [ 0, %for.inc58.preheader ]
  ...
  br i1 %exitcond64.3, label %for.cond64.preheader.us.new.preheader.loopexit, label %for.inc58, !llvm.loop !23
