...
for.body6.lr.ph:                                  ; preds = %for.end, %for.body.lr.ph
  %indvars.iv8 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next9, %for.end ]
  %arrayidx = getelementptr inbounds double, double* %x, i64 %indvars.iv8
  store double -9.990000e+02, double* %arrayidx, align 8
  %1 = trunc i64 %indvars.iv8 to i32
  %conv = sitofp i32 %1 to double
  %arrayidx2 = getelementptr inbounds double, double* %b, i64 %indvars.iv8
  store double %conv, double* %arrayidx2, align 8
  %2 = add nuw nsw i64 %indvars.iv8, 1
  %3 = trunc i64 %2 to i32
  %sub = add i32 %3, %n
  %4 = and i64 %indvars.iv8, 1
...
for.body6.prol.loopexit:                          ; preds = %for.body6.prol.loopexit.unr-lcssa
  %5 = icmp eq i64 %indvars.iv8, 0
  br i1 %5, label %for.end, label %for.body6.lr.ph.new
...
for.body6:                                        ; preds = %for.body6, %for.body6.lr.ph.new
  ...
  %arrayidx13 = getelementptr inbounds [2000 x double], [2000 x double]* %L, i64 %indvars.iv8, i64 %indvars.iv
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %8 = trunc i64 %indvars.iv to i32
  %9 = xor i32 %8, -1
  %add7.1 = add i32 %sub, %9
  ...
  store <2 x double> %div, <2 x double>* %10, align 8
  %exitcond7.1 = icmp eq i64 %indvars.iv.next, %indvars.iv8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  br i1 %exitcond7.1, label %for.end.unr-lcssa, label %for.body6
...
for.end:                                          ; preds = %for.body6.prol.loopexit, %for.end.unr-lcssa
  ...
  %exitcond = icmp ne i64 %indvars.iv.next9, %0
...
for.body.preheader:                               ; preds = %entry
  %0 = sext i32 %n to i64
  %sunkaddr12 = ptrtoint double* %x to i64
  %sunkaddr = ptrtoint double* %x to i64
  br label %for.body

for.body:                                         ; preds = %for.end, %for.body.preheader
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.end ], [ 0, %for.body.preheader ]
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.end ], [ -1, %for.body.preheader ]
...
for.body5.prol:                                   ; preds = %for.body5.prol.preheader
  %arrayidx9.prol = getelementptr inbounds [2000 x double], [2000 x double]* %L, i64 %indvars.iv7, i64 0
  %2 = load double, double* %arrayidx9.prol, align 8
  %3 = load double, double* %x, align 8
  %mul.prol = fmul double %2, %3
  %sub.prol = fsub double %1, %mul.prol
  store double %sub.prol, double* %sunkaddr11, align 8
...
for.body5.prol.loopexit.unr-lcssa:                ; preds = %for.body5.preheader, %for.body5.prol
  ...
  %.unr.ph = phi double [ %sub.prol, %for.body5.prol ], [ %1, %for.body5.preheader ]
  br label %for.body5.prol.loopexit

for.body5.prol.loopexit:                          ; preds = %for.body5.prol.loopexit.unr-lcssa
  %4 = icmp eq i64 %indvars.iv7, 1
  br i1 %4, label %for.end.loopexit, label %for.body5.preheader.new
...
for.body5:                                        ; preds = %for.body5, %for.body5.preheader.new
  ...
  %5 = phi double [ %.unr.ph, %for.body5.preheader.new ], [ %sub.1, %for.body5 ]
  ...
  store double %sub, double* %sunkaddr11, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx9.1 = getelementptr inbounds [2000 x double], [2000 x double]* %L, i64 %indvars.iv7, i64 %indvars.iv.next
  %8 = load double, double* %arrayidx9.1, align 8
  %arrayidx11.1 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next
  %9 = load double, double* %arrayidx11.1, align 8
  %mul.1 = fmul double %8, %9
  %sub.1 = fsub double %sub, %mul.1
  store double %sub.1, double* %sunkaddr11, align 8
  %exitcond6.1 = icmp eq i64 %indvars.iv.next, %indvars.iv4
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  br i1 %exitcond6.1, label %for.end.loopexit.unr-lcssa, label %for.body5
...
for.end:                                          ; preds = %for.end.loopexit, %for.body
  %.lcssa = phi double [ %1, %for.body ], [ %sub.lcssa, %for.end.loopexit ]
  ...
  %div = fdiv double %.lcssa, %10
  %sunkaddr13 = shl i64 %indvars.iv7, 3
  %sunkaddr14 = add i64 %sunkaddr12, %sunkaddr13
  %sunkaddr15 = inttoptr i64 %sunkaddr14 to double*
  store double %div, double* %sunkaddr15, align 8
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %indvars.iv.next5 = add nsw i64 %indvars.iv4, 1
  %exitcond = icmp ne i64 %indvars.iv.next8, %0
...
for.body:                                         ; preds = %if.end, %for.body.preheader
  ...
  %call2 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %3, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i64 0, i64 0), double %4) #6
