...
for.body6:                                        ; preds = %for.body6, %for.body6.lr.ph.new
  ...
  %exitcond8.1 = icmp eq i64 %indvars.iv.next, %indvars.iv9
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  br i1 %exitcond8.1, label %for.inc14.unr-lcssa, label %for.body6
...
for.body:                                         ; preds = %for.end, %for.body.preheader
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.end ], [ 0, %for.body.preheader ]
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.end ], [ -1, %for.body.preheader ]
  ...
  %cmp42 = icmp sgt i64 %indvars.iv8, 0
  br i1 %cmp42, label %for.body5.preheader, label %for.end

for.body5.preheader:                              ; preds = %for.body
  %xtraiter = and i64 %indvars.iv8, 1
...
for.body5:                                        ; preds = %for.body5, %for.body5.preheader.new
  ...
  %exitcond7.1 = icmp eq i64 %indvars.iv.next, %indvars.iv5
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  br i1 %exitcond7.1, label %for.end.loopexit.unr-lcssa, label %for.body5
