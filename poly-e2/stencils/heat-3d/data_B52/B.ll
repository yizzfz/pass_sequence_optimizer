...
for.cond8.preheader.us:                           ; preds = %for.cond8.preheader.us.preheader, %for.inc95.us
  ...
  br i1 %min.iters.check85, label %for.body11.us.preheader, label %min.iters.checked86

min.iters.checked86:                              ; preds = %for.cond8.preheader.us
  br i1 %cmp.zero89, label %for.body11.us.preheader, label %vector.memcheck108
...
vector.memcheck108:                               ; preds = %min.iters.checked86
  ...
  br i1 %memcheck.conflict107, label %for.body11.us.preheader, label %vector.body81.preheader
...
middle.block82:                                   ; preds = %vector.body81
  br i1 %cmp.n114, label %for.inc95.us, label %for.body11.us.preheader

for.body11.us.preheader:                          ; preds = %middle.block82, %vector.memcheck108, %min.iters.checked86, %for.cond8.preheader.us
...
for.body112.us:                                   ; preds = %for.body112.us.preheader, %for.body112.us
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.body112.us ], [ %indvars.iv56.ph, %for.body112.us.preheader ]
