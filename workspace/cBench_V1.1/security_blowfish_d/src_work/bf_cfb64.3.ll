...
@__llvm_prf_nm = private constant [26 x i8] c"\10\18x\DAsr\8BONK23\89O\CDK.\AA,(\01\00.6\05\E1", section "__llvm_prf_names"
@llvm.used = appending global [2 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_BF_cfb64_encrypt to i8*), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
