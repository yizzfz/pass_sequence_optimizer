...
.lr.ph:                                           ; preds = %.lr.ph5, %._crit_edge
  %indvars.iv15 = phi i64 [ 0, %.lr.ph5 ], [ %indvars.iv.next16, %._crit_edge ]
  %indvars.iv13 = phi i64 [ 1, %.lr.ph5 ], [ %indvars.iv.next14, %._crit_edge ]
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  %4 = getelementptr inbounds double, double* %2, i64 %indvars.iv15
  store double -9.990000e+02, double* %4, align 8
  %5 = trunc i64 %indvars.iv15 to i32
  %6 = sitofp i32 %5 to double
  %7 = getelementptr inbounds double, double* %3, i64 %indvars.iv15
  store double %6, double* %7, align 8
  %8 = trunc i64 %indvars.iv15 to i32
  %9 = add i32 %8, 2001
  %xtraiter19 = and i64 %indvars.iv.next16, 1
  %lcmp.mod = icmp eq i64 %xtraiter19, 0
...
.prol.preheader:                                  ; preds = %.lr.ph
  ...
  %13 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv15, i64 0
  store double %12, double* %13, align 8
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph
  %indvars.iv.unr.ph = phi i64 [ 1, %.prol.preheader ], [ 0, %.lr.ph ]
  %14 = icmp eq i64 %indvars.iv15, 0
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %exitcond12.1 = icmp eq i64 %indvars.iv.next.1, %indvars.iv13
  br i1 %exitcond12.1, label %._crit_edge.loopexit, label %.lr.ph.new
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit
  ...
  br i1 %exitcond18, label %._crit_edge6, label %.lr.ph
...
; <label>:4:                                      ; preds = %._crit_edge, %.lr.ph12
  %indvars.iv26 = phi i64 [ 0, %.lr.ph12 ], [ %indvars.iv.next27, %._crit_edge ]
  %5 = add i64 %indvars.iv26, 4294967295
  %6 = getelementptr inbounds double, double* %3, i64 %indvars.iv26
  %7 = load double, double* %6, align 8
  %8 = getelementptr inbounds double, double* %2, i64 %indvars.iv26
  store double %7, double* %8, align 8
  %9 = icmp sgt i64 %indvars.iv26, 0
  br i1 %9, label %.lr.ph, label %._crit_edge

.lr.ph:                                           ; preds = %4
  %xtraiter30 = and i64 %indvars.iv26, 1
  %lcmp.mod = icmp eq i64 %xtraiter30, 0
  br i1 %lcmp.mod, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.lr.ph
  %10 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv26, i64 0
  %11 = load double, double* %10, align 8
  %12 = load double, double* %2, align 8
  %13 = fmul double %11, %12
  %14 = fsub double %7, %13
  %sunkaddr32 = shl i64 %indvars.iv26, 3
...
.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph
  ...
  %.lcssa17.unr.ph = phi double [ %14, %.prol.preheader ], [ undef, %.lr.ph ]
  %15 = trunc i64 %5 to i32
  %16 = icmp eq i32 %15, 0
  br i1 %16, label %._crit_edge, label %.lr.ph.new.preheader

.lr.ph.new.preheader:                             ; preds = %.prol.loopexit
  %sunkaddr36 = shl i64 %indvars.iv26, 3
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %24 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv26, i64 %indvars.iv.next
  %25 = load double, double* %24, align 8
  %26 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next
  %27 = load double, double* %26, align 8
  %28 = fmul double %25, %27
  %29 = fsub double %23, %28
  store double %29, double* %sunkaddr38, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %exitcond23.1 = icmp eq i64 %indvars.iv.next.1, %indvars.iv26
  br i1 %exitcond23.1, label %._crit_edge.loopexit, label %.lr.ph.new

._crit_edge.loopexit:                             ; preds = %.lr.ph.new
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %4, %.prol.loopexit
  %.lcssa = phi double [ %.lcssa17.unr.ph, %.prol.loopexit ], [ %7, %4 ], [ %29, %._crit_edge.loopexit ]
  %30 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv26, i64 %indvars.iv26
  ...
  store double %32, double* %sunkaddr42, align 8
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv26, 1
  %exitcond29 = icmp eq i64 %indvars.iv.next27, 2000
  br i1 %exitcond29, label %._crit_edge13, label %4
