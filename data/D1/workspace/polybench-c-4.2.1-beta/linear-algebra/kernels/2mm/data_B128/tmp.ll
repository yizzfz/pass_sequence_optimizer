...
._crit_edge98:                                    ; preds = %._crit_edge98, %.lr.ph26.split.us
  ...
  %10 = mul nuw nsw i64 %indvars.iv79, %indvars.iv83
...
.lr.ph19.split.us.new:                            ; preds = %.lr.ph19.split.us.new, %.lr.ph19.split.us
  ...
  %17 = mul nuw nsw i64 %indvars.iv.next72, %indvars.iv75
  ...
  %23 = mul nuw nsw i64 %indvars.iv.next72.1, %indvars.iv75
...
._crit_edge99:                                    ; preds = %._crit_edge99, %.lr.ph12.split.us
  ...
  %30 = mul nuw nsw i64 %29, %indvars.iv67
...
._crit_edge100:                                   ; preds = %._crit_edge100, %.lr.ph5.split.us
  ...
  %38 = mul nuw nsw i64 %37, %indvars.iv61
