...
.preheader.us:                                    ; preds = %.loopexit.us, %.preheader.lr.ph..preheader.us_crit_edge
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %.loopexit.us ], [ 0, %.preheader.lr.ph..preheader.us_crit_edge ]
  br label %2

; <label>:2:                                      ; preds = %2, %.preheader.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %2 ], [ 0, %.preheader.us ]
  %3 = mul nuw nsw i64 %indvars.iv18, %indvars.iv
  %4 = trunc i64 %3 to i32
  %5 = srem i32 %4, 7
  %6 = add nsw i32 %5, 1
  %7 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv18, i64 %indvars.iv
  %8 = add nuw nsw i64 %indvars.iv, %indvars.iv18
  ...
  %. = select i1 %or.cond3.us, i32 999, i32 %6
...
.loopexit.us:                                     ; preds = %2
  ...
  %exitcond20 = icmp eq i64 %indvars.iv.next19, 2800
  br i1 %exitcond20, label %.loopexit7, label %.preheader.us
...
.preheader3.us..preheader.us.us_crit_edge:        ; preds = %.loopexit7.us.loopexit, %.preheader3.lr.ph..preheader3.us_crit_edge
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %.loopexit7.us.loopexit ], [ 0, %.preheader3.lr.ph..preheader3.us_crit_edge ]
  br label %.preheader.us.us

.loopexit7.us.loopexit:                           ; preds = %.loopexit.us.us
  %indvars.iv.next40 = add nuw nsw i64 %indvars.iv39, 1
  %exitcond = icmp eq i64 %indvars.iv.next40, 2800
  br i1 %exitcond, label %.loopexit8, label %.preheader3.us..preheader.us.us_crit_edge

.preheader.us.us:                                 ; preds = %.loopexit.us.us, %.preheader3.us..preheader.us.us_crit_edge
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %.loopexit.us.us ], [ 0, %.preheader3.us..preheader.us.us_crit_edge ]
  %2 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv35, i64 %indvars.iv39
  br label %.preheader.us.us.new

.loopexit.us.us:                                  ; preds = %.preheader.us.us.new
  %indvars.iv.next36 = add nuw nsw i64 %indvars.iv35, 1
  %exitcond38 = icmp eq i64 %indvars.iv.next36, 2800
  br i1 %exitcond38, label %.loopexit7.us.loopexit, label %.preheader.us.us
...
.preheader.us.us.new:                             ; preds = %.preheader.us.us, %.preheader.us.us.new
  ...
  %3 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv35, i64 %indvars.iv
  %4 = load i32, i32* %3, align 4
  %5 = load i32, i32* %2, align 4
  %6 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv39, i64 %indvars.iv
  ...
  %10 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv35, i64 %indvars.iv.next
  %11 = load i32, i32* %10, align 4
  %12 = load i32, i32* %2, align 4
  %13 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv39, i64 %indvars.iv.next
  ...
  %exitcond34.1 = icmp eq i64 %indvars.iv.next.1, 2800
  br i1 %exitcond34.1, label %.loopexit.us.us, label %.preheader.us.us.new

.loopexit8:                                       ; preds = %.loopexit7.us.loopexit
  ret void
}
...
.preheader.us:                                    ; preds = %.loopexit.us, %.preheader.lr.ph..preheader.us_crit_edge
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %.loopexit.us ], [ 0, %.preheader.lr.ph..preheader.us_crit_edge ]
  %6 = mul nuw nsw i64 %indvars.iv15, 2800
  br label %7
...
; <label>:14:                                     ; preds = %7, %12
  ...
  %16 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv15, i64 %indvars.iv
...
.loopexit.us:                                     ; preds = %14
  ...
  br i1 %exitcond17, label %.loopexit4, label %.preheader.us
