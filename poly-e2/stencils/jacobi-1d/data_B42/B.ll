...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc33
  ...
  br i1 %1, label %for.body3.preheader, label %for.inc33

for.body3.preheader:                              ; preds = %for.body
  br i1 %min.iters.check34, label %for.body3.preheader70, label %min.iters.checked35

min.iters.checked35:                              ; preds = %for.body3.preheader
  br i1 %cmp.zero, label %for.body3.preheader70, label %vector.memcheck51

vector.memcheck51:                                ; preds = %min.iters.checked35
  br i1 %found.conflict49, label %for.body3.preheader70, label %vector.body30.preheader
...
middle.block31:                                   ; preds = %vector.body30
  br i1 %cmp.n, label %for.end, label %for.body3.preheader70

for.body3.preheader70:                            ; preds = %middle.block31, %vector.memcheck51, %min.iters.checked35, %for.body3.preheader
  %indvars.iv.ph = phi i64 [ 1, %vector.memcheck51 ], [ 1, %min.iters.checked35 ], [ 1, %for.body3.preheader ], [ %ind.end, %middle.block31 ]
  br label %for.body3

for.body3:                                        ; preds = %for.body3.preheader70, %for.body3
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body3 ], [ %indvars.iv.ph, %for.body3.preheader70 ]
...
for.body16.preheader:                             ; preds = %for.end
  br i1 %min.iters.check34, label %for.body16.preheader69, label %min.iters.checked
...
for.body16.preheader69:                           ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.body16.preheader
  %indvars.iv15.ph = phi i64 [ 1, %vector.memcheck ], [ 1, %min.iters.checked ], [ 1, %for.body16.preheader ], [ %ind.end, %middle.block ]
  br label %for.body16

for.body16:                                       ; preds = %for.body16.preheader69, %for.body16
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.body16 ], [ %indvars.iv15.ph, %for.body16.preheader69 ]
