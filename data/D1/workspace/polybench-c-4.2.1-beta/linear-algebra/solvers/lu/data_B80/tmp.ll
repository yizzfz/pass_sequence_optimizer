...
.preheader71:                                     ; preds = %8
  ...
  %5 = icmp slt i64 %indvars.iv.next45, 2000
...
; <label>:8:                                      ; preds = %8, %.lr.ph
  ...
  br i1 %exitcond36, label %.preheader71, label %8
...
; <label>:19:                                     ; preds = %19, %16
  ...
  %exitcond94.7 = icmp eq i64 %indvars.iv.next31.7, 2000
  br i1 %exitcond94.7, label %.preheader68.preheader, label %19
...
.preheader68:                                     ; preds = %82, %.preheader68.preheader
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %82 ], [ 0, %.preheader68.preheader ]
  %scevgep51 = getelementptr [2000 x double], [2000 x double]* %0, i64 0, i64 %indvars.iv25
  %31 = add nuw nsw i64 %indvars.iv25, 1
  %scevgep53 = getelementptr [2000 x double], [2000 x double]* %0, i64 1999, i64 %31
  %32 = bitcast double* %scevgep53 to i8*
  %33 = bitcast double* %scevgep51 to i8*
  br label %.preheader67

.preheader67:                                     ; preds = %middle.block, %.preheader68
  %indvars.iv23 = phi i64 [ 0, %.preheader68 ], [ %indvars.iv.next24, %middle.block ]
  %34 = mul nuw nsw i64 %indvars.iv23, 16000
  %scevgep49 = getelementptr i8, i8* %18, i64 %34
  %35 = add nuw nsw i64 %34, 16000
  %scevgep50 = getelementptr i8, i8* %18, i64 %35
  %36 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv23, i64 %indvars.iv25
  %bound0 = icmp ult i8* %scevgep49, %32
  %bound1 = icmp ult i8* %33, %scevgep50
  %found.conflict = and i1 %bound0, %bound1
  %bc = bitcast double* %36 to i8*
  %bc55 = bitcast double* %36 to i8*
  %bound056 = icmp ult i8* %scevgep49, %bc55
  %bound157 = icmp ult i8* %bc, %scevgep50
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %45 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %index, i64 %indvars.iv25
  %46 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %37, i64 %indvars.iv25
  %47 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %38, i64 %indvars.iv25
  %48 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %39, i64 %indvars.iv25
  ...
  %59 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %30, i64 0, i64 %indvars.iv23, i64 %index
  ...
  %wide.load60 = load <2 x double>, <2 x double>* %62, align 8, !alias.scope !6, !noalias !8
  %63 = fadd <2 x double> %wide.load, %57
  %64 = fadd <2 x double> %wide.load60, %58
  ...
  br i1 %67, label %middle.block.loopexit96, label %vector.body, !llvm.loop !9

scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader
  %indvars.iv20 = phi i64 [ 0, %scalar.ph.preheader ], [ %indvars.iv.next21.1, %scalar.ph ]
  %68 = load double, double* %36, align 8
  %69 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv20, i64 %indvars.iv25
  %70 = load double, double* %69, align 8
  %71 = fmul double %68, %70
  %72 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %28, i64 0, i64 %indvars.iv23, i64 %indvars.iv20
  ...
  %76 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv.next21, i64 %indvars.iv25
  %77 = load double, double* %76, align 8
  %78 = fmul double %75, %77
  %79 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %29, i64 0, i64 %indvars.iv23, i64 %indvars.iv.next21
...
middle.block.loopexit96:                          ; preds = %vector.body
  br label %middle.block

middle.block:                                     ; preds = %middle.block.loopexit96, %middle.block.loopexit
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  %exitcond92 = icmp eq i64 %indvars.iv.next24, 2000
  br i1 %exitcond92, label %82, label %.preheader67

; <label>:82:                                     ; preds = %middle.block
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  %exitcond93 = icmp eq i64 %indvars.iv.next26, 2000
  br i1 %exitcond93, label %.preheader.preheader, label %.preheader68
...
.preheader:                                       ; preds = %middle.block62, %.preheader.preheader
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %middle.block62 ], [ 0, %.preheader.preheader ]
  %scevgep66 = getelementptr [2000 x double], [2000 x double]* %0, i64 %indvars.iv18, i64 0
  %scevgep6667 = bitcast double* %scevgep66 to i8*
  %90 = add nuw nsw i64 %indvars.iv18, 1
  %scevgep68 = getelementptr [2000 x double], [2000 x double]* %0, i64 %90, i64 0
  %scevgep6869 = bitcast double* %scevgep68 to i8*
  %91 = mul nuw nsw i64 %indvars.iv18, 16000
  %scevgep70 = getelementptr i8, i8* %18, i64 %91
  %92 = add nuw nsw i64 %91, 16000
  %scevgep71 = getelementptr i8, i8* %18, i64 %92
  %bound072 = icmp ult i8* %scevgep6667, %scevgep71
  %bound173 = icmp ult i8* %scevgep70, %scevgep6869
  %memcheck.conflict75 = and i1 %bound072, %bound173
  br i1 %memcheck.conflict75, label %scalar.ph63.preheader, label %vector.body61.preheader

vector.body61.preheader:                          ; preds = %.preheader
  br label %vector.body61

scalar.ph63.preheader:                            ; preds = %.preheader
  br label %scalar.ph63

vector.body61:                                    ; preds = %vector.body61, %vector.body61.preheader
  %index78 = phi i64 [ 0, %vector.body61.preheader ], [ %index.next79.1, %vector.body61 ]
  %93 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %88, i64 0, i64 %indvars.iv18, i64 %index78
  %94 = bitcast double* %93 to <2 x i64>*
  %wide.load86 = load <2 x i64>, <2 x i64>* %94, align 8, !alias.scope !13
  %95 = getelementptr double, double* %93, i64 2
  %96 = bitcast double* %95 to <2 x i64>*
  %wide.load87 = load <2 x i64>, <2 x i64>* %96, align 8, !alias.scope !13
  %97 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv18, i64 %index78
  %98 = bitcast double* %97 to <2 x i64>*
  store <2 x i64> %wide.load86, <2 x i64>* %98, align 8, !alias.scope !16, !noalias !13
  %99 = getelementptr double, double* %97, i64 2
  %100 = bitcast double* %99 to <2 x i64>*
  store <2 x i64> %wide.load87, <2 x i64>* %100, align 8, !alias.scope !16, !noalias !13
  %index.next79 = or i64 %index78, 4
  %101 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %89, i64 0, i64 %indvars.iv18, i64 %index.next79
  %102 = bitcast double* %101 to <2 x i64>*
  %wide.load86.1 = load <2 x i64>, <2 x i64>* %102, align 8, !alias.scope !13
  %103 = getelementptr double, double* %101, i64 2
  %104 = bitcast double* %103 to <2 x i64>*
  %wide.load87.1 = load <2 x i64>, <2 x i64>* %104, align 8, !alias.scope !13
  %105 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv18, i64 %index.next79
  %106 = bitcast double* %105 to <2 x i64>*
  store <2 x i64> %wide.load86.1, <2 x i64>* %106, align 8, !alias.scope !16, !noalias !13
  %107 = getelementptr double, double* %105, i64 2
  %108 = bitcast double* %107 to <2 x i64>*
  store <2 x i64> %wide.load87.1, <2 x i64>* %108, align 8, !alias.scope !16, !noalias !13
  %index.next79.1 = add nsw i64 %index78, 8
  %109 = icmp eq i64 %index.next79.1, 2000
  br i1 %109, label %middle.block62.loopexit95, label %vector.body61, !llvm.loop !18

scalar.ph63:                                      ; preds = %scalar.ph63, %scalar.ph63.preheader
  %indvars.iv = phi i64 [ 0, %scalar.ph63.preheader ], [ %indvars.iv.next.4, %scalar.ph63 ]
  %110 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %83, i64 0, i64 %indvars.iv18, i64 %indvars.iv
  %111 = bitcast double* %110 to i64*
  %112 = load i64, i64* %111, align 8
  %113 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv18, i64 %indvars.iv
  %114 = bitcast double* %113 to i64*
  store i64 %112, i64* %114, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %115 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %84, i64 0, i64 %indvars.iv18, i64 %indvars.iv.next
  %116 = bitcast double* %115 to i64*
  %117 = load i64, i64* %116, align 8
  %118 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv18, i64 %indvars.iv.next
  %119 = bitcast double* %118 to i64*
  store i64 %117, i64* %119, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %120 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %85, i64 0, i64 %indvars.iv18, i64 %indvars.iv.next.1
  %121 = bitcast double* %120 to i64*
  %122 = load i64, i64* %121, align 8
  %123 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv18, i64 %indvars.iv.next.1
  %124 = bitcast double* %123 to i64*
  store i64 %122, i64* %124, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %125 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %86, i64 0, i64 %indvars.iv18, i64 %indvars.iv.next.2
  %126 = bitcast double* %125 to i64*
  %127 = load i64, i64* %126, align 8
  %128 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv18, i64 %indvars.iv.next.2
  %129 = bitcast double* %128 to i64*
  store i64 %127, i64* %129, align 8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %130 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %87, i64 0, i64 %indvars.iv18, i64 %indvars.iv.next.3
  %131 = bitcast double* %130 to i64*
  %132 = load i64, i64* %131, align 8
  %133 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv18, i64 %indvars.iv.next.3
  %134 = bitcast double* %133 to i64*
  store i64 %132, i64* %134, align 8
  %exitcond.4 = icmp eq i64 %indvars.iv.next.3, 1999
  %indvars.iv.next.4 = add nsw i64 %indvars.iv, 5
  br i1 %exitcond.4, label %middle.block62.loopexit, label %scalar.ph63, !llvm.loop !19

middle.block62.loopexit:                          ; preds = %scalar.ph63
  br label %middle.block62

middle.block62.loopexit95:                        ; preds = %vector.body61
  br label %middle.block62

middle.block62:                                   ; preds = %middle.block62.loopexit95, %middle.block62.loopexit
  %indvars.iv.next19 = add nuw nsw i64 %indvars.iv18, 1
  %exitcond91 = icmp eq i64 %indvars.iv.next19, 2000
  br i1 %exitcond91, label %135, label %.preheader

; <label>:135:                                    ; preds = %middle.block62
...
.preheader.us:                                    ; preds = %._crit_edge5.us, %.preheader.us.preheader
  %indvars.iv30 = phi i64 [ %indvars.iv36, %.preheader.us.preheader ], [ %indvars.iv.next31, %._crit_edge5.us ]
