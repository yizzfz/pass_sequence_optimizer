...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge10
  %indvars.iv1121 = phi i64 [ 0, %._crit_edge10 ], [ %indvars.iv.next12, %._crit_edge ]
  %7 = mul nuw nsw i64 %indvars.iv1121, %indvars.iv1322
...
; <label>:14:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond7, label %.preheader9.preheader, label %._crit_edge10

.preheader9.preheader:                            ; preds = %14
  br label %.preheader9

.preheader9:                                      ; preds = %.preheader9.preheader, %27
  %indvars.iv920 = phi i64 [ %indvars.iv.next10, %27 ], [ 0, %.preheader9.preheader ]
  br label %._crit_edge11

._crit_edge11:                                    ; preds = %._crit_edge11, %.preheader9
  %indvars.iv719 = phi i64 [ 0, %.preheader9 ], [ %indvars.iv.next8.1, %._crit_edge11 ]
  %indvars.iv.next8 = or i64 %indvars.iv719, 1
  %15 = mul nuw nsw i64 %indvars.iv.next8, %indvars.iv920
  %16 = trunc i64 %15 to i32
  %17 = srem i32 %16, 900
  %18 = sitofp i32 %17 to double
  %19 = fdiv double %18, 9.000000e+02
  %20 = getelementptr inbounds [900 x double], [900 x double]* %3, i64 %indvars.iv920, i64 %indvars.iv719
  store double %19, double* %20, align 8
  %indvars.iv.next8.1 = add nuw nsw i64 %indvars.iv719, 2
  %21 = mul nuw nsw i64 %indvars.iv.next8.1, %indvars.iv920
  %22 = trunc i64 %21 to i32
  %23 = srem i32 %22, 900
  %24 = sitofp i32 %23 to double
  %25 = fdiv double %24, 9.000000e+02
  %26 = getelementptr inbounds [900 x double], [900 x double]* %3, i64 %indvars.iv920, i64 %indvars.iv.next8
  store double %25, double* %26, align 8
  %exitcond4.1 = icmp eq i64 %indvars.iv.next8.1, 900
  br i1 %exitcond4.1, label %27, label %._crit_edge11
...
.preheader8.preheader:                            ; preds = %27
  br label %.preheader8

.preheader8:                                      ; preds = %.preheader8.preheader, %36
  %indvars.iv518 = phi i64 [ %indvars.iv.next6, %36 ], [ 0, %.preheader8.preheader ]
  br label %._crit_edge12

._crit_edge12:                                    ; preds = %._crit_edge12, %.preheader8
  %indvars.iv317 = phi i64 [ 0, %.preheader8 ], [ %indvars.iv.next4, %._crit_edge12 ]
  %28 = add nuw nsw i64 %indvars.iv317, 3
  %29 = mul nuw nsw i64 %28, %indvars.iv518
  %30 = add nuw nsw i64 %29, 1
  %31 = trunc i64 %30 to i32
  %32 = srem i32 %31, 1200
  %33 = sitofp i32 %32 to double
  %34 = fdiv double %33, 1.200000e+03
  %35 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv518, i64 %indvars.iv317
  store double %34, double* %35, align 8
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv317, 1
  %exitcond2 = icmp eq i64 %indvars.iv.next4, 1200
  br i1 %exitcond2, label %36, label %._crit_edge12

; <label>:36:                                     ; preds = %._crit_edge12
...
.preheader:                                       ; preds = %.preheader.preheader, %44
  %indvars.iv116 = phi i64 [ %indvars.iv.next2, %44 ], [ 0, %.preheader.preheader ]
  br label %._crit_edge13

._crit_edge13:                                    ; preds = %._crit_edge13, %.preheader
  %indvars.iv15 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %._crit_edge13 ]
  %37 = add nuw nsw i64 %indvars.iv15, 2
  %38 = mul nuw nsw i64 %37, %indvars.iv116
  %39 = trunc i64 %38 to i32
  %40 = srem i32 %39, 1100
  %41 = sitofp i32 %40 to double
  %42 = fdiv double %41, 1.100000e+03
  %43 = getelementptr inbounds [1200 x double], [1200 x double]* %5, i64 %indvars.iv116, i64 %indvars.iv15
  store double %42, double* %43, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv15, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1200
  br i1 %exitcond, label %44, label %._crit_edge13

; <label>:44:                                     ; preds = %._crit_edge13
...
._crit_edge7:                                     ; preds = %24, %._crit_edge8
  %indvars.iv715 = phi i64 [ 0, %._crit_edge8 ], [ %indvars.iv.next8, %24 ]
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge7
  ...
  %indvars.iv514 = phi i64 [ 0, %._crit_edge7 ], [ %indvars.iv.next6.1, %._crit_edge ]
...
; <label>:25:                                     ; preds = %24
  ...
  br i1 %exitcond5, label %._crit_edge11.preheader, label %._crit_edge8

._crit_edge11.preheader:                          ; preds = %25
  br label %._crit_edge11

._crit_edge11:                                    ; preds = %._crit_edge11.preheader, %49
  %indvars.iv313 = phi i64 [ %indvars.iv.next4, %49 ], [ 0, %._crit_edge11.preheader ]
  br label %._crit_edge10

._crit_edge10:                                    ; preds = %48, %._crit_edge11
  %indvars.iv112 = phi i64 [ 0, %._crit_edge11 ], [ %indvars.iv.next2, %48 ]
...
._crit_edge9:                                     ; preds = %._crit_edge9, %._crit_edge10
  ...
  %indvars.iv11 = phi i64 [ 0, %._crit_edge10 ], [ %indvars.iv.next.2, %._crit_edge9 ]
...
._crit_edge._crit_edge:                           ; preds = %._crit_edge, %._crit_edge2
  %indvars.iv3 = phi i64 [ 0, %._crit_edge2 ], [ %indvars.iv.next, %._crit_edge ]
...
; <label>:17:                                     ; preds = %._crit_edge
  ...
  %exitcond1 = icmp eq i64 %indvars.iv.next2, 800
  br i1 %exitcond1, label %18, label %._crit_edge2
