...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  br i1 %39, label %middle.block.loopexit65, label %vector.body, !llvm.loop !13
...
._crit_edge19:                                    ; preds = %._crit_edge19, %.preheader3
  ...
  %64 = load double, double* %sunkaddr60, align 8
  ...
  store double %71, double* %sunkaddr60, align 8
  ...
  store double %78, double* %sunkaddr60, align 8
  %indvars.iv.next8.1 = add nuw nsw i64 %indvars.iv7, 2
  %exitcond9.1 = icmp eq i64 %indvars.iv.next8.1, 2000
  br i1 %exitcond9.1, label %79, label %._crit_edge19

; <label>:79:                                     ; preds = %._crit_edge19
...
._crit_edge21:                                    ; preds = %._crit_edge21, %.preheader
  ...
  %105 = load double, double* %sunkaddr64, align 8
  ...
  store double %112, double* %sunkaddr64, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %119, double* %sunkaddr64, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %120, label %._crit_edge21

; <label>:120:                                    ; preds = %._crit_edge21
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 2000
