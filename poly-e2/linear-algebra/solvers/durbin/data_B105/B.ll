...
vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert54 = insertelement <2 x double> undef, double %div, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load50 = load <2 x double>, <2 x double>* %29, align 8
  %30 = sub nsw i64 %sub9, %index
  %31 = getelementptr inbounds double, double* %y, i64 %30
  %32 = getelementptr double, double* %31, i64 -1
  %33 = bitcast double* %32 to <2 x double>*
  %wide.load51 = load <2 x double>, <2 x double>* %33, align 8
  %reverse = shufflevector <2 x double> %wide.load51, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %34 = getelementptr double, double* %31, i64 -2
  %35 = getelementptr double, double* %34, i64 -1
  %36 = bitcast double* %35 to <2 x double>*
  %wide.load52 = load <2 x double>, <2 x double>* %36, align 8
  %reverse53 = shufflevector <2 x double> %wide.load52, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %37 = fmul <2 x double> %broadcast.splat55, %reverse
  %38 = fmul <2 x double> %broadcast.splat55, %reverse53
  %39 = fadd <2 x double> %wide.load, %37
  %40 = fadd <2 x double> %wide.load50, %38
