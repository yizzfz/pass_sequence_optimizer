...
define i32 @main(i32, i8** nocapture readonly) local_unnamed_addr #0 {
  ...
  call fastcc void @kernel_gesummv(double %13, double %14, [1300 x double]* %10, [1300 x double]* %11, double* %15, double* %12, double* %16)
...
.lr.ph4.split.us:                                 ; preds = %._crit_edge.us, %.lr.ph4.split.us.preheader
  ...
  %9 = getelementptr inbounds double, double* %4, i64 %indvars.iv11
  store double %8, double* %9, align 8
  br label %._crit_edge1

._crit_edge1:                                     ; preds = %._crit_edge1, %.lr.ph4.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph4.split.us ], [ %indvars.iv.next, %._crit_edge1 ]
  %10 = mul nuw nsw i64 %indvars.iv, %indvars.iv11
  %11 = add nuw nsw i64 %10, 1
  %12 = trunc i64 %11 to i32
  %13 = srem i32 %12, 1300
  %14 = sitofp i32 %13 to double
  %15 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv11, i64 %indvars.iv
  ...
  %25 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv11, i64 %indvars.iv
...
._crit_edge.us:                                   ; preds = %._crit_edge1
  ...
  %exitcond16 = icmp eq i64 %indvars.iv.next12, 1300
  br i1 %exitcond16, label %.loopexit, label %.lr.ph4.split.us
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc void @kernel_gesummv(double, double, [1300 x double]* nocapture readonly, [1300 x double]* nocapture readonly, double*, double* nocapture readonly, double*) unnamed_addr #2 {
.lr.ph3.split.us.preheader:
  %7 = ptrtoint double* %4 to i64
  %sunkaddr27 = ptrtoint double* %6 to i64
...
.lr.ph3.split.us:                                 ; preds = %._crit_edge.us, %.lr.ph3.split.us.preheader
  ...
  %8 = getelementptr inbounds double, double* %4, i64 %indvars.iv11
  store double 0.000000e+00, double* %8, align 8
  %9 = getelementptr inbounds double, double* %6, i64 %indvars.iv11
  store double 0.000000e+00, double* %9, align 8
  %sunkaddr20 = shl i64 %indvars.iv11, 3
  %sunkaddr21 = add i64 %7, %sunkaddr20
  %sunkaddr22 = inttoptr i64 %sunkaddr21 to double*
  %sunkaddr29 = add i64 %sunkaddr27, %sunkaddr20
  %sunkaddr30 = inttoptr i64 %sunkaddr29 to double*
  br label %._crit_edge1

._crit_edge1:                                     ; preds = %._crit_edge1, %.lr.ph3.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph3.split.us ], [ %indvars.iv.next, %._crit_edge1 ]
  %10 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv11, i64 %indvars.iv
  ...
  %17 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv11, i64 %indvars.iv
  %18 = load double, double* %17, align 8
  %19 = load double, double* %12, align 8
  %20 = fmul double %18, %19
  %21 = load double, double* %sunkaddr30, align 8
  %22 = fadd double %20, %21
  store double %22, double* %sunkaddr30, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
  br i1 %exitcond, label %._crit_edge.us, label %._crit_edge1

._crit_edge.us:                                   ; preds = %._crit_edge1
  %23 = load double, double* %sunkaddr22, align 8
  %24 = fmul double %23, %0
  %25 = fmul double %22, %1
  %26 = fadd double %24, %25
  store double %26, double* %sunkaddr30, align 8
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond35 = icmp eq i64 %indvars.iv.next12, 1300
  br i1 %exitcond35, label %.loopexit, label %.lr.ph3.split.us
...
._crit_edge:                                      ; preds = %._crit_edge._crit_edge, %8
  ...
  %13 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %10, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i64 0, i64 0), double %12) #6
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
...
.loopexit:                                        ; preds = %._crit_edge
  ...
  %15 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %14, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #6
  %16 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %17 = call i64 @fwrite(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.7, i64 0, i64 0), i64 22, i64 1, %struct._IO_FILE* %16) #5
  ret void
}
