...
for.body.us:                                      ; preds = %for.body.us.preheader, %for.inc33.us
  ...
  br i1 %min.iters.check136, label %for.inc.us.preheader, label %min.iters.checked137

for.inc.us.preheader:                             ; preds = %middle.block133, %vector.memcheck153, %min.iters.checked137, %for.body.us
  %indvars.iv.ph = phi i64 [ 1, %vector.memcheck153 ], [ 1, %min.iters.checked137 ], [ 1, %for.body.us ], [ %ind.end119, %middle.block133 ]
  br label %for.inc.us

min.iters.checked137:                             ; preds = %for.body.us
  br i1 %cmp.zero101, label %for.inc.us.preheader, label %vector.memcheck153

vector.memcheck153:                               ; preds = %min.iters.checked137
  br i1 %found.conflict151, label %for.inc.us.preheader, label %vector.body132.preheader
...
vector.body132:                                   ; preds = %vector.body132.preheader, %vector.body132
  ...
  %4 = getelementptr inbounds double, double* %A, i64 %index155
  %5 = bitcast double* %4 to <2 x double>*
  %wide.load165 = load <2 x double>, <2 x double>* %5, align 8, !alias.scope !1
  %6 = getelementptr double, double* %4, i64 2
  %7 = bitcast double* %6 to <2 x double>*
  %wide.load166 = load <2 x double>, <2 x double>* %7, align 8, !alias.scope !1
  %8 = getelementptr inbounds double, double* %A, i64 %offset.idx160
  %9 = bitcast double* %8 to <2 x double>*
  %wide.load167 = load <2 x double>, <2 x double>* %9, align 8, !alias.scope !1
  %10 = getelementptr double, double* %8, i64 2
  %11 = bitcast double* %10 to <2 x double>*
  %wide.load168 = load <2 x double>, <2 x double>* %11, align 8, !alias.scope !1
  %12 = fadd <2 x double> %wide.load165, %wide.load167
  %13 = fadd <2 x double> %wide.load166, %wide.load168
  %14 = add nuw nsw i64 %offset.idx160, 1
  %15 = getelementptr inbounds double, double* %A, i64 %14
  %16 = getelementptr double, double* %15, i64 2
  %17 = bitcast double* %16 to <2 x double>*
  %wide.load170 = load <2 x double>, <2 x double>* %17, align 8, !alias.scope !1
  %18 = fadd <2 x double> %12, %wide.load166
  %19 = fadd <2 x double> %13, %wide.load170
  ...
  %22 = getelementptr inbounds double, double* %B, i64 %offset.idx160
  ...
  %26 = icmp eq i64 %index.next156, %n.vec100
  br i1 %26, label %middle.block133, label %vector.body132, !llvm.loop !6

middle.block133:                                  ; preds = %vector.body132
  br i1 %cmp.n120, label %for.inc30.us.preheader, label %for.inc.us.preheader
...
for.inc30.us:                                     ; preds = %for.inc30.us.preheader171, %for.inc30.us
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.inc30.us ], [ %indvars.iv65.ph, %for.inc30.us.preheader171 ]
...
for.inc30.us.preheader:                           ; preds = %for.inc30.us.preheader.loopexit, %middle.block133
  br i1 %min.iters.check136, label %for.inc30.us.preheader171, label %min.iters.checked98

for.inc30.us.preheader171:                        ; preds = %middle.block94, %vector.memcheck114, %min.iters.checked98, %for.inc30.us.preheader
...
min.iters.checked98:                              ; preds = %for.inc30.us.preheader
  br i1 %cmp.zero101, label %for.inc30.us.preheader171, label %vector.memcheck114

vector.memcheck114:                               ; preds = %min.iters.checked98
  br i1 %found.conflict112, label %for.inc30.us.preheader171, label %vector.body93.preheader
...
vector.body93:                                    ; preds = %vector.body93.preheader, %vector.body93
  ...
  %35 = getelementptr inbounds double, double* %B, i64 %index116
  %36 = bitcast double* %35 to <2 x double>*
  %wide.load126 = load <2 x double>, <2 x double>* %36, align 8, !alias.scope !11
  %37 = getelementptr double, double* %35, i64 2
  %38 = bitcast double* %37 to <2 x double>*
  %wide.load127 = load <2 x double>, <2 x double>* %38, align 8, !alias.scope !11
  %39 = getelementptr inbounds double, double* %B, i64 %offset.idx121
  %40 = bitcast double* %39 to <2 x double>*
  %wide.load128 = load <2 x double>, <2 x double>* %40, align 8, !alias.scope !11
  %41 = getelementptr double, double* %39, i64 2
  %42 = bitcast double* %41 to <2 x double>*
  %wide.load129 = load <2 x double>, <2 x double>* %42, align 8, !alias.scope !11
  %43 = fadd <2 x double> %wide.load126, %wide.load128
  %44 = fadd <2 x double> %wide.load127, %wide.load129
  %45 = add nuw nsw i64 %offset.idx121, 1
  %46 = getelementptr inbounds double, double* %B, i64 %45
  %47 = getelementptr double, double* %46, i64 2
  %48 = bitcast double* %47 to <2 x double>*
  %wide.load131 = load <2 x double>, <2 x double>* %48, align 8, !alias.scope !11
  %49 = fadd <2 x double> %43, %wide.load127
  %50 = fadd <2 x double> %44, %wide.load131
  ...
  %53 = getelementptr inbounds double, double* %A, i64 %offset.idx121
  ...
  %57 = icmp eq i64 %index.next117, %n.vec100
  br i1 %57, label %middle.block94, label %vector.body93, !llvm.loop !16

middle.block94:                                   ; preds = %vector.body93
  br i1 %cmp.n120, label %for.inc33.us, label %for.inc30.us.preheader171
