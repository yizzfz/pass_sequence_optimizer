...
._crit_edge70:                                    ; preds = %._crit_edge.._crit_edge70_crit_edge, %._crit_edge.thread, %._crit_edge51
  %54 = call i8* @polybench_alloc_data(i64 4000000, i32 8) #5
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %110 = fadd <2 x double> %wide.load, %104
  %111 = fadd <2 x double> %wide.load156, %105
...
.lr.ph47.split.prol:                              ; preds = %.lr.ph47.split.prol, %.lr.ph47.split.prol.preheader
  ...
  br i1 %prol.iter160.cmp, label %.lr.ph47.split.prol.loopexit.unr-lcssa, label %.lr.ph47.split.prol, !llvm.loop !23
...
.lr.ph12.prol:                                    ; preds = %.lr.ph12.prol, %.lr.ph12.prol.preheader
  ...
  br i1 %prol.iter153.cmp, label %.lr.ph12.prol.loopexit.unr-lcssa, label %.lr.ph12.prol, !llvm.loop !24
