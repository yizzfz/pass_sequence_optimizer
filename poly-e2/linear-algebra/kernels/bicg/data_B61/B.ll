...
for.body5.us:                                     ; preds = %for.body5.us.preheader, %for.cond12.for.end26_crit_edge.us
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.cond12.for.end26_crit_edge.us ], [ 0, %for.body5.us.preheader ]
...
for.body15.us:                                    ; preds = %for.body15.us, %for.body5.us
  ...
  br i1 %exitcond.1, label %for.cond12.for.end26_crit_edge.us, label %for.body15.us

for.cond12.for.end26_crit_edge.us:                ; preds = %for.body15.us
  %indvars.iv.next3 = add nuw nsw i64 %indvars.iv2, 1
  %exitcond4 = icmp eq i64 %indvars.iv.next3, 2100
  br i1 %exitcond4, label %for.end29, label %for.body5.us

for.body:                                         ; preds = %for.body, %for.body.lr.ph
  %indvars.iv5 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next6.1.1, %for.body ]
  ...
  %10 = trunc i64 %indvars.iv.next6.1 to i32
  %conv.18 = sitofp i32 %10 to double
  %arrayidx.1 = getelementptr inbounds double, double* %p, i64 %indvars.iv.next6.1
  %11 = trunc i64 %indvars.iv.next6.1 to i32
  %12 = or i32 %11, 1
  ...
  br i1 %exitcond7.1.1, label %for.body5.us.preheader, label %for.body
...
for.body3.us:                                     ; preds = %for.cond6.for.end33_crit_edge.us, %for.body3.us.preheader
  %indvars.iv1 = phi i64 [ 0, %for.body3.us.preheader ], [ %indvars.iv.next2, %for.cond6.for.end33_crit_edge.us ]
...
for.body8.us:                                     ; preds = %for.body8.us, %for.body3.us
  ...
  br i1 %exitcond, label %for.cond6.for.end33_crit_edge.us, label %for.body8.us
...
for.body:                                         ; preds = %if.end, %for.body.preheader
  %indvars.iv1 = phi i64 [ 0, %for.body.preheader ], [ %indvars.iv.next2, %if.end ]
