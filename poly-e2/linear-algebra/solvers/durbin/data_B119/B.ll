...
entry:
  ...
  %4 = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 0
  br label %for.inc.lr.ph

for.inc.lr.ph:                                    ; preds = %for.inc47, %entry
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc47 ], [ 1, %entry ]
  %5 = phi double [ %div, %for.inc47 ], [ %sub, %entry ]
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc47 ], [ 1, %entry ]
  %indvars.iv19 = phi i64 [ %9, %for.inc47 ], [ 0, %entry ]
  %6 = phi double [ %div, %for.inc47 ], [ %sub3, %entry ]
  %beta.032 = phi double [ %mul5, %for.inc47 ], [ 1.000000e+00, %entry ]
  %7 = add i64 %indvars.iv19, -1
  %8 = and i64 %indvars.iv30, 3
  %9 = add nuw nsw i64 %indvars.iv19, 1
  %10 = shl i64 %indvars.iv19, 3
  %11 = add nuw nsw i64 %10, 8
  %mul = fmul double %6, %6
  %sub4 = fsub double 1.000000e+00, %mul
  %mul5 = fmul double %beta.032, %sub4
...
for.inc.prol.loopexit:                            ; preds = %for.inc.prol.loopexit.loopexit, %for.inc.lr.ph
  %indvars.iv.unr = phi i64 [ 0, %for.inc.lr.ph ], [ %8, %for.inc.prol.loopexit.loopexit ]
  ...
  %16 = icmp ult i64 %indvars.iv19, 3
...
for.inc:                                          ; preds = %for.inc.preheader, %for.inc
  ...
  %add = fadd double %sum.026, %mul14.v.r1
  ...
  %exitcond.3 = icmp eq i64 %indvars.iv.next.2, %indvars.iv19
...
for.inc32.lr.ph:                                  ; preds = %for.inc32.lr.ph.loopexit, %for.inc.prol.loopexit
  ...
  %xtraiter25 = and i64 %9, 1
  %lcmp.mod26 = icmp eq i64 %xtraiter25, 0
  br i1 %lcmp.mod26, label %for.inc32.prol.loopexit, label %for.inc32.prol

for.inc32.prol:                                   ; preds = %for.inc32.lr.ph
  %28 = load double, double* %y, align 8
  %mul28.prol = fmul double %div, %5
  %add29.prol = fadd double %28, %mul28.prol
  store double %add29.prol, double* %4, align 16
  br label %for.inc32.prol.loopexit

for.inc32.prol.loopexit:                          ; preds = %for.inc32.lr.ph, %for.inc32.prol
  %indvars.iv4.unr.ph = phi i64 [ 1, %for.inc32.prol ], [ 0, %for.inc32.lr.ph ]
  %29 = icmp eq i64 %indvars.iv19, 0
  br i1 %29, label %for.inc47, label %for.inc32.preheader

for.inc32.preheader:                              ; preds = %for.inc32.prol.loopexit
  %30 = sub i64 %7, %indvars.iv4.unr.ph
  %31 = lshr i64 %30, 1
  %32 = and i64 %31, 1
  %lcmp.mod35 = icmp eq i64 %32, 0
  br i1 %lcmp.mod35, label %for.inc32.prol.preheader, label %for.inc32.prol.loopexit33.unr-lcssa

for.inc32.prol.preheader:                         ; preds = %for.inc32.preheader
  br label %for.inc32.prol36

for.inc32.prol36:                                 ; preds = %for.inc32.prol.preheader
  %arrayidx23.prol = getelementptr inbounds double, double* %y, i64 %indvars.iv4.unr.ph
  %33 = bitcast double* %arrayidx23.prol to <2 x double>*
  %arrayidx31.prol = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %indvars.iv4.unr.ph
  %indvars.iv.next5.prol = add nuw nsw i64 %indvars.iv4.unr.ph, 1
  %34 = load <2 x double>, <2 x double>* %33, align 8
  %35 = sub nsw i64 %12, %indvars.iv.next5.prol
  %arrayidx27.1.prol = getelementptr inbounds double, double* %y, i64 %35
  %36 = bitcast double* %arrayidx27.1.prol to <2 x double>*
  %37 = load <2 x double>, <2 x double>* %36, align 8
  %38 = insertelement <2 x double> undef, double %div, i32 0
  %mul28.v.i0.2.prol = shufflevector <2 x double> %38, <2 x double> undef, <2 x i32> zeroinitializer
  %mul28.1.prol = fmul <2 x double> %mul28.v.i0.2.prol, %37
  %add29.v.i1.prol = shufflevector <2 x double> %mul28.1.prol, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %add29.prol37 = fadd <2 x double> %34, %add29.v.i1.prol
  %39 = bitcast double* %arrayidx31.prol to <2 x double>*
  store <2 x double> %add29.prol37, <2 x double>* %39, align 8
  %indvars.iv.next5.1.prol = or i64 %indvars.iv4.unr.ph, 2
  br label %for.inc32.prol.loopexit33.unr-lcssa

for.inc32.prol.loopexit33.unr-lcssa:              ; preds = %for.inc32.preheader, %for.inc32.prol36
  %indvars.iv4.unr.ph38 = phi i64 [ %indvars.iv.next5.1.prol, %for.inc32.prol36 ], [ %indvars.iv4.unr.ph, %for.inc32.preheader ]
  br label %for.inc32.prol.loopexit33

for.inc32.prol.loopexit33:                        ; preds = %for.inc32.prol.loopexit33.unr-lcssa
  %40 = icmp eq i64 %31, 0
  br i1 %40, label %for.inc47.loopexit, label %for.inc32.preheader.new

for.inc32.preheader.new:                          ; preds = %for.inc32.prol.loopexit33
  %41 = insertelement <2 x double> undef, double %div, i32 0
  %mul28.v.i0.2 = shufflevector <2 x double> %41, <2 x double> undef, <2 x i32> zeroinitializer
  %42 = insertelement <2 x double> undef, double %div, i32 0
  %mul28.v.i0.2.1 = shufflevector <2 x double> %42, <2 x double> undef, <2 x i32> zeroinitializer
  br label %for.inc32

for.inc32:                                        ; preds = %for.inc32, %for.inc32.preheader.new
  %indvars.iv4 = phi i64 [ %indvars.iv4.unr.ph38, %for.inc32.preheader.new ], [ %indvars.iv.next5.1.1, %for.inc32 ]
  %arrayidx23 = getelementptr inbounds double, double* %y, i64 %indvars.iv4
  %43 = bitcast double* %arrayidx23 to <2 x double>*
  ...
  %45 = sub nsw i64 %12, %indvars.iv.next5
  %arrayidx27.1 = getelementptr inbounds double, double* %y, i64 %45
  %46 = bitcast double* %arrayidx27.1 to <2 x double>*
  %47 = load <2 x double>, <2 x double>* %46, align 8
  %mul28.1 = fmul <2 x double> %mul28.v.i0.2, %47
  %add29.v.i1 = shufflevector <2 x double> %mul28.1, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %add29 = fadd <2 x double> %44, %add29.v.i1
  %48 = bitcast double* %arrayidx31 to <2 x double>*
  store <2 x double> %add29, <2 x double>* %48, align 8
  %indvars.iv.next5.1 = add nsw i64 %indvars.iv4, 2
  %arrayidx23.1 = getelementptr inbounds double, double* %y, i64 %indvars.iv.next5.1
  %49 = bitcast double* %arrayidx23.1 to <2 x double>*
  %arrayidx31.1 = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %indvars.iv.next5.1
  %indvars.iv.next5.139 = add nsw i64 %indvars.iv4, 3
  %50 = load <2 x double>, <2 x double>* %49, align 8
  %51 = sub nsw i64 %12, %indvars.iv.next5.139
  %arrayidx27.1.1 = getelementptr inbounds double, double* %y, i64 %51
  %52 = bitcast double* %arrayidx27.1.1 to <2 x double>*
  %53 = load <2 x double>, <2 x double>* %52, align 8
  %mul28.1.1 = fmul <2 x double> %mul28.v.i0.2.1, %53
  %add29.v.i1.1 = shufflevector <2 x double> %mul28.1.1, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %add29.1 = fadd <2 x double> %50, %add29.v.i1.1
  %54 = bitcast double* %arrayidx31.1 to <2 x double>*
  store <2 x double> %add29.1, <2 x double>* %54, align 8
  %indvars.iv.next5.1.1 = add nsw i64 %indvars.iv4, 4
  %exitcond10.1.1 = icmp eq i64 %indvars.iv.next5.139, %indvars.iv19
  br i1 %exitcond10.1.1, label %for.inc47.loopexit.unr-lcssa, label %for.inc32

for.inc47.loopexit.unr-lcssa:                     ; preds = %for.inc32
  br label %for.inc47.loopexit

for.inc47.loopexit:                               ; preds = %for.inc32.prol.loopexit33, %for.inc47.loopexit.unr-lcssa
  br label %for.inc47

for.inc47:                                        ; preds = %for.inc47.loopexit, %for.inc32.prol.loopexit
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* nonnull %3, i64 %11, i32 8, i1 false)
  %arrayidx46 = getelementptr inbounds double, double* %y, i64 %indvars.iv21
  store double %div, double* %arrayidx46, align 8
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  %indvars.iv.next31 = add nuw nsw i64 %8, 1
  %exitcond = icmp eq i64 %9, 1999
