...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.end_crit_edge.us, %entry
  %indvars.iv4 = phi i64 [ 0, %entry ], [ %indvars.iv.next5, %for.cond1.for.end_crit_edge.us ]
  %0 = add i64 %indvars.iv4, 1000
...
for.body3.us:                                     ; preds = %for.body3.us, %for.cond1.preheader.us
  ...
  %arrayidx6.us = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv4, i64 %indvars.iv
  ...
  %arrayidx6.us.1 = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv4, i64 %indvars.iv.next
...
for.cond1.for.end_crit_edge.us:                   ; preds = %for.body3.us
  ...
  %cmp.us = icmp slt i64 %indvars.iv.next5, 1000
...
for.body34.us.lver.check:                         ; preds = %for.cond15.preheader, %for.end119.us
  %indvar = phi i64 [ 0, %for.cond15.preheader ], [ %indvar.next, %for.end119.us ]
  %indvars.iv19 = phi i64 [ 1, %for.cond15.preheader ], [ %indvars.iv.next20, %for.end119.us ]
  %1 = add i64 %indvar, 1
  %2 = add i64 %indvar, 1
...
for.body34.us.lver.orig:                          ; preds = %for.body34.us.lver.orig.preheader, %for.body34.us.lver.orig
  %indvars.iv13.lver.orig = phi i64 [ %indvars.iv.next14.lver.orig, %for.body34.us.lver.orig ], [ 1, %for.body34.us.lver.orig.preheader ]
  %7 = add nsw i64 %indvars.iv13.lver.orig, -1
  %arrayidx40.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv19, i64 %7
  %8 = load double, double* %arrayidx40.us.lver.orig, align 8
  %arrayidx47.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv19, i64 %indvars.iv13.lver.orig
  %arrayidx53.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv13.lver.orig, i64 %6
  %arrayidx67.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv13.lver.orig, i64 %indvars.iv.next20
  %arrayidx74.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv19, i64 %7
  ...
  %arrayidx88.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv19, i64 %indvars.iv13.lver.orig
  store double %div84.us.lver.orig, double* %arrayidx88.us.lver.orig, align 8
  %exitcond.lver.orig = icmp eq i64 %indvars.iv13.lver.orig, 998
...
for.body34.us.ph:                                 ; preds = %for.body34.us.lver.check
  %scevgep9 = getelementptr [1000 x double], [1000 x double]* %q, i64 %1, i64 0
...
for.body98.us:                                    ; preds = %for.body98.us, %for.cond30.for.end_crit_edge.us
  %indvars.iv16 = phi i64 [ 998, %for.cond30.for.end_crit_edge.us ], [ %indvars.iv.next17.1, %for.body98.us ]
  ...
  %14 = or i64 %indvars.iv16, 1
  %arrayidx107.us = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %14, i64 %indvars.iv19
...
for.body34.us:                                    ; preds = %for.body34.us, %for.body34.us.ph
  %store_forwarded11 = phi double [ %load_initial10, %for.body34.us.ph ], [ %div84.us, %for.body34.us ]
  %store_forwarded = phi double [ %load_initial, %for.body34.us.ph ], [ %div43.us, %for.body34.us ]
  %indvars.iv13 = phi i64 [ 1, %for.body34.us.ph ], [ %indvars.iv.next14, %for.body34.us ]
  %arrayidx47.us = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv19, i64 %indvars.iv13
  %arrayidx53.us = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv13, i64 %6
  %arrayidx67.us = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv13, i64 %indvars.iv.next20
  ...
  %19 = bitcast double* %arrayidx53.us to <2 x double>*
  %20 = load <2 x double>, <2 x double>* %19, align 8
  %mul61.us = fmul <2 x double> %20, <double 0xC08F400000000001, double 0xC09F3C0000000001>
  ...
  %21 = load double, double* %arrayidx67.us, align 8
  %mul68.us = fmul double %21, 0xC08F400000000001
  ...
  %arrayidx88.us = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv19, i64 %indvars.iv13
  store double %div84.us, double* %arrayidx88.us, align 8
  %exitcond = icmp eq i64 %indvars.iv13, 998
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  br i1 %exitcond, label %for.cond30.for.end_crit_edge.us.loopexit33, label %for.body34.us

for.cond30.for.end_crit_edge.us.loopexit:         ; preds = %for.body34.us.lver.orig
  br label %for.cond30.for.end_crit_edge.us

for.cond30.for.end_crit_edge.us.loopexit33:       ; preds = %for.body34.us
  br label %for.cond30.for.end_crit_edge.us
...
for.body144.us.lver.check:                        ; preds = %for.body144.us.lver.check.preheader, %for.end233.us
  %indvar12 = phi i64 [ %indvar.next13, %for.end233.us ], [ 0, %for.body144.us.lver.check.preheader ]
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.end233.us ], [ 1, %for.body144.us.lver.check.preheader ]
  ...
  %arrayidx135.us = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv30
  %24 = bitcast [1000 x double]* %arrayidx135.us to i64*
  ...
  br i1 %memcheck.conflict25, label %for.body144.us.lver.orig.preheader, label %for.body144.us.ph
...
for.body144.us.lver.orig:                         ; preds = %for.body144.us.lver.orig.preheader, %for.body144.us.lver.orig
  %indvars.iv22.lver.orig = phi i64 [ %indvars.iv.next23.lver.orig, %for.body144.us.lver.orig ], [ 1, %for.body144.us.lver.orig.preheader ]
  ...
  %mul151.v.i1.1.us.lver.orig = insertelement <2 x double> undef, double %29, i32 0
  %mul151.v.i1.2.us.lver.orig = insertelement <2 x double> %mul151.v.i1.1.us.lver.orig, double 2.000000e+00, i32 1
  %mul151.us.lver.orig = fmul <2 x double> %mul151.v.i1.2.us.lver.orig, <double 0xC08F400000000001, double 0xC09F400000000001>
  %add152.us.lver.orig = fadd <2 x double> %mul151.us.lver.orig, <double 0x409F440000000001, double 1.000000e+00>
  ...
  %mul171.us.lver.orig = fmul double %32, %add152.v.r2.us.lver.orig
  ...
  %div194.us.lver.orig = fdiv double %sub186.us.lver.orig, %add152.v.r1.us.lver.orig
  ...
  %exitcond26.lver.orig = icmp eq i64 %indvars.iv22.lver.orig, 998
  %indvars.iv.next23.lver.orig = add nuw nsw i64 %indvars.iv22.lver.orig, 1
  br i1 %exitcond26.lver.orig, label %for.cond140.for.end201_crit_edge.us.loopexit, label %for.body144.us.lver.orig
...
for.end233.us:                                    ; preds = %for.body211.us
  ...
  br i1 %cmp125.us, label %for.body144.us.lver.check, label %for.end236

for.body211.us:                                   ; preds = %for.body211.us, %for.cond140.for.end201_crit_edge.us
  %indvars.iv27 = phi i64 [ 998, %for.cond140.for.end201_crit_edge.us ], [ %indvars.iv.next28.1, %for.body211.us ]
  ...
  %36 = or i64 %indvars.iv27, 1
  %arrayidx220.us = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv30, i64 %36
  %37 = load double, double* %arrayidx220.us, align 8
  %mul221.us = fmul double %35, %37
...
for.body144.us:                                   ; preds = %for.body144.us, %for.body144.us.ph
  %store_forwarded31 = phi double [ %load_initial30, %for.body144.us.ph ], [ %div194.us, %for.body144.us ]
  %store_forwarded28 = phi double [ %load_initial27, %for.body144.us.ph ], [ %div153.us, %for.body144.us ]
  %indvars.iv22 = phi i64 [ 1, %for.body144.us.ph ], [ %indvars.iv.next23, %for.body144.us ]
  ...
  %mul151.v.i1.1.us = insertelement <2 x double> undef, double %store_forwarded28, i32 0
  %mul151.v.i1.2.us = insertelement <2 x double> %mul151.v.i1.1.us, double 2.000000e+00, i32 1
  %mul151.us = fmul <2 x double> %mul151.v.i1.2.us, <double 0xC08F400000000001, double 0xC09F400000000001>
  %add152.us = fadd <2 x double> %mul151.us, <double 0x409F440000000001, double 1.000000e+00>
  ...
  %mul171.us = fmul double %43, %add152.v.r2.us
  ...
  %div194.us = fdiv double %sub186.us, %add152.v.r1.us
  ...
  %exitcond26 = icmp eq i64 %indvars.iv22, 998
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  br i1 %exitcond26, label %for.cond140.for.end201_crit_edge.us.loopexit32, label %for.body144.us

for.cond140.for.end201_crit_edge.us.loopexit:     ; preds = %for.body144.us.lver.orig
  br label %for.cond140.for.end201_crit_edge.us

for.cond140.for.end201_crit_edge.us.loopexit32:   ; preds = %for.body144.us
  br label %for.cond140.for.end201_crit_edge.us
...
for.cond2.preheader.us:                           ; preds = %for.cond2.for.end_crit_edge.us, %entry
  %indvars.iv4 = phi i64 [ 0, %entry ], [ %indvars.iv.next5, %for.cond2.for.end_crit_edge.us ]
  %3 = mul nsw i64 %indvars.iv4, 1000
...
if.end.us:                                        ; preds = %for.body4.us, %if.then.us
  ...
  %arrayidx8.us = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv4, i64 %indvars.iv
