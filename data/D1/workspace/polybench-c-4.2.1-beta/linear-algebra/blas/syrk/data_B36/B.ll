...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %59 = shl i64 %index, 2
  %offset.idx = add i64 %indvars.iv.unr, %59
  %60 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %offset.idx
  ...
  %62 = fmul <2 x double> %strided.vec, %broadcast.splat73
  %63 = fmul <2 x double> %strided.vec69, %broadcast.splat73
  %64 = fmul <2 x double> %strided.vec70, %broadcast.splat73
  %65 = add nsw i64 %offset.idx, 3
  %66 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %65
  %67 = fmul <2 x double> %strided.vec71, %broadcast.splat73
