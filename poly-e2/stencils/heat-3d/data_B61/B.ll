...
for.inc.us:                                       ; preds = %for.inc.us, %for.cond8.preheader.us
  ...
  %mul.v.i1.2.us = shufflevector <2 x double> %16, <2 x double> undef, <2 x i32> zeroinitializer
  %mul.us = fmul <2 x double> %mul.v.i1.2.us, <double 2.000000e+00, double 2.000000e+00>
  %sub22.v.i0.1.us = insertelement <2 x double> undef, double %12, i32 0
  %sub22.v.i0.2.us = insertelement <2 x double> %sub22.v.i0.1.us, double %15, i32 1
  ...
  %add30.v.i1.1.us = insertelement <2 x double> undef, double %14, i32 0
  %add30.v.i1.2.us = insertelement <2 x double> %add30.v.i1.1.us, double %17, i32 1
...
for.inc200.us:                                    ; preds = %for.inc200.us, %for.cond109.preheader.us
  ...
  %mul126.v.i1.2.us = shufflevector <2 x double> %26, <2 x double> undef, <2 x i32> zeroinitializer
  %mul126.us = fmul <2 x double> %mul126.v.i1.2.us, <double 2.000000e+00, double 2.000000e+00>
  %sub127.v.i0.1.us = insertelement <2 x double> undef, double %22, i32 0
  %sub127.v.i0.2.us = insertelement <2 x double> %sub127.v.i0.1.us, double %25, i32 1
  ...
  %add135.v.i1.1.us = insertelement <2 x double> undef, double %24, i32 0
  %add135.v.i1.2.us = insertelement <2 x double> %add135.v.i1.1.us, double %27, i32 1
