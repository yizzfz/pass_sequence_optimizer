...
define internal fastcc void @kernel_durbin(i32, double* nocapture readonly, double* nocapture) unnamed_addr #2 {
  ...
  %9 = icmp sgt i32 %0, 1
  br i1 %9, label %.lr.ph56.preheader, label %._crit_edge57
...
.lr.ph:                                           ; preds = %._crit_edge51, %.lr.ph56.preheader
  ...
  %.04352 = phi double [ %11, %.lr.ph56.preheader ], [ %61, %._crit_edge51 ]
  %13 = add i64 %indvar, 1
  %14 = shl i64 %indvar, 3
...
._crit_edge76.prol:                               ; preds = %._crit_edge76.prol, %._crit_edge76.prol.preheader
  ...
  %.04144.prol = phi double [ 0.000000e+00, %._crit_edge76.prol.preheader ], [ %24, %._crit_edge76.prol ]
...
._crit_edge76.prol.loopexit:                      ; preds = %.lr.ph, %._crit_edge76.prol.loopexit.unr-lcssa
  %.lcssa.unr = phi double [ undef, %.lr.ph ], [ %24, %._crit_edge76.prol.loopexit.unr-lcssa ]
  %indvars.iv.unr = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next.prol, %._crit_edge76.prol.loopexit.unr-lcssa ]
  %.04144.unr = phi double [ 0.000000e+00, %.lr.ph ], [ %24, %._crit_edge76.prol.loopexit.unr-lcssa ]
  %25 = icmp ult i64 %indvar, 3
  br i1 %25, label %.lr.ph48, label %.lr.ph.new
...
._crit_edge76:                                    ; preds = %._crit_edge76, %.lr.ph.new
  ...
  %.04144 = phi double [ %.04144.unr, %.lr.ph.new ], [ %53, %._crit_edge76 ]
...
.lr.ph48:                                         ; preds = %._crit_edge76.prol.loopexit, %.lr.ph48.unr-lcssa
  %.lcssa = phi double [ %.lcssa.unr, %._crit_edge76.prol.loopexit ], [ %53, %.lr.ph48.unr-lcssa ]
  %54 = add nuw nsw i64 %indvar, 1
  %55 = add nuw nsw i64 %14, 8
  %56 = fmul double %.04253, %16
...
._crit_edge77:                                    ; preds = %._crit_edge77.preheader, %._crit_edge77
  ...
  %84 = sub nsw i64 %17, %indvars.iv60
  %85 = getelementptr inbounds double, double* %2, i64 %84
  %86 = load double, double* %85, align 8
  %87 = fmul double %61, %86
  %88 = fadd double %83, %87
  %89 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 0, i64 %indvars.iv60
