...
entry:
  ...
  tail call fastcc void @kernel_heat_3d(i32 500, i32 120, [120 x [120 x double]]* %arraydecay33, [120 x [120 x double]]* %arraydecay44)
...
if.then:                                          ; preds = %land.lhs.true
  ...
  tail call fastcc void @print_array(i32 120, [120 x [120 x double]]* %arraydecay66)
  br label %if.end
...
for.cond4.preheader:                              ; preds = %for.inc98.for.cond4.preheader_crit_edge, %for.cond1.preheader
  %indvar162 = phi i64 [ 0, %for.cond1.preheader ], [ %indvar.next163, %for.inc98.for.cond4.preheader_crit_edge ]
  %indvars.iv121 = phi i64 [ 1, %for.cond1.preheader ], [ %indvars.iv.next122, %for.inc98.for.cond4.preheader_crit_edge ]
  %0 = add nuw nsw i64 %indvar162, 1
  %1 = add nuw nsw i64 %indvar162, 2
...
for.cond8.preheader.us:                           ; preds = %for.inc95.us.for.cond8.preheader.us_crit_edge, %for.cond4.preheader
  %indvar164 = phi i64 [ 0, %for.cond4.preheader ], [ %indvar.next165, %for.inc95.us.for.cond8.preheader.us_crit_edge ]
  %indvars.iv117 = phi i64 [ 1, %for.cond4.preheader ], [ %indvars.iv.next118, %for.inc95.us.for.cond8.preheader.us_crit_edge ]
  %2 = add nuw nsw i64 %indvar164, 1
  %scevgep166 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %0, i64 %2, i64 1
  %scevgep168 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %0, i64 %2, i64 119
  %scevgep170 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvar162, i64 %2, i64 1
  %scevgep172 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %1, i64 %2, i64 119
  ...
  br i1 %memcheck.conflict177, label %for.cond8.preheader.us.for.inc.us_crit_edge, label %for.cond8.preheader.us.vector.body157_crit_edge

for.cond8.preheader.us.vector.body157_crit_edge:  ; preds = %for.cond8.preheader.us
  br label %vector.body157

for.cond8.preheader.us.for.inc.us_crit_edge:      ; preds = %for.cond8.preheader.us
  br label %for.inc.us

vector.body157:                                   ; preds = %vector.body157, %for.cond8.preheader.us.vector.body157_crit_edge
  %index180 = phi i64 [ 0, %for.cond8.preheader.us.vector.body157_crit_edge ], [ %index.next181, %vector.body157 ]
  %offset.idx184 = or i64 %index180, 1
  %3 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %add, i64 %indvars.iv117, i64 %offset.idx184
  %4 = bitcast double* %3 to <2 x double>*
  %wide.load188 = load <2 x double>, <2 x double>* %4, align 8, !alias.scope !1
  %5 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv121, i64 %indvars.iv117, i64 %offset.idx184
  %6 = bitcast double* %5 to <2 x double>*
  %wide.load189 = load <2 x double>, <2 x double>* %6, align 8, !alias.scope !1
  %7 = fmul <2 x double> %wide.load189, <double 2.000000e+00, double 2.000000e+00>
  %8 = fsub <2 x double> %wide.load188, %7
  %9 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %sub23, i64 %indvars.iv117, i64 %offset.idx184
  %10 = bitcast double* %9 to <2 x double>*
  %wide.load190 = load <2 x double>, <2 x double>* %10, align 8, !alias.scope !1
  %11 = fadd <2 x double> %wide.load190, %8
  %12 = fmul <2 x double> %11, <double 1.250000e-01, double 1.250000e-01>
  %13 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv121, i64 %add34.us, i64 %offset.idx184
  %14 = bitcast double* %13 to <2 x double>*
  %wide.load191 = load <2 x double>, <2 x double>* %14, align 8, !alias.scope !1
  %15 = bitcast double* %5 to <2 x double>*
  %wide.load192 = load <2 x double>, <2 x double>* %15, align 8, !alias.scope !1
  %16 = fmul <2 x double> %wide.load192, <double 2.000000e+00, double 2.000000e+00>
  %17 = fsub <2 x double> %wide.load191, %16
  %18 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv121, i64 %sub49.us, i64 %offset.idx184
  ...
  %23 = add nuw nsw i64 %offset.idx184, 1
  %24 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv121, i64 %indvars.iv117, i64 %23
  ...
  %27 = fmul <2 x double> %wide.load195, <double 2.000000e+00, double 2.000000e+00>
  %28 = fsub <2 x double> %wide.load194, %27
  %29 = add nsw i64 %offset.idx184, -1
  %30 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv121, i64 %indvars.iv117, i64 %29
  %31 = bitcast double* %30 to <2 x double>*
  %wide.load196 = load <2 x double>, <2 x double>* %31, align 8, !alias.scope !1
  %32 = fadd <2 x double> %wide.load196, %28
  %33 = fmul <2 x double> %32, <double 1.250000e-01, double 1.250000e-01>
  %34 = fadd <2 x double> %22, %33
  %35 = bitcast double* %5 to <2 x double>*
  %wide.load197 = load <2 x double>, <2 x double>* %35, align 8, !alias.scope !1
  %36 = fadd <2 x double> %wide.load197, %34
  %37 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv121, i64 %indvars.iv117, i64 %offset.idx184
  %38 = bitcast double* %37 to <2 x double>*
  store <2 x double> %36, <2 x double>* %38, align 8, !alias.scope !4, !noalias !1
  %index.next181 = add nuw nsw i64 %index180, 2
  %39 = icmp eq i64 %index.next181, 118
  br i1 %39, label %for.inc95.us.loopexit199, label %vector.body157, !llvm.loop !6

for.inc.us:                                       ; preds = %for.inc.us, %for.cond8.preheader.us.for.inc.us_crit_edge
  %indvars.iv = phi i64 [ 1, %for.cond8.preheader.us.for.inc.us_crit_edge ], [ %indvars.iv.next, %for.inc.us ]
  ...
  %arrayidx44.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv121, i64 %indvars.iv117, i64 %indvars.iv
  ...
  %arrayidx69.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv121, i64 %indvars.iv117, i64 %indvars.iv
  ...
  %arrayidx87.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv121, i64 %indvars.iv117, i64 %indvars.iv
...
for.inc95.us.loopexit199:                         ; preds = %vector.body157
  br label %for.inc95.us

for.inc95.us:                                     ; preds = %for.inc95.us.loopexit199, %for.inc95.us.loopexit
  %indvars.iv.next118 = add nuw nsw i64 %indvars.iv117, 1
  %exitcond120 = icmp eq i64 %indvars.iv.next118, 119
  br i1 %exitcond120, label %for.inc98, label %for.inc95.us.for.cond8.preheader.us_crit_edge
...
for.inc98:                                        ; preds = %for.inc95.us
  ...
  %exitcond124 = icmp eq i64 %indvars.iv.next122, 119
  br i1 %exitcond124, label %for.inc98.for.cond105.preheader_crit_edge, label %for.inc98.for.cond4.preheader_crit_edge
...
for.cond105.preheader:                            ; preds = %for.inc206.for.cond105.preheader_crit_edge, %for.inc98.for.cond105.preheader_crit_edge
  ...
  %indvars.iv134 = phi i64 [ %indvars.iv.next135, %for.inc206.for.cond105.preheader_crit_edge ], [ 1, %for.inc98.for.cond105.preheader_crit_edge ]
...
for.cond109.preheader.us:                         ; preds = %for.inc203.us.for.cond109.preheader.us_crit_edge, %for.cond105.preheader
  %indvar139 = phi i64 [ 0, %for.cond105.preheader ], [ %indvar.next140, %for.inc203.us.for.cond109.preheader.us_crit_edge ]
  %indvars.iv130 = phi i64 [ 1, %for.cond105.preheader ], [ %indvars.iv.next131, %for.inc203.us.for.cond109.preheader.us_crit_edge ]
  %52 = add nuw nsw i64 %indvar139, 1
  %scevgep = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %50, i64 %52, i64 1
  %scevgep142 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %50, i64 %52, i64 119
  %scevgep144 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvar, i64 %52, i64 1
  %scevgep146 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %51, i64 %52, i64 119
  ...
  br i1 %memcheck.conflict, label %for.cond109.preheader.us.for.inc200.us_crit_edge, label %for.cond109.preheader.us.vector.body_crit_edge

for.cond109.preheader.us.vector.body_crit_edge:   ; preds = %for.cond109.preheader.us
  br label %vector.body

for.cond109.preheader.us.for.inc200.us_crit_edge: ; preds = %for.cond109.preheader.us
  br label %for.inc200.us

vector.body:                                      ; preds = %vector.body, %for.cond109.preheader.us.vector.body_crit_edge
  %index = phi i64 [ 0, %for.cond109.preheader.us.vector.body_crit_edge ], [ %index.next, %vector.body ]
  %offset.idx = or i64 %index, 1
  %53 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %add113, i64 %indvars.iv130, i64 %offset.idx
  %54 = bitcast double* %53 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %54, align 8, !alias.scope !10
  %55 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv134, i64 %indvars.iv130, i64 %offset.idx
  %56 = bitcast double* %55 to <2 x double>*
  %wide.load148 = load <2 x double>, <2 x double>* %56, align 8, !alias.scope !10
  %57 = fmul <2 x double> %wide.load148, <double 2.000000e+00, double 2.000000e+00>
  %58 = fsub <2 x double> %wide.load, %57
  %59 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %sub128, i64 %indvars.iv130, i64 %offset.idx
  %60 = bitcast double* %59 to <2 x double>*
  %wide.load149 = load <2 x double>, <2 x double>* %60, align 8, !alias.scope !10
  %61 = fadd <2 x double> %wide.load149, %58
  %62 = fmul <2 x double> %61, <double 1.250000e-01, double 1.250000e-01>
  %63 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv134, i64 %add139.us, i64 %offset.idx
  %64 = bitcast double* %63 to <2 x double>*
  %wide.load150 = load <2 x double>, <2 x double>* %64, align 8, !alias.scope !10
  %65 = bitcast double* %55 to <2 x double>*
  %wide.load151 = load <2 x double>, <2 x double>* %65, align 8, !alias.scope !10
  %66 = fmul <2 x double> %wide.load151, <double 2.000000e+00, double 2.000000e+00>
  %67 = fsub <2 x double> %wide.load150, %66
  %68 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv134, i64 %sub154.us, i64 %offset.idx
  %69 = bitcast double* %68 to <2 x double>*
  %wide.load152 = load <2 x double>, <2 x double>* %69, align 8, !alias.scope !10
  %70 = fadd <2 x double> %wide.load152, %67
  %71 = fmul <2 x double> %70, <double 1.250000e-01, double 1.250000e-01>
  %72 = fadd <2 x double> %62, %71
  %73 = add nuw nsw i64 %offset.idx, 1
  %74 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv134, i64 %indvars.iv130, i64 %73
  %75 = bitcast double* %74 to <2 x double>*
  %wide.load153 = load <2 x double>, <2 x double>* %75, align 8, !alias.scope !10
  %76 = bitcast double* %55 to <2 x double>*
  %wide.load154 = load <2 x double>, <2 x double>* %76, align 8, !alias.scope !10
  %77 = fmul <2 x double> %wide.load154, <double 2.000000e+00, double 2.000000e+00>
  %78 = fsub <2 x double> %wide.load153, %77
  %79 = add nsw i64 %offset.idx, -1
  %80 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv134, i64 %indvars.iv130, i64 %79
  %81 = bitcast double* %80 to <2 x double>*
  %wide.load155 = load <2 x double>, <2 x double>* %81, align 8, !alias.scope !10
  %82 = fadd <2 x double> %wide.load155, %78
  %83 = fmul <2 x double> %82, <double 1.250000e-01, double 1.250000e-01>
  %84 = fadd <2 x double> %72, %83
  %85 = bitcast double* %55 to <2 x double>*
  %wide.load156 = load <2 x double>, <2 x double>* %85, align 8, !alias.scope !10
  %86 = fadd <2 x double> %wide.load156, %84
  %87 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv134, i64 %indvars.iv130, i64 %offset.idx
  %88 = bitcast double* %87 to <2 x double>*
  store <2 x double> %86, <2 x double>* %88, align 8, !alias.scope !13, !noalias !10
  %index.next = add nuw nsw i64 %index, 2
  %89 = icmp eq i64 %index.next, 118
  br i1 %89, label %for.inc203.us.loopexit198, label %vector.body, !llvm.loop !15

for.inc200.us:                                    ; preds = %for.inc200.us, %for.cond109.preheader.us.for.inc200.us_crit_edge
  %indvars.iv126 = phi i64 [ 1, %for.cond109.preheader.us.for.inc200.us_crit_edge ], [ %indvars.iv.next127, %for.inc200.us ]
  ...
  %arrayidx149.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv134, i64 %indvars.iv130, i64 %indvars.iv126
  ...
  %arrayidx174.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv134, i64 %indvars.iv130, i64 %indvars.iv126
  ...
  %arrayidx192.us = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv134, i64 %indvars.iv130, i64 %indvars.iv126
...
for.inc203.us.loopexit198:                        ; preds = %vector.body
  br label %for.inc203.us

for.inc203.us:                                    ; preds = %for.inc203.us.loopexit198, %for.inc203.us.loopexit
  %indvars.iv.next131 = add nuw nsw i64 %indvars.iv130, 1
  %exitcond133 = icmp eq i64 %indvars.iv.next131, 119
  br i1 %exitcond133, label %for.inc206, label %for.inc203.us.for.cond109.preheader.us_crit_edge

for.inc203.us.for.cond109.preheader.us_crit_edge: ; preds = %for.inc203.us
...
for.inc206:                                       ; preds = %for.inc203.us
  ...
  br i1 %exitcond137, label %for.inc209, label %for.inc206.for.cond105.preheader_crit_edge
