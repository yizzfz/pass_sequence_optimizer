...
.preheader5.prol.loopexit:                        ; preds = %.preheader5.preheader, %.preheader5.prol.loopexit.unr-lcssa
  ...
  br i1 %20, label %._crit_edge15.loopexit116, label %.preheader5.preheader.new
...
._crit_edge12.us:                                 ; preds = %._crit_edge12.us.loopexit, %middle.block
  ...
  br i1 %exitcond117, label %._crit_edge15.loopexit, label %.lr.ph.us.us.preheader

.lr.ph11.us:                                      ; preds = %.lr.ph11.us.preheader115, %.lr.ph11.us
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %.lr.ph11.us ], [ %indvars.iv58.ph, %.lr.ph11.us.preheader115 ]
...
.lr.ph11.us.preheader:                            ; preds = %._crit_edge.us.us
  ...
  br i1 %min.iters.check, label %.lr.ph11.us.preheader115, label %min.iters.checked

.lr.ph11.us.preheader115:                         ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.lr.ph11.us.preheader
...
min.iters.checked:                                ; preds = %.lr.ph11.us.preheader
  br i1 %cmp.zero, label %.lr.ph11.us.preheader115, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %bound0 = icmp ult double* %scevgep, %scevgep71
  %bound1 = icmp ugt double* %scevgep69, %5
  %memcheck.conflict = and i1 %bound0, %bound1
  br i1 %memcheck.conflict, label %.lr.ph11.us.preheader115, label %vector.body.preheader
...
middle.block:                                     ; preds = %vector.body.prol.loopexit, %middle.block.unr-lcssa
  br i1 %cmp.n, label %._crit_edge12.us, label %.lr.ph11.us.preheader115
...
.prol.preheader:                                  ; preds = %.lr.ph.us.us
  ...
  store double %74, double* %sunkaddr109, align 8
...
.lr.ph.us.us.new:                                 ; preds = %.lr.ph.us.us.new.preheader, %.lr.ph.us.us.new
  ...
  store double %82, double* %sunkaddr113, align 8
  ...
  store double %88, double* %sunkaddr113, align 8
...
.preheader5:                                      ; preds = %.preheader5, %.preheader5.preheader.new
  ...
  br i1 %exitcond.7, label %._crit_edge15.loopexit116.unr-lcssa, label %.preheader5

._crit_edge15.loopexit:                           ; preds = %._crit_edge12.us
  br label %._crit_edge15

._crit_edge15.loopexit116.unr-lcssa:              ; preds = %.preheader5
  br label %._crit_edge15.loopexit116

._crit_edge15.loopexit116:                        ; preds = %.preheader5.prol.loopexit, %._crit_edge15.loopexit116.unr-lcssa
  br label %._crit_edge15

._crit_edge15:                                    ; preds = %._crit_edge15.loopexit116, %._crit_edge15.loopexit, %.preheader6
