...
; <label>:9:                                      ; preds = %9, %.lr.ph
  ...
  %19 = getelementptr inbounds double, double* %2, i64 %indvars.iv4
...
.lr.ph6.us:                                       ; preds = %.lr.ph6.us.preheader91, %.lr.ph6.us
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %.lr.ph6.us ], [ %indvars.iv30.ph, %.lr.ph6.us.preheader91 ]
  %45 = add nsw i64 %indvars.iv30, -1
  %46 = getelementptr inbounds double, double* %3, i64 %45
  %47 = load double, double* %46, align 8
  %48 = getelementptr inbounds double, double* %3, i64 %indvars.iv30
  %49 = load double, double* %48, align 8
  %50 = fadd double %47, %49
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  %51 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next31
  %52 = load double, double* %51, align 8
  %53 = fadd double %50, %52
  %54 = fmul double %53, 3.333300e-01
  %55 = getelementptr inbounds double, double* %2, i64 %indvars.iv30
  store double %54, double* %55, align 8
  %56 = icmp slt i64 %indvars.iv.next31, %9
...
scalar.ph54:                                      ; preds = %scalar.ph54.preheader, %scalar.ph54
  ...
  br i1 %68, label %scalar.ph54, label %.lr.ph6.us.preheader.loopexit, !llvm.loop !10
...
.lr.ph6.us.preheader91:                           ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.lr.ph6.us.preheader
  %indvars.iv30.ph = phi i64 [ 1, %vector.memcheck ], [ 1, %min.iters.checked ], [ 1, %.lr.ph6.us.preheader ], [ %ind.end, %middle.block ]
  br label %.lr.ph6.us
...
; <label>:9:                                      ; preds = %._crit_edge, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %._crit_edge ], [ 0, %.lr.ph ]
  %storemerge1 = phi i32 [ %18, %._crit_edge ], [ 0, %.lr.ph ]
