...
define internal void @init_array([1200 x double]* nocapture %ex, [1200 x double]* %ey, [1200 x double]* %hz, double* nocapture %_fict_) #2 {
entry.for.body_crit_edge:
  br label %for.body

for.cond5.preheader.us:                           ; preds = %for.cond5.preheader.us.preheader, %for.cond5.for.end38_crit_edge.us
  %indvars.iv512.us = phi i64 [ %indvars.iv.next6.us, %for.cond5.for.end38_crit_edge.us ], [ 0, %for.cond5.preheader.us.preheader ]
...
for.body:                                         ; preds = %for.body, %entry.for.body_crit_edge
  %indvars.iv715 = phi i64 [ 0, %entry.for.body_crit_edge ], [ %indvars.iv.next8.4, %for.body ]
  ...
  br i1 %exitcond19.4, label %for.cond5.preheader.us.preheader, label %for.body
...
for.body3.preheader:                              ; preds = %for.cond1.preheader.lr.ph, %for.end112
  %indvars.iv4060 = phi i64 [ 0, %for.cond1.preheader.lr.ph ], [ %indvars.iv.next41, %for.end112 ]
  br label %for.body3
...
vector.body58:                                    ; preds = %vector.body58.preheader, %vector.body58
  ...
  %3 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv2747.us, i64 %index78
  ...
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv2747.us, i64 %index78
  ...
  br i1 %21, label %for.cond10.for.end33_crit_edge.us.loopexit112, label %vector.body58, !llvm.loop !6
...
for.cond10.for.end33_crit_edge.us.loopexit112:    ; preds = %vector.body58
  br label %for.cond10.for.end33_crit_edge.us

for.cond10.for.end33_crit_edge.us:                ; preds = %for.cond10.for.end33_crit_edge.us.loopexit112, %for.cond10.for.end33_crit_edge.us.loopexit
...
for.body3:                                        ; preds = %for.body3, %for.body3.preheader
  %indvars.iv43 = phi i64 [ 0, %for.body3.preheader ], [ %indvars.iv.next.4, %for.body3 ]
  %sunkaddr = ptrtoint double* %_fict_ to i64
  %sunkaddr93 = mul i64 %indvars.iv4060, 8
  ...
  %sunkaddr97 = mul i64 %indvars.iv4060, 8
  ...
  %sunkaddr101 = mul i64 %indvars.iv4060, 8
  ...
  %sunkaddr105 = mul i64 %indvars.iv4060, 8
  ...
  %sunkaddr109 = mul i64 %indvars.iv4060, 8
...
for.cond40.preheader.us:                          ; preds = %for.cond40.preheader.us.preheader, %for.cond40.for.end65_crit_edge.us
  ...
  %scevgep30 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv3352.us, i64 1
  %38 = add i64 %indvars.iv3352.us, 1
  %scevgep32 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %38, i64 0
  %scevgep34 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv3352.us, i64 0
  ...
  br i1 %memcheck.conflict41, label %for.body42.us.preheader.new, label %vector.body25.preheader
...
vector.body25:                                    ; preds = %vector.body25.preheader, %vector.body25
  ...
  br i1 %58, label %for.body42.us.preheader.new.loopexit, label %vector.body25, !llvm.loop !15

for.body42.us.preheader.new.loopexit:             ; preds = %vector.body25
...
for.cond73.preheader.us:                          ; preds = %for.cond73.preheader.us.preheader, %for.cond73.for.end109_crit_edge.us
  ...
  %scevgep2 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv3757.us, i64 1199
  %scevgep4 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv3757.us, i64 0
  %70 = add i64 %indvars.iv3757.us, 1
  %scevgep6 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %70, i64 0
  %scevgep8 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %indvars.iv3757.us, i64 0
...
for.body76.us:                                    ; preds = %for.body76.us.preheader, %for.body76.us
  ...
  %cmp75.us = icmp slt i64 %indvars.iv.next36.us, 1199
  br i1 %cmp75.us, label %for.body76.us, label %for.cond73.for.end109_crit_edge.us, !llvm.loop !26

for.cond73.for.end109_crit_edge.us:               ; preds = %for.body76.us
  %cmp71.us = icmp slt i64 %70, 999
  br i1 %cmp71.us, label %for.cond73.preheader.us, label %for.end112
...
for.end112:                                       ; preds = %for.cond73.for.end109_crit_edge.us
  ...
  br i1 %exitcond70, label %for.end115, label %for.body3.preheader
...
entry.for.cond2.preheader.us_crit_edge:
...
for.cond2.preheader.us:                           ; preds = %for.cond2.for.end_crit_edge.us, %entry.for.cond2.preheader.us_crit_edge
  %indvars.iv2541.us = phi i64 [ %indvars.iv.next26.us, %for.cond2.for.end_crit_edge.us ], [ 0, %entry.for.cond2.preheader.us_crit_edge ]
  %3 = mul nsw i64 %indvars.iv2541.us, 1000
  br label %for.body4.us

for.body4.us:                                     ; preds = %if.end.us, %for.cond2.preheader.us
  %indvars.iv2239.us = phi i64 [ 0, %for.cond2.preheader.us ], [ %indvars.iv.next23.us, %if.end.us ]
  %4 = add nsw i64 %indvars.iv2239.us, %3
...
for.cond2.for.end_crit_edge.us:                   ; preds = %if.end.us
  ...
  br i1 %exitcond52, label %for.end12.for.cond19.preheader.us_crit_edge, label %for.cond2.preheader.us

for.end12.for.cond19.preheader.us_crit_edge:      ; preds = %for.cond2.for.end_crit_edge.us
...
for.cond19.preheader.us:                          ; preds = %for.cond19.for.end36_crit_edge.us, %for.end12.for.cond19.preheader.us_crit_edge
  %indvars.iv1936.us = phi i64 [ %indvars.iv.next20.us, %for.cond19.for.end36_crit_edge.us ], [ 0, %for.end12.for.cond19.preheader.us_crit_edge ]
  %13 = mul nsw i64 %indvars.iv1936.us, 1000
...
for.body21.us:                                    ; preds = %if.end28.us, %for.cond19.preheader.us
  ...
  %14 = add nsw i64 %indvars.iv1634.us, %13
...
for.cond19.for.end36_crit_edge.us:                ; preds = %if.end28.us
  ...
  br i1 %exitcond49, label %for.end39.for.cond45.preheader.us_crit_edge, label %for.cond19.preheader.us

for.end39.for.cond45.preheader.us_crit_edge:      ; preds = %for.cond19.for.end36_crit_edge.us
...
for.cond45.preheader.us:                          ; preds = %for.cond45.for.end62_crit_edge.us, %for.end39.for.cond45.preheader.us_crit_edge
  %indvars.iv1331.us = phi i64 [ %indvars.iv.next14.us, %for.cond45.for.end62_crit_edge.us ], [ 0, %for.end39.for.cond45.preheader.us_crit_edge ]
  %21 = mul nsw i64 %indvars.iv1331.us, 1000
...
for.body47.us:                                    ; preds = %if.end54.us, %for.cond45.preheader.us
  ...
  %22 = add nsw i64 %indvars.iv29.us, %21
