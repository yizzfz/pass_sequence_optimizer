...
define i32 @main(i32, i8**) local_unnamed_addr #0 {
  ...
  tail call fastcc void @kernel_jacobi_1d(double* %.cast, double* %.cast1)
...
; <label>:9:                                      ; preds = %6
  tail call fastcc void @print_array(double* %.cast)
  br label %._crit_edge
...
vector.memcheck61:                                ; preds = %._crit_edge.us.preheader, %._crit_edge5.us
  %2 = phi i32 [ %27, %._crit_edge5.us ], [ 0, %._crit_edge.us.preheader ]
...
vector.body46:                                    ; preds = %vector.body46.preheader, %vector.body46
  ...
  %wide.load77 = load <2 x double>, <2 x double>* %17, align 8, !alias.scope !10
  %18 = fadd <2 x double> %12, %wide.load73
  %19 = fadd <2 x double> %13, %wide.load77
  ...
  %22 = getelementptr inbounds double, double* %1, i64 %offset.idx67
  %23 = bitcast double* %22 to <2 x double>*
  store <2 x double> %20, <2 x double>* %23, align 8, !alias.scope !13, !noalias !10
  %24 = getelementptr double, double* %22, i64 2
  %25 = bitcast double* %24 to <2 x double>*
  store <2 x double> %21, <2 x double>* %25, align 8, !alias.scope !13, !noalias !10
  %index.next64 = add i64 %index63, 4
  %26 = icmp eq i64 %index.next64, 1996
  br i1 %26, label %scalar.ph48.preheader.loopexit, label %vector.body46, !llvm.loop !15

._crit_edge5.us:                                  ; preds = %.lr.ph4.us
  %27 = add nsw i32 %2, 1
  %28 = icmp slt i32 %27, 500
  br i1 %28, label %vector.memcheck61, label %79

.lr.ph4.us:                                       ; preds = %.lr.ph4.us.preheader, %.lr.ph4.us
  %indvars.iv25 = phi i64 [ %35, %.lr.ph4.us ], [ %indvars.iv25.ph, %.lr.ph4.us.preheader ]
  %29 = add nsw i64 %indvars.iv25, -1
  %30 = getelementptr inbounds double, double* %1, i64 %29
  %31 = load double, double* %30, align 8
  %32 = getelementptr inbounds double, double* %1, i64 %indvars.iv25
  %33 = load double, double* %32, align 8
  %34 = fadd double %31, %33
  %35 = add nuw nsw i64 %indvars.iv25, 1
...
scalar.ph48:                                      ; preds = %scalar.ph48.preheader, %scalar.ph48
  %indvars.iv = phi i64 [ %48, %scalar.ph48 ], [ %indvars.iv.ph, %scalar.ph48.preheader ]
  ...
  br i1 %54, label %scalar.ph48, label %vector.memcheck, !llvm.loop !17
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load = load <2 x double>, <2 x double>* %57, align 8, !alias.scope !18
  %58 = getelementptr double, double* %56, i64 2
  %59 = bitcast double* %58 to <2 x double>*
  %wide.load41 = load <2 x double>, <2 x double>* %59, align 8, !alias.scope !18
  %60 = getelementptr inbounds double, double* %1, i64 %offset.idx
  %61 = bitcast double* %60 to <2 x double>*
  %wide.load42 = load <2 x double>, <2 x double>* %61, align 8, !alias.scope !18
  %62 = getelementptr double, double* %60, i64 2
  %63 = bitcast double* %62 to <2 x double>*
  %wide.load43 = load <2 x double>, <2 x double>* %63, align 8, !alias.scope !18
  %64 = fadd <2 x double> %wide.load, %wide.load42
  %65 = fadd <2 x double> %wide.load41, %wide.load43
  %66 = add nuw nsw i64 %offset.idx, 1
  %67 = getelementptr inbounds double, double* %1, i64 %66
  %68 = getelementptr double, double* %67, i64 2
  %69 = bitcast double* %68 to <2 x double>*
  %wide.load45 = load <2 x double>, <2 x double>* %69, align 8, !alias.scope !18
  %70 = fadd <2 x double> %64, %wide.load41
  %71 = fadd <2 x double> %65, %wide.load45
