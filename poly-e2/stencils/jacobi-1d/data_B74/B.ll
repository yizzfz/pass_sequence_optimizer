...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc33
  %inc3413 = phi i32 [ 0, %for.body.lr.ph ], [ %inc34, %for.inc33 ]
  br i1 %1, label %for.inc.preheader, label %for.inc33

for.inc.preheader:                                ; preds = %for.body
  br i1 %min.iters.check34, label %for.inc.preheader70, label %min.iters.checked35

min.iters.checked35:                              ; preds = %for.inc.preheader
  br i1 %cmp.zero, label %for.inc.preheader70, label %vector.memcheck51

vector.memcheck51:                                ; preds = %min.iters.checked35
  br i1 %found.conflict49, label %for.inc.preheader70, label %vector.body30.preheader
...
vector.body30:                                    ; preds = %vector.body30.preheader, %vector.body30
  %index53 = phi i64 [ %index.next54, %vector.body30 ], [ 0, %vector.body30.preheader ]
  ...
  br i1 %27, label %middle.block31, label %vector.body30, !llvm.loop !6

middle.block31:                                   ; preds = %vector.body30
  br i1 %cmp.n, label %for.end, label %for.inc.preheader70

for.inc.preheader70:                              ; preds = %middle.block31, %vector.memcheck51, %min.iters.checked35, %for.inc.preheader
  %indvars.iv.ph = phi i64 [ 1, %vector.memcheck51 ], [ 1, %min.iters.checked35 ], [ 1, %for.inc.preheader ], [ %ind.end, %middle.block31 ]
  br label %for.inc

for.inc:                                          ; preds = %for.inc.preheader70, %for.inc
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ %indvars.iv.ph, %for.inc.preheader70 ]
...
for.end:                                          ; preds = %for.end.loopexit, %middle.block31
...
for.inc30.preheader:                              ; preds = %for.end
  br i1 %min.iters.check34, label %for.inc30.preheader69, label %min.iters.checked

min.iters.checked:                                ; preds = %for.inc30.preheader
  br i1 %cmp.zero, label %for.inc30.preheader69, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  br i1 %found.conflict, label %for.inc30.preheader69, label %vector.body.preheader
...
middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %for.inc33, label %for.inc30.preheader69

for.inc30.preheader69:                            ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.inc30.preheader
  %indvars.iv15.ph = phi i64 [ 1, %vector.memcheck ], [ 1, %min.iters.checked ], [ 1, %for.inc30.preheader ], [ %ind.end, %middle.block ]
  br label %for.inc30

for.inc30:                                        ; preds = %for.inc30.preheader69, %for.inc30
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc30 ], [ %indvars.iv15.ph, %for.inc30.preheader69 ]
