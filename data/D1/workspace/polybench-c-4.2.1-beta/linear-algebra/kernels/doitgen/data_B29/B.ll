...
.preheader6.lr.ph:                                ; preds = %6
  %wide.trip.count52.1 = zext i32 %2 to i64
  %8 = sext i32 %2 to i64
  %9 = sext i32 %1 to i64
  ...
  %13 = icmp eq i32 %2, 1
  %sunkaddr73 = ptrtoint double* %5 to i64
  %scevgep82 = getelementptr double, double* %5, i64 %8
  %14 = add nsw i64 %9, -1
  %15 = add nsw i64 %8, -4
  %16 = lshr i64 %15, 2
...
.preheader6:                                      ; preds = %._crit_edge15, %.preheader6.lr.ph
  ...
  br i1 %11, label %.preheader5.lr.ph, label %._crit_edge15

.preheader5.lr.ph:                                ; preds = %.preheader6
  br i1 %12, label %.preheader5.us.preheader, label %.preheader5.preheader

.preheader5.preheader:                            ; preds = %.preheader5.lr.ph
  br i1 %lcmp.mod123, label %.preheader5.prol.loopexit, label %.preheader5.prol.preheader
...
.preheader5.prol:                                 ; preds = %.preheader5.prol, %.preheader5.prol.preheader
  ...
  %prol.iter = phi i64 [ %prol.iter.sub, %.preheader5.prol ], [ %xtraiter122, %.preheader5.prol.preheader ]
...
.preheader5.prol.loopexit:                        ; preds = %.preheader5.preheader, %.preheader5.prol.loopexit.unr-lcssa
  ...
  br i1 %19, label %._crit_edge15.loopexit119, label %.preheader5.preheader.new
...
._crit_edge12.us.loopexit:                        ; preds = %._crit_edge66
  br label %._crit_edge12.us

._crit_edge12.us:                                 ; preds = %._crit_edge12.us.loopexit, %middle.block
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  %exitcond120 = icmp eq i64 %indvars.iv.next61, %9
  br i1 %exitcond120, label %._crit_edge15.loopexit, label %.preheader5.us

._crit_edge66:                                    ; preds = %._crit_edge66.preheader118, %._crit_edge66
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %._crit_edge66 ], [ %indvars.iv58.ph, %._crit_edge66.preheader118 ]
  ...
  %26 = icmp slt i64 %indvars.iv.next59, %8
  br i1 %26, label %._crit_edge66, label %._crit_edge12.us.loopexit, !llvm.loop !3

._crit_edge66.preheader:                          ; preds = %._crit_edge.us.us
  %scevgep80 = getelementptr [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv62, i64 %indvars.iv60, i64 %8
  br i1 %min.iters.check, label %._crit_edge66.preheader118, label %min.iters.checked

._crit_edge66.preheader118:                       ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %._crit_edge66.preheader
  %indvars.iv58.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %min.iters.checked ], [ 0, %._crit_edge66.preheader ], [ %n.vec, %middle.block ]
  br label %._crit_edge66

min.iters.checked:                                ; preds = %._crit_edge66.preheader
  br i1 %cmp.zero, label %._crit_edge66.preheader118, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %bound0 = icmp ult double* %scevgep, %scevgep82
  %bound1 = icmp ugt double* %scevgep80, %5
  %memcheck.conflict = and i1 %bound0, %bound1
  br i1 %memcheck.conflict, label %._crit_edge66.preheader118, label %vector.body.preheader
...
vector.body.prol:                                 ; preds = %vector.body.prol, %vector.body.prol.preheader
  ...
  %wide.load85.prol = load <2 x i64>, <2 x i64>* %30, align 8, !alias.scope !6
  ...
  store <2 x i64> %wide.load85.prol, <2 x i64>* %34, align 8, !alias.scope !9, !noalias !6
  %index.next.prol = add i64 %index.prol, 4
  %prol.iter126.sub = add i64 %prol.iter126, -1
  %prol.iter126.cmp = icmp eq i64 %prol.iter126.sub, 0
  br i1 %prol.iter126.cmp, label %vector.body.prol.loopexit.unr-lcssa, label %vector.body.prol, !llvm.loop !11
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader.new
  ...
  %wide.load85 = load <2 x i64>, <2 x i64>* %38, align 8, !alias.scope !6
  ...
  store <2 x i64> %wide.load85, <2 x i64>* %42, align 8, !alias.scope !9, !noalias !6
  ...
  %wide.load85.1 = load <2 x i64>, <2 x i64>* %46, align 8, !alias.scope !6
  ...
  store <2 x i64> %wide.load85.1, <2 x i64>* %50, align 8, !alias.scope !9, !noalias !6
  ...
  %wide.load85.2 = load <2 x i64>, <2 x i64>* %54, align 8, !alias.scope !6
  ...
  store <2 x i64> %wide.load85.2, <2 x i64>* %58, align 8, !alias.scope !9, !noalias !6
  ...
  %wide.load85.3 = load <2 x i64>, <2 x i64>* %62, align 8, !alias.scope !6
  ...
  store <2 x i64> %wide.load85.3, <2 x i64>* %66, align 8, !alias.scope !9, !noalias !6
...
middle.block:                                     ; preds = %vector.body.prol.loopexit, %middle.block.unr-lcssa
  br i1 %cmp.n, label %._crit_edge12.us, label %._crit_edge66.preheader118
...
.prol.preheader:                                  ; preds = %.lr.ph.us.us
  ...
  %sunkaddr70 = shl i64 %indvars.iv54, 3
  %sunkaddr71 = add i64 %sunkaddr73, %sunkaddr70
  %sunkaddr72 = inttoptr i64 %sunkaddr71 to double*
  %73 = load double, double* %sunkaddr72, align 8
  %74 = fadd double %73, %72
  store double %74, double* %sunkaddr72, align 8
...
._crit_edge.us.us:                                ; preds = %._crit_edge.us.us.loopexit, %.prol.loopexit
  ...
  %exitcond57 = icmp eq i64 %indvars.iv.next55, %wide.trip.count52.1
  br i1 %exitcond57, label %._crit_edge66.preheader, label %.lr.ph.us.us
...
.lr.ph.us.us.new:                                 ; preds = %.lr.ph.us.us.new, %.lr.ph.us.us.new.preheader
  ...
  store double %81, double* %sunkaddr76, align 8
  ...
  store double %87, double* %sunkaddr76, align 8
...
.preheader5:                                      ; preds = %.preheader5, %.preheader5.preheader.new
  ...
  br i1 %exitcond.7, label %._crit_edge15.loopexit119.unr-lcssa, label %.preheader5

._crit_edge15.loopexit:                           ; preds = %._crit_edge12.us
  br label %._crit_edge15

._crit_edge15.loopexit119.unr-lcssa:              ; preds = %.preheader5
  br label %._crit_edge15.loopexit119

._crit_edge15.loopexit119:                        ; preds = %.preheader5.prol.loopexit, %._crit_edge15.loopexit119.unr-lcssa
  br label %._crit_edge15

._crit_edge15:                                    ; preds = %._crit_edge15.loopexit119, %._crit_edge15.loopexit, %.preheader6
  %indvars.iv.next63 = add nuw nsw i64 %indvars.iv62, 1
  %exitcond121 = icmp eq i64 %indvars.iv.next63, %10
  br i1 %exitcond121, label %._crit_edge.loopexit, label %.preheader6

._crit_edge.loopexit:                             ; preds = %._crit_edge15
  br label %._crit_edge
...
._crit_edge.us:                                   ; preds = %.preheader.us.new
  ...
  br i1 %exitcond, label %.preheader5._crit_edge, label %.preheader.us
...
.preheader.us.us:                                 ; preds = %._crit_edge.us.us, %.preheader3.us
  ...
  %9 = add nuw nsw i64 %8, %indvars.iv31
...
._crit_edge39:                                    ; preds = %._crit_edge38, %.preheader.us.us
  %indvars.iv = phi i64 [ 0, %.preheader.us.us ], [ %indvars.iv.next, %._crit_edge38 ]
...
._crit_edge38:                                    ; preds = %._crit_edge39, %15
  %17 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %18 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv35, i64 %indvars.iv31, i64 %indvars.iv
  ...
  br i1 %exitcond30, label %._crit_edge.us.us, label %._crit_edge39
