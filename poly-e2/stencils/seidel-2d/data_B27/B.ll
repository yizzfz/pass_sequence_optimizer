...
define internal void @init_array([2000 x double]* nocapture %A) #2 {
entry:
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal void @kernel_seidel_2d([2000 x double]* nocapture %A) #2 {
entry:
  br label %for.cond1.preheader

for.cond1.preheader:                              ; preds = %for.end68, %entry
  %t.01 = phi i32 [ 0, %entry ], [ %inc70, %for.end68 ]
  br label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.end, %for.cond1.preheader
  %indvar = phi i64 [ %indvar.next, %for.end ], [ 0, %for.cond1.preheader ]
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.end ], [ 1, %for.cond1.preheader ]
  %0 = add i64 %indvar, 1
...
for.body8:                                        ; preds = %for.body8, %for.cond5.preheader
  ...
  %arrayidx34 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv3, i64 %indvars.iv
  %6 = load double, double* %arrayidx34, align 8
  %add35 = fadd double %add30, %6
  %arrayidx40 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv3, i64 %indvars.iv.next
  %7 = load double, double* %arrayidx40, align 8
  %add41 = fadd double %add35, %7
  %arrayidx47 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv.next4, i64 %2
  %8 = load double, double* %arrayidx47, align 8
  %add48 = fadd double %add41, %8
  %arrayidx53 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv.next4, i64 %indvars.iv
  %9 = load double, double* %arrayidx53, align 8
  %add54 = fadd double %add48, %9
  %arrayidx60 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv.next4, i64 %indvars.iv.next
...
for.end:                                          ; preds = %for.body8
  %exitcond6 = icmp eq i64 %indvars.iv.next4, 1999
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond6, label %for.end68, label %for.cond5.preheader
