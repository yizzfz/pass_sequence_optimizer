...
.preheader.us:                                    ; preds = %.loopexit.us, %.preheader.lr.ph..preheader.us_crit_edge
  %indvars.iv15 = phi i64 [ 0, %.preheader.lr.ph..preheader.us_crit_edge ], [ %indvars.iv.next16, %.loopexit.us ]
  br label %._crit_edge3.us._crit_edge

._crit_edge3.us._crit_edge:                       ; preds = %._crit_edge3.us, %.preheader.us
  %indvars.iv = phi i64 [ 0, %.preheader.us ], [ %indvars.iv.next, %._crit_edge3.us ]
  %1 = mul nuw nsw i64 %indvars.iv15, %indvars.iv
  %2 = trunc i64 %1 to i32
  %3 = srem i32 %2, 7
  %4 = add nsw i32 %3, 1
  %5 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv15, i64 %indvars.iv
  store i32 %4, i32* %5, align 4
  %6 = add nuw nsw i64 %indvars.iv15, %indvars.iv
  %7 = trunc i64 %6 to i32
  %8 = srem i32 %7, 13
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %._crit_edge.us, label %10

; <label>:10:                                     ; preds = %._crit_edge3.us._crit_edge
  %11 = srem i32 %7, 7
  %12 = icmp eq i32 %11, 0
  %13 = srem i32 %7, 11
  %14 = icmp eq i32 %13, 0
  %or.cond.us = or i1 %12, %14
  br i1 %or.cond.us, label %._crit_edge.us, label %._crit_edge3.us

._crit_edge.us:                                   ; preds = %10, %._crit_edge3.us._crit_edge
  store i32 999, i32* %5, align 4
  br label %._crit_edge3.us

._crit_edge3.us:                                  ; preds = %10, %._crit_edge.us
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 2800
  br i1 %exitcond, label %.loopexit.us, label %._crit_edge3.us._crit_edge

.loopexit.us:                                     ; preds = %._crit_edge3.us
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  %exitcond17 = icmp eq i64 %indvars.iv.next16, 2800
  br i1 %exitcond17, label %.loopexit5, label %.preheader.us
...
.preheader3.us..preheader.us.us_crit_edge:        ; preds = %.loopexit7.us, %.preheader3.lr.ph..preheader3.us_crit_edge
  %indvars.iv38 = phi i64 [ 0, %.preheader3.lr.ph..preheader3.us_crit_edge ], [ %indvars.iv.next39, %.loopexit7.us ]
  %scevgep44 = getelementptr [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv38, i64 0
  %2 = add nuw nsw i64 %indvars.iv38, 1
  %scevgep46 = getelementptr [2800 x i32], [2800 x i32]* %1, i64 %2, i64 0
  br label %.preheader.us.us

.loopexit7.us:                                    ; preds = %.loopexit.us.us
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  %exitcond40 = icmp eq i64 %indvars.iv.next39, 2800
  br i1 %exitcond40, label %._crit_edge, label %.preheader3.us..preheader.us.us_crit_edge

.preheader.us.us:                                 ; preds = %.loopexit.us.us, %.preheader3.us..preheader.us.us_crit_edge
  %indvars.iv36 = phi i64 [ 0, %.preheader3.us..preheader.us.us_crit_edge ], [ %indvars.iv.next37, %.loopexit.us.us ]
  %scevgep = getelementptr [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv36, i64 0
  %3 = add nuw nsw i64 %indvars.iv36, 1
  %scevgep42 = getelementptr [2800 x i32], [2800 x i32]* %1, i64 %3, i64 0
  %4 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv36, i64 %indvars.iv38
  %bound0 = icmp ult i32* %scevgep, %4
  %bound1 = icmp ult i32* %4, %scevgep42
  %found.conflict = and i1 %bound0, %bound1
  %bound049 = icmp ult i32* %scevgep, %scevgep46
  %bound150 = icmp ult i32* %scevgep44, %scevgep42
  %found.conflict51 = and i1 %bound049, %bound150
  %conflict.rdx = or i1 %found.conflict, %found.conflict51
  br i1 %conflict.rdx, label %._crit_edge30.preheader, label %vector.body.preheader

vector.body.preheader:                            ; preds = %.preheader.us.us
  br label %vector.body

._crit_edge30.preheader:                          ; preds = %.preheader.us.us
  br label %._crit_edge30

vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  %index = phi i64 [ %index.next, %vector.body ], [ 0, %vector.body.preheader ]
  %5 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv36, i64 %index
  %6 = bitcast i32* %5 to <4 x i32>*
  %wide.load = load <4 x i32>, <4 x i32>* %6, align 4, !alias.scope !1, !noalias !4
  %7 = getelementptr i32, i32* %5, i64 4
  %8 = bitcast i32* %7 to <4 x i32>*
  %wide.load53 = load <4 x i32>, <4 x i32>* %8, align 4, !alias.scope !1, !noalias !4
  ...
  %14 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv38, i64 %index
  %15 = bitcast i32* %14 to <4 x i32>*
  %wide.load54 = load <4 x i32>, <4 x i32>* %15, align 4, !alias.scope !8
  %16 = getelementptr i32, i32* %14, i64 4
  %17 = bitcast i32* %16 to <4 x i32>*
  %wide.load55 = load <4 x i32>, <4 x i32>* %17, align 4, !alias.scope !8
  %18 = add nsw <4 x i32> %wide.load54, %11
  %19 = add nsw <4 x i32> %wide.load55, %13
  %20 = icmp slt <4 x i32> %wide.load, %18
  %21 = icmp slt <4 x i32> %wide.load53, %19
  %22 = select <4 x i1> %20, <4 x i32> %wide.load, <4 x i32> %18
  %23 = select <4 x i1> %21, <4 x i32> %wide.load53, <4 x i32> %19
  ...
  br i1 %26, label %.loopexit.us.us.loopexit56, label %vector.body, !llvm.loop !9

.loopexit.us.us.loopexit:                         ; preds = %._crit_edge30
  br label %.loopexit.us.us

.loopexit.us.us.loopexit56:                       ; preds = %vector.body
  br label %.loopexit.us.us

.loopexit.us.us:                                  ; preds = %.loopexit.us.us.loopexit56, %.loopexit.us.us.loopexit
...
._crit_edge30:                                    ; preds = %._crit_edge30, %._crit_edge30.preheader
  %indvars.iv = phi i64 [ 0, %._crit_edge30.preheader ], [ %indvars.iv.next.1, %._crit_edge30 ]
  %27 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv36, i64 %indvars.iv
  %28 = load i32, i32* %27, align 4
  %29 = load i32, i32* %4, align 4
  %30 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv38, i64 %indvars.iv
  ...
  %34 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv36, i64 %indvars.iv.next
  %35 = load i32, i32* %34, align 4
  %36 = load i32, i32* %4, align 4
  %37 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv38, i64 %indvars.iv.next
  %38 = load i32, i32* %37, align 4
  %39 = add nsw i32 %38, %36
  %40 = icmp slt i32 %35, %39
  %..us.us.1 = select i1 %40, i32 %35, i32 %39
  store i32 %..us.us.1, i32* %34, align 4
  %exitcond35.1 = icmp eq i64 %indvars.iv.next, 2799
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  br i1 %exitcond35.1, label %.loopexit.us.us.loopexit, label %._crit_edge30, !llvm.loop !12
...
._crit_edge.us:                                   ; preds = %._crit_edge.us._crit_edge, %11
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 2800
  br i1 %exitcond, label %.loopexit.us, label %._crit_edge.us._crit_edge
...
._crit_edge12:                                    ; preds = %.loopexit.us
