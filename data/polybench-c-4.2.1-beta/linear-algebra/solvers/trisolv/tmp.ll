...
.prol.loopexit.unr-lcssa:                         ; preds = %.prol.preheader, %.lr.ph
...
._crit_edge:                                      ; preds = %._crit_edge.unr-lcssa, %.prol.loopexit.unr-lcssa
...
.lr.ph.prol.loopexit.unr-lcssa:                   ; preds = %.lr.ph.prol.preheader, %.lr.ph.preheader
...
._crit_edge.loopexit:                             ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph.prol.loopexit.unr-lcssa
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.lr.ph5.._crit_edge_crit_edge
...
.lr.ph._crit_edge:                                ; preds = %14, %.lr.ph
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
