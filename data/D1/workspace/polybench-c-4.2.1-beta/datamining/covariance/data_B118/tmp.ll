...
.lr.ph78.split.us:                                ; preds = %._crit_edge75.us, %.lr.ph78.split.us.preheader
  %indvars.iv122 = phi i64 [ 0, %.lr.ph78.split.us.preheader ], [ %indvars.iv.next123, %._crit_edge75.us ]
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv122
  store double 0.000000e+00, double* %5, align 8
  %sunkaddr155 = shl i64 %indvars.iv122, 3
  %sunkaddr156 = add i64 %4, %sunkaddr155
  %sunkaddr157 = inttoptr i64 %sunkaddr156 to double*
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph78.split.us
  %6 = phi double [ 0.000000e+00, %.lr.ph78.split.us ], [ %21, %._crit_edge ]
  %indvars.iv118 = phi i64 [ 0, %.lr.ph78.split.us ], [ %indvars.iv.next119.4, %._crit_edge ]
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv118, i64 %indvars.iv122
  %8 = load double, double* %7, align 8
  %9 = fadd double %6, %8
  store double %9, double* %sunkaddr157, align 8
  %indvars.iv.next119 = add nuw nsw i64 %indvars.iv118, 1
  %10 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next119, i64 %indvars.iv122
  %11 = load double, double* %10, align 8
  %12 = fadd double %9, %11
  store double %12, double* %sunkaddr157, align 8
  %indvars.iv.next119.1 = add nuw nsw i64 %indvars.iv118, 2
  %13 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next119.1, i64 %indvars.iv122
  %14 = load double, double* %13, align 8
  %15 = fadd double %12, %14
  store double %15, double* %sunkaddr157, align 8
  %indvars.iv.next119.2 = add nuw nsw i64 %indvars.iv118, 3
  %16 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next119.2, i64 %indvars.iv122
  %17 = load double, double* %16, align 8
  %18 = fadd double %15, %17
  store double %18, double* %sunkaddr157, align 8
  %indvars.iv.next119.3 = add nuw nsw i64 %indvars.iv118, 4
  %19 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next119.3, i64 %indvars.iv122
  %20 = load double, double* %19, align 8
  %21 = fadd double %18, %20
  store double %21, double* %sunkaddr157, align 8
  %indvars.iv.next119.4 = add nuw nsw i64 %indvars.iv118, 5
  %exitcond136.4 = icmp eq i64 %indvars.iv.next119.4, 1400
  br i1 %exitcond136.4, label %._crit_edge75.us, label %._crit_edge

._crit_edge75.us:                                 ; preds = %._crit_edge
  %22 = fdiv double %21, %0
  %sunkaddr25 = shl i64 %indvars.iv122, 3
  %sunkaddr26 = add i64 %sunkaddr, %sunkaddr25
  %sunkaddr27 = inttoptr i64 %sunkaddr26 to double*
  store double %22, double* %sunkaddr27, align 8
  %indvars.iv.next123 = add nuw nsw i64 %indvars.iv122, 1
  %exitcond137 = icmp eq i64 %indvars.iv.next123, 1200
  br i1 %exitcond137, label %._crit_edge75.us..lr.ph70.split.us_crit_edge, label %.lr.ph78.split.us

._crit_edge75.us..lr.ph70.split.us_crit_edge:     ; preds = %._crit_edge75.us
  %scevgep10 = getelementptr double, double* %3, i64 1200
  br label %vector.memcheck

vector.memcheck:                                  ; preds = %._crit_edge67.us, %._crit_edge75.us..lr.ph70.split.us_crit_edge
  %indvars.iv113 = phi i64 [ 0, %._crit_edge75.us..lr.ph70.split.us_crit_edge ], [ %23, %._crit_edge67.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv113, i64 0
  %23 = add nuw nsw i64 %indvars.iv113, 1
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv113, i64 %offset.idx
  ...
  %33 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv113, i64 %32
  ...
  br i1 %39, label %._crit_edge67.us.loopexit28, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv109 = phi i64 [ %indvars.iv.next110.3, %scalar.ph ], [ 0, %scalar.ph.preheader ]
  %40 = getelementptr inbounds double, double* %3, i64 %indvars.iv109
  %41 = load double, double* %40, align 8
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv113, i64 %indvars.iv109
  %43 = load double, double* %42, align 8
  %44 = fsub double %43, %41
  store double %44, double* %42, align 8
  %indvars.iv.next110 = or i64 %indvars.iv109, 1
  %45 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next110
  %46 = load double, double* %45, align 8
  %47 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv113, i64 %indvars.iv.next110
  %48 = load double, double* %47, align 8
  %49 = fsub double %48, %46
  store double %49, double* %47, align 8
  %indvars.iv.next110.1 = or i64 %indvars.iv109, 2
  %50 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next110.1
  %51 = load double, double* %50, align 8
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv113, i64 %indvars.iv.next110.1
  %53 = load double, double* %52, align 8
  %54 = fsub double %53, %51
  store double %54, double* %52, align 8
  %indvars.iv.next110.2 = or i64 %indvars.iv109, 3
  %55 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next110.2
  %56 = load double, double* %55, align 8
  %57 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv113, i64 %indvars.iv.next110.2
  %58 = load double, double* %57, align 8
  %59 = fsub double %58, %56
  store double %59, double* %57, align 8
  %indvars.iv.next110.3 = add nuw nsw i64 %indvars.iv109, 4
  %exitcond134.3 = icmp eq i64 %indvars.iv.next110.3, 1200
  br i1 %exitcond134.3, label %._crit_edge67.us.loopexit, label %scalar.ph, !llvm.loop !9

._crit_edge67.us.loopexit:                        ; preds = %scalar.ph
  br label %._crit_edge67.us

._crit_edge67.us.loopexit28:                      ; preds = %vector.body
  br label %._crit_edge67.us

._crit_edge67.us:                                 ; preds = %._crit_edge67.us.loopexit28, %._crit_edge67.us.loopexit
  %exitcond135 = icmp eq i64 %23, 1400
  br i1 %exitcond135, label %.lr.ph62.split.us.preheader, label %vector.memcheck

.lr.ph62.split.us.preheader:                      ; preds = %._crit_edge67.us
  %60 = fadd double %0, -1.000000e+00
  br label %.lr.ph58.us

.lr.ph58.us:                                      ; preds = %._crit_edge59.us-lcssa.us.us, %.lr.ph62.split.us.preheader
  %indvars.iv95 = phi i64 [ 0, %.lr.ph62.split.us.preheader ], [ %indvars.iv.next96, %._crit_edge59.us-lcssa.us.us ]
  br label %.lr.ph.us.us

._crit_edge59.us-lcssa.us.us:                     ; preds = %._crit_edge.us.us
  %indvars.iv.next96 = add nuw nsw i64 %indvars.iv95, 1
  %exitcond98 = icmp eq i64 %indvars.iv.next96, 1200
  br i1 %exitcond98, label %._crit_edge63, label %.lr.ph58.us

.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph58.us
  %indvars.iv91 = phi i64 [ %indvars.iv95, %.lr.ph58.us ], [ %indvars.iv.next92, %._crit_edge.us.us ]
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv95, i64 %indvars.iv91
...
._crit_edge.us.us:                                ; preds = %._crit_edge21
  ...
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv91, i64 %indvars.iv95
...
._crit_edge21:                                    ; preds = %._crit_edge21, %.lr.ph.us.us
  ...
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv95
  %66 = load double, double* %65, align 8
  %67 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv91
  %68 = load double, double* %67, align 8
  %69 = fmul double %66, %68
  %70 = fadd double %64, %69
  store double %70, double* %61, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv95
  %72 = load double, double* %71, align 8
  %73 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv91
  %74 = load double, double* %73, align 8
  %75 = fmul double %72, %74
  %76 = fadd double %70, %75
  store double %76, double* %61, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond132.1 = icmp eq i64 %indvars.iv.next.1, 1400
  br i1 %exitcond132.1, label %._crit_edge.us.us, label %._crit_edge21

._crit_edge63:                                    ; preds = %._crit_edge59.us-lcssa.us.us
  ret void
}
...
._crit_edge2:                                     ; preds = %._crit_edge, %.lr.ph13.split.us
...
._crit_edge:                                      ; preds = %._crit_edge2, %10
  ...
  br i1 %exitcond19, label %._crit_edge.us, label %._crit_edge2

._crit_edge.us:                                   ; preds = %._crit_edge
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  %exitcond18 = icmp eq i64 %indvars.iv.next16, 1200
  br i1 %exitcond18, label %._crit_edge14, label %.lr.ph13.split.us
