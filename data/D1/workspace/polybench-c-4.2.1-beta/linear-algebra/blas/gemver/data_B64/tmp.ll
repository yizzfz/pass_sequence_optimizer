...
.preheader11.us.preheader:                        ; preds = %.preheader11.lr.ph
  ...
  %smax72 = select i1 %39, i64 %37, i64 1
  %40 = icmp sgt i64 %37, 1
  %smax74 = select i1 %40, i64 %37, i64 1
  %scevgep77 = getelementptr double, double* %33, i64 %smax74
  %scevgep79 = getelementptr double, double* %35, i64 %smax74
  %n.vec = and i64 %smax72, 9223372036854775804
...
.preheader11.us:                                  ; preds = %._crit_edge28.us, %.preheader11.us.preheader
  ...
  %41 = icmp ult i64 %smax72, 4
  %42 = add i64 %38, %indvar
  %scevgep = getelementptr [2000 x double], [2000 x double]* %31, i64 %42, i64 0
  %scevgep75 = getelementptr [2000 x double], [2000 x double]* %31, i64 %42, i64 %smax74
...
vector.memcheck:                                  ; preds = %min.iters.checked
  ...
  %bound1 = icmp ult double* %43, %scevgep75
  %found.conflict = and i1 %bound0, %bound1
  %bound082 = icmp ult double* %scevgep, %scevgep77
  %bound183 = icmp ult double* %33, %scevgep75
  %found.conflict84 = and i1 %bound082, %bound183
  %conflict.rdx = or i1 %found.conflict, %found.conflict84
  %bound087 = icmp ult double* %scevgep, %44
  %bound188 = icmp ult double* %44, %scevgep75
  %found.conflict89 = and i1 %bound087, %bound188
  %conflict.rdx90 = or i1 %conflict.rdx, %found.conflict89
  %bound091 = icmp ult double* %scevgep, %scevgep79
  %bound192 = icmp ult double* %35, %scevgep75
  %found.conflict93 = and i1 %bound091, %bound192
  %conflict.rdx94 = or i1 %conflict.rdx90, %found.conflict93
  br i1 %conflict.rdx94, label %._crit_edge.preheader, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %wide.load96 = load <2 x double>, <2 x double>* %49, align 8, !alias.scope !1, !noalias !4
  ...
  %wide.load98 = load <2 x double>, <2 x double>* %58, align 8, !alias.scope !10
  %59 = fmul <2 x double> %52, %wide.load97
  %60 = fmul <2 x double> %54, %wide.load98
  %61 = fadd <2 x double> %wide.load, %59
  %62 = fadd <2 x double> %wide.load96, %60
  ...
  %wide.load100 = load <2 x double>, <2 x double>* %71, align 8, !alias.scope !12
  %72 = fmul <2 x double> %65, %wide.load99
  %73 = fmul <2 x double> %67, %wide.load100
...
.prol.preheader63:                                ; preds = %.preheader9.us
  ...
  %sunkaddr138 = shl i64 %indvars.iv53, 3
  %sunkaddr139 = add i64 %107, %sunkaddr138
  %sunkaddr140 = inttoptr i64 %sunkaddr139 to double*
  %108 = load double, double* %sunkaddr140, align 8
  ...
  %sunkaddr142 = shl i64 %indvars.iv53, 3
  %sunkaddr143 = add i64 %106, %sunkaddr142
  %sunkaddr144 = inttoptr i64 %sunkaddr143 to double*
  store double %114, double* %sunkaddr144, align 8
...
.preheader9.us.new:                               ; preds = %.preheader9.us.new, %.preheader9.us.new.preheader
  ...
  %sunkaddr172 = ptrtoint double* %99 to i64
  %sunkaddr173 = mul i64 %indvars.iv53, 8
  %sunkaddr174 = add i64 %sunkaddr172, %sunkaddr173
  %sunkaddr175 = inttoptr i64 %sunkaddr174 to double*
  store double %123, double* %sunkaddr175, align 8
  ...
  store double %130, double* %sunkaddr175, align 8
...
.lr.ph17:                                         ; preds = %.preheader8
  ...
  %smax104 = select i1 %139, i64 %138, i64 %137
  %140 = sub nsw i64 %smax104, %136
  %min.iters.check105 = icmp ult i64 %140, 4
  br i1 %min.iters.check105, label %._crit_edge69.preheader, label %min.iters.checked106

._crit_edge69.preheader:                          ; preds = %middle.block102, %vector.memcheck124, %min.iters.checked106, %.lr.ph17
  %indvars.iv46.ph = phi i64 [ %136, %.lr.ph17 ], [ %136, %min.iters.checked106 ], [ %136, %vector.memcheck124 ], [ %ind.end, %middle.block102 ]
  br label %._crit_edge69

min.iters.checked106:                             ; preds = %.lr.ph17
  %n.vec108 = and i64 %140, -4
  %cmp.zero109 = icmp eq i64 %n.vec108, 0
  br i1 %cmp.zero109, label %._crit_edge69.preheader, label %vector.memcheck124

vector.memcheck124:                               ; preds = %min.iters.checked106
  %scevgep111 = getelementptr double, double* %133, i64 %136
  %141 = add nsw i64 %136, 1
  %142 = icmp sgt i64 %141, %137
  %smax113 = select i1 %142, i64 %141, i64 %137
  %scevgep114 = getelementptr double, double* %133, i64 %smax113
  %scevgep116 = getelementptr double, double* %134, i64 %136
  %scevgep118 = getelementptr double, double* %134, i64 %smax113
  %bound0120 = icmp ult double* %scevgep111, %scevgep118
  %bound1121 = icmp ult double* %scevgep116, %scevgep114
  %memcheck.conflict123 = and i1 %bound0120, %bound1121
  %ind.end = add nsw i64 %136, %n.vec108
  br i1 %memcheck.conflict123, label %._crit_edge69.preheader, label %vector.body101.preheader

vector.body101.preheader:                         ; preds = %vector.memcheck124
  %143 = add nsw i64 %n.vec108, -4
  %144 = lshr exact i64 %143, 2
  %145 = and i64 %144, 1
  %lcmp.mod = icmp eq i64 %145, 0
  br i1 %lcmp.mod, label %vector.body101.prol, label %vector.body101.prol.loopexit

vector.body101.prol:                              ; preds = %vector.body101.preheader
  %146 = getelementptr inbounds double, double* %133, i64 %136
  %147 = bitcast double* %146 to <2 x double>*
  %wide.load134.prol = load <2 x double>, <2 x double>* %147, align 8, !alias.scope !17, !noalias !20
  %148 = getelementptr double, double* %146, i64 2
  %149 = bitcast double* %148 to <2 x double>*
  %wide.load135.prol = load <2 x double>, <2 x double>* %149, align 8, !alias.scope !17, !noalias !20
  %150 = getelementptr inbounds double, double* %134, i64 %136
  %151 = bitcast double* %150 to <2 x double>*
  %wide.load136.prol = load <2 x double>, <2 x double>* %151, align 8, !alias.scope !20
  %152 = getelementptr double, double* %150, i64 2
  %153 = bitcast double* %152 to <2 x double>*
  %wide.load137.prol = load <2 x double>, <2 x double>* %153, align 8, !alias.scope !20
  %154 = fadd <2 x double> %wide.load134.prol, %wide.load136.prol
  %155 = fadd <2 x double> %wide.load135.prol, %wide.load137.prol
...
vector.body101.prol.loopexit:                     ; preds = %vector.body101.preheader, %vector.body101.prol
  %index126.unr = phi i64 [ 4, %vector.body101.prol ], [ 0, %vector.body101.preheader ]
  %158 = icmp eq i64 %144, 0
  br i1 %158, label %middle.block102, label %vector.body101.preheader.new
...
vector.body101:                                   ; preds = %vector.body101, %vector.body101.preheader.new
  %index126 = phi i64 [ %index126.unr, %vector.body101.preheader.new ], [ %index.next127.1, %vector.body101 ]
  %159 = add i64 %136, %index126
  %160 = getelementptr inbounds double, double* %133, i64 %159
  %161 = bitcast double* %160 to <2 x double>*
  %wide.load134 = load <2 x double>, <2 x double>* %161, align 8, !alias.scope !17, !noalias !20
  %162 = getelementptr double, double* %160, i64 2
  %163 = bitcast double* %162 to <2 x double>*
  %wide.load135 = load <2 x double>, <2 x double>* %163, align 8, !alias.scope !17, !noalias !20
  %164 = getelementptr inbounds double, double* %134, i64 %159
  %165 = bitcast double* %164 to <2 x double>*
  %wide.load136 = load <2 x double>, <2 x double>* %165, align 8, !alias.scope !20
  %166 = getelementptr double, double* %164, i64 2
  %167 = bitcast double* %166 to <2 x double>*
  %wide.load137 = load <2 x double>, <2 x double>* %167, align 8, !alias.scope !20
  %168 = fadd <2 x double> %wide.load134, %wide.load136
  %169 = fadd <2 x double> %wide.load135, %wide.load137
  ...
  %index.next127 = add i64 %index126, 4
  %172 = add i64 %136, %index.next127
  %173 = getelementptr inbounds double, double* %133, i64 %172
  %174 = bitcast double* %173 to <2 x double>*
  %wide.load134.1 = load <2 x double>, <2 x double>* %174, align 8, !alias.scope !17, !noalias !20
  %175 = getelementptr double, double* %173, i64 2
  %176 = bitcast double* %175 to <2 x double>*
  %wide.load135.1 = load <2 x double>, <2 x double>* %176, align 8, !alias.scope !17, !noalias !20
  %177 = getelementptr inbounds double, double* %134, i64 %172
  %178 = bitcast double* %177 to <2 x double>*
  %wide.load136.1 = load <2 x double>, <2 x double>* %178, align 8, !alias.scope !20
  %179 = getelementptr double, double* %177, i64 2
  %180 = bitcast double* %179 to <2 x double>*
  %wide.load137.1 = load <2 x double>, <2 x double>* %180, align 8, !alias.scope !20
  %181 = fadd <2 x double> %wide.load134.1, %wide.load136.1
  %182 = fadd <2 x double> %wide.load135.1, %wide.load137.1
  ...
  %index.next127.1 = add i64 %index126, 8
  %185 = icmp eq i64 %index.next127.1, %n.vec108
  br i1 %185, label %middle.block102.loopexit, label %vector.body101, !llvm.loop !22

middle.block102.loopexit:                         ; preds = %vector.body101
  br label %middle.block102

middle.block102:                                  ; preds = %middle.block102.loopexit, %vector.body101.prol.loopexit
  %cmp.n129 = icmp eq i64 %140, %n.vec108
  br i1 %cmp.n129, label %.preheader7, label %._crit_edge69.preheader

.preheader7.loopexit:                             ; preds = %._crit_edge69
  br label %.preheader7

.preheader7:                                      ; preds = %.preheader7.loopexit, %middle.block102, %.preheader10
...
.prol.preheader:                                  ; preds = %.preheader.us
  ...
  %sunkaddr154 = shl i64 %indvars.iv44, 3
  %sunkaddr155 = add i64 %198, %sunkaddr154
  %sunkaddr156 = inttoptr i64 %sunkaddr155 to double*
  %199 = load double, double* %sunkaddr156, align 8
  ...
  %sunkaddr158 = shl i64 %indvars.iv44, 3
  %sunkaddr159 = add i64 %197, %sunkaddr158
  %sunkaddr160 = inttoptr i64 %sunkaddr159 to double*
  store double %205, double* %sunkaddr160, align 8
  br label %.prol.loopexit
...
.preheader.us.new:                                ; preds = %.preheader.us.new, %.preheader.us.new.preheader
  ...
  %sunkaddr176 = ptrtoint double* %190 to i64
  %sunkaddr177 = mul i64 %indvars.iv44, 8
  %sunkaddr178 = add i64 %sunkaddr176, %sunkaddr177
  %sunkaddr179 = inttoptr i64 %sunkaddr178 to double*
  %207 = load double, double* %sunkaddr179, align 8
  ...
  %sunkaddr180 = ptrtoint double* %190 to i64
  %sunkaddr181 = mul i64 %indvars.iv44, 8
  %sunkaddr182 = add i64 %sunkaddr180, %sunkaddr181
  %sunkaddr183 = inttoptr i64 %sunkaddr182 to double*
  store double %214, double* %sunkaddr183, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  ...
  store double %221, double* %sunkaddr183, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, %wide.trip.count.1
