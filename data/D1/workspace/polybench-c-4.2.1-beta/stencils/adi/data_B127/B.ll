...
.preheader4:                                      ; preds = %155, %4
  %.0311 = phi i32 [ 1, %4 ], [ %157, %155 ]
  br label %.lver.check

.lver.check:                                      ; preds = %74, %.preheader4
  %indvar = phi i64 [ %5, %74 ], [ 0, %.preheader4 ]
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %74 ], [ 1, %.preheader4 ]
  %5 = add i64 %indvar, 1
...
; <label>:36:                                     ; preds = %36, %.ph
  ...
  br i1 %exitcond, label %.loopexit49, label %36
...
; <label>:55:                                     ; preds = %.loopexit49, %.loopexit48
  %56 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 999, i64 %indvars.iv3
  store double 1.000000e+00, double* %56, align 8
  br label %57

; <label>:57:                                     ; preds = %57, %55
  %indvars.iv1 = phi i64 [ 998, %55 ], [ %indvars.iv.next2.1, %57 ]
  %58 = phi double [ 1.000000e+00, %55 ], [ %71, %57 ]
  %59 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv3, i64 %indvars.iv1
  %60 = load double, double* %59, align 8
  %61 = fmul double %60, %58
  %62 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv3, i64 %indvars.iv1
  %63 = load double, double* %62, align 8
  %64 = fadd double %61, %63
  %65 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv1, i64 %indvars.iv3
  store double %64, double* %65, align 8
  %indvars.iv.next2 = add nsw i64 %indvars.iv1, -1
  %66 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv3, i64 %indvars.iv.next2
  %67 = load double, double* %66, align 8
  %68 = fmul double %67, %64
  %69 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv3, i64 %indvars.iv.next2
  %70 = load double, double* %69, align 8
  %71 = fadd double %68, %70
  %72 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv.next2, i64 %indvars.iv3
  store double %71, double* %72, align 8
  %73 = icmp sgt i64 %indvars.iv.next2, 1
...
.lver.check39.preheader:                          ; preds = %74
  br label %.lver.check39

.lver.check39:                                    ; preds = %.lver.check39.preheader, %154
  %indvar25 = phi i64 [ %75, %154 ], [ 0, %.lver.check39.preheader ]
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %154 ], [ 1, %.lver.check39.preheader ]
  ...
  %76 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv10, i64 0
...
; <label>:111:                                    ; preds = %111, %.ph40
  ...
  br i1 %exitcond7, label %.loopexit47, label %111

.loopexit:                                        ; preds = %.ph40.lver.orig
  br label %135

.loopexit47:                                      ; preds = %111
  br label %135

; <label>:135:                                    ; preds = %.loopexit47, %.loopexit
  %136 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv10, i64 999
  store double 1.000000e+00, double* %136, align 8
  br label %137

; <label>:137:                                    ; preds = %137, %135
  %indvars.iv8 = phi i64 [ 998, %135 ], [ %indvars.iv.next9.1, %137 ]
  %138 = phi double [ 1.000000e+00, %135 ], [ %151, %137 ]
  %139 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv10, i64 %indvars.iv8
  %140 = load double, double* %139, align 8
  %141 = fmul double %140, %138
  %142 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv10, i64 %indvars.iv8
  %143 = load double, double* %142, align 8
  %144 = fadd double %141, %143
  %145 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv10, i64 %indvars.iv8
  store double %144, double* %145, align 8
  %indvars.iv.next9 = add nsw i64 %indvars.iv8, -1
  %146 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv10, i64 %indvars.iv.next9
  %147 = load double, double* %146, align 8
  %148 = fmul double %147, %144
  %149 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv10, i64 %indvars.iv.next9
  %150 = load double, double* %149, align 8
  %151 = fadd double %148, %150
  %152 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv10, i64 %indvars.iv.next9
  store double %151, double* %152, align 8
  %153 = icmp sgt i64 %indvars.iv.next9, 1
  %indvars.iv.next9.1 = add nsw i64 %indvars.iv8, -2
  br i1 %153, label %137, label %154

; <label>:154:                                    ; preds = %137
  %exitcond13 = icmp eq i64 %indvars.iv.next11, 999
  br i1 %exitcond13, label %155, label %.lver.check39

; <label>:155:                                    ; preds = %154
  %156 = icmp sgt i32 %.0311, 499
