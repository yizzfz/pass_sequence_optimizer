...
for.inc:                                          ; preds = %for.inc, %for.cond1.preheader
  ...
  %sunkaddr93 = mul nuw nsw i64 %indvars.iv73, 8
  ...
  %sunkaddr97 = mul nuw nsw i64 %indvars.iv73, 8
  ...
  %sunkaddr101 = mul nuw nsw i64 %indvars.iv73, 8
  ...
  %sunkaddr105 = mul nuw nsw i64 %indvars.iv73, 8
  ...
  %sunkaddr109 = mul nuw nsw i64 %indvars.iv73, 8
...
for.inc63.us.preheader.new:                       ; preds = %for.inc63.us.preheader.new.loopexit, %for.cond40.preheader.us
  %indvars.iv59.ph = phi i64 [ 1, %for.cond40.preheader.us ], [ 1197, %for.inc63.us.preheader.new.loopexit ]
...
for.inc63.us:                                     ; preds = %for.inc63.us, %for.inc63.us.preheader.new
  %indvars.iv59 = phi i64 [ %indvars.iv.next60.prol, %for.inc63.us.preheader.new ], [ %indvars.iv.next60.1, %for.inc63.us ]
  ...
  br i1 %exitcond63.1, label %for.cond40.for.inc66_crit_edge.us, label %for.inc63.us, !llvm.loop !16
...
for.inc107.us.preheader:                          ; preds = %for.inc107.us.preheader.loopexit, %for.cond73.preheader.us
  %indvars.iv67.ph = phi i64 [ 0, %for.cond73.preheader.us ], [ 1196, %for.inc107.us.preheader.loopexit ]
  br label %for.inc107.us

for.inc107.us:                                    ; preds = %for.inc107.us.preheader, %for.inc107.us
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.inc107.us ], [ %indvars.iv67.ph, %for.inc107.us.preheader ]
...
for.inc113:                                       ; preds = %for.cond73.for.inc110_crit_edge.us
  ...
  %exitcond113 = icmp ne i64 %indvars.iv.next74, 500
  br i1 %exitcond113, label %for.cond1.preheader, label %for.end115
...
for.cond2.preheader.us:                           ; preds = %for.cond2.for.inc10_crit_edge.us, %entry
  %indvars.iv61 = phi i64 [ 0, %entry ], [ %indvars.iv.next62, %for.cond2.for.inc10_crit_edge.us ]
  %3 = mul nuw nsw i64 %indvars.iv61, 1000
  br label %for.body4.us

for.body4.us:                                     ; preds = %for.inc.us, %for.cond2.preheader.us
  %indvars.iv56 = phi i64 [ 0, %for.cond2.preheader.us ], [ %indvars.iv.next57, %for.inc.us ]
  %4 = add nuw nsw i64 %3, %indvars.iv56
...
for.cond2.for.inc10_crit_edge.us:                 ; preds = %for.inc.us
  ...
  %exitcond3 = icmp ne i64 %indvars.iv.next62, 1000
...
for.body21.us:                                    ; preds = %for.inc34.us, %for.cond19.preheader.us
  %indvars.iv46 = phi i64 [ 0, %for.cond19.preheader.us ], [ %indvars.iv.next47, %for.inc34.us ]
  %14 = add nuw nsw i64 %13, %indvars.iv46
  %15 = trunc i64 %14 to i32
...
for.cond19.for.inc37_crit_edge.us:                ; preds = %for.inc34.us
  ...
  %exitcond2 = icmp ne i64 %indvars.iv.next52, 1000
...
for.cond45.preheader.us:                          ; preds = %for.cond45.for.inc63_crit_edge.us, %for.end39
  %indvars.iv43 = phi i64 [ 0, %for.end39 ], [ %indvars.iv.next44, %for.cond45.for.inc63_crit_edge.us ]
  %21 = mul nuw nsw i64 %indvars.iv43, 1000
...
for.cond45.for.inc63_crit_edge.us:                ; preds = %for.inc60.us
  ...
  %exitcond1 = icmp ne i64 %indvars.iv.next44, 1000
