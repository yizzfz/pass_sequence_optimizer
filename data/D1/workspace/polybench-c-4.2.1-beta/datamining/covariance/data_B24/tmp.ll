...
.preheader:                                       ; preds = %28, %3
  %indvars.iv3 = phi i64 [ 0, %3 ], [ %indvars.iv.next4, %28 ]
...
._crit_edge:                                      ; preds = %._crit_edge, %.preheader
  ...
  %20 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv3, i64 %indvars.iv.next.1
  %21 = or i32 %18, 1
...
; <label>:28:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond5, label %29, label %.preheader
...
.lr.ph87.split.us:                                ; preds = %._crit_edge84.us, %.lr.ph87.split.us.preheader
  ...
  %7 = getelementptr inbounds double, double* %5, i64 %indvars.iv117
  store double 0.000000e+00, double* %7, align 8
  %sunkaddr132 = shl i64 %indvars.iv117, 3
  %sunkaddr133 = add i64 %6, %sunkaddr132
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph87.split.us
  ...
  %8 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv114, i64 %indvars.iv117
  %9 = load double, double* %8, align 8
  %10 = load double, double* %sunkaddr134, align 8
  %11 = fadd double %9, %10
  store double %11, double* %sunkaddr134, align 8
  %indvars.iv.next115 = or i64 %indvars.iv114, 1
  %12 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next115, i64 %indvars.iv117
  %13 = load double, double* %12, align 8
  %14 = fadd double %13, %11
  store double %14, double* %sunkaddr134, align 8
  %indvars.iv.next115.1 = or i64 %indvars.iv114, 2
  %15 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next115.1, i64 %indvars.iv117
  %16 = load double, double* %15, align 8
  %17 = fadd double %16, %14
  store double %17, double* %sunkaddr134, align 8
  %indvars.iv.next115.2 = or i64 %indvars.iv114, 3
  %18 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next115.2, i64 %indvars.iv117
...
._crit_edge84.us:                                 ; preds = %._crit_edge
  %21 = fdiv double %20, %2
  %sunkaddr154 = shl i64 %indvars.iv117, 3
...
._crit_edge84.us..preheader63.us_crit_edge:       ; preds = %._crit_edge84.us
  %scevgep142 = getelementptr double, double* %5, i64 1200
  br label %.preheader63.us

.preheader63.us:                                  ; preds = %._crit_edge79.us, %._crit_edge84.us..preheader63.us_crit_edge
  %indvars.iv110 = phi i64 [ 0, %._crit_edge84.us..preheader63.us_crit_edge ], [ %22, %._crit_edge79.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %3, i64 %indvars.iv110, i64 0
  %22 = add i64 %indvars.iv110, 1
  %scevgep140 = getelementptr [1200 x double], [1200 x double]* %3, i64 %22, i64 0
  %bound0 = icmp ult double* %scevgep, %scevgep142
  %bound1 = icmp ugt double* %scevgep140, %5
  %memcheck.conflict = and i1 %bound0, %bound1
  br i1 %memcheck.conflict, label %._crit_edge130.preheader, label %vector.body.preheader

vector.body.preheader:                            ; preds = %.preheader63.us
  br label %vector.body

._crit_edge130.preheader:                         ; preds = %.preheader63.us
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %25 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv110, i64 %offset.idx
  %26 = bitcast double* %25 to <8 x double>*
  %wide.vec147 = load <8 x double>, <8 x double>* %26, align 8, !alias.scope !4, !noalias !1
  %27 = fsub <8 x double> %wide.vec147, %wide.vec
  ...
  %32 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv110, i64 %31
  ...
  br i1 %38, label %._crit_edge79.us.loopexit157, label %vector.body, !llvm.loop !6

._crit_edge130:                                   ; preds = %._crit_edge130.preheader, %._crit_edge130
  %indvars.iv107 = phi i64 [ %indvars.iv.next108.3, %._crit_edge130 ], [ 0, %._crit_edge130.preheader ]
  %39 = getelementptr inbounds double, double* %5, i64 %indvars.iv107
  %40 = load double, double* %39, align 8
  %41 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv110, i64 %indvars.iv107
  %42 = load double, double* %41, align 8
  %43 = fsub double %42, %40
  store double %43, double* %41, align 8
  %indvars.iv.next108 = or i64 %indvars.iv107, 1
  %44 = getelementptr inbounds double, double* %5, i64 %indvars.iv.next108
  %45 = load double, double* %44, align 8
  %46 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv110, i64 %indvars.iv.next108
  %47 = load double, double* %46, align 8
  %48 = fsub double %47, %45
  store double %48, double* %46, align 8
  %indvars.iv.next108.1 = or i64 %indvars.iv107, 2
  %49 = getelementptr inbounds double, double* %5, i64 %indvars.iv.next108.1
  %50 = load double, double* %49, align 8
  %51 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv110, i64 %indvars.iv.next108.1
  %52 = load double, double* %51, align 8
  %53 = fsub double %52, %50
  store double %53, double* %51, align 8
  %indvars.iv.next108.2 = or i64 %indvars.iv107, 3
  %54 = getelementptr inbounds double, double* %5, i64 %indvars.iv.next108.2
  %55 = load double, double* %54, align 8
  %56 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv110, i64 %indvars.iv.next108.2
  ...
  br i1 %exitcond109.3, label %._crit_edge79.us.loopexit, label %._crit_edge130, !llvm.loop !9

._crit_edge79.us.loopexit:                        ; preds = %._crit_edge130
  br label %._crit_edge79.us

._crit_edge79.us.loopexit157:                     ; preds = %vector.body
  br label %._crit_edge79.us

._crit_edge79.us:                                 ; preds = %._crit_edge79.us.loopexit157, %._crit_edge79.us.loopexit
  %exitcond112 = icmp eq i64 %22, 1400
...
.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph67.us
  ...
  %60 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv96, i64 %indvars.iv93
  store double 0.000000e+00, double* %60, align 8
  br label %._crit_edge131

._crit_edge.us.us:                                ; preds = %._crit_edge131
  %61 = fdiv double %75, %59
  store double %61, double* %60, align 8
  %62 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv93, i64 %indvars.iv96
...
._crit_edge131:                                   ; preds = %._crit_edge131, %.lr.ph.us.us
  %63 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %75, %._crit_edge131 ]
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %._crit_edge131 ]
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv, i64 %indvars.iv96
  %65 = load double, double* %64, align 8
  %66 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv, i64 %indvars.iv93
  %67 = load double, double* %66, align 8
  %68 = fmul double %65, %67
  %69 = fadd double %63, %68
  store double %69, double* %60, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %70 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next, i64 %indvars.iv96
  %71 = load double, double* %70, align 8
  %72 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next, i64 %indvars.iv93
  ...
  br i1 %exitcond.1, label %._crit_edge.us.us, label %._crit_edge131
