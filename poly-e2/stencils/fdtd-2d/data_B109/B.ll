...
for.inc:                                          ; preds = %for.inc, %entry
  %indvars.iv22 = phi i64 [ 0, %entry ], [ %indvars.iv.next23.4, %for.inc ]
  ...
  br i1 %exitcond25.4, label %for.cond5.preheader.us.preheader, label %for.inc
...
for.cond10.preheader.us:                          ; preds = %for.cond10.for.inc34_crit_edge.us, %for.cond10.preheader.us.preheader
  ...
  %indvars.iv56 = phi i64 [ 1, %for.cond10.preheader.us.preheader ], [ %indvars.iv.next57, %for.cond10.for.inc34_crit_edge.us ]
  %0 = add i64 %indvar, 1
...
for.inc31.us:                                     ; preds = %for.inc31.us, %for.inc31.us.preheader
  ...
  br i1 %exitcond55.1, label %for.cond10.for.inc34_crit_edge.us.loopexit, label %for.inc31.us, !llvm.loop !9
...
for.inc63.us.preheader.new:                       ; preds = %for.inc63.us.preheader.new.loopexit, %for.cond40.preheader.us
  %indvars.iv62.ph = phi i64 [ 1, %for.cond40.preheader.us ], [ 1197, %for.inc63.us.preheader.new.loopexit ]
...
for.inc63.us:                                     ; preds = %for.inc63.us, %for.inc63.us.preheader.new
  %indvars.iv62 = phi i64 [ %indvars.iv.next63.prol, %for.inc63.us.preheader.new ], [ %indvars.iv.next63.1, %for.inc63.us ]
...
for.cond2.preheader.us:                           ; preds = %for.cond2.for.inc10_crit_edge.us, %entry
  %indvars.iv67 = phi i64 [ 0, %entry ], [ %indvars.iv.next68, %for.cond2.for.inc10_crit_edge.us ]
  %3 = mul nsw i64 %indvars.iv67, 1000
  br label %for.body4.us

for.body4.us:                                     ; preds = %for.inc.us, %for.cond2.preheader.us
  %indvars.iv62 = phi i64 [ 0, %for.cond2.preheader.us ], [ %indvars.iv.next63, %for.inc.us ]
  %4 = add nsw i64 %3, %indvars.iv62
  %5 = trunc i64 %4 to i32
...
for.inc.us:                                       ; preds = %for.body4.us, %if.then.us
  ...
  %arrayidx8.us = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv67, i64 %indvars.iv62
...
for.cond2.for.inc10_crit_edge.us:                 ; preds = %for.inc.us
  ...
  br i1 %exitcond71, label %for.end12, label %for.cond2.preheader.us
...
for.cond19.for.inc37_crit_edge.us:                ; preds = %for.inc34.us
  %indvars.iv.next57 = add nuw nsw i64 %indvars.iv56, 1
  %exitcond60 = icmp eq i64 %indvars.iv.next57, 1000
  br i1 %exitcond60, label %for.end39, label %for.cond19.preheader.us
...
for.cond45.for.inc63_crit_edge.us:                ; preds = %for.inc60.us
  ...
  br i1 %exitcond49, label %for.end65, label %for.cond45.preheader.us
