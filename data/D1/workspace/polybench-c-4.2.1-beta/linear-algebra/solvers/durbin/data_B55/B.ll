...
.lr.ph:                                           ; preds = %._crit_edge._crit_edge, %.lr.ph19.preheader
  %indvars.iv36 = phi i64 [ 1, %.lr.ph19.preheader ], [ %indvars.iv.next37, %._crit_edge._crit_edge ]
  %indvar = phi i64 [ 0, %.lr.ph19.preheader ], [ %14, %._crit_edge._crit_edge ]
  %.0315 = phi double [ %9, %.lr.ph19.preheader ], [ %60, %._crit_edge._crit_edge ]
  %.0414 = phi double [ 1.000000e+00, %.lr.ph19.preheader ], [ %55, %._crit_edge._crit_edge ]
  %13 = add i64 %indvar, 1
  %14 = add nuw nsw i64 %indvar, 1
  %15 = fmul double %.0315, %.0315
  %16 = add nsw i64 %indvars.iv36, -1
  %xtraiter = and i64 %13, 3
  %lcmp.mod = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod, label %._crit_edge40.prol.loopexit, label %._crit_edge40.prol.preheader

._crit_edge40.prol.preheader:                     ; preds = %.lr.ph
  br label %._crit_edge40.prol

._crit_edge40.prol:                               ; preds = %._crit_edge40.prol, %._crit_edge40.prol.preheader
  %indvars.iv.prol = phi i64 [ 0, %._crit_edge40.prol.preheader ], [ %indvars.iv.next.prol, %._crit_edge40.prol ]
  %.025.prol = phi double [ 0.000000e+00, %._crit_edge40.prol.preheader ], [ %23, %._crit_edge40.prol ]
  %prol.iter = phi i64 [ %xtraiter, %._crit_edge40.prol.preheader ], [ %prol.iter.sub, %._crit_edge40.prol ]
  ...
  %prol.iter.sub = add i64 %prol.iter, -1
  %prol.iter.cmp = icmp eq i64 %prol.iter.sub, 0
  br i1 %prol.iter.cmp, label %._crit_edge40.prol.loopexit.unr-lcssa, label %._crit_edge40.prol, !llvm.loop !3

._crit_edge40.prol.loopexit.unr-lcssa:            ; preds = %._crit_edge40.prol
  br label %._crit_edge40.prol.loopexit

._crit_edge40.prol.loopexit:                      ; preds = %.lr.ph, %._crit_edge40.prol.loopexit.unr-lcssa
  %.lcssa.unr = phi double [ undef, %.lr.ph ], [ %23, %._crit_edge40.prol.loopexit.unr-lcssa ]
  %indvars.iv.unr = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next.prol, %._crit_edge40.prol.loopexit.unr-lcssa ]
  %.025.unr = phi double [ 0.000000e+00, %.lr.ph ], [ %23, %._crit_edge40.prol.loopexit.unr-lcssa ]
  %24 = icmp ult i64 %indvar, 3
  br i1 %24, label %.lr.ph11, label %.lr.ph.new

.lr.ph.new:                                       ; preds = %._crit_edge40.prol.loopexit
  br label %._crit_edge40

._crit_edge40:                                    ; preds = %._crit_edge40, %.lr.ph.new
  %indvars.iv = phi i64 [ %indvars.iv.unr, %.lr.ph.new ], [ %indvars.iv.next.3, %._crit_edge40 ]
  %.025 = phi double [ %.025.unr, %.lr.ph.new ], [ %52, %._crit_edge40 ]
  ...
  br i1 %exitcond.3, label %.lr.ph11.unr-lcssa, label %._crit_edge40

.lr.ph11.unr-lcssa:                               ; preds = %._crit_edge40
  br label %.lr.ph11

.lr.ph11:                                         ; preds = %._crit_edge40.prol.loopexit, %.lr.ph11.unr-lcssa
  %.lcssa = phi double [ %.lcssa.unr, %._crit_edge40.prol.loopexit ], [ %52, %.lr.ph11.unr-lcssa ]
  %53 = shl i64 %indvar, 3
  %54 = fsub double 1.000000e+00, %15
  %55 = fmul double %.0414, %54
  %56 = getelementptr inbounds double, double* %1, i64 %indvars.iv36
  %57 = load double, double* %56, align 8
  %58 = fadd double %.lcssa, %57
  %59 = fsub double -0.000000e+00, %58
  %60 = fdiv double %59, %55
  %min.iters.check = icmp ult i64 %14, 4
  br i1 %min.iters.check, label %._crit_edge41.preheader, label %min.iters.checked

min.iters.checked:                                ; preds = %.lr.ph11
  %n.vec = and i64 %14, -4
  %cmp.zero = icmp eq i64 %n.vec, 0
  br i1 %cmp.zero, label %._crit_edge41.preheader, label %vector.ph

vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert47 = insertelement <2 x double> undef, double %60, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load43 = load <2 x double>, <2 x double>* %64, align 8
  %65 = sub nsw i64 %16, %index
  %66 = getelementptr inbounds double, double* %2, i64 %65
  %67 = getelementptr double, double* %66, i64 -1
  %68 = bitcast double* %67 to <2 x double>*
  %wide.load44 = load <2 x double>, <2 x double>* %68, align 8
  %reverse = shufflevector <2 x double> %wide.load44, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  ...
  %reverse46 = shufflevector <2 x double> %wide.load45, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %72 = fmul <2 x double> %broadcast.splat48, %reverse
  %73 = fmul <2 x double> %broadcast.splat48, %reverse46
  %74 = fadd <2 x double> %wide.load, %72
  %75 = fadd <2 x double> %wide.load43, %73
  %76 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 0, i64 %index
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %._crit_edge._crit_edge, label %._crit_edge41.preheader

._crit_edge41.preheader:                          ; preds = %middle.block, %min.iters.checked, %.lr.ph11
  %indvars.iv24.ph = phi i64 [ 0, %min.iters.checked ], [ 0, %.lr.ph11 ], [ %n.vec, %middle.block ]
  br label %._crit_edge41

._crit_edge41:                                    ; preds = %._crit_edge41.preheader, %._crit_edge41
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %._crit_edge41 ], [ %indvars.iv24.ph, %._crit_edge41.preheader ]
  %81 = getelementptr inbounds double, double* %2, i64 %indvars.iv24
  %82 = load double, double* %81, align 8
  %83 = sub nsw i64 %16, %indvars.iv24
  %84 = getelementptr inbounds double, double* %2, i64 %83
  %85 = load double, double* %84, align 8
  %86 = fmul double %60, %85
  %87 = fadd double %82, %86
  %88 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 0, i64 %indvars.iv24
  store double %87, double* %88, align 8
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  %exitcond29 = icmp eq i64 %indvars.iv.next25, %indvars.iv36
  br i1 %exitcond29, label %._crit_edge._crit_edge.loopexit, label %._crit_edge41, !llvm.loop !7

._crit_edge._crit_edge.loopexit:                  ; preds = %._crit_edge41
  br label %._crit_edge._crit_edge

._crit_edge._crit_edge:                           ; preds = %._crit_edge._crit_edge.loopexit, %middle.block
  %89 = add nuw nsw i64 %53, 8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull %12, i8* nonnull %11, i64 %89, i32 8, i1 false)
  %90 = getelementptr inbounds double, double* %2, i64 %indvars.iv36
  store double %60, double* %90, align 8
  %exitcond39 = icmp eq i64 %14, %wide.trip.count38
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  br i1 %exitcond39, label %._crit_edge20.loopexit, label %.lr.ph
