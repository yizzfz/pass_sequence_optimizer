...
entry:
  ...
  br i1 %cmp5, label %for.body.lr.ph, label %for.end26
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %7 = icmp sgt i32 %2, 0
  br i1 %7, label %for.body.us.preheader, label %for.body.preheader
...
for.body.us:                                      ; preds = %for.inc24.loopexit.us, %for.body.us.preheader
  %indvars.iv16 = phi i64 [ %6, %for.body.us.preheader ], [ %indvars.iv.next17, %for.inc24.loopexit.us ]
  %8 = phi i32 [ %0, %for.body.us.preheader ], [ %2, %for.inc24.loopexit.us ]
  %storemerge6.us = phi i32 [ 0, %for.body.us.preheader ], [ %15, %for.inc24.loopexit.us ]
  %rem.us = srem i32 %storemerge6.us, %8
  %conv.us = sitofp i32 %rem.us to double
  %conv1.us = sitofp i32 %8 to double
...
for.body5.us:                                     ; preds = %for.body5.us, %for.body.us
  ...
  %9 = mul nsw i64 %indvars.iv16, %indvars.iv
  %10 = add nsw i64 %9, 1
  %11 = trunc i64 %10 to i32
  %rem6.us = srem i32 %11, %2
  %conv7.us = sitofp i32 %rem6.us to double
  %arrayidx13.us = getelementptr inbounds [1300 x double], [1300 x double]* %4, i64 %indvars.iv16, i64 %indvars.iv
  %12 = mul nsw i64 %indvars.iv, %indvars.iv16
  %13 = add nsw i64 %12, 2
  ...
  %arrayidx23.us = getelementptr inbounds [1300 x double], [1300 x double]* %5, i64 %indvars.iv16, i64 %indvars.iv
  store double %div9.us.v.r2, double* %arrayidx23.us, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond, label %for.inc24.loopexit.us, label %for.body5.us

for.inc24.loopexit.us:                            ; preds = %for.body5.us
  %indvars.iv.next17 = add nsw i64 %indvars.iv16, 1
  %cmp.us = icmp slt i64 %indvars.iv.next17, %3
  %15 = trunc i64 %indvars.iv.next17 to i32
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %storemerge6 = phi i32 [ %inc25, %for.body ], [ 0, %for.body.preheader ]
  %rem = srem i32 %storemerge6, %17
  ...
  br i1 %cmp, label %for.body, label %for.cond.for.end26_crit_edge.loopexit26

for.cond.for.end26_crit_edge.loopexit:            ; preds = %for.inc24.loopexit.us
  %18 = trunc i64 %indvars.iv.next17 to i32
  br label %for.cond.for.end26_crit_edge

for.cond.for.end26_crit_edge.loopexit26:          ; preds = %for.body
  br label %for.cond.for.end26_crit_edge

for.cond.for.end26_crit_edge:                     ; preds = %for.cond.for.end26_crit_edge.loopexit26, %for.cond.for.end26_crit_edge.loopexit
  %inc25.lcssa = phi i32 [ %18, %for.cond.for.end26_crit_edge.loopexit ], [ %inc25, %for.cond.for.end26_crit_edge.loopexit26 ]
...
entry:
  ...
  %0 = load i32, i32* %n.addr, align 4
  %cmp5 = icmp sgt i32 %0, 0
  br i1 %cmp5, label %for.body.lr.ph, label %for.end41
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  br i1 %16, label %for.body.us.preheader, label %for.body.preheader
...
for.body.us:                                      ; preds = %for.end.loopexit.us, %for.body.us.preheader
  %indvars.iv20 = phi i64 [ %17, %for.body.us.preheader ], [ %indvars.iv.next21, %for.end.loopexit.us ]
  %storemerge6.us = phi i64 [ 0, %for.body.us.preheader ], [ %indvars.iv.next21, %for.end.loopexit.us ]
  %sext26 = shl i64 %storemerge6.us, 32
  %idxprom.us = ashr exact i64 %sext26, 32
  %arrayidx.us = getelementptr inbounds double, double* %1, i64 %idxprom.us
  store double 0.000000e+00, double* %arrayidx.us, align 8
  %arrayidx4.us = getelementptr inbounds double, double* %2, i64 %indvars.iv20
...
for.body7.us:                                     ; preds = %for.body7.us, %for.body.us
  ...
  %arrayidx11.us = getelementptr inbounds [1300 x double], [1300 x double]* %7, i64 %indvars.iv20, i64 %indvars.iv
  ...
  %sunkaddr35 = mul i64 %indvars.iv20, 8
  %sunkaddr36 = add i64 %10, %sunkaddr35
  %sunkaddr37 = inttoptr i64 %sunkaddr36 to double*
  %21 = load double, double* %sunkaddr37, align 8
  %add.us = fadd double %mul.us, %21
  store double %add.us, double* %sunkaddr37, align 8
  %arrayidx21.us = getelementptr inbounds [1300 x double], [1300 x double]* %11, i64 %indvars.iv20, i64 %indvars.iv
  ...
  %sunkaddr = mul i64 %indvars.iv20, 8
  %sunkaddr38 = add i64 %13, %sunkaddr
  %sunkaddr39 = inttoptr i64 %sunkaddr38 to double*
  %24 = load double, double* %sunkaddr39, align 8
  %add27.us = fadd double %mul24.us, %24
  store double %add27.us, double* %sunkaddr39, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %cmp6.us = icmp slt i64 %indvars.iv.next, %15
  br i1 %cmp6.us, label %for.body7.us, label %for.end.loopexit.us

for.end.loopexit.us:                              ; preds = %for.body7.us
  %arrayidx31.us = getelementptr inbounds double, double* %1, i64 %indvars.iv20
  %25 = load double, double* %arrayidx31.us, align 8
  %mul32.us = fmul double %5, %25
  %arrayidx34.us = getelementptr inbounds double, double* %2, i64 %indvars.iv20
  ...
  %cmp.us = icmp slt i64 %indvars.iv.next21, %18
  br i1 %cmp.us, label %for.body.us, label %for.cond.for.end41_crit_edge.loopexit

for.body:                                         ; preds = %for.body, %for.body.preheader
  %indvars.iv23 = phi i64 [ %17, %for.body.preheader ], [ %indvars.iv.next24, %for.body ]
  %storemerge6 = phi i64 [ 0, %for.body.preheader ], [ %indvars.iv.next24, %for.body ]
  %sext = shl i64 %storemerge6, 32
  %idxprom = ashr exact i64 %sext, 32
  %arrayidx = getelementptr inbounds double, double* %1, i64 %idxprom
  store double 0.000000e+00, double* %arrayidx, align 8
  %arrayidx4 = getelementptr inbounds double, double* %2, i64 %indvars.iv23
  store double 0.000000e+00, double* %arrayidx4, align 8
  %arrayidx31 = getelementptr inbounds double, double* %1, i64 %indvars.iv23
  %27 = load double, double* %arrayidx31, align 8
  %mul32 = fmul double %5, %27
  %arrayidx34 = getelementptr inbounds double, double* %2, i64 %indvars.iv23
  %add36 = fadd double %mul32, %mul35
  store double %add36, double* %arrayidx34, align 8
  %indvars.iv.next24 = add nsw i64 %indvars.iv23, 1
  %cmp = icmp slt i64 %indvars.iv.next24, %4
  br i1 %cmp, label %for.body, label %for.cond.for.end41_crit_edge.loopexit40

for.cond.for.end41_crit_edge.loopexit:            ; preds = %for.end.loopexit.us
  br label %for.cond.for.end41_crit_edge

for.cond.for.end41_crit_edge.loopexit40:          ; preds = %for.body
  br label %for.cond.for.end41_crit_edge

for.cond.for.end41_crit_edge:                     ; preds = %for.cond.for.end41_crit_edge.loopexit40, %for.cond.for.end41_crit_edge.loopexit
  %inc40.lcssa.in = phi i64 [ %indvars.iv.next21, %for.cond.for.end41_crit_edge.loopexit ], [ %indvars.iv.next24, %for.cond.for.end41_crit_edge.loopexit40 ]
...
for.body:                                         ; preds = %if.end, %for.body.lr.ph
  ...
  %storemerge2 = phi i32 [ 0, %for.body.lr.ph ], [ %11, %if.end ]
