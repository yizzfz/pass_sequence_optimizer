...
entry:
  ...
  %arraydecay13 = bitcast i8* %call to [2000 x double]*
  %arraydecay414 = bitcast i8* %call1 to double*
  %arraydecay515 = bitcast i8* %call2 to double*
  %arraydecay616 = bitcast i8* %call3 to double*
  call fastcc void @init_array([2000 x double]* %arraydecay13, double* %arraydecay414, double* %arraydecay515, double* %arraydecay616)
  call void (...) @polybench_timer_start() #4
  call fastcc void @kernel_ludcmp([2000 x double]* %arraydecay13, double* %arraydecay414, double* %arraydecay515, double* %arraydecay616)
...
for.inc:                                          ; preds = %for.inc, %entry
  %indvars.iv143 = phi i64 [ 0, %entry ], [ %indvars.iv.next144.1, %for.inc ]
  ...
  %exitcond166.1 = icmp eq i64 %indvars.iv.next144.1, 2000
  br i1 %exitcond166.1, label %for.inc25.lr.ph.preheader, label %for.inc

for.inc25.lr.ph.preheader:                        ; preds = %for.inc
  br label %for.inc25.lr.ph

for.inc25.lr.ph:                                  ; preds = %for.inc25.lr.ph.preheader, %for.inc44
  %indvars.iv141 = phi i64 [ %indvars.iv.next142, %for.inc44 ], [ 0, %for.inc25.lr.ph.preheader ]
  %5 = shl i64 %indvars.iv141, 32
  %sext = add nuw nsw i64 %5, 4294967296
  %6 = sub nsw i64 1998, %indvars.iv141
  br label %for.inc25
...
for.inc25:                                        ; preds = %for.inc25, %for.inc25.lr.ph
  %indvars.iv125 = phi i64 [ %indvars.iv.next126, %for.inc25 ], [ 0, %for.inc25.lr.ph ]
  ...
  br i1 %exitcond131, label %for.cond29.preheader, label %for.inc25
...
for.inc37.for.inc44_crit_edge:                    ; preds = %for.cond29.preheader
  ...
  %scevgep139 = getelementptr [2000 x double], [2000 x double]* %A, i64 %indvars.iv141, i64 %10
...
for.inc44:                                        ; preds = %for.cond29.preheader, %for.inc37.for.inc44_crit_edge
  ...
  %exitcond165 = icmp eq i64 %indvars.iv.next142, 2000
  br i1 %exitcond165, label %for.end46, label %for.inc25.lr.ph
...
for.inc62.us:                                     ; preds = %for.inc62.us, %for.end46
  ...
  %exitcond164.7 = icmp eq i64 %indvars.iv.next124.7, 2000
  br i1 %exitcond164.7, label %for.cond69.preheader.lr.ph, label %for.inc62.us
...
for.cond69.preheader.us.for.cond73.preheader.us.us_crit_edge: ; preds = %for.inc96.us, %for.cond69.preheader.lr.ph
  %indvars.iv117 = phi i64 [ 0, %for.cond69.preheader.lr.ph ], [ %23, %for.inc96.us ]
  %scevgep3 = getelementptr [2000 x double], [2000 x double]* %A, i64 0, i64 %indvars.iv117
  %23 = add i64 %indvars.iv117, 1
...
for.inc96.us:                                     ; preds = %for.inc93.us.us
  %exitcond163 = icmp eq i64 %23, 2000
  br i1 %exitcond163, label %for.cond103.preheader.lr.ph, label %for.cond69.preheader.us.for.cond73.preheader.us.us_crit_edge
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %29 = or i64 %index, 2
  %30 = or i64 %index, 3
  %31 = load double, double* %arrayidx80.us.us, align 8, !alias.scope !1
  %32 = insertelement <2 x double> undef, double %31, i32 0
  %33 = shufflevector <2 x double> %32, <2 x double> undef, <2 x i32> zeroinitializer
  %34 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %index, i64 %indvars.iv117
  ...
  %37 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %30, i64 %indvars.iv117
  ...
  %46 = fmul <2 x double> %33, %43
  %47 = fmul <2 x double> %33, %45
  %48 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %22, i64 0, i64 %indvars.iv115, i64 %index
  ...
  %wide.load12 = load <2 x double>, <2 x double>* %51, align 8, !alias.scope !6, !noalias !8
  %52 = fadd <2 x double> %wide.load, %46
  %53 = fadd <2 x double> %wide.load12, %47
  store <2 x double> %52, <2 x double>* %49, align 8, !alias.scope !6, !noalias !8
  store <2 x double> %53, <2 x double>* %51, align 8, !alias.scope !6, !noalias !8
  %index.next = add i64 %index, 4
  %54 = icmp eq i64 %index.next, 2000
  br i1 %54, label %for.inc93.us.us.loopexit43, label %vector.body, !llvm.loop !9
...
for.inc93.us.us:                                  ; preds = %for.inc93.us.us.loopexit43, %for.inc93.us.us.loopexit
  ...
  br i1 %exitcond162, label %for.inc96.us, label %for.cond73.preheader.us.us

for.inc90.us.us:                                  ; preds = %for.inc90.us.us, %for.inc90.us.us.preheader
  %indvars.iv111 = phi i64 [ 0, %for.inc90.us.us.preheader ], [ %indvars.iv.next112.1, %for.inc90.us.us ]
  ...
  %56 = load double, double* %arrayidx84.us.us, align 8
  %mul.us.us = fmul double %55, %56
  ...
  %57 = load double, double* %arrayidx88.us.us, align 8
  %add89.us.us = fadd double %57, %mul.us.us
  ...
  %59 = load double, double* %arrayidx84.us.us.1, align 8
  %mul.us.us.1 = fmul double %58, %59
  ...
  %60 = load double, double* %arrayidx88.us.us.1, align 8
  %add89.us.us.1 = fadd double %60, %mul.us.us.1
  store double %add89.us.us.1, double* %arrayidx88.us.us.1, align 8
  %exitcond161.1 = icmp eq i64 %indvars.iv.next112, 1999
  %indvars.iv.next112.1 = add nsw i64 %indvars.iv111, 2
  br i1 %exitcond161.1, label %for.inc93.us.us.loopexit, label %for.inc90.us.us, !llvm.loop !12

for.cond103.preheader.lr.ph:                      ; preds = %for.inc96.us
  %61 = bitcast i8* %call to [2000 x [2000 x double]]*
  %62 = bitcast i8* %call to [2000 x [2000 x double]]*
  br label %for.cond103.preheader.us

for.cond103.preheader.us:                         ; preds = %for.inc118.us, %for.cond103.preheader.lr.ph
  %indvars.iv109 = phi i64 [ 0, %for.cond103.preheader.lr.ph ], [ %63, %for.inc118.us ]
  %scevgep18 = getelementptr [2000 x double], [2000 x double]* %A, i64 %indvars.iv109, i64 0
  %scevgep1819 = bitcast double* %scevgep18 to i8*
  %63 = add i64 %indvars.iv109, 1
  %scevgep20 = getelementptr [2000 x double], [2000 x double]* %A, i64 %63, i64 0
  %scevgep2021 = bitcast double* %scevgep20 to i8*
  %64 = mul i64 %indvars.iv109, 16000
  %scevgep22 = getelementptr i8, i8* %call, i64 %64
  %65 = add i64 %64, 16000
  %scevgep23 = getelementptr i8, i8* %call, i64 %65
...
vector.body13:                                    ; preds = %vector.body13, %vector.body13.preheader
  ...
  %66 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %62, i64 0, i64 %indvars.iv109, i64 %index30
  %67 = bitcast double* %66 to <2 x i64>*
  %wide.load38 = load <2 x i64>, <2 x i64>* %67, align 8, !alias.scope !13
  %68 = getelementptr double, double* %66, i64 2
  %69 = bitcast double* %68 to <2 x i64>*
  %wide.load39 = load <2 x i64>, <2 x i64>* %69, align 8, !alias.scope !13
  %70 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv109, i64 %index30
  %71 = bitcast double* %70 to <2 x i64>*
  store <2 x i64> %wide.load38, <2 x i64>* %71, align 8, !alias.scope !16, !noalias !13
  %72 = getelementptr double, double* %70, i64 2
  %73 = bitcast double* %72 to <2 x i64>*
  store <2 x i64> %wide.load39, <2 x i64>* %73, align 8, !alias.scope !16, !noalias !13
  %index.next31 = or i64 %index30, 4
  %74 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %62, i64 0, i64 %indvars.iv109, i64 %index.next31
  %75 = bitcast double* %74 to <2 x i64>*
  %wide.load38.1 = load <2 x i64>, <2 x i64>* %75, align 8, !alias.scope !13
  %76 = getelementptr double, double* %74, i64 2
  %77 = bitcast double* %76 to <2 x i64>*
  %wide.load39.1 = load <2 x i64>, <2 x i64>* %77, align 8, !alias.scope !13
  %78 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv109, i64 %index.next31
  %79 = bitcast double* %78 to <2 x i64>*
  store <2 x i64> %wide.load38.1, <2 x i64>* %79, align 8, !alias.scope !16, !noalias !13
  %80 = getelementptr double, double* %78, i64 2
  %81 = bitcast double* %80 to <2 x i64>*
  store <2 x i64> %wide.load39.1, <2 x i64>* %81, align 8, !alias.scope !16, !noalias !13
  %index.next31.1 = add nsw i64 %index30, 8
  %82 = icmp eq i64 %index.next31.1, 2000
  br i1 %82, label %for.inc118.us.loopexit42, label %vector.body13, !llvm.loop !18
...
for.inc115.us:                                    ; preds = %for.inc115.us, %for.inc115.us.preheader
  ...
  %arrayidx110.us = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %61, i64 0, i64 %indvars.iv109, i64 %indvars.iv
  %83 = bitcast double* %arrayidx110.us to i64*
  %84 = load i64, i64* %83, align 8
  %arrayidx114.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv109, i64 %indvars.iv
  %85 = bitcast double* %arrayidx114.us to i64*
  store i64 %84, i64* %85, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx110.us.1 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %61, i64 0, i64 %indvars.iv109, i64 %indvars.iv.next
  %86 = bitcast double* %arrayidx110.us.1 to i64*
  %87 = load i64, i64* %86, align 8
  %arrayidx114.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv109, i64 %indvars.iv.next
  %88 = bitcast double* %arrayidx114.us.1 to i64*
  store i64 %87, i64* %88, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %arrayidx110.us.2 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %61, i64 0, i64 %indvars.iv109, i64 %indvars.iv.next.1
  %89 = bitcast double* %arrayidx110.us.2 to i64*
  %90 = load i64, i64* %89, align 8
  %arrayidx114.us.2 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv109, i64 %indvars.iv.next.1
  %91 = bitcast double* %arrayidx114.us.2 to i64*
  store i64 %90, i64* %91, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %arrayidx110.us.3 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %61, i64 0, i64 %indvars.iv109, i64 %indvars.iv.next.2
  %92 = bitcast double* %arrayidx110.us.3 to i64*
  %93 = load i64, i64* %92, align 8
  %arrayidx114.us.3 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv109, i64 %indvars.iv.next.2
  %94 = bitcast double* %arrayidx114.us.3 to i64*
  store i64 %93, i64* %94, align 8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %arrayidx110.us.4 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %61, i64 0, i64 %indvars.iv109, i64 %indvars.iv.next.3
  %95 = bitcast double* %arrayidx110.us.4 to i64*
  %96 = load i64, i64* %95, align 8
  %arrayidx114.us.4 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv109, i64 %indvars.iv.next.3
  %97 = bitcast double* %arrayidx114.us.4 to i64*
  store i64 %96, i64* %97, align 8
  %exitcond160.4 = icmp eq i64 %indvars.iv.next.3, 1999
  %indvars.iv.next.4 = add nsw i64 %indvars.iv, 5
  br i1 %exitcond160.4, label %for.inc118.us.loopexit, label %for.inc115.us, !llvm.loop !19
...
for.body30.us.preheader:                          ; preds = %for.inc25
  %4 = and i64 %indvars.iv156, 1
  %lcmp.mod23 = icmp eq i64 %4, 0
...
vector.body.preheader:                            ; preds = %min.iters.checked
  %6 = and i64 %2, 1
  %lcmp.mod21 = icmp eq i64 %6, 0
  br i1 %lcmp.mod21, label %vector.body.prol, label %vector.body.prol.loopexit

vector.body.prol:                                 ; preds = %vector.body.preheader
  %7 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv2, i64 %indvars.iv2
  %8 = bitcast double* %7 to <2 x i64>*
  %wide.load.prol = load <2 x i64>, <2 x i64>* %8, align 8
  %9 = getelementptr double, double* %7, i64 2
  %10 = bitcast double* %9 to <2 x i64>*
  %wide.load8.prol = load <2 x i64>, <2 x i64>* %10, align 8
  store <2 x i64> %wide.load.prol, <2 x i64>* %8, align 8
  store <2 x i64> %wide.load8.prol, <2 x i64>* %10, align 8
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader.new
  ...
  %12 = add i64 %indvars.iv2, %index
  %13 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv2, i64 %12
  ...
  %wide.load8 = load <2 x i64>, <2 x i64>* %16, align 8
  store <2 x i64> %wide.load, <2 x i64>* %14, align 8
  store <2 x i64> %wide.load8, <2 x i64>* %16, align 8
  %index.next = add i64 %index, 4
  %17 = add i64 %indvars.iv2, %index.next
  %18 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv2, i64 %17
  %19 = bitcast double* %18 to <2 x i64>*
  %wide.load.1 = load <2 x i64>, <2 x i64>* %19, align 8
  %20 = getelementptr double, double* %18, i64 2
  %21 = bitcast double* %20 to <2 x i64>*
  %wide.load8.1 = load <2 x i64>, <2 x i64>* %21, align 8
  store <2 x i64> %wide.load.1, <2 x i64>* %19, align 8
  store <2 x i64> %wide.load8.1, <2 x i64>* %21, align 8
  %index.next.1 = add i64 %index, 8
  %22 = icmp eq i64 %index.next.1, %n.vec
  br i1 %22, label %middle.block.loopexit, label %vector.body, !llvm.loop !20
...
for.body30.us:                                    ; preds = %for.body30.us.preheader, %for.inc55.us
  %indvars.iv141 = phi i64 [ %indvars.iv.next142, %for.inc55.us ], [ %indvars.iv2, %for.body30.us.preheader ]
...
for.inc48.us.prol:                                ; preds = %for.body30.us
  %24 = load double, double* %arrayidx41.us.prol, align 8
...
for.inc48.us.prol.loopexit:                       ; preds = %for.inc48.us.prol, %for.body30.us
  ...
  %w.1100.us.unr.ph = phi double [ %sub47.us.prol, %for.inc48.us.prol ], [ %23, %for.body30.us ]
...
for.inc.prol.loopexit:                            ; preds = %for.inc.prol, %for.inc.preheader
  ...
  %w.094.unr.ph = phi double [ %sub.prol, %for.inc.prol ], [ %31, %for.inc.preheader ]
  %35 = icmp eq i64 %30, 0
  br i1 %35, label %for.inc25, label %for.inc.preheader.new
...
for.inc25:                                        ; preds = %for.inc25.loopexit, %for.inc.prol.loopexit, %for.body3
  %w.0.lcssa = phi double [ %31, %for.body3 ], [ %sub.lcssa.unr.ph, %for.inc.prol.loopexit ], [ %sub.1, %for.inc25.loopexit ]
...
for.inc77.prol:                                   ; preds = %for.inc77.prol, %for.inc77.prol.preheader
  ...
  %w.287.prol = phi double [ %sub76.prol, %for.inc77.prol ], [ %44, %for.inc77.prol.preheader ]
...
for.inc77.prol.loopexit:                          ; preds = %for.inc77.prol.loopexit.loopexit, %for.inc77.preheader
  ...
  %w.287.unr = phi double [ %44, %for.inc77.preheader ], [ %sub76.prol, %for.inc77.prol.loopexit.loopexit ]
  %48 = icmp ult i64 %43, 3
  br i1 %48, label %for.inc82, label %for.inc77.preheader.new
...
for.inc82:                                        ; preds = %for.inc82.loopexit, %for.inc77.prol.loopexit, %for.body63
  %w.2.lcssa = phi double [ %44, %for.body63 ], [ %sub76.lcssa.unr, %for.inc77.prol.loopexit ], [ %sub76.3, %for.inc82.loopexit ]
...
for.inc102.prol:                                  ; preds = %for.inc102.prol, %for.inc102.prol.preheader
  ...
  %w.379.prol = phi double [ %sub101.prol, %for.inc102.prol ], [ %58, %for.inc102.prol.preheader ]
...
for.inc102.prol.loopexit:                         ; preds = %for.inc102.prol.loopexit.loopexit, %for.inc102.preheader
  ...
  %w.379.unr = phi double [ %58, %for.inc102.preheader ], [ %sub101.prol, %for.inc102.prol.loopexit.loopexit ]
  %61 = icmp ult i64 %57, 3
  br i1 %61, label %for.inc112, label %for.inc102.preheader.new
...
for.inc112:                                       ; preds = %for.inc112.loopexit, %for.inc102.prol.loopexit, %for.body88
  %w.3.lcssa = phi double [ %58, %for.body88 ], [ %sub101.lcssa.unr, %for.inc102.prol.loopexit ], [ %sub101.3, %for.inc112.loopexit ]
