...
entry:
  ...
  tail call fastcc void @init_array(double* %0, double* %1, double* %2, double* %3, [2000 x double]* %4)
  tail call void (...) @polybench_timer_start() #4
  tail call fastcc void @kernel_mvt(double* %0, double* %1, double* %2, double* %3, [2000 x double]* %4)
...
if.then:                                          ; preds = %land.lhs.true
  ...
  tail call fastcc void @print_array(double* %7, double* %6)
  br label %if.end
...
for.inc33:                                        ; preds = %for.inc33, %for.cond18.preheader
  ...
  %5 = phi double [ %add30.1, %for.inc33 ], [ %.pre17, %for.cond18.preheader ]
