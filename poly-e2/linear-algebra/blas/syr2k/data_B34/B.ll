...
for.body3.us:                                     ; preds = %for.body3.us.preheader148, %for.body3.us
  ...
  br i1 %exitcond.3, label %for.cond9.preheader.us11.preheader.loopexit, label %for.body3.us, !llvm.loop !1
...
for.cond9.preheader.us11.preheader:               ; preds = %for.cond9.preheader.us11.preheader.loopexit, %middle.block123, %for.body3.us.prol.loopexit
  %min.iters.check81 = icmp ult i64 %42, 2
  %n.vec84 = and i64 %42, -2
  %cmp.zero85 = icmp eq i64 %n.vec84, 0
  %cmp.n116 = icmp eq i64 %42, %n.vec84
  br label %for.cond9.preheader.us11

for.cond9.preheader.us11:                         ; preds = %for.cond9.preheader.us11.preheader, %for.cond9.for.inc40_crit_edge.us34
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.cond9.for.inc40_crit_edge.us34 ], [ 0, %for.cond9.preheader.us11.preheader ]
  %scevgep90 = getelementptr [1000 x double], [1000 x double]* %A, i64 0, i64 %indvars.iv46
  %4 = add i64 %indvars.iv46, 1
  %scevgep92 = getelementptr [1000 x double], [1000 x double]* %A, i64 %indvars.iv53, i64 %4
  %scevgep94 = getelementptr [1000 x double], [1000 x double]* %B, i64 0, i64 %indvars.iv46
  %scevgep96 = getelementptr [1000 x double], [1000 x double]* %B, i64 %indvars.iv53, i64 %4
  %arrayidx20.us32 = getelementptr inbounds [1000 x double], [1000 x double]* %B, i64 %indvars.iv53, i64 %indvars.iv46
  %arrayidx30.us33 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv53, i64 %indvars.iv46
  br i1 %min.iters.check81, label %for.body11.us13.preheader, label %min.iters.checked82

min.iters.checked82:                              ; preds = %for.cond9.preheader.us11
  br i1 %cmp.zero85, label %for.body11.us13.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked82
  %bound0 = icmp ult double* %scevgep, %arrayidx30.us33
  %bound1 = icmp ult double* %arrayidx30.us33, %scevgep88
  ...
  %bound0108 = icmp ult double* %scevgep, %arrayidx20.us32
  %bound1109 = icmp ult double* %arrayidx20.us32, %scevgep88
  %found.conflict110 = and i1 %bound0108, %bound1109
  %conflict.rdx111 = or i1 %conflict.rdx105, %found.conflict110
  br i1 %conflict.rdx111, label %for.body11.us13.preheader, label %vector.ph112
...
vector.body78:                                    ; preds = %vector.body78, %vector.ph112
  ...
  %5 = or i64 %index113, 1
  %6 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %index113, i64 %indvars.iv46
  %7 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %5, i64 %indvars.iv46
  ...
  %12 = fmul <2 x double> %11, %broadcast.splat121
  %13 = load double, double* %arrayidx20.us32, align 8, !alias.scope !8
  %14 = insertelement <2 x double> undef, double %13, i32 0
  %15 = shufflevector <2 x double> %14, <2 x double> undef, <2 x i32> zeroinitializer
  %16 = fmul <2 x double> %12, %15
  %17 = getelementptr inbounds [1000 x double], [1000 x double]* %B, i64 %index113, i64 %indvars.iv46
  %18 = getelementptr inbounds [1000 x double], [1000 x double]* %B, i64 %5, i64 %indvars.iv46
  ...
  %23 = fmul <2 x double> %22, %broadcast.splat121
  %24 = load double, double* %arrayidx30.us33, align 8, !alias.scope !12
  ...
  %29 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv53, i64 %index113
  ...
  %33 = icmp eq i64 %index.next114, %n.vec84
  br i1 %33, label %middle.block79, label %vector.body78, !llvm.loop !17

middle.block79:                                   ; preds = %vector.body78
  br i1 %cmp.n116, label %for.cond9.for.inc40_crit_edge.us34, label %for.body11.us13.preheader

for.body11.us13.preheader:                        ; preds = %middle.block79, %vector.memcheck, %min.iters.checked82, %for.cond9.preheader.us11
...
for.body11.us13:                                  ; preds = %for.body11.us13.preheader, %for.body11.us13
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.body11.us13 ], [ %indvars.iv41.ph, %for.body11.us13.preheader ]
  %arrayidx15.us16 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv41, i64 %indvars.iv46
  %34 = load double, double* %arrayidx15.us16, align 8
  %mul16.us17 = fmul double %34, %alpha
  %35 = load double, double* %arrayidx20.us32, align 8
  %mul21.us18 = fmul double %mul16.us17, %35
  %arrayidx25.us19 = getelementptr inbounds [1000 x double], [1000 x double]* %B, i64 %indvars.iv41, i64 %indvars.iv46
  %36 = load double, double* %arrayidx25.us19, align 8
  %mul26.us20 = fmul double %36, %alpha
  %37 = load double, double* %arrayidx30.us33, align 8
  %mul31.us21 = fmul double %mul26.us20, %37
  %add.us22 = fadd double %mul21.us18, %mul31.us21
  %arrayidx35.us23 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv53, i64 %indvars.iv41
  %38 = load double, double* %arrayidx35.us23, align 8
  %add36.us24 = fadd double %38, %add.us22
  store double %add36.us24, double* %arrayidx35.us23, align 8
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  %exitcond = icmp eq i64 %indvars.iv.next42, %indvars.iv51
  br i1 %exitcond, label %for.cond9.for.inc40_crit_edge.us34.loopexit, label %for.body11.us13, !llvm.loop !18

for.body3.lr.ph.us:                               ; preds = %for.body3.lr.ph.us.preheader, %for.cond6.for.inc43_crit_edge.us
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.cond6.for.inc43_crit_edge.us ], [ 0, %for.body3.lr.ph.us.preheader ]
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.cond6.for.inc43_crit_edge.us ], [ 1, %for.body3.lr.ph.us.preheader ]
  %39 = add i64 %indvars.iv53, -3
  %scevgep = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv53, i64 0
  %40 = mul i64 %indvars.iv53, 1201
  %41 = add i64 %40, 1
  %scevgep88 = getelementptr [1200 x double], [1200 x double]* %C, i64 0, i64 %41
  %42 = add i64 %indvars.iv53, 1
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %43 = trunc i64 %indvars.iv.next54 to i32
...
for.body3.us.prol.loopexit:                       ; preds = %for.body3.us.prol.loopexit.loopexit, %for.body3.lr.ph.us
  ...
  %45 = icmp ult i64 %indvars.iv53, 3
  br i1 %45, label %for.cond9.preheader.us11.preheader, label %for.body3.us.preheader
...
vector.body122:                                   ; preds = %vector.body122, %vector.ph130
  ...
  %55 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv53, i64 %54
  %56 = bitcast double* %55 to <8 x double>*
  %wide.vec140 = load <8 x double>, <8 x double>* %56, align 8
  ...
  %57 = fmul <2 x double> %strided.vec141, %broadcast.splat146
  %58 = fmul <2 x double> %strided.vec142, %broadcast.splat146
  %59 = fmul <2 x double> %strided.vec143, %broadcast.splat146
  %60 = add nsw i64 %54, 3
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv53, i64 %60
  %62 = fmul <2 x double> %strided.vec144, %broadcast.splat146
  ...
  %interleaved.vec147 = shufflevector <4 x double> %65, <4 x double> %66, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 1, i32 3, i32 5, i32 7>
  store <8 x double> %interleaved.vec147, <8 x double>* %64, align 8
...
for.cond9.for.inc40_crit_edge.us34.loopexit:      ; preds = %for.body11.us13
  br label %for.cond9.for.inc40_crit_edge.us34

for.cond9.for.inc40_crit_edge.us34:               ; preds = %for.cond9.for.inc40_crit_edge.us34.loopexit, %middle.block79
  %indvars.iv.next47 = add nuw nsw i64 %indvars.iv46, 1
  %exitcond49 = icmp eq i64 %indvars.iv.next47, %wide.trip.count48
  br i1 %exitcond49, label %for.cond6.for.inc43_crit_edge.us, label %for.cond9.preheader.us11

for.cond6.for.inc43_crit_edge.us:                 ; preds = %for.cond9.for.inc40_crit_edge.us34
