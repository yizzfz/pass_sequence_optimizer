...
; <label>:7:                                      ; preds = %7, %.preheader.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %7 ], [ 0, %.preheader.us ]
...
.preheader4.us:                                   ; preds = %.preheader6, %._crit_edge.us
  %indvar55 = phi i64 [ 0, %.preheader6 ], [ %indvar.next56, %._crit_edge.us ]
...
vector.body46:                                    ; preds = %vector.body46.preheader, %vector.body46
  ...
  %7 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv16, i64 %offset.idx76
  ...
  %31 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %6, i64 %offset.idx76
