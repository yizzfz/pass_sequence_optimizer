...
; <label>:2:                                      ; preds = %._crit_edge4, %1
  %indvars.iv1 = phi i64 [ 0, %1 ], [ %indvars.iv.next2, %._crit_edge4 ]
  %3 = phi i32 [ 0, %1 ], [ %22, %._crit_edge4 ]
  %4 = trunc i64 %indvars.iv1 to i32
  br label %._crit_edge3._crit_edge

._crit_edge3._crit_edge:                          ; preds = %._crit_edge3, %2
  %indvars.iv = phi i64 [ 0, %2 ], [ %indvars.iv.next, %._crit_edge3 ]
  %5 = phi i32 [ %3, %2 ], [ %4, %._crit_edge3 ]
  %6 = trunc i64 %indvars.iv to i32
  %7 = mul nsw i32 %6, %5
  %8 = srem i32 %7, 7
  %9 = add nsw i32 %8, 1
  %10 = sext i32 %5 to i64
  %11 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %10, i64 %indvars.iv
  store i32 %9, i32* %11, align 4
  %12 = add nuw nsw i64 %indvars.iv, %indvars.iv1
  ...
  %18 = srem i32 %13, 11
  %19 = icmp eq i32 %18, 0
  %or.cond10 = or i1 %or.cond, %19
  br i1 %or.cond10, label %._crit_edge, label %._crit_edge3

._crit_edge:                                      ; preds = %._crit_edge3._crit_edge
  %20 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv1, i64 %indvars.iv
  store i32 999, i32* %20, align 4
  br label %._crit_edge3

._crit_edge3:                                     ; preds = %._crit_edge3._crit_edge, %._crit_edge
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 2800
  br i1 %exitcond, label %21, label %._crit_edge3._crit_edge

; <label>:21:                                     ; preds = %._crit_edge3
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 2800
  br i1 %exitcond3, label %23, label %._crit_edge4
...
._crit_edge10:                                    ; preds = %18, %1
  %indvars.iv4 = phi i64 [ 0, %1 ], [ %indvars.iv.next5, %18 ]
  br label %._crit_edge9

._crit_edge9:                                     ; preds = %17, %._crit_edge10
  %indvars.iv1 = phi i64 [ 0, %._crit_edge10 ], [ %indvars.iv.next2, %17 ]
  %2 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv1, i64 %indvars.iv4
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge9
  %indvars.iv = phi i64 [ 0, %._crit_edge9 ], [ %indvars.iv.next.1, %._crit_edge ]
  %3 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv1, i64 %indvars.iv
  ...
  %10 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv1, i64 %indvars.iv.next
...
; <label>:17:                                     ; preds = %._crit_edge
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 2800
  br i1 %exitcond3, label %18, label %._crit_edge9

; <label>:18:                                     ; preds = %17
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1
  %exitcond6 = icmp eq i64 %indvars.iv.next5, 2800
  br i1 %exitcond6, label %19, label %._crit_edge10
