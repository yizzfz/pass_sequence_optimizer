...
; <label>:36:                                     ; preds = %37
  %exitcond13 = icmp eq i64 %indvars.iv.next4, 999
  br i1 %exitcond13, label %.lver.check40.preheader, label %.lver.check
...
.lver.check40:                                    ; preds = %.lver.check40.preheader, %111
  %indvar26 = phi i64 [ %74, %111 ], [ 0, %.lver.check40.preheader ]
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %111 ], [ 1, %.lver.check40.preheader ]
...
; <label>:111:                                    ; preds = %112
  %exitcond14 = icmp eq i64 %indvars.iv.next11, 999
  br i1 %exitcond14, label %._crit_edge16, label %.lver.check40
...
; <label>:129:                                    ; preds = %129, %.ph41
  %store_forwarded47 = phi double [ %load_initial46, %.ph41 ], [ %151, %129 ]
  %store_forwarded44 = phi double [ %load_initial43, %.ph41 ], [ %140, %129 ]
  %indvars.iv5 = phi i64 [ 1, %.ph41 ], [ %indvars.iv.next6, %129 ]
  ...
  %134 = insertelement <2 x double> undef, double %store_forwarded44, i32 0
  ...
  %149 = fmul double %store_forwarded47, 0xC08F400000000001
  ...
  br i1 %exitcond7, label %._crit_edge12.us.loopexit48, label %129

._crit_edge12.us.loopexit:                        ; preds = %.ph41.lver.orig
  br label %._crit_edge12.us

._crit_edge12.us.loopexit48:                      ; preds = %129
  br label %._crit_edge12.us
