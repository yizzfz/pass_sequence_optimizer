...
@__llvm_prf_nm = private constant [27 x i8] c"\13\19x\DAK\CA\CD\88\CF\CC\CB,aL\022\8AS\13\8B\923\00I\0B\07X", section "__llvm_prf_names"
@llvm.used = appending global [3 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_bmh_init to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_bmh_search to i8*), i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
