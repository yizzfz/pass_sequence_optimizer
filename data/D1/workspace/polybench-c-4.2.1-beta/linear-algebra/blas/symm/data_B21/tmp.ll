...
; <label>:27:                                     ; preds = %22
  ...
  %fputc.us = tail call i32 @fputc(i32 10, %struct._IO_FILE* %28) #4
  br label %29
...
; <label>:29:                                     ; preds = %27, %22
  ...
  %33 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %30, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i64 0, i64 0), double %32) #4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
; <label>:38:                                     ; preds = %._crit_edge4, %3
  ...
  %40 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %39, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #4
  %41 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %42 = tail call i64 @fwrite(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.7, i64 0, i64 0), i64 22, i64 1, %struct._IO_FILE* %41) #4
  ret void
}
