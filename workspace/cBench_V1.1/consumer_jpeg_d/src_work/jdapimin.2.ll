...
@__llvm_prf_nm = private constant [137 x i8] c"\E5\01\85\01x\DAe\8CK\0E\C20\0CD\D5\0B!\B1e\0B\F7\B0L2\A5)\F9\C9v\16\DC\9E\B4\CD\A2\88\8DGz3~k\C5\8B\EE\026<\E0J\AA\02\D5i\DD\A8\87\9A\94O\CF_\CE\CF\22\F6G\15F\89\E5\0D\A1*\C5u^\E4h\BA\DC\D3\D2\0F\06p%kK\A0\90k\B3\C9R\BD^b\BCy\CC\DC\E2YL\95%\0D\FD\BE\A5\AD\890\1Cla\A5\D4_Bg\A4\8E\F3\D8\CE!\07]N\A2/\8FTZ{", section "__llvm_prf_names"
@llvm.used = appending global [12 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_CreateDecompress to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_destroy_decompress to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_abort_decompress to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_set_marker_processor to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_read_header to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_consume_input to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_default_decompress_parms to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_input_complete to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_has_multiple_scans to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_finish_decompress to i8*), i8* bitcast ([20 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([137 x i8], [137 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
...
; <label>:51:                                     ; preds = %._crit_edge5, %._crit_edge4, %._crit_edge3, %._crit_edge2, %._crit_edge1, %._crit_edge, %1
