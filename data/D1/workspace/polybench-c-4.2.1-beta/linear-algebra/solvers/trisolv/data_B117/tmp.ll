...
.lr.ph:                                           ; preds = %._crit_edge..lr.ph_crit_edge, %.lr.ph2
  %indvars.iv8 = phi i64 [ 0, %.lr.ph2 ], [ %indvars.iv.next9, %._crit_edge..lr.ph_crit_edge ]
  %indvars.iv6 = phi i64 [ 1, %.lr.ph2 ], [ %indvars.iv.next7, %._crit_edge..lr.ph_crit_edge ]
...
._crit_edge:                                      ; preds = %.prol.loopexit.._crit_edge_crit_edge, %._crit_edge.loopexit
  ...
  br i1 %exitcond12, label %._crit_edge3, label %._crit_edge..lr.ph_crit_edge
...
._crit_edge._crit_edge:                           ; preds = %._crit_edge.._crit_edge._crit_edge_crit_edge, %.lr.ph9
  %indvars.iv17 = phi i64 [ 0, %.lr.ph9 ], [ %indvars.iv.next18, %._crit_edge.._crit_edge._crit_edge_crit_edge ]
  %4 = add nuw i64 %indvars.iv17, 4294967295
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv17
  %6 = load double, double* %5, align 8
  %7 = getelementptr inbounds double, double* %2, i64 %indvars.iv17
  store double %6, double* %7, align 8
...
.lr.ph:                                           ; preds = %._crit_edge._crit_edge
  %xtraiter20 = and i64 %indvars.iv17, 1
  %lcmp.mod = icmp eq i64 %xtraiter20, 0
  br i1 %lcmp.mod, label %.lr.ph..prol.loopexit_crit_edge, label %.prol.preheader
...
.prol.preheader:                                  ; preds = %.lr.ph
  %9 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv17, i64 0
...
.prol.loopexit:                                   ; preds = %.lr.ph..prol.loopexit_crit_edge, %.prol.preheader
  ...
  %.lcssa12.unr.ph = phi double [ %13, %.prol.preheader ], [ undef, %.lr.ph..prol.loopexit_crit_edge ]
...
.lr.ph.new:                                       ; preds = %.lr.ph.new..lr.ph.new_crit_edge, %.lr.ph.new.preheader
  ...
  %17 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv17, i64 %indvars.iv
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %23 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv17, i64 %indvars.iv.next
...
._crit_edge:                                      ; preds = %.prol.loopexit.._crit_edge_crit_edge, %._crit_edge._crit_edge.._crit_edge_crit_edge, %._crit_edge.loopexit
  %.lcssa = phi double [ %6, %._crit_edge._crit_edge.._crit_edge_crit_edge ], [ %.lcssa12.unr.ph, %.prol.loopexit.._crit_edge_crit_edge ], [ %28, %._crit_edge.loopexit ]
  %29 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv17, i64 %indvars.iv17
  %30 = load double, double* %29, align 8
  %31 = fdiv double %.lcssa, %30
  store double %31, double* %sunkaddr3, align 8
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  %exitcond22 = icmp eq i64 %indvars.iv.next18, 2000
  br i1 %exitcond22, label %._crit_edge10, label %._crit_edge.._crit_edge._crit_edge_crit_edge
...
._crit_edge:                                      ; preds = %.lr.ph.._crit_edge_crit_edge, %14
  ...
  br i1 %exitcond6, label %._crit_edge2, label %._crit_edge..lr.ph_crit_edge
