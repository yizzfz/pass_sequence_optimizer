...
.preheader62:                                     ; preds = %14, %6
  %indvars.iv19 = phi i64 [ 0, %6 ], [ %indvars.iv.next20, %14 ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %.preheader62
  %indvars.iv16 = phi i64 [ 0, %.preheader62 ], [ %indvars.iv.next17, %._crit_edge ]
...
; <label>:14:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond21, label %.preheader60.preheader, label %.preheader62

.preheader60.preheader:                           ; preds = %14
  br label %.preheader60

.preheader60:                                     ; preds = %.preheader60.preheader, %27
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %27 ], [ 0, %.preheader60.preheader ]
  br label %._crit_edge22

._crit_edge22:                                    ; preds = %._crit_edge22, %.preheader60
  %indvars.iv10 = phi i64 [ 0, %.preheader60 ], [ %indvars.iv.next11.1, %._crit_edge22 ]
  ...
  br i1 %exitcond12.1, label %27, label %._crit_edge22

; <label>:27:                                     ; preds = %._crit_edge22
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 1100
  br i1 %exitcond15, label %.preheader58.preheader, label %.preheader60

.preheader58.preheader:                           ; preds = %27
  br label %.preheader58

.preheader58:                                     ; preds = %.preheader58.preheader, %36
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %36 ], [ 0, %.preheader58.preheader ]
  br label %._crit_edge23

._crit_edge23:                                    ; preds = %._crit_edge23, %.preheader58
  %indvars.iv4 = phi i64 [ 0, %.preheader58 ], [ %indvars.iv.next5, %._crit_edge23 ]
  ...
  br i1 %exitcond6, label %36, label %._crit_edge23

; <label>:36:                                     ; preds = %._crit_edge23
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %exitcond9 = icmp eq i64 %indvars.iv.next8, 900
  br i1 %exitcond9, label %.preheader.preheader, label %.preheader58
...
._crit_edge24:                                    ; preds = %._crit_edge24, %.preheader
  ...
  br i1 %exitcond, label %44, label %._crit_edge24
...
.preheader48:                                     ; preds = %25, %7
  %indvars.iv13 = phi i64 [ 0, %7 ], [ %indvars.iv.next14, %25 ]
  br label %._crit_edge16

._crit_edge16:                                    ; preds = %24, %.preheader48
  %indvars.iv9 = phi i64 [ 0, %.preheader48 ], [ %indvars.iv.next10, %24 ]
  %8 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv13, i64 %indvars.iv9
  store double 0.000000e+00, double* %8, align 8
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge16
  %indvars.iv6 = phi i64 [ 0, %._crit_edge16 ], [ %indvars.iv.next7.1, %._crit_edge ]
  %9 = phi double [ 0.000000e+00, %._crit_edge16 ], [ %23, %._crit_edge ]
  %10 = getelementptr inbounds [1100 x double], [1100 x double]* %3, i64 %indvars.iv13, i64 %indvars.iv6
  %11 = load double, double* %10, align 8
  %12 = fmul double %11, %0
  %13 = getelementptr inbounds [900 x double], [900 x double]* %4, i64 %indvars.iv6, i64 %indvars.iv9
  %14 = load double, double* %13, align 8
  %15 = fmul double %12, %14
  %16 = fadd double %9, %15
  store double %16, double* %8, align 8
  %indvars.iv.next7 = or i64 %indvars.iv6, 1
  %17 = getelementptr inbounds [1100 x double], [1100 x double]* %3, i64 %indvars.iv13, i64 %indvars.iv.next7
  %18 = load double, double* %17, align 8
  %19 = fmul double %18, %0
  %20 = getelementptr inbounds [900 x double], [900 x double]* %4, i64 %indvars.iv.next7, i64 %indvars.iv9
  ...
  br i1 %exitcond8.1, label %24, label %._crit_edge

; <label>:24:                                     ; preds = %._crit_edge
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  %exitcond11 = icmp eq i64 %indvars.iv.next10, 900
  br i1 %exitcond11, label %25, label %._crit_edge16

; <label>:25:                                     ; preds = %24
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 800
  br i1 %exitcond15, label %.preheader.preheader, label %.preheader48

.preheader.preheader:                             ; preds = %25
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %49
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %49 ], [ 0, %.preheader.preheader ]
  br label %._crit_edge18

._crit_edge18:                                    ; preds = %48, %.preheader
  %indvars.iv1 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next2, %48 ]
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv3, i64 %indvars.iv1
...
._crit_edge17:                                    ; preds = %._crit_edge17, %._crit_edge18
  %indvars.iv = phi i64 [ 0, %._crit_edge18 ], [ %indvars.iv.next.2, %._crit_edge17 ]
  %29 = phi double [ %28, %._crit_edge18 ], [ %47, %._crit_edge17 ]
  %30 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv3, i64 %indvars.iv
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %36 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv3, i64 %indvars.iv.next
  ...
  %42 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv3, i64 %indvars.iv.next.1
  ...
  br i1 %exitcond.2, label %48, label %._crit_edge17

; <label>:48:                                     ; preds = %._crit_edge17
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond = icmp eq i64 %indvars.iv.next2, 1200
  br i1 %exitcond, label %49, label %._crit_edge18
