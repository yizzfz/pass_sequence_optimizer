...
; <label>:19:                                     ; preds = %._crit_edge14, %.lr.ph31
...
.prol.loopexit80:                                 ; preds = %.prol.loopexit80.loopexit, %.lr.ph8.us
  %indvars.iv63.unr = phi i64 [ 0, %.lr.ph8.us ], [ %16, %.prol.loopexit80.loopexit ]
...
._crit_edge14:                                    ; preds = %._crit_edge14.loopexit86, %._crit_edge14.loopexit, %19
  ...
  br i1 %exitcond, label %._crit_edge32.loopexit, label %19
...
.lr.ph9.us.us.new:                                ; preds = %.lr.ph9.us.us, %.lr.ph9.us.us.new
  %indvars.iv46 = phi i64 [ %indvars.iv.next47.1, %.lr.ph9.us.us.new ], [ 0, %.lr.ph9.us.us ]
  %6 = add nuw nsw i64 %5, %indvars.iv46
  %7 = trunc i64 %6 to i32
  %8 = srem i32 %7, 160
  %9 = sitofp i32 %8 to double
  %10 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv54, i64 %indvars.iv50, i64 %indvars.iv46
  %indvars.iv.next47 = or i64 %indvars.iv46, 1
  %11 = add nuw nsw i64 %5, %indvars.iv.next47
  ...
  br i1 %exitcond49.1, label %._crit_edge10.us.us, label %.lr.ph9.us.us.new
...
.lr.ph2.split.us.new:                             ; preds = %.lr.ph2.split.us, %.lr.ph2.split.us.new
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.lr.ph2.split.us.new ], [ 0, %.lr.ph2.split.us ]
  %19 = mul nuw nsw i64 %indvars.iv, %indvars.iv43
  %20 = trunc i64 %19 to i32
  %21 = srem i32 %20, 160
  %22 = sitofp i32 %21 to double
  %23 = getelementptr inbounds [160 x double], [160 x double]* %4, i64 %indvars.iv43, i64 %indvars.iv
  %indvars.iv.next = or i64 %indvars.iv, 1
  %24 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv43
...
._crit_edge.us:                                   ; preds = %.lr.ph2.split.us.new
  ...
  %exitcond = icmp eq i64 %indvars.iv.next44, 160
...
.lr.ph.us.us:                                     ; preds = %.lr.ph9.split.us, %._crit_edge.us.us
  ...
  %9 = add nuw nsw i64 %indvars.iv30, %8
