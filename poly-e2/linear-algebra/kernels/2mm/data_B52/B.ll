...
for.cond4.preheader:                              ; preds = %for.end27, %entry
  %indvars.iv921 = phi i64 [ 0, %entry ], [ %indvars.iv.next10, %for.end27 ]
  br label %for.body6

for.body6:                                        ; preds = %for.end, %for.cond4.preheader
  %indvars.iv720 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next8, %for.end ]
...
for.cond34.preheader:                             ; preds = %for.cond34.preheader.preheader, %for.end64
  %indvars.iv318 = phi i64 [ %indvars.iv.next4, %for.end64 ], [ 0, %for.cond34.preheader.preheader ]
  br label %for.body36

for.body36:                                       ; preds = %for.end61, %for.cond34.preheader
  %indvars.iv117 = phi i64 [ 0, %for.cond34.preheader ], [ %indvars.iv.next2, %for.end61 ]
