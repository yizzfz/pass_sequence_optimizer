...
._crit_edge25:                                    ; preds = %._crit_edge25, %.preheader11
  %indvars.iv10 = phi i64 [ 0, %.preheader11 ], [ %indvars.iv.next11.1, %._crit_edge25 ]
...
._crit_edge26:                                    ; preds = %._crit_edge26, %.preheader9
  %indvars.iv4 = phi i64 [ 0, %.preheader9 ], [ %indvars.iv.next5, %._crit_edge26 ]
...
._crit_edge20:                                    ; preds = %24, %.preheader7
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge20
  %indvars.iv7 = phi i64 [ 0, %._crit_edge20 ], [ %indvars.iv.next8.1, %._crit_edge ]
  %9 = phi double [ 0.000000e+00, %._crit_edge20 ], [ %23, %._crit_edge ]
...
; <label>:24:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond12, label %25, label %._crit_edge20
...
._crit_edge22:                                    ; preds = %48, %.preheader
...
._crit_edge21:                                    ; preds = %._crit_edge21, %._crit_edge22
  ...
  %29 = phi double [ %28, %._crit_edge22 ], [ %47, %._crit_edge21 ]
  ...
  br i1 %exitcond.2, label %48, label %._crit_edge21

; <label>:48:                                     ; preds = %._crit_edge21
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 1200
  br i1 %exitcond3, label %49, label %._crit_edge22
...
._crit_edge:                                      ; preds = %._crit_edge5, %11
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1200
  br i1 %exitcond, label %17, label %._crit_edge5
