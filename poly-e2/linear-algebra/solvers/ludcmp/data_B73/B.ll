...
for.inc:                                          ; preds = %for.inc, %entry
  ...
  %exitcond149.1 = icmp eq i64 %indvars.iv.next142, 1999
  br i1 %exitcond149.1, label %for.inc25.lr.ph.preheader, label %for.inc
...
for.inc44:                                        ; preds = %for.cond29.preheader, %for.inc37.for.inc44_crit_edge
  ...
  %exitcond165 = icmp eq i64 %indvars.iv.next140, 2000
...
for.inc62.us:                                     ; preds = %for.inc62.us, %for.end46
  ...
  %exitcond148.7 = icmp eq i64 %indvars.iv.next122.6, 1999
  br i1 %exitcond148.7, label %for.cond69.preheader.us.for.cond73.preheader.us.us_crit_edge.preheader, label %for.inc62.us
...
for.inc96.us:                                     ; preds = %for.inc93.us.us
  ...
  %exitcond164 = icmp eq i64 %indvars.iv.next116, 2000
...
for.inc93.us.us:                                  ; preds = %for.inc93.us.us.loopexit43, %for.inc93.us.us.loopexit
  ...
  %exitcond163 = icmp eq i64 %indvars.iv.next114, 2000
...
for.inc90.us.us:                                  ; preds = %for.inc90.us.us, %for.inc90.us.us.preheader
  ...
  %exitcond.1 = icmp eq i64 %indvars.iv.next110, 1999
...
for.inc115.us:                                    ; preds = %for.inc115.us, %for.inc115.us.preheader
  ...
  %exitcond147.4 = icmp eq i64 %indvars.iv.next.3, 1999
  %indvars.iv.next.4 = add nsw i64 %indvars.iv, 5
  br i1 %exitcond147.4, label %for.inc118.us.loopexit, label %for.inc115.us, !llvm.loop !19
...
for.inc118.us:                                    ; preds = %for.inc118.us.loopexit42, %for.inc118.us.loopexit
  ...
  %exitcond162 = icmp eq i64 %indvars.iv.next108, 2000
  br i1 %exitcond162, label %for.end120, label %for.cond103.preheader.us
...
for.inc:                                          ; preds = %for.inc, %for.inc.preheader.new
  ...
  %exitcond141.1 = icmp eq i64 %indvars.iv.next116, %10
...
for.body63:                                       ; preds = %for.body63.preheader, %for.inc82
  ...
  %21 = and i64 %indvars.iv136, 4294967295
...
for.inc77.preheader:                              ; preds = %for.body63
  %23 = add nsw i64 %indvars.iv136, 1
...
for.inc77:                                        ; preds = %for.inc77, %for.inc77.preheader.new
  ...
  %exitcond138.3 = icmp eq i64 %indvars.iv.next.2, %21
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
...
for.inc82:                                        ; preds = %for.inc82.loopexit, %for.inc77.prol.loopexit, %for.body63
  ...
  %indvars.iv.next114 = add nuw nsw i64 %indvars.iv113, 1
  %indvars.iv.next137 = add nuw nsw i64 %21, 1
