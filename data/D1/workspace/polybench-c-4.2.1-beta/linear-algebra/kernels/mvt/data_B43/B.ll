...
define internal fastcc void @init_array(i32, double* nocapture, double* nocapture, double* nocapture, double* nocapture, [2000 x double]* nocapture) unnamed_addr #2 {
  br i1 true, label %.lr.ph7.split.us.preheader, label %._crit_edge
...
.prol.preheader:                                  ; preds = %.lr.ph7.split.us
  %36 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv26.us, i64 0
  store double %7, double* %36, align 8
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph7.split.us
  %indvars.iv5.us.unr.ph = phi i64 [ 1, %.prol.preheader ], [ 0, %.lr.ph7.split.us ]
  br i1 false, label %..loopexit_crit_edge.us, label %.lr.ph7.split.us.new.preheader
...
.lr.ph7.split.us.new:                             ; preds = %.lr.ph7.split.us.new.preheader, %.lr.ph7.split.us.new
  ...
  %37 = mul nuw nsw i64 %indvars.iv5.us, %indvars.iv26.us
  %38 = trunc i64 %37 to i32
  %39 = srem i32 %38, 2000
  %40 = sitofp i32 %39 to double
  %41 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv26.us, i64 %indvars.iv5.us
  %indvars.iv.next.us = add nuw nsw i64 %indvars.iv5.us, 1
  %42 = mul nuw nsw i64 %indvars.iv.next.us, %indvars.iv26.us
...
define internal fastcc void @kernel_mvt(i32, double* nocapture, double* nocapture, double* nocapture readonly, double* nocapture readonly, [2000 x double]* nocapture readonly) unnamed_addr #2 {
  br i1 true, label %.preheader4.us.preheader, label %._crit_edge17
...
.preheader4.us:                                   ; preds = %._crit_edge21.us, %.preheader4.us.preheader
  ...
  %7 = getelementptr inbounds double, double* %1, i64 %indvars.iv1122.us
  br i1 true, label %.prol.loopexit27, label %.prol.preheader26

.prol.preheader26:                                ; preds = %.preheader4.us
  %8 = load double, double* %7, align 8
  %9 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv1122.us, i64 0
...
.prol.loopexit27:                                 ; preds = %.prol.preheader26, %.preheader4.us
  %indvars.iv719.us.unr.ph = phi i64 [ 1, %.prol.preheader26 ], [ 0, %.preheader4.us ]
  br i1 false, label %._crit_edge21.us, label %.preheader4.us.new.preheader
...
.preheader4.us.new:                               ; preds = %.preheader4.us.new.preheader, %.preheader4.us.new
  %14 = phi double [ %26, %.preheader4.us.new ], [ %.pre, %.preheader4.us.new.preheader ]
  %indvars.iv719.us = phi i64 [ %indvars.iv.next8.us.1, %.preheader4.us.new ], [ %indvars.iv719.us.unr.ph, %.preheader4.us.new.preheader ]
  %15 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv1122.us, i64 %indvars.iv719.us
  %16 = load double, double* %15, align 8
  %17 = getelementptr inbounds double, double* %3, i64 %indvars.iv719.us
  %18 = load double, double* %17, align 8
  %19 = fmul double %16, %18
  %20 = fadd double %14, %19
  store double %20, double* %7, align 8
  %indvars.iv.next8.us = add nuw nsw i64 %indvars.iv719.us, 1
  %21 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv1122.us, i64 %indvars.iv.next8.us
  %22 = load double, double* %21, align 8
  %23 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next8.us
...
._crit_edge21.us:                                 ; preds = %._crit_edge21.us.loopexit, %.prol.loopexit27
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  ...
  %27 = getelementptr inbounds double, double* %2, i64 %indvars.iv515.us
  br i1 true, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.preheader.us
  %28 = load double, double* %27, align 8
  %29 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 0, i64 %indvars.iv515.us
...
.prol.loopexit:                                   ; preds = %.prol.preheader, %.preheader.us
  %indvars.iv14.us.unr.ph = phi i64 [ 1, %.prol.preheader ], [ 0, %.preheader.us ]
...
.preheader.us.new:                                ; preds = %.preheader.us.new.preheader, %.preheader.us.new
  %34 = phi double [ %46, %.preheader.us.new ], [ %.pre31, %.preheader.us.new.preheader ]
  %indvars.iv14.us = phi i64 [ %indvars.iv.next.us.1, %.preheader.us.new ], [ %indvars.iv14.us.unr.ph, %.preheader.us.new.preheader ]
  %35 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv14.us, i64 %indvars.iv515.us
  %36 = load double, double* %35, align 8
  %37 = getelementptr inbounds double, double* %4, i64 %indvars.iv14.us
  %38 = load double, double* %37, align 8
  %39 = fmul double %36, %38
  %40 = fadd double %34, %39
  store double %40, double* %27, align 8
  %indvars.iv.next.us = add nuw nsw i64 %indvars.iv14.us, 1
  %41 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv.next.us, i64 %indvars.iv515.us
  %42 = load double, double* %41, align 8
  %43 = getelementptr inbounds double, double* %4, i64 %indvars.iv.next.us
