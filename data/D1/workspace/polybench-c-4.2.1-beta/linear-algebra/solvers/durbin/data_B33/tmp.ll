...
.lr.ph:                                           ; preds = %._crit_edge38, %3
  %indvars.iv56 = phi i64 [ 1, %3 ], [ %indvars.iv.next57, %._crit_edge38 ]
  %indvar = phi i64 [ 0, %3 ], [ %53, %._crit_edge38 ]
  %11 = phi double [ %10, %3 ], [ %60, %._crit_edge38 ]
  %.03039 = phi double [ 1.000000e+00, %3 ], [ %55, %._crit_edge38 ]
  %12 = add i64 %indvar, 1
  %13 = shl i64 %indvar, 3
  %14 = fmul double %11, %11
  %15 = fsub double 1.000000e+00, %14
  %16 = add nsw i64 %indvars.iv56, -1
  %xtraiter = and i64 %12, 3
  %lcmp.mod = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod, label %._crit_edge59.prol.loopexit, label %._crit_edge59.prol.preheader

._crit_edge59.prol.preheader:                     ; preds = %.lr.ph
  br label %._crit_edge59.prol

._crit_edge59.prol:                               ; preds = %._crit_edge59.prol, %._crit_edge59.prol.preheader
  %indvars.iv.prol = phi i64 [ 0, %._crit_edge59.prol.preheader ], [ %indvars.iv.next.prol, %._crit_edge59.prol ]
  %.031.prol = phi double [ 0.000000e+00, %._crit_edge59.prol.preheader ], [ %23, %._crit_edge59.prol ]
  %prol.iter = phi i64 [ %xtraiter, %._crit_edge59.prol.preheader ], [ %prol.iter.sub, %._crit_edge59.prol ]
  ...
  %23 = fadd double %.031.prol, %22
  %indvars.iv.next.prol = add nuw nsw i64 %indvars.iv.prol, 1
  %prol.iter.sub = add i64 %prol.iter, -1
  %prol.iter.cmp = icmp eq i64 %prol.iter.sub, 0
  br i1 %prol.iter.cmp, label %._crit_edge59.prol.loopexit.unr-lcssa, label %._crit_edge59.prol, !llvm.loop !1

._crit_edge59.prol.loopexit.unr-lcssa:            ; preds = %._crit_edge59.prol
  br label %._crit_edge59.prol.loopexit

._crit_edge59.prol.loopexit:                      ; preds = %.lr.ph, %._crit_edge59.prol.loopexit.unr-lcssa
  %.lcssa.unr = phi double [ undef, %.lr.ph ], [ %23, %._crit_edge59.prol.loopexit.unr-lcssa ]
  %indvars.iv.unr = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next.prol, %._crit_edge59.prol.loopexit.unr-lcssa ]
  %.031.unr = phi double [ 0.000000e+00, %.lr.ph ], [ %23, %._crit_edge59.prol.loopexit.unr-lcssa ]
  %24 = icmp ult i64 %indvar, 3
  br i1 %24, label %.lr.ph35, label %.lr.ph.new

.lr.ph.new:                                       ; preds = %._crit_edge59.prol.loopexit
  br label %._crit_edge59

._crit_edge59:                                    ; preds = %._crit_edge59, %.lr.ph.new
  %indvars.iv = phi i64 [ %indvars.iv.unr, %.lr.ph.new ], [ %indvars.iv.next.3, %._crit_edge59 ]
  %.031 = phi double [ %.031.unr, %.lr.ph.new ], [ %52, %._crit_edge59 ]
  ...
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %exitcond.3 = icmp eq i64 %indvars.iv.next.3, %indvars.iv56
  br i1 %exitcond.3, label %.lr.ph35.unr-lcssa, label %._crit_edge59

.lr.ph35.unr-lcssa:                               ; preds = %._crit_edge59
  br label %.lr.ph35

.lr.ph35:                                         ; preds = %._crit_edge59.prol.loopexit, %.lr.ph35.unr-lcssa
  %.lcssa = phi double [ %.lcssa.unr, %._crit_edge59.prol.loopexit ], [ %52, %.lr.ph35.unr-lcssa ]
  %53 = add nuw nsw i64 %indvar, 1
  %54 = add nuw nsw i64 %13, 8
  %55 = fmul double %.03039, %15
  %56 = getelementptr inbounds double, double* %1, i64 %indvars.iv56
  %57 = load double, double* %56, align 8
  %58 = fadd double %.lcssa, %57
  %59 = fsub double -0.000000e+00, %58
  %60 = fdiv double %59, %55
  %min.iters.check = icmp ult i64 %53, 4
  br i1 %min.iters.check, label %._crit_edge60.preheader, label %min.iters.checked

min.iters.checked:                                ; preds = %.lr.ph35
  %n.vec = and i64 %53, -4
  %cmp.zero = icmp eq i64 %n.vec, 0
  br i1 %cmp.zero, label %._crit_edge60.preheader, label %vector.ph

vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert66 = insertelement <2 x double> undef, double %60, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load62 = load <2 x double>, <2 x double>* %64, align 8
  %65 = sub nsw i64 %16, %index
  %66 = getelementptr inbounds double, double* %2, i64 %65
  %67 = getelementptr double, double* %66, i64 -1
  %68 = bitcast double* %67 to <2 x double>*
  %wide.load63 = load <2 x double>, <2 x double>* %68, align 8
  %reverse = shufflevector <2 x double> %wide.load63, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %69 = getelementptr double, double* %66, i64 -2
  %70 = getelementptr double, double* %69, i64 -1
  %71 = bitcast double* %70 to <2 x double>*
  %wide.load64 = load <2 x double>, <2 x double>* %71, align 8
  %reverse65 = shufflevector <2 x double> %wide.load64, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %72 = fmul <2 x double> %broadcast.splat67, %reverse
  %73 = fmul <2 x double> %broadcast.splat67, %reverse65
  %74 = fadd <2 x double> %wide.load, %72
  %75 = fadd <2 x double> %wide.load62, %73
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %._crit_edge38, label %._crit_edge60.preheader

._crit_edge60.preheader:                          ; preds = %middle.block, %min.iters.checked, %.lr.ph35
  %indvars.iv44.ph = phi i64 [ 0, %min.iters.checked ], [ 0, %.lr.ph35 ], [ %n.vec, %middle.block ]
  br label %._crit_edge60

._crit_edge60:                                    ; preds = %._crit_edge60.preheader, %._crit_edge60
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %._crit_edge60 ], [ %indvars.iv44.ph, %._crit_edge60.preheader ]
  %81 = getelementptr inbounds double, double* %2, i64 %indvars.iv44
  %82 = load double, double* %81, align 8
  %83 = sub nsw i64 %16, %indvars.iv44
  %84 = getelementptr inbounds double, double* %2, i64 %83
  %85 = load double, double* %84, align 8
  %86 = fmul double %60, %85
  %87 = fadd double %82, %86
  %88 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 0, i64 %indvars.iv44
  store double %87, double* %88, align 8
  %indvars.iv.next45 = add nuw nsw i64 %indvars.iv44, 1
  %exitcond49 = icmp eq i64 %indvars.iv.next45, %indvars.iv56
  br i1 %exitcond49, label %._crit_edge38.loopexit, label %._crit_edge60, !llvm.loop !6

._crit_edge38.loopexit:                           ; preds = %._crit_edge60
...
._crit_edge38:                                    ; preds = %._crit_edge38.loopexit, %middle.block
  ...
  %89 = getelementptr inbounds double, double* %2, i64 %indvars.iv56
  store double %60, double* %89, align 8
  %exitcond58 = icmp eq i64 %53, 1999
  %indvars.iv.next57 = add nuw nsw i64 %indvars.iv56, 1
  br i1 %exitcond58, label %90, label %.lr.ph

; <label>:90:                                     ; preds = %._crit_edge38
  ret void
}
...
._crit_edge:                                      ; preds = %._crit_edge5, %10
  ...
  br i1 %exitcond, label %16, label %._crit_edge5
