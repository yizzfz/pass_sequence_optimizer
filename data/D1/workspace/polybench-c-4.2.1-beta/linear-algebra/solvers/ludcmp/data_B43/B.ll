...
define internal fastcc void @init_array(i32, [2000 x double]*, double*, double*, double*) unnamed_addr #0 {
  ...
  %10 = icmp sgt i32 %0, 0
  br i1 %10, label %.lr.ph55, label %._crit_edge.thread
...
.lr.ph55:                                         ; preds = %5
  ...
  %xtraiter220 = and i64 %11, 1
  %lcmp.mod221 = icmp eq i64 %xtraiter220, 0
  br i1 %lcmp.mod221, label %._crit_edge66.prol.loopexit, label %._crit_edge66.prol.preheader

._crit_edge66.prol.preheader:                     ; preds = %.lr.ph55
...
._crit_edge66.prol.loopexit:                      ; preds = %.lr.ph55, %._crit_edge66.prol
  %indvars.iv122.unr = phi i64 [ 0, %.lr.ph55 ], [ 1, %._crit_edge66.prol ]
  %15 = icmp eq i32 %0, 1
  br i1 %15, label %._crit_edge, label %.lr.ph55.new

.lr.ph55.new:                                     ; preds = %._crit_edge66.prol.loopexit
  br label %._crit_edge66

._crit_edge66:                                    ; preds = %._crit_edge66, %.lr.ph55.new
  %indvars.iv122 = phi i64 [ %indvars.iv122.unr, %.lr.ph55.new ], [ %indvars.iv.next123.1, %._crit_edge66 ]
  %16 = getelementptr inbounds double, double* %3, i64 %indvars.iv122
  %17 = bitcast double* %16 to <2 x double>*
  %18 = getelementptr inbounds double, double* %4, i64 %indvars.iv122
  %19 = bitcast double* %18 to <2 x double>*
  %indvars.iv.next123 = add nuw nsw i64 %indvars.iv122, 1
  %20 = trunc i64 %indvars.iv.next123 to i32
  %21 = sitofp i32 %20 to double
  %22 = getelementptr inbounds double, double* %2, i64 %indvars.iv122
  ...
  %23 = trunc i64 %indvars.iv.next123.1 to i32
  ...
  %33 = icmp slt i64 %indvars.iv.next123.1, %11
  br i1 %33, label %._crit_edge66, label %._crit_edge.unr-lcssa

._crit_edge.unr-lcssa:                            ; preds = %._crit_edge66
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge66.prol.loopexit, %._crit_edge.unr-lcssa
  br i1 true, label %.lr.ph48, label %._crit_edge.._crit_edge67_crit_edge

._crit_edge.._crit_edge67_crit_edge:              ; preds = %._crit_edge
  br label %._crit_edge67
...
; <label>:36:                                     ; preds = %._crit_edge44, %.lr.ph48
  %indvar132 = phi i32 [ %41, %._crit_edge44 ], [ 0, %.lr.ph48 ]
  %indvars.iv120 = phi i64 [ %indvars.iv.next121, %._crit_edge44 ], [ 0, %.lr.ph48 ]
  %indvars.iv116.in = phi i32 [ %indvars.iv116, %._crit_edge44 ], [ 0, %.lr.ph48 ]
  %indvars.iv112 = phi i32 [ %indvars.iv.next113, %._crit_edge44 ], [ 0, %.lr.ph48 ]
  %37 = sub i64 %wide.trip.count, %indvars.iv120
  %38 = add i64 %37, -4
  %39 = lshr i64 %38, 2
  %40 = add nuw nsw i64 %39, 1
  %41 = add i32 %indvar132, 1
  %42 = sext i32 %41 to i64
  %43 = sub nsw i64 %35, %42
  %indvars.iv116 = add i32 %indvars.iv116.in, 1
  %44 = sext i32 %indvars.iv116 to i64
  %45 = icmp sgt i64 %indvars.iv120, -1
...
; <label>:46:                                     ; preds = %46, %.lr.ph38
  %indvars.iv108 = phi i64 [ %indvars.iv.next109, %46 ], [ 0, %.lr.ph38 ]
  %47 = sub nsw i64 0, %indvars.iv108
  %48 = trunc i64 %47 to i32
  %49 = srem i32 %48, %0
  %50 = sitofp i32 %49 to double
  %51 = fdiv double %50, %9
  %52 = fadd double %51, 1.000000e+00
  %53 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv120, i64 %indvars.iv108
  store double %52, double* %53, align 8
  %exitcond115 = icmp eq i64 %indvars.iv108, %wide.trip.count114
  %indvars.iv.next109 = add nuw nsw i64 %indvars.iv108, 1
  br i1 %exitcond115, label %._crit_edge39.loopexit, label %46
...
._crit_edge39:                                    ; preds = %._crit_edge39.loopexit, %36
  ...
  %54 = icmp slt i64 %indvars.iv.next121, %11
  br i1 %54, label %.lr.ph43.preheader, label %._crit_edge44

.lr.ph43.preheader:                               ; preds = %._crit_edge39
  %min.iters.check = icmp ult i64 %43, 4
  br i1 %min.iters.check, label %.lr.ph43.preheader205, label %min.iters.checked

min.iters.checked:                                ; preds = %.lr.ph43.preheader
  %n.vec = and i64 %43, -4
  %cmp.zero = icmp eq i64 %n.vec, 0
  %ind.end = add nsw i64 %44, %n.vec
  br i1 %cmp.zero, label %.lr.ph43.preheader205, label %vector.body.preheader

vector.body.preheader:                            ; preds = %min.iters.checked
  %xtraiter217 = and i64 %40, 3
  %lcmp.mod218 = icmp eq i64 %xtraiter217, 0
  br i1 %lcmp.mod218, label %vector.body.prol.loopexit, label %vector.body.prol.preheader
...
vector.body.prol:                                 ; preds = %vector.body.prol, %vector.body.prol.preheader
  ...
  %prol.iter219 = phi i64 [ %prol.iter219.sub, %vector.body.prol ], [ %xtraiter217, %vector.body.prol.preheader ]
  %55 = add i64 %44, %index.prol
  %56 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv120, i64 %55
  ...
  br i1 %prol.iter219.cmp, label %vector.body.prol.loopexit.unr-lcssa, label %vector.body.prol, !llvm.loop !1
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader.new
  ...
  %61 = add i64 %44, %index
  %62 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv120, i64 %61
  ...
  %67 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv120, i64 %66
  ...
  %72 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv120, i64 %71
  ...
  %77 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv120, i64 %76
...
middle.block:                                     ; preds = %vector.body.prol.loopexit, %middle.block.unr-lcssa
  ...
  br i1 %cmp.n, label %._crit_edge44, label %.lr.ph43.preheader205

.lr.ph43.preheader205:                            ; preds = %middle.block, %min.iters.checked, %.lr.ph43.preheader
  %indvars.iv118.ph = phi i64 [ %44, %min.iters.checked ], [ %44, %.lr.ph43.preheader ], [ %ind.end, %middle.block ]
  br label %.lr.ph43

.lr.ph43:                                         ; preds = %.lr.ph43.preheader205, %.lr.ph43
  %indvars.iv118 = phi i64 [ %indvars.iv.next119, %.lr.ph43 ], [ %indvars.iv118.ph, %.lr.ph43.preheader205 ]
  %82 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv120, i64 %indvars.iv118
  store double 0.000000e+00, double* %82, align 8
  %exitcond = icmp eq i64 %indvars.iv118, %wide.trip.count
...
._crit_edge44:                                    ; preds = %._crit_edge44.loopexit, %middle.block, %._crit_edge39
  %83 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv120, i64 %indvars.iv120
...
._crit_edge67:                                    ; preds = %._crit_edge.._crit_edge67_crit_edge, %._crit_edge.thread, %._crit_edge49
  %84 = call i8* @polybench_alloc_data(i64 4000000, i32 8) #5
  %85 = bitcast [2000 x [2000 x double]]** %8 to i8**
  store i8* %84, i8** %85, align 8
  %86 = bitcast i8* %84 to [2000 x [2000 x double]]*
  br i1 %10, label %.lr.ph31, label %._crit_edge71.thread

._crit_edge71.thread:                             ; preds = %._crit_edge67
  br label %.preheader

.lr.ph31:                                         ; preds = %._crit_edge67
  br i1 true, label %.lr.ph31..lr.ph31.split.us_crit_edge, label %.lr.ph31.._crit_edge71_crit_edge

.lr.ph31.._crit_edge71_crit_edge:                 ; preds = %.lr.ph31
...
.lr.ph31..lr.ph31.split.us_crit_edge:             ; preds = %.lr.ph31
  ...
  %92 = add nsw i64 %91, -1
  %xtraiter214 = and i64 %91, 3
  %lcmp.mod215 = icmp eq i64 %xtraiter214, 0
  br i1 %lcmp.mod215, label %._crit_edge27.us.prol.loopexit, label %._crit_edge27.us.prol.preheader
...
._crit_edge27.us.prol:                            ; preds = %._crit_edge27.us.prol, %._crit_edge27.us.prol.preheader
  %indvars.iv105.prol = phi i64 [ %indvars.iv.next106.prol, %._crit_edge27.us.prol ], [ 0, %._crit_edge27.us.prol.preheader ]
  %indvar.prol = phi i64 [ %indvar.next.prol, %._crit_edge27.us.prol ], [ 0, %._crit_edge27.us.prol.preheader ]
  %prol.iter216 = phi i64 [ %prol.iter216.sub, %._crit_edge27.us.prol ], [ %xtraiter214, %._crit_edge27.us.prol.preheader ]
  %scevgep.prol = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %86, i64 0, i64 %indvar.prol, i64 0
  %scevgep104.prol = bitcast double* %scevgep.prol to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep104.prol, i8 0, i64 %90, i32 8, i1 false)
  ...
  br i1 %prol.iter216.cmp, label %._crit_edge27.us.prol.loopexit.unr-lcssa, label %._crit_edge27.us.prol, !llvm.loop !8
...
._crit_edge27.us.prol.loopexit:                   ; preds = %.lr.ph31..lr.ph31.split.us_crit_edge, %._crit_edge27.us.prol.loopexit.unr-lcssa
  %indvars.iv105.unr = phi i64 [ 0, %.lr.ph31..lr.ph31.split.us_crit_edge ], [ %indvars.iv.next106.prol, %._crit_edge27.us.prol.loopexit.unr-lcssa ]
  ...
  br i1 %93, label %._crit_edge71.loopexit, label %.lr.ph31..lr.ph31.split.us_crit_edge.new
...
._crit_edge27.us:                                 ; preds = %._crit_edge27.us, %.lr.ph31..lr.ph31.split.us_crit_edge.new
  %indvars.iv105 = phi i64 [ %indvars.iv105.unr, %.lr.ph31..lr.ph31.split.us_crit_edge.new ], [ %indvars.iv.next106.3, %._crit_edge27.us ]
  ...
  call void @llvm.memset.p0i8.i64(i8* %scevgep104, i8 0, i64 %90, i32 8, i1 false)
  ...
  call void @llvm.memset.p0i8.i64(i8* %scevgep104.1, i8 0, i64 %90, i32 8, i1 false)
  ...
  call void @llvm.memset.p0i8.i64(i8* %scevgep104.2, i8 0, i64 %90, i32 8, i1 false)
  ...
  call void @llvm.memset.p0i8.i64(i8* %scevgep104.3, i8 0, i64 %90, i32 8, i1 false)
  %indvars.iv.next106.3 = add i64 %indvars.iv105, 4
  %94 = icmp slt i64 %indvars.iv.next106.3, %91
  %indvar.next.3 = add i64 %indvar, 4
  br i1 %94, label %._crit_edge27.us, label %._crit_edge71.loopexit.unr-lcssa

._crit_edge71.loopexit.unr-lcssa:                 ; preds = %._crit_edge27.us
  br label %._crit_edge71.loopexit

._crit_edge71.loopexit:                           ; preds = %._crit_edge27.us.prol.loopexit, %._crit_edge71.loopexit.unr-lcssa
  %.pr130.pre = load i32, i32* %6, align 4
  br label %._crit_edge71

._crit_edge71:                                    ; preds = %.lr.ph31.._crit_edge71_crit_edge, %._crit_edge71.loopexit
  %95 = phi i32 [ %0, %.lr.ph31.._crit_edge71_crit_edge ], [ %.pr130.pre, %._crit_edge71.loopexit ]
  %96 = icmp sgt i32 %95, 0
  br i1 %96, label %.preheader1.lr.ph, label %.preheader

.preheader1.lr.ph:                                ; preds = %._crit_edge71
  %97 = load [2000 x double]*, [2000 x double]** %7, align 8
  %98 = load [2000 x [2000 x double]]*, [2000 x [2000 x double]]** %8, align 8
  br i1 true, label %.preheader1.lr.ph..preheader1.us_crit_edge, label %.preheader1.preheader

.preheader1.preheader:                            ; preds = %.preheader1.lr.ph
  br i1 undef, label %.preheader1.prol.preheader, label %.preheader1.prol.loopexit
...
.preheader1.prol:                                 ; preds = %.preheader1.prol, %.preheader1.prol.preheader
  br i1 false, label %.preheader1.prol, label %.preheader1.prol.loopexit.unr-lcssa, !llvm.loop !9

.preheader1.prol.loopexit.unr-lcssa:              ; preds = %.preheader1.prol
  br label %.preheader1.prol.loopexit

.preheader1.prol.loopexit:                        ; preds = %.preheader1.prol.loopexit.unr-lcssa, %.preheader1.preheader
  br i1 undef, label %..preheader_crit_edge.loopexit, label %.preheader1.preheader.new
...
.preheader1.lr.ph..preheader1.us_crit_edge:       ; preds = %.preheader1.lr.ph
  ...
  %wide.trip.count96 = zext i32 %99 to i64
  %101 = add nuw nsw i64 %wide.trip.count96, 1
  %102 = add nuw nsw i64 %wide.trip.count96, 1
  %min.iters.check138 = icmp ult i64 %101, 4
  %n.vec141 = and i64 %101, 8589934588
  %cmp.zero142 = icmp eq i64 %n.vec141, 0
  %cmp.n164 = icmp eq i64 %101, %n.vec141
  br label %.preheader1.us

.preheader1.us:                                   ; preds = %._crit_edge14.us-lcssa.us.us, %.preheader1.lr.ph..preheader1.us_crit_edge
  %indvar150 = phi i64 [ %103, %._crit_edge14.us-lcssa.us.us ], [ 0, %.preheader1.lr.ph..preheader1.us_crit_edge ]
  %indvars.iv100 = phi i64 [ %indvars.iv.next101, %._crit_edge14.us-lcssa.us.us ], [ 0, %.preheader1.lr.ph..preheader1.us_crit_edge ]
  %scevgep152 = getelementptr [2000 x double], [2000 x double]* %97, i64 0, i64 %indvar150
  %103 = add i64 %indvar150, 1
  %scevgep154 = getelementptr [2000 x double], [2000 x double]* %97, i64 %wide.trip.count96, i64 %103
  br i1 true, label %.lr.ph13.us, label %.preheader1.us.._crit_edge14.us-lcssa.us.us_crit_edge

.preheader1.us.._crit_edge14.us-lcssa.us.us_crit_edge: ; preds = %.preheader1.us
  br label %._crit_edge14.us-lcssa.us.us

.lr.ph13.us:                                      ; preds = %.preheader1.us
  br label %.lr.ph10.us.us

._crit_edge14.us-lcssa.us.us.loopexit:            ; preds = %._crit_edge11.us.us
  br label %._crit_edge14.us-lcssa.us.us

._crit_edge14.us-lcssa.us.us:                     ; preds = %.preheader1.us.._crit_edge14.us-lcssa.us.us_crit_edge, %._crit_edge14.us-lcssa.us.us.loopexit
  %indvars.iv.next101 = add i64 %indvars.iv100, 1
  %104 = icmp slt i64 %indvars.iv.next101, %100
  br i1 %104, label %.preheader1.us, label %._crit_edge14.us-lcssa.us.us...preheader_crit_edge_crit_edge

._crit_edge14.us-lcssa.us.us...preheader_crit_edge_crit_edge: ; preds = %._crit_edge14.us-lcssa.us.us
  br label %..preheader_crit_edge

.lr.ph10.us.us:                                   ; preds = %._crit_edge11.us.us, %.lr.ph13.us
  %indvar144 = phi i64 [ %indvar.next145, %._crit_edge11.us.us ], [ 0, %.lr.ph13.us ]
  %indvars.iv98 = phi i64 [ %indvars.iv.next99, %._crit_edge11.us.us ], [ 0, %.lr.ph13.us ]
  %scevgep146 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %98, i64 0, i64 %indvar144, i64 0
  %scevgep148 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %98, i64 0, i64 %indvar144, i64 %101
  %105 = getelementptr inbounds [2000 x double], [2000 x double]* %97, i64 %indvars.iv98, i64 %indvars.iv100
  br i1 %min.iters.check138, label %scalar.ph137.preheader, label %min.iters.checked139

scalar.ph137.preheader:                           ; preds = %middle.block136, %vector.memcheck, %min.iters.checked139, %.lr.ph10.us.us
  %indvars.iv94.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %min.iters.checked139 ], [ 0, %.lr.ph10.us.us ], [ %n.vec141, %middle.block136 ]
  %106 = sub nsw i64 %102, %indvars.iv94.ph
  %xtraiter209 = and i64 %106, 1
  %lcmp.mod210 = icmp eq i64 %xtraiter209, 0
  br i1 %lcmp.mod210, label %scalar.ph137.prol.loopexit.unr-lcssa, label %scalar.ph137.prol.preheader

scalar.ph137.prol.preheader:                      ; preds = %scalar.ph137.preheader
  br label %scalar.ph137.prol

scalar.ph137.prol:                                ; preds = %scalar.ph137.prol.preheader
  %107 = load double, double* %105, align 8
  %108 = getelementptr inbounds [2000 x double], [2000 x double]* %97, i64 %indvars.iv94.ph, i64 %indvars.iv100
  %109 = load double, double* %108, align 8
  %110 = fmul double %107, %109
  %111 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %98, i64 0, i64 %indvars.iv98, i64 %indvars.iv94.ph
  %112 = load double, double* %111, align 8
  %113 = fadd double %110, %112
  store double %113, double* %111, align 8
  %indvars.iv.next95.prol = or i64 %indvars.iv94.ph, 1
  br label %scalar.ph137.prol.loopexit.unr-lcssa

scalar.ph137.prol.loopexit.unr-lcssa:             ; preds = %scalar.ph137.preheader, %scalar.ph137.prol
  %indvars.iv94.unr.ph = phi i64 [ %indvars.iv.next95.prol, %scalar.ph137.prol ], [ %indvars.iv94.ph, %scalar.ph137.preheader ]
  br label %scalar.ph137.prol.loopexit

scalar.ph137.prol.loopexit:                       ; preds = %scalar.ph137.prol.loopexit.unr-lcssa
  %114 = icmp eq i64 %wide.trip.count96, %indvars.iv94.ph
  br i1 %114, label %._crit_edge11.us.us.loopexit, label %scalar.ph137.preheader.new

scalar.ph137.preheader.new:                       ; preds = %scalar.ph137.prol.loopexit
  br label %scalar.ph137

min.iters.checked139:                             ; preds = %.lr.ph10.us.us
  br i1 %cmp.zero142, label %scalar.ph137.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked139
  %bound0 = icmp ult double* %scevgep146, %scevgep154
  %bound1 = icmp ult double* %scevgep152, %scevgep148
  %found.conflict = and i1 %bound0, %bound1
  %bound0157 = icmp ult double* %scevgep146, %105
  %bound1158 = icmp ult double* %105, %scevgep148
  %found.conflict159 = and i1 %bound0157, %bound1158
  %conflict.rdx = or i1 %found.conflict, %found.conflict159
  br i1 %conflict.rdx, label %scalar.ph137.preheader, label %vector.body135.preheader

vector.body135.preheader:                         ; preds = %vector.memcheck
...
vector.body135:                                   ; preds = %vector.body135.preheader, %vector.body135
  ...
  %115 = or i64 %index161, 1
  %116 = or i64 %index161, 2
  %117 = or i64 %index161, 3
  ...
  %121 = getelementptr inbounds [2000 x double], [2000 x double]* %97, i64 %index161, i64 %indvars.iv100
  %122 = getelementptr inbounds [2000 x double], [2000 x double]* %97, i64 %115, i64 %indvars.iv100
  %123 = getelementptr inbounds [2000 x double], [2000 x double]* %97, i64 %116, i64 %indvars.iv100
  %124 = getelementptr inbounds [2000 x double], [2000 x double]* %97, i64 %117, i64 %indvars.iv100
  ...
  %135 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %98, i64 0, i64 %indvars.iv98, i64 %index161
  ...
  %wide.load169 = load <2 x double>, <2 x double>* %138, align 8, !alias.scope !15, !noalias !17
  %139 = fadd <2 x double> %133, %wide.load
  %140 = fadd <2 x double> %134, %wide.load169
  ...
  %141 = icmp eq i64 %index.next162, %n.vec141
  br i1 %141, label %middle.block136, label %vector.body135, !llvm.loop !18

middle.block136:                                  ; preds = %vector.body135
  br i1 %cmp.n164, label %._crit_edge11.us.us, label %scalar.ph137.preheader

._crit_edge11.us.us.loopexit.unr-lcssa:           ; preds = %scalar.ph137
  br label %._crit_edge11.us.us.loopexit

._crit_edge11.us.us.loopexit:                     ; preds = %scalar.ph137.prol.loopexit, %._crit_edge11.us.us.loopexit.unr-lcssa
  br label %._crit_edge11.us.us

._crit_edge11.us.us:                              ; preds = %._crit_edge11.us.us.loopexit, %middle.block136
  %indvars.iv.next99 = add i64 %indvars.iv98, 1
  %142 = icmp slt i64 %indvars.iv.next99, %100
  %indvar.next145 = add i64 %indvar144, 1
  br i1 %142, label %.lr.ph10.us.us, label %._crit_edge14.us-lcssa.us.us.loopexit

scalar.ph137:                                     ; preds = %scalar.ph137, %scalar.ph137.preheader.new
  %indvars.iv94 = phi i64 [ %indvars.iv94.unr.ph, %scalar.ph137.preheader.new ], [ %indvars.iv.next95.1, %scalar.ph137 ]
  %143 = load double, double* %105, align 8
  %144 = getelementptr inbounds [2000 x double], [2000 x double]* %97, i64 %indvars.iv94, i64 %indvars.iv100
  %145 = load double, double* %144, align 8
  %146 = fmul double %143, %145
  %147 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %98, i64 0, i64 %indvars.iv98, i64 %indvars.iv94
  %148 = load double, double* %147, align 8
  %149 = fadd double %146, %148
  store double %149, double* %147, align 8
  %indvars.iv.next95 = add nuw nsw i64 %indvars.iv94, 1
  %150 = load double, double* %105, align 8
  %151 = getelementptr inbounds [2000 x double], [2000 x double]* %97, i64 %indvars.iv.next95, i64 %indvars.iv100
  %152 = load double, double* %151, align 8
  %153 = fmul double %150, %152
  %154 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %98, i64 0, i64 %indvars.iv98, i64 %indvars.iv.next95
  ...
  br i1 %exitcond97.1, label %._crit_edge11.us.us.loopexit.unr-lcssa, label %scalar.ph137, !llvm.loop !19

.preheader1:                                      ; preds = %.preheader1, %.preheader1.preheader.new
  br i1 false, label %.preheader1, label %..preheader_crit_edge.loopexit.unr-lcssa

..preheader_crit_edge.loopexit.unr-lcssa:         ; preds = %.preheader1
  br label %..preheader_crit_edge.loopexit

..preheader_crit_edge.loopexit:                   ; preds = %.preheader1.prol.loopexit, %..preheader_crit_edge.loopexit.unr-lcssa
  br label %..preheader_crit_edge

..preheader_crit_edge:                            ; preds = %..preheader_crit_edge.loopexit, %._crit_edge14.us-lcssa.us.us...preheader_crit_edge_crit_edge
  br label %.preheader

.preheader:                                       ; preds = %._crit_edge71, %._crit_edge71.thread, %..preheader_crit_edge
  %157 = phi i32 [ %95, %._crit_edge71 ], [ %0, %._crit_edge71.thread ], [ %95, %..preheader_crit_edge ]
  %158 = icmp sgt i32 %157, 0
  br i1 %158, label %.lr.ph3, label %.preheader..preheader._crit_edge_crit_edge
...
.lr.ph3:                                          ; preds = %.preheader
  ...
  br i1 true, label %.lr.ph3..lr.ph3.split.us_crit_edge, label %.lr.ph3.split.._crit_edge4_crit_edge

.lr.ph3..lr.ph3.split.us_crit_edge:               ; preds = %.lr.ph3
  %162 = add i32 %157, -1
  %163 = sext i32 %157 to i64
  %wide.trip.count90 = zext i32 %162 to i64
  %164 = add nuw nsw i64 %wide.trip.count90, 1
  %165 = and i64 %164, 8589934588
  %166 = add nsw i64 %165, -4
  %167 = lshr exact i64 %166, 2
  %168 = add nuw nsw i64 %wide.trip.count90, 1
  %min.iters.check173 = icmp ult i64 %164, 4
  %n.vec176 = and i64 %164, 8589934588
  %cmp.zero177 = icmp eq i64 %n.vec176, 0
  %169 = and i64 %167, 1
  %lcmp.mod = icmp eq i64 %169, 0
  %170 = icmp eq i64 %167, 0
  %cmp.n198 = icmp eq i64 %164, %n.vec176
  br label %.lr.ph3.split.us

.lr.ph3.split.us:                                 ; preds = %._crit_edge.us, %.lr.ph3..lr.ph3.split.us_crit_edge
  %indvar179 = phi i64 [ %indvar.next180, %._crit_edge.us ], [ 0, %.lr.ph3..lr.ph3.split.us_crit_edge ]
  %indvars.iv92 = phi i64 [ %indvars.iv.next93, %._crit_edge.us ], [ 0, %.lr.ph3..lr.ph3.split.us_crit_edge ]
  %scevgep181 = getelementptr [2000 x double], [2000 x double]* %160, i64 %indvar179, i64 0
  %scevgep183 = getelementptr [2000 x double], [2000 x double]* %160, i64 %indvar179, i64 %164
  %scevgep185 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %159, i64 0, i64 %indvar179, i64 0
  %scevgep187 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %159, i64 0, i64 %indvar179, i64 %164
  br i1 %min.iters.check173, label %scalar.ph172.preheader, label %min.iters.checked174

min.iters.checked174:                             ; preds = %.lr.ph3.split.us
  br i1 %cmp.zero177, label %scalar.ph172.preheader, label %vector.memcheck193

vector.memcheck193:                               ; preds = %min.iters.checked174
  ...
  br i1 %memcheck.conflict192, label %scalar.ph172.preheader, label %vector.body170.preheader

vector.body170.preheader:                         ; preds = %vector.memcheck193
  br i1 %lcmp.mod, label %vector.body170.prol.preheader, label %vector.body170.prol.loopexit.unr-lcssa

vector.body170.prol.preheader:                    ; preds = %vector.body170.preheader
  br label %vector.body170.prol

vector.body170.prol:                              ; preds = %vector.body170.prol.preheader
  %171 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %159, i64 0, i64 %indvars.iv92, i64 0
  %172 = bitcast double* %171 to <2 x i64>*
  %wide.load203.prol = load <2 x i64>, <2 x i64>* %172, align 8, !alias.scope !20
  %173 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %159, i64 0, i64 %indvars.iv92, i64 2
  %174 = bitcast double* %173 to <2 x i64>*
  %wide.load204.prol = load <2 x i64>, <2 x i64>* %174, align 8, !alias.scope !20
  %175 = getelementptr inbounds [2000 x double], [2000 x double]* %160, i64 %indvars.iv92, i64 0
  %176 = bitcast double* %175 to <2 x i64>*
  store <2 x i64> %wide.load203.prol, <2 x i64>* %176, align 8, !alias.scope !23, !noalias !20
  %177 = getelementptr [2000 x double], [2000 x double]* %160, i64 %indvars.iv92, i64 2
  %178 = bitcast double* %177 to <2 x i64>*
  store <2 x i64> %wide.load204.prol, <2 x i64>* %178, align 8, !alias.scope !23, !noalias !20
  br label %vector.body170.prol.loopexit.unr-lcssa

vector.body170.prol.loopexit.unr-lcssa:           ; preds = %vector.body170.preheader, %vector.body170.prol
  %index195.unr.ph = phi i64 [ 4, %vector.body170.prol ], [ 0, %vector.body170.preheader ]
  br label %vector.body170.prol.loopexit

vector.body170.prol.loopexit:                     ; preds = %vector.body170.prol.loopexit.unr-lcssa
  br i1 %170, label %middle.block171, label %vector.body170.preheader.new

vector.body170.preheader.new:                     ; preds = %vector.body170.prol.loopexit
  br label %vector.body170

vector.body170:                                   ; preds = %vector.body170, %vector.body170.preheader.new
  %index195 = phi i64 [ %index195.unr.ph, %vector.body170.preheader.new ], [ %index.next196.1, %vector.body170 ]
  %179 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %159, i64 0, i64 %indvars.iv92, i64 %index195
  %180 = bitcast double* %179 to <2 x i64>*
  %wide.load203 = load <2 x i64>, <2 x i64>* %180, align 8, !alias.scope !20
  %181 = getelementptr double, double* %179, i64 2
  %182 = bitcast double* %181 to <2 x i64>*
  %wide.load204 = load <2 x i64>, <2 x i64>* %182, align 8, !alias.scope !20
  %183 = getelementptr inbounds [2000 x double], [2000 x double]* %160, i64 %indvars.iv92, i64 %index195
  %184 = bitcast double* %183 to <2 x i64>*
  store <2 x i64> %wide.load203, <2 x i64>* %184, align 8, !alias.scope !23, !noalias !20
  %185 = getelementptr double, double* %183, i64 2
  %186 = bitcast double* %185 to <2 x i64>*
  store <2 x i64> %wide.load204, <2 x i64>* %186, align 8, !alias.scope !23, !noalias !20
  %index.next196 = add i64 %index195, 4
  %187 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %159, i64 0, i64 %indvars.iv92, i64 %index.next196
  %188 = bitcast double* %187 to <2 x i64>*
  %wide.load203.1 = load <2 x i64>, <2 x i64>* %188, align 8, !alias.scope !20
  %189 = getelementptr double, double* %187, i64 2
  %190 = bitcast double* %189 to <2 x i64>*
  %wide.load204.1 = load <2 x i64>, <2 x i64>* %190, align 8, !alias.scope !20
  %191 = getelementptr inbounds [2000 x double], [2000 x double]* %160, i64 %indvars.iv92, i64 %index.next196
  %192 = bitcast double* %191 to <2 x i64>*
  store <2 x i64> %wide.load203.1, <2 x i64>* %192, align 8, !alias.scope !23, !noalias !20
  %193 = getelementptr double, double* %191, i64 2
  %194 = bitcast double* %193 to <2 x i64>*
  store <2 x i64> %wide.load204.1, <2 x i64>* %194, align 8, !alias.scope !23, !noalias !20
  %index.next196.1 = add i64 %index195, 8
  %195 = icmp eq i64 %index.next196.1, %n.vec176
  br i1 %195, label %middle.block171.unr-lcssa, label %vector.body170, !llvm.loop !25

middle.block171.unr-lcssa:                        ; preds = %vector.body170
  br label %middle.block171

middle.block171:                                  ; preds = %vector.body170.prol.loopexit, %middle.block171.unr-lcssa
  br i1 %cmp.n198, label %._crit_edge.us, label %scalar.ph172.preheader

scalar.ph172.preheader:                           ; preds = %middle.block171, %vector.memcheck193, %min.iters.checked174, %.lr.ph3.split.us
  %indvars.iv.ph = phi i64 [ 0, %vector.memcheck193 ], [ 0, %min.iters.checked174 ], [ 0, %.lr.ph3.split.us ], [ %n.vec176, %middle.block171 ]
  %196 = sub nsw i64 %168, %indvars.iv.ph
  %197 = sub nsw i64 %wide.trip.count90, %indvars.iv.ph
  %xtraiter207 = and i64 %196, 3
  %lcmp.mod208 = icmp eq i64 %xtraiter207, 0
  br i1 %lcmp.mod208, label %scalar.ph172.prol.loopexit, label %scalar.ph172.prol.preheader

scalar.ph172.prol.preheader:                      ; preds = %scalar.ph172.preheader
  br label %scalar.ph172.prol

scalar.ph172.prol:                                ; preds = %scalar.ph172.prol, %scalar.ph172.prol.preheader
  %indvars.iv.prol = phi i64 [ %indvars.iv.next.prol, %scalar.ph172.prol ], [ %indvars.iv.ph, %scalar.ph172.prol.preheader ]
  %prol.iter = phi i64 [ %prol.iter.sub, %scalar.ph172.prol ], [ %xtraiter207, %scalar.ph172.prol.preheader ]
  %198 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %159, i64 0, i64 %indvars.iv92, i64 %indvars.iv.prol
  %199 = bitcast double* %198 to i64*
  %200 = load i64, i64* %199, align 8
  %201 = getelementptr inbounds [2000 x double], [2000 x double]* %160, i64 %indvars.iv92, i64 %indvars.iv.prol
  %202 = bitcast double* %201 to i64*
  store i64 %200, i64* %202, align 8
  %indvars.iv.next.prol = add nuw nsw i64 %indvars.iv.prol, 1
  %prol.iter.sub = add i64 %prol.iter, -1
  %prol.iter.cmp = icmp eq i64 %prol.iter.sub, 0
  br i1 %prol.iter.cmp, label %scalar.ph172.prol.loopexit.unr-lcssa, label %scalar.ph172.prol, !llvm.loop !26

scalar.ph172.prol.loopexit.unr-lcssa:             ; preds = %scalar.ph172.prol
  br label %scalar.ph172.prol.loopexit

scalar.ph172.prol.loopexit:                       ; preds = %scalar.ph172.preheader, %scalar.ph172.prol.loopexit.unr-lcssa
  %indvars.iv.unr = phi i64 [ %indvars.iv.ph, %scalar.ph172.preheader ], [ %indvars.iv.next.prol, %scalar.ph172.prol.loopexit.unr-lcssa ]
  %203 = icmp ult i64 %197, 3
  br i1 %203, label %._crit_edge.us.loopexit, label %scalar.ph172.preheader.new

scalar.ph172.preheader.new:                       ; preds = %scalar.ph172.prol.loopexit
  br label %scalar.ph172

scalar.ph172:                                     ; preds = %scalar.ph172, %scalar.ph172.preheader.new
  %indvars.iv = phi i64 [ %indvars.iv.unr, %scalar.ph172.preheader.new ], [ %indvars.iv.next.3, %scalar.ph172 ]
  %204 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %159, i64 0, i64 %indvars.iv92, i64 %indvars.iv
  %205 = bitcast double* %204 to i64*
  %206 = load i64, i64* %205, align 8
  %207 = getelementptr inbounds [2000 x double], [2000 x double]* %160, i64 %indvars.iv92, i64 %indvars.iv
  %208 = bitcast double* %207 to i64*
  store i64 %206, i64* %208, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %209 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %159, i64 0, i64 %indvars.iv92, i64 %indvars.iv.next
  %210 = bitcast double* %209 to i64*
  %211 = load i64, i64* %210, align 8
  %212 = getelementptr inbounds [2000 x double], [2000 x double]* %160, i64 %indvars.iv92, i64 %indvars.iv.next
  %213 = bitcast double* %212 to i64*
  store i64 %211, i64* %213, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %214 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %159, i64 0, i64 %indvars.iv92, i64 %indvars.iv.next.1
  %215 = bitcast double* %214 to i64*
  %216 = load i64, i64* %215, align 8
  %217 = getelementptr inbounds [2000 x double], [2000 x double]* %160, i64 %indvars.iv92, i64 %indvars.iv.next.1
  %218 = bitcast double* %217 to i64*
  store i64 %216, i64* %218, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %219 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %159, i64 0, i64 %indvars.iv92, i64 %indvars.iv.next.2
  %220 = bitcast double* %219 to i64*
  %221 = load i64, i64* %220, align 8
  %222 = getelementptr inbounds [2000 x double], [2000 x double]* %160, i64 %indvars.iv92, i64 %indvars.iv.next.2
  %223 = bitcast double* %222 to i64*
  store i64 %221, i64* %223, align 8
  %exitcond91.3 = icmp eq i64 %indvars.iv.next.2, %wide.trip.count90
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  br i1 %exitcond91.3, label %._crit_edge.us.loopexit.unr-lcssa, label %scalar.ph172, !llvm.loop !27

._crit_edge.us.loopexit.unr-lcssa:                ; preds = %scalar.ph172
  br label %._crit_edge.us.loopexit

._crit_edge.us.loopexit:                          ; preds = %scalar.ph172.prol.loopexit, %._crit_edge.us.loopexit.unr-lcssa
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %middle.block171
  %indvars.iv.next93 = add i64 %indvars.iv92, 1
  %224 = icmp slt i64 %indvars.iv.next93, %163
  %indvar.next180 = add i64 %indvar179, 1
  br i1 %224, label %.lr.ph3.split.us, label %._crit_edge.us.._crit_edge4_crit_edge

._crit_edge.us.._crit_edge4_crit_edge:            ; preds = %._crit_edge.us
  br label %._crit_edge4

.lr.ph3.split.._crit_edge4_crit_edge:             ; preds = %.lr.ph3
  br label %._crit_edge4

._crit_edge4:                                     ; preds = %.lr.ph3.split.._crit_edge4_crit_edge, %._crit_edge.us.._crit_edge4_crit_edge
  br label %.preheader._crit_edge

.preheader._crit_edge:                            ; preds = %.preheader..preheader._crit_edge_crit_edge, %._crit_edge4
  %225 = phi i8* [ %.pre, %.preheader..preheader._crit_edge_crit_edge ], [ %161, %._crit_edge4 ]
