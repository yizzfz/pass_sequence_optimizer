...
@__llvm_prf_nm = private constant [101 x i8] c"\AE\01bx\DAm\CCA\0A\800\0C\04@\FC\90\E0\D5\CF\844\0D\A56m%\8DB\7F/\88\F6\A2\D7\9D\DD\DDb\89\06T\A5*x\A6ZNVc\9D,\EF\CB,\B26C5\D8\B15\F0wkHP\EC\8DP\18\9E\D5\90N\04\1A\DC'wG\14\0F\AF\1A:\E1a\E5\10\F9;J@\B9\A7W.\DA\D3B\90", section "__llvm_prf_names"
@llvm.used = appending global [9 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jinit_color_deconverter to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_start_pass_dcolor to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_grayscale_convert to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_ycc_rgb_convert to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_build_ycc_rgb_table to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_null_convert to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_ycck_cmyk_convert to i8*), i8* bitcast ([13 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([101 x i8], [101 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
