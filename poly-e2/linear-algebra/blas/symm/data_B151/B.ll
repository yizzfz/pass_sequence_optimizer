...
for.body.us:                                      ; preds = %for.cond1.for.end_crit_edge.us, %for.body.us.preheader
  %indvars.iv65 = phi i64 [ 0, %for.body.us.preheader ], [ %indvars.iv.next66, %for.cond1.for.end_crit_edge.us ]
...
for.body3.us:                                     ; preds = %for.body3.us, %for.body.us
  ...
  br i1 %exitcond64, label %for.cond1.for.end_crit_edge.us, label %for.body3.us
...
for.body26:                                       ; preds = %for.body26.preheader, %for.body26
  ...
  %11 = add nuw nsw i64 %indvars.iv57, %indvars.iv
  ...
  %13 = add nuw nsw i64 %indvars.iv57, %indvars.iv.next
...
for.body43.preheader:                             ; preds = %for.body43.prol.loopexit
  %17 = sub i64 992, %indvars.iv48.unr
  %18 = lshr i64 %17, 3
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %24 = shl i64 %index, 3
  %25 = add i64 %indvars.iv48.unr, %24
  %26 = add nsw i64 %25, 7
  %27 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv57, i64 %26
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.inc51, label %for.body43.preheader73

for.body43.preheader73:                           ; preds = %middle.block, %min.iters.checked, %for.body43.preheader
...
for.body43:                                       ; preds = %for.body43.preheader73, %for.body43
  %indvars.iv48 = phi i64 [ %indvars.iv.next49.7, %for.body43 ], [ %indvars.iv48.ph, %for.body43.preheader73 ]
...
for.body3.lr.ph:                                  ; preds = %for.body.lr.ph, %for.inc53
  %indvars.iv52 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next53, %for.inc53 ]
...
for.inc53:                                        ; preds = %for.inc53.loopexit83, %for.inc53.loopexit82, %for.inc53.loopexit
  ...
  br i1 %exitcond55, label %for.end55, label %for.body3.lr.ph
...
for.body.us:                                      ; preds = %for.cond2.for.end_crit_edge.us, %for.body.us.preheader
  %indvars.iv14 = phi i64 [ 0, %for.body.us.preheader ], [ %indvars.iv.next15, %for.cond2.for.end_crit_edge.us ]
