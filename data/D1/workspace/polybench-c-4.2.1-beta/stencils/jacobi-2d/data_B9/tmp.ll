...
.preheader4.us:                                   ; preds = %._crit_edge.us, %.preheader4.us.preheader
  %indvar48 = phi i64 [ %indvar.next49, %._crit_edge.us ], [ 0, %.preheader4.us.preheader ]
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %._crit_edge.us ], [ 1, %.preheader4.us.preheader ]
  %4 = add i64 %indvar48, 1
  %scevgep50 = getelementptr [1300 x double], [1300 x double]* %3, i64 %4, i64 1
  %scevgep52 = getelementptr [1300 x double], [1300 x double]* %3, i64 %4, i64 1299
  %scevgep54 = getelementptr [1300 x double], [1300 x double]* %2, i64 %indvar48, i64 1
  %5 = add i64 %indvar48, 2
  %scevgep56 = getelementptr [1300 x double], [1300 x double]* %2, i64 %5, i64 1299
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  %6 = add nsw i64 %indvars.iv16, -1
  %bound058 = icmp ult double* %scevgep50, %scevgep56
  %bound159 = icmp ult double* %scevgep54, %scevgep52
  %memcheck.conflict61 = and i1 %bound058, %bound159
  br i1 %memcheck.conflict61, label %scalar.ph45.preheader, label %vector.body43.preheader

vector.body43.preheader:                          ; preds = %.preheader4.us
  br label %vector.body43

vector.body43:                                    ; preds = %vector.body43.preheader, %vector.body43
  %index64 = phi i64 [ %index.next65, %vector.body43 ], [ 0, %vector.body43.preheader ]
  %offset.idx68 = or i64 %index64, 1
  %7 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv16, i64 %offset.idx68
  %8 = bitcast double* %7 to <2 x double>*
  %wide.load73 = load <2 x double>, <2 x double>* %8, align 8, !alias.scope !1
  %9 = getelementptr double, double* %7, i64 2
  %10 = bitcast double* %9 to <2 x double>*
  %wide.load74 = load <2 x double>, <2 x double>* %10, align 8, !alias.scope !1
  %11 = add nsw i64 %offset.idx68, -1
  ...
  %wide.load76 = load <2 x double>, <2 x double>* %15, align 8, !alias.scope !1
  %16 = fadd <2 x double> %wide.load73, %wide.load75
  %17 = fadd <2 x double> %wide.load74, %wide.load76
  %18 = add nuw nsw i64 %offset.idx68, 1
  ...
  %23 = fadd <2 x double> %16, %wide.load77
  %24 = fadd <2 x double> %17, %wide.load78
  %25 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv.next17, i64 %offset.idx68
  ...
  %29 = fadd <2 x double> %23, %wide.load79
  %30 = fadd <2 x double> %24, %wide.load80
  %31 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %6, i64 %offset.idx68
  %32 = bitcast double* %31 to <2 x double>*
  %wide.load81 = load <2 x double>, <2 x double>* %32, align 8, !alias.scope !1
  %33 = getelementptr double, double* %31, i64 2
  %34 = bitcast double* %33 to <2 x double>*
  %wide.load82 = load <2 x double>, <2 x double>* %34, align 8, !alias.scope !1
  %35 = fadd <2 x double> %29, %wide.load81
  %36 = fadd <2 x double> %30, %wide.load82
  ...
  %39 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv16, i64 %offset.idx68
  ...
  %index.next65 = add i64 %index64, 4
  %43 = icmp eq i64 %index.next65, 1296
  br i1 %43, label %scalar.ph45.preheader.loopexit, label %vector.body43, !llvm.loop !6

scalar.ph45.preheader.loopexit:                   ; preds = %vector.body43
  br label %scalar.ph45.preheader

scalar.ph45.preheader:                            ; preds = %scalar.ph45.preheader.loopexit, %.preheader4.us
  %indvars.iv.ph = phi i64 [ 1, %.preheader4.us ], [ 1297, %scalar.ph45.preheader.loopexit ]
  br label %scalar.ph45

scalar.ph45:                                      ; preds = %scalar.ph45.preheader, %scalar.ph45
  %indvars.iv = phi i64 [ %indvars.iv.next, %scalar.ph45 ], [ %indvars.iv.ph, %scalar.ph45.preheader ]
  ...
  br i1 %exitcond, label %._crit_edge.us, label %scalar.ph45, !llvm.loop !9

._crit_edge.us:                                   ; preds = %scalar.ph45
  %exitcond18 = icmp eq i64 %indvars.iv.next17, 1299
  %indvar.next49 = add i64 %indvar48, 1
  br i1 %exitcond18, label %.preheader.us.preheader, label %.preheader4.us
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge11.us
  ...
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %._crit_edge11.us ], [ 1, %.preheader.us.preheader ]
  %61 = add i64 %indvar, 1
  %scevgep = getelementptr [1300 x double], [1300 x double]* %2, i64 %61, i64 1
  %scevgep27 = getelementptr [1300 x double], [1300 x double]* %2, i64 %61, i64 1299
  %scevgep29 = getelementptr [1300 x double], [1300 x double]* %3, i64 %indvar, i64 1
  %62 = add i64 %indvar, 2
  %scevgep31 = getelementptr [1300 x double], [1300 x double]* %3, i64 %62, i64 1299
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  %63 = add nsw i64 %indvars.iv22, -1
  %bound0 = icmp ult double* %scevgep, %scevgep31
  %bound1 = icmp ult double* %scevgep29, %scevgep27
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load34 = load <2 x double>, <2 x double>* %67, align 8, !alias.scope !10
  %68 = add nsw i64 %offset.idx, -1
  %69 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv22, i64 %68
  %70 = bitcast double* %69 to <2 x double>*
  %wide.load35 = load <2 x double>, <2 x double>* %70, align 8, !alias.scope !10
  %71 = getelementptr double, double* %69, i64 2
  %72 = bitcast double* %71 to <2 x double>*
  %wide.load36 = load <2 x double>, <2 x double>* %72, align 8, !alias.scope !10
  %73 = fadd <2 x double> %wide.load, %wide.load35
  %74 = fadd <2 x double> %wide.load34, %wide.load36
  %75 = add nuw nsw i64 %offset.idx, 1
  %76 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv22, i64 %75
  %77 = bitcast double* %76 to <2 x double>*
  %wide.load37 = load <2 x double>, <2 x double>* %77, align 8, !alias.scope !10
  %78 = getelementptr double, double* %76, i64 2
  %79 = bitcast double* %78 to <2 x double>*
  %wide.load38 = load <2 x double>, <2 x double>* %79, align 8, !alias.scope !10
  %80 = fadd <2 x double> %73, %wide.load37
  %81 = fadd <2 x double> %74, %wide.load38
  ...
  %86 = fadd <2 x double> %80, %wide.load39
  %87 = fadd <2 x double> %81, %wide.load40
...
scalar.ph.preheader:                              ; preds = %scalar.ph.preheader.loopexit, %.preheader.us
  %indvars.iv19.ph = phi i64 [ 1, %.preheader.us ], [ 1297, %scalar.ph.preheader.loopexit ]
  br label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %scalar.ph ], [ %indvars.iv19.ph, %scalar.ph.preheader ]
  ...
  br i1 %exitcond21, label %._crit_edge11.us, label %scalar.ph, !llvm.loop !16

._crit_edge11.us:                                 ; preds = %scalar.ph
  %exitcond24 = icmp eq i64 %indvars.iv.next23, 1299
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond24, label %._crit_edge13, label %.preheader.us
