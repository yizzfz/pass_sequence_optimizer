...
entry:
  ...
  call fastcc void @init_array(i32 1000, i32 1200, double* nonnull %alpha, double* nonnull %beta, [1200 x double]* %arraydecay12, [1000 x double]* %arraydecay313, [1200 x double]* %arraydecay414)
  call void (...) @polybench_timer_start() #3
  %0 = load double, double* %alpha, align 8
  %1 = load double, double* %beta, align 8
  call fastcc void @kernel_symm(i32 1000, i32 1200, double %0, double %1, [1200 x double]* %arraydecay12, [1000 x double]* %arraydecay313, [1200 x double]* %arraydecay414)
...
for.inc.us:                                       ; preds = %for.inc.us, %for.body.us
  %indvars.iv63 = phi i64 [ 0, %for.body.us ], [ %indvars.iv.next64, %for.inc.us ]
...
for.cond1.for.inc16_crit_edge.us:                 ; preds = %for.inc.us
  ...
  br i1 %exitcond71, label %for.inc36.lr.ph.preheader, label %for.body.us
...
for.body3.us:                                     ; preds = %for.body3.us.preheader, %for.cond4.for.inc50_crit_edge.us
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.cond4.for.inc50_crit_edge.us ], [ 0, %for.body3.us.preheader ]
...
for.inc.us:                                       ; preds = %for.inc.us, %for.body3.us
  %indvars.iv42 = phi i64 [ 0, %for.body3.us ], [ %indvars.iv.next43, %for.inc.us ]
  %temp2.034.us = phi double [ 0.000000e+00, %for.body3.us ], [ %add27.us, %for.inc.us ]
