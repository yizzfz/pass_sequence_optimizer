...
for.cond1.preheader:                              ; preds = %for.end, %entry
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.end ], [ 0, %entry ]
  br label %for.body3

for.body3:                                        ; preds = %for.body3, %for.cond1.preheader
  %indvars.iv18 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next19, %for.body3 ]
  ...
  br i1 %exitcond22, label %for.end, label %for.body3

for.end:                                          ; preds = %for.body3
  %indvars.iv.next33 = add nuw nsw i64 %indvars.iv32, 1
  %exitcond34 = icmp ne i64 %indvars.iv.next33, 800
  br i1 %exitcond34, label %for.cond1.preheader, label %for.cond15.preheader.preheader

for.cond15.preheader.preheader:                   ; preds = %for.end
  br label %for.cond15.preheader

for.cond15.preheader:                             ; preds = %for.cond15.preheader.preheader, %for.end33
  %indvars.iv29 = phi i64 [ 0, %for.cond15.preheader.preheader ], [ %indvars.iv.next30, %for.end33 ]
  br label %for.body18

for.body18:                                       ; preds = %for.body18, %for.cond15.preheader
  %indvars.iv13 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next14, %for.body18 ]
  ...
  br i1 %exitcond17, label %for.end33, label %for.body18

for.end33:                                        ; preds = %for.body18
  %indvars.iv.next30 = add nuw nsw i64 %indvars.iv29, 1
  %exitcond31 = icmp ne i64 %indvars.iv.next30, 1000
  br i1 %exitcond31, label %for.cond15.preheader, label %for.cond41.preheader.preheader
...
for.cond41.preheader:                             ; preds = %for.cond41.preheader.preheader, %for.end58
  %indvars.iv26 = phi i64 [ 0, %for.cond41.preheader.preheader ], [ %indvars.iv.next27, %for.end58 ]
  br label %for.body44

for.body44:                                       ; preds = %for.body44, %for.cond41.preheader
  %indvars.iv8 = phi i64 [ 0, %for.cond41.preheader ], [ %indvars.iv.next9, %for.body44 ]
  ...
  br i1 %exitcond12, label %for.end58, label %for.body44

for.end58:                                        ; preds = %for.body44
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv26, 1
  %exitcond28 = icmp ne i64 %indvars.iv.next27, 900
...
for.cond66.preheader:                             ; preds = %for.cond66.preheader.preheader, %for.end84
  %indvars.iv23 = phi i64 [ 0, %for.cond66.preheader.preheader ], [ %indvars.iv.next24, %for.end84 ]
  br label %for.body69
...
for.end84:                                        ; preds = %for.body69
  ...
  %exitcond25 = icmp ne i64 %indvars.iv.next24, 1200
  br i1 %exitcond25, label %for.cond66.preheader, label %for.end87
...
for.cond1.preheader:                              ; preds = %for.end23.for.cond1.preheader_crit_edge, %entry
  %indvar15 = phi i64 [ 0, %entry ], [ %indvar.next16, %for.end23.for.cond1.preheader_crit_edge ]
  %storemerge3 = phi i64 [ 0, %entry ], [ %inc25, %for.end23.for.cond1.preheader_crit_edge ]
  %sext = shl i64 %storemerge3, 32
  %idxprom = ashr exact i64 %sext, 32
  br label %for.body3

for.body3:                                        ; preds = %for.end, %for.cond1.preheader
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.end ], [ 0, %for.cond1.preheader ]
...
for.body8:                                        ; preds = %for.body8, %for.body3
  %indvars.iv12 = phi i64 [ 0, %for.body3 ], [ %indvars.iv.next13.1, %for.body8 ]
  ...
  br i1 %exitcond14.1, label %for.end, label %for.body8

for.end:                                          ; preds = %for.body8
  %indvars.iv.next28 = add nuw nsw i64 %indvars.iv27, 1
  %exitcond29 = icmp ne i64 %indvars.iv.next28, 900
  br i1 %exitcond29, label %for.body3, label %for.end23

for.end23:                                        ; preds = %for.end
  %indvar.next16 = add nuw nsw i64 %indvar15, 1
  %exitcond18 = icmp eq i64 %indvar.next16, 800
  br i1 %exitcond18, label %for.cond30.preheader.preheader, label %for.end23.for.cond1.preheader_crit_edge
...
for.cond30.preheader:                             ; preds = %for.cond30.preheader.preheader, %for.end59.for.cond30.preheader_crit_edge
  %indvar8 = phi i64 [ %indvar.next9, %for.end59.for.cond30.preheader_crit_edge ], [ 0, %for.cond30.preheader.preheader ]
  %storemerge12 = phi i64 [ %inc61, %for.end59.for.cond30.preheader_crit_edge ], [ 0, %for.cond30.preheader.preheader ]
  %sext19 = shl i64 %storemerge12, 32
  %idxprom33 = ashr exact i64 %sext19, 32
  br label %for.body32

for.body32:                                       ; preds = %for.end56, %for.cond30.preheader
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.end56 ], [ 0, %for.cond30.preheader ]
...
for.body39:                                       ; preds = %for.body39, %for.body32
  %indvars.iv5 = phi i64 [ 0, %for.body32 ], [ %indvars.iv.next6.2, %for.body39 ]
  ...
  br i1 %exitcond7.2, label %for.end56, label %for.body39

for.end56:                                        ; preds = %for.body39
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  %exitcond26 = icmp ne i64 %indvars.iv.next25, 1100
  br i1 %exitcond26, label %for.body32, label %for.end59

for.end59:                                        ; preds = %for.end56
  %indvar.next9 = add nuw nsw i64 %indvar8, 1
  %exitcond11 = icmp eq i64 %indvar.next9, 900
  br i1 %exitcond11, label %for.cond66.preheader.preheader, label %for.end59.for.cond30.preheader_crit_edge
...
for.cond66.preheader:                             ; preds = %for.cond66.preheader.preheader, %for.end95.for.cond66.preheader_crit_edge
  ...
  %storemerge21 = phi i64 [ %inc97, %for.end95.for.cond66.preheader_crit_edge ], [ 0, %for.cond66.preheader.preheader ]
  %sext20 = shl i64 %storemerge21, 32
  %idxprom69 = ashr exact i64 %sext20, 32
  br label %for.body68

for.body68:                                       ; preds = %for.end92, %for.cond66.preheader
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.end92 ], [ 0, %for.cond66.preheader ]
...
for.end92:                                        ; preds = %for.body75
  ...
  br i1 %exitcond23, label %for.body68, label %for.end95
...
for.end:                                          ; preds = %if.end
  ...
  %exitcond6 = icmp ne i64 %indvars.iv.next4, 800
  br i1 %exitcond6, label %for.cond2.preheader, label %for.end12
