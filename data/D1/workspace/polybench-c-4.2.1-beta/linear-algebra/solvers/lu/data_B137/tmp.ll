...
; <label>:7:                                      ; preds = %7, %.lr.ph94
  %indvars.iv118 = phi i64 [ %indvars.iv.next119, %7 ], [ 0, %.lr.ph94 ]
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load16 = load <2 x double>, <2 x double>* %64, align 8, !alias.scope !6, !noalias !8
  %65 = fadd <2 x double> %wide.load, %59
  %66 = fadd <2 x double> %wide.load16, %60
  ...
  br i1 %67, label %._crit_edge78.us.us.loopexit47, label %vector.body, !llvm.loop !9
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  ...
  %scevgep24 = getelementptr [2000 x double], [2000 x double]* %0, i64 %82, i64 0
  %scevgep2425 = bitcast double* %scevgep24 to i8*
  %83 = mul nuw nsw i64 %indvars.iv104, 16000
  %scevgep26 = getelementptr i8, i8* %16, i64 %83
  %84 = add nuw nsw i64 %83, 16000
  %scevgep27 = getelementptr i8, i8* %16, i64 %84
...
vector.body17:                                    ; preds = %vector.body17, %vector.body17.preheader
  ...
  %85 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv104, i64 %index34
  %86 = bitcast double* %85 to <2 x i64>*
  %wide.load42 = load <2 x i64>, <2 x i64>* %86, align 8, !alias.scope !13
  %87 = getelementptr double, double* %85, i64 2
  %88 = bitcast double* %87 to <2 x i64>*
  %wide.load43 = load <2 x i64>, <2 x i64>* %88, align 8, !alias.scope !13
  %89 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv104, i64 %index34
  %90 = bitcast double* %89 to <2 x i64>*
  store <2 x i64> %wide.load42, <2 x i64>* %90, align 8, !alias.scope !16, !noalias !13
  %91 = getelementptr double, double* %89, i64 2
  %92 = bitcast double* %91 to <2 x i64>*
  store <2 x i64> %wide.load43, <2 x i64>* %92, align 8, !alias.scope !16, !noalias !13
  %index.next35 = or i64 %index34, 4
  %93 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %37, i64 0, i64 %indvars.iv104, i64 %index.next35
  %94 = bitcast double* %93 to <2 x i64>*
  %wide.load42.1 = load <2 x i64>, <2 x i64>* %94, align 8, !alias.scope !13
  %95 = getelementptr double, double* %93, i64 2
  %96 = bitcast double* %95 to <2 x i64>*
  %wide.load43.1 = load <2 x i64>, <2 x i64>* %96, align 8, !alias.scope !13
  %97 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv104, i64 %index.next35
  %98 = bitcast double* %97 to <2 x i64>*
  store <2 x i64> %wide.load42.1, <2 x i64>* %98, align 8, !alias.scope !16, !noalias !13
  %99 = getelementptr double, double* %97, i64 2
  %100 = bitcast double* %99 to <2 x i64>*
  store <2 x i64> %wide.load43.1, <2 x i64>* %100, align 8, !alias.scope !16, !noalias !13
  %index.next35.1 = add nsw i64 %index34, 8
  %101 = icmp eq i64 %index.next35.1, 2000
  br i1 %101, label %._crit_edge.us.loopexit46, label %vector.body17, !llvm.loop !18
