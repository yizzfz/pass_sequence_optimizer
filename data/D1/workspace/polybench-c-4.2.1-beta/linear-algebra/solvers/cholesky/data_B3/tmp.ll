...
define internal void @init_array(i32, [2000 x double]* nocapture) #0 {
  %3 = icmp sgt i32 %0, 0
  br i1 %3, label %.preheader13.lr.ph, label %._crit_edge35.thread
...
.lr.ph28:                                         ; preds = %.preheader13.lr.ph, %._crit_edge33
  %indvars.iv91 = phi i64 [ 0, %.preheader13.lr.ph ], [ %indvars.iv.next92, %._crit_edge33 ]
  %indvars.iv89 = phi i64 [ 1, %.preheader13.lr.ph ], [ %indvars.iv.next90, %._crit_edge33 ]
...
; <label>:15:                                     ; preds = %15, %.lr.ph28
  %indvars.iv75 = phi i64 [ %indvars.iv.next76, %15 ], [ 0, %.lr.ph28 ]
  %16 = sub nsw i64 0, %indvars.iv75
  %17 = trunc i64 %16 to i32
  %18 = srem i32 %17, %0
  %19 = sitofp i32 %18 to double
  %20 = fdiv double %19, %5
  %21 = fadd double %20, 1.000000e+00
  %22 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv91, i64 %indvars.iv75
  store double %21, double* %22, align 8
  %indvars.iv.next76 = add nuw nsw i64 %indvars.iv75, 1
  %exitcond80 = icmp eq i64 %indvars.iv.next76, %indvars.iv89
  br i1 %exitcond80, label %._crit_edge29, label %15

._crit_edge29:                                    ; preds = %15
  %indvars.iv.next92 = add nuw nsw i64 %indvars.iv91, 1
  %23 = icmp slt i64 %indvars.iv.next92, %8
  br i1 %23, label %._crit_edge33.loopexit, label %._crit_edge33
...
._crit_edge33:                                    ; preds = %._crit_edge33.loopexit, %._crit_edge29
  ...
  br i1 %exitcond94, label %._crit_edge35, label %.lr.ph28
...
._crit_edge35:                                    ; preds = %._crit_edge33
  ...
  %27 = icmp sgt i32 %0, 0
  br i1 %27, label %.preheader12.us.preheader, label %._crit_edge16

.preheader12.us.preheader:                        ; preds = %._crit_edge35
  %28 = add i32 %0, -1
  ...
  br i1 %lcmp.mod73, label %.preheader12.us.prol.loopexit, label %._crit_edge25.us.prol.preheader

._crit_edge25.us.prol.preheader:                  ; preds = %.preheader12.us.preheader
  br label %._crit_edge25.us.prol

._crit_edge25.us.prol:                            ; preds = %._crit_edge25.us.prol.preheader, %._crit_edge25.us.prol
  %indvars.iv68.prol = phi i64 [ %indvars.iv.next69.prol, %._crit_edge25.us.prol ], [ 0, %._crit_edge25.us.prol.preheader ]
  %prol.iter74 = phi i32 [ %prol.iter74.sub, %._crit_edge25.us.prol ], [ %xtraiter72, %._crit_edge25.us.prol.preheader ]
  ...
  br i1 %prol.iter74.cmp, label %.preheader12.us.prol.loopexit.loopexit, label %._crit_edge25.us.prol, !llvm.loop !1

.preheader12.us.prol.loopexit.loopexit:           ; preds = %._crit_edge25.us.prol
...
.preheader12.us.prol.loopexit:                    ; preds = %.preheader12.us.prol.loopexit.loopexit, %.preheader12.us.preheader
  ...
  br i1 %33, label %.preheader10.lr.ph, label %._crit_edge25.us.3.preheader

._crit_edge25.us.3.preheader:                     ; preds = %.preheader12.us.prol.loopexit
  ...
  br i1 %lcmp.mod100, label %._crit_edge25.us.3.prol.preheader, label %._crit_edge25.us.3.prol.loopexit

._crit_edge25.us.3.prol.preheader:                ; preds = %._crit_edge25.us.3.preheader
  br label %._crit_edge25.us.3.prol

._crit_edge25.us.3.prol:                          ; preds = %._crit_edge25.us.3.prol.preheader
  ...
  br label %._crit_edge25.us.3.prol.loopexit

._crit_edge25.us.3.prol.loopexit:                 ; preds = %._crit_edge25.us.3.prol, %._crit_edge25.us.3.preheader
  %indvars.iv68.unr103 = phi i64 [ %indvars.iv68.unr, %._crit_edge25.us.3.preheader ], [ %indvars.iv.next69.3.prol, %._crit_edge25.us.3.prol ]
  %45 = icmp eq i64 %36, 0
  br i1 %45, label %.preheader11, label %._crit_edge25.us.3.preheader.new

._crit_edge25.us.3.preheader.new:                 ; preds = %._crit_edge25.us.3.prol.loopexit
  br label %._crit_edge25.us.3

.preheader11.unr-lcssa:                           ; preds = %._crit_edge25.us.3
  br label %.preheader11

.preheader11:                                     ; preds = %._crit_edge25.us.3.prol.loopexit, %.preheader11.unr-lcssa
  %46 = icmp sgt i32 %0, 0
  br i1 %46, label %.preheader10.lr.ph, label %._crit_edge16
...
.preheader9.us.us.preheader:                      ; preds = %.preheader10.lr.ph, %._crit_edge21.us
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %._crit_edge21.us ], [ 0, %.preheader10.lr.ph ]
...
.preheader9.us.us:                                ; preds = %._crit_edge19.us.us, %.preheader9.us.us.preheader
  %indvars.iv56 = phi i64 [ 0, %.preheader9.us.us.preheader ], [ %indvars.iv.next57, %._crit_edge19.us.us ]
...
.prol.loopexit53:                                 ; preds = %.prol.preheader52, %.preheader9.us.us
  ...
  br i1 %47, label %._crit_edge19.us.us, label %.preheader9.us.us.new.preheader

.preheader9.us.us.new.preheader:                  ; preds = %.prol.loopexit53
  br label %.preheader9.us.us.new

._crit_edge19.us.us.loopexit:                     ; preds = %.preheader9.us.us.new
  br label %._crit_edge19.us.us

._crit_edge19.us.us:                              ; preds = %._crit_edge19.us.us.loopexit, %.prol.loopexit53
  %indvars.iv.next57 = add nuw nsw i64 %indvars.iv56, 1
  %exitcond59 = icmp eq i64 %indvars.iv.next57, %wide.trip.count58
  br i1 %exitcond59, label %._crit_edge21.us, label %.preheader9.us.us
...
.preheader9.us.us.new:                            ; preds = %.preheader9.us.us.new.preheader, %.preheader9.us.us.new
  ...
  br i1 %exitcond51.1, label %._crit_edge19.us.us.loopexit, label %.preheader9.us.us.new

.preheader8:                                      ; preds = %._crit_edge21.us
  %70 = icmp sgt i32 %0, 0
  br i1 %70, label %.preheader.us.preheader, label %._crit_edge16
...
._crit_edge16:                                    ; preds = %._crit_edge16.loopexit, %._crit_edge35, %._crit_edge35.thread, %.preheader11, %.preheader8
  %98 = phi i8* [ %25, %.preheader8 ], [ %25, %.preheader11 ], [ %25, %._crit_edge35 ], [ %4, %._crit_edge35.thread ], [ %25, %._crit_edge16.loopexit ]
  tail call void @free(i8* %98) #3
  ret void

._crit_edge25.us.3:                               ; preds = %._crit_edge25.us.3, %._crit_edge25.us.3.preheader.new
  %indvars.iv68 = phi i64 [ %indvars.iv68.unr103, %._crit_edge25.us.3.preheader.new ], [ %indvars.iv.next69.3.1, %._crit_edge25.us.3 ]
  ...
  br i1 %exitcond71.3.1, label %.preheader11.unr-lcssa, label %._crit_edge25.us.3
}
...
; <label>:17:                                     ; preds = %10, %15
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, %indvars.iv8
...
._crit_edge:                                      ; preds = %17
  ...
  br i1 %exitcond13, label %._crit_edge5.loopexit, label %.lr.ph
