...
@__llvm_prf_nm = private constant [46 x i8] c",\00tmp1.ll:NotConfigured\01tmp1.ll:_notConfigured", section "__llvm_prf_names"
@llvm.used = appending global [3 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_NotConfigured to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll__notConfigured to i8*), i8* getelementptr inbounds ([46 x i8], [46 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
