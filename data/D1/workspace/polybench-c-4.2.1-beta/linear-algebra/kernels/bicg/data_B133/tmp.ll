...
.lr.ph4.split.us:                                 ; preds = %.lr.ph4.split.us.preheader, %._crit_edge.us
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %._crit_edge.us ], [ 0, %.lr.ph4.split.us.preheader ]
...
; <label>:20:                                     ; preds = %20, %.lr.ph10
  ...
  %exitcond25.1 = icmp eq i64 %indvars.iv.next19.1, 1900
  br i1 %exitcond25.1, label %.lr.ph4.split.us.preheader, label %20
...
.lr.ph3.split.us:                                 ; preds = %._crit_edge.us, %.lr.ph3.split.us.preheader
  %indvars.iv35 = phi i64 [ 0, %.lr.ph3.split.us.preheader ], [ %indvars.iv.next36, %._crit_edge.us ]
...
._crit_edge.us:                                   ; preds = %6
  ...
  br i1 %exitcond37, label %.loopexit, label %.lr.ph3.split.us
...
; <label>:20:                                     ; preds = %20, %.lr.ph9
  ...
  %exitcond39.24 = icmp eq i64 %indvars.iv.next29.24, 1900
  br i1 %exitcond39.24, label %.lr.ph3.split.us.preheader, label %20
...
; <label>:6:                                      ; preds = %._crit_edge, %.lr.ph6
  %indvars.iv11 = phi i64 [ 0, %.lr.ph6 ], [ %indvars.iv.next12, %._crit_edge ]
...
._crit_edge:                                      ; preds = %6, %10
  ...
  %13 = getelementptr inbounds double, double* %0, i64 %indvars.iv11
  ...
  %exitcond14 = icmp eq i64 %indvars.iv.next12, 1900
  br i1 %exitcond14, label %.loopexit13, label %6

.loopexit13:                                      ; preds = %._crit_edge
...
; <label>:20:                                     ; preds = %._crit_edge17, %.loopexit13
  %indvars.iv = phi i64 [ 0, %.loopexit13 ], [ %indvars.iv.next, %._crit_edge17 ]
  %21 = trunc i64 %indvars.iv to i32
  %22 = srem i32 %21, 20
  %23 = icmp eq i32 %22, 0
  br i1 %23, label %24, label %._crit_edge17
