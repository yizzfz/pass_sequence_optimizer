...
._crit_edge23:                                    ; preds = %._crit_edge23, %.preheader56
  %indvars.iv4 = phi i64 [ 0, %.preheader56 ], [ %indvars.iv.next5, %._crit_edge23 ]
  ...
  br i1 %exitcond6, label %28, label %._crit_edge23
...
.preheader71:                                     ; preds = %23, %7
  %indvars.iv22 = phi i64 [ 0, %7 ], [ %indvars.iv.next23, %23 ]
  br label %._crit_edge28

._crit_edge28:                                    ; preds = %22, %.preheader71
  %indvars.iv19 = phi i64 [ 0, %.preheader71 ], [ %indvars.iv.next20, %22 ]
  %8 = getelementptr inbounds [900 x double], [900 x double]* %0, i64 %indvars.iv22, i64 %indvars.iv19
  store double 0.000000e+00, double* %8, align 8
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge28
  %indvars.iv16 = phi i64 [ 0, %._crit_edge28 ], [ %indvars.iv.next17.1, %._crit_edge ]
  %9 = phi double [ 0.000000e+00, %._crit_edge28 ], [ %21, %._crit_edge ]
  %10 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv22, i64 %indvars.iv16
  %11 = load double, double* %10, align 8
  %12 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv16, i64 %indvars.iv19
  %13 = load double, double* %12, align 8
  %14 = fmul double %11, %13
  %15 = fadd double %9, %14
  store double %15, double* %8, align 8
  %indvars.iv.next17 = or i64 %indvars.iv16, 1
  %16 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv22, i64 %indvars.iv.next17
  %17 = load double, double* %16, align 8
  %18 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv.next17, i64 %indvars.iv19
  ...
  br i1 %exitcond18.1, label %22, label %._crit_edge

; <label>:22:                                     ; preds = %._crit_edge
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  %exitcond21 = icmp eq i64 %indvars.iv.next20, 900
  br i1 %exitcond21, label %23, label %._crit_edge28

; <label>:23:                                     ; preds = %22
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  %exitcond24 = icmp eq i64 %indvars.iv.next23, 800
  br i1 %exitcond24, label %.preheader69.preheader, label %.preheader71

.preheader69.preheader:                           ; preds = %23
  br label %.preheader69

.preheader69:                                     ; preds = %.preheader69.preheader, %45
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %45 ], [ 0, %.preheader69.preheader ]
  br label %._crit_edge30

._crit_edge30:                                    ; preds = %44, %.preheader69
  %indvars.iv10 = phi i64 [ 0, %.preheader69 ], [ %indvars.iv.next11, %44 ]
  %24 = getelementptr inbounds [1100 x double], [1100 x double]* %3, i64 %indvars.iv13, i64 %indvars.iv10
...
._crit_edge29:                                    ; preds = %._crit_edge29, %._crit_edge30
  ...
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv13, i64 %indvars.iv7
  ...
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %32 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv13, i64 %indvars.iv.next8
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv13, i64 %indvars.iv.next8.1
...
; <label>:45:                                     ; preds = %44
  ...
  br i1 %exitcond15, label %.preheader.preheader, label %.preheader69
...
; <label>:66:                                     ; preds = %._crit_edge31
  ...
  br i1 %exitcond3, label %67, label %._crit_edge32
