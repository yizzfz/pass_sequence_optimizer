...
; <label>:4:                                      ; preds = %4, %.preheader.us
  ...
  %18 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv12, i64 %indvars.iv.next
...
.preheader.preheader:                             ; preds = %.preheader37.lr.ph, %._crit_edge40
...
.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge
  ...
  %indvars.iv43 = phi i64 [ 1, %.preheader.preheader ], [ %indvars.iv.next44, %._crit_edge ]
  %3 = add i64 %indvar, 1
...
._crit_edge:                                      ; preds = %5
  %exitcond45 = icmp eq i64 %indvars.iv.next44, 1999
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond45, label %._crit_edge40, label %.preheader

._crit_edge40:                                    ; preds = %._crit_edge
  %32 = add nuw nsw i32 %storemerge41, 1
  %exitcond46 = icmp eq i32 %32, 500
  br i1 %exitcond46, label %._crit_edge42, label %.preheader.preheader
