...
.lr.ph7.preheader:
  %5 = alloca [1900 x double]*, align 8
  %6 = alloca double*, align 8
  %7 = alloca double*, align 8
  %8 = alloca double*, align 8
  store [1900 x double]* %0, [1900 x double]** %5, align 8
  store double* %1, double** %6, align 8
  store double* %3, double** %7, align 8
  store double* %4, double** %8, align 8
  %9 = bitcast double* %1 to i8*
  call void @llvm.memset.p0i8.i64(i8* %9, i8 0, i64 15200, i32 8, i1 false)
  %sunkaddr = ptrtoint double* %2 to i64
  br label %.lr.ph4.split.us

.lr.ph4.split.us:                                 ; preds = %.lr.ph7.preheader, %._crit_edge.us
  %10 = phi i32 [ %32, %._crit_edge.us ], [ 0, %.lr.ph7.preheader ]
  %11 = sext i32 %10 to i64
  %12 = getelementptr inbounds double, double* %2, i64 %11
  store double 0.000000e+00, double* %12, align 8
  %sunkaddr23 = shl nsw i64 %11, 3
  %sunkaddr24 = add i64 %sunkaddr, %sunkaddr23
  %sunkaddr25 = inttoptr i64 %sunkaddr24 to double*
  br label %13

; <label>:13:                                     ; preds = %13, %.lr.ph4.split.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %13 ], [ 0, %.lr.ph4.split.us ]
  ...
  %20 = load [1900 x double]*, [1900 x double]** %5, align 8
  %21 = getelementptr inbounds [1900 x double], [1900 x double]* %20, i64 %11, i64 %indvars.iv
  ...
  %28 = getelementptr inbounds double, double* %27, i64 %indvars.iv
  %29 = load double, double* %28, align 8
  %30 = fmul double %26, %29
  %31 = fadd double %25, %30
  store double %31, double* %sunkaddr25, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond21 = icmp eq i64 %indvars.iv.next, 1900
  br i1 %exitcond21, label %._crit_edge.us, label %13

._crit_edge.us:                                   ; preds = %13
  %32 = add nsw i32 %10, 1
  %33 = icmp slt i32 %32, 2100
  br i1 %33, label %.lr.ph4.split.us, label %._crit_edge5
...
.lr.ph6:                                          ; preds = %11, %.lr.ph6.preheader
  %indvars.iv8 = phi i64 [ 0, %.lr.ph6.preheader ], [ %indvars.iv.next9, %11 ]
...
; <label>:11:                                     ; preds = %.lr.ph6, %9
  ...
  %13 = getelementptr inbounds double, double* %0, i64 %indvars.iv8
  ...
  br i1 %exitcond, label %._crit_edge7, label %.lr.ph6
...
.lr.ph:                                           ; preds = %25, %._crit_edge7
  %indvars.iv = phi i64 [ 0, %._crit_edge7 ], [ %indvars.iv.next, %25 ]
...
; <label>:25:                                     ; preds = %.lr.ph, %23
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond12 = icmp eq i64 %indvars.iv.next, 2100
