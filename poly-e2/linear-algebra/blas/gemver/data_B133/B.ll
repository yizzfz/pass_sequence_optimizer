...
for.body.us:                                      ; preds = %for.cond1.for.end_crit_edge.us, %entry
  %indvars.iv63 = phi i64 [ 0, %entry ], [ %indvars.iv.next64, %for.cond1.for.end_crit_edge.us ]
  %sunkaddr1 = shl nuw nsw i64 %indvars.iv63, 3
...
for.body3.us:                                     ; preds = %for.body.us, %for.body3.us
  %indvars.iv59 = phi i64 [ %indvars.iv.next60.1, %for.body3.us ], [ 0, %for.body.us ]
  ...
  br i1 %exitcond62.1, label %for.cond1.for.end_crit_edge.us, label %for.body3.us
...
for.body25.us:                                    ; preds = %for.body25.us.preheader, %for.cond26.for.end44_crit_edge.us
  ...
  %sunkaddr9 = shl nuw nsw i64 %indvars.iv54, 3
...
for.body28.us:                                    ; preds = %for.body25.us, %for.body28.us
  ...
  %10 = phi double [ %add39.us.1, %for.body28.us ], [ %.pre, %for.body25.us ]
...
for.cond26.for.end44_crit_edge.us:                ; preds = %for.body28.us
  ...
  br i1 %exitcond76, label %vector.memcheck, label %for.body25.us

vector.memcheck:                                  ; preds = %for.cond26.for.end44_crit_edge.us
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  br i1 %30, label %for.body63.us.preheader.loopexit29, label %vector.body, !llvm.loop !6
...
for.body50:                                       ; preds = %for.body50.preheader, %for.body50
  ...
  %31 = load double, double* %arrayidx52, align 8
  %arrayidx54 = getelementptr inbounds double, double* %z, i64 %indvars.iv46
  %32 = load double, double* %arrayidx54, align 8
  %add55 = fadd double %31, %32
  ...
  %33 = load double, double* %arrayidx52.1, align 8
  %arrayidx54.1 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next47
  %34 = load double, double* %arrayidx54.1, align 8
  %add55.1 = fadd double %33, %34
  ...
  %35 = load double, double* %arrayidx52.2, align 8
  %arrayidx54.2 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next47.1
  %36 = load double, double* %arrayidx54.2, align 8
  %add55.2 = fadd double %35, %36
  ...
  %37 = load double, double* %arrayidx52.3, align 8
  %arrayidx54.3 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next47.2
  %38 = load double, double* %arrayidx54.3, align 8
  %add55.3 = fadd double %37, %38
  ...
  br i1 %exitcond49.3, label %for.body63.us.preheader.loopexit, label %for.body50, !llvm.loop !9

for.body63.us.preheader.loopexit:                 ; preds = %for.body50
  br label %for.body63.us.preheader

for.body63.us.preheader.loopexit29:               ; preds = %vector.body
  br label %for.body63.us.preheader

for.body63.us.preheader:                          ; preds = %for.body63.us.preheader.loopexit29, %for.body63.us.preheader.loopexit
...
for.body63.us:                                    ; preds = %for.body63.us.preheader, %for.cond64.for.end82_crit_edge.us
  ...
  %sunkaddr13 = shl nuw nsw i64 %indvars.iv41, 3
...
for.body66.us:                                    ; preds = %for.body63.us, %for.body66.us
  ...
  %39 = phi double [ %add77.us.1, %for.body66.us ], [ %.pre40, %for.body63.us ]
  %arrayidx72.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv41, i64 %indvars.iv
  %40 = load double, double* %arrayidx72.us, align 8
  %mul73.us = fmul double %40, %alpha
  %arrayidx75.us = getelementptr inbounds double, double* %x, i64 %indvars.iv
  %41 = load double, double* %arrayidx75.us, align 8
  %mul76.us = fmul double %mul73.us, %41
  %add77.us = fadd double %39, %mul76.us
  ...
  %42 = load double, double* %arrayidx72.us.1, align 8
  %mul73.us.1 = fmul double %42, %alpha
  %arrayidx75.us.1 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next
  %43 = load double, double* %arrayidx75.us.1, align 8
  %mul76.us.1 = fmul double %mul73.us.1, %43
