...
define internal fastcc void @init_array(double*, double*, [2000 x double]*, double*, double*, double*, double*, double*, double*, double*, double*) unnamed_addr #2 {
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc void @kernel_gemver(double, double, [2000 x double]*, double*, double*, double*, double*, double*, double*, double*, double*) unnamed_addr #2 {
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.body.preheader
  ...
  %wide.vec43 = load <4 x double>, <4 x double>* %29, align 8, !alias.scope !11
  ...
  %30 = fmul <2 x double> %16, %strided.vec44
  ...
  %wide.vec46 = load <4 x double>, <4 x double>* %33, align 8, !alias.scope !12
  ...
  %34 = fmul <2 x double> %19, %strided.vec47
  ...
  %38 = fmul <2 x double> %22, %strided.vec45
  %39 = fadd <2 x double> %strided.vec42, %38
  %40 = fmul <2 x double> %25, %strided.vec48
  ...
  br i1 %44, label %._crit_edge72.us.loopexit49, label %vector.body.vector.body_crit_edge, !llvm.loop !13
...
._crit_edge72.us.loopexit49:                      ; preds = %vector.body
  br label %._crit_edge72.us

._crit_edge72.us:                                 ; preds = %._crit_edge72.us.loopexit49, %._crit_edge72.us.loopexit
