...
for.cond1.preheader.us:                           ; preds = %for.inc7.us, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge
  %indvars.iv2939.us = phi i64 [ 0, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge ], [ %indvars.iv.next30.us, %for.inc7.us ]
  br label %for.inc.us

for.inc.us:                                       ; preds = %for.inc.us, %for.cond1.preheader.us
  %indvars.iv2537.us = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next26.us, %for.inc.us ]
  %0 = mul nuw nsw i64 %indvars.iv2537.us, %indvars.iv2939.us
  %1 = add nuw nsw i64 %0, 1
  %2 = trunc i64 %1 to i32
  %rem.us = srem i32 %2, 1200
  %conv.us = sitofp i32 %rem.us to double
  %div.us = fdiv double %conv.us, 1.200000e+03
  %arrayidx6.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv2939.us, i64 %indvars.iv2537.us
  store double %div.us, double* %arrayidx6.us, align 8
  %exitcond41 = icmp eq i64 %indvars.iv2537.us, 999
  %indvars.iv.next26.us = add nuw nsw i64 %indvars.iv2537.us, 1
  br i1 %exitcond41, label %for.inc7.us, label %for.inc.us
...
for.inc7.us:                                      ; preds = %for.inc.us
  ...
  br i1 %exitcond44, label %for.cond14.preheader.preheader, label %for.cond1.preheader.us

for.cond14.preheader.preheader:                   ; preds = %for.inc7.us
  br label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond14.preheader.preheader, %for.inc31
  %indvars.iv2334 = phi i64 [ %indvars.iv.next24, %for.inc31 ], [ 0, %for.cond14.preheader.preheader ]
  br label %for.inc28

for.inc28:                                        ; preds = %for.inc28, %for.cond14.preheader
  %indvars.iv32 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next, %for.inc28 ]
  %3 = mul nuw nsw i64 %indvars.iv32, %indvars.iv2334
  %4 = add nuw nsw i64 %3, 2
  %5 = trunc i64 %4 to i32
  %rem20 = srem i32 %5, 1000
  %conv21 = sitofp i32 %rem20 to double
  %div23 = fdiv double %conv21, 1.000000e+03
  %arrayidx27 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv2334, i64 %indvars.iv32
...
for.inc31:                                        ; preds = %for.inc28
  ...
  %exitcond45 = icmp eq i64 %indvars.iv.next24, 1200
  br i1 %exitcond45, label %for.end33, label %for.cond14.preheader
...
for.cond1.preheader.us:                           ; preds = %for.inc32.us, %for.cond1.preheader.us.preheader
  %indvars.iv2839.us = phi i64 [ 1, %for.cond1.preheader.us.preheader ], [ %indvars.iv.next29.us, %for.inc32.us ]
  %indvars.iv3037.us = phi i64 [ 0, %for.cond1.preheader.us.preheader ], [ %3, %for.inc32.us ]
  %0 = add i64 %indvars.iv3037.us, 1
  %1 = add i64 %indvars.iv3037.us, -3
  %2 = lshr i64 %1, 2
  %3 = add i64 %indvars.iv3037.us, 1
  %scevgep = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv3037.us, i64 0
  %4 = mul i64 %indvars.iv3037.us, 1201
  %5 = add i64 %4, 1
  %scevgep2 = getelementptr [1200 x double], [1200 x double]* %C, i64 0, i64 %5
  %min.iters.check19 = icmp ult i64 %3, 4
  br i1 %min.iters.check19, label %for.inc.us.preheader, label %min.iters.checked20

min.iters.checked20:                              ; preds = %for.cond1.preheader.us
  %n.vec22 = and i64 %3, -4
  %cmp.zero23 = icmp eq i64 %n.vec22, 0
  br i1 %cmp.zero23, label %for.inc.us.preheader, label %vector.ph24
...
vector.body16.prol:                               ; preds = %vector.ph24
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv3037.us, i64 0
  %8 = bitcast double* %7 to <2 x double>*
  %wide.load33.prol = load <2 x double>, <2 x double>* %8, align 8
  %9 = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv3037.us, i64 2
...
vector.body16:                                    ; preds = %vector.body16, %vector.ph24.new
  ...
  %14 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv3037.us, i64 %index25
  ...
  %20 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv3037.us, i64 %index.next26
...
middle.block17:                                   ; preds = %vector.body16, %vector.body16.prol.loopexit
  ...
  br i1 %cmp.n28, label %for.cond9.preheader.us.preheader, label %for.inc.us.preheader

for.inc.us.preheader:                             ; preds = %middle.block17, %min.iters.checked20, %for.cond1.preheader.us
  %indvars.iv32.us.ph = phi i64 [ 0, %min.iters.checked20 ], [ 0, %for.cond1.preheader.us ], [ %n.vec22, %middle.block17 ]
  br label %for.inc.us

for.inc.us:                                       ; preds = %for.inc.us.preheader, %for.inc.us
  %indvars.iv32.us = phi i64 [ %indvars.iv.next.us, %for.inc.us ], [ %indvars.iv32.us.ph, %for.inc.us.preheader ]
  %arrayidx5.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv3037.us, i64 %indvars.iv32.us
  ...
  %exitcond.us = icmp eq i64 %indvars.iv.next.us, %indvars.iv2839.us
  br i1 %exitcond.us, label %for.cond9.preheader.us.preheader, label %for.inc.us, !llvm.loop !4

for.cond9.preheader.us.preheader:                 ; preds = %for.inc.us, %middle.block17
  %n.vec = and i64 %3, -4
  br label %for.cond9.preheader.us

for.cond9.preheader.us:                           ; preds = %for.cond9.preheader.us.preheader, %for.inc29.us
  %indvars.iv2635.us = phi i64 [ %29, %for.inc29.us ], [ 0, %for.cond9.preheader.us.preheader ]
  %28 = icmp ult i64 %3, 4
  %scevgep4 = getelementptr [1000 x double], [1000 x double]* %A, i64 0, i64 %indvars.iv2635.us
  %29 = add i64 %indvars.iv2635.us, 1
  %scevgep6 = getelementptr [1000 x double], [1000 x double]* %A, i64 %indvars.iv3037.us, i64 %29
  %arrayidx15.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv3037.us, i64 %indvars.iv2635.us
  br i1 %28, label %for.inc26.us.preheader, label %min.iters.checked

min.iters.checked:                                ; preds = %for.cond9.preheader.us
  %30 = icmp eq i64 %n.vec, 0
  br i1 %30, label %for.inc26.us.preheader, label %vector.memcheck
...
vector.memcheck:                                  ; preds = %min.iters.checked
  ...
  br i1 %conflict.rdx, label %for.inc26.us.preheader, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %35 = or i64 %index, 2
  %36 = or i64 %index, 3
  %37 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %index, i64 %indvars.iv2635.us
  %38 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %34, i64 %indvars.iv2635.us
  %39 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %35, i64 %indvars.iv2635.us
  %40 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %36, i64 %indvars.iv2635.us
  ...
  %51 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv3037.us, i64 %index
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %58, label %for.inc29.us, label %for.inc26.us.preheader

for.inc26.us.preheader:                           ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.cond9.preheader.us
  %indvars.iv2033.us.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %min.iters.checked ], [ 0, %for.cond9.preheader.us ], [ %n.vec, %middle.block ]
  %59 = sub i64 %0, %indvars.iv2033.us.ph
  %xtraiter37 = and i64 %59, 1
  %lcmp.mod38 = icmp eq i64 %xtraiter37, 0
  br i1 %lcmp.mod38, label %for.inc26.us.prol.loopexit, label %for.inc26.us.prol

for.inc26.us.prol:                                ; preds = %for.inc26.us.preheader
  %60 = load double, double* %arrayidx15.us, align 8
  %mul16.us.prol = fmul double %60, %alpha
  %arrayidx20.us.prol = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv2033.us.ph, i64 %indvars.iv2635.us
  %61 = load double, double* %arrayidx20.us.prol, align 8
  %mul21.us.prol = fmul double %mul16.us.prol, %61
  %arrayidx25.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv3037.us, i64 %indvars.iv2033.us.ph
  ...
  %indvars.iv.next21.us.prol = or i64 %indvars.iv2033.us.ph, 1
  br label %for.inc26.us.prol.loopexit

for.inc26.us.prol.loopexit:                       ; preds = %for.inc26.us.prol, %for.inc26.us.preheader
  %indvars.iv2033.us.unr.ph = phi i64 [ %indvars.iv.next21.us.prol, %for.inc26.us.prol ], [ %indvars.iv2033.us.ph, %for.inc26.us.preheader ]
  %63 = icmp eq i64 %indvars.iv3037.us, %indvars.iv2033.us.ph
  br i1 %63, label %for.inc29.us, label %for.inc26.us.preheader.new

for.inc26.us.preheader.new:                       ; preds = %for.inc26.us.prol.loopexit
  br label %for.inc26.us

for.inc26.us:                                     ; preds = %for.inc26.us, %for.inc26.us.preheader.new
  %indvars.iv2033.us = phi i64 [ %indvars.iv2033.us.unr.ph, %for.inc26.us.preheader.new ], [ %indvars.iv.next21.us.1, %for.inc26.us ]
  %64 = load double, double* %arrayidx15.us, align 8
  %mul16.us = fmul double %64, %alpha
  %arrayidx20.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv2033.us, i64 %indvars.iv2635.us
  %65 = load double, double* %arrayidx20.us, align 8
  %mul21.us = fmul double %mul16.us, %65
  %arrayidx25.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv3037.us, i64 %indvars.iv2033.us
  ...
  %indvars.iv.next21.us = add nuw nsw i64 %indvars.iv2033.us, 1
  %67 = load double, double* %arrayidx15.us, align 8
  %mul16.us.1 = fmul double %67, %alpha
  %arrayidx20.us.1 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv.next21.us, i64 %indvars.iv2635.us
  %68 = load double, double* %arrayidx20.us.1, align 8
  %mul21.us.1 = fmul double %mul16.us.1, %68
  %arrayidx25.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv3037.us, i64 %indvars.iv.next21.us
  ...
  %indvars.iv.next21.us.1 = add nsw i64 %indvars.iv2033.us, 2
  %exitcond25.us.1 = icmp eq i64 %indvars.iv.next21.us.1, %indvars.iv2839.us
  br i1 %exitcond25.us.1, label %for.inc29.us, label %for.inc26.us, !llvm.loop !15

for.inc29.us:                                     ; preds = %for.inc26.us.prol.loopexit, %for.inc26.us, %middle.block
  %exitcond42 = icmp eq i64 %29, 1000
  br i1 %exitcond42, label %for.inc32.us, label %for.cond9.preheader.us

for.inc32.us:                                     ; preds = %for.inc29.us
  %cmp.us = icmp slt i64 %3, 1200
  %indvars.iv.next29.us = add nuw nsw i64 %indvars.iv2839.us, 1
...
for.cond2.preheader:                              ; preds = %for.inc10, %for.cond2.preheader.lr.ph.for.cond2.preheader_crit_edge
  %indvars.iv1016 = phi i64 [ 0, %for.cond2.preheader.lr.ph.for.cond2.preheader_crit_edge ], [ %indvars.iv.next11, %for.inc10 ]
  %3 = mul nuw nsw i64 %indvars.iv1016, 1200
  br label %for.body4

for.body4:                                        ; preds = %for.inc, %for.cond2.preheader
  %indvars.iv14 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next, %for.inc ]
...
for.inc:                                          ; preds = %for.body4, %if.then
  ...
  %arrayidx8 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv1016, i64 %indvars.iv14
...
for.inc10:                                        ; preds = %for.inc
  ...
  %exitcond18 = icmp eq i64 %indvars.iv.next11, 1200
