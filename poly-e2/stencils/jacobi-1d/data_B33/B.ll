...
for.body.us:                                      ; preds = %for.body.us.preheader, %for.inc33.us
  ...
  br i1 %min.iters.check134, label %for.body3.us.preheader, label %min.iters.checked135
...
min.iters.checked135:                             ; preds = %for.body.us
  br i1 %cmp.zero99, label %for.body3.us.preheader, label %vector.memcheck151
...
middle.block131:                                  ; preds = %vector.body130
  br i1 %cmp.n118, label %for.body16.us.preheader, label %for.body3.us.preheader
...
for.body16.us.preheader:                          ; preds = %for.body16.us.preheader.loopexit, %middle.block131
  br i1 %min.iters.check134, label %for.body16.us.preheader169, label %min.iters.checked96
...
min.iters.checked96:                              ; preds = %for.body16.us.preheader
  br i1 %cmp.zero99, label %for.body16.us.preheader169, label %vector.memcheck112
...
middle.block92:                                   ; preds = %vector.body91
  br i1 %cmp.n118, label %for.inc33.us, label %for.body16.us.preheader169
