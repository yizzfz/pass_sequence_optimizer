...
.preheader4:                                      ; preds = %21, %5
  ...
  %sunkaddr18 = shl nuw nsw i64 %indvars.iv14, 3
...
; <label>:7:                                      ; preds = %7, %.preheader4
  ...
  %14 = fadd double %8, %13
  store double %14, double* %sunkaddr20, align 8
...
.preheader.preheader:                             ; preds = %21
  %sunkaddr21 = ptrtoint double* %1 to i64
  br label %.preheader
...
.preheader:                                       ; preds = %.preheader.preheader, %37
  ...
  %sunkaddr22 = shl nuw nsw i64 %indvars.iv9, 3
...
; <label>:23:                                     ; preds = %23, %.preheader
  ...
  store double %30, double* %sunkaddr24, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %36, double* %sunkaddr24, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
