...
._crit_edge13:                                    ; preds = %._crit_edge13, %._crit_edge13.preheader
  ...
  %37 = mul nuw nsw i64 %36, %indvars.iv1
  %38 = trunc i64 %37 to i32
  %39 = srem i32 %38, 1100
  %40 = sitofp i32 %39 to double
  %41 = fdiv double %40, 1.100000e+03
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %5, i64 %indvars.iv1, i64 %indvars.iv
...
._crit_edge12:                                    ; preds = %._crit_edge13
  ...
  br i1 %exitcond3, label %43, label %._crit_edge13.preheader
...
._crit_edge17:                                    ; preds = %._crit_edge17, %._crit_edge._crit_edge
  %indvars.iv7 = phi i64 [ 0, %._crit_edge._crit_edge ], [ %indvars.iv.next8.1, %._crit_edge17 ]
  %9 = phi double [ 0.000000e+00, %._crit_edge._crit_edge ], [ %23, %._crit_edge17 ]
  ...
  br i1 %exitcond9.1, label %._crit_edge, label %._crit_edge17
...
._crit_edge18:                                    ; preds = %._crit_edge18, %._crit_edge7._crit_edge
  %indvars.iv = phi i64 [ 0, %._crit_edge7._crit_edge ], [ %indvars.iv.next.2, %._crit_edge18 ]
  %28 = phi double [ %27, %._crit_edge7._crit_edge ], [ %46, %._crit_edge18 ]
  ...
  br i1 %exitcond.2, label %._crit_edge7, label %._crit_edge18

._crit_edge7:                                     ; preds = %._crit_edge18
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
