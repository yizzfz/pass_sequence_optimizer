...
for.cond10.preheader.us:                          ; preds = %for.cond10.preheader.us.preheader, %for.cond10.for.inc34_crit_edge.us
  ...
  %scevgep189 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %0, i64 0
  %scevgep192 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %0, i64 1200
  %scevgep195 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvar, i64 0
  %scevgep198 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %0, i64 1200
  %bound0200 = icmp ult double* %scevgep189, %scevgep198
  %bound1201 = icmp ult double* %scevgep195, %scevgep192
  %memcheck.conflict203 = and i1 %bound0200, %bound1201
  br i1 %memcheck.conflict203, label %for.inc31.us.preheader, label %vector.body179.preheader

vector.body179.preheader:                         ; preds = %for.cond10.preheader.us
  br label %vector.body179

vector.body179:                                   ; preds = %vector.body179.preheader, %vector.body179
  %index206 = phi i64 [ %index.next207, %vector.body179 ], [ 0, %vector.body179.preheader ]
  %2 = shl i64 %index206, 1
  %3 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv87, i64 %2
  %4 = bitcast double* %3 to <4 x double>*
  %wide.vec215 = load <4 x double>, <4 x double>* %4, align 8, !alias.scope !3, !noalias !6
  %strided.vec216 = shufflevector <4 x double> %wide.vec215, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %strided.vec217 = shufflevector <4 x double> %wide.vec215, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %5 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv87, i64 %2
  %6 = bitcast double* %5 to <4 x double>*
  %wide.vec218 = load <4 x double>, <4 x double>* %6, align 8, !alias.scope !6
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %1, i64 %2
  %8 = bitcast double* %7 to <4 x double>*
  %wide.vec221 = load <4 x double>, <4 x double>* %8, align 8, !alias.scope !6
  %9 = fsub <4 x double> %wide.vec218, %wide.vec221
  ...
  %18 = fsub <2 x double> %strided.vec217, %17
  %19 = getelementptr double, double* %14, i64 -1
  %20 = bitcast double* %19 to <4 x double>*
  %interleaved.vec224 = shufflevector <2 x double> %12, <2 x double> %18, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec224, <4 x double>* %20, align 8, !alias.scope !3, !noalias !6
  %index.next207 = add i64 %index206, 2
  %21 = icmp eq i64 %index.next207, 600
  br i1 %21, label %middle.block180, label %vector.body179, !llvm.loop !8
...
for.cond10.for.inc34_crit_edge.us:                ; preds = %for.cond10.for.inc34_crit_edge.us.loopexit, %middle.block180
...
for.inc:                                          ; preds = %for.cond1.preheader, %for.inc
  ...
  %sunkaddr255 = mul i64 %indvars.iv112, 8
  %sunkaddr256 = add i64 %sunkaddr, %sunkaddr255
  %sunkaddr257 = inttoptr i64 %sunkaddr256 to i64*
  %28 = load i64, i64* %sunkaddr257, align 8
  ...
  %30 = load i64, i64* %sunkaddr257, align 8
  ...
  %34 = load i64, i64* %sunkaddr257, align 8
  ...
  %36 = load i64, i64* %sunkaddr257, align 8
  ...
  %38 = load i64, i64* %sunkaddr257, align 8
  ...
  %40 = load i64, i64* %sunkaddr257, align 8
  ...
  %42 = load i64, i64* %sunkaddr257, align 8
...
for.cond40.preheader.us:                          ; preds = %for.cond40.preheader.us.preheader, %for.cond40.for.inc66_crit_edge.us
  ...
  %scevgep148 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv99, i64 2
  %scevgep151 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv99, i64 1200
  %scevgep154 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv99, i64 1
  %scevgep157 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv99, i64 1200
  ...
  br i1 %memcheck.conflict162, label %for.inc63.us.preheader, label %vector.body142.preheader
...
vector.body142:                                   ; preds = %vector.body142.preheader, %vector.body142
  %index165 = phi i64 [ %index.next166, %vector.body142 ], [ 0, %vector.body142.preheader ]
  ...
  %strided.vec172 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  ...
  %wide.vec173 = load <4 x double>, <4 x double>* %52, align 8, !alias.scope !15
  ...
  %53 = fsub <2 x double> %strided.vec175, %strided.vec174
  ...
  %wide.vec176 = load <4 x double>, <4 x double>* %60, align 8, !alias.scope !15
  ...
  %61 = fsub <2 x double> %strided.vec178, %strided.vec177
  %62 = fmul <2 x double> %61, <double 5.000000e-01, double 5.000000e-01>
  %63 = fsub <2 x double> %strided.vec172, %62
  ...
  %66 = icmp eq i64 %index.next166, 598
  br i1 %66, label %middle.block143, label %vector.body142, !llvm.loop !17

middle.block143:                                  ; preds = %vector.body142
  br label %for.inc63.us.preheader

for.inc63.us.preheader:                           ; preds = %middle.block143, %for.cond40.preheader.us
  %indvars.iv92.ph = phi i64 [ 2, %for.cond40.preheader.us ], [ 1198, %middle.block143 ]
...
for.cond73.preheader.us:                          ; preds = %for.cond73.preheader.us.preheader, %for.cond73.for.inc110_crit_edge.us
  ...
  %scevgep123 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %74, i64 0
  %scevgep125 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %indvars.iv108, i64 0
  %scevgep127 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %74, i64 1199
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load133 = load <2 x double>, <2 x double>* %78, align 8, !alias.scope !19, !noalias !22
  %79 = or i64 %index, 1
  %80 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv108, i64 %79
  %81 = bitcast double* %80 to <2 x double>*
  %wide.load134 = load <2 x double>, <2 x double>* %81, align 8, !alias.scope !25
  %82 = getelementptr double, double* %80, i64 2
  %83 = bitcast double* %82 to <2 x double>*
  %wide.load135 = load <2 x double>, <2 x double>* %83, align 8, !alias.scope !25
  %84 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv108, i64 %index
  %85 = bitcast double* %84 to <2 x double>*
  %wide.load136 = load <2 x double>, <2 x double>* %85, align 8, !alias.scope !25
  %86 = getelementptr double, double* %84, i64 2
  %87 = bitcast double* %86 to <2 x double>*
  %wide.load137 = load <2 x double>, <2 x double>* %87, align 8, !alias.scope !25
  %88 = fsub <2 x double> %wide.load134, %wide.load136
  %89 = fsub <2 x double> %wide.load135, %wide.load137
  %90 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv.next109, i64 %index
  %91 = bitcast double* %90 to <2 x double>*
  %wide.load138 = load <2 x double>, <2 x double>* %91, align 8, !alias.scope !26
  %92 = getelementptr double, double* %90, i64 2
  %93 = bitcast double* %92 to <2 x double>*
  %wide.load139 = load <2 x double>, <2 x double>* %93, align 8, !alias.scope !26
  %94 = fadd <2 x double> %88, %wide.load138
  %95 = fadd <2 x double> %89, %wide.load139
  %96 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv108, i64 %index
  %97 = bitcast double* %96 to <2 x double>*
  %wide.load140 = load <2 x double>, <2 x double>* %97, align 8, !alias.scope !26
  %98 = getelementptr double, double* %96, i64 2
  %99 = bitcast double* %98 to <2 x double>*
  %wide.load141 = load <2 x double>, <2 x double>* %99, align 8, !alias.scope !26
  %100 = fsub <2 x double> %94, %wide.load140
  %101 = fsub <2 x double> %95, %wide.load141
  ...
  %105 = fsub <2 x double> %wide.load133, %103
