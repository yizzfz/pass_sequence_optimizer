...
@__llvm_prf_nm = private constant [139 x i8] c"\88\01\00_TIFFSetupFieldInfo\01_TIFFMergeFieldInfo\01tmp1.ll:tagCompare\01_TIFFPrintFieldInfo\01_TIFFSampleToTagType\01_TIFFFindFieldInfo\01_TIFFFieldWithTag", section "__llvm_prf_names"
@llvm.used = appending global [8 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd__TIFFSetupFieldInfo to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd__TIFFMergeFieldInfo to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_tagCompare to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd__TIFFPrintFieldInfo to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd__TIFFSampleToTagType to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd__TIFFFindFieldInfo to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd__TIFFFieldWithTag to i8*), i8* getelementptr inbounds ([139 x i8], [139 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
