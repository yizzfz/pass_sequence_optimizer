...
.preheader4:                                      ; preds = %._crit_edge22..preheader4_crit_edge, %.preheader4.lr.ph
  %.0323 = phi i32 [ 1, %.preheader4.lr.ph ], [ %150, %._crit_edge22..preheader4_crit_edge ]
  br label %.lver.check
...
.lr.ph18.us:                                      ; preds = %.lr.ph18.us..lr.ph18.us_crit_edge, %._crit_edge15.us
  ...
  %109 = phi double [ 1.000000e+00, %._crit_edge15.us ], [ %122, %.lr.ph18.us..lr.ph18.us_crit_edge ]
  ...
  br i1 %124, label %.lr.ph18.us..lr.ph18.us_crit_edge, label %._crit_edge19.us

.lr.ph18.us..lr.ph18.us_crit_edge:                ; preds = %.lr.ph18.us
  br label %.lr.ph18.us

; <label>:125:                                    ; preds = %._crit_edge76, %.ph66
  %store_forwarded72 = phi double [ %load_initial71, %.ph66 ], [ %147, %._crit_edge76 ]
  %store_forwarded69 = phi double [ %load_initial68, %.ph66 ], [ %136, %._crit_edge76 ]
  %indvars.iv30 = phi i64 [ 1, %.ph66 ], [ %indvars.iv.next31, %._crit_edge76 ]
  ...
  br i1 %exitcond33, label %._crit_edge15.us.loopexit73, label %._crit_edge76

._crit_edge76:                                    ; preds = %125
  br label %125
...
._crit_edge22:                                    ; preds = %._crit_edge19.us
  ...
  %exitcond75 = icmp ne i32 %150, 501
  br i1 %exitcond75, label %._crit_edge22..preheader4_crit_edge, label %._crit_edge24
