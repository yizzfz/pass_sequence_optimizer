...
@__llvm_prf_nm = private constant [188 x i8] c"\B9\01\00jinit_color_converter\01tmp1.ll:null_method\01tmp1.ll:grayscale_convert\01tmp1.ll:rgb_ycc_start\01tmp1.ll:rgb_gray_convert\01tmp1.ll:null_convert\01tmp1.ll:rgb_ycc_convert\01tmp1.ll:cmyk_ycck_convert", section "__llvm_prf_names"
@llvm.used = appending global [10 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jinit_color_converter to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_null_method to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_grayscale_convert to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_rgb_ycc_start to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_rgb_gray_convert to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_null_convert to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_rgb_ycc_convert to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_cmyk_ycck_convert to i8*), i8* bitcast ([17 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([188 x i8], [188 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
