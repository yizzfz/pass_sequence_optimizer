...
@__llvm_prf_nm = private constant [84 x i8] c"{Rx\DAM\8CA\0A\800\0C\04\E9\87\04\AF\FE\A6\B4\11\82\89\09iz\E8\EF\AD\01\B1\B7\19vX7\00\BC\D1\93\B3\EE\1B\D1\E16*\96\D5\01HrM\1Ee\03[\B6\CF\A3\91\ABk\A0t\D7\FEW\FA\FE\15\D6\C4\833\91\94\09\E7\CC\1E\16\82-\FC", section "__llvm_prf_names"
@llvm.used = appending global [11 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_treeinit to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_trydict to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_treeload to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_treeinsert to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_tinsert to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_treelookup to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_treeoutput to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_pdictcmp to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_mymalloc to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_myfree to i8*), i8* getelementptr inbounds ([84 x i8], [84 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
