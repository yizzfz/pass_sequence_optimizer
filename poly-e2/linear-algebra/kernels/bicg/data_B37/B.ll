...
for.body5.us:                                     ; preds = %for.cond12.for.inc27_crit_edge.us.for.body5.us_crit_edge, %for.body5.us.preheader
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.cond12.for.inc27_crit_edge.us.for.body5.us_crit_edge ], [ 0, %for.body5.us.preheader ]
...
for.inc24.us:                                     ; preds = %for.inc24.us.for.inc24.us_crit_edge, %for.body5.us
  %indvars.iv = phi i64 [ 0, %for.body5.us ], [ %indvars.iv.next.1, %for.inc24.us.for.inc24.us_crit_edge ]
  ...
  br i1 %exitcond.1, label %for.cond12.for.inc27_crit_edge.us, label %for.inc24.us.for.inc24.us_crit_edge
...
for.cond12.for.inc27_crit_edge.us:                ; preds = %for.inc24.us
  ...
  br i1 %exitcond, label %for.end29, label %for.cond12.for.inc27_crit_edge.us.for.body5.us_crit_edge
...
for.inc:                                          ; preds = %for.inc.for.inc_crit_edge, %for.inc.lr.ph
  %indvars.iv4 = phi i64 [ 0, %for.inc.lr.ph ], [ %indvars.iv.next5.1.1, %for.inc.for.inc_crit_edge ]
  ...
  br i1 %exitcond6.1.1, label %for.body5.us.preheader, label %for.inc.for.inc_crit_edge
...
for.body3.us:                                     ; preds = %for.cond6.for.inc34_crit_edge.us.for.body3.us_crit_edge, %for.body3.us.preheader
  %indvars.iv1 = phi i64 [ 0, %for.body3.us.preheader ], [ %indvars.iv.next2, %for.cond6.for.inc34_crit_edge.us.for.body3.us_crit_edge ]
...
for.cond6.for.inc34_crit_edge.us:                 ; preds = %for.inc31.us
  ...
  br i1 %exitcond3, label %for.end36, label %for.cond6.for.inc34_crit_edge.us.for.body3.us_crit_edge
...
for.body:                                         ; preds = %for.inc.for.body_crit_edge, %for.body.preheader
  %indvars.iv1 = phi i64 [ 0, %for.body.preheader ], [ %indvars.iv.next2, %for.inc.for.body_crit_edge ]
...
for.inc:                                          ; preds = %for.body.for.inc_crit_edge, %if.then
  ...
  br i1 %exitcond3, label %for.body9.preheader, label %for.inc.for.body_crit_edge
...
for.body9:                                        ; preds = %for.inc18.for.body9_crit_edge, %for.body9.preheader
  %indvars.iv = phi i64 [ 0, %for.body9.preheader ], [ %indvars.iv.next, %for.inc18.for.body9_crit_edge ]
