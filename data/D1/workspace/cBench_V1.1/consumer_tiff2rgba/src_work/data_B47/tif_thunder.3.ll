...
@__llvm_prf_nm = private constant [68 x i8] c"B\00TIFFInitThunderScan\01tmp1.ll:ThunderDecodeRow\01tmp1.ll:ThunderDecode", section "__llvm_prf_names"
@llvm.used = appending global [4 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_TIFFInitThunderScan to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_ThunderDecodeRow to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_ThunderDecode to i8*), i8* getelementptr inbounds ([68 x i8], [68 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
