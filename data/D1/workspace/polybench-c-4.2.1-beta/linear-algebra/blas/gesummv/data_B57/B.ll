...
; <label>:6:                                      ; preds = %29, %5
  %indvars.iv262 = phi i64 [ 0, %5 ], [ %indvars.iv.next27, %29 ]
  %7 = trunc i64 %indvars.iv262 to i32
  %8 = srem i32 %7, 1300
  %9 = sitofp i32 %8 to double
  %10 = fdiv double %9, 1.300000e+03
  %11 = getelementptr inbounds double, double* %4, i64 %indvars.iv262
  store double %10, double* %11, align 8
  br label %12

; <label>:12:                                     ; preds = %12, %6
  %indvars.iv1 = phi i64 [ 0, %6 ], [ %indvars.iv.next, %12 ]
  %13 = mul nuw nsw i64 %indvars.iv1, %indvars.iv262
  %14 = add nuw nsw i64 %13, 1
  %15 = trunc i64 %14 to i32
  %16 = srem i32 %15, 1300
  %17 = sitofp i32 %16 to double
  %18 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv262, i64 %indvars.iv1
  ...
  %28 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv262, i64 %indvars.iv1
...
; <label>:29:                                     ; preds = %12
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv262, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next27, 1300
  br i1 %exitcond3, label %30, label %6
...
define internal fastcc void @kernel_gesummv(double, double, [1300 x double]* nocapture readonly, [1300 x double]* nocapture readonly, double* nocapture, double* nocapture readonly, double* nocapture) unnamed_addr #2 {
  ...
  %sunkaddr11 = ptrtoint double* %6 to i64
  br label %8

; <label>:8:                                      ; preds = %25, %7
  %indvars.iv362 = phi i64 [ 0, %7 ], [ %indvars.iv.next37, %25 ]
  %9 = getelementptr inbounds double, double* %4, i64 %indvars.iv362
  store double 0.000000e+00, double* %9, align 8
  %10 = getelementptr inbounds double, double* %6, i64 %indvars.iv362
  store double 0.000000e+00, double* %10, align 8
  %sunkaddr4 = shl i64 %indvars.iv362, 3
  %sunkaddr5 = add i64 %sunkaddr, %sunkaddr4
  %sunkaddr6 = inttoptr i64 %sunkaddr5 to double*
  %sunkaddr13 = add i64 %sunkaddr11, %sunkaddr4
  %sunkaddr14 = inttoptr i64 %sunkaddr13 to double*
  br label %11

; <label>:11:                                     ; preds = %11, %8
  %indvars.iv1 = phi i64 [ 0, %8 ], [ %indvars.iv.next, %11 ]
  %12 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv362, i64 %indvars.iv1
  %13 = load double, double* %12, align 8
  %14 = getelementptr inbounds double, double* %5, i64 %indvars.iv1
  %15 = load double, double* %14, align 8
  %16 = fmul double %13, %15
  %17 = load double, double* %sunkaddr6, align 8
  %18 = fadd double %16, %17
  store double %18, double* %sunkaddr6, align 8
  %19 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv362, i64 %indvars.iv1
  %20 = load double, double* %19, align 8
  %21 = load double, double* %14, align 8
  %22 = fmul double %20, %21
  %23 = load double, double* %sunkaddr14, align 8
  %24 = fadd double %22, %23
  store double %24, double* %sunkaddr14, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv1, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
  br i1 %exitcond, label %25, label %11
...
; <label>:25:                                     ; preds = %11
  ...
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv362, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next37, 1300
  br i1 %exitcond3, label %31, label %8
