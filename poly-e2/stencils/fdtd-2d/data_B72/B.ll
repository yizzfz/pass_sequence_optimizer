...
for.inc:                                          ; preds = %for.inc, %for.cond1.preheader
  ...
  %sunkaddr93 = mul i64 %indvars.iv72, 8
  ...
  %sunkaddr97 = mul i64 %indvars.iv72, 8
  ...
  %sunkaddr101 = mul i64 %indvars.iv72, 8
  ...
  %sunkaddr105 = mul i64 %indvars.iv72, 8
  ...
  %sunkaddr109 = mul i64 %indvars.iv72, 8
...
for.inc113:                                       ; preds = %for.cond73.for.inc110_crit_edge.us
  ...
  %cmp = icmp slt i64 %indvars.iv.next73, 500
