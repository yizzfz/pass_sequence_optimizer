...
.lr.ph.us:                                        ; preds = %..loopexit_crit_edge.us..lr.ph.us_crit_edge, %.lr.ph4
  %indvars.iv5 = phi i64 [ 0, %.lr.ph4 ], [ %indvars.iv.next6, %..loopexit_crit_edge.us..lr.ph.us_crit_edge ]
...
.prol.preheader19:                                ; preds = %.preheader4.us
  ...
  %sunkaddr29 = add i64 %sunkaddr31, %sunkaddr28
  %sunkaddr30 = inttoptr i64 %sunkaddr29 to double*
  %7 = load double, double* %sunkaddr30, align 8
  %8 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv23, i64 0
  %9 = load double, double* %8, align 8
  %10 = load double, double* %3, align 8
  %11 = fmul double %9, %10
  %12 = fadd double %7, %11
  store double %12, double* %sunkaddr30, align 8
  br label %.prol.loopexit20
...
.preheader4.us.new:                               ; preds = %.preheader4.us.new..preheader4.us.new_crit_edge, %.preheader4.us.new.preheader
  %13 = phi double [ %25, %.preheader4.us.new..preheader4.us.new_crit_edge ], [ %.pre, %.preheader4.us.new.preheader ]
  ...
  %14 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv23, i64 %indvars.iv15
  %15 = load double, double* %14, align 8
  %16 = getelementptr inbounds double, double* %3, i64 %indvars.iv15
  %17 = load double, double* %16, align 8
  %18 = fmul double %15, %17
  %19 = fadd double %13, %18
  store double %19, double* %sunkaddr34, align 8
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  %20 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv23, i64 %indvars.iv.next16
  %21 = load double, double* %20, align 8
  %22 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next16
  %23 = load double, double* %22, align 8
  %24 = fmul double %21, %23
  %25 = fadd double %19, %24
  store double %25, double* %sunkaddr34, align 8
...
.prol.preheader:                                  ; preds = %.preheader.us
  %sunkaddr36 = shl nuw nsw i64 %indvars.iv12, 3
  %sunkaddr37 = add i64 %sunkaddr39, %sunkaddr36
  %sunkaddr38 = inttoptr i64 %sunkaddr37 to double*
  %26 = load double, double* %sunkaddr38, align 8
  %27 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 0, i64 %indvars.iv12
  %28 = load double, double* %27, align 8
  %29 = load double, double* %4, align 8
  %30 = fmul double %28, %29
  %31 = fadd double %26, %30
  store double %31, double* %sunkaddr38, align 8
  br label %.prol.loopexit
...
.preheader.us.new:                                ; preds = %.preheader.us.new..preheader.us.new_crit_edge, %.preheader.us.new.preheader
  ...
  store double %38, double* %sunkaddr42, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  ...
  store double %44, double* %sunkaddr42, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
...
.lr.ph7:                                          ; preds = %.lr.ph7._crit_edge..lr.ph7_crit_edge, %.lr.ph7.preheader
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %.lr.ph7._crit_edge..lr.ph7_crit_edge ], [ 0, %.lr.ph7.preheader ]
  %8 = trunc i64 %indvars.iv9 to i32
  %9 = srem i32 %8, 20
  %10 = icmp eq i32 %9, 0
  br i1 %10, label %11, label %.lr.ph7..lr.ph7._crit_edge_crit_edge

.lr.ph7..lr.ph7._crit_edge_crit_edge:             ; preds = %.lr.ph7
...
.lr.ph7._crit_edge:                               ; preds = %.lr.ph7..lr.ph7._crit_edge_crit_edge, %11
  ...
  br i1 %exitcond12, label %._crit_edge8, label %.lr.ph7._crit_edge..lr.ph7_crit_edge

.lr.ph7._crit_edge..lr.ph7_crit_edge:             ; preds = %.lr.ph7._crit_edge
  br label %.lr.ph7
...
.lr.ph:                                           ; preds = %.lr.ph._crit_edge..lr.ph_crit_edge, %._crit_edge8
  %indvars.iv = phi i64 [ %indvars.iv.next, %.lr.ph._crit_edge..lr.ph_crit_edge ], [ 0, %._crit_edge8 ]
  %21 = trunc i64 %indvars.iv to i32
  %22 = srem i32 %21, 20
  %23 = icmp eq i32 %22, 0
  br i1 %23, label %24, label %.lr.ph..lr.ph._crit_edge_crit_edge
...
.lr.ph._crit_edge:                                ; preds = %.lr.ph..lr.ph._crit_edge_crit_edge, %24
