...
; <label>:76:                                     ; preds = %2
  ...
  br i1 %79, label %80, label %.._crit_edge_crit_edge3

.._crit_edge_crit_edge3:                          ; preds = %76
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %.._crit_edge_crit_edge3, %.._crit_edge_crit_edge, %80
...
.preheader11.lr.ph:                               ; preds = %12
  ...
  br i1 %30, label %.preheader11.us.preheader, label %.preheader11.lr.ph..preheader10_crit_edge
...
.preheader11.us:                                  ; preds = %._crit_edge32.us..preheader11.us_crit_edge, %.preheader11.us.preheader
  ...
  %41 = add i64 %38, %indvar
  %scevgep = getelementptr [2000 x double], [2000 x double]* %31, i64 %41, i64 0
  %scevgep76 = getelementptr [2000 x double], [2000 x double]* %31, i64 %41, i64 %smax75
  %42 = getelementptr inbounds double, double* %32, i64 %indvars.iv61
  %43 = getelementptr inbounds double, double* %34, i64 %indvars.iv61
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.body.preheader
  ...
  %44 = getelementptr inbounds [2000 x double], [2000 x double]* %31, i64 %indvars.iv61, i64 %index
  ...
  %53 = getelementptr inbounds double, double* %33, i64 %index
  ...
  %66 = getelementptr inbounds double, double* %35, i64 %index
...
._crit_edge:                                      ; preds = %._crit_edge.._crit_edge_crit_edge, %._crit_edge.preheader
  ...
  %77 = getelementptr inbounds [2000 x double], [2000 x double]* %31, i64 %indvars.iv61, i64 %indvars.iv59
  %78 = load double, double* %77, align 8
  %79 = load double, double* %42, align 8
  %80 = getelementptr inbounds double, double* %33, i64 %indvars.iv59
  %81 = load double, double* %80, align 8
  %82 = fmul double %79, %81
  %83 = fadd double %78, %82
  %84 = load double, double* %43, align 8
  %85 = getelementptr inbounds double, double* %35, i64 %indvars.iv59
  %86 = load double, double* %85, align 8
  %87 = fmul double %84, %86
  %88 = fadd double %83, %87
  store double %88, double* %77, align 8
  %indvars.iv.next60 = add nuw nsw i64 %indvars.iv59, 1
  %89 = icmp slt i64 %indvars.iv.next60, %37
...
._crit_edge32.us:                                 ; preds = %middle.block.._crit_edge32.us_crit_edge, %._crit_edge32.us.loopexit
  ...
  %90 = icmp slt i64 %indvars.iv.next62, %29
...
.preheader9.us.preheader:                         ; preds = %.preheader9.lr.ph
  ...
  %99 = sext i32 %.promoted26 to i64
  %100 = and i32 %92, 1
  %101 = icmp eq i32 %100, 0
  %102 = icmp eq i32 %92, 1
  %sunkaddr105 = ptrtoint double* %95 to i64
  %sunkaddr = ptrtoint double* %95 to i64
  br label %.preheader9.us

.preheader9.us:                                   ; preds = %._crit_edge23.us..preheader9.us_crit_edge, %.preheader9.us.preheader
  %indvars.iv55 = phi i64 [ %99, %.preheader9.us.preheader ], [ %indvars.iv.next56, %._crit_edge23.us..preheader9.us_crit_edge ]
  br i1 %101, label %.preheader9.us..prol.loopexit66_crit_edge, label %.prol.preheader65
...
.prol.preheader65:                                ; preds = %.preheader9.us
  ...
  %103 = load double, double* %sunkaddr104, align 8
  %104 = getelementptr inbounds [2000 x double], [2000 x double]* %97, i64 0, i64 %indvars.iv55
  %105 = load double, double* %104, align 8
  %106 = fmul double %96, %105
  %107 = load double, double* %98, align 8
  %108 = fmul double %106, %107
  %109 = fadd double %103, %108
  store double %109, double* %sunkaddr104, align 8
  br label %.prol.loopexit66
...
.prol.loopexit66:                                 ; preds = %.preheader9.us..prol.loopexit66_crit_edge, %.prol.preheader65
  ...
  br i1 %102, label %.prol.loopexit66.._crit_edge23.us_crit_edge, label %.preheader9.us.new.preheader
...
.preheader9.us.new.preheader:                     ; preds = %.prol.loopexit66
  %sunkaddr106 = shl i64 %indvars.iv55, 3
...
.preheader9.us.new:                               ; preds = %.preheader9.us.new..preheader9.us.new_crit_edge, %.preheader9.us.new.preheader
  ...
  %110 = load double, double* %sunkaddr108, align 8
  %111 = getelementptr inbounds [2000 x double], [2000 x double]* %97, i64 %indvars.iv51, i64 %indvars.iv55
  %112 = load double, double* %111, align 8
  %113 = fmul double %96, %112
  %114 = getelementptr inbounds double, double* %98, i64 %indvars.iv51
  %115 = load double, double* %114, align 8
  %116 = fmul double %113, %115
  %117 = fadd double %110, %116
  store double %117, double* %sunkaddr108, align 8
  %indvars.iv.next52 = add nuw nsw i64 %indvars.iv51, 1
  %118 = getelementptr inbounds [2000 x double], [2000 x double]* %97, i64 %indvars.iv.next52, i64 %indvars.iv55
  %119 = load double, double* %118, align 8
  %120 = fmul double %96, %119
  %121 = getelementptr inbounds double, double* %98, i64 %indvars.iv.next52
  %122 = load double, double* %121, align 8
  %123 = fmul double %120, %122
  %124 = fadd double %117, %123
  store double %124, double* %sunkaddr108, align 8
...
._crit_edge23.us:                                 ; preds = %.prol.loopexit66.._crit_edge23.us_crit_edge, %._crit_edge23.us.loopexit
  ...
  %125 = icmp slt i64 %indvars.iv.next56, %93
...
.preheader.lr.ph:                                 ; preds = %.preheader7
  ...
  %136 = load [2000 x double]*, [2000 x double]** %16, align 8
  %137 = load double*, double** %22, align 8
  %.promoted14 = load i32, i32* %25, align 4
  br i1 %133, label %.preheader.us.preheader, label %._crit_edge13.loopexit39

.preheader.us.preheader:                          ; preds = %.preheader.lr.ph
  %138 = sext i32 %.promoted14 to i64
  %139 = and i32 %131, 1
  %140 = icmp eq i32 %139, 0
  %141 = icmp eq i32 %131, 1
  %sunkaddr113 = ptrtoint double* %134 to i64
  %sunkaddr109 = ptrtoint double* %134 to i64
  br label %.preheader.us

.preheader.us:                                    ; preds = %._crit_edge.us..preheader.us_crit_edge, %.preheader.us.preheader
  %indvars.iv48 = phi i64 [ %138, %.preheader.us.preheader ], [ %indvars.iv.next49, %._crit_edge.us..preheader.us_crit_edge ]
  br i1 %140, label %.preheader.us..prol.loopexit_crit_edge, label %.prol.preheader
...
.prol.preheader:                                  ; preds = %.preheader.us
  ...
  %142 = load double, double* %sunkaddr112, align 8
  %143 = getelementptr inbounds [2000 x double], [2000 x double]* %136, i64 %indvars.iv48, i64 0
  %144 = load double, double* %143, align 8
  %145 = fmul double %135, %144
  %146 = load double, double* %137, align 8
  %147 = fmul double %145, %146
  %148 = fadd double %142, %147
  store double %148, double* %sunkaddr112, align 8
  br label %.prol.loopexit
...
.prol.loopexit:                                   ; preds = %.preheader.us..prol.loopexit_crit_edge, %.prol.preheader
  ...
  br i1 %141, label %.prol.loopexit.._crit_edge.us_crit_edge, label %.preheader.us.new.preheader

.prol.loopexit.._crit_edge.us_crit_edge:          ; preds = %.prol.loopexit
  br label %._crit_edge.us

.preheader.us.new.preheader:                      ; preds = %.prol.loopexit
  %sunkaddr114 = shl i64 %indvars.iv48, 3
...
.preheader.us.new:                                ; preds = %.preheader.us.new..preheader.us.new_crit_edge, %.preheader.us.new.preheader
  ...
  %149 = load double, double* %sunkaddr116, align 8
  %150 = getelementptr inbounds [2000 x double], [2000 x double]* %136, i64 %indvars.iv48, i64 %indvars.iv
  %151 = load double, double* %150, align 8
  %152 = fmul double %135, %151
  %153 = getelementptr inbounds double, double* %137, i64 %indvars.iv
  %154 = load double, double* %153, align 8
  %155 = fmul double %152, %154
  %156 = fadd double %149, %155
  store double %156, double* %sunkaddr116, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %157 = getelementptr inbounds [2000 x double], [2000 x double]* %136, i64 %indvars.iv48, i64 %indvars.iv.next
  %158 = load double, double* %157, align 8
  %159 = fmul double %135, %158
  %160 = getelementptr inbounds double, double* %137, i64 %indvars.iv.next
  %161 = load double, double* %160, align 8
  %162 = fmul double %159, %161
  %163 = fadd double %156, %162
  store double %163, double* %sunkaddr116, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
...
._crit_edge.us:                                   ; preds = %.prol.loopexit.._crit_edge.us_crit_edge, %._crit_edge.us.loopexit
  ...
  %164 = icmp slt i64 %indvars.iv.next49, %132
...
define internal fastcc void @print_array(i32, double*) unnamed_addr #0 {
  ...
  br i1 %11, label %.lr.ph, label %.._crit_edge4_crit_edge
...
._crit_edge._crit_edge:                           ; preds = %._crit_edge.._crit_edge._crit_edge_crit_edge, %.lr.ph
  %indvars.iv = phi i64 [ %14, %.lr.ph ], [ %indvars.iv.next, %._crit_edge.._crit_edge._crit_edge_crit_edge ]
  %storemerge1 = phi i32 [ 0, %.lr.ph ], [ %25, %._crit_edge.._crit_edge._crit_edge_crit_edge ]
  %16 = srem i32 %storemerge1, 20
  %17 = icmp eq i32 %16, 0
  br i1 %17, label %18, label %._crit_edge._crit_edge.._crit_edge_crit_edge
...
._crit_edge:                                      ; preds = %._crit_edge._crit_edge.._crit_edge_crit_edge, %18
  ...
  br i1 %24, label %._crit_edge.._crit_edge._crit_edge_crit_edge, label %._crit_edge3
