...
._crit_edge7:                                     ; preds = %15, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %15 ]
  %2 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv1, i64 %indvars.iv
  %3 = add nuw nsw i64 %indvars.iv, %indvars.iv1
  ...
  %9 = srem i32 %4, 11
  %10 = icmp eq i32 %9, 0
  %or.cond6 = or i1 %or.cond, %10
  br i1 %or.cond6, label %15, label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge7
  %11 = mul nuw nsw i64 %indvars.iv, %indvars.iv1
  %12 = trunc i64 %11 to i32
  %13 = srem i32 %12, 7
  %14 = add nsw i32 %13, 1
  br label %15

; <label>:15:                                     ; preds = %._crit_edge7, %._crit_edge
  %storemerge = phi i32 [ %14, %._crit_edge ], [ 999, %._crit_edge7 ]
...
.preheader:                                       ; preds = %18, %.preheader31
  %indvars.iv1 = phi i64 [ 0, %.preheader31 ], [ %indvars.iv.next2, %18 ]
  %2 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv1, i64 %indvars.iv3
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %._crit_edge, %.preheader
  ...
  %13 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv3, i64 %indvars.iv.next
...
; <label>:19:                                     ; preds = %18
  ...
  br i1 %exitcond5, label %20, label %.preheader31
