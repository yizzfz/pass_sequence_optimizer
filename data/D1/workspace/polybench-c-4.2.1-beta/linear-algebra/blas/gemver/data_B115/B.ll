...
.preheader65.preheader:                           ; preds = %36
  br label %.preheader65

.preheader65:                                     ; preds = %53, %.preheader65.preheader
  %indvars.iv10 = phi i64 [ 0, %.preheader65.preheader ], [ %indvars.iv.next11, %53 ]
  %37 = getelementptr inbounds double, double* %8, i64 %indvars.iv10
  %.pre = load double, double* %37, align 8
  br label %._crit_edge20

._crit_edge20:                                    ; preds = %._crit_edge20, %.preheader65
  %38 = phi double [ %.pre, %.preheader65 ], [ %52, %._crit_edge20 ]
  %indvars.iv7 = phi i64 [ 0, %.preheader65 ], [ %indvars.iv.next8.1, %._crit_edge20 ]
...
.preheader:                                       ; preds = %95, %.preheader.preheader
  %indvars.iv1 = phi i64 [ 0, %.preheader.preheader ], [ %indvars.iv.next2, %95 ]
  %79 = getelementptr inbounds double, double* %7, i64 %indvars.iv1
  %.pre19 = load double, double* %79, align 8
  br label %._crit_edge22

._crit_edge22:                                    ; preds = %._crit_edge22, %.preheader
  %80 = phi double [ %.pre19, %.preheader ], [ %94, %._crit_edge22 ]
  ...
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %95, label %._crit_edge22

; <label>:95:                                     ; preds = %._crit_edge22
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 2000
