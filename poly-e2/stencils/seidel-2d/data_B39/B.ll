...
for.body3.us:                                     ; preds = %for.body3.us.preheader, %for.body3.us
  %indvars.iv = phi i64 [ %3, %for.body3.us ], [ %indvars.iv.unr.ph, %for.body3.us.preheader ]
  ...
  %7 = bitcast double* %arrayidx8.us to <2 x double>*
  store <2 x double> %div.us, <2 x double>* %7, align 8
  %exitcond.1 = icmp eq i64 %3, %wide.trip.count8
...
for.body8:                                        ; preds = %for.body8, %for.cond5.preheader
  %3 = phi double [ %11, %for.body8 ], [ %.pre18, %for.cond5.preheader ]
  %4 = phi double [ %3, %for.body8 ], [ %.pre17, %for.cond5.preheader ]
  %5 = phi double [ %10, %for.body8 ], [ %.pre16, %for.cond5.preheader ]
  %6 = phi double [ %div, %for.body8 ], [ %.pre15, %for.cond5.preheader ]
  %7 = phi double [ %9, %for.body8 ], [ %.pre14, %for.cond5.preheader ]
