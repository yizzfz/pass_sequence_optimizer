...
@__llvm_prf_nm = private constant [85 x i8] c"\8B\01Rx\DA]\CB[\0E\80 \0CD\D1\B86\16\D2\14\1D\15\14!m\8Dq\F7\C6\C7\87\F09'sc\C1DN\C0\06\97S\11\A8v\F1\B6\01j\92O\EA+e\9F\C5\1A\D3\BD<\8B\8C\FD\8A\0F\C7\B0\05\9D\9B\E7!\C1@\89e\81\FC\E5\0D/\14\087>", section "__llvm_prf_names"
@llvm.used = appending global [9 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_CreateCompress to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_destroy_compress to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_abort_compress to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_suppress_tables to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_finish_compress to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_write_marker to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_write_tables to i8*), i8* bitcast ([19 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([85 x i8], [85 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
