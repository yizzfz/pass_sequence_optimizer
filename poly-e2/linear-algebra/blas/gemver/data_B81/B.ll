...
if.then:                                          ; preds = %land.lhs.true
  ...
  call void @print_array(double* %3)
  br label %if.end
...
for.cond35.for.cond.loopexit_crit_edge.us:        ; preds = %for.inc.us
  %exitcond = icmp eq i64 %indvars.iv.next35, 2000
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc20_crit_edge.us, %entry
  %indvars.iv83 = phi i64 [ 0, %entry ], [ %0, %for.cond1.for.inc20_crit_edge.us ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %5 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv83, i64 %offset.idx
  ...
  %16 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv83, i64 %15
  ...
  br i1 %23, label %for.cond1.for.inc20_crit_edge.us.loopexit88, label %vector.body, !llvm.loop !13

for.inc.us:                                       ; preds = %for.inc.us.preheader, %for.inc.us
  %indvars.iv79 = phi i64 [ %indvars.iv.next80.1, %for.inc.us ], [ 0, %for.inc.us.preheader ]
  %arrayidx5.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv83, i64 %indvars.iv79
  %24 = load double, double* %arrayidx5.us, align 8
  %25 = load double, double* %arrayidx7.us, align 8
  %arrayidx9.us = getelementptr inbounds double, double* %v1, i64 %indvars.iv79
  ...
  %arrayidx13.us = getelementptr inbounds double, double* %v2, i64 %indvars.iv79
  ...
  %arrayidx5.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv83, i64 %indvars.iv.next80
  %29 = load double, double* %arrayidx5.us.1, align 8
  %30 = load double, double* %arrayidx7.us, align 8
  %arrayidx9.us.1 = getelementptr inbounds double, double* %v1, i64 %indvars.iv.next80
  ...
  %arrayidx13.us.1 = getelementptr inbounds double, double* %v2, i64 %indvars.iv.next80
...
for.cond1.for.inc20_crit_edge.us.loopexit88:      ; preds = %vector.body
  br label %for.cond1.for.inc20_crit_edge.us

for.cond1.for.inc20_crit_edge.us:                 ; preds = %for.cond1.for.inc20_crit_edge.us.loopexit88, %for.cond1.for.inc20_crit_edge.us.loopexit
  %exitcond95 = icmp eq i64 %0, 2000
  br i1 %exitcond95, label %for.cond26.preheader.us.preheader, label %for.cond1.preheader.us
...
for.cond26.preheader.us:                          ; preds = %for.cond26.preheader.us.preheader, %for.cond26.for.inc45_crit_edge.us
  %indvars.iv75 = phi i64 [ %indvars.iv.next76, %for.cond26.for.inc45_crit_edge.us ], [ 0, %for.cond26.preheader.us.preheader ]
  %arrayidx30.us = getelementptr inbounds double, double* %x, i64 %indvars.iv75
  %.pre = load double, double* %arrayidx30.us, align 8
  br label %for.inc42.us

for.inc42.us:                                     ; preds = %for.cond26.preheader.us, %for.inc42.us
  %indvars.iv71 = phi i64 [ %indvars.iv.next72.1, %for.inc42.us ], [ 0, %for.cond26.preheader.us ]
  %34 = phi double [ %add39.us.1, %for.inc42.us ], [ %.pre, %for.cond26.preheader.us ]
  %arrayidx34.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv71, i64 %indvars.iv75
  ...
  %sunkaddr80 = mul i64 %indvars.iv75, 8
  %sunkaddr81 = add i64 %sunkaddr, %sunkaddr80
  %sunkaddr82 = inttoptr i64 %sunkaddr81 to double*
  store double %add39.us, double* %sunkaddr82, align 8
  %indvars.iv.next72 = or i64 %indvars.iv71, 1
  %arrayidx34.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv.next72, i64 %indvars.iv75
...
vector.body31:                                    ; preds = %vector.body31.preheader, %vector.body31
  ...
  br i1 %54, label %for.cond64.preheader.us.preheader.loopexit87, label %vector.body31, !llvm.loop !22

for.cond64.preheader.us.preheader.loopexit:       ; preds = %for.inc58
  br label %for.cond64.preheader.us.preheader

for.cond64.preheader.us.preheader.loopexit87:     ; preds = %vector.body31
  br label %for.cond64.preheader.us.preheader

for.cond64.preheader.us.preheader:                ; preds = %for.cond64.preheader.us.preheader.loopexit87, %for.cond64.preheader.us.preheader.loopexit
...
for.cond64.preheader.us:                          ; preds = %for.cond64.preheader.us.preheader, %for.cond64.for.inc83_crit_edge.us
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.cond64.for.inc83_crit_edge.us ], [ 0, %for.cond64.preheader.us.preheader ]
  %arrayidx68.us = getelementptr inbounds double, double* %w, i64 %indvars.iv63
...
for.inc80.us:                                     ; preds = %for.cond64.preheader.us, %for.inc80.us
  ...
  %55 = phi double [ %add77.us.1, %for.inc80.us ], [ %.pre62, %for.cond64.preheader.us ]
  %arrayidx72.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv63, i64 %indvars.iv
  ...
  %sunkaddr83 = ptrtoint double* %w to i64
  %sunkaddr84 = mul i64 %indvars.iv63, 8
  %sunkaddr85 = add i64 %sunkaddr83, %sunkaddr84
  %sunkaddr86 = inttoptr i64 %sunkaddr85 to double*
  store double %add77.us, double* %sunkaddr86, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx72.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv63, i64 %indvars.iv.next
  ...
  store double %add77.us.1, double* %sunkaddr86, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
...
for.inc58:                                        ; preds = %for.inc58.preheader, %for.inc58
  %indvars.iv67 = phi i64 [ %indvars.iv.next68.3, %for.inc58 ], [ 0, %for.inc58.preheader ]
  %arrayidx52 = getelementptr inbounds double, double* %x, i64 %indvars.iv67
  %60 = load double, double* %arrayidx52, align 8
  %arrayidx54 = getelementptr inbounds double, double* %z, i64 %indvars.iv67
  ...
  %arrayidx52.1 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next68
  %62 = load double, double* %arrayidx52.1, align 8
  %arrayidx54.1 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next68
  ...
  %arrayidx52.2 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next68.1
  %64 = load double, double* %arrayidx52.2, align 8
  %arrayidx54.2 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next68.1
  ...
  %arrayidx52.3 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next68.2
  %66 = load double, double* %arrayidx52.3, align 8
  %arrayidx54.3 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next68.2
  ...
  %exitcond70.3 = icmp eq i64 %indvars.iv.next68.3, 2000
  br i1 %exitcond70.3, label %for.cond64.preheader.us.preheader.loopexit, label %for.inc58, !llvm.loop !23
...
for.inc:                                          ; preds = %for.body, %if.then
  ...
  br i1 %exitcond7, label %for.end, label %for.body
