...
for.body.us.new:                                  ; preds = %for.body.lr.ph, %for.cond35.for.inc46_crit_edge.us
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.cond35.for.inc46_crit_edge.us ], [ 0, %for.body.lr.ph ]
  %0 = trunc i64 %indvars.iv35 to i32
  %conv2.us = sitofp i32 %0 to double
  %arrayidx.us = getelementptr inbounds double, double* %u1, i64 %indvars.iv35
  store double %conv2.us, double* %arrayidx.us, align 8
  %indvars.iv.next36 = add nuw nsw i64 %indvars.iv35, 1
  %1 = trunc i64 %indvars.iv.next36 to i32
  %conv3.us = sitofp i32 %1 to double
  %arrayidx6.us = getelementptr inbounds double, double* %u2, i64 %indvars.iv35
  %2 = insertelement <2 x double> undef, double %conv3.us, i32 0
  %div.us.v.i0.2 = shufflevector <2 x double> %2, <2 x double> undef, <2 x i32> zeroinitializer
  %div.us = fdiv <2 x double> %div.us.v.i0.2, <double 2.000000e+03, double 2.000000e+03>
  %div4.us = fmul <2 x double> %div.us, <double 5.000000e-01, double 2.500000e-01>
  ...
  %arrayidx12.us = getelementptr inbounds double, double* %v1, i64 %indvars.iv35
  store double %div4.us.v.r2, double* %arrayidx12.us, align 8
  %arrayidx18.us = getelementptr inbounds double, double* %v2, i64 %indvars.iv35
  %div21.us = fdiv double %conv3.us, 2.000000e+03
  %div22.us = fmul double %div21.us, 1.250000e-01
  %arrayidx24.us = getelementptr inbounds double, double* %y, i64 %indvars.iv35
  store double %div22.us, double* %arrayidx24.us, align 8
  %div16.us = fdiv <2 x double> %div.us, <double 6.000000e+00, double 9.000000e+00>
  ...
  %arrayidx30.us = getelementptr inbounds double, double* %z, i64 %indvars.iv35
  store double %div16.us.v.r2, double* %arrayidx30.us, align 8
  %arrayidx32.us = getelementptr inbounds double, double* %x, i64 %indvars.iv35
  store double 0.000000e+00, double* %arrayidx32.us, align 8
  %arrayidx34.us = getelementptr inbounds double, double* %w, i64 %indvars.iv35
...
for.inc.us:                                       ; preds = %for.inc.us, %for.body.us.new
  ...
  %3 = mul nuw nsw i64 %indvars.iv, %indvars.iv35
  %4 = trunc i64 %3 to i32
  %rem.us = srem i32 %4, 2000
  %conv39.us = sitofp i32 %rem.us to double
  %arrayidx45.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv35, i64 %indvars.iv
  %indvars.iv.next = or i64 %indvars.iv, 1
  %5 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv35
...
for.cond35.for.inc46_crit_edge.us:                ; preds = %for.inc.us
  ...
  br i1 %exitcond38, label %for.end48, label %for.body.us.new
...
for.cond1.preheader.us.new:                       ; preds = %for.cond1.preheader.us.preheader, %for.cond1.for.inc20_crit_edge.us
  %indvars.iv82 = phi i64 [ 0, %for.cond1.preheader.us.preheader ], [ %indvars.iv.next83, %for.cond1.for.inc20_crit_edge.us ]
  ...
  %arrayidx7.us = getelementptr inbounds double, double* %u1, i64 %indvars.iv82
  %arrayidx11.us = getelementptr inbounds double, double* %u2, i64 %indvars.iv82
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv82, i64 %offset.idx
  ...
  %18 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv82, i64 %17
  ...
  br i1 %31, label %for.cond1.for.inc20_crit_edge.us.loopexit75, label %vector.body, !llvm.loop !13
...
for.cond1.for.inc20_crit_edge.us.loopexit75:      ; preds = %vector.body
  br label %for.cond1.for.inc20_crit_edge.us

for.cond1.for.inc20_crit_edge.us:                 ; preds = %for.cond1.for.inc20_crit_edge.us.loopexit75, %for.cond1.for.inc20_crit_edge.us.loopexit
  %indvars.iv.next83 = add nuw nsw i64 %indvars.iv82, 1
  %exitcond85 = icmp eq i64 %indvars.iv.next83, 2000
  br i1 %exitcond85, label %for.cond26.preheader.us.new.preheader, label %for.cond1.preheader.us.new
...
for.cond26.preheader.us.new:                      ; preds = %for.cond26.preheader.us.new.preheader, %for.cond26.for.inc45_crit_edge.us
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %for.cond26.for.inc45_crit_edge.us ], [ 0, %for.cond26.preheader.us.new.preheader ]
  %arrayidx30.us = getelementptr inbounds double, double* %x, i64 %indvars.iv74
  %.pre = load double, double* %arrayidx30.us, align 8
  %sunkaddr67 = shl i64 %indvars.iv74, 3
...
for.inc42.us:                                     ; preds = %for.inc42.us, %for.cond26.preheader.us.new
  ...
  %indvars.iv70 = phi i64 [ 0, %for.cond26.preheader.us.new ], [ %indvars.iv.next71.1, %for.inc42.us ]
  ...
  store double %add39.us, double* %sunkaddr69, align 8
  ...
  store double %add39.us.1, double* %sunkaddr69, align 8
...
for.cond26.for.inc45_crit_edge.us:                ; preds = %for.inc42.us
  ...
  br i1 %exitcond77, label %vector.memcheck46, label %for.cond26.preheader.us.new
...
vector.body31:                                    ; preds = %vector.body31.preheader, %vector.body31
  ...
  br i1 %65, label %for.cond64.preheader.us.new.preheader.loopexit74, label %vector.body31, !llvm.loop !22

for.cond64.preheader.us.new.preheader.loopexit:   ; preds = %for.inc58
  br label %for.cond64.preheader.us.new.preheader

for.cond64.preheader.us.new.preheader.loopexit74: ; preds = %vector.body31
  br label %for.cond64.preheader.us.new.preheader

for.cond64.preheader.us.new.preheader:            ; preds = %for.cond64.preheader.us.new.preheader.loopexit74, %for.cond64.preheader.us.new.preheader.loopexit
  %sunkaddr70 = ptrtoint double* %w to i64
...
for.cond64.preheader.us.new:                      ; preds = %for.cond64.preheader.us.new.preheader, %for.cond64.for.inc83_crit_edge.us
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.cond64.for.inc83_crit_edge.us ], [ 0, %for.cond64.preheader.us.new.preheader ]
  %arrayidx68.us = getelementptr inbounds double, double* %w, i64 %indvars.iv62
  %.pre92 = load double, double* %arrayidx68.us, align 8
  %sunkaddr71 = shl i64 %indvars.iv62, 3
...
for.inc80.us:                                     ; preds = %for.inc80.us, %for.cond64.preheader.us.new
  %66 = phi double [ %.pre92, %for.cond64.preheader.us.new ], [ %add77.us.1, %for.inc80.us ]
  ...
  store double %add77.us, double* %sunkaddr73, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %add77.us.1, double* %sunkaddr73, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
...
for.cond64.for.inc83_crit_edge.us:                ; preds = %for.inc80.us
  ...
  br i1 %exitcond65, label %for.end85, label %for.cond64.preheader.us.new
...
for.inc58:                                        ; preds = %for.inc58.preheader, %for.inc58
  ...
  br i1 %exitcond69.3, label %for.cond64.preheader.us.new.preheader.loopexit, label %for.inc58, !llvm.loop !23
