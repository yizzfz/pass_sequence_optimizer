...
@__llvm_prf_nm = private constant [95 x i8] c"]\00sha_init\01sha_update\01tmp1.ll:byte_reverse\01tmp1.ll:sha_transform\01sha_final\01sha_stream\01sha_print", section "__llvm_prf_names"
@llvm.used = appending global [8 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_sha_init to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_sha_update to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_byte_reverse to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_sha_transform to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_sha_final to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_sha_stream to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_sha_print to i8*), i8* getelementptr inbounds ([95 x i8], [95 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
