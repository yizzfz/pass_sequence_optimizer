...
for.body.prol:                                    ; preds = %for.body.prol, %entry
  %indvars.iv35.prol = phi i64 [ 0, %entry ], [ %indvars.iv.next36.prol, %for.body.prol ]
...
for.body8.us:                                     ; preds = %for.body8.us, %for.cond5.preheader.us
  ...
  %exitcond39 = icmp eq i64 %indvars.iv, 1199
  br i1 %exitcond39, label %for.cond5.for.inc39_crit_edge.us, label %for.body8.us
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  %indvars.iv35 = phi i64 [ %indvars.iv.next36.7, %for.body ], [ 4, %for.body.preheader ]
  ...
  %14 = trunc i64 %indvars.iv.next36.1 to i32
  ...
  %20 = trunc i64 %indvars.iv.next36.3 to i32
  ...
  %22 = trunc i64 %indvars.iv.next36.4 to i32
  ...
  %25 = trunc i64 %indvars.iv.next36.5 to i32
  ...
  %27 = trunc i64 %indvars.iv.next36.6 to i32
...
for.cond10.preheader.us:                          ; preds = %for.cond10.preheader.us.preheader, %for.cond10.for.inc34_crit_edge.us
  ...
  %scevgep190 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %0, i64 0
  %scevgep193 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %0, i64 1200
  %scevgep196 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvar, i64 0
  %scevgep199 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %0, i64 1200
  %bound0201 = icmp ult double* %scevgep190, %scevgep199
  %bound1202 = icmp ult double* %scevgep196, %scevgep193
  %memcheck.conflict204 = and i1 %bound0201, %bound1202
  br i1 %memcheck.conflict204, label %for.body12.us.preheader, label %vector.body180.preheader

vector.body180.preheader:                         ; preds = %for.cond10.preheader.us
  br label %vector.body180

vector.body180:                                   ; preds = %vector.body180.preheader, %vector.body180
  %index207 = phi i64 [ %index.next208, %vector.body180 ], [ 0, %vector.body180.preheader ]
  %2 = shl i64 %index207, 1
  %3 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv87, i64 %2
  %4 = bitcast double* %3 to <4 x double>*
  %wide.vec216 = load <4 x double>, <4 x double>* %4, align 8, !alias.scope !3, !noalias !6
  %strided.vec217 = shufflevector <4 x double> %wide.vec216, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %strided.vec218 = shufflevector <4 x double> %wide.vec216, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %5 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv87, i64 %2
  %6 = bitcast double* %5 to <4 x double>*
  %wide.vec219 = load <4 x double>, <4 x double>* %6, align 8, !alias.scope !6
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %1, i64 %2
  %8 = bitcast double* %7 to <4 x double>*
  %wide.vec222 = load <4 x double>, <4 x double>* %8, align 8, !alias.scope !6
  %9 = fsub <4 x double> %wide.vec219, %wide.vec222
  ...
  %18 = fsub <2 x double> %strided.vec218, %17
  %19 = getelementptr double, double* %14, i64 -1
  %20 = bitcast double* %19 to <4 x double>*
  %interleaved.vec225 = shufflevector <2 x double> %12, <2 x double> %18, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec225, <4 x double>* %20, align 8, !alias.scope !3, !noalias !6
  %index.next208 = add i64 %index207, 2
  %21 = icmp eq i64 %index.next208, 600
  br i1 %21, label %middle.block181, label %vector.body180, !llvm.loop !8
...
for.cond10.for.inc34_crit_edge.us:                ; preds = %for.cond10.for.inc34_crit_edge.us.loopexit, %middle.block181
...
for.body3:                                        ; preds = %for.cond1.preheader, %for.body3
  ...
  %sunkaddr256 = mul i64 %indvars.iv112, 8
  %sunkaddr257 = add i64 %sunkaddr, %sunkaddr256
  %sunkaddr258 = inttoptr i64 %sunkaddr257 to i64*
  %28 = load i64, i64* %sunkaddr258, align 8
  ...
  %30 = load i64, i64* %sunkaddr258, align 8
  ...
  %32 = load i64, i64* %sunkaddr258, align 8
  ...
  %34 = load i64, i64* %sunkaddr258, align 8
  ...
  %36 = load i64, i64* %sunkaddr258, align 8
  ...
  %38 = load i64, i64* %sunkaddr258, align 8
  ...
  %40 = load i64, i64* %sunkaddr258, align 8
  ...
  %42 = load i64, i64* %sunkaddr258, align 8
...
for.cond40.preheader.us:                          ; preds = %for.cond40.preheader.us.preheader, %for.cond40.for.inc66_crit_edge.us
  ...
  %scevgep149 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv99, i64 2
  %scevgep152 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv99, i64 1200
  %scevgep155 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv99, i64 1
  %scevgep158 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv99, i64 1200
  ...
  br i1 %memcheck.conflict163, label %for.body42.us.preheader, label %vector.body143.preheader

vector.body143.preheader:                         ; preds = %for.cond40.preheader.us
  br label %vector.body143

vector.body143:                                   ; preds = %vector.body143.preheader, %vector.body143
  %index166 = phi i64 [ %index.next167, %vector.body143 ], [ 0, %vector.body143.preheader ]
  %47 = shl i64 %index166, 1
  ...
  %strided.vec173 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  ...
  %wide.vec174 = load <4 x double>, <4 x double>* %52, align 8, !alias.scope !15
  ...
  %53 = fsub <2 x double> %strided.vec176, %strided.vec175
  ...
  %wide.vec177 = load <4 x double>, <4 x double>* %60, align 8, !alias.scope !15
  %strided.vec178 = shufflevector <4 x double> %wide.vec177, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %strided.vec179 = shufflevector <4 x double> %wide.vec177, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %61 = fsub <2 x double> %strided.vec179, %strided.vec178
  %62 = fmul <2 x double> %61, <double 5.000000e-01, double 5.000000e-01>
  %63 = fsub <2 x double> %strided.vec173, %62
  ...
  %66 = icmp eq i64 %index.next167, 598
  br i1 %66, label %middle.block144, label %vector.body143, !llvm.loop !17

middle.block144:                                  ; preds = %vector.body143
  br label %for.body42.us.preheader

for.body42.us.preheader:                          ; preds = %middle.block144, %for.cond40.preheader.us
  %indvars.iv92.ph = phi i64 [ 2, %for.cond40.preheader.us ], [ 1198, %middle.block144 ]
...
for.cond73.preheader.us:                          ; preds = %for.cond73.preheader.us.preheader, %for.cond73.for.inc110_crit_edge.us
  ...
  %scevgep120 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv108, i64 1199
  %scevgep122 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv108, i64 0
  %74 = add i64 %indvars.iv108, 1
  %scevgep124 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %74, i64 0
  %scevgep126 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %indvars.iv108, i64 0
  %scevgep128 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %74, i64 1199
  %indvars.iv.next109 = add nuw nsw i64 %indvars.iv108, 1
  %bound0 = icmp ult double* %scevgep, %scevgep124
  %bound1 = icmp ult double* %scevgep122, %scevgep120
  %found.conflict = and i1 %bound0, %bound1
  %bound0130 = icmp ult double* %scevgep, %scevgep128
  %bound1131 = icmp ult double* %scevgep126, %scevgep120
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load134 = load <2 x double>, <2 x double>* %78, align 8, !alias.scope !19, !noalias !22
  %79 = or i64 %index, 1
  %80 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv108, i64 %79
  %81 = bitcast double* %80 to <2 x double>*
  %wide.load135 = load <2 x double>, <2 x double>* %81, align 8, !alias.scope !25
  %82 = getelementptr double, double* %80, i64 2
  %83 = bitcast double* %82 to <2 x double>*
  %wide.load136 = load <2 x double>, <2 x double>* %83, align 8, !alias.scope !25
  %84 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv108, i64 %index
  %85 = bitcast double* %84 to <2 x double>*
  %wide.load137 = load <2 x double>, <2 x double>* %85, align 8, !alias.scope !25
  %86 = getelementptr double, double* %84, i64 2
  %87 = bitcast double* %86 to <2 x double>*
  %wide.load138 = load <2 x double>, <2 x double>* %87, align 8, !alias.scope !25
  %88 = fsub <2 x double> %wide.load135, %wide.load137
  %89 = fsub <2 x double> %wide.load136, %wide.load138
  %90 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv.next109, i64 %index
  %91 = bitcast double* %90 to <2 x double>*
  %wide.load139 = load <2 x double>, <2 x double>* %91, align 8, !alias.scope !26
  %92 = getelementptr double, double* %90, i64 2
  %93 = bitcast double* %92 to <2 x double>*
  %wide.load140 = load <2 x double>, <2 x double>* %93, align 8, !alias.scope !26
  %94 = fadd <2 x double> %88, %wide.load139
  %95 = fadd <2 x double> %89, %wide.load140
  %96 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv108, i64 %index
  %97 = bitcast double* %96 to <2 x double>*
  %wide.load141 = load <2 x double>, <2 x double>* %97, align 8, !alias.scope !26
  %98 = getelementptr double, double* %96, i64 2
  %99 = bitcast double* %98 to <2 x double>*
  %wide.load142 = load <2 x double>, <2 x double>* %99, align 8, !alias.scope !26
  %100 = fsub <2 x double> %94, %wide.load141
  %101 = fsub <2 x double> %95, %wide.load142
  ...
  %105 = fsub <2 x double> %wide.load134, %103
...
for.body76.us:                                    ; preds = %for.body76.us.preheader, %for.body76.us
  ...
  %exitcond116 = icmp eq i64 %indvars.iv104, 1198
  br i1 %exitcond116, label %for.cond73.for.inc110_crit_edge.us, label %for.body76.us, !llvm.loop !28
