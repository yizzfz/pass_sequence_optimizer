...
._crit_edge:                                      ; preds = %._crit_edge, %.preheader60
  %indvars.iv16 = phi i64 [ 0, %.preheader60 ], [ %indvars.iv.next17, %._crit_edge ]
...
.preheader58:                                     ; preds = %.preheader58.preheader, %20
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %20 ], [ 0, %.preheader58.preheader ]
  br label %._crit_edge22

._crit_edge22:                                    ; preds = %._crit_edge22, %.preheader58
  %indvars.iv10 = phi i64 [ 0, %.preheader58 ], [ %indvars.iv.next11, %._crit_edge22 ]
  ...
  br i1 %exitcond12, label %20, label %._crit_edge22
...
.preheader56:                                     ; preds = %.preheader56.preheader, %28
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %28 ], [ 0, %.preheader56.preheader ]
  br label %._crit_edge24

._crit_edge24:                                    ; preds = %._crit_edge24, %.preheader56
  %indvars.iv4 = phi i64 [ 0, %.preheader56 ], [ %indvars.iv.next5, %._crit_edge24 ]
...
._crit_edge26:                                    ; preds = %._crit_edge26, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %._crit_edge26 ]
  ...
  br i1 %exitcond, label %37, label %._crit_edge26
...
.preheader71:                                     ; preds = %23, %7
  %indvars.iv25 = phi i64 [ 0, %7 ], [ %indvars.iv.next26, %23 ]
  br label %._crit_edge28

._crit_edge28:                                    ; preds = %22, %.preheader71
  %indvars.iv21 = phi i64 [ 0, %.preheader71 ], [ %indvars.iv.next22, %22 ]
  %8 = getelementptr inbounds [900 x double], [900 x double]* %0, i64 %indvars.iv25, i64 %indvars.iv21
  store double 0.000000e+00, double* %8, align 8
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge28
  %indvars.iv18 = phi i64 [ 0, %._crit_edge28 ], [ %indvars.iv.next19.1, %._crit_edge ]
  %9 = phi double [ 0.000000e+00, %._crit_edge28 ], [ %21, %._crit_edge ]
  %10 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv25, i64 %indvars.iv18
  %11 = load double, double* %10, align 8
  %12 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv18, i64 %indvars.iv21
  %13 = load double, double* %12, align 8
  %14 = fmul double %11, %13
  %15 = fadd double %9, %14
  store double %15, double* %8, align 8
  %indvars.iv.next19 = or i64 %indvars.iv18, 1
  %16 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv25, i64 %indvars.iv.next19
  %17 = load double, double* %16, align 8
  %18 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv.next19, i64 %indvars.iv21
  ...
  br i1 %exitcond20.1, label %22, label %._crit_edge

; <label>:22:                                     ; preds = %._crit_edge
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  %exitcond23 = icmp eq i64 %indvars.iv.next22, 900
  br i1 %exitcond23, label %23, label %._crit_edge28

; <label>:23:                                     ; preds = %22
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  %exitcond27 = icmp eq i64 %indvars.iv.next26, 800
  br i1 %exitcond27, label %.preheader69.preheader, label %.preheader71

.preheader69.preheader:                           ; preds = %23
  br label %.preheader69

.preheader69:                                     ; preds = %.preheader69.preheader, %45
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %45 ], [ 0, %.preheader69.preheader ]
  br label %._crit_edge30

._crit_edge30:                                    ; preds = %44, %.preheader69
  %indvars.iv11 = phi i64 [ 0, %.preheader69 ], [ %indvars.iv.next12, %44 ]
  %24 = getelementptr inbounds [1100 x double], [1100 x double]* %3, i64 %indvars.iv15, i64 %indvars.iv11
  store double 0.000000e+00, double* %24, align 8
  br label %._crit_edge29

._crit_edge29:                                    ; preds = %._crit_edge29, %._crit_edge30
  %indvars.iv8 = phi i64 [ 0, %._crit_edge30 ], [ %indvars.iv.next9.2, %._crit_edge29 ]
  %25 = phi double [ 0.000000e+00, %._crit_edge30 ], [ %43, %._crit_edge29 ]
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv15, i64 %indvars.iv8
  %27 = load double, double* %26, align 8
  %28 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv8, i64 %indvars.iv11
  %29 = load double, double* %28, align 8
  %30 = fmul double %27, %29
  %31 = fadd double %25, %30
  store double %31, double* %24, align 8
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  %32 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv15, i64 %indvars.iv.next9
  %33 = load double, double* %32, align 8
  %34 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv.next9, i64 %indvars.iv11
  %35 = load double, double* %34, align 8
  %36 = fmul double %33, %35
  %37 = fadd double %31, %36
  store double %37, double* %24, align 8
  %indvars.iv.next9.1 = add nsw i64 %indvars.iv8, 2
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv15, i64 %indvars.iv.next9.1
  %39 = load double, double* %38, align 8
  %40 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv.next9.1, i64 %indvars.iv11
  %41 = load double, double* %40, align 8
  %42 = fmul double %39, %41
  %43 = fadd double %37, %42
  store double %43, double* %24, align 8
  %indvars.iv.next9.2 = add nsw i64 %indvars.iv8, 3
  %exitcond10.2 = icmp eq i64 %indvars.iv.next9.2, 1200
  br i1 %exitcond10.2, label %44, label %._crit_edge29

; <label>:44:                                     ; preds = %._crit_edge29
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond13 = icmp eq i64 %indvars.iv.next12, 1100
  br i1 %exitcond13, label %45, label %._crit_edge30

; <label>:45:                                     ; preds = %44
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  %exitcond17 = icmp eq i64 %indvars.iv.next16, 900
  br i1 %exitcond17, label %.preheader.preheader, label %.preheader69

.preheader.preheader:                             ; preds = %45
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %67
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %67 ], [ 0, %.preheader.preheader ]
  br label %._crit_edge33

._crit_edge33:                                    ; preds = %66, %.preheader
  %indvars.iv1 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next2, %66 ]
  %46 = getelementptr inbounds [1100 x double], [1100 x double]* %6, i64 %indvars.iv5, i64 %indvars.iv1
  store double 0.000000e+00, double* %46, align 8
  br label %._crit_edge32

._crit_edge32:                                    ; preds = %._crit_edge32, %._crit_edge33
  %indvars.iv = phi i64 [ 0, %._crit_edge33 ], [ %indvars.iv.next.2, %._crit_edge32 ]
  %47 = phi double [ 0.000000e+00, %._crit_edge33 ], [ %65, %._crit_edge32 ]
  %48 = getelementptr inbounds [900 x double], [900 x double]* %0, i64 %indvars.iv5, i64 %indvars.iv
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %54 = getelementptr inbounds [900 x double], [900 x double]* %0, i64 %indvars.iv5, i64 %indvars.iv.next
  ...
  %60 = getelementptr inbounds [900 x double], [900 x double]* %0, i64 %indvars.iv5, i64 %indvars.iv.next.1
  ...
  br i1 %exitcond.2, label %66, label %._crit_edge32

; <label>:66:                                     ; preds = %._crit_edge32
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 1100
  br i1 %exitcond3, label %67, label %._crit_edge33

; <label>:67:                                     ; preds = %66
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1
  %exitcond7 = icmp eq i64 %indvars.iv.next6, 800
  br i1 %exitcond7, label %68, label %.preheader
