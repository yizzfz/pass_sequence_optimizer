...
for.body.us:                                      ; preds = %for.body.us.preheader, %for.cond35.for.cond.loopexit_crit_edge.us
  ...
  %conv2.us = sitofp i32 %2 to double
  ...
  %3 = trunc i64 %indvars.iv.next7 to i32
  %conv3.us = sitofp i32 %3 to double
...
for.body38.us.prol.loopexit:                      ; preds = %for.body38.us.prol, %for.body.us
  ...
  br i1 %1, label %for.cond35.for.cond.loopexit_crit_edge.us, label %for.body38.us.preheader
...
for.cond1.preheader.us.preheader:                 ; preds = %entry
  ...
  %scevgep59 = getelementptr double, double* %v1, i64 2
  %scevgep64 = getelementptr double, double* %v2, i64 2
...
for.cond1.preheader.us:                           ; preds = %for.cond1.preheader.us.preheader, %for.cond1.for.inc20_crit_edge.us
  ...
  %scevgep54 = getelementptr [2000 x double], [2000 x double]* %A, i64 %indvars.iv40, i64 2
...
for.body3.us.prol:                                ; preds = %for.cond1.preheader.us
  ...
  %6 = load double, double* %v1, align 8
  %mul.us.prol = fmul double %5, %6
  %add.us.prol = fadd double %4, %mul.us.prol
  %7 = load double, double* %arrayidx11.us, align 8
  %8 = load double, double* %v2, align 8
  %mul14.us.prol = fmul double %7, %8
...
for.body3.us.preheader:                           ; preds = %for.body3.us.prol.loopexit
  %9 = sub nsw i64 %2, %indvars.iv34.unr.ph
  %10 = lshr i64 %9, 1
  %11 = add nuw i64 %10, 1
  %min.iters.check = icmp ult i64 %11, 2
  br i1 %min.iters.check, label %for.body3.us.preheader132, label %min.iters.checked

min.iters.checked:                                ; preds = %for.body3.us.preheader
  %n.mod.vf = and i64 %11, 1
  %n.vec = sub i64 %11, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  br i1 %cmp.zero, label %for.body3.us.preheader132, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %scevgep52 = getelementptr [2000 x double], [2000 x double]* %A, i64 %indvars.iv40, i64 %indvars.iv34.unr.ph
  %12 = sub nsw i64 %3, %indvars.iv34.unr.ph
  %13 = and i64 %12, -2
  %14 = or i64 %indvars.iv34.unr.ph, %13
  %scevgep55 = getelementptr double, double* %scevgep54, i64 %14
  %scevgep57 = getelementptr double, double* %v1, i64 %indvars.iv34.unr.ph
  %scevgep60 = getelementptr double, double* %scevgep59, i64 %14
  %scevgep62 = getelementptr double, double* %v2, i64 %indvars.iv34.unr.ph
  %scevgep65 = getelementptr double, double* %scevgep64, i64 %14
  %bound0 = icmp ult double* %scevgep52, %arrayidx7.us
  %bound1 = icmp ult double* %arrayidx7.us, %scevgep55
  %found.conflict = and i1 %bound0, %bound1
  %bound068 = icmp ult double* %scevgep52, %scevgep60
  %bound169 = icmp ult double* %scevgep57, %scevgep55
  %found.conflict70 = and i1 %bound068, %bound169
  %conflict.rdx = or i1 %found.conflict, %found.conflict70
  %bound073 = icmp ult double* %scevgep52, %arrayidx11.us
  %bound174 = icmp ult double* %arrayidx11.us, %scevgep55
  %found.conflict75 = and i1 %bound073, %bound174
  %conflict.rdx76 = or i1 %conflict.rdx, %found.conflict75
  %bound077 = icmp ult double* %scevgep52, %scevgep65
  %bound178 = icmp ult double* %scevgep62, %scevgep55
  ...
  br i1 %conflict.rdx80, label %for.body3.us.preheader132, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %strided.vec81 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  ...
  %wide.vec82 = load <4 x double>, <4 x double>* %26, align 8, !alias.scope !10
  %strided.vec83 = shufflevector <4 x double> %wide.vec82, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %strided.vec84 = shufflevector <4 x double> %wide.vec82, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %27 = fmul <2 x double> %24, %strided.vec83
  ...
  %wide.vec85 = load <4 x double>, <4 x double>* %33, align 8, !alias.scope !12
  ...
  %34 = fmul <2 x double> %31, %strided.vec86
  ...
  %41 = fmul <2 x double> %40, %strided.vec84
  %42 = fadd <2 x double> %strided.vec81, %41
  ...
  %46 = fmul <2 x double> %45, %strided.vec87
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.cond1.for.inc20_crit_edge.us, label %for.body3.us.preheader132

for.body3.us.preheader132:                        ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.body3.us.preheader
...
for.body3.us:                                     ; preds = %for.body3.us.preheader132, %for.body3.us
  %indvars.iv34 = phi i64 [ %indvars.iv.next35.1, %for.body3.us ], [ %indvars.iv34.ph, %for.body3.us.preheader132 ]
...
for.body28.us.prol:                               ; preds = %for.cond26.preheader.us
  %63 = load double, double* %arrayidx30.us, align 8
...
for.body28.us.prol.loopexit:                      ; preds = %for.body28.us.prol, %for.cond26.preheader.us
  ...
  br i1 %62, label %for.cond26.for.inc45_crit_edge.us, label %for.body28.us.preheader
...
for.body28.us:                                    ; preds = %for.body28.us.preheader, %for.body28.us
  ...
  %67 = load double, double* %arrayidx34.us, align 8
  %mul35.us = fmul double %67, %beta
  %arrayidx37.us = getelementptr inbounds double, double* %y, i64 %indvars.iv24
  %68 = load double, double* %arrayidx37.us, align 8
  %mul38.us = fmul double %mul35.us, %68
  %add39.us = fadd double %66, %mul38.us
  ...
  %69 = load double, double* %arrayidx34.us.1, align 8
  %mul35.us.1 = fmul double %69, %beta
  %arrayidx37.us.1 = getelementptr inbounds double, double* %y, i64 %indvars.iv.next25
  %70 = load double, double* %arrayidx37.us.1, align 8
  %mul38.us.1 = fmul double %mul35.us.1, %70
...
for.cond26.for.inc45_crit_edge.us:                ; preds = %for.cond26.for.inc45_crit_edge.us.loopexit, %for.body28.us.prol.loopexit
  ...
  %exitcond = icmp eq i64 %indvars.iv.next31, %61
...
for.body50.prol.loopexit:                         ; preds = %for.body50.prol.loopexit.loopexit, %for.body50.preheader
  %indvars.iv18.unr = phi i64 [ 0, %for.body50.preheader ], [ %76, %for.body50.prol.loopexit.loopexit ]
  %77 = icmp ult i32 %71, 3
  br i1 %77, label %for.cond64.preheader.us.preheader, label %for.body50.preheader49

for.body50.preheader49:                           ; preds = %for.body50.prol.loopexit
  %wide.trip.count20.3 = zext i32 %n to i64
  %78 = add nsw i64 %wide.trip.count36.1, -4
  %79 = sub nsw i64 %78, %indvars.iv18.unr
  %80 = lshr i64 %79, 2
  %81 = add nuw nsw i64 %80, 1
  %min.iters.check91 = icmp ult i64 %81, 2
  br i1 %min.iters.check91, label %for.body50.preheader131, label %min.iters.checked92

for.body50.preheader131:                          ; preds = %middle.block89, %vector.memcheck109, %min.iters.checked92, %for.body50.preheader49
  %indvars.iv18.ph = phi i64 [ %indvars.iv18.unr, %vector.memcheck109 ], [ %indvars.iv18.unr, %min.iters.checked92 ], [ %indvars.iv18.unr, %for.body50.preheader49 ], [ %ind.end114, %middle.block89 ]
  br label %for.body50

min.iters.checked92:                              ; preds = %for.body50.preheader49
  %n.mod.vf93 = and i64 %81, 1
  %n.vec94 = sub nsw i64 %81, %n.mod.vf93
  %cmp.zero95 = icmp eq i64 %n.vec94, 0
  br i1 %cmp.zero95, label %for.body50.preheader131, label %vector.memcheck109

vector.memcheck109:                               ; preds = %min.iters.checked92
  %scevgep97 = getelementptr double, double* %x, i64 %indvars.iv18.unr
  %82 = add nsw i64 %wide.trip.count36.1, -4
  %83 = sub nsw i64 %82, %indvars.iv18.unr
  %84 = and i64 %83, -4
  %85 = add nsw i64 %indvars.iv18.unr, %84
  %86 = add nsw i64 %85, 4
  %scevgep99 = getelementptr double, double* %x, i64 %86
  %scevgep101 = getelementptr double, double* %z, i64 %indvars.iv18.unr
  %scevgep103 = getelementptr double, double* %z, i64 %86
  ...
  %87 = shl nuw i64 %80, 2
  %88 = add i64 %indvars.iv18.unr, %87
  %89 = add i64 %88, 4
  %90 = shl nuw nsw i64 %n.mod.vf93, 2
  %ind.end114 = sub i64 %89, %90
  br i1 %memcheck.conflict108, label %for.body50.preheader131, label %vector.body88.preheader

vector.body88.preheader:                          ; preds = %vector.memcheck109
  br label %vector.body88

vector.body88:                                    ; preds = %vector.body88.preheader, %vector.body88
  %index111 = phi i64 [ %index.next112, %vector.body88 ], [ 0, %vector.body88.preheader ]
  %91 = shl i64 %index111, 2
  %92 = add i64 %indvars.iv18.unr, %91
  %93 = getelementptr inbounds double, double* %x, i64 %92
  %94 = bitcast double* %93 to <8 x double>*
  %wide.vec120 = load <8 x double>, <8 x double>* %94, align 8, !alias.scope !19, !noalias !22
  %95 = getelementptr inbounds double, double* %z, i64 %92
  %96 = bitcast double* %95 to <8 x double>*
  %wide.vec125 = load <8 x double>, <8 x double>* %96, align 8, !alias.scope !22
  %97 = fadd <8 x double> %wide.vec120, %wide.vec125
  %98 = shufflevector <8 x double> %97, <8 x double> undef, <2 x i32> <i32 0, i32 4>
  %99 = fadd <8 x double> %wide.vec120, %wide.vec125
  %100 = shufflevector <8 x double> %99, <8 x double> undef, <2 x i32> <i32 1, i32 5>
  %101 = fadd <8 x double> %wide.vec120, %wide.vec125
  ...
  %105 = fadd <8 x double> %wide.vec120, %wide.vec125
  ...
  %interleaved.vec130 = shufflevector <4 x double> %109, <4 x double> %110, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 1, i32 3, i32 5, i32 7>
  store <8 x double> %interleaved.vec130, <8 x double>* %108, align 8, !alias.scope !19, !noalias !22
  %index.next112 = add i64 %index111, 2
  %111 = icmp eq i64 %index.next112, %n.vec94
  br i1 %111, label %middle.block89, label %vector.body88, !llvm.loop !24

middle.block89:                                   ; preds = %vector.body88
  %cmp.n115 = icmp eq i64 %n.mod.vf93, 0
  br i1 %cmp.n115, label %for.cond61.preheader, label %for.body50.preheader131

for.cond61.preheader.loopexit:                    ; preds = %for.body50
  br label %for.cond61.preheader

for.cond61.preheader:                             ; preds = %for.cond61.preheader.loopexit, %middle.block89
...
for.body66.us.prol:                               ; preds = %for.cond64.preheader.us
  %114 = load double, double* %arrayidx68.us, align 8
  %arrayidx72.us.prol = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv15, i64 0
  %115 = load double, double* %arrayidx72.us.prol, align 8
  %mul73.us.prol = fmul double %115, %alpha
  %116 = load double, double* %x, align 8
  %mul76.us.prol = fmul double %mul73.us.prol, %116
  %add77.us.prol = fadd double %114, %mul76.us.prol
...
for.body66.us.prol.loopexit:                      ; preds = %for.body66.us.prol, %for.cond64.preheader.us
  ...
  br i1 %113, label %for.cond64.for.inc83_crit_edge.us, label %for.body66.us.preheader
...
for.body66.us:                                    ; preds = %for.body66.us.preheader, %for.body66.us
  ...
  %117 = load double, double* %arrayidx68.us, align 8
  %arrayidx72.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv15, i64 %indvars.iv
  %118 = load double, double* %arrayidx72.us, align 8
  %mul73.us = fmul double %118, %alpha
  %arrayidx75.us = getelementptr inbounds double, double* %x, i64 %indvars.iv
  %119 = load double, double* %arrayidx75.us, align 8
  %mul76.us = fmul double %mul73.us, %119
  %add77.us = fadd double %117, %mul76.us
  ...
  %120 = load double, double* %arrayidx72.us.1, align 8
  %mul73.us.1 = fmul double %120, %alpha
  %arrayidx75.us.1 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next
  %121 = load double, double* %arrayidx75.us.1, align 8
  %mul76.us.1 = fmul double %mul73.us.1, %121
...
for.cond64.for.inc83_crit_edge.us:                ; preds = %for.cond64.for.inc83_crit_edge.us.loopexit, %for.body66.us.prol.loopexit
  ...
  %exitcond50 = icmp eq i64 %indvars.iv.next16, %112
...
for.body50:                                       ; preds = %for.body50.preheader131, %for.body50
  %indvars.iv18 = phi i64 [ %indvars.iv.next19.3, %for.body50 ], [ %indvars.iv18.ph, %for.body50.preheader131 ]
  ...
  %124 = load double, double* %arrayidx52.1, align 8
  %arrayidx54.1 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next19
  %125 = load double, double* %arrayidx54.1, align 8
  %add55.1 = fadd double %124, %125
  ...
  %126 = load double, double* %arrayidx52.2, align 8
  %arrayidx54.2 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next19.1
  %127 = load double, double* %arrayidx54.2, align 8
  %add55.2 = fadd double %126, %127
  ...
  %128 = load double, double* %arrayidx52.3, align 8
  %arrayidx54.3 = getelementptr inbounds double, double* %z, i64 %indvars.iv.next19.2
  %129 = load double, double* %arrayidx54.3, align 8
  %add55.3 = fadd double %128, %129
