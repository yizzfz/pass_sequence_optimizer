...
@__llvm_prf_nm = private constant [46 x i8] c"$,x\DA\CB\CA\CC\CB,\89\CF\CC+K-*N\8DOI.a,\C9-0\D4\CB\C9\B1*.I,*\89/H,.\06\00\06\F2\0E\1B", section "__llvm_prf_names"
@llvm.used = appending global [4 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jinit_inverse_dct to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_start_pass to i8*), i8* bitcast ([10 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([46 x i8], [46 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
