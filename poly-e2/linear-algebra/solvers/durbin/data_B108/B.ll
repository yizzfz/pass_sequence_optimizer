...
if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(double* %arraydecay32)
  br label %if.end
...
for.body8.lr.ph:                                  ; preds = %for.end44, %entry
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.end44 ], [ 1, %entry ]
  %indvars.iv29 = phi i64 [ %5, %for.end44 ], [ 0, %entry ]
...
for.body8.prol:                                   ; preds = %for.body8.prol, %for.body8.prol.preheader
  ...
  %sum.02.prol = phi double [ 0.000000e+00, %for.body8.prol.preheader ], [ %add.prol, %for.body8.prol ]
...
for.body8.prol.loopexit:                          ; preds = %for.body8.lr.ph, %for.body8.prol.loopexit.unr-lcssa
  ...
  %sum.02.unr = phi double [ 0.000000e+00, %for.body8.lr.ph ], [ %add.prol, %for.body8.prol.loopexit.unr-lcssa ]
  %10 = icmp ult i64 %indvars.iv29, 3
  br i1 %10, label %for.body21.lr.ph, label %for.body8.lr.ph.new
...
for.body8:                                        ; preds = %for.body8, %for.body8.lr.ph.new
  ...
  %sum.02 = phi double [ %sum.02.unr, %for.body8.lr.ph.new ], [ %add.3, %for.body8 ]
