...
for.cond4.preheader:                              ; preds = %for.cond4.preheader.preheader, %for.inc98
  ...
  %1 = add i64 %indvar68, 1
  %2 = add i64 %indvar68, 2
  br i1 %cmp63, label %for.cond8.preheader.lr.ph, label %for.inc98
...
for.cond8.preheader.us:                           ; preds = %for.cond8.for.inc95_crit_edge.us, %for.cond8.preheader.lr.ph
  ...
  %5 = add i64 %indvar70, 1
  %scevgep72 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %1, i64 %5, i64 1
  %scevgep74 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %1, i64 %5, i64 %wide.trip.count29
  %scevgep76 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvar68, i64 %5, i64 1
  %scevgep78 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %2, i64 %5, i64 %wide.trip.count29
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  %6 = add nsw i64 %indvars.iv15, -1
  br i1 %min.iters.check62, label %for.inc.us.preheader, label %min.iters.checked63

min.iters.checked63:                              ; preds = %for.cond8.preheader.us
  br i1 %cmp.zero66, label %for.inc.us.preheader, label %vector.memcheck84
...
vector.memcheck84:                                ; preds = %min.iters.checked63
  ...
  br i1 %memcheck.conflict83, label %for.inc.us.preheader, label %vector.body59.preheader
...
vector.body59:                                    ; preds = %vector.body59.preheader, %vector.body59
  ...
  %7 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %3, i64 %indvars.iv15, i64 %offset.idx91
  %8 = bitcast double* %7 to <2 x double>*
  %wide.load95 = load <2 x double>, <2 x double>* %8, align 8, !alias.scope !1
  %9 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv20, i64 %indvars.iv15, i64 %offset.idx91
  %10 = bitcast double* %9 to <2 x double>*
  %wide.load96 = load <2 x double>, <2 x double>* %10, align 8, !alias.scope !1
  %11 = fmul <2 x double> %wide.load96, <double 2.000000e+00, double 2.000000e+00>
  %12 = fsub <2 x double> %wide.load95, %11
  %13 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %4, i64 %indvars.iv15, i64 %offset.idx91
  %14 = bitcast double* %13 to <2 x double>*
  %wide.load97 = load <2 x double>, <2 x double>* %14, align 8, !alias.scope !1
  %15 = fadd <2 x double> %wide.load97, %12
  %16 = fmul <2 x double> %15, <double 1.250000e-01, double 1.250000e-01>
  %17 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv20, i64 %indvars.iv.next16, i64 %offset.idx91
  %18 = bitcast double* %17 to <2 x double>*
  %wide.load98 = load <2 x double>, <2 x double>* %18, align 8, !alias.scope !1
  %19 = fsub <2 x double> %wide.load98, %11
  %20 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv20, i64 %6, i64 %offset.idx91
  %21 = bitcast double* %20 to <2 x double>*
  %wide.load99 = load <2 x double>, <2 x double>* %21, align 8, !alias.scope !1
  %22 = fadd <2 x double> %19, %wide.load99
  %23 = fmul <2 x double> %22, <double 1.250000e-01, double 1.250000e-01>
  %24 = fadd <2 x double> %16, %23
  %25 = add nuw nsw i64 %offset.idx91, 1
  %26 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv20, i64 %indvars.iv15, i64 %25
  %27 = bitcast double* %26 to <2 x double>*
  %wide.load100 = load <2 x double>, <2 x double>* %27, align 8, !alias.scope !1
  %28 = fsub <2 x double> %wide.load100, %11
  %29 = add nsw i64 %offset.idx91, -1
  %30 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %indvars.iv20, i64 %indvars.iv15, i64 %29
  %31 = bitcast double* %30 to <2 x double>*
  %wide.load101 = load <2 x double>, <2 x double>* %31, align 8, !alias.scope !1
  %32 = fadd <2 x double> %28, %wide.load101
  %33 = fmul <2 x double> %32, <double 1.250000e-01, double 1.250000e-01>
  %34 = fadd <2 x double> %24, %33
  %35 = fadd <2 x double> %wide.load96, %34
  %36 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv20, i64 %indvars.iv15, i64 %offset.idx91
  %37 = bitcast double* %36 to <2 x double>*
  store <2 x double> %35, <2 x double>* %37, align 8, !alias.scope !4, !noalias !1
  %index.next87 = add i64 %index86, 2
  %38 = icmp eq i64 %index.next87, %n.vec65
  br i1 %38, label %middle.block60, label %vector.body59, !llvm.loop !6

middle.block60:                                   ; preds = %vector.body59
  br i1 %cmp.n90, label %for.cond8.for.inc95_crit_edge.us, label %for.inc.us.preheader

for.inc.us.preheader:                             ; preds = %middle.block60, %vector.memcheck84, %min.iters.checked63, %for.cond8.preheader.us
  %indvars.iv.ph = phi i64 [ 1, %vector.memcheck84 ], [ 1, %min.iters.checked63 ], [ 1, %for.cond8.preheader.us ], [ %ind.end89, %middle.block60 ]
  br label %for.inc.us
...
for.cond109.preheader.us:                         ; preds = %for.cond109.for.inc203_crit_edge.us, %for.cond109.preheader.lr.ph
  ...
  %51 = add i64 %indvar44, 1
  %scevgep = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %47, i64 %51, i64 1
  %scevgep47 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %A, i64 %47, i64 %51, i64 %wide.trip.count29
  %scevgep49 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvar, i64 %51, i64 1
  %scevgep51 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %48, i64 %51, i64 %wide.trip.count29
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load53 = load <2 x double>, <2 x double>* %56, align 8, !alias.scope !10
  %57 = fmul <2 x double> %wide.load53, <double 2.000000e+00, double 2.000000e+00>
  ...
  %wide.load54 = load <2 x double>, <2 x double>* %60, align 8, !alias.scope !10
  %61 = fadd <2 x double> %wide.load54, %58
  ...
  %wide.load55 = load <2 x double>, <2 x double>* %64, align 8, !alias.scope !10
  %65 = fsub <2 x double> %wide.load55, %57
  %66 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %B, i64 %indvars.iv36, i64 %52, i64 %offset.idx
  %67 = bitcast double* %66 to <2 x double>*
  %wide.load56 = load <2 x double>, <2 x double>* %67, align 8, !alias.scope !10
  %68 = fadd <2 x double> %65, %wide.load56
  ...
  %74 = fsub <2 x double> %wide.load57, %57
  ...
  %wide.load58 = load <2 x double>, <2 x double>* %77, align 8, !alias.scope !10
  %78 = fadd <2 x double> %74, %wide.load58
  %79 = fmul <2 x double> %78, <double 1.250000e-01, double 1.250000e-01>
  %80 = fadd <2 x double> %70, %79
  %81 = fadd <2 x double> %wide.load53, %80
...
for.inc200.us:                                    ; preds = %for.inc200.us.preheader, %for.inc200.us
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc200.us ], [ %indvars.iv26.ph, %for.inc200.us.preheader ]
  ...
  br i1 %exitcond30, label %for.cond109.for.inc203_crit_edge.us.loopexit, label %for.inc200.us, !llvm.loop !16
