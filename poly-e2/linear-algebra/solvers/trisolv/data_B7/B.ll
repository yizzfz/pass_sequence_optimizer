...
for.body:                                         ; preds = %for.inc14, %for.body.lr.ph
  ...
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc14 ], [ %4, %for.body.lr.ph ]
  %indvars.iv10 = phi i32 [ %indvars.iv.next11, %for.inc14 ], [ %i.promoted, %for.body.lr.ph ]
  %storemerge6 = phi i32 [ %15, %for.inc14 ], [ 0, %for.body.lr.ph ]
  %6 = add i32 %i.promoted, %indvar
  ...
  %conv = sitofp i32 %storemerge6 to double
  %arrayidx2 = getelementptr inbounds double, double* %1, i64 %idxprom
...
for.body6.prol:                                   ; preds = %for.body6.prol.preheader
  %sub.prol = add i32 %7, 1
  %add7.prol = add i32 %sub.prol, %2
  %conv8.prol = sitofp i32 %add7.prol to double
  %mul.prol = fmul double %conv8.prol, 2.000000e+00
  %div.prol = fdiv double %mul.prol, %conv9
  %arrayidx13.prol = getelementptr inbounds [2000 x double], [2000 x double]* %3, i64 %indvars.iv12, i64 0
...
for.body6.prol.loopexit:                          ; preds = %for.body6.prol.loopexit.unr-lcssa
  %9 = icmp eq i32 %6, 0
  br i1 %9, label %for.inc14.loopexit, label %for.body6.preheader.new
...
for.body6:                                        ; preds = %for.body6, %for.body6.preheader.new
  ...
  %12 = sub i64 0, %indvars.iv
  %13 = trunc i64 %12 to i32
  %sub.1 = add i32 %13, %7
  %add7.1 = add i32 %sub.1, %2
...
for.body:                                         ; preds = %for.end, %for.body.lr.ph
  ...
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.end ], [ %5, %for.body.lr.ph ]
  %indvars.iv9 = phi i32 [ %indvars.iv.next10, %for.end ], [ %4, %for.body.lr.ph ]
  %storemerge6 = phi i64 [ %indvars.iv.next12, %for.end ], [ 0, %for.body.lr.ph ]
  %7 = add i32 %4, %indvar
  ...
  %cmp42 = icmp sgt i64 %indvars.iv11, 0
  br i1 %cmp42, label %for.body5.preheader, label %for.end

for.body5.preheader:                              ; preds = %for.body
  %arrayidx13 = getelementptr inbounds double, double* %1, i64 %indvars.iv11
...
for.body5.prol:                                   ; preds = %for.body5.prol.preheader
  %arrayidx9.prol = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv11, i64 0
...
for.body5.prol.loopexit:                          ; preds = %for.body5.prol.loopexit.unr-lcssa
  %15 = icmp eq i32 %7, 0
  br i1 %15, label %for.end.loopexit, label %for.body5.preheader.new
...
for.body5:                                        ; preds = %for.body5, %for.body5.preheader.new
  ...
  %arrayidx9 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv11, i64 %indvars.iv
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx9.1 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv11, i64 %indvars.iv.next
...
for.end:                                          ; preds = %for.end.loopexit, %for.body
  %arrayidx15 = getelementptr inbounds double, double* %1, i64 %indvars.iv11
  %22 = load double, double* %arrayidx15, align 8
  %arrayidx19 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv11, i64 %indvars.iv11
  ...
  %cmp = icmp slt i64 %indvars.iv.next12, %6
...
for.cond.for.end24_crit_edge:                     ; preds = %for.end
  %24 = trunc i64 %indvars.iv.next12 to i32
...
for.body:                                         ; preds = %for.inc, %for.body.lr.ph
  %inc3 = phi i32 [ %i.promoted, %for.body.lr.ph ], [ %inc, %for.inc ]
  %7 = phi %struct._IO_FILE* [ %4, %for.body.lr.ph ], [ %10, %for.inc ]
  %storemerge2 = phi i32 [ 0, %for.body.lr.ph ], [ %inc, %for.inc ]
  ...
  %call2 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %7, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i64 0, i64 0), double %8) #6
...
for.end:                                          ; preds = %entry, %for.cond.for.end_crit_edge
  %.lcssa = phi %struct._IO_FILE* [ %10, %for.cond.for.end_crit_edge ], [ %4, %entry ]
