...
.lver.check:                                      ; preds = %._crit_edge9.us, %.preheader4
  ...
  %scevgep4 = getelementptr [1000 x double], [1000 x double]* %2, i64 %4, i64 999
  %scevgep6 = getelementptr [1000 x double], [1000 x double]* %3, i64 %4, i64 0
  %scevgep8 = getelementptr [1000 x double], [1000 x double]* %3, i64 %4, i64 999
...
; <label>:51:                                     ; preds = %51, %.ph
  %store_forwarded13 = phi double [ %load_initial12, %.ph ], [ %68, %51 ]
  ...
  %66 = fmul double %store_forwarded13, 0xC09F400000000001
  ...
  br i1 %exitcond, label %._crit_edge.us.loopexit37, label %51

._crit_edge.us.loopexit:                          ; preds = %.ph.lver.orig
  br label %._crit_edge.us

._crit_edge.us.loopexit37:                        ; preds = %51
  br label %._crit_edge.us
...
.lver.check28:                                    ; preds = %.lver.check28.preheader, %._crit_edge19.us
  %indvar14 = phi i64 [ %71, %._crit_edge19.us ], [ 0, %.lver.check28.preheader ]
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %._crit_edge19.us ], [ 1, %.lver.check28.preheader ]
  %71 = add i64 %indvar14, 1
  %scevgep16 = getelementptr [1000 x double], [1000 x double]* %2, i64 %71, i64 0
  %scevgep18 = getelementptr [1000 x double], [1000 x double]* %2, i64 %71, i64 999
  %scevgep20 = getelementptr [1000 x double], [1000 x double]* %3, i64 %71, i64 0
  %scevgep22 = getelementptr [1000 x double], [1000 x double]* %3, i64 %71, i64 999
...
.ph29.lver.orig:                                  ; preds = %.ph29.lver.orig.preheader, %.ph29.lver.orig
  ...
  br i1 %exitcond33.lver.orig, label %._crit_edge15.us.loopexit, label %.ph29.lver.orig
...
; <label>:124:                                    ; preds = %124, %.ph29
  %store_forwarded35 = phi double [ %load_initial34, %.ph29 ], [ %146, %124 ]
  %store_forwarded32 = phi double [ %load_initial31, %.ph29 ], [ %135, %124 ]
  %indvars.iv30 = phi i64 [ 1, %.ph29 ], [ %indvars.iv.next31, %124 ]
  ...
  %129 = insertelement <2 x double> undef, double %store_forwarded32, i32 0
  ...
  %144 = fmul double %store_forwarded35, 0xC08F400000000001
  ...
  br i1 %exitcond33, label %._crit_edge15.us.loopexit36, label %124

._crit_edge15.us.loopexit:                        ; preds = %.ph29.lver.orig
  br label %._crit_edge15.us

._crit_edge15.us.loopexit36:                      ; preds = %124
  br label %._crit_edge15.us

._crit_edge15.us:                                 ; preds = %._crit_edge15.us.loopexit36, %._crit_edge15.us.loopexit
