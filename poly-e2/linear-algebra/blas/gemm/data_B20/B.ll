...
for.cond1.preheader.us:                           ; preds = %for.inc7.us, %entry
  %indvars.iv42 = phi i64 [ 0, %entry ], [ %indvars.iv.next43, %for.inc7.us ]
...
for.cond14.preheader.us:                          ; preds = %for.cond14.preheader.us.preheader, %for.inc31.us
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc31.us ], [ 0, %for.cond14.preheader.us.preheader ]
...
for.body17.us:                                    ; preds = %for.body17.us, %for.cond14.preheader.us
  ...
  br i1 %exitcond30.1, label %for.inc31.us, label %for.body17.us
...
for.cond38.preheader.us:                          ; preds = %for.cond38.preheader.us.preheader, %for.inc55.us
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc55.us ], [ 0, %for.cond38.preheader.us.preheader ]
...
for.body11.us.us.preheader:                       ; preds = %middle.block, %for.cond9.preheader.us.us
  %indvars.iv33.ph = phi i64 [ 1100, %middle.block ], [ 0, %for.cond9.preheader.us.us ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %13 = shl i64 %index, 1
  %14 = getelementptr inbounds [1100 x double], [1100 x double]* %B, i64 %indvars.iv37, i64 %13
  ...
  %16 = fmul <2 x double> %9, %strided.vec
  %17 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv41, i64 %13
  ...
  %22 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv41, i64 %20
...
middle.block:                                     ; preds = %vector.body
  br i1 true, label %for.inc29.us.us, label %for.body11.us.us.preheader

for.inc29.us.us.loopexit:                         ; preds = %for.body11.us.us
  br label %for.inc29.us.us

for.inc29.us.us:                                  ; preds = %for.inc29.us.us.loopexit, %middle.block
...
for.body3.us.1:                                   ; preds = %for.body3.us
  ...
  %mul.us.1 = fmul <2 x double> %34, %mul.us.v.i1.2.1
  ...
  %mul.us.2.1 = fmul <2 x double> %36, %mul.us.v.i1.2.1
