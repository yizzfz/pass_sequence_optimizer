...
@__llvm_prf_nm = private constant [32 x i8] c"\1D\1Ex\DAK\C9L.\89O\CB\CCKaL\01\B12\F32K \AC\92\D4\A2\5C\00\A5\04\0B\19", section "__llvm_prf_names"
@llvm.used = appending global [4 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_dict_find to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_dict_init to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_dict_term to i8*), i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
