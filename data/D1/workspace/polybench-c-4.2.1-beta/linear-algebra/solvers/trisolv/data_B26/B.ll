...
.prol.preheader:                                  ; preds = %.lr.ph
  ...
  %13 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv27, i64 0
...
.prol.loopexit:                                   ; preds = %.lr.ph..prol.loopexit_crit_edge, %.prol.preheader
  ...
  %14 = icmp eq i64 %indvars.iv27, 0
  br i1 %14, label %.prol.loopexit.._crit_edge_crit_edge, label %.prol.loopexit..lr.ph.new_crit_edge
...
.lr.ph.new:                                       ; preds = %.lr.ph.new..lr.ph.new_crit_edge, %.prol.loopexit..lr.ph.new_crit_edge
  ...
  %18 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv27, i64 %indvars.iv
...
; <label>:4:                                      ; preds = %._crit_edge._crit_edge, %.lr.ph34
...
.prol.preheader:                                  ; preds = %.lr.ph
  ...
  %14 = fsub double %7, %13
  store double %14, double* %sunkaddr26, align 8
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.lr.ph..prol.loopexit_crit_edge, %.prol.preheader
  %indvars.iv.unr.ph = phi i64 [ 1, %.prol.preheader ], [ 0, %.lr.ph..prol.loopexit_crit_edge ]
  %.unr.ph = phi double [ %14, %.prol.preheader ], [ %7, %.lr.ph..prol.loopexit_crit_edge ]
  %.lcssa37.unr.ph = phi double [ %14, %.prol.preheader ], [ undef, %.lr.ph..prol.loopexit_crit_edge ]
  %15 = trunc i64 %5 to i32
  %16 = icmp eq i32 %15, 0
  br i1 %16, label %.prol.loopexit.._crit_edge_crit_edge, label %.prol.loopexit..lr.ph.new_crit_edge
...
.lr.ph.new:                                       ; preds = %.lr.ph.new..lr.ph.new_crit_edge, %.prol.loopexit..lr.ph.new_crit_edge
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.lr.ph.new..lr.ph.new_crit_edge ], [ %indvars.iv.unr.ph, %.prol.loopexit..lr.ph.new_crit_edge ]
  %17 = phi double [ %29, %.lr.ph.new..lr.ph.new_crit_edge ], [ %.unr.ph, %.prol.loopexit..lr.ph.new_crit_edge ]
  ...
  store double %23, double* %sunkaddr26, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  ...
  store double %29, double* %sunkaddr26, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
...
._crit_edge:                                      ; preds = %.lr.ph.new.._crit_edge_crit_edge, %.prol.loopexit.._crit_edge_crit_edge, %.._crit_edge_crit_edge
  %.lcssa = phi double [ %7, %.._crit_edge_crit_edge ], [ %.lcssa37.unr.ph, %.prol.loopexit.._crit_edge_crit_edge ], [ %29, %.lr.ph.new.._crit_edge_crit_edge ]
  ...
  store double %32, double* %sunkaddr30, align 8
