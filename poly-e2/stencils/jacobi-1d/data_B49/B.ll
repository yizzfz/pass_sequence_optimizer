...
for.inc:                                          ; preds = %for.inc, %entry
  ...
  br i1 %exitcond3.1, label %for.end, label %for.inc
...
entry:
  ...
  %scevgep103 = getelementptr double, double* %B, i64 1999
  %scevgep109 = getelementptr double, double* %A, i64 2000
  %bound0111 = icmp ult double* %arrayidx21.us.prol, %scevgep109
  %bound1112 = icmp ugt double* %scevgep103, %A
  ...
  %bound0 = icmp ult double* %arrayidx29.us.prol, %scevgep82
...
for.body.us:                                      ; preds = %for.inc33.us, %entry
  ...
  br i1 %found.conflict113, label %for.inc.us.preheader, label %vector.body91.preheader

vector.body91.preheader:                          ; preds = %for.body.us
...
vector.body91:                                    ; preds = %vector.body91.preheader, %vector.body91
  %index117 = phi i64 [ %index.next118, %vector.body91 ], [ 0, %vector.body91.preheader ]
  %0 = shl i64 %index117, 1
  %offset.idx122 = or i64 %0, 1
  %1 = getelementptr inbounds double, double* %A, i64 %0
  %2 = bitcast double* %1 to <4 x double>*
  %wide.vec126 = load <4 x double>, <4 x double>* %2, align 8, !alias.scope !1
  ...
  %3 = fadd <2 x double> %strided.vec127, %strided.vec128
  %4 = add nuw nsw i64 %offset.idx122, 1
  %5 = getelementptr inbounds double, double* %A, i64 %4
  %6 = getelementptr double, double* %5, i64 -1
  %7 = bitcast double* %6 to <4 x double>*
  %wide.vec129 = load <4 x double>, <4 x double>* %7, align 8, !alias.scope !1
  %strided.vec131 = shufflevector <4 x double> %wide.vec129, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %8 = fadd <2 x double> %3, %strided.vec131
  %9 = fmul <2 x double> %8, <double 3.333300e-01, double 3.333300e-01>
  %10 = bitcast double* %5 to <4 x double>*
  %wide.vec132 = load <4 x double>, <4 x double>* %10, align 8, !alias.scope !1
  %strided.vec134 = shufflevector <4 x double> %wide.vec132, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %11 = fadd <4 x double> %wide.vec129, %wide.vec132
  %12 = shufflevector <4 x double> %11, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %13 = fadd <2 x double> %12, %strided.vec134
  ...
  %interleaved.vec135 = shufflevector <2 x double> %9, <2 x double> %14, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec135, <4 x double>* %17, align 8, !alias.scope !4, !noalias !1
  %index.next118 = add i64 %index117, 2
  %18 = icmp eq i64 %index.next118, 998
...
for.inc33.us:                                     ; preds = %for.inc30.us
  ...
  %exitcond68 = icmp eq i32 %inc34.us, 500
  br i1 %exitcond68, label %for.end35, label %for.body.us

for.inc30.us:                                     ; preds = %for.inc30.us.preheader, %for.inc30.us
  %indvars.iv63 = phi i64 [ %indvars.iv.next64.1, %for.inc30.us ], [ %indvars.iv63.ph, %for.inc30.us.preheader ]
  %19 = add nsw i64 %indvars.iv63, -1
  ...
  %exitcond67.1 = icmp eq i64 %indvars.iv.next64.1, 1999
  br i1 %exitcond67.1, label %for.inc33.us, label %for.inc30.us, !llvm.loop !9
