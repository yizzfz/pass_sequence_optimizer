...
for.body.us:                                      ; preds = %for.end31.us, %entry
  %indvars.iv616.us = phi i64 [ %indvars.iv.next7.us, %for.end31.us ], [ 0, %entry ]
  br label %for.body3.us

for.end31.us:                                     ; preds = %for.cond9.for.end28_crit_edge.us.us
  %indvars.iv.next7.us = add nuw nsw i64 %indvars.iv616.us, 1
  %exitcond43 = icmp eq i64 %indvars.iv.next7.us, 1000
  br i1 %exitcond43, label %for.end34, label %for.body.us

for.body3.us:                                     ; preds = %for.body3.us.1, %for.body.us
  %indvars.iv9.us = phi i64 [ 0, %for.body.us ], [ %indvars.iv.next.us.3.1, %for.body3.us.1 ]
  %arrayidx5.us = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv616.us, i64 %indvars.iv9.us
  ...
  %indvars.iv.next.us.1 = or i64 %indvars.iv9.us, 2
  %arrayidx5.us.2 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv616.us, i64 %indvars.iv.next.us.1
  ...
  %indvars.iv.next.us.3 = or i64 %indvars.iv9.us, 4
...
for.cond9.preheader.us.us.preheader:              ; preds = %for.body3.us
  %scevgep1 = getelementptr [1100 x double], [1100 x double]* %C, i64 %indvars.iv616.us, i64 0
  %scevgep4 = getelementptr [1100 x double], [1100 x double]* %C, i64 %indvars.iv616.us, i64 1100
...
for.cond9.preheader.us.us:                        ; preds = %for.cond9.preheader.us.us.preheader, %for.cond9.for.end28_crit_edge.us.us
  %indvars.iv413.us.us = phi i64 [ %indvars.iv.next5.us.us, %for.cond9.for.end28_crit_edge.us.us ], [ 0, %for.cond9.preheader.us.us.preheader ]
  %arrayidx15.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %A, i64 %indvars.iv616.us, i64 %indvars.iv413.us.us
  %scevgep7 = getelementptr [1100 x double], [1100 x double]* %B, i64 %indvars.iv413.us.us, i64 0
  %scevgep10 = getelementptr [1100 x double], [1100 x double]* %B, i64 %indvars.iv413.us.us, i64 1100
...
for.body11.us.us.preheader:                       ; preds = %middle.block, %for.cond9.preheader.us.us
  %indvars.iv211.us.us.ph = phi i64 [ 0, %for.cond9.preheader.us.us ], [ 1100, %middle.block ]
  br label %for.body11.us.us

vector.ph:                                        ; preds = %for.cond9.preheader.us.us
  %5 = load double, double* %arrayidx15.us.us, align 8, !alias.scope !1
  %6 = insertelement <2 x double> undef, double %5, i32 0
  %7 = fmul <2 x double> %6, %broadcast.splatinsert16
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %13 = shl i64 %index, 1
  %14 = getelementptr inbounds [1100 x double], [1100 x double]* %B, i64 %indvars.iv413.us.us, i64 %13
  ...
  %16 = fmul <2 x double> %8, %strided.vec
  %17 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv616.us, i64 %13
  %18 = bitcast double* %17 to <4 x double>*
  %wide.vec19 = load <4 x double>, <4 x double>* %18, align 8, !alias.scope !6, !noalias !8
  ...
  %19 = fadd <2 x double> %strided.vec20, %16
  %20 = or i64 %13, 1
  %21 = fmul <2 x double> %12, %strided.vec18
  %22 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv616.us, i64 %20
  %23 = fadd <2 x double> %strided.vec21, %21
  ...
  br i1 %26, label %middle.block, label %vector.body, !llvm.loop !9

middle.block:                                     ; preds = %vector.body
  br i1 true, label %for.cond9.for.end28_crit_edge.us.us, label %for.body11.us.us.preheader
...
for.cond9.for.end28_crit_edge.us.us:              ; preds = %for.cond9.for.end28_crit_edge.us.us.loopexit, %middle.block
  %indvars.iv.next5.us.us = add nuw nsw i64 %indvars.iv413.us.us, 1
  %exitcond42 = icmp eq i64 %indvars.iv.next5.us.us, 1200
  br i1 %exitcond42, label %for.end31.us, label %for.cond9.preheader.us.us

for.body11.us.us:                                 ; preds = %for.body11.us.us.preheader, %for.body11.us.us
  %indvars.iv211.us.us = phi i64 [ %indvars.iv.next3.us.us.1, %for.body11.us.us ], [ %indvars.iv211.us.us.ph, %for.body11.us.us.preheader ]
  %27 = load double, double* %arrayidx15.us.us, align 8
  %mul16.us.us = fmul double %27, %alpha
  %arrayidx20.us.us = getelementptr inbounds [1100 x double], [1100 x double]* %B, i64 %indvars.iv413.us.us, i64 %indvars.iv211.us.us
  %28 = load double, double* %arrayidx20.us.us, align 8
  %mul21.us.us = fmul double %mul16.us.us, %28
  %arrayidx25.us.us = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv616.us, i64 %indvars.iv211.us.us
  %29 = load double, double* %arrayidx25.us.us, align 8
  %add.us.us = fadd double %29, %mul21.us.us
  store double %add.us.us, double* %arrayidx25.us.us, align 8
  %indvars.iv.next3.us.us = or i64 %indvars.iv211.us.us, 1
  %30 = load double, double* %arrayidx15.us.us, align 8
  %mul16.us.us.1 = fmul double %30, %alpha
  %arrayidx20.us.us.1 = getelementptr inbounds [1100 x double], [1100 x double]* %B, i64 %indvars.iv413.us.us, i64 %indvars.iv.next3.us.us
  %31 = load double, double* %arrayidx20.us.us.1, align 8
  %mul21.us.us.1 = fmul double %mul16.us.us.1, %31
  %arrayidx25.us.us.1 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv616.us, i64 %indvars.iv.next3.us.us
  %32 = load double, double* %arrayidx25.us.us.1, align 8
  %add.us.us.1 = fadd double %32, %mul21.us.us.1
  store double %add.us.us.1, double* %arrayidx25.us.us.1, align 8
  %indvars.iv.next3.us.us.1 = add nsw i64 %indvars.iv211.us.us, 2
  %exitcond41.1 = icmp eq i64 %indvars.iv.next3.us.us.1, 1100
  br i1 %exitcond41.1, label %for.cond9.for.end28_crit_edge.us.us.loopexit, label %for.body11.us.us, !llvm.loop !12

for.end34:                                        ; preds = %for.end31.us
  ret void

for.body3.us.1:                                   ; preds = %for.body3.us
  %arrayidx5.us.1 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv616.us, i64 %indvars.iv.next.us.3
  %33 = bitcast double* %arrayidx5.us.1 to <2 x double>*
  %34 = load <2 x double>, <2 x double>* %33, align 8
  %mul.us.1 = fmul <2 x double> %34, %mul.us.v.i1.2
  store <2 x double> %mul.us.1, <2 x double>* %33, align 8
  %indvars.iv.next.us.1.1 = or i64 %indvars.iv9.us, 6
  %arrayidx5.us.2.1 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv616.us, i64 %indvars.iv.next.us.1.1
  %35 = bitcast double* %arrayidx5.us.2.1 to <2 x double>*
  %36 = load <2 x double>, <2 x double>* %35, align 8
  %mul.us.2.1 = fmul <2 x double> %36, %mul.us.v.i1.2
  store <2 x double> %mul.us.2.1, <2 x double>* %35, align 8
  %indvars.iv.next.us.3.1 = add nuw nsw i64 %indvars.iv9.us, 8
  br label %for.body3.us
}
