...
entry:
  ...
  store [2000 x double]* %1, [2000 x double]** %u1, align 8
  %call2 = call i8* @polybench_alloc_data(i64 2000, i32 8)
  %2 = bitcast i8* %call2 to [2000 x double]*
  store [2000 x double]* %2, [2000 x double]** %v1, align 8
  %call3 = call i8* @polybench_alloc_data(i64 2000, i32 8)
  %3 = bitcast i8* %call3 to [2000 x double]*
  store [2000 x double]* %3, [2000 x double]** %u2, align 8
  %call4 = call i8* @polybench_alloc_data(i64 2000, i32 8)
  %4 = bitcast i8* %call4 to [2000 x double]*
  store [2000 x double]* %4, [2000 x double]** %v2, align 8
  %call5 = call i8* @polybench_alloc_data(i64 2000, i32 8)
  %5 = bitcast i8* %call5 to [2000 x double]*
  store [2000 x double]* %5, [2000 x double]** %w, align 8
  %call6 = call i8* @polybench_alloc_data(i64 2000, i32 8)
  %6 = bitcast i8* %call6 to [2000 x double]*
  store [2000 x double]* %6, [2000 x double]** %x, align 8
  %call7 = call i8* @polybench_alloc_data(i64 2000, i32 8)
  %7 = bitcast i8* %call7 to [2000 x double]*
  store [2000 x double]* %7, [2000 x double]** %y, align 8
  %call8 = call i8* @polybench_alloc_data(i64 2000, i32 8)
  %8 = bitcast i8* %call8 to [2000 x double]*
  store [2000 x double]* %8, [2000 x double]** %z, align 8
  %9 = load i32, i32* %n, align 4
  %10 = load [2000 x [2000 x double]]*, [2000 x [2000 x double]]** %A, align 8
  %arraydecay = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %10, i32 0, i32 0
  %11 = load [2000 x double]*, [2000 x double]** %u1, align 8
  %arraydecay9 = getelementptr inbounds [2000 x double], [2000 x double]* %11, i32 0, i32 0
  %12 = load [2000 x double]*, [2000 x double]** %v1, align 8
  %arraydecay10 = getelementptr inbounds [2000 x double], [2000 x double]* %12, i32 0, i32 0
  %13 = load [2000 x double]*, [2000 x double]** %u2, align 8
  %arraydecay11 = getelementptr inbounds [2000 x double], [2000 x double]* %13, i32 0, i32 0
  %14 = load [2000 x double]*, [2000 x double]** %v2, align 8
  %arraydecay12 = getelementptr inbounds [2000 x double], [2000 x double]* %14, i32 0, i32 0
  %15 = load [2000 x double]*, [2000 x double]** %w, align 8
  %arraydecay13 = getelementptr inbounds [2000 x double], [2000 x double]* %15, i32 0, i32 0
  %16 = load [2000 x double]*, [2000 x double]** %x, align 8
  %arraydecay14 = getelementptr inbounds [2000 x double], [2000 x double]* %16, i32 0, i32 0
  %17 = load [2000 x double]*, [2000 x double]** %y, align 8
  %arraydecay15 = getelementptr inbounds [2000 x double], [2000 x double]* %17, i32 0, i32 0
  %18 = load [2000 x double]*, [2000 x double]** %z, align 8
  %arraydecay16 = getelementptr inbounds [2000 x double], [2000 x double]* %18, i32 0, i32 0
  call void @init_array(i32 %9, double* %alpha, double* %beta, [2000 x double]* %arraydecay, double* %arraydecay9, double* %arraydecay10, double* %arraydecay11, double* %arraydecay12, double* %arraydecay13, double* %arraydecay14, double* %arraydecay15, double* %arraydecay16)
  call void (...) @polybench_timer_start()
  %19 = load i32, i32* %n, align 4
  %20 = load double, double* %alpha, align 8
  %21 = load double, double* %beta, align 8
  %22 = load [2000 x [2000 x double]]*, [2000 x [2000 x double]]** %A, align 8
  %arraydecay17 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %22, i32 0, i32 0
  %23 = load [2000 x double]*, [2000 x double]** %u1, align 8
  %arraydecay18 = getelementptr inbounds [2000 x double], [2000 x double]* %23, i32 0, i32 0
  %24 = load [2000 x double]*, [2000 x double]** %v1, align 8
  %arraydecay19 = getelementptr inbounds [2000 x double], [2000 x double]* %24, i32 0, i32 0
  %25 = load [2000 x double]*, [2000 x double]** %u2, align 8
  %arraydecay20 = getelementptr inbounds [2000 x double], [2000 x double]* %25, i32 0, i32 0
  %26 = load [2000 x double]*, [2000 x double]** %v2, align 8
  %arraydecay21 = getelementptr inbounds [2000 x double], [2000 x double]* %26, i32 0, i32 0
  %27 = load [2000 x double]*, [2000 x double]** %w, align 8
  %arraydecay22 = getelementptr inbounds [2000 x double], [2000 x double]* %27, i32 0, i32 0
  %28 = load [2000 x double]*, [2000 x double]** %x, align 8
  %arraydecay23 = getelementptr inbounds [2000 x double], [2000 x double]* %28, i32 0, i32 0
  %29 = load [2000 x double]*, [2000 x double]** %y, align 8
  %arraydecay24 = getelementptr inbounds [2000 x double], [2000 x double]* %29, i32 0, i32 0
  %30 = load [2000 x double]*, [2000 x double]** %z, align 8
  %arraydecay25 = getelementptr inbounds [2000 x double], [2000 x double]* %30, i32 0, i32 0
  call void @kernel_gemver(i32 %19, double %20, double %21, [2000 x double]* %arraydecay17, double* %arraydecay18, double* %arraydecay19, double* %arraydecay20, double* %arraydecay21, double* %arraydecay22, double* %arraydecay23, double* %arraydecay24, double* %arraydecay25)
...
land.lhs.true:                                    ; preds = %entry
  ...
  %call26 = call i32 @strcmp(i8* %33, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i32 0, i32 0)) #4
  %tobool = icmp ne i32 %call26, 0
  br i1 %tobool, label %if.end, label %if.then

if.then:                                          ; preds = %land.lhs.true
  %34 = load i32, i32* %n, align 4
  %35 = load [2000 x double]*, [2000 x double]** %w, align 8
  %arraydecay27 = getelementptr inbounds [2000 x double], [2000 x double]* %35, i32 0, i32 0
  call void @print_array(i32 %34, double* %arraydecay27)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  %36 = load [2000 x [2000 x double]]*, [2000 x [2000 x double]]** %A, align 8
  %37 = bitcast [2000 x [2000 x double]]* %36 to i8*
  call void @free(i8* %37) #5
  %38 = load [2000 x double]*, [2000 x double]** %u1, align 8
  %39 = bitcast [2000 x double]* %38 to i8*
  call void @free(i8* %39) #5
  %40 = load [2000 x double]*, [2000 x double]** %v1, align 8
  %41 = bitcast [2000 x double]* %40 to i8*
  call void @free(i8* %41) #5
  %42 = load [2000 x double]*, [2000 x double]** %u2, align 8
  %43 = bitcast [2000 x double]* %42 to i8*
  call void @free(i8* %43) #5
  %44 = load [2000 x double]*, [2000 x double]** %v2, align 8
  %45 = bitcast [2000 x double]* %44 to i8*
  call void @free(i8* %45) #5
  %46 = load [2000 x double]*, [2000 x double]** %w, align 8
  %47 = bitcast [2000 x double]* %46 to i8*
  call void @free(i8* %47) #5
  %48 = load [2000 x double]*, [2000 x double]** %x, align 8
  %49 = bitcast [2000 x double]* %48 to i8*
  call void @free(i8* %49) #5
  %50 = load [2000 x double]*, [2000 x double]** %y, align 8
  %51 = bitcast [2000 x double]* %50 to i8*
  call void @free(i8* %51) #5
  %52 = load [2000 x double]*, [2000 x double]** %z, align 8
...
for.body38:                                       ; preds = %for.cond35
  ...
  %arrayidx43 = getelementptr inbounds [2000 x double], [2000 x double]* %38, i64 %idxprom42
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx17 = getelementptr inbounds [2000 x double], [2000 x double]* %20, i64 %idxprom16
...
for.body28:                                       ; preds = %for.cond26
  ...
  %arrayidx32 = getelementptr inbounds [2000 x double], [2000 x double]* %33, i64 %idxprom31
...
for.body66:                                       ; preds = %for.cond64
  ...
  %63 = load [2000 x double]*, [2000 x double]** %A.addr, align 8
  %64 = load i32, i32* %i, align 4
  %idxprom69 = sext i32 %64 to i64
  %arrayidx70 = getelementptr inbounds [2000 x double], [2000 x double]* %63, i64 %idxprom69
