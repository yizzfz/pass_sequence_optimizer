...
define internal fastcc void @kernel_heat_3d(i32, i32, [120 x [120 x double]]*, [120 x [120 x double]]*) unnamed_addr #0 {
  ...
  %6 = add nsw i64 %wide.trip.count139, -1
  %7 = icmp sgt i32 %5, 1
  %8 = icmp sgt i32 %5, 1
  %min.iters.check168 = icmp ult i64 %6, 2
  %n.vec171 = and i64 %6, -2
  %cmp.zero172 = icmp eq i64 %n.vec171, 0
  %ind.end195 = or i64 %6, 1
  %cmp.n196 = icmp eq i64 %6, %n.vec171
  %9 = icmp sgt i32 %5, 1
...
.preheader116:                                    ; preds = %._crit_edge127, %4
  ...
  br i1 %7, label %.preheader114.preheader, label %._crit_edge127

.preheader114.preheader:                          ; preds = %.preheader116
  br label %.preheader114

.preheader115:                                    ; preds = %._crit_edge119
  br i1 %9, label %.preheader.lr.ph.preheader, label %._crit_edge127
...
.preheader114:                                    ; preds = %.preheader114.preheader, %._crit_edge119
  ...
  br i1 %8, label %.preheader112.lr.ph, label %._crit_edge119
...
; <label>:20:                                     ; preds = %15
  ...
  %fputc.us.us = tail call i32 @fputc(i32 10, %struct._IO_FILE* %21) #4
  br label %22
