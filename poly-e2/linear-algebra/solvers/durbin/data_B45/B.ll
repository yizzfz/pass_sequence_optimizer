...
for.body:                                         ; preds = %for.body.for.body_crit_edge, %entry
  %indvars.iv = phi i64 [ 0, %entry ], [ %indvars.iv.next.4, %for.body.for.body_crit_edge ]
...
for.body8.lr.ph:                                  ; preds = %for.end44.for.body8.lr.ph_crit_edge, %entry
  %indvars.iv1 = phi i2 [ 1, %entry ], [ %indvars.iv.next2, %for.end44.for.body8.lr.ph_crit_edge ]
  %indvars.iv34 = phi i64 [ 1, %entry ], [ %indvars.iv.next35, %for.end44.for.body8.lr.ph_crit_edge ]
  %indvar = phi i64 [ 0, %entry ], [ %indvar.next, %for.end44.for.body8.lr.ph_crit_edge ]
  %alpha.014 = phi double [ %sub3, %entry ], [ %div, %for.end44.for.body8.lr.ph_crit_edge ]
  %beta.013 = phi double [ 1.000000e+00, %entry ], [ %mul5, %for.end44.for.body8.lr.ph_crit_edge ]
  %6 = add i64 %indvar, -1
  %7 = zext i2 %indvars.iv1 to i64
  %8 = shl i64 %indvar, 3
  ...
  %11 = add nsw i64 %indvars.iv34, -1
  %xtraiter = and i64 %10, 3
  %lcmp.mod = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod, label %for.body8.lr.ph.for.body8.prol.loopexit_crit_edge, label %for.body8.prol.preheader
...
for.body8.prol:                                   ; preds = %for.body8.prol.for.body8.prol_crit_edge, %for.body8.prol.preheader
  %indvars.iv.prol = phi i64 [ %indvars.iv.next.prol, %for.body8.prol.for.body8.prol_crit_edge ], [ 0, %for.body8.prol.preheader ]
  %sum.07.prol = phi double [ %add.prol, %for.body8.prol.for.body8.prol_crit_edge ], [ 0.000000e+00, %for.body8.prol.preheader ]
  %prol.iter = phi i64 [ %prol.iter.sub, %for.body8.prol.for.body8.prol_crit_edge ], [ %xtraiter, %for.body8.prol.preheader ]
  ...
  br i1 %prol.iter.cmp, label %for.body8.prol.loopexit.loopexit, label %for.body8.prol.for.body8.prol_crit_edge, !llvm.loop !1
...
for.body8.prol.loopexit:                          ; preds = %for.body8.lr.ph.for.body8.prol.loopexit_crit_edge, %for.body8.prol.loopexit.loopexit
  %indvars.iv.unr = phi i64 [ 0, %for.body8.lr.ph.for.body8.prol.loopexit_crit_edge ], [ %7, %for.body8.prol.loopexit.loopexit ]
  %sum.07.unr = phi double [ 0.000000e+00, %for.body8.lr.ph.for.body8.prol.loopexit_crit_edge ], [ %add.prol, %for.body8.prol.loopexit.loopexit ]
  %add.lcssa.unr = phi double [ undef, %for.body8.lr.ph.for.body8.prol.loopexit_crit_edge ], [ %add.prol, %for.body8.prol.loopexit.loopexit ]
  %15 = icmp ult i64 %indvar, 3
  br i1 %15, label %for.body8.prol.loopexit.for.body21.lr.ph_crit_edge, label %for.body8.preheader

for.body8.prol.loopexit.for.body21.lr.ph_crit_edge: ; preds = %for.body8.prol.loopexit
...
for.body8:                                        ; preds = %for.body8.for.body8_crit_edge, %for.body8.preheader
  %indvars.iv = phi i64 [ %indvars.iv.next.3, %for.body8.for.body8_crit_edge ], [ %indvars.iv.unr, %for.body8.preheader ]
  %sum.07 = phi double [ %add.3, %for.body8.for.body8_crit_edge ], [ %sum.07.unr, %for.body8.preheader ]
  ...
  br i1 %exitcond.3, label %for.body21.lr.ph.loopexit, label %for.body8.for.body8_crit_edge
...
for.body21.lr.ph:                                 ; preds = %for.body8.prol.loopexit.for.body21.lr.ph_crit_edge, %for.body21.lr.ph.loopexit
  %sum.0.lcssa = phi double [ %add.lcssa.unr, %for.body8.prol.loopexit.for.body21.lr.ph_crit_edge ], [ %add.3, %for.body21.lr.ph.loopexit ]
  ...
  %27 = add nsw i64 %indvars.iv34, -1
  %28 = and i64 %indvar, 1
  %lcmp.mod40 = icmp eq i64 %28, 0
  br i1 %lcmp.mod40, label %for.body21.prol, label %for.body21.lr.ph.for.body21.prol.loopexit_crit_edge

for.body21.lr.ph.for.body21.prol.loopexit_crit_edge: ; preds = %for.body21.lr.ph
  br label %for.body21.prol.loopexit

for.body21.prol:                                  ; preds = %for.body21.lr.ph
  %29 = load double, double* %y, align 8
  %sunkaddr41 = shl i64 %indvars.iv34, 3
  %sunkaddr42 = add i64 %3, %sunkaddr41
  %sunkaddr43 = add i64 %sunkaddr42, -8
  %sunkaddr44 = inttoptr i64 %sunkaddr43 to double*
  %30 = load double, double* %sunkaddr44, align 8
  %mul28.prol = fmul double %div, %30
  %add29.prol = fadd double %29, %mul28.prol
  store double %add29.prol, double* %2, align 16
  br label %for.body21.prol.loopexit

for.body21.prol.loopexit:                         ; preds = %for.body21.lr.ph.for.body21.prol.loopexit_crit_edge, %for.body21.prol
  %indvars.iv19.unr.ph = phi i64 [ 1, %for.body21.prol ], [ 0, %for.body21.lr.ph.for.body21.prol.loopexit_crit_edge ]
  %31 = icmp eq i64 %indvar, 0
  br i1 %31, label %for.body21.prol.loopexit.for.end44_crit_edge, label %for.body21.preheader
...
for.body21.preheader:                             ; preds = %for.body21.prol.loopexit
  %32 = sub i64 %6, %indvars.iv19.unr.ph
  %33 = lshr i64 %32, 1
  %34 = and i64 %33, 1
  %lcmp.mod5 = icmp eq i64 %34, 0
  br i1 %lcmp.mod5, label %for.body21.prol.preheader, label %for.body21.preheader.for.body21.prol.loopexit3.unr-lcssa_crit_edge

for.body21.preheader.for.body21.prol.loopexit3.unr-lcssa_crit_edge: ; preds = %for.body21.preheader
  br label %for.body21.prol.loopexit3.unr-lcssa

for.body21.prol.preheader:                        ; preds = %for.body21.preheader
  br label %for.body21.prol6

for.body21.prol6:                                 ; preds = %for.body21.prol.preheader
  %arrayidx23.prol = getelementptr inbounds double, double* %y, i64 %indvars.iv19.unr.ph
  %35 = bitcast double* %arrayidx23.prol to <2 x double>*
  %arrayidx31.prol = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %indvars.iv19.unr.ph
  %indvars.iv.next20.prol = add nuw nsw i64 %indvars.iv19.unr.ph, 1
  %36 = load <2 x double>, <2 x double>* %35, align 8
  %37 = sub nsw i64 %27, %indvars.iv.next20.prol
  ...
  %add29.prol7 = fadd <2 x double> %36, %add29.v.i1.prol
  %41 = bitcast double* %arrayidx31.prol to <2 x double>*
  store <2 x double> %add29.prol7, <2 x double>* %41, align 8
  %indvars.iv.next20.1.prol = or i64 %indvars.iv19.unr.ph, 2
  br label %for.body21.prol.loopexit3.unr-lcssa

for.body21.prol.loopexit3.unr-lcssa:              ; preds = %for.body21.preheader.for.body21.prol.loopexit3.unr-lcssa_crit_edge, %for.body21.prol6
  %indvars.iv19.unr.ph8 = phi i64 [ %indvars.iv.next20.1.prol, %for.body21.prol6 ], [ %indvars.iv19.unr.ph, %for.body21.preheader.for.body21.prol.loopexit3.unr-lcssa_crit_edge ]
  br label %for.body21.prol.loopexit3

for.body21.prol.loopexit3:                        ; preds = %for.body21.prol.loopexit3.unr-lcssa
  %42 = icmp eq i64 %33, 0
  br i1 %42, label %for.body21.prol.loopexit3.for.end44.loopexit_crit_edge, label %for.body21.preheader.new

for.body21.prol.loopexit3.for.end44.loopexit_crit_edge: ; preds = %for.body21.prol.loopexit3
  br label %for.end44.loopexit

for.body21.preheader.new:                         ; preds = %for.body21.prol.loopexit3
...
for.body21:                                       ; preds = %for.body21.for.body21_crit_edge, %for.body21.preheader.new
  %indvars.iv19 = phi i64 [ %indvars.iv19.unr.ph8, %for.body21.preheader.new ], [ %indvars.iv.next20.1.1, %for.body21.for.body21_crit_edge ]
  ...
  %47 = sub nsw i64 %27, %indvars.iv.next20
  ...
  %arrayidx23.1 = getelementptr inbounds double, double* %y, i64 %indvars.iv.next20.1
  %51 = bitcast double* %arrayidx23.1 to <2 x double>*
  %arrayidx31.1 = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %indvars.iv.next20.1
  %indvars.iv.next20.19 = add nsw i64 %indvars.iv19, 3
  %52 = load <2 x double>, <2 x double>* %51, align 8
  %53 = sub nsw i64 %27, %indvars.iv.next20.19
  ...
  %exitcond25.1.1 = icmp eq i64 %indvars.iv.next20.1.1, %indvars.iv34
  br i1 %exitcond25.1.1, label %for.end44.loopexit.unr-lcssa, label %for.body21.for.body21_crit_edge
...
for.end44.loopexit:                               ; preds = %for.body21.prol.loopexit3.for.end44.loopexit_crit_edge, %for.end44.loopexit.unr-lcssa
  br label %for.end44

for.end44:                                        ; preds = %for.body21.prol.loopexit.for.end44_crit_edge, %for.end44.loopexit
  ...
  br i1 %exitcond38, label %for.end49, label %for.end44.for.body8.lr.ph_crit_edge
