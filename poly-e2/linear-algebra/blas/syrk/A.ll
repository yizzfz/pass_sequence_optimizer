...
entry:
  ...
  %4 = load [1200 x [1200 x double]]*, [1200 x [1200 x double]]** %C, align 8
  %arraydecay = getelementptr inbounds [1200 x [1200 x double]], [1200 x [1200 x double]]* %4, i32 0, i32 0
  %5 = load [1200 x [1000 x double]]*, [1200 x [1000 x double]]** %A, align 8
  %arraydecay2 = getelementptr inbounds [1200 x [1000 x double]], [1200 x [1000 x double]]* %5, i32 0, i32 0
  call void @init_array(i32 %2, i32 %3, double* %alpha, double* %beta, [1200 x double]* %arraydecay, [1000 x double]* %arraydecay2)
  call void (...) @polybench_timer_start()
  %6 = load i32, i32* %n, align 4
  %7 = load i32, i32* %m, align 4
  %8 = load double, double* %alpha, align 8
  %9 = load double, double* %beta, align 8
  %10 = load [1200 x [1200 x double]]*, [1200 x [1200 x double]]** %C, align 8
  %arraydecay3 = getelementptr inbounds [1200 x [1200 x double]], [1200 x [1200 x double]]* %10, i32 0, i32 0
  %11 = load [1200 x [1000 x double]]*, [1200 x [1000 x double]]** %A, align 8
  %arraydecay4 = getelementptr inbounds [1200 x [1000 x double]], [1200 x [1000 x double]]* %11, i32 0, i32 0
  call void @kernel_syrk(i32 %6, i32 %7, double %8, double %9, [1200 x double]* %arraydecay3, [1000 x double]* %arraydecay4)
...
land.lhs.true:                                    ; preds = %entry
  ...
  %call5 = call i32 @strcmp(i8* %14, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i32 0, i32 0)) #4
  %tobool = icmp ne i32 %call5, 0
  br i1 %tobool, label %if.end, label %if.then

if.then:                                          ; preds = %land.lhs.true
  %15 = load i32, i32* %n, align 4
  %16 = load [1200 x [1200 x double]]*, [1200 x [1200 x double]]** %C, align 8
  %arraydecay6 = getelementptr inbounds [1200 x [1200 x double]], [1200 x [1200 x double]]* %16, i32 0, i32 0
  call void @print_array(i32 %15, [1200 x double]* %arraydecay6)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  %17 = load [1200 x [1200 x double]]*, [1200 x [1200 x double]]** %C, align 8
  %18 = bitcast [1200 x [1200 x double]]* %17 to i8*
  call void @free(i8* %18) #5
  %19 = load [1200 x [1000 x double]]*, [1200 x [1000 x double]]** %A, align 8
  %20 = bitcast [1200 x [1000 x double]]* %19 to i8*
...
for.body17:                                       ; preds = %for.cond14
  ...
  %23 = load [1200 x double]*, [1200 x double]** %C.addr, align 8
...
for.body11:                                       ; preds = %for.cond9
  ...
  %15 = load [1000 x double]*, [1000 x double]** %A.addr, align 8
  %16 = load i32, i32* %i, align 4
  %idxprom12 = sext i32 %16 to i64
  %arrayidx13 = getelementptr inbounds [1000 x double], [1000 x double]* %15, i64 %idxprom12
  ...
  %19 = load [1000 x double]*, [1000 x double]** %A.addr, align 8
  %20 = load i32, i32* %j, align 4
  ...
  %arrayidx23 = getelementptr inbounds [1200 x double], [1200 x double]* %23, i64 %idxprom22
  %25 = load i32, i32* %j, align 4
