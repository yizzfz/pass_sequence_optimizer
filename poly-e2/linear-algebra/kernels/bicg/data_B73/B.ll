...
for.inc.lr.ph:                                    ; preds = %entry
  ...
  %5 = add nsw i64 %0, -1
  %xtraiter40 = and i64 %0, 7
  %lcmp.mod41 = icmp eq i64 %xtraiter40, 0
  br i1 %lcmp.mod41, label %for.inc.prol.loopexit, label %for.inc.prol.preheader

for.inc.prol.preheader:                           ; preds = %for.inc.lr.ph
  br label %for.inc.prol

for.inc.prol:                                     ; preds = %for.inc.prol, %for.inc.prol.preheader
  %indvars.iv20.prol = phi i64 [ %indvars.iv.next21.prol, %for.inc.prol ], [ 0, %for.inc.prol.preheader ]
  %prol.iter42 = phi i64 [ %prol.iter42.sub, %for.inc.prol ], [ %xtraiter40, %for.inc.prol.preheader ]
...
for.inc31.us:                                     ; preds = %for.inc31.us, %for.body3.us
  ...
  %18 = load double, double* %sunkaddr45, align 8
  ...
  %20 = load double, double* %sunkaddr49, align 8
...
for.body:                                         ; preds = %for.inc, %for.body.lr.ph
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc ], [ 0, %for.body.lr.ph ]
