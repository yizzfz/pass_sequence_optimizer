...
scalar.ph67:                                      ; preds = %scalar.ph67.preheader, %scalar.ph67
  ...
  br i1 %exitcond, label %._crit_edge.us18.loopexit, label %scalar.ph67, !llvm.loop !5
...
.preheader.us15:                                  ; preds = %.preheader.us15.preheader, %._crit_edge.us18
  ...
  %scevgep77 = getelementptr [1000 x double], [1000 x double]* %5, i64 0, i64 %indvars.iv30
  %36 = add nuw nsw i64 %indvars.iv30, 1
  %scevgep79 = getelementptr [1000 x double], [1000 x double]* %5, i64 %indvars.iv37, i64 %36
  %scevgep81 = getelementptr [1000 x double], [1000 x double]* %6, i64 0, i64 %indvars.iv30
  %scevgep83 = getelementptr [1000 x double], [1000 x double]* %6, i64 %indvars.iv37, i64 %36
...
vector.body65:                                    ; preds = %vector.body65, %vector.ph99
  ...
  %40 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %index100, i64 %indvars.iv30
  ...
  %51 = getelementptr inbounds [1000 x double], [1000 x double]* %6, i64 %index100, i64 %indvars.iv30
  ...
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv37, i64 %index100
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader136, %.lr.ph.new
  %indvars.iv41 = phi i64 [ %indvars.iv.next42.3, %.lr.ph.new ], [ %indvars.iv41.ph, %.lr.ph.new.preheader136 ]
