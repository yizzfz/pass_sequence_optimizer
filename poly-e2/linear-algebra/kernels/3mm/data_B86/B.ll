...
entry:
  ...
  tail call fastcc void @kernel_3mm(i32 800, i32 900, i32 1000, i32 1100, i32 1200, [900 x double]* %arraydecay105, [1000 x double]* %arraydecay1, [900 x double]* %arraydecay72, [1100 x double]* %arraydecay136, [1200 x double]* %arraydecay83, [1100 x double]* %arraydecay94, [1100 x double]* %arraydecay167)
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc8_crit_edge.us, %entry
  %indvars.iv95 = phi i64 [ 0, %entry ], [ %indvars.iv.next96, %for.cond1.for.inc8_crit_edge.us ]
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us, %for.cond1.preheader.us
  %indvars.iv88 = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next89, %for.body3.us ]
  %0 = mul nuw nsw i64 %indvars.iv95, %indvars.iv88
  %1 = add nuw nsw i64 %0, 1
  %2 = trunc i64 %1 to i32
  %rem.us = srem i32 %2, 800
  %conv.us = sitofp i32 %rem.us to double
  %div.us = fdiv double %conv.us, 4.000000e+03
  %arrayidx7.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv95, i64 %indvars.iv88
  store double %div.us, double* %arrayidx7.us, align 8
  %indvars.iv.next89 = add nuw nsw i64 %indvars.iv88, 1
  %exitcond94 = icmp eq i64 %indvars.iv.next89, 1000
  br i1 %exitcond94, label %for.cond1.for.inc8_crit_edge.us, label %for.body3.us

for.cond1.for.inc8_crit_edge.us:                  ; preds = %for.body3.us
  %indvars.iv.next96 = add nuw nsw i64 %indvars.iv95, 1
  %exitcond99 = icmp eq i64 %indvars.iv.next96, 800
  br i1 %exitcond99, label %for.cond15.preheader.us.preheader, label %for.cond1.preheader.us
...
for.cond15.preheader.us:                          ; preds = %for.cond15.for.inc34_crit_edge.us, %for.cond15.preheader.us.preheader
  %indvars.iv82 = phi i64 [ 0, %for.cond15.preheader.us.preheader ], [ %indvars.iv.next83, %for.cond15.for.inc34_crit_edge.us ]
  br label %for.body18.us

for.body18.us:                                    ; preds = %for.body18.us, %for.cond15.preheader.us
  %indvars.iv75 = phi i64 [ 0, %for.cond15.preheader.us ], [ %indvars.iv.next76, %for.body18.us ]
  %indvars.iv.next76 = add nuw nsw i64 %indvars.iv75, 1
  %3 = mul nuw nsw i64 %indvars.iv82, %indvars.iv.next76
  %4 = add nuw nsw i64 %3, 2
  %5 = trunc i64 %4 to i32
  %rem22.us = srem i32 %5, 900
  %conv23.us = sitofp i32 %rem22.us to double
  %div26.us = fdiv double %conv23.us, 4.500000e+03
  %arrayidx30.us = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv82, i64 %indvars.iv75
  store double %div26.us, double* %arrayidx30.us, align 8
  %exitcond81 = icmp eq i64 %indvars.iv.next76, 900
  br i1 %exitcond81, label %for.cond15.for.inc34_crit_edge.us, label %for.body18.us

for.cond15.for.inc34_crit_edge.us:                ; preds = %for.body18.us
  %indvars.iv.next83 = add nuw nsw i64 %indvars.iv82, 1
  %exitcond86 = icmp eq i64 %indvars.iv.next83, 1000
  br i1 %exitcond86, label %for.cond41.preheader.us.preheader, label %for.cond15.preheader.us
...
for.cond41.preheader.us:                          ; preds = %for.cond41.for.inc59_crit_edge.us, %for.cond41.preheader.us.preheader
  %indvars.iv69 = phi i64 [ 0, %for.cond41.preheader.us.preheader ], [ %indvars.iv.next70, %for.cond41.for.inc59_crit_edge.us ]
  br label %for.body44.us

for.body44.us:                                    ; preds = %for.body44.us, %for.cond41.preheader.us
  %indvars.iv62 = phi i64 [ 0, %for.cond41.preheader.us ], [ %indvars.iv.next63, %for.body44.us ]
  %6 = add nuw nsw i64 %indvars.iv62, 3
  %7 = mul nuw nsw i64 %indvars.iv69, %6
  %8 = trunc i64 %7 to i32
  %rem47.us = srem i32 %8, 1100
  %conv48.us = sitofp i32 %rem47.us to double
  %div51.us = fdiv double %conv48.us, 5.500000e+03
  %arrayidx55.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv69, i64 %indvars.iv62
  store double %div51.us, double* %arrayidx55.us, align 8
  %indvars.iv.next63 = add nuw nsw i64 %indvars.iv62, 1
  %exitcond68 = icmp eq i64 %indvars.iv.next63, 1200
  br i1 %exitcond68, label %for.cond41.for.inc59_crit_edge.us, label %for.body44.us

for.cond41.for.inc59_crit_edge.us:                ; preds = %for.body44.us
  %indvars.iv.next70 = add nuw nsw i64 %indvars.iv69, 1
  %exitcond73 = icmp eq i64 %indvars.iv.next70, 900
  br i1 %exitcond73, label %for.cond66.preheader.us.preheader, label %for.cond41.preheader.us
...
for.cond66.preheader.us:                          ; preds = %for.cond66.for.inc85_crit_edge.us, %for.cond66.preheader.us.preheader
  %indvars.iv58 = phi i64 [ 0, %for.cond66.preheader.us.preheader ], [ %indvars.iv.next59, %for.cond66.for.inc85_crit_edge.us ]
...
for.body69.us:                                    ; preds = %for.body69.us, %for.cond66.preheader.us
  ...
  %exitcond57 = icmp eq i64 %indvars.iv.next, 1100
  br i1 %exitcond57, label %for.cond66.for.inc85_crit_edge.us, label %for.body69.us

for.cond66.for.inc85_crit_edge.us:                ; preds = %for.body69.us
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  %exitcond61 = icmp eq i64 %indvars.iv.next59, 1200
  br i1 %exitcond61, label %for.end87, label %for.cond66.preheader.us
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc24_crit_edge.us.for.cond1.preheader.us_crit_edge, %entry
  %indvar200 = phi i64 [ 0, %entry ], [ %indvar.next201, %for.cond1.for.inc24_crit_edge.us.for.cond1.preheader.us_crit_edge ]
  %inc25107.us = phi i64 [ 0, %entry ], [ %inc25.us, %for.cond1.for.inc24_crit_edge.us.for.cond1.preheader.us_crit_edge ]
  %sext222 = shl i64 %inc25107.us, 32
  %idxprom.us = ashr exact i64 %sext222, 32
  br label %for.body3.us.us

for.cond1.for.inc24_crit_edge.us:                 ; preds = %for.cond6.for.inc21_crit_edge.us.us
  %indvar.next201 = add nuw nsw i64 %indvar200, 1
  %exitcond213 = icmp eq i64 %indvar.next201, 800
  br i1 %exitcond213, label %for.cond30.preheader.us.preheader, label %for.cond1.for.inc24_crit_edge.us.for.cond1.preheader.us_crit_edge
...
for.body3.us.us:                                  ; preds = %for.cond6.for.inc21_crit_edge.us.us, %for.cond1.preheader.us
  %indvars.iv227 = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next228, %for.cond6.for.inc21_crit_edge.us.us ]
  %arrayidx5.us.us = getelementptr inbounds [900 x double], [900 x double]* %E, i64 %idxprom.us, i64 %indvars.iv227
...
for.cond6.for.inc21_crit_edge.us.us:              ; preds = %for.body8.us.us
  ...
  %cmp2.us.us = icmp slt i64 %indvars.iv.next228, 900
...
for.body8.us.us:                                  ; preds = %for.body8.us.us, %for.body3.us.us
  %indvars.iv204 = phi i64 [ 0, %for.body3.us.us ], [ %indvars.iv.next205.1, %for.body8.us.us ]
  %0 = phi double [ 0.000000e+00, %for.body3.us.us ], [ %add.us.us.1, %for.body8.us.us ]
  %arrayidx12.us.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %idxprom.us, i64 %indvars.iv204
  %1 = load double, double* %arrayidx12.us.us, align 8
  %arrayidx16.us.us = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv204, i64 %indvars.iv227
  ...
  %arrayidx12.us.us.1 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %idxprom.us, i64 %indvars.iv.next205
  %3 = load double, double* %arrayidx12.us.us.1, align 8
  %arrayidx16.us.us.1 = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv.next205, i64 %indvars.iv227
  ...
  %exitcond208.1 = icmp eq i64 %indvars.iv.next205.1, 1000
  br i1 %exitcond208.1, label %for.cond6.for.inc21_crit_edge.us.us, label %for.body8.us.us
...
for.cond30.preheader.us:                          ; preds = %for.cond30.preheader.us.preheader, %for.cond30.for.inc60_crit_edge.us.for.cond30.preheader.us_crit_edge
  %indvar180 = phi i64 [ %indvar.next181, %for.cond30.for.inc60_crit_edge.us.for.cond30.preheader.us_crit_edge ], [ 0, %for.cond30.preheader.us.preheader ]
  ...
  %sext221 = shl i64 %inc6162.us, 32
  %idxprom33.us = ashr exact i64 %sext221, 32
  br label %for.body32.us.us

for.cond30.for.inc60_crit_edge.us:                ; preds = %for.cond37.for.inc57_crit_edge.us.us
  %indvar.next181 = add nuw nsw i64 %indvar180, 1
  %exitcond193 = icmp eq i64 %indvar.next181, 900
  br i1 %exitcond193, label %for.cond66.preheader.us.preheader, label %for.cond30.for.inc60_crit_edge.us.for.cond30.preheader.us_crit_edge
...
for.body32.us.us:                                 ; preds = %for.cond37.for.inc57_crit_edge.us.us, %for.cond30.preheader.us
  %indvars.iv225 = phi i64 [ 0, %for.cond30.preheader.us ], [ %indvars.iv.next226, %for.cond37.for.inc57_crit_edge.us.us ]
  %arrayidx36.us.us = getelementptr inbounds [1100 x double], [1100 x double]* %F, i64 %idxprom33.us, i64 %indvars.iv225
...
for.cond37.for.inc57_crit_edge.us.us:             ; preds = %for.body39.us.us
  ...
  %cmp31.us.us = icmp slt i64 %indvars.iv.next226, 1100
...
for.body39.us.us:                                 ; preds = %for.body39.us.us, %for.body32.us.us
  %indvars.iv184 = phi i64 [ 0, %for.body32.us.us ], [ %indvars.iv.next185.1, %for.body39.us.us ]
  %5 = phi double [ 0.000000e+00, %for.body32.us.us ], [ %add53.us.us.1, %for.body39.us.us ]
  %arrayidx43.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %idxprom33.us, i64 %indvars.iv184
  %6 = load double, double* %arrayidx43.us.us, align 8
  %arrayidx47.us.us = getelementptr inbounds [1100 x double], [1100 x double]* %D, i64 %indvars.iv184, i64 %indvars.iv225
  ...
  %arrayidx43.us.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %idxprom33.us, i64 %indvars.iv.next185
  %8 = load double, double* %arrayidx43.us.us.1, align 8
  %arrayidx47.us.us.1 = getelementptr inbounds [1100 x double], [1100 x double]* %D, i64 %indvars.iv.next185, i64 %indvars.iv225
  ...
  %exitcond188.1 = icmp eq i64 %indvars.iv.next185.1, 1200
  br i1 %exitcond188.1, label %for.cond37.for.inc57_crit_edge.us.us, label %for.body39.us.us
...
for.cond66.for.inc96_crit_edge.us:                ; preds = %for.cond73.for.inc93_crit_edge.us.us
  ...
  %exitcond174 = icmp eq i64 %indvar.next, 800
  br i1 %exitcond174, label %for.end98, label %for.cond66.for.inc96_crit_edge.us.for.cond66.preheader.us_crit_edge
...
for.body68.us.us:                                 ; preds = %for.cond73.for.inc93_crit_edge.us.us, %for.cond66.preheader.us
  %indvars.iv = phi i64 [ 0, %for.cond66.preheader.us ], [ %indvars.iv.next, %for.cond73.for.inc93_crit_edge.us.us ]
...
for.body75.us.us:                                 ; preds = %for.body75.us.us, %for.body68.us.us
  %indvars.iv167 = phi i64 [ 0, %for.body68.us.us ], [ %indvars.iv.next168.1, %for.body75.us.us ]
  %10 = phi double [ 0.000000e+00, %for.body68.us.us ], [ %add89.us.us.1, %for.body75.us.us ]
  %arrayidx79.us.us = getelementptr inbounds [900 x double], [900 x double]* %E, i64 %idxprom69.us, i64 %indvars.iv167
  %11 = load double, double* %arrayidx79.us.us, align 8
  %arrayidx83.us.us = getelementptr inbounds [1100 x double], [1100 x double]* %F, i64 %indvars.iv167, i64 %indvars.iv
  ...
  %arrayidx79.us.us.1 = getelementptr inbounds [900 x double], [900 x double]* %E, i64 %idxprom69.us, i64 %indvars.iv.next168
  %13 = load double, double* %arrayidx79.us.us.1, align 8
  %arrayidx83.us.us.1 = getelementptr inbounds [1100 x double], [1100 x double]* %F, i64 %indvars.iv.next168, i64 %indvars.iv
  ...
  %exitcond170.1 = icmp eq i64 %indvars.iv.next168.1, 900
  br i1 %exitcond170.1, label %for.cond73.for.inc93_crit_edge.us.us, label %for.body75.us.us
...
for.cond2.for.inc10_crit_edge.us:                 ; preds = %if.end.us
  ...
  %cmp.us = icmp slt i64 %indvars.iv.next16, 800
