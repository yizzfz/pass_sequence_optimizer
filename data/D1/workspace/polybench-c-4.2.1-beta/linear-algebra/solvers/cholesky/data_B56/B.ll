...
define internal fastcc void @init_array(i32, [2000 x double]* nocapture) unnamed_addr #0 {
  br i1 true, label %._crit_edge.preheader.lr.ph, label %._crit_edge37.thread

._crit_edge37.thread:                             ; preds = %2
  %3 = tail call i8* @polybench_alloc_data(i64 4000000, i32 8) #3
...
.lr.ph34:                                         ; preds = %._crit_edge8._crit_edge..lr.ph34_crit_edge, %._crit_edge.preheader.lr.ph
  %indvars.iv85 = phi i64 [ 0, %._crit_edge.preheader.lr.ph ], [ %indvars.iv.next86, %._crit_edge8._crit_edge..lr.ph34_crit_edge ]
  %indvars.iv83 = phi i64 [ 1, %._crit_edge.preheader.lr.ph ], [ %indvars.iv.next84, %._crit_edge8._crit_edge..lr.ph34_crit_edge ]
  %4 = mul nuw nsw i64 %indvars.iv85, 2001
  %5 = add nuw nsw i64 %4, 1
  %6 = sub i64 1998, %indvars.iv85
  %7 = shl i64 %6, 3
  br label %._crit_edge

._crit_edge8.preheader:                           ; preds = %._crit_edge
  %scevgep79 = getelementptr [2000 x double], [2000 x double]* %1, i64 0, i64 %5
  %8 = and i64 %7, 34359738360
  %scevgep7980 = bitcast double* %scevgep79 to i8*
  %9 = add nuw nsw i64 %8, 8
  %indvars.iv.next86 = add nuw nsw i64 %indvars.iv85, 1
  %10 = icmp slt i64 %indvars.iv.next86, 2000
  br i1 %10, label %._crit_edge8._crit_edge.loopexit, label %._crit_edge8._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph34
  %indvars.iv67 = phi i64 [ 0, %.lr.ph34 ], [ %indvars.iv.next68, %._crit_edge ]
  %11 = sub nsw i64 0, %indvars.iv67
  %12 = trunc i64 %11 to i32
  %13 = srem i32 %12, 2000
  %14 = sitofp i32 %13 to double
  %15 = fdiv double %14, 2.000000e+03
  %16 = fadd double %15, 1.000000e+00
  %17 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv85, i64 %indvars.iv67
  store double %16, double* %17, align 8
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  %exitcond74 = icmp eq i64 %indvars.iv.next68, %indvars.iv83
  br i1 %exitcond74, label %._crit_edge8.preheader, label %._crit_edge

._crit_edge8._crit_edge.loopexit:                 ; preds = %._crit_edge8.preheader
  call void @llvm.memset.p0i8.i64(i8* nonnull %scevgep7980, i8 0, i64 %9, i32 8, i1 false)
...
._crit_edge8._crit_edge:                          ; preds = %._crit_edge8.preheader, %._crit_edge8._crit_edge.loopexit
  ...
  br i1 %exitcond88, label %._crit_edge37, label %._crit_edge8._crit_edge..lr.ph34_crit_edge

._crit_edge8._crit_edge..lr.ph34_crit_edge:       ; preds = %._crit_edge8._crit_edge
  %indvars.iv.next84 = add nuw nsw i64 %indvars.iv83, 1
  br label %.lr.ph34

._crit_edge37:                                    ; preds = %._crit_edge8._crit_edge
...
._crit_edge9._crit_edge.us.prol.preheader:        ; preds = %._crit_edge37
...
._crit_edge9._crit_edge.us.prol:                  ; preds = %._crit_edge9._crit_edge.us.prol, %._crit_edge9._crit_edge.us.prol.preheader
  %indvars.iv63.prol = phi i64 [ 0, %._crit_edge9._crit_edge.us.prol.preheader ], [ %indvars.iv.next64.prol, %._crit_edge9._crit_edge.us.prol ]
  %prol.iter139 = phi i64 [ 0, %._crit_edge9._crit_edge.us.prol.preheader ], [ %prol.iter139.sub, %._crit_edge9._crit_edge.us.prol ]
  %21 = mul nuw nsw i64 %indvars.iv63.prol, 16000
  ...
  %prol.iter139.sub = add nsw i64 %prol.iter139, -1
  %prol.iter139.cmp = icmp eq i64 %prol.iter139.sub, 0
  br i1 %prol.iter139.cmp, label %._crit_edge9._crit_edge.us.prol.loopexit.unr-lcssa, label %._crit_edge9._crit_edge.us.prol, !llvm.loop !1
...
._crit_edge9._crit_edge.us.prol.loopexit:         ; preds = %._crit_edge37, %._crit_edge9._crit_edge.us.prol.loopexit.unr-lcssa
  br i1 false, label %._crit_edge13.preheader.us.us.preheader.preheader, label %._crit_edge37.new

._crit_edge37.new:                                ; preds = %._crit_edge9._crit_edge.us.prol.loopexit
  br label %._crit_edge9._crit_edge.us

._crit_edge9._crit_edge.us:                       ; preds = %._crit_edge9._crit_edge.us, %._crit_edge37.new
  %indvars.iv63 = phi i64 [ 0, %._crit_edge37.new ], [ %indvars.iv.next64.7, %._crit_edge9._crit_edge.us ]
  %22 = mul nuw nsw i64 %indvars.iv63, 16000
  %scevgep = getelementptr i8, i8* %19, i64 %22
  call void @llvm.memset.p0i8.i64(i8* %scevgep, i8 0, i64 16000, i32 8, i1 false)
  %23 = mul i64 %indvars.iv63, 16000
  %24 = add i64 %23, 16000
  ...
  %indvars.iv.next64.7 = add nsw i64 %indvars.iv63, 8
  %exitcond66.7 = icmp eq i64 %indvars.iv.next64.7, 2000
  br i1 %exitcond66.7, label %._crit_edge13.preheader.us.us.preheader.preheader.unr-lcssa, label %._crit_edge9._crit_edge.us

._crit_edge13.preheader.us.us.preheader.preheader.unr-lcssa: ; preds = %._crit_edge9._crit_edge.us
  br label %._crit_edge13.preheader.us.us.preheader.preheader

._crit_edge13.preheader.us.us.preheader.preheader: ; preds = %._crit_edge9._crit_edge.us.prol.loopexit, %._crit_edge13.preheader.us.us.preheader.preheader.unr-lcssa
  br label %._crit_edge13.preheader.us.us.preheader

._crit_edge13.preheader.us.us.preheader:          ; preds = %._crit_edge11._crit_edge.us, %._crit_edge13.preheader.us.us.preheader.preheader
  %indvars.iv55 = phi i64 [ 0, %._crit_edge13.preheader.us.us.preheader.preheader ], [ %indvars.iv.next56, %._crit_edge11._crit_edge.us ]
  %scevgep94 = getelementptr [2000 x double], [2000 x double]* %1, i64 0, i64 %indvars.iv55
  %scevgep9495 = bitcast double* %scevgep94 to i8*
  %37 = add nsw i64 %indvars.iv55, -1999
  %scevgep96 = getelementptr [2000 x double], [2000 x double]* %1, i64 2000, i64 %37
...
._crit_edge11._crit_edge.us:                      ; preds = %._crit_edge13._crit_edge.us.us
  ...
  br i1 %exitcond58, label %._crit_edge14.preheader.us.preheader, label %._crit_edge13.preheader.us.us.preheader
...
._crit_edge13.preheader.us.us:                    ; preds = %._crit_edge13._crit_edge.us.us, %._crit_edge13.preheader.us.us.preheader
  ...
  %scevgep92 = getelementptr i8, i8* %19, i64 %38
  %39 = add i64 16000, %38
  %scevgep93 = getelementptr i8, i8* %19, i64 %39
  %40 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv51, i64 %indvars.iv55
...
._crit_edge13.us.us.preheader:                    ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %._crit_edge13.preheader.us.us
  %indvars.iv47.ph = phi i64 [ 2000, %middle.block ], [ 0, %vector.memcheck ], [ 0, %min.iters.checked ], [ 0, %._crit_edge13.preheader.us.us ]
...
._crit_edge13.us.us.prol:                         ; preds = %._crit_edge13.us.us.prol.preheader
  ...
  %42 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv47.ph, i64 %indvars.iv55
  ...
  %indvars.iv.next48.prol = add nuw nsw i64 %indvars.iv47.ph, 1
...
vector.memcheck:                                  ; preds = %min.iters.checked
  %bound0 = icmp ult i8* %scevgep92, %scevgep9697
  %bound1 = icmp ult i8* %scevgep9495, %scevgep93
  %found.conflict = and i1 %bound0, %bound1
  %bc = bitcast double* %40 to i8*
  %bc98 = bitcast double* %40 to i8*
  %bound099 = icmp ult i8* %scevgep92, %bc98
  %bound1100 = icmp ult i8* %bc, %scevgep93
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %54 = or i64 %index, 2
  %55 = or i64 %index, 3
  %56 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %index, i64 %indvars.iv55
  %57 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %53, i64 %indvars.iv55
  %58 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %54, i64 %indvars.iv55
  %59 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %55, i64 %indvars.iv55
  ...
  %wide.load103 = load <2 x double>, <2 x double>* %73, align 8, !alias.scope !8, !noalias !10
  %74 = fadd <2 x double> %wide.load, %68
  %75 = fadd <2 x double> %wide.load103, %69
...
._crit_edge13._crit_edge.us.us:                   ; preds = %._crit_edge13._crit_edge.us.us.loopexit, %middle.block
  ...
  br i1 %exitcond54, label %._crit_edge11._crit_edge.us, label %._crit_edge13.preheader.us.us
...
._crit_edge13.us.us:                              ; preds = %._crit_edge13.us.us, %._crit_edge13.us.us.preheader.new
  ...
  %80 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 %indvars.iv55
  ...
  %87 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv.next48, i64 %indvars.iv55
  ...
  %exitcond50.1 = icmp eq i64 %indvars.iv.next48.1, 2000
  br i1 %exitcond50.1, label %._crit_edge13._crit_edge.us.us.loopexit.unr-lcssa, label %._crit_edge13.us.us, !llvm.loop !14
...
._crit_edge14.preheader.us:                       ; preds = %._crit_edge14._crit_edge.us, %._crit_edge14.preheader.us.preheader
  %indvars.iv43 = phi i64 [ 0, %._crit_edge14.preheader.us.preheader ], [ %indvars.iv.next44, %._crit_edge14._crit_edge.us ]
  %scevgep113 = getelementptr [2000 x double], [2000 x double]* %1, i64 %indvars.iv43, i64 0
  %scevgep113114 = bitcast double* %scevgep113 to i8*
  %scevgep115 = getelementptr [2000 x double], [2000 x double]* %1, i64 %indvars.iv43, i64 2000
  %scevgep115116 = bitcast double* %scevgep115 to i8*
  %93 = mul nuw nsw i64 %indvars.iv43, 16000
  %scevgep117 = getelementptr i8, i8* %19, i64 %93
  %94 = add i64 16000, %93
  %scevgep118 = getelementptr i8, i8* %19, i64 %94
  br i1 false, label %._crit_edge14.us.preheader, label %min.iters.checked108

min.iters.checked108:                             ; preds = %._crit_edge14.preheader.us
  br i1 false, label %._crit_edge14.us.preheader, label %vector.memcheck123

vector.memcheck123:                               ; preds = %min.iters.checked108
  ...
  br i1 %memcheck.conflict122, label %._crit_edge14.us.preheader, label %vector.body104.preheader

vector.body104.preheader:                         ; preds = %vector.memcheck123
  br label %vector.body104

vector.body104:                                   ; preds = %vector.body104.preheader, %vector.body104
  %index125 = phi i64 [ %index.next126, %vector.body104 ], [ 0, %vector.body104.preheader ]
  %95 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv43, i64 %index125
  %96 = bitcast double* %95 to <2 x i64>*
  %wide.load133 = load <2 x i64>, <2 x i64>* %96, align 8, !alias.scope !15
  %97 = getelementptr double, double* %95, i64 2
  %98 = bitcast double* %97 to <2 x i64>*
  %wide.load134 = load <2 x i64>, <2 x i64>* %98, align 8, !alias.scope !15
  %99 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv43, i64 %index125
  %100 = bitcast double* %99 to <2 x i64>*
  store <2 x i64> %wide.load133, <2 x i64>* %100, align 8, !alias.scope !18, !noalias !15
  %101 = getelementptr double, double* %99, i64 2
  %102 = bitcast double* %101 to <2 x i64>*
  store <2 x i64> %wide.load134, <2 x i64>* %102, align 8, !alias.scope !18, !noalias !15
  %index.next126 = add i64 %index125, 4
  %103 = icmp eq i64 %index.next126, 2000
  br i1 %103, label %middle.block105, label %vector.body104, !llvm.loop !20

middle.block105:                                  ; preds = %vector.body104
  br i1 true, label %._crit_edge14._crit_edge.us, label %._crit_edge14.us.preheader

._crit_edge14.us.preheader:                       ; preds = %middle.block105, %vector.memcheck123, %min.iters.checked108, %._crit_edge14.preheader.us
  %indvars.iv.ph = phi i64 [ 2000, %middle.block105 ], [ 0, %vector.memcheck123 ], [ 0, %min.iters.checked108 ], [ 0, %._crit_edge14.preheader.us ]
...
._crit_edge14.us.prol:                            ; preds = %._crit_edge14.us.prol, %._crit_edge14.us.prol.preheader
  ...
  %105 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv43, i64 %indvars.iv.prol
  %106 = bitcast double* %105 to i64*
  %107 = load i64, i64* %106, align 8
  %108 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv43, i64 %indvars.iv.prol
...
._crit_edge14.us.prol.loopexit:                   ; preds = %._crit_edge14.us.preheader, %._crit_edge14.us.prol.loopexit.unr-lcssa
  ...
  br i1 %110, label %._crit_edge14._crit_edge.us.loopexit, label %._crit_edge14.us.preheader.new
...
._crit_edge14.us:                                 ; preds = %._crit_edge14.us, %._crit_edge14.us.preheader.new
  ...
  %111 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv43, i64 %indvars.iv
  %112 = bitcast double* %111 to i64*
  %113 = load i64, i64* %112, align 8
  %114 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv43, i64 %indvars.iv
  %115 = bitcast double* %114 to i64*
  store i64 %113, i64* %115, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %116 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv43, i64 %indvars.iv.next
  %117 = bitcast double* %116 to i64*
  %118 = load i64, i64* %117, align 8
  %119 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv43, i64 %indvars.iv.next
  %120 = bitcast double* %119 to i64*
  store i64 %118, i64* %120, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %121 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv43, i64 %indvars.iv.next.1
  %122 = bitcast double* %121 to i64*
  %123 = load i64, i64* %122, align 8
  %124 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv43, i64 %indvars.iv.next.1
  %125 = bitcast double* %124 to i64*
  store i64 %123, i64* %125, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %126 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv43, i64 %indvars.iv.next.2
  %127 = bitcast double* %126 to i64*
  %128 = load i64, i64* %127, align 8
  %129 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv43, i64 %indvars.iv.next.2
  %130 = bitcast double* %129 to i64*
  store i64 %128, i64* %130, align 8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %exitcond42.3 = icmp eq i64 %indvars.iv.next.3, 2000
  br i1 %exitcond42.3, label %._crit_edge14._crit_edge.us.loopexit.unr-lcssa, label %._crit_edge14.us, !llvm.loop !22
...
._crit_edge14._crit_edge.us:                      ; preds = %._crit_edge14._crit_edge.us.loopexit, %middle.block105
  %indvars.iv.next44 = add nuw nsw i64 %indvars.iv43, 1
  %exitcond46 = icmp eq i64 %indvars.iv.next44, 2000
  br i1 %exitcond46, label %._crit_edge12._crit_edge.loopexit, label %._crit_edge14.preheader.us

._crit_edge12._crit_edge.loopexit:                ; preds = %._crit_edge14._crit_edge.us
  br label %._crit_edge12._crit_edge

._crit_edge12._crit_edge:                         ; preds = %._crit_edge12._crit_edge.loopexit, %._crit_edge37.thread
  %131 = phi i8* [ %3, %._crit_edge37.thread ], [ %19, %._crit_edge12._crit_edge.loopexit ]
...
._crit_edge.preheader:                            ; preds = %._crit_edge4._crit_edge, %._crit_edge.preheader.preheader
  %indvars.iv45 = phi i2 [ %indvars.iv.next46, %._crit_edge4._crit_edge ], [ 0, %._crit_edge.preheader.preheader ]
  %indvars.iv33 = phi i64 [ 0, %._crit_edge.preheader.preheader ], [ %indvars.iv.next34, %._crit_edge4._crit_edge ]
...
.lr.ph8:                                          ; preds = %._crit_edge
  ...
  %xtraiter40 = and i64 %indvars.iv33, 3
  %lcmp.mod41 = icmp eq i64 %xtraiter40, 0
  br i1 %lcmp.mod41, label %._crit_edge4.prol.loopexit, label %._crit_edge4.prol.preheader
...
._crit_edge4.prol:                                ; preds = %._crit_edge4.prol, %._crit_edge4.prol.preheader
  %8 = phi double [ %.pre38, %._crit_edge4.prol.preheader ], [ %12, %._crit_edge4.prol ]
  %indvars.iv25.prol = phi i64 [ 0, %._crit_edge4.prol.preheader ], [ %indvars.iv.next26.prol, %._crit_edge4.prol ]
  %prol.iter = phi i64 [ %xtraiter40, %._crit_edge4.prol.preheader ], [ %prol.iter.sub, %._crit_edge4.prol ]
...
._crit_edge4.prol.loopexit:                       ; preds = %.lr.ph8, %._crit_edge4.prol.loopexit.unr-lcssa
  %.unr42 = phi double [ %.pre38, %.lr.ph8 ], [ %12, %._crit_edge4.prol.loopexit.unr-lcssa ]
  %indvars.iv25.unr = phi i64 [ 0, %.lr.ph8 ], [ %3, %._crit_edge4.prol.loopexit.unr-lcssa ]
  %13 = icmp ult i64 %4, 3
  br i1 %13, label %._crit_edge4._crit_edge.loopexit, label %.lr.ph8.new
...
._crit_edge3.preheader:                           ; preds = %._crit_edge3.preheader.preheader, %._crit_edge
  ...
  br i1 %14, label %._crit_edge3.preheader39, label %._crit_edge

._crit_edge3.preheader39:                         ; preds = %._crit_edge3.preheader
  %xtraiter = and i64 %indvars.iv17, 1
  %lcmp.mod = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod, label %._crit_edge3.prol.loopexit.unr-lcssa, label %._crit_edge3.prol.preheader

._crit_edge3.prol.preheader:                      ; preds = %._crit_edge3.preheader39
...
._crit_edge3.prol.loopexit.unr-lcssa:             ; preds = %._crit_edge3.preheader39, %._crit_edge3.prol
  %.lcssa.unr.ph = phi double [ %20, %._crit_edge3.prol ], [ undef, %._crit_edge3.preheader39 ]
  %.unr.ph = phi double [ %20, %._crit_edge3.prol ], [ %.pre, %._crit_edge3.preheader39 ]
  %indvars.iv.unr.ph = phi i64 [ 1, %._crit_edge3.prol ], [ 0, %._crit_edge3.preheader39 ]
...
._crit_edge3.prol.loopexit:                       ; preds = %._crit_edge3.prol.loopexit.unr-lcssa
  ...
  br i1 %21, label %._crit_edge.loopexit, label %._crit_edge3.preheader39.new

._crit_edge3.preheader39.new:                     ; preds = %._crit_edge3.prol.loopexit
  br label %._crit_edge3

._crit_edge3:                                     ; preds = %._crit_edge3, %._crit_edge3.preheader39.new
  %22 = phi double [ %.unr.ph, %._crit_edge3.preheader39.new ], [ %34, %._crit_edge3 ]
  %indvars.iv = phi i64 [ %indvars.iv.unr.ph, %._crit_edge3.preheader39.new ], [ %indvars.iv.next.1, %._crit_edge3 ]
  ...
  br i1 %exitcond16.1, label %._crit_edge.loopexit.unr-lcssa, label %._crit_edge3
...
._crit_edge.loopexit:                             ; preds = %._crit_edge3.prol.loopexit, %._crit_edge.loopexit.unr-lcssa
  %.lcssa = phi double [ %.lcssa.unr.ph, %._crit_edge3.prol.loopexit ], [ %34, %._crit_edge.loopexit.unr-lcssa ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %._crit_edge3.preheader
  %35 = phi double [ %.pre, %._crit_edge3.preheader ], [ %.lcssa, %._crit_edge.loopexit ]
  ...
  br i1 %exitcond24, label %.lr.ph8, label %._crit_edge3.preheader

._crit_edge4:                                     ; preds = %._crit_edge4, %.lr.ph8.new
  %39 = phi double [ %.unr42, %.lr.ph8.new ], [ %55, %._crit_edge4 ]
  %indvars.iv25 = phi i64 [ %indvars.iv25.unr, %.lr.ph8.new ], [ %indvars.iv.next26.3, %._crit_edge4 ]
  ...
  br i1 %exitcond32.3, label %._crit_edge4._crit_edge.loopexit.unr-lcssa, label %._crit_edge4
...
._crit_edge4._crit_edge:                          ; preds = %._crit_edge4._crit_edge.loopexit, %._crit_edge.preheader
  ...
  br i1 %exitcond36, label %._crit_edge10.loopexit, label %._crit_edge.preheader
...
._crit_edge2:                                     ; preds = %._crit_edge2._crit_edge, %12
  ...
  br i1 %exitcond10, label %._crit_edge._crit_edge, label %._crit_edge2._crit_edge

._crit_edge._crit_edge:                           ; preds = %._crit_edge2
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond16 = icmp eq i64 %indvars.iv.next14, 2000
  br i1 %exitcond16, label %._crit_edge.loopexit, label %._crit_edge._crit_edge..lr.ph_crit_edge
