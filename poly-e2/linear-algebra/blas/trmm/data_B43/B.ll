...
for.body.us:                                      ; preds = %for.cond11.for.inc27_crit_edge.us, %for.body.us.preheader
  %indvars.iv24 = phi i64 [ 0, %for.body.us.preheader ], [ %indvars.iv.next25, %for.cond11.for.inc27_crit_edge.us ]
...
for.body14.us:                                    ; preds = %for.body14.us.preheader, %for.body14.us
  ...
  br i1 %exitcond.121, label %for.cond11.for.inc27_crit_edge.us.loopexit, label %for.body14.us
...
for.body3.lr.ph.us:                               ; preds = %for.body.us
  %xtraiter42 = and i64 %indvars.iv24, 1
...
for.body3.us.prol.preheader:                      ; preds = %for.body3.lr.ph.us
  %10 = trunc i64 %indvars.iv24 to i32
...
for.cond11.for.inc27_crit_edge.us:                ; preds = %for.cond11.for.inc27_crit_edge.us.loopexit, %for.body14.us.prol.loopexit.unr-lcssa
...
for.body:                                         ; preds = %for.end, %for.body.preheader
  %indvars.iv37 = phi i64 [ 0, %for.body.preheader ], [ %indvars.iv.next38, %for.end ]
  %13 = add nuw i64 %indvars.iv37, 4294967295
  %cmp21 = icmp sgt i64 %indvars.iv37, 0
  br i1 %cmp21, label %for.body3.lr.ph, label %for.end

for.body3.lr.ph:                                  ; preds = %for.body
  %xtraiter3341 = and i64 %indvars.iv37, 1
  %lcmp.mod34 = icmp eq i64 %xtraiter3341, 0
...
for.body3:                                        ; preds = %for.body3.preheader, %for.body3
  ...
  %17 = add nuw nsw i64 %indvars.iv27, %indvars.iv37
  ...
  %19 = add nuw nsw i64 %indvars.iv.next28, %indvars.iv37
...
for.end:                                          ; preds = %for.end.loopexit, %for.body3.prol.loopexit.unr-lcssa, %for.body
  ...
  br i1 %exitcond40, label %for.end29.loopexit45, label %for.body

for.end29.loopexit:                               ; preds = %for.cond11.for.inc27_crit_edge.us
  br label %for.end29

for.end29.loopexit45:                             ; preds = %for.end
  br label %for.end29

for.end29:                                        ; preds = %for.end29.loopexit45, %for.end29.loopexit, %entry
  ret void
}
...
for.body.us:                                      ; preds = %for.cond1.for.inc30_crit_edge.us.for.body.us_crit_edge, %for.body.us.preheader
  %indvars.iv = phi i64 [ 1, %for.body.us.preheader ], [ %indvars.iv.next17.prol, %for.cond1.for.inc30_crit_edge.us.for.body.us_crit_edge ]
  %indvars.iv24 = phi i64 [ 0, %for.body.us.preheader ], [ %indvars.iv.next25, %for.cond1.for.inc30_crit_edge.us.for.body.us_crit_edge ]
  ...
  %indvars.iv.next17.prol = add nuw nsw i64 %indvars.iv, 1
  %2 = icmp slt i64 %indvars.iv.next25, 1000
...
for.body3.us:                                     ; preds = %for.end.us, %for.body.us
  ...
  br i1 %2, label %for.body6.lr.ph.us, label %for.end.us
...
for.end.us:                                       ; preds = %for.end.us.loopexit, %for.body6.us.prol.loopexit.unr-lcssa, %for.body3.us
  %5 = phi double [ %.pre, %for.body3.us ], [ %add17.us.lcssa.unr.ph, %for.body6.us.prol.loopexit.unr-lcssa ], [ %add17.us.1, %for.end.us.loopexit ]
...
for.body6.us:                                     ; preds = %for.body6.us.preheader, %for.body6.us
  ...
  %6 = phi double [ %add17.us.1, %for.body6.us ], [ %.unr.ph, %for.body6.us.preheader ]
...
for.body6.lr.ph.us:                               ; preds = %for.body3.us
  br i1 %3, label %for.body6.us.prol.loopexit.unr-lcssa, label %for.body6.us.prol.preheader
...
for.body6.us.prol.loopexit.unr-lcssa:             ; preds = %for.body6.lr.ph.us, %for.body6.us.prol.preheader
  %indvars.iv16.unr.ph = phi i64 [ %indvars.iv.next17.prol, %for.body6.us.prol.preheader ], [ %indvars.iv, %for.body6.lr.ph.us ]
  ...
  br i1 %4, label %for.end.us, label %for.body6.us.preheader
...
for.cond1.for.inc30_crit_edge.us:                 ; preds = %for.end.us
  ...
  br i1 %exitcond27, label %for.end32.loopexit, label %for.cond1.for.inc30_crit_edge.us.for.body.us_crit_edge
