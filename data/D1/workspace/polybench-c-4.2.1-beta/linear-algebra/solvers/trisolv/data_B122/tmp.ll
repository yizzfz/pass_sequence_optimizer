...
.lr.ph:                                           ; preds = %.lr.ph3, %._crit_edge
  ...
  %indvars.iv9 = phi i64 [ 1, %.lr.ph3 ], [ %indvars.iv.next10, %._crit_edge ]
  ...
  %8 = trunc i64 %indvars.iv.next12 to i32
  %9 = add i32 %8, 2000
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit
  ...
  br i1 %exitcond15, label %._crit_edge4, label %.lr.ph
...
.lr.ph3:                                          ; preds = %._crit_edge, %.lr.ph3.preheader
  %indvars.iv14 = phi i64 [ 0, %.lr.ph3.preheader ], [ %indvars.iv.next15, %._crit_edge ]
  %4 = add nuw i64 %indvars.iv14, 4294967295
  ...
  %11 = icmp sgt i64 %indvars.iv14, 0
  br i1 %11, label %.lr.ph.preheader, label %._crit_edge

.lr.ph.preheader:                                 ; preds = %.lr.ph3
  %xtraiter17 = and i64 %indvars.iv14, 1
  %lcmp.mod = icmp eq i64 %xtraiter17, 0
  br i1 %lcmp.mod, label %.lr.ph.prol.loopexit, label %.lr.ph.prol

.lr.ph.prol:                                      ; preds = %.lr.ph.preheader
  %12 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv14, i64 0
...
.lr.ph.prol.loopexit:                             ; preds = %.lr.ph.prol, %.lr.ph.preheader
  ...
  %.unr.ph = phi double [ %16, %.lr.ph.prol ], [ %10, %.lr.ph.preheader ]
  %.lcssa9.unr.ph = phi double [ %16, %.lr.ph.prol ], [ undef, %.lr.ph.preheader ]
  %17 = trunc i64 %4 to i32
  %18 = icmp eq i32 %17, 0
  br i1 %18, label %._crit_edge, label %.lr.ph.preheader24

.lr.ph.preheader24:                               ; preds = %.lr.ph.prol.loopexit
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader24, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.lr.ph ], [ %indvars.iv.unr.ph, %.lr.ph.preheader24 ]
  %19 = phi double [ %31, %.lr.ph ], [ %.unr.ph, %.lr.ph.preheader24 ]
  %20 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv14, i64 %indvars.iv
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %26 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv14, i64 %indvars.iv.next
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.lr.ph.prol.loopexit, %.lr.ph3
  %.lcssa = phi double [ %10, %.lr.ph3 ], [ %.lcssa9.unr.ph, %.lr.ph.prol.loopexit ], [ %31, %._crit_edge.loopexit ]
  %32 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv14, i64 %indvars.iv14
  %33 = load double, double* %32, align 8
  %34 = fdiv double %.lcssa, %33
  store double %34, double* %8, align 8
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  %exitcond19 = icmp eq i64 %indvars.iv.next15, 2000
  br i1 %exitcond19, label %._crit_edge4, label %.lr.ph3
