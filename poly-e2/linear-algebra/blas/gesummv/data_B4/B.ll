...
entry:
  ...
  call void @init_array(double* nonnull %alpha, double* nonnull %beta, [1300 x double]* %arraydecay1, [1300 x double]* %arraydecay72, double* %arraydecay83)
  call void (...) @polybench_timer_start() #4
  %0 = load double, double* %alpha, align 8
  %1 = load double, double* %beta, align 8
  %arraydecay116 = bitcast i8* %call2 to double*
  %arraydecay138 = bitcast i8* %call6 to double*
  call void @kernel_gesummv(double %0, double %1, [1300 x double]* %arraydecay1, [1300 x double]* %arraydecay72, double* %arraydecay116, double* %arraydecay83, double* %arraydecay138)
...
define internal void @init_array(double* nocapture %alpha, double* nocapture %beta, [1300 x double]* nocapture %A, [1300 x double]* nocapture %B, double* nocapture %x) #2 {
entry:
...
for.body:                                         ; preds = %for.inc24, %entry
  %indvars.iv47 = phi i64 [ 0, %entry ], [ %indvars.iv.next5, %for.inc24 ]
...
for.inc:                                          ; preds = %for.body, %for.inc
  %indvars.iv6 = phi i64 [ 0, %for.body ], [ %indvars.iv.next, %for.inc ]
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal void @kernel_gesummv(double %alpha, double %beta, [1300 x double]* nocapture readonly %A, [1300 x double]* nocapture readonly %B, double* %tmp, double* nocapture readonly %x, double* %y) #2 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define internal void @print_array(double* nocapture readonly %y) #0 {
entry:
