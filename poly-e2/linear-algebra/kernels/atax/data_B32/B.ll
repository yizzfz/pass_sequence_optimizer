...
for.body:                                         ; preds = %for.body, %entry
  %inc13 = phi i32 [ 0, %entry ], [ %inc.1, %for.body ]
  %conv2 = sitofp i32 %inc13 to double
  ...
  store <2 x double> %add, <2 x double>* %0, align 8
  %inc.1 = add nsw i32 %inc13, 2
  %cmp.1 = icmp slt i32 %inc.1, 2100
  br i1 %cmp.1, label %for.body, label %for.body6.us.preheader

for.body6.us.preheader:                           ; preds = %for.body
  br label %for.body6.us

for.body6.us:                                     ; preds = %for.body6.us.preheader, %for.cond7.for.end21_crit_edge.us
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.cond7.for.end21_crit_edge.us ], [ 0, %for.body6.us.preheader ]
  br label %for.body10.us

for.body10.us:                                    ; preds = %for.body10.us, %for.body6.us
  %indvars.iv = phi i64 [ 0, %for.body6.us ], [ %indvars.iv.next.1, %for.body10.us ]
  %1 = add nsw i64 %indvars.iv17, %indvars.iv
  %2 = trunc i64 %1 to i32
  %rem.us = srem i32 %2, 2100
  %conv12.us = sitofp i32 %rem.us to double
  %arrayidx18.us = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv17, i64 %indvars.iv
  %indvars.iv.next = or i64 %indvars.iv, 1
  %3 = add nsw i64 %indvars.iv17, %indvars.iv.next
  %4 = trunc i64 %3 to i32
  %rem.us.1 = srem i32 %4, 2100
  ...
  %5 = bitcast double* %arrayidx18.us to <2 x double>*
  store <2 x double> %div14.us, <2 x double>* %5, align 8
...
for.cond7.for.end21_crit_edge.us:                 ; preds = %for.body10.us
  ...
  %cmp4.us = icmp slt i64 %indvars.iv.next18, 1900
...
for.body5.us.preheader:                           ; preds = %vector.body
  ...
  %scevgep87 = getelementptr double, double* %y, i64 2100
  br label %for.body5.us

for.body5.us:                                     ; preds = %for.inc42.us, %for.body5.us.preheader
  %indvars.iv68 = phi i64 [ 0, %for.body5.us.preheader ], [ %26, %for.inc42.us ]
  %scevgep89 = getelementptr [2100 x double], [2100 x double]* %A, i64 %indvars.iv68, i64 1
  %26 = add i64 %indvars.iv68, 1
  %scevgep91 = getelementptr [2100 x double], [2100 x double]* %A, i64 %26, i64 0
  %sext = shl i64 %indvars.iv68, 32
  ...
  %arrayidx12.us = getelementptr inbounds double, double* %tmp, i64 %indvars.iv68
...
for.body26.us.for.body26.us_crit_edge:            ; preds = %for.body26.us.for.body26.us_crit_edge.preheader, %for.body26.us.for.body26.us_crit_edge
  %indvars.iv.next6779 = phi i64 [ %indvars.iv.next67, %for.body26.us.for.body26.us_crit_edge ], [ %indvars.iv.next6779.ph, %for.body26.us.for.body26.us_crit_edge.preheader ]
  %.pre74 = load double, double* %arrayidx12.us, align 8
  %arrayidx28.us = getelementptr inbounds double, double* %y, i64 %indvars.iv.next6779
  %27 = load double, double* %arrayidx28.us, align 8
  %arrayidx32.us = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv68, i64 %indvars.iv.next6779
  %28 = load double, double* %arrayidx32.us, align 8
  %mul35.us = fmul double %28, %.pre74
  %add36.us = fadd double %27, %mul35.us
  store double %add36.us, double* %arrayidx28.us, align 8
  %indvars.iv.next67 = add nuw nsw i64 %indvars.iv.next6779, 1
  %cmp25.us = icmp slt i64 %indvars.iv.next67, 2100
...
for.body10.us:                                    ; preds = %for.body10.us, %for.body5.us
  ...
  %arrayidx16.us = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv68, i64 %indvars.iv
  ...
  %arrayidx16.us.1 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv68, i64 %indvars.iv.next
  ...
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %arrayidx16.us.2 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv68, i64 %indvars.iv.next.1
...
for.body26.us.preheader:                          ; preds = %for.body10.us
  ...
  %arrayidx32.us76 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv68, i64 0
  %37 = load double, double* %arrayidx32.us76, align 8
  %mul35.us77 = fmul double %37, %add.us.2
  %add36.us78 = fadd double %36, %mul35.us77
  store double %add36.us78, double* %y, align 8
  %bound0 = icmp ult double* %scevgep, %arrayidx12.us
  %bound1 = icmp ult double* %arrayidx12.us, %scevgep87
  %found.conflict = and i1 %bound0, %bound1
  %bound094 = icmp ult double* %scevgep, %scevgep91
  %bound195 = icmp ult double* %scevgep89, %scevgep87
  %found.conflict96 = and i1 %bound094, %bound195
  %conflict.rdx = or i1 %found.conflict, %found.conflict96
  br i1 %conflict.rdx, label %for.body26.us.for.body26.us_crit_edge.preheader, label %vector.body81.preheader

vector.body81.preheader:                          ; preds = %for.body26.us.preheader
  br label %vector.body81

for.body26.us.for.body26.us_crit_edge.preheader.loopexit: ; preds = %vector.body81
...
for.body26.us.for.body26.us_crit_edge.preheader:  ; preds = %for.body26.us.for.body26.us_crit_edge.preheader.loopexit, %for.body26.us.preheader
  %indvars.iv.next6779.ph = phi i64 [ 1, %for.body26.us.preheader ], [ 2097, %for.body26.us.for.body26.us_crit_edge.preheader.loopexit ]
  br label %for.body26.us.for.body26.us_crit_edge

vector.body81:                                    ; preds = %vector.body81.preheader, %vector.body81
  %index98 = phi i64 [ %index.next99, %vector.body81 ], [ 0, %vector.body81.preheader ]
  %offset.idx = or i64 %index98, 1
  ...
  %wide.load106 = load <2 x double>, <2 x double>* %44, align 8, !alias.scope !8, !noalias !10
  %45 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv68, i64 %offset.idx
  %46 = bitcast double* %45 to <2 x double>*
  %wide.load107 = load <2 x double>, <2 x double>* %46, align 8, !alias.scope !12
  %47 = getelementptr double, double* %45, i64 2
  %48 = bitcast double* %47 to <2 x double>*
  %wide.load108 = load <2 x double>, <2 x double>* %48, align 8, !alias.scope !12
  %49 = fmul <2 x double> %wide.load107, %40
  %50 = fmul <2 x double> %wide.load108, %40
  %51 = fadd <2 x double> %wide.load, %49
  %52 = fadd <2 x double> %wide.load106, %50
  ...
  %index.next99 = add i64 %index98, 4
  %53 = icmp eq i64 %index.next99, 2096
  br i1 %53, label %for.body26.us.for.body26.us_crit_edge.preheader.loopexit, label %vector.body81, !llvm.loop !13
