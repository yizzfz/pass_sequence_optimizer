...
@__llvm_prf_nm = private constant [36 x i8] c"\1D\22x\DAKJ\CB/H\CDcLJ+JML\01R\E5E\99%\A9@:9'\BF8\15\00\9F\0D\0A\B3", section "__llvm_prf_names"
@llvm.used = appending global [5 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_bfopen to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_bfread to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_bfwrite to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_bfclose to i8*), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
