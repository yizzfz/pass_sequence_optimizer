...
for.body8.lr.ph:                                  ; preds = %entry, %for.end44
  %indvars.iv68 = phi i64 [ 1, %entry ], [ %indvars.iv.next69, %for.end44 ]
...
for.body8.prol.loopexit:                          ; preds = %for.body8.prol.loopexit.loopexit, %for.body8.lr.ph
  ...
  br i1 %14, label %for.body21.lr.ph, label %for.body8.preheader
...
for.body8:                                        ; preds = %for.body8.preheader, %for.body8
  ...
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %exitcond48.3 = icmp eq i64 %indvars.iv.next.3, %indvars.iv68
  br i1 %exitcond48.3, label %for.body21.lr.ph.loopexit, label %for.body8
...
for.body21.lr.ph:                                 ; preds = %for.body21.lr.ph.loopexit, %for.body8.prol.loopexit
  ...
  %arrayidx16 = getelementptr inbounds double, double* %r, i64 %indvars.iv68
  ...
  %26 = add nsw i64 %indvars.iv68, -1
  %27 = and i64 %indvar, 1
  %lcmp.mod73 = icmp eq i64 %27, 0
  br i1 %lcmp.mod73, label %for.body21.prol, label %for.body21.prol.loopexit

for.body21.prol:                                  ; preds = %for.body21.lr.ph
  %28 = load double, double* %y, align 8
  %sunkaddr74 = shl i64 %indvars.iv68, 3
...
for.body21.prol.loopexit:                         ; preds = %for.body21.prol, %for.body21.lr.ph
  %indvars.iv49.unr.ph = phi i64 [ 1, %for.body21.prol ], [ 0, %for.body21.lr.ph ]
...
for.body21.preheader:                             ; preds = %for.body21.prol.loopexit
  %31 = sub i64 %6, %indvars.iv49.unr.ph
  %32 = lshr i64 %31, 1
  %33 = add nuw i64 %32, 1
  %min.iters.check = icmp ult i64 %33, 2
  br i1 %min.iters.check, label %for.body21.preheader9, label %min.iters.checked

min.iters.checked:                                ; preds = %for.body21.preheader
  %n.mod.vf = and i64 %33, 1
  %n.vec = sub i64 %33, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  %34 = or i64 %indvars.iv49.unr.ph, 2
  %35 = shl nuw i64 %32, 1
  %36 = add i64 %34, %35
  %37 = shl nuw nsw i64 %n.mod.vf, 1
  %ind.end = sub i64 %36, %37
  br i1 %cmp.zero, label %for.body21.preheader9, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %38 = shl i64 %index, 1
  %offset.idx = or i64 %indvars.iv49.unr.ph, %38
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.end44, label %for.body21.preheader9

for.body21.preheader9:                            ; preds = %middle.block, %min.iters.checked, %for.body21.preheader
  %indvars.iv49.ph = phi i64 [ %indvars.iv49.unr.ph, %min.iters.checked ], [ %indvars.iv49.unr.ph, %for.body21.preheader ], [ %ind.end, %middle.block ]
...
for.body21:                                       ; preds = %for.body21.preheader9, %for.body21
  %indvars.iv49 = phi i64 [ %indvars.iv.next50.1, %for.body21 ], [ %indvars.iv49.ph, %for.body21.preheader9 ]
  %arrayidx23 = getelementptr inbounds double, double* %y, i64 %indvars.iv49
  %55 = bitcast double* %arrayidx23 to <2 x double>*
  %arrayidx31 = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %indvars.iv49
  %indvars.iv.next50 = add nuw nsw i64 %indvars.iv49, 1
  %56 = load <2 x double>, <2 x double>* %55, align 8
  %57 = sub nsw i64 %26, %indvars.iv.next50
  ...
  %exitcond57.1 = icmp eq i64 %indvars.iv.next50.1, %indvars.iv68
  br i1 %exitcond57.1, label %for.end44.loopexit, label %for.body21, !llvm.loop !6
...
for.end44:                                        ; preds = %for.end44.loopexit, %middle.block, %for.body21.prol.loopexit
  ...
  %arrayidx46 = getelementptr inbounds double, double* %y, i64 %indvars.iv68
  store double %div, double* %arrayidx46, align 8
  %indvars.iv.next69 = add nuw nsw i64 %indvars.iv68, 1
  %indvar.next = add nuw nsw i64 %indvar, 1
  %exitcond = icmp eq i64 %indvar.next, 1999
  br i1 %exitcond, label %for.end49, label %for.body8.lr.ph
