...
.preheader6.lr.ph:                                ; preds = %6
  ...
  %13 = icmp eq i32 %2, 1
  %wide.trip.count58 = zext i32 %2 to i64
  %scevgep73 = getelementptr double, double* %5, i64 %10
  %14 = add nsw i64 %11, -1
  %15 = add nsw i64 %10, -4
  %16 = lshr i64 %15, 2
...
.preheader6:                                      ; preds = %._crit_edge16..preheader6_crit_edge, %.preheader6.lr.ph
  ...
  br i1 %8, label %.preheader5.lr.ph, label %.preheader6.._crit_edge16_crit_edge
...
.preheader5.preheader:                            ; preds = %.preheader5.lr.ph
  br i1 %lcmp.mod114, label %.preheader5.preheader..preheader5.prol.loopexit_crit_edge, label %.preheader5.prol.preheader
...
.preheader5.prol:                                 ; preds = %.preheader5.prol..preheader5.prol_crit_edge, %.preheader5.prol.preheader
  ...
  %prol.iter = phi i64 [ %prol.iter.sub, %.preheader5.prol..preheader5.prol_crit_edge ], [ %xtraiter113, %.preheader5.prol.preheader ]
...
.preheader5.prol.loopexit:                        ; preds = %.preheader5.preheader..preheader5.prol.loopexit_crit_edge, %.preheader5.prol.loopexit.unr-lcssa
  ...
  br i1 %19, label %.preheader5.prol.loopexit.._crit_edge16.loopexit110_crit_edge, label %.preheader5.preheader.new

.preheader5.prol.loopexit.._crit_edge16.loopexit110_crit_edge: ; preds = %.preheader5.prol.loopexit
  br label %._crit_edge16.loopexit110
...
._crit_edge14.us:                                 ; preds = %middle.block.._crit_edge14.us_crit_edge, %._crit_edge14.us.loopexit
  ...
  %exitcond111 = icmp eq i64 %indvars.iv.next63, %11
  br i1 %exitcond111, label %._crit_edge16.loopexit, label %._crit_edge14.us..preheader5.us_crit_edge

._crit_edge14.us..preheader5.us_crit_edge:        ; preds = %._crit_edge14.us
  br label %.preheader5.us

.lr.ph13.us:                                      ; preds = %.lr.ph13.us..lr.ph13.us_crit_edge, %.lr.ph13.us.preheader109
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %.lr.ph13.us..lr.ph13.us_crit_edge ], [ %indvars.iv60.ph, %.lr.ph13.us.preheader109 ]
  ...
  %26 = icmp slt i64 %indvars.iv.next61, %10
  br i1 %26, label %.lr.ph13.us..lr.ph13.us_crit_edge, label %._crit_edge14.us.loopexit, !llvm.loop !3

.lr.ph13.us..lr.ph13.us_crit_edge:                ; preds = %.lr.ph13.us
  br label %.lr.ph13.us

.lr.ph13.us.preheader:                            ; preds = %._crit_edge.us.us
  %scevgep71 = getelementptr [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv64, i64 %indvars.iv62, i64 %10
  br i1 %min.iters.check, label %.lr.ph13.us.preheader..lr.ph13.us.preheader109_crit_edge, label %min.iters.checked

.lr.ph13.us.preheader..lr.ph13.us.preheader109_crit_edge: ; preds = %.lr.ph13.us.preheader
  br label %.lr.ph13.us.preheader109

.lr.ph13.us.preheader109:                         ; preds = %middle.block..lr.ph13.us.preheader109_crit_edge, %vector.memcheck..lr.ph13.us.preheader109_crit_edge, %min.iters.checked..lr.ph13.us.preheader109_crit_edge, %.lr.ph13.us.preheader..lr.ph13.us.preheader109_crit_edge
  %indvars.iv60.ph = phi i64 [ 0, %vector.memcheck..lr.ph13.us.preheader109_crit_edge ], [ 0, %min.iters.checked..lr.ph13.us.preheader109_crit_edge ], [ 0, %.lr.ph13.us.preheader..lr.ph13.us.preheader109_crit_edge ], [ %n.vec, %middle.block..lr.ph13.us.preheader109_crit_edge ]
  br label %.lr.ph13.us

min.iters.checked:                                ; preds = %.lr.ph13.us.preheader
  br i1 %cmp.zero, label %min.iters.checked..lr.ph13.us.preheader109_crit_edge, label %vector.memcheck

min.iters.checked..lr.ph13.us.preheader109_crit_edge: ; preds = %min.iters.checked
  br label %.lr.ph13.us.preheader109

vector.memcheck:                                  ; preds = %min.iters.checked
  %bound0 = icmp ult double* %scevgep, %scevgep73
  %bound1 = icmp ugt double* %scevgep71, %5
  %memcheck.conflict = and i1 %bound0, %bound1
  br i1 %memcheck.conflict, label %vector.memcheck..lr.ph13.us.preheader109_crit_edge, label %vector.body.preheader

vector.memcheck..lr.ph13.us.preheader109_crit_edge: ; preds = %vector.memcheck
  br label %.lr.ph13.us.preheader109

vector.body.preheader:                            ; preds = %vector.memcheck
  br i1 %lcmp.mod116, label %vector.body.preheader.vector.body.prol.loopexit_crit_edge, label %vector.body.prol.preheader
...
vector.body.prol:                                 ; preds = %vector.body.prol.vector.body.prol_crit_edge, %vector.body.prol.preheader
  ...
  %prol.iter117 = phi i64 [ %prol.iter117.sub, %vector.body.prol.vector.body.prol_crit_edge ], [ %xtraiter115, %vector.body.prol.preheader ]
  ...
  %wide.load76.prol = load <2 x i64>, <2 x i64>* %30, align 8, !alias.scope !6
  ...
  store <2 x i64> %wide.load76.prol, <2 x i64>* %34, align 8, !alias.scope !9, !noalias !6
  %index.next.prol = add i64 %index.prol, 4
  %prol.iter117.sub = add i64 %prol.iter117, -1
  %prol.iter117.cmp = icmp eq i64 %prol.iter117.sub, 0
  br i1 %prol.iter117.cmp, label %vector.body.prol.loopexit.unr-lcssa, label %vector.body.prol.vector.body.prol_crit_edge, !llvm.loop !11
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.body.preheader.new
  ...
  %wide.load76 = load <2 x i64>, <2 x i64>* %38, align 8, !alias.scope !6
  ...
  store <2 x i64> %wide.load76, <2 x i64>* %42, align 8, !alias.scope !9, !noalias !6
  ...
  %wide.load76.1 = load <2 x i64>, <2 x i64>* %46, align 8, !alias.scope !6
  ...
  store <2 x i64> %wide.load76.1, <2 x i64>* %50, align 8, !alias.scope !9, !noalias !6
  ...
  %wide.load76.2 = load <2 x i64>, <2 x i64>* %54, align 8, !alias.scope !6
  ...
  store <2 x i64> %wide.load76.2, <2 x i64>* %58, align 8, !alias.scope !9, !noalias !6
  ...
  %wide.load76.3 = load <2 x i64>, <2 x i64>* %62, align 8, !alias.scope !6
  ...
  store <2 x i64> %wide.load76.3, <2 x i64>* %66, align 8, !alias.scope !9, !noalias !6
  %index.next.3 = add i64 %index, 16
  %67 = icmp eq i64 %index.next.3, %n.vec
  br i1 %67, label %middle.block.unr-lcssa, label %vector.body.vector.body_crit_edge, !llvm.loop !12
...
middle.block:                                     ; preds = %vector.body.prol.loopexit.middle.block_crit_edge, %middle.block.unr-lcssa
  br i1 %cmp.n, label %middle.block.._crit_edge14.us_crit_edge, label %middle.block..lr.ph13.us.preheader109_crit_edge

middle.block..lr.ph13.us.preheader109_crit_edge:  ; preds = %middle.block
  br label %.lr.ph13.us.preheader109
...
.prol.loopexit:                                   ; preds = %.lr.ph.us.us..prol.loopexit_crit_edge, %.prol.preheader
  %74 = phi double [ %73, %.prol.preheader ], [ 0.000000e+00, %.lr.ph.us.us..prol.loopexit_crit_edge ]
...
.lr.ph.us.us.new:                                 ; preds = %.lr.ph.us.us.new..lr.ph.us.us.new_crit_edge, %.lr.ph.us.us.new.preheader
  %75 = phi double [ %87, %.lr.ph.us.us.new..lr.ph.us.us.new_crit_edge ], [ %74, %.lr.ph.us.us.new.preheader ]
  ...
  %exitcond55.1 = icmp eq i64 %indvars.iv.next53.1, %wide.trip.count58
...
.preheader5:                                      ; preds = %.preheader5..preheader5_crit_edge, %.preheader5.preheader.new
  ...
  br i1 %exitcond.7, label %._crit_edge16.loopexit110.unr-lcssa, label %.preheader5..preheader5_crit_edge
...
._crit_edge16.loopexit110.unr-lcssa:              ; preds = %.preheader5
  br label %._crit_edge16.loopexit110

._crit_edge16.loopexit110:                        ; preds = %.preheader5.prol.loopexit.._crit_edge16.loopexit110_crit_edge, %._crit_edge16.loopexit110.unr-lcssa
  br label %._crit_edge16

._crit_edge16:                                    ; preds = %.preheader6.._crit_edge16_crit_edge, %._crit_edge16.loopexit110, %._crit_edge16.loopexit
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1
  %exitcond112 = icmp eq i64 %indvars.iv.next65, %12
  br i1 %exitcond112, label %._crit_edge32.loopexit, label %._crit_edge16..preheader6_crit_edge
