...
.preheader.us:                                    ; preds = %._crit_edge5.us..preheader.us_crit_edge, %.preheader.us.preheader
  %indvars.iv26 = phi i64 [ 0, %.preheader.us.preheader ], [ %indvars.iv.next27, %._crit_edge5.us..preheader.us_crit_edge ]
...
.lr.ph.us.new.preheader:                          ; preds = %.prol.loopexit
  %wide.trip.count.1 = zext i32 %indvar to i64
...
._crit_edge5.us:                                  ; preds = %._crit_edge5.us.loopexit, %.prol.loopexit21
  ...
  br i1 %50, label %._crit_edge5.us..preheader.us_crit_edge, label %._crit_edge44.loopexit
...
.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge..preheader_crit_edge
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %._crit_edge..preheader_crit_edge ], [ 0, %.preheader.preheader ]
...
.lr.ph.new.preheader:                             ; preds = %.prol.loopexit34
  %wide.trip.count32.1 = zext i32 %indvar35 to i64
  br label %.lr.ph.new

.lr.ph.new:                                       ; preds = %.lr.ph.new, %.lr.ph.new.preheader
  %indvars.iv28 = phi i64 [ %indvars.iv28.unr.ph, %.lr.ph.new.preheader ], [ %indvars.iv.next29.1, %.lr.ph.new ]
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit34, %.preheader
  ...
  br i1 %71, label %._crit_edge..preheader_crit_edge, label %._crit_edge44.loopexit46

._crit_edge..preheader_crit_edge:                 ; preds = %._crit_edge
  %indvar.next36 = add i32 %indvar35, 1
  br label %.preheader

._crit_edge44.loopexit:                           ; preds = %._crit_edge5.us
...
.preheader3.us:                                   ; preds = %._crit_edge6.us..preheader3.us_crit_edge, %.preheader3.us.preheader
  ...
  %15 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv, i64 %indvars.iv30
...
._crit_edge6.us:                                  ; preds = %._crit_edge.us
  br i1 %13, label %._crit_edge6.us..preheader3.us_crit_edge, label %._crit_edge.loopexit
...
._crit_edge12:                                    ; preds = %._crit_edge11, %.preheader.us
  ...
  %14 = srem i32 %13, 20
  %15 = icmp eq i32 %14, 0
  br i1 %15, label %16, label %._crit_edge11

; <label>:16:                                     ; preds = %._crit_edge12
  %17 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %fputc.us = call i32 @fputc(i32 10, %struct._IO_FILE* %17) #5
  br label %._crit_edge11

._crit_edge11:                                    ; preds = %._crit_edge12, %16
...
._crit_edge.us:                                   ; preds = %._crit_edge11
  ...
  %exitcond13 = icmp eq i64 %indvars.iv.next10, %10
  br i1 %exitcond13, label %._crit_edge.loopexit, label %.preheader.us
