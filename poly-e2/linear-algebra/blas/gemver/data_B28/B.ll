...
for.cond.loopexit:                                ; preds = %for.inc
  ...
  br i1 %exitcond6, label %for.end48, label %for.body

for.body:                                         ; preds = %for.cond.loopexit, %entry
  %indvars.iv4 = phi i64 [ 0, %entry ], [ %indvars.iv.next5, %for.cond.loopexit ]
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  br i1 %31, label %for.inc20.loopexit31, label %vector.body, !llvm.loop !13

for.inc:                                          ; preds = %for.inc.preheader, %for.inc
  %indvars.iv20 = phi i64 [ %indvars.iv.next21.1, %for.inc ], [ 0, %for.inc.preheader ]
  ...
  br i1 %exitcond22.1, label %for.inc20.loopexit, label %for.inc, !llvm.loop !16

for.inc20.loopexit:                               ; preds = %for.inc
  br label %for.inc20

for.inc20.loopexit31:                             ; preds = %vector.body
  br label %for.inc20

for.inc20:                                        ; preds = %for.inc20.loopexit31, %for.inc20.loopexit
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  %exitcond25 = icmp eq i64 %indvars.iv.next24, 2000
  br i1 %exitcond25, label %for.cond26.preheader.preheader, label %for.cond1.preheader
...
for.cond26.preheader:                             ; preds = %for.cond26.preheader.preheader, %for.inc45
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc45 ], [ 0, %for.cond26.preheader.preheader ]
  %arrayidx30 = getelementptr inbounds double, double* %x, i64 %indvars.iv17
  %.pre = load double, double* %arrayidx30, align 8
  br label %for.inc42

for.inc42:                                        ; preds = %for.inc42, %for.cond26.preheader
  %42 = phi double [ %.pre, %for.cond26.preheader ], [ %add39.1, %for.inc42 ]
  %indvars.iv14 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next15.1, %for.inc42 ]
  ...
  br i1 %exitcond16.1, label %for.inc45, label %for.inc42

for.inc45:                                        ; preds = %for.inc42
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  %exitcond19 = icmp eq i64 %indvars.iv.next18, 2000
  br i1 %exitcond19, label %for.inc58.preheader, label %for.cond26.preheader

for.inc58.preheader:                              ; preds = %for.inc45
  br label %for.inc58

for.inc58:                                        ; preds = %for.inc58.preheader, %for.inc58
  %indvars.iv11 = phi i64 [ %indvars.iv.next12.4, %for.inc58 ], [ 0, %for.inc58.preheader ]
  ...
  br i1 %exitcond13.4, label %for.cond64.preheader.preheader, label %for.inc58

for.cond64.preheader.preheader:                   ; preds = %for.inc58
  br label %for.cond64.preheader

for.cond64.preheader:                             ; preds = %for.cond64.preheader.preheader, %for.inc83
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc83 ], [ 0, %for.cond64.preheader.preheader ]
  %arrayidx68 = getelementptr inbounds double, double* %w, i64 %indvars.iv8
  %.pre26 = load double, double* %arrayidx68, align 8
  br label %for.inc80

for.inc80:                                        ; preds = %for.inc80, %for.cond64.preheader
  %57 = phi double [ %.pre26, %for.cond64.preheader ], [ %add77.1, %for.inc80 ]
  %indvars.iv = phi i64 [ 0, %for.cond64.preheader ], [ %indvars.iv.next.1, %for.inc80 ]
...
for.inc83:                                        ; preds = %for.inc80
  ...
  br i1 %exitcond10, label %for.end85, label %for.cond64.preheader
