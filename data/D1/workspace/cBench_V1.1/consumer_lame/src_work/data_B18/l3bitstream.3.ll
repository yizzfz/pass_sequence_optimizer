...
@__llvm_prf_nm = private constant [229 x i8] c"\E2\01\00putMyBits\01III_format_bitstream\01tmp1.ll:encodeSideInfo\01tmp1.ll:encodeMainData\01tmp1.ll:drain_into_ancillary_data\01III_FlushBitstream\01abs_and_sign\01L3_huffman_coder_count1\01HuffmanCode\01tmp1.ll:Huffmancodebits\01tmp1.ll:CRC_BF_addEntry", section "__llvm_prf_names"
@llvm.used = appending global [12 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_putMyBits to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_III_format_bitstream to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_encodeSideInfo to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_encodeMainData to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_drain_into_ancillary_data to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_III_FlushBitstream to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_abs_and_sign to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_L3_huffman_coder_count1 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_HuffmanCode to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_Huffmancodebits to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_CRC_BF_addEntry to i8*), i8* getelementptr inbounds ([229 x i8], [229 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
