...
entry:
  ...
  call fastcc void @kernel_trisolv(i32 2000, [2000 x double]* %arraydecay, double* %arraydecay3, double* %arraydecay7)
...
for.body.preheader:                               ; preds = %entry
  ...
  %sunkaddr20 = ptrtoint double* %x to i64
...
for.body:                                         ; preds = %for.end, %for.body.preheader
  ...
  %2 = add nuw nsw i64 %indvars.iv7, 4294967295
...
for.body5.prol.loopexit:                          ; preds = %for.body5.prol, %for.body5.preheader
  ...
  %.unr.ph = phi double [ %sub.prol, %for.body5.prol ], [ %7, %for.body5.preheader ]
  %11 = icmp eq i64 %3, 0
  br i1 %11, label %for.end, label %for.body5.preheader.new

for.body5.preheader.new:                          ; preds = %for.body5.prol.loopexit
  %sunkaddr21 = shl i64 %indvars.iv7, 3
...
for.body5:                                        ; preds = %for.body5, %for.body5.preheader.new
  ...
  %12 = phi double [ %.unr.ph, %for.body5.preheader.new ], [ %sub.1, %for.body5 ]
  ...
  store double %sub, double* %sunkaddr23, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  ...
  store double %sub.1, double* %sunkaddr23, align 8
...
for.end:                                          ; preds = %for.end.loopexit, %for.body5.prol.loopexit, %for.body
  %.lcssa = phi double [ %7, %for.body ], [ %sub.lcssa.unr.ph, %for.body5.prol.loopexit ], [ %sub.1, %for.end.loopexit ]
  ...
  %sunkaddr14 = add i64 %1, %sunkaddr13
