...
for.cond5.preheader.us:                           ; preds = %for.cond5.preheader.us.preheader, %for.cond5.for.inc39_crit_edge.us
  ...
  %mul.v.i1.2.us = shufflevector <2 x double> %1, <2 x double> undef, <2 x i32> zeroinitializer
...
for.inc36.us:                                     ; preds = %for.inc36.us, %for.cond5.preheader.us
  ...
  %mul.v.i0.2.us = insertelement <2 x double> %mul.v.i0.1.us, double %conv18.us, i32 1
