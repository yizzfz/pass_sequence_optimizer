...
._crit_edge2:                                     ; preds = %._crit_edge2, %.lr.ph
  ...
  %storemerge1 = phi i32 [ 0, %.lr.ph ], [ %22, %._crit_edge2 ]
  %9 = sitofp i32 %storemerge1 to double
  ...
  %16 = fadd <2 x double> %15, <double 2.000000e+00, double 3.000000e+00>
  %17 = fdiv <2 x double> %16, %8
  ...
  %21 = icmp slt i64 %indvars.iv.next, %6
  %22 = trunc i64 %indvars.iv.next to i32
  br i1 %21, label %._crit_edge2, label %._crit_edge.loopexit
...
._crit_edge.us:                                   ; preds = %._crit_edge7.us, %._crit_edge.us.preheader
  %18 = phi i32 [ 0, %._crit_edge.us.preheader ], [ %44, %._crit_edge7.us ]
...
scalar.ph53.preheader:                            ; preds = %middle.block52, %vector.memcheck72, %min.iters.checked56, %._crit_edge.us
  %indvars.iv.ph = phi i64 [ %ind.end77, %middle.block52 ], [ 1, %vector.memcheck72 ], [ 1, %min.iters.checked56 ], [ 1, %._crit_edge.us ]
...
middle.block52:                                   ; preds = %vector.body51
  br i1 %cmp.n78, label %.lr.ph6.us.preheader, label %scalar.ph53.preheader
...
.lr.ph6.us:                                       ; preds = %.lr.ph6.us.preheader91, %.lr.ph6.us
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %.lr.ph6.us ], [ %indvars.iv29.ph, %.lr.ph6.us.preheader91 ]
...
scalar.ph53:                                      ; preds = %scalar.ph53.preheader, %scalar.ph53
  ...
  br i1 %69, label %scalar.ph53, label %.lr.ph6.us.preheader.loopexit, !llvm.loop !10
...
.lr.ph6.us.preheader91:                           ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.lr.ph6.us.preheader
  %indvars.iv29.ph = phi i64 [ %ind.end, %middle.block ], [ 1, %vector.memcheck ], [ 1, %min.iters.checked ], [ 1, %.lr.ph6.us.preheader ]
  br label %.lr.ph6.us
...
define internal fastcc void @print_array(i32, double*) unnamed_addr #0 {
  ...
  %7 = icmp sgt i32 %0, 0
  br i1 %7, label %.lr.ph, label %._crit_edge4
...
._crit_edge:                                      ; preds = %._crit_edge._crit_edge, %11
  ...
  br i1 %17, label %._crit_edge._crit_edge, label %._crit_edge4.loopexit
