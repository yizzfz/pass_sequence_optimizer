...
.preheader:                                       ; preds = %17, %2
  %indvars.iv7 = phi i64 [ 0, %2 ], [ %indvars.iv.next8, %17 ]
  br label %3
...
.preheader4:                                      ; preds = %21, %2
  %indvars.iv8 = phi i64 [ 0, %2 ], [ %indvars.iv.next9, %21 ]
  br label %.preheader

.preheader:                                       ; preds = %20, %.preheader4
  %indvars.iv6 = phi i64 [ 0, %.preheader4 ], [ %indvars.iv.next7, %20 ]
  %3 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv6
  %4 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv6, i64 %indvars.iv8
  %sunkaddr = ptrtoint [2800 x i32]* %3 to i64
  br label %5

; <label>:5:                                      ; preds = %5, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %5 ]
  %6 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv6, i64 %indvars.iv
  %7 = load i32, i32* %6, align 4
  %8 = load i32, i32* %4, align 4
  %9 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv8, i64 %indvars.iv
  %10 = load i32, i32* %9, align 4
  %11 = add nsw i32 %10, %8
  %12 = icmp slt i32 %7, %11
  %. = select i1 %12, i32 %7, i32 %11
  %sunkaddr1 = shl nsw i64 %indvars.iv, 2
  %sunkaddr2 = add i64 %sunkaddr1, %sunkaddr
  %sunkaddr3 = inttoptr i64 %sunkaddr2 to i32*
  store i32 %., i32* %sunkaddr3, align 4
  %indvars.iv.next = or i64 %indvars.iv, 1
  %13 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv6, i64 %indvars.iv.next
  %14 = load i32, i32* %13, align 4
  %15 = load i32, i32* %4, align 4
  %16 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv8, i64 %indvars.iv.next
  %17 = load i32, i32* %16, align 4
  %18 = add nsw i32 %17, %15
  %19 = icmp slt i32 %14, %18
  %..1 = select i1 %19, i32 %14, i32 %18
  %sunkaddr1.1 = shl nsw i64 %indvars.iv.next, 2
  %sunkaddr2.1 = add i64 %sunkaddr1.1, %sunkaddr
  %sunkaddr3.1 = inttoptr i64 %sunkaddr2.1 to i32*
  store i32 %..1, i32* %sunkaddr3.1, align 4
...
.preheader:                                       ; preds = %20, %2
  ...
  %7 = mul nuw nsw i64 %indvars.iv1, 2800
  br label %8
...
; <label>:15:                                     ; preds = %13, %8
  ...
  %17 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv1, i64 %indvars.iv
