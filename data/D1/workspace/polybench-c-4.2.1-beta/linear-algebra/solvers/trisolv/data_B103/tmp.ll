...
.prol.preheader:                                  ; preds = %.lr.ph
  ...
  %13 = fsub double %6, %12
  %sunkaddr19.prol = shl i64 %indvars.iv15, 3
  %sunkaddr20.prol = add i64 %sunkaddr, %sunkaddr19.prol
  %sunkaddr21.prol = inttoptr i64 %sunkaddr20.prol to double*
  store double %13, double* %sunkaddr21.prol, align 8
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph
  %indvars.iv.unr.ph = phi i64 [ 1, %.prol.preheader ], [ 0, %.lr.ph ]
  %.unr.ph = phi double [ %13, %.prol.preheader ], [ %6, %.lr.ph ]
  %.lcssa22.unr.ph = phi double [ %13, %.prol.preheader ], [ undef, %.lr.ph ]
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %4
  %.lcssa = phi double [ %6, %4 ], [ %.lcssa22.unr.ph, %.prol.loopexit ], [ %27, %._crit_edge.loopexit ]
  ...
  br i1 %exitcond, label %._crit_edge10, label %4
