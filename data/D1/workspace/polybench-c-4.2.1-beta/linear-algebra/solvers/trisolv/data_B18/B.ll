...
.lr.ph:                                           ; preds = %._crit_edge, %.lr.ph5
  ...
  %9 = add i32 %8, 2001
  %10 = and i64 %indvars.iv11, 1
  %lcmp.mod = icmp eq i64 %10, 0
  br i1 %lcmp.mod, label %11, label %.prol.loopexit
...
.prol.loopexit:                                   ; preds = %11, %.lr.ph
  %indvars.iv.unr.ph = phi i64 [ 1, %11 ], [ 0, %.lr.ph ]
  %16 = icmp eq i64 %indvars.iv11, 0
...
.lr.ph12.preheader:
  %sunkaddr25 = ptrtoint double* %2 to i64
...
.lr.ph12:                                         ; preds = %.lr.ph12.preheader, %._crit_edge
  ...
  %7 = getelementptr inbounds double, double* %2, i64 %indvars.iv18
  store double %6, double* %7, align 8
...
; <label>:9:                                      ; preds = %.lr.ph
  %10 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv18, i64 0
  %11 = load double, double* %10, align 8
  %12 = load double, double* %2, align 8
  %13 = fmul double %11, %12
  %14 = fsub double %6, %13
  %sunkaddr22 = shl i64 %indvars.iv18, 3
  %sunkaddr23 = add i64 %sunkaddr, %sunkaddr22
  %sunkaddr24 = inttoptr i64 %sunkaddr23 to double*
  store double %14, double* %sunkaddr24, align 8
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.lr.ph, %9
  %indvars.iv.unr.ph = phi i64 [ 1, %9 ], [ 0, %.lr.ph ]
  %.unr.ph = phi double [ %14, %9 ], [ %6, %.lr.ph ]
  %.lcssa15.unr.ph = phi double [ %14, %9 ], [ undef, %.lr.ph ]
  %15 = icmp eq i64 %indvars.iv18, 1
  br i1 %15, label %._crit_edge, label %.lr.ph.new.preheader

.lr.ph.new.preheader:                             ; preds = %.prol.loopexit
  %sunkaddr26 = shl i64 %indvars.iv18, 3
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %23 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv18, i64 %indvars.iv.next
  %24 = load double, double* %23, align 8
  %25 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next
  %26 = load double, double* %25, align 8
  %27 = fmul double %24, %26
  %28 = fsub double %22, %27
  store double %28, double* %sunkaddr28, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %.lr.ph12
  %.lcssa = phi double [ %6, %.lr.ph12 ], [ %.lcssa15.unr.ph, %.prol.loopexit ], [ %28, %._crit_edge.loopexit ]
  %29 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv18, i64 %indvars.iv18
  ...
  br i1 %exitcond21, label %._crit_edge13, label %.lr.ph12
