...
.preheader:                                       ; preds = %19, %2
  %indvars.iv21 = phi i64 [ 0, %2 ], [ %indvars.iv.next22, %19 ]
  br label %3

; <label>:3:                                      ; preds = %3, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %3 ]
  %4 = mul nuw nsw i64 %indvars.iv, %indvars.iv21
  %5 = trunc i64 %4 to i32
  %6 = srem i32 %5, 7
  %7 = add nsw i32 %6, 1
  %8 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv21, i64 %indvars.iv
  %9 = add nuw nsw i64 %indvars.iv, %indvars.iv21
  ...
  %17 = srem i32 %16, 11
  %18 = icmp eq i32 %17, 0
  %or.cond17 = or i1 %18, %or.cond
  %. = select i1 %or.cond17, i32 999, i32 %7
...
; <label>:19:                                     ; preds = %3
  ...
  br i1 %exitcond23, label %20, label %.preheader
