...
.lr.ph54:                                         ; preds = %._crit_edge61, %.preheader15.lr.ph
  %indvars.iv130 = phi i64 [ %indvars.iv.next131, %._crit_edge61 ], [ 0, %.preheader15.lr.ph ]
  %indvars.iv124 = phi i64 [ %indvars.iv.next125, %._crit_edge61 ], [ 1, %.preheader15.lr.ph ]
  %sext = shl i64 %indvars.iv124, 32
  br label %3

; <label>:3:                                      ; preds = %3, %.lr.ph54
  %indvars.iv118 = phi i64 [ 0, %.lr.ph54 ], [ %indvars.iv.next119, %3 ]
  %4 = sub nsw i64 0, %indvars.iv118
  %5 = trunc i64 %4 to i32
  %6 = srem i32 %5, 2000
  %7 = sitofp i32 %6 to double
  %8 = fdiv double %7, 2.000000e+03
  %9 = fadd double %8, 1.000000e+00
  %10 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv130, i64 %indvars.iv118
  store double %9, double* %10, align 8
  %indvars.iv.next119 = add nuw nsw i64 %indvars.iv118, 1
  %exitcond123 = icmp eq i64 %indvars.iv118, %indvars.iv130
  br i1 %exitcond123, label %._crit_edge55, label %3

._crit_edge55:                                    ; preds = %3
  %11 = ashr exact i64 %sext, 32
  %indvars.iv.next131 = add nuw nsw i64 %indvars.iv130, 1
  %12 = icmp slt i64 %indvars.iv.next131, 2000
...
vector.body.prol:                                 ; preds = %vector.body.prol, %vector.body.prol.preheader
  ...
  %18 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv130, i64 %17
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader.new
  ...
  %23 = add i64 %11, %index
  %24 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv130, i64 %23
  ...
  %29 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv130, i64 %28
  ...
  %34 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv130, i64 %33
  ...
  %39 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv130, i64 %38
...
.lr.ph60.preheader30:                             ; preds = %middle.block, %min.iters.checked, %.lr.ph60.preheader
  %indvars.iv126.ph = phi i64 [ %11, %min.iters.checked ], [ %11, %.lr.ph60.preheader ], [ %ind.end, %middle.block ]
  br label %.lr.ph60

.lr.ph60:                                         ; preds = %.lr.ph60.preheader30, %.lr.ph60
  %indvars.iv126 = phi i64 [ %indvars.iv.next127, %.lr.ph60 ], [ %indvars.iv126.ph, %.lr.ph60.preheader30 ]
  %44 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv130, i64 %indvars.iv126
  store double 0.000000e+00, double* %44, align 8
  %indvars.iv.next127 = add nsw i64 %indvars.iv126, 1
  %exitcond129 = icmp eq i64 %indvars.iv126, 1999
  br i1 %exitcond129, label %._crit_edge61.loopexit, label %.lr.ph60, !llvm.loop !6

._crit_edge61.loopexit:                           ; preds = %.lr.ph60
  br label %._crit_edge61

._crit_edge61:                                    ; preds = %._crit_edge61.loopexit, %middle.block
  %45 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv130, i64 %indvars.iv130
  store double 1.000000e+00, double* %45, align 8
  %indvars.iv.next125 = add nsw i64 %11, 1
  br label %.lr.ph54

.preheader14.us.preheader:                        ; preds = %._crit_edge55
  %46 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv130, i64 %indvars.iv130
...
._crit_edge47.us:                                 ; preds = %._crit_edge47.us, %.preheader14.us.preheader
  %indvars.iv115 = phi i64 [ 0, %.preheader14.us.preheader ], [ %indvars.iv.next116.7, %._crit_edge47.us ]
  %scevgep = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %49, i64 0, i64 %indvars.iv115, i64 0
  %scevgep114 = bitcast double* %scevgep to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep114, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next116 = or i64 %indvars.iv115, 1
  %scevgep.1 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %50, i64 0, i64 %indvars.iv.next116, i64 0
  %scevgep114.1 = bitcast double* %scevgep.1 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep114.1, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next116.1 = or i64 %indvars.iv115, 2
  %scevgep.2 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %51, i64 0, i64 %indvars.iv.next116.1, i64 0
  %scevgep114.2 = bitcast double* %scevgep.2 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep114.2, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next116.2 = or i64 %indvars.iv115, 3
  %scevgep.3 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %52, i64 0, i64 %indvars.iv.next116.2, i64 0
  %scevgep114.3 = bitcast double* %scevgep.3 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep114.3, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next116.3 = or i64 %indvars.iv115, 4
  %scevgep.4 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %53, i64 0, i64 %indvars.iv.next116.3, i64 0
  %scevgep114.4 = bitcast double* %scevgep.4 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep114.4, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next116.4 = or i64 %indvars.iv115, 5
  %scevgep.5 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %54, i64 0, i64 %indvars.iv.next116.4, i64 0
  %scevgep114.5 = bitcast double* %scevgep.5 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep114.5, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next116.5 = or i64 %indvars.iv115, 6
  %scevgep.6 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %55, i64 0, i64 %indvars.iv.next116.5, i64 0
  %scevgep114.6 = bitcast double* %scevgep.6 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep114.6, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next116.6 = or i64 %indvars.iv115, 7
  %scevgep.7 = getelementptr [2000 x [2000 x double]], [2000 x [2000 x double]]* %56, i64 0, i64 %indvars.iv.next116.6, i64 0
  %scevgep114.7 = bitcast double* %scevgep.7 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep114.7, i8 0, i64 16000, i32 8, i1 false)
  %indvars.iv.next116.7 = add nsw i64 %indvars.iv115, 8
  %exitcond34.7 = icmp eq i64 %indvars.iv.next116.7, 2000
...
.preheader11.us.us.preheader:                     ; preds = %._crit_edge27.us, %.preheader11.us.us.preheader.preheader
  %indvars.iv107 = phi i64 [ %indvars.iv.next108, %._crit_edge27.us ], [ 0, %.preheader11.us.us.preheader.preheader ]
  br label %.preheader11.us.us

._crit_edge27.us:                                 ; preds = %._crit_edge25.us.us
  %indvars.iv.next108 = add nuw nsw i64 %indvars.iv107, 1
  %exitcond33 = icmp eq i64 %indvars.iv.next108, 2000
...
.preheader11.us.us:                               ; preds = %._crit_edge25.us.us, %.preheader11.us.us.preheader
  %indvars.iv105 = phi i64 [ 0, %.preheader11.us.us.preheader ], [ %indvars.iv.next106, %._crit_edge25.us.us ]
  %59 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv105, i64 %indvars.iv107
  br label %60

._crit_edge25.us.us:                              ; preds = %60
  %indvars.iv.next106 = add nuw nsw i64 %indvars.iv105, 1
  %exitcond32 = icmp eq i64 %indvars.iv.next106, 2000
...
; <label>:60:                                     ; preds = %60, %.preheader11.us.us
  ...
  %62 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv101, i64 %indvars.iv107
  %63 = load double, double* %62, align 8
  %64 = fmul double %61, %63
  %65 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %57, i64 0, i64 %indvars.iv105, i64 %indvars.iv101
  %66 = load double, double* %65, align 8
  %67 = fadd double %64, %66
  store double %67, double* %65, align 8
  %indvars.iv.next102 = or i64 %indvars.iv101, 1
  %68 = load double, double* %59, align 8
  %69 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv.next102, i64 %indvars.iv107
  %70 = load double, double* %69, align 8
  %71 = fmul double %68, %70
  %72 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %58, i64 0, i64 %indvars.iv105, i64 %indvars.iv.next102
  ...
  br i1 %exitcond104.1, label %._crit_edge25.us.us, label %60
...
._crit_edge16:                                    ; preds = %._crit_edge16.loopexit, %.preheader6
  ...
  br i1 %exitcond5, label %._crit_edge21, label %.preheader6
