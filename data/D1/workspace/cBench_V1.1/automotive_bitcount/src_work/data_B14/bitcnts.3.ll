...
@__llvm_prf_nm = private constant [27 x i8] c"\19\00main1\01tmp1.ll:bit_shifter", section "__llvm_prf_names"
@llvm.used = appending global [4 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_main1 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_bit_shifter to i8*), i8* bitcast ([10 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
