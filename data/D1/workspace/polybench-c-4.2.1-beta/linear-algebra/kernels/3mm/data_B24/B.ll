...
._crit_edge124:                                   ; preds = %._crit_edge124, %.lr.ph77.split.us
  %indvars.iv106 = phi i64 [ 0, %.lr.ph77.split.us ], [ %indvars.iv.next107, %._crit_edge124 ]
  ...
  br i1 %exitcond109, label %._crit_edge73.us, label %._crit_edge124
...
._crit_edge125:                                   ; preds = %._crit_edge125, %.lr.ph68.split.us
  %indvars.iv97 = phi i64 [ 0, %.lr.ph68.split.us ], [ %indvars.iv.next98, %._crit_edge125 ]
  ...
  br i1 %exitcond100, label %._crit_edge64.us, label %._crit_edge125
...
._crit_edge126:                                   ; preds = %._crit_edge126, %.lr.ph59.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph59.split.us ], [ %indvars.iv.next, %._crit_edge126 ]
  ...
  br i1 %exitcond, label %._crit_edge.us, label %._crit_edge126
...
._crit_edge23:                                    ; preds = %._crit_edge, %.lr.ph15.split.us
...
._crit_edge:                                      ; preds = %._crit_edge23, %12
...
._crit_edge.us:                                   ; preds = %._crit_edge
  ...
  br i1 %exitcond21, label %._crit_edge16, label %.lr.ph15.split.us
