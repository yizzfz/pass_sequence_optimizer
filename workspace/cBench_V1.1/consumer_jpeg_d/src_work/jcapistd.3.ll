...
@__llvm_prf_nm = private constant [56 x i8] c"<6x\DAU\C8A\0A\00 \08\04@z\A9,%\A1\94\85\0A}?:6\C7\D1\CD\9D\22\E1Iu\CD\ED\1CQ\F4\DDqI\A6\A8\B0!\C6_:\0E5$.\E3\81\18\22", section "__llvm_prf_names"
@llvm.used = appending global [5 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_start_compress to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_write_scanlines to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_write_raw_data to i8*), i8* bitcast ([15 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([56 x i8], [56 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
