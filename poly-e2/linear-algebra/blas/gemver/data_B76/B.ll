...
for.body.us:                                      ; preds = %for.cond35.for.inc46_crit_edge.us, %entry
  %indvars.iv35 = phi i64 [ 0, %entry ], [ %indvars.iv.next36, %for.cond35.for.inc46_crit_edge.us ]
...
for.body38.us:                                    ; preds = %for.body.us, %for.body38.us
  ...
  %7 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv35
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv83, i64 %offset.idx
  ...
  %18 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv83, i64 %17
...
for.body3.us:                                     ; preds = %for.body3.us.preheader, %for.body3.us
  %indvars.iv79 = phi i64 [ %indvars.iv.next80.1, %for.body3.us ], [ 0, %for.body3.us.preheader ]
  ...
  br i1 %exitcond82.1, label %for.cond1.for.inc20_crit_edge.us.loopexit, label %for.body3.us, !llvm.loop !16
...
for.body28.us:                                    ; preds = %for.cond26.preheader.us, %for.body28.us
  ...
  %36 = phi double [ %add39.us.1, %for.body28.us ], [ %.pre, %for.cond26.preheader.us ]
...
vector.body31:                                    ; preds = %vector.body31.preheader, %vector.body31
  ...
  br i1 %56, label %for.cond64.preheader.us.preheader.loopexit67, label %vector.body31, !llvm.loop !22
...
for.body66.us:                                    ; preds = %for.cond64.preheader.us, %for.body66.us
  ...
  %57 = phi double [ %add77.us.1, %for.body66.us ], [ %.pre62, %for.cond64.preheader.us ]
  %arrayidx72.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv63, i64 %indvars.iv
  %58 = load double, double* %arrayidx72.us, align 8
  %mul73.us = fmul double %58, %alpha
  %arrayidx75.us = getelementptr inbounds double, double* %x, i64 %indvars.iv
  %59 = load double, double* %arrayidx75.us, align 8
  %mul76.us = fmul double %mul73.us, %59
  %add77.us = fadd double %57, %mul76.us
  ...
  %60 = load double, double* %arrayidx72.us.1, align 8
  %mul73.us.1 = fmul double %60, %alpha
  %arrayidx75.us.1 = getelementptr inbounds double, double* %x, i64 %indvars.iv.next
  %61 = load double, double* %arrayidx75.us.1, align 8
  %mul76.us.1 = fmul double %mul73.us.1, %61
...
for.body50:                                       ; preds = %for.body50.preheader, %for.body50
  %indvars.iv67 = phi i64 [ %indvars.iv.next68.3, %for.body50 ], [ 0, %for.body50.preheader ]
  ...
  br i1 %exitcond70.3, label %for.cond64.preheader.us.preheader.loopexit, label %for.body50, !llvm.loop !23
