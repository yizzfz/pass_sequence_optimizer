...
.preheader65:                                     ; preds = %52, %.preheader65.preheader
  %indvars.iv10 = phi i64 [ 0, %.preheader65.preheader ], [ %indvars.iv.next11, %52 ]
  br label %._crit_edge19

._crit_edge19:                                    ; preds = %._crit_edge19, %.preheader65
  %indvars.iv7 = phi i64 [ 0, %.preheader65 ], [ %indvars.iv.next8.1, %._crit_edge19 ]
  %sunkaddr44 = ptrtoint double* %8 to i64
  %sunkaddr45 = mul i64 %indvars.iv10, 8
  %sunkaddr46 = add i64 %sunkaddr44, %sunkaddr45
  %sunkaddr47 = inttoptr i64 %sunkaddr46 to double*
  %37 = load double, double* %sunkaddr47, align 8
  ...
  store double %44, double* %sunkaddr47, align 8
...
.preheader:                                       ; preds = %93, %.preheader.preheader
  %indvars.iv1 = phi i64 [ 0, %.preheader.preheader ], [ %indvars.iv.next2, %93 ]
...
._crit_edge21:                                    ; preds = %._crit_edge21, %.preheader
  ...
  store double %85, double* %sunkaddr51, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %92, double* %sunkaddr51, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %93, label %._crit_edge21

; <label>:93:                                     ; preds = %._crit_edge21
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 2000
  br i1 %exitcond3, label %94, label %.preheader
