...
.lr.ph5:                                          ; preds = %.lr.ph5, %.lr.ph5.preheader
  ...
  br i1 %exitcond12.2, label %.lr.ph2.split.us.preheader, label %.lr.ph5
...
.lr.ph2.split.us:                                 ; preds = %.lr.ph2.split.us.preheader, %._crit_edge.us
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %._crit_edge.us ], [ 0, %.lr.ph2.split.us.preheader ]
  br label %._crit_edge
...
._crit_edge.us:                                   ; preds = %._crit_edge
  ...
  br i1 %exitcond9, label %._crit_edge3, label %.lr.ph2.split.us
...
; Function Attrs: noinline nounwind uwtable
define internal fastcc void @kernel_atax([2100 x double]*, double* nocapture readonly, double*, double* nocapture) unnamed_addr #0 {
...
.lr.ph5.split.us:                                 ; preds = %._crit_edge3.us, %.lr.ph5.split.us.preheader
  %7 = phi [2100 x double]* [ %0, %.lr.ph5.split.us.preheader ], [ %35, %._crit_edge3.us ]
  %8 = phi double* [ %2, %.lr.ph5.split.us.preheader ], [ %32, %._crit_edge3.us ]
  %indvars.iv19 = phi i64 [ 0, %.lr.ph5.split.us.preheader ], [ %indvars.iv.next20, %._crit_edge3.us ]
  %9 = getelementptr inbounds double, double* %3, i64 %indvars.iv19
  store double 0.000000e+00, double* %9, align 8
  %sunkaddr1 = shl nuw nsw i64 %indvars.iv19, 3
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph5.split.us
  %10 = phi double [ 0.000000e+00, %.lr.ph5.split.us ], [ %22, %._crit_edge ]
  %indvars.iv = phi i64 [ 0, %.lr.ph5.split.us ], [ %indvars.iv.next.1, %._crit_edge ]
  %11 = getelementptr inbounds [2100 x double], [2100 x double]* %7, i64 %indvars.iv19, i64 %indvars.iv
  ...
  %indvars.iv.next = or i64 %indvars.iv, 1
  %17 = getelementptr inbounds [2100 x double], [2100 x double]* %7, i64 %indvars.iv19, i64 %indvars.iv.next
  ...
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2100
  br i1 %exitcond.1, label %.lr.ph2.us.preheader, label %._crit_edge

.lr.ph2.us.preheader:                             ; preds = %._crit_edge
  %sunkaddr5 = shl nuw nsw i64 %indvars.iv19, 3
  %sunkaddr6 = add i64 %sunkaddr4, %sunkaddr5
  %sunkaddr7 = inttoptr i64 %sunkaddr6 to double*
  %sunkaddr9 = shl nuw nsw i64 %indvars.iv19, 3
  %sunkaddr10 = add i64 %sunkaddr8, %sunkaddr9
  %sunkaddr11 = inttoptr i64 %sunkaddr10 to double*
  br label %.lr.ph2.us

.lr.ph2.us:                                       ; preds = %.lr.ph2.us.preheader, %.lr.ph2.us..lr.ph2.us_crit_edge
  %23 = phi double [ %.pre, %.lr.ph2.us..lr.ph2.us_crit_edge ], [ %22, %.lr.ph2.us.preheader ]
  %24 = phi [2100 x double]* [ %35, %.lr.ph2.us..lr.ph2.us_crit_edge ], [ %7, %.lr.ph2.us.preheader ]
  %25 = phi double* [ %32, %.lr.ph2.us..lr.ph2.us_crit_edge ], [ %8, %.lr.ph2.us.preheader ]
  %indvars.iv16 = phi i64 [ %indvars.iv.next17.1, %.lr.ph2.us..lr.ph2.us_crit_edge ], [ 0, %.lr.ph2.us.preheader ]
  %26 = getelementptr inbounds double, double* %25, i64 %indvars.iv16
  %27 = load double, double* %26, align 8
  %28 = getelementptr inbounds [2100 x double], [2100 x double]* %24, i64 %indvars.iv19, i64 %indvars.iv16
  ...
  %33 = getelementptr inbounds double, double* %32, i64 %indvars.iv.next17
  %34 = load double, double* %33, align 8
  %35 = load [2100 x double]*, [2100 x double]** %4, align 8
  %36 = getelementptr inbounds [2100 x double], [2100 x double]* %35, i64 %indvars.iv19, i64 %indvars.iv.next17
  %37 = load double, double* %36, align 8
  %38 = load double, double* %sunkaddr7, align 8
  %39 = fmul double %37, %38
  %40 = fadd double %34, %39
  store double %40, double* %33, align 8
  %indvars.iv.next17.1 = add nuw nsw i64 %indvars.iv16, 2
  %exitcond.118 = icmp eq i64 %indvars.iv.next17.1, 2100
  br i1 %exitcond.118, label %._crit_edge3.us, label %.lr.ph2.us..lr.ph2.us_crit_edge

.lr.ph2.us..lr.ph2.us_crit_edge:                  ; preds = %.lr.ph2.us
