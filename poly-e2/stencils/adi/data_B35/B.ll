...
entry:
  ...
  tail call void @init_array([1000 x double]* %0)
  tail call void (...) @polybench_timer_start() #4
  %1 = bitcast i8* %call1 to [1000 x double]*
  %2 = bitcast i8* %call2 to [1000 x double]*
  %3 = bitcast i8* %call3 to [1000 x double]*
  tail call void @kernel_adi([1000 x double]* %0, [1000 x double]* %1, [1000 x double]* %2, [1000 x double]* %3)
...
if.then:                                          ; preds = %land.lhs.true
  ...
  tail call void @print_array([1000 x double]* %5)
  br label %if.end
...
define internal void @init_array([1000 x double]* %u) #2 {
entry:
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal void @kernel_adi([1000 x double]* %u, [1000 x double]* %v, [1000 x double]* %p, [1000 x double]* %q) #2 {
entry:
...
for.inc.us.lver.check:                            ; preds = %for.inc118.us.for.inc120.us_crit_edge, %for.cond15.preheader
  %indvar = phi i64 [ %0, %for.inc118.us.for.inc120.us_crit_edge ], [ 0, %for.cond15.preheader ]
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc118.us.for.inc120.us_crit_edge ], [ 1, %for.cond15.preheader ]
  %0 = add i64 %indvar, 1
  ...
  %scevgep4 = getelementptr [1000 x double], [1000 x double]* %q, i64 %0, i64 0
...
for.inc.us.lver.orig:                             ; preds = %for.inc.us.lver.orig.preheader, %for.inc.us.lver.orig
  %indvars.iv50.lver.orig = phi i64 [ %indvars.iv.next51.lver.orig, %for.inc.us.lver.orig ], [ 1, %for.inc.us.lver.orig.preheader ]
  %5 = add nsw i64 %indvars.iv50.lver.orig, -1
  ...
  %arrayidx47.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv57, i64 %indvars.iv50.lver.orig
  store double %div43.us.lver.orig, double* %arrayidx47.us.lver.orig, align 8
  %arrayidx53.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv50.lver.orig, i64 %4
  ...
  %arrayidx67.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv50.lver.orig, i64 %indvars.iv.next58
  ...
  %arrayidx88.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv57, i64 %indvars.iv50.lver.orig
  store double %div84.us.lver.orig, double* %arrayidx88.us.lver.orig, align 8
  %indvars.iv.next51.lver.orig = add nuw nsw i64 %indvars.iv50.lver.orig, 1
  %cmp32.us.lver.orig = icmp slt i64 %indvars.iv.next51.lver.orig, 999
  br i1 %cmp32.us.lver.orig, label %for.inc.us.lver.orig, label %for.cond30.for.end_crit_edge.us.loopexit
...
for.inc118.us:                                    ; preds = %for.inc118.us, %for.cond30.for.end_crit_edge.us
  %11 = phi double [ 1.000000e+00, %for.cond30.for.end_crit_edge.us ], [ %add113.us.1, %for.inc118.us ]
  %indvars.iv54 = phi i64 [ 998, %for.cond30.for.end_crit_edge.us ], [ %indvars.iv.next55.1, %for.inc118.us ]
  ...
  br i1 %cmp96.us.1, label %for.inc118.us, label %for.inc118.us.for.inc120.us_crit_edge

for.inc118.us.for.inc120.us_crit_edge:            ; preds = %for.inc118.us
  %cmp17.us = icmp slt i64 %indvars.iv.next58, 999
  br i1 %cmp17.us, label %for.inc.us.lver.check, label %for.inc199.us.lver.check.preheader

for.inc199.us.lver.check.preheader:               ; preds = %for.inc118.us.for.inc120.us_crit_edge
...
for.inc.us:                                       ; preds = %for.inc.us, %for.inc.us.ph
  ...
  %indvars.iv50 = phi i64 [ 1, %for.inc.us.ph ], [ %indvars.iv.next51, %for.inc.us ]
  ...
  %arrayidx47.us = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv57, i64 %indvars.iv50
  store double %div43.us, double* %arrayidx47.us, align 8
  %arrayidx53.us = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv50, i64 %4
  ...
  %arrayidx67.us = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv50, i64 %indvars.iv.next58
  ...
  %arrayidx88.us = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv57, i64 %indvars.iv50
  store double %div84.us, double* %arrayidx88.us, align 8
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1
  %cmp32.us = icmp slt i64 %indvars.iv.next51, 999
  br i1 %cmp32.us, label %for.inc.us, label %for.cond30.for.end_crit_edge.us.loopexit35

for.cond30.for.end_crit_edge.us.loopexit:         ; preds = %for.inc.us.lver.orig
  br label %for.cond30.for.end_crit_edge.us

for.cond30.for.end_crit_edge.us.loopexit35:       ; preds = %for.inc.us
  br label %for.cond30.for.end_crit_edge.us

for.cond30.for.end_crit_edge.us:                  ; preds = %for.cond30.for.end_crit_edge.us.loopexit35, %for.cond30.for.end_crit_edge.us.loopexit
...
for.inc199.us.lver.check:                         ; preds = %for.inc199.us.lver.check.preheader, %for.inc231.us.for.inc234.us_crit_edge
  %indvar12 = phi i64 [ %19, %for.inc231.us.for.inc234.us_crit_edge ], [ 0, %for.inc199.us.lver.check.preheader ]
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.inc231.us.for.inc234.us_crit_edge ], [ 1, %for.inc199.us.lver.check.preheader ]
  %19 = add i64 %indvar12, 1
  %scevgep14 = getelementptr [1000 x double], [1000 x double]* %p, i64 %19, i64 0
  %scevgep16 = getelementptr [1000 x double], [1000 x double]* %p, i64 %19, i64 999
  %scevgep18 = getelementptr [1000 x double], [1000 x double]* %q, i64 %19, i64 0
  %scevgep20 = getelementptr [1000 x double], [1000 x double]* %q, i64 %19, i64 999
  %arrayidx130.us = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv72, i64 0
  store double 1.000000e+00, double* %arrayidx130.us, align 8
  %arrayidx133.us = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv72, i64 0
  store double 0.000000e+00, double* %arrayidx133.us, align 8
  %20 = bitcast double* %arrayidx130.us to i64*
  %21 = load i64, i64* %20, align 8
  %arrayidx138.us = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv72
  %22 = bitcast [1000 x double]* %arrayidx138.us to i64*
  store i64 %21, i64* %22, align 8
  %23 = add nsw i64 %indvars.iv72, -1
...
for.inc199.us.lver.orig:                          ; preds = %for.inc199.us.lver.orig.preheader, %for.inc199.us.lver.orig
  %indvars.iv65.lver.orig = phi i64 [ %indvars.iv.next66.lver.orig, %for.inc199.us.lver.orig ], [ 1, %for.inc199.us.lver.orig.preheader ]
  %24 = add nsw i64 %indvars.iv65.lver.orig, -1
  %arrayidx150.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv72, i64 %24
  ...
  %arrayidx157.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv72, i64 %indvars.iv65.lver.orig
  store double %div153.us.lver.orig, double* %arrayidx157.us.lver.orig, align 8
  %arrayidx163.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %23, i64 %indvars.iv65.lver.orig
  %26 = load double, double* %arrayidx163.us.lver.orig, align 8
  %27 = fmul double %26, 0xC09F400000000001
  %arrayidx170.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %indvars.iv72, i64 %indvars.iv65.lver.orig
  ...
  %arrayidx177.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %indvars.iv.next73, i64 %indvars.iv65.lver.orig
  ...
  %arrayidx184.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv72, i64 %24
  ...
  %arrayidx198.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv72, i64 %indvars.iv65.lver.orig
  store double %div194.us.lver.orig, double* %arrayidx198.us.lver.orig, align 8
  %indvars.iv.next66.lver.orig = add nuw nsw i64 %indvars.iv65.lver.orig, 1
  %cmp142.us.lver.orig = icmp slt i64 %indvars.iv.next66.lver.orig, 999
  br i1 %cmp142.us.lver.orig, label %for.inc199.us.lver.orig, label %for.cond140.for.end201_crit_edge.us.loopexit
...
for.inc231.us:                                    ; preds = %for.inc231.us, %for.cond140.for.end201_crit_edge.us
  %31 = phi double [ 1.000000e+00, %for.cond140.for.end201_crit_edge.us ], [ %add226.us.1, %for.inc231.us ]
  %indvars.iv69 = phi i64 [ 998, %for.cond140.for.end201_crit_edge.us ], [ %indvars.iv.next70.1, %for.inc231.us ]
  %arrayidx215.us = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv72, i64 %indvars.iv69
  %32 = load double, double* %arrayidx215.us, align 8
  %mul221.us = fmul double %32, %31
  %arrayidx225.us = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv72, i64 %indvars.iv69
  %33 = load double, double* %arrayidx225.us, align 8
  %add226.us = fadd double %mul221.us, %33
  %arrayidx230.us = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv72, i64 %indvars.iv69
  store double %add226.us, double* %arrayidx230.us, align 8
  %indvars.iv.next70 = add nsw i64 %indvars.iv69, -1
  %arrayidx215.us.1 = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv72, i64 %indvars.iv.next70
  %34 = load double, double* %arrayidx215.us.1, align 8
  %mul221.us.1 = fmul double %34, %add226.us
  %arrayidx225.us.1 = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv72, i64 %indvars.iv.next70
  %35 = load double, double* %arrayidx225.us.1, align 8
  %add226.us.1 = fadd double %mul221.us.1, %35
  %arrayidx230.us.1 = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv72, i64 %indvars.iv.next70
  store double %add226.us.1, double* %arrayidx230.us.1, align 8
  %cmp209.us.1 = icmp sgt i64 %indvars.iv.next70, 1
  %indvars.iv.next70.1 = add nsw i64 %indvars.iv69, -2
  br i1 %cmp209.us.1, label %for.inc231.us, label %for.inc231.us.for.inc234.us_crit_edge

for.inc231.us.for.inc234.us_crit_edge:            ; preds = %for.inc231.us
  %exitcond = icmp eq i64 %indvars.iv.next73, 999
  br i1 %exitcond, label %for.inc237, label %for.inc199.us.lver.check
...
for.inc199.us:                                    ; preds = %for.inc199.us, %for.inc199.us.ph
  ...
  %indvars.iv65 = phi i64 [ 1, %for.inc199.us.ph ], [ %indvars.iv.next66, %for.inc199.us ]
  ...
  %arrayidx157.us = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv72, i64 %indvars.iv65
  store double %div153.us, double* %arrayidx157.us, align 8
  %arrayidx163.us = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %23, i64 %indvars.iv65
  %36 = load double, double* %arrayidx163.us, align 8
  %37 = fmul double %36, 0xC09F400000000001
  %arrayidx170.us = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %indvars.iv72, i64 %indvars.iv65
  ...
  %arrayidx177.us = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %indvars.iv.next73, i64 %indvars.iv65
  ...
  %arrayidx198.us = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv72, i64 %indvars.iv65
  store double %div194.us, double* %arrayidx198.us, align 8
  %indvars.iv.next66 = add nuw nsw i64 %indvars.iv65, 1
  %cmp142.us = icmp slt i64 %indvars.iv.next66, 999
  br i1 %cmp142.us, label %for.inc199.us, label %for.cond140.for.end201_crit_edge.us.loopexit34

for.cond140.for.end201_crit_edge.us.loopexit:     ; preds = %for.inc199.us.lver.orig
  br label %for.cond140.for.end201_crit_edge.us

for.cond140.for.end201_crit_edge.us.loopexit34:   ; preds = %for.inc199.us
  br label %for.cond140.for.end201_crit_edge.us

for.cond140.for.end201_crit_edge.us:              ; preds = %for.cond140.for.end201_crit_edge.us.loopexit34, %for.cond140.for.end201_crit_edge.us.loopexit
  %arrayidx206.us = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv72, i64 999
  store double 1.000000e+00, double* %arrayidx206.us, align 8
  br label %for.inc231.us

for.inc237:                                       ; preds = %for.inc231.us.for.inc234.us_crit_edge
  %inc238 = add nsw i32 %inc23844, 1
  %cmp = icmp slt i32 %inc23844, 500
...
; Function Attrs: noinline nounwind uwtable
define internal void @print_array([1000 x double]* %u) #0 {
entry:
