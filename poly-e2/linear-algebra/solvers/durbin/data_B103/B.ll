...
for.body:                                         ; preds = %for.inc47, %entry
  ...
  %alpha.030 = phi double [ %div, %for.inc47 ], [ %sub3, %entry ]
  %beta.029 = phi double [ %mul5, %for.inc47 ], [ 1.000000e+00, %entry ]
  %indvars.iv1928 = phi i64 [ %indvars.iv.next20, %for.inc47 ], [ 1, %entry ]
  %4 = add i64 %indvar, 1
  %5 = shl i64 %indvar, 3
  %6 = add nsw i64 %indvars.iv1928, -1
...
for.inc.prol:                                     ; preds = %for.inc.prol, %for.inc.prol.preheader
  %sum.025.prol = phi double [ 0.000000e+00, %for.inc.prol.preheader ], [ %add.prol, %for.inc.prol ]
  %indvars.iv24.prol = phi i64 [ 0, %for.inc.prol.preheader ], [ %indvars.iv.next.prol, %for.inc.prol ]
  %prol.iter = phi i64 [ %xtraiter, %for.inc.prol.preheader ], [ %prol.iter.sub, %for.inc.prol ]
  %7 = sub nsw i64 %6, %indvars.iv24.prol
  %arrayidx11.prol = getelementptr inbounds double, double* %r, i64 %7
  %8 = load double, double* %arrayidx11.prol, align 8
  %arrayidx13.prol = getelementptr inbounds double, double* %y, i64 %indvars.iv24.prol
  %9 = load double, double* %arrayidx13.prol, align 8
  %mul14.prol = fmul double %8, %9
  %add.prol = fadd double %sum.025.prol, %mul14.prol
  %indvars.iv.next.prol = add nuw nsw i64 %indvars.iv24.prol, 1
...
for.inc.prol.loopexit:                            ; preds = %for.body, %for.inc.prol.loopexit.unr-lcssa
  ...
  %sum.025.unr = phi double [ 0.000000e+00, %for.body ], [ %add.prol, %for.inc.prol.loopexit.unr-lcssa ]
  %indvars.iv24.unr = phi i64 [ 0, %for.body ], [ %indvars.iv.next.prol, %for.inc.prol.loopexit.unr-lcssa ]
...
for.inc:                                          ; preds = %for.inc, %for.body.new
  %sum.025 = phi double [ %sum.025.unr, %for.body.new ], [ %add.3, %for.inc ]
  %indvars.iv24 = phi i64 [ %indvars.iv24.unr, %for.body.new ], [ %indvars.iv.next.3, %for.inc ]
  %11 = sub nsw i64 %6, %indvars.iv24
  %arrayidx11 = getelementptr inbounds double, double* %r, i64 %11
  %12 = load double, double* %arrayidx11, align 8
  %arrayidx13 = getelementptr inbounds double, double* %y, i64 %indvars.iv24
  %13 = load double, double* %arrayidx13, align 8
  %mul14 = fmul double %12, %13
  %add = fadd double %sum.025, %mul14
  ...
  %exitcond.3 = icmp eq i64 %indvars.iv1928, %indvars.iv.next.3
...
for.end:                                          ; preds = %for.inc.prol.loopexit, %for.end.unr-lcssa
  ...
  %24 = add nuw nsw i64 %5, 8
  %mul = fmul double %alpha.030, %alpha.030
  %sub4 = fsub double 1.000000e+00, %mul
  %mul5 = fmul double %beta.029, %sub4
  %arrayidx16 = getelementptr inbounds double, double* %r, i64 %indvars.iv1928
...
for.inc32.preheader:                              ; preds = %middle.block, %min.iters.checked, %for.end
  %indvars.iv526.ph = phi i64 [ 0, %min.iters.checked ], [ 0, %for.end ], [ %n.vec, %middle.block ]
  br label %for.inc32

for.inc32:                                        ; preds = %for.inc32.preheader, %for.inc32
  %indvars.iv526 = phi i64 [ %indvars.iv.next6, %for.inc32 ], [ %indvars.iv526.ph, %for.inc32.preheader ]
  %arrayidx23 = getelementptr inbounds double, double* %y, i64 %indvars.iv526
  %46 = load double, double* %arrayidx23, align 8
  %47 = sub nsw i64 %6, %indvars.iv526
  ...
  %arrayidx31 = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %indvars.iv526
  store double %add29, double* %arrayidx31, align 8
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv526, 1
  %exitcond12 = icmp eq i64 %indvars.iv1928, %indvars.iv.next6
  br i1 %exitcond12, label %for.inc47.loopexit, label %for.inc32, !llvm.loop !6

for.inc47.loopexit:                               ; preds = %for.inc32
  br label %for.inc47

for.inc47:                                        ; preds = %for.inc47.loopexit, %middle.block
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* nonnull %3, i64 %24, i32 8, i1 false)
  %arrayidx46 = getelementptr inbounds double, double* %y, i64 %indvars.iv1928
