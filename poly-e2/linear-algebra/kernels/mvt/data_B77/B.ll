...
entry:
  ...
  %4 = bitcast i8* %call to [2000 x double]*
  call fastcc void @init_array(double* %0, double* %1, double* %2, double* %3, [2000 x double]* %4)
  call void (...) @polybench_timer_start() #4
  call fastcc void @kernel_mvt(double* %0, double* %1, double* %2, double* %3, [2000 x double]* %4)
...
if.then:                                          ; preds = %land.lhs.true
  ...
  call fastcc void @print_array(double* %7, double* %6)
  br label %if.end
...
entry:
  %sunkaddr36 = ptrtoint double* %x1 to i64
  br label %for.body
...
for.body:                                         ; preds = %for.inc12, %entry
  ...
  %sunkaddr37 = shl i64 %indvars.iv28, 3
  %sunkaddr38 = add i64 %sunkaddr36, %sunkaddr37
  %sunkaddr39 = inttoptr i64 %sunkaddr38 to double*
  br label %for.inc

for.inc:                                          ; preds = %for.inc, %for.body
  %indvars.iv21 = phi i64 [ 0, %for.body ], [ %indvars.iv.next22.1, %for.inc ]
  %0 = phi double [ %.pre, %for.body ], [ %add.1, %for.inc ]
  %arrayidx7 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv28, i64 %indvars.iv21
  %1 = load double, double* %arrayidx7, align 8
  %arrayidx9 = getelementptr inbounds double, double* %y_1, i64 %indvars.iv21
  %2 = load double, double* %arrayidx9, align 8
  %mul = fmul double %1, %2
  %add = fadd double %0, %mul
  store double %add, double* %sunkaddr39, align 8
  %indvars.iv.next22 = or i64 %indvars.iv21, 1
  %arrayidx7.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv28, i64 %indvars.iv.next22
  %3 = load double, double* %arrayidx7.1, align 8
  %arrayidx9.1 = getelementptr inbounds double, double* %y_1, i64 %indvars.iv.next22
  %4 = load double, double* %arrayidx9.1, align 8
  %mul.1 = fmul double %3, %4
  %add.1 = fadd double %add, %mul.1
  store double %add.1, double* %sunkaddr39, align 8
  %indvars.iv.next22.1 = add nuw nsw i64 %indvars.iv21, 2
  %exitcond24.1 = icmp eq i64 %indvars.iv.next22.1, 2000
  br i1 %exitcond24.1, label %for.inc12, label %for.inc
...
for.inc33:                                        ; preds = %for.inc33, %for.body17
  ...
  %5 = phi double [ %.pre17, %for.body17 ], [ %add30.1, %for.inc33 ]
  ...
  store double %add30, double* %sunkaddr47, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %add30.1, double* %sunkaddr47, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
...
for.inc36:                                        ; preds = %for.inc33
  ...
  %exitcond32 = icmp eq i64 %indvars.iv.next19, 2000
  br i1 %exitcond32, label %for.end38, label %for.body17
...
if.then:                                          ; preds = %for.body
  ...
  %fputc4 = call i32 @fputc(i32 10, %struct._IO_FILE* %4) #5
  br label %if.end
