...
for.body.us:                                      ; preds = %for.cond1.for.inc30_crit_edge.us, %for.body.us.preheader
  %indvars.iv = phi i64 [ %2, %for.cond1.for.inc30_crit_edge.us ], [ 1, %for.body.us.preheader ]
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.cond1.for.inc30_crit_edge.us ], [ 0, %for.body.us.preheader ]
...
for.end.us:                                       ; preds = %for.end.us.loopexit, %for.body6.us.prol.loopexit.unr-lcssa, %for.body3.us
  %6 = phi double [ %.pre, %for.body3.us ], [ %add17.us.lcssa.unr.ph, %for.body6.us.prol.loopexit.unr-lcssa ], [ %add17.us.1, %for.end.us.loopexit ]
