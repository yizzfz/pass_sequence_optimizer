...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %19 = shl i64 %index, 3
  %offset.idx = add i64 %indvars.iv48.unr, %19
  %20 = add nsw i64 %offset.idx, 7
...
for.cond4.preheader.lr.ph:                        ; preds = %for.cond1.preheader.lr.ph, %for.inc53
  %indvars.iv54 = phi i64 [ 0, %for.cond1.preheader.lr.ph ], [ %0, %for.inc53 ]
...
vector.memcheck:                                  ; preds = %for.cond4.preheader.lr.ph
  ...
  %scevgep65 = getelementptr [1200 x double], [1200 x double]* %B, i64 %indvars.iv54, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %20 = fadd <2 x double> %broadcast.splat82, %18
  %21 = fadd <2 x double> %broadcast.splat82, %19
  ...
  br i1 %22, label %for.inc53.loopexit86, label %vector.body, !llvm.loop !16
...
for.cond4.preheader:                              ; preds = %for.cond4.preheader, %for.cond4.preheader.preheader
  ...
  br i1 %exitcond.1, label %for.inc53.loopexit85, label %for.cond4.preheader, !llvm.loop !17
