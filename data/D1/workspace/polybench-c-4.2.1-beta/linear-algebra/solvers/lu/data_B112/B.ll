...
; <label>:3:                                      ; preds = %3, %.lr.ph95
  %indvars.iv124 = phi i64 [ 0, %.lr.ph95 ], [ %indvars.iv.next125, %3 ]
  %4 = sub nsw i64 0, %indvars.iv124
  %5 = trunc i64 %4 to i32
  %6 = srem i32 %5, 2000
  %7 = sitofp i32 %6 to double
  %8 = fdiv double %7, 2.000000e+03
  %9 = fadd double %8, 1.000000e+00
  %10 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv136, i64 %indvars.iv124
  store double %9, double* %10, align 8
  %indvars.iv.next125 = add nuw nsw i64 %indvars.iv124, 1
  %exitcond128 = icmp eq i64 %indvars.iv124, %indvars.iv136
  br i1 %exitcond128, label %._crit_edge96, label %3

._crit_edge96:                                    ; preds = %3
  %indvars.iv.next137 = add nuw nsw i64 %indvars.iv136, 1
  %11 = icmp slt i64 %indvars.iv.next137, 2000
  br i1 %11, label %._crit_edge100.thread, label %.lr.ph91.split.us.preheader
...
._crit_edge88.us:                                 ; preds = %._crit_edge88.us, %.lr.ph91.split.us.preheader
  ...
  %exitcond4.7 = icmp eq i64 %indvars.iv.next123.7, 2000
  br i1 %exitcond4.7, label %.lr.ph73.us.us.preheader.preheader, label %._crit_edge88.us
...
.lr.ph73.us.us.preheader:                         ; preds = %.lr.ph73.us.us.preheader.preheader, %._crit_edge77.us
  %indvars.iv117 = phi i64 [ %indvars.iv.next118, %._crit_edge77.us ], [ 0, %.lr.ph73.us.us.preheader.preheader ]
  %scevgep7 = getelementptr [2000 x double], [2000 x double]* %0, i64 0, i64 %indvars.iv117
...
._crit_edge77.us:                                 ; preds = %._crit_edge74.us.us
  ...
  %exitcond3 = icmp eq i64 %indvars.iv.next118, 2000
  br i1 %exitcond3, label %.lr.ph69.split.us.preheader, label %.lr.ph73.us.us.preheader
...
._crit_edge74.us.us:                              ; preds = %._crit_edge74.us.us.loopexit47, %._crit_edge74.us.us.loopexit
  ...
  %exitcond2 = icmp eq i64 %indvars.iv.next116, 2000
  br i1 %exitcond2, label %._crit_edge77.us, label %.lr.ph73.us.us
...
.lr.ph69.split.us:                                ; preds = %.lr.ph69.split.us.preheader, %._crit_edge.us
  ...
  %scevgep22 = getelementptr [2000 x double], [2000 x double]* %0, i64 %indvars.iv110, i64 0
...
vector.body17.preheader:                          ; preds = %.lr.ph69.split.us
  br label %vector.body17

scalar.ph19.preheader:                            ; preds = %.lr.ph69.split.us
...
vector.body17:                                    ; preds = %vector.body17, %vector.body17.preheader
  ...
  %89 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv110, i64 %index34
  ...
  %93 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv110, i64 %index34
  ...
  %97 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %37, i64 0, i64 %indvars.iv110, i64 %index.next35
  ...
  %101 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv110, i64 %index.next35
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit46, %._crit_edge.us.loopexit
  ...
  %exitcond1 = icmp eq i64 %indvars.iv.next111, 2000
  br i1 %exitcond1, label %._crit_edge70, label %.lr.ph69.split.us
...
.lr.ph58:                                         ; preds = %._crit_edge53, %.lr.ph58.preheader
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %._crit_edge53 ], [ 0, %.lr.ph58.preheader ]
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.lr.ph44
  ...
  br i1 %exitcond4, label %.lr.ph52.split.us.preheader, label %.lr.ph44

.lr.ph52.split.us.preheader:                      ; preds = %._crit_edge
  %wide.trip.count75 = zext i32 %indvars.iv73 to i64
  %35 = and i64 %1, 1
  %lcmp.mod9 = icmp eq i64 %35, 0
  %36 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv2, i64 0
  %37 = icmp eq i64 %2, 0
  br label %.lr.ph52.split.us

.lr.ph52.split.us:                                ; preds = %._crit_edge49.us, %.lr.ph52.split.us.preheader
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %._crit_edge49.us ], [ %indvars.iv2, %.lr.ph52.split.us.preheader ]
  %38 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv2, i64 %indvars.iv79
...
; <label>:45:                                     ; preds = %45, %.lr.ph52.split.us.new
  ...
  %47 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv2, i64 %indvars.iv71
  ...
  %53 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv2, i64 %indvars.iv.next72
...
._crit_edge49.us:                                 ; preds = %.prol.loopexit7, %._crit_edge49.us.unr-lcssa
  ...
  %exitcond1 = icmp eq i64 %indvars.iv.next80, 2000
  br i1 %exitcond1, label %._crit_edge53.loopexit, label %.lr.ph52.split.us
