...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph30.split.us
  ...
  %5 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv57, i64 %indvars.iv60
  %6 = load double, double* %5, align 8
  %7 = load double, double* %sunkaddr3, align 8
  %8 = fadd double %6, %7
...
._crit_edge75:                                    ; preds = %._crit_edge75, %.lr.ph.us.us
  %60 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %72, %._crit_edge75 ]
