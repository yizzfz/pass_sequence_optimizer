...
; <label>:6:                                      ; preds = %._crit_edge, %.lr.ph12
  ...
  %7 = add i64 %indvars.iv18, 4294967295
  %8 = getelementptr inbounds double, double* %3, i64 %indvars.iv18
  %9 = bitcast double* %8 to i64*
  %10 = load i64, i64* %9, align 8
  %11 = getelementptr inbounds double, double* %2, i64 %indvars.iv18
...
.prol.preheader:                                  ; preds = %.lr.ph
  ...
  %18 = load double, double* %sunkaddr4, align 8
  %19 = fsub double %18, %17
  store double %19, double* %sunkaddr4, align 8
  br label %.prol.loopexit
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.lr.ph.new ], [ %indvars.iv.unr.ph, %.lr.ph.new.preheader ]
  %22 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv18, i64 %indvars.iv
  %23 = load double, double* %22, align 8
  %24 = getelementptr inbounds double, double* %2, i64 %indvars.iv
  %25 = load double, double* %24, align 8
  %26 = fmul double %23, %25
  %27 = load double, double* %sunkaddr4, align 8
  ...
  %34 = load double, double* %sunkaddr4, align 8
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %6
  ...
  %36 = load double, double* %sunkaddr8, align 8
  %37 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv18, i64 %indvars.iv18
  %38 = load double, double* %37, align 8
  %39 = fdiv double %36, %38
  store double %39, double* %sunkaddr8, align 8
  %indvars.iv.next19 = add nuw nsw i64 %indvars.iv18, 1
  %exitcond = icmp eq i64 %indvars.iv.next19, %wide.trip.count20
  br i1 %exitcond, label %._crit_edge13.loopexit, label %6
