...
.lr.ph29:                                         ; preds = %._crit_edge33..lr.ph29_crit_edge, %.preheader14.lr.ph
  %indvars.iv89 = phi i64 [ 0, %.preheader14.lr.ph ], [ %indvars.iv.next90, %._crit_edge33..lr.ph29_crit_edge ]
  %indvars.iv87 = phi i64 [ 1, %.preheader14.lr.ph ], [ %indvars.iv.next88, %._crit_edge33..lr.ph29_crit_edge ]
...
.preheader13:                                     ; preds = %._crit_edge
  ...
  br i1 %10, label %._crit_edge33.loopexit, label %._crit_edge33

._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph29
  %indvars.iv71 = phi i64 [ 0, %.lr.ph29 ], [ %indvars.iv.next72, %._crit_edge ]
...
._crit_edge33:                                    ; preds = %.preheader13, %._crit_edge33.loopexit
  ...
  br i1 %exitcond92, label %._crit_edge35, label %._crit_edge33..lr.ph29_crit_edge

._crit_edge33..lr.ph29_crit_edge:                 ; preds = %._crit_edge33
...
._crit_edge26.us.prol:                            ; preds = %._crit_edge26.us.prol, %._crit_edge26.us.prol.preheader
  %indvars.iv67.prol = phi i64 [ 0, %._crit_edge26.us.prol.preheader ], [ %indvars.iv.next68.prol, %._crit_edge26.us.prol ]
  %prol.iter100 = phi i64 [ 0, %._crit_edge26.us.prol.preheader ], [ %prol.iter100.sub, %._crit_edge26.us.prol ]
  ...
  %prol.iter100.sub = add nsw i64 %prol.iter100, -1
  %prol.iter100.cmp = icmp eq i64 %prol.iter100.sub, 0
  br i1 %prol.iter100.cmp, label %._crit_edge26.us.prol.loopexit.unr-lcssa, label %._crit_edge26.us.prol, !llvm.loop !1
...
._crit_edge26.us.prol.loopexit:                   ; preds = %._crit_edge35, %._crit_edge26.us.prol.loopexit.unr-lcssa
  br i1 false, label %.preheader9.us.us.preheader.preheader, label %._crit_edge35.new
...
._crit_edge26.us:                                 ; preds = %._crit_edge26.us, %._crit_edge35.new
  %indvars.iv67 = phi i64 [ 0, %._crit_edge35.new ], [ %indvars.iv.next68.7, %._crit_edge26.us ]
  ...
  br i1 %exitcond70.7, label %.preheader9.us.us.preheader.preheader.unr-lcssa, label %._crit_edge26.us

.preheader9.us.us.preheader.preheader.unr-lcssa:  ; preds = %._crit_edge26.us
  br label %.preheader9.us.us.preheader.preheader

.preheader9.us.us.preheader.preheader:            ; preds = %._crit_edge26.us.prol.loopexit, %.preheader9.us.us.preheader.preheader.unr-lcssa
...
._crit_edge94.prol:                               ; preds = %._crit_edge94.prol, %._crit_edge94.prol.preheader
  ...
  %62 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %.lcssa, i64 0, i64 %indvars.iv47, i64 %indvars.iv.prol
  %63 = bitcast double* %62 to i64*
  %64 = load i64, i64* %63, align 8
  %65 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 %indvars.iv.prol
...
._crit_edge94:                                    ; preds = %._crit_edge94, %.preheader.us.new
  ...
  %67 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %.lcssa, i64 0, i64 %indvars.iv47, i64 %indvars.iv
  %68 = bitcast double* %67 to i64*
  %69 = load i64, i64* %68, align 8
  %70 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 %indvars.iv
  %71 = bitcast double* %70 to i64*
  store i64 %69, i64* %71, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %72 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %.lcssa, i64 0, i64 %indvars.iv47, i64 %indvars.iv.next
  %73 = bitcast double* %72 to i64*
  %74 = load i64, i64* %73, align 8
  %75 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 %indvars.iv.next
  %76 = bitcast double* %75 to i64*
  store i64 %74, i64* %76, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %77 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %.lcssa, i64 0, i64 %indvars.iv47, i64 %indvars.iv.next.1
  %78 = bitcast double* %77 to i64*
  %79 = load i64, i64* %78, align 8
  %80 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 %indvars.iv.next.1
  %81 = bitcast double* %80 to i64*
  store i64 %79, i64* %81, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %82 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %.lcssa, i64 0, i64 %indvars.iv47, i64 %indvars.iv.next.2
  %83 = bitcast double* %82 to i64*
  %84 = load i64, i64* %83, align 8
  %85 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 %indvars.iv.next.2
...
._crit_edge17:                                    ; preds = %._crit_edge17.loopexit, %._crit_edge35.thread
  %87 = phi i8* [ %3, %._crit_edge35.thread ], [ %20, %._crit_edge17.loopexit ]
  tail call void @free(i8* %87) #3
  ret void
}
