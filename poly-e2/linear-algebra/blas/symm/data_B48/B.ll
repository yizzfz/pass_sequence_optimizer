...
entry:
  ...
  call void @init_array(i32 1000, i32 1200, double* nonnull %alpha, double* nonnull %beta, [1200 x double]* %arraydecay1, [1000 x double]* %arraydecay32, [1200 x double]* %arraydecay43)
  call void (...) @polybench_timer_start() #3
  %0 = load double, double* %alpha, align 8
  %1 = load double, double* %beta, align 8
  call void @kernel_symm(i32 1000, i32 1200, double %0, double %1, [1200 x double]* %arraydecay1, [1000 x double]* %arraydecay32, [1200 x double]* %arraydecay43)
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc16_crit_edge.us, %entry
  ...
  %0 = add nuw nsw i64 %indvars.iv64, 1200
...
for.inc.us:                                       ; preds = %for.inc.us, %for.cond1.preheader.us
  ...
  br i1 %exitcond63, label %for.cond1.for.inc16_crit_edge.us, label %for.inc.us

for.cond1.for.inc16_crit_edge.us:                 ; preds = %for.inc.us
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1
  %exitcond68 = icmp eq i64 %indvars.iv.next65, 1000
  br i1 %exitcond68, label %for.inc36.lr.ph.preheader, label %for.cond1.preheader.us

for.inc36.lr.ph.preheader:                        ; preds = %for.cond1.for.inc16_crit_edge.us
  br label %for.inc36.lr.ph

for.inc36.lr.ph:                                  ; preds = %for.inc36.lr.ph.preheader, %for.inc51.for.cond23.preheader_crit_edge
  %indvars.iv74 = phi i3 [ %indvars.iv.next75, %for.inc51.for.cond23.preheader_crit_edge ], [ -1, %for.inc36.lr.ph.preheader ]
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.inc51.for.cond23.preheader_crit_edge ], [ 2, %for.inc36.lr.ph.preheader ]
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc51.for.cond23.preheader_crit_edge ], [ 0, %for.inc36.lr.ph.preheader ]
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.inc51.for.cond23.preheader_crit_edge ], [ 1, %for.inc36.lr.ph.preheader ]
...
for.cond40.preheader:                             ; preds = %for.cond40.preheader.loopexit, %for.inc36.prol.loopexit.unr-lcssa
  ...
  br i1 %cmp4133, label %for.inc48.lr.ph, label %for.inc51
...
for.inc48.preheader:                              ; preds = %for.inc48.prol.loopexit
  ...
  br i1 %min.iters.check, label %for.inc48.preheader76, label %min.iters.checked

for.inc48.preheader76:                            ; preds = %middle.block, %min.iters.checked, %for.inc48.preheader
...
min.iters.checked:                                ; preds = %for.inc48.preheader
  ...
  br i1 %cmp.zero, label %for.inc48.preheader76, label %vector.body.preheader
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.inc51, label %for.inc48.preheader76
...
for.inc48:                                        ; preds = %for.inc48.preheader76, %for.inc48
  %indvars.iv48 = phi i64 [ %indvars.iv.next49.7, %for.inc48 ], [ %indvars.iv48.ph, %for.inc48.preheader76 ]
