...
@__llvm_prf_nm = private constant [84 x i8] c"R\00mdct_sub48\01mdct_init48\01tmp1.ll:window_subband\01tmp1.ll:mdct_short\01tmp1.ll:mdct_long", section "__llvm_prf_names"
@llvm.used = appending global [6 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_mdct_sub48 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_mdct_init48 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_window_subband to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_mdct_short to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_mdct_long to i8*), i8* getelementptr inbounds ([84 x i8], [84 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
