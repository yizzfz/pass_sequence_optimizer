...
entry:
  ...
  tail call fastcc void @kernel_deriche(float %0, [2160 x float]* %arraydecay, [2160 x float]* %arraydecay6, [2160 x float]* %arraydecay7, [2160 x float]* %arraydecay8)
...
vector.ph:                                        ; preds = %for.inc7.loopexit.us.vector.ph_crit_edge, %for.cond1.preheader.us.preheader
  %indvars.iv9 = phi i64 [ 0, %for.cond1.preheader.us.preheader ], [ %indvars.iv.next10, %for.inc7.loopexit.us.vector.ph_crit_edge ]
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.ph
  ...
  br i1 %9, label %for.inc7.loopexit.us, label %vector.body.vector.body_crit_edge, !llvm.loop !1

vector.body.vector.body_crit_edge:                ; preds = %vector.body
  br label %vector.body

for.inc7.loopexit.us:                             ; preds = %vector.body
  %indvars.iv.next10 = add nuw i64 %indvars.iv9, 1
  %cmp.us = icmp slt i64 %indvars.iv.next10, 4096
  br i1 %cmp.us, label %for.inc7.loopexit.us.vector.ph_crit_edge, label %for.end9

for.inc7.loopexit.us.vector.ph_crit_edge:         ; preds = %for.inc7.loopexit.us
  br label %vector.ph

for.end9:                                         ; preds = %for.inc7.loopexit.us
  ret void
}
...
for.cond31.preheader.us:                          ; preds = %for.inc55.loopexit.us.for.cond31.preheader.us_crit_edge, %for.cond31.preheader.us.preheader
  %indvars.iv78 = phi i64 [ 0, %for.cond31.preheader.us.preheader ], [ %indvars.iv.next79, %for.inc55.loopexit.us.for.cond31.preheader.us_crit_edge ]
...
for.inc.us.for.inc.us_crit_edge:                  ; preds = %for.inc.us.for.inc.us_crit_edge.1, %for.cond31.preheader.us
  ...
  br i1 %exitcond77, label %for.inc55.loopexit.us, label %for.inc.us.for.inc.us_crit_edge.1

for.inc55.loopexit.us:                            ; preds = %for.inc.us.for.inc.us_crit_edge
  %indvars.iv.next79 = add nuw i64 %indvars.iv78, 1
  %cmp.us = icmp slt i64 %indvars.iv.next79, 4096
  br i1 %cmp.us, label %for.inc55.loopexit.us.for.cond31.preheader.us_crit_edge, label %for.cond62.preheader.us.preheader

for.inc55.loopexit.us.for.cond31.preheader.us_crit_edge: ; preds = %for.inc55.loopexit.us
  br label %for.cond31.preheader.us
...
for.cond62.preheader.us:                          ; preds = %for.inc86.loopexit.us.for.cond62.preheader.us_crit_edge, %for.cond62.preheader.us.preheader
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.inc86.loopexit.us.for.cond62.preheader.us_crit_edge ], [ 0, %for.cond62.preheader.us.preheader ]
...
for.inc84.us.for.inc84.us_crit_edge:              ; preds = %for.inc84.us.for.inc84.us_crit_edge.1, %for.cond62.preheader.us
  ...
  br i1 %cmp63.us, label %for.inc84.us.for.inc84.us_crit_edge.1, label %for.inc86.loopexit.us

for.inc86.loopexit.us:                            ; preds = %for.inc84.us.for.inc84.us_crit_edge
  %indvars.iv.next72 = add nuw i64 %indvars.iv71, 1
  %cmp59.us = icmp slt i64 %indvars.iv.next72, 4096
  br i1 %cmp59.us, label %for.inc86.loopexit.us.for.cond62.preheader.us_crit_edge, label %vector.memcheck.preheader

for.inc86.loopexit.us.for.cond62.preheader.us_crit_edge: ; preds = %for.inc86.loopexit.us
  br label %for.cond62.preheader.us

vector.memcheck.preheader:                        ; preds = %for.inc86.loopexit.us
  br label %vector.memcheck

vector.memcheck:                                  ; preds = %for.inc112.loopexit.us.vector.memcheck_crit_edge, %vector.memcheck.preheader
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc112.loopexit.us.vector.memcheck_crit_edge ], [ 0, %vector.memcheck.preheader ]
...
for.inc109.us.preheader:                          ; preds = %vector.memcheck
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.body.preheader
  ...
  br i1 %35, label %for.inc112.loopexit.us.loopexit111, label %vector.body.vector.body_crit_edge, !llvm.loop !12

vector.body.vector.body_crit_edge:                ; preds = %vector.body
  br label %vector.body

for.inc109.us:                                    ; preds = %for.inc109.us.for.inc109.us_crit_edge, %for.inc109.us.preheader
  %indvars.iv62 = phi i64 [ 0, %for.inc109.us.preheader ], [ %indvars.iv.next63.2, %for.inc109.us.for.inc109.us_crit_edge ]
  ...
  br i1 %exitcond65.2, label %for.inc112.loopexit.us.loopexit, label %for.inc109.us.for.inc109.us_crit_edge, !llvm.loop !13

for.inc109.us.for.inc109.us_crit_edge:            ; preds = %for.inc109.us
  br label %for.inc109.us

for.inc112.loopexit.us.loopexit:                  ; preds = %for.inc109.us
  br label %for.inc112.loopexit.us

for.inc112.loopexit.us.loopexit111:               ; preds = %vector.body
  br label %for.inc112.loopexit.us

for.inc112.loopexit.us:                           ; preds = %for.inc112.loopexit.us.loopexit111, %for.inc112.loopexit.us.loopexit
  %indvars.iv.next67 = add nuw i64 %indvars.iv66, 1
  %cmp90.us = icmp slt i64 %indvars.iv.next67, 4096
  br i1 %cmp90.us, label %for.inc112.loopexit.us.vector.memcheck_crit_edge, label %for.cond118.preheader.us.preheader

for.inc112.loopexit.us.vector.memcheck_crit_edge: ; preds = %for.inc112.loopexit.us
  br label %vector.memcheck

for.cond118.preheader.us.preheader:               ; preds = %for.inc112.loopexit.us
...
for.cond118.preheader.us:                         ; preds = %for.inc147.loopexit.us.for.cond118.preheader.us_crit_edge, %for.cond118.preheader.us.preheader
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc147.loopexit.us.for.cond118.preheader.us_crit_edge ], [ 0, %for.cond118.preheader.us.preheader ]
...
for.inc144.us.for.inc144.us_crit_edge:            ; preds = %for.inc144.us.for.inc144.us_crit_edge.1, %for.cond118.preheader.us
  ...
  br i1 %exitcond58, label %for.inc147.loopexit.us, label %for.inc144.us.for.inc144.us_crit_edge.1

for.inc147.loopexit.us:                           ; preds = %for.inc144.us.for.inc144.us_crit_edge
  %indvars.iv.next60 = add nuw i64 %indvars.iv59, 1
  %cmp116.us = icmp slt i64 %indvars.iv.next60, 2160
  br i1 %cmp116.us, label %for.inc147.loopexit.us.for.cond118.preheader.us_crit_edge, label %for.cond154.preheader.us.preheader

for.inc147.loopexit.us.for.cond118.preheader.us_crit_edge: ; preds = %for.inc147.loopexit.us
  br label %for.cond118.preheader.us
...
for.cond154.preheader.us:                         ; preds = %for.inc179.loopexit.us.for.cond154.preheader.us_crit_edge, %for.cond154.preheader.us.preheader
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc179.loopexit.us.for.cond154.preheader.us_crit_edge ], [ 0, %for.cond154.preheader.us.preheader ]
...
for.inc176.us.for.inc176.us_crit_edge:            ; preds = %for.inc176.us.for.inc176.us_crit_edge.1, %for.cond154.preheader.us
  ...
  br i1 %cmp155.us, label %for.inc176.us.for.inc176.us_crit_edge.1, label %for.inc179.loopexit.us

for.inc179.loopexit.us:                           ; preds = %for.inc176.us.for.inc176.us_crit_edge
  %indvars.iv.next53 = add nuw i64 %indvars.iv52, 1
  %cmp151.us = icmp slt i64 %indvars.iv.next53, 2160
  br i1 %cmp151.us, label %for.inc179.loopexit.us.for.cond154.preheader.us_crit_edge, label %vector.memcheck94.preheader

for.inc179.loopexit.us.for.cond154.preheader.us_crit_edge: ; preds = %for.inc179.loopexit.us
  br label %for.cond154.preheader.us

vector.memcheck94.preheader:                      ; preds = %for.inc179.loopexit.us
  br label %vector.memcheck94

vector.memcheck94:                                ; preds = %for.inc205.loopexit.us.vector.memcheck94_crit_edge, %vector.memcheck94.preheader
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc205.loopexit.us.vector.memcheck94_crit_edge ], [ 0, %vector.memcheck94.preheader ]
...
vector.body69.preheader:                          ; preds = %vector.memcheck94
  br label %vector.body69

for.inc202.us.preheader:                          ; preds = %vector.memcheck94
...
vector.body69:                                    ; preds = %vector.body69.vector.body69_crit_edge, %vector.body69.preheader
  ...
  br i1 %75, label %for.inc205.loopexit.us.loopexit110, label %vector.body69.vector.body69_crit_edge, !llvm.loop !22
...
for.inc202.us:                                    ; preds = %for.inc202.us.for.inc202.us_crit_edge, %for.inc202.us.preheader
  ...
  br i1 %exitcond.2, label %for.inc205.loopexit.us.loopexit, label %for.inc202.us.for.inc202.us_crit_edge, !llvm.loop !23

for.inc202.us.for.inc202.us_crit_edge:            ; preds = %for.inc202.us
  br label %for.inc202.us

for.inc205.loopexit.us.loopexit:                  ; preds = %for.inc202.us
  br label %for.inc205.loopexit.us

for.inc205.loopexit.us.loopexit110:               ; preds = %vector.body69
  br label %for.inc205.loopexit.us

for.inc205.loopexit.us:                           ; preds = %for.inc205.loopexit.us.loopexit110, %for.inc205.loopexit.us.loopexit
  %indvars.iv.next48 = add nuw i64 %indvars.iv47, 1
  %cmp183.us = icmp slt i64 %indvars.iv.next48, 4096
  br i1 %cmp183.us, label %for.inc205.loopexit.us.vector.memcheck94_crit_edge, label %for.end207

for.inc205.loopexit.us.vector.memcheck94_crit_edge: ; preds = %for.inc205.loopexit.us
  br label %vector.memcheck94

for.end207:                                       ; preds = %for.inc205.loopexit.us
  ret void
...
for.inc.us.for.inc.us_crit_edge.1:                ; preds = %for.inc.us.for.inc.us_crit_edge
  ...
  %86 = bitcast float* %arrayidx35.us to <2 x float>*
  ...
  %mul37.us.1 = fmul <2 x float> %mul36.us.1.v.i0.2, %87
...
for.cond2.preheader.us:                           ; preds = %for.inc10.loopexit.us.for.cond2.preheader.us_crit_edge, %for.cond2.preheader.us.preheader
  %indvars.iv9 = phi i64 [ 0, %for.cond2.preheader.us.preheader ], [ %indvars.iv.next10, %for.inc10.loopexit.us.for.cond2.preheader.us_crit_edge ]
...
for.inc.us:                                       ; preds = %for.body4.us.for.inc.us_crit_edge, %if.then.us
  ...
  br i1 %cmp3.us, label %for.inc.us.for.body4.us_crit_edge, label %for.inc10.loopexit.us
...
for.inc10.loopexit.us:                            ; preds = %for.inc.us
  %indvars.iv.next10 = add nuw i64 %indvars.iv9, 1
  %cmp.us = icmp slt i64 %indvars.iv.next10, 4096
  br i1 %cmp.us, label %for.inc10.loopexit.us.for.cond2.preheader.us_crit_edge, label %for.end12

for.inc10.loopexit.us.for.cond2.preheader.us_crit_edge: ; preds = %for.inc10.loopexit.us
  br label %for.cond2.preheader.us

for.end12:                                        ; preds = %for.inc10.loopexit.us
