...
.preheader12._crit_edge.prol:                     ; preds = %.preheader12._crit_edge.prol, %.preheader12._crit_edge.prol.preheader
  ...
  %prol.iter152 = phi i64 [ 0, %.preheader12._crit_edge.prol.preheader ], [ %prol.iter152.sub, %.preheader12._crit_edge.prol ]
  %18 = mul nuw nsw i64 %indvars.iv3179.prol, 16000
  ...
  br i1 %prol.iter152.cmp, label %.preheader12._crit_edge.prol.loopexit.unr-lcssa, label %.preheader12._crit_edge.prol, !llvm.loop !1
...
.preheader12._crit_edge.prol.loopexit:            ; preds = %._crit_edge, %.preheader12._crit_edge.prol.loopexit.unr-lcssa
  br i1 false, label %.preheader10.preheader.preheader, label %._crit_edge.new
...
.preheader9.preheader.preheader:                  ; preds = %.preheader11, %.preheader10.preheader.preheader
  ...
  %scevgep105 = getelementptr [2000 x double], [2000 x double]* %1, i64 0, i64 %indvars.iv2559
  %scevgep105106 = bitcast double* %scevgep105 to i8*
  %34 = add nsw i64 %indvars.iv2559, -1999
  %scevgep107 = getelementptr [2000 x double], [2000 x double]* %1, i64 2000, i64 %34
...
.preheader9.preheader:                            ; preds = %.preheader10, %.preheader9.preheader.preheader
  ...
  %scevgep103 = getelementptr i8, i8* %16, i64 %35
  %36 = add i64 16000, %35
  %scevgep104 = getelementptr i8, i8* %16, i64 %36
  %37 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv2157, i64 %indvars.iv2559
  br i1 false, label %.preheader9.preheader147, label %min.iters.checked

min.iters.checked:                                ; preds = %.preheader9.preheader
  br i1 false, label %.preheader9.preheader147, label %vector.memcheck
...
vector.memcheck:                                  ; preds = %min.iters.checked
  ...
  br i1 %conflict.rdx, label %.preheader9.preheader147, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load114 = load <2 x double>, <2 x double>* %63, align 8, !alias.scope !8, !noalias !10
  %64 = fadd <2 x double> %wide.load, %58
  %65 = fadd <2 x double> %wide.load114, %59
...
middle.block:                                     ; preds = %vector.body
  br i1 true, label %.preheader10, label %.preheader9.preheader147

.preheader9.preheader147:                         ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.preheader9.preheader
...
.preheader9.prol.preheader:                       ; preds = %.preheader9.preheader147
...
.preheader9.prol.loopexit.unr-lcssa:              ; preds = %.preheader9.preheader147, %.preheader9.prol
  %indvars.iv1754.unr.ph = phi i64 [ %indvars.iv.next18.prol, %.preheader9.prol ], [ %indvars.iv1754.ph, %.preheader9.preheader147 ]
  br label %.preheader9.prol.loopexit

.preheader9.prol.loopexit:                        ; preds = %.preheader9.prol.loopexit.unr-lcssa
  br i1 false, label %.preheader10.loopexit, label %.preheader9.preheader147.new

.preheader9.preheader147.new:                     ; preds = %.preheader9.prol.loopexit
  br label %.preheader9

.preheader9:                                      ; preds = %.preheader9, %.preheader9.preheader147.new
  %indvars.iv1754 = phi i64 [ %indvars.iv1754.unr.ph, %.preheader9.preheader147.new ], [ %indvars.iv.next18.1, %.preheader9 ]
...
.preheader.preheader:                             ; preds = %.preheader8, %.preheader.preheader.preheader
  ...
  %scevgep124 = getelementptr [2000 x double], [2000 x double]* %1, i64 %indvars.iv1551, i64 0
  %scevgep124125 = bitcast double* %scevgep124 to i8*
  %scevgep126 = getelementptr [2000 x double], [2000 x double]* %1, i64 %indvars.iv1551, i64 2000
  %scevgep126127 = bitcast double* %scevgep126 to i8*
  %90 = mul nuw nsw i64 %indvars.iv1551, 16000
  %scevgep128 = getelementptr i8, i8* %16, i64 %90
  %91 = add i64 16000, %90
  %scevgep129 = getelementptr i8, i8* %16, i64 %91
...
vector.body115:                                   ; preds = %vector.body115.preheader, %vector.body115
  ...
  %92 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %17, i64 0, i64 %indvars.iv1551, i64 %index136
  %93 = bitcast double* %92 to <2 x i64>*
  %wide.load144 = load <2 x i64>, <2 x i64>* %93, align 8, !alias.scope !15
  %94 = getelementptr double, double* %92, i64 2
  %95 = bitcast double* %94 to <2 x i64>*
  %wide.load145 = load <2 x i64>, <2 x i64>* %95, align 8, !alias.scope !15
  %96 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv1551, i64 %index136
  %97 = bitcast double* %96 to <2 x i64>*
  store <2 x i64> %wide.load144, <2 x i64>* %97, align 8, !alias.scope !18, !noalias !15
  %98 = getelementptr double, double* %96, i64 2
  %99 = bitcast double* %98 to <2 x i64>*
  store <2 x i64> %wide.load145, <2 x i64>* %99, align 8, !alias.scope !18, !noalias !15
  %index.next137 = add i64 %index136, 4
  %100 = icmp eq i64 %index.next137, 2000
  br i1 %100, label %middle.block116, label %vector.body115, !llvm.loop !20

middle.block116:                                  ; preds = %vector.body115
  br i1 true, label %.preheader8, label %.preheader.preheader146

.preheader.preheader146:                          ; preds = %middle.block116, %vector.memcheck134, %min.iters.checked119, %.preheader.preheader
  %indvars.iv50.ph = phi i64 [ 0, %vector.memcheck134 ], [ 0, %min.iters.checked119 ], [ 0, %.preheader.preheader ], [ 2000, %middle.block116 ]
...
.preheader.prol.loopexit:                         ; preds = %.preheader.preheader146, %.preheader.prol.loopexit.unr-lcssa
  ...
  br i1 %107, label %.preheader8.loopexit, label %.preheader.preheader146.new

.preheader.preheader146.new:                      ; preds = %.preheader.prol.loopexit
  br label %.preheader

.preheader:                                       ; preds = %.preheader, %.preheader.preheader146.new
  %indvars.iv50 = phi i64 [ %indvars.iv50.ph, %.preheader.preheader146.new ], [ %indvars.iv.next.3, %.preheader ]
...
.preheader8.loopexit:                             ; preds = %.preheader.prol.loopexit, %.preheader8.loopexit.unr-lcssa
  br label %.preheader8

.preheader8:                                      ; preds = %.preheader8.loopexit, %middle.block116
...
.preheader8._crit_edge:                           ; preds = %.preheader8._crit_edge.loopexit, %._crit_edge.thread
  %128 = phi i8* [ %3, %._crit_edge.thread ], [ %16, %.preheader8._crit_edge.loopexit ]
