...
vector.body99:                                    ; preds = %vector.body99.preheader, %vector.body99
  ...
  %wide.vec140 = load <4 x double>, <4 x double>* %48, align 8, !alias.scope !1
  ...
  store <4 x double> %interleaved.vec143, <4 x double>* %55, align 8, !alias.scope !4, !noalias !1
  %index.next126 = add i64 %index125, 2
  %56 = icmp eq i64 %index.next126, %n.vec105
  br i1 %56, label %middle.block100, label %vector.body99, !llvm.loop !6
...
vector.body54:                                    ; preds = %vector.body54.preheader, %vector.body54
  ...
  %wide.vec89 = load <4 x double>, <4 x double>* %119, align 8, !alias.scope !11
  ...
  %wide.vec92 = load <4 x double>, <4 x double>* %124, align 8, !alias.scope !11
  ...
  %wide.vec95 = load <4 x double>, <4 x double>* %127, align 8, !alias.scope !11
  ...
  store <4 x double> %interleaved.vec98, <4 x double>* %134, align 8, !alias.scope !14, !noalias !11
  %index.next81 = add i64 %index80, 2
  %135 = icmp eq i64 %index.next81, %n.vec60
  br i1 %135, label %middle.block55, label %vector.body54, !llvm.loop !16
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.vec48 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !17
  ...
  %wide.vec51 = load <4 x double>, <4 x double>* %169, align 8, !alias.scope !17
