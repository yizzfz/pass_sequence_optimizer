...
.lr.ph28.split.us:                                ; preds = %._crit_edge25.us, %.lr.ph28.split.us.preheader
  %indvars.iv65 = phi i64 [ 0, %.lr.ph28.split.us.preheader ], [ %indvars.iv.next66, %._crit_edge25.us ]
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv65
  store double 0.000000e+00, double* %5, align 8
  %sunkaddr89 = shl i64 %indvars.iv65, 3
  %sunkaddr90 = add i64 %4, %sunkaddr89
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph28.split.us
  ...
  %indvars.iv62 = phi i64 [ 0, %.lr.ph28.split.us ], [ %indvars.iv.next63.4, %._crit_edge ]
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv62, i64 %indvars.iv65
  %8 = load double, double* %7, align 8
  %9 = fadd double %8, %6
  store double %9, double* %sunkaddr91, align 8
  %indvars.iv.next63 = add nuw nsw i64 %indvars.iv62, 1
  %10 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next63, i64 %indvars.iv65
  %11 = load double, double* %10, align 8
  %12 = fadd double %11, %9
  store double %12, double* %sunkaddr91, align 8
  %indvars.iv.next63.1 = add nuw nsw i64 %indvars.iv62, 2
  %13 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next63.1, i64 %indvars.iv65
  %14 = load double, double* %13, align 8
  %15 = fadd double %14, %12
  store double %15, double* %sunkaddr91, align 8
  %indvars.iv.next63.2 = add nuw nsw i64 %indvars.iv62, 3
  %16 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next63.2, i64 %indvars.iv65
  %17 = load double, double* %16, align 8
  %18 = fadd double %17, %15
  store double %18, double* %sunkaddr91, align 8
  %indvars.iv.next63.3 = add nuw nsw i64 %indvars.iv62, 4
  %19 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next63.3, i64 %indvars.iv65
  %20 = load double, double* %19, align 8
  %21 = fadd double %20, %18
  store double %21, double* %sunkaddr91, align 8
  %indvars.iv.next63.4 = add nuw nsw i64 %indvars.iv62, 5
  %exitcond64.4 = icmp eq i64 %indvars.iv.next63.4, 1400
  br i1 %exitcond64.4, label %._crit_edge25.us, label %._crit_edge

._crit_edge25.us:                                 ; preds = %._crit_edge
  %22 = fdiv double %21, %0
  %sunkaddr23 = shl i64 %indvars.iv65, 3
  %sunkaddr24 = add i64 %sunkaddr, %sunkaddr23
  %sunkaddr25 = inttoptr i64 %sunkaddr24 to double*
  store double %22, double* %sunkaddr25, align 8
  %indvars.iv.next66 = add nuw nsw i64 %indvars.iv65, 1
  %exitcond67 = icmp eq i64 %indvars.iv.next66, 1200
  br i1 %exitcond67, label %._crit_edge25.us..lr.ph20.split.us_crit_edge, label %.lr.ph28.split.us
...
vector.memcheck:                                  ; preds = %._crit_edge17.us, %._crit_edge25.us..lr.ph20.split.us_crit_edge
  %indvars.iv58 = phi i64 [ 0, %._crit_edge25.us..lr.ph20.split.us_crit_edge ], [ %23, %._crit_edge17.us ]
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck.vector.body_crit_edge
  ...
  br i1 %39, label %._crit_edge17.us.loopexit26, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph, %vector.memcheck.scalar.ph_crit_edge
  %indvars.iv55 = phi i64 [ 0, %vector.memcheck.scalar.ph_crit_edge ], [ %indvars.iv.next56.3, %scalar.ph ]
  %40 = getelementptr inbounds double, double* %3, i64 %indvars.iv55
  %41 = load double, double* %40, align 8
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv58, i64 %indvars.iv55
  %43 = load double, double* %42, align 8
  %44 = fsub double %43, %41
  store double %44, double* %42, align 8
  %indvars.iv.next56 = or i64 %indvars.iv55, 1
  %45 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next56
  %46 = load double, double* %45, align 8
  %47 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv58, i64 %indvars.iv.next56
  %48 = load double, double* %47, align 8
  %49 = fsub double %48, %46
  store double %49, double* %47, align 8
  %indvars.iv.next56.1 = or i64 %indvars.iv55, 2
  %50 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next56.1
  %51 = load double, double* %50, align 8
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv58, i64 %indvars.iv.next56.1
  %53 = load double, double* %52, align 8
  %54 = fsub double %53, %51
  store double %54, double* %52, align 8
  %indvars.iv.next56.2 = or i64 %indvars.iv55, 3
  %55 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next56.2
  %56 = load double, double* %55, align 8
  %57 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv58, i64 %indvars.iv.next56.2
  %58 = load double, double* %57, align 8
  %59 = fsub double %58, %56
  store double %59, double* %57, align 8
  %indvars.iv.next56.3 = add nuw nsw i64 %indvars.iv55, 4
  %exitcond57.3 = icmp eq i64 %indvars.iv.next56.3, 1200
  br i1 %exitcond57.3, label %._crit_edge17.us.loopexit, label %scalar.ph, !llvm.loop !9

._crit_edge17.us.loopexit:                        ; preds = %scalar.ph
  br label %._crit_edge17.us

._crit_edge17.us.loopexit26:                      ; preds = %vector.body
  br label %._crit_edge17.us

._crit_edge17.us:                                 ; preds = %._crit_edge17.us.loopexit26, %._crit_edge17.us.loopexit
  %exitcond60 = icmp eq i64 %23, 1400
  br i1 %exitcond60, label %.lr.ph12.split.us.preheader, label %vector.memcheck
...
.lr.ph8.us:                                       ; preds = %._crit_edge9.us-lcssa.us.us, %.lr.ph12.split.us.preheader
  %indvars.iv44 = phi i64 [ 0, %.lr.ph12.split.us.preheader ], [ %indvars.iv.next45, %._crit_edge9.us-lcssa.us.us ]
  br label %.lr.ph.us.us

._crit_edge9.us-lcssa.us.us:                      ; preds = %._crit_edge.us.us
  %indvars.iv.next45 = add nuw nsw i64 %indvars.iv44, 1
  %exitcond46 = icmp eq i64 %indvars.iv.next45, 1200
  br i1 %exitcond46, label %._crit_edge13, label %.lr.ph8.us

.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph8.us
  %indvars.iv41 = phi i64 [ %indvars.iv44, %.lr.ph8.us ], [ %indvars.iv.next42, %._crit_edge.us.us ]
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv44, i64 %indvars.iv41
...
._crit_edge.us.us:                                ; preds = %._crit_edge21
  ...
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv41, i64 %indvars.iv44
  store double %62, double* %63, align 8
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  %exitcond43 = icmp eq i64 %indvars.iv.next42, 1200
  br i1 %exitcond43, label %._crit_edge9.us-lcssa.us.us, label %.lr.ph.us.us
