...
for.body:                                         ; preds = %for.body, %for.body.lr.ph
  ...
  br i1 %cmp.2, label %for.body, label %for.body6.us.new.preheader
...
for.body6.us.new:                                 ; preds = %for.body6.us.new.preheader, %for.cond7.for.inc22_crit_edge.us
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.cond7.for.inc22_crit_edge.us ], [ 0, %for.body6.us.new.preheader ]
...
for.cond7.for.inc22_crit_edge.us:                 ; preds = %for.body10.us
  ...
  br i1 %cmp4.us, label %for.body6.us.new, label %for.end24
