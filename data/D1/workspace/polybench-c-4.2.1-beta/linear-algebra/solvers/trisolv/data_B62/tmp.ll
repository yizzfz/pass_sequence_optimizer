...
; <label>:4:                                      ; preds = %._crit_edge, %.lr.ph34
  ...
  %6 = getelementptr inbounds double, double* %3, i64 %indvars.iv40
  %7 = bitcast double* %6 to i64*
  %8 = load i64, i64* %7, align 8
  %9 = getelementptr inbounds double, double* %2, i64 %indvars.iv40
  %10 = bitcast double* %9 to i64*
  store i64 %8, i64* %10, align 8
  %11 = icmp sgt i64 %indvars.iv40, 0
...
.prol.preheader:                                  ; preds = %.lr.ph
  %12 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv40, i64 0
  %13 = load double, double* %12, align 8
  %14 = load double, double* %2, align 8
  %15 = fmul double %13, %14
  %16 = load double, double* %sunkaddr26, align 8
  %17 = fsub double %16, %15
  store double %17, double* %sunkaddr26, align 8
  br label %.prol.loopexit
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.lr.ph.new ], [ %indvars.iv.unr.ph, %.lr.ph.new.preheader ]
  %20 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv40, i64 %indvars.iv
  %21 = load double, double* %20, align 8
  %22 = getelementptr inbounds double, double* %2, i64 %indvars.iv
  %23 = load double, double* %22, align 8
  %24 = fmul double %21, %23
  %25 = load double, double* %sunkaddr26, align 8
  %26 = fsub double %25, %24
  store double %26, double* %sunkaddr26, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %27 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv40, i64 %indvars.iv.next
  %28 = load double, double* %27, align 8
  %29 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next
  %30 = load double, double* %29, align 8
  %31 = fmul double %28, %30
  %32 = load double, double* %sunkaddr26, align 8
  %33 = fsub double %32, %31
  store double %33, double* %sunkaddr26, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %4
  ...
  %34 = load double, double* %sunkaddr30, align 8
  %35 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv40, i64 %indvars.iv40
  %36 = load double, double* %35, align 8
  %37 = fdiv double %34, %36
  store double %37, double* %sunkaddr30, align 8
