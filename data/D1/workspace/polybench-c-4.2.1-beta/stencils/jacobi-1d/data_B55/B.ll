...
._crit_edge.us:                                   ; preds = %._crit_edge.us.preheader, %._crit_edge5.us
  %18 = phi i32 [ %95, %._crit_edge5.us ], [ 0, %._crit_edge.us.preheader ]
...
scalar.ph49:                                      ; preds = %scalar.ph49.preheader, %scalar.ph49
  %indvars.iv = phi i64 [ %50, %scalar.ph49 ], [ %indvars.iv.ph, %scalar.ph49.preheader ]
  %44 = add nsw i64 %indvars.iv, -1
  %45 = getelementptr inbounds double, double* %2, i64 %44
  %46 = load double, double* %45, align 8
  %47 = getelementptr inbounds double, double* %2, i64 %indvars.iv
  ...
  %55 = getelementptr inbounds double, double* %3, i64 %indvars.iv
  store double %54, double* %55, align 8
  %56 = icmp slt i64 %50, %9
  br i1 %56, label %scalar.ph49, label %.lr.ph4.us.preheader.loopexit, !llvm.loop !16
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load = load <2 x double>, <2 x double>* %59, align 8, !alias.scope !17
  %60 = getelementptr double, double* %58, i64 2
  %61 = bitcast double* %60 to <2 x double>*
  %wide.load42 = load <2 x double>, <2 x double>* %61, align 8, !alias.scope !17
  %62 = getelementptr inbounds double, double* %3, i64 %offset.idx
  %63 = bitcast double* %62 to <2 x double>*
  %wide.load43 = load <2 x double>, <2 x double>* %63, align 8, !alias.scope !17
  %64 = getelementptr double, double* %62, i64 2
  %65 = bitcast double* %64 to <2 x double>*
  %wide.load44 = load <2 x double>, <2 x double>* %65, align 8, !alias.scope !17
  %66 = fadd <2 x double> %wide.load, %wide.load43
  %67 = fadd <2 x double> %wide.load42, %wide.load44
  %68 = add nuw nsw i64 %offset.idx, 1
  %69 = getelementptr inbounds double, double* %3, i64 %68
  %70 = bitcast double* %69 to <2 x double>*
  %wide.load45 = load <2 x double>, <2 x double>* %70, align 8, !alias.scope !17
  %71 = getelementptr double, double* %69, i64 2
  %72 = bitcast double* %71 to <2 x double>*
  %wide.load46 = load <2 x double>, <2 x double>* %72, align 8, !alias.scope !17
  %73 = fadd <2 x double> %66, %wide.load45
  %74 = fadd <2 x double> %67, %wide.load46
  ...
  store <2 x double> %75, <2 x double>* %78, align 8, !alias.scope !20, !noalias !17
  %79 = getelementptr double, double* %77, i64 2
  %80 = bitcast double* %79 to <2 x double>*
  store <2 x double> %76, <2 x double>* %80, align 8, !alias.scope !20, !noalias !17
  %index.next = add i64 %index, 4
  %81 = icmp eq i64 %index.next, %n.vec
  br i1 %81, label %middle.block, label %vector.body, !llvm.loop !22
...
.lr.ph4.us:                                       ; preds = %.lr.ph4.us.preheader86, %.lr.ph4.us
  %indvars.iv25 = phi i64 [ %88, %.lr.ph4.us ], [ %indvars.iv25.ph, %.lr.ph4.us.preheader86 ]
  %82 = add nsw i64 %indvars.iv25, -1
  %83 = getelementptr inbounds double, double* %3, i64 %82
  %84 = load double, double* %83, align 8
  %85 = getelementptr inbounds double, double* %3, i64 %indvars.iv25
  %86 = load double, double* %85, align 8
  %87 = fadd double %84, %86
  %88 = add nuw nsw i64 %indvars.iv25, 1
  %89 = getelementptr inbounds double, double* %3, i64 %88
  %90 = load double, double* %89, align 8
  %91 = fadd double %87, %90
  %92 = fmul double %91, 3.333300e-01
  %93 = getelementptr inbounds double, double* %2, i64 %indvars.iv25
  store double %92, double* %93, align 8
  %94 = icmp slt i64 %88, %9
  br i1 %94, label %.lr.ph4.us, label %._crit_edge5.us.loopexit, !llvm.loop !23
...
._crit_edge5.us:                                  ; preds = %._crit_edge5.us.loopexit, %middle.block
  ...
  br i1 %96, label %._crit_edge.us, label %._crit_edge.lr.ph.split.loopexit
