...
define internal fastcc void @kernel_mvt(i32, double* nocapture, double* nocapture, double*, double*, [2000 x double]*) unnamed_addr #2 {
  br i1 true, label %.preheader5.lr.ph, label %._crit_edge7

.preheader5.lr.ph:                                ; preds = %6
  br label %.preheader5.us

.preheader5.us:                                   ; preds = %._crit_edge11.us, %.preheader5.lr.ph
  %indvars.iv27 = phi i64 [ 0, %.preheader5.lr.ph ], [ %indvars.iv.next28, %._crit_edge11.us ]
  %7 = getelementptr inbounds double, double* %1, i64 %indvars.iv27
  br i1 true, label %.prol.loopexit24, label %.prol.preheader23

.prol.preheader23:                                ; preds = %.preheader5.us
  %8 = load double, double* %7, align 8
  %9 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv27, i64 0
...
.prol.loopexit24:                                 ; preds = %.preheader5.us, %.prol.preheader23
  %indvars.iv19.unr.ph = phi i64 [ 1, %.prol.preheader23 ], [ 0, %.preheader5.us ]
  br i1 false, label %._crit_edge11.us, label %.preheader5.us.new.preheader
...
.preheader5.us.new:                               ; preds = %.preheader5.us.new, %.preheader5.us.new.preheader
  %14 = phi double [ %.pre, %.preheader5.us.new.preheader ], [ %26, %.preheader5.us.new ]
  %indvars.iv19 = phi i64 [ %indvars.iv19.unr.ph, %.preheader5.us.new.preheader ], [ %indvars.iv.next20.1, %.preheader5.us.new ]
  %15 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv27, i64 %indvars.iv19
  %16 = load double, double* %15, align 8
  %17 = getelementptr inbounds double, double* %3, i64 %indvars.iv19
  %18 = load double, double* %17, align 8
  %19 = fmul double %16, %18
  %20 = fadd double %14, %19
  store double %20, double* %7, align 8
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  %21 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv27, i64 %indvars.iv.next20
  %22 = load double, double* %21, align 8
  %23 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next20
  ...
  br i1 %exitcond22.1, label %._crit_edge11.us.loopexit, label %.preheader5.us.new

._crit_edge11.us.loopexit:                        ; preds = %.preheader5.us.new
  br label %._crit_edge11.us

._crit_edge11.us:                                 ; preds = %._crit_edge11.us.loopexit, %.prol.loopexit24
  %indvars.iv.next28 = add nuw nsw i64 %indvars.iv27, 1
  %exitcond30 = icmp eq i64 %indvars.iv.next28, 2000
  br i1 %exitcond30, label %.preheader.us.preheader, label %.preheader5.us
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  ...
  %27 = getelementptr inbounds double, double* %2, i64 %indvars.iv16
  br i1 true, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.preheader.us
  %28 = load double, double* %27, align 8
  %29 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 0, i64 %indvars.iv16
...
.preheader.us.new.preheader:                      ; preds = %.prol.loopexit
  %.pre31 = load double, double* %27, align 8
  br label %.preheader.us.new

.preheader.us.new:                                ; preds = %.preheader.us.new, %.preheader.us.new.preheader
  %34 = phi double [ %.pre31, %.preheader.us.new.preheader ], [ %46, %.preheader.us.new ]
  %indvars.iv = phi i64 [ %indvars.iv.unr.ph, %.preheader.us.new.preheader ], [ %indvars.iv.next.1, %.preheader.us.new ]
  %35 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv, i64 %indvars.iv16
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %41 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv.next, i64 %indvars.iv16
...
define internal fastcc void @print_array(i32, double* nocapture readonly, double* nocapture readonly) unnamed_addr #0 {
  ...
  br i1 true, label %.lr.ph6.preheader, label %._crit_edge7.._crit_edge_crit_edge.critedge

.lr.ph6.preheader:                                ; preds = %3
  br label %.lr.ph6

.lr.ph6:                                          ; preds = %.lr.ph6._crit_edge, %.lr.ph6.preheader
  %indvars.iv9 = phi i64 [ 0, %.lr.ph6.preheader ], [ %indvars.iv.next10, %.lr.ph6._crit_edge ]
...
.lr.ph6._crit_edge:                               ; preds = %.lr.ph6, %11
  ...
  br i1 %exitcond12, label %._crit_edge7, label %.lr.ph6
...
._crit_edge7.._crit_edge_crit_edge.critedge:      ; preds = %3
  ...
  %24 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %23, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.7, i64 0, i64 0)) #6
  br label %._crit_edge
...
; <label>:28:                                     ; preds = %.lr.ph
  ...
  %fputc = tail call i32 @fputc(i32 10, %struct._IO_FILE* %29) #5
  br label %.lr.ph._crit_edge

.lr.ph._crit_edge:                                ; preds = %.lr.ph, %28
...
._crit_edge:                                      ; preds = %._crit_edge7.._crit_edge_crit_edge, %._crit_edge.loopexit, %._crit_edge7.._crit_edge_crit_edge.critedge
