...
for.inc.prol.loopexit:                            ; preds = %for.inc.lr.ph, %for.inc.prol.loopexit.unr-lcssa
  ...
  %11 = icmp ult i64 %indvars.iv29, 3
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %23 = getelementptr inbounds double, double* %y, i64 %index
  %24 = bitcast double* %23 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %24, align 8
  %25 = getelementptr double, double* %23, i64 2
  %26 = bitcast double* %25 to <2 x double>*
  %wide.load3 = load <2 x double>, <2 x double>* %26, align 8
  %27 = sub nsw i64 %7, %index
  %28 = getelementptr inbounds double, double* %y, i64 %27
  %29 = getelementptr double, double* %28, i64 -1
  %30 = bitcast double* %29 to <2 x double>*
  %wide.load4 = load <2 x double>, <2 x double>* %30, align 8
  %reverse = shufflevector <2 x double> %wide.load4, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %31 = getelementptr double, double* %28, i64 -2
  %32 = getelementptr double, double* %31, i64 -1
  %33 = bitcast double* %32 to <2 x double>*
  %wide.load5 = load <2 x double>, <2 x double>* %33, align 8
  %reverse6 = shufflevector <2 x double> %wide.load5, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %34 = fmul <2 x double> %broadcast.splat8, %reverse
  %35 = fmul <2 x double> %broadcast.splat8, %reverse6
  %36 = fadd <2 x double> %wide.load, %34
  %37 = fadd <2 x double> %wide.load3, %35
  %38 = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %index
  %39 = bitcast double* %38 to <2 x double>*
  store <2 x double> %36, <2 x double>* %39, align 16
  %40 = getelementptr double, double* %38, i64 2
  %41 = bitcast double* %40 to <2 x double>*
  store <2 x double> %37, <2 x double>* %41, align 16
...
for.inc32:                                        ; preds = %for.inc32.preheader, %for.inc32
  ...
  %44 = sub nsw i64 %7, %indvars.iv14
  %arrayidx27 = getelementptr inbounds double, double* %y, i64 %44
  %45 = load double, double* %arrayidx27, align 8
  %mul28 = fmul double %div, %45
  %add29 = fadd double %43, %mul28
...
for.inc47:                                        ; preds = %for.inc47.loopexit, %middle.block
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* nonnull %3, i64 %46, i32 8, i1 false)
