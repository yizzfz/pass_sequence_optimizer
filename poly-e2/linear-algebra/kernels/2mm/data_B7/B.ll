...
entry:
  ...
  %cmp24 = icmp sgt i32 %ni, 0
  br i1 %cmp24, label %for.cond4.preheader.lr.ph, label %for.end67

for.cond4.preheader.lr.ph:                        ; preds = %entry
  %cmp521 = icmp sgt i32 %nj, 0
  %cmp1019 = icmp sgt i32 %nk, 0
  br i1 %cmp521, label %for.cond4.preheader.us.preheader, label %for.cond34.preheader.lr.ph

for.cond4.preheader.us.preheader:                 ; preds = %for.cond4.preheader.lr.ph
  %3 = shl nsw i64 %1, 3
  %xtraiter79 = and i64 %0, 1
...
for.cond4.preheader.us:                           ; preds = %for.cond4.for.inc28_crit_edge.us, %for.cond4.preheader.us.preheader
  %indvars.iv925.us = phi i64 [ %indvars.iv.next10.us, %for.cond4.for.inc28_crit_edge.us ], [ 0, %for.cond4.preheader.us.preheader ]
  br i1 %cmp1019, label %for.body6.us.us.preheader, label %for.cond4.for.inc28_crit_edge.us.loopexit69

for.body6.us.us.preheader:                        ; preds = %for.cond4.preheader.us
  %arrayidx15.us.us.prol = getelementptr inbounds [1100 x double], [1100 x double]* %A, i64 %indvars.iv925.us, i64 0
  br label %for.body6.us.us

for.cond4.for.inc28_crit_edge.us.loopexit69:      ; preds = %for.cond4.preheader.us
  %scevgep = getelementptr [900 x double], [900 x double]* %tmp, i64 %indvars.iv925.us, i64 0
  %scevgep77 = bitcast double* %scevgep to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep77, i8 0, i64 %3, i32 8, i1 false)
...
for.cond4.for.inc28_crit_edge.us:                 ; preds = %for.cond4.for.inc28_crit_edge.us.loopexit, %for.cond4.for.inc28_crit_edge.us.loopexit69
  %indvars.iv.next10.us = add nuw nsw i64 %indvars.iv925.us, 1
  %exitcond85 = icmp eq i64 %indvars.iv.next10.us, %2
  br i1 %exitcond85, label %for.cond34.preheader.lr.ph.loopexit, label %for.cond4.preheader.us

for.body6.us.us:                                  ; preds = %for.body6.us.us.preheader, %for.cond9.for.inc25_crit_edge.us.us
  %indvars.iv722.us.us = phi i64 [ %indvars.iv.next8.us.us, %for.cond9.for.inc25_crit_edge.us.us ], [ 0, %for.body6.us.us.preheader ]
  ...
  br i1 %lcmp.mod80, label %for.body11.us.us.prol.loopexit, label %for.body11.us.us.prol
...
for.body11.us.us.prol:                            ; preds = %for.body6.us.us
  ...
  %arrayidx19.us.us.prol = getelementptr inbounds [900 x double], [900 x double]* %B, i64 0, i64 %indvars.iv722.us.us
...
for.body11.us.us.prol.loopexit:                   ; preds = %for.body11.us.us.prol, %for.body6.us.us
  %.unr81.ph = phi double [ %add.us.us.prol, %for.body11.us.us.prol ], [ 0.000000e+00, %for.body6.us.us ]
  %indvars.iv520.us.us.unr.ph = phi i64 [ 1, %for.body11.us.us.prol ], [ 0, %for.body6.us.us ]
...
for.cond9.for.inc25_crit_edge.us.us:              ; preds = %for.cond9.for.inc25_crit_edge.us.us.loopexit, %for.body11.us.us.prol.loopexit
  ...
  %exitcond82 = icmp eq i64 %indvars.iv.next8.us.us, %1
  br i1 %exitcond82, label %for.cond4.for.inc28_crit_edge.us.loopexit, label %for.body6.us.us

for.body11.us.us:                                 ; preds = %for.body11.us.us.preheader, %for.body11.us.us
  %7 = phi double [ %add.us.us.1, %for.body11.us.us ], [ %.unr81.ph, %for.body11.us.us.preheader ]
  %indvars.iv520.us.us = phi i64 [ %indvars.iv.next6.us.us.1, %for.body11.us.us ], [ %indvars.iv520.us.us.unr.ph, %for.body11.us.us.preheader ]
  ...
  %exitcond78.1 = icmp eq i64 %indvars.iv.next6.us.us.1, %0
  br i1 %exitcond78.1, label %for.cond9.for.inc25_crit_edge.us.us.loopexit, label %for.body11.us.us
...
for.cond34.preheader.us.preheader:                ; preds = %for.cond34.preheader.lr.ph
  ...
  %xtraiter71 = and i64 %1, 1
  %lcmp.mod72 = icmp eq i64 %xtraiter71, 0
  %15 = icmp eq i32 %nj, 1
  %16 = add nsw i64 %12, -4
  %broadcast.splatinsert95 = insertelement <2 x double> undef, double %beta, i32 0
  %broadcast.splat96 = shufflevector <2 x double> %broadcast.splatinsert95, <2 x double> undef, <2 x i32> zeroinitializer
...
for.cond34.preheader.us:                          ; preds = %for.cond34.for.inc65_crit_edge.us, %for.cond34.preheader.us.preheader
  ...
  br i1 %cmp521, label %for.body36.us.us.preheader, label %for.body36.us27.preheader
...
for.body36.us27.preheader:                        ; preds = %for.cond34.preheader.us
  br i1 %lcmp.mod, label %for.body36.us27.prol.loopexit, label %for.body36.us27.prol.preheader

for.body36.us27.prol.preheader:                   ; preds = %for.body36.us27.preheader
  br label %for.body36.us27.prol

for.body36.us27.prol:                             ; preds = %for.body36.us27.prol.preheader, %for.body36.us27.prol
  %indvars.iv114.us28.prol = phi i64 [ %indvars.iv.next2.us33.prol, %for.body36.us27.prol ], [ 0, %for.body36.us27.prol.preheader ]
  %prol.iter = phi i64 [ %prol.iter.sub, %for.body36.us27.prol ], [ %xtraiter, %for.body36.us27.prol.preheader ]
  %arrayidx40.us29.prol = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv317.us, i64 %indvars.iv114.us28.prol
  %17 = load double, double* %arrayidx40.us29.prol, align 8
  %mul41.us30.prol = fmul double %17, %beta
  store double %mul41.us30.prol, double* %arrayidx40.us29.prol, align 8
  %indvars.iv.next2.us33.prol = add nuw nsw i64 %indvars.iv114.us28.prol, 1
  %prol.iter.sub = add i64 %prol.iter, -1
  %prol.iter.cmp = icmp eq i64 %prol.iter.sub, 0
  br i1 %prol.iter.cmp, label %for.body36.us27.prol.loopexit.loopexit, label %for.body36.us27.prol, !llvm.loop !1

for.body36.us27.prol.loopexit.loopexit:           ; preds = %for.body36.us27.prol
  br label %for.body36.us27.prol.loopexit

for.body36.us27.prol.loopexit:                    ; preds = %for.body36.us27.prol.loopexit.loopexit, %for.body36.us27.preheader
  %indvars.iv114.us28.unr = phi i64 [ 0, %for.body36.us27.preheader ], [ %indvars.iv.next2.us33.prol, %for.body36.us27.prol.loopexit.loopexit ]
  br i1 %14, label %for.cond34.for.inc65_crit_edge.us, label %for.body36.us27.preheader90

for.body36.us27.preheader90:                      ; preds = %for.body36.us27.prol.loopexit
  %18 = sub i64 %16, %indvars.iv114.us28.unr
  %19 = lshr i64 %18, 2
  %20 = add nuw nsw i64 %19, 1
  %min.iters.check = icmp ult i64 %20, 2
  br i1 %min.iters.check, label %for.body36.us27.preheader97, label %min.iters.checked

min.iters.checked:                                ; preds = %for.body36.us27.preheader90
  %n.mod.vf = and i64 %20, 1
  %n.vec = sub nsw i64 %20, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  %21 = add i64 %indvars.iv114.us28.unr, 4
  %22 = shl nuw i64 %19, 2
  %23 = add i64 %21, %22
  %24 = shl nuw nsw i64 %n.mod.vf, 2
  %ind.end = sub i64 %23, %24
  br i1 %cmp.zero, label %for.body36.us27.preheader97, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %25 = shl i64 %index, 2
  %26 = add i64 %indvars.iv114.us28.unr, %25
  ...
  %strided.vec92 = shufflevector <8 x double> %wide.vec, <8 x double> undef, <2 x i32> <i32 1, i32 5>
  %strided.vec93 = shufflevector <8 x double> %wide.vec, <8 x double> undef, <2 x i32> <i32 2, i32 6>
  %strided.vec94 = shufflevector <8 x double> %wide.vec, <8 x double> undef, <2 x i32> <i32 3, i32 7>
  %29 = fmul <2 x double> %strided.vec, %broadcast.splat96
  %30 = fmul <2 x double> %strided.vec92, %broadcast.splat96
  %31 = fmul <2 x double> %strided.vec93, %broadcast.splat96
  %32 = add nsw i64 %26, 3
  %33 = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv317.us, i64 %32
  %34 = fmul <2 x double> %strided.vec94, %broadcast.splat96
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.cond34.for.inc65_crit_edge.us, label %for.body36.us27.preheader97

for.body36.us27.preheader97:                      ; preds = %middle.block, %min.iters.checked, %for.body36.us27.preheader90
  %indvars.iv114.us28.ph = phi i64 [ %indvars.iv114.us28.unr, %min.iters.checked ], [ %indvars.iv114.us28.unr, %for.body36.us27.preheader90 ], [ %ind.end, %middle.block ]
  br label %for.body36.us27

for.body36.us27:                                  ; preds = %for.body36.us27.preheader97, %for.body36.us27
  %indvars.iv114.us28 = phi i64 [ %indvars.iv.next2.us33.3, %for.body36.us27 ], [ %indvars.iv114.us28.ph, %for.body36.us27.preheader97 ]
  %arrayidx40.us29 = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv317.us, i64 %indvars.iv114.us28
  %40 = load double, double* %arrayidx40.us29, align 8
  %mul41.us30 = fmul double %40, %beta
  store double %mul41.us30, double* %arrayidx40.us29, align 8
  %indvars.iv.next2.us33 = add nuw nsw i64 %indvars.iv114.us28, 1
  %arrayidx40.us29.1 = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv317.us, i64 %indvars.iv.next2.us33
  %41 = load double, double* %arrayidx40.us29.1, align 8
  %mul41.us30.1 = fmul double %41, %beta
  store double %mul41.us30.1, double* %arrayidx40.us29.1, align 8
  %indvars.iv.next2.us33.1 = add nsw i64 %indvars.iv114.us28, 2
  %arrayidx40.us29.2 = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv317.us, i64 %indvars.iv.next2.us33.1
  %42 = load double, double* %arrayidx40.us29.2, align 8
  %mul41.us30.2 = fmul double %42, %beta
  store double %mul41.us30.2, double* %arrayidx40.us29.2, align 8
  %indvars.iv.next2.us33.2 = add nsw i64 %indvars.iv114.us28, 3
  %arrayidx40.us29.3 = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv317.us, i64 %indvars.iv.next2.us33.2
  %43 = load double, double* %arrayidx40.us29.3, align 8
  %mul41.us30.3 = fmul double %43, %beta
  store double %mul41.us30.3, double* %arrayidx40.us29.3, align 8
  %indvars.iv.next2.us33.3 = add nsw i64 %indvars.iv114.us28, 4
  %exitcond.3 = icmp eq i64 %indvars.iv.next2.us33.3, %12
  br i1 %exitcond.3, label %for.cond34.for.inc65_crit_edge.us.loopexit98, label %for.body36.us27, !llvm.loop !6
...
for.cond34.for.inc65_crit_edge.us.loopexit98:     ; preds = %for.body36.us27
  br label %for.cond34.for.inc65_crit_edge.us

for.cond34.for.inc65_crit_edge.us:                ; preds = %for.cond34.for.inc65_crit_edge.us.loopexit98, %for.cond34.for.inc65_crit_edge.us.loopexit, %middle.block, %for.body36.us27.prol.loopexit
  %indvars.iv.next4.us = add nuw nsw i64 %indvars.iv317.us, 1
  %exitcond74 = icmp eq i64 %indvars.iv.next4.us, %2
  br i1 %exitcond74, label %for.end67.loopexit, label %for.cond34.preheader.us
...
for.body36.us.us:                                 ; preds = %for.body36.us.us.preheader, %for.cond42.for.inc62_crit_edge.us.us
  ...
  br i1 %lcmp.mod72, label %for.body44.us.us.prol.loopexit, label %for.body44.us.us.prol
