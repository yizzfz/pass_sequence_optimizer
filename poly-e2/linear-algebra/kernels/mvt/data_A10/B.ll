...
for.body.us:                                      ; preds = %for.cond22.for.cond.loopexit_crit_edge.us, %entry
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.cond22.for.cond.loopexit_crit_edge.us ], [ 0, %entry ]
  %0 = trunc i64 %indvars.iv31 to i32
  %conv.us = sitofp i32 %0 to double
  %arrayidx.us = getelementptr inbounds double, double* %x1, i64 %indvars.iv31
  %indvars.iv.next32 = add nuw nsw i64 %indvars.iv31, 1
  %1 = icmp eq i64 %indvars.iv.next32, 2000
  %2 = trunc i64 %indvars.iv.next32 to i32
  ...
  %arrayidx7.us = getelementptr inbounds double, double* %x2, i64 %indvars.iv31
  store double %div.us.v.r2, double* %arrayidx7.us, align 8
  %4 = add nuw nsw i64 %indvars.iv31, 3
  %5 = trunc i64 %4 to i32
  %rem9.us = srem i32 %5, 2000
  %conv10.us = sitofp i32 %rem9.us to double
  %arrayidx14.us = getelementptr inbounds double, double* %y_1, i64 %indvars.iv31
  %6 = add nuw nsw i64 %indvars.iv31, 4
  ...
  %arrayidx21.us = getelementptr inbounds double, double* %y_2, i64 %indvars.iv31
...
for.inc.us:                                       ; preds = %for.body.us, %for.inc.us
  ...
  %8 = mul nuw nsw i64 %indvars.iv, %indvars.iv31
  %9 = trunc i64 %8 to i32
  %rem26.us = srem i32 %9, 2000
  %conv27.us = sitofp i32 %rem26.us to double
  %arrayidx33.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv31, i64 %indvars.iv
  %indvars.iv.next = or i64 %indvars.iv, 1
  %10 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv31
  ...
  br i1 %exitcond.1, label %for.cond22.for.cond.loopexit_crit_edge.us, label %for.inc.us

for.cond22.for.cond.loopexit_crit_edge.us:        ; preds = %for.inc.us
  %13 = icmp eq i64 %indvars.iv.next32, 2000
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc12_crit_edge.us, %entry
  %indvars.iv40 = phi i64 [ 0, %entry ], [ %indvars.iv.next41, %for.cond1.for.inc12_crit_edge.us ]
  %arrayidx.us = getelementptr inbounds double, double* %x1, i64 %indvars.iv40
  %.pre = load double, double* %arrayidx.us, align 8
  %sunkaddr1 = mul i64 %indvars.iv40, 8
...
for.inc.us:                                       ; preds = %for.cond1.preheader.us, %for.inc.us
  ...
  %indvars.iv34 = phi i64 [ %indvars.iv.next35.1, %for.inc.us ], [ 0, %for.cond1.preheader.us ]
  %arrayidx7.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv40, i64 %indvars.iv34
  %1 = load double, double* %arrayidx7.us, align 8
  %arrayidx9.us = getelementptr inbounds double, double* %y_1, i64 %indvars.iv34
  ...
  %arrayidx7.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv40, i64 %indvars.iv.next35
  %3 = load double, double* %arrayidx7.us.1, align 8
  %arrayidx9.us.1 = getelementptr inbounds double, double* %y_1, i64 %indvars.iv.next35
  ...
  br i1 %exitcond37.1, label %for.cond1.for.inc12_crit_edge.us, label %for.inc.us
...
for.cond18.preheader.us:                          ; preds = %for.cond18.preheader.us.preheader, %for.cond18.for.inc36_crit_edge.us
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.cond18.for.inc36_crit_edge.us ], [ 0, %for.cond18.preheader.us.preheader ]
  %arrayidx22.us = getelementptr inbounds double, double* %x2, i64 %indvars.iv31
  %.pre46 = load double, double* %arrayidx22.us, align 8
  %sunkaddr5 = mul i64 %indvars.iv31, 8
...
for.inc33.us:                                     ; preds = %for.cond18.preheader.us, %for.inc33.us
  %5 = phi double [ %add30.us.1, %for.inc33.us ], [ %.pre46, %for.cond18.preheader.us ]
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %for.inc33.us ], [ 0, %for.cond18.preheader.us ]
  %arrayidx26.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv, i64 %indvars.iv31
  ...
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx26.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv.next, i64 %indvars.iv31
...
for.cond18.for.inc36_crit_edge.us:                ; preds = %for.inc33.us
  %indvars.iv.next32 = add nuw nsw i64 %indvars.iv31, 1
  %exitcond44 = icmp eq i64 %indvars.iv.next32, 2000
  br i1 %exitcond44, label %for.end38, label %for.cond18.preheader.us
...
for.body:                                         ; preds = %for.inc, %entry
  %indvars.iv16 = phi i64 [ 0, %entry ], [ %indvars.iv.next17, %for.inc ]
...
for.inc:                                          ; preds = %for.body, %if.then
  ...
  %arrayidx = getelementptr inbounds double, double* %x1, i64 %indvars.iv16
...
for.inc18:                                        ; preds = %for.body9, %if.then12
  ...
  %exitcond20 = icmp eq i64 %indvars.iv.next, 2000
  br i1 %exitcond20, label %for.end20, label %for.body9
