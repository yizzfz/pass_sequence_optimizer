...
.lr.ph.us:                                        ; preds = %..loopexit_crit_edge.us..lr.ph.us_crit_edge, %.lr.ph4
  ...
  %14 = getelementptr inbounds double, double* %1, i64 %indvars.iv5
  store double %13, double* %14, align 8
  %15 = add nuw nsw i64 %indvars.iv5, 3
  %16 = trunc i64 %15 to i32
  %17 = srem i32 %16, 2000
  %18 = sitofp i32 %17 to double
  %19 = getelementptr inbounds double, double* %2, i64 %indvars.iv5
  %20 = add nuw nsw i64 %indvars.iv5, 4
...
; <label>:30:                                     ; preds = %._crit_edge1, %.lr.ph.us
  %indvars.iv = phi i64 [ 0, %.lr.ph.us ], [ %indvars.iv.next.1, %._crit_edge1 ]
  %31 = mul nuw nsw i64 %indvars.iv, %indvars.iv5
  %32 = trunc i64 %31 to i32
  %33 = srem i32 %32, 2000
  %34 = sitofp i32 %33 to double
  %35 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 %indvars.iv5, i64 %indvars.iv
  %indvars.iv.next = or i64 %indvars.iv, 1
  %36 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv5
  ...
  br i1 %exitcond.1, label %..loopexit_crit_edge.us, label %._crit_edge1

._crit_edge1:                                     ; preds = %30
  br label %30

..loopexit_crit_edge.us:                          ; preds = %30
  %44 = icmp eq i64 %indvars.iv.next6, 2000
  br i1 %44, label %._crit_edge, label %..loopexit_crit_edge.us..lr.ph.us_crit_edge
...
.preheader4.us:                                   ; preds = %._crit_edge10.us..preheader4.us_crit_edge, %.preheader4.us.preheader
  %indvars.iv17 = phi i64 [ 0, %.preheader4.us.preheader ], [ %indvars.iv.next18, %._crit_edge10.us..preheader4.us_crit_edge ]
  %5 = getelementptr inbounds double, double* %0, i64 %indvars.iv17
  %.pre = load double, double* %5, align 8
  %sunkaddr1 = mul nuw nsw i64 %indvars.iv17, 8
...
; <label>:6:                                      ; preds = %._crit_edge, %.preheader4.us
  ...
  %indvars.iv14 = phi i64 [ 0, %.preheader4.us ], [ %indvars.iv.next15.1, %._crit_edge ]
  %8 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 %indvars.iv17, i64 %indvars.iv14
  %9 = load double, double* %8, align 8
  %10 = getelementptr inbounds double, double* %2, i64 %indvars.iv14
  %11 = load double, double* %10, align 8
  %12 = fmul double %9, %11
  %13 = fadd double %7, %12
  store double %13, double* %sunkaddr3, align 8
  %indvars.iv.next15 = or i64 %indvars.iv14, 1
  %14 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 %indvars.iv17, i64 %indvars.iv.next15
  %15 = load double, double* %14, align 8
  %16 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next15
  ...
  br i1 %exitcond16.1, label %._crit_edge10.us, label %._crit_edge
...
._crit_edge10.us:                                 ; preds = %6
  ...
  br i1 %exitcond19, label %.preheader.us.preheader, label %._crit_edge10.us..preheader4.us_crit_edge
...
.preheader.us:                                    ; preds = %._crit_edge.us..preheader.us_crit_edge, %.preheader.us.preheader
  ...
  %.pre20 = load double, double* %20, align 8
  %sunkaddr5 = mul nuw nsw i64 %indvars.iv12, 8
  %sunkaddr6 = add i64 %sunkaddr4, %sunkaddr5
  %sunkaddr7 = inttoptr i64 %sunkaddr6 to double*
  br label %21

; <label>:21:                                     ; preds = %._crit_edge8, %.preheader.us
  %22 = phi double [ %.pre20, %.preheader.us ], [ %34, %._crit_edge8 ]
  %indvars.iv = phi i64 [ 0, %.preheader.us ], [ %indvars.iv.next.1, %._crit_edge8 ]
  ...
  store double %28, double* %sunkaddr7, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %34, double* %sunkaddr7, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %._crit_edge.us, label %._crit_edge8

._crit_edge8:                                     ; preds = %21
  br label %21
...
; <label>:11:                                     ; preds = %.lr.ph7._crit_edge, %9
  ...
  br i1 %exitcond11, label %.lr.ph.preheader, label %..lr.ph7_crit_edge
