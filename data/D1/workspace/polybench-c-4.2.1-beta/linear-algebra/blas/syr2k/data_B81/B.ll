...
; Function Attrs: noinline nounwind uwtable
define internal fastcc void @init_array(i32, i32, double*, double*, [1200 x double]*, [1000 x double]*, [1000 x double]*) unnamed_addr #0 {
...
; Function Attrs: noinline nounwind uwtable
define internal fastcc void @kernel_syr2k(i32, i32, double, double, [1200 x double]*, [1000 x double]*, [1000 x double]*) unnamed_addr #0 {
  %8 = icmp sgt i32 %0, 0
...
.preheader.us16.preheader:                        ; preds = %.preheader.us16.preheader.loopexit, %middle.block110, %.prol.loopexit
  %min.iters.check68 = icmp ult i64 %75, 2
  %n.vec71 = and i64 %75, -2
  %cmp.zero72 = icmp eq i64 %n.vec71, 0
  %cmp.n103 = icmp eq i64 %75, %n.vec71
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %._crit_edge10.us
  %indvars.iv138 = phi i2 [ 1, %.lr.ph.us.preheader ], [ %indvars.iv.next139, %._crit_edge10.us ]
  ...
  %72 = add nsw i64 %indvars.iv38, -3
  %scevgep = getelementptr [1200 x double], [1200 x double]* %4, i64 %indvars.iv38, i64 0
  %73 = mul i64 %indvars.iv38, 1201
  %74 = add i64 %73, 1
  %scevgep75 = getelementptr [1200 x double], [1200 x double]* %4, i64 0, i64 %74
  %75 = add nuw nsw i64 %indvars.iv38, 1
...
.lr.ph.us.new.preheader:                          ; preds = %.prol.loopexit
  ...
  %min.iters.check112 = icmp ult i64 %83, 2
...
min.iters.checked113:                             ; preds = %.lr.ph.us.new.preheader
  %n.mod.vf114 = and i64 %83, 1
  %n.vec115 = sub nsw i64 %83, %n.mod.vf114
  %cmp.zero116 = icmp eq i64 %n.vec115, 0
  %84 = add nsw i64 %indvars.iv.unr, 4
  %85 = shl nuw i64 %82, 2
  %86 = add i64 %84, %85
  %87 = shl nuw nsw i64 %n.mod.vf114, 2
  %ind.end121 = sub i64 %86, %87
...
vector.body109:                                   ; preds = %vector.body109, %vector.ph117
  ...
  %wide.vec127 = load <8 x double>, <8 x double>* %91, align 8
  ...
  %92 = fmul <2 x double> %strided.vec128, %broadcast.splat133
  %93 = fmul <2 x double> %strided.vec129, %broadcast.splat133
  %94 = fmul <2 x double> %strided.vec130, %broadcast.splat133
  %95 = add nsw i64 %89, 3
  %96 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv38, i64 %95
  %97 = fmul <2 x double> %strided.vec131, %broadcast.splat133
  ...
  %interleaved.vec134 = shufflevector <4 x double> %100, <4 x double> %101, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 1, i32 3, i32 5, i32 7>
  store <8 x double> %interleaved.vec134, <8 x double>* %99, align 8
  %index.next119 = add i64 %index118, 2
  %102 = icmp eq i64 %index.next119, %n.vec115
  br i1 %102, label %middle.block110, label %vector.body109, !llvm.loop !21
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.preheader4
  %indvars.iv140 = phi i2 [ 1, %.lr.ph.preheader ], [ %indvars.iv.next141, %.preheader4 ]
  ...
  %103 = zext i2 %indvars.iv140 to i64
  %104 = add nuw nsw i64 %103, 4294967295
  %105 = and i64 %104, 4294967295
  %106 = add nuw nsw i64 %105, 1
  %107 = add nsw i64 %indvars.iv54, -3
...
.prol.loopexit48:                                 ; preds = %.prol.loopexit48.loopexit, %.lr.ph
  %indvars.iv42.unr = phi i64 [ 0, %.lr.ph ], [ %106, %.prol.loopexit48.loopexit ]
...
.lr.ph.new.preheader:                             ; preds = %.prol.loopexit48
  %113 = sub i64 %107, %indvars.iv42.unr
  %114 = lshr i64 %113, 2
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %124 = fmul <2 x double> %strided.vec, %broadcast.splat64
  %125 = fmul <2 x double> %strided.vec60, %broadcast.splat64
  %126 = fmul <2 x double> %strided.vec61, %broadcast.splat64
  %127 = add nsw i64 %121, 3
  %128 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv54, i64 %127
  %129 = fmul <2 x double> %strided.vec62, %broadcast.splat64
