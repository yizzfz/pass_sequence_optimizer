...
for.cond1.preheader.us:                           ; preds = %entry, %for.cond1.for.inc7_crit_edge.us
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.cond1.for.inc7_crit_edge.us ], [ 0, %entry ]
...
for.cond1.for.inc7_crit_edge.us:                  ; preds = %for.body3.us
  ...
  br i1 %exitcond45, label %for.cond14.preheader.us.preheader, label %for.cond1.preheader.us
...
for.cond14.for.inc31_crit_edge.us:                ; preds = %for.body17.us
  ...
  br i1 %exitcond34, label %for.cond38.preheader.us.preheader, label %for.cond14.preheader.us
...
vector.ph:                                        ; preds = %for.cond9.preheader.us.us
  %.pre = load double, double* %arrayidx15.us.us, align 8, !alias.scope !1
  %6 = insertelement <2 x double> undef, double %.pre, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %9 = shl i64 %index, 1
  %10 = getelementptr inbounds [1100 x double], [1100 x double]* %B, i64 %indvars.iv37, i64 %9
  ...
  %12 = fmul <2 x double> %8, %strided.vec
  %13 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv41, i64 %9
  ...
  %16 = or i64 %9, 1
  %17 = fmul <2 x double> %8, %strided.vec18
  %18 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv41, i64 %16
...
middle.block:                                     ; preds = %vector.body
  br i1 true, label %for.cond9.for.inc29_crit_edge.us.us, label %middle.block.for.body11.us.us_crit_edge

middle.block.for.body11.us.us_crit_edge:          ; preds = %middle.block
  br label %for.body11.us.us.preheader

for.body11.us.us.preheader:                       ; preds = %for.cond9.preheader.us.us, %middle.block.for.body11.us.us_crit_edge
...
for.cond9.for.inc29_crit_edge.us.us:              ; preds = %for.cond9.for.inc29_crit_edge.us.us.loopexit, %middle.block
  ...
  br i1 %exitcond40, label %for.inc32.us, label %for.cond9.preheader.us.us
...
for.body3.us.1:                                   ; preds = %for.body3.us
  ...
  %mul.us.1 = fmul <2 x double> %30, %mul.us.v.i1.2.1
  ...
  %mul.us.2.1 = fmul <2 x double> %32, %mul.us.v.i1.2.1
