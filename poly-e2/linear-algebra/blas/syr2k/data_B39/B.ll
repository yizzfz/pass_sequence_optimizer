...
for.cond1.preheader.us:                           ; preds = %for.inc17.us, %for.cond1.preheader.us.preheader
  %indvars.iv25 = phi i64 [ 0, %for.cond1.preheader.us.preheader ], [ %indvars.iv.next26, %for.inc17.us ]
...
for.cond24.preheader.us:                          ; preds = %for.inc41.us, %for.cond24.preheader.lr.ph
  %indvars.iv14 = phi i64 [ 0, %for.cond24.preheader.lr.ph ], [ %indvars.iv.next15, %for.inc41.us ]
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc void @kernel_syr2k(i32 %n, i32 %m, double %alpha, double %beta, [1200 x double]* %C, [1000 x double]* readonly %A, [1000 x double]* readonly %B) unnamed_addr #2 {
entry:
  %cmp8 = icmp sgt i32 %n, 0
...
for.body3.lr.ph.us.preheader:                     ; preds = %for.cond1.preheader.lr.ph
  ...
  %broadcast.splatinsert119 = insertelement <2 x double> undef, double %alpha, i32 0
  %broadcast.splat120 = shufflevector <2 x double> %broadcast.splatinsert119, <2 x double> undef, <2 x i32> zeroinitializer
  %broadcast.splatinsert144 = insertelement <2 x double> undef, double %beta, i32 0
  %broadcast.splat145 = shufflevector <2 x double> %broadcast.splatinsert144, <2 x double> undef, <2 x i32> zeroinitializer
  br label %for.body3.lr.ph.us

for.body3.lr.ph.us:                               ; preds = %for.inc43.us.for.body3.lr.ph.us_crit_edge, %for.body3.lr.ph.us.preheader
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc43.us.for.body3.lr.ph.us_crit_edge ], [ 0, %for.body3.lr.ph.us.preheader ]
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc43.us.for.body3.lr.ph.us_crit_edge ], [ 1, %for.body3.lr.ph.us.preheader ]
  %0 = add i64 %indvars.iv52, -3
  %scevgep = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv52, i64 0
  %1 = mul i64 %indvars.iv52, 1201
  %2 = add i64 %1, 1
  %scevgep87 = getelementptr [1200 x double], [1200 x double]* %C, i64 0, i64 %2
  %3 = add i64 %indvars.iv52, 1
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1
  %4 = trunc i64 %indvars.iv.next53 to i32
...
for.body3.us.prol.loopexit:                       ; preds = %for.body3.us.prol.loopexit.loopexit, %for.body3.lr.ph.us
  ...
  %6 = icmp ult i64 %indvars.iv52, 3
  br i1 %6, label %for.cond9.preheader.us10.preheader, label %for.body3.us.preheader

for.body3.us.preheader:                           ; preds = %for.body3.us.prol.loopexit
  %7 = sub i64 %0, %indvars.iv.unr
  %8 = lshr i64 %7, 2
  %9 = add nuw nsw i64 %8, 1
  %min.iters.check124 = icmp ult i64 %9, 2
  br i1 %min.iters.check124, label %for.body3.us.preheader147, label %min.iters.checked125

min.iters.checked125:                             ; preds = %for.body3.us.preheader
  %n.mod.vf126 = and i64 %9, 1
  %n.vec127 = sub nsw i64 %9, %n.mod.vf126
  %cmp.zero128 = icmp eq i64 %n.vec127, 0
  %10 = add i64 %indvars.iv.unr, 4
  %11 = shl nuw i64 %8, 2
  %12 = add i64 %10, %11
  %13 = shl nuw nsw i64 %n.mod.vf126, 2
  %ind.end133 = sub i64 %12, %13
  br i1 %cmp.zero128, label %for.body3.us.preheader147, label %vector.ph129
...
vector.body121:                                   ; preds = %vector.body121, %vector.ph129
  ...
  %14 = shl i64 %index130, 2
  %15 = add i64 %indvars.iv.unr, %14
  %16 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv52, i64 %15
  %17 = bitcast double* %16 to <8 x double>*
  %wide.vec139 = load <8 x double>, <8 x double>* %17, align 8
  %strided.vec140 = shufflevector <8 x double> %wide.vec139, <8 x double> undef, <2 x i32> <i32 0, i32 4>
  %strided.vec141 = shufflevector <8 x double> %wide.vec139, <8 x double> undef, <2 x i32> <i32 1, i32 5>
  %strided.vec142 = shufflevector <8 x double> %wide.vec139, <8 x double> undef, <2 x i32> <i32 2, i32 6>
  %strided.vec143 = shufflevector <8 x double> %wide.vec139, <8 x double> undef, <2 x i32> <i32 3, i32 7>
  %18 = fmul <2 x double> %strided.vec140, %broadcast.splat145
  %19 = fmul <2 x double> %strided.vec141, %broadcast.splat145
  %20 = fmul <2 x double> %strided.vec142, %broadcast.splat145
  %21 = add nsw i64 %15, 3
  %22 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv52, i64 %21
  %23 = fmul <2 x double> %strided.vec143, %broadcast.splat145
  ...
  %interleaved.vec146 = shufflevector <4 x double> %26, <4 x double> %27, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 1, i32 3, i32 5, i32 7>
  store <8 x double> %interleaved.vec146, <8 x double>* %25, align 8
  %index.next131 = add i64 %index130, 2
  %28 = icmp eq i64 %index.next131, %n.vec127
  br i1 %28, label %middle.block122, label %vector.body121, !llvm.loop !3

middle.block122:                                  ; preds = %vector.body121
  %cmp.n134 = icmp eq i64 %n.mod.vf126, 0
  br i1 %cmp.n134, label %for.cond9.preheader.us10.preheader, label %for.body3.us.preheader147

for.body3.us.preheader147:                        ; preds = %middle.block122, %min.iters.checked125, %for.body3.us.preheader
  %indvars.iv.ph = phi i64 [ %ind.end133, %middle.block122 ], [ %indvars.iv.unr, %min.iters.checked125 ], [ %indvars.iv.unr, %for.body3.us.preheader ]
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us.preheader147, %for.body3.us
  %indvars.iv = phi i64 [ %indvars.iv.next.3, %for.body3.us ], [ %indvars.iv.ph, %for.body3.us.preheader147 ]
  ...
  br i1 %exitcond.3, label %for.cond9.preheader.us10.preheader.loopexit, label %for.body3.us, !llvm.loop !6

for.cond9.preheader.us10.preheader.loopexit:      ; preds = %for.body3.us
  br label %for.cond9.preheader.us10.preheader

for.cond9.preheader.us10.preheader:               ; preds = %for.cond9.preheader.us10.preheader.loopexit, %middle.block122, %for.body3.us.prol.loopexit
  %min.iters.check80 = icmp ult i64 %3, 2
  %n.vec83 = and i64 %3, -2
  %cmp.zero84 = icmp eq i64 %n.vec83, 0
  %cmp.n115 = icmp eq i64 %3, %n.vec83
  br label %for.cond9.preheader.us10

for.cond9.preheader.us10:                         ; preds = %for.cond9.preheader.us10.preheader, %for.inc40.us31
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc40.us31 ], [ 0, %for.cond9.preheader.us10.preheader ]
  %scevgep89 = getelementptr [1000 x double], [1000 x double]* %A, i64 0, i64 %indvars.iv45
  %33 = add i64 %indvars.iv45, 1
  %scevgep91 = getelementptr [1000 x double], [1000 x double]* %A, i64 %indvars.iv52, i64 %33
  %scevgep93 = getelementptr [1000 x double], [1000 x double]* %B, i64 0, i64 %indvars.iv45
  %scevgep95 = getelementptr [1000 x double], [1000 x double]* %B, i64 %indvars.iv52, i64 %33
  %arrayidx20.us14 = getelementptr inbounds [1000 x double], [1000 x double]* %B, i64 %indvars.iv52, i64 %indvars.iv45
  %arrayidx30.us15 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv52, i64 %indvars.iv45
  br i1 %min.iters.check80, label %for.body11.us16.preheader, label %min.iters.checked81

min.iters.checked81:                              ; preds = %for.cond9.preheader.us10
  br i1 %cmp.zero84, label %for.body11.us16.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked81
  %bound0 = icmp ult double* %scevgep, %arrayidx30.us15
  %bound1 = icmp ult double* %arrayidx30.us15, %scevgep87
  ...
  %bound0107 = icmp ult double* %scevgep, %arrayidx20.us14
  %bound1108 = icmp ult double* %arrayidx20.us14, %scevgep87
  %found.conflict109 = and i1 %bound0107, %bound1108
  %conflict.rdx110 = or i1 %conflict.rdx104, %found.conflict109
  br i1 %conflict.rdx110, label %for.body11.us16.preheader, label %vector.ph111

vector.ph111:                                     ; preds = %vector.memcheck
  %34 = load double, double* %arrayidx20.us14, align 8, !alias.scope !8
  %35 = insertelement <2 x double> undef, double %34, i32 0
  %36 = shufflevector <2 x double> %35, <2 x double> undef, <2 x i32> zeroinitializer
  %37 = load double, double* %arrayidx30.us15, align 8, !alias.scope !11
...
vector.body77:                                    ; preds = %vector.body77, %vector.ph111
  %index112 = phi i64 [ 0, %vector.ph111 ], [ %index.next113, %vector.body77 ]
  %40 = or i64 %index112, 1
  %41 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %index112, i64 %indvars.iv45
  %42 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %40, i64 %indvars.iv45
  ...
  %47 = fmul <2 x double> %46, %broadcast.splat120
  %48 = fmul <2 x double> %47, %36
  %49 = getelementptr inbounds [1000 x double], [1000 x double]* %B, i64 %index112, i64 %indvars.iv45
  %50 = getelementptr inbounds [1000 x double], [1000 x double]* %B, i64 %40, i64 %indvars.iv45
  ...
  %55 = fmul <2 x double> %54, %broadcast.splat120
  %56 = fmul <2 x double> %55, %39
  %57 = fadd <2 x double> %48, %56
  %58 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv52, i64 %index112
  ...
  %62 = icmp eq i64 %index.next113, %n.vec83
  br i1 %62, label %middle.block78, label %vector.body77, !llvm.loop !20

middle.block78:                                   ; preds = %vector.body77
  br i1 %cmp.n115, label %for.inc40.us31, label %for.body11.us16.preheader

for.body11.us16.preheader:                        ; preds = %middle.block78, %vector.memcheck, %min.iters.checked81, %for.cond9.preheader.us10
  %indvars.iv40.ph = phi i64 [ %n.vec83, %middle.block78 ], [ 0, %vector.memcheck ], [ 0, %min.iters.checked81 ], [ 0, %for.cond9.preheader.us10 ]
  br label %for.body11.us16

for.body11.us16:                                  ; preds = %for.body11.us16.preheader, %for.body11.us16
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.body11.us16 ], [ %indvars.iv40.ph, %for.body11.us16.preheader ]
  %arrayidx15.us19 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv40, i64 %indvars.iv45
  %63 = load double, double* %arrayidx15.us19, align 8
  %mul16.us20 = fmul double %63, %alpha
  %64 = load double, double* %arrayidx20.us14, align 8
  %mul21.us21 = fmul double %mul16.us20, %64
  %arrayidx25.us22 = getelementptr inbounds [1000 x double], [1000 x double]* %B, i64 %indvars.iv40, i64 %indvars.iv45
  %65 = load double, double* %arrayidx25.us22, align 8
  %mul26.us23 = fmul double %65, %alpha
  %66 = load double, double* %arrayidx30.us15, align 8
  %mul31.us24 = fmul double %mul26.us23, %66
  %add.us25 = fadd double %mul21.us21, %mul31.us24
  %arrayidx35.us26 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv52, i64 %indvars.iv40
  %67 = load double, double* %arrayidx35.us26, align 8
  %add36.us27 = fadd double %67, %add.us25
  store double %add36.us27, double* %arrayidx35.us26, align 8
  %indvars.iv.next41 = add nuw nsw i64 %indvars.iv40, 1
  %exitcond = icmp eq i64 %indvars.iv.next41, %indvars.iv50
  br i1 %exitcond, label %for.inc40.us31.loopexit, label %for.body11.us16, !llvm.loop !21

for.inc40.us31.loopexit:                          ; preds = %for.body11.us16
  br label %for.inc40.us31

for.inc40.us31:                                   ; preds = %for.inc40.us31.loopexit, %middle.block78
  %indvars.iv.next46 = add nuw nsw i64 %indvars.iv45, 1
  %exitcond48 = icmp eq i64 %indvars.iv.next46, %wide.trip.count47
  br i1 %exitcond48, label %for.inc43.us, label %for.cond9.preheader.us10

for.inc43.us:                                     ; preds = %for.inc40.us31
  %exitcond55 = icmp eq i64 %indvars.iv.next53, %wide.trip.count54
  br i1 %exitcond55, label %for.end45.loopexit, label %for.inc43.us.for.body3.lr.ph.us_crit_edge

for.inc43.us.for.body3.lr.ph.us_crit_edge:        ; preds = %for.inc43.us
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1
  br label %for.body3.lr.ph.us

for.body3.lr.ph:                                  ; preds = %for.inc43.for.body3.lr.ph_crit_edge, %for.body3.lr.ph.preheader
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc43.for.body3.lr.ph_crit_edge ], [ 0, %for.body3.lr.ph.preheader ]
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc43.for.body3.lr.ph_crit_edge ], [ 1, %for.body3.lr.ph.preheader ]
  %68 = add i64 %indvars.iv66, -3
  %indvars.iv.next67 = add nuw nsw i64 %indvars.iv66, 1
  %69 = trunc i64 %indvars.iv.next67 to i32
  %xtraiter61 = and i32 %69, 3
...
for.body3.prol.loopexit:                          ; preds = %for.body3.prol.loopexit.loopexit, %for.body3.lr.ph
  %indvars.iv56.unr = phi i64 [ 0, %for.body3.lr.ph ], [ %indvars.iv.next57.prol, %for.body3.prol.loopexit.loopexit ]
  %71 = icmp ult i64 %indvars.iv66, 3
  br i1 %71, label %for.inc43, label %for.body3.preheader

for.body3.preheader:                              ; preds = %for.body3.prol.loopexit
  %72 = sub i64 %68, %indvars.iv56.unr
  %73 = lshr i64 %72, 2
  %74 = add nuw nsw i64 %73, 1
  %min.iters.check = icmp ult i64 %74, 2
  br i1 %min.iters.check, label %for.body3.preheader148, label %min.iters.checked

min.iters.checked:                                ; preds = %for.body3.preheader
  %n.mod.vf = and i64 %74, 1
  %n.vec = sub nsw i64 %74, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  %75 = add i64 %indvars.iv56.unr, 4
  %76 = shl nuw i64 %73, 2
  %77 = add i64 %75, %76
  %78 = shl nuw nsw i64 %n.mod.vf, 2
  %ind.end = sub i64 %77, %78
  br i1 %cmp.zero, label %for.body3.preheader148, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %79 = shl i64 %index, 2
  %80 = add i64 %indvars.iv56.unr, %79
  %81 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv66, i64 %80
  ...
  %83 = fmul <2 x double> %strided.vec, %broadcast.splat76
  %84 = fmul <2 x double> %strided.vec72, %broadcast.splat76
  %85 = fmul <2 x double> %strided.vec73, %broadcast.splat76
  %86 = add nsw i64 %80, 3
  %87 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv66, i64 %86
  %88 = fmul <2 x double> %strided.vec74, %broadcast.splat76
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.inc43, label %for.body3.preheader148

for.body3.preheader148:                           ; preds = %middle.block, %min.iters.checked, %for.body3.preheader
  %indvars.iv56.ph = phi i64 [ %ind.end, %middle.block ], [ %indvars.iv56.unr, %min.iters.checked ], [ %indvars.iv56.unr, %for.body3.preheader ]
  br label %for.body3

for.body3:                                        ; preds = %for.body3.preheader148, %for.body3
  %indvars.iv56 = phi i64 [ %indvars.iv.next57.3, %for.body3 ], [ %indvars.iv56.ph, %for.body3.preheader148 ]
...
for.inc43:                                        ; preds = %for.inc43.loopexit, %middle.block, %for.body3.prol.loopexit
  ...
  br i1 %exitcond69, label %for.end45.loopexit149, label %for.inc43.for.body3.lr.ph_crit_edge
...
for.end45.loopexit149:                            ; preds = %for.inc43
  br label %for.end45

for.end45:                                        ; preds = %for.end45.loopexit149, %for.end45.loopexit, %entry
  ret void
}
