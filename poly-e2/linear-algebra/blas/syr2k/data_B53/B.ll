...
for.cond9.preheader.us12.preheader:               ; preds = %for.cond9.preheader.us12.preheader.loopexit, %middle.block125, %for.body3.us.prol.loopexit
  %min.iters.check83 = icmp ult i64 %42, 2
  %n.vec86 = and i64 %42, -2
  %cmp.zero87 = icmp eq i64 %n.vec86, 0
  %cmp.n118 = icmp eq i64 %42, %n.vec86
...
for.cond9.preheader.us12:                         ; preds = %for.cond9.preheader.us12.preheader, %for.cond9.for.inc40_crit_edge.us35
  ...
  %scevgep94 = getelementptr [1000 x double], [1000 x double]* %A, i64 %indvars.iv54, i64 %4
  %scevgep96 = getelementptr [1000 x double], [1000 x double]* %B, i64 0, i64 %indvars.iv47
  %scevgep98 = getelementptr [1000 x double], [1000 x double]* %B, i64 %indvars.iv54, i64 %4
  ...
  br i1 %min.iters.check83, label %for.body11.us14.preheader, label %min.iters.checked84

min.iters.checked84:                              ; preds = %for.cond9.preheader.us12
  br i1 %cmp.zero87, label %for.body11.us14.preheader, label %vector.memcheck
...
vector.memcheck:                                  ; preds = %min.iters.checked84
  ...
  br i1 %conflict.rdx113, label %for.body11.us14.preheader, label %vector.ph114
...
vector.body80:                                    ; preds = %vector.body80, %vector.ph114
  ...
  %11 = or i64 %index115, 1
  %12 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %index115, i64 %indvars.iv47
  %13 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %11, i64 %indvars.iv47
  ...
  %18 = fmul <2 x double> %17, %broadcast.splat123
  %19 = fmul <2 x double> %18, %7
  %20 = getelementptr inbounds [1000 x double], [1000 x double]* %B, i64 %index115, i64 %indvars.iv47
  %21 = getelementptr inbounds [1000 x double], [1000 x double]* %B, i64 %11, i64 %indvars.iv47
  ...
  %26 = fmul <2 x double> %25, %broadcast.splat123
  %27 = fmul <2 x double> %26, %10
  %28 = fadd <2 x double> %19, %27
  %29 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv54, i64 %index115
  ...
  %33 = icmp eq i64 %index.next116, %n.vec86
  br i1 %33, label %middle.block81, label %vector.body80, !llvm.loop !17

middle.block81:                                   ; preds = %vector.body80
  br i1 %cmp.n118, label %for.cond9.for.inc40_crit_edge.us35, label %for.body11.us14.preheader

for.body11.us14.preheader:                        ; preds = %middle.block81, %vector.memcheck, %min.iters.checked84, %for.cond9.preheader.us12
  %indvars.iv42.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %min.iters.checked84 ], [ 0, %for.cond9.preheader.us12 ], [ %n.vec86, %middle.block81 ]
...
for.body3.lr.ph.us:                               ; preds = %for.body3.lr.ph.us.preheader, %for.cond6.for.inc43_crit_edge.us
  ...
  %41 = add i64 %40, 1
  %scevgep90 = getelementptr [1200 x double], [1200 x double]* %C, i64 0, i64 %41
...
for.body3.us.preheader:                           ; preds = %for.body3.us.prol.loopexit
  ...
  %min.iters.check127 = icmp ult i64 %48, 2
  br i1 %min.iters.check127, label %for.body3.us.preheader150, label %min.iters.checked128

for.body3.us.preheader150:                        ; preds = %middle.block125, %min.iters.checked128, %for.body3.us.preheader
  %indvars.iv.ph = phi i64 [ %indvars.iv.unr, %min.iters.checked128 ], [ %indvars.iv.unr, %for.body3.us.preheader ], [ %ind.end136, %middle.block125 ]
  br label %for.body3.us

min.iters.checked128:                             ; preds = %for.body3.us.preheader
  %n.mod.vf129 = and i64 %48, 1
  %n.vec130 = sub nsw i64 %48, %n.mod.vf129
  %cmp.zero131 = icmp eq i64 %n.vec130, 0
  %49 = add i64 %indvars.iv.unr, 4
  %50 = shl nuw i64 %47, 2
  %51 = add i64 %49, %50
  %52 = shl nuw nsw i64 %n.mod.vf129, 2
  %ind.end136 = sub i64 %51, %52
  br i1 %cmp.zero131, label %for.body3.us.preheader150, label %vector.ph132
...
vector.body124:                                   ; preds = %vector.body124, %vector.ph132
  ...
  %wide.vec142 = load <8 x double>, <8 x double>* %56, align 8
  ...
  %57 = fmul <2 x double> %strided.vec143, %broadcast.splat148
  %58 = fmul <2 x double> %strided.vec144, %broadcast.splat148
  %59 = fmul <2 x double> %strided.vec145, %broadcast.splat148
  %60 = add nsw i64 %54, 3
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv54, i64 %60
  %62 = fmul <2 x double> %strided.vec146, %broadcast.splat148
  ...
  %interleaved.vec149 = shufflevector <4 x double> %65, <4 x double> %66, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 1, i32 3, i32 5, i32 7>
  store <8 x double> %interleaved.vec149, <8 x double>* %64, align 8
  %index.next134 = add i64 %index133, 2
  %67 = icmp eq i64 %index.next134, %n.vec130
  br i1 %67, label %middle.block125, label %vector.body124, !llvm.loop !21

middle.block125:                                  ; preds = %vector.body124
  %cmp.n137 = icmp eq i64 %n.mod.vf129, 0
  br i1 %cmp.n137, label %for.cond9.preheader.us12.preheader, label %for.body3.us.preheader150
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %83 = fmul <2 x double> %strided.vec, %broadcast.splat79
  %84 = fmul <2 x double> %strided.vec75, %broadcast.splat79
  %85 = fmul <2 x double> %strided.vec76, %broadcast.splat79
  %86 = add nsw i64 %80, 3
  %87 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv68, i64 %86
  %88 = fmul <2 x double> %strided.vec77, %broadcast.splat79
