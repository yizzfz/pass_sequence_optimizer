...
for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.cond4.for.inc37_crit_edge.us
  ...
  %4 = add nuw nsw i64 %indvar55, 2
  %scevgep63 = getelementptr [1300 x double], [1300 x double]* %A, i64 %4, i64 %wide.trip.count20
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %5 = add nsw i64 %indvars.iv12, -1
  br i1 %2, label %for.inc.us.preheader, label %min.iters.checked50

min.iters.checked50:                              ; preds = %for.cond4.preheader.us
  %6 = icmp eq i64 %n.vec52, 0
  br i1 %6, label %for.inc.us.preheader, label %vector.memcheck69
...
vector.body46:                                    ; preds = %vector.body46.preheader, %vector.body46
  ...
  %31 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %5, i64 %offset.idx76
...
middle.block47:                                   ; preds = %vector.body46
  %44 = icmp eq i64 %0, %n.vec52
  br i1 %44, label %for.cond4.for.inc37_crit_edge.us, label %for.inc.us.preheader
...
for.inc.us:                                       ; preds = %for.inc.us.preheader, %for.inc.us
  ...
  %arrayidx14.us = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv12, i64 %46
...
for.cond44.preheader.us:                          ; preds = %for.cond44.preheader.us.preheader, %for.cond44.for.inc84_crit_edge.us
  ...
  %scevgep30 = getelementptr [1300 x double], [1300 x double]* %A, i64 %53, i64 %wide.trip.count20
  %scevgep32 = getelementptr [1300 x double], [1300 x double]* %B, i64 %indvar, i64 1
  %54 = add nuw nsw i64 %indvar, 2
  %scevgep34 = getelementptr [1300 x double], [1300 x double]* %B, i64 %54, i64 %wide.trip.count20
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  %55 = add nsw i64 %indvars.iv22, -1
  br i1 %52, label %for.inc81.us.preheader, label %min.iters.checked

min.iters.checked:                                ; preds = %for.cond44.preheader.us
  %56 = icmp eq i64 %n.vec, 0
  br i1 %56, label %for.inc81.us.preheader, label %vector.memcheck
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %57 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv22, i64 %offset.idx
  %58 = bitcast double* %57 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %58, align 8, !alias.scope !10
  %59 = getelementptr double, double* %57, i64 2
  %60 = bitcast double* %59 to <2 x double>*
  %wide.load37 = load <2 x double>, <2 x double>* %60, align 8, !alias.scope !10
  %61 = add nsw i64 %offset.idx, -1
  %62 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv22, i64 %61
  %63 = bitcast double* %62 to <2 x double>*
  %wide.load38 = load <2 x double>, <2 x double>* %63, align 8, !alias.scope !10
  %64 = getelementptr double, double* %62, i64 2
  %65 = bitcast double* %64 to <2 x double>*
  %wide.load39 = load <2 x double>, <2 x double>* %65, align 8, !alias.scope !10
  %66 = fadd <2 x double> %wide.load, %wide.load38
  %67 = fadd <2 x double> %wide.load37, %wide.load39
  %68 = add nuw nsw i64 %offset.idx, 1
  %69 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv22, i64 %68
  ...
  %73 = fadd <2 x double> %66, %wide.load40
  %74 = fadd <2 x double> %67, %wide.load41
  %75 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv.next23, i64 %offset.idx
  ...
  %wide.load45 = load <2 x double>, <2 x double>* %84, align 8, !alias.scope !10
  %85 = fadd <2 x double> %79, %wide.load44
  %86 = fadd <2 x double> %80, %wide.load45
  ...
  %89 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv22, i64 %offset.idx
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %94, label %for.cond44.for.inc84_crit_edge.us, label %for.inc81.us.preheader
...
for.inc81.us:                                     ; preds = %for.inc81.us.preheader, %for.inc81.us
  ...
  %arrayidx56.us = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv22, i64 %96
  ...
  %arrayidx74.us = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %55, i64 %indvars.iv17
