...
for.inc.us:                                       ; preds = %for.body.us, %for.inc.us
  ...
  %4 = mul nuw nsw i64 %indvars.iv12, %indvars.iv.next
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc20_crit_edge.us, %entry
  %indvars.iv63 = phi i64 [ 0, %entry ], [ %indvars.iv.next64, %for.cond1.for.inc20_crit_edge.us ]
  %sunkaddr1 = shl i64 %indvars.iv63, 3
...
for.inc.us:                                       ; preds = %for.cond1.preheader.us, %for.inc.us
  %indvars.iv59 = phi i64 [ %indvars.iv.next60.1, %for.inc.us ], [ 0, %for.cond1.preheader.us ]
...
for.cond1.for.inc20_crit_edge.us:                 ; preds = %for.inc.us
  ...
  %exitcond82 = icmp eq i64 %indvars.iv.next64, 2000
...
for.cond26.preheader.us:                          ; preds = %for.cond26.preheader.us.preheader, %for.cond26.for.inc45_crit_edge.us
  ...
  %sunkaddr9 = shl i64 %indvars.iv54, 3
...
for.cond26.for.inc45_crit_edge.us:                ; preds = %for.inc42.us
  ...
  br i1 %exitcond76, label %vector.memcheck, label %for.cond26.preheader.us
...
for.inc80.us:                                     ; preds = %for.cond64.preheader.us, %for.inc80.us
  ...
  %31 = phi double [ %add77.us.1, %for.inc80.us ], [ %.pre40, %for.cond64.preheader.us ]
...
for.inc58:                                        ; preds = %for.inc58.preheader, %for.inc58
  ...
  br i1 %exitcond49.3, label %for.cond64.preheader.us.preheader.loopexit, label %for.inc58, !llvm.loop !9
