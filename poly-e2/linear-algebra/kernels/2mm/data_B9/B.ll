...
for.cond59.preheader:                             ; preds = %for.cond59.preheader.loopexit, %for.end33.thread, %for.cond38.preheader.lr.ph, %for.end33
  %20 = phi i64 [ %8, %for.end33.thread ], [ %15, %for.cond38.preheader.lr.ph ], [ %15, %for.end33 ], [ %15, %for.cond59.preheader.loopexit ]
...
for.cond4.preheader.us:                           ; preds = %for.cond4.for.inc28_crit_edge.us, %for.cond4.preheader.us.preheader
  ...
  br i1 %4, label %for.body6.us.us.preheader, label %for.body6.us49.preheader
...
for.body6.us49.preheader:                         ; preds = %for.cond4.preheader.us
...
for.cond4.for.inc28_crit_edge.us:                 ; preds = %for.cond4.for.inc28_crit_edge.us.loopexit, %for.body6.us49.preheader
...
for.body36.us20.prol:                             ; preds = %for.body36.us20.prol.preheader, %for.body36.us20.prol
  ...
  %19 = load double, double* %arrayidx40.us22.prol, align 8
  %mul41.us23.prol = fmul double %19, %beta
...
for.body36.us20.prol.loopexit:                    ; preds = %for.body36.us20.prol.loopexit.loopexit, %for.body36.us20.preheader
  ...
  br i1 %16, label %for.cond34.for.inc65_crit_edge.us, label %for.body36.us20.preheader92

for.body36.us20.preheader92:                      ; preds = %for.body36.us20.prol.loopexit
  %20 = sub i64 %18, %indvars.iv114.us21.unr
  %21 = lshr i64 %20, 2
...
min.iters.checked:                                ; preds = %for.body36.us20.preheader92
  ...
  %23 = add i64 %indvars.iv114.us21.unr, 4
  %24 = shl nuw i64 %21, 2
  %25 = add i64 %23, %24
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %27 = shl i64 %index, 2
  %28 = add i64 %indvars.iv114.us21.unr, %27
  %29 = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv317.us, i64 %28
  %30 = bitcast double* %29 to <8 x double>*
  %wide.vec = load <8 x double>, <8 x double>* %30, align 8
  ...
  %31 = fmul <2 x double> %strided.vec, %broadcast.splat98
  %32 = fmul <2 x double> %strided.vec94, %broadcast.splat98
  %33 = fmul <2 x double> %strided.vec95, %broadcast.splat98
  %34 = add nsw i64 %28, 3
  %35 = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv317.us, i64 %34
  %36 = fmul <2 x double> %strided.vec96, %broadcast.splat98
...
for.body36.us20:                                  ; preds = %for.body36.us20.preheader99, %for.body36.us20
  ...
  %42 = load double, double* %arrayidx40.us22, align 8
  %mul41.us23 = fmul double %42, %beta
  ...
  %43 = load double, double* %arrayidx40.us22.1, align 8
  %mul41.us23.1 = fmul double %43, %beta
  ...
  %44 = load double, double* %arrayidx40.us22.2, align 8
  %mul41.us23.2 = fmul double %44, %beta
  ...
  %45 = load double, double* %arrayidx40.us22.3, align 8
  %mul41.us23.3 = fmul double %45, %beta
  store double %mul41.us23.3, double* %arrayidx40.us22.3, align 8
  %indvars.iv.next2.us26.3 = add nsw i64 %indvars.iv114.us21, 4
  %exitcond.3 = icmp eq i64 %indvars.iv.next2.us26.3, %14
...
for.body36.us.us:                                 ; preds = %for.body36.us.us.preheader, %for.cond42.for.inc62_crit_edge.us.us
  ...
  %46 = load double, double* %arrayidx40.us.us, align 8
  %mul41.us.us = fmul double %46, %beta
...
for.body44.us.us.prol:                            ; preds = %for.body36.us.us
  %47 = load double, double* %arrayidx48.us.us.prol, align 8
  %arrayidx52.us.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 0, i64 %indvars.iv114.us.us
  %48 = load double, double* %arrayidx52.us.us.prol, align 8
  %mul53.us.us.prol = fmul double %47, %48
...
for.body44.us.us.prol.loopexit:                   ; preds = %for.body36.us.us, %for.body44.us.us.prol
  ...
  br i1 %17, label %for.cond42.for.inc62_crit_edge.us.us, label %for.body44.us.us.preheader
...
for.body44.us.us:                                 ; preds = %for.body44.us.us.preheader, %for.body44.us.us
  ...
  %49 = phi double [ %add58.us.us.1, %for.body44.us.us ], [ %.unr.ph, %for.body44.us.us.preheader ]
  %arrayidx48.us.us = getelementptr inbounds [900 x double], [900 x double]* %tmp, i64 %indvars.iv317.us, i64 %indvars.iv12.us.us
  %50 = load double, double* %arrayidx48.us.us, align 8
  %arrayidx52.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv12.us.us, i64 %indvars.iv114.us.us
  %51 = load double, double* %arrayidx52.us.us, align 8
  %mul53.us.us = fmul double %50, %51
  %add58.us.us = fadd double %49, %mul53.us.us
