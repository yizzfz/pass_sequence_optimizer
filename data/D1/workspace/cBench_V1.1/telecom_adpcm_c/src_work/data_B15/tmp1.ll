...
; <label>:17:                                     ; preds = %40, %12
  ...
  %19 = call i64 @read(i32 0, i8* bitcast ([1000 x i16]* @sbuf to i8*), i64 2000)
...
; <label>:33:                                     ; preds = %29
  ...
  %36 = sdiv i32 %35, 2
  call void @adpcm_coder(i16* getelementptr inbounds ([1000 x i16], [1000 x i16]* @sbuf, i32 0, i32 0), i8* getelementptr inbounds ([500 x i8], [500 x i8]* @abuf, i32 0, i32 0), i32 %36, %struct.adpcm_state* @state)
  br label %37
...
; <label>:40:                                     ; preds = %29
  ...
  %44 = call i64 @write(i32 1, i8* getelementptr inbounds ([500 x i8], [500 x i8]* @abuf, i32 0, i32 0), i64 %43)
  br label %17
