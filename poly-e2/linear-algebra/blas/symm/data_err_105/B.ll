...
for.body.us:                                      ; preds = %for.cond1.for.end_crit_edge.us, %entry
  %indvars.iv36 = phi i64 [ 0, %entry ], [ %indvars.iv.next37, %for.cond1.for.end_crit_edge.us ]
  %0 = add nuw nsw i64 %indvars.iv36, 1200
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us, %for.body.us
  %indvars.iv31 = phi i64 [ 0, %for.body.us ], [ %indvars.iv.next32, %for.body3.us ]
  %1 = add nuw nsw i64 %indvars.iv36, %indvars.iv31
  %2 = trunc i64 %1 to i32
  %rem.us = srem i32 %2, 100
  %conv.us = sitofp i32 %rem.us to double
  %div.us = fdiv double %conv.us, 1.000000e+03
  %arrayidx6.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv36, i64 %indvars.iv31
  store double %div.us, double* %arrayidx6.us, align 8
  %3 = sub nuw nsw i64 %0, %indvars.iv31
  %4 = trunc i64 %3 to i32
  %rem8.us = srem i32 %4, 100
  %conv9.us = sitofp i32 %rem8.us to double
  %div11.us = fdiv double %conv9.us, 1.000000e+03
  %arrayidx15.us = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv36, i64 %indvars.iv31
...
for.cond1.for.end_crit_edge.us:                   ; preds = %for.body3.us
  ...
  %exitcond48 = icmp eq i64 %indvars.iv.next37, 1000
  br i1 %exitcond48, label %for.body26.lr.ph.preheader, label %for.body.us
...
for.body26.lr.ph:                                 ; preds = %for.body26.lr.ph.preheader, %for.inc51
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc51 ], [ 1, %for.body26.lr.ph.preheader ]
  %indvars.iv44 = phi i3 [ %indvars.iv.next45, %for.inc51 ], [ -1, %for.body26.lr.ph.preheader ]
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc51 ], [ 2, %for.body26.lr.ph.preheader ]
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc51 ], [ 0, %for.body26.lr.ph.preheader ]
  %indvar = phi i32 [ %11, %for.inc51 ], [ 0, %for.body26.lr.ph.preheader ]
  %5 = zext i3 %indvars.iv44 to i64
  %6 = add nuw nsw i64 %5, 4294967295
  %7 = and i64 %6, 4294967295
  %8 = add i64 %indvars.iv42, %7
  %9 = sub nuw nsw i32 1007, %indvar
...
for.body26.prol.preheader:                        ; preds = %for.body26.lr.ph
  ...
  %arrayidx35.prol = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv29, i64 0
...
for.body26.prol.loopexit.unr-lcssa:               ; preds = %for.body26.lr.ph, %for.body26.prol.preheader
  ...
  br i1 %13, label %for.end38, label %for.body26.preheader
...
for.body26:                                       ; preds = %for.body26.preheader, %for.body26
  ...
  %14 = add nsw i64 %indvars.iv29, %indvars.iv
  %15 = trunc i64 %14 to i32
  %rem28 = srem i32 %15, 100
  %conv29 = sitofp i32 %rem28 to double
  %arrayidx35 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv29, i64 %indvars.iv
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %16 = add nsw i64 %indvars.iv29, %indvars.iv.next
  %17 = trunc i64 %16 to i32
  %rem28.1 = srem i32 %17, 100
  ...
  %18 = bitcast double* %arrayidx35 to <2 x double>*
  store <2 x double> %div31, <2 x double>* %18, align 8
...
for.end38:                                        ; preds = %for.end38.loopexit, %for.body26.prol.loopexit.unr-lcssa
  ...
  %cmp413 = icmp slt i64 %indvars.iv.next30, 1000
  br i1 %cmp413, label %for.body43.lr.ph, label %for.end53

for.body43.lr.ph:                                 ; preds = %for.end38
  %xtraiter25 = and i32 %9, 7
  %lcmp.mod26 = icmp eq i32 %xtraiter25, 0
  br i1 %lcmp.mod26, label %for.body43.prol.loopexit, label %for.body43.prol.preheader
...
for.body43.prol:                                  ; preds = %for.body43.prol.preheader, %for.body43.prol
  %indvars.iv23.prol = phi i64 [ %indvars.iv.next24.prol, %for.body43.prol ], [ %indvars.iv46, %for.body43.prol.preheader ]
  %prol.iter = phi i32 [ %prol.iter.sub, %for.body43.prol ], [ %xtraiter25, %for.body43.prol.preheader ]
  %arrayidx47.prol = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv29, i64 %indvars.iv23.prol
...
for.body43.prol.loopexit:                         ; preds = %for.body43.prol.loopexit.loopexit, %for.body43.lr.ph
  %indvars.iv23.unr = phi i64 [ %indvars.iv46, %for.body43.lr.ph ], [ %8, %for.body43.prol.loopexit.loopexit ]
  %19 = icmp ult i32 %10, 7
  br i1 %19, label %for.inc51, label %for.body43.preheader

for.body43.preheader:                             ; preds = %for.body43.prol.loopexit
  br label %for.body43

for.body43:                                       ; preds = %for.body43.preheader, %for.body43
  %indvars.iv23 = phi i64 [ %indvars.iv.next24.7, %for.body43 ], [ %indvars.iv23.unr, %for.body43.preheader ]
  %arrayidx47 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv29, i64 %indvars.iv23
  store double -9.990000e+02, double* %arrayidx47, align 8
  %indvars.iv.next24 = add nsw i64 %indvars.iv23, 1
  %arrayidx47.1 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv29, i64 %indvars.iv.next24
  store double -9.990000e+02, double* %arrayidx47.1, align 8
  %indvars.iv.next24.1 = add nsw i64 %indvars.iv23, 2
  %arrayidx47.2 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv29, i64 %indvars.iv.next24.1
  store double -9.990000e+02, double* %arrayidx47.2, align 8
  %indvars.iv.next24.2 = add nsw i64 %indvars.iv23, 3
  %arrayidx47.3 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv29, i64 %indvars.iv.next24.2
  store double -9.990000e+02, double* %arrayidx47.3, align 8
  %indvars.iv.next24.3 = add nsw i64 %indvars.iv23, 4
  %arrayidx47.4 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv29, i64 %indvars.iv.next24.3
  store double -9.990000e+02, double* %arrayidx47.4, align 8
  %indvars.iv.next24.4 = add nsw i64 %indvars.iv23, 5
  %arrayidx47.5 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv29, i64 %indvars.iv.next24.4
  store double -9.990000e+02, double* %arrayidx47.5, align 8
  %indvars.iv.next24.5 = add nsw i64 %indvars.iv23, 6
  %arrayidx47.6 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv29, i64 %indvars.iv.next24.5
  store double -9.990000e+02, double* %arrayidx47.6, align 8
  %indvars.iv.next24.6 = add nsw i64 %indvars.iv23, 7
  %arrayidx47.7 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv29, i64 %indvars.iv.next24.6
  store double -9.990000e+02, double* %arrayidx47.7, align 8
  %indvars.iv.next24.7 = add nsw i64 %indvars.iv23, 8
  %lftr.wideiv.7 = trunc i64 %indvars.iv.next24.7 to i32
...
for.inc51:                                        ; preds = %for.inc51.loopexit, %for.body43.prol.loopexit
  %20 = icmp slt i64 %indvars.iv.next30, 1000
  %indvars.iv.next47 = add nuw nsw i64 %indvars.iv46, 1
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1
  %indvars.iv.next45 = add i3 %indvars.iv44, -1
  br i1 %20, label %for.body26.lr.ph, label %for.end53
...
entry:
  ...
  %broadcast.splatinsert53 = insertelement <2 x double> undef, double %beta, i32 0
  %broadcast.splat54 = shufflevector <2 x double> %broadcast.splatinsert53, <2 x double> undef, <2 x i32> zeroinitializer
  %broadcast.splatinsert57 = insertelement <2 x double> undef, double %alpha, i32 0
  %broadcast.splat58 = shufflevector <2 x double> %broadcast.splatinsert57, <2 x double> undef, <2 x i32> zeroinitializer
  %broadcast.splatinsert59 = insertelement <2 x double> undef, double %mul44, i32 0
...
vector.memcheck:                                  ; preds = %for.body
  %scevgep45 = getelementptr [1200 x double], [1200 x double]* %B, i64 %0, i64 0
  %scevgep43 = getelementptr [1200 x double], [1200 x double]* %B, i64 %indvars.iv36, i64 0
  %bound0 = icmp ult double* %scevgep, %scevgep45
  %bound1 = icmp ult double* %scevgep43, %scevgep41
  %found.conflict = and i1 %bound0, %bound1
  %bound048 = icmp ult double* %scevgep, %arrayidx41
  %bound149 = icmp ult double* %arrayidx41, %scevgep41
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load52 = load <2 x double>, <2 x double>* %4, align 8, !alias.scope !3, !noalias !6
  %5 = fmul <2 x double> %wide.load, %broadcast.splat54
  %6 = fmul <2 x double> %wide.load52, %broadcast.splat54
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv36, i64 %index
  %8 = bitcast double* %7 to <2 x double>*
  %wide.load55 = load <2 x double>, <2 x double>* %8, align 8, !alias.scope !9
  %9 = getelementptr double, double* %7, i64 2
  %10 = bitcast double* %9 to <2 x double>*
  %wide.load56 = load <2 x double>, <2 x double>* %10, align 8, !alias.scope !9
  %11 = fmul <2 x double> %wide.load55, %broadcast.splat58
  %12 = fmul <2 x double> %wide.load56, %broadcast.splat58
  ...
  %22 = fadd <2 x double> %20, %broadcast.splat60
  %23 = fadd <2 x double> %21, %broadcast.splat60
  ...
  br i1 %26, label %for.inc53.loopexit64, label %vector.body, !llvm.loop !11
...
for.body6.us:                                     ; preds = %for.body6.us, %for.body3.us
  ...
  %arrayidx12.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv36, i64 %indvars.iv18
  ...
  %exitcond25 = icmp eq i64 %indvars.iv.next19, %indvars.iv36
  br i1 %exitcond25, label %for.cond4.for.end_crit_edge.us, label %for.body6.us
...
for.body3:                                        ; preds = %for.body3, %for.body3.preheader
  ...
  br i1 %exitcond.1, label %for.inc53.loopexit63, label %for.body3, !llvm.loop !14

for.inc53.loopexit:                               ; preds = %for.cond4.for.end_crit_edge.us
  br label %for.inc53

for.inc53.loopexit63:                             ; preds = %for.body3
  br label %for.inc53

for.inc53.loopexit64:                             ; preds = %vector.body
  br label %for.inc53

for.inc53:                                        ; preds = %for.inc53.loopexit64, %for.inc53.loopexit63, %for.inc53.loopexit
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  %exitcond38 = icmp eq i64 %indvars.iv.next37, 1000
  br i1 %exitcond38, label %for.end55, label %for.body
