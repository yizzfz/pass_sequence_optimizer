...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc16_crit_edge.us, %for.cond1.preheader.us.preheader
  ...
  %0 = add nsw i64 %indvars.iv65, 1200
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.inc51, label %for.inc48.preheader1
...
for.cond4.preheader.lr.ph:                        ; preds = %for.cond1.preheader.lr.ph, %for.inc53
  %indvars.iv53 = phi i64 [ 0, %for.cond1.preheader.lr.ph ], [ %0, %for.inc53 ]
...
vector.memcheck:                                  ; preds = %for.cond4.preheader.lr.ph
  ...
  %scevgep7 = getelementptr [1200 x double], [1200 x double]* %B, i64 %indvars.iv53, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %20 = fadd <2 x double> %broadcast.splat24, %18
  %21 = fadd <2 x double> %broadcast.splat24, %19
  ...
  br i1 %22, label %for.inc53.loopexit28, label %vector.body, !llvm.loop !16
...
for.cond4.preheader:                              ; preds = %for.cond4.preheader, %for.cond4.preheader.preheader
  ...
  br i1 %exitcond.1, label %for.inc53.loopexit27, label %for.cond4.preheader, !llvm.loop !17
