...
.lr.ph4.split.us:                                 ; preds = %.lr.ph8.preheader, %._crit_edge.us
  %.13.us = phi i32 [ %22, %._crit_edge.us ], [ 0, %.lr.ph8.preheader ]
...
; <label>:8:                                      ; preds = %8, %.lr.ph4.split.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %8 ], [ 0, %.lr.ph4.split.us ]
  %9 = getelementptr inbounds double, double* %1, i64 %indvars.iv
  %10 = load double, double* %9, align 8
  %11 = load double, double* %sunkaddr12, align 8
