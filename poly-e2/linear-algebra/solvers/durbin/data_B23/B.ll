...
min.iters.checked:                                ; preds = %for.body21.preheader
  ...
  %35 = or i64 %indvars.iv36.unr.ph, 2
  %36 = shl nuw i64 %33, 1
  %37 = add i64 %35, %36
...
vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert68 = insertelement <2 x double> undef, double %div, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %39 = shl i64 %index, 1
  %offset.idx = or i64 %indvars.iv36.unr.ph, %39
  ...
  %strided.vec63 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  ...
  %wide.vec64 = load <4 x double>, <4 x double>* %45, align 8
  %strided.vec65 = shufflevector <4 x double> %wide.vec64, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %reverse = shufflevector <2 x double> %strided.vec65, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %strided.vec66 = shufflevector <4 x double> %wide.vec64, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %reverse67 = shufflevector <2 x double> %strided.vec66, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %46 = fmul <2 x double> %broadcast.splat69, %reverse67
  %47 = fadd <2 x double> %strided.vec, %46
  %48 = add nuw nsw i64 %offset.idx, 1
  %49 = fmul <2 x double> %broadcast.splat69, %reverse
  %50 = fadd <2 x double> %strided.vec63, %49
...
for.body21.preheader1:                            ; preds = %middle.block, %min.iters.checked, %for.body21.preheader
  %indvars.iv36.ph = phi i64 [ %indvars.iv36.unr.ph, %min.iters.checked ], [ %indvars.iv36.unr.ph, %for.body21.preheader ], [ %ind.end, %middle.block ]
...
for.body21:                                       ; preds = %for.body21.preheader1, %for.body21
  %indvars.iv36 = phi i64 [ %indvars.iv.next37.1, %for.body21 ], [ %indvars.iv36.ph, %for.body21.preheader1 ]
  ...
  %58 = sub nsw i64 %27, %indvars.iv.next37
  ...
  %exitcond42.1 = icmp eq i64 %indvars.iv.next37.1, %indvars.iv51
  br i1 %exitcond42.1, label %for.end44.loopexit, label %for.body21, !llvm.loop !6
