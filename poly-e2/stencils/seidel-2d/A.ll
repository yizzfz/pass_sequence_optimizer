...
entry:
  ...
  %arraydecay1 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %5, i32 0, i32 0
  call void @kernel_seidel_2d(i32 %3, i32 %4, [2000 x double]* %arraydecay1)
...
land.lhs.true:                                    ; preds = %entry
  ...
  %call2 = call i32 @strcmp(i8* %8, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i32 0, i32 0)) #4
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %arraydecay3 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %10, i32 0, i32 0
  call void @print_array(i32 %9, [2000 x double]* %arraydecay3)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  %11 = load [2000 x [2000 x double]]*, [2000 x [2000 x double]]** %A, align 8
  %12 = bitcast [2000 x [2000 x double]]* %11 to i8*
...
for.body8:                                        ; preds = %for.cond5
  ...
  %arrayidx15 = getelementptr inbounds [2000 x double], [2000 x double]* %10, i64 %idxprom14
  ...
  %arrayidx20 = getelementptr inbounds [2000 x double], [2000 x double]* %14, i64 %idxprom19
  ...
  %arrayidx26 = getelementptr inbounds [2000 x double], [2000 x double]* %18, i64 %idxprom25
  ...
  %22 = load [2000 x double]*, [2000 x double]** %A.addr, align 8
  %23 = load i32, i32* %i, align 4
  %idxprom31 = sext i32 %23 to i64
  %arrayidx32 = getelementptr inbounds [2000 x double], [2000 x double]* %22, i64 %idxprom31
  ...
  %arrayidx37 = getelementptr inbounds [2000 x double], [2000 x double]* %26, i64 %idxprom36
  ...
  %arrayidx44 = getelementptr inbounds [2000 x double], [2000 x double]* %30, i64 %idxprom43
  ...
  %arrayidx51 = getelementptr inbounds [2000 x double], [2000 x double]* %34, i64 %idxprom50
  ...
  %arrayidx63 = getelementptr inbounds [2000 x double], [2000 x double]* %42, i64 %idxprom62
