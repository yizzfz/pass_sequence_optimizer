...
; <label>:5:                                      ; preds = %5, %.preheader.us
  ...
  %exitcond9 = icmp eq i64 %indvars.iv.next, 1300
  br i1 %exitcond9, label %._crit_edge.us, label %5

._crit_edge.us:                                   ; preds = %5
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1
  %exitcond = icmp eq i64 %indvars.iv.next6, 1300
...
.preheader4.us:                                   ; preds = %.preheader6, %._crit_edge.us
  %indvar52 = phi i64 [ 0, %.preheader6 ], [ %indvar.next53, %._crit_edge.us ]
  %indvars.iv16 = phi i64 [ 1, %.preheader6 ], [ %indvars.iv.next17, %._crit_edge.us ]
  %4 = add nuw nsw i64 %indvar52, 1
  ...
  br i1 %memcheck.conflict65, label %scalar.ph49.preheader, label %vector.body47.preheader
...
vector.body47:                                    ; preds = %vector.body47.preheader, %vector.body47
  ...
  br i1 %43, label %scalar.ph49.preheader.loopexit, label %vector.body47, !llvm.loop !6

scalar.ph49.preheader.loopexit:                   ; preds = %vector.body47
  br label %scalar.ph49.preheader

scalar.ph49.preheader:                            ; preds = %scalar.ph49.preheader.loopexit, %.preheader4.us
  %indvars.iv.ph = phi i64 [ 1, %.preheader4.us ], [ 1297, %scalar.ph49.preheader.loopexit ]
...
scalar.ph49:                                      ; preds = %scalar.ph49.preheader, %scalar.ph49
  ...
  br i1 %exitcond29, label %._crit_edge.us, label %scalar.ph49, !llvm.loop !9
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %exitcond = icmp eq i64 %indvars.iv.next21, 1299
  br i1 %exitcond, label %._crit_edge11.us, label %scalar.ph, !llvm.loop !16
