...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc7_crit_edge.us, %entry
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.cond1.for.inc7_crit_edge.us ], [ 0, %entry ]
  %0 = add nuw nsw i64 %indvars.iv5, 1000
...
for.body3.us:                                     ; preds = %for.cond1.preheader.us, %for.body3.us
  ...
  %5 = bitcast double* %arrayidx6.us to <2 x double>*
  store <2 x double> %div.us, <2 x double>* %5, align 8
...
for.cond1.for.inc7_crit_edge.us:                  ; preds = %for.body3.us
  ...
  br i1 %exitcond9, label %for.end9, label %for.cond1.preheader.us
...
for.inc120.us:                                    ; preds = %for.body98.us
  %exitcond23 = icmp eq i64 %indvars.iv.next20, 999
  %indvar.next = add nuw nsw i64 %indvar, 1
  br i1 %exitcond23, label %for.body144.us.lver.check.preheader, label %for.body34.us.lver.check
...
for.body98.us:                                    ; preds = %for.cond30.for.end_crit_edge.us, %for.body98.us
  %indvars.iv16 = phi i64 [ %indvars.iv.next17.1, %for.body98.us ], [ 998, %for.cond30.for.end_crit_edge.us ]
  %12 = phi double [ %add113.us.1, %for.body98.us ], [ 1.000000e+00, %for.cond30.for.end_crit_edge.us ]
...
for.body144.us.lver.check:                        ; preds = %for.body144.us.lver.check.preheader, %for.inc234.us
  %indvar12 = phi i64 [ %indvar.next13, %for.inc234.us ], [ 0, %for.body144.us.lver.check.preheader ]
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc234.us ], [ 1, %for.body144.us.lver.check.preheader ]
  %20 = add nuw nsw i64 %indvar12, 1
  %21 = add nuw nsw i64 %indvar12, 1
  ...
  %arrayidx130.us = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv32, i64 0
  store double 1.000000e+00, double* %arrayidx130.us, align 8
  %arrayidx133.us = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv32, i64 0
  store double 0.000000e+00, double* %arrayidx133.us, align 8
  %22 = bitcast double* %arrayidx130.us to i64*
  %23 = load i64, i64* %22, align 8
  %arrayidx138.us = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv32
...
for.body144.us.lver.orig:                         ; preds = %for.body144.us.lver.orig.preheader, %for.body144.us.lver.orig
  ...
  %26 = add nsw i64 %indvars.iv24.lver.orig, -1
  %arrayidx150.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv32, i64 %26
  %27 = load double, double* %arrayidx150.us.lver.orig, align 8
  %arrayidx157.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv32, i64 %indvars.iv24.lver.orig
  %arrayidx163.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %25, i64 %indvars.iv24.lver.orig
  %arrayidx170.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %indvars.iv32, i64 %indvars.iv24.lver.orig
  %arrayidx177.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %indvars.iv.next33, i64 %indvars.iv24.lver.orig
  %arrayidx184.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv32, i64 %26
  ...
  %arrayidx198.us.lver.orig = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv32, i64 %indvars.iv24.lver.orig
  ...
  %exitcond28.lver.orig = icmp eq i64 %indvars.iv.next25.lver.orig, 999
...
for.inc234.us:                                    ; preds = %for.body211.us
  %exitcond36 = icmp eq i64 %indvars.iv.next33, 999
  %indvar.next13 = add nuw nsw i64 %indvar12, 1
  br i1 %exitcond36, label %for.inc237, label %for.body144.us.lver.check

for.body211.us:                                   ; preds = %for.cond140.for.end201_crit_edge.us, %for.body211.us
  %indvars.iv29 = phi i64 [ %indvars.iv.next30.1, %for.body211.us ], [ 998, %for.cond140.for.end201_crit_edge.us ]
  %34 = phi double [ %add226.us.1, %for.body211.us ], [ 1.000000e+00, %for.cond140.for.end201_crit_edge.us ]
  %arrayidx215.us = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv32, i64 %indvars.iv29
  %35 = load double, double* %arrayidx215.us, align 8
  %mul221.us = fmul double %35, %34
  %arrayidx225.us = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv32, i64 %indvars.iv29
  %36 = load double, double* %arrayidx225.us, align 8
  %add226.us = fadd double %mul221.us, %36
  %arrayidx230.us = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv32, i64 %indvars.iv29
  store double %add226.us, double* %arrayidx230.us, align 8
  %indvars.iv.next30 = add nsw i64 %indvars.iv29, -1
  %arrayidx215.us.1 = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv32, i64 %indvars.iv.next30
  %37 = load double, double* %arrayidx215.us.1, align 8
  %mul221.us.1 = fmul double %37, %add226.us
  %arrayidx225.us.1 = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv32, i64 %indvars.iv.next30
  %38 = load double, double* %arrayidx225.us.1, align 8
  %add226.us.1 = fadd double %mul221.us.1, %38
  %arrayidx230.us.1 = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv32, i64 %indvars.iv.next30
...
for.body144.us:                                   ; preds = %for.body144.us, %for.body144.us.ph
  ...
  %arrayidx157.us = getelementptr inbounds [1000 x double], [1000 x double]* %p, i64 %indvars.iv32, i64 %indvars.iv24
  %arrayidx163.us = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %25, i64 %indvars.iv24
  %arrayidx170.us = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %indvars.iv32, i64 %indvars.iv24
  %arrayidx177.us = getelementptr inbounds [1000 x double], [1000 x double]* %v, i64 %indvars.iv.next33, i64 %indvars.iv24
  %39 = insertelement <2 x double> undef, double %store_forwarded28, i32 0
  %mul151.v.i1.2.us = shufflevector <2 x double> %39, <2 x double> undef, <2 x i32> zeroinitializer
  ...
  %arrayidx198.us = getelementptr inbounds [1000 x double], [1000 x double]* %q, i64 %indvars.iv32, i64 %indvars.iv24
  store double %div194.us, double* %arrayidx198.us, align 8
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  %exitcond28 = icmp eq i64 %indvars.iv.next25, 999
  br i1 %exitcond28, label %for.cond140.for.end201_crit_edge.us.loopexit32, label %for.body144.us
...
for.cond140.for.end201_crit_edge.us:              ; preds = %for.cond140.for.end201_crit_edge.us.loopexit32, %for.cond140.for.end201_crit_edge.us.loopexit
  %arrayidx206.us = getelementptr inbounds [1000 x double], [1000 x double]* %u, i64 %indvars.iv32, i64 999
...
for.inc237:                                       ; preds = %for.inc234.us
  ...
  %exitcond37 = icmp eq i32 %t.014, 500
  br i1 %exitcond37, label %for.end239, label %for.cond15.preheader
