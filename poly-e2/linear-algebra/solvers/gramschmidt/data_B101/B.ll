...
for.cond.loopexit:                                ; preds = %for.cond.loopexit.loopexit, %for.end31
  %exitcond82 = icmp eq i64 %indvars.iv.next73, 1200
  br i1 %exitcond82, label %for.end88, label %for.cond.loopexit.for.cond1.preheader_crit_edge
...
for.body16:                                       ; preds = %for.body16, %for.end
  %indvars.iv45 = phi i64 [ 0, %for.end ], [ %indvars.iv.next46.1, %for.body16 ]
  ...
  br i1 %exitcond48.1, label %for.end31, label %for.body16
...
for.body62.us:                                    ; preds = %for.body62.us.preheader, %for.body62.us
  %indvars.iv60 = phi i64 [ %indvars.iv.next61.1, %for.body62.us ], [ 0, %for.body62.us.preheader ]
  ...
  br i1 %exitcond63.1, label %for.end82.us, label %for.body62.us
