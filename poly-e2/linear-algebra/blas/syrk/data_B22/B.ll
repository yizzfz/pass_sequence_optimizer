...
for.inc31:                                        ; preds = %for.body17
  ...
  %exitcond24 = icmp eq i64 %indvars.iv.next4, 1200
  br i1 %exitcond24, label %for.end33, label %for.cond14.preheader
...
for.cond1.preheader.us:                           ; preds = %for.inc32.us, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge
  %indvars.iv = phi i2 [ 1, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge ], [ %indvars.iv.next30, %for.inc32.us ]
  %indvars.iv1122.us = phi i64 [ 1, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge ], [ %indvars.iv.next12.us, %for.inc32.us ]
  %indvars.iv1320.us = phi i64 [ 0, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge ], [ %2, %for.inc32.us ]
...
for.body3.us.prol.loopexit:                       ; preds = %for.body3.us.prol, %for.cond1.preheader.us
  %indvars.iv15.us.unr = phi i64 [ 0, %for.cond1.preheader.us ], [ %1, %for.body3.us.prol ]
  %4 = icmp ult i64 %indvars.iv1320.us, 3
  br i1 %4, label %for.cond9.preheader.us.preheader, label %for.body3.us.prol.loopexit.for.body3.us_crit_edge
...
min.iters.checked:                                ; preds = %for.body3.us.prol.loopexit.for.body3.us_crit_edge
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.cond9.preheader.us.preheader, label %for.body3.us.preheader

for.body3.us.preheader:                           ; preds = %middle.block, %min.iters.checked, %for.body3.us.prol.loopexit.for.body3.us_crit_edge
  %indvars.iv15.us.ph = phi i64 [ %indvars.iv15.us.unr, %min.iters.checked ], [ %indvars.iv15.us.unr, %for.body3.us.prol.loopexit.for.body3.us_crit_edge ], [ %ind.end, %middle.block ]
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us.preheader, %for.body3.us
  %indvars.iv15.us = phi i64 [ %indvars.iv.next.us.3, %for.body3.us ], [ %indvars.iv15.us.ph, %for.body3.us.preheader ]
  ...
  br i1 %exitcond.us.3, label %for.cond9.preheader.us.preheader, label %for.body3.us, !llvm.loop !6

for.cond9.preheader.us.preheader:                 ; preds = %for.body3.us, %middle.block, %for.body3.us.prol.loopexit
  %xtraiter25 = and i64 %2, 1
...
for.cond9.preheader.us:                           ; preds = %for.inc29.us, %for.cond9.preheader.us.preheader
  %indvars.iv918.us = phi i64 [ 0, %for.cond9.preheader.us.preheader ], [ %indvars.iv.next10.us, %for.inc29.us ]
  %30 = icmp eq i64 %xtraiter25, 0
  %arrayidx15.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv1320.us, i64 %indvars.iv918.us
  br i1 %30, label %for.body11.us.prol.loopexit.unr-lcssa, label %for.body11.us.prol.preheader

for.body11.us.prol.preheader:                     ; preds = %for.cond9.preheader.us
  %31 = load double, double* %arrayidx15.us, align 8
  %mul16.us.prol = fmul double %31, %alpha
  %arrayidx20.us.prol = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 0, i64 %indvars.iv918.us
  %32 = load double, double* %arrayidx20.us.prol, align 8
  %mul21.us.prol = fmul double %mul16.us.prol, %32
  %33 = load double, double* %arrayidx25.us.prol, align 8
  %add.us.prol = fadd double %33, %mul21.us.prol
...
for.body11.us.prol.loopexit.unr-lcssa:            ; preds = %for.cond9.preheader.us, %for.body11.us.prol.preheader
  ...
  %34 = icmp eq i64 %indvars.iv1320.us, 0
  br i1 %34, label %for.inc29.us, label %for.body11.us.preheader
...
for.body11.us:                                    ; preds = %for.body11.us.preheader, %for.body11.us
  ...
  %add.us = fadd double %37, %mul21.us
  ...
  %add.us.1 = fadd double %40, %mul21.us.1
