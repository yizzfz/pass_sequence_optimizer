...
.lr.ph30.split.us.preheader:
  ...
  %sunkaddr101 = ptrtoint double* %5 to i64
...
._crit_edge27.us:                                 ; preds = %._crit_edge
  %20 = fdiv double %19, %2
  %sunkaddr102 = shl i64 %indvars.iv60, 3
...
vector.memcheck:                                  ; preds = %._crit_edge22.us, %._crit_edge27.us..preheader6.us_crit_edge
  ...
  %scevgep87 = getelementptr [1200 x double], [1200 x double]* %3, i64 %21, i64 0
...
._crit_edge68.preheader:                          ; preds = %vector.memcheck
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.vec94 = load <8 x double>, <8 x double>* %25, align 8, !alias.scope !4, !noalias !1
  %26 = fsub <8 x double> %wide.vec94, %wide.vec
  ...
  br i1 %37, label %._crit_edge22.us.loopexit105, label %vector.body, !llvm.loop !6
