...
for.body.prol.loopexit:                           ; preds = %for.body.preheader, %for.body.prol.preheader
  %indvars.iv3.unr = phi i64 [ 0, %for.body.preheader ], [ 1, %for.body.prol.preheader ]
  %2 = icmp eq i32 %n, 1
...
for.body:                                         ; preds = %for.body, %for.body.preheader.new
  %indvars.iv3 = phi i64 [ %indvars.iv3.unr, %for.body.preheader.new ], [ %indvars.iv.next.1, %for.body ]
...
entry:
  ...
  br i1 %cmp16, label %for.cond1.preheader.lr.ph, label %for.end35
...
for.cond1.preheader:                              ; preds = %for.inc33, %for.cond1.preheader.lr.ph
  ...
  br i1 %cmp211, label %for.body3.lr.ph, label %for.inc33

for.body3.lr.ph:                                  ; preds = %for.cond1.preheader
  br i1 %min.iters.check35, label %for.body3.preheader, label %min.iters.checked36

for.body3.preheader:                              ; preds = %middle.block33, %vector.memcheck52, %min.iters.checked36, %for.body3.lr.ph
  %indvars.iv12.ph = phi i64 [ 1, %vector.memcheck52 ], [ 1, %min.iters.checked36 ], [ 1, %for.body3.lr.ph ], [ %ind.end, %middle.block33 ]
...
for.body3.prol.loopexit.unr-lcssa:                ; preds = %for.body3.preheader, %for.body3.prol.preheader
  %indvars.iv12.unr.ph = phi i64 [ %indvars.iv.next.prol, %for.body3.prol.preheader ], [ %indvars.iv12.ph, %for.body3.preheader ]
...
min.iters.checked36:                              ; preds = %for.body3.lr.ph
  br i1 %cmp.zero, label %for.body3.preheader, label %vector.memcheck52

vector.memcheck52:                                ; preds = %min.iters.checked36
  br i1 %found.conflict50, label %for.body3.preheader, label %vector.body32.preheader
...
vector.body32:                                    ; preds = %vector.body32.preheader, %vector.body32
  ...
  br i1 %31, label %middle.block33, label %vector.body32, !llvm.loop !6
...
for.cond13.preheader:                             ; preds = %for.cond13.preheader.loopexit, %middle.block33
...
for.body16.lr.ph:                                 ; preds = %for.cond13.preheader
  br i1 %min.iters.check35, label %for.body16.preheader, label %min.iters.checked

for.body16.preheader:                             ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.body16.lr.ph
  %indvars.iv814.ph = phi i64 [ 1, %vector.memcheck ], [ 1, %min.iters.checked ], [ 1, %for.body16.lr.ph ], [ %ind.end, %middle.block ]
  %32 = sub nsw i64 %0, %indvars.iv814.ph
  %xtraiter70 = and i64 %32, 1
  %lcmp.mod71 = icmp eq i64 %xtraiter70, 0
  br i1 %lcmp.mod71, label %for.body16.prol.loopexit.unr-lcssa, label %for.body16.prol.preheader
...
for.body16.prol.loopexit.unr-lcssa:               ; preds = %for.body16.preheader, %for.body16.prol.preheader
  %indvars.iv814.unr.ph = phi i64 [ %indvars.iv.next9.prol, %for.body16.prol.preheader ], [ %indvars.iv814.ph, %for.body16.preheader ]
...
for.body3:                                        ; preds = %for.body3, %for.body3.preheader.new
  %indvars.iv12 = phi i64 [ %indvars.iv12.unr.ph, %for.body3.preheader.new ], [ %indvars.iv.next.1, %for.body3 ]
...
for.body16:                                       ; preds = %for.body16, %for.body16.preheader.new
  %indvars.iv814 = phi i64 [ %indvars.iv814.unr.ph, %for.body16.preheader.new ], [ %indvars.iv.next9.1, %for.body16 ]
  ...
  br i1 %exitcond18.1, label %for.inc33.loopexit.unr-lcssa, label %for.body16, !llvm.loop !16
...
for.inc33:                                        ; preds = %for.cond13.preheader.for.inc33_crit_edge, %for.inc33.loopexit, %for.cond1.preheader, %middle.block
  ...
  br i1 %exitcond19, label %for.end35.loopexit, label %for.cond1.preheader
