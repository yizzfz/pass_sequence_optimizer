...
.lr.ph29.prol:                                    ; preds = %.lr.ph29.prol, %.lr.ph29.preheader
  %indvars.iv36.prol = phi i64 [ 0, %.lr.ph29.preheader ], [ %indvars.iv.next37.prol, %.lr.ph29.prol ]
  %prol.iter = phi i32 [ 4, %.lr.ph29.preheader ], [ %prol.iter.sub, %.lr.ph29.prol ]
  ...
  br i1 %prol.iter.cmp, label %.lr.ph29.preheader42, label %.lr.ph29.prol, !llvm.loop !1

.lr.ph29.preheader42:                             ; preds = %.lr.ph29.prol
  br label %.lr.ph29
...
; <label>:14:                                     ; preds = %14, %.preheader.us
  ...
  br i1 %exitcond40, label %._crit_edge.us, label %14

._crit_edge.us:                                   ; preds = %14
  %indvars.iv.next32 = add nuw nsw i64 %indvars.iv31, 1
  %exitcond = icmp eq i64 %indvars.iv.next32, 1000
  br i1 %exitcond, label %._crit_edge26, label %.preheader.us

.lr.ph29:                                         ; preds = %.lr.ph29.preheader42, %.lr.ph29
  %indvars.iv36 = phi i64 [ %indvars.iv.next37.7, %.lr.ph29 ], [ 4, %.lr.ph29.preheader42 ]
...
.preheader69.us:                                  ; preds = %.preheader69.us.preheader, %._crit_edge.us
  ...
  %scevgep210 = getelementptr [1200 x double], [1200 x double]* %4, i64 %9, i64 0
  %scevgep213 = getelementptr [1200 x double], [1200 x double]* %4, i64 %9, i64 1200
  %scevgep216 = getelementptr [1200 x double], [1200 x double]* %5, i64 %indvar, i64 0
  %scevgep219 = getelementptr [1200 x double], [1200 x double]* %5, i64 %9, i64 1200
  %bound0221 = icmp ult double* %scevgep210, %scevgep219
  %bound1222 = icmp ult double* %scevgep216, %scevgep213
  %memcheck.conflict224 = and i1 %bound0221, %bound1222
  br i1 %memcheck.conflict224, label %.preheader69.us.new.preheader, label %vector.body200.preheader

vector.body200.preheader:                         ; preds = %.preheader69.us
  br label %vector.body200

vector.body200:                                   ; preds = %vector.body200.preheader, %vector.body200
  %index227 = phi i64 [ %index.next228, %vector.body200 ], [ 0, %vector.body200.preheader ]
  %11 = shl i64 %index227, 1
  %12 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv100, i64 %11
  %13 = bitcast double* %12 to <4 x double>*
  %wide.vec236 = load <4 x double>, <4 x double>* %13, align 8, !alias.scope !3, !noalias !6
  %strided.vec237 = shufflevector <4 x double> %wide.vec236, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %strided.vec238 = shufflevector <4 x double> %wide.vec236, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %14 = getelementptr inbounds [1200 x double], [1200 x double]* %5, i64 %indvars.iv100, i64 %11
  %15 = bitcast double* %14 to <4 x double>*
  %wide.vec239 = load <4 x double>, <4 x double>* %15, align 8, !alias.scope !6
  %16 = getelementptr inbounds [1200 x double], [1200 x double]* %5, i64 %10, i64 %11
  %17 = bitcast double* %16 to <4 x double>*
  %wide.vec242 = load <4 x double>, <4 x double>* %17, align 8, !alias.scope !6
  %18 = fsub <4 x double> %wide.vec239, %wide.vec242
  ...
  %27 = fsub <2 x double> %strided.vec238, %26
  %28 = getelementptr double, double* %23, i64 -1
  %29 = bitcast double* %28 to <4 x double>*
  %interleaved.vec245 = shufflevector <2 x double> %21, <2 x double> %27, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec245, <4 x double>* %29, align 8, !alias.scope !3, !noalias !6
  %index.next228 = add i64 %index227, 2
  %30 = icmp eq i64 %index.next228, 600
  br i1 %30, label %middle.block201, label %vector.body200, !llvm.loop !8

middle.block201:                                  ; preds = %vector.body200
  br i1 true, label %._crit_edge.us, label %.preheader69.us.new.preheader

.preheader69.us.new.preheader:                    ; preds = %middle.block201, %.preheader69.us
  %indvars.iv92.ph = phi i64 [ 0, %.preheader69.us ], [ 1200, %middle.block201 ]
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %middle.block201
  %indvars.iv.next101 = add nuw nsw i64 %indvars.iv100, 1
  %exitcond129 = icmp eq i64 %indvars.iv.next101, 1000
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond129, label %.preheader68.us.preheader, label %.preheader69.us
...
.preheader68.us:                                  ; preds = %.preheader68.us.preheader, %._crit_edge80.us
  ...
  %scevgep169 = getelementptr [1200 x double], [1200 x double]* %3, i64 %indvars.iv112, i64 2
  %scevgep172 = getelementptr [1200 x double], [1200 x double]* %3, i64 %indvars.iv112, i64 1200
  %scevgep175 = getelementptr [1200 x double], [1200 x double]* %5, i64 %indvars.iv112, i64 1
  %scevgep178 = getelementptr [1200 x double], [1200 x double]* %5, i64 %indvars.iv112, i64 1200
  %bound0180 = icmp ult double* %scevgep169, %scevgep178
  %bound1181 = icmp ult double* %scevgep175, %scevgep172
  %memcheck.conflict183 = and i1 %bound0180, %bound1181
  br i1 %memcheck.conflict183, label %.preheader68.us.new.preheader, label %vector.body163.preheader

vector.body163.preheader:                         ; preds = %.preheader68.us
...
vector.body163:                                   ; preds = %vector.body163.preheader, %vector.body163
  ...
  %strided.vec193 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  ...
  %wide.vec194 = load <4 x double>, <4 x double>* %87, align 8, !alias.scope !15
  ...
  %88 = fsub <2 x double> %strided.vec196, %strided.vec195
  ...
  %wide.vec197 = load <4 x double>, <4 x double>* %95, align 8, !alias.scope !15
  %strided.vec198 = shufflevector <4 x double> %wide.vec197, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %strided.vec199 = shufflevector <4 x double> %wide.vec197, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %96 = fsub <2 x double> %strided.vec199, %strided.vec198
  %97 = fmul <2 x double> %96, <double 5.000000e-01, double 5.000000e-01>
  %98 = fsub <2 x double> %strided.vec193, %97
  ...
  %101 = icmp eq i64 %index.next187, 598
  br i1 %101, label %middle.block164, label %vector.body163, !llvm.loop !17

middle.block164:                                  ; preds = %vector.body163
  br i1 false, label %._crit_edge80.us, label %.preheader68.us.new.preheader

.preheader68.us.new.preheader:                    ; preds = %middle.block164, %.preheader68.us
  %indvars.iv104.ph = phi i64 [ 2, %.preheader68.us ], [ 1198, %middle.block164 ]
...
._crit_edge80.us:                                 ; preds = %._crit_edge80.us.loopexit, %middle.block164
  %indvars.iv.next113 = add nuw nsw i64 %indvars.iv112, 1
  %exitcond = icmp eq i64 %indvars.iv.next113, 1000
  br i1 %exitcond, label %.preheader.us.preheader, label %.preheader68.us
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge84.us
  ...
  %scevgep140 = getelementptr [1200 x double], [1200 x double]* %5, i64 %indvars.iv121, i64 1199
  %scevgep142 = getelementptr [1200 x double], [1200 x double]* %3, i64 %indvars.iv121, i64 0
  %121 = add i64 %indvars.iv121, 1
  %scevgep144 = getelementptr [1200 x double], [1200 x double]* %3, i64 %121, i64 0
  %scevgep146 = getelementptr [1200 x double], [1200 x double]* %4, i64 %indvars.iv121, i64 0
  %scevgep148 = getelementptr [1200 x double], [1200 x double]* %4, i64 %121, i64 1199
  %indvars.iv.next122 = add nuw nsw i64 %indvars.iv121, 1
  %bound0 = icmp ult double* %scevgep, %scevgep144
  %bound1 = icmp ult double* %scevgep142, %scevgep140
  %found.conflict = and i1 %bound0, %bound1
  %bound0150 = icmp ult double* %scevgep, %scevgep148
  %bound1151 = icmp ult double* %scevgep146, %scevgep140
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load154 = load <2 x double>, <2 x double>* %125, align 8, !alias.scope !19, !noalias !22
  %126 = or i64 %index, 1
  %127 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv121, i64 %126
  %128 = bitcast double* %127 to <2 x double>*
  %wide.load155 = load <2 x double>, <2 x double>* %128, align 8, !alias.scope !25
  %129 = getelementptr double, double* %127, i64 2
  %130 = bitcast double* %129 to <2 x double>*
  %wide.load156 = load <2 x double>, <2 x double>* %130, align 8, !alias.scope !25
  %131 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv121, i64 %index
  %132 = bitcast double* %131 to <2 x double>*
  %wide.load157 = load <2 x double>, <2 x double>* %132, align 8, !alias.scope !25
  %133 = getelementptr double, double* %131, i64 2
  %134 = bitcast double* %133 to <2 x double>*
  %wide.load158 = load <2 x double>, <2 x double>* %134, align 8, !alias.scope !25
  %135 = fsub <2 x double> %wide.load155, %wide.load157
  %136 = fsub <2 x double> %wide.load156, %wide.load158
  ...
  %wide.load159 = load <2 x double>, <2 x double>* %138, align 8, !alias.scope !26
  %139 = getelementptr double, double* %137, i64 2
  %140 = bitcast double* %139 to <2 x double>*
  %wide.load160 = load <2 x double>, <2 x double>* %140, align 8, !alias.scope !26
  %141 = fadd <2 x double> %135, %wide.load159
  %142 = fadd <2 x double> %136, %wide.load160
  %143 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv121, i64 %index
  %144 = bitcast double* %143 to <2 x double>*
  %wide.load161 = load <2 x double>, <2 x double>* %144, align 8, !alias.scope !26
  %145 = getelementptr double, double* %143, i64 2
  %146 = bitcast double* %145 to <2 x double>*
  %wide.load162 = load <2 x double>, <2 x double>* %146, align 8, !alias.scope !26
  %147 = fsub <2 x double> %141, %wide.load161
  %148 = fsub <2 x double> %142, %wide.load162
  ...
  %152 = fsub <2 x double> %wide.load154, %150
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %exitcond130 = icmp eq i64 %indvars.iv.next118, 1199
  br i1 %exitcond130, label %._crit_edge84.us, label %scalar.ph, !llvm.loop !28
...
._crit_edge86:                                    ; preds = %._crit_edge84.us
  ...
  %exitcond131 = icmp eq i64 %indvars.iv.next126, 500
  br i1 %exitcond131, label %._crit_edge88, label %.preheader73
...
; <label>:17:                                     ; preds = %15, %10
  ...
  %exitcond84 = icmp eq i64 %indvars.iv.next73, 1200
  br i1 %exitcond84, label %._crit_edge52.us, label %10

._crit_edge52.us:                                 ; preds = %17
  %indvars.iv.next77 = add nuw nsw i64 %indvars.iv76, 1
  %exitcond85 = icmp eq i64 %indvars.iv.next77, 1000
  br i1 %exitcond85, label %._crit_edge54, label %.preheader41.us
...
; <label>:36:                                     ; preds = %34, %29
  ...
  %exitcond82 = icmp eq i64 %indvars.iv.next64, 1200
  br i1 %exitcond82, label %._crit_edge47.us, label %29

._crit_edge47.us:                                 ; preds = %36
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  %exitcond83 = icmp eq i64 %indvars.iv.next68, 1000
  br i1 %exitcond83, label %._crit_edge49, label %.preheader40.us
...
; <label>:53:                                     ; preds = %51, %46
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond81 = icmp eq i64 %indvars.iv.next, 1200
  br i1 %exitcond81, label %._crit_edge.us, label %46

._crit_edge.us:                                   ; preds = %53
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  %exitcond = icmp eq i64 %indvars.iv.next59, 1000
  br i1 %exitcond, label %._crit_edge44, label %.preheader.us
