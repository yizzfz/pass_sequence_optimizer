...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph35.split.us
  ...
  %9 = mul nuw nsw i64 %indvars.iv68, %indvars.iv72
  %10 = add nuw nsw i64 %9, 1
  %11 = trunc i64 %10 to i32
  %12 = srem i32 %11, 800
  %13 = sitofp i32 %12 to double
  %14 = fdiv double %13, 4.000000e+03
  %15 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv72, i64 %indvars.iv68
...
._crit_edge77:                                    ; preds = %._crit_edge77, %.lr.ph24.split.us
  %indvars.iv59 = phi i64 [ 0, %.lr.ph24.split.us ], [ %indvars.iv.next60, %._crit_edge77 ]
  %indvars.iv.next60 = add nuw nsw i64 %indvars.iv59, 1
  %16 = mul nuw nsw i64 %indvars.iv.next60, %indvars.iv63
  %17 = add nuw nsw i64 %16, 2
  %18 = trunc i64 %17 to i32
  %19 = srem i32 %18, 900
  %20 = sitofp i32 %19 to double
  %21 = fdiv double %20, 4.500000e+03
  %22 = getelementptr inbounds [900 x double], [900 x double]* %6, i64 %indvars.iv63, i64 %indvars.iv59
  store double %21, double* %22, align 8
  %exitcond62 = icmp eq i64 %indvars.iv.next60, 900
  br i1 %exitcond62, label %._crit_edge21.us, label %._crit_edge77

._crit_edge21.us:                                 ; preds = %._crit_edge77
...
._crit_edge78:                                    ; preds = %._crit_edge78, %.lr.ph13.split.us
  %indvars.iv50 = phi i64 [ 0, %.lr.ph13.split.us ], [ %indvars.iv.next51, %._crit_edge78 ]
  %23 = add nuw nsw i64 %indvars.iv50, 3
  %24 = mul nuw nsw i64 %23, %indvars.iv54
  %25 = trunc i64 %24 to i32
  %26 = srem i32 %25, 1100
  %27 = sitofp i32 %26 to double
  %28 = fdiv double %27, 5.500000e+03
  %29 = getelementptr inbounds [1200 x double], [1200 x double]* %7, i64 %indvars.iv54, i64 %indvars.iv50
  store double %28, double* %29, align 8
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1
  %exitcond53 = icmp eq i64 %indvars.iv.next51, 1200
  br i1 %exitcond53, label %._crit_edge10.us, label %._crit_edge78

._crit_edge10.us:                                 ; preds = %._crit_edge78
...
._crit_edge79:                                    ; preds = %._crit_edge79, %.lr.ph2.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph2.split.us ], [ %indvars.iv.next, %._crit_edge79 ]
  %30 = add nuw nsw i64 %indvars.iv, 2
  %31 = mul nuw nsw i64 %30, %indvars.iv45
  %32 = add nuw nsw i64 %31, 2
  %33 = trunc i64 %32 to i32
  %34 = srem i32 %33, 1000
  %35 = sitofp i32 %34 to double
  %36 = fdiv double %35, 5.000000e+03
  %37 = getelementptr inbounds [1100 x double], [1100 x double]* %8, i64 %indvars.iv45, i64 %indvars.iv
  store double %36, double* %37, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1100
  br i1 %exitcond, label %._crit_edge.us, label %._crit_edge79

._crit_edge.us:                                   ; preds = %._crit_edge79
...
.lr.ph2.split.us:                                 ; preds = %._crit_edge.us, %.lr.ph2.split.us.preheader
  %indvars.iv9 = phi i64 [ 0, %.lr.ph2.split.us.preheader ], [ %indvars.iv.next10, %._crit_edge.us ]
  %7 = mul nsw i64 %indvars.iv9, 800
  br label %._crit_edge14

._crit_edge14:                                    ; preds = %._crit_edge, %.lr.ph2.split.us
...
._crit_edge.us:                                   ; preds = %._crit_edge
  ...
  br i1 %exitcond12, label %._crit_edge3, label %.lr.ph2.split.us
