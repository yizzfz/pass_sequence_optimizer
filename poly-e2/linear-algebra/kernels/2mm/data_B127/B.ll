...
entry:
  ...
  %arraydecay17 = bitcast i8* %call2 to [1100 x double]*
  %arraydecay918 = bitcast i8* %call4 to [900 x double]*
  %arraydecay1019 = bitcast i8* %call6 to [1200 x double]*
  %arraydecay1120 = bitcast i8* %call8 to [1200 x double]*
  call fastcc void @init_array(double* nonnull %alpha, double* nonnull %beta, [1100 x double]* %arraydecay17, [900 x double]* %arraydecay918, [1200 x double]* %arraydecay1019, [1200 x double]* %arraydecay1120)
  tail call void (...) @polybench_timer_start() #4
  %0 = load double, double* %alpha, align 8
  %1 = load double, double* %beta, align 8
  %arraydecay1221 = bitcast i8* %call to [900 x double]*
  tail call fastcc void @kernel_2mm(double %0, double %1, [900 x double]* %arraydecay1221, [1100 x double]* %arraydecay17, [900 x double]* %arraydecay918, [1200 x double]* %arraydecay1019, [1200 x double]* %arraydecay1120)
...
if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array([1200 x double]* %arraydecay1120)
  br label %if.end
...
for.body17.us:                                    ; preds = %for.body17.us, %for.cond14.preheader.us
  %indvars.iv5476.us = phi i64 [ 0, %for.cond14.preheader.us ], [ %indvars.iv.next55.us.1, %for.body17.us ]
  ...
  br i1 %exitcond8.1, label %for.inc31.us, label %for.body17.us
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc void @kernel_2mm(double %alpha, double %beta, [900 x double]* %tmp, [1100 x double]* nocapture readonly %A, [900 x double]* nocapture readonly %B, [1200 x double]* nocapture readonly %C, [1200 x double]* %D) unnamed_addr #2 {
...
for.body6.us.us.preheader:                        ; preds = %for.inc28.us, %for.cond4.preheader.us.preheader
  %indvars.iv3962.us = phi i64 [ 0, %for.cond4.preheader.us.preheader ], [ %indvars.iv.next40.us, %for.inc28.us ]
  %arrayidx.us = getelementptr inbounds [900 x double], [900 x double]* %tmp, i64 %indvars.iv3962.us
  %0 = ptrtoint [900 x double]* %arrayidx.us to i64
  br label %for.body6.us.us

for.inc28.us:                                     ; preds = %for.inc25.us.us
  %indvars.iv.next40.us = add nuw nsw i64 %indvars.iv3962.us, 1
  %exitcond11 = icmp eq i64 %indvars.iv.next40.us, 800
  br i1 %exitcond11, label %for.body36.us.us.preheader.preheader, label %for.body6.us.us.preheader
...
for.body6.us.us:                                  ; preds = %for.inc25.us.us, %for.body6.us.us.preheader
  %indvars.iv3759.us.us = phi i64 [ 0, %for.body6.us.us.preheader ], [ %indvars.iv.next38.us.us, %for.inc25.us.us ]
  %arrayidx8.us.us = getelementptr inbounds [900 x double], [900 x double]* %tmp, i64 %indvars.iv3962.us, i64 %indvars.iv3759.us.us
  store double 0.000000e+00, double* %arrayidx8.us.us, align 8
  %sunkaddr41.us.us = shl i64 %indvars.iv3759.us.us, 3
  %sunkaddr42.us.us = add i64 %sunkaddr41.us.us, %0
  %sunkaddr43.us.us = inttoptr i64 %sunkaddr42.us.us to double*
  %.pre = load double, double* %sunkaddr43.us.us, align 8
  br label %for.inc.us.us

for.inc25.us.us:                                  ; preds = %for.inc.us.us
  %indvars.iv.next38.us.us = add nuw nsw i64 %indvars.iv3759.us.us, 1
  %exitcond9 = icmp eq i64 %indvars.iv.next38.us.us, 900
  br i1 %exitcond9, label %for.inc28.us, label %for.body6.us.us

for.inc.us.us:                                    ; preds = %for.inc.us.us, %for.body6.us.us
  %1 = phi double [ %.pre, %for.body6.us.us ], [ %add.us.us.1, %for.inc.us.us ]
  %indvars.iv3557.us.us = phi i64 [ 0, %for.body6.us.us ], [ %indvars.iv.next36.us.us.1, %for.inc.us.us ]
  %arrayidx15.us.us = getelementptr inbounds [1100 x double], [1100 x double]* %A, i64 %indvars.iv3962.us, i64 %indvars.iv3557.us.us
  %2 = load double, double* %arrayidx15.us.us, align 8
  %mul.us.us = fmul double %2, %alpha
  %arrayidx19.us.us = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv3557.us.us, i64 %indvars.iv3759.us.us
  %3 = load double, double* %arrayidx19.us.us, align 8
  %mul20.us.us = fmul double %mul.us.us, %3
  %add.us.us = fadd double %1, %mul20.us.us
  store double %add.us.us, double* %sunkaddr43.us.us, align 8
  %indvars.iv.next36.us.us = or i64 %indvars.iv3557.us.us, 1
  %arrayidx15.us.us.1 = getelementptr inbounds [1100 x double], [1100 x double]* %A, i64 %indvars.iv3962.us, i64 %indvars.iv.next36.us.us
  %4 = load double, double* %arrayidx15.us.us.1, align 8
  %mul.us.us.1 = fmul double %4, %alpha
  %arrayidx19.us.us.1 = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv.next36.us.us, i64 %indvars.iv3759.us.us
  %5 = load double, double* %arrayidx19.us.us.1, align 8
  %mul20.us.us.1 = fmul double %mul.us.us.1, %5
  %add.us.us.1 = fadd double %add.us.us, %mul20.us.us.1
  store double %add.us.us.1, double* %sunkaddr43.us.us, align 8
  %indvars.iv.next36.us.us.1 = add nsw i64 %indvars.iv3557.us.us, 2
  %exitcond8.1 = icmp eq i64 %indvars.iv.next36.us.us.1, 1100
  br i1 %exitcond8.1, label %for.inc25.us.us, label %for.inc.us.us

for.body36.us.us.preheader:                       ; preds = %for.body36.us.us.preheader.preheader, %for.inc65.us
  %indvars.iv3354.us = phi i64 [ %indvars.iv.next34.us, %for.inc65.us ], [ 0, %for.body36.us.us.preheader.preheader ]
  %arrayidx38.us = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv3354.us
  %6 = ptrtoint [1200 x double]* %arrayidx38.us to i64
  br label %for.body36.us.us

for.inc65.us:                                     ; preds = %for.inc62.us.us
  %indvars.iv.next34.us = add nuw nsw i64 %indvars.iv3354.us, 1
  %exitcond7 = icmp eq i64 %indvars.iv.next34.us, 800
  br i1 %exitcond7, label %for.end67, label %for.body36.us.us.preheader

for.body36.us.us:                                 ; preds = %for.inc62.us.us, %for.body36.us.us.preheader
  %indvars.iv3151.us.us = phi i64 [ 0, %for.body36.us.us.preheader ], [ %indvars.iv.next32.us.us, %for.inc62.us.us ]
  %arrayidx40.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv3354.us, i64 %indvars.iv3151.us.us
  %7 = load double, double* %arrayidx40.us.us, align 8
  %mul41.us.us = fmul double %7, %beta
  store double %mul41.us.us, double* %arrayidx40.us.us, align 8
  %sunkaddr45.us.us = shl i64 %indvars.iv3151.us.us, 3
  %sunkaddr46.us.us = add i64 %sunkaddr45.us.us, %6
  %sunkaddr47.us.us = inttoptr i64 %sunkaddr46.us.us to double*
  %.pre5 = load double, double* %sunkaddr47.us.us, align 8
  br label %for.inc59.us.us

for.inc62.us.us:                                  ; preds = %for.inc59.us.us
  %indvars.iv.next32.us.us = add nuw nsw i64 %indvars.iv3151.us.us, 1
  %exitcond6 = icmp eq i64 %indvars.iv.next32.us.us, 1200
  br i1 %exitcond6, label %for.inc65.us, label %for.body36.us.us

for.inc59.us.us:                                  ; preds = %for.inc59.us.us, %for.body36.us.us
  %8 = phi double [ %.pre5, %for.body36.us.us ], [ %add58.us.us.2, %for.inc59.us.us ]
  %indvars.iv49.us.us = phi i64 [ 0, %for.body36.us.us ], [ %indvars.iv.next.us.us.2, %for.inc59.us.us ]
  %arrayidx48.us.us = getelementptr inbounds [900 x double], [900 x double]* %tmp, i64 %indvars.iv3354.us, i64 %indvars.iv49.us.us
  %9 = load double, double* %arrayidx48.us.us, align 8
  %arrayidx52.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv49.us.us, i64 %indvars.iv3151.us.us
  %10 = load double, double* %arrayidx52.us.us, align 8
  %mul53.us.us = fmul double %9, %10
  %add58.us.us = fadd double %8, %mul53.us.us
  store double %add58.us.us, double* %sunkaddr47.us.us, align 8
  %indvars.iv.next.us.us = add nuw nsw i64 %indvars.iv49.us.us, 1
  %arrayidx48.us.us.1 = getelementptr inbounds [900 x double], [900 x double]* %tmp, i64 %indvars.iv3354.us, i64 %indvars.iv.next.us.us
  %11 = load double, double* %arrayidx48.us.us.1, align 8
  %arrayidx52.us.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv.next.us.us, i64 %indvars.iv3151.us.us
  %12 = load double, double* %arrayidx52.us.us.1, align 8
  %mul53.us.us.1 = fmul double %11, %12
  %add58.us.us.1 = fadd double %add58.us.us, %mul53.us.us.1
  store double %add58.us.us.1, double* %sunkaddr47.us.us, align 8
  %indvars.iv.next.us.us.1 = add nsw i64 %indvars.iv49.us.us, 2
  %arrayidx48.us.us.2 = getelementptr inbounds [900 x double], [900 x double]* %tmp, i64 %indvars.iv3354.us, i64 %indvars.iv.next.us.us.1
  %13 = load double, double* %arrayidx48.us.us.2, align 8
  %arrayidx52.us.us.2 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv.next.us.us.1, i64 %indvars.iv3151.us.us
  %14 = load double, double* %arrayidx52.us.us.2, align 8
  %mul53.us.us.2 = fmul double %13, %14
  %add58.us.us.2 = fadd double %add58.us.us.1, %mul53.us.us.2
  store double %add58.us.us.2, double* %sunkaddr47.us.us, align 8
  %indvars.iv.next.us.us.2 = add nsw i64 %indvars.iv49.us.us, 3
