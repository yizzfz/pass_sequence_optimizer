...
.preheader.us:                                    ; preds = %.loopexit.us, %..preheader.us_crit_edge
  %indvars.iv16 = phi i64 [ 0, %..preheader.us_crit_edge ], [ %indvars.iv.next17, %.loopexit.us ]
...
._crit_edge15:                                    ; preds = %._crit_edge15, %.preheader.us
  ...
  %13 = srem i32 %8, 11
  %14 = icmp eq i32 %13, 0
  %or.cond14 = or i1 %or.cond, %14
  %. = select i1 %or.cond14, i32 999, i32 %5
...
.loopexit.us:                                     ; preds = %._crit_edge15
  ...
  br i1 %exitcond18, label %.loopexit9, label %.preheader.us
...
.preheader3.us:                                   ; preds = %.loopexit8.us-lcssa.us.us, %.preheader3.lr.ph
  %indvars.iv31 = phi i64 [ 0, %.preheader3.lr.ph ], [ %indvars.iv.next32, %.loopexit8.us-lcssa.us.us ]
...
.preheader.us.us:                                 ; preds = %.loopexit.us.us, %.preheader3.us
  %indvars.iv29 = phi i64 [ 0, %.preheader3.us ], [ %indvars.iv.next30, %.loopexit.us.us ]
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %14 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv31, i64 %index
  %15 = bitcast i32* %14 to <4 x i32>*
  %wide.load48 = load <4 x i32>, <4 x i32>* %15, align 4, !alias.scope !8
  %16 = getelementptr i32, i32* %14, i64 4
  %17 = bitcast i32* %16 to <4 x i32>*
  %wide.load49 = load <4 x i32>, <4 x i32>* %17, align 4, !alias.scope !8
  %18 = add nsw <4 x i32> %wide.load48, %11
  %19 = add nsw <4 x i32> %wide.load49, %13
  %20 = icmp slt <4 x i32> %wide.load, %18
  %21 = icmp slt <4 x i32> %wide.load47, %19
  %22 = select <4 x i1> %20, <4 x i32> %wide.load, <4 x i32> %18
  %23 = select <4 x i1> %21, <4 x i32> %wide.load47, <4 x i32> %19
  ...
  br i1 %26, label %.loopexit.us.us.loopexit51, label %vector.body, !llvm.loop !9

.loopexit.us.us.loopexit:                         ; preds = %scalar.ph
  br label %.loopexit.us.us

.loopexit.us.us.loopexit51:                       ; preds = %vector.body
  br label %.loopexit.us.us

.loopexit.us.us:                                  ; preds = %.loopexit.us.us.loopexit51, %.loopexit.us.us.loopexit
  %indvars.iv.next30 = add nuw nsw i64 %indvars.iv29, 1
  %exitcond33 = icmp eq i64 %indvars.iv.next30, 2800
  br i1 %exitcond33, label %.loopexit8.us-lcssa.us.us, label %.preheader.us.us

scalar.ph:                                        ; preds = %scalar.ph.preheader, %._crit_edge50
  %indvars.iv = phi i64 [ %indvars.iv.next, %._crit_edge50 ], [ 0, %scalar.ph.preheader ]
  %27 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv29, i64 %indvars.iv
  %28 = load i32, i32* %27, align 4
  %29 = load i32, i32* %4, align 4
  %30 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv31, i64 %indvars.iv
  ...
  br i1 %exitcond, label %.loopexit.us.us.loopexit, label %._crit_edge50, !llvm.loop !12

._crit_edge50:                                    ; preds = %scalar.ph
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %scalar.ph
...
._crit_edge:                                      ; preds = %._crit_edge8, %11
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 2800
  br i1 %exitcond, label %.loopexit.us, label %._crit_edge8
