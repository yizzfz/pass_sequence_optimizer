...
for.inc:                                          ; preds = %for.inc, %for.inc.preheader
  %indvars.iv = phi i64 [ 0, %for.inc.preheader ], [ %indvars.iv.next.4, %for.inc ]
...
for.body:                                         ; preds = %for.inc47.for.body_crit_edge, %for.body.lr.ph
  ...
  %5 = phi double [ %div4849, %for.inc47.for.body_crit_edge ], [ %sub3, %for.body.lr.ph ]
  ...
  %cmp76 = icmp sgt i64 %indvars.iv41, 0
  br i1 %cmp76, label %for.body.for.inc_crit_edge, label %for.end.thread
...
for.inc.prol.preheader:                           ; preds = %for.body.for.inc_crit_edge
...
for.inc.prol.loopexit.unr-lcssa:                  ; preds = %for.body.for.inc_crit_edge, %for.inc.prol
  %add.lcssa.unr.ph = phi double [ %add.prol, %for.inc.prol ], [ undef, %for.body.for.inc_crit_edge ]
  %indvars.iv.unr.ph = phi i64 [ 1, %for.inc.prol ], [ 0, %for.body.for.inc_crit_edge ]
  %add9.unr.ph = phi double [ %add.prol, %for.inc.prol ], [ 0.000000e+00, %for.body.for.inc_crit_edge ]
  br label %for.inc.prol.loopexit

for.inc.prol.loopexit:                            ; preds = %for.inc.prol.loopexit.unr-lcssa
  %12 = icmp eq i32 %indvar, 0
  br i1 %12, label %for.end.for.inc32_crit_edge, label %for.body.for.inc_crit_edge.new

for.body.for.inc_crit_edge.new:                   ; preds = %for.inc.prol.loopexit
  br label %for.inc
...
for.inc:                                          ; preds = %for.inc, %for.body.for.inc_crit_edge.new
  %indvars.iv = phi i64 [ %indvars.iv.unr.ph, %for.body.for.inc_crit_edge.new ], [ %indvars.iv.next.1, %for.inc ]
  %add9 = phi double [ %add9.unr.ph, %for.body.for.inc_crit_edge.new ], [ %add.1, %for.inc ]
  ...
  br i1 %exitcond.1, label %for.end.for.inc32_crit_edge.unr-lcssa, label %for.inc

for.end.for.inc32_crit_edge.unr-lcssa:            ; preds = %for.inc
  br label %for.end.for.inc32_crit_edge

for.end.for.inc32_crit_edge:                      ; preds = %for.inc.prol.loopexit, %for.end.for.inc32_crit_edge.unr-lcssa
  %add.lcssa = phi double [ %add.lcssa.unr.ph, %for.inc.prol.loopexit ], [ %add.1, %for.end.for.inc32_crit_edge.unr-lcssa ]
...
for.inc32.prol.preheader:                         ; preds = %for.end.for.inc32_crit_edge
...
for.inc32.prol.loopexit.unr-lcssa:                ; preds = %for.end.for.inc32_crit_edge, %for.inc32.prol
  %indvars.iv27.unr.ph = phi i64 [ 1, %for.inc32.prol ], [ 0, %for.end.for.inc32_crit_edge ]
  br label %for.inc32.prol.loopexit

for.inc32.prol.loopexit:                          ; preds = %for.inc32.prol.loopexit.unr-lcssa
  %24 = icmp eq i32 %indvar, 0
  br i1 %24, label %for.inc42.lr.ph, label %for.end.for.inc32_crit_edge.new

for.end.for.inc32_crit_edge.new:                  ; preds = %for.inc32.prol.loopexit
  br label %for.inc32

for.inc42.lr.ph.unr-lcssa:                        ; preds = %for.inc32
  br label %for.inc42.lr.ph

for.inc42.lr.ph:                                  ; preds = %for.inc32.prol.loopexit, %for.inc42.lr.ph.unr-lcssa
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* nonnull %3, i64 %8, i32 8, i1 false)
  br label %for.inc47

for.inc32:                                        ; preds = %for.inc32, %for.end.for.inc32_crit_edge.new
  %indvars.iv27 = phi i64 [ %indvars.iv27.unr.ph, %for.end.for.inc32_crit_edge.new ], [ %indvars.iv.next28.1, %for.inc32 ]
  ...
  br i1 %exitcond33.1, label %for.inc42.lr.ph.unr-lcssa, label %for.inc32

for.inc47:                                        ; preds = %for.end.thread, %for.inc42.lr.ph
  %div4849 = phi double [ %div, %for.inc42.lr.ph ], [ %div47, %for.end.thread ]
