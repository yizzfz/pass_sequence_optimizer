...
.loopexit:                                        ; preds = %.loopexit.loopexit, %.split
  ...
  br i1 %87, label %.loopexit1.loopexit24, label %.split

.loopexit1.loopexit:                              ; preds = %20
  call void @llvm.memset.p0i8.i64(i8* %scevgep, i8 0, i64 %12, i32 1, i1 false)
  br label %.loopexit1

.loopexit1.loopexit24:                            ; preds = %.loopexit
  br label %.loopexit1

.loopexit1:                                       ; preds = %.loopexit1.loopexit24, %.loopexit1.loopexit, %17
...
; <label>:40:                                     ; preds = %40, %.split.us.split
...
.us-lcssa.us:                                     ; preds = %.us-lcssa.us.loopexit19, %.us-lcssa.us.loopexit, %.split.us
  %.lcssa4 = phi float [ undef, %.split.us ], [ %58, %.us-lcssa.us.loopexit ], [ %79, %.us-lcssa.us.loopexit19 ]
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %.split
  ...
  br i1 %80, label %.us-lcssa.us.loopexit19, label %.split
...
; <label>:115:                                    ; preds = %.preheader, %115
  %116 = phi i64 [ %136, %115 ], [ %16, %.preheader ]
  %117 = add i64 %116, %5
...
; <label>:163:                                    ; preds = %170
  ...
  %167 = getelementptr inbounds [100 x i8], [100 x i8]* %1, i64 0, i64 0
