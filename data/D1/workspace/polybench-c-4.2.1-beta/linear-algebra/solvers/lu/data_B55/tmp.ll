...
.preheader.us.preheader:                          ; preds = %._crit_edge
  %xtraiter78 = and i64 %indvars.iv72, 1
  %6 = icmp eq i64 %xtraiter78, 0
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge40.us
  ...
  br i1 %6, label %.prol.loopexit77, label %9
...
.prol.loopexit77:                                 ; preds = %.preheader.us, %9
  %indvars.iv61.unr.ph = phi i64 [ 1, %9 ], [ 0, %.preheader.us ]
  %.unr80.ph = phi double [ %14, %9 ], [ %.pre50, %.preheader.us ]
...
.preheader.us.new:                                ; preds = %.preheader.us.new.preheader, %.preheader.us.new
  ...
  %15 = phi double [ %27, %.preheader.us.new ], [ %.unr80.ph, %.preheader.us.new.preheader ]
...
._crit_edge40.us:                                 ; preds = %._crit_edge40.us.loopexit, %.prol.loopexit77
