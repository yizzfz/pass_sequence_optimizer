...
.preheader9.us.us.preheader:                      ; preds = %.preheader9.us.us.preheader.preheader, %._crit_edge21.us
  ...
  %37 = add nsw i64 %indvars.iv59, -1999
  %scevgep102 = getelementptr [2000 x double], [2000 x double]* %1, i64 2000, i64 %37
...
.preheader9.us.us:                                ; preds = %._crit_edge19.us.us, %.preheader9.us.us.preheader
  ...
  %38 = mul nuw nsw i64 %indvars.iv55, 16000
  %scevgep98 = getelementptr i8, i8* %19, i64 %38
  %39 = add i64 16000, %38
  %scevgep99 = getelementptr i8, i8* %19, i64 %39
  %40 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv55, i64 %indvars.iv59
...
._crit_edge93.prol:                               ; preds = %._crit_edge93.prol.preheader
  ...
  %42 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv51.ph, i64 %indvars.iv59
  %43 = load double, double* %42, align 8
  %44 = fmul double %41, %43
  %45 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv55, i64 %indvars.iv51.ph
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %56 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %index, i64 %indvars.iv59
  ...
  %59 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %50, i64 %indvars.iv59
  ...
  %70 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv55, i64 %index
  ...
  %wide.load109 = load <2 x double>, <2 x double>* %73, align 8, !alias.scope !8, !noalias !10
  %74 = fadd <2 x double> %wide.load, %68
  %75 = fadd <2 x double> %wide.load109, %69
...
._crit_edge93:                                    ; preds = %._crit_edge93, %._crit_edge93.preheader.new
  ...
  %80 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv51, i64 %indvars.iv59
  %81 = load double, double* %80, align 8
  %82 = fmul double %79, %81
  %83 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv55, i64 %indvars.iv51
  %84 = load double, double* %83, align 8
  %85 = fadd double %84, %82
  store double %85, double* %83, align 8
  %indvars.iv.next52 = add nuw nsw i64 %indvars.iv51, 1
  %86 = load double, double* %40, align 8
  %87 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv.next52, i64 %indvars.iv59
  %88 = load double, double* %87, align 8
  %89 = fmul double %86, %88
  %90 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv55, i64 %indvars.iv.next52
  ...
  br i1 %exitcond54.1, label %._crit_edge19.us.us.loopexit.unr-lcssa, label %._crit_edge93, !llvm.loop !14
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  ...
  %scevgep123 = getelementptr i8, i8* %19, i64 %93
  %94 = add i64 16000, %93
  %scevgep124 = getelementptr i8, i8* %19, i64 %94
...
vector.body110:                                   ; preds = %vector.body110.preheader, %vector.body110
  ...
  %95 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv47, i64 %index131
  %96 = bitcast double* %95 to <2 x i64>*
  %wide.load139 = load <2 x i64>, <2 x i64>* %96, align 8, !alias.scope !15
  %97 = getelementptr double, double* %95, i64 2
  %98 = bitcast double* %97 to <2 x i64>*
  %wide.load140 = load <2 x i64>, <2 x i64>* %98, align 8, !alias.scope !15
  %99 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv47, i64 %index131
  %100 = bitcast double* %99 to <2 x i64>*
  store <2 x i64> %wide.load139, <2 x i64>* %100, align 8, !alias.scope !18, !noalias !15
  %101 = getelementptr double, double* %99, i64 2
  %102 = bitcast double* %101 to <2 x i64>*
  store <2 x i64> %wide.load140, <2 x i64>* %102, align 8, !alias.scope !18, !noalias !15
  %index.next132 = add i64 %index131, 4
  %103 = icmp eq i64 %index.next132, 2000
  br i1 %103, label %middle.block111, label %vector.body110, !llvm.loop !20
...
._crit_edge94.prol.loopexit:                      ; preds = %._crit_edge94.preheader, %._crit_edge94.prol.loopexit.unr-lcssa
  ...
  br i1 %110, label %._crit_edge.us.loopexit, label %._crit_edge94.preheader.new
...
._crit_edge16:                                    ; preds = %._crit_edge16.loopexit, %._crit_edge42.thread
  %131 = phi i8* [ %3, %._crit_edge42.thread ], [ %19, %._crit_edge16.loopexit ]
