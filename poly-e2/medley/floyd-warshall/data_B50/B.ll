...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %8 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv59, i64 %index
  %9 = bitcast i32* %8 to <4 x i32>*
  %wide.load74 = load <4 x i32>, <4 x i32>* %9, align 4, !alias.scope !8
  %10 = getelementptr i32, i32* %8, i64 4
  %11 = bitcast i32* %10 to <4 x i32>*
  %wide.load75 = load <4 x i32>, <4 x i32>* %11, align 4, !alias.scope !8
  %12 = add nsw <4 x i32> %wide.load74, %7
  %13 = add nsw <4 x i32> %wide.load75, %7
  %14 = icmp slt <4 x i32> %wide.load, %12
  %15 = icmp slt <4 x i32> %wide.load73, %13
  %predphi = select <4 x i1> %14, <4 x i32> %wide.load, <4 x i32> %12
  %predphi76 = select <4 x i1> %15, <4 x i32> %wide.load73, <4 x i32> %13
  store <4 x i32> %predphi, <4 x i32>* %2, align 4, !alias.scope !1, !noalias !4
  store <4 x i32> %predphi76, <4 x i32>* %4, align 4, !alias.scope !1, !noalias !4
...
for.body6.us.us:                                  ; preds = %for.body6.us.us.preheader, %for.body6.us.us
  ...
  %17 = load i32, i32* %arrayidx8.us.us, align 4
  %18 = load i32, i32* %arrayidx12.us.us, align 4
  %arrayidx16.us.us = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv59, i64 %indvars.iv
  %19 = load i32, i32* %arrayidx16.us.us, align 4
  %add.us.us = add nsw i32 %19, %18
  %cmp17.us.us = icmp slt i32 %17, %add.us.us
  %.add.us.us = select i1 %cmp17.us.us, i32 %17, i32 %add.us.us
