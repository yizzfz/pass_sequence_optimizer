...
; <label>:11:                                     ; preds = %11, %.lr.ph4.split.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %11 ], [ 0, %.lr.ph4.split.us ]
  %12 = mul nsw i64 %indvars.iv, %indvars.iv11
  %13 = add nsw i64 %12, 1
  ...
  %27 = getelementptr inbounds [1300 x double], [1300 x double]* %4, i64 %indvars.iv11, i64 %indvars.iv
  store double %26, double* %27, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %28 = icmp slt i64 %indvars.iv.next, 1300
  br i1 %28, label %11, label %._crit_edge.us

._crit_edge.us:                                   ; preds = %11
  %indvars.iv.next12 = add nsw i64 %indvars.iv11, 1
  %29 = icmp slt i64 %indvars.iv.next12, 1300
  br i1 %29, label %.lr.ph4.split.us, label %._crit_edge5
...
.lr.ph3:
  ...
  %sunkaddr27 = ptrtoint double* %7 to i64
  br label %.lr.ph3.split.us

.lr.ph3.split.us:                                 ; preds = %.lr.ph3, %._crit_edge.us
  %indvars.iv11 = phi i64 [ 0, %.lr.ph3 ], [ %indvars.iv.next12, %._crit_edge.us ]
  %8 = getelementptr inbounds double, double* %5, i64 %indvars.iv11
  store double 0.000000e+00, double* %8, align 8
  %9 = getelementptr inbounds double, double* %7, i64 %indvars.iv11
...
; <label>:10:                                     ; preds = %10, %.lr.ph3.split.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %10 ], [ 0, %.lr.ph3.split.us ]
  ...
  %16 = load double, double* %sunkaddr22, align 8
  ...
  %22 = load double, double* %sunkaddr30, align 8
  %23 = fadd double %21, %22
  store double %23, double* %sunkaddr30, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %24 = icmp slt i64 %indvars.iv.next, 1300
  br i1 %24, label %10, label %._crit_edge.us
...
._crit_edge.us:                                   ; preds = %10
  ...
  %indvars.iv.next12 = add nsw i64 %indvars.iv11, 1
  %30 = icmp slt i64 %indvars.iv.next12, 1300
  br i1 %30, label %.lr.ph3.split.us, label %._crit_edge4
...
._crit_edge:                                      ; preds = %6, %10
  ...
  %16 = icmp slt i64 %indvars.iv.next, 1300
  br i1 %16, label %6, label %._crit_edge2
