...
for.body21.lr.ph:                                 ; preds = %for.body21.lr.ph.loopexit, %for.body8.prol.loopexit
  ...
  %26 = add nsw i64 %indvars.iv60, -1
  %27 = and i64 %indvar, 1
  %lcmp.mod66 = icmp eq i64 %27, 0
...
for.body21.preheader:                             ; preds = %for.body21.prol.loopexit
  %31 = sub i64 %6, %indvars.iv45.unr.ph
  %32 = lshr i64 %31, 1
  %33 = add nuw i64 %32, 1
...
min.iters.checked:                                ; preds = %for.body21.preheader
  ...
  %34 = or i64 %indvars.iv45.unr.ph, 2
  %35 = shl nuw i64 %32, 1
  %36 = add i64 %34, %35
...
vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert77 = insertelement <2 x double> undef, double %div, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %38 = shl i64 %index, 1
  %offset.idx = or i64 %indvars.iv45.unr.ph, %38
  ...
  %strided.vec72 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  ...
  %wide.vec73 = load <4 x double>, <4 x double>* %44, align 8
  %strided.vec74 = shufflevector <4 x double> %wide.vec73, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %reverse = shufflevector <2 x double> %strided.vec74, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %strided.vec75 = shufflevector <4 x double> %wide.vec73, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %reverse76 = shufflevector <2 x double> %strided.vec75, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %45 = fmul <2 x double> %broadcast.splat78, %reverse76
  %46 = fadd <2 x double> %strided.vec, %45
  %47 = add nuw nsw i64 %offset.idx, 1
  %48 = fmul <2 x double> %broadcast.splat78, %reverse
  %49 = fadd <2 x double> %strided.vec72, %48
...
for.body21:                                       ; preds = %for.body21.preheader1, %for.body21
  %indvars.iv45 = phi i64 [ %indvars.iv.next46.1, %for.body21 ], [ %indvars.iv45.ph, %for.body21.preheader1 ]
  ...
  %57 = sub nsw i64 %26, %indvars.iv.next46
