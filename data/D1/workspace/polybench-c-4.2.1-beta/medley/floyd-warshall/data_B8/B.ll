...
; <label>:2:                                      ; preds = %2, %.preheader.us
  ...
  %5 = srem i32 %4, 7
  %6 = add nsw i32 %5, 1
  %7 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv22, i64 %indvars.iv
  %8 = add nuw nsw i64 %indvars.iv, %indvars.iv22
  ...
  %16 = srem i32 %15, 11
  %17 = icmp eq i32 %16, 0
  %or.cond16.us = or i1 %17, %or.cond.us
  %..us = select i1 %or.cond16.us, i32 999, i32 %6
...
._crit_edge.us:                                   ; preds = %2
  ...
  %exitcond24 = icmp eq i64 %indvars.iv.next23, 2800
  br i1 %exitcond24, label %._crit_edge21, label %.preheader.us
...
.preheader.us.us.preheader:                       ; preds = %.preheader24.lr.ph, %._crit_edge27.us
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %._crit_edge27.us ], [ 0, %.preheader24.lr.ph ]
  br label %.preheader.us.us

._crit_edge27.us:                                 ; preds = %._crit_edge.us.us
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  %exitcond43 = icmp eq i64 %indvars.iv.next42, 2800
  br i1 %exitcond43, label %._crit_edge29, label %.preheader.us.us.preheader

.preheader.us.us:                                 ; preds = %._crit_edge.us.us, %.preheader.us.us.preheader
  %indvars.iv39 = phi i64 [ 0, %.preheader.us.us.preheader ], [ %indvars.iv.next40, %._crit_edge.us.us ]
  %2 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv39, i64 %indvars.iv41
  br label %3

._crit_edge.us.us:                                ; preds = %3
  %indvars.iv.next40 = add nuw nsw i64 %indvars.iv39, 1
  %exitcond = icmp eq i64 %indvars.iv.next40, 2800
  br i1 %exitcond, label %._crit_edge27.us, label %.preheader.us.us

; <label>:3:                                      ; preds = %3, %.preheader.us.us
  %indvars.iv = phi i64 [ 0, %.preheader.us.us ], [ %indvars.iv.next.1, %3 ]
  %4 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv39, i64 %indvars.iv
  %5 = load i32, i32* %4, align 4
  %6 = load i32, i32* %2, align 4
  %7 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv41, i64 %indvars.iv
  %8 = load i32, i32* %7, align 4
  %9 = add nsw i32 %8, %6
  %10 = icmp slt i32 %5, %9
  %..us.us = select i1 %10, i32 %5, i32 %9
  store i32 %..us.us, i32* %4, align 4
  %indvars.iv.next = or i64 %indvars.iv, 1
  %11 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv39, i64 %indvars.iv.next
  %12 = load i32, i32* %11, align 4
  %13 = load i32, i32* %2, align 4
  %14 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv41, i64 %indvars.iv.next
  %15 = load i32, i32* %14, align 4
  %16 = add nsw i32 %15, %13
  %17 = icmp slt i32 %12, %16
  %..us.us.1 = select i1 %17, i32 %12, i32 %16
  store i32 %..us.us.1, i32* %11, align 4
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2800
  br i1 %exitcond.1, label %._crit_edge.us.us, label %3
...
; <label>:14:                                     ; preds = %12, %7
  ...
  %16 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv12, i64 %indvars.iv
