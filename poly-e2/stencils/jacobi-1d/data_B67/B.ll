...
for.body.preheader:                               ; preds = %entry
  ...
  %sub = add nsw i64 %0, -1
  %1 = icmp sgt i64 %sub, 2
  %smax = select i1 %1, i64 %sub, i64 2
  ...
  %scevgep38 = getelementptr double, double* %B, i64 1
  %scevgep41 = getelementptr double, double* %B, i64 %smax
  %scevgep43 = getelementptr double, double* %A, i64 %3
  %4 = icmp sgt i32 %sub3, 1
  %min.iters.check32 = icmp ult i64 %2, 4
  %n.vec = and i64 %2, -4
  ...
  %bound045 = icmp ult double* %scevgep38, %scevgep43
  %bound146 = icmp ugt double* %scevgep41, %A
...
for.body:                                         ; preds = %for.body.preheader, %for.inc33
  ...
  br i1 %4, label %for.inc.preheader, label %for.inc33

for.inc.preheader:                                ; preds = %for.body
  br i1 %min.iters.check32, label %for.inc.preheader68, label %min.iters.checked33

min.iters.checked33:                              ; preds = %for.inc.preheader
  br i1 %cmp.zero, label %for.inc.preheader68, label %vector.memcheck49

vector.memcheck49:                                ; preds = %min.iters.checked33
  br i1 %found.conflict47, label %for.inc.preheader68, label %vector.body28.preheader

vector.body28.preheader:                          ; preds = %vector.memcheck49
  br label %vector.body28

vector.body28:                                    ; preds = %vector.body28.preheader, %vector.body28
  %index51 = phi i64 [ %index.next52, %vector.body28 ], [ 0, %vector.body28.preheader ]
  %offset.idx56 = or i64 %index51, 1
  %5 = getelementptr inbounds double, double* %A, i64 %index51
  ...
  %9 = getelementptr inbounds double, double* %A, i64 %offset.idx56
  %10 = bitcast double* %9 to <2 x double>*
  %wide.load63 = load <2 x double>, <2 x double>* %10, align 8, !alias.scope !1
  %11 = getelementptr double, double* %9, i64 2
  %12 = bitcast double* %11 to <2 x double>*
  %wide.load64 = load <2 x double>, <2 x double>* %12, align 8, !alias.scope !1
  %13 = fadd <2 x double> %wide.load61, %wide.load63
  %14 = fadd <2 x double> %wide.load62, %wide.load64
  %15 = add nuw nsw i64 %offset.idx56, 1
  %16 = getelementptr inbounds double, double* %A, i64 %15
  %17 = getelementptr double, double* %16, i64 2
  %18 = bitcast double* %17 to <2 x double>*
  %wide.load66 = load <2 x double>, <2 x double>* %18, align 8, !alias.scope !1
  %19 = fadd <2 x double> %13, %wide.load62
  %20 = fadd <2 x double> %14, %wide.load66
  ...
  %23 = getelementptr inbounds double, double* %B, i64 %offset.idx56
  ...
  %index.next52 = add i64 %index51, 4
  %27 = icmp eq i64 %index.next52, %n.vec
  br i1 %27, label %middle.block29, label %vector.body28, !llvm.loop !6

middle.block29:                                   ; preds = %vector.body28
  br i1 %cmp.n, label %for.end, label %for.inc.preheader68

for.inc.preheader68:                              ; preds = %middle.block29, %vector.memcheck49, %min.iters.checked33, %for.inc.preheader
  %indvars.iv.ph = phi i64 [ 1, %vector.memcheck49 ], [ 1, %min.iters.checked33 ], [ 1, %for.inc.preheader ], [ %ind.end, %middle.block29 ]
  br label %for.inc

for.inc:                                          ; preds = %for.inc.preheader68, %for.inc
  %indvars.iv = phi i64 [ %add7, %for.inc ], [ %indvars.iv.ph, %for.inc.preheader68 ]
...
for.inc30.preheader:                              ; preds = %for.end
  br i1 %min.iters.check32, label %for.inc30.preheader67, label %min.iters.checked

min.iters.checked:                                ; preds = %for.inc30.preheader
  br i1 %cmp.zero, label %for.inc30.preheader67, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  br i1 %found.conflict, label %for.inc30.preheader67, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load = load <2 x double>, <2 x double>* %32, align 8, !alias.scope !10
  %33 = getelementptr double, double* %31, i64 2
  %34 = bitcast double* %33 to <2 x double>*
  %wide.load23 = load <2 x double>, <2 x double>* %34, align 8, !alias.scope !10
  %35 = getelementptr inbounds double, double* %B, i64 %offset.idx
  %36 = bitcast double* %35 to <2 x double>*
  %wide.load24 = load <2 x double>, <2 x double>* %36, align 8, !alias.scope !10
  %37 = getelementptr double, double* %35, i64 2
  %38 = bitcast double* %37 to <2 x double>*
  %wide.load25 = load <2 x double>, <2 x double>* %38, align 8, !alias.scope !10
  %39 = fadd <2 x double> %wide.load, %wide.load24
  %40 = fadd <2 x double> %wide.load23, %wide.load25
  ...
  %wide.load27 = load <2 x double>, <2 x double>* %44, align 8, !alias.scope !10
  %45 = fadd <2 x double> %39, %wide.load23
  %46 = fadd <2 x double> %40, %wide.load27
  ...
  br i1 %53, label %middle.block, label %vector.body, !llvm.loop !15

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %for.inc33, label %for.inc30.preheader67

for.inc30.preheader67:                            ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.inc30.preheader
  %indvars.iv14.ph = phi i64 [ 1, %vector.memcheck ], [ 1, %min.iters.checked ], [ 1, %for.inc30.preheader ], [ %ind.end, %middle.block ]
  br label %for.inc30

for.inc30:                                        ; preds = %for.inc30.preheader67, %for.inc30
  %indvars.iv14 = phi i64 [ %add23, %for.inc30 ], [ %indvars.iv14.ph, %for.inc30.preheader67 ]
