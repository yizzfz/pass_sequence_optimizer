...
; <label>:14:                                     ; preds = %14, %.preheader40.us
  ...
  %exitcond74 = icmp eq i64 %indvars.iv.next73, %11
...
._crit_edge50.us:                                 ; preds = %14
  ...
  br i1 %exitcond78, label %.preheader.lr.ph.loopexit, label %.preheader40.us
...
.preheader.lr.ph:                                 ; preds = %.preheader.lr.ph.loopexit, %.preheader40.lr.ph..preheader.lr.ph_crit_edge
  %wide.trip.count60.7.pre-phi = phi i64 [ %.pre, %.preheader40.lr.ph..preheader.lr.ph_crit_edge ], [ %wide.trip.count77, %.preheader.lr.ph.loopexit ]
  %27 = add i32 %0, 7
  %28 = add i32 %0, -2
  %29 = sext i32 %0 to i64
  %30 = add nsw i64 %wide.trip.count60.7.pre-phi, -8
  %31 = trunc i32 %27 to i3
  br label %.lr.ph
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %middle.block, %.prol.loopexit62, %._crit_edge
  ...
  %exitcond = icmp eq i64 %indvars.iv.next70, %wide.trip.count60.7.pre-phi
...
.lr.ph:                                           ; preds = %.preheader.lr.ph, %.loopexit
  %indvars.iv85 = phi i3 [ %31, %.preheader.lr.ph ], [ %indvars.iv.next86, %.loopexit ]
  ...
  %32 = zext i3 %indvars.iv85 to i32
  %33 = add i32 %32, -1
  %34 = zext i32 %33 to i64
  %35 = add i64 %indvars.iv83, %34
  %36 = sub nsw i64 0, %indvars.iv69
...
.prol.preheader:                                  ; preds = %.lr.ph
  %40 = trunc i64 %indvars.iv69 to i32
  %41 = srem i32 %40, 100
  %42 = sitofp i32 %41 to double
  %43 = fdiv double %42, %10
  %44 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 0
  store double %43, double* %44, align 8
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph
  %indvars.iv.unr.ph = phi i64 [ 1, %.prol.preheader ], [ 0, %.lr.ph ]
  %45 = icmp eq i64 %indvars.iv69, 0
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %46 = add nuw nsw i64 %indvars.iv, %indvars.iv69
  %47 = trunc i64 %46 to i32
  %48 = srem i32 %47, 100
  %49 = sitofp i32 %48 to double
  %50 = fdiv double %49, %10
  %51 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv
  store double %50, double* %51, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %52 = add nuw nsw i64 %indvars.iv.next, %indvars.iv69
  %53 = trunc i64 %52 to i32
  %54 = srem i32 %53, 100
  %55 = sitofp i32 %54 to double
  %56 = fdiv double %55, %10
  %57 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv.next
...
.prol.preheader61:                                ; preds = %.prol.preheader61.preheader, %.prol.preheader61
  ...
  %59 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv58.prol
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %68 = shl i64 %index, 3
  %69 = add i64 %indvars.iv58.unr, %68
  %70 = add nsw i64 %69, 7
  %71 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %70
...
.lr.ph44.new:                                     ; preds = %.lr.ph44.new.preheader82, %.lr.ph44.new
  ...
  %75 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv58
  store double -9.990000e+02, double* %75, align 8
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  %76 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv.next59
  store double -9.990000e+02, double* %76, align 8
  %indvars.iv.next59.1 = add nsw i64 %indvars.iv58, 2
  %77 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv.next59.1
  store double -9.990000e+02, double* %77, align 8
  %indvars.iv.next59.2 = add nsw i64 %indvars.iv58, 3
  %78 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv.next59.2
  store double -9.990000e+02, double* %78, align 8
  %indvars.iv.next59.3 = add nsw i64 %indvars.iv58, 4
  %79 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv.next59.3
  store double -9.990000e+02, double* %79, align 8
  %indvars.iv.next59.4 = add nsw i64 %indvars.iv58, 5
  %80 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv.next59.4
  store double -9.990000e+02, double* %80, align 8
  %indvars.iv.next59.5 = add nsw i64 %indvars.iv58, 6
  %81 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv.next59.5
  store double -9.990000e+02, double* %81, align 8
  %indvars.iv.next59.6 = add nsw i64 %indvars.iv58, 7
  %82 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv.next59.6
  store double -9.990000e+02, double* %82, align 8
  %indvars.iv.next59.7 = add nsw i64 %indvars.iv58, 8
  %exitcond.7 = icmp eq i64 %indvars.iv.next59.7, %wide.trip.count60.7.pre-phi
...
.preheader.us56.preheader110:                     ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.preheader.us56.preheader
  %indvars.iv.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %min.iters.checked ], [ 0, %.preheader.us56.preheader ], [ %n.vec, %middle.block ]
...
; <label>:84:                                     ; preds = %84, %.preheader.us.us
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %84 ], [ 0, %.preheader.us.us ]
  %.047.us.us = phi double [ %97, %84 ], [ 0.000000e+00, %.preheader.us.us ]
  ...
  br i1 %exitcond77, label %._crit_edge.us.us, label %84
