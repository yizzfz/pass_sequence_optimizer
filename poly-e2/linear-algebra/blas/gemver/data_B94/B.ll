...
for.body.us:                                      ; preds = %for.cond35.for.inc46_crit_edge.us.for.body.us_crit_edge, %entry
  %indvars.iv9 = phi i64 [ 0, %entry ], [ %indvars.iv.next10, %for.cond35.for.inc46_crit_edge.us.for.body.us_crit_edge ]
...
for.body38.us:                                    ; preds = %for.body38.us.for.body38.us_crit_edge, %for.body.us
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %for.body38.us.for.body38.us_crit_edge ], [ 0, %for.body.us ]
  %2 = mul nuw nsw i64 %indvars.iv9, %indvars.iv
  ...
  %4 = mul nuw nsw i64 %indvars.iv9, %indvars.iv.next
  ...
  br i1 %exitcond.1, label %for.cond35.for.inc46_crit_edge.us, label %for.body38.us.for.body38.us_crit_edge
...
for.body.us:                                      ; preds = %for.cond1.for.inc20_crit_edge.us.for.body.us_crit_edge, %entry
  %indvars.iv53 = phi i64 [ 0, %entry ], [ %0, %for.cond1.for.inc20_crit_edge.us.for.body.us_crit_edge ]
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.body.preheader
  ...
  br i1 %25, label %for.cond1.for.inc20_crit_edge.us.loopexit68, label %vector.body.vector.body_crit_edge, !llvm.loop !13

vector.body.vector.body_crit_edge:                ; preds = %vector.body
  br label %vector.body

for.body3.us:                                     ; preds = %for.body3.us.for.body3.us_crit_edge, %for.body3.us.preheader
  %indvars.iv49 = phi i64 [ %indvars.iv.next50.1, %for.body3.us.for.body3.us_crit_edge ], [ 0, %for.body3.us.preheader ]
  ...
  br i1 %exitcond52.1, label %for.cond1.for.inc20_crit_edge.us.loopexit, label %for.body3.us.for.body3.us_crit_edge, !llvm.loop !16
...
for.cond1.for.inc20_crit_edge.us:                 ; preds = %for.cond1.for.inc20_crit_edge.us.loopexit68, %for.cond1.for.inc20_crit_edge.us.loopexit
  ...
  br i1 %exitcond72, label %for.body25.us.preheader, label %for.cond1.for.inc20_crit_edge.us.for.body.us_crit_edge

for.cond1.for.inc20_crit_edge.us.for.body.us_crit_edge: ; preds = %for.cond1.for.inc20_crit_edge.us
  br label %for.body.us

for.body25.us.preheader:                          ; preds = %for.cond1.for.inc20_crit_edge.us
  br label %for.body25.us

for.body25.us:                                    ; preds = %for.cond26.for.inc45_crit_edge.us.for.body25.us_crit_edge, %for.body25.us.preheader
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.cond26.for.inc45_crit_edge.us.for.body25.us_crit_edge ], [ 0, %for.body25.us.preheader ]
...
for.body28.us:                                    ; preds = %for.body28.us.for.body28.us_crit_edge, %for.body25.us
  %indvars.iv40 = phi i64 [ %indvars.iv.next41.1, %for.body28.us.for.body28.us_crit_edge ], [ 0, %for.body25.us ]
  %36 = phi double [ %add39.us.1, %for.body28.us.for.body28.us_crit_edge ], [ %.pre, %for.body25.us ]
  ...
  br i1 %exitcond43.1, label %for.cond26.for.inc45_crit_edge.us, label %for.body28.us.for.body28.us_crit_edge
...
for.cond26.for.inc45_crit_edge.us:                ; preds = %for.body28.us
  ...
  br i1 %exitcond66, label %vector.memcheck46, label %for.cond26.for.inc45_crit_edge.us.for.body25.us_crit_edge

for.cond26.for.inc45_crit_edge.us.for.body25.us_crit_edge: ; preds = %for.cond26.for.inc45_crit_edge.us
  br label %for.body25.us
...
vector.body31:                                    ; preds = %vector.body31.vector.body31_crit_edge, %vector.body31.preheader
  ...
  br i1 %56, label %for.body63.us.preheader.loopexit67, label %vector.body31.vector.body31_crit_edge, !llvm.loop !22
...
for.body50:                                       ; preds = %for.body50.for.body50_crit_edge, %for.body50.preheader
  %indvars.iv36 = phi i64 [ %indvars.iv.next37.3, %for.body50.for.body50_crit_edge ], [ 0, %for.body50.preheader ]
  ...
  br i1 %exitcond39.3, label %for.body63.us.preheader.loopexit, label %for.body50.for.body50_crit_edge, !llvm.loop !23
...
for.body63.us:                                    ; preds = %for.cond64.for.inc83_crit_edge.us.for.body63.us_crit_edge, %for.body63.us.preheader
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.cond64.for.inc83_crit_edge.us.for.body63.us_crit_edge ], [ 0, %for.body63.us.preheader ]
...
for.body66.us:                                    ; preds = %for.body66.us.for.body66.us_crit_edge, %for.body63.us
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %for.body66.us.for.body66.us_crit_edge ], [ 0, %for.body63.us ]
  %65 = phi double [ %add77.us.1, %for.body66.us.for.body66.us_crit_edge ], [ %.pre30, %for.body63.us ]
  ...
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %for.cond64.for.inc83_crit_edge.us, label %for.body66.us.for.body66.us_crit_edge
...
for.cond64.for.inc83_crit_edge.us:                ; preds = %for.body66.us
  ...
  br i1 %exitcond, label %for.end85, label %for.cond64.for.inc83_crit_edge.us.for.body63.us_crit_edge

for.cond64.for.inc83_crit_edge.us.for.body63.us_crit_edge: ; preds = %for.cond64.for.inc83_crit_edge.us
  br label %for.body63.us
