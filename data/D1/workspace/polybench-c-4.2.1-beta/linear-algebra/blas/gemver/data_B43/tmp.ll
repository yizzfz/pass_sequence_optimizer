...
; <label>:26:                                     ; preds = %2
  ...
  br i1 %28, label %29, label %.._crit_edge_crit_edge4

.._crit_edge_crit_edge4:                          ; preds = %26
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %.._crit_edge_crit_edge4, %.._crit_edge_crit_edge, %29
...
.preheader5:                                      ; preds = %middle.block..preheader5_crit_edge, %11
  %indvars.iv16 = phi i64 [ 0, %11 ], [ %indvars.iv.next17, %middle.block..preheader5_crit_edge ]
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.body.preheader
  %index = phi i64 [ 0, %vector.body.preheader ], [ %index.next, %vector.body.vector.body_crit_edge ]
  ...
  br i1 %45, label %vector.body.middle.block_crit_edge, label %vector.body.vector.body_crit_edge, !llvm.loop !13
...
._crit_edge:                                      ; preds = %._crit_edge.._crit_edge_crit_edge, %._crit_edge.preheader
  %indvars.iv13 = phi i64 [ 0, %._crit_edge.preheader ], [ %indvars.iv.next14.1, %._crit_edge.._crit_edge_crit_edge ]
  ...
  br i1 %exitcond15.1, label %._crit_edge.middle.block_crit_edge, label %._crit_edge.._crit_edge_crit_edge, !llvm.loop !16

._crit_edge.._crit_edge_crit_edge:                ; preds = %._crit_edge
  br label %._crit_edge

._crit_edge.middle.block_crit_edge:               ; preds = %._crit_edge
  br label %middle.block

middle.block:                                     ; preds = %._crit_edge.middle.block_crit_edge, %vector.body.middle.block_crit_edge
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  %exitcond18 = icmp eq i64 %indvars.iv.next17, 2000
  br i1 %exitcond18, label %.preheader3.preheader, label %middle.block..preheader5_crit_edge
...
.preheader3:                                      ; preds = %..preheader3_crit_edge, %.preheader3.preheader
  %indvars.iv10 = phi i64 [ 0, %.preheader3.preheader ], [ %indvars.iv.next11, %..preheader3_crit_edge ]
  br label %._crit_edge19

._crit_edge19:                                    ; preds = %._crit_edge19.._crit_edge19_crit_edge, %.preheader3
  %indvars.iv7 = phi i64 [ 0, %.preheader3 ], [ %indvars.iv.next8.1, %._crit_edge19.._crit_edge19_crit_edge ]
  ...
  br i1 %exitcond9.1, label %85, label %._crit_edge19.._crit_edge19_crit_edge
...
; <label>:85:                                     ; preds = %._crit_edge19
  ...
  br i1 %exitcond12, label %.preheader2.preheader, label %..preheader3_crit_edge

..preheader3_crit_edge:                           ; preds = %85
  br label %.preheader3

.preheader2.preheader:                            ; preds = %85
  br label %.preheader2

.preheader2:                                      ; preds = %.preheader2..preheader2_crit_edge, %.preheader2.preheader
  %indvars.iv4 = phi i64 [ 0, %.preheader2.preheader ], [ %indvars.iv.next5.4, %.preheader2..preheader2_crit_edge ]
  ...
  br i1 %exitcond6.4, label %.preheader.preheader, label %.preheader2..preheader2_crit_edge
...
.preheader:                                       ; preds = %..preheader_crit_edge, %.preheader.preheader
  %indvars.iv1 = phi i64 [ 0, %.preheader.preheader ], [ %indvars.iv.next2, %..preheader_crit_edge ]
...
._crit_edge21:                                    ; preds = %._crit_edge21.._crit_edge21_crit_edge, %.preheader
  ...
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %126, label %._crit_edge21.._crit_edge21_crit_edge
...
; <label>:126:                                    ; preds = %._crit_edge21
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 2000
  br i1 %exitcond3, label %127, label %..preheader_crit_edge
...
._crit_edge._crit_edge:                           ; preds = %._crit_edge.._crit_edge._crit_edge_crit_edge, %1
  %indvars.iv = phi i64 [ 0, %1 ], [ %indvars.iv.next, %._crit_edge.._crit_edge._crit_edge_crit_edge ]
  %6 = trunc i64 %indvars.iv to i32
  %7 = srem i32 %6, 20
  %8 = icmp eq i32 %7, 0
  br i1 %8, label %9, label %._crit_edge._crit_edge.._crit_edge_crit_edge
...
._crit_edge:                                      ; preds = %._crit_edge._crit_edge.._crit_edge_crit_edge, %9
  ...
  br i1 %exitcond, label %15, label %._crit_edge.._crit_edge._crit_edge_crit_edge
