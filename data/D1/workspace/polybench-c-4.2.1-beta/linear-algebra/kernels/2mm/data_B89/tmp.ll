...
.preheader11:                                     ; preds = %.preheader11.preheader, %28
  %indvars.iv2233 = phi i64 [ %indvars.iv.next23, %28 ], [ 0, %.preheader11.preheader ]
...
._crit_edge8:                                     ; preds = %._crit_edge8, %.preheader11
  ...
  %19 = getelementptr inbounds [900 x double], [900 x double]* %3, i64 %indvars.iv2233, i64 %indvars.iv2032
  %indvars.iv.next21.1 = add nuw nsw i64 %indvars.iv2032, 2
  %20 = mul nuw nsw i64 %indvars.iv.next21.1, %indvars.iv2233
...
.preheader9:                                      ; preds = %.preheader9.preheader, %37
  %indvars.iv1831 = phi i64 [ %indvars.iv.next19, %37 ], [ 0, %.preheader9.preheader ]
  br label %._crit_edge9

._crit_edge9:                                     ; preds = %._crit_edge9, %.preheader9
  %indvars.iv1630 = phi i64 [ 0, %.preheader9 ], [ %indvars.iv.next17, %._crit_edge9 ]
  %29 = add nuw nsw i64 %indvars.iv1630, 3
  %30 = mul nuw nsw i64 %29, %indvars.iv1831
  %31 = add nuw nsw i64 %30, 1
  %32 = trunc i64 %31 to i32
  %33 = srem i32 %32, 1200
  %34 = sitofp i32 %33 to double
  %35 = fdiv double %34, 1.200000e+03
  %36 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv1831, i64 %indvars.iv1630
...
.preheader:                                       ; preds = %.preheader.preheader, %45
  %indvars.iv1429 = phi i64 [ %indvars.iv.next15, %45 ], [ 0, %.preheader.preheader ]
  br label %._crit_edge10

._crit_edge10:                                    ; preds = %._crit_edge10, %.preheader
  %indvars.iv28 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %._crit_edge10 ]
  %38 = add nuw nsw i64 %indvars.iv28, 2
  %39 = mul nuw nsw i64 %38, %indvars.iv1429
  %40 = trunc i64 %39 to i32
  %41 = srem i32 %40, 1100
  %42 = sitofp i32 %41 to double
  %43 = fdiv double %42, 1.100000e+03
  %44 = getelementptr inbounds [1200 x double], [1200 x double]* %5, i64 %indvars.iv1429, i64 %indvars.iv28
