...
for.cond1.preheader:                              ; preds = %for.inc20, %entry
  %indvars.iv22 = phi i64 [ 0, %entry ], [ %indvars.iv.next20, %for.inc20 ]
  br label %for.body3

for.body3:                                        ; preds = %for.body3, %for.cond1.preheader
  %indvars.iv19 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next, %for.body3 ]
  %0 = mul nuw nsw i64 %indvars.iv19, %indvars.iv22
  %1 = trunc i64 %0 to i32
  %rem = srem i32 %1, 7
  %add = add nsw i32 %rem, 1
  %arrayidx5 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv22, i64 %indvars.iv19
  %2 = add nuw nsw i64 %indvars.iv19, %indvars.iv22
...
for.cond1.preheader:                              ; preds = %for.inc38, %entry
  %indvars.iv30 = phi i64 [ 0, %entry ], [ %indvars.iv.next28, %for.inc38 ]
  %scevgep4 = getelementptr [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv30, i64 0
...
for.cond4.preheader:                              ; preds = %for.inc35, %for.cond1.preheader
  %indvars.iv27 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next25, %for.inc35 ]
  ...
  %arrayidx12 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv27, i64 %indvars.iv30
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %11 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv30, i64 %index
  ...
  br i1 %23, label %for.inc35.loopexit17, label %vector.body, !llvm.loop !9

for.body6:                                        ; preds = %for.body6, %for.body6.preheader
  %indvars.iv24 = phi i64 [ 0, %for.body6.preheader ], [ %indvars.iv.next.1, %for.body6 ]
  %arrayidx8 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv27, i64 %indvars.iv24
  %24 = load i32, i32* %arrayidx8, align 4
  %25 = load i32, i32* %arrayidx12, align 4
  %arrayidx16 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv30, i64 %indvars.iv24
  ...
  %arrayidx16.1 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv30, i64 %indvars.iv.next
...
for.inc35:                                        ; preds = %for.inc35.loopexit17, %for.inc35.loopexit
  ...
  %exitcond26 = icmp eq i64 %indvars.iv.next25, 2800
  br i1 %exitcond26, label %for.inc38, label %for.cond4.preheader

for.inc38:                                        ; preds = %for.inc35
  %indvars.iv.next28 = add nuw nsw i64 %indvars.iv30, 1
  %exitcond29 = icmp eq i64 %indvars.iv.next28, 2800
  br i1 %exitcond29, label %for.end40, label %for.cond1.preheader
...
if.end:                                           ; preds = %for.body4, %if.then
  ...
  %arrayidx8 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv13, i64 %indvars.iv9
