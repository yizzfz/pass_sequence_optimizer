...
._crit_edge18:                                    ; preds = %._crit_edge18, %.preheader.us
  ...
  %1 = mul nuw nsw i64 %indvars.iv, %indvars.iv13
  %2 = trunc i64 %1 to i32
  %3 = srem i32 %2, 7
  %4 = add nsw i32 %3, 1
  %5 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv13, i64 %indvars.iv
  %6 = add nuw nsw i64 %indvars.iv13, %indvars.iv
...
.loopexit.us:                                     ; preds = %._crit_edge18
  ...
  %exitcond22 = icmp eq i64 %indvars.iv.next14, 2800
  br i1 %exitcond22, label %.loopexit3, label %.preheader.us
...
.loopexit6.us:                                    ; preds = %.loopexit.us.us
  ...
  %exitcond35 = icmp eq i64 %indvars.iv.next32, 2800
  br i1 %exitcond35, label %.loopexit7, label %.preheader3.us..preheader.us.us_crit_edge
...
.preheader.us.us:                                 ; preds = %.loopexit.us.us, %.preheader3.us..preheader.us.us_crit_edge
  ...
  br i1 %conflict.rdx, label %._crit_edge33.preheader, label %vector.body.preheader

vector.body.preheader:                            ; preds = %.preheader.us.us
  br label %vector.body

._crit_edge33.preheader:                          ; preds = %.preheader.us.us
...
.loopexit.us.us.loopexit:                         ; preds = %._crit_edge33
...
.loopexit.us.us:                                  ; preds = %.loopexit.us.us.loopexit17, %.loopexit.us.us.loopexit
  ...
  %exitcond34 = icmp eq i64 %indvars.iv.next30, 2800
  br i1 %exitcond34, label %.loopexit6.us, label %.preheader.us.us

._crit_edge33:                                    ; preds = %._crit_edge33, %._crit_edge33.preheader
  %indvars.iv = phi i64 [ 0, %._crit_edge33.preheader ], [ %indvars.iv.next.1, %._crit_edge33 ]
  ...
  br i1 %exitcond.1, label %.loopexit.us.us.loopexit, label %._crit_edge33, !llvm.loop !12
...
._crit_edge:                                      ; preds = %._crit_edge14, %10
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 2800
  br i1 %exitcond, label %.loopexit.us, label %._crit_edge14
