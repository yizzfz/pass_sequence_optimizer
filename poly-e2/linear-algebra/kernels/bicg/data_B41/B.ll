...
for.inc24.us:                                     ; preds = %for.inc24.us, %for.body5.us
  %indvars.iv26.us = phi i64 [ 0, %for.body5.us ], [ %indvars.iv.next.us.1, %for.inc24.us ]
  ...
  %indvars.iv.next.us.1 = add nuw nsw i64 %indvars.iv26.us, 2
...
for.inc:                                          ; preds = %for.inc, %for.inc.lr.ph
  ...
  %indvars.iv.next24.1 = add nuw nsw i64 %indvars.iv2331, 2
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc void @kernel_bicg([1900 x double]* nocapture readonly %A, double* nocapture %s, double* %q, double* nocapture readonly %p, double* %r) unnamed_addr #2 {
...
for.body3.us:                                     ; preds = %for.cond6.for.inc34_crit_edge.us, %for.body3.us.preheader
  %indvars.iv2330.us = phi i64 [ %indvars.iv.next24.us, %for.cond6.for.inc34_crit_edge.us ], [ 0, %for.body3.us.preheader ]
  %arrayidx5.us = getelementptr inbounds double, double* %q, i64 %indvars.iv2330.us
  store double 0.000000e+00, double* %arrayidx5.us, align 8
  br label %for.inc31.us

for.inc31.us:                                     ; preds = %for.inc31.us, %for.body3.us
  %indvars.iv28.us = phi i64 [ 0, %for.body3.us ], [ %indvars.iv.next.us, %for.inc31.us ]
  %arrayidx10.us = getelementptr inbounds double, double* %s, i64 %indvars.iv28.us
  %0 = load double, double* %arrayidx10.us, align 8
  %sunkaddr = ptrtoint double* %r to i64
  %sunkaddr12 = mul i64 %indvars.iv2330.us, 8
  ...
  %arrayidx16.us = getelementptr inbounds [1900 x double], [1900 x double]* %A, i64 %indvars.iv2330.us, i64 %indvars.iv28.us
  ...
  %sunkaddr16 = mul i64 %indvars.iv2330.us, 8
  ...
  %arrayidx26.us = getelementptr inbounds double, double* %p, i64 %indvars.iv28.us
...
for.cond6.for.inc34_crit_edge.us:                 ; preds = %for.inc31.us
  %indvars.iv.next24.us = add nuw nsw i64 %indvars.iv2330.us, 1
  %exitcond1 = icmp eq i64 %indvars.iv.next24.us, 2100
