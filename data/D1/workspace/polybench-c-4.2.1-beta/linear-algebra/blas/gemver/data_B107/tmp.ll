...
.preheader2:                                      ; preds = %52, %.preheader2.preheader
  %indvars.iv10 = phi i64 [ 0, %.preheader2.preheader ], [ %indvars.iv.next11, %52 ]
...
._crit_edge20:                                    ; preds = %._crit_edge20, %.preheader2
  ...
  %37 = load double, double* %sunkaddr48, align 8
  ...
  store double %44, double* %sunkaddr48, align 8
  ...
  store double %51, double* %sunkaddr48, align 8
...
._crit_edge22:                                    ; preds = %._crit_edge22, %.preheader
  ...
  %78 = load double, double* %sunkaddr52, align 8
  ...
  store double %85, double* %sunkaddr52, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %92, double* %sunkaddr52, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %93, label %._crit_edge22

; <label>:93:                                     ; preds = %._crit_edge22
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 2000
