...
for.inc.lr.ph:                                    ; preds = %entry, %for.inc47
  %indvars.iv17 = phi i64 [ 1, %entry ], [ %indvars.iv.next18, %for.inc47 ]
  %indvar = phi i64 [ 0, %entry ], [ %indvar.next, %for.inc47 ]
  %6 = phi double [ %sub3, %entry ], [ %div, %for.inc47 ]
  %beta.036 = phi double [ 1.000000e+00, %entry ], [ %mul5, %for.inc47 ]
  %7 = add i64 %indvar, -1
  %8 = shl i64 %indvar, 3
  %9 = add nuw nsw i64 %8, 8
  %mul = fmul double %6, %6
  %sub4 = fsub double 1.000000e+00, %mul
  %mul5 = fmul double %beta.036, %sub4
  %10 = add i64 %indvar, 1
  %sub9 = add nsw i64 %indvars.iv17, -1
...
for.inc.prol:                                     ; preds = %for.inc.prol.preheader, %for.inc.prol
  ...
  %sum.029.prol = phi double [ %add.prol, %for.inc.prol ], [ 0.000000e+00, %for.inc.prol.preheader ]
  ...
  %add.prol = fadd double %sum.029.prol, %mul14.prol
...
for.inc.prol.loopexit:                            ; preds = %for.inc.prol.loopexit.loopexit, %for.inc.lr.ph
  ...
  %sum.029.unr = phi double [ 0.000000e+00, %for.inc.lr.ph ], [ %add.prol, %for.inc.prol.loopexit.loopexit ]
...
for.inc:                                          ; preds = %for.inc.preheader, %for.inc
  ...
  %sum.029 = phi double [ %add.3, %for.inc ], [ %sum.029.unr, %for.inc.preheader ]
  ...
  %add = fadd double %sum.029, %mul14.v.r1
...
for.inc32.lr.ph:                                  ; preds = %for.inc32.lr.ph.loopexit, %for.inc.prol.loopexit
  ...
  %arrayidx16 = getelementptr inbounds double, double* %r, i64 %indvars.iv17
  ...
  %sub24 = add nsw i64 %indvars.iv17, -1
  %23 = and i64 %indvar, 1
  %lcmp.mod21 = icmp eq i64 %23, 0
  br i1 %lcmp.mod21, label %for.inc32.prol, label %for.inc32.prol.loopexit

for.inc32.prol:                                   ; preds = %for.inc32.lr.ph
  %24 = load double, double* %y, align 8
  %sunkaddr22 = shl i64 %indvars.iv17, 3
  %sunkaddr23 = add i64 %3, %sunkaddr22
  %sunkaddr24 = add i64 %sunkaddr23, -8
  %sunkaddr25 = inttoptr i64 %sunkaddr24 to double*
  %25 = load double, double* %sunkaddr25, align 8
...
for.inc32.prol.loopexit:                          ; preds = %for.inc32.prol, %for.inc32.lr.ph
  %indvars.iv3.unr.ph = phi i64 [ 1, %for.inc32.prol ], [ 0, %for.inc32.lr.ph ]
...
for.inc32.preheader:                              ; preds = %for.inc32.prol.loopexit
  %27 = sub i64 %7, %indvars.iv3.unr.ph
  %28 = lshr i64 %27, 1
  %29 = add nuw i64 %28, 1
  %min.iters.check = icmp ult i64 %29, 2
  br i1 %min.iters.check, label %for.inc32.preheader35, label %min.iters.checked

min.iters.checked:                                ; preds = %for.inc32.preheader
  %n.mod.vf = and i64 %29, 1
  %n.vec = sub i64 %29, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  %30 = or i64 %indvars.iv3.unr.ph, 2
  %31 = shl nuw i64 %28, 1
  %32 = add i64 %30, %31
  %33 = shl nuw nsw i64 %n.mod.vf, 1
  %ind.end = sub i64 %32, %33
  br i1 %cmp.zero, label %for.inc32.preheader35, label %vector.ph

vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert32 = insertelement <2 x double> undef, double %div, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %34 = shl i64 %index, 1
  %offset.idx = or i64 %indvars.iv3.unr.ph, %34
  ...
  %strided.vec27 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  ...
  %wide.vec28 = load <4 x double>, <4 x double>* %40, align 8
  %strided.vec29 = shufflevector <4 x double> %wide.vec28, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %reverse = shufflevector <2 x double> %strided.vec29, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %strided.vec30 = shufflevector <4 x double> %wide.vec28, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %reverse31 = shufflevector <2 x double> %strided.vec30, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %41 = fmul <2 x double> %broadcast.splat33, %reverse31
  %42 = fadd <2 x double> %strided.vec, %41
  %43 = add nuw nsw i64 %offset.idx, 1
  %44 = fmul <2 x double> %broadcast.splat33, %reverse
  %45 = fadd <2 x double> %strided.vec27, %44
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.inc47, label %for.inc32.preheader35

for.inc32.preheader35:                            ; preds = %middle.block, %min.iters.checked, %for.inc32.preheader
  %indvars.iv3.ph = phi i64 [ %indvars.iv3.unr.ph, %min.iters.checked ], [ %indvars.iv3.unr.ph, %for.inc32.preheader ], [ %ind.end, %middle.block ]
...
for.inc32:                                        ; preds = %for.inc32.preheader35, %for.inc32
  %indvars.iv3 = phi i64 [ %indvars.iv.next4.1, %for.inc32 ], [ %indvars.iv3.ph, %for.inc32.preheader35 ]
  %arrayidx23 = getelementptr inbounds double, double* %y, i64 %indvars.iv3
  %51 = bitcast double* %arrayidx23 to <2 x double>*
  %arrayidx31 = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %indvars.iv3
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv3, 1
  %52 = load <2 x double>, <2 x double>* %51, align 8
  %sub25.1 = sub nsw i64 %sub24, %indvars.iv.next4
  ...
  %exitcond8.1 = icmp eq i64 %indvars.iv.next4.1, %indvars.iv17
  br i1 %exitcond8.1, label %for.inc47.loopexit, label %for.inc32, !llvm.loop !6
...
for.inc47:                                        ; preds = %for.inc47.loopexit, %middle.block, %for.inc32.prol.loopexit
  ...
  %arrayidx46 = getelementptr inbounds double, double* %y, i64 %indvars.iv17
  store double %div, double* %arrayidx46, align 8
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  %indvar.next = add nuw nsw i64 %indvar, 1
  %exitcond19 = icmp eq i64 %indvar.next, 1999
  br i1 %exitcond19, label %for.end49, label %for.inc.lr.ph
