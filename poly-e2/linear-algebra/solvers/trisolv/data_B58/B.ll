...
entry:
  ...
  call fastcc void @init_array(i32 2000, [2000 x double]* %0, double* %1, double* %2)
  call void (...) @polybench_timer_start() #4
  call fastcc void @kernel_trisolv(i32 2000, [2000 x double]* %0, double* %1, double* %2)
...
for.inc.lr.ph:                                    ; preds = %for.inc14, %for.body.lr.ph
  %indvars.iv7 = phi i64 [ 0, %for.body.lr.ph ], [ %2, %for.inc14 ]
...
for.inc.prol.loopexit:                            ; preds = %for.inc.prol.loopexit.unr-lcssa
  ...
  br i1 %5, label %for.inc14, label %for.inc.lr.ph.new
...
for.inc:                                          ; preds = %for.inc, %for.inc.lr.ph.new
  ...
  br i1 %exitcond.1, label %for.inc14.unr-lcssa, label %for.inc

for.inc14.unr-lcssa:                              ; preds = %for.inc
  br label %for.inc14

for.inc14:                                        ; preds = %for.inc.prol.loopexit, %for.inc14.unr-lcssa
  %exitcond = icmp ne i64 %2, %0
  br i1 %exitcond, label %for.inc.lr.ph, label %for.end16.loopexit
...
for.body:                                         ; preds = %for.end, %for.body.preheader
  ...
  %1 = add nuw nsw i64 %indvars.iv7, 4294967295
