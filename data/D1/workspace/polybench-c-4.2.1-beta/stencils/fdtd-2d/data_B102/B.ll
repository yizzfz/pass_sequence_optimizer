...
define internal fastcc void @init_array(i32, i32, i32, [1200 x double]* nocapture, [1200 x double]* nocapture, [1200 x double]* nocapture, double* nocapture) unnamed_addr #2 {
  %8 = icmp sgt i32 %0, 0
  br i1 %8, label %.lr.ph8.preheader, label %..preheader2_crit_edge

..preheader2_crit_edge:                           ; preds = %7
  br label %.preheader2
...
.lr.ph8.preheader:                                ; preds = %7
  ...
  br i1 %lcmp.mod, label %.lr.ph8.preheader..lr.ph8.prol.loopexit_crit_edge, label %.lr.ph8.prol.preheader

.lr.ph8.preheader..lr.ph8.prol.loopexit_crit_edge: ; preds = %.lr.ph8.preheader
...
.lr.ph8.prol.loopexit:                            ; preds = %.lr.ph8.preheader..lr.ph8.prol.loopexit_crit_edge, %.lr.ph8.prol.loopexit.loopexit
  %indvars.iv15.unr = phi i64 [ 0, %.lr.ph8.preheader..lr.ph8.prol.loopexit_crit_edge ], [ %indvars.iv.next16.prol, %.lr.ph8.prol.loopexit.loopexit ]
  %13 = icmp ult i32 %9, 7
  br i1 %13, label %.lr.ph8.prol.loopexit..preheader2_crit_edge, label %.lr.ph8.preheader19

.lr.ph8.prol.loopexit..preheader2_crit_edge:      ; preds = %.lr.ph8.prol.loopexit
  br label %.preheader2
...
.preheader2:                                      ; preds = %.lr.ph8.prol.loopexit..preheader2_crit_edge, %..preheader2_crit_edge, %.preheader2.loopexit
  %14 = icmp sgt i32 %1, 0
  br i1 %14, label %.preheader.lr.ph, label %.preheader2.._crit_edge5_crit_edge

.preheader2.._crit_edge5_crit_edge:               ; preds = %.preheader2
...
.preheader.lr.ph:                                 ; preds = %.preheader2
  ...
  br i1 %15, label %.preheader.us.preheader, label %.preheader.lr.ph.._crit_edge5_crit_edge

.preheader.lr.ph.._crit_edge5_crit_edge:          ; preds = %.preheader.lr.ph
  br label %._crit_edge5
...
.preheader.us:                                    ; preds = %._crit_edge.us..preheader.us_crit_edge, %.preheader.us.preheader
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %._crit_edge.us..preheader.us_crit_edge ], [ 0, %.preheader.us.preheader ]
  %18 = trunc i64 %indvars.iv10 to i32
  %19 = sitofp i32 %18 to double
  br label %20

; <label>:20:                                     ; preds = %._crit_edge, %.preheader.us
...
._crit_edge.us:                                   ; preds = %20
  ...
  br i1 %exitcond13, label %._crit_edge5.loopexit, label %._crit_edge.us..preheader.us_crit_edge
...
._crit_edge5:                                     ; preds = %.preheader.lr.ph.._crit_edge5_crit_edge, %.preheader2.._crit_edge5_crit_edge, %._crit_edge5.loopexit
  ret void
}
...
define internal fastcc void @kernel_fdtd_2d(i32, i32, i32, [1200 x double]* nocapture, [1200 x double]* nocapture, [1200 x double]* nocapture, double* nocapture readonly) unnamed_addr #2 {
  %8 = icmp sgt i32 %0, 0
  br i1 %8, label %.preheader10.lr.ph, label %.._crit_edge25_crit_edge

.._crit_edge25_crit_edge:                         ; preds = %7
...
.preheader10:                                     ; preds = %._crit_edge23..preheader10_crit_edge, %.preheader10.lr.ph
  %indvars.iv62 = phi i64 [ 0, %.preheader10.lr.ph ], [ %indvars.iv.next63, %._crit_edge23..preheader10_crit_edge ]
...
.prol.loopexit:                                   ; preds = %.lr.ph..prol.loopexit_crit_edge, %.prol.loopexit.loopexit
  ...
  br i1 %12, label %.prol.loopexit..preheader9_crit_edge, label %.lr.ph.new.preheader

.prol.loopexit..preheader9_crit_edge:             ; preds = %.prol.loopexit
  br label %.preheader9
...
.preheader9:                                      ; preds = %.prol.loopexit..preheader9_crit_edge, %.preheader10..preheader9_crit_edge, %.preheader9.loopexit
  br i1 %brmerge, label %.preheader9..preheader8_crit_edge, label %.preheader6.us.preheader

.preheader9..preheader8_crit_edge:                ; preds = %.preheader9
  br label %.preheader8

.preheader6.us.preheader:                         ; preds = %.preheader9
  br label %.preheader6.us

.preheader6.us:                                   ; preds = %._crit_edge.us..preheader6.us_crit_edge, %.preheader6.us.preheader
  %indvar = phi i64 [ %indvar.next, %._crit_edge.us..preheader6.us_crit_edge ], [ 0, %.preheader6.us.preheader ]
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %._crit_edge.us..preheader6.us_crit_edge ], [ 1, %.preheader6.us.preheader ]
  %26 = add i64 %indvar, 1
  ...
  br i1 %lcmp.mod35, label %.preheader6.us..prol.loopexit33_crit_edge, label %.prol.preheader32

.preheader6.us..prol.loopexit33_crit_edge:        ; preds = %.preheader6.us
...
.prol.loopexit33:                                 ; preds = %.preheader6.us..prol.loopexit33_crit_edge, %.prol.preheader32
  %indvars.iv29.unr.ph = phi i64 [ 1, %.prol.preheader32 ], [ 0, %.preheader6.us..prol.loopexit33_crit_edge ]
...
.preheader6.us.new.preheader:                     ; preds = %.prol.loopexit33
  ...
  br i1 %min.iters.check141, label %.preheader6.us.new.preheader..preheader6.us.new.preheader185_crit_edge, label %min.iters.checked142

.preheader6.us.new.preheader..preheader6.us.new.preheader185_crit_edge: ; preds = %.preheader6.us.new.preheader
  br label %.preheader6.us.new.preheader185
...
min.iters.checked142:                             ; preds = %.preheader6.us.new.preheader
  ...
  br i1 %cmp.zero145, label %min.iters.checked142..preheader6.us.new.preheader185_crit_edge, label %vector.memcheck163

min.iters.checked142..preheader6.us.new.preheader185_crit_edge: ; preds = %min.iters.checked142
  br label %.preheader6.us.new.preheader185
...
vector.memcheck163:                               ; preds = %min.iters.checked142
  ...
  br i1 %memcheck.conflict162, label %vector.memcheck163..preheader6.us.new.preheader185_crit_edge, label %vector.body138.preheader

vector.memcheck163..preheader6.us.new.preheader185_crit_edge: ; preds = %vector.memcheck163
  br label %.preheader6.us.new.preheader185
...
vector.body138:                                   ; preds = %vector.body138.vector.body138_crit_edge, %vector.body138.preheader
  ...
  br i1 %66, label %middle.block139, label %vector.body138.vector.body138_crit_edge, !llvm.loop !9
...
middle.block139:                                  ; preds = %vector.body138
  ...
  br i1 %cmp.n169, label %middle.block139.._crit_edge.us_crit_edge, label %middle.block139..preheader6.us.new.preheader185_crit_edge

middle.block139..preheader6.us.new.preheader185_crit_edge: ; preds = %middle.block139
  br label %.preheader6.us.new.preheader185

middle.block139.._crit_edge.us_crit_edge:         ; preds = %middle.block139
  br label %._crit_edge.us

.preheader6.us.new.preheader185:                  ; preds = %middle.block139..preheader6.us.new.preheader185_crit_edge, %vector.memcheck163..preheader6.us.new.preheader185_crit_edge, %min.iters.checked142..preheader6.us.new.preheader185_crit_edge, %.preheader6.us.new.preheader..preheader6.us.new.preheader185_crit_edge
  %indvars.iv29.ph = phi i64 [ %indvars.iv29.unr.ph, %vector.memcheck163..preheader6.us.new.preheader185_crit_edge ], [ %indvars.iv29.unr.ph, %min.iters.checked142..preheader6.us.new.preheader185_crit_edge ], [ %indvars.iv29.unr.ph, %.preheader6.us.new.preheader..preheader6.us.new.preheader185_crit_edge ], [ %ind.end168, %middle.block139..preheader6.us.new.preheader185_crit_edge ]
...
._crit_edge.us:                                   ; preds = %middle.block139.._crit_edge.us_crit_edge, %.prol.loopexit33.._crit_edge.us_crit_edge, %._crit_edge.us.loopexit
  %indvars.iv.next38 = add nuw nsw i64 %indvars.iv37, 1
  %exitcond = icmp eq i64 %indvars.iv.next38, %wide.trip.count39
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond, label %.preheader8.loopexit, label %._crit_edge.us..preheader6.us_crit_edge

._crit_edge.us..preheader6.us_crit_edge:          ; preds = %._crit_edge.us
  br label %.preheader6.us
...
.preheader8:                                      ; preds = %.preheader9..preheader8_crit_edge, %.preheader8.loopexit
  br i1 %brmerge69, label %.preheader8..preheader7_crit_edge, label %.preheader5.us.preheader
...
.preheader5.us:                                   ; preds = %._crit_edge17.us..preheader5.us_crit_edge, %.preheader5.us.preheader
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %._crit_edge17.us..preheader5.us_crit_edge ], [ 0, %.preheader5.us.preheader ]
  ...
  br i1 %lcmp.mod48, label %.preheader5.us..prol.loopexit46_crit_edge, label %.prol.preheader45

.preheader5.us..prol.loopexit46_crit_edge:        ; preds = %.preheader5.us
...
.prol.loopexit46:                                 ; preds = %.preheader5.us..prol.loopexit46_crit_edge, %.prol.preheader45
  %indvars.iv41.unr.ph = phi i64 [ 2, %.prol.preheader45 ], [ 1, %.preheader5.us..prol.loopexit46_crit_edge ]
...
.preheader5.us.new.preheader:                     ; preds = %.prol.loopexit46
  ...
  br i1 %min.iters.check100, label %.preheader5.us.new.preheader..preheader5.us.new.preheader184_crit_edge, label %min.iters.checked101

.preheader5.us.new.preheader..preheader5.us.new.preheader184_crit_edge: ; preds = %.preheader5.us.new.preheader
  br label %.preheader5.us.new.preheader184
...
min.iters.checked101:                             ; preds = %.preheader5.us.new.preheader
  ...
  br i1 %cmp.zero104, label %min.iters.checked101..preheader5.us.new.preheader184_crit_edge, label %vector.memcheck122

min.iters.checked101..preheader5.us.new.preheader184_crit_edge: ; preds = %min.iters.checked101
  br label %.preheader5.us.new.preheader184
...
vector.memcheck122:                               ; preds = %min.iters.checked101
  ...
  br i1 %memcheck.conflict121, label %vector.memcheck122..preheader5.us.new.preheader184_crit_edge, label %vector.body97.preheader

vector.memcheck122..preheader5.us.new.preheader184_crit_edge: ; preds = %vector.memcheck122
  br label %.preheader5.us.new.preheader184
...
vector.body97:                                    ; preds = %vector.body97.vector.body97_crit_edge, %vector.body97.preheader
  ...
  br i1 %147, label %middle.block98, label %vector.body97.vector.body97_crit_edge, !llvm.loop !18
...
middle.block98:                                   ; preds = %vector.body97
  ...
  br i1 %cmp.n127, label %middle.block98.._crit_edge17.us_crit_edge, label %middle.block98..preheader5.us.new.preheader184_crit_edge

middle.block98..preheader5.us.new.preheader184_crit_edge: ; preds = %middle.block98
  br label %.preheader5.us.new.preheader184

middle.block98.._crit_edge17.us_crit_edge:        ; preds = %middle.block98
  br label %._crit_edge17.us

.preheader5.us.new.preheader184:                  ; preds = %middle.block98..preheader5.us.new.preheader184_crit_edge, %vector.memcheck122..preheader5.us.new.preheader184_crit_edge, %min.iters.checked101..preheader5.us.new.preheader184_crit_edge, %.preheader5.us.new.preheader..preheader5.us.new.preheader184_crit_edge
  %indvars.iv41.ph = phi i64 [ %indvars.iv41.unr.ph, %vector.memcheck122..preheader5.us.new.preheader184_crit_edge ], [ %indvars.iv41.unr.ph, %min.iters.checked101..preheader5.us.new.preheader184_crit_edge ], [ %indvars.iv41.unr.ph, %.preheader5.us.new.preheader..preheader5.us.new.preheader184_crit_edge ], [ %ind.end, %middle.block98..preheader5.us.new.preheader184_crit_edge ]
...
._crit_edge17.us:                                 ; preds = %middle.block98.._crit_edge17.us_crit_edge, %.prol.loopexit46.._crit_edge17.us_crit_edge, %._crit_edge17.us.loopexit
  %indvars.iv.next50 = add nuw nsw i64 %indvars.iv49, 1
  %exitcond52 = icmp eq i64 %indvars.iv.next50, %wide.trip.count51
  br i1 %exitcond52, label %.preheader7.loopexit, label %._crit_edge17.us..preheader5.us_crit_edge

._crit_edge17.us..preheader5.us_crit_edge:        ; preds = %._crit_edge17.us
  br label %.preheader5.us

.preheader7.loopexit:                             ; preds = %._crit_edge17.us
  br label %.preheader7

.preheader7:                                      ; preds = %.preheader8..preheader7_crit_edge, %.preheader7.loopexit
  br i1 %brmerge72, label %.preheader7.._crit_edge23_crit_edge, label %.preheader.us.preheader

.preheader7.._crit_edge23_crit_edge:              ; preds = %.preheader7
  br label %._crit_edge23

.preheader.us.preheader:                          ; preds = %.preheader7
  br label %.preheader.us

.preheader.us:                                    ; preds = %._crit_edge21.us..preheader.us_crit_edge, %.preheader.us.preheader
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %._crit_edge21.us..preheader.us_crit_edge ], [ 0, %.preheader.us.preheader ]
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.body.preheader
  ...
  br i1 %201, label %middle.block, label %vector.body.vector.body_crit_edge, !llvm.loop !28

vector.body.vector.body_crit_edge:                ; preds = %vector.body
  br label %vector.body

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %middle.block.._crit_edge21.us_crit_edge, label %middle.block.scalar.ph.preheader_crit_edge
...
scalar.ph.preheader:                              ; preds = %middle.block.scalar.ph.preheader_crit_edge, %vector.memcheck.scalar.ph.preheader_crit_edge, %min.iters.checked.scalar.ph.preheader_crit_edge, %.preheader.us.scalar.ph.preheader_crit_edge
  %indvars.iv54.ph = phi i64 [ 0, %vector.memcheck.scalar.ph.preheader_crit_edge ], [ 0, %min.iters.checked.scalar.ph.preheader_crit_edge ], [ 0, %.preheader.us.scalar.ph.preheader_crit_edge ], [ %n.vec, %middle.block.scalar.ph.preheader_crit_edge ]
  br label %scalar.ph
...
._crit_edge21.us:                                 ; preds = %middle.block.._crit_edge21.us_crit_edge, %._crit_edge21.us.loopexit
  ...
  br i1 %exitcond61, label %._crit_edge23.loopexit, label %._crit_edge21.us..preheader.us_crit_edge

._crit_edge21.us..preheader.us_crit_edge:         ; preds = %._crit_edge21.us
  br label %.preheader.us

._crit_edge23.loopexit:                           ; preds = %._crit_edge21.us
  br label %._crit_edge23

._crit_edge23:                                    ; preds = %.preheader7.._crit_edge23_crit_edge, %._crit_edge23.loopexit
  %indvars.iv.next63 = add nuw nsw i64 %indvars.iv62, 1
  %exitcond65 = icmp eq i64 %indvars.iv.next63, %wide.trip.count64
  br i1 %exitcond65, label %._crit_edge25.loopexit, label %._crit_edge23..preheader10_crit_edge

._crit_edge23..preheader10_crit_edge:             ; preds = %._crit_edge23
  br label %.preheader10
...
define internal fastcc void @print_array(i32, i32, [1200 x double]* nocapture readonly, [1200 x double]* nocapture readonly, [1200 x double]* nocapture readonly) unnamed_addr #0 {
  ...
  br i1 %or.cond, label %.preheader11.us.preheader, label %.._crit_edge24_crit_edge

.._crit_edge24_crit_edge:                         ; preds = %5
...
.preheader11.us:                                  ; preds = %._crit_edge22.us..preheader11.us_crit_edge, %.preheader11.us.preheader
  %indvars.iv46 = phi i64 [ 0, %.preheader11.us.preheader ], [ %indvars.iv.next47, %._crit_edge22.us..preheader11.us_crit_edge ]
  %13 = mul nsw i64 %indvars.iv46, %12
  br label %14

; <label>:14:                                     ; preds = %._crit_edge53, %.preheader11.us
  %indvars.iv42 = phi i64 [ 0, %.preheader11.us ], [ %indvars.iv.next43, %._crit_edge53 ]
...
; <label>:21:                                     ; preds = %._crit_edge, %19
  ...
  br i1 %exitcond45, label %._crit_edge22.us, label %._crit_edge53
...
._crit_edge22.us:                                 ; preds = %21
  ...
  br i1 %exitcond49, label %._crit_edge24.loopexit, label %._crit_edge22.us..preheader11.us_crit_edge

._crit_edge22.us..preheader11.us_crit_edge:       ; preds = %._crit_edge22.us
  br label %.preheader11.us
...
._crit_edge24:                                    ; preds = %.._crit_edge24_crit_edge, %._crit_edge24.loopexit
  ...
  br i1 %or.cond51, label %.preheader10.us.preheader, label %._crit_edge24.._crit_edge19_crit_edge

._crit_edge24.._crit_edge19_crit_edge:            ; preds = %._crit_edge24
...
.preheader10.us:                                  ; preds = %._crit_edge17.us..preheader10.us_crit_edge, %.preheader10.us.preheader
  %indvars.iv37 = phi i64 [ 0, %.preheader10.us.preheader ], [ %indvars.iv.next38, %._crit_edge17.us..preheader10.us_crit_edge ]
  %35 = mul nsw i64 %indvars.iv37, %34
  br label %36

; <label>:36:                                     ; preds = %._crit_edge55, %.preheader10.us
  %indvars.iv33 = phi i64 [ 0, %.preheader10.us ], [ %indvars.iv.next34, %._crit_edge55 ]
...
; <label>:43:                                     ; preds = %._crit_edge54, %41
  ...
  br i1 %exitcond36, label %._crit_edge17.us, label %._crit_edge55
...
._crit_edge17.us:                                 ; preds = %43
  ...
  br i1 %exitcond40, label %._crit_edge19.loopexit, label %._crit_edge17.us..preheader10.us_crit_edge
...
._crit_edge19:                                    ; preds = %._crit_edge24.._crit_edge19_crit_edge, %._crit_edge19.loopexit
  %48 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %49 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %48, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8, i64 0, i64 0)) #6
  %50 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %51 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %50, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.9, i64 0, i64 0)) #6
  %52 = icmp sgt i32 %0, 0
  %53 = icmp sgt i32 %1, 0
  %or.cond52 = and i1 %52, %53
  br i1 %or.cond52, label %.preheader.us.preheader, label %._crit_edge19.._crit_edge14_crit_edge

._crit_edge19.._crit_edge14_crit_edge:            ; preds = %._crit_edge19
...
.preheader.us:                                    ; preds = %._crit_edge.us..preheader.us_crit_edge, %.preheader.us.preheader
  %indvars.iv28 = phi i64 [ 0, %.preheader.us.preheader ], [ %indvars.iv.next29, %._crit_edge.us..preheader.us_crit_edge ]
  %55 = mul nsw i64 %indvars.iv28, %54
  br label %56

; <label>:56:                                     ; preds = %._crit_edge57, %.preheader.us
  %indvars.iv = phi i64 [ 0, %.preheader.us ], [ %indvars.iv.next, %._crit_edge57 ]
  %57 = add nsw i64 %indvars.iv, %55
  %58 = trunc i64 %57 to i32
  %59 = srem i32 %58, 20
  %60 = icmp eq i32 %59, 0
  br i1 %60, label %61, label %._crit_edge56
...
; <label>:63:                                     ; preds = %._crit_edge56, %61
...
._crit_edge57:                                    ; preds = %63
  br label %56

._crit_edge.us:                                   ; preds = %63
  %indvars.iv.next29 = add nuw nsw i64 %indvars.iv28, 1
  %exitcond31 = icmp eq i64 %indvars.iv.next29, %wide.trip.count30
  br i1 %exitcond31, label %._crit_edge14.loopexit, label %._crit_edge.us..preheader.us_crit_edge
...
._crit_edge14:                                    ; preds = %._crit_edge19.._crit_edge14_crit_edge, %._crit_edge14.loopexit
