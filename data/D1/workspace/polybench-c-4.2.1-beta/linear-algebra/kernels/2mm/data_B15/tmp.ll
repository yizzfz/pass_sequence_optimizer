...
._crit_edge:                                      ; preds = %._crit_edge28, %._crit_edge.preheader
  %indvars.iv19 = phi i64 [ 0, %._crit_edge.preheader ], [ %indvars.iv.next20, %._crit_edge28 ]
  br label %._crit_edge22

._crit_edge22:                                    ; preds = %._crit_edge22, %._crit_edge
  %indvars.iv16 = phi i64 [ 0, %._crit_edge ], [ %indvars.iv.next17, %._crit_edge22 ]
  ...
  br i1 %exitcond18, label %._crit_edge28, label %._crit_edge22

._crit_edge28:                                    ; preds = %._crit_edge22
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  %exitcond21 = icmp eq i64 %indvars.iv.next20, 800
  br i1 %exitcond21, label %._crit_edge6.preheader, label %._crit_edge

._crit_edge6.preheader:                           ; preds = %._crit_edge28
  br label %._crit_edge6

._crit_edge6:                                     ; preds = %._crit_edge6.preheader, %._crit_edge23
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %._crit_edge23 ], [ 0, %._crit_edge6.preheader ]
  br label %._crit_edge24

._crit_edge24:                                    ; preds = %._crit_edge24, %._crit_edge6
  %indvars.iv10 = phi i64 [ 0, %._crit_edge6 ], [ %indvars.iv.next11.1, %._crit_edge24 ]
  ...
  br i1 %exitcond12.1, label %._crit_edge23, label %._crit_edge24

._crit_edge23:                                    ; preds = %._crit_edge24
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 1100
  br i1 %exitcond15, label %._crit_edge8.preheader, label %._crit_edge6

._crit_edge8.preheader:                           ; preds = %._crit_edge23
  br label %._crit_edge8

._crit_edge8:                                     ; preds = %._crit_edge8.preheader, %._crit_edge18
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %._crit_edge18 ], [ 0, %._crit_edge8.preheader ]
  br label %._crit_edge25

._crit_edge25:                                    ; preds = %._crit_edge25, %._crit_edge8
  %indvars.iv4 = phi i64 [ 0, %._crit_edge8 ], [ %indvars.iv.next5, %._crit_edge25 ]
...
._crit_edge18:                                    ; preds = %._crit_edge25
  ...
  br i1 %exitcond9, label %._crit_edge10.preheader, label %._crit_edge8

._crit_edge10.preheader:                          ; preds = %._crit_edge18
  br label %._crit_edge10

._crit_edge10:                                    ; preds = %._crit_edge10.preheader, %._crit_edge12
  %indvars.iv1 = phi i64 [ %indvars.iv.next2, %._crit_edge12 ], [ 0, %._crit_edge10.preheader ]
  br label %._crit_edge26

._crit_edge26:                                    ; preds = %._crit_edge26, %._crit_edge10
  %indvars.iv = phi i64 [ 0, %._crit_edge10 ], [ %indvars.iv.next, %._crit_edge26 ]
  ...
  br i1 %exitcond, label %._crit_edge12, label %._crit_edge26

._crit_edge12:                                    ; preds = %._crit_edge26
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 800
  br i1 %exitcond3, label %._crit_edge15, label %._crit_edge10
...
._crit_edge:                                      ; preds = %._crit_edge21, %._crit_edge.preheader
  %indvars.iv13 = phi i64 [ 0, %._crit_edge.preheader ], [ %indvars.iv.next14, %._crit_edge21 ]
  br label %.lr.ph17

.lr.ph17:                                         ; preds = %._crit_edge18, %._crit_edge
  %indvars.iv9 = phi i64 [ 0, %._crit_edge ], [ %indvars.iv.next10, %._crit_edge18 ]
  %7 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv13, i64 %indvars.iv9
  store double 0.000000e+00, double* %7, align 8
  br label %._crit_edge16

._crit_edge16:                                    ; preds = %._crit_edge16, %.lr.ph17
  %indvars.iv6 = phi i64 [ 0, %.lr.ph17 ], [ %indvars.iv.next7.1, %._crit_edge16 ]
  %8 = phi double [ 0.000000e+00, %.lr.ph17 ], [ %22, %._crit_edge16 ]
  ...
  br i1 %exitcond8.1, label %._crit_edge18, label %._crit_edge16

._crit_edge18:                                    ; preds = %._crit_edge16
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  %exitcond11 = icmp eq i64 %indvars.iv.next10, 900
  br i1 %exitcond11, label %._crit_edge21, label %.lr.ph17

._crit_edge21:                                    ; preds = %._crit_edge18
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 800
  br i1 %exitcond15, label %._crit_edge6.preheader, label %._crit_edge

._crit_edge6.preheader:                           ; preds = %._crit_edge21
  br label %._crit_edge6

._crit_edge6:                                     ; preds = %._crit_edge6.preheader, %._crit_edge12
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %._crit_edge12 ], [ 0, %._crit_edge6.preheader ]
  br label %.lr.ph

.lr.ph:                                           ; preds = %._crit_edge9, %._crit_edge6
  %indvars.iv1 = phi i64 [ 0, %._crit_edge6 ], [ %indvars.iv.next2, %._crit_edge9 ]
...
._crit_edge17:                                    ; preds = %._crit_edge17, %.lr.ph
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next.2, %._crit_edge17 ]
  %26 = phi double [ %25, %.lr.ph ], [ %44, %._crit_edge17 ]
  ...
  br i1 %exitcond.2, label %._crit_edge9, label %._crit_edge17

._crit_edge9:                                     ; preds = %._crit_edge17
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond = icmp eq i64 %indvars.iv.next2, 1200
  br i1 %exitcond, label %._crit_edge12, label %.lr.ph

._crit_edge12:                                    ; preds = %._crit_edge9
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv3, 1
  %exitcond5 = icmp eq i64 %indvars.iv.next4, 800
  br i1 %exitcond5, label %._crit_edge14, label %._crit_edge6
...
._crit_edge:                                      ; preds = %._crit_edge4, %._crit_edge.preheader
  %indvars.iv1 = phi i64 [ 0, %._crit_edge.preheader ], [ %indvars.iv.next2, %._crit_edge4 ]
  %5 = mul nuw nsw i64 %indvars.iv1, 800
  br label %._crit_edge2._crit_edge

._crit_edge2._crit_edge:                          ; preds = %._crit_edge2, %._crit_edge
  %indvars.iv = phi i64 [ 0, %._crit_edge ], [ %indvars.iv.next, %._crit_edge2 ]
...
._crit_edge2:                                     ; preds = %._crit_edge2._crit_edge, %10
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1200
  br i1 %exitcond, label %._crit_edge4, label %._crit_edge2._crit_edge

._crit_edge4:                                     ; preds = %._crit_edge2
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 800
  br i1 %exitcond3, label %._crit_edge7, label %._crit_edge
