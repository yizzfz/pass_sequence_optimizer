...
for.cond14.preheader.us:                          ; preds = %for.cond14.preheader.us.preheader, %for.inc31.us
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc31.us ], [ 0, %for.cond14.preheader.us.preheader ]
...
for.body17.us:                                    ; preds = %for.body17.us, %for.cond14.preheader.us
  ...
  %3 = mul nuw nsw i64 %indvars.iv24, %indvars.iv
...
for.inc31.us:                                     ; preds = %for.body17.us
  ...
  %exitcond38 = icmp eq i64 %indvars.iv.next25, 1200
...
for.cond1.preheader.us:                           ; preds = %for.inc32.us, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge
  ...
  %indvars.iv74 = phi i32 [ %indvars.iv.next75, %for.inc32.us ], [ 0, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge ]
  %indvars.iv60 = phi i64 [ %3, %for.inc32.us ], [ 0, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge ]
  %0 = add i64 %indvar, 1
  %1 = add i64 %indvar, -3
  %2 = lshr i64 %1, 2
  ...
  %6 = zext i32 %indvars.iv74 to i64
...
vector.body16.prol:                               ; preds = %vector.ph24
  %8 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv60, i64 0
  %9 = bitcast double* %8 to <2 x double>*
  %wide.load33.prol = load <2 x double>, <2 x double>* %9, align 8
  %10 = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv60, i64 2
...
vector.body16:                                    ; preds = %vector.body16, %vector.ph24.new
  ...
  %15 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv60, i64 %index25
  ...
  %21 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv60, i64 %index.next26
...
middle.block17:                                   ; preds = %vector.body16, %vector.body16.prol.loopexit
  ...
  br i1 %cmp.n28, label %for.cond9.preheader.us21.preheader, label %for.body3.us.preheader37
...
for.body3.us:                                     ; preds = %for.body3.us.preheader37, %for.body3.us
  ...
  %exitcond73 = icmp eq i64 %indvars.iv, %6
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br i1 %exitcond73, label %for.cond9.preheader.us21.preheader, label %for.body3.us, !llvm.loop !4
...
for.cond9.preheader.us21:                         ; preds = %for.cond9.preheader.us21.preheader, %for.inc29.us40
  %indvars.iv57 = phi i64 [ %30, %for.inc29.us40 ], [ 0, %for.cond9.preheader.us21.preheader ]
  %29 = icmp ult i64 %3, 4
  %scevgep4 = getelementptr [1000 x double], [1000 x double]* %A, i64 0, i64 %indvars.iv57
  %30 = add i64 %indvars.iv57, 1
  %scevgep6 = getelementptr [1000 x double], [1000 x double]* %A, i64 %indvars.iv60, i64 %30
  %arrayidx15.us29 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv60, i64 %indvars.iv57
  br i1 %29, label %for.body11.us25.preheader, label %min.iters.checked

min.iters.checked:                                ; preds = %for.cond9.preheader.us21
  %31 = icmp eq i64 %n.vec, 0
  br i1 %31, label %for.body11.us25.preheader, label %vector.memcheck
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %36 = or i64 %index, 2
  %37 = or i64 %index, 3
  %38 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %index, i64 %indvars.iv57
  ...
  %41 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %37, i64 %indvars.iv57
  ...
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv60, i64 %index
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %59, label %for.inc29.us40, label %for.body11.us25.preheader
...
for.body11.us25.preheader:                        ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.cond9.preheader.us21
  ...
  %60 = sub i64 %0, %indvars.iv51.ph
  %xtraiter38 = and i64 %60, 1
  %lcmp.mod39 = icmp eq i64 %xtraiter38, 0
  br i1 %lcmp.mod39, label %for.body11.us25.prol.loopexit, label %for.body11.us25.prol

for.body11.us25.prol:                             ; preds = %for.body11.us25.preheader
  %61 = load double, double* %arrayidx15.us29, align 8
  %mul16.us30.prol = fmul double %61, %alpha
  %arrayidx20.us32.prol = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv51.ph, i64 %indvars.iv57
  %62 = load double, double* %arrayidx20.us32.prol, align 8
  %mul21.us33.prol = fmul double %mul16.us30.prol, %62
  %arrayidx25.us34.prol = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv60, i64 %indvars.iv51.ph
  %63 = load double, double* %arrayidx25.us34.prol, align 8
  %add.us35.prol = fadd double %mul21.us33.prol, %63
...
for.body11.us25.prol.loopexit:                    ; preds = %for.body11.us25.prol, %for.body11.us25.preheader
  ...
  %64 = icmp eq i64 %indvar, %indvars.iv51.ph
  br i1 %64, label %for.inc29.us40, label %for.body11.us25.preheader.new
...
for.body11.us25:                                  ; preds = %for.body11.us25, %for.body11.us25.preheader.new
  ...
  %65 = load double, double* %arrayidx15.us29, align 8
  %mul16.us30 = fmul double %65, %alpha
  %arrayidx20.us32 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv51, i64 %indvars.iv57
  %66 = load double, double* %arrayidx20.us32, align 8
  %mul21.us33 = fmul double %mul16.us30, %66
  %arrayidx25.us34 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv60, i64 %indvars.iv51
  %67 = load double, double* %arrayidx25.us34, align 8
  %add.us35 = fadd double %mul21.us33, %67
  store double %add.us35, double* %arrayidx25.us34, align 8
  %indvars.iv.next52 = add nuw nsw i64 %indvars.iv51, 1
  %68 = load double, double* %arrayidx15.us29, align 8
  %mul16.us30.1 = fmul double %68, %alpha
  %arrayidx20.us32.1 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv.next52, i64 %indvars.iv57
  %69 = load double, double* %arrayidx20.us32.1, align 8
  %mul21.us33.1 = fmul double %mul16.us30.1, %69
  %arrayidx25.us34.1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv60, i64 %indvars.iv.next52
  %70 = load double, double* %arrayidx25.us34.1, align 8
  %add.us35.1 = fadd double %mul21.us33.1, %70
  store double %add.us35.1, double* %arrayidx25.us34.1, align 8
  %exitcond.1 = icmp eq i64 %indvars.iv.next52, %6
  %indvars.iv.next52.1 = add nsw i64 %indvars.iv51, 2
  br i1 %exitcond.1, label %for.inc29.us40, label %for.body11.us25, !llvm.loop !15

for.inc29.us40:                                   ; preds = %for.body11.us25.prol.loopexit, %for.body11.us25, %middle.block
  %exitcond76 = icmp eq i64 %30, 1000
  br i1 %exitcond76, label %for.inc32.us, label %for.cond9.preheader.us21

for.inc32.us:                                     ; preds = %for.inc29.us40, %for.cond1.preheader.us
