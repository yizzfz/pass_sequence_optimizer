...
for.cond1.preheader:                              ; preds = %entry, %for.inc9
  %indvars.iv37 = phi i64 [ 0, %entry ], [ %indvars.iv.next4, %for.inc9 ]
...
for.body3:                                        ; preds = %for.body3, %for.cond1.preheader
  ...
  %arrayidx8 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv37, i64 %indvars.iv6
...
for.inc9:                                         ; preds = %for.body3
  ...
  br i1 %exitcond5, label %for.end11, label %for.cond1.preheader
...
; Function Attrs: noinline nounwind uwtable
define internal fastcc void @kernel_seidel_2d([2000 x double]* %A) unnamed_addr #0 {
entry:
  br label %for.cond1.preheader

for.cond1.preheader:                              ; preds = %for.inc69, %entry
  %0 = phi i32 [ 0, %entry ], [ %inc70, %for.inc69 ]
  br label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.cond1.preheader, %for.inc66
  %indvar = phi i64 [ 0, %for.cond1.preheader ], [ %indvar.next, %for.inc66 ]
  %indvars.iv410 = phi i64 [ 1, %for.cond1.preheader ], [ %indvars.iv.next5, %for.inc66 ]
  %1 = add i64 %indvar, 1
  %scevgep = getelementptr [2000 x double], [2000 x double]* %A, i64 %1, i64 0
  %2 = add nsw i64 %indvars.iv410, -1
  %3 = add nuw nsw i64 %indvars.iv410, 1
  %load_initial = load double, double* %scevgep, align 8
  br label %for.body8

for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  %store_forwarded = phi double [ %load_initial, %for.cond5.preheader ], [ %div, %for.body8 ]
  %indvars.iv8 = phi i64 [ 1, %for.cond5.preheader ], [ %indvars.iv.next, %for.body8 ]
  %4 = add nsw i64 %indvars.iv8, -1
  %arrayidx12 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %2, i64 %4
  %5 = load double, double* %arrayidx12, align 8
  %arrayidx17 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %2, i64 %indvars.iv8
  ...
  %arrayidx34 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv410, i64 %indvars.iv8
  %8 = load double, double* %arrayidx34, align 8
  %add35 = fadd double %add30, %8
  %arrayidx40 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv410, i64 %indvars.iv.next
  %9 = load double, double* %arrayidx40, align 8
  %add41 = fadd double %add35, %9
  %arrayidx47 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %3, i64 %4
  %10 = load double, double* %arrayidx47, align 8
  %add48 = fadd double %add41, %10
  %arrayidx53 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %3, i64 %indvars.iv8
  %11 = load double, double* %arrayidx53, align 8
  %add54 = fadd double %add48, %11
  %arrayidx60 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %3, i64 %indvars.iv.next
...
for.inc66:                                        ; preds = %for.body8
  ...
  %exitcond11 = icmp eq i64 %indvars.iv.next5, 1999
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond11, label %for.inc69, label %for.cond5.preheader

for.inc69:                                        ; preds = %for.inc66
  %inc70 = add nuw nsw i32 %0, 1
  %exitcond12 = icmp eq i32 %inc70, 500
  br i1 %exitcond12, label %for.end71, label %for.cond1.preheader
...
for.cond2.preheader:                              ; preds = %for.inc10, %entry
  ...
  %3 = mul nuw nsw i64 %indvars.iv37, 2000
  br label %for.body4
...
for.inc10:                                        ; preds = %if.end
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv37, 1
  %exitcond8 = icmp eq i64 %indvars.iv.next4, 2000
