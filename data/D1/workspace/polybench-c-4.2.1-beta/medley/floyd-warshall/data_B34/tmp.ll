...
; <label>:2:                                      ; preds = %2, %.preheader
  ...
  %5 = srem i32 %4, 7
  %6 = add nsw i32 %5, 1
  %7 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv6, i64 %indvars.iv
  %8 = add nuw nsw i64 %indvars.iv, %indvars.iv6
  ...
  %. = select i1 %or.cond3, i32 999, i32 %6
...
.preheader1:                                      ; preds = %19, %1
  %indvars.iv8 = phi i64 [ 0, %1 ], [ %indvars.iv.next9, %19 ]
  br label %.preheader

.preheader:                                       ; preds = %18, %.preheader1
  %indvars.iv5 = phi i64 [ 0, %.preheader1 ], [ %indvars.iv.next6, %18 ]
  %2 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv5, i64 %indvars.iv8
  br label %3

; <label>:3:                                      ; preds = %3, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %3 ]
  %4 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv5, i64 %indvars.iv
  %5 = load i32, i32* %4, align 4
  %6 = load i32, i32* %2, align 4
  %7 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv8, i64 %indvars.iv
  ...
  %11 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv5, i64 %indvars.iv.next
  %12 = load i32, i32* %11, align 4
  %13 = load i32, i32* %2, align 4
  %14 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv8, i64 %indvars.iv.next
...
; <label>:19:                                     ; preds = %18
  ...
  br i1 %exitcond10, label %20, label %.preheader1
