...
for.body6.lr.ph:                                  ; preds = %for.inc14, %for.body.lr.ph
  %indvars.iv5 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next6, %for.inc14 ]
...
for.inc14:                                        ; preds = %for.body6.prol.loopexit, %for.inc14.unr-lcssa
  ...
  %exitcond9 = icmp eq i64 %indvars.iv.next6, %0
  br i1 %exitcond9, label %for.end16.loopexit, label %for.body6.lr.ph
...
for.body5:                                        ; preds = %for.body5, %for.body5.preheader.new
  ...
  %exitcond9.1 = icmp eq i64 %indvars.iv.next, %3
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  br i1 %exitcond9.1, label %for.end.loopexit.unr-lcssa, label %for.body5
