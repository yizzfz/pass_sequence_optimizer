...
._crit_edge1:                                     ; preds = %._crit_edge1, %2
  %indvars.iv410 = phi i64 [ 0, %2 ], [ %indvars.iv.next5.2, %._crit_edge1 ]
  ...
  br i1 %exitcond6.2, label %._crit_edge7.preheader.preheader, label %._crit_edge1

._crit_edge7.preheader.preheader:                 ; preds = %._crit_edge1
  br label %._crit_edge7.preheader

._crit_edge7.preheader:                           ; preds = %._crit_edge7.preheader.preheader, %._crit_edge
  %indvars.iv19 = phi i64 [ %indvars.iv.next2, %._crit_edge ], [ 0, %._crit_edge7.preheader.preheader ]
  br label %._crit_edge7

._crit_edge7:                                     ; preds = %._crit_edge7, %._crit_edge7.preheader
  %indvars.iv8 = phi i64 [ 0, %._crit_edge7.preheader ], [ %indvars.iv.next.1, %._crit_edge7 ]
...
._crit_edge1:                                     ; preds = %._crit_edge1, %4
  %indvars.iv721 = phi i64 [ 0, %4 ], [ %indvars.iv.next8.11, %._crit_edge1 ]
  %11 = getelementptr inbounds double, double* %2, i64 %indvars.iv721
  store double 0.000000e+00, double* %11, align 8
  %indvars.iv.next8 = or i64 %indvars.iv721, 1
  %12 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8
  store double 0.000000e+00, double* %12, align 8
  %indvars.iv.next8.1 = or i64 %indvars.iv721, 2
  %13 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.1
  store double 0.000000e+00, double* %13, align 8
  %indvars.iv.next8.2 = or i64 %indvars.iv721, 3
  %14 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.2
  store double 0.000000e+00, double* %14, align 8
  %indvars.iv.next8.3 = add nsw i64 %indvars.iv721, 4
  %15 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.3
  store double 0.000000e+00, double* %15, align 8
  %indvars.iv.next8.4 = add nsw i64 %indvars.iv721, 5
  %16 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.4
  store double 0.000000e+00, double* %16, align 8
  %indvars.iv.next8.5 = add nsw i64 %indvars.iv721, 6
  %17 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.5
  store double 0.000000e+00, double* %17, align 8
  %indvars.iv.next8.6 = add nsw i64 %indvars.iv721, 7
  %18 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.6
  store double 0.000000e+00, double* %18, align 8
  %indvars.iv.next8.7 = add nsw i64 %indvars.iv721, 8
  %19 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.7
  store double 0.000000e+00, double* %19, align 8
  %indvars.iv.next8.8 = add nsw i64 %indvars.iv721, 9
  %20 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.8
  store double 0.000000e+00, double* %20, align 8
  %indvars.iv.next8.9 = add nsw i64 %indvars.iv721, 10
  %21 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.9
  store double 0.000000e+00, double* %21, align 8
  %indvars.iv.next8.10 = add nsw i64 %indvars.iv721, 11
  %22 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next8.10
  store double 0.000000e+00, double* %22, align 8
  %indvars.iv.next8.11 = add nsw i64 %indvars.iv721, 12
  %exitcond9.11 = icmp eq i64 %indvars.iv.next8.11, 2100
  br i1 %exitcond9.11, label %._crit_edge, label %._crit_edge1

._crit_edge4:                                     ; preds = %52, %._crit_edge
  %indvars.iv420 = phi i64 [ 0, %._crit_edge ], [ %indvars.iv.next5, %52 ]
  %23 = getelementptr inbounds double, double* %3, i64 %indvars.iv420
  store double 0.000000e+00, double* %23, align 8
  br label %._crit_edge2

._crit_edge2:                                     ; preds = %._crit_edge2, %._crit_edge4
  %indvars.iv18 = phi i64 [ 0, %._crit_edge4 ], [ %indvars.iv.next.1, %._crit_edge2 ]
  %sunkaddr = ptrtoint double* %3 to i64
  %sunkaddr5 = mul i64 %indvars.iv420, 8
  %sunkaddr6 = add i64 %sunkaddr, %sunkaddr5
  %sunkaddr7 = inttoptr i64 %sunkaddr6 to double*
  %24 = load double, double* %sunkaddr7, align 8
  %25 = getelementptr inbounds [2100 x double], [2100 x double]* %8, i64 %indvars.iv420, i64 %indvars.iv18
  ...
  %sunkaddr8 = ptrtoint double* %3 to i64
  %sunkaddr9 = mul i64 %indvars.iv420, 8
  %sunkaddr10 = add i64 %sunkaddr8, %sunkaddr9
  %sunkaddr11 = inttoptr i64 %sunkaddr10 to double*
  %31 = load double, double* %sunkaddr11, align 8
  %32 = getelementptr inbounds [2100 x double], [2100 x double]* %8, i64 %indvars.iv420, i64 %indvars.iv.next
  %33 = load double, double* %32, align 8
  %34 = getelementptr inbounds double, double* %9, i64 %indvars.iv.next
  %35 = load double, double* %34, align 8
  %36 = fmul double %33, %35
  %37 = fadd double %31, %36
  store double %37, double* %sunkaddr11, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv18, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2100
  br i1 %exitcond.1, label %._crit_edge10.preheader, label %._crit_edge2

._crit_edge10.preheader:                          ; preds = %._crit_edge2
  br label %._crit_edge10

._crit_edge10:                                    ; preds = %._crit_edge10, %._crit_edge10.preheader
  %indvars.iv119 = phi i64 [ 0, %._crit_edge10.preheader ], [ %indvars.iv.next2.1, %._crit_edge10 ]
  %38 = getelementptr inbounds double, double* %10, i64 %indvars.iv119
  %39 = load double, double* %38, align 8
  %40 = getelementptr inbounds [2100 x double], [2100 x double]* %8, i64 %indvars.iv420, i64 %indvars.iv119
  %41 = load double, double* %40, align 8
  %sunkaddr12 = ptrtoint double* %3 to i64
  %sunkaddr13 = mul i64 %indvars.iv420, 8
  %sunkaddr14 = add i64 %sunkaddr12, %sunkaddr13
  %sunkaddr17 = inttoptr i64 %sunkaddr14 to double*
  ...
  %47 = getelementptr inbounds [2100 x double], [2100 x double]* %8, i64 %indvars.iv420, i64 %indvars.iv.next2
  %48 = load double, double* %47, align 8
  %sunkaddr18 = ptrtoint double* %3 to i64
  %sunkaddr19 = mul i64 %indvars.iv420, 8
  %sunkaddr20 = add i64 %sunkaddr18, %sunkaddr19
  %sunkaddr21 = inttoptr i64 %sunkaddr20 to double*
  %49 = load double, double* %sunkaddr21, align 8
  ...
  br i1 %exitcond3.1, label %52, label %._crit_edge10

; <label>:52:                                     ; preds = %._crit_edge10
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv420, 1
  %exitcond6 = icmp eq i64 %indvars.iv.next5, 1900
  br i1 %exitcond6, label %53, label %._crit_edge4
