...
@__llvm_prf_nm = private constant [46 x i8] c"',x\DAKK+\89/\CE\C8/*a,\C9-0\D4\CB\C9\B1J\CB(aL\03\8A\E6\E4\E7\A53f\E6e\96\C4\03y\00!)\0Ey", section "__llvm_prf_names"
@llvm.used = appending global [5 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_fft_short to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_fht to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_fft_long to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_init_fft to i8*), i8* getelementptr inbounds ([46 x i8], [46 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
...
define internal void @fht(float*, i16 signext) #1 {
