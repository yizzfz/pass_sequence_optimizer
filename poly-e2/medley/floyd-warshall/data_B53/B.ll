...
for.cond1.preheader:                              ; preds = %for.inc20.for.cond1.preheader_crit_edge, %entry
  %indvars.iv21 = phi i64 [ 0, %entry ], [ %indvars.iv.next22, %for.inc20.for.cond1.preheader_crit_edge ]
  br label %for.body3
...
for.cond1.preheader:                              ; preds = %for.inc38.for.cond1.preheader_crit_edge, %entry
  %indvars.iv29 = phi i64 [ 0, %entry ], [ %indvars.iv.next30, %for.inc38.for.cond1.preheader_crit_edge ]
...
for.cond4.preheader:                              ; preds = %for.inc35.for.cond4.preheader_crit_edge, %for.cond1.preheader
  %indvars.iv27 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next28, %for.inc35.for.cond4.preheader_crit_edge ]
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.body.preheader
  ...
  br i1 %23, label %for.inc35.loopexit18, label %vector.body.vector.body_crit_edge, !llvm.loop !9
...
for.inc35:                                        ; preds = %for.inc35.loopexit18, %for.inc35.loopexit
  ...
  br i1 %exitcond16, label %for.inc38, label %for.inc35.for.cond4.preheader_crit_edge
...
for.inc38:                                        ; preds = %for.inc35
  ...
  br i1 %exitcond17, label %for.end40, label %for.inc38.for.cond1.preheader_crit_edge
...
for.cond2.preheader:                              ; preds = %for.inc10.for.cond2.preheader_crit_edge, %entry
  %indvars.iv11 = phi i64 [ 0, %entry ], [ %indvars.iv.next12, %for.inc10.for.cond2.preheader_crit_edge ]
