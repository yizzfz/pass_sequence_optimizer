...
define internal void @init_array([2000 x double]*) #2 {
  br label %.preheader
...
; <label>:4:                                      ; preds = %4, %.preheader
  ...
  %11 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv12, i64 %indvars.iv
  ...
  %18 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv12, i64 %indvars.iv.next
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal void @kernel_seidel_2d([2000 x double]*) #2 {
  br label %.preheader37

.preheader37:                                     ; preds = %._crit_edge40, %1
  %storemerge41 = phi i32 [ 0, %1 ], [ %31, %._crit_edge40 ]
  br label %.preheader

.preheader:                                       ; preds = %.preheader37, %._crit_edge
  %indvar = phi i64 [ 0, %.preheader37 ], [ %indvar.next, %._crit_edge ]
  %indvars.iv42 = phi i64 [ 1, %.preheader37 ], [ %indvars.iv.next43, %._crit_edge ]
  %2 = add i64 %indvar, 1
...
; <label>:4:                                      ; preds = %.preheader, %4
  ...
  %15 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv42, i64 %indvars.iv
  %16 = load double, double* %15, align 8
  %17 = fadd double %14, %16
  %18 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv42, i64 %indvars.iv.next
  %19 = load double, double* %18, align 8
  %20 = fadd double %17, %19
  %21 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv.next43, i64 %5
  %22 = load double, double* %21, align 8
  %23 = fadd double %20, %22
  %24 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv.next43, i64 %indvars.iv
  %25 = load double, double* %24, align 8
  %26 = fadd double %23, %25
  %27 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv.next43, i64 %indvars.iv.next
...
._crit_edge:                                      ; preds = %4
  %exitcond44 = icmp eq i64 %indvars.iv.next43, 1999
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond44, label %._crit_edge40, label %.preheader

._crit_edge40:                                    ; preds = %._crit_edge
  %31 = add nuw nsw i32 %storemerge41, 1
  %exitcond45 = icmp eq i32 %31, 500
  br i1 %exitcond45, label %32, label %.preheader37

; <label>:32:                                     ; preds = %._crit_edge40
  ret void
}
