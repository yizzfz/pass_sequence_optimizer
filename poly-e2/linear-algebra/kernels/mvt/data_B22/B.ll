...
for.body.us:                                      ; preds = %for.cond22.for.inc34_crit_edge.us, %entry
  %indvars.iv10 = phi i64 [ 0, %entry ], [ %indvars.iv.next11, %for.cond22.for.inc34_crit_edge.us ]
  %0 = trunc i64 %indvars.iv10 to i32
  %rem.us = srem i32 %0, 2000
  %conv.us = sitofp i32 %rem.us to double
  %arrayidx.us = getelementptr inbounds double, double* %x1, i64 %indvars.iv10
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %1 = trunc i64 %indvars.iv.next11 to i32
  %rem2.us = srem i32 %1, 2000
  ...
  %arrayidx7.us = getelementptr inbounds double, double* %x2, i64 %indvars.iv10
  store double %div.us.v.r2, double* %arrayidx7.us, align 8
  %2 = add nuw nsw i64 %indvars.iv10, 3
  %3 = trunc i64 %2 to i32
  %rem9.us = srem i32 %3, 2000
  %conv10.us = sitofp i32 %rem9.us to double
  %arrayidx14.us = getelementptr inbounds double, double* %y_1, i64 %indvars.iv10
  %4 = add nuw nsw i64 %indvars.iv10, 4
  %5 = trunc i64 %4 to i32
  %rem16.us = srem i32 %5, 2000
  ...
  %arrayidx21.us = getelementptr inbounds double, double* %y_2, i64 %indvars.iv10
...
for.body25.us:                                    ; preds = %for.body.us, %for.body25.us
  ...
  %6 = mul nsw i64 %indvars.iv, %indvars.iv10
  %7 = trunc i64 %6 to i32
  %rem26.us = srem i32 %7, 2000
  %conv27.us = sitofp i32 %rem26.us to double
  %arrayidx33.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv10, i64 %indvars.iv
  %indvars.iv.next = or i64 %indvars.iv, 1
  %8 = mul nsw i64 %indvars.iv.next, %indvars.iv10
  %9 = trunc i64 %8 to i32
  %rem26.us.1 = srem i32 %9, 2000
  ...
  %10 = bitcast double* %arrayidx33.us to <2 x double>*
  store <2 x double> %div29.us, <2 x double>* %10, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %for.cond22.for.inc34_crit_edge.us, label %for.body25.us

for.cond22.for.inc34_crit_edge.us:                ; preds = %for.body25.us
  %exitcond = icmp eq i64 %indvars.iv.next11, 2000
  br i1 %exitcond, label %for.end36, label %for.body.us
...
entry:
  %sunkaddr41 = ptrtoint double* %x1 to i64
  %sunkaddr45 = ptrtoint double* %x1 to i64
  br label %for.cond1.preheader.us

for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc12_crit_edge.us, %entry
  %indvars.iv30 = phi i64 [ 0, %entry ], [ %indvars.iv.next31, %for.cond1.for.inc12_crit_edge.us ]
  %sunkaddr42 = shl nuw nsw i64 %indvars.iv30, 3
  ...
  %sunkaddr46 = shl nuw nsw i64 %indvars.iv30, 3
...
for.body3.us:                                     ; preds = %for.cond1.preheader.us, %for.body3.us
  ...
  %indvars.iv23 = phi i64 [ %indvars.iv.next24.1, %for.body3.us ], [ 0, %for.cond1.preheader.us ]
  %arrayidx7.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv30, i64 %indvars.iv23
  %1 = load double, double* %arrayidx7.us, align 8
  %arrayidx9.us = getelementptr inbounds double, double* %y_1, i64 %indvars.iv23
  %2 = load double, double* %arrayidx9.us, align 8
  %mul.us = fmul double %1, %2
  %add.us = fadd double %0, %mul.us
  store double %add.us, double* %sunkaddr48, align 8
  %indvars.iv.next24 = or i64 %indvars.iv23, 1
  %arrayidx7.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv30, i64 %indvars.iv.next24
  %3 = load double, double* %arrayidx7.us.1, align 8
  %arrayidx9.us.1 = getelementptr inbounds double, double* %y_1, i64 %indvars.iv.next24
  %4 = load double, double* %arrayidx9.us.1, align 8
  %mul.us.1 = fmul double %3, %4
  %add.us.1 = fadd double %add.us, %mul.us.1
  store double %add.us.1, double* %sunkaddr48, align 8
  %indvars.iv.next24.1 = add nuw nsw i64 %indvars.iv23, 2
  %exitcond.129 = icmp eq i64 %indvars.iv.next24.1, 2000
  br i1 %exitcond.129, label %for.cond1.for.inc12_crit_edge.us, label %for.body3.us

for.cond1.for.inc12_crit_edge.us:                 ; preds = %for.body3.us
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  %exitcond61 = icmp eq i64 %indvars.iv.next31, 2000
  br i1 %exitcond61, label %for.cond18.preheader.us.preheader, label %for.cond1.preheader.us

for.cond18.preheader.us.preheader:                ; preds = %for.cond1.for.inc12_crit_edge.us
  %sunkaddr53 = ptrtoint double* %x2 to i64
  %sunkaddr57 = ptrtoint double* %x2 to i64
...
for.cond18.preheader.us:                          ; preds = %for.cond18.preheader.us.preheader, %for.cond18.for.inc36_crit_edge.us
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.cond18.for.inc36_crit_edge.us ], [ 0, %for.cond18.preheader.us.preheader ]
  %sunkaddr54 = shl nuw nsw i64 %indvars.iv21, 3
  %sunkaddr55 = add i64 %sunkaddr53, %sunkaddr54
  %sunkaddr56 = inttoptr i64 %sunkaddr55 to double*
  %.pre37 = load double, double* %sunkaddr56, align 8
  %sunkaddr58 = shl nuw nsw i64 %indvars.iv21, 3
...
for.body20.us:                                    ; preds = %for.cond18.preheader.us, %for.body20.us
  %5 = phi double [ %add30.us.1, %for.body20.us ], [ %.pre37, %for.cond18.preheader.us ]
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %for.body20.us ], [ 0, %for.cond18.preheader.us ]
  %arrayidx26.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv, i64 %indvars.iv21
  ...
  store double %add30.us, double* %sunkaddr60, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx26.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv.next, i64 %indvars.iv21
  ...
  store double %add30.us.1, double* %sunkaddr60, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
...
for.body:                                         ; preds = %if.end, %entry
  %indvars.iv10 = phi i64 [ 0, %entry ], [ %indvars.iv.next11, %if.end ]
...
if.end:                                           ; preds = %for.body, %if.then
  ...
  br i1 %exitcond12, label %for.end, label %for.body
