...
for.body6:                                        ; preds = %for.body6, %for.body6.lr.ph.new
  ...
  %11 = sub nsw i64 %3, %indvars.iv.next
  %12 = add nsw i64 %11, 1
...
for.body5.prol.loopexit:                          ; preds = %for.body5.prol.loopexit.unr-lcssa
  %11 = icmp eq i64 %2, 0
  br i1 %11, label %for.end.loopexit, label %for.body5.preheader.new
...
for.body5:                                        ; preds = %for.body5, %for.body5.preheader.new
  ...
  %exitcond11.1 = icmp eq i64 %indvars.iv.next, %3
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  br i1 %exitcond11.1, label %for.end.loopexit.unr-lcssa, label %for.body5
