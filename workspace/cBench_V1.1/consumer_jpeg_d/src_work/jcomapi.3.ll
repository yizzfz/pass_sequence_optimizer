...
@__llvm_prf_nm = private constant [57 x i8] c"D7x\DA\CB*HM\8FOL\CA/*a\CC\021SR\8BK\8A\F2+!\9C\C4\9C\9C\FC\E4\F8\C2\D2\C4\BC\92\F8\92\C4\A4\9CTd\E1\8C\D2\B44\88(\00\94\AB\1A\AE", section "__llvm_prf_names"
@llvm.used = appending global [6 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_abort to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_destroy to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_alloc_quant_table to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_alloc_huff_table to i8*), i8* bitcast ([10 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([57 x i8], [57 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
