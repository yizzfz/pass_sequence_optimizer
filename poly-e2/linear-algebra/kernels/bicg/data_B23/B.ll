...
for.cond12.for.inc27_crit_edge.us:                ; preds = %for.inc24.us
  ...
  %exitcond = icmp ne i64 %indvars.iv.next3, 2100
  br i1 %exitcond, label %for.body5.us, label %for.end29
...
for.inc31.us:                                     ; preds = %for.inc31.us, %for.body3.us
  ...
  %sunkaddr24 = ptrtoint double* %q to i64
  %sunkaddr25 = mul nuw nsw i64 %indvars.iv1, 8
  %sunkaddr26 = add i64 %sunkaddr24, %sunkaddr25
  %sunkaddr27 = inttoptr i64 %sunkaddr26 to double*
  %3 = load double, double* %sunkaddr27, align 8
  ...
  store double %add28.us, double* %sunkaddr27, align 8
...
for.cond6.for.inc34_crit_edge.us:                 ; preds = %for.inc31.us
  ...
  %exitcond28 = icmp ne i64 %indvars.iv.next2, 2100
  br i1 %exitcond28, label %for.body3.us, label %for.end36
...
for.inc:                                          ; preds = %for.body, %if.then
  ...
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp ne i64 %indvars.iv.next2, 1900
  br i1 %exitcond3, label %for.body, label %for.body9.preheader
...
for.inc18:                                        ; preds = %for.body9, %if.then12
  ...
  br i1 %exitcond, label %for.body9, label %for.end20
