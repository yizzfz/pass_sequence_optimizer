...
@__llvm_prf_nm = private constant [17 x i8] c"\0F\00jpeg_idct_ifast", section "__llvm_prf_names"
@llvm.used = appending global [2 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jpeg_idct_ifast to i8*), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
