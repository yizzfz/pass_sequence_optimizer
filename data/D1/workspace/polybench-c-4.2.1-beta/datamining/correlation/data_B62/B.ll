...
.lr.ph151.split.preheader236:                     ; preds = %.lr.ph151.split.prol.loopexit
  ...
  br i1 %min.iters.check, label %.lr.ph151.split.preheader266, label %min.iters.checked

.lr.ph151.split.preheader266:                     ; preds = %middle.block, %min.iters.checked, %.lr.ph151.split.preheader236
...
min.iters.checked:                                ; preds = %.lr.ph151.split.preheader236
  ...
  br i1 %cmp.zero, label %.lr.ph151.split.preheader266, label %vector.ph

vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert249 = insertelement <2 x double> undef, double %16, i32 0
  %interleaved.vec = shufflevector <2 x double> %broadcast.splatinsert249, <2 x double> undef, <8 x i32> zeroinitializer
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %.._crit_edge109_crit_edge, label %.lr.ph151.split.preheader266
...
.lr.ph151.split.us:                               ; preds = %.lr.ph151.split.us.preheader, %._crit_edge147.us
  ...
  br i1 %lcmp.mod222, label %.prol.loopexit220, label %.prol.preheader219
...
.prol.loopexit220:                                ; preds = %.prol.preheader219, %.lr.ph151.split.us
  %indvars.iv215.unr.ph = phi i64 [ 1, %.prol.preheader219 ], [ 0, %.lr.ph151.split.us ]
  %.unr223.ph = phi double [ %39, %.prol.preheader219 ], [ 0.000000e+00, %.lr.ph151.split.us ]
  %.lcssa182.unr.ph = phi double [ %39, %.prol.preheader219 ], [ undef, %.lr.ph151.split.us ]
  br i1 %10, label %.prol.loopexit220.._crit_edge147.us_crit_edge, label %.lr.ph151.split.us.new.preheader

.prol.loopexit220.._crit_edge147.us_crit_edge:    ; preds = %.prol.loopexit220
  %.pre = shl nsw i64 %35, 3
  %.pre258 = add i64 %sunkaddr161, %.pre
  %.pre259 = inttoptr i64 %.pre258 to double*
  br label %._crit_edge147.us

.lr.ph151.split.us.new.preheader:                 ; preds = %.prol.loopexit220
  %sunkaddr158 = shl nsw i64 %35, 3
  %sunkaddr159 = add i64 %sunkaddr161, %sunkaddr158
  %sunkaddr160 = inttoptr i64 %sunkaddr159 to double*
  %40 = sub nsw i64 %11, %indvars.iv215.unr.ph
  %41 = lshr i64 %40, 1
  %42 = and i64 %41, 1
  %lcmp.mod272 = icmp eq i64 %42, 0
  br i1 %lcmp.mod272, label %.lr.ph151.split.us.new.prol.preheader, label %.lr.ph151.split.us.new.prol.loopexit.unr-lcssa
...
.lr.ph151.split.us.new.prol:                      ; preds = %.lr.ph151.split.us.new.prol.preheader
  ...
  store double %45, double* %sunkaddr160, align 8
  ...
  store double %48, double* %sunkaddr160, align 8
...
.lr.ph151.split.us.new.prol.loopexit.unr-lcssa:   ; preds = %.lr.ph151.split.us.new.preheader, %.lr.ph151.split.us.new.prol
  %.lcssa270.unr.ph = phi double [ %48, %.lr.ph151.split.us.new.prol ], [ undef, %.lr.ph151.split.us.new.preheader ]
  %indvars.iv215.unr.ph273 = phi i64 [ %indvars.iv.next216.1.prol, %.lr.ph151.split.us.new.prol ], [ %indvars.iv215.unr.ph, %.lr.ph151.split.us.new.preheader ]
  %.unr.ph274 = phi double [ %48, %.lr.ph151.split.us.new.prol ], [ %.unr223.ph, %.lr.ph151.split.us.new.preheader ]
...
.lr.ph151.split.us.new:                           ; preds = %.lr.ph151.split.us.new, %.lr.ph151.split.us.new.preheader.new
  %indvars.iv215 = phi i64 [ %indvars.iv215.unr.ph273, %.lr.ph151.split.us.new.preheader.new ], [ %indvars.iv.next216.1.1, %.lr.ph151.split.us.new ]
  %50 = phi double [ %.unr.ph274, %.lr.ph151.split.us.new.preheader.new ], [ %62, %.lr.ph151.split.us.new ]
  %51 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv215, i64 %35
  %52 = load double, double* %51, align 8
  %53 = fadd double %52, %50
  store double %53, double* %sunkaddr160, align 8
  ...
  store double %56, double* %sunkaddr160, align 8
  ...
  store double %59, double* %sunkaddr160, align 8
  %indvars.iv.next216.1275 = add nsw i64 %indvars.iv215, 3
  %60 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next216.1275, i64 %35
  %61 = load double, double* %60, align 8
  %62 = fadd double %61, %59
  store double %62, double* %sunkaddr160, align 8
...
._crit_edge147.us.loopexit:                       ; preds = %.lr.ph151.split.us.new.prol.loopexit, %._crit_edge147.us.loopexit.unr-lcssa
  %.lcssa270 = phi double [ %.lcssa270.unr.ph, %.lr.ph151.split.us.new.prol.loopexit ], [ %62, %._crit_edge147.us.loopexit.unr-lcssa ]
  br label %._crit_edge147.us

._crit_edge147.us:                                ; preds = %._crit_edge147.us.loopexit, %.prol.loopexit220.._crit_edge147.us_crit_edge
  %sunkaddr164.pre-phi = phi double* [ %.pre259, %.prol.loopexit220.._crit_edge147.us_crit_edge ], [ %sunkaddr160, %._crit_edge147.us.loopexit ]
  %.lcssa182 = phi double [ %.lcssa182.unr.ph, %.prol.loopexit220.._crit_edge147.us_crit_edge ], [ %.lcssa270, %._crit_edge147.us.loopexit ]
  %63 = fdiv double %.lcssa182, %2
  store double %63, double* %sunkaddr164.pre-phi, align 8
  %64 = add nsw i32 %.0100149.us, 1
  %65 = icmp slt i32 %64, %0
  br i1 %65, label %.lr.ph151.split.us, label %.._crit_edge109_crit_edge.loopexit

.._crit_edge109_crit_edge.loopexit:               ; preds = %._crit_edge147.us
  br label %.._crit_edge109_crit_edge

.._crit_edge109_crit_edge.loopexit267:            ; preds = %.lr.ph151.split
  br label %.._crit_edge109_crit_edge

.._crit_edge109_crit_edge:                        ; preds = %.._crit_edge109_crit_edge.loopexit267, %.._crit_edge109_crit_edge.loopexit, %middle.block
...
.lr.ph143:                                        ; preds = %.lr.ph151.split.prol.loopexit, %.._crit_edge109_crit_edge
...
.lr.ph143.split.us:                               ; preds = %.lr.ph143.split.us.preheader, %._crit_edge140.us
  ...
  br i1 %lcmp.mod207, label %.prol.loopexit205, label %.prol.preheader204
...
.prol.loopexit205:                                ; preds = %.prol.preheader204, %.lr.ph143.split.us
  %indvars.iv200.unr.ph = phi i64 [ 1, %.prol.preheader204 ], [ 0, %.lr.ph143.split.us ]
  %.unr208.ph = phi double [ %80, %.prol.preheader204 ], [ 0.000000e+00, %.lr.ph143.split.us ]
  %.lcssa181.unr.ph = phi double [ %80, %.prol.preheader204 ], [ undef, %.lr.ph143.split.us ]
...
._crit_edge140.us:                                ; preds = %._crit_edge140.us.loopexit, %.prol.loopexit205.._crit_edge140.us_crit_edge
  %sunkaddr176.pre-phi = phi double* [ %.pre262, %.prol.loopexit205.._crit_edge140.us_crit_edge ], [ %sunkaddr172, %._crit_edge140.us.loopexit ]
...
.lr.ph151.split:                                  ; preds = %.lr.ph151.split.preheader266, %.lr.ph151.split
  %indvars.iv224 = phi i64 [ %indvars.iv.next225.3, %.lr.ph151.split ], [ %indvars.iv224.ph, %.lr.ph151.split.preheader266 ]
  ...
  br i1 %exitcond227.3, label %.._crit_edge109_crit_edge.loopexit267, label %.lr.ph151.split, !llvm.loop !6

._crit_edge109.._crit_edge110_crit_edge.loopexit: ; preds = %._crit_edge140.us
  br label %._crit_edge109.._crit_edge110_crit_edge

._crit_edge109.._crit_edge110_crit_edge.loopexit265: ; preds = %.lr.ph143.split
  br label %._crit_edge109.._crit_edge110_crit_edge

._crit_edge109.._crit_edge110_crit_edge:          ; preds = %._crit_edge109.._crit_edge110_crit_edge.loopexit265, %._crit_edge109.._crit_edge110_crit_edge.loopexit, %.._crit_edge109_crit_edge.._crit_edge109.._crit_edge110_crit_edge_crit_edge, %7, %.lr.ph143.split.prol.loopexit
...
.lr.ph143.split:                                  ; preds = %.lr.ph143.split.preheader234, %.lr.ph143.split
  ...
  br i1 %exitcond212.1, label %._crit_edge109.._crit_edge110_crit_edge.loopexit265, label %.lr.ph143.split
...
.lr.ph123.split.prol.loopexit:                    ; preds = %.lr.ph123.split.prol.loopexit.loopexit, %.lr.ph123.split.preheader
  ...
  br i1 %174, label %._crit_edge112, label %.lr.ph123.split.preheader263

.lr.ph123.split.preheader263:                     ; preds = %.lr.ph123.split.prol.loopexit
  br label %.lr.ph123.split

.lr.ph123.split:                                  ; preds = %.lr.ph123.split.preheader263, %.lr.ph123.split
  %indvars.iv185 = phi i64 [ %indvars.iv.next186.3, %.lr.ph123.split ], [ %indvars.iv185.unr, %.lr.ph123.split.preheader263 ]
...
._crit_edge112:                                   ; preds = %._crit_edge112.loopexit, %.lr.ph123.split.prol.loopexit, %._crit_edge112.._crit_edge113_crit_edge
  ...
  br i1 %exitcond, label %._crit_edge112._crit_edge.loopexit264, label %._crit_edge112.._crit_edge113_crit_edge

._crit_edge112._crit_edge.loopexit:               ; preds = %._crit_edge112.us
  br label %._crit_edge112._crit_edge

._crit_edge112._crit_edge.loopexit264:            ; preds = %._crit_edge112
  br label %._crit_edge112._crit_edge

._crit_edge112._crit_edge:                        ; preds = %._crit_edge112._crit_edge.loopexit264, %._crit_edge112._crit_edge.loopexit, %._crit_edge110.._crit_edge112_crit_edge.thread, %._crit_edge110.._crit_edge112_crit_edge
  %183 = phi i32 [ %105, %._crit_edge110.._crit_edge112_crit_edge.thread ], [ %128, %._crit_edge110.._crit_edge112_crit_edge ], [ %128, %._crit_edge112._crit_edge.loopexit ], [ %128, %._crit_edge112._crit_edge.loopexit264 ]
