...
for.inc:                                          ; preds = %for.inc, %entry
  %indvars.iv2 = phi i64 [ 0, %entry ], [ %indvars.iv.next.1, %for.inc ]
...
entry:
  ...
  %scevgep15 = getelementptr double, double* %A, i64 1999
  %scevgep18 = getelementptr double, double* %B, i64 2000
  %scevgep31 = getelementptr double, double* %B, i64 1
  %scevgep33 = getelementptr double, double* %B, i64 1999
  %scevgep36 = getelementptr double, double* %A, i64 2000
  %bound038 = icmp ult double* %scevgep31, %scevgep36
  %bound139 = icmp ugt double* %scevgep33, %A
...
for.cond1.preheader:                              ; preds = %for.inc33, %entry
  ...
  br i1 %found.conflict40, label %for.inc.preheader, label %vector.body26.preheader

vector.body26.preheader:                          ; preds = %for.cond1.preheader
  br label %vector.body26

for.inc.preheader.loopexit:                       ; preds = %vector.body26
  br label %for.inc.preheader

for.inc.preheader:                                ; preds = %for.inc.preheader.loopexit, %for.cond1.preheader
  %indvars.iv8.ph = phi i64 [ 1, %for.cond1.preheader ], [ 1997, %for.inc.preheader.loopexit ]
...
vector.body26:                                    ; preds = %vector.body26.preheader, %vector.body26
  %index44 = phi i64 [ %index.next45, %vector.body26 ], [ 0, %vector.body26.preheader ]
  %offset.idx48 = or i64 %index44, 1
  %1 = getelementptr inbounds double, double* %A, i64 %index44
  %2 = bitcast double* %1 to <2 x double>*
  %wide.load53 = load <2 x double>, <2 x double>* %2, align 8, !alias.scope !1
  %3 = getelementptr double, double* %1, i64 2
  %4 = bitcast double* %3 to <2 x double>*
  %wide.load54 = load <2 x double>, <2 x double>* %4, align 8, !alias.scope !1
  %5 = getelementptr inbounds double, double* %A, i64 %offset.idx48
  %6 = bitcast double* %5 to <2 x double>*
  %wide.load55 = load <2 x double>, <2 x double>* %6, align 8, !alias.scope !1
  %7 = getelementptr double, double* %5, i64 2
  %8 = bitcast double* %7 to <2 x double>*
  %wide.load56 = load <2 x double>, <2 x double>* %8, align 8, !alias.scope !1
  %9 = fadd <2 x double> %wide.load53, %wide.load55
  %10 = fadd <2 x double> %wide.load54, %wide.load56
  %11 = add nuw nsw i64 %offset.idx48, 1
  %12 = getelementptr inbounds double, double* %A, i64 %11
  %13 = getelementptr double, double* %12, i64 2
  %14 = bitcast double* %13 to <2 x double>*
  %wide.load58 = load <2 x double>, <2 x double>* %14, align 8, !alias.scope !1
  %15 = fadd <2 x double> %9, %wide.load54
  %16 = fadd <2 x double> %10, %wide.load58
  ...
  %19 = getelementptr inbounds double, double* %B, i64 %offset.idx48
  ...
  %23 = icmp eq i64 %index.next45, 1996
  br i1 %23, label %for.inc.preheader.loopexit, label %vector.body26, !llvm.loop !6
...
for.inc30.preheader:                              ; preds = %for.inc30.preheader.loopexit, %vector.memcheck
  %indvars.iv410.ph = phi i64 [ 1, %vector.memcheck ], [ 1997, %for.inc30.preheader.loopexit ]
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load21 = load <2 x double>, <2 x double>* %27, align 8, !alias.scope !9
  %28 = getelementptr inbounds double, double* %B, i64 %offset.idx
  %29 = bitcast double* %28 to <2 x double>*
  %wide.load22 = load <2 x double>, <2 x double>* %29, align 8, !alias.scope !9
  %30 = getelementptr double, double* %28, i64 2
  %31 = bitcast double* %30 to <2 x double>*
  %wide.load23 = load <2 x double>, <2 x double>* %31, align 8, !alias.scope !9
  %32 = fadd <2 x double> %wide.load, %wide.load22
  %33 = fadd <2 x double> %wide.load21, %wide.load23
  ...
  %wide.load25 = load <2 x double>, <2 x double>* %37, align 8, !alias.scope !9
  %38 = fadd <2 x double> %32, %wide.load21
  %39 = fadd <2 x double> %33, %wide.load25
...
for.inc:                                          ; preds = %for.inc, %for.inc.preheader.new
  %indvars.iv8 = phi i64 [ %indvars.iv8.ph, %for.inc.preheader.new ], [ %indvars.iv.next.1, %for.inc ]
  %47 = add nsw i64 %indvars.iv8, -1
  %arrayidx = getelementptr inbounds double, double* %A, i64 %47
  %48 = load double, double* %arrayidx, align 8
  %arrayidx6 = getelementptr inbounds double, double* %A, i64 %indvars.iv8
  ...
  %arrayidx12 = getelementptr inbounds double, double* %B, i64 %indvars.iv8
...
for.inc30:                                        ; preds = %for.inc30, %for.inc30.preheader.new
  %indvars.iv410 = phi i64 [ %indvars.iv410.ph, %for.inc30.preheader.new ], [ %indvars.iv.next5.1, %for.inc30 ]
  %54 = add nsw i64 %indvars.iv410, -1
  %arrayidx19 = getelementptr inbounds double, double* %B, i64 %54
  %55 = load double, double* %arrayidx19, align 8
  %arrayidx21 = getelementptr inbounds double, double* %B, i64 %indvars.iv410
  ...
  %arrayidx29 = getelementptr inbounds double, double* %A, i64 %indvars.iv410
  ...
  %exitcond12.1 = icmp eq i64 %indvars.iv.next5.1, 1999
  br i1 %exitcond12.1, label %for.inc33.unr-lcssa, label %for.inc30, !llvm.loop !16
...
for.inc33:                                        ; preds = %for.inc30.prol.loopexit.unr-lcssa.for.inc33_crit_edge, %for.inc33.unr-lcssa
  ...
  %exitcond13 = icmp eq i32 %inc34, 500
  br i1 %exitcond13, label %for.end35, label %for.cond1.preheader
