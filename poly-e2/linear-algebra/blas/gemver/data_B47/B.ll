...
entry:
  ...
  %arraydecay22 = bitcast i8* %call to [2000 x double]*
  %arraydecay923 = bitcast i8* %call1 to double*
  %arraydecay1024 = bitcast i8* %call2 to double*
  %arraydecay1125 = bitcast i8* %call3 to double*
  %arraydecay1226 = bitcast i8* %call4 to double*
  %arraydecay1327 = bitcast i8* %call5 to double*
  %arraydecay1428 = bitcast i8* %call6 to double*
  %arraydecay1529 = bitcast i8* %call7 to double*
  %arraydecay1630 = bitcast i8* %call8 to double*
  call void @init_array(double* nonnull %alpha, double* nonnull %beta, [2000 x double]* %arraydecay22, double* %arraydecay923, double* %arraydecay1024, double* %arraydecay1125, double* %arraydecay1226, double* %arraydecay1327, double* %arraydecay1428, double* %arraydecay1529, double* %arraydecay1630)
  call void (...) @polybench_timer_start() #4
  %0 = load double, double* %alpha, align 8
  %1 = load double, double* %beta, align 8
  call void @kernel_gemver(double %0, double %1, [2000 x double]* %arraydecay22, double* %arraydecay923, double* %arraydecay1024, double* %arraydecay1125, double* %arraydecay1226, double* %arraydecay1327, double* %arraydecay1428, double* %arraydecay1529, double* %arraydecay1630)
...
if.then:                                          ; preds = %land.lhs.true
  call void @print_array(double* %arraydecay1327)
  br label %if.end
...
for.body.us:                                      ; preds = %entry, %for.cond35.for.cond.loopexit_crit_edge.us
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.cond35.for.cond.loopexit_crit_edge.us ], [ 0, %entry ]
...
for.cond35.for.cond.loopexit_crit_edge.us:        ; preds = %for.inc.us
  ...
  br i1 %exitcond37, label %for.end48, label %for.body.us
...
for.cond1.preheader.us:                           ; preds = %entry, %for.cond1.for.inc20_crit_edge.us
  %indvars.iv82 = phi i64 [ %indvars.iv.next83, %for.cond1.for.inc20_crit_edge.us ], [ 0, %entry ]
...
for.cond1.for.inc20_crit_edge.us:                 ; preds = %for.cond1.for.inc20_crit_edge.us.loopexit68, %for.cond1.for.inc20_crit_edge.us.loopexit
  ...
  br i1 %exitcond85, label %for.cond26.preheader.us.preheader, label %for.cond1.preheader.us
...
for.cond26.preheader.us:                          ; preds = %for.cond26.preheader.us.preheader, %for.cond26.for.inc45_crit_edge.us
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %for.cond26.for.inc45_crit_edge.us ], [ 0, %for.cond26.preheader.us.preheader ]
...
for.inc42.us:                                     ; preds = %for.cond26.preheader.us, %for.inc42.us
  ...
  %indvars.iv70 = phi i64 [ %indvars.iv.next71.1, %for.inc42.us ], [ 0, %for.cond26.preheader.us ]
...
for.cond26.for.inc45_crit_edge.us:                ; preds = %for.inc42.us
  ...
  br i1 %exitcond77, label %vector.memcheck46, label %for.cond26.preheader.us
...
for.cond64.preheader.us:                          ; preds = %for.cond64.preheader.us.preheader, %for.cond64.for.inc83_crit_edge.us
  ...
  %.pre97 = load double, double* %arrayidx68.us, align 8
  br label %for.inc80.us

for.inc80.us:                                     ; preds = %for.cond64.preheader.us, %for.inc80.us
  %66 = phi double [ %add77.us.1, %for.inc80.us ], [ %.pre97, %for.cond64.preheader.us ]
...
for.inc58:                                        ; preds = %for.inc58.preheader, %for.inc58
  ...
  br i1 %exitcond69.3, label %for.cond64.preheader.us.preheader.loopexit, label %for.inc58, !llvm.loop !23
