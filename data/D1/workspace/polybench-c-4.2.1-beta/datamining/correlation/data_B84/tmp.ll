...
.._crit_edge_crit_edge:                           ; preds = %..._crit_edge_crit_edge_crit_edge, %2
  %storemerge7 = phi i32 [ 0, %2 ], [ %20, %..._crit_edge_crit_edge_crit_edge ]
...
; <label>:19:                                     ; preds = %._crit_edge
  ...
  br i1 %21, label %..._crit_edge_crit_edge_crit_edge, label %22
...
define internal fastcc void @kernel_correlation(i32, i32, double, [1200 x double]* nocapture, [1200 x double]* nocapture, double* nocapture, double* nocapture) unnamed_addr #0 {
  %8 = icmp sgt i32 %0, 0
  br i1 %8, label %.lr.ph134, label %.._crit_edge.._crit_edge9_crit_edge_crit_edge

.._crit_edge.._crit_edge9_crit_edge_crit_edge:    ; preds = %7
...
.lr.ph134.split.preheader:                        ; preds = %.lr.ph134
  ...
  br i1 %lcmp.mod212, label %.lr.ph134.split.preheader..lr.ph134.split.prol.loopexit_crit_edge, label %.lr.ph134.split.prol.preheader

.lr.ph134.split.preheader..lr.ph134.split.prol.loopexit_crit_edge: ; preds = %.lr.ph134.split.preheader
...
.lr.ph134.split.prol:                             ; preds = %.lr.ph134.split.prol..lr.ph134.split.prol_crit_edge, %.lr.ph134.split.prol.preheader
  %indvars.iv207.prol = phi i64 [ %indvars.iv.next208.prol, %.lr.ph134.split.prol..lr.ph134.split.prol_crit_edge ], [ 0, %.lr.ph134.split.prol.preheader ]
  %prol.iter213 = phi i32 [ %prol.iter213.sub, %.lr.ph134.split.prol..lr.ph134.split.prol_crit_edge ], [ %xtraiter211, %.lr.ph134.split.prol.preheader ]
  ...
  br i1 %prol.iter213.cmp, label %.lr.ph134.split.prol.loopexit.loopexit, label %.lr.ph134.split.prol..lr.ph134.split.prol_crit_edge, !llvm.loop !1

.lr.ph134.split.prol..lr.ph134.split.prol_crit_edge: ; preds = %.lr.ph134.split.prol
  br label %.lr.ph134.split.prol

.lr.ph134.split.prol.loopexit.loopexit:           ; preds = %.lr.ph134.split.prol
  br label %.lr.ph134.split.prol.loopexit

.lr.ph134.split.prol.loopexit:                    ; preds = %.lr.ph134.split.preheader..lr.ph134.split.prol.loopexit_crit_edge, %.lr.ph134.split.prol.loopexit.loopexit
  %indvars.iv207.unr = phi i64 [ 0, %.lr.ph134.split.preheader..lr.ph134.split.prol.loopexit_crit_edge ], [ %indvars.iv.next208.prol, %.lr.ph134.split.prol.loopexit.loopexit ]
  %15 = icmp ult i32 %12, 3
  br i1 %15, label %.lr.ph134.split.prol.loopexit..lr.ph128_crit_edge, label %.lr.ph134.split.preheader219

.lr.ph134.split.prol.loopexit..lr.ph128_crit_edge: ; preds = %.lr.ph134.split.prol.loopexit
  br label %.lr.ph128
...
.lr.ph134.split.preheader219:                     ; preds = %.lr.ph134.split.prol.loopexit
  ...
  br i1 %min.iters.check, label %.lr.ph134.split.preheader219..lr.ph134.split.preheader252_crit_edge, label %min.iters.checked

.lr.ph134.split.preheader219..lr.ph134.split.preheader252_crit_edge: ; preds = %.lr.ph134.split.preheader219
  br label %.lr.ph134.split.preheader252

.lr.ph134.split.preheader252:                     ; preds = %middle.block..lr.ph134.split.preheader252_crit_edge, %min.iters.checked..lr.ph134.split.preheader252_crit_edge, %.lr.ph134.split.preheader219..lr.ph134.split.preheader252_crit_edge
  %indvars.iv207.ph = phi i64 [ %indvars.iv207.unr, %min.iters.checked..lr.ph134.split.preheader252_crit_edge ], [ %indvars.iv207.unr, %.lr.ph134.split.preheader219..lr.ph134.split.preheader252_crit_edge ], [ %ind.end, %middle.block..lr.ph134.split.preheader252_crit_edge ]
...
min.iters.checked:                                ; preds = %.lr.ph134.split.preheader219
  ...
  br i1 %cmp.zero, label %min.iters.checked..lr.ph134.split.preheader252_crit_edge, label %vector.ph

min.iters.checked..lr.ph134.split.preheader252_crit_edge: ; preds = %min.iters.checked
  br label %.lr.ph134.split.preheader252

vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert235 = insertelement <2 x double> undef, double %16, i32 0
  %interleaved.vec = shufflevector <2 x double> %broadcast.splatinsert235, <2 x double> undef, <8 x i32> zeroinitializer
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.ph
  ...
  br i1 %34, label %middle.block, label %vector.body.vector.body_crit_edge, !llvm.loop !3
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %middle.block..._crit_edge_crit_edge_crit_edge, label %middle.block..lr.ph134.split.preheader252_crit_edge

middle.block..lr.ph134.split.preheader252_crit_edge: ; preds = %middle.block
  br label %.lr.ph134.split.preheader252

middle.block..._crit_edge_crit_edge_crit_edge:    ; preds = %middle.block
  br label %.._crit_edge_crit_edge

.lr.ph134.split.us:                               ; preds = %._crit_edge.us..lr.ph134.split.us_crit_edge, %.lr.ph134.split.us.preheader
  %storemerge132.us = phi i32 [ %64, %._crit_edge.us..lr.ph134.split.us_crit_edge ], [ 0, %.lr.ph134.split.us.preheader ]
  %35 = sext i32 %storemerge132.us to i64
  %36 = getelementptr inbounds double, double* %5, i64 %35
  store double 0.000000e+00, double* %36, align 8
  br i1 %lcmp.mod205, label %.lr.ph134.split.us..prol.loopexit203_crit_edge, label %.prol.preheader202

.lr.ph134.split.us..prol.loopexit203_crit_edge:   ; preds = %.lr.ph134.split.us
...
.prol.loopexit203:                                ; preds = %.lr.ph134.split.us..prol.loopexit203_crit_edge, %.prol.preheader202
  %indvars.iv198.unr.ph = phi i64 [ 1, %.prol.preheader202 ], [ 0, %.lr.ph134.split.us..prol.loopexit203_crit_edge ]
  %.unr206.ph = phi double [ %39, %.prol.preheader202 ], [ 0.000000e+00, %.lr.ph134.split.us..prol.loopexit203_crit_edge ]
  %.lcssa165.unr.ph = phi double [ %39, %.prol.preheader202 ], [ undef, %.lr.ph134.split.us..prol.loopexit203_crit_edge ]
...
.prol.loopexit203.._crit_edge.us_crit_edge:       ; preds = %.prol.loopexit203
  ...
  %.pre244 = add i64 %sunkaddr144, %.pre
...
.lr.ph134.split.us.new.preheader:                 ; preds = %.prol.loopexit203
  ...
  %41 = lshr i64 %40, 1
  %42 = and i64 %41, 1
  %lcmp.mod258 = icmp eq i64 %42, 0
  br i1 %lcmp.mod258, label %.lr.ph134.split.us.new.prol.preheader, label %.lr.ph134.split.us.new.preheader..lr.ph134.split.us.new.prol.loopexit.unr-lcssa_crit_edge

.lr.ph134.split.us.new.preheader..lr.ph134.split.us.new.prol.loopexit.unr-lcssa_crit_edge: ; preds = %.lr.ph134.split.us.new.preheader
...
.lr.ph134.split.us.new.prol.loopexit.unr-lcssa:   ; preds = %.lr.ph134.split.us.new.preheader..lr.ph134.split.us.new.prol.loopexit.unr-lcssa_crit_edge, %.lr.ph134.split.us.new.prol
  %.lcssa256.unr.ph = phi double [ %48, %.lr.ph134.split.us.new.prol ], [ undef, %.lr.ph134.split.us.new.preheader..lr.ph134.split.us.new.prol.loopexit.unr-lcssa_crit_edge ]
  %indvars.iv198.unr.ph259 = phi i64 [ %indvars.iv.next199.1.prol, %.lr.ph134.split.us.new.prol ], [ %indvars.iv198.unr.ph, %.lr.ph134.split.us.new.preheader..lr.ph134.split.us.new.prol.loopexit.unr-lcssa_crit_edge ]
  %.unr.ph260 = phi double [ %48, %.lr.ph134.split.us.new.prol ], [ %.unr206.ph, %.lr.ph134.split.us.new.preheader..lr.ph134.split.us.new.prol.loopexit.unr-lcssa_crit_edge ]
...
.lr.ph134.split.us.new.prol.loopexit:             ; preds = %.lr.ph134.split.us.new.prol.loopexit.unr-lcssa
  %49 = icmp eq i64 %41, 0
  br i1 %49, label %.lr.ph134.split.us.new.prol.loopexit.._crit_edge.us.loopexit_crit_edge, label %.lr.ph134.split.us.new.preheader.new

.lr.ph134.split.us.new.prol.loopexit.._crit_edge.us.loopexit_crit_edge: ; preds = %.lr.ph134.split.us.new.prol.loopexit
...
.lr.ph134.split.us.new:                           ; preds = %.lr.ph134.split.us.new..lr.ph134.split.us.new_crit_edge, %.lr.ph134.split.us.new.preheader.new
  %indvars.iv198 = phi i64 [ %indvars.iv198.unr.ph259, %.lr.ph134.split.us.new.preheader.new ], [ %indvars.iv.next199.1.1, %.lr.ph134.split.us.new..lr.ph134.split.us.new_crit_edge ]
  %50 = phi double [ %.unr.ph260, %.lr.ph134.split.us.new.preheader.new ], [ %62, %.lr.ph134.split.us.new..lr.ph134.split.us.new_crit_edge ]
  ...
  %indvars.iv.next199.1261 = add nsw i64 %indvars.iv198, 3
  %60 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv.next199.1261, i64 %35
  ...
  br i1 %exitcond201.1.1, label %._crit_edge.us.loopexit.unr-lcssa, label %.lr.ph134.split.us.new..lr.ph134.split.us.new_crit_edge

.lr.ph134.split.us.new..lr.ph134.split.us.new_crit_edge: ; preds = %.lr.ph134.split.us.new
  br label %.lr.ph134.split.us.new

._crit_edge.us.loopexit.unr-lcssa:                ; preds = %.lr.ph134.split.us.new
  br label %._crit_edge.us.loopexit

._crit_edge.us.loopexit:                          ; preds = %.lr.ph134.split.us.new.prol.loopexit.._crit_edge.us.loopexit_crit_edge, %._crit_edge.us.loopexit.unr-lcssa
  %.lcssa256 = phi double [ %.lcssa256.unr.ph, %.lr.ph134.split.us.new.prol.loopexit.._crit_edge.us.loopexit_crit_edge ], [ %62, %._crit_edge.us.loopexit.unr-lcssa ]
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %.prol.loopexit203.._crit_edge.us_crit_edge
  %sunkaddr147.pre-phi = phi double* [ %.pre245, %.prol.loopexit203.._crit_edge.us_crit_edge ], [ %sunkaddr143, %._crit_edge.us.loopexit ]
  %.lcssa165 = phi double [ %.lcssa165.unr.ph, %.prol.loopexit203.._crit_edge.us_crit_edge ], [ %.lcssa256, %._crit_edge.us.loopexit ]
  %63 = fdiv double %.lcssa165, %2
  store double %63, double* %sunkaddr147.pre-phi, align 8
  %64 = add nsw i32 %storemerge132.us, 1
  %65 = icmp slt i32 %64, %0
  br i1 %65, label %._crit_edge.us..lr.ph134.split.us_crit_edge, label %.._crit_edge_crit_edge.loopexit

._crit_edge.us..lr.ph134.split.us_crit_edge:      ; preds = %._crit_edge.us
  br label %.lr.ph134.split.us

.._crit_edge_crit_edge.loopexit:                  ; preds = %._crit_edge.us
  br label %.._crit_edge_crit_edge

.._crit_edge_crit_edge.loopexit253:               ; preds = %.lr.ph134.split
  br label %.._crit_edge_crit_edge

.._crit_edge_crit_edge:                           ; preds = %middle.block..._crit_edge_crit_edge_crit_edge, %.._crit_edge_crit_edge.loopexit253, %.._crit_edge_crit_edge.loopexit
  br i1 true, label %.._crit_edge_crit_edge..lr.ph128_crit_edge, label %.._crit_edge_crit_edge.._crit_edge.._crit_edge9_crit_edge_crit_edge

.._crit_edge_crit_edge..lr.ph128_crit_edge:       ; preds = %.._crit_edge_crit_edge
  br label %.lr.ph128

.._crit_edge_crit_edge.._crit_edge.._crit_edge9_crit_edge_crit_edge: ; preds = %.._crit_edge_crit_edge
  br label %._crit_edge.._crit_edge9_crit_edge

.lr.ph128:                                        ; preds = %.._crit_edge_crit_edge..lr.ph128_crit_edge, %.lr.ph134.split.prol.loopexit..lr.ph128_crit_edge
...
.lr.ph128.split.preheader:                        ; preds = %.lr.ph128
  ...
  br i1 %lcmp.mod197, label %.lr.ph128.split.preheader..lr.ph128.split.prol.loopexit_crit_edge, label %.lr.ph128.split.prol

.lr.ph128.split.preheader..lr.ph128.split.prol.loopexit_crit_edge: ; preds = %.lr.ph128.split.preheader
...
.lr.ph128.split.prol.loopexit:                    ; preds = %.lr.ph128.split.preheader..lr.ph128.split.prol.loopexit_crit_edge, %.lr.ph128.split.prol
  %indvars.iv192.unr = phi i64 [ 0, %.lr.ph128.split.preheader..lr.ph128.split.prol.loopexit_crit_edge ], [ 1, %.lr.ph128.split.prol ]
  %71 = icmp eq i32 %0, 1
  br i1 %71, label %.lr.ph128.split.prol.loopexit.._crit_edge.._crit_edge9_crit_edge_crit_edge, label %.lr.ph128.split.preheader217

.lr.ph128.split.prol.loopexit.._crit_edge.._crit_edge9_crit_edge_crit_edge: ; preds = %.lr.ph128.split.prol.loopexit
  br label %._crit_edge.._crit_edge9_crit_edge
...
.lr.ph128.split.us:                               ; preds = %._crit_edge125.us..lr.ph128.split.us_crit_edge, %.lr.ph128.split.us.preheader
  %storemerge1127.us = phi i32 [ %98, %._crit_edge125.us..lr.ph128.split.us_crit_edge ], [ 0, %.lr.ph128.split.us.preheader ]
  ...
  br i1 %lcmp.mod190, label %.lr.ph128.split.us..prol.loopexit188_crit_edge, label %.prol.preheader187

.lr.ph128.split.us..prol.loopexit188_crit_edge:   ; preds = %.lr.ph128.split.us
...
.prol.loopexit188:                                ; preds = %.lr.ph128.split.us..prol.loopexit188_crit_edge, %.prol.preheader187
  %indvars.iv183.unr.ph = phi i64 [ 1, %.prol.preheader187 ], [ 0, %.lr.ph128.split.us..prol.loopexit188_crit_edge ]
  %.unr191.ph = phi double [ %80, %.prol.preheader187 ], [ 0.000000e+00, %.lr.ph128.split.us..prol.loopexit188_crit_edge ]
  %.lcssa164.unr.ph = phi double [ %80, %.prol.preheader187 ], [ undef, %.lr.ph128.split.us..prol.loopexit188_crit_edge ]
...
.prol.loopexit188.._crit_edge125.us_crit_edge:    ; preds = %.prol.loopexit188
  %.pre246 = shl nsw i64 %73, 3
  %.pre247 = add i64 %sunkaddr156, %.pre246
  %.pre248 = inttoptr i64 %.pre247 to double*
...
.lr.ph128.split.us.new:                           ; preds = %.lr.ph128.split.us.new..lr.ph128.split.us.new_crit_edge, %.lr.ph128.split.us.new.preheader
  %indvars.iv183 = phi i64 [ %indvars.iv.next184.1, %.lr.ph128.split.us.new..lr.ph128.split.us.new_crit_edge ], [ %indvars.iv183.unr.ph, %.lr.ph128.split.us.new.preheader ]
  %81 = phi double [ %93, %.lr.ph128.split.us.new..lr.ph128.split.us.new_crit_edge ], [ %.unr191.ph, %.lr.ph128.split.us.new.preheader ]
  ...
  br i1 %exitcond186.1, label %._crit_edge125.us.loopexit, label %.lr.ph128.split.us.new..lr.ph128.split.us.new_crit_edge

.lr.ph128.split.us.new..lr.ph128.split.us.new_crit_edge: ; preds = %.lr.ph128.split.us.new
  br label %.lr.ph128.split.us.new
...
._crit_edge125.us:                                ; preds = %._crit_edge125.us.loopexit, %.prol.loopexit188.._crit_edge125.us_crit_edge
  %sunkaddr159.pre-phi = phi double* [ %.pre248, %.prol.loopexit188.._crit_edge125.us_crit_edge ], [ %sunkaddr155, %._crit_edge125.us.loopexit ]
  ...
  br i1 %99, label %._crit_edge125.us..lr.ph128.split.us_crit_edge, label %._crit_edge.._crit_edge9_crit_edge.loopexit

._crit_edge125.us..lr.ph128.split.us_crit_edge:   ; preds = %._crit_edge125.us
  br label %.lr.ph128.split.us

.lr.ph134.split:                                  ; preds = %.lr.ph134.split..lr.ph134.split_crit_edge, %.lr.ph134.split.preheader252
  %indvars.iv207 = phi i64 [ %indvars.iv.next208.3, %.lr.ph134.split..lr.ph134.split_crit_edge ], [ %indvars.iv207.ph, %.lr.ph134.split.preheader252 ]
  ...
  br i1 %exitcond210.3, label %.._crit_edge_crit_edge.loopexit253, label %.lr.ph134.split..lr.ph134.split_crit_edge, !llvm.loop !6

.lr.ph134.split..lr.ph134.split_crit_edge:        ; preds = %.lr.ph134.split
  br label %.lr.ph134.split

._crit_edge.._crit_edge9_crit_edge.loopexit:      ; preds = %._crit_edge125.us
  br label %._crit_edge.._crit_edge9_crit_edge

._crit_edge.._crit_edge9_crit_edge.loopexit251:   ; preds = %.lr.ph128.split
  br label %._crit_edge.._crit_edge9_crit_edge

._crit_edge.._crit_edge9_crit_edge:               ; preds = %.lr.ph128.split.prol.loopexit.._crit_edge.._crit_edge9_crit_edge_crit_edge, %.._crit_edge.._crit_edge9_crit_edge_crit_edge, %._crit_edge.._crit_edge9_crit_edge.loopexit251, %._crit_edge.._crit_edge9_crit_edge.loopexit, %.._crit_edge_crit_edge.._crit_edge.._crit_edge9_crit_edge_crit_edge
  %104 = icmp sgt i32 %1, 0
  br i1 %104, label %._crit_edge9.._crit_edge11_crit_edge.lr.ph, label %._crit_edge.._crit_edge9_crit_edge.._crit_edge9.._crit_edge12_crit_edge_crit_edge

._crit_edge.._crit_edge9_crit_edge.._crit_edge9.._crit_edge12_crit_edge_crit_edge: ; preds = %._crit_edge.._crit_edge9_crit_edge
...
._crit_edge9.._crit_edge11_crit_edge.us:          ; preds = %._crit_edge11._crit_edge.us.._crit_edge9.._crit_edge11_crit_edge.us_crit_edge, %._crit_edge9.._crit_edge11_crit_edge.us.preheader
  %storemerge2121.us = phi i32 [ %118, %._crit_edge11._crit_edge.us.._crit_edge9.._crit_edge11_crit_edge.us_crit_edge ], [ 0, %._crit_edge9.._crit_edge11_crit_edge.us.preheader ]
  %106 = sext i32 %storemerge2121.us to i64
  br label %._crit_edge11.us

._crit_edge11.us:                                 ; preds = %._crit_edge11.us.._crit_edge11.us_crit_edge, %._crit_edge9.._crit_edge11_crit_edge.us
  %indvars.iv178 = phi i64 [ 0, %._crit_edge9.._crit_edge11_crit_edge.us ], [ %indvars.iv.next179, %._crit_edge11.us.._crit_edge11.us_crit_edge ]
  ...
  br i1 %exitcond181, label %._crit_edge11._crit_edge.us, label %._crit_edge11.us.._crit_edge11.us_crit_edge

._crit_edge11.us.._crit_edge11.us_crit_edge:      ; preds = %._crit_edge11.us
  br label %._crit_edge11.us

._crit_edge11._crit_edge.us:                      ; preds = %._crit_edge11.us
  %118 = add nsw i32 %storemerge2121.us, 1
  %119 = icmp slt i32 %118, %1
  br i1 %119, label %._crit_edge11._crit_edge.us.._crit_edge9.._crit_edge11_crit_edge.us_crit_edge, label %._crit_edge9.._crit_edge12_crit_edge.loopexit

._crit_edge11._crit_edge.us.._crit_edge9.._crit_edge11_crit_edge.us_crit_edge: ; preds = %._crit_edge11._crit_edge.us
  br label %._crit_edge9.._crit_edge11_crit_edge.us

.lr.ph128.split:                                  ; preds = %.lr.ph128.split..lr.ph128.split_crit_edge, %.lr.ph128.split.preheader217
  %indvars.iv192 = phi i64 [ %indvars.iv.next193.1, %.lr.ph128.split..lr.ph128.split_crit_edge ], [ %indvars.iv192.unr, %.lr.ph128.split.preheader217 ]
  ...
  br i1 %exitcond195.1, label %._crit_edge.._crit_edge9_crit_edge.loopexit251, label %.lr.ph128.split..lr.ph128.split_crit_edge

.lr.ph128.split..lr.ph128.split_crit_edge:        ; preds = %.lr.ph128.split
  br label %.lr.ph128.split

._crit_edge9.._crit_edge12_crit_edge.loopexit:    ; preds = %._crit_edge11._crit_edge.us
  br label %._crit_edge9.._crit_edge12_crit_edge

._crit_edge9.._crit_edge12_crit_edge:             ; preds = %._crit_edge.._crit_edge9_crit_edge.._crit_edge9.._crit_edge12_crit_edge_crit_edge, %._crit_edge9.._crit_edge12_crit_edge.loopexit
  %128 = add nsw i32 %0, -1
  %129 = icmp sgt i32 %0, 1
  br i1 %129, label %.lr.ph109, label %._crit_edge9.._crit_edge12_crit_edge.._crit_edge12._crit_edge_crit_edge

._crit_edge9.._crit_edge12_crit_edge.._crit_edge12._crit_edge_crit_edge: ; preds = %._crit_edge9.._crit_edge12_crit_edge
  br label %._crit_edge12._crit_edge
...
.lr.ph109.split.us:                               ; preds = %._crit_edge12.us..lr.ph109.split.us_crit_edge, %.lr.ph109.split.us.preheader
  %storemerge3108.us = phi i32 [ %storemerge4103.us, %._crit_edge12.us..lr.ph109.split.us_crit_edge ], [ 0, %.lr.ph109.split.us.preheader ]
  ...
  br i1 %136, label %.lr.ph.us.us.preheader, label %.lr.ph109.split.us.._crit_edge12.us_crit_edge

.lr.ph109.split.us.._crit_edge12.us_crit_edge:    ; preds = %.lr.ph109.split.us
...
._crit_edge12.us:                                 ; preds = %.lr.ph109.split.us.._crit_edge12.us_crit_edge, %._crit_edge12.us.loopexit
  %138 = icmp slt i32 %storemerge4103.us, %128
  br i1 %138, label %._crit_edge12.us..lr.ph109.split.us_crit_edge, label %._crit_edge12._crit_edge.loopexit

._crit_edge12.us..lr.ph109.split.us_crit_edge:    ; preds = %._crit_edge12.us
  br label %.lr.ph109.split.us

.lr.ph.us.us:                                     ; preds = %._crit_edge101.us.us..lr.ph.us.us_crit_edge, %.lr.ph.us.us.preheader
  %storemerge4104.us.us = phi i32 [ %storemerge4.us.us, %._crit_edge101.us.us..lr.ph.us.us_crit_edge ], [ %storemerge4103.us, %.lr.ph.us.us.preheader ]
...
.prol.loopexit:                                   ; preds = %.lr.ph.us.us..prol.loopexit_crit_edge, %.prol.preheader
  ...
  %.unr.ph = phi double [ %145, %.prol.preheader ], [ 0.000000e+00, %.lr.ph.us.us..prol.loopexit_crit_edge ]
  %.lcssa.unr.ph = phi double [ %145, %.prol.preheader ], [ undef, %.lr.ph.us.us..prol.loopexit_crit_edge ]
  br i1 %130, label %.prol.loopexit.._crit_edge101.us.us_crit_edge, label %.lr.ph.us.us.new.preheader

.prol.loopexit.._crit_edge101.us.us_crit_edge:    ; preds = %.prol.loopexit
...
._crit_edge101.us.us:                             ; preds = %.prol.loopexit.._crit_edge101.us.us_crit_edge, %._crit_edge101.us.us.loopexit
  %.lcssa = phi double [ %.lcssa.unr.ph, %.prol.loopexit.._crit_edge101.us.us_crit_edge ], [ %160, %._crit_edge101.us.us.loopexit ]
  ...
  br i1 %147, label %._crit_edge101.us.us..lr.ph.us.us_crit_edge, label %._crit_edge12.us.loopexit

._crit_edge101.us.us..lr.ph.us.us_crit_edge:      ; preds = %._crit_edge101.us.us
  br label %.lr.ph.us.us
...
.lr.ph.us.us.new:                                 ; preds = %.lr.ph.us.us.new..lr.ph.us.us.new_crit_edge, %.lr.ph.us.us.new.preheader
  ...
  %148 = phi double [ %160, %.lr.ph.us.us.new..lr.ph.us.us.new_crit_edge ], [ %.unr.ph, %.lr.ph.us.us.new.preheader ]
  ...
  br i1 %exitcond.1, label %._crit_edge101.us.us.loopexit, label %.lr.ph.us.us.new..lr.ph.us.us.new_crit_edge

.lr.ph.us.us.new..lr.ph.us.us.new_crit_edge:      ; preds = %.lr.ph.us.us.new
  br label %.lr.ph.us.us.new

.lr.ph109.split:                                  ; preds = %._crit_edge12..lr.ph109.split_crit_edge, %.lr.ph109.split.preheader
  %indvar = phi i64 [ 0, %.lr.ph109.split.preheader ], [ %indvar.next, %._crit_edge12..lr.ph109.split_crit_edge ]
  %indvars.iv166 = phi i64 [ 1, %.lr.ph109.split.preheader ], [ %indvars.iv.next167, %._crit_edge12..lr.ph109.split_crit_edge ]
  %storemerge3108 = phi i32 [ 0, %.lr.ph109.split.preheader ], [ %storemerge4103, %._crit_edge12..lr.ph109.split_crit_edge ]
  ...
  br i1 %165, label %.lr.ph106.split.preheader, label %.lr.ph109.split.._crit_edge12_crit_edge

.lr.ph109.split.._crit_edge12_crit_edge:          ; preds = %.lr.ph109.split
...
.lr.ph106.split.preheader:                        ; preds = %.lr.ph109.split
  ...
  br i1 %lcmp.mod174, label %.lr.ph106.split.preheader..lr.ph106.split.prol.loopexit_crit_edge, label %.lr.ph106.split.prol.preheader

.lr.ph106.split.preheader..lr.ph106.split.prol.loopexit_crit_edge: ; preds = %.lr.ph106.split.preheader
...
.lr.ph106.split.prol:                             ; preds = %.lr.ph106.split.prol..lr.ph106.split.prol_crit_edge, %.lr.ph106.split.prol.preheader
  %indvars.iv168.prol = phi i64 [ %indvars.iv.next169.prol, %.lr.ph106.split.prol..lr.ph106.split.prol_crit_edge ], [ %indvars.iv166, %.lr.ph106.split.prol.preheader ]
  %prol.iter = phi i32 [ %prol.iter.sub, %.lr.ph106.split.prol..lr.ph106.split.prol_crit_edge ], [ %xtraiter173, %.lr.ph106.split.prol.preheader ]
  ...
  br i1 %prol.iter.cmp, label %.lr.ph106.split.prol.loopexit.loopexit, label %.lr.ph106.split.prol..lr.ph106.split.prol_crit_edge, !llvm.loop !8

.lr.ph106.split.prol..lr.ph106.split.prol_crit_edge: ; preds = %.lr.ph106.split.prol
  br label %.lr.ph106.split.prol

.lr.ph106.split.prol.loopexit.loopexit:           ; preds = %.lr.ph106.split.prol
  br label %.lr.ph106.split.prol.loopexit

.lr.ph106.split.prol.loopexit:                    ; preds = %.lr.ph106.split.preheader..lr.ph106.split.prol.loopexit_crit_edge, %.lr.ph106.split.prol.loopexit.loopexit
  %indvars.iv168.unr = phi i64 [ %indvars.iv166, %.lr.ph106.split.preheader..lr.ph106.split.prol.loopexit_crit_edge ], [ %indvars.iv.next169.prol, %.lr.ph106.split.prol.loopexit.loopexit ]
  %171 = icmp ult i32 %162, 3
  br i1 %171, label %.lr.ph106.split.prol.loopexit.._crit_edge12_crit_edge, label %.lr.ph106.split.preheader249

.lr.ph106.split.prol.loopexit.._crit_edge12_crit_edge: ; preds = %.lr.ph106.split.prol.loopexit
  br label %._crit_edge12

.lr.ph106.split.preheader249:                     ; preds = %.lr.ph106.split.prol.loopexit
  br label %.lr.ph106.split

.lr.ph106.split:                                  ; preds = %.lr.ph106.split..lr.ph106.split_crit_edge, %.lr.ph106.split.preheader249
  %indvars.iv168 = phi i64 [ %indvars.iv.next169.3, %.lr.ph106.split..lr.ph106.split_crit_edge ], [ %indvars.iv168.unr, %.lr.ph106.split.preheader249 ]
  ...
  br i1 %exitcond.3, label %._crit_edge12.loopexit, label %.lr.ph106.split..lr.ph106.split_crit_edge

.lr.ph106.split..lr.ph106.split_crit_edge:        ; preds = %.lr.ph106.split
  br label %.lr.ph106.split

._crit_edge12.loopexit:                           ; preds = %.lr.ph106.split
  br label %._crit_edge12

._crit_edge12:                                    ; preds = %.lr.ph106.split.prol.loopexit.._crit_edge12_crit_edge, %.lr.ph109.split.._crit_edge12_crit_edge, %._crit_edge12.loopexit
  %indvars.iv.next167 = add nuw nsw i64 %indvars.iv166, 1
  %indvar.next = add nuw nsw i64 %indvar, 1
  %exitcond = icmp eq i64 %indvar.next, %131
  br i1 %exitcond, label %._crit_edge12._crit_edge.loopexit250, label %._crit_edge12..lr.ph109.split_crit_edge

._crit_edge12..lr.ph109.split_crit_edge:          ; preds = %._crit_edge12
  br label %.lr.ph109.split

._crit_edge12._crit_edge.loopexit:                ; preds = %._crit_edge12.us
  br label %._crit_edge12._crit_edge

._crit_edge12._crit_edge.loopexit250:             ; preds = %._crit_edge12
  br label %._crit_edge12._crit_edge

._crit_edge12._crit_edge:                         ; preds = %._crit_edge9.._crit_edge12_crit_edge.._crit_edge12._crit_edge_crit_edge, %._crit_edge12._crit_edge.loopexit250, %._crit_edge12._crit_edge.loopexit, %._crit_edge9.._crit_edge12_crit_edge.thread
  %184 = phi i32 [ %105, %._crit_edge9.._crit_edge12_crit_edge.thread ], [ %128, %._crit_edge9.._crit_edge12_crit_edge.._crit_edge12._crit_edge_crit_edge ], [ %128, %._crit_edge12._crit_edge.loopexit ], [ %128, %._crit_edge12._crit_edge.loopexit250 ]
...
define internal fastcc void @print_array(i32, [1200 x double]* nocapture readonly) unnamed_addr #0 {
  ...
  %7 = icmp sgt i32 %0, 0
  br i1 %7, label %.._crit_edge2_crit_edge.us.preheader, label %.._crit_edge12_crit_edge

.._crit_edge12_crit_edge:                         ; preds = %2
  br label %._crit_edge12

.._crit_edge2_crit_edge.us.preheader:             ; preds = %2
  %wide.trip.count = zext i32 %0 to i64
  br label %.._crit_edge2_crit_edge.us

.._crit_edge2_crit_edge.us:                       ; preds = %._crit_edge2._crit_edge.us..._crit_edge2_crit_edge.us_crit_edge, %.._crit_edge2_crit_edge.us.preheader
  %storemerge11.us = phi i32 [ %22, %._crit_edge2._crit_edge.us..._crit_edge2_crit_edge.us_crit_edge ], [ 0, %.._crit_edge2_crit_edge.us.preheader ]
  %8 = mul nsw i32 %storemerge11.us, %0
  %9 = sext i32 %storemerge11.us to i64
  %10 = zext i32 %8 to i64
  br label %11

; <label>:11:                                     ; preds = %._crit_edge.us._crit_edge, %.._crit_edge2_crit_edge.us
  %indvars.iv = phi i64 [ 0, %.._crit_edge2_crit_edge.us ], [ %indvars.iv.next, %._crit_edge.us._crit_edge ]
...
._crit_edge.us:                                   ; preds = %.._crit_edge.us_crit_edge, %16
  ...
  br i1 %exitcond, label %._crit_edge2._crit_edge.us, label %._crit_edge.us._crit_edge
...
._crit_edge2._crit_edge.us:                       ; preds = %._crit_edge.us
  ...
  br i1 %23, label %._crit_edge2._crit_edge.us..._crit_edge2_crit_edge.us_crit_edge, label %._crit_edge12.loopexit

._crit_edge2._crit_edge.us..._crit_edge2_crit_edge.us_crit_edge: ; preds = %._crit_edge2._crit_edge.us
  br label %.._crit_edge2_crit_edge.us

._crit_edge12.loopexit:                           ; preds = %._crit_edge2._crit_edge.us
  br label %._crit_edge12
