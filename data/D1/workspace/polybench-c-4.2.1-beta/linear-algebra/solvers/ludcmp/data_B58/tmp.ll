...
._crit_edge85:                                    ; preds = %._crit_edge39.us.._crit_edge44_crit_edge, %.lr.ph43.split.._crit_edge44_crit_edge
  %65 = phi i32 [ %.pr150.pre, %._crit_edge39.us.._crit_edge44_crit_edge ], [ %0, %.lr.ph43.split.._crit_edge44_crit_edge ]
...
.lr.ph53.split:                                   ; preds = %.lr.ph53.split, %.lr.ph53.split.preheader.new
  %indvars.iv122 = phi i64 [ %indvars.iv122.unr, %.lr.ph53.split.preheader.new ], [ %indvars.iv.next123.3, %.lr.ph53.split ]
  %indvars.iv.next123.2 = add i64 %indvars.iv122, 3
  %exitcond125.3 = icmp eq i64 %indvars.iv.next123.2, %wide.trip.count124
  %indvars.iv.next123.3 = add i64 %indvars.iv122, 4
  br i1 %exitcond125.3, label %._crit_edge54.loopexit144.unr-lcssa, label %.lr.ph53.split
