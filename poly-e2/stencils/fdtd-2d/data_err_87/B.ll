...
entry:
  ...
  tail call fastcc void @init_array([1200 x double]* %0, [1200 x double]* %1, [1200 x double]* %2, double* %arraydecay6)
  tail call void (...) @polybench_timer_start() #4
  tail call fastcc void @kernel_fdtd_2d([1200 x double]* %0, [1200 x double]* %1, [1200 x double]* %2, double* %arraydecay6)
...
for.cond5.preheader.us:                           ; preds = %for.cond5.preheader.us.preheader, %for.inc39.loopexit.us
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc39.loopexit.us ], [ 0, %for.cond5.preheader.us.preheader ]
...
for.inc36.us:                                     ; preds = %for.inc36.us, %for.cond5.preheader.us
  ...
  br i1 %cmp6.us, label %for.inc36.us, label %for.inc39.loopexit.us

for.inc39.loopexit.us:                            ; preds = %for.inc36.us
  %indvars.iv.next20 = add nsw i64 %indvars.iv19, 1
  %cmp2.us = icmp slt i64 %indvars.iv.next20, 1000
  br i1 %cmp2.us, label %for.cond5.preheader.us, label %for.end41

for.inc:                                          ; preds = %for.inc, %entry
  %inc14 = phi i32 [ 0, %entry ], [ %inc.4, %for.inc ]
  %conv = sitofp i32 %inc14 to double
...
for.end41:                                        ; preds = %for.inc39.loopexit.us
  ret void
}
...
for.cond10.preheader.us:                          ; preds = %for.cond10.preheader.us.preheader, %for.inc34.loopexit.us
  %indvar = phi i64 [ %0, %for.inc34.loopexit.us ], [ 0, %for.cond10.preheader.us.preheader ]
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.inc34.loopexit.us ], [ 1, %for.cond10.preheader.us.preheader ]
  %0 = add i64 %indvar, 1
...
vector.body58:                                    ; preds = %vector.body58.preheader, %vector.body58
  ...
  br i1 %20, label %for.inc34.loopexit.us.loopexit112, label %vector.body58, !llvm.loop !6
...
for.inc31.us:                                     ; preds = %for.inc31.us, %for.inc31.us.preheader
  ...
  br i1 %cmp11.us.1, label %for.inc31.us, label %for.inc34.loopexit.us.loopexit, !llvm.loop !9

for.inc34.loopexit.us.loopexit:                   ; preds = %for.inc31.us
  br label %for.inc34.loopexit.us

for.inc34.loopexit.us.loopexit112:                ; preds = %vector.body58
  br label %for.inc34.loopexit.us

for.inc34.loopexit.us:                            ; preds = %for.inc34.loopexit.us.loopexit112, %for.inc34.loopexit.us.loopexit
...
for.cond40.preheader.us.preheader:                ; preds = %for.inc34.loopexit.us
...
for.cond40.preheader.us:                          ; preds = %for.cond40.preheader.us.preheader, %for.inc66.loopexit.us
  %indvars.iv63 = phi i64 [ %37, %for.inc66.loopexit.us ], [ 0, %for.cond40.preheader.us.preheader ]
  %scevgep30 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv63, i64 1
  %37 = add i64 %indvars.iv63, 1
...
for.inc63.us:                                     ; preds = %for.inc63.us, %for.inc63.us.preheader.new
  ...
  br i1 %exitcond62.1, label %for.inc66.loopexit.us, label %for.inc63.us, !llvm.loop !16

for.inc66.loopexit.us:                            ; preds = %for.inc63.us
  %cmp38.us = icmp slt i64 %37, 1000
  br i1 %cmp38.us, label %for.cond40.preheader.us, label %for.cond73.preheader.us.preheader

for.cond73.preheader.us.preheader:                ; preds = %for.inc66.loopexit.us
  br label %for.cond73.preheader.us

for.cond73.preheader.us:                          ; preds = %for.cond73.preheader.us.preheader, %for.inc110.loopexit.us
  %indvars.iv67 = phi i64 [ %69, %for.inc110.loopexit.us ], [ 0, %for.cond73.preheader.us.preheader ]
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %70 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv67, i64 %index
  ...
  %74 = or i64 %index, 1
  %75 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv67, i64 %74
  ...
  %79 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv67, i64 %index
  ...
  %91 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv67, i64 %index
...
for.inc107.us:                                    ; preds = %for.inc107.us.preheader, %for.inc107.us
  ...
  %arrayidx94.us = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %69, i64 %indvars.iv65
  ...
  br i1 %cmp75.us, label %for.inc107.us, label %for.inc110.loopexit.us, !llvm.loop !26

for.inc110.loopexit.us:                           ; preds = %for.inc107.us
  %cmp71.us = icmp slt i64 %69, 999
  br i1 %cmp71.us, label %for.cond73.preheader.us, label %for.inc113

for.inc113:                                       ; preds = %for.inc110.loopexit.us
...
for.cond2.preheader.us:                           ; preds = %for.inc10.loopexit.us, %entry
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc10.loopexit.us ], [ 0, %entry ]
...
for.inc.us:                                       ; preds = %for.body4.us, %if.then.us
  ...
  br i1 %exitcond65, label %for.inc10.loopexit.us, label %for.body4.us
...
for.cond19.preheader.us:                          ; preds = %for.inc37.loopexit.us, %for.end12.loopexit
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc37.loopexit.us ], [ 0, %for.end12.loopexit ]
...
for.inc34.us:                                     ; preds = %for.body21.us, %if.then26.us
  ...
  br i1 %exitcond55, label %for.inc37.loopexit.us, label %for.body21.us

for.inc37.loopexit.us:                            ; preds = %for.inc34.us
  %indvars.iv.next57 = add nsw i64 %indvars.iv56, 1
  %cmp17.us = icmp slt i64 %indvars.iv.next57, 1000
  br i1 %cmp17.us, label %for.cond19.preheader.us, label %for.end39

for.end39:                                        ; preds = %for.inc37.loopexit.us
...
for.cond45.preheader.us:                          ; preds = %for.inc63.loopexit.us, %for.end39
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc63.loopexit.us ], [ 0, %for.end39 ]
...
for.inc60.us:                                     ; preds = %for.body47.us, %if.then52.us
  ...
  br i1 %exitcond, label %for.inc63.loopexit.us, label %for.body47.us

for.inc63.loopexit.us:                            ; preds = %for.inc60.us
  %indvars.iv.next49 = add nsw i64 %indvars.iv48, 1
  %cmp43.us = icmp slt i64 %indvars.iv.next49, 1000
  br i1 %cmp43.us, label %for.cond45.preheader.us, label %for.end65

for.end65:                                        ; preds = %for.inc63.loopexit.us
