...
for.body.us:                                      ; preds = %for.cond2.for.inc24_crit_edge.us, %entry
  %indvars.iv7 = phi i64 [ 0, %entry ], [ %indvars.iv.next8, %for.cond2.for.inc24_crit_edge.us ]
...
for.cond5.for.end_crit_edge.us:                   ; preds = %for.body7.us
  %sunkaddr17 = shl i64 %indvars.iv4, 3
  ...
  %arrayidx34.us = getelementptr inbounds double, double* %y, i64 %indvars.iv4
