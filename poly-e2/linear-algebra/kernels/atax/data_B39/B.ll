...
for.cond7.preheader.us:                           ; preds = %for.cond7.preheader.us.preheader, %for.cond7.for.inc22_crit_edge.us
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.cond7.for.inc22_crit_edge.us ], [ 0, %for.cond7.preheader.us.preheader ]
...
for.body10.us:                                    ; preds = %for.body10.us, %for.cond7.preheader.us
  ...
  %2 = add nsw i64 %indvars.iv.next, %indvars.iv14
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %8 = trunc i64 %indvars.iv.next17.1 to i32
