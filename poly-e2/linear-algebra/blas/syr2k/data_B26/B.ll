...
for.cond24.preheader.lr.ph:                       ; preds = %for.cond24.preheader.lr.ph.loopexit, %for.cond1.preheader.lr.ph
...
for.inc43:                                        ; preds = %for.inc43.loopexit, %middle.block, %for.inc.prol.loopexit
  %exitcond71 = icmp eq i64 %indvars.iv.next69, %wide.trip.count56
