...
@__llvm_prf_nm = private constant [28 x i8] c"\16\1Ax\DAK\CCI,\8F\CF\CC+(-aL\041\F3KK\80l\00d\9C\08\EB", section "__llvm_prf_names"
@llvm.used = appending global [3 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_alaw_input to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_alaw_output to i8*), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
