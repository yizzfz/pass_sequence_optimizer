...
for.inc:                                          ; preds = %for.inc, %entry
  %indvars.iv2 = phi i64 [ 0, %entry ], [ %indvars.iv.next.4, %for.inc ]
...
for.body:                                         ; preds = %for.inc47, %entry
  %indvars.iv = phi i64 [ %indvars.iv.next38, %for.inc47 ], [ 1, %entry ]
  %indvar = phi i64 [ %indvar.next, %for.inc47 ], [ 0, %entry ]
  %alpha.027 = phi double [ %div, %for.inc47 ], [ %sub3, %entry ]
  %beta.026 = phi double [ %mul5, %for.inc47 ], [ 1.000000e+00, %entry ]
  %indvars.iv1925 = phi i64 [ %indvars.iv.next20, %for.inc47 ], [ 1, %entry ]
  %6 = add i64 %indvar, -1
  ...
  %11 = add nsw i64 %indvars.iv1925, -1
...
for.inc.prol:                                     ; preds = %for.inc.prol.preheader, %for.inc.prol
  ...
  %12 = sub nsw i64 %11, %indvars.iv21.prol
...
for.inc.prol.loopexit:                            ; preds = %for.inc.prol.loopexit.loopexit, %for.body
  ...
  %indvars.iv21.unr = phi i64 [ 0, %for.body ], [ %7, %for.inc.prol.loopexit.loopexit ]
...
for.end:                                          ; preds = %for.end.loopexit, %for.inc.prol.loopexit
  ...
  %27 = and i64 %indvar, 1
  %lcmp.mod32 = icmp eq i64 %27, 0
  br i1 %lcmp.mod32, label %for.inc32.prol, label %for.inc32.prol.loopexit

for.inc32.prol:                                   ; preds = %for.end
  ...
  %29 = load double, double* %sunkaddr36, align 8
...
for.inc32.prol.loopexit:                          ; preds = %for.inc32.prol, %for.end
  %indvars.iv523.unr.ph = phi i64 [ 1, %for.inc32.prol ], [ 0, %for.end ]
...
for.inc32.preheader:                              ; preds = %for.inc32.prol.loopexit
  %31 = sub i64 %6, %indvars.iv523.unr.ph
  %32 = lshr i64 %31, 1
  %33 = add nuw i64 %32, 1
...
min.iters.checked:                                ; preds = %for.inc32.preheader
  ...
  %34 = or i64 %indvars.iv523.unr.ph, 2
  %35 = shl nuw i64 %32, 1
  %36 = add i64 %34, %35
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %38 = shl i64 %index, 1
  %offset.idx = or i64 %indvars.iv523.unr.ph, %38
  ...
  %wide.vec40 = load <4 x double>, <4 x double>* %44, align 8
  ...
  %45 = fmul <2 x double> %broadcast.splat45, %reverse43
  %46 = fadd <2 x double> %strided.vec, %45
  %47 = add nuw nsw i64 %offset.idx, 1
  %48 = fmul <2 x double> %broadcast.splat45, %reverse
  %49 = fadd <2 x double> %strided.vec39, %48
...
for.inc32.preheader1:                             ; preds = %middle.block, %min.iters.checked, %for.inc32.preheader
  %indvars.iv523.ph = phi i64 [ %indvars.iv523.unr.ph, %min.iters.checked ], [ %indvars.iv523.unr.ph, %for.inc32.preheader ], [ %ind.end, %middle.block ]
...
for.inc32:                                        ; preds = %for.inc32.preheader1, %for.inc32
  %indvars.iv523 = phi i64 [ %indvars.iv.next6.1, %for.inc32 ], [ %indvars.iv523.ph, %for.inc32.preheader1 ]
  ...
  %57 = sub nsw i64 %11, %indvars.iv.next6
  ...
  %indvars.iv.next6.1 = add nuw nsw i64 %indvars.iv523, 2
  %exitcond12.1 = icmp eq i64 %indvars.iv1925, %indvars.iv.next6.1
  br i1 %exitcond12.1, label %for.inc47.loopexit, label %for.inc32, !llvm.loop !6
