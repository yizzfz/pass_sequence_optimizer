...
.prol.loopexit27:                                 ; preds = %.prol.preheader26, %.preheader12
  %indvars.iv519.unr.ph = phi i64 [ 1, %.prol.preheader26 ], [ 0, %.preheader12 ]
  br i1 false, label %._crit_edge21, label %.preheader12.new.preheader

.preheader12.new.preheader:                       ; preds = %.prol.loopexit27
  %.pre = load double, double* %7, align 8
  br label %.preheader12.new

.preheader12.new:                                 ; preds = %.preheader12.new.preheader, %.preheader12.new
  %14 = phi double [ %26, %.preheader12.new ], [ %.pre, %.preheader12.new.preheader ]
  %indvars.iv519 = phi i64 [ %indvars.iv.next6.1, %.preheader12.new ], [ %indvars.iv519.unr.ph, %.preheader12.new.preheader ]
  %15 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv922, i64 %indvars.iv519
  %16 = load double, double* %15, align 8
  %17 = getelementptr inbounds double, double* %3, i64 %indvars.iv519
  %18 = load double, double* %17, align 8
  %19 = fmul double %16, %18
  %20 = fadd double %14, %19
  store double %20, double* %7, align 8
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv519, 1
  %21 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv922, i64 %indvars.iv.next6
  %22 = load double, double* %21, align 8
  %23 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next6
  ...
  br i1 %exitcond8.1, label %._crit_edge21.loopexit, label %.preheader12.new

._crit_edge21.loopexit:                           ; preds = %.preheader12.new
  br label %._crit_edge21

._crit_edge21:                                    ; preds = %._crit_edge21.loopexit, %.prol.loopexit27
...
.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge
  ...
  %27 = getelementptr inbounds double, double* %2, i64 %indvars.iv315
  br i1 true, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.preheader
  %28 = load double, double* %27, align 8
  %29 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 0, i64 %indvars.iv315
...
.preheader.new:                                   ; preds = %.preheader.new.preheader, %.preheader.new
  %34 = phi double [ %46, %.preheader.new ], [ %.pre31, %.preheader.new.preheader ]
  %indvars.iv14 = phi i64 [ %indvars.iv.next.1, %.preheader.new ], [ %indvars.iv14.unr.ph, %.preheader.new.preheader ]
  %35 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv14, i64 %indvars.iv315
  %36 = load double, double* %35, align 8
  %37 = getelementptr inbounds double, double* %4, i64 %indvars.iv14
  %38 = load double, double* %37, align 8
  %39 = fmul double %36, %38
  %40 = fadd double %34, %39
  store double %40, double* %27, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv14, 1
  %41 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv.next, i64 %indvars.iv315
