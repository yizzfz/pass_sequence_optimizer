...
; <label>:11:                                     ; preds = %11, %8
  ...
  %sunkaddr21 = mul i64 %indvars.iv3, 8
  %sunkaddr22 = add i64 %sunkaddr, %sunkaddr21
  %sunkaddr23 = inttoptr i64 %sunkaddr22 to double*
  %17 = load double, double* %sunkaddr23, align 8
  %18 = fadd double %16, %17
  %sunkaddr24 = ptrtoint double* %4 to i64
  %sunkaddr25 = mul i64 %indvars.iv3, 8
  ...
  %sunkaddr28 = ptrtoint double* %6 to i64
  %sunkaddr29 = mul i64 %indvars.iv3, 8
  %sunkaddr30 = add i64 %sunkaddr28, %sunkaddr29
  %sunkaddr31 = inttoptr i64 %sunkaddr30 to double*
  %24 = load double, double* %sunkaddr31, align 8
  %25 = fadd double %23, %24
  %sunkaddr32 = ptrtoint double* %6 to i64
  %sunkaddr33 = mul i64 %indvars.iv3, 8
  %sunkaddr34 = add i64 %sunkaddr32, %sunkaddr33
  %sunkaddr35 = inttoptr i64 %sunkaddr34 to double*
  store double %25, double* %sunkaddr35, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
