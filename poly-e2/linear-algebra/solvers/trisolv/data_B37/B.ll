...
for.body.preheader:                               ; preds = %entry
  ...
  %sunkaddr16 = ptrtoint double* %x to i64
  br label %for.body
...
for.body5.prol:                                   ; preds = %for.body5.preheader
  ...
  %sunkaddr9 = mul nuw nsw i64 %indvars.iv7, 8
...
for.body5.prol.loopexit:                          ; preds = %for.body5.prol, %for.body5.preheader
  ...
  %10 = icmp eq i64 %2, 0
  br i1 %10, label %for.end, label %for.body5.preheader.new

for.body5.preheader.new:                          ; preds = %for.body5.prol.loopexit
  %sunkaddr13 = mul nuw nsw i64 %indvars.iv7, 8
...
for.body5:                                        ; preds = %for.body5, %for.body5.preheader.new
  ...
  store double %sub, double* %sunkaddr15, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  ...
  store double %sub.1, double* %sunkaddr15, align 8
...
for.end:                                          ; preds = %for.end.loopexit, %for.body5.prol.loopexit, %for.body
  %.lcssa = phi double [ %6, %for.body ], [ %sub.lcssa.unr.ph, %for.body5.prol.loopexit ], [ %sub.1, %for.end.loopexit ]
