...
for.body.us:                                      ; preds = %for.cond35.for.end_crit_edge.us.for.body.us_crit_edge, %entry
  %indvars.iv11 = phi i64 [ 0, %entry ], [ %indvars.iv.next12, %for.cond35.for.end_crit_edge.us.for.body.us_crit_edge ]
...
for.body38.us:                                    ; preds = %for.body38.us.for.body38.us_crit_edge, %for.body.us
  ...
  %2 = mul nuw nsw i64 %indvars.iv, %indvars.iv11
  ...
  %4 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv11
...
for.cond35.for.end_crit_edge.us:                  ; preds = %for.body38.us
  ...
  br i1 %exitcond, label %for.end48, label %for.cond35.for.end_crit_edge.us.for.body.us_crit_edge

for.cond35.for.end_crit_edge.us.for.body.us_crit_edge: ; preds = %for.cond35.for.end_crit_edge.us
  br label %for.body.us
...
entry:
  %sunkaddr89 = ptrtoint double* %u1 to i64
  %sunkaddr93 = ptrtoint double* %u2 to i64
  %scevgep5 = getelementptr double, double* %v1, i64 2000
  %scevgep8 = getelementptr double, double* %v2, i64 2000
  br label %for.body.us

for.body.us:                                      ; preds = %for.cond1.for.end_crit_edge.us.for.body.us_crit_edge, %entry
  %indvars.iv59 = phi i64 [ 0, %entry ], [ %0, %for.cond1.for.end_crit_edge.us.for.body.us_crit_edge ]
  ...
  %bc = inttoptr i64 %sunkaddr91 to i8*
  ...
  %bc14 = inttoptr i64 %sunkaddr95 to i8*
  ...
  br i1 %conflict.rdx23, label %for.body.us.for.body3.us_crit_edge, label %vector.ph

for.body.us.for.body3.us_crit_edge:               ; preds = %for.body.us
  br label %for.body3.us

vector.ph:                                        ; preds = %for.body.us
  %.pre67 = load double, double* %sunkaddr92, align 8, !alias.scope !1
  %.pre68 = load double, double* %sunkaddr96, align 8, !alias.scope !4
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.ph
  ...
  br i1 %23, label %vector.body.for.cond1.for.end_crit_edge.us_crit_edge, label %vector.body.vector.body_crit_edge, !llvm.loop !13

vector.body.vector.body_crit_edge:                ; preds = %vector.body
  br label %vector.body

vector.body.for.cond1.for.end_crit_edge.us_crit_edge: ; preds = %vector.body
  br label %for.cond1.for.end_crit_edge.us

for.body3.us:                                     ; preds = %for.body3.us.for.body3.us_crit_edge, %for.body.us.for.body3.us_crit_edge
  %indvars.iv55 = phi i64 [ %indvars.iv.next56.1, %for.body3.us.for.body3.us_crit_edge ], [ 0, %for.body.us.for.body3.us_crit_edge ]
  ...
  %25 = load double, double* %sunkaddr92, align 8
  ...
  %27 = load double, double* %sunkaddr96, align 8
  ...
  %32 = load double, double* %sunkaddr96, align 8
  ...
  br i1 %exitcond58.1, label %for.body3.us.for.cond1.for.end_crit_edge.us_crit_edge, label %for.body3.us.for.body3.us_crit_edge, !llvm.loop !16

for.body3.us.for.body3.us_crit_edge:              ; preds = %for.body3.us
  br label %for.body3.us

for.body3.us.for.cond1.for.end_crit_edge.us_crit_edge: ; preds = %for.body3.us
  br label %for.cond1.for.end_crit_edge.us

for.cond1.for.end_crit_edge.us:                   ; preds = %for.body3.us.for.cond1.for.end_crit_edge.us_crit_edge, %vector.body.for.cond1.for.end_crit_edge.us_crit_edge
  %exitcond78 = icmp eq i64 %0, 2000
  br i1 %exitcond78, label %for.body25.us.preheader, label %for.cond1.for.end_crit_edge.us.for.body.us_crit_edge
...
for.body25.us.preheader:                          ; preds = %for.cond1.for.end_crit_edge.us
  %sunkaddr101 = ptrtoint double* %x to i64
  br label %for.body25.us

for.body25.us:                                    ; preds = %for.cond26.for.end44_crit_edge.us.for.body25.us_crit_edge, %for.body25.us.preheader
  %indvars.iv50 = phi i64 [ 0, %for.body25.us.preheader ], [ %indvars.iv.next51, %for.cond26.for.end44_crit_edge.us.for.body25.us_crit_edge ]
  %arrayidx30.us = getelementptr inbounds double, double* %x, i64 %indvars.iv50
  %.pre = load double, double* %arrayidx30.us, align 8
  %sunkaddr102 = shl i64 %indvars.iv50, 3
  %sunkaddr103 = add i64 %sunkaddr101, %sunkaddr102
  %sunkaddr104 = inttoptr i64 %sunkaddr103 to double*
  br label %for.body28.us

for.body28.us:                                    ; preds = %for.body28.us.for.body28.us_crit_edge, %for.body25.us
  %indvars.iv46 = phi i64 [ 0, %for.body25.us ], [ %indvars.iv.next47.1, %for.body28.us.for.body28.us_crit_edge ]
  %34 = phi double [ %.pre, %for.body25.us ], [ %add39.us.1, %for.body28.us.for.body28.us_crit_edge ]
  ...
  store double %add39.us, double* %sunkaddr104, align 8
  ...
  store double %add39.us.1, double* %sunkaddr104, align 8
  %indvars.iv.next47.1 = add nuw nsw i64 %indvars.iv46, 2
  %exitcond49.1 = icmp eq i64 %indvars.iv.next47.1, 2000
  br i1 %exitcond49.1, label %for.cond26.for.end44_crit_edge.us, label %for.body28.us.for.body28.us_crit_edge
...
for.cond26.for.end44_crit_edge.us:                ; preds = %for.body28.us
  ...
  br i1 %exitcond72, label %vector.memcheck46, label %for.cond26.for.end44_crit_edge.us.for.body25.us_crit_edge

for.cond26.for.end44_crit_edge.us.for.body25.us_crit_edge: ; preds = %for.cond26.for.end44_crit_edge.us
  br label %for.body25.us
...
vector.memcheck46:                                ; preds = %for.cond26.for.end44_crit_edge.us
  ...
  br i1 %found.conflict44, label %vector.memcheck46.for.body50_crit_edge, label %vector.memcheck46.vector.body31_crit_edge

vector.memcheck46.vector.body31_crit_edge:        ; preds = %vector.memcheck46
  br label %vector.body31

vector.memcheck46.for.body50_crit_edge:           ; preds = %vector.memcheck46
  br label %for.body50

vector.body31:                                    ; preds = %vector.body31.vector.body31_crit_edge, %vector.memcheck46.vector.body31_crit_edge
  %index48 = phi i64 [ %index.next49, %vector.body31.vector.body31_crit_edge ], [ 0, %vector.memcheck46.vector.body31_crit_edge ]
  ...
  br i1 %54, label %vector.body31.for.body63.us.preheader_crit_edge, label %vector.body31.vector.body31_crit_edge, !llvm.loop !22

vector.body31.vector.body31_crit_edge:            ; preds = %vector.body31
  br label %vector.body31

vector.body31.for.body63.us.preheader_crit_edge:  ; preds = %vector.body31
  br label %for.body63.us.preheader

for.body50:                                       ; preds = %for.body50.for.body50_crit_edge, %vector.memcheck46.for.body50_crit_edge
  %indvars.iv42 = phi i64 [ %indvars.iv.next43.3, %for.body50.for.body50_crit_edge ], [ 0, %vector.memcheck46.for.body50_crit_edge ]
  ...
  br i1 %exitcond45.3, label %for.body50.for.body63.us.preheader_crit_edge, label %for.body50.for.body50_crit_edge, !llvm.loop !23

for.body50.for.body50_crit_edge:                  ; preds = %for.body50
  br label %for.body50

for.body50.for.body63.us.preheader_crit_edge:     ; preds = %for.body50
  br label %for.body63.us.preheader

for.body63.us.preheader:                          ; preds = %for.body50.for.body63.us.preheader_crit_edge, %vector.body31.for.body63.us.preheader_crit_edge
  %sunkaddr109 = ptrtoint double* %w to i64
  br label %for.body63.us

for.body63.us:                                    ; preds = %for.cond64.for.end82_crit_edge.us.for.body63.us_crit_edge, %for.body63.us.preheader
  %indvars.iv37 = phi i64 [ 0, %for.body63.us.preheader ], [ %indvars.iv.next38, %for.cond64.for.end82_crit_edge.us.for.body63.us_crit_edge ]
  %arrayidx68.us = getelementptr inbounds double, double* %w, i64 %indvars.iv37
  %.pre36 = load double, double* %arrayidx68.us, align 8
  %sunkaddr110 = shl i64 %indvars.iv37, 3
  %sunkaddr111 = add i64 %sunkaddr109, %sunkaddr110
  %sunkaddr112 = inttoptr i64 %sunkaddr111 to double*
  br label %for.body66.us

for.body66.us:                                    ; preds = %for.body66.us.for.body66.us_crit_edge, %for.body63.us
  %indvars.iv = phi i64 [ 0, %for.body63.us ], [ %indvars.iv.next.1, %for.body66.us.for.body66.us_crit_edge ]
  %63 = phi double [ %.pre36, %for.body63.us ], [ %add77.us.1, %for.body66.us.for.body66.us_crit_edge ]
  ...
  store double %add77.us, double* %sunkaddr112, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %add77.us.1, double* %sunkaddr112, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
...
for.cond64.for.end82_crit_edge.us:                ; preds = %for.body66.us
  ...
  br i1 %exitcond, label %for.end85, label %for.cond64.for.end82_crit_edge.us.for.body63.us_crit_edge

for.cond64.for.end82_crit_edge.us.for.body63.us_crit_edge: ; preds = %for.cond64.for.end82_crit_edge.us
  br label %for.body63.us
