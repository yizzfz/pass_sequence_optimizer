...
for.body.preheader:                               ; preds = %for.body.lr.ph
  ...
  br i1 %min.iters.check, label %for.body.preheader47, label %min.iters.checked

for.body.preheader47:                             ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.body.preheader
  %indvars.iv13.ph = phi i64 [ %14, %vector.memcheck ], [ %14, %min.iters.checked ], [ %14, %for.body.preheader ], [ %ind.end, %middle.block ]
  br label %for.body

min.iters.checked:                                ; preds = %for.body.preheader
  %n.vec = and i64 %17, -4
  %cmp.zero = icmp eq i64 %n.vec, 0
  br i1 %cmp.zero, label %for.body.preheader47, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %scevgep = getelementptr double, double* %1, i64 %14
  %18 = add nsw i64 %14, 1
  %19 = icmp sgt i64 %18, %4
  %smax34 = select i1 %19, i64 %18, i64 %4
  %scevgep35 = getelementptr double, double* %1, i64 %smax34
  %scevgep37 = getelementptr double, double* %2, i64 %14
  %scevgep39 = getelementptr double, double* %2, i64 %smax34
  %bound0 = icmp ult double* %scevgep, %scevgep39
  %bound1 = icmp ult double* %scevgep37, %scevgep35
  %memcheck.conflict = and i1 %bound0, %bound1
  %ind.end = add nsw i64 %14, %n.vec
  br i1 %memcheck.conflict, label %for.body.preheader47, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %broadcast.splatinsert43 = insertelement <2 x double> undef, double %5, i32 0
  %broadcast.splat44 = shufflevector <2 x double> %broadcast.splatinsert43, <2 x double> undef, <2 x i32> zeroinitializer
  %broadcast.splatinsert45 = insertelement <2 x double> undef, double %mul35, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load42 = load <2 x double>, <2 x double>* %30, align 8, !alias.scope !1, !noalias !4
  %31 = fmul <2 x double> %broadcast.splat44, %wide.load
  %32 = fmul <2 x double> %broadcast.splat44, %wide.load42
  %33 = fadd <2 x double> %31, %broadcast.splat46
  %34 = fadd <2 x double> %32, %broadcast.splat46
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.cond.for.end41_crit_edge, label %for.body.preheader47

for.body.us.preheader:                            ; preds = %for.body.lr.ph
  %38 = sext i32 %3 to i64
  %sunkaddr = ptrtoint double* %9 to i64
  %sunkaddr52 = ptrtoint double* %9 to i64
  %sunkaddr56 = ptrtoint double* %11 to i64
  %sunkaddr60 = ptrtoint double* %11 to i64
  br label %for.body.us
...
for.body7.us:                                     ; preds = %for.body7.us, %for.body.us
  ...
  store double %add.us, double* %sunkaddr55, align 8
  ...
  %44 = load double, double* %sunkaddr59, align 8
  %add27.us = fadd double %mul24.us, %44
  store double %add27.us, double* %sunkaddr63, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.body:                                         ; preds = %for.body.preheader47, %for.body
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.body ], [ %indvars.iv13.ph, %for.body.preheader47 ]
  ...
  br i1 %cmp, label %for.body, label %for.cond.for.end41_crit_edge.loopexit64, !llvm.loop !9

for.cond.for.end41_crit_edge.loopexit:            ; preds = %for.cond5.for.end_crit_edge.us
  br label %for.cond.for.end41_crit_edge

for.cond.for.end41_crit_edge.loopexit64:          ; preds = %for.body
  br label %for.cond.for.end41_crit_edge

for.cond.for.end41_crit_edge:                     ; preds = %for.cond.for.end41_crit_edge.loopexit64, %for.cond.for.end41_crit_edge.loopexit, %middle.block
  %inc40.lcssa.in = phi i64 [ %ind.end, %middle.block ], [ %indvars.iv.next10, %for.cond.for.end41_crit_edge.loopexit ], [ %indvars.iv.next14, %for.cond.for.end41_crit_edge.loopexit64 ]
