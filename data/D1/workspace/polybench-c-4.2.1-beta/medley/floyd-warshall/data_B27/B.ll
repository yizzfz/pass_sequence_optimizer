...
._crit_edge:                                      ; preds = %._crit_edge, %.preheader.us
  ...
  %3 = mul nuw nsw i64 %indvars.iv, %indvars.iv11
  %4 = trunc i64 %3 to i32
  %5 = srem i32 %4, 7
  %6 = add nsw i32 %5, 1
  %7 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv11, i64 %indvars.iv
  %8 = add nuw nsw i64 %indvars.iv, %indvars.iv11
  ...
  %14 = srem i32 %9, 11
  %15 = icmp eq i32 %14, 0
  %or.cond4.us = or i1 %15, %or.cond.us
  %..us = select i1 %or.cond4.us, i32 999, i32 %6
  store i32 %..us, i32* %7, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond10 = icmp eq i64 %indvars.iv.next, 2800
  br i1 %exitcond10, label %._crit_edge.us, label %._crit_edge

._crit_edge.us:                                   ; preds = %._crit_edge
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond14 = icmp eq i64 %indvars.iv.next12, 2800
  br i1 %exitcond14, label %._crit_edge8.loopexit, label %.preheader.us
...
define internal fastcc void @kernel_floyd_warshall(i32, [2800 x i32]* nocapture) unnamed_addr #2 {
  br i1 true, label %.preheader.us.us.preheader.preheader, label %._crit_edge8
...
.preheader.us.us.preheader:                       ; preds = %.preheader.us.us.preheader.preheader, %._crit_edge6.us
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %._crit_edge6.us ], [ 0, %.preheader.us.us.preheader.preheader ]
  %scevgep31 = getelementptr [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv24, i64 0
  %scevgep33 = getelementptr [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv24, i64 2800
...
.preheader.us.us:                                 ; preds = %._crit_edge.us.us, %.preheader.us.us.preheader
  ...
  %scevgep = getelementptr [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv20, i64 0
  %scevgep29 = getelementptr [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv20, i64 2800
  %3 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv20, i64 %indvars.iv24
...
._crit_edge.preheader:                            ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.preheader.us.us
  %indvars.iv.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %min.iters.checked ], [ 0, %.preheader.us.us ], [ 2800, %middle.block ]
...
._crit_edge.prol:                                 ; preds = %._crit_edge.prol.preheader
  %4 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv20, i64 %indvars.iv.ph
  %5 = load i32, i32* %4, align 4
  %6 = load i32, i32* %3, align 4
  %7 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv24, i64 %indvars.iv.ph
  %8 = load i32, i32* %7, align 4
  %9 = add nsw i32 %8, %6
  %10 = icmp slt i32 %5, %9
  %..us.us.prol = select i1 %10, i32 %5, i32 %9
  store i32 %..us.us.prol, i32* %4, align 4
...
._crit_edge.prol.loopexit:                        ; preds = %._crit_edge.prol.loopexit.unr-lcssa
  br i1 false, label %._crit_edge.us.us.loopexit, label %._crit_edge.preheader.new

._crit_edge.preheader.new:                        ; preds = %._crit_edge.prol.loopexit
  br label %._crit_edge

min.iters.checked:                                ; preds = %.preheader.us.us
  br i1 false, label %._crit_edge.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %bound0 = icmp ult i32* %scevgep, %3
  %bound1 = icmp ult i32* %3, %scevgep29
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %11 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv20, i64 %index
  %12 = bitcast i32* %11 to <4 x i32>*
  %wide.load = load <4 x i32>, <4 x i32>* %12, align 4, !alias.scope !1, !noalias !4
  %13 = getelementptr i32, i32* %11, i64 4
  %14 = bitcast i32* %13 to <4 x i32>*
  %wide.load40 = load <4 x i32>, <4 x i32>* %14, align 4, !alias.scope !1, !noalias !4
  %15 = load i32, i32* %3, align 4, !alias.scope !7
  %16 = insertelement <4 x i32> undef, i32 %15, i32 0
  %17 = shufflevector <4 x i32> %16, <4 x i32> undef, <4 x i32> zeroinitializer
  %18 = insertelement <4 x i32> undef, i32 %15, i32 0
  %19 = shufflevector <4 x i32> %18, <4 x i32> undef, <4 x i32> zeroinitializer
  %20 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv24, i64 %index
  %21 = bitcast i32* %20 to <4 x i32>*
  %wide.load41 = load <4 x i32>, <4 x i32>* %21, align 4, !alias.scope !8
  %22 = getelementptr i32, i32* %20, i64 4
  %23 = bitcast i32* %22 to <4 x i32>*
  %wide.load42 = load <4 x i32>, <4 x i32>* %23, align 4, !alias.scope !8
  %24 = add nsw <4 x i32> %wide.load41, %17
  %25 = add nsw <4 x i32> %wide.load42, %19
  %26 = icmp slt <4 x i32> %wide.load, %24
  %27 = icmp slt <4 x i32> %wide.load40, %25
  %28 = select <4 x i1> %26, <4 x i32> %wide.load, <4 x i32> %24
  %29 = select <4 x i1> %27, <4 x i32> %wide.load40, <4 x i32> %25
  %30 = bitcast i32* %11 to <4 x i32>*
  store <4 x i32> %28, <4 x i32>* %30, align 4, !alias.scope !1, !noalias !4
  %31 = bitcast i32* %13 to <4 x i32>*
  store <4 x i32> %29, <4 x i32>* %31, align 4, !alias.scope !1, !noalias !4
  %index.next = add i64 %index, 8
  %32 = icmp eq i64 %index.next, 2800
  br i1 %32, label %middle.block, label %vector.body, !llvm.loop !9

middle.block:                                     ; preds = %vector.body
  br i1 true, label %._crit_edge.us.us, label %._crit_edge.preheader
...
._crit_edge.us.us:                                ; preds = %._crit_edge.us.us.loopexit, %middle.block
  ...
  %exitcond23 = icmp eq i64 %indvars.iv.next21, 2800
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge.preheader.new
  ...
  %33 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv20, i64 %indvars.iv
  %34 = load i32, i32* %33, align 4
  %35 = load i32, i32* %3, align 4
  %36 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv24, i64 %indvars.iv
  %37 = load i32, i32* %36, align 4
  %38 = add nsw i32 %37, %35
  %39 = icmp slt i32 %34, %38
  %..us.us = select i1 %39, i32 %34, i32 %38
  store i32 %..us.us, i32* %33, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %40 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv20, i64 %indvars.iv.next
  %41 = load i32, i32* %40, align 4
  %42 = load i32, i32* %3, align 4
  %43 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv24, i64 %indvars.iv.next
  %44 = load i32, i32* %43, align 4
  %45 = add nsw i32 %44, %42
  %46 = icmp slt i32 %41, %45
  %..us.us.1 = select i1 %46, i32 %41, i32 %45
  store i32 %..us.us.1, i32* %40, align 4
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %exitcond19.1 = icmp eq i64 %indvars.iv.next.1, 2800
  br i1 %exitcond19.1, label %._crit_edge.us.us.loopexit.unr-lcssa, label %._crit_edge, !llvm.loop !12
...
.preheader.us:                                    ; preds = %._crit_edge.us, %.preheader.us.preheader
  ...
  %7 = mul nsw i64 %indvars.iv7, 2800
...
._crit_edge:                                      ; preds = %._crit_edge11, %12
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond6 = icmp eq i64 %indvars.iv.next, 2800
  br i1 %exitcond6, label %._crit_edge.us, label %._crit_edge11

._crit_edge.us:                                   ; preds = %._crit_edge
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %exitcond10 = icmp eq i64 %indvars.iv.next8, 2800
