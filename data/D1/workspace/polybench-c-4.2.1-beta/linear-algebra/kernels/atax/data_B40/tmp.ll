...
define internal fastcc void @init_array(i32, i32, [2100 x double]*, double* nocapture) unnamed_addr #2 {
  ...
  %9 = sext i32 %1 to i64
  %10 = icmp sgt i32 %1, 0
  br i1 %10, label %.lr.ph15.preheader, label %.preheader3.preheader

.lr.ph15.preheader:                               ; preds = %4
  %xtraiter19 = and i64 %9, 1
  %lcmp.mod20 = icmp eq i64 %xtraiter19, 0
  br i1 %lcmp.mod20, label %.lr.ph15.prol.loopexit, label %.lr.ph15.prol
...
.lr.ph15.prol.loopexit:                           ; preds = %.lr.ph15.preheader, %.lr.ph15.prol
  %indvars.iv914.unr = phi i64 [ 0, %.lr.ph15.preheader ], [ 1, %.lr.ph15.prol ]
  %13 = icmp eq i32 %1, 1
  br i1 %13, label %.preheader3.preheader, label %.lr.ph15.preheader.new

.lr.ph15.preheader.new:                           ; preds = %.lr.ph15.prol.loopexit
  br label %.lr.ph15

.preheader3.preheader.loopexit:                   ; preds = %.lr.ph15
  br label %.preheader3.preheader

.preheader3.preheader:                            ; preds = %.preheader3.preheader.loopexit, %.lr.ph15.prol.loopexit, %4
  ...
  br i1 %21, label %.preheader.preheader.preheader, label %.preheader3.preheader._crit_edge
...
.lr.ph15:                                         ; preds = %.lr.ph15, %.lr.ph15.preheader.new
  %indvars.iv914 = phi i64 [ %indvars.iv914.unr, %.lr.ph15.preheader.new ], [ %indvars.iv.next10.1, %.lr.ph15 ]
  %24 = trunc i64 %indvars.iv914 to i32
  %25 = sitofp i32 %24 to double
  %26 = getelementptr inbounds double, double* %3, i64 %indvars.iv914
  ...
  %indvars.iv.next10.1 = add nsw i64 %indvars.iv914, 2
  %exitcond16.1 = icmp eq i64 %indvars.iv.next10.1, %9
  br i1 %exitcond16.1, label %.preheader3.preheader.loopexit, label %.lr.ph15

.preheader.preheader:                             ; preds = %.preheader.preheader.preheader, %.preheader3
  %indvars.iv712 = phi i64 [ %indvars.iv.next8, %.preheader3 ], [ 0, %.preheader.preheader.preheader ]
  br i1 %22, label %.preheader.preheader18, label %.preheader3

.preheader.preheader18:                           ; preds = %.preheader.preheader
  br i1 %lcmp.mod, label %.preheader.prol.loopexit, label %.preheader.prol

.preheader.prol:                                  ; preds = %.preheader.preheader18
...
.preheader.prol.loopexit:                         ; preds = %.preheader.prol, %.preheader.preheader18
  %indvars.iv11.unr.ph = phi i64 [ 1, %.preheader.prol ], [ 0, %.preheader.preheader18 ]
  br i1 %23, label %.preheader3, label %.preheader.preheader18.new

.preheader.preheader18.new:                       ; preds = %.preheader.prol.loopexit
  br label %.preheader

.preheader:                                       ; preds = %.preheader, %.preheader.preheader18.new
  %indvars.iv11 = phi i64 [ %indvars.iv11.unr.ph, %.preheader.preheader18.new ], [ %indvars.iv.next.1, %.preheader ]
...
.preheader3:                                      ; preds = %.preheader3.loopexit, %.preheader.prol.loopexit, %.preheader.preheader
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv712, 1
  %56 = icmp slt i64 %indvars.iv.next8, %20
  br i1 %56, label %.preheader.preheader, label %.preheader3.preheader._crit_edge.loopexit

.preheader3.preheader._crit_edge.loopexit:        ; preds = %.preheader3
  br label %.preheader3.preheader._crit_edge

.preheader3.preheader._crit_edge:                 ; preds = %.preheader3.preheader._crit_edge.loopexit, %.preheader3.preheader
  ret void
}
...
define internal fastcc void @kernel_atax(i32, i32, [2100 x double]*, double*, double*, double*) unnamed_addr #2 {
  ...
  %14 = icmp sgt i32 %1, 0
  br i1 %14, label %.lr.ph33.preheader, label %.preheader4.preheader

.lr.ph33.preheader:                               ; preds = %6
  %15 = add nsw i64 %13, -1
  %xtraiter43 = and i64 %13, 7
  %lcmp.mod44 = icmp eq i64 %xtraiter43, 0
  br i1 %lcmp.mod44, label %.lr.ph33.prol.loopexit, label %.lr.ph33.prol.preheader
...
.lr.ph33.prol:                                    ; preds = %.lr.ph33.prol, %.lr.ph33.prol.preheader
  %indvars.iv2332.prol = phi i64 [ %indvars.iv.next24.prol, %.lr.ph33.prol ], [ 0, %.lr.ph33.prol.preheader ]
  %prol.iter = phi i64 [ %prol.iter.sub, %.lr.ph33.prol ], [ %xtraiter43, %.lr.ph33.prol.preheader ]
  %16 = getelementptr inbounds double, double* %4, i64 %indvars.iv2332.prol
  store double 0.000000e+00, double* %16, align 8
  %indvars.iv.next24.prol = add nuw nsw i64 %indvars.iv2332.prol, 1
  %prol.iter.sub = add i64 %prol.iter, -1
  %prol.iter.cmp = icmp eq i64 %prol.iter.sub, 0
  br i1 %prol.iter.cmp, label %.lr.ph33.prol.loopexit.loopexit, label %.lr.ph33.prol, !llvm.loop !1
...
.lr.ph33.prol.loopexit:                           ; preds = %.lr.ph33.prol.loopexit.loopexit, %.lr.ph33.preheader
  %indvars.iv2332.unr = phi i64 [ 0, %.lr.ph33.preheader ], [ %indvars.iv.next24.prol, %.lr.ph33.prol.loopexit.loopexit ]
  %17 = icmp ult i64 %15, 7
  br i1 %17, label %.preheader4.preheader, label %.lr.ph33.preheader.new

.lr.ph33.preheader.new:                           ; preds = %.lr.ph33.prol.loopexit
  br label %.lr.ph33

.preheader4.preheader.loopexit:                   ; preds = %.lr.ph33
  br label %.preheader4.preheader

.preheader4.preheader:                            ; preds = %.preheader4.preheader.loopexit, %.lr.ph33.prol.loopexit, %6
  ...
  br i1 %26, label %.lr.ph31.preheader, label %.preheader4.preheader._crit_edge

.lr.ph31.preheader:                               ; preds = %.preheader4.preheader
  %27 = add nsw i64 %24, -1
...
.lr.ph33:                                         ; preds = %.lr.ph33, %.lr.ph33.preheader.new
  %indvars.iv2332 = phi i64 [ %indvars.iv2332.unr, %.lr.ph33.preheader.new ], [ %indvars.iv.next24.7, %.lr.ph33 ]
  %32 = getelementptr inbounds double, double* %4, i64 %indvars.iv2332
  ...
  %indvars.iv.next24.1 = add nsw i64 %indvars.iv2332, 2
  %34 = getelementptr inbounds double, double* %4, i64 %indvars.iv.next24.1
  store double 0.000000e+00, double* %34, align 8
  %indvars.iv.next24.2 = add nsw i64 %indvars.iv2332, 3
  %35 = getelementptr inbounds double, double* %4, i64 %indvars.iv.next24.2
  store double 0.000000e+00, double* %35, align 8
  %indvars.iv.next24.3 = add nsw i64 %indvars.iv2332, 4
  %36 = getelementptr inbounds double, double* %4, i64 %indvars.iv.next24.3
  store double 0.000000e+00, double* %36, align 8
  %indvars.iv.next24.4 = add nsw i64 %indvars.iv2332, 5
  %37 = getelementptr inbounds double, double* %4, i64 %indvars.iv.next24.4
  store double 0.000000e+00, double* %37, align 8
  %indvars.iv.next24.5 = add nsw i64 %indvars.iv2332, 6
  %38 = getelementptr inbounds double, double* %4, i64 %indvars.iv.next24.5
  store double 0.000000e+00, double* %38, align 8
  %indvars.iv.next24.6 = add nsw i64 %indvars.iv2332, 7
  %39 = getelementptr inbounds double, double* %4, i64 %indvars.iv.next24.6
  store double 0.000000e+00, double* %39, align 8
  %indvars.iv.next24.7 = add nsw i64 %indvars.iv2332, 8
  %exitcond35.7 = icmp eq i64 %indvars.iv.next24.7, %13
  br i1 %exitcond35.7, label %.preheader4.preheader.loopexit, label %.lr.ph33

.lr.ph31:                                         ; preds = %.lr.ph31.preheader, %.preheader4
  %indvars.iv2128 = phi i64 [ %indvars.iv.next22, %.preheader4 ], [ 0, %.lr.ph31.preheader ]
  %40 = getelementptr inbounds double, double* %19, i64 %indvars.iv2128
  store double 0.000000e+00, double* %40, align 8
  br i1 %28, label %.lr.ph.preheader, label %.preheader.preheader
...
.lr.ph.prol.loopexit:                             ; preds = %.lr.ph.prol, %.lr.ph.preheader
  ...
  br i1 %29, label %.preheader.preheader, label %.lr.ph.preheader.new
...
.preheader.preheader:                             ; preds = %.preheader.preheader.loopexit, %.lr.ph.prol.loopexit, %.lr.ph31
  br i1 %30, label %.preheader.preheader40, label %.preheader4

.preheader.preheader40:                           ; preds = %.preheader.preheader
  br i1 %lcmp.mod42, label %.preheader.prol.loopexit, label %.preheader.prol

.preheader.prol:                                  ; preds = %.preheader.preheader40
...
.preheader.prol.loopexit:                         ; preds = %.preheader.prol, %.preheader.preheader40
  %indvars.iv1926.unr.ph = phi i64 [ 1, %.preheader.prol ], [ 0, %.preheader.preheader40 ]
  br i1 %31, label %.preheader4, label %.preheader.preheader40.new

.preheader.preheader40.new:                       ; preds = %.preheader.prol.loopexit
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  ...
  br i1 %exitcond.1, label %.preheader.preheader.loopexit, label %.lr.ph

.preheader:                                       ; preds = %.preheader, %.preheader.preheader40.new
  %indvars.iv1926 = phi i64 [ %indvars.iv1926.unr.ph, %.preheader.preheader40.new ], [ %indvars.iv.next20.1, %.preheader ]
  ...
  %exitcond34.1 = icmp eq i64 %indvars.iv.next20.1, %24
  br i1 %exitcond34.1, label %.preheader4.loopexit, label %.preheader
...
.preheader4:                                      ; preds = %.preheader4.loopexit, %.preheader.prol.loopexit, %.preheader.preheader
  ...
  br i1 %83, label %.lr.ph31, label %.preheader4.preheader._crit_edge.loopexit

.preheader4.preheader._crit_edge.loopexit:        ; preds = %.preheader4
  br label %.preheader4.preheader._crit_edge

.preheader4.preheader._crit_edge:                 ; preds = %.preheader4.preheader._crit_edge.loopexit, %.preheader4.preheader
  ret void
}
