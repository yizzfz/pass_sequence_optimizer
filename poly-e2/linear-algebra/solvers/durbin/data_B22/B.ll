...
for.inc.lr.ph:                                    ; preds = %for.inc47, %entry
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %for.inc47 ], [ 1, %entry ]
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc47 ], [ 1, %entry ]
...
for.inc32.prol:                                   ; preds = %for.inc32.lr.ph
  ...
  %sunkaddr72 = add i64 %3, %sunkaddr71
...
vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert83 = insertelement <2 x double> undef, double %div, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec79 = load <4 x double>, <4 x double>* %45, align 8
  %strided.vec80 = shufflevector <4 x double> %wide.vec79, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %reverse = shufflevector <2 x double> %strided.vec80, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %strided.vec81 = shufflevector <4 x double> %wide.vec79, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %reverse82 = shufflevector <2 x double> %strided.vec81, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %46 = fmul <2 x double> %broadcast.splat84, %reverse82
  %47 = fadd <2 x double> %strided.vec, %46
  %48 = add nuw nsw i64 %offset.idx, 1
  %49 = fmul <2 x double> %broadcast.splat84, %reverse
  %50 = fadd <2 x double> %strided.vec78, %49
...
for.inc47:                                        ; preds = %for.inc47.loopexit, %middle.block, %for.inc32.prol.loopexit
  ...
  %indvars.iv.next77 = add nuw nsw i64 %7, 1
