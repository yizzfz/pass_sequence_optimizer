...
.lr.ph71.prol.loopexit:                           ; preds = %.lr.ph71.preheader, %.lr.ph71.prol
  ...
  br i1 %15, label %.preheader65, label %.lr.ph71.preheader144

.lr.ph71.preheader144:                            ; preds = %.lr.ph71.prol.loopexit
  br label %.lr.ph71
...
.lr.ph76.us.prol.loopexit:                        ; preds = %.lr.ph76.us.preheader, %.lr.ph76.us.prol
  ...
  br i1 %15, label %.loopexit.us, label %.lr.ph76.us.preheader143
...
._crit_edge:                                      ; preds = %._crit_edge1, %17
...
._crit_edge3:                                     ; preds = %._crit_edge2, %.preheader.us
  ...
  %34 = srem i32 %33, 20
  %35 = icmp eq i32 %34, 0
  br i1 %35, label %36, label %._crit_edge2
...
._crit_edge2:                                     ; preds = %._crit_edge3, %36
  %38 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %39 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv40, i64 %indvars.iv
  %40 = load double, double* %39, align 8
  %41 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %38, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i64 0, i64 0), double %40) #7
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond53 = icmp eq i64 %indvars.iv.next, %29
...
._crit_edge32:                                    ; preds = %._crit_edge32.loopexit, %._crit_edge38
  ...
  %43 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %42, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i64 0, i64 0)) #7
