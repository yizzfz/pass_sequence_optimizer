...
for.cond1.preheader.us:                           ; preds = %for.inc7.us, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge
  %indvars.iv2737.us = phi i64 [ 0, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge ], [ %indvars.iv.next28.us, %for.inc7.us ]
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us, %for.cond1.preheader.us
  %indvars.iv2335.us = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next24.us, %for.body3.us ]
  %0 = mul nuw nsw i64 %indvars.iv2335.us, %indvars.iv2737.us
  %1 = add nuw nsw i64 %0, 1
  %2 = trunc i64 %1 to i32
  %rem.us = srem i32 %2, 1200
  %conv.us = sitofp i32 %rem.us to double
  %div.us = fdiv double %conv.us, 1.200000e+03
  %arrayidx6.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv2737.us, i64 %indvars.iv2335.us
  store double %div.us, double* %arrayidx6.us, align 8
  %indvars.iv.next24.us = add nuw nsw i64 %indvars.iv2335.us, 1
  %exitcond39 = icmp eq i64 %indvars.iv2335.us, 999
  br i1 %exitcond39, label %for.inc7.us, label %for.body3.us

for.inc7.us:                                      ; preds = %for.body3.us
  %indvars.iv.next28.us = add nuw nsw i64 %indvars.iv2737.us, 1
  %exitcond42 = icmp eq i64 %indvars.iv.next28.us, 1200
...
for.cond14.preheader:                             ; preds = %for.cond14.preheader.preheader, %for.inc31
  %indvars.iv2132 = phi i64 [ %indvars.iv.next22, %for.inc31 ], [ 0, %for.cond14.preheader.preheader ]
  br label %for.body17

for.body17:                                       ; preds = %for.body17, %for.cond14.preheader
  %indvars.iv30 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next, %for.body17 ]
  %3 = mul nuw nsw i64 %indvars.iv30, %indvars.iv2132
  %4 = add nuw nsw i64 %3, 2
  %5 = trunc i64 %4 to i32
  %rem20 = srem i32 %5, 1000
  %conv21 = sitofp i32 %rem20 to double
  %div23 = fdiv double %conv21, 1.000000e+03
  %arrayidx27 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv2132, i64 %indvars.iv30
...
for.inc31:                                        ; preds = %for.body17
  ...
  %exitcond43 = icmp eq i64 %indvars.iv.next22, 1200
  br i1 %exitcond43, label %for.end33, label %for.cond14.preheader
...
for.cond1.preheader.us:                           ; preds = %for.cond1.preheader.us.preheader, %for.inc32.us
  %indvars.iv2839.us = phi i64 [ %indvars.iv.next29.us, %for.inc32.us ], [ 1, %for.cond1.preheader.us.preheader ]
  %indvars.iv3037.us = phi i64 [ %3, %for.inc32.us ], [ 0, %for.cond1.preheader.us.preheader ]
...
for.body3.us:                                     ; preds = %for.body3.us.preheader, %for.body3.us
  %indvars.iv32.us = phi i64 [ %indvars.iv.next.us, %for.body3.us ], [ %indvars.iv32.us.ph, %for.body3.us.preheader ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %32 = or i64 %index, 2
  %33 = or i64 %index, 3
  %34 = load double, double* %arrayidx15.us, align 8, !alias.scope !6
  %35 = insertelement <2 x double> undef, double %34, i32 0
  %36 = fmul <2 x double> %35, %broadcast.splatinsert13
  %37 = shufflevector <2 x double> %36, <2 x double> undef, <2 x i32> zeroinitializer
  %38 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %index, i64 %indvars.iv2635.us
  %39 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %31, i64 %indvars.iv2635.us
  %40 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %32, i64 %indvars.iv2635.us
  %41 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %33, i64 %indvars.iv2635.us
  ...
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv3037.us, i64 %index
  ...
  %57 = fadd <2 x double> %wide.load15, %51
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %59, label %for.inc29.us, label %for.body11.us.preheader
...
for.body11.us.preheader:                          ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.cond9.preheader.us
  ...
  %60 = sub i64 %0, %indvars.iv2033.us.ph
  %xtraiter37 = and i64 %60, 1
...
for.body11.us.prol.loopexit:                      ; preds = %for.body11.us.prol, %for.body11.us.preheader
  %indvars.iv2033.us.unr.ph = phi i64 [ %indvars.iv.next21.us.prol, %for.body11.us.prol ], [ %indvars.iv2033.us.ph, %for.body11.us.preheader ]
  %64 = icmp eq i64 %indvars.iv3037.us, %indvars.iv2033.us.ph
  br i1 %64, label %for.inc29.us, label %for.body11.us.preheader.new
...
for.body11.us:                                    ; preds = %for.body11.us, %for.body11.us.preheader.new
  %indvars.iv2033.us = phi i64 [ %indvars.iv2033.us.unr.ph, %for.body11.us.preheader.new ], [ %indvars.iv.next21.us.1, %for.body11.us ]
  %65 = load double, double* %arrayidx15.us, align 8
  %mul16.us = fmul double %65, %alpha
  %arrayidx20.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv2033.us, i64 %indvars.iv2635.us
  %66 = load double, double* %arrayidx20.us, align 8
  %mul21.us = fmul double %mul16.us, %66
  %arrayidx25.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv3037.us, i64 %indvars.iv2033.us
  %67 = load double, double* %arrayidx25.us, align 8
  %add.us = fadd double %67, %mul21.us
  store double %add.us, double* %arrayidx25.us, align 8
  %indvars.iv.next21.us = add nuw nsw i64 %indvars.iv2033.us, 1
  %68 = load double, double* %arrayidx15.us, align 8
  %mul16.us.1 = fmul double %68, %alpha
  %arrayidx20.us.1 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv.next21.us, i64 %indvars.iv2635.us
  %69 = load double, double* %arrayidx20.us.1, align 8
  %mul21.us.1 = fmul double %mul16.us.1, %69
  %arrayidx25.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv3037.us, i64 %indvars.iv.next21.us
  %70 = load double, double* %arrayidx25.us.1, align 8
  %add.us.1 = fadd double %70, %mul21.us.1
  ...
  br i1 %exitcond25.us.1, label %for.inc29.us, label %for.body11.us, !llvm.loop !15
...
for.inc32.us:                                     ; preds = %for.inc29.us
  ...
  %exitcond43 = icmp eq i64 %3, 1200
  br i1 %exitcond43, label %for.end34, label %for.cond1.preheader.us
...
for.cond2.preheader:                              ; preds = %for.inc10, %for.cond2.preheader.lr.ph.for.cond2.preheader_crit_edge
  %indvars.iv915 = phi i64 [ 0, %for.cond2.preheader.lr.ph.for.cond2.preheader_crit_edge ], [ %indvars.iv.next10, %for.inc10 ]
  %3 = mul nuw nsw i64 %indvars.iv915, 1200
  br label %for.body4

for.body4:                                        ; preds = %if.end, %for.cond2.preheader
  %indvars.iv13 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next, %if.end ]
  %4 = add nuw nsw i64 %indvars.iv13, %3
  %5 = trunc i64 %4 to i32
  %rem = srem i32 %5, 20
