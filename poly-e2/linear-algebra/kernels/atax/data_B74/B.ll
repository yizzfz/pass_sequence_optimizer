...
for.body10.us:                                    ; preds = %for.body10.us, %for.body6.us
  ...
  %1 = add nuw nsw i64 %indvars.iv18, %indvars.iv
  ...
  %3 = add nuw nsw i64 %indvars.iv18, %indvars.iv.next
  ...
  %exitcond17.1 = icmp eq i64 %indvars.iv.next.1, 2100
  br i1 %exitcond17.1, label %for.cond7.for.inc22_crit_edge.us, label %for.body10.us
