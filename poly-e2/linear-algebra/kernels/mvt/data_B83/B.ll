...
for.body.lr.ph:
  br label %for.body.new

for.body.new:                                     ; preds = %for.inc34, %for.body.lr.ph
  %indvars.iv10 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next11, %for.inc34 ]
...
for.body25:                                       ; preds = %for.body25, %for.body.new
  %indvars.iv = phi i64 [ 0, %for.body.new ], [ %indvars.iv.next.1, %for.body25 ]
  %8 = mul nuw nsw i64 %indvars.iv10, %indvars.iv
  ...
  %10 = mul nuw nsw i64 %indvars.iv10, %indvars.iv.next
...
for.inc34:                                        ; preds = %for.body25
  ...
  br i1 %13, label %for.end36, label %for.body.new
...
for.cond1.preheader.preheader:
  ...
  br label %for.cond1.preheader.new

for.cond1.preheader.new:                          ; preds = %for.inc12, %for.cond1.preheader.preheader
...
for.body3:                                        ; preds = %for.body3, %for.cond1.preheader.new
  %indvars.iv24 = phi i64 [ 0, %for.cond1.preheader.new ], [ %indvars.iv.next25.1, %for.body3 ]
  %0 = phi double [ %.pre, %for.cond1.preheader.new ], [ %add.1, %for.body3 ]
...
for.inc12:                                        ; preds = %for.body3
  ...
  br i1 %exitcond, label %for.cond18.preheader.new.preheader, label %for.cond1.preheader.new

for.cond18.preheader.new.preheader:               ; preds = %for.inc12
  %sunkaddr4 = ptrtoint double* %x2 to i64
  br label %for.cond18.preheader.new

for.cond18.preheader.new:                         ; preds = %for.cond18.preheader.new.preheader, %for.inc36
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc36 ], [ 0, %for.cond18.preheader.new.preheader ]
...
for.body20:                                       ; preds = %for.body20, %for.cond18.preheader.new
  %indvars.iv = phi i64 [ 0, %for.cond18.preheader.new ], [ %indvars.iv.next.1, %for.body20 ]
  %5 = phi double [ %.pre20, %for.cond18.preheader.new ], [ %add30.1, %for.body20 ]
...
for.inc36:                                        ; preds = %for.body20
  ...
  br i1 %exitcond35, label %for.end38, label %for.cond18.preheader.new
