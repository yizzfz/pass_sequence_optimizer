...
for.body26.lr.ph:                                 ; preds = %for.body26.lr.ph.preheader, %for.inc51
  %indvars.iv54 = phi i64 [ %7, %for.inc51 ], [ 0, %for.body26.lr.ph.preheader ]
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc51 ], [ 1, %for.body26.lr.ph.preheader ]
...
for.body26.prol.loopexit.unr-lcssa:               ; preds = %for.body26.lr.ph, %for.body26.prol.preheader
  ...
  br i1 %9, label %for.cond40.preheader, label %for.body26.preheader
...
for.body43.preheader:                             ; preds = %for.body43.prol.loopexit
  %11 = sub i64 992, %indvars.iv48.unr
  %12 = lshr i64 %11, 3
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %18 = shl i64 %index, 3
  %19 = add i64 %indvars.iv48.unr, %18
  %20 = add nsw i64 %19, 7
  %21 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv54, i64 %20
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.inc51, label %for.body43.preheader71
...
for.body26:                                       ; preds = %for.body26.preheader, %for.body26
  ...
  %25 = add nuw nsw i64 %indvars.iv, %indvars.iv54
  ...
  %27 = add nuw nsw i64 %indvars.iv.next, %indvars.iv54
...
for.body43:                                       ; preds = %for.body43.preheader71, %for.body43
  ...
  br i1 %exitcond51.7, label %for.inc51.loopexit, label %for.body43, !llvm.loop !6
