...
for.body.preheader:                               ; preds = %for.body.lr.ph
  ...
  br i1 %min.iters.check, label %for.body.preheader64, label %min.iters.checked

for.body.preheader64:                             ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.body.preheader
...
min.iters.checked:                                ; preds = %for.body.preheader
  ...
  br i1 %cmp.zero, label %for.body.preheader64, label %vector.memcheck
...
vector.memcheck:                                  ; preds = %min.iters.checked
  ...
  br i1 %memcheck.conflict, label %for.body.preheader64, label %vector.ph
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.cond.for.end41_crit_edge, label %for.body.preheader64

for.body.us.preheader:                            ; preds = %for.body.lr.ph
  %38 = sext i32 %3 to i64
  %sunkaddr = ptrtoint double* %9 to i64
  %sunkaddr51 = ptrtoint double* %9 to i64
  %sunkaddr55 = ptrtoint double* %11 to i64
  %sunkaddr59 = ptrtoint double* %11 to i64
  br label %for.body.us
...
for.body7.us:                                     ; preds = %for.body7.us, %for.body.us
  ...
  %41 = load double, double* %sunkaddr50, align 8
  ...
  %44 = load double, double* %sunkaddr58, align 8
  %add27.us = fadd double %mul24.us, %44
  store double %add27.us, double* %sunkaddr62, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.body:                                         ; preds = %for.body.preheader64, %for.body
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.body ], [ %indvars.iv14.ph, %for.body.preheader64 ]
  ...
  br i1 %cmp, label %for.body, label %for.cond.for.end41_crit_edge.loopexit66, !llvm.loop !9

for.cond.for.end41_crit_edge.loopexit:            ; preds = %for.cond5.for.end_crit_edge.us
  br label %for.cond.for.end41_crit_edge

for.cond.for.end41_crit_edge.loopexit66:          ; preds = %for.body
  br label %for.cond.for.end41_crit_edge

for.cond.for.end41_crit_edge:                     ; preds = %for.cond.for.end41_crit_edge.loopexit66, %for.cond.for.end41_crit_edge.loopexit, %middle.block
  %inc40.lcssa.in = phi i64 [ %ind.end, %middle.block ], [ %indvars.iv.next11, %for.cond.for.end41_crit_edge.loopexit ], [ %indvars.iv.next15, %for.cond.for.end41_crit_edge.loopexit66 ]
