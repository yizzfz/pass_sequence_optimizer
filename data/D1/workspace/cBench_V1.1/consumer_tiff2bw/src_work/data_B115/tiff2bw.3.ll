...
@__llvm_prf_nm = private constant [167 x i8] c"\A4\01\00main1\01tmp1.ll:processCompressOptions\01tmp1.ll:usage\01tmp1.ll:cpTags\01tmp1.ll:checkcmap\01tmp1.ll:compresspalette\01tmp1.ll:compresscontig\01tmp1.ll:compresssep\01tmp1.ll:cpTag", section "__llvm_prf_names"
@llvm.used = appending global [10 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_main1 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_processCompressOptions to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_usage to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_cpTags to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_checkcmap to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_compresspalette to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_compresscontig to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_compresssep to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_cpTag to i8*), i8* getelementptr inbounds ([167 x i8], [167 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
