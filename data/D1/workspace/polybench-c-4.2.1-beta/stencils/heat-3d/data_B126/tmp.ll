...
.preheader10:                                     ; preds = %.preheader10.loopexit, %.preheader11
  br i1 %31, label %.preheader8.preheader, label %._crit_edge18
...
vector.body17:                                    ; preds = %vector.body17.preheader, %vector.body17
  ...
  %48 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %39, i64 %43, i64 %offset.idx49
  %49 = bitcast double* %48 to <2 x double>*
  %wide.load53 = load <2 x double>, <2 x double>* %49, align 8, !alias.scope !1
  %50 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv61, i64 %43, i64 %offset.idx49
  ...
  %54 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %40, i64 %43, i64 %offset.idx49
  ...
  %58 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv61, i64 %45, i64 %offset.idx49
  ...
  %77 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvars.iv61, i64 %43, i64 %offset.idx49
  ...
  br i1 %79, label %middle.block18, label %vector.body17, !llvm.loop !6
...
.preheader8:                                      ; preds = %.preheader8.preheader, %._crit_edge17
  ...
  br i1 %32, label %.preheader.lr.ph, label %._crit_edge17

.preheader.lr.ph:                                 ; preds = %.preheader8
  %114 = add nuw nsw i64 %indvars.iv68, 1
  %115 = add nsw i64 %indvars.iv68, -1
  br i1 %33, label %.preheader.us.preheader, label %._crit_edge17

.preheader.us.preheader:                          ; preds = %.preheader.lr.ph
  br label %.preheader.us

.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge16.us
  %indvar1 = phi i64 [ %indvar.next2, %._crit_edge16.us ], [ 0, %.preheader.us.preheader ]
...
; <label>:36:                                     ; preds = %34, %29
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond32 = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond32, label %._crit_edge.us.us, label %29
