...
for.inc14:                                        ; preds = %for.body6.prol.loopexit, %for.inc14.unr-lcssa
  ...
  %exitcond = icmp ne i64 %indvars.iv.next10, %0
...
for.body.preheader:                               ; preds = %entry
  ...
  %sunkaddr21 = ptrtoint double* %x to i64
  br label %for.body
...
for.body5:                                        ; preds = %for.body5, %for.body5.preheader.new
  ...
  store double %sub, double* %sunkaddr20, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  ...
  store double %sub.1, double* %sunkaddr20.1, align 8
...
for.end:                                          ; preds = %for.end.loopexit, %for.body
  ...
  %sunkaddr22 = shl i64 %indvars.iv7, 3
