...
entry:
  ...
  br i1 %or.cond, label %for.cond.for.cond1_crit_edge.us.preheader, label %for.end9

for.cond.for.cond1_crit_edge.us.preheader:        ; preds = %entry
  %0 = add i32 %h, -1
  %1 = sext i32 %w to i64
...
for.cond.for.cond1_crit_edge.us:                  ; preds = %for.cond1.for.inc7_crit_edge.us, %for.cond.for.cond1_crit_edge.us.preheader
  %indvars.iv8 = phi i64 [ 0, %for.cond.for.cond1_crit_edge.us.preheader ], [ %indvars.iv.next9, %for.cond1.for.inc7_crit_edge.us ]
  %3 = mul nsw i64 %indvars.iv8, 313
  br i1 %min.iters.check, label %for.inc.us.preheader, label %min.iters.checked

min.iters.checked:                                ; preds = %for.cond.for.cond1_crit_edge.us
...
for.inc.us.preheader:                             ; preds = %middle.block, %min.iters.checked, %for.cond.for.cond1_crit_edge.us
  %indvars.iv.ph = phi i64 [ 0, %min.iters.checked ], [ 0, %for.cond.for.cond1_crit_edge.us ], [ %n.vec, %middle.block ]
  br label %for.inc.us
...
for.cond1.for.inc7_crit_edge.us:                  ; preds = %for.cond1.for.inc7_crit_edge.us.loopexit, %middle.block
  ...
  br i1 %cmp.us, label %for.cond.for.cond1_crit_edge.us, label %for.end9.loopexit
...
entry:
  ...
  br i1 %cmp39, label %for.cond.for.cond31_crit_edge.lr.ph, label %for.cond89.for.cond115_crit_edge

for.cond.for.cond31_crit_edge.lr.ph:              ; preds = %entry
  %cmp3234 = icmp sgt i32 %h, 0
  br i1 %cmp3234, label %for.cond.for.cond31_crit_edge.us.preheader, label %for.end207

for.cond.for.cond31_crit_edge.us.preheader:       ; preds = %for.cond.for.cond31_crit_edge.lr.ph
  %2 = add i32 %h, -1
  %3 = sext i32 %w to i64
  ...
  br label %for.cond.for.cond31_crit_edge.us

for.cond.for.cond31_crit_edge.us:                 ; preds = %for.cond31.for.inc55_crit_edge.us, %for.cond.for.cond31_crit_edge.us.preheader
  %indvars.iv78 = phi i64 [ 0, %for.cond.for.cond31_crit_edge.us.preheader ], [ %indvars.iv.next79, %for.cond31.for.inc55_crit_edge.us ]
...
for.inc.us.for.inc.us_crit_edge.preheader:        ; preds = %for.cond.for.cond31_crit_edge.us
...
for.cond31.for.inc55_crit_edge.us:                ; preds = %for.cond31.for.inc55_crit_edge.us.loopexit, %for.inc.us.for.inc.us_crit_edge.prol.loopexit, %for.cond.for.cond31_crit_edge.us
  %indvars.iv.next79 = add nuw i64 %indvars.iv78, 1
  %cmp.us = icmp slt i64 %indvars.iv.next79, %3
  br i1 %cmp.us, label %for.cond.for.cond31_crit_edge.us, label %for.cond58.for.cond62_crit_edge.us.preheader

for.cond58.for.cond62_crit_edge.us.preheader:     ; preds = %for.cond31.for.inc55_crit_edge.us
  ...
  %14 = icmp eq i32 %h, 2
  br label %for.cond58.for.cond62_crit_edge.us

for.cond58.for.cond62_crit_edge.us:               ; preds = %for.cond62.for.inc86_crit_edge.us, %for.cond58.for.cond62_crit_edge.us.preheader
  %indvars.iv71 = phi i64 [ 0, %for.cond58.for.cond62_crit_edge.us.preheader ], [ %indvars.iv.next72, %for.cond62.for.inc86_crit_edge.us ]
...
for.inc84.us.for.inc84.us_crit_edge.preheader:    ; preds = %for.cond58.for.cond62_crit_edge.us
...
for.cond62.for.inc86_crit_edge.us:                ; preds = %for.cond62.for.inc86_crit_edge.us.loopexit, %for.inc84.us.for.inc84.us_crit_edge.prol.loopexit, %for.cond58.for.cond62_crit_edge.us
  %indvars.iv.next72 = add nuw i64 %indvars.iv71, 1
  %cmp59.us = icmp slt i64 %indvars.iv.next72, %3
  br i1 %cmp59.us, label %for.cond58.for.cond62_crit_edge.us, label %for.cond89.for.cond92_crit_edge.us.preheader

for.cond89.for.cond92_crit_edge.us.preheader:     ; preds = %for.cond62.for.inc86_crit_edge.us
  ...
  br label %for.cond89.for.cond92_crit_edge.us

for.cond89.for.cond92_crit_edge.us:               ; preds = %for.cond89.for.cond92_crit_edge.us.preheader, %for.cond92.for.inc112_crit_edge.us
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.cond92.for.inc112_crit_edge.us ], [ 0, %for.cond89.for.cond92_crit_edge.us.preheader ]
...
min.iters.checked:                                ; preds = %for.cond89.for.cond92_crit_edge.us
...
for.inc109.us.preheader:                          ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.cond89.for.cond92_crit_edge.us
  %indvars.iv62.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %min.iters.checked ], [ 0, %for.cond89.for.cond92_crit_edge.us ], [ %n.vec, %middle.block ]
...
for.cond92.for.inc112_crit_edge.us:               ; preds = %for.cond92.for.inc112_crit_edge.us.loopexit, %for.inc109.us.prol.loopexit, %middle.block
  ...
  br i1 %cmp90.us, label %for.cond89.for.cond92_crit_edge.us, label %for.cond89.for.cond115_crit_edge.loopexit

for.cond89.for.cond115_crit_edge.loopexit:        ; preds = %for.cond92.for.inc112_crit_edge.us
  br label %for.cond89.for.cond115_crit_edge

for.cond89.for.cond115_crit_edge:                 ; preds = %for.cond89.for.cond115_crit_edge.loopexit, %entry
  %cmp11619 = icmp sgt i32 %h, 0
  br i1 %cmp11619, label %for.cond115.for.cond118_crit_edge.lr.ph, label %for.cond150.for.cond182_crit_edge

for.cond115.for.cond118_crit_edge.lr.ph:          ; preds = %for.cond89.for.cond115_crit_edge
  %76 = icmp sgt i32 %w, 0
  br i1 %76, label %for.cond115.for.cond118_crit_edge.us.preheader, label %for.end207

for.cond115.for.cond118_crit_edge.us.preheader:   ; preds = %for.cond115.for.cond118_crit_edge.lr.ph
  %77 = add i32 %w, -1
  ...
  br label %for.cond115.for.cond118_crit_edge.us

for.cond115.for.cond118_crit_edge.us:             ; preds = %for.cond118.for.inc147_crit_edge.us, %for.cond115.for.cond118_crit_edge.us.preheader
  %indvars.iv59 = phi i64 [ 0, %for.cond115.for.cond118_crit_edge.us.preheader ], [ %indvars.iv.next60, %for.cond118.for.inc147_crit_edge.us ]
...
for.inc144.us.for.inc144.us_crit_edge.preheader:  ; preds = %for.cond115.for.cond118_crit_edge.us
...
for.cond118.for.inc147_crit_edge.us:              ; preds = %for.cond118.for.inc147_crit_edge.us.loopexit, %for.inc144.us.for.inc144.us_crit_edge.prol.loopexit, %for.cond115.for.cond118_crit_edge.us
  %indvars.iv.next60 = add nuw i64 %indvars.iv59, 1
  %cmp116.us = icmp slt i64 %indvars.iv.next60, %78
  br i1 %cmp116.us, label %for.cond115.for.cond118_crit_edge.us, label %for.cond150.for.cond154_crit_edge.us.preheader

for.cond150.for.cond154_crit_edge.us.preheader:   ; preds = %for.cond118.for.inc147_crit_edge.us
  ...
  %89 = icmp eq i32 %w, 2
  br label %for.cond150.for.cond154_crit_edge.us

for.cond150.for.cond154_crit_edge.us:             ; preds = %for.cond154.for.inc179_crit_edge.us, %for.cond150.for.cond154_crit_edge.us.preheader
  %indvars.iv52 = phi i64 [ 0, %for.cond150.for.cond154_crit_edge.us.preheader ], [ %indvars.iv.next53, %for.cond154.for.inc179_crit_edge.us ]
...
for.inc176.us.for.inc176.us_crit_edge.preheader:  ; preds = %for.cond150.for.cond154_crit_edge.us
...
for.cond154.for.inc179_crit_edge.us:              ; preds = %for.cond154.for.inc179_crit_edge.us.loopexit, %for.inc176.us.for.inc176.us_crit_edge.prol.loopexit, %for.cond150.for.cond154_crit_edge.us
  %indvars.iv.next53 = add nuw i64 %indvars.iv52, 1
  %cmp151.us = icmp slt i64 %indvars.iv.next53, %78
  br i1 %cmp151.us, label %for.cond150.for.cond154_crit_edge.us, label %for.cond150.for.cond182_crit_edge.loopexit

for.cond150.for.cond182_crit_edge.loopexit:       ; preds = %for.cond154.for.inc179_crit_edge.us
  br label %for.cond150.for.cond182_crit_edge

for.cond150.for.cond182_crit_edge:                ; preds = %for.cond150.for.cond182_crit_edge.loopexit, %for.cond89.for.cond115_crit_edge
  %93 = icmp sgt i32 %h, 0
  %94 = icmp sgt i32 %w, 0
  %brmerge.demorgan = and i1 %94, %93
  br i1 %brmerge.demorgan, label %for.cond182.for.cond185_crit_edge.us.preheader, label %for.end207

for.cond182.for.cond185_crit_edge.us.preheader:   ; preds = %for.cond150.for.cond182_crit_edge
  %95 = add i32 %h, -1
  ...
  br label %for.cond182.for.cond185_crit_edge.us

for.cond182.for.cond185_crit_edge.us:             ; preds = %for.cond185.for.inc205_crit_edge.us, %for.cond182.for.cond185_crit_edge.us.preheader
  %indvars.iv47 = phi i64 [ 0, %for.cond182.for.cond185_crit_edge.us.preheader ], [ %indvars.iv.next48, %for.cond185.for.inc205_crit_edge.us ]
...
min.iters.checked176:                             ; preds = %for.cond182.for.cond185_crit_edge.us
...
for.inc202.us.preheader:                          ; preds = %middle.block173, %vector.memcheck201, %min.iters.checked176, %for.cond182.for.cond185_crit_edge.us
  %indvars.iv.ph = phi i64 [ 0, %vector.memcheck201 ], [ 0, %min.iters.checked176 ], [ 0, %for.cond182.for.cond185_crit_edge.us ], [ %n.vec178, %middle.block173 ]
...
for.cond185.for.inc205_crit_edge.us:              ; preds = %for.cond185.for.inc205_crit_edge.us.loopexit, %for.inc202.us.prol.loopexit, %middle.block173
  ...
  br i1 %cmp183.us, label %for.cond182.for.cond185_crit_edge.us, label %for.end207.loopexit

for.end207.loopexit:                              ; preds = %for.cond185.for.inc205_crit_edge.us
  br label %for.end207

for.end207:                                       ; preds = %for.end207.loopexit, %for.cond150.for.cond182_crit_edge, %for.cond.for.cond31_crit_edge.lr.ph, %for.cond115.for.cond118_crit_edge.lr.ph
  ret void
}
...
entry:
  ...
  br i1 %or.cond, label %for.cond.for.cond2_crit_edge.us.preheader, label %for.end12
...
for.cond.for.cond2_crit_edge.us:                  ; preds = %for.cond2.for.inc10_crit_edge.us, %for.cond.for.cond2_crit_edge.us.preheader
  %indvars.iv8 = phi i64 [ 0, %for.cond.for.cond2_crit_edge.us.preheader ], [ %indvars.iv.next9, %for.cond2.for.inc10_crit_edge.us ]
...
for.cond2.for.inc10_crit_edge.us:                 ; preds = %for.inc.us
  ...
  br i1 %cmp.us, label %for.cond.for.cond2_crit_edge.us, label %for.end12.loopexit
