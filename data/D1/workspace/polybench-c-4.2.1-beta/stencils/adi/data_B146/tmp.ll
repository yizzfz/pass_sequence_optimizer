...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge.preheader
  %indvars.iv4 = phi i64 [ 0, %._crit_edge.preheader ], [ %indvars.iv.next.1, %._crit_edge ]
...
; <label>:14:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond1, label %15, label %._crit_edge.preheader
...
define internal fastcc void @kernel_adi([1000 x double]*, [1000 x double]*, [1000 x double]*, [1000 x double]*) unnamed_addr #0 {
  br label %._crit_edge.preheader..lr.ph_crit_edge

._crit_edge.preheader..lr.ph_crit_edge:           ; preds = %._crit_edge4._crit_edge, %4
  %.0324 = phi i32 [ 1, %4 ], [ %154, %._crit_edge4._crit_edge ]
  br label %._crit_edge25.lver.check

._crit_edge25.lver.check:                         ; preds = %._crit_edge, %._crit_edge.preheader..lr.ph_crit_edge
  %indvar = phi i64 [ %5, %._crit_edge ], [ 0, %._crit_edge.preheader..lr.ph_crit_edge ]
  %indvars.iv719 = phi i64 [ %13, %._crit_edge ], [ 1, %._crit_edge.preheader..lr.ph_crit_edge ]
...
._crit_edge25.lver.orig:                          ; preds = %._crit_edge25.lver.orig.preheader, %._crit_edge25.lver.orig
  ...
  %36 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv719, i64 %indvars.iv17.lver.orig
...
._crit_edge25:                                    ; preds = %._crit_edge25, %._crit_edge25.ph
  ...
  %37 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv719, i64 %indvars.iv17
  ...
  %54 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv719, i64 %indvars.iv17
...
; <label>:55:                                     ; preds = %.loopexit36, %.loopexit35
  %56 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 999, i64 %indvars.iv719
  store double 1.000000e+00, double* %56, align 8
  br label %57

; <label>:57:                                     ; preds = %57, %55
  %58 = phi double [ 1.000000e+00, %55 ], [ %71, %57 ]
  %indvars.iv518 = phi i64 [ 998, %55 ], [ %indvars.iv.next6.1, %57 ]
  %59 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv719, i64 %indvars.iv518
  %60 = load double, double* %59, align 8
  %61 = fmul double %60, %58
  %62 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv719, i64 %indvars.iv518
  %63 = load double, double* %62, align 8
  %64 = fadd double %61, %63
  %65 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv518, i64 %indvars.iv719
  store double %64, double* %65, align 8
  %indvars.iv.next6 = add nsw i64 %indvars.iv518, -1
  %66 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv719, i64 %indvars.iv.next6
  %67 = load double, double* %66, align 8
  %68 = fmul double %67, %64
  %69 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv719, i64 %indvars.iv.next6
  %70 = load double, double* %69, align 8
  %71 = fadd double %68, %70
  %72 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv.next6, i64 %indvars.iv719
  store double %71, double* %72, align 8
  %73 = icmp sgt i64 %indvars.iv.next6, 1
  %indvars.iv.next6.1 = add nsw i64 %indvars.iv518, -2
  br i1 %73, label %57, label %._crit_edge

._crit_edge:                                      ; preds = %57
  %exitcond1 = icmp eq i64 %13, 999
  br i1 %exitcond1, label %._crit_edge27.lver.check.preheader, label %._crit_edge25.lver.check

._crit_edge27.lver.check.preheader:               ; preds = %._crit_edge
  br label %._crit_edge27.lver.check

._crit_edge27.lver.check:                         ; preds = %._crit_edge27.lver.check.preheader, %._crit_edge4
  %indvar14 = phi i64 [ %74, %._crit_edge4 ], [ 0, %._crit_edge27.lver.check.preheader ]
  %indvars.iv1522 = phi i64 [ %83, %._crit_edge4 ], [ 1, %._crit_edge27.lver.check.preheader ]
  %74 = add nuw nsw i64 %indvar14, 1
  ...
  %75 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv1522
  %76 = getelementptr inbounds [1000 x double], [1000 x double]* %75, i64 0, i64 0
  store double 1.000000e+00, double* %76, align 8
  %77 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv1522, i64 0
  store double 0.000000e+00, double* %77, align 8
  %78 = bitcast [1000 x double]* %75 to i64*
  %79 = load i64, i64* %78, align 8
  %80 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv1522
  %81 = bitcast [1000 x double]* %80 to i64*
  store i64 %79, i64* %81, align 8
  %82 = add nsw i64 %indvars.iv1522, -1
  %83 = add nuw nsw i64 %indvars.iv1522, 1
...
._crit_edge27.lver.orig:                          ; preds = %._crit_edge27.lver.orig.preheader, %._crit_edge27.lver.orig
  %indvars.iv920.lver.orig = phi i64 [ %indvars.iv.next10.lver.orig, %._crit_edge27.lver.orig ], [ 1, %._crit_edge27.lver.orig.preheader ]
  %84 = add nsw i64 %indvars.iv920.lver.orig, -1
  %85 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv1522, i64 %84
  %86 = load double, double* %85, align 8
  %87 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv1522, i64 %indvars.iv920.lver.orig
  %88 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %82, i64 %indvars.iv920.lver.orig
  %89 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv1522, i64 %indvars.iv920.lver.orig
  %90 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %83, i64 %indvars.iv920.lver.orig
  %91 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv1522, i64 %84
  ...
  %111 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv1522, i64 %indvars.iv920.lver.orig
  ...
  br i1 %exitcond12.lver.orig, label %.loopexit, label %._crit_edge27.lver.orig
...
._crit_edge27:                                    ; preds = %._crit_edge27, %._crit_edge27.ph
  ...
  %indvars.iv920 = phi i64 [ 1, %._crit_edge27.ph ], [ %indvars.iv.next10, %._crit_edge27 ]
  %112 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv1522, i64 %indvars.iv920
  %113 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %82, i64 %indvars.iv920
  %114 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv1522, i64 %indvars.iv920
  %115 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %83, i64 %indvars.iv920
  ...
  %134 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv1522, i64 %indvars.iv920
  ...
  br i1 %exitcond12, label %.loopexit34, label %._crit_edge27
...
; <label>:135:                                    ; preds = %.loopexit34, %.loopexit
  %136 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv1522, i64 999
  store double 1.000000e+00, double* %136, align 8
  br label %137

; <label>:137:                                    ; preds = %137, %135
  %138 = phi double [ 1.000000e+00, %135 ], [ %151, %137 ]
  %indvars.iv1321 = phi i64 [ 998, %135 ], [ %indvars.iv.next14.1, %137 ]
  %139 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv1522, i64 %indvars.iv1321
  %140 = load double, double* %139, align 8
  %141 = fmul double %140, %138
  %142 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv1522, i64 %indvars.iv1321
  %143 = load double, double* %142, align 8
  %144 = fadd double %141, %143
  %145 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv1522, i64 %indvars.iv1321
  store double %144, double* %145, align 8
  %indvars.iv.next14 = add nsw i64 %indvars.iv1321, -1
  %146 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv1522, i64 %indvars.iv.next14
  %147 = load double, double* %146, align 8
  %148 = fmul double %147, %144
  %149 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv1522, i64 %indvars.iv.next14
  %150 = load double, double* %149, align 8
  %151 = fadd double %148, %150
  %152 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv1522, i64 %indvars.iv.next14
  store double %151, double* %152, align 8
  %153 = icmp sgt i64 %indvars.iv.next14, 1
  %indvars.iv.next14.1 = add nsw i64 %indvars.iv1321, -2
  br i1 %153, label %137, label %._crit_edge4

._crit_edge4:                                     ; preds = %137
  %exitcond2 = icmp eq i64 %83, 999
  br i1 %exitcond2, label %._crit_edge4._crit_edge, label %._crit_edge27.lver.check

._crit_edge4._crit_edge:                          ; preds = %._crit_edge4
  %154 = add nuw nsw i32 %.0324, 1
  %exitcond37 = icmp eq i32 %154, 501
  br i1 %exitcond37, label %155, label %._crit_edge.preheader..lr.ph_crit_edge

; <label>:155:                                    ; preds = %._crit_edge4._crit_edge
  ret void
}
...
._crit_edge.preheader:                            ; preds = %17, %1
  %indvars.iv36 = phi i64 [ 0, %1 ], [ %indvars.iv.next4, %17 ]
  %6 = mul nuw nsw i64 %indvars.iv36, 1000
  br label %._crit_edge2._crit_edge

._crit_edge2._crit_edge:                          ; preds = %._crit_edge2, %._crit_edge.preheader
  %indvars.iv5 = phi i64 [ 0, %._crit_edge.preheader ], [ %indvars.iv.next, %._crit_edge2 ]
...
._crit_edge2:                                     ; preds = %._crit_edge2._crit_edge, %11
  ...
  %14 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv36, i64 %indvars.iv5
...
; <label>:17:                                     ; preds = %._crit_edge2
  ...
  br i1 %exitcond1, label %18, label %._crit_edge.preheader
