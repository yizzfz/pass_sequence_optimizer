...
for.body7:                                        ; preds = %for.body7, %for.body
  ...
  %mul24 = fmul double %5, %6
  %sunkaddr21 = ptrtoint double* %y to i64
  %sunkaddr22 = shl i64 %indvars.iv14, 3
  %sunkaddr23 = add i64 %sunkaddr21, %sunkaddr22
  %sunkaddr24 = inttoptr i64 %sunkaddr23 to double*
  %7 = load double, double* %sunkaddr24, align 8
  %add27 = fadd double %mul24, %7
  store double %add27, double* %sunkaddr24, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv3, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
  br i1 %exitcond, label %for.end, label %for.body7

for.end:                                          ; preds = %for.body7
  %sunkaddr11 = shl i64 %indvars.iv14, 3
  %sunkaddr12 = add i64 %1, %sunkaddr11
  %sunkaddr13 = inttoptr i64 %sunkaddr12 to double*
  %8 = load double, double* %sunkaddr13, align 8
  %mul32 = fmul double %8, %alpha
  %sunkaddr15 = shl i64 %indvars.iv14, 3
  %sunkaddr16 = add i64 %0, %sunkaddr15
  %sunkaddr17 = inttoptr i64 %sunkaddr16 to double*
  %9 = load double, double* %sunkaddr17, align 8
  %mul35 = fmul double %9, %beta
