...
for.inc:                                          ; preds = %for.inc, %for.body.new
  %indvars.iv = phi i64 [ 0, %for.body.new ], [ %indvars.iv.next.1, %for.inc ]
...
for.inc34:                                        ; preds = %for.inc
  ...
  br i1 %12, label %for.end36, label %for.body.new
...
for.body.new:                                     ; preds = %for.inc12, %for.body.preheader
  ...
  %arrayidx = getelementptr inbounds double, double* %x1, i64 %indvars.iv27
  %.pre = load double, double* %arrayidx, align 8
  %sunkaddr1 = mul nuw nsw i64 %indvars.iv27, 8
  %sunkaddr2 = add i64 %sunkaddr, %sunkaddr1
  %sunkaddr3 = inttoptr i64 %sunkaddr2 to double*
  br label %for.inc

for.inc:                                          ; preds = %for.inc, %for.body.new
  %indvars.iv23 = phi i64 [ 0, %for.body.new ], [ %indvars.iv.next24.1, %for.inc ]
  %0 = phi double [ %.pre, %for.body.new ], [ %add.1, %for.inc ]
  %arrayidx7 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv27, i64 %indvars.iv23
  %1 = load double, double* %arrayidx7, align 8
  %arrayidx9 = getelementptr inbounds double, double* %y_1, i64 %indvars.iv23
  ...
  %arrayidx7.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv27, i64 %indvars.iv.next24
  %3 = load double, double* %arrayidx7.1, align 8
  %arrayidx9.1 = getelementptr inbounds double, double* %y_1, i64 %indvars.iv.next24
  ...
  br i1 %exitcond26.1, label %for.inc12, label %for.inc

for.inc12:                                        ; preds = %for.inc
  %indvars.iv.next28 = add nuw nsw i64 %indvars.iv27, 1
  %exitcond30 = icmp eq i64 %indvars.iv.next28, 2000
  br i1 %exitcond30, label %for.body17.preheader, label %for.body.new
...
for.body17:                                       ; preds = %for.body17.preheader, %for.inc36
  ...
  %sunkaddr5 = mul nuw nsw i64 %indvars.iv19, 8
...
for.inc33:                                        ; preds = %for.inc33, %for.body17
  ...
  %5 = phi double [ %add30.1, %for.inc33 ], [ %.pre18, %for.body17 ]
