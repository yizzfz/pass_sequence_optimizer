...
for.inc:                                          ; preds = %for.inc, %for.body
  %indvars.iv19 = phi i64 [ %indvars.iv.next20.1, %for.inc ], [ 0, %for.body ]
  ...
  br i1 %exitcond22.1, label %for.inc12, label %for.inc

for.inc12:                                        ; preds = %for.inc
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  %exitcond30 = icmp eq i64 %indvars.iv.next24, 2000
  br i1 %exitcond30, label %for.body17.preheader, label %for.body
...
for.inc33:                                        ; preds = %for.inc33, %for.body17
  ...
  %5 = phi double [ %add30.1, %for.inc33 ], [ %.pre14, %for.body17 ]
