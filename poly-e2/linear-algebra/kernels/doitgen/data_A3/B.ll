...
for.cond1.preheader:                              ; preds = %for.cond1.preheader.lr.ph, %for.inc42
  %storemerge36 = phi i32 [ 0, %for.cond1.preheader.lr.ph ], [ %inc43, %for.inc42 ]
...
for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.inc39.us
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc39.us ], [ 0, %for.cond4.preheader.us.preheader ]
  %15 = phi i32 [ %split9.us, %for.inc39.us ], [ %storemerge36, %for.cond4.preheader.us.preheader ]
...
for.body27.us:                                    ; preds = %for.body27.us.preheader, %for.body27.us
  ...
  br i1 %exitcond60.3, label %for.inc39.us.loopexit, label %for.body27.us
...
for.cond4.preheader:                              ; preds = %for.cond4.preheader.preheader, %for.inc39
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc39 ], [ 0, %for.cond4.preheader.preheader ]
...
for.inc39:                                        ; preds = %for.inc39.loopexit, %for.body27.prol.loopexit, %for.cond4.preheader
  ...
  br i1 %exitcond43, label %for.inc42.loopexit81, label %for.cond4.preheader
...
for.inc42:                                        ; preds = %for.inc42.loopexit81, %for.inc42.loopexit, %for.cond1.preheader
  %.lcssa6 = phi i32 [ %storemerge36, %for.cond1.preheader ], [ %split9.us, %for.inc42.loopexit ], [ %storemerge36, %for.inc42.loopexit81 ]
...
for.body6:                                        ; preds = %for.body6, %for.cond4.preheader
  ...
  br i1 %exitcond15.1, label %for.inc12, label %for.body6
