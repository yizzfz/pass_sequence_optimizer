...
.preheader4:                                      ; preds = %.preheader._crit_edge, %4
  %.0319 = phi i32 [ 1, %4 ], [ %151, %.preheader._crit_edge ]
  br label %._crit_edge21.us.lver.check

._crit_edge21.us.lver.check:                      ; preds = %36, %.preheader4
  ...
  br i1 %memcheck.conflict, label %._crit_edge21.us.lver.orig.preheader, label %._crit_edge21.us.ph

._crit_edge21.us.lver.orig.preheader:             ; preds = %._crit_edge21.us.lver.check
  br label %._crit_edge21.us.lver.orig

._crit_edge21.us.lver.orig:                       ; preds = %._crit_edge21.us.lver.orig.preheader, %._crit_edge21.us.lver.orig
  %indvars.iv.lver.orig = phi i64 [ %indvars.iv.next.lver.orig, %._crit_edge21.us.lver.orig ], [ 1, %._crit_edge21.us.lver.orig.preheader ]
  ...
  br i1 %exitcond.lver.orig, label %._crit_edge.us.loopexit, label %._crit_edge21.us.lver.orig

._crit_edge21.us.ph:                              ; preds = %._crit_edge21.us.lver.check
  %load_initial = load double, double* %scevgep, align 8
  %load_initial23 = load double, double* %scevgep17, align 8
  br label %._crit_edge21.us

; <label>:36:                                     ; preds = %._crit_edge22.us
  %exitcond12 = icmp eq i64 %indvars.iv.next4, 999
  br i1 %exitcond12, label %._crit_edge25.us.lver.check.preheader, label %._crit_edge21.us.lver.check

._crit_edge25.us.lver.check.preheader:            ; preds = %36
  br label %._crit_edge25.us.lver.check

._crit_edge22.us:                                 ; preds = %._crit_edge22.us, %._crit_edge.us
  %indvars.iv1 = phi i64 [ 998, %._crit_edge.us ], [ %indvars.iv.next2.1, %._crit_edge22.us ]
  %37 = phi double [ 1.000000e+00, %._crit_edge.us ], [ %50, %._crit_edge22.us ]
  ...
  br i1 %52, label %._crit_edge22.us, label %36

._crit_edge21.us:                                 ; preds = %._crit_edge21.us, %._crit_edge21.us.ph
  %store_forwarded24 = phi double [ %load_initial23, %._crit_edge21.us.ph ], [ %69, %._crit_edge21.us ]
  %store_forwarded = phi double [ %load_initial, %._crit_edge21.us.ph ], [ %57, %._crit_edge21.us ]
  %indvars.iv = phi i64 [ 1, %._crit_edge21.us.ph ], [ %indvars.iv.next, %._crit_edge21.us ]
  ...
  %67 = fmul double %store_forwarded24, 0xC09F400000000001
  ...
  br i1 %exitcond, label %._crit_edge.us.loopexit46, label %._crit_edge21.us

._crit_edge.us.loopexit:                          ; preds = %._crit_edge21.us.lver.orig
  br label %._crit_edge.us

._crit_edge.us.loopexit46:                        ; preds = %._crit_edge21.us
  br label %._crit_edge.us
...
._crit_edge25.us.lver.check:                      ; preds = %._crit_edge25.us.lver.check.preheader, %109
  %indvar25 = phi i64 [ %72, %109 ], [ 0, %._crit_edge25.us.lver.check.preheader ]
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %109 ], [ 1, %._crit_edge25.us.lver.check.preheader ]
  %72 = add i64 %indvar25, 1
  %scevgep27 = getelementptr [1000 x double], [1000 x double]* %2, i64 %72, i64 0
  %scevgep29 = getelementptr [1000 x double], [1000 x double]* %2, i64 %72, i64 999
  %scevgep31 = getelementptr [1000 x double], [1000 x double]* %3, i64 %72, i64 0
  %scevgep33 = getelementptr [1000 x double], [1000 x double]* %3, i64 %72, i64 999
  %73 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv10
  %74 = getelementptr inbounds [1000 x double], [1000 x double]* %73, i64 0, i64 0
  store double 1.000000e+00, double* %74, align 8
  %75 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv10, i64 0
  store double 0.000000e+00, double* %75, align 8
  %76 = bitcast [1000 x double]* %73 to i64*
  %77 = load i64, i64* %76, align 8
  %78 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv10
  %79 = bitcast [1000 x double]* %78 to i64*
  store i64 %77, i64* %79, align 8
  %80 = add nsw i64 %indvars.iv10, -1
  ...
  br i1 %memcheck.conflict38, label %._crit_edge25.us.lver.orig.preheader, label %._crit_edge25.us.ph

._crit_edge25.us.lver.orig.preheader:             ; preds = %._crit_edge25.us.lver.check
  br label %._crit_edge25.us.lver.orig

._crit_edge25.us.lver.orig:                       ; preds = %._crit_edge25.us.lver.orig.preheader, %._crit_edge25.us.lver.orig
  %indvars.iv5.lver.orig = phi i64 [ %indvars.iv.next6.lver.orig, %._crit_edge25.us.lver.orig ], [ 1, %._crit_edge25.us.lver.orig.preheader ]
  %81 = add nsw i64 %indvars.iv5.lver.orig, -1
  %82 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv10, i64 %81
  %83 = load double, double* %82, align 8
  %84 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv10, i64 %indvars.iv5.lver.orig
  %85 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %80, i64 %indvars.iv5.lver.orig
  %86 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv10, i64 %indvars.iv5.lver.orig
  %87 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv.next11, i64 %indvars.iv5.lver.orig
  %88 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv10, i64 %81
  ...
  %108 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv10, i64 %indvars.iv5.lver.orig
  ...
  br i1 %exitcond7.lver.orig, label %._crit_edge13.us.loopexit, label %._crit_edge25.us.lver.orig

._crit_edge25.us.ph:                              ; preds = %._crit_edge25.us.lver.check
  %load_initial40 = load double, double* %scevgep27, align 8
  %load_initial43 = load double, double* %scevgep31, align 8
  br label %._crit_edge25.us

; <label>:109:                                    ; preds = %._crit_edge26.us
  %exitcond13 = icmp eq i64 %indvars.iv.next11, 999
  br i1 %exitcond13, label %.preheader._crit_edge, label %._crit_edge25.us.lver.check

._crit_edge26.us:                                 ; preds = %._crit_edge26.us, %._crit_edge13.us
  %indvars.iv8 = phi i64 [ 998, %._crit_edge13.us ], [ %indvars.iv.next9.1, %._crit_edge26.us ]
  %110 = phi double [ 1.000000e+00, %._crit_edge13.us ], [ %123, %._crit_edge26.us ]
  %111 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv10, i64 %indvars.iv8
  %112 = load double, double* %111, align 8
  %113 = fmul double %112, %110
  %114 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv10, i64 %indvars.iv8
  %115 = load double, double* %114, align 8
  %116 = fadd double %113, %115
  %117 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv10, i64 %indvars.iv8
  store double %116, double* %117, align 8
  %indvars.iv.next9 = add nsw i64 %indvars.iv8, -1
  %118 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv10, i64 %indvars.iv.next9
  %119 = load double, double* %118, align 8
  %120 = fmul double %119, %116
  %121 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv10, i64 %indvars.iv.next9
  %122 = load double, double* %121, align 8
  %123 = fadd double %120, %122
  %124 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv10, i64 %indvars.iv.next9
  store double %123, double* %124, align 8
  %125 = icmp sgt i64 %indvars.iv.next9, 1
  %indvars.iv.next9.1 = add nsw i64 %indvars.iv8, -2
  br i1 %125, label %._crit_edge26.us, label %109

._crit_edge25.us:                                 ; preds = %._crit_edge25.us, %._crit_edge25.us.ph
  %store_forwarded44 = phi double [ %load_initial43, %._crit_edge25.us.ph ], [ %147, %._crit_edge25.us ]
  %store_forwarded41 = phi double [ %load_initial40, %._crit_edge25.us.ph ], [ %136, %._crit_edge25.us ]
  %indvars.iv5 = phi i64 [ 1, %._crit_edge25.us.ph ], [ %indvars.iv.next6, %._crit_edge25.us ]
  %126 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv10, i64 %indvars.iv5
  %127 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %80, i64 %indvars.iv5
  %128 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv10, i64 %indvars.iv5
  %129 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv.next11, i64 %indvars.iv5
  %130 = insertelement <2 x double> undef, double %store_forwarded41, i32 0
  ...
  %145 = fmul double %store_forwarded44, 0xC08F400000000001
  %146 = fsub double %144, %145
  %147 = fdiv double %146, %135
  %148 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv10, i64 %indvars.iv5
  store double %147, double* %148, align 8
  %exitcond7 = icmp eq i64 %indvars.iv5, 998
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1
  br i1 %exitcond7, label %._crit_edge13.us.loopexit45, label %._crit_edge25.us

._crit_edge13.us.loopexit:                        ; preds = %._crit_edge25.us.lver.orig
  br label %._crit_edge13.us

._crit_edge13.us.loopexit45:                      ; preds = %._crit_edge25.us
  br label %._crit_edge13.us

._crit_edge13.us:                                 ; preds = %._crit_edge13.us.loopexit45, %._crit_edge13.us.loopexit
  %149 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv10, i64 999
  store double 1.000000e+00, double* %149, align 8
  br label %._crit_edge26.us

.preheader._crit_edge:                            ; preds = %109
  %150 = icmp sgt i32 %.0319, 499
  %151 = add nuw nsw i32 %.0319, 1
  br i1 %150, label %152, label %.preheader4

; <label>:152:                                    ; preds = %.preheader._crit_edge
  ret void
}
