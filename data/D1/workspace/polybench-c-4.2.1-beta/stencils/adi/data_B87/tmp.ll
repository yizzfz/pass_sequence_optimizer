...
.lver.check65:                                    ; preds = %.lver.check65.preheader, %._crit_edge19.us
  ...
  %75 = bitcast [1000 x double]* %74 to double*
...
; <label>:126:                                    ; preds = %126, %.ph66
  %store_forwarded72 = phi double [ %load_initial71, %.ph66 ], [ %148, %126 ]
  %store_forwarded69 = phi double [ %load_initial68, %.ph66 ], [ %137, %126 ]
  %indvars.iv30 = phi i64 [ 1, %.ph66 ], [ %indvars.iv.next31, %126 ]
  ...
  br i1 %exitcond33, label %._crit_edge15.us.loopexit75, label %126

._crit_edge15.us.loopexit:                        ; preds = %.ph66.lver.orig
  br label %._crit_edge15.us

._crit_edge15.us.loopexit75:                      ; preds = %126
  br label %._crit_edge15.us
...
._crit_edge22:                                    ; preds = %._crit_edge19.us
  ...
  br i1 %151, label %.preheader4, label %._crit_edge24
