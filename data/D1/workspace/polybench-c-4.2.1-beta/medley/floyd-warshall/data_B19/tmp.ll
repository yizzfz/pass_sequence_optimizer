...
.preheader:                                       ; preds = %18, %1
  %indvars.iv20 = phi i64 [ 0, %1 ], [ %indvars.iv.next21, %18 ]
  br label %2
...
; <label>:2:                                      ; preds = %2, %.preheader
  ...
  %5 = srem i32 %4, 7
  %6 = add nsw i32 %5, 1
  %7 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv20, i64 %indvars.iv
...
; <label>:18:                                     ; preds = %2
  ...
  br i1 %exitcond22, label %19, label %.preheader
...
.preheader24:                                     ; preds = %19, %1
  %indvars.iv30 = phi i64 [ 0, %1 ], [ %indvars.iv.next31, %19 ]
  br label %.preheader

.preheader:                                       ; preds = %18, %.preheader24
  %indvars.iv28 = phi i64 [ 0, %.preheader24 ], [ %indvars.iv.next29, %18 ]
  %2 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv28, i64 %indvars.iv30
  br label %3

; <label>:3:                                      ; preds = %3, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %3 ]
  %4 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv28, i64 %indvars.iv
  %5 = load i32, i32* %4, align 4
  %6 = load i32, i32* %2, align 4
  %7 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv30, i64 %indvars.iv
  ...
  %11 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv28, i64 %indvars.iv.next
  %12 = load i32, i32* %11, align 4
  %13 = load i32, i32* %2, align 4
  %14 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv30, i64 %indvars.iv.next
...
; <label>:14:                                     ; preds = %12, %7
  ...
  %16 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv11, i64 %indvars.iv
