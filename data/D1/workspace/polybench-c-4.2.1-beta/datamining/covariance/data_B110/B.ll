...
.lr.ph24.split.us:                                ; preds = %._crit_edge21.us, %.lr.ph24.split.us.preheader
  ...
  %sunkaddr100 = shl i64 %indvars.iv67, 3
  %sunkaddr101 = add i64 %4, %sunkaddr100
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph24.split.us
  ...
  store double %15, double* %sunkaddr102, align 8
  ...
  store double %18, double* %sunkaddr102, align 8
  ...
  store double %21, double* %sunkaddr102, align 8
  %indvars.iv.next64.4 = add nuw nsw i64 %indvars.iv63, 5
  %exitcond81.4 = icmp eq i64 %indvars.iv.next64.4, 1400
  br i1 %exitcond81.4, label %._crit_edge21.us, label %._crit_edge

._crit_edge21.us:                                 ; preds = %._crit_edge
  %22 = fdiv double %21, %0
  %sunkaddr26 = shl i64 %indvars.iv67, 3
  ...
  br i1 %exitcond82, label %._crit_edge21.us..preheader6.us_crit_edge, label %.lr.ph24.split.us
...
vector.memcheck:                                  ; preds = %._crit_edge16.us, %._crit_edge21.us..preheader6.us_crit_edge
  ...
  %scevgep11 = getelementptr [1200 x double], [1200 x double]* %1, i64 %23, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck.vector.body_crit_edge
  ...
  %wide.vec18 = load <8 x double>, <8 x double>* %27, align 8, !alias.scope !4, !noalias !1
  %28 = fsub <8 x double> %wide.vec18, %wide.vec
  ...
  br i1 %39, label %._crit_edge16.us.loopexit29, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph, %vector.memcheck.scalar.ph_crit_edge
  %indvars.iv54 = phi i64 [ 0, %vector.memcheck.scalar.ph_crit_edge ], [ %indvars.iv.next55.3, %scalar.ph ]
  ...
  br i1 %exitcond79.3, label %._crit_edge16.us.loopexit, label %scalar.ph, !llvm.loop !9

._crit_edge16.us.loopexit:                        ; preds = %scalar.ph
  br label %._crit_edge16.us

._crit_edge16.us.loopexit29:                      ; preds = %vector.body
  br label %._crit_edge16.us

._crit_edge16.us:                                 ; preds = %._crit_edge16.us.loopexit29, %._crit_edge16.us.loopexit
  %exitcond80 = icmp eq i64 %23, 1400
  br i1 %exitcond80, label %.preheader.us.preheader, label %vector.memcheck
...
._crit_edge24:                                    ; preds = %._crit_edge24, %.lr.ph.us.us
  %64 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %76, %._crit_edge24 ]
  ...
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond77.1 = icmp eq i64 %indvars.iv.next.1, 1400
  br i1 %exitcond77.1, label %._crit_edge.us.us, label %._crit_edge24
