...
@__llvm_prf_nm = private constant [251 x i8] c"\F8\01\00jinit_d_coef_controller\01tmp1.ll:start_input_pass\01tmp1.ll:start_output_pass\01tmp1.ll:consume_data\01tmp1.ll:decompress_data\01tmp1.ll:dummy_consume_data\01tmp1.ll:decompress_onepass\01tmp1.ll:start_iMCU_row\01tmp1.ll:smoothing_ok\01tmp1.ll:decompress_smooth_data", section "__llvm_prf_names"
@llvm.used = appending global [12 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jinit_d_coef_controller to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_start_input_pass to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_start_output_pass to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_consume_data to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_decompress_data to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_dummy_consume_data to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_decompress_onepass to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_start_iMCU_row to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_smoothing_ok to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_decompress_smooth_data to i8*), i8* bitcast ([17 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([251 x i8], [251 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
