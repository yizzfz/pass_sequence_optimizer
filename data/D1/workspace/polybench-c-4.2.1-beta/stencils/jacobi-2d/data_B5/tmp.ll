...
.preheader4.us:                                   ; preds = %._crit_edge.us..preheader4.us_crit_edge, %.preheader6
  %indvar52 = phi i64 [ 0, %.preheader6 ], [ %indvar.next53, %._crit_edge.us..preheader4.us_crit_edge ]
  %indvars.iv16 = phi i64 [ 1, %.preheader6 ], [ %indvars.iv.next17, %._crit_edge.us..preheader4.us_crit_edge ]
  %4 = add i64 %indvar52, 1
  %scevgep54 = getelementptr [1300 x double], [1300 x double]* %3, i64 %4, i64 1
  %scevgep56 = getelementptr [1300 x double], [1300 x double]* %3, i64 %4, i64 1299
  %scevgep58 = getelementptr [1300 x double], [1300 x double]* %2, i64 %indvar52, i64 1
  %5 = add i64 %indvar52, 2
  %scevgep60 = getelementptr [1300 x double], [1300 x double]* %2, i64 %5, i64 1299
  ...
  br i1 %memcheck.conflict65, label %._crit_edge.preheader, label %vector.body47.preheader

vector.body47.preheader:                          ; preds = %.preheader4.us
  br label %vector.body47

vector.body47:                                    ; preds = %vector.body47.preheader, %vector.body47
  %index68 = phi i64 [ %index.next69, %vector.body47 ], [ 0, %vector.body47.preheader ]
  %offset.idx72 = or i64 %index68, 1
  %7 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv16, i64 %offset.idx72
  ...
  %16 = fadd <2 x double> %wide.load77, %wide.load79
  %17 = fadd <2 x double> %wide.load78, %wide.load80
  %18 = add nuw nsw i64 %offset.idx72, 1
  ...
  %wide.load82 = load <2 x double>, <2 x double>* %22, align 8, !alias.scope !1
  %23 = fadd <2 x double> %16, %wide.load81
  %24 = fadd <2 x double> %17, %wide.load82
  %25 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv.next17, i64 %offset.idx72
  %26 = bitcast double* %25 to <2 x double>*
  %wide.load83 = load <2 x double>, <2 x double>* %26, align 8, !alias.scope !1
  %27 = getelementptr double, double* %25, i64 2
  %28 = bitcast double* %27 to <2 x double>*
  %wide.load84 = load <2 x double>, <2 x double>* %28, align 8, !alias.scope !1
  %29 = fadd <2 x double> %23, %wide.load83
  %30 = fadd <2 x double> %24, %wide.load84
  %31 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %6, i64 %offset.idx72
  %32 = bitcast double* %31 to <2 x double>*
  %wide.load85 = load <2 x double>, <2 x double>* %32, align 8, !alias.scope !1
  %33 = getelementptr double, double* %31, i64 2
  %34 = bitcast double* %33 to <2 x double>*
  %wide.load86 = load <2 x double>, <2 x double>* %34, align 8, !alias.scope !1
  %35 = fadd <2 x double> %29, %wide.load85
  %36 = fadd <2 x double> %30, %wide.load86
  ...
  %39 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv16, i64 %offset.idx72
  ...
  %43 = icmp eq i64 %index.next69, 1296
  br i1 %43, label %._crit_edge.preheader.loopexit, label %vector.body47, !llvm.loop !6

._crit_edge.preheader.loopexit:                   ; preds = %vector.body47
...
._crit_edge.us:                                   ; preds = %._crit_edge
  ...
  br i1 %exitcond19, label %.preheader.us.preheader, label %._crit_edge.us..preheader4.us_crit_edge
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge11.us..preheader.us_crit_edge
  %indvar = phi i64 [ %indvar.next, %._crit_edge11.us..preheader.us_crit_edge ], [ 0, %.preheader.us.preheader ]
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %._crit_edge11.us..preheader.us_crit_edge ], [ 1, %.preheader.us.preheader ]
  %61 = add i64 %indvar, 1
  %scevgep = getelementptr [1300 x double], [1300 x double]* %2, i64 %61, i64 1
  %scevgep31 = getelementptr [1300 x double], [1300 x double]* %2, i64 %61, i64 1299
  %scevgep33 = getelementptr [1300 x double], [1300 x double]* %3, i64 %indvar, i64 1
  %62 = add i64 %indvar, 2
  %scevgep35 = getelementptr [1300 x double], [1300 x double]* %3, i64 %62, i64 1299
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %73 = fadd <2 x double> %wide.load, %wide.load39
  %74 = fadd <2 x double> %wide.load38, %wide.load40
  %75 = add nuw nsw i64 %offset.idx, 1
  %76 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv24, i64 %75
  %77 = bitcast double* %76 to <2 x double>*
  %wide.load41 = load <2 x double>, <2 x double>* %77, align 8, !alias.scope !10
  %78 = getelementptr double, double* %76, i64 2
  %79 = bitcast double* %78 to <2 x double>*
  %wide.load42 = load <2 x double>, <2 x double>* %79, align 8, !alias.scope !10
  %80 = fadd <2 x double> %73, %wide.load41
  %81 = fadd <2 x double> %74, %wide.load42
  %82 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv.next25, i64 %offset.idx
  %83 = bitcast double* %82 to <2 x double>*
  %wide.load43 = load <2 x double>, <2 x double>* %83, align 8, !alias.scope !10
  %84 = getelementptr double, double* %82, i64 2
  %85 = bitcast double* %84 to <2 x double>*
  %wide.load44 = load <2 x double>, <2 x double>* %85, align 8, !alias.scope !10
  %86 = fadd <2 x double> %80, %wide.load43
  %87 = fadd <2 x double> %81, %wide.load44
  %88 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %63, i64 %offset.idx
  %89 = bitcast double* %88 to <2 x double>*
  %wide.load45 = load <2 x double>, <2 x double>* %89, align 8, !alias.scope !10
  %90 = getelementptr double, double* %88, i64 2
  %91 = bitcast double* %90 to <2 x double>*
  %wide.load46 = load <2 x double>, <2 x double>* %91, align 8, !alias.scope !10
  %92 = fadd <2 x double> %86, %wide.load45
  %93 = fadd <2 x double> %87, %wide.load46
  ...
  br i1 %100, label %._crit_edge29.preheader.loopexit, label %vector.body, !llvm.loop !15

._crit_edge29.preheader.loopexit:                 ; preds = %vector.body
  br label %._crit_edge29.preheader

._crit_edge29.preheader:                          ; preds = %._crit_edge29.preheader.loopexit, %.preheader.us
  %indvars.iv20.ph = phi i64 [ 1, %.preheader.us ], [ 1297, %._crit_edge29.preheader.loopexit ]
...
._crit_edge29:                                    ; preds = %._crit_edge29.preheader, %._crit_edge29
  ...
  br i1 %exitcond23, label %._crit_edge11.us, label %._crit_edge29, !llvm.loop !16

._crit_edge11.us:                                 ; preds = %._crit_edge29
  %exitcond27 = icmp eq i64 %indvars.iv.next25, 1299
  br i1 %exitcond27, label %._crit_edge13, label %._crit_edge11.us..preheader.us_crit_edge
