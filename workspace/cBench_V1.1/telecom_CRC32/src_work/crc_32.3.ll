...
@__llvm_prf_nm = private constant [41 x i8] c"$'x\DA+-HI,Iu\0Er66bL.J66J\CB\CCI\85\B0\92J\D3\18s\133\F3\0C\01\DB\E4\0B\B1", section "__llvm_prf_names"
@llvm.used = appending global [5 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_updateCRC32 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_crc32file to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_crc32buf to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_main1 to i8*), i8* getelementptr inbounds ([41 x i8], [41 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
