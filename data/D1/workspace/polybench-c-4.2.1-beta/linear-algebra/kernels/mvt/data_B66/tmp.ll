...
; <label>:6:                                      ; preds = %.loopexit, %5
  %indvars.iv35 = phi i64 [ 0, %5 ], [ %indvars.iv.next36, %.loopexit ]
  %7 = trunc i64 %indvars.iv35 to i32
  %8 = sitofp i32 %7 to double
  %9 = getelementptr inbounds double, double* %0, i64 %indvars.iv35
  %indvars.iv.next36 = add nuw nsw i64 %indvars.iv35, 1
  %10 = icmp eq i64 %indvars.iv.next36, 2000
  ...
  %16 = getelementptr inbounds double, double* %1, i64 %indvars.iv35
  store double %15, double* %16, align 8
  %17 = add nuw nsw i64 %indvars.iv35, 3
  %18 = trunc i64 %17 to i32
  %19 = srem i32 %18, 2000
  %20 = sitofp i32 %19 to double
  %21 = getelementptr inbounds double, double* %2, i64 %indvars.iv35
  %22 = add nuw nsw i64 %indvars.iv35, 4
  ...
  %31 = getelementptr inbounds double, double* %3, i64 %indvars.iv35
  store double %30, double* %31, align 8
  br label %32

; <label>:32:                                     ; preds = %32, %6
  %indvars.iv = phi i64 [ 0, %6 ], [ %indvars.iv.next.1, %32 ]
  %33 = mul nuw nsw i64 %indvars.iv, %indvars.iv35
  %34 = trunc i64 %33 to i32
  %35 = srem i32 %34, 2000
  %36 = sitofp i32 %35 to double
  %37 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 %indvars.iv35, i64 %indvars.iv
  %indvars.iv.next = or i64 %indvars.iv, 1
  %38 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv35
...
.preheader32:                                     ; preds = %21, %5
  %indvars.iv42 = phi i64 [ 0, %5 ], [ %indvars.iv.next43, %21 ]
  %6 = getelementptr inbounds double, double* %0, i64 %indvars.iv42
  %.pre = load double, double* %6, align 8
  br label %7

; <label>:7:                                      ; preds = %7, %.preheader32
  %8 = phi double [ %.pre, %.preheader32 ], [ %20, %7 ]
  %indvars.iv39 = phi i64 [ 0, %.preheader32 ], [ %indvars.iv.next40.1, %7 ]
  %9 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 %indvars.iv42, i64 %indvars.iv39
  %10 = load double, double* %9, align 8
  %11 = getelementptr inbounds double, double* %2, i64 %indvars.iv39
  %12 = load double, double* %11, align 8
  %13 = fmul double %10, %12
  %14 = fadd double %8, %13
  store double %14, double* %6, align 8
  %indvars.iv.next40 = or i64 %indvars.iv39, 1
  %15 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 %indvars.iv42, i64 %indvars.iv.next40
  %16 = load double, double* %15, align 8
  %17 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next40
  %18 = load double, double* %17, align 8
  %19 = fmul double %16, %18
  %20 = fadd double %14, %19
  store double %20, double* %6, align 8
  %indvars.iv.next40.1 = add nuw nsw i64 %indvars.iv39, 2
  %exitcond41.1 = icmp eq i64 %indvars.iv.next40.1, 2000
  br i1 %exitcond41.1, label %21, label %7

; <label>:21:                                     ; preds = %7
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1
  %exitcond44 = icmp eq i64 %indvars.iv.next43, 2000
  br i1 %exitcond44, label %.preheader.preheader, label %.preheader32

.preheader.preheader:                             ; preds = %21
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %37
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %37 ], [ 0, %.preheader.preheader ]
  %22 = getelementptr inbounds double, double* %1, i64 %indvars.iv37
  %.pre45 = load double, double* %22, align 8
  br label %23

; <label>:23:                                     ; preds = %23, %.preheader
  %24 = phi double [ %.pre45, %.preheader ], [ %36, %23 ]
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %23 ]
  %25 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 %indvars.iv, i64 %indvars.iv37
  ...
  %indvars.iv.next = or i64 %indvars.iv, 1
  %31 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 %indvars.iv.next, i64 %indvars.iv37
...
; <label>:7:                                      ; preds = %13, %2
  %indvars.iv17 = phi i64 [ 0, %2 ], [ %indvars.iv.next18, %13 ]
...
; <label>:11:                                     ; preds = %7
  ...
  %fputc14 = tail call i32 @fputc(i32 10, %struct._IO_FILE* %12) #5
  br label %13
...
; <label>:13:                                     ; preds = %11, %7
  ...
  br i1 %exitcond19, label %18, label %7
