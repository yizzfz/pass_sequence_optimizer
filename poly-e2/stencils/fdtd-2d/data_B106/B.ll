...
for.cond5.preheader.us:                           ; preds = %for.cond5.preheader.us.preheader, %for.cond5.for.inc39_crit_edge.us
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.cond5.for.inc39_crit_edge.us ], [ 0, %for.cond5.preheader.us.preheader ]
...
for.cond5.for.inc39_crit_edge.us:                 ; preds = %for.inc36.us
  ...
  br i1 %exitcond14, label %for.end41, label %for.cond5.preheader.us

for.inc:                                          ; preds = %for.inc, %entry
  %indvars.iv16 = phi i64 [ 0, %entry ], [ %indvars.iv.next17.4, %for.inc ]
  ...
  br i1 %exitcond19.4, label %for.cond5.preheader.us.preheader, label %for.inc
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal void @kernel_fdtd_2d([1200 x double]* %ex, [1200 x double]* %ey, [1200 x double]* nocapture %hz, double* %_fict_) #2 {
entry:
...
for.cond10.preheader.us:                          ; preds = %for.cond10.preheader.us.preheader, %for.cond10.for.inc34_crit_edge.us
  ...
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.cond10.for.inc34_crit_edge.us ], [ 1, %for.cond10.preheader.us.preheader ]
  %0 = add i64 %indvar, 1
  ...
  %sub.us = add nsw i64 %indvars.iv58, -1
...
vector.body58:                                    ; preds = %vector.body58.preheader, %vector.body58
  ...
  %2 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv58, i64 %index78
  ...
  %6 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv58, i64 %index78
  ...
  br i1 %20, label %for.cond10.for.inc34_crit_edge.us.loopexit114, label %vector.body58, !llvm.loop !6

for.inc31.us:                                     ; preds = %for.inc31.us, %for.inc31.us.preheader
  %indvars.iv54 = phi i64 [ 0, %for.inc31.us.preheader ], [ %indvars.iv.next55.1, %for.inc31.us ]
  ...
  br i1 %exitcond57.1, label %for.cond10.for.inc34_crit_edge.us.loopexit, label %for.inc31.us, !llvm.loop !9

for.cond10.for.inc34_crit_edge.us.loopexit:       ; preds = %for.inc31.us
  br label %for.cond10.for.inc34_crit_edge.us

for.cond10.for.inc34_crit_edge.us.loopexit114:    ; preds = %vector.body58
  br label %for.cond10.for.inc34_crit_edge.us

for.cond10.for.inc34_crit_edge.us:                ; preds = %for.cond10.for.inc34_crit_edge.us.loopexit114, %for.cond10.for.inc34_crit_edge.us.loopexit
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  %exitcond61 = icmp eq i64 %indvars.iv.next59, 1000
  br i1 %exitcond61, label %for.cond40.preheader.us.preheader, label %for.cond10.preheader.us
...
for.cond40.preheader.us:                          ; preds = %for.cond40.for.inc66_crit_edge.us, %for.cond40.preheader.us.preheader
  %indvars.iv67 = phi i64 [ %37, %for.cond40.for.inc66_crit_edge.us ], [ 0, %for.cond40.preheader.us.preheader ]
  %scevgep30 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv67, i64 1
  %37 = add i64 %indvars.iv67, 1
  %scevgep32 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %37, i64 0
  %scevgep34 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv67, i64 0
...
vector.body25:                                    ; preds = %vector.body25.preheader, %vector.body25
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv67, i64 %offset.idx
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv67, i64 %offset.idx
  ...
  %47 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv67, i64 %46
...
for.inc63.us.preheader.new:                       ; preds = %for.inc63.us.preheader.new.loopexit, %for.cond40.preheader.us
  %indvars.iv63.ph = phi i64 [ 1, %for.cond40.preheader.us ], [ 1197, %for.inc63.us.preheader.new.loopexit ]
  %arrayidx46.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv67, i64 %indvars.iv63.ph
  %58 = load double, double* %arrayidx46.us.prol, align 8
  %arrayidx50.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv67, i64 %indvars.iv63.ph
  %59 = load double, double* %arrayidx50.us.prol, align 8
  %sub53.us.prol = add nsw i64 %indvars.iv63.ph, -1
  %arrayidx55.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv67, i64 %sub53.us.prol
  %60 = load double, double* %arrayidx55.us.prol, align 8
  %sub56.us.prol = fsub double %59, %60
  ...
  %indvars.iv.next64.prol = add nuw nsw i64 %indvars.iv63.ph, 1
  br label %for.inc63.us

for.inc63.us:                                     ; preds = %for.inc63.us, %for.inc63.us.preheader.new
  %indvars.iv63 = phi i64 [ %indvars.iv.next64.prol, %for.inc63.us.preheader.new ], [ %indvars.iv.next64.1, %for.inc63.us ]
  %arrayidx46.us = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv67, i64 %indvars.iv63
  %61 = load double, double* %arrayidx46.us, align 8
  %arrayidx50.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv67, i64 %indvars.iv63
  %62 = load double, double* %arrayidx50.us, align 8
  %sub53.us = add nsw i64 %indvars.iv63, -1
  %arrayidx55.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv67, i64 %sub53.us
  %63 = load double, double* %arrayidx55.us, align 8
  %sub56.us = fsub double %62, %63
  %mul57.us = fmul double %sub56.us, 5.000000e-01
  %sub58.us = fsub double %61, %mul57.us
  store double %sub58.us, double* %arrayidx46.us, align 8
  %indvars.iv.next64 = add nuw nsw i64 %indvars.iv63, 1
  %arrayidx46.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv67, i64 %indvars.iv.next64
  %64 = load double, double* %arrayidx46.us.1, align 8
  %arrayidx50.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv67, i64 %indvars.iv.next64
  %65 = load double, double* %arrayidx50.us.1, align 8
  %arrayidx55.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv67, i64 %indvars.iv63
  %66 = load double, double* %arrayidx55.us.1, align 8
  %sub56.us.1 = fsub double %65, %66
  %mul57.us.1 = fmul double %sub56.us.1, 5.000000e-01
  %sub58.us.1 = fsub double %64, %mul57.us.1
  store double %sub58.us.1, double* %arrayidx46.us.1, align 8
  %indvars.iv.next64.1 = add nsw i64 %indvars.iv63, 2
  %exitcond66.1 = icmp eq i64 %indvars.iv.next64.1, 1200
  br i1 %exitcond66.1, label %for.cond40.for.inc66_crit_edge.us, label %for.inc63.us, !llvm.loop !16

for.cond40.for.inc66_crit_edge.us:                ; preds = %for.inc63.us
  %exitcond70 = icmp eq i64 %37, 1000
  br i1 %exitcond70, label %for.cond73.preheader.us.preheader, label %for.cond40.preheader.us
...
for.cond73.preheader.us:                          ; preds = %for.cond73.for.inc110_crit_edge.us, %for.cond73.preheader.us.preheader
  %indvars.iv76 = phi i64 [ %67, %for.cond73.for.inc110_crit_edge.us ], [ 0, %for.cond73.preheader.us.preheader ]
  ...
  %67 = add i64 %indvars.iv76, 1
  %scevgep6 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %67, i64 0
  %scevgep8 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %indvars.iv76, i64 0
  %scevgep10 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %67, i64 1199
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %68 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv76, i64 %index
  %69 = bitcast double* %68 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %69, align 8, !alias.scope !17, !noalias !20
  %70 = getelementptr double, double* %68, i64 2
  %71 = bitcast double* %70 to <2 x double>*
  %wide.load16 = load <2 x double>, <2 x double>* %71, align 8, !alias.scope !17, !noalias !20
  %72 = or i64 %index, 1
  %73 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv76, i64 %72
  %74 = bitcast double* %73 to <2 x double>*
  %wide.load17 = load <2 x double>, <2 x double>* %74, align 8, !alias.scope !23
  %75 = getelementptr double, double* %73, i64 2
  %76 = bitcast double* %75 to <2 x double>*
  %wide.load18 = load <2 x double>, <2 x double>* %76, align 8, !alias.scope !23
  %77 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv76, i64 %index
  %78 = bitcast double* %77 to <2 x double>*
  %wide.load19 = load <2 x double>, <2 x double>* %78, align 8, !alias.scope !23
  %79 = getelementptr double, double* %77, i64 2
  %80 = bitcast double* %79 to <2 x double>*
  %wide.load20 = load <2 x double>, <2 x double>* %80, align 8, !alias.scope !23
  %81 = fsub <2 x double> %wide.load17, %wide.load19
  %82 = fsub <2 x double> %wide.load18, %wide.load20
  %83 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %67, i64 %index
  %84 = bitcast double* %83 to <2 x double>*
  %wide.load21 = load <2 x double>, <2 x double>* %84, align 8, !alias.scope !24
  %85 = getelementptr double, double* %83, i64 2
  %86 = bitcast double* %85 to <2 x double>*
  %wide.load22 = load <2 x double>, <2 x double>* %86, align 8, !alias.scope !24
  %87 = fadd <2 x double> %81, %wide.load21
  %88 = fadd <2 x double> %82, %wide.load22
  %89 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv76, i64 %index
  %90 = bitcast double* %89 to <2 x double>*
  %wide.load23 = load <2 x double>, <2 x double>* %90, align 8, !alias.scope !24
  %91 = getelementptr double, double* %89, i64 2
  %92 = bitcast double* %91 to <2 x double>*
  %wide.load24 = load <2 x double>, <2 x double>* %92, align 8, !alias.scope !24
  %93 = fsub <2 x double> %87, %wide.load23
  %94 = fsub <2 x double> %88, %wide.load24
  ...
  %98 = fsub <2 x double> %wide.load16, %96
  store <2 x double> %97, <2 x double>* %69, align 8, !alias.scope !17, !noalias !20
  store <2 x double> %98, <2 x double>* %71, align 8, !alias.scope !17, !noalias !20
  %index.next = add i64 %index, 4
  %99 = icmp eq i64 %index.next, 1196
  br i1 %99, label %for.inc107.us.preheader.loopexit, label %vector.body, !llvm.loop !25
...
for.inc107.us:                                    ; preds = %for.inc107.us.preheader, %for.inc107.us
  %indvars.iv72 = phi i64 [ %add.us, %for.inc107.us ], [ %indvars.iv72.ph, %for.inc107.us.preheader ]
  ...
  %add.us = add nuw nsw i64 %indvars.iv72, 1
  %arrayidx84.us = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv76, i64 %add.us
  ...
  %arrayidx94.us = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %67, i64 %indvars.iv72
  ...
  %exitcond75 = icmp eq i64 %add.us, 1199
  br i1 %exitcond75, label %for.cond73.for.inc110_crit_edge.us, label %for.inc107.us, !llvm.loop !26

for.cond73.for.inc110_crit_edge.us:               ; preds = %for.inc107.us
  %exitcond79 = icmp eq i64 %67, 999
...
for.inc113:                                       ; preds = %for.cond73.for.inc110_crit_edge.us
  ...
  %exitcond83 = icmp eq i64 %indvars.iv.next81, 500
  br i1 %exitcond83, label %for.end115, label %for.cond1.preheader
...
for.body4.us:                                     ; preds = %for.inc.us, %for.cond2.preheader.us
  %indvars.iv45 = phi i64 [ 0, %for.cond2.preheader.us ], [ %indvars.iv.next46, %for.inc.us ]
...
for.body21.us:                                    ; preds = %for.inc34.us, %for.cond19.preheader.us
  %indvars.iv34 = phi i64 [ 0, %for.cond19.preheader.us ], [ %indvars.iv.next35, %for.inc34.us ]
...
for.cond19.for.inc37_crit_edge.us:                ; preds = %for.inc34.us
  ...
  br i1 %exitcond43, label %for.end39, label %for.cond19.preheader.us
...
for.cond45.for.inc63_crit_edge.us:                ; preds = %for.inc60.us
  ...
  br i1 %exitcond32, label %for.end65, label %for.cond45.preheader.us
