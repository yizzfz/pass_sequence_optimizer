...
for.cond9.preheader.us12.preheader:               ; preds = %for.cond9.preheader.us12.preheader.loopexit, %middle.block124, %for.body3.us.prol.loopexit
  %min.iters.check82 = icmp ult i64 %46, 2
  %n.vec85 = and i64 %46, -2
  %cmp.zero86 = icmp eq i64 %n.vec85, 0
  %cmp.n117 = icmp eq i64 %46, %n.vec85
...
for.cond9.preheader.us12:                         ; preds = %for.cond9.preheader.us12.preheader, %for.cond9.for.inc40_crit_edge.us35
  ...
  %4 = add nuw nsw i64 %indvars.iv47, 1
...
for.body3.lr.ph.us:                               ; preds = %for.body3.lr.ph.us.preheader, %for.cond6.for.inc43_crit_edge.us
  %indvars.iv152 = phi i2 [ 1, %for.body3.lr.ph.us.preheader ], [ %indvars.iv.next153, %for.cond6.for.inc43_crit_edge.us ]
  ...
  %39 = zext i2 %indvars.iv152 to i32
  %40 = add i32 %39, -1
  %41 = zext i32 %40 to i64
  %42 = add i64 %41, 1
  %43 = add nsw i64 %indvars.iv54, -3
  %scevgep = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv54, i64 0
  %44 = mul i64 %indvars.iv54, 1201
  %45 = add i64 %44, 1
  %scevgep89 = getelementptr [1200 x double], [1200 x double]* %C, i64 0, i64 %45
  %46 = add nuw nsw i64 %indvars.iv54, 1
...
for.body3.us.prol.loopexit:                       ; preds = %for.body3.us.prol.loopexit.loopexit, %for.body3.lr.ph.us
  %indvars.iv.unr = phi i64 [ 0, %for.body3.lr.ph.us ], [ %42, %for.body3.us.prol.loopexit.loopexit ]
...
for.body3.us.preheader:                           ; preds = %for.body3.us.prol.loopexit
  ...
  %min.iters.check126 = icmp ult i64 %52, 2
...
min.iters.checked127:                             ; preds = %for.body3.us.preheader
  %n.mod.vf128 = and i64 %52, 1
  %n.vec129 = sub nsw i64 %52, %n.mod.vf128
  %cmp.zero130 = icmp eq i64 %n.vec129, 0
  %53 = add i64 %indvars.iv.unr, 4
  %54 = shl nuw i64 %51, 2
  %55 = add i64 %53, %54
  %56 = shl nuw nsw i64 %n.mod.vf128, 2
  %ind.end135 = sub i64 %55, %56
...
vector.body123:                                   ; preds = %vector.body123, %vector.ph131
  ...
  %wide.vec141 = load <8 x double>, <8 x double>* %60, align 8
  ...
  %61 = fmul <2 x double> %strided.vec142, %broadcast.splat147
  %62 = fmul <2 x double> %strided.vec143, %broadcast.splat147
  %63 = fmul <2 x double> %strided.vec144, %broadcast.splat147
  %64 = add nsw i64 %58, 3
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv54, i64 %64
  %66 = fmul <2 x double> %strided.vec145, %broadcast.splat147
  ...
  %interleaved.vec148 = shufflevector <4 x double> %69, <4 x double> %70, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 1, i32 3, i32 5, i32 7>
  store <8 x double> %interleaved.vec148, <8 x double>* %68, align 8
  %index.next133 = add i64 %index132, 2
  %71 = icmp eq i64 %index.next133, %n.vec129
  br i1 %71, label %middle.block124, label %vector.body123, !llvm.loop !21
...
for.cond6.for.inc43_crit_edge.us:                 ; preds = %for.cond9.for.inc40_crit_edge.us35
  ...
  %indvars.iv.next153 = add i2 %indvars.iv152, 1
...
for.body3.lr.ph:                                  ; preds = %for.body3.lr.ph.preheader, %for.inc43
  %indvars.iv154 = phi i2 [ 1, %for.body3.lr.ph.preheader ], [ %indvars.iv.next155, %for.inc43 ]
  ...
  %72 = zext i2 %indvars.iv154 to i32
  %73 = add i32 %72, -1
  %74 = zext i32 %73 to i64
  %75 = add i64 %74, 1
  %76 = add nsw i64 %indvars.iv68, -3
  %indvars.iv.next69 = add nuw nsw i64 %indvars.iv68, 1
  %77 = trunc i64 %indvars.iv.next69 to i32
  %xtraiter63 = and i32 %77, 3
...
for.body3.prol.loopexit:                          ; preds = %for.body3.prol.loopexit.loopexit, %for.body3.lr.ph
  %indvars.iv58.unr = phi i64 [ 0, %for.body3.lr.ph ], [ %75, %for.body3.prol.loopexit.loopexit ]
  %79 = icmp ult i64 %indvars.iv68, 3
  br i1 %79, label %for.inc43, label %for.body3.preheader

for.body3.preheader:                              ; preds = %for.body3.prol.loopexit
  %80 = sub i64 %76, %indvars.iv58.unr
  %81 = lshr i64 %80, 2
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %87 = shl i64 %index, 2
  %88 = add i64 %indvars.iv58.unr, %87
  %89 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv68, i64 %88
  ...
  %91 = fmul <2 x double> %strided.vec, %broadcast.splat78
  %92 = fmul <2 x double> %strided.vec74, %broadcast.splat78
  %93 = fmul <2 x double> %strided.vec75, %broadcast.splat78
  %94 = add nsw i64 %88, 3
  %95 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv68, i64 %94
  %96 = fmul <2 x double> %strided.vec76, %broadcast.splat78
...
for.inc43:                                        ; preds = %for.inc43.loopexit, %middle.block, %for.body3.prol.loopexit
  ...
  %indvars.iv.next155 = add i2 %indvars.iv154, 1
