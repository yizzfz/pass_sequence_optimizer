...
entry:
  ...
  br i1 %cmp12, label %for.cond1.preheader.lr.ph, label %entry.for.end22_crit_edge
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc20_crit_edge.us.for.cond1.preheader.us_crit_edge, %for.cond1.preheader.lr.ph
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.cond1.for.inc20_crit_edge.us.for.cond1.preheader.us_crit_edge ], [ 0, %for.cond1.preheader.lr.ph ]
...
for.cond1.for.inc20_crit_edge.us:                 ; preds = %for.body3.us
  ...
  br i1 %exitcond19, label %for.end22.loopexit, label %for.cond1.for.inc20_crit_edge.us.for.cond1.preheader.us_crit_edge
...
for.end22:                                        ; preds = %entry.for.end22_crit_edge, %for.end22.loopexit
  ret void
}
...
entry:
  ...
  br i1 %cmp52, label %for.cond1.preheader.lr.ph, label %entry.for.end89_crit_edge
...
for.cond1.preheader:                              ; preds = %for.inc87.for.cond1.preheader_crit_edge, %for.cond1.preheader.lr.ph
  %storemerge53 = phi i32 [ 0, %for.cond1.preheader.lr.ph ], [ %inc88, %for.inc87.for.cond1.preheader_crit_edge ]
  br i1 %cmp246, label %for.cond4.preheader.us.preheader, label %for.cond1.preheader.for.inc87_crit_edge
...
for.cond4.preheader.us:                           ; preds = %for.cond4.for.inc37_crit_edge.us.for.cond4.preheader.us_crit_edge, %for.cond4.preheader.us.preheader
  %indvar98 = phi i64 [ %indvar.next99, %for.cond4.for.inc37_crit_edge.us.for.cond4.preheader.us_crit_edge ], [ 0, %for.cond4.preheader.us.preheader ]
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.cond4.for.inc37_crit_edge.us.for.cond4.preheader.us_crit_edge ], [ 1, %for.cond4.preheader.us.preheader ]
  %1 = add nuw nsw i64 %indvar98, 1
  ...
  %2 = add nuw nsw i64 %indvar98, 2
  %scevgep106 = getelementptr [1300 x double], [1300 x double]* %A, i64 %2, i64 %wide.trip.count63
  %indvars.iv.next56 = add nuw nsw i64 %indvars.iv55, 1
  %3 = add nsw i64 %indvars.iv55, -1
  br i1 %min.iters.check92, label %for.cond4.preheader.us.for.body7.us.preheader_crit_edge, label %min.iters.checked93
...
min.iters.checked93:                              ; preds = %for.cond4.preheader.us
  br i1 %cmp.zero96, label %min.iters.checked93.for.body7.us.preheader_crit_edge, label %vector.memcheck112

min.iters.checked93.for.body7.us.preheader_crit_edge: ; preds = %min.iters.checked93
  br label %for.body7.us.preheader
...
vector.memcheck112:                               ; preds = %min.iters.checked93
  ...
  br i1 %memcheck.conflict111, label %vector.memcheck112.for.body7.us.preheader_crit_edge, label %vector.body89.preheader

vector.memcheck112.for.body7.us.preheader_crit_edge: ; preds = %vector.memcheck112
  br label %for.body7.us.preheader
...
vector.body89:                                    ; preds = %vector.body89.vector.body89_crit_edge, %vector.body89.preheader
  %index114 = phi i64 [ %index.next115, %vector.body89.vector.body89_crit_edge ], [ 0, %vector.body89.preheader ]
  ...
  br i1 %40, label %middle.block90, label %vector.body89.vector.body89_crit_edge, !llvm.loop !6

vector.body89.vector.body89_crit_edge:            ; preds = %vector.body89
  br label %vector.body89

middle.block90:                                   ; preds = %vector.body89
  br i1 %cmp.n118, label %middle.block90.for.cond4.for.inc37_crit_edge.us_crit_edge, label %middle.block90.for.body7.us.preheader_crit_edge

middle.block90.for.body7.us.preheader_crit_edge:  ; preds = %middle.block90
  br label %for.body7.us.preheader

middle.block90.for.cond4.for.inc37_crit_edge.us_crit_edge: ; preds = %middle.block90
  br label %for.cond4.for.inc37_crit_edge.us

for.body7.us.preheader:                           ; preds = %middle.block90.for.body7.us.preheader_crit_edge, %vector.memcheck112.for.body7.us.preheader_crit_edge, %min.iters.checked93.for.body7.us.preheader_crit_edge, %for.cond4.preheader.us.for.body7.us.preheader_crit_edge
  %indvars.iv.ph = phi i64 [ 1, %vector.memcheck112.for.body7.us.preheader_crit_edge ], [ 1, %min.iters.checked93.for.body7.us.preheader_crit_edge ], [ 1, %for.cond4.preheader.us.for.body7.us.preheader_crit_edge ], [ %ind.end117, %middle.block90.for.body7.us.preheader_crit_edge ]
...
for.cond4.for.inc37_crit_edge.us:                 ; preds = %middle.block90.for.cond4.for.inc37_crit_edge.us_crit_edge, %for.cond4.for.inc37_crit_edge.us.loopexit
  %exitcond59 = icmp eq i64 %indvars.iv.next56, %wide.trip.count58
  br i1 %exitcond59, label %for.cond40.preheader, label %for.cond4.for.inc37_crit_edge.us.for.cond4.preheader.us_crit_edge
...
for.cond40.preheader:                             ; preds = %for.cond4.for.inc37_crit_edge.us
  br i1 %cmp4250, label %for.cond44.preheader.us.preheader, label %for.cond40.preheader.for.inc87_crit_edge
...
for.cond44.preheader.us:                          ; preds = %for.cond44.for.inc84_crit_edge.us.for.cond44.preheader.us_crit_edge, %for.cond44.preheader.us.preheader
  ...
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.cond44.for.inc84_crit_edge.us.for.cond44.preheader.us_crit_edge ], [ 1, %for.cond44.preheader.us.preheader ]
  ...
  br i1 %min.iters.check, label %for.cond44.preheader.us.for.body47.us.preheader_crit_edge, label %min.iters.checked
...
min.iters.checked:                                ; preds = %for.cond44.preheader.us
  br i1 %cmp.zero, label %min.iters.checked.for.body47.us.preheader_crit_edge, label %vector.memcheck

min.iters.checked.for.body47.us.preheader_crit_edge: ; preds = %min.iters.checked
  br label %for.body47.us.preheader
...
vector.memcheck:                                  ; preds = %min.iters.checked
  ...
  br i1 %memcheck.conflict, label %vector.memcheck.for.body47.us.preheader_crit_edge, label %vector.body.preheader

vector.memcheck.for.body47.us.preheader_crit_edge: ; preds = %vector.memcheck
  br label %for.body47.us.preheader
...
middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %middle.block.for.cond44.for.inc84_crit_edge.us_crit_edge, label %middle.block.for.body47.us.preheader_crit_edge

middle.block.for.body47.us.preheader_crit_edge:   ; preds = %middle.block
  br label %for.body47.us.preheader

middle.block.for.cond44.for.inc84_crit_edge.us_crit_edge: ; preds = %middle.block
  br label %for.cond44.for.inc84_crit_edge.us

for.body47.us.preheader:                          ; preds = %middle.block.for.body47.us.preheader_crit_edge, %vector.memcheck.for.body47.us.preheader_crit_edge, %min.iters.checked.for.body47.us.preheader_crit_edge, %for.cond44.preheader.us.for.body47.us.preheader_crit_edge
  %indvars.iv60.ph = phi i64 [ 1, %vector.memcheck.for.body47.us.preheader_crit_edge ], [ 1, %min.iters.checked.for.body47.us.preheader_crit_edge ], [ 1, %for.cond44.preheader.us.for.body47.us.preheader_crit_edge ], [ %ind.end, %middle.block.for.body47.us.preheader_crit_edge ]
  br label %for.body47.us

for.body47.us:                                    ; preds = %for.body47.us.for.body47.us_crit_edge, %for.body47.us.preheader
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.body47.us.for.body47.us_crit_edge ], [ %indvars.iv60.ph, %for.body47.us.preheader ]
  ...
  br i1 %exitcond64, label %for.cond44.for.inc84_crit_edge.us.loopexit, label %for.body47.us.for.body47.us_crit_edge, !llvm.loop !16
...
for.cond44.for.inc84_crit_edge.us:                ; preds = %middle.block.for.cond44.for.inc84_crit_edge.us_crit_edge, %for.cond44.for.inc84_crit_edge.us.loopexit
  %exitcond69 = icmp eq i64 %indvars.iv.next66, %wide.trip.count68
  br i1 %exitcond69, label %for.inc87.loopexit, label %for.cond44.for.inc84_crit_edge.us.for.cond44.preheader.us_crit_edge
...
for.inc87:                                        ; preds = %for.cond40.preheader.for.inc87_crit_edge, %for.cond1.preheader.for.inc87_crit_edge, %for.inc87.loopexit
  %inc88 = add nuw nsw i32 %storemerge53, 1
  %exitcond70 = icmp eq i32 %inc88, %tsteps
  br i1 %exitcond70, label %for.end89.loopexit, label %for.inc87.for.cond1.preheader_crit_edge
...
for.end89:                                        ; preds = %entry.for.end89_crit_edge, %for.end89.loopexit
  ret void
}
...
for.cond2.preheader.us:                           ; preds = %for.cond2.for.inc10_crit_edge.us.for.cond2.preheader.us_crit_edge, %for.cond2.preheader.us.preheader
  %indvars.iv12 = phi i64 [ 0, %for.cond2.preheader.us.preheader ], [ %indvars.iv.next13, %for.cond2.for.inc10_crit_edge.us.for.cond2.preheader.us_crit_edge ]
...
for.cond2.for.inc10_crit_edge.us:                 ; preds = %if.end.us
  ...
  br i1 %exitcond16, label %for.end12.loopexit, label %for.cond2.for.inc10_crit_edge.us.for.cond2.preheader.us_crit_edge
