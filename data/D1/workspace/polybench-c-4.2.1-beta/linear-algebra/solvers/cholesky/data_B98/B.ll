...
.lr.ph36:                                         ; preds = %._crit_edge40, %.preheader14.lr.ph
  %indvars.iv81 = phi i64 [ 0, %.preheader14.lr.ph ], [ %indvars.iv.next82, %._crit_edge40 ]
  %indvars.iv79 = phi i64 [ 1, %.preheader14.lr.ph ], [ %indvars.iv.next80, %._crit_edge40 ]
  %4 = mul nuw nsw i64 %indvars.iv81, 2001
  %5 = add nuw nsw i64 %4, 1
  %6 = sub i64 1998, %indvars.iv81
  %7 = shl i64 %6, 3
  br label %._crit_edge

.preheader13:                                     ; preds = %._crit_edge
  %scevgep75 = getelementptr [2000 x double], [2000 x double]* %1, i64 0, i64 %5
  %8 = and i64 %7, 34359738360
  %scevgep7576 = bitcast double* %scevgep75 to i8*
  %9 = add nuw nsw i64 %8, 8
  %indvars.iv.next82 = add nuw nsw i64 %indvars.iv81, 1
  %10 = icmp slt i64 %indvars.iv.next82, 2000
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph36
  ...
  %11 = sub nsw i64 0, %indvars.iv61
  %12 = trunc i64 %11 to i32
  %13 = srem i32 %12, 2000
  %14 = sitofp i32 %13 to double
  %15 = fdiv double %14, 2.000000e+03
  %16 = fadd double %15, 1.000000e+00
  %17 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv81, i64 %indvars.iv61
...
._crit_edge40.loopexit:                           ; preds = %.preheader13
  call void @llvm.memset.p0i8.i64(i8* nonnull %scevgep7576, i8 0, i64 %9, i32 8, i1 false)
  br label %._crit_edge40

._crit_edge40:                                    ; preds = %.preheader13, %._crit_edge40.loopexit
  %18 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv81, i64 %indvars.iv81
  store double 1.000000e+00, double* %18, align 8
  %exitcond84 = icmp eq i64 %indvars.iv.next82, 2000
  %indvars.iv.next80 = add nuw nsw i64 %indvars.iv79, 1
  br i1 %exitcond84, label %._crit_edge42, label %.lr.ph36
...
._crit_edge33.us.prol:                            ; preds = %._crit_edge33.us.prol, %._crit_edge33.us.prol.preheader
  %indvar55.prol = phi i64 [ 0, %._crit_edge33.us.prol.preheader ], [ %indvar.next56.prol, %._crit_edge33.us.prol ]
  %prol.iter141 = phi i64 [ 0, %._crit_edge33.us.prol.preheader ], [ %prol.iter141.sub, %._crit_edge33.us.prol ]
  %20 = mul nuw nsw i64 %indvar55.prol, 16000
  %scevgep.prol = getelementptr i8, i8* %19, i64 %20
  call void @llvm.memset.p0i8.i64(i8* %scevgep.prol, i8 0, i64 16000, i32 8, i1 false)
  %indvar.next56.prol = add nuw nsw i64 %indvar55.prol, 1
  %prol.iter141.sub = add nsw i64 %prol.iter141, -1
  %prol.iter141.cmp = icmp eq i64 %prol.iter141.sub, 0
  br i1 %prol.iter141.cmp, label %._crit_edge33.us.prol.loopexit.unr-lcssa, label %._crit_edge33.us.prol, !llvm.loop !1
...
.preheader9.us.us.preheader:                      ; preds = %.preheader9.us.us.preheader.preheader, %._crit_edge22.us
  %indvars.iv144 = phi i64 [ 0, %.preheader9.us.us.preheader.preheader ], [ %indvars.iv.next145, %._crit_edge22.us ]
  %scevgep94 = getelementptr [2000 x double], [2000 x double]* %1, i64 0, i64 %indvars.iv144
  %scevgep9495 = bitcast double* %scevgep94 to i8*
  %37 = add nsw i64 %indvars.iv144, -1999
...
._crit_edge22.us:                                 ; preds = %._crit_edge20.us.us
  ...
  %38 = icmp slt i64 %indvars.iv.next145, 2000
  br i1 %38, label %.preheader9.us.us.preheader, label %.preheader.us.preheader

.preheader9.us.us:                                ; preds = %._crit_edge20.us.us, %.preheader9.us.us.preheader
  %indvars.iv142 = phi i64 [ %indvars.iv.next143, %._crit_edge20.us.us ], [ 0, %.preheader9.us.us.preheader ]
  %39 = mul nuw nsw i64 %indvars.iv142, 16000
  %scevgep90 = getelementptr i8, i8* %19, i64 %39
  %40 = add nuw nsw i64 16000, %39
  %scevgep91 = getelementptr i8, i8* %19, i64 %40
  %41 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv142, i64 %indvars.iv144
  br i1 false, label %._crit_edge85.preheader, label %min.iters.checked

._crit_edge85.preheader:                          ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.preheader9.us.us
  %indvars.iv49.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %min.iters.checked ], [ 0, %.preheader9.us.us ], [ 2000, %middle.block ]
  br i1 true, label %._crit_edge85.prol.loopexit.unr-lcssa, label %._crit_edge85.prol.preheader

._crit_edge85.prol.preheader:                     ; preds = %._crit_edge85.preheader
  br label %._crit_edge85.prol

._crit_edge85.prol:                               ; preds = %._crit_edge85.prol.preheader
  %42 = load double, double* %41, align 8
  %43 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv49.ph, i64 %indvars.iv144
  %44 = load double, double* %43, align 8
  %45 = fmul double %42, %44
  %46 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv142, i64 %indvars.iv49.ph
  %47 = load double, double* %46, align 8
  %48 = fadd double %47, %45
  store double %48, double* %46, align 8
  %indvars.iv.next50.prol = add nuw nsw i64 %indvars.iv49.ph, 1
  br label %._crit_edge85.prol.loopexit.unr-lcssa

._crit_edge85.prol.loopexit.unr-lcssa:            ; preds = %._crit_edge85.preheader, %._crit_edge85.prol
  %indvars.iv49.unr.ph = phi i64 [ %indvars.iv.next50.prol, %._crit_edge85.prol ], [ %indvars.iv49.ph, %._crit_edge85.preheader ]
  br label %._crit_edge85.prol.loopexit

._crit_edge85.prol.loopexit:                      ; preds = %._crit_edge85.prol.loopexit.unr-lcssa
  br i1 false, label %._crit_edge20.us.us.loopexit, label %._crit_edge85.preheader.new

._crit_edge85.preheader.new:                      ; preds = %._crit_edge85.prol.loopexit
  br label %._crit_edge85

min.iters.checked:                                ; preds = %.preheader9.us.us
  br i1 false, label %._crit_edge85.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %bound0 = icmp ult i8* %scevgep90, %scevgep9697
  %bound1 = icmp ult i8* %scevgep9495, %scevgep91
  %found.conflict = and i1 %bound0, %bound1
  %bc = bitcast double* %41 to i8*
  %bc98 = bitcast double* %41 to i8*
  %bound099 = icmp ult i8* %scevgep90, %bc98
  %bound1100 = icmp ult i8* %bc, %scevgep91
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %55 = or i64 %index, 2
  %56 = or i64 %index, 3
  %57 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %index, i64 %indvars.iv144
  %58 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %54, i64 %indvars.iv144
  %59 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %55, i64 %indvars.iv144
  %60 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %56, i64 %indvars.iv144
  ...
  %71 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv142, i64 %index
  ...
  %wide.load103 = load <2 x double>, <2 x double>* %74, align 8, !alias.scope !8, !noalias !10
  %75 = fadd <2 x double> %wide.load, %69
  %76 = fadd <2 x double> %wide.load103, %70
...
middle.block:                                     ; preds = %vector.body
  br i1 true, label %._crit_edge20.us.us, label %._crit_edge85.preheader

._crit_edge20.us.us.loopexit.unr-lcssa:           ; preds = %._crit_edge85
  br label %._crit_edge20.us.us.loopexit

._crit_edge20.us.us.loopexit:                     ; preds = %._crit_edge85.prol.loopexit, %._crit_edge20.us.us.loopexit.unr-lcssa
  br label %._crit_edge20.us.us

._crit_edge20.us.us:                              ; preds = %._crit_edge20.us.us.loopexit, %middle.block
  %indvars.iv.next143 = add nuw nsw i64 %indvars.iv142, 1
  %80 = icmp slt i64 %indvars.iv.next143, 2000
  br i1 %80, label %.preheader9.us.us, label %._crit_edge22.us

._crit_edge85:                                    ; preds = %._crit_edge85, %._crit_edge85.preheader.new
  %indvars.iv49 = phi i64 [ %indvars.iv49.unr.ph, %._crit_edge85.preheader.new ], [ %indvars.iv.next50.1, %._crit_edge85 ]
  %81 = load double, double* %41, align 8
  %82 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv49, i64 %indvars.iv144
  %83 = load double, double* %82, align 8
  %84 = fmul double %81, %83
  %85 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv142, i64 %indvars.iv49
  %86 = load double, double* %85, align 8
  %87 = fadd double %86, %84
  store double %87, double* %85, align 8
  %indvars.iv.next50 = add nuw nsw i64 %indvars.iv49, 1
  %88 = load double, double* %41, align 8
  %89 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv.next50, i64 %indvars.iv144
  %90 = load double, double* %89, align 8
  %91 = fmul double %88, %90
  %92 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv142, i64 %indvars.iv.next50
  ...
  br i1 %exitcond52.1, label %._crit_edge20.us.us.loopexit.unr-lcssa, label %._crit_edge85, !llvm.loop !14

.preheader.us.preheader:                          ; preds = %._crit_edge22.us
  %scevgep115 = getelementptr [2000 x double], [2000 x double]* %1, i64 0, i64 2000
  %scevgep119 = getelementptr i8, i8* %19, i64 16000
  br label %.preheader.us

.preheader.us:                                    ; preds = %._crit_edge.us, %.preheader.us.preheader
  %indvar = phi i64 [ %indvar.next, %._crit_edge.us ], [ 0, %.preheader.us.preheader ]
  %.2716.us = phi i64 [ %134, %._crit_edge.us ], [ 0, %.preheader.us.preheader ]
  %sext = shl i64 %.2716.us, 32
  %95 = ashr exact i64 %sext, 32
  br i1 false, label %._crit_edge86.preheader, label %min.iters.checked108

min.iters.checked108:                             ; preds = %.preheader.us
  br i1 false, label %._crit_edge86.preheader, label %vector.memcheck125

vector.memcheck125:                               ; preds = %min.iters.checked108
  %scevgep113 = getelementptr [2000 x double], [2000 x double]* %1, i64 %95, i64 0
  %scevgep113114 = bitcast double* %scevgep113 to i8*
  %96 = mul nsw i64 %95, 2000
  %scevgep116 = getelementptr double, double* %scevgep115, i64 %96
  %scevgep116117 = bitcast double* %scevgep116 to i8*
  %97 = mul nsw i64 %95, 16000
  %scevgep118 = getelementptr i8, i8* %19, i64 %97
  %scevgep120 = getelementptr i8, i8* %scevgep119, i64 %97
  %bound0121 = icmp ult i8* %scevgep113114, %scevgep120
  %bound1122 = icmp ult i8* %scevgep118, %scevgep116117
  %memcheck.conflict124 = and i1 %bound0121, %bound1122
  br i1 %memcheck.conflict124, label %._crit_edge86.preheader, label %vector.body104.preheader

vector.body104.preheader:                         ; preds = %vector.memcheck125
  br label %vector.body104

vector.body104:                                   ; preds = %vector.body104.preheader, %vector.body104
  %index127 = phi i64 [ %index.next128, %vector.body104 ], [ 0, %vector.body104.preheader ]
  %98 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %95, i64 %index127
  %99 = bitcast double* %98 to <2 x i64>*
  %wide.load135 = load <2 x i64>, <2 x i64>* %99, align 8, !alias.scope !15
  %100 = getelementptr double, double* %98, i64 2
  %101 = bitcast double* %100 to <2 x i64>*
  %wide.load136 = load <2 x i64>, <2 x i64>* %101, align 8, !alias.scope !15
  %102 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %95, i64 %index127
  %103 = bitcast double* %102 to <2 x i64>*
  store <2 x i64> %wide.load135, <2 x i64>* %103, align 8, !alias.scope !18, !noalias !15
  %104 = getelementptr double, double* %102, i64 2
  %105 = bitcast double* %104 to <2 x i64>*
  store <2 x i64> %wide.load136, <2 x i64>* %105, align 8, !alias.scope !18, !noalias !15
  %index.next128 = add i64 %index127, 4
  %106 = icmp eq i64 %index.next128, 2000
  br i1 %106, label %middle.block105, label %vector.body104, !llvm.loop !20

middle.block105:                                  ; preds = %vector.body104
  br i1 true, label %._crit_edge.us, label %._crit_edge86.preheader

._crit_edge86.preheader:                          ; preds = %middle.block105, %vector.memcheck125, %min.iters.checked108, %.preheader.us
  %indvars.iv.ph = phi i64 [ 0, %vector.memcheck125 ], [ 0, %min.iters.checked108 ], [ 0, %.preheader.us ], [ 2000, %middle.block105 ]
  %107 = sub nsw i64 1999, %indvars.iv.ph
  br i1 true, label %._crit_edge86.prol.loopexit, label %._crit_edge86.prol.preheader

._crit_edge86.prol.preheader:                     ; preds = %._crit_edge86.preheader
  br label %._crit_edge86.prol

._crit_edge86.prol:                               ; preds = %._crit_edge86.prol, %._crit_edge86.prol.preheader
  %indvars.iv.prol = phi i64 [ %indvars.iv.next.prol, %._crit_edge86.prol ], [ %indvars.iv.ph, %._crit_edge86.prol.preheader ]
  %prol.iter = phi i64 [ %prol.iter.sub, %._crit_edge86.prol ], [ 0, %._crit_edge86.prol.preheader ]
  %108 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %95, i64 %indvars.iv.prol
  %109 = bitcast double* %108 to i64*
  %110 = load i64, i64* %109, align 8
  %111 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %95, i64 %indvars.iv.prol
  %112 = bitcast double* %111 to i64*
  store i64 %110, i64* %112, align 8
  %indvars.iv.next.prol = add nuw nsw i64 %indvars.iv.prol, 1
  %prol.iter.sub = add nsw i64 %prol.iter, -1
  %prol.iter.cmp = icmp eq i64 %prol.iter.sub, 0
  br i1 %prol.iter.cmp, label %._crit_edge86.prol.loopexit.unr-lcssa, label %._crit_edge86.prol, !llvm.loop !21

._crit_edge86.prol.loopexit.unr-lcssa:            ; preds = %._crit_edge86.prol
  br label %._crit_edge86.prol.loopexit

._crit_edge86.prol.loopexit:                      ; preds = %._crit_edge86.preheader, %._crit_edge86.prol.loopexit.unr-lcssa
  %113 = icmp ult i64 %107, 3
  br i1 %113, label %._crit_edge.us.loopexit, label %._crit_edge86.preheader.new

._crit_edge86.preheader.new:                      ; preds = %._crit_edge86.prol.loopexit
  br label %._crit_edge86

._crit_edge86:                                    ; preds = %._crit_edge86, %._crit_edge86.preheader.new
  %indvars.iv = phi i64 [ %indvars.iv.ph, %._crit_edge86.preheader.new ], [ %indvars.iv.next.3, %._crit_edge86 ]
  %114 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %95, i64 %indvars.iv
  %115 = bitcast double* %114 to i64*
  %116 = load i64, i64* %115, align 8
  %117 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %95, i64 %indvars.iv
  %118 = bitcast double* %117 to i64*
  store i64 %116, i64* %118, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %119 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %95, i64 %indvars.iv.next
  %120 = bitcast double* %119 to i64*
  %121 = load i64, i64* %120, align 8
  %122 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %95, i64 %indvars.iv.next
  %123 = bitcast double* %122 to i64*
  store i64 %121, i64* %123, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %124 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %95, i64 %indvars.iv.next.1
  %125 = bitcast double* %124 to i64*
  %126 = load i64, i64* %125, align 8
  %127 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %95, i64 %indvars.iv.next.1
  %128 = bitcast double* %127 to i64*
  store i64 %126, i64* %128, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %129 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %95, i64 %indvars.iv.next.2
  %130 = bitcast double* %129 to i64*
  %131 = load i64, i64* %130, align 8
  %132 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %95, i64 %indvars.iv.next.2
  %133 = bitcast double* %132 to i64*
  store i64 %131, i64* %133, align 8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %exitcond46.3 = icmp eq i64 %indvars.iv.next.3, 2000
  br i1 %exitcond46.3, label %._crit_edge.us.loopexit.unr-lcssa, label %._crit_edge86, !llvm.loop !22

._crit_edge.us.loopexit.unr-lcssa:                ; preds = %._crit_edge86
  br label %._crit_edge.us.loopexit

._crit_edge.us.loopexit:                          ; preds = %._crit_edge86.prol.loopexit, %._crit_edge.us.loopexit.unr-lcssa
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %middle.block105
...
._crit_edge17:                                    ; preds = %._crit_edge17.loopexit, %._crit_edge42.thread
  %135 = phi i8* [ %3, %._crit_edge42.thread ], [ %19, %._crit_edge17.loopexit ]
  tail call void @free(i8* %135) #3
  ret void
}
