...
if.then:                                          ; preds = %land.lhs.true
  call fastcc void @print_array(i32 4096, i32 2160, [2160 x float]* %arraydecay42)
  br label %if.end
...
for.cond1.preheader.us:                           ; preds = %for.cond1.preheader.us.preheader, %for.cond1.for.inc7_crit_edge.us
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.cond1.for.inc7_crit_edge.us ], [ 0, %for.cond1.preheader.us.preheader ]
  %1 = mul nuw nsw i64 %indvars.iv14, 313
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %8 = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv14, i64 %index
...
for.inc.us:                                       ; preds = %for.inc.us.preheader, %for.inc.us
  ...
  %arrayidx6.us = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv14, i64 %indvars.iv
...
for.cond1.for.inc7_crit_edge.us:                  ; preds = %for.cond1.for.inc7_crit_edge.us.loopexit, %middle.block
  ...
  br i1 %exitcond18, label %for.end9.loopexit, label %for.cond1.preheader.us
...
for.cond31.preheader.us:                          ; preds = %for.cond31.preheader.us.preheader, %for.cond31.for.inc55_crit_edge.us
  ...
  br i1 %lcmp.mod210, label %for.inc.us.prol.loopexit, label %for.inc.us.prol

for.inc.us.prol:                                  ; preds = %for.cond31.preheader.us
...
for.inc.us.prol.loopexit:                         ; preds = %for.inc.us.prol, %for.cond31.preheader.us
  %indvars.iv205.unr.ph = phi i64 [ 1, %for.inc.us.prol ], [ 0, %for.cond31.preheader.us ]
  %xm1.0155.us.unr.ph = phi float [ %4, %for.inc.us.prol ], [ 0.000000e+00, %for.cond31.preheader.us ]
  %ym1.0154.us.unr.ph = phi float [ %add42.us.prol, %for.inc.us.prol ], [ 0.000000e+00, %for.cond31.preheader.us ]
  br i1 %2, label %for.cond31.for.inc55_crit_edge.us, label %for.inc.us.preheader

for.inc.us.preheader:                             ; preds = %for.inc.us.prol.loopexit
  br label %for.inc.us

for.inc.us:                                       ; preds = %for.inc.us.preheader, %for.inc.us
  %indvars.iv205 = phi i64 [ %indvars.iv.next206.1, %for.inc.us ], [ %indvars.iv205.unr.ph, %for.inc.us.preheader ]
  %xm1.0155.us = phi float [ %8, %for.inc.us ], [ %xm1.0155.us.unr.ph, %for.inc.us.preheader ]
  %ym1.0154.us = phi float [ %add42.us.1, %for.inc.us ], [ %ym1.0154.us.unr.ph, %for.inc.us.preheader ]
  %ym2.0153.us = phi float [ %add42.us, %for.inc.us ], [ 0.000000e+00, %for.inc.us.preheader ]
  ...
  %mul36.us.1 = fmul float %div, %7
  %mul37.us.1 = fmul float %mul16.v.r1, %6
  ...
  %8 = load float, float* %arrayidx35.us.1, align 4
  %indvars.iv.next206.1 = add nuw nsw i64 %indvars.iv205, 2
  %exitcond208.1 = icmp eq i64 %indvars.iv.next206.1, %wide.trip.count207.1
  br i1 %exitcond208.1, label %for.cond31.for.inc55_crit_edge.us.loopexit, label %for.inc.us

for.cond31.for.inc55_crit_edge.us.loopexit:       ; preds = %for.inc.us
  br label %for.cond31.for.inc55_crit_edge.us

for.cond31.for.inc55_crit_edge.us:                ; preds = %for.cond31.for.inc55_crit_edge.us.loopexit, %for.inc.us.prol.loopexit
...
for.inc84.us:                                     ; preds = %for.cond62.preheader.us, %for.inc84.us
  %indvars.iv198 = phi i64 [ %9, %for.cond62.preheader.us ], [ %indvars.iv.next199, %for.inc84.us ]
  %xp1.0148.us = phi float [ 0.000000e+00, %for.cond62.preheader.us ], [ %10, %for.inc84.us ]
  %xp2.0147.us = phi float [ 0.000000e+00, %for.cond62.preheader.us ], [ %xp1.0148.us, %for.inc84.us ]
  %yp1.0146.us = phi float [ 0.000000e+00, %for.cond62.preheader.us ], [ %add71.us, %for.inc84.us ]
  %yp2.0145.us = phi float [ 0.000000e+00, %for.cond62.preheader.us ], [ %yp1.0146.us, %for.inc84.us ]
  ...
  %10 = load float, float* %arrayidx79.us, align 4
  %cmp63.us = icmp sgt i64 %indvars.iv198, 1
  br i1 %cmp63.us, label %for.inc84.us, label %for.cond62.for.inc86_crit_edge.us

for.cond62.for.inc86_crit_edge.us:                ; preds = %for.inc84.us
...
for.cond92.preheader.us.preheader:                ; preds = %for.cond92.preheader.lr.ph
  ...
  %13 = add nsw i64 %wide.trip.count207.1, -2
...
for.cond92.preheader.us:                          ; preds = %for.cond92.preheader.us.preheader, %for.cond92.for.inc112_crit_edge.us
  ...
  br i1 %lcmp.mod192, label %for.inc109.us.prol.loopexit, label %for.inc109.us.prol

for.inc109.us.prol:                               ; preds = %for.cond92.preheader.us
  %arrayidx98.us.prol = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv193, i64 0
  %14 = load float, float* %arrayidx98.us.prol, align 4
  %arrayidx102.us.prol = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv193, i64 0
  %15 = load float, float* %arrayidx102.us.prol, align 4
  %add103.us.prol = fadd float %14, %15
...
for.inc109.us.prol.loopexit:                      ; preds = %for.inc109.us.prol, %for.cond92.preheader.us
  %indvars.iv187.unr.ph = phi i64 [ 1, %for.inc109.us.prol ], [ 0, %for.cond92.preheader.us ]
  br i1 %11, label %for.cond92.for.inc112_crit_edge.us, label %for.inc109.us.preheader

for.inc109.us.preheader:                          ; preds = %for.inc109.us.prol.loopexit
  %16 = sub nsw i64 %12, %indvars.iv187.unr.ph
  %17 = lshr i64 %16, 1
  %18 = add nuw i64 %17, 1
  %min.iters.check = icmp ult i64 %18, 4
  br i1 %min.iters.check, label %for.inc109.us.preheader311, label %min.iters.checked

min.iters.checked:                                ; preds = %for.inc109.us.preheader
  %n.mod.vf = and i64 %18, 3
  %n.vec = sub i64 %18, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  br i1 %cmp.zero, label %for.inc109.us.preheader311, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %scevgep233 = getelementptr [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv193, i64 %indvars.iv187.unr.ph
  %19 = sub nsw i64 %13, %indvars.iv187.unr.ph
  %20 = and i64 %19, -2
  %21 = or i64 %indvars.iv187.unr.ph, %20
  %scevgep236 = getelementptr float, float* %scevgep235, i64 %21
  %scevgep239 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv193, i64 %indvars.iv187.unr.ph
  %scevgep242 = getelementptr float, float* %scevgep241, i64 %21
  %scevgep245 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv193, i64 %indvars.iv187.unr.ph
  %scevgep248 = getelementptr float, float* %scevgep247, i64 %21
  ...
  %22 = or i64 %indvars.iv187.unr.ph, 2
  %23 = shl nuw i64 %17, 1
  %24 = add i64 %22, %23
  %25 = shl nuw nsw i64 %n.mod.vf, 1
  %ind.end = sub i64 %24, %25
  br i1 %conflict.rdx, label %for.inc109.us.preheader311, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %26 = shl i64 %index, 1
  %offset.idx = or i64 %indvars.iv187.unr.ph, %26
  %27 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv193, i64 %offset.idx
  %28 = bitcast float* %27 to <8 x float>*
  %wide.vec = load <8 x float>, <8 x float>* %28, align 4, !alias.scope !6
  %29 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv193, i64 %offset.idx
  %30 = bitcast float* %29 to <8 x float>*
  %wide.vec254 = load <8 x float>, <8 x float>* %30, align 4, !alias.scope !9
  %31 = fadd <8 x float> %wide.vec, %wide.vec254
  %32 = shufflevector <8 x float> %31, <8 x float> undef, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %33 = add nuw nsw i64 %offset.idx, 1
  %34 = fadd <8 x float> %wide.vec, %wide.vec254
  %35 = shufflevector <8 x float> %34, <8 x float> undef, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %36 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv193, i64 %33
  %37 = getelementptr float, float* %36, i64 -1
  %38 = bitcast float* %37 to <8 x float>*
  %interleaved.vec = shufflevector <4 x float> %32, <4 x float> %35, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x float> %interleaved.vec, <8 x float>* %38, align 4, !alias.scope !11, !noalias !13
  %index.next = add i64 %index, 4
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.cond92.for.inc112_crit_edge.us, label %for.inc109.us.preheader311

for.inc109.us.preheader311:                       ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.inc109.us.preheader
  %indvars.iv187.ph = phi i64 [ %indvars.iv187.unr.ph, %vector.memcheck ], [ %indvars.iv187.unr.ph, %min.iters.checked ], [ %indvars.iv187.unr.ph, %for.inc109.us.preheader ], [ %ind.end, %middle.block ]
  br label %for.inc109.us

for.inc109.us:                                    ; preds = %for.inc109.us.preheader311, %for.inc109.us
  %indvars.iv187 = phi i64 [ %indvars.iv.next188.1, %for.inc109.us ], [ %indvars.iv187.ph, %for.inc109.us.preheader311 ]
  ...
  br i1 %exitcond190.1, label %for.cond92.for.inc112_crit_edge.us.loopexit, label %for.inc109.us, !llvm.loop !15

for.cond92.for.inc112_crit_edge.us.loopexit:      ; preds = %for.inc109.us
  br label %for.cond92.for.inc112_crit_edge.us

for.cond92.for.inc112_crit_edge.us:               ; preds = %for.cond92.for.inc112_crit_edge.us.loopexit, %middle.block, %for.inc109.us.prol.loopexit
...
for.cond118.preheader.us:                         ; preds = %for.cond118.preheader.us.preheader, %for.cond118.for.inc147_crit_edge.us
  ...
  br i1 %lcmp.mod181, label %for.inc144.us.prol.loopexit, label %for.inc144.us.prol

for.inc144.us.prol:                               ; preds = %for.cond118.preheader.us
  ...
  %mul125.us.prol = fmul float %div, %45
  ...
  %46 = load float, float* %arrayidx124.us.prol, align 4
  br label %for.inc144.us.prol.loopexit

for.inc144.us.prol.loopexit:                      ; preds = %for.inc144.us.prol, %for.cond118.preheader.us
  %indvars.iv176.unr.ph = phi i64 [ 1, %for.inc144.us.prol ], [ 0, %for.cond118.preheader.us ]
  %tm1.0135.us.unr.ph = phi float [ %46, %for.inc144.us.prol ], [ 0.000000e+00, %for.cond118.preheader.us ]
  %ym1.1134.us.unr.ph = phi float [ %add131.us.prol, %for.inc144.us.prol ], [ 0.000000e+00, %for.cond118.preheader.us ]
  br i1 %44, label %for.cond118.for.inc147_crit_edge.us, label %for.inc144.us.preheader

for.inc144.us.preheader:                          ; preds = %for.inc144.us.prol.loopexit
  br label %for.inc144.us

for.inc144.us:                                    ; preds = %for.inc144.us.preheader, %for.inc144.us
  %indvars.iv176 = phi i64 [ %indvars.iv.next177.1, %for.inc144.us ], [ %indvars.iv176.unr.ph, %for.inc144.us.preheader ]
  %tm1.0135.us = phi float [ %50, %for.inc144.us ], [ %tm1.0135.us.unr.ph, %for.inc144.us.preheader ]
  %ym1.1134.us = phi float [ %add131.us.1, %for.inc144.us ], [ %ym1.1134.us.unr.ph, %for.inc144.us.preheader ]
  %ym2.1133.us = phi float [ %add131.us, %for.inc144.us ], [ 0.000000e+00, %for.inc144.us.preheader ]
  ...
  %48 = load float, float* %arrayidx124.us, align 4
  ...
  %mul125.us.1 = fmul float %div, %49
  %mul126.us.1 = fmul float %mul16.v.r1, %48
  ...
  %50 = load float, float* %arrayidx124.us.1, align 4
  %indvars.iv.next177.1 = add nuw nsw i64 %indvars.iv176, 2
  %exitcond179.1 = icmp eq i64 %indvars.iv.next177.1, %wide.trip.count178.1
  br i1 %exitcond179.1, label %for.cond118.for.inc147_crit_edge.us.loopexit, label %for.inc144.us

for.cond118.for.inc147_crit_edge.us.loopexit:     ; preds = %for.inc144.us
  br label %for.cond118.for.inc147_crit_edge.us

for.cond118.for.inc147_crit_edge.us:              ; preds = %for.cond118.for.inc147_crit_edge.us.loopexit, %for.inc144.us.prol.loopexit
...
for.inc176.us:                                    ; preds = %for.cond154.preheader.us, %for.inc176.us
  %indvars.iv169 = phi i64 [ %51, %for.cond154.preheader.us ], [ %indvars.iv.next170, %for.inc176.us ]
  %tp1.0128.us = phi float [ 0.000000e+00, %for.cond154.preheader.us ], [ %52, %for.inc176.us ]
  %tp2.0127.us = phi float [ 0.000000e+00, %for.cond154.preheader.us ], [ %tp1.0128.us, %for.inc176.us ]
  %yp1.1126.us = phi float [ 0.000000e+00, %for.cond154.preheader.us ], [ %add163.us, %for.inc176.us ]
  %yp2.1125.us = phi float [ 0.000000e+00, %for.cond154.preheader.us ], [ %yp1.1126.us, %for.inc176.us ]
  ...
  %52 = load float, float* %arrayidx171.us, align 4
  %cmp155.us = icmp sgt i64 %indvars.iv169, 1
  br i1 %cmp155.us, label %for.inc176.us, label %for.cond154.for.inc179_crit_edge.us

for.cond154.for.inc179_crit_edge.us:              ; preds = %for.inc176.us
...
for.cond185.preheader.us.preheader:               ; preds = %for.cond182.preheader
  ...
  %55 = add nsw i64 %wide.trip.count.1, -2
...
for.inc202.us.prol.loopexit:                      ; preds = %for.inc202.us.prol, %for.cond185.preheader.us
  %indvars.iv.unr.ph = phi i64 [ 1, %for.inc202.us.prol ], [ 0, %for.cond185.preheader.us ]
  br i1 %53, label %for.cond185.for.inc205_crit_edge.us, label %for.inc202.us.preheader

for.inc202.us.preheader:                          ; preds = %for.inc202.us.prol.loopexit
  %58 = sub nsw i64 %54, %indvars.iv.unr.ph
  %59 = lshr i64 %58, 1
  %60 = add nuw i64 %59, 1
  %min.iters.check260 = icmp ult i64 %60, 4
  br i1 %min.iters.check260, label %for.inc202.us.preheader310, label %min.iters.checked261

min.iters.checked261:                             ; preds = %for.inc202.us.preheader
  %n.mod.vf262 = and i64 %60, 3
  %n.vec263 = sub i64 %60, %n.mod.vf262
  %cmp.zero264 = icmp eq i64 %n.vec263, 0
  br i1 %cmp.zero264, label %for.inc202.us.preheader310, label %vector.memcheck292
...
vector.memcheck292:                               ; preds = %min.iters.checked261
  ...
  %61 = sub nsw i64 %55, %indvars.iv.unr.ph
  %62 = and i64 %61, -2
  %63 = or i64 %indvars.iv.unr.ph, %62
  %scevgep270 = getelementptr float, float* %scevgep269, i64 %63
  %scevgep273 = getelementptr [2160 x float], [2160 x float]* %y1, i64 %indvars.iv165, i64 %indvars.iv.unr.ph
  %scevgep276 = getelementptr float, float* %scevgep275, i64 %63
  %scevgep279 = getelementptr [2160 x float], [2160 x float]* %y2, i64 %indvars.iv165, i64 %indvars.iv.unr.ph
  %scevgep282 = getelementptr float, float* %scevgep281, i64 %63
  ...
  %64 = or i64 %indvars.iv.unr.ph, 2
  %65 = shl nuw i64 %59, 1
  %66 = add i64 %64, %65
  %67 = shl nuw nsw i64 %n.mod.vf262, 1
  %ind.end297 = sub i64 %66, %67
  br i1 %conflict.rdx290, label %for.inc202.us.preheader310, label %vector.body257.preheader
...
vector.body257:                                   ; preds = %vector.body257.preheader, %vector.body257
  ...
  %68 = shl i64 %index294, 1
  %offset.idx299 = or i64 %indvars.iv.unr.ph, %68
  %69 = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv165, i64 %offset.idx299
  %70 = bitcast float* %69 to <8 x float>*
  %wide.vec303 = load <8 x float>, <8 x float>* %70, align 4, !alias.scope !16
  %71 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv165, i64 %offset.idx299
  %72 = bitcast float* %71 to <8 x float>*
  %wide.vec306 = load <8 x float>, <8 x float>* %72, align 4, !alias.scope !19
  %73 = fadd <8 x float> %wide.vec303, %wide.vec306
  %74 = shufflevector <8 x float> %73, <8 x float> undef, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %75 = add nuw nsw i64 %offset.idx299, 1
  %76 = fadd <8 x float> %wide.vec303, %wide.vec306
  %77 = shufflevector <8 x float> %76, <8 x float> undef, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %78 = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv165, i64 %75
  %79 = getelementptr float, float* %78, i64 -1
  %80 = bitcast float* %79 to <8 x float>*
  %interleaved.vec309 = shufflevector <4 x float> %74, <4 x float> %77, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x float> %interleaved.vec309, <8 x float>* %80, align 4, !alias.scope !21, !noalias !23
  %index.next295 = add i64 %index294, 4
  %81 = icmp eq i64 %index.next295, %n.vec263
  br i1 %81, label %middle.block258, label %vector.body257, !llvm.loop !24

middle.block258:                                  ; preds = %vector.body257
  %cmp.n298 = icmp eq i64 %n.mod.vf262, 0
  br i1 %cmp.n298, label %for.cond185.for.inc205_crit_edge.us, label %for.inc202.us.preheader310

for.inc202.us.preheader310:                       ; preds = %middle.block258, %vector.memcheck292, %min.iters.checked261, %for.inc202.us.preheader
  %indvars.iv.ph = phi i64 [ %indvars.iv.unr.ph, %vector.memcheck292 ], [ %indvars.iv.unr.ph, %min.iters.checked261 ], [ %indvars.iv.unr.ph, %for.inc202.us.preheader ], [ %ind.end297, %middle.block258 ]
  br label %for.inc202.us

for.inc202.us:                                    ; preds = %for.inc202.us.preheader310, %for.inc202.us
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %for.inc202.us ], [ %indvars.iv.ph, %for.inc202.us.preheader310 ]
  %arrayidx191.us = getelementptr inbounds [2160 x float], [2160 x float]* %y1, i64 %indvars.iv165, i64 %indvars.iv
  %82 = load float, float* %arrayidx191.us, align 4
  %arrayidx195.us = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv165, i64 %indvars.iv
  %83 = load float, float* %arrayidx195.us, align 4
  %add196.us = fadd float %82, %83
  ...
  %84 = load float, float* %arrayidx191.us.1, align 4
  %arrayidx195.us.1 = getelementptr inbounds [2160 x float], [2160 x float]* %y2, i64 %indvars.iv165, i64 %indvars.iv.next
  %85 = load float, float* %arrayidx195.us.1, align 4
  %add196.us.1 = fadd float %84, %85
...
for.cond185.for.inc205_crit_edge.us:              ; preds = %for.cond185.for.inc205_crit_edge.us.loopexit, %middle.block258, %for.inc202.us.prol.loopexit
...
entry:
  ...
  %cmp38 = icmp sgt i32 %h, 0
  %or.cond = and i1 %cmp10, %cmp38
...
for.inc.us:                                       ; preds = %if.then.us, %for.body4.us
  ...
  %arrayidx8.us = getelementptr inbounds [2160 x float], [2160 x float]* %imgOut, i64 %indvars.iv14, i64 %indvars.iv
