...
scalar.ph.preheader:                              ; preds = %min.iters.checked, %vector.memcheck, %.preheader.us
  br label %scalar.ph
...
scalar.ph.preheader.1:                            ; preds = %vector.memcheck.1, %.preheader.us.1, %min.iters.checked.1
