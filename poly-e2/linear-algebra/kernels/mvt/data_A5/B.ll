...
entry:
  ...
  br i1 %cmp4, label %for.body.lr.ph, label %for.end36
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %3 = insertelement <2 x double> undef, double %conv1, i32 0
  %div12.us.v.i1.2 = shufflevector <2 x double> %3, <2 x double> undef, <2 x i32> zeroinitializer
  %4 = insertelement <2 x double> undef, double %conv1, i32 0
  %div29.us.v.i1.2 = shufflevector <2 x double> %4, <2 x double> undef, <2 x i32> zeroinitializer
  br label %for.body.us

for.body.us:                                      ; preds = %for.cond22.for.cond.loopexit_crit_edge.us, %for.body.lr.ph
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.cond22.for.cond.loopexit_crit_edge.us ], [ 0, %for.body.lr.ph ]
  %5 = trunc i64 %indvars.iv7 to i32
  %conv.us = sitofp i32 %5 to double
  %arrayidx.us = getelementptr inbounds double, double* %x1, i64 %indvars.iv7
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %6 = icmp eq i64 %indvars.iv.next8, %0
  %7 = trunc i64 %indvars.iv.next8 to i32
  %8 = sitofp i32 %7 to double
  %conv3.us = select i1 %6, double 0.000000e+00, double %8
  ...
  %arrayidx7.us = getelementptr inbounds double, double* %x2, i64 %indvars.iv7
  store double %div.us.v.r2, double* %arrayidx7.us, align 8
  %9 = add nuw nsw i64 %indvars.iv7, 3
  %10 = trunc i64 %9 to i32
  %rem9.us = srem i32 %10, %n
  %conv10.us = sitofp i32 %rem9.us to double
  %arrayidx14.us = getelementptr inbounds double, double* %y_1, i64 %indvars.iv7
  %11 = add nuw nsw i64 %indvars.iv7, 4
  %12 = trunc i64 %11 to i32
  %rem16.us = srem i32 %12, %n
  ...
  %div12.us = fdiv <2 x double> %div12.us.v.i0.2, %div12.us.v.i1.2
  ...
  %arrayidx21.us = getelementptr inbounds double, double* %y_2, i64 %indvars.iv7
...
for.body25.us.prol:                               ; preds = %for.body.us
  %arrayidx33.us.prol = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv7, i64 0
...
for.body25.us:                                    ; preds = %for.body25.us.preheader, %for.body25.us
  ...
  %rem26.us = srem i32 %14, %n
  %conv27.us = sitofp i32 %rem26.us to double
  %arrayidx33.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv7, i64 %indvars.iv
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %15 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv7
  %16 = trunc i64 %15 to i32
  %rem26.us.1 = srem i32 %16, %n
  ...
  %div29.us = fdiv <2 x double> %div29.us.v.i0.2, %div29.us.v.i1.2
  %17 = bitcast double* %arrayidx33.us to <2 x double>*
  store <2 x double> %div29.us, <2 x double>* %17, align 8
...
for.cond22.for.cond.loopexit_crit_edge.us:        ; preds = %for.cond22.for.cond.loopexit_crit_edge.us.loopexit, %for.body25.us.prol.loopexit
  %exitcond12 = icmp eq i64 %indvars.iv.next8, %wide.trip.count11
  br i1 %exitcond12, label %for.end36.loopexit, label %for.body.us
...
entry:
  ...
  br i1 %cmp10, label %for.cond1.preheader.us.preheader, label %for.end38

for.cond1.preheader.us.preheader:                 ; preds = %entry
  %0 = zext i32 %n to i64
  %xtraiter24 = and i64 %0, 1
  %lcmp.mod25 = icmp eq i64 %xtraiter24, 0
  %1 = icmp eq i32 %n, 1
  %wide.trip.count18.1 = zext i32 %n to i64
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc12_crit_edge.us, %for.cond1.preheader.us.preheader
  ...
  %arrayidx.us = getelementptr inbounds double, double* %x1, i64 %indvars.iv20
  br i1 %lcmp.mod25, label %for.body3.us.prol.loopexit, label %for.body3.us.prol

for.body3.us.prol:                                ; preds = %for.cond1.preheader.us
  %2 = load double, double* %arrayidx.us, align 8
  %arrayidx7.us.prol = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv20, i64 0
...
for.body3.us.prol.loopexit:                       ; preds = %for.body3.us.prol, %for.cond1.preheader.us
  %indvars.iv16.unr.ph = phi i64 [ 1, %for.body3.us.prol ], [ 0, %for.cond1.preheader.us ]
  br i1 %1, label %for.cond1.for.inc12_crit_edge.us, label %for.body3.us.preheader

for.body3.us.preheader:                           ; preds = %for.body3.us.prol.loopexit
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us.preheader, %for.body3.us
  %indvars.iv16 = phi i64 [ %indvars.iv.next17.1, %for.body3.us ], [ %indvars.iv16.unr.ph, %for.body3.us.preheader ]
  %5 = load double, double* %arrayidx.us, align 8
  %arrayidx7.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv20, i64 %indvars.iv16
  %6 = load double, double* %arrayidx7.us, align 8
  %arrayidx9.us = getelementptr inbounds double, double* %y_1, i64 %indvars.iv16
  ...
  %arrayidx7.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv20, i64 %indvars.iv.next17
  %8 = load double, double* %arrayidx7.us.1, align 8
  %arrayidx9.us.1 = getelementptr inbounds double, double* %y_1, i64 %indvars.iv.next17
  ...
  %exitcond19.1 = icmp eq i64 %indvars.iv.next17.1, %wide.trip.count18.1
  br i1 %exitcond19.1, label %for.cond1.for.inc12_crit_edge.us.loopexit, label %for.body3.us

for.cond1.for.inc12_crit_edge.us.loopexit:        ; preds = %for.body3.us
  br label %for.cond1.for.inc12_crit_edge.us

for.cond1.for.inc12_crit_edge.us:                 ; preds = %for.cond1.for.inc12_crit_edge.us.loopexit, %for.body3.us.prol.loopexit
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  %exitcond26 = icmp eq i64 %indvars.iv.next21, %0
  br i1 %exitcond26, label %for.cond15.preheader, label %for.cond1.preheader.us

for.cond15.preheader:                             ; preds = %for.cond1.for.inc12_crit_edge.us
  %cmp166 = icmp sgt i32 %n, 0
  br i1 %cmp166, label %for.cond18.preheader.us.preheader, label %for.end38
...
for.cond18.preheader.us:                          ; preds = %for.cond18.for.inc36_crit_edge.us, %for.cond18.preheader.us.preheader
  %indvars.iv12 = phi i64 [ 0, %for.cond18.preheader.us.preheader ], [ %indvars.iv.next13, %for.cond18.for.inc36_crit_edge.us ]
  %arrayidx22.us = getelementptr inbounds double, double* %x2, i64 %indvars.iv12
...
for.body20.us.prol:                               ; preds = %for.cond18.preheader.us
  ...
  %arrayidx26.us.prol = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 0, i64 %indvars.iv12
...
for.body20.us.prol.loopexit:                      ; preds = %for.body20.us.prol, %for.cond18.preheader.us
  ...
  br i1 %11, label %for.cond18.for.inc36_crit_edge.us, label %for.body20.us.preheader
...
for.body20.us:                                    ; preds = %for.body20.us.preheader, %for.body20.us
  ...
  %arrayidx26.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv, i64 %indvars.iv12
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx26.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv.next, i64 %indvars.iv12
  ...
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, %wide.trip.count.1
  br i1 %exitcond.1, label %for.cond18.for.inc36_crit_edge.us.loopexit, label %for.body20.us

for.cond18.for.inc36_crit_edge.us.loopexit:       ; preds = %for.body20.us
  br label %for.cond18.for.inc36_crit_edge.us

for.cond18.for.inc36_crit_edge.us:                ; preds = %for.cond18.for.inc36_crit_edge.us.loopexit, %for.body20.us.prol.loopexit
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %exitcond = icmp eq i64 %indvars.iv.next13, %10
...
for.body:                                         ; preds = %if.end, %for.body.preheader
  %indvars.iv9 = phi i64 [ 0, %for.body.preheader ], [ %indvars.iv.next10, %if.end ]
...
if.then:                                          ; preds = %for.body
  ...
  %fputc4 = tail call i32 @fputc(i32 10, %struct._IO_FILE* %5) #5
  br label %if.end
...
if.end:                                           ; preds = %for.body, %if.then
  ...
  %exitcond = icmp eq i64 %indvars.iv.next10, %3
...
for.end:                                          ; preds = %for.end.loopexit, %entry
  ...
  br i1 %cmp85, label %for.body9.preheader, label %for.end20
...
if.end14:                                         ; preds = %for.body9, %if.then12
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond13 = icmp eq i64 %indvars.iv.next, %10
  br i1 %exitcond13, label %for.end20.loopexit, label %for.body9
...
for.end20:                                        ; preds = %for.end20.loopexit, %for.end
  ...
  %call21 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %15, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.7, i64 0, i64 0)) #6
