...
; <label>:14:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond21, label %._crit_edge24.preheader, label %._crit_edge22

._crit_edge24.preheader:                          ; preds = %14
  br label %._crit_edge24

._crit_edge24:                                    ; preds = %._crit_edge24.preheader, %27
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %27 ], [ 0, %._crit_edge24.preheader ]
  br label %._crit_edge23

._crit_edge23:                                    ; preds = %._crit_edge23, %._crit_edge24
  %indvars.iv10 = phi i64 [ 0, %._crit_edge24 ], [ %indvars.iv.next11.1, %._crit_edge23 ]
  ...
  br i1 %exitcond12.1, label %27, label %._crit_edge23

; <label>:27:                                     ; preds = %._crit_edge23
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 1100
  br i1 %exitcond15, label %._crit_edge26.preheader, label %._crit_edge24

._crit_edge26.preheader:                          ; preds = %27
  br label %._crit_edge26

._crit_edge26:                                    ; preds = %._crit_edge26.preheader, %36
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %36 ], [ 0, %._crit_edge26.preheader ]
  br label %._crit_edge25

._crit_edge25:                                    ; preds = %._crit_edge25, %._crit_edge26
  %indvars.iv4 = phi i64 [ 0, %._crit_edge26 ], [ %indvars.iv.next5, %._crit_edge25 ]
  ...
  br i1 %exitcond6, label %36, label %._crit_edge25

; <label>:36:                                     ; preds = %._crit_edge25
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %exitcond9 = icmp eq i64 %indvars.iv.next8, 900
  br i1 %exitcond9, label %._crit_edge28.preheader, label %._crit_edge26

._crit_edge28.preheader:                          ; preds = %36
  br label %._crit_edge28

._crit_edge28:                                    ; preds = %._crit_edge28.preheader, %44
  %indvars.iv1 = phi i64 [ %indvars.iv.next2, %44 ], [ 0, %._crit_edge28.preheader ]
  br label %._crit_edge27

._crit_edge27:                                    ; preds = %._crit_edge27, %._crit_edge28
  %indvars.iv = phi i64 [ 0, %._crit_edge28 ], [ %indvars.iv.next, %._crit_edge27 ]
...
; <label>:44:                                     ; preds = %._crit_edge27
  ...
  br i1 %exitcond3, label %45, label %._crit_edge28
...
._crit_edge17:                                    ; preds = %25, %7
  %indvars.iv13 = phi i64 [ 0, %7 ], [ %indvars.iv.next14, %25 ]
  br label %._crit_edge16

._crit_edge16:                                    ; preds = %24, %._crit_edge17
  %indvars.iv10 = phi i64 [ 0, %._crit_edge17 ], [ %indvars.iv.next11, %24 ]
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge16
  %indvars.iv7 = phi i64 [ 0, %._crit_edge16 ], [ %indvars.iv.next8.1, %._crit_edge ]
...
; <label>:24:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond12, label %25, label %._crit_edge16

; <label>:25:                                     ; preds = %24
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 800
  br i1 %exitcond15, label %._crit_edge20.preheader, label %._crit_edge17

._crit_edge20.preheader:                          ; preds = %25
  br label %._crit_edge20

._crit_edge20:                                    ; preds = %._crit_edge20.preheader, %49
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %49 ], [ 0, %._crit_edge20.preheader ]
  br label %._crit_edge19

._crit_edge19:                                    ; preds = %48, %._crit_edge20
  %indvars.iv1 = phi i64 [ 0, %._crit_edge20 ], [ %indvars.iv.next2, %48 ]
...
; <label>:49:                                     ; preds = %48
  ...
  br i1 %exitcond6, label %50, label %._crit_edge20
