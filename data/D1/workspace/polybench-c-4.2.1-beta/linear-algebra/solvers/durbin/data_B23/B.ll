...
._crit_edge7:                                     ; preds = %._crit_edge7, %.lr.ph.new
  ...
  br i1 %exitcond.3, label %._crit_edge.loopexit.unr-lcssa, label %._crit_edge7
...
.lr.ph:                                           ; preds = %._crit_edge51, %.lr.ph56.preheader
  ...
  %indvar = phi i64 [ 0, %.lr.ph56.preheader ], [ %54, %._crit_edge51 ]
  %.04253 = phi double [ 1.000000e+00, %.lr.ph56.preheader ], [ %56, %._crit_edge51 ]
  %.04352 = phi double [ %9, %.lr.ph56.preheader ], [ %61, %._crit_edge51 ]
  %13 = add i64 %indvar, 1
  %14 = fmul double %.04352, %.04352
...
._crit_edge76.prol:                               ; preds = %._crit_edge76.prol, %._crit_edge76.prol.preheader
  ...
  %.04144.prol = phi double [ 0.000000e+00, %._crit_edge76.prol.preheader ], [ %22, %._crit_edge76.prol ]
...
._crit_edge76.prol.loopexit:                      ; preds = %.lr.ph, %._crit_edge76.prol.loopexit.unr-lcssa
  %.lcssa.unr = phi double [ undef, %.lr.ph ], [ %22, %._crit_edge76.prol.loopexit.unr-lcssa ]
  %indvars.iv.unr = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next.prol, %._crit_edge76.prol.loopexit.unr-lcssa ]
  %.04144.unr = phi double [ 0.000000e+00, %.lr.ph ], [ %22, %._crit_edge76.prol.loopexit.unr-lcssa ]
  %23 = icmp ult i64 %indvar, 3
  br i1 %23, label %.lr.ph48, label %.lr.ph.new
...
._crit_edge76:                                    ; preds = %._crit_edge76, %.lr.ph.new
  ...
  %.04144 = phi double [ %.04144.unr, %.lr.ph.new ], [ %51, %._crit_edge76 ]
...
.lr.ph48:                                         ; preds = %._crit_edge76.prol.loopexit, %.lr.ph48.unr-lcssa
  %.lcssa = phi double [ %.lcssa.unr, %._crit_edge76.prol.loopexit ], [ %51, %.lr.ph48.unr-lcssa ]
  %52 = shl i64 %indvar, 3
  %53 = fsub double 1.000000e+00, %14
  %54 = add nuw nsw i64 %indvar, 1
  %55 = add nuw nsw i64 %52, 8
  %56 = fmul double %.04253, %53
  %57 = getelementptr inbounds double, double* %1, i64 %indvars.iv72
...
vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert83 = insertelement <2 x double> undef, double %61, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load79 = load <2 x double>, <2 x double>* %65, align 8
  %66 = sub nsw i64 %15, %index
  %67 = getelementptr inbounds double, double* %2, i64 %66
  %68 = getelementptr double, double* %67, i64 -1
  %69 = bitcast double* %68 to <2 x double>*
  %wide.load80 = load <2 x double>, <2 x double>* %69, align 8
  ...
  %wide.load81 = load <2 x double>, <2 x double>* %72, align 8
  %reverse82 = shufflevector <2 x double> %wide.load81, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %73 = fmul <2 x double> %broadcast.splat84, %reverse
  %74 = fmul <2 x double> %broadcast.splat84, %reverse82
  %75 = fadd <2 x double> %wide.load, %73
  %76 = fadd <2 x double> %wide.load79, %74
...
._crit_edge77:                                    ; preds = %._crit_edge77.preheader, %._crit_edge77
  ...
  %82 = getelementptr inbounds double, double* %2, i64 %indvars.iv60
  %83 = load double, double* %82, align 8
  %84 = sub nsw i64 %15, %indvars.iv60
  %85 = getelementptr inbounds double, double* %2, i64 %84
  %86 = load double, double* %85, align 8
  %87 = fmul double %61, %86
  %88 = fadd double %83, %87
  %89 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 0, i64 %indvars.iv60
...
._crit_edge51:                                    ; preds = %._crit_edge51.loopexit, %middle.block
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull %12, i8* nonnull %11, i64 %55, i32 8, i1 false)
  %90 = getelementptr inbounds double, double* %2, i64 %indvars.iv72
  store double %61, double* %90, align 8
  %exitcond75 = icmp eq i64 %54, %wide.trip.count74
