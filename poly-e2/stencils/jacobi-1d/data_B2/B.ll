...
entry:
  ...
  tail call void @init_array(i32 2000, double* %arraydecay, double* %arraydecay2)
  tail call void (...) @polybench_timer_start() #4
  tail call void @kernel_jacobi_1d(i32 500, i32 2000, double* %arraydecay, double* %arraydecay2)
...
if.then:                                          ; preds = %land.lhs.true
  tail call void @print_array(i32 2000, double* %arraydecay)
  br label %if.end
...
define internal void @init_array(i32 %n, double* %A, double* %B) #2 {
entry:
...
vector.memcheck:                                  ; preds = %min.iters.checked
  ...
  br i1 %memcheck.conflict, label %for.inc.preheader, label %vector.ph
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal void @kernel_jacobi_1d(i32 %tsteps, i32 %n, double* %A, double* %B) #2 {
entry:
...
for.inc.us.preheader:                             ; preds = %for.inc.us.prol.loopexit
  ...
  br i1 %min.iters.check70, label %for.inc.us.preheader113, label %min.iters.checked71

for.inc.us.preheader113:                          ; preds = %middle.block68, %vector.memcheck91, %min.iters.checked71, %for.inc.us.preheader
  %indvars.iv.ph = phi i64 [ %indvars.iv.unr.ph, %vector.memcheck91 ], [ %indvars.iv.unr.ph, %min.iters.checked71 ], [ %indvars.iv.unr.ph, %for.inc.us.preheader ], [ %ind.end96, %middle.block68 ]
  br label %for.inc.us

min.iters.checked71:                              ; preds = %for.inc.us.preheader
  %n.mod.vf72 = and i64 %15, 1
  %n.vec73 = sub i64 %15, %n.mod.vf72
  %cmp.zero74 = icmp eq i64 %n.vec73, 0
  br i1 %cmp.zero74, label %for.inc.us.preheader113, label %vector.memcheck91
...
vector.memcheck91:                                ; preds = %min.iters.checked71
  ...
  br i1 %memcheck.conflict90, label %for.inc.us.preheader113, label %vector.body67.preheader
...
middle.block68:                                   ; preds = %vector.body67
  ...
  br i1 %cmp.n97, label %for.inc30.us.preheader, label %for.inc.us.preheader113
...
for.inc30.us:                                     ; preds = %for.inc30.us.preheader112, %for.inc30.us
  %indvars.iv28 = phi i64 [ %indvars.iv.next29.1, %for.inc30.us ], [ %indvars.iv28.ph, %for.inc30.us.preheader112 ]
  ...
  br i1 %exitcond.135, label %for.inc33.us.loopexit, label %for.inc30.us, !llvm.loop !18

for.inc.us:                                       ; preds = %for.inc.us.preheader113, %for.inc.us
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %for.inc.us ], [ %indvars.iv.ph, %for.inc.us.preheader113 ]
...
for.inc30.us.preheader:                           ; preds = %for.inc30.us.preheader.loopexit, %for.inc.us.prol.loopexit, %middle.block68
  br i1 %lcmp.mod33, label %for.inc30.us.prol.loopexit, label %for.inc30.us.prol
...
for.inc30.us.prol.loopexit:                       ; preds = %for.inc30.us.prol, %for.inc30.us.preheader
  %indvars.iv28.unr.ph = phi i64 [ 2, %for.inc30.us.prol ], [ 1, %for.inc30.us.preheader ]
  br i1 %5, label %for.inc33.us, label %for.inc30.us.preheader47

for.inc30.us.preheader47:                         ; preds = %for.inc30.us.prol.loopexit
  %60 = sub nsw i64 %6, %indvars.iv28.unr.ph
  %61 = lshr i64 %60, 1
  %62 = add nuw i64 %61, 1
  %min.iters.check = icmp ult i64 %62, 2
  br i1 %min.iters.check, label %for.inc30.us.preheader112, label %min.iters.checked

for.inc30.us.preheader112:                        ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.inc30.us.preheader47
  %indvars.iv28.ph = phi i64 [ %indvars.iv28.unr.ph, %vector.memcheck ], [ %indvars.iv28.unr.ph, %min.iters.checked ], [ %indvars.iv28.unr.ph, %for.inc30.us.preheader47 ], [ %ind.end, %middle.block ]
  br label %for.inc30.us

min.iters.checked:                                ; preds = %for.inc30.us.preheader47
  %n.mod.vf = and i64 %62, 1
  %n.vec = sub i64 %62, %n.mod.vf
  %cmp.zero = icmp eq i64 %n.vec, 0
  br i1 %cmp.zero, label %for.inc30.us.preheader112, label %vector.memcheck
...
vector.memcheck:                                  ; preds = %min.iters.checked
  ...
  br i1 %memcheck.conflict, label %for.inc30.us.preheader112, label %vector.body.preheader
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.inc33.us, label %for.inc30.us.preheader112
