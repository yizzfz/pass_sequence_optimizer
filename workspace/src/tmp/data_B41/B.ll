...
; <label>:18:                                     ; preds = %.loopexit2, %9
  %19 = phi i64 [ 0, %9 ], [ %102, %.loopexit2 ]
  %20 = icmp sgt i32 %10, 0
  %21 = trunc i64 %19 to i32
  %22 = mul i64 %19, 1202590842880
  %23 = ashr exact i64 %22, 32
  %24 = getelementptr i8, i8* %1, i64 %23
  br i1 %20, label %25, label %.loopexit2

; <label>:25:                                     ; preds = %18
  %26 = icmp sgt i32 %2, 0
  %27 = mul nuw nsw i64 %19, 280
  br i1 %26, label %.preheader1.preheader, label %29

.preheader1.preheader:                            ; preds = %25
  %sext = shl i64 %19, 32
  %28 = ashr exact i64 %sext, 32
  br label %.preheader1

; <label>:29:                                     ; preds = %25
  tail call void @llvm.memset.p0i8.i64(i8* %24, i8 0, i64 %13, i32 1, i1 false)
  br label %.loopexit2

.preheader1:                                      ; preds = %.preheader1.preheader, %.us-lcssa.us
  %30 = phi i64 [ %65, %.us-lcssa.us ], [ 0, %.preheader1.preheader ]
  %31 = icmp eq i64 %17, 0
  %32 = trunc i64 %30 to i32
  br i1 %31, label %.split.us, label %.split.preheader
...
.split.us:                                        ; preds = %.preheader1
  %33 = icmp eq i32 %2, 1
  br i1 %33, label %.us-lcssa.us, label %.split.us.split.preheader
...
.us-lcssa.us.loopexit23:                          ; preds = %.loopexit
  br label %.us-lcssa.us

.us-lcssa.us:                                     ; preds = %.us-lcssa.us.loopexit23, %.us-lcssa.us.loopexit, %.split.us
  %.lcssa4 = phi float [ undef, %.split.us ], [ %57, %.us-lcssa.us.loopexit ], [ %79, %.us-lcssa.us.loopexit23 ]
  %62 = fptoui float %.lcssa4 to i8
  %63 = add nuw nsw i64 %30, %27
...
.split:                                           ; preds = %.split.preheader, %.loopexit
  ...
  %67 = phi float [ %79, %.loopexit ], [ 0.000000e+00, %.split.preheader ]
  %68 = icmp eq i32 %2, 1
  %69 = add nuw nsw i64 %indvars.iv, %28
  ...
  %77 = fmul float %6, %76
  %78 = fadd float %67, %77
  br i1 %68, label %.loopexit, label %.preheader.preheader
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %.split
  ...
  br i1 %80, label %.us-lcssa.us.loopexit23, label %.split
...
.loopexit2:                                       ; preds = %.loopexit2.loopexit, %29, %18
  %102 = add nuw nsw i64 %19, 1
  %103 = icmp eq i64 %102, %16
  br i1 %103, label %.loopexit3.loopexit, label %18
}
...
; <label>:25:                                     ; preds = %3
  ...
  %sunkaddr2 = add i64 %27, %5
  %sunkaddr3 = add i64 %sunkaddr2, -1
  %sunkaddr4 = inttoptr i64 %sunkaddr3 to <16 x i8>*
  %28 = load <16 x i8>, <16 x i8>* %sunkaddr4, align 1, !tbaa !1, !alias.scope !13
  %sunkaddr7 = add i64 %sunkaddr2, 15
  %sunkaddr8 = inttoptr i64 %sunkaddr7 to <16 x i8>*
  %29 = load <16 x i8>, <16 x i8>* %sunkaddr8, align 1, !tbaa !1, !alias.scope !13
  %sunkaddr10 = add i64 %26, %5
  %sunkaddr11 = inttoptr i64 %sunkaddr10 to <16 x i8>*
  store <16 x i8> %28, <16 x i8>* %sunkaddr11, align 1, !tbaa !1, !alias.scope !16, !noalias !13
  %sunkaddr14 = add i64 %sunkaddr10, 16
  %sunkaddr15 = inttoptr i64 %sunkaddr14 to <16 x i8>*
  store <16 x i8> %29, <16 x i8>* %sunkaddr15, align 1, !tbaa !1, !alias.scope !16, !noalias !13
...
; <label>:117:                                    ; preds = %.preheader, %117
  %118 = phi i64 [ %138, %117 ], [ %21, %.preheader ]
  %119 = add i64 %118, %5
