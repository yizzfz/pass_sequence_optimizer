...
.preheader:                                       ; preds = %18, %1
  %indvars.iv25 = phi i64 [ 0, %1 ], [ %indvars.iv.next26, %18 ]
  br label %2
...
; <label>:2:                                      ; preds = %2, %.preheader
  ...
  %5 = srem i32 %4, 7
  %6 = add nsw i32 %5, 1
  %7 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv25, i64 %indvars.iv
  %8 = add nuw nsw i64 %indvars.iv, %indvars.iv25
  ...
  %16 = srem i32 %15, 11
  %17 = icmp eq i32 %16, 0
  %or.cond22 = or i1 %17, %or.cond
  %. = select i1 %or.cond22, i32 999, i32 %6
...
; <label>:18:                                     ; preds = %2
  ...
  br i1 %exitcond27, label %19, label %.preheader
...
.preheader31:                                     ; preds = %19, %1
  %indvars.iv37 = phi i64 [ 0, %1 ], [ %indvars.iv.next38, %19 ]
  br label %.preheader

.preheader:                                       ; preds = %18, %.preheader31
  %indvars.iv35 = phi i64 [ 0, %.preheader31 ], [ %indvars.iv.next36, %18 ]
...
; <label>:3:                                      ; preds = %3, %.preheader
  ...
  %4 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv35, i64 %indvars.iv
  %5 = load i32, i32* %4, align 4
  %6 = load i32, i32* %2, align 4
  %7 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv37, i64 %indvars.iv
  ...
  %11 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv35, i64 %indvars.iv.next
  %12 = load i32, i32* %11, align 4
  %13 = load i32, i32* %2, align 4
  %14 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv37, i64 %indvars.iv.next
...
; <label>:19:                                     ; preds = %18
  ...
  br i1 %exitcond39, label %20, label %.preheader31
...
.preheader:                                       ; preds = %19, %1
  %indvars.iv14 = phi i64 [ 0, %1 ], [ %indvars.iv.next15, %19 ]
...
; <label>:14:                                     ; preds = %7, %12
  ...
  %16 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv14, i64 %indvars.iv
...
; <label>:19:                                     ; preds = %14
  ...
  br i1 %exitcond16, label %20, label %.preheader
