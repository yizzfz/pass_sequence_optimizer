...
; <label>:39:                                     ; preds = %39, %.lr.ph28.split.us
  ...
  %exitcond135.1 = icmp eq i64 %indvars.iv.next133.1, 2160
  br i1 %exitcond135.1, label %._crit_edge26.us, label %39
...
.preheader1.us:                                   ; preds = %.preheader1.us.preheader, %._crit_edge17.us
  ...
  %scevgep146 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv120, i64 2
  %scevgep152 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv120, i64 2
  %scevgep158 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv120, i64 2
...
.preheader1.us.new.preheader:                     ; preds = %.prol.loopexit117
  ...
  br i1 false, label %.preheader1.us.new.preheader222, label %min.iters.checked

min.iters.checked:                                ; preds = %.preheader1.us.new.preheader
  %n.mod.vf = and i64 %93, 3
  %n.vec = sub nsw i64 %93, %n.mod.vf
  br i1 false, label %.preheader1.us.new.preheader222, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %scevgep144 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv120, i64 %indvars.iv112.unr.ph
  %94 = sub nsw i64 2158, %indvars.iv112.unr.ph
  %95 = and i64 %94, 2158
  %96 = or i64 %indvars.iv112.unr.ph, %95
  %scevgep147 = getelementptr float, float* %scevgep146, i64 %96
  %scevgep150 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv120, i64 %indvars.iv112.unr.ph
  %scevgep153 = getelementptr float, float* %scevgep152, i64 %96
  %scevgep156 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv120, i64 %indvars.iv112.unr.ph
  %scevgep159 = getelementptr float, float* %scevgep158, i64 %96
  %bound0 = icmp ult float* %scevgep144, %scevgep153
  %bound1 = icmp ult float* %scevgep150, %scevgep147
  %found.conflict = and i1 %bound0, %bound1
  %bound0161 = icmp ult float* %scevgep144, %scevgep159
  %bound1162 = icmp ult float* %scevgep156, %scevgep147
  ...
  br i1 %conflict.rdx, label %.preheader1.us.new.preheader222, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.vec165 = load <8 x float>, <8 x float>* %105, align 4, !alias.scope !9
  %106 = fadd <8 x float> %wide.vec, %wide.vec165
  %107 = shufflevector <8 x float> %106, <8 x float> undef, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %108 = add nuw nsw i64 %offset.idx, 1
  %109 = fadd <8 x float> %wide.vec, %wide.vec165
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %._crit_edge17.us, label %.preheader1.us.new.preheader222

.preheader1.us.new.preheader222:                  ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.preheader1.us.new.preheader
...
.preheader1.us.new:                               ; preds = %.preheader1.us.new.preheader222, %.preheader1.us.new
  %indvars.iv112 = phi i64 [ %indvars.iv.next113.1, %.preheader1.us.new ], [ %indvars.iv112.ph, %.preheader1.us.new.preheader222 ]
...
; <label>:127:                                    ; preds = %127, %.lr.ph14.split.us
  ...
  %exitcond106.1 = icmp eq i64 %indvars.iv.next104.1, 4096
  br i1 %exitcond106.1, label %._crit_edge13.us, label %127
...
._crit_edge7.us:                                  ; preds = %153
  ...
  br i1 %exitcond101, label %._crit_edge10.loopexit, label %.lr.ph9.split.us

._crit_edge10.loopexit:                           ; preds = %._crit_edge7.us
  br label %._crit_edge10

._crit_edge10:                                    ; preds = %._crit_edge10.loopexit, %.preheader, %.lr.ph9, %._crit_edge15
  %179 = phi i1 [ false, %._crit_edge15 ], [ true, %.lr.ph9 ], [ false, %.preheader ], [ true, %._crit_edge10.loopexit ]
  br i1 %179, label %.lr.ph3.split.us.preheader, label %._crit_edge4
...
.lr.ph3.split.us:                                 ; preds = %.lr.ph3.split.us.preheader, %._crit_edge.us
  ...
  %scevgep180 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv92, i64 2
  %scevgep186 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv92, i64 2
  %scevgep192 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv92, i64 2
...
.lr.ph3.split.us.new.preheader:                   ; preds = %.prol.loopexit
  ...
  br i1 false, label %.lr.ph3.split.us.new.preheader221, label %min.iters.checked172

min.iters.checked172:                             ; preds = %.lr.ph3.split.us.new.preheader
  %n.mod.vf173 = and i64 %182, 3
  %n.vec174 = sub nsw i64 %182, %n.mod.vf173
  br i1 false, label %.lr.ph3.split.us.new.preheader221, label %vector.memcheck203

vector.memcheck203:                               ; preds = %min.iters.checked172
  %scevgep178 = getelementptr [2160 x float], [2160 x float]* %4, i64 %indvars.iv92, i64 %indvars.iv.unr.ph
  %183 = sub nsw i64 2158, %indvars.iv.unr.ph
  %184 = and i64 %183, 2158
  %185 = or i64 %indvars.iv.unr.ph, %184
  %scevgep181 = getelementptr float, float* %scevgep180, i64 %185
  %scevgep184 = getelementptr [2160 x float], [2160 x float]* %5, i64 %indvars.iv92, i64 %indvars.iv.unr.ph
  %scevgep187 = getelementptr float, float* %scevgep186, i64 %185
  %scevgep190 = getelementptr [2160 x float], [2160 x float]* %6, i64 %indvars.iv92, i64 %indvars.iv.unr.ph
  %scevgep193 = getelementptr float, float* %scevgep192, i64 %185
  %bound0195 = icmp ult float* %scevgep178, %scevgep187
  %bound1196 = icmp ult float* %scevgep184, %scevgep181
  %found.conflict197 = and i1 %bound0195, %bound1196
  %bound0198 = icmp ult float* %scevgep178, %scevgep193
  %bound1199 = icmp ult float* %scevgep190, %scevgep181
  ...
  %189 = shl nuw nsw i64 %n.mod.vf173, 1
  %ind.end208 = sub nsw i64 %188, %189
  br i1 %conflict.rdx201, label %.lr.ph3.split.us.new.preheader221, label %vector.body168.preheader

vector.body168.preheader:                         ; preds = %vector.memcheck203
  br label %vector.body168

vector.body168:                                   ; preds = %vector.body168.preheader, %vector.body168
  %index205 = phi i64 [ %index.next206, %vector.body168 ], [ 0, %vector.body168.preheader ]
  %190 = shl i64 %index205, 1
  %offset.idx210 = or i64 %indvars.iv.unr.ph, %190
  %191 = getelementptr inbounds [2160 x float], [2160 x float]* %5, i64 %indvars.iv92, i64 %offset.idx210
  %192 = bitcast float* %191 to <8 x float>*
  %wide.vec214 = load <8 x float>, <8 x float>* %192, align 4, !alias.scope !16
  %193 = getelementptr inbounds [2160 x float], [2160 x float]* %6, i64 %indvars.iv92, i64 %offset.idx210
  %194 = bitcast float* %193 to <8 x float>*
  %wide.vec217 = load <8 x float>, <8 x float>* %194, align 4, !alias.scope !19
  %195 = fadd <8 x float> %wide.vec214, %wide.vec217
  %196 = shufflevector <8 x float> %195, <8 x float> undef, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %197 = add nuw nsw i64 %offset.idx210, 1
  %198 = fadd <8 x float> %wide.vec214, %wide.vec217
  ...
  %interleaved.vec220 = shufflevector <4 x float> %196, <4 x float> %199, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x float> %interleaved.vec220, <8 x float>* %202, align 4, !alias.scope !21, !noalias !23
  %index.next206 = add i64 %index205, 4
  %203 = icmp eq i64 %index.next206, %n.vec174
  br i1 %203, label %middle.block169, label %vector.body168, !llvm.loop !24

middle.block169:                                  ; preds = %vector.body168
  %cmp.n209 = icmp eq i64 %n.mod.vf173, 0
  br i1 %cmp.n209, label %._crit_edge.us, label %.lr.ph3.split.us.new.preheader221

.lr.ph3.split.us.new.preheader221:                ; preds = %middle.block169, %vector.memcheck203, %min.iters.checked172, %.lr.ph3.split.us.new.preheader
  %indvars.iv.ph = phi i64 [ %indvars.iv.unr.ph, %vector.memcheck203 ], [ %indvars.iv.unr.ph, %min.iters.checked172 ], [ %indvars.iv.unr.ph, %.lr.ph3.split.us.new.preheader ], [ %ind.end208, %middle.block169 ]
  br label %.lr.ph3.split.us.new

.lr.ph3.split.us.new:                             ; preds = %.lr.ph3.split.us.new.preheader221, %.lr.ph3.split.us.new
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.lr.ph3.split.us.new ], [ %indvars.iv.ph, %.lr.ph3.split.us.new.preheader221 ]
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %middle.block169, %.prol.loopexit
