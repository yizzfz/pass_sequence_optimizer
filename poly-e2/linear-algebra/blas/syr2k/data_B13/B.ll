...
for.inc.lr.ph.preheader:                          ; preds = %for.cond1.preheader.lr.ph
  ...
  %mul.v.i1.2.prol = shufflevector <2 x double> %0, <2 x double> undef, <2 x i32> zeroinitializer
  ...
  %mul.v.i1.2.1 = shufflevector <2 x double> %2, <2 x double> undef, <2 x i32> zeroinitializer
...
for.inc.lr.ph.us.preheader:                       ; preds = %for.cond1.preheader.lr.ph
  ...
  %mul.us.v.i1.2.prol = shufflevector <2 x double> %3, <2 x double> undef, <2 x i32> zeroinitializer
  %4 = insertelement <2 x double> undef, double %beta, i32 0
  %mul.us.v.i1.2 = shufflevector <2 x double> %4, <2 x double> undef, <2 x i32> zeroinitializer
  %5 = insertelement <2 x double> undef, double %beta, i32 0
  %mul.us.v.i1.2.1 = shufflevector <2 x double> %5, <2 x double> undef, <2 x i32> zeroinitializer
...
for.inc.us:                                       ; preds = %for.inc.us, %for.inc.us.preheader.new
  ...
  %8 = bitcast double* %arrayidx5.us.2 to <2 x double>*
  %9 = load <2 x double>, <2 x double>* %8, align 8
  %mul.us.2 = fmul <2 x double> %9, %mul.us.v.i1.2
  store <2 x double> %mul.us.2, <2 x double>* %8, align 8
  ...
  %mul.us.1 = fmul <2 x double> %11, %mul.us.v.i1.2.1
  store <2 x double> %mul.us.1, <2 x double>* %10, align 8
  ...
  %12 = bitcast double* %arrayidx5.us.2.1 to <2 x double>*
  %13 = load <2 x double>, <2 x double>* %12, align 8
  %mul.us.2.1 = fmul <2 x double> %13, %mul.us.v.i1.2.1
  store <2 x double> %mul.us.2.1, <2 x double>* %12, align 8
...
for.cond9.preheader.us12:                         ; preds = %for.cond9.preheader.us12.preheader, %for.cond9.for.inc40_crit_edge.us35
  ...
  %14 = add nuw nsw i64 %indvars.iv47, 1
  %scevgep79 = getelementptr [1000 x double], [1000 x double]* %A, i64 %indvars.iv54, i64 %14
  %scevgep81 = getelementptr [1000 x double], [1000 x double]* %B, i64 0, i64 %indvars.iv47
  %scevgep83 = getelementptr [1000 x double], [1000 x double]* %B, i64 %indvars.iv54, i64 %14
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %15 = or i64 %index, 1
  %16 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %index, i64 %indvars.iv47
  %17 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %15, i64 %indvars.iv47
  %18 = load double, double* %16, align 8, !alias.scope !1
  %19 = load double, double* %17, align 8, !alias.scope !1
  %20 = insertelement <2 x double> undef, double %18, i32 0
  %21 = insertelement <2 x double> %20, double %19, i32 1
  %22 = fmul <2 x double> %21, %broadcast.splat100
  %23 = load double, double* %arrayidx20.us33, align 8, !alias.scope !4
  ...
  %27 = getelementptr inbounds [1000 x double], [1000 x double]* %B, i64 %index, i64 %indvars.iv47
  %28 = getelementptr inbounds [1000 x double], [1000 x double]* %B, i64 %15, i64 %indvars.iv47
  %29 = load double, double* %27, align 8, !alias.scope !6
  %30 = load double, double* %28, align 8, !alias.scope !6
  %31 = insertelement <2 x double> undef, double %29, i32 0
  %32 = insertelement <2 x double> %31, double %30, i32 1
  %33 = fmul <2 x double> %32, %broadcast.splat100
  %34 = load double, double* %arrayidx30.us34, align 8, !alias.scope !8
  ...
  %39 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv54, i64 %index
  %40 = bitcast double* %39 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %40, align 8, !alias.scope !10, !noalias !12
  %41 = fadd <2 x double> %wide.load, %38
  %42 = bitcast double* %39 to <2 x double>*
  store <2 x double> %41, <2 x double>* %42, align 8, !alias.scope !10, !noalias !12
...
for.inc37.us14:                                   ; preds = %for.inc37.us14.preheader, %for.inc37.us14
  ...
  %44 = load double, double* %arrayidx15.us17, align 8
  %mul16.us18 = fmul double %44, %alpha
  %45 = load double, double* %arrayidx20.us33, align 8
  %mul21.us19 = fmul double %mul16.us18, %45
  %arrayidx25.us20 = getelementptr inbounds [1000 x double], [1000 x double]* %B, i64 %indvars.iv42, i64 %indvars.iv47
  %46 = load double, double* %arrayidx25.us20, align 8
  %mul26.us21 = fmul double %46, %alpha
  %47 = load double, double* %arrayidx30.us34, align 8
  %mul31.us22 = fmul double %mul26.us21, %47
  ...
  %48 = load double, double* %arrayidx35.us24, align 8
  %add36.us25 = fadd double %48, %add.us23
...
for.inc.lr.ph.us:                                 ; preds = %for.inc.lr.ph.us.preheader, %for.cond6.for.inc43_crit_edge.us
  %indvars.iv120 = phi i2 [ 1, %for.inc.lr.ph.us.preheader ], [ %indvars.iv.next, %for.cond6.for.inc43_crit_edge.us ]
  ...
  %49 = zext i2 %indvars.iv120 to i32
  %50 = add i32 %49, -1
  %51 = zext i32 %50 to i64
  %52 = add i64 %51, 1
  %53 = add nsw i64 %indvars.iv54, -3
  %scevgep = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv54, i64 0
  %54 = mul i64 %indvars.iv54, 1201
  %55 = add i64 %54, 1
  %scevgep75 = getelementptr [1200 x double], [1200 x double]* %C, i64 0, i64 %55
  %56 = add nuw nsw i64 %indvars.iv54, 1
  %indvars.iv.next55 = add nuw nsw i64 %indvars.iv54, 1
  %57 = trunc i64 %indvars.iv.next55 to i32
...
for.inc.us.prol:                                  ; preds = %for.inc.us.prol.preheader, %for.inc.us.prol
  ...
  %58 = load double, double* %arrayidx5.us.prol, align 8
  %mul.us.prol = fmul double %58, %beta
...
for.inc.us.prol.loopexit:                         ; preds = %for.inc.us.prol.loopexit.loopexit, %for.inc.lr.ph.us
  ...
  %59 = icmp ult i64 %indvars.iv54, 3
  br i1 %59, label %for.cond9.preheader.us12.preheader, label %for.inc.us.preheader

for.inc.us.preheader:                             ; preds = %for.inc.us.prol.loopexit
  %60 = sub i64 %53, %indvars.iv.unr
  %61 = lshr i64 %60, 2
  %62 = and i64 %61, 1
  %lcmp.mod105 = icmp eq i64 %62, 0
...
for.inc.us.prol106:                               ; preds = %for.inc.us.prol.preheader102
  ...
  %mul.us.prol109 = fmul <2 x double> %64, %mul.us.v.i1.2.prol
  ...
  %mul.us.2.prol = fmul <2 x double> %66, %mul.us.v.i1.2.prol
  store <2 x double> %mul.us.2.prol, <2 x double>* %65, align 8
...
for.inc.lr.ph:                                    ; preds = %for.inc.lr.ph.preheader, %for.inc43
  ...
  %68 = zext i2 %indvars.iv121 to i32
  %69 = add i32 %68, -1
...
for.inc.prol:                                     ; preds = %for.inc.prol.preheader, %for.inc.prol
  ...
  %74 = load double, double* %arrayidx5.prol, align 8
  %mul.prol = fmul double %74, %beta
...
for.inc.prol.loopexit:                            ; preds = %for.inc.prol.loopexit.loopexit, %for.inc.lr.ph
  %indvars.iv58.unr = phi i64 [ 0, %for.inc.lr.ph ], [ %71, %for.inc.prol.loopexit.loopexit ]
  %75 = icmp ult i64 %indvars.iv68, 3
  br i1 %75, label %for.inc43, label %for.inc.preheader

for.inc.preheader:                                ; preds = %for.inc.prol.loopexit
  %76 = sub i64 %72, %indvars.iv58.unr
  %77 = lshr i64 %76, 2
  %78 = and i64 %77, 1
  %lcmp.mod114 = icmp eq i64 %78, 0
...
for.inc.prol115:                                  ; preds = %for.inc.prol.preheader111
  ...
  %79 = bitcast double* %arrayidx5.prol117 to <2 x double>*
  %80 = load <2 x double>, <2 x double>* %79, align 8
  %mul.prol118 = fmul <2 x double> %80, %mul.v.i1.2.prol
  store <2 x double> %mul.prol118, <2 x double>* %79, align 8
  ...
  %81 = bitcast double* %arrayidx5.2.prol to <2 x double>*
  %82 = load <2 x double>, <2 x double>* %81, align 8
  %mul.2.prol = fmul <2 x double> %82, %mul.v.i1.2.prol
  store <2 x double> %mul.2.prol, <2 x double>* %81, align 8
...
for.inc:                                          ; preds = %for.inc, %for.inc.preheader.new
  ...
  %86 = bitcast double* %arrayidx5.2 to <2 x double>*
  %87 = load <2 x double>, <2 x double>* %86, align 8
  %mul.2 = fmul <2 x double> %87, %mul.v.i1.2
  store <2 x double> %mul.2, <2 x double>* %86, align 8
  ...
  %mul.1 = fmul <2 x double> %89, %mul.v.i1.2.1
  store <2 x double> %mul.1, <2 x double>* %88, align 8
  ...
  %90 = bitcast double* %arrayidx5.2.1 to <2 x double>*
  %91 = load <2 x double>, <2 x double>* %90, align 8
  %mul.2.1 = fmul <2 x double> %91, %mul.v.i1.2.1
  store <2 x double> %mul.2.1, <2 x double>* %90, align 8
...
for.inc43:                                        ; preds = %for.inc43.loopexit, %for.inc.prol.loopexit
  ...
  %indvars.iv.next122 = add i2 %indvars.iv121, 1
