...
define internal fastcc void @init_array(i32, double*, double*, double*, double*, [2000 x double]*) unnamed_addr #2 {
  br i1 true, label %.lr.ph4, label %._crit_edge5
...
.lr.ph4.split.us:                                 ; preds = %.lr.ph4, %._crit_edge.us
  %indvars.iv11 = phi i64 [ 0, %.lr.ph4 ], [ %indvars.iv.next12, %._crit_edge.us ]
  %8 = trunc i64 %indvars.iv11 to i32
  %9 = srem i32 %8, 2000
  %10 = sitofp i32 %9 to double
  %11 = getelementptr inbounds double, double* %1, i64 %indvars.iv11
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %12 = trunc i64 %indvars.iv.next12 to i32
  %13 = srem i32 %12, 2000
  ...
  %20 = getelementptr inbounds double, double* %2, i64 %indvars.iv11
  store double %19, double* %20, align 8
  %21 = add nuw nsw i64 %indvars.iv11, 3
  %22 = trunc i64 %21 to i32
  %23 = srem i32 %22, 2000
  %24 = sitofp i32 %23 to double
  %25 = getelementptr inbounds double, double* %3, i64 %indvars.iv11
  %26 = add nuw nsw i64 %indvars.iv11, 4
  ...
  %35 = getelementptr inbounds double, double* %4, i64 %indvars.iv11
  store double %34, double* %35, align 8
  br i1 true, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.lr.ph4.split.us
  %36 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv11, i64 0
...
.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph4.split.us
  ...
  br i1 false, label %._crit_edge.us, label %.lr.ph4.split.us.new.preheader
...
.lr.ph4.split.us.new:                             ; preds = %.lr.ph4.split.us.new.preheader, %.lr.ph4.split.us.new
  ...
  %37 = mul nsw i64 %indvars.iv, %indvars.iv11
  %38 = trunc i64 %37 to i32
  %39 = srem i32 %38, 2000
  %40 = sitofp i32 %39 to double
  %41 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv11, i64 %indvars.iv
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %42 = mul nsw i64 %indvars.iv.next, %indvars.iv11
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %.prol.loopexit
  %exitcond = icmp ne i64 %indvars.iv.next12, 2000
  br i1 %exitcond, label %.lr.ph4.split.us, label %._crit_edge5.loopexit
...
define internal fastcc void @kernel_mvt(i32, double*, double*, double*, double*, [2000 x double]*) unnamed_addr #2 {
  br i1 true, label %.preheader5.us.preheader, label %.preheader4.thread

.preheader5.us.preheader:                         ; preds = %6
  br label %.preheader5.us

.preheader5.us:                                   ; preds = %.preheader5.us.preheader, %._crit_edge12.us
  %indvars.iv34 = phi i64 [ 0, %.preheader5.us.preheader ], [ %indvars.iv.next35, %._crit_edge12.us ]
  %7 = getelementptr inbounds double, double* %1, i64 %indvars.iv34
  br i1 true, label %.prol.loopexit29, label %.prol.preheader28

.prol.preheader28:                                ; preds = %.preheader5.us
  %8 = load double, double* %7, align 8
  %9 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv34, i64 0
...
.prol.loopexit29:                                 ; preds = %.prol.preheader28, %.preheader5.us
  %indvars.iv25.unr.ph = phi i64 [ 1, %.prol.preheader28 ], [ 0, %.preheader5.us ]
  br i1 false, label %._crit_edge12.us, label %.preheader5.us.new.preheader
...
.preheader5.us.new:                               ; preds = %.preheader5.us.new.preheader, %.preheader5.us.new
  %14 = phi double [ %26, %.preheader5.us.new ], [ %.pre, %.preheader5.us.new.preheader ]
  %indvars.iv25 = phi i64 [ %indvars.iv.next26.1, %.preheader5.us.new ], [ %indvars.iv25.unr.ph, %.preheader5.us.new.preheader ]
  %15 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv34, i64 %indvars.iv25
  %16 = load double, double* %15, align 8
  %17 = getelementptr inbounds double, double* %3, i64 %indvars.iv25
  %18 = load double, double* %17, align 8
  %19 = fmul double %16, %18
  %20 = fadd double %14, %19
  store double %20, double* %7, align 8
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  %21 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv34, i64 %indvars.iv.next26
  %22 = load double, double* %21, align 8
  %23 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next26
  %24 = load double, double* %23, align 8
  %25 = fmul double %22, %24
  %26 = fadd double %20, %25
  store double %26, double* %7, align 8
  %indvars.iv.next26.1 = add nuw nsw i64 %indvars.iv25, 2
  %exitcond.133 = icmp eq i64 %indvars.iv.next26.1, 2000
  br i1 %exitcond.133, label %._crit_edge12.us.loopexit, label %.preheader5.us.new

._crit_edge12.us.loopexit:                        ; preds = %.preheader5.us.new
  br label %._crit_edge12.us

._crit_edge12.us:                                 ; preds = %._crit_edge12.us.loopexit, %.prol.loopexit29
  %indvars.iv.next35 = add nuw nsw i64 %indvars.iv34, 1
  %exitcond41 = icmp ne i64 %indvars.iv.next35, 2000
  br i1 %exitcond41, label %.preheader5.us, label %.preheader.us.preheader
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  ...
  %27 = getelementptr inbounds double, double* %2, i64 %indvars.iv23
  br i1 true, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.preheader.us
  %28 = load double, double* %27, align 8
  %29 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 0, i64 %indvars.iv23
...
.preheader.us.new.preheader:                      ; preds = %.prol.loopexit
  %.pre40 = load double, double* %27, align 8
  br label %.preheader.us.new

.preheader.us.new:                                ; preds = %.preheader.us.new.preheader, %.preheader.us.new
  %34 = phi double [ %46, %.preheader.us.new ], [ %.pre40, %.preheader.us.new.preheader ]
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.preheader.us.new ], [ %indvars.iv.unr.ph, %.preheader.us.new.preheader ]
  %35 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv, i64 %indvars.iv23
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %41 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv.next, i64 %indvars.iv23
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %.prol.loopexit
  ...
  %exitcond = icmp ne i64 %indvars.iv.next24, 2000
  br i1 %exitcond, label %.preheader.us, label %.preheader4.thread.loopexit
...
define internal fastcc void @print_array(i32, double*, double*) unnamed_addr #0 {
  ...
  br i1 true, label %.lr.ph6, label %.critedge

.lr.ph6:                                          ; preds = %3
  br label %8

; <label>:8:                                      ; preds = %.lr.ph6, %14
  %indvars.iv11 = phi i64 [ 0, %.lr.ph6 ], [ %indvars.iv.next12, %14 ]
...
; <label>:14:                                     ; preds = %8, %12
  ...
  %16 = getelementptr inbounds double, double* %1, i64 %indvars.iv11
  %17 = load double, double* %16, align 8
  %18 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %15, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i64 0, i64 0), double %17) #6
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond13 = icmp ne i64 %indvars.iv.next12, 2000
  br i1 %exitcond13, label %8, label %._crit_edge7
...
; <label>:29:                                     ; preds = %23, %27
  ...
  br i1 %exitcond, label %23, label %._crit_edge.loopexit

.critedge:                                        ; preds = %3
  %34 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %35 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %34, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0)) #6
  %36 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %37 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %36, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.7, i64 0, i64 0)) #6
  br label %._crit_edge

._crit_edge.loopexit:                             ; preds = %29
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.critedge, %._crit_edge7
  %38 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %39 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %38, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.7, i64 0, i64 0)) #6
  %40 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %41 = tail call i64 @fwrite(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.8, i64 0, i64 0), i64 22, i64 1, %struct._IO_FILE* %40) #5
  ret void
}
