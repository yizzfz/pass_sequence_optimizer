...
entry:
  ...
  %smax67 = select i1 %14, i64 %10, i64 2
  %15 = icmp sgt i64 %7, 2
  %smax83 = select i1 %15, i64 %7, i64 2
  %16 = add nsw i64 %smax83, -1
  %17 = icmp sgt i64 %7, 2
  %smax96 = select i1 %17, i64 %7, i64 2
  %min.iters.check84 = icmp ult i64 %16, 2
  %n.vec87 = and i64 %16, -2
  %cmp.zero88 = icmp eq i64 %n.vec87, 0
  %ind.end112 = or i64 %16, 1
  %cmp.n113 = icmp eq i64 %16, %n.vec87
...
for.cond4.preheader:                              ; preds = %for.cond4.preheader.preheader, %for.inc98
  ...
  %18 = add nuw nsw i64 %indvar90, 1
  %19 = add nuw nsw i64 %indvar90, 2
...
for.cond8.preheader.us:                           ; preds = %for.cond8.preheader.us.preheader, %for.inc95.us
  ...
  %20 = add nuw nsw i64 %indvar92, 1
  %scevgep94 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %6, i64 %18, i64 %20, i64 1
  %scevgep97 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %6, i64 %18, i64 %20, i64 %smax96
  %scevgep99 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %5, i64 %indvar90, i64 %20, i64 1
  %scevgep101 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %5, i64 %19, i64 %20, i64 %smax96
...
vector.body80:                                    ; preds = %vector.body80.preheader, %vector.body80
  ...
  %21 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %5, i64 %add, i64 %indvars.iv54, i64 %offset.idx114
  %22 = bitcast double* %21 to <2 x double>*
  %wide.load118 = load <2 x double>, <2 x double>* %22, align 8, !alias.scope !1
  %23 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %5, i64 %indvars.iv56, i64 %indvars.iv54, i64 %offset.idx114
  %24 = bitcast double* %23 to <2 x double>*
  %wide.load119 = load <2 x double>, <2 x double>* %24, align 8, !alias.scope !1
  %25 = fmul <2 x double> %wide.load119, <double 2.000000e+00, double 2.000000e+00>
  %26 = fsub <2 x double> %wide.load118, %25
  %27 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %5, i64 %sub23, i64 %indvars.iv54, i64 %offset.idx114
  %28 = bitcast double* %27 to <2 x double>*
  %wide.load120 = load <2 x double>, <2 x double>* %28, align 8, !alias.scope !1
  %29 = fadd <2 x double> %wide.load120, %26
  %30 = fmul <2 x double> %29, <double 1.250000e-01, double 1.250000e-01>
  %31 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %5, i64 %indvars.iv56, i64 %add34.us, i64 %offset.idx114
  %32 = bitcast double* %31 to <2 x double>*
  %wide.load121 = load <2 x double>, <2 x double>* %32, align 8, !alias.scope !1
  %33 = fsub <2 x double> %wide.load121, %25
  %34 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %5, i64 %indvars.iv56, i64 %sub49.us, i64 %offset.idx114
  %35 = bitcast double* %34 to <2 x double>*
  %wide.load122 = load <2 x double>, <2 x double>* %35, align 8, !alias.scope !1
  %36 = fadd <2 x double> %33, %wide.load122
  %37 = fmul <2 x double> %36, <double 1.250000e-01, double 1.250000e-01>
  %38 = fadd <2 x double> %30, %37
  %39 = add nuw nsw i64 %offset.idx114, 1
  %40 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %5, i64 %indvars.iv56, i64 %indvars.iv54, i64 %39
  %41 = bitcast double* %40 to <2 x double>*
  %wide.load123 = load <2 x double>, <2 x double>* %41, align 8, !alias.scope !1
  %42 = fsub <2 x double> %wide.load123, %25
  %43 = add nsw i64 %offset.idx114, -1
  %44 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %5, i64 %indvars.iv56, i64 %indvars.iv54, i64 %43
  %45 = bitcast double* %44 to <2 x double>*
  %wide.load124 = load <2 x double>, <2 x double>* %45, align 8, !alias.scope !1
  %46 = fadd <2 x double> %42, %wide.load124
  %47 = fmul <2 x double> %46, <double 1.250000e-01, double 1.250000e-01>
  %48 = fadd <2 x double> %38, %47
  %49 = fadd <2 x double> %wide.load119, %48
  %50 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %6, i64 %indvars.iv56, i64 %indvars.iv54, i64 %offset.idx114
  %51 = bitcast double* %50 to <2 x double>*
  store <2 x double> %49, <2 x double>* %51, align 8, !alias.scope !4, !noalias !1
  %index.next110 = add i64 %index109, 2
  %52 = icmp eq i64 %index.next110, %n.vec87
  br i1 %52, label %middle.block81, label %vector.body80, !llvm.loop !6
...
for.cond109.preheader.us:                         ; preds = %for.cond109.preheader.us.preheader, %for.inc203.us
  ...
  %62 = add nuw nsw i64 %indvar64, 1
  %scevgep = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %60, i64 %62, i64 1
  %scevgep68 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %60, i64 %62, i64 %smax67
  %scevgep70 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvar, i64 %62, i64 1
  %scevgep72 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %61, i64 %62, i64 %smax67
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %63 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %add113, i64 %indvars.iv60, i64 %offset.idx
  %64 = bitcast double* %63 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %64, align 8, !alias.scope !10
  %65 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv62, i64 %indvars.iv60, i64 %offset.idx
  %66 = bitcast double* %65 to <2 x double>*
  %wide.load74 = load <2 x double>, <2 x double>* %66, align 8, !alias.scope !10
  %67 = fmul <2 x double> %wide.load74, <double 2.000000e+00, double 2.000000e+00>
  %68 = fsub <2 x double> %wide.load, %67
  %69 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %sub128, i64 %indvars.iv60, i64 %offset.idx
  %70 = bitcast double* %69 to <2 x double>*
  %wide.load75 = load <2 x double>, <2 x double>* %70, align 8, !alias.scope !10
  %71 = fadd <2 x double> %wide.load75, %68
  %72 = fmul <2 x double> %71, <double 1.250000e-01, double 1.250000e-01>
  %73 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv62, i64 %add139.us, i64 %offset.idx
  %74 = bitcast double* %73 to <2 x double>*
  %wide.load76 = load <2 x double>, <2 x double>* %74, align 8, !alias.scope !10
  %75 = fsub <2 x double> %wide.load76, %67
  %76 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv62, i64 %sub154.us, i64 %offset.idx
  %77 = bitcast double* %76 to <2 x double>*
  %wide.load77 = load <2 x double>, <2 x double>* %77, align 8, !alias.scope !10
  %78 = fadd <2 x double> %75, %wide.load77
  %79 = fmul <2 x double> %78, <double 1.250000e-01, double 1.250000e-01>
  %80 = fadd <2 x double> %72, %79
  %81 = add nuw nsw i64 %offset.idx, 1
  %82 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv62, i64 %indvars.iv60, i64 %81
  %83 = bitcast double* %82 to <2 x double>*
  %wide.load78 = load <2 x double>, <2 x double>* %83, align 8, !alias.scope !10
  %84 = fsub <2 x double> %wide.load78, %67
  %85 = add nsw i64 %offset.idx, -1
  %86 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv62, i64 %indvars.iv60, i64 %85
  %87 = bitcast double* %86 to <2 x double>*
  %wide.load79 = load <2 x double>, <2 x double>* %87, align 8, !alias.scope !10
  %88 = fadd <2 x double> %84, %wide.load79
  %89 = fmul <2 x double> %88, <double 1.250000e-01, double 1.250000e-01>
  %90 = fadd <2 x double> %80, %89
  %91 = fadd <2 x double> %wide.load74, %90
  %92 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvars.iv62, i64 %indvars.iv60, i64 %offset.idx
