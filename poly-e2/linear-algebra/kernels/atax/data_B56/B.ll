...
for.body5.us:                                     ; preds = %for.inc42.us, %for.body5.us.preheader
  ...
  %scevgep91 = getelementptr [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 1
  %29 = add i64 %indvars.iv65, 1
  %scevgep93 = getelementptr [2100 x double], [2100 x double]* %A, i64 %29, i64 0
...
for.inc42.us:                                     ; preds = %for.body26.us.for.body26.us_crit_edge
  %exitcond78 = icmp eq i64 %29, 1900
  br i1 %exitcond78, label %for.end44, label %for.body5.us
...
for.body26.us.for.body26.us_crit_edge:            ; preds = %for.body26.us.for.body26.us_crit_edge, %for.body26.us.for.body26.us_crit_edge.preheader.new
  %indvars.iv.next6477 = phi i64 [ %indvars.iv.next64.prol, %for.body26.us.for.body26.us_crit_edge.preheader.new ], [ %indvars.iv.next64.1, %for.body26.us.for.body26.us_crit_edge ]
  %.pre71 = load double, double* %arrayidx12.us, align 8
  %arrayidx28.us = getelementptr inbounds double, double* %y, i64 %indvars.iv.next6477
  %30 = load double, double* %arrayidx28.us, align 8
  %arrayidx32.us = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 %indvars.iv.next6477
  ...
  %indvars.iv.next64 = add nuw nsw i64 %indvars.iv.next6477, 1
  ...
  %indvars.iv.next64.1 = add nsw i64 %indvars.iv.next6477, 2
  %exitcond73.1 = icmp eq i64 %indvars.iv.next64, 2099
  br i1 %exitcond73.1, label %for.inc42.us, label %for.body26.us.for.body26.us_crit_edge, !llvm.loop !4
...
for.body26.us.preheader:                          ; preds = %for.body10.us
  ...
  %arrayidx32.us74 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 0
  %42 = load double, double* %arrayidx32.us74, align 8
  %mul35.us75 = fmul double %42, %add.us.2
  %add36.us76 = fadd double %41, %mul35.us75
  store double %add36.us76, double* %y, align 8
  %bound0 = icmp ult double* %scevgep, %arrayidx12.us
  %bound1 = icmp ult double* %arrayidx12.us, %scevgep89
  ...
  br i1 %conflict.rdx, label %for.body26.us.for.body26.us_crit_edge.preheader.new, label %vector.body83.preheader

vector.body83.preheader:                          ; preds = %for.body26.us.preheader
  br label %vector.body83

for.body26.us.for.body26.us_crit_edge.preheader.new.loopexit: ; preds = %vector.body83
...
for.body26.us.for.body26.us_crit_edge.preheader.new: ; preds = %for.body26.us.for.body26.us_crit_edge.preheader.new.loopexit, %for.body26.us.preheader
  %indvars.iv.next6477.ph = phi i64 [ 1, %for.body26.us.preheader ], [ 2097, %for.body26.us.for.body26.us_crit_edge.preheader.new.loopexit ]
  %.pre71.prol = load double, double* %arrayidx12.us, align 8
  %arrayidx28.us.prol = getelementptr inbounds double, double* %y, i64 %indvars.iv.next6477.ph
  %43 = load double, double* %arrayidx28.us.prol, align 8
  %arrayidx32.us.prol = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 %indvars.iv.next6477.ph
  ...
  %indvars.iv.next64.prol = add nuw nsw i64 %indvars.iv.next6477.ph, 1
  br label %for.body26.us.for.body26.us_crit_edge

vector.body83:                                    ; preds = %vector.body83.preheader, %vector.body83
  %index100 = phi i64 [ %index.next101, %vector.body83 ], [ 0, %vector.body83.preheader ]
  %offset.idx = or i64 %index100, 1
  ...
  %wide.load108 = load <2 x double>, <2 x double>* %51, align 8, !alias.scope !8, !noalias !10
  %52 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 %offset.idx
  %53 = bitcast double* %52 to <2 x double>*
  %wide.load109 = load <2 x double>, <2 x double>* %53, align 8, !alias.scope !12
  %54 = getelementptr double, double* %52, i64 2
  %55 = bitcast double* %54 to <2 x double>*
  %wide.load110 = load <2 x double>, <2 x double>* %55, align 8, !alias.scope !12
  %56 = fmul <2 x double> %wide.load109, %47
  %57 = fmul <2 x double> %wide.load110, %47
  %58 = fadd <2 x double> %wide.load, %56
  %59 = fadd <2 x double> %wide.load108, %57
  ...
  %index.next101 = add i64 %index100, 4
  %60 = icmp eq i64 %index.next101, 2096
  br i1 %60, label %for.body26.us.for.body26.us_crit_edge.preheader.new.loopexit, label %vector.body83, !llvm.loop !13
...
for.body:                                         ; preds = %if.end, %entry
  ...
  %storemerge2 = phi i32 [ %6, %if.end ], [ 0, %entry ]
