...
; <label>:68:                                     ; preds = %49
  ...
  %70 = call i32 @ferror(%struct._IO_FILE* %69) #7
  %71 = icmp ne i32 %70, 0
...
; <label>:87:                                     ; preds = %68
  %88 = call noalias i8* @malloc(i64 5104) #7
...
; <label>:73:                                     ; preds = %53
  ...
  %77 = call i32 @ferror(%struct._IO_FILE* %76) #7
  %78 = icmp ne i32 %77, 0
...
; <label>:178:                                    ; preds = %159
  ...
  %183 = call i32 @ferror(%struct._IO_FILE* %182) #7
...
; <label>:58:                                     ; preds = %38
  ...
  %62 = call i32 @ferror(%struct._IO_FILE* %61) #7
  %63 = icmp ne i32 %62, 0
...
; <label>:174:                                    ; preds = %155
  ...
  %179 = call i32 @ferror(%struct._IO_FILE* %178) #7
...
; <label>:209:                                    ; preds = %206
  ...
  %214 = call i32 @ferror(%struct._IO_FILE* %213) #7
...
; <label>:216:                                    ; preds = %209
  ...
  %224 = call i32 @ferror(%struct._IO_FILE* %223) #7
...
; <label>:67:                                     ; preds = %._crit_edge, %63, %59, %51, %43, %35, %28
...
; <label>:82:                                     ; preds = %63, %56
  ...
  %84 = call i32 @ferror(%struct._IO_FILE* %83) #7
  %85 = icmp ne i32 %84, 0
...
; <label>:101:                                    ; preds = %82
  %102 = call noalias i8* @malloc(i64 5104) #7
...
; <label>:100:                                    ; preds = %293, %91
  ...
  %104 = call i32 @ferror(%struct._IO_FILE* %103) #7
  %105 = icmp ne i32 %104, 0
  br i1 %105, label %106, label %121
...
; <label>:134:                                    ; preds = %127
  ...
  %146 = call i32 @ferror(%struct._IO_FILE* %145) #7
...
; <label>:42:                                     ; preds = %._crit_edge, %38, %30, %22, %18, %6
...
; <label>:64:                                     ; preds = %27
  ...
  %71 = call i8* @strcat(i8* %65, i8* %70) #7
  %72 = getelementptr inbounds [10 x i8], [10 x i8]* %14, i32 0, i32 0
  %73 = call i8* @strcat(i8* %72, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.8, i32 0, i32 0)) #7
  %74 = load i32, i32* %9, align 4
  %75 = icmp eq i32 %74, 0
...
; <label>:79:                                     ; preds = %76
  ...
  %82 = call i32 @strcmp(i8* %81, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.9, i32 0, i32 0)) #10
  %83 = icmp eq i32 %82, 0
...
; <label>:101:                                    ; preds = %64
  ...
  %104 = call %struct._IO_FILE* @fdopen(i32 %102, i8* %103) #7
