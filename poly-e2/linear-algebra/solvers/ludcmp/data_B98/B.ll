...
for.inc:                                          ; preds = %for.inc, %entry.for.inc_crit_edge
  %indvars.iv139 = phi i64 [ 0, %entry.for.inc_crit_edge ], [ %indvars.iv.next140.1, %for.inc ]
  %arrayidx = getelementptr inbounds double, double* %x, i64 %indvars.iv139
  %0 = bitcast double* %arrayidx to <2 x double>*
  %arrayidx3 = getelementptr inbounds double, double* %y, i64 %indvars.iv139
  %1 = bitcast double* %arrayidx3 to <2 x double>*
  %indvars.iv.next140 = or i64 %indvars.iv139, 1
  %2 = trunc i64 %indvars.iv.next140 to i32
  %conv4 = sitofp i32 %2 to double
  %arrayidx8 = getelementptr inbounds double, double* %b, i64 %indvars.iv139
  ...
  %3 = trunc i64 %indvars.iv.next140.1 to i32
  ...
  %exitcond167.1 = icmp eq i64 %indvars.iv.next140, 1999
...
for.inc25.lr.ph:                                  ; preds = %for.inc25.lr.ph.preheader, %for.inc44
  %indvars.iv137 = phi i64 [ %indvars.iv.next138, %for.inc44 ], [ 0, %for.inc25.lr.ph.preheader ]
  %5 = shl i64 %indvars.iv137, 32
  %sext = add nuw nsw i64 %5, 4294967296
  %6 = ashr exact i64 %sext, 32
  br label %for.inc25

for.inc25:                                        ; preds = %for.inc25, %for.inc25.lr.ph
  %indvars.iv124 = phi i64 [ %indvars.iv.next125, %for.inc25 ], [ 0, %for.inc25.lr.ph ]
  %7 = sub nsw i64 0, %indvars.iv124
  %8 = trunc i64 %7 to i32
  %rem = srem i32 %8, 2000
  %conv17 = sitofp i32 %rem to double
  %div19 = fdiv double %conv17, 2.000000e+03
  %add20 = fadd double %div19, 1.000000e+00
  %arrayidx24 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv137, i64 %indvars.iv124
  store double %add20, double* %arrayidx24, align 8
  %exitcond130 = icmp eq i64 %indvars.iv124, %indvars.iv137
  %indvars.iv.next125 = add nuw nsw i64 %indvars.iv124, 1
  br i1 %exitcond130, label %for.end27, label %for.inc25

for.end27:                                        ; preds = %for.inc25
  %indvars.iv.next138 = add nuw nsw i64 %indvars.iv137, 1
  %cmp3080 = icmp slt i64 %indvars.iv.next138, 2000
  br i1 %cmp3080, label %for.inc37.for.inc44_crit_edge, label %for.inc44

for.inc37.for.inc44_crit_edge:                    ; preds = %for.end27
  %scevgep145 = getelementptr [2000 x double], [2000 x double]* %A, i64 %indvars.iv137, i64 %6
  %9 = sub nsw i64 2000, %6
  %10 = shl nsw i64 %9, 3
  %scevgep145146 = bitcast double* %scevgep145 to i8*
  call void @llvm.memset.p0i8.i64(i8* nonnull %scevgep145146, i8 0, i64 %10, i32 8, i1 false)
  br label %for.inc44

for.inc44:                                        ; preds = %for.end27, %for.inc37.for.inc44_crit_edge
  %arrayidx43 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv137, i64 %indvars.iv137
  store double 1.000000e+00, double* %arrayidx43, align 8
  %exitcond166 = icmp eq i64 %indvars.iv.next138, 2000
  br i1 %exitcond166, label %for.end46.for.cond51.preheader.us_crit_edge, label %for.inc25.lr.ph
...
for.cond69.preheader.us.for.cond73.preheader.us.us_crit_edge: ; preds = %for.cond69.preheader.us.for.cond73.preheader.us.us_crit_edge.preheader, %for.inc96.us
  %indvars.iv116 = phi i64 [ %indvars.iv.next117, %for.inc96.us ], [ 0, %for.cond69.preheader.us.for.cond73.preheader.us.us_crit_edge.preheader ]
  %scevgep3 = getelementptr [2000 x double], [2000 x double]* %A, i64 0, i64 %indvars.iv116
  %22 = add i64 %indvars.iv116, 1
...
for.inc96.us:                                     ; preds = %for.inc93.us.us
  ...
  %exitcond164 = icmp eq i64 %indvars.iv.next117, 2000
  br i1 %exitcond164, label %vector.memcheck28.preheader, label %for.cond69.preheader.us.for.cond73.preheader.us.us_crit_edge

vector.memcheck28.preheader:                      ; preds = %for.inc96.us
...
vector.memcheck:                                  ; preds = %for.inc93.us.us, %for.cond69.preheader.us.for.cond73.preheader.us.us_crit_edge
  %indvars.iv114 = phi i64 [ 0, %for.cond69.preheader.us.for.cond73.preheader.us.us_crit_edge ], [ %indvars.iv.next115, %for.inc93.us.us ]
  %32 = mul i64 %indvars.iv114, 16000
  %scevgep1 = getelementptr i8, i8* %call, i64 %32
  %33 = add i64 %32, 16000
  %scevgep2 = getelementptr i8, i8* %call, i64 %33
  %arrayidx80.us.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv114, i64 %indvars.iv116
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %42 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %index, i64 %indvars.iv116
  %43 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %34, i64 %indvars.iv116
  %44 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %35, i64 %indvars.iv116
  %45 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %36, i64 %indvars.iv116
  ...
  %56 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %21, i64 0, i64 %indvars.iv114, i64 %index
...
for.inc93.us.us:                                  ; preds = %for.inc93.us.us.loopexit43, %for.inc93.us.us.loopexit
  ...
  %exitcond163 = icmp eq i64 %indvars.iv.next115, 2000
  br i1 %exitcond163, label %for.inc96.us, label %vector.memcheck
...
for.inc90.us.us:                                  ; preds = %for.inc90.us.us, %for.inc90.us.us.preheader
  ...
  %arrayidx84.us.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv110, i64 %indvars.iv116
  %66 = load double, double* %arrayidx84.us.us, align 8
  %mul.us.us = fmul double %65, %66
  %arrayidx88.us.us = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %19, i64 0, i64 %indvars.iv114, i64 %indvars.iv110
  ...
  %arrayidx84.us.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv.next111, i64 %indvars.iv116
  %69 = load double, double* %arrayidx84.us.us.1, align 8
  %mul.us.us.1 = fmul double %68, %69
  %arrayidx88.us.us.1 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %20, i64 0, i64 %indvars.iv114, i64 %indvars.iv.next111
  ...
  %exitcond162.1 = icmp eq i64 %indvars.iv.next111, 1999
...
vector.memcheck28:                                ; preds = %vector.memcheck28.preheader, %for.inc118.us
  %indvars.iv108 = phi i64 [ %indvars.iv.next109, %for.inc118.us ], [ 0, %vector.memcheck28.preheader ]
  ...
  %74 = bitcast double* %scevgep20 to i8*
  %75 = bitcast double* %scevgep18 to i8*
  %bound024 = icmp ult i8* %75, %scevgep23
  %bound125 = icmp ult i8* %scevgep22, %74
...
for.inc115.us.preheader:                          ; preds = %vector.memcheck28
...
vector.body13:                                    ; preds = %vector.body13, %vector.body13.preheader
  ...
  %76 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %30, i64 0, i64 %indvars.iv108, i64 %index30
  ...
  %80 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv108, i64 %index30
  ...
  %84 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %31, i64 0, i64 %indvars.iv108, i64 %index.next31
  ...
  %88 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv108, i64 %index.next31
...
for.inc118.us:                                    ; preds = %for.inc118.us.loopexit42, %for.inc118.us.loopexit
  ...
  %exitcond = icmp eq i64 %indvars.iv.next109, 2000
  br i1 %exitcond, label %for.end120, label %vector.memcheck28
...
for.cond1.preheader:                              ; preds = %for.inc58, %entry.for.cond1.preheader_crit_edge
  ...
  %indvars.iv153 = phi i64 [ %indvars.iv.next154, %for.inc58 ], [ 4294967295, %entry.for.cond1.preheader_crit_edge ]
  %0 = sub i64 2000, %indvars.iv2
  %1 = add i64 %0, -4
  %2 = lshr i64 %1, 2
  %3 = sub i64 2000, %indvars.iv2
  %4 = and i64 %indvars.iv153, 4294967295
...
for.body30.preheader13:                           ; preds = %middle.block, %min.iters.checked, %for.body30.preheader
  %indvars.iv125.ph = phi i64 [ %indvars.iv2, %min.iters.checked ], [ %indvars.iv2, %for.body30.preheader ], [ %ind.end, %middle.block ]
  br label %for.body30
...
vector.body.prol:                                 ; preds = %vector.body.preheader
  %6 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv2, i64 %indvars.iv2
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader.new
  ...
  %13 = add i64 %indvars.iv2, %index
  %14 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv2, i64 %13
  ...
  %index.next = add i64 %index, 4
  %20 = add i64 %indvars.iv2, %index.next
  %21 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv2, i64 %20
...
for.body30.us.preheader:                          ; preds = %for.body30.lr.ph
  %28 = and i64 %indvars.iv153, 1
  %lcmp.mod23 = icmp eq i64 %28, 0
...
for.body30.us:                                    ; preds = %for.body30.us.preheader, %for.inc55.us
  %indvars.iv137 = phi i64 [ %indvars.iv.next138, %for.inc55.us ], [ %indvars.iv2, %for.body30.us.preheader ]
  %arrayidx34.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv2, i64 %indvars.iv137
  %30 = load double, double* %arrayidx34.us, align 8
  br i1 %lcmp.mod23, label %for.inc48.us.prol, label %for.inc48.us.prol.loopexit
...
for.inc48.us:                                     ; preds = %for.inc48.us, %for.body30.us.new
  %indvars.iv129 = phi i64 [ %indvars.iv129.unr.ph, %for.body30.us.new ], [ %indvars.iv.next130.1, %for.inc48.us ]
  %w.198.us = phi double [ %w.198.us.unr.ph, %for.body30.us.new ], [ %sub47.us.1, %for.inc48.us ]
  %arrayidx41.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv2, i64 %indvars.iv129
  %33 = bitcast double* %arrayidx41.us to <2 x double>*
  %arrayidx45.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv129, i64 %indvars.iv137
  %34 = load double, double* %arrayidx45.us, align 8
  %indvars.iv.next130 = add nuw nsw i64 %indvars.iv129, 1
  %35 = load <2 x double>, <2 x double>* %33, align 8
  %arrayidx45.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv.next130, i64 %indvars.iv137
  ...
  %exitcond155.1 = icmp eq i64 %indvars.iv.next130, %4
...
for.inc55.us:                                     ; preds = %for.inc55.us.loopexit, %for.inc48.us.prol.loopexit
  ...
  %arrayidx54.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv2, i64 %indvars.iv137
  store double %sub47.us.lcssa, double* %arrayidx54.us, align 8
  %indvars.iv.next138 = add nuw nsw i64 %indvars.iv137, 1
  %exitcond5 = icmp eq i64 %indvars.iv.next138, 2000
...
for.body3:                                        ; preds = %for.body3.preheader, %for.inc25
  ...
  %37 = and i64 %indvars.iv149, 4294967295
...
for.inc.preheader:                                ; preds = %for.body3
  %39 = and i64 %indvars.iv149, 1
  %lcmp.mod19 = icmp eq i64 %39, 0
...
for.inc:                                          ; preds = %for.inc, %for.inc.preheader.new
  ...
  %exitcond151.1 = icmp eq i64 %indvars.iv.next116, %37
...
for.inc25:                                        ; preds = %for.inc25.loopexit, %for.inc.prol.loopexit, %for.body3
  ...
  %arrayidx24 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv2, i64 %indvars.iv121
  store double %div, double* %arrayidx24, align 8
  %indvars.iv.next122 = add nuw nsw i64 %indvars.iv121, 1
  %indvars.iv.next150 = add nuw nsw i64 %37, 1
...
for.body30:                                       ; preds = %for.body30.preheader13, %for.body30
  %indvars.iv125 = phi i64 [ %indvars.iv.next126, %for.body30 ], [ %indvars.iv125.ph, %for.body30.preheader13 ]
  %arrayidx34 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv2, i64 %indvars.iv125
  %48 = bitcast double* %arrayidx34 to i64*
  %49 = load i64, i64* %48, align 8
  %arrayidx54 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv2, i64 %indvars.iv125
  %50 = bitcast double* %arrayidx54 to i64*
  store i64 %49, i64* %50, align 8
  %exitcond152 = icmp eq i64 %indvars.iv125, 1999
  %indvars.iv.next126 = add nuw nsw i64 %indvars.iv125, 1
  br i1 %exitcond152, label %for.inc58.loopexit24, label %for.body30, !llvm.loop !21
...
for.inc58:                                        ; preds = %for.inc58.loopexit24, %for.inc58.loopexit, %middle.block
  ...
  %indvars.iv.next154 = add nuw nsw i64 %4, 1
...
for.body63:                                       ; preds = %for.body63.preheader, %for.inc82
  ...
  %51 = and i64 %indvars.iv146, 4294967295
...
for.inc77.preheader:                              ; preds = %for.body63
  %53 = add nsw i64 %indvars.iv146, 1
  %xtraiter15 = and i64 %53, 3
...
for.inc77.prol:                                   ; preds = %for.inc77.prol, %for.inc77.prol.preheader
  ...
  br i1 %prol.iter17.cmp, label %for.inc77.prol.loopexit.loopexit, label %for.inc77.prol, !llvm.loop !23
...
for.inc77:                                        ; preds = %for.inc77, %for.inc77.preheader.new
  ...
  %exitcond148.3 = icmp eq i64 %indvars.iv.next.2, %51
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
...
for.inc82:                                        ; preds = %for.inc82.loopexit, %for.inc77.prol.loopexit, %for.body63
  ...
  %indvars.iv.next147 = add nuw nsw i64 %51, 1
