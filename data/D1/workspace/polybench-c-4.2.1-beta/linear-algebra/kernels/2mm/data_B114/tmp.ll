...
._crit_edge24:                                    ; preds = %._crit_edge24.preheader, %28
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %28 ], [ 0, %._crit_edge24.preheader ]
...
._crit_edge23:                                    ; preds = %._crit_edge23, %._crit_edge24
  ...
  br i1 %exitcond12.1, label %28, label %._crit_edge23
...
._crit_edge26.preheader:                          ; preds = %28
  br label %._crit_edge26

._crit_edge26:                                    ; preds = %._crit_edge26.preheader, %37
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %37 ], [ 0, %._crit_edge26.preheader ]
...
._crit_edge25:                                    ; preds = %._crit_edge25, %._crit_edge26
  ...
  br i1 %exitcond6, label %37, label %._crit_edge25
...
._crit_edge28.preheader:                          ; preds = %37
  br label %._crit_edge28

._crit_edge28:                                    ; preds = %._crit_edge28.preheader, %45
  %indvars.iv1 = phi i64 [ %indvars.iv.next2, %45 ], [ 0, %._crit_edge28.preheader ]
...
; <label>:45:                                     ; preds = %._crit_edge27
  ...
  br i1 %exitcond3, label %46, label %._crit_edge28
