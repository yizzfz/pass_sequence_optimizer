...
@__llvm_prf_nm = private constant [12 x i8] c"\0A\00gsm_decode", section "__llvm_prf_names"
@llvm.used = appending global [2 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_gsm_decode to i8*), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
