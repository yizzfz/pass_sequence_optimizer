...
for.body6.lr.ph:                                  ; preds = %for.inc14, %for.body.lr.ph
  %indvars.iv8 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next9, %for.inc14 ]
  ...
  %3 = add nuw nsw i64 %indvars.iv8, %0
...
for.body6.prol.loopexit:                          ; preds = %for.body6.prol.loopexit.unr-lcssa
  %7 = icmp eq i64 %indvars.iv8, 0
  br i1 %7, label %for.inc14, label %for.body6.lr.ph.new
...
for.inc14:                                        ; preds = %for.body6.prol.loopexit, %for.inc14.unr-lcssa
  ...
  %exitcond = icmp ne i64 %indvars.iv.next9, %1
...
for.body.for.end_crit_edge:                       ; preds = %for.body
  %.pre15 = shl i64 %indvars.iv6, 3
  %.pre16 = add i64 %.pre, %.pre15
  %.pre17 = inttoptr i64 %.pre16 to double*
  br label %for.end
...
for.body5.prol.loopexit.unr-lcssa:                ; preds = %for.body5.preheader, %for.body5.prol
  ...
  %sunkaddr10.lcssa.unr.ph = phi double* [ %sunkaddr10.prol, %for.body5.prol ], [ undef, %for.body5.preheader ]
  %indvars.iv.unr.ph = phi i64 [ 1, %for.body5.prol ], [ 0, %for.body5.preheader ]
  %.unr.ph = phi double [ %sub.prol, %for.body5.prol ], [ %6, %for.body5.preheader ]
...
for.body5:                                        ; preds = %for.body5, %for.body5.preheader.new
  ...
  %11 = phi double [ %.unr.ph, %for.body5.preheader.new ], [ %sub.1, %for.body5 ]
  ...
  store double %sub, double* %sunkaddr10, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  ...
  store double %sub.1, double* %sunkaddr10.1, align 8
...
for.end.loopexit:                                 ; preds = %for.body5.prol.loopexit, %for.end.loopexit.unr-lcssa
  ...
  %sunkaddr10.lcssa = phi double* [ %sunkaddr10.lcssa.unr.ph, %for.body5.prol.loopexit ], [ %sunkaddr10.1, %for.end.loopexit.unr-lcssa ]
  br label %for.end

for.end:                                          ; preds = %for.end.loopexit, %for.body.for.end_crit_edge
  %sunkaddr14.pre-phi = phi double* [ %.pre17, %for.body.for.end_crit_edge ], [ %sunkaddr10.lcssa, %for.end.loopexit ]
  %.lcssa = phi double [ %6, %for.body.for.end_crit_edge ], [ %sub.lcssa, %for.end.loopexit ]
  ...
  %div = fdiv double %.lcssa, %16
  store double %div, double* %sunkaddr14.pre-phi, align 8
...
for.body:                                         ; preds = %for.inc, %for.body.preheader
  ...
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %5, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i64 0, i64 0), double %6) #6
...
for.end:                                          ; preds = %for.end.loopexit, %entry
  ...
  %call5 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %.lcssa, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #6
