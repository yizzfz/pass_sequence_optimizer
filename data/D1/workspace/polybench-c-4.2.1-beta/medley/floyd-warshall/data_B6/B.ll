...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %._crit_edge.us ], [ 0, %.preheader.us.preheader ]
  br label %2

; <label>:2:                                      ; preds = %2, %.preheader.us
  %indvars.iv = phi i64 [ 0, %.preheader.us ], [ %indvars.iv.next, %2 ]
  %3 = mul nuw nsw i64 %indvars.iv, %indvars.iv23
  %4 = trunc i64 %3 to i32
  %5 = srem i32 %4, 7
  %6 = add nsw i32 %5, 1
  %7 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv23, i64 %indvars.iv
  %8 = add nuw nsw i64 %indvars.iv, %indvars.iv23
  ...
  %16 = srem i32 %15, 11
  %17 = icmp eq i32 %16, 0
  %or.cond17.us = or i1 %17, %or.cond.us
  %..us = select i1 %or.cond17.us, i32 999, i32 %6
...
._crit_edge.us:                                   ; preds = %2
  ...
  %exitcond26 = icmp eq i64 %indvars.iv.next24, 2800
  br i1 %exitcond26, label %._crit_edge22, label %.preheader.us
...
.preheader.us.us.preheader.preheader:
  br label %.preheader.us.us.preheader

.preheader.us.us.preheader:                       ; preds = %.preheader.us.us.preheader.preheader, %._crit_edge29.us
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %._crit_edge29.us ], [ 0, %.preheader.us.us.preheader.preheader ]
  br label %.preheader.us.us

._crit_edge29.us:                                 ; preds = %._crit_edge.us.us
  %indvars.iv.next45 = add nuw nsw i64 %indvars.iv44, 1
  %exitcond47 = icmp eq i64 %indvars.iv.next45, 2800
  br i1 %exitcond47, label %._crit_edge31, label %.preheader.us.us.preheader

.preheader.us.us:                                 ; preds = %._crit_edge.us.us, %.preheader.us.us.preheader
  %indvars.iv41 = phi i64 [ 0, %.preheader.us.us.preheader ], [ %indvars.iv.next42, %._crit_edge.us.us ]
  %2 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv41, i64 %indvars.iv44
  br label %.preheader.us.us.new

._crit_edge.us.us:                                ; preds = %.preheader.us.us.new
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  %exitcond = icmp eq i64 %indvars.iv.next42, 2800
  br i1 %exitcond, label %._crit_edge29.us, label %.preheader.us.us
...
.preheader.us.us.new:                             ; preds = %.preheader.us.us, %.preheader.us.us.new
  ...
  %3 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv41, i64 %indvars.iv
  %4 = load i32, i32* %3, align 4
  %5 = load i32, i32* %2, align 4
  %6 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv44, i64 %indvars.iv
  ...
  %10 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv41, i64 %indvars.iv.next
  %11 = load i32, i32* %10, align 4
  %12 = load i32, i32* %2, align 4
  %13 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv44, i64 %indvars.iv.next
...
._crit_edge31:                                    ; preds = %._crit_edge29.us
  ret void
}
...
.preheader.us:                                    ; preds = %._crit_edge.us, %.preheader.us.preheader
  ...
  %6 = mul nsw i64 %indvars.iv13, 2800
  br label %7
...
._crit_edge.us:                                   ; preds = %14
  ...
  %exitcond16 = icmp eq i64 %indvars.iv.next14, 2800
