...
.lr.ph38.split.us:                                ; preds = %._crit_edge34.us, %.lr.ph38.split.us.preheader
  ...
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv84
  store double 0.000000e+00, double* %5, align 8
  %sunkaddr117 = shl i64 %indvars.iv84, 3
  %sunkaddr118 = add i64 %4, %sunkaddr117
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph38.split.us
  ...
  %6 = phi double [ 0.000000e+00, %.lr.ph38.split.us ], [ %21, %._crit_edge ]
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv80, i64 %indvars.iv84
  %8 = load double, double* %7, align 8
  %9 = fadd double %6, %8
  store double %9, double* %sunkaddr119, align 8
  %indvars.iv.next81 = add nuw nsw i64 %indvars.iv80, 1
  %10 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next81, i64 %indvars.iv84
  %11 = load double, double* %10, align 8
  %12 = fadd double %9, %11
  store double %12, double* %sunkaddr119, align 8
  %indvars.iv.next81.1 = add nuw nsw i64 %indvars.iv80, 2
  %13 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next81.1, i64 %indvars.iv84
  %14 = load double, double* %13, align 8
  %15 = fadd double %12, %14
  store double %15, double* %sunkaddr119, align 8
  %indvars.iv.next81.2 = add nuw nsw i64 %indvars.iv80, 3
  %16 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next81.2, i64 %indvars.iv84
  %17 = load double, double* %16, align 8
  %18 = fadd double %15, %17
  store double %18, double* %sunkaddr119, align 8
  %indvars.iv.next81.3 = add nuw nsw i64 %indvars.iv80, 4
  %19 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next81.3, i64 %indvars.iv84
  %20 = load double, double* %19, align 8
  %21 = fadd double %18, %20
  store double %21, double* %sunkaddr119, align 8
...
._crit_edge34.us:                                 ; preds = %._crit_edge
  %22 = fdiv double %21, %0
  %sunkaddr24 = shl i64 %indvars.iv84, 3
...
vector.memcheck:                                  ; preds = %._crit_edge26.us, %._crit_edge34.us..lr.ph29.split.us_crit_edge
  %indvars.iv75 = phi i64 [ 0, %._crit_edge34.us..lr.ph29.split.us_crit_edge ], [ %23, %._crit_edge26.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv75, i64 0
  %23 = add nuw nsw i64 %indvars.iv75, 1
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv75, i64 %offset.idx
  ...
  %33 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv75, i64 %32
  ...
  br i1 %39, label %._crit_edge26.us.loopexit27, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv71 = phi i64 [ %indvars.iv.next72.3, %scalar.ph ], [ 0, %scalar.ph.preheader ]
  %40 = getelementptr inbounds double, double* %3, i64 %indvars.iv71
  %41 = load double, double* %40, align 8
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv75, i64 %indvars.iv71
  %43 = load double, double* %42, align 8
  %44 = fsub double %43, %41
  store double %44, double* %42, align 8
  %indvars.iv.next72 = or i64 %indvars.iv71, 1
  %45 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next72
  %46 = load double, double* %45, align 8
  %47 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv75, i64 %indvars.iv.next72
  %48 = load double, double* %47, align 8
  %49 = fsub double %48, %46
  store double %49, double* %47, align 8
  %indvars.iv.next72.1 = or i64 %indvars.iv71, 2
  %50 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next72.1
  %51 = load double, double* %50, align 8
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv75, i64 %indvars.iv.next72.1
  %53 = load double, double* %52, align 8
  %54 = fsub double %53, %51
  store double %54, double* %52, align 8
  %indvars.iv.next72.2 = or i64 %indvars.iv71, 3
  %55 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next72.2
  %56 = load double, double* %55, align 8
  %57 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv75, i64 %indvars.iv.next72.2
...
._crit_edge26.us.loopexit27:                      ; preds = %vector.body
  br label %._crit_edge26.us

._crit_edge26.us:                                 ; preds = %._crit_edge26.us.loopexit27, %._crit_edge26.us.loopexit
  %exitcond97 = icmp eq i64 %23, 1400
...
._crit_edge18.us-lcssa.us.us:                     ; preds = %._crit_edge.us.us
  ...
  br i1 %exitcond60, label %._crit_edge22, label %.lr.ph17.us
...
.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph17.us
  ...
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv57, i64 %indvars.iv53
...
._crit_edge.us.us:                                ; preds = %._crit_edge21
  ...
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv53, i64 %indvars.iv57
...
._crit_edge21:                                    ; preds = %._crit_edge21, %.lr.ph.us.us
  ...
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv57
  %66 = load double, double* %65, align 8
  %67 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv53
  %68 = load double, double* %67, align 8
  %69 = fmul double %66, %68
  %70 = fadd double %64, %69
  store double %70, double* %61, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv57
  %72 = load double, double* %71, align 8
  %73 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv53
  ...
  br i1 %exitcond94.1, label %._crit_edge.us.us, label %._crit_edge21
