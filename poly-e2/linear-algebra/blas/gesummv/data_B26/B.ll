...
entry:
  %sunkaddr24 = ptrtoint double* %tmp to i64
...
for.body:                                         ; preds = %for.end.for.body_crit_edge, %entry
  %indvars.iv12 = phi i64 [ 0, %entry ], [ %indvars.iv.next13, %for.end.for.body_crit_edge ]
  %arrayidx = getelementptr inbounds double, double* %tmp, i64 %indvars.iv12
  store double 0.000000e+00, double* %arrayidx, align 8
  %arrayidx4 = getelementptr inbounds double, double* %y, i64 %indvars.iv12
  store double 0.000000e+00, double* %arrayidx4, align 8
  %sunkaddr17 = shl i64 %indvars.iv12, 3
  %sunkaddr18 = add i64 %sunkaddr, %sunkaddr17
  %sunkaddr19 = inttoptr i64 %sunkaddr18 to double*
  %sunkaddr21 = shl i64 %indvars.iv12, 3
...
for.body7:                                        ; preds = %for.body7.for.body7_crit_edge, %for.body
  ...
  %arrayidx11 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv12, i64 %indvars.iv
  ...
  %mul = fmul double %0, %1
  %2 = load double, double* %sunkaddr19, align 8
  %add = fadd double %mul, %2
  store double %add, double* %sunkaddr19, align 8
  %arrayidx21 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv12, i64 %indvars.iv
  %3 = load double, double* %arrayidx21, align 8
  %4 = load double, double* %arrayidx13, align 8
  %mul24 = fmul double %3, %4
  %5 = load double, double* %sunkaddr23, align 8
...
for.end:                                          ; preds = %for.body7
  %sunkaddr25 = shl i64 %indvars.iv12, 3
  ...
  %mul35 = fmul double %7, %beta
  %add36 = fadd double %mul32, %mul35
  store double %add36, double* %sunkaddr31, align 8
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %exitcond14 = icmp eq i64 %indvars.iv.next13, 1300
  br i1 %exitcond14, label %for.end41, label %for.end.for.body_crit_edge
