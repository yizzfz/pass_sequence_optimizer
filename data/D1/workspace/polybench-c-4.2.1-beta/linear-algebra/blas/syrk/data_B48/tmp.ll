...
.lr.ph.us.new:                                    ; preds = %.lr.ph.us.new, %.lr.ph.us.new.preheader.new
  %indvars.iv = phi i64 [ %indvars.iv.unr72.ph, %.lr.ph.us.new.preheader.new ], [ %indvars.iv.next.3.1, %.lr.ph.us.new ]
  %8 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %indvars.iv
  %9 = bitcast double* %8 to <2 x double>*
  %10 = load <2 x double>, <2 x double>* %9, align 8
  %11 = fmul <2 x double> %10, %7
  ...
  %15 = fmul <2 x double> %14, %7
  store <2 x double> %15, <2 x double>* %13, align 8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %16 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %indvars.iv.next.3
  ...
  %20 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %indvars.iv.next.1.1
  %21 = bitcast double* %20 to <2 x double>*
  %22 = load <2 x double>, <2 x double>* %21, align 8
  %23 = fmul <2 x double> %22, %7
  store <2 x double> %23, <2 x double>* %21, align 8
  %indvars.iv.next.3.1 = add nsw i64 %indvars.iv, 8
  %exitcond.3.1 = icmp eq i64 %indvars.iv.next.3.1, %indvars.iv39
...
.preheader.us15.new:                              ; preds = %.preheader.us15.new.preheader, %.preheader.us15.new
  ...
  %24 = load double, double* %40, align 8
  %25 = fmul double %24, %2
  %26 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv25, i64 %indvars.iv35
  %27 = load double, double* %26, align 8
  %28 = fmul double %25, %27
  %29 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %indvars.iv25
  %30 = load double, double* %29, align 8
  %31 = fadd double %30, %28
  store double %31, double* %29, align 8
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  %32 = load double, double* %40, align 8
  %33 = fmul double %32, %2
  %34 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv.next26, i64 %indvars.iv35
  %35 = load double, double* %34, align 8
  %36 = fmul double %33, %35
  %37 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %indvars.iv.next26
...
.preheader.us15:                                  ; preds = %._crit_edge.us18, %.preheader.us15.preheader
  ...
  %40 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv41, i64 %indvars.iv35
...
.prol.preheader30:                                ; preds = %.preheader.us15
  ...
  %46 = load double, double* %71, align 8
  %47 = fadd double %46, %45
  store double %47, double* %71, align 8
...
.prol.loopexit31:                                 ; preds = %.preheader.us15, %.prol.preheader30
  ...
  br i1 %70, label %._crit_edge.us18, label %.preheader.us15.new.preheader
...
.lr.ph.us:                                        ; preds = %._crit_edge9.us..lr.ph.us_crit_edge, %.preheader4.lr.ph
  ...
  %48 = add i64 %indvars.iv41, -3
  %49 = zext i2 %indvars.iv63 to i64
...
.prol.preheader:                                  ; preds = %.prol.preheader.preheader, %.prol.preheader
  ...
  %54 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %indvars.iv.prol
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.loopexit, %.lr.ph.us
  %indvars.iv.unr = phi i64 [ 0, %.lr.ph.us ], [ %52, %.prol.loopexit.loopexit ]
  %57 = icmp ult i64 %indvars.iv41, 3
  br i1 %57, label %.preheader.us15.preheader, label %.lr.ph.us.new.preheader

.lr.ph.us.new.preheader:                          ; preds = %.prol.loopexit
  %58 = sub i64 %48, %indvars.iv.unr
  %59 = lshr i64 %58, 2
  %60 = and i64 %59, 1
  %lcmp.mod70 = icmp eq i64 %60, 0
  br i1 %lcmp.mod70, label %.lr.ph.us.new.prol.preheader, label %.lr.ph.us.new.prol.loopexit.unr-lcssa
...
.lr.ph.us.new.prol:                               ; preds = %.lr.ph.us.new.prol.preheader
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %indvars.iv.unr
  %62 = bitcast double* %61 to <2 x double>*
  %63 = load <2 x double>, <2 x double>* %62, align 8
  %64 = fmul <2 x double> %63, %7
  store <2 x double> %64, <2 x double>* %62, align 8
  %indvars.iv.next.1.prol = add nsw i64 %indvars.iv.unr, 2
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %indvars.iv.next.1.prol
  %66 = bitcast double* %65 to <2 x double>*
  %67 = load <2 x double>, <2 x double>* %66, align 8
  %68 = fmul <2 x double> %67, %7
  store <2 x double> %68, <2 x double>* %66, align 8
...
.lr.ph.us.new.prol.loopexit.unr-lcssa:            ; preds = %.lr.ph.us.new.preheader, %.lr.ph.us.new.prol
  %indvars.iv.unr72.ph = phi i64 [ %indvars.iv.next.3.prol, %.lr.ph.us.new.prol ], [ %indvars.iv.unr, %.lr.ph.us.new.preheader ]
  br label %.lr.ph.us.new.prol.loopexit

.lr.ph.us.new.prol.loopexit:                      ; preds = %.lr.ph.us.new.prol.loopexit.unr-lcssa
  %69 = icmp eq i64 %59, 0
  br i1 %69, label %.preheader.us15.preheader.loopexit, label %.lr.ph.us.new.preheader.new
...
.preheader.us15.preheader:                        ; preds = %.preheader.us15.preheader.loopexit, %.prol.loopexit
  ...
  %70 = icmp eq i64 %indvars.iv41, 0
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 0
