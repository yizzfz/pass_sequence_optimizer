...
for.body:                                         ; preds = %for.inc14.for.body_crit_edge, %for.body.lr.ph
  %indvar = phi i32 [ %indvar.next, %for.inc14.for.body_crit_edge ], [ 0, %for.body.lr.ph ]
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc14.for.body_crit_edge ], [ %4, %for.body.lr.ph ]
  %indvars.iv8 = phi i32 [ %indvars.iv.next9, %for.inc14.for.body_crit_edge ], [ %i.promoted, %for.body.lr.ph ]
  ...
  br i1 %cmp41, label %for.body6.lr.ph, label %for.body.for.inc14_crit_edge
...
for.body6.lr.ph:                                  ; preds = %for.body
  ...
  br i1 %lcmp.mod, label %for.body6.prol.preheader, label %for.body6.lr.ph.for.body6.prol.loopexit.unr-lcssa_crit_edge

for.body6.lr.ph.for.body6.prol.loopexit.unr-lcssa_crit_edge: ; preds = %for.body6.lr.ph
...
for.body6.prol.loopexit.unr-lcssa:                ; preds = %for.body6.lr.ph.for.body6.prol.loopexit.unr-lcssa_crit_edge, %for.body6.prol
  %indvars.iv.unr.ph = phi i64 [ 1, %for.body6.prol ], [ 0, %for.body6.lr.ph.for.body6.prol.loopexit.unr-lcssa_crit_edge ]
  br label %for.body6.prol.loopexit

for.body6.prol.loopexit:                          ; preds = %for.body6.prol.loopexit.unr-lcssa
  %13 = icmp eq i32 %7, 0
  br i1 %13, label %for.body6.prol.loopexit.for.inc14.loopexit_crit_edge, label %for.body6.lr.ph.new

for.body6.prol.loopexit.for.inc14.loopexit_crit_edge: ; preds = %for.body6.prol.loopexit
...
for.body6:                                        ; preds = %for.body6.for.body6_crit_edge, %for.body6.lr.ph.new
  ...
  %17 = sub nsw i64 %9, %indvars.iv.next
  %18 = add nsw i64 %17, 1
  ...
  br i1 %exitcond.1, label %for.inc14.loopexit.unr-lcssa, label %for.body6.for.body6_crit_edge
...
for.inc14.loopexit:                               ; preds = %for.body6.prol.loopexit.for.inc14.loopexit_crit_edge, %for.inc14.loopexit.unr-lcssa
  br label %for.inc14

for.inc14:                                        ; preds = %for.body.for.inc14_crit_edge, %for.inc14.loopexit
...
for.end16:                                        ; preds = %entry.for.end16_crit_edge, %for.cond.for.end16_crit_edge
  ret void
}
...
entry:
  ...
  store i32 0, i32* %i, align 4
  %cmp3 = icmp sgt i32 %n, 0
  br i1 %cmp3, label %for.body.lr.ph, label %entry.for.end24_crit_edge
...
for.body:                                         ; preds = %for.end.for.body_crit_edge, %for.body.lr.ph
  %indvar = phi i32 [ %indvar.next, %for.end.for.body_crit_edge ], [ 0, %for.body.lr.ph ]
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.end.for.body_crit_edge ], [ %5, %for.body.lr.ph ]
  %indvars.iv6 = phi i32 [ %indvars.iv.next7, %for.end.for.body_crit_edge ], [ %4, %for.body.lr.ph ]
  %7 = add i32 %4, %indvar
  ...
  br i1 %cmp41, label %for.body5.lr.ph, label %for.body.for.end_crit_edge

for.body.for.end_crit_edge:                       ; preds = %for.body
  br label %for.end

for.body5.lr.ph:                                  ; preds = %for.body
  %arrayidx13 = getelementptr inbounds double, double* %1, i64 %indvars.iv8
  %wide.trip.count = zext i32 %indvars.iv6 to i64
  %11 = and i32 %7, 1
  %lcmp.mod = icmp eq i32 %11, 0
  br i1 %lcmp.mod, label %for.body5.prol.preheader, label %for.body5.lr.ph.for.body5.prol.loopexit.unr-lcssa_crit_edge

for.body5.lr.ph.for.body5.prol.loopexit.unr-lcssa_crit_edge: ; preds = %for.body5.lr.ph
...
for.body5.prol.loopexit.unr-lcssa:                ; preds = %for.body5.lr.ph.for.body5.prol.loopexit.unr-lcssa_crit_edge, %for.body5.prol
  %indvars.iv.unr.ph = phi i64 [ 1, %for.body5.prol ], [ 0, %for.body5.lr.ph.for.body5.prol.loopexit.unr-lcssa_crit_edge ]
  br label %for.body5.prol.loopexit

for.body5.prol.loopexit:                          ; preds = %for.body5.prol.loopexit.unr-lcssa
  %15 = icmp eq i32 %7, 0
  br i1 %15, label %for.body5.prol.loopexit.for.end.loopexit_crit_edge, label %for.body5.lr.ph.new

for.body5.prol.loopexit.for.end.loopexit_crit_edge: ; preds = %for.body5.prol.loopexit
  br label %for.end.loopexit

for.body5.lr.ph.new:                              ; preds = %for.body5.prol.loopexit
  br label %for.body5

for.body5:                                        ; preds = %for.body5.for.body5_crit_edge, %for.body5.lr.ph.new
  %indvars.iv = phi i64 [ %indvars.iv.unr.ph, %for.body5.lr.ph.new ], [ %indvars.iv.next.1, %for.body5.for.body5_crit_edge ]
  ...
  %exitcond.1 = icmp eq i64 %indvars.iv.next, %wide.trip.count
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  br i1 %exitcond.1, label %for.end.loopexit.unr-lcssa, label %for.body5.for.body5_crit_edge
...
for.end.loopexit:                                 ; preds = %for.body5.prol.loopexit.for.end.loopexit_crit_edge, %for.end.loopexit.unr-lcssa
  br label %for.end
...
for.end24:                                        ; preds = %entry.for.end24_crit_edge, %for.cond.for.end24_crit_edge
  ret void
}
...
for.body:                                         ; preds = %for.inc.for.body_crit_edge, %for.body.lr.ph
  %indvars.iv = phi i64 [ %6, %for.body.lr.ph ], [ %indvars.iv.next, %for.inc.for.body_crit_edge ]
  %8 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %arrayidx = getelementptr inbounds double, double* %4, i64 %indvars.iv
  %9 = load double, double* %arrayidx, align 8
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %8, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i64 0, i64 0), double %9) #5
...
for.end:                                          ; preds = %entry.for.end_crit_edge, %for.cond.for.end_crit_edge
  ...
  %call5 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %13, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #5
