...
if.then:                                          ; preds = %land.lhs.true
  tail call void @print_array(i32 1300, double* %arraydecay13)
  br label %if.end
...
for.inc.us:                                       ; preds = %for.inc.us, %for.body.us
  ...
  %exitcond14 = icmp eq i64 %indvars.iv.next, 1300
  br i1 %exitcond14, label %for.cond2.for.inc24_crit_edge.us, label %for.inc.us
...
entry:
  br i1 true, label %for.body.us.preheader, label %for.end41

for.body.us.preheader:                            ; preds = %entry
  br label %for.body.us

for.body.us:                                      ; preds = %for.cond5.for.inc39_crit_edge.us, %for.body.us.preheader
  %indvars.iv5 = phi i64 [ 0, %for.body.us.preheader ], [ %indvars.iv.next6, %for.cond5.for.inc39_crit_edge.us ]
...
for.inc.us:                                       ; preds = %for.inc.us, %for.body.us
  ...
  br i1 %exitcond11, label %for.cond5.for.inc39_crit_edge.us, label %for.inc.us
...
for.inc:                                          ; preds = %if.then, %for.body
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next, 1300
