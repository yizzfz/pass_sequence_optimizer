...
for.inc48.prol.loopexit:                          ; preds = %for.inc48.prol.loopexit.loopexit, %for.inc48.lr.ph
  ...
  %16 = icmp ult i32 %8, 7
  br i1 %16, label %for.cond19.loopexit, label %for.inc48.preheader
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.cond19.loopexit, label %for.inc48.preheader75
...
entry:
  ...
  %broadcast.splatinsert122 = insertelement <2 x double> undef, double %mul44.us57, i32 0
...
for.cond4.preheader.us43:                         ; preds = %for.cond4.preheader.us43, %for.cond4.preheader.us43.preheader
  ...
  %arrayidx31.us50 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv95, i64 %indvars.iv
  %27 = load double, double* %arrayidx31.us50, align 8
  %mul32.us51 = fmul double %27, %beta
  %arrayidx36.us52 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv95, i64 %indvars.iv
  ...
  %arrayidx31.us50.1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv95, i64 %indvars.iv.next
  %30 = load double, double* %arrayidx31.us50.1, align 8
  %mul32.us51.1 = fmul double %30, %beta
  %arrayidx36.us52.1 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv95, i64 %indvars.iv.next
  ...
  br i1 %exitcond.1, label %for.cond1.for.inc53_crit_edge.us.loopexit126, label %for.cond4.preheader.us43, !llvm.loop !17
...
for.cond1.for.inc53_crit_edge.us.loopexit126:     ; preds = %for.cond4.preheader.us43
  br label %for.cond1.for.inc53_crit_edge.us
...
for.inc.us.us:                                    ; preds = %for.inc.us.us, %for.cond4.preheader.us.us
  %indvars.iv85 = phi i64 [ 0, %for.cond4.preheader.us.us ], [ %indvars.iv.next86, %for.inc.us.us ]
  %temp2.034.us.us = phi double [ 0.000000e+00, %for.cond4.preheader.us.us ], [ %add27.us.us, %for.inc.us.us ]
