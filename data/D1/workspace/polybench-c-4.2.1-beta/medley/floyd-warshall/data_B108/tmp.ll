...
._crit_edge15:                                    ; preds = %._crit_edge15, %.preheader.us
  ...
  %1 = mul nuw nsw i64 %indvars.iv17, %indvars.iv
  %2 = trunc i64 %1 to i32
  %3 = srem i32 %2, 7
  %4 = add nsw i32 %3, 1
  %5 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv17, i64 %indvars.iv
  %6 = add nuw nsw i64 %indvars.iv, %indvars.iv17
  %7 = trunc i64 %6 to i32
  %8 = srem i32 %7, 13
  %9 = icmp eq i32 %8, 0
  %10 = srem i32 %7, 7
  %11 = icmp eq i32 %10, 0
  %or.cond.us = or i1 %9, %11
  %12 = srem i32 %7, 11
  %13 = icmp eq i32 %12, 0
  %or.cond3.us = or i1 %13, %or.cond.us
  %. = select i1 %or.cond3.us, i32 999, i32 %4
...
.loopexit.us:                                     ; preds = %._crit_edge15
  ...
  %exitcond1 = icmp eq i64 %indvars.iv.next18, 2800
  br i1 %exitcond1, label %._crit_edge, label %.preheader.us
...
.preheader3.us..preheader.us.us_crit_edge:        ; preds = %.loopexit7.us, %.preheader3.lr.ph..preheader3.us_crit_edge
  ...
  %scevgep5 = getelementptr [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv35, i64 0
  %1 = add nuw nsw i64 %indvars.iv35, 1
  %scevgep7 = getelementptr [2800 x i32], [2800 x i32]* %0, i64 %1, i64 0
  br label %.preheader.us.us

.loopexit7.us:                                    ; preds = %.loopexit.us.us
  %indvars.iv.next36 = add nuw nsw i64 %indvars.iv35, 1
  %exitcond1 = icmp eq i64 %indvars.iv.next36, 2800
  br i1 %exitcond1, label %._crit_edge, label %.preheader3.us..preheader.us.us_crit_edge
...
.preheader.us.us:                                 ; preds = %.loopexit.us.us, %.preheader3.us..preheader.us.us_crit_edge
  ...
  %scevgep = getelementptr [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv33, i64 0
  %2 = add nuw nsw i64 %indvars.iv33, 1
  %scevgep3 = getelementptr [2800 x i32], [2800 x i32]* %0, i64 %2, i64 0
  %3 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv33, i64 %indvars.iv35
  %bound0 = icmp ult i32* %scevgep, %3
  %bound1 = icmp ult i32* %3, %scevgep3
  %found.conflict = and i1 %bound0, %bound1
  %bound010 = icmp ult i32* %scevgep, %scevgep7
  %bound111 = icmp ult i32* %scevgep5, %scevgep3
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %4 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv33, i64 %index
  %5 = bitcast i32* %4 to <4 x i32>*
  %wide.load = load <4 x i32>, <4 x i32>* %5, align 4, !alias.scope !1, !noalias !4
  %6 = getelementptr i32, i32* %4, i64 4
  %7 = bitcast i32* %6 to <4 x i32>*
  %wide.load14 = load <4 x i32>, <4 x i32>* %7, align 4, !alias.scope !1, !noalias !4
  ...
  %13 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv35, i64 %index
  %14 = bitcast i32* %13 to <4 x i32>*
  %wide.load15 = load <4 x i32>, <4 x i32>* %14, align 4, !alias.scope !8
  %15 = getelementptr i32, i32* %13, i64 4
  %16 = bitcast i32* %15 to <4 x i32>*
  %wide.load16 = load <4 x i32>, <4 x i32>* %16, align 4, !alias.scope !8
  %17 = add nsw <4 x i32> %wide.load15, %10
  %18 = add nsw <4 x i32> %wide.load16, %12
  %19 = icmp slt <4 x i32> %wide.load, %17
  %20 = icmp slt <4 x i32> %wide.load14, %18
  %21 = select <4 x i1> %19, <4 x i32> %wide.load, <4 x i32> %17
  %22 = select <4 x i1> %20, <4 x i32> %wide.load14, <4 x i32> %18
  ...
  br i1 %25, label %.loopexit.us.us.loopexit17, label %vector.body, !llvm.loop !9

.loopexit.us.us.loopexit:                         ; preds = %scalar.ph
  br label %.loopexit.us.us

.loopexit.us.us.loopexit17:                       ; preds = %vector.body
  br label %.loopexit.us.us

.loopexit.us.us:                                  ; preds = %.loopexit.us.us.loopexit17, %.loopexit.us.us.loopexit
...
scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader
  ...
  %26 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv33, i64 %indvars.iv
  %27 = load i32, i32* %26, align 4
  %28 = load i32, i32* %3, align 4
  %29 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv35, i64 %indvars.iv
  ...
  %33 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv33, i64 %indvars.iv.next
  %34 = load i32, i32* %33, align 4
  %35 = load i32, i32* %3, align 4
  %36 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv35, i64 %indvars.iv.next
...
.preheader.us:                                    ; preds = %.loopexit.us, %.preheader.lr.ph..preheader.us_crit_edge
  ...
  %5 = mul nuw nsw i64 %indvars.iv14, 2800
...
._crit_edge12:                                    ; preds = %._crit_edge11, %.preheader.us
  ...
  %8 = srem i32 %7, 20
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %10, label %._crit_edge11
...
._crit_edge11:                                    ; preds = %._crit_edge12, %10
  %12 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %13 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv14, i64 %indvars.iv
...
.loopexit.us:                                     ; preds = %._crit_edge11
  ...
  %exitcond1 = icmp eq i64 %indvars.iv.next15, 2800
  br i1 %exitcond1, label %._crit_edge, label %.preheader.us
