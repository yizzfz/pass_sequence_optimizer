...
; <label>:8:                                      ; preds = %5
  ...
  %15 = icmp sgt i32 %9, 0
  %16 = icmp slt i32 %4, 1
  br label %.loopexit6._crit_edge

.loopexit6._crit_edge:                            ; preds = %.loopexit6, %8
  %17 = phi i64 [ 0, %8 ], [ %84, %.loopexit6 ]
  %18 = mul i64 %17, 280
  %scevgep = getelementptr i8, i8* %2, i64 %18
  br i1 %15, label %19, label %.loopexit6

; <label>:19:                                     ; preds = %.loopexit6._crit_edge
  %20 = trunc i64 %17 to i32
  br i1 %16, label %.loopexit6.loopexit, label %.split.preheader

.split.preheader:                                 ; preds = %19
  br label %.split

.split:                                           ; preds = %.split.preheader, %.loopexit
  %21 = phi i64 [ %82, %.loopexit ], [ 0, %.split.preheader ]
...
._crit_edge19:                                    ; preds = %49, %._crit_edge
  %41 = phi float [ 0.000000e+00, %._crit_edge ], [ %75, %49 ]
  %42 = phi float [ 0.000000e+00, %._crit_edge ], [ %72, %49 ]
  %43 = phi float [ 0.000000e+00, %._crit_edge ], [ %69, %49 ]
  %44 = phi i32 [ 0, %._crit_edge ], [ %50, %49 ]
...
; <label>:49:                                     ; preds = %._crit_edge20
  %50 = add nuw nsw i32 %44, 1
  %51 = icmp eq i32 %50, %4
  br i1 %51, label %33, label %._crit_edge19

._crit_edge20:                                    ; preds = %._crit_edge20, %._crit_edge19
  %52 = phi i64 [ 0, %._crit_edge19 ], [ %76, %._crit_edge20 ]
  %53 = phi float [ %41, %._crit_edge19 ], [ %75, %._crit_edge20 ]
  %54 = phi float [ %42, %._crit_edge19 ], [ %72, %._crit_edge20 ]
  %55 = phi float [ %43, %._crit_edge19 ], [ %69, %._crit_edge20 ]
  ...
  br i1 %77, label %49, label %._crit_edge20

.loopexit.loopexit:                               ; preds = %33
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %.split
  %78 = phi i32 [ 0, %.split ], [ %38, %.loopexit.loopexit ]
  ...
  br i1 %83, label %.loopexit6.loopexit25, label %.split

.loopexit6.loopexit:                              ; preds = %19
  call void @llvm.memset.p0i8.i64(i8* %scevgep, i8 0, i64 %12, i32 1, i1 false)
  br label %.loopexit6

.loopexit6.loopexit25:                            ; preds = %.loopexit
  br label %.loopexit6

.loopexit6:                                       ; preds = %.loopexit6.loopexit25, %.loopexit6._crit_edge, %.loopexit6.loopexit
  %84 = add nuw nsw i64 %17, 1
  %85 = icmp eq i64 %84, %14
  br i1 %85, label %.loopexit7.loopexit, label %.loopexit6._crit_edge
...
._crit_edge14:                                    ; preds = %111, %4
  %6 = phi i64 [ 0, %4 ], [ %112, %111 ]
  %7 = mul nuw nsw i64 %6, 280
  br label %.loopexit._crit_edge

.loopexit._crit_edge:                             ; preds = %.loopexit, %._crit_edge14
  %8 = phi i64 [ 0, %._crit_edge14 ], [ %109, %.loopexit ]
  %9 = add nsw i64 %8, -4
  %10 = icmp slt i64 %9, %5
...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge13
  %20 = phi i64 [ 0, %._crit_edge13 ], [ %94, %._crit_edge ]
  %21 = phi float [ 0.000000e+00, %._crit_edge13 ], [ %93, %._crit_edge ]
  %22 = phi float [ 0.000000e+00, %._crit_edge13 ], [ %90, %._crit_edge ]
  %23 = phi float [ 0.000000e+00, %._crit_edge13 ], [ %87, %._crit_edge ]
...
; <label>:96:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond, label %.loopexit.loopexit, label %._crit_edge13

.loopexit.loopexit:                               ; preds = %96
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %.loopexit._crit_edge
  %105 = phi i32 [ 0, %.loopexit._crit_edge ], [ %102, %.loopexit.loopexit ]
  ...
  br i1 %110, label %111, label %.loopexit._crit_edge

; <label>:111:                                    ; preds = %.loopexit
  %112 = add nuw nsw i64 %6, 1
  %113 = icmp eq i64 %112, 219
  br i1 %113, label %114, label %._crit_edge14
...
; <label>:9:                                      ; preds = %3
  ...
  %20 = icmp eq i64 %17, 0
  %21 = icmp eq i32 %2, 1
  br label %.loopexit5._crit_edge

.loopexit5._crit_edge:                            ; preds = %.loopexit5, %9
  %22 = phi i64 [ 0, %9 ], [ %106, %.loopexit5 ]
  %23 = trunc i64 %22 to i32
  %24 = mul i64 %22, 1202590842880
  %25 = ashr exact i64 %24, 32
  %26 = getelementptr i8, i8* %1, i64 %25
  br i1 %18, label %27, label %.loopexit5

; <label>:27:                                     ; preds = %.loopexit5._crit_edge
  %28 = mul nuw nsw i64 %22, 280
  br i1 %19, label %.preheader1, label %64

.preheader1:                                      ; preds = %27
  br i1 %20, label %.preheader1.split.us.preheader, label %.preheader1.split

.preheader1.split.us.preheader:                   ; preds = %.preheader1
  br label %.preheader1.split.us

.preheader1.split.us:                             ; preds = %.preheader1.split.us.preheader, %.us-lcssa.us.us
  %29 = phi i64 [ %61, %.us-lcssa.us.us ], [ 0, %.preheader1.split.us.preheader ]
  %30 = trunc i64 %29 to i32
  br i1 %21, label %.us-lcssa.us.us, label %.preheader.us.us.preheader

.preheader.us.us.preheader:                       ; preds = %.preheader1.split.us
  br label %.preheader.us.us

.preheader.us.us:                                 ; preds = %.preheader.us.us.preheader, %.loopexit.us.us
  %31 = phi i32 [ %36, %.loopexit.us.us ], [ 0, %.preheader.us.us.preheader ]
  %32 = phi float [ %55, %.loopexit.us.us ], [ 0.000000e+00, %.preheader.us.us.preheader ]
  %33 = add nuw nsw i32 %31, %23
  %34 = mul nsw i32 %33, 280
  %35 = add i32 %34, %30
  br label %._crit_edge

.loopexit.us.us:                                  ; preds = %._crit_edge
  %36 = add nuw nsw i32 %31, 1
  %37 = icmp eq i32 %36, %2
  br i1 %37, label %.us-lcssa.us.us.loopexit, label %.preheader.us.us

._crit_edge:                                      ; preds = %._crit_edge, %.preheader.us.us
  %38 = phi i64 [ 0, %.preheader.us.us ], [ %56, %._crit_edge ]
  %39 = phi float [ %32, %.preheader.us.us ], [ %55, %._crit_edge ]
  ...
  br i1 %57, label %.loopexit.us.us, label %._crit_edge

.us-lcssa.us.us.loopexit:                         ; preds = %.loopexit.us.us
  br label %.us-lcssa.us.us

.us-lcssa.us.us:                                  ; preds = %.us-lcssa.us.us.loopexit, %.preheader1.split.us
  %.lcssa7.ph.us.us = phi float [ undef, %.preheader1.split.us ], [ %55, %.us-lcssa.us.us.loopexit ]
  %58 = fptoui float %.lcssa7.ph.us.us to i8
  %59 = add nuw nsw i64 %29, %28
  %60 = getelementptr inbounds i8, i8* %1, i64 %59
  store i8 %58, i8* %60, align 1, !tbaa !1
  %61 = add nuw nsw i64 %29, 1
  %62 = icmp eq i64 %61, %15
  br i1 %62, label %.loopexit5.loopexit, label %.preheader1.split.us
...
; <label>:64:                                     ; preds = %27
  tail call void @llvm.memset.p0i8.i64(i8* %26, i8 0, i64 %13, i32 1, i1 false)
  br label %.loopexit5

..split_crit_edge:                                ; preds = %.us-lcssa, %.preheader1.split
  %65 = phi i64 [ 0, %.preheader1.split ], [ %70, %.us-lcssa ]
  %66 = trunc i64 %65 to i32
  br label %.loopexit._crit_edge

.us-lcssa:                                        ; preds = %.loopexit
  %67 = fptoui float %83 to i8
  %68 = add nuw nsw i64 %65, %28
  %69 = getelementptr inbounds i8, i8* %1, i64 %68
  store i8 %67, i8* %69, align 1, !tbaa !1
  %70 = add nuw nsw i64 %65, 1
  %71 = icmp eq i64 %70, %15
  br i1 %71, label %.loopexit5.loopexit24, label %..split_crit_edge

.loopexit._crit_edge:                             ; preds = %.loopexit, %..split_crit_edge
  %indvars.iv = phi i64 [ 0, %..split_crit_edge ], [ %indvars.iv.next, %.loopexit ]
  %72 = phi float [ 0.000000e+00, %..split_crit_edge ], [ %83, %.loopexit ]
  %73 = add nuw nsw i64 %indvars.iv, %63
  %74 = mul nsw i64 %73, 280
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %.loopexit._crit_edge
  %83 = phi float [ %82, %.loopexit._crit_edge ], [ %103, %.loopexit.loopexit ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %84 = icmp eq i64 %indvars.iv.next, %14
  br i1 %84, label %.us-lcssa, label %.loopexit._crit_edge

.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  %85 = phi i64 [ %104, %.preheader ], [ 1, %.preheader.preheader ]
  %86 = phi float [ %103, %.preheader ], [ %82, %.preheader.preheader ]
  ...
  br i1 %105, label %.loopexit.loopexit, label %.preheader

.loopexit6.loopexit:                              ; preds = %.loopexit5
  br label %.loopexit6

.loopexit6:                                       ; preds = %.loopexit6.loopexit, %3
  ret void

.loopexit5.loopexit:                              ; preds = %.us-lcssa.us.us
  br label %.loopexit5

.loopexit5.loopexit24:                            ; preds = %.us-lcssa
  br label %.loopexit5

.loopexit5:                                       ; preds = %.loopexit5.loopexit24, %.loopexit5.loopexit, %.loopexit5._crit_edge, %64
  %106 = add nuw nsw i64 %22, 1
  %107 = icmp eq i64 %106, %16
  br i1 %107, label %.loopexit6.loopexit, label %.loopexit5._crit_edge
}
...
.loopexit._crit_edge:                             ; preds = %.loopexit, %._crit_edge14
  %27 = phi i64 [ 0, %._crit_edge14 ], [ %132, %.loopexit ]
  %28 = add nsw i64 %27, -4
...
; <label>:42:                                     ; preds = %._crit_edge13
  ...
  br i1 %51, label %._crit_edge, label %.loopexit.loopexit

._crit_edge13:                                    ; preds = %._crit_edge13, %._crit_edge
  %52 = phi i64 [ 0, %._crit_edge ], [ %126, %._crit_edge13 ]
  %53 = phi float [ 0.000000e+00, %._crit_edge ], [ %125, %._crit_edge13 ]
  %54 = phi float [ 0.000000e+00, %._crit_edge ], [ %122, %._crit_edge13 ]
  %55 = phi float [ 0.000000e+00, %._crit_edge ], [ %119, %._crit_edge13 ]
  ...
  br i1 %127, label %42, label %._crit_edge13

.loopexit.loopexit:                               ; preds = %42
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %.loopexit._crit_edge
  %128 = phi i32 [ 0, %.loopexit._crit_edge ], [ %48, %.loopexit.loopexit ]
  ...
  br i1 %133, label %134, label %.loopexit._crit_edge

; <label>:134:                                    ; preds = %.loopexit
  %135 = add nuw nsw i64 %23, 1
  %136 = icmp eq i64 %135, 219
  br i1 %136, label %137, label %._crit_edge14
...
; <label>:143:                                    ; preds = %._crit_edge16
  ...
  br i1 %145, label %19, label %._crit_edge15

._crit_edge16:                                    ; preds = %._crit_edge16, %._crit_edge15
  %146 = phi i64 [ 0, %._crit_edge15 ], [ %152, %._crit_edge16 ]
  ...
  br i1 %153, label %143, label %._crit_edge16

._crit_edge17:                                    ; preds = %159, %137
...
; <label>:159:                                    ; preds = %._crit_edge18
  %160 = add nuw nsw i64 %154, 1
  %161 = icmp eq i64 %160, 223
  br i1 %161, label %156, label %._crit_edge17

._crit_edge18:                                    ; preds = %._crit_edge18, %._crit_edge17
  %162 = phi i64 [ 0, %._crit_edge17 ], [ %172, %._crit_edge18 ]
  ...
  br i1 %173, label %159, label %._crit_edge18
}
