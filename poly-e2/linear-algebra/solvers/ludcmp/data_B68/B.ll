...
for.body30.preheader:                             ; preds = %for.cond1.preheader
  %2 = sub i64 0, %indvars.iv7
  %xtraiter16 = and i64 %2, 7
...
for.body30.prol:                                  ; preds = %for.body30.prol, %for.body30.prol.preheader
  %indvars.iv128.prol = phi i64 [ %indvars.iv.next129.prol, %for.body30.prol ], [ %indvars.iv7, %for.body30.prol.preheader ]
  %prol.iter18 = phi i64 [ %prol.iter18.sub, %for.body30.prol ], [ %xtraiter16, %for.body30.prol.preheader ]
  ...
  br i1 %prol.iter18.cmp, label %for.body30.prol.loopexit.loopexit, label %for.body30.prol, !llvm.loop !20
...
for.body30.prol.loopexit:                         ; preds = %for.body30.prol.loopexit.loopexit, %for.body30.preheader
  %indvars.iv128.unr = phi i64 [ %indvars.iv7, %for.body30.preheader ], [ %indvars.iv.next129.prol, %for.body30.prol.loopexit.loopexit ]
  %3 = icmp ult i64 %0, 7
...
for.inc48.us.prol.loopexit:                       ; preds = %for.inc48.us.prol, %for.body30.us
  ...
  br i1 %23, label %for.inc55.us, label %for.body30.us.new
...
for.body3:                                        ; preds = %for.body3.preheader, %for.inc25
  ...
  %11 = and i64 %indvars.iv152, 4294967295
...
for.inc.preheader:                                ; preds = %for.body3
  %13 = and i64 %indvars.iv152, 1
  %lcmp.mod20 = icmp eq i64 %13, 0
...
for.inc:                                          ; preds = %for.inc, %for.inc.preheader.new
  ...
  %exitcond154.1 = icmp eq i64 %indvars.iv.next119, %11
...
for.inc25:                                        ; preds = %for.inc25.loopexit, %for.inc.prol.loopexit, %for.body3
  ...
  %indvars.iv.next153 = add nuw nsw i64 %11, 1
  %exitcond9 = icmp eq i64 %indvars.iv.next125, %indvars.iv7
  br i1 %exitcond9, label %for.body30.us.preheader, label %for.body3

for.body30.us.preheader:                          ; preds = %for.inc25
  %22 = and i64 %indvars.iv156, 1
  %lcmp.mod22 = icmp eq i64 %22, 0
...
for.body63:                                       ; preds = %for.body63.preheader, %for.inc82
  ...
  %24 = and i64 %indvars.iv149, 4294967295
...
for.inc77.preheader:                              ; preds = %for.body63
  %26 = add nsw i64 %indvars.iv149, 1
  %xtraiter13 = and i64 %26, 3
  %lcmp.mod14 = icmp eq i64 %xtraiter13, 0
  br i1 %lcmp.mod14, label %for.inc77.prol.loopexit, label %for.inc77.prol.preheader
...
for.inc77.prol:                                   ; preds = %for.inc77.prol, %for.inc77.prol.preheader
  ...
  %w.287.prol = phi double [ %sub76.prol, %for.inc77.prol ], [ %25, %for.inc77.prol.preheader ]
  %prol.iter15 = phi i64 [ %prol.iter15.sub, %for.inc77.prol ], [ %xtraiter13, %for.inc77.prol.preheader ]
  ...
  br i1 %prol.iter15.cmp, label %for.inc77.prol.loopexit.loopexit, label %for.inc77.prol, !llvm.loop !22
...
for.inc77.prol.loopexit:                          ; preds = %for.inc77.prol.loopexit.loopexit, %for.inc77.preheader
  ...
  %w.287.unr = phi double [ %25, %for.inc77.preheader ], [ %sub76.prol, %for.inc77.prol.loopexit.loopexit ]
  %29 = icmp ult i64 %24, 3
  br i1 %29, label %for.inc82, label %for.inc77.preheader.new
...
for.inc77:                                        ; preds = %for.inc77, %for.inc77.preheader.new
  ...
  %exitcond151.3 = icmp eq i64 %indvars.iv.next.2, %24
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
...
for.inc82:                                        ; preds = %for.inc82.loopexit, %for.inc77.prol.loopexit, %for.body63
  %w.2.lcssa = phi double [ %25, %for.body63 ], [ %sub76.lcssa.unr, %for.inc77.prol.loopexit ], [ %sub76.3, %for.inc82.loopexit ]
  ...
  %indvars.iv.next150 = add nuw nsw i64 %24, 1
...
for.inc102.prol:                                  ; preds = %for.inc102.prol, %for.inc102.prol.preheader
  ...
  %w.379.prol = phi double [ %sub101.prol, %for.inc102.prol ], [ %39, %for.inc102.prol.preheader ]
...
for.inc102.prol.loopexit:                         ; preds = %for.inc102.prol.loopexit.loopexit, %for.inc102.preheader
  ...
  %w.379.unr = phi double [ %39, %for.inc102.preheader ], [ %sub101.prol, %for.inc102.prol.loopexit.loopexit ]
  %42 = icmp ult i64 %38, 3
  br i1 %42, label %for.inc112, label %for.inc102.preheader.new
...
for.inc102:                                       ; preds = %for.inc102, %for.inc102.preheader.new
  ...
  %exitcond.3 = icmp eq i64 %indvars.iv108, 1996
...
for.inc112:                                       ; preds = %for.inc112.loopexit, %for.inc102.prol.loopexit, %for.body88
  %w.3.lcssa = phi double [ %39, %for.body88 ], [ %sub101.lcssa.unr, %for.inc102.prol.loopexit ], [ %sub101.3, %for.inc112.loopexit ]
