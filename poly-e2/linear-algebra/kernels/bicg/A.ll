...
entry:
  ...
  %0 = bitcast i8* %call to [2100 x [1900 x double]]*
  store [2100 x [1900 x double]]* %0, [2100 x [1900 x double]]** %A, align 8
  %call1 = call i8* @polybench_alloc_data(i64 1900, i32 8)
  %1 = bitcast i8* %call1 to [1900 x double]*
  store [1900 x double]* %1, [1900 x double]** %s, align 8
  %call2 = call i8* @polybench_alloc_data(i64 2100, i32 8)
  %2 = bitcast i8* %call2 to [2100 x double]*
  store [2100 x double]* %2, [2100 x double]** %q, align 8
  %call3 = call i8* @polybench_alloc_data(i64 1900, i32 8)
  %3 = bitcast i8* %call3 to [1900 x double]*
  store [1900 x double]* %3, [1900 x double]** %p, align 8
  %call4 = call i8* @polybench_alloc_data(i64 2100, i32 8)
  %4 = bitcast i8* %call4 to [2100 x double]*
  store [2100 x double]* %4, [2100 x double]** %r, align 8
  %5 = load i32, i32* %m, align 4
  %6 = load i32, i32* %n, align 4
  %7 = load [2100 x [1900 x double]]*, [2100 x [1900 x double]]** %A, align 8
  %arraydecay = getelementptr inbounds [2100 x [1900 x double]], [2100 x [1900 x double]]* %7, i32 0, i32 0
  %8 = load [2100 x double]*, [2100 x double]** %r, align 8
  %arraydecay5 = getelementptr inbounds [2100 x double], [2100 x double]* %8, i32 0, i32 0
  %9 = load [1900 x double]*, [1900 x double]** %p, align 8
  %arraydecay6 = getelementptr inbounds [1900 x double], [1900 x double]* %9, i32 0, i32 0
  call void @init_array(i32 %5, i32 %6, [1900 x double]* %arraydecay, double* %arraydecay5, double* %arraydecay6)
  call void (...) @polybench_timer_start()
  %10 = load i32, i32* %m, align 4
  %11 = load i32, i32* %n, align 4
  %12 = load [2100 x [1900 x double]]*, [2100 x [1900 x double]]** %A, align 8
  %arraydecay7 = getelementptr inbounds [2100 x [1900 x double]], [2100 x [1900 x double]]* %12, i32 0, i32 0
  %13 = load [1900 x double]*, [1900 x double]** %s, align 8
  %arraydecay8 = getelementptr inbounds [1900 x double], [1900 x double]* %13, i32 0, i32 0
  %14 = load [2100 x double]*, [2100 x double]** %q, align 8
  %arraydecay9 = getelementptr inbounds [2100 x double], [2100 x double]* %14, i32 0, i32 0
  %15 = load [1900 x double]*, [1900 x double]** %p, align 8
  %arraydecay10 = getelementptr inbounds [1900 x double], [1900 x double]* %15, i32 0, i32 0
  %16 = load [2100 x double]*, [2100 x double]** %r, align 8
  %arraydecay11 = getelementptr inbounds [2100 x double], [2100 x double]* %16, i32 0, i32 0
  call void @kernel_bicg(i32 %10, i32 %11, [1900 x double]* %arraydecay7, double* %arraydecay8, double* %arraydecay9, double* %arraydecay10, double* %arraydecay11)
...
land.lhs.true:                                    ; preds = %entry
  ...
  %call12 = call i32 @strcmp(i8* %19, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i32 0, i32 0)) #4
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %22 = load [1900 x double]*, [1900 x double]** %s, align 8
  %arraydecay13 = getelementptr inbounds [1900 x double], [1900 x double]* %22, i32 0, i32 0
  %23 = load [2100 x double]*, [2100 x double]** %q, align 8
  %arraydecay14 = getelementptr inbounds [2100 x double], [2100 x double]* %23, i32 0, i32 0
  call void @print_array(i32 %20, i32 %21, double* %arraydecay13, double* %arraydecay14)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  %24 = load [2100 x [1900 x double]]*, [2100 x [1900 x double]]** %A, align 8
  %25 = bitcast [2100 x [1900 x double]]* %24 to i8*
  call void @free(i8* %25) #5
  %26 = load [1900 x double]*, [1900 x double]** %s, align 8
  %27 = bitcast [1900 x double]* %26 to i8*
  call void @free(i8* %27) #5
  %28 = load [2100 x double]*, [2100 x double]** %q, align 8
  %29 = bitcast [2100 x double]* %28 to i8*
  call void @free(i8* %29) #5
  %30 = load [1900 x double]*, [1900 x double]** %p, align 8
  %31 = bitcast [1900 x double]* %30 to i8*
  call void @free(i8* %31) #5
  %32 = load [2100 x double]*, [2100 x double]** %r, align 8
  %33 = bitcast [2100 x double]* %32 to i8*
...
for.body15:                                       ; preds = %for.cond12
  ...
  %21 = load [1900 x double]*, [1900 x double]** %A.addr, align 8
  %22 = load i32, i32* %i, align 4
  %idxprom20 = sext i32 %22 to i64
  %arrayidx21 = getelementptr inbounds [1900 x double], [1900 x double]* %21, i64 %idxprom20
...
for.body8:                                        ; preds = %for.cond6
  ...
  %17 = load [1900 x double]*, [1900 x double]** %A.addr, align 8
  %18 = load i32, i32* %i, align 4
  %idxprom13 = sext i32 %18 to i64
  %arrayidx14 = getelementptr inbounds [1900 x double], [1900 x double]* %17, i64 %idxprom13
  ...
  %26 = load [1900 x double]*, [1900 x double]** %A.addr, align 8
  %27 = load i32, i32* %i, align 4
  %idxprom21 = sext i32 %27 to i64
  %arrayidx22 = getelementptr inbounds [1900 x double], [1900 x double]* %26, i64 %idxprom21
...
for.end:                                          ; preds = %for.cond
  ...
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %12, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %for.cond7
...
for.end20:                                        ; preds = %for.cond7
  ...
  %call21 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %22, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i32 0, i32 0))
