...
for.cond1.preheader:                              ; preds = %for.inc87, %for.cond1.preheader.lr.ph
  ...
  br i1 %0, label %for.cond4.preheader.us.preheader, label %for.inc87
...
for.cond44.preheader.us:                          ; preds = %for.cond44.preheader.us.preheader, %for.cond44.for.inc84_crit_edge.us
  ...
  %scevgep30 = getelementptr [1300 x double], [1300 x double]* %A, i64 %48, i64 %wide.trip.count20
  %scevgep32 = getelementptr [1300 x double], [1300 x double]* %B, i64 %indvar, i64 1
  %49 = add i64 %indvar, 2
  %scevgep34 = getelementptr [1300 x double], [1300 x double]* %B, i64 %49, i64 %wide.trip.count20
