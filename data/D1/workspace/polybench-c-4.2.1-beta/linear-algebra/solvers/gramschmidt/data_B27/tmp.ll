...
.preheader.us.prol.loopexit:                      ; preds = %.preheader.us.prol.loopexit.loopexit, %.preheader.us.preheader
  ...
  br i1 %25, label %._crit_edge30, label %._crit_edge.us.3.preheader
...
._crit_edge.us.3.prol.loopexit:                   ; preds = %._crit_edge.us.3.prol, %._crit_edge.us.3.preheader
  ...
  %30 = icmp eq i64 %28, 0
  br i1 %30, label %._crit_edge30.loopexit, label %._crit_edge.us.3.preheader.new
...
.lr.ph71:                                         ; preds = %._crit_edge
  ...
  br i1 %lcmp.mod122, label %.prol.loopexit120, label %.prol.preheader119
...
.prol.loopexit120:                                ; preds = %.lr.ph71, %.prol.preheader119
...
.preheader65:                                     ; preds = %.preheader65.loopexit, %.prol.loopexit120, %._crit_edge
  ...
  br i1 %54, label %.lr.ph77, label %._crit_edge78

.lr.ph77:                                         ; preds = %.preheader65
  br i1 %9, label %.lr.ph77..lr.ph77.split.us_crit_edge, label %._crit_edge78.loopexit89

.lr.ph77..lr.ph77.split.us_crit_edge:             ; preds = %.lr.ph77
...
.lr.ph77.split.us:                                ; preds = %.loopexit.us, %.lr.ph77..lr.ph77.split.us_crit_edge
  %indvars.iv110 = phi i64 [ %indvars.iv108, %.lr.ph77..lr.ph77.split.us_crit_edge ], [ %indvars.iv.next111, %.loopexit.us ]
...
.prol.loopexit125:                                ; preds = %.lr.ph77.split.us, %.prol.preheader124
...
.lr.ph76.us:                                      ; preds = %.preheader.us
  ...
  br i1 %lcmp.mod133, label %.prol.loopexit131, label %.prol.preheader130
...
.prol.loopexit131:                                ; preds = %.lr.ph76.us, %.prol.preheader130
...
._crit_edge:                                      ; preds = %._crit_edge56, %18
  ...
  br i1 %exitcond54, label %._crit_edge35.us, label %._crit_edge56
...
._crit_edge58:                                    ; preds = %._crit_edge57, %.preheader.us
  ...
  %36 = srem i32 %35, 20
  %37 = icmp eq i32 %36, 0
  br i1 %37, label %38, label %._crit_edge57

; <label>:38:                                     ; preds = %._crit_edge58
  %39 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %fputc.us = tail call i32 @fputc(i32 10, %struct._IO_FILE* %39) #6
  br label %._crit_edge57

._crit_edge57:                                    ; preds = %._crit_edge58, %38
  %40 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %41 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv40, i64 %indvars.iv
  ...
  br i1 %exitcond53, label %._crit_edge.us, label %._crit_edge58
