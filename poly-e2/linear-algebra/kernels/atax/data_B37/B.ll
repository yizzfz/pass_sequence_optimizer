...
for.body10.us:                                    ; preds = %for.body10.us, %for.cond7.preheader.us
  ...
  %exitcond19.1 = icmp eq i64 %indvars.iv.next, 2099
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %exitcond.2 = icmp eq i64 %indvars.iv.next21.1, 2099
...
for.body5.us:                                     ; preds = %for.inc42.us, %for.body5.us.preheader
  ...
  %scevgep93 = getelementptr [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 1
  %29 = add i64 %indvars.iv65, 1
  %scevgep95 = getelementptr [2100 x double], [2100 x double]* %A, i64 %29, i64 0
...
for.body26.us.for.body26.us_crit_edge:            ; preds = %for.body26.us.for.body26.us_crit_edge, %for.body26.us.for.body26.us_crit_edge.preheader.new
  %indvars.iv6383 = phi i64 [ %indvars.iv6383.ph, %for.body26.us.for.body26.us_crit_edge.preheader.new ], [ %indvars.iv.next64.1, %for.body26.us.for.body26.us_crit_edge ]
  %indvars.iv.next64 = add nuw nsw i64 %indvars.iv6383, 1
  ...
  %indvars.iv.next64.1 = add nsw i64 %indvars.iv6383, 2
...
for.body26.us.preheader:                          ; preds = %for.body10.us
  ...
  %42 = load double, double* %arrayidx32.us80, align 8
  %mul35.us81 = fmul double %42, %add.us.2
  %add36.us82 = fadd double %41, %mul35.us81
  store double %add36.us82, double* %y, align 8
  %bound0 = icmp ult double* %scevgep, %arrayidx12.us
  %bound1 = icmp ult double* %arrayidx12.us, %scevgep91
  ...
  br i1 %conflict.rdx, label %for.body26.us.for.body26.us_crit_edge.preheader.new, label %vector.body85.preheader

vector.body85.preheader:                          ; preds = %for.body26.us.preheader
  br label %vector.body85

for.body26.us.for.body26.us_crit_edge.preheader.new.loopexit: ; preds = %vector.body85
...
for.body26.us.for.body26.us_crit_edge.preheader.new: ; preds = %for.body26.us.for.body26.us_crit_edge.preheader.new.loopexit, %for.body26.us.preheader
  %indvars.iv6383.ph = phi i64 [ 1, %for.body26.us.preheader ], [ 2097, %for.body26.us.for.body26.us_crit_edge.preheader.new.loopexit ]
  %.pre71.prol = load double, double* %arrayidx12.us, align 8
  %arrayidx28.us.prol = getelementptr inbounds double, double* %y, i64 %indvars.iv6383.ph
  %43 = load double, double* %arrayidx28.us.prol, align 8
  %arrayidx32.us.prol = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 %indvars.iv6383.ph
...
vector.body85:                                    ; preds = %vector.body85.preheader, %vector.body85
  %index102 = phi i64 [ %index.next103, %vector.body85 ], [ 0, %vector.body85.preheader ]
  %45 = or i64 %index102, 1
  ...
  %wide.load110 = load <2 x double>, <2 x double>* %52, align 8, !alias.scope !8, !noalias !10
  %53 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv65, i64 %45
  %54 = bitcast double* %53 to <2 x double>*
  %wide.load111 = load <2 x double>, <2 x double>* %54, align 8, !alias.scope !12
  %55 = getelementptr double, double* %53, i64 2
  %56 = bitcast double* %55 to <2 x double>*
  %wide.load112 = load <2 x double>, <2 x double>* %56, align 8, !alias.scope !12
  %57 = fmul <2 x double> %wide.load111, %48
  %58 = fmul <2 x double> %wide.load112, %48
  %59 = fadd <2 x double> %wide.load, %57
  %60 = fadd <2 x double> %wide.load110, %58
  ...
  %61 = icmp eq i64 %index.next103, 2096
  br i1 %61, label %for.body26.us.for.body26.us_crit_edge.preheader.new.loopexit, label %vector.body85, !llvm.loop !13
