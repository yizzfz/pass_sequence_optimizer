...
for.body.us:                                      ; preds = %for.cond2.for.inc24_crit_edge.us, %for.body.us.preheader
  %indvars.iv14 = phi i64 [ %6, %for.body.us.preheader ], [ %indvars.iv.next15, %for.cond2.for.inc24_crit_edge.us ]
...
for.end:                                          ; preds = %entry, %for.cond.for.end_crit_edge
  ...
  %call5 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %14, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #6
