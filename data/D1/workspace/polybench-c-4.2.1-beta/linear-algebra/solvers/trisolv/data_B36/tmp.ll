...
.lr.ph33:                                         ; preds = %.lr.ph33.preheader, %._crit_edge
  %indvars.iv2630 = phi i64 [ %indvars.iv.next27, %._crit_edge ], [ 0, %.lr.ph33.preheader ]
  %6 = getelementptr inbounds double, double* %3, i64 %indvars.iv2630
  %7 = bitcast double* %6 to i64*
  %8 = load i64, i64* %7, align 8
  %9 = getelementptr inbounds double, double* %2, i64 %indvars.iv2630
  %10 = bitcast double* %9 to i64*
  store i64 %8, i64* %10, align 8
  %exitcond28 = icmp eq i64 %indvars.iv2630, 0
  %11 = bitcast i64 %8 to double
  br i1 %exitcond28, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph33
  %xtraiter = and i64 %indvars.iv2630, 1
  %lcmp.mod = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.lr.ph
  %12 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv2630, i64 0
  %13 = load double, double* %12, align 8
  %14 = load double, double* %2, align 8
  %15 = fmul double %13, %14
  %16 = fsub double %11, %15
  %sunkaddr36 = shl nuw nsw i64 %indvars.iv2630, 3
  %sunkaddr37 = add i64 %5, %sunkaddr36
  %sunkaddr38 = inttoptr i64 %sunkaddr37 to double*
  store double %16, double* %sunkaddr38, align 8
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph
  %.lcssa.unr.ph = phi double [ %16, %.prol.preheader ], [ undef, %.lr.ph ]
  %.unr.ph = phi double [ %16, %.prol.preheader ], [ %11, %.lr.ph ]
  %indvars.iv29.unr.ph = phi i64 [ 1, %.prol.preheader ], [ 0, %.lr.ph ]
  %17 = icmp eq i64 %indvars.iv2630, 1
  br i1 %17, label %._crit_edge, label %.lr.ph.new.preheader

.lr.ph.new.preheader:                             ; preds = %.prol.loopexit
  %sunkaddr47 = shl i64 %indvars.iv2630, 3
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %19 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv2630, i64 %indvars.iv29
  %20 = load double, double* %19, align 8
  %21 = getelementptr inbounds double, double* %2, i64 %indvars.iv29
  %22 = load double, double* %21, align 8
  %23 = fmul double %20, %22
  %24 = fsub double %18, %23
  store double %24, double* %sunkaddr49, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv29, 1
  %25 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv2630, i64 %indvars.iv.next
  %26 = load double, double* %25, align 8
  %27 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next
  %28 = load double, double* %27, align 8
  %29 = fmul double %26, %28
  %30 = fsub double %24, %29
  store double %30, double* %sunkaddr49, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv29, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, %indvars.iv2630
  br i1 %exitcond.1, label %._crit_edge.loopexit, label %.lr.ph.new

._crit_edge.loopexit:                             ; preds = %.lr.ph.new
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %.lr.ph33
  %31 = phi double [ %11, %.lr.ph33 ], [ %.lcssa.unr.ph, %.prol.loopexit ], [ %30, %._crit_edge.loopexit ]
  %32 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv2630, i64 %indvars.iv2630
  %33 = load double, double* %32, align 8
  %34 = fdiv double %31, %33
  %sunkaddr44 = shl nuw nsw i64 %indvars.iv2630, 3
  %sunkaddr45 = add i64 %4, %sunkaddr44
  %sunkaddr46 = inttoptr i64 %sunkaddr45 to double*
  store double %34, double* %sunkaddr46, align 8
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv2630, 1
  %exitcond35 = icmp eq i64 %indvars.iv.next27, 2000
  br i1 %exitcond35, label %._crit_edge34, label %.lr.ph33
