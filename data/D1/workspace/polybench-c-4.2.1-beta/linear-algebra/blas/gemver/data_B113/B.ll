...
define internal fastcc void @kernel_gemver(double, double, [2000 x double]*, double* readonly, double* readonly, double* readonly, double* readonly, double*, double*, double* nocapture readonly, double* nocapture readonly) unnamed_addr #2 {
  %scevgep23 = getelementptr double, double* %4, i64 2000
  %scevgep25 = getelementptr double, double* %6, i64 2000
  br label %.preheader5
...
.preheader5:                                      ; preds = %middle.block, %11
  ...
  %scevgep21 = getelementptr [2000 x double], [2000 x double]* %2, i64 %12, i64 0
  ...
  %bound1 = icmp ult double* %13, %scevgep21
  %found.conflict = and i1 %bound0, %bound1
  %bound028 = icmp ult double* %scevgep, %scevgep23
  %bound129 = icmp ugt double* %scevgep21, %4
  %found.conflict30 = and i1 %bound028, %bound129
  %conflict.rdx = or i1 %found.conflict, %found.conflict30
  %bound033 = icmp ult double* %scevgep, %14
  %bound134 = icmp ult double* %14, %scevgep21
  %found.conflict35 = and i1 %bound033, %bound134
  %conflict.rdx36 = or i1 %conflict.rdx, %found.conflict35
  %bound037 = icmp ult double* %scevgep, %scevgep25
  %bound138 = icmp ugt double* %scevgep21, %6
  %found.conflict39 = and i1 %bound037, %bound138
  %conflict.rdx40 = or i1 %conflict.rdx36, %found.conflict39
  br i1 %conflict.rdx40, label %._crit_edge.preheader, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %wide.vec42 = load <4 x double>, <4 x double>* %21, align 8, !alias.scope !10
  ...
  %22 = fmul <2 x double> %19, %strided.vec43
  ...
  %wide.vec45 = load <4 x double>, <4 x double>* %28, align 8, !alias.scope !12
  ...
  %29 = fmul <2 x double> %26, %strided.vec46
  ...
  %33 = fmul <2 x double> %19, %strided.vec44
  %34 = fadd <2 x double> %strided.vec41, %33
  %35 = fmul <2 x double> %26, %strided.vec47
  ...
  br i1 %39, label %middle.block.loopexit63, label %vector.body, !llvm.loop !13
...
middle.block.loopexit63:                          ; preds = %vector.body
  br label %middle.block

middle.block:                                     ; preds = %middle.block.loopexit63, %middle.block.loopexit
...
.preheader3:                                      ; preds = %79, %.preheader3.preheader
  %indvars.iv10 = phi i64 [ 0, %.preheader3.preheader ], [ %indvars.iv.next11, %79 ]
  br label %._crit_edge6

._crit_edge6:                                     ; preds = %._crit_edge6, %.preheader3
  %indvars.iv7 = phi i64 [ 0, %.preheader3 ], [ %indvars.iv.next8.1, %._crit_edge6 ]
  %sunkaddr = ptrtoint double* %8 to i64
  %sunkaddr56 = mul i64 %indvars.iv10, 8
  %sunkaddr57 = add i64 %sunkaddr, %sunkaddr56
  %sunkaddr58 = inttoptr i64 %sunkaddr57 to double*
  %64 = load double, double* %sunkaddr58, align 8
  ...
  store double %71, double* %sunkaddr58, align 8
...
._crit_edge8:                                     ; preds = %._crit_edge8, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %._crit_edge8 ]
  %sunkaddr59 = ptrtoint double* %7 to i64
  %sunkaddr60 = mul i64 %indvars.iv1, 8
  %sunkaddr61 = add i64 %sunkaddr59, %sunkaddr60
  %sunkaddr62 = inttoptr i64 %sunkaddr61 to double*
  %105 = load double, double* %sunkaddr62, align 8
  ...
  store double %112, double* %sunkaddr62, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %119, double* %sunkaddr62, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %120, label %._crit_edge8

; <label>:120:                                    ; preds = %._crit_edge8
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 2000
