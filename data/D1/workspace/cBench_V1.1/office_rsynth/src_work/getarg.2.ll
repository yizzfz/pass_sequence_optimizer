...
@__llvm_prf_nm = private constant [9 x i8] c"\07\00getargs", section "__llvm_prf_names"
@llvm.used = appending global [2 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_getargs to i8*), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
...
; <label>:175:                                    ; preds = %._crit_edge1, %._crit_edge, %159
