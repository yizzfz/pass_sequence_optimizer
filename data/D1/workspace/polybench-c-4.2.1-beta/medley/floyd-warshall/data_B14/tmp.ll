...
.preheader:                                       ; preds = %19, %2
  %indvars.iv59 = phi i64 [ 0, %2 ], [ %indvars.iv.next6, %19 ]
  br label %3

; <label>:3:                                      ; preds = %3, %.preheader
  %indvars.iv8 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %3 ]
  %4 = mul nuw nsw i64 %indvars.iv8, %indvars.iv59
  %5 = trunc i64 %4 to i32
  %6 = srem i32 %5, 7
  %7 = add nsw i32 %6, 1
  %8 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv59, i64 %indvars.iv8
  %9 = add nuw nsw i64 %indvars.iv8, %indvars.iv59
...
.preheader:                                       ; preds = %19, %.preheader3
  %indvars.iv411 = phi i64 [ 0, %.preheader3 ], [ %indvars.iv.next5, %19 ]
  %3 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv411, i64 %indvars.iv712
  br label %4

; <label>:4:                                      ; preds = %4, %.preheader
  %indvars.iv10 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %4 ]
  %5 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv411, i64 %indvars.iv10
  ...
  %12 = getelementptr inbounds [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv411, i64 %indvars.iv.next
...
; <label>:20:                                     ; preds = %19
  ...
  br i1 %exitcond9, label %21, label %.preheader3
