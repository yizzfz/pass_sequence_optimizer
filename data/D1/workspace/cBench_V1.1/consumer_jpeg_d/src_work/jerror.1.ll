...
define %struct.jpeg_error_mgr* @jpeg_std_error(%struct.jpeg_error_mgr* returned) #0 {
...
define internal void @output_message(%struct.jpeg_common_struct*) #2 {
  ...
  call void %6(%struct.jpeg_common_struct* %0, i8* nonnull %7) #7
  %8 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %9 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %8, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.120, i64 0, i64 0), i8* nonnull %7) #9
  ret void
}
...
; <label>:47:                                     ; preds = %44
  %48 = getelementptr inbounds %struct.jpeg_error_mgr, %struct.jpeg_error_mgr* %4, i64 0, i32 6
  %49 = tail call i32 (i8*, i8*, ...) @sprintf(i8* %1, i8* %.2, %union.anon* %48) #7
  br label %67
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %44
  %50 = getelementptr inbounds %struct.jpeg_error_mgr, %struct.jpeg_error_mgr* %4, i64 0, i32 6, i32 0, i64 0
  %51 = load i32, i32* %50, align 4
  %52 = getelementptr inbounds %struct.jpeg_error_mgr, %struct.jpeg_error_mgr* %4, i64 0, i32 6, i32 0, i64 1
  %53 = load i32, i32* %52, align 4
  %54 = getelementptr inbounds %struct.jpeg_error_mgr, %struct.jpeg_error_mgr* %4, i64 0, i32 6, i32 0, i64 2
  %55 = load i32, i32* %54, align 4
  %56 = getelementptr inbounds %struct.jpeg_error_mgr, %struct.jpeg_error_mgr* %4, i64 0, i32 6, i32 0, i64 3
  %57 = load i32, i32* %56, align 4
  %58 = getelementptr inbounds %struct.jpeg_error_mgr, %struct.jpeg_error_mgr* %4, i64 0, i32 6, i32 0, i64 4
  %59 = load i32, i32* %58, align 4
  %60 = getelementptr inbounds %struct.jpeg_error_mgr, %struct.jpeg_error_mgr* %4, i64 0, i32 6, i32 0, i64 5
  %61 = load i32, i32* %60, align 4
  %62 = getelementptr inbounds %struct.jpeg_error_mgr, %struct.jpeg_error_mgr* %4, i64 0, i32 6, i32 0, i64 6
  %63 = load i32, i32* %62, align 4
  %64 = getelementptr inbounds %struct.jpeg_error_mgr, %struct.jpeg_error_mgr* %4, i64 0, i32 6, i32 0, i64 7
  %65 = load i32, i32* %64, align 4
  %66 = tail call i32 (i8*, i8*, ...) @sprintf(i8* %1, i8* %.2, i32 %51, i32 %53, i32 %55, i32 %57, i32 %59, i32 %61, i32 %63, i32 %65) #7
  br label %67

; <label>:67:                                     ; preds = %.loopexit, %47
  ret void
}
