...
@__llvm_prf_nm = private constant [104 x i8] c"f\00calc_sfb_ave_noise\01find_scalefac\01compute_scalefacs_short\01compute_scalefacs_long\01VBR_iteration_loop_new", section "__llvm_prf_names"
@llvm.used = appending global [6 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_calc_sfb_ave_noise to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_find_scalefac to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_compute_scalefacs_short to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_compute_scalefacs_long to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_VBR_iteration_loop_new to i8*), i8* getelementptr inbounds ([104 x i8], [104 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
...
; <label>:233:                                    ; preds = %223, %._crit_edge
  br label %234
