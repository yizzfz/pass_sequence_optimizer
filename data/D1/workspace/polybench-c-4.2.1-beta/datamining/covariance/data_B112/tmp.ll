...
.lr.ph26.split.us:                                ; preds = %._crit_edge22.us, %.lr.ph26.split.us.preheader
  %indvars.iv71 = phi i64 [ 0, %.lr.ph26.split.us.preheader ], [ %indvars.iv.next72, %._crit_edge22.us ]
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv71
  store double 0.000000e+00, double* %5, align 8
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph26.split.us
  %indvars.iv67 = phi i64 [ 0, %.lr.ph26.split.us ], [ %indvars.iv.next68.4, %._crit_edge ]
  %6 = phi double [ 0.000000e+00, %.lr.ph26.split.us ], [ %21, %._crit_edge ]
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv67, i64 %indvars.iv71
  %8 = load double, double* %7, align 8
  %9 = fadd double %8, %6
  %sunkaddr = ptrtoint double* %3 to i64
  %sunkaddr43 = mul nuw nsw i64 %indvars.iv71, 8
  %sunkaddr44 = add i64 %sunkaddr, %sunkaddr43
  %sunkaddr45 = inttoptr i64 %sunkaddr44 to double*
  store double %9, double* %sunkaddr45, align 8
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  %10 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next68, i64 %indvars.iv71
  %11 = load double, double* %10, align 8
  %12 = fadd double %11, %9
  store double %12, double* %sunkaddr45, align 8
  %indvars.iv.next68.1 = add nuw nsw i64 %indvars.iv67, 2
  %13 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next68.1, i64 %indvars.iv71
  %14 = load double, double* %13, align 8
  %15 = fadd double %14, %12
  store double %15, double* %sunkaddr45, align 8
  %indvars.iv.next68.2 = add nuw nsw i64 %indvars.iv67, 3
  %16 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next68.2, i64 %indvars.iv71
  %17 = load double, double* %16, align 8
  %18 = fadd double %17, %15
  store double %18, double* %sunkaddr45, align 8
  %indvars.iv.next68.3 = add nuw nsw i64 %indvars.iv67, 4
  %19 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next68.3, i64 %indvars.iv71
  %20 = load double, double* %19, align 8
  %21 = fadd double %20, %18
  store double %21, double* %sunkaddr45, align 8
  %indvars.iv.next68.4 = add nuw nsw i64 %indvars.iv67, 5
  %exitcond85.4 = icmp eq i64 %indvars.iv.next68.4, 1400
  br i1 %exitcond85.4, label %._crit_edge22.us, label %._crit_edge

._crit_edge22.us:                                 ; preds = %._crit_edge
  %22 = fdiv double %21, %0
  %sunkaddr38 = shl i64 %indvars.iv71, 3
  %sunkaddr39 = add i64 %4, %sunkaddr38
  %sunkaddr40 = inttoptr i64 %sunkaddr39 to double*
  store double %22, double* %sunkaddr40, align 8
  %indvars.iv.next72 = add nuw nsw i64 %indvars.iv71, 1
  %exitcond86 = icmp eq i64 %indvars.iv.next72, 1200
  br i1 %exitcond86, label %._crit_edge22.us..preheader6.us_crit_edge, label %.lr.ph26.split.us

._crit_edge22.us..preheader6.us_crit_edge:        ; preds = %._crit_edge22.us
  %scevgep24 = getelementptr double, double* %3, i64 1200
  br label %vector.memcheck

vector.memcheck:                                  ; preds = %._crit_edge17.us, %._crit_edge22.us..preheader6.us_crit_edge
  %indvars.iv62 = phi i64 [ 0, %._crit_edge22.us..preheader6.us_crit_edge ], [ %23, %._crit_edge17.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv62, i64 0
  %23 = add nuw nsw i64 %indvars.iv62, 1
  %scevgep22 = getelementptr [1200 x double], [1200 x double]* %1, i64 %23, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv62, i64 %offset.idx
  %27 = bitcast double* %26 to <8 x double>*
  %wide.vec29 = load <8 x double>, <8 x double>* %27, align 8, !alias.scope !4, !noalias !1
  %28 = fsub <8 x double> %wide.vec29, %wide.vec
  ...
  %33 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv62, i64 %32
  ...
  br i1 %39, label %._crit_edge17.us.loopexit46, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader
  %indvars.iv58 = phi i64 [ 0, %scalar.ph.preheader ], [ %indvars.iv.next59.3, %scalar.ph ]
  %40 = getelementptr inbounds double, double* %3, i64 %indvars.iv58
  %41 = load double, double* %40, align 8
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv62, i64 %indvars.iv58
  %43 = load double, double* %42, align 8
  %44 = fsub double %43, %41
  store double %44, double* %42, align 8
  %indvars.iv.next59 = or i64 %indvars.iv58, 1
  %45 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next59
  %46 = load double, double* %45, align 8
  %47 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv62, i64 %indvars.iv.next59
  %48 = load double, double* %47, align 8
  %49 = fsub double %48, %46
  store double %49, double* %47, align 8
  %indvars.iv.next59.1 = or i64 %indvars.iv58, 2
  %50 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next59.1
  %51 = load double, double* %50, align 8
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv62, i64 %indvars.iv.next59.1
  %53 = load double, double* %52, align 8
  %54 = fsub double %53, %51
  store double %54, double* %52, align 8
  %indvars.iv.next59.2 = or i64 %indvars.iv58, 3
  %55 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next59.2
  %56 = load double, double* %55, align 8
  %57 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv62, i64 %indvars.iv.next59.2
  %58 = load double, double* %57, align 8
  %59 = fsub double %58, %56
  store double %59, double* %57, align 8
  %indvars.iv.next59.3 = add nuw nsw i64 %indvars.iv58, 4
  %exitcond83.3 = icmp eq i64 %indvars.iv.next59.3, 1200
  br i1 %exitcond83.3, label %._crit_edge17.us.loopexit, label %scalar.ph, !llvm.loop !9

._crit_edge17.us.loopexit:                        ; preds = %scalar.ph
  br label %._crit_edge17.us

._crit_edge17.us.loopexit46:                      ; preds = %vector.body
  br label %._crit_edge17.us

._crit_edge17.us:                                 ; preds = %._crit_edge17.us.loopexit46, %._crit_edge17.us.loopexit
  %exitcond84 = icmp eq i64 %23, 1400
  br i1 %exitcond84, label %.preheader.us.preheader, label %vector.memcheck

.preheader.us.preheader:                          ; preds = %._crit_edge17.us
  %60 = fadd double %0, -1.000000e+00
  br label %.lr.ph11.us

.lr.ph11.us:                                      ; preds = %._crit_edge12.us-lcssa.us.us, %.preheader.us.preheader
  %indvars.iv44 = phi i64 [ 0, %.preheader.us.preheader ], [ %indvars.iv.next45, %._crit_edge12.us-lcssa.us.us ]
  br label %.lr.ph.us.us

._crit_edge12.us-lcssa.us.us:                     ; preds = %._crit_edge.us.us
  %indvars.iv.next45 = add nuw nsw i64 %indvars.iv44, 1
  %exitcond47 = icmp eq i64 %indvars.iv.next45, 1200
  br i1 %exitcond47, label %._crit_edge14, label %.lr.ph11.us

.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph11.us
  %indvars.iv40 = phi i64 [ %indvars.iv44, %.lr.ph11.us ], [ %indvars.iv.next41, %._crit_edge.us.us ]
  %61 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv44, i64 %indvars.iv40
  store double 0.000000e+00, double* %61, align 8
  br label %._crit_edge35

._crit_edge.us.us:                                ; preds = %._crit_edge35
  %62 = fdiv double %76, %60
  store double %62, double* %61, align 8
  %63 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv40, i64 %indvars.iv44
  store double %62, double* %63, align 8
  %indvars.iv.next41 = add nuw nsw i64 %indvars.iv40, 1
  %exitcond = icmp eq i64 %indvars.iv.next41, 1200
  br i1 %exitcond, label %._crit_edge12.us-lcssa.us.us, label %.lr.ph.us.us

._crit_edge35:                                    ; preds = %._crit_edge35, %.lr.ph.us.us
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %._crit_edge35 ]
  %64 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %76, %._crit_edge35 ]
  %65 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv44
  %66 = load double, double* %65, align 8
  %67 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv40
  %68 = load double, double* %67, align 8
  %69 = fmul double %66, %68
  %70 = fadd double %64, %69
  store double %70, double* %61, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv44
  %72 = load double, double* %71, align 8
  %73 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv40
  %74 = load double, double* %73, align 8
  %75 = fmul double %72, %74
  %76 = fadd double %70, %75
  store double %76, double* %61, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond81.1 = icmp eq i64 %indvars.iv.next.1, 1400
  br i1 %exitcond81.1, label %._crit_edge.us.us, label %._crit_edge35

._crit_edge14:                                    ; preds = %._crit_edge12.us-lcssa.us.us
  ret void
}
...
._crit_edge:                                      ; preds = %._crit_edge3, %10
  ...
  br i1 %exitcond9, label %._crit_edge.us, label %._crit_edge3
