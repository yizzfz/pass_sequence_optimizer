...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader.new
  ...
  br i1 %43, label %middle.block.loopexit, label %vector.body, !llvm.loop !3
...
vector.body6:                                     ; preds = %vector.body6, %vector.body6.preheader
  ...
  br i1 %94, label %._crit_edge.us.loopexit36, label %vector.body6, !llvm.loop !13
...
._crit_edge.us.loopexit36:                        ; preds = %vector.body6
  br label %._crit_edge.us
...
.lr.ph:                                           ; preds = %.lr.ph3
  ...
  br i1 %lcmp.mod, label %13, label %.prol.loopexit
...
; <label>:21:                                     ; preds = %21, %.lr.ph.new
  ...
  br i1 %exitcond.1, label %._crit_edge.loopexit.loopexit, label %21

._crit_edge.loopexit.loopexit:                    ; preds = %21
...
.lr.ph14.split.us:                                ; preds = %._crit_edge10.us, %.lr.ph14.split.us.preheader
  ...
  br i1 %lcmp.mod9, label %46, label %.prol.loopexit7

; <label>:46:                                     ; preds = %.lr.ph14.split.us
...
.prol.loopexit7:                                  ; preds = %46, %.lr.ph14.split.us
...
; <label>:52:                                     ; preds = %52, %.lr.ph14.split.us.new
  ...
  br i1 %exitcond54.1, label %._crit_edge10.us.loopexit, label %52

._crit_edge10.us.loopexit:                        ; preds = %52
  br label %._crit_edge10.us

._crit_edge10.us:                                 ; preds = %._crit_edge10.us.loopexit, %.prol.loopexit7
