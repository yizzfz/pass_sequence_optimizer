...
entry:
  ...
  call fastcc void @init_array([2000 x double]* %arraydecay, double* %arraydecay3, double* %arraydecay4)
  call void (...) @polybench_timer_start() #3
  call fastcc void @kernel_trisolv([2000 x double]* %arraydecay, double* %arraydecay3, double* %arraydecay4)
...
for.body6.prol.loopexit:                          ; preds = %for.body6.prol.loopexit.unr-lcssa
  %3 = icmp eq i64 %indvars.iv6, 0
  br i1 %3, label %for.end, label %for.body6.lr.ph.new
...
for.body6:                                        ; preds = %for.body6, %for.body6.lr.ph.new
  ...
  %6 = bitcast double* %arrayidx13 to <2 x double>*
...
for.end:                                          ; preds = %for.body6.prol.loopexit, %for.end.unr-lcssa
  ...
  br i1 %exitcond, label %for.end16, label %for.body6.lr.ph
...
for.end:                                          ; preds = %for.end.loopexit, %for.body
  %.lcssa = phi double [ %2, %for.body ], [ %sub.lcssa, %for.end.loopexit ]
...
for.body:                                         ; preds = %if.end, %for.body.preheader
  ...
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i64 0, i64 0), double %5) #3
