...
._crit_edge._crit_edge:                           ; preds = %._crit_edge, %.lr.ph9
  %indvars.iv19 = phi i64 [ 0, %.lr.ph9 ], [ %indvars.iv.next20, %._crit_edge ]
  %4 = add nuw i64 %indvars.iv19, 4294967295
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv19
  %6 = load double, double* %5, align 8
  %7 = getelementptr inbounds double, double* %2, i64 %indvars.iv19
  store double %6, double* %7, align 8
  %8 = icmp sgt i64 %indvars.iv19, 0
  %sunkaddr1 = shl nsw i64 %indvars.iv19, 3
  %sunkaddr2 = add i64 %sunkaddr4, %sunkaddr1
  %sunkaddr3 = inttoptr i64 %sunkaddr2 to double*
  br i1 %8, label %.lr.ph, label %._crit_edge

.lr.ph:                                           ; preds = %._crit_edge._crit_edge
  %xtraiter22 = and i64 %indvars.iv19, 1
  %lcmp.mod = icmp eq i64 %xtraiter22, 0
  br i1 %lcmp.mod, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.lr.ph
  %9 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv19, i64 0
...
.prol.loopexit:                                   ; preds = %.lr.ph, %.prol.preheader
  ...
  %.lcssa14.unr.ph = phi double [ %13, %.prol.preheader ], [ undef, %.lr.ph ]
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %23 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv19, i64 %indvars.iv.next
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %._crit_edge._crit_edge
  %.lcssa = phi double [ %6, %._crit_edge._crit_edge ], [ %.lcssa14.unr.ph, %.prol.loopexit ], [ %28, %._crit_edge.loopexit ]
  %29 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv19, i64 %indvars.iv19
  %30 = load double, double* %29, align 8
  %31 = fdiv double %.lcssa, %30
  store double %31, double* %sunkaddr3, align 8
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  %exitcond24 = icmp eq i64 %indvars.iv.next20, 2000
  br i1 %exitcond24, label %._crit_edge10, label %._crit_edge._crit_edge
