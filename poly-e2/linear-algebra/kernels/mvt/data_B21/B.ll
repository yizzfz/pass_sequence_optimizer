...
for.body.us:                                      ; preds = %for.cond22.for.cond.loopexit_crit_edge.us, %entry
  %indvars.iv4 = phi i64 [ 0, %entry ], [ %indvars.iv.next5, %for.cond22.for.cond.loopexit_crit_edge.us ]
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.end_crit_edge.us, %entry
  %indvars.iv14 = phi i64 [ 0, %entry ], [ %indvars.iv.next15, %for.cond1.for.end_crit_edge.us ]
...
for.body3.us:                                     ; preds = %for.cond1.preheader.us, %for.body3.us
  ...
  %indvars.iv8 = phi i64 [ %indvars.iv.next9.1, %for.body3.us ], [ 0, %for.cond1.preheader.us ]
  ...
  %sunkaddr8 = mul i64 %indvars.iv14, 8
  ...
  store double %add.us.1, double* %sunkaddr10, align 8
  %indvars.iv.next9.1 = add nsw i64 %indvars.iv8, 2
  %exitcond11.1 = icmp eq i64 %indvars.iv.next9.1, 2000
  br i1 %exitcond11.1, label %for.cond1.for.end_crit_edge.us, label %for.body3.us
...
for.cond18.preheader.us:                          ; preds = %for.cond18.preheader.us.preheader, %for.cond18.for.end35_crit_edge.us
  ...
  %.pre20 = load double, double* %arrayidx22.us, align 8
  br label %for.body20.us

for.body20.us:                                    ; preds = %for.cond18.preheader.us, %for.body20.us
  %5 = phi double [ %add30.us.1, %for.body20.us ], [ %.pre20, %for.cond18.preheader.us ]
  ...
  %sunkaddr11 = ptrtoint double* %x2 to i64
  %sunkaddr12 = mul i64 %indvars.iv5, 8
  %sunkaddr13 = add i64 %sunkaddr11, %sunkaddr12
  %sunkaddr14 = inttoptr i64 %sunkaddr13 to double*
  store double %add30.us, double* %sunkaddr14, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %add30.us.1, double* %sunkaddr14, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
...
for.cond18.for.end35_crit_edge.us:                ; preds = %for.body20.us
  ...
  %exitcond18 = icmp eq i64 %indvars.iv.next6, 2000
