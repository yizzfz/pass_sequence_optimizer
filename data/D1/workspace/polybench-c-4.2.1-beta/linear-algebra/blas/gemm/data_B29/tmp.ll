...
._crit_edge.preheader:                            ; preds = %41, %8
  %indvars.iv15 = phi i64 [ 0, %8 ], [ %indvars.iv.next16, %41 ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge.preheader
  %indvars.iv = phi i64 [ 0, %._crit_edge.preheader ], [ %indvars.iv.next.4, %._crit_edge ]
  %9 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv15, i64 %indvars.iv
  %10 = load double, double* %9, align 8
  %11 = fmul double %10, %4
  store double %11, double* %9, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %12 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv15, i64 %indvars.iv.next
  %13 = load double, double* %12, align 8
  %14 = fmul double %13, %4
  store double %14, double* %12, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %15 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv15, i64 %indvars.iv.next.1
  %16 = load double, double* %15, align 8
  %17 = fmul double %16, %4
  store double %17, double* %15, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %18 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv15, i64 %indvars.iv.next.2
  %19 = load double, double* %18, align 8
  %20 = fmul double %19, %4
  store double %20, double* %18, align 8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %21 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv15, i64 %indvars.iv.next.3
...
._crit_edge4.preheader:                           ; preds = %._crit_edge4.preheader.preheader, %._crit_edge3
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %._crit_edge3 ], [ 0, %._crit_edge4.preheader.preheader ]
  %24 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv15, i64 %indvars.iv12
  br label %._crit_edge4

._crit_edge4:                                     ; preds = %._crit_edge4, %._crit_edge4.preheader
  %indvars.iv9 = phi i64 [ 0, %._crit_edge4.preheader ], [ %indvars.iv.next10.1, %._crit_edge4 ]
  %25 = load double, double* %24, align 8
  %26 = fmul double %25, %3
  %27 = getelementptr inbounds [1100 x double], [1100 x double]* %7, i64 %indvars.iv12, i64 %indvars.iv9
  %28 = load double, double* %27, align 8
  %29 = fmul double %26, %28
  %30 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv15, i64 %indvars.iv9
  ...
  %34 = fmul double %33, %3
  %35 = getelementptr inbounds [1100 x double], [1100 x double]* %7, i64 %indvars.iv12, i64 %indvars.iv.next10
  %36 = load double, double* %35, align 8
  %37 = fmul double %34, %36
  %38 = getelementptr inbounds [1100 x double], [1100 x double]* %5, i64 %indvars.iv15, i64 %indvars.iv.next10
...
._crit_edge.preheader:                            ; preds = %19, %3
...
._crit_edge2:                                     ; preds = %._crit_edge2._crit_edge, %13
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1100
  br i1 %exitcond, label %19, label %._crit_edge2._crit_edge
