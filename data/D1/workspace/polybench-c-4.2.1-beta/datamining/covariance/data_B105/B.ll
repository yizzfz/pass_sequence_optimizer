...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph20.split.us
  %5 = phi double [ 0.000000e+00, %.lr.ph20.split.us ], [ %20, %._crit_edge ]
  %indvars.iv89 = phi i64 [ 0, %.lr.ph20.split.us ], [ %indvars.iv.next90.4, %._crit_edge ]
  %6 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv89, i64 %indvars.iv92
  %7 = load double, double* %6, align 8
  %8 = fadd double %5, %7
  store double %8, double* %sunkaddr128, align 8
  %indvars.iv.next90 = add nuw nsw i64 %indvars.iv89, 1
  %9 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next90, i64 %indvars.iv92
  %10 = load double, double* %9, align 8
  %11 = fadd double %8, %10
  store double %11, double* %sunkaddr128, align 8
  %indvars.iv.next90.1 = add nuw nsw i64 %indvars.iv89, 2
  %12 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next90.1, i64 %indvars.iv92
  %13 = load double, double* %12, align 8
  %14 = fadd double %11, %13
  store double %14, double* %sunkaddr128, align 8
  %indvars.iv.next90.2 = add nuw nsw i64 %indvars.iv89, 3
  %15 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next90.2, i64 %indvars.iv92
  %16 = load double, double* %15, align 8
  %17 = fadd double %14, %16
  store double %17, double* %sunkaddr128, align 8
  %indvars.iv.next90.3 = add nuw nsw i64 %indvars.iv89, 4
  %18 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next90.3, i64 %indvars.iv92
  %19 = load double, double* %18, align 8
  %20 = fadd double %17, %19
  store double %20, double* %sunkaddr128, align 8
  %indvars.iv.next90.4 = add nuw nsw i64 %indvars.iv89, 5
  %exitcond107.4 = icmp eq i64 %indvars.iv.next90.4, 1400
  br i1 %exitcond107.4, label %._crit_edge18.us, label %._crit_edge

._crit_edge18.us:                                 ; preds = %._crit_edge
  %21 = fdiv double %20, %0
  %sunkaddr27 = shl i64 %indvars.iv92, 3
  ...
  br i1 %exitcond108, label %._crit_edge18.us..preheader7.us_crit_edge, label %.lr.ph20.split.us

._crit_edge18.us..preheader7.us_crit_edge:        ; preds = %._crit_edge18.us
  %scevgep10 = getelementptr double, double* %3, i64 1200
  br label %vector.memcheck

vector.memcheck:                                  ; preds = %._crit_edge15.us, %._crit_edge18.us..preheader7.us_crit_edge
  %indvars.iv87 = phi i64 [ 0, %._crit_edge18.us..preheader7.us_crit_edge ], [ %22, %._crit_edge15.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %1, i64 %indvars.iv87, i64 0
  %22 = add nuw nsw i64 %indvars.iv87, 1
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %25 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv87, i64 %offset.idx
  ...
  %32 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv87, i64 %31
  ...
  br i1 %38, label %._crit_edge15.us.loopexit30, label %vector.body, !llvm.loop !6

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv85 = phi i64 [ %indvars.iv.next86.3, %scalar.ph ], [ 0, %scalar.ph.preheader ]
  %39 = getelementptr inbounds double, double* %3, i64 %indvars.iv85
  %40 = load double, double* %39, align 8
  %41 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv87, i64 %indvars.iv85
  %42 = load double, double* %41, align 8
  %43 = fsub double %42, %40
  store double %43, double* %41, align 8
  %indvars.iv.next86 = or i64 %indvars.iv85, 1
  %44 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next86
  %45 = load double, double* %44, align 8
  %46 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv87, i64 %indvars.iv.next86
  %47 = load double, double* %46, align 8
  %48 = fsub double %47, %45
  store double %48, double* %46, align 8
  %indvars.iv.next86.1 = or i64 %indvars.iv85, 2
  %49 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next86.1
  %50 = load double, double* %49, align 8
  %51 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv87, i64 %indvars.iv.next86.1
  %52 = load double, double* %51, align 8
  %53 = fsub double %52, %50
  store double %53, double* %51, align 8
  %indvars.iv.next86.2 = or i64 %indvars.iv85, 3
  %54 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next86.2
  %55 = load double, double* %54, align 8
  %56 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv87, i64 %indvars.iv.next86.2
  ...
  br i1 %exitcond104.3, label %._crit_edge15.us.loopexit, label %scalar.ph, !llvm.loop !9

._crit_edge15.us.loopexit:                        ; preds = %scalar.ph
  br label %._crit_edge15.us

._crit_edge15.us.loopexit30:                      ; preds = %vector.body
  br label %._crit_edge15.us

._crit_edge15.us:                                 ; preds = %._crit_edge15.us.loopexit30, %._crit_edge15.us.loopexit
  %exitcond105 = icmp eq i64 %22, 1400
  br i1 %exitcond105, label %.lr.ph12.split.us.preheader, label %vector.memcheck

.lr.ph12.split.us.preheader:                      ; preds = %._crit_edge15.us
  %59 = fadd double %0, -1.000000e+00
  br label %.lr.ph10.us

.lr.ph10.us:                                      ; preds = %._crit_edge11.us-lcssa.us.us, %.lr.ph12.split.us.preheader
  %indvars.iv71 = phi i64 [ 0, %.lr.ph12.split.us.preheader ], [ %indvars.iv.next72, %._crit_edge11.us-lcssa.us.us ]
  br label %.lr.ph.us.us

._crit_edge11.us-lcssa.us.us:                     ; preds = %._crit_edge.us.us
  %indvars.iv.next72 = add nuw nsw i64 %indvars.iv71, 1
  %exitcond101 = icmp eq i64 %indvars.iv.next72, 1200
  br i1 %exitcond101, label %._crit_edge13, label %.lr.ph10.us
...
.lr.ph.us.us:                                     ; preds = %._crit_edge.us.us, %.lr.ph10.us
  ...
  %60 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv71, i64 %indvars.iv63
...
._crit_edge.us.us:                                ; preds = %._crit_edge24
  ...
  %62 = getelementptr inbounds [1200 x double], [1200 x double]* %2, i64 %indvars.iv63, i64 %indvars.iv71
...
._crit_edge24:                                    ; preds = %._crit_edge24, %.lr.ph.us.us
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv71
  %65 = load double, double* %64, align 8
  %66 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv, i64 %indvars.iv63
  %67 = load double, double* %66, align 8
  %68 = fmul double %65, %67
  %69 = fadd double %63, %68
  store double %69, double* %60, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %70 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv71
  %71 = load double, double* %70, align 8
  %72 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv63
  ...
  br i1 %exitcond.1, label %._crit_edge.us.us, label %._crit_edge24
...
._crit_edge.us:                                   ; preds = %._crit_edge
  ...
  br i1 %exitcond11, label %._crit_edge2, label %.preheader.us
