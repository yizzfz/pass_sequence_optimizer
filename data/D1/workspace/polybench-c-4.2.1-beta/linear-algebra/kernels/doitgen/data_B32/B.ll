...
.lr.ph39:                                         ; preds = %6
  ...
  %n.vec = and i64 %8, -4
  %xtraiter123 = and i64 %14, 3
  %xtraiter121 = and i64 %9, 7
  br label %15

; <label>:15:                                     ; preds = %._crit_edge21, %.lr.ph39
  %indvars.iv72 = phi i64 [ 0, %.lr.ph39 ], [ %indvars.iv.next73, %._crit_edge21 ]
  %16 = icmp sgt i32 %1, 0
  br i1 %16, label %.lr.ph20, label %._crit_edge21

.lr.ph20:                                         ; preds = %15
  %17 = icmp sgt i32 %2, 0
  br i1 %17, label %.lr.ph20.split.us.preheader, label %.lr.ph20.split.preheader

.lr.ph20.split.preheader:                         ; preds = %.lr.ph20
  %18 = icmp eq i64 %xtraiter121, 0
  br i1 %18, label %.lr.ph20.split.prol.loopexit, label %.lr.ph20.split.prol.preheader
...
.lr.ph20.split.prol:                              ; preds = %.lr.ph20.split.prol, %.lr.ph20.split.prol.preheader
  ...
  %prol.iter = phi i64 [ %prol.iter.sub, %.lr.ph20.split.prol ], [ %xtraiter121, %.lr.ph20.split.prol.preheader ]
  %indvars.iv.next57.prol = add nuw nsw i64 %indvars.iv56.prol, 1
  %prol.iter.sub = add i64 %prol.iter, -1
  %prol.iter.cmp = icmp eq i64 %prol.iter.sub, 0
  br i1 %prol.iter.cmp, label %.lr.ph20.split.prol.loopexit.loopexit, label %.lr.ph20.split.prol, !llvm.loop !1

.lr.ph20.split.prol.loopexit.loopexit:            ; preds = %.lr.ph20.split.prol
  br label %.lr.ph20.split.prol.loopexit

.lr.ph20.split.prol.loopexit:                     ; preds = %.lr.ph20.split.prol.loopexit.loopexit, %.lr.ph20.split.preheader
  %indvars.iv56.unr = phi i64 [ 0, %.lr.ph20.split.preheader ], [ %indvars.iv.next57.prol, %.lr.ph20.split.prol.loopexit.loopexit ]
  %19 = icmp ult i64 %11, 7
  br i1 %19, label %._crit_edge21, label %.lr.ph20.split.preheader.new
...
.lr.ph20.split.us:                                ; preds = %._crit_edge17.us, %.lr.ph20.split.us.preheader
  ...
  %20 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv72, i64 %indvars.iv70, i64 0
...
.lr.ph16.us:                                      ; preds = %.lr.ph16.us.preheader117, %.lr.ph16.us
  ...
  %21 = getelementptr inbounds double, double* %5, i64 %indvars.iv68
  %22 = bitcast double* %21 to i64*
  %23 = load i64, i64* %22, align 8
  %24 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv72, i64 %indvars.iv70, i64 %indvars.iv68
  %25 = bitcast double* %24 to i64*
  store i64 %23, i64* %25, align 8
  %indvars.iv.next69 = add nuw nsw i64 %indvars.iv68, 1
  %26 = icmp slt i64 %indvars.iv.next69, %8
  br i1 %26, label %.lr.ph16.us, label %._crit_edge17.us.loopexit, !llvm.loop !3
...
.lr.ph16.us.preheader:                            ; preds = %._crit_edge.us.us
  ...
  br i1 %27, label %.lr.ph16.us.preheader117, label %min.iters.checked
...
min.iters.checked:                                ; preds = %.lr.ph16.us.preheader
  %28 = icmp eq i64 %n.vec, 0
  br i1 %28, label %.lr.ph16.us.preheader117, label %vector.memcheck
...
vector.body.preheader:                            ; preds = %vector.memcheck
  %29 = icmp eq i64 %xtraiter123, 0
  br i1 %29, label %vector.body.prol.loopexit, label %vector.body.prol.preheader
...
vector.body.prol:                                 ; preds = %vector.body.prol, %vector.body.prol.preheader
  ...
  br i1 %prol.iter125.cmp, label %vector.body.prol.loopexit.loopexit, label %vector.body.prol, !llvm.loop !11
...
vector.body.prol.loopexit:                        ; preds = %vector.body.prol.loopexit.loopexit, %vector.body.preheader
  ...
  %38 = icmp ult i64 %12, 12
  br i1 %38, label %middle.block, label %vector.body.preheader.new
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader.new
  ...
  %wide.load84 = load <2 x i64>, <2 x i64>* %42, align 8, !alias.scope !6
  %43 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv72, i64 %indvars.iv70, i64 %index
  ...
  store <2 x i64> %wide.load84, <2 x i64>* %46, align 8, !alias.scope !9, !noalias !6
  ...
  %wide.load84.1 = load <2 x i64>, <2 x i64>* %50, align 8, !alias.scope !6
  %51 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv72, i64 %indvars.iv70, i64 %index.next
  ...
  store <2 x i64> %wide.load84.1, <2 x i64>* %54, align 8, !alias.scope !9, !noalias !6
  ...
  %wide.load84.2 = load <2 x i64>, <2 x i64>* %58, align 8, !alias.scope !6
  %59 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv72, i64 %indvars.iv70, i64 %index.next.1
  ...
  store <2 x i64> %wide.load84.2, <2 x i64>* %62, align 8, !alias.scope !9, !noalias !6
  ...
  %wide.load84.3 = load <2 x i64>, <2 x i64>* %66, align 8, !alias.scope !6
  %67 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv72, i64 %indvars.iv70, i64 %index.next.2
  ...
  store <2 x i64> %wide.load84.3, <2 x i64>* %70, align 8, !alias.scope !9, !noalias !6
  %index.next.3 = add i64 %index, 16
  %71 = icmp eq i64 %index.next.3, %n.vec
  br i1 %71, label %middle.block.loopexit, label %vector.body, !llvm.loop !12

middle.block.loopexit:                            ; preds = %vector.body
  br label %middle.block

middle.block:                                     ; preds = %middle.block.loopexit, %vector.body.prol.loopexit
  %72 = icmp eq i64 %8, %n.vec
  br i1 %72, label %._crit_edge17.us, label %.lr.ph16.us.preheader117
...
.lr.ph.us.us:                                     ; preds = %.lr.ph20.split.us, %._crit_edge.us.us
  ...
  %73 = icmp eq i32 %xtraiter, 0
  %74 = getelementptr inbounds double, double* %5, i64 %indvars.iv64
  store double 0.000000e+00, double* %74, align 8
  br i1 %73, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.lr.ph.us.us
  %75 = load double, double* %20, align 8
  %76 = getelementptr inbounds [160 x double], [160 x double]* %4, i64 0, i64 %indvars.iv64
  %77 = load double, double* %76, align 8
  %78 = fmul double %75, %77
  %79 = fadd double %78, 0.000000e+00
  %sunkaddr = ptrtoint double* %5 to i64
  %sunkaddr126 = mul i64 %indvars.iv64, 8
  %sunkaddr127 = add i64 %sunkaddr, %sunkaddr126
  %sunkaddr128 = inttoptr i64 %sunkaddr127 to double*
  store double %79, double* %sunkaddr128, align 8
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph.us.us
  %80 = phi double [ %79, %.prol.preheader ], [ 0.000000e+00, %.lr.ph.us.us ]
  %indvars.iv60.unr.ph = phi i64 [ 1, %.prol.preheader ], [ 0, %.lr.ph.us.us ]
  %81 = icmp eq i32 %2, 1
  br i1 %81, label %._crit_edge.us.us, label %.lr.ph.us.us.new.preheader
...
.lr.ph.us.us.new:                                 ; preds = %.lr.ph.us.us.new.preheader, %.lr.ph.us.us.new
  %82 = phi double [ %94, %.lr.ph.us.us.new ], [ %80, %.lr.ph.us.us.new.preheader ]
  %indvars.iv60 = phi i64 [ %indvars.iv.next61.1, %.lr.ph.us.us.new ], [ %indvars.iv60.unr.ph, %.lr.ph.us.us.new.preheader ]
  %83 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv72, i64 %indvars.iv70, i64 %indvars.iv60
  %84 = load double, double* %83, align 8
  %85 = getelementptr inbounds [160 x double], [160 x double]* %4, i64 %indvars.iv60, i64 %indvars.iv64
  %86 = load double, double* %85, align 8
  %87 = fmul double %84, %86
  %88 = fadd double %87, %82
  %sunkaddr129 = ptrtoint double* %5 to i64
  %sunkaddr130 = mul i64 %indvars.iv64, 8
  %sunkaddr131 = add i64 %sunkaddr129, %sunkaddr130
  %sunkaddr132 = inttoptr i64 %sunkaddr131 to double*
  store double %88, double* %sunkaddr132, align 8
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  %89 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %3, i64 %indvars.iv72, i64 %indvars.iv70, i64 %indvars.iv.next61
  %90 = load double, double* %89, align 8
  %91 = getelementptr inbounds [160 x double], [160 x double]* %4, i64 %indvars.iv.next61, i64 %indvars.iv64
  %92 = load double, double* %91, align 8
  %93 = fmul double %90, %92
  %94 = fadd double %93, %88
  store double %94, double* %sunkaddr132, align 8
...
.lr.ph20.split:                                   ; preds = %.lr.ph20.split, %.lr.ph20.split.preheader.new
  ...
  br i1 %exitcond.7, label %._crit_edge21.loopexit133, label %.lr.ph20.split

._crit_edge21.loopexit:                           ; preds = %._crit_edge17.us
  br label %._crit_edge21

._crit_edge21.loopexit133:                        ; preds = %.lr.ph20.split
  br label %._crit_edge21

._crit_edge21:                                    ; preds = %._crit_edge21.loopexit133, %._crit_edge21.loopexit, %.lr.ph20.split.prol.loopexit, %15
  %indvars.iv.next73 = add nuw nsw i64 %indvars.iv72, 1
  %exitcond120 = icmp eq i64 %indvars.iv.next73, %10
  br i1 %exitcond120, label %._crit_edge40.loopexit, label %15
