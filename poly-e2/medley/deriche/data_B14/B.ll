...
for.cond1.preheader.us.preheader:                 ; preds = %entry
  ...
  %wide.trip.count6 = zext i32 %w to i64
...
for.cond1.preheader.us:                           ; preds = %for.cond1.preheader.us.preheader, %for.cond1.for.inc7_crit_edge.us
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.cond1.for.inc7_crit_edge.us ], [ 0, %for.cond1.preheader.us.preheader ]
  %1 = mul nuw nsw i64 %indvars.iv3, 313
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %8 = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv3, i64 %index
...
for.body3.us:                                     ; preds = %for.body3.us.preheader, %for.body3.us
  ...
  %arrayidx6.us = getelementptr inbounds [2160 x float], [2160 x float]* %imgIn, i64 %indvars.iv3, i64 %indvars.iv
...
for.cond1.for.inc7_crit_edge.us:                  ; preds = %for.cond1.for.inc7_crit_edge.us.loopexit, %middle.block
  ...
  %exitcond7 = icmp eq i64 %indvars.iv.next4, %wide.trip.count6
  br i1 %exitcond7, label %for.end9.loopexit, label %for.cond1.preheader.us
