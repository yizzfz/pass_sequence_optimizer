...
; <label>:7:                                      ; preds = %._crit_edge, %.preheader13
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %._crit_edge ], [ 0, %.preheader13 ]
...
; <label>:15:                                     ; preds = %7
  ...
  br i1 %exitcond35, label %.preheader11.preheader, label %.preheader13

.preheader11.preheader:                           ; preds = %15
  br label %.preheader11

.preheader11:                                     ; preds = %.preheader11.preheader, %28
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %28 ], [ 0, %.preheader11.preheader ]
  br label %._crit_edge12

._crit_edge12:                                    ; preds = %._crit_edge12, %.preheader11
  %indvars.iv22 = phi i64 [ 0, %.preheader11 ], [ %indvars.iv.next23.1, %._crit_edge12 ]
  ...
  br i1 %exitcond24.1, label %28, label %._crit_edge12

; <label>:28:                                     ; preds = %._crit_edge12
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  %exitcond34 = icmp eq i64 %indvars.iv.next26, 1100
  br i1 %exitcond34, label %.preheader9.preheader, label %.preheader11

.preheader9.preheader:                            ; preds = %28
  br label %.preheader9

.preheader9:                                      ; preds = %.preheader9.preheader, %38
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %38 ], [ 0, %.preheader9.preheader ]
  br label %29

; <label>:29:                                     ; preds = %._crit_edge36, %.preheader9
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %._crit_edge36 ], [ 0, %.preheader9 ]
...
; <label>:38:                                     ; preds = %29
  ...
  br i1 %exitcond33, label %.preheader.preheader, label %.preheader9

.preheader.preheader:                             ; preds = %38
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %47
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %47 ], [ 0, %.preheader.preheader ]
  br label %39

; <label>:39:                                     ; preds = %._crit_edge37, %.preheader
  %indvars.iv = phi i64 [ %indvars.iv.next, %._crit_edge37 ], [ 0, %.preheader ]
...
; <label>:47:                                     ; preds = %39
  ...
  br i1 %exitcond32, label %48, label %.preheader
...
._crit_edge8:                                     ; preds = %18, %.preheader7
  %indvars.iv18 = phi i64 [ 0, %.preheader7 ], [ %indvars.iv.next19, %18 ]
  %8 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv20, i64 %indvars.iv18
  store double 0.000000e+00, double* %8, align 8
  br label %9

; <label>:9:                                      ; preds = %._crit_edge, %._crit_edge8
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %._crit_edge ], [ 0, %._crit_edge8 ]
  %10 = phi double [ %17, %._crit_edge ], [ 0.000000e+00, %._crit_edge8 ]
...
; <label>:18:                                     ; preds = %9
  ...
  br i1 %exitcond24, label %19, label %._crit_edge8

; <label>:19:                                     ; preds = %18
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  %exitcond25 = icmp eq i64 %indvars.iv.next21, 800
  br i1 %exitcond25, label %.preheader.preheader, label %.preheader7

.preheader.preheader:                             ; preds = %19
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %32
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %32 ], [ 0, %.preheader.preheader ]
  br label %._crit_edge10

._crit_edge10:                                    ; preds = %31, %.preheader
  %indvars.iv11 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next12, %31 ]
...
; <label>:23:                                     ; preds = %._crit_edge26, %._crit_edge10
  %indvars.iv = phi i64 [ %indvars.iv.next, %._crit_edge26 ], [ 0, %._crit_edge10 ]
  %24 = phi double [ %30, %._crit_edge26 ], [ %22, %._crit_edge10 ]
...
; <label>:31:                                     ; preds = %23
  ...
  br i1 %exitcond22, label %32, label %._crit_edge10

; <label>:32:                                     ; preds = %31
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond23 = icmp eq i64 %indvars.iv.next14, 800
  br i1 %exitcond23, label %33, label %.preheader
