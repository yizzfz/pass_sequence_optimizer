...
if.then:                                          ; preds = %land.lhs.true
  call void @print_array([1200 x double]* %arraydecay11)
  br label %if.end
...
for.cond1.preheader.us:                           ; preds = %entry, %for.cond1.for.inc7_crit_edge.us
  %indvars.iv88 = phi i64 [ %indvars.iv.next89, %for.cond1.for.inc7_crit_edge.us ], [ 0, %entry ]
  br label %for.inc.us

for.inc.us:                                       ; preds = %for.inc.us, %for.cond1.preheader.us
  %indvars.iv82 = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next83, %for.inc.us ]
  %0 = mul nuw nsw i64 %indvars.iv88, %indvars.iv82
  %1 = add nuw nsw i64 %0, 1
  %2 = trunc i64 %1 to i32
  %rem.us = srem i32 %2, 800
  %conv.us = sitofp i32 %rem.us to double
  %div.us = fdiv double %conv.us, 8.000000e+02
  %arrayidx6.us = getelementptr inbounds [1100 x double], [1100 x double]* %A, i64 %indvars.iv88, i64 %indvars.iv82
  store double %div.us, double* %arrayidx6.us, align 8
  %indvars.iv.next83 = add nuw nsw i64 %indvars.iv82, 1
  %exitcond104 = icmp eq i64 %indvars.iv.next83, 1100
  br i1 %exitcond104, label %for.cond1.for.inc7_crit_edge.us, label %for.inc.us

for.cond1.for.inc7_crit_edge.us:                  ; preds = %for.inc.us
  %indvars.iv.next89 = add nuw nsw i64 %indvars.iv88, 1
  %exitcond106 = icmp eq i64 %indvars.iv.next89, 800
...
for.cond14.preheader.us:                          ; preds = %for.cond14.preheader.us.preheader, %for.cond14.for.inc31_crit_edge.us
  %indvars.iv77 = phi i64 [ %indvars.iv.next78, %for.cond14.for.inc31_crit_edge.us ], [ 0, %for.cond14.preheader.us.preheader ]
  br label %for.inc28.us

for.inc28.us:                                     ; preds = %for.inc28.us, %for.cond14.preheader.us
  %indvars.iv72 = phi i64 [ 0, %for.cond14.preheader.us ], [ %indvars.iv.next73.1, %for.inc28.us ]
  %indvars.iv.next73 = or i64 %indvars.iv72, 1
  %3 = mul nuw nsw i64 %indvars.iv77, %indvars.iv.next73
  %4 = trunc i64 %3 to i32
  %rem20.us = srem i32 %4, 900
  %conv21.us = sitofp i32 %rem20.us to double
  %div23.us = fdiv double %conv21.us, 9.000000e+02
  %arrayidx27.us = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv77, i64 %indvars.iv72
  store double %div23.us, double* %arrayidx27.us, align 8
  %indvars.iv.next73.1 = add nsw i64 %indvars.iv72, 2
  %5 = mul nuw nsw i64 %indvars.iv77, %indvars.iv.next73.1
  %6 = trunc i64 %5 to i32
  %rem20.us.1 = srem i32 %6, 900
  %conv21.us.1 = sitofp i32 %rem20.us.1 to double
  %div23.us.1 = fdiv double %conv21.us.1, 9.000000e+02
  %arrayidx27.us.1 = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv77, i64 %indvars.iv.next73
  store double %div23.us.1, double* %arrayidx27.us.1, align 8
  %exitcond100.1 = icmp eq i64 %indvars.iv.next73.1, 900
  br i1 %exitcond100.1, label %for.cond14.for.inc31_crit_edge.us, label %for.inc28.us

for.cond14.for.inc31_crit_edge.us:                ; preds = %for.inc28.us
  %indvars.iv.next78 = add nuw nsw i64 %indvars.iv77, 1
  %exitcond102 = icmp eq i64 %indvars.iv.next78, 1100
  br i1 %exitcond102, label %for.cond38.preheader.us.preheader, label %for.cond14.preheader.us
...
for.cond38.preheader.us:                          ; preds = %for.cond38.preheader.us.preheader, %for.cond38.for.inc56_crit_edge.us
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.cond38.for.inc56_crit_edge.us ], [ 0, %for.cond38.preheader.us.preheader ]
  br label %for.inc53.us

for.inc53.us:                                     ; preds = %for.inc53.us, %for.cond38.preheader.us
  %indvars.iv60 = phi i64 [ 0, %for.cond38.preheader.us ], [ %indvars.iv.next61, %for.inc53.us ]
  %7 = add nuw nsw i64 %indvars.iv60, 3
  %8 = mul nuw nsw i64 %indvars.iv67, %7
  %9 = add nuw nsw i64 %8, 1
  %10 = trunc i64 %9 to i32
  %rem45.us = srem i32 %10, 1200
  %conv46.us = sitofp i32 %rem45.us to double
  %div48.us = fdiv double %conv46.us, 1.200000e+03
  %arrayidx52.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv67, i64 %indvars.iv60
  store double %div48.us, double* %arrayidx52.us, align 8
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  %exitcond96 = icmp eq i64 %indvars.iv.next61, 1200
  br i1 %exitcond96, label %for.cond38.for.inc56_crit_edge.us, label %for.inc53.us

for.cond38.for.inc56_crit_edge.us:                ; preds = %for.inc53.us
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  %exitcond98 = icmp eq i64 %indvars.iv.next68, 900
  br i1 %exitcond98, label %for.cond63.preheader.us.preheader, label %for.cond38.preheader.us
...
for.cond63.preheader.us:                          ; preds = %for.cond63.preheader.us.preheader, %for.cond63.for.inc80_crit_edge.us
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.cond63.for.inc80_crit_edge.us ], [ 0, %for.cond63.preheader.us.preheader ]
...
for.inc77.us:                                     ; preds = %for.inc77.us, %for.cond63.preheader.us
  ...
  %12 = mul nuw nsw i64 %indvars.iv55, %11
  %13 = trunc i64 %12 to i32
  %rem69.us = srem i32 %13, 1100
  %conv70.us = sitofp i32 %rem69.us to double
  %div72.us = fdiv double %conv70.us, 1.100000e+03
  %arrayidx76.us = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv55, i64 %indvars.iv
  store double %div72.us, double* %arrayidx76.us, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond94 = icmp eq i64 %indvars.iv.next, 1200
  br i1 %exitcond94, label %for.cond63.for.inc80_crit_edge.us, label %for.inc77.us

for.cond63.for.inc80_crit_edge.us:                ; preds = %for.inc77.us
  %indvars.iv.next56 = add nuw nsw i64 %indvars.iv55, 1
  %exitcond = icmp eq i64 %indvars.iv.next56, 800
...
for.cond4.preheader.us:                           ; preds = %for.cond4.for.inc28_crit_edge.us, %entry
  %indvars.iv129 = phi i64 [ 0, %entry ], [ %indvars.iv.next130, %for.cond4.for.inc28_crit_edge.us ]
  br label %for.body6.us.us

for.cond4.for.inc28_crit_edge.us:                 ; preds = %for.cond9.for.inc25_crit_edge.us.us
  %indvars.iv.next130 = add nuw nsw i64 %indvars.iv129, 1
  %exitcond145 = icmp eq i64 %indvars.iv.next130, 800
  br i1 %exitcond145, label %for.cond34.preheader.us.preheader, label %for.cond4.preheader.us
...
for.body6.us.us:                                  ; preds = %for.cond4.preheader.us, %for.cond9.for.inc25_crit_edge.us.us
  %indvars.iv125 = phi i64 [ %indvars.iv.next126, %for.cond9.for.inc25_crit_edge.us.us ], [ 0, %for.cond4.preheader.us ]
  %arrayidx8.us.us = getelementptr inbounds [900 x double], [900 x double]* %tmp, i64 %indvars.iv129, i64 %indvars.iv125
...
for.cond9.for.inc25_crit_edge.us.us:              ; preds = %for.inc.us.us
  ...
  %exitcond143 = icmp eq i64 %indvars.iv.next126, 900
  br i1 %exitcond143, label %for.cond4.for.inc28_crit_edge.us, label %for.body6.us.us

for.inc.us.us:                                    ; preds = %for.body6.us.us, %for.inc.us.us
  %indvars.iv121 = phi i64 [ %indvars.iv.next122.1, %for.inc.us.us ], [ 0, %for.body6.us.us ]
  %0 = phi double [ %add.us.us.1, %for.inc.us.us ], [ 0.000000e+00, %for.body6.us.us ]
  %arrayidx15.us.us = getelementptr inbounds [1100 x double], [1100 x double]* %A, i64 %indvars.iv129, i64 %indvars.iv121
  %1 = load double, double* %arrayidx15.us.us, align 8
  %mul.us.us = fmul double %1, %alpha
  %arrayidx19.us.us = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv121, i64 %indvars.iv125
  ...
  %arrayidx15.us.us.1 = getelementptr inbounds [1100 x double], [1100 x double]* %A, i64 %indvars.iv129, i64 %indvars.iv.next122
  %3 = load double, double* %arrayidx15.us.us.1, align 8
  %mul.us.us.1 = fmul double %3, %alpha
  %arrayidx19.us.us.1 = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv.next122, i64 %indvars.iv125
  ...
  %exitcond124.1 = icmp eq i64 %indvars.iv.next122.1, 1100
  br i1 %exitcond124.1, label %for.cond9.for.inc25_crit_edge.us.us, label %for.inc.us.us

for.cond34.preheader.us:                          ; preds = %for.cond34.preheader.us.preheader, %for.cond34.for.inc65_crit_edge.us
  %indvars.iv112 = phi i64 [ %indvars.iv.next113, %for.cond34.for.inc65_crit_edge.us ], [ 0, %for.cond34.preheader.us.preheader ]
  br label %for.body36.us.us

for.cond34.for.inc65_crit_edge.us:                ; preds = %for.cond42.for.inc62_crit_edge.us.us
  %indvars.iv.next113 = add nuw nsw i64 %indvars.iv112, 1
  %exitcond136 = icmp eq i64 %indvars.iv.next113, 800
  br i1 %exitcond136, label %for.end67, label %for.cond34.preheader.us

for.body36.us.us:                                 ; preds = %for.cond34.preheader.us, %for.cond42.for.inc62_crit_edge.us.us
  %indvars.iv108 = phi i64 [ %indvars.iv.next109, %for.cond42.for.inc62_crit_edge.us.us ], [ 0, %for.cond34.preheader.us ]
  %arrayidx40.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv112, i64 %indvars.iv108
...
for.cond42.for.inc62_crit_edge.us.us:             ; preds = %for.inc59.us.us
  ...
  %exitcond = icmp eq i64 %indvars.iv.next109, 1200
...
for.inc59.us.us:                                  ; preds = %for.body36.us.us, %for.inc59.us.us
  %indvars.iv104 = phi i64 [ %indvars.iv.next105.1, %for.inc59.us.us ], [ 0, %for.body36.us.us ]
  %6 = phi double [ %add58.us.us.1, %for.inc59.us.us ], [ %mul41.us.us, %for.body36.us.us ]
  %arrayidx48.us.us = getelementptr inbounds [900 x double], [900 x double]* %tmp, i64 %indvars.iv112, i64 %indvars.iv104
  %7 = load double, double* %arrayidx48.us.us, align 8
  %arrayidx52.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv104, i64 %indvars.iv108
  ...
  %arrayidx48.us.us.1 = getelementptr inbounds [900 x double], [900 x double]* %tmp, i64 %indvars.iv112, i64 %indvars.iv.next105
  %9 = load double, double* %arrayidx48.us.us.1, align 8
  %arrayidx52.us.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv.next105, i64 %indvars.iv108
  ...
  %exitcond107.1 = icmp eq i64 %indvars.iv.next105.1, 900
  br i1 %exitcond107.1, label %for.cond42.for.inc62_crit_edge.us.us, label %for.inc59.us.us
...
for.inc.us:                                       ; preds = %for.body4.us, %if.then.us
  ...
  %arrayidx8.us = getelementptr inbounds [1200 x double], [1200 x double]* %D, i64 %indvars.iv13, i64 %indvars.iv
