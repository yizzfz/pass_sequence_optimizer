...
@__llvm_prf_nm = private constant [40 x i8] c"%&x\DAK\CC\C9\C9O\8EO\CA,\89O,*J\ACdLO-\01r\18\8B!TZNf\01\90\06\00\0F1\0E\1F", section "__llvm_prf_names"
@llvm.used = appending global [5 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_alloc_bit_array to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_getbit to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_setbit to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_flipbit to i8*), i8* getelementptr inbounds ([40 x i8], [40 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
