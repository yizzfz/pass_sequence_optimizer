...
.preheader5:                                      ; preds = %36, %11
  %indvars.iv21 = phi i64 [ 0, %11 ], [ %indvars.iv.next22, %36 ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %.preheader5
  %indvars.iv18 = phi i64 [ 0, %.preheader5 ], [ %indvars.iv.next19.1, %._crit_edge ]
  %12 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv21, i64 %indvars.iv18
  %13 = load double, double* %12, align 8
  %sunkaddr = ptrtoint double* %3 to i64
  %sunkaddr20 = mul i64 %indvars.iv21, 8
  ...
  %sunkaddr24 = mul i64 %indvars.iv21, 8
  ...
  %24 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv21, i64 %indvars.iv.next19
  %25 = load double, double* %24, align 8
  %26 = load double, double* %sunkaddr22, align 8
  %27 = getelementptr inbounds double, double* %4, i64 %indvars.iv.next19
  %28 = load double, double* %27, align 8
  %29 = fmul double %26, %28
  %30 = fadd double %25, %29
  %31 = load double, double* %sunkaddr26, align 8
  %32 = getelementptr inbounds double, double* %6, i64 %indvars.iv.next19
  ...
  br i1 %exitcond20.1, label %36, label %._crit_edge
...
.preheader3.preheader:                            ; preds = %36
  br label %.preheader3

.preheader3:                                      ; preds = %53, %.preheader3.preheader
  %indvars.iv15 = phi i64 [ 0, %.preheader3.preheader ], [ %indvars.iv.next16, %53 ]
  %37 = getelementptr inbounds double, double* %8, i64 %indvars.iv15
  %.pre = load double, double* %37, align 8
  br label %._crit_edge1

._crit_edge1:                                     ; preds = %._crit_edge1, %.preheader3
  %38 = phi double [ %.pre, %.preheader3 ], [ %52, %._crit_edge1 ]
  %indvars.iv12 = phi i64 [ 0, %.preheader3 ], [ %indvars.iv.next13.1, %._crit_edge1 ]
  %39 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv12, i64 %indvars.iv15
  %40 = load double, double* %39, align 8
  %41 = fmul double %40, %1
  %42 = getelementptr inbounds double, double* %9, i64 %indvars.iv12
  %43 = load double, double* %42, align 8
  %44 = fmul double %41, %43
  %45 = fadd double %38, %44
  %sunkaddr27 = ptrtoint double* %8 to i64
  %sunkaddr28 = mul i64 %indvars.iv15, 8
  %sunkaddr29 = add i64 %sunkaddr27, %sunkaddr28
  %sunkaddr30 = inttoptr i64 %sunkaddr29 to double*
  store double %45, double* %sunkaddr30, align 8
  %indvars.iv.next13 = or i64 %indvars.iv12, 1
  %46 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next13, i64 %indvars.iv15
  %47 = load double, double* %46, align 8
  %48 = fmul double %47, %1
  %49 = getelementptr inbounds double, double* %9, i64 %indvars.iv.next13
  %50 = load double, double* %49, align 8
  %51 = fmul double %48, %50
  %52 = fadd double %45, %51
  store double %52, double* %sunkaddr30, align 8
  %indvars.iv.next13.1 = add nsw i64 %indvars.iv12, 2
  %exitcond14.1 = icmp eq i64 %indvars.iv.next13.1, 2000
  br i1 %exitcond14.1, label %53, label %._crit_edge1

; <label>:53:                                     ; preds = %._crit_edge1
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  %exitcond17 = icmp eq i64 %indvars.iv.next16, 2000
  br i1 %exitcond17, label %.preheader2.preheader, label %.preheader3
...
.preheader2:                                      ; preds = %.preheader2, %.preheader2.preheader
  ...
  %54 = getelementptr inbounds double, double* %8, i64 %indvars.iv9
  %55 = load double, double* %54, align 8
  %56 = getelementptr inbounds double, double* %10, i64 %indvars.iv9
  %57 = load double, double* %56, align 8
  %58 = fadd double %55, %57
  store double %58, double* %54, align 8
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  %59 = getelementptr inbounds double, double* %8, i64 %indvars.iv.next10
  %60 = load double, double* %59, align 8
  %61 = getelementptr inbounds double, double* %10, i64 %indvars.iv.next10
  %62 = load double, double* %61, align 8
  %63 = fadd double %60, %62
  store double %63, double* %59, align 8
  %indvars.iv.next10.1 = add nsw i64 %indvars.iv9, 2
  %64 = getelementptr inbounds double, double* %8, i64 %indvars.iv.next10.1
  %65 = load double, double* %64, align 8
  %66 = getelementptr inbounds double, double* %10, i64 %indvars.iv.next10.1
  %67 = load double, double* %66, align 8
  %68 = fadd double %65, %67
  store double %68, double* %64, align 8
  %indvars.iv.next10.2 = add nsw i64 %indvars.iv9, 3
  %69 = getelementptr inbounds double, double* %8, i64 %indvars.iv.next10.2
  %70 = load double, double* %69, align 8
  %71 = getelementptr inbounds double, double* %10, i64 %indvars.iv.next10.2
  %72 = load double, double* %71, align 8
  %73 = fadd double %70, %72
  store double %73, double* %69, align 8
  %indvars.iv.next10.3 = add nsw i64 %indvars.iv9, 4
  %74 = getelementptr inbounds double, double* %8, i64 %indvars.iv.next10.3
  %75 = load double, double* %74, align 8
  %76 = getelementptr inbounds double, double* %10, i64 %indvars.iv.next10.3
  ...
  br i1 %exitcond11.4, label %.preheader.preheader, label %.preheader2

.preheader.preheader:                             ; preds = %.preheader2
  br label %.preheader

.preheader:                                       ; preds = %95, %.preheader.preheader
  %indvars.iv6 = phi i64 [ 0, %.preheader.preheader ], [ %indvars.iv.next7, %95 ]
  %79 = getelementptr inbounds double, double* %7, i64 %indvars.iv6
  %.pre4 = load double, double* %79, align 8
  br label %._crit_edge3

._crit_edge3:                                     ; preds = %._crit_edge3, %.preheader
  %80 = phi double [ %.pre4, %.preheader ], [ %94, %._crit_edge3 ]
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %._crit_edge3 ]
  %81 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv6, i64 %indvars.iv
  ...
  %sunkaddr32 = mul i64 %indvars.iv6, 8
  %sunkaddr33 = add i64 %sunkaddr31, %sunkaddr32
  %sunkaddr34 = inttoptr i64 %sunkaddr33 to double*
  store double %87, double* %sunkaddr34, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %88 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv6, i64 %indvars.iv.next
  ...
  store double %94, double* %sunkaddr34, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond.1, label %95, label %._crit_edge3

; <label>:95:                                     ; preds = %._crit_edge3
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %exitcond8 = icmp eq i64 %indvars.iv.next7, 2000
  br i1 %exitcond8, label %96, label %.preheader
