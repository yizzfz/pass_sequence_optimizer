...
; <label>:4:                                      ; preds = %4, %.lr.ph95
  %indvars.iv124 = phi i64 [ 0, %.lr.ph95 ], [ %indvars.iv.next125, %4 ]
  ...
  br i1 %exitcond128, label %._crit_edge96, label %4
...
._crit_edge88.us:                                 ; preds = %._crit_edge88.us, %.lr.ph91.split.us.preheader
  ...
  %exitcond45.7 = icmp eq i64 %indvars.iv.next123.7, 2000
  br i1 %exitcond45.7, label %.lr.ph73.us.us.preheader.preheader, label %._crit_edge88.us
...
._crit_edge77.us:                                 ; preds = %._crit_edge74.us.us
  ...
  %exitcond44 = icmp eq i64 %indvars.iv.next118, 2000
  br i1 %exitcond44, label %.lr.ph69.split.us.preheader, label %.lr.ph73.us.us.preheader
...
.lr.ph73.us.us:                                   ; preds = %._crit_edge74.us.us, %.lr.ph73.us.us.preheader
  ...
  %40 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv115, i64 %indvars.iv117
...
vector.body.preheader:                            ; preds = %.lr.ph73.us.us
  br label %vector.body

scalar.ph.preheader:                              ; preds = %.lr.ph73.us.us
  br label %scalar.ph
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %49 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %index, i64 %indvars.iv117
  %50 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %41, i64 %indvars.iv117
  %51 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %42, i64 %indvars.iv117
  %52 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %43, i64 %indvars.iv117
  ...
  %63 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %27, i64 0, i64 %indvars.iv115, i64 %index
  ...
  br i1 %71, label %._crit_edge74.us.us.loopexit47, label %vector.body, !llvm.loop !9

._crit_edge74.us.us.loopexit:                     ; preds = %scalar.ph
  br label %._crit_edge74.us.us

._crit_edge74.us.us.loopexit47:                   ; preds = %vector.body
  br label %._crit_edge74.us.us

._crit_edge74.us.us:                              ; preds = %._crit_edge74.us.us.loopexit47, %._crit_edge74.us.us.loopexit
  %indvars.iv.next116 = add nuw nsw i64 %indvars.iv115, 1
  %exitcond43 = icmp eq i64 %indvars.iv.next116, 2000
  br i1 %exitcond43, label %._crit_edge77.us, label %.lr.ph73.us.us

scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader
  %indvars.iv112 = phi i64 [ 0, %scalar.ph.preheader ], [ %indvars.iv.next113.1, %scalar.ph ]
  %72 = load double, double* %40, align 8
  %73 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv112, i64 %indvars.iv117
  %74 = load double, double* %73, align 8
  %75 = fmul double %72, %74
  %76 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %25, i64 0, i64 %indvars.iv115, i64 %indvars.iv112
  ...
  %80 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv.next113, i64 %indvars.iv117
  %81 = load double, double* %80, align 8
  %82 = fmul double %79, %81
  %83 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv115, i64 %indvars.iv.next113
  ...
  br i1 %exitcond114.1, label %._crit_edge74.us.us.loopexit, label %scalar.ph, !llvm.loop !12

.lr.ph69.split.us:                                ; preds = %._crit_edge.us, %.lr.ph69.split.us.preheader
  %indvars.iv110 = phi i64 [ %indvars.iv.next111, %._crit_edge.us ], [ 0, %.lr.ph69.split.us.preheader ]
  %scevgep18 = getelementptr [2000 x double], [2000 x double]* %0, i64 %indvars.iv110, i64 0
  %scevgep1819 = bitcast double* %scevgep18 to i8*
  %86 = add nuw nsw i64 %indvars.iv110, 1
  %scevgep20 = getelementptr [2000 x double], [2000 x double]* %0, i64 %86, i64 0
  %scevgep2021 = bitcast double* %scevgep20 to i8*
  %87 = mul nuw nsw i64 %indvars.iv110, 16000
...
vector.body13.preheader:                          ; preds = %.lr.ph69.split.us
  br label %vector.body13

scalar.ph15.preheader:                            ; preds = %.lr.ph69.split.us
...
vector.body13:                                    ; preds = %vector.body13, %vector.body13.preheader
  ...
  %89 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv110, i64 %index30
  ...
  %93 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv110, i64 %index30
  ...
  %97 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %37, i64 0, i64 %indvars.iv110, i64 %index.next31
  ...
  %101 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv110, i64 %index.next31
...
scalar.ph15:                                      ; preds = %scalar.ph15, %scalar.ph15.preheader
  ...
  %106 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %31, i64 0, i64 %indvars.iv110, i64 %indvars.iv
  %107 = bitcast double* %106 to i64*
  %108 = load i64, i64* %107, align 8
  %109 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv110, i64 %indvars.iv
  %110 = bitcast double* %109 to i64*
  store i64 %108, i64* %110, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %111 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %32, i64 0, i64 %indvars.iv110, i64 %indvars.iv.next
  %112 = bitcast double* %111 to i64*
  %113 = load i64, i64* %112, align 8
  %114 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv110, i64 %indvars.iv.next
  %115 = bitcast double* %114 to i64*
  store i64 %113, i64* %115, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %116 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %33, i64 0, i64 %indvars.iv110, i64 %indvars.iv.next.1
  %117 = bitcast double* %116 to i64*
  %118 = load i64, i64* %117, align 8
  %119 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv110, i64 %indvars.iv.next.1
  %120 = bitcast double* %119 to i64*
  store i64 %118, i64* %120, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %121 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %34, i64 0, i64 %indvars.iv110, i64 %indvars.iv.next.2
  %122 = bitcast double* %121 to i64*
  %123 = load i64, i64* %122, align 8
  %124 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv110, i64 %indvars.iv.next.2
  %125 = bitcast double* %124 to i64*
  store i64 %123, i64* %125, align 8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %126 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %35, i64 0, i64 %indvars.iv110, i64 %indvars.iv.next.3
  %127 = bitcast double* %126 to i64*
  %128 = load i64, i64* %127, align 8
  %129 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv110, i64 %indvars.iv.next.3
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit46, %._crit_edge.us.loopexit
  ...
  %exitcond42 = icmp eq i64 %indvars.iv.next111, 2000
  br i1 %exitcond42, label %._crit_edge70, label %.lr.ph69.split.us
...
.lr.ph58:                                         ; preds = %._crit_edge53, %.lr.ph58.preheader
  %indvars.iv1 = phi i64 [ %indvars.iv.next2, %._crit_edge53 ], [ 0, %.lr.ph58.preheader ]
...
.lr.ph44:                                         ; preds = %._crit_edge, %.lr.ph44.preheader
  ...
  %8 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv1, i64 %indvars.iv68
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.lr.ph44
  ...
  %exitcond3 = icmp eq i64 %indvars.iv.next69, %indvars.iv1
  br i1 %exitcond3, label %.lr.ph52.split.us.preheader, label %.lr.ph44
...
.lr.ph52.split.us:                                ; preds = %._crit_edge49.us, %.lr.ph52.split.us.preheader
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %._crit_edge49.us ], [ %indvars.iv1, %.lr.ph52.split.us.preheader ]
  %38 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv1, i64 %indvars.iv79
  %.pre65 = load double, double* %38, align 8
  br i1 %lcmp.mod9, label %.prol.preheader6, label %.prol.loopexit7.unr-lcssa

.prol.preheader6:                                 ; preds = %.lr.ph52.split.us
  br label %39
...
.prol.loopexit7.unr-lcssa:                        ; preds = %.lr.ph52.split.us, %39
  %indvars.iv71.unr.ph = phi i64 [ 1, %39 ], [ 0, %.lr.ph52.split.us ]
  %.unr10.ph = phi double [ %44, %39 ], [ %.pre65, %.lr.ph52.split.us ]
...
.lr.ph52.split.us.new:                            ; preds = %.prol.loopexit7
  br label %45
...
; <label>:45:                                     ; preds = %45, %.lr.ph52.split.us.new
  ...
  %46 = phi double [ %.unr10.ph, %.lr.ph52.split.us.new ], [ %58, %45 ]
  %47 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv1, i64 %indvars.iv71
  ...
  %53 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv1, i64 %indvars.iv.next72
...
._crit_edge49.us:                                 ; preds = %.prol.loopexit7, %._crit_edge49.us.unr-lcssa
  ...
  %exitcond4 = icmp eq i64 %indvars.iv.next80, 2000
  br i1 %exitcond4, label %._crit_edge53.loopexit, label %.lr.ph52.split.us
...
._crit_edge53:                                    ; preds = %._crit_edge53.loopexit, %.lr.ph58
  ...
  br i1 %exitcond5, label %._crit_edge59, label %.lr.ph58
...
; <label>:6:                                      ; preds = %13, %.lr.ph14.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph14.split.us ], [ %indvars.iv.next, %13 ]
...
; <label>:13:                                     ; preds = %6, %11
  ...
  %15 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv17, i64 %indvars.iv
...
._crit_edge.us:                                   ; preds = %13
  ...
  %exitcond1 = icmp eq i64 %indvars.iv.next18, 2000
  br i1 %exitcond1, label %._crit_edge15, label %.lr.ph14.split.us
