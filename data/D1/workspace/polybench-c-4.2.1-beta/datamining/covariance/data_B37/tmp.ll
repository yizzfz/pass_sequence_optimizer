...
.lr.ph80.split.us:                                ; preds = %._crit_edge77.us, %.lr.ph80.split.us.preheader
  ...
  %sunkaddr121 = shl nuw nsw i64 %indvars.iv110, 3
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph80.split.us
  ...
  %10 = fadd double %9, %7
  store double %10, double* %sunkaddr123, align 8
  ...
  store double %13, double* %sunkaddr123, align 8
  ...
  store double %19, double* %sunkaddr123, align 8
...
._crit_edge77.us:                                 ; preds = %._crit_edge
  %20 = fdiv double %19, %2
  %sunkaddr145 = shl i64 %indvars.iv110, 3
...
._crit_edge77.us..preheader56.us_crit_edge:       ; preds = %._crit_edge77.us
  %scevgep132 = getelementptr double, double* %5, i64 1200
...
.preheader56.us:                                  ; preds = %._crit_edge72.us, %._crit_edge77.us..preheader56.us_crit_edge
  ...
  %scevgep130 = getelementptr [1200 x double], [1200 x double]* %3, i64 %21, i64 0
  %bound0 = icmp ult double* %scevgep, %scevgep132
  %bound1 = icmp ugt double* %scevgep130, %5
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.vec137 = load <8 x double>, <8 x double>* %25, align 8, !alias.scope !4, !noalias !1
  %26 = fsub <8 x double> %wide.vec137, %wide.vec
  ...
  br i1 %37, label %._crit_edge72.us.loopexit148, label %vector.body, !llvm.loop !6

._crit_edge117:                                   ; preds = %._crit_edge117.preheader, %._crit_edge117
  %indvars.iv100 = phi i64 [ %indvars.iv.next101.3, %._crit_edge117 ], [ 0, %._crit_edge117.preheader ]
  ...
  br i1 %exitcond102.3, label %._crit_edge72.us.loopexit, label %._crit_edge117, !llvm.loop !9

._crit_edge72.us.loopexit:                        ; preds = %._crit_edge117
  br label %._crit_edge72.us

._crit_edge72.us.loopexit148:                     ; preds = %vector.body
  br label %._crit_edge72.us

._crit_edge72.us:                                 ; preds = %._crit_edge72.us.loopexit148, %._crit_edge72.us.loopexit
...
._crit_edge118:                                   ; preds = %._crit_edge118, %.lr.ph.us.us
  ...
  %indvars.iv = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next.1, %._crit_edge118 ]
  ...
  br i1 %exitcond.1, label %._crit_edge.us.us, label %._crit_edge118
