...
; <label>:4:                                      ; preds = %._crit_edge._crit_edge, %.lr.ph4
  %indvars.iv11 = phi i64 [ 0, %.lr.ph4 ], [ %indvars.iv.next12, %._crit_edge._crit_edge ]
  %indvar = phi i32 [ 0, %.lr.ph4 ], [ %indvar.next, %._crit_edge._crit_edge ]
  %indvars.iv9 = phi i32 [ 1, %.lr.ph4 ], [ %indvars.iv.next10, %._crit_edge._crit_edge ]
  %5 = phi i32 [ 0, %.lr.ph4 ], [ %32, %._crit_edge._crit_edge ]
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %22 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv11, i64 %indvars.iv
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %4
  ...
  br i1 %31, label %._crit_edge._crit_edge, label %._crit_edge13
...
; <label>:4:                                      ; preds = %._crit_edge._crit_edge, %.lr.ph3
  %indvars.iv11 = phi i64 [ 0, %.lr.ph3 ], [ %indvars.iv.next12, %._crit_edge._crit_edge ]
  %indvar = phi i32 [ 0, %.lr.ph3 ], [ %indvar.next, %._crit_edge._crit_edge ]
  %indvars.iv9 = phi i32 [ 0, %.lr.ph3 ], [ %indvars.iv.next10, %._crit_edge._crit_edge ]
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %4
  ...
  br i1 %36, label %._crit_edge._crit_edge, label %._crit_edge14
...
._crit_edge._crit_edge:                           ; preds = %._crit_edge, %.lr.ph
  ...
  %7 = phi %struct._IO_FILE* [ %6, %.lr.ph ], [ %17, %._crit_edge ]
...
._crit_edge:                                      ; preds = %._crit_edge._crit_edge, %14
  ...
  br i1 %16, label %._crit_edge._crit_edge, label %._crit_edge8
