...
for.inc.lr.ph:                                    ; preds = %for.inc47, %entry
  ...
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc47 ], [ 0, %entry ]
  ...
  %5 = add i64 %indvars.iv19, 1
  %6 = shl i64 %indvars.iv19, 3
  %mul = fmul double %alpha.044, %alpha.044
  %sub4 = fsub double 1.000000e+00, %mul
  %7 = add nsw i64 %indvars.iv21, -1
...
for.inc.prol.loopexit:                            ; preds = %for.inc.lr.ph, %for.inc.prol.loopexit.unr-lcssa
  ...
  %11 = icmp ult i64 %indvars.iv19, 3
  br i1 %11, label %for.inc32.lr.ph, label %for.inc.lr.ph.new
...
vector.ph:                                        ; preds = %min.iters.checked
  %broadcast.splatinsert31 = insertelement <2 x double> undef, double %div, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load27 = load <2 x double>, <2 x double>* %28, align 8
  %29 = sub nsw i64 %7, %index
  %30 = getelementptr inbounds double, double* %y, i64 %29
  %31 = getelementptr double, double* %30, i64 -1
  %32 = bitcast double* %31 to <2 x double>*
  %wide.load28 = load <2 x double>, <2 x double>* %32, align 8
  %reverse = shufflevector <2 x double> %wide.load28, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %33 = getelementptr double, double* %30, i64 -2
  %34 = getelementptr double, double* %33, i64 -1
  %35 = bitcast double* %34 to <2 x double>*
  %wide.load29 = load <2 x double>, <2 x double>* %35, align 8
  %reverse30 = shufflevector <2 x double> %wide.load29, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %36 = fmul <2 x double> %broadcast.splat32, %reverse
  %37 = fmul <2 x double> %broadcast.splat32, %reverse30
  %38 = fadd <2 x double> %wide.load, %36
  %39 = fadd <2 x double> %wide.load27, %37
...
for.inc32.preheader:                              ; preds = %middle.block, %min.iters.checked, %for.inc32.lr.ph
  %indvars.iv4.ph = phi i64 [ 0, %min.iters.checked ], [ 0, %for.inc32.lr.ph ], [ %n.vec, %middle.block ]
  br label %for.inc32

for.inc32:                                        ; preds = %for.inc32.preheader, %for.inc32
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.inc32 ], [ %indvars.iv4.ph, %for.inc32.preheader ]
  %arrayidx23 = getelementptr inbounds double, double* %y, i64 %indvars.iv4
  %45 = load double, double* %arrayidx23, align 8
  %46 = sub nsw i64 %7, %indvars.iv4
  ...
  br i1 %exitcond10, label %for.inc47.loopexit, label %for.inc32, !llvm.loop !6
...
for.inc47:                                        ; preds = %for.inc47.loopexit, %middle.block
  ...
  %exitcond25 = icmp eq i64 %indvars.iv.next20, 1999
  br i1 %exitcond25, label %for.end49, label %for.inc.lr.ph
