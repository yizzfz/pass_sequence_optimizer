...
._crit_edge23:                                    ; preds = %._crit_edge23, %.preheader10
  %indvars.iv16 = phi i64 [ 0, %.preheader10 ], [ %indvars.iv.next17, %._crit_edge23 ]
  ...
  br i1 %exitcond18, label %._crit_edge27, label %._crit_edge23

._crit_edge27:                                    ; preds = %._crit_edge23
...
._crit_edge24:                                    ; preds = %._crit_edge24, %.preheader8
  %indvars.iv10 = phi i64 [ 0, %.preheader8 ], [ %indvars.iv.next11.1, %._crit_edge24 ]
...
._crit_edge25:                                    ; preds = %._crit_edge25, %.preheader6
  %indvars.iv4 = phi i64 [ 0, %.preheader6 ], [ %indvars.iv.next5, %._crit_edge25 ]
  ...
  br i1 %exitcond6, label %._crit_edge17, label %._crit_edge25

._crit_edge17:                                    ; preds = %._crit_edge25
...
._crit_edge26:                                    ; preds = %._crit_edge26, %.preheader
  ...
  br i1 %exitcond, label %._crit_edge, label %._crit_edge26
...
._crit_edge17:                                    ; preds = %._crit_edge17, %.lr.ph15
  %indvars.iv6 = phi i64 [ 0, %.lr.ph15 ], [ %indvars.iv.next7.1, %._crit_edge17 ]
  %8 = phi double [ 0.000000e+00, %.lr.ph15 ], [ %22, %._crit_edge17 ]
  ...
  br i1 %exitcond8.1, label %._crit_edge16, label %._crit_edge17
...
._crit_edge6:                                     ; preds = %._crit_edge4, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %._crit_edge4 ]
  %6 = add nuw nsw i64 %indvars.iv, %5
  %7 = trunc i64 %6 to i32
  %8 = srem i32 %7, 20
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %10, label %._crit_edge4
...
._crit_edge4:                                     ; preds = %._crit_edge6, %10
