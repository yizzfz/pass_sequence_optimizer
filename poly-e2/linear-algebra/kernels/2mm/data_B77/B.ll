...
for.cond.for.cond1_crit_edge.us:                  ; preds = %for.end.us, %for.cond.for.cond1_crit_edge.us.preheader
  %indvars.iv2141.us = phi i64 [ 0, %for.cond.for.cond1_crit_edge.us.preheader ], [ %indvars.iv.next22.us, %for.end.us ]
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us, %for.cond.for.cond1_crit_edge.us
  %indvars.iv1739.us = phi i64 [ 0, %for.cond.for.cond1_crit_edge.us ], [ %indvars.iv.next18.us, %for.body3.us ]
  ...
  br i1 %exitcond10, label %for.end.us, label %for.body3.us
...
for.end.us:                                       ; preds = %for.body3.us
  ...
  br i1 %exitcond11, label %for.cond10.for.cond14_crit_edge.us.preheader, label %for.cond.for.cond1_crit_edge.us

for.cond10.for.cond14_crit_edge.us.preheader:     ; preds = %for.end.us
  br label %for.cond10.for.cond14_crit_edge.us

for.cond10.for.cond14_crit_edge.us:               ; preds = %for.cond10.for.cond14_crit_edge.us.preheader, %for.end30.us
  %indvars.iv1536.us = phi i64 [ %indvars.iv.next16.us, %for.end30.us ], [ 0, %for.cond10.for.cond14_crit_edge.us.preheader ]
  br label %for.body17.us

for.body17.us:                                    ; preds = %for.body17.us, %for.cond10.for.cond14_crit_edge.us
  %indvars.iv1234.us = phi i64 [ 0, %for.cond10.for.cond14_crit_edge.us ], [ %indvars.iv.next13.us.1, %for.body17.us ]
  ...
  br i1 %exitcond8.1, label %for.end30.us, label %for.body17.us
...
for.end30.us:                                     ; preds = %for.body17.us
  ...
  br i1 %exitcond9, label %for.cond34.for.cond38_crit_edge.us.preheader, label %for.cond10.for.cond14_crit_edge.us

for.cond34.for.cond38_crit_edge.us.preheader:     ; preds = %for.end30.us
  br label %for.cond34.for.cond38_crit_edge.us

for.cond34.for.cond38_crit_edge.us:               ; preds = %for.cond34.for.cond38_crit_edge.us.preheader, %for.end55.us
  %indvars.iv1031.us = phi i64 [ %indvars.iv.next11.us, %for.end55.us ], [ 0, %for.cond34.for.cond38_crit_edge.us.preheader ]
  br label %for.body41.us

for.body41.us:                                    ; preds = %for.body41.us, %for.cond34.for.cond38_crit_edge.us
  %indvars.iv529.us = phi i64 [ 0, %for.cond34.for.cond38_crit_edge.us ], [ %indvars.iv.next6.us, %for.body41.us ]
  ...
  br i1 %exitcond6, label %for.end55.us, label %for.body41.us
...
for.end55.us:                                     ; preds = %for.body41.us
  ...
  br i1 %exitcond7, label %for.cond59.for.cond63_crit_edge.us.preheader, label %for.cond34.for.cond38_crit_edge.us

for.cond59.for.cond63_crit_edge.us.preheader:     ; preds = %for.end55.us
  br label %for.cond59.for.cond63_crit_edge.us

for.cond59.for.cond63_crit_edge.us:               ; preds = %for.cond59.for.cond63_crit_edge.us.preheader, %for.end79.us
  %indvars.iv326.us = phi i64 [ %indvars.iv.next4.us, %for.end79.us ], [ 0, %for.cond59.for.cond63_crit_edge.us.preheader ]
  br label %for.body66.us

for.body66.us:                                    ; preds = %for.body66.us, %for.cond59.for.cond63_crit_edge.us
  %indvars.iv24.us = phi i64 [ 0, %for.cond59.for.cond63_crit_edge.us ], [ %indvars.iv.next.us, %for.body66.us ]
  ...
  br i1 %exitcond, label %for.end79.us, label %for.body66.us
...
for.end79.us:                                     ; preds = %for.body66.us
  ...
  br i1 %exitcond5, label %for.end82, label %for.cond59.for.cond63_crit_edge.us
...
for.cond.for.cond4_crit_edge.us.preheader:
  br label %for.body6.us.us.preheader

for.body6.us.us.preheader:                        ; preds = %for.end27.us, %for.cond.for.cond4_crit_edge.us.preheader
  %indvars.iv925.us = phi i64 [ 0, %for.cond.for.cond4_crit_edge.us.preheader ], [ %indvars.iv.next10.us, %for.end27.us ]
...
for.body6.us.us:                                  ; preds = %for.end.us.us, %for.body6.us.us.preheader
  %indvars.iv722.us.us = phi i64 [ 0, %for.body6.us.us.preheader ], [ %indvars.iv.next8.us.us, %for.end.us.us ]
...
for.end.us.us:                                    ; preds = %for.body11.us.us
  ...
  br i1 %exitcond8, label %for.end27.us, label %for.body6.us.us
...
for.body11.us.us:                                 ; preds = %for.body11.us.us, %for.body6.us.us
  ...
  %indvars.iv520.us.us = phi i64 [ 0, %for.body6.us.us ], [ %indvars.iv.next6.us.us.1, %for.body11.us.us ]
  ...
  br i1 %exitcond7.1, label %for.end.us.us, label %for.body11.us.us

for.body36.us.us.preheader:                       ; preds = %for.body36.us.us.preheader.preheader, %for.end64.us
  %indvars.iv317.us = phi i64 [ %indvars.iv.next4.us, %for.end64.us ], [ 0, %for.body36.us.us.preheader.preheader ]
...
for.body36.us.us:                                 ; preds = %for.end61.us.us, %for.body36.us.us.preheader
  %indvars.iv114.us.us = phi i64 [ 0, %for.body36.us.us.preheader ], [ %indvars.iv.next2.us.us, %for.end61.us.us ]
...
for.end61.us.us:                                  ; preds = %for.body44.us.us
  ...
  br i1 %exitcond5, label %for.end64.us, label %for.body36.us.us

for.body44.us.us:                                 ; preds = %for.body44.us.us, %for.body36.us.us
  %6 = phi double [ %mul41.us.us, %for.body36.us.us ], [ %add58.us.us.2, %for.body44.us.us ]
  %indvars.iv12.us.us = phi i64 [ 0, %for.body36.us.us ], [ %indvars.iv.next.us.us.2, %for.body44.us.us ]
  ...
  br i1 %exitcond.2, label %for.end61.us.us, label %for.body44.us.us
...
for.cond.for.cond2_crit_edge.us:                  ; preds = %for.end.us, %for.cond.for.cond2_crit_edge.us.preheader
  %indvars.iv28.us = phi i64 [ 0, %for.cond.for.cond2_crit_edge.us.preheader ], [ %indvars.iv.next3.us, %for.end.us ]
  %3 = mul nuw nsw i64 %indvars.iv28.us, 800
  br label %for.body4.us

for.body4.us:                                     ; preds = %if.end.us, %for.cond.for.cond2_crit_edge.us
  %indvars.iv6.us = phi i64 [ 0, %for.cond.for.cond2_crit_edge.us ], [ %indvars.iv.next.us, %if.end.us ]
...
for.end.us:                                       ; preds = %if.end.us
  ...
  br i1 %exitcond2, label %for.end12, label %for.cond.for.cond2_crit_edge.us
