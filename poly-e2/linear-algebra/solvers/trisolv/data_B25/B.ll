...
for.body6.lr.ph:                                  ; preds = %for.end, %for.body.lr.ph
  %indvars.iv10 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next11, %for.end ]
...
for.body:                                         ; preds = %for.end, %for.body.preheader
  ...
  %indvars.iv6 = phi i32 [ %indvars.iv.next7, %for.end ], [ -1, %for.body.preheader ]
...
for.end:                                          ; preds = %for.end.loopexit, %for.body
  %13 = phi double [ %3, %for.body ], [ %sub.lcssa, %for.end.loopexit ]
...
if.then:                                          ; preds = %for.body
  ...
  %fputc = call i32 @fputc(i32 10, %struct._IO_FILE* %7) #5
  br label %if.end
