...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc7_crit_edge.us, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge
  %indvars.iv2434.us = phi i64 [ 0, %for.cond1.preheader.lr.ph.for.cond1.preheader.us_crit_edge ], [ %indvars.iv.next25.us, %for.cond1.for.inc7_crit_edge.us ]
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us, %for.cond1.preheader.us
  %indvars.iv2032.us = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next21.us, %for.body3.us ]
  ...
  %exitcond36 = icmp eq i64 %indvars.iv2032.us, 999
  %indvars.iv.next21.us = add nuw nsw i64 %indvars.iv2032.us, 1
  br i1 %exitcond36, label %for.cond1.for.inc7_crit_edge.us, label %for.body3.us

for.cond1.for.inc7_crit_edge.us:                  ; preds = %for.body3.us
  %indvars.iv.next25.us = add nuw nsw i64 %indvars.iv2434.us, 1
  %exitcond41 = icmp eq i64 %indvars.iv.next25.us, 1200
  br i1 %exitcond41, label %for.cond14.preheader.preheader, label %for.cond1.preheader.us
...
for.body17:                                       ; preds = %for.body17, %for.cond14.preheader
  %indvars.iv27 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next, %for.body17 ]
...
for.inc31:                                        ; preds = %for.body17
  ...
  %cmp11 = icmp slt i64 %indvars.iv.next19, 1200
  br i1 %cmp11, label %for.cond14.preheader, label %for.end33
...
for.cond1.preheader.us:                           ; preds = %for.cond6.for.inc32_crit_edge.us, %for.cond1.preheader.us.preheader
  ...
  %indvars.iv2936.us = phi i64 [ %3, %for.cond6.for.inc32_crit_edge.us ], [ 0, %for.cond1.preheader.us.preheader ]
  %0 = add i64 %indvars.iv2936.us, 1
  %1 = add i64 %indvars.iv2936.us, -3
  %2 = lshr i64 %1, 2
  %3 = add i64 %indvars.iv2936.us, 1
  %scevgep = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv2936.us, i64 0
  %4 = mul i64 %indvars.iv2936.us, 1201
  %5 = add i64 %4, 1
...
vector.body16.prol:                               ; preds = %vector.body16.prol.preheader
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv2936.us, i64 0
  %8 = bitcast double* %7 to <2 x double>*
  %wide.load33.prol = load <2 x double>, <2 x double>* %8, align 8
  %9 = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv2936.us, i64 2
...
vector.body16.prol.loopexit.unr-lcssa:            ; preds = %vector.ph24, %vector.body16.prol
...
vector.body16:                                    ; preds = %vector.body16, %vector.ph24.new
  ...
  %14 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv2936.us, i64 %index25
  ...
  %20 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv2936.us, i64 %index.next26
  ...
  br i1 %26, label %middle.block17.unr-lcssa, label %vector.body16, !llvm.loop !1

middle.block17.unr-lcssa:                         ; preds = %vector.body16
  br label %middle.block17

middle.block17:                                   ; preds = %vector.body16.prol.loopexit, %middle.block17.unr-lcssa
...
for.body3.us.preheader:                           ; preds = %middle.block17, %min.iters.checked20, %for.cond1.preheader.us
  %indvars.iv31.us.ph = phi i64 [ 0, %min.iters.checked20 ], [ 0, %for.cond1.preheader.us ], [ %n.vec22, %middle.block17 ]
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us.preheader, %for.body3.us
  %indvars.iv31.us = phi i64 [ %indvars.iv.next.us, %for.body3.us ], [ %indvars.iv31.us.ph, %for.body3.us.preheader ]
  ...
  %exitcond.us = icmp eq i64 %indvars.iv.next.us, %indvars.iv2738.us
  br i1 %exitcond.us, label %for.cond9.preheader.us.preheader.loopexit, label %for.body3.us, !llvm.loop !4

for.cond9.preheader.us.preheader.loopexit:        ; preds = %for.body3.us
  br label %for.cond9.preheader.us.preheader

for.cond9.preheader.us.preheader:                 ; preds = %for.cond9.preheader.us.preheader.loopexit, %middle.block17
  %n.vec = and i64 %3, -4
...
for.cond9.preheader.us:                           ; preds = %for.cond9.preheader.us.preheader, %for.inc29.us
  %indvars.iv2534.us = phi i64 [ %28, %for.inc29.us ], [ 0, %for.cond9.preheader.us.preheader ]
  %scevgep4 = getelementptr [1000 x double], [1000 x double]* %A, i64 0, i64 %indvars.iv2534.us
  %28 = add i64 %indvars.iv2534.us, 1
  %scevgep6 = getelementptr [1000 x double], [1000 x double]* %A, i64 %indvars.iv2936.us, i64 %28
  %arrayidx15.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv2936.us, i64 %indvars.iv2534.us
  br i1 %min.iters.check19, label %for.body11.us.preheader, label %min.iters.checked
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %29 = insertelement <2 x double> undef, double %.pre, i32 0
  %30 = fmul <2 x double> %29, %broadcast.splatinsert13
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %33 = or i64 %index, 2
  %34 = or i64 %index, 3
  %35 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %index, i64 %indvars.iv2534.us
  %36 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %32, i64 %indvars.iv2534.us
  %37 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %33, i64 %indvars.iv2534.us
  %38 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %34, i64 %indvars.iv2534.us
  ...
  %47 = fmul <2 x double> %31, %44
  %48 = fmul <2 x double> %31, %46
  %49 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv2936.us, i64 %index
  %50 = bitcast double* %49 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %50, align 8, !alias.scope !11, !noalias !13
  %51 = getelementptr double, double* %49, i64 2
  %52 = bitcast double* %51 to <2 x double>*
  %wide.load15 = load <2 x double>, <2 x double>* %52, align 8, !alias.scope !11, !noalias !13
  %53 = fadd <2 x double> %wide.load, %47
  %54 = fadd <2 x double> %wide.load15, %48
  store <2 x double> %53, <2 x double>* %50, align 8, !alias.scope !11, !noalias !13
  store <2 x double> %54, <2 x double>* %52, align 8, !alias.scope !11, !noalias !13
  %index.next = add i64 %index, 4
  %55 = icmp eq i64 %index.next, %n.vec
  br i1 %55, label %middle.block, label %vector.body, !llvm.loop !14

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %for.inc29.us, label %for.body11.us.preheader

for.body11.us.preheader:                          ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.cond9.preheader.us
  %indvars.iv1932.us.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %min.iters.checked ], [ 0, %for.cond9.preheader.us ], [ %n.vec, %middle.block ]
  %56 = sub i64 %0, %indvars.iv1932.us.ph
  %xtraiter37 = and i64 %56, 1
  %lcmp.mod38 = icmp eq i64 %xtraiter37, 0
  br i1 %lcmp.mod38, label %for.body11.us.prol.loopexit.unr-lcssa, label %for.body11.us.prol.preheader

for.body11.us.prol.preheader:                     ; preds = %for.body11.us.preheader
  br label %for.body11.us.prol

for.body11.us.prol:                               ; preds = %for.body11.us.prol.preheader
  %57 = load double, double* %arrayidx15.us, align 8
  %mul16.us.prol = fmul double %57, %alpha
  %arrayidx20.us.prol = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv1932.us.ph, i64 %indvars.iv2534.us
  %58 = load double, double* %arrayidx20.us.prol, align 8
  %mul21.us.prol = fmul double %mul16.us.prol, %58
  %arrayidx25.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv2936.us, i64 %indvars.iv1932.us.ph
  %59 = load double, double* %arrayidx25.us.prol, align 8
  %add.us.prol = fadd double %59, %mul21.us.prol
  store double %add.us.prol, double* %arrayidx25.us.prol, align 8
  %indvars.iv.next20.us.prol = or i64 %indvars.iv1932.us.ph, 1
  br label %for.body11.us.prol.loopexit.unr-lcssa

for.body11.us.prol.loopexit.unr-lcssa:            ; preds = %for.body11.us.preheader, %for.body11.us.prol
  %indvars.iv1932.us.unr.ph = phi i64 [ %indvars.iv.next20.us.prol, %for.body11.us.prol ], [ %indvars.iv1932.us.ph, %for.body11.us.preheader ]
  br label %for.body11.us.prol.loopexit

for.body11.us.prol.loopexit:                      ; preds = %for.body11.us.prol.loopexit.unr-lcssa
  %60 = icmp eq i64 %indvars.iv2936.us, %indvars.iv1932.us.ph
  br i1 %60, label %for.inc29.us.loopexit, label %for.body11.us.preheader.new
...
for.body11.us:                                    ; preds = %for.body11.us, %for.body11.us.preheader.new
  %indvars.iv1932.us = phi i64 [ %indvars.iv1932.us.unr.ph, %for.body11.us.preheader.new ], [ %indvars.iv.next20.us.1, %for.body11.us ]
  ...
  %add.us = fadd double %63, %mul21.us
  ...
  br i1 %exitcond24.us.1, label %for.inc29.us.loopexit.unr-lcssa, label %for.body11.us, !llvm.loop !15

for.inc29.us.loopexit.unr-lcssa:                  ; preds = %for.body11.us
  br label %for.inc29.us.loopexit

for.inc29.us.loopexit:                            ; preds = %for.body11.us.prol.loopexit, %for.inc29.us.loopexit.unr-lcssa
  br label %for.inc29.us

for.inc29.us:                                     ; preds = %for.inc29.us.loopexit, %middle.block
  %exitcond41 = icmp eq i64 %28, 1000
  br i1 %exitcond41, label %for.cond6.for.inc32_crit_edge.us, label %for.cond9.preheader.us
...
for.cond2.preheader:                              ; preds = %for.inc10, %for.cond2.preheader.lr.ph.for.cond2.preheader_crit_edge
  %indvars.iv814 = phi i64 [ 0, %for.cond2.preheader.lr.ph.for.cond2.preheader_crit_edge ], [ %indvars.iv.next9, %for.inc10 ]
  %3 = mul nsw i64 %indvars.iv814, 1200
  br label %for.body4

for.body4:                                        ; preds = %if.end, %for.cond2.preheader
  %indvars.iv12 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next, %if.end ]
  %4 = add nsw i64 %indvars.iv12, %3
  %5 = trunc i64 %4 to i32
  %rem = srem i32 %5, 20
...
for.inc10:                                        ; preds = %if.end
  ...
  %exitcond16 = icmp eq i64 %indvars.iv.next9, 1200
  br i1 %exitcond16, label %for.end12, label %for.cond2.preheader
