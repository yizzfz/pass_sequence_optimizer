...
._crit_edge26:                                    ; preds = %._crit_edge26, %._crit_edge
  %indvars.iv16 = phi i64 [ 0, %._crit_edge ], [ %indvars.iv.next17, %._crit_edge26 ]
  ...
  br i1 %exitcond18, label %14, label %._crit_edge26

; <label>:14:                                     ; preds = %._crit_edge26
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  %exitcond21 = icmp eq i64 %indvars.iv.next20, 800
  br i1 %exitcond21, label %._crit_edge9.preheader, label %._crit_edge

._crit_edge9.preheader:                           ; preds = %14
  br label %._crit_edge9

._crit_edge9:                                     ; preds = %._crit_edge9.preheader, %27
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %27 ], [ 0, %._crit_edge9.preheader ]
  br label %._crit_edge27

._crit_edge27:                                    ; preds = %._crit_edge27, %._crit_edge9
  %indvars.iv10 = phi i64 [ 0, %._crit_edge9 ], [ %indvars.iv.next11.1, %._crit_edge27 ]
  ...
  br i1 %exitcond12.1, label %27, label %._crit_edge27

; <label>:27:                                     ; preds = %._crit_edge27
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 1100
  br i1 %exitcond15, label %._crit_edge11.preheader, label %._crit_edge9

._crit_edge11.preheader:                          ; preds = %27
  br label %._crit_edge11

._crit_edge11:                                    ; preds = %._crit_edge11.preheader, %36
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %36 ], [ 0, %._crit_edge11.preheader ]
  br label %._crit_edge28

._crit_edge28:                                    ; preds = %._crit_edge28, %._crit_edge11
  %indvars.iv4 = phi i64 [ 0, %._crit_edge11 ], [ %indvars.iv.next5, %._crit_edge28 ]
  ...
  br i1 %exitcond6, label %36, label %._crit_edge28

; <label>:36:                                     ; preds = %._crit_edge28
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %exitcond9 = icmp eq i64 %indvars.iv.next8, 900
  br i1 %exitcond9, label %._crit_edge13.preheader, label %._crit_edge11

._crit_edge13.preheader:                          ; preds = %36
  br label %._crit_edge13

._crit_edge13:                                    ; preds = %._crit_edge13.preheader, %44
  %indvars.iv1 = phi i64 [ %indvars.iv.next2, %44 ], [ 0, %._crit_edge13.preheader ]
  br label %._crit_edge29

._crit_edge29:                                    ; preds = %._crit_edge29, %._crit_edge13
  %indvars.iv = phi i64 [ 0, %._crit_edge13 ], [ %indvars.iv.next, %._crit_edge29 ]
...
; <label>:44:                                     ; preds = %._crit_edge29
  ...
  br i1 %exitcond3, label %45, label %._crit_edge13
...
._crit_edge22:                                    ; preds = %24, %._crit_edge
  %indvars.iv10 = phi i64 [ 0, %._crit_edge ], [ %indvars.iv.next11, %24 ]
...
._crit_edge21:                                    ; preds = %._crit_edge21, %._crit_edge22
  %indvars.iv7 = phi i64 [ 0, %._crit_edge22 ], [ %indvars.iv.next8.1, %._crit_edge21 ]
  %9 = phi double [ 0.000000e+00, %._crit_edge22 ], [ %23, %._crit_edge21 ]
  ...
  br i1 %exitcond9.1, label %24, label %._crit_edge21

; <label>:24:                                     ; preds = %._crit_edge21
...
; <label>:25:                                     ; preds = %24
  ...
  br i1 %exitcond15, label %._crit_edge7.preheader, label %._crit_edge

._crit_edge7.preheader:                           ; preds = %25
  br label %._crit_edge7

._crit_edge7:                                     ; preds = %._crit_edge7.preheader, %49
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %49 ], [ 0, %._crit_edge7.preheader ]
  br label %._crit_edge24

._crit_edge24:                                    ; preds = %48, %._crit_edge7
  %indvars.iv1 = phi i64 [ 0, %._crit_edge7 ], [ %indvars.iv.next2, %48 ]
...
._crit_edge23:                                    ; preds = %._crit_edge23, %._crit_edge24
  %indvars.iv = phi i64 [ 0, %._crit_edge24 ], [ %indvars.iv.next.2, %._crit_edge23 ]
  %29 = phi double [ %28, %._crit_edge24 ], [ %47, %._crit_edge23 ]
  ...
  br i1 %exitcond.2, label %48, label %._crit_edge23

; <label>:48:                                     ; preds = %._crit_edge23
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 1200
  br i1 %exitcond3, label %49, label %._crit_edge24

; <label>:49:                                     ; preds = %48
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1
  %exitcond6 = icmp eq i64 %indvars.iv.next5, 800
  br i1 %exitcond6, label %50, label %._crit_edge7
