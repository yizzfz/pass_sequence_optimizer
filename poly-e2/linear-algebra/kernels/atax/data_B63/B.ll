...
entry:
  ...
  call fastcc void @kernel_atax(i32 1900, i32 2100, [2100 x double]* %arraydecay1, double* %arraydecay42, double* %arraydecay73, double* %arraydecay84)
...
for.body5.us.preheader:                           ; preds = %for.body
  ...
  %scevgep104 = getelementptr double, double* %y, i64 2100
  %0 = ptrtoint double* %tmp to i64
  %1 = bitcast double* %scevgep104 to i8*
...
for.body5.us:                                     ; preds = %for.inc42.us, %for.body5.us.preheader
  ...
  %scevgep106 = getelementptr [2100 x double], [2100 x double]* %A, i64 %indvars.iv66, i64 1
  %3 = add i64 %indvars.iv66, 1
  %scevgep108 = getelementptr [2100 x double], [2100 x double]* %A, i64 %3, i64 0
  ...
  %sunkaddr91 = shl i64 %indvars.iv66, 3
  %sunkaddr92 = add i64 %0, %sunkaddr91
  %4 = inttoptr i64 %sunkaddr92 to double*
  br label %for.body10.us
...
for.body26.us.for.body26.us_crit_edge:            ; preds = %for.body26.us.for.body26.us_crit_edge.preheader, %for.body26.us.for.body26.us_crit_edge
  %indvars.iv.next65102 = phi i64 [ %indvars.iv.next65, %for.body26.us.for.body26.us_crit_edge ], [ %indvars.iv.next65102.ph, %for.body26.us.for.body26.us_crit_edge.preheader ]
  %.pre = load double, double* %17, align 8
  %arrayidx28.us = getelementptr inbounds double, double* %y, i64 %indvars.iv.next65102
  %5 = load double, double* %arrayidx28.us, align 8
  %arrayidx32.us = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv66, i64 %indvars.iv.next65102
  ...
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv.next65102, 1
...
for.body10.us.for.body26.us_crit_edge:            ; preds = %for.body10.us
  ...
  %arrayidx32.us99 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv66, i64 0
  %15 = load double, double* %arrayidx32.us99, align 8
  %mul35.us100 = fmul double %15, %add.us.2
  %add36.us101 = fadd double %14, %mul35.us100
  store double %add36.us101, double* %y, align 8
  %bc = inttoptr i64 %sunkaddr92 to i8*
  %bound0 = icmp ult i8* %2, %bc
  %bound1 = icmp ult i8* %bc, %1
  %found.conflict = and i1 %bound0, %bound1
  %bound0111 = icmp ult double* %scevgep, %scevgep108
  %bound1112 = icmp ult double* %scevgep106, %scevgep104
...
vector.body.preheader:                            ; preds = %for.body10.us.for.body26.us_crit_edge
  %16 = inttoptr i64 %sunkaddr92 to double*
...
for.body26.us.for.body26.us_crit_edge.preheader:  ; preds = %for.body26.us.for.body26.us_crit_edge.preheader.loopexit, %for.body10.us.for.body26.us_crit_edge
  %indvars.iv.next65102.ph = phi i64 [ 1, %for.body10.us.for.body26.us_crit_edge ], [ 2097, %for.body26.us.for.body26.us_crit_edge.preheader.loopexit ]
  %17 = inttoptr i64 %sunkaddr92 to double*
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load115 = load <2 x double>, <2 x double>* %24, align 8, !alias.scope !7, !noalias !9
  %25 = getelementptr inbounds [2100 x double], [2100 x double]* %A, i64 %indvars.iv66, i64 %offset.idx
  %26 = bitcast double* %25 to <2 x double>*
  %wide.load116 = load <2 x double>, <2 x double>* %26, align 8, !alias.scope !11
  %27 = getelementptr double, double* %25, i64 2
  %28 = bitcast double* %27 to <2 x double>*
  %wide.load117 = load <2 x double>, <2 x double>* %28, align 8, !alias.scope !11
  %29 = fmul <2 x double> %wide.load116, %20
  %30 = fmul <2 x double> %wide.load117, %20
  %31 = fadd <2 x double> %wide.load, %29
  %32 = fadd <2 x double> %wide.load115, %30
