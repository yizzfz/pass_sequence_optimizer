...
.lr.ph.us:                                        ; preds = %._crit_edge9.us..lr.ph.us_crit_edge, %.preheader4.lr.ph
  %indvars.iv62 = phi i2 [ %indvars.iv.next63, %._crit_edge9.us..lr.ph.us_crit_edge ], [ 1, %.preheader4.lr.ph ]
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %._crit_edge9.us..lr.ph.us_crit_edge ], [ 0, %.preheader4.lr.ph ]
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %._crit_edge9.us..lr.ph.us_crit_edge ], [ 1, %.preheader4.lr.ph ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %63 = fmul <2 x double> %strided.vec, %broadcast.splat73
  %64 = fmul <2 x double> %strided.vec69, %broadcast.splat73
  %65 = fmul <2 x double> %strided.vec70, %broadcast.splat73
  %66 = add nsw i64 %60, 3
  %67 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv41, i64 %66
  %68 = fmul <2 x double> %strided.vec71, %broadcast.splat73
...
._crit_edge.us18:                                 ; preds = %._crit_edge.us18.loopexit, %.prol.loopexit31
  ...
  %exitcond64 = icmp eq i64 %indvars.iv.next36, 1000
  br i1 %exitcond64, label %._crit_edge9.us, label %.preheader.us15
