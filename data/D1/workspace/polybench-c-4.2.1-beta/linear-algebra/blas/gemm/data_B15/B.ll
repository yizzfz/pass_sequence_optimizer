...
.preheader7:                                      ; preds = %14, %5
  %indvars.iv26 = phi i64 [ 0, %5 ], [ %indvars.iv.next27, %14 ]
  br label %6

; <label>:6:                                      ; preds = %6, %.preheader7
  %indvars.iv23 = phi i64 [ 0, %.preheader7 ], [ %indvars.iv.next24, %6 ]
  ...
  br i1 %exitcond25, label %14, label %6
...
.preheader5:                                      ; preds = %.preheader5.preheader, %28
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %28 ], [ 0, %.preheader5.preheader ]
  br label %15

; <label>:15:                                     ; preds = %15, %.preheader5
  %indvars.iv17 = phi i64 [ 0, %.preheader5 ], [ %indvars.iv.next18.1, %15 ]
  %indvars.iv.next18 = or i64 %indvars.iv17, 1
  %16 = mul nuw nsw i64 %indvars.iv.next18, %indvars.iv20
  %17 = trunc i64 %16 to i32
  %18 = srem i32 %17, 1200
  %19 = sitofp i32 %18 to double
  %20 = fdiv double %19, 1.200000e+03
  %21 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv20, i64 %indvars.iv17
  ...
  %27 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv20, i64 %indvars.iv.next18
  store double %26, double* %27, align 8
  %exitcond19.1 = icmp eq i64 %indvars.iv.next18.1, 1200
  br i1 %exitcond19.1, label %28, label %15
...
.preheader:                                       ; preds = %.preheader.preheader, %37
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %37 ], [ 0, %.preheader.preheader ]
  br label %29
...
; <label>:29:                                     ; preds = %29, %.preheader
  ...
  %36 = getelementptr inbounds [1100 x double], [1100 x double]* %4, i64 %indvars.iv14, i64 %indvars.iv
...
; <label>:37:                                     ; preds = %29
  ...
  br i1 %exitcond16, label %38, label %.preheader
...
.preheader4:                                      ; preds = %58, %5
  %indvars.iv13 = phi i64 [ 0, %5 ], [ %6, %58 ]
...
; <label>:7:                                      ; preds = %7, %.preheader4
  %indvars.iv = phi i64 [ 0, %.preheader4 ], [ %indvars.iv.next.4, %7 ]
  %8 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv13, i64 %indvars.iv
  %9 = load double, double* %8, align 8
  %10 = fmul double %9, %1
  store double %10, double* %8, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %11 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv13, i64 %indvars.iv.next
  %12 = load double, double* %11, align 8
  %13 = fmul double %12, %1
  store double %13, double* %11, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %14 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv13, i64 %indvars.iv.next.1
  %15 = load double, double* %14, align 8
  %16 = fmul double %15, %1
  store double %16, double* %14, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %17 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv13, i64 %indvars.iv.next.2
  %18 = load double, double* %17, align 8
  %19 = fmul double %18, %1
  store double %19, double* %17, align 8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %20 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv13, i64 %indvars.iv.next.3
...
.preheader:                                       ; preds = %.preheader.preheader, %middle.block
  %indvars.iv11 = phi i64 [ %23, %middle.block ], [ 0, %.preheader.preheader ]
  ...
  %24 = getelementptr inbounds [1200 x double], [1200 x double]* %3, i64 %indvars.iv13, i64 %indvars.iv11
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %29 = getelementptr inbounds [1100 x double], [1100 x double]* %4, i64 %indvars.iv11, i64 %offset.idx
  ...
  %32 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv13, i64 %offset.idx
  ...
  %37 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv13, i64 %35
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %43 = fmul double %42, %0
  %44 = getelementptr inbounds [1100 x double], [1100 x double]* %4, i64 %indvars.iv11, i64 %indvars.iv9
  %45 = load double, double* %44, align 8
  %46 = fmul double %43, %45
  %47 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv13, i64 %indvars.iv9
  ...
  %51 = fmul double %50, %0
  %52 = getelementptr inbounds [1100 x double], [1100 x double]* %4, i64 %indvars.iv11, i64 %indvars.iv.next10
  %53 = load double, double* %52, align 8
  %54 = fmul double %51, %53
  %55 = getelementptr inbounds [1100 x double], [1100 x double]* %2, i64 %indvars.iv13, i64 %indvars.iv.next10
...
.preheader:                                       ; preds = %18, %1
  %indvars.iv4 = phi i64 [ 0, %1 ], [ %indvars.iv.next5, %18 ]
...
._crit_edge:                                      ; preds = %7, %12
  ...
  %15 = getelementptr inbounds [1100 x double], [1100 x double]* %0, i64 %indvars.iv4, i64 %indvars.iv
