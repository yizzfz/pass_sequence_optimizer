...
.preheader8:                                      ; preds = %._crit_edge44, %4
  %15 = phi [1000 x double]* [ %1, %4 ], [ %168, %._crit_edge44 ]
  %16 = phi i32 [ 1, %4 ], [ %173, %._crit_edge44 ]
  %17 = phi [1000 x double]* [ %2, %4 ], [ %138, %._crit_edge44 ]
  br label %.lr.ph

.lver.check:                                      ; preds = %50, %.lr.ph43.split.us.preheader
  %indvar = phi i64 [ 0, %.lr.ph43.split.us.preheader ], [ %18, %50 ]
  %indvars.iv16 = phi i64 [ 1, %.lr.ph43.split.us.preheader ], [ %indvars.iv.next17, %50 ]
  %18 = add i64 %indvar, 1
  %scevgep = getelementptr [1000 x double], [1000 x double]* %138, i64 %18, i64 0
  %scevgep47 = getelementptr [1000 x double], [1000 x double]* %138, i64 %18, i64 999
  %scevgep49 = getelementptr [1000 x double], [1000 x double]* %133, i64 %18, i64 0
  %scevgep51 = getelementptr [1000 x double], [1000 x double]* %133, i64 %18, i64 999
...
.ph.lver.orig:                                    ; preds = %.ph.lver.orig.preheader, %.ph.lver.orig
  ...
  br i1 %exitcond13.lver.orig, label %._crit_edge42.us.loopexit, label %.ph.lver.orig

.ph:                                              ; preds = %.lver.check
  %load_initial = load double, double* %scevgep, align 8
  %load_initial55 = load double, double* %scevgep49, align 8
  br label %68

; <label>:50:                                     ; preds = %51
  %exitcond35 = icmp eq i64 %indvars.iv.next17, 999
  br i1 %exitcond35, label %._crit_edge44, label %.lver.check

; <label>:51:                                     ; preds = %51, %._crit_edge42.us
  %indvars.iv14 = phi i64 [ 998, %._crit_edge42.us ], [ %indvars.iv.next15.1, %51 ]
  %52 = phi double [ 1.000000e+00, %._crit_edge42.us ], [ %65, %51 ]
...
; <label>:68:                                     ; preds = %68, %.ph
  %store_forwarded56 = phi double [ %load_initial55, %.ph ], [ %86, %68 ]
  ...
  %84 = fmul double %114, %store_forwarded56
  ...
  br i1 %exitcond13, label %._crit_edge42.us.loopexit57, label %68

._crit_edge42.us.loopexit:                        ; preds = %.ph.lver.orig
  br label %._crit_edge42.us

._crit_edge42.us.loopexit57:                      ; preds = %68
  br label %._crit_edge42.us

._crit_edge42.us:                                 ; preds = %._crit_edge42.us.loopexit57, %._crit_edge42.us.loopexit
...
.lr.ph:                                           ; preds = %..lr.ph_crit_edge, %.preheader8
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %..lr.ph_crit_edge ], [ 1, %.preheader8 ]
  %89 = phi [1000 x double]* [ %.pre, %..lr.ph_crit_edge ], [ %15, %.preheader8 ]
  %90 = phi [1000 x double]* [ %138, %..lr.ph_crit_edge ], [ %17, %.preheader8 ]
  ...
  %.pre53 = load double, double* %9, align 8
  %.pre54 = load double, double* %10, align 8
  br label %101

; <label>:101:                                    ; preds = %101, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %101 ], [ 1, %.lr.ph ]
  %102 = phi double [ %142, %101 ], [ %.pre54, %.lr.ph ]
  %103 = phi double [ %132, %101 ], [ %.pre53, %.lr.ph ]
...
; <label>:164:                                    ; preds = %147
  ...
  br i1 %165, label %..lr.ph_crit_edge, label %.lr.ph43.split.us.preheader

.lr.ph43.split.us.preheader:                      ; preds = %164
...
._crit_edge44:                                    ; preds = %50
  %172 = icmp sgt i32 %16, 499
  %173 = add nuw nsw i32 %16, 1
  br i1 %172, label %174, label %.preheader8

; <label>:174:                                    ; preds = %._crit_edge44
  ret void
}
