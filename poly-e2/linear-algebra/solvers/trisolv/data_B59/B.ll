...
for.end:                                          ; preds = %for.body6.prol.loopexit, %for.end.unr-lcssa
  ...
  %exitcond11 = icmp eq i64 %indvars.iv.next9, %1
  br i1 %exitcond11, label %for.end16.loopexit, label %for.body6.lr.ph
...
for.body:                                         ; preds = %for.end, %for.body.preheader
  ...
  %1 = add nuw i64 %indvars.iv6, 4294967295
...
for.end:                                          ; preds = %for.end.loopexit, %for.body
  ...
  %exitcond8 = icmp eq i64 %indvars.iv.next7, %0
  br i1 %exitcond8, label %for.end24.loopexit, label %for.body
