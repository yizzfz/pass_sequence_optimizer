...
.preheader:                                       ; preds = %15, %1
  %indvars.iv12 = phi i64 [ 0, %1 ], [ %indvars.iv.next13, %15 ]
  br label %._crit_edge11

._crit_edge11:                                    ; preds = %._crit_edge11, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %._crit_edge11 ]
  %2 = mul nuw nsw i64 %indvars.iv12, %indvars.iv
  %3 = trunc i64 %2 to i32
  %4 = srem i32 %3, 7
  %5 = add nsw i32 %4, 1
  %6 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv12, i64 %indvars.iv
  %7 = add nuw nsw i64 %indvars.iv, %indvars.iv12
  ...
  %. = select i1 %or.cond3, i32 999, i32 %5
  store i32 %., i32* %6, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 2800
  br i1 %exitcond, label %15, label %._crit_edge11
...
.preheader1:                                      ; preds = %41, %1
  %indvars.iv6 = phi i64 [ 0, %1 ], [ %indvars.iv.next7, %41 ]
  %scevgep4 = getelementptr [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv6, i64 0
  %2 = add nuw nsw i64 %indvars.iv6, 1
  %scevgep6 = getelementptr [2800 x i32], [2800 x i32]* %0, i64 %2, i64 0
  br label %.preheader

.preheader:                                       ; preds = %middle.block, %.preheader1
  %indvars.iv4 = phi i64 [ 0, %.preheader1 ], [ %indvars.iv.next5, %middle.block ]
  %scevgep = getelementptr [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv4, i64 0
  %3 = add nuw nsw i64 %indvars.iv4, 1
  %scevgep2 = getelementptr [2800 x i32], [2800 x i32]* %0, i64 %3, i64 0
  %4 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv4, i64 %indvars.iv6
  %bound0 = icmp ult i32* %scevgep, %4
  %bound1 = icmp ult i32* %4, %scevgep2
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %5 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv4, i64 %index
  %6 = bitcast i32* %5 to <4 x i32>*
  %wide.load = load <4 x i32>, <4 x i32>* %6, align 4, !alias.scope !1, !noalias !4
  %7 = getelementptr i32, i32* %5, i64 4
  %8 = bitcast i32* %7 to <4 x i32>*
  %wide.load13 = load <4 x i32>, <4 x i32>* %8, align 4, !alias.scope !1, !noalias !4
  ...
  %14 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv6, i64 %index
  %15 = bitcast i32* %14 to <4 x i32>*
  %wide.load14 = load <4 x i32>, <4 x i32>* %15, align 4, !alias.scope !8
  %16 = getelementptr i32, i32* %14, i64 4
  %17 = bitcast i32* %16 to <4 x i32>*
  %wide.load15 = load <4 x i32>, <4 x i32>* %17, align 4, !alias.scope !8
  %18 = add nsw <4 x i32> %wide.load14, %11
  %19 = add nsw <4 x i32> %wide.load15, %13
  %20 = icmp slt <4 x i32> %wide.load, %18
  %21 = icmp slt <4 x i32> %wide.load13, %19
  %22 = select <4 x i1> %20, <4 x i32> %wide.load, <4 x i32> %18
  %23 = select <4 x i1> %21, <4 x i32> %wide.load13, <4 x i32> %19
  ...
  br i1 %26, label %middle.block.loopexit16, label %vector.body, !llvm.loop !9

scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader
  %indvars.iv = phi i64 [ 0, %scalar.ph.preheader ], [ %indvars.iv.next.1, %scalar.ph ]
  %27 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv4, i64 %indvars.iv
  %28 = load i32, i32* %27, align 4
  %29 = load i32, i32* %4, align 4
  %30 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv6, i64 %indvars.iv
  ...
  %34 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv4, i64 %indvars.iv.next
  %35 = load i32, i32* %34, align 4
  %36 = load i32, i32* %4, align 4
  %37 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv6, i64 %indvars.iv.next
...
middle.block.loopexit16:                          ; preds = %vector.body
  br label %middle.block

middle.block:                                     ; preds = %middle.block.loopexit16, %middle.block.loopexit
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1
  %exitcond8 = icmp eq i64 %indvars.iv.next5, 2800
  br i1 %exitcond8, label %41, label %.preheader

; <label>:41:                                     ; preds = %middle.block
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %exitcond9 = icmp eq i64 %indvars.iv.next7, 2800
  br i1 %exitcond9, label %42, label %.preheader1
...
.preheader:                                       ; preds = %17, %1
  ...
  %6 = mul nuw nsw i64 %indvars.iv2, 2800
...
._crit_edge:                                      ; preds = %._crit_edge1, %11
  ...
  %14 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv2, i64 %indvars.iv
...
; <label>:17:                                     ; preds = %._crit_edge
  ...
  %exitcond4 = icmp eq i64 %indvars.iv.next3, 2800
