...
.preheader3.us..preheader.us.us_crit_edge:        ; preds = %.loopexit7.us, %.preheader3.lr.ph..preheader3.us_crit_edge
  ...
  %scevgep43 = getelementptr [2800 x i32], [2800 x i32]* %1, i64 %indvars.iv35, i64 0
...
.loopexit7.us:                                    ; preds = %.loopexit.us.us
  ...
  %exitcond39 = icmp eq i64 %indvars.iv.next36, 2800
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load53 = load <4 x i32>, <4 x i32>* %15, align 4, !alias.scope !8
  %16 = getelementptr i32, i32* %14, i64 4
  %17 = bitcast i32* %16 to <4 x i32>*
  %wide.load54 = load <4 x i32>, <4 x i32>* %17, align 4, !alias.scope !8
  %18 = add nsw <4 x i32> %wide.load53, %11
  %19 = add nsw <4 x i32> %wide.load54, %13
  %20 = icmp slt <4 x i32> %wide.load, %18
  %21 = icmp slt <4 x i32> %wide.load52, %19
  %22 = select <4 x i1> %20, <4 x i32> %wide.load, <4 x i32> %18
  %23 = select <4 x i1> %21, <4 x i32> %wide.load52, <4 x i32> %19
  ...
  br i1 %26, label %.loopexit.us.us.loopexit55, label %vector.body, !llvm.loop !9
...
scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader
  ...
  %exitcond38.1 = icmp eq i64 %indvars.iv.next, 2799
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  br i1 %exitcond38.1, label %.loopexit.us.us.loopexit, label %scalar.ph, !llvm.loop !12
