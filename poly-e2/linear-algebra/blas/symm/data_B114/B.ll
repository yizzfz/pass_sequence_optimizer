...
for.inc48.prol.loopexit:                          ; preds = %for.inc48.prol.loopexit.loopexit, %for.inc48.lr.ph
  %indvars.iv48.unr = phi i64 [ %indvars.iv55, %for.inc48.lr.ph ], [ %indvars.iv.next49.prol, %for.inc48.prol.loopexit.loopexit ]
  %16 = icmp ult i32 %8, 7
...
min.iters.checked:                                ; preds = %for.inc48.preheader
  ...
  br i1 %cmp.zero, label %for.inc48.preheader73, label %vector.body.preheader
...
for.inc48:                                        ; preds = %for.inc48.preheader73, %for.inc48
  %indvars.iv48 = phi i64 [ %indvars.iv.next49.7, %for.inc48 ], [ %indvars.iv48.ph, %for.inc48.preheader73 ]
