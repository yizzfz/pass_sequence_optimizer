...
init_array.exit:                                  ; preds = %.init_array.exit_crit_edge, %.init_array.exit_crit_edge140
...
._crit_edge23.preheader:                          ; preds = %middle.block101, %vector.memcheck121, %min.iters.checked105.._crit_edge23_crit_edge, %.lr.ph1.us.._crit_edge23_crit_edge
...
._crit_edge4.us:                                  ; preds = %middle.block64.._crit_edge4.us_crit_edge, %._crit_edge.us.._crit_edge4.us_crit_edge, %._crit_edge4.us.loopexit
  %60 = add nsw i32 %35, 1
  %61 = icmp slt i32 %60, 500
  br i1 %61, label %.lr.ph1.us, label %.kernel_jacobi_1d.exit_crit_edge.loopexit

.lr.ph3.us:                                       ; preds = %.lr.ph3.us.preheader146.new, %.lr.ph3.us
...
.lr.ph3.us.preheader146:                          ; preds = %middle.block64, %vector.memcheck82, %min.iters.checked67..lr.ph3.us_crit_edge, %.lr.ph3.us.preheader..lr.ph3.us_crit_edge
...
.lr.ph3.us.prol.loopexit.unr-lcssa:               ; preds = %.lr.ph3.us.prol, %.lr.ph3.us.preheader146
...
._crit_edge24.prol.loopexit.unr-lcssa:            ; preds = %._crit_edge24.prol, %._crit_edge24.preheader
...
._crit_edge4.us16.loopexit:                       ; preds = %._crit_edge4.us16.loopexit.unr-lcssa, %._crit_edge24.prol.loopexit
...
.kernel_jacobi_1d.exit_crit_edge:                 ; preds = %.kernel_jacobi_1d.exit_crit_edge.loopexit, %.lr.ph7.split.split..kernel_jacobi_1d.exit_crit_edge_crit_edge, %._crit_edge4.us16..kernel_jacobi_1d.exit_crit_edge_crit_edge
  br label %kernel_jacobi_1d.exit

kernel_jacobi_1d.exit:                            ; preds = %.kernel_jacobi_1d.exit_crit_edge, %init_array.exit.kernel_jacobi_1d.exit_crit_edge
...
._crit_edge26:                                    ; preds = %146, %._crit_edge27
...
kernel_jacobi_1d.exit._crit_edge:                 ; preds = %print_array.exit, %133, %kernel_jacobi_1d.exit
