...
._crit_edge.prol.loopexit:                        ; preds = %._crit_edge.prol.loopexit.unr-lcssa
  br i1 %5, label %._crit_edge.us, label %.preheader.us.new
...
.preheader3:                                      ; preds = %._crit_edge6, %.preheader3.lr.ph
  %.027 = phi i32 [ 0, %.preheader3.lr.ph ], [ %31, %._crit_edge6 ]
...
.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge
  %indvar = phi i64 [ %8, %._crit_edge ], [ 0, %.preheader.preheader ]
  ...
  %.phi.trans.insert = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %9, i64 0
  %.pre = load double, double* %.phi.trans.insert, align 8
  %.phi.trans.insert15 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %9, i64 1
  %.pre16 = load double, double* %.phi.trans.insert15, align 8
  %.phi.trans.insert17 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv9, i64 1
  %.pre18 = load double, double* %.phi.trans.insert17, align 8
  %.phi.trans.insert19 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next10, i64 0
  %.pre20 = load double, double* %.phi.trans.insert19, align 8
  %.phi.trans.insert21 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next10, i64 1
  %.pre22 = load double, double* %.phi.trans.insert21, align 8
  br label %._crit_edge14

._crit_edge14:                                    ; preds = %._crit_edge14, %.preheader
  %10 = phi double [ %.pre22, %.preheader ], [ %28, %._crit_edge14 ]
  %11 = phi double [ %.pre20, %.preheader ], [ %10, %._crit_edge14 ]
  %12 = phi double [ %.pre18, %.preheader ], [ %23, %._crit_edge14 ]
  %13 = phi double [ %.pre16, %.preheader ], [ %17, %._crit_edge14 ]
  %14 = phi double [ %.pre, %.preheader ], [ %13, %._crit_edge14 ]
  %store_forwarded = phi double [ %load_initial, %.preheader ], [ %30, %._crit_edge14 ]
  ...
  %21 = fadd double %19, %12
  %22 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv9, i64 %indvars.iv.next
  %23 = load double, double* %22, align 8
  %24 = fadd double %21, %23
  %25 = fadd double %24, %11
  %26 = fadd double %25, %10
  %27 = getelementptr inbounds [2000 x double], [2000 x double]* %2, i64 %indvars.iv.next10, i64 %indvars.iv.next
