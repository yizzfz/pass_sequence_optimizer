...
for.inc:                                          ; preds = %for.inc, %for.cond1.preheader
  %indvars.iv55 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next56, %for.inc ]
  %1 = add nuw nsw i64 %indvars.iv55, %indvars.iv60
  ...
  br i1 %exitcond59, label %for.inc16, label %for.inc

for.inc16:                                        ; preds = %for.inc
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  %exitcond63 = icmp eq i64 %indvars.iv.next61, 1000
  br i1 %exitcond63, label %for.inc36.lr.ph.preheader, label %for.cond1.preheader
...
for.inc36.lr.ph:                                  ; preds = %for.inc36.lr.ph.preheader, %for.inc51
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc51 ], [ 0, %for.inc36.lr.ph.preheader ]
...
for.inc48.lr.ph:                                  ; preds = %for.cond40.preheader
  ...
  br i1 %lcmp.mod48, label %for.inc48.prol.loopexit, label %for.inc48.prol.preheader
...
for.inc48.prol:                                   ; preds = %for.inc48.prol.preheader, %for.inc48.prol
  %indvars.iv45.prol = phi i64 [ %indvars.iv.next46.prol, %for.inc48.prol ], [ %indvars.iv51, %for.inc48.prol.preheader ]
  %prol.iter = phi i32 [ %prol.iter.sub, %for.inc48.prol ], [ %xtraiter47, %for.inc48.prol.preheader ]
...
for.inc48.prol.loopexit:                          ; preds = %for.inc48.prol.loopexit.loopexit, %for.inc48.lr.ph
  %indvars.iv45.unr = phi i64 [ %indvars.iv51, %for.inc48.lr.ph ], [ %indvars.iv.next46.prol, %for.inc48.prol.loopexit.loopexit ]
  %10 = trunc i64 %6 to i32
  %11 = icmp ult i32 %10, 7
  br i1 %11, label %for.inc51, label %for.inc48.preheader

for.inc48.preheader:                              ; preds = %for.inc48.prol.loopexit
  %12 = sub i64 992, %indvars.iv45.unr
  %13 = lshr i64 %12, 3
  %14 = add nuw nsw i64 %13, 1
  %min.iters.check = icmp ult i64 %14, 2
  br i1 %min.iters.check, label %for.inc48.preheader65, label %min.iters.checked

for.inc48.preheader65:                            ; preds = %middle.block, %min.iters.checked, %for.inc48.preheader
  %indvars.iv45.ph = phi i64 [ %indvars.iv45.unr, %min.iters.checked ], [ %indvars.iv45.unr, %for.inc48.preheader ], [ %ind.end, %middle.block ]
  br label %for.inc48
...
min.iters.checked:                                ; preds = %for.inc48.preheader
  ...
  %15 = add i64 %indvars.iv45.unr, 8
  %16 = shl nuw i64 %13, 3
  %17 = add i64 %15, %16
  %18 = shl nuw nsw i64 %n.mod.vf, 3
  %ind.end = sub i64 %17, %18
  br i1 %cmp.zero, label %for.inc48.preheader65, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %19 = shl i64 %index, 3
  %20 = add i64 %indvars.iv45.unr, %19
  %21 = add nsw i64 %20, 7
  %22 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv53, i64 %21
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.inc51, label %for.inc48.preheader65
...
for.inc36:                                        ; preds = %for.inc36.preheader, %for.inc36
  ...
  %26 = add nuw nsw i64 %indvars.iv, %indvars.iv53
  ...
  %28 = add nuw nsw i64 %indvars.iv.next, %indvars.iv53
...
for.inc48:                                        ; preds = %for.inc48.preheader65, %for.inc48
  %indvars.iv45 = phi i64 [ %indvars.iv.next46.7, %for.inc48 ], [ %indvars.iv45.ph, %for.inc48.preheader65 ]
...
entry:
  ...
  %broadcast.splatinsert67 = insertelement <2 x double> undef, double %beta, i32 0
  %broadcast.splat68 = shufflevector <2 x double> %broadcast.splatinsert67, <2 x double> undef, <2 x i32> zeroinitializer
  %broadcast.splatinsert71 = insertelement <2 x double> undef, double %alpha, i32 0
  %broadcast.splat72 = shufflevector <2 x double> %broadcast.splatinsert71, <2 x double> undef, <2 x i32> zeroinitializer
  %broadcast.splatinsert73 = insertelement <2 x double> undef, double %mul44, i32 0
...
for.cond1.preheader:                              ; preds = %for.inc53, %entry
  ...
  %scevgep = getelementptr [1200 x double], [1200 x double]* %C, i64 %indvars.iv48, i64 0
  %0 = add i64 %indvars.iv48, 1
  %scevgep55 = getelementptr [1200 x double], [1200 x double]* %C, i64 %0, i64 0
...
vector.memcheck:                                  ; preds = %for.cond1.preheader
  %scevgep59 = getelementptr [1200 x double], [1200 x double]* %B, i64 %0, i64 0
  %scevgep57 = getelementptr [1200 x double], [1200 x double]* %B, i64 %indvars.iv48, i64 0
  %bound0 = icmp ult double* %scevgep, %scevgep59
  %bound1 = icmp ult double* %scevgep57, %scevgep55
  %found.conflict = and i1 %bound0, %bound1
  %bound062 = icmp ult double* %scevgep, %arrayidx41
  %bound163 = icmp ult double* %arrayidx41, %scevgep55
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv48, i64 %index
  ...
  %wide.load66 = load <2 x double>, <2 x double>* %4, align 8, !alias.scope !8, !noalias !11
  %5 = fmul <2 x double> %wide.load, %broadcast.splat68
  %6 = fmul <2 x double> %wide.load66, %broadcast.splat68
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %B, i64 %indvars.iv48, i64 %index
  %8 = bitcast double* %7 to <2 x double>*
  %wide.load69 = load <2 x double>, <2 x double>* %8, align 8, !alias.scope !14
  %9 = getelementptr double, double* %7, i64 2
  %10 = bitcast double* %9 to <2 x double>*
  %wide.load70 = load <2 x double>, <2 x double>* %10, align 8, !alias.scope !14
  %11 = fmul <2 x double> %wide.load69, %broadcast.splat72
  %12 = fmul <2 x double> %wide.load70, %broadcast.splat72
  ...
  %22 = fadd <2 x double> %broadcast.splat74, %20
  %23 = fadd <2 x double> %broadcast.splat74, %21
  ...
  br i1 %26, label %for.inc53.loopexit78, label %vector.body, !llvm.loop !16

for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.cond4.for.inc50_crit_edge.us
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.cond4.for.inc50_crit_edge.us ], [ 0, %for.cond4.preheader.us.preheader ]
...
for.inc.us:                                       ; preds = %for.inc.us, %for.cond4.preheader.us
  %indvars.iv40 = phi i64 [ 0, %for.cond4.preheader.us ], [ %indvars.iv.next41, %for.inc.us ]
  ...
  br i1 %exitcond44, label %for.cond4.for.inc50_crit_edge.us, label %for.inc.us
...
for.cond4.preheader:                              ; preds = %for.cond4.preheader, %for.cond4.preheader.preheader
  ...
  br i1 %exitcond.1, label %for.inc53.loopexit77, label %for.cond4.preheader, !llvm.loop !17

for.inc53.loopexit:                               ; preds = %for.cond4.for.inc50_crit_edge.us
  br label %for.inc53

for.inc53.loopexit77:                             ; preds = %for.cond4.preheader
  br label %for.inc53

for.inc53.loopexit78:                             ; preds = %vector.body
  br label %for.inc53

for.inc53:                                        ; preds = %for.inc53.loopexit78, %for.inc53.loopexit77, %for.inc53.loopexit
