...
.preheader27.us:                                  ; preds = %._crit_edge31.us..preheader27.us_crit_edge, %.preheader27.us.preheader
  %indvars.iv55 = phi i64 [ 0, %.preheader27.us.preheader ], [ %indvars.iv.next56, %._crit_edge31.us..preheader27.us_crit_edge ]
  %indvars.iv44 = phi i64 [ 1, %.preheader27.us.preheader ], [ %indvars.iv.next45, %._crit_edge31.us..preheader27.us_crit_edge ]
...
.preheader.us34.prol.loopexit:                    ; preds = %.preheader.us34.prol.loopexit.loopexit, %.preheader.us34.preheader
  ...
  br i1 %12, label %._crit_edge31.us, label %.preheader.us34.preheader62

.preheader.us34.preheader62:                      ; preds = %.preheader.us34.prol.loopexit
  %27 = sub nsw i64 %16, %indvars.iv.unr
  %28 = lshr i64 %27, 2
  %29 = add nuw nsw i64 %28, 1
  %min.iters.check = icmp ult i64 %29, 2
  br i1 %min.iters.check, label %.preheader.us34.preheader70, label %min.iters.checked

min.iters.checked:                                ; preds = %.preheader.us34.preheader62
  ...
  br i1 %cmp.zero, label %.preheader.us34.preheader70, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %34 = shl i64 %index, 2
  %offset.idx = add i64 %indvars.iv.unr, %34
  %35 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv55, i64 %offset.idx
  %36 = bitcast double* %35 to <8 x double>*
  %wide.vec = load <8 x double>, <8 x double>* %36, align 8
  ...
  %37 = fmul <2 x double> %strided.vec, %broadcast.splat69
  %38 = fmul <2 x double> %strided.vec65, %broadcast.splat69
  %39 = fmul <2 x double> %strided.vec66, %broadcast.splat69
  %40 = add nsw i64 %offset.idx, 3
  %41 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv55, i64 %40
  %42 = fmul <2 x double> %strided.vec67, %broadcast.splat69
  %43 = getelementptr double, double* %41, i64 -3
  %44 = bitcast double* %43 to <8 x double>*
  %45 = shufflevector <2 x double> %37, <2 x double> %38, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %46 = shufflevector <2 x double> %39, <2 x double> %42, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %interleaved.vec = shufflevector <4 x double> %45, <4 x double> %46, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 1, i32 3, i32 5, i32 7>
  store <8 x double> %interleaved.vec, <8 x double>* %44, align 8
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %._crit_edge31.us, label %.preheader.us34.preheader70

.preheader.us34.preheader70:                      ; preds = %middle.block, %min.iters.checked, %.preheader.us34.preheader62
  %indvars.iv.ph = phi i64 [ %ind.end, %middle.block ], [ %indvars.iv.unr, %min.iters.checked ], [ %indvars.iv.unr, %.preheader.us34.preheader62 ]
  br label %.preheader.us34

.preheader.us34:                                  ; preds = %.preheader.us34.preheader70, %.preheader.us34
  %indvars.iv = phi i64 [ %indvars.iv.next.3, %.preheader.us34 ], [ %indvars.iv.ph, %.preheader.us34.preheader70 ]
  %48 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv55, i64 %indvars.iv
  %49 = load double, double* %48, align 8
  %50 = fmul double %49, %2
  store double %50, double* %48, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %51 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv55, i64 %indvars.iv.next
  %52 = load double, double* %51, align 8
  %53 = fmul double %52, %2
  store double %53, double* %51, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %54 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv55, i64 %indvars.iv.next.1
  %55 = load double, double* %54, align 8
  %56 = fmul double %55, %2
  store double %56, double* %54, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %57 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv55, i64 %indvars.iv.next.2
  %58 = load double, double* %57, align 8
  %59 = fmul double %58, %2
  store double %59, double* %57, align 8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %exitcond.3 = icmp eq i64 %indvars.iv.next.3, %wide.trip.count54
  br i1 %exitcond.3, label %._crit_edge31.us.loopexit71, label %.preheader.us34, !llvm.loop !6

._crit_edge31.us.loopexit:                        ; preds = %._crit_edge.us.us
  br label %._crit_edge31.us

._crit_edge31.us.loopexit71:                      ; preds = %.preheader.us34
  br label %._crit_edge31.us

._crit_edge31.us:                                 ; preds = %._crit_edge31.us.loopexit71, %._crit_edge31.us.loopexit, %middle.block, %.preheader.us34.prol.loopexit
  %exitcond58 = icmp eq i64 %indvars.iv.next56, %wide.trip.count48.1
  br i1 %exitcond58, label %._crit_edge33.loopexit, label %._crit_edge31.us..preheader27.us_crit_edge
...
.preheader.us.us:                                 ; preds = %._crit_edge.us.us, %.preheader.us.us.preheader
  %indvars.iv52 = phi i64 [ 0, %.preheader.us.us.preheader ], [ %indvars.iv.next53, %._crit_edge.us.us ]
  %60 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv55, i64 %indvars.iv52
  br i1 %lcmp.mod50, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.preheader.us.us
  %61 = load double, double* %23, align 8
  %62 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv44, i64 %indvars.iv52
...
.prol.loopexit:                                   ; preds = %.preheader.us.us, %.prol.preheader
  %indvars.iv46.unr.ph = phi i64 [ %indvars.iv.next47.prol, %.prol.preheader ], [ %indvars.iv44, %.preheader.us.us ]
  %.pre64 = load double, double* %60, align 8
...
._crit_edge.us.us:                                ; preds = %._crit_edge.us.us.loopexit, %.prol.loopexit
  %67 = phi double [ %.pre64, %.prol.loopexit ], [ %81, %._crit_edge.us.us.loopexit ]
  %68 = fmul double %67, %2
...
.preheader.us.us.new:                             ; preds = %.preheader.us.us.new.preheader, %.preheader.us.us.new
  %69 = phi double [ %81, %.preheader.us.us.new ], [ %.pre64, %.preheader.us.us.new.preheader ]
  %indvars.iv46 = phi i64 [ %indvars.iv.next47.1, %.preheader.us.us.new ], [ %indvars.iv46.unr.ph, %.preheader.us.us.new.preheader ]
  %70 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv46, i64 %indvars.iv55
  %71 = load double, double* %70, align 8
  %72 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv46, i64 %indvars.iv52
  %73 = load double, double* %72, align 8
  %74 = fmul double %71, %73
  %75 = fadd double %69, %74
  store double %75, double* %60, align 8
  %indvars.iv.next47 = add nuw nsw i64 %indvars.iv46, 1
  %76 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv.next47, i64 %indvars.iv55
  %77 = load double, double* %76, align 8
  %78 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv.next47, i64 %indvars.iv52
  %79 = load double, double* %78, align 8
  %80 = fmul double %77, %79
  %81 = fadd double %75, %80
  store double %81, double* %60, align 8
