...
for.inc.us:                                       ; preds = %for.body.us, %for.inc.us
  ...
  br i1 %exitcond10.1, label %for.cond35.for.cond.loopexit_crit_edge.us, label %for.inc.us
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc20_crit_edge.us, %entry
  %indvars.iv35 = phi i64 [ 0, %entry ], [ %indvars.iv.next36, %for.cond1.for.inc20_crit_edge.us ]
  %sunkaddr1 = shl nuw nsw i64 %indvars.iv35, 3
...
for.inc.us:                                       ; preds = %for.cond1.preheader.us, %for.inc.us
  ...
  %exitcond43.1 = icmp eq i64 %indvars.iv.next32.1, 2000
  br i1 %exitcond43.1, label %for.cond1.for.inc20_crit_edge.us, label %for.inc.us

for.cond1.for.inc20_crit_edge.us:                 ; preds = %for.inc.us
  %indvars.iv.next36 = add nuw nsw i64 %indvars.iv35, 1
  %exitcond44 = icmp eq i64 %indvars.iv.next36, 2000
  br i1 %exitcond44, label %for.cond26.preheader.us.preheader, label %for.cond1.preheader.us
...
for.cond26.preheader.us:                          ; preds = %for.cond26.preheader.us.preheader, %for.cond26.for.inc45_crit_edge.us
  ...
  %sunkaddr9 = shl nuw nsw i64 %indvars.iv27, 3
...
for.inc42.us:                                     ; preds = %for.cond26.preheader.us, %for.inc42.us
  ...
  %exitcond41.1 = icmp eq i64 %indvars.iv.next24.1, 2000
  br i1 %exitcond41.1, label %for.cond26.for.inc45_crit_edge.us, label %for.inc42.us

for.cond26.for.inc45_crit_edge.us:                ; preds = %for.inc42.us
  %indvars.iv.next28 = add nuw nsw i64 %indvars.iv27, 1
  %exitcond42 = icmp eq i64 %indvars.iv.next28, 2000
  br i1 %exitcond42, label %vector.memcheck, label %for.cond26.preheader.us
...
for.cond64.preheader.us:                          ; preds = %for.cond64.preheader.us.preheader, %for.cond64.for.inc83_crit_edge.us
  ...
  %.pre54 = load double, double* %arrayidx68.us, align 8
  %sunkaddr13 = shl nuw nsw i64 %indvars.iv15, 3
...
for.inc80.us:                                     ; preds = %for.cond64.preheader.us, %for.inc80.us
  %34 = phi double [ %add77.us.1, %for.inc80.us ], [ %.pre54, %for.cond64.preheader.us ]
  ...
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond39.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond39.1, label %for.cond64.for.inc83_crit_edge.us, label %for.inc80.us
...
for.inc58:                                        ; preds = %for.inc58.preheader, %for.inc58
  ...
  %exitcond40.3 = icmp eq i64 %indvars.iv.next20.3, 2000
  br i1 %exitcond40.3, label %for.cond64.preheader.us.preheader.loopexit, label %for.inc58, !llvm.loop !9
