...
@__PRETTY_FUNCTION__.get_side_info = private unnamed_addr constant [28 x i8] c"MYSideInfo *get_side_info()\00", align 1
...
@__llvm_prf_nm = private constant [212 x i8] c"\CA\03\D0\01x\DA}PMk\C2@\10%\7FH\E8\D5\A3\B4\8BBZ\84\1Cz\5C\06\F6E\97\EE\87\9D\9D\10\EA\AF7\13u5 =\BE\8Fy\F3fv\C9\8B\C9\1CI6^:aPl6\C6N\A0\CC\C00E4\12Oo\AB\10\D6E2\C3\16\EF`}\EAs\E5#\F9d\1D\09=\9C\EA\F9\1D0\C0\22 \22I\D1\5C\13\86r\AC\E1\D5\FD\CD^\F09\85\BCO\19*W\A5g\DC\16\CEas\C8\9EXZ\A4\83\1C\15%\8CJlsp`%\BE0^\81\E1\1C\EB.\F5\A8\DAfr\FF\C8\E4\DC\C7\B5\AF\22F\F1g,\E3\B5\D1\92\D1\99$\FCWK\8Fz\8Ez\EE'-\95\17\0F\AC\13\DD$\ED\9E\95\03\E4\85\FF\F1\16\A5m\F0\E9\E7\02>\1B\A8\E3", section "__llvm_prf_names"
@llvm.used = appending global [23 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_InitFormatBitStream to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_BF_BitstreamFrame to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_store_side_info to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_main_data to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_side_queue_elements to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_BF_FlushBitstream to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_WriteMainDataBits to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_free_side_queues to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_BF_PartLength to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_BF_newPartHolder to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_BF_NewHolderFromBitstreamPart to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_BF_LoadHolderFromBitstreamPart to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_BF_addElement to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_BF_resizePartHolder to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_BF_freePartHolder to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_BF_addEntry to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_writePartMainData to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_write_side_info to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_writePartSideInfo to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_get_side_info to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_free_side_info_link to i8*), i8* bitcast ([16 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([212 x i8], [212 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
...
; <label>:8:                                      ; preds = %0
  ...
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.13, i32 0, i32 0), i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i32 0, i32 0), i32 384, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.get_side_info, i32 0, i32 0)) #6
  unreachable
                                                  ; No predecessors!
  br label %11
