...
entry:
  ...
  call void @init_array(double* nonnull %alpha, double* nonnull %beta, [1200 x double]* %arraydecay12, [1000 x double]* %arraydecay313, [1200 x double]* %arraydecay414)
  call void (...) @polybench_timer_start() #3
  %0 = load double, double* %alpha, align 8
  %1 = load double, double* %beta, align 8
  call void @kernel_symm(double %0, double %1, [1200 x double]* %arraydecay12, [1000 x double]* %arraydecay313, [1200 x double]* %arraydecay414)
...
for.cond1.preheader.us:                           ; preds = %entry, %for.cond1.for.inc16_crit_edge.us
  %indvars.iv59.us = phi i64 [ %indvars.iv.next56.us, %for.cond1.for.inc16_crit_edge.us ], [ 0, %entry ]
  %0 = add i64 %indvars.iv59.us, 1200
...
for.cond23.preheader:                             ; preds = %for.cond23.preheader.preheader, %for.inc51
  ...
  %indvars.iv4649 = phi i64 [ %8, %for.inc51 ], [ 0, %for.cond23.preheader.preheader ]
  %6 = sub i64 999, %indvars.iv4649
  %7 = sub i64 998, %indvars.iv4649
  %8 = add i64 %indvars.iv4649, 1
...
for.inc36.prol.preheader:                         ; preds = %for.cond23.preheader
  %9 = trunc i64 %indvars.iv4649 to i32
  %rem28.prol = srem i32 %9, 100
  %conv29.prol = sitofp i32 %rem28.prol to double
  %div31.prol = fdiv double %conv29.prol, 1.000000e+03
  %arrayidx35.prol = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv4649, i64 0
...
for.inc36.prol.loopexit.unr-lcssa:                ; preds = %for.cond23.preheader, %for.inc36.prol.preheader
  ...
  %cond = icmp eq i64 %indvars.iv4649, 0
  br i1 %cond, label %for.inc48.lr.ph, label %for.inc36.preheader

for.inc36.preheader:                              ; preds = %for.inc36.prol.loopexit.unr-lcssa
  br label %for.inc36

for.cond40.preheader:                             ; preds = %for.inc36
  %exitcond4042 = icmp eq i64 %indvars.iv4649, 999
...
for.inc48.prol:                                   ; preds = %for.inc48.prol.preheader, %for.inc48.prol
  %indvars.iv.next3843.in.prol = phi i64 [ %indvars.iv.next3843.prol, %for.inc48.prol ], [ %indvars.iv4649, %for.inc48.prol.preheader ]
  ...
  %arrayidx47.prol = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv4649, i64 %indvars.iv.next3843.prol
...
for.inc48.prol.loopexit:                          ; preds = %for.inc48.prol.loopexit.loopexit, %for.inc48.lr.ph
  %indvars.iv.next3843.in.unr = phi i64 [ %indvars.iv4649, %for.inc48.lr.ph ], [ %indvars.iv.next3843.prol, %for.inc48.prol.loopexit.loopexit ]
  %10 = icmp ult i64 %7, 7
  br i1 %10, label %for.inc51, label %for.inc48.preheader

for.inc48.preheader:                              ; preds = %for.inc48.prol.loopexit
  %11 = sub i64 991, %indvars.iv.next3843.in.unr
  %12 = lshr i64 %11, 3
  %13 = add nuw nsw i64 %12, 1
  %min.iters.check = icmp ult i64 %13, 2
  br i1 %min.iters.check, label %for.inc48.preheader69, label %min.iters.checked

for.inc48.preheader69:                            ; preds = %middle.block, %min.iters.checked, %for.inc48.preheader
...
min.iters.checked:                                ; preds = %for.inc48.preheader
  ...
  %14 = add i64 %indvars.iv.next3843.in.unr, 8
  %15 = shl nuw i64 %12, 3
  %16 = add i64 %14, %15
  %17 = shl nuw nsw i64 %n.mod.vf, 3
  %ind.end = sub i64 %16, %17
  br i1 %cmp.zero, label %for.inc48.preheader69, label %vector.body.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %18 = shl i64 %index, 3
  %19 = add i64 %indvars.iv.next3843.in.unr, %18
  %20 = add nsw i64 %19, 8
  %21 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv4649, i64 %20
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.inc51, label %for.inc48.preheader69
...
for.inc36:                                        ; preds = %for.inc36.preheader, %for.inc36
  ...
  %25 = add nuw nsw i64 %indvars.iv35, %indvars.iv4649
  %26 = trunc i64 %25 to i32
  %rem28 = srem i32 %26, 100
  %conv29 = sitofp i32 %rem28 to double
  %arrayidx35 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv4649, i64 %indvars.iv35
  %indvars.iv.next = add nuw nsw i64 %indvars.iv35, 1
  %27 = add nuw nsw i64 %indvars.iv.next, %indvars.iv4649
  ...
  %indvars.iv.next.1 = add nsw i64 %indvars.iv35, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, %indvars.iv4450
  br i1 %exitcond.1, label %for.cond40.preheader, label %for.inc36

for.inc48:                                        ; preds = %for.inc48.preheader69, %for.inc48
  %indvars.iv.next3843.in = phi i64 [ %indvars.iv.next3843.7, %for.inc48 ], [ %indvars.iv.next3843.in.ph, %for.inc48.preheader69 ]
  %indvars.iv.next3843 = add nuw nsw i64 %indvars.iv.next3843.in, 1
  %arrayidx47 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv4649, i64 %indvars.iv.next3843
  store double -9.990000e+02, double* %arrayidx47, align 8
  %indvars.iv.next3843.1 = add nsw i64 %indvars.iv.next3843.in, 2
  %arrayidx47.1 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv4649, i64 %indvars.iv.next3843.1
  store double -9.990000e+02, double* %arrayidx47.1, align 8
  %indvars.iv.next3843.2 = add nsw i64 %indvars.iv.next3843.in, 3
  %arrayidx47.2 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv4649, i64 %indvars.iv.next3843.2
  store double -9.990000e+02, double* %arrayidx47.2, align 8
  %indvars.iv.next3843.3 = add nsw i64 %indvars.iv.next3843.in, 4
  %arrayidx47.3 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv4649, i64 %indvars.iv.next3843.3
  store double -9.990000e+02, double* %arrayidx47.3, align 8
  %indvars.iv.next3843.4 = add nsw i64 %indvars.iv.next3843.in, 5
  %arrayidx47.4 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv4649, i64 %indvars.iv.next3843.4
  store double -9.990000e+02, double* %arrayidx47.4, align 8
  %indvars.iv.next3843.5 = add nsw i64 %indvars.iv.next3843.in, 6
  %arrayidx47.5 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv4649, i64 %indvars.iv.next3843.5
  store double -9.990000e+02, double* %arrayidx47.5, align 8
  %indvars.iv.next3843.6 = add nsw i64 %indvars.iv.next3843.in, 7
  %arrayidx47.6 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv4649, i64 %indvars.iv.next3843.6
  store double -9.990000e+02, double* %arrayidx47.6, align 8
  %indvars.iv.next3843.7 = add nsw i64 %indvars.iv.next3843.in, 8
  %arrayidx47.7 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv4649, i64 %indvars.iv.next3843.7
...
for.cond1.preheader.us:                           ; preds = %entry, %for.cond1.for.inc53_crit_edge.us
  %indvars.iv43.us = phi i64 [ %indvars.iv.next41.us, %for.cond1.for.inc53_crit_edge.us ], [ 0, %entry ]
...
for.cond4.for.inc50_crit_edge.us.us:              ; preds = %for.inc.us.us
  ...
  br i1 %exitcond40.us, label %for.cond1.for.inc53_crit_edge.us.loopexit2, label %for.cond4.preheader.us.us
...
for.cond2.preheader.us:                           ; preds = %entry, %for.cond2.for.inc10_crit_edge.us
  %indvars.iv14.us = phi i64 [ %indvars.iv.next11.us, %for.cond2.for.inc10_crit_edge.us ], [ 0, %entry ]
  %3 = mul nsw i64 %indvars.iv14.us, 1000
  br label %for.body4.us

for.body4.us:                                     ; preds = %for.inc.us, %for.cond2.preheader.us
  %indvars.iv10.us = phi i64 [ 0, %for.cond2.preheader.us ], [ %indvars.iv.next.us, %for.inc.us ]
  %4 = add nsw i64 %indvars.iv10.us, %3
  %5 = trunc i64 %4 to i32
