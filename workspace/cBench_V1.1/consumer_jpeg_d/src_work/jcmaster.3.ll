...
@__llvm_prf_nm = private constant [117 x i8] c"\C3\01rx\DAM\8E\D1\0A\C30\08E\E9\0F\0D\FA\BA\9F\11I-u\98D\D4\F5\FB\E7BI\FB\E8=z\AE\1Fn\1CP\A0\A2\07\19\94\DE\C2\BA,Qu}\89\BC\D5H\D1\08\F6n\A0\E8~\83\1C\C0\03-\BE:\C3=e~\8C\C5K8\D1\BF\86Q\C0\E9yp\A2\F0\86A\E0\C5Xc\E6NB%2\C5\966\C3J\E9z\94\E7\A7\83\0D\DB\0F\93\12J\81", section "__llvm_prf_names"
@llvm.used = appending global [10 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jinit_c_master_control to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_prepare_for_pass to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_pass_startup to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_finish_pass_master to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_initial_setup to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_validate_script to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_select_scan_parameters to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_per_scan_setup to i8*), i8* bitcast ([41 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([117 x i8], [117 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
