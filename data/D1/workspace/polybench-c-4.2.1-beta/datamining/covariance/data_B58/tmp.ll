...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph30.split.us
  %8 = phi double [ 0.000000e+00, %.lr.ph30.split.us ], [ %20, %._crit_edge ]
  ...
  %sunkaddr102 = mul i64 %indvars.iv60, 8
...
._crit_edge27.us:                                 ; preds = %._crit_edge
  ...
  %sunkaddr97 = add i64 %6, %sunkaddr96
...
.preheader6.us:                                   ; preds = %._crit_edge22.us, %._crit_edge27.us..preheader6.us_crit_edge
  ...
  %scevgep81 = getelementptr [1200 x double], [1200 x double]* %3, i64 %22, i64 0
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.vec88 = load <8 x double>, <8 x double>* %26, align 8, !alias.scope !4, !noalias !1
  %27 = fsub <8 x double> %wide.vec88, %wide.vec
...
._crit_edge69:                                    ; preds = %._crit_edge69, %.lr.ph.us.us
  %63 = phi double [ 0.000000e+00, %.lr.ph.us.us ], [ %75, %._crit_edge69 ]
