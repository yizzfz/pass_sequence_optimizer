...
.lr.ph:                                           ; preds = %._crit_edge3, %.lr.ph5
  ...
  %sunkaddr8 = shl nuw nsw i64 %indvars.iv13, 3
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph
  ...
  %6 = load double, double* %sunkaddr10, align 8
  ...
  %11 = fmul double %8, %10
  %12 = fadd double %6, %11
  store double %12, double* %sunkaddr10, align 8
  ...
  store double %18, double* %sunkaddr10, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  ...
  store double %24, double* %sunkaddr10, align 8
...
.lr.ph2.preheader:                                ; preds = %._crit_edge
  %sunkaddr12 = shl nuw nsw i64 %indvars.iv13, 3
...
.lr.ph2:                                          ; preds = %.lr.ph2.preheader, %.lr.ph2
  ...
  %29 = load double, double* %sunkaddr14, align 8
  ...
  %36 = load double, double* %sunkaddr14, align 8
  ...
  %43 = load double, double* %sunkaddr14, align 8
