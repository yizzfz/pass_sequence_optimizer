...
._crit_edge.preheader:                            ; preds = %2, %24
  %.02226 = phi i32 [ 0, %2 ], [ %25, %24 ]
  %3 = add nuw i32 %.02226, 120
  %4 = sext i32 %.02226 to i64
  br label %._crit_edge23.preheader

._crit_edge23.preheader:                          ; preds = %._crit_edge.preheader, %._crit_edge
  %.02125 = phi i32 [ 0, %._crit_edge.preheader ], [ %22, %._crit_edge ]
  %5 = add nuw i32 %3, %.02125
  %6 = sext i32 %.02125 to i64
  %7 = sext i32 %5 to i64
  br label %._crit_edge23

._crit_edge23:                                    ; preds = %._crit_edge23, %._crit_edge23.preheader
  %indvars.iv = phi i64 [ 0, %._crit_edge23.preheader ], [ %indvars.iv.next.1, %._crit_edge23 ]
  ...
  br i1 %exitcond.1, label %._crit_edge, label %._crit_edge23

._crit_edge:                                      ; preds = %._crit_edge23
  %22 = add nsw i32 %.02125, 1
  %23 = icmp slt i32 %22, 120
  br i1 %23, label %._crit_edge23.preheader, label %24

; <label>:24:                                     ; preds = %._crit_edge
  %25 = add nsw i32 %.02226, 1
  %26 = icmp slt i32 %25, 120
  br i1 %26, label %._crit_edge.preheader, label %27
...
._crit_edge.preheader:                            ; preds = %._crit_edge113._crit_edge, %2
  %.0111128 = phi i32 [ 1, %2 ], [ %155, %._crit_edge113._crit_edge ]
  br label %._crit_edge112.preheader

._crit_edge112.preheader:                         ; preds = %._crit_edge.preheader, %._crit_edge
  %indvar21 = phi i64 [ 0, %._crit_edge.preheader ], [ %indvar.next22, %._crit_edge ]
  %.0109120 = phi i32 [ 1, %._crit_edge.preheader ], [ %5, %._crit_edge ]
  %3 = add i64 %indvar21, 1
  %4 = add i64 %indvar21, 2
  %5 = add nsw i32 %.0109120, 1
  %6 = sext i32 %5 to i64
  %7 = sext i32 %.0109120 to i64
  %8 = add nsw i32 %.0109120, -1
  %9 = sext i32 %8 to i64
  br label %._crit_edge114.preheader

._crit_edge114.preheader:                         ; preds = %._crit_edge112.preheader, %._crit_edge112
  %indvar23 = phi i64 [ 0, %._crit_edge112.preheader ], [ %indvar.next24, %._crit_edge112 ]
  %.0107118 = phi i32 [ 1, %._crit_edge112.preheader ], [ %12, %._crit_edge112 ]
  ...
  br i1 %memcheck.conflict36, label %._crit_edge114.preheader56, label %vector.body16.preheader

vector.body16.preheader:                          ; preds = %._crit_edge114.preheader
  br label %vector.body16

._crit_edge114.preheader56:                       ; preds = %._crit_edge114.preheader
...
vector.body16:                                    ; preds = %vector.body16.preheader, %vector.body16
  ...
  %31 = fadd <2 x double> %wide.load51, %28
  ...
  %41 = fadd <2 x double> %wide.load53, %37
  ...
  br i1 %47, label %._crit_edge112.loopexit59, label %vector.body16, !llvm.loop !6

._crit_edge114:                                   ; preds = %._crit_edge114.preheader56, %._crit_edge114
  %indvars.iv = phi i64 [ %indvars.iv.next, %._crit_edge114 ], [ 1, %._crit_edge114.preheader56 ]
  ...
  br i1 %exitcond, label %._crit_edge112.loopexit, label %._crit_edge114, !llvm.loop !9

._crit_edge112.loopexit:                          ; preds = %._crit_edge114
  br label %._crit_edge112

._crit_edge112.loopexit59:                        ; preds = %vector.body16
  br label %._crit_edge112

._crit_edge112:                                   ; preds = %._crit_edge112.loopexit59, %._crit_edge112.loopexit
  %77 = icmp slt i32 %12, 119
  %indvar.next24 = add i64 %indvar23, 1
  br i1 %77, label %._crit_edge114.preheader, label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge112
  %78 = icmp slt i32 %5, 119
  %indvar.next22 = add i64 %indvar21, 1
  br i1 %78, label %._crit_edge112.preheader, label %._crit_edge115.preheader.preheader
...
._crit_edge115.preheader:                         ; preds = %._crit_edge115.preheader.preheader, %._crit_edge113
  %indvar = phi i64 [ %indvar.next, %._crit_edge113 ], [ 0, %._crit_edge115.preheader.preheader ]
  %.1110126 = phi i32 [ %81, %._crit_edge113 ], [ 1, %._crit_edge115.preheader.preheader ]
  %79 = add i64 %indvar, 1
  %80 = add i64 %indvar, 2
  %81 = add nsw i32 %.1110126, 1
  %82 = sext i32 %81 to i64
  %83 = sext i32 %.1110126 to i64
  %84 = add nsw i32 %.1110126, -1
  %85 = sext i32 %84 to i64
  br label %._crit_edge116.preheader

._crit_edge116.preheader:                         ; preds = %._crit_edge115.preheader, %._crit_edge115
  %indvar1 = phi i64 [ 0, %._crit_edge115.preheader ], [ %indvar.next2, %._crit_edge115 ]
  %.1108124 = phi i32 [ 1, %._crit_edge115.preheader ], [ %88, %._crit_edge115 ]
  ...
  %87 = sext i32 %.1108124 to i64
  %88 = add nsw i32 %.1108124, 1
  %89 = sext i32 %88 to i64
  %90 = add nsw i32 %.1108124, -1
  %91 = sext i32 %90 to i64
  %bound0 = icmp ult double* %scevgep, %scevgep8
  %bound1 = icmp ult double* %scevgep6, %scevgep4
  %memcheck.conflict = and i1 %bound0, %bound1
  br i1 %memcheck.conflict, label %._crit_edge116.preheader54, label %vector.body.preheader

vector.body.preheader:                            ; preds = %._crit_edge116.preheader
  br label %vector.body

._crit_edge116.preheader54:                       ; preds = %._crit_edge116.preheader
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %107 = fadd <2 x double> %wide.load13, %104
  ...
  %117 = fadd <2 x double> %wide.load15, %113
  ...
  br i1 %123, label %._crit_edge115.loopexit58, label %vector.body, !llvm.loop !15

._crit_edge116:                                   ; preds = %._crit_edge116.preheader54, %._crit_edge116
  %indvars.iv129 = phi i64 [ %indvars.iv.next130, %._crit_edge116 ], [ 1, %._crit_edge116.preheader54 ]
  %124 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %82, i64 %87, i64 %indvars.iv129
  %125 = load double, double* %124, align 8
  %126 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %83, i64 %87, i64 %indvars.iv129
  %127 = load double, double* %126, align 8
  %128 = fmul double %127, 2.000000e+00
  %129 = fsub double %125, %128
  %130 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %85, i64 %87, i64 %indvars.iv129
  %131 = load double, double* %130, align 8
  %132 = fadd double %131, %129
  %133 = fmul double %132, 1.250000e-01
  %134 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %83, i64 %89, i64 %indvars.iv129
  %135 = load double, double* %134, align 8
  %136 = fsub double %135, %128
  %137 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %83, i64 %91, i64 %indvars.iv129
  %138 = load double, double* %137, align 8
  %139 = fadd double %138, %136
  %140 = fmul double %139, 1.250000e-01
  %141 = fadd double %133, %140
  %indvars.iv.next130 = add nuw nsw i64 %indvars.iv129, 1
  %142 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %83, i64 %87, i64 %indvars.iv.next130
  %143 = load double, double* %142, align 8
  %144 = fsub double %143, %128
  %145 = add nsw i64 %indvars.iv129, -1
  ...
  %152 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %0, i64 %83, i64 %87, i64 %indvars.iv129
  store double %151, double* %152, align 8
  %exitcond131 = icmp eq i64 %indvars.iv.next130, 119
  br i1 %exitcond131, label %._crit_edge115.loopexit, label %._crit_edge116, !llvm.loop !16

._crit_edge115.loopexit:                          ; preds = %._crit_edge116
  br label %._crit_edge115

._crit_edge115.loopexit58:                        ; preds = %vector.body
  br label %._crit_edge115

._crit_edge115:                                   ; preds = %._crit_edge115.loopexit58, %._crit_edge115.loopexit
  %153 = icmp slt i32 %88, 119
  %indvar.next2 = add i64 %indvar1, 1
  br i1 %153, label %._crit_edge116.preheader, label %._crit_edge113

._crit_edge113:                                   ; preds = %._crit_edge115
  %154 = icmp slt i32 %81, 119
  %indvar.next = add i64 %indvar, 1
  br i1 %154, label %._crit_edge115.preheader, label %._crit_edge113._crit_edge

._crit_edge113._crit_edge:                        ; preds = %._crit_edge113
  %155 = add nuw nsw i32 %.0111128, 1
  %exitcond132 = icmp eq i32 %155, 501
  br i1 %exitcond132, label %156, label %._crit_edge.preheader

; <label>:156:                                    ; preds = %._crit_edge113._crit_edge
  ret void
}
...
._crit_edge.preheader:                            ; preds = %1, %25
  %.01924 = phi i32 [ 0, %1 ], [ %26, %25 ]
  %6 = mul nuw nsw i32 %.01924, 120
  %7 = sext i32 %.01924 to i64
  br label %._crit_edge20.preheader

._crit_edge20.preheader:                          ; preds = %._crit_edge.preheader, %._crit_edge
  %.01823 = phi i32 [ 0, %._crit_edge.preheader ], [ %23, %._crit_edge ]
...
; <label>:12:                                     ; preds = %._crit_edge21, %._crit_edge20.preheader
  %indvars.iv = phi i64 [ 0, %._crit_edge20.preheader ], [ %indvars.iv.next, %._crit_edge21 ]
...
._crit_edge:                                      ; preds = %._crit_edge21
  %23 = add nsw i32 %.01823, 1
  %24 = icmp slt i32 %23, 120
  br i1 %24, label %._crit_edge20.preheader, label %25

; <label>:25:                                     ; preds = %._crit_edge
  %26 = add nsw i32 %.01924, 1
  %27 = icmp slt i32 %26, 120
  br i1 %27, label %._crit_edge.preheader, label %28
