...
entry:
  ...
  call fastcc void @init_array(double* nonnull %alpha, double* nonnull %beta, [2000 x double]* %0, double* %1, double* %2, double* %3, double* %4, double* %5, double* %6, double* %7, double* %arraydecay169)
  call void (...) @polybench_timer_start() #4
  %8 = load double, double* %alpha, align 8
  %9 = load double, double* %beta, align 8
  call fastcc void @kernel_gemver(double %8, double %9, [2000 x double]* %0, double* %1, double* %2, double* %3, double* %4, double* %5, double* %6, double* %7, double* %arraydecay169)
...
for.inc42.us:                                     ; preds = %for.inc42.us, %for.body25.us
  %indvars.iv50 = phi i64 [ 0, %for.body25.us ], [ %indvars.iv.next51.1, %for.inc42.us ]
...
for.inc80.us:                                     ; preds = %for.inc80.us, %for.body63.us
  ...
  %65 = phi double [ %.pre40, %for.body63.us ], [ %add77.us.1, %for.inc80.us ]
