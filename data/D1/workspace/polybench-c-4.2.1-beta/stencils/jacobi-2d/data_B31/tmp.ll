...
; <label>:13:                                     ; preds = %10
  tail call void @print_array(i32 1300, [1300 x double]* %7)
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %._crit_edge, %.preheader.us
  ...
  %13 = fdiv double %12, %5
  %14 = getelementptr inbounds [1300 x double], [1300 x double]* %1, i64 %indvars.iv16, i64 %indvars.iv
  ...
  %20 = fdiv double %19, %5
  %21 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv16, i64 %indvars.iv
...
.preheader51.lr.ph:                               ; preds = %4
  ...
  %min.iters.check95 = icmp ult i64 %9, 4
  %n.vec98 = and i64 %9, -4
  %cmp.zero99 = icmp eq i64 %n.vec98, 0
  %ind.end120 = or i64 %n.vec98, 1
  %cmp.n121 = icmp eq i64 %9, %n.vec98
...
.preheader49.us:                                  ; preds = %.preheader49.us.preheader, %._crit_edge.us
  ...
  %10 = add nuw nsw i64 %indvar101, 1
  %scevgep103 = getelementptr [1300 x double], [1300 x double]* %3, i64 %10, i64 1
  %scevgep105 = getelementptr [1300 x double], [1300 x double]* %3, i64 %10, i64 %wide.trip.count67
  %scevgep107 = getelementptr [1300 x double], [1300 x double]* %2, i64 %indvar101, i64 1
  %11 = add nuw nsw i64 %indvar101, 2
  %scevgep109 = getelementptr [1300 x double], [1300 x double]* %2, i64 %11, i64 %wide.trip.count67
  %indvars.iv.next62 = add nuw nsw i64 %indvars.iv61, 1
  %12 = add nsw i64 %indvars.iv61, -1
  br i1 %min.iters.check95, label %._crit_edge.preheader, label %min.iters.checked96

min.iters.checked96:                              ; preds = %.preheader49.us
  br i1 %cmp.zero99, label %._crit_edge.preheader, label %vector.memcheck115
...
vector.memcheck115:                               ; preds = %min.iters.checked96
  ...
  br i1 %memcheck.conflict114, label %._crit_edge.preheader, label %vector.body92.preheader
...
vector.body92:                                    ; preds = %vector.body92.preheader, %vector.body92
  ...
  %13 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv61, i64 %offset.idx122
  ...
  %17 = add nsw i64 %offset.idx122, -1
  ...
  %22 = fadd <2 x double> %wide.load127, %wide.load129
  %23 = fadd <2 x double> %wide.load128, %wide.load130
  %24 = add nuw nsw i64 %offset.idx122, 1
  ...
  %29 = fadd <2 x double> %22, %wide.load131
  %30 = fadd <2 x double> %23, %wide.load132
  %31 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %indvars.iv.next62, i64 %offset.idx122
  ...
  %37 = getelementptr inbounds [1300 x double], [1300 x double]* %2, i64 %12, i64 %offset.idx122
  %38 = bitcast double* %37 to <2 x double>*
  %wide.load135 = load <2 x double>, <2 x double>* %38, align 8, !alias.scope !1
  %39 = getelementptr double, double* %37, i64 2
  %40 = bitcast double* %39 to <2 x double>*
  %wide.load136 = load <2 x double>, <2 x double>* %40, align 8, !alias.scope !1
  %41 = fadd <2 x double> %35, %wide.load135
  %42 = fadd <2 x double> %36, %wide.load136
  ...
  %45 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv61, i64 %offset.idx122
  ...
  %49 = icmp eq i64 %index.next118, %n.vec98
  br i1 %49, label %middle.block93, label %vector.body92, !llvm.loop !6

middle.block93:                                   ; preds = %vector.body92
  br i1 %cmp.n121, label %._crit_edge.us, label %._crit_edge.preheader

._crit_edge.preheader:                            ; preds = %middle.block93, %vector.memcheck115, %min.iters.checked96, %.preheader49.us
  %indvars.iv.ph = phi i64 [ 1, %vector.memcheck115 ], [ 1, %min.iters.checked96 ], [ 1, %.preheader49.us ], [ %ind.end120, %middle.block93 ]
  br label %._crit_edge
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge56.us
  ...
  %67 = add nuw nsw i64 %indvar, 1
  %scevgep = getelementptr [1300 x double], [1300 x double]* %2, i64 %67, i64 1
  %scevgep76 = getelementptr [1300 x double], [1300 x double]* %2, i64 %67, i64 %wide.trip.count67
  %scevgep78 = getelementptr [1300 x double], [1300 x double]* %3, i64 %indvar, i64 1
  %68 = add nuw nsw i64 %indvar, 2
  %scevgep80 = getelementptr [1300 x double], [1300 x double]* %3, i64 %68, i64 %wide.trip.count67
  %indvars.iv.next70 = add nuw nsw i64 %indvars.iv69, 1
  %69 = add nsw i64 %indvars.iv69, -1
  br i1 %min.iters.check, label %._crit_edge74.preheader, label %min.iters.checked

min.iters.checked:                                ; preds = %.preheader.us
  br i1 %cmp.zero, label %._crit_edge74.preheader, label %vector.memcheck
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.load83 = load <2 x double>, <2 x double>* %73, align 8, !alias.scope !10
  %74 = add nsw i64 %offset.idx, -1
  %75 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %indvars.iv69, i64 %74
  %76 = bitcast double* %75 to <2 x double>*
  %wide.load84 = load <2 x double>, <2 x double>* %76, align 8, !alias.scope !10
  %77 = getelementptr double, double* %75, i64 2
  %78 = bitcast double* %77 to <2 x double>*
  %wide.load85 = load <2 x double>, <2 x double>* %78, align 8, !alias.scope !10
  %79 = fadd <2 x double> %wide.load, %wide.load84
  ...
  %wide.load86 = load <2 x double>, <2 x double>* %83, align 8, !alias.scope !10
  %84 = getelementptr double, double* %82, i64 2
  %85 = bitcast double* %84 to <2 x double>*
  %wide.load87 = load <2 x double>, <2 x double>* %85, align 8, !alias.scope !10
  ...
  %wide.load88 = load <2 x double>, <2 x double>* %89, align 8, !alias.scope !10
  %90 = getelementptr double, double* %88, i64 2
  %91 = bitcast double* %90 to <2 x double>*
  %wide.load89 = load <2 x double>, <2 x double>* %91, align 8, !alias.scope !10
  %92 = fadd <2 x double> %86, %wide.load88
  %93 = fadd <2 x double> %87, %wide.load89
  %94 = getelementptr inbounds [1300 x double], [1300 x double]* %3, i64 %69, i64 %offset.idx
  %95 = bitcast double* %94 to <2 x double>*
  %wide.load90 = load <2 x double>, <2 x double>* %95, align 8, !alias.scope !10
  %96 = getelementptr double, double* %94, i64 2
  %97 = bitcast double* %96 to <2 x double>*
  %wide.load91 = load <2 x double>, <2 x double>* %97, align 8, !alias.scope !10
  %98 = fadd <2 x double> %92, %wide.load90
  %99 = fadd <2 x double> %93, %wide.load91
...
middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %._crit_edge56.us, label %._crit_edge74.preheader

._crit_edge74.preheader:                          ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %.preheader.us
...
._crit_edge74:                                    ; preds = %._crit_edge74.preheader, %._crit_edge74
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %._crit_edge74 ], [ %indvars.iv65.ph, %._crit_edge74.preheader ]
  ...
  br i1 %exitcond68, label %._crit_edge56.us.loopexit, label %._crit_edge74, !llvm.loop !16

._crit_edge56.us.loopexit:                        ; preds = %._crit_edge74
...
._crit_edge:                                      ; preds = %._crit_edge16, %14
  ...
  %17 = getelementptr inbounds [1300 x double], [1300 x double]* %1, i64 %indvars.iv12, i64 %indvars.iv
