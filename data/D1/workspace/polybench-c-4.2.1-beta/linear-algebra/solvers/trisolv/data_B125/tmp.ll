...
.lr.ph:                                           ; preds = %.lr.ph2, %._crit_edge
  ...
  %indvars.iv8 = phi i64 [ 1, %.lr.ph2 ], [ %indvars.iv.next9, %._crit_edge ]
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit
  ...
  br i1 %exitcond14, label %._crit_edge3, label %.lr.ph
...
; <label>:4:                                      ; preds = %._crit_edge, %.lr.ph13
  %indvars.iv21 = phi i64 [ 0, %.lr.ph13 ], [ %indvars.iv.next22, %._crit_edge ]
  %5 = add nuw i64 %indvars.iv21, 4294967295
  %6 = getelementptr inbounds double, double* %3, i64 %indvars.iv21
  %7 = load double, double* %6, align 8
  %8 = getelementptr inbounds double, double* %2, i64 %indvars.iv21
  store double %7, double* %8, align 8
  %9 = icmp sgt i64 %indvars.iv21, 0
...
.prol.preheader:                                  ; preds = %.lr.ph
  %10 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv21, i64 0
...
.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph
  ...
  %.lcssa.unr.ph = phi double [ %14, %.prol.preheader ], [ undef, %.lr.ph ]
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %18 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv21, i64 %indvars.iv
  %19 = load double, double* %18, align 8
  %20 = getelementptr inbounds double, double* %2, i64 %indvars.iv
  %21 = load double, double* %20, align 8
  %22 = fmul double %19, %21
  %23 = fsub double %17, %22
  store double %23, double* %sunkaddr4, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %24 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv21, i64 %indvars.iv.next
  %25 = load double, double* %24, align 8
  %26 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next
  %27 = load double, double* %26, align 8
  %28 = fmul double %25, %27
  %29 = fsub double %23, %28
  store double %29, double* %sunkaddr4, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %4, %.prol.loopexit
  %.lcssa9 = phi double [ %.lcssa.unr.ph, %.prol.loopexit ], [ %7, %4 ], [ %29, %._crit_edge.loopexit ]
  %30 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv21, i64 %indvars.iv21
  %31 = load double, double* %30, align 8
  %32 = fdiv double %.lcssa9, %31
  store double %32, double* %sunkaddr4, align 8
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  %exitcond26 = icmp eq i64 %indvars.iv.next22, 2000
  br i1 %exitcond26, label %._crit_edge14, label %4
...
._crit_edge:                                      ; preds = %.lr.ph, %14
  ...
  br i1 %exitcond7, label %._crit_edge2, label %.lr.ph
