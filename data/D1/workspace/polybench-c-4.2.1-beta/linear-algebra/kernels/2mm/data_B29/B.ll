...
.preheader13:                                     ; preds = %15, %6
  %indvars.iv16 = phi i64 [ 0, %6 ], [ %indvars.iv.next17, %15 ]
  br label %7

; <label>:7:                                      ; preds = %._crit_edge, %.preheader13
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %._crit_edge ], [ 0, %.preheader13 ]
  %8 = mul nuw nsw i64 %indvars.iv13, %indvars.iv16
...
.preheader11:                                     ; preds = %.preheader11.preheader, %28
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %28 ], [ 0, %.preheader11.preheader ]
  br label %._crit_edge25

._crit_edge25:                                    ; preds = %._crit_edge25, %.preheader11
  %indvars.iv8 = phi i64 [ 0, %.preheader11 ], [ %indvars.iv.next9.1, %._crit_edge25 ]
  %indvars.iv.next9 = or i64 %indvars.iv8, 1
  %16 = mul nuw nsw i64 %indvars.iv.next9, %indvars.iv11
  ...
  %22 = mul nuw nsw i64 %indvars.iv.next9.1, %indvars.iv11
  ...
  br i1 %exitcond10.1, label %28, label %._crit_edge25

; <label>:28:                                     ; preds = %._crit_edge25
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond20 = icmp eq i64 %indvars.iv.next12, 1100
  br i1 %exitcond20, label %.preheader9.preheader, label %.preheader11

.preheader9.preheader:                            ; preds = %28
  br label %.preheader9

.preheader9:                                      ; preds = %.preheader9.preheader, %38
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %38 ], [ 0, %.preheader9.preheader ]
  br label %29

; <label>:29:                                     ; preds = %._crit_edge22, %.preheader9
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %._crit_edge22 ], [ 0, %.preheader9 ]
  %30 = add nuw nsw i64 %indvars.iv3, 3
  %31 = mul nuw nsw i64 %30, %indvars.iv6
...
; <label>:38:                                     ; preds = %29
  ...
  br i1 %exitcond19, label %.preheader.preheader, label %.preheader9

.preheader.preheader:                             ; preds = %38
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %47
  %indvars.iv1 = phi i64 [ %indvars.iv.next2, %47 ], [ 0, %.preheader.preheader ]
  br label %39

; <label>:39:                                     ; preds = %._crit_edge23, %.preheader
  %indvars.iv = phi i64 [ %indvars.iv.next, %._crit_edge23 ], [ 0, %.preheader ]
  %40 = add nuw nsw i64 %indvars.iv, 2
  %41 = mul nuw nsw i64 %40, %indvars.iv1
...
; <label>:47:                                     ; preds = %39
  ...
  br i1 %exitcond18, label %48, label %.preheader
...
.preheader7:                                      ; preds = %19, %7
  %indvars.iv10 = phi i64 [ 0, %7 ], [ %indvars.iv.next11, %19 ]
  br label %._crit_edge15

._crit_edge15:                                    ; preds = %18, %.preheader7
  %indvars.iv8 = phi i64 [ 0, %.preheader7 ], [ %indvars.iv.next9, %18 ]
  %8 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv10, i64 %indvars.iv8
  store double 0.000000e+00, double* %8, align 8
  br label %9

; <label>:9:                                      ; preds = %._crit_edge, %._crit_edge15
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %._crit_edge ], [ 0, %._crit_edge15 ]
  %10 = phi double [ %17, %._crit_edge ], [ 0.000000e+00, %._crit_edge15 ]
...
; <label>:18:                                     ; preds = %9
  ...
  br i1 %exitcond14, label %19, label %._crit_edge15
...
.preheader:                                       ; preds = %.preheader.preheader, %32
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %32 ], [ 0, %.preheader.preheader ]
  br label %._crit_edge17

._crit_edge17:                                    ; preds = %31, %.preheader
  %indvars.iv1 = phi i64 [ 0, %.preheader ], [ %indvars.iv.next2, %31 ]
...
; <label>:23:                                     ; preds = %._crit_edge16, %._crit_edge17
  %indvars.iv = phi i64 [ %indvars.iv.next, %._crit_edge16 ], [ 0, %._crit_edge17 ]
  %24 = phi double [ %30, %._crit_edge16 ], [ %22, %._crit_edge17 ]
...
; <label>:31:                                     ; preds = %23
  ...
  br i1 %exitcond12, label %32, label %._crit_edge17

; <label>:32:                                     ; preds = %31
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv3, 1
  %exitcond13 = icmp eq i64 %indvars.iv.next4, 800
  br i1 %exitcond13, label %33, label %.preheader
