...
@__llvm_prf_nm = private constant [21 x i8] c"\0B\13x\DAK/\CE\8D\CF\CC-\C8\C9OI\05\00\1B\8A\04\91", section "__llvm_prf_names"
@llvm.used = appending global [2 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_gsm_implode to i8*), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
