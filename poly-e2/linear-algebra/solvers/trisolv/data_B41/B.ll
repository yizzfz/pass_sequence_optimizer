...
for.body6.prol.loopexit:                          ; preds = %for.body6.prol.loopexit.unr-lcssa
  %13 = icmp eq i32 %7, 0
  br i1 %13, label %for.inc14.loopexit, label %for.body6.preheader.new
...
for.cond.for.end16_crit_edge:                     ; preds = %for.inc14
  %21 = trunc i64 %indvars.iv.next13 to i32
...
for.body:                                         ; preds = %for.end, %for.body.lr.ph
  ...
  %indvars.iv8 = phi i32 [ %indvars.iv.next9, %for.end ], [ %4, %for.body.lr.ph ]
  %7 = add i32 %4, %indvar
...
for.cond.for.end24_crit_edge:                     ; preds = %for.end
  %24 = trunc i64 %indvars.iv.next11 to i32
