...
._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge21
  ...
  %15 = load double, double* %sunkaddr8, align 8
  %16 = fadd double %14, %15
  store double %16, double* %sunkaddr12, align 8
  ...
  %22 = load double, double* %sunkaddr16, align 8
  %23 = fadd double %21, %22
  store double %23, double* %sunkaddr20, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 1300
...
; <label>:24:                                     ; preds = %._crit_edge
  ...
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv3, 1
  %exitcond5 = icmp eq i64 %indvars.iv.next4, 1300
  br i1 %exitcond5, label %33, label %._crit_edge21
