...
.lver.check39.preheader:                          ; preds = %._crit_edge.us
...
; <label>:53:                                     ; preds = %53, %.ph
  %store_forwarded24 = phi double [ %load_initial23, %.ph ], [ %70, %53 ]
  %store_forwarded = phi double [ %load_initial, %.ph ], [ %58, %53 ]
  %indvars.iv = phi i64 [ 1, %.ph ], [ %indvars.iv.next, %53 ]
  %54 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv3, i64 %indvars.iv
  %55 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv, i64 %12
  %56 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv, i64 %indvars.iv.next4
  %.lhs = fmul double %store_forwarded, 0xC09F400000000001
  %57 = fadd double %.lhs, 0x40AF420000000001
  ...
  %68 = fmul double %store_forwarded24, 0xC09F400000000001
  %69 = fsub double %67, %68
  %70 = fdiv double %69, %57
  %71 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv3, i64 %indvars.iv
  store double %70, double* %71, align 8
  %exitcond = icmp eq i64 %indvars.iv, 998
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br i1 %exitcond, label %._crit_edge7.us.loopexit48, label %53

._crit_edge7.us.loopexit:                         ; preds = %.ph.lver.orig
  br label %._crit_edge7.us

._crit_edge7.us.loopexit48:                       ; preds = %53
  br label %._crit_edge7.us

._crit_edge7.us:                                  ; preds = %._crit_edge7.us.loopexit48, %._crit_edge7.us.loopexit
  %72 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 999, i64 %indvars.iv3
  store double 1.000000e+00, double* %72, align 8
  br label %36

.lver.check39:                                    ; preds = %.lver.check39.preheader, %._crit_edge4.us
  %indvar25 = phi i64 [ %73, %._crit_edge4.us ], [ 0, %.lver.check39.preheader ]
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %._crit_edge4.us ], [ 1, %.lver.check39.preheader ]
  %73 = add i64 %indvar25, 1
  %scevgep27 = getelementptr [1000 x double], [1000 x double]* %2, i64 %73, i64 0
  %scevgep29 = getelementptr [1000 x double], [1000 x double]* %2, i64 %73, i64 999
  %scevgep31 = getelementptr [1000 x double], [1000 x double]* %3, i64 %73, i64 0
  %scevgep33 = getelementptr [1000 x double], [1000 x double]* %3, i64 %73, i64 999
  %74 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv10
...
._crit_edge4.us:                                  ; preds = %110
  %exitcond13 = icmp eq i64 %indvars.iv.next11, 999
  br i1 %exitcond13, label %._crit_edge4._crit_edge, label %.lver.check39

; <label>:110:                                    ; preds = %110, %._crit_edge14.us
  %indvars.iv8 = phi i64 [ 998, %._crit_edge14.us ], [ %indvars.iv.next9.1, %110 ]
  %111 = phi double [ 1.000000e+00, %._crit_edge14.us ], [ %124, %110 ]
  %112 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv10, i64 %indvars.iv8
  %113 = load double, double* %112, align 8
  %114 = fmul double %113, %111
  %115 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv10, i64 %indvars.iv8
  %116 = load double, double* %115, align 8
  %117 = fadd double %114, %116
  %118 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv10, i64 %indvars.iv8
  store double %117, double* %118, align 8
  %indvars.iv.next9 = add nsw i64 %indvars.iv8, -1
  %119 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv10, i64 %indvars.iv.next9
  %120 = load double, double* %119, align 8
  %121 = fmul double %120, %117
  %122 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv10, i64 %indvars.iv.next9
  %123 = load double, double* %122, align 8
  %124 = fadd double %121, %123
  %125 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv10, i64 %indvars.iv.next9
  store double %124, double* %125, align 8
  %126 = icmp sgt i64 %indvars.iv.next9, 1
  %indvars.iv.next9.1 = add nsw i64 %indvars.iv8, -2
  br i1 %126, label %110, label %._crit_edge4.us

; <label>:127:                                    ; preds = %127, %.ph40
  %store_forwarded46 = phi double [ %load_initial45, %.ph40 ], [ %149, %127 ]
  %store_forwarded43 = phi double [ %load_initial42, %.ph40 ], [ %138, %127 ]
  %indvars.iv5 = phi i64 [ 1, %.ph40 ], [ %indvars.iv.next6, %127 ]
  %128 = getelementptr inbounds [1000 x double], [1000 x double]* %2, i64 %indvars.iv10, i64 %indvars.iv5
  %129 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %81, i64 %indvars.iv5
  %130 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv10, i64 %indvars.iv5
  %131 = getelementptr inbounds [1000 x double], [1000 x double]* %1, i64 %indvars.iv.next11, i64 %indvars.iv5
  %132 = insertelement <2 x double> undef, double %store_forwarded43, i32 0
  ...
  %147 = fmul double %store_forwarded46, 0xC08F400000000001
  %148 = fsub double %146, %147
  %149 = fdiv double %148, %137
  %150 = getelementptr inbounds [1000 x double], [1000 x double]* %3, i64 %indvars.iv10, i64 %indvars.iv5
  store double %149, double* %150, align 8
  %exitcond7 = icmp eq i64 %indvars.iv5, 998
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1
  br i1 %exitcond7, label %._crit_edge14.us.loopexit47, label %127

._crit_edge14.us.loopexit:                        ; preds = %.ph40.lver.orig
  br label %._crit_edge14.us

._crit_edge14.us.loopexit47:                      ; preds = %127
  br label %._crit_edge14.us

._crit_edge14.us:                                 ; preds = %._crit_edge14.us.loopexit47, %._crit_edge14.us.loopexit
  %151 = getelementptr inbounds [1000 x double], [1000 x double]* %0, i64 %indvars.iv10, i64 999
