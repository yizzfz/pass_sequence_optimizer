...
._crit_edge87:                                    ; preds = %._crit_edge87, %.lr.ph26.split.us
  ...
  %6 = mul nuw nsw i64 %indvars.iv83, %indvars.iv79
...
._crit_edge23.us:                                 ; preds = %._crit_edge87
  ...
  %exitcond104 = icmp eq i64 %indvars.iv.next84, 800
  br i1 %exitcond104, label %.lr.ph19.split.us.preheader, label %.lr.ph26.split.us
...
.lr.ph19.split.us.new:                            ; preds = %.lr.ph19.split.us.new, %.lr.ph19.split.us
  ...
  %13 = mul nuw nsw i64 %indvars.iv75, %indvars.iv.next72
  ...
  %18 = mul nuw nsw i64 %indvars.iv75, %indvars.iv.next72.1
...
._crit_edge16.us:                                 ; preds = %.lr.ph19.split.us.new
  ...
  %exitcond103 = icmp eq i64 %indvars.iv.next76, 1100
  br i1 %exitcond103, label %.lr.ph12.split.us.preheader, label %.lr.ph19.split.us
...
._crit_edge90:                                    ; preds = %._crit_edge90, %.lr.ph12.split.us
  %indvars.iv63 = phi i64 [ 0, %.lr.ph12.split.us ], [ %indvars.iv.next64, %._crit_edge90 ]
  %26 = add nuw nsw i64 %indvars.iv63, 3
  %27 = mul nuw nsw i64 %indvars.iv67, %26
  ...
  br i1 %exitcond66, label %._crit_edge9.us, label %._crit_edge90

._crit_edge9.us:                                  ; preds = %._crit_edge90
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  %exitcond102 = icmp eq i64 %indvars.iv.next68, 900
  br i1 %exitcond102, label %.lr.ph5.split.us.preheader, label %.lr.ph12.split.us
...
._crit_edge92:                                    ; preds = %._crit_edge92, %.lr.ph5.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph5.split.us ], [ %indvars.iv.next, %._crit_edge92 ]
  %34 = add nuw nsw i64 %indvars.iv, 2
  %35 = mul nuw nsw i64 %indvars.iv61, %34
  ...
  br i1 %exitcond, label %._crit_edge.us, label %._crit_edge92

._crit_edge.us:                                   ; preds = %._crit_edge92
  %indvars.iv.next62 = add nuw nsw i64 %indvars.iv61, 1
  %exitcond101 = icmp eq i64 %indvars.iv.next62, 800
  br i1 %exitcond101, label %._crit_edge91, label %.lr.ph5.split.us
...
._crit_edge12.us:                                 ; preds = %._crit_edge9.us.us
  ...
  %exitcond102 = icmp eq i64 %indvar.next, 800
  br i1 %exitcond102, label %.lr.ph2.us.preheader, label %.lr.ph11.us
...
.lr.ph8.us.us:                                    ; preds = %._crit_edge9.us.us, %.lr.ph11.us
  ...
  %7 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvar, i64 %indvars.iv77
...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph8.us.us
  ...
  %9 = getelementptr inbounds [1100 x double], [1100 x double]* %3, i64 %indvar, i64 %indvars.iv74
  ...
  %16 = getelementptr inbounds [1100 x double], [1100 x double]* %3, i64 %indvar, i64 %indvars.iv.next75
...
._crit_edge3.us:                                  ; preds = %._crit_edge.us.us
  ...
  br i1 %exitcond101, label %._crit_edge90, label %.lr.ph2.us
...
._crit_edge91:                                    ; preds = %._crit_edge91, %.lr.ph.us.us
  %26 = phi double [ %25, %.lr.ph.us.us ], [ %44, %._crit_edge91 ]
...
.lr.ph4.split.us:                                 ; preds = %._crit_edge2.us, %.lr.ph4
  ...
  %5 = mul nuw nsw i64 %indvars.iv12, 800
...
._crit_edge2.us:                                  ; preds = %._crit_edge.us
  ...
  br i1 %exitcond16, label %._crit_edge, label %.lr.ph4.split.us
