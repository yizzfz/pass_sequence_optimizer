...
._crit_edge1:                                     ; preds = %14, %6
  %indvars.iv19 = phi i64 [ 0, %6 ], [ %indvars.iv.next20, %14 ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge1
  %indvars.iv16 = phi i64 [ 0, %._crit_edge1 ], [ %indvars.iv.next17, %._crit_edge ]
...
; <label>:14:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond21, label %._crit_edge3.preheader, label %._crit_edge1

._crit_edge3.preheader:                           ; preds = %14
  br label %._crit_edge3

._crit_edge3:                                     ; preds = %._crit_edge3.preheader, %28
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %28 ], [ 0, %._crit_edge3.preheader ]
  br label %._crit_edge2

._crit_edge2:                                     ; preds = %._crit_edge2, %._crit_edge3
  %indvars.iv10 = phi i64 [ 0, %._crit_edge3 ], [ %indvars.iv.next11.1, %._crit_edge2 ]
  ...
  br i1 %exitcond12.1, label %28, label %._crit_edge2

; <label>:28:                                     ; preds = %._crit_edge2
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 1100
  br i1 %exitcond15, label %._crit_edge5.preheader, label %._crit_edge3

._crit_edge5.preheader:                           ; preds = %28
  br label %._crit_edge5

._crit_edge5:                                     ; preds = %._crit_edge5.preheader, %37
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %37 ], [ 0, %._crit_edge5.preheader ]
  br label %._crit_edge4

._crit_edge4:                                     ; preds = %._crit_edge4, %._crit_edge5
  %indvars.iv4 = phi i64 [ 0, %._crit_edge5 ], [ %indvars.iv.next5, %._crit_edge4 ]
  ...
  br i1 %exitcond6, label %37, label %._crit_edge4

; <label>:37:                                     ; preds = %._crit_edge4
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %exitcond9 = icmp eq i64 %indvars.iv.next8, 900
  br i1 %exitcond9, label %._crit_edge7.preheader, label %._crit_edge5

._crit_edge7.preheader:                           ; preds = %37
  br label %._crit_edge7

._crit_edge7:                                     ; preds = %._crit_edge7.preheader, %45
  %indvars.iv1 = phi i64 [ %indvars.iv.next2, %45 ], [ 0, %._crit_edge7.preheader ]
  br label %._crit_edge6

._crit_edge6:                                     ; preds = %._crit_edge6, %._crit_edge7
  %indvars.iv = phi i64 [ 0, %._crit_edge7 ], [ %indvars.iv.next, %._crit_edge6 ]
...
; <label>:45:                                     ; preds = %._crit_edge6
  ...
  br i1 %exitcond3, label %46, label %._crit_edge7
...
._crit_edge2:                                     ; preds = %25, %7
  %indvars.iv13 = phi i64 [ 0, %7 ], [ %indvars.iv.next14, %25 ]
  br label %._crit_edge1

._crit_edge1:                                     ; preds = %24, %._crit_edge2
  %indvars.iv10 = phi i64 [ 0, %._crit_edge2 ], [ %indvars.iv.next11, %24 ]
  %8 = getelementptr inbounds [900 x double], [900 x double]* %2, i64 %indvars.iv13, i64 %indvars.iv10
  store double 0.000000e+00, double* %8, align 8
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge1
  %indvars.iv7 = phi i64 [ 0, %._crit_edge1 ], [ %indvars.iv.next8.1, %._crit_edge ]
  %9 = phi double [ 0.000000e+00, %._crit_edge1 ], [ %23, %._crit_edge ]
...
; <label>:24:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond12, label %25, label %._crit_edge1

; <label>:25:                                     ; preds = %24
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond15 = icmp eq i64 %indvars.iv.next14, 800
  br i1 %exitcond15, label %._crit_edge5.preheader, label %._crit_edge2

._crit_edge5.preheader:                           ; preds = %25
  br label %._crit_edge5

._crit_edge5:                                     ; preds = %._crit_edge5.preheader, %49
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %49 ], [ 0, %._crit_edge5.preheader ]
  br label %._crit_edge4

._crit_edge4:                                     ; preds = %48, %._crit_edge5
  %indvars.iv1 = phi i64 [ 0, %._crit_edge5 ], [ %indvars.iv.next2, %48 ]
...
._crit_edge3:                                     ; preds = %._crit_edge3, %._crit_edge4
  %indvars.iv = phi i64 [ 0, %._crit_edge4 ], [ %indvars.iv.next.2, %._crit_edge3 ]
  %29 = phi double [ %28, %._crit_edge4 ], [ %47, %._crit_edge3 ]
  ...
  br i1 %exitcond.2, label %48, label %._crit_edge3

; <label>:48:                                     ; preds = %._crit_edge3
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond3 = icmp eq i64 %indvars.iv.next2, 1200
  br i1 %exitcond3, label %49, label %._crit_edge4

; <label>:49:                                     ; preds = %48
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1
  %exitcond6 = icmp eq i64 %indvars.iv.next5, 800
  br i1 %exitcond6, label %50, label %._crit_edge5
