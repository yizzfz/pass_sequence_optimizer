...
; <label>:648:                                    ; preds = %._crit_edge12, %._crit_edge11, %._crit_edge10, %542
...
; <label>:669:                                    ; preds = %._crit_edge19, %._crit_edge18, %._crit_edge17, %._crit_edge16, %._crit_edge15, %._crit_edge14, %._crit_edge13, %542
...
; <label>:828:                                    ; preds = %._crit_edge1, %._crit_edge, %813
...
; <label>:900:                                    ; preds = %._crit_edge2, %898, %813
...
; <label>:1053:                                   ; preds = %._crit_edge9, %._crit_edge8, %._crit_edge7, %813
...
; <label>:259:                                    ; preds = %._crit_edge7, %._crit_edge6, %._crit_edge5, %247
...
; <label>:348:                                    ; preds = %._crit_edge8, %346, %247
...
; <label>:423:                                    ; preds = %._crit_edge10, %._crit_edge9, %247
  %424 = load %struct.TIFFDirEntry*, %struct.TIFFDirEntry** %4, align 8
...
; <label>:108:                                    ; preds = %._crit_edge2, %._crit_edge1, %91
