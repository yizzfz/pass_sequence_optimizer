...
entry:
  ...
  %arraydecay39 = bitcast i8* %call1 to double*
  tail call fastcc void @kernel_durbin(double* %arraydecay7, double* %arraydecay39)
...
for.inc.lr.ph:                                    ; preds = %for.inc47, %entry
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.inc47 ], [ 1, %entry ]
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.inc47 ], [ 0, %entry ]
  %beta.045 = phi double [ %mul5, %for.inc47 ], [ 1.000000e+00, %entry ]
  %alpha.044 = phi double [ %div, %for.inc47 ], [ %sub3, %entry ]
...
for.inc.prol:                                     ; preds = %for.inc.prol, %for.inc.prol.preheader
  ...
  %sum.038.prol = phi double [ 0.000000e+00, %for.inc.prol.preheader ], [ %add.prol, %for.inc.prol ]
  ...
  %add.prol = fadd double %sum.038.prol, %mul14.prol
...
for.inc.prol.loopexit:                            ; preds = %for.inc.lr.ph, %for.inc.prol.loopexit.unr-lcssa
  ...
  %sum.038.unr = phi double [ 0.000000e+00, %for.inc.lr.ph ], [ %add.prol, %for.inc.prol.loopexit.unr-lcssa ]
  %10 = icmp ult i64 %indvars.iv65, 3
...
for.inc:                                          ; preds = %for.inc, %for.inc.lr.ph.new
  ...
  %sum.038 = phi double [ %sum.038.unr, %for.inc.lr.ph.new ], [ %add.3, %for.inc ]
  ...
  %exitcond.3 = icmp eq i64 %indvars.iv.next.2, %indvars.iv65
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
...
for.inc32.lr.ph:                                  ; preds = %for.inc.prol.loopexit, %for.inc32.lr.ph.unr-lcssa
  ...
  %mul = fmul double %alpha.044, %alpha.044
  %sub4 = fsub double 1.000000e+00, %mul
  %mul5 = fmul double %beta.045, %sub4
  %arrayidx16 = getelementptr inbounds double, double* %r, i64 %indvars.iv67
  %23 = load double, double* %arrayidx16, align 8
  %add17 = fadd double %add.lcssa, %23
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %24 = getelementptr inbounds double, double* %y, i64 %index
  %25 = bitcast double* %24 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %25, align 8
  %26 = getelementptr double, double* %24, i64 2
  %27 = bitcast double* %26 to <2 x double>*
  %wide.load3 = load <2 x double>, <2 x double>* %27, align 8
  %28 = sub nsw i64 %6, %index
  %29 = getelementptr inbounds double, double* %y, i64 %28
  %30 = getelementptr double, double* %29, i64 -1
  %31 = bitcast double* %30 to <2 x double>*
  %wide.load4 = load <2 x double>, <2 x double>* %31, align 8
  %reverse = shufflevector <2 x double> %wide.load4, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %32 = getelementptr double, double* %29, i64 -2
  %33 = getelementptr double, double* %32, i64 -1
  %34 = bitcast double* %33 to <2 x double>*
  %wide.load5 = load <2 x double>, <2 x double>* %34, align 8
  %reverse6 = shufflevector <2 x double> %wide.load5, <2 x double> undef, <2 x i32> <i32 1, i32 0>
  %35 = fmul <2 x double> %broadcast.splat8, %reverse
  %36 = fmul <2 x double> %broadcast.splat8, %reverse6
  %37 = fadd <2 x double> %wide.load, %35
  %38 = fadd <2 x double> %wide.load3, %36
  %39 = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %index
  %40 = bitcast double* %39 to <2 x double>*
  store <2 x double> %37, <2 x double>* %40, align 16
  %41 = getelementptr double, double* %39, i64 2
  %42 = bitcast double* %41 to <2 x double>*
  store <2 x double> %38, <2 x double>* %42, align 16
...
for.inc32.preheader:                              ; preds = %middle.block, %min.iters.checked, %for.inc32.lr.ph
  %indvars.iv50.ph = phi i64 [ 0, %min.iters.checked ], [ 0, %for.inc32.lr.ph ], [ %n.vec, %middle.block ]
  br label %for.inc32

for.inc32:                                        ; preds = %for.inc32.preheader, %for.inc32
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc32 ], [ %indvars.iv50.ph, %for.inc32.preheader ]
  %arrayidx23 = getelementptr inbounds double, double* %y, i64 %indvars.iv50
  %44 = load double, double* %arrayidx23, align 8
  %45 = sub nsw i64 %6, %indvars.iv50
  %arrayidx27 = getelementptr inbounds double, double* %y, i64 %45
  %46 = load double, double* %arrayidx27, align 8
  %mul28 = fmul double %div, %46
  %add29 = fadd double %44, %mul28
  %arrayidx31 = getelementptr inbounds [2000 x double], [2000 x double]* %z, i64 0, i64 %indvars.iv50
  store double %add29, double* %arrayidx31, align 8
  %exitcond56 = icmp eq i64 %indvars.iv50, %indvars.iv65
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1
  br i1 %exitcond56, label %for.inc47.loopexit, label %for.inc32, !llvm.loop !6

for.inc47.loopexit:                               ; preds = %for.inc32
  br label %for.inc47

for.inc47:                                        ; preds = %for.inc47.loopexit, %middle.block
  %47 = shl i64 %indvars.iv65, 3
  %48 = add nuw nsw i64 %47, 8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* nonnull %3, i64 %48, i32 8, i1 false)
  %arrayidx46 = getelementptr inbounds double, double* %y, i64 %indvars.iv67
  store double %div, double* %arrayidx46, align 8
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  %indvars.iv.next66 = add nuw nsw i64 %indvars.iv65, 1
  %exitcond1 = icmp eq i64 %indvars.iv.next66, 1999
