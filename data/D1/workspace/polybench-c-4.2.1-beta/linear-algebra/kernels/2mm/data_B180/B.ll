...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph20.split.us
  ...
  %exitcond82 = icmp eq i64 %indvars.iv.next71, 1100
  br i1 %exitcond82, label %._crit_edge18.us, label %._crit_edge
...
._crit_edge98:                                    ; preds = %._crit_edge98, %.lr.ph8.split.us
  ...
  br i1 %exitcond, label %._crit_edge6.us, label %._crit_edge98
...
._crit_edge99:                                    ; preds = %._crit_edge99, %.lr.ph2.split.us
  ...
  %exitcond78 = icmp eq i64 %indvars.iv.next, 1200
  br i1 %exitcond78, label %._crit_edge.us, label %._crit_edge99
...
._crit_edge12.us:                                 ; preds = %._crit_edge9.us.us
  ...
  %exitcond107 = icmp eq i64 %indvars.iv.next82, 800
  br i1 %exitcond107, label %.lr.ph.us.us.preheader.preheader, label %.lr.ph8.us.us.preheader
...
._crit_edge9.us.us:                               ; preds = %._crit_edge
  ...
  %exitcond93 = icmp eq i64 %indvars.iv.next78, 900
  br i1 %exitcond93, label %._crit_edge12.us, label %.lr.ph8.us.us
...
._crit_edge3.us:                                  ; preds = %._crit_edge.us.us
  ...
  %exitcond106 = icmp eq i64 %indvars.iv.next69, 800
  br i1 %exitcond106, label %49, label %.lr.ph.us.us.preheader
...
._crit_edge.us.us:                                ; preds = %._crit_edge105
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1
  %exitcond90 = icmp eq i64 %indvars.iv.next65, 1200
  br i1 %exitcond90, label %._crit_edge3.us, label %.lr.ph.us.us

._crit_edge105:                                   ; preds = %._crit_edge105, %.lr.ph.us.us
  %30 = phi double [ %29, %.lr.ph.us.us ], [ %48, %._crit_edge105 ]
  %indvars.iv62 = phi i64 [ 0, %.lr.ph.us.us ], [ %indvars.iv.next63.2, %._crit_edge105 ]
  ...
  br i1 %exitcond.2, label %._crit_edge.us.us, label %._crit_edge105
...
._crit_edge:                                      ; preds = %._crit_edge18, %12
  ...
  br i1 %exitcond12, label %._crit_edge.us, label %._crit_edge18

._crit_edge.us:                                   ; preds = %._crit_edge
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %exitcond = icmp eq i64 %indvars.iv.next11, 800
