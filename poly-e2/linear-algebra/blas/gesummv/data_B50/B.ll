...
for.body.lr.ph:                                   ; preds = %entry
  ...
  br i1 %cmp31, label %for.body.lr.ph.for.body.us_crit_edge, label %for.body.lr.ph.for.body_crit_edge
...
for.body.us:                                      ; preds = %for.cond2.for.inc24_crit_edge.us, %for.body.lr.ph.for.body.us_crit_edge
  %indvars.iv13 = phi i64 [ %9, %for.body.lr.ph.for.body.us_crit_edge ], [ %indvars.iv.next14, %for.cond2.for.inc24_crit_edge.us ]
...
for.inc.us:                                       ; preds = %for.inc.us, %for.body.us
  ...
  br i1 %cmp3.us, label %for.inc.us, label %for.cond2.for.inc24_crit_edge.us
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph.for.body_crit_edge
  %indvars.iv15 = phi i64 [ %9, %for.body.lr.ph.for.body_crit_edge ], [ %indvars.iv.next16, %for.body ]
...
for.cond.for.end26_crit_edge:                     ; preds = %for.cond.for.end26_crit_edge.loopexit20, %for.cond.for.end26_crit_edge.loopexit
  %inc25.lcssa.in = phi i64 [ %indvars.iv.next14, %for.cond.for.end26_crit_edge.loopexit ], [ %indvars.iv.next16, %for.cond.for.end26_crit_edge.loopexit20 ]
...
for.body.preheader:                               ; preds = %for.body.lr.ph
  ...
  br i1 %min.iters.check, label %for.body.preheader49, label %min.iters.checked

min.iters.checked:                                ; preds = %for.body.preheader
  %n.vec = and i64 %17, -4
  %cmp.zero = icmp eq i64 %n.vec, 0
  br i1 %cmp.zero, label %for.body.preheader49, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %scevgep = getelementptr double, double* %1, i64 %14
  %18 = add nsw i64 %14, 1
  %19 = icmp sgt i64 %18, %4
  %smax36 = select i1 %19, i64 %18, i64 %4
  %scevgep37 = getelementptr double, double* %1, i64 %smax36
  %scevgep39 = getelementptr double, double* %2, i64 %14
  %scevgep41 = getelementptr double, double* %2, i64 %smax36
  %bound0 = icmp ult double* %scevgep, %scevgep41
  %bound1 = icmp ult double* %scevgep39, %scevgep37
  %memcheck.conflict = and i1 %bound0, %bound1
  %ind.end = add nsw i64 %14, %n.vec
  br i1 %memcheck.conflict, label %for.body.preheader49, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %broadcast.splatinsert45 = insertelement <2 x double> undef, double %5, i32 0
  %broadcast.splat46 = shufflevector <2 x double> %broadcast.splatinsert45, <2 x double> undef, <2 x i32> zeroinitializer
  %broadcast.splatinsert47 = insertelement <2 x double> undef, double %mul35, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load44 = load <2 x double>, <2 x double>* %30, align 8, !alias.scope !1, !noalias !4
  %31 = fmul <2 x double> %broadcast.splat46, %wide.load
  %32 = fmul <2 x double> %broadcast.splat46, %wide.load44
  %33 = fadd <2 x double> %31, %broadcast.splat48
  %34 = fadd <2 x double> %32, %broadcast.splat48
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.cond.for.end41_crit_edge, label %for.body.preheader49

for.body.preheader49:                             ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.body.preheader
  %indvars.iv11.ph = phi i64 [ %14, %for.body.preheader ], [ %14, %min.iters.checked ], [ %14, %vector.memcheck ], [ %ind.end, %middle.block ]
  br label %for.body
...
for.body.us:                                      ; preds = %for.cond5.for.inc39_crit_edge.us, %for.body.us.preheader
  %indvars.iv9 = phi i64 [ %14, %for.body.us.preheader ], [ %indvars.iv.next10, %for.cond5.for.inc39_crit_edge.us ]
...
for.cond5.for.inc39_crit_edge.us:                 ; preds = %for.inc.us
  ...
  %cmp.us = icmp slt i64 %indvars.iv.next10, %38
  br i1 %cmp.us, label %for.body.us, label %for.cond.for.end41_crit_edge.loopexit

for.body:                                         ; preds = %for.body, %for.body.preheader49
  %indvars.iv11 = phi i64 [ %indvars.iv11.ph, %for.body.preheader49 ], [ %indvars.iv.next12, %for.body ]
  %arrayidx = getelementptr inbounds double, double* %1, i64 %indvars.iv11
  store double 0.000000e+00, double* %arrayidx, align 8
  %arrayidx4 = getelementptr inbounds double, double* %2, i64 %indvars.iv11
  store double 0.000000e+00, double* %arrayidx4, align 8
  %arrayidx31 = getelementptr inbounds double, double* %1, i64 %indvars.iv11
  %47 = load double, double* %arrayidx31, align 8
  %mul32 = fmul double %5, %47
  %add36 = fadd double %mul32, %mul35
  %arrayidx38 = getelementptr inbounds double, double* %2, i64 %indvars.iv11
  store double %add36, double* %arrayidx38, align 8
  %indvars.iv.next12 = add nsw i64 %indvars.iv11, 1
  %cmp = icmp slt i64 %indvars.iv.next12, %4
...
for.cond.for.end41_crit_edge:                     ; preds = %for.cond.for.end41_crit_edge.loopexit65, %for.cond.for.end41_crit_edge.loopexit, %middle.block
  %inc40.lcssa.in = phi i64 [ %ind.end, %middle.block ], [ %indvars.iv.next10, %for.cond.for.end41_crit_edge.loopexit ], [ %indvars.iv.next12, %for.cond.for.end41_crit_edge.loopexit65 ]
