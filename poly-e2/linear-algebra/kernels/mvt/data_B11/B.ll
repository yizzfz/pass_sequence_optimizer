...
for.body.us:                                      ; preds = %for.cond22.for.cond.loopexit_crit_edge.us, %for.body.lr.ph
  ...
  %div.us.v.i0.2 = insertelement <2 x double> %div.us.v.i0.1, double %3, i32 1
  ...
  %div5.us = select i1 %1, double 0.000000e+00, double %div.us.v.r2
...
for.inc.us:                                       ; preds = %for.inc.us, %for.body.us
  ...
  %11 = mul nuw nsw i64 %indvars.iv.next, %8
  %12 = trunc i64 %11 to i32
  %rem26.us.1 = srem i32 %12, 2000
  %conv27.us.1 = sitofp i32 %rem26.us.1 to double
  %div29.us.1 = fdiv double %conv27.us.1, 2.000000e+03
  %arrayidx33.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv7, i64 %indvars.iv.next
  store double %div29.us.1, double* %arrayidx33.us.1, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %exitcond13.1 = icmp eq i64 %indvars.iv.next.1, 2000
  br i1 %exitcond13.1, label %for.cond22.for.cond.loopexit_crit_edge.us, label %for.inc.us

for.cond22.for.cond.loopexit_crit_edge.us:        ; preds = %for.inc.us
...
for.cond1.preheader.us:                           ; preds = %for.cond1.preheader.us.preheader, %for.cond1.for.inc12_crit_edge.us
  %storemerge11.us = phi i32 [ %inc13.us, %for.cond1.for.inc12_crit_edge.us ], [ 0, %for.cond1.preheader.us.preheader ]
  %idxprom.us = sext i32 %storemerge11.us to i64
  %sunkaddr12 = shl nsw i64 %idxprom.us, 3
  %sunkaddr13 = add i64 %0, %sunkaddr12
  %sunkaddr14 = inttoptr i64 %sunkaddr13 to double*
  %.pre = load double, double* %sunkaddr14, align 8
  %sunkaddr1 = mul i64 %idxprom.us, 8
  %sunkaddr2 = add i64 %sunkaddr, %sunkaddr1
  %sunkaddr3 = inttoptr i64 %sunkaddr2 to double*
  br label %for.inc.us

for.inc.us:                                       ; preds = %for.inc.us, %for.cond1.preheader.us
  %1 = phi double [ %.pre, %for.cond1.preheader.us ], [ %add.us.1, %for.inc.us ]
  %indvars.iv19 = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next20.1, %for.inc.us ]
  %arrayidx7.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %idxprom.us, i64 %indvars.iv19
  %2 = load double, double* %arrayidx7.us, align 8
  %arrayidx9.us = getelementptr inbounds double, double* %y_1, i64 %indvars.iv19
  %3 = load double, double* %arrayidx9.us, align 8
  ...
  %arrayidx7.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %idxprom.us, i64 %indvars.iv.next20
  %4 = load double, double* %arrayidx7.us.1, align 8
  %arrayidx9.us.1 = getelementptr inbounds double, double* %y_1, i64 %indvars.iv.next20
  %5 = load double, double* %arrayidx9.us.1, align 8
  ...
  br i1 %exitcond22.1, label %for.cond1.for.inc12_crit_edge.us, label %for.inc.us

for.cond1.for.inc12_crit_edge.us:                 ; preds = %for.inc.us
  %inc13.us = add nsw i32 %storemerge11.us, 1
  %cmp.us = icmp slt i32 %inc13.us, 2000
...
for.cond18.preheader.us:                          ; preds = %for.cond18.preheader.us.preheader, %for.cond18.for.inc36_crit_edge.us
  %storemerge17.us = phi i32 [ %inc37.us, %for.cond18.for.inc36_crit_edge.us ], [ 0, %for.cond18.preheader.us.preheader ]
  %idxprom21.us = sext i32 %storemerge17.us to i64
  %sunkaddr16 = shl nsw i64 %idxprom21.us, 3
  %sunkaddr17 = add i64 %6, %sunkaddr16
  %sunkaddr18 = inttoptr i64 %sunkaddr17 to double*
  %.pre23 = load double, double* %sunkaddr18, align 8
  %sunkaddr5 = mul i64 %idxprom21.us, 8
...
for.inc33.us:                                     ; preds = %for.inc33.us, %for.cond18.preheader.us
  %7 = phi double [ %.pre23, %for.cond18.preheader.us ], [ %add30.us.1, %for.inc33.us ]
  %indvars.iv = phi i64 [ 0, %for.cond18.preheader.us ], [ %indvars.iv.next.1, %for.inc33.us ]
  %arrayidx26.us = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv, i64 %idxprom21.us
  ...
  %mul29.us = fmul double %8, %9
  %add30.us = fadd double %7, %mul29.us
  store double %add30.us, double* %sunkaddr7, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx26.us.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv.next, i64 %idxprom21.us
  %10 = load double, double* %arrayidx26.us.1, align 8
  %arrayidx28.us.1 = getelementptr inbounds double, double* %y_2, i64 %indvars.iv.next
  %11 = load double, double* %arrayidx28.us.1, align 8
  %mul29.us.1 = fmul double %10, %11
...
for.cond18.for.inc36_crit_edge.us:                ; preds = %for.inc33.us
  %inc37.us = add nsw i32 %storemerge17.us, 1
  %cmp16.us = icmp slt i32 %inc37.us, 2000
...
for.body:                                         ; preds = %for.inc, %for.body.preheader
  %indvars.iv9 = phi i64 [ 0, %for.body.preheader ], [ %indvars.iv.next10, %for.inc ]
