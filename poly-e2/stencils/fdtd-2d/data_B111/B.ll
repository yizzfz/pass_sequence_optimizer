...
entry:
  ...
  tail call void @init_array([1200 x double]* %arraydecay1, [1200 x double]* %arraydecay42, [1200 x double]* %arraydecay53, double* %arraydecay64)
  tail call void (...) @polybench_timer_start() #4
  tail call void @kernel_fdtd_2d([1200 x double]* %arraydecay1, [1200 x double]* %arraydecay42, [1200 x double]* %arraydecay53, double* %arraydecay64)
...
for.cond5.preheader.us:                           ; preds = %for.inc39.us, %for.cond5.preheader.us.preheader
  %indvars.iv17 = phi i64 [ 0, %for.cond5.preheader.us.preheader ], [ %indvars.iv.next18, %for.inc39.us ]
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %9 = trunc i64 %indvars.iv.next21 to i32
  ...
  %12 = trunc i64 %indvars.iv.next21.1 to i32
  ...
  %14 = trunc i64 %indvars.iv.next21.2 to i32
  ...
  %17 = trunc i64 %indvars.iv.next21.3 to i32
  ...
  %exitcond22.4 = icmp eq i64 %indvars.iv.next21.3, 499
  br i1 %exitcond22.4, label %for.cond5.preheader.us.preheader, label %for.body
...
for.cond1.preheader:                              ; preds = %for.inc113, %entry
  %indvars.iv65 = phi i64 [ 0, %entry ], [ %indvars.iv.next66, %for.inc113 ]
  br label %for.body3

for.cond10.preheader.us:                          ; preds = %for.inc34.us, %for.cond10.preheader.us.preheader
  %indvar = phi i64 [ 0, %for.cond10.preheader.us.preheader ], [ %0, %for.inc34.us ]
  %indvars.iv53 = phi i64 [ 1, %for.cond10.preheader.us.preheader ], [ %indvars.iv.next54, %for.inc34.us ]
  %0 = add i64 %indvar, 1
...
vector.body58:                                    ; preds = %vector.body58, %vector.body58.preheader
  %index78 = phi i64 [ 0, %vector.body58.preheader ], [ %index.next79, %vector.body58 ]
  %3 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv53, i64 %index78
  ...
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv53, i64 %index78
  ...
  br i1 %21, label %for.inc34.us.loopexit112, label %vector.body58, !llvm.loop !6
...
for.body12.us:                                    ; preds = %for.body12.us, %for.body12.us.preheader
  ...
  %exitcond71.1 = icmp eq i64 %indvars.iv.next52, 1199
  br i1 %exitcond71.1, label %for.inc34.us.loopexit, label %for.body12.us, !llvm.loop !9

for.inc34.us.loopexit:                            ; preds = %for.body12.us
  br label %for.inc34.us

for.inc34.us.loopexit112:                         ; preds = %vector.body58
  br label %for.inc34.us

for.inc34.us:                                     ; preds = %for.inc34.us.loopexit112, %for.inc34.us.loopexit
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %cmp8.us = icmp slt i64 %indvars.iv.next54, 1000
...
for.body3:                                        ; preds = %for.body3, %for.cond1.preheader
  ...
  %sunkaddr93 = mul i64 %indvars.iv65, 8
  ...
  %exitcond70.4 = icmp eq i64 %indvars.iv.next.3, 1199
  br i1 %exitcond70.4, label %for.cond10.preheader.us.preheader, label %for.body3

for.cond10.preheader.us.preheader:                ; preds = %for.body3
  br label %for.cond10.preheader.us

for.cond40.preheader.us:                          ; preds = %for.inc66.us, %for.cond40.preheader.us.preheader
  %indvars.iv59 = phi i64 [ 0, %for.cond40.preheader.us.preheader ], [ %38, %for.inc66.us ]
  %scevgep30 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv59, i64 1
  %38 = add i64 %indvars.iv59, 1
  %scevgep32 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %38, i64 0
  %scevgep34 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv59, i64 0
...
vector.body25:                                    ; preds = %vector.body25, %vector.body25.preheader
  %index44 = phi i64 [ 0, %vector.body25.preheader ], [ %index.next45, %vector.body25 ]
  %offset.idx = or i64 %index44, 1
  %39 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv59, i64 %offset.idx
  ...
  %43 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv59, i64 %offset.idx
  ...
  %48 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv59, i64 %47
...
for.body42.us.preheader.new:                      ; preds = %for.body42.us.preheader.new.loopexit, %for.cond40.preheader.us
  %indvars.iv56.ph = phi i64 [ 1, %for.cond40.preheader.us ], [ 1197, %for.body42.us.preheader.new.loopexit ]
  %arrayidx46.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv59, i64 %indvars.iv56.ph
  %59 = load double, double* %arrayidx46.us.prol, align 8
  %arrayidx50.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv59, i64 %indvars.iv56.ph
  %60 = load double, double* %arrayidx50.us.prol, align 8
  %61 = add nsw i64 %indvars.iv56.ph, -1
  %arrayidx55.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv59, i64 %61
...
for.body42.us:                                    ; preds = %for.body42.us, %for.body42.us.preheader.new
  %indvars.iv56 = phi i64 [ %indvars.iv.next57.prol, %for.body42.us.preheader.new ], [ %indvars.iv.next57.1, %for.body42.us ]
  %arrayidx46.us = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv59, i64 %indvars.iv56
  %63 = load double, double* %arrayidx46.us, align 8
  %arrayidx50.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv59, i64 %indvars.iv56
  %64 = load double, double* %arrayidx50.us, align 8
  %65 = add nsw i64 %indvars.iv56, -1
  %arrayidx55.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv59, i64 %65
  ...
  %arrayidx46.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv59, i64 %indvars.iv.next57
  %67 = load double, double* %arrayidx46.us.1, align 8
  %arrayidx50.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv59, i64 %indvars.iv.next57
  %68 = load double, double* %arrayidx50.us.1, align 8
  %arrayidx55.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv59, i64 %indvars.iv56
  ...
  %exitcond.1 = icmp eq i64 %indvars.iv.next57.1, 1200
  br i1 %exitcond.1, label %for.inc66.us, label %for.body42.us, !llvm.loop !16
...
for.cond73.preheader.us:                          ; preds = %for.inc110.us, %for.cond73.preheader.us.preheader
  %indvars.iv63 = phi i64 [ 0, %for.cond73.preheader.us.preheader ], [ %70, %for.inc110.us ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv63, i64 0
  %scevgep2 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv63, i64 1199
  %scevgep4 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv63, i64 0
  %70 = add i64 %indvars.iv63, 1
  %scevgep6 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %70, i64 0
  %scevgep8 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %indvars.iv63, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv63, i64 %index
  ...
  %75 = or i64 %index, 1
  %76 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv63, i64 %75
  ...
  %80 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv63, i64 %index
  ...
  %92 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv63, i64 %index
...
for.body76.us.preheader:                          ; preds = %for.body76.us.preheader.loopexit, %for.cond73.preheader.us
  %indvars.iv61.ph = phi i64 [ 0, %for.cond73.preheader.us ], [ 1196, %for.body76.us.preheader.loopexit ]
  br label %for.body76.us

for.body76.us:                                    ; preds = %for.body76.us, %for.body76.us.preheader
  %indvars.iv61 = phi i64 [ %indvars.iv61.ph, %for.body76.us.preheader ], [ %indvars.iv.next62, %for.body76.us ]
  %arrayidx80.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv63, i64 %indvars.iv61
  %103 = load double, double* %arrayidx80.us, align 8
  %indvars.iv.next62 = add nuw nsw i64 %indvars.iv61, 1
  %arrayidx84.us = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv63, i64 %indvars.iv.next62
  %104 = load double, double* %arrayidx84.us, align 8
  %arrayidx88.us = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv63, i64 %indvars.iv61
  %105 = load double, double* %arrayidx88.us, align 8
  %sub89.us = fsub double %104, %105
  %arrayidx94.us = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %70, i64 %indvars.iv61
  %106 = load double, double* %arrayidx94.us, align 8
  %add95.us = fadd double %sub89.us, %106
  %arrayidx99.us = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv63, i64 %indvars.iv61
  ...
  %exitcond72 = icmp eq i64 %indvars.iv61, 1198
  br i1 %exitcond72, label %for.inc110.us, label %for.body76.us, !llvm.loop !26
...
for.cond2.preheader.us:                           ; preds = %for.inc10.us, %entry
  %indvars.iv61 = phi i64 [ 0, %entry ], [ %indvars.iv.next62, %for.inc10.us ]
  %3 = mul nsw i64 %indvars.iv61, 1000
  br label %for.body4.us

for.body4.us:                                     ; preds = %if.end.us, %for.cond2.preheader.us
  %indvars.iv56 = phi i64 [ 0, %for.cond2.preheader.us ], [ %indvars.iv.next57, %if.end.us ]
  %4 = add nsw i64 %3, %indvars.iv56
...
if.end.us:                                        ; preds = %for.body4.us, %if.then.us
  ...
  %arrayidx8.us = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv61, i64 %indvars.iv56
  %8 = load double, double* %arrayidx8.us, align 8
  %call9.us = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %7, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i64 0, i64 0), double %8) #6
  %indvars.iv.next57 = add nuw nsw i64 %indvars.iv56, 1
  %exitcond60 = icmp eq i64 %indvars.iv.next57, 1200
  br i1 %exitcond60, label %for.inc10.us, label %for.body4.us
...
for.cond19.preheader.us:                          ; preds = %for.inc37.us, %for.end12
  %indvars.iv51 = phi i64 [ 0, %for.end12 ], [ %indvars.iv.next52, %for.inc37.us ]
  %13 = mul nsw i64 %indvars.iv51, 1000
  br label %for.body21.us

for.body21.us:                                    ; preds = %if.end28.us, %for.cond19.preheader.us
  %indvars.iv46 = phi i64 [ 0, %for.cond19.preheader.us ], [ %indvars.iv.next47, %if.end28.us ]
...
if.end28.us:                                      ; preds = %for.body21.us, %if.then26.us
  ...
  %exitcond50 = icmp eq i64 %indvars.iv.next47, 1200
  br i1 %exitcond50, label %for.inc37.us, label %for.body21.us
...
for.cond45.preheader.us:                          ; preds = %for.inc63.us, %for.end39
  %indvars.iv43 = phi i64 [ 0, %for.end39 ], [ %indvars.iv.next44, %for.inc63.us ]
  %21 = mul nsw i64 %indvars.iv43, 1000
...
if.end54.us:                                      ; preds = %for.body47.us, %if.then52.us
  ...
  %arrayidx58.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv43, i64 %indvars.iv
...
for.inc63.us:                                     ; preds = %if.end54.us
  ...
  %cmp43.us = icmp slt i64 %indvars.iv.next44, 1000
