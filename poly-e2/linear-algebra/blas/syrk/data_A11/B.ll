...
vector.body16:                                    ; preds = %vector.body16, %vector.ph24.new
  ...
  br i1 %26, label %middle.block17.loopexit, label %vector.body16, !llvm.loop !1

middle.block17.loopexit:                          ; preds = %vector.body16
  br label %middle.block17

middle.block17:                                   ; preds = %middle.block17.loopexit, %vector.body16.prol.loopexit
...
for.body11.us:                                    ; preds = %for.body11.us, %for.body11.us.preheader.new
  ...
  br i1 %exitcond8.us.1, label %for.inc29.us.loopexit, label %for.body11.us, !llvm.loop !15

for.inc29.us.loopexit:                            ; preds = %for.body11.us
  br label %for.inc29.us

for.inc29.us:                                     ; preds = %for.inc29.us.loopexit, %for.body11.us.prol.loopexit, %middle.block
