...
; <label>:6:                                      ; preds = %.loopexit, %5
  %indvars.iv25 = phi i64 [ 0, %5 ], [ %indvars.iv.next26, %.loopexit ]
  %7 = trunc i64 %indvars.iv25 to i32
  %8 = sitofp i32 %7 to double
  %9 = getelementptr inbounds double, double* %0, i64 %indvars.iv25
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  %10 = icmp eq i64 %indvars.iv.next26, 2000
  ...
  %16 = getelementptr inbounds double, double* %1, i64 %indvars.iv25
  store double %15, double* %16, align 8
  %17 = add nuw nsw i64 %indvars.iv25, 3
  %18 = trunc i64 %17 to i32
  %19 = srem i32 %18, 2000
  %20 = sitofp i32 %19 to double
  %21 = getelementptr inbounds double, double* %2, i64 %indvars.iv25
  %22 = add nuw nsw i64 %indvars.iv25, 4
  ...
  %31 = getelementptr inbounds double, double* %3, i64 %indvars.iv25
  store double %30, double* %31, align 8
  br label %32

; <label>:32:                                     ; preds = %32, %6
  %indvars.iv = phi i64 [ 0, %6 ], [ %indvars.iv.next.1, %32 ]
  %33 = mul nuw nsw i64 %indvars.iv, %indvars.iv25
  %34 = trunc i64 %33 to i32
  %35 = srem i32 %34, 2000
  %36 = sitofp i32 %35 to double
  %37 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 %indvars.iv25, i64 %indvars.iv
  %indvars.iv.next = or i64 %indvars.iv, 1
  %38 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv25
...
.preheader27:                                     ; preds = %21, %5
  %indvars.iv38 = phi i64 [ 0, %5 ], [ %indvars.iv.next39, %21 ]
  %6 = getelementptr inbounds double, double* %0, i64 %indvars.iv38
  %.pre = load double, double* %6, align 8
  br label %7

; <label>:7:                                      ; preds = %7, %.preheader27
  %8 = phi double [ %.pre, %.preheader27 ], [ %20, %7 ]
  %indvars.iv35 = phi i64 [ 0, %.preheader27 ], [ %indvars.iv.next36.1, %7 ]
  %9 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 %indvars.iv38, i64 %indvars.iv35
  %10 = load double, double* %9, align 8
  %11 = getelementptr inbounds double, double* %2, i64 %indvars.iv35
  %12 = load double, double* %11, align 8
  %13 = fmul double %10, %12
  %14 = fadd double %8, %13
  store double %14, double* %6, align 8
  %indvars.iv.next36 = or i64 %indvars.iv35, 1
  %15 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 %indvars.iv38, i64 %indvars.iv.next36
  %16 = load double, double* %15, align 8
  %17 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next36
  ...
  br i1 %exitcond37.1, label %21, label %7

; <label>:21:                                     ; preds = %7
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  %exitcond40 = icmp eq i64 %indvars.iv.next39, 2000
  br i1 %exitcond40, label %.preheader.preheader, label %.preheader27

.preheader.preheader:                             ; preds = %21
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %37
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %37 ], [ 0, %.preheader.preheader ]
  %22 = getelementptr inbounds double, double* %1, i64 %indvars.iv32
  %.pre41 = load double, double* %22, align 8
  br label %23

; <label>:23:                                     ; preds = %23, %.preheader
  %24 = phi double [ %.pre41, %.preheader ], [ %36, %23 ]
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %23 ]
  %25 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 %indvars.iv, i64 %indvars.iv32
  ...
  %indvars.iv.next = or i64 %indvars.iv, 1
  %31 = getelementptr inbounds [2000 x double], [2000 x double]* %4, i64 %indvars.iv.next, i64 %indvars.iv32
...
; <label>:37:                                     ; preds = %23
  ...
  br i1 %exitcond34, label %38, label %.preheader
...
; <label>:13:                                     ; preds = %11, %7
  ...
  %15 = getelementptr inbounds double, double* %0, i64 %indvars.iv16
  %16 = load double, double* %15, align 8
  %17 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %14, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i64 0, i64 0), double %16) #6
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  %exitcond18 = icmp eq i64 %indvars.iv.next17, 2000
  br i1 %exitcond18, label %18, label %7
