...
for.cond1.preheader.us:                           ; preds = %for.inc32.us, %entry
  ...
  %1 = add nuw nsw i64 %indvars.iv41, 1
  br label %for.inc.us
...
for.cond9.preheader.us.us:                        ; preds = %for.cond9.preheader.us.us.preheader, %for.cond9.for.inc29_crit_edge.us.us
  ...
  %6 = add nuw nsw i64 %indvars.iv37, 1
  %scevgep6 = getelementptr [1100 x double], [1100 x double]* %B, i64 %6, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %9 = fmul <2 x double> %8, %broadcast.splatinsert12
  %10 = shufflevector <2 x double> %9, <2 x double> undef, <2 x i32> zeroinitializer
  %11 = getelementptr inbounds [1100 x double], [1100 x double]* %B, i64 %indvars.iv37, i64 %offset.idx
  ...
  %14 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv41, i64 %offset.idx
  %15 = bitcast double* %14 to <4 x double>*
  %wide.vec15 = load <4 x double>, <4 x double>* %15, align 8, !alias.scope !6, !noalias !8
  ...
  %16 = fadd <2 x double> %strided.vec16, %13
  ...
  br i1 %27, label %for.cond9.for.inc29_crit_edge.us.us.loopexit18, label %vector.body, !llvm.loop !9
...
for.inc26.us.us:                                  ; preds = %for.inc26.us.us.preheader, %for.inc26.us.us
  %indvars.iv33 = phi i64 [ %indvars.iv.next34.1, %for.inc26.us.us ], [ 0, %for.inc26.us.us.preheader ]
...
for.inc.us.1:                                     ; preds = %for.inc.us
  ...
  %mul.us.1 = fmul <2 x double> %35, %mul.us.v.i1.2
  ...
  %mul.us.2.1 = fmul <2 x double> %37, %mul.us.v.i1.2
