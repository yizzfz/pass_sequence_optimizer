...
define internal fastcc void @init_array(double* nocapture %alpha, double* nocapture %beta, [1300 x double]* nocapture %A, [1300 x double]* %B, double* nocapture %x) unnamed_addr #2 {
entry:
  store double 1.500000e+00, double* %alpha, align 8
  store double 1.200000e+00, double* %beta, align 8
  br label %for.body.us

for.body.us:                                      ; preds = %for.cond2.for.end_crit_edge.us.for.body.us_crit_edge, %entry
  %indvars.iv7 = phi i64 [ 0, %entry ], [ %indvars.iv.next8, %for.cond2.for.end_crit_edge.us.for.body.us_crit_edge ]
...
for.body5.us:                                     ; preds = %for.body5.us.for.body5.us_crit_edge, %for.body.us
  %indvars.iv = phi i64 [ 0, %for.body.us ], [ %indvars.iv.next, %for.body5.us.for.body5.us_crit_edge ]
  ...
  br i1 %exitcond11, label %for.cond2.for.end_crit_edge.us, label %for.body5.us.for.body5.us_crit_edge
...
for.cond2.for.end_crit_edge.us:                   ; preds = %for.body5.us
  ...
  br i1 %exitcond, label %for.end26, label %for.cond2.for.end_crit_edge.us.for.body.us_crit_edge
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc void @kernel_gesummv(double %alpha, double %beta, [1300 x double]* %A, [1300 x double]* %B, double* %tmp, double* %x, double* %y) unnamed_addr #2 {
entry:
  %sunkaddr8 = ptrtoint double* %tmp to i64
  %sunkaddr = ptrtoint double* %tmp to i64
  %sunkaddr4 = ptrtoint double* %y to i64
  %sunkaddr14 = ptrtoint double* %y to i64
  br label %for.body.us

for.body.us:                                      ; preds = %for.cond5.for.end_crit_edge.us.for.body.us_crit_edge, %entry
  %indvars.iv4 = phi i64 [ 0, %entry ], [ %indvars.iv.next5, %for.cond5.for.end_crit_edge.us.for.body.us_crit_edge ]
...
for.body7.us:                                     ; preds = %for.body7.us.for.body7.us_crit_edge, %for.body.us
  %indvars.iv = phi i64 [ 0, %for.body.us ], [ %indvars.iv.next, %for.body7.us.for.body7.us_crit_edge ]
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond8 = icmp eq i64 %indvars.iv.next, 1300
  br i1 %exitcond8, label %for.cond5.for.end_crit_edge.us, label %for.body7.us.for.body7.us_crit_edge

for.body7.us.for.body7.us_crit_edge:              ; preds = %for.body7.us
  br label %for.body7.us

for.cond5.for.end_crit_edge.us:                   ; preds = %for.body7.us
  %sunkaddr9 = shl i64 %indvars.iv4, 3
  %sunkaddr12 = add i64 %sunkaddr8, %sunkaddr9
  %sunkaddr13 = inttoptr i64 %sunkaddr12 to double*
  %6 = load double, double* %sunkaddr13, align 8
  ...
  %7 = load double, double* %sunkaddr17, align 8
  %mul35.us = fmul double %7, %beta
  %add36.us = fadd double %mul32.us, %mul35.us
  store double %add36.us, double* %sunkaddr17, align 8
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1
  %exitcond = icmp eq i64 %indvars.iv.next5, 1300
  br i1 %exitcond, label %for.end41, label %for.cond5.for.end_crit_edge.us.for.body.us_crit_edge
...
if.end:                                           ; preds = %for.body.if.end_crit_edge, %if.then
  ...
  br i1 %exitcond2, label %for.end, label %if.end.for.body_crit_edge
