...
.prol.preheader:                                  ; preds = %.lr.ph
  ...
  %12 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv26, i64 0
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %17 = getelementptr inbounds [2000 x double], [2000 x double]* %0, i64 %indvars.iv26, i64 %indvars.iv
...
; <label>:3:                                      ; preds = %._crit_edge, %.lr.ph34
  ...
  %4 = add i64 %indvars.iv42, 4294967295
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %3
  %.lcssa = phi double [ %6, %3 ], [ %.lcssa37.unr.ph, %.prol.loopexit ], [ %28, %._crit_edge.loopexit ]
