...
for.body3.us:                                     ; preds = %for.body3.us, %for.cond1.preheader.us
  ...
  br i1 %exitcond41, label %for.cond1.for.inc7_crit_edge.us, label %for.body3.us
...
for.cond10.preheader:                             ; preds = %for.cond1.for.inc7_crit_edge.us
  ...
  br i1 %cmp118, label %for.cond14.preheader.lr.ph, label %for.cond34.preheader
...
vector.body139:                                   ; preds = %vector.body139, %vector.ph147
  ...
  br i1 %30, label %middle.block140, label %vector.body139, !llvm.loop !3
...
for.body3.us:                                     ; preds = %for.body3.us.preheader166, %for.body3.us
  %indvars.iv = phi i64 [ %indvars.iv.next.3, %for.body3.us ], [ %indvars.iv.ph, %for.body3.us.preheader166 ]
  ...
  br i1 %exitcond.3, label %for.cond1.for.cond6.preheader_crit_edge.us.loopexit, label %for.body3.us, !llvm.loop !6
...
for.body11.us.us.prol.loopexit:                   ; preds = %for.body11.us.us.prol, %for.cond9.preheader.us.us
  ...
  br i1 %4, label %for.cond9.for.inc29_crit_edge.us.us, label %for.body11.us.us.preheader
...
vector.ph120:                                     ; preds = %vector.memcheck119
  %48 = load double, double* %arrayidx15.us.us, align 8, !alias.scope !8
  ...
  %52 = load double, double* %arrayidx15.us.us, align 8, !alias.scope !8
...
vector.body88:                                    ; preds = %vector.body88, %vector.ph120
  ...
  %wide.vec132 = load <4 x double>, <4 x double>* %58, align 8, !alias.scope !11
  ...
  %wide.vec135 = load <4 x double>, <4 x double>* %61, align 8, !alias.scope !13, !noalias !15
  ...
  store <4 x double> %interleaved.vec138, <4 x double>* %68, align 8, !alias.scope !13, !noalias !15
  %index.next122 = add i64 %index121, 2
  %69 = icmp eq i64 %index.next122, %n.vec94
  br i1 %69, label %middle.block89, label %vector.body88, !llvm.loop !16
...
for.cond9.for.inc29_crit_edge.us.us:              ; preds = %for.cond9.for.inc29_crit_edge.us.us.loopexit, %middle.block89, %for.body11.us.us.prol.loopexit
...
for.body11.us.us:                                 ; preds = %for.body11.us.us.preheader165, %for.body11.us.us
  %indvars.iv34 = phi i64 [ %indvars.iv.next35.1, %for.body11.us.us ], [ %indvars.iv34.ph, %for.body11.us.us.preheader165 ]
  ...
  br i1 %exitcond.1, label %for.cond9.for.inc29_crit_edge.us.us.loopexit, label %for.body11.us.us, !llvm.loop !17
...
for.cond1.preheader:                              ; preds = %for.cond1.preheader.preheader, %for.inc32
  ...
  br i1 %brmerge65.demorgan, label %for.cond9.preheader.us.preheader, label %for.inc32
...
for.body11.us.prol:                               ; preds = %for.cond9.preheader.us
  %76 = load double, double* %arrayidx15.us, align 8
  %mul16.us.prol = fmul double %76, %alpha
  %arrayidx20.us.prol = getelementptr inbounds [1100 x double], [1100 x double]* %B, i64 %indvars.iv54, i64 0
  %77 = load double, double* %arrayidx20.us.prol, align 8
  %mul21.us.prol = fmul double %mul16.us.prol, %77
  %78 = load double, double* %arrayidx25.us.prol, align 8
  %add.us.prol = fadd double %78, %mul21.us.prol
  store double %add.us.prol, double* %arrayidx25.us.prol, align 8
  br label %for.body11.us.preheader

for.body11.us.preheader:                          ; preds = %for.cond9.preheader.us, %for.body11.us.prol
  %indvars.iv48.unr.ph = phi i64 [ 1, %for.body11.us.prol ], [ 0, %for.cond9.preheader.us ]
  %79 = sub nsw i64 %0, %indvars.iv48.unr.ph
  %80 = lshr i64 %79, 1
  %81 = add nuw i64 %80, 1
...
min.iters.checked:                                ; preds = %for.body11.us.preheader
  %n.mod.vf = and i64 %81, 1
  %n.vec = sub i64 %81, %n.mod.vf
...
vector.memcheck:                                  ; preds = %min.iters.checked
  ...
  %82 = sub nsw i64 %1, %indvars.iv48.unr.ph
  %83 = and i64 %82, -2
  %84 = or i64 %indvars.iv48.unr.ph, %83
  %scevgep70 = getelementptr double, double* %scevgep69, i64 %84
  %scevgep73 = getelementptr [1100 x double], [1100 x double]* %B, i64 %indvars.iv54, i64 %indvars.iv48.unr.ph
  %scevgep76 = getelementptr double, double* %scevgep75, i64 %84
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %97 = shl i64 %index, 1
  %offset.idx = or i64 %indvars.iv48.unr.ph, %97
  %98 = getelementptr inbounds [1100 x double], [1100 x double]* %B, i64 %indvars.iv54, i64 %offset.idx
  %99 = bitcast double* %98 to <4 x double>*
  %wide.vec = load <4 x double>, <4 x double>* %99, align 8, !alias.scope !21
  %strided.vec = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 0, i32 2>
  %strided.vec84 = shufflevector <4 x double> %wide.vec, <4 x double> undef, <2 x i32> <i32 1, i32 3>
  %100 = fmul <2 x double> %92, %strided.vec
  %101 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv58, i64 %offset.idx
  %102 = bitcast double* %101 to <4 x double>*
  %wide.vec85 = load <4 x double>, <4 x double>* %102, align 8, !alias.scope !23, !noalias !25
  ...
  %103 = fadd <2 x double> %strided.vec86, %100
  %104 = add nuw nsw i64 %offset.idx, 1
  %105 = fmul <2 x double> %96, %strided.vec84
  %106 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv58, i64 %104
  %107 = fadd <2 x double> %strided.vec87, %105
  %108 = getelementptr double, double* %106, i64 -1
  %109 = bitcast double* %108 to <4 x double>*
  %interleaved.vec = shufflevector <2 x double> %103, <2 x double> %107, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec, <4 x double>* %109, align 8, !alias.scope !23, !noalias !25
  %index.next = add i64 %index, 2
  %110 = icmp eq i64 %index.next, %n.vec
  br i1 %110, label %middle.block, label %vector.body, !llvm.loop !26

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.mod.vf, 0
  br i1 %cmp.n, label %for.cond9.for.inc29_crit_edge.us, label %for.body11.us.preheader167

for.body11.us.preheader167:                       ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %for.body11.us.preheader
  %indvars.iv48.ph = phi i64 [ %indvars.iv48.unr.ph, %vector.memcheck ], [ %indvars.iv48.unr.ph, %min.iters.checked ], [ %indvars.iv48.unr.ph, %for.body11.us.preheader ], [ %ind.end, %middle.block ]
  br label %for.body11.us

for.body11.us:                                    ; preds = %for.body11.us.preheader167, %for.body11.us
  %indvars.iv48 = phi i64 [ %indvars.iv.next49.1, %for.body11.us ], [ %indvars.iv48.ph, %for.body11.us.preheader167 ]
  %111 = load double, double* %arrayidx15.us, align 8
  %mul16.us = fmul double %111, %alpha
  %arrayidx20.us = getelementptr inbounds [1100 x double], [1100 x double]* %B, i64 %indvars.iv54, i64 %indvars.iv48
  %112 = load double, double* %arrayidx20.us, align 8
  %mul21.us = fmul double %mul16.us, %112
  %arrayidx25.us = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv58, i64 %indvars.iv48
  %113 = load double, double* %arrayidx25.us, align 8
  %add.us = fadd double %113, %mul21.us
  store double %add.us, double* %arrayidx25.us, align 8
  %indvars.iv.next49 = add nuw nsw i64 %indvars.iv48, 1
  %114 = load double, double* %arrayidx15.us, align 8
  %mul16.us.1 = fmul double %114, %alpha
  %arrayidx20.us.1 = getelementptr inbounds [1100 x double], [1100 x double]* %B, i64 %indvars.iv54, i64 %indvars.iv.next49
  %115 = load double, double* %arrayidx20.us.1, align 8
  %mul21.us.1 = fmul double %mul16.us.1, %115
  %arrayidx25.us.1 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv58, i64 %indvars.iv.next49
  %116 = load double, double* %arrayidx25.us.1, align 8
  %add.us.1 = fadd double %116, %mul21.us.1
  ...
  br i1 %exitcond51.1, label %for.cond9.for.inc29_crit_edge.us.loopexit, label %for.body11.us, !llvm.loop !27
