...
@__llvm_prf_nm = private constant [84 x i8] c"R\00mad_bit_init\01mad_bit_length\01mad_bit_nextbyte\01mad_bit_skip\01mad_bit_read\01mad_bit_crc", section "__llvm_prf_names"
@llvm.used = appending global [7 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_mad_bit_init to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_mad_bit_length to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_mad_bit_nextbyte to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_mad_bit_skip to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_mad_bit_read to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_mad_bit_crc to i8*), i8* getelementptr inbounds ([84 x i8], [84 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
