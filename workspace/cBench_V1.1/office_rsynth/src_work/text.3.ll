...
@__llvm_prf_nm = private constant [88 x i8] c"sVx\DA=\C81\0A\C0 \0C\00@\FCP\A1k\DFP:\F4\03\22\1Ak &bb\FD~\87\827\1E\EA+\13\C8\A1Fa\15\0El\EE\BAOg\B5\ED\1B\D1\F1\0CP\F5SzZ\D5\8A0\F8\18lMFN\BE\0F\825\04\D9j\B0X\D6t|\CA_\1F\82\C8*\04", section "__llvm_prf_names"
@llvm.used = appending global [10 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_isvowel to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_isconsonant to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_NRL to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_guess_word to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_phone_cat to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_find_rule to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_leftmatch to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_rightmatch to i8*), i8* bitcast ([10 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([88 x i8], [88 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
