...
.lr.ph150.split.us.preheader:
  %sunkaddr = ptrtoint double* %3 to i64
  br label %.lr.ph150.split.us

.lr.ph150.split.us:                               ; preds = %._crit_edge.us, %.lr.ph150.split.us.preheader
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %._crit_edge.us ], [ 0, %.lr.ph150.split.us.preheader ]
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv16
  store double 0.000000e+00, double* %5, align 8
  %sunkaddr216 = shl nsw i64 %indvars.iv16, 3
  %sunkaddr217 = add i64 %sunkaddr, %sunkaddr216
  %sunkaddr218 = inttoptr i64 %sunkaddr217 to double*
  br label %6

; <label>:6:                                      ; preds = %6, %.lr.ph150.split.us
  %indvars.iv204 = phi i64 [ 0, %.lr.ph150.split.us ], [ %indvars.iv.next205.1.1, %6 ]
  %7 = phi double [ 0.000000e+00, %.lr.ph150.split.us ], [ %19, %6 ]
  %8 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv204, i64 %indvars.iv16
  %9 = load double, double* %8, align 8
  %10 = fadd double %9, %7
  store double %10, double* %sunkaddr218, align 8
  %indvars.iv.next205 = or i64 %indvars.iv204, 1
  %11 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next205, i64 %indvars.iv16
  %12 = load double, double* %11, align 8
  %13 = fadd double %12, %10
  store double %13, double* %sunkaddr218, align 8
  %indvars.iv.next205.1 = or i64 %indvars.iv204, 2
  %14 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next205.1, i64 %indvars.iv16
  %15 = load double, double* %14, align 8
  %16 = fadd double %15, %13
  store double %16, double* %sunkaddr218, align 8
  %indvars.iv.next205.123 = or i64 %indvars.iv204, 3
  %17 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next205.123, i64 %indvars.iv16
  %18 = load double, double* %17, align 8
  %19 = fadd double %18, %16
  store double %19, double* %sunkaddr218, align 8
  %indvars.iv.next205.1.1 = add nsw i64 %indvars.iv204, 4
  %exitcond206.1.1 = icmp eq i64 %indvars.iv.next205.1.1, 1400
  br i1 %exitcond206.1.1, label %._crit_edge.us, label %6
...
._crit_edge.us:                                   ; preds = %6
  ...
  br i1 %exitcond18, label %.lr.ph144.split.us.preheader, label %.lr.ph150.split.us

.lr.ph144.split.us.preheader:                     ; preds = %._crit_edge.us
  %sunkaddr227 = ptrtoint double* %4 to i64
  br label %.lr.ph144.split.us

.lr.ph144.split.us:                               ; preds = %._crit_edge141.us, %.lr.ph144.split.us.preheader
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %._crit_edge141.us ], [ 0, %.lr.ph144.split.us.preheader ]
  %21 = getelementptr inbounds double, double* %4, i64 %indvars.iv13
  store double 0.000000e+00, double* %21, align 8
  %sunkaddr224 = shl nsw i64 %indvars.iv13, 3
...
; <label>:22:                                     ; preds = %22, %.lr.ph144.split.us
  %indvars.iv198 = phi i64 [ 0, %.lr.ph144.split.us ], [ %indvars.iv.next199.1, %22 ]
  %23 = phi double [ 0.000000e+00, %.lr.ph144.split.us ], [ %35, %22 ]
  %24 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv198, i64 %indvars.iv13
  ...
  %30 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv.next199, i64 %indvars.iv13
  ...
  %exitcond200.1 = icmp eq i64 %indvars.iv.next199.1, 1400
  br i1 %exitcond200.1, label %._crit_edge141.us, label %22

._crit_edge141.us:                                ; preds = %22
  %36 = fdiv double %35, %0
  ...
  br i1 %exitcond15, label %._crit_edge110.._crit_edge112_crit_edge.us.preheader, label %.lr.ph144.split.us

._crit_edge110.._crit_edge112_crit_edge.us.preheader: ; preds = %._crit_edge141.us
...
._crit_edge110.._crit_edge112_crit_edge.us:       ; preds = %._crit_edge112._crit_edge.us, %._crit_edge110.._crit_edge112_crit_edge.us.preheader
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %._crit_edge112._crit_edge.us ], [ 0, %._crit_edge110.._crit_edge112_crit_edge.us.preheader ]
...
._crit_edge112.us:                                ; preds = %._crit_edge112.us, %._crit_edge110.._crit_edge112_crit_edge.us
  ...
  %40 = getelementptr inbounds double, double* %3, i64 %indvars.iv194
  %41 = load double, double* %40, align 8
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %1, i64 %indvars.iv10, i64 %indvars.iv194
  %43 = load double, double* %42, align 8
  %44 = fsub double %43, %41
  store double %44, double* %42, align 8
  %45 = tail call double @sqrt(double %0) #4
  %46 = getelementptr inbounds double, double* %4, i64 %indvars.iv194
  ...
  %exitcond196 = icmp eq i64 %indvars.iv.next195, 1200
  br i1 %exitcond196, label %._crit_edge112._crit_edge.us, label %._crit_edge112.us

._crit_edge112._crit_edge.us:                     ; preds = %._crit_edge112.us
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %exitcond12 = icmp eq i64 %indvars.iv.next11, 1400
  br i1 %exitcond12, label %.lr.ph.us.us.preheader.preheader, label %._crit_edge110.._crit_edge112_crit_edge.us

.lr.ph.us.us.preheader.preheader:                 ; preds = %._crit_edge112._crit_edge.us
  br label %.lr.ph.us.us.preheader

.lr.ph.us.us.preheader:                           ; preds = %.lr.ph.us.us.preheader.preheader, %._crit_edge113.us
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %._crit_edge113.us ], [ 0, %.lr.ph.us.us.preheader.preheader ]
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %._crit_edge113.us ], [ 1, %.lr.ph.us.us.preheader.preheader ]
...
._crit_edge113.us:                                ; preds = %._crit_edge123.us.us
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  %exitcond = icmp eq i64 %indvars.iv.next9, 1199
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv3, 1
  br i1 %exitcond, label %._crit_edge113._crit_edge, label %.lr.ph.us.us.preheader
...
._crit_edge123.us.us:                             ; preds = %54
  ...
  br i1 %exitcond7, label %._crit_edge113.us, label %.lr.ph.us.us
...
; <label>:54:                                     ; preds = %54, %.lr.ph.us.us
  ...
  br i1 %exitcond.1, label %._crit_edge123.us.us, label %54

._crit_edge113._crit_edge:                        ; preds = %._crit_edge113.us
