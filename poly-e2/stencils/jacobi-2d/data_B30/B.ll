...
entry:
  ...
  br i1 %cmp15, label %for.cond1.preheader.lr.ph, label %for.end22
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc20_crit_edge.us, %for.cond1.preheader.lr.ph
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.cond1.for.inc20_crit_edge.us ], [ 0, %for.cond1.preheader.lr.ph ]
...
for.body3.us:                                     ; preds = %for.body3.us, %for.cond1.preheader.us
  ...
  %arrayidx8.us = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv19, i64 %indvars.iv
  ...
  %arrayidx19.us = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv19, i64 %indvars.iv
...
for.cond1.for.inc20_crit_edge.us:                 ; preds = %for.body3.us
  ...
  br i1 %exitcond22, label %for.end22.loopexit, label %for.cond1.preheader.us
...
for.cond1.preheader:                              ; preds = %for.inc87, %for.cond1.preheader.lr.ph
  ...
  br i1 %1, label %for.cond4.preheader.us.preheader, label %for.inc87
...
for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.cond4.for.inc37_crit_edge.us
  ...
  %scevgep103 = getelementptr [1300 x double], [1300 x double]* %B, i64 %3, i64 %wide.trip.count64
  %scevgep105 = getelementptr [1300 x double], [1300 x double]* %A, i64 %indvar99, i64 1
  %4 = add i64 %indvar99, 2
  %scevgep107 = getelementptr [1300 x double], [1300 x double]* %A, i64 %4, i64 %wide.trip.count64
  %indvars.iv.next57 = add nuw nsw i64 %indvars.iv56, 1
  %5 = add nsw i64 %indvars.iv56, -1
  br i1 %2, label %for.body7.us.preheader, label %min.iters.checked94

min.iters.checked94:                              ; preds = %for.cond4.preheader.us
  %6 = icmp eq i64 %n.vec96, 0
  br i1 %6, label %for.body7.us.preheader, label %vector.memcheck113
...
vector.body90:                                    ; preds = %vector.body90.preheader, %vector.body90
  ...
  %7 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv56, i64 %offset.idx120
  ...
  %12 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv56, i64 %11
  ...
  %19 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv56, i64 %18
  ...
  %25 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv.next57, i64 %offset.idx120
  ...
  %31 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %5, i64 %offset.idx120
  ...
  %39 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv56, i64 %offset.idx120
  ...
  %43 = icmp eq i64 %index.next116, %n.vec96
  br i1 %43, label %middle.block91, label %vector.body90, !llvm.loop !6

middle.block91:                                   ; preds = %vector.body90
  %44 = icmp eq i64 %0, %n.vec96
  br i1 %44, label %for.cond4.for.inc37_crit_edge.us, label %for.body7.us.preheader
...
for.body7.us:                                     ; preds = %for.body7.us.preheader, %for.body7.us
  ...
  %arrayidx14.us = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv56, i64 %46
...
for.cond40.preheader:                             ; preds = %for.cond4.for.inc37_crit_edge.us
  %51 = icmp sgt i32 %sub, 1
  br i1 %51, label %for.cond44.preheader.us.preheader, label %for.inc87
...
for.cond44.preheader.us:                          ; preds = %for.cond44.preheader.us.preheader, %for.cond44.for.inc84_crit_edge.us
  ...
  %52 = icmp ult i64 %0, 4
  %53 = add i64 %indvar, 1
  %scevgep = getelementptr [1300 x double], [1300 x double]* %A, i64 %53, i64 1
  %scevgep74 = getelementptr [1300 x double], [1300 x double]* %A, i64 %53, i64 %wide.trip.count64
  %scevgep76 = getelementptr [1300 x double], [1300 x double]* %B, i64 %indvar, i64 1
  %54 = add i64 %indvar, 2
  %scevgep78 = getelementptr [1300 x double], [1300 x double]* %B, i64 %54, i64 %wide.trip.count64
  %indvars.iv.next67 = add nuw nsw i64 %indvars.iv66, 1
  %55 = add nsw i64 %indvars.iv66, -1
  br i1 %52, label %for.body47.us.preheader, label %min.iters.checked

min.iters.checked:                                ; preds = %for.cond44.preheader.us
  %56 = icmp eq i64 %n.vec, 0
  br i1 %56, label %for.body47.us.preheader, label %vector.memcheck
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %57 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv66, i64 %offset.idx
  %58 = bitcast double* %57 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %58, align 8, !alias.scope !10
  %59 = getelementptr double, double* %57, i64 2
  %60 = bitcast double* %59 to <2 x double>*
  %wide.load81 = load <2 x double>, <2 x double>* %60, align 8, !alias.scope !10
  %61 = add nsw i64 %offset.idx, -1
  %62 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv66, i64 %61
  %63 = bitcast double* %62 to <2 x double>*
  %wide.load82 = load <2 x double>, <2 x double>* %63, align 8, !alias.scope !10
  %64 = getelementptr double, double* %62, i64 2
  %65 = bitcast double* %64 to <2 x double>*
  %wide.load83 = load <2 x double>, <2 x double>* %65, align 8, !alias.scope !10
  %66 = fadd <2 x double> %wide.load, %wide.load82
  %67 = fadd <2 x double> %wide.load81, %wide.load83
  %68 = add nuw nsw i64 %offset.idx, 1
  %69 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv66, i64 %68
  ...
  %73 = fadd <2 x double> %66, %wide.load84
  %74 = fadd <2 x double> %67, %wide.load85
  %75 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv.next67, i64 %offset.idx
  %76 = bitcast double* %75 to <2 x double>*
  %wide.load86 = load <2 x double>, <2 x double>* %76, align 8, !alias.scope !10
  %77 = getelementptr double, double* %75, i64 2
  %78 = bitcast double* %77 to <2 x double>*
  %wide.load87 = load <2 x double>, <2 x double>* %78, align 8, !alias.scope !10
  %79 = fadd <2 x double> %73, %wide.load86
  %80 = fadd <2 x double> %74, %wide.load87
  %81 = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %55, i64 %offset.idx
  ...
  %88 = fmul <2 x double> %86, <double 2.000000e-01, double 2.000000e-01>
  %89 = getelementptr inbounds [1300 x double], [1300 x double]* %A, i64 %indvars.iv66, i64 %offset.idx
  %90 = bitcast double* %89 to <2 x double>*
  store <2 x double> %87, <2 x double>* %90, align 8, !alias.scope !13, !noalias !10
  %91 = getelementptr double, double* %89, i64 2
  %92 = bitcast double* %91 to <2 x double>*
  store <2 x double> %88, <2 x double>* %92, align 8, !alias.scope !13, !noalias !10
  %index.next = add i64 %index, 4
  %93 = icmp eq i64 %index.next, %n.vec
  br i1 %93, label %middle.block, label %vector.body, !llvm.loop !15

middle.block:                                     ; preds = %vector.body
  %94 = icmp eq i64 %0, %n.vec
  br i1 %94, label %for.cond44.for.inc84_crit_edge.us, label %for.body47.us.preheader
...
for.body47.us:                                    ; preds = %for.body47.us.preheader, %for.body47.us
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.body47.us ], [ %indvars.iv61.ph, %for.body47.us.preheader ]
  %arrayidx51.us = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv66, i64 %indvars.iv61
  %95 = load double, double* %arrayidx51.us, align 8
  %96 = add nsw i64 %indvars.iv61, -1
  %arrayidx56.us = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv66, i64 %96
  %97 = load double, double* %arrayidx56.us, align 8
  %add57.us = fadd double %95, %97
  %indvars.iv.next62 = add nuw nsw i64 %indvars.iv61, 1
  %arrayidx62.us = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv66, i64 %indvars.iv.next62
  %98 = load double, double* %arrayidx62.us, align 8
  %add63.us = fadd double %add57.us, %98
  %arrayidx68.us = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %indvars.iv.next67, i64 %indvars.iv61
  %99 = load double, double* %arrayidx68.us, align 8
  %add69.us = fadd double %add63.us, %99
  %arrayidx74.us = getelementptr inbounds [1300 x double], [1300 x double]* %B, i64 %55, i64 %indvars.iv61
  %100 = load double, double* %arrayidx74.us, align 8
  %add75.us = fadd double %add69.us, %100
  ...
  br i1 %exitcond65, label %for.cond44.for.inc84_crit_edge.us.loopexit, label %for.body47.us, !llvm.loop !16
