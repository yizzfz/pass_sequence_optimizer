...
for.body8.lr.ph:                                  ; preds = %for.end44, %entry
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.end44 ], [ 1, %entry ]
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.end44 ], [ 0, %entry ]
  %beta.045 = phi double [ %mul5, %for.end44 ], [ 1.000000e+00, %entry ]
  %alpha.044 = phi double [ %div, %for.end44 ], [ %sub3, %entry ]
  %4 = add i64 %indvars.iv65, 1
  %5 = add i64 %indvars.iv65, 1
  %6 = shl i64 %indvars.iv65, 3
  %mul = fmul double %alpha.044, %alpha.044
  %sub4 = fsub double 1.000000e+00, %mul
  %7 = add nsw i64 %indvars.iv67, -1
...
for.body8.prol:                                   ; preds = %for.body8.prol, %for.body8.prol.preheader
  %indvars.iv.prol = phi i64 [ 0, %for.body8.prol.preheader ], [ %indvars.iv.next.prol, %for.body8.prol ]
  %sum.038.prol = phi double [ 0.000000e+00, %for.body8.prol.preheader ], [ %add.prol, %for.body8.prol ]
...
for.body8.prol.loopexit:                          ; preds = %for.body8.lr.ph, %for.body8.prol.loopexit.unr-lcssa
  %add.lcssa.unr = phi double [ undef, %for.body8.lr.ph ], [ %add.prol, %for.body8.prol.loopexit.unr-lcssa ]
  %indvars.iv.unr = phi i64 [ 0, %for.body8.lr.ph ], [ %indvars.iv.next.prol, %for.body8.prol.loopexit.unr-lcssa ]
  %sum.038.unr = phi double [ 0.000000e+00, %for.body8.lr.ph ], [ %add.prol, %for.body8.prol.loopexit.unr-lcssa ]
  %11 = icmp ult i64 %indvars.iv65, 3
  br i1 %11, label %for.body21.lr.ph, label %for.body8.lr.ph.new
...
for.body8:                                        ; preds = %for.body8, %for.body8.lr.ph.new
  ...
  %sum.038 = phi double [ %sum.038.unr, %for.body8.lr.ph.new ], [ %add.3, %for.body8 ]
...
for.body21.lr.ph:                                 ; preds = %for.body8.prol.loopexit, %for.body21.lr.ph.unr-lcssa
...
for.body21.preheader:                             ; preds = %middle.block, %min.iters.checked, %for.body21.lr.ph
  %indvars.iv50.ph = phi i64 [ 0, %min.iters.checked ], [ 0, %for.body21.lr.ph ], [ %n.vec, %middle.block ]
  br label %for.body21

for.body21:                                       ; preds = %for.body21.preheader, %for.body21
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.body21 ], [ %indvars.iv50.ph, %for.body21.preheader ]
  %arrayidx23 = getelementptr inbounds double, double* %y, i64 %indvars.iv50
  %45 = load double, double* %arrayidx23, align 8
  %46 = sub nsw i64 %7, %indvars.iv50
  ...
  br i1 %exitcond56, label %for.end44.loopexit, label %for.body21, !llvm.loop !6
...
for.end44:                                        ; preds = %for.end44.loopexit, %middle.block
  ...
  br i1 %exitcond1, label %for.end49, label %for.body8.lr.ph
