...
for.body.us:                                      ; preds = %for.cond2.for.end_crit_edge.us, %entry
  %indvars.iv49.us = phi i64 [ 0, %entry ], [ %indvars.iv.next5.us, %for.cond2.for.end_crit_edge.us ]
...
entry:
  ...
  %sunkaddr24 = ptrtoint double* %y to i64
  br label %for.body.us

for.body.us:                                      ; preds = %for.cond5.for.end_crit_edge.us, %entry
  %indvars.iv16.us = phi i64 [ 0, %entry ], [ %indvars.iv.next2.us, %for.cond5.for.end_crit_edge.us ]
...
for.body7.us:                                     ; preds = %for.body7.us, %for.body.us
  ...
  %3 = load double, double* %sunkaddr23, align 8
  %add.us = fadd double %mul.us, %3
  store double %add.us, double* %sunkaddr23, align 8
  ...
  store double %add27.us, double* %sunkaddr27, align 8
...
for.cond5.for.end_crit_edge.us:                   ; preds = %for.body7.us
  %sunkaddr18 = shl i64 %indvars.iv16.us, 3
