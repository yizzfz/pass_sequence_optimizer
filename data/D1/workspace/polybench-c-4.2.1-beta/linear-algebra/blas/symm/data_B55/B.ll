...
.preheader39.lr.ph:                               ; preds = %.preheader41.lr.ph, %.preheader40
  ...
  %33 = add nsw i64 %wide.trip.count58.7, -8
  br label %.lr.ph
...
.prol.preheader:                                  ; preds = %.lr.ph
  ...
  %43 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv67, i64 0
  store double %42, double* %43, align 8
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph
  %indvars.iv.unr.ph = phi i64 [ 1, %.prol.preheader ], [ 0, %.lr.ph ]
  %44 = icmp eq i64 %indvars.iv67, 0
...
.preheader:                                       ; preds = %.preheader.loopexit, %.prol.loopexit
  %45 = icmp slt i64 %indvars.iv.next68, %32
  br i1 %45, label %.lr.ph43, label %._crit_edge

.lr.ph43:                                         ; preds = %.preheader
  %xtraiter61 = and i32 %36, 7
...
.prol.preheader59:                                ; preds = %.prol.preheader59.preheader, %.prol.preheader59
  ...
  %46 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv67, i64 %indvars.iv56.prol
...
.prol.loopexit60:                                 ; preds = %.prol.loopexit60.loopexit, %.lr.ph43
  ...
  br i1 %47, label %._crit_edge, label %.lr.ph43.new.preheader

.lr.ph43.new.preheader:                           ; preds = %.prol.loopexit60
  %48 = sub i64 %33, %indvars.iv56.unr
  %49 = lshr i64 %48, 3
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %55 = shl i64 %index, 3
  %56 = add i64 %indvars.iv56.unr, %55
  %57 = add nsw i64 %56, 7
  %58 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv67, i64 %57
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %62 = add nuw nsw i64 %indvars.iv, %indvars.iv67
  %63 = trunc i64 %62 to i32
  %64 = srem i32 %63, 100
  %65 = sitofp i32 %64 to double
  %66 = fdiv double %65, %29
  %67 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv67, i64 %indvars.iv
  store double %66, double* %67, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %68 = add nuw nsw i64 %indvars.iv.next, %indvars.iv67
  %69 = trunc i64 %68 to i32
  %70 = srem i32 %69, 100
  %71 = sitofp i32 %70 to double
  %72 = fdiv double %71, %29
  %73 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv67, i64 %indvars.iv.next
...
.lr.ph43.new:                                     ; preds = %.lr.ph43.new.preheader80, %.lr.ph43.new
  ...
  %74 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv67, i64 %indvars.iv56
  store double -9.990000e+02, double* %74, align 8
  %indvars.iv.next57 = add nuw nsw i64 %indvars.iv56, 1
  %75 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv67, i64 %indvars.iv.next57
  store double -9.990000e+02, double* %75, align 8
  %indvars.iv.next57.1 = add nsw i64 %indvars.iv56, 2
  %76 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv67, i64 %indvars.iv.next57.1
  store double -9.990000e+02, double* %76, align 8
  %indvars.iv.next57.2 = add nsw i64 %indvars.iv56, 3
  %77 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv67, i64 %indvars.iv.next57.2
  store double -9.990000e+02, double* %77, align 8
  %indvars.iv.next57.3 = add nsw i64 %indvars.iv56, 4
  %78 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv67, i64 %indvars.iv.next57.3
  store double -9.990000e+02, double* %78, align 8
  %indvars.iv.next57.4 = add nsw i64 %indvars.iv56, 5
  %79 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv67, i64 %indvars.iv.next57.4
  store double -9.990000e+02, double* %79, align 8
  %indvars.iv.next57.5 = add nsw i64 %indvars.iv56, 6
  %80 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv67, i64 %indvars.iv.next57.5
  store double -9.990000e+02, double* %80, align 8
  %indvars.iv.next57.6 = add nsw i64 %indvars.iv56, 7
  %81 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv67, i64 %indvars.iv.next57.6
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %28 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv67, i64 %index
  %29 = bitcast double* %28 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %29, align 8, !alias.scope !8, !noalias !11
  %30 = getelementptr double, double* %28, i64 2
  %31 = bitcast double* %30 to <2 x double>*
  %wide.load85 = load <2 x double>, <2 x double>* %31, align 8, !alias.scope !8, !noalias !11
  %32 = fmul <2 x double> %wide.load, %broadcast.splat87
  %33 = fmul <2 x double> %wide.load85, %broadcast.splat87
  %34 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv67, i64 %index
  %35 = bitcast double* %34 to <2 x double>*
  %wide.load88 = load <2 x double>, <2 x double>* %35, align 8, !alias.scope !14
  %36 = getelementptr double, double* %34, i64 2
  %37 = bitcast double* %36 to <2 x double>*
  %wide.load89 = load <2 x double>, <2 x double>* %37, align 8, !alias.scope !14
  %38 = fmul <2 x double> %wide.load88, %broadcast.splat91
  %39 = fmul <2 x double> %wide.load89, %broadcast.splat91
  %40 = load double, double* %14, align 8, !alias.scope !15
  ...
  %45 = fmul <2 x double> %38, %42
  %46 = fmul <2 x double> %39, %44
  %47 = fadd <2 x double> %32, %45
  %48 = fadd <2 x double> %33, %46
  %49 = fadd <2 x double> %broadcast.splat93, %47
  %50 = fadd <2 x double> %broadcast.splat93, %48
  %51 = bitcast double* %28 to <2 x double>*
  store <2 x double> %49, <2 x double>* %51, align 8, !alias.scope !8, !noalias !11
  %52 = bitcast double* %30 to <2 x double>*
  store <2 x double> %50, <2 x double>* %52, align 8, !alias.scope !8, !noalias !11
