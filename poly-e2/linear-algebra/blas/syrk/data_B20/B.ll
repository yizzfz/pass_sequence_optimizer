...
for.cond14.preheader:                             ; preds = %for.inc31, %for.cond14.preheader.preheader
  %indvars.iv314 = phi i64 [ 0, %for.cond14.preheader.preheader ], [ %indvars.iv.next4, %for.inc31 ]
  br label %for.body17
...
for.cond1.preheader.us:                           ; preds = %for.inc32.us, %for.cond1.preheader.us.preheader
  %indvars.iv1122.us = phi i64 [ 1, %for.cond1.preheader.us.preheader ], [ %indvars.iv.next12.us, %for.inc32.us ]
  %indvars.iv1320.us = phi i64 [ 0, %for.cond1.preheader.us.preheader ], [ %3, %for.inc32.us ]
...
for.body3.us:                                     ; preds = %for.body3.us, %for.body3.us.preheader
  %indvars.iv15.us = phi i64 [ %indvars.iv15.us.ph, %for.body3.us.preheader ], [ %indvars.iv.next.us, %for.body3.us ]
...
for.cond9.preheader.us:                           ; preds = %for.inc29.us, %for.cond9.preheader.us.preheader
  %indvars.iv918.us = phi i64 [ 0, %for.cond9.preheader.us.preheader ], [ %29, %for.inc29.us ]
  %28 = icmp ult i64 %3, 4
