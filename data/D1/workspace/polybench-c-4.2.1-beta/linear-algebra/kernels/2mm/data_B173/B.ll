...
._crit_edge78:                                    ; preds = %._crit_edge78.._crit_edge78_crit_edge, %.lr.ph20.split.us
  %indvars.iv70 = phi i64 [ 0, %.lr.ph20.split.us ], [ %indvars.iv.next71, %._crit_edge78.._crit_edge78_crit_edge ]
  ...
  %exitcond86 = icmp eq i64 %indvars.iv70, 1099
  br i1 %exitcond86, label %._crit_edge18.us, label %._crit_edge78.._crit_edge78_crit_edge

._crit_edge78.._crit_edge78_crit_edge:            ; preds = %._crit_edge78
  %indvars.iv.next71 = add nuw nsw i64 %indvars.iv70, 1
  br label %._crit_edge78

._crit_edge18.us:                                 ; preds = %._crit_edge78
  %indvars.iv.next75 = add nuw nsw i64 %indvars.iv74, 1
  %exitcond98 = icmp eq i64 %indvars.iv.next75, 800
  br i1 %exitcond98, label %.lr.ph14.split.us.new.preheader.preheader, label %.lr.ph20.split.us
...
._crit_edge12.us:                                 ; preds = %.lr.ph14.split.us.new
  ...
  %exitcond97 = icmp eq i64 %indvars.iv.next67, 1100
  br i1 %exitcond97, label %.lr.ph8.split.us.preheader, label %.lr.ph14.split.us.new.preheader
...
._crit_edge82:                                    ; preds = %._crit_edge82.._crit_edge82_crit_edge, %.lr.ph8.split.us
  %indvars.iv54 = phi i64 [ 0, %.lr.ph8.split.us ], [ %indvars.iv.next55, %._crit_edge82.._crit_edge82_crit_edge ]
  ...
  %exitcond = icmp eq i64 %indvars.iv54, 1199
  br i1 %exitcond, label %._crit_edge6.us, label %._crit_edge82.._crit_edge82_crit_edge

._crit_edge82.._crit_edge82_crit_edge:            ; preds = %._crit_edge82
  %indvars.iv.next55 = add nuw nsw i64 %indvars.iv54, 1
  br label %._crit_edge82

._crit_edge6.us:                                  ; preds = %._crit_edge82
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  %exitcond96 = icmp eq i64 %indvars.iv.next59, 900
  br i1 %exitcond96, label %.lr.ph2.split.us.preheader, label %.lr.ph8.split.us
...
._crit_edge84:                                    ; preds = %._crit_edge84.._crit_edge84_crit_edge, %.lr.ph2.split.us
  %indvars.iv = phi i64 [ 0, %.lr.ph2.split.us ], [ %indvars.iv.next, %._crit_edge84.._crit_edge84_crit_edge ]
  ...
  %exitcond85 = icmp eq i64 %indvars.iv, 1199
  br i1 %exitcond85, label %._crit_edge.us, label %._crit_edge84.._crit_edge84_crit_edge

._crit_edge84.._crit_edge84_crit_edge:            ; preds = %._crit_edge84
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %._crit_edge84

._crit_edge.us:                                   ; preds = %._crit_edge84
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1
  %exitcond95 = icmp eq i64 %indvars.iv.next53, 800
  br i1 %exitcond95, label %._crit_edge83, label %.lr.ph2.split.us

._crit_edge83:                                    ; preds = %._crit_edge.us
  ret void
}
...
._crit_edge12.us:                                 ; preds = %._crit_edge9.us.us
  ...
  %exitcond103 = icmp eq i64 %indvars.iv.next82, 800
  br i1 %exitcond103, label %.lr.ph.us.us.preheader.preheader, label %.lr.ph8.us.us.preheader
...
._crit_edge88:                                    ; preds = %._crit_edge88.._crit_edge88_crit_edge, %.lr.ph8.us.us
  ...
  %exitcond91 = icmp eq i64 %indvars.iv74, 1099
  br i1 %exitcond91, label %._crit_edge9.us.us, label %._crit_edge88.._crit_edge88_crit_edge
...
._crit_edge3.us:                                  ; preds = %._crit_edge.us.us
  ...
  %exitcond102 = icmp eq i64 %indvars.iv.next69, 800
  br i1 %exitcond102, label %._crit_edge89, label %.lr.ph.us.us.preheader
...
._crit_edge13:                                    ; preds = %._crit_edge12, %.lr.ph2.split.us
...
._crit_edge12:                                    ; preds = %._crit_edge13, %12
...
._crit_edge.us:                                   ; preds = %._crit_edge12
  ...
  %exitcond16 = icmp eq i64 %indvars.iv.next11, 800
  br i1 %exitcond16, label %._crit_edge, label %.lr.ph2.split.us
