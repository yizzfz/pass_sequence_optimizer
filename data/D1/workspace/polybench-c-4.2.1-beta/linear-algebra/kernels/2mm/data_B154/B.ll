...
._crit_edge29:                                    ; preds = %14, %6
  %indvars.iv19 = phi i64 [ 0, %6 ], [ %indvars.iv.next20, %14 ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge, %._crit_edge29
  %indvars.iv16 = phi i64 [ 0, %._crit_edge29 ], [ %indvars.iv.next17, %._crit_edge ]
...
; <label>:14:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond21, label %.preheader2.preheader, label %._crit_edge29
...
._crit_edge30:                                    ; preds = %._crit_edge30, %.preheader2
  %indvars.iv10 = phi i64 [ 0, %.preheader2 ], [ %indvars.iv.next11.1, %._crit_edge30 ]
  ...
  br i1 %exitcond12.1, label %28, label %._crit_edge30
...
._crit_edge32:                                    ; preds = %._crit_edge32, %.preheader1
  %indvars.iv4 = phi i64 [ 0, %.preheader1 ], [ %indvars.iv.next5, %._crit_edge32 ]
  ...
  br i1 %exitcond6, label %37, label %._crit_edge32

; <label>:37:                                     ; preds = %._crit_edge32
...
._crit_edge34:                                    ; preds = %._crit_edge34, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %._crit_edge34 ]
  ...
  br i1 %exitcond, label %45, label %._crit_edge34

; <label>:45:                                     ; preds = %._crit_edge34
...
; <label>:25:                                     ; preds = %24
  ...
  br i1 %exitcond15, label %.preheader.preheader, label %._crit_edge23

.preheader.preheader:                             ; preds = %25
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %49
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %49 ], [ 0, %.preheader.preheader ]
  br label %._crit_edge25

._crit_edge25:                                    ; preds = %48, %.preheader
