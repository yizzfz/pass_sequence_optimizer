...
for.inc:                                          ; preds = %for.inc, %entry
  %indvars.iv4 = phi i64 [ 0, %entry ], [ %indvars.iv.next5.1, %for.inc ]
  ...
  %exitcond6.1 = icmp eq i64 %indvars.iv.next5.1, 1900
  br i1 %exitcond6.1, label %for.body5.preheader, label %for.inc

for.body5.preheader:                              ; preds = %for.inc
  br label %for.body5

for.body5:                                        ; preds = %for.inc27, %for.body5.preheader
  %indvars.iv2 = phi i64 [ 0, %for.body5.preheader ], [ %indvars.iv.next3, %for.inc27 ]
...
for.inc24:                                        ; preds = %for.inc24, %for.body5
  ...
  %5 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv2
  ...
  %7 = mul nuw nsw i64 %indvars.iv.next.1, %indvars.iv2
...
for.inc27:                                        ; preds = %for.inc24
  ...
  br i1 %exitcond, label %for.end29, label %for.body5
...
for.body3:                                        ; preds = %for.inc34, %for.body3.preheader
  %indvars.iv1 = phi i64 [ 0, %for.body3.preheader ], [ %indvars.iv.next2, %for.inc34 ]
...
for.inc31:                                        ; preds = %for.inc31, %for.body3
  ...
  store double %add28, double* %sunkaddr26, align 8
