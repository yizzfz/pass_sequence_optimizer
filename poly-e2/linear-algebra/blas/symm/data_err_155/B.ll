...
for.inc.us:                                       ; preds = %for.body.us, %for.inc.us
  ...
  %cmp2.us = icmp slt i64 %indvars.iv.next36, 1200
...
for.cond1.for.inc16_crit_edge.us:                 ; preds = %for.inc.us
  ...
  %cmp.us = icmp slt i64 %indvars.iv.next39, 1000
...
for.body22:                                       ; preds = %for.body22.preheader, %for.inc51
  ...
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc51 ], [ 0, %for.body22.preheader ]
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc51 ], [ 1, %for.body22.preheader ]
  %indvars.iv26 = phi i32 [ %indvars.iv.next27, %for.inc51 ], [ 1, %for.body22.preheader ]
...
for.inc36:                                        ; preds = %for.inc36.preheader, %for.inc36
  ...
  %11 = add nsw i64 %indvars.iv, %indvars.iv33
  ...
  %13 = add nsw i64 %indvars.iv.next, %indvars.iv33
...
for.inc48.lr.ph:                                  ; preds = %for.end38
  %xtraiter41 = and i32 %5, 7
  %lcmp.mod42 = icmp eq i32 %xtraiter41, 0
  br i1 %lcmp.mod42, label %for.inc48.prol.loopexit, label %for.inc48.prol.preheader
...
for.inc48.prol:                                   ; preds = %for.inc48.prol.preheader, %for.inc48.prol
  ...
  %prol.iter = phi i32 [ %prol.iter.sub, %for.inc48.prol ], [ %xtraiter41, %for.inc48.prol.preheader ]
...
for.inc51:                                        ; preds = %for.inc51.loopexit, %for.inc48.prol.loopexit
  %17 = icmp slt i64 %indvars.iv.next34, 1000
  %indvars.iv.next27 = add i32 %indvars.iv26, 1
  %indvars.iv.next29 = add nsw i64 %indvars.iv28, 1
  br i1 %17, label %for.body22, label %for.end53
