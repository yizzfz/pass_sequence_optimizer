...
define internal fastcc void @kernel_heat_3d(i32, [120 x [120 x double]]* nocapture, [120 x [120 x double]]* nocapture) unnamed_addr #2 {
  %4 = add nsw i32 %0, -1
  %wide.trip.count125 = zext i32 %4 to i64
  %wide.trip.count = zext i32 %4 to i64
  %wide.trip.count129 = zext i32 %4 to i64
  %wide.trip.count137 = zext i32 %4 to i64
  %wide.trip.count133 = zext i32 %4 to i64
  %wide.trip.count141 = zext i32 %4 to i64
  %5 = add nsw i64 %wide.trip.count133, -1
  %6 = icmp sgt i32 %4, 1
  %7 = icmp sgt i32 %4, 1
  %min.iters.check162 = icmp ult i64 %5, 2
  %n.vec165 = and i64 %5, -2
  %cmp.zero166 = icmp eq i64 %n.vec165, 0
  %ind.end189 = or i64 %5, 1
  %cmp.n190 = icmp eq i64 %5, %n.vec165
  %8 = icmp sgt i32 %4, 1
...
.preheader108:                                    ; preds = %.preheader108.preheader, %._crit_edge113
  ...
  %9 = add i64 %indvar168, 1
  %10 = add i64 %indvar168, 2
...
.preheader106.us:                                 ; preds = %._crit_edge.us, %.preheader106.lr.ph
  ...
  %13 = add i64 %indvar170, 1
  %scevgep172 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %9, i64 %13, i64 1
  %scevgep174 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %9, i64 %13, i64 %wide.trip.count133
  %scevgep176 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvar168, i64 %13, i64 1
  %scevgep178 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %10, i64 %13, i64 %wide.trip.count133
...
vector.body159:                                   ; preds = %vector.body159.preheader, %vector.body159
  ...
  %15 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %11, i64 %indvars.iv123, i64 %offset.idx191
  %16 = bitcast double* %15 to <2 x double>*
  %wide.load195 = load <2 x double>, <2 x double>* %16, align 8, !alias.scope !1
  %17 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv127, i64 %indvars.iv123, i64 %offset.idx191
  %18 = bitcast double* %17 to <2 x double>*
  %wide.load196 = load <2 x double>, <2 x double>* %18, align 8, !alias.scope !1
  %19 = fmul <2 x double> %wide.load196, <double 2.000000e+00, double 2.000000e+00>
  %20 = fsub <2 x double> %wide.load195, %19
  %21 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %12, i64 %indvars.iv123, i64 %offset.idx191
  %22 = bitcast double* %21 to <2 x double>*
  %wide.load197 = load <2 x double>, <2 x double>* %22, align 8, !alias.scope !1
  %23 = fadd <2 x double> %wide.load197, %20
  %24 = fmul <2 x double> %23, <double 1.250000e-01, double 1.250000e-01>
  %25 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv127, i64 %indvars.iv.next124, i64 %offset.idx191
  %26 = bitcast double* %25 to <2 x double>*
  %wide.load198 = load <2 x double>, <2 x double>* %26, align 8, !alias.scope !1
  %27 = fsub <2 x double> %wide.load198, %19
  %28 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv127, i64 %14, i64 %offset.idx191
  %29 = bitcast double* %28 to <2 x double>*
  %wide.load199 = load <2 x double>, <2 x double>* %29, align 8, !alias.scope !1
  %30 = fadd <2 x double> %27, %wide.load199
  %31 = fmul <2 x double> %30, <double 1.250000e-01, double 1.250000e-01>
  %32 = fadd <2 x double> %24, %31
  %33 = add nuw nsw i64 %offset.idx191, 1
  %34 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv127, i64 %indvars.iv123, i64 %33
  %35 = bitcast double* %34 to <2 x double>*
  %wide.load200 = load <2 x double>, <2 x double>* %35, align 8, !alias.scope !1
  %36 = fsub <2 x double> %wide.load200, %19
  %37 = add nsw i64 %offset.idx191, -1
  %38 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv127, i64 %indvars.iv123, i64 %37
  %39 = bitcast double* %38 to <2 x double>*
  %wide.load201 = load <2 x double>, <2 x double>* %39, align 8, !alias.scope !1
  %40 = fadd <2 x double> %36, %wide.load201
  %41 = fmul <2 x double> %40, <double 1.250000e-01, double 1.250000e-01>
  %42 = fadd <2 x double> %32, %41
  %43 = fadd <2 x double> %wide.load196, %42
  %44 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvars.iv127, i64 %indvars.iv123, i64 %offset.idx191
  %45 = bitcast double* %44 to <2 x double>*
  store <2 x double> %43, <2 x double>* %45, align 8, !alias.scope !4, !noalias !1
  %index.next187 = add i64 %index186, 2
  %46 = icmp eq i64 %index.next187, %n.vec165
  br i1 %46, label %middle.block160, label %vector.body159, !llvm.loop !6
...
scalar.ph161:                                     ; preds = %scalar.ph161.preheader, %scalar.ph161
  ...
  %47 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %11, i64 %indvars.iv123, i64 %indvars.iv
  %48 = load double, double* %47, align 8
  %49 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv127, i64 %indvars.iv123, i64 %indvars.iv
  %50 = load double, double* %49, align 8
  %51 = fmul double %50, 2.000000e+00
  %52 = fsub double %48, %51
  %53 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %12, i64 %indvars.iv123, i64 %indvars.iv
  %54 = load double, double* %53, align 8
  %55 = fadd double %54, %52
  %56 = fmul double %55, 1.250000e-01
  %57 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv127, i64 %indvars.iv.next124, i64 %indvars.iv
  %58 = load double, double* %57, align 8
  %59 = fsub double %58, %51
  %60 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv127, i64 %14, i64 %indvars.iv
  %61 = load double, double* %60, align 8
  %62 = fadd double %59, %61
  %63 = fmul double %62, 1.250000e-01
  %64 = fadd double %56, %63
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %65 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv127, i64 %indvars.iv123, i64 %indvars.iv.next
  %66 = load double, double* %65, align 8
  %67 = fsub double %66, %51
  %68 = add nsw i64 %indvars.iv, -1
  %69 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv127, i64 %indvars.iv123, i64 %68
  %70 = load double, double* %69, align 8
  %71 = fadd double %67, %70
  %72 = fmul double %71, 1.250000e-01
  %73 = fadd double %64, %72
  %74 = fadd double %50, %73
  %75 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvars.iv127, i64 %indvars.iv123, i64 %indvars.iv
...
.preheader.us:                                    ; preds = %._crit_edge117.us, %.preheader.lr.ph
  ...
  %80 = add i64 %indvar144, 1
  %scevgep = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %76, i64 %80, i64 1
  %scevgep147 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %76, i64 %80, i64 %wide.trip.count133
  %scevgep149 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvar, i64 %80, i64 1
  %scevgep151 = getelementptr [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %77, i64 %80, i64 %wide.trip.count133
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %82 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %78, i64 %indvars.iv135, i64 %offset.idx
  %83 = bitcast double* %82 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %83, align 8, !alias.scope !10
  %84 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvars.iv139, i64 %indvars.iv135, i64 %offset.idx
  %85 = bitcast double* %84 to <2 x double>*
  %wide.load153 = load <2 x double>, <2 x double>* %85, align 8, !alias.scope !10
  %86 = fmul <2 x double> %wide.load153, <double 2.000000e+00, double 2.000000e+00>
  %87 = fsub <2 x double> %wide.load, %86
  %88 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %79, i64 %indvars.iv135, i64 %offset.idx
  %89 = bitcast double* %88 to <2 x double>*
  %wide.load154 = load <2 x double>, <2 x double>* %89, align 8, !alias.scope !10
  %90 = fadd <2 x double> %wide.load154, %87
  %91 = fmul <2 x double> %90, <double 1.250000e-01, double 1.250000e-01>
  %92 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvars.iv139, i64 %indvars.iv.next136, i64 %offset.idx
  %93 = bitcast double* %92 to <2 x double>*
  %wide.load155 = load <2 x double>, <2 x double>* %93, align 8, !alias.scope !10
  %94 = fsub <2 x double> %wide.load155, %86
  %95 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvars.iv139, i64 %81, i64 %offset.idx
  %96 = bitcast double* %95 to <2 x double>*
  %wide.load156 = load <2 x double>, <2 x double>* %96, align 8, !alias.scope !10
  %97 = fadd <2 x double> %94, %wide.load156
  %98 = fmul <2 x double> %97, <double 1.250000e-01, double 1.250000e-01>
  %99 = fadd <2 x double> %91, %98
  %100 = add nuw nsw i64 %offset.idx, 1
  %101 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvars.iv139, i64 %indvars.iv135, i64 %100
  %102 = bitcast double* %101 to <2 x double>*
  %wide.load157 = load <2 x double>, <2 x double>* %102, align 8, !alias.scope !10
  %103 = fsub <2 x double> %wide.load157, %86
  %104 = add nsw i64 %offset.idx, -1
  %105 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvars.iv139, i64 %indvars.iv135, i64 %104
  %106 = bitcast double* %105 to <2 x double>*
  %wide.load158 = load <2 x double>, <2 x double>* %106, align 8, !alias.scope !10
  %107 = fadd <2 x double> %103, %wide.load158
  %108 = fmul <2 x double> %107, <double 1.250000e-01, double 1.250000e-01>
  %109 = fadd <2 x double> %99, %108
  %110 = fadd <2 x double> %wide.load153, %109
  %111 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv139, i64 %indvars.iv135, i64 %offset.idx
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %114 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %78, i64 %indvars.iv135, i64 %indvars.iv131
  %115 = load double, double* %114, align 8
  %116 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvars.iv139, i64 %indvars.iv135, i64 %indvars.iv131
  %117 = load double, double* %116, align 8
  %118 = fmul double %117, 2.000000e+00
  %119 = fsub double %115, %118
  %120 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %79, i64 %indvars.iv135, i64 %indvars.iv131
  %121 = load double, double* %120, align 8
  %122 = fadd double %121, %119
  %123 = fmul double %122, 1.250000e-01
  %124 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvars.iv139, i64 %indvars.iv.next136, i64 %indvars.iv131
  %125 = load double, double* %124, align 8
  %126 = fsub double %125, %118
  %127 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvars.iv139, i64 %81, i64 %indvars.iv131
  %128 = load double, double* %127, align 8
  %129 = fadd double %126, %128
  %130 = fmul double %129, 1.250000e-01
  %131 = fadd double %123, %130
  %indvars.iv.next132 = add nuw nsw i64 %indvars.iv131, 1
  %132 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvars.iv139, i64 %indvars.iv135, i64 %indvars.iv.next132
  %133 = load double, double* %132, align 8
  %134 = fsub double %133, %118
  %135 = add nsw i64 %indvars.iv131, -1
  %136 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %2, i64 %indvars.iv139, i64 %indvars.iv135, i64 %135
  %137 = load double, double* %136, align 8
  %138 = fadd double %134, %137
  %139 = fmul double %138, 1.250000e-01
  %140 = fadd double %131, %139
  %141 = fadd double %117, %140
  %142 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %1, i64 %indvars.iv139, i64 %indvars.iv135, i64 %indvars.iv131
