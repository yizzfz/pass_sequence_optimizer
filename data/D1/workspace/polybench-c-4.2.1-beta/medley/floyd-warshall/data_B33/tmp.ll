...
._crit_edge8.preheader:                           ; preds = %15, %1
  %indvars.iv11 = phi i64 [ 0, %1 ], [ %indvars.iv.next12, %15 ]
  br label %._crit_edge4

._crit_edge4:                                     ; preds = %._crit_edge4, %._crit_edge8.preheader
  %indvars.iv = phi i64 [ 0, %._crit_edge8.preheader ], [ %indvars.iv.next, %._crit_edge4 ]
  ...
  %7 = add nuw nsw i64 %indvars.iv, %indvars.iv11
  ...
  br i1 %exitcond, label %15, label %._crit_edge4

; <label>:15:                                     ; preds = %._crit_edge4
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond13 = icmp eq i64 %indvars.iv.next12, 2800
  br i1 %exitcond13, label %16, label %._crit_edge8.preheader
...
._crit_edge.preheader:                            ; preds = %17, %1
  %indvars.iv9 = phi i64 [ 0, %1 ], [ %indvars.iv.next10, %17 ]
...
._crit_edge3:                                     ; preds = %._crit_edge3, %._crit_edge3.preheader
  ...
  %3 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv7, i64 %indvars.iv
  %4 = load i32, i32* %3, align 4
  %5 = load i32, i32* %2, align 4
  %6 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv9, i64 %indvars.iv
  ...
  %10 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv7, i64 %indvars.iv.next
  %11 = load i32, i32* %10, align 4
  %12 = load i32, i32* %2, align 4
  %13 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv9, i64 %indvars.iv.next
...
._crit_edge:                                      ; preds = %._crit_edge3
  ...
  br i1 %exitcond, label %17, label %._crit_edge3.preheader

; <label>:17:                                     ; preds = %._crit_edge
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  %exitcond11 = icmp eq i64 %indvars.iv.next10, 2800
  br i1 %exitcond11, label %18, label %._crit_edge.preheader
...
._crit_edge2.preheader:                           ; preds = %18, %1
  %indvars.iv5 = phi i64 [ 0, %1 ], [ %indvars.iv.next6, %18 ]
  %6 = mul nuw nsw i64 %indvars.iv5, 2800
  br label %7

; <label>:7:                                      ; preds = %._crit_edge, %._crit_edge2.preheader
  %indvars.iv = phi i64 [ 0, %._crit_edge2.preheader ], [ %indvars.iv.next, %._crit_edge ]
...
._crit_edge:                                      ; preds = %7, %12
  ...
  %15 = getelementptr inbounds [2800 x i32], [2800 x i32]* %0, i64 %indvars.iv5, i64 %indvars.iv
...
; <label>:18:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond7, label %19, label %._crit_edge2.preheader
