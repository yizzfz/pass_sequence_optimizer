...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc void @kernel_mvt(double* nocapture, double* nocapture, double*, double*, [2000 x double]*) unnamed_addr #2 {
.preheader5.lr.ph:
...
.lr.ph6:                                          ; preds = %.lr.ph6.preheader, %11
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %11 ], [ 0, %.lr.ph6.preheader ]
  %6 = trunc i64 %indvars.iv9 to i32
  %7 = srem i32 %6, 20
  %8 = icmp eq i32 %7, 0
  br i1 %8, label %9, label %11

; <label>:9:                                      ; preds = %.lr.ph6
  %10 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %fputc4 = tail call i32 @fputc(i32 10, %struct._IO_FILE* %10) #5
  br label %11

; <label>:11:                                     ; preds = %.lr.ph6, %9
...
.lr.ph:                                           ; preds = %._crit_edge7, %25
  %indvars.iv = phi i64 [ %indvars.iv.next, %25 ], [ 0, %._crit_edge7 ]
