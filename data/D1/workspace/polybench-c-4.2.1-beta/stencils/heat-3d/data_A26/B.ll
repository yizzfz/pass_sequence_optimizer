...
define internal fastcc void @init_array(i32, [120 x [120 x double]]* nocapture, [120 x [120 x double]]* nocapture) unnamed_addr #2 {
  %4 = icmp sgt i32 %0, 0
  br i1 %4, label %.preheader3.lr.ph, label %.._crit_edge8_crit_edge

.._crit_edge8_crit_edge:                          ; preds = %3
...
.preheader.us.us.preheader:                       ; preds = %._crit_edge6.us..preheader.us.us.preheader_crit_edge, %.preheader3.lr.ph
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %._crit_edge6.us..preheader.us.us.preheader_crit_edge ], [ 0, %.preheader3.lr.ph ]
...
._crit_edge6.us:                                  ; preds = %._crit_edge.us.us
  ...
  br i1 %exitcond24, label %._crit_edge8.loopexit, label %._crit_edge6.us..preheader.us.us.preheader_crit_edge

._crit_edge6.us..preheader.us.us.preheader_crit_edge: ; preds = %._crit_edge6.us
  br label %.preheader.us.us.preheader

.preheader.us.us:                                 ; preds = %._crit_edge.us.us..preheader.us.us_crit_edge, %.preheader.us.us.preheader
  %indvars.iv18 = phi i64 [ 0, %.preheader.us.us.preheader ], [ %indvars.iv.next19, %._crit_edge.us.us..preheader.us.us_crit_edge ]
...
._crit_edge.us.us:                                ; preds = %.prol.loopexit.._crit_edge.us.us_crit_edge, %._crit_edge.us.us.loopexit
  ...
  br i1 %exitcond, label %._crit_edge6.us, label %._crit_edge.us.us..preheader.us.us_crit_edge
...
.preheader5:                                      ; preds = %._crit_edge16..preheader5_crit_edge, %3
  %.0517 = phi i32 [ 1, %3 ], [ %143, %._crit_edge16..preheader5_crit_edge ]
...
.preheader4:                                      ; preds = %._crit_edge8
  br i1 %7, label %.preheader.lr.ph.preheader, label %.preheader4.._crit_edge16_crit_edge
...
.preheader3:                                      ; preds = %._crit_edge8..preheader3_crit_edge, %.preheader3.preheader
  %indvar63 = phi i64 [ %indvar.next64, %._crit_edge8..preheader3_crit_edge ], [ 0, %.preheader3.preheader ]
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %._crit_edge8..preheader3_crit_edge ], [ 1, %.preheader3.preheader ]
...
.preheader1.us:                                   ; preds = %._crit_edge.us..preheader1.us_crit_edge, %.preheader1.lr.ph
  %indvar65 = phi i64 [ %indvar.next66, %._crit_edge.us..preheader1.us_crit_edge ], [ 0, %.preheader1.lr.ph ]
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %._crit_edge.us..preheader1.us_crit_edge ], [ 1, %.preheader1.lr.ph ]
  ...
  br i1 %min.iters.check57, label %.preheader1.us.scalar.ph56.preheader_crit_edge, label %min.iters.checked58

.preheader1.us.scalar.ph56.preheader_crit_edge:   ; preds = %.preheader1.us
  br label %scalar.ph56.preheader

min.iters.checked58:                              ; preds = %.preheader1.us
  br i1 %cmp.zero61, label %min.iters.checked58.scalar.ph56.preheader_crit_edge, label %vector.memcheck79

min.iters.checked58.scalar.ph56.preheader_crit_edge: ; preds = %min.iters.checked58
  br label %scalar.ph56.preheader
...
vector.memcheck79:                                ; preds = %min.iters.checked58
  ...
  br i1 %memcheck.conflict78, label %vector.memcheck79.scalar.ph56.preheader_crit_edge, label %vector.body54.preheader

vector.memcheck79.scalar.ph56.preheader_crit_edge: ; preds = %vector.memcheck79
  br label %scalar.ph56.preheader
...
vector.body54:                                    ; preds = %vector.body54.vector.body54_crit_edge, %vector.body54.preheader
  ...
  br i1 %46, label %middle.block55, label %vector.body54.vector.body54_crit_edge, !llvm.loop !6

vector.body54.vector.body54_crit_edge:            ; preds = %vector.body54
  br label %vector.body54

middle.block55:                                   ; preds = %vector.body54
  br i1 %cmp.n85, label %middle.block55.._crit_edge.us_crit_edge, label %middle.block55.scalar.ph56.preheader_crit_edge

middle.block55.scalar.ph56.preheader_crit_edge:   ; preds = %middle.block55
  br label %scalar.ph56.preheader

middle.block55.._crit_edge.us_crit_edge:          ; preds = %middle.block55
  br label %._crit_edge.us

scalar.ph56.preheader:                            ; preds = %middle.block55.scalar.ph56.preheader_crit_edge, %vector.memcheck79.scalar.ph56.preheader_crit_edge, %min.iters.checked58.scalar.ph56.preheader_crit_edge, %.preheader1.us.scalar.ph56.preheader_crit_edge
  %indvars.iv.ph = phi i64 [ 1, %vector.memcheck79.scalar.ph56.preheader_crit_edge ], [ 1, %min.iters.checked58.scalar.ph56.preheader_crit_edge ], [ 1, %.preheader1.us.scalar.ph56.preheader_crit_edge ], [ %ind.end84, %middle.block55.scalar.ph56.preheader_crit_edge ]
...
._crit_edge.us:                                   ; preds = %middle.block55.._crit_edge.us_crit_edge, %._crit_edge.us.loopexit
  %exitcond21 = icmp eq i64 %indvars.iv.next19, %wide.trip.count20
  %indvar.next66 = add i64 %indvar65, 1
  br i1 %exitcond21, label %._crit_edge8.loopexit, label %._crit_edge.us..preheader1.us_crit_edge
...
._crit_edge8:                                     ; preds = %.preheader3.._crit_edge8_crit_edge, %._crit_edge8.loopexit
  ...
  br i1 %exitcond25, label %.preheader4, label %._crit_edge8..preheader3_crit_edge

._crit_edge8..preheader3_crit_edge:               ; preds = %._crit_edge8
  br label %.preheader3

.preheader.lr.ph:                                 ; preds = %._crit_edge14..preheader.lr.ph_crit_edge, %.preheader.lr.ph.preheader
  %indvar = phi i64 [ %indvar.next, %._crit_edge14..preheader.lr.ph_crit_edge ], [ 0, %.preheader.lr.ph.preheader ]
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %._crit_edge14..preheader.lr.ph_crit_edge ], [ 1, %.preheader.lr.ph.preheader ]
  %76 = add i64 %indvar, 1
  %77 = add i64 %indvar, 2
...
.preheader.us:                                    ; preds = %._crit_edge12.us..preheader.us_crit_edge, %.preheader.lr.ph
  %indvar39 = phi i64 [ %indvar.next40, %._crit_edge12.us..preheader.us_crit_edge ], [ 0, %.preheader.lr.ph ]
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %._crit_edge12.us..preheader.us_crit_edge ], [ 1, %.preheader.lr.ph ]
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.body.preheader
  ...
  br i1 %113, label %middle.block, label %vector.body.vector.body_crit_edge, !llvm.loop !15

vector.body.vector.body_crit_edge:                ; preds = %vector.body
  br label %vector.body

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %middle.block.._crit_edge12.us_crit_edge, label %middle.block.scalar.ph.preheader_crit_edge
...
scalar.ph.preheader:                              ; preds = %middle.block.scalar.ph.preheader_crit_edge, %vector.memcheck.scalar.ph.preheader_crit_edge, %min.iters.checked.scalar.ph.preheader_crit_edge, %.preheader.us.scalar.ph.preheader_crit_edge
  %indvars.iv26.ph = phi i64 [ 1, %vector.memcheck.scalar.ph.preheader_crit_edge ], [ 1, %min.iters.checked.scalar.ph.preheader_crit_edge ], [ 1, %.preheader.us.scalar.ph.preheader_crit_edge ], [ %ind.end, %middle.block.scalar.ph.preheader_crit_edge ]
  br label %scalar.ph
...
._crit_edge12.us:                                 ; preds = %middle.block.._crit_edge12.us_crit_edge, %._crit_edge12.us.loopexit
  ...
  br i1 %exitcond33, label %._crit_edge14, label %._crit_edge12.us..preheader.us_crit_edge
...
._crit_edge14:                                    ; preds = %._crit_edge12.us
  ...
  br i1 %exitcond37, label %._crit_edge16.loopexit, label %._crit_edge14..preheader.lr.ph_crit_edge

._crit_edge14..preheader.lr.ph_crit_edge:         ; preds = %._crit_edge14
  br label %.preheader.lr.ph

._crit_edge16.loopexit:                           ; preds = %._crit_edge14
  br label %._crit_edge16

._crit_edge16:                                    ; preds = %.preheader4.._crit_edge16_crit_edge, %.preheader5.._crit_edge16_crit_edge, %._crit_edge16.loopexit
  %143 = add nuw nsw i32 %.0517, 1
  %exitcond38 = icmp eq i32 %143, 501
  br i1 %exitcond38, label %144, label %._crit_edge16..preheader5_crit_edge

._crit_edge16..preheader5_crit_edge:              ; preds = %._crit_edge16
  br label %.preheader5
...
define internal fastcc void @print_array(i32, [120 x [120 x double]]* nocapture readonly) unnamed_addr #0 {
  ...
  %7 = icmp sgt i32 %0, 0
  br i1 %7, label %.preheader3.lr.ph, label %.._crit_edge8_crit_edge
...
.preheader.us.us.preheader:                       ; preds = %._crit_edge6.us..preheader.us.us.preheader_crit_edge, %.preheader3.lr.ph
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %._crit_edge6.us..preheader.us.us.preheader_crit_edge ], [ 0, %.preheader3.lr.ph ]
...
._crit_edge6.us:                                  ; preds = %._crit_edge.us.us
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  %exitcond25 = icmp eq i64 %indvars.iv.next23, %wide.trip.count24
  br i1 %exitcond25, label %._crit_edge8.loopexit, label %._crit_edge6.us..preheader.us.us.preheader_crit_edge
...
._crit_edge.us.us:                                ; preds = %22
  %indvars.iv.next19 = add nuw nsw i64 %indvars.iv18, 1
  %exitcond21 = icmp eq i64 %indvars.iv.next19, %wide.trip.count20
  br i1 %exitcond21, label %._crit_edge6.us, label %._crit_edge.us.us..preheader.us.us_crit_edge

._crit_edge.us.us..preheader.us.us_crit_edge:     ; preds = %._crit_edge.us.us
  br label %.preheader.us.us

; <label>:15:                                     ; preds = %._crit_edge26, %.preheader.us.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %._crit_edge26 ], [ 0, %.preheader.us.us ]
