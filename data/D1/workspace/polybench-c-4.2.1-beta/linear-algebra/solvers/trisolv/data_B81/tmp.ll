...
.lr.ph9:
  %sunkaddr29 = ptrtoint double* %2 to i64
  %sunkaddr = ptrtoint double* %2 to i64
  %sunkaddr33 = ptrtoint double* %2 to i64
  br label %4

; <label>:4:                                      ; preds = %._crit_edge, %.lr.ph9
  %indvars.iv17 = phi i64 [ 0, %.lr.ph9 ], [ %indvars.iv.next18, %._crit_edge ]
  %5 = add nuw nsw i64 %indvars.iv17, 4294967295
  %6 = getelementptr inbounds double, double* %3, i64 %indvars.iv17
  %7 = load double, double* %6, align 8
  %8 = getelementptr inbounds double, double* %2, i64 %indvars.iv17
  store double %7, double* %8, align 8
  %9 = icmp sgt i64 %indvars.iv17, 0
...
.prol.preheader:                                  ; preds = %.lr.ph
  %10 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv17, i64 0
  %11 = load double, double* %10, align 8
  %12 = load double, double* %2, align 8
  %13 = fmul double %11, %12
  %14 = fsub double %7, %13
  %sunkaddr26 = shl i64 %indvars.iv17, 3
  %sunkaddr27 = add i64 %sunkaddr, %sunkaddr26
  %sunkaddr28 = inttoptr i64 %sunkaddr27 to double*
  store double %14, double* %sunkaddr28, align 8
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph
  %indvars.iv.unr.ph = phi i64 [ 1, %.prol.preheader ], [ 0, %.lr.ph ]
  %.unr.ph = phi double [ %14, %.prol.preheader ], [ %7, %.lr.ph ]
  %.lcssa12.unr.ph = phi double [ %14, %.prol.preheader ], [ undef, %.lr.ph ]
  %15 = trunc i64 %5 to i32
  %16 = icmp eq i32 %15, 0
  br i1 %16, label %._crit_edge, label %.lr.ph.new.preheader

.lr.ph.new.preheader:                             ; preds = %.prol.loopexit
  %sunkaddr30 = shl i64 %indvars.iv17, 3
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %18 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv17, i64 %indvars.iv
  %19 = load double, double* %18, align 8
  %20 = getelementptr inbounds double, double* %2, i64 %indvars.iv
  %21 = load double, double* %20, align 8
  %22 = fmul double %19, %21
  %23 = fsub double %17, %22
  store double %23, double* %sunkaddr32, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %24 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv17, i64 %indvars.iv.next
  %25 = load double, double* %24, align 8
  %26 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next
  %27 = load double, double* %26, align 8
  %28 = fmul double %25, %27
  %29 = fsub double %23, %28
  store double %29, double* %sunkaddr32, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %4, %.prol.loopexit
  %.lcssa = phi double [ %.lcssa12.unr.ph, %.prol.loopexit ], [ %7, %4 ], [ %29, %._crit_edge.loopexit ]
  %30 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv17, i64 %indvars.iv17
  %31 = load double, double* %30, align 8
  %32 = fdiv double %.lcssa, %31
  %sunkaddr34 = shl i64 %indvars.iv17, 3
  ...
  br i1 %exitcond22, label %._crit_edge10, label %4
