...
for.end:                                          ; preds = %for.body3
  ...
  br i1 %exitcond30, label %for.end.for.cond15.preheader_crit_edge, label %for.cond1.preheader

for.end.for.cond15.preheader_crit_edge:           ; preds = %for.end
  br label %for.cond15.preheader

for.cond15.preheader:                             ; preds = %for.end33, %for.end.for.cond15.preheader_crit_edge
  %indvars.iv2036 = phi i64 [ 0, %for.end.for.cond15.preheader_crit_edge ], [ %indvars.iv.next21, %for.end33 ]
  br label %for.body18
...
for.end33:                                        ; preds = %for.body18
  ...
  br i1 %exitcond22, label %for.end33.for.cond41.preheader_crit_edge, label %for.cond15.preheader

for.end33.for.cond41.preheader_crit_edge:         ; preds = %for.end33
  br label %for.cond41.preheader

for.cond41.preheader:                             ; preds = %for.end58, %for.end33.for.cond41.preheader_crit_edge
  %indvars.iv1234 = phi i64 [ 0, %for.end33.for.cond41.preheader_crit_edge ], [ %indvars.iv.next13, %for.end58 ]
  br label %for.body44
...
for.end58:                                        ; preds = %for.body44
  ...
  br i1 %exitcond14, label %for.end58.for.cond66.preheader_crit_edge, label %for.cond41.preheader

for.end58.for.cond66.preheader_crit_edge:         ; preds = %for.end58
  br label %for.cond66.preheader

for.cond66.preheader:                             ; preds = %for.end84, %for.end58.for.cond66.preheader_crit_edge
  %indvars.iv432 = phi i64 [ 0, %for.end58.for.cond66.preheader_crit_edge ], [ %indvars.iv.next5, %for.end84 ]
  br label %for.body69
...
for.end23:                                        ; preds = %for.end
  ...
  br i1 %exitcond24, label %for.end23.for.cond30.preheader_crit_edge, label %for.cond1.preheader

for.end23.for.cond30.preheader_crit_edge:         ; preds = %for.end23
  br label %for.cond30.preheader

for.cond30.preheader:                             ; preds = %for.end59, %for.end23.for.cond30.preheader_crit_edge
  %indvars.iv1330 = phi i64 [ 0, %for.end23.for.cond30.preheader_crit_edge ], [ %indvars.iv.next14, %for.end59 ]
  br label %for.body32
...
for.body39:                                       ; preds = %for.body39, %for.body32
  ...
  %indvars.iv728 = phi i64 [ 0, %for.body32 ], [ %indvars.iv.next8.2, %for.body39 ]
...
for.end59:                                        ; preds = %for.end56
  ...
  br i1 %exitcond15, label %for.end59.for.cond66.preheader_crit_edge, label %for.cond30.preheader

for.end59.for.cond66.preheader_crit_edge:         ; preds = %for.end59
  br label %for.cond66.preheader

for.cond66.preheader:                             ; preds = %for.end95, %for.end59.for.cond66.preheader_crit_edge
  %indvars.iv427 = phi i64 [ 0, %for.end59.for.cond66.preheader_crit_edge ], [ %indvars.iv.next5, %for.end95 ]
  br label %for.body68
