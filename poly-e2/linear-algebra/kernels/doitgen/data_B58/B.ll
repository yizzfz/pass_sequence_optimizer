...
for.cond4.preheader.prol.loopexit:                ; preds = %for.cond4.preheader.preheader, %for.cond4.preheader.prol.loopexit.unr-lcssa
  ...
  br i1 %14, label %for.inc42.loopexit86, label %for.cond4.preheader.preheader.new
...
for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.inc39.us
  %15 = phi i32 [ %split20.us, %for.inc39.us ], [ %storemerge52, %for.cond4.preheader.us.preheader ]
...
for.body9.us32.prol:                              ; preds = %for.body6.us29
  %28 = load double, double* %arrayidx15.us34.prol, align 8
  %arrayidx19.us35.prol = getelementptr inbounds [160 x double], [160 x double]* %C4, i64 0, i64 %indvars.iv718.us30
  %29 = load double, double* %arrayidx19.us35.prol, align 8
  %mul.us36.prol = fmul double %28, %29
...
for.body9.us32:                                   ; preds = %for.body9.us32.preheader, %for.body9.us32
  %30 = phi double [ %add.us37.1, %for.body9.us32 ], [ %.unr.ph, %for.body9.us32.preheader ]
  ...
  %31 = load double, double* %arrayidx15.us34, align 8
  %arrayidx19.us35 = getelementptr inbounds [160 x double], [160 x double]* %C4, i64 %indvars.iv16.us33, i64 %indvars.iv718.us30
  %32 = load double, double* %arrayidx19.us35, align 8
  %mul.us36 = fmul double %31, %32
  %add.us37 = fadd double %30, %mul.us36
  ...
  %33 = load double, double* %arrayidx15.us34.1, align 8
  %arrayidx19.us35.1 = getelementptr inbounds [160 x double], [160 x double]* %C4, i64 %indvars.iv.next.us38, i64 %indvars.iv718.us30
  %34 = load double, double* %arrayidx19.us35.1, align 8
  %mul.us36.1 = fmul double %33, %34
...
for.body27.lr.ph.us:                              ; preds = %for.body27.lr.ph.us.loopexit, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit
  %split20.us = phi i32 [ %15, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit ], [ %storemerge52, %for.body27.lr.ph.us.loopexit ]
...
for.cond4.preheader:                              ; preds = %for.cond4.preheader, %for.cond4.preheader.preheader.new
  ...
  br i1 %exitcond56.7, label %for.inc42.loopexit86.unr-lcssa, label %for.cond4.preheader

for.inc42.loopexit:                               ; preds = %for.inc39.us
  br label %for.inc42

for.inc42.loopexit86.unr-lcssa:                   ; preds = %for.cond4.preheader
  br label %for.inc42.loopexit86

for.inc42.loopexit86:                             ; preds = %for.cond4.preheader.prol.loopexit, %for.inc42.loopexit86.unr-lcssa
  br label %for.inc42

for.inc42:                                        ; preds = %for.inc42.loopexit86, %for.inc42.loopexit, %for.cond1.preheader
  %.lcssa14 = phi i32 [ %storemerge52, %for.cond1.preheader ], [ %split20.us, %for.inc42.loopexit ], [ %storemerge52, %for.inc42.loopexit86 ]
