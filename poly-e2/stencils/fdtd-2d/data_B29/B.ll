...
for.cond10.preheader.us:                          ; preds = %for.cond10.preheader.us.preheader, %for.cond10.for.inc34_crit_edge.us
  ...
  br i1 %memcheck.conflict136, label %for.body12.us.preheader, label %vector.body112.preheader
...
vector.body112:                                   ; preds = %vector.body112.preheader, %vector.body112
  %index139 = phi i64 [ %index.next140, %vector.body112 ], [ 0, %vector.body112.preheader ]
  ...
  br i1 %20, label %middle.block113, label %vector.body112, !llvm.loop !8
...
for.cond10.for.inc34_crit_edge.us:                ; preds = %for.cond10.for.inc34_crit_edge.us.loopexit, %middle.block113
...
for.body3:                                        ; preds = %for.body3, %for.cond1.preheader
  ...
  %sunkaddr186 = mul i64 %indvars.iv1636, 8
  %sunkaddr187 = add i64 %sunkaddr, %sunkaddr186
  %sunkaddr188 = inttoptr i64 %sunkaddr187 to i64*
  %27 = load i64, i64* %sunkaddr188, align 8
  ...
  %29 = load i64, i64* %sunkaddr188, align 8
  ...
  %31 = load i64, i64* %sunkaddr188, align 8
  ...
  %33 = load i64, i64* %sunkaddr188, align 8
  ...
  %35 = load i64, i64* %sunkaddr188, align 8
  ...
  %37 = load i64, i64* %sunkaddr188, align 8
  ...
  %39 = load i64, i64* %sunkaddr188, align 8
  ...
  %41 = load i64, i64* %sunkaddr188, align 8
...
for.cond40.preheader.us:                          ; preds = %for.cond40.preheader.us.preheader, %for.cond40.for.inc66_crit_edge.us
  ...
  br i1 %memcheck.conflict95, label %for.body42.us.preheader, label %vector.body75.preheader
...
vector.body75:                                    ; preds = %vector.body75.preheader, %vector.body75
  %index98 = phi i64 [ %index.next99, %vector.body75 ], [ 0, %vector.body75.preheader ]
  ...
  br i1 %65, label %middle.block76, label %vector.body75, !llvm.loop !17

middle.block76:                                   ; preds = %vector.body75
  br label %for.body42.us.preheader

for.body42.us.preheader:                          ; preds = %middle.block76, %for.cond40.preheader.us
  %indvars.iv626.us.ph = phi i64 [ 2, %for.cond40.preheader.us ], [ 1198, %middle.block76 ]
...
for.cond40.for.inc66_crit_edge.us:                ; preds = %for.body42.us
  ...
  br i1 %exitcond47, label %for.cond73.preheader.us.preheader, label %for.cond40.preheader.us
...
for.cond73.preheader.us:                          ; preds = %for.cond73.preheader.us.preheader, %for.cond73.for.inc110_crit_edge.us
  %indvars.iv1333.us = phi i64 [ %73, %for.cond73.for.inc110_crit_edge.us ], [ 0, %for.cond73.preheader.us.preheader ]
  ...
  %73 = add i64 %indvars.iv1333.us, 1
...
for.inc113:                                       ; preds = %for.cond73.for.inc110_crit_edge.us
  ...
  br i1 %exitcond48, label %for.end115, label %for.cond1.preheader
