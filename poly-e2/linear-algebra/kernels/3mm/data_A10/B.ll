...
entry:
  %call = call i8* @polybench_alloc_data(i64 720000, i32 8) #4
  %call1 = call i8* @polybench_alloc_data(i64 800000, i32 8) #4
  %call2 = call i8* @polybench_alloc_data(i64 900000, i32 8) #4
  %call3 = call i8* @polybench_alloc_data(i64 990000, i32 8) #4
  %call4 = call i8* @polybench_alloc_data(i64 1080000, i32 8) #4
  %call5 = call i8* @polybench_alloc_data(i64 1320000, i32 8) #4
  %call6 = call i8* @polybench_alloc_data(i64 880000, i32 8) #4
  ...
  call fastcc void @init_array(i32 800, i32 900, i32 1000, i32 1100, i32 1200, [1000 x double]* %arraydecay, [900 x double]* %arraydecay7, [1200 x double]* %arraydecay8, [1100 x double]* %arraydecay9)
  ...
  call fastcc void @kernel_3mm(i32 800, i32 900, i32 1000, i32 1100, i32 1200, [900 x double]* %arraydecay10, [1000 x double]* %arraydecay, [900 x double]* %arraydecay7, [1100 x double]* %arraydecay13, [1200 x double]* %arraydecay8, [1100 x double]* %arraydecay9, [1100 x double]* %arraydecay16)
...
if.then:                                          ; preds = %land.lhs.true
  ...
  call fastcc void @print_array(i32 800, i32 1100, [1100 x double]* %1)
  br label %if.end
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc8_crit_edge.us, %entry
  %indvars.iv82 = phi i64 [ 0, %entry ], [ %indvars.iv.next83, %for.cond1.for.inc8_crit_edge.us ]
  br label %for.body3.us

for.body3.us:                                     ; preds = %for.body3.us, %for.cond1.preheader.us
  %indvars.iv76 = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next77, %for.body3.us ]
  ...
  br i1 %exitcond81, label %for.cond1.for.inc8_crit_edge.us, label %for.body3.us
...
for.cond15.preheader.us:                          ; preds = %for.cond15.preheader.us.preheader, %for.cond15.for.inc34_crit_edge.us
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.cond15.for.inc34_crit_edge.us ], [ 0, %for.cond15.preheader.us.preheader ]
...
for.body18.us:                                    ; preds = %for.body18.us, %for.cond15.preheader.us
  ...
  %3 = mul nsw i64 %indvars.iv72, %indvars.iv.next69
  %4 = add nsw i64 %3, 2
  %5 = trunc i64 %4 to i32
  %rem22.us = srem i32 %5, 900
  %conv23.us = sitofp i32 %rem22.us to double
  %div26.us = fdiv double %conv23.us, 4.500000e+03
  %arrayidx30.us = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv72, i64 %indvars.iv68
  store double %div26.us, double* %arrayidx30.us, align 8
  %exitcond = icmp eq i64 %indvars.iv.next69, 900
  br i1 %exitcond, label %for.cond15.for.inc34_crit_edge.us, label %for.body18.us

for.cond15.for.inc34_crit_edge.us:                ; preds = %for.body18.us
  %indvars.iv.next73 = add nsw i64 %indvars.iv72, 1
  %cmp12.us = icmp slt i64 %indvars.iv.next73, 1000
...
for.cond41.preheader.us:                          ; preds = %for.cond41.preheader.us.preheader, %for.cond41.for.inc59_crit_edge.us
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.cond41.for.inc59_crit_edge.us ], [ 0, %for.cond41.preheader.us.preheader ]
  br label %for.body44.us

for.body44.us:                                    ; preds = %for.body44.us, %for.cond41.preheader.us
  %indvars.iv60 = phi i64 [ 0, %for.cond41.preheader.us ], [ %indvars.iv.next61, %for.body44.us ]
  %6 = add nuw nsw i64 %indvars.iv60, 3
  %7 = mul nsw i64 %indvars.iv64, %6
  %8 = trunc i64 %7 to i32
  %rem47.us = srem i32 %8, 1100
  %conv48.us = sitofp i32 %rem47.us to double
  %div51.us = fdiv double %conv48.us, 5.500000e+03
  %arrayidx55.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv64, i64 %indvars.iv60
  store double %div51.us, double* %arrayidx55.us, align 8
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  %cmp42.us = icmp slt i64 %indvars.iv.next61, 1200
  br i1 %cmp42.us, label %for.body44.us, label %for.cond41.for.inc59_crit_edge.us

for.cond41.for.inc59_crit_edge.us:                ; preds = %for.body44.us
  %indvars.iv.next65 = add nsw i64 %indvars.iv64, 1
  %cmp38.us = icmp slt i64 %indvars.iv.next65, 900
...
for.cond66.preheader.us:                          ; preds = %for.cond66.preheader.us.preheader, %for.cond66.for.inc85_crit_edge.us
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.cond66.for.inc85_crit_edge.us ], [ 0, %for.cond66.preheader.us.preheader ]
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc24_crit_edge.us, %entry
  %indvars.iv204 = phi i64 [ 0, %entry ], [ %indvars.iv.next205, %for.cond1.for.inc24_crit_edge.us ]
  br label %for.body3.us.us

for.cond1.for.inc24_crit_edge.us:                 ; preds = %for.body8.us.us.for.cond6.for.inc21_crit_edge.us.us_crit_edge
  %indvars.iv.next205 = add nsw i64 %indvars.iv204, 1
  %cmp.us = icmp slt i64 %indvars.iv.next205, 800
...
for.body3.us.us:                                  ; preds = %for.body8.us.us.for.cond6.for.inc21_crit_edge.us.us_crit_edge, %for.cond1.preheader.us
  %indvars.iv198 = phi i64 [ 0, %for.cond1.preheader.us ], [ %indvars.iv.next199, %for.body8.us.us.for.cond6.for.inc21_crit_edge.us.us_crit_edge ]
  %arrayidx5.us.us = getelementptr inbounds [900 x double], [900 x double]* %E, i64 %indvars.iv204, i64 %indvars.iv198
...
for.body8.us.us:                                  ; preds = %for.body8.us.us, %for.body3.us.us
  ...
  %indvars.iv192 = phi i64 [ 0, %for.body3.us.us ], [ %indvars.iv.next193.1, %for.body8.us.us ]
  %arrayidx12.us.us = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv204, i64 %indvars.iv192
  %1 = load double, double* %arrayidx12.us.us, align 8
  %arrayidx16.us.us = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv192, i64 %indvars.iv198
  ...
  %arrayidx12.us.us.1 = getelementptr inbounds [1000 x double], [1000 x double]* %A, i64 %indvars.iv204, i64 %indvars.iv.next193
  %3 = load double, double* %arrayidx12.us.us.1, align 8
  %arrayidx16.us.us.1 = getelementptr inbounds [900 x double], [900 x double]* %B, i64 %indvars.iv.next193, i64 %indvars.iv198
  ...
  %exitcond195.1 = icmp eq i64 %indvars.iv.next193.1, 1000
  br i1 %exitcond195.1, label %for.body8.us.us.for.cond6.for.inc21_crit_edge.us.us_crit_edge, label %for.body8.us.us

for.body8.us.us.for.cond6.for.inc21_crit_edge.us.us_crit_edge: ; preds = %for.body8.us.us
  %indvars.iv.next199 = add nuw nsw i64 %indvars.iv198, 1
  %exitcond201 = icmp eq i64 %indvars.iv.next199, 900
  br i1 %exitcond201, label %for.cond1.for.inc24_crit_edge.us, label %for.body3.us.us

for.cond30.preheader.us:                          ; preds = %for.cond30.preheader.us.preheader, %for.cond30.for.inc60_crit_edge.us
  %indvars.iv179 = phi i64 [ %indvars.iv.next180, %for.cond30.for.inc60_crit_edge.us ], [ 0, %for.cond30.preheader.us.preheader ]
  br label %for.body32.us.us

for.cond30.for.inc60_crit_edge.us:                ; preds = %for.body39.us.us.for.cond37.for.inc57_crit_edge.us.us_crit_edge
  %indvars.iv.next180 = add nsw i64 %indvars.iv179, 1
  %cmp28.us = icmp slt i64 %indvars.iv.next180, 900
...
for.body32.us.us:                                 ; preds = %for.body39.us.us.for.cond37.for.inc57_crit_edge.us.us_crit_edge, %for.cond30.preheader.us
  %indvars.iv173 = phi i64 [ 0, %for.cond30.preheader.us ], [ %indvars.iv.next174, %for.body39.us.us.for.cond37.for.inc57_crit_edge.us.us_crit_edge ]
  %arrayidx36.us.us = getelementptr inbounds [1100 x double], [1100 x double]* %F, i64 %indvars.iv179, i64 %indvars.iv173
...
for.body39.us.us:                                 ; preds = %for.body39.us.us, %for.body32.us.us
  ...
  %arrayidx43.us.us = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv179, i64 %indvars.iv167
  %6 = load double, double* %arrayidx43.us.us, align 8
  %arrayidx47.us.us = getelementptr inbounds [1100 x double], [1100 x double]* %D, i64 %indvars.iv167, i64 %indvars.iv173
  ...
  %arrayidx43.us.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %C, i64 %indvars.iv179, i64 %indvars.iv.next168
  %8 = load double, double* %arrayidx43.us.us.1, align 8
  %arrayidx47.us.us.1 = getelementptr inbounds [1100 x double], [1100 x double]* %D, i64 %indvars.iv.next168, i64 %indvars.iv173
  ...
  br i1 %exitcond170.1, label %for.body39.us.us.for.cond37.for.inc57_crit_edge.us.us_crit_edge, label %for.body39.us.us

for.body39.us.us.for.cond37.for.inc57_crit_edge.us.us_crit_edge: ; preds = %for.body39.us.us
  %indvars.iv.next174 = add nuw nsw i64 %indvars.iv173, 1
  %exitcond176 = icmp eq i64 %indvars.iv.next174, 1100
  br i1 %exitcond176, label %for.cond30.for.inc60_crit_edge.us, label %for.body32.us.us

for.cond66.preheader.us:                          ; preds = %for.cond66.preheader.us.preheader, %for.cond66.for.inc96_crit_edge.us
  %indvars.iv156 = phi i64 [ %indvars.iv.next157, %for.cond66.for.inc96_crit_edge.us ], [ 0, %for.cond66.preheader.us.preheader ]
  br label %for.body68.us.us

for.cond66.for.inc96_crit_edge.us:                ; preds = %for.body75.us.us.for.cond73.for.inc93_crit_edge.us.us_crit_edge
  %indvars.iv.next157 = add nsw i64 %indvars.iv156, 1
  %cmp64.us = icmp slt i64 %indvars.iv.next157, 800
  br i1 %cmp64.us, label %for.cond66.preheader.us, label %for.end98

for.body68.us.us:                                 ; preds = %for.body75.us.us.for.cond73.for.inc93_crit_edge.us.us_crit_edge, %for.cond66.preheader.us
  %indvars.iv151 = phi i64 [ 0, %for.cond66.preheader.us ], [ %indvars.iv.next152, %for.body75.us.us.for.cond73.for.inc93_crit_edge.us.us_crit_edge ]
  %arrayidx72.us.us = getelementptr inbounds [1100 x double], [1100 x double]* %G, i64 %indvars.iv156, i64 %indvars.iv151
...
for.body75.us.us:                                 ; preds = %for.body75.us.us, %for.body68.us.us
  ...
  %arrayidx79.us.us = getelementptr inbounds [900 x double], [900 x double]* %E, i64 %indvars.iv156, i64 %indvars.iv
  %11 = load double, double* %arrayidx79.us.us, align 8
  %arrayidx83.us.us = getelementptr inbounds [1100 x double], [1100 x double]* %F, i64 %indvars.iv, i64 %indvars.iv151
  ...
  %arrayidx79.us.us.1 = getelementptr inbounds [900 x double], [900 x double]* %E, i64 %indvars.iv156, i64 %indvars.iv.next
  %13 = load double, double* %arrayidx79.us.us.1, align 8
  %arrayidx83.us.us.1 = getelementptr inbounds [1100 x double], [1100 x double]* %F, i64 %indvars.iv.next, i64 %indvars.iv151
  ...
  br i1 %exitcond.1, label %for.body75.us.us.for.cond73.for.inc93_crit_edge.us.us_crit_edge, label %for.body75.us.us

for.body75.us.us.for.cond73.for.inc93_crit_edge.us.us_crit_edge: ; preds = %for.body75.us.us
  %indvars.iv.next152 = add nuw nsw i64 %indvars.iv151, 1
  %exitcond = icmp eq i64 %indvars.iv.next152, 1100
