...
.preheader37.lr.ph:                               ; preds = %7
  ...
  br i1 %9, label %.preheader37.us.preheader, label %.preheader.lr.ph
...
; <label>:12:                                     ; preds = %12, %.preheader37.us
  %indvars.iv52 = phi i64 [ 0, %.preheader37.us ], [ %indvars.iv.next53, %12 ]
  %13 = mul nuw nsw i64 %indvars.iv52, %indvars.iv56
  %14 = add nuw nsw i64 %13, 1
  %15 = trunc i64 %14 to i32
  %16 = srem i32 %15, %0
  %17 = sitofp i32 %16 to double
  %18 = fdiv double %17, %10
  %19 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv56, i64 %indvars.iv52
  ...
  %25 = getelementptr inbounds [1000 x double], [1000 x double]* %6, i64 %indvars.iv56, i64 %indvars.iv52
  store double %24, double* %25, align 8
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1
  %exitcond55 = icmp eq i64 %indvars.iv.next53, %wide.trip.count54
  br i1 %exitcond55, label %._crit_edge44.us, label %12

._crit_edge44.us:                                 ; preds = %12
  %indvars.iv.next57 = add nuw nsw i64 %indvars.iv56, 1
  %exitcond59 = icmp eq i64 %indvars.iv.next57, %wide.trip.count58
  br i1 %exitcond59, label %.preheader36, label %.preheader37.us

.preheader36:                                     ; preds = %._crit_edge44.us
  %26 = icmp sgt i32 %0, 0
  br i1 %26, label %.preheader.lr.ph, label %._crit_edge41

.preheader.lr.ph:                                 ; preds = %.preheader37.lr.ph, %.preheader36
...
; <label>:28:                                     ; preds = %28, %.preheader.us
  ...
  %29 = mul nuw nsw i64 %indvars.iv, %indvars.iv48
  %30 = add nuw nsw i64 %29, 3
  %31 = trunc i64 %30 to i32
  %32 = srem i32 %31, %0
  %33 = sitofp i32 %32 to double
  %34 = fdiv double %33, %27
  %35 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv48, i64 %indvars.iv
...
._crit_edge41:                                    ; preds = %._crit_edge41.loopexit, %7, %.preheader36
  ret void
}
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.loopexit, %.lr.ph.us
  ...
  br i1 %76, label %.preheader.us46.preheader, label %.lr.ph.us.new.preheader
