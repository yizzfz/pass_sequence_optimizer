...
.lr.ph.us:                                        ; preds = %._crit_edge.us, %.lr.ph6
  ...
  %10 = getelementptr inbounds double, double* %1, i64 %indvars.iv8
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  %11 = icmp eq i64 %indvars.iv.next9, 2000
  %12 = trunc i64 %indvars.iv.next9 to i32
  ...
  %20 = getelementptr inbounds double, double* %2, i64 %indvars.iv8
  store double %19, double* %20, align 8
  %21 = add nuw nsw i64 %indvars.iv8, 3
  %22 = trunc i64 %21 to i32
  %23 = srem i32 %22, 2000
  %24 = sitofp i32 %23 to double
  %25 = getelementptr inbounds double, double* %3, i64 %indvars.iv8
  %26 = add nuw nsw i64 %indvars.iv8, 4
  ...
  %35 = getelementptr inbounds double, double* %4, i64 %indvars.iv8
  store double %34, double* %35, align 8
  br i1 true, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.lr.ph.us
  %36 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv8, i64 0
...
.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph.us
  ...
  br i1 false, label %._crit_edge.us, label %.lr.ph.us.new.preheader
...
.lr.ph.us.new:                                    ; preds = %.lr.ph.us.new.preheader, %.lr.ph.us.new
  ...
  %37 = mul nuw nsw i64 %indvars.iv, %indvars.iv8
  %38 = trunc i64 %37 to i32
  %39 = srem i32 %38, 2000
  %40 = sitofp i32 %39 to double
  %41 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv8, i64 %indvars.iv
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %42 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv8
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %.prol.loopexit
  br i1 %11, label %._crit_edge7.loopexit, label %.lr.ph.us
...
.preheader4.us:                                   ; preds = %.preheader4.us.preheader, %._crit_edge10.us
  ...
  br i1 true, label %.prol.loopexit40, label %.prol.preheader39

.prol.preheader39:                                ; preds = %.preheader4.us
  %sunkaddr24.prol = shl i64 %indvars.iv20, 3
  %sunkaddr25.prol = add i64 %sunkaddr, %sunkaddr24.prol
  %sunkaddr26.prol = inttoptr i64 %sunkaddr25.prol to double*
  %7 = load double, double* %sunkaddr26.prol, align 8
  %8 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv20, i64 0
  %9 = load double, double* %8, align 8
  %10 = load double, double* %3, align 8
  %11 = fmul double %9, %10
  %12 = fadd double %7, %11
  store double %12, double* %sunkaddr26.prol, align 8
  br label %.prol.loopexit40

.prol.loopexit40:                                 ; preds = %.prol.preheader39, %.preheader4.us
  %indvars.iv16.unr.ph = phi i64 [ 1, %.prol.preheader39 ], [ 0, %.preheader4.us ]
  br i1 false, label %._crit_edge10.us, label %.preheader4.us.new.preheader

.preheader4.us.new.preheader:                     ; preds = %.prol.loopexit40
  %sunkaddr24 = shl i64 %indvars.iv20, 3
  %sunkaddr25 = add i64 %sunkaddr, %sunkaddr24
  %sunkaddr26 = inttoptr i64 %sunkaddr25 to double*
  %.pre = load double, double* %sunkaddr26, align 8
  br label %.preheader4.us.new

.preheader4.us.new:                               ; preds = %.preheader4.us.new.preheader, %.preheader4.us.new
  %13 = phi double [ %25, %.preheader4.us.new ], [ %.pre, %.preheader4.us.new.preheader ]
  %indvars.iv16 = phi i64 [ %indvars.iv.next17.1, %.preheader4.us.new ], [ %indvars.iv16.unr.ph, %.preheader4.us.new.preheader ]
  %14 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv20, i64 %indvars.iv16
  %15 = load double, double* %14, align 8
  %16 = getelementptr inbounds double, double* %3, i64 %indvars.iv16
  %17 = load double, double* %16, align 8
  %18 = fmul double %15, %17
  %19 = fadd double %13, %18
  store double %19, double* %sunkaddr26, align 8
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  %20 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv20, i64 %indvars.iv.next17
  %21 = load double, double* %20, align 8
  %22 = getelementptr inbounds double, double* %3, i64 %indvars.iv.next17
  %23 = load double, double* %22, align 8
  %24 = fmul double %21, %23
  %25 = fadd double %19, %24
  store double %25, double* %sunkaddr26, align 8
  %indvars.iv.next17.1 = add nuw nsw i64 %indvars.iv16, 2
  %exitcond19.1 = icmp eq i64 %indvars.iv.next17.1, 2000
  br i1 %exitcond19.1, label %._crit_edge10.us.loopexit, label %.preheader4.us.new

._crit_edge10.us.loopexit:                        ; preds = %.preheader4.us.new
  br label %._crit_edge10.us

._crit_edge10.us:                                 ; preds = %._crit_edge10.us.loopexit, %.prol.loopexit40
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  %exitcond23 = icmp eq i64 %indvars.iv.next21, 2000
...
.prol.preheader:                                  ; preds = %.preheader.us
  %sunkaddr32.prol = shl i64 %indvars.iv12, 3
  %sunkaddr33.prol = add i64 %sunkaddr31, %sunkaddr32.prol
  %sunkaddr34.prol = inttoptr i64 %sunkaddr33.prol to double*
  %26 = load double, double* %sunkaddr34.prol, align 8
  %27 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 0, i64 %indvars.iv12
  %28 = load double, double* %27, align 8
  %29 = load double, double* %4, align 8
  %30 = fmul double %28, %29
  %31 = fadd double %26, %30
  store double %31, double* %sunkaddr34.prol, align 8
  br label %.prol.loopexit
...
.preheader.us.new.preheader:                      ; preds = %.prol.loopexit
  ...
  %.pre43 = load double, double* %sunkaddr34, align 8
  br label %.preheader.us.new

.preheader.us.new:                                ; preds = %.preheader.us.new.preheader, %.preheader.us.new
  %32 = phi double [ %44, %.preheader.us.new ], [ %.pre43, %.preheader.us.new.preheader ]
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.preheader.us.new ], [ %indvars.iv.unr.ph, %.preheader.us.new.preheader ]
  %33 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv, i64 %indvars.iv12
  %34 = load double, double* %33, align 8
  %35 = getelementptr inbounds double, double* %4, i64 %indvars.iv
  %36 = load double, double* %35, align 8
  %37 = fmul double %34, %36
  %38 = fadd double %32, %37
  store double %38, double* %sunkaddr34, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %39 = getelementptr inbounds [2000 x double], [2000 x double]* %5, i64 %indvars.iv.next, i64 %indvars.iv12
  %40 = load double, double* %39, align 8
  %41 = getelementptr inbounds double, double* %4, i64 %indvars.iv.next
  %42 = load double, double* %41, align 8
  %43 = fmul double %40, %42
  %44 = fadd double %38, %43
  store double %44, double* %sunkaddr34, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %.prol.loopexit
  ...
  br i1 %exitcond15, label %._crit_edge7.loopexit, label %.preheader.us
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %._crit_edge.critedge, %._crit_edge8
