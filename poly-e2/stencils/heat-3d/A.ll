...
entry:
  ...
  %0 = bitcast i8* %call to [120 x [120 x [120 x double]]]*
  store [120 x [120 x [120 x double]]]* %0, [120 x [120 x [120 x double]]]** %A, align 8
  %call1 = call i8* @polybench_alloc_data(i64 1728000, i32 8)
  %1 = bitcast i8* %call1 to [120 x [120 x [120 x double]]]*
  store [120 x [120 x [120 x double]]]* %1, [120 x [120 x [120 x double]]]** %B, align 8
  %2 = load i32, i32* %n, align 4
  %3 = load [120 x [120 x [120 x double]]]*, [120 x [120 x [120 x double]]]** %A, align 8
  %arraydecay = getelementptr inbounds [120 x [120 x [120 x double]]], [120 x [120 x [120 x double]]]* %3, i32 0, i32 0
  %4 = load [120 x [120 x [120 x double]]]*, [120 x [120 x [120 x double]]]** %B, align 8
  %arraydecay2 = getelementptr inbounds [120 x [120 x [120 x double]]], [120 x [120 x [120 x double]]]* %4, i32 0, i32 0
  call void @init_array(i32 %2, [120 x [120 x double]]* %arraydecay, [120 x [120 x double]]* %arraydecay2)
  call void (...) @polybench_timer_start()
  %5 = load i32, i32* %tsteps, align 4
  %6 = load i32, i32* %n, align 4
  %7 = load [120 x [120 x [120 x double]]]*, [120 x [120 x [120 x double]]]** %A, align 8
  %arraydecay3 = getelementptr inbounds [120 x [120 x [120 x double]]], [120 x [120 x [120 x double]]]* %7, i32 0, i32 0
  %8 = load [120 x [120 x [120 x double]]]*, [120 x [120 x [120 x double]]]** %B, align 8
  %arraydecay4 = getelementptr inbounds [120 x [120 x [120 x double]]], [120 x [120 x [120 x double]]]* %8, i32 0, i32 0
  call void @kernel_heat_3d(i32 %5, i32 %6, [120 x [120 x double]]* %arraydecay3, [120 x [120 x double]]* %arraydecay4)
...
land.lhs.true:                                    ; preds = %entry
  ...
  %call5 = call i32 @strcmp(i8* %11, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i32 0, i32 0)) #4
  %tobool = icmp ne i32 %call5, 0
  br i1 %tobool, label %if.end, label %if.then

if.then:                                          ; preds = %land.lhs.true
  %12 = load i32, i32* %n, align 4
  %13 = load [120 x [120 x [120 x double]]]*, [120 x [120 x [120 x double]]]** %A, align 8
  %arraydecay6 = getelementptr inbounds [120 x [120 x [120 x double]]], [120 x [120 x [120 x double]]]* %13, i32 0, i32 0
  call void @print_array(i32 %12, [120 x [120 x double]]* %arraydecay6)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  %14 = load [120 x [120 x [120 x double]]]*, [120 x [120 x [120 x double]]]** %A, align 8
  %15 = bitcast [120 x [120 x [120 x double]]]* %14 to i8*
...
for.body6:                                        ; preds = %for.cond4
  ...
  %15 = load [120 x [120 x double]]*, [120 x [120 x double]]** %A.addr, align 8
  %16 = load i32, i32* %i, align 4
  %idxprom13 = sext i32 %16 to i64
  %arrayidx14 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %15, i64 %idxprom13
...
for.body11:                                       ; preds = %for.cond8
  ...
  %arrayidx = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %7, i64 %idxprom
  ...
  %12 = load [120 x [120 x double]]*, [120 x [120 x double]]** %A.addr, align 8
  %13 = load i32, i32* %i, align 4
  %idxprom16 = sext i32 %13 to i64
  %arrayidx17 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %12, i64 %idxprom16
  ...
  %sub22 = fsub double %11, %mul
  %17 = load [120 x [120 x double]]*, [120 x [120 x double]]** %A.addr, align 8
  %18 = load i32, i32* %i, align 4
  %sub23 = sub nsw i32 %18, 1
  %idxprom24 = sext i32 %sub23 to i64
  %arrayidx25 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %17, i64 %idxprom24
  ...
  %add30 = fadd double %sub22, %21
  %mul31 = fmul double 1.250000e-01, %add30
  %22 = load [120 x [120 x double]]*, [120 x [120 x double]]** %A.addr, align 8
  %23 = load i32, i32* %i, align 4
  %idxprom32 = sext i32 %23 to i64
  %arrayidx33 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %22, i64 %idxprom32
  ...
  %27 = load [120 x [120 x double]]*, [120 x [120 x double]]** %A.addr, align 8
  %28 = load i32, i32* %i, align 4
  %idxprom39 = sext i32 %28 to i64
  %arrayidx40 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %27, i64 %idxprom39
  ...
  %mul45 = fmul double 2.000000e+00, %31
  %sub46 = fsub double %26, %mul45
  %32 = load [120 x [120 x double]]*, [120 x [120 x double]]** %A.addr, align 8
  %33 = load i32, i32* %i, align 4
  %idxprom47 = sext i32 %33 to i64
  %arrayidx48 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %32, i64 %idxprom47
  ...
  %add54 = fadd double %sub46, %36
  %mul55 = fmul double 1.250000e-01, %add54
  %add56 = fadd double %mul31, %mul55
  %37 = load [120 x [120 x double]]*, [120 x [120 x double]]** %A.addr, align 8
  %38 = load i32, i32* %i, align 4
  %idxprom57 = sext i32 %38 to i64
  %arrayidx58 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %37, i64 %idxprom57
  ...
  %42 = load [120 x [120 x double]]*, [120 x [120 x double]]** %A.addr, align 8
  %43 = load i32, i32* %i, align 4
  %idxprom64 = sext i32 %43 to i64
  %arrayidx65 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %42, i64 %idxprom64
  ...
  %mul70 = fmul double 2.000000e+00, %46
  %sub71 = fsub double %41, %mul70
  %47 = load [120 x [120 x double]]*, [120 x [120 x double]]** %A.addr, align 8
  %48 = load i32, i32* %i, align 4
  %idxprom72 = sext i32 %48 to i64
  %arrayidx73 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %47, i64 %idxprom72
  ...
  %add79 = fadd double %sub71, %51
  %mul80 = fmul double 1.250000e-01, %add79
  %add81 = fadd double %add56, %mul80
  %52 = load [120 x [120 x double]]*, [120 x [120 x double]]** %A.addr, align 8
  %53 = load i32, i32* %i, align 4
  %idxprom82 = sext i32 %53 to i64
  %arrayidx83 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %52, i64 %idxprom82
  ...
  %add88 = fadd double %add81, %56
  %57 = load [120 x [120 x double]]*, [120 x [120 x double]]** %B.addr, align 8
  %58 = load i32, i32* %i, align 4
  %idxprom89 = sext i32 %58 to i64
  %arrayidx90 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %57, i64 %idxprom89
...
for.body112:                                      ; preds = %for.cond109
  %70 = load [120 x [120 x double]]*, [120 x [120 x double]]** %B.addr, align 8
  %71 = load i32, i32* %i, align 4
  %add113 = add nsw i32 %71, 1
  %idxprom114 = sext i32 %add113 to i64
  %arrayidx115 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %70, i64 %idxprom114
  ...
  %75 = load [120 x [120 x double]]*, [120 x [120 x double]]** %B.addr, align 8
  %76 = load i32, i32* %i, align 4
  %idxprom120 = sext i32 %76 to i64
  %arrayidx121 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %75, i64 %idxprom120
  ...
  %mul126 = fmul double 2.000000e+00, %79
  %sub127 = fsub double %74, %mul126
  %80 = load [120 x [120 x double]]*, [120 x [120 x double]]** %B.addr, align 8
  %81 = load i32, i32* %i, align 4
  %sub128 = sub nsw i32 %81, 1
  %idxprom129 = sext i32 %sub128 to i64
  %arrayidx130 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %80, i64 %idxprom129
  ...
  %add135 = fadd double %sub127, %84
  %mul136 = fmul double 1.250000e-01, %add135
  %85 = load [120 x [120 x double]]*, [120 x [120 x double]]** %B.addr, align 8
  %86 = load i32, i32* %i, align 4
  %idxprom137 = sext i32 %86 to i64
  %arrayidx138 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %85, i64 %idxprom137
  ...
  %90 = load [120 x [120 x double]]*, [120 x [120 x double]]** %B.addr, align 8
  %91 = load i32, i32* %i, align 4
  %idxprom144 = sext i32 %91 to i64
  %arrayidx145 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %90, i64 %idxprom144
  ...
  %mul150 = fmul double 2.000000e+00, %94
  %sub151 = fsub double %89, %mul150
  %95 = load [120 x [120 x double]]*, [120 x [120 x double]]** %B.addr, align 8
  %96 = load i32, i32* %i, align 4
  %idxprom152 = sext i32 %96 to i64
  %arrayidx153 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %95, i64 %idxprom152
  ...
  %add159 = fadd double %sub151, %99
  %mul160 = fmul double 1.250000e-01, %add159
  %add161 = fadd double %mul136, %mul160
  %100 = load [120 x [120 x double]]*, [120 x [120 x double]]** %B.addr, align 8
  %101 = load i32, i32* %i, align 4
  %idxprom162 = sext i32 %101 to i64
  %arrayidx163 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %100, i64 %idxprom162
  ...
  %105 = load [120 x [120 x double]]*, [120 x [120 x double]]** %B.addr, align 8
  %106 = load i32, i32* %i, align 4
  %idxprom169 = sext i32 %106 to i64
  %arrayidx170 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %105, i64 %idxprom169
  ...
  %mul175 = fmul double 2.000000e+00, %109
  %sub176 = fsub double %104, %mul175
  %110 = load [120 x [120 x double]]*, [120 x [120 x double]]** %B.addr, align 8
  %111 = load i32, i32* %i, align 4
  %idxprom177 = sext i32 %111 to i64
  %arrayidx178 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %110, i64 %idxprom177
  ...
  %add184 = fadd double %sub176, %114
  %mul185 = fmul double 1.250000e-01, %add184
  %add186 = fadd double %add161, %mul185
  %115 = load [120 x [120 x double]]*, [120 x [120 x double]]** %B.addr, align 8
  %116 = load i32, i32* %i, align 4
  %idxprom187 = sext i32 %116 to i64
  %arrayidx188 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %115, i64 %idxprom187
  ...
  %add193 = fadd double %add186, %119
  %120 = load [120 x [120 x double]]*, [120 x [120 x double]]** %A.addr, align 8
  %121 = load i32, i32* %i, align 4
  %idxprom194 = sext i32 %121 to i64
  %arrayidx195 = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %120, i64 %idxprom194
...
if.then:                                          ; preds = %for.body7
  ...
  %call12 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %14, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body7
  %15 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %16 = load [120 x [120 x double]]*, [120 x [120 x double]]** %A.addr, align 8
  %17 = load i32, i32* %i, align 4
  %idxprom = sext i32 %17 to i64
  %arrayidx = getelementptr inbounds [120 x [120 x double]], [120 x [120 x double]]* %16, i64 %idxprom
  ...
  %call17 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %15, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i32 0, i32 0), double %20)
  br label %for.inc
...
for.end23:                                        ; preds = %for.cond
  ...
  %call24 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %24, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  %25 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %call25 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %25, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.7, i32 0, i32 0))
  ret void
}
