...
entry:
  ...
  store [2000 x double]* %1, [2000 x double]** %x1, align 8
  %call2 = call i8* @polybench_alloc_data(i64 2000, i32 8)
  %2 = bitcast i8* %call2 to [2000 x double]*
  store [2000 x double]* %2, [2000 x double]** %x2, align 8
  %call3 = call i8* @polybench_alloc_data(i64 2000, i32 8)
  %3 = bitcast i8* %call3 to [2000 x double]*
  store [2000 x double]* %3, [2000 x double]** %y_1, align 8
  %call4 = call i8* @polybench_alloc_data(i64 2000, i32 8)
  %4 = bitcast i8* %call4 to [2000 x double]*
  store [2000 x double]* %4, [2000 x double]** %y_2, align 8
  %5 = load i32, i32* %n, align 4
  %6 = load [2000 x double]*, [2000 x double]** %x1, align 8
  %arraydecay = getelementptr inbounds [2000 x double], [2000 x double]* %6, i32 0, i32 0
  %7 = load [2000 x double]*, [2000 x double]** %x2, align 8
  %arraydecay5 = getelementptr inbounds [2000 x double], [2000 x double]* %7, i32 0, i32 0
  %8 = load [2000 x double]*, [2000 x double]** %y_1, align 8
  %arraydecay6 = getelementptr inbounds [2000 x double], [2000 x double]* %8, i32 0, i32 0
  %9 = load [2000 x double]*, [2000 x double]** %y_2, align 8
  %arraydecay7 = getelementptr inbounds [2000 x double], [2000 x double]* %9, i32 0, i32 0
  %10 = load [2000 x [2000 x double]]*, [2000 x [2000 x double]]** %A, align 8
  %arraydecay8 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %10, i32 0, i32 0
  call void @init_array(i32 %5, double* %arraydecay, double* %arraydecay5, double* %arraydecay6, double* %arraydecay7, [2000 x double]* %arraydecay8)
  call void (...) @polybench_timer_start()
  %11 = load i32, i32* %n, align 4
  %12 = load [2000 x double]*, [2000 x double]** %x1, align 8
  %arraydecay9 = getelementptr inbounds [2000 x double], [2000 x double]* %12, i32 0, i32 0
  %13 = load [2000 x double]*, [2000 x double]** %x2, align 8
  %arraydecay10 = getelementptr inbounds [2000 x double], [2000 x double]* %13, i32 0, i32 0
  %14 = load [2000 x double]*, [2000 x double]** %y_1, align 8
  %arraydecay11 = getelementptr inbounds [2000 x double], [2000 x double]* %14, i32 0, i32 0
  %15 = load [2000 x double]*, [2000 x double]** %y_2, align 8
  %arraydecay12 = getelementptr inbounds [2000 x double], [2000 x double]* %15, i32 0, i32 0
  %16 = load [2000 x [2000 x double]]*, [2000 x [2000 x double]]** %A, align 8
  %arraydecay13 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %16, i32 0, i32 0
  call void @kernel_mvt(i32 %11, double* %arraydecay9, double* %arraydecay10, double* %arraydecay11, double* %arraydecay12, [2000 x double]* %arraydecay13)
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %21 = load [2000 x double]*, [2000 x double]** %x1, align 8
  %arraydecay15 = getelementptr inbounds [2000 x double], [2000 x double]* %21, i32 0, i32 0
  %22 = load [2000 x double]*, [2000 x double]** %x2, align 8
  %arraydecay16 = getelementptr inbounds [2000 x double], [2000 x double]* %22, i32 0, i32 0
...
if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  ...
  %25 = load [2000 x double]*, [2000 x double]** %x1, align 8
  %26 = bitcast [2000 x double]* %25 to i8*
  call void @free(i8* %26) #5
  %27 = load [2000 x double]*, [2000 x double]** %x2, align 8
  %28 = bitcast [2000 x double]* %27 to i8*
  call void @free(i8* %28) #5
  %29 = load [2000 x double]*, [2000 x double]** %y_1, align 8
  %30 = bitcast [2000 x double]* %29 to i8*
  call void @free(i8* %30) #5
  %31 = load [2000 x double]*, [2000 x double]** %y_2, align 8
...
for.body25:                                       ; preds = %for.cond22
  ...
  %arrayidx31 = getelementptr inbounds [2000 x double], [2000 x double]* %28, i64 %idxprom30
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx5 = getelementptr inbounds [2000 x double], [2000 x double]* %7, i64 %idxprom4
...
for.body20:                                       ; preds = %for.cond18
  ...
  %arrayidx24 = getelementptr inbounds [2000 x double], [2000 x double]* %25, i64 %idxprom23
...
for.end:                                          ; preds = %for.cond
  ...
  %call5 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %11, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0))
  %12 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %12, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.7, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %for.cond7
...
if.then12:                                        ; preds = %for.body9
  ...
  %call13 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %16, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  br label %if.end14
...
if.end14:                                         ; preds = %if.then12, %for.body9
  ...
  %call17 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %17, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i32 0, i32 0), double %20)
  br label %for.inc18
...
for.end20:                                        ; preds = %for.cond7
  ...
  %call21 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %22, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.7, i32 0, i32 0))
  %23 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %call22 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %23, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.8, i32 0, i32 0))
  ret void
}
