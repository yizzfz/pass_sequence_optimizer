...
entry:
  ...
  %cmp59 = icmp sgt i32 %nr, 0
  br i1 %cmp59, label %for.cond1.preheader.lr.ph, label %for.end44
...
for.cond1.preheader:                              ; preds = %for.inc42, %for.cond1.preheader.lr.ph
  %indvars.iv2660 = phi i64 [ 0, %for.cond1.preheader.lr.ph ], [ %indvars.iv.next27, %for.inc42 ]
...
for.body6.us40.preheader:                         ; preds = %for.cond4.preheader.us
  %arrayidx15.us45.prol = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %indvars.iv2660, i64 %indvars.iv2436.us, i64 0
...
for.inc39.us:                                     ; preds = %for.inc39.us.loopexit, %for.inc36.us.prol.loopexit, %for.cond4.for.cond25.preheader_crit_edge.us
  ...
  %exitcond73 = icmp eq i64 %indvars.iv.next25.us, %1
  br i1 %exitcond73, label %for.inc42.loopexit, label %for.cond4.preheader.us

for.inc36.us:                                     ; preds = %for.inc36.us.preheader95, %for.inc36.us
  %indvars.iv2234.us = phi i64 [ %indvars.iv.next23.us.3, %for.inc36.us ], [ %indvars.iv2234.us.unr, %for.inc36.us.preheader95 ]
  %arrayidx29.us = getelementptr inbounds double, double* %sum, i64 %indvars.iv2234.us
  %14 = bitcast double* %arrayidx29.us to i64*
  %15 = load i64, i64* %14, align 8
  %arrayidx35.us = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %indvars.iv2660, i64 %indvars.iv2436.us, i64 %indvars.iv2234.us
  ...
  %arrayidx35.us.1 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %indvars.iv2660, i64 %indvars.iv2436.us, i64 %indvars.iv.next23.us
  ...
  %arrayidx35.us.2 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %indvars.iv2660, i64 %indvars.iv2436.us, i64 %indvars.iv.next23.us.1
  ...
  %arrayidx35.us.3 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %indvars.iv2660, i64 %indvars.iv2436.us, i64 %indvars.iv.next23.us.2
  %25 = bitcast double* %arrayidx35.us.3 to i64*
  store i64 %24, i64* %25, align 8
  %indvars.iv.next23.us.3 = add nsw i64 %indvars.iv2234.us, 4
  %exitcond71.3 = icmp eq i64 %indvars.iv.next23.us.3, %0
  br i1 %exitcond71.3, label %for.inc39.us.loopexit, label %for.inc36.us

for.body6.us40:                                   ; preds = %for.body6.us40.preheader, %for.cond7.for.inc22_crit_edge.us56
  %indvars.iv2031.us41 = phi i64 [ %indvars.iv.next21.us53, %for.cond7.for.inc22_crit_edge.us56 ], [ 0, %for.body6.us40.preheader ]
  ...
  br i1 %lcmp.mod76, label %for.inc.us43.prol.loopexit, label %for.inc.us43.prol
...
for.inc.us43.prol:                                ; preds = %for.body6.us40
  ...
  %sunkaddr80 = shl i64 %indvars.iv2031.us41, 3
  %sunkaddr81 = add i64 %sunkaddr, %sunkaddr80
  %sunkaddr82 = inttoptr i64 %sunkaddr81 to double*
  %28 = load double, double* %sunkaddr82, align 8
  %add.us48.prol = fadd double %28, %mul.us47.prol
  store double %add.us48.prol, double* %sunkaddr82, align 8
...
for.inc.us43.prol.loopexit:                       ; preds = %for.inc.us43.prol, %for.body6.us40
  ...
  br i1 %11, label %for.cond7.for.inc22_crit_edge.us56, label %for.inc.us43.preheader

for.inc.us43.preheader:                           ; preds = %for.inc.us43.prol.loopexit
  %sunkaddr84 = shl i64 %indvars.iv2031.us41, 3
...
for.inc.us43:                                     ; preds = %for.inc.us43.preheader, %for.inc.us43
  ...
  %arrayidx15.us45 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %indvars.iv2660, i64 %indvars.iv2436.us, i64 %indvars.iv29.us44
  ...
  %31 = load double, double* %sunkaddr86, align 8
  %add.us48 = fadd double %31, %mul.us47
  store double %add.us48, double* %sunkaddr86, align 8
  %indvars.iv.next.us49 = add nuw nsw i64 %indvars.iv29.us44, 1
  %arrayidx15.us45.1 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %indvars.iv2660, i64 %indvars.iv2436.us, i64 %indvars.iv.next.us49
  ...
  %34 = load double, double* %sunkaddr86, align 8
  %add.us48.1 = fadd double %34, %mul.us47.1
  store double %add.us48.1, double* %sunkaddr86, align 8
  %indvars.iv.next.us49.1 = add nsw i64 %indvars.iv29.us44, 2
  %exitcond.us50.1 = icmp eq i64 %indvars.iv.next.us49.1, %wide.trip.count
  br i1 %exitcond.us50.1, label %for.cond7.for.inc22_crit_edge.us56.loopexit, label %for.inc.us43

for.cond7.for.inc22_crit_edge.us56.loopexit:      ; preds = %for.inc.us43
  br label %for.cond7.for.inc22_crit_edge.us56

for.cond7.for.inc22_crit_edge.us56:               ; preds = %for.cond7.for.inc22_crit_edge.us56.loopexit, %for.inc.us43.prol.loopexit
  %indvars.iv.next21.us53 = add nuw nsw i64 %indvars.iv2031.us41, 1
  %exitcond67 = icmp eq i64 %indvars.iv.next21.us53, %0
  br i1 %exitcond67, label %for.cond4.for.cond25.preheader_crit_edge.us.loopexit96, label %for.body6.us40
...
for.cond4.for.cond25.preheader_crit_edge.us.loopexit96: ; preds = %for.cond7.for.inc22_crit_edge.us56
  br label %for.cond4.for.cond25.preheader_crit_edge.us

for.cond4.for.cond25.preheader_crit_edge.us:      ; preds = %for.cond4.for.cond25.preheader_crit_edge.us.loopexit96, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit
...
for.inc36.us.preheader:                           ; preds = %for.cond4.for.cond25.preheader_crit_edge.us
  br i1 %lcmp.mod78, label %for.inc36.us.prol.loopexit, label %for.inc36.us.prol.preheader
...
for.inc36.us.prol:                                ; preds = %for.inc36.us.prol.preheader, %for.inc36.us.prol
  ...
  %prol.iter79 = phi i64 [ %prol.iter79.sub, %for.inc36.us.prol ], [ %xtraiter77, %for.inc36.us.prol.preheader ]
  ...
  %arrayidx35.us.prol = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %indvars.iv2660, i64 %indvars.iv2436.us, i64 %indvars.iv2234.us.prol
  ...
  br i1 %prol.iter79.cmp, label %for.inc36.us.prol.loopexit.loopexit, label %for.inc36.us.prol, !llvm.loop !1
...
for.inc36.us.prol.loopexit:                       ; preds = %for.inc36.us.prol.loopexit.loopexit, %for.inc36.us.preheader
  ...
  br i1 %10, label %for.inc39.us, label %for.inc36.us.preheader95

for.inc36.us.preheader95:                         ; preds = %for.inc36.us.prol.loopexit
...
for.inc36.prol:                                   ; preds = %for.inc36.prol.preheader, %for.inc36.prol
  ...
  %arrayidx35.prol = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %indvars.iv2660, i64 %indvars.iv2436, i64 %indvars.iv2234.prol
...
for.inc36.prol.loopexit:                          ; preds = %for.inc36.prol.loopexit.loopexit, %for.inc36.preheader
  ...
  br i1 %13, label %for.inc39, label %for.inc36.preheader97

for.inc36.preheader97:                            ; preds = %for.inc36.prol.loopexit
  br label %for.inc36

for.inc36:                                        ; preds = %for.inc36.preheader97, %for.inc36
  %indvars.iv2234 = phi i64 [ %indvars.iv.next23.3, %for.inc36 ], [ %indvars.iv2234.unr, %for.inc36.preheader97 ]
  %arrayidx29 = getelementptr inbounds double, double* %sum, i64 %indvars.iv2234
  %41 = bitcast double* %arrayidx29 to i64*
  %42 = load i64, i64* %41, align 8
  %arrayidx35 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %indvars.iv2660, i64 %indvars.iv2436, i64 %indvars.iv2234
  ...
  %arrayidx35.1 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %indvars.iv2660, i64 %indvars.iv2436, i64 %indvars.iv.next23
  ...
  %arrayidx35.2 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %indvars.iv2660, i64 %indvars.iv2436, i64 %indvars.iv.next23.1
  ...
  %arrayidx35.3 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %indvars.iv2660, i64 %indvars.iv2436, i64 %indvars.iv.next23.2
...
for.inc39:                                        ; preds = %for.inc39.loopexit, %for.inc36.prol.loopexit, %for.cond4.preheader
  ...
  %exitcond66 = icmp eq i64 %indvars.iv.next25, %1
  br i1 %exitcond66, label %for.inc42.loopexit98, label %for.cond4.preheader

for.inc42.loopexit:                               ; preds = %for.inc39.us
  br label %for.inc42

for.inc42.loopexit98:                             ; preds = %for.inc39
  br label %for.inc42

for.inc42:                                        ; preds = %for.inc42.loopexit98, %for.inc42.loopexit, %for.cond1.preheader
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv2660, 1
  %exitcond74 = icmp eq i64 %indvars.iv.next27, %2
  br i1 %exitcond74, label %for.end44.loopexit, label %for.cond1.preheader
