...
vector.memcheck:                                  ; preds = %._crit_edge.us, %.lr.ph3.split.us.preheader
...
vector.body6.preheader:                           ; preds = %vector.memcheck
  br label %vector.body6

scalar.ph8.preheader:                             ; preds = %vector.memcheck
  br label %scalar.ph8
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit35, %._crit_edge.us.loopexit
  ...
  br i1 %exitcond31, label %120, label %vector.memcheck
