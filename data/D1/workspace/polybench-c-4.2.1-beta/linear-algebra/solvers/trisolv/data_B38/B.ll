...
.prol.preheader:                                  ; preds = %.lr.ph
  ...
  %14 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv26, i64 0
  store double %13, double* %14, align 8
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph
  %indvars.iv.unr.ph = phi i64 [ 1, %.prol.preheader ], [ 0, %.lr.ph ]
  %15 = icmp eq i64 %indvars.iv26, 0
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %19 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv26, i64 %indvars.iv
...
; <label>:4:                                      ; preds = %._crit_edge, %.lr.ph34
  %indvars.iv38 = phi i64 [ 0, %.lr.ph34 ], [ %indvars.iv.next39, %._crit_edge ]
  %5 = getelementptr inbounds double, double* %3, i64 %indvars.iv38
  %6 = bitcast double* %5 to i64*
  %7 = load i64, i64* %6, align 8
  %8 = getelementptr inbounds double, double* %2, i64 %indvars.iv38
  %9 = bitcast double* %8 to i64*
  store i64 %7, i64* %9, align 8
  %10 = icmp sgt i64 %indvars.iv38, 0
  br i1 %10, label %.lr.ph, label %._crit_edge

.lr.ph:                                           ; preds = %4
  %sunkaddr24 = shl nsw i64 %indvars.iv38, 3
...
.prol.preheader:                                  ; preds = %.lr.ph
  %11 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv38, i64 0
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %.lr.ph.new ], [ %indvars.iv.unr.ph, %.lr.ph.new.preheader ]
  %18 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv38, i64 %indvars.iv
  %19 = load double, double* %18, align 8
  %20 = getelementptr inbounds double, double* %2, i64 %indvars.iv
  %21 = load double, double* %20, align 8
  %22 = fmul double %19, %21
  %23 = load double, double* %sunkaddr26, align 8
  %24 = fsub double %23, %22
  store double %24, double* %sunkaddr26, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %25 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv38, i64 %indvars.iv.next
  %26 = load double, double* %25, align 8
  %27 = getelementptr inbounds double, double* %2, i64 %indvars.iv.next
  %28 = load double, double* %27, align 8
  %29 = fmul double %26, %28
  %30 = load double, double* %sunkaddr26, align 8
  %31 = fsub double %30, %29
  store double %31, double* %sunkaddr26, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %4
  %sunkaddr28 = shl nsw i64 %indvars.iv38, 3
  ...
  %33 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv38, i64 %indvars.iv38
  %34 = load double, double* %33, align 8
  %35 = fdiv double %32, %34
  store double %35, double* %sunkaddr30, align 8
...
; <label>:16:                                     ; preds = %.lr.ph, %14
  ...
  br i1 %exitcond8, label %._crit_edge, label %.lr.ph
