...
for.inc.lr.ph:                                    ; preds = %for.inc47, %entry
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc47 ], [ 1, %entry ]
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc47 ], [ 0, %entry ]
  %alpha.014 = phi double [ %div, %for.inc47 ], [ %sub3, %entry ]
  %beta.013 = phi double [ %mul5, %for.inc47 ], [ 1.000000e+00, %entry ]
  %4 = add i64 %indvars.iv34, 1
  %5 = add i64 %indvars.iv34, 1
...
for.inc.prol:                                     ; preds = %for.inc.prol, %for.inc.prol.preheader
  ...
  %sum.07.prol = phi double [ 0.000000e+00, %for.inc.prol.preheader ], [ %add.prol, %for.inc.prol ]
...
for.inc.prol.loopexit:                            ; preds = %for.inc.lr.ph, %for.inc.prol.loopexit.unr-lcssa
  ...
  %sum.07.unr = phi double [ 0.000000e+00, %for.inc.lr.ph ], [ %add.prol, %for.inc.prol.loopexit.unr-lcssa ]
  %10 = icmp ult i64 %indvars.iv34, 3
...
for.inc:                                          ; preds = %for.inc, %for.inc.lr.ph.new
  ...
  %sum.07 = phi double [ %sum.07.unr, %for.inc.lr.ph.new ], [ %add.3, %for.inc ]
  ...
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %exitcond.3 = icmp eq i64 %indvars.iv.next.2, %indvars.iv34
...
for.inc32.lr.ph:                                  ; preds = %for.inc.prol.loopexit, %for.inc32.lr.ph.unr-lcssa
  ...
  %arrayidx16 = getelementptr inbounds double, double* %r, i64 %indvars.iv36
...
for.inc32.preheader:                              ; preds = %middle.block, %min.iters.checked, %for.inc32.lr.ph
  %indvars.iv19.ph = phi i64 [ 0, %min.iters.checked ], [ 0, %for.inc32.lr.ph ], [ %n.vec, %middle.block ]
  br label %for.inc32

for.inc32:                                        ; preds = %for.inc32.preheader, %for.inc32
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc32 ], [ %indvars.iv19.ph, %for.inc32.preheader ]
  %arrayidx23 = getelementptr inbounds double, double* %y, i64 %indvars.iv19
  %44 = load double, double* %arrayidx23, align 8
  %45 = sub nsw i64 %6, %indvars.iv19
  ...
  %exitcond25 = icmp eq i64 %indvars.iv19, %indvars.iv34
  br i1 %exitcond25, label %for.inc47.loopexit, label %for.inc32, !llvm.loop !6

for.inc47.loopexit:                               ; preds = %for.inc32
  br label %for.inc47

for.inc47:                                        ; preds = %for.inc47.loopexit, %middle.block
  %47 = shl i64 %indvars.iv34, 3
  %48 = add nuw nsw i64 %47, 8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* nonnull %3, i64 %48, i32 8, i1 false)
  %arrayidx46 = getelementptr inbounds double, double* %y, i64 %indvars.iv36
  store double %div, double* %arrayidx46, align 8
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  %indvars.iv.next35 = add nuw nsw i64 %indvars.iv34, 1
  %exitcond1 = icmp eq i64 %indvars.iv.next35, 1999
