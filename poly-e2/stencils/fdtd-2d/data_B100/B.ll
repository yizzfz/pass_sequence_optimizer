...
entry:
  ...
  %arraydecay42 = bitcast i8* %call1 to [1200 x double]*
  %arraydecay53 = bitcast i8* %call2 to [1200 x double]*
  %arraydecay6 = bitcast i8* %call3 to double*
  tail call fastcc void @init_array([1200 x double]* %arraydecay1, [1200 x double]* %arraydecay42, [1200 x double]* %arraydecay53, double* %arraydecay6)
  tail call void (...) @polybench_timer_start() #4
  tail call fastcc void @kernel_fdtd_2d([1200 x double]* %arraydecay1, [1200 x double]* %arraydecay42, [1200 x double]* %arraydecay53, double* %arraydecay6)
...
for.cond5.preheader.us:                           ; preds = %for.cond5.preheader.us.preheader, %for.cond5.for.inc39_crit_edge.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.cond5.for.inc39_crit_edge.us ], [ 0, %for.cond5.preheader.us.preheader ]
...
for.inc36.us:                                     ; preds = %for.inc36.us, %for.cond5.preheader.us
  %indvars.iv15 = phi i64 [ 0, %for.cond5.preheader.us ], [ %indvars.iv.next16, %for.inc36.us ]
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  %1 = trunc i64 %indvars.iv.next16 to i32
  %conv10.us = sitofp i32 %1 to double
  %arrayidx15.us = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv, i64 %indvars.iv15
  %2 = add nuw nsw i64 %indvars.iv15, 2
  ...
  %arrayidx25.us = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv, i64 %indvars.iv15
  ...
  %arrayidx35.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv, i64 %indvars.iv15
...
for.cond5.for.inc39_crit_edge.us:                 ; preds = %for.inc36.us
  ...
  %exitcond25 = icmp eq i64 %indvars.iv.next, 1000
  br i1 %exitcond25, label %for.end41, label %for.cond5.preheader.us

for.inc:                                          ; preds = %for.inc, %entry
  %indvars.iv21 = phi i64 [ 0, %entry ], [ %indvars.iv.next22.4, %for.inc ]
  %6 = trunc i64 %indvars.iv21 to i32
  %conv = sitofp i32 %6 to double
  %arrayidx = getelementptr inbounds double, double* %_fict_, i64 %indvars.iv21
  store double %conv, double* %arrayidx, align 8
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  %7 = trunc i64 %indvars.iv.next22 to i32
  %conv.1 = sitofp i32 %7 to double
  %arrayidx.1 = getelementptr inbounds double, double* %_fict_, i64 %indvars.iv.next22
  store double %conv.1, double* %arrayidx.1, align 8
  %indvars.iv.next22.1 = add nsw i64 %indvars.iv21, 2
  %8 = trunc i64 %indvars.iv.next22.1 to i32
  %conv.2 = sitofp i32 %8 to double
  %arrayidx.2 = getelementptr inbounds double, double* %_fict_, i64 %indvars.iv.next22.1
  store double %conv.2, double* %arrayidx.2, align 8
  %indvars.iv.next22.2 = add nsw i64 %indvars.iv21, 3
  %9 = trunc i64 %indvars.iv.next22.2 to i32
  %conv.3 = sitofp i32 %9 to double
  %arrayidx.3 = getelementptr inbounds double, double* %_fict_, i64 %indvars.iv.next22.2
  store double %conv.3, double* %arrayidx.3, align 8
  %indvars.iv.next22.3 = add nsw i64 %indvars.iv21, 4
  %10 = trunc i64 %indvars.iv.next22.3 to i32
  %conv.4 = sitofp i32 %10 to double
  %arrayidx.4 = getelementptr inbounds double, double* %_fict_, i64 %indvars.iv.next22.3
  store double %conv.4, double* %arrayidx.4, align 8
  %indvars.iv.next22.4 = add nsw i64 %indvars.iv21, 5
  %exitcond26.4 = icmp eq i64 %indvars.iv.next22.4, 500
  br i1 %exitcond26.4, label %for.cond5.preheader.us.preheader, label %for.inc
...
for.cond1.preheader:                              ; preds = %for.inc113, %entry
  %indvars.iv60 = phi i64 [ 0, %entry ], [ %indvars.iv.next61, %for.inc113 ]
  br label %for.inc
...
for.cond10.preheader.us:                          ; preds = %for.cond10.preheader.us.preheader, %for.cond10.for.inc34_crit_edge.us
  ...
  %indvars.iv.us = phi i64 [ %indvars.iv.next.us, %for.cond10.for.inc34_crit_edge.us ], [ 1, %for.cond10.preheader.us.preheader ]
  %0 = add i64 %indvar, 1
...
vector.body58:                                    ; preds = %vector.body58.preheader, %vector.body58
  ...
  %3 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv.us, i64 %index78
  ...
  %7 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv.us, i64 %index78
...
for.inc31.us:                                     ; preds = %for.inc31.us, %for.inc31.us.preheader
  %indvars.iv45 = phi i64 [ 0, %for.inc31.us.preheader ], [ %indvars.iv.next46.1, %for.inc31.us ]
  %arrayidx16.us = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv.us, i64 %indvars.iv45
  %22 = load double, double* %arrayidx16.us, align 8
  %arrayidx20.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv.us, i64 %indvars.iv45
  %23 = load double, double* %arrayidx20.us, align 8
  %arrayidx24.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %2, i64 %indvars.iv45
  ...
  %arrayidx16.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv.us, i64 %indvars.iv.next46
  %25 = load double, double* %arrayidx16.us.1, align 8
  %arrayidx20.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv.us, i64 %indvars.iv.next46
  %26 = load double, double* %arrayidx20.us.1, align 8
  %arrayidx24.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %2, i64 %indvars.iv.next46
  ...
  %exitcond68.1 = icmp eq i64 %indvars.iv.next46.1, 1200
  br i1 %exitcond68.1, label %for.cond10.for.inc34_crit_edge.us.loopexit, label %for.inc31.us, !llvm.loop !9
...
for.cond10.for.inc34_crit_edge.us:                ; preds = %for.cond10.for.inc34_crit_edge.us.loopexit112, %for.cond10.for.inc34_crit_edge.us.loopexit
  ...
  %exitcond69 = icmp eq i64 %indvars.iv.next.us, 1000
  br i1 %exitcond69, label %for.cond40.preheader.us.preheader, label %for.cond10.preheader.us
...
for.inc:                                          ; preds = %for.inc, %for.cond1.preheader
  ...
  %sunkaddr101 = mul i64 %indvars.iv60, 8
  ...
  %arrayidx6.2 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 0, i64 %indvars.iv.next66.1
  ...
  %sunkaddr105 = mul i64 %indvars.iv60, 8
  ...
  %arrayidx6.3 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 0, i64 %indvars.iv.next66.2
  ...
  %sunkaddr109 = mul i64 %indvars.iv60, 8
  ...
  %arrayidx6.4 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 0, i64 %indvars.iv.next66.3
  %37 = bitcast double* %arrayidx6.4 to i64*
  store i64 %36, i64* %37, align 8
  %indvars.iv.next66.4 = add nsw i64 %indvars.iv65, 5
  %exitcond78.4 = icmp eq i64 %indvars.iv.next66.4, 1200
  br i1 %exitcond78.4, label %for.cond10.preheader.us.preheader, label %for.inc
...
for.cond40.preheader.us:                          ; preds = %for.cond40.preheader.us.preheader, %for.cond40.for.inc66_crit_edge.us
  %indvars.iv29.us = phi i64 [ %38, %for.cond40.for.inc66_crit_edge.us ], [ 0, %for.cond40.preheader.us.preheader ]
  %scevgep30 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv29.us, i64 1
  %38 = add i64 %indvars.iv29.us, 1
  %scevgep32 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %38, i64 0
  %scevgep34 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv29.us, i64 0
...
vector.body25:                                    ; preds = %vector.body25.preheader, %vector.body25
  ...
  %39 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv29.us, i64 %offset.idx
  ...
  %43 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv29.us, i64 %offset.idx
  ...
  %48 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv29.us, i64 %47
...
for.inc63.us.preheader.new:                       ; preds = %for.inc63.us.preheader.new.loopexit, %for.cond40.preheader.us
  %indvars.iv47.ph = phi i64 [ 1, %for.cond40.preheader.us ], [ 1197, %for.inc63.us.preheader.new.loopexit ]
  %arrayidx46.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv29.us, i64 %indvars.iv47.ph
  %59 = load double, double* %arrayidx46.us.prol, align 8
  %arrayidx50.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv29.us, i64 %indvars.iv47.ph
  %60 = load double, double* %arrayidx50.us.prol, align 8
  %61 = add nsw i64 %indvars.iv47.ph, -1
  %arrayidx55.us.prol = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv29.us, i64 %61
...
for.inc63.us:                                     ; preds = %for.inc63.us, %for.inc63.us.preheader.new
  %indvars.iv47 = phi i64 [ %indvars.iv.next48.prol, %for.inc63.us.preheader.new ], [ %indvars.iv.next48.1, %for.inc63.us ]
  %arrayidx46.us = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv29.us, i64 %indvars.iv47
  %63 = load double, double* %arrayidx46.us, align 8
  %arrayidx50.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv29.us, i64 %indvars.iv47
  %64 = load double, double* %arrayidx50.us, align 8
  %65 = add nsw i64 %indvars.iv47, -1
  %arrayidx55.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv29.us, i64 %65
  ...
  %arrayidx46.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv29.us, i64 %indvars.iv.next48
  %67 = load double, double* %arrayidx46.us.1, align 8
  %arrayidx50.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv29.us, i64 %indvars.iv.next48
  %68 = load double, double* %arrayidx50.us.1, align 8
  %arrayidx55.us.1 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv29.us, i64 %indvars.iv47
  ...
  %exitcond71.1 = icmp eq i64 %indvars.iv.next48.1, 1200
  br i1 %exitcond71.1, label %for.cond40.for.inc66_crit_edge.us, label %for.inc63.us, !llvm.loop !16

for.cond40.for.inc66_crit_edge.us:                ; preds = %for.inc63.us
  %exitcond72 = icmp eq i64 %38, 1000
  br i1 %exitcond72, label %for.cond73.preheader.us.preheader, label %for.cond40.preheader.us
...
for.cond73.preheader.us:                          ; preds = %for.cond73.preheader.us.preheader, %for.cond73.for.inc110_crit_edge.us
  %indvars.iv42.us = phi i64 [ %70, %for.cond73.for.inc110_crit_edge.us ], [ 0, %for.cond73.preheader.us.preheader ]
  %scevgep = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv42.us, i64 0
  %scevgep2 = getelementptr [1200 x double], [1200 x double]* %hz, i64 %indvars.iv42.us, i64 1199
  %scevgep4 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %indvars.iv42.us, i64 0
  %70 = add i64 %indvars.iv42.us, 1
  %scevgep6 = getelementptr [1200 x double], [1200 x double]* %ex, i64 %70, i64 0
  %scevgep8 = getelementptr [1200 x double], [1200 x double]* %ey, i64 %indvars.iv42.us, i64 0
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %71 = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv42.us, i64 %index
  ...
  %75 = or i64 %index, 1
  %76 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv42.us, i64 %75
  ...
  %80 = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv42.us, i64 %index
  ...
  %92 = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv42.us, i64 %index
...
for.inc107.us.preheader:                          ; preds = %for.inc107.us.preheader.loopexit, %for.cond73.preheader.us
  %indvars.iv50.ph = phi i64 [ 0, %for.cond73.preheader.us ], [ 1196, %for.inc107.us.preheader.loopexit ]
  br label %for.inc107.us

for.inc107.us:                                    ; preds = %for.inc107.us.preheader, %for.inc107.us
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc107.us ], [ %indvars.iv50.ph, %for.inc107.us.preheader ]
  %arrayidx80.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv42.us, i64 %indvars.iv50
  %103 = load double, double* %arrayidx80.us, align 8
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1
  %arrayidx84.us = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv42.us, i64 %indvars.iv.next51
  %104 = load double, double* %arrayidx84.us, align 8
  %arrayidx88.us = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv42.us, i64 %indvars.iv50
  %105 = load double, double* %arrayidx88.us, align 8
  %sub89.us = fsub double %104, %105
  %arrayidx94.us = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %70, i64 %indvars.iv50
  %106 = load double, double* %arrayidx94.us, align 8
  %add95.us = fadd double %sub89.us, %106
  %arrayidx99.us = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv42.us, i64 %indvars.iv50
  ...
  %cmp75.us = icmp slt i64 %indvars.iv.next51, 1199
...
for.inc113:                                       ; preds = %for.cond73.for.inc110_crit_edge.us
  ...
  %exitcond73 = icmp eq i64 %indvars.iv.next61, 500
  br i1 %exitcond73, label %for.end115, label %for.cond1.preheader
...
for.cond2.preheader.us:                           ; preds = %for.cond2.for.inc10_crit_edge.us, %entry
  %indvars.iv55 = phi i64 [ 0, %entry ], [ %indvars.iv.next56, %for.cond2.for.inc10_crit_edge.us ]
  %3 = mul nsw i64 %indvars.iv55, 1000
  %4 = trunc i64 %3 to i32
  br label %for.body4.us

for.body4.us:                                     ; preds = %for.inc.us, %for.cond2.preheader.us
  %indvars.iv32.us = phi i64 [ 0, %for.cond2.preheader.us ], [ %indvars.iv.next33.us, %for.inc.us ]
  %storemerge530.us = phi i32 [ 0, %for.cond2.preheader.us ], [ %8, %for.inc.us ]
  %add.us = add nsw i32 %4, %storemerge530.us
...
for.inc.us:                                       ; preds = %for.body4.us, %if.then.us
  ...
  %arrayidx8.us = getelementptr inbounds [1200 x double], [1200 x double]* %ex, i64 %indvars.iv55, i64 %indvars.iv32.us
  %7 = load double, double* %arrayidx8.us, align 8
  %call9.us = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %6, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i64 0, i64 0), double %7) #5
  %indvars.iv.next33.us = add nuw nsw i64 %indvars.iv32.us, 1
  %exitcond54 = icmp eq i64 %indvars.iv.next33.us, 1200
  %8 = trunc i64 %indvars.iv.next33.us to i32
  br i1 %exitcond54, label %for.cond2.for.inc10_crit_edge.us, label %for.body4.us

for.cond2.for.inc10_crit_edge.us:                 ; preds = %for.inc.us
  %indvars.iv.next56 = add nuw nsw i64 %indvars.iv55, 1
  %exitcond63 = icmp eq i64 %indvars.iv.next56, 1000
...
for.body21.us:                                    ; preds = %for.inc34.us, %for.cond19.preheader.us
  %indvars.iv23.us = phi i64 [ 0, %for.cond19.preheader.us ], [ %indvars.iv.next24.us, %for.inc34.us ]
  %storemerge421.us = phi i32 [ 0, %for.cond19.preheader.us ], [ %18, %for.inc34.us ]
  %add23.us = add nsw i32 %14, %storemerge421.us
...
for.inc34.us:                                     ; preds = %for.body21.us, %if.then26.us
  ...
  %arrayidx32.us = getelementptr inbounds [1200 x double], [1200 x double]* %ey, i64 %indvars.iv48, i64 %indvars.iv23.us
  %17 = load double, double* %arrayidx32.us, align 8
  %call33.us = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %16, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i64 0, i64 0), double %17) #5
  %indvars.iv.next24.us = add nuw nsw i64 %indvars.iv23.us, 1
  %exitcond47 = icmp eq i64 %indvars.iv.next24.us, 1200
  %18 = trunc i64 %indvars.iv.next24.us to i32
...
for.cond19.for.inc37_crit_edge.us:                ; preds = %for.inc34.us
  ...
  %exitcond62 = icmp eq i64 %indvars.iv.next49, 1000
  br i1 %exitcond62, label %for.end39, label %for.cond19.preheader.us
...
for.cond45.preheader.us:                          ; preds = %for.cond45.for.inc63_crit_edge.us, %for.end39
  %indvars.iv = phi i64 [ 0, %for.end39 ], [ %indvars.iv.next, %for.cond45.for.inc63_crit_edge.us ]
  %21 = mul nsw i64 %indvars.iv, 1000
  %22 = trunc i64 %21 to i32
  br label %for.body47.us

for.body47.us:                                    ; preds = %for.inc60.us, %for.cond45.preheader.us
  %indvars.iv.us = phi i64 [ 0, %for.cond45.preheader.us ], [ %indvars.iv.next.us, %for.inc60.us ]
  %storemerge315.us = phi i32 [ 0, %for.cond45.preheader.us ], [ %26, %for.inc60.us ]
  %add49.us = add nsw i32 %22, %storemerge315.us
...
for.inc60.us:                                     ; preds = %for.body47.us, %if.then52.us
  ...
  %arrayidx58.us = getelementptr inbounds [1200 x double], [1200 x double]* %hz, i64 %indvars.iv, i64 %indvars.iv.us
  %25 = load double, double* %arrayidx58.us, align 8
  %call59.us = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %24, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i64 0, i64 0), double %25) #5
  %indvars.iv.next.us = add nuw nsw i64 %indvars.iv.us, 1
  %exitcond = icmp eq i64 %indvars.iv.next.us, 1200
  %26 = trunc i64 %indvars.iv.next.us to i32
...
for.cond45.for.inc63_crit_edge.us:                ; preds = %for.inc60.us
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond61 = icmp eq i64 %indvars.iv.next, 1000
  br i1 %exitcond61, label %for.end65, label %for.cond45.preheader.us
