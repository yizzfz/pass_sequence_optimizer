...
._crit_edge27.us..preheader6.us_crit_edge:        ; preds = %._crit_edge27.us
  %scevgep71 = getelementptr double, double* %5, i64 1200
...
.preheader6.us:                                   ; preds = %._crit_edge22.us, %._crit_edge27.us..preheader6.us_crit_edge
  ...
  %scevgep69 = getelementptr [1200 x double], [1200 x double]* %3, i64 %21, i64 0
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %wide.vec76 = load <8 x double>, <8 x double>* %25, align 8, !alias.scope !4, !noalias !1
  %26 = fsub <8 x double> %wide.vec76, %wide.vec
  ...
  br i1 %37, label %._crit_edge22.us.loopexit81, label %vector.body, !llvm.loop !6
...
._crit_edge22.us.loopexit81:                      ; preds = %vector.body
  br label %._crit_edge22.us

._crit_edge22.us:                                 ; preds = %._crit_edge22.us.loopexit81, %._crit_edge22.us.loopexit
