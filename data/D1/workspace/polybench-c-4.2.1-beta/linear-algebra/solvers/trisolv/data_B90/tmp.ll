...
; <label>:6:                                      ; preds = %._crit_edge, %.lr.ph9
  ...
  %7 = add nuw i64 %indvars.iv17, 4294967295
  %8 = getelementptr inbounds double, double* %3, i64 %indvars.iv17
  %9 = load double, double* %8, align 8
  %10 = getelementptr inbounds double, double* %2, i64 %indvars.iv17
  store double %9, double* %10, align 8
  %11 = icmp sgt i64 %indvars.iv17, 0
  br i1 %11, label %.lr.ph, label %._crit_edge

.lr.ph:                                           ; preds = %6
  %xtraiter27 = and i64 %indvars.iv17, 1
...
; <label>:12:                                     ; preds = %.lr.ph
  ...
  %17 = fsub double %9, %16
  %sunkaddr20 = shl i64 %indvars.iv17, 3
...
.prol.loopexit:                                   ; preds = %.lr.ph, %12
  ...
  %.unr.ph = phi double [ %17, %12 ], [ %9, %.lr.ph ]
  %.lcssa12.unr.ph = phi double [ %17, %12 ], [ undef, %.lr.ph ]
  %18 = trunc i64 %7 to i32
  %19 = icmp eq i32 %18, 0
  br i1 %19, label %._crit_edge, label %.lr.ph.new.preheader

.lr.ph.new.preheader:                             ; preds = %.prol.loopexit
  %sunkaddr32 = shl i64 %indvars.iv17, 3
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  store double %32, double* %sunkaddr34, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit, %6
  %.lcssa = phi double [ %9, %6 ], [ %.lcssa12.unr.ph, %.prol.loopexit ], [ %32, %._crit_edge.loopexit ]
  ...
  %sunkaddr6 = add i64 %5, %sunkaddr5
  %sunkaddr7 = inttoptr i64 %sunkaddr6 to double*
  store double %35, double* %sunkaddr7, align 8
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  %exitcond29 = icmp eq i64 %indvars.iv.next18, 2000
  br i1 %exitcond29, label %._crit_edge10, label %6
