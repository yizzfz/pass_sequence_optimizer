...
@__llvm_prf_nm = private constant [11 x i8] c"\09\00Gsm_Coder", section "__llvm_prf_names"
@llvm.used = appending global [2 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_Gsm_Coder to i8*), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
