...
define internal fastcc void @init_array(i32, i32, double* nocapture, double* nocapture, [1200 x double]* nocapture, [1000 x double]* nocapture, [1200 x double]* nocapture) unnamed_addr #2 {
  ...
  %8 = icmp sgt i32 %0, 0
  br i1 %8, label %.preheader5.lr.ph, label %.._crit_edge11_crit_edge
...
.preheader5.us:                                   ; preds = %._crit_edge14.us..preheader5.us_crit_edge, %.preheader5.us.preheader
  %indvars.iv39 = phi i64 [ 0, %.preheader5.us.preheader ], [ %indvars.iv.next40, %._crit_edge14.us..preheader5.us_crit_edge ]
  %12 = add i64 %indvars.iv39, %11
  %13 = trunc i64 %12 to i32
  br label %14

; <label>:14:                                     ; preds = %._crit_edge47, %.preheader5.us
  %indvars.iv36 = phi i64 [ 0, %.preheader5.us ], [ %indvars.iv.next37, %._crit_edge47 ]
  ...
  br i1 %exitcond38, label %._crit_edge14.us, label %._crit_edge47

._crit_edge47:                                    ; preds = %14
  br label %14

._crit_edge14.us:                                 ; preds = %14
  %indvars.iv.next40 = add nuw nsw i64 %indvars.iv39, 1
  %exitcond42 = icmp eq i64 %indvars.iv.next40, %wide.trip.count41
  br i1 %exitcond42, label %.preheader4, label %._crit_edge14.us..preheader5.us_crit_edge
...
.preheader4:                                      ; preds = %._crit_edge14.us
  %27 = icmp sgt i32 %0, 0
  br i1 %27, label %.preheader4..preheader3.lr.ph_crit_edge, label %.preheader4.._crit_edge11_crit_edge

.preheader4.._crit_edge11_crit_edge:              ; preds = %.preheader4
  br label %._crit_edge11

.preheader4..preheader3.lr.ph_crit_edge:          ; preds = %.preheader4
  br label %.preheader3.lr.ph

.preheader3.lr.ph:                                ; preds = %.preheader4..preheader3.lr.ph_crit_edge, %.preheader5.lr.ph..preheader3.lr.ph_crit_edge
...
.lr.ph:                                           ; preds = %._crit_edge..lr.ph_crit_edge, %.preheader3.lr.ph
  %indvars.iv33 = phi i64 [ 0, %.preheader3.lr.ph ], [ %indvars.iv.next34, %._crit_edge..lr.ph_crit_edge ]
  %indvars.iv31 = phi i64 [ 1, %.preheader3.lr.ph ], [ %indvars.iv.next32, %._crit_edge..lr.ph_crit_edge ]
...
.prol.loopexit:                                   ; preds = %.lr.ph..prol.loopexit_crit_edge, %.prol.preheader
  ...
  br i1 %43, label %.prol.loopexit..preheader_crit_edge, label %.lr.ph.new.preheader
...
.preheader:                                       ; preds = %.prol.loopexit..preheader_crit_edge, %.preheader.loopexit
  ...
  br i1 %44, label %.lr.ph9, label %.preheader.._crit_edge_crit_edge
...
.lr.ph9:                                          ; preds = %.preheader
  ...
  br i1 %lcmp.mod28, label %.lr.ph9..prol.loopexit26_crit_edge, label %.prol.preheader25.preheader

.lr.ph9..prol.loopexit26_crit_edge:               ; preds = %.lr.ph9
...
.prol.loopexit26:                                 ; preds = %.lr.ph9..prol.loopexit26_crit_edge, %.prol.loopexit26.loopexit
  %indvars.iv22.unr = phi i64 [ %indvars.iv31, %.lr.ph9..prol.loopexit26_crit_edge ], [ %indvars.iv.next23.prol, %.prol.loopexit26.loopexit ]
  %46 = icmp ult i32 %37, 7
  br i1 %46, label %.prol.loopexit26.._crit_edge_crit_edge, label %.lr.ph9.new.preheader

.prol.loopexit26.._crit_edge_crit_edge:           ; preds = %.prol.loopexit26
  br label %._crit_edge
...
.lr.ph9.new.preheader:                            ; preds = %.prol.loopexit26
  ...
  br i1 %min.iters.check, label %.lr.ph9.new.preheader..lr.ph9.new.preheader46_crit_edge, label %min.iters.checked

.lr.ph9.new.preheader..lr.ph9.new.preheader46_crit_edge: ; preds = %.lr.ph9.new.preheader
  br label %.lr.ph9.new.preheader46

.lr.ph9.new.preheader46:                          ; preds = %middle.block..lr.ph9.new.preheader46_crit_edge, %min.iters.checked..lr.ph9.new.preheader46_crit_edge, %.lr.ph9.new.preheader..lr.ph9.new.preheader46_crit_edge
  %indvars.iv22.ph = phi i64 [ %indvars.iv22.unr, %min.iters.checked..lr.ph9.new.preheader46_crit_edge ], [ %indvars.iv22.unr, %.lr.ph9.new.preheader..lr.ph9.new.preheader46_crit_edge ], [ %ind.end, %middle.block..lr.ph9.new.preheader46_crit_edge ]
  br label %.lr.ph9.new
...
min.iters.checked:                                ; preds = %.lr.ph9.new.preheader
  ...
  br i1 %cmp.zero, label %min.iters.checked..lr.ph9.new.preheader46_crit_edge, label %vector.body.preheader

min.iters.checked..lr.ph9.new.preheader46_crit_edge: ; preds = %min.iters.checked
  br label %.lr.ph9.new.preheader46
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.body.preheader
  ...
  br i1 %60, label %middle.block, label %vector.body.vector.body_crit_edge, !llvm.loop !3
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %middle.block.._crit_edge_crit_edge, label %middle.block..lr.ph9.new.preheader46_crit_edge

middle.block..lr.ph9.new.preheader46_crit_edge:   ; preds = %middle.block
  br label %.lr.ph9.new.preheader46
...
._crit_edge:                                      ; preds = %middle.block.._crit_edge_crit_edge, %.prol.loopexit26.._crit_edge_crit_edge, %.preheader.._crit_edge_crit_edge, %._crit_edge.loopexit
  %indvars.iv.next32 = add nuw nsw i64 %indvars.iv31, 1
  %exitcond = icmp eq i64 %indvars.iv.next34, %wide.trip.count35
  br i1 %exitcond, label %._crit_edge11.loopexit, label %._crit_edge..lr.ph_crit_edge
...
._crit_edge11:                                    ; preds = %.preheader4.._crit_edge11_crit_edge, %.._crit_edge11_crit_edge, %._crit_edge11.loopexit
  ret void
}
...
define internal fastcc void @kernel_symm(i32, i32, double, double, [1200 x double]* nocapture, [1000 x double]* nocapture readonly, [1200 x double]* nocapture readonly) unnamed_addr #2 {
  ...
  %9 = icmp sgt i32 %1, 0
  %or.cond = and i1 %8, %9
  br i1 %or.cond, label %.preheader4.us.preheader, label %.._crit_edge15_crit_edge
...
.preheader4.us:                                   ; preds = %._crit_edge11.us..preheader4.us_crit_edge, %.preheader4.us.preheader
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %._crit_edge11.us..preheader4.us_crit_edge ], [ 0, %.preheader4.us.preheader ]
...
.preheader.us21.preheader:                        ; preds = %.preheader4.us
  br i1 %min.iters.check, label %.preheader.us21.preheader..preheader.us21.preheader70_crit_edge, label %min.iters.checked

.preheader.us21.preheader..preheader.us21.preheader70_crit_edge: ; preds = %.preheader.us21.preheader
  br label %.preheader.us21.preheader70

min.iters.checked:                                ; preds = %.preheader.us21.preheader
  br i1 %cmp.zero, label %min.iters.checked..preheader.us21.preheader70_crit_edge, label %vector.memcheck

min.iters.checked..preheader.us21.preheader70_crit_edge: ; preds = %min.iters.checked
  br label %.preheader.us21.preheader70
...
vector.memcheck:                                  ; preds = %min.iters.checked
  ...
  br i1 %conflict.rdx, label %vector.memcheck..preheader.us21.preheader70_crit_edge, label %vector.ph

vector.memcheck..preheader.us21.preheader70_crit_edge: ; preds = %vector.memcheck
  br label %.preheader.us21.preheader70
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.ph
  ...
  %15 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv42, i64 %index
  ...
  %wide.load61 = load <2 x double>, <2 x double>* %18, align 8, !alias.scope !8, !noalias !11
  %19 = fmul <2 x double> %wide.load, %broadcast.splat63
  %20 = fmul <2 x double> %wide.load61, %broadcast.splat63
  %21 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv42, i64 %index
  %22 = bitcast double* %21 to <2 x double>*
  %wide.load64 = load <2 x double>, <2 x double>* %22, align 8, !alias.scope !14
  %23 = getelementptr double, double* %21, i64 2
  %24 = bitcast double* %23 to <2 x double>*
  %wide.load65 = load <2 x double>, <2 x double>* %24, align 8, !alias.scope !14
  %25 = fmul <2 x double> %wide.load64, %broadcast.splat67
  %26 = fmul <2 x double> %wide.load65, %broadcast.splat67
...
middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %middle.block.._crit_edge11.us_crit_edge, label %middle.block..preheader.us21.preheader70_crit_edge

middle.block..preheader.us21.preheader70_crit_edge: ; preds = %middle.block
  br label %.preheader.us21.preheader70

middle.block.._crit_edge11.us_crit_edge:          ; preds = %middle.block
  br label %._crit_edge11.us

.preheader.us21.preheader70:                      ; preds = %middle.block..preheader.us21.preheader70_crit_edge, %vector.memcheck..preheader.us21.preheader70_crit_edge, %min.iters.checked..preheader.us21.preheader70_crit_edge, %.preheader.us21.preheader..preheader.us21.preheader70_crit_edge
  %indvars.iv.ph = phi i64 [ 0, %vector.memcheck..preheader.us21.preheader70_crit_edge ], [ 0, %min.iters.checked..preheader.us21.preheader70_crit_edge ], [ 0, %.preheader.us21.preheader..preheader.us21.preheader70_crit_edge ], [ %n.vec, %middle.block..preheader.us21.preheader70_crit_edge ]
  %41 = sub nsw i64 %wide.trip.count40, %indvars.iv.ph
  %xtraiter = and i64 %41, 1
  %lcmp.mod = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod, label %.preheader.us21.preheader70..preheader.us21.prol.loopexit.unr-lcssa_crit_edge, label %.preheader.us21.prol.preheader

.preheader.us21.preheader70..preheader.us21.prol.loopexit.unr-lcssa_crit_edge: ; preds = %.preheader.us21.preheader70
...
.preheader.us21.prol.loopexit.unr-lcssa:          ; preds = %.preheader.us21.preheader70..preheader.us21.prol.loopexit.unr-lcssa_crit_edge, %.preheader.us21.prol
  %indvars.iv.unr.ph = phi i64 [ %indvars.iv.next.prol, %.preheader.us21.prol ], [ %indvars.iv.ph, %.preheader.us21.preheader70..preheader.us21.prol.loopexit.unr-lcssa_crit_edge ]
...
.preheader.us21.prol.loopexit:                    ; preds = %.preheader.us21.prol.loopexit.unr-lcssa
  ...
  br i1 %52, label %.preheader.us21.prol.loopexit.._crit_edge11.us.loopexit71_crit_edge, label %.preheader.us21.preheader70.new

.preheader.us21.prol.loopexit.._crit_edge11.us.loopexit71_crit_edge: ; preds = %.preheader.us21.prol.loopexit
...
._crit_edge11.us.loopexit71:                      ; preds = %.preheader.us21.prol.loopexit.._crit_edge11.us.loopexit71_crit_edge, %._crit_edge11.us.loopexit71.unr-lcssa
  br label %._crit_edge11.us

._crit_edge11.us:                                 ; preds = %middle.block.._crit_edge11.us_crit_edge, %._crit_edge11.us.loopexit71, %._crit_edge11.us.loopexit
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1
  %exitcond45 = icmp eq i64 %indvars.iv.next43, %wide.trip.count44
  br i1 %exitcond45, label %._crit_edge15.loopexit, label %._crit_edge11.us..preheader4.us_crit_edge
...
.preheader.us.us:                                 ; preds = %._crit_edge.us.us..preheader.us.us_crit_edge, %.preheader.us.us.preheader
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %._crit_edge.us.us..preheader.us.us_crit_edge ], [ 0, %.preheader.us.us.preheader ]
...
._crit_edge.us.us:                                ; preds = %85
  ...
  br i1 %exitcond41, label %._crit_edge11.us.loopexit, label %._crit_edge.us.us..preheader.us.us_crit_edge
...
; <label>:85:                                     ; preds = %._crit_edge, %.preheader.us.us
  ...
  %.07.us.us = phi double [ %98, %._crit_edge ], [ 0.000000e+00, %.preheader.us.us ]
