...
; <label>:19:                                     ; preds = %._crit_edge3, %._crit_edge2, %._crit_edge1, %._crit_edge, %2
  br label %28
...
; <label>:57:                                     ; preds = %._crit_edge5, %._crit_edge4, %52
...
; <label>:48:                                     ; preds = %._crit_edge3, %._crit_edge2, %._crit_edge1, %._crit_edge, %4
  br label %57
...
; <label>:221:                                    ; preds = %._crit_edge5, %192, %126
...
; <label>:18:                                     ; preds = %._crit_edge1, %._crit_edge, %2
...
; <label>:26:                                     ; preds = %._crit_edge3, %._crit_edge2, %2
...
; <label>:11:                                     ; preds = %._crit_edge1, %._crit_edge, %1
...
; <label>:21:                                     ; preds = %._crit_edge2, %19, %1
  %22 = load %struct._TIFFRGBAImage*, %struct._TIFFRGBAImage** %3, align 8
