...
._crit_edge2.preheader:                           ; preds = %20, %3
  %indvars.iv5 = phi i64 [ 0, %3 ], [ %indvars.iv.next6, %20 ]
  %8 = mul nuw nsw i64 %indvars.iv5, 1000
  br label %9

; <label>:9:                                      ; preds = %._crit_edge, %._crit_edge2.preheader
...
; <label>:20:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond7, label %21, label %._crit_edge2.preheader
