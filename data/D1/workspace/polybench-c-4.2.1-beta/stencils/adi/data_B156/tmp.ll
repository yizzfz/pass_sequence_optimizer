...
.ph.lver.orig:                                    ; preds = %.ph.lver.orig.preheader, %.ph.lver.orig
  ...
  %.rhs.us.lver.orig = fmul double %15, 0xC09F400000000001
  %20 = fadd double %.rhs.us.lver.orig, 0x40AF420000000001
...
; <label>:54:                                     ; preds = %54, %.ph
  ...
  %.rhs.us = fmul double %store_forwarded, 0xC09F400000000001
  %58 = fadd double %.rhs.us, 0x40AF420000000001
  ...
  %62 = fmul <2 x double> %61, <double 0x408F400000000001, double 0xC09F3C0000000001>
...
; <label>:129:                                    ; preds = %129, %.ph40
  ...
  br i1 %exitcond7, label %._crit_edge12.us.loopexit47, label %129

._crit_edge12.us.loopexit:                        ; preds = %.ph40.lver.orig
  br label %._crit_edge12.us

._crit_edge12.us.loopexit47:                      ; preds = %129
  br label %._crit_edge12.us
...
._crit_edge16:                                    ; preds = %111
  ...
  %exitcond49 = icmp eq i32 %154, 501
  br i1 %exitcond49, label %155, label %.preheader4
