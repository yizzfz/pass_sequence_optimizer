...
.prol.preheader:                                  ; preds = %.lr.ph
  %26 = trunc i64 %indvars.iv69 to i32
  %27 = srem i32 %26, 100
  %28 = sitofp i32 %27 to double
  %29 = fdiv double %28, 1.000000e+03
  %30 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 0
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %32 = add nuw nsw i64 %indvars.iv, %indvars.iv69
  %33 = trunc i64 %32 to i32
  %34 = srem i32 %33, 100
  %35 = sitofp i32 %34 to double
  %36 = fdiv double %35, 1.000000e+03
  %37 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv
  store double %36, double* %37, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %38 = add nuw nsw i64 %indvars.iv.next, %indvars.iv69
  %39 = trunc i64 %38 to i32
  %40 = srem i32 %39, 100
  %41 = sitofp i32 %40 to double
  %42 = fdiv double %41, 1.000000e+03
  %43 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv.next
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit
  %44 = icmp slt i64 %indvars.iv.next70, 1000
  br i1 %44, label %.lr.ph44, label %.loopexit
...
.prol.preheader61:                                ; preds = %.prol.preheader61.preheader, %.prol.preheader61
  ...
  %45 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv58.prol
...
.prol.loopexit62:                                 ; preds = %.prol.loopexit62.loopexit, %.lr.ph44
  ...
  %46 = icmp ult i32 %25, 7
  br i1 %46, label %.loopexit, label %.lr.ph44.new.preheader

.lr.ph44.new.preheader:                           ; preds = %.prol.loopexit62
  %47 = sub i64 992, %indvars.iv58.unr
  %48 = lshr i64 %47, 3
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %54 = shl i64 %index, 3
  %offset.idx = add i64 %indvars.iv58.unr, %54
  %55 = add nsw i64 %offset.idx, 7
  %56 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %55
...
.lr.ph44.new:                                     ; preds = %.lr.ph44.new.preheader82, %.lr.ph44.new
  ...
  %60 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv58
  store double -9.990000e+02, double* %60, align 8
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  %61 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv.next59
  store double -9.990000e+02, double* %61, align 8
  %indvars.iv.next59.1 = add nsw i64 %indvars.iv58, 2
  %62 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv.next59.1
  store double -9.990000e+02, double* %62, align 8
  %indvars.iv.next59.2 = add nsw i64 %indvars.iv58, 3
  %63 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv.next59.2
  store double -9.990000e+02, double* %63, align 8
  %indvars.iv.next59.3 = add nsw i64 %indvars.iv58, 4
  %64 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv.next59.3
  store double -9.990000e+02, double* %64, align 8
  %indvars.iv.next59.4 = add nsw i64 %indvars.iv58, 5
  %65 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv.next59.4
  store double -9.990000e+02, double* %65, align 8
  %indvars.iv.next59.5 = add nsw i64 %indvars.iv58, 6
  %66 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv.next59.5
  store double -9.990000e+02, double* %66, align 8
  %indvars.iv.next59.6 = add nsw i64 %indvars.iv58, 7
  %67 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv69, i64 %indvars.iv.next59.6
...
.preheader44.us:                                  ; preds = %.preheader44.us.preheader, %._crit_edge51.us
  %indvars.iv82 = phi i64 [ %8, %._crit_edge51.us ], [ 0, %.preheader44.us.preheader ]
...
vector.ph:                                        ; preds = %vector.memcheck
  %.pre = load double, double* %10, align 8, !alias.scope !8
  %11 = insertelement <2 x double> undef, double %.pre, i32 0
  %12 = shufflevector <2 x double> %11, <2 x double> undef, <2 x i32> zeroinitializer
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %13 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv82, i64 %index
  ...
  %wide.load101 = load <2 x double>, <2 x double>* %16, align 8, !alias.scope !11, !noalias !13
  %17 = fmul <2 x double> %wide.load, %broadcast.splat103
  %18 = fmul <2 x double> %wide.load101, %broadcast.splat103
  %19 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv82, i64 %index
  %20 = bitcast double* %19 to <2 x double>*
  %wide.load104 = load <2 x double>, <2 x double>* %20, align 8, !alias.scope !15
  %21 = getelementptr double, double* %19, i64 2
  %22 = bitcast double* %21 to <2 x double>*
  %wide.load105 = load <2 x double>, <2 x double>* %22, align 8, !alias.scope !15
  %23 = fmul <2 x double> %wide.load104, %broadcast.splat107
  %24 = fmul <2 x double> %wide.load105, %broadcast.splat107
  %25 = fmul <2 x double> %23, %12
  ...
  store <2 x double> %29, <2 x double>* %14, align 8, !alias.scope !11, !noalias !13
  store <2 x double> %30, <2 x double>* %16, align 8, !alias.scope !11, !noalias !13
  %index.next = add i64 %index, 4
  %31 = icmp eq i64 %index.next, 1200
  br i1 %31, label %._crit_edge51.us.loopexit113, label %vector.body, !llvm.loop !16
...
.preheader.us61:                                  ; preds = %.preheader.us61, %.preheader.us61.preheader
  ...
  %32 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv82, i64 %indvars.iv
  %33 = load double, double* %32, align 8
  %34 = fmul double %33, %3
  %35 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv82, i64 %indvars.iv
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv82, i64 %indvars.iv.next
  %43 = load double, double* %42, align 8
  %44 = fmul double %43, %3
  %45 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv82, i64 %indvars.iv.next
  ...
  br i1 %exitcond.1, label %._crit_edge51.us.loopexit112, label %.preheader.us61, !llvm.loop !17

._crit_edge51.us.loopexit:                        ; preds = %._crit_edge.us.us
  br label %._crit_edge51.us

._crit_edge51.us.loopexit112:                     ; preds = %.preheader.us61
  br label %._crit_edge51.us

._crit_edge51.us.loopexit113:                     ; preds = %vector.body
  br label %._crit_edge51.us

._crit_edge51.us:                                 ; preds = %._crit_edge51.us.loopexit113, %._crit_edge51.us.loopexit112, %._crit_edge51.us.loopexit
  %exitcond85 = icmp eq i64 %8, 1000
...
.preheader.us.us:                                 ; preds = %.preheader.us.us.preheader, %._crit_edge.us.us
  ...
  %52 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv82, i64 %indvars.iv78
  br label %63

._crit_edge.us.us:                                ; preds = %63
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv82, i64 %indvars.iv78
...
; <label>:63:                                     ; preds = %63, %.preheader.us.us
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %63 ], [ 0, %.preheader.us.us ]
  %.047.us.us = phi double [ %76, %63 ], [ 0.000000e+00, %.preheader.us.us ]
  %64 = load double, double* %52, align 8
  %65 = fmul double %64, %2
  %66 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv82, i64 %indvars.iv72
  %67 = load double, double* %66, align 8
  %68 = fmul double %65, %67
  %69 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv72, i64 %indvars.iv78
  %70 = load double, double* %69, align 8
  %71 = fadd double %70, %68
  store double %71, double* %69, align 8
  %72 = getelementptr inbounds [1200 x double], [1200 x double]* %6, i64 %indvars.iv72, i64 %indvars.iv78
  %73 = load double, double* %72, align 8
  %74 = load double, double* %66, align 8
  %75 = fmul double %73, %74
  %76 = fadd double %.047.us.us, %75
  %indvars.iv.next73 = add nuw nsw i64 %indvars.iv72, 1
  %exitcond77 = icmp eq i64 %indvars.iv.next73, %indvars.iv82
  br i1 %exitcond77, label %._crit_edge.us.us, label %63
