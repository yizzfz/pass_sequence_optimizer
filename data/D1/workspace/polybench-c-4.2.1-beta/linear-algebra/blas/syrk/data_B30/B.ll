...
.lr.ph.us.new:                                    ; preds = %.lr.ph.us.new.preheader, %.lr.ph.us.new
  ...
  br i1 %exitcond.3, label %.preheader.us39.preheader.loopexit, label %.lr.ph.us.new
...
.prol.preheader54:                                ; preds = %.preheader.us39
  ...
  %38 = fmul double %37, %2
  %39 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 0, i64 %indvars.iv59
...
.prol.loopexit55:                                 ; preds = %.preheader.us39, %.prol.preheader54
  ...
  br i1 %53, label %._crit_edge.us42, label %.preheader.us39.new.preheader
...
.lr.ph.us:                                        ; preds = %._crit_edge33.us..lr.ph.us_crit_edge, %.preheader28.lr.ph
  ...
  %44 = zext i2 %indvars.iv87 to i64
  %45 = add nuw nsw i64 %44, 4294967295
  %46 = and i64 %45, 4294967295
  %47 = add nuw nsw i64 %46, 1
  %indvars.iv.next66 = add nuw nsw i64 %indvars.iv65, 1
  %48 = trunc i64 %indvars.iv.next66 to i32
...
.prol.preheader:                                  ; preds = %.prol.preheader.preheader, %.prol.preheader
  ...
  %49 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv65, i64 %indvars.iv.prol
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.loopexit, %.lr.ph.us
  ...
  %52 = icmp ult i64 %indvars.iv65, 3
  br i1 %52, label %.preheader.us39.preheader, label %.lr.ph.us.new.preheader
...
.preheader.us39.preheader:                        ; preds = %.preheader.us39.preheader.loopexit, %.prol.loopexit
  %xtraiter5685 = and i64 %indvars.iv.next66, 1
  %lcmp.mod57 = icmp eq i64 %xtraiter5685, 0
  %53 = icmp eq i64 %indvars.iv65, 0
  %54 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv65, i64 0
