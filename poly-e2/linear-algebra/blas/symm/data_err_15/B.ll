...
entry:
  ...
  call void @kernel_symm(i32 1000, i32 1200, double %0, double %1, [1200 x double]* %arraydecay, [1000 x double]* %arraydecay3, [1200 x double]* %arraydecay7)
...
for.cond23.preheader:                             ; preds = %for.cond23.preheader.preheader, %for.inc51.for.cond23.preheader_crit_edge
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc51.for.cond23.preheader_crit_edge ], [ 0, %for.cond23.preheader.preheader ]
  %indvar = phi i32 [ %indvar.next, %for.inc51.for.cond23.preheader_crit_edge ], [ 0, %for.cond23.preheader.preheader ]
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc51.for.cond23.preheader_crit_edge ], [ 1, %for.cond23.preheader.preheader ]
  %indvars.iv28 = phi i32 [ %indvars.iv.next29, %for.inc51.for.cond23.preheader_crit_edge ], [ 1, %for.cond23.preheader.preheader ]
  %5 = add i64 %indvars.iv35, 1
  %6 = and i64 %5, 4294967295
  %7 = sub i32 1007, %indvar
  %8 = sub i32 998, %indvar
...
for.body26.preheader:                             ; preds = %for.cond23.preheader
  ...
  %xtraiter44 = and i64 %5, 1
  %lcmp.mod45 = icmp eq i64 %xtraiter44, 0
  br i1 %lcmp.mod45, label %for.body26.prol.loopexit, label %for.body26.prol
...
for.body26.prol.loopexit:                         ; preds = %for.body26.prol, %for.body26.preheader
  ...
  %10 = icmp eq i64 %6, 1
  br i1 %10, label %for.cond40.preheader, label %for.body26.preheader.new
...
for.body26:                                       ; preds = %for.body26, %for.body26.preheader.new
  ...
  %12 = add nsw i64 %indvars.iv35, %indvars.iv
  ...
  %14 = add nsw i64 %indvars.iv35, %indvars.iv.next
...
for.inc51:                                        ; preds = %for.inc51.loopexit, %for.body43.prol.loopexit
  %16 = icmp slt i64 %indvars.iv.next36, 1000
  br i1 %16, label %for.inc51.for.cond23.preheader_crit_edge, label %for.end53
...
for.cond1.preheader:                              ; preds = %for.inc53.for.cond1.preheader_crit_edge, %entry
  %indvars.iv31 = phi i64 [ 0, %entry ], [ %indvars.iv.next32, %for.inc53.for.cond1.preheader_crit_edge ]
  %indvars.iv29 = phi i32 [ 0, %entry ], [ %indvars.iv.next30, %for.inc53.for.cond1.preheader_crit_edge ]
...
for.body3.us:                                     ; preds = %for.cond4.for.end_crit_edge.us, %for.body3.us.preheader
  %indvars.iv27 = phi i64 [ 0, %for.body3.us.preheader ], [ %indvars.iv.next28, %for.cond4.for.end_crit_edge.us ]
...
for.inc53:                                        ; preds = %for.inc53.loopexit61, %for.inc53.loopexit60, %for.inc53.loopexit
  ...
  br i1 %cmp, label %for.inc53.for.cond1.preheader_crit_edge, label %for.end55
