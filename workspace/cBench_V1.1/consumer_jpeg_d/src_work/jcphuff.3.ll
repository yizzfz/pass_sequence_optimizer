...
@__llvm_prf_nm = private constant [149 x i8] c"\EA\02\91\01x\DA}\90M\0EB!\0C\84\E3\85L\DC\BA3z\0F\02\8F\22\18\FE\D2\96\85\B7\B7\81D\1FD]2\F3\95\99\F6\11r`U}sNA\DE\8A\05<p\AA\A7c\8Cgb\8D\E2i\A2\01\BC\8D\01\AA\B45u\BB*\17\90\F8\9Bw\F9\E3\C9\1C\82\0B\19~\0C.\A6<\02\F9\D1\E5\AE\D9\03.\95\F6\C0R6\C9\82\08}\99Y\A4g2%\CE\9A\09L\B3\02\C5`\CB\9F\A0\D8$g\C2lKU\19\C9\DC\DDn|\D65\B0\1D\7F\01\DF:\87\00", section "__llvm_prf_names"
@llvm.used = appending global [17 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_jinit_phuff_encoder to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_start_pass_phuff to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_encode_mcu_DC_first to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_encode_mcu_AC_first to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_encode_mcu_DC_refine to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_encode_mcu_AC_refine to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_finish_pass_gather_phuff to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_finish_pass_phuff to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_emit_restart to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_emit_symbol to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_emit_bits to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_emit_eobrun to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_flush_bits to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_dump_buffer to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_emit_buffered_bits to i8*), i8* bitcast ([16 x { i64, i64, i8* }]* @__llvm_prf_vnodes to i8*), i8* getelementptr inbounds ([149 x i8], [149 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
...
define internal void @emit_symbol(%struct.phuff_entropy_encoder*, i32, i32) #3 {
  %4 = alloca %struct.phuff_entropy_encoder*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: inlinehint nounwind uwtable
define internal void @emit_bits(%struct.phuff_entropy_encoder*, i32, i32) #3 {
  %4 = alloca %struct.phuff_entropy_encoder*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
