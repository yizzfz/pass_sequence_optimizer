...
.lr.ph.us.new:                                    ; preds = %.lr.ph.us.new, %.lr.ph.us.new.preheader.new
  %indvars.iv = phi i64 [ %indvars.iv.unr120.ph, %.lr.ph.us.new.preheader.new ], [ %indvars.iv.next.3.1, %.lr.ph.us.new ]
  %11 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv68, i64 %indvars.iv
  ...
  %21 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv68, i64 %indvars.iv.next.3
  ...
  %26 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv68, i64 %indvars.iv.next.1.1
  %27 = bitcast double* %26 to <2 x double>*
  %28 = load <2 x double>, <2 x double>* %27, align 8
  %29 = fmul <2 x double> %28, %10
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %31 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv56, i64 %indvars.iv61
  %32 = load double, double* %31, align 8
  %33 = fmul double %32, %2
  %34 = load double, double* %46, align 8
  %35 = fmul double %33, %34
  %36 = getelementptr inbounds [1000 x double], [1000 x double]* %6, i64 %indvars.iv56, i64 %indvars.iv61
  %37 = load double, double* %36, align 8
  %38 = fmul double %37, %2
  %39 = load double, double* %47, align 8
  %40 = fmul double %38, %39
  %41 = fadd double %35, %40
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv68, i64 %indvars.iv56
...
.preheader.us46:                                  ; preds = %.preheader.us46.preheader, %._crit_edge.us49
  ...
  %45 = add i64 %indvars.iv61, 1
  %scevgep95 = getelementptr [1000 x double], [1000 x double]* %5, i64 %indvars.iv68, i64 %45
  %scevgep97 = getelementptr [1000 x double], [1000 x double]* %6, i64 0, i64 %indvars.iv61
  %scevgep99 = getelementptr [1000 x double], [1000 x double]* %6, i64 %indvars.iv68, i64 %45
  %46 = getelementptr inbounds [1000 x double], [1000 x double]* %6, i64 %indvars.iv68, i64 %indvars.iv61
  %47 = getelementptr inbounds [1000 x double], [1000 x double]* %5, i64 %indvars.iv68, i64 %indvars.iv61
...
vector.memcheck:                                  ; preds = %min.iters.checked
  %bound0 = icmp ult double* %scevgep, %47
  %bound1 = icmp ult double* %47, %scevgep91
  ...
  %bound0111 = icmp ult double* %scevgep, %46
  %bound1112 = icmp ult double* %46, %scevgep91
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %51 = load double, double* %49, align 8, !alias.scope !4
  %52 = load double, double* %50, align 8, !alias.scope !4
  ...
  %56 = load double, double* %46, align 8, !alias.scope !7
  ...
  %60 = getelementptr inbounds [1000 x double], [1000 x double]* %6, i64 %index, i64 %indvars.iv61
  %61 = getelementptr inbounds [1000 x double], [1000 x double]* %6, i64 %48, i64 %indvars.iv61
  %62 = load double, double* %60, align 8, !alias.scope !9
  %63 = load double, double* %61, align 8, !alias.scope !9
  %64 = insertelement <2 x double> undef, double %62, i32 0
  %65 = insertelement <2 x double> %64, double %63, i32 1
  %66 = fmul <2 x double> %65, %broadcast.splat116
  %67 = load double, double* %47, align 8, !alias.scope !11
  ...
  %72 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv68, i64 %index
  %73 = bitcast double* %72 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %73, align 8, !alias.scope !13, !noalias !15
  %74 = fadd <2 x double> %wide.load, %71
  %75 = bitcast double* %72 to <2 x double>*
  store <2 x double> %74, <2 x double>* %75, align 8, !alias.scope !13, !noalias !15
  %index.next = add i64 %index, 2
  %76 = icmp eq i64 %index.next, %n.vec
  br i1 %76, label %middle.block, label %vector.body, !llvm.loop !16

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %._crit_edge.us49, label %scalar.ph.preheader

.lr.ph.us:                                        ; preds = %.preheader35.lr.ph, %._crit_edge40.us
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %._crit_edge40.us ], [ 0, %.preheader35.lr.ph ]
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %._crit_edge40.us ], [ 1, %.preheader35.lr.ph ]
  %77 = add i64 %indvars.iv68, -3
  %scevgep = getelementptr [1200 x double], [1200 x double]* %4, i64 %indvars.iv68, i64 0
  %78 = mul i64 %indvars.iv68, 1201
  %79 = add i64 %78, 1
  %scevgep91 = getelementptr [1200 x double], [1200 x double]* %4, i64 0, i64 %79
  %80 = add i64 %indvars.iv68, 1
  %indvars.iv.next69 = add nuw nsw i64 %indvars.iv68, 1
  %81 = trunc i64 %indvars.iv.next69 to i32
...
.prol.preheader:                                  ; preds = %.prol.preheader.preheader, %.prol.preheader
  ...
  %82 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv68, i64 %indvars.iv.prol
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.loopexit, %.lr.ph.us
  ...
  %85 = icmp ult i64 %indvars.iv68, 3
  br i1 %85, label %.preheader.us46.preheader, label %.lr.ph.us.new.preheader

.lr.ph.us.new.preheader:                          ; preds = %.prol.loopexit
  %86 = sub i64 %77, %indvars.iv.unr
  %87 = lshr i64 %86, 2
  %88 = and i64 %87, 1
  %lcmp.mod118 = icmp eq i64 %88, 0
  br i1 %lcmp.mod118, label %.lr.ph.us.new.prol.preheader, label %.lr.ph.us.new.prol.loopexit.unr-lcssa
...
.lr.ph.us.new.prol:                               ; preds = %.lr.ph.us.new.prol.preheader
  %89 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv68, i64 %indvars.iv.unr
  %90 = bitcast double* %89 to <2 x double>*
  %91 = load <2 x double>, <2 x double>* %90, align 8
  %92 = fmul <2 x double> %91, %8
  ...
  %94 = getelementptr inbounds [1200 x double], [1200 x double]* %4, i64 %indvars.iv68, i64 %indvars.iv.next.1.prol
  %95 = bitcast double* %94 to <2 x double>*
  %96 = load <2 x double>, <2 x double>* %95, align 8
  %97 = fmul <2 x double> %96, %10
...
.lr.ph.us.new.prol.loopexit.unr-lcssa:            ; preds = %.lr.ph.us.new.preheader, %.lr.ph.us.new.prol
  %indvars.iv.unr120.ph = phi i64 [ %indvars.iv.next.3.prol, %.lr.ph.us.new.prol ], [ %indvars.iv.unr, %.lr.ph.us.new.preheader ]
  br label %.lr.ph.us.new.prol.loopexit

.lr.ph.us.new.prol.loopexit:                      ; preds = %.lr.ph.us.new.prol.loopexit.unr-lcssa
  %99 = icmp eq i64 %87, 0
  br i1 %99, label %.preheader.us46.preheader.loopexit, label %.lr.ph.us.new.preheader.new
