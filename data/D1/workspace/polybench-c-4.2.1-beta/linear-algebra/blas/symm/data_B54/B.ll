...
.preheader6:                                      ; preds = %.preheader6.loopexit, %.preheader7.lr.ph
  ...
  br i1 %45, label %.preheader5.lr.ph, label %97
...
.preheader5:                                      ; preds = %.preheader5.lr.ph, %._crit_edge
  ...
  %60 = sub i32 %52, %indvar
  %61 = sub i32 %54, %indvar
  %62 = icmp slt i64 %indvars.iv42, 0
  br i1 %62, label %.preheader, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader5
  %63 = add i32 %49, %indvar
  %xtraiter = and i32 %63, 1
  %lcmp.mod = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod, label %.prol.loopexit, label %.prol.preheader

.prol.preheader:                                  ; preds = %.lr.ph
  %64 = trunc i64 %indvars.iv42 to i32
  %65 = srem i32 %64, 100
  %66 = sitofp i32 %65 to double
  %67 = fdiv double %66, %48
  %68 = getelementptr inbounds [1000 x double], [1000 x double]* %47, i64 %indvars.iv42, i64 0
...
.prol.loopexit:                                   ; preds = %.prol.preheader, %.lr.ph
  ...
  %69 = sub i32 0, %indvar
  %70 = icmp eq i32 %.promoted, %69
  br i1 %70, label %.preheader, label %.lr.ph.new.preheader
...
.preheader:                                       ; preds = %.preheader.loopexit, %.prol.loopexit, %.preheader5
  ...
  %71 = icmp slt i64 %indvars.iv.next43, %57
  br i1 %71, label %.lr.ph11, label %._crit_edge

.lr.ph11:                                         ; preds = %.preheader
  %xtraiter38 = and i32 %60, 7
...
.prol.preheader36:                                ; preds = %.prol.preheader36.preheader, %.prol.preheader36
  ...
  %72 = getelementptr inbounds [1000 x double], [1000 x double]* %47, i64 %indvars.iv42, i64 %indvars.iv34.prol
...
.prol.loopexit37:                                 ; preds = %.prol.loopexit37.loopexit, %.lr.ph11
  ...
  %73 = icmp ult i32 %61, 7
  br i1 %73, label %._crit_edge, label %.lr.ph11.new.preheader
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %74 = add nsw i64 %indvars.iv, %indvars.iv42
  %75 = trunc i64 %74 to i32
  %76 = srem i32 %75, 100
  %77 = sitofp i32 %76 to double
  %78 = getelementptr inbounds [1000 x double], [1000 x double]* %47, i64 %indvars.iv42, i64 %indvars.iv
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %79 = add nsw i64 %indvars.iv.next, %indvars.iv42
  %80 = trunc i64 %79 to i32
  %81 = srem i32 %80, 100
  %82 = sitofp i32 %81 to double
  %83 = insertelement <2 x double> undef, double %77, i32 0
  %84 = insertelement <2 x double> %83, double %82, i32 1
  %85 = fdiv <2 x double> %84, %59
  %86 = bitcast double* %78 to <2 x double>*
...
.lr.ph11.new:                                     ; preds = %.lr.ph11.new.preheader, %.lr.ph11.new
  ...
  %87 = getelementptr inbounds [1000 x double], [1000 x double]* %47, i64 %indvars.iv42, i64 %indvars.iv34
  store double -9.990000e+02, double* %87, align 8
  %indvars.iv.next35 = add nsw i64 %indvars.iv34, 1
  %88 = getelementptr inbounds [1000 x double], [1000 x double]* %47, i64 %indvars.iv42, i64 %indvars.iv.next35
  store double -9.990000e+02, double* %88, align 8
  %indvars.iv.next35.1 = add nsw i64 %indvars.iv34, 2
  %89 = getelementptr inbounds [1000 x double], [1000 x double]* %47, i64 %indvars.iv42, i64 %indvars.iv.next35.1
  store double -9.990000e+02, double* %89, align 8
  %indvars.iv.next35.2 = add nsw i64 %indvars.iv34, 3
  %90 = getelementptr inbounds [1000 x double], [1000 x double]* %47, i64 %indvars.iv42, i64 %indvars.iv.next35.2
  store double -9.990000e+02, double* %90, align 8
  %indvars.iv.next35.3 = add nsw i64 %indvars.iv34, 4
  %91 = getelementptr inbounds [1000 x double], [1000 x double]* %47, i64 %indvars.iv42, i64 %indvars.iv.next35.3
  store double -9.990000e+02, double* %91, align 8
  %indvars.iv.next35.4 = add nsw i64 %indvars.iv34, 5
  %92 = getelementptr inbounds [1000 x double], [1000 x double]* %47, i64 %indvars.iv42, i64 %indvars.iv.next35.4
  store double -9.990000e+02, double* %92, align 8
  %indvars.iv.next35.5 = add nsw i64 %indvars.iv34, 6
  %93 = getelementptr inbounds [1000 x double], [1000 x double]* %47, i64 %indvars.iv42, i64 %indvars.iv.next35.5
  store double -9.990000e+02, double* %93, align 8
  %indvars.iv.next35.6 = add nsw i64 %indvars.iv34, 7
  %94 = getelementptr inbounds [1000 x double], [1000 x double]* %47, i64 %indvars.iv42, i64 %indvars.iv.next35.6
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.prol.loopexit37, %.preheader
  %95 = icmp slt i64 %indvars.iv.next43, %56
  %indvars.iv.next31 = add i32 %indvars.iv30, 1
  %indvar.next = add i32 %indvar, 1
  %indvars.iv.next33 = add nsw i64 %indvars.iv32, 1
  br i1 %95, label %.preheader5, label %._crit_edge14
...
; <label>:97:                                     ; preds = %.preheader6.thread, %._crit_edge14, %.preheader6
  ret void
}
