...
._crit_edge2:                                     ; preds = %._crit_edge2, %2
  %indvars.iv510 = phi i64 [ 0, %2 ], [ %indvars.iv.next6.2, %._crit_edge2 ]
  ...
  br i1 %exitcond7.2, label %._crit_edge1.preheader.preheader, label %._crit_edge2

._crit_edge1.preheader.preheader:                 ; preds = %._crit_edge2
  br label %._crit_edge1.preheader

._crit_edge1.preheader:                           ; preds = %._crit_edge1.preheader.preheader, %._crit_edge
  %indvars.iv29 = phi i64 [ %indvars.iv.next3, %._crit_edge ], [ 0, %._crit_edge1.preheader.preheader ]
  br label %._crit_edge1

._crit_edge1:                                     ; preds = %._crit_edge1, %._crit_edge1.preheader
  %indvars.iv8 = phi i64 [ 0, %._crit_edge1.preheader ], [ %indvars.iv.next.1, %._crit_edge1 ]
...
._crit_edge:                                      ; preds = %._crit_edge1
  ...
  br i1 %exitcond4, label %31, label %._crit_edge1.preheader
...
._crit_edge.preheader:                            ; preds = %._crit_edge2
...
._crit_edge2:                                     ; preds = %._crit_edge2, %4
  %indvars.iv821 = phi i64 [ 0, %4 ], [ %indvars.iv.next9.11, %._crit_edge2 ]
  ...
  br i1 %exitcond10.11, label %._crit_edge.preheader, label %._crit_edge2

._crit_edge._crit_edge:                           ; preds = %._crit_edge, %._crit_edge.preheader
  %indvars.iv520 = phi i64 [ 0, %._crit_edge.preheader ], [ %indvars.iv.next6, %._crit_edge ]
...
._crit_edge3:                                     ; preds = %._crit_edge3, %._crit_edge._crit_edge
  %indvars.iv18 = phi i64 [ 0, %._crit_edge._crit_edge ], [ %indvars.iv.next.1, %._crit_edge3 ]
  ...
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2100
  br i1 %exitcond.1, label %._crit_edge1.preheader, label %._crit_edge3
...
._crit_edge1:                                     ; preds = %._crit_edge1, %._crit_edge1.preheader
  %indvars.iv219 = phi i64 [ 0, %._crit_edge1.preheader ], [ %indvars.iv.next3.1, %._crit_edge1 ]
  ...
  br i1 %exitcond4.1, label %._crit_edge, label %._crit_edge1

._crit_edge:                                      ; preds = %._crit_edge1
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv520, 1
  %exitcond7 = icmp eq i64 %indvars.iv.next6, 1900
  br i1 %exitcond7, label %52, label %._crit_edge._crit_edge
