...
.preheader73.lr.ph:                               ; preds = %2
  ...
  %7 = zext i32 %6 to i64
  %8 = sext i32 %0 to i64
  %wide.trip.count154 = zext i32 %0 to i64
  br label %.lr.ph95

.lr.ph95:                                         ; preds = %._crit_edge100, %.preheader73.lr.ph
  %indvars.iv152 = phi i64 [ 0, %.preheader73.lr.ph ], [ %indvars.iv.next153, %._crit_edge100 ]
  %indvars.iv150 = phi i64 [ 1, %.preheader73.lr.ph ], [ %indvars.iv.next151, %._crit_edge100 ]
  %9 = add nuw nsw i64 %indvars.iv152, 1
  %10 = sub i64 %7, %indvars.iv152
  %11 = shl i64 %10, 3
  %12 = and i64 %11, 34359738360
  br label %13

; <label>:13:                                     ; preds = %13, %.lr.ph95
  %indvars.iv135 = phi i64 [ %indvars.iv.next136, %13 ], [ 0, %.lr.ph95 ]
  %14 = sub nsw i64 0, %indvars.iv135
  %15 = trunc i64 %14 to i32
  %16 = srem i32 %15, %0
  %17 = sitofp i32 %16 to double
  %18 = fdiv double %17, %5
  %19 = fadd double %18, 1.000000e+00
  %20 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv152, i64 %indvars.iv135
  store double %19, double* %20, align 8
  %indvars.iv.next136 = add nuw nsw i64 %indvars.iv135, 1
  %exitcond140 = icmp eq i64 %indvars.iv.next136, %indvars.iv150
  br i1 %exitcond140, label %._crit_edge96, label %13

._crit_edge96:                                    ; preds = %13
  %indvars.iv.next153 = add nuw nsw i64 %indvars.iv152, 1
  %21 = icmp slt i64 %indvars.iv.next153, %8
  br i1 %21, label %.lr.ph99.preheader, label %._crit_edge100

.lr.ph99.preheader:                               ; preds = %._crit_edge96
  %22 = add nuw nsw i64 %12, 8
  %scevgep147 = getelementptr [2000 x double], [2000 x double]* %1, i64 0, i64 %9
  %23 = mul nuw nsw i64 %indvars.iv152, 2000
  %scevgep148 = getelementptr double, double* %scevgep147, i64 %23
  %scevgep148149 = bitcast double* %scevgep148 to i8*
  call void @llvm.memset.p0i8.i64(i8* %scevgep148149, i8 0, i64 %22, i32 8, i1 false)
  br label %._crit_edge100

._crit_edge100:                                   ; preds = %.lr.ph99.preheader, %._crit_edge96
  %24 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv152, i64 %indvars.iv152
  store double 1.000000e+00, double* %24, align 8
  %indvars.iv.next151 = add nuw nsw i64 %indvars.iv150, 1
  %exitcond155 = icmp eq i64 %indvars.iv.next153, %wide.trip.count154
  br i1 %exitcond155, label %._crit_edge102, label %.lr.ph95

._crit_edge102:                                   ; preds = %._crit_edge100
  %25 = icmp sgt i32 %0, 0
  %26 = tail call i8* @polybench_alloc_data(i64 4000000, i32 8) #4
  br i1 %25, label %.preheader72.us.preheader, label %._crit_edge76

.preheader72.us.preheader:                        ; preds = %._crit_edge102
  %27 = add i32 %0, -1
...
._crit_edge92.us.prol.preheader:                  ; preds = %.preheader72.us.preheader
  %31 = add nsw i32 %xtraiter132, -1
  %32 = zext i32 %31 to i64
  br label %._crit_edge92.us.prol

._crit_edge92.us.prol:                            ; preds = %._crit_edge92.us.prol.preheader, %._crit_edge92.us.prol
  %indvars.iv128.prol = phi i64 [ %indvars.iv.next129.prol, %._crit_edge92.us.prol ], [ 0, %._crit_edge92.us.prol.preheader ]
  %prol.iter134 = phi i32 [ %prol.iter134.sub, %._crit_edge92.us.prol ], [ %xtraiter132, %._crit_edge92.us.prol.preheader ]
  %33 = mul nuw nsw i64 %indvars.iv128.prol, 16000
  ...
  br i1 %prol.iter134.cmp, label %.preheader72.us.prol.loopexit.loopexit, label %._crit_edge92.us.prol, !llvm.loop !1
...
.preheader72.us.prol.loopexit:                    ; preds = %.preheader72.us.prol.loopexit.loopexit, %.preheader72.us.preheader
  %indvars.iv128.unr = phi i64 [ 0, %.preheader72.us.preheader ], [ %34, %.preheader72.us.prol.loopexit.loopexit ]
  %35 = icmp ult i32 %27, 3
  br i1 %35, label %.preheader70.lr.ph, label %._crit_edge92.us.3.preheader

._crit_edge92.us.3.preheader:                     ; preds = %.preheader72.us.prol.loopexit
  %wide.trip.count130.3 = zext i32 %0 to i64
  %36 = add nsw i64 %wide.trip.count130.3, -4
  %37 = sub nsw i64 %36, %indvars.iv128.unr
  %38 = lshr i64 %37, 2
  %39 = and i64 %38, 1
...
._crit_edge92.us.3.prol:                          ; preds = %._crit_edge92.us.3.prol.preheader
  %40 = mul nuw nsw i64 %indvars.iv128.unr, 16000
  %scevgep.prol163 = getelementptr i8, i8* %26, i64 %40
  call void @llvm.memset.p0i8.i64(i8* %scevgep.prol163, i8 0, i64 %30, i32 8, i1 false)
  %41 = mul nsw i64 %indvars.iv128.unr, 16000
  %42 = add i64 %41, 16000
  %scevgep.1.prol = getelementptr i8, i8* %26, i64 %42
  call void @llvm.memset.p0i8.i64(i8* %scevgep.1.prol, i8 0, i64 %30, i32 8, i1 false)
  %43 = mul nsw i64 %indvars.iv128.unr, 16000
  %44 = add i64 %43, 32000
  %scevgep.2.prol = getelementptr i8, i8* %26, i64 %44
  call void @llvm.memset.p0i8.i64(i8* %scevgep.2.prol, i8 0, i64 %30, i32 8, i1 false)
  %45 = mul nsw i64 %indvars.iv128.unr, 16000
  %46 = add i64 %45, 48000
...
._crit_edge92.us.3.prol.loopexit:                 ; preds = %._crit_edge92.us.3.prol, %._crit_edge92.us.3.preheader
  %indvars.iv128.unr164 = phi i64 [ %indvars.iv128.unr, %._crit_edge92.us.3.preheader ], [ %indvars.iv.next129.3.prol, %._crit_edge92.us.3.prol ]
  %47 = icmp eq i64 %38, 0
  br i1 %47, label %.preheader71, label %._crit_edge92.us.3.preheader.new

._crit_edge92.us.3.preheader.new:                 ; preds = %._crit_edge92.us.3.prol.loopexit
  br label %._crit_edge92.us.3

.preheader71.unr-lcssa:                           ; preds = %._crit_edge92.us.3
  br label %.preheader71

.preheader71:                                     ; preds = %._crit_edge92.us.3.prol.loopexit, %.preheader71.unr-lcssa
  %48 = icmp sgt i32 %0, 0
  br i1 %48, label %.preheader70.lr.ph, label %._crit_edge76

.preheader70.lr.ph:                               ; preds = %.preheader72.us.prol.loopexit, %.preheader71
  %xtraiter114 = and i32 %0, 1
  %wide.trip.count118 = zext i32 %0 to i64
  %wide.trip.count110.1 = zext i32 %0 to i64
  %wide.trip.count122 = zext i32 %0 to i64
  %49 = icmp eq i32 %xtraiter114, 0
  %50 = icmp eq i32 %0, 1
...
.preheader69.us.us.preheader:                     ; preds = %._crit_edge81.us, %.preheader70.lr.ph
  %indvars.iv120 = phi i64 [ %indvars.iv.next121, %._crit_edge81.us ], [ 0, %.preheader70.lr.ph ]
  %sunkaddr158 = shl i64 %indvars.iv120, 3
...
._crit_edge81.us:                                 ; preds = %._crit_edge79.us.us
  ...
  %exitcond123 = icmp eq i64 %indvars.iv.next121, %wide.trip.count122
  br i1 %exitcond123, label %.preheader68, label %.preheader69.us.us.preheader
...
.preheader69.us.us:                               ; preds = %._crit_edge79.us.us, %.preheader69.us.us.preheader
  ...
  %53 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv116, i64 %indvars.iv120
  br i1 %49, label %.prol.loopexit113, label %54

; <label>:54:                                     ; preds = %.preheader69.us.us
  %55 = load double, double* %53, align 8
  %56 = load double, double* %sunkaddr160, align 8
  %57 = fmul double %55, %56
  %58 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %52, i64 0, i64 %indvars.iv116, i64 0
  %59 = load double, double* %58, align 8
  %60 = fadd double %59, %57
  store double %60, double* %58, align 8
  br label %.prol.loopexit113

.prol.loopexit113:                                ; preds = %.preheader69.us.us, %54
  %indvars.iv108.unr.ph = phi i64 [ 1, %54 ], [ 0, %.preheader69.us.us ]
  br i1 %50, label %._crit_edge79.us.us, label %.preheader69.us.us.new.preheader
...
.preheader69.us.us.new:                           ; preds = %.preheader69.us.us.new.preheader, %.preheader69.us.us.new
  ...
  %62 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv108, i64 %indvars.iv120
  %63 = load double, double* %62, align 8
  %64 = fmul double %61, %63
  %65 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %51, i64 0, i64 %indvars.iv116, i64 %indvars.iv108
  %66 = load double, double* %65, align 8
  %67 = fadd double %66, %64
  store double %67, double* %65, align 8
  %indvars.iv.next109 = add nuw nsw i64 %indvars.iv108, 1
  %68 = load double, double* %53, align 8
  %69 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv.next109, i64 %indvars.iv120
  %70 = load double, double* %69, align 8
  %71 = fmul double %68, %70
  %72 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %51, i64 0, i64 %indvars.iv116, i64 %indvars.iv.next109
  %73 = load double, double* %72, align 8
  %74 = fadd double %73, %71
  store double %74, double* %72, align 8
  %indvars.iv.next109.1 = add nuw nsw i64 %indvars.iv108, 2
  %exitcond111.1 = icmp eq i64 %indvars.iv.next109.1, %wide.trip.count110.1
  br i1 %exitcond111.1, label %._crit_edge79.us.us.loopexit, label %.preheader69.us.us.new

.preheader68:                                     ; preds = %._crit_edge81.us
  %75 = icmp sgt i32 %0, 0
  br i1 %75, label %.preheader.us.preheader, label %._crit_edge76

.preheader.us.preheader:                          ; preds = %.preheader68
  %76 = add i32 %0, -1
...
.prol.preheader:                                  ; preds = %.prol.preheader.preheader, %.prol.preheader
  ...
  %84 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %83, i64 0, i64 %indvars.iv105, i64 %indvars.iv.prol
  %85 = bitcast double* %84 to i64*
  %86 = load i64, i64* %85, align 8
  %87 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv105, i64 %indvars.iv.prol
...
.preheader.us.new:                                ; preds = %.preheader.us.new.preheader, %.preheader.us.new
  ...
  %89 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %82, i64 0, i64 %indvars.iv105, i64 %indvars.iv
  %90 = bitcast double* %89 to i64*
  %91 = load i64, i64* %90, align 8
  %92 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv105, i64 %indvars.iv
  %93 = bitcast double* %92 to i64*
  store i64 %91, i64* %93, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %94 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %82, i64 0, i64 %indvars.iv105, i64 %indvars.iv.next
  %95 = bitcast double* %94 to i64*
  %96 = load i64, i64* %95, align 8
  %97 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv105, i64 %indvars.iv.next
  %98 = bitcast double* %97 to i64*
  store i64 %96, i64* %98, align 8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %99 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %82, i64 0, i64 %indvars.iv105, i64 %indvars.iv.next.1
  %100 = bitcast double* %99 to i64*
  %101 = load i64, i64* %100, align 8
  %102 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv105, i64 %indvars.iv.next.1
  %103 = bitcast double* %102 to i64*
  store i64 %101, i64* %103, align 8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %104 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %82, i64 0, i64 %indvars.iv105, i64 %indvars.iv.next.2
  %105 = bitcast double* %104 to i64*
  %106 = load i64, i64* %105, align 8
  %107 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv105, i64 %indvars.iv.next.2
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.loopexit, %.prol.loopexit
  ...
  %exitcond = icmp eq i64 %indvars.iv.next106, %wide.trip.count107
  br i1 %exitcond, label %._crit_edge76.loopexit, label %.preheader.us

._crit_edge76.loopexit:                           ; preds = %._crit_edge.us
  br label %._crit_edge76

._crit_edge76:                                    ; preds = %._crit_edge76.loopexit, %._crit_edge102, %._crit_edge102.thread, %.preheader71, %.preheader68
  %109 = phi i8* [ %26, %.preheader68 ], [ %26, %.preheader71 ], [ %26, %._crit_edge102 ], [ %4, %._crit_edge102.thread ], [ %26, %._crit_edge76.loopexit ]
  tail call void @free(i8* %109) #4
  ret void

._crit_edge92.us.3:                               ; preds = %._crit_edge92.us.3, %._crit_edge92.us.3.preheader.new
  %indvars.iv128 = phi i64 [ %indvars.iv128.unr164, %._crit_edge92.us.3.preheader.new ], [ %indvars.iv.next129.3.1, %._crit_edge92.us.3 ]
  %110 = mul nuw nsw i64 %indvars.iv128, 16000
  %scevgep = getelementptr i8, i8* %26, i64 %110
  call void @llvm.memset.p0i8.i64(i8* %scevgep, i8 0, i64 %30, i32 8, i1 false)
  %111 = mul i64 %indvars.iv128, 16000
  ...
  %113 = mul i64 %indvars.iv128, 16000
  ...
  %115 = mul i64 %indvars.iv128, 16000
  ...
  %117 = mul nuw nsw i64 %indvars.iv.next129.3, 16000
  %scevgep.1165 = getelementptr i8, i8* %26, i64 %117
  call void @llvm.memset.p0i8.i64(i8* %scevgep.1165, i8 0, i64 %30, i32 8, i1 false)
  %118 = mul i64 %indvars.iv.next129.3, 16000
  ...
  %120 = mul i64 %indvars.iv.next129.3, 16000
  ...
  %122 = mul i64 %indvars.iv.next129.3, 16000
  ...
  %exitcond131.3.1 = icmp eq i64 %indvars.iv.next129.3.1, %wide.trip.count130.3
  br i1 %exitcond131.3.1, label %.preheader71.unr-lcssa, label %._crit_edge92.us.3
}
...
.preheader.lr.ph:                                 ; preds = %._crit_edge
  ...
  br i1 %7, label %.preheader.us.preheader, label %._crit_edge51

.preheader.us.preheader:                          ; preds = %.preheader.lr.ph
  %xtraiter7893 = and i64 %indvars.iv89, 1
  %8 = trunc i64 %4 to i32
  %9 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv89, i64 0
  %10 = icmp eq i64 %xtraiter7893, 0
  %11 = icmp eq i32 %8, 0
  br label %.preheader.us
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge49.us
  ...
  %12 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv89, i64 %indvars.iv83
  %.pre59 = load double, double* %12, align 8
  br i1 %10, label %.prol.loopexit77, label %13

; <label>:13:                                     ; preds = %.preheader.us
  %14 = load double, double* %9, align 8
  %15 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 0, i64 %indvars.iv83
  %16 = load double, double* %15, align 8
  %17 = fmul double %14, %16
  %18 = fsub double %.pre59, %17
  store double %18, double* %12, align 8
  br label %.prol.loopexit77

.prol.loopexit77:                                 ; preds = %.preheader.us, %13
  %indvars.iv71.unr.ph = phi i64 [ 1, %13 ], [ 0, %.preheader.us ]
  %.unr80.ph = phi double [ %18, %13 ], [ %.pre59, %.preheader.us ]
  br i1 %11, label %._crit_edge49.us, label %.preheader.us.new.preheader
...
.preheader.us.new:                                ; preds = %.preheader.us.new.preheader, %.preheader.us.new
  ...
  %19 = phi double [ %31, %.preheader.us.new ], [ %.unr80.ph, %.preheader.us.new.preheader ]
  %20 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv89, i64 %indvars.iv71
  %21 = load double, double* %20, align 8
  %22 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv71, i64 %indvars.iv83
  %23 = load double, double* %22, align 8
  %24 = fmul double %21, %23
  %25 = fsub double %19, %24
  store double %25, double* %12, align 8
  %indvars.iv.next72 = add nuw nsw i64 %indvars.iv71, 1
  %26 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv89, i64 %indvars.iv.next72
  %27 = load double, double* %26, align 8
  %28 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv.next72, i64 %indvars.iv83
...
.preheader42:                                     ; preds = %.preheader42.preheader, %._crit_edge
  ...
  %32 = add nuw i64 %indvars.iv65, 4294967295
  %33 = icmp sgt i64 %indvars.iv65, 0
  %34 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv89, i64 %indvars.iv65
...
; <label>:35:                                     ; preds = %.lr.ph
  ...
  %37 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 0, i64 %indvars.iv65
...
.lr.ph.new:                                       ; preds = %.lr.ph.new.preheader, %.lr.ph.new
  ...
  %44 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv89, i64 %indvars.iv
  %45 = load double, double* %44, align 8
  %46 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv, i64 %indvars.iv65
  %47 = load double, double* %46, align 8
  %48 = fmul double %45, %47
  %49 = fsub double %43, %48
  store double %49, double* %34, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %50 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv89, i64 %indvars.iv.next
  %51 = load double, double* %50, align 8
  %52 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv.next, i64 %indvars.iv65
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader42, %.prol.loopexit
  %56 = phi double [ %.lcssa.unr.ph, %.prol.loopexit ], [ %.pre, %.preheader42 ], [ %55, %._crit_edge.loopexit ]
  %57 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv65, i64 %indvars.iv65
  %58 = load double, double* %57, align 8
  %59 = fdiv double %56, %58
  store double %59, double* %34, align 8
  %indvars.iv.next66 = add nuw nsw i64 %indvars.iv65, 1
  %exitcond = icmp eq i64 %indvars.iv.next66, %indvars.iv89
  br i1 %exitcond, label %.preheader.lr.ph, label %.preheader42
