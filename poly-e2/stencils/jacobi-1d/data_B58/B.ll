...
entry:
  ...
  %scevgep83 = getelementptr double, double* %A, i64 1999
  %scevgep86 = getelementptr double, double* %B, i64 2000
  %scevgep99 = getelementptr double, double* %B, i64 1
  %scevgep101 = getelementptr double, double* %B, i64 1999
  %scevgep104 = getelementptr double, double* %A, i64 2000
  %bound0106 = icmp ult double* %scevgep99, %scevgep104
  %bound1107 = icmp ugt double* %scevgep101, %A
  %found.conflict108 = and i1 %bound0106, %bound1107
  %bound0 = icmp ult double* %scevgep, %scevgep86
  %bound1 = icmp ugt double* %scevgep83, %B
  %found.conflict = and i1 %bound0, %bound1
  br label %for.body.us

for.body.us:                                      ; preds = %for.inc33.us.for.body.us_crit_edge, %entry
  %inc3413.us = phi i32 [ %inc34.us, %for.inc33.us.for.body.us_crit_edge ], [ 0, %entry ]
  br i1 %found.conflict108, label %for.body.us.for.body3.us_crit_edge, label %for.body.us.vector.body94_crit_edge

for.body.us.vector.body94_crit_edge:              ; preds = %for.body.us
  br label %vector.body94

for.body.us.for.body3.us_crit_edge:               ; preds = %for.body.us
  br label %for.body3.us.preheader

vector.body94:                                    ; preds = %vector.body94.vector.body94_crit_edge, %for.body.us.vector.body94_crit_edge
  %index112 = phi i64 [ %index.next113, %vector.body94.vector.body94_crit_edge ], [ 0, %for.body.us.vector.body94_crit_edge ]
  %offset.idx116 = or i64 %index112, 1
  %0 = getelementptr inbounds double, double* %A, i64 %index112
  %1 = bitcast double* %0 to <2 x double>*
  %wide.load121 = load <2 x double>, <2 x double>* %1, align 8, !alias.scope !1
  %2 = getelementptr double, double* %0, i64 2
  %3 = bitcast double* %2 to <2 x double>*
  %wide.load122 = load <2 x double>, <2 x double>* %3, align 8, !alias.scope !1
  %4 = getelementptr inbounds double, double* %A, i64 %offset.idx116
  %5 = bitcast double* %4 to <2 x double>*
  %wide.load123 = load <2 x double>, <2 x double>* %5, align 8, !alias.scope !1
  %6 = getelementptr double, double* %4, i64 2
  %7 = bitcast double* %6 to <2 x double>*
  %wide.load124 = load <2 x double>, <2 x double>* %7, align 8, !alias.scope !1
  %8 = fadd <2 x double> %wide.load121, %wide.load123
  %9 = fadd <2 x double> %wide.load122, %wide.load124
  %10 = add nuw nsw i64 %offset.idx116, 1
  %11 = getelementptr inbounds double, double* %A, i64 %10
  %12 = getelementptr double, double* %11, i64 2
  %13 = bitcast double* %12 to <2 x double>*
  %wide.load126 = load <2 x double>, <2 x double>* %13, align 8, !alias.scope !1
  %14 = fadd <2 x double> %8, %wide.load122
  %15 = fadd <2 x double> %9, %wide.load126
  ...
  %18 = getelementptr inbounds double, double* %B, i64 %offset.idx116
  ...
  %22 = icmp eq i64 %index.next113, 1996
  br i1 %22, label %vector.body94.for.body3.us_crit_edge, label %vector.body94.vector.body94_crit_edge, !llvm.loop !6

vector.body94.vector.body94_crit_edge:            ; preds = %vector.body94
  br label %vector.body94

vector.body94.for.body3.us_crit_edge:             ; preds = %vector.body94
  br label %for.body3.us.preheader

for.body3.us.preheader:                           ; preds = %for.body.us.for.body3.us_crit_edge, %vector.body94.for.body3.us_crit_edge
  %indvars.iv.ph = phi i64 [ 1997, %vector.body94.for.body3.us_crit_edge ], [ 1, %for.body.us.for.body3.us_crit_edge ]
  br label %for.body3.us

for.inc33.us:                                     ; preds = %for.body16.us
  %inc34.us = add nuw nsw i32 %inc3413.us, 1
  %exitcond = icmp eq i32 %inc34.us, 500
  br i1 %exitcond, label %for.end35, label %for.inc33.us.for.body.us_crit_edge

for.inc33.us.for.body.us_crit_edge:               ; preds = %for.inc33.us
  br label %for.body.us

for.body16.us:                                    ; preds = %for.body16.us.preheader, %for.body16.us.for.body16.us_crit_edge
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.body16.us.for.body16.us_crit_edge ], [ %indvars.iv68.ph, %for.body16.us.preheader ]
  %23 = add nsw i64 %indvars.iv68, -1
  %arrayidx19.us = getelementptr inbounds double, double* %B, i64 %23
  %24 = load double, double* %arrayidx19.us, align 8
  %arrayidx21.us = getelementptr inbounds double, double* %B, i64 %indvars.iv68
  %25 = load double, double* %arrayidx21.us, align 8
  %add22.us = fadd double %24, %25
  %indvars.iv.next69 = add nuw nsw i64 %indvars.iv68, 1
  %arrayidx25.us = getelementptr inbounds double, double* %B, i64 %indvars.iv.next69
  %26 = load double, double* %arrayidx25.us, align 8
  %add26.us = fadd double %add22.us, %26
  %mul27.us = fmul double %add26.us, 3.333300e-01
  %arrayidx29.us = getelementptr inbounds double, double* %A, i64 %indvars.iv68
  store double %mul27.us, double* %arrayidx29.us, align 8
  %exitcond81 = icmp eq i64 %indvars.iv.next69, 1999
  br i1 %exitcond81, label %for.inc33.us, label %for.body16.us.for.body16.us_crit_edge, !llvm.loop !9
...
for.body3.us:                                     ; preds = %for.body3.us.preheader, %for.body3.us.for.body3.us_crit_edge
  ...
  %exitcond80 = icmp eq i64 %indvars.iv.next, 1999
  br i1 %exitcond80, label %vector.memcheck, label %for.body3.us.for.body3.us_crit_edge, !llvm.loop !10

for.body3.us.for.body3.us_crit_edge:              ; preds = %for.body3.us
  br label %for.body3.us

vector.memcheck:                                  ; preds = %for.body3.us
...
vector.body:                                      ; preds = %vector.body.vector.body_crit_edge, %vector.memcheck.vector.body_crit_edge
  ...
  %31 = getelementptr inbounds double, double* %B, i64 %index
  %32 = bitcast double* %31 to <2 x double>*
  %wide.load = load <2 x double>, <2 x double>* %32, align 8, !alias.scope !11
  %33 = getelementptr double, double* %31, i64 2
  %34 = bitcast double* %33 to <2 x double>*
  %wide.load89 = load <2 x double>, <2 x double>* %34, align 8, !alias.scope !11
  %35 = getelementptr inbounds double, double* %B, i64 %offset.idx
  %36 = bitcast double* %35 to <2 x double>*
  %wide.load90 = load <2 x double>, <2 x double>* %36, align 8, !alias.scope !11
  %37 = getelementptr double, double* %35, i64 2
  %38 = bitcast double* %37 to <2 x double>*
  %wide.load91 = load <2 x double>, <2 x double>* %38, align 8, !alias.scope !11
  %39 = fadd <2 x double> %wide.load, %wide.load90
  %40 = fadd <2 x double> %wide.load89, %wide.load91
  ...
  %wide.load93 = load <2 x double>, <2 x double>* %44, align 8, !alias.scope !11
  %45 = fadd <2 x double> %39, %wide.load89
  %46 = fadd <2 x double> %40, %wide.load93
  ...
  %49 = getelementptr inbounds double, double* %A, i64 %offset.idx
  ...
  %53 = icmp eq i64 %index.next, 1996
  br i1 %53, label %vector.body.for.body16.us_crit_edge, label %vector.body.vector.body_crit_edge, !llvm.loop !16

vector.body.vector.body_crit_edge:                ; preds = %vector.body
  br label %vector.body

vector.body.for.body16.us_crit_edge:              ; preds = %vector.body
  br label %for.body16.us.preheader

for.body16.us.preheader:                          ; preds = %vector.memcheck.for.body16.us_crit_edge, %vector.body.for.body16.us_crit_edge
  %indvars.iv68.ph = phi i64 [ 1997, %vector.body.for.body16.us_crit_edge ], [ 1, %vector.memcheck.for.body16.us_crit_edge ]
  br label %for.body16.us
