...
._crit_edge:                                      ; preds = %._crit_edge, %.preheader6
  %indvars.iv16 = phi i64 [ 0, %.preheader6 ], [ %indvars.iv.next17, %._crit_edge ]
...
; <label>:12:                                     ; preds = %._crit_edge
  ...
  br i1 %exitcond21, label %.preheader4.preheader, label %.preheader6

.preheader4.preheader:                            ; preds = %12
  br label %.preheader4

.preheader4:                                      ; preds = %.preheader4.preheader, %20
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %20 ], [ 0, %.preheader4.preheader ]
  br label %._crit_edge22

._crit_edge22:                                    ; preds = %._crit_edge22, %.preheader4
  %indvars.iv10 = phi i64 [ 0, %.preheader4 ], [ %indvars.iv.next11, %._crit_edge22 ]
...
; <label>:20:                                     ; preds = %._crit_edge22
  ...
  br i1 %exitcond15, label %.preheader2.preheader, label %.preheader4

.preheader2.preheader:                            ; preds = %20
  br label %.preheader2

.preheader2:                                      ; preds = %.preheader2.preheader, %28
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %28 ], [ 0, %.preheader2.preheader ]
  br label %._crit_edge23

._crit_edge23:                                    ; preds = %._crit_edge23, %.preheader2
  %indvars.iv4 = phi i64 [ 0, %.preheader2 ], [ %indvars.iv.next5, %._crit_edge23 ]
...
; <label>:28:                                     ; preds = %._crit_edge23
  ...
  br i1 %exitcond9, label %.preheader.preheader, label %.preheader2
...
.preheader9:                                      ; preds = %23, %7
  %indvars.iv24 = phi i64 [ 0, %7 ], [ %indvars.iv.next25, %23 ]
  br label %._crit_edge27

._crit_edge27:                                    ; preds = %22, %.preheader9
  %indvars.iv20 = phi i64 [ 0, %.preheader9 ], [ %indvars.iv.next21, %22 ]
...
; <label>:23:                                     ; preds = %22
  ...
  br i1 %exitcond26, label %.preheader7.preheader, label %.preheader9

.preheader7.preheader:                            ; preds = %23
  br label %.preheader7

.preheader7:                                      ; preds = %.preheader7.preheader, %45
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %45 ], [ 0, %.preheader7.preheader ]
  br label %._crit_edge29

._crit_edge29:                                    ; preds = %44, %.preheader7
  %indvars.iv10 = phi i64 [ 0, %.preheader7 ], [ %indvars.iv.next11, %44 ]
...
._crit_edge28:                                    ; preds = %._crit_edge28, %._crit_edge29
  %indvars.iv7 = phi i64 [ 0, %._crit_edge29 ], [ %indvars.iv.next8.2, %._crit_edge28 ]
  %25 = phi double [ 0.000000e+00, %._crit_edge29 ], [ %43, %._crit_edge28 ]
  ...
  br i1 %exitcond9.2, label %44, label %._crit_edge28

; <label>:44:                                     ; preds = %._crit_edge28
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %exitcond12 = icmp eq i64 %indvars.iv.next11, 1100
  br i1 %exitcond12, label %45, label %._crit_edge29
...
._crit_edge31:                                    ; preds = %66, %.preheader
...
._crit_edge30:                                    ; preds = %._crit_edge30, %._crit_edge31
  ...
  %47 = phi double [ 0.000000e+00, %._crit_edge31 ], [ %65, %._crit_edge30 ]
  ...
  br i1 %exitcond.2, label %66, label %._crit_edge30

; <label>:66:                                     ; preds = %._crit_edge30
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  %exitcond = icmp eq i64 %indvars.iv.next2, 1100
  br i1 %exitcond, label %67, label %._crit_edge31
