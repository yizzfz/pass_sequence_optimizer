...
.lr.ph14.new:                                     ; preds = %.lr.ph14, %.lr.ph14.new
  ...
  br i1 %exitcond20.1, label %.lr.ph10.split.us.preheader, label %.lr.ph14.new
...
._crit_edge.us:                                   ; preds = %.lr.ph10.split.us.new
  ...
  br i1 %exitcond18, label %._crit_edge11, label %.lr.ph10.split.us
...
.lr.ph10.split.us:                                ; preds = %.lr.ph14.preheader, %._crit_edge.us
  ...
  %sunkaddr1 = shl i64 %indvars.iv27.us, 3
...
._crit_edge.us:                                   ; preds = %7
  %indvars.iv.next3.us = add nuw nsw i64 %indvars.iv27.us, 1
  %exitcond29 = icmp eq i64 %indvars.iv.next3.us, 2100
  br i1 %exitcond29, label %._crit_edge11, label %.lr.ph10.split.us
...
.lr.ph10:                                         ; preds = %.lr.ph10.preheader, %11
  %indvars.iv18 = phi i64 [ %indvars.iv.next2, %11 ], [ 0, %.lr.ph10.preheader ]
...
; <label>:9:                                      ; preds = %.lr.ph10
  ...
  %fputc6 = tail call i32 @fputc(i32 10, %struct._IO_FILE* %10) #6
  br label %11

; <label>:11:                                     ; preds = %9, %.lr.ph10
  ...
  %exitcond12 = icmp eq i64 %indvars.iv.next2, 1900
  br i1 %exitcond12, label %._crit_edge11, label %.lr.ph10

._crit_edge11:                                    ; preds = %11
...
.lr.ph:                                           ; preds = %._crit_edge11, %25
  %indvars.iv7 = phi i64 [ %indvars.iv.next, %25 ], [ 0, %._crit_edge11 ]
...
; <label>:25:                                     ; preds = %23, %.lr.ph
  ...
  %27 = getelementptr inbounds double, double* %1, i64 %indvars.iv7
