...
@__llvm_prf_nm = private constant [68 x i8] c"B\00audio_init_input\01tmp1.ll:get_u32\01audio_init_output\01tmp1.ll:put_u32", section "__llvm_prf_names"
@llvm.used = appending global [5 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_audio_init_input to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_get_u32 to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_audio_init_output to i8*), i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_tmp1.ll_put_u32 to i8*), i8* getelementptr inbounds ([68 x i8], [68 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
