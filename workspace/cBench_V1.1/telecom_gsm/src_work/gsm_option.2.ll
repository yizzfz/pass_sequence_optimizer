...
@__llvm_prf_nm = private constant [20 x i8] c"\0A\12x\DAK/\CE\8D\CF/(\C9\CC\CF\03\00\17=\04@", section "__llvm_prf_names"
@llvm.used = appending global [2 x i8*] [i8* bitcast ({ i64, i64, i64*, i8*, i8*, i32, [1 x i16] }* @__profd_gsm_option to i8*), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__llvm_prf_nm, i32 0, i32 0)], section "llvm.metadata"
