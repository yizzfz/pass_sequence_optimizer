...
entry:
  ...
  tail call fastcc void @kernel_trisolv([2000 x double]* %arraydecay, double* %arraydecay3, double* %arraydecay7)
...
for.body6.lr.ph:                                  ; preds = %for.inc14, %entry
  %indvars.iv7 = phi i64 [ 0, %entry ], [ %indvars.iv.next8, %for.inc14 ]
...
for.inc14:                                        ; preds = %for.body6.prol.loopexit, %for.inc14.unr-lcssa
  ...
  %exitcond1 = icmp eq i64 %indvars.iv.next8, 2000
...
for.body:                                         ; preds = %for.end, %entry
  ...
  %indvars.iv5 = phi i32 [ %indvars.iv.next6, %for.end ], [ -1, %entry ]
