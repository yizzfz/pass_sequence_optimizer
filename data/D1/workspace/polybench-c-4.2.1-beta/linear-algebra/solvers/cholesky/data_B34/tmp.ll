...
.preheader13:                                     ; preds = %._crit_edge
  ...
  br i1 %8, label %._crit_edge38.loopexit, label %._crit_edge38
...
._crit_edge38.loopexit:                           ; preds = %.preheader13
  call void @llvm.memset.p0i8.i64(i8* nonnull %scevgep8182, i8 0, i64 %7, i32 8, i1 false)
  br label %._crit_edge38

._crit_edge38:                                    ; preds = %.preheader13, %._crit_edge38.loopexit
  %16 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv87, i64 %indvars.iv87
...
._crit_edge33.us:                                 ; preds = %._crit_edge33.us, %._crit_edge40
  ...
  br i1 %exitcond68.7, label %.preheader9.us.us.preheader.preheader, label %._crit_edge33.us
...
.preheader9.us.us:                                ; preds = %._crit_edge20.us.us, %.preheader9.us.us.preheader
  ...
  %27 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv53, i64 %indvars.iv57
...
._crit_edge91:                                    ; preds = %._crit_edge91, %.preheader9.us.us
  ...
  %29 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv49, i64 %indvars.iv57
  %30 = load double, double* %29, align 8
  %31 = fmul double %28, %30
  %32 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv53, i64 %indvars.iv49
  ...
  %36 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv.next50, i64 %indvars.iv57
  %37 = load double, double* %36, align 8
  %38 = fmul double %35, %37
  %39 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv53, i64 %indvars.iv.next50
...
._crit_edge92:                                    ; preds = %._crit_edge92, %.preheader.us
  %indvars.iv = phi i64 [ 0, %.preheader.us ], [ %indvars.iv.next.4, %._crit_edge92 ]
  %42 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv45, i64 %indvars.iv
  %43 = bitcast double* %42 to i64*
  %44 = load i64, i64* %43, align 8
  %45 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv45, i64 %indvars.iv
  %46 = bitcast double* %45 to i64*
  store i64 %44, i64* %46, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %47 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv45, i64 %indvars.iv.next
  %48 = bitcast double* %47 to i64*
  %49 = load i64, i64* %48, align 8
  %50 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv45, i64 %indvars.iv.next
  %51 = bitcast double* %50 to i64*
  store i64 %49, i64* %51, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %52 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv45, i64 %indvars.iv.next.1
  %53 = bitcast double* %52 to i64*
  %54 = load i64, i64* %53, align 8
  %55 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv45, i64 %indvars.iv.next.1
  %56 = bitcast double* %55 to i64*
  store i64 %54, i64* %56, align 8
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %57 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv45, i64 %indvars.iv.next.2
  %58 = bitcast double* %57 to i64*
  %59 = load i64, i64* %58, align 8
  %60 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv45, i64 %indvars.iv.next.2
  %61 = bitcast double* %60 to i64*
  store i64 %59, i64* %61, align 8
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %62 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %26, i64 0, i64 %indvars.iv45, i64 %indvars.iv.next.3
  %63 = bitcast double* %62 to i64*
  %64 = load i64, i64* %63, align 8
  %65 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv45, i64 %indvars.iv.next.3
  %66 = bitcast double* %65 to i64*
  store i64 %64, i64* %66, align 8
  %indvars.iv.next.4 = add nuw nsw i64 %indvars.iv, 5
  %exitcond44.4 = icmp eq i64 %indvars.iv.next.4, 2000
  br i1 %exitcond44.4, label %._crit_edge.us, label %._crit_edge92
...
.preheader4:                                      ; preds = %._crit_edge9, %.preheader4.preheader
  %indvars.iv50 = phi i2 [ %indvars.iv.next51, %._crit_edge9 ], [ 0, %.preheader4.preheader ]
  %indvars.iv34 = phi i64 [ 0, %.preheader4.preheader ], [ %indvars.iv.next35, %._crit_edge9 ]
  %2 = zext i2 %indvars.iv50 to i64
...
.lr.ph8:                                          ; preds = %._crit_edge
  ...
  %xtraiter44 = and i64 %indvars.iv34, 3
  %lcmp.mod45 = icmp eq i64 %xtraiter44, 0
  br i1 %lcmp.mod45, label %._crit_edge39.prol.loopexit, label %._crit_edge39.prol.preheader
...
._crit_edge39.prol:                               ; preds = %._crit_edge39.prol, %._crit_edge39.prol.preheader
  ...
  %prol.iter = phi i64 [ %xtraiter44, %._crit_edge39.prol.preheader ], [ %prol.iter.sub, %._crit_edge39.prol ]
  ...
  br i1 %prol.iter.cmp, label %._crit_edge39.prol.loopexit.unr-lcssa, label %._crit_edge39.prol, !llvm.loop !1
...
._crit_edge39.prol.loopexit:                      ; preds = %.lr.ph8, %._crit_edge39.prol.loopexit.unr-lcssa
  %.lcssa43.unr = phi double [ undef, %.lr.ph8 ], [ %11, %._crit_edge39.prol.loopexit.unr-lcssa ]
  %.unr46 = phi double [ %.pre41, %.lr.ph8 ], [ %11, %._crit_edge39.prol.loopexit.unr-lcssa ]
...
._crit_edge39:                                    ; preds = %._crit_edge39, %.lr.ph8.new
  %38 = phi double [ %.unr46, %.lr.ph8.new ], [ %54, %._crit_edge39 ]
...
._crit_edge9.loopexit:                            ; preds = %._crit_edge39.prol.loopexit, %._crit_edge9.loopexit.unr-lcssa
  %.lcssa43 = phi double [ %.lcssa43.unr, %._crit_edge39.prol.loopexit ], [ %54, %._crit_edge9.loopexit.unr-lcssa ]
  br label %._crit_edge9
...
._crit_edge9:                                     ; preds = %._crit_edge9.loopexit, %.preheader4.._crit_edge9_crit_edge
  ...
  %55 = phi double [ %.pre42, %.preheader4.._crit_edge9_crit_edge ], [ %.lcssa43, %._crit_edge9.loopexit ]
  ...
  %indvars.iv.next51 = add i2 %indvars.iv50, 1
...
._crit_edge:                                      ; preds = %._crit_edge17
  ...
  br i1 %exitcond16, label %._crit_edge4, label %._crit_edge..lr.ph_crit_edge
