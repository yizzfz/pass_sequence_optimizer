...
for.inc:                                          ; preds = %for.inc, %entry
  %indvars.iv146 = phi i64 [ 0, %entry ], [ %indvars.iv.next147.1, %for.inc ]
  ...
  %exitcond170.1 = icmp eq i64 %indvars.iv.next147, 1999
...
for.inc25.lr.ph:                                  ; preds = %for.inc25.lr.ph.preheader, %for.inc44
  %indvars.iv144 = phi i64 [ %indvars.iv.next145, %for.inc44 ], [ 0, %for.inc25.lr.ph.preheader ]
  %5 = shl i64 %indvars.iv144, 32
  %sext = add nuw nsw i64 %5, 4294967296
  %6 = ashr exact i64 %sext, 32
  %7 = sub nsw i64 1998, %indvars.iv144
  %8 = shl i64 %7, 3
  br label %for.inc25
...
for.inc25:                                        ; preds = %for.inc25, %for.inc25.lr.ph
  %indvars.iv128 = phi i64 [ %indvars.iv.next129, %for.inc25 ], [ 0, %for.inc25.lr.ph ]
  ...
  br i1 %exitcond134, label %for.cond29.preheader, label %for.inc25
...
for.inc44:                                        ; preds = %for.cond29.preheader, %for.inc37.for.inc44_crit_edge
  ...
  br i1 %exitcond169, label %for.end46, label %for.inc25.lr.ph
...
for.inc62.us:                                     ; preds = %for.inc62.us, %for.end46
  %indvars.iv126 = phi i64 [ 0, %for.end46 ], [ %indvars.iv.next127.7, %for.inc62.us ]
  ...
  %exitcond168.7 = icmp eq i64 %indvars.iv.next127.7, 2000
  br i1 %exitcond168.7, label %for.cond69.preheader.us.for.cond73.preheader.us.us_crit_edge.preheader, label %for.inc62.us
...
for.cond69.preheader.us.for.cond73.preheader.us.us_crit_edge: ; preds = %for.cond69.preheader.us.for.cond73.preheader.us.us_crit_edge.preheader, %for.inc96.us
  %indvars.iv120 = phi i64 [ %indvars.iv.next121, %for.inc96.us ], [ 0, %for.cond69.preheader.us.for.cond73.preheader.us.us_crit_edge.preheader ]
...
for.inc90.us.us:                                  ; preds = %for.inc90.us.us, %for.inc90.us.us.preheader
  %indvars.iv114 = phi i64 [ 0, %for.inc90.us.us.preheader ], [ %indvars.iv.next115.1, %for.inc90.us.us ]
  ...
  %exitcond165.1 = icmp eq i64 %indvars.iv.next115, 1999
  %indvars.iv.next115.1 = add nsw i64 %indvars.iv114, 2
  br i1 %exitcond165.1, label %for.inc93.us.us.loopexit, label %for.inc90.us.us, !llvm.loop !12
...
for.inc115.us:                                    ; preds = %for.inc115.us, %for.inc115.us.preheader
  ...
  %exitcond164.4 = icmp eq i64 %indvars.iv.next.3, 1999
  %indvars.iv.next.4 = add nsw i64 %indvars.iv, 5
  br i1 %exitcond164.4, label %for.inc118.us.loopexit, label %for.inc115.us, !llvm.loop !19
...
for.cond1.preheader:                              ; preds = %for.inc58, %entry
  ...
  %indvars.iv155 = phi i64 [ %indvars.iv.next156, %for.inc58 ], [ 4294967295, %entry ]
  %0 = sub i64 2000, %indvars.iv2
  %1 = add i64 %0, -4
  %2 = lshr i64 %1, 2
  %3 = sub i64 2000, %indvars.iv2
  %4 = and i64 %indvars.iv155, 4294967295
...
for.body30.preheader13:                           ; preds = %middle.block, %min.iters.checked, %for.body30.preheader
  %indvars.iv127.ph = phi i64 [ %indvars.iv2, %min.iters.checked ], [ %indvars.iv2, %for.body30.preheader ], [ %ind.end, %middle.block ]
  br label %for.body30
...
for.inc48.us.prol.loopexit:                       ; preds = %for.inc48.us.prol, %for.body30.us
  ...
  %w.199.us.unr.ph = phi double [ %sub47.us.prol, %for.inc48.us.prol ], [ %30, %for.body30.us ]
...
for.inc48.us:                                     ; preds = %for.inc48.us, %for.body30.us.new
  ...
  %w.199.us = phi double [ %w.199.us.unr.ph, %for.body30.us.new ], [ %sub47.us.1, %for.inc48.us ]
  ...
  %exitcond157.1 = icmp eq i64 %indvars.iv.next133, %4
  %indvars.iv.next133.1 = add nsw i64 %indvars.iv132, 2
  br i1 %exitcond157.1, label %for.inc55.us.loopexit, label %for.inc48.us
...
for.body3:                                        ; preds = %for.body3.preheader, %for.inc25
  %indvars.iv151 = phi i64 [ %indvars.iv.next152, %for.inc25 ], [ 4294967295, %for.body3.preheader ]
  %indvars.iv123 = phi i64 [ %indvars.iv.next124, %for.inc25 ], [ 0, %for.body3.preheader ]
  %37 = and i64 %indvars.iv151, 4294967295
  ...
  br i1 %cmp791, label %for.inc.preheader, label %for.inc25

for.inc.preheader:                                ; preds = %for.body3
  %39 = and i64 %indvars.iv151, 1
...
for.inc.prol.loopexit:                            ; preds = %for.inc.prol, %for.inc.preheader
  ...
  %w.093.unr.ph = phi double [ %sub.prol, %for.inc.prol ], [ %38, %for.inc.preheader ]
  %42 = icmp eq i64 %37, 0
...
for.inc:                                          ; preds = %for.inc, %for.inc.preheader.new
  ...
  %w.093 = phi double [ %w.093.unr.ph, %for.inc.preheader.new ], [ %sub.1, %for.inc ]
  ...
  %exitcond153.1 = icmp eq i64 %indvars.iv.next118, %37
  %indvars.iv.next118.1 = add nsw i64 %indvars.iv117, 2
  br i1 %exitcond153.1, label %for.inc25.loopexit, label %for.inc
...
for.inc25:                                        ; preds = %for.inc25.loopexit, %for.inc.prol.loopexit, %for.body3
  ...
  %indvars.iv.next152 = add nuw nsw i64 %37, 1
...
for.body30:                                       ; preds = %for.body30.preheader13, %for.body30
  %indvars.iv127 = phi i64 [ %indvars.iv.next128, %for.body30 ], [ %indvars.iv127.ph, %for.body30.preheader13 ]
  ...
  br i1 %exitcond154, label %for.inc58.loopexit24, label %for.body30, !llvm.loop !21
...
for.inc58:                                        ; preds = %for.inc58.loopexit24, %for.inc58.loopexit, %middle.block
  ...
  %indvars.iv.next156 = add nuw nsw i64 %4, 1
...
for.body63:                                       ; preds = %for.body63.preheader, %for.inc82
  %indvars.iv148 = phi i64 [ %indvars.iv.next149, %for.inc82 ], [ 4294967295, %for.body63.preheader ]
  %indvars.iv115 = phi i64 [ %indvars.iv.next116, %for.inc82 ], [ 0, %for.body63.preheader ]
  %51 = and i64 %indvars.iv148, 4294967295
...
for.inc77.preheader:                              ; preds = %for.body63
  %53 = add nsw i64 %indvars.iv148, 1
...
for.inc77:                                        ; preds = %for.inc77, %for.inc77.preheader.new
  ...
  %exitcond150.3 = icmp eq i64 %indvars.iv.next.2, %51
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  br i1 %exitcond150.3, label %for.inc82.loopexit, label %for.inc77
...
for.inc82:                                        ; preds = %for.inc82.loopexit, %for.inc77.prol.loopexit, %for.body63
  ...
  %indvars.iv.next149 = add nuw nsw i64 %51, 1
...
for.body88:                                       ; preds = %for.body88.preheader, %for.inc112
  ...
  %indvars.iv109 = phi i64 [ 2000, %for.body88.preheader ], [ %indvars.iv.next110, %for.inc112 ]
  %65 = add i64 %indvar, -1
...
for.inc102:                                       ; preds = %for.inc102, %for.inc102.preheader.new
  ...
  %exitcond.3 = icmp eq i64 %indvars.iv107, 1996
