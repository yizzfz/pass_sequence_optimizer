...
for.cond1.preheader:                              ; preds = %for.inc12, %for.cond1.preheader.preheader
  %indvars.iv27 = phi i64 [ 0, %for.cond1.preheader.preheader ], [ %indvars.iv.next28, %for.inc12 ]
...
for.body3:                                        ; preds = %for.body3, %for.cond1.preheader
  %indvars.iv24 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next25.1, %for.body3 ]
  %0 = phi double [ %.pre, %for.cond1.preheader ], [ %add.1, %for.body3 ]
  %arrayidx7 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv27, i64 %indvars.iv24
  ...
  %arrayidx7.1 = getelementptr inbounds [2000 x double], [2000 x double]* %A, i64 %indvars.iv27, i64 %indvars.iv.next25
  ...
  %exitcond26.1 = icmp eq i64 %indvars.iv.next25.1, 2000
  br i1 %exitcond26.1, label %for.inc12, label %for.body3

for.inc12:                                        ; preds = %for.body3
  %indvars.iv.next28 = add nuw nsw i64 %indvars.iv27, 1
  %exitcond29 = icmp eq i64 %indvars.iv.next28, 2000
  br i1 %exitcond29, label %for.inc12.for.cond18.preheader_crit_edge, label %for.cond1.preheader

for.inc12.for.cond18.preheader_crit_edge:         ; preds = %for.inc12
  %sunkaddr4 = ptrtoint double* %x2 to i64
  br label %for.cond18.preheader

for.cond18.preheader:                             ; preds = %for.inc36, %for.inc12.for.cond18.preheader_crit_edge
  %indvars.iv21 = phi i64 [ 0, %for.inc12.for.cond18.preheader_crit_edge ], [ %indvars.iv.next22, %for.inc36 ]
...
for.body20:                                       ; preds = %for.body20, %for.cond18.preheader
  ...
  %5 = phi double [ %.pre20, %for.cond18.preheader ], [ %add30.1, %for.body20 ]
...
for.inc36:                                        ; preds = %for.body20
  ...
  br i1 %exitcond23, label %for.end38, label %for.cond18.preheader
...
if.end:                                           ; preds = %for.body, %if.then
  ...
  br i1 %exitcond15, label %for.body9.preheader, label %for.body
