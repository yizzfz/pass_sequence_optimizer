...
for.cond1.preheader.lr.ph:                        ; preds = %entry
  ...
  %2 = load [160 x double]*, [160 x double]** %C4.addr, align 8
  %3 = shl nsw i64 %0, 3
  %4 = add nsw i64 %0, -1
  %5 = icmp sgt i32 %nq, 0
  %6 = icmp sgt i32 %np, 0
...
for.cond1.preheader:                              ; preds = %for.cond1.preheader.lr.ph, %for.end41
  %storemerge52 = phi i32 [ 0, %for.cond1.preheader.lr.ph ], [ %inc43, %for.end41 ]
...
for.cond4.preheader.us:                           ; preds = %for.cond4.preheader.us.preheader, %for.end38.us
  %14 = phi i32 [ %split20.us, %for.end38.us ], [ %storemerge52, %for.cond4.preheader.us.preheader ]
  %indvars.iv1124.us = phi i64 [ %indvars.iv.next12.us, %for.end38.us ], [ 0, %for.cond4.preheader.us.preheader ]
  br i1 %7, label %for.cond4.for.cond25.preheader_crit_edge.us.loopexit, label %for.body6.us29.preheader
...
for.end38.us:                                     ; preds = %for.end38.us.loopexit, %for.body27.us.prol.loopexit, %for.cond4.for.cond25.preheader_crit_edge.us
  ...
  br i1 %exitcond64, label %for.end41.loopexit, label %for.cond4.preheader.us
...
for.body27.us:                                    ; preds = %for.body27.us.preheader, %for.body27.us
  ...
  br i1 %exitcond61.3, label %for.end38.us.loopexit, label %for.body27.us

for.body6.us29:                                   ; preds = %for.body6.us29.preheader, %for.cond7.for.end_crit_edge.us46
  %indvars.iv718.us30 = phi i64 [ %indvars.iv.next8.us43, %for.cond7.for.end_crit_edge.us46 ], [ 0, %for.body6.us29.preheader ]
...
for.body9.us32.prol:                              ; preds = %for.body6.us29
  %27 = load double, double* %arrayidx15.us34.prol, align 8
  %arrayidx19.us35.prol = getelementptr inbounds [160 x double], [160 x double]* %2, i64 0, i64 %indvars.iv718.us30
  %28 = load double, double* %arrayidx19.us35.prol, align 8
  %mul.us36.prol = fmul double %27, %28
...
for.body9.us32.prol.loopexit:                     ; preds = %for.body9.us32.prol, %for.body6.us29
  ...
  br i1 %11, label %for.cond7.for.end_crit_edge.us46, label %for.body9.us32.preheader
...
for.body9.us32:                                   ; preds = %for.body9.us32.preheader, %for.body9.us32
  %29 = phi double [ %add.us37.1, %for.body9.us32 ], [ %.unr.ph, %for.body9.us32.preheader ]
  ...
  %30 = load double, double* %arrayidx15.us34, align 8
  %arrayidx19.us35 = getelementptr inbounds [160 x double], [160 x double]* %2, i64 %indvars.iv16.us33, i64 %indvars.iv718.us30
  %31 = load double, double* %arrayidx19.us35, align 8
  %mul.us36 = fmul double %30, %31
  %add.us37 = fadd double %29, %mul.us36
  ...
  %32 = load double, double* %arrayidx15.us34.1, align 8
  %arrayidx19.us35.1 = getelementptr inbounds [160 x double], [160 x double]* %2, i64 %indvars.iv.next.us38, i64 %indvars.iv718.us30
  %33 = load double, double* %arrayidx19.us35.1, align 8
  %mul.us36.1 = fmul double %32, %33
  %add.us37.1 = fadd double %add.us37, %mul.us36.1
  store double %add.us37.1, double* %sunkaddr76, align 8
  %indvars.iv.next.us38.1 = add nuw nsw i64 %indvars.iv16.us33, 2
  %exitcond.us39.1 = icmp eq i64 %indvars.iv.next.us38.1, %wide.trip.count
  br i1 %exitcond.us39.1, label %for.cond7.for.end_crit_edge.us46.loopexit, label %for.body9.us32

for.cond7.for.end_crit_edge.us46.loopexit:        ; preds = %for.body9.us32
  br label %for.cond7.for.end_crit_edge.us46

for.cond7.for.end_crit_edge.us46:                 ; preds = %for.cond7.for.end_crit_edge.us46.loopexit, %for.body9.us32.prol.loopexit
...
for.cond4.for.cond25.preheader_crit_edge.us.loopexit81: ; preds = %for.cond7.for.end_crit_edge.us46
  br label %for.cond4.for.cond25.preheader_crit_edge.us
...
for.cond4.for.cond25.preheader_crit_edge.us:      ; preds = %for.cond4.for.cond25.preheader_crit_edge.us.loopexit81, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit
  %split20.us = phi i32 [ %14, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit ], [ %storemerge52, %for.cond4.for.cond25.preheader_crit_edge.us.loopexit81 ]
...
for.body27.us.prol.loopexit:                      ; preds = %for.body27.us.prol.loopexit.loopexit, %for.body27.lr.ph.us
  %indvars.iv922.us.unr = phi i64 [ 0, %for.body27.lr.ph.us ], [ %xtraiter, %for.body27.us.prol.loopexit.loopexit ]
...
for.cond4.preheader:                              ; preds = %for.cond4.preheader.preheader, %for.end38
  %indvars.iv1124 = phi i64 [ %indvars.iv.next12, %for.end38 ], [ 0, %for.cond4.preheader.preheader ]
  br i1 %12, label %for.body27.lr.ph, label %for.end38
...
for.body27.prol:                                  ; preds = %for.body27.prol.preheader, %for.body27.prol
  ...
  %37 = bitcast double* %arrayidx29.prol to i64*
  ...
  %39 = bitcast double* %arrayidx35.prol to i64*
...
for.body27.prol.loopexit:                         ; preds = %for.body27.prol.loopexit.loopexit, %for.body27.lr.ph
  %indvars.iv922.unr = phi i64 [ 0, %for.body27.lr.ph ], [ %xtraiter, %for.body27.prol.loopexit.loopexit ]
  br i1 %13, label %for.end38, label %for.body27.preheader
...
for.body27:                                       ; preds = %for.body27.preheader, %for.body27
  ...
  %40 = bitcast double* %arrayidx29 to i64*
  ...
  %42 = bitcast double* %arrayidx35 to i64*
  ...
  %43 = bitcast double* %arrayidx29.1 to i64*
  ...
  %45 = bitcast double* %arrayidx35.1 to i64*
  ...
  %46 = bitcast double* %arrayidx29.2 to i64*
  ...
  %48 = bitcast double* %arrayidx35.2 to i64*
  ...
  %49 = bitcast double* %arrayidx29.3 to i64*
  ...
  %51 = bitcast double* %arrayidx35.3 to i64*
  store i64 %50, i64* %51, align 8
  %indvars.iv.next10.3 = add nuw nsw i64 %indvars.iv922, 4
...
for.end38:                                        ; preds = %for.end38.loopexit, %for.body27.prol.loopexit, %for.cond4.preheader
  ...
  br i1 %exitcond56, label %for.end41.loopexit82, label %for.cond4.preheader

for.end41.loopexit:                               ; preds = %for.end38.us
  br label %for.end41

for.end41.loopexit82:                             ; preds = %for.end38
  br label %for.end41

for.end41:                                        ; preds = %for.end41.loopexit82, %for.end41.loopexit, %for.cond1.preheader
  %.lcssa14 = phi i32 [ %storemerge52, %for.cond1.preheader ], [ %split20.us, %for.end41.loopexit ], [ %storemerge52, %for.end41.loopexit82 ]
...
for.cond1.preheader:                              ; preds = %for.end14, %entry
  %indvars.iv145 = phi i64 [ 0, %entry ], [ %indvars.iv.next15, %for.end14 ]
  br label %for.cond4.preheader

for.cond4.preheader:                              ; preds = %for.end, %for.cond1.preheader
  %indvars.iv114 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next12, %for.end ]
  %0 = mul nuw nsw i64 %indvars.iv114, %indvars.iv145
  br label %for.body6

for.body6:                                        ; preds = %for.body6, %for.cond4.preheader
  %indvars.iv83 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next9.1, %for.body6 ]
  %1 = add nuw nsw i64 %indvars.iv83, %0
  %2 = trunc i64 %1 to i32
  %rem = srem i32 %2, 160
  %conv = sitofp i32 %rem to double
  %arrayidx11 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %indvars.iv145, i64 %indvars.iv114, i64 %indvars.iv83
  %indvars.iv.next9 = or i64 %indvars.iv83, 1
  ...
  %indvars.iv.next9.1 = add nuw nsw i64 %indvars.iv83, 2
  %exitcond7.1 = icmp eq i64 %indvars.iv.next9.1, 160
  br i1 %exitcond7.1, label %for.end, label %for.body6

for.end:                                          ; preds = %for.body6
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv114, 1
  %exitcond8 = icmp eq i64 %indvars.iv.next12, 140
  br i1 %exitcond8, label %for.end14, label %for.cond4.preheader

for.end14:                                        ; preds = %for.end
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv145, 1
  %exitcond9 = icmp eq i64 %indvars.iv.next15, 150
  br i1 %exitcond9, label %for.cond22.preheader.preheader, label %for.cond1.preheader

for.cond22.preheader.preheader:                   ; preds = %for.end14
  br label %for.cond22.preheader

for.cond22.preheader:                             ; preds = %for.cond22.preheader.preheader, %for.end37
  %indvars.iv62 = phi i64 [ %indvars.iv.next7, %for.end37 ], [ 0, %for.cond22.preheader.preheader ]
  br label %for.body25

for.body25:                                       ; preds = %for.body25, %for.cond22.preheader
  %indvars.iv1 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next.1, %for.body25 ]
  %6 = mul nuw nsw i64 %indvars.iv1, %indvars.iv62
  %7 = trunc i64 %6 to i32
  %rem27 = srem i32 %7, 160
  %conv28 = sitofp i32 %rem27 to double
  %arrayidx34 = getelementptr inbounds [160 x double], [160 x double]* %C4, i64 %indvars.iv62, i64 %indvars.iv1
  %indvars.iv.next = or i64 %indvars.iv1, 1
  %8 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv62
...
for.end37:                                        ; preds = %for.body25
  ...
  %exitcond6 = icmp eq i64 %indvars.iv.next7, 160
  br i1 %exitcond6, label %for.end40, label %for.cond22.preheader
...
for.cond2.preheader:                              ; preds = %for.end20, %entry
  %indvars.iv73 = phi i64 [ 0, %entry ], [ %indvars.iv.next8, %for.end20 ]
  %3 = mul nuw nsw i64 %indvars.iv73, 140
  br label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.end, %for.cond2.preheader
  %indvars.iv52 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next6, %for.end ]
  %mul83 = add nuw nsw i64 %indvars.iv52, %3
  %add = mul nuw nsw i64 %mul83, 160
  br label %for.body7

for.body7:                                        ; preds = %if.end, %for.cond5.preheader
  %indvars.iv1 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next, %if.end ]
  %4 = add nuw nsw i64 %indvars.iv1, %add
...
if.end:                                           ; preds = %if.then, %for.body7
  ...
  %arrayidx16 = getelementptr inbounds [140 x [160 x double]], [140 x [160 x double]]* %A, i64 %indvars.iv73, i64 %indvars.iv52, i64 %indvars.iv1
...
for.end:                                          ; preds = %if.end
  ...
  %exitcond4 = icmp eq i64 %indvars.iv.next6, 140
  br i1 %exitcond4, label %for.end20, label %for.cond5.preheader

for.end20:                                        ; preds = %for.end
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv73, 1
  %exitcond5 = icmp eq i64 %indvars.iv.next8, 150
  br i1 %exitcond5, label %for.end23, label %for.cond2.preheader
