...
._crit_edge:                                      ; preds = %._crit_edge, %.lr.ph95
  ...
  %6 = sub nsw i64 0, %indvars.iv131
  %7 = trunc i64 %6 to i32
  %8 = srem i32 %7, 2000
  %9 = sitofp i32 %8 to double
  %10 = fdiv double %9, 2.000000e+03
  %11 = fadd double %10, 1.000000e+00
  %12 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv149, i64 %indvars.iv131
...
._crit_edge96:                                    ; preds = %._crit_edge
  ...
  %14 = shl i64 %5, 3
  %scevgep143 = getelementptr [2000 x double], [2000 x double]* %1, i64 0, i64 %13
  %15 = and i64 %14, 34359738360
  %indvars.iv.next150 = add nuw nsw i64 %indvars.iv149, 1
  %16 = icmp slt i64 %indvars.iv.next150, 2000
  br i1 %16, label %.lr.ph99.preheader, label %._crit_edge100

.lr.ph99.preheader:                               ; preds = %._crit_edge96
  %17 = add nuw nsw i64 %15, 8
  %scevgep143144 = bitcast double* %scevgep143 to i8*
  call void @llvm.memset.p0i8.i64(i8* nonnull %scevgep143144, i8 0, i64 %17, i32 8, i1 false)
  br label %._crit_edge100

._crit_edge100:                                   ; preds = %._crit_edge96, %.lr.ph99.preheader
...
._crit_edge102:                                   ; preds = %._crit_edge100
  ...
  br i1 true, label %.preheader72.us.prol.loopexit, label %.preheader72.us.prol.preheader

.preheader72.us.prol.preheader:                   ; preds = %._crit_edge102
  br label %.preheader72.us.prol

.preheader72.us.prol:                             ; preds = %.preheader72.us.prol, %.preheader72.us.prol.preheader
  %indvars.iv127.prol = phi i64 [ 0, %.preheader72.us.prol.preheader ], [ %indvars.iv.next128.prol, %.preheader72.us.prol ]
  %prol.iter203 = phi i64 [ 0, %.preheader72.us.prol.preheader ], [ %prol.iter203.sub, %.preheader72.us.prol ]
  %20 = mul nuw nsw i64 %indvars.iv127.prol, 16000
  ...
  br i1 %prol.iter203.cmp, label %.preheader72.us.prol.loopexit.unr-lcssa, label %.preheader72.us.prol, !llvm.loop !1

.preheader72.us.prol.loopexit.unr-lcssa:          ; preds = %.preheader72.us.prol
  br label %.preheader72.us.prol.loopexit

.preheader72.us.prol.loopexit:                    ; preds = %._crit_edge102, %.preheader72.us.prol.loopexit.unr-lcssa
  br i1 false, label %.preheader70.lr.ph, label %._crit_edge102.new

._crit_edge102.new:                               ; preds = %.preheader72.us.prol.loopexit
  br label %.preheader72.us

.preheader72.us:                                  ; preds = %.preheader72.us, %._crit_edge102.new
  %indvars.iv127 = phi i64 [ 0, %._crit_edge102.new ], [ %indvars.iv.next128.7, %.preheader72.us ]
  %21 = mul nuw nsw i64 %indvars.iv127, 16000
  %scevgep = getelementptr i8, i8* %19, i64 %21
  call void @llvm.memset.p0i8.i64(i8* %scevgep, i8 0, i64 16000, i32 8, i1 false)
  %22 = mul i64 %indvars.iv127, 16000
  %23 = add i64 %22, 16000
  %scevgep.1 = getelementptr i8, i8* %19, i64 %23
  call void @llvm.memset.p0i8.i64(i8* %scevgep.1, i8 0, i64 16000, i32 8, i1 false)
  %24 = mul i64 %indvars.iv127, 16000
  %25 = add i64 %24, 32000
  %scevgep.2 = getelementptr i8, i8* %19, i64 %25
  call void @llvm.memset.p0i8.i64(i8* %scevgep.2, i8 0, i64 16000, i32 8, i1 false)
  %26 = mul i64 %indvars.iv127, 16000
  %27 = add i64 %26, 48000
  %scevgep.3 = getelementptr i8, i8* %19, i64 %27
  call void @llvm.memset.p0i8.i64(i8* %scevgep.3, i8 0, i64 16000, i32 8, i1 false)
  %28 = mul i64 %indvars.iv127, 16000
  %29 = add i64 %28, 64000
  %scevgep.4 = getelementptr i8, i8* %19, i64 %29
  call void @llvm.memset.p0i8.i64(i8* %scevgep.4, i8 0, i64 16000, i32 8, i1 false)
  %30 = mul i64 %indvars.iv127, 16000
  %31 = add i64 %30, 80000
  %scevgep.5 = getelementptr i8, i8* %19, i64 %31
  call void @llvm.memset.p0i8.i64(i8* %scevgep.5, i8 0, i64 16000, i32 8, i1 false)
  %32 = mul i64 %indvars.iv127, 16000
  %33 = add i64 %32, 96000
  %scevgep.6 = getelementptr i8, i8* %19, i64 %33
  call void @llvm.memset.p0i8.i64(i8* %scevgep.6, i8 0, i64 16000, i32 8, i1 false)
  %34 = mul i64 %indvars.iv127, 16000
  ...
  br i1 %exitcond130.7, label %.preheader70.lr.ph.unr-lcssa, label %.preheader72.us

.preheader70.lr.ph.unr-lcssa:                     ; preds = %.preheader72.us
  br label %.preheader70.lr.ph

.preheader70.lr.ph:                               ; preds = %.preheader72.us.prol.loopexit, %.preheader70.lr.ph.unr-lcssa
...
.preheader69.us.us.preheader:                     ; preds = %._crit_edge81.us, %.preheader70.lr.ph
  %indvars.iv119 = phi i64 [ 0, %.preheader70.lr.ph ], [ %indvars.iv.next120, %._crit_edge81.us ]
  %scevgep158 = getelementptr [2000 x double], [2000 x double]* %1, i64 0, i64 %indvars.iv119
...
._crit_edge81.us:                                 ; preds = %._crit_edge79.us.us
  ...
  br i1 %exitcond122, label %.preheader.lr.ph, label %.preheader69.us.us.preheader
...
.preheader69.us.us:                               ; preds = %._crit_edge79.us.us, %.preheader69.us.us.preheader
  ...
  %scevgep156 = getelementptr i8, i8* %19, i64 %38
  %39 = add i64 16000, %38
  %scevgep157 = getelementptr i8, i8* %19, i64 %39
...
._crit_edge153.prol:                              ; preds = %._crit_edge153.prol.preheader
  ...
  %45 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv115, i64 %indvars.iv111.ph
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %70 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv115, i64 %index
  ...
  %wide.load167 = load <2 x double>, <2 x double>* %73, align 8, !alias.scope !8, !noalias !10
  %74 = fadd <2 x double> %wide.load, %68
  %75 = fadd <2 x double> %wide.load167, %69
...
._crit_edge153:                                   ; preds = %._crit_edge153, %._crit_edge153.preheader.new
  ...
  %83 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv115, i64 %indvars.iv111
  ...
  %90 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv115, i64 %indvars.iv.next112
...
.preheader.us:                                    ; preds = %._crit_edge.us, %.preheader.lr.ph
  %indvars.iv107 = phi i64 [ 0, %.preheader.lr.ph ], [ %indvars.iv.next108, %._crit_edge.us ]
  %scevgep177 = getelementptr [2000 x double], [2000 x double]* %1, i64 %indvars.iv107, i64 0
  %scevgep177178 = bitcast double* %scevgep177 to i8*
  %scevgep179 = getelementptr [2000 x double], [2000 x double]* %1, i64 %indvars.iv107, i64 2000
  %scevgep179180 = bitcast double* %scevgep179 to i8*
  %93 = mul nuw nsw i64 %indvars.iv107, 16000
  %scevgep181 = getelementptr i8, i8* %19, i64 %93
  %94 = add i64 16000, %93
  %scevgep182 = getelementptr i8, i8* %19, i64 %94
  br i1 false, label %._crit_edge154.preheader, label %min.iters.checked172

min.iters.checked172:                             ; preds = %.preheader.us
  br i1 false, label %._crit_edge154.preheader, label %vector.memcheck187
...
vector.memcheck187:                               ; preds = %min.iters.checked172
  ...
  br i1 %memcheck.conflict186, label %._crit_edge154.preheader, label %vector.body168.preheader
...
vector.body168:                                   ; preds = %vector.body168.preheader, %vector.body168
  ...
  %95 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv107, i64 %index189
  %96 = bitcast double* %95 to <2 x i64>*
  %wide.load197 = load <2 x i64>, <2 x i64>* %96, align 8, !alias.scope !15
  %97 = getelementptr double, double* %95, i64 2
  %98 = bitcast double* %97 to <2 x i64>*
  %wide.load198 = load <2 x i64>, <2 x i64>* %98, align 8, !alias.scope !15
  %99 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv107, i64 %index189
  %100 = bitcast double* %99 to <2 x i64>*
  store <2 x i64> %wide.load197, <2 x i64>* %100, align 8, !alias.scope !18, !noalias !15
  %101 = getelementptr double, double* %99, i64 2
  %102 = bitcast double* %101 to <2 x i64>*
  store <2 x i64> %wide.load198, <2 x i64>* %102, align 8, !alias.scope !18, !noalias !15
  %index.next190 = add i64 %index189, 4
  %103 = icmp eq i64 %index.next190, 2000
  br i1 %103, label %middle.block169, label %vector.body168, !llvm.loop !20

middle.block169:                                  ; preds = %vector.body168
  br i1 true, label %._crit_edge.us, label %._crit_edge154.preheader

._crit_edge154.preheader:                         ; preds = %middle.block169, %vector.memcheck187, %min.iters.checked172, %.preheader.us
...
._crit_edge154.prol:                              ; preds = %._crit_edge154.prol, %._crit_edge154.prol.preheader
  ...
  %105 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv107, i64 %indvars.iv.prol
...
._crit_edge154:                                   ; preds = %._crit_edge154, %._crit_edge154.preheader.new
  ...
  %111 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv107, i64 %indvars.iv
  ...
  %116 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv107, i64 %indvars.iv.next
  ...
  %121 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv107, i64 %indvars.iv.next.1
  ...
  %126 = getelementptr inbounds [2000 x [2000 x double]], [2000 x [2000 x double]]* %36, i64 0, i64 %indvars.iv107, i64 %indvars.iv.next.2
...
.preheader44:                                     ; preds = %.preheader44.preheader, %._crit_edge49
  %indvars.iv96 = phi i2 [ 0, %.preheader44.preheader ], [ %indvars.iv.next97, %._crit_edge49 ]
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %._crit_edge49 ], [ 0, %.preheader44.preheader ]
  %3 = zext i2 %indvars.iv96 to i64
  %4 = add nsw i64 %indvars.iv74, -1
  %5 = icmp sgt i64 %indvars.iv74, 0
  br i1 %5, label %.preheader.preheader, label %.preheader43.._crit_edge49_crit_edge
...
.preheader43.._crit_edge49_crit_edge:             ; preds = %.preheader44
  %.phi.trans.insert82 = getelementptr inbounds [2000 x double], [2000 x double]* %1, i64 %indvars.iv74, i64 %indvars.iv74
  %.pre83 = load double, double* %.phi.trans.insert82, align 8
...
.lr.ph48:                                         ; preds = %._crit_edge
  ...
  %xtraiter90 = and i64 %indvars.iv74, 3
  %lcmp.mod91 = icmp eq i64 %xtraiter90, 0
  br i1 %lcmp.mod91, label %._crit_edge79.prol.loopexit, label %._crit_edge79.prol.preheader
...
._crit_edge79.prol:                               ; preds = %._crit_edge79.prol, %._crit_edge79.prol.preheader
  ...
  %prol.iter = phi i64 [ %xtraiter90, %._crit_edge79.prol.preheader ], [ %prol.iter.sub, %._crit_edge79.prol ]
...
._crit_edge79.prol.loopexit:                      ; preds = %.lr.ph48, %._crit_edge79.prol.loopexit.unr-lcssa
  %.lcssa89.unr = phi double [ undef, %.lr.ph48 ], [ %12, %._crit_edge79.prol.loopexit.unr-lcssa ]
  %.unr92 = phi double [ %.pre81, %.lr.ph48 ], [ %12, %._crit_edge79.prol.loopexit.unr-lcssa ]
...
._crit_edge79:                                    ; preds = %._crit_edge79, %.lr.ph48.new
  %39 = phi double [ %.unr92, %.lr.ph48.new ], [ %55, %._crit_edge79 ]
...
._crit_edge49.loopexit:                           ; preds = %._crit_edge79.prol.loopexit, %._crit_edge49.loopexit.unr-lcssa
  %.lcssa89 = phi double [ %.lcssa89.unr, %._crit_edge79.prol.loopexit ], [ %55, %._crit_edge49.loopexit.unr-lcssa ]
  br label %._crit_edge49

._crit_edge49:                                    ; preds = %._crit_edge49.loopexit, %.preheader43.._crit_edge49_crit_edge
  %.pre-phi84 = phi double* [ %.phi.trans.insert82, %.preheader43.._crit_edge49_crit_edge ], [ %7, %._crit_edge49.loopexit ]
  %56 = phi double [ %.pre83, %.preheader43.._crit_edge49_crit_edge ], [ %.lcssa89, %._crit_edge49.loopexit ]
  %57 = tail call double @sqrt(double %56) #3
  store double %57, double* %.pre-phi84, align 8
