...
for.cond1.preheader:                              ; preds = %for.inc20, %entry
  %indvars.iv37 = phi i64 [ 0, %entry ], [ %indvars.iv.next4, %for.inc20 ]
  br label %for.body3

for.body3:                                        ; preds = %for.body3, %for.cond1.preheader
  %indvars.iv6 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next, %for.body3 ]
  %0 = mul nuw nsw i64 %indvars.iv6, %indvars.iv37
  %1 = trunc i64 %0 to i32
  %rem = srem i32 %1, 7
  %add = add nsw i32 %rem, 1
  %arrayidx5 = getelementptr inbounds [2800 x i32], [2800 x i32]* %path, i64 %indvars.iv37, i64 %indvars.iv6
  %2 = add nuw nsw i64 %indvars.iv6, %indvars.iv37
  ...
  %or.cond5 = or i1 %cmp15, %or.cond
  %.add = select i1 %or.cond5, i32 999, i32 %add
...
for.inc20:                                        ; preds = %for.body3
  ...
  %exitcond8 = icmp eq i64 %indvars.iv.next4, 2800
  br i1 %exitcond8, label %for.end22, label %for.cond1.preheader
