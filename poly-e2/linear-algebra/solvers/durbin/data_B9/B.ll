...
for.body8.prol.loopexit:                          ; preds = %for.body8.prol.loopexit.loopexit, %for.body8.lr.ph
  ...
  br i1 %10, label %for.body21.lr.ph, label %for.body8.preheader
...
for.body21.prol:                                  ; preds = %for.body21.lr.ph
  ...
  store double %add29.prol, double* %27, align 16
...
for.body21.preheader:                             ; preds = %for.body21.prol.loopexit
  %31 = sub i64 %2, %indvars.iv14.unr.ph
  %32 = lshr i64 %31, 1
  %33 = add nuw i64 %32, 1
...
for.body21:                                       ; preds = %for.body21.preheader49, %for.body21
  ...
  %55 = sub nsw i64 %24, %indvars.iv14
  %arrayidx27 = getelementptr inbounds double, double* %y, i64 %55
  %56 = load double, double* %arrayidx27, align 8
  %mul28 = fmul double %div, %56
  %add29 = fadd double %54, %mul28
  ...
  %57 = load double, double* %arrayidx23.1, align 8
  %58 = sub nsw i64 %24, %indvars.iv.next15
  %arrayidx27.1 = getelementptr inbounds double, double* %y, i64 %58
  %59 = load double, double* %arrayidx27.1, align 8
  %mul28.1 = fmul double %div, %59
  %add29.1 = fadd double %57, %mul28.1
...
for.end44:                                        ; preds = %for.end44.loopexit, %middle.block, %for.body21.prol.loopexit
  %60 = bitcast [2000 x double]* %z to i8*
  %61 = bitcast double* %y to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %61, i8* nonnull %60, i64 %4, i32 8, i1 false)
