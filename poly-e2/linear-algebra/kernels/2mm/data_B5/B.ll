...
entry:
  ...
  tail call void @kernel_2mm(i32 800, i32 900, i32 1100, i32 1200, double %0, double %1, [900 x double]* %arraydecay12, [1100 x double]* %arraydecay, [900 x double]* %arraydecay9, [1200 x double]* %arraydecay10, [1200 x double]* %arraydecay11)
...
if.then:                                          ; preds = %land.lhs.true
  tail call void @print_array(i32 800, i32 1200, [1200 x double]* %arraydecay11)
  br label %if.end
...
define internal void @init_array(i32 %ni, i32 %nj, i32 %nk, i32 %nl, double* nocapture %alpha, double* nocapture %beta, [1100 x double]* nocapture %A, [900 x double]* nocapture %B, [1200 x double]* nocapture %C, [1200 x double]* nocapture %D) #2 {
entry:
...
for.inc.us:                                       ; preds = %for.inc.us, %for.cond1.preheader.us
  ...
  br i1 %exitcond55, label %for.cond1.for.inc7_crit_edge.us, label %for.inc.us
...
for.inc28.us.prol.loopexit:                       ; preds = %for.inc28.us.prol, %for.cond14.preheader.us
  %indvars.iv1234.us.unr.ph = phi i64 [ 1, %for.inc28.us.prol ], [ 0, %for.cond14.preheader.us ]
  br i1 %7, label %for.cond14.for.inc31_crit_edge.us, label %for.inc28.us.preheader
...
for.inc28.us:                                     ; preds = %for.inc28.us.preheader, %for.inc28.us
  %indvars.iv1234.us = phi i64 [ %indvars.iv.next13.us.1, %for.inc28.us ], [ %indvars.iv1234.us.unr.ph, %for.inc28.us.preheader ]
  ...
  br i1 %exitcond52.1, label %for.cond14.for.inc31_crit_edge.us.loopexit, label %for.inc28.us
...
for.end33:                                        ; preds = %for.end33.loopexit, %for.end9.thread, %for.end9
  ...
  br i1 %cmp3530, label %for.cond38.preheader.lr.ph, label %for.end58

for.cond38.preheader.lr.ph:                       ; preds = %for.end33
  %cmp3928 = icmp sgt i32 %nl, 0
  %conv47 = sitofp i32 %nl to double
  br i1 %cmp3928, label %for.cond38.preheader.us.preheader, label %for.end58
...
for.inc53.us:                                     ; preds = %for.inc53.us, %for.cond38.preheader.us
  ...
  br i1 %exitcond49, label %for.cond38.for.inc56_crit_edge.us, label %for.inc53.us
...
for.cond38.for.inc56_crit_edge.us:                ; preds = %for.inc53.us
  ...
  br i1 %exitcond50, label %for.end58.loopexit, label %for.cond38.preheader.us
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal void @kernel_2mm(i32 %ni, i32 %nj, i32 %nk, i32 %nl, double %alpha, double %beta, [900 x double]* nocapture %tmp, [1100 x double]* nocapture readonly %A, [900 x double]* nocapture readonly %B, [1200 x double]* nocapture readonly %C, [1200 x double]* nocapture %D) #2 {
entry:
  %0 = sext i32 %nk to i64
...
for.body6.us.us:                                  ; preds = %for.body6.us.us.preheader, %for.cond9.for.inc25_crit_edge.us.us
  ...
  br i1 %lcmp.mod82, label %for.inc.us.us.prol.loopexit, label %for.inc.us.us.prol
...
for.inc.us.us.prol.loopexit:                      ; preds = %for.inc.us.us.prol, %for.body6.us.us
  %.unr83.ph = phi double [ %add.us.us.prol, %for.inc.us.us.prol ], [ 0.000000e+00, %for.body6.us.us ]
  %indvars.iv541.us.us.unr.ph = phi i64 [ 1, %for.inc.us.us.prol ], [ 0, %for.body6.us.us ]
  br i1 %4, label %for.cond9.for.inc25_crit_edge.us.us, label %for.inc.us.us.preheader
...
for.inc.us.us:                                    ; preds = %for.inc.us.us.preheader, %for.inc.us.us
  %7 = phi double [ %add.us.us.1, %for.inc.us.us ], [ %.unr83.ph, %for.inc.us.us.preheader ]
  %indvars.iv541.us.us = phi i64 [ %indvars.iv.next6.us.us.1, %for.inc.us.us ], [ %indvars.iv541.us.us.unr.ph, %for.inc.us.us.preheader ]
  ...
  br i1 %exitcond80.1, label %for.cond9.for.inc25_crit_edge.us.us.loopexit, label %for.inc.us.us
...
for.body36.us.us:                                 ; preds = %for.body36.us.us.preheader, %for.cond42.for.inc62_crit_edge.us.us
  ...
  br i1 %lcmp.mod74, label %for.inc59.us.us.prol.loopexit, label %for.inc59.us.us.prol
...
for.inc59.us.us.prol.loopexit:                    ; preds = %for.inc59.us.us.prol, %for.body36.us.us
  %.unr.ph = phi double [ %add58.us.us.prol, %for.inc59.us.us.prol ], [ %mul41.us.us, %for.body36.us.us ]
  %indvars.iv12.us.us.unr.ph = phi i64 [ 1, %for.inc59.us.us.prol ], [ 0, %for.body36.us.us ]
  br i1 %15, label %for.cond42.for.inc62_crit_edge.us.us, label %for.inc59.us.us.preheader
...
for.inc59.us.us:                                  ; preds = %for.inc59.us.us.preheader, %for.inc59.us.us
  %47 = phi double [ %add58.us.us.1, %for.inc59.us.us ], [ %.unr.ph, %for.inc59.us.us.preheader ]
  %indvars.iv12.us.us = phi i64 [ %indvars.iv.next.us.us.1, %for.inc59.us.us ], [ %indvars.iv12.us.us.unr.ph, %for.inc59.us.us.preheader ]
  ...
  br i1 %exitcond.1, label %for.cond42.for.inc62_crit_edge.us.us.loopexit, label %for.inc59.us.us
...
; Function Attrs: noinline nounwind uwtable
define internal void @print_array(i32 %ni, i32 %nl, [1200 x double]* nocapture readonly %D) #0 {
entry:
