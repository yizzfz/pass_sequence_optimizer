...
if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array([1100 x double]* %arraydecay1)
  br label %if.end
...
for.cond1.preheader.us:                           ; preds = %for.inc32.us, %entry
  ...
  %2 = add nuw nsw i64 %indvars.iv53, 1
  br label %for.body3.us
...
for.cond9.preheader.us.us.preheader:              ; preds = %for.body3.us
  %scevgep = getelementptr [1100 x double], [1100 x double]* %C, i64 %indvars.iv53, i64 0
...
for.cond9.preheader.us.us:                        ; preds = %for.cond9.preheader.us.us.preheader, %for.cond9.for.inc29_crit_edge.us.us
  ...
  %7 = add nuw nsw i64 %indvars.iv49, 1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %12 = getelementptr inbounds [1100 x double], [1100 x double]* %B, i64 %indvars.iv49, i64 %offset.idx
  ...
  %15 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv53, i64 %offset.idx
  ...
  %24 = getelementptr inbounds [1100 x double], [1100 x double]* %C, i64 %indvars.iv53, i64 %18
...
for.body11.us.us:                                 ; preds = %for.body11.us.us.preheader, %for.body11.us.us
  %indvars.iv45 = phi i64 [ %indvars.iv.next46.1, %for.body11.us.us ], [ 0, %for.body11.us.us.preheader ]
