...
entry:
  ...
  %sunkaddr55 = ptrtoint double* %u2 to i64
...
for.cond1.preheader.us:                           ; preds = %entry, %for.cond1.for.inc20_crit_edge.us
  ...
  %sunkaddr57 = add i64 %sunkaddr55, %sunkaddr52
...
for.inc.us:                                       ; preds = %for.cond1.preheader.us, %for.inc.us
  ...
  %1 = load double, double* %sunkaddr54, align 8
  ...
  %3 = load double, double* %sunkaddr58, align 8
  ...
  %8 = load double, double* %sunkaddr58, align 8
  ...
  br i1 %exitcond34.1, label %for.cond1.for.inc20_crit_edge.us, label %for.inc.us
...
for.cond26.preheader.us.preheader:                ; preds = %for.cond1.for.inc20_crit_edge.us
  %sunkaddr59 = ptrtoint double* %x to i64
...
for.cond26.preheader.us:                          ; preds = %for.cond26.preheader.us.preheader, %for.cond26.for.inc45_crit_edge.us
  ...
  %sunkaddr60 = shl i64 %indvars.iv27, 3
...
for.inc42.us:                                     ; preds = %for.cond26.preheader.us, %for.inc42.us
  ...
  store double %add39.us, double* %sunkaddr62, align 8
  ...
  store double %add39.us.1, double* %sunkaddr62, align 8
...
vector.body:                                      ; preds = %vector.body.preheader, %vector.body
  ...
  %21 = fadd <8 x double> %wide.vec, %wide.vec9
  %22 = shufflevector <8 x double> %21, <8 x double> undef, <2 x i32> <i32 1, i32 5>
  %23 = fadd <8 x double> %wide.vec, %wide.vec9
  ...
  %27 = fadd <8 x double> %wide.vec, %wide.vec9
  ...
  br i1 %33, label %for.cond64.preheader.us.preheader.loopexit14, label %vector.body, !llvm.loop !6

for.cond64.preheader.us.preheader.loopexit:       ; preds = %for.inc58
  br label %for.cond64.preheader.us.preheader

for.cond64.preheader.us.preheader.loopexit14:     ; preds = %vector.body
  br label %for.cond64.preheader.us.preheader

for.cond64.preheader.us.preheader:                ; preds = %for.cond64.preheader.us.preheader.loopexit14, %for.cond64.preheader.us.preheader.loopexit
  %sunkaddr63 = ptrtoint double* %w to i64
...
for.cond64.preheader.us:                          ; preds = %for.cond64.preheader.us.preheader, %for.cond64.for.inc83_crit_edge.us
  ...
  %sunkaddr64 = shl i64 %indvars.iv15, 3
...
for.inc80.us:                                     ; preds = %for.cond64.preheader.us, %for.inc80.us
  %34 = phi double [ %add77.us.1, %for.inc80.us ], [ %.pre50, %for.cond64.preheader.us ]
  ...
  store double %add77.us, double* %sunkaddr66, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store double %add77.us.1, double* %sunkaddr66, align 8
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.1 = icmp eq i64 %indvars.iv.next.1, 2000
