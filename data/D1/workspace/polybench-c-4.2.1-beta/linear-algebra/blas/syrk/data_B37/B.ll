...
._crit_edge57:                                    ; preds = %._crit_edge57, %.preheader.us
  ...
  br i1 %exitcond53, label %._crit_edge.us, label %._crit_edge57
...
.lr.ph.us.new.preheader:                          ; preds = %middle.block, %min.iters.checked, %.prol.loopexit..lr.ph.us.new_crit_edge
  %indvars.iv.ph = phi i64 [ %ind.end, %middle.block ], [ %indvars.iv.unr, %min.iters.checked ], [ %indvars.iv.unr, %.prol.loopexit..lr.ph.us.new_crit_edge ]
...
._crit_edge:                                      ; preds = %._crit_edge20, %11
  ...
  br i1 %exitcond18, label %._crit_edge.us, label %._crit_edge20
